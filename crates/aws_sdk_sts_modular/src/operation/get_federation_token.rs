...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for GetFederationTokenTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) =
            context.input().downcast_ref::<GetFederationTokenInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for GetFederationTokenResponseDeserializer
{
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for GetFederationTokenRequestSerializer
{
    #[allow(
        unused_mut,
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for GetFederationTokenEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
...
impl ::aws_types::request_id::RequestId
    for crate::operation::get_federation_token::GetFederationTokenError
{
