...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for GetWebIdentityTokenTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) =
            context.input().downcast_ref::<GetWebIdentityTokenInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for GetWebIdentityTokenResponseDeserializer
{
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for GetWebIdentityTokenRequestSerializer
{
    #[allow(
        unused_mut,
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for GetWebIdentityTokenEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
...
impl GetWebIdentityTokenError {
    ...
    pub fn is_outbound_web_identity_federation_disabled_exception(&self) -> bool {
        matches!(
            self,
            Self::OutboundWebIdentityFederationDisabledException(_)
        )
    }
...
impl ::aws_types::request_id::RequestId
    for crate::operation::get_web_identity_token::GetWebIdentityTokenError
{
