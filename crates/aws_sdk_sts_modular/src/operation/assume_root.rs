...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssumeRoot {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::orchestrator::Metadata::new("AssumeRoot", "STS"),
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for AssumeRootTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AssumeRootInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for AssumeRootResponseDeserializer
{
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_assume_root::de_assume_root_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_assume_root::de_assume_root_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssumeRootRequestSerializer {
    ...
    > {
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_assume_root_input::ser_assume_root_input_input_input(
                &input,
            )?,
        );
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for AssumeRootEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "AssumeRootEndpointParamsInterceptor"
    }
