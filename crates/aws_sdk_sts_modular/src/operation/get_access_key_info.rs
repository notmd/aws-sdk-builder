...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for GetAccessKeyInfoTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) =
            context.input().downcast_ref::<GetAccessKeyInfoInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for GetAccessKeyInfoResponseDeserializer
{
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for GetAccessKeyInfoRequestSerializer
{
    #[allow(
        unused_mut,
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for GetAccessKeyInfoEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "GetAccessKeyInfoEndpointParamsInterceptor"
    }
...
impl ::aws_types::request_id::RequestId
    for crate::operation::get_access_key_info::GetAccessKeyInfoError
{
