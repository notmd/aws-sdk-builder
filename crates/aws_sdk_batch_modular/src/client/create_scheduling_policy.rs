...
impl super::Client {
    ...
    ///   - [`quota_share_policy(QuotaSharePolicy)`](crate::operation::create_scheduling_policy::builders::CreateSchedulingPolicyFluentBuilder::quota_share_policy) / [`set_quota_share_policy(Option<QuotaSharePolicy>)`](crate::operation::create_scheduling_policy::builders::CreateSchedulingPolicyFluentBuilder::set_quota_share_policy):<br>required: **false**<br><p>The quota share scheduling policy details. Only one of fairsharePolicy or quotaSharePolicy can be set. Once set, this policy type cannot be removed or changed to a fairSharePolicy.</p><br>
