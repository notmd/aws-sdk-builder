...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_list_function_url_configs::de_list_function_url_configs(
                _response_body,
                output,
            )
            .map_err(
                ...
                match key.to_unescaped()?.as_ref() {
                    "FunctionUrlConfigs" => {
                        builder = builder.set_function_url_configs(
                            crate::protocol_serde::shape_function_url_config_list::de_function_url_config_list(tokens, _value, depth + 1)?,
                        );
                    }
                    "NextMarker" => {
