...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::publish_version::PublishVersionError::unhandled(generic))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_publish_version::de_publish_version(
            _response_body,
            output,
        )
        .map_err(crate::operation::publish_version::PublishVersionError::unhandled)?;
...
> {
    ...
    crate::protocol_serde::shape_publish_version_input::ser_publish_version_input_input(
        &mut object,
        input,
    )?;
    object.finish();
