...
impl super::Client {
    ...
    pub fn describe_continuous_backups(
        &self,
    ) -> crate::operation::describe_continuous_backups::builders::DescribeContinuousBackupsFluentBuilder {
        crate::operation::describe_continuous_backups::builders::DescribeContinuousBackupsFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
