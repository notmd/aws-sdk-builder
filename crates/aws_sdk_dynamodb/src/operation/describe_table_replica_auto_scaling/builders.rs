...
impl DescribeTableReplicaAutoScalingFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::describe_table_replica_auto_scaling::builders::DescribeTableReplicaAutoScalingInputBuilder
    {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::describe_table_replica_auto_scaling::DescribeTableReplicaAutoScaling::orchestrate(
            &runtime_plugins,
            input,
        )
        .await
