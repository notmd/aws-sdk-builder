                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "S3BucketSource" => {
                                builder = builder.set_s3_bucket_source(
                                    crate::protocol_serde::shape_s3_bucket_source::de_s3_bucket_source(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
                            ...
                            "InputFormatOptions" => {
                                builder = builder.set_input_format_options(
                                    crate::protocol_serde::shape_input_format_options::de_input_format_options(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
                            ...
                            "InputCompressionType" => {
                                builder = builder.set_input_compression_type(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                        .map(|s| {
                                            s.to_unescaped()
                                                .map(|u| crate::types::InputCompressionType::from(u.as_ref()))
                                        })
                                        .transpose()?,
                                );
                            }
