...
> {
    ...
    Err(match error_code {
        ...
        "InvalidEndpointException" => {
            crate::operation::create_backup::CreateBackupError::InvalidEndpointException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TableNotFoundException" => crate::operation::create_backup::CreateBackupError::TableNotFoundException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_table_not_found_exception::de_table_not_found_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::create_backup::CreateBackupError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "BackupDetails" => {
                    builder = builder.set_backup_details(
                        crate::protocol_serde::shape_backup_details::de_backup_details(tokens, _value, depth + 1)?,
                    );
                }
