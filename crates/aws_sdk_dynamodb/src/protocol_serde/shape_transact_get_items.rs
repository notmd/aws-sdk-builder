...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::transact_get_items::TransactGetItemsError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "InvalidEndpointException" => {
            crate::operation::transact_get_items::TransactGetItemsError::InvalidEndpointException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            crate::operation::transact_get_items::TransactGetItemsError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TransactionCanceledException" => {
            crate::operation::transact_get_items::TransactGetItemsError::TransactionCanceledException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
