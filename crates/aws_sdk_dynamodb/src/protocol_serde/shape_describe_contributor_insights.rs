...
> {
    ...
    Err(match error_code {
        "InternalServerError" => {
            crate::operation::describe_contributor_insights::DescribeContributorInsightsError::InternalServerError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    ...
                    .map_err(
                        crate::operation::describe_contributor_insights::DescribeContributorInsightsError::unhandled,
                    )?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_contributor_insights::de_describe_contributor_insights(
            _response_body,
            output,
        )
        .map_err(crate::operation::describe_contributor_insights::DescribeContributorInsightsError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_describe_contributor_insights_input::ser_describe_contributor_insights_input_input(
        &mut object,
        input,
    )?;
    object.finish();
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                match key.to_unescaped()?.as_ref() {
                    ...
                    "ContributorInsightsRuleList" => {
                        ...
                        crate::protocol_serde::shape_contributor_insights_rule_list::de_contributor_insights_rule_list(tokens, _value, depth + 1)?,
                    );
                    }
                    "ContributorInsightsStatus" => {
                        builder = builder.set_contributor_insights_status(
                            ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                .map(|s| {
                                    s.to_unescaped()
                                        .map(|u| crate::types::ContributorInsightsStatus::from(u.as_ref()))
                                })
                                .transpose()?,
                        );
                    }
                    ...
                    "FailureException" => {
                        builder = builder.set_failure_exception(
                            crate::protocol_serde::shape_failure_exception::de_failure_exception(
                                tokens,
                                _value,
                                depth + 1,
                            )?,
                    ...
                    "ContributorInsightsMode" => {
                        builder = builder.set_contributor_insights_mode(
                            ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                .map(|s| {
                                    s.to_unescaped()
                                        .map(|u| crate::types::ContributorInsightsMode::from(u.as_ref()))
                                })
                                .transpose()?,
                        );
                    }
