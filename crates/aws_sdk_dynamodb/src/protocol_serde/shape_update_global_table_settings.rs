...
> {
    ...
    Err(match error_code {
        ...
        "IndexNotFoundException" => {
            crate::operation::update_global_table_settings::UpdateGlobalTableSettingsError::IndexNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::IndexNotFoundExceptionBuilder::default();
                    output =
                        crate::protocol_serde::shape_index_not_found_exception::de_index_not_found_exception_json_err(
                            _response_body,
                            output,
                        )
                        .map_err(
                            crate::operation::update_global_table_settings::UpdateGlobalTableSettingsError::unhandled,
                        )?;
                    let output = output.meta(generic);
                    output.build()
                };
        ...
        "InternalServerError" => {
            crate::operation::update_global_table_settings::UpdateGlobalTableSettingsError::InternalServerError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "LimitExceededException" => {
            crate::operation::update_global_table_settings::UpdateGlobalTableSettingsError::LimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceInUseException" => {
            crate::operation::update_global_table_settings::UpdateGlobalTableSettingsError::ResourceInUseException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_update_global_table_settings::de_update_global_table_settings(
            _response_body,
            output,
        )
        .map_err(crate::operation::update_global_table_settings::UpdateGlobalTableSettingsError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_update_global_table_settings_input::ser_update_global_table_settings_input_input(
        &mut object,
        input,
    )?;
    object.finish();
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "ReplicaSettings" => {
                    builder = builder.set_replica_settings(
                        crate::protocol_serde::shape_replica_settings_description_list::de_replica_settings_description_list(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
