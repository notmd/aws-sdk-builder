    ...
    Err(match error_code {
        "ImportConflictException" => crate::operation::import_table::ImportTableError::ImportConflictException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_import_conflict_exception::de_import_conflict_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::import_table::ImportTableError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ImportTableDescription" => {
                    builder = builder.set_import_table_description(
                        crate::protocol_serde::shape_import_table_description::de_import_table_description(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
