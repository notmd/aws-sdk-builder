        ...
        "TableNotFoundException" => {
            crate::operation::describe_continuous_backups::DescribeContinuousBackupsError::TableNotFoundException({
                ...
                let mut tmp = {
                    ...
                    output =
                        crate::protocol_serde::shape_table_not_found_exception::de_table_not_found_exception_json_err(
                            _response_body,
                            output,
                        )
                        .map_err(
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_continuous_backups::de_describe_continuous_backups(
            _response_body,
            output,
        )
        .map_err(crate::operation::describe_continuous_backups::DescribeContinuousBackupsError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_describe_continuous_backups_input::ser_describe_continuous_backups_input_input(
        &mut object,
        input,
    )?;
    object.finish();
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                match key.to_unescaped()?.as_ref() {
                    "ContinuousBackupsDescription" => {
                        ...
                        crate::protocol_serde::shape_continuous_backups_description::de_continuous_backups_description(tokens, _value, depth + 1)?,
                    );
                    }
