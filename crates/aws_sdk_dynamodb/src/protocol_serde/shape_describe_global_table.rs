...
> {
    ...
    Err(match error_code {
        "GlobalTableNotFoundException" => {
            crate::operation::describe_global_table::DescribeGlobalTableError::GlobalTableNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InternalServerError" => {
            crate::operation::describe_global_table::DescribeGlobalTableError::InternalServerError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidEndpointException" => {
            crate::operation::describe_global_table::DescribeGlobalTableError::InvalidEndpointException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_describe_global_table_input::ser_describe_global_table_input_input(
        &mut object,
        input,
    )?;
    object.finish();
