...
> {
    ...
    Err(match error_code {
        "InternalServerError" => {
            crate::operation::update_contributor_insights::UpdateContributorInsightsError::InternalServerError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    ...
                    .map_err(
                        crate::operation::update_contributor_insights::UpdateContributorInsightsError::unhandled,
                    )?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_update_contributor_insights::de_update_contributor_insights(
            _response_body,
            output,
        )
        .map_err(crate::operation::update_contributor_insights::UpdateContributorInsightsError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_update_contributor_insights_input::ser_update_contributor_insights_input_input(
        &mut object,
        input,
    )?;
    object.finish();
