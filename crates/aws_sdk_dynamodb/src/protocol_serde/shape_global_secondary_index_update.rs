...
pub fn ser_global_secondary_index_update(
    ...
    if let Some(var_1) = &input.update {
        ...
        crate::protocol_serde::shape_update_global_secondary_index_action::ser_update_global_secondary_index_action(
            &mut object_2,
            var_1,
        )?;
        object_2.finish();
    ...
    if let Some(var_3) = &input.create {
        ...
        crate::protocol_serde::shape_create_global_secondary_index_action::ser_create_global_secondary_index_action(
            &mut object_4,
            var_3,
        )?;
        object_4.finish();
    ...
    if let Some(var_5) = &input.delete {
        ...
        crate::protocol_serde::shape_delete_global_secondary_index_action::ser_delete_global_secondary_index_action(
            &mut object_6,
            var_5,
        )?;
        object_6.finish();
