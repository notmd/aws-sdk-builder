...
> {
    ...
    Err(match error_code {
        "InternalServerError" => {
            crate::operation::describe_time_to_live::DescribeTimeToLiveError::InternalServerError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidEndpointException" => {
            crate::operation::describe_time_to_live::DescribeTimeToLiveError::InvalidEndpointException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            crate::operation::describe_time_to_live::DescribeTimeToLiveError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_describe_time_to_live_input::ser_describe_time_to_live_input_input(
        &mut object,
        input,
    )?;
    object.finish();
