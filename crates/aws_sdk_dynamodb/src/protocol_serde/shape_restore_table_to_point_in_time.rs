...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_restore_table_to_point_in_time::de_restore_table_to_point_in_time(
            _response_body,
            output,
        )
        .map_err(crate::operation::restore_table_to_point_in_time::RestoreTableToPointInTimeError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_restore_table_to_point_in_time_input::ser_restore_table_to_point_in_time_input_input(
        &mut object,
        input,
    )?;
    object.finish();
