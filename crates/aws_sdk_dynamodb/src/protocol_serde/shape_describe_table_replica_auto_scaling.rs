...
> {
    ...
    let mut generic_builder =
        crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(
            crate::operation::describe_table_replica_auto_scaling::DescribeTableReplicaAutoScalingError::unhandled,
        )?;
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_describe_table_replica_auto_scaling::de_describe_table_replica_auto_scaling(
                _response_body,
                output,
            )
            .map_err(
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                match key.to_unescaped()?.as_ref() {
                    "TableAutoScalingDescription" => {
                        ...
                        crate::protocol_serde::shape_table_auto_scaling_description::de_table_auto_scaling_description(tokens, _value, depth + 1)?,
                    );
                    }
