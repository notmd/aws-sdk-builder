...
> {
    ...
    Err(match error_code {
        ...
        "InvalidEndpointException" => {
            crate::operation::create_global_table::CreateGlobalTableError::InvalidEndpointException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "LimitExceededException" => {
            crate::operation::create_global_table::CreateGlobalTableError::LimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TableNotFoundException" => {
            crate::operation::create_global_table::CreateGlobalTableError::TableNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
