...
> {
    ...
    Err(match error_code {
        "InternalServerError" => {
            crate::operation::list_tags_of_resource::ListTagsOfResourceError::InternalServerError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidEndpointException" => {
            crate::operation::list_tags_of_resource::ListTagsOfResourceError::InvalidEndpointException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            crate::operation::list_tags_of_resource::ListTagsOfResourceError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_list_tags_of_resource_input::ser_list_tags_of_resource_input_input(
        &mut object,
        input,
    )?;
    object.finish();
