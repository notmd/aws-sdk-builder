...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_global_table_settings::de_describe_global_table_settings(
            _response_body,
            output,
        )
        .map_err(crate::operation::describe_global_table_settings::DescribeGlobalTableSettingsError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_describe_global_table_settings_input::ser_describe_global_table_settings_input_input(
        &mut object,
        input,
    )?;
    object.finish();
