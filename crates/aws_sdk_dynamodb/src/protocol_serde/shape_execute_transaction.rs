...
> {
    ...
    Err(match error_code {
        ...
        "RequestLimitExceeded" => {
            crate::operation::execute_transaction::ExecuteTransactionError::RequestLimitExceeded({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            crate::operation::execute_transaction::ExecuteTransactionError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TransactionCanceledException" => {
            crate::operation::execute_transaction::ExecuteTransactionError::TransactionCanceledException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TransactionInProgressException" => {
            crate::operation::execute_transaction::ExecuteTransactionError::TransactionInProgressException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "Responses" => {
                    builder =
                        builder.set_responses(crate::protocol_serde::shape_item_response_list::de_item_response_list(
                            tokens,
                            _value,
                            depth + 1,
                        )?);
