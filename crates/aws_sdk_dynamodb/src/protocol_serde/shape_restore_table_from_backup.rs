...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::restore_table_from_backup::RestoreTableFromBackupError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "BackupInUseException" => {
            crate::operation::restore_table_from_backup::RestoreTableFromBackupError::BackupInUseException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::BackupInUseExceptionBuilder::default();
                    output = crate::protocol_serde::shape_backup_in_use_exception::de_backup_in_use_exception_json_err(
                        _response_body,
                        output,
                    )
                    .map_err(crate::operation::restore_table_from_backup::RestoreTableFromBackupError::unhandled)?;
        ...
        "InternalServerError" => {
            crate::operation::restore_table_from_backup::RestoreTableFromBackupError::InternalServerError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "LimitExceededException" => {
            crate::operation::restore_table_from_backup::RestoreTableFromBackupError::LimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TableInUseException" => {
            crate::operation::restore_table_from_backup::RestoreTableFromBackupError::TableInUseException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::TableInUseExceptionBuilder::default();
                    output = crate::protocol_serde::shape_table_in_use_exception::de_table_in_use_exception_json_err(
                        _response_body,
                        output,
                    )
                    .map_err(crate::operation::restore_table_from_backup::RestoreTableFromBackupError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_restore_table_from_backup::de_restore_table_from_backup(
            _response_body,
            output,
        )
        .map_err(crate::operation::restore_table_from_backup::RestoreTableFromBackupError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_restore_table_from_backup_input::ser_restore_table_from_backup_input_input(
        &mut object,
        input,
    )?;
    object.finish();
