...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::list_contributor_insights::ListContributorInsightsError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "InternalServerError" => {
            crate::operation::list_contributor_insights::ListContributorInsightsError::InternalServerError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_contributor_insights::de_list_contributor_insights(
            _response_body,
            output,
        )
        .map_err(crate::operation::list_contributor_insights::ListContributorInsightsError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_list_contributor_insights_input::ser_list_contributor_insights_input_input(
        &mut object,
        input,
    )?;
    object.finish();
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                match key.to_unescaped()?.as_ref() {
                    "ContributorInsightsSummaries" => {
                        ...
                        crate::protocol_serde::shape_contributor_insights_summaries::de_contributor_insights_summaries(tokens, _value, depth + 1)?,
                    );
                    }
                    "NextToken" => {
