...
> {
    ...
    Err(match error_code {
        ...
        "InvalidEndpointException" => {
            crate::operation::batch_get_item::BatchGetItemError::InvalidEndpointException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            crate::operation::batch_get_item::BatchGetItemError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "Responses" => {
                    builder = builder.set_responses(
                        crate::protocol_serde::shape_batch_get_response_map::de_batch_get_response_map(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
                ...
                "UnprocessedKeys" => {
                    builder = builder.set_unprocessed_keys(
                        crate::protocol_serde::shape_batch_get_request_map::de_batch_get_request_map(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
