...
> {
    ...
    Err(match error_code {
        "GlobalTableNotFoundException" => {
            crate::operation::update_global_table::UpdateGlobalTableError::GlobalTableNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidEndpointException" => {
            crate::operation::update_global_table::UpdateGlobalTableError::InvalidEndpointException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ReplicaAlreadyExistsException" => {
            crate::operation::update_global_table::UpdateGlobalTableError::ReplicaAlreadyExistsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ReplicaNotFoundException" => {
            crate::operation::update_global_table::UpdateGlobalTableError::ReplicaNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TableNotFoundException" => {
            crate::operation::update_global_table::UpdateGlobalTableError::TableNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "GlobalTableDescription" => {
                    builder = builder.set_global_table_description(
                        crate::protocol_serde::shape_global_table_description::de_global_table_description(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
