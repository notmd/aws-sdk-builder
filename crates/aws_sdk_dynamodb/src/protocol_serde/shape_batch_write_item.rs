...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::batch_write_item::BatchWriteItemError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "InvalidEndpointException" => {
            crate::operation::batch_write_item::BatchWriteItemError::InvalidEndpointException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ReplicatedWriteConflictException" => {
            crate::operation::batch_write_item::BatchWriteItemError::ReplicatedWriteConflictException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            crate::operation::batch_write_item::BatchWriteItemError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "UnprocessedItems" => {
                    builder = builder.set_unprocessed_items(
                        crate::protocol_serde::shape_batch_write_item_request_map::de_batch_write_item_request_map(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
