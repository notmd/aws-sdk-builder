...
> {
    ...
    Err(match error_code {
        "InternalServerError" => {
            crate::operation::batch_execute_statement::BatchExecuteStatementError::InternalServerError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "RequestLimitExceeded" => {
            crate::operation::batch_execute_statement::BatchExecuteStatementError::RequestLimitExceeded({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ThrottlingException" => {
            crate::operation::batch_execute_statement::BatchExecuteStatementError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_batch_execute_statement::de_batch_execute_statement(_response_body, output)
                .map_err(crate::operation::batch_execute_statement::BatchExecuteStatementError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_batch_execute_statement_input::ser_batch_execute_statement_input_input(
        &mut object,
        input,
    )?;
    object.finish();
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "Responses" => {
                    builder = builder.set_responses(
                        crate::protocol_serde::shape_parti_ql_batch_response::de_parti_ql_batch_response(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
