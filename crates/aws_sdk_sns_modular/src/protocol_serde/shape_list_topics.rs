...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::list_topics::ListTopicsError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "AuthorizationError" => {
            crate::operation::list_topics::ListTopicsError::AuthorizationErrorException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InternalError" => {
            crate::operation::list_topics::ListTopicsError::InternalErrorException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
