...
//!
//! ```rust,no_run
//! use aws_sdk_sns_modular as sns;
//!
//! #[::tokio::main]
//! async fn main() -> Result<(), sns::Error> {
//!     let config = aws_config::load_from_env().await;
//!     let client = aws_sdk_sns_modular::Client::new(&config);
//!
...
//! ```
//!
//! See the [client documentation](https://docs.rs/aws-sdk-sns/latest/aws_sdk_sns_modular/client/struct.Client.html)
...
/// let config = aws_sdk_sns_modular::config::Builder::from(&sdk_config)
/// # /*
