...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateTopic {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::orchestrator::Metadata::new("CreateTopic", "SNS"),
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for CreateTopicTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateTopicInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for CreateTopicResponseDeserializer
{
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateTopicRequestSerializer {
    ...
    > {
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_topic_input::ser_create_topic_input_input_input(
                &input,
            )?,
        );
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for CreateTopicEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "CreateTopicEndpointParamsInterceptor"
    }
...
impl CreateTopicError {
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::TagLimitExceededException(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            }
            Self::TagPolicyException(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            }
            Self::TopicLimitExceededException(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            }
