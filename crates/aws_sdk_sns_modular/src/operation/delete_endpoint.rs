...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteEndpoint {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::orchestrator::Metadata::new("DeleteEndpoint", "SNS"),
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for DeleteEndpointTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) =
            context.input().downcast_ref::<DeleteEndpointInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for DeleteEndpointRequestSerializer
{
    #[allow(
        unused_mut,
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for DeleteEndpointEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "DeleteEndpointEndpointParamsInterceptor"
    }
