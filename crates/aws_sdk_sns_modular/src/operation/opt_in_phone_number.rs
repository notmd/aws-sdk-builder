...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for OptInPhoneNumberResponseDeserializer
{
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_opt_in_phone_number::de_opt_in_phone_number_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for OptInPhoneNumberRequestSerializer
{
    #[allow(
        unused_mut,
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for OptInPhoneNumberEndpointParamsInterceptor
{
...
impl ::aws_types::request_id::RequestId
    for crate::operation::opt_in_phone_number::OptInPhoneNumberError
{
