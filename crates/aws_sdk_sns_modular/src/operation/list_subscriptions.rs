...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for ListSubscriptionsTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) =
            context.input().downcast_ref::<ListSubscriptionsInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for ListSubscriptionsResponseDeserializer
{
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_subscriptions::de_list_subscriptions_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_subscriptions::de_list_subscriptions_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for ListSubscriptionsRequestSerializer
{
    #[allow(
        unused_mut,
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for ListSubscriptionsEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "ListSubscriptionsEndpointParamsInterceptor"
    }
...
impl ::aws_types::request_id::RequestId
    for crate::operation::list_subscriptions::ListSubscriptionsError
{
