...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for Subscribe {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::orchestrator::Metadata::new("Subscribe", "SNS"),
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for SubscribeTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<SubscribeInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for SubscribeResponseDeserializer
{
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for SubscribeEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "SubscribeEndpointParamsInterceptor"
    }
