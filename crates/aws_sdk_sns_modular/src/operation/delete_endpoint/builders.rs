...
impl DeleteEndpointFluentBuilder {
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::delete_endpoint::DeleteEndpoint::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        crate::operation::delete_endpoint::DeleteEndpoint::orchestrate(&runtime_plugins, input)
            .await
    }
