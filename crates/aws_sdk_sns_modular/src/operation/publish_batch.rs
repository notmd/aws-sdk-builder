...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PublishBatch {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::orchestrator::Metadata::new("PublishBatch", "SNS"),
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for PublishBatchTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) =
            context.input().downcast_ref::<PublishBatchInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for PublishBatchResponseDeserializer
{
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_publish_batch::de_publish_batch_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PublishBatchRequestSerializer {
    ...
    > {
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_publish_batch_input::ser_publish_batch_input_input_input(
                &input,
            )?,
        );
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for PublishBatchEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "PublishBatchEndpointParamsInterceptor"
    }
...
impl PublishBatchError {
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::BatchRequestTooLongException(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            }
            Self::EmptyBatchRequestException(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            }
            Self::EndpointDisabledException(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            }
            Self::InternalErrorException(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            }
            Self::InvalidBatchEntryIdException(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            }
            ...
            Self::InvalidSecurityException(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            }
            ...
            Self::KmsOptInRequired(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            }
            Self::KmsThrottlingException(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            }
