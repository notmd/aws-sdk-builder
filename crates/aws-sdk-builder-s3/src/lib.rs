//! Build-time model provider for s3 AWS service.
...
pub const METADATA: aws_sdk_builder::ServiceMetadata = aws_sdk_builder::ServiceMetadata {
    key: "s3",
    service_shape_id: "com.amazonaws.s3#AmazonS3",
    filename: "model.json",
    crate_name: "aws-sdk-s3",
    module_name: "aws_sdk_s3",
    sdk_version: Some("1.143.0"),
    model_sha256: "85e30a81b268de1b569bc1611a77fac7422198402f616149164a900285eb44e7",
};
