...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for ListPackageVersionsTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) =
            context.input().downcast_ref::<ListPackageVersionsInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for ListPackageVersionsResponseDeserializer
{
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            ...
            crate::protocol_serde::shape_list_package_versions::de_list_package_versions_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for ListPackageVersionsRequestSerializer
{
    #[allow(
        unused_mut,
                ...
                if let ::std::option::Option::Some(inner_7) = &_input.status {
                    {
                        query.push_kv(
                            "status",
                            &::aws_smithy_http::query::fmt_string(inner_7.as_str()),
                        );
                    }
                }
                if let ::std::option::Option::Some(inner_8) = &_input.sort_by {
                    {
                        query.push_kv(
                            "sortBy",
                            &::aws_smithy_http::query::fmt_string(inner_8.as_str()),
                        );
                    }
                }
                ...
                if let ::std::option::Option::Some(inner_11) = &_input.origin_type {
                    {
                        query.push_kv(
                            "originType",
                            &::aws_smithy_http::query::fmt_string(inner_11.as_str()),
                        );
                    }
                }
                ::std::result::Result::Ok(())
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for ListPackageVersionsEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "ListPackageVersionsEndpointParamsInterceptor"
    }
...
impl ::aws_types::request_id::RequestId
    for crate::operation::list_package_versions::ListPackageVersionsError
{
