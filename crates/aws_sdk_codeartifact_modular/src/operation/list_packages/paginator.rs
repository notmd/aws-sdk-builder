...
pub struct ListPackagesPaginator {
    ...
    builder: crate::operation::list_packages::builders::ListPackagesInputBuilder,
...
impl ListPackagesPaginator {
    ...
    pub fn items(self) -> crate::operation::list_packages::paginator::ListPackagesPaginatorItems {
        crate::operation::list_packages::paginator::ListPackagesPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_packages::ListPackages::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_packages_output_output_next_token(resp);
...
impl ListPackagesPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_packages_output_output_packages(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
