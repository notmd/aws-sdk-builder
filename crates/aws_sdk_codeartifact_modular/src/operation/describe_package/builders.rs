...
impl DescribePackageFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::describe_package::builders::DescribePackageInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::describe_package::DescribePackage::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        crate::operation::describe_package::DescribePackage::orchestrate(&runtime_plugins, input)
            .await
    }
