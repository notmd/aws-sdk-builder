...
impl super::Client {
    ...
    ///   - [`use_case_description(impl Into<String>)`](crate::operation::put_account_details::builders::PutAccountDetailsFluentBuilder::use_case_description) / [`set_use_case_description(Option<String>)`](crate::operation::put_account_details::builders::PutAccountDetailsFluentBuilder::set_use_case_description):<br>required: **false**<br><p>A description of the types of email that you plan to send.</p><br>
