...
> {
    ...
    Err(match error_code {
        "BadRequestException" => crate::operation::get_message_insights::GetMessageInsightsError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => crate::operation::get_message_insights::GetMessageInsightsError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
