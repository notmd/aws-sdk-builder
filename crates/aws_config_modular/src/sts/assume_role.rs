...
use aws_sdk_sts_modular::operation::assume_role::builders::AssumeRoleFluentBuilder;
use aws_sdk_sts_modular::operation::assume_role::AssumeRoleError;
use aws_sdk_sts_modular::types::{PolicyDescriptorType, Tag};
use aws_sdk_sts_modular::Client as StsClient;
...
/// ```no_run
/// use aws_config_modular::sts::AssumeRoleProvider;
/// use aws_types::region::Region;
/// # async fn docs() {
...
/// use aws_types::region::Region;
/// # async fn docs() {
/// let conf = aws_config_modular::from_env().use_fips(true).load().await;
/// let provider = AssumeRoleProvider::builder("arn:aws:iam::123456789012:role/demo")
///   .configure(&conf)
///   .session_name("testAR")
///   .build().await;
...
/// use aws_config_modular::sts::AssumeRoleProvider;
/// use aws_types::region::Region;
/// use aws_config_modular::environment::EnvironmentVariableCredentialsProvider;
/// # async fn docs() {
/// let provider = AssumeRoleProvider::builder("arn:aws:iam::123456789012:role/demo")
...
impl AssumeRoleProviderBuilder {
    ...
    /// [policy](aws_sdk_sts_modular::operation::assume_role::builders::AssumeRoleInputBuilder::policy_arns)
    ...
    /// This parameter is optional.
    /// For more information, see
    /// [policy_arns](aws_sdk_sts_modular::operation::assume_role::builders::AssumeRoleInputBuilder::policy_arns)
    ...
    ///
    /// For more information, see
    /// [duration_seconds](aws_sdk_sts_modular::operation::assume_role::builders::AssumeRoleInputBuilder::duration_seconds)
    ...
    /// use aws_types::region::Region;
    /// use aws_config_modular::sts::AssumeRoleProvider;
    /// let config = aws_config_modular::from_env().region(Region::from_static("us-west-2")).load().await;
    ...
    /// from [`aws_config_modular::from_env`](crate::from_env) if `configure` was never called.
    pub async fn build(self) -> AssumeRoleProvider {
        ...
        let config = aws_sdk_sts_modular::config::Builder::from(&conf);
