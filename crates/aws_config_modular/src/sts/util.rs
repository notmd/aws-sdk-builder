...
use aws_sdk_sts_modular::types::{AssumedRoleUser, Credentials as StsCredentials};
...
// `Arn` is `pub(crate)` within generated SDKs, making it inaccessible from `aws-config-modular`.
