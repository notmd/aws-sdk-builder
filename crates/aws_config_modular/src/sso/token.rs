...
use aws_sdk_ssooidc_modular::error::DisplayErrorContext;
use aws_sdk_ssooidc_modular::operation::create_token::CreateTokenOutput;
use aws_sdk_ssooidc_modular::Client as SsoOidcClient;
...
mod tests {
    use super::*;
    use aws_sdk_sso_modular::config::{AsyncSleep, SharedAsyncSleep};
