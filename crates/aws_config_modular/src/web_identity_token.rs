...
//! ```no_run
//! # async fn test() {
//! use aws_config_modular::web_identity_token::WebIdentityTokenCredentialsProvider;
//! use aws_config_modular::provider_config::ProviderConfig;
...
use aws_sdk_sts_modular::{types::PolicyDescriptorType, Client as StsClient};
