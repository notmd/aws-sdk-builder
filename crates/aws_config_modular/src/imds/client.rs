...
/// ```no_run
/// use aws_config_modular::imds::client::Client;
/// # async fn docs() {
...
/// ```no_run
/// use aws_config_modular::imds::client::{Client, EndpointMode};
/// # async fn docs() {
...
impl Builder {
    ...
    /// ```no_run
    /// # async fn test() {
    /// use aws_config_modular::imds::Client;
        ...
        let operation = Operation::builder()
            ...
            .runtime_plugin(
                MetricsRuntimePlugin::builder()
                    .with_scope("aws_config_modular::imds_credentials")
