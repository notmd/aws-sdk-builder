...
use aws_sdk_signin_modular::config::Builder as SignInClientConfigBuilder;
use aws_sdk_signin_modular::operation::create_o_auth2_token::CreateOAuth2TokenError;
use aws_sdk_signin_modular::types::{CreateOAuth2TokenRequestBody, OAuth2ErrorCode};
use aws_sdk_signin_modular::Client as SignInClient;
...
mod test {
    ...
    use crate::provider_config::ProviderConfig;
    use aws_credential_types::provider::ProvideCredentials;
    use aws_sdk_signin_modular::config::RuntimeComponents;
    ...
    #[tokio::test]
    #[ignore = "upstream fixture data is intentionally omitted from aws-config-modular"]
