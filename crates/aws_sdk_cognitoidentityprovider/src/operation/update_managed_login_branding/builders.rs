...
impl UpdateManagedLoginBrandingFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::update_managed_login_branding::builders::UpdateManagedLoginBrandingInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::update_managed_login_branding::UpdateManagedLoginBranding::operation_runtime_plugins(
