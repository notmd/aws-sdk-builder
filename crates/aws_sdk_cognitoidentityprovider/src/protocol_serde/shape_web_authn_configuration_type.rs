...
pub(crate) fn de_web_authn_configuration_type<'a, I>(
    ...
    Option<crate::types::WebAuthnConfigurationType>,
                            ...
                            "UserVerification" => {
                                builder = builder.set_user_verification(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                        .map(|s| {
                                            s.to_unescaped()
                                                .map(|u| crate::types::UserVerificationType::from(u.as_ref()))
                                        })
                                        .transpose()?,
                                );
                            }
                                    ...
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                        .map(|s| {
                                            s.to_unescaped().map(|u| {
                                                crate::types::WebAuthnFactorConfigurationType::from(u.as_ref())
                                            })
                                        })
                                        .transpose()?,
                                );
