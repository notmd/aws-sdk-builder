...
> {
    ...
    let mut generic_builder =
        crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
            .map_err(crate::operation::set_user_settings::SetUserSettingsError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::set_user_settings::SetUserSettingsError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "InternalErrorException" => {
            crate::operation::set_user_settings::SetUserSettingsError::InternalErrorException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidParameterException" => {
            crate::operation::set_user_settings::SetUserSettingsError::InvalidParameterException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NotAuthorizedException" => {
            crate::operation::set_user_settings::SetUserSettingsError::NotAuthorizedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "OperationNotEnabledException" => {
            crate::operation::set_user_settings::SetUserSettingsError::OperationNotEnabledException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "PasswordResetRequiredException" => {
            crate::operation::set_user_settings::SetUserSettingsError::PasswordResetRequiredException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            crate::operation::set_user_settings::SetUserSettingsError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "UserNotConfirmedException" => {
            crate::operation::set_user_settings::SetUserSettingsError::UserNotConfirmedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_set_user_settings_input::ser_set_user_settings_input_input(&mut object, input)?;
    object.finish();
