...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_set_user_pool_mfa_config::de_set_user_pool_mfa_config(_response_body, output)
                .map_err(crate::operation::set_user_pool_mfa_config::SetUserPoolMfaConfigError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_set_user_pool_mfa_config_input::ser_set_user_pool_mfa_config_input_input(
        &mut object,
        input,
    )?;
    object.finish();
