...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::list_user_pool_clients::ListUserPoolClientsError::unhandled(
                    generic,
                ),
            )
        }
    ...
    Err(match error_code {
        "InternalErrorException" => crate::operation::list_user_pool_clients::ListUserPoolClientsError::InternalErrorException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidParameterException" => crate::operation::list_user_pool_clients::ListUserPoolClientsError::InvalidParameterException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotAuthorizedException" => crate::operation::list_user_pool_clients::ListUserPoolClientsError::NotAuthorizedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => crate::operation::list_user_pool_clients::ListUserPoolClientsError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_user_pool_clients::builders::ListUserPoolClientsOutputBuilder::default();
        output = crate::protocol_serde::shape_list_user_pool_clients::de_list_user_pool_clients(
            _response_body,
            output,
        )
        .map_err(crate::operation::list_user_pool_clients::ListUserPoolClientsError::unhandled)?;
...
> {
    ...
    crate::protocol_serde::shape_list_user_pool_clients_input::ser_list_user_pool_clients_input_input(&mut object, input)?;
    object.finish();
