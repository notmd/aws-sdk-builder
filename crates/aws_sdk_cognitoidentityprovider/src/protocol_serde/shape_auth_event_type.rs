                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "EventResponse" => {
                                builder = builder.set_event_response(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                        .map(|s| {
                                            s.to_unescaped()
                                                .map(|u| crate::types::EventResponseType::from(u.as_ref()))
                                        })
                                        .transpose()?,
                                );
                            }
                            "EventRisk" => {
                                builder = builder.set_event_risk(
                                    crate::protocol_serde::shape_event_risk_type::de_event_risk_type(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
                            ...
                            "EventContextData" => {
                                builder = builder.set_event_context_data(
                                    crate::protocol_serde::shape_event_context_data_type::de_event_context_data_type(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
                            ...
                            "EventFeedback" => {
                                builder = builder.set_event_feedback(
                                    crate::protocol_serde::shape_event_feedback_type::de_event_feedback_type(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
