...
> {
    ...
    Err(match error_code {
        "InternalErrorException" => {
            crate::operation::delete_resource_server::DeleteResourceServerError::InternalErrorException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidParameterException" => {
            crate::operation::delete_resource_server::DeleteResourceServerError::InvalidParameterException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NotAuthorizedException" => {
            crate::operation::delete_resource_server::DeleteResourceServerError::NotAuthorizedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            crate::operation::delete_resource_server::DeleteResourceServerError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => {
            crate::operation::delete_resource_server::DeleteResourceServerError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_delete_resource_server_input::ser_delete_resource_server_input_input(
        &mut object,
        input,
    )?;
    object.finish();
