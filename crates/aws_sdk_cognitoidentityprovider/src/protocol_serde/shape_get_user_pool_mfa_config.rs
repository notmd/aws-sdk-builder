...
> {
    ...
    Err(match error_code {
        "InternalErrorException" => {
            crate::operation::get_user_pool_mfa_config::GetUserPoolMfaConfigError::InternalErrorException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidParameterException" => {
            crate::operation::get_user_pool_mfa_config::GetUserPoolMfaConfigError::InvalidParameterException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NotAuthorizedException" => {
            crate::operation::get_user_pool_mfa_config::GetUserPoolMfaConfigError::NotAuthorizedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            crate::operation::get_user_pool_mfa_config::GetUserPoolMfaConfigError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => {
            crate::operation::get_user_pool_mfa_config::GetUserPoolMfaConfigError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_get_user_pool_mfa_config::de_get_user_pool_mfa_config(_response_body, output)
                .map_err(crate::operation::get_user_pool_mfa_config::GetUserPoolMfaConfigError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_get_user_pool_mfa_config_input::ser_get_user_pool_mfa_config_input_input(
        &mut object,
        input,
    )?;
    object.finish();
                ...
                match key.to_unescaped()?.as_ref() {
                    "SmsMfaConfiguration" => {
                        builder = builder.set_sms_mfa_configuration(
                            crate::protocol_serde::shape_sms_mfa_config_type::de_sms_mfa_config_type(
                                tokens,
                                _value,
                                depth + 1,
                            )?,
                    ...
                    "EmailMfaConfiguration" => {
                        builder = builder.set_email_mfa_configuration(
                            crate::protocol_serde::shape_email_mfa_config_type::de_email_mfa_config_type(
                                tokens,
                                _value,
                                depth + 1,
                            )?,
                    ...
                    "WebAuthnConfiguration" => {
                        builder = builder.set_web_authn_configuration(
                            crate::protocol_serde::shape_web_authn_configuration_type::de_web_authn_configuration_type(
                                tokens,
                                _value,
                                depth + 1,
                            )?,
