...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::list_web_authn_credentials::ListWebAuthnCredentialsError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "ForbiddenException" => {
            crate::operation::list_web_authn_credentials::ListWebAuthnCredentialsError::ForbiddenException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InternalErrorException" => {
            crate::operation::list_web_authn_credentials::ListWebAuthnCredentialsError::InternalErrorException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    ...
                    output =
                        ...
                        .map_err(
                            crate::operation::list_web_authn_credentials::ListWebAuthnCredentialsError::unhandled,
                        )?;
                    let output = output.meta(generic);
                    output.build()
                };
        ...
        "InvalidParameterException" => {
            crate::operation::list_web_authn_credentials::ListWebAuthnCredentialsError::InvalidParameterException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "LimitExceededException" => {
            crate::operation::list_web_authn_credentials::ListWebAuthnCredentialsError::LimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NotAuthorizedException" => {
            crate::operation::list_web_authn_credentials::ListWebAuthnCredentialsError::NotAuthorizedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "OperationNotEnabledException" => {
            crate::operation::list_web_authn_credentials::ListWebAuthnCredentialsError::OperationNotEnabledException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => {
            crate::operation::list_web_authn_credentials::ListWebAuthnCredentialsError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        _ => crate::operation::list_web_authn_credentials::ListWebAuthnCredentialsError::generic(generic),
    })
}
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_web_authn_credentials::de_list_web_authn_credentials(
            _response_body,
            output,
        )
        .map_err(crate::operation::list_web_authn_credentials::ListWebAuthnCredentialsError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::list_web_authn_credentials_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_web_authn_credentials::ListWebAuthnCredentialsError::unhandled)?
    })
}
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_list_web_authn_credentials_input::ser_list_web_authn_credentials_input_input(
        &mut object,
        input,
    )?;
    object.finish();
