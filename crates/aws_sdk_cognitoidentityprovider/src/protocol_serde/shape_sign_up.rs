...
pub fn de_sign_up_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::sign_up::SignUpOutput, crate::operation::sign_up::SignUpError> {
    #[allow(unused_mut)]
    ...
    Err(match error_code {
        ...
        "UsernameExistsException" => crate::operation::sign_up::SignUpError::UsernameExistsException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_username_exists_exception::de_username_exists_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::sign_up::SignUpError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "UserConfirmed" => {
                    builder = builder.set_user_confirmed(::aws_smithy_json::deserialize::token::expect_bool_or_null(
                        tokens.next(),
                    )?);
                }
                "CodeDeliveryDetails" => {
                    builder = builder.set_code_delivery_details(
                        crate::protocol_serde::shape_code_delivery_details_type::de_code_delivery_details_type(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
