...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::resend_confirmation_code::ResendConfirmationCodeError::unhandled(generic))
        }
    };
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_resend_confirmation_code::de_resend_confirmation_code(_response_body, output)
                .map_err(crate::operation::resend_confirmation_code::ResendConfirmationCodeError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_resend_confirmation_code_input::ser_resend_confirmation_code_input_input(
        &mut object,
        input,
    )?;
    object.finish();
