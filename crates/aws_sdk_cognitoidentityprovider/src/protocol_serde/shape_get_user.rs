...
pub fn de_get_user_http_error(
    ...
    Err(match error_code {
        ...
        "OperationNotEnabledException" => crate::operation::get_user::GetUserError::OperationNotEnabledException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "UserAttributes" => {
                    builder = builder.set_user_attributes(
                        crate::protocol_serde::shape_attribute_list_type::de_attribute_list_type(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
                ...
                "MFAOptions" => {
                    builder = builder.set_mfa_options(
                        crate::protocol_serde::shape_mfa_option_list_type::de_mfa_option_list_type(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
