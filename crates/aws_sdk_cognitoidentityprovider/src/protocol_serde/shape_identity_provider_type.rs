...
pub(crate) fn de_identity_provider_type<'a, I>(
    ...
    Option<crate::types::IdentityProviderType>,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "ProviderType" => {
                                builder = builder.set_provider_type(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                        .map(|s| {
                                            s.to_unescaped()
                                                .map(|u| crate::types::IdentityProviderTypeType::from(u.as_ref()))
                                        })
                                        .transpose()?,
                                );
                            }
                            "ProviderDetails" => {
                                builder = builder.set_provider_details(
                                    crate::protocol_serde::shape_provider_details_type::de_provider_details_type(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
                            ...
                            "AttributeMapping" => {
                                builder = builder.set_attribute_mapping(
                                    crate::protocol_serde::shape_attribute_mapping_type::de_attribute_mapping_type(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
