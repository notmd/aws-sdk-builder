...
pub(crate) fn de_domain_description_type<'a, I>(
    ...
    Option<crate::types::DomainDescriptionType>,
                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "Status" => {
                                builder = builder.set_status(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                        .map(|s| {
                                            s.to_unescaped()
                                                .map(|u| crate::types::DomainStatusType::from(u.as_ref()))
                                        })
                                        .transpose()?,
                                );
                            }
                            ...
                            "Routing" => {
                                builder =
                                    builder.set_routing(crate::protocol_serde::shape_routing_type::de_routing_type(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?);
