...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::admin_list_devices::AdminListDevicesError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "InternalErrorException" => {
            crate::operation::admin_list_devices::AdminListDevicesError::InternalErrorException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidParameterException" => {
            crate::operation::admin_list_devices::AdminListDevicesError::InvalidParameterException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidUserPoolConfigurationException" => {
            crate::operation::admin_list_devices::AdminListDevicesError::InvalidUserPoolConfigurationException({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_invalid_user_pool_configuration_exception::de_invalid_user_pool_configuration_exception_json_err(_response_body, output).map_err(crate::operation::admin_list_devices::AdminListDevicesError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        "NotAuthorizedException" => {
            crate::operation::admin_list_devices::AdminListDevicesError::NotAuthorizedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "OperationNotEnabledException" => {
            crate::operation::admin_list_devices::AdminListDevicesError::OperationNotEnabledException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            crate::operation::admin_list_devices::AdminListDevicesError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => {
            crate::operation::admin_list_devices::AdminListDevicesError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::admin_list_devices::builders::AdminListDevicesOutputBuilder::default();
        output = crate::protocol_serde::shape_admin_list_devices::de_admin_list_devices(_response_body, output)
            .map_err(crate::operation::admin_list_devices::AdminListDevicesError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_admin_list_devices_input::ser_admin_list_devices_input_input(&mut object, input)?;
    object.finish();
