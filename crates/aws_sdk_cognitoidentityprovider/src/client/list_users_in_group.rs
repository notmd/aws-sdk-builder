...
impl super::Client {
    ...
    ///   - [`limit(i32)`](crate::operation::list_users_in_group::builders::ListUsersInGroupFluentBuilder::limit) / [`set_limit(Option<i32>)`](crate::operation::list_users_in_group::builders::ListUsersInGroupFluentBuilder::set_limit):<br>required: **false**<br><p>The maximum number of groups that you want Amazon Cognito to return in the response. In some SDK contexts, this operation might return fewer items than you specify in the <code>Limit</code> parameter without having reached the end of the full list. If the response contains a <code>PaginationToken</code>, then there are more results.</p><br>
