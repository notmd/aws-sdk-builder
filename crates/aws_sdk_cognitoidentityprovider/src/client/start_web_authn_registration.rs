...
impl super::Client {
    ...
    pub fn start_web_authn_registration(
        &self,
    ) -> crate::operation::start_web_authn_registration::builders::StartWebAuthnRegistrationFluentBuilder {
        crate::operation::start_web_authn_registration::builders::StartWebAuthnRegistrationFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
