...
impl super::Client {
    ...
    ///   - [`user_pool_id(impl Into<String>)`](crate::operation::create_resource_server::builders::CreateResourceServerFluentBuilder::user_pool_id) / [`set_user_pool_id(Option<String>)`](crate::operation::create_resource_server::builders::CreateResourceServerFluentBuilder::set_user_pool_id):<br>required: **true**<br><p>The ID of the user pool where you want to create a resource server.</p><br>
    ///   - [`identifier(impl Into<String>)`](crate::operation::create_resource_server::builders::CreateResourceServerFluentBuilder::identifier) / [`set_identifier(Option<String>)`](crate::operation::create_resource_server::builders::CreateResourceServerFluentBuilder::set_identifier):<br>required: **true**<br><p>A unique resource server identifier for the resource server. The identifier can be an API friendly name like <code>solar-system-data</code>. You can also set an API URL like <code>https://solar-system-data-api.example.com</code> as your identifier.</p> <p>Amazon Cognito represents scopes in the access token in the format <code>$resource-server-identifier/$scope</code>. Longer scope-identifier strings increase the size of your access tokens.</p><br>
    ...
    ///   - [`resource_server(Option<ResourceServerType>)`](crate::operation::create_resource_server::CreateResourceServerOutput::resource_server): <p>The details of the new resource server.</p>
    ...
    pub fn create_resource_server(
        &self,
    ) -> crate::operation::create_resource_server::builders::CreateResourceServerFluentBuilder {
        crate::operation::create_resource_server::builders::CreateResourceServerFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
