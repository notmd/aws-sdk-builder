    ...
    for UpdateUserAttributesResponseDeserializer
{
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_update_user_attributes::de_update_user_attributes_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_update_user_attributes::de_update_user_attributes_http_response(status, headers, body)
        };
