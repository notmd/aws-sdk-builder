...
> {
    ...
    Err(match error_code {
        ...
        "NotAuthorizedException" => crate::operation::list_tags_for_resource::ListTagsForResourceError::NotAuthorizedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "OperationNotEnabledException" => crate::operation::list_tags_for_resource::ListTagsForResourceError::OperationNotEnabledException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                match key.to_unescaped()?.as_ref() {
                    "Tags" => {
                        builder = builder.set_tags(crate::protocol_serde::shape_user_pool_tags_type::de_user_pool_tags_type(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
