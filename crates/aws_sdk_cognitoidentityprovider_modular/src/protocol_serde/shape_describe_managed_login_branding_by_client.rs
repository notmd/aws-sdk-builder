...
>{
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_managed_login_branding_by_client::DescribeManagedLoginBrandingByClientError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "InternalErrorException" => {
            crate::operation::describe_managed_login_branding_by_client::DescribeManagedLoginBrandingByClientError::InternalErrorException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                ...
                let mut tmp = {
                    ...
                    output =
                        crate::protocol_serde::shape_invalid_parameter_exception::de_invalid_parameter_exception_json_err(_response_body, output)
                            .map_err(
                                crate::operation::describe_managed_login_branding_by_client::DescribeManagedLoginBrandingByClientError::unhandled,
                            )?;
                    let output = output.meta(generic);
                    output.build()
                };
        ...
        "NotAuthorizedException" => {
            crate::operation::describe_managed_login_branding_by_client::DescribeManagedLoginBrandingByClientError::NotAuthorizedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        _ => crate::operation::describe_managed_login_branding_by_client::DescribeManagedLoginBrandingByClientError::generic(generic),
    })
}
...
>{
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_managed_login_branding_by_client::de_describe_managed_login_branding_by_client(
            _response_body,
            output,
        )
        .map_err(crate::operation::describe_managed_login_branding_by_client::DescribeManagedLoginBrandingByClientError::unhandled)?;
