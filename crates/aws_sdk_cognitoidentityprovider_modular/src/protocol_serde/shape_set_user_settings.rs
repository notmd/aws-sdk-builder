...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::set_user_settings::SetUserSettingsError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
        ...
        "OperationNotEnabledException" => crate::operation::set_user_settings::SetUserSettingsError::OperationNotEnabledException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    ...
    crate::protocol_serde::shape_set_user_settings_input::ser_set_user_settings_input_input(
        &mut object,
        input,
    )?;
    object.finish();
