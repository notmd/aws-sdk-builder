...
///
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_cognitoidentityprovider_modular::Error> {
/// # let client: aws_sdk_cognitoidentityprovider_modular::Client = unimplemented!();
