...
impl super::Client {
    ...
    ///   - [`web_authn_mfa_settings(WebAuthnMfaSettingsType)`](crate::operation::set_user_mfa_preference::builders::SetUserMFAPreferenceFluentBuilder::web_authn_mfa_settings) / [`set_web_authn_mfa_settings(Option<WebAuthnMfaSettingsType>)`](crate::operation::set_user_mfa_preference::builders::SetUserMFAPreferenceFluentBuilder::set_web_authn_mfa_settings):<br>required: **false**<br><p>User preferences for passkey MFA. Activates or deactivates passkey MFA for the user. When activated, passkey authentication requires user verification, and passkey sign-in is available when MFA is required. To activate this setting, the <code>FactorConfiguration</code> of your user pool <code>WebAuthnConfiguration</code> must be <code>MULTI_FACTOR_WITH_USER_VERIFICATION</code>. To activate this setting, your user pool must be in the <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/feature-plans-features-essentials.html"> Essentials tier</a> or higher.</p><br>
