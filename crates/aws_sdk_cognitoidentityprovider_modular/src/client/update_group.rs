...
impl super::Client {
    ...
    ///   - [`user_pool_id(impl Into<String>)`](crate::operation::update_group::builders::UpdateGroupFluentBuilder::user_pool_id) / [`set_user_pool_id(Option<String>)`](crate::operation::update_group::builders::UpdateGroupFluentBuilder::set_user_pool_id):<br>required: **true**<br><p>The ID of the user pool that contains the group you want to update.</p><br>
    ///   - [`description(impl Into<String>)`](crate::operation::update_group::builders::UpdateGroupFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_group::builders::UpdateGroupFluentBuilder::set_description):<br>required: **false**<br><p>A new description of the existing group.</p><br>
    ///   - [`role_arn(impl Into<String>)`](crate::operation::update_group::builders::UpdateGroupFluentBuilder::role_arn) / [`set_role_arn(Option<String>)`](crate::operation::update_group::builders::UpdateGroupFluentBuilder::set_role_arn):<br>required: **false**<br><p>The Amazon Resource Name (ARN) of an IAM role that you want to associate with the group. The role assignment contributes to the <code>cognito:roles</code> and <code>cognito:preferred_role</code> claims in group members' tokens.</p><br>
    ...
    ///   - [`group(Option<GroupType>)`](crate::operation::update_group::UpdateGroupOutput::group): <p>Contains the updated details of the group, including precedence, IAM role, and description.</p>
