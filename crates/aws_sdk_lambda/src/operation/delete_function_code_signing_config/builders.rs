...
impl DeleteFunctionCodeSigningConfigFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::delete_function_code_signing_config::builders::DeleteFunctionCodeSigningConfigInputBuilder
    {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::delete_function_code_signing_config::DeleteFunctionCodeSigningConfig::orchestrate(
            &runtime_plugins,
            input,
        )
        .await
