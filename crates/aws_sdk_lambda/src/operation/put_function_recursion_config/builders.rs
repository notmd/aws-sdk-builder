...
impl PutFunctionRecursionConfigFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::put_function_recursion_config::builders::PutFunctionRecursionConfigInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::put_function_recursion_config::PutFunctionRecursionConfig::operation_runtime_plugins(
