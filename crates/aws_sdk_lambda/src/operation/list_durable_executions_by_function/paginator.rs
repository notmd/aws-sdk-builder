...
impl ListDurableExecutionsByFunctionPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::list_durable_executions_by_function::paginator::ListDurableExecutionsByFunctionPaginatorItems
    {
        crate::operation::list_durable_executions_by_function::paginator::ListDurableExecutionsByFunctionPaginatorItems(
            self,
        )
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token =
                                    crate::lens::reflens_list_durable_executions_by_function_output_output_next_marker(
                                        resp,
                                    );
