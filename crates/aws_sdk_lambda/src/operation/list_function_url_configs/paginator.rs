...
impl ListFunctionUrlConfigsPaginator {
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::list_function_url_configs::ListFunctionUrlConfigs::operation_runtime_plugins(
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(
            ::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_function_url_configs::ListFunctionUrlConfigs::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token =
                                    crate::lens::reflens_list_function_url_configs_output_output_next_marker(resp);
