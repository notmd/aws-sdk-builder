...
impl GetFunctionCodeSigningConfigFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::get_function_code_signing_config::builders::GetFunctionCodeSigningConfigInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::get_function_code_signing_config::GetFunctionCodeSigningConfig::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        crate::operation::get_function_code_signing_config::GetFunctionCodeSigningConfig::orchestrate(
            &runtime_plugins,
            input,
        )
        .await
