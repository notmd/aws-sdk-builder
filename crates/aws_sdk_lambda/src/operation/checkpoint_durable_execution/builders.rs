...
impl CheckpointDurableExecutionFluentBuilder {
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::checkpoint_durable_execution::CheckpointDurableExecution::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        crate::operation::checkpoint_durable_execution::CheckpointDurableExecution::orchestrate(&runtime_plugins, input)
            .await
    }
