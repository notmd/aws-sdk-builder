...
impl GetDurableExecutionStatePaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::get_durable_execution_state::paginator::GetDurableExecutionStatePaginatorItems {
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::get_durable_execution_state::GetDurableExecutionState::operation_runtime_plugins(
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token =
                                    crate::lens::reflens_get_durable_execution_state_output_output_next_marker(resp);
