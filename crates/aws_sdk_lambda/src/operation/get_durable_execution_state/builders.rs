...
impl GetDurableExecutionStateFluentBuilder {
    ...
    > {
        ...
        crate::operation::get_durable_execution_state::GetDurableExecutionState::orchestrate(&runtime_plugins, input)
            .await
    }
    ...
    pub fn into_paginator(
        ...
        crate::operation::get_durable_execution_state::paginator::GetDurableExecutionStatePaginator::new(
            self.handle,
            self.inner,
        )
    }
