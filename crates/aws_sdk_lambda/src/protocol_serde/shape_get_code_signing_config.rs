...
> {
    ...
    Err(match error_code {
        ...
        "ResourceNotFoundException" => {
            crate::operation::get_code_signing_config::GetCodeSigningConfigError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_get_code_signing_config::de_get_code_signing_config(_response_body, output)
                .map_err(crate::operation::get_code_signing_config::GetCodeSigningConfigError::unhandled)?;
