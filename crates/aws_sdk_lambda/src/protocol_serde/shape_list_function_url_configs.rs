...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::list_function_url_configs::ListFunctionUrlConfigsError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        ...
        "ResourceNotFoundException" => {
            crate::operation::list_function_url_configs::ListFunctionUrlConfigsError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceException" => {
            crate::operation::list_function_url_configs::ListFunctionUrlConfigsError::ServiceException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => {
            crate::operation::list_function_url_configs::ListFunctionUrlConfigsError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_function_url_configs::de_list_function_url_configs(
            _response_body,
            output,
        )
        .map_err(crate::operation::list_function_url_configs::ListFunctionUrlConfigsError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "FunctionUrlConfigs" => {
                    builder = builder.set_function_url_configs(
                        crate::protocol_serde::shape_function_url_config_list::de_function_url_config_list(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
