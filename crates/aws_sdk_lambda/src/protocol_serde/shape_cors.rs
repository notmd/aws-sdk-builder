                        ...
                        .as_ref()
                    {
                        ...
                        "AllowHeaders" => {
                            builder = builder.set_allow_headers(
                                crate::protocol_serde::shape_headers_list::de_headers_list(tokens, _value, depth + 1)?,
                            );
                        }
                        "AllowMethods" => {
                            builder = builder.set_allow_methods(
                                crate::protocol_serde::shape_allow_methods_list::de_allow_methods_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "AllowOrigins" => {
                            builder = builder.set_allow_origins(
                                crate::protocol_serde::shape_allow_origins_list::de_allow_origins_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
