...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::checkpoint_durable_execution::CheckpointDurableExecutionError::unhandled(generic),
            )
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_checkpoint_durable_execution::de_checkpoint_durable_execution(
            _response_body,
            output,
        )
        .map_err(crate::operation::checkpoint_durable_execution::CheckpointDurableExecutionError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_checkpoint_durable_execution_input::ser_checkpoint_durable_execution_input_input(
        &mut object,
        input,
    )?;
    object.finish();
