...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_add_layer_version_permission::de_add_layer_version_permission(
            _response_body,
            output,
        )
        .map_err(crate::operation::add_layer_version_permission::AddLayerVersionPermissionError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_add_layer_version_permission_input::ser_add_layer_version_permission_input_input(
        &mut object,
        input,
    )?;
    object.finish();
