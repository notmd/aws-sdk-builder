...
> {
    ...
    Err(match error_code {
        ...
        "ResourceNotFoundException" => {
            crate::operation::get_function_url_config::GetFunctionUrlConfigError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => {
            crate::operation::get_function_url_config::GetFunctionUrlConfigError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_get_function_url_config::de_get_function_url_config(_response_body, output)
                .map_err(crate::operation::get_function_url_config::GetFunctionUrlConfigError::unhandled)?;
