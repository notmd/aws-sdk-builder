...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::update_capacity_provider::UpdateCapacityProviderError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        ...
        "ServiceException" => {
            crate::operation::update_capacity_provider::UpdateCapacityProviderError::ServiceException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_update_capacity_provider::de_update_capacity_provider(_response_body, output)
                .map_err(crate::operation::update_capacity_provider::UpdateCapacityProviderError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_update_capacity_provider_input::ser_update_capacity_provider_input_input(
        &mut object,
        input,
    )?;
    object.finish();
