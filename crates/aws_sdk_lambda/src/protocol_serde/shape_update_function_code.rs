...
> {
    ...
    Err(match error_code {
        ...
        "CodeStorageExceededException" => {
            crate::operation::update_function_code::UpdateFunctionCodeError::CodeStorageExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "CodeVerificationFailedException" => {
            crate::operation::update_function_code::UpdateFunctionCodeError::CodeVerificationFailedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidCodeSignatureException" => {
            crate::operation::update_function_code::UpdateFunctionCodeError::InvalidCodeSignatureException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidParameterValueException" => {
            crate::operation::update_function_code::UpdateFunctionCodeError::InvalidParameterValueException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "PreconditionFailedException" => {
            crate::operation::update_function_code::UpdateFunctionCodeError::PreconditionFailedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceConflictException" => {
            crate::operation::update_function_code::UpdateFunctionCodeError::ResourceConflictException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            crate::operation::update_function_code::UpdateFunctionCodeError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => {
            crate::operation::update_function_code::UpdateFunctionCodeError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "CapacityProviderConfig" => {
                    builder = builder.set_capacity_provider_config(
                        crate::protocol_serde::shape_capacity_provider_config::de_capacity_provider_config(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
                ...
                "DurableConfig" => {
                    builder = builder.set_durable_config(
                        crate::protocol_serde::shape_durable_config::de_durable_config(tokens, _value, depth + 1)?,
                    );
                }
                "Environment" => {
                    builder = builder.set_environment(
                        crate::protocol_serde::shape_environment_response::de_environment_response(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
                ...
                "FileSystemConfigs" => {
                    builder = builder.set_file_system_configs(
                        crate::protocol_serde::shape_file_system_config_list::de_file_system_config_list(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
                ...
                "ImageConfigResponse" => {
                    builder = builder.set_image_config_response(
                        crate::protocol_serde::shape_image_config_response::de_image_config_response(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
                ...
                "LastUpdateStatusReasonCode" => {
                    builder = builder.set_last_update_status_reason_code(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| {
                                s.to_unescaped()
                                    .map(|u| crate::types::LastUpdateStatusReasonCode::from(u.as_ref()))
                            })
                            .transpose()?,
                    );
                }
                "Layers" => {
                    builder = builder.set_layers(
                        crate::protocol_serde::shape_layers_reference_list::de_layers_reference_list(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
                ...
                "LoggingConfig" => {
                    builder = builder.set_logging_config(
                        crate::protocol_serde::shape_logging_config::de_logging_config(tokens, _value, depth + 1)?,
                    );
                }
                "MasterArn" => {
                ...
                "RuntimeVersionConfig" => {
                    builder = builder.set_runtime_version_config(
                        crate::protocol_serde::shape_runtime_version_config::de_runtime_version_config(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
                ...
                "SnapStart" => {
                    builder = builder.set_snap_start(
                        crate::protocol_serde::shape_snap_start_response::de_snap_start_response(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
                ...
                "TenancyConfig" => {
                    builder = builder.set_tenancy_config(
                        crate::protocol_serde::shape_tenancy_config::de_tenancy_config(tokens, _value, depth + 1)?,
                    );
                }
                "Timeout" => {
                ...
                "TracingConfig" => {
                    builder = builder.set_tracing_config(
                        crate::protocol_serde::shape_tracing_config_response::de_tracing_config_response(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
                ...
                "VpcConfig" => {
                    builder = builder.set_vpc_config(
                        crate::protocol_serde::shape_vpc_config_response::de_vpc_config_response(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
