...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_put_function_recursion_config::de_put_function_recursion_config(
            _response_body,
            output,
        )
        .map_err(crate::operation::put_function_recursion_config::PutFunctionRecursionConfigError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_put_function_recursion_config_input::ser_put_function_recursion_config_input_input(
        &mut object,
        input,
    )?;
    object.finish();
