...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::update_code_signing_config::UpdateCodeSigningConfigError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        ...
        "ServiceException" => {
            crate::operation::update_code_signing_config::UpdateCodeSigningConfigError::ServiceException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_update_code_signing_config::de_update_code_signing_config(
            _response_body,
            output,
        )
        .map_err(crate::operation::update_code_signing_config::UpdateCodeSigningConfigError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_update_code_signing_config_input::ser_update_code_signing_config_input_input(
        &mut object,
        input,
    )?;
    object.finish();
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "CodeSigningConfig" => {
                    builder = builder.set_code_signing_config(
                        crate::protocol_serde::shape_code_signing_config::de_code_signing_config(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
