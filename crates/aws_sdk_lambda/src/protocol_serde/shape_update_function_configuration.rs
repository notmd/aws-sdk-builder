...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::update_function_configuration::UpdateFunctionConfigurationError::unhandled(generic),
            )
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_update_function_configuration::de_update_function_configuration(
            _response_body,
            output,
        )
        .map_err(crate::operation::update_function_configuration::UpdateFunctionConfigurationError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_update_function_configuration_input::ser_update_function_configuration_input_input(
        &mut object,
        input,
    )?;
    object.finish();
