            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "Code" => {
                    builder = builder.set_code(
                        crate::protocol_serde::shape_function_code_location::de_function_code_location(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
                ...
                "Concurrency" => {
                    builder = builder.set_concurrency(crate::protocol_serde::shape_concurrency::de_concurrency(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
                ...
                "Configuration" => {
                    builder = builder.set_configuration(
                        crate::protocol_serde::shape_function_configuration::de_function_configuration(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
                ...
                "TagsError" => {
                    builder = builder.set_tags_error(crate::protocol_serde::shape_tags_error::de_tags_error(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
