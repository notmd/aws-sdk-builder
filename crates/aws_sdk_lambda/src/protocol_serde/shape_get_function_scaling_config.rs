...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::get_function_scaling_config::GetFunctionScalingConfigError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
        ...
        "ResourceNotFoundException" => {
            crate::operation::get_function_scaling_config::GetFunctionScalingConfigError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceException" => {
            crate::operation::get_function_scaling_config::GetFunctionScalingConfigError::ServiceException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => {
            crate::operation::get_function_scaling_config::GetFunctionScalingConfigError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_function_scaling_config::de_get_function_scaling_config(
            _response_body,
            output,
        )
        .map_err(crate::operation::get_function_scaling_config::GetFunctionScalingConfigError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "AppliedFunctionScalingConfig" => {
                    builder = builder.set_applied_function_scaling_config(
                        crate::protocol_serde::shape_function_scaling_config::de_function_scaling_config(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
