...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::delete_capacity_provider::DeleteCapacityProviderError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        ...
        "ServiceException" => {
            crate::operation::delete_capacity_provider::DeleteCapacityProviderError::ServiceException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_delete_capacity_provider::de_delete_capacity_provider(_response_body, output)
                .map_err(crate::operation::delete_capacity_provider::DeleteCapacityProviderError::unhandled)?;
