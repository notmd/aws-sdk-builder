...
> {
    ...
    Err(match error_code {
        ...
        "ServiceException" => {
            crate::operation::get_layer_version_policy::GetLayerVersionPolicyError::ServiceException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => {
            crate::operation::get_layer_version_policy::GetLayerVersionPolicyError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_get_layer_version_policy::de_get_layer_version_policy(_response_body, output)
                .map_err(crate::operation::get_layer_version_policy::GetLayerVersionPolicyError::unhandled)?;
