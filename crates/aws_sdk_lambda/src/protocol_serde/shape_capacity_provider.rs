                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "State" => {
                                builder = builder.set_state(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                        .map(|s| {
                                            s.to_unescaped()
                                                .map(|u| crate::types::CapacityProviderState::from(u.as_ref()))
                                        })
                                        .transpose()?,
                                );
                            }
                            ...
                            "InstanceRequirements" => {
                                builder = builder.set_instance_requirements(
                                    crate::protocol_serde::shape_instance_requirements::de_instance_requirements(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
                            ...
                            "PropagateTags" => {
                                builder = builder.set_propagate_tags(
                                    crate::protocol_serde::shape_propagate_tags::de_propagate_tags(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
