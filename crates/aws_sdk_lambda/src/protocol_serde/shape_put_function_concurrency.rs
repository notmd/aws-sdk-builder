...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::put_function_concurrency::PutFunctionConcurrencyError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        ...
        "ServiceException" => {
            crate::operation::put_function_concurrency::PutFunctionConcurrencyError::ServiceException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_put_function_concurrency::de_put_function_concurrency(_response_body, output)
                .map_err(crate::operation::put_function_concurrency::PutFunctionConcurrencyError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_put_function_concurrency_input::ser_put_function_concurrency_input_input(
        &mut object,
        input,
    )?;
    object.finish();
