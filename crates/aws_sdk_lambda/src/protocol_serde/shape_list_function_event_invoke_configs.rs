...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_list_function_event_invoke_configs::de_list_function_event_invoke_configs(
                _response_body,
                output,
            )
            .map_err(
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "FunctionEventInvokeConfigs" => {
                    builder = builder.set_function_event_invoke_configs(
                        crate::protocol_serde::shape_function_event_invoke_config_list::de_function_event_invoke_config_list(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
