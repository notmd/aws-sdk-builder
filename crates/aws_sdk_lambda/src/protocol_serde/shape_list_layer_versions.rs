...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(crate::operation::list_layer_versions::ListLayerVersionsError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InvalidParameterValueException" => {
            crate::operation::list_layer_versions::ListLayerVersionsError::InvalidParameterValueException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            crate::operation::list_layer_versions::ListLayerVersionsError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => {
            crate::operation::list_layer_versions::ListLayerVersionsError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_layer_versions::de_list_layer_versions(_response_body, output)
            .map_err(crate::operation::list_layer_versions::ListLayerVersionsError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "LayerVersions" => {
                    builder = builder.set_layer_versions(
                        crate::protocol_serde::shape_layer_versions_list::de_layer_versions_list(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
