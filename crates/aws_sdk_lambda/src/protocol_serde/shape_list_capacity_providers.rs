...
> {
    ...
    Err(match error_code {
        ...
        "ServiceException" => {
            crate::operation::list_capacity_providers::ListCapacityProvidersError::ServiceException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => {
            crate::operation::list_capacity_providers::ListCapacityProvidersError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_list_capacity_providers::de_list_capacity_providers(_response_body, output)
                .map_err(crate::operation::list_capacity_providers::ListCapacityProvidersError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "CapacityProviders" => {
                    builder = builder.set_capacity_providers(
                        crate::protocol_serde::shape_capacity_providers_list::de_capacity_providers_list(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
