...
> {
    ...
    Err(match error_code {
        ...
        "KMSAccessDeniedException" => {
            crate::operation::get_durable_execution::GetDurableExecutionError::KmsAccessDeniedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "KMSDisabledException" => {
            crate::operation::get_durable_execution::GetDurableExecutionError::KmsDisabledException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "KMSInvalidStateException" => {
            crate::operation::get_durable_execution::GetDurableExecutionError::KmsInvalidStateException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "KMSNotFoundException" => {
            crate::operation::get_durable_execution::GetDurableExecutionError::KmsNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            crate::operation::get_durable_execution::GetDurableExecutionError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => {
            crate::operation::get_durable_execution::GetDurableExecutionError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "EndTimestamp" => {
                    builder =
                        builder.set_end_timestamp(::aws_smithy_json::deserialize::token::expect_timestamp_or_null(
                            tokens.next(),
                            ::aws_smithy_types::date_time::Format::EpochSeconds,
                        )?);
                }
                "Error" => {
                    builder = builder.set_error(crate::protocol_serde::shape_error_object::de_error_object(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
                ...
                "ExecutionDataIncluded" => {
                    builder = builder.set_execution_data_included(
                ...
                "StartTimestamp" => {
                    builder =
                        builder.set_start_timestamp(::aws_smithy_json::deserialize::token::expect_timestamp_or_null(
                            tokens.next(),
                            ::aws_smithy_types::date_time::Format::EpochSeconds,
                        )?);
                }
                ...
                "TraceHeader" => {
                    builder = builder.set_trace_header(crate::protocol_serde::shape_trace_header::de_trace_header(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
