...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::unsubscribe::UnsubscribeError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "AuthorizationError" => {
            crate::operation::unsubscribe::UnsubscribeError::AuthorizationErrorException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InternalError" => {
            crate::operation::unsubscribe::UnsubscribeError::InternalErrorException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidParameter" => {
            crate::operation::unsubscribe::UnsubscribeError::InvalidParameterException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidSecurity" => {
            crate::operation::unsubscribe::UnsubscribeError::InvalidSecurityException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
