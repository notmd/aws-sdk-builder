...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::list_subscriptions::ListSubscriptionsError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "AuthorizationError" => {
            crate::operation::list_subscriptions::ListSubscriptionsError::AuthorizationErrorException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidParameter" => {
            crate::operation::list_subscriptions::ListSubscriptionsError::InvalidParameterException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    ...
    if !(start_el.matches("ListSubscriptionsResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected ListSubscriptionsResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("ListSubscriptionsResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected ListSubscriptionsResult got {start_el:?}"
            )));
        }
