...
> {
    ...
    Err(match error_code {
        "AuthorizationError" => {
            crate::operation::get_topic_attributes::GetTopicAttributesError::AuthorizationErrorException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidParameter" => {
            crate::operation::get_topic_attributes::GetTopicAttributesError::InvalidParameterException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidSecurity" => {
            crate::operation::get_topic_attributes::GetTopicAttributesError::InvalidSecurityException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("GetTopicAttributesResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected GetTopicAttributesResult got {start_el:?}"
            )));
        }
