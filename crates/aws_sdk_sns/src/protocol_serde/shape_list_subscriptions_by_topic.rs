...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::list_subscriptions_by_topic::ListSubscriptionsByTopicError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
        "AuthorizationError" => {
            crate::operation::list_subscriptions_by_topic::ListSubscriptionsByTopicError::AuthorizationErrorException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InternalError" => {
            crate::operation::list_subscriptions_by_topic::ListSubscriptionsByTopicError::InternalErrorException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidParameter" => {
            crate::operation::list_subscriptions_by_topic::ListSubscriptionsByTopicError::InvalidParameterException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NotFound" => {
            crate::operation::list_subscriptions_by_topic::ListSubscriptionsByTopicError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_subscriptions_by_topic::de_list_subscriptions_by_topic(
            _response_body,
            output,
        )
        .map_err(crate::operation::list_subscriptions_by_topic::ListSubscriptionsByTopicError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("ListSubscriptionsByTopicResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected ListSubscriptionsByTopicResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("ListSubscriptionsByTopicResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected ListSubscriptionsByTopicResult got {start_el:?}"
            )));
        }
        while let Some(mut tag) = result_tag.next_tag() {
            ...
            s if s.matches("Subscriptions") /* Subscriptions com.amazonaws.sns.synthetic#ListSubscriptionsByTopicOutput$Subscriptions */ =>  {
                let var_1 =
                    Some(
                        crate::protocol_serde::shape_subscriptions_list::de_subscriptions_list(&mut tag, depth + 1)
                        ?
                    )
                ;
