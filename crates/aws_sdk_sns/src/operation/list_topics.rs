...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListTopics {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::orchestrator::Metadata::new("ListTopics", "SNS"),
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for ListTopicsTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListTopicsInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for ListTopicsResponseDeserializer
{
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_topics::de_list_topics_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_topics::de_list_topics_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListTopicsRequestSerializer {
    ...
    > {
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_list_topics_input::ser_list_topics_input_input_input(
                &input,
            )?,
        );
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for ListTopicsEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "ListTopicsEndpointParamsInterceptor"
    }
