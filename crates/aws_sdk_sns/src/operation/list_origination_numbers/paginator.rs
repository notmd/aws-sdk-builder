...
pub struct ListOriginationNumbersPaginator {
    ...
    builder: crate::operation::list_origination_numbers::builders::ListOriginationNumbersInputBuilder,
...
impl ListOriginationNumbersPaginator {
    ...
    pub fn items(self) -> crate::operation::list_origination_numbers::paginator::ListOriginationNumbersPaginatorItems {
        crate::operation::list_origination_numbers::paginator::ListOriginationNumbersPaginatorItems(self)
    }
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::list_origination_numbers::ListOriginationNumbers::operation_runtime_plugins(
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(
            ::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_origination_numbers::ListOriginationNumbers::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token =
                                    crate::lens::reflens_list_origination_numbers_output_output_next_token(resp);
...
impl ListOriginationNumbersPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_origination_numbers_output_output_phone_numbers(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
