...
impl crate::operation::confirm_subscription::builders::ConfirmSubscriptionInputBuilder {
...
impl ConfirmSubscriptionFluentBuilder {
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::confirm_subscription::ConfirmSubscription::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        crate::operation::confirm_subscription::ConfirmSubscription::orchestrate(
            &runtime_plugins,
            input,
        )
        .await
