...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::create_virtual_mfa_device::CreateVirtualMFADeviceError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "ConcurrentModification" => {
            crate::operation::create_virtual_mfa_device::CreateVirtualMFADeviceError::ConcurrentModificationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "EntityAlreadyExists" => {
            crate::operation::create_virtual_mfa_device::CreateVirtualMFADeviceError::EntityAlreadyExistsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidInput" => {
            crate::operation::create_virtual_mfa_device::CreateVirtualMFADeviceError::InvalidInputException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "LimitExceeded" => {
            crate::operation::create_virtual_mfa_device::CreateVirtualMFADeviceError::LimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceFailure" => {
            crate::operation::create_virtual_mfa_device::CreateVirtualMFADeviceError::ServiceFailureException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_virtual_mfa_device::de_create_virtual_mfa_device(
            _response_body,
            output,
        )
        .map_err(crate::operation::create_virtual_mfa_device::CreateVirtualMFADeviceError::unhandled)?;
