...
> {
    ...
    let mut generic_builder =
        crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(
            crate::operation::get_account_authorization_details::GetAccountAuthorizationDetailsError::unhandled,
        )?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_account_authorization_details::de_get_account_authorization_details(
            _response_body,
            output,
        )
        .map_err(crate::operation::get_account_authorization_details::GetAccountAuthorizationDetailsError::unhandled)?;
