...
> {
    ...
    let mut generic_builder =
        crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
            .map_err(crate::operation::update_assume_role_policy::UpdateAssumeRolePolicyError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::update_assume_role_policy::UpdateAssumeRolePolicyError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "LimitExceeded" => {
            crate::operation::update_assume_role_policy::UpdateAssumeRolePolicyError::LimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "MalformedPolicyDocument" => {
            crate::operation::update_assume_role_policy::UpdateAssumeRolePolicyError::MalformedPolicyDocumentException(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
        ...
        "NoSuchEntity" => {
            crate::operation::update_assume_role_policy::UpdateAssumeRolePolicyError::NoSuchEntityException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceFailure" => {
            crate::operation::update_assume_role_policy::UpdateAssumeRolePolicyError::ServiceFailureException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "UnmodifiableEntity" => {
            crate::operation::update_assume_role_policy::UpdateAssumeRolePolicyError::UnmodifiableEntityException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
