...
> {
    ...
    Err(match error_code {
        "DuplicateSSHPublicKey" => {
            crate::operation::upload_ssh_public_key::UploadSSHPublicKeyError::DuplicateSshPublicKeyException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidPublicKey" => {
            crate::operation::upload_ssh_public_key::UploadSSHPublicKeyError::InvalidPublicKeyException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_upload_ssh_public_key::de_upload_ssh_public_key(_response_body, output)
            .map_err(crate::operation::upload_ssh_public_key::UploadSSHPublicKeyError::unhandled)?;
