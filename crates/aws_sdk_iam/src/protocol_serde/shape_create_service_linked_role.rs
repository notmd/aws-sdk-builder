...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::create_service_linked_role::CreateServiceLinkedRoleError::unhandled(generic))
        }
    };
            ...
            crate::operation::create_service_linked_role::CreateServiceLinkedRoleError::LimitExceededException({
                ...
                let mut tmp = {
                    ...
                    output =
                        ...
                        .map_err(
                            crate::operation::create_service_linked_role::CreateServiceLinkedRoleError::unhandled,
                        )?;
                    let output = output.meta(generic);
                    output.build()
                };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_service_linked_role::de_create_service_linked_role(
            _response_body,
            output,
        )
        .map_err(crate::operation::create_service_linked_role::CreateServiceLinkedRoleError::unhandled)?;
