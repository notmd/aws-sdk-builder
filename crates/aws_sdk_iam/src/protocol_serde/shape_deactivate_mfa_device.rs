...
> {
    ...
    Err(match error_code {
        "ConcurrentModification" => {
            crate::operation::deactivate_mfa_device::DeactivateMFADeviceError::ConcurrentModificationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceFailure" => {
            crate::operation::deactivate_mfa_device::DeactivateMFADeviceError::ServiceFailureException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
