...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::put_group_policy::PutGroupPolicyError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "MalformedPolicyDocument" => {
            crate::operation::put_group_policy::PutGroupPolicyError::MalformedPolicyDocumentException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
