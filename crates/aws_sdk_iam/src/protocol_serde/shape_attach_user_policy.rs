...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::attach_user_policy::AttachUserPolicyError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "PolicyNotAttachable" => {
            crate::operation::attach_user_policy::AttachUserPolicyError::PolicyNotAttachableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
