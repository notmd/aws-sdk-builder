...
> {
    ...
    let mut generic_builder =
        crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(
            crate::operation::get_context_keys_for_custom_policy::GetContextKeysForCustomPolicyError::unhandled,
        )?;
        ...
        "InvalidInput" => crate::operation::get_context_keys_for_custom_policy::GetContextKeysForCustomPolicyError::InvalidInputException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_invalid_input_exception::de_invalid_input_exception_xml_err(_response_body, output)
                    .map_err(crate::operation::get_context_keys_for_custom_policy::GetContextKeysForCustomPolicyError::unhandled)?;
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_get_context_keys_for_custom_policy::de_get_context_keys_for_custom_policy(
                _response_body,
                output,
            )
            .map_err(
