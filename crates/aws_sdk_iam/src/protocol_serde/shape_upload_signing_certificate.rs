...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::upload_signing_certificate::UploadSigningCertificateError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "ConcurrentModification" => {
            crate::operation::upload_signing_certificate::UploadSigningCertificateError::ConcurrentModificationException(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
        ...
        "DuplicateCertificate" => {
            crate::operation::upload_signing_certificate::UploadSigningCertificateError::DuplicateCertificateException(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
        ...
        "EntityAlreadyExists" => {
            crate::operation::upload_signing_certificate::UploadSigningCertificateError::EntityAlreadyExistsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidCertificate" => {
            crate::operation::upload_signing_certificate::UploadSigningCertificateError::InvalidCertificateException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "LimitExceeded" => {
            crate::operation::upload_signing_certificate::UploadSigningCertificateError::LimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "MalformedCertificate" => {
            crate::operation::upload_signing_certificate::UploadSigningCertificateError::MalformedCertificateException(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
        ...
        "NoSuchEntity" => {
            crate::operation::upload_signing_certificate::UploadSigningCertificateError::NoSuchEntityException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceFailure" => {
            crate::operation::upload_signing_certificate::UploadSigningCertificateError::ServiceFailureException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_upload_signing_certificate::de_upload_signing_certificate(
            _response_body,
            output,
        )
        .map_err(crate::operation::upload_signing_certificate::UploadSigningCertificateError::unhandled)?;
