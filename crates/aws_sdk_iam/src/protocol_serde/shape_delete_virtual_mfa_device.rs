...
> {
    ...
    let mut generic_builder =
        crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
            .map_err(crate::operation::delete_virtual_mfa_device::DeleteVirtualMFADeviceError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::delete_virtual_mfa_device::DeleteVirtualMFADeviceError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "ConcurrentModification" => {
            crate::operation::delete_virtual_mfa_device::DeleteVirtualMFADeviceError::ConcurrentModificationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "DeleteConflict" => {
            crate::operation::delete_virtual_mfa_device::DeleteVirtualMFADeviceError::DeleteConflictException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "LimitExceeded" => {
            crate::operation::delete_virtual_mfa_device::DeleteVirtualMFADeviceError::LimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NoSuchEntity" => {
            crate::operation::delete_virtual_mfa_device::DeleteVirtualMFADeviceError::NoSuchEntityException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceFailure" => {
            crate::operation::delete_virtual_mfa_device::DeleteVirtualMFADeviceError::ServiceFailureException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
