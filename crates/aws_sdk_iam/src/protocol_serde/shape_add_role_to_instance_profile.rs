...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::add_role_to_instance_profile::AddRoleToInstanceProfileError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
        "EntityAlreadyExists" => {
            crate::operation::add_role_to_instance_profile::AddRoleToInstanceProfileError::EntityAlreadyExistsException(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
        ...
        "LimitExceeded" => {
            crate::operation::add_role_to_instance_profile::AddRoleToInstanceProfileError::LimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NoSuchEntity" => {
            crate::operation::add_role_to_instance_profile::AddRoleToInstanceProfileError::NoSuchEntityException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceFailure" => {
            crate::operation::add_role_to_instance_profile::AddRoleToInstanceProfileError::ServiceFailureException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "UnmodifiableEntity" => {
            crate::operation::add_role_to_instance_profile::AddRoleToInstanceProfileError::UnmodifiableEntityException(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
