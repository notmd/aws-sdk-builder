...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::create_open_id_connect_provider::CreateOpenIDConnectProviderError::unhandled(generic),
            )
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_open_id_connect_provider::de_create_open_id_connect_provider(
            _response_body,
            output,
        )
        .map_err(crate::operation::create_open_id_connect_provider::CreateOpenIDConnectProviderError::unhandled)?;
