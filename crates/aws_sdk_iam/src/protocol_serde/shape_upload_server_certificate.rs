...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::upload_server_certificate::UploadServerCertificateError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "ConcurrentModification" => {
            crate::operation::upload_server_certificate::UploadServerCertificateError::ConcurrentModificationException(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
        ...
        "EntityAlreadyExists" => {
            crate::operation::upload_server_certificate::UploadServerCertificateError::EntityAlreadyExistsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidInput" => {
            crate::operation::upload_server_certificate::UploadServerCertificateError::InvalidInputException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "KeyPairMismatch" => {
            crate::operation::upload_server_certificate::UploadServerCertificateError::KeyPairMismatchException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "LimitExceeded" => {
            crate::operation::upload_server_certificate::UploadServerCertificateError::LimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    ...
                    output =
                        ...
                        .map_err(
                            crate::operation::upload_server_certificate::UploadServerCertificateError::unhandled,
                        )?;
                    let output = output.meta(generic);
                    output.build()
                };
        ...
        "MalformedCertificate" => {
            crate::operation::upload_server_certificate::UploadServerCertificateError::MalformedCertificateException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceFailure" => {
            crate::operation::upload_server_certificate::UploadServerCertificateError::ServiceFailureException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_upload_server_certificate::de_upload_server_certificate(
            _response_body,
            output,
        )
        .map_err(crate::operation::upload_server_certificate::UploadServerCertificateError::unhandled)?;
