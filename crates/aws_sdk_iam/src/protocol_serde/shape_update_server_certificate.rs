...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::update_server_certificate::UpdateServerCertificateError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
            ...
            crate::operation::update_server_certificate::UpdateServerCertificateError::LimitExceededException({
                ...
                let mut tmp = {
                    ...
                    output =
                        ...
                        .map_err(
                            crate::operation::update_server_certificate::UpdateServerCertificateError::unhandled,
                        )?;
                    let output = output.meta(generic);
                    output.build()
                };
        ...
        "NoSuchEntity" => {
            crate::operation::update_server_certificate::UpdateServerCertificateError::NoSuchEntityException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
