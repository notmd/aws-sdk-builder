...
> {
    ...
    Err(match error_code {
        "InvalidInput" => {
            crate::operation::list_saml_provider_tags::ListSAMLProviderTagsError::InvalidInputException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NoSuchEntity" => {
            crate::operation::list_saml_provider_tags::ListSAMLProviderTagsError::NoSuchEntityException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceFailure" => {
            crate::operation::list_saml_provider_tags::ListSAMLProviderTagsError::ServiceFailureException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_list_saml_provider_tags::de_list_saml_provider_tags(_response_body, output)
                .map_err(crate::operation::list_saml_provider_tags::ListSAMLProviderTagsError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("ListSAMLProviderTagsResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected ListSAMLProviderTagsResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("ListSAMLProviderTagsResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected ListSAMLProviderTagsResult got {start_el:?}"
            )));
        }
