...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::list_attached_role_policies::ListAttachedRolePoliciesError::unhandled(generic),
            )
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_attached_role_policies::de_list_attached_role_policies(
            _response_body,
            output,
        )
        .map_err(crate::operation::list_attached_role_policies::ListAttachedRolePoliciesError::unhandled)?;
