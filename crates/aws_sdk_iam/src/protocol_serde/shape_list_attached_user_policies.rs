...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::list_attached_user_policies::ListAttachedUserPoliciesError::unhandled(generic),
            )
        }
    };
            ...
            crate::operation::list_attached_user_policies::ListAttachedUserPoliciesError::NoSuchEntityException({
                ...
                let mut tmp = {
                    ...
                    output =
                        ...
                        .map_err(
                            crate::operation::list_attached_user_policies::ListAttachedUserPoliciesError::unhandled,
                        )?;
                    let output = output.meta(generic);
                    output.build()
                };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_attached_user_policies::de_list_attached_user_policies(
            _response_body,
            output,
        )
        .map_err(crate::operation::list_attached_user_policies::ListAttachedUserPoliciesError::unhandled)?;
...
pub fn de_list_attached_user_policies(
    inp: &[u8],
    mut builder: crate::operation::list_attached_user_policies::builders::ListAttachedUserPoliciesOutputBuilder,
) -> std::result::Result<
    crate::operation::list_attached_user_policies::builders::ListAttachedUserPoliciesOutputBuilder,
