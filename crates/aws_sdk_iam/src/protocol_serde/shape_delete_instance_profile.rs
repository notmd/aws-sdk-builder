...
> {
    ...
    Err(match error_code {
        "DeleteConflict" => {
            crate::operation::delete_instance_profile::DeleteInstanceProfileError::DeleteConflictException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "LimitExceeded" => {
            crate::operation::delete_instance_profile::DeleteInstanceProfileError::LimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NoSuchEntity" => {
            crate::operation::delete_instance_profile::DeleteInstanceProfileError::NoSuchEntityException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceFailure" => {
            crate::operation::delete_instance_profile::DeleteInstanceProfileError::ServiceFailureException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
