...
> {
    ...
    let mut generic_builder =
        crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(
            crate::operation::create_service_specific_credential::CreateServiceSpecificCredentialError::unhandled,
        )?;
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_create_service_specific_credential::de_create_service_specific_credential(
                _response_body,
                output,
            )
            .map_err(
