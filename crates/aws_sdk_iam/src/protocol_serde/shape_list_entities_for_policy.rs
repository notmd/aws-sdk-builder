...
> {
    ...
    Err(match error_code {
        "InvalidInput" => {
            crate::operation::list_entities_for_policy::ListEntitiesForPolicyError::InvalidInputException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NoSuchEntity" => {
            crate::operation::list_entities_for_policy::ListEntitiesForPolicyError::NoSuchEntityException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceFailure" => {
            crate::operation::list_entities_for_policy::ListEntitiesForPolicyError::ServiceFailureException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_list_entities_for_policy::de_list_entities_for_policy(_response_body, output)
                .map_err(crate::operation::list_entities_for_policy::ListEntitiesForPolicyError::unhandled)?;
