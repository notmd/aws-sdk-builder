...
> {
    ...
    let mut generic_builder =
        crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
            .map_err(crate::operation::update_role_description::UpdateRoleDescriptionError::unhandled)?;
    ...
    Err(match error_code {
        "NoSuchEntity" => {
            crate::operation::update_role_description::UpdateRoleDescriptionError::NoSuchEntityException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceFailure" => {
            crate::operation::update_role_description::UpdateRoleDescriptionError::ServiceFailureException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_update_role_description::de_update_role_description(_response_body, output)
                .map_err(crate::operation::update_role_description::UpdateRoleDescriptionError::unhandled)?;
