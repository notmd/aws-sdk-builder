...
> {
    ...
    Err(match error_code {
        "LimitExceeded" => {
            crate::operation::remove_user_from_group::RemoveUserFromGroupError::LimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceFailure" => {
            crate::operation::remove_user_from_group::RemoveUserFromGroupError::ServiceFailureException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
