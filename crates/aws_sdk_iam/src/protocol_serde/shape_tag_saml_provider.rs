...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::tag_saml_provider::TagSAMLProviderError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "ConcurrentModification" => {
            crate::operation::tag_saml_provider::TagSAMLProviderError::ConcurrentModificationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
