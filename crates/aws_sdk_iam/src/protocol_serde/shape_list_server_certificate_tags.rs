...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::list_server_certificate_tags::ListServerCertificateTagsError::unhandled(generic),
            )
        }
    };
            ...
            crate::operation::list_server_certificate_tags::ListServerCertificateTagsError::NoSuchEntityException({
                ...
                let mut tmp = {
                    ...
                    output =
                        ...
                        .map_err(
                            crate::operation::list_server_certificate_tags::ListServerCertificateTagsError::unhandled,
                        )?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_server_certificate_tags::de_list_server_certificate_tags(
            _response_body,
            output,
        )
        .map_err(crate::operation::list_server_certificate_tags::ListServerCertificateTagsError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::list_server_certificate_tags_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_server_certificate_tags::ListServerCertificateTagsError::unhandled)?
    })
}
