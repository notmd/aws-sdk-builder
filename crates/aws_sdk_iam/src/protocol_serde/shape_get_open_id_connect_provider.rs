...
> {
    ...
    let mut generic_builder =
        crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
            .map_err(crate::operation::get_open_id_connect_provider::GetOpenIDConnectProviderError::unhandled)?;
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::get_open_id_connect_provider::GetOpenIDConnectProviderError::unhandled(generic),
            )
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_open_id_connect_provider::de_get_open_id_connect_provider(
            _response_body,
            output,
        )
        .map_err(crate::operation::get_open_id_connect_provider::GetOpenIDConnectProviderError::unhandled)?;
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("GetOpenIDConnectProviderResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected GetOpenIDConnectProviderResult got {start_el:?}"
            )));
        }
