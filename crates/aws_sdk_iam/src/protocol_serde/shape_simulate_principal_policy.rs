...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::simulate_principal_policy::SimulatePrincipalPolicyError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "InvalidInput" => {
            crate::operation::simulate_principal_policy::SimulatePrincipalPolicyError::InvalidInputException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NoSuchEntity" => {
            crate::operation::simulate_principal_policy::SimulatePrincipalPolicyError::NoSuchEntityException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_simulate_principal_policy::de_simulate_principal_policy(
            _response_body,
            output,
        )
        .map_err(crate::operation::simulate_principal_policy::SimulatePrincipalPolicyError::unhandled)?;
