...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::list_instance_profiles_for_role::ListInstanceProfilesForRoleError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
        "NoSuchEntity" => {
            crate::operation::list_instance_profiles_for_role::ListInstanceProfilesForRoleError::NoSuchEntityException(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
        ...
        "ServiceFailure" => {
            crate::operation::list_instance_profiles_for_role::ListInstanceProfilesForRoleError::ServiceFailureException(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_instance_profiles_for_role::de_list_instance_profiles_for_role(
            _response_body,
            output,
        )
        .map_err(crate::operation::list_instance_profiles_for_role::ListInstanceProfilesForRoleError::unhandled)?;
