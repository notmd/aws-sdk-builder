...
> {
    ...
    Err(match error_code {
        "DeleteConflict" => {
            crate::operation::delete_policy_version::DeletePolicyVersionError::DeleteConflictException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceFailure" => {
            crate::operation::delete_policy_version::DeletePolicyVersionError::ServiceFailureException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
