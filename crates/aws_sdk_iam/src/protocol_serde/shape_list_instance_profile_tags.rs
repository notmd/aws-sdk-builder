...
> {
    ...
    let mut generic_builder =
        crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
            .map_err(crate::operation::list_instance_profile_tags::ListInstanceProfileTagsError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::list_instance_profile_tags::ListInstanceProfileTagsError::unhandled(generic))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_instance_profile_tags::de_list_instance_profile_tags(
            _response_body,
            output,
        )
        .map_err(crate::operation::list_instance_profile_tags::ListInstanceProfileTagsError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::list_instance_profile_tags_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_instance_profile_tags::ListInstanceProfileTagsError::unhandled)?
    })
}
