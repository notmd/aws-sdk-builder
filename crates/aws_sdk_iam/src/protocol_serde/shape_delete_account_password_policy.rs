...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::delete_account_password_policy::DeleteAccountPasswordPolicyError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
        "LimitExceeded" => {
            crate::operation::delete_account_password_policy::DeleteAccountPasswordPolicyError::LimitExceededException(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
        ...
        "NoSuchEntity" => {
            crate::operation::delete_account_password_policy::DeleteAccountPasswordPolicyError::NoSuchEntityException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceFailure" => {
            crate::operation::delete_account_password_policy::DeleteAccountPasswordPolicyError::ServiceFailureException(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::delete_account_password_policy::builders::DeleteAccountPasswordPolicyOutputBuilder::default();
