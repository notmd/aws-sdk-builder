...
impl ListAttachedGroupPoliciesFluentBuilder {
    ...
    > {
        ...
        crate::operation::list_attached_group_policies::ListAttachedGroupPolicies::orchestrate(&runtime_plugins, input)
            .await
    }
    ...
    pub fn into_paginator(
        ...
        crate::operation::list_attached_group_policies::paginator::ListAttachedGroupPoliciesPaginator::new(
            self.handle,
            self.inner,
        )
    }
