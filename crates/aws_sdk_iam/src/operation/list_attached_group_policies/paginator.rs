...
impl ListAttachedGroupPoliciesPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::list_attached_group_policies::paginator::ListAttachedGroupPoliciesPaginatorItems {
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::list_attached_group_policies::ListAttachedGroupPolicies::operation_runtime_plugins(
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token =
                                    crate::lens::reflens_list_attached_group_policies_output_output_marker(resp);
