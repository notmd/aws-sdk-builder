...
impl GenerateCredentialReportFluentBuilder {
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::generate_credential_report::GenerateCredentialReport::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        crate::operation::generate_credential_report::GenerateCredentialReport::orchestrate(&runtime_plugins, input)
            .await
    }
