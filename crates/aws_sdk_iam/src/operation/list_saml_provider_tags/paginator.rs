...
pub struct ListSamlProviderTagsPaginator {
    ...
    builder: crate::operation::list_saml_provider_tags::builders::ListSamlProviderTagsInputBuilder,
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(
            ::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            crate::operation::list_saml_provider_tags::ListSAMLProviderTags::orchestrate(&runtime_plugins, input.clone()).await;
