...
impl ListInstanceProfilesForRolePaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::list_instance_profiles_for_role::paginator::ListInstanceProfilesForRolePaginatorItems {
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token =
                                    crate::lens::reflens_list_instance_profiles_for_role_output_output_marker(resp);
