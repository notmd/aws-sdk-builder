...
impl ListServerCertificateTagsPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::list_server_certificate_tags::paginator::ListServerCertificateTagsPaginatorItems {
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token =
                                    crate::lens::reflens_list_server_certificate_tags_output_output_marker(resp);
