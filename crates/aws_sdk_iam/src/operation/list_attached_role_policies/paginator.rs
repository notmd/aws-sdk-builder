...
impl ListAttachedRolePoliciesPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::list_attached_role_policies::paginator::ListAttachedRolePoliciesPaginatorItems {
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token =
                                    crate::lens::reflens_list_attached_role_policies_output_output_marker(resp);
