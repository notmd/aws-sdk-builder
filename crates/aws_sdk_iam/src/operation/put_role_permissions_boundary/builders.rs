...
impl PutRolePermissionsBoundaryFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::put_role_permissions_boundary::builders::PutRolePermissionsBoundaryInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::put_role_permissions_boundary::PutRolePermissionsBoundary::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        crate::operation::put_role_permissions_boundary::PutRolePermissionsBoundary::orchestrate(
            &runtime_plugins,
            input,
        )
        .await
