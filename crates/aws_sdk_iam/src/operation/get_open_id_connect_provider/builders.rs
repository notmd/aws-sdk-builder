...
impl GetOpenIDConnectProviderFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::get_open_id_connect_provider::builders::GetOpenIdConnectProviderInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::get_open_id_connect_provider::GetOpenIDConnectProvider::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        crate::operation::get_open_id_connect_provider::GetOpenIDConnectProvider::orchestrate(&runtime_plugins, input)
            .await
    }
