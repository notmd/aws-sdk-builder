...
impl ListAttachedUserPoliciesPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::list_attached_user_policies::paginator::ListAttachedUserPoliciesPaginatorItems {
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token =
                                    crate::lens::reflens_list_attached_user_policies_output_output_marker(resp);
