...
impl ListInstanceProfilesPaginator {
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::list_instance_profiles::ListInstanceProfiles::operation_runtime_plugins(
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(
            ::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_instance_profiles::ListInstanceProfiles::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
