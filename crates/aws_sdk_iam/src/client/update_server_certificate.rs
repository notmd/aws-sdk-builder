...
impl super::Client {
    /// Constructs a fluent builder for the [`UpdateServerCertificate`](crate::operation::update_server_certificate::builders::UpdateServerCertificateFluentBuilder) operation.
    ///
