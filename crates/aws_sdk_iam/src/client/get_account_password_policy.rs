...
impl super::Client {
    ...
    pub fn get_account_password_policy(
        &self,
    ) -> crate::operation::get_account_password_policy::builders::GetAccountPasswordPolicyFluentBuilder {
        crate::operation::get_account_password_policy::builders::GetAccountPasswordPolicyFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
