...
impl super::Client {
    ...
    pub fn delete_role_permissions_boundary(
        &self,
    ) -> crate::operation::delete_role_permissions_boundary::builders::DeleteRolePermissionsBoundaryFluentBuilder {
        crate::operation::delete_role_permissions_boundary::builders::DeleteRolePermissionsBoundaryFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
