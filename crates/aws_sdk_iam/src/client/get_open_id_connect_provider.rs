...
impl super::Client {
    ...
    ///   - [`open_id_connect_provider_arn(impl Into<String>)`](crate::operation::get_open_id_connect_provider::builders::GetOpenIDConnectProviderFluentBuilder::open_id_connect_provider_arn) / [`set_open_id_connect_provider_arn(Option<String>)`](crate::operation::get_open_id_connect_provider::builders::GetOpenIDConnectProviderFluentBuilder::set_open_id_connect_provider_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the OIDC provider resource object in IAM to get information for. You can get a list of OIDC provider resource ARNs by using the <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_ListOpenIDConnectProviders.html">ListOpenIDConnectProviders</a> operation.</p> <p>For more information about ARNs, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Names (ARNs)</a> in the <i>Amazon Web Services General Reference</i>.</p><br>
    ...
    ///   - [`url(Option<String>)`](crate::operation::get_open_id_connect_provider::GetOpenIdConnectProviderOutput::url): <p>The URL that the IAM OIDC provider resource object is associated with. For more information, see <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_CreateOpenIDConnectProvider.html">CreateOpenIDConnectProvider</a>.</p>
    ///   - [`client_id_list(Option<Vec::<String>>)`](crate::operation::get_open_id_connect_provider::GetOpenIdConnectProviderOutput::client_id_list): <p>A list of client IDs (also known as audiences) that are associated with the specified IAM OIDC provider resource object. For more information, see <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_CreateOpenIDConnectProvider.html">CreateOpenIDConnectProvider</a>.</p>
    ///   - [`thumbprint_list(Option<Vec::<String>>)`](crate::operation::get_open_id_connect_provider::GetOpenIdConnectProviderOutput::thumbprint_list): <p>A list of certificate thumbprints that are associated with the specified IAM OIDC provider resource object. For more information, see <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_CreateOpenIDConnectProvider.html">CreateOpenIDConnectProvider</a>.</p>
    ...
    pub fn get_open_id_connect_provider(
        &self,
    ) -> crate::operation::get_open_id_connect_provider::builders::GetOpenIDConnectProviderFluentBuilder {
        crate::operation::get_open_id_connect_provider::builders::GetOpenIDConnectProviderFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
