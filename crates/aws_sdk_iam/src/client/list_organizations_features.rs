...
impl super::Client {
    ...
    pub fn list_organizations_features(
        &self,
    ) -> crate::operation::list_organizations_features::builders::ListOrganizationsFeaturesFluentBuilder {
        crate::operation::list_organizations_features::builders::ListOrganizationsFeaturesFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
