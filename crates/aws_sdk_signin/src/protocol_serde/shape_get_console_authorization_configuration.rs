...
pub fn de_get_console_authorization_configuration_http_error(
...
> {
    ...
    .map_err(
        crate::operation::get_console_authorization_configuration::GetConsoleAuthorizationConfigurationError::unhandled,
    )?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(crate::operation::get_console_authorization_configuration::GetConsoleAuthorizationConfigurationError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => {
            crate::operation::get_console_authorization_configuration::GetConsoleAuthorizationConfigurationError::AccessDeniedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InternalServerException" => {
            crate::operation::get_console_authorization_configuration::GetConsoleAuthorizationConfigurationError::InternalServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TooManyRequestsError" => {
            crate::operation::get_console_authorization_configuration::GetConsoleAuthorizationConfigurationError::TooManyRequestsError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ValidationException" => {
            crate::operation::get_console_authorization_configuration::GetConsoleAuthorizationConfigurationError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        _ => crate::operation::get_console_authorization_configuration::GetConsoleAuthorizationConfigurationError::generic(generic),
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_get_console_authorization_configuration_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
pub(crate) fn de_get_console_authorization_configuration(
    _value: &[u8],
