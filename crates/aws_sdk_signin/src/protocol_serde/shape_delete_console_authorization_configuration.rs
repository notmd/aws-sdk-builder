...
pub fn de_delete_console_authorization_configuration_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::delete_console_authorization_configuration::DeleteConsoleAuthorizationConfigurationError::unhandled)?;
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::delete_console_authorization_configuration::DeleteConsoleAuthorizationConfigurationError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
            ...
            crate::operation::delete_console_authorization_configuration::DeleteConsoleAuthorizationConfigurationError::AccessDeniedException({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_access_denied_exception::de_access_denied_exception_json_err(_response_body, output)
                        .map_err(
                            crate::operation::delete_console_authorization_configuration::DeleteConsoleAuthorizationConfigurationError::unhandled,
                        )?;
        ...
        "TooManyRequestsError" => {
            crate::operation::delete_console_authorization_configuration::DeleteConsoleAuthorizationConfigurationError::TooManyRequestsError({
                ...
                let mut tmp = {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::too_many_requests_error_correct_errors(output).build().map_err(
                        crate::operation::delete_console_authorization_configuration::DeleteConsoleAuthorizationConfigurationError::unhandled,
                    )?
                };
                tmp
        ...
        _ => crate::operation::delete_console_authorization_configuration::DeleteConsoleAuthorizationConfigurationError::generic(generic),
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_console_authorization_configuration_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_console_authorization_configuration::de_delete_console_authorization_configuration(
            _response_body,
            output,
        )
        .map_err(crate::operation::delete_console_authorization_configuration::DeleteConsoleAuthorizationConfigurationError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::delete_console_authorization_configuration_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::delete_console_authorization_configuration::DeleteConsoleAuthorizationConfigurationError::unhandled)?
    })
}

pub fn ser_delete_console_authorization_configuration_input(
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_delete_console_authorization_configuration_input::ser_delete_console_authorization_configuration_input_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub(crate) fn de_delete_console_authorization_configuration(
    _value: &[u8],
