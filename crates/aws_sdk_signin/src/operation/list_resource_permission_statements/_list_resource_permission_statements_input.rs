...
pub struct ListResourcePermissionStatementsInput {
...
impl ListResourcePermissionStatementsInputBuilder {
    /// Maximum number of results to return
    ...
    /// Consumes the builder and constructs a [`ListResourcePermissionStatementsInput`](crate::operation::list_resource_permission_statements::ListResourcePermissionStatementsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
