...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for CreateOAuth2TokenResponseDeserializer
{
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_o_auth2_token::de_create_o_auth2_token_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for CreateOAuth2TokenRequestSerializer
{
    #[allow(
        unused_mut,
    ...
    > {
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_o_auth2_token_input::ser_token_input_http_payload(
                &input.token_input,
            )?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for CreateOAuth2TokenEndpointParamsInterceptor
{
...
impl ::aws_types::request_id::RequestId
    for crate::operation::create_o_auth2_token::CreateOAuth2TokenError
{
