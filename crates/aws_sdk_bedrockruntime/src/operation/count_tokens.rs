...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for CountTokensTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CountTokensInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for CountTokensResponseDeserializer
{
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_count_tokens::de_count_tokens_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_count_tokens::de_count_tokens_http_response(
                status, headers, body,
            )
        };
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for CountTokensEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "CountTokensEndpointParamsInterceptor"
    }
