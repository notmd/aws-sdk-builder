...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for StartAsyncInvokeTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) =
            context.input().downcast_ref::<StartAsyncInvokeInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for StartAsyncInvokeResponseDeserializer
{
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_start_async_invoke::de_start_async_invoke_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_start_async_invoke::de_start_async_invoke_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for StartAsyncInvokeRequestSerializer
{
    #[allow(
        unused_mut,
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for StartAsyncInvokeEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "StartAsyncInvokeEndpointParamsInterceptor"
    }
...
impl ::aws_types::request_id::RequestId
    for crate::operation::start_async_invoke::StartAsyncInvokeError
{
