...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin
    for InvokeModelWithBidirectionalStream
{
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg =
            ::aws_smithy_types::config_bag::Layer::new("InvokeModelWithBidirectionalStream");
        ...
        signing_options.payload_override =
    ...
    for InvokeModelWithBidirectionalStreamRequestSerializer
{
    ...
    > {
        ...
        let body = ::aws_smithy_types::body::SdkBody::from({
            ...
            let marshaller =
                crate::event_stream_serde::InvokeModelWithBidirectionalStreamInputMarshaller::new();
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for InvokeModelWithBidirectionalStreamError
{
