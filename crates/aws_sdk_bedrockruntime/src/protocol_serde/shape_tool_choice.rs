...
pub fn ser_tool_choice(
    ...
    match input {
        crate::types::ToolChoice::Auto(inner) => {
            ...
            crate::protocol_serde::shape_auto_tool_choice::ser_auto_tool_choice(
                &mut object_1,
                inner,
            )?;
            object_1.finish();
        ...
        crate::types::ToolChoice::Any(inner) => {
            ...
            crate::protocol_serde::shape_any_tool_choice::ser_any_tool_choice(
                &mut object_2,
                inner,
            )?;
            object_2.finish();
        ...
        crate::types::ToolChoice::Tool(inner) => {
            ...
            crate::protocol_serde::shape_specific_tool_choice::ser_specific_tool_choice(
                &mut object_3,
                inner,
            )?;
            object_3.finish();
        }
        crate::types::ToolChoice::Unknown => {
            return Err(
