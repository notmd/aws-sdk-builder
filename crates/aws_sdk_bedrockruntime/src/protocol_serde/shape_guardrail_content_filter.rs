                        ...
                        .as_ref()
                    {
                            ...
                            builder = builder.set_type(
                                ...
                                .map(|s| {
                                    s.to_unescaped().map(|u| {
                                        crate::types::GuardrailContentFilterType::from(u.as_ref())
                                    })
                                })
                                .transpose()?,
                            );
                        ...
                        "confidence" => {
                            builder = builder.set_confidence(
                                ...
                                .map(|s| {
                                    s.to_unescaped().map(|u| {
                                        crate::types::GuardrailContentFilterConfidence::from(
                                            u.as_ref(),
                                        )
                                    })
                                })
                        ...
                        "filterStrength" => {
                            builder = builder.set_filter_strength(
                                ...
                                .map(|s| {
                                    s.to_unescaped().map(|u| {
                                        crate::types::GuardrailContentFilterStrength::from(
                                            u.as_ref(),
                                        )
                                    })
                                })
                        ...
                        "action" => {
                            builder = builder.set_action(
                                ...
                                .map(|s| {
                                    s.to_unescaped().map(|u| {
                                        crate::types::GuardrailContentPolicyAction::from(u.as_ref())
                                    })
                                })
                                .transpose()?,
                            );
