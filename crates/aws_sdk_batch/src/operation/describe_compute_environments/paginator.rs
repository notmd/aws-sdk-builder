...
impl DescribeComputeEnvironmentsPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::describe_compute_environments::paginator::DescribeComputeEnvironmentsPaginatorItems {
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token =
                                    crate::lens::reflens_describe_compute_environments_output_output_next_token(resp);
