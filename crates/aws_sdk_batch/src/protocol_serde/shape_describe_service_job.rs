                ...
                match key.to_unescaped()?.as_ref() {
                    "attempts" => {
                        builder = builder.set_attempts(
                            crate::protocol_serde::shape_service_job_attempt_details::de_service_job_attempt_details(
                                tokens,
                                _value,
                                depth + 1,
                            )?,
                    ...
                    "latestAttempt" => {
                        builder = builder.set_latest_attempt(
                            crate::protocol_serde::shape_latest_service_job_attempt::de_latest_service_job_attempt(
                                tokens,
                                _value,
                                depth + 1,
                            )?,
                    ...
                    "retryStrategy" => {
                        builder = builder.set_retry_strategy(
                            crate::protocol_serde::shape_service_job_retry_strategy::de_service_job_retry_strategy(
                                tokens,
                                _value,
                                depth + 1,
                            )?,
                    ...
                    "status" => {
                        builder = builder.set_status(
                            ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                .map(|s| {
                                    s.to_unescaped()
                                        .map(|u| crate::types::ServiceJobStatus::from(u.as_ref()))
                                })
                                .transpose()?,
                        );
                    }
                    ...
                    "timeoutConfig" => {
                        builder = builder.set_timeout_config(
                            crate::protocol_serde::shape_service_job_timeout::de_service_job_timeout(
                                tokens,
                                _value,
                                depth + 1,
                            )?,
