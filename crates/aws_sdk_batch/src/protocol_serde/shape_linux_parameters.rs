                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                        match key.to_unescaped()?.as_ref() {
                            "devices" => {
                                builder =
                                    builder.set_devices(crate::protocol_serde::shape_devices_list::de_devices_list(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?);
                            ...
                            "tmpfs" => {
                                builder = builder.set_tmpfs(crate::protocol_serde::shape_tmpfs_list::de_tmpfs_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
