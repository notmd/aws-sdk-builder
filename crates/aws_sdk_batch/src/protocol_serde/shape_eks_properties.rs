...
pub(crate) fn de_eks_properties<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::EksProperties>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<
        Item = Result<
                        ...
                        match key.to_unescaped()?.as_ref() {
                            "podProperties" => {
                                builder = builder.set_pod_properties(
                                    crate::protocol_serde::shape_eks_pod_properties::de_eks_pod_properties(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
