...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::delete_scheduling_policy::DeleteSchedulingPolicyError::unhandled(generic))
        }
    };
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_delete_scheduling_policy_input::ser_delete_scheduling_policy_input_input(
        &mut object,
        input,
    )?;
    object.finish();
