            ...
            loop {
                match tokens.next().transpose()? {
                        ...
                        .as_ref()
                    {
                        ...
                        "hostPath" => {
                            builder =
                                builder.set_host_path(crate::protocol_serde::shape_eks_host_path::de_eks_host_path(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                        ...
                        "emptyDir" => {
                            builder =
                                builder.set_empty_dir(crate::protocol_serde::shape_eks_empty_dir::de_eks_empty_dir(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                        ...
                        "secret" => {
                            builder = builder.set_secret(crate::protocol_serde::shape_eks_secret::de_eks_secret(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
