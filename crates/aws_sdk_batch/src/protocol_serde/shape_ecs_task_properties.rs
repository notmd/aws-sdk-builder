        ...
        for item_3 in var_1 {
            {
                ...
                crate::protocol_serde::shape_task_container_properties::ser_task_container_properties(
                    &mut object_4,
                    item_3,
                )?;
                object_4.finish();
...
pub(crate) fn de_ecs_task_properties<'a, I>(
    ...
    Option<crate::types::EcsTaskProperties>,
    ...
    >,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                        match key.to_unescaped()?.as_ref() {
                            "containers" => {
                                ...
                                crate::protocol_serde::shape_list_task_container_properties::de_list_task_container_properties(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
            ...
            Ok(Some(
                crate::serde_util::ecs_task_properties_correct_errors(builder).build(),
            ))
        }
