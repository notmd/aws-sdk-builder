...
pub fn ser_instance_launch_template(
    ...
    if let Some(var_7) = &input.storage_configuration {
        ...
        crate::protocol_serde::shape_managed_instances_storage_configuration::ser_managed_instances_storage_configuration(&mut object_8, var_7)?;
        object_8.finish();
    }
...
pub(crate) fn de_instance_launch_template<'a, I>(
    ...
    Option<crate::types::InstanceLaunchTemplate>,
