...
pub fn de_list_jobs_http_error(
    ...
    Err(match error_code {
        "ClientException" => crate::operation::list_jobs::ListJobsError::ClientException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServerException" => crate::operation::list_jobs::ListJobsError::ServerException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_list_jobs_http_response(
    ...
    Ok({
        ...
        crate::serde_util::list_jobs_output_output_correct_errors(output).build()
    })
}
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "jobSummaryList" => {
                    builder = builder.set_job_summary_list(
                        crate::protocol_serde::shape_job_summary_list::de_job_summary_list(tokens, _value, depth + 1)?,
                    );
                }
                "nextToken" => {
