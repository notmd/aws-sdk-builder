    ...
    >,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "container" => {
                                builder = builder.set_container(
                                    crate::protocol_serde::shape_container_summary::de_container_summary(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
                            ...
                            "arrayProperties" => {
                                builder = builder.set_array_properties(
                                    crate::protocol_serde::shape_array_properties_summary::de_array_properties_summary(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
                            ...
                            "nodeProperties" => {
                                builder = builder.set_node_properties(
                                    crate::protocol_serde::shape_node_properties_summary::de_node_properties_summary(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
            ...
            Ok(Some(crate::serde_util::job_summary_correct_errors(builder).build()))
        }
