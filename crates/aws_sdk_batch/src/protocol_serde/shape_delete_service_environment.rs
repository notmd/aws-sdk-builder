...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::delete_service_environment::DeleteServiceEnvironmentError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "ClientException" => {
            crate::operation::delete_service_environment::DeleteServiceEnvironmentError::ClientException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServerException" => {
            crate::operation::delete_service_environment::DeleteServiceEnvironmentError::ServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_delete_service_environment_input::ser_delete_service_environment_input_input(
        &mut object,
        input,
    )?;
    object.finish();
