...
impl super::Client {
    /// Constructs a fluent builder for the [`CreateConsumableResource`](crate::operation::create_consumable_resource::builders::CreateConsumableResourceFluentBuilder) operation.
    ///
    /// - The fluent builder is configurable:
    ///   - [`consumable_resource_name(impl Into<String>)`](crate::operation::create_consumable_resource::builders::CreateConsumableResourceFluentBuilder::consumable_resource_name) / [`set_consumable_resource_name(Option<String>)`](crate::operation::create_consumable_resource::builders::CreateConsumableResourceFluentBuilder::set_consumable_resource_name):<br>required: **true**<br><p>The name of the consumable resource. Must be unique.</p><br>
    ///   - [`total_quantity(i64)`](crate::operation::create_consumable_resource::builders::CreateConsumableResourceFluentBuilder::total_quantity) / [`set_total_quantity(Option<i64>)`](crate::operation::create_consumable_resource::builders::CreateConsumableResourceFluentBuilder::set_total_quantity):<br>required: **false**<br><p>The total amount of the consumable resource that is available. Must be non-negative.</p><br>
    ...
    pub fn create_consumable_resource(
        ...
        crate::operation::create_consumable_resource::builders::CreateConsumableResourceFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
