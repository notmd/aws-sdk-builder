...
mod test {
    ...
    fn test_25() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint =
            endpoint.expect("Expected valid endpoint: https://email-fips.cn-north-1.api.amazonwebservices.com.cn");
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_27() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint =
            endpoint.expect("Expected valid endpoint: https://email.cn-north-1.api.amazonwebservices.com.cn");
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_49() {
        ...
        let error = endpoint.expect_err(
            "expected error: EndpointId must be a valid host label [Invalid EndpointId (Invalid chars / format)]",
        );
    ...
    fn test_50() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let error =
            endpoint.expect_err("expected error: EndpointId must be a valid host label [Invalid EndpointId (Empty)]");
        assert_eq!(format!("{}", error), "EndpointId must be a valid host label")
    }
    ...
    fn test_53() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint =
            endpoint.expect("Expected valid endpoint: https://abc123.456def.endpoints.email.us-gov.amazonaws.com");
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_59() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint =
            endpoint.expect("Expected valid endpoint: https://abc123.456def.endpoints.email.amazonaws.com.cn");
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_60() {
        ...
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://abc123.456def.endpoints.email.global.api.amazonwebservices.com.cn",
        );
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
            ...
            match current_ref {
                ref_val if ref_val >= 100_000_000 => {
                    return match (ref_val - 100_000_000) as usize {
                        ...
                        13 => ::std::result::Result::Err(Box::new(
                            ::aws_smithy_http::endpoint::ResolveEndpointError::message(
                        ...
                        15 => ::std::result::Result::Err(Box::new(
                            ::aws_smithy_http::endpoint::ResolveEndpointError::message(
                        ...
                        18 => ::std::result::Result::Err(Box::new(
                            ::aws_smithy_http::endpoint::ResolveEndpointError::message(
