...
pub struct ListConfigurationSetsPaginator {
    ...
    builder: crate::operation::list_configuration_sets::builders::ListConfigurationSetsInputBuilder,
...
impl ListConfigurationSetsPaginator {
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::list_configuration_sets::ListConfigurationSets::operation_runtime_plugins(
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(
            ::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_configuration_sets::ListConfigurationSets::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token =
                                    crate::lens::reflens_list_configuration_sets_output_output_next_token(resp);
