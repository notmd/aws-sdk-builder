...
impl crate::operation::create_deliverability_test_report::builders::CreateDeliverabilityTestReportInputBuilder {
...
impl CreateDeliverabilityTestReportFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::create_deliverability_test_report::builders::CreateDeliverabilityTestReportInputBuilder
    {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::create_deliverability_test_report::CreateDeliverabilityTestReport::orchestrate(
            &runtime_plugins,
            input,
        )
        .await
