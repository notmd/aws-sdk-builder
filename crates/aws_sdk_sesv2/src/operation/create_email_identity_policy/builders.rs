...
impl CreateEmailIdentityPolicyFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::create_email_identity_policy::builders::CreateEmailIdentityPolicyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::create_email_identity_policy::CreateEmailIdentityPolicy::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        crate::operation::create_email_identity_policy::CreateEmailIdentityPolicy::orchestrate(&runtime_plugins, input)
            .await
    }
