...
impl super::Client {
    ...
    pub fn create_multi_region_endpoint(
        &self,
    ) -> crate::operation::create_multi_region_endpoint::builders::CreateMultiRegionEndpointFluentBuilder {
        crate::operation::create_multi_region_endpoint::builders::CreateMultiRegionEndpointFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
