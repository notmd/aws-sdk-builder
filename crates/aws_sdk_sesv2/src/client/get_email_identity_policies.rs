...
impl super::Client {
    ...
    pub fn get_email_identity_policies(
        &self,
    ) -> crate::operation::get_email_identity_policies::builders::GetEmailIdentityPoliciesFluentBuilder {
        crate::operation::get_email_identity_policies::builders::GetEmailIdentityPoliciesFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
