...
impl super::Client {
    ...
    pub fn delete_email_identity_policy(
        &self,
    ) -> crate::operation::delete_email_identity_policy::builders::DeleteEmailIdentityPolicyFluentBuilder {
        crate::operation::delete_email_identity_policy::builders::DeleteEmailIdentityPolicyFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
