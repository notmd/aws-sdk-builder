...
impl super::Client {
    ...
    pub fn create_email_identity_policy(
        &self,
    ) -> crate::operation::create_email_identity_policy::builders::CreateEmailIdentityPolicyFluentBuilder {
        crate::operation::create_email_identity_policy::builders::CreateEmailIdentityPolicyFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
