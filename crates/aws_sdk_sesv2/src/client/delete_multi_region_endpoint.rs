...
impl super::Client {
    ...
    pub fn delete_multi_region_endpoint(
        &self,
    ) -> crate::operation::delete_multi_region_endpoint::builders::DeleteMultiRegionEndpointFluentBuilder {
        crate::operation::delete_multi_region_endpoint::builders::DeleteMultiRegionEndpointFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
