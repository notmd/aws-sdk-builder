...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::create_configuration_set::CreateConfigurationSetError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "AlreadyExistsException" => {
            crate::operation::create_configuration_set::CreateConfigurationSetError::AlreadyExistsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "BadRequestException" => {
            crate::operation::create_configuration_set::CreateConfigurationSetError::BadRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ConcurrentModificationException" => {
            crate::operation::create_configuration_set::CreateConfigurationSetError::ConcurrentModificationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "LimitExceededException" => {
            crate::operation::create_configuration_set::CreateConfigurationSetError::LimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NotFoundException" => {
            crate::operation::create_configuration_set::CreateConfigurationSetError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => {
            crate::operation::create_configuration_set::CreateConfigurationSetError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_create_configuration_set_input::ser_create_configuration_set_input_input(
        &mut object,
        input,
    )?;
    object.finish();
