...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::test_render_email_template::TestRenderEmailTemplateError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "BadRequestException" => {
            crate::operation::test_render_email_template::TestRenderEmailTemplateError::BadRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NotFoundException" => {
            crate::operation::test_render_email_template::TestRenderEmailTemplateError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_test_render_email_template::de_test_render_email_template(
            _response_body,
            output,
        )
        .map_err(crate::operation::test_render_email_template::TestRenderEmailTemplateError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_test_render_email_template_input::ser_test_render_email_template_input_input(
        &mut object,
        input,
    )?;
    object.finish();
