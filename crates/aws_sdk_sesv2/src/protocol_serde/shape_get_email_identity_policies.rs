...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::get_email_identity_policies::GetEmailIdentityPoliciesError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
        ...
        "NotFoundException" => {
            crate::operation::get_email_identity_policies::GetEmailIdentityPoliciesError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_email_identity_policies::de_get_email_identity_policies(
            _response_body,
            output,
        )
        .map_err(crate::operation::get_email_identity_policies::GetEmailIdentityPoliciesError::unhandled)?;
