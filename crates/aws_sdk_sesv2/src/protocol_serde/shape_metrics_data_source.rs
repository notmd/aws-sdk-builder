                        ...
                        .as_ref()
                    {
                        "Dimensions" => {
                            builder = builder.set_dimensions(
                                crate::protocol_serde::shape_export_dimensions::de_export_dimensions(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "Namespace" => {
                            builder = builder.set_namespace(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| {
                                        s.to_unescaped()
                                            .map(|u| crate::types::MetricNamespace::from(u.as_ref()))
                                    })
                                    .transpose()?,
                            );
                        }
                        "Metrics" => {
                            builder =
                                builder.set_metrics(crate::protocol_serde::shape_export_metrics::de_export_metrics(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                        ...
                        "EndDate" => {
                            builder =
                                builder.set_end_date(::aws_smithy_json::deserialize::token::expect_timestamp_or_null(
                                    tokens.next(),
                                    ::aws_smithy_types::date_time::Format::EpochSeconds,
                                )?);
                        }
