...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::list_suppressed_destinations::ListSuppressedDestinationsError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
        "BadRequestException" => {
            crate::operation::list_suppressed_destinations::ListSuppressedDestinationsError::BadRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidNextTokenException" => {
            crate::operation::list_suppressed_destinations::ListSuppressedDestinationsError::InvalidNextTokenException(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
        ...
        "NotFoundException" => {
            crate::operation::list_suppressed_destinations::ListSuppressedDestinationsError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => {
            crate::operation::list_suppressed_destinations::ListSuppressedDestinationsError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_suppressed_destinations::de_list_suppressed_destinations(
            _response_body,
            output,
        )
        .map_err(crate::operation::list_suppressed_destinations::ListSuppressedDestinationsError::unhandled)?;
