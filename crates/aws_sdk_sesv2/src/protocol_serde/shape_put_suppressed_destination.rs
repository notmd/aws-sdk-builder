...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::put_suppressed_destination::PutSuppressedDestinationError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "BadRequestException" => {
            crate::operation::put_suppressed_destination::PutSuppressedDestinationError::BadRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NotFoundException" => {
            crate::operation::put_suppressed_destination::PutSuppressedDestinationError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        _ => crate::operation::put_suppressed_destination::PutSuppressedDestinationError::generic(generic),
    })
}
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_put_suppressed_destination_input::ser_put_suppressed_destination_input_input(
        &mut object,
        input,
    )?;
    object.finish();
