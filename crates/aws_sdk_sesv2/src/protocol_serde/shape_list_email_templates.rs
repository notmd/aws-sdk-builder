...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(crate::operation::list_email_templates::ListEmailTemplatesError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "BadRequestException" => {
            crate::operation::list_email_templates::ListEmailTemplatesError::BadRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => {
            crate::operation::list_email_templates::ListEmailTemplatesError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_email_templates::de_list_email_templates(_response_body, output)
            .map_err(crate::operation::list_email_templates::ListEmailTemplatesError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "TemplatesMetadata" => {
                    builder = builder.set_templates_metadata(
                        crate::protocol_serde::shape_email_template_metadata_list::de_email_template_metadata_list(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
