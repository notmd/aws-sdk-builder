...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::get_suppressed_destination::GetSuppressedDestinationError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "BadRequestException" => {
            crate::operation::get_suppressed_destination::GetSuppressedDestinationError::BadRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NotFoundException" => {
            crate::operation::get_suppressed_destination::GetSuppressedDestinationError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_suppressed_destination::de_get_suppressed_destination(
            _response_body,
            output,
        )
        .map_err(crate::operation::get_suppressed_destination::GetSuppressedDestinationError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "SuppressedDestination" => {
                    builder = builder.set_suppressed_destination(
                        crate::protocol_serde::shape_suppressed_destination::de_suppressed_destination(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
