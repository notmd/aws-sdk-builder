...
pub(crate) fn de_message_insights_filters<'a, I>(
    ...
    Option<crate::types::MessageInsightsFilters>,
                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "Isp" => {
                                builder =
                                    builder.set_isp(crate::protocol_serde::shape_isp_filter_list::de_isp_filter_list(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?);
                            ...
                            "LastDeliveryEvent" => {
                                builder = builder.set_last_delivery_event(
                                    crate::protocol_serde::shape_last_delivery_event_list::de_last_delivery_event_list(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
