...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::get_deliverability_test_report::GetDeliverabilityTestReportError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
        "BadRequestException" => {
            crate::operation::get_deliverability_test_report::GetDeliverabilityTestReportError::BadRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    ...
                    .map_err(
                        crate::operation::get_deliverability_test_report::GetDeliverabilityTestReportError::unhandled,
                    )?;
        ...
        "NotFoundException" => {
            crate::operation::get_deliverability_test_report::GetDeliverabilityTestReportError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => {
            crate::operation::get_deliverability_test_report::GetDeliverabilityTestReportError::TooManyRequestsException(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
        ...
        _ => crate::operation::get_deliverability_test_report::GetDeliverabilityTestReportError::generic(generic),
    })
}
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_deliverability_test_report::de_get_deliverability_test_report(
            _response_body,
            output,
        )
        .map_err(crate::operation::get_deliverability_test_report::GetDeliverabilityTestReportError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "DeliverabilityTestReport" => {
                    builder = builder.set_deliverability_test_report(
                        crate::protocol_serde::shape_deliverability_test_report::de_deliverability_test_report(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
                ...
                "IspPlacements" => {
                    builder = builder.set_isp_placements(
                        crate::protocol_serde::shape_isp_placements::de_isp_placements(tokens, _value, depth + 1)?,
                    );
                }
                "Message" => {
                ...
                "OverallPlacement" => {
                    builder = builder.set_overall_placement(
                        crate::protocol_serde::shape_placement_statistics::de_placement_statistics(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
