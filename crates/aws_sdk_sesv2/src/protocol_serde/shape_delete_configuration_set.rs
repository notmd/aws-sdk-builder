...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::delete_configuration_set::DeleteConfigurationSetError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "BadRequestException" => {
            crate::operation::delete_configuration_set::DeleteConfigurationSetError::BadRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NotFoundException" => {
            crate::operation::delete_configuration_set::DeleteConfigurationSetError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => {
            crate::operation::delete_configuration_set::DeleteConfigurationSetError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
