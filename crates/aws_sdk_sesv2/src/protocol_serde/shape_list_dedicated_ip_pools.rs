...
> {
    ...
    Err(match error_code {
        "BadRequestException" => {
            crate::operation::list_dedicated_ip_pools::ListDedicatedIpPoolsError::BadRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => {
            crate::operation::list_dedicated_ip_pools::ListDedicatedIpPoolsError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_list_dedicated_ip_pools::de_list_dedicated_ip_pools(_response_body, output)
                .map_err(crate::operation::list_dedicated_ip_pools::ListDedicatedIpPoolsError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "DedicatedIpPools" => {
                    builder = builder.set_dedicated_ip_pools(
                        crate::protocol_serde::shape_list_of_dedicated_ip_pools::de_list_of_dedicated_ip_pools(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
