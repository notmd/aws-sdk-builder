...
> {
    ...
    let mut generic_builder =
        crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
            .map_err(crate::operation::delete_suppressed_destination::DeleteSuppressedDestinationError::unhandled)?;
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::delete_suppressed_destination::DeleteSuppressedDestinationError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
        "BadRequestException" => {
            crate::operation::delete_suppressed_destination::DeleteSuppressedDestinationError::BadRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    ...
                    .map_err(
                        crate::operation::delete_suppressed_destination::DeleteSuppressedDestinationError::unhandled,
                    )?;
        ...
        "NotFoundException" => {
            crate::operation::delete_suppressed_destination::DeleteSuppressedDestinationError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => {
            crate::operation::delete_suppressed_destination::DeleteSuppressedDestinationError::TooManyRequestsException(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
