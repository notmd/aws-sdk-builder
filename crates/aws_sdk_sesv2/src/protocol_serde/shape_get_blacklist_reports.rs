...
> {
    ...
    Err(match error_code {
        "BadRequestException" => {
            crate::operation::get_blacklist_reports::GetBlacklistReportsError::BadRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => {
            crate::operation::get_blacklist_reports::GetBlacklistReportsError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_blacklist_reports::de_get_blacklist_reports(_response_body, output)
            .map_err(crate::operation::get_blacklist_reports::GetBlacklistReportsError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::get_blacklist_reports_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::get_blacklist_reports::GetBlacklistReportsError::unhandled)?
    })
}
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "BlacklistReport" => {
                    builder = builder.set_blacklist_report(
                        crate::protocol_serde::shape_blacklist_report::de_blacklist_report(tokens, _value, depth + 1)?,
                    );
                }
