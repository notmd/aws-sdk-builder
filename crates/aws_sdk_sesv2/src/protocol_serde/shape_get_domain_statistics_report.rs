...
> {
    ...
    let mut generic_builder =
        crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
            .map_err(crate::operation::get_domain_statistics_report::GetDomainStatisticsReportError::unhandled)?;
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::get_domain_statistics_report::GetDomainStatisticsReportError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
        "BadRequestException" => {
            crate::operation::get_domain_statistics_report::GetDomainStatisticsReportError::BadRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NotFoundException" => {
            crate::operation::get_domain_statistics_report::GetDomainStatisticsReportError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => {
            crate::operation::get_domain_statistics_report::GetDomainStatisticsReportError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_domain_statistics_report::de_get_domain_statistics_report(
            _response_body,
            output,
        )
        .map_err(crate::operation::get_domain_statistics_report::GetDomainStatisticsReportError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::get_domain_statistics_report_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::get_domain_statistics_report::GetDomainStatisticsReportError::unhandled)?
    })
}
                ...
                match key.to_unescaped()?.as_ref() {
                    "DailyVolumes" => {
                        builder = builder.set_daily_volumes(
                            crate::protocol_serde::shape_daily_volumes::de_daily_volumes(tokens, _value, depth + 1)?,
                        );
                    }
                    "OverallVolume" => {
                        builder = builder.set_overall_volume(
                            crate::protocol_serde::shape_overall_volume::de_overall_volume(tokens, _value, depth + 1)?,
                        );
                    }
