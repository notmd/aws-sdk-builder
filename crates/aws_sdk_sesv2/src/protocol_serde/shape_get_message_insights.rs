...
> {
    ...
    Err(match error_code {
        "BadRequestException" => {
            crate::operation::get_message_insights::GetMessageInsightsError::BadRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NotFoundException" => crate::operation::get_message_insights::GetMessageInsightsError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => {
            crate::operation::get_message_insights::GetMessageInsightsError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        _ => crate::operation::get_message_insights::GetMessageInsightsError::generic(generic),
    })
}
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "EmailTags" => {
                    builder = builder.set_email_tags(
                        crate::protocol_serde::shape_message_tag_list::de_message_tag_list(tokens, _value, depth + 1)?,
                    );
                }
                "FromEmailAddress" => {
                ...
                "Insights" => {
                    builder = builder.set_insights(
                        crate::protocol_serde::shape_email_insights_list::de_email_insights_list(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
