...
> {
    ...
    let mut generic_builder =
        crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(
            crate::operation::list_deliverability_test_reports::ListDeliverabilityTestReportsError::unhandled,
        )?;
    ...
    Err(match error_code {
        "BadRequestException" => crate::operation::list_deliverability_test_reports::ListDeliverabilityTestReportsError::BadRequestException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_bad_request_exception::de_bad_request_exception_json_err(_response_body, output)
                    .map_err(crate::operation::list_deliverability_test_reports::ListDeliverabilityTestReportsError::unhandled)?;
        ...
        "TooManyRequestsException" => {
            crate::operation::list_deliverability_test_reports::ListDeliverabilityTestReportsError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_deliverability_test_reports::de_list_deliverability_test_reports(
            _response_body,
            output,
        )
        .map_err(crate::operation::list_deliverability_test_reports::ListDeliverabilityTestReportsError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::list_deliverability_test_reports_output_output_correct_errors(output)
            .build()
            .map_err(
                crate::operation::list_deliverability_test_reports::ListDeliverabilityTestReportsError::unhandled,
            )?
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "DeliverabilityTestReports" => {
                    builder = builder.set_deliverability_test_reports(
                        crate::protocol_serde::shape_deliverability_test_reports::de_deliverability_test_reports(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
