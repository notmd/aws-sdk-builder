    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "PricingAttributes" => {
                    builder = builder.set_pricing_attributes(
                        crate::protocol_serde::shape_pricing_attributes::de_pricing_attributes(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
                ...
                "SendQuota" => {
                    builder = builder.set_send_quota(crate::protocol_serde::shape_send_quota::de_send_quota(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
                ...
                "SendingEnabled" => {
                    builder = builder.set_sending_enabled(::aws_smithy_json::deserialize::token::expect_bool_or_null(
                        tokens.next(),
                    )?);
                }
                "SuppressionAttributes" => {
                    builder = builder.set_suppression_attributes(
                        crate::protocol_serde::shape_suppression_attributes::de_suppression_attributes(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
                ...
                "VdmAttributes" => {
                    builder = builder.set_vdm_attributes(
                        crate::protocol_serde::shape_vdm_attributes::de_vdm_attributes(tokens, _value, depth + 1)?,
                    );
                }
