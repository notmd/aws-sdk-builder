...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::register_client::RegisterClientError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "InternalServerException" => {
            crate::operation::register_client::RegisterClientError::InternalServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidRequestException" => {
            crate::operation::register_client::RegisterClientError::InvalidRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidScopeException" => {
            crate::operation::register_client::RegisterClientError::InvalidScopeException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "SlowDownException" => {
            crate::operation::register_client::RegisterClientError::SlowDownException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_register_client::de_register_client(
            _response_body,
            output,
        )
        .map_err(crate::operation::register_client::RegisterClientError::unhandled)?;
...
> {
    ...
    crate::protocol_serde::shape_register_client_input::ser_register_client_input_input(
        &mut object,
        input,
    )?;
    object.finish();
