...
///     AccessDeniedExceptionReason::KmsAccessDenied => { /* ... */ },
...
impl ::std::convert::From<&str> for AccessDeniedExceptionReason {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AccessDeniedExceptionReason::Unknown(
...
impl AccessDeniedExceptionReason {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            AccessDeniedExceptionReason::KmsAccessDenied => "KMS_AccessDeniedException",
...
impl ::std::fmt::Display for AccessDeniedExceptionReason {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            AccessDeniedExceptionReason::KmsAccessDenied => write!(f, "KMS_AccessDeniedException"),
