...
> {
    ...
    Err(match error_code {
        ...
        "InvalidSecurity" => {
            crate::operation::purge_queue::PurgeQueueError::InvalidSecurity({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "RequestThrottled" => {
            crate::operation::purge_queue::PurgeQueueError::RequestThrottled({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
> {
    ...
    crate::protocol_serde::shape_purge_queue_input::ser_purge_queue_input_input(
        &mut object,
        input,
    )?;
    object.finish();
