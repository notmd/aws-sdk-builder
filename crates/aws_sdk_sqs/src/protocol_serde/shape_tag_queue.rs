...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::tag_queue::TagQueueError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "InvalidSecurity" => {
            crate::operation::tag_queue::TagQueueError::InvalidSecurity({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "AWS.SimpleQueueService.NonExistentQueue" => {
            crate::operation::tag_queue::TagQueueError::QueueDoesNotExist({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "RequestThrottled" => {
            crate::operation::tag_queue::TagQueueError::RequestThrottled({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "AWS.SimpleQueueService.UnsupportedOperation" => {
            crate::operation::tag_queue::TagQueueError::UnsupportedOperation({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
