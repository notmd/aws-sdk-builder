...
> {
    ...
    let error_code =
        match generic.code() {
            Some(code) => code,
            None => return Err(
                crate::operation::cancel_message_move_task::CancelMessageMoveTaskError::unhandled(
                    generic,
                ),
            ),
        };
    ...
    Err(match error_code {
        ...
        "RequestThrottled" => crate::operation::cancel_message_move_task::CancelMessageMoveTaskError::RequestThrottled({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_cancel_message_move_task::de_cancel_message_move_task(
                _response_body,
                output,
            )
            .map_err(
...
> {
    ...
    crate::protocol_serde::shape_cancel_message_move_task_input::ser_cancel_message_move_task_input_input(&mut object, input)?;
    object.finish();
