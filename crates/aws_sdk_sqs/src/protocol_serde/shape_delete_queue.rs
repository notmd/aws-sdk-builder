...
> {
    ...
    Err(match error_code {
        ...
        "InvalidSecurity" => {
            crate::operation::delete_queue::DeleteQueueError::InvalidSecurity({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "AWS.SimpleQueueService.NonExistentQueue" => {
            crate::operation::delete_queue::DeleteQueueError::QueueDoesNotExist({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "RequestThrottled" => {
            crate::operation::delete_queue::DeleteQueueError::RequestThrottled({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "AWS.SimpleQueueService.UnsupportedOperation" => {
            crate::operation::delete_queue::DeleteQueueError::UnsupportedOperation({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
> {
    ...
    crate::protocol_serde::shape_delete_queue_input::ser_delete_queue_input_input(
        &mut object,
        input,
    )?;
    object.finish();
