...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteQueue {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::orchestrator::Metadata::new("DeleteQueue", "SQS"),
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for DeleteQueueTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DeleteQueueInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for DeleteQueueResponseDeserializer
{
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for DeleteQueueEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "DeleteQueueEndpointParamsInterceptor"
    }
