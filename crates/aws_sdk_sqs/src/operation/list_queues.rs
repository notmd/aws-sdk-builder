...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListQueues {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::orchestrator::Metadata::new("ListQueues", "SQS"),
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for ListQueuesTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListQueuesInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for ListQueuesResponseDeserializer
{
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_queues::de_list_queues_http_error(
                status, headers, body,
            )
        } else {
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for ListQueuesEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "ListQueuesEndpointParamsInterceptor"
    }
