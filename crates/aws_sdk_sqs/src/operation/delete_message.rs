...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteMessage {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::orchestrator::Metadata::new("DeleteMessage", "SQS"),
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for DeleteMessageTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) =
            context.input().downcast_ref::<DeleteMessageInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for DeleteMessageResponseDeserializer
{
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for DeleteMessageEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "DeleteMessageEndpointParamsInterceptor"
    }
