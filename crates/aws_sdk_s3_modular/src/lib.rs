...
//!
//! ```rust,no_run
//! use aws_sdk_s3_modular as s3;
//!
//! #[::tokio::main]
//! async fn main() -> Result<(), s3::Error> {
//!     let config = aws_config::load_from_env().await;
//!     let client = aws_sdk_s3_modular::Client::new(&config);
//!
...
//! ```
//!
//! See the [client documentation](https://docs.rs/aws-sdk-s3/latest/aws_sdk_s3_modular/client/struct.Client.html)
...
/// let config = aws_sdk_s3_modular::config::Builder::from(&sdk_config)
/// # /*
