...
impl DeleteBucketInventoryConfigurationFluentBuilder {
    ...
    > {
        ...
        let runtime_plugins = crate::operation::delete_bucket_inventory_configuration::DeleteBucketInventoryConfiguration::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::delete_bucket_inventory_configuration::DeleteBucketInventoryConfiguration::orchestrate(&runtime_plugins, input).await
    }
