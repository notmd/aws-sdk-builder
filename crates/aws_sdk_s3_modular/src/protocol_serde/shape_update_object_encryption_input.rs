...
pub fn ser_object_encryption_http_payload(
    payload: &::std::option::Option<crate::types::ObjectEncryption>,
    ...
    Ok(
        crate::protocol_serde::shape_update_object_encryption_input::ser_object_encryption_payload(
            payload,
        )?,
    )
}
...
) -> std::result::Result<std::vec::Vec<u8>, ::aws_smithy_types::error::operation::SerializationError>
{
    let mut out = String::new();
    {
        ...
        crate::protocol_serde::shape_object_encryption::ser_object_encryption(input, root)?
    }
    Ok(out.into_bytes())
}
