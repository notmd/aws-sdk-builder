...
> {
    ...
    crate::protocol_serde::shape_batch_write_item_input::ser_batch_write_item_input_input(
        &mut object,
        input,
    )?;
    object.finish();
                ...
                match key.to_unescaped()?.as_ref() {
                    "UnprocessedItems" => {
                        builder = builder.set_unprocessed_items(
                            crate::protocol_serde::shape_batch_write_item_request_map::de_batch_write_item_request_map(tokens, _value, depth + 1)?,
                        );
                    }
