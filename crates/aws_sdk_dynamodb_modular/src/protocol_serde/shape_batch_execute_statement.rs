...
> {
    ...
    Err(match error_code {
        ...
        "ThrottlingException" => crate::operation::batch_execute_statement::BatchExecuteStatementError::ThrottlingException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                match key.to_unescaped()?.as_ref() {
                    "Responses" => {
                        builder = builder.set_responses(crate::protocol_serde::shape_parti_ql_batch_response::de_parti_ql_batch_response(
                            tokens,
                            _value,
                            depth + 1,
                        )?);
