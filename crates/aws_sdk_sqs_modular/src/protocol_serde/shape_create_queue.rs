...
> {
    ...
    Err(match error_code {
        ...
        "InvalidAttributeName" => {
            crate::operation::create_queue::CreateQueueError::InvalidAttributeName({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidAttributeValue" => {
            crate::operation::create_queue::CreateQueueError::InvalidAttributeValue({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidSecurity" => {
            crate::operation::create_queue::CreateQueueError::InvalidSecurity({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "RequestThrottled" => {
            crate::operation::create_queue::CreateQueueError::RequestThrottled({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
> {
    ...
    crate::protocol_serde::shape_create_queue_input::ser_create_queue_input_input(
        &mut object,
        input,
    )?;
    object.finish();
