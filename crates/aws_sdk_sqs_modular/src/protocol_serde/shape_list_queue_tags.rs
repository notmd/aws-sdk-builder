...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::list_queue_tags::ListQueueTagsError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "InvalidAddress" => {
            crate::operation::list_queue_tags::ListQueueTagsError::InvalidAddress({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
                    ...
                    output =
                        ...
                        .map_err(
                            crate::operation::list_queue_tags::ListQueueTagsError::unhandled,
                        )?;
        ...
        "InvalidSecurity" => {
            crate::operation::list_queue_tags::ListQueueTagsError::InvalidSecurity({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "RequestThrottled" => {
            crate::operation::list_queue_tags::ListQueueTagsError::RequestThrottled({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_queue_tags::de_list_queue_tags(
            _response_body,
            output,
        )
        .map_err(crate::operation::list_queue_tags::ListQueueTagsError::unhandled)?;
        ...
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                match key.to_unescaped()?.as_ref() {
                    "Tags" => {
                        builder =
                            builder.set_tags(crate::protocol_serde::shape_tag_map::de_tag_map(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
