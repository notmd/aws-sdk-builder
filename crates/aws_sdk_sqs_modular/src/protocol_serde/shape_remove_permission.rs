...
> {
    ...
    Err(match error_code {
        "InvalidAddress" => {
            crate::operation::remove_permission::RemovePermissionError::InvalidAddress({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidSecurity" => {
            crate::operation::remove_permission::RemovePermissionError::InvalidSecurity({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "RequestThrottled" => {
            crate::operation::remove_permission::RemovePermissionError::RequestThrottled({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
> {
    ...
    crate::protocol_serde::shape_remove_permission_input::ser_remove_permission_input_input(
        &mut object,
        input,
    )?;
    object.finish();
