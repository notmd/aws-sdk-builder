...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::untag_queue::UntagQueueError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "InvalidSecurity" => {
            crate::operation::untag_queue::UntagQueueError::InvalidSecurity({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "RequestThrottled" => {
            crate::operation::untag_queue::UntagQueueError::RequestThrottled({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
> {
    ...
    crate::protocol_serde::shape_untag_queue_input::ser_untag_queue_input_input(
        &mut object,
        input,
    )?;
    object.finish();
