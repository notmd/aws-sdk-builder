...
> {
    ...
    Err(match error_code {
        "InvalidAddress" => {
            crate::operation::set_queue_attributes::SetQueueAttributesError::InvalidAddress({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidAttributeValue" => {
            crate::operation::set_queue_attributes::SetQueueAttributesError::InvalidAttributeValue(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
        ...
        "InvalidSecurity" => {
            crate::operation::set_queue_attributes::SetQueueAttributesError::InvalidSecurity({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "OverLimit" => {
            crate::operation::set_queue_attributes::SetQueueAttributesError::OverLimit({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    ...
                    .map_err(
                        crate::operation::set_queue_attributes::SetQueueAttributesError::unhandled,
                    )?;
                    let output = output.meta(generic);
                    output.build()
                };
        ...
        "AWS.SimpleQueueService.NonExistentQueue" => {
            crate::operation::set_queue_attributes::SetQueueAttributesError::QueueDoesNotExist({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "RequestThrottled" => {
            crate::operation::set_queue_attributes::SetQueueAttributesError::RequestThrottled({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "AWS.SimpleQueueService.UnsupportedOperation" => {
            crate::operation::set_queue_attributes::SetQueueAttributesError::UnsupportedOperation({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
> {
    ...
    crate::protocol_serde::shape_set_queue_attributes_input::ser_set_queue_attributes_input_input(
        &mut object,
        input,
    )?;
    object.finish();
