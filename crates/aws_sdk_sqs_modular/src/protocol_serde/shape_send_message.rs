...
> {
    ...
    Err(match error_code {
        ...
        "InvalidMessageContents" => {
            crate::operation::send_message::SendMessageError::InvalidMessageContents({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_invalid_message_contents::de_invalid_message_contents_json_err(_response_body, output)
                    .map_err(crate::operation::send_message::SendMessageError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
        ...
        "InvalidSecurity" => {
            crate::operation::send_message::SendMessageError::InvalidSecurity({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "KMS.AccessDeniedException" => {
            crate::operation::send_message::SendMessageError::KmsAccessDenied({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "KMS.InvalidKeyUsageException" => {
            crate::operation::send_message::SendMessageError::KmsInvalidKeyUsage({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "KMS.InvalidStateException" => {
            crate::operation::send_message::SendMessageError::KmsInvalidState({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "KMS.OptInRequired" => {
            crate::operation::send_message::SendMessageError::KmsOptInRequired({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "KMS.ThrottlingException" => {
            crate::operation::send_message::SendMessageError::KmsThrottled({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "AWS.SimpleQueueService.NonExistentQueue" => {
            crate::operation::send_message::SendMessageError::QueueDoesNotExist({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "RequestThrottled" => {
            crate::operation::send_message::SendMessageError::RequestThrottled({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
> {
    ...
    crate::protocol_serde::shape_send_message_input::ser_send_message_input_input(
        &mut object,
        input,
    )?;
    object.finish();
