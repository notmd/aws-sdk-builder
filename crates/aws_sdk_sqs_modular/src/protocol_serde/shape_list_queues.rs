...
> {
    ...
    Err(match error_code {
        ...
        "InvalidSecurity" => {
            crate::operation::list_queues::ListQueuesError::InvalidSecurity({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "RequestThrottled" => {
            crate::operation::list_queues::ListQueuesError::RequestThrottled({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "AWS.SimpleQueueService.UnsupportedOperation" => {
            crate::operation::list_queues::ListQueuesError::UnsupportedOperation({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
> {
    ...
    crate::protocol_serde::shape_list_queues_input::ser_list_queues_input_input(
        &mut object,
        input,
    )?;
    object.finish();
