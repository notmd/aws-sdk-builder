...
> {
    ...
    Err(match error_code {
        ...
        "InvalidSecurity" => {
            crate::operation::get_queue_url::GetQueueUrlError::InvalidSecurity({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "RequestThrottled" => {
            crate::operation::get_queue_url::GetQueueUrlError::RequestThrottled({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "AWS.SimpleQueueService.UnsupportedOperation" => {
            crate::operation::get_queue_url::GetQueueUrlError::UnsupportedOperation({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
> {
    ...
    crate::protocol_serde::shape_get_queue_url_input::ser_get_queue_url_input_input(
        &mut object,
        input,
    )?;
    object.finish();
