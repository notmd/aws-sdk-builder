...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetQueueUrl {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::orchestrator::Metadata::new("GetQueueUrl", "SQS"),
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for GetQueueUrlTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetQueueUrlInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for GetQueueUrlResponseDeserializer
{
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_queue_url::de_get_queue_url_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_queue_url::de_get_queue_url_http_response(
                status, headers, body,
            )
        };
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for GetQueueUrlEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "GetQueueUrlEndpointParamsInterceptor"
    }
...
impl GetQueueUrlError {
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::InvalidSecurity(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            }
            Self::QueueDoesNotExist(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            }
            Self::RequestThrottled(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            }
            Self::UnsupportedOperation(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            }
