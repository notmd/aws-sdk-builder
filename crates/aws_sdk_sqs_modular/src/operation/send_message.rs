...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SendMessage {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::orchestrator::Metadata::new("SendMessage", "SQS"),
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for SendMessageTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<SendMessageInput>()
        else {
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for SendMessageEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "SendMessageEndpointParamsInterceptor"
    }
