...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ReceiveMessage {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::orchestrator::Metadata::new("ReceiveMessage", "SQS"),
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for ReceiveMessageTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) =
            context.input().downcast_ref::<ReceiveMessageInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for ReceiveMessageResponseDeserializer
{
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_receive_message::de_receive_message_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for ReceiveMessageRequestSerializer
{
    #[allow(
        unused_mut,
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for ReceiveMessageEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "ReceiveMessageEndpointParamsInterceptor"
    }
