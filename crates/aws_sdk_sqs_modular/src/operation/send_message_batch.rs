...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for SendMessageBatchTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) =
            context.input().downcast_ref::<SendMessageBatchInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for SendMessageBatchResponseDeserializer
{
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for SendMessageBatchRequestSerializer
{
    #[allow(
        unused_mut,
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for SendMessageBatchEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "SendMessageBatchEndpointParamsInterceptor"
    }
...
impl SendMessageBatchError {
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::BatchEntryIdsNotDistinct(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            }
            Self::BatchRequestTooLong(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            }
            Self::EmptyBatchRequest(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            }
            Self::InvalidAddress(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            }
            Self::InvalidBatchEntryId(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            }
            Self::InvalidSecurity(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            }
            Self::KmsAccessDenied(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            }
            Self::KmsDisabled(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            }
            Self::KmsInvalidKeyUsage(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            }
            Self::KmsInvalidState(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            }
            Self::KmsNotFound(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            ...
            Self::TooManyEntriesInBatchRequest(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            }
...
impl ::aws_types::request_id::RequestId
    for crate::operation::send_message_batch::SendMessageBatchError
{
