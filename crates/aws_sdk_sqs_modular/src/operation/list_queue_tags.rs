...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListQueueTags {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::orchestrator::Metadata::new("ListQueueTags", "SQS"),
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for ListQueueTagsTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) =
            context.input().downcast_ref::<ListQueueTagsInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for ListQueueTagsResponseDeserializer
{
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for ListQueueTagsEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "ListQueueTagsEndpointParamsInterceptor"
    }
