...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for GetQueueAttributesTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) =
            context.input().downcast_ref::<GetQueueAttributesInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for GetQueueAttributesResponseDeserializer
{
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for GetQueueAttributesRequestSerializer
{
    #[allow(
        unused_mut,
    ...
    > {
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_queue_attributes::ser_get_queue_attributes_input(
                &input,
            )?,
        );
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for GetQueueAttributesEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "GetQueueAttributesEndpointParamsInterceptor"
    }
