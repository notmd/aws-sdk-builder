...
impl Builder {
    ...
    pub fn token_provider(
        mut self,
        token_provider: impl crate::config::ProvideToken + 'static,
    ) -> Self {
        self.set_token_provider(
            ::std::option::Option::Some(::aws_smithy_runtime_api::shared::IntoShared::<
...
impl ServiceRuntimePlugin {
    pub fn new(_service_config: crate::config::Config) -> Self {
        let config = {
            let mut cfg =
                ::aws_smithy_types::config_bag::Layer::new("AmazonBedrockFrontendService");
...
impl From<&::aws_types::sdk_config::SdkConfig> for Builder {
    fn from(input: &::aws_types::sdk_config::SdkConfig) -> Self {
        ...
        if let ::std::option::Option::Some(val) = input.service_config().and_then(|conf| {
            ...
            if !input
                .get_origin("auth_scheme_preference")
                .is_client_config()
            {
