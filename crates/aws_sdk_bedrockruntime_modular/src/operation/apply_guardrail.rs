...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for ApplyGuardrailTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) =
            context.input().downcast_ref::<ApplyGuardrailInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for ApplyGuardrailResponseDeserializer
{
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_apply_guardrail::de_apply_guardrail_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_apply_guardrail::de_apply_guardrail_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for ApplyGuardrailRequestSerializer
{
    #[allow(
        unused_mut,
    ...
    > {
        ...
        let mut request_builder = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError>
            {
                ...
                let guardrail_identifier = ::aws_smithy_http::label::fmt_string(
                    input_1,
                ...
                let guardrail_version = ::aws_smithy_http::label::fmt_string(
                    input_2,
                    ::aws_smithy_http::label::EncodingStrategy::Default,
                );
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for ApplyGuardrailEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "ApplyGuardrailEndpointParamsInterceptor"
    }
