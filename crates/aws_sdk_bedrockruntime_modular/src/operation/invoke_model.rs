...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for InvokeModelTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<InvokeModelInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for InvokeModelResponseDeserializer
{
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_invoke_model::de_invoke_model_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_invoke_model::de_invoke_model_http_response(
                status, headers, body,
            )
        };
    ...
    > {
        ...
        let mut request_builder = {
            ...
            > {
                ...
                let builder = crate::protocol_serde::shape_invoke_model::ser_invoke_model_headers(
                    input, builder,
                )?;
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for InvokeModelEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "InvokeModelEndpointParamsInterceptor"
    }
...
impl InvokeModelError {
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::ModelErrorException(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            }
            Self::ModelNotReadyException(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            }
            Self::ModelTimeoutException(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            }
...
impl ::aws_smithy_types::retry::ProvideErrorKind for InvokeModelError {
    ...
    fn retryable_error_kind(&self) -> ::std::option::Option<::aws_smithy_types::retry::ErrorKind> {
        match self {
            Self::ModelNotReadyException(inner) => {
