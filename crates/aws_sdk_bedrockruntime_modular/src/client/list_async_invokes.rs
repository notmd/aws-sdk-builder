...
impl super::Client {
    ...
    pub fn list_async_invokes(
        &self,
    ) -> crate::operation::list_async_invokes::builders::ListAsyncInvokesFluentBuilder {
        crate::operation::list_async_invokes::builders::ListAsyncInvokesFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
