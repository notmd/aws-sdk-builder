...
//! aws-sdk-bedrockruntime = "1.141.0"
...
//!
//! ```rust,no_run
//! use aws_sdk_bedrockruntime_modular as bedrockruntime;
//!
//! #[::tokio::main]
...
//! ```
//!
//! See the [client documentation](https://docs.rs/aws-sdk-bedrockruntime/latest/aws_sdk_bedrockruntime_modular/client/struct.Client.html)
