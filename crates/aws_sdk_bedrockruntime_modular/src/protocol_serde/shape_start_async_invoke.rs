...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::start_async_invoke::StartAsyncInvokeError::unhandled(generic),
            )
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_start_async_invoke::de_start_async_invoke(
            _response_body,
            output,
        )
        .map_err(crate::operation::start_async_invoke::StartAsyncInvokeError::unhandled)?;
...
> {
    ...
    crate::protocol_serde::shape_start_async_invoke_input::ser_start_async_invoke_input_input(
        &mut object,
        input,
    )?;
    object.finish();
