...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::converse::ConverseError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "AccessDeniedException" => {
            crate::operation::converse::ConverseError::AccessDeniedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InternalServerException" => {
            crate::operation::converse::ConverseError::InternalServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "ModelNotReadyException" => {
            crate::operation::converse::ConverseError::ModelNotReadyException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "ModelTimeoutException" => {
            crate::operation::converse::ConverseError::ModelTimeoutException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "ResourceNotFoundException" => {
            crate::operation::converse::ConverseError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "ServiceUnavailableException" => {
            crate::operation::converse::ConverseError::ServiceUnavailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                match key.to_unescaped()?.as_ref() {
                    "additionalModelResponseFields" => {
                        builder = builder.set_additional_model_response_fields(Some(
                            ::aws_smithy_json::deserialize::token::expect_document(tokens)?,
                        ));
                    }
                    "metrics" => {
                        builder = builder.set_metrics(
                            crate::protocol_serde::shape_converse_metrics::de_converse_metrics(
                                tokens,
                                _value,
                                depth + 1,
                            )?,
                    ...
                    "output" => {
                        builder = builder.set_output(
                            crate::protocol_serde::shape_converse_output::de_converse_output(
                                tokens,
                                _value,
                                depth + 1,
                            )?,
                    ...
                    "serviceTier" => {
                        builder = builder.set_service_tier(
                            crate::protocol_serde::shape_service_tier::de_service_tier(
                                tokens,
                                _value,
                                depth + 1,
                            )?,
                    ...
                    "stopReason" => {
                        builder = builder.set_stop_reason(
                            ...
                            .map(|s| {
                                s.to_unescaped()
                                    .map(|u| crate::types::StopReason::from(u.as_ref()))
                            })
                            .transpose()?,
                        );
                    }
                    "trace" => {
                        builder = builder.set_trace(
                            crate::protocol_serde::shape_converse_trace::de_converse_trace(
                                tokens,
                                _value,
                                depth + 1,
                            )?,
                    ...
                    "usage" => {
                        builder = builder.set_usage(
                            crate::protocol_serde::shape_token_usage::de_token_usage(
                                tokens,
                                _value,
                                depth + 1,
                            )?,
