...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::list_async_invokes::ListAsyncInvokesError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
        "AccessDeniedException" => {
            crate::operation::list_async_invokes::ListAsyncInvokesError::AccessDeniedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InternalServerException" => {
            crate::operation::list_async_invokes::ListAsyncInvokesError::InternalServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "ThrottlingException" => {
            crate::operation::list_async_invokes::ListAsyncInvokesError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "ValidationException" => {
            crate::operation::list_async_invokes::ListAsyncInvokesError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_async_invokes::de_list_async_invokes(
            _response_body,
            output,
        )
        .map_err(crate::operation::list_async_invokes::ListAsyncInvokesError::unhandled)?;
