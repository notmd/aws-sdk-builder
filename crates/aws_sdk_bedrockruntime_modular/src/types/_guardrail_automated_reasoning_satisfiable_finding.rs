...
pub struct GuardrailAutomatedReasoningSatisfiableFinding {
    ...
    pub claims_true_scenario:
        ::std::option::Option<crate::types::GuardrailAutomatedReasoningScenario>,
    /// <p>An example scenario demonstrating how the claims could be logically false.</p>
    pub claims_false_scenario:
        ::std::option::Option<crate::types::GuardrailAutomatedReasoningScenario>,
...
impl GuardrailAutomatedReasoningSatisfiableFinding {
    ...
    /// <p>An example scenario demonstrating how the claims could be logically true.</p>
    pub fn claims_true_scenario(
        &self,
    ) -> ::std::option::Option<&crate::types::GuardrailAutomatedReasoningScenario> {
        self.claims_true_scenario.as_ref()
    }
    /// <p>An example scenario demonstrating how the claims could be logically false.</p>
    pub fn claims_false_scenario(
        &self,
    ) -> ::std::option::Option<&crate::types::GuardrailAutomatedReasoningScenario> {
...
pub struct GuardrailAutomatedReasoningSatisfiableFindingBuilder {
    pub(crate) translation:
        ::std::option::Option<crate::types::GuardrailAutomatedReasoningTranslation>,
    pub(crate) claims_true_scenario:
        ::std::option::Option<crate::types::GuardrailAutomatedReasoningScenario>,
    pub(crate) claims_false_scenario:
        ::std::option::Option<crate::types::GuardrailAutomatedReasoningScenario>,
...
impl GuardrailAutomatedReasoningSatisfiableFindingBuilder {
    ...
    /// <p>An example scenario demonstrating how the claims could be logically true.</p>
    pub fn set_claims_true_scenario(
        mut self,
        input: ::std::option::Option<crate::types::GuardrailAutomatedReasoningScenario>,
    ) -> Self {
        self.claims_true_scenario = input;
        self
    }
    /// <p>An example scenario demonstrating how the claims could be logically true.</p>
    pub fn get_claims_true_scenario(
        &self,
    ) -> &::std::option::Option<crate::types::GuardrailAutomatedReasoningScenario> {
    ...
    /// <p>An example scenario demonstrating how the claims could be logically false.</p>
    pub fn set_claims_false_scenario(
        mut self,
        input: ::std::option::Option<crate::types::GuardrailAutomatedReasoningScenario>,
    ) -> Self {
    ...
    /// <p>An example scenario demonstrating how the claims could be logically false.</p>
    pub fn get_claims_false_scenario(
        &self,
    ) -> &::std::option::Option<crate::types::GuardrailAutomatedReasoningScenario> {
