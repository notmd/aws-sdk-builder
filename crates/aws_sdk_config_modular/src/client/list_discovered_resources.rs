...
impl super::Client {
    ...
    ///   - [`resource_ids(impl Into<String>)`](crate::operation::list_discovered_resources::builders::ListDiscoveredResourcesFluentBuilder::resource_ids) / [`set_resource_ids(Option<Vec::<String>>)`](crate::operation::list_discovered_resources::builders::ListDiscoveredResourcesFluentBuilder::set_resource_ids):<br>required: **false**<br><p>The IDs of only those resources that you want Config to list in the response. If you do not specify this parameter, Config lists all resources of the specified type that it has discovered. You can list a minimum of 1 resourceID and a maximum of 20 resourceIds.</p><br>
    ///   - [`resource_name(impl Into<String>)`](crate::operation::list_discovered_resources::builders::ListDiscoveredResourcesFluentBuilder::resource_name) / [`set_resource_name(Option<String>)`](crate::operation::list_discovered_resources::builders::ListDiscoveredResourcesFluentBuilder::set_resource_name):<br>required: **false**<br><p>The custom name of only those resources that you want Config to list in the response. If you do not specify this parameter, Config lists all resources of the specified type that it has discovered.</p><br>
    ///   - [`limit(i32)`](crate::operation::list_discovered_resources::builders::ListDiscoveredResourcesFluentBuilder::limit) / [`set_limit(Option<i32>)`](crate::operation::list_discovered_resources::builders::ListDiscoveredResourcesFluentBuilder::set_limit):<br>required: **false**<br><p>The maximum number of resource identifiers returned on each page. The default is 100. You cannot specify a number greater than 100. If you specify 0, Config uses the default.</p><br>
    ///   - [`include_deleted_resources(bool)`](crate::operation::list_discovered_resources::builders::ListDiscoveredResourcesFluentBuilder::include_deleted_resources) / [`set_include_deleted_resources(Option<bool>)`](crate::operation::list_discovered_resources::builders::ListDiscoveredResourcesFluentBuilder::set_include_deleted_resources):<br>required: **false**<br><p>Specifies whether Config includes deleted resources in the results. By default, deleted resources are not included.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_discovered_resources::builders::ListDiscoveredResourcesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_discovered_resources::builders::ListDiscoveredResourcesFluentBuilder::set_next_token):<br>required: **false**<br><p>The <code>nextToken</code> string returned on a previous page that you use to get the next page of results in a paginated response.</p><br>
