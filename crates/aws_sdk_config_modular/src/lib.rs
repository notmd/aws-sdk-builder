...
//!
//! ```rust,no_run
//! use aws_sdk_config_modular as config;
//!
//! #[::tokio::main]
//! async fn main() -> Result<(), config::Error> {
//!     let config = aws_config::load_from_env().await;
//!     let client = aws_sdk_config_modular::Client::new(&config);
//!
...
//! ```
//!
//! See the [client documentation](https://docs.rs/aws-sdk-config/latest/aws_sdk_config_modular/client/struct.Client.html)
...
/// let config = aws_sdk_config_modular::config::Builder::from(&sdk_config)
/// # /*
