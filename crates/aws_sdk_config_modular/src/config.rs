...
/// Configuration for a aws_sdk_config_modular service client.
///
...
impl Builder {
    ...
    /// use aws_sdk_config_modular::config::Config;
    ...
    /// # fn example() {
    /// use std::time::Duration;
    /// use aws_sdk_config_modular::config::{Builder, Config};
    /// use aws_smithy_runtime::client::http::hyper_014::HyperClientBuilder;
    ///
    ...
    /// }
    ///
    /// let mut builder = aws_sdk_config_modular::Config::builder();
    ...
    /// impl aws_sdk_config_modular::config::auth::ResolveAuthScheme for CustomAuthSchemeResolver {
    ///     fn resolve_auth_scheme<'a>(
    ///         &'a self,
    ///         _params: &'a aws_sdk_config_modular::config::auth::Params,
    ///         _cfg: &'a ConfigBag,
    ///         _runtime_components: &'a RuntimeComponents,
    ...
    /// }
    ///
    /// let config = aws_sdk_config_modular::Config::builder()
    ...
    ///     // ...
    ///     .build();
    /// let client = aws_sdk_config_modular::Client::from_conf(config);
    /// ```
    ...
    /// rules for `aws_sdk_config_modular`.
    ///
    ///
    ...
    /// ```no_run
    /// use aws_sdk_config_modular::config::endpoint::{ResolveEndpoint, EndpointFuture, Params, Endpoint};
    /// #[derive(Debug)]
    ...
    /// let config = aws_sdk_config_modular::Config::builder().endpoint_resolver(resolver).build();
    /// let client = aws_sdk_config_modular::Client::from_conf(config);
    /// ```
    ...
    /// ```no_run
    /// use aws_sdk_config_modular::config::Config;
    /// use aws_sdk_config_modular::config::retry::RetryConfig;
    ///
    ...
    ///
    /// ```no_run
    /// use aws_sdk_config_modular::config::{AsyncSleep, Config, SharedAsyncSleep, Sleep};
    ///
    /// #[derive(Debug)]
    ...
    ///
    /// ```no_run
    /// use aws_sdk_config_modular::config::{AsyncSleep, Builder, Config, SharedAsyncSleep, Sleep};
    ///
    /// #[derive(Debug)]
    /// pub struct ForeverSleep;
    ///
    ...
    /// # use std::time::Duration;
    /// use aws_sdk_config_modular::config::Config;
    /// use aws_sdk_config_modular::config::timeout::TimeoutConfig;
    ///
    ...
    /// ```no_run
    /// use aws_sdk_config_modular::config::Config;
    /// use aws_sdk_config_modular::config::retry::{RetryPartition, TokenBucket};
    ///
    ...
    /// ```no_run
    /// use aws_sdk_config_modular::config::Config;
    /// use aws_sdk_config_modular::config::retry::{ClientRateLimiter, RetryConfig, RetryPartition};
    ///
    ...
    /// ```no_run
    /// use aws_sdk_config_modular::config::IdentityCache;
    ///
    /// let config = aws_sdk_config_modular::Config::builder()
    ...
    /// #    fn meta(&self) -> &aws_sdk_config_modular::error::ErrorMetadata { todo!() }
    /// # }
    ///
    ...
    /// ```no_run
    /// use aws_sdk_config_modular::config::BehaviorVersion;
    ///
    /// let config = aws_sdk_config_modular::Config::builder()
