    ...
    for PutConfigurationRecorderResponseDeserializer
{
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_put_configuration_recorder::de_put_configuration_recorder_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_put_configuration_recorder::de_put_configuration_recorder_http_response(status, headers, body)
        };
