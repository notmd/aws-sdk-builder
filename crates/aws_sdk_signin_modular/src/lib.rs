...
//!
//! ```rust,ignore
//! use aws_sdk_signin_modular as signin;
//!
//! #[::tokio::main]
//! async fn main() -> Result<(), signin::Error> {
//!     let config = aws_config::load_from_env().await;
//!     let client = aws_sdk_signin_modular::Client::new(&config);
//!
...
//! ```
//!
//! See the [client documentation](https://docs.rs/aws-sdk-signin/latest/aws_sdk_signin_modular/client/struct.Client.html)
