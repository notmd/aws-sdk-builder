...
> {
    ...
    Err(match error_code {
        "AccessDeniedException" => {
            crate::operation::describe_repository::DescribeRepositoryError::AccessDeniedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InternalServerException" => {
            crate::operation::describe_repository::DescribeRepositoryError::InternalServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            crate::operation::describe_repository::DescribeRepositoryError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ThrottlingException" => crate::operation::describe_repository::DescribeRepositoryError::ThrottlingException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                ...
                output = output.set_retry_after_seconds(
                    crate::protocol_serde::shape_throttling_exception::de_retry_after_seconds_header(_response_headers)
                        .map_err(|_| {
                            crate::operation::describe_repository::DescribeRepositoryError::unhandled(
        ...
        "ValidationException" => crate::operation::describe_repository::DescribeRepositoryError::ValidationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => crate::operation::describe_repository::DescribeRepositoryError::generic(generic),
    })
}
...
pub(crate) fn de_describe_repository(
    _value: &[u8],
    mut builder: crate::operation::describe_repository::builders::DescribeRepositoryOutputBuilder,
) -> ::std::result::Result<
