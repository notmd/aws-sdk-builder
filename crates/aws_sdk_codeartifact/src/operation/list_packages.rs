...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for ListPackagesTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) =
            context.input().downcast_ref::<ListPackagesInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for ListPackagesResponseDeserializer
{
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_packages::de_list_packages_http_error(
                status, headers, body,
            )
        } else {
                ...
                if let ::std::option::Option::Some(inner_9) = &_input.publish {
                    {
                        query.push_kv(
                            "publish",
                            &::aws_smithy_http::query::fmt_string(inner_9.as_str()),
                        );
                    }
                }
                if let ::std::option::Option::Some(inner_10) = &_input.upstream {
                    {
                        query.push_kv(
                            "upstream",
                            &::aws_smithy_http::query::fmt_string(inner_10.as_str()),
                        );
                    }
                }
                ::std::result::Result::Ok(())
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for ListPackagesEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "ListPackagesEndpointParamsInterceptor"
    }
