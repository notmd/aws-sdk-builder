...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::schedule_key_deletion::ScheduleKeyDeletionError::unhandled(
                    generic,
                ),
            )
        }
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_schedule_key_deletion::de_schedule_key_deletion(
            _response_body,
            output,
        )
        .map_err(crate::operation::schedule_key_deletion::ScheduleKeyDeletionError::unhandled)?;
