...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::generate_data_key_pair::GenerateDataKeyPairError::unhandled(
                    generic,
                ),
            )
        }
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_generate_data_key_pair::de_generate_data_key_pair(
            _response_body,
            output,
        )
        .map_err(crate::operation::generate_data_key_pair::GenerateDataKeyPairError::unhandled)?;
