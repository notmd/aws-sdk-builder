...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::enable_key::EnableKeyError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "DependencyTimeoutException" => {
            crate::operation::enable_key::EnableKeyError::DependencyTimeoutException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidArnException" => {
            crate::operation::enable_key::EnableKeyError::InvalidArnException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "KMSInternalException" => {
            crate::operation::enable_key::EnableKeyError::KmsInternalException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "KMSInvalidStateException" => {
            crate::operation::enable_key::EnableKeyError::KmsInvalidStateException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "LimitExceededException" => {
            crate::operation::enable_key::EnableKeyError::LimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
> {
    ...
    crate::protocol_serde::shape_enable_key_input::ser_enable_key_input_input(&mut object, input)?;
    object.finish();
