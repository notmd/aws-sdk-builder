...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::generate_random::GenerateRandomError::unhandled(generic))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_generate_random::de_generate_random(
            _response_body,
            output,
        )
        .map_err(crate::operation::generate_random::GenerateRandomError::unhandled)?;
...
> {
    ...
    crate::protocol_serde::shape_generate_random_input::ser_generate_random_input_input(
        &mut object,
        input,
    )?;
    object.finish();
