...
pub(crate) fn de_rotations_list_entry<'a, I>(
    ...
    Option<crate::types::RotationsListEntry>,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "ImportState" => {
                                builder = builder.set_import_state(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped()
                                            .map(|u| crate::types::ImportState::from(u.as_ref()))
                                    })
                                    .transpose()?,
                                );
                            }
                                ...
                                builder = builder.set_key_material_state(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped().map(|u| {
                                            crate::types::KeyMaterialState::from(u.as_ref())
                                        })
                                    })
                                    .transpose()?,
                                );
                            ...
                            "RotationType" => {
                                builder = builder.set_rotation_type(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped()
                                            .map(|u| crate::types::RotationType::from(u.as_ref()))
                                    })
                                    .transpose()?,
                                );
                            }
