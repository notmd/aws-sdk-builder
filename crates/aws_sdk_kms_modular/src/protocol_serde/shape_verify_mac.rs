...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::verify_mac::VerifyMacError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "DryRunOperationException" => {
            crate::operation::verify_mac::VerifyMacError::DryRunOperationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidGrantTokenException" => {
            crate::operation::verify_mac::VerifyMacError::InvalidGrantTokenException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidKeyUsageException" => {
            crate::operation::verify_mac::VerifyMacError::InvalidKeyUsageException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "KeyUnavailableException" => {
            crate::operation::verify_mac::VerifyMacError::KeyUnavailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "KMSInternalException" => {
            crate::operation::verify_mac::VerifyMacError::KmsInternalException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "KMSInvalidMacException" => {
            crate::operation::verify_mac::VerifyMacError::KmsInvalidMacException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "KMSInvalidStateException" => {
            crate::operation::verify_mac::VerifyMacError::KmsInvalidStateException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
