...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_key::DescribeKeyError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "DependencyTimeoutException" => {
            crate::operation::describe_key::DescribeKeyError::DependencyTimeoutException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidArnException" => {
            crate::operation::describe_key::DescribeKeyError::InvalidArnException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "KMSInternalException" => {
            crate::operation::describe_key::DescribeKeyError::KmsInternalException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "NotFoundException" => {
            crate::operation::describe_key::DescribeKeyError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
> {
    ...
    crate::protocol_serde::shape_describe_key_input::ser_describe_key_input_input(
        &mut object,
        input,
    )?;
    object.finish();
                ...
                match key.to_unescaped()?.as_ref() {
                    "KeyMetadata" => {
                        builder = builder.set_key_metadata(
                            crate::protocol_serde::shape_key_metadata::de_key_metadata(
                                tokens,
                                _value,
                                depth + 1,
                            )?,
