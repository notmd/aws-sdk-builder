...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::generate_data_key::GenerateDataKeyError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
        "DependencyTimeoutException" => {
            crate::operation::generate_data_key::GenerateDataKeyError::DependencyTimeoutException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "DisabledException" => {
            crate::operation::generate_data_key::GenerateDataKeyError::DisabledException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "DryRunOperationException" => {
            crate::operation::generate_data_key::GenerateDataKeyError::DryRunOperationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidGrantTokenException" => {
            crate::operation::generate_data_key::GenerateDataKeyError::InvalidGrantTokenException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidKeyUsageException" => {
            crate::operation::generate_data_key::GenerateDataKeyError::InvalidKeyUsageException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "KeyUnavailableException" => {
            crate::operation::generate_data_key::GenerateDataKeyError::KeyUnavailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "KMSInternalException" => {
            crate::operation::generate_data_key::GenerateDataKeyError::KmsInternalException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "KMSInvalidStateException" => {
            crate::operation::generate_data_key::GenerateDataKeyError::KmsInvalidStateException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "NotFoundException" => {
            crate::operation::generate_data_key::GenerateDataKeyError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_generate_data_key::de_generate_data_key(
            _response_body,
            output,
        )
        .map_err(crate::operation::generate_data_key::GenerateDataKeyError::unhandled)?;
...
> {
    ...
    crate::protocol_serde::shape_generate_data_key_input::ser_generate_data_key_input_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub(crate) fn de_generate_data_key(
    ...
    crate::operation::generate_data_key::builders::GenerateDataKeyOutputBuilder,
