...
impl super::Client {
    ...
    pub fn get_key_last_usage(
        &self,
    ) -> crate::operation::get_key_last_usage::builders::GetKeyLastUsageFluentBuilder {
        crate::operation::get_key_last_usage::builders::GetKeyLastUsageFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
