...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RevokeGrant {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::orchestrator::Metadata::new("RevokeGrant", "KMS"),
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for RevokeGrantTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RevokeGrantInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for RevokeGrantResponseDeserializer
{
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_revoke_grant::de_revoke_grant_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_revoke_grant::de_revoke_grant_http_response(
                status, headers, body,
            )
        };
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for RevokeGrantEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "RevokeGrantEndpointParamsInterceptor"
    }
...
impl RevokeGrantError {
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::InvalidGrantIdException(e) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e)
            }
