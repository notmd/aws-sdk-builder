...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GenerateRandom {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::orchestrator::Metadata::new("GenerateRandom", "KMS"),
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for GenerateRandomTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) =
            context.input().downcast_ref::<GenerateRandomInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for GenerateRandomResponseDeserializer
{
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_generate_random::de_generate_random_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_generate_random::de_generate_random_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for GenerateRandomRequestSerializer
{
    #[allow(
        unused_mut,
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for GenerateRandomEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "GenerateRandomEndpointParamsInterceptor"
    }
