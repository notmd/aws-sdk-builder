...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListKeyPolicies {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::orchestrator::Metadata::new("ListKeyPolicies", "KMS"),
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for ListKeyPoliciesTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) =
            context.input().downcast_ref::<ListKeyPoliciesInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for ListKeyPoliciesResponseDeserializer
{
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for ListKeyPoliciesRequestSerializer
{
    #[allow(
        unused_mut,
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for ListKeyPoliciesEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "ListKeyPoliciesEndpointParamsInterceptor"
    }
...
impl ::aws_types::request_id::RequestId
    for crate::operation::list_key_policies::ListKeyPoliciesError
{
