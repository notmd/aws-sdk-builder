...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for UpdatePrimaryRegionTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) =
            context.input().downcast_ref::<UpdatePrimaryRegionInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for UpdatePrimaryRegionResponseDeserializer
{
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for UpdatePrimaryRegionRequestSerializer
{
    #[allow(
        unused_mut,
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for UpdatePrimaryRegionEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "UpdatePrimaryRegionEndpointParamsInterceptor"
    }
