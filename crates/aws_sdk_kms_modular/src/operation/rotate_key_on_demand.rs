...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for RotateKeyOnDemandTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) =
            context.input().downcast_ref::<RotateKeyOnDemandInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for RotateKeyOnDemandResponseDeserializer
{
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_rotate_key_on_demand::de_rotate_key_on_demand_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for RotateKeyOnDemandRequestSerializer
{
    #[allow(
        unused_mut,
    ...
    > {
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_rotate_key_on_demand::ser_rotate_key_on_demand_input(
                &input,
            )?,
        );
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for RotateKeyOnDemandEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "RotateKeyOnDemandEndpointParamsInterceptor"
    }
...
impl ::aws_types::request_id::RequestId
    for crate::operation::rotate_key_on_demand::RotateKeyOnDemandError
{
