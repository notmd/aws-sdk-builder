...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisableKey {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::orchestrator::Metadata::new("DisableKey", "KMS"),
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for DisableKeyTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DisableKeyInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for DisableKeyResponseDeserializer
{
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for DisableKeyEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "DisableKeyEndpointParamsInterceptor"
    }
