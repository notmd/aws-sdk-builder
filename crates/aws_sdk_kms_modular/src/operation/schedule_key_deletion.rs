...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for ScheduleKeyDeletionTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) =
            context.input().downcast_ref::<ScheduleKeyDeletionInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for ScheduleKeyDeletionResponseDeserializer
{
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for ScheduleKeyDeletionRequestSerializer
{
    #[allow(
        unused_mut,
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for ScheduleKeyDeletionEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "ScheduleKeyDeletionEndpointParamsInterceptor"
    }
...
impl ::aws_types::request_id::RequestId
    for crate::operation::schedule_key_deletion::ScheduleKeyDeletionError
{
