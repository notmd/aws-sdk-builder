...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for GenerateDataKeyPairTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) =
            context.input().downcast_ref::<GenerateDataKeyPairInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for GenerateDataKeyPairResponseDeserializer
{
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for GenerateDataKeyPairRequestSerializer
{
    #[allow(
        unused_mut,
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for GenerateDataKeyPairEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "GenerateDataKeyPairEndpointParamsInterceptor"
    }
