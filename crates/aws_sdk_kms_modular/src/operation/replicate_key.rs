...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ReplicateKey {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::orchestrator::Metadata::new("ReplicateKey", "KMS"),
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for ReplicateKeyTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) =
            context.input().downcast_ref::<ReplicateKeyInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for ReplicateKeyResponseDeserializer
{
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_replicate_key::de_replicate_key_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_replicate_key::de_replicate_key_http_response(
                status, headers, body,
            )
        };
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for ReplicateKeyEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "ReplicateKeyEndpointParamsInterceptor"
    }
