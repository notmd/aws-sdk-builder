...
impl ListResourceTagsPaginator {
    ...
    pub fn items(self) -> crate::operation::list_resource_tags::paginator::ListResourceTagsPaginatorItems {
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_resource_tags::ListResourceTags::orchestrate(&runtime_plugins, input.clone()).await;
