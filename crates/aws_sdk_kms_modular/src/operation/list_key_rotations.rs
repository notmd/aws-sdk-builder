...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for ListKeyRotationsTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) =
            context.input().downcast_ref::<ListKeyRotationsInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for ListKeyRotationsResponseDeserializer
{
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_key_rotations::de_list_key_rotations_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_key_rotations::de_list_key_rotations_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for ListKeyRotationsRequestSerializer
{
    #[allow(
        unused_mut,
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for ListKeyRotationsEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "ListKeyRotationsEndpointParamsInterceptor"
    }
...
impl ::aws_types::request_id::RequestId
    for crate::operation::list_key_rotations::ListKeyRotationsError
{
