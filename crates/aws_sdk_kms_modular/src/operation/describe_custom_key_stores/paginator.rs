...
impl DescribeCustomKeyStoresPaginator {
    ...
    pub fn items(self) -> crate::operation::describe_custom_key_stores::paginator::DescribeCustomKeyStoresPaginatorItems{
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(
            ::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            crate::operation::describe_custom_key_stores::DescribeCustomKeyStores::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_describe_custom_key_stores_output_output_next_marker(resp);
