...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutKeyPolicy {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::orchestrator::Metadata::new("PutKeyPolicy", "KMS"),
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for PutKeyPolicyTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) =
            context.input().downcast_ref::<PutKeyPolicyInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for PutKeyPolicyResponseDeserializer
{
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_put_key_policy::de_put_key_policy_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_put_key_policy::de_put_key_policy_http_response(
                status, headers, body,
            )
        };
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for PutKeyPolicyEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "PutKeyPolicyEndpointParamsInterceptor"
    }
