...
impl super::Client {
    /// Constructs a fluent builder for the [`GetDelegationRequest`](crate::operation::get_delegation_request::builders::GetDelegationRequestFluentBuilder) operation.
    ///
    /// - The fluent builder is configurable:
    ///   - [`delegation_request_id(impl Into<String>)`](crate::operation::get_delegation_request::builders::GetDelegationRequestFluentBuilder::delegation_request_id) / [`set_delegation_request_id(Option<String>)`](crate::operation::get_delegation_request::builders::GetDelegationRequestFluentBuilder::set_delegation_request_id):<br>required: **true**<br><p>The unique identifier of the delegation request to retrieve.</p><br>
    ///   - [`delegation_permission_check(bool)`](crate::operation::get_delegation_request::builders::GetDelegationRequestFluentBuilder::delegation_permission_check) / [`set_delegation_permission_check(Option<bool>)`](crate::operation::get_delegation_request::builders::GetDelegationRequestFluentBuilder::set_delegation_permission_check):<br>required: **false**<br><p>Specifies whether to perform a permission check for the delegation request.</p> <p>If set to true, the <code>GetDelegationRequest</code> API call will start a permission check process. This process calculates whether the caller has sufficient permissions to cover the asks from this delegation request.</p> <p>Setting this parameter to true does not guarantee an answer in the response. See the <code>PermissionCheckStatus</code> and the <code>PermissionCheckResult</code> response attributes for further details.</p><br>
    /// - On success, responds with [`GetDelegationRequestOutput`](crate::operation::get_delegation_request::GetDelegationRequestOutput) with field(s):
    ///   - [`delegation_request(Option<DelegationRequest>)`](crate::operation::get_delegation_request::GetDelegationRequestOutput::delegation_request): <p>The delegation request object containing all details about the request.</p>
