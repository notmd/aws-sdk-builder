...
impl super::Client {
    ...
    ///   - [`tags(Vec::<Tag>)`](crate::operation::list_policy_tags::ListPolicyTagsOutput::tags): <p>The list of tags that are currently attached to the IAM customer managed policy. Each tag consists of a key name and an associated value. If no tags are attached to the specified resource, the response contains an empty list.</p>
