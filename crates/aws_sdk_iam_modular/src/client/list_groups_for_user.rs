...
impl super::Client {
    ...
    ///   - [`user_name(impl Into<String>)`](crate::operation::list_groups_for_user::builders::ListGroupsForUserFluentBuilder::user_name) / [`set_user_name(Option<String>)`](crate::operation::list_groups_for_user::builders::ListGroupsForUserFluentBuilder::set_user_name):<br>required: **true**<br><p>The name of the user to list groups for.</p> <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p><br>
    ///   - [`marker(impl Into<String>)`](crate::operation::list_groups_for_user::builders::ListGroupsForUserFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::list_groups_for_user::builders::ListGroupsForUserFluentBuilder::set_marker):<br>required: **false**<br><p>Use this parameter only when paginating results and only after you receive a response indicating that the results are truncated. Set it to the value of the <code>Marker</code> element in the response that you received to indicate where the next call should start.</p><br>
    ///   - [`max_items(i32)`](crate::operation::list_groups_for_user::builders::ListGroupsForUserFluentBuilder::max_items) / [`set_max_items(Option<i32>)`](crate::operation::list_groups_for_user::builders::ListGroupsForUserFluentBuilder::set_max_items):<br>required: **false**<br><p>Use this only when paginating results to indicate the maximum number of items you want in the response. If additional items exist beyond the maximum you specify, the <code>IsTruncated</code> response element is <code>true</code>.</p> <p>If you do not include this parameter, the number of items defaults to 100. Note that IAM might return fewer results, even when there are more results available. In that case, the <code>IsTruncated</code> response element returns <code>true</code>, and <code>Marker</code> contains a value to include in the subsequent call that tells the service where to continue from.</p><br>
    ...
    ///   - [`groups(Vec::<Group>)`](crate::operation::list_groups_for_user::ListGroupsForUserOutput::groups): <p>A list of groups.</p>
