...
impl super::Client {
    ...
    /// This operation supports pagination; See [`into_paginator()`](crate::operation::list_role_tags::builders::ListRoleTagsFluentBuilder::into_paginator).
    ///
    /// - The fluent builder is configurable:
    ///   - [`role_name(impl Into<String>)`](crate::operation::list_role_tags::builders::ListRoleTagsFluentBuilder::role_name) / [`set_role_name(Option<String>)`](crate::operation::list_role_tags::builders::ListRoleTagsFluentBuilder::set_role_name):<br>required: **true**<br><p>The name of the IAM role for which you want to see the list of tags.</p> <p>This parameter accepts (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters that consist of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p><br>
    ///   - [`marker(impl Into<String>)`](crate::operation::list_role_tags::builders::ListRoleTagsFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::list_role_tags::builders::ListRoleTagsFluentBuilder::set_marker):<br>required: **false**<br><p>Use this parameter only when paginating results and only after you receive a response indicating that the results are truncated. Set it to the value of the <code>Marker</code> element in the response that you received to indicate where the next call should start.</p><br>
    ///   - [`max_items(i32)`](crate::operation::list_role_tags::builders::ListRoleTagsFluentBuilder::max_items) / [`set_max_items(Option<i32>)`](crate::operation::list_role_tags::builders::ListRoleTagsFluentBuilder::set_max_items):<br>required: **false**<br><p>Use this only when paginating results to indicate the maximum number of items you want in the response. If additional items exist beyond the maximum you specify, the <code>IsTruncated</code> response element is <code>true</code>.</p> <p>If you do not include this parameter, the number of items defaults to 100. Note that IAM might return fewer results, even when there are more results available. In that case, the <code>IsTruncated</code> response element returns <code>true</code>, and <code>Marker</code> contains a value to include in the subsequent call that tells the service where to continue from.</p><br>
    /// - On success, responds with [`ListRoleTagsOutput`](crate::operation::list_role_tags::ListRoleTagsOutput) with field(s):
    ///   - [`tags(Vec::<Tag>)`](crate::operation::list_role_tags::ListRoleTagsOutput::tags): <p>The list of tags that are currently attached to the role. Each tag consists of a key name and an associated value. If no tags are attached to the specified resource, the response contains an empty list.</p>
