...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::disconnect_custom_key_store::DisconnectCustomKeyStoreError::unhandled(generic),
            )
        }
    };
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_disconnect_custom_key_store_input::ser_disconnect_custom_key_store_input_input(
        &mut object,
        input,
    )?;
    object.finish();
