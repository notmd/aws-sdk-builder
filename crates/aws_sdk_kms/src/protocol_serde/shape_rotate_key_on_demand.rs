...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_rotate_key_on_demand::de_rotate_key_on_demand(
            _response_body,
            output,
        )
        .map_err(crate::operation::rotate_key_on_demand::RotateKeyOnDemandError::unhandled)?;
...
> {
    ...
    crate::protocol_serde::shape_rotate_key_on_demand_input::ser_rotate_key_on_demand_input_input(
        &mut object,
        input,
    )?;
    object.finish();
