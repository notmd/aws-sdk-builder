...
> {
    ...
    Err(match error_code {
        "DependencyTimeoutException" => {
            crate::operation::update_key_description::UpdateKeyDescriptionError::DependencyTimeoutException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidArnException" => {
            crate::operation::update_key_description::UpdateKeyDescriptionError::InvalidArnException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "KMSInternalException" => {
            crate::operation::update_key_description::UpdateKeyDescriptionError::KmsInternalException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "KMSInvalidStateException" => {
            crate::operation::update_key_description::UpdateKeyDescriptionError::KmsInvalidStateException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NotFoundException" => {
            crate::operation::update_key_description::UpdateKeyDescriptionError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_update_key_description_input::ser_update_key_description_input_input(
        &mut object,
        input,
    )?;
    object.finish();
