...
> {
    ...
    Err(match error_code {
        "DependencyTimeoutException" => {
            crate::operation::delete_alias::DeleteAliasError::DependencyTimeoutException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "KMSInternalException" => {
            crate::operation::delete_alias::DeleteAliasError::KmsInternalException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "KMSInvalidStateException" => {
            crate::operation::delete_alias::DeleteAliasError::KmsInvalidStateException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "NotFoundException" => {
            crate::operation::delete_alias::DeleteAliasError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
> {
    ...
    crate::protocol_serde::shape_delete_alias_input::ser_delete_alias_input_input(
        &mut object,
        input,
    )?;
    object.finish();
