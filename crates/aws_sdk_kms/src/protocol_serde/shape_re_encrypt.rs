...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::re_encrypt::ReEncryptError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "DependencyTimeoutException" => {
            crate::operation::re_encrypt::ReEncryptError::DependencyTimeoutException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidCiphertextException" => {
            crate::operation::re_encrypt::ReEncryptError::InvalidCiphertextException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidGrantTokenException" => {
            crate::operation::re_encrypt::ReEncryptError::InvalidGrantTokenException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidKeyUsageException" => {
            crate::operation::re_encrypt::ReEncryptError::InvalidKeyUsageException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "KeyUnavailableException" => {
            crate::operation::re_encrypt::ReEncryptError::KeyUnavailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "KMSInternalException" => {
            crate::operation::re_encrypt::ReEncryptError::KmsInternalException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "KMSInvalidStateException" => {
            crate::operation::re_encrypt::ReEncryptError::KmsInvalidStateException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
pub(crate) fn de_re_encrypt(
    ...
    crate::operation::re_encrypt::builders::ReEncryptOutputBuilder,
