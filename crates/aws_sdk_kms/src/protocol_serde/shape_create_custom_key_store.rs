...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_create_custom_key_store::de_create_custom_key_store(_response_body, output)
                .map_err(crate::operation::create_custom_key_store::CreateCustomKeyStoreError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_create_custom_key_store_input::ser_create_custom_key_store_input_input(
        &mut object,
        input,
    )?;
    object.finish();
