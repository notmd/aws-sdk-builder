...
> {
    ...
    Err(match error_code {
        "DependencyTimeoutException" => {
            crate::operation::cancel_key_deletion::CancelKeyDeletionError::DependencyTimeoutException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "KMSInternalException" => {
            crate::operation::cancel_key_deletion::CancelKeyDeletionError::KmsInternalException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "KMSInvalidStateException" => {
            crate::operation::cancel_key_deletion::CancelKeyDeletionError::KmsInvalidStateException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
