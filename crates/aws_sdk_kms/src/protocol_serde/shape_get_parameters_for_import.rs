...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::get_parameters_for_import::GetParametersForImportError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        ...
        "InvalidArnException" => {
            crate::operation::get_parameters_for_import::GetParametersForImportError::InvalidArnException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "KMSInternalException" => {
            crate::operation::get_parameters_for_import::GetParametersForImportError::KmsInternalException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NotFoundException" => {
            crate::operation::get_parameters_for_import::GetParametersForImportError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_parameters_for_import::de_get_parameters_for_import(
            _response_body,
            output,
        )
        .map_err(crate::operation::get_parameters_for_import::GetParametersForImportError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_get_parameters_for_import_input::ser_get_parameters_for_import_input_input(
        &mut object,
        input,
    )?;
    object.finish();
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "ImportToken" => {
                    builder = builder.set_import_token(::aws_smithy_json::deserialize::token::expect_blob_or_null(
                        tokens.next(),
                    )?);
                }
                "PublicKey" => {
