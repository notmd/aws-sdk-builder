...
pub(crate) fn de_grant_list_entry<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::GrantListEntry>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<
        Item = Result<
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "Operations" => {
                                builder = builder.set_operations(
                                    crate::protocol_serde::shape_grant_operation_list::de_grant_operation_list(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
                            ...
                            "Constraints" => {
                                builder = builder.set_constraints(
                                    crate::protocol_serde::shape_grant_constraints::de_grant_constraints(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
