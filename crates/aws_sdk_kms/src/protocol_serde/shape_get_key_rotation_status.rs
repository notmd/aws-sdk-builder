...
> {
    ...
    Err(match error_code {
        "DependencyTimeoutException" => {
            crate::operation::get_key_rotation_status::GetKeyRotationStatusError::DependencyTimeoutException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidArnException" => {
            crate::operation::get_key_rotation_status::GetKeyRotationStatusError::InvalidArnException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "KMSInternalException" => {
            crate::operation::get_key_rotation_status::GetKeyRotationStatusError::KmsInternalException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "KMSInvalidStateException" => {
            crate::operation::get_key_rotation_status::GetKeyRotationStatusError::KmsInvalidStateException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NotFoundException" => {
            crate::operation::get_key_rotation_status::GetKeyRotationStatusError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_get_key_rotation_status::de_get_key_rotation_status(_response_body, output)
                .map_err(crate::operation::get_key_rotation_status::GetKeyRotationStatusError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_get_key_rotation_status_input::ser_get_key_rotation_status_input_input(
        &mut object,
        input,
    )?;
    object.finish();
        ...
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "OnDemandRotationStartDate" => {
                    builder = builder.set_on_demand_rotation_start_date(
                        ::aws_smithy_json::deserialize::token::expect_timestamp_or_null(
                            tokens.next(),
                            ::aws_smithy_types::date_time::Format::EpochSeconds,
                        )?,
