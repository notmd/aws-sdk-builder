...
> {
    ...
    Err(match error_code {
        "DependencyTimeoutException" => {
            crate::operation::list_retirable_grants::ListRetirableGrantsError::DependencyTimeoutException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidArnException" => {
            crate::operation::list_retirable_grants::ListRetirableGrantsError::InvalidArnException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidMarkerException" => {
            crate::operation::list_retirable_grants::ListRetirableGrantsError::InvalidMarkerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "KMSInternalException" => {
            crate::operation::list_retirable_grants::ListRetirableGrantsError::KmsInternalException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_list_retirable_grants_input::ser_list_retirable_grants_input_input(
        &mut object,
        input,
    )?;
    object.finish();
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "Grants" => {
                    builder = builder.set_grants(crate::protocol_serde::shape_grant_list::de_grant_list(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
