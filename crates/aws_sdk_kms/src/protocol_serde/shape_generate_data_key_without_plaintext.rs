...
> {
    ...
    let mut generic_builder =
        crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(
            crate::operation::generate_data_key_without_plaintext::GenerateDataKeyWithoutPlaintextError::unhandled,
        )?;
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_generate_data_key_without_plaintext::de_generate_data_key_without_plaintext(
                _response_body,
                output,
            )
            .map_err(
