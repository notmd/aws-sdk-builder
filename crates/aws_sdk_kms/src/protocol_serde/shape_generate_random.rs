...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::generate_random::GenerateRandomError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "CustomKeyStoreNotFoundException" => {
            crate::operation::generate_random::GenerateRandomError::CustomKeyStoreNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "DependencyTimeoutException" => {
            crate::operation::generate_random::GenerateRandomError::DependencyTimeoutException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "UnsupportedOperationException" => {
            crate::operation::generate_random::GenerateRandomError::UnsupportedOperationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_generate_random::de_generate_random(_response_body, output)
            .map_err(crate::operation::generate_random::GenerateRandomError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_generate_random_input::ser_generate_random_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_generate_random(
    _value: &[u8],
    mut builder: crate::operation::generate_random::builders::GenerateRandomOutputBuilder,
) -> ::std::result::Result<
    crate::operation::generate_random::builders::GenerateRandomOutputBuilder,
