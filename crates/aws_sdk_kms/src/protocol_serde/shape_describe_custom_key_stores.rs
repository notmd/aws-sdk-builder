...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_custom_key_stores::DescribeCustomKeyStoresError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        ...
        "InvalidMarkerException" => {
            crate::operation::describe_custom_key_stores::DescribeCustomKeyStoresError::InvalidMarkerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::InvalidMarkerExceptionBuilder::default();
                    output =
                        crate::protocol_serde::shape_invalid_marker_exception::de_invalid_marker_exception_json_err(
                            _response_body,
                            output,
                        )
                        .map_err(
        ...
        "KMSInternalException" => {
            crate::operation::describe_custom_key_stores::DescribeCustomKeyStoresError::KmsInternalException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_custom_key_stores::de_describe_custom_key_stores(
            _response_body,
            output,
        )
        .map_err(crate::operation::describe_custom_key_stores::DescribeCustomKeyStoresError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_describe_custom_key_stores_input::ser_describe_custom_key_stores_input_input(
        &mut object,
        input,
    )?;
    object.finish();
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "CustomKeyStores" => {
                    builder = builder.set_custom_key_stores(
                        crate::protocol_serde::shape_custom_key_stores_list::de_custom_key_stores_list(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
                ...
                "Truncated" => {
                    builder = builder.set_truncated(::aws_smithy_json::deserialize::token::expect_bool_or_null(
                        tokens.next(),
                    )?);
                }
