    ...
    Err(match error_code {
        ...
        "InvalidMarkerException" => crate::operation::list_aliases::ListAliasesError::InvalidMarkerException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_invalid_marker_exception::de_invalid_marker_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::list_aliases::ListAliasesError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "Aliases" => {
                    builder = builder.set_aliases(crate::protocol_serde::shape_alias_list::de_alias_list(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
