...
> {
    ...
    Err(match error_code {
        "DependencyTimeoutException" => {
            crate::operation::derive_shared_secret::DeriveSharedSecretError::DependencyTimeoutException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "DryRunOperationException" => {
            crate::operation::derive_shared_secret::DeriveSharedSecretError::DryRunOperationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidGrantTokenException" => {
            crate::operation::derive_shared_secret::DeriveSharedSecretError::InvalidGrantTokenException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidKeyUsageException" => {
            crate::operation::derive_shared_secret::DeriveSharedSecretError::InvalidKeyUsageException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "KeyUnavailableException" => {
            crate::operation::derive_shared_secret::DeriveSharedSecretError::KeyUnavailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "KMSInternalException" => {
            crate::operation::derive_shared_secret::DeriveSharedSecretError::KmsInternalException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "KMSInvalidStateException" => {
            crate::operation::derive_shared_secret::DeriveSharedSecretError::KmsInvalidStateException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "SharedSecret" => {
                    builder = builder.set_shared_secret(::aws_smithy_json::deserialize::token::expect_blob_or_null(
                        tokens.next(),
                    )?);
                }
                ...
                "KeyAgreementAlgorithm" => {
                    builder = builder.set_key_agreement_algorithm(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| {
                                s.to_unescaped()
                                    .map(|u| crate::types::KeyAgreementAlgorithmSpec::from(u.as_ref()))
                            })
                            .transpose()?,
                    );
                }
