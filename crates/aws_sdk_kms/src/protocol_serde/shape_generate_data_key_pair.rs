...
> {
    ...
    Err(match error_code {
        "DependencyTimeoutException" => {
            crate::operation::generate_data_key_pair::GenerateDataKeyPairError::DependencyTimeoutException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "DryRunOperationException" => {
            crate::operation::generate_data_key_pair::GenerateDataKeyPairError::DryRunOperationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidGrantTokenException" => {
            crate::operation::generate_data_key_pair::GenerateDataKeyPairError::InvalidGrantTokenException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidKeyUsageException" => {
            crate::operation::generate_data_key_pair::GenerateDataKeyPairError::InvalidKeyUsageException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "KeyUnavailableException" => {
            crate::operation::generate_data_key_pair::GenerateDataKeyPairError::KeyUnavailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::KeyUnavailableExceptionBuilder::default();
                    output =
                        crate::protocol_serde::shape_key_unavailable_exception::de_key_unavailable_exception_json_err(
                            _response_body,
                            output,
                        )
                        .map_err(crate::operation::generate_data_key_pair::GenerateDataKeyPairError::unhandled)?;
        ...
        "KMSInternalException" => {
            crate::operation::generate_data_key_pair::GenerateDataKeyPairError::KmsInternalException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "KMSInvalidStateException" => {
            crate::operation::generate_data_key_pair::GenerateDataKeyPairError::KmsInvalidStateException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_generate_data_key_pair::de_generate_data_key_pair(_response_body, output)
            .map_err(crate::operation::generate_data_key_pair::GenerateDataKeyPairError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_generate_data_key_pair_input::ser_generate_data_key_pair_input_input(
        &mut object,
        input,
    )?;
    object.finish();
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "PublicKey" => {
                    builder = builder.set_public_key(::aws_smithy_json::deserialize::token::expect_blob_or_null(
                        tokens.next(),
                    )?);
                }
                "KeyId" => {
                ...
                "KeyPairSpec" => {
                    builder = builder.set_key_pair_spec(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| {
                                s.to_unescaped()
                                    .map(|u| crate::types::DataKeyPairSpec::from(u.as_ref()))
                            })
                            .transpose()?,
                    );
                }
