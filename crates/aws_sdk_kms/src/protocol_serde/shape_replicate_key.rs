            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ReplicaKeyMetadata" => {
                    builder = builder.set_replica_key_metadata(
                        crate::protocol_serde::shape_key_metadata::de_key_metadata(tokens, _value, depth + 1)?,
                    );
                }
                "ReplicaPolicy" => {
                ...
                "ReplicaTags" => {
                    builder = builder.set_replica_tags(crate::protocol_serde::shape_tag_list::de_tag_list(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
