...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_imported_key_material::de_delete_imported_key_material(
            _response_body,
            output,
        )
        .map_err(crate::operation::delete_imported_key_material::DeleteImportedKeyMaterialError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_delete_imported_key_material_input::ser_delete_imported_key_material_input_input(
        &mut object,
        input,
    )?;
    object.finish();
