...
> {
    ...
    Err(match error_code {
        ...
        "KMSInternalException" => {
            crate::operation::delete_custom_key_store::DeleteCustomKeyStoreError::KmsInternalException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_delete_custom_key_store_input::ser_delete_custom_key_store_input_input(
        &mut object,
        input,
    )?;
    object.finish();
