...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::list_key_rotations::ListKeyRotationsError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "InvalidMarkerException" => {
            crate::operation::list_key_rotations::ListKeyRotationsError::InvalidMarkerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "KMSInvalidStateException" => {
            crate::operation::list_key_rotations::ListKeyRotationsError::KmsInvalidStateException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "UnsupportedOperationException" => {
            crate::operation::list_key_rotations::ListKeyRotationsError::UnsupportedOperationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                match key.to_unescaped()?.as_ref() {
                    "Rotations" => {
                        builder = builder.set_rotations(
                            crate::protocol_serde::shape_rotations_list::de_rotations_list(tokens, _value, depth + 1)?,
                        );
                    }
                    "NextMarker" => {
