    ...
    Err(match error_code {
        ...
        "KMSInvalidMacException" => crate::operation::verify_mac::VerifyMacError::KmsInvalidMacException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_kms_invalid_mac_exception::de_kms_invalid_mac_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::verify_mac::VerifyMacError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "MacValid" => {
                    builder = builder.set_mac_valid(::aws_smithy_json::deserialize::token::expect_bool_or_null(
                        tokens.next(),
                    )?);
                }
                "MacAlgorithm" => {
