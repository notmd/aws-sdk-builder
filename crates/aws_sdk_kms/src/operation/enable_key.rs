...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for EnableKey {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::orchestrator::Metadata::new("EnableKey", "KMS"),
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for EnableKeyTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<EnableKeyInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for EnableKeyResponseDeserializer
{
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            ...
            crate::protocol_serde::shape_enable_key::de_enable_key_http_response(
                status, headers, body,
            )
        };
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for EnableKeyEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "EnableKeyEndpointParamsInterceptor"
    }
