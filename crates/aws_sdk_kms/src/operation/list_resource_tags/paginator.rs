...
pub struct ListResourceTagsPaginator {
    ...
    builder: crate::operation::list_resource_tags::builders::ListResourceTagsInputBuilder,
...
impl ListResourceTagsPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::list_resource_tags::paginator::ListResourceTagsPaginatorItems {
        crate::operation::list_resource_tags::paginator::ListResourceTagsPaginatorItems(self)
    }
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::list_resource_tags::ListResourceTags::operation_runtime_plugins(
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(
            ::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            crate::operation::list_resource_tags::ListResourceTags::orchestrate(
                                &runtime_plugins,
                                input.clone(),
                            )
                            .await;
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_resource_tags_output_output_next_marker(resp);
...
impl ListResourceTagsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(
            |page| {
                crate::lens::lens_list_resource_tags_output_output_tags(page)
                    .unwrap_or_default()
                    .into_iter()
            },
        )
