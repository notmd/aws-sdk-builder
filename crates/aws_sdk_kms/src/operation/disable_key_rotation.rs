...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for DisableKeyRotationTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) =
            context.input().downcast_ref::<DisableKeyRotationInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for DisableKeyRotationResponseDeserializer
{
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for DisableKeyRotationRequestSerializer
{
    #[allow(
        unused_mut,
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for DisableKeyRotationEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "DisableKeyRotationEndpointParamsInterceptor"
    }
