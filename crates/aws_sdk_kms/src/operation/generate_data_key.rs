...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GenerateDataKey {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::orchestrator::Metadata::new("GenerateDataKey", "KMS"),
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for GenerateDataKeyTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) =
            context.input().downcast_ref::<GenerateDataKeyInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for GenerateDataKeyResponseDeserializer
{
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for GenerateDataKeyRequestSerializer
{
    #[allow(
        unused_mut,
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for GenerateDataKeyEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "GenerateDataKeyEndpointParamsInterceptor"
    }
...
impl ::aws_types::request_id::RequestId
    for crate::operation::generate_data_key::GenerateDataKeyError
{
