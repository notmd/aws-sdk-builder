...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for CancelKeyDeletionTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) =
            context.input().downcast_ref::<CancelKeyDeletionInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for CancelKeyDeletionResponseDeserializer
{
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for CancelKeyDeletionRequestSerializer
{
    #[allow(
        unused_mut,
    ...
    > {
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_cancel_key_deletion::ser_cancel_key_deletion_input(
                &input,
            )?,
        );
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for CancelKeyDeletionEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "CancelKeyDeletionEndpointParamsInterceptor"
    }
