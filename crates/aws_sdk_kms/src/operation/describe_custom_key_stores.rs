...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for DescribeCustomKeyStoresResponseDeserializer
{
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for DescribeCustomKeyStoresRequestSerializer
{
    #[allow(
        unused_mut,
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for DescribeCustomKeyStoresEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "DescribeCustomKeyStoresEndpointParamsInterceptor"
    }
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError
    for DescribeCustomKeyStoresError
{
...
impl ::aws_types::request_id::RequestId
    for crate::operation::describe_custom_key_stores::DescribeCustomKeyStoresError
{
