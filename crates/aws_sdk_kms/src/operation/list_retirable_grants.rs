...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for ListRetirableGrantsTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) =
            context.input().downcast_ref::<ListRetirableGrantsInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for ListRetirableGrantsResponseDeserializer
{
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for ListRetirableGrantsRequestSerializer
{
    #[allow(
        unused_mut,
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for ListRetirableGrantsEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "ListRetirableGrantsEndpointParamsInterceptor"
    }
