...
pub struct ListKeyRotationsPaginator {
    ...
    builder: crate::operation::list_key_rotations::builders::ListKeyRotationsInputBuilder,
...
impl ListKeyRotationsPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::list_key_rotations::paginator::ListKeyRotationsPaginatorItems {
        crate::operation::list_key_rotations::paginator::ListKeyRotationsPaginatorItems(self)
    }
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::list_key_rotations::ListKeyRotations::operation_runtime_plugins(
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(
            ::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            crate::operation::list_key_rotations::ListKeyRotations::orchestrate(
                                &runtime_plugins,
                                input.clone(),
                            )
                            .await;
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_key_rotations_output_output_next_marker(resp);
...
impl ListKeyRotationsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(
            |page| {
                crate::lens::lens_list_key_rotations_output_output_rotations(page)
                    .unwrap_or_default()
                    .into_iter()
            },
        )
