...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GenerateMac {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::orchestrator::Metadata::new("GenerateMac", "KMS"),
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for GenerateMacTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GenerateMacInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for GenerateMacResponseDeserializer
{
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for GenerateMacEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "GenerateMacEndpointParamsInterceptor"
    }
