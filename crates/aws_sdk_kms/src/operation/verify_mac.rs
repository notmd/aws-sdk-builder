...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for VerifyMac {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::orchestrator::Metadata::new("VerifyMac", "KMS"),
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for VerifyMacTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<VerifyMacInput>()
        else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for VerifyMacResponseDeserializer
{
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            ...
            crate::protocol_serde::shape_verify_mac::de_verify_mac_http_response(
                status, headers, body,
            )
        };
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for VerifyMacEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "VerifyMacEndpointParamsInterceptor"
    }
