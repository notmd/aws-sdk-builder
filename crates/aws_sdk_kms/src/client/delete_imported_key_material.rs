...
impl super::Client {
    ...
    pub fn delete_imported_key_material(
        &self,
    ) -> crate::operation::delete_imported_key_material::builders::DeleteImportedKeyMaterialFluentBuilder {
        crate::operation::delete_imported_key_material::builders::DeleteImportedKeyMaterialFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
