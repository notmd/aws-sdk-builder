...
impl super::Client {
    ...
    pub fn disconnect_custom_key_store(
        &self,
    ) -> crate::operation::disconnect_custom_key_store::builders::DisconnectCustomKeyStoreFluentBuilder {
        crate::operation::disconnect_custom_key_store::builders::DisconnectCustomKeyStoreFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
