...
pub fn ser_website_configuration_http_payload(
    payload: &::std::option::Option<crate::types::WebsiteConfiguration>,
) -> ::std::result::Result<::std::vec::Vec<u8>, ::aws_smithy_types::error::operation::BuildError> {
    let payload = match payload.as_ref() {
        Some(t) => t,
        None => return Ok(crate::protocol_serde::rest_xml_unset_struct_payload()),
    };
    Ok(crate::protocol_serde::shape_put_bucket_website_input::ser_website_configuration_payload(payload)?)
}
...
pub fn ser_website_configuration_payload(
    ...
    let mut out = String::new();
    {
        ...
        crate::protocol_serde::shape_website_configuration::ser_website_configuration(input, root)?
    }
    Ok(out.into_bytes())
}
