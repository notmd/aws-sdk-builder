//! Build-time model provider for batch AWS service.
...
pub const METADATA: aws_sdk_builder::ServiceMetadata = aws_sdk_builder::ServiceMetadata {
    key: "batch",
    filename: "model.json",
    module_name: "aws_sdk_batch",
    sdk_version: Some("1.124.0"),
};
...
/// Includes the generated Batch SDK inside the caller's module.
#[macro_export]
macro_rules! include_sdk {
    () => {
        include!(concat!(env!("OUT_DIR"), "/generated/batch/consumer.rs"));
    };
}
