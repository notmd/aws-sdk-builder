...
static S3_INTEGRATION_TESTS: &[IntegrationTestAsset] = &[
    ...
    s3_integration_test!("tests/alternative-async-runtime.rs"),
    s3_integration_test!("tests/auth_scheme_preference.rs"),
    s3_integration_test!("tests/aws_chunked.rs"),
    s3_integration_test!("tests/body_size_hint.rs"),
    s3_integration_test!("tests/bucket-required.rs"),
    s3_integration_test!("tests/business_metrics.rs"),
    s3_integration_test!("tests/checksums.rs"),
    s3_integration_test!("tests/client_construction.rs"),
    s3_integration_test!("tests/concurrency.rs"),
    s3_integration_test!("tests/config-override.rs"),
    s3_integration_test!("tests/config_to_builder.rs"),
    s3_integration_test!("tests/content-length-enforcement.rs"),
    s3_integration_test!("tests/credential_features.rs"),
    s3_integration_test!("tests/customizable-operation.rs"),
    s3_integration_test!("tests/endpoints.rs"),
    s3_integration_test!("tests/expires_interceptor.rs"),
    s3_integration_test!("tests/express.rs"),
    s3_integration_test!("tests/identity-cache.rs"),
    s3_integration_test!("tests/ignore-invalid-xml-body-root.rs"),
    s3_integration_test!("tests/interceptors.rs"),
    s3_integration_test!("tests/mocks.rs"),
    s3_integration_test!("tests/naughty-string-metadata.rs"),
    s3_integration_test!("tests/no_auth.rs"),
    s3_integration_test!("tests/normalize-uri-path.rs"),
    s3_integration_test!("tests/presigning.rs"),
    s3_integration_test!("tests/query-strings-are-correctly-encoded.rs"),
    s3_integration_test!("tests/reconnects.rs"),
    s3_integration_test!("tests/recursion-detection.rs"),
    s3_integration_test!("tests/request_id.rs"),
    s3_integration_test!("tests/request_information_headers.rs"),
    s3_integration_test!("tests/required-query-params.rs"),
    s3_integration_test!("tests/retry-classifier-customization.rs"),
    s3_integration_test!("tests/select-object-content.rs"),
    s3_integration_test!("tests/service_timeout_overrides.rs"),
    s3_integration_test!("tests/signing-it.rs"),
    s3_integration_test!("tests/sigv4a_signing_region_set.rs"),
    s3_integration_test!("tests/size-type.rs"),
    s3_integration_test!("tests/stalled-stream-protection.rs"),
    s3_integration_test!("tests/status-200-errors.rs"),
    s3_integration_test!("tests/streaming-response.rs"),
    s3_integration_test!("tests/timeouts.rs"),
    s3_integration_test!("tests/token_bucket_time_source.rs"),
];
