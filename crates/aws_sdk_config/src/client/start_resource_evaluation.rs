...
impl super::Client {
    ...
    ///   - [`evaluation_mode(EvaluationMode)`](crate::operation::start_resource_evaluation::builders::StartResourceEvaluationFluentBuilder::evaluation_mode) / [`set_evaluation_mode(Option<EvaluationMode>)`](crate::operation::start_resource_evaluation::builders::StartResourceEvaluationFluentBuilder::set_evaluation_mode):<br>required: **true**<br><p>The mode of an evaluation.</p><note>  <p>The only valid value for this API is <code>PROACTIVE</code>.</p> </note><br>
    ...
    pub fn start_resource_evaluation(
        ...
        crate::operation::start_resource_evaluation::builders::StartResourceEvaluationFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
