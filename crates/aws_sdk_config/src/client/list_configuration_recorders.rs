...
impl super::Client {
    ...
    pub fn list_configuration_recorders(
        &self,
    ) -> crate::operation::list_configuration_recorders::builders::ListConfigurationRecordersFluentBuilder {
        crate::operation::list_configuration_recorders::builders::ListConfigurationRecordersFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
