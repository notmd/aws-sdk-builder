...
impl super::Client {
    ...
    pub fn disassociate_resource_types(
        &self,
    ) -> crate::operation::disassociate_resource_types::builders::DisassociateResourceTypesFluentBuilder {
        crate::operation::disassociate_resource_types::builders::DisassociateResourceTypesFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
