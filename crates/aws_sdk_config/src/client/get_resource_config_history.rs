...
impl super::Client {
    ...
    ///   - [`earlier_time(DateTime)`](crate::operation::get_resource_config_history::builders::GetResourceConfigHistoryFluentBuilder::earlier_time) / [`set_earlier_time(Option<DateTime>)`](crate::operation::get_resource_config_history::builders::GetResourceConfigHistoryFluentBuilder::set_earlier_time):<br>required: **false**<br><p>The chronologically earliest time in the time range for which the history requested. If not specified, the action returns paginated results that contain configuration items that start when the first configuration item was recorded.</p><br>
    ...
    ///   - [`configuration_items(Option<Vec::<ConfigurationItem>>)`](crate::operation::get_resource_config_history::GetResourceConfigHistoryOutput::configuration_items): <p>An array of <code>ConfigurationItems</code> Objects. Contatins the configuration history for one or more resources.</p>
    ...
    pub fn get_resource_config_history(
        &self,
    ) -> crate::operation::get_resource_config_history::builders::GetResourceConfigHistoryFluentBuilder {
        crate::operation::get_resource_config_history::builders::GetResourceConfigHistoryFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
