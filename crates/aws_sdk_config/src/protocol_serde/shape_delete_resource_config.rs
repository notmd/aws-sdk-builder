...
> {
    ...
    Err(match error_code {
        ...
        "ValidationException" => {
            crate::operation::delete_resource_config::DeleteResourceConfigError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_delete_resource_config_input::ser_delete_resource_config_input_input(
        &mut object,
        input,
    )?;
    object.finish();
