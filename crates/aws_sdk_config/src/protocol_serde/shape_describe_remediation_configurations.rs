...
> {
    ...
    let mut generic_builder =
        crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(
            crate::operation::describe_remediation_configurations::DescribeRemediationConfigurationsError::unhandled,
        )?;
...
pub(crate) fn de_describe_remediation_configurations(
    _value: &[u8],
    mut builder: crate::operation::describe_remediation_configurations::builders::DescribeRemediationConfigurationsOutputBuilder,
) -> ::std::result::Result<
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "RemediationConfigurations" => {
                    builder = builder.set_remediation_configurations(
                        crate::protocol_serde::shape_remediation_configurations::de_remediation_configurations(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
