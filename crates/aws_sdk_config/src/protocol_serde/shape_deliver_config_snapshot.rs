...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_deliver_config_snapshot::de_deliver_config_snapshot(_response_body, output)
                .map_err(crate::operation::deliver_config_snapshot::DeliverConfigSnapshotError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_deliver_config_snapshot_input::ser_deliver_config_snapshot_input_input(
        &mut object,
        input,
    )?;
    object.finish();
