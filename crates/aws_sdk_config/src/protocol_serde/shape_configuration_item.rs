...
pub(crate) fn de_configuration_item<'a, I>(
    ...
    Option<crate::types::ConfigurationItem>,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "configurationItemStatus" => {
                                builder = builder.set_configuration_item_status(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                        .map(|s| {
                                            s.to_unescaped()
                                                .map(|u| crate::types::ConfigurationItemStatus::from(u.as_ref()))
                                        })
                                        .transpose()?,
                                );
                            }
                            ...
                            "relatedEvents" => {
                                builder = builder.set_related_events(
                                    crate::protocol_serde::shape_related_event_list::de_related_event_list(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
                            ...
                            "relationships" => {
                                builder = builder.set_relationships(
                                    crate::protocol_serde::shape_relationship_list::de_relationship_list(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
                            ...
                            "recordingFrequency" => {
                                builder = builder.set_recording_frequency(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                        .map(|s| {
                                            s.to_unescaped()
                                                .map(|u| crate::types::RecordingFrequency::from(u.as_ref()))
                                        })
                                        .transpose()?,
                                );
                            }
                            "configurationItemDeliveryTime" => {
                                builder = builder.set_configuration_item_delivery_time(
                                    ::aws_smithy_json::deserialize::token::expect_timestamp_or_null(
                                        tokens.next(),
                                        ::aws_smithy_types::date_time::Format::EpochSeconds,
                                    )?,
