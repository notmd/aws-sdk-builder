...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::batch_get_resource_config::BatchGetResourceConfigError::unhandled(generic))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_batch_get_resource_config::de_batch_get_resource_config(
            _response_body,
            output,
        )
        .map_err(crate::operation::batch_get_resource_config::BatchGetResourceConfigError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_batch_get_resource_config_input::ser_batch_get_resource_config_input_input(
        &mut object,
        input,
    )?;
    object.finish();
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "baseConfigurationItems" => {
                    builder = builder.set_base_configuration_items(
                        crate::protocol_serde::shape_base_configuration_items::de_base_configuration_items(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
                ...
                "unprocessedResourceKeys" => {
                    builder = builder.set_unprocessed_resource_keys(
                        crate::protocol_serde::shape_resource_keys::de_resource_keys(tokens, _value, depth + 1)?,
                    );
                }
