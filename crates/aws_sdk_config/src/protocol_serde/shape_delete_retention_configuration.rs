...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::delete_retention_configuration::DeleteRetentionConfigurationError::unhandled(generic),
            )
        }
    };
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_delete_retention_configuration_input::ser_delete_retention_configuration_input_input(
        &mut object,
        input,
    )?;
    object.finish();
