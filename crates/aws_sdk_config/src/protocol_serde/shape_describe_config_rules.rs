...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(crate::operation::describe_config_rules::DescribeConfigRulesError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InvalidNextTokenException" => {
            crate::operation::describe_config_rules::DescribeConfigRulesError::InvalidNextTokenException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NoSuchConfigRuleException" => {
            crate::operation::describe_config_rules::DescribeConfigRulesError::NoSuchConfigRuleException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::describe_config_rules::builders::DescribeConfigRulesOutputBuilder::default();
        output = crate::protocol_serde::shape_describe_config_rules::de_describe_config_rules(_response_body, output)
            .map_err(crate::operation::describe_config_rules::DescribeConfigRulesError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_describe_config_rules_input::ser_describe_config_rules_input_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub(crate) fn de_describe_config_rules(
    _value: &[u8],
    mut builder: crate::operation::describe_config_rules::builders::DescribeConfigRulesOutputBuilder,
) -> ::std::result::Result<
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ConfigRules" => {
                    builder = builder.set_config_rules(crate::protocol_serde::shape_config_rules::de_config_rules(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
