...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::delete_evaluation_results::DeleteEvaluationResultsError::unhandled(generic))
        }
    };
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_delete_evaluation_results_input::ser_delete_evaluation_results_input_input(
        &mut object,
        input,
    )?;
    object.finish();
