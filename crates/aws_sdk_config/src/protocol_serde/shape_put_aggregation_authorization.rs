...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_put_aggregation_authorization::de_put_aggregation_authorization(
            _response_body,
            output,
        )
        .map_err(crate::operation::put_aggregation_authorization::PutAggregationAuthorizationError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_put_aggregation_authorization_input::ser_put_aggregation_authorization_input_input(
        &mut object,
        input,
    )?;
    object.finish();
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "AggregationAuthorization" => {
                    builder = builder.set_aggregation_authorization(
                        crate::protocol_serde::shape_aggregation_authorization::de_aggregation_authorization(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
