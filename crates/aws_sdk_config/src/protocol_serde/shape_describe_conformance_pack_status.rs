...
> {
    ...
    let mut generic_builder =
        crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(
            crate::operation::describe_conformance_pack_status::DescribeConformancePackStatusError::unhandled,
        )?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_conformance_pack_status::de_describe_conformance_pack_status(
            _response_body,
            output,
        )
        .map_err(crate::operation::describe_conformance_pack_status::DescribeConformancePackStatusError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ConformancePackStatusDetails" => {
                    builder = builder.set_conformance_pack_status_details(
                        crate::protocol_serde::shape_conformance_pack_status_details_list::de_conformance_pack_status_details_list(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
