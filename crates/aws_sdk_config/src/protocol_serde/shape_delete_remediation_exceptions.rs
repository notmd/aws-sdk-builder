...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::delete_remediation_exceptions::DeleteRemediationExceptionsError::unhandled(generic),
            )
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_remediation_exceptions::de_delete_remediation_exceptions(
            _response_body,
            output,
        )
        .map_err(crate::operation::delete_remediation_exceptions::DeleteRemediationExceptionsError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_delete_remediation_exceptions_input::ser_delete_remediation_exceptions_input_input(
        &mut object,
        input,
    )?;
    object.finish();
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "FailedBatches" => {
                    builder = builder.set_failed_batches(
                            crate::protocol_serde::shape_failed_delete_remediation_exceptions_batches::de_failed_delete_remediation_exceptions_batches(tokens, _value, depth + 1)?
                        );
                }
