...
> {
    ...
    Err(match error_code {
        ...
        "InsufficientPermissionsException" => {
            crate::operation::put_connector::PutConnectorError::InsufficientPermissionsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "MaxNumberOfConnectorsExceededException" => {
            crate::operation::put_connector::PutConnectorError::MaxNumberOfConnectorsExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
