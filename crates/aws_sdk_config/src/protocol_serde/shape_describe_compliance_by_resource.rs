...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::describe_compliance_by_resource::DescribeComplianceByResourceError::unhandled(
                    generic,
                ),
            )
        }
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_compliance_by_resource::de_describe_compliance_by_resource(
            _response_body,
            output,
        )
        .map_err(crate::operation::describe_compliance_by_resource::DescribeComplianceByResourceError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ComplianceByResources" => {
                    builder = builder.set_compliance_by_resources(
                        crate::protocol_serde::shape_compliance_by_resources::de_compliance_by_resources(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
