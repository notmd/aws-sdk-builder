...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::associate_resource_types::AssociateResourceTypesError::unhandled(generic))
        }
    };
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_associate_resource_types::de_associate_resource_types(_response_body, output)
                .map_err(crate::operation::associate_resource_types::AssociateResourceTypesError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_associate_resource_types_input::ser_associate_resource_types_input_input(
        &mut object,
        input,
    )?;
    object.finish();
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ConfigurationRecorder" => {
                    builder = builder.set_configuration_recorder(
                        crate::protocol_serde::shape_configuration_recorder::de_configuration_recorder(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
