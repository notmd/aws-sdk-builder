...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::get_resource_evaluation_summary::GetResourceEvaluationSummaryError::unhandled(
                    generic,
                ),
            )
        }
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_resource_evaluation_summary::de_get_resource_evaluation_summary(
            _response_body,
            output,
        )
        .map_err(crate::operation::get_resource_evaluation_summary::GetResourceEvaluationSummaryError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "EvaluationStatus" => {
                    builder = builder.set_evaluation_status(
                        crate::protocol_serde::shape_evaluation_status::de_evaluation_status(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
                ...
                "EvaluationContext" => {
                    builder = builder.set_evaluation_context(
                        crate::protocol_serde::shape_evaluation_context::de_evaluation_context(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
                ...
                "ResourceDetails" => {
                    builder = builder.set_resource_details(
                        crate::protocol_serde::shape_resource_details::de_resource_details(tokens, _value, depth + 1)?,
                    );
                }
