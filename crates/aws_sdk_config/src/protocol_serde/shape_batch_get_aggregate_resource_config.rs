...
> {
    ...
    let mut generic_builder =
        crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(
            crate::operation::batch_get_aggregate_resource_config::BatchGetAggregateResourceConfigError::unhandled,
        )?;
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_batch_get_aggregate_resource_config::de_batch_get_aggregate_resource_config(
                _response_body,
                output,
            )
            .map_err(
