        ...
        "ValidationException" => {
            crate::operation::list_configuration_recorders::ListConfigurationRecordersError::ValidationException({
                ...
                let mut tmp = {
                    ...
                    .map_err(
                        crate::operation::list_configuration_recorders::ListConfigurationRecordersError::unhandled,
                    )?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_configuration_recorders::de_list_configuration_recorders(
            _response_body,
            output,
        )
        .map_err(crate::operation::list_configuration_recorders::ListConfigurationRecordersError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_list_configuration_recorders_input::ser_list_configuration_recorders_input_input(
        &mut object,
        input,
    )?;
    object.finish();
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ConfigurationRecorderSummaries" => {
                    builder = builder.set_configuration_recorder_summaries(
                        crate::protocol_serde::shape_configuration_recorder_summaries::de_configuration_recorder_summaries(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
