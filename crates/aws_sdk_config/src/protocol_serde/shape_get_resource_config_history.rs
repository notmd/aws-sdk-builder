...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_resource_config_history::de_get_resource_config_history(
            _response_body,
            output,
        )
        .map_err(crate::operation::get_resource_config_history::GetResourceConfigHistoryError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_get_resource_config_history_input::ser_get_resource_config_history_input_input(
        &mut object,
        input,
    )?;
    object.finish();
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "configurationItems" => {
                    builder = builder.set_configuration_items(
                        crate::protocol_serde::shape_configuration_item_list::de_configuration_item_list(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
