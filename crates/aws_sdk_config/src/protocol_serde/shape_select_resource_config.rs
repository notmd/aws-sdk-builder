...
> {
    ...
    Err(match error_code {
        "InvalidExpressionException" => {
            crate::operation::select_resource_config::SelectResourceConfigError::InvalidExpressionException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidLimitException" => {
            crate::operation::select_resource_config::SelectResourceConfigError::InvalidLimitException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidNextTokenException" => {
            crate::operation::select_resource_config::SelectResourceConfigError::InvalidNextTokenException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_select_resource_config_input::ser_select_resource_config_input_input(
        &mut object,
        input,
    )?;
    object.finish();
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "Results" => {
                    builder = builder.set_results(crate::protocol_serde::shape_results::de_results(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
                ...
                "QueryInfo" => {
                    builder = builder.set_query_info(crate::protocol_serde::shape_query_info::de_query_info(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
