...
> {
    ...
    let mut generic_builder =
        crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(
            crate::operation::describe_configuration_recorders::DescribeConfigurationRecordersError::unhandled,
        )?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_configuration_recorders::de_describe_configuration_recorders(
            _response_body,
            output,
        )
        .map_err(crate::operation::describe_configuration_recorders::DescribeConfigurationRecordersError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ConfigurationRecorders" => {
                    builder = builder.set_configuration_recorders(
                        crate::protocol_serde::shape_configuration_recorder_list::de_configuration_recorder_list(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
