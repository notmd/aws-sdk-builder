...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::list_discovered_resources::ListDiscoveredResourcesError::unhandled(generic))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_discovered_resources::de_list_discovered_resources(
            _response_body,
            output,
        )
        .map_err(crate::operation::list_discovered_resources::ListDiscoveredResourcesError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_list_discovered_resources_input::ser_list_discovered_resources_input_input(
        &mut object,
        input,
    )?;
    object.finish();
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "resourceIdentifiers" => {
                    builder = builder.set_resource_identifiers(
                        crate::protocol_serde::shape_resource_identifier_list::de_resource_identifier_list(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
