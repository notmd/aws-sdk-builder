...
> {
    ...
    let mut generic_builder =
        crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(
            crate::operation::describe_organization_config_rules::DescribeOrganizationConfigRulesError::unhandled,
        )?;
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_describe_organization_config_rules::de_describe_organization_config_rules(
                _response_body,
                output,
            )
            .map_err(
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_describe_organization_config_rules_input::ser_describe_organization_config_rules_input_input(&mut object, input)?;
    object.finish();
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "OrganizationConfigRules" => {
                    builder = builder.set_organization_config_rules(
                        crate::protocol_serde::shape_organization_config_rules::de_organization_config_rules(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
