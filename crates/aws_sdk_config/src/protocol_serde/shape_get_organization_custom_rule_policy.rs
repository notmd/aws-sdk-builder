...
> {
    ...
    let mut generic_builder =
        crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(
            crate::operation::get_organization_custom_rule_policy::GetOrganizationCustomRulePolicyError::unhandled,
        )?;
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_get_organization_custom_rule_policy::de_get_organization_custom_rule_policy(
                _response_body,
                output,
            )
            .map_err(
