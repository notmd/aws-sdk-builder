...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_start_remediation_execution::de_start_remediation_execution(
            _response_body,
            output,
        )
        .map_err(crate::operation::start_remediation_execution::StartRemediationExecutionError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_start_remediation_execution_input::ser_start_remediation_execution_input_input(
        &mut object,
        input,
    )?;
    object.finish();
