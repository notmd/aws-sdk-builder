...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_disassociate_resource_types::de_disassociate_resource_types(
            _response_body,
            output,
        )
        .map_err(crate::operation::disassociate_resource_types::DisassociateResourceTypesError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_disassociate_resource_types_input::ser_disassociate_resource_types_input_input(
        &mut object,
        input,
    )?;
    object.finish();
