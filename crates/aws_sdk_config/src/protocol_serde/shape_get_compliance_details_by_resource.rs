...
> {
    ...
    let mut generic_builder =
        crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(
            crate::operation::get_compliance_details_by_resource::GetComplianceDetailsByResourceError::unhandled,
        )?;
    ...
    Err(match error_code {
        "InvalidParameterValueException" => {
            crate::operation::get_compliance_details_by_resource::GetComplianceDetailsByResourceError::InvalidParameterValueException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_get_compliance_details_by_resource::de_get_compliance_details_by_resource(
                _response_body,
                output,
            )
            .map_err(
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_get_compliance_details_by_resource_input::ser_get_compliance_details_by_resource_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_get_compliance_details_by_resource(
    _value: &[u8],
    mut builder: crate::operation::get_compliance_details_by_resource::builders::GetComplianceDetailsByResourceOutputBuilder,
) -> ::std::result::Result<
    crate::operation::get_compliance_details_by_resource::builders::GetComplianceDetailsByResourceOutputBuilder,
