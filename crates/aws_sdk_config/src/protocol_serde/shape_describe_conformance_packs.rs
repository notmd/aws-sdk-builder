...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_conformance_packs::DescribeConformancePacksError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "InvalidLimitException" => {
            crate::operation::describe_conformance_packs::DescribeConformancePacksError::InvalidLimitException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::InvalidLimitExceptionBuilder::default();
                    output = crate::protocol_serde::shape_invalid_limit_exception::de_invalid_limit_exception_json_err(
                        _response_body,
                        output,
                    )
                    .map_err(crate::operation::describe_conformance_packs::DescribeConformancePacksError::unhandled)?;
        ...
        "InvalidNextTokenException" => {
            crate::operation::describe_conformance_packs::DescribeConformancePacksError::InvalidNextTokenException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_conformance_packs::de_describe_conformance_packs(
            _response_body,
            output,
        )
        .map_err(crate::operation::describe_conformance_packs::DescribeConformancePacksError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_describe_conformance_packs_input::ser_describe_conformance_packs_input_input(
        &mut object,
        input,
    )?;
    object.finish();
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ConformancePackDetails" => {
                    builder = builder.set_conformance_pack_details(
                        crate::protocol_serde::shape_conformance_pack_detail_list::de_conformance_pack_detail_list(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
