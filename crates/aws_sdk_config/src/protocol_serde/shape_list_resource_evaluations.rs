...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::list_resource_evaluations::ListResourceEvaluationsError::unhandled(generic))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_resource_evaluations::de_list_resource_evaluations(
            _response_body,
            output,
        )
        .map_err(crate::operation::list_resource_evaluations::ListResourceEvaluationsError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_list_resource_evaluations_input::ser_list_resource_evaluations_input_input(
        &mut object,
        input,
    )?;
    object.finish();
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ResourceEvaluations" => {
                    builder = builder.set_resource_evaluations(
                        crate::protocol_serde::shape_resource_evaluations::de_resource_evaluations(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
