...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::put_configuration_recorder::PutConfigurationRecorderError::unhandled(generic))
        }
    };
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_put_configuration_recorder_input::ser_put_configuration_recorder_input_input(
        &mut object,
        input,
    )?;
    object.finish();
