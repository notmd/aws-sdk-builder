...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_put_remediation_configurations::de_put_remediation_configurations(
            _response_body,
            output,
        )
        .map_err(crate::operation::put_remediation_configurations::PutRemediationConfigurationsError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_put_remediation_configurations_input::ser_put_remediation_configurations_input_input(
        &mut object,
        input,
    )?;
    object.finish();
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "FailedBatches" => {
                    builder = builder.set_failed_batches(
                        crate::protocol_serde::shape_failed_remediation_batches::de_failed_remediation_batches(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
