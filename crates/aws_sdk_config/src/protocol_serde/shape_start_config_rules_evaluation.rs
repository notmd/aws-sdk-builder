...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::start_config_rules_evaluation::StartConfigRulesEvaluationError::unhandled(generic),
            )
        }
    };
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_start_config_rules_evaluation_input::ser_start_config_rules_evaluation_input_input(
        &mut object,
        input,
    )?;
    object.finish();
