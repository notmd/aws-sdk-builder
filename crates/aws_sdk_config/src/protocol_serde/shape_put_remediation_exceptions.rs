...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::put_remediation_exceptions::PutRemediationExceptionsError::unhandled(generic))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_put_remediation_exceptions::de_put_remediation_exceptions(
            _response_body,
            output,
        )
        .map_err(crate::operation::put_remediation_exceptions::PutRemediationExceptionsError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_put_remediation_exceptions_input::ser_put_remediation_exceptions_input_input(
        &mut object,
        input,
    )?;
    object.finish();
