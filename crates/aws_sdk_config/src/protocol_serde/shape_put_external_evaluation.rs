...
> {
    ...
    Err(match error_code {
        ...
        "NoSuchConfigRuleException" => {
            crate::operation::put_external_evaluation::PutExternalEvaluationError::NoSuchConfigRuleException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_put_external_evaluation_input::ser_put_external_evaluation_input_input(
        &mut object,
        input,
    )?;
    object.finish();
