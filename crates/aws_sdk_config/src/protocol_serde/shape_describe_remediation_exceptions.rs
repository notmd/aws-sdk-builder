...
> {
    ...
    let mut generic_builder =
        crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(
            crate::operation::describe_remediation_exceptions::DescribeRemediationExceptionsError::unhandled,
        )?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_remediation_exceptions::de_describe_remediation_exceptions(
            _response_body,
            output,
        )
        .map_err(crate::operation::describe_remediation_exceptions::DescribeRemediationExceptionsError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "RemediationExceptions" => {
                    builder = builder.set_remediation_exceptions(
                        crate::protocol_serde::shape_remediation_exceptions::de_remediation_exceptions(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
