...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::put_stored_query::PutStoredQueryError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "TooManyTagsException" => crate::operation::put_stored_query::PutStoredQueryError::TooManyTagsException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_too_many_tags_exception::de_too_many_tags_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::put_stored_query::PutStoredQueryError::unhandled)?;
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::put_stored_query::builders::PutStoredQueryOutputBuilder::default();
        output = crate::protocol_serde::shape_put_stored_query::de_put_stored_query(_response_body, output)
            .map_err(crate::operation::put_stored_query::PutStoredQueryError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_put_stored_query_input::ser_put_stored_query_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_put_stored_query(
    _value: &[u8],
    mut builder: crate::operation::put_stored_query::builders::PutStoredQueryOutputBuilder,
) -> ::std::result::Result<
    crate::operation::put_stored_query::builders::PutStoredQueryOutputBuilder,
