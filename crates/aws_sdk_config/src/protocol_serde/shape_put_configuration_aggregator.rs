...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_put_configuration_aggregator::de_put_configuration_aggregator(
            _response_body,
            output,
        )
        .map_err(crate::operation::put_configuration_aggregator::PutConfigurationAggregatorError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_put_configuration_aggregator_input::ser_put_configuration_aggregator_input_input(
        &mut object,
        input,
    )?;
    object.finish();
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ConfigurationAggregator" => {
                    builder = builder.set_configuration_aggregator(
                        crate::protocol_serde::shape_configuration_aggregator::de_configuration_aggregator(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
