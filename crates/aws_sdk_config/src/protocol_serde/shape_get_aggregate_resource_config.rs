...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_aggregate_resource_config::de_get_aggregate_resource_config(
            _response_body,
            output,
        )
        .map_err(crate::operation::get_aggregate_resource_config::GetAggregateResourceConfigError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_get_aggregate_resource_config_input::ser_get_aggregate_resource_config_input_input(
        &mut object,
        input,
    )?;
    object.finish();
