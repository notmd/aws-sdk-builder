...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_discovered_resource_counts::de_get_discovered_resource_counts(
            _response_body,
            output,
        )
        .map_err(crate::operation::get_discovered_resource_counts::GetDiscoveredResourceCountsError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_get_discovered_resource_counts_input::ser_get_discovered_resource_counts_input_input(
        &mut object,
        input,
    )?;
    object.finish();
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "resourceCounts" => {
                    builder = builder.set_resource_counts(
                        crate::protocol_serde::shape_resource_counts::de_resource_counts(tokens, _value, depth + 1)?,
                    );
                }
                "nextToken" => {
