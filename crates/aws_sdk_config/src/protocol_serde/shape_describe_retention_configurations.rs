...
> {
    ...
    let mut generic_builder =
        crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(
            crate::operation::describe_retention_configurations::DescribeRetentionConfigurationsError::unhandled,
        )?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_retention_configurations::de_describe_retention_configurations(
            _response_body,
            output,
        )
        .map_err(
...
pub(crate) fn de_describe_retention_configurations(
    _value: &[u8],
    mut builder: crate::operation::describe_retention_configurations::builders::DescribeRetentionConfigurationsOutputBuilder,
) -> ::std::result::Result<
    crate::operation::describe_retention_configurations::builders::DescribeRetentionConfigurationsOutputBuilder,
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "RetentionConfigurations" => {
                    builder = builder.set_retention_configurations(
                        crate::protocol_serde::shape_retention_configuration_list::de_retention_configuration_list(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
