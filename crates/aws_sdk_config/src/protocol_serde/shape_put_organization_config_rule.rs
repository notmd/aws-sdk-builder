...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_put_organization_config_rule::de_put_organization_config_rule(
            _response_body,
            output,
        )
        .map_err(crate::operation::put_organization_config_rule::PutOrganizationConfigRuleError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_put_organization_config_rule_input::ser_put_organization_config_rule_input_input(
        &mut object,
        input,
    )?;
    object.finish();
