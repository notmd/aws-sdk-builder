...
pub fn ser_organization_custom_rule_metadata(
    ...
    }
    {
        object
            ...
            .string(input.lambda_function_arn.as_str());
    }
    {
...
pub(crate) fn de_organization_custom_rule_metadata<'a, I>(
    ...
    Option<crate::types::OrganizationCustomRuleMetadata>,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "ResourceTypesScope" => {
                                builder = builder.set_resource_types_scope(
                                    crate::protocol_serde::shape_resource_types_scope::de_resource_types_scope(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
