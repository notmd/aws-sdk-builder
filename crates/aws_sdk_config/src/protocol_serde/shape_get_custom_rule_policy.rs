...
> {
    ...
    Err(match error_code {
        "NoSuchConfigRuleException" => {
            crate::operation::get_custom_rule_policy::GetCustomRulePolicyError::NoSuchConfigRuleException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_get_custom_rule_policy_input::ser_get_custom_rule_policy_input_input(
        &mut object,
        input,
    )?;
    object.finish();
