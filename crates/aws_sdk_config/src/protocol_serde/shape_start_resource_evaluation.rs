...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::start_resource_evaluation::StartResourceEvaluationError::unhandled(generic))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_start_resource_evaluation::de_start_resource_evaluation(
            _response_body,
            output,
        )
        .map_err(crate::operation::start_resource_evaluation::StartResourceEvaluationError::unhandled)?;
...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_start_resource_evaluation_input::ser_start_resource_evaluation_input_input(
        &mut object,
        input,
    )?;
    object.finish();
