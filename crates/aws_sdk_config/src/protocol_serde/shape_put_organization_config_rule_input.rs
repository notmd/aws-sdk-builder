...
pub fn ser_put_organization_config_rule_input_input(
    ...
    if let Some(var_2) = &input.organization_managed_rule_metadata {
        ...
        crate::protocol_serde::shape_organization_managed_rule_metadata::ser_organization_managed_rule_metadata(
            &mut object_3,
            var_2,
        )?;
        object_3.finish();
    ...
    if let Some(var_4) = &input.organization_custom_rule_metadata {
        ...
        crate::protocol_serde::shape_organization_custom_rule_metadata::ser_organization_custom_rule_metadata(
            &mut object_5,
            var_4,
        )?;
        object_5.finish();
