...
pub struct DescribeConformancePackCompliancePaginator {
    ...
    builder:
        crate::operation::describe_conformance_pack_compliance::builders::DescribeConformancePackComplianceInputBuilder,
...
impl DescribeConformancePackCompliancePaginator {
    ...
    pub(crate) fn new(
        handle: std::sync::Arc<crate::client::Handle>,
        builder: crate::operation::describe_conformance_pack_compliance::builders::DescribeConformancePackComplianceInputBuilder,
    ) -> Self {
        Self {
            handle,
            builder,
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(
            ::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::describe_conformance_pack_compliance::DescribeConformancePackCompliance::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token =
                                    crate::lens::reflens_describe_conformance_pack_compliance_output_output_next_token(
                                        resp,
                                    );
...
impl DescribeConformancePackCompliancePaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_conformance_pack_compliance_output_output_conformance_pack_rule_compliance_list(
                page,
            )
            .unwrap_or_default()
            .into_iter()
