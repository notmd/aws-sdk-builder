...
impl GetOrganizationCustomRulePolicyFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::get_organization_custom_rule_policy::builders::GetOrganizationCustomRulePolicyInputBuilder
    {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::get_organization_custom_rule_policy::GetOrganizationCustomRulePolicy::orchestrate(
            &runtime_plugins,
            input,
        )
        .await
