...
impl ListConfigurationRecordersPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::list_configuration_recorders::paginator::ListConfigurationRecordersPaginatorItems {
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token =
                                    crate::lens::reflens_list_configuration_recorders_output_output_next_token(resp);
