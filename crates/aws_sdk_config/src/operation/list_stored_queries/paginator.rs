...
pub struct ListStoredQueriesPaginator {
    ...
    builder: crate::operation::list_stored_queries::builders::ListStoredQueriesInputBuilder,
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_stored_queries_output_output_next_token(resp);
