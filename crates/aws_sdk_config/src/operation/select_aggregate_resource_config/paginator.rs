...
impl SelectAggregateResourceConfigPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::select_aggregate_resource_config::paginator::SelectAggregateResourceConfigPaginatorItems
    {
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token =
                                    crate::lens::reflens_select_aggregate_resource_config_output_output_next_token(
                                        resp,
                                    );
