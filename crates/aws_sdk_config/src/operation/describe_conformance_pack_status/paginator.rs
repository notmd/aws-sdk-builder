...
impl DescribeConformancePackStatusPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::describe_conformance_pack_status::paginator::DescribeConformancePackStatusPaginatorItems
    {
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(
            ::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::describe_conformance_pack_status::DescribeConformancePackStatus::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token =
                                    crate::lens::reflens_describe_conformance_pack_status_output_output_next_token(
                                        resp,
                                    );
...
impl DescribeConformancePackStatusPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_conformance_pack_status_output_output_conformance_pack_status_details(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
