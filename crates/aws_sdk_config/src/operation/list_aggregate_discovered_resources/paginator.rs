...
impl ListAggregateDiscoveredResourcesPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::list_aggregate_discovered_resources::paginator::ListAggregateDiscoveredResourcesPaginatorItems
    {
        crate::operation::list_aggregate_discovered_resources::paginator::ListAggregateDiscoveredResourcesPaginatorItems(
            self,
        )
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token =
                                    crate::lens::reflens_list_aggregate_discovered_resources_output_output_next_token(
                                        resp,
                                    );
