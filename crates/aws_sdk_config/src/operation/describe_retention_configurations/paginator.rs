...
impl DescribeRetentionConfigurationsPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::describe_retention_configurations::paginator::DescribeRetentionConfigurationsPaginatorItems
    {
        crate::operation::describe_retention_configurations::paginator::DescribeRetentionConfigurationsPaginatorItems(
            self,
        )
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token =
                                    crate::lens::reflens_describe_retention_configurations_output_output_next_token(
                                        resp,
                                    );
