...
impl DeleteOrganizationConfigRuleFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::delete_organization_config_rule::builders::DeleteOrganizationConfigRuleInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::delete_organization_config_rule::DeleteOrganizationConfigRule::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        crate::operation::delete_organization_config_rule::DeleteOrganizationConfigRule::orchestrate(
            &runtime_plugins,
            input,
        )
        .await
