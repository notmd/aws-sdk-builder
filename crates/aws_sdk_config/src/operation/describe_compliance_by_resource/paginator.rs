...
pub struct DescribeComplianceByResourcePaginator {
    ...
    builder: crate::operation::describe_compliance_by_resource::builders::DescribeComplianceByResourceInputBuilder,
...
impl DescribeComplianceByResourcePaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::describe_compliance_by_resource::paginator::DescribeComplianceByResourcePaginatorItems {
        crate::operation::describe_compliance_by_resource::paginator::DescribeComplianceByResourcePaginatorItems(self)
    }
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::describe_compliance_by_resource::DescribeComplianceByResource::operation_runtime_plugins(
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(
            ::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::describe_compliance_by_resource::DescribeComplianceByResource::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token =
                                    crate::lens::reflens_describe_compliance_by_resource_output_output_next_token(resp);
...
impl DescribeComplianceByResourcePaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_compliance_by_resource_output_output_compliance_by_resources(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
