...
impl GetComplianceDetailsByResourcePaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::get_compliance_details_by_resource::paginator::GetComplianceDetailsByResourcePaginatorItems
    {
        crate::operation::get_compliance_details_by_resource::paginator::GetComplianceDetailsByResourcePaginatorItems(
            self,
        )
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token =
                                    crate::lens::reflens_get_compliance_details_by_resource_output_output_next_token(
                                        resp,
                                    );
