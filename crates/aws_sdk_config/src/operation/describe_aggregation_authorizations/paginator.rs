...
impl DescribeAggregationAuthorizationsPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::describe_aggregation_authorizations::paginator::DescribeAggregationAuthorizationsPaginatorItems
    {
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token =
                                    crate::lens::reflens_describe_aggregation_authorizations_output_output_next_token(
                                        resp,
                                    );
