...
impl DeleteConfigurationAggregatorFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::delete_configuration_aggregator::builders::DeleteConfigurationAggregatorInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::delete_configuration_aggregator::DeleteConfigurationAggregator::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        crate::operation::delete_configuration_aggregator::DeleteConfigurationAggregator::orchestrate(
            &runtime_plugins,
            input,
        )
        .await
