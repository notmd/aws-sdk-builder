...
## s3
**Progress:** `1344/1344` files compared · `1188` matched · `69` mismatches · `87` missing · `0` extra · `88.39%` match (100.00% means fully matched)
...
```diff
--- reference/src/operation/list_bucket_inventory_configurations.rs
+++ generated/src/operation/list_bucket_inventory_configurations.rs
@@ -108,7 +108,6 @@
                 .expect("required fields set"),
         ));
