...
## sns
**Progress:** `449/449` files compared · `211` matched · `81` mismatches · `157` missing · `0` extra · `46.99%` match (100.00% means fully matched)

### `src/client/check_if_phone_number_is_opted_out.rs`

```diff
--- reference/src/client/check_if_phone_number_is_opted_out.rs
+++ generated/src/client/check_if_phone_number_is_opted_out.rs
@@ -5,7 +5,7 @@
...
+    ///   - [`is_opted_out(Option<bool>)`](crate::operation::check_if_phone_number_is_opted_out::CheckIfPhoneNumberIsOptedOutOutput::is_opted_out): <p>Indicates whether the phone number is opted out:</p> <ul>  <li>   <p><code>true</code> – The phone number is opted out, meaning you cannot publish SMS messages to it.</p></li>  <li>   <p><code>false</code> – The phone number is opted in, meaning you can publish SMS messages to it.</p></li> </ul>
...
-///
-/// ```ignore
-/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_sns::Error> {
-/// # let client: aws_sdk_sns::Client = unimplemented!();
...
+include!(concat!(
+    env!("OUT_DIR"),
+    "/generated/sns/src/client/check_if_phone_number_is_opted_out.rs"
+));
...
+include!(concat!(
+    env!("OUT_DIR"),
+    "/generated/sns/src/client/get_platform_application_attributes.rs"
+));
...
+include!(concat!(
+    env!("OUT_DIR"),
+    "/generated/sns/src/client/list_endpoints_by_platform_application.rs"
+));
...
+include!(concat!(
+    env!("OUT_DIR"),
+    "/generated/sns/src/client/set_platform_application_attributes.rs"
+));
...
+}
+mod lens {
+    include!(concat!(env!("OUT_DIR"), "/generated/sns/src/lens.rs"));
+}
```
...
```diff
--- reference/src/operation/check_if_phone_number_is_opted_out/_check_if_phone_number_is_opted_out_output.rs
+++ generated/src/operation/check_if_phone_number_is_opted_out/_check_if_phone_number_is_opted_out_output.rs
@@ -11,7 +11,7 @@
     /// <li>
...
```diff
--- reference/src/operation/get_sms_sandbox_account_status/_get_sms_sandbox_account_status_output.rs
+++ generated/src/operation/get_sms_sandbox_account_status/_get_sms_sandbox_account_status_output.rs
@@ -58,10 +58,22 @@
         self
     }
...
```diff
--- reference/src/operation/list_origination_numbers/_list_origination_numbers_output.rs
+++ generated/src/operation/list_origination_numbers/_list_origination_numbers_output.rs
@@ -1,7 +1,7 @@
 // Code generated by software.amazon.smithy.rust.codegen.smithy-rs. DO NOT EDIT.
...
+impl ::std::fmt::Debug for ListOriginationNumbersOutputBuilder {
+    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
+        let mut formatter = f.debug_struct("ListOriginationNumbersOutputBuilder");
+        formatter.field("next_token", &self.next_token);
+        formatter.field("phone_numbers", &"*** Sensitive Data Redacted ***");
+        formatter.field("_request_id", &self._request_id);
+        formatter.finish()
...
+impl ::std::fmt::Debug for ListSmsSandboxPhoneNumbersOutputBuilder {
+    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
+        let mut formatter = f.debug_struct("ListSmsSandboxPhoneNumbersOutputBuilder");
+        formatter.field("phone_numbers", &"*** Sensitive Data Redacted ***");
+        formatter.field("next_token", &self.next_token);
+        formatter.field("_request_id", &self._request_id);
+        formatter.finish()
