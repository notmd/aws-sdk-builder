...
## kms
**Progress:** `600/600` files compared · `230` matched · `165` mismatches · `204` missing · `1` extra · `38.33%` match (100.00% means fully matched)
...
```diff
--- reference/src/operation/decrypt/_decrypt_output.rs
+++ generated/src/operation/decrypt/_decrypt_output.rs
@@ -7,12 +7,12 @@
...
```diff
--- reference/src/operation/derive_shared_secret/_derive_shared_secret_output.rs
+++ generated/src/operation/derive_shared_secret/_derive_shared_secret_output.rs
@@ -7,10 +7,10 @@
     pub key_id: ::std::option::Option<::std::string::String>,
...
```diff
--- reference/src/operation/derive_shared_secret/builders.rs
+++ generated/src/operation/derive_shared_secret/builders.rs
@@ -217,7 +217,7 @@
     /// <p>If you use <a href="https://docs.aws.amazon.com/cli/v1/userguide/cli-chap-welcome.html">Amazon Web Services CLI version 1</a>, you must provide the DER-encoded X.509 public key in a file. Otherwise, the Amazon Web Services CLI Base64-encodes the public key a second time, resulting in a <code>ValidationException</code>.</p>
     /// </note>
     /// <p>You can specify the public key as binary data in a file using fileb (<code>fileb://<path-to-file></path-to-file></code>) or in-line using a Base64 encoded string.</p>
...
+        formatter.field("custom_key_stores", &"*** Sensitive Data Redacted ***");
...
+impl ::std::fmt::Debug for DescribeCustomKeyStoresOutputBuilder {
+    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
+        let mut formatter = f.debug_struct("DescribeCustomKeyStoresOutputBuilder");
+        formatter.field("custom_key_stores", &"*** Sensitive Data Redacted ***");
+        formatter.field("next_marker", &self.next_marker);
+        formatter.field("truncated", &self.truncated);
+        formatter.field("_request_id", &self._request_id);
...
```diff
--- reference/src/operation/encrypt/_encrypt_output.rs
+++ generated/src/operation/encrypt/_encrypt_output.rs
@@ -4,7 +4,7 @@
 #[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::fmt::Debug)]
...
```diff
--- reference/src/operation/generate_data_key/_generate_data_key_output.rs
+++ generated/src/operation/generate_data_key/_generate_data_key_output.rs
@@ -4,15 +4,15 @@
 #[derive(::std::clone::Clone, ::std::cmp::PartialEq)]
...
```diff
--- reference/src/operation/generate_data_key_pair/_generate_data_key_pair_output.rs
+++ generated/src/operation/generate_data_key_pair/_generate_data_key_pair_output.rs
@@ -4,12 +4,12 @@
 #[derive(::std::clone::Clone, ::std::cmp::PartialEq)]
...
```diff
--- reference/src/operation/generate_data_key_pair_without_plaintext/_generate_data_key_pair_without_plaintext_output.rs
+++ generated/src/operation/generate_data_key_pair_without_plaintext/_generate_data_key_pair_without_plaintext_output.rs
@@ -4,9 +4,9 @@
 #[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::fmt::Debug)]
...
```diff
--- reference/src/operation/generate_data_key_without_plaintext/_generate_data_key_without_plaintext_output.rs
+++ generated/src/operation/generate_data_key_without_plaintext/_generate_data_key_without_plaintext_output.rs
@@ -4,7 +4,7 @@
 #[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::fmt::Debug)]
...
```diff
--- reference/src/operation/generate_mac/_generate_mac_output.rs
+++ generated/src/operation/generate_mac/_generate_mac_output.rs
@@ -5,7 +5,7 @@
...
```diff
--- reference/src/operation/generate_mac/builders.rs
+++ generated/src/operation/generate_mac/builders.rs
@@ -118,19 +118,19 @@
     }
     /// <p>The message to be hashed. Specify a message of up to 4,096 bytes.</p>
     /// <p><code>GenerateMac</code> and <code>VerifyMac</code> do not provide special handling for message digests. If you generate an HMAC for a hash digest of a message, you must verify the HMAC of the same hash digest.</p>
...
```diff
--- reference/src/operation/generate_random/_generate_random_output.rs
+++ generated/src/operation/generate_random/_generate_random_output.rs
@@ -5,21 +5,21 @@
...
```diff
--- reference/src/operation/get_parameters_for_import/_get_parameters_for_import_output.rs
+++ generated/src/operation/get_parameters_for_import/_get_parameters_for_import_output.rs
@@ -6,9 +6,9 @@
...
+    pub encrypted_key_material: ::std::option::Option<::std::vec::Vec<u8>>,
...
+    pub fn encrypted_key_material(&self) -> ::std::option::Option<&::std::vec::Vec<u8>> {
...
+    pub(crate) import_token: ::std::option::Option<::std::vec::Vec<u8>>,
+    pub(crate) encrypted_key_material: ::std::option::Option<::std::vec::Vec<u8>>,
...
```diff
--- reference/src/operation/import_key_material/builders.rs
+++ generated/src/operation/import_key_material/builders.rs
@@ -204,31 +204,31 @@
         self.inner.get_key_id()
     }
     /// <p>The import token that you received in the response to a previous <code>GetParametersForImport</code> request. It must be from the same response that contained the public key that you used to encrypt the key material.</p>
...
```diff
--- reference/src/operation/re_encrypt/_re_encrypt_output.rs
+++ generated/src/operation/re_encrypt/_re_encrypt_output.rs
@@ -4,7 +4,7 @@
 #[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::fmt::Debug)]
...
```diff
--- reference/src/operation/sign/_sign_input.rs
+++ generated/src/operation/sign/_sign_input.rs
@@ -20,7 +20,7 @@
     pub key_id: ::std::option::Option<::std::string::String>,
...
```diff
--- reference/src/operation/sign/_sign_output.rs
+++ generated/src/operation/sign/_sign_output.rs
@@ -13,7 +13,7 @@
...
```diff
--- reference/src/types/_recipient_info.rs
+++ generated/src/types/_recipient_info.rs
@@ -8,7 +8,7 @@
