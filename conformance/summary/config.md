...
## config
**Progress:** `1262/1262` files compared · `1142` matched · `120` mismatches · `0` missing · `0` extra · `90.49%` match (100.00% means fully matched)
...
+    ///   - [`configuration_recorder(Option<ConfigurationRecorder>)`](crate::operation::associate_resource_types::AssociateResourceTypesOutput::configuration_recorder): <p>Records configuration changes to the resource types in scope.</p> <p>For more information about the configuration recorder, see <a href="https://docs.aws.amazon.com/config/latest/developerguide/stop-start-recorder.html"> <b>Working with the Configuration Recorder</b></a> in the <i>Config Developer Guide</i>.</p>
     ...
     pub fn associate_resource_types(&self) -> super::operation::associate_resource_types::builders::AssociateResourceTypesFluentBuilder {
         super::operation::associate_resource_types::builders::AssociateResourceTypesFluentBuilder::new(self.handle.clone())
```
...
+    ///   - [`configuration_recorder(Option<ConfigurationRecorder>)`](crate::operation::disassociate_resource_types::DisassociateResourceTypesOutput::configuration_recorder): <p>Records configuration changes to the resource types in scope.</p> <p>For more information about the configuration recorder, see <a href="https://docs.aws.amazon.com/config/latest/developerguide/stop-start-recorder.html"> <b>Working with the Configuration Recorder</b></a> in the <i>Config Developer Guide</i>.</p>
     ...
     pub fn disassociate_resource_types(&self) -> super::operation::disassociate_resource_types::builders::DisassociateResourceTypesFluentBuilder {
         super::operation::disassociate_resource_types::builders::DisassociateResourceTypesFluentBuilder::new(self.handle.clone())
```
...
```diff
--- reference/src/operation/describe_aggregate_compliance_by_config_rules/_describe_aggregate_compliance_by_config_rules_input.rs
+++ generated/src/operation/describe_aggregate_compliance_by_config_rules/_describe_aggregate_compliance_by_config_rules_input.rs
@@ -116,7 +116,7 @@
             super::operation::describe_aggregate_compliance_by_config_rules::DescribeAggregateComplianceByConfigRulesInput {
...
```diff
--- reference/src/operation/describe_aggregate_compliance_by_conformance_packs/_describe_aggregate_compliance_by_conformance_packs_input.rs
+++ generated/src/operation/describe_aggregate_compliance_by_conformance_packs/_describe_aggregate_compliance_by_conformance_packs_input.rs
@@ -117,7 +117,7 @@
             super::operation::describe_aggregate_compliance_by_conformance_packs::DescribeAggregateComplianceByConformancePacksInput {
                 configuration_aggregator_name: self.configuration_aggregator_name,
                 filters: self.filters,
-                limit: self.limit,
+                limit: self.limit.unwrap_or_default(),
...
```diff
--- reference/src/operation/describe_aggregate_compliance_by_conformance_packs/paginator.rs
+++ generated/src/operation/describe_aggregate_compliance_by_conformance_packs/paginator.rs
@@ -72,10 +72,11 @@
         let builder = self.builder;
         let handle = self.handle;
         let runtime_plugins = super::operation::describe_aggregate_compliance_by_conformance_packs::DescribeAggregateComplianceByConformancePacks::operation_runtime_plugins(
-                                handle.runtime_plugins.clone(),
-                                &handle.conf,
-                                ::std::option::Option::None,
-                            ).with_operation_plugin(super::sdk_feature_tracker::paginator::PaginatorFeatureTrackerRuntimePlugin::new());
+            handle.runtime_plugins.clone(),
+            &handle.conf,
+            ::std::option::Option::None,
+        )
...
```diff
--- reference/src/operation/describe_aggregation_authorizations/_describe_aggregation_authorizations_input.rs
+++ generated/src/operation/describe_aggregation_authorizations/_describe_aggregation_authorizations_input.rs
@@ -70,7 +70,7 @@
     > {
         ::std::result::Result::Ok(
             super::operation::describe_aggregation_authorizations::DescribeAggregationAuthorizationsInput {
-                limit: self.limit,
+                limit: self.limit.unwrap_or_default(),
                 next_token: self.next_token,
             },
...
```diff
--- reference/src/operation/describe_compliance_by_resource/_describe_compliance_by_resource_input.rs
+++ generated/src/operation/describe_compliance_by_resource/_describe_compliance_by_resource_input.rs
@@ -144,7 +144,7 @@
...
```diff
--- reference/src/operation/describe_config_rule_evaluation_status/_describe_config_rule_evaluation_status_input.rs
+++ generated/src/operation/describe_config_rule_evaluation_status/_describe_config_rule_evaluation_status_input.rs
@@ -112,7 +112,7 @@
             super::operation::describe_config_rule_evaluation_status::DescribeConfigRuleEvaluationStatusInput {
...
```diff
--- reference/src/operation/describe_configuration_aggregator_sources_status/_describe_configuration_aggregator_sources_status_input.rs
+++ generated/src/operation/describe_configuration_aggregator_sources_status/_describe_configuration_aggregator_sources_status_input.rs
@@ -165,7 +165,7 @@
                 configuration_aggregator_name: self.configuration_aggregator_name,
...
```diff
--- reference/src/operation/describe_configuration_aggregator_sources_status/paginator.rs
+++ generated/src/operation/describe_configuration_aggregator_sources_status/paginator.rs
@@ -71,10 +71,11 @@
         let builder = self.builder;
         let handle = self.handle;
         let runtime_plugins = super::operation::describe_configuration_aggregator_sources_status::DescribeConfigurationAggregatorSourcesStatus::operation_runtime_plugins(
-                                handle.runtime_plugins.clone(),
-                                &handle.conf,
-                                ::std::option::Option::None,
-                            ).with_operation_plugin(super::sdk_feature_tracker::paginator::PaginatorFeatureTrackerRuntimePlugin::new());
...
```diff
--- reference/src/operation/describe_configuration_aggregators/_describe_configuration_aggregators_input.rs
+++ generated/src/operation/describe_configuration_aggregators/_describe_configuration_aggregators_input.rs
@@ -101,7 +101,7 @@
             super::operation::describe_configuration_aggregators::DescribeConfigurationAggregatorsInput {
...
```diff
--- reference/src/operation/describe_conformance_pack_compliance/_describe_conformance_pack_compliance_input.rs
+++ generated/src/operation/describe_conformance_pack_compliance/_describe_conformance_pack_compliance_input.rs
@@ -115,7 +115,7 @@
             super::operation::describe_conformance_pack_compliance::DescribeConformancePackComplianceInput {
...
```diff
--- reference/src/operation/describe_conformance_pack_compliance/_describe_conformance_pack_compliance_output.rs
+++ generated/src/operation/describe_conformance_pack_compliance/_describe_conformance_pack_compliance_output.rs
@@ -120,22 +120,11 @@
         super::operation::describe_conformance_pack_compliance::DescribeConformancePackComplianceOutput,
...
-            }
-        )
+        ::std::result::Result::Ok(super::operation::describe_conformance_pack_compliance::DescribeConformancePackComplianceOutput {
+            conformance_pack_name: self.conformance_pack_name.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("conformance_pack_name", "conformance_pack_name was not specified but it is required when building DescribeConformancePackComplianceOutput"))?,
+            conformance_pack_rule_compliance_list: self.conformance_pack_rule_compliance_list.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("conformance_pack_rule_compliance_list", "conformance_pack_rule_compliance_list was not specified but it is required when building DescribeConformancePackComplianceOutput"))?,
+            next_token: self.next_token,
+            _request_id: self._request_id,
+        })
     }
...
```diff
--- reference/src/operation/describe_conformance_pack_status/_describe_conformance_pack_status_input.rs
+++ generated/src/operation/describe_conformance_pack_status/_describe_conformance_pack_status_input.rs
@@ -99,7 +99,7 @@
     > {
         ::std::result::Result::Ok(super::operation::describe_conformance_pack_status::DescribeConformancePackStatusInput {
...
```diff
--- reference/src/operation/describe_conformance_packs/_describe_conformance_packs_input.rs
+++ generated/src/operation/describe_conformance_packs/_describe_conformance_packs_input.rs
@@ -99,7 +99,7 @@
     > {
         ::std::result::Result::Ok(super::operation::describe_conformance_packs::DescribeConformancePacksInput {
             conformance_pack_names: self.conformance_pack_names,
-            limit: self.limit,
+            limit: self.limit.unwrap_or_default(),
             next_token: self.next_token,
...
```diff
--- reference/src/operation/describe_organization_config_rule_statuses/_describe_organization_config_rule_statuses_input.rs
+++ generated/src/operation/describe_organization_config_rule_statuses/_describe_organization_config_rule_statuses_input.rs
@@ -100,7 +100,7 @@
         ::std::result::Result::Ok(
             super::operation::describe_organization_config_rule_statuses::DescribeOrganizationConfigRuleStatusesInput {
...
```diff
--- reference/src/operation/describe_organization_config_rules/_describe_organization_config_rules_input.rs
+++ generated/src/operation/describe_organization_config_rules/_describe_organization_config_rules_input.rs
@@ -100,7 +100,7 @@
         ::std::result::Result::Ok(
             super::operation::describe_organization_config_rules::DescribeOrganizationConfigRulesInput {
                 organization_config_rule_names: self.organization_config_rule_names,
-                limit: self.limit,
+                limit: self.limit.unwrap_or_default(),
                 next_token: self.next_token,
...
```diff
--- reference/src/operation/describe_organization_conformance_pack_statuses/_describe_organization_conformance_pack_statuses_input.rs
+++ generated/src/operation/describe_organization_conformance_pack_statuses/_describe_organization_conformance_pack_statuses_input.rs
@@ -102,7 +102,7 @@
         ::std::result::Result::Ok(
             super::operation::describe_organization_conformance_pack_statuses::DescribeOrganizationConformancePackStatusesInput {
...
```diff
--- reference/src/operation/describe_organization_conformance_pack_statuses/paginator.rs
+++ generated/src/operation/describe_organization_conformance_pack_statuses/paginator.rs
@@ -68,10 +68,11 @@
         let builder = self.builder;
         let handle = self.handle;
         let runtime_plugins = super::operation::describe_organization_conformance_pack_statuses::DescribeOrganizationConformancePackStatuses::operation_runtime_plugins(
-                                handle.runtime_plugins.clone(),
-                                &handle.conf,
-                                ::std::option::Option::None,
-                            ).with_operation_plugin(super::sdk_feature_tracker::paginator::PaginatorFeatureTrackerRuntimePlugin::new());
...
```diff
--- reference/src/operation/describe_organization_conformance_packs/_describe_organization_conformance_packs_input.rs
+++ generated/src/operation/describe_organization_conformance_packs/_describe_organization_conformance_packs_input.rs
@@ -100,7 +100,7 @@
         ::std::result::Result::Ok(
             super::operation::describe_organization_conformance_packs::DescribeOrganizationConformancePacksInput {
                 organization_conformance_pack_names: self.organization_conformance_pack_names,
-                limit: self.limit,
+                limit: self.limit.unwrap_or_default(),
                 next_token: self.next_token,
...
```diff
--- reference/src/operation/describe_pending_aggregation_requests/_describe_pending_aggregation_requests_input.rs
+++ generated/src/operation/describe_pending_aggregation_requests/_describe_pending_aggregation_requests_input.rs
@@ -70,7 +70,7 @@
     > {
         ::std::result::Result::Ok(
             super::operation::describe_pending_aggregation_requests::DescribePendingAggregationRequestsInput {
-                limit: self.limit,
+                limit: self.limit.unwrap_or_default(),
                 next_token: self.next_token,
             },
...
```diff
--- reference/src/operation/describe_remediation_exceptions/_describe_remediation_exceptions_input.rs
+++ generated/src/operation/describe_remediation_exceptions/_describe_remediation_exceptions_input.rs
@@ -122,7 +122,7 @@
         ::std::result::Result::Ok(super::operation::describe_remediation_exceptions::DescribeRemediationExceptionsInput {
...
```diff
--- reference/src/operation/describe_remediation_execution_status/_describe_remediation_execution_status_input.rs
+++ generated/src/operation/describe_remediation_execution_status/_describe_remediation_execution_status_input.rs
@@ -123,7 +123,7 @@
             super::operation::describe_remediation_execution_status::DescribeRemediationExecutionStatusInput {
                 config_rule_name: self.config_rule_name,
                 resource_keys: self.resource_keys,
-                limit: self.limit,
+                limit: self.limit.unwrap_or_default(),
...
```diff
--- reference/src/operation/get_aggregate_compliance_details_by_config_rule/_get_aggregate_compliance_details_by_config_rule_input.rs
+++ generated/src/operation/get_aggregate_compliance_details_by_config_rule/_get_aggregate_compliance_details_by_config_rule_input.rs
@@ -195,7 +195,7 @@
...
```diff
--- reference/src/operation/get_aggregate_config_rule_compliance_summary/_get_aggregate_config_rule_compliance_summary_input.rs
+++ generated/src/operation/get_aggregate_config_rule_compliance_summary/_get_aggregate_config_rule_compliance_summary_input.rs
@@ -138,7 +138,7 @@
                 configuration_aggregator_name: self.configuration_aggregator_name,
                 filters: self.filters,
...
```diff
--- reference/src/operation/get_aggregate_conformance_pack_compliance_summary/_get_aggregate_conformance_pack_compliance_summary_input.rs
+++ generated/src/operation/get_aggregate_conformance_pack_compliance_summary/_get_aggregate_conformance_pack_compliance_summary_input.rs
@@ -138,7 +138,7 @@
                 configuration_aggregator_name: self.configuration_aggregator_name,
                 filters: self.filters,
                 group_by_key: self.group_by_key,
...
```diff
--- reference/src/operation/get_aggregate_conformance_pack_compliance_summary/paginator.rs
+++ generated/src/operation/get_aggregate_conformance_pack_compliance_summary/paginator.rs
@@ -58,10 +58,11 @@
         let builder = self.builder;
         let handle = self.handle;
         let runtime_plugins = super::operation::get_aggregate_conformance_pack_compliance_summary::GetAggregateConformancePackComplianceSummary::operation_runtime_plugins(
-                                handle.runtime_plugins.clone(),
-                                &handle.conf,
-                                ::std::option::Option::None,
-                            ).with_operation_plugin(super::sdk_feature_tracker::paginator::PaginatorFeatureTrackerRuntimePlugin::new());
...
```diff
--- reference/src/operation/get_aggregate_discovered_resource_counts/_get_aggregate_discovered_resource_counts_input.rs
+++ generated/src/operation/get_aggregate_discovered_resource_counts/_get_aggregate_discovered_resource_counts_input.rs
@@ -137,7 +137,7 @@
                 configuration_aggregator_name: self.configuration_aggregator_name,
                 filters: self.filters,
                 group_by_key: self.group_by_key,
...
```diff
--- reference/src/operation/get_compliance_details_by_config_rule/_get_compliance_details_by_config_rule_input.rs
+++ generated/src/operation/get_compliance_details_by_config_rule/_get_compliance_details_by_config_rule_input.rs
@@ -129,7 +129,7 @@
             super::operation::get_compliance_details_by_config_rule::GetComplianceDetailsByConfigRuleInput {
                 config_rule_name: self.config_rule_name,
                 compliance_types: self.compliance_types,
-                limit: self.limit,
+                limit: self.limit.unwrap_or_default(),
...
-            super::protocol_serde::shape_get_compliance_summary_by_config_rule::ser_get_compliance_summary_by_config_rule_input(&input)?,
-        );
+        let body = ::aws_smithy_types::body::SdkBody::from("");
...
```diff
--- reference/src/operation/get_conformance_pack_compliance_details/_get_conformance_pack_compliance_details_input.rs
+++ generated/src/operation/get_conformance_pack_compliance_details/_get_conformance_pack_compliance_details_input.rs
@@ -115,7 +115,7 @@
             super::operation::get_conformance_pack_compliance_details::GetConformancePackComplianceDetailsInput {
                 conformance_pack_name: self.conformance_pack_name,
                 filters: self.filters,
-                limit: self.limit,
+                limit: self.limit.unwrap_or_default(),
...
```diff
--- reference/src/operation/get_conformance_pack_compliance_summary/_get_conformance_pack_compliance_summary_input.rs
+++ generated/src/operation/get_conformance_pack_compliance_summary/_get_conformance_pack_compliance_summary_input.rs
@@ -100,7 +100,7 @@
         ::std::result::Result::Ok(
             super::operation::get_conformance_pack_compliance_summary::GetConformancePackComplianceSummaryInput {
                 conformance_pack_names: self.conformance_pack_names,
-                limit: self.limit,
+                limit: self.limit.unwrap_or_default(),
                 next_token: self.next_token,
...
```diff
--- reference/src/operation/get_discovered_resource_counts/_get_discovered_resource_counts_input.rs
+++ generated/src/operation/get_discovered_resource_counts/_get_discovered_resource_counts_input.rs
@@ -114,7 +114,7 @@
     > {
         ::std::result::Result::Ok(super::operation::get_discovered_resource_counts::GetDiscoveredResourceCountsInput {
...
```diff
--- reference/src/operation/get_organization_config_rule_detailed_status/_get_organization_config_rule_detailed_status_input.rs
+++ generated/src/operation/get_organization_config_rule_detailed_status/_get_organization_config_rule_detailed_status_input.rs
@@ -116,7 +116,7 @@
             super::operation::get_organization_config_rule_detailed_status::GetOrganizationConfigRuleDetailedStatusInput {
...
```diff
--- reference/src/operation/get_organization_conformance_pack_detailed_status/_get_organization_conformance_pack_detailed_status_input.rs
+++ generated/src/operation/get_organization_conformance_pack_detailed_status/_get_organization_conformance_pack_detailed_status_input.rs
@@ -116,7 +116,7 @@
             super::operation::get_organization_conformance_pack_detailed_status::GetOrganizationConformancePackDetailedStatusInput {
...
```diff
--- reference/src/operation/get_organization_conformance_pack_detailed_status/paginator.rs
+++ generated/src/operation/get_organization_conformance_pack_detailed_status/paginator.rs
@@ -71,10 +71,11 @@
         let builder = self.builder;
         let handle = self.handle;
         let runtime_plugins = super::operation::get_organization_conformance_pack_detailed_status::GetOrganizationConformancePackDetailedStatus::operation_runtime_plugins(
-                                handle.runtime_plugins.clone(),
-                                &handle.conf,
-                                ::std::option::Option::None,
-                            ).with_operation_plugin(super::sdk_feature_tracker::paginator::PaginatorFeatureTrackerRuntimePlugin::new());
...
```diff
--- reference/src/operation/get_resource_config_history/_get_resource_config_history_input.rs
+++ generated/src/operation/get_resource_config_history/_get_resource_config_history_input.rs
@@ -182,7 +182,7 @@
...
```diff
--- reference/src/operation/list_aggregate_discovered_resources/_list_aggregate_discovered_resources_input.rs
+++ generated/src/operation/list_aggregate_discovered_resources/_list_aggregate_discovered_resources_input.rs
@@ -138,7 +138,7 @@
                 configuration_aggregator_name: self.configuration_aggregator_name,
                 resource_type: self.resource_type,
                 filters: self.filters,
...
```diff
--- reference/src/operation/list_configuration_recorders/_list_configuration_recorders_input.rs
+++ generated/src/operation/list_configuration_recorders/_list_configuration_recorders_input.rs
@@ -99,7 +99,7 @@
     > {
         ::std::result::Result::Ok(super::operation::list_configuration_recorders::ListConfigurationRecordersInput {
             filters: self.filters,
...
```diff
--- reference/src/operation/list_conformance_pack_compliance_scores/_list_conformance_pack_compliance_scores_input.rs
+++ generated/src/operation/list_conformance_pack_compliance_scores/_list_conformance_pack_compliance_scores_input.rs
@@ -151,7 +151,7 @@
                 filters: self.filters,
...
```diff
--- reference/src/operation/list_conformance_pack_compliance_scores/_list_conformance_pack_compliance_scores_output.rs
+++ generated/src/operation/list_conformance_pack_compliance_scores/_list_conformance_pack_compliance_scores_output.rs
@@ -96,17 +96,10 @@
...
-            }
-        )
+        ::std::result::Result::Ok(super::operation::list_conformance_pack_compliance_scores::ListConformancePackComplianceScoresOutput {
+            next_token: self.next_token,
+            conformance_pack_compliance_scores: self.conformance_pack_compliance_scores.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("conformance_pack_compliance_scores", "conformance_pack_compliance_scores was not specified but it is required when building ListConformancePackComplianceScoresOutput"))?,
+            _request_id: self._request_id,
+        })
     }
 }
...
```diff
--- reference/src/operation/list_connectors/_list_connectors_input.rs
+++ generated/src/operation/list_connectors/_list_connectors_input.rs
@@ -95,7 +95,7 @@
         self,
     ) -> ::std::result::Result<super::operation::list_connectors::ListConnectorsInput, ::aws_smithy_types::error::operation::BuildError> {
         ::std::result::Result::Ok(super::operation::list_connectors::ListConnectorsInput {
-            max_results: self.max_results,
+            max_results: self.max_results.unwrap_or_default(),
             next_token: self.next_token,
             filters: self.filters,
...
```diff
--- reference/src/operation/list_discovered_resources/_list_discovered_resources_input.rs
+++ generated/src/operation/list_discovered_resources/_list_discovered_resources_input.rs
@@ -166,8 +166,8 @@
             resource_type: self.resource_type,
...
```diff
--- reference/src/operation/list_resource_evaluations/_list_resource_evaluations_input.rs
+++ generated/src/operation/list_resource_evaluations/_list_resource_evaluations_input.rs
@@ -91,7 +91,7 @@
     > {
         ::std::result::Result::Ok(super::operation::list_resource_evaluations::ListResourceEvaluationsInput {
             filters: self.filters,
-            limit: self.limit,
+            limit: self.limit.unwrap_or_default(),
             next_token: self.next_token,
...
```diff
--- reference/src/operation/list_stored_queries/_list_stored_queries_input.rs
+++ generated/src/operation/list_stored_queries/_list_stored_queries_input.rs
@@ -67,7 +67,7 @@
     ) -> ::std::result::Result<super::operation::list_stored_queries::ListStoredQueriesInput, ::aws_smithy_types::error::operation::BuildError> {
         ::std::result::Result::Ok(super::operation::list_stored_queries::ListStoredQueriesInput {
             next_token: self.next_token,
-            max_results: self.max_results,
+            max_results: self.max_results.unwrap_or_default(),
         })
...
@@ -190,7 +190,7 @@
     {
         ::std::result::Result::Ok(super::operation::list_tags_for_resource::ListTagsForResourceInput {
...
```diff
--- reference/src/operation/put_evaluations/_put_evaluations_input.rs
+++ generated/src/operation/put_evaluations/_put_evaluations_input.rs
@@ -109,7 +109,7 @@
         ::std::result::Result::Ok(super::operation::put_evaluations::PutEvaluationsInput {
...
```diff
--- reference/src/operation/select_aggregate_resource_config/_select_aggregate_resource_config_input.rs
+++ generated/src/operation/select_aggregate_resource_config/_select_aggregate_resource_config_input.rs
@@ -136,8 +136,8 @@
         ::std::result::Result::Ok(super::operation::select_aggregate_resource_config::SelectAggregateResourceConfigInput {
...
```diff
--- reference/src/operation/select_resource_config/_select_resource_config_input.rs
+++ generated/src/operation/select_resource_config/_select_resource_config_input.rs
@@ -90,7 +90,7 @@
     {
         ::std::result::Result::Ok(super::operation::select_resource_config::SelectResourceConfigInput {
             expression: self.expression,
-            limit: self.limit,
+            limit: self.limit.unwrap_or_default(),
             next_token: self.next_token,
...
```diff
--- reference/src/operation/start_resource_evaluation/_start_resource_evaluation_input.rs
+++ generated/src/operation/start_resource_evaluation/_start_resource_evaluation_input.rs
@@ -157,7 +157,7 @@
...
### `src/protocol_serde/shape_aggregate_conformance_pack_compliance_summary.rs`

```diff
--- reference/src/protocol_serde/shape_aggregate_conformance_pack_compliance_summary.rs
+++ generated/src/protocol_serde/shape_aggregate_conformance_pack_compliance_summary.rs
@@ -22,9 +22,7 @@
                     Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                     Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                         "ComplianceSummary" => {
-                            builder = builder.set_compliance_summary(
-                                    super::protocol_serde::shape_aggregate_conformance_pack_compliance_count::de_aggregate_conformance_pack_compliance_count(tokens, _value, depth + 1)?
-                                );
+                            builder = builder.set_compliance_summary(super::protocol_serde::shape_aggregate_conformance_pack_compliance_count::de_aggregate_conformance_pack_compliance_count(tokens, _value, depth + 1)?);
                         }
                         "GroupName" => {
                             builder = builder.set_group_name(
```

### `src/protocol_serde/shape_aggregate_conformance_pack_compliance_summary_list.rs`

```diff
--- reference/src/protocol_serde/shape_aggregate_conformance_pack_compliance_summary_list.rs
+++ generated/src/protocol_serde/shape_aggregate_conformance_pack_compliance_summary_list.rs
@@ -26,9 +26,7 @@
                         break;
                     }
                     _ => {
-                        let value =
-                            super::protocol_serde::shape_aggregate_conformance_pack_compliance_summary::de_aggregate_conformance_pack_compliance_summary(tokens, _value, depth + 1)?
-                        ;
+                        let value = super::protocol_serde::shape_aggregate_conformance_pack_compliance_summary::de_aggregate_conformance_pack_compliance_summary(tokens, _value, depth + 1)?;
                         if let Some(value) = value {
                             items.push(value);
                         } else {
```

### `src/protocol_serde/shape_configuration_recorder.rs`

```diff
--- reference/src/protocol_serde/shape_configuration_recorder.rs
+++ generated/src/protocol_serde/shape_configuration_recorder.rs
@@ -1,4 +1,47 @@
 // Code generated by software.amazon.smithy.rust.codegen.smithy-rs. DO NOT EDIT.
+pub fn ser_configuration_recorder(
+    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
+    input: &super::types::ConfigurationRecorder,
...
+        super::protocol_serde::shape_recording_group::ser_recording_group(&mut object_5, var_4)?;
+        object_5.finish();
+    }
+    if let Some(var_6) = &input.recording_mode {
+        #[allow(unused_mut)]
+        let mut object_7 = object.key("recordingMode").start_object();
+        super::protocol_serde::shape_recording_mode::ser_recording_mode(&mut object_7, var_6)?;
+        object_7.finish();
+    }
...
+        super::protocol_serde::shape_scope_configuration::ser_scope_configuration(&mut object_12, var_11)?;
+        object_12.finish();
+    }
+    Ok(())
+}
...
### `src/protocol_serde/shape_delete_aggregation_authorization.rs`

```diff
--- reference/src/protocol_serde/shape_delete_aggregation_authorization.rs
+++ generated/src/protocol_serde/shape_delete_aggregation_authorization.rs
@@ -70,3 +70,36 @@
     object.finish();
     Ok(::aws_smithy_types::body::SdkBody::from(out))
 }
+
+pub(crate) fn de_delete_aggregation_authorization(
+    _value: &[u8],
+    mut builder: super::operation::delete_aggregation_authorization::builders::DeleteAggregationAuthorizationOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::delete_aggregation_authorization::builders::DeleteAggregationAuthorizationOutputBuilder,
...
### `src/protocol_serde/shape_delete_config_rule.rs`

```diff
--- reference/src/protocol_serde/shape_delete_config_rule.rs
+++ generated/src/protocol_serde/shape_delete_config_rule.rs
@@ -75,3 +75,36 @@
     object.finish();
     Ok(::aws_smithy_types::body::SdkBody::from(out))
 }
...
+    _value: &[u8],
+    mut builder: super::operation::delete_config_rule::builders::DeleteConfigRuleOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::delete_config_rule::builders::DeleteConfigRuleOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
### `src/protocol_serde/shape_delete_configuration_aggregator.rs`

```diff
--- reference/src/protocol_serde/shape_delete_configuration_aggregator.rs
+++ generated/src/protocol_serde/shape_delete_configuration_aggregator.rs
@@ -66,3 +66,36 @@
     object.finish();
     Ok(::aws_smithy_types::body::SdkBody::from(out))
 }
+
+pub(crate) fn de_delete_configuration_aggregator(
+    _value: &[u8],
+    mut builder: super::operation::delete_configuration_aggregator::builders::DeleteConfigurationAggregatorOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::delete_configuration_aggregator::builders::DeleteConfigurationAggregatorOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
### `src/protocol_serde/shape_delete_configuration_recorder.rs`

```diff
--- reference/src/protocol_serde/shape_delete_configuration_recorder.rs
+++ generated/src/protocol_serde/shape_delete_configuration_recorder.rs
@@ -89,3 +89,36 @@
     object.finish();
     Ok(::aws_smithy_types::body::SdkBody::from(out))
 }
+
+pub(crate) fn de_delete_configuration_recorder(
+    _value: &[u8],
+    mut builder: super::operation::delete_configuration_recorder::builders::DeleteConfigurationRecorderOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::delete_configuration_recorder::builders::DeleteConfigurationRecorderOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
### `src/protocol_serde/shape_delete_conformance_pack.rs`

```diff
--- reference/src/protocol_serde/shape_delete_conformance_pack.rs
+++ generated/src/protocol_serde/shape_delete_conformance_pack.rs
@@ -83,3 +83,36 @@
     object.finish();
     Ok(::aws_smithy_types::body::SdkBody::from(out))
 }
...
+    _value: &[u8],
+    mut builder: super::operation::delete_conformance_pack::builders::DeleteConformancePackOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::delete_conformance_pack::builders::DeleteConformancePackOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
### `src/protocol_serde/shape_delete_connector.rs`

```diff
--- reference/src/protocol_serde/shape_delete_connector.rs
+++ generated/src/protocol_serde/shape_delete_connector.rs
@@ -74,3 +74,36 @@
     object.finish();
     Ok(::aws_smithy_types::body::SdkBody::from(out))
 }
...
+    _value: &[u8],
+    mut builder: super::operation::delete_connector::builders::DeleteConnectorOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::delete_connector::builders::DeleteConnectorOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
### `src/protocol_serde/shape_delete_delivery_channel.rs`

```diff
--- reference/src/protocol_serde/shape_delete_delivery_channel.rs
+++ generated/src/protocol_serde/shape_delete_delivery_channel.rs
@@ -84,3 +84,36 @@
     object.finish();
     Ok(::aws_smithy_types::body::SdkBody::from(out))
 }
+
+pub(crate) fn de_delete_delivery_channel(
+    _value: &[u8],
+    mut builder: super::operation::delete_delivery_channel::builders::DeleteDeliveryChannelOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::delete_delivery_channel::builders::DeleteDeliveryChannelOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
### `src/protocol_serde/shape_delete_evaluation_results.rs`

```diff
--- reference/src/protocol_serde/shape_delete_evaluation_results.rs
+++ generated/src/protocol_serde/shape_delete_evaluation_results.rs
@@ -85,3 +85,36 @@
     object.finish();
     Ok(::aws_smithy_types::body::SdkBody::from(out))
 }
+
+pub(crate) fn de_delete_evaluation_results(
+    _value: &[u8],
+    mut builder: super::operation::delete_evaluation_results::builders::DeleteEvaluationResultsOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::delete_evaluation_results::builders::DeleteEvaluationResultsOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
### `src/protocol_serde/shape_delete_organization_config_rule.rs`

```diff
--- reference/src/protocol_serde/shape_delete_organization_config_rule.rs
+++ generated/src/protocol_serde/shape_delete_organization_config_rule.rs
@@ -101,3 +101,36 @@
     object.finish();
     Ok(::aws_smithy_types::body::SdkBody::from(out))
 }
...
### `src/protocol_serde/shape_delete_organization_conformance_pack.rs`

```diff
--- reference/src/protocol_serde/shape_delete_organization_conformance_pack.rs
+++ generated/src/protocol_serde/shape_delete_organization_conformance_pack.rs
@@ -108,3 +108,36 @@
     object.finish();
     Ok(::aws_smithy_types::body::SdkBody::from(out))
 }
+
+pub(crate) fn de_delete_organization_conformance_pack(
+    _value: &[u8],
+    mut builder: super::operation::delete_organization_conformance_pack::builders::DeleteOrganizationConformancePackOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::delete_organization_conformance_pack::builders::DeleteOrganizationConformancePackOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
### `src/protocol_serde/shape_delete_pending_aggregation_request.rs`

```diff
--- reference/src/protocol_serde/shape_delete_pending_aggregation_request.rs
+++ generated/src/protocol_serde/shape_delete_pending_aggregation_request.rs
@@ -70,3 +70,36 @@
     object.finish();
     Ok(::aws_smithy_types::body::SdkBody::from(out))
 }
+
+pub(crate) fn de_delete_pending_aggregation_request(
+    _value: &[u8],
+    mut builder: super::operation::delete_pending_aggregation_request::builders::DeletePendingAggregationRequestOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::delete_pending_aggregation_request::builders::DeletePendingAggregationRequestOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
### `src/protocol_serde/shape_delete_remediation_configuration.rs`

```diff
--- reference/src/protocol_serde/shape_delete_remediation_configuration.rs
+++ generated/src/protocol_serde/shape_delete_remediation_configuration.rs
@@ -126,3 +126,36 @@
     object.finish();
     Ok(::aws_smithy_types::body::SdkBody::from(out))
 }
+
+pub(crate) fn de_delete_remediation_configuration(
+    _value: &[u8],
+    mut builder: super::operation::delete_remediation_configuration::builders::DeleteRemediationConfigurationOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::delete_remediation_configuration::builders::DeleteRemediationConfigurationOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
### `src/protocol_serde/shape_delete_remediation_exceptions.rs`

```diff
--- reference/src/protocol_serde/shape_delete_remediation_exceptions.rs
+++ generated/src/protocol_serde/shape_delete_remediation_exceptions.rs
@@ -92,9 +92,7 @@
             Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                 match key.to_unescaped()?.as_ref() {
                     "FailedBatches" => {
-                        builder = builder.set_failed_batches(
-                            super::protocol_serde::shape_failed_delete_remediation_exceptions_batches::de_failed_delete_remediation_exceptions_batches(tokens, _value, depth + 1)?
-                        );
+                        builder = builder.set_failed_batches(super::protocol_serde::shape_failed_delete_remediation_exceptions_batches::de_failed_delete_remediation_exceptions_batches(tokens, _value, depth + 1)?);
                     }
                     _ => ::aws_smithy_json::deserialize::token::skip_value(tokens)?,
                 }
```

### `src/protocol_serde/shape_delete_resource_config.rs`

```diff
--- reference/src/protocol_serde/shape_delete_resource_config.rs
+++ generated/src/protocol_serde/shape_delete_resource_config.rs
@@ -81,3 +81,36 @@
     object.finish();
     Ok(::aws_smithy_types::body::SdkBody::from(out))
 }
+
+pub(crate) fn de_delete_resource_config(
+    _value: &[u8],
+    mut builder: super::operation::delete_resource_config::builders::DeleteResourceConfigOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::delete_resource_config::builders::DeleteResourceConfigOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
### `src/protocol_serde/shape_delete_retention_configuration.rs`

```diff
--- reference/src/protocol_serde/shape_delete_retention_configuration.rs
+++ generated/src/protocol_serde/shape_delete_retention_configuration.rs
@@ -86,3 +86,36 @@
     object.finish();
     Ok(::aws_smithy_types::body::SdkBody::from(out))
 }
+
+pub(crate) fn de_delete_retention_configuration(
+    _value: &[u8],
+    mut builder: super::operation::delete_retention_configuration::builders::DeleteRetentionConfigurationOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::delete_retention_configuration::builders::DeleteRetentionConfigurationOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
@@ -26,53 +26,47 @@
     Err(match error_code {
         "ConflictException" => super::operation::delete_service_linked_configuration_recorder::DeleteServiceLinkedConfigurationRecorderError::ConflictException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::ConflictExceptionBuilder::default();
-                    output = super::protocol_serde::shape_conflict_exception::de_conflict_exception_json_err(_response_body, output).map_err(super::operation::delete_service_linked_configuration_recorder::DeleteServiceLinkedConfigurationRecorderError::unhandled)?;
...
+            }
         ...
         "NoSuchConfigurationRecorderException" => super::operation::delete_service_linked_configuration_recorder::DeleteServiceLinkedConfigurationRecorderError::NoSuchConfigurationRecorderException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::NoSuchConfigurationRecorderExceptionBuilder::default();
-                    output = super::protocol_serde::shape_no_such_configuration_recorder_exception::de_no_such_configuration_recorder_exception_json_err(_response_body, output).map_err(super::operation::delete_service_linked_configuration_recorder::DeleteServiceLinkedConfigurationRecorderError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "ValidationException" => super::operation::delete_service_linked_configuration_recorder::DeleteServiceLinkedConfigurationRecorderError::ValidationException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::ValidationExceptionBuilder::default();
-                    output = super::protocol_serde::shape_validation_exception::de_validation_exception_json_err(_response_body, output).map_err(super::operation::delete_service_linked_configuration_recorder::DeleteServiceLinkedConfigurationRecorderError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
-        _ => super::operation::delete_service_linked_configuration_recorder::DeleteServiceLinkedConfigurationRecorderError::generic(generic)
+        _ => super::operation::delete_service_linked_configuration_recorder::DeleteServiceLinkedConfigurationRecorderError::generic(generic),
     })
 }
...
### `src/protocol_serde/shape_delete_stored_query.rs`

```diff
--- reference/src/protocol_serde/shape_delete_stored_query.rs
+++ generated/src/protocol_serde/shape_delete_stored_query.rs
@@ -76,3 +76,36 @@
     object.finish();
     Ok(::aws_smithy_types::body::SdkBody::from(out))
 }
...
+    _value: &[u8],
+    mut builder: super::operation::delete_stored_query::builders::DeleteStoredQueryOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::delete_stored_query::builders::DeleteStoredQueryOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
@@ -26,69 +26,61 @@
     Err(match error_code {
         "InvalidLimitException" => super::operation::describe_aggregate_compliance_by_config_rules::DescribeAggregateComplianceByConfigRulesError::InvalidLimitException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::InvalidLimitExceptionBuilder::default();
-                    output = super::protocol_serde::shape_invalid_limit_exception::de_invalid_limit_exception_json_err(_response_body, output).map_err(super::operation::describe_aggregate_compliance_by_config_rules::DescribeAggregateComplianceByConfigRulesError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "InvalidNextTokenException" => super::operation::describe_aggregate_compliance_by_config_rules::DescribeAggregateComplianceByConfigRulesError::InvalidNextTokenException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::InvalidNextTokenExceptionBuilder::default();
-                    output = super::protocol_serde::shape_invalid_next_token_exception::de_invalid_next_token_exception_json_err(_response_body, output).map_err(super::operation::describe_aggregate_compliance_by_config_rules::DescribeAggregateComplianceByConfigRulesError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "NoSuchConfigurationAggregatorException" => super::operation::describe_aggregate_compliance_by_config_rules::DescribeAggregateComplianceByConfigRulesError::NoSuchConfigurationAggregatorException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::NoSuchConfigurationAggregatorExceptionBuilder::default();
-                    output = super::protocol_serde::shape_no_such_configuration_aggregator_exception::de_no_such_configuration_aggregator_exception_json_err(_response_body, output).map_err(super::operation::describe_aggregate_compliance_by_config_rules::DescribeAggregateComplianceByConfigRulesError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "ValidationException" => super::operation::describe_aggregate_compliance_by_config_rules::DescribeAggregateComplianceByConfigRulesError::ValidationException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::ValidationExceptionBuilder::default();
-                    output = super::protocol_serde::shape_validation_exception::de_validation_exception_json_err(_response_body, output).map_err(super::operation::describe_aggregate_compliance_by_config_rules::DescribeAggregateComplianceByConfigRulesError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
-        _ => super::operation::describe_aggregate_compliance_by_config_rules::DescribeAggregateComplianceByConfigRulesError::generic(generic)
+        _ => super::operation::describe_aggregate_compliance_by_config_rules::DescribeAggregateComplianceByConfigRulesError::generic(generic),
     })
 }
...
@@ -28,69 +28,61 @@
     Err(match error_code {
         "InvalidLimitException" => super::operation::describe_aggregate_compliance_by_conformance_packs::DescribeAggregateComplianceByConformancePacksError::InvalidLimitException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::InvalidLimitExceptionBuilder::default();
-                    output = super::protocol_serde::shape_invalid_limit_exception::de_invalid_limit_exception_json_err(_response_body, output).map_err(super::operation::describe_aggregate_compliance_by_conformance_packs::DescribeAggregateComplianceByConformancePacksError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "InvalidNextTokenException" => super::operation::describe_aggregate_compliance_by_conformance_packs::DescribeAggregateComplianceByConformancePacksError::InvalidNextTokenException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::InvalidNextTokenExceptionBuilder::default();
-                    output = super::protocol_serde::shape_invalid_next_token_exception::de_invalid_next_token_exception_json_err(_response_body, output).map_err(super::operation::describe_aggregate_compliance_by_conformance_packs::DescribeAggregateComplianceByConformancePacksError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "NoSuchConfigurationAggregatorException" => super::operation::describe_aggregate_compliance_by_conformance_packs::DescribeAggregateComplianceByConformancePacksError::NoSuchConfigurationAggregatorException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::NoSuchConfigurationAggregatorExceptionBuilder::default();
-                    output = super::protocol_serde::shape_no_such_configuration_aggregator_exception::de_no_such_configuration_aggregator_exception_json_err(_response_body, output).map_err(super::operation::describe_aggregate_compliance_by_conformance_packs::DescribeAggregateComplianceByConformancePacksError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "ValidationException" => super::operation::describe_aggregate_compliance_by_conformance_packs::DescribeAggregateComplianceByConformancePacksError::ValidationException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::ValidationExceptionBuilder::default();
-                    output = super::protocol_serde::shape_validation_exception::de_validation_exception_json_err(_response_body, output).map_err(super::operation::describe_aggregate_compliance_by_conformance_packs::DescribeAggregateComplianceByConformancePacksError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
-        _ => super::operation::describe_aggregate_compliance_by_conformance_packs::DescribeAggregateComplianceByConformancePacksError::generic(generic)
+        _ => super::operation::describe_aggregate_compliance_by_conformance_packs::DescribeAggregateComplianceByConformancePacksError::generic(generic),
     })
 }
...
-                            super::protocol_serde::shape_aggregate_compliance_by_conformance_pack_list::de_aggregate_compliance_by_conformance_pack_list(tokens, _value, depth + 1)?
-                        );
+                        builder = builder.set_aggregate_compliance_by_conformance_packs(super::protocol_serde::shape_aggregate_compliance_by_conformance_pack_list::de_aggregate_compliance_by_conformance_pack_list(tokens, _value, depth + 1)?);
                     }
                     "NextToken" => {
...
@@ -28,69 +28,61 @@
     Err(match error_code {
         "InvalidLimitException" => super::operation::describe_configuration_aggregator_sources_status::DescribeConfigurationAggregatorSourcesStatusError::InvalidLimitException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::InvalidLimitExceptionBuilder::default();
-                    output = super::protocol_serde::shape_invalid_limit_exception::de_invalid_limit_exception_json_err(_response_body, output).map_err(super::operation::describe_configuration_aggregator_sources_status::DescribeConfigurationAggregatorSourcesStatusError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "InvalidNextTokenException" => super::operation::describe_configuration_aggregator_sources_status::DescribeConfigurationAggregatorSourcesStatusError::InvalidNextTokenException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::InvalidNextTokenExceptionBuilder::default();
-                    output = super::protocol_serde::shape_invalid_next_token_exception::de_invalid_next_token_exception_json_err(_response_body, output).map_err(super::operation::describe_configuration_aggregator_sources_status::DescribeConfigurationAggregatorSourcesStatusError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "InvalidParameterValueException" => super::operation::describe_configuration_aggregator_sources_status::DescribeConfigurationAggregatorSourcesStatusError::InvalidParameterValueException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::InvalidParameterValueExceptionBuilder::default();
-                    output = super::protocol_serde::shape_invalid_parameter_value_exception::de_invalid_parameter_value_exception_json_err(_response_body, output).map_err(super::operation::describe_configuration_aggregator_sources_status::DescribeConfigurationAggregatorSourcesStatusError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "NoSuchConfigurationAggregatorException" => super::operation::describe_configuration_aggregator_sources_status::DescribeConfigurationAggregatorSourcesStatusError::NoSuchConfigurationAggregatorException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::NoSuchConfigurationAggregatorExceptionBuilder::default();
-                    output = super::protocol_serde::shape_no_such_configuration_aggregator_exception::de_no_such_configuration_aggregator_exception_json_err(_response_body, output).map_err(super::operation::describe_configuration_aggregator_sources_status::DescribeConfigurationAggregatorSourcesStatusError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
-        _ => super::operation::describe_configuration_aggregator_sources_status::DescribeConfigurationAggregatorSourcesStatusError::generic(generic)
+        _ => super::operation::describe_configuration_aggregator_sources_status::DescribeConfigurationAggregatorSourcesStatusError::generic(generic),
     })
 }
...
@@ -24,69 +24,61 @@
     Err(match error_code {
         "InvalidLimitException" => super::operation::describe_organization_config_rule_statuses::DescribeOrganizationConfigRuleStatusesError::InvalidLimitException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::InvalidLimitExceptionBuilder::default();
-                    output = super::protocol_serde::shape_invalid_limit_exception::de_invalid_limit_exception_json_err(_response_body, output).map_err(super::operation::describe_organization_config_rule_statuses::DescribeOrganizationConfigRuleStatusesError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "InvalidNextTokenException" => super::operation::describe_organization_config_rule_statuses::DescribeOrganizationConfigRuleStatusesError::InvalidNextTokenException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::InvalidNextTokenExceptionBuilder::default();
-                    output = super::protocol_serde::shape_invalid_next_token_exception::de_invalid_next_token_exception_json_err(_response_body, output).map_err(super::operation::describe_organization_config_rule_statuses::DescribeOrganizationConfigRuleStatusesError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "NoSuchOrganizationConfigRuleException" => super::operation::describe_organization_config_rule_statuses::DescribeOrganizationConfigRuleStatusesError::NoSuchOrganizationConfigRuleException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::NoSuchOrganizationConfigRuleExceptionBuilder::default();
-                    output = super::protocol_serde::shape_no_such_organization_config_rule_exception::de_no_such_organization_config_rule_exception_json_err(_response_body, output).map_err(super::operation::describe_organization_config_rule_statuses::DescribeOrganizationConfigRuleStatusesError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "OrganizationAccessDeniedException" => super::operation::describe_organization_config_rule_statuses::DescribeOrganizationConfigRuleStatusesError::OrganizationAccessDeniedException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::OrganizationAccessDeniedExceptionBuilder::default();
-                    output = super::protocol_serde::shape_organization_access_denied_exception::de_organization_access_denied_exception_json_err(_response_body, output).map_err(super::operation::describe_organization_config_rule_statuses::DescribeOrganizationConfigRuleStatusesError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
-        _ => super::operation::describe_organization_config_rule_statuses::DescribeOrganizationConfigRuleStatusesError::generic(generic)
+        _ => super::operation::describe_organization_config_rule_statuses::DescribeOrganizationConfigRuleStatusesError::generic(generic),
     })
 }
...
@@ -28,69 +28,61 @@
     Err(match error_code {
         "InvalidLimitException" => super::operation::describe_organization_conformance_pack_statuses::DescribeOrganizationConformancePackStatusesError::InvalidLimitException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::InvalidLimitExceptionBuilder::default();
-                    output = super::protocol_serde::shape_invalid_limit_exception::de_invalid_limit_exception_json_err(_response_body, output).map_err(super::operation::describe_organization_conformance_pack_statuses::DescribeOrganizationConformancePackStatusesError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "InvalidNextTokenException" => super::operation::describe_organization_conformance_pack_statuses::DescribeOrganizationConformancePackStatusesError::InvalidNextTokenException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::InvalidNextTokenExceptionBuilder::default();
-                    output = super::protocol_serde::shape_invalid_next_token_exception::de_invalid_next_token_exception_json_err(_response_body, output).map_err(super::operation::describe_organization_conformance_pack_statuses::DescribeOrganizationConformancePackStatusesError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "NoSuchOrganizationConformancePackException" => super::operation::describe_organization_conformance_pack_statuses::DescribeOrganizationConformancePackStatusesError::NoSuchOrganizationConformancePackException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::NoSuchOrganizationConformancePackExceptionBuilder::default();
-                    output = super::protocol_serde::shape_no_such_organization_conformance_pack_exception::de_no_such_organization_conformance_pack_exception_json_err(_response_body, output).map_err(super::operation::describe_organization_conformance_pack_statuses::DescribeOrganizationConformancePackStatusesError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "OrganizationAccessDeniedException" => super::operation::describe_organization_conformance_pack_statuses::DescribeOrganizationConformancePackStatusesError::OrganizationAccessDeniedException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::OrganizationAccessDeniedExceptionBuilder::default();
-                    output = super::protocol_serde::shape_organization_access_denied_exception::de_organization_access_denied_exception_json_err(_response_body, output).map_err(super::operation::describe_organization_conformance_pack_statuses::DescribeOrganizationConformancePackStatusesError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
-        _ => super::operation::describe_organization_conformance_pack_statuses::DescribeOrganizationConformancePackStatusesError::generic(generic)
+        _ => super::operation::describe_organization_conformance_pack_statuses::DescribeOrganizationConformancePackStatusesError::generic(generic),
     })
 }
...
@@ -22,69 +22,61 @@
     Err(match error_code {
         "InvalidLimitException" => super::operation::describe_organization_conformance_packs::DescribeOrganizationConformancePacksError::InvalidLimitException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::InvalidLimitExceptionBuilder::default();
-                    output = super::protocol_serde::shape_invalid_limit_exception::de_invalid_limit_exception_json_err(_response_body, output).map_err(super::operation::describe_organization_conformance_packs::DescribeOrganizationConformancePacksError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "InvalidNextTokenException" => super::operation::describe_organization_conformance_packs::DescribeOrganizationConformancePacksError::InvalidNextTokenException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::InvalidNextTokenExceptionBuilder::default();
-                    output = super::protocol_serde::shape_invalid_next_token_exception::de_invalid_next_token_exception_json_err(_response_body, output).map_err(super::operation::describe_organization_conformance_packs::DescribeOrganizationConformancePacksError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "NoSuchOrganizationConformancePackException" => super::operation::describe_organization_conformance_packs::DescribeOrganizationConformancePacksError::NoSuchOrganizationConformancePackException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::NoSuchOrganizationConformancePackExceptionBuilder::default();
-                    output = super::protocol_serde::shape_no_such_organization_conformance_pack_exception::de_no_such_organization_conformance_pack_exception_json_err(_response_body, output).map_err(super::operation::describe_organization_conformance_packs::DescribeOrganizationConformancePacksError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "OrganizationAccessDeniedException" => super::operation::describe_organization_conformance_packs::DescribeOrganizationConformancePacksError::OrganizationAccessDeniedException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::OrganizationAccessDeniedExceptionBuilder::default();
-                    output = super::protocol_serde::shape_organization_access_denied_exception::de_organization_access_denied_exception_json_err(_response_body, output).map_err(super::operation::describe_organization_conformance_packs::DescribeOrganizationConformancePacksError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
-        _ => super::operation::describe_organization_conformance_packs::DescribeOrganizationConformancePacksError::generic(generic)
+        _ => super::operation::describe_organization_conformance_packs::DescribeOrganizationConformancePacksError::generic(generic),
     })
 }
...
### `src/protocol_serde/shape_evaluation_context.rs`

```diff
--- reference/src/protocol_serde/shape_evaluation_context.rs
+++ generated/src/protocol_serde/shape_evaluation_context.rs
@@ -1,4 +1,14 @@
 // Code generated by software.amazon.smithy.rust.codegen.smithy-rs. DO NOT EDIT.
+pub fn ser_evaluation_context(
+    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
+    input: &super::types::EvaluationContext,
+) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::SerializationError> {
...
### `src/protocol_serde/shape_exclusion_by_resource_types.rs`

```diff
--- reference/src/protocol_serde/shape_exclusion_by_resource_types.rs
+++ generated/src/protocol_serde/shape_exclusion_by_resource_types.rs
@@ -1,4 +1,20 @@
 // Code generated by software.amazon.smithy.rust.codegen.smithy-rs. DO NOT EDIT.
+pub fn ser_exclusion_by_resource_types(
+    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
+    input: &super::types::ExclusionByResourceTypes,
+) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::SerializationError> {
...
@@ -26,69 +26,61 @@
     Err(match error_code {
         "InvalidLimitException" => super::operation::get_aggregate_compliance_details_by_config_rule::GetAggregateComplianceDetailsByConfigRuleError::InvalidLimitException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::InvalidLimitExceptionBuilder::default();
-                    output = super::protocol_serde::shape_invalid_limit_exception::de_invalid_limit_exception_json_err(_response_body, output).map_err(super::operation::get_aggregate_compliance_details_by_config_rule::GetAggregateComplianceDetailsByConfigRuleError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "InvalidNextTokenException" => super::operation::get_aggregate_compliance_details_by_config_rule::GetAggregateComplianceDetailsByConfigRuleError::InvalidNextTokenException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::InvalidNextTokenExceptionBuilder::default();
-                    output = super::protocol_serde::shape_invalid_next_token_exception::de_invalid_next_token_exception_json_err(_response_body, output).map_err(super::operation::get_aggregate_compliance_details_by_config_rule::GetAggregateComplianceDetailsByConfigRuleError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "NoSuchConfigurationAggregatorException" => super::operation::get_aggregate_compliance_details_by_config_rule::GetAggregateComplianceDetailsByConfigRuleError::NoSuchConfigurationAggregatorException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::NoSuchConfigurationAggregatorExceptionBuilder::default();
-                    output = super::protocol_serde::shape_no_such_configuration_aggregator_exception::de_no_such_configuration_aggregator_exception_json_err(_response_body, output).map_err(super::operation::get_aggregate_compliance_details_by_config_rule::GetAggregateComplianceDetailsByConfigRuleError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "ValidationException" => super::operation::get_aggregate_compliance_details_by_config_rule::GetAggregateComplianceDetailsByConfigRuleError::ValidationException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::ValidationExceptionBuilder::default();
-                    output = super::protocol_serde::shape_validation_exception::de_validation_exception_json_err(_response_body, output).map_err(super::operation::get_aggregate_compliance_details_by_config_rule::GetAggregateComplianceDetailsByConfigRuleError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
-        _ => super::operation::get_aggregate_compliance_details_by_config_rule::GetAggregateComplianceDetailsByConfigRuleError::generic(generic)
+        _ => super::operation::get_aggregate_compliance_details_by_config_rule::GetAggregateComplianceDetailsByConfigRuleError::generic(generic),
     })
 }
...
@@ -26,69 +26,61 @@
     Err(match error_code {
         "InvalidLimitException" => super::operation::get_aggregate_config_rule_compliance_summary::GetAggregateConfigRuleComplianceSummaryError::InvalidLimitException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::InvalidLimitExceptionBuilder::default();
-                    output = super::protocol_serde::shape_invalid_limit_exception::de_invalid_limit_exception_json_err(_response_body, output).map_err(super::operation::get_aggregate_config_rule_compliance_summary::GetAggregateConfigRuleComplianceSummaryError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "InvalidNextTokenException" => super::operation::get_aggregate_config_rule_compliance_summary::GetAggregateConfigRuleComplianceSummaryError::InvalidNextTokenException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::InvalidNextTokenExceptionBuilder::default();
-                    output = super::protocol_serde::shape_invalid_next_token_exception::de_invalid_next_token_exception_json_err(_response_body, output).map_err(super::operation::get_aggregate_config_rule_compliance_summary::GetAggregateConfigRuleComplianceSummaryError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "NoSuchConfigurationAggregatorException" => super::operation::get_aggregate_config_rule_compliance_summary::GetAggregateConfigRuleComplianceSummaryError::NoSuchConfigurationAggregatorException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::NoSuchConfigurationAggregatorExceptionBuilder::default();
-                    output = super::protocol_serde::shape_no_such_configuration_aggregator_exception::de_no_such_configuration_aggregator_exception_json_err(_response_body, output).map_err(super::operation::get_aggregate_config_rule_compliance_summary::GetAggregateConfigRuleComplianceSummaryError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "ValidationException" => super::operation::get_aggregate_config_rule_compliance_summary::GetAggregateConfigRuleComplianceSummaryError::ValidationException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::ValidationExceptionBuilder::default();
-                    output = super::protocol_serde::shape_validation_exception::de_validation_exception_json_err(_response_body, output).map_err(super::operation::get_aggregate_config_rule_compliance_summary::GetAggregateConfigRuleComplianceSummaryError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
-        _ => super::operation::get_aggregate_config_rule_compliance_summary::GetAggregateConfigRuleComplianceSummaryError::generic(generic)
+        _ => super::operation::get_aggregate_config_rule_compliance_summary::GetAggregateConfigRuleComplianceSummaryError::generic(generic),
     })
 }
...
@@ -28,69 +28,61 @@
     Err(match error_code {
         "InvalidLimitException" => super::operation::get_aggregate_conformance_pack_compliance_summary::GetAggregateConformancePackComplianceSummaryError::InvalidLimitException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::InvalidLimitExceptionBuilder::default();
-                    output = super::protocol_serde::shape_invalid_limit_exception::de_invalid_limit_exception_json_err(_response_body, output).map_err(super::operation::get_aggregate_conformance_pack_compliance_summary::GetAggregateConformancePackComplianceSummaryError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "InvalidNextTokenException" => super::operation::get_aggregate_conformance_pack_compliance_summary::GetAggregateConformancePackComplianceSummaryError::InvalidNextTokenException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::InvalidNextTokenExceptionBuilder::default();
-                    output = super::protocol_serde::shape_invalid_next_token_exception::de_invalid_next_token_exception_json_err(_response_body, output).map_err(super::operation::get_aggregate_conformance_pack_compliance_summary::GetAggregateConformancePackComplianceSummaryError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "NoSuchConfigurationAggregatorException" => super::operation::get_aggregate_conformance_pack_compliance_summary::GetAggregateConformancePackComplianceSummaryError::NoSuchConfigurationAggregatorException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::NoSuchConfigurationAggregatorExceptionBuilder::default();
-                    output = super::protocol_serde::shape_no_such_configuration_aggregator_exception::de_no_such_configuration_aggregator_exception_json_err(_response_body, output).map_err(super::operation::get_aggregate_conformance_pack_compliance_summary::GetAggregateConformancePackComplianceSummaryError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "ValidationException" => super::operation::get_aggregate_conformance_pack_compliance_summary::GetAggregateConformancePackComplianceSummaryError::ValidationException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::ValidationExceptionBuilder::default();
-                    output = super::protocol_serde::shape_validation_exception::de_validation_exception_json_err(_response_body, output).map_err(super::operation::get_aggregate_conformance_pack_compliance_summary::GetAggregateConformancePackComplianceSummaryError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
-        _ => super::operation::get_aggregate_conformance_pack_compliance_summary::GetAggregateConformancePackComplianceSummaryError::generic(generic)
+        _ => super::operation::get_aggregate_conformance_pack_compliance_summary::GetAggregateConformancePackComplianceSummaryError::generic(generic),
     })
 }
...
-                            super::protocol_serde::shape_aggregate_conformance_pack_compliance_summary_list::de_aggregate_conformance_pack_compliance_summary_list(tokens, _value, depth + 1)?
-                        );
+                    builder = builder.set_aggregate_conformance_pack_compliance_summaries(super::protocol_serde::shape_aggregate_conformance_pack_compliance_summary_list::de_aggregate_conformance_pack_compliance_summary_list(tokens, _value, depth + 1)?);
                 }
                 "GroupByKey" => {
...
-        super::serde_util::get_aggregate_discovered_resource_counts_output_output_correct_errors(output).build()
...
@@ -22,85 +22,75 @@
     Err(match error_code {
         "InvalidLimitException" => super::operation::get_conformance_pack_compliance_details::GetConformancePackComplianceDetailsError::InvalidLimitException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::InvalidLimitExceptionBuilder::default();
-                    output = super::protocol_serde::shape_invalid_limit_exception::de_invalid_limit_exception_json_err(_response_body, output).map_err(super::operation::get_conformance_pack_compliance_details::GetConformancePackComplianceDetailsError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "InvalidNextTokenException" => super::operation::get_conformance_pack_compliance_details::GetConformancePackComplianceDetailsError::InvalidNextTokenException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::InvalidNextTokenExceptionBuilder::default();
-                    output = super::protocol_serde::shape_invalid_next_token_exception::de_invalid_next_token_exception_json_err(_response_body, output).map_err(super::operation::get_conformance_pack_compliance_details::GetConformancePackComplianceDetailsError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "InvalidParameterValueException" => super::operation::get_conformance_pack_compliance_details::GetConformancePackComplianceDetailsError::InvalidParameterValueException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::InvalidParameterValueExceptionBuilder::default();
-                    output = super::protocol_serde::shape_invalid_parameter_value_exception::de_invalid_parameter_value_exception_json_err(_response_body, output).map_err(super::operation::get_conformance_pack_compliance_details::GetConformancePackComplianceDetailsError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "NoSuchConfigRuleInConformancePackException" => super::operation::get_conformance_pack_compliance_details::GetConformancePackComplianceDetailsError::NoSuchConfigRuleInConformancePackException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::NoSuchConfigRuleInConformancePackExceptionBuilder::default();
-                    output = super::protocol_serde::shape_no_such_config_rule_in_conformance_pack_exception::de_no_such_config_rule_in_conformance_pack_exception_json_err(_response_body, output).map_err(super::operation::get_conformance_pack_compliance_details::GetConformancePackComplianceDetailsError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "NoSuchConformancePackException" => super::operation::get_conformance_pack_compliance_details::GetConformancePackComplianceDetailsError::NoSuchConformancePackException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::NoSuchConformancePackExceptionBuilder::default();
-                    output = super::protocol_serde::shape_no_such_conformance_pack_exception::de_no_such_conformance_pack_exception_json_err(_response_body, output).map_err(super::operation::get_conformance_pack_compliance_details::GetConformancePackComplianceDetailsError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
-        _ => super::operation::get_conformance_pack_compliance_details::GetConformancePackComplianceDetailsError::generic(generic)
+        _ => super::operation::get_conformance_pack_compliance_details::GetConformancePackComplianceDetailsError::generic(generic),
     })
 }
...
-                            super::protocol_serde::shape_conformance_pack_rule_evaluation_results_list::de_conformance_pack_rule_evaluation_results_list(tokens, _value, depth + 1)?
-                        );
+                        builder = builder.set_conformance_pack_rule_evaluation_results(super::protocol_serde::shape_conformance_pack_rule_evaluation_results_list::de_conformance_pack_rule_evaluation_results_list(tokens, _value, depth + 1)?);
                     }
                     "NextToken" => {
                         builder = builder.set_next_token(
```
...
@@ -26,69 +26,61 @@
     Err(match error_code {
         "InvalidLimitException" => super::operation::get_organization_config_rule_detailed_status::GetOrganizationConfigRuleDetailedStatusError::InvalidLimitException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::InvalidLimitExceptionBuilder::default();
-                    output = super::protocol_serde::shape_invalid_limit_exception::de_invalid_limit_exception_json_err(_response_body, output).map_err(super::operation::get_organization_config_rule_detailed_status::GetOrganizationConfigRuleDetailedStatusError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "InvalidNextTokenException" => super::operation::get_organization_config_rule_detailed_status::GetOrganizationConfigRuleDetailedStatusError::InvalidNextTokenException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::InvalidNextTokenExceptionBuilder::default();
-                    output = super::protocol_serde::shape_invalid_next_token_exception::de_invalid_next_token_exception_json_err(_response_body, output).map_err(super::operation::get_organization_config_rule_detailed_status::GetOrganizationConfigRuleDetailedStatusError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "NoSuchOrganizationConfigRuleException" => super::operation::get_organization_config_rule_detailed_status::GetOrganizationConfigRuleDetailedStatusError::NoSuchOrganizationConfigRuleException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::NoSuchOrganizationConfigRuleExceptionBuilder::default();
-                    output = super::protocol_serde::shape_no_such_organization_config_rule_exception::de_no_such_organization_config_rule_exception_json_err(_response_body, output).map_err(super::operation::get_organization_config_rule_detailed_status::GetOrganizationConfigRuleDetailedStatusError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "OrganizationAccessDeniedException" => super::operation::get_organization_config_rule_detailed_status::GetOrganizationConfigRuleDetailedStatusError::OrganizationAccessDeniedException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::OrganizationAccessDeniedExceptionBuilder::default();
-                    output = super::protocol_serde::shape_organization_access_denied_exception::de_organization_access_denied_exception_json_err(_response_body, output).map_err(super::operation::get_organization_config_rule_detailed_status::GetOrganizationConfigRuleDetailedStatusError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
-        _ => super::operation::get_organization_config_rule_detailed_status::GetOrganizationConfigRuleDetailedStatusError::generic(generic)
+        _ => super::operation::get_organization_config_rule_detailed_status::GetOrganizationConfigRuleDetailedStatusError::generic(generic),
     })
 }
...
@@ -28,69 +28,61 @@
     Err(match error_code {
         "InvalidLimitException" => super::operation::get_organization_conformance_pack_detailed_status::GetOrganizationConformancePackDetailedStatusError::InvalidLimitException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::InvalidLimitExceptionBuilder::default();
-                    output = super::protocol_serde::shape_invalid_limit_exception::de_invalid_limit_exception_json_err(_response_body, output).map_err(super::operation::get_organization_conformance_pack_detailed_status::GetOrganizationConformancePackDetailedStatusError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "InvalidNextTokenException" => super::operation::get_organization_conformance_pack_detailed_status::GetOrganizationConformancePackDetailedStatusError::InvalidNextTokenException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::InvalidNextTokenExceptionBuilder::default();
-                    output = super::protocol_serde::shape_invalid_next_token_exception::de_invalid_next_token_exception_json_err(_response_body, output).map_err(super::operation::get_organization_conformance_pack_detailed_status::GetOrganizationConformancePackDetailedStatusError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "NoSuchOrganizationConformancePackException" => super::operation::get_organization_conformance_pack_detailed_status::GetOrganizationConformancePackDetailedStatusError::NoSuchOrganizationConformancePackException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::NoSuchOrganizationConformancePackExceptionBuilder::default();
-                    output = super::protocol_serde::shape_no_such_organization_conformance_pack_exception::de_no_such_organization_conformance_pack_exception_json_err(_response_body, output).map_err(super::operation::get_organization_conformance_pack_detailed_status::GetOrganizationConformancePackDetailedStatusError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "OrganizationAccessDeniedException" => super::operation::get_organization_conformance_pack_detailed_status::GetOrganizationConformancePackDetailedStatusError::OrganizationAccessDeniedException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::OrganizationAccessDeniedExceptionBuilder::default();
-                    output = super::protocol_serde::shape_organization_access_denied_exception::de_organization_access_denied_exception_json_err(_response_body, output).map_err(super::operation::get_organization_conformance_pack_detailed_status::GetOrganizationConformancePackDetailedStatusError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
-        _ => super::operation::get_organization_conformance_pack_detailed_status::GetOrganizationConformancePackDetailedStatusError::generic(generic)
+        _ => super::operation::get_organization_conformance_pack_detailed_status::GetOrganizationConformancePackDetailedStatusError::generic(generic),
     })
 }
...
-                            super::protocol_serde::shape_organization_conformance_pack_detailed_statuses::de_organization_conformance_pack_detailed_statuses(tokens, _value, depth + 1)?
-                        );
+                    builder = builder.set_organization_conformance_pack_detailed_statuses(super::protocol_serde::shape_organization_conformance_pack_detailed_statuses::de_organization_conformance_pack_detailed_statuses(tokens, _value, depth + 1)?);
                 }
                 "NextToken" => {
                     builder = builder.set_next_token(
```
...
### `src/protocol_serde/shape_organization_config_rule.rs`

```diff
--- reference/src/protocol_serde/shape_organization_config_rule.rs
+++ generated/src/protocol_serde/shape_organization_config_rule.rs
@@ -67,9 +67,7 @@
                             )?);
                         }
                         "OrganizationCustomPolicyRuleMetadata" => {
-                            builder = builder.set_organization_custom_policy_rule_metadata(
-                                    super::protocol_serde::shape_organization_custom_policy_rule_metadata_no_policy::de_organization_custom_policy_rule_metadata_no_policy(tokens, _value, depth + 1)?
-                                );
+                            builder = builder.set_organization_custom_policy_rule_metadata(super::protocol_serde::shape_organization_custom_policy_rule_metadata_no_policy::de_organization_custom_policy_rule_metadata_no_policy(tokens, _value, depth + 1)?);
                         }
                         _ => ::aws_smithy_json::deserialize::token::skip_value(tokens)?,
                     },
```

### `src/protocol_serde/shape_organization_conformance_pack_detailed_statuses.rs`

```diff
--- reference/src/protocol_serde/shape_organization_conformance_pack_detailed_statuses.rs
+++ generated/src/protocol_serde/shape_organization_conformance_pack_detailed_statuses.rs
@@ -26,9 +26,7 @@
                         break;
                     }
                     _ => {
-                        let value =
-                            super::protocol_serde::shape_organization_conformance_pack_detailed_status::de_organization_conformance_pack_detailed_status(tokens, _value, depth + 1)?
-                        ;
+                        let value = super::protocol_serde::shape_organization_conformance_pack_detailed_status::de_organization_conformance_pack_detailed_status(tokens, _value, depth + 1)?;
                         if let Some(value) = value {
                             items.push(value);
                         } else {
```

### `src/protocol_serde/shape_organization_custom_policy_rule_metadata_no_policy.rs`

```diff
--- reference/src/protocol_serde/shape_organization_custom_policy_rule_metadata_no_policy.rs
+++ generated/src/protocol_serde/shape_organization_custom_policy_rule_metadata_no_policy.rs
@@ -29,9 +29,7 @@
                             );
                         }
                         "OrganizationConfigRuleTriggerTypes" => {
-                            builder = builder.set_organization_config_rule_trigger_types(
-                                    super::protocol_serde::shape_organization_config_rule_trigger_type_no_sns::de_organization_config_rule_trigger_type_no_sns(tokens, _value, depth + 1)?
-                                );
+                            builder = builder.set_organization_config_rule_trigger_types(super::protocol_serde::shape_organization_config_rule_trigger_type_no_sns::de_organization_config_rule_trigger_type_no_sns(tokens, _value, depth + 1)?);
                         }
                         "InputParameters" => {
                             builder = builder.set_input_parameters(
```

### `src/protocol_serde/shape_put_config_rule.rs`

```diff
--- reference/src/protocol_serde/shape_put_config_rule.rs
+++ generated/src/protocol_serde/shape_put_config_rule.rs
@@ -127,3 +127,36 @@
     object.finish();
     Ok(::aws_smithy_types::body::SdkBody::from(out))
 }
+
+pub(crate) fn de_put_config_rule(
+    _value: &[u8],
+    mut builder: super::operation::put_config_rule::builders::PutConfigRuleOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::put_config_rule::builders::PutConfigRuleOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
### `src/protocol_serde/shape_put_configuration_recorder.rs`

```diff
--- reference/src/protocol_serde/shape_put_configuration_recorder.rs
+++ generated/src/protocol_serde/shape_put_configuration_recorder.rs
@@ -152,3 +152,36 @@
     object.finish();
     Ok(::aws_smithy_types::body::SdkBody::from(out))
 }
...
+    _value: &[u8],
+    mut builder: super::operation::put_configuration_recorder::builders::PutConfigurationRecorderOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::put_configuration_recorder::builders::PutConfigurationRecorderOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
### `src/protocol_serde/shape_put_delivery_channel.rs`

```diff
--- reference/src/protocol_serde/shape_put_delivery_channel.rs
+++ generated/src/protocol_serde/shape_put_delivery_channel.rs
@@ -188,3 +188,36 @@
     object.finish();
     Ok(::aws_smithy_types::body::SdkBody::from(out))
 }
+
+pub(crate) fn de_put_delivery_channel(
+    _value: &[u8],
+    mut builder: super::operation::put_delivery_channel::builders::PutDeliveryChannelOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::put_delivery_channel::builders::PutDeliveryChannelOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
### `src/protocol_serde/shape_put_external_evaluation.rs`

```diff
--- reference/src/protocol_serde/shape_put_external_evaluation.rs
+++ generated/src/protocol_serde/shape_put_external_evaluation.rs
@@ -84,3 +84,36 @@
     object.finish();
     Ok(::aws_smithy_types::body::SdkBody::from(out))
 }
+
+pub(crate) fn de_put_external_evaluation(
+    _value: &[u8],
+    mut builder: super::operation::put_external_evaluation::builders::PutExternalEvaluationOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::put_external_evaluation::builders::PutExternalEvaluationOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
@@ -22,133 +22,117 @@
     Err(match error_code {
         "InsufficientPermissionsException" => super::operation::put_organization_conformance_pack::PutOrganizationConformancePackError::InsufficientPermissionsException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::InsufficientPermissionsExceptionBuilder::default();
-                    output = super::protocol_serde::shape_insufficient_permissions_exception::de_insufficient_permissions_exception_json_err(_response_body, output).map_err(super::operation::put_organization_conformance_pack::PutOrganizationConformancePackError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "MaxNumberOfOrganizationConformancePacksExceededException" => super::operation::put_organization_conformance_pack::PutOrganizationConformancePackError::MaxNumberOfOrganizationConformancePacksExceededException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::MaxNumberOfOrganizationConformancePacksExceededExceptionBuilder::default();
-                    output = super::protocol_serde::shape_max_number_of_organization_conformance_packs_exceeded_exception::de_max_number_of_organization_conformance_packs_exceeded_exception_json_err(_response_body, output).map_err(super::operation::put_organization_conformance_pack::PutOrganizationConformancePackError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "NoAvailableOrganizationException" => super::operation::put_organization_conformance_pack::PutOrganizationConformancePackError::NoAvailableOrganizationException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::NoAvailableOrganizationExceptionBuilder::default();
-                    output = super::protocol_serde::shape_no_available_organization_exception::de_no_available_organization_exception_json_err(_response_body, output).map_err(super::operation::put_organization_conformance_pack::PutOrganizationConformancePackError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "OrganizationAccessDeniedException" => super::operation::put_organization_conformance_pack::PutOrganizationConformancePackError::OrganizationAccessDeniedException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::OrganizationAccessDeniedExceptionBuilder::default();
-                    output = super::protocol_serde::shape_organization_access_denied_exception::de_organization_access_denied_exception_json_err(_response_body, output).map_err(super::operation::put_organization_conformance_pack::PutOrganizationConformancePackError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "OrganizationAllFeaturesNotEnabledException" => super::operation::put_organization_conformance_pack::PutOrganizationConformancePackError::OrganizationAllFeaturesNotEnabledException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::OrganizationAllFeaturesNotEnabledExceptionBuilder::default();
-                    output = super::protocol_serde::shape_organization_all_features_not_enabled_exception::de_organization_all_features_not_enabled_exception_json_err(_response_body, output).map_err(super::operation::put_organization_conformance_pack::PutOrganizationConformancePackError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "OrganizationConformancePackTemplateValidationException" => super::operation::put_organization_conformance_pack::PutOrganizationConformancePackError::OrganizationConformancePackTemplateValidationException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::OrganizationConformancePackTemplateValidationExceptionBuilder::default();
-                    output = super::protocol_serde::shape_organization_conformance_pack_template_validation_exception::de_organization_conformance_pack_template_validation_exception_json_err(_response_body, output).map_err(super::operation::put_organization_conformance_pack::PutOrganizationConformancePackError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "ResourceInUseException" => super::operation::put_organization_conformance_pack::PutOrganizationConformancePackError::ResourceInUseException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::ResourceInUseExceptionBuilder::default();
-                    output = super::protocol_serde::shape_resource_in_use_exception::de_resource_in_use_exception_json_err(_response_body, output).map_err(super::operation::put_organization_conformance_pack::PutOrganizationConformancePackError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "ValidationException" => super::operation::put_organization_conformance_pack::PutOrganizationConformancePackError::ValidationException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::ValidationExceptionBuilder::default();
-                    output = super::protocol_serde::shape_validation_exception::de_validation_exception_json_err(_response_body, output).map_err(super::operation::put_organization_conformance_pack::PutOrganizationConformancePackError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
-        _ => super::operation::put_organization_conformance_pack::PutOrganizationConformancePackError::generic(generic)
+        _ => super::operation::put_organization_conformance_pack::PutOrganizationConformancePackError::generic(generic),
     })
 }
...
### `src/protocol_serde/shape_put_resource_config.rs`

```diff
--- reference/src/protocol_serde/shape_put_resource_config.rs
+++ generated/src/protocol_serde/shape_put_resource_config.rs
@@ -116,3 +116,36 @@
     object.finish();
     Ok(::aws_smithy_types::body::SdkBody::from(out))
 }
...
+    _value: &[u8],
+    mut builder: super::operation::put_resource_config::builders::PutResourceConfigOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::put_resource_config::builders::PutResourceConfigOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
@@ -27,53 +27,47 @@
     Err(match error_code {
         "ConflictException" => super::operation::put_third_party_service_linked_configuration_recorder::PutThirdPartyServiceLinkedConfigurationRecorderError::ConflictException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::ConflictExceptionBuilder::default();
-                    output = super::protocol_serde::shape_conflict_exception::de_conflict_exception_json_err(_response_body, output).map_err(super::operation::put_third_party_service_linked_configuration_recorder::PutThirdPartyServiceLinkedConfigurationRecorderError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "InsufficientPermissionsException" => super::operation::put_third_party_service_linked_configuration_recorder::PutThirdPartyServiceLinkedConfigurationRecorderError::InsufficientPermissionsException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::InsufficientPermissionsExceptionBuilder::default();
-                    output = super::protocol_serde::shape_insufficient_permissions_exception::de_insufficient_permissions_exception_json_err(_response_body, output).map_err(super::operation::put_third_party_service_linked_configuration_recorder::PutThirdPartyServiceLinkedConfigurationRecorderError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
+            }
         ...
         "ValidationException" => super::operation::put_third_party_service_linked_configuration_recorder::PutThirdPartyServiceLinkedConfigurationRecorderError::ValidationException({
             #[allow(unused_mut)]
-            let mut tmp =
-                 {
-                    #[allow(unused_mut)]
-                    let mut output = super::types::error::builders::ValidationExceptionBuilder::default();
-                    output = super::protocol_serde::shape_validation_exception::de_validation_exception_json_err(_response_body, output).map_err(super::operation::put_third_party_service_linked_configuration_recorder::PutThirdPartyServiceLinkedConfigurationRecorderError::unhandled)?;
-                    let output = output.meta(generic);
-                    output.build()
-                }
-            ;
...
-        _ => super::operation::put_third_party_service_linked_configuration_recorder::PutThirdPartyServiceLinkedConfigurationRecorderError::generic(generic)
+        _ => super::operation::put_third_party_service_linked_configuration_recorder::PutThirdPartyServiceLinkedConfigurationRecorderError::generic(generic),
     })
 }
...
@@ -89,9 +83,12 @@
     Ok({
         #[allow(unused_mut)]
         let mut output = super::operation::put_third_party_service_linked_configuration_recorder::builders::PutThirdPartyServiceLinkedConfigurationRecorderOutputBuilder::default();
-        output = super::protocol_serde::shape_put_third_party_service_linked_configuration_recorder::de_put_third_party_service_linked_configuration_recorder(_response_body, output).map_err(super::operation::put_third_party_service_linked_configuration_recorder::PutThirdPartyServiceLinkedConfigurationRecorderError::unhandled)?;
+        output = super::protocol_serde::shape_put_third_party_service_linked_configuration_recorder::de_put_third_party_service_linked_configuration_recorder(_response_body, output)
+            .map_err(super::operation::put_third_party_service_linked_configuration_recorder::PutThirdPartyServiceLinkedConfigurationRecorderError::unhandled)?;
         output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
-        super::serde_util::put_third_party_service_linked_configuration_recorder_output_output_correct_errors(output).build().map_err(super::operation::put_third_party_service_linked_configuration_recorder::PutThirdPartyServiceLinkedConfigurationRecorderError::unhandled)?
+        super::serde_util::put_third_party_service_linked_configuration_recorder_output_output_correct_errors(output)
+            .build()
+            .map_err(super::operation::put_third_party_service_linked_configuration_recorder::PutThirdPartyServiceLinkedConfigurationRecorderError::unhandled)?
     })
 }
...
+    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
+    input: &super::types::RecordingGroup,
+) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::SerializationError> {
+    {
...
+        super::protocol_serde::shape_exclusion_by_resource_types::ser_exclusion_by_resource_types(&mut object_5, var_4)?;
+        object_5.finish();
+    }
+    if let Some(var_6) = &input.recording_strategy {
+        #[allow(unused_mut)]
+        let mut object_7 = object.key("recordingStrategy").start_object();
+        super::protocol_serde::shape_recording_strategy::ser_recording_strategy(&mut object_7, var_6)?;
+        object_7.finish();
+    }
+    Ok(())
+}
...
### `src/protocol_serde/shape_recording_mode.rs`

```diff
--- reference/src/protocol_serde/shape_recording_mode.rs
+++ generated/src/protocol_serde/shape_recording_mode.rs
@@ -1,4 +1,26 @@
 // Code generated by software.amazon.smithy.rust.codegen.smithy-rs. DO NOT EDIT.
+pub fn ser_recording_mode(
+    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
+    input: &super::types::RecordingMode,
+) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::SerializationError> {
+    {
...
+                super::protocol_serde::shape_recording_mode_override::ser_recording_mode_override(&mut object_4, item_3)?;
+                object_4.finish();
+            }
+        }
+        array_2.finish();
...
### `src/protocol_serde/shape_recording_strategy.rs`

```diff
--- reference/src/protocol_serde/shape_recording_strategy.rs
+++ generated/src/protocol_serde/shape_recording_strategy.rs
@@ -1,4 +1,14 @@
 // Code generated by software.amazon.smithy.rust.codegen.smithy-rs. DO NOT EDIT.
+pub fn ser_recording_strategy(
+    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
+    input: &super::types::RecordingStrategy,
+) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::SerializationError> {
+    if let Some(var_1) = &input.use_only {
+        object.key("useOnly").string(var_1.as_str());
+    }
+    Ok(())
+}
+
 pub(crate) fn de_recording_strategy<'a, I>(
     tokens: &mut ::std::iter::Peekable<I>,
     _value: &'a [u8],
@@ -44,13 +54,3 @@
         )),
...
### `src/protocol_serde/shape_resource_details.rs`

```diff
--- reference/src/protocol_serde/shape_resource_details.rs
+++ generated/src/protocol_serde/shape_resource_details.rs
@@ -1,4 +1,23 @@
 // Code generated by software.amazon.smithy.rust.codegen.smithy-rs. DO NOT EDIT.
+pub fn ser_resource_details(
+    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
+    input: &super::types::ResourceDetails,
+) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::SerializationError> {
+    {
...
### `src/protocol_serde/shape_start_config_rules_evaluation.rs`

```diff
--- reference/src/protocol_serde/shape_start_config_rules_evaluation.rs
+++ generated/src/protocol_serde/shape_start_config_rules_evaluation.rs
@@ -116,3 +116,36 @@
     object.finish();
     Ok(::aws_smithy_types::body::SdkBody::from(out))
 }
...
### `src/protocol_serde/shape_start_configuration_recorder.rs`

```diff
--- reference/src/protocol_serde/shape_start_configuration_recorder.rs
+++ generated/src/protocol_serde/shape_start_configuration_recorder.rs
@@ -110,3 +110,36 @@
     object.finish();
     Ok(::aws_smithy_types::body::SdkBody::from(out))
 }
+
+pub(crate) fn de_start_configuration_recorder(
+    _value: &[u8],
+    mut builder: super::operation::start_configuration_recorder::builders::StartConfigurationRecorderOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::start_configuration_recorder::builders::StartConfigurationRecorderOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
### `src/protocol_serde/shape_stop_configuration_recorder.rs`

```diff
--- reference/src/protocol_serde/shape_stop_configuration_recorder.rs
+++ generated/src/protocol_serde/shape_stop_configuration_recorder.rs
@@ -93,3 +93,36 @@
     object.finish();
     Ok(::aws_smithy_types::body::SdkBody::from(out))
 }
+
+pub(crate) fn de_stop_configuration_recorder(
+    _value: &[u8],
+    mut builder: super::operation::stop_configuration_recorder::builders::StopConfigurationRecorderOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::stop_configuration_recorder::builders::StopConfigurationRecorderOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
### `src/protocol_serde/shape_stored_query.rs`

```diff
--- reference/src/protocol_serde/shape_stored_query.rs
+++ generated/src/protocol_serde/shape_stored_query.rs
@@ -1,4 +1,26 @@
 // Code generated by software.amazon.smithy.rust.codegen.smithy-rs. DO NOT EDIT.
+pub fn ser_stored_query(
+    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
+    input: &super::types::StoredQuery,
+) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::SerializationError> {
...
+            "UNKNOWN" => RemediationExecutionState::Unknown,
             other => RemediationExecutionState::Unknown(super::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
         }
     }
@@ -88,7 +86,7 @@
...
+            "UNKNOWN" => RemediationExecutionStepState::Unknown,
             other => RemediationExecutionStepState::Unknown(super::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
         }
     }
@@ -93,7 +91,7 @@
...
-            "AWS::XRay::EncryptionConfig" => ResourceType::EncryptionConfig,
             other => ResourceType::Unknown(super::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
         }
     }
@@ -2194,21 +2194,19 @@
