...
+
+impl Client {
+    pub fn assume_role(&self) -> operation::assume_role::Builder { operation::assume_role::Builder::new() }
 }
```
...
+
+impl Client {
+    pub fn assume_role_with_web_identity(&self) -> operation::assume_role_with_web_identity::Builder { operation::assume_role_with_web_identity::Builder::new() }
 }
```
...
+
+impl Client {
+    pub fn decode_authorization_message(&self) -> operation::decode_authorization_message::Builder { operation::decode_authorization_message::Builder::new() }
 }
```
...
+
+impl Client {
+    pub fn get_access_key_info(&self) -> operation::get_access_key_info::Builder { operation::get_access_key_info::Builder::new() }
 }
```
...
+
+impl Client {
+    pub fn get_caller_identity(&self) -> operation::get_caller_identity::Builder { operation::get_caller_identity::Builder::new() }
 }
```
...
+
+impl Client {
+    pub fn get_federation_token(&self) -> operation::get_federation_token::Builder { operation::get_federation_token::Builder::new() }
 }
```
...
+
+impl Client {
+    pub fn get_session_token(&self) -> operation::get_session_token::Builder { operation::get_session_token::Builder::new() }
 }
```
...
+
+impl Client {
+    pub fn get_web_identity_token(&self) -> operation::get_web_identity_token::Builder { operation::get_web_identity_token::Builder::new() }
 }
```
