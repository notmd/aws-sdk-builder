...
**Progress:** `1361/1361` files compared · `1214` matched · `147` mismatches · `0` missing · `0` extra · `89.20%` match (100.00% means fully matched)
...
+    ///   - [`custom_attributes(SchemaAttributeType)`](crate::operation::add_custom_attributes::builders::AddCustomAttributesFluentBuilder::custom_attributes) / [`set_custom_attributes(Option<Vec::<SchemaAttributeType>>)`](crate::operation::add_custom_attributes::builders::AddCustomAttributesFluentBuilder::set_custom_attributes):<br>required: **true**<br><p>An array of custom attribute names and other properties. Sets the following characteristics:</p> <dl> <dt>AttributeDataType</dt> <dd> <p>The expected data type. Can be a string, a number, a date and time, or a boolean.</p></dd> <dt>Mutable</dt> <dd> <p>If true, you can grant app clients write access to the attribute value. If false, the attribute value can only be set up on sign-up or administrator creation of users.</p></dd> <dt>Name</dt> <dd> <p>The attribute name. For an attribute like <code>custom:myAttribute</code>, enter <code>myAttribute</code> for this field.</p></dd> <dt>Required</dt> <dd> <p>When true, users who sign up or are created must set a value for the attribute.</p></dd> <dt>NumberAttributeConstraints</dt> <dd> <p>The minimum and maximum length of accepted values for a <code>Number</code>-type attribute.</p></dd> <dt>StringAttributeConstraints</dt> <dd> <p>The minimum and maximum length of accepted values for a <code>String</code>-type attribute.</p></dd> <dt>DeveloperOnlyAttribute</dt> <dd> <p>This legacy option creates an attribute with a <code>dev:</code> prefix. You can only set the value of a developer-only attribute with administrative IAM credentials.</p></dd></dl><br>
     ...
     pub fn add_custom_attributes(&self) -> super::operation::add_custom_attributes::builders::AddCustomAttributesFluentBuilder {
```
...
@@ -11,7 +11,7 @@
         ...
         super::operation::admin_set_user_mfa_preference::AdminSetUserMfaPreferenceOutput,
         ::aws_smithy_runtime_api::client::result::SdkError<
-            super::operation::admin_set_user_mfa_preference::AdminSetUserMFAPreferenceError,
+            super::operation::admin_set_user_mfa_preference::AdminSetUserMfaPreferenceError,
...
+pub struct AdminSetUserMfaPreferenceFluentBuilder {
     ...
     inner: super::operation::admin_set_user_mfa_preference::builders::AdminSetUserMfaPreferenceInputBuilder,
...
+    /// Access the AdminSetUserMfaPreference as a reference.
     pub fn as_input(&self) -> &super::operation::admin_set_user_mfa_preference::builders::AdminSetUserMfaPreferenceInputBuilder {
         &self.inner
     }
@@ -82,7 +82,7 @@
     ) -> ::std::result::Result<
...
-        let runtime_plugins = super::operation::admin_set_user_mfa_preference::AdminSetUserMFAPreference::operation_runtime_plugins(
+        let runtime_plugins = super::operation::admin_set_user_mfa_preference::AdminSetUserMfaPreference::operation_runtime_plugins(
             self.handle.runtime_plugins.clone(),
             &self.handle.conf,
             self.config_override,
         );
-        super::operation::admin_set_user_mfa_preference::AdminSetUserMFAPreference::orchestrate(&runtime_plugins, input).await
+        super::operation::admin_set_user_mfa_preference::AdminSetUserMfaPreference::orchestrate(&runtime_plugins, input).await
     }
...
+    pub settings: ::std::option::Option<::std::string::String>,
     ...
     pub assets: ::std::option::Option<::std::vec::Vec<super::types::AssetType>>,
 }
@@ -52,7 +52,7 @@
     /// <li>
     /// <p><code>languageSelector</code> (for localization, see <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pools-managed-login.html#managed-login-localization">Managed login localization)</a></p></li>
...
+    pub(crate) settings: ::std::option::Option<::std::string::String>,
     pub(crate) assets: ::std::option::Option<::std::vec::Vec<super::types::AssetType>>,
 }
...
@@ -215,7 +215,7 @@
         ::std::result::Result::Ok(super::operation::create_managed_login_branding::CreateManagedLoginBrandingInput {
             user_pool_id: self.user_pool_id,
...
@@ -381,8 +381,8 @@
     ...
     pub(crate) explicit_auth_flows: ::std::option::Option<::std::vec::Vec<super::types::ExplicitAuthFlowsType>>,
...
+    pub(crate) logout_ur_ls: ::std::option::Option<::std::vec::Vec<::std::string::String>>,
     ...
     pub(crate) allowed_o_auth_flows: ::std::option::Option<::std::vec::Vec<super::types::OAuthFlowType>>,
...
@@ -1026,9 +1026,9 @@
         ::std::result::Result::Ok(super::operation::create_user_pool_client::CreateUserPoolClientInput {
             user_pool_id: self.user_pool_id,
...
@@ -94,7 +94,7 @@
         ::std::result::Result::Ok(super::operation::describe_managed_login_branding::DescribeManagedLoginBrandingInput {
             user_pool_id: self.user_pool_id,
...
@@ -104,7 +104,7 @@
             super::operation::describe_managed_login_branding_by_client::DescribeManagedLoginBrandingByClientInput {
                 user_pool_id: self.user_pool_id,
                 client_id: self.client_id,
-                return_merged_resources: self.return_merged_resources,
+                return_merged_resources: self.return_merged_resources.unwrap_or_default(),
...
@@ -11,7 +11,7 @@
         ...
         super::operation::get_csv_header::GetCsvHeaderOutput,
         ::aws_smithy_runtime_api::client::result::SdkError<
-            super::operation::get_csv_header::GetCSVHeaderError,
+            super::operation::get_csv_header::GetCsvHeaderError,
             ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
         >,
     > {
...
+pub struct GetCsvHeaderFluentBuilder {
     handle: ::std::sync::Arc<super::client::Handle>,
     inner: super::operation::get_csv_header::builders::GetCsvHeaderInputBuilder,
     config_override: ::std::option::Option<super::config::Builder>,
@@ -41,8 +41,8 @@
 impl
     super::client::customize::internal::CustomizableSend<
...
+    /// Access the GetCsvHeader as a reference.
     pub fn as_input(&self) -> &super::operation::get_csv_header::builders::GetCsvHeaderInputBuilder {
         &self.inner
     }
@@ -82,7 +82,7 @@
     ) -> ::std::result::Result<
...
@@ -90,12 +90,12 @@
             ...
             .build()
             .map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
-        let runtime_plugins = super::operation::get_csv_header::GetCSVHeader::operation_runtime_plugins(
+        let runtime_plugins = super::operation::get_csv_header::GetCsvHeader::operation_runtime_plugins(
             self.handle.runtime_plugins.clone(),
             &self.handle.conf,
             self.config_override,
         );
-        super::operation::get_csv_header::GetCSVHeader::orchestrate(&runtime_plugins, input).await
+        super::operation::get_csv_header::GetCsvHeader::orchestrate(&runtime_plugins, input).await
     }
...
@@ -11,7 +11,7 @@
         ...
         super::operation::get_ui_customization::GetUiCustomizationOutput,
         ::aws_smithy_runtime_api::client::result::SdkError<
-            super::operation::get_ui_customization::GetUICustomizationError,
+            super::operation::get_ui_customization::GetUiCustomizationError,
             ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
         >,
     > {
...
+pub struct GetUiCustomizationFluentBuilder {
     handle: ::std::sync::Arc<super::client::Handle>,
     inner: super::operation::get_ui_customization::builders::GetUiCustomizationInputBuilder,
     config_override: ::std::option::Option<super::config::Builder>,
@@ -32,8 +32,8 @@
 impl
     super::client::customize::internal::CustomizableSend<
...
+    /// Access the GetUiCustomization as a reference.
     pub fn as_input(&self) -> &super::operation::get_ui_customization::builders::GetUiCustomizationInputBuilder {
         &self.inner
     }
@@ -73,7 +73,7 @@
     ) -> ::std::result::Result<
...
@@ -81,12 +81,12 @@
             ...
             .build()
             .map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
-        let runtime_plugins = super::operation::get_ui_customization::GetUICustomization::operation_runtime_plugins(
+        let runtime_plugins = super::operation::get_ui_customization::GetUiCustomization::operation_runtime_plugins(
             self.handle.runtime_plugins.clone(),
             &self.handle.conf,
             self.config_override,
         );
-        super::operation::get_ui_customization::GetUICustomization::orchestrate(&runtime_plugins, input).await
+        super::operation::get_ui_customization::GetUiCustomization::orchestrate(&runtime_plugins, input).await
     }
...
+    pub fn get_settings(&self) -> &::std::option::Option<::std::string::String> {
     ...
     /// Appends an item to `assets`.
@@ -202,7 +202,7 @@
         ::std::result::Result::Ok(super::operation::update_managed_login_branding::UpdateManagedLoginBrandingInput {
             user_pool_id: self.user_pool_id,
             managed_login_branding_id: self.managed_login_branding_id,
-            use_cognito_provided_values: self.use_cognito_provided_values,
+            use_cognito_provided_values: self.use_cognito_provided_values.unwrap_or_default(),
...
@@ -72,7 +72,7 @@
     > {
         ::std::result::Result::Ok(super::operation::update_provisioned_limit::UpdateProvisionedLimitInput {
...
+    _value: &[u8],
+    mut builder: super::operation::add_custom_attributes::builders::AddCustomAttributesOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::add_custom_attributes::builders::AddCustomAttributesOutputBuilder,
...
+    _value: &[u8],
+    mut builder: super::operation::admin_add_user_to_group::builders::AdminAddUserToGroupOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::admin_add_user_to_group::builders::AdminAddUserToGroupOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
+    _value: &[u8],
+    mut builder: super::operation::admin_confirm_sign_up::builders::AdminConfirmSignUpOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::admin_confirm_sign_up::builders::AdminConfirmSignUpOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
@@ -3,10 +3,10 @@
     ...
     input: &super::types::AdminCreateUserConfigType,
...
+    _value: &[u8],
+    mut builder: super::operation::admin_delete_user::builders::AdminDeleteUserOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::admin_delete_user::builders::AdminDeleteUserOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
+    _value: &[u8],
+    mut builder: super::operation::admin_delete_user_attributes::builders::AdminDeleteUserAttributesOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::admin_delete_user_attributes::builders::AdminDeleteUserAttributesOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
+    _value: &[u8],
+    mut builder: super::operation::admin_disable_provider_for_user::builders::AdminDisableProviderForUserOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::admin_disable_provider_for_user::builders::AdminDisableProviderForUserOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
+    _value: &[u8],
+    mut builder: super::operation::admin_disable_user::builders::AdminDisableUserOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::admin_disable_user::builders::AdminDisableUserOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
+    _value: &[u8],
+    mut builder: super::operation::admin_enable_user::builders::AdminEnableUserOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::admin_enable_user::builders::AdminEnableUserOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
+    _value: &[u8],
+    mut builder: super::operation::admin_forget_device::builders::AdminForgetDeviceOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::admin_forget_device::builders::AdminForgetDeviceOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
+    _value: &[u8],
+    mut builder: super::operation::admin_link_provider_for_user::builders::AdminLinkProviderForUserOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::admin_link_provider_for_user::builders::AdminLinkProviderForUserOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
+    _value: &[u8],
+    mut builder: super::operation::admin_remove_user_from_group::builders::AdminRemoveUserFromGroupOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::admin_remove_user_from_group::builders::AdminRemoveUserFromGroupOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
+    _value: &[u8],
+    mut builder: super::operation::admin_reset_user_password::builders::AdminResetUserPasswordOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::admin_reset_user_password::builders::AdminResetUserPasswordOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
-        .map_err(super::operation::admin_set_user_mfa_preference::AdminSetUserMFAPreferenceError::unhandled)?;
+        .map_err(super::operation::admin_set_user_mfa_preference::AdminSetUserMfaPreferenceError::unhandled)?;
     generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
     let generic = generic_builder.build();
     let error_code = match generic.code() {
         Some(code) => code,
-        None => return Err(super::operation::admin_set_user_mfa_preference::AdminSetUserMFAPreferenceError::unhandled(generic)),
+        None => return Err(super::operation::admin_set_user_mfa_preference::AdminSetUserMfaPreferenceError::unhandled(generic)),
     };

     let _error_message = generic.message().map(|msg| msg.to_owned());
     Err(match error_code {
-        "InternalErrorException" => super::operation::admin_set_user_mfa_preference::AdminSetUserMFAPreferenceError::InternalErrorException({
+        "InternalErrorException" => super::operation::admin_set_user_mfa_preference::AdminSetUserMfaPreferenceError::InternalErrorException({
             #[allow(unused_mut)]
             let mut tmp = {
                 #[allow(unused_mut)]
...
-        "InvalidParameterException" => super::operation::admin_set_user_mfa_preference::AdminSetUserMFAPreferenceError::InvalidParameterException({
+        "InvalidParameterException" => super::operation::admin_set_user_mfa_preference::AdminSetUserMfaPreferenceError::InvalidParameterException({
             #[allow(unused_mut)]
             let mut tmp = {
                 #[allow(unused_mut)]
...
-        "NotAuthorizedException" => super::operation::admin_set_user_mfa_preference::AdminSetUserMFAPreferenceError::NotAuthorizedException({
+        "NotAuthorizedException" => super::operation::admin_set_user_mfa_preference::AdminSetUserMfaPreferenceError::NotAuthorizedException({
             #[allow(unused_mut)]
             let mut tmp = {
                 #[allow(unused_mut)]
...
-            super::operation::admin_set_user_mfa_preference::AdminSetUserMFAPreferenceError::OperationNotEnabledException({
+            super::operation::admin_set_user_mfa_preference::AdminSetUserMfaPreferenceError::OperationNotEnabledException({
                 #[allow(unused_mut)]
                 let mut tmp = {
                     #[allow(unused_mut)]
...
-            super::operation::admin_set_user_mfa_preference::AdminSetUserMFAPreferenceError::PasswordResetRequiredException({
+            super::operation::admin_set_user_mfa_preference::AdminSetUserMfaPreferenceError::PasswordResetRequiredException({
                 #[allow(unused_mut)]
                 let mut tmp = {
                     #[allow(unused_mut)]
...
-        "ResourceNotFoundException" => super::operation::admin_set_user_mfa_preference::AdminSetUserMFAPreferenceError::ResourceNotFoundException({
+        "ResourceNotFoundException" => super::operation::admin_set_user_mfa_preference::AdminSetUserMfaPreferenceError::ResourceNotFoundException({
             #[allow(unused_mut)]
             let mut tmp = {
                 #[allow(unused_mut)]
...
-        "UserNotConfirmedException" => super::operation::admin_set_user_mfa_preference::AdminSetUserMFAPreferenceError::UserNotConfirmedException({
+        "UserNotConfirmedException" => super::operation::admin_set_user_mfa_preference::AdminSetUserMfaPreferenceError::UserNotConfirmedException({
             #[allow(unused_mut)]
             let mut tmp = {
                 #[allow(unused_mut)]
...
-        "UserNotFoundException" => super::operation::admin_set_user_mfa_preference::AdminSetUserMFAPreferenceError::UserNotFoundException({
+        "UserNotFoundException" => super::operation::admin_set_user_mfa_preference::AdminSetUserMfaPreferenceError::UserNotFoundException({
             #[allow(unused_mut)]
             let mut tmp = {
                 #[allow(unused_mut)]
...
-        _ => super::operation::admin_set_user_mfa_preference::AdminSetUserMFAPreferenceError::generic(generic),
+        _ => super::operation::admin_set_user_mfa_preference::AdminSetUserMfaPreferenceError::generic(generic),
     })
 }
...
+    _value: &[u8],
+    mut builder: super::operation::admin_set_user_mfa_preference::builders::AdminSetUserMfaPreferenceOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::admin_set_user_mfa_preference::builders::AdminSetUserMfaPreferenceOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
+    _value: &[u8],
+    mut builder: super::operation::admin_set_user_password::builders::AdminSetUserPasswordOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::admin_set_user_password::builders::AdminSetUserPasswordOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
+    _value: &[u8],
+    mut builder: super::operation::admin_set_user_settings::builders::AdminSetUserSettingsOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::admin_set_user_settings::builders::AdminSetUserSettingsOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
+    _value: &[u8],
+    mut builder: super::operation::admin_update_auth_event_feedback::builders::AdminUpdateAuthEventFeedbackOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::admin_update_auth_event_feedback::builders::AdminUpdateAuthEventFeedbackOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
+    _value: &[u8],
+    mut builder: super::operation::admin_update_device_status::builders::AdminUpdateDeviceStatusOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::admin_update_device_status::builders::AdminUpdateDeviceStatusOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
+    _value: &[u8],
+    mut builder: super::operation::admin_update_user_attributes::builders::AdminUpdateUserAttributesOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::admin_update_user_attributes::builders::AdminUpdateUserAttributesOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
+    _value: &[u8],
+    mut builder: super::operation::admin_user_global_sign_out::builders::AdminUserGlobalSignOutOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::admin_user_global_sign_out::builders::AdminUserGlobalSignOutOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
+    _value: &[u8],
+    mut builder: super::operation::change_password::builders::ChangePasswordOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::change_password::builders::ChangePasswordOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
+    _value: &[u8],
+    mut builder: super::operation::complete_web_authn_registration::builders::CompleteWebAuthnRegistrationOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::complete_web_authn_registration::builders::CompleteWebAuthnRegistrationOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
+    _value: &[u8],
+    mut builder: super::operation::confirm_forgot_password::builders::ConfirmForgotPasswordOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::confirm_forgot_password::builders::ConfirmForgotPasswordOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
+    _value: &[u8],
+    mut builder: super::operation::delete_group::builders::DeleteGroupOutputBuilder,
+) -> ::std::result::Result<super::operation::delete_group::builders::DeleteGroupOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
+{
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
+    #[allow(unused_variables)]
...
+    _value: &[u8],
+    mut builder: super::operation::delete_identity_provider::builders::DeleteIdentityProviderOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::delete_identity_provider::builders::DeleteIdentityProviderOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
+    _value: &[u8],
+    mut builder: super::operation::delete_managed_login_branding::builders::DeleteManagedLoginBrandingOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::delete_managed_login_branding::builders::DeleteManagedLoginBrandingOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
+    _value: &[u8],
+    mut builder: super::operation::delete_resource_server::builders::DeleteResourceServerOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::delete_resource_server::builders::DeleteResourceServerOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
+    _value: &[u8],
+    mut builder: super::operation::delete_terms::builders::DeleteTermsOutputBuilder,
+) -> ::std::result::Result<super::operation::delete_terms::builders::DeleteTermsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
+{
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
+    #[allow(unused_variables)]
...
+    _value: &[u8],
+    mut builder: super::operation::delete_user::builders::DeleteUserOutputBuilder,
+) -> ::std::result::Result<super::operation::delete_user::builders::DeleteUserOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
+{
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
+    #[allow(unused_variables)]
...
+    _value: &[u8],
+    mut builder: super::operation::delete_user_attributes::builders::DeleteUserAttributesOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::delete_user_attributes::builders::DeleteUserAttributesOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
+    _value: &[u8],
+    mut builder: super::operation::delete_user_pool::builders::DeleteUserPoolOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::delete_user_pool::builders::DeleteUserPoolOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
+    _value: &[u8],
+    mut builder: super::operation::delete_user_pool_client::builders::DeleteUserPoolClientOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::delete_user_pool_client::builders::DeleteUserPoolClientOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
+    _value: &[u8],
+    mut builder: super::operation::delete_user_pool_client_secret::builders::DeleteUserPoolClientSecretOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::delete_user_pool_client_secret::builders::DeleteUserPoolClientSecretOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
+    _value: &[u8],
+    mut builder: super::operation::delete_user_pool_domain::builders::DeleteUserPoolDomainOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::delete_user_pool_domain::builders::DeleteUserPoolDomainOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
+    _value: &[u8],
+    mut builder: super::operation::delete_web_authn_credential::builders::DeleteWebAuthnCredentialOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::delete_web_authn_credential::builders::DeleteWebAuthnCredentialOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
@@ -3,10 +3,10 @@
     object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
     input: &super::types::DeviceConfigurationType,
 ) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::SerializationError> {
...
+    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
+    input: &super::types::EmailMfaConfigType,
+) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::SerializationError> {
...
@@ -3,10 +3,10 @@
     object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
     input: &super::types::EmailMfaSettingsType,
 ) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::SerializationError> {
-    if input.enabled {
+    {
...
+    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
+    input: &super::types::FailoverType,
+) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::SerializationError> {
+    {
...
+    _value: &[u8],
+    mut builder: super::operation::forget_device::builders::ForgetDeviceOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::forget_device::builders::ForgetDeviceOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
@@ -4,26 +4,26 @@
     ...
     _response_body: &[u8],
-) -> std::result::Result<super::operation::get_csv_header::GetCsvHeaderOutput, super::operation::get_csv_header::GetCSVHeaderError> {
+) -> std::result::Result<super::operation::get_csv_header::GetCsvHeaderOutput, super::operation::get_csv_header::GetCsvHeaderError> {
     #[allow(unused_mut)]
     let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
-        .map_err(super::operation::get_csv_header::GetCSVHeaderError::unhandled)?;
+        .map_err(super::operation::get_csv_header::GetCsvHeaderError::unhandled)?;
     generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
     let generic = generic_builder.build();
     let error_code = match generic.code() {
         Some(code) => code,
-        None => return Err(super::operation::get_csv_header::GetCSVHeaderError::unhandled(generic)),
+        None => return Err(super::operation::get_csv_header::GetCsvHeaderError::unhandled(generic)),
     };

     let _error_message = generic.message().map(|msg| msg.to_owned());
     Err(match error_code {
-        "InternalErrorException" => super::operation::get_csv_header::GetCSVHeaderError::InternalErrorException({
+        "InternalErrorException" => super::operation::get_csv_header::GetCsvHeaderError::InternalErrorException({
             #[allow(unused_mut)]
             let mut tmp = {
                 #[allow(unused_mut)]
...
-        "InvalidParameterException" => super::operation::get_csv_header::GetCSVHeaderError::InvalidParameterException({
+        "InvalidParameterException" => super::operation::get_csv_header::GetCsvHeaderError::InvalidParameterException({
             #[allow(unused_mut)]
             let mut tmp = {
                 #[allow(unused_mut)]
...
-        "NotAuthorizedException" => super::operation::get_csv_header::GetCSVHeaderError::NotAuthorizedException({
+        "NotAuthorizedException" => super::operation::get_csv_header::GetCsvHeaderError::NotAuthorizedException({
             #[allow(unused_mut)]
             let mut tmp = {
                 #[allow(unused_mut)]
...
-        "OperationNotEnabledException" => super::operation::get_csv_header::GetCSVHeaderError::OperationNotEnabledException({
+        "OperationNotEnabledException" => super::operation::get_csv_header::GetCsvHeaderError::OperationNotEnabledException({
             #[allow(unused_mut)]
             let mut tmp = {
                 #[allow(unused_mut)]
...
-        "ResourceNotFoundException" => super::operation::get_csv_header::GetCSVHeaderError::ResourceNotFoundException({
+        "ResourceNotFoundException" => super::operation::get_csv_header::GetCsvHeaderError::ResourceNotFoundException({
             #[allow(unused_mut)]
             let mut tmp = {
                 #[allow(unused_mut)]
...
-        "TooManyRequestsException" => super::operation::get_csv_header::GetCSVHeaderError::TooManyRequestsException({
+        "TooManyRequestsException" => super::operation::get_csv_header::GetCsvHeaderError::TooManyRequestsException({
             #[allow(unused_mut)]
             let mut tmp = {
                 #[allow(unused_mut)]
...
-        _ => super::operation::get_csv_header::GetCSVHeaderError::generic(generic),
+        _ => super::operation::get_csv_header::GetCsvHeaderError::generic(generic),
     })
 }
...
+) -> std::result::Result<super::operation::get_csv_header::GetCsvHeaderOutput, super::operation::get_csv_header::GetCsvHeaderError> {
     Ok({
         #[allow(unused_mut)]
         let mut output = super::operation::get_csv_header::builders::GetCsvHeaderOutputBuilder::default();
         output = super::protocol_serde::shape_get_csv_header::de_get_csv_header(_response_body, output)
-            .map_err(super::operation::get_csv_header::GetCSVHeaderError::unhandled)?;
+            .map_err(super::operation::get_csv_header::GetCsvHeaderError::unhandled)?;
...
+    super::operation::get_ui_customization::GetUiCustomizationError,
 > {
     #[allow(unused_mut)]
     let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
-        .map_err(super::operation::get_ui_customization::GetUICustomizationError::unhandled)?;
+        .map_err(super::operation::get_ui_customization::GetUiCustomizationError::unhandled)?;
     generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
     let generic = generic_builder.build();
     let error_code = match generic.code() {
         Some(code) => code,
-        None => return Err(super::operation::get_ui_customization::GetUICustomizationError::unhandled(generic)),
+        None => return Err(super::operation::get_ui_customization::GetUiCustomizationError::unhandled(generic)),
     };

     let _error_message = generic.message().map(|msg| msg.to_owned());
     Err(match error_code {
-        "InternalErrorException" => super::operation::get_ui_customization::GetUICustomizationError::InternalErrorException({
+        "InternalErrorException" => super::operation::get_ui_customization::GetUiCustomizationError::InternalErrorException({
             #[allow(unused_mut)]
             let mut tmp = {
                 #[allow(unused_mut)]
...
-        "InvalidParameterException" => super::operation::get_ui_customization::GetUICustomizationError::InvalidParameterException({
+        "InvalidParameterException" => super::operation::get_ui_customization::GetUiCustomizationError::InvalidParameterException({
             #[allow(unused_mut)]
             let mut tmp = {
                 #[allow(unused_mut)]
...
-        "NotAuthorizedException" => super::operation::get_ui_customization::GetUICustomizationError::NotAuthorizedException({
+        "NotAuthorizedException" => super::operation::get_ui_customization::GetUiCustomizationError::NotAuthorizedException({
             #[allow(unused_mut)]
             let mut tmp = {
                 #[allow(unused_mut)]
...
-        "OperationNotEnabledException" => super::operation::get_ui_customization::GetUICustomizationError::OperationNotEnabledException({
+        "OperationNotEnabledException" => super::operation::get_ui_customization::GetUiCustomizationError::OperationNotEnabledException({
             #[allow(unused_mut)]
             let mut tmp = {
                 #[allow(unused_mut)]
...
-        "ResourceNotFoundException" => super::operation::get_ui_customization::GetUICustomizationError::ResourceNotFoundException({
+        "ResourceNotFoundException" => super::operation::get_ui_customization::GetUiCustomizationError::ResourceNotFoundException({
             #[allow(unused_mut)]
             let mut tmp = {
                 #[allow(unused_mut)]
...
-        "TooManyRequestsException" => super::operation::get_ui_customization::GetUICustomizationError::TooManyRequestsException({
+        "TooManyRequestsException" => super::operation::get_ui_customization::GetUiCustomizationError::TooManyRequestsException({
             #[allow(unused_mut)]
             let mut tmp = {
                 #[allow(unused_mut)]
...
-        _ => super::operation::get_ui_customization::GetUICustomizationError::generic(generic),
+        _ => super::operation::get_ui_customization::GetUiCustomizationError::generic(generic),
     })
 }
...
+    super::operation::get_ui_customization::GetUiCustomizationError,
 > {
     Ok({
         #[allow(unused_mut)]
         let mut output = super::operation::get_ui_customization::builders::GetUiCustomizationOutputBuilder::default();
         output = super::protocol_serde::shape_get_ui_customization::de_get_ui_customization(_response_body, output)
-            .map_err(super::operation::get_ui_customization::GetUICustomizationError::unhandled)?;
+            .map_err(super::operation::get_ui_customization::GetUiCustomizationError::unhandled)?;
         output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
         super::serde_util::get_ui_customization_output_output_correct_errors(output).build()
     })
```
...
+    _value: &[u8],
+    mut builder: super::operation::global_sign_out::builders::GlobalSignOutOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::global_sign_out::builders::GlobalSignOutOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
### `src/protocol_serde/shape_lambda_config_type.rs`

```diff
--- reference/src/protocol_serde/shape_lambda_config_type.rs
+++ generated/src/protocol_serde/shape_lambda_config_type.rs
@@ -157,9 +157,7 @@
                                 );
                             }
                             "PreTokenGenerationConfig" => {
-                                builder = builder.set_pre_token_generation_config(
-                                    super::protocol_serde::shape_pre_token_generation_version_config_type::de_pre_token_generation_version_config_type(tokens, _value, depth + 1)?
-                                );
+                                builder = builder.set_pre_token_generation_config(super::protocol_serde::shape_pre_token_generation_version_config_type::de_pre_token_generation_version_config_type(tokens, _value, depth + 1)?);
                             }
                             "CustomSMSSender" => {
...
-            Ok(Some(super::serde_util::limit_type_correct_errors(builder).build()))
+            Ok(Some(super::serde_util::limit_type_correct_errors(builder).build().map_err(|err| {
...
+                            builder = builder.set_settings(Some(::aws_smithy_json::deserialize::token::expect_document(tokens.next())?));
                         ...
                         "Assets" => {
                             builder = builder.set_assets(super::protocol_serde::shape_asset_list_type::de_asset_list_type(
```
...
+    _value: &[u8],
+    mut builder: super::operation::revoke_token::builders::RevokeTokenOutputBuilder,
+) -> ::std::result::Result<super::operation::revoke_token::builders::RevokeTokenOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
+{
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
+    #[allow(unused_variables)]
...
### `src/protocol_serde/shape_risk_configuration_type.rs`

```diff
--- reference/src/protocol_serde/shape_risk_configuration_type.rs
+++ generated/src/protocol_serde/shape_risk_configuration_type.rs
@@ -37,14 +37,10 @@
                                 );
                             }
                             "CompromisedCredentialsRiskConfiguration" => {
-                                builder = builder.set_compromised_credentials_risk_configuration(
-                                    super::protocol_serde::shape_compromised_credentials_risk_configuration_type::de_compromised_credentials_risk_configuration_type(tokens, _value, depth + 1)?
-                                );
+                                builder = builder.set_compromised_credentials_risk_configuration(super::protocol_serde::shape_compromised_credentials_risk_configuration_type::de_compromised_credentials_risk_configuration_type(tokens, _value, depth + 1)?);
                             }
                             "AccountTakeoverRiskConfiguration" => {
-                                builder = builder.set_account_takeover_risk_configuration(
-                                    super::protocol_serde::shape_account_takeover_risk_configuration_type::de_account_takeover_risk_configuration_type(tokens, _value, depth + 1)?
-                                );
+                                builder = builder.set_account_takeover_risk_configuration(super::protocol_serde::shape_account_takeover_risk_configuration_type::de_account_takeover_risk_configuration_type(tokens, _value, depth + 1)?);
                             }
...
+    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
+    input: &super::types::RoutingType,
+) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::SerializationError> {
+    if let Some(var_1) = &input.failover {
+        #[allow(unused_mut)]
+        let mut object_2 = object.key("Failover").start_object();
+        super::protocol_serde::shape_failover_type::ser_failover_type(&mut object_2, var_1)?;
+        object_2.finish();
+    }
+    Ok(())
+}
...
-        super::protocol_serde::shape_number_attribute_constraints_type::ser_number_attribute_constraints_type(&mut object_7, var_6)?;
-        object_7.finish();
...
-        super::protocol_serde::shape_string_attribute_constraints_type::ser_string_attribute_constraints_type(&mut object_9, var_8)?;
-        object_9.finish();
...
+    super::operation::set_ui_customization::SetUiCustomizationError,
 > {
     #[allow(unused_mut)]
     let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
-        .map_err(super::operation::set_ui_customization::SetUICustomizationError::unhandled)?;
+        .map_err(super::operation::set_ui_customization::SetUiCustomizationError::unhandled)?;
     generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
     let generic = generic_builder.build();
     let error_code = match generic.code() {
         Some(code) => code,
-        None => return Err(super::operation::set_ui_customization::SetUICustomizationError::unhandled(generic)),
+        None => return Err(super::operation::set_ui_customization::SetUiCustomizationError::unhandled(generic)),
     };

     let _error_message = generic.message().map(|msg| msg.to_owned());
     Err(match error_code {
-        "InternalErrorException" => super::operation::set_ui_customization::SetUICustomizationError::InternalErrorException({
+        "InternalErrorException" => super::operation::set_ui_customization::SetUiCustomizationError::InternalErrorException({
             #[allow(unused_mut)]
             let mut tmp = {
                 #[allow(unused_mut)]
...
-        "InvalidParameterException" => super::operation::set_ui_customization::SetUICustomizationError::InvalidParameterException({
+        "InvalidParameterException" => super::operation::set_ui_customization::SetUiCustomizationError::InvalidParameterException({
             #[allow(unused_mut)]
             let mut tmp = {
                 #[allow(unused_mut)]
...
-        "NotAuthorizedException" => super::operation::set_ui_customization::SetUICustomizationError::NotAuthorizedException({
+        "NotAuthorizedException" => super::operation::set_ui_customization::SetUiCustomizationError::NotAuthorizedException({
             #[allow(unused_mut)]
             let mut tmp = {
                 #[allow(unused_mut)]
...
-        "OperationNotEnabledException" => super::operation::set_ui_customization::SetUICustomizationError::OperationNotEnabledException({
+        "OperationNotEnabledException" => super::operation::set_ui_customization::SetUiCustomizationError::OperationNotEnabledException({
             #[allow(unused_mut)]
             let mut tmp = {
                 #[allow(unused_mut)]
...
-        "ResourceNotFoundException" => super::operation::set_ui_customization::SetUICustomizationError::ResourceNotFoundException({
+        "ResourceNotFoundException" => super::operation::set_ui_customization::SetUiCustomizationError::ResourceNotFoundException({
             #[allow(unused_mut)]
             let mut tmp = {
                 #[allow(unused_mut)]
...
-        "TooManyRequestsException" => super::operation::set_ui_customization::SetUICustomizationError::TooManyRequestsException({
+        "TooManyRequestsException" => super::operation::set_ui_customization::SetUiCustomizationError::TooManyRequestsException({
             #[allow(unused_mut)]
             let mut tmp = {
                 #[allow(unused_mut)]
...
-        _ => super::operation::set_ui_customization::SetUICustomizationError::generic(generic),
+        _ => super::operation::set_ui_customization::SetUiCustomizationError::generic(generic),
     })
 }
...
+    super::operation::set_ui_customization::SetUiCustomizationError,
 > {
     Ok({
         #[allow(unused_mut)]
         let mut output = super::operation::set_ui_customization::builders::SetUiCustomizationOutputBuilder::default();
         output = super::protocol_serde::shape_set_ui_customization::de_set_ui_customization(_response_body, output)
-            .map_err(super::operation::set_ui_customization::SetUICustomizationError::unhandled)?;
+            .map_err(super::operation::set_ui_customization::SetUiCustomizationError::unhandled)?;
         output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
         super::serde_util::set_ui_customization_output_output_correct_errors(output).build()
     })
```
...
+    _value: &[u8],
+    mut builder: super::operation::set_user_settings::builders::SetUserSettingsOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::set_user_settings::builders::SetUserSettingsOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
+    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
+    input: &super::types::SmsMfaConfigType,
+) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::SerializationError> {
...
+        super::protocol_serde::shape_sms_configuration_type::ser_sms_configuration_type(&mut object_3, var_2)?;
+        object_3.finish();
+    }
+    Ok(())
+}
...
+    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
+    input: &super::types::SoftwareTokenMfaConfigType,
+) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::SerializationError> {
+    {
+        object.key("Enabled").boolean(input.enabled);
+    }
...
@@ -3,10 +3,10 @@
     object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
     input: &super::types::SoftwareTokenMfaSettingsType,
 ) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::SerializationError> {
-    if input.enabled {
+    {
         object.key("Enabled").boolean(input.enabled);
...
+    _value: &[u8],
+    mut builder: super::operation::update_auth_event_feedback::builders::UpdateAuthEventFeedbackOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::update_auth_event_feedback::builders::UpdateAuthEventFeedbackOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
### `src/protocol_serde/shape_user_attribute_update_settings_type.rs`

```diff
--- reference/src/protocol_serde/shape_user_attribute_update_settings_type.rs
+++ generated/src/protocol_serde/shape_user_attribute_update_settings_type.rs
@@ -38,9 +38,7 @@
                     Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                     Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                         "AttributesRequireVerificationBeforeUpdate" => {
-                            builder = builder.set_attributes_require_verification_before_update(
-                                    super::protocol_serde::shape_attributes_require_verification_before_update_type::de_attributes_require_verification_before_update_type(tokens, _value, depth + 1)?
-                                );
+                            builder = builder.set_attributes_require_verification_before_update(super::protocol_serde::shape_attributes_require_verification_before_update_type::de_attributes_require_verification_before_update_type(tokens, _value, depth + 1)?);
                         }
                         _ => ::aws_smithy_json::deserialize::token::skip_value(tokens)?,
                     },
```
...
@@ -116,7 +116,7 @@
                         ...
                         "CallbackURLs" => {
-                            builder = builder.set_callback_urls(super::protocol_serde::shape_callback_urls_list_type::de_callback_urls_list_type(
+                            builder = builder.set_callback_ur_ls(super::protocol_serde::shape_callback_urls_list_type::de_callback_urls_list_type(
                                 tokens,
                                 _value,
                                 depth + 1,
@@ -123,7 +123,7 @@
                         ...
                         "LogoutURLs" => {
-                            builder = builder.set_logout_urls(super::protocol_serde::shape_logout_urls_list_type::de_logout_urls_list_type(
+                            builder = builder.set_logout_ur_ls(super::protocol_serde::shape_logout_urls_list_type::de_logout_urls_list_type(
                                 tokens,
                                 _value,
                                 depth + 1,
```
...
+    _value: &[u8],
+    mut builder: super::operation::verify_user_attribute::builders::VerifyUserAttributeOutputBuilder,
+) -> ::std::result::Result<
+    super::operation::verify_user_attribute::builders::VerifyUserAttributeOutputBuilder,
+    ::aws_smithy_json::deserialize::error::DeserializeError,
+> {
+    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(super::protocol_serde::or_empty_doc(_value)).peekable();
+    let tokens = &mut tokens_owned;
...
+    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
+    input: &super::types::WebAuthnConfigurationType,
+) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::SerializationError> {
...
+    pub required: bool,
     ...
     pub number_attribute_constraints: ::std::option::Option<super::types::NumberAttributeConstraintsType>,
...
+    pub fn required(&self) -> bool {
     ...
     /// <p>Specifies the constraints for an attribute of the number type.</p>
@@ -193,9 +193,9 @@
         super::types::SchemaAttributeType {
             name: self.name,
...
+            "UNKNOWN" => UserStatusType::Unknown,
             other => UserStatusType::Unknown(super::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
         }
     }
@@ -103,7 +101,7 @@
