...
## batch
**Progress:** `764/764` files compared · `558` matched · `204` mismatches · `0` missing · `2` extra · `73.04%` match (100.00% means fully matched)
...
```diff
--- reference/src/protocol_serde/shape_delete_scheduling_policy.rs
+++ generated/src/protocol_serde/shape_delete_scheduling_policy.rs
@@ -84,3 +84,36 @@
     object.finish();
     Ok(::aws_smithy_types::body::SdkBody::from(out))
 }
...
```diff
--- reference/src/protocol_serde/shape_terminate_job.rs
+++ generated/src/protocol_serde/shape_terminate_job.rs
@@ -74,3 +74,36 @@
     object.finish();
     Ok(::aws_smithy_types::body::SdkBody::from(out))
 }
...
```diff
--- reference/src/protocol_serde/shape_update_scheduling_policy.rs
+++ generated/src/protocol_serde/shape_update_scheduling_policy.rs
@@ -84,3 +84,36 @@
     object.finish();
     Ok(::aws_smithy_types::body::SdkBody::from(out))
 }
