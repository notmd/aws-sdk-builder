...
impl super::Client {
    ...
    pub fn get_csv_header(&self) -> super::operation::get_csv_header::builders::GetCSVHeaderFluentBuilder {
        super::operation::get_csv_header::builders::GetCSVHeaderFluentBuilder::new(self.handle.clone())
    }
}
