...
impl super::Client {
    ...
    pub fn get_identity_provider_by_identifier(
        &self,
    ) -> super::operation::get_identity_provider_by_identifier::builders::GetIdentityProviderByIdentifierFluentBuilder {
        super::operation::get_identity_provider_by_identifier::builders::GetIdentityProviderByIdentifierFluentBuilder::new(self.handle.clone())
    }
}
