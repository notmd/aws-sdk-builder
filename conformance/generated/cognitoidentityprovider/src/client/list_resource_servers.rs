...
impl super::Client {
    ...
    pub fn list_resource_servers(&self) -> super::operation::list_resource_servers::builders::ListResourceServersFluentBuilder {
        super::operation::list_resource_servers::builders::ListResourceServersFluentBuilder::new(self.handle.clone())
    }
}
