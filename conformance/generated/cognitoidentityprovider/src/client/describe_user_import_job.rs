...
impl super::Client {
    ...
    pub fn describe_user_import_job(&self) -> super::operation::describe_user_import_job::builders::DescribeUserImportJobFluentBuilder {
        super::operation::describe_user_import_job::builders::DescribeUserImportJobFluentBuilder::new(self.handle.clone())
    }
}
