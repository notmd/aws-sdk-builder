...
impl super::Client {
    ...
    pub fn start_user_import_job(&self) -> super::operation::start_user_import_job::builders::StartUserImportJobFluentBuilder {
        super::operation::start_user_import_job::builders::StartUserImportJobFluentBuilder::new(self.handle.clone())
    }
}
