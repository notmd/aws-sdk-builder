...
impl super::Client {
    ...
    pub fn delete_user_pool_client(&self) -> super::operation::delete_user_pool_client::builders::DeleteUserPoolClientFluentBuilder {
        super::operation::delete_user_pool_client::builders::DeleteUserPoolClientFluentBuilder::new(self.handle.clone())
    }
}
