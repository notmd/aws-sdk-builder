...
impl super::Client {
    ...
    pub fn change_password(&self) -> super::operation::change_password::builders::ChangePasswordFluentBuilder {
        super::operation::change_password::builders::ChangePasswordFluentBuilder::new(self.handle.clone())
    }
}
