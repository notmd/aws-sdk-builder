...
impl super::Client {
    ...
    pub fn stop_user_import_job(&self) -> super::operation::stop_user_import_job::builders::StopUserImportJobFluentBuilder {
        super::operation::stop_user_import_job::builders::StopUserImportJobFluentBuilder::new(self.handle.clone())
    }
}
