...
impl super::Client {
    ...
    pub fn admin_add_user_to_group(&self) -> super::operation::admin_add_user_to_group::builders::AdminAddUserToGroupFluentBuilder {
        super::operation::admin_add_user_to_group::builders::AdminAddUserToGroupFluentBuilder::new(self.handle.clone())
    }
}
