...
impl super::Client {
    ...
    pub fn get_signing_certificate(&self) -> super::operation::get_signing_certificate::builders::GetSigningCertificateFluentBuilder {
        super::operation::get_signing_certificate::builders::GetSigningCertificateFluentBuilder::new(self.handle.clone())
    }
}
