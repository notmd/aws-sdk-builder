...
impl super::Client {
    ...
    pub fn describe_identity_provider(&self) -> super::operation::describe_identity_provider::builders::DescribeIdentityProviderFluentBuilder {
        super::operation::describe_identity_provider::builders::DescribeIdentityProviderFluentBuilder::new(self.handle.clone())
    }
}
