...
impl super::Client {
    ...
    pub fn global_sign_out(&self) -> super::operation::global_sign_out::builders::GlobalSignOutFluentBuilder {
        super::operation::global_sign_out::builders::GlobalSignOutFluentBuilder::new(self.handle.clone())
    }
}
