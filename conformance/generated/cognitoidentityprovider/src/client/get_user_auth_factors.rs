...
impl super::Client {
    ...
    pub fn get_user_auth_factors(&self) -> super::operation::get_user_auth_factors::builders::GetUserAuthFactorsFluentBuilder {
        super::operation::get_user_auth_factors::builders::GetUserAuthFactorsFluentBuilder::new(self.handle.clone())
    }
}
