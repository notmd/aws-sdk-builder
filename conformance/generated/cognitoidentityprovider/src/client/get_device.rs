...
impl super::Client {
    ...
    pub fn get_device(&self) -> super::operation::get_device::builders::GetDeviceFluentBuilder {
        super::operation::get_device::builders::GetDeviceFluentBuilder::new(self.handle.clone())
    }
}
