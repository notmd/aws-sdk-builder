...
impl super::Client {
    ...
    pub fn delete_resource_server(&self) -> super::operation::delete_resource_server::builders::DeleteResourceServerFluentBuilder {
        super::operation::delete_resource_server::builders::DeleteResourceServerFluentBuilder::new(self.handle.clone())
    }
}
