...
impl super::Client {
    ...
    pub fn start_web_authn_registration(&self) -> super::operation::start_web_authn_registration::builders::StartWebAuthnRegistrationFluentBuilder {
        super::operation::start_web_authn_registration::builders::StartWebAuthnRegistrationFluentBuilder::new(self.handle.clone())
    }
}
