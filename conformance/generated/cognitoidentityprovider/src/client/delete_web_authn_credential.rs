...
impl super::Client {
    ...
    pub fn delete_web_authn_credential(&self) -> super::operation::delete_web_authn_credential::builders::DeleteWebAuthnCredentialFluentBuilder {
        super::operation::delete_web_authn_credential::builders::DeleteWebAuthnCredentialFluentBuilder::new(self.handle.clone())
    }
}
