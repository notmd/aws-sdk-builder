...
impl super::Client {
    ...
    pub fn admin_user_global_sign_out(&self) -> super::operation::admin_user_global_sign_out::builders::AdminUserGlobalSignOutFluentBuilder {
        super::operation::admin_user_global_sign_out::builders::AdminUserGlobalSignOutFluentBuilder::new(self.handle.clone())
    }
}
