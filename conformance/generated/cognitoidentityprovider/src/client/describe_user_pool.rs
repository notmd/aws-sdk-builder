...
impl super::Client {
    ...
    pub fn describe_user_pool(&self) -> super::operation::describe_user_pool::builders::DescribeUserPoolFluentBuilder {
        super::operation::describe_user_pool::builders::DescribeUserPoolFluentBuilder::new(self.handle.clone())
    }
}
