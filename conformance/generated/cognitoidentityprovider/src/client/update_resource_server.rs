...
impl super::Client {
    ...
    pub fn update_resource_server(&self) -> super::operation::update_resource_server::builders::UpdateResourceServerFluentBuilder {
        super::operation::update_resource_server::builders::UpdateResourceServerFluentBuilder::new(self.handle.clone())
    }
}
