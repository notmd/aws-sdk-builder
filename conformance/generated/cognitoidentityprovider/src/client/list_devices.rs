...
impl super::Client {
    ...
    pub fn list_devices(&self) -> super::operation::list_devices::builders::ListDevicesFluentBuilder {
        super::operation::list_devices::builders::ListDevicesFluentBuilder::new(self.handle.clone())
    }
}
