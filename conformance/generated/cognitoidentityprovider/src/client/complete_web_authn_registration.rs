...
impl super::Client {
    ...
    pub fn complete_web_authn_registration(
        &self,
    ) -> super::operation::complete_web_authn_registration::builders::CompleteWebAuthnRegistrationFluentBuilder {
        super::operation::complete_web_authn_registration::builders::CompleteWebAuthnRegistrationFluentBuilder::new(self.handle.clone())
    }
}
