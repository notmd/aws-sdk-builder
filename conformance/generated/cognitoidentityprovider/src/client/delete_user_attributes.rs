...
impl super::Client {
    ...
    pub fn delete_user_attributes(&self) -> super::operation::delete_user_attributes::builders::DeleteUserAttributesFluentBuilder {
        super::operation::delete_user_attributes::builders::DeleteUserAttributesFluentBuilder::new(self.handle.clone())
    }
}
