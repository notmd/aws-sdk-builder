...
impl super::Client {
    ...
    pub fn get_ui_customization(&self) -> super::operation::get_ui_customization::builders::GetUICustomizationFluentBuilder {
        super::operation::get_ui_customization::builders::GetUICustomizationFluentBuilder::new(self.handle.clone())
    }
}
