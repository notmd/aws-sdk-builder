...
impl super::Client {
    ...
    pub fn admin_enable_user(&self) -> super::operation::admin_enable_user::builders::AdminEnableUserFluentBuilder {
        super::operation::admin_enable_user::builders::AdminEnableUserFluentBuilder::new(self.handle.clone())
    }
}
