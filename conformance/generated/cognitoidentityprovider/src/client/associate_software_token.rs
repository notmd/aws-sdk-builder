...
impl super::Client {
    ...
    pub fn associate_software_token(&self) -> super::operation::associate_software_token::builders::AssociateSoftwareTokenFluentBuilder {
        super::operation::associate_software_token::builders::AssociateSoftwareTokenFluentBuilder::new(self.handle.clone())
    }
}
