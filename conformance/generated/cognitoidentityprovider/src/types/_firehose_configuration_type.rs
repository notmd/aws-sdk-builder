...
impl FirehoseConfigurationType {
    ...
    pub fn builder() -> super::types::builders::FirehoseConfigurationTypeBuilder {
        super::types::builders::FirehoseConfigurationTypeBuilder::default()
    }
}
...
impl FirehoseConfigurationTypeBuilder {
    ...
    pub fn build(self) -> super::types::FirehoseConfigurationType {
        super::types::FirehoseConfigurationType { stream_arn: self.stream_arn }
    }
}
