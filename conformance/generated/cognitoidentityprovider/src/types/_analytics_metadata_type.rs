...
impl AnalyticsMetadataType {
    ...
    pub fn builder() -> super::types::builders::AnalyticsMetadataTypeBuilder {
        super::types::builders::AnalyticsMetadataTypeBuilder::default()
    }
}
...
impl AnalyticsMetadataTypeBuilder {
    ...
    pub fn build(self) -> super::types::AnalyticsMetadataType {
        super::types::AnalyticsMetadataType {
