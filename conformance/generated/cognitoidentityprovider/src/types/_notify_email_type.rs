...
impl NotifyEmailType {
    ...
    pub fn builder() -> super::types::builders::NotifyEmailTypeBuilder {
        super::types::builders::NotifyEmailTypeBuilder::default()
    }
}
...
impl NotifyEmailTypeBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::NotifyEmailType, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::NotifyEmailType {
