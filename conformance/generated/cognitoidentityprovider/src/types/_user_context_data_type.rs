...
impl UserContextDataType {
    ...
    pub fn builder() -> super::types::builders::UserContextDataTypeBuilder {
        super::types::builders::UserContextDataTypeBuilder::default()
    }
}
...
impl UserContextDataTypeBuilder {
    ...
    pub fn build(self) -> super::types::UserContextDataType {
        super::types::UserContextDataType {
