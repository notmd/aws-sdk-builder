...
impl WebAuthnCredentialDescription {
    ...
    pub fn builder() -> super::types::builders::WebAuthnCredentialDescriptionBuilder {
        super::types::builders::WebAuthnCredentialDescriptionBuilder::default()
    }
}
...
impl WebAuthnCredentialDescriptionBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::WebAuthnCredentialDescription, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::WebAuthnCredentialDescription {
