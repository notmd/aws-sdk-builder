...
impl SoftwareTokenMfaSettingsType {
    ...
    pub fn builder() -> super::types::builders::SoftwareTokenMfaSettingsTypeBuilder {
        super::types::builders::SoftwareTokenMfaSettingsTypeBuilder::default()
    }
}
...
impl SoftwareTokenMfaSettingsTypeBuilder {
    ...
    pub fn build(self) -> super::types::SoftwareTokenMfaSettingsType {
        super::types::SoftwareTokenMfaSettingsType {
