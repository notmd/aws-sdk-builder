...
pub struct SignInPolicyType {
    ...
    /// </note>
    pub allowed_first_auth_factors: ::std::option::Option<::std::vec::Vec<super::types::AuthFactorType>>,
}
impl SignInPolicyType {
    ...
    pub fn allowed_first_auth_factors(&self) -> &[super::types::AuthFactorType] {
...
impl SignInPolicyType {
    ...
    pub fn builder() -> super::types::builders::SignInPolicyTypeBuilder {
        super::types::builders::SignInPolicyTypeBuilder::default()
    }
}
...
pub struct SignInPolicyTypeBuilder {
    pub(crate) allowed_first_auth_factors: ::std::option::Option<::std::vec::Vec<super::types::AuthFactorType>>,
}
impl SignInPolicyTypeBuilder {
    ...
    /// <p><code>SOFTWARE_TOKEN</code> is not currently supported as a first auth factor. Do not include this value in <code>AllowedFirstAuthFactors</code>.</p>
    /// </note>
    pub fn allowed_first_auth_factors(mut self, input: super::types::AuthFactorType) -> Self {
    ...
    /// <p><code>SOFTWARE_TOKEN</code> is not currently supported as a first auth factor. Do not include this value in <code>AllowedFirstAuthFactors</code>.</p>
    /// </note>
    pub fn set_allowed_first_auth_factors(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::AuthFactorType>>) -> Self {
    ...
    /// <p><code>SOFTWARE_TOKEN</code> is not currently supported as a first auth factor. Do not include this value in <code>AllowedFirstAuthFactors</code>.</p>
    /// </note>
    pub fn get_allowed_first_auth_factors(&self) -> &::std::option::Option<::std::vec::Vec<super::types::AuthFactorType>> {
        &self.allowed_first_auth_factors
    }
    /// Consumes the builder and constructs a [`SignInPolicyType`](crate::types::SignInPolicyType).
    pub fn build(self) -> super::types::SignInPolicyType {
        super::types::SignInPolicyType {
