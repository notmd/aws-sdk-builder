...
impl S3ConfigurationType {
    ...
    pub fn builder() -> super::types::builders::S3ConfigurationTypeBuilder {
        super::types::builders::S3ConfigurationTypeBuilder::default()
    }
}
...
impl S3ConfigurationTypeBuilder {
    ...
    pub fn build(self) -> super::types::S3ConfigurationType {
        super::types::S3ConfigurationType { bucket_arn: self.bucket_arn }
    }
}
