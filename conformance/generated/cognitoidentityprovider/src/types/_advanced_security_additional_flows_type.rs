...
pub struct AdvancedSecurityAdditionalFlowsType {
    ...
    pub custom_auth_mode: ::std::option::Option<super::types::AdvancedSecurityEnabledModeType>,
}
impl AdvancedSecurityAdditionalFlowsType {
    /// <p>The operating mode of threat protection in custom authentication with <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-lambda-challenge.html"> Custom authentication challenge Lambda triggers</a>.</p>
    pub fn custom_auth_mode(&self) -> ::std::option::Option<&super::types::AdvancedSecurityEnabledModeType> {
...
impl AdvancedSecurityAdditionalFlowsType {
    ...
    pub fn builder() -> super::types::builders::AdvancedSecurityAdditionalFlowsTypeBuilder {
        super::types::builders::AdvancedSecurityAdditionalFlowsTypeBuilder::default()
    }
}
...
pub struct AdvancedSecurityAdditionalFlowsTypeBuilder {
    pub(crate) custom_auth_mode: ::std::option::Option<super::types::AdvancedSecurityEnabledModeType>,
}
impl AdvancedSecurityAdditionalFlowsTypeBuilder {
    /// <p>The operating mode of threat protection in custom authentication with <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-lambda-challenge.html"> Custom authentication challenge Lambda triggers</a>.</p>
    pub fn custom_auth_mode(mut self, input: super::types::AdvancedSecurityEnabledModeType) -> Self {
        self.custom_auth_mode = ::std::option::Option::Some(input);
        self
    }
    /// <p>The operating mode of threat protection in custom authentication with <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-lambda-challenge.html"> Custom authentication challenge Lambda triggers</a>.</p>
    pub fn set_custom_auth_mode(mut self, input: ::std::option::Option<super::types::AdvancedSecurityEnabledModeType>) -> Self {
        self.custom_auth_mode = input;
        self
    }
    /// <p>The operating mode of threat protection in custom authentication with <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-lambda-challenge.html"> Custom authentication challenge Lambda triggers</a>.</p>
    pub fn get_custom_auth_mode(&self) -> &::std::option::Option<super::types::AdvancedSecurityEnabledModeType> {
    ...
    pub fn build(self) -> super::types::AdvancedSecurityAdditionalFlowsType {
        super::types::AdvancedSecurityAdditionalFlowsType {
