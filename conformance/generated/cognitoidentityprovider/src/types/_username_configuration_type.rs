...
impl UsernameConfigurationType {
    ...
    pub fn builder() -> super::types::builders::UsernameConfigurationTypeBuilder {
        super::types::builders::UsernameConfigurationTypeBuilder::default()
    }
}
...
impl UsernameConfigurationTypeBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::UsernameConfigurationType, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::UsernameConfigurationType {
