...
impl UserPoolClientDescription {
    ...
    pub fn builder() -> super::types::builders::UserPoolClientDescriptionBuilder {
        super::types::builders::UserPoolClientDescriptionBuilder::default()
    }
}
...
impl UserPoolClientDescriptionBuilder {
    ...
    pub fn build(self) -> super::types::UserPoolClientDescription {
