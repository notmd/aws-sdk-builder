...
impl MfaOptionType {
    ...
    pub fn builder() -> super::types::builders::MfaOptionTypeBuilder {
        super::types::builders::MfaOptionTypeBuilder::default()
    }
}
...
impl MfaOptionTypeBuilder {
    ...
    pub fn build(self) -> super::types::MfaOptionType {
        super::types::MfaOptionType {
