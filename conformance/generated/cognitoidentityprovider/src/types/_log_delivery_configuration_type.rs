...
pub struct LogDeliveryConfigurationType {
    ...
    pub log_configurations: ::std::vec::Vec<super::types::LogConfigurationType>,
}
...
impl LogDeliveryConfigurationType {
    ...
    pub fn builder() -> super::types::builders::LogDeliveryConfigurationTypeBuilder {
        super::types::builders::LogDeliveryConfigurationTypeBuilder::default()
    }
}
...
impl LogDeliveryConfigurationTypeBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::LogDeliveryConfigurationType, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::LogDeliveryConfigurationType {
