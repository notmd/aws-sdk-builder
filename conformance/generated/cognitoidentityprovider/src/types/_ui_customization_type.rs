...
impl UiCustomizationType {
    ...
    pub fn builder() -> super::types::builders::UiCustomizationTypeBuilder {
        super::types::builders::UiCustomizationTypeBuilder::default()
    }
}
...
impl UiCustomizationTypeBuilder {
    ...
    pub fn build(self) -> super::types::UiCustomizationType {
        super::types::UiCustomizationType {
