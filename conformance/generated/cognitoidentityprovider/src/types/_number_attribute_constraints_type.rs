...
impl NumberAttributeConstraintsType {
    ...
    pub fn builder() -> super::types::builders::NumberAttributeConstraintsTypeBuilder {
        super::types::builders::NumberAttributeConstraintsTypeBuilder::default()
    }
}
...
impl NumberAttributeConstraintsTypeBuilder {
    ...
    pub fn build(self) -> super::types::NumberAttributeConstraintsType {
        super::types::NumberAttributeConstraintsType {
