...
impl SmsMfaConfigType {
    ...
    pub fn builder() -> super::types::builders::SmsMfaConfigTypeBuilder {
        super::types::builders::SmsMfaConfigTypeBuilder::default()
    }
}
...
impl SmsMfaConfigTypeBuilder {
    ...
    pub fn build(self) -> super::types::SmsMfaConfigType {
        super::types::SmsMfaConfigType {
