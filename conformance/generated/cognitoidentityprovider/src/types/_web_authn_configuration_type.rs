...
pub struct WebAuthnConfigurationType {
    ...
    pub user_verification: ::std::option::Option<super::types::UserVerificationType>,
    ...
    pub factor_configuration: ::std::option::Option<super::types::WebAuthnFactorConfigurationType>,
}
impl WebAuthnConfigurationType {
    ...
    /// <p>When <code>required</code>, users can only register and sign in users with passkeys that are capable of <a href="https://www.w3.org/TR/webauthn-2/#enum-userVerificationRequirement">user verification</a>. When <code>preferred</code>, your user pool doesn't require the use of authenticators with user verification but encourages it.</p>
    pub fn user_verification(&self) -> ::std::option::Option<&super::types::UserVerificationType> {
        self.user_verification.as_ref()
    }
    /// <p>Sets whether passkeys can be used as multi-factor authentication (MFA). When set to <code>MULTI_FACTOR_WITH_USER_VERIFICATION</code>, passkey authentication with user verification satisfies MFA requirements. When set to <code>SINGLE_FACTOR</code> or not set, passkeys are a single authentication factor. To activate this setting, your user pool must be in the <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/feature-plans-features-essentials.html"> Essentials tier</a> or higher.</p>
    pub fn factor_configuration(&self) -> ::std::option::Option<&super::types::WebAuthnFactorConfigurationType> {
...
impl WebAuthnConfigurationType {
    ...
    pub fn builder() -> super::types::builders::WebAuthnConfigurationTypeBuilder {
        super::types::builders::WebAuthnConfigurationTypeBuilder::default()
    }
}
...
pub struct WebAuthnConfigurationTypeBuilder {
    ...
    pub(crate) user_verification: ::std::option::Option<super::types::UserVerificationType>,
    pub(crate) factor_configuration: ::std::option::Option<super::types::WebAuthnFactorConfigurationType>,
}
impl WebAuthnConfigurationTypeBuilder {
    ...
    /// <p>When <code>required</code>, users can only register and sign in users with passkeys that are capable of <a href="https://www.w3.org/TR/webauthn-2/#enum-userVerificationRequirement">user verification</a>. When <code>preferred</code>, your user pool doesn't require the use of authenticators with user verification but encourages it.</p>
    pub fn user_verification(mut self, input: super::types::UserVerificationType) -> Self {
        self.user_verification = ::std::option::Option::Some(input);
        self
    }
    /// <p>When <code>required</code>, users can only register and sign in users with passkeys that are capable of <a href="https://www.w3.org/TR/webauthn-2/#enum-userVerificationRequirement">user verification</a>. When <code>preferred</code>, your user pool doesn't require the use of authenticators with user verification but encourages it.</p>
    pub fn set_user_verification(mut self, input: ::std::option::Option<super::types::UserVerificationType>) -> Self {
        self.user_verification = input;
        self
    }
    /// <p>When <code>required</code>, users can only register and sign in users with passkeys that are capable of <a href="https://www.w3.org/TR/webauthn-2/#enum-userVerificationRequirement">user verification</a>. When <code>preferred</code>, your user pool doesn't require the use of authenticators with user verification but encourages it.</p>
    pub fn get_user_verification(&self) -> &::std::option::Option<super::types::UserVerificationType> {
        &self.user_verification
    }
    /// <p>Sets whether passkeys can be used as multi-factor authentication (MFA). When set to <code>MULTI_FACTOR_WITH_USER_VERIFICATION</code>, passkey authentication with user verification satisfies MFA requirements. When set to <code>SINGLE_FACTOR</code> or not set, passkeys are a single authentication factor. To activate this setting, your user pool must be in the <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/feature-plans-features-essentials.html"> Essentials tier</a> or higher.</p>
    pub fn factor_configuration(mut self, input: super::types::WebAuthnFactorConfigurationType) -> Self {
        self.factor_configuration = ::std::option::Option::Some(input);
        self
    }
    /// <p>Sets whether passkeys can be used as multi-factor authentication (MFA). When set to <code>MULTI_FACTOR_WITH_USER_VERIFICATION</code>, passkey authentication with user verification satisfies MFA requirements. When set to <code>SINGLE_FACTOR</code> or not set, passkeys are a single authentication factor. To activate this setting, your user pool must be in the <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/feature-plans-features-essentials.html"> Essentials tier</a> or higher.</p>
    pub fn set_factor_configuration(mut self, input: ::std::option::Option<super::types::WebAuthnFactorConfigurationType>) -> Self {
        self.factor_configuration = input;
        self
    }
    /// <p>Sets whether passkeys can be used as multi-factor authentication (MFA). When set to <code>MULTI_FACTOR_WITH_USER_VERIFICATION</code>, passkey authentication with user verification satisfies MFA requirements. When set to <code>SINGLE_FACTOR</code> or not set, passkeys are a single authentication factor. To activate this setting, your user pool must be in the <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/feature-plans-features-essentials.html"> Essentials tier</a> or higher.</p>
    pub fn get_factor_configuration(&self) -> &::std::option::Option<super::types::WebAuthnFactorConfigurationType> {
    ...
    pub fn build(self) -> super::types::WebAuthnConfigurationType {
        super::types::WebAuthnConfigurationType {
