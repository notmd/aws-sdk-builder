...
impl EmailMfaConfigType {
    ...
    pub fn builder() -> super::types::builders::EmailMfaConfigTypeBuilder {
        super::types::builders::EmailMfaConfigTypeBuilder::default()
    }
}
...
impl EmailMfaConfigTypeBuilder {
    ...
    pub fn build(self) -> super::types::EmailMfaConfigType {
        super::types::EmailMfaConfigType {
