...
pub struct AccountTakeoverRiskConfigurationType {
    ...
    pub notify_configuration: ::std::option::Option<super::types::NotifyConfigurationType>,
    /// <p>A list of account-takeover actions for each level of risk that Amazon Cognito might assess with threat protection.</p>
    pub actions: ::std::option::Option<super::types::AccountTakeoverActionsType>,
}
impl AccountTakeoverRiskConfigurationType {
    /// <p>The settings for composing and sending an email message when threat protection assesses a risk level with adaptive authentication. When you choose to notify users in <code>AccountTakeoverRiskConfiguration</code>, Amazon Cognito sends an email message using the method and template that you set with this data type.</p>
    pub fn notify_configuration(&self) -> ::std::option::Option<&super::types::NotifyConfigurationType> {
        self.notify_configuration.as_ref()
    }
    /// <p>A list of account-takeover actions for each level of risk that Amazon Cognito might assess with threat protection.</p>
    pub fn actions(&self) -> ::std::option::Option<&super::types::AccountTakeoverActionsType> {
        self.actions.as_ref()
    }
}
impl AccountTakeoverRiskConfigurationType {
    ...
    pub fn builder() -> super::types::builders::AccountTakeoverRiskConfigurationTypeBuilder {
        super::types::builders::AccountTakeoverRiskConfigurationTypeBuilder::default()
    }
}
...
pub struct AccountTakeoverRiskConfigurationTypeBuilder {
    pub(crate) notify_configuration: ::std::option::Option<super::types::NotifyConfigurationType>,
    pub(crate) actions: ::std::option::Option<super::types::AccountTakeoverActionsType>,
}
impl AccountTakeoverRiskConfigurationTypeBuilder {
    /// <p>The settings for composing and sending an email message when threat protection assesses a risk level with adaptive authentication. When you choose to notify users in <code>AccountTakeoverRiskConfiguration</code>, Amazon Cognito sends an email message using the method and template that you set with this data type.</p>
    pub fn notify_configuration(mut self, input: super::types::NotifyConfigurationType) -> Self {
        self.notify_configuration = ::std::option::Option::Some(input);
        self
    }
    /// <p>The settings for composing and sending an email message when threat protection assesses a risk level with adaptive authentication. When you choose to notify users in <code>AccountTakeoverRiskConfiguration</code>, Amazon Cognito sends an email message using the method and template that you set with this data type.</p>
    pub fn set_notify_configuration(mut self, input: ::std::option::Option<super::types::NotifyConfigurationType>) -> Self {
        self.notify_configuration = input;
        self
    }
    /// <p>The settings for composing and sending an email message when threat protection assesses a risk level with adaptive authentication. When you choose to notify users in <code>AccountTakeoverRiskConfiguration</code>, Amazon Cognito sends an email message using the method and template that you set with this data type.</p>
    pub fn get_notify_configuration(&self) -> &::std::option::Option<super::types::NotifyConfigurationType> {
        &self.notify_configuration
    }
    /// <p>A list of account-takeover actions for each level of risk that Amazon Cognito might assess with threat protection.</p>
    /// This field is required.
    pub fn actions(mut self, input: super::types::AccountTakeoverActionsType) -> Self {
        self.actions = ::std::option::Option::Some(input);
        self
    }
    /// <p>A list of account-takeover actions for each level of risk that Amazon Cognito might assess with threat protection.</p>
    pub fn set_actions(mut self, input: ::std::option::Option<super::types::AccountTakeoverActionsType>) -> Self {
        self.actions = input;
        self
    }
    /// <p>A list of account-takeover actions for each level of risk that Amazon Cognito might assess with threat protection.</p>
    pub fn get_actions(&self) -> &::std::option::Option<super::types::AccountTakeoverActionsType> {
        &self.actions
    }
    ...
    pub fn build(self) -> super::types::AccountTakeoverRiskConfigurationType {
        super::types::AccountTakeoverRiskConfigurationType {
