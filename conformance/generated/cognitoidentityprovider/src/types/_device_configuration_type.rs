...
impl DeviceConfigurationType {
    ...
    pub fn builder() -> super::types::builders::DeviceConfigurationTypeBuilder {
        super::types::builders::DeviceConfigurationTypeBuilder::default()
    }
}
...
impl DeviceConfigurationTypeBuilder {
    ...
    pub fn build(self) -> super::types::DeviceConfigurationType {
        super::types::DeviceConfigurationType {
