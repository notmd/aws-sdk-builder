...
pub struct LambdaConfigType {
    ...
    pub pre_token_generation_config: ::std::option::Option<super::types::PreTokenGenerationVersionConfigType>,
    ...
    pub custom_sms_sender: ::std::option::Option<super::types::CustomSmsLambdaVersionConfigType>,
    ...
    pub custom_email_sender: ::std::option::Option<super::types::CustomEmailLambdaVersionConfigType>,
    ...
    pub inbound_federation: ::std::option::Option<super::types::InboundFederationLambdaType>,
}
impl LambdaConfigType {
    ...
    /// <p>The detailed configuration of a <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-lambda-pre-token-generation.html">pre token generation Lambda trigger</a> in a user pool. If you also set an ARN in <code>PreTokenGeneration</code>, its value must be identical to <code>PreTokenGenerationConfig</code>.</p>
    pub fn pre_token_generation_config(&self) -> ::std::option::Option<&super::types::PreTokenGenerationVersionConfigType> {
        self.pre_token_generation_config.as_ref()
    }
    /// <p>The configuration of a custom SMS sender Lambda trigger. This trigger routes all SMS notifications from a user pool to a Lambda function that delivers the message using custom logic.</p>
    pub fn custom_sms_sender(&self) -> ::std::option::Option<&super::types::CustomSmsLambdaVersionConfigType> {
        self.custom_sms_sender.as_ref()
    }
    /// <p>The configuration of a custom email sender Lambda trigger. This trigger routes all email notifications from a user pool to a Lambda function that delivers the message using custom logic.</p>
    pub fn custom_email_sender(&self) -> ::std::option::Option<&super::types::CustomEmailLambdaVersionConfigType> {
    ...
    /// <p>The configuration of an inbound federation Lambda trigger. This trigger can transform federated user attributes during the authentication with external identity providers.</p>
    pub fn inbound_federation(&self) -> ::std::option::Option<&super::types::InboundFederationLambdaType> {
...
impl LambdaConfigType {
    ...
    pub fn builder() -> super::types::builders::LambdaConfigTypeBuilder {
        super::types::builders::LambdaConfigTypeBuilder::default()
    }
}
...
pub struct LambdaConfigTypeBuilder {
    ...
    pub(crate) pre_token_generation_config: ::std::option::Option<super::types::PreTokenGenerationVersionConfigType>,
    pub(crate) custom_sms_sender: ::std::option::Option<super::types::CustomSmsLambdaVersionConfigType>,
    pub(crate) custom_email_sender: ::std::option::Option<super::types::CustomEmailLambdaVersionConfigType>,
    pub(crate) kms_key_id: ::std::option::Option<::std::string::String>,
    pub(crate) inbound_federation: ::std::option::Option<super::types::InboundFederationLambdaType>,
}
impl LambdaConfigTypeBuilder {
    ...
    /// <p>The detailed configuration of a <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-lambda-pre-token-generation.html">pre token generation Lambda trigger</a> in a user pool. If you also set an ARN in <code>PreTokenGeneration</code>, its value must be identical to <code>PreTokenGenerationConfig</code>.</p>
    pub fn pre_token_generation_config(mut self, input: super::types::PreTokenGenerationVersionConfigType) -> Self {
        self.pre_token_generation_config = ::std::option::Option::Some(input);
        self
    }
    /// <p>The detailed configuration of a <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-lambda-pre-token-generation.html">pre token generation Lambda trigger</a> in a user pool. If you also set an ARN in <code>PreTokenGeneration</code>, its value must be identical to <code>PreTokenGenerationConfig</code>.</p>
    pub fn set_pre_token_generation_config(mut self, input: ::std::option::Option<super::types::PreTokenGenerationVersionConfigType>) -> Self {
        self.pre_token_generation_config = input;
        self
    }
    /// <p>The detailed configuration of a <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-lambda-pre-token-generation.html">pre token generation Lambda trigger</a> in a user pool. If you also set an ARN in <code>PreTokenGeneration</code>, its value must be identical to <code>PreTokenGenerationConfig</code>.</p>
    pub fn get_pre_token_generation_config(&self) -> &::std::option::Option<super::types::PreTokenGenerationVersionConfigType> {
        &self.pre_token_generation_config
    }
    /// <p>The configuration of a custom SMS sender Lambda trigger. This trigger routes all SMS notifications from a user pool to a Lambda function that delivers the message using custom logic.</p>
    pub fn custom_sms_sender(mut self, input: super::types::CustomSmsLambdaVersionConfigType) -> Self {
        self.custom_sms_sender = ::std::option::Option::Some(input);
        self
    }
    /// <p>The configuration of a custom SMS sender Lambda trigger. This trigger routes all SMS notifications from a user pool to a Lambda function that delivers the message using custom logic.</p>
    pub fn set_custom_sms_sender(mut self, input: ::std::option::Option<super::types::CustomSmsLambdaVersionConfigType>) -> Self {
        self.custom_sms_sender = input;
        self
    }
    /// <p>The configuration of a custom SMS sender Lambda trigger. This trigger routes all SMS notifications from a user pool to a Lambda function that delivers the message using custom logic.</p>
    pub fn get_custom_sms_sender(&self) -> &::std::option::Option<super::types::CustomSmsLambdaVersionConfigType> {
        &self.custom_sms_sender
    }
    /// <p>The configuration of a custom email sender Lambda trigger. This trigger routes all email notifications from a user pool to a Lambda function that delivers the message using custom logic.</p>
    pub fn custom_email_sender(mut self, input: super::types::CustomEmailLambdaVersionConfigType) -> Self {
        self.custom_email_sender = ::std::option::Option::Some(input);
        self
    }
    /// <p>The configuration of a custom email sender Lambda trigger. This trigger routes all email notifications from a user pool to a Lambda function that delivers the message using custom logic.</p>
    pub fn set_custom_email_sender(mut self, input: ::std::option::Option<super::types::CustomEmailLambdaVersionConfigType>) -> Self {
        self.custom_email_sender = input;
        self
    }
    /// <p>The configuration of a custom email sender Lambda trigger. This trigger routes all email notifications from a user pool to a Lambda function that delivers the message using custom logic.</p>
    pub fn get_custom_email_sender(&self) -> &::std::option::Option<super::types::CustomEmailLambdaVersionConfigType> {
    ...
    /// <p>The configuration of an inbound federation Lambda trigger. This trigger can transform federated user attributes during the authentication with external identity providers.</p>
    pub fn inbound_federation(mut self, input: super::types::InboundFederationLambdaType) -> Self {
        self.inbound_federation = ::std::option::Option::Some(input);
        self
    }
    /// <p>The configuration of an inbound federation Lambda trigger. This trigger can transform federated user attributes during the authentication with external identity providers.</p>
    pub fn set_inbound_federation(mut self, input: ::std::option::Option<super::types::InboundFederationLambdaType>) -> Self {
        self.inbound_federation = input;
        self
    }
    /// <p>The configuration of an inbound federation Lambda trigger. This trigger can transform federated user attributes during the authentication with external identity providers.</p>
    pub fn get_inbound_federation(&self) -> &::std::option::Option<super::types::InboundFederationLambdaType> {
        &self.inbound_federation
    }
    /// Consumes the builder and constructs a [`LambdaConfigType`](crate::types::LambdaConfigType).
    pub fn build(self) -> super::types::LambdaConfigType {
        super::types::LambdaConfigType {
