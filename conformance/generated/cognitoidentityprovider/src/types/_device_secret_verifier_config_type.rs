...
impl DeviceSecretVerifierConfigType {
    ...
    pub fn builder() -> super::types::builders::DeviceSecretVerifierConfigTypeBuilder {
        super::types::builders::DeviceSecretVerifierConfigTypeBuilder::default()
    }
}
...
impl DeviceSecretVerifierConfigTypeBuilder {
    ...
    pub fn build(self) -> super::types::DeviceSecretVerifierConfigType {
        super::types::DeviceSecretVerifierConfigType {
