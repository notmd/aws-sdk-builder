...
pub struct EventRiskType {
    ...
    pub risk_decision: ::std::option::Option<super::types::RiskDecisionType>,
    /// <p>The risk level that adaptive authentication assessed for the authentication event.</p>
    pub risk_level: ::std::option::Option<super::types::RiskLevelType>,
...
impl EventRiskType {
    /// <p>The action taken by adaptive authentication. If <code>NoRisk</code>, your user pool took no action. If <code>AccountTakeover</code>, your user pool applied the adaptive authentication automated response that you configured. If <code>Block</code>, your user pool prevented the attempt.</p>
    pub fn risk_decision(&self) -> ::std::option::Option<&super::types::RiskDecisionType> {
        self.risk_decision.as_ref()
    }
    /// <p>The risk level that adaptive authentication assessed for the authentication event.</p>
    pub fn risk_level(&self) -> ::std::option::Option<&super::types::RiskLevelType> {
...
impl EventRiskType {
    ...
    pub fn builder() -> super::types::builders::EventRiskTypeBuilder {
        super::types::builders::EventRiskTypeBuilder::default()
    }
}
...
pub struct EventRiskTypeBuilder {
    pub(crate) risk_decision: ::std::option::Option<super::types::RiskDecisionType>,
    pub(crate) risk_level: ::std::option::Option<super::types::RiskLevelType>,
    pub(crate) compromised_credentials_detected: ::std::option::Option<bool>,
}
impl EventRiskTypeBuilder {
    /// <p>The action taken by adaptive authentication. If <code>NoRisk</code>, your user pool took no action. If <code>AccountTakeover</code>, your user pool applied the adaptive authentication automated response that you configured. If <code>Block</code>, your user pool prevented the attempt.</p>
    pub fn risk_decision(mut self, input: super::types::RiskDecisionType) -> Self {
        self.risk_decision = ::std::option::Option::Some(input);
        self
    }
    /// <p>The action taken by adaptive authentication. If <code>NoRisk</code>, your user pool took no action. If <code>AccountTakeover</code>, your user pool applied the adaptive authentication automated response that you configured. If <code>Block</code>, your user pool prevented the attempt.</p>
    pub fn set_risk_decision(mut self, input: ::std::option::Option<super::types::RiskDecisionType>) -> Self {
        self.risk_decision = input;
        self
    }
    /// <p>The action taken by adaptive authentication. If <code>NoRisk</code>, your user pool took no action. If <code>AccountTakeover</code>, your user pool applied the adaptive authentication automated response that you configured. If <code>Block</code>, your user pool prevented the attempt.</p>
    pub fn get_risk_decision(&self) -> &::std::option::Option<super::types::RiskDecisionType> {
        &self.risk_decision
    }
    /// <p>The risk level that adaptive authentication assessed for the authentication event.</p>
    pub fn risk_level(mut self, input: super::types::RiskLevelType) -> Self {
        self.risk_level = ::std::option::Option::Some(input);
        self
    }
    /// <p>The risk level that adaptive authentication assessed for the authentication event.</p>
    pub fn set_risk_level(mut self, input: ::std::option::Option<super::types::RiskLevelType>) -> Self {
        self.risk_level = input;
        self
    }
    /// <p>The risk level that adaptive authentication assessed for the authentication event.</p>
    pub fn get_risk_level(&self) -> &::std::option::Option<super::types::RiskLevelType> {
        &self.risk_level
    }
    /// <p>Indicates whether compromised credentials were detected during an authentication event.</p>
    ...
    pub fn build(self) -> super::types::EventRiskType {
        super::types::EventRiskType {
