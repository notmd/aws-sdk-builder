...
impl NewDeviceMetadataType {
    ...
    pub fn builder() -> super::types::builders::NewDeviceMetadataTypeBuilder {
        super::types::builders::NewDeviceMetadataTypeBuilder::default()
    }
}
...
impl NewDeviceMetadataTypeBuilder {
    ...
    pub fn build(self) -> super::types::NewDeviceMetadataType {
        super::types::NewDeviceMetadataType {
