...
pub struct CustomEmailLambdaVersionConfigType {
    ...
    pub lambda_version: super::types::CustomEmailSenderLambdaVersionType,
...
impl CustomEmailLambdaVersionConfigType {
    /// <p>The user pool trigger version of the request that Amazon Cognito sends to your Lambda function. Higher-numbered versions add fields that support new features.</p>
    /// <p>You must use a <code>LambdaVersion</code> of <code>V1_0</code> with a custom sender function.</p>
    pub fn lambda_version(&self) -> &super::types::CustomEmailSenderLambdaVersionType {
        &self.lambda_version
    }
    /// <p>The Amazon Resource Name (ARN) of the function that you want to assign to your Lambda trigger.</p>
...
impl CustomEmailLambdaVersionConfigType {
    ...
    pub fn builder() -> super::types::builders::CustomEmailLambdaVersionConfigTypeBuilder {
        super::types::builders::CustomEmailLambdaVersionConfigTypeBuilder::default()
    }
}
...
pub struct CustomEmailLambdaVersionConfigTypeBuilder {
    pub(crate) lambda_version: ::std::option::Option<super::types::CustomEmailSenderLambdaVersionType>,
...
impl CustomEmailLambdaVersionConfigTypeBuilder {
    ...
    pub fn lambda_version(mut self, input: super::types::CustomEmailSenderLambdaVersionType) -> Self {
        self.lambda_version = ::std::option::Option::Some(input);
        self
    }
    /// <p>The user pool trigger version of the request that Amazon Cognito sends to your Lambda function. Higher-numbered versions add fields that support new features.</p>
    /// <p>You must use a <code>LambdaVersion</code> of <code>V1_0</code> with a custom sender function.</p>
    pub fn set_lambda_version(mut self, input: ::std::option::Option<super::types::CustomEmailSenderLambdaVersionType>) -> Self {
        self.lambda_version = input;
        self
    }
    /// <p>The user pool trigger version of the request that Amazon Cognito sends to your Lambda function. Higher-numbered versions add fields that support new features.</p>
    /// <p>You must use a <code>LambdaVersion</code> of <code>V1_0</code> with a custom sender function.</p>
    pub fn get_lambda_version(&self) -> &::std::option::Option<super::types::CustomEmailSenderLambdaVersionType> {
        &self.lambda_version
    }
    /// <p>The Amazon Resource Name (ARN) of the function that you want to assign to your Lambda trigger.</p>
    /// This field is required.
    ...
    pub fn build(self) -> ::std::result::Result<super::types::CustomEmailLambdaVersionConfigType, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::CustomEmailLambdaVersionConfigType {
