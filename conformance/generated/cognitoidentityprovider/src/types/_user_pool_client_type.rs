...
impl UserPoolClientType {
    ...
    pub fn builder() -> super::types::builders::UserPoolClientTypeBuilder {
        super::types::builders::UserPoolClientTypeBuilder::default()
    }
}
...
impl UserPoolClientTypeBuilder {
    ...
    pub fn build(self) -> super::types::UserPoolClientType {
        super::types::UserPoolClientType {
