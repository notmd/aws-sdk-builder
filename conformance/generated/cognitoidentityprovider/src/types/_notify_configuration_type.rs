...
impl NotifyConfigurationType {
    ...
    /// <p>The template for the email message that your user pool sends when a detected risk event is blocked.</p>
    pub fn block_email(&self) -> ::std::option::Option<&super::types::NotifyEmailType> {
        self.block_email.as_ref()
    }
    /// <p>The template for the email message that your user pool sends when no action is taken in response to a detected risk.</p>
    pub fn no_action_email(&self) -> ::std::option::Option<&super::types::NotifyEmailType> {
        self.no_action_email.as_ref()
    }
    /// <p>The template for the email message that your user pool sends when MFA is challenged in response to a detected risk.</p>
    pub fn mfa_email(&self) -> ::std::option::Option<&super::types::NotifyEmailType> {
...
impl NotifyConfigurationType {
    ...
    pub fn builder() -> super::types::builders::NotifyConfigurationTypeBuilder {
        super::types::builders::NotifyConfigurationTypeBuilder::default()
    }
}
...
pub struct NotifyConfigurationTypeBuilder {
    ...
    pub(crate) block_email: ::std::option::Option<super::types::NotifyEmailType>,
    pub(crate) no_action_email: ::std::option::Option<super::types::NotifyEmailType>,
    pub(crate) mfa_email: ::std::option::Option<super::types::NotifyEmailType>,
}
impl NotifyConfigurationTypeBuilder {
    ...
    /// <p>The template for the email message that your user pool sends when a detected risk event is blocked.</p>
    pub fn block_email(mut self, input: super::types::NotifyEmailType) -> Self {
        self.block_email = ::std::option::Option::Some(input);
        self
    }
    /// <p>The template for the email message that your user pool sends when a detected risk event is blocked.</p>
    pub fn set_block_email(mut self, input: ::std::option::Option<super::types::NotifyEmailType>) -> Self {
        self.block_email = input;
        self
    }
    /// <p>The template for the email message that your user pool sends when a detected risk event is blocked.</p>
    pub fn get_block_email(&self) -> &::std::option::Option<super::types::NotifyEmailType> {
        &self.block_email
    }
    /// <p>The template for the email message that your user pool sends when no action is taken in response to a detected risk.</p>
    pub fn no_action_email(mut self, input: super::types::NotifyEmailType) -> Self {
        self.no_action_email = ::std::option::Option::Some(input);
        self
    }
    /// <p>The template for the email message that your user pool sends when no action is taken in response to a detected risk.</p>
    pub fn set_no_action_email(mut self, input: ::std::option::Option<super::types::NotifyEmailType>) -> Self {
        self.no_action_email = input;
        self
    }
    /// <p>The template for the email message that your user pool sends when no action is taken in response to a detected risk.</p>
    pub fn get_no_action_email(&self) -> &::std::option::Option<super::types::NotifyEmailType> {
        &self.no_action_email
    }
    /// <p>The template for the email message that your user pool sends when MFA is challenged in response to a detected risk.</p>
    pub fn mfa_email(mut self, input: super::types::NotifyEmailType) -> Self {
        self.mfa_email = ::std::option::Option::Some(input);
        self
    }
    /// <p>The template for the email message that your user pool sends when MFA is challenged in response to a detected risk.</p>
    pub fn set_mfa_email(mut self, input: ::std::option::Option<super::types::NotifyEmailType>) -> Self {
        self.mfa_email = input;
        self
    }
    /// <p>The template for the email message that your user pool sends when MFA is challenged in response to a detected risk.</p>
    pub fn get_mfa_email(&self) -> &::std::option::Option<super::types::NotifyEmailType> {
        &self.mfa_email
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::types::NotifyConfigurationType, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::NotifyConfigurationType {
            from: self.from,
