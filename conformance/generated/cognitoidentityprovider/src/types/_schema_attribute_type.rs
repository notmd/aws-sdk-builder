...
pub struct SchemaAttributeType {
    ...
    pub attribute_data_type: ::std::option::Option<super::types::AttributeDataType>,
    /// <note>
    ...
    pub string_attribute_constraints: ::std::option::Option<super::types::StringAttributeConstraintsType>,
}
impl SchemaAttributeType {
    ...
    /// <p>The data format of the values for your attribute. When you choose an <code>AttributeDataType</code>, Amazon Cognito validates the input against the data type. A custom attribute value in your user's ID token is always a string, for example <code>"custom:isMember" : "true"</code> or <code>"custom:YearsAsMember" : "12"</code>.</p>
    pub fn attribute_data_type(&self) -> ::std::option::Option<&super::types::AttributeDataType> {
    ...
    /// <p>Specifies the constraints for an attribute of the number type.</p>
    pub fn number_attribute_constraints(&self) -> ::std::option::Option<&super::types::NumberAttributeConstraintsType> {
        self.number_attribute_constraints.as_ref()
    }
    /// <p>Specifies the constraints for an attribute of the string type.</p>
    pub fn string_attribute_constraints(&self) -> ::std::option::Option<&super::types::StringAttributeConstraintsType> {
...
impl SchemaAttributeType {
    ...
    pub fn builder() -> super::types::builders::SchemaAttributeTypeBuilder {
        super::types::builders::SchemaAttributeTypeBuilder::default()
    }
}
...
pub struct SchemaAttributeTypeBuilder {
    ...
    pub(crate) attribute_data_type: ::std::option::Option<super::types::AttributeDataType>,
    pub(crate) developer_only_attribute: ::std::option::Option<bool>,
    pub(crate) mutable: ::std::option::Option<bool>,
    pub(crate) required: ::std::option::Option<bool>,
    pub(crate) number_attribute_constraints: ::std::option::Option<super::types::NumberAttributeConstraintsType>,
    pub(crate) string_attribute_constraints: ::std::option::Option<super::types::StringAttributeConstraintsType>,
}
impl SchemaAttributeTypeBuilder {
    ...
    /// <p>The data format of the values for your attribute. When you choose an <code>AttributeDataType</code>, Amazon Cognito validates the input against the data type. A custom attribute value in your user's ID token is always a string, for example <code>"custom:isMember" : "true"</code> or <code>"custom:YearsAsMember" : "12"</code>.</p>
    pub fn attribute_data_type(mut self, input: super::types::AttributeDataType) -> Self {
        self.attribute_data_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The data format of the values for your attribute. When you choose an <code>AttributeDataType</code>, Amazon Cognito validates the input against the data type. A custom attribute value in your user's ID token is always a string, for example <code>"custom:isMember" : "true"</code> or <code>"custom:YearsAsMember" : "12"</code>.</p>
    pub fn set_attribute_data_type(mut self, input: ::std::option::Option<super::types::AttributeDataType>) -> Self {
        self.attribute_data_type = input;
        self
    }
    /// <p>The data format of the values for your attribute. When you choose an <code>AttributeDataType</code>, Amazon Cognito validates the input against the data type. A custom attribute value in your user's ID token is always a string, for example <code>"custom:isMember" : "true"</code> or <code>"custom:YearsAsMember" : "12"</code>.</p>
    pub fn get_attribute_data_type(&self) -> &::std::option::Option<super::types::AttributeDataType> {
    ...
    /// <p>Specifies the constraints for an attribute of the number type.</p>
    pub fn number_attribute_constraints(mut self, input: super::types::NumberAttributeConstraintsType) -> Self {
        self.number_attribute_constraints = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies the constraints for an attribute of the number type.</p>
    pub fn set_number_attribute_constraints(mut self, input: ::std::option::Option<super::types::NumberAttributeConstraintsType>) -> Self {
        self.number_attribute_constraints = input;
        self
    }
    /// <p>Specifies the constraints for an attribute of the number type.</p>
    pub fn get_number_attribute_constraints(&self) -> &::std::option::Option<super::types::NumberAttributeConstraintsType> {
        &self.number_attribute_constraints
    }
    /// <p>Specifies the constraints for an attribute of the string type.</p>
    pub fn string_attribute_constraints(mut self, input: super::types::StringAttributeConstraintsType) -> Self {
        self.string_attribute_constraints = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies the constraints for an attribute of the string type.</p>
    pub fn set_string_attribute_constraints(mut self, input: ::std::option::Option<super::types::StringAttributeConstraintsType>) -> Self {
        self.string_attribute_constraints = input;
        self
    }
    /// <p>Specifies the constraints for an attribute of the string type.</p>
    pub fn get_string_attribute_constraints(&self) -> &::std::option::Option<super::types::StringAttributeConstraintsType> {
    ...
    pub fn build(self) -> super::types::SchemaAttributeType {
