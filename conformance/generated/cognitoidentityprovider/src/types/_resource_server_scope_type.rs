...
impl ResourceServerScopeType {
    ...
    pub fn builder() -> super::types::builders::ResourceServerScopeTypeBuilder {
        super::types::builders::ResourceServerScopeTypeBuilder::default()
    }
}
...
impl ResourceServerScopeTypeBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::ResourceServerScopeType, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ResourceServerScopeType {
