...
impl ResourceServerType {
    ...
    pub fn builder() -> super::types::builders::ResourceServerTypeBuilder {
        super::types::builders::ResourceServerTypeBuilder::default()
    }
}
...
impl ResourceServerTypeBuilder {
    ...
    pub fn build(self) -> super::types::ResourceServerType {
