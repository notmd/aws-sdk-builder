...
impl EventContextDataType {
    ...
    pub fn builder() -> super::types::builders::EventContextDataTypeBuilder {
        super::types::builders::EventContextDataTypeBuilder::default()
    }
}
...
impl EventContextDataTypeBuilder {
    ...
    pub fn build(self) -> super::types::EventContextDataType {
        super::types::EventContextDataType {
