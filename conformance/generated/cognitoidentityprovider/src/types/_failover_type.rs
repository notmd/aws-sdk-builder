...
impl FailoverType {
    ...
    pub fn builder() -> super::types::builders::FailoverTypeBuilder {
        super::types::builders::FailoverTypeBuilder::default()
    }
}
...
impl FailoverTypeBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::FailoverType, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::FailoverType {
