...
impl AttributeType {
    ...
    pub fn builder() -> super::types::builders::AttributeTypeBuilder {
        super::types::builders::AttributeTypeBuilder::default()
    }
}
...
impl AttributeTypeBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::AttributeType, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::AttributeType {
