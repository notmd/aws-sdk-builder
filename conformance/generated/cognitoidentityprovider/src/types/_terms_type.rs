...
pub struct TermsType {
    ...
    pub terms_source: super::types::TermsSourceType,
    /// <p>This parameter is reserved for future use and currently accepts one value.</p>
    pub enforcement: super::types::TermsEnforcementType,
...
impl TermsType {
    ...
    /// <p>This parameter is reserved for future use and currently accepts one value.</p>
    pub fn terms_source(&self) -> &super::types::TermsSourceType {
        &self.terms_source
    }
    /// <p>This parameter is reserved for future use and currently accepts one value.</p>
    pub fn enforcement(&self) -> &super::types::TermsEnforcementType {
        &self.enforcement
    }
    /// <p>A map of URLs to languages. For each localized language that will view the requested <code>TermsName</code>, assign a URL. A selection of <code>cognito:default</code> displays for all languages that don't have a language-specific URL.</p>
    /// <p>For example, <code>"cognito:default": "https://terms.example.com", "cognito:spanish": "https://terms.example.com/es"</code>.</p>
...
impl TermsType {
    ...
    pub fn builder() -> super::types::builders::TermsTypeBuilder {
        super::types::builders::TermsTypeBuilder::default()
    }
}
...
impl TermsTypeBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::TermsType, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::TermsType {
