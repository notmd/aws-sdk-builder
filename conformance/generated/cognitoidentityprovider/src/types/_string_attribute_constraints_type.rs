...
impl StringAttributeConstraintsType {
    ...
    pub fn builder() -> super::types::builders::StringAttributeConstraintsTypeBuilder {
        super::types::builders::StringAttributeConstraintsTypeBuilder::default()
    }
}
...
impl StringAttributeConstraintsTypeBuilder {
    ...
    pub fn build(self) -> super::types::StringAttributeConstraintsType {
        super::types::StringAttributeConstraintsType {
