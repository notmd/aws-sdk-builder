...
impl ProviderDescription {
    ...
    pub fn builder() -> super::types::builders::ProviderDescriptionBuilder {
        super::types::builders::ProviderDescriptionBuilder::default()
    }
}
...
impl ProviderDescriptionBuilder {
    ...
    pub fn build(self) -> super::types::ProviderDescription {
