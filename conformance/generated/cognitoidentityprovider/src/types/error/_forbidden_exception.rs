...
impl ::aws_types::request_id::RequestId for super::types::error::ForbiddenException {
...
impl ForbiddenException {
    ...
    pub fn builder() -> super::types::error::builders::ForbiddenExceptionBuilder {
        super::types::error::builders::ForbiddenExceptionBuilder::default()
    }
}
...
impl ForbiddenExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::ForbiddenException {
        super::types::error::ForbiddenException {
