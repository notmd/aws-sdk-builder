...
impl ::aws_types::request_id::RequestId for super::types::error::PreconditionNotMetException {
...
impl PreconditionNotMetException {
    ...
    pub fn builder() -> super::types::error::builders::PreconditionNotMetExceptionBuilder {
        super::types::error::builders::PreconditionNotMetExceptionBuilder::default()
    }
}
...
impl PreconditionNotMetExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::PreconditionNotMetException {
        super::types::error::PreconditionNotMetException {
