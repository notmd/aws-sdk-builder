...
impl ::aws_types::request_id::RequestId for super::types::error::WebAuthnRelyingPartyMismatchException {
...
impl WebAuthnRelyingPartyMismatchException {
    ...
    pub fn builder() -> super::types::error::builders::WebAuthnRelyingPartyMismatchExceptionBuilder {
        super::types::error::builders::WebAuthnRelyingPartyMismatchExceptionBuilder::default()
    }
}
...
impl WebAuthnRelyingPartyMismatchExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::WebAuthnRelyingPartyMismatchException {
        super::types::error::WebAuthnRelyingPartyMismatchException {
