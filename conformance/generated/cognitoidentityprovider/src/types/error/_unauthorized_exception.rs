...
impl ::aws_types::request_id::RequestId for super::types::error::UnauthorizedException {
...
impl UnauthorizedException {
    ...
    pub fn builder() -> super::types::error::builders::UnauthorizedExceptionBuilder {
        super::types::error::builders::UnauthorizedExceptionBuilder::default()
    }
}
...
impl UnauthorizedExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::UnauthorizedException {
        super::types::error::UnauthorizedException {
