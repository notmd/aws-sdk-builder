...
impl EumsSmsConfigurationType {
    ...
    pub fn builder() -> super::types::builders::EumsSmsConfigurationTypeBuilder {
        super::types::builders::EumsSmsConfigurationTypeBuilder::default()
    }
}
...
impl EumsSmsConfigurationTypeBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::EumsSmsConfigurationType, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::EumsSmsConfigurationType {
