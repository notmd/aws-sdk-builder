...
pub struct UserPoolType {
    ...
    pub schema_attributes: ::std::option::Option<::std::vec::Vec<super::types::SchemaAttributeType>>,
...
impl UserPoolType {
    ...
    pub fn schema_attributes(&self) -> &[super::types::SchemaAttributeType] {
...
impl UserPoolType {
    ...
    pub fn builder() -> super::types::builders::UserPoolTypeBuilder {
        super::types::builders::UserPoolTypeBuilder::default()
    }
}
...
pub struct UserPoolTypeBuilder {
    ...
    pub(crate) schema_attributes: ::std::option::Option<::std::vec::Vec<super::types::SchemaAttributeType>>,
...
impl UserPoolTypeBuilder {
    ...
    /// <p>A list of the user attributes and their properties in your user pool. The attribute schema contains standard attributes, custom attributes with a <code>custom:</code> prefix, and developer attributes with a <code>dev:</code> prefix. For more information, see <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-settings-attributes.html">User pool attributes</a>.</p>
    /// <p>Developer-only attributes are a legacy feature of user pools, and are read-only to all app clients. You can create and update developer-only attributes only with IAM-authenticated API operations. Use app client read/write permissions instead.</p>
    pub fn schema_attributes(mut self, input: super::types::SchemaAttributeType) -> Self {
    ...
    /// <p>A list of the user attributes and their properties in your user pool. The attribute schema contains standard attributes, custom attributes with a <code>custom:</code> prefix, and developer attributes with a <code>dev:</code> prefix. For more information, see <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-settings-attributes.html">User pool attributes</a>.</p>
    /// <p>Developer-only attributes are a legacy feature of user pools, and are read-only to all app clients. You can create and update developer-only attributes only with IAM-authenticated API operations. Use app client read/write permissions instead.</p>
    pub fn set_schema_attributes(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::SchemaAttributeType>>) -> Self {
        self.schema_attributes = input;
        self
    }
    /// <p>A list of the user attributes and their properties in your user pool. The attribute schema contains standard attributes, custom attributes with a <code>custom:</code> prefix, and developer attributes with a <code>dev:</code> prefix. For more information, see <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-settings-attributes.html">User pool attributes</a>.</p>
    /// <p>Developer-only attributes are a legacy feature of user pools, and are read-only to all app clients. You can create and update developer-only attributes only with IAM-authenticated API operations. Use app client read/write permissions instead.</p>
    pub fn get_schema_attributes(&self) -> &::std::option::Option<::std::vec::Vec<super::types::SchemaAttributeType>> {
    ...
    pub fn build(self) -> super::types::UserPoolType {
        super::types::UserPoolType {
            id: self.id,
            name: self.name,
