...
impl AnalyticsConfigurationType {
    ...
    pub fn builder() -> super::types::builders::AnalyticsConfigurationTypeBuilder {
        super::types::builders::AnalyticsConfigurationTypeBuilder::default()
    }
}
...
impl AnalyticsConfigurationTypeBuilder {
    ...
    pub fn build(self) -> super::types::AnalyticsConfigurationType {
        super::types::AnalyticsConfigurationType {
