...
impl PasswordPolicyType {
    ...
    pub fn builder() -> super::types::builders::PasswordPolicyTypeBuilder {
        super::types::builders::PasswordPolicyTypeBuilder::default()
    }
}
...
impl PasswordPolicyTypeBuilder {
    ...
    pub fn build(self) -> super::types::PasswordPolicyType {
        super::types::PasswordPolicyType {
