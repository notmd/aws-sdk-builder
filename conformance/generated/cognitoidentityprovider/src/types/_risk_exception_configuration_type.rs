...
impl RiskExceptionConfigurationType {
    ...
    pub fn builder() -> super::types::builders::RiskExceptionConfigurationTypeBuilder {
        super::types::builders::RiskExceptionConfigurationTypeBuilder::default()
    }
}
...
impl RiskExceptionConfigurationTypeBuilder {
    ...
    pub fn build(self) -> super::types::RiskExceptionConfigurationType {
        super::types::RiskExceptionConfigurationType {
