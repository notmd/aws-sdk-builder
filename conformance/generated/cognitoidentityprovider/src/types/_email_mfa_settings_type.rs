...
impl EmailMfaSettingsType {
    ...
    pub fn builder() -> super::types::builders::EmailMfaSettingsTypeBuilder {
        super::types::builders::EmailMfaSettingsTypeBuilder::default()
    }
}
...
impl EmailMfaSettingsTypeBuilder {
    ...
    pub fn build(self) -> super::types::EmailMfaSettingsType {
        super::types::EmailMfaSettingsType {
