...
impl SmsMfaSettingsType {
    ...
    pub fn builder() -> super::types::builders::SmsMfaSettingsTypeBuilder {
        super::types::builders::SmsMfaSettingsTypeBuilder::default()
    }
}
...
impl SmsMfaSettingsTypeBuilder {
    ...
    pub fn build(self) -> super::types::SmsMfaSettingsType {
        super::types::SmsMfaSettingsType {
