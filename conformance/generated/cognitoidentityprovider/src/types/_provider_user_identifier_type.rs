...
impl ProviderUserIdentifierType {
    ...
    pub fn builder() -> super::types::builders::ProviderUserIdentifierTypeBuilder {
        super::types::builders::ProviderUserIdentifierTypeBuilder::default()
    }
}
...
impl ProviderUserIdentifierTypeBuilder {
    ...
    pub fn build(self) -> super::types::ProviderUserIdentifierType {
        super::types::ProviderUserIdentifierType {
