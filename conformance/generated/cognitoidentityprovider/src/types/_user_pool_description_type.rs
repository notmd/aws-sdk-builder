...
impl UserPoolDescriptionType {
    ...
    pub fn builder() -> super::types::builders::UserPoolDescriptionTypeBuilder {
        super::types::builders::UserPoolDescriptionTypeBuilder::default()
    }
}
...
impl UserPoolDescriptionTypeBuilder {
    ...
    pub fn build(self) -> super::types::UserPoolDescriptionType {
