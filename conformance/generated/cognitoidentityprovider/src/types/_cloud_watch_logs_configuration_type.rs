...
impl CloudWatchLogsConfigurationType {
    ...
    pub fn builder() -> super::types::builders::CloudWatchLogsConfigurationTypeBuilder {
        super::types::builders::CloudWatchLogsConfigurationTypeBuilder::default()
    }
}
...
impl CloudWatchLogsConfigurationTypeBuilder {
    ...
    pub fn build(self) -> super::types::CloudWatchLogsConfigurationType {
        super::types::CloudWatchLogsConfigurationType {
