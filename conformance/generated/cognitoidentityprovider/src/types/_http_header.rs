...
impl HttpHeader {
    ...
    pub fn builder() -> super::types::builders::HttpHeaderBuilder {
        super::types::builders::HttpHeaderBuilder::default()
    }
}
...
impl HttpHeaderBuilder {
    ...
    pub fn build(self) -> super::types::HttpHeader {
        super::types::HttpHeader {
