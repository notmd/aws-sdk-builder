...
pub struct ManagedLoginBrandingType {
    ...
    /// <p>When true, applies the default branding style options. This option reverts to default style options that are managed by Amazon Cognito. You can modify them later in the branding editor.</p>
...
impl ManagedLoginBrandingType {
    ...
    pub fn assets(&self) -> &[super::types::AssetType] {
...
impl ManagedLoginBrandingType {
    ...
    pub fn builder() -> super::types::builders::ManagedLoginBrandingTypeBuilder {
        super::types::builders::ManagedLoginBrandingTypeBuilder::default()
    }
}
...
impl ManagedLoginBrandingTypeBuilder {
    ...
    pub fn build(self) -> super::types::ManagedLoginBrandingType {
        super::types::ManagedLoginBrandingType {
