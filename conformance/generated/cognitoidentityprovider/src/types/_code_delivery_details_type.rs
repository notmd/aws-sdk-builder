...
pub struct CodeDeliveryDetailsType {
    ...
    pub delivery_medium: ::std::option::Option<super::types::DeliveryMediumType>,
...
impl CodeDeliveryDetailsType {
    ...
    /// <p>The method that Amazon Cognito used to send the code.</p>
    pub fn delivery_medium(&self) -> ::std::option::Option<&super::types::DeliveryMediumType> {
...
impl CodeDeliveryDetailsType {
    ...
    pub fn builder() -> super::types::builders::CodeDeliveryDetailsTypeBuilder {
        super::types::builders::CodeDeliveryDetailsTypeBuilder::default()
    }
}
...
pub struct CodeDeliveryDetailsTypeBuilder {
    ...
    pub(crate) delivery_medium: ::std::option::Option<super::types::DeliveryMediumType>,
...
impl CodeDeliveryDetailsTypeBuilder {
    ...
    /// <p>The method that Amazon Cognito used to send the code.</p>
    pub fn delivery_medium(mut self, input: super::types::DeliveryMediumType) -> Self {
        self.delivery_medium = ::std::option::Option::Some(input);
        self
    }
    /// <p>The method that Amazon Cognito used to send the code.</p>
    pub fn set_delivery_medium(mut self, input: ::std::option::Option<super::types::DeliveryMediumType>) -> Self {
        self.delivery_medium = input;
        self
    }
    /// <p>The method that Amazon Cognito used to send the code.</p>
    pub fn get_delivery_medium(&self) -> &::std::option::Option<super::types::DeliveryMediumType> {
    ...
    pub fn build(self) -> super::types::CodeDeliveryDetailsType {
        super::types::CodeDeliveryDetailsType {
