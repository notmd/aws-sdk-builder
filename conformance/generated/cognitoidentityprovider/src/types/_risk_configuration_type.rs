...
impl RiskConfigurationType {
    ...
    pub fn builder() -> super::types::builders::RiskConfigurationTypeBuilder {
        super::types::builders::RiskConfigurationTypeBuilder::default()
    }
}
...
impl RiskConfigurationTypeBuilder {
    ...
    pub fn build(self) -> super::types::RiskConfigurationType {
        super::types::RiskConfigurationType {
