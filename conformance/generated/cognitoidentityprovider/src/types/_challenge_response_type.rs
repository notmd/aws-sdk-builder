...
pub struct ChallengeResponseType {
    ...
    pub challenge_name: ::std::option::Option<super::types::ChallengeName>,
    /// <p>The set of key-value pairs that provides a response to the requested challenge.</p>
    pub challenge_response: ::std::option::Option<super::types::ChallengeResponse>,
}
impl ChallengeResponseType {
    /// <p>The type of challenge that your previous authentication request returned in the parameter <code>ChallengeName</code>, for example <code>SMS_MFA</code>.</p>
    pub fn challenge_name(&self) -> ::std::option::Option<&super::types::ChallengeName> {
        self.challenge_name.as_ref()
    }
    /// <p>The set of key-value pairs that provides a response to the requested challenge.</p>
    pub fn challenge_response(&self) -> ::std::option::Option<&super::types::ChallengeResponse> {
...
impl ChallengeResponseType {
    ...
    pub fn builder() -> super::types::builders::ChallengeResponseTypeBuilder {
        super::types::builders::ChallengeResponseTypeBuilder::default()
    }
}
...
pub struct ChallengeResponseTypeBuilder {
    pub(crate) challenge_name: ::std::option::Option<super::types::ChallengeName>,
    pub(crate) challenge_response: ::std::option::Option<super::types::ChallengeResponse>,
}
impl ChallengeResponseTypeBuilder {
    /// <p>The type of challenge that your previous authentication request returned in the parameter <code>ChallengeName</code>, for example <code>SMS_MFA</code>.</p>
    pub fn challenge_name(mut self, input: super::types::ChallengeName) -> Self {
        self.challenge_name = ::std::option::Option::Some(input);
        self
    }
    /// <p>The type of challenge that your previous authentication request returned in the parameter <code>ChallengeName</code>, for example <code>SMS_MFA</code>.</p>
    pub fn set_challenge_name(mut self, input: ::std::option::Option<super::types::ChallengeName>) -> Self {
        self.challenge_name = input;
        self
    }
    /// <p>The type of challenge that your previous authentication request returned in the parameter <code>ChallengeName</code>, for example <code>SMS_MFA</code>.</p>
    pub fn get_challenge_name(&self) -> &::std::option::Option<super::types::ChallengeName> {
        &self.challenge_name
    }
    /// <p>The set of key-value pairs that provides a response to the requested challenge.</p>
    pub fn challenge_response(mut self, input: super::types::ChallengeResponse) -> Self {
        self.challenge_response = ::std::option::Option::Some(input);
        self
    }
    /// <p>The set of key-value pairs that provides a response to the requested challenge.</p>
    pub fn set_challenge_response(mut self, input: ::std::option::Option<super::types::ChallengeResponse>) -> Self {
        self.challenge_response = input;
        self
    }
    /// <p>The set of key-value pairs that provides a response to the requested challenge.</p>
    pub fn get_challenge_response(&self) -> &::std::option::Option<super::types::ChallengeResponse> {
        &self.challenge_response
    }
    /// Consumes the builder and constructs a [`ChallengeResponseType`](crate::types::ChallengeResponseType).
    pub fn build(self) -> super::types::ChallengeResponseType {
        super::types::ChallengeResponseType {
