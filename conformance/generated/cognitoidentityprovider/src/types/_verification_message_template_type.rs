...
pub struct VerificationMessageTemplateType {
    ...
    pub default_email_option: ::std::option::Option<super::types::DefaultEmailOptionType>,
}
impl VerificationMessageTemplateType {
    ...
    /// <p>The configuration of verification emails to contain a clickable link or a verification code.</p>
    /// <p>For link, your template body must contain link text in the format <code>{##Click here##}</code>. "Click here" in the example is a customizable string. For code, your template body must contain a code placeholder in the format <code>{####}</code>.</p>
    pub fn default_email_option(&self) -> ::std::option::Option<&super::types::DefaultEmailOptionType> {
...
impl VerificationMessageTemplateType {
    ...
    pub fn builder() -> super::types::builders::VerificationMessageTemplateTypeBuilder {
        super::types::builders::VerificationMessageTemplateTypeBuilder::default()
    }
}
...
pub struct VerificationMessageTemplateTypeBuilder {
    ...
    pub(crate) default_email_option: ::std::option::Option<super::types::DefaultEmailOptionType>,
}
impl VerificationMessageTemplateTypeBuilder {
    ...
    /// <p>The configuration of verification emails to contain a clickable link or a verification code.</p>
    /// <p>For link, your template body must contain link text in the format <code>{##Click here##}</code>. "Click here" in the example is a customizable string. For code, your template body must contain a code placeholder in the format <code>{####}</code>.</p>
    pub fn default_email_option(mut self, input: super::types::DefaultEmailOptionType) -> Self {
        self.default_email_option = ::std::option::Option::Some(input);
        self
    }
    /// <p>The configuration of verification emails to contain a clickable link or a verification code.</p>
    /// <p>For link, your template body must contain link text in the format <code>{##Click here##}</code>. "Click here" in the example is a customizable string. For code, your template body must contain a code placeholder in the format <code>{####}</code>.</p>
    pub fn set_default_email_option(mut self, input: ::std::option::Option<super::types::DefaultEmailOptionType>) -> Self {
        self.default_email_option = input;
        self
    }
    /// <p>The configuration of verification emails to contain a clickable link or a verification code.</p>
    /// <p>For link, your template body must contain link text in the format <code>{##Click here##}</code>. "Click here" in the example is a customizable string. For code, your template body must contain a code placeholder in the format <code>{####}</code>.</p>
    pub fn get_default_email_option(&self) -> &::std::option::Option<super::types::DefaultEmailOptionType> {
    ...
    pub fn build(self) -> super::types::VerificationMessageTemplateType {
        super::types::VerificationMessageTemplateType {
