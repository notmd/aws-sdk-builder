...
impl IdentityProviderType {
    ...
    pub fn builder() -> super::types::builders::IdentityProviderTypeBuilder {
        super::types::builders::IdentityProviderTypeBuilder::default()
    }
}
...
impl IdentityProviderTypeBuilder {
    ...
    pub fn build(self) -> super::types::IdentityProviderType {
        super::types::IdentityProviderType {
