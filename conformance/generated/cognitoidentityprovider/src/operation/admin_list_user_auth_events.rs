    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::admin_list_user_auth_events::AdminListUserAuthEventsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::admin_list_user_auth_events::AdminListUserAuthEventsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AdminListUserAuthEventsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_admin_list_user_auth_events::de_admin_list_user_auth_events_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_admin_list_user_auth_events::de_admin_list_user_auth_events_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AdminListUserAuthEventsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::admin_list_user_auth_events::AdminListUserAuthEventsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::admin_list_user_auth_events::AdminListUserAuthEventsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_admin_list_user_auth_events::ser_admin_list_user_auth_events_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::admin_list_user_auth_events::AdminListUserAuthEventsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::admin_list_user_auth_events::_admin_list_user_auth_events_input::AdminListUserAuthEventsInput;

pub use super::operation::admin_list_user_auth_events::_admin_list_user_auth_events_output::AdminListUserAuthEventsOutput;
