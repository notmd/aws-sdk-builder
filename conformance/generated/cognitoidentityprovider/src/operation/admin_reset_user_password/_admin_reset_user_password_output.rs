...
impl AdminResetUserPasswordOutput {
    ...
    pub fn builder() -> super::operation::admin_reset_user_password::builders::AdminResetUserPasswordOutputBuilder {
        super::operation::admin_reset_user_password::builders::AdminResetUserPasswordOutputBuilder::default()
    }
}
...
impl AdminResetUserPasswordOutputBuilder {
    ...
    pub fn build(self) -> super::operation::admin_reset_user_password::AdminResetUserPasswordOutput {
