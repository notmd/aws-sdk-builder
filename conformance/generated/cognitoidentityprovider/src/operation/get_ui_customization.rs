    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_ui_customization::GetUICustomizationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_ui_customization::GetUiCustomizationOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetUICustomizationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_ui_customization::de_get_ui_customization_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_ui_customization::de_get_ui_customization_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetUICustomizationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_ui_customization::GetUiCustomizationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_ui_customization::GetUiCustomizationInput,
        ...
        let body =
            ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_get_ui_customization::ser_get_ui_customization_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::get_ui_customization::GetUICustomizationError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_ui_customization::_get_ui_customization_input::GetUiCustomizationInput;

pub use super::operation::get_ui_customization::_get_ui_customization_output::GetUiCustomizationOutput;
