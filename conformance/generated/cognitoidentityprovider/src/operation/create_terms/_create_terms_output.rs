...
impl CreateTermsOutput {
    ...
    pub fn builder() -> super::operation::create_terms::builders::CreateTermsOutputBuilder {
        super::operation::create_terms::builders::CreateTermsOutputBuilder::default()
    }
}
...
impl CreateTermsOutputBuilder {
    ...
    pub fn build(self) -> super::operation::create_terms::CreateTermsOutput {
