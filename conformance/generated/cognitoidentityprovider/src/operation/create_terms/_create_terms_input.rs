...
impl CreateTermsInput {
    ...
    pub fn builder() -> super::operation::create_terms::builders::CreateTermsInputBuilder {
        super::operation::create_terms::builders::CreateTermsInputBuilder::default()
    }
}
...
impl CreateTermsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::create_terms::CreateTermsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::create_terms::CreateTermsInput {
