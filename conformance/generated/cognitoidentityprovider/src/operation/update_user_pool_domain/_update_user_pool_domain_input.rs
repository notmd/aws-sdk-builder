...
impl UpdateUserPoolDomainInput {
    ...
    pub fn builder() -> super::operation::update_user_pool_domain::builders::UpdateUserPoolDomainInputBuilder {
        super::operation::update_user_pool_domain::builders::UpdateUserPoolDomainInputBuilder::default()
    }
}
...
impl UpdateUserPoolDomainInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::update_user_pool_domain::UpdateUserPoolDomainInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::update_user_pool_domain::UpdateUserPoolDomainInput {
            domain: self.domain,
