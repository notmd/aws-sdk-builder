...
impl AdminGetDeviceInput {
    ...
    pub fn builder() -> super::operation::admin_get_device::builders::AdminGetDeviceInputBuilder {
        super::operation::admin_get_device::builders::AdminGetDeviceInputBuilder::default()
    }
}
...
impl AdminGetDeviceInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::admin_get_device::AdminGetDeviceInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::admin_get_device::AdminGetDeviceInput {
