    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_identity_providers::ListIdentityProvidersError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_identity_providers::ListIdentityProvidersOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListIdentityProvidersResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_identity_providers::de_list_identity_providers_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_identity_providers::de_list_identity_providers_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListIdentityProvidersRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_identity_providers::ListIdentityProvidersInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_identity_providers::ListIdentityProvidersInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_list_identity_providers::ser_list_identity_providers_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::operation::list_identity_providers::ListIdentityProvidersError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_identity_providers::_list_identity_providers_input::ListIdentityProvidersInput;

pub use super::operation::list_identity_providers::_list_identity_providers_output::ListIdentityProvidersOutput;
