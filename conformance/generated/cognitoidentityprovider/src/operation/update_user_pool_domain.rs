    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::update_user_pool_domain::UpdateUserPoolDomainError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::update_user_pool_domain::UpdateUserPoolDomainOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateUserPoolDomainResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_update_user_pool_domain::de_update_user_pool_domain_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_update_user_pool_domain::de_update_user_pool_domain_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateUserPoolDomainRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::update_user_pool_domain::UpdateUserPoolDomainInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::update_user_pool_domain::UpdateUserPoolDomainInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_update_user_pool_domain::ser_update_user_pool_domain_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::operation::update_user_pool_domain::UpdateUserPoolDomainError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::update_user_pool_domain::_update_user_pool_domain_input::UpdateUserPoolDomainInput;

pub use super::operation::update_user_pool_domain::_update_user_pool_domain_output::UpdateUserPoolDomainOutput;
