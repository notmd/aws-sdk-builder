    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::update_identity_provider::UpdateIdentityProviderError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::update_identity_provider::UpdateIdentityProviderOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateIdentityProviderResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_update_identity_provider::de_update_identity_provider_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_update_identity_provider::de_update_identity_provider_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateIdentityProviderRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::update_identity_provider::UpdateIdentityProviderInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::update_identity_provider::UpdateIdentityProviderInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_update_identity_provider::ser_update_identity_provider_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::update_identity_provider::UpdateIdentityProviderError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::update_identity_provider::_update_identity_provider_input::UpdateIdentityProviderInput;

pub use super::operation::update_identity_provider::_update_identity_provider_output::UpdateIdentityProviderOutput;
