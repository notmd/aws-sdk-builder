...
impl ForgotPasswordInput {
    ...
    pub fn builder() -> super::operation::forgot_password::builders::ForgotPasswordInputBuilder {
        super::operation::forgot_password::builders::ForgotPasswordInputBuilder::default()
    }
}
...
impl ForgotPasswordInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::forgot_password::ForgotPasswordInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::forgot_password::ForgotPasswordInput {
