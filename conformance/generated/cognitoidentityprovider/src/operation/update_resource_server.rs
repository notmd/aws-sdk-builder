    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::update_resource_server::UpdateResourceServerError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::update_resource_server::UpdateResourceServerOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateResourceServerResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_update_resource_server::de_update_resource_server_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_update_resource_server::de_update_resource_server_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateResourceServerRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::update_resource_server::UpdateResourceServerInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::update_resource_server::UpdateResourceServerInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_update_resource_server::ser_update_resource_server_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::operation::update_resource_server::UpdateResourceServerError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::update_resource_server::_update_resource_server_input::UpdateResourceServerInput;

pub use super::operation::update_resource_server::_update_resource_server_output::UpdateResourceServerOutput;
