    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::create_user_pool_client::CreateUserPoolClientError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::create_user_pool_client::CreateUserPoolClientOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateUserPoolClientResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_create_user_pool_client::de_create_user_pool_client_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_create_user_pool_client::de_create_user_pool_client_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateUserPoolClientRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::create_user_pool_client::CreateUserPoolClientInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::create_user_pool_client::CreateUserPoolClientInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_create_user_pool_client::ser_create_user_pool_client_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::operation::create_user_pool_client::CreateUserPoolClientError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::create_user_pool_client::_create_user_pool_client_input::CreateUserPoolClientInput;

pub use super::operation::create_user_pool_client::_create_user_pool_client_output::CreateUserPoolClientOutput;
