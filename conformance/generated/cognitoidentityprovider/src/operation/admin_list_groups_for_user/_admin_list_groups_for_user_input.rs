...
impl AdminListGroupsForUserInput {
    ...
    pub fn builder() -> super::operation::admin_list_groups_for_user::builders::AdminListGroupsForUserInputBuilder {
        super::operation::admin_list_groups_for_user::builders::AdminListGroupsForUserInputBuilder::default()
    }
}
...
impl AdminListGroupsForUserInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::admin_list_groups_for_user::AdminListGroupsForUserInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::admin_list_groups_for_user::AdminListGroupsForUserInput {
