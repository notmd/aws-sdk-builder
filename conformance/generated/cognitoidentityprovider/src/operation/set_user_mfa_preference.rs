    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::set_user_mfa_preference::SetUserMFAPreferenceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::set_user_mfa_preference::SetUserMfaPreferenceOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetUserMFAPreferenceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_set_user_mfa_preference::de_set_user_mfa_preference_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_set_user_mfa_preference::de_set_user_mfa_preference_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetUserMFAPreferenceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::set_user_mfa_preference::SetUserMfaPreferenceInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::set_user_mfa_preference::SetUserMfaPreferenceInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_set_user_mfa_preference::ser_set_user_mfa_preference_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::operation::set_user_mfa_preference::SetUserMFAPreferenceError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::set_user_mfa_preference::_set_user_mfa_preference_input::SetUserMfaPreferenceInput;

pub use super::operation::set_user_mfa_preference::_set_user_mfa_preference_output::SetUserMfaPreferenceOutput;
