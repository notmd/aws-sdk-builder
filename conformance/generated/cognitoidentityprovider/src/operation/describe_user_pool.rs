...
impl DescribeUserPool {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::operation::describe_user_pool::DescribeUserPoolOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::describe_user_pool::DescribeUserPoolError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::describe_user_pool::DescribeUserPoolError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::describe_user_pool::DescribeUserPoolOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeUserPoolResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_describe_user_pool::de_describe_user_pool_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_describe_user_pool::de_describe_user_pool_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeUserPoolRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::describe_user_pool::DescribeUserPoolInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::describe_user_pool::DescribeUserPoolInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_describe_user_pool::ser_describe_user_pool_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::describe_user_pool::DescribeUserPoolError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::describe_user_pool::_describe_user_pool_input::DescribeUserPoolInput;

pub use super::operation::describe_user_pool::_describe_user_pool_output::DescribeUserPoolOutput;
