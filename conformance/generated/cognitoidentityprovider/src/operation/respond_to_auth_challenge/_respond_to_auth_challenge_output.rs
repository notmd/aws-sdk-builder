...
impl RespondToAuthChallengeOutput {
    ...
    pub fn builder() -> super::operation::respond_to_auth_challenge::builders::RespondToAuthChallengeOutputBuilder {
        super::operation::respond_to_auth_challenge::builders::RespondToAuthChallengeOutputBuilder::default()
    }
}
...
impl RespondToAuthChallengeOutputBuilder {
    ...
    pub fn build(self) -> super::operation::respond_to_auth_challenge::RespondToAuthChallengeOutput {
