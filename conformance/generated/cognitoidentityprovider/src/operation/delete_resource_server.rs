    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_resource_server::DeleteResourceServerError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_resource_server::DeleteResourceServerOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteResourceServerResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_resource_server::de_delete_resource_server_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_resource_server::de_delete_resource_server_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteResourceServerRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_resource_server::DeleteResourceServerInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_resource_server::DeleteResourceServerInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_delete_resource_server::ser_delete_resource_server_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::operation::delete_resource_server::DeleteResourceServerError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_resource_server::_delete_resource_server_input::DeleteResourceServerInput;

pub use super::operation::delete_resource_server::_delete_resource_server_output::DeleteResourceServerOutput;
