...
impl DeleteManagedLoginBrandingInput {
    ...
    pub fn builder() -> super::operation::delete_managed_login_branding::builders::DeleteManagedLoginBrandingInputBuilder {
        super::operation::delete_managed_login_branding::builders::DeleteManagedLoginBrandingInputBuilder::default()
    }
}
...
impl DeleteManagedLoginBrandingInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::delete_managed_login_branding::DeleteManagedLoginBrandingInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::delete_managed_login_branding::DeleteManagedLoginBrandingInput {
