    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_resource_servers::ListResourceServersError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_resource_servers::ListResourceServersOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListResourceServersResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_resource_servers::de_list_resource_servers_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_resource_servers::de_list_resource_servers_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListResourceServersRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_resource_servers::ListResourceServersInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_resource_servers::ListResourceServersInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_list_resource_servers::ser_list_resource_servers_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::operation::list_resource_servers::ListResourceServersError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_resource_servers::_list_resource_servers_input::ListResourceServersInput;

pub use super::operation::list_resource_servers::_list_resource_servers_output::ListResourceServersOutput;
