    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::forget_device::ForgetDeviceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::forget_device::ForgetDeviceOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ForgetDeviceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_forget_device::de_forget_device_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_forget_device::de_forget_device_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ForgetDeviceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::forget_device::ForgetDeviceInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::forget_device::ForgetDeviceInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_forget_device::ser_forget_device_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::forget_device::ForgetDeviceError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::forget_device::_forget_device_input::ForgetDeviceInput;

pub use super::operation::forget_device::_forget_device_output::ForgetDeviceOutput;
