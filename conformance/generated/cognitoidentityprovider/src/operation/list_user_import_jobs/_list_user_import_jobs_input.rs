...
impl ListUserImportJobsInput {
    ...
    pub fn builder() -> super::operation::list_user_import_jobs::builders::ListUserImportJobsInputBuilder {
        super::operation::list_user_import_jobs::builders::ListUserImportJobsInputBuilder::default()
    }
}
...
impl ListUserImportJobsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_user_import_jobs::ListUserImportJobsInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::list_user_import_jobs::ListUserImportJobsInput {
