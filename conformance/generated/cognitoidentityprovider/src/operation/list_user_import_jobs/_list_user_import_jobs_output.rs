...
pub struct ListUserImportJobsOutput {
    ...
    pub user_import_jobs: ::std::option::Option<::std::vec::Vec<super::types::UserImportJobType>>,
...
impl ListUserImportJobsOutput {
    ...
    pub fn user_import_jobs(&self) -> &[super::types::UserImportJobType] {
...
impl ListUserImportJobsOutput {
    ...
    pub fn builder() -> super::operation::list_user_import_jobs::builders::ListUserImportJobsOutputBuilder {
        super::operation::list_user_import_jobs::builders::ListUserImportJobsOutputBuilder::default()
    }
}
...
pub struct ListUserImportJobsOutputBuilder {
    pub(crate) user_import_jobs: ::std::option::Option<::std::vec::Vec<super::types::UserImportJobType>>,
...
impl ListUserImportJobsOutputBuilder {
    ...
    ///
    /// <p>An array of user import jobs from the requested user pool. For each, the response includes logging destination, status, and the Amazon S3 pre-signed URL for CSV upload.</p>
    pub fn user_import_jobs(mut self, input: super::types::UserImportJobType) -> Self {
    ...
    /// <p>An array of user import jobs from the requested user pool. For each, the response includes logging destination, status, and the Amazon S3 pre-signed URL for CSV upload.</p>
    pub fn set_user_import_jobs(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::UserImportJobType>>) -> Self {
        self.user_import_jobs = input;
        self
    }
    /// <p>An array of user import jobs from the requested user pool. For each, the response includes logging destination, status, and the Amazon S3 pre-signed URL for CSV upload.</p>
    pub fn get_user_import_jobs(&self) -> &::std::option::Option<::std::vec::Vec<super::types::UserImportJobType>> {
    ...
    pub fn build(self) -> super::operation::list_user_import_jobs::ListUserImportJobsOutput {
