    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::create_identity_provider::CreateIdentityProviderError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::create_identity_provider::CreateIdentityProviderOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateIdentityProviderResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_create_identity_provider::de_create_identity_provider_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_create_identity_provider::de_create_identity_provider_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateIdentityProviderRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::create_identity_provider::CreateIdentityProviderInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::create_identity_provider::CreateIdentityProviderInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_create_identity_provider::ser_create_identity_provider_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::create_identity_provider::CreateIdentityProviderError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::create_identity_provider::_create_identity_provider_input::CreateIdentityProviderInput;

pub use super::operation::create_identity_provider::_create_identity_provider_output::CreateIdentityProviderOutput;
