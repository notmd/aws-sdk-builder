...
pub struct CreateResourceServerInput {
    ...
    pub scopes: ::std::option::Option<::std::vec::Vec<super::types::ResourceServerScopeType>>,
}
impl CreateResourceServerInput {
    ...
    pub fn scopes(&self) -> &[super::types::ResourceServerScopeType] {
...
impl CreateResourceServerInput {
    ...
    pub fn builder() -> super::operation::create_resource_server::builders::CreateResourceServerInputBuilder {
        super::operation::create_resource_server::builders::CreateResourceServerInputBuilder::default()
    }
}
...
pub struct CreateResourceServerInputBuilder {
    ...
    pub(crate) scopes: ::std::option::Option<::std::vec::Vec<super::types::ResourceServerScopeType>>,
}
impl CreateResourceServerInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::create_resource_server::CreateResourceServerInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::create_resource_server::CreateResourceServerInput {
