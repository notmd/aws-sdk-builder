...
pub use super::operation::create_resource_server::_create_resource_server_input::CreateResourceServerInputBuilder;

pub use super::operation::create_resource_server::_create_resource_server_output::CreateResourceServerOutputBuilder;

impl super::operation::create_resource_server::builders::CreateResourceServerInputBuilder {
...
pub struct CreateResourceServerFluentBuilder {
    ...
    inner: super::operation::create_resource_server::builders::CreateResourceServerInputBuilder,
...
impl CreateResourceServerFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::create_resource_server::builders::CreateResourceServerInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::create_resource_server::CreateResourceServer::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::create_resource_server::CreateResourceServer::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn scopes(mut self, input: super::types::ResourceServerScopeType) -> Self {
        self.inner = self.inner.scopes(input);
        self
    }
    /// <p>A list of custom scopes. Each scope is a key-value map with the keys <code>ScopeName</code> and <code>ScopeDescription</code>. The name of a custom scope is a combination of <code>ScopeName</code> and the resource server <code>Name</code> in this request, for example <code>MyResourceServerName/MyScopeName</code>.</p>
    pub fn set_scopes(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::ResourceServerScopeType>>) -> Self {
        self.inner = self.inner.set_scopes(input);
        self
    }
    /// <p>A list of custom scopes. Each scope is a key-value map with the keys <code>ScopeName</code> and <code>ScopeDescription</code>. The name of a custom scope is a combination of <code>ScopeName</code> and the resource server <code>Name</code> in this request, for example <code>MyResourceServerName/MyScopeName</code>.</p>
    pub fn get_scopes(&self) -> &::std::option::Option<::std::vec::Vec<super::types::ResourceServerScopeType>> {
