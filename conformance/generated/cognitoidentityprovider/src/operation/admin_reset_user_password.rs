    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::admin_reset_user_password::AdminResetUserPasswordError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::admin_reset_user_password::AdminResetUserPasswordOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AdminResetUserPasswordResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_admin_reset_user_password::de_admin_reset_user_password_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_admin_reset_user_password::de_admin_reset_user_password_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AdminResetUserPasswordRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::admin_reset_user_password::AdminResetUserPasswordInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::admin_reset_user_password::AdminResetUserPasswordInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_admin_reset_user_password::ser_admin_reset_user_password_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::admin_reset_user_password::AdminResetUserPasswordError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::admin_reset_user_password::_admin_reset_user_password_input::AdminResetUserPasswordInput;

pub use super::operation::admin_reset_user_password::_admin_reset_user_password_output::AdminResetUserPasswordOutput;
