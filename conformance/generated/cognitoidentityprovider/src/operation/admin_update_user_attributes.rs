    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::admin_update_user_attributes::AdminUpdateUserAttributesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::admin_update_user_attributes::AdminUpdateUserAttributesOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AdminUpdateUserAttributesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_admin_update_user_attributes::de_admin_update_user_attributes_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_admin_update_user_attributes::de_admin_update_user_attributes_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AdminUpdateUserAttributesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::admin_update_user_attributes::AdminUpdateUserAttributesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::admin_update_user_attributes::AdminUpdateUserAttributesInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_admin_update_user_attributes::ser_admin_update_user_attributes_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::admin_update_user_attributes::AdminUpdateUserAttributesError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::admin_update_user_attributes::_admin_update_user_attributes_input::AdminUpdateUserAttributesInput;

pub use super::operation::admin_update_user_attributes::_admin_update_user_attributes_output::AdminUpdateUserAttributesOutput;
