...
impl AdminSetUserSettingsInput {
    ...
    pub fn builder() -> super::operation::admin_set_user_settings::builders::AdminSetUserSettingsInputBuilder {
        super::operation::admin_set_user_settings::builders::AdminSetUserSettingsInputBuilder::default()
    }
}
...
impl AdminSetUserSettingsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::admin_set_user_settings::AdminSetUserSettingsInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::admin_set_user_settings::AdminSetUserSettingsInput {
