...
impl AdminListDevices {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::operation::admin_list_devices::AdminListDevicesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::admin_list_devices::AdminListDevicesError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::admin_list_devices::AdminListDevicesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::admin_list_devices::AdminListDevicesOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AdminListDevicesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_admin_list_devices::de_admin_list_devices_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_admin_list_devices::de_admin_list_devices_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AdminListDevicesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::admin_list_devices::AdminListDevicesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::admin_list_devices::AdminListDevicesInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_admin_list_devices::ser_admin_list_devices_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::admin_list_devices::AdminListDevicesError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::admin_list_devices::_admin_list_devices_input::AdminListDevicesInput;

pub use super::operation::admin_list_devices::_admin_list_devices_output::AdminListDevicesOutput;
