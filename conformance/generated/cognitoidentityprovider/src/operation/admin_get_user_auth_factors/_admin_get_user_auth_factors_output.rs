...
pub struct AdminGetUserAuthFactorsOutput {
    ...
    pub configured_user_auth_factors: ::std::option::Option<::std::vec::Vec<super::types::AuthFactorType>>,
...
impl AdminGetUserAuthFactorsOutput {
    ...
    pub fn configured_user_auth_factors(&self) -> &[super::types::AuthFactorType] {
...
impl ::std::fmt::Debug for AdminGetUserAuthFactorsOutput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("AdminGetUserAuthFactorsOutput");
...
impl ::aws_types::request_id::RequestId for AdminGetUserAuthFactorsOutput {
...
impl AdminGetUserAuthFactorsOutput {
    ...
    pub fn builder() -> super::operation::admin_get_user_auth_factors::builders::AdminGetUserAuthFactorsOutputBuilder {
        super::operation::admin_get_user_auth_factors::builders::AdminGetUserAuthFactorsOutputBuilder::default()
    }
}

/// A builder for [`AdminGetUserAuthFactorsOutput`](crate::operation::admin_get_user_auth_factors::AdminGetUserAuthFactorsOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default)]
#[non_exhaustive]
pub struct AdminGetUserAuthFactorsOutputBuilder {
    ...
    pub(crate) configured_user_auth_factors: ::std::option::Option<::std::vec::Vec<super::types::AuthFactorType>>,
    _request_id: Option<String>,
}
impl AdminGetUserAuthFactorsOutputBuilder {
    ...
    /// <p>The authentication types that are available to the user with <code>USER_AUTH</code> sign-in, for example <code>\["PASSWORD", "WEB_AUTHN"\]</code>.</p>
    /// <p><code>PASSWORD</code> can only be used as a first authentication factor. <code>SOFTWARE_TOKEN</code> can only be used as an MFA factor. <code>EMAIL_OTP</code>, <code>SMS_OTP</code>, and <code>WEB_AUTHN</code> can be used as either a first authentication factor or an MFA factor. <code>WEB_AUTHN</code> is available as an MFA factor only when passkey MFA is enabled at the user pool level.</p>
    pub fn configured_user_auth_factors(mut self, input: super::types::AuthFactorType) -> Self {
    ...
    /// <p>The authentication types that are available to the user with <code>USER_AUTH</code> sign-in, for example <code>\["PASSWORD", "WEB_AUTHN"\]</code>.</p>
    /// <p><code>PASSWORD</code> can only be used as a first authentication factor. <code>SOFTWARE_TOKEN</code> can only be used as an MFA factor. <code>EMAIL_OTP</code>, <code>SMS_OTP</code>, and <code>WEB_AUTHN</code> can be used as either a first authentication factor or an MFA factor. <code>WEB_AUTHN</code> is available as an MFA factor only when passkey MFA is enabled at the user pool level.</p>
    pub fn set_configured_user_auth_factors(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::AuthFactorType>>) -> Self {
        self.configured_user_auth_factors = input;
        self
    }
    /// <p>The authentication types that are available to the user with <code>USER_AUTH</code> sign-in, for example <code>\["PASSWORD", "WEB_AUTHN"\]</code>.</p>
    /// <p><code>PASSWORD</code> can only be used as a first authentication factor. <code>SOFTWARE_TOKEN</code> can only be used as an MFA factor. <code>EMAIL_OTP</code>, <code>SMS_OTP</code>, and <code>WEB_AUTHN</code> can be used as either a first authentication factor or an MFA factor. <code>WEB_AUTHN</code> is available as an MFA factor only when passkey MFA is enabled at the user pool level.</p>
    pub fn get_configured_user_auth_factors(&self) -> &::std::option::Option<::std::vec::Vec<super::types::AuthFactorType>> {
    ...
    /// Consumes the builder and constructs a [`AdminGetUserAuthFactorsOutput`](crate::operation::admin_get_user_auth_factors::AdminGetUserAuthFactorsOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`username`](crate::operation::admin_get_user_auth_factors::builders::AdminGetUserAuthFactorsOutputBuilder::username)
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(super::operation::admin_get_user_auth_factors::AdminGetUserAuthFactorsOutput {
...
impl ::std::fmt::Debug for AdminGetUserAuthFactorsOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("AdminGetUserAuthFactorsOutputBuilder");
        formatter.field("username", &"*** Sensitive Data Redacted ***");
        formatter.field("preferred_mfa_setting", &self.preferred_mfa_setting);
        formatter.field("user_mfa_setting_list", &self.user_mfa_setting_list);
        formatter.field("configured_user_auth_factors", &self.configured_user_auth_factors);
