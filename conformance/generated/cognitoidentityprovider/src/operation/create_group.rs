...
impl CreateGroup {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::operation::create_group::CreateGroupOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::create_group::CreateGroupError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::create_group::CreateGroupError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::create_group::CreateGroupOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateGroupResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_create_group::de_create_group_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_create_group::de_create_group_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateGroupRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::create_group::CreateGroupInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::create_group::CreateGroupInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_create_group::ser_create_group_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::create_group::CreateGroupError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::create_group::_create_group_input::CreateGroupInput;

pub use super::operation::create_group::_create_group_output::CreateGroupOutput;
