...
impl DescribeManagedLoginBrandingInput {
    ...
    pub fn builder() -> super::operation::describe_managed_login_branding::builders::DescribeManagedLoginBrandingInputBuilder {
        super::operation::describe_managed_login_branding::builders::DescribeManagedLoginBrandingInputBuilder::default()
    }
}
...
impl DescribeManagedLoginBrandingInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::describe_managed_login_branding::DescribeManagedLoginBrandingInput,
