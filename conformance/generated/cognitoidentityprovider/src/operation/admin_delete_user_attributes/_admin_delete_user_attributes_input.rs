...
impl AdminDeleteUserAttributesInput {
    ...
    pub fn builder() -> super::operation::admin_delete_user_attributes::builders::AdminDeleteUserAttributesInputBuilder {
        super::operation::admin_delete_user_attributes::builders::AdminDeleteUserAttributesInputBuilder::default()
    }
}
...
impl AdminDeleteUserAttributesInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::admin_delete_user_attributes::AdminDeleteUserAttributesInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::admin_delete_user_attributes::AdminDeleteUserAttributesInput {
