...
impl AdminDeleteUserAttributesOutput {
    ...
    pub fn builder() -> super::operation::admin_delete_user_attributes::builders::AdminDeleteUserAttributesOutputBuilder {
        super::operation::admin_delete_user_attributes::builders::AdminDeleteUserAttributesOutputBuilder::default()
    }
}
...
impl AdminDeleteUserAttributesOutputBuilder {
    ...
    pub fn build(self) -> super::operation::admin_delete_user_attributes::AdminDeleteUserAttributesOutput {
