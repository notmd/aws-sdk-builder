...
impl DeleteWebAuthnCredentialInput {
    ...
    pub fn builder() -> super::operation::delete_web_authn_credential::builders::DeleteWebAuthnCredentialInputBuilder {
        super::operation::delete_web_authn_credential::builders::DeleteWebAuthnCredentialInputBuilder::default()
    }
}
...
impl DeleteWebAuthnCredentialInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::delete_web_authn_credential::DeleteWebAuthnCredentialInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::delete_web_authn_credential::DeleteWebAuthnCredentialInput {
