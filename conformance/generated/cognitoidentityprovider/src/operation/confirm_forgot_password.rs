    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::confirm_forgot_password::ConfirmForgotPasswordError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::confirm_forgot_password::ConfirmForgotPasswordOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ConfirmForgotPasswordResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_confirm_forgot_password::de_confirm_forgot_password_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_confirm_forgot_password::de_confirm_forgot_password_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ConfirmForgotPasswordRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::confirm_forgot_password::ConfirmForgotPasswordInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::confirm_forgot_password::ConfirmForgotPasswordInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_confirm_forgot_password::ser_confirm_forgot_password_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::operation::confirm_forgot_password::ConfirmForgotPasswordError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::confirm_forgot_password::_confirm_forgot_password_input::ConfirmForgotPasswordInput;

pub use super::operation::confirm_forgot_password::_confirm_forgot_password_output::ConfirmForgotPasswordOutput;
