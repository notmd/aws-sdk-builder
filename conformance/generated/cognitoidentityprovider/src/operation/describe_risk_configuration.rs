    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::describe_risk_configuration::DescribeRiskConfigurationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::describe_risk_configuration::DescribeRiskConfigurationOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeRiskConfigurationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_describe_risk_configuration::de_describe_risk_configuration_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_describe_risk_configuration::de_describe_risk_configuration_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeRiskConfigurationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::describe_risk_configuration::DescribeRiskConfigurationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::describe_risk_configuration::DescribeRiskConfigurationInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_describe_risk_configuration::ser_describe_risk_configuration_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::describe_risk_configuration::DescribeRiskConfigurationError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::describe_risk_configuration::_describe_risk_configuration_input::DescribeRiskConfigurationInput;

pub use super::operation::describe_risk_configuration::_describe_risk_configuration_output::DescribeRiskConfigurationOutput;
