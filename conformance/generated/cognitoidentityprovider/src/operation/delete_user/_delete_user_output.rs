...
impl DeleteUserOutput {
    ...
    pub fn builder() -> super::operation::delete_user::builders::DeleteUserOutputBuilder {
        super::operation::delete_user::builders::DeleteUserOutputBuilder::default()
    }
}
...
impl DeleteUserOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_user::DeleteUserOutput {
