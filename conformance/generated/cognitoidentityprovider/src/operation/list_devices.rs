...
impl ListDevices {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::operation::list_devices::ListDevicesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::list_devices::ListDevicesError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_devices::ListDevicesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_devices::ListDevicesOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListDevicesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_devices::de_list_devices_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_devices::de_list_devices_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListDevicesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_devices::ListDevicesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_devices::ListDevicesInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_list_devices::ser_list_devices_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::list_devices::ListDevicesError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_devices::_list_devices_input::ListDevicesInput;

pub use super::operation::list_devices::_list_devices_output::ListDevicesOutput;
