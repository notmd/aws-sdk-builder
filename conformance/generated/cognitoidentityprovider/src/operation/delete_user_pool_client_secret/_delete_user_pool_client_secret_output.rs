...
impl DeleteUserPoolClientSecretOutput {
    ...
    pub fn builder() -> super::operation::delete_user_pool_client_secret::builders::DeleteUserPoolClientSecretOutputBuilder {
        super::operation::delete_user_pool_client_secret::builders::DeleteUserPoolClientSecretOutputBuilder::default()
    }
}
...
impl DeleteUserPoolClientSecretOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_user_pool_client_secret::DeleteUserPoolClientSecretOutput {
