...
impl DeleteUserPoolDomainInput {
    ...
    pub fn builder() -> super::operation::delete_user_pool_domain::builders::DeleteUserPoolDomainInputBuilder {
        super::operation::delete_user_pool_domain::builders::DeleteUserPoolDomainInputBuilder::default()
    }
}
...
impl DeleteUserPoolDomainInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::delete_user_pool_domain::DeleteUserPoolDomainInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::delete_user_pool_domain::DeleteUserPoolDomainInput {
            domain: self.domain,
