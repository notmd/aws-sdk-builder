...
impl DeleteUserPoolDomainOutput {
    ...
    pub fn builder() -> super::operation::delete_user_pool_domain::builders::DeleteUserPoolDomainOutputBuilder {
        super::operation::delete_user_pool_domain::builders::DeleteUserPoolDomainOutputBuilder::default()
    }
}
...
impl DeleteUserPoolDomainOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_user_pool_domain::DeleteUserPoolDomainOutput {
