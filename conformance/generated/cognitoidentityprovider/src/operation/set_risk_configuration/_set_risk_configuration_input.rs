...
pub struct SetRiskConfigurationInput {
    ...
    pub compromised_credentials_risk_configuration: ::std::option::Option<super::types::CompromisedCredentialsRiskConfigurationType>,
    /// <p>The settings for automated responses and notification templates for adaptive authentication with threat protection.</p>
    pub account_takeover_risk_configuration: ::std::option::Option<super::types::AccountTakeoverRiskConfigurationType>,
    /// <p>A set of IP-address overrides to threat protection. You can set up IP-address always-block and always-allow lists.</p>
    pub risk_exception_configuration: ::std::option::Option<super::types::RiskExceptionConfigurationType>,
}
impl SetRiskConfigurationInput {
    ...
    /// <p>The configuration of automated reactions to detected compromised credentials. Includes settings for blocking future sign-in requests and for the types of password-submission events you want to monitor.</p>
    pub fn compromised_credentials_risk_configuration(&self) -> ::std::option::Option<&super::types::CompromisedCredentialsRiskConfigurationType> {
        self.compromised_credentials_risk_configuration.as_ref()
    }
    /// <p>The settings for automated responses and notification templates for adaptive authentication with threat protection.</p>
    pub fn account_takeover_risk_configuration(&self) -> ::std::option::Option<&super::types::AccountTakeoverRiskConfigurationType> {
        self.account_takeover_risk_configuration.as_ref()
    }
    /// <p>A set of IP-address overrides to threat protection. You can set up IP-address always-block and always-allow lists.</p>
    pub fn risk_exception_configuration(&self) -> ::std::option::Option<&super::types::RiskExceptionConfigurationType> {
...
impl SetRiskConfigurationInput {
    ...
    pub fn builder() -> super::operation::set_risk_configuration::builders::SetRiskConfigurationInputBuilder {
        super::operation::set_risk_configuration::builders::SetRiskConfigurationInputBuilder::default()
    }
}
...
pub struct SetRiskConfigurationInputBuilder {
    ...
    pub(crate) compromised_credentials_risk_configuration: ::std::option::Option<super::types::CompromisedCredentialsRiskConfigurationType>,
    pub(crate) account_takeover_risk_configuration: ::std::option::Option<super::types::AccountTakeoverRiskConfigurationType>,
    pub(crate) risk_exception_configuration: ::std::option::Option<super::types::RiskExceptionConfigurationType>,
}
impl SetRiskConfigurationInputBuilder {
    ...
    /// <p>The configuration of automated reactions to detected compromised credentials. Includes settings for blocking future sign-in requests and for the types of password-submission events you want to monitor.</p>
    pub fn compromised_credentials_risk_configuration(mut self, input: super::types::CompromisedCredentialsRiskConfigurationType) -> Self {
    ...
    pub fn set_compromised_credentials_risk_configuration(
        mut self,
        input: ::std::option::Option<super::types::CompromisedCredentialsRiskConfigurationType>,
    ) -> Self {
    ...
    pub fn get_compromised_credentials_risk_configuration(
        &self,
    ) -> &::std::option::Option<super::types::CompromisedCredentialsRiskConfigurationType> {
        &self.compromised_credentials_risk_configuration
    }
    /// <p>The settings for automated responses and notification templates for adaptive authentication with threat protection.</p>
    pub fn account_takeover_risk_configuration(mut self, input: super::types::AccountTakeoverRiskConfigurationType) -> Self {
    ...
    pub fn set_account_takeover_risk_configuration(
        mut self,
        input: ::std::option::Option<super::types::AccountTakeoverRiskConfigurationType>,
    ) -> Self {
        self.account_takeover_risk_configuration = input;
        self
    }
    /// <p>The settings for automated responses and notification templates for adaptive authentication with threat protection.</p>
    pub fn get_account_takeover_risk_configuration(&self) -> &::std::option::Option<super::types::AccountTakeoverRiskConfigurationType> {
        &self.account_takeover_risk_configuration
    }
    /// <p>A set of IP-address overrides to threat protection. You can set up IP-address always-block and always-allow lists.</p>
    pub fn risk_exception_configuration(mut self, input: super::types::RiskExceptionConfigurationType) -> Self {
        self.risk_exception_configuration = ::std::option::Option::Some(input);
        self
    }
    /// <p>A set of IP-address overrides to threat protection. You can set up IP-address always-block and always-allow lists.</p>
    pub fn set_risk_exception_configuration(mut self, input: ::std::option::Option<super::types::RiskExceptionConfigurationType>) -> Self {
        self.risk_exception_configuration = input;
        self
    }
    /// <p>A set of IP-address overrides to threat protection. You can set up IP-address always-block and always-allow lists.</p>
    pub fn get_risk_exception_configuration(&self) -> &::std::option::Option<super::types::RiskExceptionConfigurationType> {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::set_risk_configuration::SetRiskConfigurationInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::set_risk_configuration::SetRiskConfigurationInput {
