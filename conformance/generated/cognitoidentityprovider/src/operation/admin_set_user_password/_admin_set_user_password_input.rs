...
impl AdminSetUserPasswordInput {
    ...
    pub fn builder() -> super::operation::admin_set_user_password::builders::AdminSetUserPasswordInputBuilder {
        super::operation::admin_set_user_password::builders::AdminSetUserPasswordInputBuilder::default()
    }
}
...
impl AdminSetUserPasswordInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::admin_set_user_password::AdminSetUserPasswordInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::admin_set_user_password::AdminSetUserPasswordInput {
