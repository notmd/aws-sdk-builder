...
impl ListDevicesInput {
    ...
    pub fn builder() -> super::operation::list_devices::builders::ListDevicesInputBuilder {
        super::operation::list_devices::builders::ListDevicesInputBuilder::default()
    }
}
...
impl ListDevicesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::list_devices::ListDevicesInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_devices::ListDevicesInput {
