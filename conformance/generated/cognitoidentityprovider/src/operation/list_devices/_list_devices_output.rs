...
impl ListDevicesOutput {
    ...
    pub fn builder() -> super::operation::list_devices::builders::ListDevicesOutputBuilder {
        super::operation::list_devices::builders::ListDevicesOutputBuilder::default()
    }
}
...
impl ListDevicesOutputBuilder {
    ...
    pub fn build(self) -> super::operation::list_devices::ListDevicesOutput {
