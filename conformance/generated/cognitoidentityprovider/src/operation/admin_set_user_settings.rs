    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::admin_set_user_settings::AdminSetUserSettingsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::admin_set_user_settings::AdminSetUserSettingsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AdminSetUserSettingsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_admin_set_user_settings::de_admin_set_user_settings_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_admin_set_user_settings::de_admin_set_user_settings_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AdminSetUserSettingsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::admin_set_user_settings::AdminSetUserSettingsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::admin_set_user_settings::AdminSetUserSettingsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_admin_set_user_settings::ser_admin_set_user_settings_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::operation::admin_set_user_settings::AdminSetUserSettingsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::admin_set_user_settings::_admin_set_user_settings_input::AdminSetUserSettingsInput;

pub use super::operation::admin_set_user_settings::_admin_set_user_settings_output::AdminSetUserSettingsOutput;
