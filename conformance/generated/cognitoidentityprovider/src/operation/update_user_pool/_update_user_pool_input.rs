...
impl UpdateUserPoolInput {
    ...
    pub fn builder() -> super::operation::update_user_pool::builders::UpdateUserPoolInputBuilder {
        super::operation::update_user_pool::builders::UpdateUserPoolInputBuilder::default()
    }
}
...
impl UpdateUserPoolInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::update_user_pool::UpdateUserPoolInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::update_user_pool::UpdateUserPoolInput {
