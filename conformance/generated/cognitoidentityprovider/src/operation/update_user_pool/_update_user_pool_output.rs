...
impl UpdateUserPoolOutput {
    ...
    pub fn builder() -> super::operation::update_user_pool::builders::UpdateUserPoolOutputBuilder {
        super::operation::update_user_pool::builders::UpdateUserPoolOutputBuilder::default()
    }
}
...
impl UpdateUserPoolOutputBuilder {
    ...
    pub fn build(self) -> super::operation::update_user_pool::UpdateUserPoolOutput {
