    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_identity_provider::DeleteIdentityProviderError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_identity_provider::DeleteIdentityProviderOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteIdentityProviderResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_identity_provider::de_delete_identity_provider_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_identity_provider::de_delete_identity_provider_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteIdentityProviderRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_identity_provider::DeleteIdentityProviderInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_identity_provider::DeleteIdentityProviderInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_delete_identity_provider::ser_delete_identity_provider_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::delete_identity_provider::DeleteIdentityProviderError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_identity_provider::_delete_identity_provider_input::DeleteIdentityProviderInput;

pub use super::operation::delete_identity_provider::_delete_identity_provider_output::DeleteIdentityProviderOutput;
