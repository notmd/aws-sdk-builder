...
impl RevokeToken {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::operation::revoke_token::RevokeTokenOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::revoke_token::RevokeTokenError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::revoke_token::RevokeTokenError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::revoke_token::RevokeTokenOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RevokeTokenResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_revoke_token::de_revoke_token_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_revoke_token::de_revoke_token_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RevokeTokenRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::revoke_token::RevokeTokenInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::revoke_token::RevokeTokenInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_revoke_token::ser_revoke_token_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::revoke_token::RevokeTokenError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::revoke_token::_revoke_token_input::RevokeTokenInput;

pub use super::operation::revoke_token::_revoke_token_output::RevokeTokenOutput;
