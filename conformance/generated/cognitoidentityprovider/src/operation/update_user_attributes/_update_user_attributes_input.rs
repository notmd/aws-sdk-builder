...
impl UpdateUserAttributesInput {
    ...
    pub fn builder() -> super::operation::update_user_attributes::builders::UpdateUserAttributesInputBuilder {
        super::operation::update_user_attributes::builders::UpdateUserAttributesInputBuilder::default()
    }
}
...
impl UpdateUserAttributesInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::update_user_attributes::UpdateUserAttributesInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::update_user_attributes::UpdateUserAttributesInput {
