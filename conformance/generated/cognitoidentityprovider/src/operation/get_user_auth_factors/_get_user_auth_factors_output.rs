...
impl GetUserAuthFactorsOutput {
    ...
    pub fn builder() -> super::operation::get_user_auth_factors::builders::GetUserAuthFactorsOutputBuilder {
        super::operation::get_user_auth_factors::builders::GetUserAuthFactorsOutputBuilder::default()
    }
}
...
impl GetUserAuthFactorsOutputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_user_auth_factors::GetUserAuthFactorsOutput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::get_user_auth_factors::GetUserAuthFactorsOutput {
