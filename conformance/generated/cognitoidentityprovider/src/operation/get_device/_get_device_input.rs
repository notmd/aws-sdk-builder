...
impl GetDeviceInput {
    ...
    pub fn builder() -> super::operation::get_device::builders::GetDeviceInputBuilder {
        super::operation::get_device::builders::GetDeviceInputBuilder::default()
    }
}
...
impl GetDeviceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::get_device::GetDeviceInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_device::GetDeviceInput {
