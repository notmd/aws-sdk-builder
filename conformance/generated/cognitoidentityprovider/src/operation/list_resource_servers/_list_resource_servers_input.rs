...
impl ListResourceServersInput {
    ...
    pub fn builder() -> super::operation::list_resource_servers::builders::ListResourceServersInputBuilder {
        super::operation::list_resource_servers::builders::ListResourceServersInputBuilder::default()
    }
}
...
impl ListResourceServersInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_resource_servers::ListResourceServersInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::list_resource_servers::ListResourceServersInput {
