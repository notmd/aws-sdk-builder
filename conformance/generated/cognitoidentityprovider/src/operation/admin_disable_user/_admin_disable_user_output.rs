...
impl AdminDisableUserOutput {
    ...
    pub fn builder() -> super::operation::admin_disable_user::builders::AdminDisableUserOutputBuilder {
        super::operation::admin_disable_user::builders::AdminDisableUserOutputBuilder::default()
    }
}
...
impl AdminDisableUserOutputBuilder {
    ...
    pub fn build(self) -> super::operation::admin_disable_user::AdminDisableUserOutput {
