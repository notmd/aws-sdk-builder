...
impl AdminDisableUserInput {
    ...
    pub fn builder() -> super::operation::admin_disable_user::builders::AdminDisableUserInputBuilder {
        super::operation::admin_disable_user::builders::AdminDisableUserInputBuilder::default()
    }
}
...
impl AdminDisableUserInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::admin_disable_user::AdminDisableUserInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::admin_disable_user::AdminDisableUserInput {
