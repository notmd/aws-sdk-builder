...
impl AdminRemoveUserFromGroupInput {
    ...
    pub fn builder() -> super::operation::admin_remove_user_from_group::builders::AdminRemoveUserFromGroupInputBuilder {
        super::operation::admin_remove_user_from_group::builders::AdminRemoveUserFromGroupInputBuilder::default()
    }
}
...
impl AdminRemoveUserFromGroupInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::admin_remove_user_from_group::AdminRemoveUserFromGroupInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::admin_remove_user_from_group::AdminRemoveUserFromGroupInput {
