...
pub struct SetLogDeliveryConfigurationInput {
    ...
    pub log_configurations: ::std::option::Option<::std::vec::Vec<super::types::LogConfigurationType>>,
}
impl SetLogDeliveryConfigurationInput {
    ...
    pub fn log_configurations(&self) -> &[super::types::LogConfigurationType] {
...
impl SetLogDeliveryConfigurationInput {
    ...
    pub fn builder() -> super::operation::set_log_delivery_configuration::builders::SetLogDeliveryConfigurationInputBuilder {
        super::operation::set_log_delivery_configuration::builders::SetLogDeliveryConfigurationInputBuilder::default()
    }
}
...
pub struct SetLogDeliveryConfigurationInputBuilder {
    ...
    pub(crate) log_configurations: ::std::option::Option<::std::vec::Vec<super::types::LogConfigurationType>>,
}
impl SetLogDeliveryConfigurationInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::set_log_delivery_configuration::SetLogDeliveryConfigurationInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::set_log_delivery_configuration::SetLogDeliveryConfigurationInput {
