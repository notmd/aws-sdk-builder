    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::update_auth_event_feedback::UpdateAuthEventFeedbackError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::update_auth_event_feedback::UpdateAuthEventFeedbackOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateAuthEventFeedbackResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_update_auth_event_feedback::de_update_auth_event_feedback_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_update_auth_event_feedback::de_update_auth_event_feedback_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateAuthEventFeedbackRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::update_auth_event_feedback::UpdateAuthEventFeedbackInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::update_auth_event_feedback::UpdateAuthEventFeedbackInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_update_auth_event_feedback::ser_update_auth_event_feedback_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::update_auth_event_feedback::UpdateAuthEventFeedbackError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::update_auth_event_feedback::_update_auth_event_feedback_input::UpdateAuthEventFeedbackInput;

pub use super::operation::update_auth_event_feedback::_update_auth_event_feedback_output::UpdateAuthEventFeedbackOutput;
