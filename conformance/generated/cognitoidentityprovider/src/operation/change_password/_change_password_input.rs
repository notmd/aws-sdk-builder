...
impl ChangePasswordInput {
    ...
    pub fn builder() -> super::operation::change_password::builders::ChangePasswordInputBuilder {
        super::operation::change_password::builders::ChangePasswordInputBuilder::default()
    }
}
...
impl ChangePasswordInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::change_password::ChangePasswordInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::change_password::ChangePasswordInput {
