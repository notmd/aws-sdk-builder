    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::update_user_pool::UpdateUserPoolError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::update_user_pool::UpdateUserPoolOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateUserPoolResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_update_user_pool::de_update_user_pool_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_update_user_pool::de_update_user_pool_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateUserPoolRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::update_user_pool::UpdateUserPoolInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::update_user_pool::UpdateUserPoolInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_update_user_pool::ser_update_user_pool_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::update_user_pool::UpdateUserPoolError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::update_user_pool::_update_user_pool_input::UpdateUserPoolInput;

pub use super::operation::update_user_pool::_update_user_pool_output::UpdateUserPoolOutput;
