...
impl UpdateGroup {
    ...
    pub(crate) async fn orchestrate(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::update_group::UpdateGroupError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::update_group::UpdateGroupError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::update_group::UpdateGroupOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateGroupResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_update_group::de_update_group_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_update_group::de_update_group_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateGroupRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::update_group::UpdateGroupInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::update_group::UpdateGroupInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_update_group::ser_update_group_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::update_group::UpdateGroupError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::update_group::_update_group_input::UpdateGroupInput;

pub use super::operation::update_group::_update_group_output::UpdateGroupOutput;
