...
impl ListUserPoolClientsInput {
    ...
    pub fn builder() -> super::operation::list_user_pool_clients::builders::ListUserPoolClientsInputBuilder {
        super::operation::list_user_pool_clients::builders::ListUserPoolClientsInputBuilder::default()
    }
}
...
impl ListUserPoolClientsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_user_pool_clients::ListUserPoolClientsInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::list_user_pool_clients::ListUserPoolClientsInput {
