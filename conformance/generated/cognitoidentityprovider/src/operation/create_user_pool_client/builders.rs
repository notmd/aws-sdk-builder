...
pub use super::operation::create_user_pool_client::_create_user_pool_client_input::CreateUserPoolClientInputBuilder;

pub use super::operation::create_user_pool_client::_create_user_pool_client_output::CreateUserPoolClientOutputBuilder;

impl super::operation::create_user_pool_client::builders::CreateUserPoolClientInputBuilder {
...
///
/// <p>Creates an app client in a user pool. This operation sets basic and advanced configuration options.</p>
/// <p>Unlike app clients created in the console, Amazon Cognito doesn't automatically assign a branding style to app clients that you configure with this API operation. Managed login and classic hosted UI pages aren't available for your client until after you apply a branding style.</p><important>
...
pub struct CreateUserPoolClientFluentBuilder {
    ...
    inner: super::operation::create_user_pool_client::builders::CreateUserPoolClientInputBuilder,
...
impl
    super::client::customize::internal::CustomizableSend<
        super::operation::create_user_pool_client::CreateUserPoolClientOutput,
        super::operation::create_user_pool_client::CreateUserPoolClientError,
    > for CreateUserPoolClientFluentBuilder
{
    fn send(
        self,
...
impl CreateUserPoolClientFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::create_user_pool_client::builders::CreateUserPoolClientInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::create_user_pool_client::CreateUserPoolClient::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::create_user_pool_client::CreateUserPoolClient::orchestrate(&runtime_plugins, input).await
    }
