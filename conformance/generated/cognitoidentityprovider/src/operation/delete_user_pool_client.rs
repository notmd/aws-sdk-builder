    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_user_pool_client::DeleteUserPoolClientError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_user_pool_client::DeleteUserPoolClientOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteUserPoolClientResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_user_pool_client::de_delete_user_pool_client_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_user_pool_client::de_delete_user_pool_client_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteUserPoolClientRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_user_pool_client::DeleteUserPoolClientInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_user_pool_client::DeleteUserPoolClientInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_delete_user_pool_client::ser_delete_user_pool_client_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::operation::delete_user_pool_client::DeleteUserPoolClientError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_user_pool_client::_delete_user_pool_client_input::DeleteUserPoolClientInput;

pub use super::operation::delete_user_pool_client::_delete_user_pool_client_output::DeleteUserPoolClientOutput;
