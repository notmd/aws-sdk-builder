    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::admin_link_provider_for_user::AdminLinkProviderForUserError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::admin_link_provider_for_user::AdminLinkProviderForUserOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AdminLinkProviderForUserResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_admin_link_provider_for_user::de_admin_link_provider_for_user_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_admin_link_provider_for_user::de_admin_link_provider_for_user_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AdminLinkProviderForUserRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::admin_link_provider_for_user::AdminLinkProviderForUserInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::admin_link_provider_for_user::AdminLinkProviderForUserInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_admin_link_provider_for_user::ser_admin_link_provider_for_user_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::admin_link_provider_for_user::AdminLinkProviderForUserError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::admin_link_provider_for_user::_admin_link_provider_for_user_input::AdminLinkProviderForUserInput;

pub use super::operation::admin_link_provider_for_user::_admin_link_provider_for_user_output::AdminLinkProviderForUserOutput;
