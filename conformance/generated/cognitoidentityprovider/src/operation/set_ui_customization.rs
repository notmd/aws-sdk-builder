    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::set_ui_customization::SetUICustomizationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::set_ui_customization::SetUiCustomizationOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetUICustomizationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_set_ui_customization::de_set_ui_customization_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_set_ui_customization::de_set_ui_customization_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetUICustomizationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::set_ui_customization::SetUiCustomizationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::set_ui_customization::SetUiCustomizationInput,
        ...
        let body =
            ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_set_ui_customization::ser_set_ui_customization_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::set_ui_customization::SetUICustomizationError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::set_ui_customization::_set_ui_customization_input::SetUiCustomizationInput;

pub use super::operation::set_ui_customization::_set_ui_customization_output::SetUiCustomizationOutput;
