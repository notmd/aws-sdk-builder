...
impl UpdateUserPoolClientInput {
    ...
    pub fn builder() -> super::operation::update_user_pool_client::builders::UpdateUserPoolClientInputBuilder {
        super::operation::update_user_pool_client::builders::UpdateUserPoolClientInputBuilder::default()
    }
}
...
impl UpdateUserPoolClientInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::update_user_pool_client::UpdateUserPoolClientInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::update_user_pool_client::UpdateUserPoolClientInput {
