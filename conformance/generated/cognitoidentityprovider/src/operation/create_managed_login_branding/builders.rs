...
pub use super::operation::create_managed_login_branding::_create_managed_login_branding_input::CreateManagedLoginBrandingInputBuilder;

pub use super::operation::create_managed_login_branding::_create_managed_login_branding_output::CreateManagedLoginBrandingOutputBuilder;

impl super::operation::create_managed_login_branding::builders::CreateManagedLoginBrandingInputBuilder {
...
pub struct CreateManagedLoginBrandingFluentBuilder {
    ...
    inner: super::operation::create_managed_login_branding::builders::CreateManagedLoginBrandingInputBuilder,
...
impl CreateManagedLoginBrandingFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::create_managed_login_branding::builders::CreateManagedLoginBrandingInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::create_managed_login_branding::CreateManagedLoginBranding::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::create_managed_login_branding::CreateManagedLoginBranding::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn assets(mut self, input: super::types::AssetType) -> Self {
        self.inner = self.inner.assets(input);
        self
    }
    /// <p>An array of image files that you want to apply to functions like backgrounds, logos, and icons. Each object must also indicate whether it is for dark mode, light mode, or browser-adaptive mode.</p>
    pub fn set_assets(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::AssetType>>) -> Self {
        self.inner = self.inner.set_assets(input);
        self
    }
    /// <p>An array of image files that you want to apply to functions like backgrounds, logos, and icons. Each object must also indicate whether it is for dark mode, light mode, or browser-adaptive mode.</p>
    pub fn get_assets(&self) -> &::std::option::Option<::std::vec::Vec<super::types::AssetType>> {
