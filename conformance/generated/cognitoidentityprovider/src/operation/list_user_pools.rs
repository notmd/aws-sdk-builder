...
impl ListUserPools {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::operation::list_user_pools::ListUserPoolsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::list_user_pools::ListUserPoolsError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_user_pools::ListUserPoolsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_user_pools::ListUserPoolsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListUserPoolsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_user_pools::de_list_user_pools_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_user_pools::de_list_user_pools_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListUserPoolsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_user_pools::ListUserPoolsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_user_pools::ListUserPoolsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_list_user_pools::ser_list_user_pools_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::list_user_pools::ListUserPoolsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_user_pools::_list_user_pools_input::ListUserPoolsInput;

pub use super::operation::list_user_pools::_list_user_pools_output::ListUserPoolsOutput;
