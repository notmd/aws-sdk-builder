...
impl GlobalSignOutInput {
    ...
    pub fn builder() -> super::operation::global_sign_out::builders::GlobalSignOutInputBuilder {
        super::operation::global_sign_out::builders::GlobalSignOutInputBuilder::default()
    }
}
...
impl GlobalSignOutInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::global_sign_out::GlobalSignOutInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::global_sign_out::GlobalSignOutInput {
