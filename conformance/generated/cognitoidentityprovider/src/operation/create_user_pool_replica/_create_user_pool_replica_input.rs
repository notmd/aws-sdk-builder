...
impl CreateUserPoolReplicaInput {
    ...
    pub fn builder() -> super::operation::create_user_pool_replica::builders::CreateUserPoolReplicaInputBuilder {
        super::operation::create_user_pool_replica::builders::CreateUserPoolReplicaInputBuilder::default()
    }
}
...
impl CreateUserPoolReplicaInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::create_user_pool_replica::CreateUserPoolReplicaInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::create_user_pool_replica::CreateUserPoolReplicaInput {
