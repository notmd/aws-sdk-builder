    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::verify_software_token::VerifySoftwareTokenError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::verify_software_token::VerifySoftwareTokenOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for VerifySoftwareTokenResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_verify_software_token::de_verify_software_token_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_verify_software_token::de_verify_software_token_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for VerifySoftwareTokenRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::verify_software_token::VerifySoftwareTokenInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::verify_software_token::VerifySoftwareTokenInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_verify_software_token::ser_verify_software_token_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::operation::verify_software_token::VerifySoftwareTokenError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::verify_software_token::_verify_software_token_input::VerifySoftwareTokenInput;

pub use super::operation::verify_software_token::_verify_software_token_output::VerifySoftwareTokenOutput;
