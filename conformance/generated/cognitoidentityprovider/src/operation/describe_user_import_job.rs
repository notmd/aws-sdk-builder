    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::describe_user_import_job::DescribeUserImportJobError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::describe_user_import_job::DescribeUserImportJobOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeUserImportJobResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_describe_user_import_job::de_describe_user_import_job_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_describe_user_import_job::de_describe_user_import_job_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeUserImportJobRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::describe_user_import_job::DescribeUserImportJobInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::describe_user_import_job::DescribeUserImportJobInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_describe_user_import_job::ser_describe_user_import_job_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::describe_user_import_job::DescribeUserImportJobError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::describe_user_import_job::_describe_user_import_job_input::DescribeUserImportJobInput;

pub use super::operation::describe_user_import_job::_describe_user_import_job_output::DescribeUserImportJobOutput;
