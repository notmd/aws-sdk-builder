...
impl AdminDeleteUser {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::operation::admin_delete_user::AdminDeleteUserOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::admin_delete_user::AdminDeleteUserError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::admin_delete_user::AdminDeleteUserError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::admin_delete_user::AdminDeleteUserOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AdminDeleteUserResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_admin_delete_user::de_admin_delete_user_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_admin_delete_user::de_admin_delete_user_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AdminDeleteUserRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::admin_delete_user::AdminDeleteUserInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::admin_delete_user::AdminDeleteUserInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_admin_delete_user::ser_admin_delete_user_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::admin_delete_user::AdminDeleteUserError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::admin_delete_user::_admin_delete_user_input::AdminDeleteUserInput;

pub use super::operation::admin_delete_user::_admin_delete_user_output::AdminDeleteUserOutput;
