    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::admin_create_user::AdminCreateUserError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::admin_create_user::AdminCreateUserOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AdminCreateUserResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_admin_create_user::de_admin_create_user_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_admin_create_user::de_admin_create_user_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AdminCreateUserRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::admin_create_user::AdminCreateUserInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::admin_create_user::AdminCreateUserInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_admin_create_user::ser_admin_create_user_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::admin_create_user::AdminCreateUserError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::admin_create_user::_admin_create_user_input::AdminCreateUserInput;

pub use super::operation::admin_create_user::_admin_create_user_output::AdminCreateUserOutput;
