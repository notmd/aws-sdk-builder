...
impl GetCsvHeaderOutput {
    ...
    pub fn builder() -> super::operation::get_csv_header::builders::GetCsvHeaderOutputBuilder {
        super::operation::get_csv_header::builders::GetCsvHeaderOutputBuilder::default()
    }
}
...
impl GetCsvHeaderOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_csv_header::GetCsvHeaderOutput {
