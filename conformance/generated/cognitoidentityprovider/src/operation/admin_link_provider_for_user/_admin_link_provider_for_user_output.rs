...
impl AdminLinkProviderForUserOutput {
    ...
    pub fn builder() -> super::operation::admin_link_provider_for_user::builders::AdminLinkProviderForUserOutputBuilder {
        super::operation::admin_link_provider_for_user::builders::AdminLinkProviderForUserOutputBuilder::default()
    }
}
...
impl AdminLinkProviderForUserOutputBuilder {
    ...
    pub fn build(self) -> super::operation::admin_link_provider_for_user::AdminLinkProviderForUserOutput {
