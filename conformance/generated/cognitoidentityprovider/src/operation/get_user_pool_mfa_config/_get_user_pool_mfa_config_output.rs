...
impl GetUserPoolMfaConfigOutput {
    ...
    pub fn builder() -> super::operation::get_user_pool_mfa_config::builders::GetUserPoolMfaConfigOutputBuilder {
        super::operation::get_user_pool_mfa_config::builders::GetUserPoolMfaConfigOutputBuilder::default()
    }
}
...
impl GetUserPoolMfaConfigOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_user_pool_mfa_config::GetUserPoolMfaConfigOutput {
        super::operation::get_user_pool_mfa_config::GetUserPoolMfaConfigOutput {
