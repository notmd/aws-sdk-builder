...
impl DeleteGroup {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::operation::delete_group::DeleteGroupOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::delete_group::DeleteGroupError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_group::DeleteGroupError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_group::DeleteGroupOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteGroupResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_group::de_delete_group_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_group::de_delete_group_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteGroupRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_group::DeleteGroupInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_group::DeleteGroupInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_delete_group::ser_delete_group_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::delete_group::DeleteGroupError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_group::_delete_group_input::DeleteGroupInput;

pub use super::operation::delete_group::_delete_group_output::DeleteGroupOutput;
