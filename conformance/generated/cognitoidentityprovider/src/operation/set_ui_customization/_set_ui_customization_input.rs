...
impl SetUiCustomizationInput {
    ...
    pub fn builder() -> super::operation::set_ui_customization::builders::SetUiCustomizationInputBuilder {
        super::operation::set_ui_customization::builders::SetUiCustomizationInputBuilder::default()
    }
}
...
impl SetUiCustomizationInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::set_ui_customization::SetUiCustomizationInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::set_ui_customization::SetUiCustomizationInput {
