...
impl StartWebAuthnRegistrationInput {
    ...
    pub fn builder() -> super::operation::start_web_authn_registration::builders::StartWebAuthnRegistrationInputBuilder {
        super::operation::start_web_authn_registration::builders::StartWebAuthnRegistrationInputBuilder::default()
    }
}
...
impl StartWebAuthnRegistrationInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::start_web_authn_registration::StartWebAuthnRegistrationInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::start_web_authn_registration::StartWebAuthnRegistrationInput {
