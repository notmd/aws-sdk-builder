    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::describe_user_pool_client::DescribeUserPoolClientError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::describe_user_pool_client::DescribeUserPoolClientOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeUserPoolClientResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_describe_user_pool_client::de_describe_user_pool_client_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_describe_user_pool_client::de_describe_user_pool_client_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeUserPoolClientRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::describe_user_pool_client::DescribeUserPoolClientInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::describe_user_pool_client::DescribeUserPoolClientInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_describe_user_pool_client::ser_describe_user_pool_client_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::describe_user_pool_client::DescribeUserPoolClientError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::describe_user_pool_client::_describe_user_pool_client_input::DescribeUserPoolClientInput;

pub use super::operation::describe_user_pool_client::_describe_user_pool_client_output::DescribeUserPoolClientOutput;
