...
impl DescribeManagedLoginBrandingByClientInput {
    ...
    pub fn builder() -> super::operation::describe_managed_login_branding_by_client::builders::DescribeManagedLoginBrandingByClientInputBuilder {
        super::operation::describe_managed_login_branding_by_client::builders::DescribeManagedLoginBrandingByClientInputBuilder::default()
    }
}
