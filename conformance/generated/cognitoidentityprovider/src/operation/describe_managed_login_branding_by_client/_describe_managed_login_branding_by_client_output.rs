...
pub struct DescribeManagedLoginBrandingByClientOutput {
    ...
    pub managed_login_branding: ::std::option::Option<super::types::ManagedLoginBrandingType>,
    _request_id: Option<String>,
}
impl DescribeManagedLoginBrandingByClientOutput {
    /// <p>The details of the requested branding style.</p>
    pub fn managed_login_branding(&self) -> ::std::option::Option<&super::types::ManagedLoginBrandingType> {
...
impl DescribeManagedLoginBrandingByClientOutput {
    ...
    pub fn builder() -> super::operation::describe_managed_login_branding_by_client::builders::DescribeManagedLoginBrandingByClientOutputBuilder {
...
pub struct DescribeManagedLoginBrandingByClientOutputBuilder {
    pub(crate) managed_login_branding: ::std::option::Option<super::types::ManagedLoginBrandingType>,
    _request_id: Option<String>,
}
impl DescribeManagedLoginBrandingByClientOutputBuilder {
    /// <p>The details of the requested branding style.</p>
    pub fn managed_login_branding(mut self, input: super::types::ManagedLoginBrandingType) -> Self {
        self.managed_login_branding = ::std::option::Option::Some(input);
        self
    }
    /// <p>The details of the requested branding style.</p>
    pub fn set_managed_login_branding(mut self, input: ::std::option::Option<super::types::ManagedLoginBrandingType>) -> Self {
        self.managed_login_branding = input;
        self
    }
    /// <p>The details of the requested branding style.</p>
    pub fn get_managed_login_branding(&self) -> &::std::option::Option<super::types::ManagedLoginBrandingType> {
    ...
    pub fn build(self) -> super::operation::describe_managed_login_branding_by_client::DescribeManagedLoginBrandingByClientOutput {
