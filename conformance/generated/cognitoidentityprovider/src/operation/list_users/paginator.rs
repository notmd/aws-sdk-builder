...
pub struct ListUsersPaginator {
    ...
    builder: super::operation::list_users::builders::ListUsersInputBuilder,
    stop_on_duplicate_token: bool,
}

impl ListUsersPaginator {
    /// Create a new paginator-wrapper
    pub(crate) fn new(handle: std::sync::Arc<super::client::Handle>, builder: super::operation::list_users::builders::ListUsersInputBuilder) -> Self {
        Self {
            handle,
            builder,
    ...
    pub fn items(self) -> super::operation::list_users::paginator::ListUsersPaginatorItems {
        super::operation::list_users::paginator::ListUsersPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::operation::list_users::ListUsers::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_list_users_output_output_pagination_token(resp);
...
impl ListUsersPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| super::lens::lens_list_users_output_output_users(page).unwrap_or_default().into_iter())
    }
}
