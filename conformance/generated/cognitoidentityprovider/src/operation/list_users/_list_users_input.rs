...
impl ListUsersInput {
    ...
    pub fn builder() -> super::operation::list_users::builders::ListUsersInputBuilder {
        super::operation::list_users::builders::ListUsersInputBuilder::default()
    }
}
...
impl ListUsersInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::list_users::ListUsersInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_users::ListUsersInput {
