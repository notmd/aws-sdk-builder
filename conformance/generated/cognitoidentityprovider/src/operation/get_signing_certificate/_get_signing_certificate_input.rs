...
impl GetSigningCertificateInput {
    ...
    pub fn builder() -> super::operation::get_signing_certificate::builders::GetSigningCertificateInputBuilder {
        super::operation::get_signing_certificate::builders::GetSigningCertificateInputBuilder::default()
    }
}
...
impl GetSigningCertificateInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_signing_certificate::GetSigningCertificateInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::get_signing_certificate::GetSigningCertificateInput {
