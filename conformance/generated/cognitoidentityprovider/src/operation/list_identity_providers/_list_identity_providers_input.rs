...
impl ListIdentityProvidersInput {
    ...
    pub fn builder() -> super::operation::list_identity_providers::builders::ListIdentityProvidersInputBuilder {
        super::operation::list_identity_providers::builders::ListIdentityProvidersInputBuilder::default()
    }
}
...
impl ListIdentityProvidersInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_identity_providers::ListIdentityProvidersInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::list_identity_providers::ListIdentityProvidersInput {
