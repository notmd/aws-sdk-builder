...
impl AdminConfirmSignUpInput {
    ...
    pub fn builder() -> super::operation::admin_confirm_sign_up::builders::AdminConfirmSignUpInputBuilder {
        super::operation::admin_confirm_sign_up::builders::AdminConfirmSignUpInputBuilder::default()
    }
}
...
impl AdminConfirmSignUpInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::admin_confirm_sign_up::AdminConfirmSignUpInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::admin_confirm_sign_up::AdminConfirmSignUpInput {
