...
impl AdminConfirmSignUpOutput {
    ...
    pub fn builder() -> super::operation::admin_confirm_sign_up::builders::AdminConfirmSignUpOutputBuilder {
        super::operation::admin_confirm_sign_up::builders::AdminConfirmSignUpOutputBuilder::default()
    }
}
...
impl AdminConfirmSignUpOutputBuilder {
    ...
    pub fn build(self) -> super::operation::admin_confirm_sign_up::AdminConfirmSignUpOutput {
