    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::describe_resource_server::DescribeResourceServerError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::describe_resource_server::DescribeResourceServerOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeResourceServerResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_describe_resource_server::de_describe_resource_server_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_describe_resource_server::de_describe_resource_server_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeResourceServerRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::describe_resource_server::DescribeResourceServerInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::describe_resource_server::DescribeResourceServerInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_describe_resource_server::ser_describe_resource_server_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::describe_resource_server::DescribeResourceServerError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::describe_resource_server::_describe_resource_server_input::DescribeResourceServerInput;

pub use super::operation::describe_resource_server::_describe_resource_server_output::DescribeResourceServerOutput;
