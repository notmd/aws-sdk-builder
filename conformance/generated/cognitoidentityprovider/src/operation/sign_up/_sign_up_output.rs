...
impl SignUpOutput {
    ...
    pub fn builder() -> super::operation::sign_up::builders::SignUpOutputBuilder {
        super::operation::sign_up::builders::SignUpOutputBuilder::default()
    }
}
...
impl SignUpOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::sign_up::SignUpOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::sign_up::SignUpOutput {
