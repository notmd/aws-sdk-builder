    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::admin_set_user_password::AdminSetUserPasswordError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::admin_set_user_password::AdminSetUserPasswordOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AdminSetUserPasswordResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_admin_set_user_password::de_admin_set_user_password_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_admin_set_user_password::de_admin_set_user_password_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AdminSetUserPasswordRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::admin_set_user_password::AdminSetUserPasswordInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::admin_set_user_password::AdminSetUserPasswordInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_admin_set_user_password::ser_admin_set_user_password_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::operation::admin_set_user_password::AdminSetUserPasswordError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::admin_set_user_password::_admin_set_user_password_input::AdminSetUserPasswordInput;

pub use super::operation::admin_set_user_password::_admin_set_user_password_output::AdminSetUserPasswordOutput;
