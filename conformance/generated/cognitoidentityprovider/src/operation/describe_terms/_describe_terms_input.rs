...
impl DescribeTermsInput {
    ...
    pub fn builder() -> super::operation::describe_terms::builders::DescribeTermsInputBuilder {
        super::operation::describe_terms::builders::DescribeTermsInputBuilder::default()
    }
}
...
impl DescribeTermsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::describe_terms::DescribeTermsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::describe_terms::DescribeTermsInput {
