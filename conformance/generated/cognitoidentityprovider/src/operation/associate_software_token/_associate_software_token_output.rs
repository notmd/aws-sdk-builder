...
impl AssociateSoftwareTokenOutput {
    ...
    pub fn builder() -> super::operation::associate_software_token::builders::AssociateSoftwareTokenOutputBuilder {
        super::operation::associate_software_token::builders::AssociateSoftwareTokenOutputBuilder::default()
    }
}
...
impl AssociateSoftwareTokenOutputBuilder {
    ...
    pub fn build(self) -> super::operation::associate_software_token::AssociateSoftwareTokenOutput {
