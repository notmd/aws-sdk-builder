...
impl CreateUserImportJobInput {
    ...
    pub fn builder() -> super::operation::create_user_import_job::builders::CreateUserImportJobInputBuilder {
        super::operation::create_user_import_job::builders::CreateUserImportJobInputBuilder::default()
    }
}
...
impl CreateUserImportJobInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::create_user_import_job::CreateUserImportJobInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::create_user_import_job::CreateUserImportJobInput {
