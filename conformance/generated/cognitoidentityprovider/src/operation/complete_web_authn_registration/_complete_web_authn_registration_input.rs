...
impl CompleteWebAuthnRegistrationInput {
    ...
    pub fn builder() -> super::operation::complete_web_authn_registration::builders::CompleteWebAuthnRegistrationInputBuilder {
        super::operation::complete_web_authn_registration::builders::CompleteWebAuthnRegistrationInputBuilder::default()
    }
}
...
impl CompleteWebAuthnRegistrationInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::complete_web_authn_registration::CompleteWebAuthnRegistrationInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::complete_web_authn_registration::CompleteWebAuthnRegistrationInput {
