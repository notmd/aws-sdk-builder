...
impl SetUserPoolMfaConfigOutput {
    ...
    pub fn builder() -> super::operation::set_user_pool_mfa_config::builders::SetUserPoolMfaConfigOutputBuilder {
        super::operation::set_user_pool_mfa_config::builders::SetUserPoolMfaConfigOutputBuilder::default()
    }
}
...
impl SetUserPoolMfaConfigOutputBuilder {
    ...
    pub fn build(self) -> super::operation::set_user_pool_mfa_config::SetUserPoolMfaConfigOutput {
