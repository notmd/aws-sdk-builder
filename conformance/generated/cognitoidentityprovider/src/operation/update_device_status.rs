    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::update_device_status::UpdateDeviceStatusError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::update_device_status::UpdateDeviceStatusOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateDeviceStatusResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_update_device_status::de_update_device_status_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_update_device_status::de_update_device_status_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateDeviceStatusRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::update_device_status::UpdateDeviceStatusInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::update_device_status::UpdateDeviceStatusInput,
        ...
        let body =
            ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_update_device_status::ser_update_device_status_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::update_device_status::UpdateDeviceStatusError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::update_device_status::_update_device_status_input::UpdateDeviceStatusInput;

pub use super::operation::update_device_status::_update_device_status_output::UpdateDeviceStatusOutput;
