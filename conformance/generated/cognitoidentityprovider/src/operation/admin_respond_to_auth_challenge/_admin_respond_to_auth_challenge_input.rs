...
pub struct AdminRespondToAuthChallengeInput {
    ...
    pub context_data: ::std::option::Option<super::types::ContextDataType>,
...
impl AdminRespondToAuthChallengeInput {
    ...
    /// <p>Contextual data about your user session like the device fingerprint, IP address, or location. Amazon Cognito threat protection evaluates the risk of an authentication event based on the context that your app generates and passes to Amazon Cognito when it makes API requests.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-settings-viewing-threat-protection-app.html">Collecting data for threat protection in applications</a>.</p>
    pub fn context_data(&self) -> ::std::option::Option<&super::types::ContextDataType> {
...
impl AdminRespondToAuthChallengeInput {
    ...
    pub fn builder() -> super::operation::admin_respond_to_auth_challenge::builders::AdminRespondToAuthChallengeInputBuilder {
        super::operation::admin_respond_to_auth_challenge::builders::AdminRespondToAuthChallengeInputBuilder::default()
    }
}
...
pub struct AdminRespondToAuthChallengeInputBuilder {
    ...
    pub(crate) context_data: ::std::option::Option<super::types::ContextDataType>,
...
impl AdminRespondToAuthChallengeInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::admin_respond_to_auth_challenge::AdminRespondToAuthChallengeInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::admin_respond_to_auth_challenge::AdminRespondToAuthChallengeInput {
