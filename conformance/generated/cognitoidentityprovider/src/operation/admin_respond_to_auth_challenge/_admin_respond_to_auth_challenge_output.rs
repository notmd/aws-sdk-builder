...
impl AdminRespondToAuthChallengeOutput {
    ...
    pub fn builder() -> super::operation::admin_respond_to_auth_challenge::builders::AdminRespondToAuthChallengeOutputBuilder {
        super::operation::admin_respond_to_auth_challenge::builders::AdminRespondToAuthChallengeOutputBuilder::default()
    }
}
...
impl AdminRespondToAuthChallengeOutputBuilder {
    ...
    pub fn build(self) -> super::operation::admin_respond_to_auth_challenge::AdminRespondToAuthChallengeOutput {
