...
pub use super::operation::admin_respond_to_auth_challenge::_admin_respond_to_auth_challenge_input::AdminRespondToAuthChallengeInputBuilder;

pub use super::operation::admin_respond_to_auth_challenge::_admin_respond_to_auth_challenge_output::AdminRespondToAuthChallengeOutputBuilder;

impl super::operation::admin_respond_to_auth_challenge::builders::AdminRespondToAuthChallengeInputBuilder {
...
pub struct AdminRespondToAuthChallengeFluentBuilder {
    ...
    inner: super::operation::admin_respond_to_auth_challenge::builders::AdminRespondToAuthChallengeInputBuilder,
...
impl AdminRespondToAuthChallengeFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::admin_respond_to_auth_challenge::builders::AdminRespondToAuthChallengeInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::admin_respond_to_auth_challenge::AdminRespondToAuthChallenge::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::admin_respond_to_auth_challenge::AdminRespondToAuthChallenge::orchestrate(&runtime_plugins, input).await
    }
    ...
    /// </ul>
    pub fn challenge_name(mut self, input: super::types::ChallengeNameType) -> Self {
    ...
    /// <p>To set up SMS or email MFA, collect a <code>phone_number</code> or <code>email</code> attribute for the user. Then restart the authentication flow with an <code>InitiateAuth</code> or <code>AdminInitiateAuth</code> request.</p></li>
    /// </ul>
    pub fn set_challenge_name(mut self, input: ::std::option::Option<super::types::ChallengeNameType>) -> Self {
    ...
    /// <p>To set up SMS or email MFA, collect a <code>phone_number</code> or <code>email</code> attribute for the user. Then restart the authentication flow with an <code>InitiateAuth</code> or <code>AdminInitiateAuth</code> request.</p></li>
    /// </ul>
    pub fn get_challenge_name(&self) -> &::std::option::Option<super::types::ChallengeNameType> {
    ...
    pub fn context_data(mut self, input: super::types::ContextDataType) -> Self {
        self.inner = self.inner.context_data(input);
        self
    }
    /// <p>Contextual data about your user session like the device fingerprint, IP address, or location. Amazon Cognito threat protection evaluates the risk of an authentication event based on the context that your app generates and passes to Amazon Cognito when it makes API requests.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-settings-viewing-threat-protection-app.html">Collecting data for threat protection in applications</a>.</p>
    pub fn set_context_data(mut self, input: ::std::option::Option<super::types::ContextDataType>) -> Self {
        self.inner = self.inner.set_context_data(input);
        self
    }
    /// <p>Contextual data about your user session like the device fingerprint, IP address, or location. Amazon Cognito threat protection evaluates the risk of an authentication event based on the context that your app generates and passes to Amazon Cognito when it makes API requests.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-settings-viewing-threat-protection-app.html">Collecting data for threat protection in applications</a>.</p>
    pub fn get_context_data(&self) -> &::std::option::Option<super::types::ContextDataType> {
