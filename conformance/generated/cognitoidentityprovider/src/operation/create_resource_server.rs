    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::create_resource_server::CreateResourceServerError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::create_resource_server::CreateResourceServerOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateResourceServerResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_create_resource_server::de_create_resource_server_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_create_resource_server::de_create_resource_server_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateResourceServerRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::create_resource_server::CreateResourceServerInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::create_resource_server::CreateResourceServerInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_create_resource_server::ser_create_resource_server_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::operation::create_resource_server::CreateResourceServerError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::create_resource_server::_create_resource_server_input::CreateResourceServerInput;

pub use super::operation::create_resource_server::_create_resource_server_output::CreateResourceServerOutput;
