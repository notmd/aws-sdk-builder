...
impl AdminUpdateUserAttributesOutput {
    ...
    pub fn builder() -> super::operation::admin_update_user_attributes::builders::AdminUpdateUserAttributesOutputBuilder {
        super::operation::admin_update_user_attributes::builders::AdminUpdateUserAttributesOutputBuilder::default()
    }
}
...
impl AdminUpdateUserAttributesOutputBuilder {
    ...
    pub fn build(self) -> super::operation::admin_update_user_attributes::AdminUpdateUserAttributesOutput {
