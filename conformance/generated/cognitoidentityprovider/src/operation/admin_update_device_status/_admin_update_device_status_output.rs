...
impl AdminUpdateDeviceStatusOutput {
    ...
    pub fn builder() -> super::operation::admin_update_device_status::builders::AdminUpdateDeviceStatusOutputBuilder {
        super::operation::admin_update_device_status::builders::AdminUpdateDeviceStatusOutputBuilder::default()
    }
}
...
impl AdminUpdateDeviceStatusOutputBuilder {
    ...
    pub fn build(self) -> super::operation::admin_update_device_status::AdminUpdateDeviceStatusOutput {
