...
impl ConfirmSignUpOutput {
    ...
    pub fn builder() -> super::operation::confirm_sign_up::builders::ConfirmSignUpOutputBuilder {
        super::operation::confirm_sign_up::builders::ConfirmSignUpOutputBuilder::default()
    }
}
...
impl ConfirmSignUpOutputBuilder {
    ...
    pub fn build(self) -> super::operation::confirm_sign_up::ConfirmSignUpOutput {
