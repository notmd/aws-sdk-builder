...
impl ConfirmSignUpInput {
    ...
    pub fn builder() -> super::operation::confirm_sign_up::builders::ConfirmSignUpInputBuilder {
        super::operation::confirm_sign_up::builders::ConfirmSignUpInputBuilder::default()
    }
}
...
impl ConfirmSignUpInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::confirm_sign_up::ConfirmSignUpInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::confirm_sign_up::ConfirmSignUpInput {
