    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_user_pool_clients::ListUserPoolClientsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_user_pool_clients::ListUserPoolClientsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListUserPoolClientsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_user_pool_clients::de_list_user_pool_clients_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_user_pool_clients::de_list_user_pool_clients_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListUserPoolClientsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_user_pool_clients::ListUserPoolClientsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_user_pool_clients::ListUserPoolClientsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_list_user_pool_clients::ser_list_user_pool_clients_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::operation::list_user_pool_clients::ListUserPoolClientsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_user_pool_clients::_list_user_pool_clients_input::ListUserPoolClientsInput;

pub use super::operation::list_user_pool_clients::_list_user_pool_clients_output::ListUserPoolClientsOutput;
