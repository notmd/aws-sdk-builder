...
impl GetUser {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::operation::get_user::GetUserOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::get_user::GetUserError,
    ...
    > {
        let map_err =
            |err: ::aws_smithy_runtime_api::client::result::SdkError<
                ...
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >| { err.map_service_error(|err| err.downcast::<super::operation::get_user::GetUserError>().expect("correct error type")) };
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_user::GetUserOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetUserResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_user::de_get_user_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_user::de_get_user_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetUserRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::get_user::GetUserInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_user::GetUserInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_get_user::ser_get_user_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::get_user::GetUserError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_user::_get_user_input::GetUserInput;

pub use super::operation::get_user::_get_user_output::GetUserOutput;
