...
pub struct InitiateAuthInput {
    ...
    pub auth_flow: ::std::option::Option<super::types::AuthFlowType>,
...
impl InitiateAuthInput {
    ...
    /// </dl>
    /// <p><code>ADMIN_USER_PASSWORD_AUTH</code> is a flow type of <code>AdminInitiateAuth</code> and isn't valid for InitiateAuth. <code>ADMIN_NO_SRP_AUTH</code> is a legacy server-side username-password flow and isn't valid for InitiateAuth.</p>
    pub fn auth_flow(&self) -> ::std::option::Option<&super::types::AuthFlowType> {
...
impl InitiateAuthInput {
    ...
    pub fn builder() -> super::operation::initiate_auth::builders::InitiateAuthInputBuilder {
        super::operation::initiate_auth::builders::InitiateAuthInputBuilder::default()
    }
}
...
pub struct InitiateAuthInputBuilder {
    pub(crate) auth_flow: ::std::option::Option<super::types::AuthFlowType>,
...
impl InitiateAuthInputBuilder {
    ...
    pub fn auth_flow(mut self, input: super::types::AuthFlowType) -> Self {
    ...
    /// </dl>
    /// <p><code>ADMIN_USER_PASSWORD_AUTH</code> is a flow type of <code>AdminInitiateAuth</code> and isn't valid for InitiateAuth. <code>ADMIN_NO_SRP_AUTH</code> is a legacy server-side username-password flow and isn't valid for InitiateAuth.</p>
    pub fn set_auth_flow(mut self, input: ::std::option::Option<super::types::AuthFlowType>) -> Self {
    ...
    /// </dl>
    /// <p><code>ADMIN_USER_PASSWORD_AUTH</code> is a flow type of <code>AdminInitiateAuth</code> and isn't valid for InitiateAuth. <code>ADMIN_NO_SRP_AUTH</code> is a legacy server-side username-password flow and isn't valid for InitiateAuth.</p>
    pub fn get_auth_flow(&self) -> &::std::option::Option<super::types::AuthFlowType> {
        &self.auth_flow
    }
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::initiate_auth::InitiateAuthInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::initiate_auth::InitiateAuthInput {
