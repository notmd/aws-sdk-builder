...
impl InitiateAuthOutput {
    ...
    pub fn builder() -> super::operation::initiate_auth::builders::InitiateAuthOutputBuilder {
        super::operation::initiate_auth::builders::InitiateAuthOutputBuilder::default()
    }
}
...
impl InitiateAuthOutputBuilder {
    ...
    pub fn build(self) -> super::operation::initiate_auth::InitiateAuthOutput {
