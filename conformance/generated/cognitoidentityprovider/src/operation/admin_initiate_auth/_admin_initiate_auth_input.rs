...
impl AdminInitiateAuthInput {
    ...
    pub fn builder() -> super::operation::admin_initiate_auth::builders::AdminInitiateAuthInputBuilder {
        super::operation::admin_initiate_auth::builders::AdminInitiateAuthInputBuilder::default()
    }
}
...
impl AdminInitiateAuthInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::admin_initiate_auth::AdminInitiateAuthInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::admin_initiate_auth::AdminInitiateAuthInput {
