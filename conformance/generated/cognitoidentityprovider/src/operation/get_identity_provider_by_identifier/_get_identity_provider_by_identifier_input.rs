...
impl GetIdentityProviderByIdentifierInput {
    ...
    pub fn builder() -> super::operation::get_identity_provider_by_identifier::builders::GetIdentityProviderByIdentifierInputBuilder {
        super::operation::get_identity_provider_by_identifier::builders::GetIdentityProviderByIdentifierInputBuilder::default()
    }
}
...
impl GetIdentityProviderByIdentifierInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::get_identity_provider_by_identifier::GetIdentityProviderByIdentifierInput,
