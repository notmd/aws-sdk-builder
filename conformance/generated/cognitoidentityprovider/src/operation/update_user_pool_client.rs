    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::update_user_pool_client::UpdateUserPoolClientError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::update_user_pool_client::UpdateUserPoolClientOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateUserPoolClientResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_update_user_pool_client::de_update_user_pool_client_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_update_user_pool_client::de_update_user_pool_client_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateUserPoolClientRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::update_user_pool_client::UpdateUserPoolClientInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::update_user_pool_client::UpdateUserPoolClientInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_update_user_pool_client::ser_update_user_pool_client_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::operation::update_user_pool_client::UpdateUserPoolClientError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::update_user_pool_client::_update_user_pool_client_input::UpdateUserPoolClientInput;

pub use super::operation::update_user_pool_client::_update_user_pool_client_output::UpdateUserPoolClientOutput;
