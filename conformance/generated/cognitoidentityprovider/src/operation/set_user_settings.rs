...
impl SetUserSettings {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::operation::set_user_settings::SetUserSettingsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::set_user_settings::SetUserSettingsError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::set_user_settings::SetUserSettingsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::set_user_settings::SetUserSettingsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetUserSettingsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_set_user_settings::de_set_user_settings_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_set_user_settings::de_set_user_settings_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetUserSettingsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::set_user_settings::SetUserSettingsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::set_user_settings::SetUserSettingsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_set_user_settings::ser_set_user_settings_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::set_user_settings::SetUserSettingsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::set_user_settings::_set_user_settings_input::SetUserSettingsInput;

pub use super::operation::set_user_settings::_set_user_settings_output::SetUserSettingsOutput;
