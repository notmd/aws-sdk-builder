...
pub struct AdminUpdateAuthEventFeedbackInput {
    ...
    pub feedback_value: ::std::option::Option<super::types::FeedbackValueType>,
}
impl AdminUpdateAuthEventFeedbackInput {
    ...
    /// <p>Your feedback to the authentication event. When you provide a <code>FeedbackValue</code> value of <code>valid</code>, you tell Amazon Cognito that you trust a user session where Amazon Cognito has evaluated some level of risk. When you provide a <code>FeedbackValue</code> value of <code>invalid</code>, you tell Amazon Cognito that you don't trust a user session, or you don't believe that Amazon Cognito evaluated a high-enough risk level.</p>
    pub fn feedback_value(&self) -> ::std::option::Option<&super::types::FeedbackValueType> {
...
impl AdminUpdateAuthEventFeedbackInput {
    ...
    pub fn builder() -> super::operation::admin_update_auth_event_feedback::builders::AdminUpdateAuthEventFeedbackInputBuilder {
        super::operation::admin_update_auth_event_feedback::builders::AdminUpdateAuthEventFeedbackInputBuilder::default()
    }
}
...
pub struct AdminUpdateAuthEventFeedbackInputBuilder {
    ...
    pub(crate) feedback_value: ::std::option::Option<super::types::FeedbackValueType>,
}
impl AdminUpdateAuthEventFeedbackInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::admin_update_auth_event_feedback::AdminUpdateAuthEventFeedbackInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::admin_update_auth_event_feedback::AdminUpdateAuthEventFeedbackInput {
