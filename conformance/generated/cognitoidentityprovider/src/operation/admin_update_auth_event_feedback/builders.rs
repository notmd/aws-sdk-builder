...
pub use super::operation::admin_update_auth_event_feedback::_admin_update_auth_event_feedback_input::AdminUpdateAuthEventFeedbackInputBuilder;

pub use super::operation::admin_update_auth_event_feedback::_admin_update_auth_event_feedback_output::AdminUpdateAuthEventFeedbackOutputBuilder;

impl super::operation::admin_update_auth_event_feedback::builders::AdminUpdateAuthEventFeedbackInputBuilder {
...
pub struct AdminUpdateAuthEventFeedbackFluentBuilder {
    ...
    inner: super::operation::admin_update_auth_event_feedback::builders::AdminUpdateAuthEventFeedbackInputBuilder,
...
impl AdminUpdateAuthEventFeedbackFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::admin_update_auth_event_feedback::builders::AdminUpdateAuthEventFeedbackInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::admin_update_auth_event_feedback::AdminUpdateAuthEventFeedback::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::admin_update_auth_event_feedback::AdminUpdateAuthEventFeedback::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn feedback_value(mut self, input: super::types::FeedbackValueType) -> Self {
        self.inner = self.inner.feedback_value(input);
        self
    }
    /// <p>Your feedback to the authentication event. When you provide a <code>FeedbackValue</code> value of <code>valid</code>, you tell Amazon Cognito that you trust a user session where Amazon Cognito has evaluated some level of risk. When you provide a <code>FeedbackValue</code> value of <code>invalid</code>, you tell Amazon Cognito that you don't trust a user session, or you don't believe that Amazon Cognito evaluated a high-enough risk level.</p>
    pub fn set_feedback_value(mut self, input: ::std::option::Option<super::types::FeedbackValueType>) -> Self {
        self.inner = self.inner.set_feedback_value(input);
        self
    }
    /// <p>Your feedback to the authentication event. When you provide a <code>FeedbackValue</code> value of <code>valid</code>, you tell Amazon Cognito that you trust a user session where Amazon Cognito has evaluated some level of risk. When you provide a <code>FeedbackValue</code> value of <code>invalid</code>, you tell Amazon Cognito that you don't trust a user session, or you don't believe that Amazon Cognito evaluated a high-enough risk level.</p>
    pub fn get_feedback_value(&self) -> &::std::option::Option<super::types::FeedbackValueType> {
