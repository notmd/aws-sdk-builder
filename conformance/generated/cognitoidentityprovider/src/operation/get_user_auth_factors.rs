    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_user_auth_factors::GetUserAuthFactorsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_user_auth_factors::GetUserAuthFactorsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetUserAuthFactorsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_user_auth_factors::de_get_user_auth_factors_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_user_auth_factors::de_get_user_auth_factors_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetUserAuthFactorsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_user_auth_factors::GetUserAuthFactorsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_user_auth_factors::GetUserAuthFactorsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_get_user_auth_factors::ser_get_user_auth_factors_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::operation::get_user_auth_factors::GetUserAuthFactorsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_user_auth_factors::_get_user_auth_factors_input::GetUserAuthFactorsInput;

pub use super::operation::get_user_auth_factors::_get_user_auth_factors_output::GetUserAuthFactorsOutput;
