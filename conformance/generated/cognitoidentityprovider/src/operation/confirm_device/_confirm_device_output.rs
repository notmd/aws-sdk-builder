...
impl ConfirmDeviceOutput {
    ...
    pub fn builder() -> super::operation::confirm_device::builders::ConfirmDeviceOutputBuilder {
        super::operation::confirm_device::builders::ConfirmDeviceOutputBuilder::default()
    }
}
...
impl ConfirmDeviceOutputBuilder {
    ...
    pub fn build(self) -> super::operation::confirm_device::ConfirmDeviceOutput {
