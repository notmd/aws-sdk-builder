...
impl CreateUserPoolDomainOutput {
    ...
    pub fn builder() -> super::operation::create_user_pool_domain::builders::CreateUserPoolDomainOutputBuilder {
        super::operation::create_user_pool_domain::builders::CreateUserPoolDomainOutputBuilder::default()
    }
}
...
impl CreateUserPoolDomainOutputBuilder {
    ...
    pub fn build(self) -> super::operation::create_user_pool_domain::CreateUserPoolDomainOutput {
