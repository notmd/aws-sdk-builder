...
impl CreateUserPoolDomainInput {
    ...
    pub fn builder() -> super::operation::create_user_pool_domain::builders::CreateUserPoolDomainInputBuilder {
        super::operation::create_user_pool_domain::builders::CreateUserPoolDomainInputBuilder::default()
    }
}
...
impl CreateUserPoolDomainInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::create_user_pool_domain::CreateUserPoolDomainInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::create_user_pool_domain::CreateUserPoolDomainInput {
            domain: self.domain,
