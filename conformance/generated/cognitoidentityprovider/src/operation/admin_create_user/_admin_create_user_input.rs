...
pub struct AdminCreateUserInput {
    ...
    /// </dd>
    /// </dl>
    pub user_attributes: ::std::option::Option<::std::vec::Vec<super::types::AttributeType>>,
    ...
    pub validation_data: ::std::option::Option<::std::vec::Vec<super::types::AttributeType>>,
    ...
    pub message_action: ::std::option::Option<super::types::MessageActionType>,
    ...
    pub desired_delivery_mediums: ::std::option::Option<::std::vec::Vec<super::types::DeliveryMediumType>>,
...
impl AdminCreateUserInput {
    ...
    pub fn user_attributes(&self) -> &[super::types::AttributeType] {
    ...
    pub fn validation_data(&self) -> &[super::types::AttributeType] {
    ...
    /// <p>Set to <code>RESEND</code> to resend the invitation message to a user that already exists, and to reset the temporary-password duration with a new temporary password. Set to <code>SUPPRESS</code> to suppress sending the message. You can specify only one value.</p>
    pub fn message_action(&self) -> ::std::option::Option<&super::types::MessageActionType> {
    ...
    pub fn desired_delivery_mediums(&self) -> &[super::types::DeliveryMediumType] {
...
impl AdminCreateUserInput {
    ...
    pub fn builder() -> super::operation::admin_create_user::builders::AdminCreateUserInputBuilder {
        super::operation::admin_create_user::builders::AdminCreateUserInputBuilder::default()
    }
}
...
pub struct AdminCreateUserInputBuilder {
    ...
    pub(crate) user_attributes: ::std::option::Option<::std::vec::Vec<super::types::AttributeType>>,
    pub(crate) validation_data: ::std::option::Option<::std::vec::Vec<super::types::AttributeType>>,
    pub(crate) temporary_password: ::std::option::Option<::std::string::String>,
    pub(crate) force_alias_creation: ::std::option::Option<bool>,
    pub(crate) message_action: ::std::option::Option<super::types::MessageActionType>,
    pub(crate) desired_delivery_mediums: ::std::option::Option<::std::vec::Vec<super::types::DeliveryMediumType>>,
...
impl AdminCreateUserInputBuilder {
    ...
    /// </dd>
    /// </dl>
    pub fn user_attributes(mut self, input: super::types::AttributeType) -> Self {
    ...
    /// </dd>
    /// </dl>
    pub fn set_user_attributes(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::AttributeType>>) -> Self {
    ...
    /// </dd>
    /// </dl>
    pub fn get_user_attributes(&self) -> &::std::option::Option<::std::vec::Vec<super::types::AttributeType>> {
    ...
    /// <p>Your Lambda function can analyze this additional data and act on it. Your function can automatically confirm and verify select users or perform external API operations like logging user attributes and validation data to Amazon CloudWatch Logs.</p>
    /// <p>For more information about the pre sign-up Lambda trigger, see <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-lambda-pre-sign-up.html">Pre sign-up Lambda trigger</a>.</p>
    pub fn validation_data(mut self, input: super::types::AttributeType) -> Self {
    ...
    /// <p>Your Lambda function can analyze this additional data and act on it. Your function can automatically confirm and verify select users or perform external API operations like logging user attributes and validation data to Amazon CloudWatch Logs.</p>
    /// <p>For more information about the pre sign-up Lambda trigger, see <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-lambda-pre-sign-up.html">Pre sign-up Lambda trigger</a>.</p>
    pub fn set_validation_data(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::AttributeType>>) -> Self {
    ...
    /// <p>Your Lambda function can analyze this additional data and act on it. Your function can automatically confirm and verify select users or perform external API operations like logging user attributes and validation data to Amazon CloudWatch Logs.</p>
    /// <p>For more information about the pre sign-up Lambda trigger, see <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-lambda-pre-sign-up.html">Pre sign-up Lambda trigger</a>.</p>
    pub fn get_validation_data(&self) -> &::std::option::Option<::std::vec::Vec<super::types::AttributeType>> {
    ...
    /// <p>Set to <code>RESEND</code> to resend the invitation message to a user that already exists, and to reset the temporary-password duration with a new temporary password. Set to <code>SUPPRESS</code> to suppress sending the message. You can specify only one value.</p>
    pub fn message_action(mut self, input: super::types::MessageActionType) -> Self {
        self.message_action = ::std::option::Option::Some(input);
        self
    }
    /// <p>Set to <code>RESEND</code> to resend the invitation message to a user that already exists, and to reset the temporary-password duration with a new temporary password. Set to <code>SUPPRESS</code> to suppress sending the message. You can specify only one value.</p>
    pub fn set_message_action(mut self, input: ::std::option::Option<super::types::MessageActionType>) -> Self {
        self.message_action = input;
        self
    }
    /// <p>Set to <code>RESEND</code> to resend the invitation message to a user that already exists, and to reset the temporary-password duration with a new temporary password. Set to <code>SUPPRESS</code> to suppress sending the message. You can specify only one value.</p>
    pub fn get_message_action(&self) -> &::std::option::Option<super::types::MessageActionType> {
        &self.message_action
    }
    ...
    ///
    /// <p>Specify <code>EMAIL</code> if email will be used to send the welcome message. Specify <code>SMS</code> if the phone number will be used. The default value is <code>SMS</code>. You can specify more than one value.</p>
    pub fn desired_delivery_mediums(mut self, input: super::types::DeliveryMediumType) -> Self {
    ...
    /// <p>Specify <code>EMAIL</code> if email will be used to send the welcome message. Specify <code>SMS</code> if the phone number will be used. The default value is <code>SMS</code>. You can specify more than one value.</p>
    pub fn set_desired_delivery_mediums(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::DeliveryMediumType>>) -> Self {
        self.desired_delivery_mediums = input;
        self
    }
    /// <p>Specify <code>EMAIL</code> if email will be used to send the welcome message. Specify <code>SMS</code> if the phone number will be used. The default value is <code>SMS</code>. You can specify more than one value.</p>
    pub fn get_desired_delivery_mediums(&self) -> &::std::option::Option<::std::vec::Vec<super::types::DeliveryMediumType>> {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::admin_create_user::AdminCreateUserInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::admin_create_user::AdminCreateUserInput {
