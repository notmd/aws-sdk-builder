    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::resend_confirmation_code::ResendConfirmationCodeError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::resend_confirmation_code::ResendConfirmationCodeOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ResendConfirmationCodeResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_resend_confirmation_code::de_resend_confirmation_code_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_resend_confirmation_code::de_resend_confirmation_code_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ResendConfirmationCodeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::resend_confirmation_code::ResendConfirmationCodeInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::resend_confirmation_code::ResendConfirmationCodeInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_resend_confirmation_code::ser_resend_confirmation_code_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::resend_confirmation_code::ResendConfirmationCodeError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::resend_confirmation_code::_resend_confirmation_code_input::ResendConfirmationCodeInput;

pub use super::operation::resend_confirmation_code::_resend_confirmation_code_output::ResendConfirmationCodeOutput;
