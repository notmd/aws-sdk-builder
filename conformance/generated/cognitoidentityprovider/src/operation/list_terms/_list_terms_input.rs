...
impl ListTermsInput {
    /// Creates a new builder-style object to manufacture [`ListTermsInput`](crate::operation::list_terms::ListTermsInput).
    pub fn builder() -> super::operation::list_terms::builders::ListTermsInputBuilder {
        super::operation::list_terms::builders::ListTermsInputBuilder::default()
    }
}
...
impl ListTermsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::list_terms::ListTermsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_terms::ListTermsInput {
