...
pub struct ListTermsOutput {
    ...
    pub terms: ::std::vec::Vec<super::types::TermsDescriptionType>,
...
impl ListTermsOutput {
    /// <p>A summary of the requested terms documents. Includes unique identifiers for later changes to the terms documents.</p>
    pub fn terms(&self) -> &[super::types::TermsDescriptionType] {
        use std::ops::Deref;
        self.terms.deref()
    }
    /// <p>This API operation returns a limited number of results. The pagination token is an identifier that you can present in an additional API request with the same parameters. When you include the pagination token, Amazon Cognito returns the next set of items after the current list. Subsequent requests return a new pagination token. By use of this token, you can paginate through the full list of items.</p>
...
impl ListTermsOutput {
    ...
    pub fn builder() -> super::operation::list_terms::builders::ListTermsOutputBuilder {
        super::operation::list_terms::builders::ListTermsOutputBuilder::default()
    }
}
...
pub struct ListTermsOutputBuilder {
    pub(crate) terms: ::std::option::Option<::std::vec::Vec<super::types::TermsDescriptionType>>,
...
impl ListTermsOutputBuilder {
    ...
    ///
    /// <p>A summary of the requested terms documents. Includes unique identifiers for later changes to the terms documents.</p>
    pub fn terms(mut self, input: super::types::TermsDescriptionType) -> Self {
    ...
    /// <p>A summary of the requested terms documents. Includes unique identifiers for later changes to the terms documents.</p>
    pub fn set_terms(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::TermsDescriptionType>>) -> Self {
        self.terms = input;
        self
    }
    /// <p>A summary of the requested terms documents. Includes unique identifiers for later changes to the terms documents.</p>
    pub fn get_terms(&self) -> &::std::option::Option<::std::vec::Vec<super::types::TermsDescriptionType>> {
        &self.terms
    }
    /// <p>This API operation returns a limited number of results. The pagination token is an identifier that you can present in an additional API request with the same parameters. When you include the pagination token, Amazon Cognito returns the next set of items after the current list. Subsequent requests return a new pagination token. By use of this token, you can paginate through the full list of items.</p>
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::list_terms::ListTermsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_terms::ListTermsOutput {
