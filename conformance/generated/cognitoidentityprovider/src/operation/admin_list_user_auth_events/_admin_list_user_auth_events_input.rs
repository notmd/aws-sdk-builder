...
impl AdminListUserAuthEventsInput {
    ...
    pub fn builder() -> super::operation::admin_list_user_auth_events::builders::AdminListUserAuthEventsInputBuilder {
        super::operation::admin_list_user_auth_events::builders::AdminListUserAuthEventsInputBuilder::default()
    }
}
...
impl AdminListUserAuthEventsInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::admin_list_user_auth_events::AdminListUserAuthEventsInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::admin_list_user_auth_events::AdminListUserAuthEventsInput {
