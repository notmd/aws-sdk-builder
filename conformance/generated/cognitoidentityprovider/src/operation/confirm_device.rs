...
impl ConfirmDevice {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::operation::confirm_device::ConfirmDeviceOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::confirm_device::ConfirmDeviceError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::confirm_device::ConfirmDeviceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::confirm_device::ConfirmDeviceOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ConfirmDeviceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_confirm_device::de_confirm_device_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_confirm_device::de_confirm_device_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ConfirmDeviceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::confirm_device::ConfirmDeviceInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::confirm_device::ConfirmDeviceInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_confirm_device::ser_confirm_device_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::confirm_device::ConfirmDeviceError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::confirm_device::_confirm_device_input::ConfirmDeviceInput;

pub use super::operation::confirm_device::_confirm_device_output::ConfirmDeviceOutput;
