...
pub struct CreateIdentityProviderInput {
    ...
    pub provider_type: ::std::option::Option<super::types::IdentityProviderTypeType>,
...
impl CreateIdentityProviderInput {
    ...
    /// <p>The type of IdP that you want to add. Amazon Cognito supports OIDC, SAML 2.0, Login With Amazon, Sign In With Apple, Google, and Facebook IdPs.</p>
    pub fn provider_type(&self) -> ::std::option::Option<&super::types::IdentityProviderTypeType> {
...
impl CreateIdentityProviderInput {
    ...
    pub fn builder() -> super::operation::create_identity_provider::builders::CreateIdentityProviderInputBuilder {
        super::operation::create_identity_provider::builders::CreateIdentityProviderInputBuilder::default()
    }
}
...
pub struct CreateIdentityProviderInputBuilder {
    ...
    pub(crate) provider_type: ::std::option::Option<super::types::IdentityProviderTypeType>,
...
impl CreateIdentityProviderInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::create_identity_provider::CreateIdentityProviderInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::create_identity_provider::CreateIdentityProviderInput {
