...
impl SetUserSettingsInput {
    ...
    pub fn builder() -> super::operation::set_user_settings::builders::SetUserSettingsInputBuilder {
        super::operation::set_user_settings::builders::SetUserSettingsInputBuilder::default()
    }
}
...
impl SetUserSettingsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::set_user_settings::SetUserSettingsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::set_user_settings::SetUserSettingsInput {
