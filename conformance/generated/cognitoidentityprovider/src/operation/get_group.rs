    ...
    > {
        let map_err =
            |err: ::aws_smithy_runtime_api::client::result::SdkError<
                ...
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >| { err.map_service_error(|err| err.downcast::<super::operation::get_group::GetGroupError>().expect("correct error type")) };
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_group::GetGroupOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetGroupResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_group::de_get_group_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_group::de_get_group_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetGroupRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::get_group::GetGroupInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_group::GetGroupInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_get_group::ser_get_group_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::get_group::GetGroupError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_group::_get_group_input::GetGroupInput;

pub use super::operation::get_group::_get_group_output::GetGroupOutput;
