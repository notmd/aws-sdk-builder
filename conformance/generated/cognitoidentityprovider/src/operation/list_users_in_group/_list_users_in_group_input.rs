...
impl ListUsersInGroupInput {
    ...
    pub fn builder() -> super::operation::list_users_in_group::builders::ListUsersInGroupInputBuilder {
        super::operation::list_users_in_group::builders::ListUsersInGroupInputBuilder::default()
    }
}
...
impl ListUsersInGroupInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_users_in_group::ListUsersInGroupInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_users_in_group::ListUsersInGroupInput {
