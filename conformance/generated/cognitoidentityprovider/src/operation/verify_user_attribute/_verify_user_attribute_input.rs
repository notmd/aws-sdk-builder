...
impl VerifyUserAttributeInput {
    ...
    pub fn builder() -> super::operation::verify_user_attribute::builders::VerifyUserAttributeInputBuilder {
        super::operation::verify_user_attribute::builders::VerifyUserAttributeInputBuilder::default()
    }
}
...
impl VerifyUserAttributeInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::verify_user_attribute::VerifyUserAttributeInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::verify_user_attribute::VerifyUserAttributeInput {
