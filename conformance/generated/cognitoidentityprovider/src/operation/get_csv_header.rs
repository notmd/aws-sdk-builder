    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_csv_header::GetCSVHeaderError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_csv_header::GetCsvHeaderOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetCSVHeaderResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_csv_header::de_get_csv_header_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_csv_header::de_get_csv_header_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetCSVHeaderRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_csv_header::GetCsvHeaderInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_csv_header::GetCsvHeaderInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_get_csv_header::ser_get_csv_header_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::get_csv_header::GetCSVHeaderError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_csv_header::_get_csv_header_input::GetCsvHeaderInput;

pub use super::operation::get_csv_header::_get_csv_header_output::GetCsvHeaderOutput;
