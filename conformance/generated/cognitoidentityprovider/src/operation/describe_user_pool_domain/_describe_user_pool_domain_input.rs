...
impl DescribeUserPoolDomainInput {
    ...
    pub fn builder() -> super::operation::describe_user_pool_domain::builders::DescribeUserPoolDomainInputBuilder {
        super::operation::describe_user_pool_domain::builders::DescribeUserPoolDomainInputBuilder::default()
    }
}
...
impl DescribeUserPoolDomainInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::describe_user_pool_domain::DescribeUserPoolDomainInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::describe_user_pool_domain::DescribeUserPoolDomainInput { domain: self.domain })
    }
}
