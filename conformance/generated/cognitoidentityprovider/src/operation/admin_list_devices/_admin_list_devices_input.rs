...
impl AdminListDevicesInput {
    ...
    pub fn builder() -> super::operation::admin_list_devices::builders::AdminListDevicesInputBuilder {
        super::operation::admin_list_devices::builders::AdminListDevicesInputBuilder::default()
    }
}
...
impl AdminListDevicesInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::admin_list_devices::AdminListDevicesInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::admin_list_devices::AdminListDevicesInput {
