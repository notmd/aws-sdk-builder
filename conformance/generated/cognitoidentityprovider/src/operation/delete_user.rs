...
impl DeleteUser {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::operation::delete_user::DeleteUserOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::delete_user::DeleteUserError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_user::DeleteUserError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_user::DeleteUserOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteUserResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_user::de_delete_user_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_user::de_delete_user_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteUserRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::delete_user::DeleteUserInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_user::DeleteUserInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_delete_user::ser_delete_user_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::delete_user::DeleteUserError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_user::_delete_user_input::DeleteUserInput;

pub use super::operation::delete_user::_delete_user_output::DeleteUserOutput;
