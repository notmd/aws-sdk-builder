...
impl AdminDeleteUserInput {
    ...
    pub fn builder() -> super::operation::admin_delete_user::builders::AdminDeleteUserInputBuilder {
        super::operation::admin_delete_user::builders::AdminDeleteUserInputBuilder::default()
    }
}
...
impl AdminDeleteUserInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::admin_delete_user::AdminDeleteUserInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::admin_delete_user::AdminDeleteUserInput {
