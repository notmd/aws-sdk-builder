...
impl ListUsersInGroup {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::operation::list_users_in_group::ListUsersInGroupOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::list_users_in_group::ListUsersInGroupError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_users_in_group::ListUsersInGroupError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_users_in_group::ListUsersInGroupOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListUsersInGroupResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_users_in_group::de_list_users_in_group_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_users_in_group::de_list_users_in_group_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListUsersInGroupRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_users_in_group::ListUsersInGroupInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_users_in_group::ListUsersInGroupInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_list_users_in_group::ser_list_users_in_group_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::list_users_in_group::ListUsersInGroupError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_users_in_group::_list_users_in_group_input::ListUsersInGroupInput;

pub use super::operation::list_users_in_group::_list_users_in_group_output::ListUsersInGroupOutput;
