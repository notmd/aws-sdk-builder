...
pub fn ser_create_user_pool_input_input(
    ...
    if let Some(var_2) = &input.policies {
        ...
        super::protocol_serde::shape_user_pool_policy_type::ser_user_pool_policy_type(&mut object_3, var_2)?;
        object_3.finish();
    }
    ...
    if let Some(var_5) = &input.lambda_config {
        ...
        super::protocol_serde::shape_lambda_config_type::ser_lambda_config_type(&mut object_6, var_5)?;
        object_6.finish();
    }
    ...
    if let Some(var_19) = &input.verification_message_template {
        ...
        super::protocol_serde::shape_verification_message_template_type::ser_verification_message_template_type(&mut object_20, var_19)?;
        object_20.finish();
    }
    ...
    if let Some(var_23) = &input.user_attribute_update_settings {
        ...
        super::protocol_serde::shape_user_attribute_update_settings_type::ser_user_attribute_update_settings_type(&mut object_24, var_23)?;
        object_24.finish();
    }
    if let Some(var_25) = &input.device_configuration {
        #[allow(unused_mut)]
        let mut object_26 = object.key("DeviceConfiguration").start_object();
        super::protocol_serde::shape_device_configuration_type::ser_device_configuration_type(&mut object_26, var_25)?;
        object_26.finish();
    }
    if let Some(var_27) = &input.email_configuration {
        #[allow(unused_mut)]
        let mut object_28 = object.key("EmailConfiguration").start_object();
        super::protocol_serde::shape_email_configuration_type::ser_email_configuration_type(&mut object_28, var_27)?;
        object_28.finish();
    }
    if let Some(var_29) = &input.sms_configuration {
        #[allow(unused_mut)]
        let mut object_30 = object.key("SmsConfiguration").start_object();
        super::protocol_serde::shape_sms_configuration_type::ser_sms_configuration_type(&mut object_30, var_29)?;
        object_30.finish();
    }
    ...
    if let Some(var_35) = &input.admin_create_user_config {
        ...
        super::protocol_serde::shape_admin_create_user_config_type::ser_admin_create_user_config_type(&mut object_36, var_35)?;
        object_36.finish();
    }
        ...
        for item_39 in var_37 {
            {
                ...
                super::protocol_serde::shape_schema_attribute_type::ser_schema_attribute_type(&mut object_40, item_39)?;
                object_40.finish();
            }
        }
        array_38.finish();
    ...
    if let Some(var_41) = &input.user_pool_add_ons {
        ...
        super::protocol_serde::shape_user_pool_add_ons_type::ser_user_pool_add_ons_type(&mut object_42, var_41)?;
        object_42.finish();
    }
    if let Some(var_43) = &input.username_configuration {
        #[allow(unused_mut)]
        let mut object_44 = object.key("UsernameConfiguration").start_object();
        super::protocol_serde::shape_username_configuration_type::ser_username_configuration_type(&mut object_44, var_43)?;
        object_44.finish();
    }
    if let Some(var_45) = &input.account_recovery_setting {
        #[allow(unused_mut)]
        let mut object_46 = object.key("AccountRecoverySetting").start_object();
        super::protocol_serde::shape_account_recovery_setting_type::ser_account_recovery_setting_type(&mut object_46, var_45)?;
        object_46.finish();
    }
    ...
    if let Some(var_48) = &input.key_configuration {
        ...
        super::protocol_serde::shape_key_configuration_type::ser_key_configuration_type(&mut object_49, var_48)?;
        object_49.finish();
    }
    if let Some(var_50) = &input.issuer_configuration {
        #[allow(unused_mut)]
        let mut object_51 = object.key("IssuerConfiguration").start_object();
        super::protocol_serde::shape_issuer_configuration_type::ser_issuer_configuration_type(&mut object_51, var_50)?;
        object_51.finish();
    }
    Ok(())
}
