...
use super::super::endpoint_lib::partition::deser::deserialize_partitions;
...
mod deser {
    use super::super::endpoint_lib::partition::{PartitionMetadata, PartitionMetadataBuilder, PartitionOutputOverride, PartitionResolver};
