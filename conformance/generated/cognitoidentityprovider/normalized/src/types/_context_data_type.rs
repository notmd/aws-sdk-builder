...
pub struct ContextDataType {
    ...
    pub http_headers: ::std::vec::Vec<super::super::types::HttpHeader>,
...
impl ContextDataType {
    ...
    /// <p>The HTTP headers from your user's authentication request.</p>
    pub fn http_headers(&self) -> &[super::super::types::HttpHeader] {
        use std::ops::Deref;
...
impl ContextDataType {
    ...
    pub fn builder() -> super::super::types::builders::ContextDataTypeBuilder {
        super::super::types::builders::ContextDataTypeBuilder::default()
    }
}
...
pub struct ContextDataTypeBuilder {
    ...
    pub(crate) http_headers: ::std::option::Option<::std::vec::Vec<super::super::types::HttpHeader>>,
...
impl ContextDataTypeBuilder {
    ...
    ///
    /// <p>The HTTP headers from your user's authentication request.</p>
    pub fn http_headers(mut self, input: super::super::types::HttpHeader) -> Self {
    ...
    /// <p>The HTTP headers from your user's authentication request.</p>
    pub fn set_http_headers(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::HttpHeader>>) -> Self {
        self.http_headers = input;
        self
    }
    /// <p>The HTTP headers from your user's authentication request.</p>
    pub fn get_http_headers(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::HttpHeader>> {
        &self.http_headers
    }
    /// <p>Encoded device-fingerprint details that your app collected with the Amazon Cognito context data collection library. For more information, see <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pool-settings-adaptive-authentication.html#user-pool-settings-adaptive-authentication-device-fingerprint">Adding user device and session data to API requests</a>.</p>
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::ContextDataType, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::ContextDataType {
