...
pub struct AssetType {
    ...
    pub category: super::super::types::AssetCategoryType,
    ...
    pub color_mode: super::super::types::ColorSchemeModeType,
    /// <p>The file type of the image file.</p>
    pub extension: super::super::types::AssetExtensionType,
...
impl AssetType {
    /// <p>The category that the image corresponds to in your managed login configuration. Managed login has asset categories for different types of logos, backgrounds, and icons.</p>
    pub fn category(&self) -> &super::super::types::AssetCategoryType {
        &self.category
    }
    /// <p>The display-mode target of the asset: light, dark, or browser-adaptive. For example, Amazon Cognito displays a dark-mode image only when the browser or application is in dark mode, but displays a browser-adaptive file in all contexts.</p>
    pub fn color_mode(&self) -> &super::super::types::ColorSchemeModeType {
        &self.color_mode
    }
    /// <p>The file type of the image file.</p>
    pub fn extension(&self) -> &super::super::types::AssetExtensionType {
        &self.extension
    }
    /// <p>The image file, in Base64-encoded binary.</p>
...
impl AssetType {
    ...
    pub fn builder() -> super::super::types::builders::AssetTypeBuilder {
        super::super::types::builders::AssetTypeBuilder::default()
    }
}
...
pub struct AssetTypeBuilder {
    pub(crate) category: ::std::option::Option<super::super::types::AssetCategoryType>,
    pub(crate) color_mode: ::std::option::Option<super::super::types::ColorSchemeModeType>,
    pub(crate) extension: ::std::option::Option<super::super::types::AssetExtensionType>,
...
impl AssetTypeBuilder {
    ...
    pub fn category(mut self, input: super::super::types::AssetCategoryType) -> Self {
        self.category = ::std::option::Option::Some(input);
        self
    }
    /// <p>The category that the image corresponds to in your managed login configuration. Managed login has asset categories for different types of logos, backgrounds, and icons.</p>
    pub fn set_category(mut self, input: ::std::option::Option<super::super::types::AssetCategoryType>) -> Self {
        self.category = input;
        self
    }
    /// <p>The category that the image corresponds to in your managed login configuration. Managed login has asset categories for different types of logos, backgrounds, and icons.</p>
    pub fn get_category(&self) -> &::std::option::Option<super::super::types::AssetCategoryType> {
        &self.category
    }
    /// <p>The display-mode target of the asset: light, dark, or browser-adaptive. For example, Amazon Cognito displays a dark-mode image only when the browser or application is in dark mode, but displays a browser-adaptive file in all contexts.</p>
    /// This field is required.
    pub fn color_mode(mut self, input: super::super::types::ColorSchemeModeType) -> Self {
        self.color_mode = ::std::option::Option::Some(input);
        self
    }
    /// <p>The display-mode target of the asset: light, dark, or browser-adaptive. For example, Amazon Cognito displays a dark-mode image only when the browser or application is in dark mode, but displays a browser-adaptive file in all contexts.</p>
    pub fn set_color_mode(mut self, input: ::std::option::Option<super::super::types::ColorSchemeModeType>) -> Self {
        self.color_mode = input;
        self
    }
    /// <p>The display-mode target of the asset: light, dark, or browser-adaptive. For example, Amazon Cognito displays a dark-mode image only when the browser or application is in dark mode, but displays a browser-adaptive file in all contexts.</p>
    pub fn get_color_mode(&self) -> &::std::option::Option<super::super::types::ColorSchemeModeType> {
        &self.color_mode
    }
    /// <p>The file type of the image file.</p>
    /// This field is required.
    pub fn extension(mut self, input: super::super::types::AssetExtensionType) -> Self {
        self.extension = ::std::option::Option::Some(input);
        self
    }
    /// <p>The file type of the image file.</p>
    pub fn set_extension(mut self, input: ::std::option::Option<super::super::types::AssetExtensionType>) -> Self {
        self.extension = input;
        self
    }
    /// <p>The file type of the image file.</p>
    pub fn get_extension(&self) -> &::std::option::Option<super::super::types::AssetExtensionType> {
        &self.extension
    }
    /// <p>The image file, in Base64-encoded binary.</p>
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::AssetType, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::AssetType {
