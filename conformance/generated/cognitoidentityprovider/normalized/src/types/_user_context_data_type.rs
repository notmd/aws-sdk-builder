...
impl UserContextDataType {
    ...
    pub fn builder() -> super::super::types::builders::UserContextDataTypeBuilder {
        super::super::types::builders::UserContextDataTypeBuilder::default()
    }
}
...
impl UserContextDataTypeBuilder {
    ...
    pub fn build(self) -> super::super::types::UserContextDataType {
        super::super::types::UserContextDataType {
