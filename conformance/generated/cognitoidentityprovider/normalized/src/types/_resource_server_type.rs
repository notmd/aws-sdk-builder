...
pub struct ResourceServerType {
    ...
    pub scopes: ::std::option::Option<::std::vec::Vec<super::super::types::ResourceServerScopeType>>,
}
impl ResourceServerType {
    ...
    pub fn scopes(&self) -> &[super::super::types::ResourceServerScopeType] {
...
impl ResourceServerType {
    ...
    pub fn builder() -> super::super::types::builders::ResourceServerTypeBuilder {
        super::super::types::builders::ResourceServerTypeBuilder::default()
    }
}
...
pub struct ResourceServerTypeBuilder {
    ...
    pub(crate) scopes: ::std::option::Option<::std::vec::Vec<super::super::types::ResourceServerScopeType>>,
}
impl ResourceServerTypeBuilder {
    ...
    ///
    /// <p>A list of scopes that are defined for the resource server.</p>
    pub fn scopes(mut self, input: super::super::types::ResourceServerScopeType) -> Self {
    ...
    /// <p>A list of scopes that are defined for the resource server.</p>
    pub fn set_scopes(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::ResourceServerScopeType>>) -> Self {
        self.scopes = input;
        self
    }
    /// <p>A list of scopes that are defined for the resource server.</p>
    pub fn get_scopes(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::ResourceServerScopeType>> {
        &self.scopes
    }
    /// Consumes the builder and constructs a [`ResourceServerType`](crate::types::ResourceServerType).
    pub fn build(self) -> super::super::types::ResourceServerType {
        super::super::types::ResourceServerType {
