...
pub struct RiskConfigurationType {
    ...
    pub compromised_credentials_risk_configuration: ::std::option::Option<super::super::types::CompromisedCredentialsRiskConfigurationType>,
    /// <p>The settings for automated responses and notification templates for adaptive authentication with threat protection.</p>
    pub account_takeover_risk_configuration: ::std::option::Option<super::super::types::AccountTakeoverRiskConfigurationType>,
    /// <p>Exceptions to the risk evaluation configuration, including always-allow and always-block IP address ranges.</p>
    pub risk_exception_configuration: ::std::option::Option<super::super::types::RiskExceptionConfigurationType>,
...
impl RiskConfigurationType {
    ...
    /// <p>The settings for automated responses and notification templates for adaptive authentication with threat protection.</p>
    pub fn account_takeover_risk_configuration(&self) -> ::std::option::Option<&super::super::types::AccountTakeoverRiskConfigurationType> {
        self.account_takeover_risk_configuration.as_ref()
    }
    /// <p>Exceptions to the risk evaluation configuration, including always-allow and always-block IP address ranges.</p>
    pub fn risk_exception_configuration(&self) -> ::std::option::Option<&super::super::types::RiskExceptionConfigurationType> {
...
impl RiskConfigurationType {
    ...
    pub fn builder() -> super::super::types::builders::RiskConfigurationTypeBuilder {
        super::super::types::builders::RiskConfigurationTypeBuilder::default()
    }
}
...
pub struct RiskConfigurationTypeBuilder {
    ...
    pub(crate) compromised_credentials_risk_configuration: ::std::option::Option<super::super::types::CompromisedCredentialsRiskConfigurationType>,
    pub(crate) account_takeover_risk_configuration: ::std::option::Option<super::super::types::AccountTakeoverRiskConfigurationType>,
    pub(crate) risk_exception_configuration: ::std::option::Option<super::super::types::RiskExceptionConfigurationType>,
...
impl RiskConfigurationTypeBuilder {
    ...
    /// <p>Settings for compromised-credentials actions and authentication types with threat protection in full-function <code>ENFORCED</code> mode.</p>
    pub fn compromised_credentials_risk_configuration(mut self, input: super::super::types::CompromisedCredentialsRiskConfigurationType) -> Self {
    ...
    pub fn set_compromised_credentials_risk_configuration(
        mut self,
        input: ::std::option::Option<super::super::types::CompromisedCredentialsRiskConfigurationType>,
    ) -> Self {
    ...
    /// <p>The settings for automated responses and notification templates for adaptive authentication with threat protection.</p>
    pub fn account_takeover_risk_configuration(mut self, input: super::super::types::AccountTakeoverRiskConfigurationType) -> Self {
    ...
    pub fn set_account_takeover_risk_configuration(
        mut self,
        input: ::std::option::Option<super::super::types::AccountTakeoverRiskConfigurationType>,
    ) -> Self {
        self.account_takeover_risk_configuration = input;
        self
    }
    /// <p>The settings for automated responses and notification templates for adaptive authentication with threat protection.</p>
    pub fn get_account_takeover_risk_configuration(&self) -> &::std::option::Option<super::super::types::AccountTakeoverRiskConfigurationType> {
        &self.account_takeover_risk_configuration
    }
    /// <p>Exceptions to the risk evaluation configuration, including always-allow and always-block IP address ranges.</p>
    pub fn risk_exception_configuration(mut self, input: super::super::types::RiskExceptionConfigurationType) -> Self {
        self.risk_exception_configuration = ::std::option::Option::Some(input);
        self
    }
    /// <p>Exceptions to the risk evaluation configuration, including always-allow and always-block IP address ranges.</p>
    pub fn set_risk_exception_configuration(mut self, input: ::std::option::Option<super::super::types::RiskExceptionConfigurationType>) -> Self {
        self.risk_exception_configuration = input;
        self
    }
    /// <p>Exceptions to the risk evaluation configuration, including always-allow and always-block IP address ranges.</p>
    pub fn get_risk_exception_configuration(&self) -> &::std::option::Option<super::super::types::RiskExceptionConfigurationType> {
    ...
    pub fn build(self) -> super::super::types::RiskConfigurationType {
        super::super::types::RiskConfigurationType {
