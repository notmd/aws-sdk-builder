...
impl EmailMfaConfigType {
    ...
    pub fn builder() -> super::super::types::builders::EmailMfaConfigTypeBuilder {
        super::super::types::builders::EmailMfaConfigTypeBuilder::default()
    }
}
...
impl EmailMfaConfigTypeBuilder {
    ...
    pub fn build(self) -> super::super::types::EmailMfaConfigType {
        super::super::types::EmailMfaConfigType {
