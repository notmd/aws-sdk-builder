...
impl NotifyEmailType {
    ...
    pub fn builder() -> super::super::types::builders::NotifyEmailTypeBuilder {
        super::super::types::builders::NotifyEmailTypeBuilder::default()
    }
}
...
impl NotifyEmailTypeBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::NotifyEmailType, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::NotifyEmailType {
