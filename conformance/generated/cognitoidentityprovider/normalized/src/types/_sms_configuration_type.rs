...
pub struct SmsConfigurationType {
    ...
    pub eums_sms: ::std::option::Option<super::super::types::EumsSmsConfigurationType>,
}
impl SmsConfigurationType {
    ...
    /// <p>The configuration for sending SMS messages through Amazon Web Services End User Messaging SMS, as an alternative to Amazon SNS. In a user pool, provide either the Amazon SNS configuration (<code>SnsCallerArn</code>) or this configuration, but not both. In Amazon Web Services Regions where Amazon SNS is not available, this configuration is required.</p>
    pub fn eums_sms(&self) -> ::std::option::Option<&super::super::types::EumsSmsConfigurationType> {
...
impl SmsConfigurationType {
    ...
    pub fn builder() -> super::super::types::builders::SmsConfigurationTypeBuilder {
        super::super::types::builders::SmsConfigurationTypeBuilder::default()
    }
}
...
pub struct SmsConfigurationTypeBuilder {
    ...
    pub(crate) eums_sms: ::std::option::Option<super::super::types::EumsSmsConfigurationType>,
}
impl SmsConfigurationTypeBuilder {
    ...
    /// <p>The configuration for sending SMS messages through Amazon Web Services End User Messaging SMS, as an alternative to Amazon SNS. In a user pool, provide either the Amazon SNS configuration (<code>SnsCallerArn</code>) or this configuration, but not both. In Amazon Web Services Regions where Amazon SNS is not available, this configuration is required.</p>
    pub fn eums_sms(mut self, input: super::super::types::EumsSmsConfigurationType) -> Self {
        self.eums_sms = ::std::option::Option::Some(input);
        self
    }
    /// <p>The configuration for sending SMS messages through Amazon Web Services End User Messaging SMS, as an alternative to Amazon SNS. In a user pool, provide either the Amazon SNS configuration (<code>SnsCallerArn</code>) or this configuration, but not both. In Amazon Web Services Regions where Amazon SNS is not available, this configuration is required.</p>
    pub fn set_eums_sms(mut self, input: ::std::option::Option<super::super::types::EumsSmsConfigurationType>) -> Self {
        self.eums_sms = input;
        self
    }
    /// <p>The configuration for sending SMS messages through Amazon Web Services End User Messaging SMS, as an alternative to Amazon SNS. In a user pool, provide either the Amazon SNS configuration (<code>SnsCallerArn</code>) or this configuration, but not both. In Amazon Web Services Regions where Amazon SNS is not available, this configuration is required.</p>
    pub fn get_eums_sms(&self) -> &::std::option::Option<super::super::types::EumsSmsConfigurationType> {
        &self.eums_sms
    }
    /// Consumes the builder and constructs a [`SmsConfigurationType`](crate::types::SmsConfigurationType).
    pub fn build(self) -> super::super::types::SmsConfigurationType {
        super::super::types::SmsConfigurationType {
