...
pub struct LogDeliveryConfigurationType {
    ...
    pub log_configurations: ::std::vec::Vec<super::super::types::LogConfigurationType>,
}
impl LogDeliveryConfigurationType {
    ...
    /// <p>A logging destination of a user pool. User pools can have multiple logging destinations for message-delivery and user-activity logs.</p>
    pub fn log_configurations(&self) -> &[super::super::types::LogConfigurationType] {
        use std::ops::Deref;
...
impl LogDeliveryConfigurationType {
    ...
    pub fn builder() -> super::super::types::builders::LogDeliveryConfigurationTypeBuilder {
        super::super::types::builders::LogDeliveryConfigurationTypeBuilder::default()
    }
}
...
pub struct LogDeliveryConfigurationTypeBuilder {
    ...
    pub(crate) log_configurations: ::std::option::Option<::std::vec::Vec<super::super::types::LogConfigurationType>>,
}
impl LogDeliveryConfigurationTypeBuilder {
    ...
    ///
    /// <p>A logging destination of a user pool. User pools can have multiple logging destinations for message-delivery and user-activity logs.</p>
    pub fn log_configurations(mut self, input: super::super::types::LogConfigurationType) -> Self {
    ...
    /// <p>A logging destination of a user pool. User pools can have multiple logging destinations for message-delivery and user-activity logs.</p>
    pub fn set_log_configurations(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::LogConfigurationType>>) -> Self {
        self.log_configurations = input;
        self
    }
    /// <p>A logging destination of a user pool. User pools can have multiple logging destinations for message-delivery and user-activity logs.</p>
    pub fn get_log_configurations(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::LogConfigurationType>> {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::LogDeliveryConfigurationType, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::LogDeliveryConfigurationType {
