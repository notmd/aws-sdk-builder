...
impl SmsMfaConfigType {
    ...
    pub fn builder() -> super::super::types::builders::SmsMfaConfigTypeBuilder {
        super::super::types::builders::SmsMfaConfigTypeBuilder::default()
    }
}
...
impl SmsMfaConfigTypeBuilder {
    ...
    pub fn build(self) -> super::super::types::SmsMfaConfigType {
        super::super::types::SmsMfaConfigType {
