...
pub struct UserPoolAddOnsType {
    ...
    pub advanced_security_mode: super::super::types::AdvancedSecurityModeType,
    ...
    pub advanced_security_additional_flows: ::std::option::Option<super::super::types::AdvancedSecurityAdditionalFlowsType>,
}
impl UserPoolAddOnsType {
    /// <p>The operating mode of threat protection for standard authentication types in your user pool, including username-password and secure remote password (SRP) authentication.</p>
    pub fn advanced_security_mode(&self) -> &super::super::types::AdvancedSecurityModeType {
        &self.advanced_security_mode
    }
    /// <p>Threat protection configuration options for additional authentication types in your user pool, including custom authentication.</p>
    pub fn advanced_security_additional_flows(&self) -> ::std::option::Option<&super::super::types::AdvancedSecurityAdditionalFlowsType> {
...
impl UserPoolAddOnsType {
    ...
    pub fn builder() -> super::super::types::builders::UserPoolAddOnsTypeBuilder {
        super::super::types::builders::UserPoolAddOnsTypeBuilder::default()
    }
}
...
pub struct UserPoolAddOnsTypeBuilder {
    pub(crate) advanced_security_mode: ::std::option::Option<super::super::types::AdvancedSecurityModeType>,
    pub(crate) advanced_security_additional_flows: ::std::option::Option<super::super::types::AdvancedSecurityAdditionalFlowsType>,
}
impl UserPoolAddOnsTypeBuilder {
    /// <p>The operating mode of threat protection for standard authentication types in your user pool, including username-password and secure remote password (SRP) authentication.</p>
    /// This field is required.
    pub fn advanced_security_mode(mut self, input: super::super::types::AdvancedSecurityModeType) -> Self {
        self.advanced_security_mode = ::std::option::Option::Some(input);
        self
    }
    /// <p>The operating mode of threat protection for standard authentication types in your user pool, including username-password and secure remote password (SRP) authentication.</p>
    pub fn set_advanced_security_mode(mut self, input: ::std::option::Option<super::super::types::AdvancedSecurityModeType>) -> Self {
        self.advanced_security_mode = input;
        self
    }
    /// <p>The operating mode of threat protection for standard authentication types in your user pool, including username-password and secure remote password (SRP) authentication.</p>
    pub fn get_advanced_security_mode(&self) -> &::std::option::Option<super::super::types::AdvancedSecurityModeType> {
        &self.advanced_security_mode
    }
    /// <p>Threat protection configuration options for additional authentication types in your user pool, including custom authentication.</p>
    pub fn advanced_security_additional_flows(mut self, input: super::super::types::AdvancedSecurityAdditionalFlowsType) -> Self {
    ...
    /// <p>Threat protection configuration options for additional authentication types in your user pool, including custom authentication.</p>
    pub fn get_advanced_security_additional_flows(&self) -> &::std::option::Option<super::super::types::AdvancedSecurityAdditionalFlowsType> {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::UserPoolAddOnsType, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::UserPoolAddOnsType {
