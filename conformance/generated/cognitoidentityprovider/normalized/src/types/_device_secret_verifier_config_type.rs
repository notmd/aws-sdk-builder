...
impl DeviceSecretVerifierConfigType {
    ...
    pub fn builder() -> super::super::types::builders::DeviceSecretVerifierConfigTypeBuilder {
        super::super::types::builders::DeviceSecretVerifierConfigTypeBuilder::default()
    }
}
...
impl DeviceSecretVerifierConfigTypeBuilder {
    ...
    pub fn build(self) -> super::super::types::DeviceSecretVerifierConfigType {
        super::super::types::DeviceSecretVerifierConfigType {
