...
impl SmsMfaSettingsType {
    ...
    pub fn builder() -> super::super::types::builders::SmsMfaSettingsTypeBuilder {
        super::super::types::builders::SmsMfaSettingsTypeBuilder::default()
    }
}
...
impl SmsMfaSettingsTypeBuilder {
    ...
    pub fn build(self) -> super::super::types::SmsMfaSettingsType {
        super::super::types::SmsMfaSettingsType {
