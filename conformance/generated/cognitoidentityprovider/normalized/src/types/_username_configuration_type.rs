...
impl UsernameConfigurationType {
    ...
    pub fn builder() -> super::super::types::builders::UsernameConfigurationTypeBuilder {
        super::super::types::builders::UsernameConfigurationTypeBuilder::default()
    }
}
...
impl UsernameConfigurationTypeBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::UsernameConfigurationType, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::UsernameConfigurationType {
