...
pub struct RefreshTokenRotationType {
    ...
    pub feature: super::super::types::FeatureType,
...
impl RefreshTokenRotationType {
    /// <p>The state of refresh token rotation for the current app client.</p>
    pub fn feature(&self) -> &super::super::types::FeatureType {
        &self.feature
    }
    /// <p>When you request a token refresh with <code>GetTokensFromRefreshToken</code>, the original refresh token that you're rotating out can remain valid for a period of time of up to 60 seconds. This allows for client-side retries. When <code>RetryGracePeriodSeconds</code> is <code>0</code>, the grace period is disabled and a successful request immediately invalidates the submitted refresh token.</p>
...
impl RefreshTokenRotationType {
    ...
    pub fn builder() -> super::super::types::builders::RefreshTokenRotationTypeBuilder {
        super::super::types::builders::RefreshTokenRotationTypeBuilder::default()
    }
}
...
pub struct RefreshTokenRotationTypeBuilder {
    pub(crate) feature: ::std::option::Option<super::super::types::FeatureType>,
    pub(crate) retry_grace_period_seconds: ::std::option::Option<i32>,
}
impl RefreshTokenRotationTypeBuilder {
    /// <p>The state of refresh token rotation for the current app client.</p>
    /// This field is required.
    pub fn feature(mut self, input: super::super::types::FeatureType) -> Self {
        self.feature = ::std::option::Option::Some(input);
        self
    }
    /// <p>The state of refresh token rotation for the current app client.</p>
    pub fn set_feature(mut self, input: ::std::option::Option<super::super::types::FeatureType>) -> Self {
        self.feature = input;
        self
    }
    /// <p>The state of refresh token rotation for the current app client.</p>
    pub fn get_feature(&self) -> &::std::option::Option<super::super::types::FeatureType> {
        &self.feature
    }
    /// <p>When you request a token refresh with <code>GetTokensFromRefreshToken</code>, the original refresh token that you're rotating out can remain valid for a period of time of up to 60 seconds. This allows for client-side retries. When <code>RetryGracePeriodSeconds</code> is <code>0</code>, the grace period is disabled and a successful request immediately invalidates the submitted refresh token.</p>
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::RefreshTokenRotationType, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::RefreshTokenRotationType {
