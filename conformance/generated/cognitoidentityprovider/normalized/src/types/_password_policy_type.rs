...
impl PasswordPolicyType {
    ...
    pub fn builder() -> super::super::types::builders::PasswordPolicyTypeBuilder {
        super::super::types::builders::PasswordPolicyTypeBuilder::default()
    }
}
...
impl PasswordPolicyTypeBuilder {
    ...
    pub fn build(self) -> super::super::types::PasswordPolicyType {
        super::super::types::PasswordPolicyType {
