...
impl NewDeviceMetadataType {
    ...
    pub fn builder() -> super::super::types::builders::NewDeviceMetadataTypeBuilder {
        super::super::types::builders::NewDeviceMetadataTypeBuilder::default()
    }
}
...
impl NewDeviceMetadataTypeBuilder {
    ...
    pub fn build(self) -> super::super::types::NewDeviceMetadataType {
        super::super::types::NewDeviceMetadataType {
