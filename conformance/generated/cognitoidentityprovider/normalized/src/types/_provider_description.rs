...
impl ProviderDescription {
    ...
    pub fn builder() -> super::super::types::builders::ProviderDescriptionBuilder {
        super::super::types::builders::ProviderDescriptionBuilder::default()
    }
}
...
impl ProviderDescriptionBuilder {
    ...
    pub fn build(self) -> super::super::types::ProviderDescription {
        super::super::types::ProviderDescription {
