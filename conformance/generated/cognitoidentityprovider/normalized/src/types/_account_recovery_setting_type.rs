...
pub struct AccountRecoverySettingType {
    ...
    pub recovery_mechanisms: ::std::option::Option<::std::vec::Vec<super::super::types::RecoveryOptionType>>,
}
impl AccountRecoverySettingType {
    ...
    pub fn recovery_mechanisms(&self) -> &[super::super::types::RecoveryOptionType] {
...
impl AccountRecoverySettingType {
    ...
    pub fn builder() -> super::super::types::builders::AccountRecoverySettingTypeBuilder {
        super::super::types::builders::AccountRecoverySettingTypeBuilder::default()
    }
}
...
pub struct AccountRecoverySettingTypeBuilder {
    pub(crate) recovery_mechanisms: ::std::option::Option<::std::vec::Vec<super::super::types::RecoveryOptionType>>,
}
impl AccountRecoverySettingTypeBuilder {
    ...
    ///
    /// <p>The list of options and priorities for user message delivery in forgot-password operations. Sets or displays user pool preferences for email or SMS message priority, whether users should fall back to a second delivery method, and whether passwords should only be reset by administrators.</p>
    pub fn recovery_mechanisms(mut self, input: super::super::types::RecoveryOptionType) -> Self {
    ...
    /// <p>The list of options and priorities for user message delivery in forgot-password operations. Sets or displays user pool preferences for email or SMS message priority, whether users should fall back to a second delivery method, and whether passwords should only be reset by administrators.</p>
    pub fn set_recovery_mechanisms(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::RecoveryOptionType>>) -> Self {
        self.recovery_mechanisms = input;
        self
    }
    /// <p>The list of options and priorities for user message delivery in forgot-password operations. Sets or displays user pool preferences for email or SMS message priority, whether users should fall back to a second delivery method, and whether passwords should only be reset by administrators.</p>
    pub fn get_recovery_mechanisms(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::RecoveryOptionType>> {
    ...
    pub fn build(self) -> super::super::types::AccountRecoverySettingType {
        super::super::types::AccountRecoverySettingType {
