...
pub struct RecoveryOptionType {
    ...
    pub name: super::super::types::RecoveryOptionNameType,
}
impl RecoveryOptionType {
    ...
    /// <p>The recovery method that this object sets a recovery option for.</p>
    pub fn name(&self) -> &super::super::types::RecoveryOptionNameType {
        &self.name
    }
}
impl RecoveryOptionType {
    /// Creates a new builder-style object to manufacture [`RecoveryOptionType`](crate::types::RecoveryOptionType).
    pub fn builder() -> super::super::types::builders::RecoveryOptionTypeBuilder {
        super::super::types::builders::RecoveryOptionTypeBuilder::default()
    }
}
...
pub struct RecoveryOptionTypeBuilder {
    ...
    pub(crate) name: ::std::option::Option<super::super::types::RecoveryOptionNameType>,
}
impl RecoveryOptionTypeBuilder {
    ...
    /// <p>The recovery method that this object sets a recovery option for.</p>
    /// This field is required.
    pub fn name(mut self, input: super::super::types::RecoveryOptionNameType) -> Self {
        self.name = ::std::option::Option::Some(input);
        self
    }
    /// <p>The recovery method that this object sets a recovery option for.</p>
    pub fn set_name(mut self, input: ::std::option::Option<super::super::types::RecoveryOptionNameType>) -> Self {
        self.name = input;
        self
    }
    /// <p>The recovery method that this object sets a recovery option for.</p>
    pub fn get_name(&self) -> &::std::option::Option<super::super::types::RecoveryOptionNameType> {
        &self.name
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::RecoveryOptionType, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::RecoveryOptionType {
