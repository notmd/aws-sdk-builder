...
impl RiskExceptionConfigurationType {
    ...
    pub fn builder() -> super::super::types::builders::RiskExceptionConfigurationTypeBuilder {
        super::super::types::builders::RiskExceptionConfigurationTypeBuilder::default()
    }
}
...
impl RiskExceptionConfigurationTypeBuilder {
    ...
    pub fn build(self) -> super::super::types::RiskExceptionConfigurationType {
        super::super::types::RiskExceptionConfigurationType {
