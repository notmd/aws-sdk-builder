...
impl AttributeType {
    ...
    pub fn builder() -> super::super::types::builders::AttributeTypeBuilder {
        super::super::types::builders::AttributeTypeBuilder::default()
    }
}
...
impl AttributeTypeBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::AttributeType, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::AttributeType {
