...
///     SecurityPolicyType::TlsV1 => { /* ... */ },
///     SecurityPolicyType::TlsV122021 => { /* ... */ },
///     SecurityPolicyType::TlsV132025 => { /* ... */ },
...
impl ::std::convert::From<&str> for SecurityPolicyType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SecurityPolicyType::Unknown(super::super::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
...
impl SecurityPolicyType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            SecurityPolicyType::TlsV1 => "TLS_V1",
            SecurityPolicyType::TlsV122021 => "TLS_V1_2_2021",
            SecurityPolicyType::TlsV132025 => "TLS_V1_3_2025",
...
impl ::std::fmt::Display for SecurityPolicyType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            SecurityPolicyType::TlsV1 => write!(f, "TLS_V1"),
            SecurityPolicyType::TlsV122021 => write!(f, "TLS_V1_2_2021"),
            SecurityPolicyType::TlsV132025 => write!(f, "TLS_V1_3_2025"),
