...
impl S3ConfigurationType {
    ...
    pub fn builder() -> super::super::types::builders::S3ConfigurationTypeBuilder {
        super::super::types::builders::S3ConfigurationTypeBuilder::default()
    }
}
...
impl S3ConfigurationTypeBuilder {
    ...
    pub fn build(self) -> super::super::types::S3ConfigurationType {
        super::super::types::S3ConfigurationType { bucket_arn: self.bucket_arn }
    }
}
