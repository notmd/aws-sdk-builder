...
impl MessageTemplateType {
    ...
    pub fn builder() -> super::super::types::builders::MessageTemplateTypeBuilder {
        super::super::types::builders::MessageTemplateTypeBuilder::default()
    }
}
...
impl MessageTemplateTypeBuilder {
    ...
    pub fn build(self) -> super::super::types::MessageTemplateType {
        super::super::types::MessageTemplateType {
