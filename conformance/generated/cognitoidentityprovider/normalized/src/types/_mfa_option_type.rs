...
impl MfaOptionType {
    ...
    pub fn builder() -> super::super::types::builders::MfaOptionTypeBuilder {
        super::super::types::builders::MfaOptionTypeBuilder::default()
    }
}
...
impl MfaOptionTypeBuilder {
    ...
    pub fn build(self) -> super::super::types::MfaOptionType {
        super::super::types::MfaOptionType {
