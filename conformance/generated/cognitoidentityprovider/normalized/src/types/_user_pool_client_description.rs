...
impl UserPoolClientDescription {
    ...
    pub fn builder() -> super::super::types::builders::UserPoolClientDescriptionBuilder {
        super::super::types::builders::UserPoolClientDescriptionBuilder::default()
    }
}
...
impl UserPoolClientDescriptionBuilder {
    ...
    pub fn build(self) -> super::super::types::UserPoolClientDescription {
        super::super::types::UserPoolClientDescription {
