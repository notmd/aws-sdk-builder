...
pub struct AdminCreateUserConfigType {
    ...
    pub invite_message_template: ::std::option::Option<super::super::types::MessageTemplateType>,
}
impl AdminCreateUserConfigType {
    ...
    /// <p>The template for the welcome message to new users. This template must include the <code>{####}</code> temporary password placeholder if you are creating users with passwords. If your users don't have passwords, you can omit the placeholder.</p>
    /// <p>See also <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pool-settings-message-customizations.html#cognito-user-pool-settings-user-invitation-message-customization">Customizing User Invitation Messages</a>.</p>
    pub fn invite_message_template(&self) -> ::std::option::Option<&super::super::types::MessageTemplateType> {
...
impl AdminCreateUserConfigType {
    ...
    pub fn builder() -> super::super::types::builders::AdminCreateUserConfigTypeBuilder {
        super::super::types::builders::AdminCreateUserConfigTypeBuilder::default()
    }
}
...
pub struct AdminCreateUserConfigTypeBuilder {
    ...
    pub(crate) invite_message_template: ::std::option::Option<super::super::types::MessageTemplateType>,
}
impl AdminCreateUserConfigTypeBuilder {
    ...
    /// <p>The template for the welcome message to new users. This template must include the <code>{####}</code> temporary password placeholder if you are creating users with passwords. If your users don't have passwords, you can omit the placeholder.</p>
    /// <p>See also <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pool-settings-message-customizations.html#cognito-user-pool-settings-user-invitation-message-customization">Customizing User Invitation Messages</a>.</p>
    pub fn invite_message_template(mut self, input: super::super::types::MessageTemplateType) -> Self {
        self.invite_message_template = ::std::option::Option::Some(input);
        self
    }
    /// <p>The template for the welcome message to new users. This template must include the <code>{####}</code> temporary password placeholder if you are creating users with passwords. If your users don't have passwords, you can omit the placeholder.</p>
    /// <p>See also <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pool-settings-message-customizations.html#cognito-user-pool-settings-user-invitation-message-customization">Customizing User Invitation Messages</a>.</p>
    pub fn set_invite_message_template(mut self, input: ::std::option::Option<super::super::types::MessageTemplateType>) -> Self {
        self.invite_message_template = input;
        self
    }
    /// <p>The template for the welcome message to new users. This template must include the <code>{####}</code> temporary password placeholder if you are creating users with passwords. If your users don't have passwords, you can omit the placeholder.</p>
    /// <p>See also <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pool-settings-message-customizations.html#cognito-user-pool-settings-user-invitation-message-customization">Customizing User Invitation Messages</a>.</p>
    pub fn get_invite_message_template(&self) -> &::std::option::Option<super::super::types::MessageTemplateType> {
    ...
    pub fn build(self) -> super::super::types::AdminCreateUserConfigType {
        super::super::types::AdminCreateUserConfigType {
