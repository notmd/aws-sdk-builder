...
impl SoftwareTokenMfaSettingsType {
    ...
    pub fn builder() -> super::super::types::builders::SoftwareTokenMfaSettingsTypeBuilder {
        super::super::types::builders::SoftwareTokenMfaSettingsTypeBuilder::default()
    }
}
...
impl SoftwareTokenMfaSettingsTypeBuilder {
    ...
    pub fn build(self) -> super::super::types::SoftwareTokenMfaSettingsType {
        super::super::types::SoftwareTokenMfaSettingsType {
