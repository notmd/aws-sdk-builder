...
impl EventContextDataType {
    ...
    pub fn builder() -> super::super::types::builders::EventContextDataTypeBuilder {
        super::super::types::builders::EventContextDataTypeBuilder::default()
    }
}
...
impl EventContextDataTypeBuilder {
    ...
    pub fn build(self) -> super::super::types::EventContextDataType {
        super::super::types::EventContextDataType {
