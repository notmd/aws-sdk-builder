...
impl AnalyticsMetadataType {
    ...
    pub fn builder() -> super::super::types::builders::AnalyticsMetadataTypeBuilder {
        super::super::types::builders::AnalyticsMetadataTypeBuilder::default()
    }
}
...
impl AnalyticsMetadataTypeBuilder {
    ...
    pub fn build(self) -> super::super::types::AnalyticsMetadataType {
        super::super::types::AnalyticsMetadataType {
