...
impl EmailMfaSettingsType {
    ...
    pub fn builder() -> super::super::types::builders::EmailMfaSettingsTypeBuilder {
        super::super::types::builders::EmailMfaSettingsTypeBuilder::default()
    }
}
...
impl EmailMfaSettingsTypeBuilder {
    ...
    pub fn build(self) -> super::super::types::EmailMfaSettingsType {
        super::super::types::EmailMfaSettingsType {
