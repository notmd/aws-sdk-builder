...
impl SoftwareTokenMfaConfigType {
    ...
    pub fn builder() -> super::super::types::builders::SoftwareTokenMfaConfigTypeBuilder {
        super::super::types::builders::SoftwareTokenMfaConfigTypeBuilder::default()
    }
}
...
impl SoftwareTokenMfaConfigTypeBuilder {
    ...
    pub fn build(self) -> super::super::types::SoftwareTokenMfaConfigType {
        super::super::types::SoftwareTokenMfaConfigType {
