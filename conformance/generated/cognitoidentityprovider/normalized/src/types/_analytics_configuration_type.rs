...
impl AnalyticsConfigurationType {
    ...
    pub fn builder() -> super::super::types::builders::AnalyticsConfigurationTypeBuilder {
        super::super::types::builders::AnalyticsConfigurationTypeBuilder::default()
    }
}
...
impl AnalyticsConfigurationTypeBuilder {
    ...
    pub fn build(self) -> super::super::types::AnalyticsConfigurationType {
        super::super::types::AnalyticsConfigurationType {
