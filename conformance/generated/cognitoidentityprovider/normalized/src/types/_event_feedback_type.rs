...
pub struct EventFeedbackType {
    ...
    pub feedback_value: super::super::types::FeedbackValueType,
...
impl EventFeedbackType {
    /// <p>Your feedback to the authentication event. When you provide a <code>FeedbackValue</code> value of <code>valid</code>, you tell Amazon Cognito that you trust a user session where Amazon Cognito has evaluated some level of risk. When you provide a <code>FeedbackValue</code> value of <code>invalid</code>, you tell Amazon Cognito that you don't trust a user session, or you don't believe that Amazon Cognito evaluated a high-enough risk level.</p>
    pub fn feedback_value(&self) -> &super::super::types::FeedbackValueType {
        &self.feedback_value
    }
    /// <p>The submitter of the event feedback. For example, if you submit event feedback in the Amazon Cognito console, this value is <code>Admin</code>.</p>
...
impl EventFeedbackType {
    ...
    pub fn builder() -> super::super::types::builders::EventFeedbackTypeBuilder {
        super::super::types::builders::EventFeedbackTypeBuilder::default()
    }
}
...
pub struct EventFeedbackTypeBuilder {
    pub(crate) feedback_value: ::std::option::Option<super::super::types::FeedbackValueType>,
...
impl EventFeedbackTypeBuilder {
    ...
    pub fn feedback_value(mut self, input: super::super::types::FeedbackValueType) -> Self {
        self.feedback_value = ::std::option::Option::Some(input);
        self
    }
    /// <p>Your feedback to the authentication event. When you provide a <code>FeedbackValue</code> value of <code>valid</code>, you tell Amazon Cognito that you trust a user session where Amazon Cognito has evaluated some level of risk. When you provide a <code>FeedbackValue</code> value of <code>invalid</code>, you tell Amazon Cognito that you don't trust a user session, or you don't believe that Amazon Cognito evaluated a high-enough risk level.</p>
    pub fn set_feedback_value(mut self, input: ::std::option::Option<super::super::types::FeedbackValueType>) -> Self {
        self.feedback_value = input;
        self
    }
    /// <p>Your feedback to the authentication event. When you provide a <code>FeedbackValue</code> value of <code>valid</code>, you tell Amazon Cognito that you trust a user session where Amazon Cognito has evaluated some level of risk. When you provide a <code>FeedbackValue</code> value of <code>invalid</code>, you tell Amazon Cognito that you don't trust a user session, or you don't believe that Amazon Cognito evaluated a high-enough risk level.</p>
    pub fn get_feedback_value(&self) -> &::std::option::Option<super::super::types::FeedbackValueType> {
        &self.feedback_value
    }
    /// <p>The submitter of the event feedback. For example, if you submit event feedback in the Amazon Cognito console, this value is <code>Admin</code>.</p>
    /// This field is required.
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::EventFeedbackType, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::EventFeedbackType {
