...
pub struct UserType {
    ...
    pub attributes: ::std::option::Option<::std::vec::Vec<super::super::types::AttributeType>>,
    ...
    pub user_status: ::std::option::Option<super::super::types::UserStatusType>,
    /// <p>The user's MFA configuration.</p>
    pub mfa_options: ::std::option::Option<::std::vec::Vec<super::super::types::MfaOptionType>>,
}
impl UserType {
    /// <p>The user's username.</p>
    ...
    pub fn attributes(&self) -> &[super::super::types::AttributeType] {
    ...
    /// </ul>
    /// <p>The statuses <code>ARCHIVED</code>, <code>UNKNOWN</code>, and <code>COMPROMISED</code> are no longer used.</p>
    pub fn user_status(&self) -> ::std::option::Option<&super::super::types::UserStatusType> {
    ...
    pub fn mfa_options(&self) -> &[super::super::types::MfaOptionType] {
...
impl UserType {
    ...
    pub fn builder() -> super::super::types::builders::UserTypeBuilder {
        super::super::types::builders::UserTypeBuilder::default()
    }
}
...
pub struct UserTypeBuilder {
    ...
    pub(crate) attributes: ::std::option::Option<::std::vec::Vec<super::super::types::AttributeType>>,
    ...
    pub(crate) user_status: ::std::option::Option<super::super::types::UserStatusType>,
    pub(crate) mfa_options: ::std::option::Option<::std::vec::Vec<super::super::types::MfaOptionType>>,
}
impl UserTypeBuilder {
    ...
    ///
    /// <p>Names and values of a user's attributes, for example <code>email</code>.</p>
    pub fn attributes(mut self, input: super::super::types::AttributeType) -> Self {
    ...
    /// <p>Names and values of a user's attributes, for example <code>email</code>.</p>
    pub fn set_attributes(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::AttributeType>>) -> Self {
        self.attributes = input;
        self
    }
    /// <p>Names and values of a user's attributes, for example <code>email</code>.</p>
    pub fn get_attributes(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::AttributeType>> {
        &self.attributes
    }
    /// <p>The date and time when the item was created. Amazon Cognito returns this timestamp in UNIX epoch time format. Your SDK might render the output in a human-readable format like ISO 8601 or a Java <code>Date</code> object.</p>
    ...
    /// </ul>
    /// <p>The statuses <code>ARCHIVED</code>, <code>UNKNOWN</code>, and <code>COMPROMISED</code> are no longer used.</p>
    pub fn user_status(mut self, input: super::super::types::UserStatusType) -> Self {
    ...
    /// </ul>
    /// <p>The statuses <code>ARCHIVED</code>, <code>UNKNOWN</code>, and <code>COMPROMISED</code> are no longer used.</p>
    pub fn set_user_status(mut self, input: ::std::option::Option<super::super::types::UserStatusType>) -> Self {
    ...
    /// </ul>
    /// <p>The statuses <code>ARCHIVED</code>, <code>UNKNOWN</code>, and <code>COMPROMISED</code> are no longer used.</p>
    pub fn get_user_status(&self) -> &::std::option::Option<super::super::types::UserStatusType> {
        &self.user_status
    }
    ...
    ///
    /// <p>The user's MFA configuration.</p>
    pub fn mfa_options(mut self, input: super::super::types::MfaOptionType) -> Self {
    ...
    /// <p>The user's MFA configuration.</p>
    pub fn set_mfa_options(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::MfaOptionType>>) -> Self {
        self.mfa_options = input;
        self
    }
    /// <p>The user's MFA configuration.</p>
    pub fn get_mfa_options(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::MfaOptionType>> {
        &self.mfa_options
    }
    /// Consumes the builder and constructs a [`UserType`](crate::types::UserType).
    pub fn build(self) -> super::super::types::UserType {
        super::super::types::UserType {
