...
impl FirehoseConfigurationType {
    ...
    pub fn builder() -> super::super::types::builders::FirehoseConfigurationTypeBuilder {
        super::super::types::builders::FirehoseConfigurationTypeBuilder::default()
    }
}
...
impl FirehoseConfigurationTypeBuilder {
    ...
    pub fn build(self) -> super::super::types::FirehoseConfigurationType {
        super::super::types::FirehoseConfigurationType { stream_arn: self.stream_arn }
    }
}
