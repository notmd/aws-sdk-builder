...
pub struct UserPoolClientType {
    ...
    pub token_validity_units: ::std::option::Option<super::super::types::TokenValidityUnitsType>,
    ...
    pub explicit_auth_flows: ::std::option::Option<::std::vec::Vec<super::super::types::ExplicitAuthFlowsType>>,
    ...
    /// </dd>
    /// </dl>
    pub allowed_o_auth_flows: ::std::option::Option<::std::vec::Vec<super::super::types::OAuthFlowType>>,
    ...
    /// </note>
    pub analytics_configuration: ::std::option::Option<super::super::types::AnalyticsConfigurationType>,
    ...
    pub prevent_user_existence_errors: ::std::option::Option<super::super::types::PreventUserExistenceErrorTypes>,
    ...
    pub refresh_token_rotation: ::std::option::Option<super::super::types::RefreshTokenRotationType>,
}
impl UserPoolClientType {
    ...
    /// <p>The time units that, with <code>IdTokenValidity</code>, <code>AccessTokenValidity</code>, and <code>RefreshTokenValidity</code>, set and display the duration of ID, access, and refresh tokens for an app client. You can assign a separate token validity unit to each type of token.</p>
    pub fn token_validity_units(&self) -> ::std::option::Option<&super::super::types::TokenValidityUnitsType> {
    ...
    pub fn explicit_auth_flows(&self) -> &[super::super::types::ExplicitAuthFlowsType] {
    ...
    pub fn allowed_o_auth_flows(&self) -> &[super::super::types::OAuthFlowType] {
    ...
    /// <p>In Amazon Web Services Regions where Amazon Pinpoint isn't available, user pools only support sending events to Amazon Pinpoint projects in Amazon Web Services Region us-east-1. In Regions where Amazon Pinpoint is available, user pools support sending events to Amazon Pinpoint projects within that same Region.</p>
    /// </note>
    pub fn analytics_configuration(&self) -> ::std::option::Option<&super::super::types::AnalyticsConfigurationType> {
        self.analytics_configuration.as_ref()
    }
    /// <p>When <code>ENABLED</code>, suppresses messages that might indicate a valid user exists when someone attempts sign-in. This parameters sets your preference for the errors and responses that you want Amazon Cognito APIs to return during authentication, account confirmation, and password recovery when the user doesn't exist in the user pool. When set to <code>ENABLED</code> and the user doesn't exist, authentication returns an error indicating either the username or password was incorrect. Account confirmation and password recovery return a response indicating a code was sent to a simulated destination. When set to <code>LEGACY</code>, those APIs return a <code>UserNotFoundException</code> exception if the user doesn't exist in the user pool.</p>
    /// <p>Defaults to <code>LEGACY</code>.</p>
    pub fn prevent_user_existence_errors(&self) -> ::std::option::Option<&super::super::types::PreventUserExistenceErrorTypes> {
    ...
    /// <p>The configuration of your app client for refresh token rotation. When enabled, your app client issues new ID, access, and refresh tokens when users renew their sessions with refresh tokens. When disabled, token refresh issues only ID and access tokens.</p>
    pub fn refresh_token_rotation(&self) -> ::std::option::Option<&super::super::types::RefreshTokenRotationType> {
...
impl UserPoolClientType {
    ...
    pub fn builder() -> super::super::types::builders::UserPoolClientTypeBuilder {
        super::super::types::builders::UserPoolClientTypeBuilder::default()
    }
}
...
pub struct UserPoolClientTypeBuilder {
    ...
    pub(crate) token_validity_units: ::std::option::Option<super::super::types::TokenValidityUnitsType>,
    ...
    pub(crate) analytics_configuration: ::std::option::Option<super::super::types::AnalyticsConfigurationType>,
    pub(crate) prevent_user_existence_errors: ::std::option::Option<super::super::types::PreventUserExistenceErrorTypes>,
    ...
    pub(crate) refresh_token_rotation: ::std::option::Option<super::super::types::RefreshTokenRotationType>,
}
impl UserPoolClientTypeBuilder {
    ...
    /// <p>The time units that, with <code>IdTokenValidity</code>, <code>AccessTokenValidity</code>, and <code>RefreshTokenValidity</code>, set and display the duration of ID, access, and refresh tokens for an app client. You can assign a separate token validity unit to each type of token.</p>
    pub fn token_validity_units(mut self, input: super::super::types::TokenValidityUnitsType) -> Self {
        self.token_validity_units = ::std::option::Option::Some(input);
        self
    }
    /// <p>The time units that, with <code>IdTokenValidity</code>, <code>AccessTokenValidity</code>, and <code>RefreshTokenValidity</code>, set and display the duration of ID, access, and refresh tokens for an app client. You can assign a separate token validity unit to each type of token.</p>
    pub fn set_token_validity_units(mut self, input: ::std::option::Option<super::super::types::TokenValidityUnitsType>) -> Self {
        self.token_validity_units = input;
        self
    }
    /// <p>The time units that, with <code>IdTokenValidity</code>, <code>AccessTokenValidity</code>, and <code>RefreshTokenValidity</code>, set and display the duration of ID, access, and refresh tokens for an app client. You can assign a separate token validity unit to each type of token.</p>
    pub fn get_token_validity_units(&self) -> &::std::option::Option<super::super::types::TokenValidityUnitsType> {
    ...
    /// </ul>
    /// <p>In some environments, you will see the values <code>ADMIN_NO_SRP_AUTH</code>, <code>CUSTOM_AUTH_FLOW_ONLY</code>, or <code>USER_PASSWORD_AUTH</code>. You can't assign these legacy <code>ExplicitAuthFlows</code> values to user pool clients at the same time as values that begin with <code>ALLOW_</code>, like <code>ALLOW_USER_SRP_AUTH</code>.</p>
    pub fn explicit_auth_flows(mut self, input: super::super::types::ExplicitAuthFlowsType) -> Self {
    ...
    /// </ul>
    /// <p>In some environments, you will see the values <code>ADMIN_NO_SRP_AUTH</code>, <code>CUSTOM_AUTH_FLOW_ONLY</code>, or <code>USER_PASSWORD_AUTH</code>. You can't assign these legacy <code>ExplicitAuthFlows</code> values to user pool clients at the same time as values that begin with <code>ALLOW_</code>, like <code>ALLOW_USER_SRP_AUTH</code>.</p>
    pub fn set_explicit_auth_flows(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::ExplicitAuthFlowsType>>) -> Self {
    ...
    /// </ul>
    /// <p>In some environments, you will see the values <code>ADMIN_NO_SRP_AUTH</code>, <code>CUSTOM_AUTH_FLOW_ONLY</code>, or <code>USER_PASSWORD_AUTH</code>. You can't assign these legacy <code>ExplicitAuthFlows</code> values to user pool clients at the same time as values that begin with <code>ALLOW_</code>, like <code>ALLOW_USER_SRP_AUTH</code>.</p>
    pub fn get_explicit_auth_flows(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::ExplicitAuthFlowsType>> {
    ...
    /// </dd>
    /// </dl>
    pub fn allowed_o_auth_flows(mut self, input: super::super::types::OAuthFlowType) -> Self {
    ...
    /// </dd>
    /// </dl>
    pub fn set_allowed_o_auth_flows(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::OAuthFlowType>>) -> Self {
    ...
    /// </dd>
    /// </dl>
    pub fn get_allowed_o_auth_flows(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::OAuthFlowType>> {
    ...
    /// <p>In Amazon Web Services Regions where Amazon Pinpoint isn't available, user pools only support sending events to Amazon Pinpoint projects in Amazon Web Services Region us-east-1. In Regions where Amazon Pinpoint is available, user pools support sending events to Amazon Pinpoint projects within that same Region.</p>
    /// </note>
    pub fn analytics_configuration(mut self, input: super::super::types::AnalyticsConfigurationType) -> Self {
    ...
    /// <p>In Amazon Web Services Regions where Amazon Pinpoint isn't available, user pools only support sending events to Amazon Pinpoint projects in Amazon Web Services Region us-east-1. In Regions where Amazon Pinpoint is available, user pools support sending events to Amazon Pinpoint projects within that same Region.</p>
    /// </note>
    pub fn set_analytics_configuration(mut self, input: ::std::option::Option<super::super::types::AnalyticsConfigurationType>) -> Self {
    ...
    /// <p>In Amazon Web Services Regions where Amazon Pinpoint isn't available, user pools only support sending events to Amazon Pinpoint projects in Amazon Web Services Region us-east-1. In Regions where Amazon Pinpoint is available, user pools support sending events to Amazon Pinpoint projects within that same Region.</p>
    /// </note>
    pub fn get_analytics_configuration(&self) -> &::std::option::Option<super::super::types::AnalyticsConfigurationType> {
        &self.analytics_configuration
    }
    /// <p>When <code>ENABLED</code>, suppresses messages that might indicate a valid user exists when someone attempts sign-in. This parameters sets your preference for the errors and responses that you want Amazon Cognito APIs to return during authentication, account confirmation, and password recovery when the user doesn't exist in the user pool. When set to <code>ENABLED</code> and the user doesn't exist, authentication returns an error indicating either the username or password was incorrect. Account confirmation and password recovery return a response indicating a code was sent to a simulated destination. When set to <code>LEGACY</code>, those APIs return a <code>UserNotFoundException</code> exception if the user doesn't exist in the user pool.</p>
    /// <p>Defaults to <code>LEGACY</code>.</p>
    pub fn prevent_user_existence_errors(mut self, input: super::super::types::PreventUserExistenceErrorTypes) -> Self {
        self.prevent_user_existence_errors = ::std::option::Option::Some(input);
        self
    }
    /// <p>When <code>ENABLED</code>, suppresses messages that might indicate a valid user exists when someone attempts sign-in. This parameters sets your preference for the errors and responses that you want Amazon Cognito APIs to return during authentication, account confirmation, and password recovery when the user doesn't exist in the user pool. When set to <code>ENABLED</code> and the user doesn't exist, authentication returns an error indicating either the username or password was incorrect. Account confirmation and password recovery return a response indicating a code was sent to a simulated destination. When set to <code>LEGACY</code>, those APIs return a <code>UserNotFoundException</code> exception if the user doesn't exist in the user pool.</p>
    /// <p>Defaults to <code>LEGACY</code>.</p>
    pub fn set_prevent_user_existence_errors(mut self, input: ::std::option::Option<super::super::types::PreventUserExistenceErrorTypes>) -> Self {
        self.prevent_user_existence_errors = input;
        self
    }
    /// <p>When <code>ENABLED</code>, suppresses messages that might indicate a valid user exists when someone attempts sign-in. This parameters sets your preference for the errors and responses that you want Amazon Cognito APIs to return during authentication, account confirmation, and password recovery when the user doesn't exist in the user pool. When set to <code>ENABLED</code> and the user doesn't exist, authentication returns an error indicating either the username or password was incorrect. Account confirmation and password recovery return a response indicating a code was sent to a simulated destination. When set to <code>LEGACY</code>, those APIs return a <code>UserNotFoundException</code> exception if the user doesn't exist in the user pool.</p>
    /// <p>Defaults to <code>LEGACY</code>.</p>
    pub fn get_prevent_user_existence_errors(&self) -> &::std::option::Option<super::super::types::PreventUserExistenceErrorTypes> {
    ...
    /// <p>The configuration of your app client for refresh token rotation. When enabled, your app client issues new ID, access, and refresh tokens when users renew their sessions with refresh tokens. When disabled, token refresh issues only ID and access tokens.</p>
    pub fn refresh_token_rotation(mut self, input: super::super::types::RefreshTokenRotationType) -> Self {
        self.refresh_token_rotation = ::std::option::Option::Some(input);
        self
    }
    /// <p>The configuration of your app client for refresh token rotation. When enabled, your app client issues new ID, access, and refresh tokens when users renew their sessions with refresh tokens. When disabled, token refresh issues only ID and access tokens.</p>
    pub fn set_refresh_token_rotation(mut self, input: ::std::option::Option<super::super::types::RefreshTokenRotationType>) -> Self {
        self.refresh_token_rotation = input;
        self
    }
    /// <p>The configuration of your app client for refresh token rotation. When enabled, your app client issues new ID, access, and refresh tokens when users renew their sessions with refresh tokens. When disabled, token refresh issues only ID and access tokens.</p>
    pub fn get_refresh_token_rotation(&self) -> &::std::option::Option<super::super::types::RefreshTokenRotationType> {
        &self.refresh_token_rotation
    }
    /// Consumes the builder and constructs a [`UserPoolClientType`](crate::types::UserPoolClientType).
    pub fn build(self) -> super::super::types::UserPoolClientType {
        super::super::types::UserPoolClientType {
