...
impl GroupType {
    ...
    pub fn builder() -> super::super::types::builders::GroupTypeBuilder {
        super::super::types::builders::GroupTypeBuilder::default()
    }
}
...
impl GroupTypeBuilder {
    ...
    pub fn build(self) -> super::super::types::GroupType {
        super::super::types::GroupType {
