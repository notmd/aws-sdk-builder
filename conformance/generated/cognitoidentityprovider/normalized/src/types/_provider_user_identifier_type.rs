...
impl ProviderUserIdentifierType {
    ...
    pub fn builder() -> super::super::types::builders::ProviderUserIdentifierTypeBuilder {
        super::super::types::builders::ProviderUserIdentifierTypeBuilder::default()
    }
}
...
impl ProviderUserIdentifierTypeBuilder {
    ...
    pub fn build(self) -> super::super::types::ProviderUserIdentifierType {
        super::super::types::ProviderUserIdentifierType {
