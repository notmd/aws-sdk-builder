...
pub struct CompromisedCredentialsRiskConfigurationType {
    ...
    pub event_filter: ::std::option::Option<::std::vec::Vec<super::super::types::EventFilterType>>,
    /// <p>Settings for the actions that you want your user pool to take when Amazon Cognito detects compromised credentials.</p>
    pub actions: ::std::option::Option<super::super::types::CompromisedCredentialsActionsType>,
}
impl CompromisedCredentialsRiskConfigurationType {
    ...
    pub fn event_filter(&self) -> &[super::super::types::EventFilterType] {
        self.event_filter.as_deref().unwrap_or_default()
    }
    /// <p>Settings for the actions that you want your user pool to take when Amazon Cognito detects compromised credentials.</p>
    pub fn actions(&self) -> ::std::option::Option<&super::super::types::CompromisedCredentialsActionsType> {
        self.actions.as_ref()
    }
}
impl CompromisedCredentialsRiskConfigurationType {
    ...
    pub fn builder() -> super::super::types::builders::CompromisedCredentialsRiskConfigurationTypeBuilder {
        super::super::types::builders::CompromisedCredentialsRiskConfigurationTypeBuilder::default()
    }
}
...
pub struct CompromisedCredentialsRiskConfigurationTypeBuilder {
    pub(crate) event_filter: ::std::option::Option<::std::vec::Vec<super::super::types::EventFilterType>>,
    pub(crate) actions: ::std::option::Option<super::super::types::CompromisedCredentialsActionsType>,
}
impl CompromisedCredentialsRiskConfigurationTypeBuilder {
    ...
    ///
    /// <p>Settings for the sign-in activity where you want to configure compromised-credentials actions. Defaults to all events.</p>
    pub fn event_filter(mut self, input: super::super::types::EventFilterType) -> Self {
    ...
    /// <p>Settings for the sign-in activity where you want to configure compromised-credentials actions. Defaults to all events.</p>
    pub fn set_event_filter(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::EventFilterType>>) -> Self {
        self.event_filter = input;
        self
    }
    /// <p>Settings for the sign-in activity where you want to configure compromised-credentials actions. Defaults to all events.</p>
    pub fn get_event_filter(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::EventFilterType>> {
        &self.event_filter
    }
    /// <p>Settings for the actions that you want your user pool to take when Amazon Cognito detects compromised credentials.</p>
    /// This field is required.
    pub fn actions(mut self, input: super::super::types::CompromisedCredentialsActionsType) -> Self {
        self.actions = ::std::option::Option::Some(input);
        self
    }
    /// <p>Settings for the actions that you want your user pool to take when Amazon Cognito detects compromised credentials.</p>
    pub fn set_actions(mut self, input: ::std::option::Option<super::super::types::CompromisedCredentialsActionsType>) -> Self {
        self.actions = input;
        self
    }
    /// <p>Settings for the actions that you want your user pool to take when Amazon Cognito detects compromised credentials.</p>
    pub fn get_actions(&self) -> &::std::option::Option<super::super::types::CompromisedCredentialsActionsType> {
        &self.actions
    }
    ...
    pub fn build(self) -> super::super::types::CompromisedCredentialsRiskConfigurationType {
        super::super::types::CompromisedCredentialsRiskConfigurationType {
