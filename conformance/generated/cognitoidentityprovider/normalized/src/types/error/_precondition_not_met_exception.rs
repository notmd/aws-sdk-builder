...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::PreconditionNotMetException {
...
impl PreconditionNotMetException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::PreconditionNotMetExceptionBuilder {
        super::super::super::types::error::builders::PreconditionNotMetExceptionBuilder::default()
    }
}
...
impl PreconditionNotMetExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::PreconditionNotMetException {
        super::super::super::types::error::PreconditionNotMetException {
