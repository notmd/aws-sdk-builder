...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::ForbiddenException {
...
impl ForbiddenException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::ForbiddenExceptionBuilder {
        super::super::super::types::error::builders::ForbiddenExceptionBuilder::default()
    }
}
...
impl ForbiddenExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::ForbiddenException {
        super::super::super::types::error::ForbiddenException {
