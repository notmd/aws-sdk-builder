...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::InvalidSmsRoleTrustRelationshipException {
...
impl InvalidSmsRoleTrustRelationshipException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::InvalidSmsRoleTrustRelationshipExceptionBuilder {
        super::super::super::types::error::builders::InvalidSmsRoleTrustRelationshipExceptionBuilder::default()
    }
}
...
impl InvalidSmsRoleTrustRelationshipExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::InvalidSmsRoleTrustRelationshipException {
        super::super::super::types::error::InvalidSmsRoleTrustRelationshipException {
