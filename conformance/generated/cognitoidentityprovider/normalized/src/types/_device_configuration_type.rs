...
impl DeviceConfigurationType {
    ...
    pub fn builder() -> super::super::types::builders::DeviceConfigurationTypeBuilder {
        super::super::types::builders::DeviceConfigurationTypeBuilder::default()
    }
}
...
impl DeviceConfigurationTypeBuilder {
    ...
    pub fn build(self) -> super::super::types::DeviceConfigurationType {
        super::super::types::DeviceConfigurationType {
