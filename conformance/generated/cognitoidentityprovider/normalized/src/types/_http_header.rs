...
impl HttpHeader {
    ...
    pub fn builder() -> super::super::types::builders::HttpHeaderBuilder {
        super::super::types::builders::HttpHeaderBuilder::default()
    }
}
...
impl HttpHeaderBuilder {
    ...
    pub fn build(self) -> super::super::types::HttpHeader {
        super::super::types::HttpHeader {
