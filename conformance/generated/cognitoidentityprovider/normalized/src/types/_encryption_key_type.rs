...
///     EncryptionKeyType::AwsOwnedKey => { /* ... */ },
///     EncryptionKeyType::CustomerManagedKey => { /* ... */ },
...
impl ::std::convert::From<&str> for EncryptionKeyType {
    fn from(s: &str) -> Self {
        match s {
            "AWS_OWNED_KEY" => EncryptionKeyType::AwsOwnedKey,
            "CUSTOMER_MANAGED_KEY" => EncryptionKeyType::CustomerManagedKey,
            other => EncryptionKeyType::Unknown(super::super::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
...
impl EncryptionKeyType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            EncryptionKeyType::AwsOwnedKey => "AWS_OWNED_KEY",
            EncryptionKeyType::CustomerManagedKey => "CUSTOMER_MANAGED_KEY",
...
impl ::std::fmt::Display for EncryptionKeyType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            EncryptionKeyType::AwsOwnedKey => write!(f, "AWS_OWNED_KEY"),
            EncryptionKeyType::CustomerManagedKey => write!(f, "CUSTOMER_MANAGED_KEY"),
