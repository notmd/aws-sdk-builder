...
impl UserPoolDescriptionType {
    ...
    pub fn builder() -> super::super::types::builders::UserPoolDescriptionTypeBuilder {
        super::super::types::builders::UserPoolDescriptionTypeBuilder::default()
    }
}
...
impl UserPoolDescriptionTypeBuilder {
    ...
    pub fn build(self) -> super::super::types::UserPoolDescriptionType {
        super::super::types::UserPoolDescriptionType {
            id: self.id,
            name: self.name,
