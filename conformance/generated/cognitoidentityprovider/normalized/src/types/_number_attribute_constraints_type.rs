...
impl NumberAttributeConstraintsType {
    ...
    pub fn builder() -> super::super::types::builders::NumberAttributeConstraintsTypeBuilder {
        super::super::types::builders::NumberAttributeConstraintsTypeBuilder::default()
    }
}
...
impl NumberAttributeConstraintsTypeBuilder {
    ...
    pub fn build(self) -> super::super::types::NumberAttributeConstraintsType {
        super::super::types::NumberAttributeConstraintsType {
