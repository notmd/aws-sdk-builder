...
impl UiCustomizationType {
    ...
    pub fn builder() -> super::super::types::builders::UiCustomizationTypeBuilder {
        super::super::types::builders::UiCustomizationTypeBuilder::default()
    }
}
...
impl UiCustomizationTypeBuilder {
    ...
    pub fn build(self) -> super::super::types::UiCustomizationType {
        super::super::types::UiCustomizationType {
