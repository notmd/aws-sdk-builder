...
pub struct CompromisedCredentialsActionsType {
    ...
    pub event_action: super::super::types::CompromisedCredentialsEventActionType,
}
impl CompromisedCredentialsActionsType {
    /// <p>The action that Amazon Cognito takes when it detects compromised credentials.</p>
    pub fn event_action(&self) -> &super::super::types::CompromisedCredentialsEventActionType {
        &self.event_action
    }
}
impl CompromisedCredentialsActionsType {
    ...
    pub fn builder() -> super::super::types::builders::CompromisedCredentialsActionsTypeBuilder {
        super::super::types::builders::CompromisedCredentialsActionsTypeBuilder::default()
    }
}
...
pub struct CompromisedCredentialsActionsTypeBuilder {
    pub(crate) event_action: ::std::option::Option<super::super::types::CompromisedCredentialsEventActionType>,
}
impl CompromisedCredentialsActionsTypeBuilder {
    /// <p>The action that Amazon Cognito takes when it detects compromised credentials.</p>
    /// This field is required.
    pub fn event_action(mut self, input: super::super::types::CompromisedCredentialsEventActionType) -> Self {
        self.event_action = ::std::option::Option::Some(input);
        self
    }
    /// <p>The action that Amazon Cognito takes when it detects compromised credentials.</p>
    pub fn set_event_action(mut self, input: ::std::option::Option<super::super::types::CompromisedCredentialsEventActionType>) -> Self {
        self.event_action = input;
        self
    }
    /// <p>The action that Amazon Cognito takes when it detects compromised credentials.</p>
    pub fn get_event_action(&self) -> &::std::option::Option<super::super::types::CompromisedCredentialsEventActionType> {
        &self.event_action
    }
