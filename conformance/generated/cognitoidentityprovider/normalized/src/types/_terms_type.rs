...
pub struct TermsType {
    ...
    pub terms_source: super::super::types::TermsSourceType,
    /// <p>This parameter is reserved for future use and currently accepts one value.</p>
    pub enforcement: super::super::types::TermsEnforcementType,
...
impl TermsType {
    ...
    /// <p>This parameter is reserved for future use and currently accepts one value.</p>
    pub fn terms_source(&self) -> &super::super::types::TermsSourceType {
        &self.terms_source
    }
    /// <p>This parameter is reserved for future use and currently accepts one value.</p>
    pub fn enforcement(&self) -> &super::super::types::TermsEnforcementType {
        &self.enforcement
    }
    /// <p>A map of URLs to languages. For each localized language that will view the requested <code>TermsName</code>, assign a URL. A selection of <code>cognito:default</code> displays for all languages that don't have a language-specific URL.</p>
    /// <p>For example, <code>"cognito:default": "https://terms.example.com", "cognito:spanish": "https://terms.example.com/es"</code>.</p>
...
impl TermsType {
    ...
    pub fn builder() -> super::super::types::builders::TermsTypeBuilder {
        super::super::types::builders::TermsTypeBuilder::default()
    }
}
...
pub struct TermsTypeBuilder {
    ...
    pub(crate) terms_source: ::std::option::Option<super::super::types::TermsSourceType>,
    pub(crate) enforcement: ::std::option::Option<super::super::types::TermsEnforcementType>,
...
impl TermsTypeBuilder {
    ...
    /// <p>This parameter is reserved for future use and currently accepts one value.</p>
    /// This field is required.
    pub fn terms_source(mut self, input: super::super::types::TermsSourceType) -> Self {
        self.terms_source = ::std::option::Option::Some(input);
        self
    }
    /// <p>This parameter is reserved for future use and currently accepts one value.</p>
    pub fn set_terms_source(mut self, input: ::std::option::Option<super::super::types::TermsSourceType>) -> Self {
        self.terms_source = input;
        self
    }
    /// <p>This parameter is reserved for future use and currently accepts one value.</p>
    pub fn get_terms_source(&self) -> &::std::option::Option<super::super::types::TermsSourceType> {
        &self.terms_source
    }
    /// <p>This parameter is reserved for future use and currently accepts one value.</p>
    /// This field is required.
    pub fn enforcement(mut self, input: super::super::types::TermsEnforcementType) -> Self {
        self.enforcement = ::std::option::Option::Some(input);
        self
    }
    /// <p>This parameter is reserved for future use and currently accepts one value.</p>
    pub fn set_enforcement(mut self, input: ::std::option::Option<super::super::types::TermsEnforcementType>) -> Self {
        self.enforcement = input;
        self
    }
    /// <p>This parameter is reserved for future use and currently accepts one value.</p>
    pub fn get_enforcement(&self) -> &::std::option::Option<super::super::types::TermsEnforcementType> {
        &self.enforcement
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::TermsType, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::TermsType {
