...
impl StringAttributeConstraintsType {
    ...
    pub fn builder() -> super::super::types::builders::StringAttributeConstraintsTypeBuilder {
        super::super::types::builders::StringAttributeConstraintsTypeBuilder::default()
    }
}
...
impl StringAttributeConstraintsTypeBuilder {
    ...
    pub fn build(self) -> super::super::types::StringAttributeConstraintsType {
        super::super::types::StringAttributeConstraintsType {
