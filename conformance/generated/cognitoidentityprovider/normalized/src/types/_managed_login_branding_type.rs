...
impl ManagedLoginBrandingType {
    ...
    pub fn assets(&self) -> &[super::super::types::AssetType] {
...
impl ManagedLoginBrandingType {
    ...
    pub fn builder() -> super::super::types::builders::ManagedLoginBrandingTypeBuilder {
        super::super::types::builders::ManagedLoginBrandingTypeBuilder::default()
    }
}
...
impl ManagedLoginBrandingTypeBuilder {
    ...
    ///
    /// <p>An array of image files that you want to apply to roles like backgrounds, logos, and icons. Each object must also indicate whether it is for dark mode, light mode, or browser-adaptive mode.</p>
    pub fn assets(mut self, input: super::super::types::AssetType) -> Self {
    ...
    /// <p>An array of image files that you want to apply to roles like backgrounds, logos, and icons. Each object must also indicate whether it is for dark mode, light mode, or browser-adaptive mode.</p>
    pub fn set_assets(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::AssetType>>) -> Self {
        self.assets = input;
        self
    }
    /// <p>An array of image files that you want to apply to roles like backgrounds, logos, and icons. Each object must also indicate whether it is for dark mode, light mode, or browser-adaptive mode.</p>
    pub fn get_assets(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::AssetType>> {
        &self.assets
    }
    /// <p>The date and time when the item was created. Amazon Cognito returns this timestamp in UNIX epoch time format. Your SDK might render the output in a human-readable format like ISO 8601 or a Java <code>Date</code> object.</p>
    ...
    pub fn build(self) -> super::super::types::ManagedLoginBrandingType {
        super::super::types::ManagedLoginBrandingType {
