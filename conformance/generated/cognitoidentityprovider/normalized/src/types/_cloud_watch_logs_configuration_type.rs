...
impl CloudWatchLogsConfigurationType {
    ...
    pub fn builder() -> super::super::types::builders::CloudWatchLogsConfigurationTypeBuilder {
        super::super::types::builders::CloudWatchLogsConfigurationTypeBuilder::default()
    }
}
...
impl CloudWatchLogsConfigurationTypeBuilder {
    ...
    pub fn build(self) -> super::super::types::CloudWatchLogsConfigurationType {
        super::super::types::CloudWatchLogsConfigurationType {
