...
> {
    ...
    Err(match error_code {
        "FeatureUnavailableInTierException" => {
            super::super::operation::create_user_pool_replica::CreateUserPoolReplicaError::FeatureUnavailableInTierException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InternalErrorException" => super::super::operation::create_user_pool_replica::CreateUserPoolReplicaError::InternalErrorException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidParameterException" => super::super::operation::create_user_pool_replica::CreateUserPoolReplicaError::InvalidParameterException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "LimitExceededException" => super::super::operation::create_user_pool_replica::CreateUserPoolReplicaError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotAuthorizedException" => super::super::operation::create_user_pool_replica::CreateUserPoolReplicaError::NotAuthorizedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::super::operation::create_user_pool_replica::CreateUserPoolReplicaError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UserPoolTaggingException" => super::super::operation::create_user_pool_replica::CreateUserPoolReplicaError::UserPoolTaggingException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::create_user_pool_replica::builders::CreateUserPoolReplicaOutputBuilder::default();
        output = super::super::protocol_serde::shape_create_user_pool_replica::de_create_user_pool_replica(_response_body, output)
            .map_err(super::super::operation::create_user_pool_replica::CreateUserPoolReplicaError::unhandled)?;
...
pub fn ser_create_user_pool_replica_input(
    ...
    super::super::protocol_serde::shape_create_user_pool_replica_input::ser_create_user_pool_replica_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_create_user_pool_replica(
    _value: &[u8],
    mut builder: super::super::operation::create_user_pool_replica::builders::CreateUserPoolReplicaOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::create_user_pool_replica::builders::CreateUserPoolReplicaOutputBuilder,
