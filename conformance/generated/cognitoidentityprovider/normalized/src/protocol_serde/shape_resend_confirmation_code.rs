...
pub fn de_resend_confirmation_code_http_error(
    ...
    super::super::operation::resend_confirmation_code::ResendConfirmationCodeOutput,
    super::super::operation::resend_confirmation_code::ResendConfirmationCodeError,
> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(super::super::operation::resend_confirmation_code::ResendConfirmationCodeError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "InternalErrorException" => super::super::operation::resend_confirmation_code::ResendConfirmationCodeError::InternalErrorException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidEmailRoleAccessPolicyException" => {
            super::super::operation::resend_confirmation_code::ResendConfirmationCodeError::InvalidEmailRoleAccessPolicyException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = super::super::types::error::builders::InvalidEmailRoleAccessPolicyExceptionBuilder::default();
                    output = super::super::protocol_serde::shape_invalid_email_role_access_policy_exception::de_invalid_email_role_access_policy_exception_json_err(_response_body, output).map_err(super::super::operation::resend_confirmation_code::ResendConfirmationCodeError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        "InvalidLambdaResponseException" => {
            super::super::operation::resend_confirmation_code::ResendConfirmationCodeError::InvalidLambdaResponseException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidParameterException" => super::super::operation::resend_confirmation_code::ResendConfirmationCodeError::InvalidParameterException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidSmsRoleAccessPolicyException" => {
            super::super::operation::resend_confirmation_code::ResendConfirmationCodeError::InvalidSmsRoleAccessPolicyException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidSmsRoleTrustRelationshipException" => {
            super::super::operation::resend_confirmation_code::ResendConfirmationCodeError::InvalidSmsRoleTrustRelationshipException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = super::super::types::error::builders::InvalidSmsRoleTrustRelationshipExceptionBuilder::default();
                    output = super::super::protocol_serde::shape_invalid_sms_role_trust_relationship_exception::de_invalid_sms_role_trust_relationship_exception_json_err(_response_body, output).map_err(super::super::operation::resend_confirmation_code::ResendConfirmationCodeError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        "LimitExceededException" => super::super::operation::resend_confirmation_code::ResendConfirmationCodeError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotAuthorizedException" => super::super::operation::resend_confirmation_code::ResendConfirmationCodeError::NotAuthorizedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::super::operation::resend_confirmation_code::ResendConfirmationCodeError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UnexpectedLambdaException" => super::super::operation::resend_confirmation_code::ResendConfirmationCodeError::UnexpectedLambdaException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::resend_confirmation_code::builders::ResendConfirmationCodeOutputBuilder::default();
        output = super::super::protocol_serde::shape_resend_confirmation_code::de_resend_confirmation_code(_response_body, output)
            .map_err(super::super::operation::resend_confirmation_code::ResendConfirmationCodeError::unhandled)?;
...
pub fn ser_resend_confirmation_code_input(
    input: &super::super::operation::resend_confirmation_code::ResendConfirmationCodeInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    super::super::protocol_serde::shape_resend_confirmation_code_input::ser_resend_confirmation_code_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_resend_confirmation_code(
    _value: &[u8],
    mut builder: super::super::operation::resend_confirmation_code::builders::ResendConfirmationCodeOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::resend_confirmation_code::builders::ResendConfirmationCodeOutputBuilder,
