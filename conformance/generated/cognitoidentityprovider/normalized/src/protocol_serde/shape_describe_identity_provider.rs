...
> {
    ...
    Err(match error_code {
        "InternalErrorException" => super::super::operation::describe_identity_provider::DescribeIdentityProviderError::InternalErrorException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::describe_identity_provider::builders::DescribeIdentityProviderOutputBuilder::default();
        output = super::super::protocol_serde::shape_describe_identity_provider::de_describe_identity_provider(_response_body, output)
            .map_err(super::super::operation::describe_identity_provider::DescribeIdentityProviderError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::super::serde_util::describe_identity_provider_output_output_correct_errors(output).build()
    })
}
...
pub fn ser_describe_identity_provider_input(
    ...
    super::super::protocol_serde::shape_describe_identity_provider_input::ser_describe_identity_provider_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_describe_identity_provider(
    _value: &[u8],
    mut builder: super::super::operation::describe_identity_provider::builders::DescribeIdentityProviderOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::describe_identity_provider::builders::DescribeIdentityProviderOutputBuilder,
