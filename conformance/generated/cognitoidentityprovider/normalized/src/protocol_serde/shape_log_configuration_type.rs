...
pub fn ser_log_configuration_type(
    ...
    input: &super::super::types::LogConfigurationType,
    ...
    if let Some(var_1) = &input.cloud_watch_logs_configuration {
        ...
        super::super::protocol_serde::shape_cloud_watch_logs_configuration_type::ser_cloud_watch_logs_configuration_type(&mut object_2, var_1)?;
        object_2.finish();
    }
    if let Some(var_3) = &input.s3_configuration {
        #[allow(unused_mut)]
        let mut object_4 = object.key("S3Configuration").start_object();
        super::super::protocol_serde::shape_s3_configuration_type::ser_s3_configuration_type(&mut object_4, var_3)?;
        object_4.finish();
    }
    if let Some(var_5) = &input.firehose_configuration {
        #[allow(unused_mut)]
        let mut object_6 = object.key("FirehoseConfiguration").start_object();
        super::super::protocol_serde::shape_firehose_configuration_type::ser_firehose_configuration_type(&mut object_6, var_5)?;
        object_6.finish();
    }
    Ok(())
}
...
pub(crate) fn de_log_configuration_type<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::super::types::LogConfigurationType>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::super::types::builders::LogConfigurationTypeBuilder::default();
            loop {
                match tokens.next().transpose()? {
                        ...
                        "LogLevel" => {
                            builder = builder.set_log_level(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| super::super::types::LogLevel::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "EventSource" => {
                            builder = builder.set_event_source(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| super::super::types::EventSourceName::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "CloudWatchLogsConfiguration" => {
                            builder = builder.set_cloud_watch_logs_configuration(
                                super::super::protocol_serde::shape_cloud_watch_logs_configuration_type::de_cloud_watch_logs_configuration_type(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
