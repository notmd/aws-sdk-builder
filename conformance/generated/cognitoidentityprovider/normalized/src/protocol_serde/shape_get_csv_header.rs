...
pub fn ser_get_csv_header_input(
    ...
    super::super::protocol_serde::shape_get_csv_header_input::ser_get_csv_header_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_get_csv_header(
    _value: &[u8],
    mut builder: super::super::operation::get_csv_header::builders::GetCsvHeaderOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::get_csv_header::builders::GetCsvHeaderOutputBuilder,
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "CSVHeader" => {
                    builder = builder.set_csv_header(super::super::protocol_serde::shape_list_of_string_types::de_list_of_string_types(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
