...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::set_log_delivery_configuration::SetLogDeliveryConfigurationError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "FeatureUnavailableInTierException" => {
            super::super::operation::set_log_delivery_configuration::SetLogDeliveryConfigurationError::FeatureUnavailableInTierException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::set_log_delivery_configuration::builders::SetLogDeliveryConfigurationOutputBuilder::default();
        output = super::super::protocol_serde::shape_set_log_delivery_configuration::de_set_log_delivery_configuration(_response_body, output)
            .map_err(super::super::operation::set_log_delivery_configuration::SetLogDeliveryConfigurationError::unhandled)?;
...
pub fn ser_set_log_delivery_configuration_input(
    ...
    super::super::protocol_serde::shape_set_log_delivery_configuration_input::ser_set_log_delivery_configuration_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_set_log_delivery_configuration(
    _value: &[u8],
    mut builder: super::super::operation::set_log_delivery_configuration::builders::SetLogDeliveryConfigurationOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::set_log_delivery_configuration::builders::SetLogDeliveryConfigurationOutputBuilder,
