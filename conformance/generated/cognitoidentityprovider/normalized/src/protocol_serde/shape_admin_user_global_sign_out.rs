...
> {
    ...
    Err(match error_code {
        "InternalErrorException" => super::super::operation::admin_user_global_sign_out::AdminUserGlobalSignOutError::InternalErrorException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidParameterException" => super::super::operation::admin_user_global_sign_out::AdminUserGlobalSignOutError::InvalidParameterException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotAuthorizedException" => super::super::operation::admin_user_global_sign_out::AdminUserGlobalSignOutError::NotAuthorizedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::super::operation::admin_user_global_sign_out::AdminUserGlobalSignOutError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UserNotFoundException" => super::super::operation::admin_user_global_sign_out::AdminUserGlobalSignOutError::UserNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::admin_user_global_sign_out::builders::AdminUserGlobalSignOutOutputBuilder::default();
...
pub fn ser_admin_user_global_sign_out_input(
    ...
    super::super::protocol_serde::shape_admin_user_global_sign_out_input::ser_admin_user_global_sign_out_input_input(&mut object, input)?;
    object.finish();
