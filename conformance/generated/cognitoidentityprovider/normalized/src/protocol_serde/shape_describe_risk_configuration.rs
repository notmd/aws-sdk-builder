...
> {
    ...
    Err(match error_code {
        "InternalErrorException" => super::super::operation::describe_risk_configuration::DescribeRiskConfigurationError::InternalErrorException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "OperationNotEnabledException" => {
            super::super::operation::describe_risk_configuration::DescribeRiskConfigurationError::OperationNotEnabledException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::describe_risk_configuration::builders::DescribeRiskConfigurationOutputBuilder::default();
        output = super::super::protocol_serde::shape_describe_risk_configuration::de_describe_risk_configuration(_response_body, output)
            .map_err(super::super::operation::describe_risk_configuration::DescribeRiskConfigurationError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::super::serde_util::describe_risk_configuration_output_output_correct_errors(output).build()
    })
}
...
pub fn ser_describe_risk_configuration_input(
    ...
    super::super::protocol_serde::shape_describe_risk_configuration_input::ser_describe_risk_configuration_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_describe_risk_configuration(
    _value: &[u8],
    mut builder: super::super::operation::describe_risk_configuration::builders::DescribeRiskConfigurationOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::describe_risk_configuration::builders::DescribeRiskConfigurationOutputBuilder,
