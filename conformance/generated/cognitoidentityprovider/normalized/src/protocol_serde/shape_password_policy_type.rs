...
pub fn ser_password_policy_type(
    ...
    input: &super::super::types::PasswordPolicyType,
...
pub(crate) fn de_password_policy_type<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::super::types::PasswordPolicyType>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::super::types::builders::PasswordPolicyTypeBuilder::default();
            loop {
                match tokens.next().transpose()? {
