...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::admin_update_auth_event_feedback::AdminUpdateAuthEventFeedbackError::unhandled(generic)),
    };
    ...
    Err(match error_code {
        ...
        "ResourceNotFoundException" => {
            super::super::operation::admin_update_auth_event_feedback::AdminUpdateAuthEventFeedbackError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => {
            super::super::operation::admin_update_auth_event_feedback::AdminUpdateAuthEventFeedbackError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::admin_update_auth_event_feedback::builders::AdminUpdateAuthEventFeedbackOutputBuilder::default();
...
pub fn ser_admin_update_auth_event_feedback_input(
    ...
    super::super::protocol_serde::shape_admin_update_auth_event_feedback_input::ser_admin_update_auth_event_feedback_input_input(&mut object, input)?;
    object.finish();
