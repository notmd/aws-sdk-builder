...
pub fn ser_update_user_pool_input_input(
    ...
    if let Some(var_13) = &input.verification_message_template {
        ...
        super::super::protocol_serde::shape_verification_message_template_type::ser_verification_message_template_type(&mut object_14, var_13)?;
        object_14.finish();
    }
    ...
    if let Some(var_16) = &input.user_attribute_update_settings {
        ...
        super::super::protocol_serde::shape_user_attribute_update_settings_type::ser_user_attribute_update_settings_type(&mut object_17, var_16)?;
        object_17.finish();
    }
    ...
    if let Some(var_19) = &input.device_configuration {
        ...
        super::super::protocol_serde::shape_device_configuration_type::ser_device_configuration_type(&mut object_20, var_19)?;
        object_20.finish();
    }
    if let Some(var_21) = &input.email_configuration {
        #[allow(unused_mut)]
        let mut object_22 = object.key("EmailConfiguration").start_object();
        super::super::protocol_serde::shape_email_configuration_type::ser_email_configuration_type(&mut object_22, var_21)?;
        object_22.finish();
    }
    if let Some(var_23) = &input.sms_configuration {
        #[allow(unused_mut)]
        let mut object_24 = object.key("SmsConfiguration").start_object();
        super::super::protocol_serde::shape_sms_configuration_type::ser_sms_configuration_type(&mut object_24, var_23)?;
        object_24.finish();
    }
    ...
    if let Some(var_29) = &input.admin_create_user_config {
        ...
        super::super::protocol_serde::shape_admin_create_user_config_type::ser_admin_create_user_config_type(&mut object_30, var_29)?;
        object_30.finish();
    }
    if let Some(var_31) = &input.user_pool_add_ons {
        #[allow(unused_mut)]
        let mut object_32 = object.key("UserPoolAddOns").start_object();
        super::super::protocol_serde::shape_user_pool_add_ons_type::ser_user_pool_add_ons_type(&mut object_32, var_31)?;
        object_32.finish();
    }
    if let Some(var_33) = &input.account_recovery_setting {
        #[allow(unused_mut)]
        let mut object_34 = object.key("AccountRecoverySetting").start_object();
        super::super::protocol_serde::shape_account_recovery_setting_type::ser_account_recovery_setting_type(&mut object_34, var_33)?;
        object_34.finish();
    }
    ...
    if let Some(var_37) = &input.key_configuration {
        ...
        super::super::protocol_serde::shape_key_configuration_type::ser_key_configuration_type(&mut object_38, var_37)?;
        object_38.finish();
    }
    if let Some(var_39) = &input.issuer_configuration {
        #[allow(unused_mut)]
        let mut object_40 = object.key("IssuerConfiguration").start_object();
        super::super::protocol_serde::shape_issuer_configuration_type::ser_issuer_configuration_type(&mut object_40, var_39)?;
        object_40.finish();
    }
    Ok(())
}
