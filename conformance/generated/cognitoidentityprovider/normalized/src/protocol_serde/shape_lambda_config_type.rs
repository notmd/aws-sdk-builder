...
pub fn ser_lambda_config_type(
    ...
    input: &super::super::types::LambdaConfigType,
    ...
    if let Some(var_13) = &input.custom_sms_sender {
        ...
        super::super::protocol_serde::shape_custom_sms_lambda_version_config_type::ser_custom_sms_lambda_version_config_type(&mut object_14, var_13)?;
        object_14.finish();
    }
    ...
    if let Some(var_18) = &input.inbound_federation {
        ...
        super::super::protocol_serde::shape_inbound_federation_lambda_type::ser_inbound_federation_lambda_type(&mut object_19, var_18)?;
        object_19.finish();
    }
    Ok(())
}
...
pub(crate) fn de_lambda_config_type<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::super::types::LambdaConfigType>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::super::types::builders::LambdaConfigTypeBuilder::default();
            loop {
                match tokens.next().transpose()? {
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "InboundFederation" => {
                                builder = builder.set_inbound_federation(
                                    super::super::protocol_serde::shape_inbound_federation_lambda_type::de_inbound_federation_lambda_type(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
