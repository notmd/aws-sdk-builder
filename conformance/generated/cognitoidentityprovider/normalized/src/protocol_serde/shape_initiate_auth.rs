...
pub fn de_initiate_auth_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::initiate_auth::InitiateAuthOutput, super::super::operation::initiate_auth::InitiateAuthError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::initiate_auth::InitiateAuthError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "ForbiddenException" => super::super::operation::initiate_auth::InitiateAuthError::ForbiddenException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalErrorException" => super::super::operation::initiate_auth::InitiateAuthError::InternalErrorException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidEmailRoleAccessPolicyException" => {
            super::super::operation::initiate_auth::InitiateAuthError::InvalidEmailRoleAccessPolicyException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = super::super::types::error::builders::InvalidEmailRoleAccessPolicyExceptionBuilder::default();
                    output = super::super::protocol_serde::shape_invalid_email_role_access_policy_exception::de_invalid_email_role_access_policy_exception_json_err(_response_body, output).map_err(super::super::operation::initiate_auth::InitiateAuthError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        "InvalidLambdaResponseException" => super::super::operation::initiate_auth::InitiateAuthError::InvalidLambdaResponseException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidParameterException" => super::super::operation::initiate_auth::InitiateAuthError::InvalidParameterException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidSmsRoleAccessPolicyException" => super::super::operation::initiate_auth::InitiateAuthError::InvalidSmsRoleAccessPolicyException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidUserPoolConfigurationException" => {
            super::super::operation::initiate_auth::InitiateAuthError::InvalidUserPoolConfigurationException({
                ...
                let mut tmp = {
                    ...
                    output = super::super::protocol_serde::shape_invalid_user_pool_configuration_exception::de_invalid_user_pool_configuration_exception_json_err(_response_body, output).map_err(super::super::operation::initiate_auth::InitiateAuthError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        "NotAuthorizedException" => super::super::operation::initiate_auth::InitiateAuthError::NotAuthorizedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "OperationNotEnabledException" => super::super::operation::initiate_auth::InitiateAuthError::OperationNotEnabledException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "PasswordResetRequiredException" => super::super::operation::initiate_auth::InitiateAuthError::PasswordResetRequiredException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => super::super::operation::initiate_auth::InitiateAuthError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::super::operation::initiate_auth::InitiateAuthError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UnexpectedLambdaException" => super::super::operation::initiate_auth::InitiateAuthError::UnexpectedLambdaException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UnsupportedOperationException" => super::super::operation::initiate_auth::InitiateAuthError::UnsupportedOperationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UserLambdaValidationException" => super::super::operation::initiate_auth::InitiateAuthError::UserLambdaValidationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UserNotConfirmedException" => super::super::operation::initiate_auth::InitiateAuthError::UserNotConfirmedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UserNotFoundException" => super::super::operation::initiate_auth::InitiateAuthError::UserNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_initiate_auth_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::initiate_auth::builders::InitiateAuthOutputBuilder::default();
        output = super::super::protocol_serde::shape_initiate_auth::de_initiate_auth(_response_body, output)
            .map_err(super::super::operation::initiate_auth::InitiateAuthError::unhandled)?;
...
pub fn ser_initiate_auth_input(
    input: &super::super::operation::initiate_auth::InitiateAuthInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    super::super::protocol_serde::shape_initiate_auth_input::ser_initiate_auth_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_initiate_auth(
    _value: &[u8],
    mut builder: super::super::operation::initiate_auth::builders::InitiateAuthOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::initiate_auth::builders::InitiateAuthOutputBuilder,
