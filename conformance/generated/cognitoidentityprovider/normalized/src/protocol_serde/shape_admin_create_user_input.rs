        ...
        for item_5 in var_3 {
            {
                ...
                super::super::protocol_serde::shape_attribute_type::ser_attribute_type(&mut object_6, item_5)?;
                object_6.finish();
            }
        }
        array_4.finish();
        ...
        for item_9 in var_7 {
            {
                ...
                super::super::protocol_serde::shape_attribute_type::ser_attribute_type(&mut object_10, item_9)?;
                object_10.finish();
            }
        }
        array_8.finish();
