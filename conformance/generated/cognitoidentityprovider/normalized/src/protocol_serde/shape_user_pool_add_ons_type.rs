...
pub fn ser_user_pool_add_ons_type(
    ...
    input: &super::super::types::UserPoolAddOnsType,
...
pub(crate) fn de_user_pool_add_ons_type<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::super::types::UserPoolAddOnsType>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::super::types::builders::UserPoolAddOnsTypeBuilder::default();
            loop {
                match tokens.next().transpose()? {
                        ...
                        "AdvancedSecurityMode" => {
                            builder = builder.set_advanced_security_mode(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| super::super::types::AdvancedSecurityModeType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
