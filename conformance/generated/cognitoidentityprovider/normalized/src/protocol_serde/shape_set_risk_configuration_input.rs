...
pub fn ser_set_risk_configuration_input_input(
    ...
    if let Some(var_3) = &input.compromised_credentials_risk_configuration {
        ...
        super::super::protocol_serde::shape_compromised_credentials_risk_configuration_type::ser_compromised_credentials_risk_configuration_type(
            &mut object_4,
            var_3,
        )?;
        object_4.finish();
    ...
    if let Some(var_7) = &input.risk_exception_configuration {
        ...
        super::super::protocol_serde::shape_risk_exception_configuration_type::ser_risk_exception_configuration_type(&mut object_8, var_7)?;
        object_8.finish();
    }
    Ok(())
}
