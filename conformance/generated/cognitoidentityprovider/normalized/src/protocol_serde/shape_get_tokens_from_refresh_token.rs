...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::get_tokens_from_refresh_token::GetTokensFromRefreshTokenError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "ForbiddenException" => super::super::operation::get_tokens_from_refresh_token::GetTokensFromRefreshTokenError::ForbiddenException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalErrorException" => super::super::operation::get_tokens_from_refresh_token::GetTokensFromRefreshTokenError::InternalErrorException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidLambdaResponseException" => {
            super::super::operation::get_tokens_from_refresh_token::GetTokensFromRefreshTokenError::InvalidLambdaResponseException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "OperationNotEnabledException" => {
            super::super::operation::get_tokens_from_refresh_token::GetTokensFromRefreshTokenError::OperationNotEnabledException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "RefreshTokenReuseException" => {
            super::super::operation::get_tokens_from_refresh_token::GetTokensFromRefreshTokenError::RefreshTokenReuseException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "UserNotFoundException" => super::super::operation::get_tokens_from_refresh_token::GetTokensFromRefreshTokenError::UserNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::get_tokens_from_refresh_token::builders::GetTokensFromRefreshTokenOutputBuilder::default();
        output = super::super::protocol_serde::shape_get_tokens_from_refresh_token::de_get_tokens_from_refresh_token(_response_body, output)
            .map_err(super::super::operation::get_tokens_from_refresh_token::GetTokensFromRefreshTokenError::unhandled)?;
...
pub fn ser_get_tokens_from_refresh_token_input(
    ...
    super::super::protocol_serde::shape_get_tokens_from_refresh_token_input::ser_get_tokens_from_refresh_token_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_get_tokens_from_refresh_token(
    _value: &[u8],
    mut builder: super::super::operation::get_tokens_from_refresh_token::builders::GetTokensFromRefreshTokenOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::get_tokens_from_refresh_token::builders::GetTokensFromRefreshTokenOutputBuilder,
