...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::admin_create_user::AdminCreateUserError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "CodeDeliveryFailureException" => super::super::operation::admin_create_user::AdminCreateUserError::CodeDeliveryFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalErrorException" => super::super::operation::admin_create_user::AdminCreateUserError::InternalErrorException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidLambdaResponseException" => super::super::operation::admin_create_user::AdminCreateUserError::InvalidLambdaResponseException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidParameterException" => super::super::operation::admin_create_user::AdminCreateUserError::InvalidParameterException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidPasswordException" => super::super::operation::admin_create_user::AdminCreateUserError::InvalidPasswordException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidSmsRoleTrustRelationshipException" => {
            super::super::operation::admin_create_user::AdminCreateUserError::InvalidSmsRoleTrustRelationshipException({
                ...
                let mut tmp = {
                    ...
                    output = super::super::protocol_serde::shape_invalid_sms_role_trust_relationship_exception::de_invalid_sms_role_trust_relationship_exception_json_err(_response_body, output).map_err(super::super::operation::admin_create_user::AdminCreateUserError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        "NotAuthorizedException" => super::super::operation::admin_create_user::AdminCreateUserError::NotAuthorizedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "OperationNotEnabledException" => super::super::operation::admin_create_user::AdminCreateUserError::OperationNotEnabledException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "PreconditionNotMetException" => super::super::operation::admin_create_user::AdminCreateUserError::PreconditionNotMetException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => super::super::operation::admin_create_user::AdminCreateUserError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::super::operation::admin_create_user::AdminCreateUserError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UnexpectedLambdaException" => super::super::operation::admin_create_user::AdminCreateUserError::UnexpectedLambdaException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UnsupportedUserStateException" => super::super::operation::admin_create_user::AdminCreateUserError::UnsupportedUserStateException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                let mut output = super::super::types::error::builders::UnsupportedUserStateExceptionBuilder::default();
                output = super::super::protocol_serde::shape_unsupported_user_state_exception::de_unsupported_user_state_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(super::super::operation::admin_create_user::AdminCreateUserError::unhandled)?;
        ...
        "UserLambdaValidationException" => super::super::operation::admin_create_user::AdminCreateUserError::UserLambdaValidationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UsernameExistsException" => super::super::operation::admin_create_user::AdminCreateUserError::UsernameExistsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UserNotFoundException" => super::super::operation::admin_create_user::AdminCreateUserError::UserNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = super::super::protocol_serde::shape_admin_create_user::de_admin_create_user(_response_body, output)
            .map_err(super::super::operation::admin_create_user::AdminCreateUserError::unhandled)?;
...
pub fn ser_admin_create_user_input(
    input: &super::super::operation::admin_create_user::AdminCreateUserInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    super::super::protocol_serde::shape_admin_create_user_input::ser_admin_create_user_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_admin_create_user(
    _value: &[u8],
    mut builder: super::super::operation::admin_create_user::builders::AdminCreateUserOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::admin_create_user::builders::AdminCreateUserOutputBuilder,
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "User" => {
                    builder = builder.set_user(super::super::protocol_serde::shape_user_type::de_user_type(tokens, _value, depth + 1)?);
                }
