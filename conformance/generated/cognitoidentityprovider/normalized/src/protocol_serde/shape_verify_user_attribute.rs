...
> {
    ...
    Err(match error_code {
        "AliasExistsException" => super::super::operation::verify_user_attribute::VerifyUserAttributeError::AliasExistsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "CodeMismatchException" => super::super::operation::verify_user_attribute::VerifyUserAttributeError::CodeMismatchException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ExpiredCodeException" => super::super::operation::verify_user_attribute::VerifyUserAttributeError::ExpiredCodeException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ForbiddenException" => super::super::operation::verify_user_attribute::VerifyUserAttributeError::ForbiddenException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalErrorException" => super::super::operation::verify_user_attribute::VerifyUserAttributeError::InternalErrorException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidParameterException" => super::super::operation::verify_user_attribute::VerifyUserAttributeError::InvalidParameterException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "LimitExceededException" => super::super::operation::verify_user_attribute::VerifyUserAttributeError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotAuthorizedException" => super::super::operation::verify_user_attribute::VerifyUserAttributeError::NotAuthorizedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "OperationNotEnabledException" => super::super::operation::verify_user_attribute::VerifyUserAttributeError::OperationNotEnabledException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::super::operation::verify_user_attribute::VerifyUserAttributeError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UserNotConfirmedException" => super::super::operation::verify_user_attribute::VerifyUserAttributeError::UserNotConfirmedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UserNotFoundException" => super::super::operation::verify_user_attribute::VerifyUserAttributeError::UserNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::verify_user_attribute::builders::VerifyUserAttributeOutputBuilder::default();
...
pub fn ser_verify_user_attribute_input(
    ...
    super::super::protocol_serde::shape_verify_user_attribute_input::ser_verify_user_attribute_input_input(&mut object, input)?;
    object.finish();
