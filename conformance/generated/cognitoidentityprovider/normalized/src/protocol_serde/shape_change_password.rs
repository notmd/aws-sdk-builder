...
pub fn de_change_password_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::change_password::ChangePasswordOutput, super::super::operation::change_password::ChangePasswordError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::change_password::ChangePasswordError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "ForbiddenException" => super::super::operation::change_password::ChangePasswordError::ForbiddenException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalErrorException" => super::super::operation::change_password::ChangePasswordError::InternalErrorException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidParameterException" => super::super::operation::change_password::ChangePasswordError::InvalidParameterException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidPasswordException" => super::super::operation::change_password::ChangePasswordError::InvalidPasswordException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "LimitExceededException" => super::super::operation::change_password::ChangePasswordError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotAuthorizedException" => super::super::operation::change_password::ChangePasswordError::NotAuthorizedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "OperationNotEnabledException" => super::super::operation::change_password::ChangePasswordError::OperationNotEnabledException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "PasswordHistoryPolicyViolationException" => {
            super::super::operation::change_password::ChangePasswordError::PasswordHistoryPolicyViolationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = super::super::types::error::builders::PasswordHistoryPolicyViolationExceptionBuilder::default();
                    output = super::super::protocol_serde::shape_password_history_policy_violation_exception::de_password_history_policy_violation_exception_json_err(_response_body, output).map_err(super::super::operation::change_password::ChangePasswordError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        "PasswordResetRequiredException" => super::super::operation::change_password::ChangePasswordError::PasswordResetRequiredException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => super::super::operation::change_password::ChangePasswordError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::super::operation::change_password::ChangePasswordError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UserNotConfirmedException" => super::super::operation::change_password::ChangePasswordError::UserNotConfirmedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UserNotFoundException" => super::super::operation::change_password::ChangePasswordError::UserNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_change_password_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::change_password::builders::ChangePasswordOutputBuilder::default();
...
pub fn ser_change_password_input(
    input: &super::super::operation::change_password::ChangePasswordInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    super::super::protocol_serde::shape_change_password_input::ser_change_password_input_input(&mut object, input)?;
    object.finish();
