...
pub fn ser_describe_managed_login_branding_by_client_input(
    ...
    super::super::protocol_serde::shape_describe_managed_login_branding_by_client_input::ser_describe_managed_login_branding_by_client_input_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub(crate) fn de_describe_managed_login_branding_by_client(
    _value: &[u8],
    mut builder: super::super::operation::describe_managed_login_branding_by_client::builders::DescribeManagedLoginBrandingByClientOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::describe_managed_login_branding_by_client::builders::DescribeManagedLoginBrandingByClientOutputBuilder,
