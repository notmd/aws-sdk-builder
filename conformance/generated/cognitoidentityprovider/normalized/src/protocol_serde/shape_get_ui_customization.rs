...
pub fn ser_get_ui_customization_input(
    ...
    super::super::protocol_serde::shape_get_ui_customization_input::ser_get_ui_customization_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_get_ui_customization(
    _value: &[u8],
    mut builder: super::super::operation::get_ui_customization::builders::GetUiCustomizationOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::get_ui_customization::builders::GetUiCustomizationOutputBuilder,
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "UICustomization" => {
                    builder = builder.set_ui_customization(super::super::protocol_serde::shape_ui_customization_type::de_ui_customization_type(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
