...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::create_user_pool::CreateUserPoolError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "FeatureUnavailableInTierException" => super::super::operation::create_user_pool::CreateUserPoolError::FeatureUnavailableInTierException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalErrorException" => super::super::operation::create_user_pool::CreateUserPoolError::InternalErrorException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidEmailRoleAccessPolicyException" => {
            super::super::operation::create_user_pool::CreateUserPoolError::InvalidEmailRoleAccessPolicyException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = super::super::types::error::builders::InvalidEmailRoleAccessPolicyExceptionBuilder::default();
                    output = super::super::protocol_serde::shape_invalid_email_role_access_policy_exception::de_invalid_email_role_access_policy_exception_json_err(_response_body, output).map_err(super::super::operation::create_user_pool::CreateUserPoolError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        "InvalidParameterException" => super::super::operation::create_user_pool::CreateUserPoolError::InvalidParameterException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidSmsRoleTrustRelationshipException" => {
            super::super::operation::create_user_pool::CreateUserPoolError::InvalidSmsRoleTrustRelationshipException({
                ...
                let mut tmp = {
                    ...
                    output = super::super::protocol_serde::shape_invalid_sms_role_trust_relationship_exception::de_invalid_sms_role_trust_relationship_exception_json_err(_response_body, output).map_err(super::super::operation::create_user_pool::CreateUserPoolError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        "LimitExceededException" => super::super::operation::create_user_pool::CreateUserPoolError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotAuthorizedException" => super::super::operation::create_user_pool::CreateUserPoolError::NotAuthorizedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TierChangeNotAllowedException" => super::super::operation::create_user_pool::CreateUserPoolError::TierChangeNotAllowedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::super::operation::create_user_pool::CreateUserPoolError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UserPoolTaggingException" => super::super::operation::create_user_pool::CreateUserPoolError::UserPoolTaggingException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = super::super::protocol_serde::shape_create_user_pool::de_create_user_pool(_response_body, output)
            .map_err(super::super::operation::create_user_pool::CreateUserPoolError::unhandled)?;
...
pub fn ser_create_user_pool_input(
    input: &super::super::operation::create_user_pool::CreateUserPoolInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    super::super::protocol_serde::shape_create_user_pool_input::ser_create_user_pool_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_create_user_pool(
    _value: &[u8],
    mut builder: super::super::operation::create_user_pool::builders::CreateUserPoolOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::create_user_pool::builders::CreateUserPoolOutputBuilder,
