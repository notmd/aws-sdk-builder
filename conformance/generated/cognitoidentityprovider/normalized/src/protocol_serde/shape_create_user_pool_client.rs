...
> {
    ...
    Err(match error_code {
        "FeatureUnavailableInTierException" => {
            super::super::operation::create_user_pool_client::CreateUserPoolClientError::FeatureUnavailableInTierException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InternalErrorException" => super::super::operation::create_user_pool_client::CreateUserPoolClientError::InternalErrorException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidOAuthFlowException" => super::super::operation::create_user_pool_client::CreateUserPoolClientError::InvalidOAuthFlowException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidParameterException" => super::super::operation::create_user_pool_client::CreateUserPoolClientError::InvalidParameterException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "LimitExceededException" => super::super::operation::create_user_pool_client::CreateUserPoolClientError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotAuthorizedException" => super::super::operation::create_user_pool_client::CreateUserPoolClientError::NotAuthorizedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ScopeDoesNotExistException" => super::super::operation::create_user_pool_client::CreateUserPoolClientError::ScopeDoesNotExistException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::super::operation::create_user_pool_client::CreateUserPoolClientError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::create_user_pool_client::builders::CreateUserPoolClientOutputBuilder::default();
        output = super::super::protocol_serde::shape_create_user_pool_client::de_create_user_pool_client(_response_body, output)
            .map_err(super::super::operation::create_user_pool_client::CreateUserPoolClientError::unhandled)?;
...
pub fn ser_create_user_pool_client_input(
    ...
    super::super::protocol_serde::shape_create_user_pool_client_input::ser_create_user_pool_client_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_create_user_pool_client(
    _value: &[u8],
    mut builder: super::super::operation::create_user_pool_client::builders::CreateUserPoolClientOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::create_user_pool_client::builders::CreateUserPoolClientOutputBuilder,
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "UserPoolClient" => {
                    builder = builder.set_user_pool_client(super::super::protocol_serde::shape_user_pool_client_type::de_user_pool_client_type(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
