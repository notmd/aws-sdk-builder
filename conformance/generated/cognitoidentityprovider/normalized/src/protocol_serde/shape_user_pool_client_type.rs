...
pub(crate) fn de_user_pool_client_type<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::super::types::UserPoolClientType>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::super::types::builders::UserPoolClientTypeBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ExplicitAuthFlows" => {
                            builder = builder.set_explicit_auth_flows(
                                super::super::protocol_serde::shape_explicit_auth_flows_list_type::de_explicit_auth_flows_list_type(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "AllowedOAuthFlows" => {
                            builder = builder.set_allowed_o_auth_flows(super::super::protocol_serde::shape_o_auth_flows_type::de_o_auth_flows_type(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "AllowedOAuthScopes" => {
                            builder = builder.set_allowed_o_auth_scopes(super::super::protocol_serde::shape_scope_list_type::de_scope_list_type(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "AnalyticsConfiguration" => {
                            builder = builder.set_analytics_configuration(
                                super::super::protocol_serde::shape_analytics_configuration_type::de_analytics_configuration_type(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
