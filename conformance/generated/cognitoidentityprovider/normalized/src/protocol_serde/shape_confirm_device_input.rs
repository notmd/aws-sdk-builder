...
pub fn ser_confirm_device_input_input(
    ...
    if let Some(var_3) = &input.device_secret_verifier_config {
        ...
        super::super::protocol_serde::shape_device_secret_verifier_config_type::ser_device_secret_verifier_config_type(&mut object_4, var_3)?;
        object_4.finish();
    }
