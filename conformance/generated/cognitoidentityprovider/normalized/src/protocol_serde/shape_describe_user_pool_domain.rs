...
> {
    ...
    Err(match error_code {
        "InternalErrorException" => super::super::operation::describe_user_pool_domain::DescribeUserPoolDomainError::InternalErrorException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidParameterException" => super::super::operation::describe_user_pool_domain::DescribeUserPoolDomainError::InvalidParameterException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotAuthorizedException" => super::super::operation::describe_user_pool_domain::DescribeUserPoolDomainError::NotAuthorizedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::describe_user_pool_domain::builders::DescribeUserPoolDomainOutputBuilder::default();
        output = super::super::protocol_serde::shape_describe_user_pool_domain::de_describe_user_pool_domain(_response_body, output)
            .map_err(super::super::operation::describe_user_pool_domain::DescribeUserPoolDomainError::unhandled)?;
...
pub fn ser_describe_user_pool_domain_input(
    ...
    super::super::protocol_serde::shape_describe_user_pool_domain_input::ser_describe_user_pool_domain_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_describe_user_pool_domain(
    _value: &[u8],
    mut builder: super::super::operation::describe_user_pool_domain::builders::DescribeUserPoolDomainOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::describe_user_pool_domain::builders::DescribeUserPoolDomainOutputBuilder,
