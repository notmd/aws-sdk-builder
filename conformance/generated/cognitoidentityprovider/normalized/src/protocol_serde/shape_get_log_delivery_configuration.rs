...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::get_log_delivery_configuration::GetLogDeliveryConfigurationError::unhandled(generic)),
    };
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::get_log_delivery_configuration::builders::GetLogDeliveryConfigurationOutputBuilder::default();
        output = super::super::protocol_serde::shape_get_log_delivery_configuration::de_get_log_delivery_configuration(_response_body, output)
            .map_err(super::super::operation::get_log_delivery_configuration::GetLogDeliveryConfigurationError::unhandled)?;
...
pub fn ser_get_log_delivery_configuration_input(
    ...
    super::super::protocol_serde::shape_get_log_delivery_configuration_input::ser_get_log_delivery_configuration_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_get_log_delivery_configuration(
    _value: &[u8],
    mut builder: super::super::operation::get_log_delivery_configuration::builders::GetLogDeliveryConfigurationOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::get_log_delivery_configuration::builders::GetLogDeliveryConfigurationOutputBuilder,
