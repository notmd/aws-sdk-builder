...
pub fn ser_set_ui_customization_input(
    ...
    super::super::protocol_serde::shape_set_ui_customization_input::ser_set_ui_customization_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_set_ui_customization(
    _value: &[u8],
    mut builder: super::super::operation::set_ui_customization::builders::SetUiCustomizationOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::set_ui_customization::builders::SetUiCustomizationOutputBuilder,
