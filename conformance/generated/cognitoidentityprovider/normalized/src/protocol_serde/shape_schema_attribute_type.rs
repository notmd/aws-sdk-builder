...
pub fn ser_schema_attribute_type(
    ...
    input: &super::super::types::SchemaAttributeType,
...
pub(crate) fn de_schema_attribute_type<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::super::types::SchemaAttributeType>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::super::types::builders::SchemaAttributeTypeBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "AttributeDataType" => {
                            builder = builder.set_attribute_data_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| super::super::types::AttributeDataType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        ...
                        "NumberAttributeConstraints" => {
                            builder = builder.set_number_attribute_constraints(
                                super::super::protocol_serde::shape_number_attribute_constraints_type::de_number_attribute_constraints_type(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "StringAttributeConstraints" => {
                            builder = builder.set_string_attribute_constraints(
                                super::super::protocol_serde::shape_string_attribute_constraints_type::de_string_attribute_constraints_type(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
