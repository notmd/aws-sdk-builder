...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::delete_user_pool_client_secret::DeleteUserPoolClientSecretError::unhandled(generic)),
    };
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::delete_user_pool_client_secret::builders::DeleteUserPoolClientSecretOutputBuilder::default();
...
pub fn ser_delete_user_pool_client_secret_input(
    ...
    super::super::protocol_serde::shape_delete_user_pool_client_secret_input::ser_delete_user_pool_client_secret_input_input(&mut object, input)?;
    object.finish();
