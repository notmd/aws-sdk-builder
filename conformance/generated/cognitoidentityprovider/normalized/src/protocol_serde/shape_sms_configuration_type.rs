...
pub fn ser_sms_configuration_type(
    ...
    input: &super::super::types::SmsConfigurationType,
    ...
    if let Some(var_3) = &input.eums_sms {
        ...
        super::super::protocol_serde::shape_eums_sms_configuration_type::ser_eums_sms_configuration_type(&mut object_4, var_3)?;
        object_4.finish();
    }
    Ok(())
}
...
pub(crate) fn de_sms_configuration_type<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::super::types::SmsConfigurationType>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::super::types::builders::SmsConfigurationTypeBuilder::default();
            loop {
                match tokens.next().transpose()? {
