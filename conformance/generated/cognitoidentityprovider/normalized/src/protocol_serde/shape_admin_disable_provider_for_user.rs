...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::admin_disable_provider_for_user::AdminDisableProviderForUserError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AliasExistsException" => super::super::operation::admin_disable_provider_for_user::AdminDisableProviderForUserError::AliasExistsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            super::super::operation::admin_disable_provider_for_user::AdminDisableProviderForUserError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => {
            super::super::operation::admin_disable_provider_for_user::AdminDisableProviderForUserError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::admin_disable_provider_for_user::builders::AdminDisableProviderForUserOutputBuilder::default();
...
pub fn ser_admin_disable_provider_for_user_input(
    ...
    super::super::protocol_serde::shape_admin_disable_provider_for_user_input::ser_admin_disable_provider_for_user_input_input(&mut object, input)?;
    object.finish();
