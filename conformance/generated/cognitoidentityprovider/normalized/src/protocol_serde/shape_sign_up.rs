...
pub fn de_sign_up_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::sign_up::SignUpOutput, super::super::operation::sign_up::SignUpError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::sign_up::SignUpError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "CodeDeliveryFailureException" => super::super::operation::sign_up::SignUpError::CodeDeliveryFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ForbiddenException" => super::super::operation::sign_up::SignUpError::ForbiddenException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalErrorException" => super::super::operation::sign_up::SignUpError::InternalErrorException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidParameterException" => super::super::operation::sign_up::SignUpError::InvalidParameterException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidPasswordException" => super::super::operation::sign_up::SignUpError::InvalidPasswordException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidSmsRoleAccessPolicyException" => super::super::operation::sign_up::SignUpError::InvalidSmsRoleAccessPolicyException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidSmsRoleTrustRelationshipException" => super::super::operation::sign_up::SignUpError::InvalidSmsRoleTrustRelationshipException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                let mut output = super::super::types::error::builders::InvalidSmsRoleTrustRelationshipExceptionBuilder::default();
                output = super::super::protocol_serde::shape_invalid_sms_role_trust_relationship_exception::de_invalid_sms_role_trust_relationship_exception_json_err(_response_body, output).map_err(super::super::operation::sign_up::SignUpError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
            if tmp.message.is_none() {
        ...
        "LimitExceededException" => super::super::operation::sign_up::SignUpError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotAuthorizedException" => super::super::operation::sign_up::SignUpError::NotAuthorizedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "OperationNotEnabledException" => super::super::operation::sign_up::SignUpError::OperationNotEnabledException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => super::super::operation::sign_up::SignUpError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::super::operation::sign_up::SignUpError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UnexpectedLambdaException" => super::super::operation::sign_up::SignUpError::UnexpectedLambdaException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UserLambdaValidationException" => super::super::operation::sign_up::SignUpError::UserLambdaValidationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UsernameExistsException" => super::super::operation::sign_up::SignUpError::UsernameExistsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn ser_sign_up_input(
    ...
    super::super::protocol_serde::shape_sign_up_input::ser_sign_up_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_sign_up(
    _value: &[u8],
    mut builder: super::super::operation::sign_up::builders::SignUpOutputBuilder,
) -> ::std::result::Result<super::super::operation::sign_up::builders::SignUpOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
