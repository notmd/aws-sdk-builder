...
pub(crate) fn de_user_pool_type<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::super::types::UserPoolType>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::super::types::builders::UserPoolTypeBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Policies" => {
                            builder = builder.set_policies(super::super::protocol_serde::shape_user_pool_policy_type::de_user_pool_policy_type(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "DeletionProtection" => {
                            builder = builder.set_deletion_protection(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| super::super::types::DeletionProtectionType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "LambdaConfig" => {
                            builder = builder.set_lambda_config(super::super::protocol_serde::shape_lambda_config_type::de_lambda_config_type(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "Status" => {
                            builder = builder.set_status(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| super::super::types::StatusType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "LastModifiedDate" => {
                        ...
                        "AutoVerifiedAttributes" => {
                            builder = builder.set_auto_verified_attributes(
                                super::super::protocol_serde::shape_verified_attributes_list_type::de_verified_attributes_list_type(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "UsernameAttributes" => {
                            builder = builder.set_username_attributes(
                                super::super::protocol_serde::shape_username_attributes_list_type::de_username_attributes_list_type(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "VerificationMessageTemplate" => {
                            builder = builder.set_verification_message_template(
                                super::super::protocol_serde::shape_verification_message_template_type::de_verification_message_template_type(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "UserAttributeUpdateSettings" => {
                            builder = builder.set_user_attribute_update_settings(
                                super::super::protocol_serde::shape_user_attribute_update_settings_type::de_user_attribute_update_settings_type(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "EmailConfiguration" => {
                            builder = builder.set_email_configuration(
                                super::super::protocol_serde::shape_email_configuration_type::de_email_configuration_type(tokens, _value, depth + 1)?,
                            );
                        }
                        "SmsConfiguration" => {
                        ...
                        "AdminCreateUserConfig" => {
                            builder = builder.set_admin_create_user_config(
                                super::super::protocol_serde::shape_admin_create_user_config_type::de_admin_create_user_config_type(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "AccountRecoverySetting" => {
                            builder = builder.set_account_recovery_setting(
                                super::super::protocol_serde::shape_account_recovery_setting_type::de_account_recovery_setting_type(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "UserPoolTier" => {
                            builder = builder.set_user_pool_tier(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| super::super::types::UserPoolTierType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "KeyConfiguration" => {
