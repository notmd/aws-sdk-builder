...
> {
    ...
    Err(match error_code {
        "ForbiddenException" => super::super::operation::list_web_authn_credentials::ListWebAuthnCredentialsError::ForbiddenException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalErrorException" => super::super::operation::list_web_authn_credentials::ListWebAuthnCredentialsError::InternalErrorException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotAuthorizedException" => super::super::operation::list_web_authn_credentials::ListWebAuthnCredentialsError::NotAuthorizedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::super::operation::list_web_authn_credentials::ListWebAuthnCredentialsError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_web_authn_credentials::builders::ListWebAuthnCredentialsOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_web_authn_credentials::de_list_web_authn_credentials(_response_body, output)
            .map_err(super::super::operation::list_web_authn_credentials::ListWebAuthnCredentialsError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::super::serde_util::list_web_authn_credentials_output_output_correct_errors(output)
            .build()
            .map_err(super::super::operation::list_web_authn_credentials::ListWebAuthnCredentialsError::unhandled)?
    })
}
...
pub fn ser_list_web_authn_credentials_input(
    ...
    super::super::protocol_serde::shape_list_web_authn_credentials_input::ser_list_web_authn_credentials_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_list_web_authn_credentials(
    _value: &[u8],
    mut builder: super::super::operation::list_web_authn_credentials::builders::ListWebAuthnCredentialsOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::list_web_authn_credentials::builders::ListWebAuthnCredentialsOutputBuilder,
