...
impl ForgotPassword {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::super::operation::forgot_password::ForgotPasswordOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::forgot_password::ForgotPasswordError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::forgot_password::ForgotPasswordError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::forgot_password::ForgotPasswordOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ForgotPassword {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ForgotPassword")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ForgotPasswordResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_forgot_password::de_forgot_password_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_forgot_password::de_forgot_password_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ForgotPasswordRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::forgot_password::ForgotPasswordInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::forgot_password::ForgotPasswordInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_forgot_password::ser_forgot_password_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::forgot_password::ForgotPasswordError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::forgot_password::_forgot_password_input::ForgotPasswordInput;

pub use super::super::operation::forgot_password::_forgot_password_output::ForgotPasswordOutput;
