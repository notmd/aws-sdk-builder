...
impl ForgotPasswordInput {
    ...
    pub fn builder() -> super::super::super::operation::forgot_password::builders::ForgotPasswordInputBuilder {
        super::super::super::operation::forgot_password::builders::ForgotPasswordInputBuilder::default()
    }
}
...
impl ForgotPasswordInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::forgot_password::ForgotPasswordInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::forgot_password::ForgotPasswordInput {
