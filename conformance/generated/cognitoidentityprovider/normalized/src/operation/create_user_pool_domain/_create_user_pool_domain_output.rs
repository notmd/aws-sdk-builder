...
impl CreateUserPoolDomainOutput {
    ...
    pub fn builder() -> super::super::super::operation::create_user_pool_domain::builders::CreateUserPoolDomainOutputBuilder {
        super::super::super::operation::create_user_pool_domain::builders::CreateUserPoolDomainOutputBuilder::default()
    }
}
...
impl CreateUserPoolDomainOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::create_user_pool_domain::CreateUserPoolDomainOutput {
