...
pub struct CreateUserPoolDomainInput {
    ...
    pub custom_domain_config: ::std::option::Option<super::super::super::types::CustomDomainConfigType>,
    ...
    pub routing: ::std::option::Option<super::super::super::types::RoutingType>,
}
impl CreateUserPoolDomainInput {
    ...
    /// <p>Provide this parameter only if you want to use a <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pools-add-custom-domain.html">custom domain</a> for your user pool. Otherwise, you can omit this parameter and use a <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pools-assign-domain-prefix.html">prefix domain</a> instead.</p>
    /// <p>When you create a custom domain, the passkey RP ID defaults to the custom domain. If you had a prefix domain active, this will cause passkey integration for your prefix domain to stop working due to a mismatch in RP ID. To keep the prefix domain passkey integration working, you can explicitly set RP ID to the prefix domain.</p>
    pub fn custom_domain_config(&self) -> ::std::option::Option<&super::super::super::types::CustomDomainConfigType> {
        self.custom_domain_config.as_ref()
    }
    /// <p>The configuration of routing for requests to the domain for replicas of a replicated user pool. The routing configuration is currently only supported for custom domains.</p>
    pub fn routing(&self) -> ::std::option::Option<&super::super::super::types::RoutingType> {
        self.routing.as_ref()
    }
}
impl CreateUserPoolDomainInput {
    ...
    pub fn builder() -> super::super::super::operation::create_user_pool_domain::builders::CreateUserPoolDomainInputBuilder {
        super::super::super::operation::create_user_pool_domain::builders::CreateUserPoolDomainInputBuilder::default()
    }
}
...
pub struct CreateUserPoolDomainInputBuilder {
    ...
    pub(crate) custom_domain_config: ::std::option::Option<super::super::super::types::CustomDomainConfigType>,
    pub(crate) routing: ::std::option::Option<super::super::super::types::RoutingType>,
}
impl CreateUserPoolDomainInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::create_user_pool_domain::CreateUserPoolDomainInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::create_user_pool_domain::CreateUserPoolDomainInput {
            domain: self.domain,
