...
impl RespondToAuthChallengeOutput {
    ...
    pub fn builder() -> super::super::super::operation::respond_to_auth_challenge::builders::RespondToAuthChallengeOutputBuilder {
        super::super::super::operation::respond_to_auth_challenge::builders::RespondToAuthChallengeOutputBuilder::default()
    }
}
...
impl RespondToAuthChallengeOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::respond_to_auth_challenge::RespondToAuthChallengeOutput {
