...
impl UpdateIdentityProviderInput {
    ...
    pub fn builder() -> super::super::super::operation::update_identity_provider::builders::UpdateIdentityProviderInputBuilder {
        super::super::super::operation::update_identity_provider::builders::UpdateIdentityProviderInputBuilder::default()
    }
}
...
impl UpdateIdentityProviderInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::update_identity_provider::UpdateIdentityProviderInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::update_identity_provider::UpdateIdentityProviderInput {
