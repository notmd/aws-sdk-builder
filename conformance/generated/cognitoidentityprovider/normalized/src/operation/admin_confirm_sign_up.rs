...
impl AdminConfirmSignUp {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::admin_confirm_sign_up::AdminConfirmSignUpInput,
    ) -> ::std::result::Result<
        super::super::operation::admin_confirm_sign_up::AdminConfirmSignUpOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::admin_confirm_sign_up::AdminConfirmSignUpError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::admin_confirm_sign_up::AdminConfirmSignUpError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::admin_confirm_sign_up::AdminConfirmSignUpOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AdminConfirmSignUp {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AdminConfirmSignUp")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AdminConfirmSignUpResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_admin_confirm_sign_up::de_admin_confirm_sign_up_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_admin_confirm_sign_up::de_admin_confirm_sign_up_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AdminConfirmSignUpRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::admin_confirm_sign_up::AdminConfirmSignUpInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::admin_confirm_sign_up::AdminConfirmSignUpInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_admin_confirm_sign_up::ser_admin_confirm_sign_up_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::admin_confirm_sign_up::AdminConfirmSignUpError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::admin_confirm_sign_up::_admin_confirm_sign_up_input::AdminConfirmSignUpInput;

pub use super::super::operation::admin_confirm_sign_up::_admin_confirm_sign_up_output::AdminConfirmSignUpOutput;
