...
impl SetUserSettings {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::set_user_settings::SetUserSettingsInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::set_user_settings::SetUserSettingsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::set_user_settings::SetUserSettingsOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SetUserSettings {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SetUserSettings")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetUserSettingsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_set_user_settings::de_set_user_settings_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_set_user_settings::de_set_user_settings_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetUserSettingsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::set_user_settings::SetUserSettingsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::set_user_settings::SetUserSettingsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_set_user_settings::ser_set_user_settings_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::set_user_settings::SetUserSettingsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::set_user_settings::_set_user_settings_input::SetUserSettingsInput;

pub use super::super::operation::set_user_settings::_set_user_settings_output::SetUserSettingsOutput;
