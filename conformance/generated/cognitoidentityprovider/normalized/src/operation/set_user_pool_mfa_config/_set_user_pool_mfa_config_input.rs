...
impl SetUserPoolMfaConfigInput {
    ...
    pub fn builder() -> super::super::super::operation::set_user_pool_mfa_config::builders::SetUserPoolMfaConfigInputBuilder {
        super::super::super::operation::set_user_pool_mfa_config::builders::SetUserPoolMfaConfigInputBuilder::default()
    }
}
