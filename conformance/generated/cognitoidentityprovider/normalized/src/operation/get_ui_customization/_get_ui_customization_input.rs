...
impl GetUiCustomizationInput {
    ...
    pub fn builder() -> super::super::super::operation::get_ui_customization::builders::GetUiCustomizationInputBuilder {
        super::super::super::operation::get_ui_customization::builders::GetUiCustomizationInputBuilder::default()
    }
}
...
impl GetUiCustomizationInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::get_ui_customization::GetUiCustomizationInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::get_ui_customization::GetUiCustomizationInput {
