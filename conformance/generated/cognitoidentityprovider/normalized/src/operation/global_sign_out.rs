...
impl GlobalSignOut {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::super::operation::global_sign_out::GlobalSignOutOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::global_sign_out::GlobalSignOutError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::global_sign_out::GlobalSignOutError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::global_sign_out::GlobalSignOutOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GlobalSignOut {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GlobalSignOut")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GlobalSignOutResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_global_sign_out::de_global_sign_out_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_global_sign_out::de_global_sign_out_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GlobalSignOutRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::global_sign_out::GlobalSignOutInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::global_sign_out::GlobalSignOutInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_global_sign_out::ser_global_sign_out_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::global_sign_out::GlobalSignOutError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::global_sign_out::_global_sign_out_input::GlobalSignOutInput;

pub use super::super::operation::global_sign_out::_global_sign_out_output::GlobalSignOutOutput;
