...
impl CreateManagedLoginBrandingInput {
    ...
    pub fn assets(&self) -> &[super::super::super::types::AssetType] {
...
impl CreateManagedLoginBrandingInput {
    ...
    pub fn builder() -> super::super::super::operation::create_managed_login_branding::builders::CreateManagedLoginBrandingInputBuilder {
        super::super::super::operation::create_managed_login_branding::builders::CreateManagedLoginBrandingInputBuilder::default()
    }
}
