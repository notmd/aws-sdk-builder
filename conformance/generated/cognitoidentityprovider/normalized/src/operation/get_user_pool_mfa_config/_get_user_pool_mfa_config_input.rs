...
impl GetUserPoolMfaConfigInput {
    ...
    pub fn builder() -> super::super::super::operation::get_user_pool_mfa_config::builders::GetUserPoolMfaConfigInputBuilder {
        super::super::super::operation::get_user_pool_mfa_config::builders::GetUserPoolMfaConfigInputBuilder::default()
    }
}
