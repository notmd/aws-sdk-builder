    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::respond_to_auth_challenge::RespondToAuthChallengeError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::respond_to_auth_challenge::RespondToAuthChallengeOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RespondToAuthChallenge {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RespondToAuthChallenge")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RespondToAuthChallengeResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_respond_to_auth_challenge::de_respond_to_auth_challenge_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_respond_to_auth_challenge::de_respond_to_auth_challenge_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RespondToAuthChallengeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::respond_to_auth_challenge::RespondToAuthChallengeInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::respond_to_auth_challenge::RespondToAuthChallengeInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_respond_to_auth_challenge::ser_respond_to_auth_challenge_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::super::operation::respond_to_auth_challenge::RespondToAuthChallengeError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::respond_to_auth_challenge::_respond_to_auth_challenge_input::RespondToAuthChallengeInput;

pub use super::super::operation::respond_to_auth_challenge::_respond_to_auth_challenge_output::RespondToAuthChallengeOutput;
