...
impl UpdateManagedLoginBrandingInput {
    ...
    pub fn builder() -> super::super::super::operation::update_managed_login_branding::builders::UpdateManagedLoginBrandingInputBuilder {
        super::super::super::operation::update_managed_login_branding::builders::UpdateManagedLoginBrandingInputBuilder::default()
    }
}
