...
pub struct UpdateDeviceStatusInput {
    ...
    pub device_remembered_status: ::std::option::Option<super::super::super::types::DeviceRememberedStatusType>,
}
impl UpdateDeviceStatusInput {
    ...
    /// <p>To enable device authentication with the specified device, set to <code>remembered</code>.To disable, set to <code>not_remembered</code>.</p>
    pub fn device_remembered_status(&self) -> ::std::option::Option<&super::super::super::types::DeviceRememberedStatusType> {
...
impl UpdateDeviceStatusInput {
    ...
    pub fn builder() -> super::super::super::operation::update_device_status::builders::UpdateDeviceStatusInputBuilder {
        super::super::super::operation::update_device_status::builders::UpdateDeviceStatusInputBuilder::default()
    }
}
...
pub struct UpdateDeviceStatusInputBuilder {
    ...
    pub(crate) device_remembered_status: ::std::option::Option<super::super::super::types::DeviceRememberedStatusType>,
}
impl UpdateDeviceStatusInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::update_device_status::UpdateDeviceStatusInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::update_device_status::UpdateDeviceStatusInput {
