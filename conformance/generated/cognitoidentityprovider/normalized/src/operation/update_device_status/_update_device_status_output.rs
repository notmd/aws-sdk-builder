...
impl UpdateDeviceStatusOutput {
    ...
    pub fn builder() -> super::super::super::operation::update_device_status::builders::UpdateDeviceStatusOutputBuilder {
        super::super::super::operation::update_device_status::builders::UpdateDeviceStatusOutputBuilder::default()
    }
}
...
impl UpdateDeviceStatusOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::update_device_status::UpdateDeviceStatusOutput {
