...
impl AdminDisableUserInput {
    ...
    pub fn builder() -> super::super::super::operation::admin_disable_user::builders::AdminDisableUserInputBuilder {
        super::super::super::operation::admin_disable_user::builders::AdminDisableUserInputBuilder::default()
    }
}
...
impl AdminDisableUserInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::admin_disable_user::AdminDisableUserInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::super::operation::admin_disable_user::AdminDisableUserInput {
