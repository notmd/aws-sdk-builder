...
impl AdminDisableUserOutput {
    ...
    pub fn builder() -> super::super::super::operation::admin_disable_user::builders::AdminDisableUserOutputBuilder {
        super::super::super::operation::admin_disable_user::builders::AdminDisableUserOutputBuilder::default()
    }
}
...
impl AdminDisableUserOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::admin_disable_user::AdminDisableUserOutput {
