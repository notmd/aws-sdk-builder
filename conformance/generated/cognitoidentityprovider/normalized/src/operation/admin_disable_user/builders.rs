...
pub use super::super::super::operation::admin_disable_user::_admin_disable_user_input::AdminDisableUserInputBuilder;

pub use super::super::super::operation::admin_disable_user::_admin_disable_user_output::AdminDisableUserOutputBuilder;

impl super::super::super::operation::admin_disable_user::builders::AdminDisableUserInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::admin_disable_user::AdminDisableUserOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::admin_disable_user::AdminDisableUserError,
...
pub struct AdminDisableUserFluentBuilder {
    ...
    inner: super::super::super::operation::admin_disable_user::builders::AdminDisableUserInputBuilder,
...
impl
    super::super::super::client::customize::internal::CustomizableSend<
        super::super::super::operation::admin_disable_user::AdminDisableUserOutput,
        super::super::super::operation::admin_disable_user::AdminDisableUserError,
    > for AdminDisableUserFluentBuilder
{
    fn send(
        self,
...
impl AdminDisableUserFluentBuilder {
    /// Creates a new `AdminDisableUserFluentBuilder`.
    ...
    pub fn as_input(&self) -> &super::super::super::operation::admin_disable_user::builders::AdminDisableUserInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::admin_disable_user::AdminDisableUser::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::admin_disable_user::AdminDisableUser::orchestrate(&runtime_plugins, input).await
    }
