    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::create_user_import_job::CreateUserImportJobError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::create_user_import_job::CreateUserImportJobOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateUserImportJob {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateUserImportJob")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateUserImportJobResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_create_user_import_job::de_create_user_import_job_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_create_user_import_job::de_create_user_import_job_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateUserImportJobRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::create_user_import_job::CreateUserImportJobInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::create_user_import_job::CreateUserImportJobInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_create_user_import_job::ser_create_user_import_job_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::create_user_import_job::CreateUserImportJobError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::create_user_import_job::_create_user_import_job_input::CreateUserImportJobInput;

pub use super::super::operation::create_user_import_job::_create_user_import_job_output::CreateUserImportJobOutput;
