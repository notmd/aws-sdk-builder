...
pub use super::super::super::operation::admin_delete_user::_admin_delete_user_input::AdminDeleteUserInputBuilder;

pub use super::super::super::operation::admin_delete_user::_admin_delete_user_output::AdminDeleteUserOutputBuilder;

impl super::super::super::operation::admin_delete_user::builders::AdminDeleteUserInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::admin_delete_user::AdminDeleteUserOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::admin_delete_user::AdminDeleteUserError,
...
pub struct AdminDeleteUserFluentBuilder {
    ...
    inner: super::super::super::operation::admin_delete_user::builders::AdminDeleteUserInputBuilder,
...
impl AdminDeleteUserFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::admin_delete_user::builders::AdminDeleteUserInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::admin_delete_user::AdminDeleteUser::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::admin_delete_user::AdminDeleteUser::orchestrate(&runtime_plugins, input).await
    }
