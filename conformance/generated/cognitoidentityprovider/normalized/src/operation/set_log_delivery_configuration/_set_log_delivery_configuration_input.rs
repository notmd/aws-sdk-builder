...
pub struct SetLogDeliveryConfigurationInput {
    ...
    pub log_configurations: ::std::option::Option<::std::vec::Vec<super::super::super::types::LogConfigurationType>>,
}
impl SetLogDeliveryConfigurationInput {
    ...
    pub fn log_configurations(&self) -> &[super::super::super::types::LogConfigurationType] {
...
impl SetLogDeliveryConfigurationInput {
    ...
    pub fn builder() -> super::super::super::operation::set_log_delivery_configuration::builders::SetLogDeliveryConfigurationInputBuilder {
        super::super::super::operation::set_log_delivery_configuration::builders::SetLogDeliveryConfigurationInputBuilder::default()
    }
}
...
pub struct SetLogDeliveryConfigurationInputBuilder {
    ...
    pub(crate) log_configurations: ::std::option::Option<::std::vec::Vec<super::super::super::types::LogConfigurationType>>,
}
