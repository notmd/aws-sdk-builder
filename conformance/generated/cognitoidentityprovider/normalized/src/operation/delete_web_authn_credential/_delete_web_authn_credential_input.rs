...
impl DeleteWebAuthnCredentialInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_web_authn_credential::builders::DeleteWebAuthnCredentialInputBuilder {
        super::super::super::operation::delete_web_authn_credential::builders::DeleteWebAuthnCredentialInputBuilder::default()
    }
}
