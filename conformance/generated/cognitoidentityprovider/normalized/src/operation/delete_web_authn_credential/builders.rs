...
pub use super::super::super::operation::delete_web_authn_credential::_delete_web_authn_credential_input::DeleteWebAuthnCredentialInputBuilder;

pub use super::super::super::operation::delete_web_authn_credential::_delete_web_authn_credential_output::DeleteWebAuthnCredentialOutputBuilder;

impl super::super::super::operation::delete_web_authn_credential::builders::DeleteWebAuthnCredentialInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_web_authn_credential::DeleteWebAuthnCredentialOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_web_authn_credential::DeleteWebAuthnCredentialError,
...
pub struct DeleteWebAuthnCredentialFluentBuilder {
    ...
    inner: super::super::super::operation::delete_web_authn_credential::builders::DeleteWebAuthnCredentialInputBuilder,
...
impl DeleteWebAuthnCredentialFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_web_authn_credential::builders::DeleteWebAuthnCredentialInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_web_authn_credential::DeleteWebAuthnCredential::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_web_authn_credential::DeleteWebAuthnCredential::orchestrate(&runtime_plugins, input).await
    }
