...
impl AdminGetUser {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::super::operation::admin_get_user::AdminGetUserOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::admin_get_user::AdminGetUserError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::admin_get_user::AdminGetUserError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::admin_get_user::AdminGetUserOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AdminGetUser {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AdminGetUserResponseDeserializer,
        ));
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AdminGetUser")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AdminGetUserResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_admin_get_user::de_admin_get_user_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_admin_get_user::de_admin_get_user_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AdminGetUserRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::admin_get_user::AdminGetUserInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::admin_get_user::AdminGetUserInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_admin_get_user::ser_admin_get_user_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::admin_get_user::AdminGetUserError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::admin_get_user::_admin_get_user_input::AdminGetUserInput;

pub use super::super::operation::admin_get_user::_admin_get_user_output::AdminGetUserOutput;
