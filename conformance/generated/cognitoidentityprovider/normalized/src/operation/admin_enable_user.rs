...
impl AdminEnableUser {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::admin_enable_user::AdminEnableUserInput,
    ) -> ::std::result::Result<
        super::super::operation::admin_enable_user::AdminEnableUserOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::admin_enable_user::AdminEnableUserError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::admin_enable_user::AdminEnableUserError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::admin_enable_user::AdminEnableUserOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AdminEnableUser {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AdminEnableUser")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AdminEnableUserResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_admin_enable_user::de_admin_enable_user_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_admin_enable_user::de_admin_enable_user_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AdminEnableUserRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::admin_enable_user::AdminEnableUserInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::admin_enable_user::AdminEnableUserInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_admin_enable_user::ser_admin_enable_user_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::admin_enable_user::AdminEnableUserError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::admin_enable_user::_admin_enable_user_input::AdminEnableUserInput;

pub use super::super::operation::admin_enable_user::_admin_enable_user_output::AdminEnableUserOutput;
