...
impl DeleteResourceServerOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_resource_server::builders::DeleteResourceServerOutputBuilder {
        super::super::super::operation::delete_resource_server::builders::DeleteResourceServerOutputBuilder::default()
    }
}
...
impl DeleteResourceServerOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_resource_server::DeleteResourceServerOutput {
