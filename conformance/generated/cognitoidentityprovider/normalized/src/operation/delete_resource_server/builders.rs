...
pub use super::super::super::operation::delete_resource_server::_delete_resource_server_input::DeleteResourceServerInputBuilder;

pub use super::super::super::operation::delete_resource_server::_delete_resource_server_output::DeleteResourceServerOutputBuilder;

impl super::super::super::operation::delete_resource_server::builders::DeleteResourceServerInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_resource_server::DeleteResourceServerOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_resource_server::DeleteResourceServerError,
...
pub struct DeleteResourceServerFluentBuilder {
    ...
    inner: super::super::super::operation::delete_resource_server::builders::DeleteResourceServerInputBuilder,
...
impl DeleteResourceServerFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_resource_server::builders::DeleteResourceServerInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_resource_server::DeleteResourceServer::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_resource_server::DeleteResourceServer::orchestrate(&runtime_plugins, input).await
    }
