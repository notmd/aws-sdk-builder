...
impl ListUserPoolReplicasInput {
    ...
    pub fn builder() -> super::super::super::operation::list_user_pool_replicas::builders::ListUserPoolReplicasInputBuilder {
        super::super::super::operation::list_user_pool_replicas::builders::ListUserPoolReplicasInputBuilder::default()
    }
}
...
impl ListUserPoolReplicasInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::list_user_pool_replicas::ListUserPoolReplicasInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::list_user_pool_replicas::ListUserPoolReplicasInput {
