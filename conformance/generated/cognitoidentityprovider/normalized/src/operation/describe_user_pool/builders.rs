...
pub use super::super::super::operation::describe_user_pool::_describe_user_pool_input::DescribeUserPoolInputBuilder;

pub use super::super::super::operation::describe_user_pool::_describe_user_pool_output::DescribeUserPoolOutputBuilder;

impl super::super::super::operation::describe_user_pool::builders::DescribeUserPoolInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::describe_user_pool::DescribeUserPoolOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::describe_user_pool::DescribeUserPoolError,
...
pub struct DescribeUserPoolFluentBuilder {
    ...
    inner: super::super::super::operation::describe_user_pool::builders::DescribeUserPoolInputBuilder,
...
impl DescribeUserPoolFluentBuilder {
    /// Creates a new `DescribeUserPoolFluentBuilder`.
    ...
    pub fn as_input(&self) -> &super::super::super::operation::describe_user_pool::builders::DescribeUserPoolInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::describe_user_pool::DescribeUserPool::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::describe_user_pool::DescribeUserPool::orchestrate(&runtime_plugins, input).await
    }
