...
impl DescribeUserPoolInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_user_pool::builders::DescribeUserPoolInputBuilder {
        super::super::super::operation::describe_user_pool::builders::DescribeUserPoolInputBuilder::default()
    }
}
