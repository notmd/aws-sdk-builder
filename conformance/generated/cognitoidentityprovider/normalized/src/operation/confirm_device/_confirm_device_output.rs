...
impl ConfirmDeviceOutput {
    ...
    pub fn builder() -> super::super::super::operation::confirm_device::builders::ConfirmDeviceOutputBuilder {
        super::super::super::operation::confirm_device::builders::ConfirmDeviceOutputBuilder::default()
    }
}
...
impl ConfirmDeviceOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::confirm_device::ConfirmDeviceOutput {
