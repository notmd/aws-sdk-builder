...
pub struct ConfirmDeviceInput {
    ...
    pub device_secret_verifier_config: ::std::option::Option<super::super::super::types::DeviceSecretVerifierConfigType>,
...
impl ConfirmDeviceInput {
    ...
    /// <p>The configuration of the device secret verifier.</p>
    pub fn device_secret_verifier_config(&self) -> ::std::option::Option<&super::super::super::types::DeviceSecretVerifierConfigType> {
...
impl ConfirmDeviceInput {
    ...
    pub fn builder() -> super::super::super::operation::confirm_device::builders::ConfirmDeviceInputBuilder {
        super::super::super::operation::confirm_device::builders::ConfirmDeviceInputBuilder::default()
    }
}
...
pub struct ConfirmDeviceInputBuilder {
    ...
    pub(crate) device_secret_verifier_config: ::std::option::Option<super::super::super::types::DeviceSecretVerifierConfigType>,
