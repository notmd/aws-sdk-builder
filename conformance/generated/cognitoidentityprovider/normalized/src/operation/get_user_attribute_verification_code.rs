    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::get_user_attribute_verification_code::GetUserAttributeVerificationCodeError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::get_user_attribute_verification_code::GetUserAttributeVerificationCodeOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetUserAttributeVerificationCode {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetUserAttributeVerificationCode")
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetUserAttributeVerificationCodeTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetUserAttributeVerificationCodeInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetUserAttributeVerificationCodeResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_get_user_attribute_verification_code::de_get_user_attribute_verification_code_http_error(
                status, headers, body,
            )
        } else {
            super::super::protocol_serde::shape_get_user_attribute_verification_code::de_get_user_attribute_verification_code_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetUserAttributeVerificationCodeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::get_user_attribute_verification_code::GetUserAttributeVerificationCodeInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::get_user_attribute_verification_code::GetUserAttributeVerificationCodeInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_get_user_attribute_verification_code::ser_get_user_attribute_verification_code_input(&input)?,
        );
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetUserAttributeVerificationCodeEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "GetUserAttributeVerificationCodeEndpointParamsInterceptor"
    }
...
pub enum GetUserAttributeVerificationCodeError {
    ...
    CodeDeliveryFailureException(super::super::types::error::CodeDeliveryFailureException),
...
impl ::aws_types::request_id::RequestId for super::super::operation::get_user_attribute_verification_code::GetUserAttributeVerificationCodeError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::get_user_attribute_verification_code::_get_user_attribute_verification_code_input::GetUserAttributeVerificationCodeInput;

pub use super::super::operation::get_user_attribute_verification_code::_get_user_attribute_verification_code_output::GetUserAttributeVerificationCodeOutput;
