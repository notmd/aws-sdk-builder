...
impl AdminAddUserToGroupInput {
    ...
    pub fn builder() -> super::super::super::operation::admin_add_user_to_group::builders::AdminAddUserToGroupInputBuilder {
        super::super::super::operation::admin_add_user_to_group::builders::AdminAddUserToGroupInputBuilder::default()
    }
}
...
impl AdminAddUserToGroupInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::admin_add_user_to_group::AdminAddUserToGroupInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::admin_add_user_to_group::AdminAddUserToGroupInput {
