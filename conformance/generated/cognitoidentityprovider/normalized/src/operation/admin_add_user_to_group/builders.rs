...
pub use super::super::super::operation::admin_add_user_to_group::_admin_add_user_to_group_input::AdminAddUserToGroupInputBuilder;

pub use super::super::super::operation::admin_add_user_to_group::_admin_add_user_to_group_output::AdminAddUserToGroupOutputBuilder;

impl super::super::super::operation::admin_add_user_to_group::builders::AdminAddUserToGroupInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::admin_add_user_to_group::AdminAddUserToGroupOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::admin_add_user_to_group::AdminAddUserToGroupError,
...
///
/// <p>Adds a user to a group. A user who is in a group can present a preferred-role claim to an identity pool, and populates a <code>cognito:groups</code> claim to their access and identity tokens.</p><note>
...
pub struct AdminAddUserToGroupFluentBuilder {
    ...
    inner: super::super::super::operation::admin_add_user_to_group::builders::AdminAddUserToGroupInputBuilder,
...
impl AdminAddUserToGroupFluentBuilder {
    /// Creates a new `AdminAddUserToGroupFluentBuilder`.
    ...
    pub fn as_input(&self) -> &super::super::super::operation::admin_add_user_to_group::builders::AdminAddUserToGroupInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::admin_add_user_to_group::AdminAddUserToGroup::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::admin_add_user_to_group::AdminAddUserToGroup::orchestrate(&runtime_plugins, input).await
    }
