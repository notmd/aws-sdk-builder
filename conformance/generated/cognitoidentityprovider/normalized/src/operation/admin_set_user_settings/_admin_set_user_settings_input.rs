...
impl AdminSetUserSettingsInput {
    ...
    pub fn builder() -> super::super::super::operation::admin_set_user_settings::builders::AdminSetUserSettingsInputBuilder {
        super::super::super::operation::admin_set_user_settings::builders::AdminSetUserSettingsInputBuilder::default()
    }
}
