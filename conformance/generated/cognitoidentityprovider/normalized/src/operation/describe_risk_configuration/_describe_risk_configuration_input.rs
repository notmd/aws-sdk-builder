...
impl DescribeRiskConfigurationInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_risk_configuration::builders::DescribeRiskConfigurationInputBuilder {
        super::super::super::operation::describe_risk_configuration::builders::DescribeRiskConfigurationInputBuilder::default()
    }
}
