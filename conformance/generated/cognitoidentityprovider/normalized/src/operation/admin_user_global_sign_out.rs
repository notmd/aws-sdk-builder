...
impl AdminUserGlobalSignOut {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::admin_user_global_sign_out::AdminUserGlobalSignOutInput,
    ) -> ::std::result::Result<
        super::super::operation::admin_user_global_sign_out::AdminUserGlobalSignOutOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::admin_user_global_sign_out::AdminUserGlobalSignOutError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::admin_user_global_sign_out::AdminUserGlobalSignOutError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::admin_user_global_sign_out::AdminUserGlobalSignOutOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AdminUserGlobalSignOut {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AdminUserGlobalSignOut")
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AdminUserGlobalSignOutTelemetryInputCaptureInterceptor {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AdminUserGlobalSignOutResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_admin_user_global_sign_out::de_admin_user_global_sign_out_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_admin_user_global_sign_out::de_admin_user_global_sign_out_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AdminUserGlobalSignOutRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::admin_user_global_sign_out::AdminUserGlobalSignOutInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::admin_user_global_sign_out::AdminUserGlobalSignOutInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_admin_user_global_sign_out::ser_admin_user_global_sign_out_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::super::operation::admin_user_global_sign_out::AdminUserGlobalSignOutError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::admin_user_global_sign_out::_admin_user_global_sign_out_input::AdminUserGlobalSignOutInput;

pub use super::super::operation::admin_user_global_sign_out::_admin_user_global_sign_out_output::AdminUserGlobalSignOutOutput;
