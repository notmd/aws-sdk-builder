    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::admin_set_user_mfa_preference::AdminSetUserMFAPreferenceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::admin_set_user_mfa_preference::AdminSetUserMfaPreferenceOutput>()
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AdminSetUserMFAPreferenceTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AdminSetUserMfaPreferenceInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AdminSetUserMFAPreferenceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_admin_set_user_mfa_preference::de_admin_set_user_mfa_preference_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_admin_set_user_mfa_preference::de_admin_set_user_mfa_preference_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AdminSetUserMFAPreferenceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::admin_set_user_mfa_preference::AdminSetUserMfaPreferenceInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::admin_set_user_mfa_preference::AdminSetUserMfaPreferenceInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_admin_set_user_mfa_preference::ser_admin_set_user_mfa_preference_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::super::operation::admin_set_user_mfa_preference::AdminSetUserMFAPreferenceError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::admin_set_user_mfa_preference::_admin_set_user_mfa_preference_input::AdminSetUserMfaPreferenceInput;

pub use super::super::operation::admin_set_user_mfa_preference::_admin_set_user_mfa_preference_output::AdminSetUserMfaPreferenceOutput;
