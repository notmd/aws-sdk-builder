...
impl CreateGroupInput {
    ...
    pub fn builder() -> super::super::super::operation::create_group::builders::CreateGroupInputBuilder {
        super::super::super::operation::create_group::builders::CreateGroupInputBuilder::default()
    }
}
