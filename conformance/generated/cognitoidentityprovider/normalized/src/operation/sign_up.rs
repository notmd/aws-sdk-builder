...
impl SignUp {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::sign_up::SignUpInput,
    ) -> ::std::result::Result<
        super::super::operation::sign_up::SignUpOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::sign_up::SignUpError,
    ...
    > {
        let map_err =
            |err: ::aws_smithy_runtime_api::client::result::SdkError<
                ...
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >| { err.map_service_error(|err| err.downcast::<super::super::operation::sign_up::SignUpError>().expect("correct error type")) };
        let context = Self::orchestrate_with_stop_point(runtime_plugins, input, ::aws_smithy_runtime::client::orchestrator::StopPoint::None)
            .await
            .map_err(map_err)?;
        let output = context.finalize().map_err(map_err)?;
        ::std::result::Result::Ok(output.downcast::<super::super::operation::sign_up::SignUpOutput>().expect("correct output type"))
    }
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Cognito Identity Provider", "SignUp", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SignUpResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_sign_up::de_sign_up_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_sign_up::de_sign_up_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SignUpRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::super::operation::sign_up::SignUpInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::sign_up::SignUpInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_sign_up::ser_sign_up_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SignUpEndpointParamsInterceptor {
    ...
    fn read_before_execution(
        ...
        let _input = context.input().downcast_ref::<SignUpInput>().ok_or("failed to downcast to SignUpInput")?;
...
pub enum SignUpError {
    ...
    UsernameExistsException(super::super::types::error::UsernameExistsException),
...
impl ::aws_types::request_id::RequestId for super::super::operation::sign_up::SignUpError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::sign_up::_sign_up_input::SignUpInput;

pub use super::super::operation::sign_up::_sign_up_output::SignUpOutput;
