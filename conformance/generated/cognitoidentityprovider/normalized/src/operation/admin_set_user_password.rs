...
impl AdminSetUserPassword {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::admin_set_user_password::AdminSetUserPasswordInput,
    ) -> ::std::result::Result<
        super::super::operation::admin_set_user_password::AdminSetUserPasswordOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::admin_set_user_password::AdminSetUserPasswordError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::admin_set_user_password::AdminSetUserPasswordError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::admin_set_user_password::AdminSetUserPasswordOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AdminSetUserPassword {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AdminSetUserPassword")
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AdminSetUserPasswordTelemetryInputCaptureInterceptor {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AdminSetUserPasswordResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_admin_set_user_password::de_admin_set_user_password_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_admin_set_user_password::de_admin_set_user_password_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AdminSetUserPasswordRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::admin_set_user_password::AdminSetUserPasswordInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::admin_set_user_password::AdminSetUserPasswordInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_admin_set_user_password::ser_admin_set_user_password_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::admin_set_user_password::AdminSetUserPasswordError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::admin_set_user_password::_admin_set_user_password_input::AdminSetUserPasswordInput;

pub use super::super::operation::admin_set_user_password::_admin_set_user_password_output::AdminSetUserPasswordOutput;
