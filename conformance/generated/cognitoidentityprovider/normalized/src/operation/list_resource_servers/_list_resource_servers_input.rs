...
impl ListResourceServersInput {
    ...
    pub fn builder() -> super::super::super::operation::list_resource_servers::builders::ListResourceServersInputBuilder {
        super::super::super::operation::list_resource_servers::builders::ListResourceServersInputBuilder::default()
    }
}
