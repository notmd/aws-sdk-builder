...
pub struct ListResourceServersOutput {
    ...
    pub resource_servers: ::std::vec::Vec<super::super::super::types::ResourceServerType>,
...
impl ListResourceServersOutput {
    /// <p>An array of resource servers and the details of their configuration. For each, the response includes names, identifiers, and custom scopes.</p>
    pub fn resource_servers(&self) -> &[super::super::super::types::ResourceServerType] {
        use std::ops::Deref;
...
impl ListResourceServersOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_resource_servers::builders::ListResourceServersOutputBuilder {
        super::super::super::operation::list_resource_servers::builders::ListResourceServersOutputBuilder::default()
    }
}
...
pub struct ListResourceServersOutputBuilder {
    pub(crate) resource_servers: ::std::option::Option<::std::vec::Vec<super::super::super::types::ResourceServerType>>,
...
impl ListResourceServersOutputBuilder {
    ...
    ///
    /// <p>An array of resource servers and the details of their configuration. For each, the response includes names, identifiers, and custom scopes.</p>
    pub fn resource_servers(mut self, input: super::super::super::types::ResourceServerType) -> Self {
    ...
    /// <p>An array of resource servers and the details of their configuration. For each, the response includes names, identifiers, and custom scopes.</p>
    pub fn set_resource_servers(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::ResourceServerType>>) -> Self {
        self.resource_servers = input;
        self
    }
    /// <p>An array of resource servers and the details of their configuration. For each, the response includes names, identifiers, and custom scopes.</p>
    pub fn get_resource_servers(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::ResourceServerType>> {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::list_resource_servers::ListResourceServersOutput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::list_resource_servers::ListResourceServersOutput {
