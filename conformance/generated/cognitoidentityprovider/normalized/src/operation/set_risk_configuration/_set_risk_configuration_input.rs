...
pub struct SetRiskConfigurationInput {
    ...
    pub compromised_credentials_risk_configuration: ::std::option::Option<super::super::super::types::CompromisedCredentialsRiskConfigurationType>,
    /// <p>The settings for automated responses and notification templates for adaptive authentication with threat protection.</p>
    pub account_takeover_risk_configuration: ::std::option::Option<super::super::super::types::AccountTakeoverRiskConfigurationType>,
    /// <p>A set of IP-address overrides to threat protection. You can set up IP-address always-block and always-allow lists.</p>
    pub risk_exception_configuration: ::std::option::Option<super::super::super::types::RiskExceptionConfigurationType>,
}
impl SetRiskConfigurationInput {
    ...
    /// <p>The settings for automated responses and notification templates for adaptive authentication with threat protection.</p>
    pub fn account_takeover_risk_configuration(&self) -> ::std::option::Option<&super::super::super::types::AccountTakeoverRiskConfigurationType> {
        self.account_takeover_risk_configuration.as_ref()
    }
    /// <p>A set of IP-address overrides to threat protection. You can set up IP-address always-block and always-allow lists.</p>
    pub fn risk_exception_configuration(&self) -> ::std::option::Option<&super::super::super::types::RiskExceptionConfigurationType> {
...
impl SetRiskConfigurationInput {
    ...
    pub fn builder() -> super::super::super::operation::set_risk_configuration::builders::SetRiskConfigurationInputBuilder {
        super::super::super::operation::set_risk_configuration::builders::SetRiskConfigurationInputBuilder::default()
    }
}
