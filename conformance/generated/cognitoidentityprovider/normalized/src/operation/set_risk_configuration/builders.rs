...
pub use super::super::super::operation::set_risk_configuration::_set_risk_configuration_input::SetRiskConfigurationInputBuilder;

pub use super::super::super::operation::set_risk_configuration::_set_risk_configuration_output::SetRiskConfigurationOutputBuilder;

impl super::super::super::operation::set_risk_configuration::builders::SetRiskConfigurationInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::set_risk_configuration::SetRiskConfigurationOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::set_risk_configuration::SetRiskConfigurationError,
...
pub struct SetRiskConfigurationFluentBuilder {
    ...
    inner: super::super::super::operation::set_risk_configuration::builders::SetRiskConfigurationInputBuilder,
...
impl SetRiskConfigurationFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::set_risk_configuration::builders::SetRiskConfigurationInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::set_risk_configuration::SetRiskConfiguration::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::set_risk_configuration::SetRiskConfiguration::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn set_compromised_credentials_risk_configuration(
        mut self,
        input: ::std::option::Option<super::super::super::types::CompromisedCredentialsRiskConfigurationType>,
    ) -> Self {
    ...
    pub fn account_takeover_risk_configuration(mut self, input: super::super::super::types::AccountTakeoverRiskConfigurationType) -> Self {
    ...
    pub fn set_account_takeover_risk_configuration(
        mut self,
        input: ::std::option::Option<super::super::super::types::AccountTakeoverRiskConfigurationType>,
    ) -> Self {
    ...
    pub fn risk_exception_configuration(mut self, input: super::super::super::types::RiskExceptionConfigurationType) -> Self {
    ...
    /// <p>A set of IP-address overrides to threat protection. You can set up IP-address always-block and always-allow lists.</p>
    pub fn get_risk_exception_configuration(&self) -> &::std::option::Option<super::super::super::types::RiskExceptionConfigurationType> {
