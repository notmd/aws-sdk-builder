...
impl DescribeManagedLoginBrandingInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_managed_login_branding::builders::DescribeManagedLoginBrandingInputBuilder {
        super::super::super::operation::describe_managed_login_branding::builders::DescribeManagedLoginBrandingInputBuilder::default()
    }
}
...
impl DescribeManagedLoginBrandingInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::describe_managed_login_branding::DescribeManagedLoginBrandingInput,
