...
pub use super::super::super::operation::describe_managed_login_branding::_describe_managed_login_branding_input::DescribeManagedLoginBrandingInputBuilder;

pub use super::super::super::operation::describe_managed_login_branding::_describe_managed_login_branding_output::DescribeManagedLoginBrandingOutputBuilder;

impl super::super::super::operation::describe_managed_login_branding::builders::DescribeManagedLoginBrandingInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::describe_managed_login_branding::DescribeManagedLoginBrandingOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::describe_managed_login_branding::DescribeManagedLoginBrandingError,
...
pub struct DescribeManagedLoginBrandingFluentBuilder {
    ...
    inner: super::super::super::operation::describe_managed_login_branding::builders::DescribeManagedLoginBrandingInputBuilder,
...
impl DescribeManagedLoginBrandingFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::describe_managed_login_branding::builders::DescribeManagedLoginBrandingInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::describe_managed_login_branding::DescribeManagedLoginBranding::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::describe_managed_login_branding::DescribeManagedLoginBranding::orchestrate(&runtime_plugins, input).await
    }
