...
impl VerifyUserAttributeInput {
    ...
    pub fn builder() -> super::super::super::operation::verify_user_attribute::builders::VerifyUserAttributeInputBuilder {
        super::super::super::operation::verify_user_attribute::builders::VerifyUserAttributeInputBuilder::default()
    }
}
