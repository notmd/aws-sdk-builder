...
pub use super::super::super::operation::verify_user_attribute::_verify_user_attribute_input::VerifyUserAttributeInputBuilder;

pub use super::super::super::operation::verify_user_attribute::_verify_user_attribute_output::VerifyUserAttributeOutputBuilder;

impl super::super::super::operation::verify_user_attribute::builders::VerifyUserAttributeInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::verify_user_attribute::VerifyUserAttributeOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::verify_user_attribute::VerifyUserAttributeError,
...
pub struct VerifyUserAttributeFluentBuilder {
    ...
    inner: super::super::super::operation::verify_user_attribute::builders::VerifyUserAttributeInputBuilder,
...
impl VerifyUserAttributeFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::verify_user_attribute::builders::VerifyUserAttributeInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::verify_user_attribute::VerifyUserAttribute::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::verify_user_attribute::VerifyUserAttribute::orchestrate(&runtime_plugins, input).await
    }
