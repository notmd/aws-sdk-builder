...
impl GetSigningCertificateInput {
    ...
    pub fn builder() -> super::super::super::operation::get_signing_certificate::builders::GetSigningCertificateInputBuilder {
        super::super::super::operation::get_signing_certificate::builders::GetSigningCertificateInputBuilder::default()
    }
}
