...
impl GetUserInput {
    ...
    pub fn builder() -> super::super::super::operation::get_user::builders::GetUserInputBuilder {
        super::super::super::operation::get_user::builders::GetUserInputBuilder::default()
    }
}
...
impl GetUserInputBuilder {
    ...
    pub fn build(
        ...
        ::std::result::Result::Ok(super::super::super::operation::get_user::GetUserInput {
