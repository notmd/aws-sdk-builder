...
impl AssociateSoftwareTokenInput {
    ...
    pub fn builder() -> super::super::super::operation::associate_software_token::builders::AssociateSoftwareTokenInputBuilder {
        super::super::super::operation::associate_software_token::builders::AssociateSoftwareTokenInputBuilder::default()
    }
}
...
impl AssociateSoftwareTokenInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::associate_software_token::AssociateSoftwareTokenInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::associate_software_token::AssociateSoftwareTokenInput {
