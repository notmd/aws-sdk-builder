...
pub use super::super::super::operation::associate_software_token::_associate_software_token_input::AssociateSoftwareTokenInputBuilder;

pub use super::super::super::operation::associate_software_token::_associate_software_token_output::AssociateSoftwareTokenOutputBuilder;

impl super::super::super::operation::associate_software_token::builders::AssociateSoftwareTokenInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::associate_software_token::AssociateSoftwareTokenOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::associate_software_token::AssociateSoftwareTokenError,
...
pub struct AssociateSoftwareTokenFluentBuilder {
    ...
    inner: super::super::super::operation::associate_software_token::builders::AssociateSoftwareTokenInputBuilder,
...
impl AssociateSoftwareTokenFluentBuilder {
    /// Creates a new `AssociateSoftwareTokenFluentBuilder`.
    ...
    pub fn as_input(&self) -> &super::super::super::operation::associate_software_token::builders::AssociateSoftwareTokenInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::associate_software_token::AssociateSoftwareToken::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::associate_software_token::AssociateSoftwareToken::orchestrate(&runtime_plugins, input).await
    }
