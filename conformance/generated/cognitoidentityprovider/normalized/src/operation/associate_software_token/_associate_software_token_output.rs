...
impl AssociateSoftwareTokenOutput {
    ...
    pub fn builder() -> super::super::super::operation::associate_software_token::builders::AssociateSoftwareTokenOutputBuilder {
        super::super::super::operation::associate_software_token::builders::AssociateSoftwareTokenOutputBuilder::default()
    }
}
...
impl AssociateSoftwareTokenOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::associate_software_token::AssociateSoftwareTokenOutput {
