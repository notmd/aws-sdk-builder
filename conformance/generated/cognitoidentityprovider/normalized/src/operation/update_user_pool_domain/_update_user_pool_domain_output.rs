...
impl UpdateUserPoolDomainOutput {
    ...
    pub fn builder() -> super::super::super::operation::update_user_pool_domain::builders::UpdateUserPoolDomainOutputBuilder {
        super::super::super::operation::update_user_pool_domain::builders::UpdateUserPoolDomainOutputBuilder::default()
    }
}
...
impl UpdateUserPoolDomainOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::update_user_pool_domain::UpdateUserPoolDomainOutput {
