...
impl UpdateUserPoolDomainInput {
    ...
    pub fn builder() -> super::super::super::operation::update_user_pool_domain::builders::UpdateUserPoolDomainInputBuilder {
        super::super::super::operation::update_user_pool_domain::builders::UpdateUserPoolDomainInputBuilder::default()
    }
}
...
impl UpdateUserPoolDomainInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::update_user_pool_domain::UpdateUserPoolDomainInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::update_user_pool_domain::UpdateUserPoolDomainInput {
            domain: self.domain,
