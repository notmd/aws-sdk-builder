...
impl CreateUserPoolClientInput {
    ...
    pub fn builder() -> super::super::super::operation::create_user_pool_client::builders::CreateUserPoolClientInputBuilder {
        super::super::super::operation::create_user_pool_client::builders::CreateUserPoolClientInputBuilder::default()
    }
}
...
impl CreateUserPoolClientInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::create_user_pool_client::CreateUserPoolClientInput, ::aws_smithy_types::error::operation::BuildError>
    {
