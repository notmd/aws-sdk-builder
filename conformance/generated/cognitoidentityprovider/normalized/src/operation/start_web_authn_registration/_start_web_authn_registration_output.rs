...
impl StartWebAuthnRegistrationOutput {
    ...
    pub fn builder() -> super::super::super::operation::start_web_authn_registration::builders::StartWebAuthnRegistrationOutputBuilder {
        super::super::super::operation::start_web_authn_registration::builders::StartWebAuthnRegistrationOutputBuilder::default()
    }
}
