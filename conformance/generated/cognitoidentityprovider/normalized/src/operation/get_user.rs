...
impl GetUser {
    ...
    > {
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::get_user::GetUserOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetUserResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_get_user::de_get_user_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_get_user::de_get_user_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetUserRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::super::operation::get_user::GetUserInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::get_user::GetUserInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_get_user::ser_get_user_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::get_user::GetUserError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::get_user::_get_user_input::GetUserInput;

pub use super::super::operation::get_user::_get_user_output::GetUserOutput;
