...
pub struct AdminGetUserOutput {
    ...
    /// </ul>
    pub user_status: ::std::option::Option<super::super::super::types::UserStatusType>,
    ...
    pub mfa_options: ::std::option::Option<::std::vec::Vec<super::super::super::types::MfaOptionType>>,
...
impl AdminGetUserOutput {
    ...
    /// <p>EXTERNAL_PROVIDER - The user signed in with a third-party identity provider.</p></li>
    /// </ul>
    pub fn user_status(&self) -> ::std::option::Option<&super::super::super::types::UserStatusType> {
    ...
    pub fn mfa_options(&self) -> &[super::super::super::types::MfaOptionType] {
...
impl AdminGetUserOutput {
    ...
    pub fn builder() -> super::super::super::operation::admin_get_user::builders::AdminGetUserOutputBuilder {
        super::super::super::operation::admin_get_user::builders::AdminGetUserOutputBuilder::default()
    }
}
...
pub struct AdminGetUserOutputBuilder {
    ...
    pub(crate) user_status: ::std::option::Option<super::super::super::types::UserStatusType>,
    pub(crate) mfa_options: ::std::option::Option<::std::vec::Vec<super::super::super::types::MfaOptionType>>,
...
impl AdminGetUserOutputBuilder {
    ...
    /// <p>EXTERNAL_PROVIDER - The user signed in with a third-party identity provider.</p></li>
    /// </ul>
    pub fn user_status(mut self, input: super::super::super::types::UserStatusType) -> Self {
    ...
    /// <p>EXTERNAL_PROVIDER - The user signed in with a third-party identity provider.</p></li>
    /// </ul>
    pub fn set_user_status(mut self, input: ::std::option::Option<super::super::super::types::UserStatusType>) -> Self {
    ...
    /// <p>EXTERNAL_PROVIDER - The user signed in with a third-party identity provider.</p></li>
    /// </ul>
    pub fn get_user_status(&self) -> &::std::option::Option<super::super::super::types::UserStatusType> {
        &self.user_status
    }
    ...
    ///
    /// <p><i>This response parameter is no longer supported.</i> It provides information only about SMS MFA configurations. It doesn't provide information about time-based one-time password (TOTP) software token MFA configurations. To look up information about either type of MFA configuration, use UserMFASettingList instead.</p>
    pub fn mfa_options(mut self, input: super::super::super::types::MfaOptionType) -> Self {
    ...
    /// <p><i>This response parameter is no longer supported.</i> It provides information only about SMS MFA configurations. It doesn't provide information about time-based one-time password (TOTP) software token MFA configurations. To look up information about either type of MFA configuration, use UserMFASettingList instead.</p>
    pub fn set_mfa_options(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::MfaOptionType>>) -> Self {
        self.mfa_options = input;
        self
    }
    /// <p><i>This response parameter is no longer supported.</i> It provides information only about SMS MFA configurations. It doesn't provide information about time-based one-time password (TOTP) software token MFA configurations. To look up information about either type of MFA configuration, use UserMFASettingList instead.</p>
    pub fn get_mfa_options(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::MfaOptionType>> {
        &self.mfa_options
    }
    /// <p>The user's preferred MFA. Users can prefer SMS message, email message, or TOTP MFA.</p>
