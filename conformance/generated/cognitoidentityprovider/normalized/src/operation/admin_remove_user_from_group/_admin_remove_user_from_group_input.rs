...
impl AdminRemoveUserFromGroupInput {
    ...
    pub fn builder() -> super::super::super::operation::admin_remove_user_from_group::builders::AdminRemoveUserFromGroupInputBuilder {
        super::super::super::operation::admin_remove_user_from_group::builders::AdminRemoveUserFromGroupInputBuilder::default()
    }
}
