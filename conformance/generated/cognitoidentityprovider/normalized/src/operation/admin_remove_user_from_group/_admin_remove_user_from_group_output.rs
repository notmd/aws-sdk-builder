...
impl AdminRemoveUserFromGroupOutput {
    ...
    pub fn builder() -> super::super::super::operation::admin_remove_user_from_group::builders::AdminRemoveUserFromGroupOutputBuilder {
        super::super::super::operation::admin_remove_user_from_group::builders::AdminRemoveUserFromGroupOutputBuilder::default()
    }
}
...
impl AdminRemoveUserFromGroupOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::admin_remove_user_from_group::AdminRemoveUserFromGroupOutput {
