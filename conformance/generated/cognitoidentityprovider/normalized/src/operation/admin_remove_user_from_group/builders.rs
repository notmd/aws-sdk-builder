...
pub use super::super::super::operation::admin_remove_user_from_group::_admin_remove_user_from_group_input::AdminRemoveUserFromGroupInputBuilder;

pub use super::super::super::operation::admin_remove_user_from_group::_admin_remove_user_from_group_output::AdminRemoveUserFromGroupOutputBuilder;

impl super::super::super::operation::admin_remove_user_from_group::builders::AdminRemoveUserFromGroupInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::admin_remove_user_from_group::AdminRemoveUserFromGroupOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::admin_remove_user_from_group::AdminRemoveUserFromGroupError,
...
pub struct AdminRemoveUserFromGroupFluentBuilder {
    ...
    inner: super::super::super::operation::admin_remove_user_from_group::builders::AdminRemoveUserFromGroupInputBuilder,
...
impl AdminRemoveUserFromGroupFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::admin_remove_user_from_group::builders::AdminRemoveUserFromGroupInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::admin_remove_user_from_group::AdminRemoveUserFromGroup::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::admin_remove_user_from_group::AdminRemoveUserFromGroup::orchestrate(&runtime_plugins, input).await
    }
