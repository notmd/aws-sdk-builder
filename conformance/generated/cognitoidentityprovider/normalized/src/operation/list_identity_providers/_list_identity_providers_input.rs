...
impl ListIdentityProvidersInput {
    ...
    pub fn builder() -> super::super::super::operation::list_identity_providers::builders::ListIdentityProvidersInputBuilder {
        super::super::super::operation::list_identity_providers::builders::ListIdentityProvidersInputBuilder::default()
    }
}
...
impl ListIdentityProvidersInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::list_identity_providers::ListIdentityProvidersInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::list_identity_providers::ListIdentityProvidersInput {
