...
pub struct ListIdentityProvidersOutput {
    ...
    pub providers: ::std::vec::Vec<super::super::super::types::ProviderDescription>,
...
impl ListIdentityProvidersOutput {
    /// <p>An array of the IdPs in your user pool. For each, the response includes identifiers, the IdP name and type, and trust-relationship details like the issuer URL.</p>
    pub fn providers(&self) -> &[super::super::super::types::ProviderDescription] {
        use std::ops::Deref;
...
impl ListIdentityProvidersOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_identity_providers::builders::ListIdentityProvidersOutputBuilder {
        super::super::super::operation::list_identity_providers::builders::ListIdentityProvidersOutputBuilder::default()
    }
}
...
pub struct ListIdentityProvidersOutputBuilder {
    pub(crate) providers: ::std::option::Option<::std::vec::Vec<super::super::super::types::ProviderDescription>>,
...
impl ListIdentityProvidersOutputBuilder {
    ...
    ///
    /// <p>An array of the IdPs in your user pool. For each, the response includes identifiers, the IdP name and type, and trust-relationship details like the issuer URL.</p>
    pub fn providers(mut self, input: super::super::super::types::ProviderDescription) -> Self {
    ...
    /// <p>An array of the IdPs in your user pool. For each, the response includes identifiers, the IdP name and type, and trust-relationship details like the issuer URL.</p>
    pub fn set_providers(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::ProviderDescription>>) -> Self {
        self.providers = input;
        self
    }
    /// <p>An array of the IdPs in your user pool. For each, the response includes identifiers, the IdP name and type, and trust-relationship details like the issuer URL.</p>
    pub fn get_providers(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::ProviderDescription>> {
        &self.providers
    }
    /// <p>The identifier that Amazon Cognito returned with the previous request to this operation. When you include a pagination token in your request, Amazon Cognito returns the next set of items in the list. By use of this token, you can paginate through the full list of items.</p>
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::list_identity_providers::ListIdentityProvidersOutput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::list_identity_providers::ListIdentityProvidersOutput {
