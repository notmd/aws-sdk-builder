    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::admin_initiate_auth::AdminInitiateAuthError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::admin_initiate_auth::AdminInitiateAuthOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AdminInitiateAuth {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AdminInitiateAuth")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AdminInitiateAuthResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_admin_initiate_auth::de_admin_initiate_auth_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_admin_initiate_auth::de_admin_initiate_auth_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AdminInitiateAuthRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::admin_initiate_auth::AdminInitiateAuthInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::admin_initiate_auth::AdminInitiateAuthInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_admin_initiate_auth::ser_admin_initiate_auth_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::admin_initiate_auth::AdminInitiateAuthError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::admin_initiate_auth::_admin_initiate_auth_input::AdminInitiateAuthInput;

pub use super::super::operation::admin_initiate_auth::_admin_initiate_auth_output::AdminInitiateAuthOutput;
