...
impl ListUsers {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::list_users::ListUsersInput,
    ) -> ::std::result::Result<
        super::super::operation::list_users::ListUsersOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::list_users::ListUsersError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::list_users::ListUsersError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::list_users::ListUsersOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListUsersResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_list_users::de_list_users_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_list_users::de_list_users_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListUsersRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::list_users::ListUsersInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_list_users::ser_list_users_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::list_users::ListUsersError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::list_users::_list_users_input::ListUsersInput;

pub use super::super::operation::list_users::_list_users_output::ListUsersOutput;
