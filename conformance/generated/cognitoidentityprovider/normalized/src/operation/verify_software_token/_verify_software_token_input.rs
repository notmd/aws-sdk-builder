...
impl VerifySoftwareTokenInput {
    ...
    pub fn builder() -> super::super::super::operation::verify_software_token::builders::VerifySoftwareTokenInputBuilder {
        super::super::super::operation::verify_software_token::builders::VerifySoftwareTokenInputBuilder::default()
    }
}
...
impl VerifySoftwareTokenInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::verify_software_token::VerifySoftwareTokenInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::verify_software_token::VerifySoftwareTokenInput {
