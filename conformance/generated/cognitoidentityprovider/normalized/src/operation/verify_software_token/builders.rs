...
pub use super::super::super::operation::verify_software_token::_verify_software_token_input::VerifySoftwareTokenInputBuilder;

pub use super::super::super::operation::verify_software_token::_verify_software_token_output::VerifySoftwareTokenOutputBuilder;

impl super::super::super::operation::verify_software_token::builders::VerifySoftwareTokenInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::verify_software_token::VerifySoftwareTokenOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::verify_software_token::VerifySoftwareTokenError,
...
pub struct VerifySoftwareTokenFluentBuilder {
    ...
    inner: super::super::super::operation::verify_software_token::builders::VerifySoftwareTokenInputBuilder,
...
impl VerifySoftwareTokenFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::verify_software_token::builders::VerifySoftwareTokenInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::verify_software_token::VerifySoftwareToken::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::verify_software_token::VerifySoftwareToken::orchestrate(&runtime_plugins, input).await
    }
