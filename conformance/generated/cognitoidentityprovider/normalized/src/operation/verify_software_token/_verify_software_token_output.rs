...
pub struct VerifySoftwareTokenOutput {
    ...
    pub status: ::std::option::Option<super::super::super::types::VerifySoftwareTokenResponseType>,
...
impl VerifySoftwareTokenOutput {
    /// <p>Amazon Cognito can accept or reject the code that you provide. This response parameter indicates the success of TOTP verification. Some reasons that this operation might return an error are clock skew on the user's device and excessive retries.</p>
    pub fn status(&self) -> ::std::option::Option<&super::super::super::types::VerifySoftwareTokenResponseType> {
        self.status.as_ref()
    }
    /// <p>This session ID satisfies an <code>MFA_SETUP</code> challenge. Supply the session ID in your challenge response.</p>
...
impl VerifySoftwareTokenOutput {
    ...
    pub fn builder() -> super::super::super::operation::verify_software_token::builders::VerifySoftwareTokenOutputBuilder {
        super::super::super::operation::verify_software_token::builders::VerifySoftwareTokenOutputBuilder::default()
    }
}
...
pub struct VerifySoftwareTokenOutputBuilder {
    pub(crate) status: ::std::option::Option<super::super::super::types::VerifySoftwareTokenResponseType>,
    pub(crate) session: ::std::option::Option<::std::string::String>,
    _request_id: Option<String>,
}
impl VerifySoftwareTokenOutputBuilder {
    /// <p>Amazon Cognito can accept or reject the code that you provide. This response parameter indicates the success of TOTP verification. Some reasons that this operation might return an error are clock skew on the user's device and excessive retries.</p>
    pub fn status(mut self, input: super::super::super::types::VerifySoftwareTokenResponseType) -> Self {
        self.status = ::std::option::Option::Some(input);
        self
    }
    /// <p>Amazon Cognito can accept or reject the code that you provide. This response parameter indicates the success of TOTP verification. Some reasons that this operation might return an error are clock skew on the user's device and excessive retries.</p>
    pub fn set_status(mut self, input: ::std::option::Option<super::super::super::types::VerifySoftwareTokenResponseType>) -> Self {
        self.status = input;
        self
    }
    /// <p>Amazon Cognito can accept or reject the code that you provide. This response parameter indicates the success of TOTP verification. Some reasons that this operation might return an error are clock skew on the user's device and excessive retries.</p>
    pub fn get_status(&self) -> &::std::option::Option<super::super::super::types::VerifySoftwareTokenResponseType> {
        &self.status
    }
    /// <p>This session ID satisfies an <code>MFA_SETUP</code> challenge. Supply the session ID in your challenge response.</p>
    ...
    pub fn build(self) -> super::super::super::operation::verify_software_token::VerifySoftwareTokenOutput {
