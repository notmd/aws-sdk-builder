...
impl AdminUpdateAuthEventFeedbackOutput {
    ...
    pub fn builder() -> super::super::super::operation::admin_update_auth_event_feedback::builders::AdminUpdateAuthEventFeedbackOutputBuilder {
        super::super::super::operation::admin_update_auth_event_feedback::builders::AdminUpdateAuthEventFeedbackOutputBuilder::default()
    }
}
...
impl AdminUpdateAuthEventFeedbackOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::admin_update_auth_event_feedback::AdminUpdateAuthEventFeedbackOutput {
