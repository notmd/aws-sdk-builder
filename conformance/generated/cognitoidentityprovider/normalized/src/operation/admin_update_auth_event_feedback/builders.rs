...
pub use super::super::super::operation::admin_update_auth_event_feedback::_admin_update_auth_event_feedback_input::AdminUpdateAuthEventFeedbackInputBuilder;

pub use super::super::super::operation::admin_update_auth_event_feedback::_admin_update_auth_event_feedback_output::AdminUpdateAuthEventFeedbackOutputBuilder;

impl super::super::super::operation::admin_update_auth_event_feedback::builders::AdminUpdateAuthEventFeedbackInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::admin_update_auth_event_feedback::AdminUpdateAuthEventFeedbackOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::admin_update_auth_event_feedback::AdminUpdateAuthEventFeedbackError,
...
pub struct AdminUpdateAuthEventFeedbackFluentBuilder {
    ...
    inner: super::super::super::operation::admin_update_auth_event_feedback::builders::AdminUpdateAuthEventFeedbackInputBuilder,
...
impl AdminUpdateAuthEventFeedbackFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::admin_update_auth_event_feedback::builders::AdminUpdateAuthEventFeedbackInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::admin_update_auth_event_feedback::AdminUpdateAuthEventFeedback::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::admin_update_auth_event_feedback::AdminUpdateAuthEventFeedback::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn feedback_value(mut self, input: super::super::super::types::FeedbackValueType) -> Self {
        self.inner = self.inner.feedback_value(input);
        self
    }
    /// <p>Your feedback to the authentication event. When you provide a <code>FeedbackValue</code> value of <code>valid</code>, you tell Amazon Cognito that you trust a user session where Amazon Cognito has evaluated some level of risk. When you provide a <code>FeedbackValue</code> value of <code>invalid</code>, you tell Amazon Cognito that you don't trust a user session, or you don't believe that Amazon Cognito evaluated a high-enough risk level.</p>
    pub fn set_feedback_value(mut self, input: ::std::option::Option<super::super::super::types::FeedbackValueType>) -> Self {
        self.inner = self.inner.set_feedback_value(input);
        self
    }
    /// <p>Your feedback to the authentication event. When you provide a <code>FeedbackValue</code> value of <code>valid</code>, you tell Amazon Cognito that you trust a user session where Amazon Cognito has evaluated some level of risk. When you provide a <code>FeedbackValue</code> value of <code>invalid</code>, you tell Amazon Cognito that you don't trust a user session, or you don't believe that Amazon Cognito evaluated a high-enough risk level.</p>
    pub fn get_feedback_value(&self) -> &::std::option::Option<super::super::super::types::FeedbackValueType> {
