...
impl GetLogDeliveryConfigurationInput {
    ...
    pub fn builder() -> super::super::super::operation::get_log_delivery_configuration::builders::GetLogDeliveryConfigurationInputBuilder {
        super::super::super::operation::get_log_delivery_configuration::builders::GetLogDeliveryConfigurationInputBuilder::default()
    }
}
