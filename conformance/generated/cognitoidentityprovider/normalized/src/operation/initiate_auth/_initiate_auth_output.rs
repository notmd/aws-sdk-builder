...
impl InitiateAuthOutput {
    ...
    pub fn builder() -> super::super::super::operation::initiate_auth::builders::InitiateAuthOutputBuilder {
        super::super::super::operation::initiate_auth::builders::InitiateAuthOutputBuilder::default()
    }
}
...
impl InitiateAuthOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::initiate_auth::InitiateAuthOutput {
        super::super::super::operation::initiate_auth::InitiateAuthOutput {
