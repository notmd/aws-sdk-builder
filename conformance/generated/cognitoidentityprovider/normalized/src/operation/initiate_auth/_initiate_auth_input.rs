...
pub struct InitiateAuthInput {
    ...
    pub auth_flow: ::std::option::Option<super::super::super::types::AuthFlowType>,
...
impl InitiateAuthInput {
    ...
    /// </dl>
    /// <p><code>ADMIN_USER_PASSWORD_AUTH</code> is a flow type of <code>AdminInitiateAuth</code> and isn't valid for InitiateAuth. <code>ADMIN_NO_SRP_AUTH</code> is a legacy server-side username-password flow and isn't valid for InitiateAuth.</p>
    pub fn auth_flow(&self) -> ::std::option::Option<&super::super::super::types::AuthFlowType> {
...
impl InitiateAuthInput {
    ...
    pub fn builder() -> super::super::super::operation::initiate_auth::builders::InitiateAuthInputBuilder {
        super::super::super::operation::initiate_auth::builders::InitiateAuthInputBuilder::default()
    }
}
...
pub struct InitiateAuthInputBuilder {
    pub(crate) auth_flow: ::std::option::Option<super::super::super::types::AuthFlowType>,
