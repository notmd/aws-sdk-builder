...
impl AdminDisableProviderForUserOutput {
    ...
    pub fn builder() -> super::super::super::operation::admin_disable_provider_for_user::builders::AdminDisableProviderForUserOutputBuilder {
        super::super::super::operation::admin_disable_provider_for_user::builders::AdminDisableProviderForUserOutputBuilder::default()
    }
}
...
impl AdminDisableProviderForUserOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::admin_disable_provider_for_user::AdminDisableProviderForUserOutput {
