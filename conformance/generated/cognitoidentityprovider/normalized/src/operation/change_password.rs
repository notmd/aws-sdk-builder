...
impl ChangePassword {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::super::operation::change_password::ChangePasswordOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::change_password::ChangePasswordError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::change_password::ChangePasswordError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::change_password::ChangePasswordOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ChangePasswordResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_change_password::de_change_password_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_change_password::de_change_password_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ChangePasswordRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::change_password::ChangePasswordInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::change_password::ChangePasswordInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_change_password::ser_change_password_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::change_password::ChangePasswordError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::change_password::_change_password_input::ChangePasswordInput;

pub use super::super::operation::change_password::_change_password_output::ChangePasswordOutput;
