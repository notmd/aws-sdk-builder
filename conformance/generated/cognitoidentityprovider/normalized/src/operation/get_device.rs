...
impl GetDevice {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::get_device::GetDeviceInput,
    ) -> ::std::result::Result<
        super::super::operation::get_device::GetDeviceOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::get_device::GetDeviceError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::get_device::GetDeviceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::get_device::GetDeviceOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetDeviceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_get_device::de_get_device_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_get_device::de_get_device_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetDeviceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::super::operation::get_device::GetDeviceInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::get_device::GetDeviceInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_get_device::ser_get_device_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::get_device::GetDeviceError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::get_device::_get_device_input::GetDeviceInput;

pub use super::super::operation::get_device::_get_device_output::GetDeviceOutput;
