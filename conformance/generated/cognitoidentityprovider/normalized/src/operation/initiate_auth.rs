...
impl InitiateAuth {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::super::operation::initiate_auth::InitiateAuthOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::initiate_auth::InitiateAuthError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::initiate_auth::InitiateAuthError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::initiate_auth::InitiateAuthOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for InitiateAuthResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_initiate_auth::de_initiate_auth_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_initiate_auth::de_initiate_auth_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for InitiateAuthRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::initiate_auth::InitiateAuthInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::initiate_auth::InitiateAuthInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_initiate_auth::ser_initiate_auth_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::initiate_auth::InitiateAuthError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::initiate_auth::_initiate_auth_input::InitiateAuthInput;

pub use super::super::operation::initiate_auth::_initiate_auth_output::InitiateAuthOutput;
