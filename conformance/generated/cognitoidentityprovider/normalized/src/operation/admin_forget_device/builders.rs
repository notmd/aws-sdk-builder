...
pub use super::super::super::operation::admin_forget_device::_admin_forget_device_input::AdminForgetDeviceInputBuilder;

pub use super::super::super::operation::admin_forget_device::_admin_forget_device_output::AdminForgetDeviceOutputBuilder;

impl super::super::super::operation::admin_forget_device::builders::AdminForgetDeviceInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::admin_forget_device::AdminForgetDeviceOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::admin_forget_device::AdminForgetDeviceError,
...
pub struct AdminForgetDeviceFluentBuilder {
    ...
    inner: super::super::super::operation::admin_forget_device::builders::AdminForgetDeviceInputBuilder,
...
impl
    super::super::super::client::customize::internal::CustomizableSend<
        super::super::super::operation::admin_forget_device::AdminForgetDeviceOutput,
        super::super::super::operation::admin_forget_device::AdminForgetDeviceError,
    > for AdminForgetDeviceFluentBuilder
{
    fn send(
        self,
...
impl AdminForgetDeviceFluentBuilder {
    /// Creates a new `AdminForgetDeviceFluentBuilder`.
    ...
    pub fn as_input(&self) -> &super::super::super::operation::admin_forget_device::builders::AdminForgetDeviceInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::admin_forget_device::AdminForgetDevice::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::admin_forget_device::AdminForgetDevice::orchestrate(&runtime_plugins, input).await
    }
