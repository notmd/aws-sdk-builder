...
impl AdminForgetDeviceInput {
    ...
    pub fn builder() -> super::super::super::operation::admin_forget_device::builders::AdminForgetDeviceInputBuilder {
        super::super::super::operation::admin_forget_device::builders::AdminForgetDeviceInputBuilder::default()
    }
}
...
impl AdminForgetDeviceInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::admin_forget_device::AdminForgetDeviceInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::super::operation::admin_forget_device::AdminForgetDeviceInput {
