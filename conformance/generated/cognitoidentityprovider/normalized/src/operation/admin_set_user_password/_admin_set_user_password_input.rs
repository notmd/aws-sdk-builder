...
impl AdminSetUserPasswordInput {
    ...
    pub fn builder() -> super::super::super::operation::admin_set_user_password::builders::AdminSetUserPasswordInputBuilder {
        super::super::super::operation::admin_set_user_password::builders::AdminSetUserPasswordInputBuilder::default()
    }
}
...
impl AdminSetUserPasswordInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::admin_set_user_password::AdminSetUserPasswordInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::admin_set_user_password::AdminSetUserPasswordInput {
