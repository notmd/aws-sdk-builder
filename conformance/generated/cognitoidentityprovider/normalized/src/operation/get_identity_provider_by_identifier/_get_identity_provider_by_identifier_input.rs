...
impl GetIdentityProviderByIdentifierInput {
    ...
    pub fn builder() -> super::super::super::operation::get_identity_provider_by_identifier::builders::GetIdentityProviderByIdentifierInputBuilder {
        super::super::super::operation::get_identity_provider_by_identifier::builders::GetIdentityProviderByIdentifierInputBuilder::default()
    }
}
...
impl GetIdentityProviderByIdentifierInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::get_identity_provider_by_identifier::GetIdentityProviderByIdentifierInput,
