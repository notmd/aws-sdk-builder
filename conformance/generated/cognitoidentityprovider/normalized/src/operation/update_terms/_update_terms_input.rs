...
pub struct UpdateTermsInput {
    ...
    pub terms_source: ::std::option::Option<super::super::super::types::TermsSourceType>,
    /// <p>This parameter is reserved for future use and currently accepts only one value.</p>
    pub enforcement: ::std::option::Option<super::super::super::types::TermsEnforcementType>,
...
impl UpdateTermsInput {
    ...
    /// <p>This parameter is reserved for future use and currently accepts only one value.</p>
    pub fn terms_source(&self) -> ::std::option::Option<&super::super::super::types::TermsSourceType> {
        self.terms_source.as_ref()
    }
    /// <p>This parameter is reserved for future use and currently accepts only one value.</p>
    pub fn enforcement(&self) -> ::std::option::Option<&super::super::super::types::TermsEnforcementType> {
...
impl UpdateTermsInput {
    ...
    pub fn builder() -> super::super::super::operation::update_terms::builders::UpdateTermsInputBuilder {
        super::super::super::operation::update_terms::builders::UpdateTermsInputBuilder::default()
    }
}
...
pub struct UpdateTermsInputBuilder {
    ...
    pub(crate) terms_source: ::std::option::Option<super::super::super::types::TermsSourceType>,
    pub(crate) enforcement: ::std::option::Option<super::super::super::types::TermsEnforcementType>,
