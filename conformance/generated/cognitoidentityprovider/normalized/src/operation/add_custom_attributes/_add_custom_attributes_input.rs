...
pub struct AddCustomAttributesInput {
    ...
    /// </dd>
    /// </dl>
    pub custom_attributes: ::std::option::Option<::std::vec::Vec<super::super::super::types::SchemaAttributeType>>,
}
impl AddCustomAttributesInput {
    ...
    pub fn custom_attributes(&self) -> &[super::super::super::types::SchemaAttributeType] {
...
impl AddCustomAttributesInput {
    ...
    pub fn builder() -> super::super::super::operation::add_custom_attributes::builders::AddCustomAttributesInputBuilder {
        super::super::super::operation::add_custom_attributes::builders::AddCustomAttributesInputBuilder::default()
    }
}
...
pub struct AddCustomAttributesInputBuilder {
    ...
    pub(crate) custom_attributes: ::std::option::Option<::std::vec::Vec<super::super::super::types::SchemaAttributeType>>,
}
