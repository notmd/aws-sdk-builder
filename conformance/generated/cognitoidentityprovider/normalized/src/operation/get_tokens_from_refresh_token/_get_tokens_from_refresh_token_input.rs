...
impl GetTokensFromRefreshTokenInput {
    ...
    pub fn builder() -> super::super::super::operation::get_tokens_from_refresh_token::builders::GetTokensFromRefreshTokenInputBuilder {
        super::super::super::operation::get_tokens_from_refresh_token::builders::GetTokensFromRefreshTokenInputBuilder::default()
    }
}
