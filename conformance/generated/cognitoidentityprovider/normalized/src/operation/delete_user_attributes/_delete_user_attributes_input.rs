...
impl DeleteUserAttributesInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_user_attributes::builders::DeleteUserAttributesInputBuilder {
        super::super::super::operation::delete_user_attributes::builders::DeleteUserAttributesInputBuilder::default()
    }
}
...
impl DeleteUserAttributesInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::delete_user_attributes::DeleteUserAttributesInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::delete_user_attributes::DeleteUserAttributesInput {
