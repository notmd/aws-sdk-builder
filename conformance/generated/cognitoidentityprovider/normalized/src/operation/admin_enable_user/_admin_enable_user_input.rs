...
impl AdminEnableUserInput {
    ...
    pub fn builder() -> super::super::super::operation::admin_enable_user::builders::AdminEnableUserInputBuilder {
        super::super::super::operation::admin_enable_user::builders::AdminEnableUserInputBuilder::default()
    }
}
...
impl AdminEnableUserInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::admin_enable_user::AdminEnableUserInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::super::operation::admin_enable_user::AdminEnableUserInput {
