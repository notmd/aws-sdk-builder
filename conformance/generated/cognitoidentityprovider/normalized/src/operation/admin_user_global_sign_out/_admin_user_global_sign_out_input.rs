...
impl AdminUserGlobalSignOutInput {
    ...
    pub fn builder() -> super::super::super::operation::admin_user_global_sign_out::builders::AdminUserGlobalSignOutInputBuilder {
        super::super::super::operation::admin_user_global_sign_out::builders::AdminUserGlobalSignOutInputBuilder::default()
    }
}
...
impl AdminUserGlobalSignOutInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::admin_user_global_sign_out::AdminUserGlobalSignOutInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::admin_user_global_sign_out::AdminUserGlobalSignOutInput {
