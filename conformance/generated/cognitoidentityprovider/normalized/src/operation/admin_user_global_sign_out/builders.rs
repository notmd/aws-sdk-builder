...
pub use super::super::super::operation::admin_user_global_sign_out::_admin_user_global_sign_out_input::AdminUserGlobalSignOutInputBuilder;

pub use super::super::super::operation::admin_user_global_sign_out::_admin_user_global_sign_out_output::AdminUserGlobalSignOutOutputBuilder;

impl super::super::super::operation::admin_user_global_sign_out::builders::AdminUserGlobalSignOutInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::admin_user_global_sign_out::AdminUserGlobalSignOutOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::admin_user_global_sign_out::AdminUserGlobalSignOutError,
...
///
/// <p>Invalidates the identity, access, and refresh tokens that Amazon Cognito issued to a user. Call this operation with your administrative credentials when your user signs out of your app. This results in the following behavior.</p>
/// <ul>
/// <li>
...
pub struct AdminUserGlobalSignOutFluentBuilder {
    ...
    inner: super::super::super::operation::admin_user_global_sign_out::builders::AdminUserGlobalSignOutInputBuilder,
...
impl
    super::super::super::client::customize::internal::CustomizableSend<
        super::super::super::operation::admin_user_global_sign_out::AdminUserGlobalSignOutOutput,
        super::super::super::operation::admin_user_global_sign_out::AdminUserGlobalSignOutError,
    > for AdminUserGlobalSignOutFluentBuilder
{
    fn send(
        self,
...
impl AdminUserGlobalSignOutFluentBuilder {
    /// Creates a new `AdminUserGlobalSignOutFluentBuilder`.
    ...
    pub fn as_input(&self) -> &super::super::super::operation::admin_user_global_sign_out::builders::AdminUserGlobalSignOutInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::admin_user_global_sign_out::AdminUserGlobalSignOut::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::admin_user_global_sign_out::AdminUserGlobalSignOut::orchestrate(&runtime_plugins, input).await
    }
