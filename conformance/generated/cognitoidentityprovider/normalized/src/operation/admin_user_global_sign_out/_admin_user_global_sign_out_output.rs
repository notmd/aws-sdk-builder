...
impl AdminUserGlobalSignOutOutput {
    ...
    pub fn builder() -> super::super::super::operation::admin_user_global_sign_out::builders::AdminUserGlobalSignOutOutputBuilder {
        super::super::super::operation::admin_user_global_sign_out::builders::AdminUserGlobalSignOutOutputBuilder::default()
    }
}
...
impl AdminUserGlobalSignOutOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::admin_user_global_sign_out::AdminUserGlobalSignOutOutput {
