...
impl ConfirmSignUpInput {
    ...
    pub fn builder() -> super::super::super::operation::confirm_sign_up::builders::ConfirmSignUpInputBuilder {
        super::super::super::operation::confirm_sign_up::builders::ConfirmSignUpInputBuilder::default()
    }
}
...
impl ConfirmSignUpInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::confirm_sign_up::ConfirmSignUpInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::confirm_sign_up::ConfirmSignUpInput {
