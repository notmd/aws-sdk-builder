...
impl ConfirmSignUpOutput {
    ...
    pub fn builder() -> super::super::super::operation::confirm_sign_up::builders::ConfirmSignUpOutputBuilder {
        super::super::super::operation::confirm_sign_up::builders::ConfirmSignUpOutputBuilder::default()
    }
}
...
impl ConfirmSignUpOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::confirm_sign_up::ConfirmSignUpOutput {
