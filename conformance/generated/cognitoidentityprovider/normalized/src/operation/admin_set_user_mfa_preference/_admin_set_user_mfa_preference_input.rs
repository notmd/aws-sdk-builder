...
impl AdminSetUserMfaPreferenceInput {
    ...
    pub fn builder() -> super::super::super::operation::admin_set_user_mfa_preference::builders::AdminSetUserMfaPreferenceInputBuilder {
        super::super::super::operation::admin_set_user_mfa_preference::builders::AdminSetUserMfaPreferenceInputBuilder::default()
    }
}
