...
impl AdminSetUserMfaPreferenceOutput {
    ...
    pub fn builder() -> super::super::super::operation::admin_set_user_mfa_preference::builders::AdminSetUserMfaPreferenceOutputBuilder {
        super::super::super::operation::admin_set_user_mfa_preference::builders::AdminSetUserMfaPreferenceOutputBuilder::default()
    }
}
...
impl AdminSetUserMfaPreferenceOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::admin_set_user_mfa_preference::AdminSetUserMfaPreferenceOutput {
