...
impl ListUsersInput {
    ...
    pub fn builder() -> super::super::super::operation::list_users::builders::ListUsersInputBuilder {
        super::super::super::operation::list_users::builders::ListUsersInputBuilder::default()
    }
}
