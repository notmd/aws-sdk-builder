...
impl ListUsersOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_users::builders::ListUsersOutputBuilder {
        super::super::super::operation::list_users::builders::ListUsersOutputBuilder::default()
    }
}
...
impl ListUsersOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::list_users::ListUsersOutput {
