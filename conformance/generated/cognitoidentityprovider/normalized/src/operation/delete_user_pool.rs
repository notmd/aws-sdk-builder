    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::delete_user_pool::DeleteUserPoolError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::delete_user_pool::DeleteUserPoolOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteUserPoolResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_delete_user_pool::de_delete_user_pool_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_delete_user_pool::de_delete_user_pool_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteUserPoolRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::delete_user_pool::DeleteUserPoolInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::delete_user_pool::DeleteUserPoolInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_delete_user_pool::ser_delete_user_pool_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::delete_user_pool::DeleteUserPoolError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::delete_user_pool::_delete_user_pool_input::DeleteUserPoolInput;

pub use super::super::operation::delete_user_pool::_delete_user_pool_output::DeleteUserPoolOutput;
