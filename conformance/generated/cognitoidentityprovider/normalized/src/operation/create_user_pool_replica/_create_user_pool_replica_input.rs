...
impl CreateUserPoolReplicaInput {
    ...
    pub fn builder() -> super::super::super::operation::create_user_pool_replica::builders::CreateUserPoolReplicaInputBuilder {
        super::super::super::operation::create_user_pool_replica::builders::CreateUserPoolReplicaInputBuilder::default()
    }
}
