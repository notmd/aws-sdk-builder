...
impl DeleteUserPoolDomainInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_user_pool_domain::builders::DeleteUserPoolDomainInputBuilder {
        super::super::super::operation::delete_user_pool_domain::builders::DeleteUserPoolDomainInputBuilder::default()
    }
}
