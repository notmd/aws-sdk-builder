...
pub use super::super::super::operation::admin_confirm_sign_up::_admin_confirm_sign_up_input::AdminConfirmSignUpInputBuilder;

pub use super::super::super::operation::admin_confirm_sign_up::_admin_confirm_sign_up_output::AdminConfirmSignUpOutputBuilder;

impl super::super::super::operation::admin_confirm_sign_up::builders::AdminConfirmSignUpInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::admin_confirm_sign_up::AdminConfirmSignUpOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::admin_confirm_sign_up::AdminConfirmSignUpError,
...
/// <p>This request sets a user account active in a user pool that <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/signing-up-users-in-your-app.html#signing-up-users-in-your-app-and-confirming-them-as-admin">requires confirmation of new user accounts</a> before they can sign in. You can configure your user pool to not send confirmation codes to new users and instead confirm them with this API operation on the back end.</p><note>
...
/// </ul>
/// </note>
/// <p>To configure your user pool to require administrative confirmation of users, set <code>AllowAdminCreateUserOnly</code> to <code>true</code> in a <code>CreateUserPool</code> or <code>UpdateUserPool</code> request.</p>
#[derive(::std::clone::Clone, ::std::fmt::Debug)]
pub struct AdminConfirmSignUpFluentBuilder {
    handle: ::std::sync::Arc<super::super::super::client::Handle>,
    inner: super::super::super::operation::admin_confirm_sign_up::builders::AdminConfirmSignUpInputBuilder,
...
impl AdminConfirmSignUpFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::admin_confirm_sign_up::builders::AdminConfirmSignUpInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::admin_confirm_sign_up::AdminConfirmSignUp::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::admin_confirm_sign_up::AdminConfirmSignUp::orchestrate(&runtime_plugins, input).await
    }
