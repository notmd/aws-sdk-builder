...
impl AdminConfirmSignUpOutput {
    ...
    pub fn builder() -> super::super::super::operation::admin_confirm_sign_up::builders::AdminConfirmSignUpOutputBuilder {
        super::super::super::operation::admin_confirm_sign_up::builders::AdminConfirmSignUpOutputBuilder::default()
    }
}
...
impl AdminConfirmSignUpOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::admin_confirm_sign_up::AdminConfirmSignUpOutput {
