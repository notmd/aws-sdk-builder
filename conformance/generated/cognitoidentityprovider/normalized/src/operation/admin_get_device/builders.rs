...
pub use super::super::super::operation::admin_get_device::_admin_get_device_input::AdminGetDeviceInputBuilder;

pub use super::super::super::operation::admin_get_device::_admin_get_device_output::AdminGetDeviceOutputBuilder;

impl super::super::super::operation::admin_get_device::builders::AdminGetDeviceInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::admin_get_device::AdminGetDeviceOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::admin_get_device::AdminGetDeviceError,
...
///
/// <p>Given the device key, returns details for a user's device. For more information, see <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/amazon-cognito-user-pools-device-tracking.html">Working with devices</a>.</p><note>
...
pub struct AdminGetDeviceFluentBuilder {
    ...
    inner: super::super::super::operation::admin_get_device::builders::AdminGetDeviceInputBuilder,
...
impl
    super::super::super::client::customize::internal::CustomizableSend<
        super::super::super::operation::admin_get_device::AdminGetDeviceOutput,
        super::super::super::operation::admin_get_device::AdminGetDeviceError,
    > for AdminGetDeviceFluentBuilder
{
    fn send(
        self,
...
impl AdminGetDeviceFluentBuilder {
    ...
    /// Access the AdminGetDevice as a reference.
    pub fn as_input(&self) -> &super::super::super::operation::admin_get_device::builders::AdminGetDeviceInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::admin_get_device::AdminGetDevice::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::admin_get_device::AdminGetDevice::orchestrate(&runtime_plugins, input).await
    }
