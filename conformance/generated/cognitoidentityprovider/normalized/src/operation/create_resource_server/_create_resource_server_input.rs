...
impl CreateResourceServerInput {
    ...
    pub fn builder() -> super::super::super::operation::create_resource_server::builders::CreateResourceServerInputBuilder {
        super::super::super::operation::create_resource_server::builders::CreateResourceServerInputBuilder::default()
    }
}
