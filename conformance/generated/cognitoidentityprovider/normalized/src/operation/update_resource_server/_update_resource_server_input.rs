...
pub struct UpdateResourceServerInput {
    ...
    pub scopes: ::std::option::Option<::std::vec::Vec<super::super::super::types::ResourceServerScopeType>>,
}
impl UpdateResourceServerInput {
    ...
    pub fn scopes(&self) -> &[super::super::super::types::ResourceServerScopeType] {
...
impl UpdateResourceServerInput {
    ...
    pub fn builder() -> super::super::super::operation::update_resource_server::builders::UpdateResourceServerInputBuilder {
        super::super::super::operation::update_resource_server::builders::UpdateResourceServerInputBuilder::default()
    }
}
...
pub struct UpdateResourceServerInputBuilder {
    ...
    pub(crate) scopes: ::std::option::Option<::std::vec::Vec<super::super::super::types::ResourceServerScopeType>>,
}
impl UpdateResourceServerInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::update_resource_server::UpdateResourceServerInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::update_resource_server::UpdateResourceServerInput {
