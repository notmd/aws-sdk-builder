...
impl DescribeUserImportJobInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_user_import_job::builders::DescribeUserImportJobInputBuilder {
        super::super::super::operation::describe_user_import_job::builders::DescribeUserImportJobInputBuilder::default()
    }
}
...
impl DescribeUserImportJobInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::describe_user_import_job::DescribeUserImportJobInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::describe_user_import_job::DescribeUserImportJobInput {
