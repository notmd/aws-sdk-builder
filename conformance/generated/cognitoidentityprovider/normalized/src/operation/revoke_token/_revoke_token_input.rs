...
impl RevokeTokenInput {
    ...
    pub fn builder() -> super::super::super::operation::revoke_token::builders::RevokeTokenInputBuilder {
        super::super::super::operation::revoke_token::builders::RevokeTokenInputBuilder::default()
    }
}
...
impl RevokeTokenInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::super::operation::revoke_token::RevokeTokenInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::super::operation::revoke_token::RevokeTokenInput {
            token: self.token,
