...
impl RevokeTokenOutput {
    ...
    pub fn builder() -> super::super::super::operation::revoke_token::builders::RevokeTokenOutputBuilder {
        super::super::super::operation::revoke_token::builders::RevokeTokenOutputBuilder::default()
    }
}
...
impl RevokeTokenOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::revoke_token::RevokeTokenOutput {
