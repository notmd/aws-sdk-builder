    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::stop_user_import_job::StopUserImportJobError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::stop_user_import_job::StopUserImportJobOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopUserImportJobResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_stop_user_import_job::de_stop_user_import_job_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_stop_user_import_job::de_stop_user_import_job_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StopUserImportJobRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::stop_user_import_job::StopUserImportJobInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::stop_user_import_job::StopUserImportJobInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_stop_user_import_job::ser_stop_user_import_job_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::stop_user_import_job::StopUserImportJobError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::stop_user_import_job::_stop_user_import_job_input::StopUserImportJobInput;

pub use super::super::operation::stop_user_import_job::_stop_user_import_job_output::StopUserImportJobOutput;
