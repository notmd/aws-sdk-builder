...
impl AdminUpdateDeviceStatusOutput {
    ...
    pub fn builder() -> super::super::super::operation::admin_update_device_status::builders::AdminUpdateDeviceStatusOutputBuilder {
        super::super::super::operation::admin_update_device_status::builders::AdminUpdateDeviceStatusOutputBuilder::default()
    }
}
...
impl AdminUpdateDeviceStatusOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::admin_update_device_status::AdminUpdateDeviceStatusOutput {
