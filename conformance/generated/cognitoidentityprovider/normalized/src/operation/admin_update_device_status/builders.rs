...
pub use super::super::super::operation::admin_update_device_status::_admin_update_device_status_input::AdminUpdateDeviceStatusInputBuilder;

pub use super::super::super::operation::admin_update_device_status::_admin_update_device_status_output::AdminUpdateDeviceStatusOutputBuilder;

impl super::super::super::operation::admin_update_device_status::builders::AdminUpdateDeviceStatusInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::admin_update_device_status::AdminUpdateDeviceStatusOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::admin_update_device_status::AdminUpdateDeviceStatusError,
...
pub struct AdminUpdateDeviceStatusFluentBuilder {
    ...
    inner: super::super::super::operation::admin_update_device_status::builders::AdminUpdateDeviceStatusInputBuilder,
...
impl AdminUpdateDeviceStatusFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::admin_update_device_status::builders::AdminUpdateDeviceStatusInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::admin_update_device_status::AdminUpdateDeviceStatus::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::admin_update_device_status::AdminUpdateDeviceStatus::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn device_remembered_status(mut self, input: super::super::super::types::DeviceRememberedStatusType) -> Self {
        self.inner = self.inner.device_remembered_status(input);
        self
    }
    /// <p>To enable device authentication with the specified device, set to <code>remembered</code>.To disable, set to <code>not_remembered</code>.</p>
    pub fn set_device_remembered_status(mut self, input: ::std::option::Option<super::super::super::types::DeviceRememberedStatusType>) -> Self {
        self.inner = self.inner.set_device_remembered_status(input);
        self
    }
    /// <p>To enable device authentication with the specified device, set to <code>remembered</code>.To disable, set to <code>not_remembered</code>.</p>
    pub fn get_device_remembered_status(&self) -> &::std::option::Option<super::super::super::types::DeviceRememberedStatusType> {
