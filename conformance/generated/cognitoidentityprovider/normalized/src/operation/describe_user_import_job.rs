...
impl DescribeUserImportJob {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::describe_user_import_job::DescribeUserImportJobInput,
    ) -> ::std::result::Result<
        super::super::operation::describe_user_import_job::DescribeUserImportJobOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::describe_user_import_job::DescribeUserImportJobError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::describe_user_import_job::DescribeUserImportJobError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::describe_user_import_job::DescribeUserImportJobOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeUserImportJob {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeUserImportJob")
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeUserImportJobTelemetryInputCaptureInterceptor {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeUserImportJobResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_describe_user_import_job::de_describe_user_import_job_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_describe_user_import_job::de_describe_user_import_job_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeUserImportJobRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::describe_user_import_job::DescribeUserImportJobInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::describe_user_import_job::DescribeUserImportJobInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_describe_user_import_job::ser_describe_user_import_job_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::super::operation::describe_user_import_job::DescribeUserImportJobError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::describe_user_import_job::_describe_user_import_job_input::DescribeUserImportJobInput;

pub use super::super::operation::describe_user_import_job::_describe_user_import_job_output::DescribeUserImportJobOutput;
