    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::admin_add_user_to_group::AdminAddUserToGroupError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::admin_add_user_to_group::AdminAddUserToGroupOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AdminAddUserToGroup {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AdminAddUserToGroup")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AdminAddUserToGroupResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_admin_add_user_to_group::de_admin_add_user_to_group_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_admin_add_user_to_group::de_admin_add_user_to_group_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AdminAddUserToGroupRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::admin_add_user_to_group::AdminAddUserToGroupInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::admin_add_user_to_group::AdminAddUserToGroupInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_admin_add_user_to_group::ser_admin_add_user_to_group_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::admin_add_user_to_group::AdminAddUserToGroupError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::admin_add_user_to_group::_admin_add_user_to_group_input::AdminAddUserToGroupInput;

pub use super::super::operation::admin_add_user_to_group::_admin_add_user_to_group_output::AdminAddUserToGroupOutput;
