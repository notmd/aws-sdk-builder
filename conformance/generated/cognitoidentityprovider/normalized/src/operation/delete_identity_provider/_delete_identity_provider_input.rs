...
impl DeleteIdentityProviderInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_identity_provider::builders::DeleteIdentityProviderInputBuilder {
        super::super::super::operation::delete_identity_provider::builders::DeleteIdentityProviderInputBuilder::default()
    }
}
...
impl DeleteIdentityProviderInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::delete_identity_provider::DeleteIdentityProviderInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::delete_identity_provider::DeleteIdentityProviderInput {
