...
impl DeleteIdentityProviderOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_identity_provider::builders::DeleteIdentityProviderOutputBuilder {
        super::super::super::operation::delete_identity_provider::builders::DeleteIdentityProviderOutputBuilder::default()
    }
}
...
impl DeleteIdentityProviderOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_identity_provider::DeleteIdentityProviderOutput {
