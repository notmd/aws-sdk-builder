...
pub use super::super::super::operation::delete_identity_provider::_delete_identity_provider_input::DeleteIdentityProviderInputBuilder;

pub use super::super::super::operation::delete_identity_provider::_delete_identity_provider_output::DeleteIdentityProviderOutputBuilder;

impl super::super::super::operation::delete_identity_provider::builders::DeleteIdentityProviderInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_identity_provider::DeleteIdentityProviderOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_identity_provider::DeleteIdentityProviderError,
...
pub struct DeleteIdentityProviderFluentBuilder {
    ...
    inner: super::super::super::operation::delete_identity_provider::builders::DeleteIdentityProviderInputBuilder,
...
impl DeleteIdentityProviderFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_identity_provider::builders::DeleteIdentityProviderInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_identity_provider::DeleteIdentityProvider::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_identity_provider::DeleteIdentityProvider::orchestrate(&runtime_plugins, input).await
    }
