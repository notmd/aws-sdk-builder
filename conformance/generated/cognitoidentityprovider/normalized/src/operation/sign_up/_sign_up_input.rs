...
pub struct SignUpInput {
    ...
    pub user_attributes: ::std::option::Option<::std::vec::Vec<super::super::super::types::AttributeType>>,
    ...
    pub validation_data: ::std::option::Option<::std::vec::Vec<super::super::super::types::AttributeType>>,
    ...
    pub analytics_metadata: ::std::option::Option<super::super::super::types::AnalyticsMetadataType>,
    ...
    pub user_context_data: ::std::option::Option<super::super::super::types::UserContextDataType>,
...
impl SignUpInput {
    ...
    pub fn user_attributes(&self) -> &[super::super::super::types::AttributeType] {
    ...
    pub fn validation_data(&self) -> &[super::super::super::types::AttributeType] {
        self.validation_data.as_deref().unwrap_or_default()
    }
    /// <p>Information that supports analytics outcomes with Amazon Pinpoint, including the user's endpoint ID. The endpoint ID is a destination for Amazon Pinpoint push notifications, for example a device identifier, email address, or phone number.</p>
    pub fn analytics_metadata(&self) -> ::std::option::Option<&super::super::super::types::AnalyticsMetadataType> {
        self.analytics_metadata.as_ref()
    }
    /// <p>Contextual data about your user session like the device fingerprint, IP address, or location. Amazon Cognito threat protection evaluates the risk of an authentication event based on the context that your app generates and passes to Amazon Cognito when it makes API requests.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-settings-viewing-threat-protection-app.html">Collecting data for threat protection in applications</a>.</p>
    pub fn user_context_data(&self) -> ::std::option::Option<&super::super::super::types::UserContextDataType> {
...
impl SignUpInput {
    ...
    pub fn builder() -> super::super::super::operation::sign_up::builders::SignUpInputBuilder {
        super::super::super::operation::sign_up::builders::SignUpInputBuilder::default()
    }
}
...
pub struct SignUpInputBuilder {
    ...
    pub(crate) user_attributes: ::std::option::Option<::std::vec::Vec<super::super::super::types::AttributeType>>,
    pub(crate) validation_data: ::std::option::Option<::std::vec::Vec<super::super::super::types::AttributeType>>,
    pub(crate) analytics_metadata: ::std::option::Option<super::super::super::types::AnalyticsMetadataType>,
    pub(crate) user_context_data: ::std::option::Option<super::super::super::types::UserContextDataType>,
