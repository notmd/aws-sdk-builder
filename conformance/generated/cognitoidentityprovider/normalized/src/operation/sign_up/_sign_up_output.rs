...
impl SignUpOutput {
    ...
    pub fn builder() -> super::super::super::operation::sign_up::builders::SignUpOutputBuilder {
        super::super::super::operation::sign_up::builders::SignUpOutputBuilder::default()
    }
}
