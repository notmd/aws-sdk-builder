...
impl DeleteUserPoolReplicaInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_user_pool_replica::builders::DeleteUserPoolReplicaInputBuilder {
        super::super::super::operation::delete_user_pool_replica::builders::DeleteUserPoolReplicaInputBuilder::default()
    }
}
...
impl DeleteUserPoolReplicaInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::delete_user_pool_replica::DeleteUserPoolReplicaInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::delete_user_pool_replica::DeleteUserPoolReplicaInput {
