    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::delete_user_pool_domain::DeleteUserPoolDomainError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::delete_user_pool_domain::DeleteUserPoolDomainOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteUserPoolDomain {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteUserPoolDomain")
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteUserPoolDomainTelemetryInputCaptureInterceptor {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteUserPoolDomainResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_delete_user_pool_domain::de_delete_user_pool_domain_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_delete_user_pool_domain::de_delete_user_pool_domain_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteUserPoolDomainRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::delete_user_pool_domain::DeleteUserPoolDomainInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::delete_user_pool_domain::DeleteUserPoolDomainInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_delete_user_pool_domain::ser_delete_user_pool_domain_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::delete_user_pool_domain::DeleteUserPoolDomainError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::delete_user_pool_domain::_delete_user_pool_domain_input::DeleteUserPoolDomainInput;

pub use super::super::operation::delete_user_pool_domain::_delete_user_pool_domain_output::DeleteUserPoolDomainOutput;
