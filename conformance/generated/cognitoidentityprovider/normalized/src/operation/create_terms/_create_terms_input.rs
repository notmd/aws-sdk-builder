...
impl CreateTermsInput {
    ...
    pub fn builder() -> super::super::super::operation::create_terms::builders::CreateTermsInputBuilder {
        super::super::super::operation::create_terms::builders::CreateTermsInputBuilder::default()
    }
}
