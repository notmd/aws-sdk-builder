...
impl UpdateUserAttributesInput {
    ...
    pub fn builder() -> super::super::super::operation::update_user_attributes::builders::UpdateUserAttributesInputBuilder {
        super::super::super::operation::update_user_attributes::builders::UpdateUserAttributesInputBuilder::default()
    }
}
...
impl UpdateUserAttributesInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::update_user_attributes::UpdateUserAttributesInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::update_user_attributes::UpdateUserAttributesInput {
