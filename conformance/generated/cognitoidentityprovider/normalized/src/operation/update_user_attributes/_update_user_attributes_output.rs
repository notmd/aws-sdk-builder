...
pub struct UpdateUserAttributesOutput {
    ...
    pub code_delivery_details_list: ::std::option::Option<::std::vec::Vec<super::super::super::types::CodeDeliveryDetailsType>>,
...
impl UpdateUserAttributesOutput {
    ...
    pub fn code_delivery_details_list(&self) -> &[super::super::super::types::CodeDeliveryDetailsType] {
...
impl UpdateUserAttributesOutput {
    ...
    pub fn builder() -> super::super::super::operation::update_user_attributes::builders::UpdateUserAttributesOutputBuilder {
        super::super::super::operation::update_user_attributes::builders::UpdateUserAttributesOutputBuilder::default()
    }
}
...
pub struct UpdateUserAttributesOutputBuilder {
    pub(crate) code_delivery_details_list: ::std::option::Option<::std::vec::Vec<super::super::super::types::CodeDeliveryDetailsType>>,
    _request_id: Option<String>,
}
impl UpdateUserAttributesOutputBuilder {
    ...
    ///
    /// <p>When the attribute-update request includes an email address or phone number attribute, Amazon Cognito sends a message to users with a code that confirms ownership of the new value that they entered. The <code>CodeDeliveryDetails</code> object is information about the delivery destination for that link or code. This behavior happens in user pools configured to automatically verify changes to those attributes. For more information, see <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/signing-up-users-in-your-app.html#verifying-when-users-change-their-email-or-phone-number">Verifying when users change their email or phone number</a>.</p>
    pub fn code_delivery_details_list(mut self, input: super::super::super::types::CodeDeliveryDetailsType) -> Self {
    ...
    /// <p>When the attribute-update request includes an email address or phone number attribute, Amazon Cognito sends a message to users with a code that confirms ownership of the new value that they entered. The <code>CodeDeliveryDetails</code> object is information about the delivery destination for that link or code. This behavior happens in user pools configured to automatically verify changes to those attributes. For more information, see <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/signing-up-users-in-your-app.html#verifying-when-users-change-their-email-or-phone-number">Verifying when users change their email or phone number</a>.</p>
    pub fn set_code_delivery_details_list(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::CodeDeliveryDetailsType>>) -> Self {
        self.code_delivery_details_list = input;
        self
    }
    /// <p>When the attribute-update request includes an email address or phone number attribute, Amazon Cognito sends a message to users with a code that confirms ownership of the new value that they entered. The <code>CodeDeliveryDetails</code> object is information about the delivery destination for that link or code. This behavior happens in user pools configured to automatically verify changes to those attributes. For more information, see <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/signing-up-users-in-your-app.html#verifying-when-users-change-their-email-or-phone-number">Verifying when users change their email or phone number</a>.</p>
    pub fn get_code_delivery_details_list(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::CodeDeliveryDetailsType>> {
    ...
    pub fn build(self) -> super::super::super::operation::update_user_attributes::UpdateUserAttributesOutput {
