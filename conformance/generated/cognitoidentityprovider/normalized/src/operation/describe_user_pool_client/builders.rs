...
pub use super::super::super::operation::describe_user_pool_client::_describe_user_pool_client_input::DescribeUserPoolClientInputBuilder;

pub use super::super::super::operation::describe_user_pool_client::_describe_user_pool_client_output::DescribeUserPoolClientOutputBuilder;

impl super::super::super::operation::describe_user_pool_client::builders::DescribeUserPoolClientInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::describe_user_pool_client::DescribeUserPoolClientOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::describe_user_pool_client::DescribeUserPoolClientError,
...
pub struct DescribeUserPoolClientFluentBuilder {
    ...
    inner: super::super::super::operation::describe_user_pool_client::builders::DescribeUserPoolClientInputBuilder,
...
impl
    super::super::super::client::customize::internal::CustomizableSend<
        super::super::super::operation::describe_user_pool_client::DescribeUserPoolClientOutput,
        super::super::super::operation::describe_user_pool_client::DescribeUserPoolClientError,
    > for DescribeUserPoolClientFluentBuilder
{
    fn send(
        self,
...
impl DescribeUserPoolClientFluentBuilder {
    /// Creates a new `DescribeUserPoolClientFluentBuilder`.
    ...
    pub fn as_input(&self) -> &super::super::super::operation::describe_user_pool_client::builders::DescribeUserPoolClientInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::describe_user_pool_client::DescribeUserPoolClient::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::describe_user_pool_client::DescribeUserPoolClient::orchestrate(&runtime_plugins, input).await
    }
