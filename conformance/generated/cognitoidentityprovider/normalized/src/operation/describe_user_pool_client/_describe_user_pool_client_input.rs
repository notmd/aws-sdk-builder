...
impl DescribeUserPoolClientInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_user_pool_client::builders::DescribeUserPoolClientInputBuilder {
        super::super::super::operation::describe_user_pool_client::builders::DescribeUserPoolClientInputBuilder::default()
    }
}
...
impl DescribeUserPoolClientInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::describe_user_pool_client::DescribeUserPoolClientInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::describe_user_pool_client::DescribeUserPoolClientInput {
