...
impl UpdateDeviceStatus {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::update_device_status::UpdateDeviceStatusInput,
    ) -> ::std::result::Result<
        super::super::operation::update_device_status::UpdateDeviceStatusOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::update_device_status::UpdateDeviceStatusError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::update_device_status::UpdateDeviceStatusError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::update_device_status::UpdateDeviceStatusOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateDeviceStatus {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateDeviceStatus")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateDeviceStatusResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_update_device_status::de_update_device_status_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_update_device_status::de_update_device_status_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateDeviceStatusRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::update_device_status::UpdateDeviceStatusInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::update_device_status::UpdateDeviceStatusInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_update_device_status::ser_update_device_status_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::update_device_status::UpdateDeviceStatusError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::update_device_status::_update_device_status_input::UpdateDeviceStatusInput;

pub use super::super::operation::update_device_status::_update_device_status_output::UpdateDeviceStatusOutput;
