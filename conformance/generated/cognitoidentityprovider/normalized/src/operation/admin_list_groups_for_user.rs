...
impl AdminListGroupsForUser {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::admin_list_groups_for_user::AdminListGroupsForUserInput,
    ) -> ::std::result::Result<
        super::super::operation::admin_list_groups_for_user::AdminListGroupsForUserOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::admin_list_groups_for_user::AdminListGroupsForUserError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::admin_list_groups_for_user::AdminListGroupsForUserError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::admin_list_groups_for_user::AdminListGroupsForUserOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AdminListGroupsForUser {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AdminListGroupsForUser")
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AdminListGroupsForUserTelemetryInputCaptureInterceptor {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AdminListGroupsForUserResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_admin_list_groups_for_user::de_admin_list_groups_for_user_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_admin_list_groups_for_user::de_admin_list_groups_for_user_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AdminListGroupsForUserRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::admin_list_groups_for_user::AdminListGroupsForUserInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::admin_list_groups_for_user::AdminListGroupsForUserInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_admin_list_groups_for_user::ser_admin_list_groups_for_user_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::super::operation::admin_list_groups_for_user::AdminListGroupsForUserError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::admin_list_groups_for_user::_admin_list_groups_for_user_input::AdminListGroupsForUserInput;

pub use super::super::operation::admin_list_groups_for_user::_admin_list_groups_for_user_output::AdminListGroupsForUserOutput;
