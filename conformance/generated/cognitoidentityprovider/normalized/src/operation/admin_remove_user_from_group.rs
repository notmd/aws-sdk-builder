...
impl AdminRemoveUserFromGroup {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::admin_remove_user_from_group::AdminRemoveUserFromGroupInput,
    ) -> ::std::result::Result<
        super::super::operation::admin_remove_user_from_group::AdminRemoveUserFromGroupOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::admin_remove_user_from_group::AdminRemoveUserFromGroupError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::admin_remove_user_from_group::AdminRemoveUserFromGroupError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::admin_remove_user_from_group::AdminRemoveUserFromGroupOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AdminRemoveUserFromGroup {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AdminRemoveUserFromGroup")
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AdminRemoveUserFromGroupTelemetryInputCaptureInterceptor {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AdminRemoveUserFromGroupResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_admin_remove_user_from_group::de_admin_remove_user_from_group_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_admin_remove_user_from_group::de_admin_remove_user_from_group_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AdminRemoveUserFromGroupRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::admin_remove_user_from_group::AdminRemoveUserFromGroupInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::admin_remove_user_from_group::AdminRemoveUserFromGroupInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_admin_remove_user_from_group::ser_admin_remove_user_from_group_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::super::operation::admin_remove_user_from_group::AdminRemoveUserFromGroupError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::admin_remove_user_from_group::_admin_remove_user_from_group_input::AdminRemoveUserFromGroupInput;

pub use super::super::operation::admin_remove_user_from_group::_admin_remove_user_from_group_output::AdminRemoveUserFromGroupOutput;
