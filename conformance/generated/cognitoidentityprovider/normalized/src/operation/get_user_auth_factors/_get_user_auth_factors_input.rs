...
impl GetUserAuthFactorsInput {
    ...
    pub fn builder() -> super::super::super::operation::get_user_auth_factors::builders::GetUserAuthFactorsInputBuilder {
        super::super::super::operation::get_user_auth_factors::builders::GetUserAuthFactorsInputBuilder::default()
    }
}
