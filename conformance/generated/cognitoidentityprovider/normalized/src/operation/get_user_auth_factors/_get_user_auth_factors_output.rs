...
impl GetUserAuthFactorsOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_user_auth_factors::builders::GetUserAuthFactorsOutputBuilder {
        super::super::super::operation::get_user_auth_factors::builders::GetUserAuthFactorsOutputBuilder::default()
    }
}
