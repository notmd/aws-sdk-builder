...
impl AdminUpdateDeviceStatus {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::admin_update_device_status::AdminUpdateDeviceStatusInput,
    ) -> ::std::result::Result<
        super::super::operation::admin_update_device_status::AdminUpdateDeviceStatusOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::admin_update_device_status::AdminUpdateDeviceStatusError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::admin_update_device_status::AdminUpdateDeviceStatusError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::admin_update_device_status::AdminUpdateDeviceStatusOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AdminUpdateDeviceStatus {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AdminUpdateDeviceStatus")
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AdminUpdateDeviceStatusTelemetryInputCaptureInterceptor {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AdminUpdateDeviceStatusResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_admin_update_device_status::de_admin_update_device_status_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_admin_update_device_status::de_admin_update_device_status_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AdminUpdateDeviceStatusRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::admin_update_device_status::AdminUpdateDeviceStatusInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::admin_update_device_status::AdminUpdateDeviceStatusInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_admin_update_device_status::ser_admin_update_device_status_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::super::operation::admin_update_device_status::AdminUpdateDeviceStatusError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::admin_update_device_status::_admin_update_device_status_input::AdminUpdateDeviceStatusInput;

pub use super::super::operation::admin_update_device_status::_admin_update_device_status_output::AdminUpdateDeviceStatusOutput;
