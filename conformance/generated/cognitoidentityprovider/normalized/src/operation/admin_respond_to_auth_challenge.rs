    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::admin_respond_to_auth_challenge::AdminRespondToAuthChallengeError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::admin_respond_to_auth_challenge::AdminRespondToAuthChallengeOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AdminRespondToAuthChallenge {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AdminRespondToAuthChallenge")
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AdminRespondToAuthChallengeTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AdminRespondToAuthChallengeInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AdminRespondToAuthChallengeResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_admin_respond_to_auth_challenge::de_admin_respond_to_auth_challenge_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_admin_respond_to_auth_challenge::de_admin_respond_to_auth_challenge_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AdminRespondToAuthChallengeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::admin_respond_to_auth_challenge::AdminRespondToAuthChallengeInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::admin_respond_to_auth_challenge::AdminRespondToAuthChallengeInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_admin_respond_to_auth_challenge::ser_admin_respond_to_auth_challenge_input(&input)?,
        );
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AdminRespondToAuthChallengeEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "AdminRespondToAuthChallengeEndpointParamsInterceptor"
    }
...
pub enum AdminRespondToAuthChallengeError {
    ...
    AliasExistsException(super::super::types::error::AliasExistsException),
    /// <p>This exception is thrown if the provided code doesn't match what the server was expecting.</p>
    CodeMismatchException(super::super::types::error::CodeMismatchException),
    /// <p>This exception is thrown if a code has expired.</p>
    ExpiredCodeException(super::super::types::error::ExpiredCodeException),
    ...
    InvalidEmailRoleAccessPolicyException(super::super::types::error::InvalidEmailRoleAccessPolicyException),
    /// <p>This exception is thrown when Amazon Cognito encounters an invalid Lambda response.</p>
    InvalidLambdaResponseException(super::super::types::error::InvalidLambdaResponseException),
    ...
    InvalidPasswordException(super::super::types::error::InvalidPasswordException),
    ...
    InvalidSmsRoleAccessPolicyException(super::super::types::error::InvalidSmsRoleAccessPolicyException),
    ...
    InvalidSmsRoleTrustRelationshipException(super::super::types::error::InvalidSmsRoleTrustRelationshipException),
    /// <p>This exception is thrown when the user pool configuration is not valid.</p>
    InvalidUserPoolConfigurationException(super::super::types::error::InvalidUserPoolConfigurationException),
    /// <p>This exception is thrown when Amazon Cognito can't find a multi-factor authentication (MFA) method.</p>
    MfaMethodNotFoundException(super::super::types::error::MfaMethodNotFoundException),
    /// <p>This exception is thrown when a user isn't authorized.</p>
    NotAuthorizedException(super::super::types::error::NotAuthorizedException),
    ...
    OperationNotEnabledException(super::super::types::error::OperationNotEnabledException),
    ...
    PasswordHistoryPolicyViolationException(super::super::types::error::PasswordHistoryPolicyViolationException),
    /// <p>This exception is thrown when a password reset is required.</p>
    PasswordResetRequiredException(super::super::types::error::PasswordResetRequiredException),
    ...
    SoftwareTokenMfaNotFoundException(super::super::types::error::SoftwareTokenMfaNotFoundException),
    ...
    UnexpectedLambdaException(super::super::types::error::UnexpectedLambdaException),
    ...
    UserLambdaValidationException(super::super::types::error::UserLambdaValidationException),
    /// <p>This exception is thrown when a user isn't confirmed successfully.</p>
    UserNotConfirmedException(super::super::types::error::UserNotConfirmedException),
    /// <p>This exception is thrown when a user isn't found.</p>
    UserNotFoundException(super::super::types::error::UserNotFoundException),
...
impl ::aws_types::request_id::RequestId for super::super::operation::admin_respond_to_auth_challenge::AdminRespondToAuthChallengeError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::admin_respond_to_auth_challenge::_admin_respond_to_auth_challenge_input::AdminRespondToAuthChallengeInput;

pub use super::super::operation::admin_respond_to_auth_challenge::_admin_respond_to_auth_challenge_output::AdminRespondToAuthChallengeOutput;
