...
impl ListGroups {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::super::operation::list_groups::ListGroupsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::list_groups::ListGroupsError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::list_groups::ListGroupsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::list_groups::ListGroupsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListGroupsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_list_groups::de_list_groups_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_list_groups::de_list_groups_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListGroupsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::list_groups::ListGroupsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_list_groups::ser_list_groups_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::list_groups::ListGroupsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::list_groups::_list_groups_input::ListGroupsInput;

pub use super::super::operation::list_groups::_list_groups_output::ListGroupsOutput;
