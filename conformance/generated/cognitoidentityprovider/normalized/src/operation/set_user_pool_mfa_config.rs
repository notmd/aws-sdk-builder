    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::set_user_pool_mfa_config::SetUserPoolMfaConfigError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::set_user_pool_mfa_config::SetUserPoolMfaConfigOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetUserPoolMfaConfigResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_set_user_pool_mfa_config::de_set_user_pool_mfa_config_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_set_user_pool_mfa_config::de_set_user_pool_mfa_config_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetUserPoolMfaConfigRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::set_user_pool_mfa_config::SetUserPoolMfaConfigInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::set_user_pool_mfa_config::SetUserPoolMfaConfigInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_set_user_pool_mfa_config::ser_set_user_pool_mfa_config_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::super::operation::set_user_pool_mfa_config::SetUserPoolMfaConfigError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::set_user_pool_mfa_config::_set_user_pool_mfa_config_input::SetUserPoolMfaConfigInput;

pub use super::super::operation::set_user_pool_mfa_config::_set_user_pool_mfa_config_output::SetUserPoolMfaConfigOutput;
