...
impl DeleteManagedLoginBrandingInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_managed_login_branding::builders::DeleteManagedLoginBrandingInputBuilder {
        super::super::super::operation::delete_managed_login_branding::builders::DeleteManagedLoginBrandingInputBuilder::default()
    }
}
