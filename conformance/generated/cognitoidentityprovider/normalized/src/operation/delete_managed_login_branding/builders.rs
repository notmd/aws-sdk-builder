...
pub use super::super::super::operation::delete_managed_login_branding::_delete_managed_login_branding_input::DeleteManagedLoginBrandingInputBuilder;

pub use super::super::super::operation::delete_managed_login_branding::_delete_managed_login_branding_output::DeleteManagedLoginBrandingOutputBuilder;

impl super::super::super::operation::delete_managed_login_branding::builders::DeleteManagedLoginBrandingInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_managed_login_branding::DeleteManagedLoginBrandingOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_managed_login_branding::DeleteManagedLoginBrandingError,
...
pub struct DeleteManagedLoginBrandingFluentBuilder {
    ...
    inner: super::super::super::operation::delete_managed_login_branding::builders::DeleteManagedLoginBrandingInputBuilder,
...
impl DeleteManagedLoginBrandingFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_managed_login_branding::builders::DeleteManagedLoginBrandingInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_managed_login_branding::DeleteManagedLoginBranding::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_managed_login_branding::DeleteManagedLoginBranding::orchestrate(&runtime_plugins, input).await
    }
