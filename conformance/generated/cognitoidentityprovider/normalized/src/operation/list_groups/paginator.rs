...
pub struct ListGroupsPaginator {
    ...
    builder: super::super::super::operation::list_groups::builders::ListGroupsInputBuilder,
...
impl ListGroupsPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::list_groups::paginator::ListGroupsPaginatorItems {
        super::super::super::operation::list_groups::paginator::ListGroupsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::super::super::operation::list_groups::ListGroups::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_groups_output_output_next_token(resp);
