...
impl ListGroupsOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_groups::builders::ListGroupsOutputBuilder {
        super::super::super::operation::list_groups::builders::ListGroupsOutputBuilder::default()
    }
}
...
impl ListGroupsOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::list_groups::ListGroupsOutput {
