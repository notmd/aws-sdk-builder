...
pub use super::super::super::operation::admin_link_provider_for_user::_admin_link_provider_for_user_input::AdminLinkProviderForUserInputBuilder;

pub use super::super::super::operation::admin_link_provider_for_user::_admin_link_provider_for_user_output::AdminLinkProviderForUserOutputBuilder;

impl super::super::super::operation::admin_link_provider_for_user::builders::AdminLinkProviderForUserInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::admin_link_provider_for_user::AdminLinkProviderForUserOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::admin_link_provider_for_user::AdminLinkProviderForUserError,
...
pub struct AdminLinkProviderForUserFluentBuilder {
    ...
    inner: super::super::super::operation::admin_link_provider_for_user::builders::AdminLinkProviderForUserInputBuilder,
...
impl AdminLinkProviderForUserFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::admin_link_provider_for_user::builders::AdminLinkProviderForUserInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::admin_link_provider_for_user::AdminLinkProviderForUser::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::admin_link_provider_for_user::AdminLinkProviderForUser::orchestrate(&runtime_plugins, input).await
    }
    ...
    /// </important>
    pub fn destination_user(mut self, input: super::super::super::types::ProviderUserIdentifierType) -> Self {
    ...
    /// <p>All attributes in the DestinationUser profile must be mutable. If you have assigned the user any immutable custom attributes, the operation won't succeed.</p>
    /// </important>
    pub fn set_destination_user(mut self, input: ::std::option::Option<super::super::super::types::ProviderUserIdentifierType>) -> Self {
    ...
    /// <p>All attributes in the DestinationUser profile must be mutable. If you have assigned the user any immutable custom attributes, the operation won't succeed.</p>
    /// </important>
    pub fn get_destination_user(&self) -> &::std::option::Option<super::super::super::types::ProviderUserIdentifierType> {
    ...
    /// </ul>
    pub fn source_user(mut self, input: super::super::super::types::ProviderUserIdentifierType) -> Self {
    ...
    /// <p>When you set <code>ProviderAttributeName</code> to <code>Cognito_Subject</code>, Amazon Cognito will automatically parse the default unique identifier found in the subject from the IdP token.</p></li>
    /// </ul>
    pub fn set_source_user(mut self, input: ::std::option::Option<super::super::super::types::ProviderUserIdentifierType>) -> Self {
    ...
    /// <p>When you set <code>ProviderAttributeName</code> to <code>Cognito_Subject</code>, Amazon Cognito will automatically parse the default unique identifier found in the subject from the IdP token.</p></li>
    /// </ul>
    pub fn get_source_user(&self) -> &::std::option::Option<super::super::super::types::ProviderUserIdentifierType> {
