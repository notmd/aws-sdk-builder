...
pub struct AdminLinkProviderForUserInput {
    ...
    /// </important>
    pub destination_user: ::std::option::Option<super::super::super::types::ProviderUserIdentifierType>,
    ...
    /// </ul>
    pub source_user: ::std::option::Option<super::super::super::types::ProviderUserIdentifierType>,
}
impl AdminLinkProviderForUserInput {
    ...
    /// <p>All attributes in the DestinationUser profile must be mutable. If you have assigned the user any immutable custom attributes, the operation won't succeed.</p>
    /// </important>
    pub fn destination_user(&self) -> ::std::option::Option<&super::super::super::types::ProviderUserIdentifierType> {
    ...
    /// <p>When you set <code>ProviderAttributeName</code> to <code>Cognito_Subject</code>, Amazon Cognito will automatically parse the default unique identifier found in the subject from the IdP token.</p></li>
    /// </ul>
    pub fn source_user(&self) -> ::std::option::Option<&super::super::super::types::ProviderUserIdentifierType> {
...
impl AdminLinkProviderForUserInput {
    ...
    pub fn builder() -> super::super::super::operation::admin_link_provider_for_user::builders::AdminLinkProviderForUserInputBuilder {
        super::super::super::operation::admin_link_provider_for_user::builders::AdminLinkProviderForUserInputBuilder::default()
    }
}
...
pub struct AdminLinkProviderForUserInputBuilder {
    ...
    pub(crate) destination_user: ::std::option::Option<super::super::super::types::ProviderUserIdentifierType>,
    pub(crate) source_user: ::std::option::Option<super::super::super::types::ProviderUserIdentifierType>,
}
