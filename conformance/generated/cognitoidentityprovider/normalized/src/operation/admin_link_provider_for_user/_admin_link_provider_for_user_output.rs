...
impl AdminLinkProviderForUserOutput {
    ...
    pub fn builder() -> super::super::super::operation::admin_link_provider_for_user::builders::AdminLinkProviderForUserOutputBuilder {
        super::super::super::operation::admin_link_provider_for_user::builders::AdminLinkProviderForUserOutputBuilder::default()
    }
}
...
impl AdminLinkProviderForUserOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::admin_link_provider_for_user::AdminLinkProviderForUserOutput {
