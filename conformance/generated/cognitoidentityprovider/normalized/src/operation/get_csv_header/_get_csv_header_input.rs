...
impl GetCsvHeaderInput {
    ...
    pub fn builder() -> super::super::super::operation::get_csv_header::builders::GetCsvHeaderInputBuilder {
        super::super::super::operation::get_csv_header::builders::GetCsvHeaderInputBuilder::default()
    }
}
