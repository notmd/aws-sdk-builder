...
impl GetCsvHeaderOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_csv_header::builders::GetCsvHeaderOutputBuilder {
        super::super::super::operation::get_csv_header::builders::GetCsvHeaderOutputBuilder::default()
    }
}
...
impl GetCsvHeaderOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::get_csv_header::GetCsvHeaderOutput {
