...
impl AdminDeleteUserAttributes {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::admin_delete_user_attributes::AdminDeleteUserAttributesInput,
    ) -> ::std::result::Result<
        super::super::operation::admin_delete_user_attributes::AdminDeleteUserAttributesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::admin_delete_user_attributes::AdminDeleteUserAttributesError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::admin_delete_user_attributes::AdminDeleteUserAttributesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::admin_delete_user_attributes::AdminDeleteUserAttributesOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AdminDeleteUserAttributes {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AdminDeleteUserAttributes")
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AdminDeleteUserAttributesTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AdminDeleteUserAttributesInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AdminDeleteUserAttributesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_admin_delete_user_attributes::de_admin_delete_user_attributes_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_admin_delete_user_attributes::de_admin_delete_user_attributes_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AdminDeleteUserAttributesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::admin_delete_user_attributes::AdminDeleteUserAttributesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::admin_delete_user_attributes::AdminDeleteUserAttributesInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_admin_delete_user_attributes::ser_admin_delete_user_attributes_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::super::operation::admin_delete_user_attributes::AdminDeleteUserAttributesError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::admin_delete_user_attributes::_admin_delete_user_attributes_input::AdminDeleteUserAttributesInput;

pub use super::super::operation::admin_delete_user_attributes::_admin_delete_user_attributes_output::AdminDeleteUserAttributesOutput;
