...
impl DescribeIdentityProviderInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_identity_provider::builders::DescribeIdentityProviderInputBuilder {
        super::super::super::operation::describe_identity_provider::builders::DescribeIdentityProviderInputBuilder::default()
    }
}
