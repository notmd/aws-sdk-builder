...
pub use super::super::super::operation::list_user_pools::_list_user_pools_input::ListUserPoolsInputBuilder;

pub use super::super::super::operation::list_user_pools::_list_user_pools_output::ListUserPoolsOutputBuilder;

impl super::super::super::operation::list_user_pools::builders::ListUserPoolsInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::list_user_pools::ListUserPoolsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::list_user_pools::ListUserPoolsError,
...
pub struct ListUserPoolsFluentBuilder {
    ...
    inner: super::super::super::operation::list_user_pools::builders::ListUserPoolsInputBuilder,
...
impl ListUserPoolsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::list_user_pools::builders::ListUserPoolsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::list_user_pools::ListUserPools::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::list_user_pools::ListUserPools::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::super::super::operation::list_user_pools::paginator::ListUserPoolsPaginator {
        super::super::super::operation::list_user_pools::paginator::ListUserPoolsPaginator::new(self.handle, self.inner)
    }
