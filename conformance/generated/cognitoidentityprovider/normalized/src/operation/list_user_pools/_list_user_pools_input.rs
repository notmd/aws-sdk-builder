...
impl ListUserPoolsInput {
    ...
    pub fn builder() -> super::super::super::operation::list_user_pools::builders::ListUserPoolsInputBuilder {
        super::super::super::operation::list_user_pools::builders::ListUserPoolsInputBuilder::default()
    }
}
...
impl ListUserPoolsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::list_user_pools::ListUserPoolsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::super::operation::list_user_pools::ListUserPoolsInput {
