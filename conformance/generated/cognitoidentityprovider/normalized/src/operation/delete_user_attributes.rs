...
impl DeleteUserAttributes {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::delete_user_attributes::DeleteUserAttributesInput,
    ) -> ::std::result::Result<
        super::super::operation::delete_user_attributes::DeleteUserAttributesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::delete_user_attributes::DeleteUserAttributesError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::delete_user_attributes::DeleteUserAttributesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::delete_user_attributes::DeleteUserAttributesOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteUserAttributes {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteUserAttributes")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteUserAttributesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_delete_user_attributes::de_delete_user_attributes_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_delete_user_attributes::de_delete_user_attributes_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteUserAttributesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::delete_user_attributes::DeleteUserAttributesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::delete_user_attributes::DeleteUserAttributesInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_delete_user_attributes::ser_delete_user_attributes_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::delete_user_attributes::DeleteUserAttributesError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::delete_user_attributes::_delete_user_attributes_input::DeleteUserAttributesInput;

pub use super::super::operation::delete_user_attributes::_delete_user_attributes_output::DeleteUserAttributesOutput;
