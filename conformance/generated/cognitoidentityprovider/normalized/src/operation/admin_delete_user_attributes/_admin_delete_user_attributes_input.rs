...
impl AdminDeleteUserAttributesInput {
    ...
    pub fn builder() -> super::super::super::operation::admin_delete_user_attributes::builders::AdminDeleteUserAttributesInputBuilder {
        super::super::super::operation::admin_delete_user_attributes::builders::AdminDeleteUserAttributesInputBuilder::default()
    }
}
