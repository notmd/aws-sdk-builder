...
impl AdminDeleteUserAttributesOutput {
    ...
    pub fn builder() -> super::super::super::operation::admin_delete_user_attributes::builders::AdminDeleteUserAttributesOutputBuilder {
        super::super::super::operation::admin_delete_user_attributes::builders::AdminDeleteUserAttributesOutputBuilder::default()
    }
}
...
impl AdminDeleteUserAttributesOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::admin_delete_user_attributes::AdminDeleteUserAttributesOutput {
