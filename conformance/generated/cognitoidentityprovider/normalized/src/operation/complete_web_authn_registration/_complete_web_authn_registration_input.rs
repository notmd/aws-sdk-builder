...
impl CompleteWebAuthnRegistrationInput {
    ...
    pub fn builder() -> super::super::super::operation::complete_web_authn_registration::builders::CompleteWebAuthnRegistrationInputBuilder {
        super::super::super::operation::complete_web_authn_registration::builders::CompleteWebAuthnRegistrationInputBuilder::default()
    }
}
