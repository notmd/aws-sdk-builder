...
impl VerifyUserAttribute {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::verify_user_attribute::VerifyUserAttributeInput,
    ) -> ::std::result::Result<
        super::super::operation::verify_user_attribute::VerifyUserAttributeOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::verify_user_attribute::VerifyUserAttributeError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::verify_user_attribute::VerifyUserAttributeError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::verify_user_attribute::VerifyUserAttributeOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for VerifyUserAttribute {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("VerifyUserAttribute")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for VerifyUserAttributeResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_verify_user_attribute::de_verify_user_attribute_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_verify_user_attribute::de_verify_user_attribute_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for VerifyUserAttributeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::verify_user_attribute::VerifyUserAttributeInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::verify_user_attribute::VerifyUserAttributeInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_verify_user_attribute::ser_verify_user_attribute_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::verify_user_attribute::VerifyUserAttributeError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::verify_user_attribute::_verify_user_attribute_input::VerifyUserAttributeInput;

pub use super::super::operation::verify_user_attribute::_verify_user_attribute_output::VerifyUserAttributeOutput;
