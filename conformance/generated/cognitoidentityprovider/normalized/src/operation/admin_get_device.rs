...
impl AdminGetDevice {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::admin_get_device::AdminGetDeviceInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::admin_get_device::AdminGetDeviceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::admin_get_device::AdminGetDeviceOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AdminGetDeviceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_admin_get_device::de_admin_get_device_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_admin_get_device::de_admin_get_device_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AdminGetDeviceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::admin_get_device::AdminGetDeviceInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::admin_get_device::AdminGetDeviceInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_admin_get_device::ser_admin_get_device_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::admin_get_device::AdminGetDeviceError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::admin_get_device::_admin_get_device_input::AdminGetDeviceInput;

pub use super::super::operation::admin_get_device::_admin_get_device_output::AdminGetDeviceOutput;
