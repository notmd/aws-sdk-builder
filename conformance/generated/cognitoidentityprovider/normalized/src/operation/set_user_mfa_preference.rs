...
impl SetUserMfaPreference {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::set_user_mfa_preference::SetUserMfaPreferenceInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::set_user_mfa_preference::SetUserMFAPreferenceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::set_user_mfa_preference::SetUserMfaPreferenceOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SetUserMfaPreference {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SetUserMFAPreference")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetUserMFAPreferenceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_set_user_mfa_preference::de_set_user_mfa_preference_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_set_user_mfa_preference::de_set_user_mfa_preference_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetUserMFAPreferenceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::set_user_mfa_preference::SetUserMfaPreferenceInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::set_user_mfa_preference::SetUserMfaPreferenceInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_set_user_mfa_preference::ser_set_user_mfa_preference_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::set_user_mfa_preference::SetUserMFAPreferenceError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::set_user_mfa_preference::_set_user_mfa_preference_input::SetUserMfaPreferenceInput;

pub use super::super::operation::set_user_mfa_preference::_set_user_mfa_preference_output::SetUserMfaPreferenceOutput;
