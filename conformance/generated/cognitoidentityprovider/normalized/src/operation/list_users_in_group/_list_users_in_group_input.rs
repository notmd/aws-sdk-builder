...
impl ListUsersInGroupInput {
    ...
    pub fn builder() -> super::super::super::operation::list_users_in_group::builders::ListUsersInGroupInputBuilder {
        super::super::super::operation::list_users_in_group::builders::ListUsersInGroupInputBuilder::default()
    }
}
