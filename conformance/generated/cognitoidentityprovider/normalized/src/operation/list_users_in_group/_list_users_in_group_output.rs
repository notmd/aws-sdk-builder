...
pub struct ListUsersInGroupOutput {
    ...
    pub users: ::std::option::Option<::std::vec::Vec<super::super::super::types::UserType>>,
...
impl ListUsersInGroupOutput {
    ...
    pub fn users(&self) -> &[super::super::super::types::UserType] {
...
impl ListUsersInGroupOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_users_in_group::builders::ListUsersInGroupOutputBuilder {
        super::super::super::operation::list_users_in_group::builders::ListUsersInGroupOutputBuilder::default()
    }
}
...
pub struct ListUsersInGroupOutputBuilder {
    pub(crate) users: ::std::option::Option<::std::vec::Vec<super::super::super::types::UserType>>,
...
impl ListUsersInGroupOutputBuilder {
    ...
    ///
    /// <p>An array of users who are members in the group, and their attributes.</p>
    pub fn users(mut self, input: super::super::super::types::UserType) -> Self {
    ...
    /// <p>An array of users who are members in the group, and their attributes.</p>
    pub fn set_users(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::UserType>>) -> Self {
        self.users = input;
        self
    }
    /// <p>An array of users who are members in the group, and their attributes.</p>
    pub fn get_users(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::UserType>> {
        &self.users
    }
    /// <p>The identifier that Amazon Cognito returned with the previous request to this operation. When you include a pagination token in your request, Amazon Cognito returns the next set of items in the list. By use of this token, you can paginate through the full list of items.</p>
    ...
    pub fn build(self) -> super::super::super::operation::list_users_in_group::ListUsersInGroupOutput {
