...
pub use super::super::super::operation::admin_respond_to_auth_challenge::_admin_respond_to_auth_challenge_input::AdminRespondToAuthChallengeInputBuilder;

pub use super::super::super::operation::admin_respond_to_auth_challenge::_admin_respond_to_auth_challenge_output::AdminRespondToAuthChallengeOutputBuilder;

impl super::super::super::operation::admin_respond_to_auth_challenge::builders::AdminRespondToAuthChallengeInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::admin_respond_to_auth_challenge::AdminRespondToAuthChallengeOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::admin_respond_to_auth_challenge::AdminRespondToAuthChallengeError,
...
pub struct AdminRespondToAuthChallengeFluentBuilder {
    ...
    inner: super::super::super::operation::admin_respond_to_auth_challenge::builders::AdminRespondToAuthChallengeInputBuilder,
...
impl AdminRespondToAuthChallengeFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::admin_respond_to_auth_challenge::builders::AdminRespondToAuthChallengeInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::admin_respond_to_auth_challenge::AdminRespondToAuthChallenge::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::admin_respond_to_auth_challenge::AdminRespondToAuthChallenge::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn context_data(mut self, input: super::super::super::types::ContextDataType) -> Self {
        self.inner = self.inner.context_data(input);
        self
    }
    /// <p>Contextual data about your user session like the device fingerprint, IP address, or location. Amazon Cognito threat protection evaluates the risk of an authentication event based on the context that your app generates and passes to Amazon Cognito when it makes API requests.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-settings-viewing-threat-protection-app.html">Collecting data for threat protection in applications</a>.</p>
    pub fn set_context_data(mut self, input: ::std::option::Option<super::super::super::types::ContextDataType>) -> Self {
        self.inner = self.inner.set_context_data(input);
        self
    }
    /// <p>Contextual data about your user session like the device fingerprint, IP address, or location. Amazon Cognito threat protection evaluates the risk of an authentication event based on the context that your app generates and passes to Amazon Cognito when it makes API requests.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-settings-viewing-threat-protection-app.html">Collecting data for threat protection in applications</a>.</p>
    pub fn get_context_data(&self) -> &::std::option::Option<super::super::super::types::ContextDataType> {
