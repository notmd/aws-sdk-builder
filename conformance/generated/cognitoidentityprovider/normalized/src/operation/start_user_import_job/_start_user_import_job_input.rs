...
impl StartUserImportJobInput {
    ...
    pub fn builder() -> super::super::super::operation::start_user_import_job::builders::StartUserImportJobInputBuilder {
        super::super::super::operation::start_user_import_job::builders::StartUserImportJobInputBuilder::default()
    }
}
