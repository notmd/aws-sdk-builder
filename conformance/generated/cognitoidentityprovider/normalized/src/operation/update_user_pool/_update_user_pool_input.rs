...
impl UpdateUserPoolInput {
    ...
    pub fn builder() -> super::super::super::operation::update_user_pool::builders::UpdateUserPoolInputBuilder {
        super::super::super::operation::update_user_pool::builders::UpdateUserPoolInputBuilder::default()
    }
}
...
impl UpdateUserPoolInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::update_user_pool::UpdateUserPoolInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::super::operation::update_user_pool::UpdateUserPoolInput {
