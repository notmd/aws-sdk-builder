...
impl UpdateUserPoolOutput {
    ...
    pub fn builder() -> super::super::super::operation::update_user_pool::builders::UpdateUserPoolOutputBuilder {
        super::super::super::operation::update_user_pool::builders::UpdateUserPoolOutputBuilder::default()
    }
}
...
impl UpdateUserPoolOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::update_user_pool::UpdateUserPoolOutput {
