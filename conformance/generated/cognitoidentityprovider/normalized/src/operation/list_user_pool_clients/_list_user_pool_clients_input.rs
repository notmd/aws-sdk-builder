...
impl ListUserPoolClientsInput {
    ...
    pub fn builder() -> super::super::super::operation::list_user_pool_clients::builders::ListUserPoolClientsInputBuilder {
        super::super::super::operation::list_user_pool_clients::builders::ListUserPoolClientsInputBuilder::default()
    }
}
