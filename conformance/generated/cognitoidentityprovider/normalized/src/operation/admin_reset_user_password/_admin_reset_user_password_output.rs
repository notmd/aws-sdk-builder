...
impl AdminResetUserPasswordOutput {
    ...
    pub fn builder() -> super::super::super::operation::admin_reset_user_password::builders::AdminResetUserPasswordOutputBuilder {
        super::super::super::operation::admin_reset_user_password::builders::AdminResetUserPasswordOutputBuilder::default()
    }
}
...
impl AdminResetUserPasswordOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::admin_reset_user_password::AdminResetUserPasswordOutput {
