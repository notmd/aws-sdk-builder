...
impl AdminResetUserPasswordInput {
    ...
    pub fn builder() -> super::super::super::operation::admin_reset_user_password::builders::AdminResetUserPasswordInputBuilder {
        super::super::super::operation::admin_reset_user_password::builders::AdminResetUserPasswordInputBuilder::default()
    }
}
...
impl AdminResetUserPasswordInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::admin_reset_user_password::AdminResetUserPasswordInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::admin_reset_user_password::AdminResetUserPasswordInput {
