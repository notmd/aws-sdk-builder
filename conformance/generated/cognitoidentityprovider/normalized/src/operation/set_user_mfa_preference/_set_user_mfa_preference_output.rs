...
impl SetUserMfaPreferenceOutput {
    ...
    pub fn builder() -> super::super::super::operation::set_user_mfa_preference::builders::SetUserMfaPreferenceOutputBuilder {
        super::super::super::operation::set_user_mfa_preference::builders::SetUserMfaPreferenceOutputBuilder::default()
    }
}
...
impl SetUserMfaPreferenceOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::set_user_mfa_preference::SetUserMfaPreferenceOutput {
