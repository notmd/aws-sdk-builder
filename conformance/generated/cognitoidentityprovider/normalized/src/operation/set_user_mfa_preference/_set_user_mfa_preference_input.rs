...
pub struct SetUserMfaPreferenceInput {
    ...
    pub sms_mfa_settings: ::std::option::Option<super::super::super::types::SmsMfaSettingsType>,
    ...
    pub software_token_mfa_settings: ::std::option::Option<super::super::super::types::SoftwareTokenMfaSettingsType>,
    ...
    pub email_mfa_settings: ::std::option::Option<super::super::super::types::EmailMfaSettingsType>,
    ...
    pub web_authn_mfa_settings: ::std::option::Option<super::super::super::types::WebAuthnMfaSettingsType>,
...
impl SetUserMfaPreferenceInput {
    /// <p>User preferences for SMS message MFA. Activates or deactivates SMS MFA and sets it as the preferred MFA method when multiple methods are available.</p>
    pub fn sms_mfa_settings(&self) -> ::std::option::Option<&super::super::super::types::SmsMfaSettingsType> {
        self.sms_mfa_settings.as_ref()
    }
    /// <p>User preferences for time-based one-time password (TOTP) MFA. Activates or deactivates TOTP MFA and sets it as the preferred MFA method when multiple methods are available. Users must register a TOTP authenticator before they set this as their preferred MFA method.</p>
    pub fn software_token_mfa_settings(&self) -> ::std::option::Option<&super::super::super::types::SoftwareTokenMfaSettingsType> {
        self.software_token_mfa_settings.as_ref()
    }
    /// <p>User preferences for email message MFA. Activates or deactivates email MFA and sets it as the preferred MFA method when multiple methods are available. To activate this setting, your user pool must be in the <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/feature-plans-features-essentials.html"> Essentials tier</a> or higher.</p>
    pub fn email_mfa_settings(&self) -> ::std::option::Option<&super::super::super::types::EmailMfaSettingsType> {
        self.email_mfa_settings.as_ref()
    }
    /// <p>User preferences for passkey MFA. Activates or deactivates passkey MFA for the user. When activated, passkey authentication requires user verification, and passkey sign-in is available when MFA is required. To activate this setting, the <code>FactorConfiguration</code> of your user pool <code>WebAuthnConfiguration</code> must be <code>MULTI_FACTOR_WITH_USER_VERIFICATION</code>. To activate this setting, your user pool must be in the <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/feature-plans-features-essentials.html"> Essentials tier</a> or higher.</p>
    pub fn web_authn_mfa_settings(&self) -> ::std::option::Option<&super::super::super::types::WebAuthnMfaSettingsType> {
...
impl SetUserMfaPreferenceInput {
    ...
    pub fn builder() -> super::super::super::operation::set_user_mfa_preference::builders::SetUserMfaPreferenceInputBuilder {
        super::super::super::operation::set_user_mfa_preference::builders::SetUserMfaPreferenceInputBuilder::default()
    }
}
...
pub struct SetUserMfaPreferenceInputBuilder {
    pub(crate) sms_mfa_settings: ::std::option::Option<super::super::super::types::SmsMfaSettingsType>,
    pub(crate) software_token_mfa_settings: ::std::option::Option<super::super::super::types::SoftwareTokenMfaSettingsType>,
    pub(crate) email_mfa_settings: ::std::option::Option<super::super::super::types::EmailMfaSettingsType>,
    pub(crate) web_authn_mfa_settings: ::std::option::Option<super::super::super::types::WebAuthnMfaSettingsType>,
...
impl SetUserMfaPreferenceInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::set_user_mfa_preference::SetUserMfaPreferenceInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::set_user_mfa_preference::SetUserMfaPreferenceInput {
