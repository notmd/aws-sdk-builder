...
impl AdminUpdateUserAttributesOutput {
    ...
    pub fn builder() -> super::super::super::operation::admin_update_user_attributes::builders::AdminUpdateUserAttributesOutputBuilder {
        super::super::super::operation::admin_update_user_attributes::builders::AdminUpdateUserAttributesOutputBuilder::default()
    }
}
...
impl AdminUpdateUserAttributesOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::admin_update_user_attributes::AdminUpdateUserAttributesOutput {
