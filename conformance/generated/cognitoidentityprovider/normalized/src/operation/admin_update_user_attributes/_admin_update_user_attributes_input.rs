...
impl AdminUpdateUserAttributesInput {
    ...
    pub fn builder() -> super::super::super::operation::admin_update_user_attributes::builders::AdminUpdateUserAttributesInputBuilder {
        super::super::super::operation::admin_update_user_attributes::builders::AdminUpdateUserAttributesInputBuilder::default()
    }
}
