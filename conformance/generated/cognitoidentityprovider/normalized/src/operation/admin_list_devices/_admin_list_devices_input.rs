...
impl AdminListDevicesInput {
    ...
    pub fn builder() -> super::super::super::operation::admin_list_devices::builders::AdminListDevicesInputBuilder {
        super::super::super::operation::admin_list_devices::builders::AdminListDevicesInputBuilder::default()
    }
}
