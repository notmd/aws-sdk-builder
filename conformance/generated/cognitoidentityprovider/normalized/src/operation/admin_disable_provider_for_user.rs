...
impl AdminDisableProviderForUser {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::admin_disable_provider_for_user::AdminDisableProviderForUserInput,
    ) -> ::std::result::Result<
        super::super::operation::admin_disable_provider_for_user::AdminDisableProviderForUserOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::admin_disable_provider_for_user::AdminDisableProviderForUserError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::admin_disable_provider_for_user::AdminDisableProviderForUserError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::admin_disable_provider_for_user::AdminDisableProviderForUserOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AdminDisableProviderForUser {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AdminDisableProviderForUser")
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AdminDisableProviderForUserTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AdminDisableProviderForUserInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AdminDisableProviderForUserResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_admin_disable_provider_for_user::de_admin_disable_provider_for_user_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_admin_disable_provider_for_user::de_admin_disable_provider_for_user_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AdminDisableProviderForUserRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::admin_disable_provider_for_user::AdminDisableProviderForUserInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::admin_disable_provider_for_user::AdminDisableProviderForUserInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_admin_disable_provider_for_user::ser_admin_disable_provider_for_user_input(&input)?,
        );
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AdminDisableProviderForUserEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "AdminDisableProviderForUserEndpointParamsInterceptor"
    }
...
impl ::aws_types::request_id::RequestId for super::super::operation::admin_disable_provider_for_user::AdminDisableProviderForUserError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::admin_disable_provider_for_user::_admin_disable_provider_for_user_input::AdminDisableProviderForUserInput;

pub use super::super::operation::admin_disable_provider_for_user::_admin_disable_provider_for_user_output::AdminDisableProviderForUserOutput;
