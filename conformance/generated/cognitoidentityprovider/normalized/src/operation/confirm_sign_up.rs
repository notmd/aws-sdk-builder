...
impl ConfirmSignUp {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::super::operation::confirm_sign_up::ConfirmSignUpOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::confirm_sign_up::ConfirmSignUpError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::confirm_sign_up::ConfirmSignUpError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::confirm_sign_up::ConfirmSignUpOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ConfirmSignUp {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ConfirmSignUp")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ConfirmSignUpResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_confirm_sign_up::de_confirm_sign_up_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_confirm_sign_up::de_confirm_sign_up_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ConfirmSignUpRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::confirm_sign_up::ConfirmSignUpInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::confirm_sign_up::ConfirmSignUpInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_confirm_sign_up::ser_confirm_sign_up_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::confirm_sign_up::ConfirmSignUpError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::confirm_sign_up::_confirm_sign_up_input::ConfirmSignUpInput;

pub use super::super::operation::confirm_sign_up::_confirm_sign_up_output::ConfirmSignUpOutput;
