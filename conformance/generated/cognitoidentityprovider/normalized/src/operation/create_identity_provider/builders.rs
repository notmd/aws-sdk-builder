...
pub use super::super::super::operation::create_identity_provider::_create_identity_provider_input::CreateIdentityProviderInputBuilder;

pub use super::super::super::operation::create_identity_provider::_create_identity_provider_output::CreateIdentityProviderOutputBuilder;

impl super::super::super::operation::create_identity_provider::builders::CreateIdentityProviderInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::create_identity_provider::CreateIdentityProviderOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::create_identity_provider::CreateIdentityProviderError,
...
pub struct CreateIdentityProviderFluentBuilder {
    ...
    inner: super::super::super::operation::create_identity_provider::builders::CreateIdentityProviderInputBuilder,
...
impl CreateIdentityProviderFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::create_identity_provider::builders::CreateIdentityProviderInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::create_identity_provider::CreateIdentityProvider::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::create_identity_provider::CreateIdentityProvider::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn provider_type(mut self, input: super::super::super::types::IdentityProviderTypeType) -> Self {
        self.inner = self.inner.provider_type(input);
        self
    }
    /// <p>The type of IdP that you want to add. Amazon Cognito supports OIDC, SAML 2.0, Login With Amazon, Sign In With Apple, Google, and Facebook IdPs.</p>
    pub fn set_provider_type(mut self, input: ::std::option::Option<super::super::super::types::IdentityProviderTypeType>) -> Self {
        self.inner = self.inner.set_provider_type(input);
        self
    }
    /// <p>The type of IdP that you want to add. Amazon Cognito supports OIDC, SAML 2.0, Login With Amazon, Sign In With Apple, Google, and Facebook IdPs.</p>
    pub fn get_provider_type(&self) -> &::std::option::Option<super::super::super::types::IdentityProviderTypeType> {
