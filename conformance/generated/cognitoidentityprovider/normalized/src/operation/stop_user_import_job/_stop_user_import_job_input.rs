...
impl StopUserImportJobInput {
    ...
    pub fn builder() -> super::super::super::operation::stop_user_import_job::builders::StopUserImportJobInputBuilder {
        super::super::super::operation::stop_user_import_job::builders::StopUserImportJobInputBuilder::default()
    }
}
