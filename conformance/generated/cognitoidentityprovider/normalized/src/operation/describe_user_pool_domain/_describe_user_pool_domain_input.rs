...
impl DescribeUserPoolDomainInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_user_pool_domain::builders::DescribeUserPoolDomainInputBuilder {
        super::super::super::operation::describe_user_pool_domain::builders::DescribeUserPoolDomainInputBuilder::default()
    }
}
...
impl DescribeUserPoolDomainInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::describe_user_pool_domain::DescribeUserPoolDomainInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::describe_user_pool_domain::DescribeUserPoolDomainInput { domain: self.domain })
    }
}
