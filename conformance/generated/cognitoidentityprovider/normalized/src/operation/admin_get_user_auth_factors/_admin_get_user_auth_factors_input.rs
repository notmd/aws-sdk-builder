...
impl AdminGetUserAuthFactorsInput {
    ...
    pub fn builder() -> super::super::super::operation::admin_get_user_auth_factors::builders::AdminGetUserAuthFactorsInputBuilder {
        super::super::super::operation::admin_get_user_auth_factors::builders::AdminGetUserAuthFactorsInputBuilder::default()
    }
}
