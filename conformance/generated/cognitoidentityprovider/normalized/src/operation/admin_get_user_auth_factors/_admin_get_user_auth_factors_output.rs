...
pub struct AdminGetUserAuthFactorsOutput {
    ...
    pub configured_user_auth_factors: ::std::option::Option<::std::vec::Vec<super::super::super::types::AuthFactorType>>,
...
impl AdminGetUserAuthFactorsOutput {
    ...
    pub fn configured_user_auth_factors(&self) -> &[super::super::super::types::AuthFactorType] {
...
impl AdminGetUserAuthFactorsOutput {
    ...
    pub fn builder() -> super::super::super::operation::admin_get_user_auth_factors::builders::AdminGetUserAuthFactorsOutputBuilder {
        super::super::super::operation::admin_get_user_auth_factors::builders::AdminGetUserAuthFactorsOutputBuilder::default()
    }
}
...
pub struct AdminGetUserAuthFactorsOutputBuilder {
    ...
    pub(crate) configured_user_auth_factors: ::std::option::Option<::std::vec::Vec<super::super::super::types::AuthFactorType>>,
    _request_id: Option<String>,
}
impl AdminGetUserAuthFactorsOutputBuilder {
    ...
    /// <p>The authentication types that are available to the user with <code>USER_AUTH</code> sign-in, for example <code>\["PASSWORD", "WEB_AUTHN"\]</code>.</p>
    /// <p><code>PASSWORD</code> can only be used as a first authentication factor. <code>SOFTWARE_TOKEN</code> can only be used as an MFA factor. <code>EMAIL_OTP</code>, <code>SMS_OTP</code>, and <code>WEB_AUTHN</code> can be used as either a first authentication factor or an MFA factor. <code>WEB_AUTHN</code> is available as an MFA factor only when passkey MFA is enabled at the user pool level.</p>
    pub fn configured_user_auth_factors(mut self, input: super::super::super::types::AuthFactorType) -> Self {
    ...
    /// <p>The authentication types that are available to the user with <code>USER_AUTH</code> sign-in, for example <code>\["PASSWORD", "WEB_AUTHN"\]</code>.</p>
    /// <p><code>PASSWORD</code> can only be used as a first authentication factor. <code>SOFTWARE_TOKEN</code> can only be used as an MFA factor. <code>EMAIL_OTP</code>, <code>SMS_OTP</code>, and <code>WEB_AUTHN</code> can be used as either a first authentication factor or an MFA factor. <code>WEB_AUTHN</code> is available as an MFA factor only when passkey MFA is enabled at the user pool level.</p>
    pub fn get_configured_user_auth_factors(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::AuthFactorType>> {
