...
pub use super::super::super::operation::list_user_import_jobs::_list_user_import_jobs_input::ListUserImportJobsInputBuilder;

pub use super::super::super::operation::list_user_import_jobs::_list_user_import_jobs_output::ListUserImportJobsOutputBuilder;

impl super::super::super::operation::list_user_import_jobs::builders::ListUserImportJobsInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::list_user_import_jobs::ListUserImportJobsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::list_user_import_jobs::ListUserImportJobsError,
...
pub struct ListUserImportJobsFluentBuilder {
    ...
    inner: super::super::super::operation::list_user_import_jobs::builders::ListUserImportJobsInputBuilder,
...
impl
    super::super::super::client::customize::internal::CustomizableSend<
        super::super::super::operation::list_user_import_jobs::ListUserImportJobsOutput,
        super::super::super::operation::list_user_import_jobs::ListUserImportJobsError,
    > for ListUserImportJobsFluentBuilder
{
    fn send(
        self,
...
impl ListUserImportJobsFluentBuilder {
    /// Creates a new `ListUserImportJobsFluentBuilder`.
    ...
    pub fn as_input(&self) -> &super::super::super::operation::list_user_import_jobs::builders::ListUserImportJobsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::list_user_import_jobs::ListUserImportJobs::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::list_user_import_jobs::ListUserImportJobs::orchestrate(&runtime_plugins, input).await
    }
