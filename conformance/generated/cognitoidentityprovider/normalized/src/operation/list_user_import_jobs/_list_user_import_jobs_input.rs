...
impl ListUserImportJobsInput {
    ...
    pub fn builder() -> super::super::super::operation::list_user_import_jobs::builders::ListUserImportJobsInputBuilder {
        super::super::super::operation::list_user_import_jobs::builders::ListUserImportJobsInputBuilder::default()
    }
}
...
impl ListUserImportJobsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::list_user_import_jobs::ListUserImportJobsInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::list_user_import_jobs::ListUserImportJobsInput {
