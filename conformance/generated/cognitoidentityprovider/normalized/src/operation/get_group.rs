...
impl GetGroup {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::super::operation::get_group::GetGroupOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::get_group::GetGroupError,
    ...
    > {
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::get_group::GetGroupOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetGroupResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_get_group::de_get_group_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_get_group::de_get_group_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetGroupRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::get_group::GetGroupInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_get_group::ser_get_group_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::get_group::GetGroupError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::get_group::_get_group_input::GetGroupInput;

pub use super::super::operation::get_group::_get_group_output::GetGroupOutput;
