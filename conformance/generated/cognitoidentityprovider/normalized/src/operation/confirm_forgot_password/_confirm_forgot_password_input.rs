...
impl ConfirmForgotPasswordInput {
    ...
    pub fn builder() -> super::super::super::operation::confirm_forgot_password::builders::ConfirmForgotPasswordInputBuilder {
        super::super::super::operation::confirm_forgot_password::builders::ConfirmForgotPasswordInputBuilder::default()
    }
}
...
impl ConfirmForgotPasswordInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::confirm_forgot_password::ConfirmForgotPasswordInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::confirm_forgot_password::ConfirmForgotPasswordInput {
