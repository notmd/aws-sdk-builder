    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::set_risk_configuration::SetRiskConfigurationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::set_risk_configuration::SetRiskConfigurationOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SetRiskConfiguration {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SetRiskConfiguration")
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SetRiskConfigurationTelemetryInputCaptureInterceptor {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetRiskConfigurationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_set_risk_configuration::de_set_risk_configuration_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_set_risk_configuration::de_set_risk_configuration_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetRiskConfigurationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::set_risk_configuration::SetRiskConfigurationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::set_risk_configuration::SetRiskConfigurationInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_set_risk_configuration::ser_set_risk_configuration_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::set_risk_configuration::SetRiskConfigurationError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::set_risk_configuration::_set_risk_configuration_input::SetRiskConfigurationInput;

pub use super::super::operation::set_risk_configuration::_set_risk_configuration_output::SetRiskConfigurationOutput;
