...
impl GlobalSignOutOutput {
    ...
    pub fn builder() -> super::super::super::operation::global_sign_out::builders::GlobalSignOutOutputBuilder {
        super::super::super::operation::global_sign_out::builders::GlobalSignOutOutputBuilder::default()
    }
}
...
impl GlobalSignOutOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::global_sign_out::GlobalSignOutOutput {
