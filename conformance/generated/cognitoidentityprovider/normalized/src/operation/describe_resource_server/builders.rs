...
pub use super::super::super::operation::describe_resource_server::_describe_resource_server_input::DescribeResourceServerInputBuilder;

pub use super::super::super::operation::describe_resource_server::_describe_resource_server_output::DescribeResourceServerOutputBuilder;

impl super::super::super::operation::describe_resource_server::builders::DescribeResourceServerInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::describe_resource_server::DescribeResourceServerOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::describe_resource_server::DescribeResourceServerError,
...
pub struct DescribeResourceServerFluentBuilder {
    ...
    inner: super::super::super::operation::describe_resource_server::builders::DescribeResourceServerInputBuilder,
...
impl DescribeResourceServerFluentBuilder {
    /// Creates a new `DescribeResourceServerFluentBuilder`.
    ...
    pub fn as_input(&self) -> &super::super::super::operation::describe_resource_server::builders::DescribeResourceServerInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::describe_resource_server::DescribeResourceServer::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::describe_resource_server::DescribeResourceServer::orchestrate(&runtime_plugins, input).await
    }
