...
impl DescribeResourceServerInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_resource_server::builders::DescribeResourceServerInputBuilder {
        super::super::super::operation::describe_resource_server::builders::DescribeResourceServerInputBuilder::default()
    }
}
...
impl DescribeResourceServerInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::describe_resource_server::DescribeResourceServerInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::describe_resource_server::DescribeResourceServerInput {
