...
impl ForgetDeviceInput {
    ...
    pub fn builder() -> super::super::super::operation::forget_device::builders::ForgetDeviceInputBuilder {
        super::super::super::operation::forget_device::builders::ForgetDeviceInputBuilder::default()
    }
}
