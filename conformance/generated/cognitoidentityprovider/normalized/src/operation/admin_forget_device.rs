...
impl AdminForgetDevice {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::admin_forget_device::AdminForgetDeviceInput,
    ) -> ::std::result::Result<
        super::super::operation::admin_forget_device::AdminForgetDeviceOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::admin_forget_device::AdminForgetDeviceError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::admin_forget_device::AdminForgetDeviceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::admin_forget_device::AdminForgetDeviceOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AdminForgetDevice {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AdminForgetDevice")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AdminForgetDeviceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_admin_forget_device::de_admin_forget_device_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_admin_forget_device::de_admin_forget_device_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AdminForgetDeviceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::admin_forget_device::AdminForgetDeviceInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::admin_forget_device::AdminForgetDeviceInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_admin_forget_device::ser_admin_forget_device_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::admin_forget_device::AdminForgetDeviceError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::admin_forget_device::_admin_forget_device_input::AdminForgetDeviceInput;

pub use super::super::operation::admin_forget_device::_admin_forget_device_output::AdminForgetDeviceOutput;
