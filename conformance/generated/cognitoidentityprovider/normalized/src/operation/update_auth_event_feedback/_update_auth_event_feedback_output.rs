...
impl UpdateAuthEventFeedbackOutput {
    ...
    pub fn builder() -> super::super::super::operation::update_auth_event_feedback::builders::UpdateAuthEventFeedbackOutputBuilder {
        super::super::super::operation::update_auth_event_feedback::builders::UpdateAuthEventFeedbackOutputBuilder::default()
    }
}
...
impl UpdateAuthEventFeedbackOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::update_auth_event_feedback::UpdateAuthEventFeedbackOutput {
