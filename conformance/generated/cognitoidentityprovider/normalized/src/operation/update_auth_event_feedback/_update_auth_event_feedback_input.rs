...
pub struct UpdateAuthEventFeedbackInput {
    ...
    pub feedback_value: ::std::option::Option<super::super::super::types::FeedbackValueType>,
}
impl UpdateAuthEventFeedbackInput {
    ...
    /// <p>Your feedback to the authentication event. When you provide a <code>FeedbackValue</code> value of <code>valid</code>, you tell Amazon Cognito that you trust a user session where Amazon Cognito has evaluated some level of risk. When you provide a <code>FeedbackValue</code> value of <code>invalid</code>, you tell Amazon Cognito that you don't trust a user session, or you don't believe that Amazon Cognito evaluated a high-enough risk level.</p>
    pub fn feedback_value(&self) -> ::std::option::Option<&super::super::super::types::FeedbackValueType> {
...
impl UpdateAuthEventFeedbackInput {
    ...
    pub fn builder() -> super::super::super::operation::update_auth_event_feedback::builders::UpdateAuthEventFeedbackInputBuilder {
        super::super::super::operation::update_auth_event_feedback::builders::UpdateAuthEventFeedbackInputBuilder::default()
    }
}
...
pub struct UpdateAuthEventFeedbackInputBuilder {
    ...
    pub(crate) feedback_value: ::std::option::Option<super::super::super::types::FeedbackValueType>,
}
impl UpdateAuthEventFeedbackInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::update_auth_event_feedback::UpdateAuthEventFeedbackInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::update_auth_event_feedback::UpdateAuthEventFeedbackInput {
