...
impl AdminInitiateAuthInput {
    ...
    pub fn builder() -> super::super::super::operation::admin_initiate_auth::builders::AdminInitiateAuthInputBuilder {
        super::super::super::operation::admin_initiate_auth::builders::AdminInitiateAuthInputBuilder::default()
    }
}
