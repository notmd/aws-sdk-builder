...
pub struct AdminInitiateAuthOutput {
    ...
    /// </ul>
    pub challenge_name: ::std::option::Option<super::super::super::types::ChallengeNameType>,
    ...
    pub authentication_result: ::std::option::Option<super::super::super::types::AuthenticationResultType>,
    ...
    pub available_challenges: ::std::option::Option<::std::vec::Vec<super::super::super::types::ChallengeNameType>>,
...
impl AdminInitiateAuthOutput {
    ...
    /// <p>To set up SMS or email MFA, collect a <code>phone_number</code> or <code>email</code> attribute for the user. Then restart the authentication flow with an <code>InitiateAuth</code> or <code>AdminInitiateAuth</code> request.</p></li>
    /// </ul>
    pub fn challenge_name(&self) -> ::std::option::Option<&super::super::super::types::ChallengeNameType> {
    ...
    /// <p>The outcome of successful authentication. This is only returned if the user pool has no additional challenges to return. If Amazon Cognito returns another challenge, the response includes <code>ChallengeName</code>, <code>ChallengeParameters</code>, and <code>Session</code> so that your user can answer the challenge.</p>
    pub fn authentication_result(&self) -> ::std::option::Option<&super::super::super::types::AuthenticationResultType> {
    ...
    pub fn available_challenges(&self) -> &[super::super::super::types::ChallengeNameType] {
...
impl AdminInitiateAuthOutput {
    ...
    pub fn builder() -> super::super::super::operation::admin_initiate_auth::builders::AdminInitiateAuthOutputBuilder {
        super::super::super::operation::admin_initiate_auth::builders::AdminInitiateAuthOutputBuilder::default()
    }
}
...
pub struct AdminInitiateAuthOutputBuilder {
    pub(crate) challenge_name: ::std::option::Option<super::super::super::types::ChallengeNameType>,
    ...
    pub(crate) authentication_result: ::std::option::Option<super::super::super::types::AuthenticationResultType>,
    pub(crate) available_challenges: ::std::option::Option<::std::vec::Vec<super::super::super::types::ChallengeNameType>>,
    _request_id: Option<String>,
}
impl AdminInitiateAuthOutputBuilder {
    ...
    /// <p>To set up SMS or email MFA, collect a <code>phone_number</code> or <code>email</code> attribute for the user. Then restart the authentication flow with an <code>InitiateAuth</code> or <code>AdminInitiateAuth</code> request.</p></li>
    /// </ul>
    pub fn challenge_name(mut self, input: super::super::super::types::ChallengeNameType) -> Self {
    ...
    /// <p>To set up SMS or email MFA, collect a <code>phone_number</code> or <code>email</code> attribute for the user. Then restart the authentication flow with an <code>InitiateAuth</code> or <code>AdminInitiateAuth</code> request.</p></li>
    /// </ul>
    pub fn set_challenge_name(mut self, input: ::std::option::Option<super::super::super::types::ChallengeNameType>) -> Self {
    ...
    /// <p>To set up SMS or email MFA, collect a <code>phone_number</code> or <code>email</code> attribute for the user. Then restart the authentication flow with an <code>InitiateAuth</code> or <code>AdminInitiateAuth</code> request.</p></li>
    /// </ul>
    pub fn get_challenge_name(&self) -> &::std::option::Option<super::super::super::types::ChallengeNameType> {
        &self.challenge_name
    }
    /// <p>The session that must be passed to challenge-response requests. If an <code>AdminInitiateAuth</code> or <code>AdminRespondToAuthChallenge</code> API request results in another authentication challenge, Amazon Cognito returns a session ID and the parameters of the next challenge. Pass this session ID in the <code>Session</code> parameter of <code>AdminRespondToAuthChallenge</code>.</p>
    ...
    /// <p>The outcome of successful authentication. This is only returned if the user pool has no additional challenges to return. If Amazon Cognito returns another challenge, the response includes <code>ChallengeName</code>, <code>ChallengeParameters</code>, and <code>Session</code> so that your user can answer the challenge.</p>
    pub fn authentication_result(mut self, input: super::super::super::types::AuthenticationResultType) -> Self {
        self.authentication_result = ::std::option::Option::Some(input);
        self
    }
    /// <p>The outcome of successful authentication. This is only returned if the user pool has no additional challenges to return. If Amazon Cognito returns another challenge, the response includes <code>ChallengeName</code>, <code>ChallengeParameters</code>, and <code>Session</code> so that your user can answer the challenge.</p>
    pub fn set_authentication_result(mut self, input: ::std::option::Option<super::super::super::types::AuthenticationResultType>) -> Self {
        self.authentication_result = input;
        self
    }
    /// <p>The outcome of successful authentication. This is only returned if the user pool has no additional challenges to return. If Amazon Cognito returns another challenge, the response includes <code>ChallengeName</code>, <code>ChallengeParameters</code>, and <code>Session</code> so that your user can answer the challenge.</p>
    pub fn get_authentication_result(&self) -> &::std::option::Option<super::super::super::types::AuthenticationResultType> {
    ...
    ///
    /// <p>This response parameter lists the available authentication challenges that users can select from in <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/authentication-flows-selection-sdk.html#authentication-flows-selection-choice">choice-based authentication</a>. For example, they might be able to choose between passkey authentication, a one-time password from an SMS message, and a traditional password.</p>
    pub fn available_challenges(mut self, input: super::super::super::types::ChallengeNameType) -> Self {
    ...
    /// <p>This response parameter lists the available authentication challenges that users can select from in <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/authentication-flows-selection-sdk.html#authentication-flows-selection-choice">choice-based authentication</a>. For example, they might be able to choose between passkey authentication, a one-time password from an SMS message, and a traditional password.</p>
    pub fn set_available_challenges(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::ChallengeNameType>>) -> Self {
        self.available_challenges = input;
        self
    }
    /// <p>This response parameter lists the available authentication challenges that users can select from in <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/authentication-flows-selection-sdk.html#authentication-flows-selection-choice">choice-based authentication</a>. For example, they might be able to choose between passkey authentication, a one-time password from an SMS message, and a traditional password.</p>
    pub fn get_available_challenges(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::ChallengeNameType>> {
    ...
    pub fn build(self) -> super::super::super::operation::admin_initiate_auth::AdminInitiateAuthOutput {
        super::super::super::operation::admin_initiate_auth::AdminInitiateAuthOutput {
