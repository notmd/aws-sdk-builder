...
impl ChangePasswordInput {
    ...
    pub fn builder() -> super::super::super::operation::change_password::builders::ChangePasswordInputBuilder {
        super::super::super::operation::change_password::builders::ChangePasswordInputBuilder::default()
    }
}
