...
pub struct AdminCreateUserInput {
    ...
    pub message_action: ::std::option::Option<super::super::super::types::MessageActionType>,
    ...
    pub desired_delivery_mediums: ::std::option::Option<::std::vec::Vec<super::super::super::types::DeliveryMediumType>>,
...
impl AdminCreateUserInput {
    ...
    /// <p>Set to <code>RESEND</code> to resend the invitation message to a user that already exists, and to reset the temporary-password duration with a new temporary password. Set to <code>SUPPRESS</code> to suppress sending the message. You can specify only one value.</p>
    pub fn message_action(&self) -> ::std::option::Option<&super::super::super::types::MessageActionType> {
    ...
    pub fn desired_delivery_mediums(&self) -> &[super::super::super::types::DeliveryMediumType] {
...
impl AdminCreateUserInput {
    ...
    pub fn builder() -> super::super::super::operation::admin_create_user::builders::AdminCreateUserInputBuilder {
        super::super::super::operation::admin_create_user::builders::AdminCreateUserInputBuilder::default()
    }
}
...
pub struct AdminCreateUserInputBuilder {
    ...
    pub(crate) message_action: ::std::option::Option<super::super::super::types::MessageActionType>,
    pub(crate) desired_delivery_mediums: ::std::option::Option<::std::vec::Vec<super::super::super::types::DeliveryMediumType>>,
...
impl AdminCreateUserInputBuilder {
    ...
    /// <p>Set to <code>RESEND</code> to resend the invitation message to a user that already exists, and to reset the temporary-password duration with a new temporary password. Set to <code>SUPPRESS</code> to suppress sending the message. You can specify only one value.</p>
    pub fn message_action(mut self, input: super::super::super::types::MessageActionType) -> Self {
        self.message_action = ::std::option::Option::Some(input);
        self
    }
    /// <p>Set to <code>RESEND</code> to resend the invitation message to a user that already exists, and to reset the temporary-password duration with a new temporary password. Set to <code>SUPPRESS</code> to suppress sending the message. You can specify only one value.</p>
    pub fn set_message_action(mut self, input: ::std::option::Option<super::super::super::types::MessageActionType>) -> Self {
        self.message_action = input;
        self
    }
    /// <p>Set to <code>RESEND</code> to resend the invitation message to a user that already exists, and to reset the temporary-password duration with a new temporary password. Set to <code>SUPPRESS</code> to suppress sending the message. You can specify only one value.</p>
    pub fn get_message_action(&self) -> &::std::option::Option<super::super::super::types::MessageActionType> {
        &self.message_action
    }
    ...
    ///
    /// <p>Specify <code>EMAIL</code> if email will be used to send the welcome message. Specify <code>SMS</code> if the phone number will be used. The default value is <code>SMS</code>. You can specify more than one value.</p>
    pub fn desired_delivery_mediums(mut self, input: super::super::super::types::DeliveryMediumType) -> Self {
    ...
    /// <p>Specify <code>EMAIL</code> if email will be used to send the welcome message. Specify <code>SMS</code> if the phone number will be used. The default value is <code>SMS</code>. You can specify more than one value.</p>
    pub fn get_desired_delivery_mediums(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::DeliveryMediumType>> {
