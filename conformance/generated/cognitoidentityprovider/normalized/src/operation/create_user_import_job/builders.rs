...
pub use super::super::super::operation::create_user_import_job::_create_user_import_job_input::CreateUserImportJobInputBuilder;

pub use super::super::super::operation::create_user_import_job::_create_user_import_job_output::CreateUserImportJobOutputBuilder;

impl super::super::super::operation::create_user_import_job::builders::CreateUserImportJobInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::create_user_import_job::CreateUserImportJobOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::create_user_import_job::CreateUserImportJobError,
...
pub struct CreateUserImportJobFluentBuilder {
    ...
    inner: super::super::super::operation::create_user_import_job::builders::CreateUserImportJobInputBuilder,
...
impl CreateUserImportJobFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::create_user_import_job::builders::CreateUserImportJobInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::create_user_import_job::CreateUserImportJob::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::create_user_import_job::CreateUserImportJob::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn password_hashing_algorithm(mut self, input: super::super::super::types::PasswordHashingAlgorithmType) -> Self {
        self.inner = self.inner.password_hashing_algorithm(input);
        self
    }
    /// <p>The password hashing algorithm used to generate the hashes in the CSV file for this import job.</p>
    /// <p>Valid values: <code>BCRYPT</code> | <code>SCRYPT</code> | <code>ARGON2ID</code> | <code>PBKDF2_SHA256</code></p>
    pub fn set_password_hashing_algorithm(mut self, input: ::std::option::Option<super::super::super::types::PasswordHashingAlgorithmType>) -> Self {
        self.inner = self.inner.set_password_hashing_algorithm(input);
        self
    }
    /// <p>The password hashing algorithm used to generate the hashes in the CSV file for this import job.</p>
    /// <p>Valid values: <code>BCRYPT</code> | <code>SCRYPT</code> | <code>ARGON2ID</code> | <code>PBKDF2_SHA256</code></p>
    pub fn get_password_hashing_algorithm(&self) -> &::std::option::Option<super::super::super::types::PasswordHashingAlgorithmType> {
