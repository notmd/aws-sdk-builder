...
pub struct CreateUserImportJobInput {
    ...
    pub password_hashing_algorithm: ::std::option::Option<super::super::super::types::PasswordHashingAlgorithmType>,
}
impl CreateUserImportJobInput {
    ...
    /// <p>The password hashing algorithm used to generate the hashes in the CSV file for this import job.</p>
    /// <p>Valid values: <code>BCRYPT</code> | <code>SCRYPT</code> | <code>ARGON2ID</code> | <code>PBKDF2_SHA256</code></p>
    pub fn password_hashing_algorithm(&self) -> ::std::option::Option<&super::super::super::types::PasswordHashingAlgorithmType> {
...
impl CreateUserImportJobInput {
    ...
    pub fn builder() -> super::super::super::operation::create_user_import_job::builders::CreateUserImportJobInputBuilder {
        super::super::super::operation::create_user_import_job::builders::CreateUserImportJobInputBuilder::default()
    }
}
...
pub struct CreateUserImportJobInputBuilder {
    ...
    pub(crate) password_hashing_algorithm: ::std::option::Option<super::super::super::types::PasswordHashingAlgorithmType>,
}
impl CreateUserImportJobInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::create_user_import_job::CreateUserImportJobInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::create_user_import_job::CreateUserImportJobInput {
