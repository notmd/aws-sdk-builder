...
pub struct AdminListGroupsForUserOutput {
    ...
    pub groups: ::std::option::Option<::std::vec::Vec<super::super::super::types::GroupType>>,
...
impl AdminListGroupsForUserOutput {
    ...
    pub fn groups(&self) -> &[super::super::super::types::GroupType] {
...
impl AdminListGroupsForUserOutput {
    ...
    pub fn builder() -> super::super::super::operation::admin_list_groups_for_user::builders::AdminListGroupsForUserOutputBuilder {
        super::super::super::operation::admin_list_groups_for_user::builders::AdminListGroupsForUserOutputBuilder::default()
    }
}
...
pub struct AdminListGroupsForUserOutputBuilder {
    pub(crate) groups: ::std::option::Option<::std::vec::Vec<super::super::super::types::GroupType>>,
...
impl AdminListGroupsForUserOutputBuilder {
    ...
    ///
    /// <p>An array of groups and information about them.</p>
    pub fn groups(mut self, input: super::super::super::types::GroupType) -> Self {
    ...
    /// <p>An array of groups and information about them.</p>
    pub fn set_groups(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::GroupType>>) -> Self {
        self.groups = input;
        self
    }
    /// <p>An array of groups and information about them.</p>
    pub fn get_groups(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::GroupType>> {
        &self.groups
    }
    /// <p>The identifier that Amazon Cognito returned with the previous request to this operation. When you include a pagination token in your request, Amazon Cognito returns the next set of items in the list. By use of this token, you can paginate through the full list of items.</p>
    ...
    pub fn build(self) -> super::super::super::operation::admin_list_groups_for_user::AdminListGroupsForUserOutput {
