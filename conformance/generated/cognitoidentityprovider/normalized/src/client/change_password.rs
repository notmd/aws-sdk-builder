...
impl super::Client {
    ...
    pub fn change_password(&self) -> super::super::operation::change_password::builders::ChangePasswordFluentBuilder {
        super::super::operation::change_password::builders::ChangePasswordFluentBuilder::new(self.handle.clone())
    }
}
