...
impl super::Client {
    ...
    pub fn get_signing_certificate(&self) -> super::super::operation::get_signing_certificate::builders::GetSigningCertificateFluentBuilder {
        super::super::operation::get_signing_certificate::builders::GetSigningCertificateFluentBuilder::new(self.handle.clone())
    }
}
