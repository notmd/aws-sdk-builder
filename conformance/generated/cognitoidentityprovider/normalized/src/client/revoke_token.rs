...
impl super::Client {
    ...
    pub fn revoke_token(&self) -> super::super::operation::revoke_token::builders::RevokeTokenFluentBuilder {
        super::super::operation::revoke_token::builders::RevokeTokenFluentBuilder::new(self.handle.clone())
    }
}
