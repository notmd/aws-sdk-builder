...
impl super::Client {
    ...
    pub fn delete_resource_server(&self) -> super::super::operation::delete_resource_server::builders::DeleteResourceServerFluentBuilder {
        super::super::operation::delete_resource_server::builders::DeleteResourceServerFluentBuilder::new(self.handle.clone())
    }
}
