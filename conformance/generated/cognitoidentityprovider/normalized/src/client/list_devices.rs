...
impl super::Client {
    ...
    pub fn list_devices(&self) -> super::super::operation::list_devices::builders::ListDevicesFluentBuilder {
        super::super::operation::list_devices::builders::ListDevicesFluentBuilder::new(self.handle.clone())
    }
}
