...
impl super::Client {
    ...
    pub fn describe_user_pool_domain(&self) -> super::super::operation::describe_user_pool_domain::builders::DescribeUserPoolDomainFluentBuilder {
        super::super::operation::describe_user_pool_domain::builders::DescribeUserPoolDomainFluentBuilder::new(self.handle.clone())
    }
}
