...
impl super::Client {
    ...
    pub fn admin_disable_user(&self) -> super::super::operation::admin_disable_user::builders::AdminDisableUserFluentBuilder {
        super::super::operation::admin_disable_user::builders::AdminDisableUserFluentBuilder::new(self.handle.clone())
    }
}
