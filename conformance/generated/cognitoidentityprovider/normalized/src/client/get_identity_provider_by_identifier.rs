...
impl super::Client {
    ...
    pub fn get_identity_provider_by_identifier(
        &self,
    ) -> super::super::operation::get_identity_provider_by_identifier::builders::GetIdentityProviderByIdentifierFluentBuilder {
        super::super::operation::get_identity_provider_by_identifier::builders::GetIdentityProviderByIdentifierFluentBuilder::new(self.handle.clone())
    }
}
