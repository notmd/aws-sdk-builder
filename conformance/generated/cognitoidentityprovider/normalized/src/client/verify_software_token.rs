...
impl super::Client {
    ...
    pub fn verify_software_token(&self) -> super::super::operation::verify_software_token::builders::VerifySoftwareTokenFluentBuilder {
        super::super::operation::verify_software_token::builders::VerifySoftwareTokenFluentBuilder::new(self.handle.clone())
    }
}
