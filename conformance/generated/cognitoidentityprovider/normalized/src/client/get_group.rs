...
impl super::Client {
    ...
    pub fn get_group(&self) -> super::super::operation::get_group::builders::GetGroupFluentBuilder {
        super::super::operation::get_group::builders::GetGroupFluentBuilder::new(self.handle.clone())
    }
}
