...
impl super::Client {
    ...
    ///   - [`group_name(impl Into<String>)`](crate::operation::delete_group::builders::DeleteGroupFluentBuilder::group_name) / [`set_group_name(Option<String>)`](crate::operation::delete_group::builders::DeleteGroupFluentBuilder::set_group_name):<br>required: **true**<br><p>The name of the group that you want to delete.</p><br>
    ...
    pub fn delete_group(&self) -> super::super::operation::delete_group::builders::DeleteGroupFluentBuilder {
        super::super::operation::delete_group::builders::DeleteGroupFluentBuilder::new(self.handle.clone())
    }
}
