...
impl super::Client {
    ...
    pub fn describe_managed_login_branding_by_client(
        &self,
    ) -> super::super::operation::describe_managed_login_branding_by_client::builders::DescribeManagedLoginBrandingByClientFluentBuilder {
        super::super::operation::describe_managed_login_branding_by_client::builders::DescribeManagedLoginBrandingByClientFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
