...
impl super::Client {
    ...
    ///   - [`identity_provider(Option<IdentityProviderType>)`](crate::operation::describe_identity_provider::DescribeIdentityProviderOutput::identity_provider): <p>The details of the requested IdP.</p>
    ...
    pub fn describe_identity_provider(&self) -> super::super::operation::describe_identity_provider::builders::DescribeIdentityProviderFluentBuilder {
        super::super::operation::describe_identity_provider::builders::DescribeIdentityProviderFluentBuilder::new(self.handle.clone())
    }
}
