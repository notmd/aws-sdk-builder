...
impl super::Client {
    ...
    ///   - [`user_pool_id(impl Into<String>)`](crate::operation::admin_user_global_sign_out::builders::AdminUserGlobalSignOutFluentBuilder::user_pool_id) / [`set_user_pool_id(Option<String>)`](crate::operation::admin_user_global_sign_out::builders::AdminUserGlobalSignOutFluentBuilder::set_user_pool_id):<br>required: **true**<br><p>The ID of the user pool where you want to sign out a user.</p><br>
    ...
    pub fn admin_user_global_sign_out(&self) -> super::super::operation::admin_user_global_sign_out::builders::AdminUserGlobalSignOutFluentBuilder {
        super::super::operation::admin_user_global_sign_out::builders::AdminUserGlobalSignOutFluentBuilder::new(self.handle.clone())
    }
}
