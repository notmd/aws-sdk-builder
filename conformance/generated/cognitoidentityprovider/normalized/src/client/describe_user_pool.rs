...
impl super::Client {
    ...
    pub fn describe_user_pool(&self) -> super::super::operation::describe_user_pool::builders::DescribeUserPoolFluentBuilder {
        super::super::operation::describe_user_pool::builders::DescribeUserPoolFluentBuilder::new(self.handle.clone())
    }
}
