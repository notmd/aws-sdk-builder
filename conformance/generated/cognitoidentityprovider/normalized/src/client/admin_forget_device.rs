...
impl super::Client {
    ...
    ///   - [`user_pool_id(impl Into<String>)`](crate::operation::admin_forget_device::builders::AdminForgetDeviceFluentBuilder::user_pool_id) / [`set_user_pool_id(Option<String>)`](crate::operation::admin_forget_device::builders::AdminForgetDeviceFluentBuilder::set_user_pool_id):<br>required: **true**<br><p>The ID of the user pool where the device owner is a user.</p><br>
    ...
    pub fn admin_forget_device(&self) -> super::super::operation::admin_forget_device::builders::AdminForgetDeviceFluentBuilder {
        super::super::operation::admin_forget_device::builders::AdminForgetDeviceFluentBuilder::new(self.handle.clone())
    }
}
