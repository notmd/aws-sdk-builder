...
impl super::Client {
    ...
    pub fn set_user_settings(&self) -> super::super::operation::set_user_settings::builders::SetUserSettingsFluentBuilder {
        super::super::operation::set_user_settings::builders::SetUserSettingsFluentBuilder::new(self.handle.clone())
    }
}
