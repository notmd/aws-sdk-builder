...
impl super::Client {
    ...
    pub fn get_log_delivery_configuration(
        &self,
    ) -> super::super::operation::get_log_delivery_configuration::builders::GetLogDeliveryConfigurationFluentBuilder {
        super::super::operation::get_log_delivery_configuration::builders::GetLogDeliveryConfigurationFluentBuilder::new(self.handle.clone())
    }
}
