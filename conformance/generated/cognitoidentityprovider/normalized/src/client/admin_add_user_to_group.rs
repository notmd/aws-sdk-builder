...
impl super::Client {
    ...
    pub fn admin_add_user_to_group(&self) -> super::super::operation::admin_add_user_to_group::builders::AdminAddUserToGroupFluentBuilder {
        super::super::operation::admin_add_user_to_group::builders::AdminAddUserToGroupFluentBuilder::new(self.handle.clone())
    }
}
