...
impl super::Client {
    ...
    pub fn list_identity_providers(&self) -> super::super::operation::list_identity_providers::builders::ListIdentityProvidersFluentBuilder {
        super::super::operation::list_identity_providers::builders::ListIdentityProvidersFluentBuilder::new(self.handle.clone())
    }
}
