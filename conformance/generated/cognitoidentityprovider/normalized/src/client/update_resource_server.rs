...
impl super::Client {
    ...
    pub fn update_resource_server(&self) -> super::super::operation::update_resource_server::builders::UpdateResourceServerFluentBuilder {
        super::super::operation::update_resource_server::builders::UpdateResourceServerFluentBuilder::new(self.handle.clone())
    }
}
