...
impl super::Client {
    ...
    pub fn list_user_pools(&self) -> super::super::operation::list_user_pools::builders::ListUserPoolsFluentBuilder {
        super::super::operation::list_user_pools::builders::ListUserPoolsFluentBuilder::new(self.handle.clone())
    }
}
