...
impl super::Client {
    ...
    pub fn get_user(&self) -> super::super::operation::get_user::builders::GetUserFluentBuilder {
        super::super::operation::get_user::builders::GetUserFluentBuilder::new(self.handle.clone())
    }
}
