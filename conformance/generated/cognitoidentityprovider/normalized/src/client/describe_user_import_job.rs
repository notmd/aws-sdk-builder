...
impl super::Client {
    ...
    ///   - [`user_import_job(Option<UserImportJobType>)`](crate::operation::describe_user_import_job::DescribeUserImportJobOutput::user_import_job): <p>The details of the user import job. Includes logging destination, status, and the Amazon S3 pre-signed URL for CSV upload.</p>
    ...
    pub fn describe_user_import_job(&self) -> super::super::operation::describe_user_import_job::builders::DescribeUserImportJobFluentBuilder {
        super::super::operation::describe_user_import_job::builders::DescribeUserImportJobFluentBuilder::new(self.handle.clone())
    }
}
