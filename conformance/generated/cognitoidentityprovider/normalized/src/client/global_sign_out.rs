...
impl super::Client {
    ...
    pub fn global_sign_out(&self) -> super::super::operation::global_sign_out::builders::GlobalSignOutFluentBuilder {
        super::super::operation::global_sign_out::builders::GlobalSignOutFluentBuilder::new(self.handle.clone())
    }
}
