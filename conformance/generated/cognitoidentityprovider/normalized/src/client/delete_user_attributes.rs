...
impl super::Client {
    ...
    pub fn delete_user_attributes(&self) -> super::super::operation::delete_user_attributes::builders::DeleteUserAttributesFluentBuilder {
        super::super::operation::delete_user_attributes::builders::DeleteUserAttributesFluentBuilder::new(self.handle.clone())
    }
}
