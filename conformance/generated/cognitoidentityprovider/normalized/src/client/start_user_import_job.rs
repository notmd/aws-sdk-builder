...
impl super::Client {
    ...
    pub fn start_user_import_job(&self) -> super::super::operation::start_user_import_job::builders::StartUserImportJobFluentBuilder {
        super::super::operation::start_user_import_job::builders::StartUserImportJobFluentBuilder::new(self.handle.clone())
    }
}
