...
impl super::Client {
    ...
    pub fn delete_user_pool(&self) -> super::super::operation::delete_user_pool::builders::DeleteUserPoolFluentBuilder {
        super::super::operation::delete_user_pool::builders::DeleteUserPoolFluentBuilder::new(self.handle.clone())
    }
}
