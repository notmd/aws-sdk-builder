...
impl super::Client {
    ...
    pub fn get_ui_customization(&self) -> super::super::operation::get_ui_customization::builders::GetUICustomizationFluentBuilder {
        super::super::operation::get_ui_customization::builders::GetUICustomizationFluentBuilder::new(self.handle.clone())
    }
}
