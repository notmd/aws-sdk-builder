...
impl super::Client {
    ...
    pub fn delete_user(&self) -> super::super::operation::delete_user::builders::DeleteUserFluentBuilder {
        super::super::operation::delete_user::builders::DeleteUserFluentBuilder::new(self.handle.clone())
    }
}
