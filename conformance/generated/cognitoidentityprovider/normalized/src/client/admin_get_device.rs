...
impl super::Client {
    ...
    ///   - [`device_key(impl Into<String>)`](crate::operation::admin_get_device::builders::AdminGetDeviceFluentBuilder::device_key) / [`set_device_key(Option<String>)`](crate::operation::admin_get_device::builders::AdminGetDeviceFluentBuilder::set_device_key):<br>required: **true**<br><p>The key of the device that you want to delete.</p><br>
    ///   - [`user_pool_id(impl Into<String>)`](crate::operation::admin_get_device::builders::AdminGetDeviceFluentBuilder::user_pool_id) / [`set_user_pool_id(Option<String>)`](crate::operation::admin_get_device::builders::AdminGetDeviceFluentBuilder::set_user_pool_id):<br>required: **true**<br><p>The ID of the user pool where the device owner is a user.</p><br>
    ...
    ///   - [`device(Option<DeviceType>)`](crate::operation::admin_get_device::AdminGetDeviceOutput::device): <p>Details of the requested device. Includes device information, last-accessed and created dates, and the device key.</p>
    /// - On failure, responds with [`SdkError<AdminGetDeviceError>`](crate::operation::admin_get_device::AdminGetDeviceError)
    pub fn admin_get_device(&self) -> super::super::operation::admin_get_device::builders::AdminGetDeviceFluentBuilder {
        super::super::operation::admin_get_device::builders::AdminGetDeviceFluentBuilder::new(self.handle.clone())
    }
}
