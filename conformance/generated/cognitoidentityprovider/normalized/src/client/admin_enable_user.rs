...
impl super::Client {
    ...
    pub fn admin_enable_user(&self) -> super::super::operation::admin_enable_user::builders::AdminEnableUserFluentBuilder {
        super::super::operation::admin_enable_user::builders::AdminEnableUserFluentBuilder::new(self.handle.clone())
    }
}
