...
impl PolicyDescriptorType {
    ...
    pub fn builder() -> super::super::types::builders::PolicyDescriptorTypeBuilder {
        super::super::types::builders::PolicyDescriptorTypeBuilder::default()
    }
}
...
impl PolicyDescriptorTypeBuilder {
    ...
    pub fn build(self) -> super::super::types::PolicyDescriptorType {
        super::super::types::PolicyDescriptorType { arn: self.arn }
    }
}
