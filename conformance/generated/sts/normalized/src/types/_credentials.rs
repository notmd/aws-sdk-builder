...
impl Credentials {
    ...
    pub fn builder() -> super::super::types::builders::CredentialsBuilder {
        super::super::types::builders::CredentialsBuilder::default()
    }
}
...
impl CredentialsBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::Credentials, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::Credentials {
