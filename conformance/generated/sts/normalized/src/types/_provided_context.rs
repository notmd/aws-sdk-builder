...
impl ProvidedContext {
    ...
    pub fn builder() -> super::super::types::builders::ProvidedContextBuilder {
        super::super::types::builders::ProvidedContextBuilder::default()
    }
}
...
impl ProvidedContextBuilder {
    ...
    pub fn build(self) -> super::super::types::ProvidedContext {
        super::super::types::ProvidedContext {
