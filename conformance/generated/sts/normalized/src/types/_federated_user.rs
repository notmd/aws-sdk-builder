...
impl FederatedUser {
    ...
    pub fn builder() -> super::super::types::builders::FederatedUserBuilder {
        super::super::types::builders::FederatedUserBuilder::default()
    }
}
...
impl FederatedUserBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::FederatedUser, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::FederatedUser {
