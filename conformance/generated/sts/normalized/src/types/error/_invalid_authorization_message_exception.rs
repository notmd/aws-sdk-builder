...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::InvalidAuthorizationMessageException {
...
impl InvalidAuthorizationMessageException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::InvalidAuthorizationMessageExceptionBuilder {
        super::super::super::types::error::builders::InvalidAuthorizationMessageExceptionBuilder::default()
    }
}
...
impl InvalidAuthorizationMessageExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::InvalidAuthorizationMessageException {
        super::super::super::types::error::InvalidAuthorizationMessageException {
