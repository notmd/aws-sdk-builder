...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::RegionDisabledException {
...
impl RegionDisabledException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::RegionDisabledExceptionBuilder {
        super::super::super::types::error::builders::RegionDisabledExceptionBuilder::default()
    }
}
...
impl RegionDisabledExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::RegionDisabledException {
        super::super::super::types::error::RegionDisabledException {
