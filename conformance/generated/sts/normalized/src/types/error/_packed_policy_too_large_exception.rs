...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::PackedPolicyTooLargeException {
...
impl PackedPolicyTooLargeException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::PackedPolicyTooLargeExceptionBuilder {
        super::super::super::types::error::builders::PackedPolicyTooLargeExceptionBuilder::default()
    }
}
...
impl PackedPolicyTooLargeExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::PackedPolicyTooLargeException {
        super::super::super::types::error::PackedPolicyTooLargeException {
