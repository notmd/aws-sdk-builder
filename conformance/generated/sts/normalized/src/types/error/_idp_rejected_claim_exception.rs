...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::IdpRejectedClaimException {
...
impl IdpRejectedClaimException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::IdpRejectedClaimExceptionBuilder {
        super::super::super::types::error::builders::IdpRejectedClaimExceptionBuilder::default()
    }
}
...
impl IdpRejectedClaimExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::IdpRejectedClaimException {
        super::super::super::types::error::IdpRejectedClaimException {
