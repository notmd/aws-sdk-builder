...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::InvalidIdentityTokenException {
...
impl InvalidIdentityTokenException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::InvalidIdentityTokenExceptionBuilder {
        super::super::super::types::error::builders::InvalidIdentityTokenExceptionBuilder::default()
    }
}
...
impl InvalidIdentityTokenExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::InvalidIdentityTokenException {
        super::super::super::types::error::InvalidIdentityTokenException {
