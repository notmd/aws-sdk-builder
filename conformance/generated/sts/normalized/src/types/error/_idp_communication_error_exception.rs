...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::IdpCommunicationErrorException {
...
impl IdpCommunicationErrorException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::IdpCommunicationErrorExceptionBuilder {
        super::super::super::types::error::builders::IdpCommunicationErrorExceptionBuilder::default()
    }
}
...
impl IdpCommunicationErrorExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::IdpCommunicationErrorException {
        super::super::super::types::error::IdpCommunicationErrorException {
