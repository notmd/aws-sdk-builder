...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::ExpiredTokenException {
...
impl ExpiredTokenException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::ExpiredTokenExceptionBuilder {
        super::super::super::types::error::builders::ExpiredTokenExceptionBuilder::default()
    }
}
...
impl ExpiredTokenExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::ExpiredTokenException {
        super::super::super::types::error::ExpiredTokenException {
