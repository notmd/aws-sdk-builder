...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(super::super::operation::get_delegated_access_token::GetDelegatedAccessTokenError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "ExpiredTradeInTokenException" => super::super::operation::get_delegated_access_token::GetDelegatedAccessTokenError::ExpiredTradeInTokenException({
            ...
            let mut tmp = {
                ...
                output = super::super::protocol_serde::shape_expired_trade_in_token_exception::de_expired_trade_in_token_exception_xml_err(
                    _response_body,
                    output,
                )
                .map_err(super::super::operation::get_delegated_access_token::GetDelegatedAccessTokenError::unhandled)?;
...
pub fn de_get_delegated_access_token(
    ...
    super::super::operation::get_delegated_access_token::builders::GetDelegatedAccessTokenOutputBuilder,
