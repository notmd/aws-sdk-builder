    ...
    Err(match error_code {
        ...
        "IDPCommunicationError" => super::super::operation::assume_role_with_web_identity::AssumeRoleWithWebIdentityError::IdpCommunicationErrorException({
            ...
            let mut tmp = {
                ...
                output = super::super::protocol_serde::shape_idp_communication_error_exception::de_idp_communication_error_exception_xml_err(
                    _response_body,
                    output,
                )
                .map_err(super::super::operation::assume_role_with_web_identity::AssumeRoleWithWebIdentityError::unhandled)?;
        ...
        "InvalidIdentityToken" => super::super::operation::assume_role_with_web_identity::AssumeRoleWithWebIdentityError::InvalidIdentityTokenException({
            ...
            let mut tmp = {
                ...
                output = super::super::protocol_serde::shape_invalid_identity_token_exception::de_invalid_identity_token_exception_xml_err(
                    _response_body,
                    output,
                )
                .map_err(super::super::operation::assume_role_with_web_identity::AssumeRoleWithWebIdentityError::unhandled)?;
        ...
        "MalformedPolicyDocument" => {
            super::super::operation::assume_role_with_web_identity::AssumeRoleWithWebIdentityError::MalformedPolicyDocumentException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "PackedPolicyTooLarge" => super::super::operation::assume_role_with_web_identity::AssumeRoleWithWebIdentityError::PackedPolicyTooLargeException({
            ...
            let mut tmp = {
                ...
                output = super::super::protocol_serde::shape_packed_policy_too_large_exception::de_packed_policy_too_large_exception_xml_err(
                    _response_body,
                    output,
                )
                .map_err(super::super::operation::assume_role_with_web_identity::AssumeRoleWithWebIdentityError::unhandled)?;
...
pub fn de_assume_role_with_web_identity(
    ...
    super::super::operation::assume_role_with_web_identity::builders::AssumeRoleWithWebIdentityOutputBuilder,
...
> {
    ...
    if !(start_el.matches("AssumeRoleWithWebIdentityResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected AssumeRoleWithWebIdentityResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("AssumeRoleWithWebIdentityResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected AssumeRoleWithWebIdentityResult got {start_el:?}"
            )));
        }
