...
impl AssumeRole {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::super::operation::assume_role::AssumeRoleOutput,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::assume_role::AssumeRoleError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::assume_role::AssumeRoleOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AssumeRoleResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_assume_role::de_assume_role_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_assume_role::de_assume_role_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssumeRoleRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::assume_role::AssumeRoleInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::assume_role::AssumeRoleError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::assume_role::_assume_role_input::AssumeRoleInput;

pub use super::super::operation::assume_role::_assume_role_output::AssumeRoleOutput;
