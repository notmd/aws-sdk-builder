...
impl GetSessionTokenInput {
    ...
    pub fn builder() -> super::super::super::operation::get_session_token::builders::GetSessionTokenInputBuilder {
        super::super::super::operation::get_session_token::builders::GetSessionTokenInputBuilder::default()
    }
}
