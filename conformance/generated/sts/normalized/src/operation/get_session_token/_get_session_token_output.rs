...
impl GetSessionTokenOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_session_token::builders::GetSessionTokenOutputBuilder {
        super::super::super::operation::get_session_token::builders::GetSessionTokenOutputBuilder::default()
    }
}
...
impl GetSessionTokenOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::get_session_token::GetSessionTokenOutput {
