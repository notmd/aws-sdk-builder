    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::assume_role_with_saml::AssumeRoleWithSAMLError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::assume_role_with_saml::AssumeRoleWithSamlOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AssumeRoleWithSAMLResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_assume_role_with_saml::de_assume_role_with_saml_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_assume_role_with_saml::de_assume_role_with_saml_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssumeRoleWithSAMLRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::assume_role_with_saml::AssumeRoleWithSamlInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::assume_role_with_saml::AssumeRoleWithSamlInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::assume_role_with_saml::AssumeRoleWithSAMLError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::assume_role_with_saml::_assume_role_with_saml_input::AssumeRoleWithSamlInput;

pub use super::super::operation::assume_role_with_saml::_assume_role_with_saml_output::AssumeRoleWithSamlOutput;
