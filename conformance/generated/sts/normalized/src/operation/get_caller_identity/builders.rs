...
pub use super::super::super::operation::get_caller_identity::_get_caller_identity_input::GetCallerIdentityInputBuilder;

pub use super::super::super::operation::get_caller_identity::_get_caller_identity_output::GetCallerIdentityOutputBuilder;

impl super::super::super::operation::get_caller_identity::builders::GetCallerIdentityInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::get_caller_identity::GetCallerIdentityOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::get_caller_identity::GetCallerIdentityError,
...
pub struct GetCallerIdentityFluentBuilder {
    ...
    inner: super::super::super::operation::get_caller_identity::builders::GetCallerIdentityInputBuilder,
...
impl GetCallerIdentityFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::get_caller_identity::builders::GetCallerIdentityInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::get_caller_identity::GetCallerIdentity::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::get_caller_identity::GetCallerIdentity::orchestrate(&runtime_plugins, input).await
    }
