...
impl GetCallerIdentityInput {
    ...
    pub fn builder() -> super::super::super::operation::get_caller_identity::builders::GetCallerIdentityInputBuilder {
        super::super::super::operation::get_caller_identity::builders::GetCallerIdentityInputBuilder::default()
    }
}
