...
impl GetCallerIdentityOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_caller_identity::builders::GetCallerIdentityOutputBuilder {
        super::super::super::operation::get_caller_identity::builders::GetCallerIdentityOutputBuilder::default()
    }
}
...
impl GetCallerIdentityOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::get_caller_identity::GetCallerIdentityOutput {
