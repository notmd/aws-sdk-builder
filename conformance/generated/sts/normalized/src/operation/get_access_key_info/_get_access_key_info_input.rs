...
impl GetAccessKeyInfoInput {
    ...
    pub fn builder() -> super::super::super::operation::get_access_key_info::builders::GetAccessKeyInfoInputBuilder {
        super::super::super::operation::get_access_key_info::builders::GetAccessKeyInfoInputBuilder::default()
    }
}
