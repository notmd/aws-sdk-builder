...
pub use super::super::super::operation::get_access_key_info::_get_access_key_info_input::GetAccessKeyInfoInputBuilder;

pub use super::super::super::operation::get_access_key_info::_get_access_key_info_output::GetAccessKeyInfoOutputBuilder;

impl super::super::super::operation::get_access_key_info::builders::GetAccessKeyInfoInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::get_access_key_info::GetAccessKeyInfoOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::get_access_key_info::GetAccessKeyInfoError,
...
pub struct GetAccessKeyInfoFluentBuilder {
    ...
    inner: super::super::super::operation::get_access_key_info::builders::GetAccessKeyInfoInputBuilder,
...
impl GetAccessKeyInfoFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::get_access_key_info::builders::GetAccessKeyInfoInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::get_access_key_info::GetAccessKeyInfo::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::get_access_key_info::GetAccessKeyInfo::orchestrate(&runtime_plugins, input).await
    }
