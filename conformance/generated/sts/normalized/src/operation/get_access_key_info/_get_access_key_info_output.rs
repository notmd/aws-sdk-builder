...
impl GetAccessKeyInfoOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_access_key_info::builders::GetAccessKeyInfoOutputBuilder {
        super::super::super::operation::get_access_key_info::builders::GetAccessKeyInfoOutputBuilder::default()
    }
}
...
impl GetAccessKeyInfoOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::get_access_key_info::GetAccessKeyInfoOutput {
