...
impl DecodeAuthorizationMessageInput {
    ...
    pub fn builder() -> super::super::super::operation::decode_authorization_message::builders::DecodeAuthorizationMessageInputBuilder {
        super::super::super::operation::decode_authorization_message::builders::DecodeAuthorizationMessageInputBuilder::default()
    }
}
