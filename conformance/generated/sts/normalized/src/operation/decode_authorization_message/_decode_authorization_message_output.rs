...
impl DecodeAuthorizationMessageOutput {
    ...
    pub fn builder() -> super::super::super::operation::decode_authorization_message::builders::DecodeAuthorizationMessageOutputBuilder {
        super::super::super::operation::decode_authorization_message::builders::DecodeAuthorizationMessageOutputBuilder::default()
    }
}
...
impl DecodeAuthorizationMessageOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::decode_authorization_message::DecodeAuthorizationMessageOutput {
