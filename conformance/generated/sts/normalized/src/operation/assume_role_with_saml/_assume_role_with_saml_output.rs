...
impl AssumeRoleWithSamlOutput {
    ...
    pub fn builder() -> super::super::super::operation::assume_role_with_saml::builders::AssumeRoleWithSamlOutputBuilder {
        super::super::super::operation::assume_role_with_saml::builders::AssumeRoleWithSamlOutputBuilder::default()
    }
}
...
impl AssumeRoleWithSamlOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::assume_role_with_saml::AssumeRoleWithSamlOutput {
