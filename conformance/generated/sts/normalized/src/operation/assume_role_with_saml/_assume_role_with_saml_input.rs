...
impl AssumeRoleWithSamlInput {
    ...
    pub fn builder() -> super::super::super::operation::assume_role_with_saml::builders::AssumeRoleWithSamlInputBuilder {
        super::super::super::operation::assume_role_with_saml::builders::AssumeRoleWithSamlInputBuilder::default()
    }
}
