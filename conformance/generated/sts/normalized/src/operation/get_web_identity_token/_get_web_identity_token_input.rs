...
impl GetWebIdentityTokenInput {
    ...
    pub fn builder() -> super::super::super::operation::get_web_identity_token::builders::GetWebIdentityTokenInputBuilder {
        super::super::super::operation::get_web_identity_token::builders::GetWebIdentityTokenInputBuilder::default()
    }
}
