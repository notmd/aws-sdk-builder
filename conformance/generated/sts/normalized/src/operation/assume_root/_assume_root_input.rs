...
impl AssumeRootInput {
    ...
    /// <p><a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/security-iam-awsmanpol.html#security-iam-awsmanpol-SQSUnlockQueuePolicy">SQSUnlockQueuePolicy</a></p></li>
    /// </ul>
    pub fn task_policy_arn(&self) -> ::std::option::Option<&super::super::super::types::PolicyDescriptorType> {
...
impl AssumeRootInput {
    ...
    pub fn builder() -> super::super::super::operation::assume_root::builders::AssumeRootInputBuilder {
        super::super::super::operation::assume_root::builders::AssumeRootInputBuilder::default()
    }
}
...
pub struct AssumeRootInputBuilder {
    ...
    pub(crate) task_policy_arn: ::std::option::Option<super::super::super::types::PolicyDescriptorType>,
