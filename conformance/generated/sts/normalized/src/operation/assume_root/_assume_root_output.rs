...
impl AssumeRootOutput {
    ...
    pub fn builder() -> super::super::super::operation::assume_root::builders::AssumeRootOutputBuilder {
        super::super::super::operation::assume_root::builders::AssumeRootOutputBuilder::default()
    }
}
...
impl AssumeRootOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::assume_root::AssumeRootOutput {
