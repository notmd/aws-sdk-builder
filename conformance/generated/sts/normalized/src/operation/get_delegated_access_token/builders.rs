...
pub use super::super::super::operation::get_delegated_access_token::_get_delegated_access_token_input::GetDelegatedAccessTokenInputBuilder;

pub use super::super::super::operation::get_delegated_access_token::_get_delegated_access_token_output::GetDelegatedAccessTokenOutputBuilder;

impl super::super::super::operation::get_delegated_access_token::builders::GetDelegatedAccessTokenInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::get_delegated_access_token::GetDelegatedAccessTokenOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::get_delegated_access_token::GetDelegatedAccessTokenError,
...
pub struct GetDelegatedAccessTokenFluentBuilder {
    ...
    inner: super::super::super::operation::get_delegated_access_token::builders::GetDelegatedAccessTokenInputBuilder,
...
impl GetDelegatedAccessTokenFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::get_delegated_access_token::builders::GetDelegatedAccessTokenInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::get_delegated_access_token::GetDelegatedAccessToken::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::get_delegated_access_token::GetDelegatedAccessToken::orchestrate(&runtime_plugins, input).await
    }
