...
impl GetDelegatedAccessTokenOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_delegated_access_token::builders::GetDelegatedAccessTokenOutputBuilder {
        super::super::super::operation::get_delegated_access_token::builders::GetDelegatedAccessTokenOutputBuilder::default()
    }
}
...
impl GetDelegatedAccessTokenOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::get_delegated_access_token::GetDelegatedAccessTokenOutput {
