...
impl GetDelegatedAccessTokenInput {
    ...
    pub fn builder() -> super::super::super::operation::get_delegated_access_token::builders::GetDelegatedAccessTokenInputBuilder {
        super::super::super::operation::get_delegated_access_token::builders::GetDelegatedAccessTokenInputBuilder::default()
    }
}
...
impl GetDelegatedAccessTokenInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::get_delegated_access_token::GetDelegatedAccessTokenInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::get_delegated_access_token::GetDelegatedAccessTokenInput {
