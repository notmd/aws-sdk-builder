...
impl GetFederationTokenOutput {
    ...
    /// <p>Identifiers for the federated user associated with the credentials (such as <code>arn:aws:sts::123456789012:federated-user/Bob</code> or <code>123456789012:Bob</code>). You can use the federated user's ARN in your resource-based policies, such as an Amazon S3 bucket policy.</p>
    pub fn federated_user(&self) -> ::std::option::Option<&super::super::super::types::FederatedUser> {
...
impl GetFederationTokenOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_federation_token::builders::GetFederationTokenOutputBuilder {
        super::super::super::operation::get_federation_token::builders::GetFederationTokenOutputBuilder::default()
    }
}
...
pub struct GetFederationTokenOutputBuilder {
    ...
    pub(crate) federated_user: ::std::option::Option<super::super::super::types::FederatedUser>,
...
impl GetFederationTokenOutputBuilder {
    ...
    /// <p>Identifiers for the federated user associated with the credentials (such as <code>arn:aws:sts::123456789012:federated-user/Bob</code> or <code>123456789012:Bob</code>). You can use the federated user's ARN in your resource-based policies, such as an Amazon S3 bucket policy.</p>
    pub fn federated_user(mut self, input: super::super::super::types::FederatedUser) -> Self {
        self.federated_user = ::std::option::Option::Some(input);
        self
    }
    /// <p>Identifiers for the federated user associated with the credentials (such as <code>arn:aws:sts::123456789012:federated-user/Bob</code> or <code>123456789012:Bob</code>). You can use the federated user's ARN in your resource-based policies, such as an Amazon S3 bucket policy.</p>
    pub fn set_federated_user(mut self, input: ::std::option::Option<super::super::super::types::FederatedUser>) -> Self {
        self.federated_user = input;
        self
    }
    /// <p>Identifiers for the federated user associated with the credentials (such as <code>arn:aws:sts::123456789012:federated-user/Bob</code> or <code>123456789012:Bob</code>). You can use the federated user's ARN in your resource-based policies, such as an Amazon S3 bucket policy.</p>
    pub fn get_federated_user(&self) -> &::std::option::Option<super::super::super::types::FederatedUser> {
        &self.federated_user
    }
    /// <p>A percentage value that indicates the packed size of the session policies and session tags combined passed in the request. The request fails if the packed size is greater than 100 percent, which means the policies and tags exceeded the allowed space.</p>
    ...
    pub fn build(self) -> super::super::super::operation::get_federation_token::GetFederationTokenOutput {
