...
impl super::Client {
    ...
    pub fn get_access_key_info(&self) -> super::super::operation::get_access_key_info::builders::GetAccessKeyInfoFluentBuilder {
        super::super::operation::get_access_key_info::builders::GetAccessKeyInfoFluentBuilder::new(self.handle.clone())
    }
}
