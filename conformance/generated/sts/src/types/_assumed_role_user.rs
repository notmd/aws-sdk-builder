...
impl AssumedRoleUser {
    ...
    pub fn builder() -> super::types::builders::AssumedRoleUserBuilder {
        super::types::builders::AssumedRoleUserBuilder::default()
    }
}
...
impl AssumedRoleUserBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::AssumedRoleUser, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::AssumedRoleUser {
