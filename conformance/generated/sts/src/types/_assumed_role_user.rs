...
impl AssumedRoleUserBuilder {
    ...
    pub fn set_assumed_role_id(mut self, input: ::std::option::Option<::std::string::String>) -> Self { self.assumed_role_id = input; self }
    /// <p>A unique identifier that contains the role ID and the role session name of the role that is being assumed. The role ID is generated by Amazon Web Services when the role is created.</p>
    pub fn get_assumed_role_id(&self) -> &::std::option::Option<::std::string::String> { &self.assumed_role_id }
    /// <p>The ARN of the temporary security credentials that are returned from the <a>AssumeRole</a> action. For more information about ARNs and how to use them in policies, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_identifiers.html">IAM Identifiers</a> in the <i>IAM User Guide</i>.</p>
    /// This field is required.
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::AssumedRoleUser, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::AssumedRoleUser {
            assumed_role_id: self.assumed_role_id.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("assumed_role_id", "assumed_role_id was not specified but it is required when building AssumedRoleUser"))?,
            arn: self.arn.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("arn", "arn was not specified but it is required when building AssumedRoleUser"))?,
        })
    }
}
