...
impl Credentials {
    ...
    pub fn builder() -> super::types::builders::CredentialsBuilder {
        super::types::builders::CredentialsBuilder::default()
    }
}
...
impl CredentialsBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::Credentials, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::Credentials {
