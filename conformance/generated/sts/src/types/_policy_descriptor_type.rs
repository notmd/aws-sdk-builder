...
impl PolicyDescriptorType {
    ...
    pub fn builder() -> super::types::builders::PolicyDescriptorTypeBuilder {
        super::types::builders::PolicyDescriptorTypeBuilder::default()
    }
}
...
impl PolicyDescriptorTypeBuilder {
    ...
    pub fn build(self) -> super::types::PolicyDescriptorType {
        super::types::PolicyDescriptorType { arn: self.arn }
    }
}
