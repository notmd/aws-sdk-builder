...
impl super::Client {
    ...
    pub fn get_caller_identity(&self) -> super::operation::get_caller_identity::builders::GetCallerIdentityFluentBuilder {
        super::operation::get_caller_identity::builders::GetCallerIdentityFluentBuilder::new(self.handle.clone())
    }
}
