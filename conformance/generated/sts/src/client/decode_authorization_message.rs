...
impl super::Client {
    ...
    pub fn decode_authorization_message(&self) -> super::operation::decode_authorization_message::builders::DecodeAuthorizationMessageFluentBuilder {
        super::operation::decode_authorization_message::builders::DecodeAuthorizationMessageFluentBuilder::new(self.handle.clone())
    }
}
