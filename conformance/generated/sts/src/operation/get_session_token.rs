...
impl GetSessionToken {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::get_session_token::GetSessionTokenInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_session_token::GetSessionTokenError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_session_token::GetSessionTokenOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetSessionTokenResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_session_token::de_get_session_token_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_session_token::de_get_session_token_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetSessionTokenRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_session_token::GetSessionTokenInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_session_token::GetSessionTokenInput,
...
impl ::aws_types::request_id::RequestId for super::operation::get_session_token::GetSessionTokenError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_session_token::_get_session_token_input::GetSessionTokenInput;

pub use super::operation::get_session_token::_get_session_token_output::GetSessionTokenOutput;
