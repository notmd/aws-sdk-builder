...
impl GetFederationTokenInput {
    ...
    pub fn builder() -> super::operation::get_federation_token::builders::GetFederationTokenInputBuilder {
        super::operation::get_federation_token::builders::GetFederationTokenInputBuilder::default()
    }
}
...
impl GetFederationTokenInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_federation_token::GetFederationTokenInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::get_federation_token::GetFederationTokenInput {
            name: self.name,
            policy: self.policy,
