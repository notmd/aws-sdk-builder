...
impl AssumeRoleWithSamlOutput {
    ...
    pub fn builder() -> super::operation::assume_role_with_saml::builders::AssumeRoleWithSamlOutputBuilder {
        super::operation::assume_role_with_saml::builders::AssumeRoleWithSamlOutputBuilder::default()
    }
}
...
impl AssumeRoleWithSamlOutputBuilder {
    ...
    pub fn build(self) -> super::operation::assume_role_with_saml::AssumeRoleWithSamlOutput {
