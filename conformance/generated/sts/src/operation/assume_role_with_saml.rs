...
pub mod _assume_role_with_saml_input {
    include!(concat!(env!("OUT_DIR"), "/generated/sts/src/operation/assume_role_with_saml/_assume_role_with_saml_input.rs"));
}
...
pub mod _assume_role_with_saml_output {
    include!(concat!(env!("OUT_DIR"), "/generated/sts/src/operation/assume_role_with_saml/_assume_role_with_saml_output.rs"));
}
