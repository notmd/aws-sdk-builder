...
pub struct AssumeRoleInput {
    ...
    pub provided_contexts: ::std::option::Option<::std::vec::Vec<super::types::ProvidedContext>>,
}
impl AssumeRoleInput {
    ...
    pub fn provided_contexts(&self) -> &[super::types::ProvidedContext] {
...
impl AssumeRoleInput {
    ...
    pub fn builder() -> super::operation::assume_role::builders::AssumeRoleInputBuilder {
        super::operation::assume_role::builders::AssumeRoleInputBuilder::default()
    }
}
...
pub struct AssumeRoleInputBuilder {
    ...
    pub(crate) provided_contexts: ::std::option::Option<::std::vec::Vec<super::types::ProvidedContext>>,
}
impl AssumeRoleInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::assume_role::AssumeRoleInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::assume_role::AssumeRoleInput {
