...
impl AssumeRoleOutput {
    ...
    pub fn builder() -> super::operation::assume_role::builders::AssumeRoleOutputBuilder {
        super::operation::assume_role::builders::AssumeRoleOutputBuilder::default()
    }
}
...
impl AssumeRoleOutputBuilder {
    ...
    pub fn build(self) -> super::operation::assume_role::AssumeRoleOutput {
