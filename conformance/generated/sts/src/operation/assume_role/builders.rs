...
pub use super::operation::assume_role::_assume_role_input::AssumeRoleInputBuilder;

pub use super::operation::assume_role::_assume_role_output::AssumeRoleOutputBuilder;

impl super::operation::assume_role::builders::AssumeRoleInputBuilder {
...
pub struct AssumeRoleFluentBuilder {
    ...
    inner: super::operation::assume_role::builders::AssumeRoleInputBuilder,
...
impl AssumeRoleFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::assume_role::builders::AssumeRoleInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::assume_role::AssumeRole::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::assume_role::AssumeRole::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn provided_contexts(mut self, input: super::types::ProvidedContext) -> Self {
    ...
    /// <p>The following is an example of a <code>ProvidedContext</code> value that includes a single trusted context assertion and the ARN of the context provider from which the trusted context assertion was generated.</p>
    /// <p><code>\[{"ProviderArn":"arn:aws:iam::aws:contextProvider/IdentityCenter","ContextAssertion":"trusted-context-assertion"}\]</code></p>
    pub fn set_provided_contexts(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::ProvidedContext>>) -> Self {
    ...
    /// <p>The following is an example of a <code>ProvidedContext</code> value that includes a single trusted context assertion and the ARN of the context provider from which the trusted context assertion was generated.</p>
    /// <p><code>\[{"ProviderArn":"arn:aws:iam::aws:contextProvider/IdentityCenter","ContextAssertion":"trusted-context-assertion"}\]</code></p>
    pub fn get_provided_contexts(&self) -> &::std::option::Option<::std::vec::Vec<super::types::ProvidedContext>> {
