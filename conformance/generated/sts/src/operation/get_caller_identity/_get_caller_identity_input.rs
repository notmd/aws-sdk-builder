...
impl GetCallerIdentityInput {
    ...
    pub fn builder() -> super::operation::get_caller_identity::builders::GetCallerIdentityInputBuilder {
        super::operation::get_caller_identity::builders::GetCallerIdentityInputBuilder::default()
    }
}
...
impl GetCallerIdentityInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_caller_identity::GetCallerIdentityInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_caller_identity::GetCallerIdentityInput {})
    }
}
