...
impl AssumeRoleWithWebIdentity {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::assume_role_with_web_identity::AssumeRoleWithWebIdentityInput,
    ) -> ::std::result::Result<
        super::operation::assume_role_with_web_identity::AssumeRoleWithWebIdentityOutput,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::assume_role_with_web_identity::AssumeRoleWithWebIdentityError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::assume_role_with_web_identity::AssumeRoleWithWebIdentityOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AssumeRoleWithWebIdentityResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_assume_role_with_web_identity::de_assume_role_with_web_identity_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_assume_role_with_web_identity::de_assume_role_with_web_identity_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssumeRoleWithWebIdentityRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::assume_role_with_web_identity::AssumeRoleWithWebIdentityInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::assume_role_with_web_identity::AssumeRoleWithWebIdentityInput,
...
impl ::aws_types::request_id::RequestId for super::operation::assume_role_with_web_identity::AssumeRoleWithWebIdentityError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::assume_role_with_web_identity::_assume_role_with_web_identity_input::AssumeRoleWithWebIdentityInput;

pub use super::operation::assume_role_with_web_identity::_assume_role_with_web_identity_output::AssumeRoleWithWebIdentityOutput;
