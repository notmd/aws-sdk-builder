...
impl GetCallerIdentity {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::get_caller_identity::GetCallerIdentityInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_caller_identity::GetCallerIdentityError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_caller_identity::GetCallerIdentityOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetCallerIdentityResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_caller_identity::de_get_caller_identity_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_caller_identity::de_get_caller_identity_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetCallerIdentityRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_caller_identity::GetCallerIdentityInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_caller_identity::GetCallerIdentityInput,
...
impl ::aws_types::request_id::RequestId for super::operation::get_caller_identity::GetCallerIdentityError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_caller_identity::_get_caller_identity_input::GetCallerIdentityInput;

pub use super::operation::get_caller_identity::_get_caller_identity_output::GetCallerIdentityOutput;
