...
impl GetDelegatedAccessToken {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::get_delegated_access_token::GetDelegatedAccessTokenInput,
    ) -> ::std::result::Result<
        super::operation::get_delegated_access_token::GetDelegatedAccessTokenOutput,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_delegated_access_token::GetDelegatedAccessTokenError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_delegated_access_token::GetDelegatedAccessTokenOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetDelegatedAccessTokenResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_delegated_access_token::de_get_delegated_access_token_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_delegated_access_token::de_get_delegated_access_token_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetDelegatedAccessTokenRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_delegated_access_token::GetDelegatedAccessTokenInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_delegated_access_token::GetDelegatedAccessTokenInput,
...
impl ::aws_types::request_id::RequestId for super::operation::get_delegated_access_token::GetDelegatedAccessTokenError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_delegated_access_token::_get_delegated_access_token_input::GetDelegatedAccessTokenInput;

pub use super::operation::get_delegated_access_token::_get_delegated_access_token_output::GetDelegatedAccessTokenOutput;
