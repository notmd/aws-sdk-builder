    ...
    pub fn build(self) -> super::Input { self.input }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::GetDelegatedAccessTokenOutput, super::GetDelegatedAccessTokenError> {
                         ...
                         if !status.is_success() {
                             return Err(super::GetDelegatedAccessTokenError::unhandled_with_request_ids(format!("GetDelegatedAccessToken returned HTTP {}", status), response.header("x-amzn-requestid").map(str::to_owned), ::std::option::Option::None));
                         }
