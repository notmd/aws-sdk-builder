...
impl GetDelegatedAccessTokenOutput {
    ...
    pub fn builder() -> super::operation::get_delegated_access_token::builders::GetDelegatedAccessTokenOutputBuilder {
        super::operation::get_delegated_access_token::builders::GetDelegatedAccessTokenOutputBuilder::default()
    }
}
...
impl GetDelegatedAccessTokenOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_delegated_access_token::GetDelegatedAccessTokenOutput {
