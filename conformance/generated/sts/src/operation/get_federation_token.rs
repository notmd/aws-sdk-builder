...
impl GetFederationToken {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::get_federation_token::GetFederationTokenInput,
    ) -> ::std::result::Result<
        super::operation::get_federation_token::GetFederationTokenOutput,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_federation_token::GetFederationTokenError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_federation_token::GetFederationTokenOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetFederationTokenResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_federation_token::de_get_federation_token_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_federation_token::de_get_federation_token_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetFederationTokenRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_federation_token::GetFederationTokenInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_federation_token::GetFederationTokenInput,
...
impl ::aws_types::request_id::RequestId for super::operation::get_federation_token::GetFederationTokenError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_federation_token::_get_federation_token_input::GetFederationTokenInput;

pub use super::operation::get_federation_token::_get_federation_token_output::GetFederationTokenOutput;
