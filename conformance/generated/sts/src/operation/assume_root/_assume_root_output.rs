...
impl AssumeRootOutput {
    ...
    pub fn builder() -> super::operation::assume_root::builders::AssumeRootOutputBuilder {
        super::operation::assume_root::builders::AssumeRootOutputBuilder::default()
    }
}
...
impl AssumeRootOutputBuilder {
    ...
    pub fn build(self) -> super::operation::assume_root::AssumeRootOutput {
