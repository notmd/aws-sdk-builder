...
pub struct AssumeRootInput {
    ...
    /// </ul>
    pub task_policy_arn: ::std::option::Option<super::types::PolicyDescriptorType>,
...
impl AssumeRootInput {
    ...
    /// <p><a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/security-iam-awsmanpol.html#security-iam-awsmanpol-SQSUnlockQueuePolicy">SQSUnlockQueuePolicy</a></p></li>
    /// </ul>
    pub fn task_policy_arn(&self) -> ::std::option::Option<&super::types::PolicyDescriptorType> {
...
impl AssumeRootInput {
    ...
    pub fn builder() -> super::operation::assume_root::builders::AssumeRootInputBuilder {
        super::operation::assume_root::builders::AssumeRootInputBuilder::default()
    }
}
...
pub struct AssumeRootInputBuilder {
    ...
    pub(crate) task_policy_arn: ::std::option::Option<super::types::PolicyDescriptorType>,
...
impl AssumeRootInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::assume_root::AssumeRootInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::assume_root::AssumeRootInput {
