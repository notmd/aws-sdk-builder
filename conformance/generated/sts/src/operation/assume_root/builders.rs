...
pub use super::operation::assume_root::_assume_root_input::AssumeRootInputBuilder;

pub use super::operation::assume_root::_assume_root_output::AssumeRootOutputBuilder;

impl super::operation::assume_root::builders::AssumeRootInputBuilder {
...
pub struct AssumeRootFluentBuilder {
    ...
    inner: super::operation::assume_root::builders::AssumeRootInputBuilder,
...
impl AssumeRootFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::assume_root::builders::AssumeRootInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::assume_root::AssumeRoot::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::assume_root::AssumeRoot::orchestrate(&runtime_plugins, input).await
    }
    ...
    /// </ul>
    pub fn task_policy_arn(mut self, input: super::types::PolicyDescriptorType) -> Self {
    ...
    /// <p><a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/security-iam-awsmanpol.html#security-iam-awsmanpol-SQSUnlockQueuePolicy">SQSUnlockQueuePolicy</a></p></li>
    /// </ul>
    pub fn set_task_policy_arn(mut self, input: ::std::option::Option<super::types::PolicyDescriptorType>) -> Self {
    ...
    /// <p><a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/security-iam-awsmanpol.html#security-iam-awsmanpol-SQSUnlockQueuePolicy">SQSUnlockQueuePolicy</a></p></li>
    /// </ul>
    pub fn get_task_policy_arn(&self) -> &::std::option::Option<super::types::PolicyDescriptorType> {
