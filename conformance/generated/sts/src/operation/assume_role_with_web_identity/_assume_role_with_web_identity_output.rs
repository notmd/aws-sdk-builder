...
pub struct AssumeRoleWithWebIdentityOutput {
    ...
    pub assumed_role_user: ::std::option::Option<super::types::AssumedRoleUser>,
...
impl AssumeRoleWithWebIdentityOutput {
    ...
    /// <p>The Amazon Resource Name (ARN) and the assumed role ID, which are identifiers that you can use to refer to the resulting temporary security credentials. For example, you can reference these credentials as a principal in a resource-based policy by using the ARN or assumed role ID. The ARN and ID include the <code>RoleSessionName</code> that you specified when you called <code>AssumeRole</code>.</p>
    pub fn assumed_role_user(&self) -> ::std::option::Option<&super::types::AssumedRoleUser> {
...
impl AssumeRoleWithWebIdentityOutput {
    ...
    pub fn builder() -> super::operation::assume_role_with_web_identity::builders::AssumeRoleWithWebIdentityOutputBuilder {
        super::operation::assume_role_with_web_identity::builders::AssumeRoleWithWebIdentityOutputBuilder::default()
    }
}
...
pub struct AssumeRoleWithWebIdentityOutputBuilder {
    ...
    pub(crate) assumed_role_user: ::std::option::Option<super::types::AssumedRoleUser>,
...
impl AssumeRoleWithWebIdentityOutputBuilder {
    ...
    /// <p>The Amazon Resource Name (ARN) and the assumed role ID, which are identifiers that you can use to refer to the resulting temporary security credentials. For example, you can reference these credentials as a principal in a resource-based policy by using the ARN or assumed role ID. The ARN and ID include the <code>RoleSessionName</code> that you specified when you called <code>AssumeRole</code>.</p>
    pub fn assumed_role_user(mut self, input: super::types::AssumedRoleUser) -> Self {
        self.assumed_role_user = ::std::option::Option::Some(input);
        self
    }
    /// <p>The Amazon Resource Name (ARN) and the assumed role ID, which are identifiers that you can use to refer to the resulting temporary security credentials. For example, you can reference these credentials as a principal in a resource-based policy by using the ARN or assumed role ID. The ARN and ID include the <code>RoleSessionName</code> that you specified when you called <code>AssumeRole</code>.</p>
    pub fn set_assumed_role_user(mut self, input: ::std::option::Option<super::types::AssumedRoleUser>) -> Self {
        self.assumed_role_user = input;
        self
    }
    /// <p>The Amazon Resource Name (ARN) and the assumed role ID, which are identifiers that you can use to refer to the resulting temporary security credentials. For example, you can reference these credentials as a principal in a resource-based policy by using the ARN or assumed role ID. The ARN and ID include the <code>RoleSessionName</code> that you specified when you called <code>AssumeRole</code>.</p>
    pub fn get_assumed_role_user(&self) -> &::std::option::Option<super::types::AssumedRoleUser> {
    ...
    pub fn build(self) -> super::operation::assume_role_with_web_identity::AssumeRoleWithWebIdentityOutput {
