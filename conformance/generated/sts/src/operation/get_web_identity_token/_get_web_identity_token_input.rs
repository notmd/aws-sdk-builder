...
impl GetWebIdentityTokenInput {
    ...
    pub fn builder() -> super::operation::get_web_identity_token::builders::GetWebIdentityTokenInputBuilder {
        super::operation::get_web_identity_token::builders::GetWebIdentityTokenInputBuilder::default()
    }
}
...
impl GetWebIdentityTokenInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_web_identity_token::GetWebIdentityTokenInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::get_web_identity_token::GetWebIdentityTokenInput {
