    ...
    pub fn build(self) -> super::Input { self.input }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::GetAccessKeyInfoOutput, super::GetAccessKeyInfoError> {
                         ...
                         if !status.is_success() {
                             return Err(super::GetAccessKeyInfoError::unhandled_with_request_ids(format!("GetAccessKeyInfo returned HTTP {}", status), response.header("x-amzn-requestid").map(str::to_owned), ::std::option::Option::None));
                         }
