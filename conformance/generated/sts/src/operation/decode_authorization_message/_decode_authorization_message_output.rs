...
impl DecodeAuthorizationMessageOutput {
    ...
    pub fn builder() -> super::operation::decode_authorization_message::builders::DecodeAuthorizationMessageOutputBuilder {
        super::operation::decode_authorization_message::builders::DecodeAuthorizationMessageOutputBuilder::default()
    }
}
...
impl DecodeAuthorizationMessageOutputBuilder {
    ...
    pub fn build(self) -> super::operation::decode_authorization_message::DecodeAuthorizationMessageOutput {
