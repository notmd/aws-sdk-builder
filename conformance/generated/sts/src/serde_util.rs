...
pub(crate) fn assumed_role_user_correct_errors(
    mut builder: super::types::builders::AssumedRoleUserBuilder,
) -> super::types::builders::AssumedRoleUserBuilder {
...
pub(crate) fn credentials_correct_errors(mut builder: super::types::builders::CredentialsBuilder) -> super::types::builders::CredentialsBuilder {
...
pub(crate) fn federated_user_correct_errors(
    mut builder: super::types::builders::FederatedUserBuilder,
) -> super::types::builders::FederatedUserBuilder {
