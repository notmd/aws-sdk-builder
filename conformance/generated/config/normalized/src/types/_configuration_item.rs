...
pub struct ConfigurationItem {
    ...
    /// </ul>
    pub configuration_item_status: ::std::option::Option<super::super::types::ConfigurationItemStatus>,
    ...
    pub resource_type: ::std::option::Option<super::super::types::ResourceType>,
    ...
    pub relationships: ::std::option::Option<::std::vec::Vec<super::super::types::Relationship>>,
    ...
    /// </note>
    pub recording_frequency: ::std::option::Option<super::super::types::RecordingFrequency>,
...
impl ConfigurationItem {
    ...
    /// <p>ResourceDeletedNotRecorded – The resource was deleted but its configuration was not recorded since the recorder doesn't record resources of this type</p></li>
    /// </ul>
    pub fn configuration_item_status(&self) -> ::std::option::Option<&super::super::types::ConfigurationItemStatus> {
    ...
    /// <p>The type of Amazon Web Services resource.</p>
    pub fn resource_type(&self) -> ::std::option::Option<&super::super::types::ResourceType> {
    ...
    pub fn relationships(&self) -> &[super::super::types::Relationship] {
    ...
    /// <p>This field only appears in the API response when <code>DAILY</code> recording is enabled for a resource type. If this field is not present, <code>CONTINUOUS</code> recording is enabled for that resource type. For more information on daily recording and continuous recording, see <a href="https://docs.aws.amazon.com/config/latest/developerguide/select-resources.html#select-resources-recording-frequency">Recording Frequency</a> in the <i>Config Developer Guide</i>.</p>
    /// </note>
    pub fn recording_frequency(&self) -> ::std::option::Option<&super::super::types::RecordingFrequency> {
...
impl ConfigurationItem {
    ...
    pub fn builder() -> super::super::types::builders::ConfigurationItemBuilder {
        super::super::types::builders::ConfigurationItemBuilder::default()
    }
}
...
pub struct ConfigurationItemBuilder {
    ...
    pub(crate) configuration_item_status: ::std::option::Option<super::super::types::ConfigurationItemStatus>,
    ...
    pub(crate) resource_type: ::std::option::Option<super::super::types::ResourceType>,
    ...
    pub(crate) relationships: ::std::option::Option<::std::vec::Vec<super::super::types::Relationship>>,
    ...
    pub(crate) recording_frequency: ::std::option::Option<super::super::types::RecordingFrequency>,
...
impl ConfigurationItemBuilder {
    ...
    /// <p>ResourceDeletedNotRecorded – The resource was deleted but its configuration was not recorded since the recorder doesn't record resources of this type</p></li>
    /// </ul>
    pub fn configuration_item_status(mut self, input: super::super::types::ConfigurationItemStatus) -> Self {
    ...
    /// <p>ResourceDeletedNotRecorded – The resource was deleted but its configuration was not recorded since the recorder doesn't record resources of this type</p></li>
    /// </ul>
    pub fn set_configuration_item_status(mut self, input: ::std::option::Option<super::super::types::ConfigurationItemStatus>) -> Self {
    ...
    /// <p>ResourceDeletedNotRecorded – The resource was deleted but its configuration was not recorded since the recorder doesn't record resources of this type</p></li>
    /// </ul>
    pub fn get_configuration_item_status(&self) -> &::std::option::Option<super::super::types::ConfigurationItemStatus> {
    ...
    /// <p>The type of Amazon Web Services resource.</p>
    pub fn resource_type(mut self, input: super::super::types::ResourceType) -> Self {
        self.resource_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The type of Amazon Web Services resource.</p>
    pub fn set_resource_type(mut self, input: ::std::option::Option<super::super::types::ResourceType>) -> Self {
        self.resource_type = input;
        self
    }
    /// <p>The type of Amazon Web Services resource.</p>
    pub fn get_resource_type(&self) -> &::std::option::Option<super::super::types::ResourceType> {
        &self.resource_type
    }
    /// <p>The ID of the resource (for example, <code>sg-xxxxxx</code>).</p>
    ...
    ///
    /// <p>A list of related Amazon Web Services resources.</p>
    pub fn relationships(mut self, input: super::super::types::Relationship) -> Self {
    ...
    /// <p>A list of related Amazon Web Services resources.</p>
    pub fn set_relationships(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::Relationship>>) -> Self {
        self.relationships = input;
        self
    }
    /// <p>A list of related Amazon Web Services resources.</p>
    pub fn get_relationships(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::Relationship>> {
        &self.relationships
    }
    /// <p>A JSON-encoded string that contains the contents for the resource configuration. This string needs to be deserialized using <code>json.loads()</code> before you can access the contents.</p>
    ...
    /// <p>This field only appears in the API response when <code>DAILY</code> recording is enabled for a resource type. If this field is not present, <code>CONTINUOUS</code> recording is enabled for that resource type. For more information on daily recording and continuous recording, see <a href="https://docs.aws.amazon.com/config/latest/developerguide/select-resources.html#select-resources-recording-frequency">Recording Frequency</a> in the <i>Config Developer Guide</i>.</p>
    /// </note>
    pub fn recording_frequency(mut self, input: super::super::types::RecordingFrequency) -> Self {
    ...
    /// <p>This field only appears in the API response when <code>DAILY</code> recording is enabled for a resource type. If this field is not present, <code>CONTINUOUS</code> recording is enabled for that resource type. For more information on daily recording and continuous recording, see <a href="https://docs.aws.amazon.com/config/latest/developerguide/select-resources.html#select-resources-recording-frequency">Recording Frequency</a> in the <i>Config Developer Guide</i>.</p>
    /// </note>
    pub fn set_recording_frequency(mut self, input: ::std::option::Option<super::super::types::RecordingFrequency>) -> Self {
    ...
    /// <p>This field only appears in the API response when <code>DAILY</code> recording is enabled for a resource type. If this field is not present, <code>CONTINUOUS</code> recording is enabled for that resource type. For more information on daily recording and continuous recording, see <a href="https://docs.aws.amazon.com/config/latest/developerguide/select-resources.html#select-resources-recording-frequency">Recording Frequency</a> in the <i>Config Developer Guide</i>.</p>
    /// </note>
    pub fn get_recording_frequency(&self) -> &::std::option::Option<super::super::types::RecordingFrequency> {
    ...
    pub fn build(self) -> super::super::types::ConfigurationItem {
        super::super::types::ConfigurationItem {
