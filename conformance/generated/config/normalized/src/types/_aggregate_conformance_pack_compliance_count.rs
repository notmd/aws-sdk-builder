...
impl AggregateConformancePackComplianceCount {
    ...
    pub fn builder() -> super::super::types::builders::AggregateConformancePackComplianceCountBuilder {
        super::super::types::builders::AggregateConformancePackComplianceCountBuilder::default()
    }
}
...
impl AggregateConformancePackComplianceCountBuilder {
    ...
    pub fn build(self) -> super::super::types::AggregateConformancePackComplianceCount {
        super::super::types::AggregateConformancePackComplianceCount {
