...
impl ConfigRuleEvaluationStatus {
    ...
    pub fn builder() -> super::super::types::builders::ConfigRuleEvaluationStatusBuilder {
        super::super::types::builders::ConfigRuleEvaluationStatusBuilder::default()
    }
}
...
impl ConfigRuleEvaluationStatusBuilder {
    ...
    pub fn build(self) -> super::super::types::ConfigRuleEvaluationStatus {
        super::super::types::ConfigRuleEvaluationStatus {
