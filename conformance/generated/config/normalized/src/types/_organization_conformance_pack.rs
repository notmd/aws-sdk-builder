...
impl OrganizationConformancePack {
    ...
    pub fn builder() -> super::super::types::builders::OrganizationConformancePackBuilder {
        super::super::types::builders::OrganizationConformancePackBuilder::default()
    }
}
...
impl OrganizationConformancePackBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::OrganizationConformancePack, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::OrganizationConformancePack {
