...
pub struct RecordingGroup {
    ...
    /// </note>
    pub resource_types: ::std::option::Option<::std::vec::Vec<super::super::types::ResourceType>>,
    ...
    /// </note>
    pub exclusion_by_resource_types: ::std::option::Option<super::super::types::ExclusionByResourceTypes>,
    ...
    /// </note>
    pub recording_strategy: ::std::option::Option<super::super::types::RecordingStrategy>,
}
impl RecordingGroup {
    /// <p>Specifies whether Config records configuration changes for all supported resource types, excluding the global IAM resource types.</p>
    /// <p>If you set this field to <code>true</code>, when Config adds support for a new resource type, Config starts recording resources of that type automatically.</p>
    ...
    pub fn resource_types(&self) -> &[super::super::types::ResourceType] {
    ...
    /// <p>To use this option, you must set the <code>useOnly</code> field of <a href="https://docs.aws.amazon.com/config/latest/APIReference/API_RecordingStrategy.html">RecordingStrategy</a> to <code>EXCLUSION_BY_RESOURCE_TYPES</code>.</p>
    /// </note>
    pub fn exclusion_by_resource_types(&self) -> ::std::option::Option<&super::super::types::ExclusionByResourceTypes> {
    ...
    /// <p>IAM users, groups, roles, and customer managed policies will be recorded in the Region where you set up the configuration recorder if that is a Region where Config was available before February 2022. You cannot be record the global IAM resouce types in Regions supported by Config after February 2022. For a list of those Regions, see <a href="https://docs.aws.amazon.com/config/latest/developerguide/select-resources.html#select-resources-all">Recording Amazon Web Services Resources | Global Resources</a>.</p>
    /// </note>
    pub fn recording_strategy(&self) -> ::std::option::Option<&super::super::types::RecordingStrategy> {
...
impl RecordingGroup {
    ...
    pub fn builder() -> super::super::types::builders::RecordingGroupBuilder {
        super::super::types::builders::RecordingGroupBuilder::default()
    }
}
...
pub struct RecordingGroupBuilder {
    ...
    pub(crate) resource_types: ::std::option::Option<::std::vec::Vec<super::super::types::ResourceType>>,
    pub(crate) exclusion_by_resource_types: ::std::option::Option<super::super::types::ExclusionByResourceTypes>,
    pub(crate) recording_strategy: ::std::option::Option<super::super::types::RecordingStrategy>,
}
impl RecordingGroupBuilder {
    ...
    /// <p>Before specifying a resource type for Config to track, check <a href="https://docs.aws.amazon.com/config/latest/developerguide/what-is-resource-config-coverage.html">Resource Coverage by Region Availability</a> to see if the resource type is supported in the Amazon Web Services Region where you set up Config. If a resource type is supported by Config in at least one Region, you can enable the recording of that resource type in all Regions supported by Config, even if the specified resource type is not supported in the Amazon Web Services Region where you set up Config.</p>
    /// </note>
    pub fn resource_types(mut self, input: super::super::types::ResourceType) -> Self {
    ...
    /// <p>Before specifying a resource type for Config to track, check <a href="https://docs.aws.amazon.com/config/latest/developerguide/what-is-resource-config-coverage.html">Resource Coverage by Region Availability</a> to see if the resource type is supported in the Amazon Web Services Region where you set up Config. If a resource type is supported by Config in at least one Region, you can enable the recording of that resource type in all Regions supported by Config, even if the specified resource type is not supported in the Amazon Web Services Region where you set up Config.</p>
    /// </note>
    pub fn set_resource_types(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::ResourceType>>) -> Self {
    ...
    /// <p>Before specifying a resource type for Config to track, check <a href="https://docs.aws.amazon.com/config/latest/developerguide/what-is-resource-config-coverage.html">Resource Coverage by Region Availability</a> to see if the resource type is supported in the Amazon Web Services Region where you set up Config. If a resource type is supported by Config in at least one Region, you can enable the recording of that resource type in all Regions supported by Config, even if the specified resource type is not supported in the Amazon Web Services Region where you set up Config.</p>
    /// </note>
    pub fn get_resource_types(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::ResourceType>> {
        &self.resource_types
    }
    /// <p>An object that specifies how Config excludes resource types from being recorded by the configuration recorder.</p><note>
    /// <p><b>Required fields</b></p>
    /// <p>To use this option, you must set the <code>useOnly</code> field of <a href="https://docs.aws.amazon.com/config/latest/APIReference/API_RecordingStrategy.html">RecordingStrategy</a> to <code>EXCLUSION_BY_RESOURCE_TYPES</code>.</p>
    /// </note>
    pub fn exclusion_by_resource_types(mut self, input: super::super::types::ExclusionByResourceTypes) -> Self {
    ...
    /// <p>To use this option, you must set the <code>useOnly</code> field of <a href="https://docs.aws.amazon.com/config/latest/APIReference/API_RecordingStrategy.html">RecordingStrategy</a> to <code>EXCLUSION_BY_RESOURCE_TYPES</code>.</p>
    /// </note>
    pub fn set_exclusion_by_resource_types(mut self, input: ::std::option::Option<super::super::types::ExclusionByResourceTypes>) -> Self {
    ...
    /// <p>To use this option, you must set the <code>useOnly</code> field of <a href="https://docs.aws.amazon.com/config/latest/APIReference/API_RecordingStrategy.html">RecordingStrategy</a> to <code>EXCLUSION_BY_RESOURCE_TYPES</code>.</p>
    /// </note>
    pub fn get_exclusion_by_resource_types(&self) -> &::std::option::Option<super::super::types::ExclusionByResourceTypes> {
    ...
    /// <p>IAM users, groups, roles, and customer managed policies will be recorded in the Region where you set up the configuration recorder if that is a Region where Config was available before February 2022. You cannot be record the global IAM resouce types in Regions supported by Config after February 2022. For a list of those Regions, see <a href="https://docs.aws.amazon.com/config/latest/developerguide/select-resources.html#select-resources-all">Recording Amazon Web Services Resources | Global Resources</a>.</p>
    /// </note>
    pub fn recording_strategy(mut self, input: super::super::types::RecordingStrategy) -> Self {
    ...
    /// <p>IAM users, groups, roles, and customer managed policies will be recorded in the Region where you set up the configuration recorder if that is a Region where Config was available before February 2022. You cannot be record the global IAM resouce types in Regions supported by Config after February 2022. For a list of those Regions, see <a href="https://docs.aws.amazon.com/config/latest/developerguide/select-resources.html#select-resources-all">Recording Amazon Web Services Resources | Global Resources</a>.</p>
    /// </note>
    pub fn set_recording_strategy(mut self, input: ::std::option::Option<super::super::types::RecordingStrategy>) -> Self {
    ...
    /// <p>IAM users, groups, roles, and customer managed policies will be recorded in the Region where you set up the configuration recorder if that is a Region where Config was available before February 2022. You cannot be record the global IAM resouce types in Regions supported by Config after February 2022. For a list of those Regions, see <a href="https://docs.aws.amazon.com/config/latest/developerguide/select-resources.html#select-resources-all">Recording Amazon Web Services Resources | Global Resources</a>.</p>
    /// </note>
    pub fn get_recording_strategy(&self) -> &::std::option::Option<super::super::types::RecordingStrategy> {
        &self.recording_strategy
    }
    /// Consumes the builder and constructs a [`RecordingGroup`](crate::types::RecordingGroup).
    pub fn build(self) -> super::super::types::RecordingGroup {
        super::super::types::RecordingGroup {
