...
impl ConformancePackComplianceScoresFilters {
    ...
    pub fn builder() -> super::super::types::builders::ConformancePackComplianceScoresFiltersBuilder {
        super::super::types::builders::ConformancePackComplianceScoresFiltersBuilder::default()
    }
}
...
impl ConformancePackComplianceScoresFiltersBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::types::ConformancePackComplianceScoresFilters, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::ConformancePackComplianceScoresFilters {
