...
pub struct ConfigSnapshotDeliveryProperties {
    ...
    pub delivery_frequency: ::std::option::Option<super::super::types::MaximumExecutionFrequency>,
}
impl ConfigSnapshotDeliveryProperties {
    /// <p>The frequency with which Config delivers configuration snapshots.</p>
    pub fn delivery_frequency(&self) -> ::std::option::Option<&super::super::types::MaximumExecutionFrequency> {
...
impl ConfigSnapshotDeliveryProperties {
    ...
    pub fn builder() -> super::super::types::builders::ConfigSnapshotDeliveryPropertiesBuilder {
        super::super::types::builders::ConfigSnapshotDeliveryPropertiesBuilder::default()
    }
}
...
pub struct ConfigSnapshotDeliveryPropertiesBuilder {
    pub(crate) delivery_frequency: ::std::option::Option<super::super::types::MaximumExecutionFrequency>,
}
impl ConfigSnapshotDeliveryPropertiesBuilder {
    /// <p>The frequency with which Config delivers configuration snapshots.</p>
    pub fn delivery_frequency(mut self, input: super::super::types::MaximumExecutionFrequency) -> Self {
        self.delivery_frequency = ::std::option::Option::Some(input);
        self
    }
    /// <p>The frequency with which Config delivers configuration snapshots.</p>
    pub fn set_delivery_frequency(mut self, input: ::std::option::Option<super::super::types::MaximumExecutionFrequency>) -> Self {
        self.delivery_frequency = input;
        self
    }
    /// <p>The frequency with which Config delivers configuration snapshots.</p>
    pub fn get_delivery_frequency(&self) -> &::std::option::Option<super::super::types::MaximumExecutionFrequency> {
    ...
    pub fn build(self) -> super::super::types::ConfigSnapshotDeliveryProperties {
        super::super::types::ConfigSnapshotDeliveryProperties {
