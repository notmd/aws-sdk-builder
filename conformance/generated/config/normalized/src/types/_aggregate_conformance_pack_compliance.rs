...
impl AggregateConformancePackCompliance {
    ...
    pub fn builder() -> super::super::types::builders::AggregateConformancePackComplianceBuilder {
        super::super::types::builders::AggregateConformancePackComplianceBuilder::default()
    }
}
...
impl AggregateConformancePackComplianceBuilder {
    ...
    pub fn build(self) -> super::super::types::AggregateConformancePackCompliance {
        super::super::types::AggregateConformancePackCompliance {
