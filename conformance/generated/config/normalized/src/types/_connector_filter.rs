...
pub struct ConnectorFilter {
    ...
    pub filter_name: ::std::option::Option<super::super::types::ConnectorFilterName>,
...
impl ConnectorFilter {
    /// <p>The name of the filter. Currently, only <code>provider</code> is supported.</p>
    pub fn filter_name(&self) -> ::std::option::Option<&super::super::types::ConnectorFilterName> {
...
impl ConnectorFilter {
    ...
    pub fn builder() -> super::super::types::builders::ConnectorFilterBuilder {
        super::super::types::builders::ConnectorFilterBuilder::default()
    }
}
...
pub struct ConnectorFilterBuilder {
    pub(crate) filter_name: ::std::option::Option<super::super::types::ConnectorFilterName>,
    pub(crate) filter_values: ::std::option::Option<::std::vec::Vec<::std::string::String>>,
}
impl ConnectorFilterBuilder {
    /// <p>The name of the filter. Currently, only <code>provider</code> is supported.</p>
    pub fn filter_name(mut self, input: super::super::types::ConnectorFilterName) -> Self {
        self.filter_name = ::std::option::Option::Some(input);
        self
    }
    /// <p>The name of the filter. Currently, only <code>provider</code> is supported.</p>
    pub fn set_filter_name(mut self, input: ::std::option::Option<super::super::types::ConnectorFilterName>) -> Self {
        self.filter_name = input;
        self
    }
    /// <p>The name of the filter. Currently, only <code>provider</code> is supported.</p>
    pub fn get_filter_name(&self) -> &::std::option::Option<super::super::types::ConnectorFilterName> {
        &self.filter_name
    }
    ...
    pub fn build(self) -> super::super::types::ConnectorFilter {
        super::super::types::ConnectorFilter {
