...
impl RemediationException {
    ...
    pub fn builder() -> super::super::types::builders::RemediationExceptionBuilder {
        super::super::types::builders::RemediationExceptionBuilder::default()
    }
}
...
impl RemediationExceptionBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::RemediationException, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::RemediationException {
