...
impl ConfigStreamDeliveryInfo {
    ...
    pub fn builder() -> super::super::types::builders::ConfigStreamDeliveryInfoBuilder {
        super::super::types::builders::ConfigStreamDeliveryInfoBuilder::default()
    }
}
...
impl ConfigStreamDeliveryInfoBuilder {
    ...
    pub fn build(self) -> super::super::types::ConfigStreamDeliveryInfo {
        super::super::types::ConfigStreamDeliveryInfo {
