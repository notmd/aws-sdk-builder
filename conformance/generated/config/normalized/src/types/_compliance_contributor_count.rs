...
impl ComplianceContributorCount {
    ...
    pub fn builder() -> super::super::types::builders::ComplianceContributorCountBuilder {
        super::super::types::builders::ComplianceContributorCountBuilder::default()
    }
}
...
impl ComplianceContributorCountBuilder {
    ...
    pub fn build(self) -> super::super::types::ComplianceContributorCount {
        super::super::types::ComplianceContributorCount {
