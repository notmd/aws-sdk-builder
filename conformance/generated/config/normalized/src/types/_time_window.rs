...
impl TimeWindow {
    ...
    pub fn builder() -> super::super::types::builders::TimeWindowBuilder {
        super::super::types::builders::TimeWindowBuilder::default()
    }
}
...
impl TimeWindowBuilder {
    ...
    pub fn build(self) -> super::super::types::TimeWindow {
        super::super::types::TimeWindow {
