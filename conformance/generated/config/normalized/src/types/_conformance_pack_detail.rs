...
pub struct ConformancePackDetail {
    ...
    pub conformance_pack_input_parameters: ::std::option::Option<::std::vec::Vec<super::super::types::ConformancePackInputParameter>>,
    ...
    pub template_ssm_document_details: ::std::option::Option<super::super::types::TemplateSsmDocumentDetails>,
}
impl ConformancePackDetail {
    ...
    pub fn conformance_pack_input_parameters(&self) -> &[super::super::types::ConformancePackInputParameter] {
    ...
    /// <p>An object that contains the name or Amazon Resource Name (ARN) of the Amazon Web Services Systems Manager document (SSM document) and the version of the SSM document that is used to create a conformance pack.</p>
    pub fn template_ssm_document_details(&self) -> ::std::option::Option<&super::super::types::TemplateSsmDocumentDetails> {
...
impl ConformancePackDetail {
    ...
    pub fn builder() -> super::super::types::builders::ConformancePackDetailBuilder {
        super::super::types::builders::ConformancePackDetailBuilder::default()
    }
}
...
pub struct ConformancePackDetailBuilder {
    ...
    pub(crate) conformance_pack_input_parameters: ::std::option::Option<::std::vec::Vec<super::super::types::ConformancePackInputParameter>>,
    pub(crate) last_update_requested_time: ::std::option::Option<::aws_smithy_types::DateTime>,
    pub(crate) created_by: ::std::option::Option<::std::string::String>,
    pub(crate) template_ssm_document_details: ::std::option::Option<super::super::types::TemplateSsmDocumentDetails>,
}
impl ConformancePackDetailBuilder {
    ...
    ///
    /// <p>A list of <code>ConformancePackInputParameter</code> objects.</p>
    pub fn conformance_pack_input_parameters(mut self, input: super::super::types::ConformancePackInputParameter) -> Self {
    ...
    pub fn set_conformance_pack_input_parameters(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::types::ConformancePackInputParameter>>,
    ) -> Self {
    ...
    /// <p>An object that contains the name or Amazon Resource Name (ARN) of the Amazon Web Services Systems Manager document (SSM document) and the version of the SSM document that is used to create a conformance pack.</p>
    pub fn template_ssm_document_details(mut self, input: super::super::types::TemplateSsmDocumentDetails) -> Self {
        self.template_ssm_document_details = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object that contains the name or Amazon Resource Name (ARN) of the Amazon Web Services Systems Manager document (SSM document) and the version of the SSM document that is used to create a conformance pack.</p>
    pub fn set_template_ssm_document_details(mut self, input: ::std::option::Option<super::super::types::TemplateSsmDocumentDetails>) -> Self {
        self.template_ssm_document_details = input;
        self
    }
    /// <p>An object that contains the name or Amazon Resource Name (ARN) of the Amazon Web Services Systems Manager document (SSM document) and the version of the SSM document that is used to create a conformance pack.</p>
    pub fn get_template_ssm_document_details(&self) -> &::std::option::Option<super::super::types::TemplateSsmDocumentDetails> {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::ConformancePackDetail, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::ConformancePackDetail {
