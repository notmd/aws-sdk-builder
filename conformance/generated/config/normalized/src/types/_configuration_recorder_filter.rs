...
pub struct ConfigurationRecorderFilter {
    ...
    pub filter_name: ::std::option::Option<super::super::types::ConfigurationRecorderFilterName>,
...
impl ConfigurationRecorderFilter {
    /// <p>The name of the type of filter. Currently, only <code>recordingScope</code> is supported.</p>
    pub fn filter_name(&self) -> ::std::option::Option<&super::super::types::ConfigurationRecorderFilterName> {
...
impl ConfigurationRecorderFilter {
    ...
    pub fn builder() -> super::super::types::builders::ConfigurationRecorderFilterBuilder {
        super::super::types::builders::ConfigurationRecorderFilterBuilder::default()
    }
}
...
pub struct ConfigurationRecorderFilterBuilder {
    pub(crate) filter_name: ::std::option::Option<super::super::types::ConfigurationRecorderFilterName>,
    pub(crate) filter_value: ::std::option::Option<::std::vec::Vec<::std::string::String>>,
}
impl ConfigurationRecorderFilterBuilder {
    /// <p>The name of the type of filter. Currently, only <code>recordingScope</code> is supported.</p>
    pub fn filter_name(mut self, input: super::super::types::ConfigurationRecorderFilterName) -> Self {
        self.filter_name = ::std::option::Option::Some(input);
        self
    }
    /// <p>The name of the type of filter. Currently, only <code>recordingScope</code> is supported.</p>
    pub fn set_filter_name(mut self, input: ::std::option::Option<super::super::types::ConfigurationRecorderFilterName>) -> Self {
        self.filter_name = input;
        self
    }
    /// <p>The name of the type of filter. Currently, only <code>recordingScope</code> is supported.</p>
    pub fn get_filter_name(&self) -> &::std::option::Option<super::super::types::ConfigurationRecorderFilterName> {
        &self.filter_name
    }
    ...
    pub fn build(self) -> super::super::types::ConfigurationRecorderFilter {
        super::super::types::ConfigurationRecorderFilter {
