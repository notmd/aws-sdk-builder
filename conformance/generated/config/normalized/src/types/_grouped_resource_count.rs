...
impl GroupedResourceCount {
    ...
    pub fn builder() -> super::super::types::builders::GroupedResourceCountBuilder {
        super::super::types::builders::GroupedResourceCountBuilder::default()
    }
}
...
impl GroupedResourceCountBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::GroupedResourceCount, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::GroupedResourceCount {
