...
pub struct FailedRemediationBatch {
    ...
    pub failed_items: ::std::option::Option<::std::vec::Vec<super::super::types::RemediationConfiguration>>,
}
impl FailedRemediationBatch {
    ...
    pub fn failed_items(&self) -> &[super::super::types::RemediationConfiguration] {
...
impl FailedRemediationBatch {
    ...
    pub fn builder() -> super::super::types::builders::FailedRemediationBatchBuilder {
        super::super::types::builders::FailedRemediationBatchBuilder::default()
    }
}
...
pub struct FailedRemediationBatchBuilder {
    ...
    pub(crate) failed_items: ::std::option::Option<::std::vec::Vec<super::super::types::RemediationConfiguration>>,
}
impl FailedRemediationBatchBuilder {
    ...
    ///
    /// <p>Returns remediation configurations of the failed items.</p>
    pub fn failed_items(mut self, input: super::super::types::RemediationConfiguration) -> Self {
    ...
    /// <p>Returns remediation configurations of the failed items.</p>
    pub fn set_failed_items(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::RemediationConfiguration>>) -> Self {
        self.failed_items = input;
        self
    }
    /// <p>Returns remediation configurations of the failed items.</p>
    pub fn get_failed_items(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::RemediationConfiguration>> {
        &self.failed_items
    }
    /// Consumes the builder and constructs a [`FailedRemediationBatch`](crate::types::FailedRemediationBatch).
    pub fn build(self) -> super::super::types::FailedRemediationBatch {
        super::super::types::FailedRemediationBatch {
