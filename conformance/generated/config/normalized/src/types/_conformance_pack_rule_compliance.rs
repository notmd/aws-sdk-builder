...
impl ConformancePackRuleCompliance {
    ...
    pub fn builder() -> super::super::types::builders::ConformancePackRuleComplianceBuilder {
        super::super::types::builders::ConformancePackRuleComplianceBuilder::default()
    }
}
...
impl ConformancePackRuleComplianceBuilder {
    ...
    pub fn build(self) -> super::super::types::ConformancePackRuleCompliance {
        super::super::types::ConformancePackRuleCompliance {
