...
impl TemplateSsmDocumentDetails {
    ...
    pub fn builder() -> super::super::types::builders::TemplateSsmDocumentDetailsBuilder {
        super::super::types::builders::TemplateSsmDocumentDetailsBuilder::default()
    }
}
...
impl TemplateSsmDocumentDetailsBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::TemplateSsmDocumentDetails, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::TemplateSsmDocumentDetails {
