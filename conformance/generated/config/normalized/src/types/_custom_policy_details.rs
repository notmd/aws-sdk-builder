...
impl CustomPolicyDetails {
    ...
    pub fn builder() -> super::super::types::builders::CustomPolicyDetailsBuilder {
        super::super::types::builders::CustomPolicyDetailsBuilder::default()
    }
}
...
impl CustomPolicyDetailsBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::CustomPolicyDetails, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::CustomPolicyDetails {
