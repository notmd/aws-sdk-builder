...
pub struct MemberAccountStatus {
    ...
    /// </ul>
    pub member_account_rule_status: super::super::types::MemberAccountRuleStatus,
...
impl MemberAccountStatus {
    ...
    /// <p><code>UPDATE_FAILED</code> when Config rule deletion has failed in the member account.</p></li>
    /// </ul>
    pub fn member_account_rule_status(&self) -> &super::super::types::MemberAccountRuleStatus {
...
impl MemberAccountStatus {
    ...
    pub fn builder() -> super::super::types::builders::MemberAccountStatusBuilder {
        super::super::types::builders::MemberAccountStatusBuilder::default()
    }
}
...
pub struct MemberAccountStatusBuilder {
    ...
    pub(crate) member_account_rule_status: ::std::option::Option<super::super::types::MemberAccountRuleStatus>,
...
impl MemberAccountStatusBuilder {
    ...
    /// </ul>
    /// This field is required.
    pub fn member_account_rule_status(mut self, input: super::super::types::MemberAccountRuleStatus) -> Self {
    ...
    /// <p><code>UPDATE_FAILED</code> when Config rule deletion has failed in the member account.</p></li>
    /// </ul>
    pub fn set_member_account_rule_status(mut self, input: ::std::option::Option<super::super::types::MemberAccountRuleStatus>) -> Self {
    ...
    /// <p><code>UPDATE_FAILED</code> when Config rule deletion has failed in the member account.</p></li>
    /// </ul>
    pub fn get_member_account_rule_status(&self) -> &::std::option::Option<super::super::types::MemberAccountRuleStatus> {
        &self.member_account_rule_status
    }
    /// <p>An error code that is returned when Config rule creation or deletion failed in the member account.</p>
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::MemberAccountStatus, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::MemberAccountStatus {
