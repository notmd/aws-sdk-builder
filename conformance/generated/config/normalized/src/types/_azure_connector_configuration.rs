...
impl AzureConnectorConfiguration {
    ...
    pub fn builder() -> super::super::types::builders::AzureConnectorConfigurationBuilder {
        super::super::types::builders::AzureConnectorConfigurationBuilder::default()
    }
}
...
impl AzureConnectorConfigurationBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::AzureConnectorConfiguration, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::AzureConnectorConfiguration {
