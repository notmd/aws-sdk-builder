...
impl OrganizationAggregationSource {
    ...
    pub fn builder() -> super::super::types::builders::OrganizationAggregationSourceBuilder {
        super::super::types::builders::OrganizationAggregationSourceBuilder::default()
    }
}
...
impl OrganizationAggregationSourceBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::OrganizationAggregationSource, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::OrganizationAggregationSource {
