...
impl EvaluationContext {
    ...
    pub fn builder() -> super::super::types::builders::EvaluationContextBuilder {
        super::super::types::builders::EvaluationContextBuilder::default()
    }
}
...
impl EvaluationContextBuilder {
    ...
    pub fn build(self) -> super::super::types::EvaluationContext {
        super::super::types::EvaluationContext {
