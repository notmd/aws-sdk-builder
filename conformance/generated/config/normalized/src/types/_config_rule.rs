...
pub struct ConfigRule {
    ...
    pub scope: ::std::option::Option<super::super::types::Scope>,
    ...
    pub source: ::std::option::Option<super::super::types::Source>,
    ...
    /// </note>
    pub maximum_execution_frequency: ::std::option::Option<super::super::types::MaximumExecutionFrequency>,
    ...
    pub config_rule_state: ::std::option::Option<super::super::types::ConfigRuleState>,
    ...
    pub evaluation_modes: ::std::option::Option<::std::vec::Vec<super::super::types::EvaluationModeConfiguration>>,
    ...
    pub rule_evaluation_visibility: ::std::option::Option<super::super::types::RuleEvaluationVisibility>,
}
impl ConfigRule {
    /// <p>The name that you assign to the Config rule. The name is required if you are adding a new rule.</p>
    ...
    /// <p>Defines which resources can trigger an evaluation for the rule. The scope can include one or more resource types, a combination of one resource type and one resource ID, or a combination of a tag key and value. Specify a scope to constrain the resources that can trigger an evaluation for the rule. If you do not specify a scope, evaluations are triggered when any resource in the recording group changes.</p>
    pub fn scope(&self) -> ::std::option::Option<&super::super::types::Scope> {
        self.scope.as_ref()
    }
    /// <p>Provides the rule owner (<code>Amazon Web Services</code> for managed rules, <code>CUSTOM_POLICY</code> for Custom Policy rules, and <code>CUSTOM_LAMBDA</code> for Custom Lambda rules), the rule identifier, and the notifications that cause the function to evaluate your Amazon Web Services resources.</p>
    pub fn source(&self) -> ::std::option::Option<&super::super::types::Source> {
        self.source.as_ref()
    }
    /// <p>A string, in JSON format, that is passed to the Config rule Lambda function.</p>
    ...
    /// <p>By default, rules with a periodic trigger are evaluated every 24 hours. To change the frequency, specify a valid value for the <code>MaximumExecutionFrequency</code> parameter.</p>
    /// </note>
    pub fn maximum_execution_frequency(&self) -> ::std::option::Option<&super::super::types::MaximumExecutionFrequency> {
    ...
    /// <p>Config sets the state of the rule to <code>DELETING_RESULTS</code> temporarily after you use the <code>DeleteEvaluationResults</code> request to delete the current evaluation results for the Config rule.</p>
    /// <p>Config temporarily sets the state of a rule to <code>DELETING</code> after you use the <code>DeleteConfigRule</code> request to delete the rule. After Config deletes the rule, the rule and all of its evaluations are erased and are no longer available.</p>
    pub fn config_rule_state(&self) -> ::std::option::Option<&super::super::types::ConfigRuleState> {
    ...
    pub fn evaluation_modes(&self) -> &[super::super::types::EvaluationModeConfiguration] {
        self.evaluation_modes.as_deref().unwrap_or_default()
    }
    /// <p>Indicates whether you can get <code>Evaluation</code>s for the Config rule. You can get <code>Evaluation</code>s for the Amazon Web Services Config rule if this value is <code>EXTERNAL</code>. You cannot get <code>Evaluation</code>s for the Amazon Web Services Config rule if this value is <code>INTERNAL</code>.</p>
    pub fn rule_evaluation_visibility(&self) -> ::std::option::Option<&super::super::types::RuleEvaluationVisibility> {
...
impl ConfigRule {
    ...
    pub fn builder() -> super::super::types::builders::ConfigRuleBuilder {
        super::super::types::builders::ConfigRuleBuilder::default()
    }
}
...
pub struct ConfigRuleBuilder {
    ...
    pub(crate) scope: ::std::option::Option<super::super::types::Scope>,
    pub(crate) source: ::std::option::Option<super::super::types::Source>,
    ...
    pub(crate) config_rule_state: ::std::option::Option<super::super::types::ConfigRuleState>,
    pub(crate) created_by: ::std::option::Option<::std::string::String>,
    pub(crate) evaluation_modes: ::std::option::Option<::std::vec::Vec<super::super::types::EvaluationModeConfiguration>>,
    pub(crate) rule_evaluation_visibility: ::std::option::Option<super::super::types::RuleEvaluationVisibility>,
}
impl ConfigRuleBuilder {
    ...
    /// <p>Defines which resources can trigger an evaluation for the rule. The scope can include one or more resource types, a combination of one resource type and one resource ID, or a combination of a tag key and value. Specify a scope to constrain the resources that can trigger an evaluation for the rule. If you do not specify a scope, evaluations are triggered when any resource in the recording group changes.</p>
    pub fn scope(mut self, input: super::super::types::Scope) -> Self {
        self.scope = ::std::option::Option::Some(input);
        self
    }
    /// <p>Defines which resources can trigger an evaluation for the rule. The scope can include one or more resource types, a combination of one resource type and one resource ID, or a combination of a tag key and value. Specify a scope to constrain the resources that can trigger an evaluation for the rule. If you do not specify a scope, evaluations are triggered when any resource in the recording group changes.</p>
    pub fn set_scope(mut self, input: ::std::option::Option<super::super::types::Scope>) -> Self {
        self.scope = input;
        self
    }
    /// <p>Defines which resources can trigger an evaluation for the rule. The scope can include one or more resource types, a combination of one resource type and one resource ID, or a combination of a tag key and value. Specify a scope to constrain the resources that can trigger an evaluation for the rule. If you do not specify a scope, evaluations are triggered when any resource in the recording group changes.</p>
    pub fn get_scope(&self) -> &::std::option::Option<super::super::types::Scope> {
        &self.scope
    }
    /// <p>Provides the rule owner (<code>Amazon Web Services</code> for managed rules, <code>CUSTOM_POLICY</code> for Custom Policy rules, and <code>CUSTOM_LAMBDA</code> for Custom Lambda rules), the rule identifier, and the notifications that cause the function to evaluate your Amazon Web Services resources.</p>
    /// This field is required.
    pub fn source(mut self, input: super::super::types::Source) -> Self {
        self.source = ::std::option::Option::Some(input);
        self
    }
    /// <p>Provides the rule owner (<code>Amazon Web Services</code> for managed rules, <code>CUSTOM_POLICY</code> for Custom Policy rules, and <code>CUSTOM_LAMBDA</code> for Custom Lambda rules), the rule identifier, and the notifications that cause the function to evaluate your Amazon Web Services resources.</p>
    pub fn set_source(mut self, input: ::std::option::Option<super::super::types::Source>) -> Self {
        self.source = input;
        self
    }
    /// <p>Provides the rule owner (<code>Amazon Web Services</code> for managed rules, <code>CUSTOM_POLICY</code> for Custom Policy rules, and <code>CUSTOM_LAMBDA</code> for Custom Lambda rules), the rule identifier, and the notifications that cause the function to evaluate your Amazon Web Services resources.</p>
    pub fn get_source(&self) -> &::std::option::Option<super::super::types::Source> {
        &self.source
    }
    /// <p>A string, in JSON format, that is passed to the Config rule Lambda function.</p>
    ...
    /// <p>By default, rules with a periodic trigger are evaluated every 24 hours. To change the frequency, specify a valid value for the <code>MaximumExecutionFrequency</code> parameter.</p>
    /// </note>
    pub fn maximum_execution_frequency(mut self, input: super::super::types::MaximumExecutionFrequency) -> Self {
    ...
    /// <p>By default, rules with a periodic trigger are evaluated every 24 hours. To change the frequency, specify a valid value for the <code>MaximumExecutionFrequency</code> parameter.</p>
    /// </note>
    pub fn set_maximum_execution_frequency(mut self, input: ::std::option::Option<super::super::types::MaximumExecutionFrequency>) -> Self {
    ...
    /// <p>By default, rules with a periodic trigger are evaluated every 24 hours. To change the frequency, specify a valid value for the <code>MaximumExecutionFrequency</code> parameter.</p>
    /// </note>
    pub fn get_maximum_execution_frequency(&self) -> &::std::option::Option<super::super::types::MaximumExecutionFrequency> {
    ...
    /// <p>Config sets the state of the rule to <code>DELETING_RESULTS</code> temporarily after you use the <code>DeleteEvaluationResults</code> request to delete the current evaluation results for the Config rule.</p>
    /// <p>Config temporarily sets the state of a rule to <code>DELETING</code> after you use the <code>DeleteConfigRule</code> request to delete the rule. After Config deletes the rule, the rule and all of its evaluations are erased and are no longer available.</p>
    pub fn config_rule_state(mut self, input: super::super::types::ConfigRuleState) -> Self {
    ...
    /// <p>Config sets the state of the rule to <code>DELETING_RESULTS</code> temporarily after you use the <code>DeleteEvaluationResults</code> request to delete the current evaluation results for the Config rule.</p>
    /// <p>Config temporarily sets the state of a rule to <code>DELETING</code> after you use the <code>DeleteConfigRule</code> request to delete the rule. After Config deletes the rule, the rule and all of its evaluations are erased and are no longer available.</p>
    pub fn set_config_rule_state(mut self, input: ::std::option::Option<super::super::types::ConfigRuleState>) -> Self {
    ...
    /// <p>Config sets the state of the rule to <code>DELETING_RESULTS</code> temporarily after you use the <code>DeleteEvaluationResults</code> request to delete the current evaluation results for the Config rule.</p>
    /// <p>Config temporarily sets the state of a rule to <code>DELETING</code> after you use the <code>DeleteConfigRule</code> request to delete the rule. After Config deletes the rule, the rule and all of its evaluations are erased and are no longer available.</p>
    pub fn get_config_rule_state(&self) -> &::std::option::Option<super::super::types::ConfigRuleState> {
    ...
    ///
    /// <p>The modes the Config rule can be evaluated in. The valid values are distinct objects. By default, the value is Detective evaluation mode only.</p>
    pub fn evaluation_modes(mut self, input: super::super::types::EvaluationModeConfiguration) -> Self {
    ...
    /// <p>The modes the Config rule can be evaluated in. The valid values are distinct objects. By default, the value is Detective evaluation mode only.</p>
    pub fn set_evaluation_modes(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::EvaluationModeConfiguration>>) -> Self {
        self.evaluation_modes = input;
        self
    }
    /// <p>The modes the Config rule can be evaluated in. The valid values are distinct objects. By default, the value is Detective evaluation mode only.</p>
    pub fn get_evaluation_modes(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::EvaluationModeConfiguration>> {
        &self.evaluation_modes
    }
    /// <p>Indicates whether you can get <code>Evaluation</code>s for the Config rule. You can get <code>Evaluation</code>s for the Amazon Web Services Config rule if this value is <code>EXTERNAL</code>. You cannot get <code>Evaluation</code>s for the Amazon Web Services Config rule if this value is <code>INTERNAL</code>.</p>
    pub fn rule_evaluation_visibility(mut self, input: super::super::types::RuleEvaluationVisibility) -> Self {
        self.rule_evaluation_visibility = ::std::option::Option::Some(input);
        self
    }
    /// <p>Indicates whether you can get <code>Evaluation</code>s for the Config rule. You can get <code>Evaluation</code>s for the Amazon Web Services Config rule if this value is <code>EXTERNAL</code>. You cannot get <code>Evaluation</code>s for the Amazon Web Services Config rule if this value is <code>INTERNAL</code>.</p>
    pub fn set_rule_evaluation_visibility(mut self, input: ::std::option::Option<super::super::types::RuleEvaluationVisibility>) -> Self {
        self.rule_evaluation_visibility = input;
        self
    }
    /// <p>Indicates whether you can get <code>Evaluation</code>s for the Config rule. You can get <code>Evaluation</code>s for the Amazon Web Services Config rule if this value is <code>EXTERNAL</code>. You cannot get <code>Evaluation</code>s for the Amazon Web Services Config rule if this value is <code>INTERNAL</code>.</p>
    pub fn get_rule_evaluation_visibility(&self) -> &::std::option::Option<super::super::types::RuleEvaluationVisibility> {
        &self.rule_evaluation_visibility
    }
    /// Consumes the builder and constructs a [`ConfigRule`](crate::types::ConfigRule).
    pub fn build(self) -> super::super::types::ConfigRule {
        super::super::types::ConfigRule {
