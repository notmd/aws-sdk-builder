...
pub struct AggregateComplianceByConformancePack {
    ...
    pub compliance: ::std::option::Option<super::super::types::AggregateConformancePackCompliance>,
...
impl AggregateComplianceByConformancePack {
    ...
    /// <p>The compliance status of the conformance pack.</p>
    pub fn compliance(&self) -> ::std::option::Option<&super::super::types::AggregateConformancePackCompliance> {
...
impl AggregateComplianceByConformancePack {
    ...
    pub fn builder() -> super::super::types::builders::AggregateComplianceByConformancePackBuilder {
        super::super::types::builders::AggregateComplianceByConformancePackBuilder::default()
    }
}
...
pub struct AggregateComplianceByConformancePackBuilder {
    ...
    pub(crate) compliance: ::std::option::Option<super::super::types::AggregateConformancePackCompliance>,
...
impl AggregateComplianceByConformancePackBuilder {
    ...
    /// <p>The compliance status of the conformance pack.</p>
    pub fn compliance(mut self, input: super::super::types::AggregateConformancePackCompliance) -> Self {
        self.compliance = ::std::option::Option::Some(input);
        self
    }
    /// <p>The compliance status of the conformance pack.</p>
    pub fn set_compliance(mut self, input: ::std::option::Option<super::super::types::AggregateConformancePackCompliance>) -> Self {
        self.compliance = input;
        self
    }
    /// <p>The compliance status of the conformance pack.</p>
    pub fn get_compliance(&self) -> &::std::option::Option<super::super::types::AggregateConformancePackCompliance> {
        &self.compliance
    }
    /// <p>The 12-digit Amazon Web Services account ID of the source account.</p>
    ...
    pub fn build(self) -> super::super::types::AggregateComplianceByConformancePack {
        super::super::types::AggregateComplianceByConformancePack {
