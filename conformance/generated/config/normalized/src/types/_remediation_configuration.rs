...
pub struct RemediationConfiguration {
    ...
    pub target_type: super::super::types::RemediationTargetType,
    ...
    pub parameters: ::std::option::Option<::std::collections::HashMap<::std::string::String, super::super::types::RemediationParameterValue>>,
    /// <p>The type of a resource.</p>
    pub resource_type: ::std::option::Option<::std::string::String>,
    /// <p>The remediation is triggered automatically.</p>
    pub automatic: bool,
    /// <p>An ExecutionControls object.</p>
    pub execution_controls: ::std::option::Option<super::super::types::ExecutionControls>,
...
impl RemediationConfiguration {
    ...
    /// <p>The type of the target. Target executes remediation. For example, SSM document.</p>
    pub fn target_type(&self) -> &super::super::types::RemediationTargetType {
        &self.target_type
    }
    /// <p>Target ID is the name of the SSM document.</p>
    ...
    /// <p>An ExecutionControls object.</p>
    pub fn execution_controls(&self) -> ::std::option::Option<&super::super::types::ExecutionControls> {
...
impl RemediationConfiguration {
    ...
    pub fn builder() -> super::super::types::builders::RemediationConfigurationBuilder {
        super::super::types::builders::RemediationConfigurationBuilder::default()
    }
}
...
pub struct RemediationConfigurationBuilder {
    ...
    pub(crate) target_type: ::std::option::Option<super::super::types::RemediationTargetType>,
    pub(crate) target_id: ::std::option::Option<::std::string::String>,
    pub(crate) target_version: ::std::option::Option<::std::string::String>,
    pub(crate) parameters: ::std::option::Option<::std::collections::HashMap<::std::string::String, super::super::types::RemediationParameterValue>>,
    pub(crate) resource_type: ::std::option::Option<::std::string::String>,
    pub(crate) automatic: ::std::option::Option<bool>,
    pub(crate) execution_controls: ::std::option::Option<super::super::types::ExecutionControls>,
...
impl RemediationConfigurationBuilder {
    ...
    /// <p>The type of the target. Target executes remediation. For example, SSM document.</p>
    /// This field is required.
    pub fn target_type(mut self, input: super::super::types::RemediationTargetType) -> Self {
        self.target_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The type of the target. Target executes remediation. For example, SSM document.</p>
    pub fn set_target_type(mut self, input: ::std::option::Option<super::super::types::RemediationTargetType>) -> Self {
        self.target_type = input;
        self
    }
    /// <p>The type of the target. Target executes remediation. For example, SSM document.</p>
    pub fn get_target_type(&self) -> &::std::option::Option<super::super::types::RemediationTargetType> {
        &self.target_type
    }
    /// <p>Target ID is the name of the SSM document.</p>
    /// This field is required.
    ...
    ///
    /// <p>An object of the RemediationParameterValue.</p>
    pub fn parameters(mut self, k: impl ::std::convert::Into<::std::string::String>, v: super::super::types::RemediationParameterValue) -> Self {
    ...
    pub fn set_parameters(
        mut self,
        input: ::std::option::Option<::std::collections::HashMap<::std::string::String, super::super::types::RemediationParameterValue>>,
    ) -> Self {
    ...
    /// <p>An ExecutionControls object.</p>
    pub fn execution_controls(mut self, input: super::super::types::ExecutionControls) -> Self {
        self.execution_controls = ::std::option::Option::Some(input);
        self
    }
    /// <p>An ExecutionControls object.</p>
    pub fn set_execution_controls(mut self, input: ::std::option::Option<super::super::types::ExecutionControls>) -> Self {
        self.execution_controls = input;
        self
    }
    /// <p>An ExecutionControls object.</p>
    pub fn get_execution_controls(&self) -> &::std::option::Option<super::super::types::ExecutionControls> {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::RemediationConfiguration, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::RemediationConfiguration {
