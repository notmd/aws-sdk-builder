...
pub struct RecordingModeOverride {
    ...
    /// </ul>
    /// </important>
    pub resource_types: ::std::vec::Vec<super::super::types::ResourceType>,
...
impl RecordingModeOverride {
    ...
    pub fn builder() -> super::super::types::builders::RecordingModeOverrideBuilder {
        super::super::types::builders::RecordingModeOverrideBuilder::default()
    }
}
...
impl RecordingModeOverrideBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::RecordingModeOverride, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::RecordingModeOverride {
