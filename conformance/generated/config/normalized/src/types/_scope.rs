...
impl Scope {
    ...
    pub fn builder() -> super::super::types::builders::ScopeBuilder {
        super::super::types::builders::ScopeBuilder::default()
    }
}
...
impl ScopeBuilder {
    ...
    pub fn build(self) -> super::super::types::Scope {
        super::super::types::Scope {
