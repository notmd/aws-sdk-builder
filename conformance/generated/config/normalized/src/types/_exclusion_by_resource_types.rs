...
impl ExclusionByResourceTypes {
    ...
    pub fn builder() -> super::super::types::builders::ExclusionByResourceTypesBuilder {
        super::super::types::builders::ExclusionByResourceTypesBuilder::default()
    }
}
...
impl ExclusionByResourceTypesBuilder {
    ...
    pub fn build(self) -> super::super::types::ExclusionByResourceTypes {
        super::super::types::ExclusionByResourceTypes {
