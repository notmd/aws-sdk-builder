...
impl AggregationAuthorization {
    ...
    pub fn builder() -> super::super::types::builders::AggregationAuthorizationBuilder {
        super::super::types::builders::AggregationAuthorizationBuilder::default()
    }
}
...
impl AggregationAuthorizationBuilder {
    ...
    pub fn build(self) -> super::super::types::AggregationAuthorization {
        super::super::types::AggregationAuthorization {
