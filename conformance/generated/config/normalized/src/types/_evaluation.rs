...
impl Evaluation {
    ...
    pub fn builder() -> super::super::types::builders::EvaluationBuilder {
        super::super::types::builders::EvaluationBuilder::default()
    }
}
...
impl EvaluationBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::Evaluation, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::Evaluation {
