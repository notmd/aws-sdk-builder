...
impl AggregatorFilterResourceType {
    ...
    pub fn builder() -> super::super::types::builders::AggregatorFilterResourceTypeBuilder {
        super::super::types::builders::AggregatorFilterResourceTypeBuilder::default()
    }
}
...
impl AggregatorFilterResourceTypeBuilder {
    ...
    pub fn build(self) -> super::super::types::AggregatorFilterResourceType {
        super::super::types::AggregatorFilterResourceType {
            r#type: self.r#type,
            value: self.value,
        }
    }
