...
impl ConfigRuleComplianceSummaryFilters {
    ...
    pub fn builder() -> super::super::types::builders::ConfigRuleComplianceSummaryFiltersBuilder {
        super::super::types::builders::ConfigRuleComplianceSummaryFiltersBuilder::default()
    }
}
...
impl ConfigRuleComplianceSummaryFiltersBuilder {
    ...
    pub fn build(self) -> super::super::types::ConfigRuleComplianceSummaryFilters {
        super::super::types::ConfigRuleComplianceSummaryFilters {
