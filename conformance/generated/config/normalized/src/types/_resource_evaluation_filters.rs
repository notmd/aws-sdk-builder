...
pub struct ResourceEvaluationFilters {
    ...
    pub time_window: ::std::option::Option<super::super::types::TimeWindow>,
...
impl ResourceEvaluationFilters {
    ...
    /// <p>Returns a <code>TimeWindow</code> object.</p>
    pub fn time_window(&self) -> ::std::option::Option<&super::super::types::TimeWindow> {
...
impl ResourceEvaluationFilters {
    ...
    pub fn builder() -> super::super::types::builders::ResourceEvaluationFiltersBuilder {
        super::super::types::builders::ResourceEvaluationFiltersBuilder::default()
    }
}
...
pub struct ResourceEvaluationFiltersBuilder {
    ...
    pub(crate) time_window: ::std::option::Option<super::super::types::TimeWindow>,
...
impl ResourceEvaluationFiltersBuilder {
    ...
    /// <p>Returns a <code>TimeWindow</code> object.</p>
    pub fn time_window(mut self, input: super::super::types::TimeWindow) -> Self {
        self.time_window = ::std::option::Option::Some(input);
        self
    }
    /// <p>Returns a <code>TimeWindow</code> object.</p>
    pub fn set_time_window(mut self, input: ::std::option::Option<super::super::types::TimeWindow>) -> Self {
        self.time_window = input;
        self
    }
    /// <p>Returns a <code>TimeWindow</code> object.</p>
    pub fn get_time_window(&self) -> &::std::option::Option<super::super::types::TimeWindow> {
        &self.time_window
    }
    /// <p>Filters evaluations for a given infrastructure deployment. For example: CFN Stack.</p>
    ...
    pub fn build(self) -> super::super::types::ResourceEvaluationFilters {
        super::super::types::ResourceEvaluationFilters {
