...
pub struct ConfigurationAggregator {
    ...
    pub account_aggregation_sources: ::std::option::Option<::std::vec::Vec<super::super::types::AccountAggregationSource>>,
    /// <p>Provides an organization and list of regions to be aggregated.</p>
    pub organization_aggregation_source: ::std::option::Option<super::super::types::OrganizationAggregationSource>,
    ...
    pub aggregator_filters: ::std::option::Option<super::super::types::AggregatorFilters>,
}
impl ConfigurationAggregator {
    ...
    pub fn account_aggregation_sources(&self) -> &[super::super::types::AccountAggregationSource] {
        self.account_aggregation_sources.as_deref().unwrap_or_default()
    }
    /// <p>Provides an organization and list of regions to be aggregated.</p>
    pub fn organization_aggregation_source(&self) -> ::std::option::Option<&super::super::types::OrganizationAggregationSource> {
    ...
    /// <p>An object to filter the data you specify for an aggregator.</p>
    pub fn aggregator_filters(&self) -> ::std::option::Option<&super::super::types::AggregatorFilters> {
...
impl ConfigurationAggregator {
    ...
    pub fn builder() -> super::super::types::builders::ConfigurationAggregatorBuilder {
        super::super::types::builders::ConfigurationAggregatorBuilder::default()
    }
}
...
pub struct ConfigurationAggregatorBuilder {
    ...
    pub(crate) account_aggregation_sources: ::std::option::Option<::std::vec::Vec<super::super::types::AccountAggregationSource>>,
    pub(crate) organization_aggregation_source: ::std::option::Option<super::super::types::OrganizationAggregationSource>,
    pub(crate) creation_time: ::std::option::Option<::aws_smithy_types::DateTime>,
    pub(crate) last_updated_time: ::std::option::Option<::aws_smithy_types::DateTime>,
    pub(crate) created_by: ::std::option::Option<::std::string::String>,
    pub(crate) aggregator_filters: ::std::option::Option<super::super::types::AggregatorFilters>,
}
impl ConfigurationAggregatorBuilder {
    ...
    ///
    /// <p>Provides a list of source accounts and regions to be aggregated.</p>
    pub fn account_aggregation_sources(mut self, input: super::super::types::AccountAggregationSource) -> Self {
    ...
    /// <p>Provides a list of source accounts and regions to be aggregated.</p>
    pub fn get_account_aggregation_sources(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::AccountAggregationSource>> {
        &self.account_aggregation_sources
    }
    /// <p>Provides an organization and list of regions to be aggregated.</p>
    pub fn organization_aggregation_source(mut self, input: super::super::types::OrganizationAggregationSource) -> Self {
        self.organization_aggregation_source = ::std::option::Option::Some(input);
        self
    }
    /// <p>Provides an organization and list of regions to be aggregated.</p>
    pub fn set_organization_aggregation_source(mut self, input: ::std::option::Option<super::super::types::OrganizationAggregationSource>) -> Self {
        self.organization_aggregation_source = input;
        self
    }
    /// <p>Provides an organization and list of regions to be aggregated.</p>
    pub fn get_organization_aggregation_source(&self) -> &::std::option::Option<super::super::types::OrganizationAggregationSource> {
    ...
    /// <p>An object to filter the data you specify for an aggregator.</p>
    pub fn aggregator_filters(mut self, input: super::super::types::AggregatorFilters) -> Self {
        self.aggregator_filters = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object to filter the data you specify for an aggregator.</p>
    pub fn set_aggregator_filters(mut self, input: ::std::option::Option<super::super::types::AggregatorFilters>) -> Self {
        self.aggregator_filters = input;
        self
    }
    /// <p>An object to filter the data you specify for an aggregator.</p>
    pub fn get_aggregator_filters(&self) -> &::std::option::Option<super::super::types::AggregatorFilters> {
        &self.aggregator_filters
    }
    /// Consumes the builder and constructs a [`ConfigurationAggregator`](crate::types::ConfigurationAggregator).
    pub fn build(self) -> super::super::types::ConfigurationAggregator {
        super::super::types::ConfigurationAggregator {
