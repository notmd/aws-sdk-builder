...
impl ComplianceByResource {
    ...
    pub fn builder() -> super::super::types::builders::ComplianceByResourceBuilder {
        super::super::types::builders::ComplianceByResourceBuilder::default()
    }
}
...
impl ComplianceByResourceBuilder {
    ...
    pub fn build(self) -> super::super::types::ComplianceByResource {
        super::super::types::ComplianceByResource {
