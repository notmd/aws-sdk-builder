...
impl EvaluationResultQualifier {
    ...
    pub fn builder() -> super::super::types::builders::EvaluationResultQualifierBuilder {
        super::super::types::builders::EvaluationResultQualifierBuilder::default()
    }
}
...
impl EvaluationResultQualifierBuilder {
    ...
    pub fn build(self) -> super::super::types::EvaluationResultQualifier {
        super::super::types::EvaluationResultQualifier {
