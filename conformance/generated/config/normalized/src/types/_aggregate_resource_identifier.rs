...
pub struct AggregateResourceIdentifier {
    ...
    pub resource_type: super::super::types::ResourceType,
...
impl AggregateResourceIdentifier {
    ...
    /// <p>The type of the Amazon Web Services resource.</p>
    pub fn resource_type(&self) -> &super::super::types::ResourceType {
        &self.resource_type
    }
    /// <p>The name of the Amazon Web Services resource.</p>
...
impl AggregateResourceIdentifier {
    ...
    pub fn builder() -> super::super::types::builders::AggregateResourceIdentifierBuilder {
        super::super::types::builders::AggregateResourceIdentifierBuilder::default()
    }
}
...
impl AggregateResourceIdentifierBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::AggregateResourceIdentifier, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::AggregateResourceIdentifier {
