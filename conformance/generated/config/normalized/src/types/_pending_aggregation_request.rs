...
impl PendingAggregationRequest {
    ...
    pub fn builder() -> super::super::types::builders::PendingAggregationRequestBuilder {
        super::super::types::builders::PendingAggregationRequestBuilder::default()
    }
}
...
impl PendingAggregationRequestBuilder {
    ...
    pub fn build(self) -> super::super::types::PendingAggregationRequest {
        super::super::types::PendingAggregationRequest {
