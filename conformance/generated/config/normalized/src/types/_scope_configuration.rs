...
impl ScopeConfiguration {
    ...
    pub fn builder() -> super::super::types::builders::ScopeConfigurationBuilder {
        super::super::types::builders::ScopeConfigurationBuilder::default()
    }
}
...
impl ScopeConfigurationBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::ScopeConfiguration, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::ScopeConfiguration {
