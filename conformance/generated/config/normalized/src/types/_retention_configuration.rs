...
impl RetentionConfiguration {
    ...
    pub fn builder() -> super::super::types::builders::RetentionConfigurationBuilder {
        super::super::types::builders::RetentionConfigurationBuilder::default()
    }
}
...
impl RetentionConfigurationBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::RetentionConfiguration, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::RetentionConfiguration {
