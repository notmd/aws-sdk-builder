...
pub struct ConformancePackEvaluationResult {
    ...
    pub compliance_type: super::super::types::ConformancePackComplianceType,
...
impl ConformancePackEvaluationResult {
    /// <p>The compliance type. The allowed values are <code>COMPLIANT</code> and <code>NON_COMPLIANT</code>. <code>INSUFFICIENT_DATA</code> is not supported.</p>
    pub fn compliance_type(&self) -> &super::super::types::ConformancePackComplianceType {
...
impl ConformancePackEvaluationResult {
    ...
    pub fn builder() -> super::super::types::builders::ConformancePackEvaluationResultBuilder {
        super::super::types::builders::ConformancePackEvaluationResultBuilder::default()
    }
}
...
pub struct ConformancePackEvaluationResultBuilder {
    pub(crate) compliance_type: ::std::option::Option<super::super::types::ConformancePackComplianceType>,
...
impl ConformancePackEvaluationResultBuilder {
    ...
    pub fn compliance_type(mut self, input: super::super::types::ConformancePackComplianceType) -> Self {
        self.compliance_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The compliance type. The allowed values are <code>COMPLIANT</code> and <code>NON_COMPLIANT</code>. <code>INSUFFICIENT_DATA</code> is not supported.</p>
    pub fn set_compliance_type(mut self, input: ::std::option::Option<super::super::types::ConformancePackComplianceType>) -> Self {
        self.compliance_type = input;
        self
    }
    /// <p>The compliance type. The allowed values are <code>COMPLIANT</code> and <code>NON_COMPLIANT</code>. <code>INSUFFICIENT_DATA</code> is not supported.</p>
    pub fn get_compliance_type(&self) -> &::std::option::Option<super::super::types::ConformancePackComplianceType> {
        &self.compliance_type
    }
    /// <p>Uniquely identifies an evaluation result.</p>
    /// This field is required.
