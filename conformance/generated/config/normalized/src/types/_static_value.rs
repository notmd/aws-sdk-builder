...
impl StaticValue {
    ...
    pub fn builder() -> super::super::types::builders::StaticValueBuilder {
        super::super::types::builders::StaticValueBuilder::default()
    }
}
...
impl StaticValueBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::StaticValue, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::StaticValue {
