...
impl StoredQuery {
    ...
    pub fn builder() -> super::super::types::builders::StoredQueryBuilder {
        super::super::types::builders::StoredQueryBuilder::default()
    }
}
...
impl StoredQueryBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::StoredQuery, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::StoredQuery {
