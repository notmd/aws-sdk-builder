...
pub struct ConformancePackComplianceSummary {
    ...
    pub conformance_pack_compliance_status: super::super::types::ConformancePackComplianceType,
}
impl ConformancePackComplianceSummary {
    ...
    /// <p>The status of the conformance pack.</p>
    pub fn conformance_pack_compliance_status(&self) -> &super::super::types::ConformancePackComplianceType {
...
impl ConformancePackComplianceSummary {
    ...
    pub fn builder() -> super::super::types::builders::ConformancePackComplianceSummaryBuilder {
        super::super::types::builders::ConformancePackComplianceSummaryBuilder::default()
    }
}
...
pub struct ConformancePackComplianceSummaryBuilder {
    ...
    pub(crate) conformance_pack_compliance_status: ::std::option::Option<super::super::types::ConformancePackComplianceType>,
}
impl ConformancePackComplianceSummaryBuilder {
    ...
    /// <p>The status of the conformance pack.</p>
    /// This field is required.
    pub fn conformance_pack_compliance_status(mut self, input: super::super::types::ConformancePackComplianceType) -> Self {
    ...
    /// <p>The status of the conformance pack.</p>
    pub fn get_conformance_pack_compliance_status(&self) -> &::std::option::Option<super::super::types::ConformancePackComplianceType> {
        &self.conformance_pack_compliance_status
    }
