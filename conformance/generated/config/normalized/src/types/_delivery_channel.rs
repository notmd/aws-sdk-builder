...
pub struct DeliveryChannel {
    ...
    pub config_snapshot_delivery_properties: ::std::option::Option<super::super::types::ConfigSnapshotDeliveryProperties>,
}
impl DeliveryChannel {
    ...
    /// <p>The options for how often Config delivers configuration snapshots to the Amazon S3 bucket.</p>
    pub fn config_snapshot_delivery_properties(&self) -> ::std::option::Option<&super::super::types::ConfigSnapshotDeliveryProperties> {
...
impl DeliveryChannel {
    ...
    pub fn builder() -> super::super::types::builders::DeliveryChannelBuilder {
        super::super::types::builders::DeliveryChannelBuilder::default()
    }
}
...
pub struct DeliveryChannelBuilder {
    ...
    pub(crate) config_snapshot_delivery_properties: ::std::option::Option<super::super::types::ConfigSnapshotDeliveryProperties>,
}
impl DeliveryChannelBuilder {
    ...
    /// <p>The options for how often Config delivers configuration snapshots to the Amazon S3 bucket.</p>
    pub fn config_snapshot_delivery_properties(mut self, input: super::super::types::ConfigSnapshotDeliveryProperties) -> Self {
    ...
    /// <p>The options for how often Config delivers configuration snapshots to the Amazon S3 bucket.</p>
    pub fn get_config_snapshot_delivery_properties(&self) -> &::std::option::Option<super::super::types::ConfigSnapshotDeliveryProperties> {
    ...
    pub fn build(self) -> super::super::types::DeliveryChannel {
        super::super::types::DeliveryChannel {
            name: self.name,
