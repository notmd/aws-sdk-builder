...
impl ResourceIdentifier {
    ...
    pub fn builder() -> super::super::types::builders::ResourceIdentifierBuilder {
        super::super::types::builders::ResourceIdentifierBuilder::default()
    }
}
...
impl ResourceIdentifierBuilder {
    ...
    pub fn build(self) -> super::super::types::ResourceIdentifier {
        super::super::types::ResourceIdentifier {
