...
pub struct RemediationExecutionStep {
    ...
    pub state: ::std::option::Option<super::super::types::RemediationExecutionStepState>,
...
impl RemediationExecutionStep {
    ...
    /// <p>The valid status of the step.</p>
    pub fn state(&self) -> ::std::option::Option<&super::super::types::RemediationExecutionStepState> {
        self.state.as_ref()
    }
    /// <p>An error message if the step was interrupted during execution.</p>
...
impl RemediationExecutionStep {
    ...
    pub fn builder() -> super::super::types::builders::RemediationExecutionStepBuilder {
        super::super::types::builders::RemediationExecutionStepBuilder::default()
    }
}
...
pub struct RemediationExecutionStepBuilder {
    ...
    pub(crate) state: ::std::option::Option<super::super::types::RemediationExecutionStepState>,
...
impl RemediationExecutionStepBuilder {
    ...
    /// <p>The valid status of the step.</p>
    pub fn state(mut self, input: super::super::types::RemediationExecutionStepState) -> Self {
        self.state = ::std::option::Option::Some(input);
        self
    }
    /// <p>The valid status of the step.</p>
    pub fn set_state(mut self, input: ::std::option::Option<super::super::types::RemediationExecutionStepState>) -> Self {
        self.state = input;
        self
    }
    /// <p>The valid status of the step.</p>
    pub fn get_state(&self) -> &::std::option::Option<super::super::types::RemediationExecutionStepState> {
        &self.state
    }
    /// <p>An error message if the step was interrupted during execution.</p>
    ...
    pub fn build(self) -> super::super::types::RemediationExecutionStep {
        super::super::types::RemediationExecutionStep {
            name: self.name,
            state: self.state,
