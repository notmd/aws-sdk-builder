...
pub struct SourceDetail {
    ...
    pub event_source: ::std::option::Option<super::super::types::EventSource>,
...
impl SourceDetail {
    /// <p>The source of the event, such as an Amazon Web Services service, that triggers Config to evaluate your Amazon Web Services resources.</p>
    pub fn event_source(&self) -> ::std::option::Option<&super::super::types::EventSource> {
    ...
    /// </ul>
    /// <p>If you want your custom rule to be triggered by configuration changes, specify two SourceDetail objects, one for <code>ConfigurationItemChangeNotification</code> and one for <code>OversizedConfigurationItemChangeNotification</code>.</p>
    pub fn message_type(&self) -> ::std::option::Option<&super::super::types::MessageType> {
...
impl SourceDetail {
    ...
    pub fn builder() -> super::super::types::builders::SourceDetailBuilder {
        super::super::types::builders::SourceDetailBuilder::default()
    }
}
...
pub struct SourceDetailBuilder {
    pub(crate) event_source: ::std::option::Option<super::super::types::EventSource>,
    pub(crate) message_type: ::std::option::Option<super::super::types::MessageType>,
...
impl SourceDetailBuilder {
    /// <p>The source of the event, such as an Amazon Web Services service, that triggers Config to evaluate your Amazon Web Services resources.</p>
    pub fn event_source(mut self, input: super::super::types::EventSource) -> Self {
        self.event_source = ::std::option::Option::Some(input);
        self
    }
    /// <p>The source of the event, such as an Amazon Web Services service, that triggers Config to evaluate your Amazon Web Services resources.</p>
    pub fn set_event_source(mut self, input: ::std::option::Option<super::super::types::EventSource>) -> Self {
        self.event_source = input;
        self
    }
    /// <p>The source of the event, such as an Amazon Web Services service, that triggers Config to evaluate your Amazon Web Services resources.</p>
    pub fn get_event_source(&self) -> &::std::option::Option<super::super::types::EventSource> {
        &self.event_source
    }
    /// <p>The type of notification that triggers Config to run an evaluation for a rule. You can specify the following notification types:</p>
    /// <ul>
    ...
    /// </ul>
    /// <p>If you want your custom rule to be triggered by configuration changes, specify two SourceDetail objects, one for <code>ConfigurationItemChangeNotification</code> and one for <code>OversizedConfigurationItemChangeNotification</code>.</p>
    pub fn message_type(mut self, input: super::super::types::MessageType) -> Self {
    ...
    /// </ul>
    /// <p>If you want your custom rule to be triggered by configuration changes, specify two SourceDetail objects, one for <code>ConfigurationItemChangeNotification</code> and one for <code>OversizedConfigurationItemChangeNotification</code>.</p>
    pub fn set_message_type(mut self, input: ::std::option::Option<super::super::types::MessageType>) -> Self {
    ...
    /// </ul>
    /// <p>If you want your custom rule to be triggered by configuration changes, specify two SourceDetail objects, one for <code>ConfigurationItemChangeNotification</code> and one for <code>OversizedConfigurationItemChangeNotification</code>.</p>
    pub fn get_message_type(&self) -> &::std::option::Option<super::super::types::MessageType> {
        &self.message_type
    }
    /// <p>The frequency at which you want Config to run evaluations for a custom rule with a periodic trigger. If you specify a value for <code>MaximumExecutionFrequency</code>, then <code>MessageType</code> must use the <code>ScheduledNotification</code> value.</p><note>
    /// <p>By default, rules with a periodic trigger are evaluated every 24 hours. To change the frequency, specify a valid value for the <code>MaximumExecutionFrequency</code> parameter.</p>
    ...
    pub fn build(self) -> super::super::types::SourceDetail {
        super::super::types::SourceDetail {
