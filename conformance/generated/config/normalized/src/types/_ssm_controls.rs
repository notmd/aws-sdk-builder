...
impl SsmControls {
    ...
    pub fn builder() -> super::super::types::builders::SsmControlsBuilder {
        super::super::types::builders::SsmControlsBuilder::default()
    }
}
...
impl SsmControlsBuilder {
    ...
    pub fn build(self) -> super::super::types::SsmControls {
        super::super::types::SsmControls {
