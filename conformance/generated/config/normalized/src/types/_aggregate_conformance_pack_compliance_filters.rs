...
pub struct AggregateConformancePackComplianceFilters {
    ...
    pub compliance_type: ::std::option::Option<super::super::types::ConformancePackComplianceType>,
...
impl AggregateConformancePackComplianceFilters {
    ...
    /// <p>The compliance status of the conformance pack.</p>
    pub fn compliance_type(&self) -> ::std::option::Option<&super::super::types::ConformancePackComplianceType> {
...
impl AggregateConformancePackComplianceFilters {
    ...
    pub fn builder() -> super::super::types::builders::AggregateConformancePackComplianceFiltersBuilder {
        super::super::types::builders::AggregateConformancePackComplianceFiltersBuilder::default()
    }
}
...
impl AggregateConformancePackComplianceFiltersBuilder {
    ...
    pub fn build(self) -> super::super::types::AggregateConformancePackComplianceFilters {
        super::super::types::AggregateConformancePackComplianceFilters {
