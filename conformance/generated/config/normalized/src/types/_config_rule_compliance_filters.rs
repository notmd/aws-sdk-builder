...
impl ConfigRuleComplianceFilters {
    ...
    pub fn builder() -> super::super::types::builders::ConfigRuleComplianceFiltersBuilder {
        super::super::types::builders::ConfigRuleComplianceFiltersBuilder::default()
    }
}
...
impl ConfigRuleComplianceFiltersBuilder {
    ...
    pub fn build(self) -> super::super::types::ConfigRuleComplianceFilters {
        super::super::types::ConfigRuleComplianceFilters {
