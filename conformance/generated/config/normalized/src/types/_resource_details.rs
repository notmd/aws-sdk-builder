...
pub struct ResourceDetails {
    ...
    /// </note>
    pub resource_configuration_schema_type: ::std::option::Option<super::super::types::ResourceConfigurationSchemaType>,
}
impl ResourceDetails {
    ...
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/registry.html#registry-view">Managing extensions through the CloudFormation registry</a> and <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-template-resource-type-ref.html">Amazon Web Services resource and property types reference</a> in the CloudFormation User Guide.</p>
    /// </note>
    pub fn resource_configuration_schema_type(&self) -> ::std::option::Option<&super::super::types::ResourceConfigurationSchemaType> {
...
impl ResourceDetails {
    ...
    pub fn builder() -> super::super::types::builders::ResourceDetailsBuilder {
        super::super::types::builders::ResourceDetailsBuilder::default()
    }
}
...
pub struct ResourceDetailsBuilder {
    ...
    pub(crate) resource_configuration_schema_type: ::std::option::Option<super::super::types::ResourceConfigurationSchemaType>,
}
impl ResourceDetailsBuilder {
    ...
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/registry.html#registry-view">Managing extensions through the CloudFormation registry</a> and <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-template-resource-type-ref.html">Amazon Web Services resource and property types reference</a> in the CloudFormation User Guide.</p>
    /// </note>
    pub fn resource_configuration_schema_type(mut self, input: super::super::types::ResourceConfigurationSchemaType) -> Self {
    ...
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/registry.html#registry-view">Managing extensions through the CloudFormation registry</a> and <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-template-resource-type-ref.html">Amazon Web Services resource and property types reference</a> in the CloudFormation User Guide.</p>
    /// </note>
    pub fn get_resource_configuration_schema_type(&self) -> &::std::option::Option<super::super::types::ResourceConfigurationSchemaType> {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::ResourceDetails, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::ResourceDetails {
