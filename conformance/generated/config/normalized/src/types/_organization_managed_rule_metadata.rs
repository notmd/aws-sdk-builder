...
impl OrganizationManagedRuleMetadata {
    ...
    pub fn builder() -> super::super::types::builders::OrganizationManagedRuleMetadataBuilder {
        super::super::types::builders::OrganizationManagedRuleMetadataBuilder::default()
    }
}
