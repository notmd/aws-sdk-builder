...
impl BaseConfigurationItem {
    ...
    pub fn builder() -> super::super::types::builders::BaseConfigurationItemBuilder {
        super::super::types::builders::BaseConfigurationItemBuilder::default()
    }
}
...
impl BaseConfigurationItemBuilder {
    ...
    pub fn build(self) -> super::super::types::BaseConfigurationItem {
        super::super::types::BaseConfigurationItem {
