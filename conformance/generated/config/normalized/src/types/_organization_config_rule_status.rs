...
pub struct OrganizationConfigRuleStatus {
    ...
    /// </ul>
    pub organization_rule_status: super::super::types::OrganizationRuleStatus,
...
impl OrganizationConfigRuleStatus {
    ...
    /// <p><code>UPDATE_FAILED</code> when an organization Config rule update failed in one or more member accounts within that organization.</p></li>
    /// </ul>
    pub fn organization_rule_status(&self) -> &super::super::types::OrganizationRuleStatus {
...
impl OrganizationConfigRuleStatus {
    ...
    pub fn builder() -> super::super::types::builders::OrganizationConfigRuleStatusBuilder {
        super::super::types::builders::OrganizationConfigRuleStatusBuilder::default()
    }
}
...
pub struct OrganizationConfigRuleStatusBuilder {
    ...
    pub(crate) organization_rule_status: ::std::option::Option<super::super::types::OrganizationRuleStatus>,
...
impl OrganizationConfigRuleStatusBuilder {
    ...
    /// </ul>
    /// This field is required.
    pub fn organization_rule_status(mut self, input: super::super::types::OrganizationRuleStatus) -> Self {
    ...
    /// <p><code>UPDATE_FAILED</code> when an organization Config rule update failed in one or more member accounts within that organization.</p></li>
    /// </ul>
    pub fn set_organization_rule_status(mut self, input: ::std::option::Option<super::super::types::OrganizationRuleStatus>) -> Self {
    ...
    /// <p><code>UPDATE_FAILED</code> when an organization Config rule update failed in one or more member accounts within that organization.</p></li>
    /// </ul>
    pub fn get_organization_rule_status(&self) -> &::std::option::Option<super::super::types::OrganizationRuleStatus> {
        &self.organization_rule_status
    }
    /// <p>An error code that is returned when organization Config rule creation or deletion has failed.</p>
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::OrganizationConfigRuleStatus, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::OrganizationConfigRuleStatus {
