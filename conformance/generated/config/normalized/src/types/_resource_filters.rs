...
impl ResourceFilters {
    ...
    pub fn builder() -> super::super::types::builders::ResourceFiltersBuilder {
        super::super::types::builders::ResourceFiltersBuilder::default()
    }
}
...
impl ResourceFiltersBuilder {
    ...
    pub fn build(self) -> super::super::types::ResourceFilters {
        super::super::types::ResourceFilters {
