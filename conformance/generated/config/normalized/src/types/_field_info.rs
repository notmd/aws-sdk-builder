...
impl FieldInfo {
    ...
    pub fn builder() -> super::super::types::builders::FieldInfoBuilder {
        super::super::types::builders::FieldInfoBuilder::default()
    }
}
...
impl FieldInfoBuilder {
    ...
    pub fn build(self) -> super::super::types::FieldInfo {
        super::super::types::FieldInfo { name: self.name }
    }
}
