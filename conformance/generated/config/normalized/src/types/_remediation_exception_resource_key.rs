...
impl RemediationExceptionResourceKey {
    ...
    pub fn builder() -> super::super::types::builders::RemediationExceptionResourceKeyBuilder {
        super::super::types::builders::RemediationExceptionResourceKeyBuilder::default()
    }
}
...
impl RemediationExceptionResourceKeyBuilder {
    ...
    pub fn build(self) -> super::super::types::RemediationExceptionResourceKey {
        super::super::types::RemediationExceptionResourceKey {
