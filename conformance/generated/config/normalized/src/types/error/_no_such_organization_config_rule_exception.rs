...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::NoSuchOrganizationConfigRuleException {
...
impl NoSuchOrganizationConfigRuleException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::NoSuchOrganizationConfigRuleExceptionBuilder {
        super::super::super::types::error::builders::NoSuchOrganizationConfigRuleExceptionBuilder::default()
    }
}
...
impl NoSuchOrganizationConfigRuleExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::NoSuchOrganizationConfigRuleException {
        super::super::super::types::error::NoSuchOrganizationConfigRuleException {
