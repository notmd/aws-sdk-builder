...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::OrganizationAccessDeniedException {
...
impl OrganizationAccessDeniedException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::OrganizationAccessDeniedExceptionBuilder {
        super::super::super::types::error::builders::OrganizationAccessDeniedExceptionBuilder::default()
    }
}
...
impl OrganizationAccessDeniedExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::OrganizationAccessDeniedException {
        super::super::super::types::error::OrganizationAccessDeniedException {
