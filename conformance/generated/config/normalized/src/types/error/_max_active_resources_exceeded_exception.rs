...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::MaxActiveResourcesExceededException {
...
impl MaxActiveResourcesExceededException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::MaxActiveResourcesExceededExceptionBuilder {
        super::super::super::types::error::builders::MaxActiveResourcesExceededExceptionBuilder::default()
    }
}
...
impl MaxActiveResourcesExceededExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::MaxActiveResourcesExceededException {
        super::super::super::types::error::MaxActiveResourcesExceededException {
