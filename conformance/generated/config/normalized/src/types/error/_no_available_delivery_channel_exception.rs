...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::NoAvailableDeliveryChannelException {
...
impl NoAvailableDeliveryChannelException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::NoAvailableDeliveryChannelExceptionBuilder {
        super::super::super::types::error::builders::NoAvailableDeliveryChannelExceptionBuilder::default()
    }
}
...
impl NoAvailableDeliveryChannelExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::NoAvailableDeliveryChannelException {
        super::super::super::types::error::NoAvailableDeliveryChannelException {
