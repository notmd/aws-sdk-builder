...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::MaxNumberOfConfigRulesExceededException {
...
impl MaxNumberOfConfigRulesExceededException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::MaxNumberOfConfigRulesExceededExceptionBuilder {
        super::super::super::types::error::builders::MaxNumberOfConfigRulesExceededExceptionBuilder::default()
    }
}
...
impl MaxNumberOfConfigRulesExceededExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::MaxNumberOfConfigRulesExceededException {
        super::super::super::types::error::MaxNumberOfConfigRulesExceededException {
