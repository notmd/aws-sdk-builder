...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::MaxNumberOfOrganizationConfigRulesExceededException {
...
impl MaxNumberOfOrganizationConfigRulesExceededException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::MaxNumberOfOrganizationConfigRulesExceededExceptionBuilder {
        super::super::super::types::error::builders::MaxNumberOfOrganizationConfigRulesExceededExceptionBuilder::default()
    }
}
...
impl MaxNumberOfOrganizationConfigRulesExceededExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::MaxNumberOfOrganizationConfigRulesExceededException {
        super::super::super::types::error::MaxNumberOfOrganizationConfigRulesExceededException {
