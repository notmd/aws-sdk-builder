...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::InvalidRecordingGroupException {
...
impl InvalidRecordingGroupException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::InvalidRecordingGroupExceptionBuilder {
        super::super::super::types::error::builders::InvalidRecordingGroupExceptionBuilder::default()
    }
}
...
impl InvalidRecordingGroupExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::InvalidRecordingGroupException {
        super::super::super::types::error::InvalidRecordingGroupException {
