...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::NoSuchBucketException {
...
impl NoSuchBucketException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::NoSuchBucketExceptionBuilder {
        super::super::super::types::error::builders::NoSuchBucketExceptionBuilder::default()
    }
}
...
impl NoSuchBucketExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::NoSuchBucketException {
        super::super::super::types::error::NoSuchBucketException {
