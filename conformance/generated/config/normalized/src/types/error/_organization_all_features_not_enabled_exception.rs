...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::OrganizationAllFeaturesNotEnabledException {
...
impl OrganizationAllFeaturesNotEnabledException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::OrganizationAllFeaturesNotEnabledExceptionBuilder {
        super::super::super::types::error::builders::OrganizationAllFeaturesNotEnabledExceptionBuilder::default()
    }
}
...
impl OrganizationAllFeaturesNotEnabledExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::OrganizationAllFeaturesNotEnabledException {
        super::super::super::types::error::OrganizationAllFeaturesNotEnabledException {
