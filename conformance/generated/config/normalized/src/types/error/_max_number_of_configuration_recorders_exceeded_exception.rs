...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::MaxNumberOfConfigurationRecordersExceededException {
...
impl MaxNumberOfConfigurationRecordersExceededException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::MaxNumberOfConfigurationRecordersExceededExceptionBuilder {
        super::super::super::types::error::builders::MaxNumberOfConfigurationRecordersExceededExceptionBuilder::default()
    }
}
...
impl MaxNumberOfConfigurationRecordersExceededExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::MaxNumberOfConfigurationRecordersExceededException {
        super::super::super::types::error::MaxNumberOfConfigurationRecordersExceededException {
