...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::NoSuchOrganizationConformancePackException {
...
impl NoSuchOrganizationConformancePackException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::NoSuchOrganizationConformancePackExceptionBuilder {
        super::super::super::types::error::builders::NoSuchOrganizationConformancePackExceptionBuilder::default()
    }
}
...
impl NoSuchOrganizationConformancePackExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::NoSuchOrganizationConformancePackException {
        super::super::super::types::error::NoSuchOrganizationConformancePackException {
