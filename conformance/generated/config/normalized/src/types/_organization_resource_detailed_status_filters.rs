...
pub struct OrganizationResourceDetailedStatusFilters {
    ...
    /// </ul>
    pub status: ::std::option::Option<super::super::types::OrganizationResourceDetailedStatus>,
}
impl OrganizationResourceDetailedStatusFilters {
    ...
    /// <p><code>UPDATE_FAILED</code> when conformance pack deletion has failed in the member account.</p></li>
    /// </ul>
    pub fn status(&self) -> ::std::option::Option<&super::super::types::OrganizationResourceDetailedStatus> {
        self.status.as_ref()
    }
}
impl OrganizationResourceDetailedStatusFilters {
    ...
    pub fn builder() -> super::super::types::builders::OrganizationResourceDetailedStatusFiltersBuilder {
        super::super::types::builders::OrganizationResourceDetailedStatusFiltersBuilder::default()
    }
}
...
impl OrganizationResourceDetailedStatusFiltersBuilder {
    ...
    pub fn build(self) -> super::super::types::OrganizationResourceDetailedStatusFilters {
        super::super::types::OrganizationResourceDetailedStatusFilters {
