...
pub struct AggregateEvaluationResult {
    ...
    pub evaluation_result_identifier: ::std::option::Option<super::super::types::EvaluationResultIdentifier>,
    ...
    pub compliance_type: ::std::option::Option<super::super::types::ComplianceType>,
...
impl AggregateEvaluationResult {
    /// <p>Uniquely identifies the evaluation result.</p>
    pub fn evaluation_result_identifier(&self) -> ::std::option::Option<&super::super::types::EvaluationResultIdentifier> {
        self.evaluation_result_identifier.as_ref()
    }
    /// <p>The resource compliance status.</p>
    /// <p>For the <code>AggregationEvaluationResult</code> data type, Config supports only the <code>COMPLIANT</code> and <code>NON_COMPLIANT</code>. Config does not support the <code>NOT_APPLICABLE</code> and <code>INSUFFICIENT_DATA</code> value.</p>
    pub fn compliance_type(&self) -> ::std::option::Option<&super::super::types::ComplianceType> {
...
impl AggregateEvaluationResult {
    ...
    pub fn builder() -> super::super::types::builders::AggregateEvaluationResultBuilder {
        super::super::types::builders::AggregateEvaluationResultBuilder::default()
    }
}
...
pub struct AggregateEvaluationResultBuilder {
    pub(crate) evaluation_result_identifier: ::std::option::Option<super::super::types::EvaluationResultIdentifier>,
    pub(crate) compliance_type: ::std::option::Option<super::super::types::ComplianceType>,
...
impl AggregateEvaluationResultBuilder {
    /// <p>Uniquely identifies the evaluation result.</p>
    pub fn evaluation_result_identifier(mut self, input: super::super::types::EvaluationResultIdentifier) -> Self {
        self.evaluation_result_identifier = ::std::option::Option::Some(input);
        self
    }
    /// <p>Uniquely identifies the evaluation result.</p>
    pub fn set_evaluation_result_identifier(mut self, input: ::std::option::Option<super::super::types::EvaluationResultIdentifier>) -> Self {
        self.evaluation_result_identifier = input;
        self
    }
    /// <p>Uniquely identifies the evaluation result.</p>
    pub fn get_evaluation_result_identifier(&self) -> &::std::option::Option<super::super::types::EvaluationResultIdentifier> {
        &self.evaluation_result_identifier
    }
    /// <p>The resource compliance status.</p>
    /// <p>For the <code>AggregationEvaluationResult</code> data type, Config supports only the <code>COMPLIANT</code> and <code>NON_COMPLIANT</code>. Config does not support the <code>NOT_APPLICABLE</code> and <code>INSUFFICIENT_DATA</code> value.</p>
    pub fn compliance_type(mut self, input: super::super::types::ComplianceType) -> Self {
        self.compliance_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The resource compliance status.</p>
    /// <p>For the <code>AggregationEvaluationResult</code> data type, Config supports only the <code>COMPLIANT</code> and <code>NON_COMPLIANT</code>. Config does not support the <code>NOT_APPLICABLE</code> and <code>INSUFFICIENT_DATA</code> value.</p>
    pub fn set_compliance_type(mut self, input: ::std::option::Option<super::super::types::ComplianceType>) -> Self {
        self.compliance_type = input;
        self
    }
    /// <p>The resource compliance status.</p>
    /// <p>For the <code>AggregationEvaluationResult</code> data type, Config supports only the <code>COMPLIANT</code> and <code>NON_COMPLIANT</code>. Config does not support the <code>NOT_APPLICABLE</code> and <code>INSUFFICIENT_DATA</code> value.</p>
    pub fn get_compliance_type(&self) -> &::std::option::Option<super::super::types::ComplianceType> {
    ...
    pub fn build(self) -> super::super::types::AggregateEvaluationResult {
        super::super::types::AggregateEvaluationResult {
