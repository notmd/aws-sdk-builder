...
pub struct ConfigurationRecorderSummary {
    ...
    pub recording_scope: super::super::types::RecordingScope,
    ...
    pub provider: ::std::option::Option<super::super::types::Provider>,
}
impl ConfigurationRecorderSummary {
    ...
    /// <p>Indicates whether the <a href="https://docs.aws.amazon.com/config/latest/APIReference/API_ConfigurationItem.html">ConfigurationItems</a> in scope for the configuration recorder are recorded for free (<code>INTERNAL</code>) or if you are charged a service fee for recording (<code>PAID</code>).</p>
    pub fn recording_scope(&self) -> &super::super::types::RecordingScope {
        &self.recording_scope
    }
    /// <p>For service-linked configuration recorders that record resources from a third-party cloud service provider, indicates the cloud service provider. Currently, <code>AZURE</code> is supported.</p>
    pub fn provider(&self) -> ::std::option::Option<&super::super::types::Provider> {
...
impl ConfigurationRecorderSummary {
    ...
    pub fn builder() -> super::super::types::builders::ConfigurationRecorderSummaryBuilder {
        super::super::types::builders::ConfigurationRecorderSummaryBuilder::default()
    }
}
...
pub struct ConfigurationRecorderSummaryBuilder {
    ...
    pub(crate) provider: ::std::option::Option<super::super::types::Provider>,
}
impl ConfigurationRecorderSummaryBuilder {
    ...
    /// <p>For service-linked configuration recorders that record resources from a third-party cloud service provider, indicates the cloud service provider. Currently, <code>AZURE</code> is supported.</p>
    pub fn provider(mut self, input: super::super::types::Provider) -> Self {
        self.provider = ::std::option::Option::Some(input);
        self
    }
    /// <p>For service-linked configuration recorders that record resources from a third-party cloud service provider, indicates the cloud service provider. Currently, <code>AZURE</code> is supported.</p>
    pub fn set_provider(mut self, input: ::std::option::Option<super::super::types::Provider>) -> Self {
        self.provider = input;
        self
    }
    /// <p>For service-linked configuration recorders that record resources from a third-party cloud service provider, indicates the cloud service provider. Currently, <code>AZURE</code> is supported.</p>
    pub fn get_provider(&self) -> &::std::option::Option<super::super::types::Provider> {
        &self.provider
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::ConfigurationRecorderSummary, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::ConfigurationRecorderSummary {
