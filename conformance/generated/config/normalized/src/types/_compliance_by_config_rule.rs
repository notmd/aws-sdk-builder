...
impl ComplianceByConfigRule {
    ...
    pub fn builder() -> super::super::types::builders::ComplianceByConfigRuleBuilder {
        super::super::types::builders::ComplianceByConfigRuleBuilder::default()
    }
}
...
impl ComplianceByConfigRuleBuilder {
    ...
    pub fn build(self) -> super::super::types::ComplianceByConfigRule {
        super::super::types::ComplianceByConfigRule {
