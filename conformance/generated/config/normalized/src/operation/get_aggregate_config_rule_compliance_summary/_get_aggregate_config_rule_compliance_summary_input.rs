...
pub struct GetAggregateConfigRuleComplianceSummaryInput {
    ...
    pub filters: ::std::option::Option<super::super::super::types::ConfigRuleComplianceSummaryFilters>,
    /// <p>Groups the result based on ACCOUNT_ID or AWS_REGION.</p>
    pub group_by_key: ::std::option::Option<super::super::super::types::ConfigRuleComplianceSummaryGroupKey>,
...
impl GetAggregateConfigRuleComplianceSummaryInput {
    ...
    /// <p>Filters the results based on the ConfigRuleComplianceSummaryFilters object.</p>
    pub fn filters(&self) -> ::std::option::Option<&super::super::super::types::ConfigRuleComplianceSummaryFilters> {
        self.filters.as_ref()
    }
    /// <p>Groups the result based on ACCOUNT_ID or AWS_REGION.</p>
    pub fn group_by_key(&self) -> ::std::option::Option<&super::super::super::types::ConfigRuleComplianceSummaryGroupKey> {
...
pub struct GetAggregateConfigRuleComplianceSummaryInputBuilder {
    ...
    pub(crate) filters: ::std::option::Option<super::super::super::types::ConfigRuleComplianceSummaryFilters>,
    pub(crate) group_by_key: ::std::option::Option<super::super::super::types::ConfigRuleComplianceSummaryGroupKey>,
...
impl GetAggregateConfigRuleComplianceSummaryInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::get_aggregate_config_rule_compliance_summary::GetAggregateConfigRuleComplianceSummaryInput,
