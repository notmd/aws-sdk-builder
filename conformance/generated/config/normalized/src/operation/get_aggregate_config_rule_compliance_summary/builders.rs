...
pub use super::super::super::operation::get_aggregate_config_rule_compliance_summary::_get_aggregate_config_rule_compliance_summary_input::GetAggregateConfigRuleComplianceSummaryInputBuilder;

pub use super::super::super::operation::get_aggregate_config_rule_compliance_summary::_get_aggregate_config_rule_compliance_summary_output::GetAggregateConfigRuleComplianceSummaryOutputBuilder;

impl super::super::super::operation::get_aggregate_config_rule_compliance_summary::builders::GetAggregateConfigRuleComplianceSummaryInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::get_aggregate_config_rule_compliance_summary::GetAggregateConfigRuleComplianceSummaryError,
...
impl GetAggregateConfigRuleComplianceSummaryFluentBuilder {
    ...
    pub fn filters(mut self, input: super::super::super::types::ConfigRuleComplianceSummaryFilters) -> Self {
        self.inner = self.inner.filters(input);
        self
    }
    /// <p>Filters the results based on the ConfigRuleComplianceSummaryFilters object.</p>
    pub fn set_filters(mut self, input: ::std::option::Option<super::super::super::types::ConfigRuleComplianceSummaryFilters>) -> Self {
        self.inner = self.inner.set_filters(input);
        self
    }
    /// <p>Filters the results based on the ConfigRuleComplianceSummaryFilters object.</p>
    pub fn get_filters(&self) -> &::std::option::Option<super::super::super::types::ConfigRuleComplianceSummaryFilters> {
        self.inner.get_filters()
    }
    /// <p>Groups the result based on ACCOUNT_ID or AWS_REGION.</p>
    pub fn group_by_key(mut self, input: super::super::super::types::ConfigRuleComplianceSummaryGroupKey) -> Self {
        self.inner = self.inner.group_by_key(input);
        self
    }
    /// <p>Groups the result based on ACCOUNT_ID or AWS_REGION.</p>
    pub fn set_group_by_key(mut self, input: ::std::option::Option<super::super::super::types::ConfigRuleComplianceSummaryGroupKey>) -> Self {
        self.inner = self.inner.set_group_by_key(input);
        self
    }
    /// <p>Groups the result based on ACCOUNT_ID or AWS_REGION.</p>
    pub fn get_group_by_key(&self) -> &::std::option::Option<super::super::super::types::ConfigRuleComplianceSummaryGroupKey> {
