...
pub struct GetAggregateConfigRuleComplianceSummaryOutput {
    ...
    pub aggregate_compliance_counts: ::std::option::Option<::std::vec::Vec<super::super::super::types::AggregateComplianceCount>>,
...
impl GetAggregateConfigRuleComplianceSummaryOutput {
    ...
    pub fn aggregate_compliance_counts(&self) -> &[super::super::super::types::AggregateComplianceCount] {
...
pub struct GetAggregateConfigRuleComplianceSummaryOutputBuilder {
    ...
    pub(crate) aggregate_compliance_counts: ::std::option::Option<::std::vec::Vec<super::super::super::types::AggregateComplianceCount>>,
...
impl GetAggregateConfigRuleComplianceSummaryOutputBuilder {
    ...
    ///
    /// <p>Returns a list of AggregateComplianceCounts object.</p>
    pub fn aggregate_compliance_counts(mut self, input: super::super::super::types::AggregateComplianceCount) -> Self {
    ...
    /// <p>Returns a list of AggregateComplianceCounts object.</p>
    pub fn get_aggregate_compliance_counts(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::AggregateComplianceCount>> {
