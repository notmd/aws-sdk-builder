...
impl GetAggregateDiscoveredResourceCounts {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::super::operation::get_aggregate_discovered_resource_counts::GetAggregateDiscoveredResourceCountsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::get_aggregate_discovered_resource_counts::GetAggregateDiscoveredResourceCountsError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::get_aggregate_discovered_resource_counts::GetAggregateDiscoveredResourceCountsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::get_aggregate_discovered_resource_counts::GetAggregateDiscoveredResourceCountsOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetAggregateDiscoveredResourceCounts {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetAggregateDiscoveredResourceCounts")
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetAggregateDiscoveredResourceCountsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetAggregateDiscoveredResourceCountsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetAggregateDiscoveredResourceCountsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_get_aggregate_discovered_resource_counts::de_get_aggregate_discovered_resource_counts_http_error(
                status, headers, body,
            )
        } else {
            super::super::protocol_serde::shape_get_aggregate_discovered_resource_counts::de_get_aggregate_discovered_resource_counts_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetAggregateDiscoveredResourceCountsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::get_aggregate_discovered_resource_counts::GetAggregateDiscoveredResourceCountsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::get_aggregate_discovered_resource_counts::GetAggregateDiscoveredResourceCountsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_get_aggregate_discovered_resource_counts::ser_get_aggregate_discovered_resource_counts_input(&input)?,
        );
...
pub use super::super::operation::get_aggregate_discovered_resource_counts::_get_aggregate_discovered_resource_counts_input::GetAggregateDiscoveredResourceCountsInput;

pub use super::super::operation::get_aggregate_discovered_resource_counts::_get_aggregate_discovered_resource_counts_output::GetAggregateDiscoveredResourceCountsOutput;
