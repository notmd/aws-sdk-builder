...
pub use super::super::super::operation::delete_config_rule::_delete_config_rule_input::DeleteConfigRuleInputBuilder;

pub use super::super::super::operation::delete_config_rule::_delete_config_rule_output::DeleteConfigRuleOutputBuilder;

impl super::super::super::operation::delete_config_rule::builders::DeleteConfigRuleInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_config_rule::DeleteConfigRuleOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_config_rule::DeleteConfigRuleError,
...
pub struct DeleteConfigRuleFluentBuilder {
    ...
    inner: super::super::super::operation::delete_config_rule::builders::DeleteConfigRuleInputBuilder,
...
impl DeleteConfigRuleFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_config_rule::builders::DeleteConfigRuleInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_config_rule::DeleteConfigRule::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_config_rule::DeleteConfigRule::orchestrate(&runtime_plugins, input).await
    }
