...
impl DeleteConfigRuleOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_config_rule::builders::DeleteConfigRuleOutputBuilder {
        super::super::super::operation::delete_config_rule::builders::DeleteConfigRuleOutputBuilder::default()
    }
}
...
impl DeleteConfigRuleOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_config_rule::DeleteConfigRuleOutput {
