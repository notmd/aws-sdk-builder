...
pub struct DescribeAggregateComplianceByConfigRulesOutput {
    ...
    pub aggregate_compliance_by_config_rules: ::std::option::Option<::std::vec::Vec<super::super::super::types::AggregateComplianceByConfigRule>>,
...
impl DescribeAggregateComplianceByConfigRulesOutput {
    ...
    pub fn aggregate_compliance_by_config_rules(&self) -> &[super::super::super::types::AggregateComplianceByConfigRule] {
...
impl DescribeAggregateComplianceByConfigRulesOutputBuilder {
    ...
    ///
    /// <p>Returns a list of AggregateComplianceByConfigRule object.</p>
    pub fn aggregate_compliance_by_config_rules(mut self, input: super::super::super::types::AggregateComplianceByConfigRule) -> Self {
    ...
    pub fn set_aggregate_compliance_by_config_rules(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::AggregateComplianceByConfigRule>>,
    ) -> Self {
