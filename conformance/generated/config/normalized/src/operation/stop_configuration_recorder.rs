...
impl StopConfigurationRecorder {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::stop_configuration_recorder::StopConfigurationRecorderInput,
    ) -> ::std::result::Result<
        super::super::operation::stop_configuration_recorder::StopConfigurationRecorderOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::stop_configuration_recorder::StopConfigurationRecorderError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::stop_configuration_recorder::StopConfigurationRecorderError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::stop_configuration_recorder::StopConfigurationRecorderOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopConfigurationRecorder {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StopConfigurationRecorder")
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StopConfigurationRecorderTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<StopConfigurationRecorderInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopConfigurationRecorderResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_stop_configuration_recorder::de_stop_configuration_recorder_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_stop_configuration_recorder::de_stop_configuration_recorder_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StopConfigurationRecorderRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::stop_configuration_recorder::StopConfigurationRecorderInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::stop_configuration_recorder::StopConfigurationRecorderInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_stop_configuration_recorder::ser_stop_configuration_recorder_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::super::operation::stop_configuration_recorder::StopConfigurationRecorderError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::stop_configuration_recorder::_stop_configuration_recorder_input::StopConfigurationRecorderInput;

pub use super::super::operation::stop_configuration_recorder::_stop_configuration_recorder_output::StopConfigurationRecorderOutput;
