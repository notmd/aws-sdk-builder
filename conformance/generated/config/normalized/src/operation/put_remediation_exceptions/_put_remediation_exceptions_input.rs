...
impl PutRemediationExceptionsInput {
    ...
    pub fn builder() -> super::super::super::operation::put_remediation_exceptions::builders::PutRemediationExceptionsInputBuilder {
        super::super::super::operation::put_remediation_exceptions::builders::PutRemediationExceptionsInputBuilder::default()
    }
}
