...
impl DescribeAggregateComplianceByConformancePacksOutput {
    ...
    pub fn aggregate_compliance_by_conformance_packs(&self) -> &[super::super::super::types::AggregateComplianceByConformancePack] {
...
impl DescribeAggregateComplianceByConformancePacksOutputBuilder {
    ...
    ///
    /// <p>Returns the <code>AggregateComplianceByConformancePack</code> object.</p>
    pub fn aggregate_compliance_by_conformance_packs(mut self, input: super::super::super::types::AggregateComplianceByConformancePack) -> Self {
    ...
    pub fn set_aggregate_compliance_by_conformance_packs(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::AggregateComplianceByConformancePack>>,
    ) -> Self {
