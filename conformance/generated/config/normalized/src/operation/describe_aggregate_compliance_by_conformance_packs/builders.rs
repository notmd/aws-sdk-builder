...
pub use super::super::super::operation::describe_aggregate_compliance_by_conformance_packs::_describe_aggregate_compliance_by_conformance_packs_input::DescribeAggregateComplianceByConformancePacksInputBuilder;

pub use super::super::super::operation::describe_aggregate_compliance_by_conformance_packs::_describe_aggregate_compliance_by_conformance_packs_output::DescribeAggregateComplianceByConformancePacksOutputBuilder;

impl super::super::super::operation::describe_aggregate_compliance_by_conformance_packs::builders::DescribeAggregateComplianceByConformancePacksInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::describe_aggregate_compliance_by_conformance_packs::DescribeAggregateComplianceByConformancePacksError,
...
pub struct DescribeAggregateComplianceByConformancePacksFluentBuilder {
    ...
    inner: super::super::super::operation::describe_aggregate_compliance_by_conformance_packs::builders::DescribeAggregateComplianceByConformancePacksInputBuilder,
...
impl DescribeAggregateComplianceByConformancePacksFluentBuilder {
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::describe_aggregate_compliance_by_conformance_packs::DescribeAggregateComplianceByConformancePacks::operation_runtime_plugins(
    ...
    pub fn filters(mut self, input: super::super::super::types::AggregateConformancePackComplianceFilters) -> Self {
        self.inner = self.inner.filters(input);
        self
    }
    /// <p>Filters the result by <code>AggregateConformancePackComplianceFilters</code> object.</p>
    pub fn set_filters(mut self, input: ::std::option::Option<super::super::super::types::AggregateConformancePackComplianceFilters>) -> Self {
        self.inner = self.inner.set_filters(input);
        self
    }
    /// <p>Filters the result by <code>AggregateConformancePackComplianceFilters</code> object.</p>
    pub fn get_filters(&self) -> &::std::option::Option<super::super::super::types::AggregateConformancePackComplianceFilters> {
