...
pub struct PutRemediationConfigurationsInput {
    ...
    pub remediation_configurations: ::std::option::Option<::std::vec::Vec<super::super::super::types::RemediationConfiguration>>,
}
impl PutRemediationConfigurationsInput {
    ...
    pub fn remediation_configurations(&self) -> &[super::super::super::types::RemediationConfiguration] {
...
impl PutRemediationConfigurationsInput {
    ...
    pub fn builder() -> super::super::super::operation::put_remediation_configurations::builders::PutRemediationConfigurationsInputBuilder {
        super::super::super::operation::put_remediation_configurations::builders::PutRemediationConfigurationsInputBuilder::default()
    }
}
...
pub struct PutRemediationConfigurationsInputBuilder {
    pub(crate) remediation_configurations: ::std::option::Option<::std::vec::Vec<super::super::super::types::RemediationConfiguration>>,
}
