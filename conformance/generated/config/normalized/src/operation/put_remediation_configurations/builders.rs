...
pub use super::super::super::operation::put_remediation_configurations::_put_remediation_configurations_input::PutRemediationConfigurationsInputBuilder;

pub use super::super::super::operation::put_remediation_configurations::_put_remediation_configurations_output::PutRemediationConfigurationsOutputBuilder;

impl super::super::super::operation::put_remediation_configurations::builders::PutRemediationConfigurationsInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::put_remediation_configurations::PutRemediationConfigurationsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::put_remediation_configurations::PutRemediationConfigurationsError,
...
pub struct PutRemediationConfigurationsFluentBuilder {
    ...
    inner: super::super::super::operation::put_remediation_configurations::builders::PutRemediationConfigurationsInputBuilder,
...
impl PutRemediationConfigurationsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::put_remediation_configurations::builders::PutRemediationConfigurationsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::put_remediation_configurations::PutRemediationConfigurations::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::put_remediation_configurations::PutRemediationConfigurations::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn remediation_configurations(mut self, input: super::super::super::types::RemediationConfiguration) -> Self {
    ...
    /// <p>A list of remediation configuration objects.</p>
    pub fn get_remediation_configurations(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::RemediationConfiguration>> {
