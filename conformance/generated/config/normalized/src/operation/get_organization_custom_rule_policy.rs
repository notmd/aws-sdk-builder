...
impl GetOrganizationCustomRulePolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::get_organization_custom_rule_policy::GetOrganizationCustomRulePolicyInput,
    ) -> ::std::result::Result<
        super::super::operation::get_organization_custom_rule_policy::GetOrganizationCustomRulePolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::get_organization_custom_rule_policy::GetOrganizationCustomRulePolicyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::get_organization_custom_rule_policy::GetOrganizationCustomRulePolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::get_organization_custom_rule_policy::GetOrganizationCustomRulePolicyOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetOrganizationCustomRulePolicy {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetOrganizationCustomRulePolicy")
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetOrganizationCustomRulePolicyTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetOrganizationCustomRulePolicyInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetOrganizationCustomRulePolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_get_organization_custom_rule_policy::de_get_organization_custom_rule_policy_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_get_organization_custom_rule_policy::de_get_organization_custom_rule_policy_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetOrganizationCustomRulePolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::get_organization_custom_rule_policy::GetOrganizationCustomRulePolicyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::get_organization_custom_rule_policy::GetOrganizationCustomRulePolicyInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_get_organization_custom_rule_policy::ser_get_organization_custom_rule_policy_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::super::operation::get_organization_custom_rule_policy::GetOrganizationCustomRulePolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::get_organization_custom_rule_policy::_get_organization_custom_rule_policy_input::GetOrganizationCustomRulePolicyInput;

pub use super::super::operation::get_organization_custom_rule_policy::_get_organization_custom_rule_policy_output::GetOrganizationCustomRulePolicyOutput;
