...
impl GetCustomRulePolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::get_custom_rule_policy::builders::GetCustomRulePolicyInputBuilder {
        super::super::super::operation::get_custom_rule_policy::builders::GetCustomRulePolicyInputBuilder::default()
    }
}
...
impl GetCustomRulePolicyInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::get_custom_rule_policy::GetCustomRulePolicyInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::get_custom_rule_policy::GetCustomRulePolicyInput {
