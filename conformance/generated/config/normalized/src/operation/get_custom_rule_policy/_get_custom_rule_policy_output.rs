...
impl GetCustomRulePolicyOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_custom_rule_policy::builders::GetCustomRulePolicyOutputBuilder {
        super::super::super::operation::get_custom_rule_policy::builders::GetCustomRulePolicyOutputBuilder::default()
    }
}
...
impl GetCustomRulePolicyOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::get_custom_rule_policy::GetCustomRulePolicyOutput {
