...
impl PutConfigRule {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::super::operation::put_config_rule::PutConfigRuleOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::put_config_rule::PutConfigRuleError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::put_config_rule::PutConfigRuleError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::put_config_rule::PutConfigRuleOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutConfigRuleResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_put_config_rule::de_put_config_rule_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_put_config_rule::de_put_config_rule_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutConfigRuleRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::put_config_rule::PutConfigRuleInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::put_config_rule::PutConfigRuleInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_put_config_rule::ser_put_config_rule_input(&input)?);
...
pub enum PutConfigRuleError {
    ...
    MaxNumberOfConfigRulesExceededException(super::super::types::error::MaxNumberOfConfigRulesExceededException),
...
impl ::aws_types::request_id::RequestId for super::super::operation::put_config_rule::PutConfigRuleError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::put_config_rule::_put_config_rule_input::PutConfigRuleInput;

pub use super::super::operation::put_config_rule::_put_config_rule_output::PutConfigRuleOutput;
