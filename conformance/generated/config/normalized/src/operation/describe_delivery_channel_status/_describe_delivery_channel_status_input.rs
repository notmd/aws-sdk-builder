...
impl DescribeDeliveryChannelStatusInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_delivery_channel_status::builders::DescribeDeliveryChannelStatusInputBuilder {
        super::super::super::operation::describe_delivery_channel_status::builders::DescribeDeliveryChannelStatusInputBuilder::default()
    }
}
...
impl DescribeDeliveryChannelStatusInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::describe_delivery_channel_status::DescribeDeliveryChannelStatusInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::describe_delivery_channel_status::DescribeDeliveryChannelStatusInput {
