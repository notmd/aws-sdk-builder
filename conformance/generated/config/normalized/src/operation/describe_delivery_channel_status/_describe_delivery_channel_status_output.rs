...
pub struct DescribeDeliveryChannelStatusOutput {
    ...
    pub delivery_channels_status: ::std::option::Option<::std::vec::Vec<super::super::super::types::DeliveryChannelStatus>>,
...
impl DescribeDeliveryChannelStatusOutput {
    ...
    pub fn delivery_channels_status(&self) -> &[super::super::super::types::DeliveryChannelStatus] {
...
impl DescribeDeliveryChannelStatusOutput {
    ...
    pub fn builder() -> super::super::super::operation::describe_delivery_channel_status::builders::DescribeDeliveryChannelStatusOutputBuilder {
        super::super::super::operation::describe_delivery_channel_status::builders::DescribeDeliveryChannelStatusOutputBuilder::default()
    }
}
...
pub struct DescribeDeliveryChannelStatusOutputBuilder {
    pub(crate) delivery_channels_status: ::std::option::Option<::std::vec::Vec<super::super::super::types::DeliveryChannelStatus>>,
    _request_id: Option<String>,
}
impl DescribeDeliveryChannelStatusOutputBuilder {
    ...
    ///
    /// <p>A list that contains the status of a specified delivery channel.</p>
    pub fn delivery_channels_status(mut self, input: super::super::super::types::DeliveryChannelStatus) -> Self {
    ...
    /// <p>A list that contains the status of a specified delivery channel.</p>
    pub fn get_delivery_channels_status(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::DeliveryChannelStatus>> {
    ...
    pub fn build(self) -> super::super::super::operation::describe_delivery_channel_status::DescribeDeliveryChannelStatusOutput {
