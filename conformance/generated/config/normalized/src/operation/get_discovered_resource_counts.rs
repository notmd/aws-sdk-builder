...
impl GetDiscoveredResourceCounts {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::get_discovered_resource_counts::GetDiscoveredResourceCountsInput,
    ) -> ::std::result::Result<
        super::super::operation::get_discovered_resource_counts::GetDiscoveredResourceCountsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::get_discovered_resource_counts::GetDiscoveredResourceCountsError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::get_discovered_resource_counts::GetDiscoveredResourceCountsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::get_discovered_resource_counts::GetDiscoveredResourceCountsOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetDiscoveredResourceCounts {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetDiscoveredResourceCounts")
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetDiscoveredResourceCountsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetDiscoveredResourceCountsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetDiscoveredResourceCountsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_get_discovered_resource_counts::de_get_discovered_resource_counts_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_get_discovered_resource_counts::de_get_discovered_resource_counts_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetDiscoveredResourceCountsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::get_discovered_resource_counts::GetDiscoveredResourceCountsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::get_discovered_resource_counts::GetDiscoveredResourceCountsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_get_discovered_resource_counts::ser_get_discovered_resource_counts_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::super::operation::get_discovered_resource_counts::GetDiscoveredResourceCountsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::get_discovered_resource_counts::_get_discovered_resource_counts_input::GetDiscoveredResourceCountsInput;

pub use super::super::operation::get_discovered_resource_counts::_get_discovered_resource_counts_output::GetDiscoveredResourceCountsOutput;
