...
pub use super::super::super::operation::delete_organization_conformance_pack::_delete_organization_conformance_pack_input::DeleteOrganizationConformancePackInputBuilder;

pub use super::super::super::operation::delete_organization_conformance_pack::_delete_organization_conformance_pack_output::DeleteOrganizationConformancePackOutputBuilder;

impl super::super::super::operation::delete_organization_conformance_pack::builders::DeleteOrganizationConformancePackInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_organization_conformance_pack::DeleteOrganizationConformancePackOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_organization_conformance_pack::DeleteOrganizationConformancePackError,
...
pub struct DeleteOrganizationConformancePackFluentBuilder {
    ...
    inner: super::super::super::operation::delete_organization_conformance_pack::builders::DeleteOrganizationConformancePackInputBuilder,
