...
pub use super::super::super::operation::delete_delivery_channel::_delete_delivery_channel_input::DeleteDeliveryChannelInputBuilder;

pub use super::super::super::operation::delete_delivery_channel::_delete_delivery_channel_output::DeleteDeliveryChannelOutputBuilder;

impl super::super::super::operation::delete_delivery_channel::builders::DeleteDeliveryChannelInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_delivery_channel::DeleteDeliveryChannelOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_delivery_channel::DeleteDeliveryChannelError,
...
pub struct DeleteDeliveryChannelFluentBuilder {
    ...
    inner: super::super::super::operation::delete_delivery_channel::builders::DeleteDeliveryChannelInputBuilder,
...
impl DeleteDeliveryChannelFluentBuilder {
    /// Creates a new `DeleteDeliveryChannelFluentBuilder`.
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_delivery_channel::builders::DeleteDeliveryChannelInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_delivery_channel::DeleteDeliveryChannel::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_delivery_channel::DeleteDeliveryChannel::orchestrate(&runtime_plugins, input).await
    }
