...
impl GetConformancePackComplianceSummaryOutput {
    ...
    pub fn conformance_pack_compliance_summary_list(&self) -> &[super::super::super::types::ConformancePackComplianceSummary] {
...
impl GetConformancePackComplianceSummaryOutputBuilder {
    ...
    ///
    /// <p>A list of <code>ConformancePackComplianceSummary</code> objects.</p>
    pub fn conformance_pack_compliance_summary_list(mut self, input: super::super::super::types::ConformancePackComplianceSummary) -> Self {
    ...
    pub fn set_conformance_pack_compliance_summary_list(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::ConformancePackComplianceSummary>>,
    ) -> Self {
    ...
    pub fn build(self) -> super::super::super::operation::get_conformance_pack_compliance_summary::GetConformancePackComplianceSummaryOutput {
