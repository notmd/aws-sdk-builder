...
pub struct GetConformancePackComplianceSummaryPaginator {
    ...
    builder: super::super::super::operation::get_conformance_pack_compliance_summary::builders::GetConformancePackComplianceSummaryInputBuilder,
...
impl GetConformancePackComplianceSummaryPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::ConformancePackComplianceSummary,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::get_conformance_pack_compliance_summary::GetConformancePackComplianceSummaryError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_get_conformance_pack_compliance_summary_output_output_conformance_pack_compliance_summary_list(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
