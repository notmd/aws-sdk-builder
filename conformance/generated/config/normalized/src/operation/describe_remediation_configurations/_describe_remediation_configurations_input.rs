...
impl DescribeRemediationConfigurationsInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_remediation_configurations::builders::DescribeRemediationConfigurationsInputBuilder {
        super::super::super::operation::describe_remediation_configurations::builders::DescribeRemediationConfigurationsInputBuilder::default()
    }
}
...
impl DescribeRemediationConfigurationsInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::describe_remediation_configurations::DescribeRemediationConfigurationsInput,
