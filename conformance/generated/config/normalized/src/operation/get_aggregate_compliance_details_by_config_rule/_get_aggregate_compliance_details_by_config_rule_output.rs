...
pub struct GetAggregateComplianceDetailsByConfigRuleOutput {
    ...
    pub aggregate_evaluation_results: ::std::option::Option<::std::vec::Vec<super::super::super::types::AggregateEvaluationResult>>,
...
impl GetAggregateComplianceDetailsByConfigRuleOutput {
    ...
    pub fn aggregate_evaluation_results(&self) -> &[super::super::super::types::AggregateEvaluationResult] {
...
pub struct GetAggregateComplianceDetailsByConfigRuleOutputBuilder {
    pub(crate) aggregate_evaluation_results: ::std::option::Option<::std::vec::Vec<super::super::super::types::AggregateEvaluationResult>>,
...
impl GetAggregateComplianceDetailsByConfigRuleOutputBuilder {
    ...
    ///
    /// <p>Returns an AggregateEvaluationResults object.</p>
    pub fn aggregate_evaluation_results(mut self, input: super::super::super::types::AggregateEvaluationResult) -> Self {
    ...
    pub fn set_aggregate_evaluation_results(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::AggregateEvaluationResult>>,
    ) -> Self {
        self.aggregate_evaluation_results = input;
        self
    }
    /// <p>Returns an AggregateEvaluationResults object.</p>
    pub fn get_aggregate_evaluation_results(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::AggregateEvaluationResult>> {
