...
impl DeleteOrganizationConformancePack {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::delete_organization_conformance_pack::DeleteOrganizationConformancePackInput,
    ) -> ::std::result::Result<
        super::super::operation::delete_organization_conformance_pack::DeleteOrganizationConformancePackOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::delete_organization_conformance_pack::DeleteOrganizationConformancePackError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::delete_organization_conformance_pack::DeleteOrganizationConformancePackError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::delete_organization_conformance_pack::DeleteOrganizationConformancePackOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteOrganizationConformancePack {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteOrganizationConformancePack")
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteOrganizationConformancePackTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DeleteOrganizationConformancePackInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteOrganizationConformancePackResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_delete_organization_conformance_pack::de_delete_organization_conformance_pack_http_error(
                status, headers, body,
            )
        } else {
            super::super::protocol_serde::shape_delete_organization_conformance_pack::de_delete_organization_conformance_pack_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteOrganizationConformancePackRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::delete_organization_conformance_pack::DeleteOrganizationConformancePackInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::delete_organization_conformance_pack::DeleteOrganizationConformancePackInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_delete_organization_conformance_pack::ser_delete_organization_conformance_pack_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::super::operation::delete_organization_conformance_pack::DeleteOrganizationConformancePackError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::delete_organization_conformance_pack::_delete_organization_conformance_pack_input::DeleteOrganizationConformancePackInput;

pub use super::super::operation::delete_organization_conformance_pack::_delete_organization_conformance_pack_output::DeleteOrganizationConformancePackOutput;
