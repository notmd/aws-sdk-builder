...
pub use super::super::super::operation::get_resource_evaluation_summary::_get_resource_evaluation_summary_input::GetResourceEvaluationSummaryInputBuilder;

pub use super::super::super::operation::get_resource_evaluation_summary::_get_resource_evaluation_summary_output::GetResourceEvaluationSummaryOutputBuilder;

impl super::super::super::operation::get_resource_evaluation_summary::builders::GetResourceEvaluationSummaryInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::get_resource_evaluation_summary::GetResourceEvaluationSummaryError,
...
pub struct GetResourceEvaluationSummaryFluentBuilder {
    ...
    inner: super::super::super::operation::get_resource_evaluation_summary::builders::GetResourceEvaluationSummaryInputBuilder,
...
impl GetResourceEvaluationSummaryFluentBuilder {
    /// Creates a new `GetResourceEvaluationSummaryFluentBuilder`.
    ...
    pub fn as_input(&self) -> &super::super::super::operation::get_resource_evaluation_summary::builders::GetResourceEvaluationSummaryInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::get_resource_evaluation_summary::GetResourceEvaluationSummary::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::get_resource_evaluation_summary::GetResourceEvaluationSummary::orchestrate(&runtime_plugins, input).await
    }
