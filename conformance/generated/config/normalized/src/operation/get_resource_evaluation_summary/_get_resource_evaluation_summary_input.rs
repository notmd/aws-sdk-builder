...
impl GetResourceEvaluationSummaryInput {
    ...
    pub fn builder() -> super::super::super::operation::get_resource_evaluation_summary::builders::GetResourceEvaluationSummaryInputBuilder {
        super::super::super::operation::get_resource_evaluation_summary::builders::GetResourceEvaluationSummaryInputBuilder::default()
    }
}
