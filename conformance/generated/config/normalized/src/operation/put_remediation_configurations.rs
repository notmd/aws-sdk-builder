...
impl PutRemediationConfigurations {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::put_remediation_configurations::PutRemediationConfigurationsInput,
    ) -> ::std::result::Result<
        super::super::operation::put_remediation_configurations::PutRemediationConfigurationsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::put_remediation_configurations::PutRemediationConfigurationsError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::put_remediation_configurations::PutRemediationConfigurationsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::put_remediation_configurations::PutRemediationConfigurationsOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutRemediationConfigurations {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutRemediationConfigurations")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutRemediationConfigurationsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_put_remediation_configurations::de_put_remediation_configurations_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_put_remediation_configurations::de_put_remediation_configurations_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutRemediationConfigurationsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::put_remediation_configurations::PutRemediationConfigurationsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::put_remediation_configurations::PutRemediationConfigurationsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_put_remediation_configurations::ser_put_remediation_configurations_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::super::operation::put_remediation_configurations::PutRemediationConfigurationsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::put_remediation_configurations::_put_remediation_configurations_input::PutRemediationConfigurationsInput;

pub use super::super::operation::put_remediation_configurations::_put_remediation_configurations_output::PutRemediationConfigurationsOutput;
