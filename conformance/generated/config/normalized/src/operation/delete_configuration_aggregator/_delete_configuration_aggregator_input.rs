...
impl DeleteConfigurationAggregatorInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_configuration_aggregator::builders::DeleteConfigurationAggregatorInputBuilder {
        super::super::super::operation::delete_configuration_aggregator::builders::DeleteConfigurationAggregatorInputBuilder::default()
    }
}
