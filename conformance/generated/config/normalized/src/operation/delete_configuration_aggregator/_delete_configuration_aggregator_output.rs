...
impl DeleteConfigurationAggregatorOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_configuration_aggregator::builders::DeleteConfigurationAggregatorOutputBuilder {
        super::super::super::operation::delete_configuration_aggregator::builders::DeleteConfigurationAggregatorOutputBuilder::default()
    }
}
...
impl DeleteConfigurationAggregatorOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_configuration_aggregator::DeleteConfigurationAggregatorOutput {
