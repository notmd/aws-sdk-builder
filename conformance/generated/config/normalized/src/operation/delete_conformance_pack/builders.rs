...
pub use super::super::super::operation::delete_conformance_pack::_delete_conformance_pack_input::DeleteConformancePackInputBuilder;

pub use super::super::super::operation::delete_conformance_pack::_delete_conformance_pack_output::DeleteConformancePackOutputBuilder;

impl super::super::super::operation::delete_conformance_pack::builders::DeleteConformancePackInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_conformance_pack::DeleteConformancePackOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_conformance_pack::DeleteConformancePackError,
...
pub struct DeleteConformancePackFluentBuilder {
    ...
    inner: super::super::super::operation::delete_conformance_pack::builders::DeleteConformancePackInputBuilder,
...
impl DeleteConformancePackFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_conformance_pack::builders::DeleteConformancePackInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_conformance_pack::DeleteConformancePack::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_conformance_pack::DeleteConformancePack::orchestrate(&runtime_plugins, input).await
    }
