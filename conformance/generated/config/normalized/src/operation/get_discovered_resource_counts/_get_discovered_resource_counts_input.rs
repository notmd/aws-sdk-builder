...
impl GetDiscoveredResourceCountsInput {
    ...
    pub fn builder() -> super::super::super::operation::get_discovered_resource_counts::builders::GetDiscoveredResourceCountsInputBuilder {
        super::super::super::operation::get_discovered_resource_counts::builders::GetDiscoveredResourceCountsInputBuilder::default()
    }
}
