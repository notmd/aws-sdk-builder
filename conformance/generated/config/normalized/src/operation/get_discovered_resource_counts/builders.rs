...
pub use super::super::super::operation::get_discovered_resource_counts::_get_discovered_resource_counts_input::GetDiscoveredResourceCountsInputBuilder;

pub use super::super::super::operation::get_discovered_resource_counts::_get_discovered_resource_counts_output::GetDiscoveredResourceCountsOutputBuilder;

impl super::super::super::operation::get_discovered_resource_counts::builders::GetDiscoveredResourceCountsInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::get_discovered_resource_counts::GetDiscoveredResourceCountsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::get_discovered_resource_counts::GetDiscoveredResourceCountsError,
...
pub struct GetDiscoveredResourceCountsFluentBuilder {
    ...
    inner: super::super::super::operation::get_discovered_resource_counts::builders::GetDiscoveredResourceCountsInputBuilder,
...
impl GetDiscoveredResourceCountsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::get_discovered_resource_counts::builders::GetDiscoveredResourceCountsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::get_discovered_resource_counts::GetDiscoveredResourceCounts::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::get_discovered_resource_counts::GetDiscoveredResourceCounts::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::super::super::operation::get_discovered_resource_counts::paginator::GetDiscoveredResourceCountsPaginator {
        super::super::super::operation::get_discovered_resource_counts::paginator::GetDiscoveredResourceCountsPaginator::new(self.handle, self.inner)
    }
    ///
