...
pub struct GetAggregateResourceConfigInput {
    ...
    pub resource_identifier: ::std::option::Option<super::super::super::types::AggregateResourceIdentifier>,
}
impl GetAggregateResourceConfigInput {
    ...
    /// <p>An object that identifies aggregate resource.</p>
    pub fn resource_identifier(&self) -> ::std::option::Option<&super::super::super::types::AggregateResourceIdentifier> {
...
impl GetAggregateResourceConfigInput {
    ...
    pub fn builder() -> super::super::super::operation::get_aggregate_resource_config::builders::GetAggregateResourceConfigInputBuilder {
        super::super::super::operation::get_aggregate_resource_config::builders::GetAggregateResourceConfigInputBuilder::default()
    }
}
...
pub struct GetAggregateResourceConfigInputBuilder {
    ...
    pub(crate) resource_identifier: ::std::option::Option<super::super::super::types::AggregateResourceIdentifier>,
}
