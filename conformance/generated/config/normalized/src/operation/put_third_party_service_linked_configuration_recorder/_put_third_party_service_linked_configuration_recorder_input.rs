...
pub struct PutThirdPartyServiceLinkedConfigurationRecorderInput {
    ...
    pub scope_configuration: ::std::option::Option<super::super::super::types::ScopeConfiguration>,
...
impl PutThirdPartyServiceLinkedConfigurationRecorderInput {
    ...
    /// <p>Specifies the scope of resources to record from the third-party cloud service provider.</p>
    pub fn scope_configuration(&self) -> ::std::option::Option<&super::super::super::types::ScopeConfiguration> {
...
pub struct PutThirdPartyServiceLinkedConfigurationRecorderInputBuilder {
    ...
    pub(crate) scope_configuration: ::std::option::Option<super::super::super::types::ScopeConfiguration>,
