...
pub use super::super::super::operation::put_third_party_service_linked_configuration_recorder::_put_third_party_service_linked_configuration_recorder_input::PutThirdPartyServiceLinkedConfigurationRecorderInputBuilder;

pub use super::super::super::operation::put_third_party_service_linked_configuration_recorder::_put_third_party_service_linked_configuration_recorder_output::PutThirdPartyServiceLinkedConfigurationRecorderOutputBuilder;

impl super::super::super::operation::put_third_party_service_linked_configuration_recorder::builders::PutThirdPartyServiceLinkedConfigurationRecorderInputBuilder {
...
pub struct PutThirdPartyServiceLinkedConfigurationRecorderFluentBuilder {
                ...
                inner: super::super::super::operation::put_third_party_service_linked_configuration_recorder::builders::PutThirdPartyServiceLinkedConfigurationRecorderInputBuilder,
...
impl PutThirdPartyServiceLinkedConfigurationRecorderFluentBuilder {
    ...
    >{
        ...
        let runtime_plugins = super::super::super::operation::put_third_party_service_linked_configuration_recorder::PutThirdPartyServiceLinkedConfigurationRecorder::operation_runtime_plugins(
    ...
    pub fn scope_configuration(mut self, input: super::super::super::types::ScopeConfiguration) -> Self {
        self.inner = self.inner.scope_configuration(input);
        self
    }
    /// <p>Specifies the scope of resources to record from the third-party cloud service provider.</p>
    pub fn set_scope_configuration(mut self, input: ::std::option::Option<super::super::super::types::ScopeConfiguration>) -> Self {
        self.inner = self.inner.set_scope_configuration(input);
        self
    }
    /// <p>Specifies the scope of resources to record from the third-party cloud service provider.</p>
    pub fn get_scope_configuration(&self) -> &::std::option::Option<super::super::super::types::ScopeConfiguration> {
