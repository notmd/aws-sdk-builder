...
impl DeleteEvaluationResultsOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_evaluation_results::builders::DeleteEvaluationResultsOutputBuilder {
        super::super::super::operation::delete_evaluation_results::builders::DeleteEvaluationResultsOutputBuilder::default()
    }
}
...
impl DeleteEvaluationResultsOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_evaluation_results::DeleteEvaluationResultsOutput {
