...
pub use super::super::super::operation::delete_evaluation_results::_delete_evaluation_results_input::DeleteEvaluationResultsInputBuilder;

pub use super::super::super::operation::delete_evaluation_results::_delete_evaluation_results_output::DeleteEvaluationResultsOutputBuilder;

impl super::super::super::operation::delete_evaluation_results::builders::DeleteEvaluationResultsInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_evaluation_results::DeleteEvaluationResultsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_evaluation_results::DeleteEvaluationResultsError,
...
pub struct DeleteEvaluationResultsFluentBuilder {
    ...
    inner: super::super::super::operation::delete_evaluation_results::builders::DeleteEvaluationResultsInputBuilder,
...
impl DeleteEvaluationResultsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_evaluation_results::builders::DeleteEvaluationResultsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_evaluation_results::DeleteEvaluationResults::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_evaluation_results::DeleteEvaluationResults::orchestrate(&runtime_plugins, input).await
    }
