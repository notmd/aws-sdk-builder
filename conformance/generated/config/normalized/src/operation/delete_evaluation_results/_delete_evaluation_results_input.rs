...
impl DeleteEvaluationResultsInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_evaluation_results::builders::DeleteEvaluationResultsInputBuilder {
        super::super::super::operation::delete_evaluation_results::builders::DeleteEvaluationResultsInputBuilder::default()
    }
}
...
impl DeleteEvaluationResultsInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::delete_evaluation_results::DeleteEvaluationResultsInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::delete_evaluation_results::DeleteEvaluationResultsInput {
