...
impl PutResourceConfigOutput {
    ...
    pub fn builder() -> super::super::super::operation::put_resource_config::builders::PutResourceConfigOutputBuilder {
        super::super::super::operation::put_resource_config::builders::PutResourceConfigOutputBuilder::default()
    }
}
...
impl PutResourceConfigOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::put_resource_config::PutResourceConfigOutput {
