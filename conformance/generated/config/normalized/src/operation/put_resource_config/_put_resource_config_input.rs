...
impl PutResourceConfigInput {
    ...
    pub fn builder() -> super::super::super::operation::put_resource_config::builders::PutResourceConfigInputBuilder {
        super::super::super::operation::put_resource_config::builders::PutResourceConfigInputBuilder::default()
    }
}
