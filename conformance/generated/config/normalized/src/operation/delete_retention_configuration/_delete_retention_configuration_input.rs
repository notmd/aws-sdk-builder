...
impl DeleteRetentionConfigurationInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_retention_configuration::builders::DeleteRetentionConfigurationInputBuilder {
        super::super::super::operation::delete_retention_configuration::builders::DeleteRetentionConfigurationInputBuilder::default()
    }
}
