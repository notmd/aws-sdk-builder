...
impl DeleteRetentionConfigurationOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_retention_configuration::builders::DeleteRetentionConfigurationOutputBuilder {
        super::super::super::operation::delete_retention_configuration::builders::DeleteRetentionConfigurationOutputBuilder::default()
    }
}
...
impl DeleteRetentionConfigurationOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_retention_configuration::DeleteRetentionConfigurationOutput {
