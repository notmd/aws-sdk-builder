...
impl GetComplianceDetailsByResourceOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_compliance_details_by_resource::builders::GetComplianceDetailsByResourceOutputBuilder {
        super::super::super::operation::get_compliance_details_by_resource::builders::GetComplianceDetailsByResourceOutputBuilder::default()
    }
}
...
impl GetComplianceDetailsByResourceOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::get_compliance_details_by_resource::GetComplianceDetailsByResourceOutput {
