...
pub use super::super::super::operation::get_compliance_details_by_resource::_get_compliance_details_by_resource_input::GetComplianceDetailsByResourceInputBuilder;

pub use super::super::super::operation::get_compliance_details_by_resource::_get_compliance_details_by_resource_output::GetComplianceDetailsByResourceOutputBuilder;

impl super::super::super::operation::get_compliance_details_by_resource::builders::GetComplianceDetailsByResourceInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::get_compliance_details_by_resource::GetComplianceDetailsByResourceOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::get_compliance_details_by_resource::GetComplianceDetailsByResourceError,
...
pub struct GetComplianceDetailsByResourceFluentBuilder {
    ...
    inner: super::super::super::operation::get_compliance_details_by_resource::builders::GetComplianceDetailsByResourceInputBuilder,
