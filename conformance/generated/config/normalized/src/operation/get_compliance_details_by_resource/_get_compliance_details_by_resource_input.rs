...
pub struct GetComplianceDetailsByResourceInput {
    ...
    pub compliance_types: ::std::option::Option<::std::vec::Vec<super::super::super::types::ComplianceType>>,
...
impl GetComplianceDetailsByResourceInput {
    ...
    pub fn compliance_types(&self) -> &[super::super::super::types::ComplianceType] {
...
impl GetComplianceDetailsByResourceInput {
    ...
    pub fn builder() -> super::super::super::operation::get_compliance_details_by_resource::builders::GetComplianceDetailsByResourceInputBuilder {
        super::super::super::operation::get_compliance_details_by_resource::builders::GetComplianceDetailsByResourceInputBuilder::default()
    }
}
...
pub struct GetComplianceDetailsByResourceInputBuilder {
    ...
    pub(crate) compliance_types: ::std::option::Option<::std::vec::Vec<super::super::super::types::ComplianceType>>,
...
impl GetComplianceDetailsByResourceInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::get_compliance_details_by_resource::GetComplianceDetailsByResourceInput,
