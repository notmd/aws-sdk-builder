...
pub struct GetComplianceDetailsByResourcePaginator {
    ...
    builder: super::super::super::operation::get_compliance_details_by_resource::builders::GetComplianceDetailsByResourceInputBuilder,
...
impl GetComplianceDetailsByResourcePaginator {
    ...
    pub fn items(self) -> super::super::super::operation::get_compliance_details_by_resource::paginator::GetComplianceDetailsByResourcePaginatorItems {
        super::super::super::operation::get_compliance_details_by_resource::paginator::GetComplianceDetailsByResourcePaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::super::super::operation::get_compliance_details_by_resource::GetComplianceDetailsByResource::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_get_compliance_details_by_resource_output_output_next_token(resp);
...
impl GetComplianceDetailsByResourcePaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_get_compliance_details_by_resource_output_output_evaluation_results(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
