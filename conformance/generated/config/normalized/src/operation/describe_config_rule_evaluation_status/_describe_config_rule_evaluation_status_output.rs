...
pub struct DescribeConfigRuleEvaluationStatusOutput {
    ...
    pub config_rules_evaluation_status: ::std::option::Option<::std::vec::Vec<super::super::super::types::ConfigRuleEvaluationStatus>>,
...
impl DescribeConfigRuleEvaluationStatusOutput {
    ...
    pub fn config_rules_evaluation_status(&self) -> &[super::super::super::types::ConfigRuleEvaluationStatus] {
...
pub struct DescribeConfigRuleEvaluationStatusOutputBuilder {
    pub(crate) config_rules_evaluation_status: ::std::option::Option<::std::vec::Vec<super::super::super::types::ConfigRuleEvaluationStatus>>,
...
impl DescribeConfigRuleEvaluationStatusOutputBuilder {
    ...
    ///
    /// <p>Status information about your Config managed rules.</p>
    pub fn config_rules_evaluation_status(mut self, input: super::super::super::types::ConfigRuleEvaluationStatus) -> Self {
    ...
    pub fn set_config_rules_evaluation_status(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::ConfigRuleEvaluationStatus>>,
    ) -> Self {
    ...
    pub fn build(self) -> super::super::super::operation::describe_config_rule_evaluation_status::DescribeConfigRuleEvaluationStatusOutput {
