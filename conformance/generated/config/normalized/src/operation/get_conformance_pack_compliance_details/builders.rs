...
pub use super::super::super::operation::get_conformance_pack_compliance_details::_get_conformance_pack_compliance_details_input::GetConformancePackComplianceDetailsInputBuilder;

pub use super::super::super::operation::get_conformance_pack_compliance_details::_get_conformance_pack_compliance_details_output::GetConformancePackComplianceDetailsOutputBuilder;

impl super::super::super::operation::get_conformance_pack_compliance_details::builders::GetConformancePackComplianceDetailsInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::get_conformance_pack_compliance_details::GetConformancePackComplianceDetailsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::get_conformance_pack_compliance_details::GetConformancePackComplianceDetailsError,
...
pub struct GetConformancePackComplianceDetailsFluentBuilder {
    ...
    inner: super::super::super::operation::get_conformance_pack_compliance_details::builders::GetConformancePackComplianceDetailsInputBuilder,
...
impl GetConformancePackComplianceDetailsFluentBuilder {
    ...
    > {
        ...
        let runtime_plugins =
            super::super::super::operation::get_conformance_pack_compliance_details::GetConformancePackComplianceDetails::operation_runtime_plugins(
    ...
    pub fn into_paginator(
        self,
    ) -> super::super::super::operation::get_conformance_pack_compliance_details::paginator::GetConformancePackComplianceDetailsPaginator {
        super::super::super::operation::get_conformance_pack_compliance_details::paginator::GetConformancePackComplianceDetailsPaginator::new(
            self.handle,
            self.inner,
        )
    }
    ...
    pub fn filters(mut self, input: super::super::super::types::ConformancePackEvaluationFilters) -> Self {
        self.inner = self.inner.filters(input);
        self
    }
    /// <p>A <code>ConformancePackEvaluationFilters</code> object.</p>
    pub fn set_filters(mut self, input: ::std::option::Option<super::super::super::types::ConformancePackEvaluationFilters>) -> Self {
        self.inner = self.inner.set_filters(input);
        self
    }
    /// <p>A <code>ConformancePackEvaluationFilters</code> object.</p>
    pub fn get_filters(&self) -> &::std::option::Option<super::super::super::types::ConformancePackEvaluationFilters> {
