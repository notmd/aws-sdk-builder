...
pub struct GetConformancePackComplianceDetailsOutput {
    ...
    pub conformance_pack_rule_evaluation_results: ::std::option::Option<::std::vec::Vec<super::super::super::types::ConformancePackEvaluationResult>>,
...
impl GetConformancePackComplianceDetailsOutput {
    ...
    pub fn conformance_pack_rule_evaluation_results(&self) -> &[super::super::super::types::ConformancePackEvaluationResult] {
...
impl GetConformancePackComplianceDetailsOutputBuilder {
    ...
    ///
    /// <p>Returns a list of <code>ConformancePackEvaluationResult</code> objects.</p>
    pub fn conformance_pack_rule_evaluation_results(mut self, input: super::super::super::types::ConformancePackEvaluationResult) -> Self {
    ...
    pub fn set_conformance_pack_rule_evaluation_results(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::ConformancePackEvaluationResult>>,
    ) -> Self {
