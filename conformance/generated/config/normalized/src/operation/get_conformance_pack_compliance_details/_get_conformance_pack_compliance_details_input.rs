...
pub struct GetConformancePackComplianceDetailsInput {
    ...
    pub filters: ::std::option::Option<super::super::super::types::ConformancePackEvaluationFilters>,
...
impl GetConformancePackComplianceDetailsInput {
    ...
    /// <p>A <code>ConformancePackEvaluationFilters</code> object.</p>
    pub fn filters(&self) -> ::std::option::Option<&super::super::super::types::ConformancePackEvaluationFilters> {
        self.filters.as_ref()
    }
    /// <p>The maximum number of evaluation results returned on each page. If you do no specify a number, Config uses the default. The default is 100.</p>
...
impl GetConformancePackComplianceDetailsInput {
    ...
    pub fn builder() -> super::super::super::operation::get_conformance_pack_compliance_details::builders::GetConformancePackComplianceDetailsInputBuilder {
        super::super::super::operation::get_conformance_pack_compliance_details::builders::GetConformancePackComplianceDetailsInputBuilder::default()
    }
}
...
pub struct GetConformancePackComplianceDetailsInputBuilder {
    ...
    pub(crate) filters: ::std::option::Option<super::super::super::types::ConformancePackEvaluationFilters>,
