...
pub use super::super::super::operation::associate_resource_types::_associate_resource_types_input::AssociateResourceTypesInputBuilder;

pub use super::super::super::operation::associate_resource_types::_associate_resource_types_output::AssociateResourceTypesOutputBuilder;

impl super::super::super::operation::associate_resource_types::builders::AssociateResourceTypesInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::associate_resource_types::AssociateResourceTypesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::associate_resource_types::AssociateResourceTypesError,
...
pub struct AssociateResourceTypesFluentBuilder {
    ...
    inner: super::super::super::operation::associate_resource_types::builders::AssociateResourceTypesInputBuilder,
...
impl AssociateResourceTypesFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::associate_resource_types::builders::AssociateResourceTypesInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::associate_resource_types::AssociateResourceTypes::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::associate_resource_types::AssociateResourceTypes::orchestrate(&runtime_plugins, input).await
    }
