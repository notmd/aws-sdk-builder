...
pub struct AssociateResourceTypesInput {
    ...
    pub resource_types: ::std::option::Option<::std::vec::Vec<super::super::super::types::ResourceType>>,
}
impl AssociateResourceTypesInput {
    ...
    pub fn resource_types(&self) -> &[super::super::super::types::ResourceType] {
...
impl AssociateResourceTypesInput {
    ...
    pub fn builder() -> super::super::super::operation::associate_resource_types::builders::AssociateResourceTypesInputBuilder {
        super::super::super::operation::associate_resource_types::builders::AssociateResourceTypesInputBuilder::default()
    }
}
...
pub struct AssociateResourceTypesInputBuilder {
    ...
    pub(crate) resource_types: ::std::option::Option<::std::vec::Vec<super::super::super::types::ResourceType>>,
}
impl AssociateResourceTypesInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::associate_resource_types::AssociateResourceTypesInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::associate_resource_types::AssociateResourceTypesInput {
