...
pub struct DescribeOrganizationConformancePackStatusesOutput {
    ...
    pub organization_conformance_pack_statuses: ::std::option::Option<::std::vec::Vec<super::super::super::types::OrganizationConformancePackStatus>>,
...
impl DescribeOrganizationConformancePackStatusesOutput {
    ...
    pub fn organization_conformance_pack_statuses(&self) -> &[super::super::super::types::OrganizationConformancePackStatus] {
...
impl DescribeOrganizationConformancePackStatusesOutputBuilder {
    ...
    ///
    /// <p>A list of <code>OrganizationConformancePackStatus</code> objects.</p>
    pub fn organization_conformance_pack_statuses(mut self, input: super::super::super::types::OrganizationConformancePackStatus) -> Self {
    ...
    pub fn set_organization_conformance_pack_statuses(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::OrganizationConformancePackStatus>>,
    ) -> Self {
