...
pub struct DescribeOrganizationConformancePacksOutput {
    ...
    pub organization_conformance_packs: ::std::option::Option<::std::vec::Vec<super::super::super::types::OrganizationConformancePack>>,
...
impl DescribeOrganizationConformancePacksOutput {
    ...
    pub fn organization_conformance_packs(&self) -> &[super::super::super::types::OrganizationConformancePack] {
...
pub struct DescribeOrganizationConformancePacksOutputBuilder {
    pub(crate) organization_conformance_packs: ::std::option::Option<::std::vec::Vec<super::super::super::types::OrganizationConformancePack>>,
...
impl DescribeOrganizationConformancePacksOutputBuilder {
    ...
    ///
    /// <p>Returns a list of OrganizationConformancePacks objects.</p>
    pub fn organization_conformance_packs(mut self, input: super::super::super::types::OrganizationConformancePack) -> Self {
    ...
    pub fn set_organization_conformance_packs(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::OrganizationConformancePack>>,
    ) -> Self {
    ...
    pub fn build(self) -> super::super::super::operation::describe_organization_conformance_packs::DescribeOrganizationConformancePacksOutput {
