...
pub struct GetComplianceSummaryByConfigRuleOutput {
    ...
    pub compliance_summary: ::std::option::Option<super::super::super::types::ComplianceSummary>,
    _request_id: Option<String>,
}
impl GetComplianceSummaryByConfigRuleOutput {
    /// <p>The number of Config rules that are compliant and the number that are noncompliant, up to a maximum of 25 for each.</p>
    pub fn compliance_summary(&self) -> ::std::option::Option<&super::super::super::types::ComplianceSummary> {
...
pub struct GetComplianceSummaryByConfigRuleOutputBuilder {
    pub(crate) compliance_summary: ::std::option::Option<super::super::super::types::ComplianceSummary>,
    _request_id: Option<String>,
}
impl GetComplianceSummaryByConfigRuleOutputBuilder {
    /// <p>The number of Config rules that are compliant and the number that are noncompliant, up to a maximum of 25 for each.</p>
    pub fn compliance_summary(mut self, input: super::super::super::types::ComplianceSummary) -> Self {
        self.compliance_summary = ::std::option::Option::Some(input);
        self
    }
    /// <p>The number of Config rules that are compliant and the number that are noncompliant, up to a maximum of 25 for each.</p>
    pub fn set_compliance_summary(mut self, input: ::std::option::Option<super::super::super::types::ComplianceSummary>) -> Self {
        self.compliance_summary = input;
        self
    }
    /// <p>The number of Config rules that are compliant and the number that are noncompliant, up to a maximum of 25 for each.</p>
    pub fn get_compliance_summary(&self) -> &::std::option::Option<super::super::super::types::ComplianceSummary> {
    ...
    pub fn build(self) -> super::super::super::operation::get_compliance_summary_by_config_rule::GetComplianceSummaryByConfigRuleOutput {
