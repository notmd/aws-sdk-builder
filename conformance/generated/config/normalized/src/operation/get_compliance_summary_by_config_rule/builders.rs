...
pub use super::super::super::operation::get_compliance_summary_by_config_rule::_get_compliance_summary_by_config_rule_input::GetComplianceSummaryByConfigRuleInputBuilder;

pub use super::super::super::operation::get_compliance_summary_by_config_rule::_get_compliance_summary_by_config_rule_output::GetComplianceSummaryByConfigRuleOutputBuilder;

impl super::super::super::operation::get_compliance_summary_by_config_rule::builders::GetComplianceSummaryByConfigRuleInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::get_compliance_summary_by_config_rule::GetComplianceSummaryByConfigRuleOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::get_compliance_summary_by_config_rule::GetComplianceSummaryByConfigRuleError,
...
pub struct GetComplianceSummaryByConfigRuleFluentBuilder {
    ...
    inner: super::super::super::operation::get_compliance_summary_by_config_rule::builders::GetComplianceSummaryByConfigRuleInputBuilder,
