...
pub struct ListResourceEvaluationsOutput {
    ...
    pub resource_evaluations: ::std::option::Option<::std::vec::Vec<super::super::super::types::ResourceEvaluation>>,
...
impl ListResourceEvaluationsOutput {
    ...
    pub fn resource_evaluations(&self) -> &[super::super::super::types::ResourceEvaluation] {
...
impl ListResourceEvaluationsOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_resource_evaluations::builders::ListResourceEvaluationsOutputBuilder {
        super::super::super::operation::list_resource_evaluations::builders::ListResourceEvaluationsOutputBuilder::default()
    }
}
...
pub struct ListResourceEvaluationsOutputBuilder {
    pub(crate) resource_evaluations: ::std::option::Option<::std::vec::Vec<super::super::super::types::ResourceEvaluation>>,
...
impl ListResourceEvaluationsOutputBuilder {
    ...
    ///
    /// <p>Returns a <code>ResourceEvaluations</code> object.</p>
    pub fn resource_evaluations(mut self, input: super::super::super::types::ResourceEvaluation) -> Self {
    ...
    /// <p>Returns a <code>ResourceEvaluations</code> object.</p>
    pub fn set_resource_evaluations(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::ResourceEvaluation>>) -> Self {
        self.resource_evaluations = input;
        self
    }
    /// <p>Returns a <code>ResourceEvaluations</code> object.</p>
    pub fn get_resource_evaluations(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::ResourceEvaluation>> {
    ...
    pub fn build(self) -> super::super::super::operation::list_resource_evaluations::ListResourceEvaluationsOutput {
