...
pub struct ListResourceEvaluationsPaginator {
    ...
    builder: super::super::super::operation::list_resource_evaluations::builders::ListResourceEvaluationsInputBuilder,
...
impl ListResourceEvaluationsPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::list_resource_evaluations::paginator::ListResourceEvaluationsPaginatorItems {
        super::super::super::operation::list_resource_evaluations::paginator::ListResourceEvaluationsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            super::super::super::operation::list_resource_evaluations::ListResourceEvaluations::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_resource_evaluations_output_output_next_token(resp);
...
impl ListResourceEvaluationsPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::ResourceEvaluation,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::list_resource_evaluations::ListResourceEvaluationsError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_list_resource_evaluations_output_output_resource_evaluations(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
