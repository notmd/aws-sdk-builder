...
impl StartResourceEvaluationInput {
    ...
    pub fn builder() -> super::super::super::operation::start_resource_evaluation::builders::StartResourceEvaluationInputBuilder {
        super::super::super::operation::start_resource_evaluation::builders::StartResourceEvaluationInputBuilder::default()
    }
}
...
impl StartResourceEvaluationInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::start_resource_evaluation::StartResourceEvaluationInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::start_resource_evaluation::StartResourceEvaluationInput {
