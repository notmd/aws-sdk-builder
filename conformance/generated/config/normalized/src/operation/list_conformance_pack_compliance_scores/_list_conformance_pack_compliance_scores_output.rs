...
pub struct ListConformancePackComplianceScoresOutput {
    ...
    pub conformance_pack_compliance_scores: ::std::vec::Vec<super::super::super::types::ConformancePackComplianceScore>,
...
impl ListConformancePackComplianceScoresOutput {
    ...
    /// <p>A list of <code>ConformancePackComplianceScore</code> objects.</p>
    pub fn conformance_pack_compliance_scores(&self) -> &[super::super::super::types::ConformancePackComplianceScore] {
        use std::ops::Deref;
...
pub struct ListConformancePackComplianceScoresOutputBuilder {
    ...
    pub(crate) conformance_pack_compliance_scores: ::std::option::Option<::std::vec::Vec<super::super::super::types::ConformancePackComplianceScore>>,
    _request_id: Option<String>,
}
impl ListConformancePackComplianceScoresOutputBuilder {
    ...
    ///
    /// <p>A list of <code>ConformancePackComplianceScore</code> objects.</p>
    pub fn conformance_pack_compliance_scores(mut self, input: super::super::super::types::ConformancePackComplianceScore) -> Self {
    ...
    pub fn set_conformance_pack_compliance_scores(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::ConformancePackComplianceScore>>,
    ) -> Self {
    ...
    > {
        ::std::result::Result::Ok(super::super::super::operation::list_conformance_pack_compliance_scores::ListConformancePackComplianceScoresOutput {
