...
pub struct DescribeConformancePackCompliancePaginator {
    ...
    builder: super::super::super::operation::describe_conformance_pack_compliance::builders::DescribeConformancePackComplianceInputBuilder,
...
impl DescribeConformancePackCompliancePaginator {
    ...
    pub fn items(self) -> super::super::super::operation::describe_conformance_pack_compliance::paginator::DescribeConformancePackCompliancePaginatorItems {
        super::super::super::operation::describe_conformance_pack_compliance::paginator::DescribeConformancePackCompliancePaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::super::super::operation::describe_conformance_pack_compliance::DescribeConformancePackCompliance::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_describe_conformance_pack_compliance_output_output_next_token(resp);
...
impl DescribeConformancePackCompliancePaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::ConformancePackRuleCompliance,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::describe_conformance_pack_compliance::DescribeConformancePackComplianceError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_describe_conformance_pack_compliance_output_output_conformance_pack_rule_compliance_list(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
