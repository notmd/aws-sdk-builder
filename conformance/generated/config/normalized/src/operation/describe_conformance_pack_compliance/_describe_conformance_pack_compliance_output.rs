...
pub struct DescribeConformancePackComplianceOutput {
    ...
    pub conformance_pack_rule_compliance_list: ::std::vec::Vec<super::super::super::types::ConformancePackRuleCompliance>,
...
impl DescribeConformancePackComplianceOutput {
    ...
    /// <p>Returns a list of <code>ConformancePackRuleCompliance</code> objects.</p>
    pub fn conformance_pack_rule_compliance_list(&self) -> &[super::super::super::types::ConformancePackRuleCompliance] {
        use std::ops::Deref;
...
impl DescribeConformancePackComplianceOutputBuilder {
    ...
    ///
    /// <p>Returns a list of <code>ConformancePackRuleCompliance</code> objects.</p>
    pub fn conformance_pack_rule_compliance_list(mut self, input: super::super::super::types::ConformancePackRuleCompliance) -> Self {
    ...
    pub fn set_conformance_pack_rule_compliance_list(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::ConformancePackRuleCompliance>>,
    ) -> Self {
    ...
    > {
        ::std::result::Result::Ok(super::super::super::operation::describe_conformance_pack_compliance::DescribeConformancePackComplianceOutput {
