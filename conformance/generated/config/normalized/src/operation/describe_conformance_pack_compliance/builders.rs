...
pub use super::super::super::operation::describe_conformance_pack_compliance::_describe_conformance_pack_compliance_input::DescribeConformancePackComplianceInputBuilder;

pub use super::super::super::operation::describe_conformance_pack_compliance::_describe_conformance_pack_compliance_output::DescribeConformancePackComplianceOutputBuilder;

impl super::super::super::operation::describe_conformance_pack_compliance::builders::DescribeConformancePackComplianceInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::describe_conformance_pack_compliance::DescribeConformancePackComplianceOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::describe_conformance_pack_compliance::DescribeConformancePackComplianceError,
...
pub struct DescribeConformancePackComplianceFluentBuilder {
    ...
    inner: super::super::super::operation::describe_conformance_pack_compliance::builders::DescribeConformancePackComplianceInputBuilder,
...
impl DescribeConformancePackComplianceFluentBuilder {
    ...
    pub fn filters(mut self, input: super::super::super::types::ConformancePackComplianceFilters) -> Self {
        self.inner = self.inner.filters(input);
        self
    }
    /// <p>A <code>ConformancePackComplianceFilters</code> object.</p>
    pub fn set_filters(mut self, input: ::std::option::Option<super::super::super::types::ConformancePackComplianceFilters>) -> Self {
        self.inner = self.inner.set_filters(input);
        self
    }
    /// <p>A <code>ConformancePackComplianceFilters</code> object.</p>
    pub fn get_filters(&self) -> &::std::option::Option<super::super::super::types::ConformancePackComplianceFilters> {
