...
impl DisassociateResourceTypes {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::disassociate_resource_types::DisassociateResourceTypesInput,
    ) -> ::std::result::Result<
        super::super::operation::disassociate_resource_types::DisassociateResourceTypesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::disassociate_resource_types::DisassociateResourceTypesError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::disassociate_resource_types::DisassociateResourceTypesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::disassociate_resource_types::DisassociateResourceTypesOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisassociateResourceTypes {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisassociateResourceTypes")
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisassociateResourceTypesTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DisassociateResourceTypesInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisassociateResourceTypesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_disassociate_resource_types::de_disassociate_resource_types_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_disassociate_resource_types::de_disassociate_resource_types_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisassociateResourceTypesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::disassociate_resource_types::DisassociateResourceTypesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::disassociate_resource_types::DisassociateResourceTypesInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_disassociate_resource_types::ser_disassociate_resource_types_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::super::operation::disassociate_resource_types::DisassociateResourceTypesError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::disassociate_resource_types::_disassociate_resource_types_input::DisassociateResourceTypesInput;

pub use super::super::operation::disassociate_resource_types::_disassociate_resource_types_output::DisassociateResourceTypesOutput;
