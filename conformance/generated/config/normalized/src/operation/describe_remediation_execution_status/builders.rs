...
pub use super::super::super::operation::describe_remediation_execution_status::_describe_remediation_execution_status_input::DescribeRemediationExecutionStatusInputBuilder;

pub use super::super::super::operation::describe_remediation_execution_status::_describe_remediation_execution_status_output::DescribeRemediationExecutionStatusOutputBuilder;

impl super::super::super::operation::describe_remediation_execution_status::builders::DescribeRemediationExecutionStatusInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::describe_remediation_execution_status::DescribeRemediationExecutionStatusOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::describe_remediation_execution_status::DescribeRemediationExecutionStatusError,
...
pub struct DescribeRemediationExecutionStatusFluentBuilder {
    ...
    inner: super::super::super::operation::describe_remediation_execution_status::builders::DescribeRemediationExecutionStatusInputBuilder,
