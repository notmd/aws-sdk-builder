...
pub struct DescribeRemediationExecutionStatusPaginator {
    ...
    builder: super::super::super::operation::describe_remediation_execution_status::builders::DescribeRemediationExecutionStatusInputBuilder,
...
impl DescribeRemediationExecutionStatusPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::RemediationExecutionStatus,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::describe_remediation_execution_status::DescribeRemediationExecutionStatusError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_describe_remediation_execution_status_output_output_remediation_execution_statuses(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
