...
pub struct DescribeRemediationExecutionStatusOutput {
    ...
    pub remediation_execution_statuses: ::std::option::Option<::std::vec::Vec<super::super::super::types::RemediationExecutionStatus>>,
...
impl DescribeRemediationExecutionStatusOutput {
    ...
    pub fn remediation_execution_statuses(&self) -> &[super::super::super::types::RemediationExecutionStatus] {
...
pub struct DescribeRemediationExecutionStatusOutputBuilder {
    pub(crate) remediation_execution_statuses: ::std::option::Option<::std::vec::Vec<super::super::super::types::RemediationExecutionStatus>>,
...
impl DescribeRemediationExecutionStatusOutputBuilder {
    ...
    ///
    /// <p>Returns a list of remediation execution statuses objects.</p>
    pub fn remediation_execution_statuses(mut self, input: super::super::super::types::RemediationExecutionStatus) -> Self {
    ...
    pub fn set_remediation_execution_statuses(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::RemediationExecutionStatus>>,
    ) -> Self {
    ...
    pub fn build(self) -> super::super::super::operation::describe_remediation_execution_status::DescribeRemediationExecutionStatusOutput {
