...
pub struct GetAggregateConformancePackComplianceSummaryOutput {
    ...
    pub aggregate_conformance_pack_compliance_summaries:
        ::std::option::Option<::std::vec::Vec<super::super::super::types::AggregateConformancePackComplianceSummary>>,
...
impl GetAggregateConformancePackComplianceSummaryOutput {
    ...
    pub fn aggregate_conformance_pack_compliance_summaries(&self) -> &[super::super::super::types::AggregateConformancePackComplianceSummary] {
...
impl GetAggregateConformancePackComplianceSummaryOutputBuilder {
    ...
    pub fn set_aggregate_conformance_pack_compliance_summaries(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::AggregateConformancePackComplianceSummary>>,
    ) -> Self {
