...
pub struct GetAggregateConformancePackComplianceSummaryInput {
    ...
    pub filters: ::std::option::Option<super::super::super::types::AggregateConformancePackComplianceSummaryFilters>,
    /// <p>Groups the result based on Amazon Web Services account ID or Amazon Web Services Region.</p>
    pub group_by_key: ::std::option::Option<super::super::super::types::AggregateConformancePackComplianceSummaryGroupKey>,
...
impl GetAggregateConformancePackComplianceSummaryInput {
    ...
    /// <p>Filters the results based on the <code>AggregateConformancePackComplianceSummaryFilters</code> object.</p>
    pub fn filters(&self) -> ::std::option::Option<&super::super::super::types::AggregateConformancePackComplianceSummaryFilters> {
        self.filters.as_ref()
    }
    /// <p>Groups the result based on Amazon Web Services account ID or Amazon Web Services Region.</p>
    pub fn group_by_key(&self) -> ::std::option::Option<&super::super::super::types::AggregateConformancePackComplianceSummaryGroupKey> {
...
pub struct GetAggregateConformancePackComplianceSummaryInputBuilder {
    ...
    pub(crate) filters: ::std::option::Option<super::super::super::types::AggregateConformancePackComplianceSummaryFilters>,
    pub(crate) group_by_key: ::std::option::Option<super::super::super::types::AggregateConformancePackComplianceSummaryGroupKey>,
...
impl GetAggregateConformancePackComplianceSummaryInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::get_aggregate_conformance_pack_compliance_summary::GetAggregateConformancePackComplianceSummaryInput,
