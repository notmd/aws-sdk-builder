...
pub use super::super::super::operation::get_aggregate_conformance_pack_compliance_summary::_get_aggregate_conformance_pack_compliance_summary_input::GetAggregateConformancePackComplianceSummaryInputBuilder;

pub use super::super::super::operation::get_aggregate_conformance_pack_compliance_summary::_get_aggregate_conformance_pack_compliance_summary_output::GetAggregateConformancePackComplianceSummaryOutputBuilder;

impl super::super::super::operation::get_aggregate_conformance_pack_compliance_summary::builders::GetAggregateConformancePackComplianceSummaryInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::get_aggregate_conformance_pack_compliance_summary::GetAggregateConformancePackComplianceSummaryError,
...
pub struct GetAggregateConformancePackComplianceSummaryFluentBuilder {
    ...
    inner: super::super::super::operation::get_aggregate_conformance_pack_compliance_summary::builders::GetAggregateConformancePackComplianceSummaryInputBuilder,
...
impl GetAggregateConformancePackComplianceSummaryFluentBuilder {
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::get_aggregate_conformance_pack_compliance_summary::GetAggregateConformancePackComplianceSummary::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
        super::super::super::operation::get_aggregate_conformance_pack_compliance_summary::GetAggregateConformancePackComplianceSummary::orchestrate(
            &runtime_plugins,
            input,
        )
        .await
    ...
    pub fn filters(mut self, input: super::super::super::types::AggregateConformancePackComplianceSummaryFilters) -> Self {
        self.inner = self.inner.filters(input);
        self
    }
    /// <p>Filters the results based on the <code>AggregateConformancePackComplianceSummaryFilters</code> object.</p>
    pub fn set_filters(mut self, input: ::std::option::Option<super::super::super::types::AggregateConformancePackComplianceSummaryFilters>) -> Self {
        self.inner = self.inner.set_filters(input);
        self
    }
    /// <p>Filters the results based on the <code>AggregateConformancePackComplianceSummaryFilters</code> object.</p>
    pub fn get_filters(&self) -> &::std::option::Option<super::super::super::types::AggregateConformancePackComplianceSummaryFilters> {
        self.inner.get_filters()
    }
    /// <p>Groups the result based on Amazon Web Services account ID or Amazon Web Services Region.</p>
    pub fn group_by_key(mut self, input: super::super::super::types::AggregateConformancePackComplianceSummaryGroupKey) -> Self {
    ...
    /// <p>Groups the result based on Amazon Web Services account ID or Amazon Web Services Region.</p>
    pub fn get_group_by_key(&self) -> &::std::option::Option<super::super::super::types::AggregateConformancePackComplianceSummaryGroupKey> {
