...
pub struct GetResourceConfigHistoryInput {
    ...
    pub chronological_order: ::std::option::Option<super::super::super::types::ChronologicalOrder>,
...
impl GetResourceConfigHistoryInput {
    ...
    /// <p>The chronological order for configuration items listed. By default, the results are listed in reverse chronological order.</p>
    pub fn chronological_order(&self) -> ::std::option::Option<&super::super::super::types::ChronologicalOrder> {
...
impl GetResourceConfigHistoryInput {
    ...
    pub fn builder() -> super::super::super::operation::get_resource_config_history::builders::GetResourceConfigHistoryInputBuilder {
        super::super::super::operation::get_resource_config_history::builders::GetResourceConfigHistoryInputBuilder::default()
    }
}
...
pub struct GetResourceConfigHistoryInputBuilder {
    ...
    pub(crate) chronological_order: ::std::option::Option<super::super::super::types::ChronologicalOrder>,
