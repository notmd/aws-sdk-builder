...
/// Paginator for [`GetResourceConfigHistory`](crate::operation::get_resource_config_history::GetResourceConfigHistory)
pub struct GetResourceConfigHistoryPaginator {
    handle: std::sync::Arc<super::super::super::client::Handle>,
    builder: super::super::super::operation::get_resource_config_history::builders::GetResourceConfigHistoryInputBuilder,
...
impl GetResourceConfigHistoryPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::get_resource_config_history::paginator::GetResourceConfigHistoryPaginatorItems {
        super::super::super::operation::get_resource_config_history::paginator::GetResourceConfigHistoryPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            super::super::super::operation::get_resource_config_history::GetResourceConfigHistory::orchestrate(&runtime_plugins, input.clone())
                                .await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_get_resource_config_history_output_output_next_token(resp);
...
impl GetResourceConfigHistoryPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::ConfigurationItem,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::get_resource_config_history::GetResourceConfigHistoryError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_get_resource_config_history_output_output_configuration_items(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
