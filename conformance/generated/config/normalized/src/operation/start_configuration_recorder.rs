...
impl StartConfigurationRecorder {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::start_configuration_recorder::StartConfigurationRecorderInput,
    ) -> ::std::result::Result<
        super::super::operation::start_configuration_recorder::StartConfigurationRecorderOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::start_configuration_recorder::StartConfigurationRecorderError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::start_configuration_recorder::StartConfigurationRecorderError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::start_configuration_recorder::StartConfigurationRecorderOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartConfigurationRecorder {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartConfigurationRecorder")
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartConfigurationRecorderTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<StartConfigurationRecorderInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartConfigurationRecorderResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_start_configuration_recorder::de_start_configuration_recorder_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_start_configuration_recorder::de_start_configuration_recorder_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartConfigurationRecorderRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::start_configuration_recorder::StartConfigurationRecorderInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::start_configuration_recorder::StartConfigurationRecorderInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_start_configuration_recorder::ser_start_configuration_recorder_input(&input)?,
        );
...
pub enum StartConfigurationRecorderError {
    ...
    NoAvailableDeliveryChannelException(super::super::types::error::NoAvailableDeliveryChannelException),
...
impl StartConfigurationRecorderError {
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::NoAvailableDeliveryChannelException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for StartConfigurationRecorderError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::NoAvailableDeliveryChannelException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
...
impl ::aws_types::request_id::RequestId for super::super::operation::start_configuration_recorder::StartConfigurationRecorderError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::start_configuration_recorder::_start_configuration_recorder_input::StartConfigurationRecorderInput;

pub use super::super::operation::start_configuration_recorder::_start_configuration_recorder_output::StartConfigurationRecorderOutput;
