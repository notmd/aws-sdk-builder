...
impl GetOrganizationConfigRuleDetailedStatusPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::MemberAccountStatus,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::get_organization_config_rule_detailed_status::GetOrganizationConfigRuleDetailedStatusError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_get_organization_config_rule_detailed_status_output_output_organization_config_rule_detailed_status(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
