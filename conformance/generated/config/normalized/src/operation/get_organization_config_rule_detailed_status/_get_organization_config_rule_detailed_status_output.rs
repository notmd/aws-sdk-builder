...
pub struct GetOrganizationConfigRuleDetailedStatusOutput {
    ...
    pub organization_config_rule_detailed_status: ::std::option::Option<::std::vec::Vec<super::super::super::types::MemberAccountStatus>>,
...
impl GetOrganizationConfigRuleDetailedStatusOutput {
    ...
    pub fn organization_config_rule_detailed_status(&self) -> &[super::super::super::types::MemberAccountStatus] {
...
pub struct GetOrganizationConfigRuleDetailedStatusOutputBuilder {
    pub(crate) organization_config_rule_detailed_status: ::std::option::Option<::std::vec::Vec<super::super::super::types::MemberAccountStatus>>,
...
impl GetOrganizationConfigRuleDetailedStatusOutputBuilder {
    ...
    ///
    /// <p>A list of <code>MemberAccountStatus</code> objects.</p>
    pub fn organization_config_rule_detailed_status(mut self, input: super::super::super::types::MemberAccountStatus) -> Self {
    ...
    pub fn set_organization_config_rule_detailed_status(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::MemberAccountStatus>>,
    ) -> Self {
