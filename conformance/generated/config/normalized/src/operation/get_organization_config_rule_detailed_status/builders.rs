...
pub use super::super::super::operation::get_organization_config_rule_detailed_status::_get_organization_config_rule_detailed_status_input::GetOrganizationConfigRuleDetailedStatusInputBuilder;

pub use super::super::super::operation::get_organization_config_rule_detailed_status::_get_organization_config_rule_detailed_status_output::GetOrganizationConfigRuleDetailedStatusOutputBuilder;

impl super::super::super::operation::get_organization_config_rule_detailed_status::builders::GetOrganizationConfigRuleDetailedStatusInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::get_organization_config_rule_detailed_status::GetOrganizationConfigRuleDetailedStatusError,
...
impl GetOrganizationConfigRuleDetailedStatusFluentBuilder {
    ...
    pub fn filters(mut self, input: super::super::super::types::StatusDetailFilters) -> Self {
        self.inner = self.inner.filters(input);
        self
    }
    /// <p>A <code>StatusDetailFilters</code> object.</p>
    pub fn set_filters(mut self, input: ::std::option::Option<super::super::super::types::StatusDetailFilters>) -> Self {
        self.inner = self.inner.set_filters(input);
        self
    }
    /// <p>A <code>StatusDetailFilters</code> object.</p>
    pub fn get_filters(&self) -> &::std::option::Option<super::super::super::types::StatusDetailFilters> {
