...
impl DeletePendingAggregationRequestInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_pending_aggregation_request::builders::DeletePendingAggregationRequestInputBuilder {
        super::super::super::operation::delete_pending_aggregation_request::builders::DeletePendingAggregationRequestInputBuilder::default()
    }
}
...
impl DeletePendingAggregationRequestInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::delete_pending_aggregation_request::DeletePendingAggregationRequestInput,
