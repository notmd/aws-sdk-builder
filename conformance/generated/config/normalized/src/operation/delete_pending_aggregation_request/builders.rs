...
pub use super::super::super::operation::delete_pending_aggregation_request::_delete_pending_aggregation_request_input::DeletePendingAggregationRequestInputBuilder;

pub use super::super::super::operation::delete_pending_aggregation_request::_delete_pending_aggregation_request_output::DeletePendingAggregationRequestOutputBuilder;

impl super::super::super::operation::delete_pending_aggregation_request::builders::DeletePendingAggregationRequestInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_pending_aggregation_request::DeletePendingAggregationRequestOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_pending_aggregation_request::DeletePendingAggregationRequestError,
...
pub struct DeletePendingAggregationRequestFluentBuilder {
    ...
    inner: super::super::super::operation::delete_pending_aggregation_request::builders::DeletePendingAggregationRequestInputBuilder,
...
impl DeletePendingAggregationRequestFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_pending_aggregation_request::builders::DeletePendingAggregationRequestInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_pending_aggregation_request::DeletePendingAggregationRequest::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_pending_aggregation_request::DeletePendingAggregationRequest::orchestrate(&runtime_plugins, input).await
    }
