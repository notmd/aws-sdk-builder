...
impl PutStoredQuery {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::put_stored_query::PutStoredQueryInput,
    ) -> ::std::result::Result<
        super::super::operation::put_stored_query::PutStoredQueryOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::put_stored_query::PutStoredQueryError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::put_stored_query::PutStoredQueryError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::put_stored_query::PutStoredQueryOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutStoredQuery {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutStoredQuery")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutStoredQueryResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_put_stored_query::de_put_stored_query_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_put_stored_query::de_put_stored_query_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutStoredQueryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::put_stored_query::PutStoredQueryInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::put_stored_query::PutStoredQueryInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_put_stored_query::ser_put_stored_query_input(&input)?);
...
pub enum PutStoredQueryError {
    ...
    ResourceConcurrentModificationException(super::super::types::error::ResourceConcurrentModificationException),
    ...
    TooManyTagsException(super::super::types::error::TooManyTagsException),
...
impl PutStoredQueryError {
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::ResourceConcurrentModificationException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for PutStoredQueryError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::ResourceConcurrentModificationException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
...
impl ::aws_types::request_id::RequestId for super::super::operation::put_stored_query::PutStoredQueryError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::put_stored_query::_put_stored_query_input::PutStoredQueryInput;

pub use super::super::operation::put_stored_query::_put_stored_query_output::PutStoredQueryOutput;
