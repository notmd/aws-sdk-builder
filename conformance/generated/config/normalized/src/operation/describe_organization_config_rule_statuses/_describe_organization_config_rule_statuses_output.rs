...
pub struct DescribeOrganizationConfigRuleStatusesOutput {
    ...
    pub organization_config_rule_statuses: ::std::option::Option<::std::vec::Vec<super::super::super::types::OrganizationConfigRuleStatus>>,
...
impl DescribeOrganizationConfigRuleStatusesOutput {
    ...
    pub fn organization_config_rule_statuses(&self) -> &[super::super::super::types::OrganizationConfigRuleStatus] {
...
pub struct DescribeOrganizationConfigRuleStatusesOutputBuilder {
    pub(crate) organization_config_rule_statuses: ::std::option::Option<::std::vec::Vec<super::super::super::types::OrganizationConfigRuleStatus>>,
...
impl DescribeOrganizationConfigRuleStatusesOutputBuilder {
    ...
    ///
    /// <p>A list of <code>OrganizationConfigRuleStatus</code> objects.</p>
    pub fn organization_config_rule_statuses(mut self, input: super::super::super::types::OrganizationConfigRuleStatus) -> Self {
    ...
    pub fn set_organization_config_rule_statuses(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::OrganizationConfigRuleStatus>>,
    ) -> Self {
    ...
    pub fn build(self) -> super::super::super::operation::describe_organization_config_rule_statuses::DescribeOrganizationConfigRuleStatusesOutput {
