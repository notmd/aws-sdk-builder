...
pub struct DescribeOrganizationConfigRuleStatusesPaginator {
    ...
    builder: super::super::super::operation::describe_organization_config_rule_statuses::builders::DescribeOrganizationConfigRuleStatusesInputBuilder,
...
impl DescribeOrganizationConfigRuleStatusesPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::OrganizationConfigRuleStatus,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::describe_organization_config_rule_statuses::DescribeOrganizationConfigRuleStatusesError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_describe_organization_config_rule_statuses_output_output_organization_config_rule_statuses(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
