...
pub use super::super::super::operation::describe_organization_config_rule_statuses::_describe_organization_config_rule_statuses_input::DescribeOrganizationConfigRuleStatusesInputBuilder;

pub use super::super::super::operation::describe_organization_config_rule_statuses::_describe_organization_config_rule_statuses_output::DescribeOrganizationConfigRuleStatusesOutputBuilder;

impl super::super::super::operation::describe_organization_config_rule_statuses::builders::DescribeOrganizationConfigRuleStatusesInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::describe_organization_config_rule_statuses::DescribeOrganizationConfigRuleStatusesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::describe_organization_config_rule_statuses::DescribeOrganizationConfigRuleStatusesError,
...
pub struct DescribeOrganizationConfigRuleStatusesFluentBuilder {
    ...
    inner: super::super::super::operation::describe_organization_config_rule_statuses::builders::DescribeOrganizationConfigRuleStatusesInputBuilder,
...
impl DescribeOrganizationConfigRuleStatusesFluentBuilder {
    ...
    > {
        ...
        super::super::super::operation::describe_organization_config_rule_statuses::DescribeOrganizationConfigRuleStatuses::orchestrate(&runtime_plugins, input)
            .await
    }
    ...
    pub fn into_paginator(
        self,
    ) -> super::super::super::operation::describe_organization_config_rule_statuses::paginator::DescribeOrganizationConfigRuleStatusesPaginator {
        super::super::super::operation::describe_organization_config_rule_statuses::paginator::DescribeOrganizationConfigRuleStatusesPaginator::new(
            self.handle,
            self.inner,
        )
    }
