...
pub use super::super::super::operation::describe_remediation_exceptions::_describe_remediation_exceptions_input::DescribeRemediationExceptionsInputBuilder;

pub use super::super::super::operation::describe_remediation_exceptions::_describe_remediation_exceptions_output::DescribeRemediationExceptionsOutputBuilder;

impl super::super::super::operation::describe_remediation_exceptions::builders::DescribeRemediationExceptionsInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::describe_remediation_exceptions::DescribeRemediationExceptionsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::describe_remediation_exceptions::DescribeRemediationExceptionsError,
...
pub struct DescribeRemediationExceptionsFluentBuilder {
    ...
    inner: super::super::super::operation::describe_remediation_exceptions::builders::DescribeRemediationExceptionsInputBuilder,
...
impl DescribeRemediationExceptionsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::describe_remediation_exceptions::builders::DescribeRemediationExceptionsInputBuilder {
        &self.inner
    }
