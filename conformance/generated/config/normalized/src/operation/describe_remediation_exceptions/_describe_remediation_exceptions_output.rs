...
pub struct DescribeRemediationExceptionsOutput {
    ...
    pub remediation_exceptions: ::std::option::Option<::std::vec::Vec<super::super::super::types::RemediationException>>,
...
impl DescribeRemediationExceptionsOutput {
    ...
    pub fn remediation_exceptions(&self) -> &[super::super::super::types::RemediationException] {
...
impl DescribeRemediationExceptionsOutput {
    ...
    pub fn builder() -> super::super::super::operation::describe_remediation_exceptions::builders::DescribeRemediationExceptionsOutputBuilder {
        super::super::super::operation::describe_remediation_exceptions::builders::DescribeRemediationExceptionsOutputBuilder::default()
    }
}
...
pub struct DescribeRemediationExceptionsOutputBuilder {
    pub(crate) remediation_exceptions: ::std::option::Option<::std::vec::Vec<super::super::super::types::RemediationException>>,
...
impl DescribeRemediationExceptionsOutputBuilder {
    ...
    ///
    /// <p>Returns a list of remediation exception objects.</p>
    pub fn remediation_exceptions(mut self, input: super::super::super::types::RemediationException) -> Self {
    ...
    /// <p>Returns a list of remediation exception objects.</p>
    pub fn get_remediation_exceptions(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::RemediationException>> {
    ...
    pub fn build(self) -> super::super::super::operation::describe_remediation_exceptions::DescribeRemediationExceptionsOutput {
