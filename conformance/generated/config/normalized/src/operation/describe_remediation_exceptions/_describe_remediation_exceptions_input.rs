...
pub struct DescribeRemediationExceptionsInput {
    ...
    pub resource_keys: ::std::option::Option<::std::vec::Vec<super::super::super::types::RemediationExceptionResourceKey>>,
...
impl DescribeRemediationExceptionsInput {
    ...
    pub fn resource_keys(&self) -> &[super::super::super::types::RemediationExceptionResourceKey] {
...
impl DescribeRemediationExceptionsInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_remediation_exceptions::builders::DescribeRemediationExceptionsInputBuilder {
        super::super::super::operation::describe_remediation_exceptions::builders::DescribeRemediationExceptionsInputBuilder::default()
    }
}
...
pub struct DescribeRemediationExceptionsInputBuilder {
    ...
    pub(crate) resource_keys: ::std::option::Option<::std::vec::Vec<super::super::super::types::RemediationExceptionResourceKey>>,
