...
impl StartConfigRulesEvaluationInput {
    ...
    pub fn builder() -> super::super::super::operation::start_config_rules_evaluation::builders::StartConfigRulesEvaluationInputBuilder {
        super::super::super::operation::start_config_rules_evaluation::builders::StartConfigRulesEvaluationInputBuilder::default()
    }
}
