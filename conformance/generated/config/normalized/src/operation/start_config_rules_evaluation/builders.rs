...
pub use super::super::super::operation::start_config_rules_evaluation::_start_config_rules_evaluation_input::StartConfigRulesEvaluationInputBuilder;

pub use super::super::super::operation::start_config_rules_evaluation::_start_config_rules_evaluation_output::StartConfigRulesEvaluationOutputBuilder;

impl super::super::super::operation::start_config_rules_evaluation::builders::StartConfigRulesEvaluationInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::start_config_rules_evaluation::StartConfigRulesEvaluationOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::start_config_rules_evaluation::StartConfigRulesEvaluationError,
...
pub struct StartConfigRulesEvaluationFluentBuilder {
    ...
    inner: super::super::super::operation::start_config_rules_evaluation::builders::StartConfigRulesEvaluationInputBuilder,
...
impl StartConfigRulesEvaluationFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::start_config_rules_evaluation::builders::StartConfigRulesEvaluationInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::start_config_rules_evaluation::StartConfigRulesEvaluation::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::start_config_rules_evaluation::StartConfigRulesEvaluation::orchestrate(&runtime_plugins, input).await
    }
