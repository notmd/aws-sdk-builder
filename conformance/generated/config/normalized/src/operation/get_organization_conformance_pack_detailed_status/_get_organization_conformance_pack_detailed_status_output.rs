...
pub struct GetOrganizationConformancePackDetailedStatusOutput {
    ...
    pub organization_conformance_pack_detailed_statuses:
        ::std::option::Option<::std::vec::Vec<super::super::super::types::OrganizationConformancePackDetailedStatus>>,
...
impl GetOrganizationConformancePackDetailedStatusOutput {
    ...
    pub fn organization_conformance_pack_detailed_statuses(&self) -> &[super::super::super::types::OrganizationConformancePackDetailedStatus] {
...
impl GetOrganizationConformancePackDetailedStatusOutputBuilder {
    ...
    pub fn set_organization_conformance_pack_detailed_statuses(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::OrganizationConformancePackDetailedStatus>>,
    ) -> Self {
