...
pub struct GetOrganizationConformancePackDetailedStatusPaginator {
    ...
    builder: super::super::super::operation::get_organization_conformance_pack_detailed_status::builders::GetOrganizationConformancePackDetailedStatusInputBuilder,
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::super::super::operation::get_organization_conformance_pack_detailed_status::GetOrganizationConformancePackDetailedStatus::orchestrate(&runtime_plugins, input.clone()).await;
...
impl GetOrganizationConformancePackDetailedStatusPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::OrganizationConformancePackDetailedStatus,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::get_organization_conformance_pack_detailed_status::GetOrganizationConformancePackDetailedStatusError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
