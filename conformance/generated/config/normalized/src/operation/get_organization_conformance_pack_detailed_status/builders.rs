...
pub use super::super::super::operation::get_organization_conformance_pack_detailed_status::_get_organization_conformance_pack_detailed_status_input::GetOrganizationConformancePackDetailedStatusInputBuilder;

pub use super::super::super::operation::get_organization_conformance_pack_detailed_status::_get_organization_conformance_pack_detailed_status_output::GetOrganizationConformancePackDetailedStatusOutputBuilder;

impl super::super::super::operation::get_organization_conformance_pack_detailed_status::builders::GetOrganizationConformancePackDetailedStatusInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::get_organization_conformance_pack_detailed_status::GetOrganizationConformancePackDetailedStatusError,
...
pub struct GetOrganizationConformancePackDetailedStatusFluentBuilder {
    ...
    inner: super::super::super::operation::get_organization_conformance_pack_detailed_status::builders::GetOrganizationConformancePackDetailedStatusInputBuilder,
...
impl GetOrganizationConformancePackDetailedStatusFluentBuilder {
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::get_organization_conformance_pack_detailed_status::GetOrganizationConformancePackDetailedStatus::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
        super::super::super::operation::get_organization_conformance_pack_detailed_status::GetOrganizationConformancePackDetailedStatus::orchestrate(
            &runtime_plugins,
            input,
        )
        .await
    ...
    pub fn filters(mut self, input: super::super::super::types::OrganizationResourceDetailedStatusFilters) -> Self {
        self.inner = self.inner.filters(input);
        self
    }
    /// <p>An <code>OrganizationResourceDetailedStatusFilters</code> object.</p>
    pub fn set_filters(mut self, input: ::std::option::Option<super::super::super::types::OrganizationResourceDetailedStatusFilters>) -> Self {
        self.inner = self.inner.set_filters(input);
        self
    }
    /// <p>An <code>OrganizationResourceDetailedStatusFilters</code> object.</p>
    pub fn get_filters(&self) -> &::std::option::Option<super::super::super::types::OrganizationResourceDetailedStatusFilters> {
