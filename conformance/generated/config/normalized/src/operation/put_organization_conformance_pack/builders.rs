...
pub use super::super::super::operation::put_organization_conformance_pack::_put_organization_conformance_pack_input::PutOrganizationConformancePackInputBuilder;

pub use super::super::super::operation::put_organization_conformance_pack::_put_organization_conformance_pack_output::PutOrganizationConformancePackOutputBuilder;

impl super::super::super::operation::put_organization_conformance_pack::builders::PutOrganizationConformancePackInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::put_organization_conformance_pack::PutOrganizationConformancePackOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::put_organization_conformance_pack::PutOrganizationConformancePackError,
...
pub struct PutOrganizationConformancePackFluentBuilder {
    ...
    inner: super::super::super::operation::put_organization_conformance_pack::builders::PutOrganizationConformancePackInputBuilder,
