...
pub struct ListAggregateDiscoveredResourcesOutput {
    ...
    pub resource_identifiers: ::std::option::Option<::std::vec::Vec<super::super::super::types::AggregateResourceIdentifier>>,
...
impl ListAggregateDiscoveredResourcesOutput {
    ...
    pub fn resource_identifiers(&self) -> &[super::super::super::types::AggregateResourceIdentifier] {
...
impl ListAggregateDiscoveredResourcesOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_aggregate_discovered_resources::builders::ListAggregateDiscoveredResourcesOutputBuilder {
        super::super::super::operation::list_aggregate_discovered_resources::builders::ListAggregateDiscoveredResourcesOutputBuilder::default()
    }
}
...
pub struct ListAggregateDiscoveredResourcesOutputBuilder {
    pub(crate) resource_identifiers: ::std::option::Option<::std::vec::Vec<super::super::super::types::AggregateResourceIdentifier>>,
...
impl ListAggregateDiscoveredResourcesOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::list_aggregate_discovered_resources::ListAggregateDiscoveredResourcesOutput {
