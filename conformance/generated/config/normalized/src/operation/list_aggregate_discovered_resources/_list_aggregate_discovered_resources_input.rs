...
pub struct ListAggregateDiscoveredResourcesInput {
    ...
    pub resource_type: ::std::option::Option<super::super::super::types::ResourceType>,
    /// <p>Filters the results based on the <code>ResourceFilters</code> object.</p>
    pub filters: ::std::option::Option<super::super::super::types::ResourceFilters>,
...
impl ListAggregateDiscoveredResourcesInput {
    ...
    /// <p>The type of resources that you want Config to list in the response.</p>
    pub fn resource_type(&self) -> ::std::option::Option<&super::super::super::types::ResourceType> {
        self.resource_type.as_ref()
    }
    /// <p>Filters the results based on the <code>ResourceFilters</code> object.</p>
    pub fn filters(&self) -> ::std::option::Option<&super::super::super::types::ResourceFilters> {
        self.filters.as_ref()
    }
    /// <p>The maximum number of resource identifiers returned on each page. You cannot specify a number greater than 100. If you specify 0, Config uses the default.</p>
...
impl ListAggregateDiscoveredResourcesInput {
    ...
    pub fn builder() -> super::super::super::operation::list_aggregate_discovered_resources::builders::ListAggregateDiscoveredResourcesInputBuilder {
        super::super::super::operation::list_aggregate_discovered_resources::builders::ListAggregateDiscoveredResourcesInputBuilder::default()
    }
}
...
pub struct ListAggregateDiscoveredResourcesInputBuilder {
    ...
    pub(crate) resource_type: ::std::option::Option<super::super::super::types::ResourceType>,
    pub(crate) filters: ::std::option::Option<super::super::super::types::ResourceFilters>,
...
impl ListAggregateDiscoveredResourcesInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::list_aggregate_discovered_resources::ListAggregateDiscoveredResourcesInput,
