...
pub use super::super::super::operation::list_aggregate_discovered_resources::_list_aggregate_discovered_resources_input::ListAggregateDiscoveredResourcesInputBuilder;

pub use super::super::super::operation::list_aggregate_discovered_resources::_list_aggregate_discovered_resources_output::ListAggregateDiscoveredResourcesOutputBuilder;

impl super::super::super::operation::list_aggregate_discovered_resources::builders::ListAggregateDiscoveredResourcesInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::list_aggregate_discovered_resources::ListAggregateDiscoveredResourcesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::list_aggregate_discovered_resources::ListAggregateDiscoveredResourcesError,
...
pub struct ListAggregateDiscoveredResourcesFluentBuilder {
    ...
    inner: super::super::super::operation::list_aggregate_discovered_resources::builders::ListAggregateDiscoveredResourcesInputBuilder,
...
impl ListAggregateDiscoveredResourcesFluentBuilder {
    ...
    pub fn filters(mut self, input: super::super::super::types::ResourceFilters) -> Self {
        self.inner = self.inner.filters(input);
        self
    }
    /// <p>Filters the results based on the <code>ResourceFilters</code> object.</p>
    pub fn set_filters(mut self, input: ::std::option::Option<super::super::super::types::ResourceFilters>) -> Self {
        self.inner = self.inner.set_filters(input);
        self
    }
    /// <p>Filters the results based on the <code>ResourceFilters</code> object.</p>
    pub fn get_filters(&self) -> &::std::option::Option<super::super::super::types::ResourceFilters> {
