...
pub struct ListAggregateDiscoveredResourcesPaginator {
    ...
    builder: super::super::super::operation::list_aggregate_discovered_resources::builders::ListAggregateDiscoveredResourcesInputBuilder,
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_aggregate_discovered_resources_output_output_next_token(resp);
...
impl ListAggregateDiscoveredResourcesPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::AggregateResourceIdentifier,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::list_aggregate_discovered_resources::ListAggregateDiscoveredResourcesError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_list_aggregate_discovered_resources_output_output_resource_identifiers(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
