...
pub use super::super::super::operation::describe_configuration_aggregators::_describe_configuration_aggregators_input::DescribeConfigurationAggregatorsInputBuilder;

pub use super::super::super::operation::describe_configuration_aggregators::_describe_configuration_aggregators_output::DescribeConfigurationAggregatorsOutputBuilder;

impl super::super::super::operation::describe_configuration_aggregators::builders::DescribeConfigurationAggregatorsInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::describe_configuration_aggregators::DescribeConfigurationAggregatorsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::describe_configuration_aggregators::DescribeConfigurationAggregatorsError,
...
pub struct DescribeConfigurationAggregatorsFluentBuilder {
    ...
    inner: super::super::super::operation::describe_configuration_aggregators::builders::DescribeConfigurationAggregatorsInputBuilder,
...
impl DescribeConfigurationAggregatorsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::describe_configuration_aggregators::builders::DescribeConfigurationAggregatorsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        super::super::super::operation::describe_configuration_aggregators::DescribeConfigurationAggregators::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::super::super::operation::describe_configuration_aggregators::paginator::DescribeConfigurationAggregatorsPaginator {
        super::super::super::operation::describe_configuration_aggregators::paginator::DescribeConfigurationAggregatorsPaginator::new(self.handle, self.inner)
    }
    ///
