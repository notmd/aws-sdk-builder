...
pub struct DescribeConfigurationAggregatorsOutput {
    ...
    pub configuration_aggregators: ::std::option::Option<::std::vec::Vec<super::super::super::types::ConfigurationAggregator>>,
...
impl DescribeConfigurationAggregatorsOutput {
    ...
    pub fn configuration_aggregators(&self) -> &[super::super::super::types::ConfigurationAggregator] {
...
impl DescribeConfigurationAggregatorsOutput {
    ...
    pub fn builder() -> super::super::super::operation::describe_configuration_aggregators::builders::DescribeConfigurationAggregatorsOutputBuilder {
        super::super::super::operation::describe_configuration_aggregators::builders::DescribeConfigurationAggregatorsOutputBuilder::default()
    }
}
...
pub struct DescribeConfigurationAggregatorsOutputBuilder {
    pub(crate) configuration_aggregators: ::std::option::Option<::std::vec::Vec<super::super::super::types::ConfigurationAggregator>>,
...
impl DescribeConfigurationAggregatorsOutputBuilder {
    ...
    ///
    /// <p>Returns a ConfigurationAggregators object.</p>
    pub fn configuration_aggregators(mut self, input: super::super::super::types::ConfigurationAggregator) -> Self {
    ...
    /// <p>Returns a ConfigurationAggregators object.</p>
    pub fn get_configuration_aggregators(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::ConfigurationAggregator>> {
    ...
    pub fn build(self) -> super::super::super::operation::describe_configuration_aggregators::DescribeConfigurationAggregatorsOutput {
