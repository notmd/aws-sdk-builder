...
pub struct DescribeConfigurationAggregatorsPaginator {
    ...
    builder: super::super::super::operation::describe_configuration_aggregators::builders::DescribeConfigurationAggregatorsInputBuilder,
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::super::super::operation::describe_configuration_aggregators::DescribeConfigurationAggregators::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_describe_configuration_aggregators_output_output_next_token(resp);
...
impl DescribeConfigurationAggregatorsPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::ConfigurationAggregator,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::describe_configuration_aggregators::DescribeConfigurationAggregatorsError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_describe_configuration_aggregators_output_output_configuration_aggregators(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
