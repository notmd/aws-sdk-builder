...
impl PutConnector {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::put_connector::PutConnectorInput,
    ) -> ::std::result::Result<
        super::super::operation::put_connector::PutConnectorOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::put_connector::PutConnectorError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::put_connector::PutConnectorError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::put_connector::PutConnectorOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutConnectorResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_put_connector::de_put_connector_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_put_connector::de_put_connector_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutConnectorRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::put_connector::PutConnectorInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::put_connector::PutConnectorInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_put_connector::ser_put_connector_input(&input)?);
...
pub enum PutConnectorError {
    ...
    MaxNumberOfConnectorsExceededException(super::super::types::error::MaxNumberOfConnectorsExceededException),
...
impl ::aws_types::request_id::RequestId for super::super::operation::put_connector::PutConnectorError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::put_connector::_put_connector_input::PutConnectorInput;

pub use super::super::operation::put_connector::_put_connector_output::PutConnectorOutput;
