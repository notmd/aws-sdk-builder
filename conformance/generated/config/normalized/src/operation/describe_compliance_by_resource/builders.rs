...
pub use super::super::super::operation::describe_compliance_by_resource::_describe_compliance_by_resource_input::DescribeComplianceByResourceInputBuilder;

pub use super::super::super::operation::describe_compliance_by_resource::_describe_compliance_by_resource_output::DescribeComplianceByResourceOutputBuilder;

impl super::super::super::operation::describe_compliance_by_resource::builders::DescribeComplianceByResourceInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::describe_compliance_by_resource::DescribeComplianceByResourceOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::describe_compliance_by_resource::DescribeComplianceByResourceError,
...
pub struct DescribeComplianceByResourceFluentBuilder {
    ...
    inner: super::super::super::operation::describe_compliance_by_resource::builders::DescribeComplianceByResourceInputBuilder,
...
impl DescribeComplianceByResourceFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::describe_compliance_by_resource::builders::DescribeComplianceByResourceInputBuilder {
        &self.inner
    }
    ...
    pub fn compliance_types(mut self, input: super::super::super::types::ComplianceType) -> Self {
        self.inner = self.inner.compliance_types(input);
        self
    }
    /// <p>Filters the results by compliance.</p>
    pub fn set_compliance_types(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::ComplianceType>>) -> Self {
        self.inner = self.inner.set_compliance_types(input);
        self
    }
    /// <p>Filters the results by compliance.</p>
    pub fn get_compliance_types(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::ComplianceType>> {
