...
pub struct PutEvaluationsInput {
    ...
    pub evaluations: ::std::option::Option<::std::vec::Vec<super::super::super::types::Evaluation>>,
...
impl PutEvaluationsInput {
    ...
    pub fn evaluations(&self) -> &[super::super::super::types::Evaluation] {
...
impl PutEvaluationsInput {
    ...
    pub fn builder() -> super::super::super::operation::put_evaluations::builders::PutEvaluationsInputBuilder {
        super::super::super::operation::put_evaluations::builders::PutEvaluationsInputBuilder::default()
    }
}
...
pub struct PutEvaluationsInputBuilder {
    pub(crate) evaluations: ::std::option::Option<::std::vec::Vec<super::super::super::types::Evaluation>>,
...
impl PutEvaluationsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::put_evaluations::PutEvaluationsInput, ::aws_smithy_types::error::operation::BuildError> {
