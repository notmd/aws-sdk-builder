...
impl GetOrganizationCustomRulePolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::get_organization_custom_rule_policy::builders::GetOrganizationCustomRulePolicyInputBuilder {
        super::super::super::operation::get_organization_custom_rule_policy::builders::GetOrganizationCustomRulePolicyInputBuilder::default()
    }
}
...
impl GetOrganizationCustomRulePolicyInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::get_organization_custom_rule_policy::GetOrganizationCustomRulePolicyInput,
