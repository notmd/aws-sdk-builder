...
impl GetOrganizationCustomRulePolicyOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_organization_custom_rule_policy::builders::GetOrganizationCustomRulePolicyOutputBuilder {
        super::super::super::operation::get_organization_custom_rule_policy::builders::GetOrganizationCustomRulePolicyOutputBuilder::default()
    }
}
...
impl GetOrganizationCustomRulePolicyOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::get_organization_custom_rule_policy::GetOrganizationCustomRulePolicyOutput {
