...
pub use super::super::super::operation::put_delivery_channel::_put_delivery_channel_input::PutDeliveryChannelInputBuilder;

pub use super::super::super::operation::put_delivery_channel::_put_delivery_channel_output::PutDeliveryChannelOutputBuilder;

impl super::super::super::operation::put_delivery_channel::builders::PutDeliveryChannelInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::put_delivery_channel::PutDeliveryChannelOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::put_delivery_channel::PutDeliveryChannelError,
...
pub struct PutDeliveryChannelFluentBuilder {
    ...
    inner: super::super::super::operation::put_delivery_channel::builders::PutDeliveryChannelInputBuilder,
...
impl PutDeliveryChannelFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::put_delivery_channel::builders::PutDeliveryChannelInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::put_delivery_channel::PutDeliveryChannel::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::put_delivery_channel::PutDeliveryChannel::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn delivery_channel(mut self, input: super::super::super::types::DeliveryChannel) -> Self {
        self.inner = self.inner.delivery_channel(input);
        self
    }
    /// <p>An object for the delivery channel. A delivery channel sends notifications and updated configuration states.</p>
    pub fn set_delivery_channel(mut self, input: ::std::option::Option<super::super::super::types::DeliveryChannel>) -> Self {
        self.inner = self.inner.set_delivery_channel(input);
        self
    }
    /// <p>An object for the delivery channel. A delivery channel sends notifications and updated configuration states.</p>
    pub fn get_delivery_channel(&self) -> &::std::option::Option<super::super::super::types::DeliveryChannel> {
