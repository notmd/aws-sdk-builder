...
pub struct PutDeliveryChannelInput {
    ...
    pub delivery_channel: ::std::option::Option<super::super::super::types::DeliveryChannel>,
}
impl PutDeliveryChannelInput {
    /// <p>An object for the delivery channel. A delivery channel sends notifications and updated configuration states.</p>
    pub fn delivery_channel(&self) -> ::std::option::Option<&super::super::super::types::DeliveryChannel> {
...
impl PutDeliveryChannelInput {
    ...
    pub fn builder() -> super::super::super::operation::put_delivery_channel::builders::PutDeliveryChannelInputBuilder {
        super::super::super::operation::put_delivery_channel::builders::PutDeliveryChannelInputBuilder::default()
    }
}
...
pub struct PutDeliveryChannelInputBuilder {
    pub(crate) delivery_channel: ::std::option::Option<super::super::super::types::DeliveryChannel>,
}
