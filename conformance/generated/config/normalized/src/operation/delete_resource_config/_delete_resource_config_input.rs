...
impl DeleteResourceConfigInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_resource_config::builders::DeleteResourceConfigInputBuilder {
        super::super::super::operation::delete_resource_config::builders::DeleteResourceConfigInputBuilder::default()
    }
}
...
impl DeleteResourceConfigInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::delete_resource_config::DeleteResourceConfigInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::delete_resource_config::DeleteResourceConfigInput {
