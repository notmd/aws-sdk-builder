...
pub use super::super::super::operation::put_service_linked_configuration_recorder::_put_service_linked_configuration_recorder_input::PutServiceLinkedConfigurationRecorderInputBuilder;

pub use super::super::super::operation::put_service_linked_configuration_recorder::_put_service_linked_configuration_recorder_output::PutServiceLinkedConfigurationRecorderOutputBuilder;

impl super::super::super::operation::put_service_linked_configuration_recorder::builders::PutServiceLinkedConfigurationRecorderInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::put_service_linked_configuration_recorder::PutServiceLinkedConfigurationRecorderOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::put_service_linked_configuration_recorder::PutServiceLinkedConfigurationRecorderError,
...
/// <p>For more information and a list of supported services/service principals, see <a href="https://docs.aws.amazon.com/config/latest/developerguide/stop-start-recorder.html"> <b>Working with the Configuration Recorder</b> </a> in the <i>Config Developer Guide</i>.</p>
...
pub struct PutServiceLinkedConfigurationRecorderFluentBuilder {
    ...
    inner: super::super::super::operation::put_service_linked_configuration_recorder::builders::PutServiceLinkedConfigurationRecorderInputBuilder,
...
impl PutServiceLinkedConfigurationRecorderFluentBuilder {
    ...
    > {
        ...
        let runtime_plugins =
            super::super::super::operation::put_service_linked_configuration_recorder::PutServiceLinkedConfigurationRecorder::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        super::super::super::operation::put_service_linked_configuration_recorder::PutServiceLinkedConfigurationRecorder::orchestrate(&runtime_plugins, input).await
    }
