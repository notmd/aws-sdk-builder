...
impl DescribeOrganizationConformancePackStatuses {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::describe_organization_conformance_pack_statuses::DescribeOrganizationConformancePackStatusesInput,
    ) -> ::std::result::Result<
        super::super::operation::describe_organization_conformance_pack_statuses::DescribeOrganizationConformancePackStatusesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::describe_organization_conformance_pack_statuses::DescribeOrganizationConformancePackStatusesError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                err.downcast::<super::super::operation::describe_organization_conformance_pack_statuses::DescribeOrganizationConformancePackStatusesError>().expect("correct error type")
                            })
        };
        ...
        ::std::result::Result::Ok(output.downcast::<super::super::operation::describe_organization_conformance_pack_statuses::DescribeOrganizationConformancePackStatusesOutput>().expect("correct output type"))
    }
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeOrganizationConformancePackStatusesTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DescribeOrganizationConformancePackStatusesInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeOrganizationConformancePackStatusesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_describe_organization_conformance_pack_statuses::de_describe_organization_conformance_pack_statuses_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_describe_organization_conformance_pack_statuses::de_describe_organization_conformance_pack_statuses_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeOrganizationConformancePackStatusesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::describe_organization_conformance_pack_statuses::DescribeOrganizationConformancePackStatusesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::describe_organization_conformance_pack_statuses::DescribeOrganizationConformancePackStatusesInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_describe_organization_conformance_pack_statuses::ser_describe_organization_conformance_pack_statuses_input(&input)?);
...
pub enum DescribeOrganizationConformancePackStatusesError {
    ...
    NoSuchOrganizationConformancePackException(super::super::types::error::NoSuchOrganizationConformancePackException),
    ...
    OrganizationAccessDeniedException(super::super::types::error::OrganizationAccessDeniedException),
...
impl DescribeOrganizationConformancePackStatusesError {
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::NoSuchOrganizationConformancePackException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeOrganizationConformancePackStatusesError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::NoSuchOrganizationConformancePackException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::OrganizationAccessDeniedException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::Unhandled(_inner) => &_inner.meta,
        }
    }
}
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeOrganizationConformancePackStatusesError {
...
impl ::aws_types::request_id::RequestId
    for super::super::operation::describe_organization_conformance_pack_statuses::DescribeOrganizationConformancePackStatusesError
{
...
pub use super::super::operation::describe_organization_conformance_pack_statuses::_describe_organization_conformance_pack_statuses_input::DescribeOrganizationConformancePackStatusesInput;

pub use super::super::operation::describe_organization_conformance_pack_statuses::_describe_organization_conformance_pack_statuses_output::DescribeOrganizationConformancePackStatusesOutput;
