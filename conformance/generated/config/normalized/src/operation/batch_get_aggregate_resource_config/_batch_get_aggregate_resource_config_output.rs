...
pub struct BatchGetAggregateResourceConfigOutput {
    ...
    pub unprocessed_resource_identifiers: ::std::option::Option<::std::vec::Vec<super::super::super::types::AggregateResourceIdentifier>>,
...
impl BatchGetAggregateResourceConfigOutput {
    ...
    pub fn unprocessed_resource_identifiers(&self) -> &[super::super::super::types::AggregateResourceIdentifier] {
...
impl BatchGetAggregateResourceConfigOutput {
    ...
    pub fn builder() -> super::super::super::operation::batch_get_aggregate_resource_config::builders::BatchGetAggregateResourceConfigOutputBuilder {
        super::super::super::operation::batch_get_aggregate_resource_config::builders::BatchGetAggregateResourceConfigOutputBuilder::default()
    }
}
...
pub struct BatchGetAggregateResourceConfigOutputBuilder {
    ...
    pub(crate) unprocessed_resource_identifiers: ::std::option::Option<::std::vec::Vec<super::super::super::types::AggregateResourceIdentifier>>,
    _request_id: Option<String>,
}
impl BatchGetAggregateResourceConfigOutputBuilder {
    ...
    ///
    /// <p>A list of resource identifiers that were not processed with current scope. The list is empty if all the resources are processed.</p>
    pub fn unprocessed_resource_identifiers(mut self, input: super::super::super::types::AggregateResourceIdentifier) -> Self {
    ...
    pub fn build(self) -> super::super::super::operation::batch_get_aggregate_resource_config::BatchGetAggregateResourceConfigOutput {
