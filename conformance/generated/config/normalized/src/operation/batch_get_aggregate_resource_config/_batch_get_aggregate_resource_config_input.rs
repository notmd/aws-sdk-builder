...
impl BatchGetAggregateResourceConfigInput {
    ...
    pub fn builder() -> super::super::super::operation::batch_get_aggregate_resource_config::builders::BatchGetAggregateResourceConfigInputBuilder {
        super::super::super::operation::batch_get_aggregate_resource_config::builders::BatchGetAggregateResourceConfigInputBuilder::default()
    }
}
...
impl BatchGetAggregateResourceConfigInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::batch_get_aggregate_resource_config::BatchGetAggregateResourceConfigInput,
