...
pub use super::super::super::operation::select_aggregate_resource_config::_select_aggregate_resource_config_input::SelectAggregateResourceConfigInputBuilder;

pub use super::super::super::operation::select_aggregate_resource_config::_select_aggregate_resource_config_output::SelectAggregateResourceConfigOutputBuilder;

impl super::super::super::operation::select_aggregate_resource_config::builders::SelectAggregateResourceConfigInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::select_aggregate_resource_config::SelectAggregateResourceConfigOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::select_aggregate_resource_config::SelectAggregateResourceConfigError,
...
pub struct SelectAggregateResourceConfigFluentBuilder {
    ...
    inner: super::super::super::operation::select_aggregate_resource_config::builders::SelectAggregateResourceConfigInputBuilder,
...
impl SelectAggregateResourceConfigFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::select_aggregate_resource_config::builders::SelectAggregateResourceConfigInputBuilder {
        &self.inner
    }
