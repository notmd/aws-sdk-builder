...
impl SelectAggregateResourceConfigInput {
    ...
    pub fn builder() -> super::super::super::operation::select_aggregate_resource_config::builders::SelectAggregateResourceConfigInputBuilder {
        super::super::super::operation::select_aggregate_resource_config::builders::SelectAggregateResourceConfigInputBuilder::default()
    }
}
