...
impl DescribeConfigurationRecordersInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_configuration_recorders::builders::DescribeConfigurationRecordersInputBuilder {
        super::super::super::operation::describe_configuration_recorders::builders::DescribeConfigurationRecordersInputBuilder::default()
    }
}
