...
pub struct DescribeConfigurationRecordersOutput {
    ...
    pub configuration_recorders: ::std::option::Option<::std::vec::Vec<super::super::super::types::ConfigurationRecorder>>,
...
impl DescribeConfigurationRecordersOutput {
    ...
    pub fn configuration_recorders(&self) -> &[super::super::super::types::ConfigurationRecorder] {
...
impl DescribeConfigurationRecordersOutput {
    ...
    pub fn builder() -> super::super::super::operation::describe_configuration_recorders::builders::DescribeConfigurationRecordersOutputBuilder {
        super::super::super::operation::describe_configuration_recorders::builders::DescribeConfigurationRecordersOutputBuilder::default()
    }
}
...
pub struct DescribeConfigurationRecordersOutputBuilder {
    pub(crate) configuration_recorders: ::std::option::Option<::std::vec::Vec<super::super::super::types::ConfigurationRecorder>>,
    _request_id: Option<String>,
}
impl DescribeConfigurationRecordersOutputBuilder {
    ...
    ///
    /// <p>A list that contains the descriptions of the specified configuration recorders.</p>
    pub fn configuration_recorders(mut self, input: super::super::super::types::ConfigurationRecorder) -> Self {
    ...
    /// <p>A list that contains the descriptions of the specified configuration recorders.</p>
    pub fn get_configuration_recorders(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::ConfigurationRecorder>> {
    ...
    pub fn build(self) -> super::super::super::operation::describe_configuration_recorders::DescribeConfigurationRecordersOutput {
        super::super::super::operation::describe_configuration_recorders::DescribeConfigurationRecordersOutput {
