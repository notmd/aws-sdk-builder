...
pub struct DescribePendingAggregationRequestsOutput {
    ...
    pub pending_aggregation_requests: ::std::option::Option<::std::vec::Vec<super::super::super::types::PendingAggregationRequest>>,
...
impl DescribePendingAggregationRequestsOutput {
    ...
    pub fn pending_aggregation_requests(&self) -> &[super::super::super::types::PendingAggregationRequest] {
...
pub struct DescribePendingAggregationRequestsOutputBuilder {
    pub(crate) pending_aggregation_requests: ::std::option::Option<::std::vec::Vec<super::super::super::types::PendingAggregationRequest>>,
...
impl DescribePendingAggregationRequestsOutputBuilder {
    ...
    ///
    /// <p>Returns a PendingAggregationRequests object.</p>
    pub fn pending_aggregation_requests(mut self, input: super::super::super::types::PendingAggregationRequest) -> Self {
    ...
    pub fn set_pending_aggregation_requests(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::PendingAggregationRequest>>,
    ) -> Self {
        self.pending_aggregation_requests = input;
        self
    }
    /// <p>Returns a PendingAggregationRequests object.</p>
    pub fn get_pending_aggregation_requests(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::PendingAggregationRequest>> {
    ...
    pub fn build(self) -> super::super::super::operation::describe_pending_aggregation_requests::DescribePendingAggregationRequestsOutput {
