...
impl StopConfigurationRecorderOutput {
    ...
    pub fn builder() -> super::super::super::operation::stop_configuration_recorder::builders::StopConfigurationRecorderOutputBuilder {
        super::super::super::operation::stop_configuration_recorder::builders::StopConfigurationRecorderOutputBuilder::default()
    }
}
...
impl StopConfigurationRecorderOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::stop_configuration_recorder::StopConfigurationRecorderOutput {
