...
pub use super::super::super::operation::stop_configuration_recorder::_stop_configuration_recorder_input::StopConfigurationRecorderInputBuilder;

pub use super::super::super::operation::stop_configuration_recorder::_stop_configuration_recorder_output::StopConfigurationRecorderOutputBuilder;

impl super::super::super::operation::stop_configuration_recorder::builders::StopConfigurationRecorderInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::stop_configuration_recorder::StopConfigurationRecorderOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::stop_configuration_recorder::StopConfigurationRecorderError,
...
pub struct StopConfigurationRecorderFluentBuilder {
    ...
    inner: super::super::super::operation::stop_configuration_recorder::builders::StopConfigurationRecorderInputBuilder,
...
impl StopConfigurationRecorderFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::stop_configuration_recorder::builders::StopConfigurationRecorderInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::stop_configuration_recorder::StopConfigurationRecorder::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::stop_configuration_recorder::StopConfigurationRecorder::orchestrate(&runtime_plugins, input).await
    }
