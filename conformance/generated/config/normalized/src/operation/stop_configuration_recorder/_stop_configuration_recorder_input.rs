...
impl StopConfigurationRecorderInput {
    ...
    pub fn builder() -> super::super::super::operation::stop_configuration_recorder::builders::StopConfigurationRecorderInputBuilder {
        super::super::super::operation::stop_configuration_recorder::builders::StopConfigurationRecorderInputBuilder::default()
    }
}
