...
pub struct DescribeOrganizationConfigRulesPaginator {
    ...
    builder: super::super::super::operation::describe_organization_config_rules::builders::DescribeOrganizationConfigRulesInputBuilder,
...
impl DescribeOrganizationConfigRulesPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::describe_organization_config_rules::paginator::DescribeOrganizationConfigRulesPaginatorItems {
        super::super::super::operation::describe_organization_config_rules::paginator::DescribeOrganizationConfigRulesPaginatorItems(self)
    }
    ...
    pub fn send(
        ...
        ::std::result::Result<
            ...
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::describe_organization_config_rules::DescribeOrganizationConfigRulesError,
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::super::super::operation::describe_organization_config_rules::DescribeOrganizationConfigRules::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_describe_organization_config_rules_output_output_next_token(resp);
...
impl DescribeOrganizationConfigRulesPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::OrganizationConfigRule,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::describe_organization_config_rules::DescribeOrganizationConfigRulesError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_describe_organization_config_rules_output_output_organization_config_rules(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
