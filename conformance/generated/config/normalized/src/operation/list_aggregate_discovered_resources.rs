...
impl ListAggregateDiscoveredResources {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::list_aggregate_discovered_resources::ListAggregateDiscoveredResourcesInput,
    ) -> ::std::result::Result<
        super::super::operation::list_aggregate_discovered_resources::ListAggregateDiscoveredResourcesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::list_aggregate_discovered_resources::ListAggregateDiscoveredResourcesError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::list_aggregate_discovered_resources::ListAggregateDiscoveredResourcesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::list_aggregate_discovered_resources::ListAggregateDiscoveredResourcesOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAggregateDiscoveredResources {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListAggregateDiscoveredResources")
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListAggregateDiscoveredResourcesTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListAggregateDiscoveredResourcesInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAggregateDiscoveredResourcesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_list_aggregate_discovered_resources::de_list_aggregate_discovered_resources_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_list_aggregate_discovered_resources::de_list_aggregate_discovered_resources_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAggregateDiscoveredResourcesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::list_aggregate_discovered_resources::ListAggregateDiscoveredResourcesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::list_aggregate_discovered_resources::ListAggregateDiscoveredResourcesInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_list_aggregate_discovered_resources::ser_list_aggregate_discovered_resources_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::super::operation::list_aggregate_discovered_resources::ListAggregateDiscoveredResourcesError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::list_aggregate_discovered_resources::_list_aggregate_discovered_resources_input::ListAggregateDiscoveredResourcesInput;

pub use super::super::operation::list_aggregate_discovered_resources::_list_aggregate_discovered_resources_output::ListAggregateDiscoveredResourcesOutput;
