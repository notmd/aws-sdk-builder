...
pub use super::super::super::operation::delete_aggregation_authorization::_delete_aggregation_authorization_input::DeleteAggregationAuthorizationInputBuilder;

pub use super::super::super::operation::delete_aggregation_authorization::_delete_aggregation_authorization_output::DeleteAggregationAuthorizationOutputBuilder;

impl super::super::super::operation::delete_aggregation_authorization::builders::DeleteAggregationAuthorizationInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_aggregation_authorization::DeleteAggregationAuthorizationOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_aggregation_authorization::DeleteAggregationAuthorizationError,
...
pub struct DeleteAggregationAuthorizationFluentBuilder {
    ...
    inner: super::super::super::operation::delete_aggregation_authorization::builders::DeleteAggregationAuthorizationInputBuilder,
