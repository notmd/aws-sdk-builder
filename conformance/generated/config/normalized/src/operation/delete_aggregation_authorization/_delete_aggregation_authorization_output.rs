...
impl DeleteAggregationAuthorizationOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_aggregation_authorization::builders::DeleteAggregationAuthorizationOutputBuilder {
        super::super::super::operation::delete_aggregation_authorization::builders::DeleteAggregationAuthorizationOutputBuilder::default()
    }
}
...
impl DeleteAggregationAuthorizationOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_aggregation_authorization::DeleteAggregationAuthorizationOutput {
