...
impl DeleteAggregationAuthorizationInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_aggregation_authorization::builders::DeleteAggregationAuthorizationInputBuilder {
        super::super::super::operation::delete_aggregation_authorization::builders::DeleteAggregationAuthorizationInputBuilder::default()
    }
}
