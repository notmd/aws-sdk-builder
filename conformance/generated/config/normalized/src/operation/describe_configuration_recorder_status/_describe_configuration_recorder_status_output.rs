...
pub struct DescribeConfigurationRecorderStatusOutput {
    ...
    pub configuration_recorders_status: ::std::option::Option<::std::vec::Vec<super::super::super::types::ConfigurationRecorderStatus>>,
...
impl DescribeConfigurationRecorderStatusOutput {
    ...
    pub fn configuration_recorders_status(&self) -> &[super::super::super::types::ConfigurationRecorderStatus] {
...
pub struct DescribeConfigurationRecorderStatusOutputBuilder {
    pub(crate) configuration_recorders_status: ::std::option::Option<::std::vec::Vec<super::super::super::types::ConfigurationRecorderStatus>>,
    _request_id: Option<String>,
}
impl DescribeConfigurationRecorderStatusOutputBuilder {
    ...
    ///
    /// <p>A list that contains status of the specified recorders.</p>
    pub fn configuration_recorders_status(mut self, input: super::super::super::types::ConfigurationRecorderStatus) -> Self {
    ...
    pub fn set_configuration_recorders_status(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::ConfigurationRecorderStatus>>,
    ) -> Self {
    ...
    pub fn build(self) -> super::super::super::operation::describe_configuration_recorder_status::DescribeConfigurationRecorderStatusOutput {
