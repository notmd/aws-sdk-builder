...
pub struct DescribeComplianceByConfigRuleOutput {
    ...
    pub compliance_by_config_rules: ::std::option::Option<::std::vec::Vec<super::super::super::types::ComplianceByConfigRule>>,
...
impl DescribeComplianceByConfigRuleOutput {
    ...
    pub fn compliance_by_config_rules(&self) -> &[super::super::super::types::ComplianceByConfigRule] {
...
impl DescribeComplianceByConfigRuleOutput {
    ...
    pub fn builder() -> super::super::super::operation::describe_compliance_by_config_rule::builders::DescribeComplianceByConfigRuleOutputBuilder {
        super::super::super::operation::describe_compliance_by_config_rule::builders::DescribeComplianceByConfigRuleOutputBuilder::default()
    }
}
...
pub struct DescribeComplianceByConfigRuleOutputBuilder {
    pub(crate) compliance_by_config_rules: ::std::option::Option<::std::vec::Vec<super::super::super::types::ComplianceByConfigRule>>,
...
impl DescribeComplianceByConfigRuleOutputBuilder {
    ...
    ///
    /// <p>Indicates whether each of the specified Config rules is compliant.</p>
    pub fn compliance_by_config_rules(mut self, input: super::super::super::types::ComplianceByConfigRule) -> Self {
    ...
    /// <p>Indicates whether each of the specified Config rules is compliant.</p>
    pub fn get_compliance_by_config_rules(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::ComplianceByConfigRule>> {
    ...
    pub fn build(self) -> super::super::super::operation::describe_compliance_by_config_rule::DescribeComplianceByConfigRuleOutput {
