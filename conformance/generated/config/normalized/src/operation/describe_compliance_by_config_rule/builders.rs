...
pub use super::super::super::operation::describe_compliance_by_config_rule::_describe_compliance_by_config_rule_input::DescribeComplianceByConfigRuleInputBuilder;

pub use super::super::super::operation::describe_compliance_by_config_rule::_describe_compliance_by_config_rule_output::DescribeComplianceByConfigRuleOutputBuilder;

impl super::super::super::operation::describe_compliance_by_config_rule::builders::DescribeComplianceByConfigRuleInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::describe_compliance_by_config_rule::DescribeComplianceByConfigRuleOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::describe_compliance_by_config_rule::DescribeComplianceByConfigRuleError,
...
pub struct DescribeComplianceByConfigRuleFluentBuilder {
    ...
    inner: super::super::super::operation::describe_compliance_by_config_rule::builders::DescribeComplianceByConfigRuleInputBuilder,
