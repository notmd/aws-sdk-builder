...
impl PutStoredQueryOutput {
    ...
    pub fn builder() -> super::super::super::operation::put_stored_query::builders::PutStoredQueryOutputBuilder {
        super::super::super::operation::put_stored_query::builders::PutStoredQueryOutputBuilder::default()
    }
}
...
impl PutStoredQueryOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::put_stored_query::PutStoredQueryOutput {
