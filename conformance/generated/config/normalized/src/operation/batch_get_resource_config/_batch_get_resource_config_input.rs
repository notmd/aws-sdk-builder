...
pub struct BatchGetResourceConfigInput {
    ...
    pub resource_keys: ::std::option::Option<::std::vec::Vec<super::super::super::types::ResourceKey>>,
}
impl BatchGetResourceConfigInput {
    ...
    pub fn resource_keys(&self) -> &[super::super::super::types::ResourceKey] {
...
impl BatchGetResourceConfigInput {
    ...
    pub fn builder() -> super::super::super::operation::batch_get_resource_config::builders::BatchGetResourceConfigInputBuilder {
        super::super::super::operation::batch_get_resource_config::builders::BatchGetResourceConfigInputBuilder::default()
    }
}
...
pub struct BatchGetResourceConfigInputBuilder {
    pub(crate) resource_keys: ::std::option::Option<::std::vec::Vec<super::super::super::types::ResourceKey>>,
}
impl BatchGetResourceConfigInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::batch_get_resource_config::BatchGetResourceConfigInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::batch_get_resource_config::BatchGetResourceConfigInput {
