...
pub struct BatchGetResourceConfigOutput {
    ...
    pub base_configuration_items: ::std::option::Option<::std::vec::Vec<super::super::super::types::BaseConfigurationItem>>,
    ...
    pub unprocessed_resource_keys: ::std::option::Option<::std::vec::Vec<super::super::super::types::ResourceKey>>,
...
impl BatchGetResourceConfigOutput {
    ...
    pub fn base_configuration_items(&self) -> &[super::super::super::types::BaseConfigurationItem] {
    ...
    pub fn unprocessed_resource_keys(&self) -> &[super::super::super::types::ResourceKey] {
...
impl BatchGetResourceConfigOutput {
    ...
    pub fn builder() -> super::super::super::operation::batch_get_resource_config::builders::BatchGetResourceConfigOutputBuilder {
        super::super::super::operation::batch_get_resource_config::builders::BatchGetResourceConfigOutputBuilder::default()
    }
}
...
pub struct BatchGetResourceConfigOutputBuilder {
    pub(crate) base_configuration_items: ::std::option::Option<::std::vec::Vec<super::super::super::types::BaseConfigurationItem>>,
    pub(crate) unprocessed_resource_keys: ::std::option::Option<::std::vec::Vec<super::super::super::types::ResourceKey>>,
    _request_id: Option<String>,
}
impl BatchGetResourceConfigOutputBuilder {
    ...
    ///
    /// <p>A list that contains the current configuration of one or more resources.</p>
    pub fn base_configuration_items(mut self, input: super::super::super::types::BaseConfigurationItem) -> Self {
    ...
    /// <p>A list that contains the current configuration of one or more resources.</p>
    pub fn get_base_configuration_items(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::BaseConfigurationItem>> {
    ...
    ///
    /// <p>A list of resource keys that were not processed with the current response. The unprocessesResourceKeys value is in the same form as ResourceKeys, so the value can be directly provided to a subsequent BatchGetResourceConfig operation. If there are no unprocessed resource keys, the response contains an empty unprocessedResourceKeys list.</p>
    pub fn unprocessed_resource_keys(mut self, input: super::super::super::types::ResourceKey) -> Self {
    ...
    /// <p>A list of resource keys that were not processed with the current response. The unprocessesResourceKeys value is in the same form as ResourceKeys, so the value can be directly provided to a subsequent BatchGetResourceConfig operation. If there are no unprocessed resource keys, the response contains an empty unprocessedResourceKeys list.</p>
    pub fn set_unprocessed_resource_keys(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::ResourceKey>>) -> Self {
        self.unprocessed_resource_keys = input;
        self
    }
    /// <p>A list of resource keys that were not processed with the current response. The unprocessesResourceKeys value is in the same form as ResourceKeys, so the value can be directly provided to a subsequent BatchGetResourceConfig operation. If there are no unprocessed resource keys, the response contains an empty unprocessedResourceKeys list.</p>
    pub fn get_unprocessed_resource_keys(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::ResourceKey>> {
    ...
    pub fn build(self) -> super::super::super::operation::batch_get_resource_config::BatchGetResourceConfigOutput {
        super::super::super::operation::batch_get_resource_config::BatchGetResourceConfigOutput {
