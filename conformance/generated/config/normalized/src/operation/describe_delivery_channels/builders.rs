...
pub use super::super::super::operation::describe_delivery_channels::_describe_delivery_channels_input::DescribeDeliveryChannelsInputBuilder;

pub use super::super::super::operation::describe_delivery_channels::_describe_delivery_channels_output::DescribeDeliveryChannelsOutputBuilder;

impl super::super::super::operation::describe_delivery_channels::builders::DescribeDeliveryChannelsInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::describe_delivery_channels::DescribeDeliveryChannelsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::describe_delivery_channels::DescribeDeliveryChannelsError,
...
pub struct DescribeDeliveryChannelsFluentBuilder {
    ...
    inner: super::super::super::operation::describe_delivery_channels::builders::DescribeDeliveryChannelsInputBuilder,
...
impl DescribeDeliveryChannelsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::describe_delivery_channels::builders::DescribeDeliveryChannelsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::describe_delivery_channels::DescribeDeliveryChannels::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::describe_delivery_channels::DescribeDeliveryChannels::orchestrate(&runtime_plugins, input).await
    }
