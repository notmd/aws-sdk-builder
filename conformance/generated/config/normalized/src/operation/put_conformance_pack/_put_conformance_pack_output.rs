...
impl PutConformancePackOutput {
    ...
    pub fn builder() -> super::super::super::operation::put_conformance_pack::builders::PutConformancePackOutputBuilder {
        super::super::super::operation::put_conformance_pack::builders::PutConformancePackOutputBuilder::default()
    }
}
...
impl PutConformancePackOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::put_conformance_pack::PutConformancePackOutput {
