...
pub struct PutConformancePackInput {
    ...
    pub conformance_pack_input_parameters: ::std::option::Option<::std::vec::Vec<super::super::super::types::ConformancePackInputParameter>>,
    ...
    pub template_ssm_document_details: ::std::option::Option<super::super::super::types::TemplateSsmDocumentDetails>,
...
impl PutConformancePackInput {
    ...
    pub fn conformance_pack_input_parameters(&self) -> &[super::super::super::types::ConformancePackInputParameter] {
        self.conformance_pack_input_parameters.as_deref().unwrap_or_default()
    }
    /// <p>An object of type <code>TemplateSSMDocumentDetails</code>, which contains the name or the Amazon Resource Name (ARN) of the Amazon Web Services Systems Manager document (SSM document) and the version of the SSM document that is used to create a conformance pack.</p>
    pub fn template_ssm_document_details(&self) -> ::std::option::Option<&super::super::super::types::TemplateSsmDocumentDetails> {
...
impl PutConformancePackInput {
    ...
    pub fn builder() -> super::super::super::operation::put_conformance_pack::builders::PutConformancePackInputBuilder {
        super::super::super::operation::put_conformance_pack::builders::PutConformancePackInputBuilder::default()
    }
}
...
pub struct PutConformancePackInputBuilder {
    ...
    pub(crate) conformance_pack_input_parameters: ::std::option::Option<::std::vec::Vec<super::super::super::types::ConformancePackInputParameter>>,
    pub(crate) template_ssm_document_details: ::std::option::Option<super::super::super::types::TemplateSsmDocumentDetails>,
