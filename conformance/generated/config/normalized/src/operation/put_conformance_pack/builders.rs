...
pub use super::super::super::operation::put_conformance_pack::_put_conformance_pack_input::PutConformancePackInputBuilder;

pub use super::super::super::operation::put_conformance_pack::_put_conformance_pack_output::PutConformancePackOutputBuilder;

impl super::super::super::operation::put_conformance_pack::builders::PutConformancePackInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::put_conformance_pack::PutConformancePackOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::put_conformance_pack::PutConformancePackError,
...
pub struct PutConformancePackFluentBuilder {
    ...
    inner: super::super::super::operation::put_conformance_pack::builders::PutConformancePackInputBuilder,
...
impl PutConformancePackFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::put_conformance_pack::builders::PutConformancePackInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::put_conformance_pack::PutConformancePack::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::put_conformance_pack::PutConformancePack::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn conformance_pack_input_parameters(mut self, input: super::super::super::types::ConformancePackInputParameter) -> Self {
    ...
    pub fn set_conformance_pack_input_parameters(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::ConformancePackInputParameter>>,
    ) -> Self {
    ...
    pub fn template_ssm_document_details(mut self, input: super::super::super::types::TemplateSsmDocumentDetails) -> Self {
        self.inner = self.inner.template_ssm_document_details(input);
        self
    }
    /// <p>An object of type <code>TemplateSSMDocumentDetails</code>, which contains the name or the Amazon Resource Name (ARN) of the Amazon Web Services Systems Manager document (SSM document) and the version of the SSM document that is used to create a conformance pack.</p>
    pub fn set_template_ssm_document_details(mut self, input: ::std::option::Option<super::super::super::types::TemplateSsmDocumentDetails>) -> Self {
        self.inner = self.inner.set_template_ssm_document_details(input);
        self
    }
    /// <p>An object of type <code>TemplateSSMDocumentDetails</code>, which contains the name or the Amazon Resource Name (ARN) of the Amazon Web Services Systems Manager document (SSM document) and the version of the SSM document that is used to create a conformance pack.</p>
    pub fn get_template_ssm_document_details(&self) -> &::std::option::Option<super::super::super::types::TemplateSsmDocumentDetails> {
