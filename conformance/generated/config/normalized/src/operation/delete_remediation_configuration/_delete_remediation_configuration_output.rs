...
impl DeleteRemediationConfigurationOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_remediation_configuration::builders::DeleteRemediationConfigurationOutputBuilder {
        super::super::super::operation::delete_remediation_configuration::builders::DeleteRemediationConfigurationOutputBuilder::default()
    }
}
...
impl DeleteRemediationConfigurationOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_remediation_configuration::DeleteRemediationConfigurationOutput {
