...
impl DeleteRemediationConfigurationInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_remediation_configuration::builders::DeleteRemediationConfigurationInputBuilder {
        super::super::super::operation::delete_remediation_configuration::builders::DeleteRemediationConfigurationInputBuilder::default()
    }
}
