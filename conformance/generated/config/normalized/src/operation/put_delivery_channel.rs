    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::put_delivery_channel::PutDeliveryChannelError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::put_delivery_channel::PutDeliveryChannelOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutDeliveryChannelResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_put_delivery_channel::de_put_delivery_channel_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_put_delivery_channel::de_put_delivery_channel_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutDeliveryChannelRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::put_delivery_channel::PutDeliveryChannelInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::put_delivery_channel::PutDeliveryChannelInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_put_delivery_channel::ser_put_delivery_channel_input(
            &input,
        )?);
...
pub enum PutDeliveryChannelError {
    ...
    InsufficientDeliveryPolicyException(super::super::types::error::InsufficientDeliveryPolicyException),
    /// <p>The specified delivery channel name is not valid.</p>
    InvalidDeliveryChannelNameException(super::super::types::error::InvalidDeliveryChannelNameException),
    /// <p>The specified Amazon S3 key prefix is not valid.</p>
    InvalidS3KeyPrefixException(super::super::types::error::InvalidS3KeyPrefixException),
    /// <p>The specified Amazon KMS Key ARN is not valid.</p>
    InvalidS3KmsKeyArnException(super::super::types::error::InvalidS3KmsKeyArnException),
    /// <p>The specified Amazon SNS topic does not exist.</p>
    InvalidSnsTopicArnException(super::super::types::error::InvalidSnsTopicArnException),
    /// <p>You have reached the limit of the number of delivery channels you can create.</p>
    MaxNumberOfDeliveryChannelsExceededException(super::super::types::error::MaxNumberOfDeliveryChannelsExceededException),
    ...
    NoSuchBucketException(super::super::types::error::NoSuchBucketException),
...
impl ::aws_types::request_id::RequestId for super::super::operation::put_delivery_channel::PutDeliveryChannelError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::put_delivery_channel::_put_delivery_channel_input::PutDeliveryChannelInput;

pub use super::super::operation::put_delivery_channel::_put_delivery_channel_output::PutDeliveryChannelOutput;
