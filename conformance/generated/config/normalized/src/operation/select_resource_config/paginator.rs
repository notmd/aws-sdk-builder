...
/// Paginator for [`SelectResourceConfig`](crate::operation::select_resource_config::SelectResourceConfig)
pub struct SelectResourceConfigPaginator {
    handle: std::sync::Arc<super::super::super::client::Handle>,
    builder: super::super::super::operation::select_resource_config::builders::SelectResourceConfigInputBuilder,
...
impl SelectResourceConfigPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::select_resource_config::paginator::SelectResourceConfigPaginatorItems {
        super::super::super::operation::select_resource_config::paginator::SelectResourceConfigPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::super::super::operation::select_resource_config::SelectResourceConfig::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_select_resource_config_output_output_next_token(resp);
...
impl SelectResourceConfigPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_select_resource_config_output_output_results(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
