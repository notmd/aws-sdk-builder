...
impl SelectResourceConfigOutput {
    ...
    pub fn builder() -> super::super::super::operation::select_resource_config::builders::SelectResourceConfigOutputBuilder {
        super::super::super::operation::select_resource_config::builders::SelectResourceConfigOutputBuilder::default()
    }
}
...
impl SelectResourceConfigOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::select_resource_config::SelectResourceConfigOutput {
