...
impl SelectResourceConfigInput {
    ...
    pub fn builder() -> super::super::super::operation::select_resource_config::builders::SelectResourceConfigInputBuilder {
        super::super::super::operation::select_resource_config::builders::SelectResourceConfigInputBuilder::default()
    }
}
