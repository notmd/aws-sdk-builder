...
impl StartRemediationExecution {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::start_remediation_execution::StartRemediationExecutionInput,
    ) -> ::std::result::Result<
        super::super::operation::start_remediation_execution::StartRemediationExecutionOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::start_remediation_execution::StartRemediationExecutionError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::start_remediation_execution::StartRemediationExecutionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::start_remediation_execution::StartRemediationExecutionOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartRemediationExecutionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_start_remediation_execution::de_start_remediation_execution_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_start_remediation_execution::de_start_remediation_execution_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartRemediationExecutionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::start_remediation_execution::StartRemediationExecutionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::start_remediation_execution::StartRemediationExecutionInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_start_remediation_execution::ser_start_remediation_execution_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::super::operation::start_remediation_execution::StartRemediationExecutionError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::start_remediation_execution::_start_remediation_execution_input::StartRemediationExecutionInput;

pub use super::super::operation::start_remediation_execution::_start_remediation_execution_output::StartRemediationExecutionOutput;
