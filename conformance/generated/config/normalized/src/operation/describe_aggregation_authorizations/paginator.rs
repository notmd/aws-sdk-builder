...
pub struct DescribeAggregationAuthorizationsPaginator {
    ...
    builder: super::super::super::operation::describe_aggregation_authorizations::builders::DescribeAggregationAuthorizationsInputBuilder,
...
impl DescribeAggregationAuthorizationsPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::describe_aggregation_authorizations::paginator::DescribeAggregationAuthorizationsPaginatorItems {
        super::super::super::operation::describe_aggregation_authorizations::paginator::DescribeAggregationAuthorizationsPaginatorItems(self)
    }
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::operation::describe_aggregation_authorizations::DescribeAggregationAuthorizationsOutput,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::describe_aggregation_authorizations::DescribeAggregationAuthorizationsError,
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::super::super::operation::describe_aggregation_authorizations::DescribeAggregationAuthorizations::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_describe_aggregation_authorizations_output_output_next_token(resp);
...
impl DescribeAggregationAuthorizationsPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::AggregationAuthorization,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::describe_aggregation_authorizations::DescribeAggregationAuthorizationsError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_describe_aggregation_authorizations_output_output_aggregation_authorizations(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
