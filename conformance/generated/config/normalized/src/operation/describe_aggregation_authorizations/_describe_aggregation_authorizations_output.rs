...
pub struct DescribeAggregationAuthorizationsOutput {
    ...
    pub aggregation_authorizations: ::std::option::Option<::std::vec::Vec<super::super::super::types::AggregationAuthorization>>,
...
impl DescribeAggregationAuthorizationsOutput {
    ...
    pub fn aggregation_authorizations(&self) -> &[super::super::super::types::AggregationAuthorization] {
...
pub struct DescribeAggregationAuthorizationsOutputBuilder {
    pub(crate) aggregation_authorizations: ::std::option::Option<::std::vec::Vec<super::super::super::types::AggregationAuthorization>>,
...
impl DescribeAggregationAuthorizationsOutputBuilder {
    ...
    ///
    /// <p>Returns a list of authorizations granted to various aggregator accounts and regions.</p>
    pub fn aggregation_authorizations(mut self, input: super::super::super::types::AggregationAuthorization) -> Self {
    ...
    /// <p>Returns a list of authorizations granted to various aggregator accounts and regions.</p>
    pub fn get_aggregation_authorizations(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::AggregationAuthorization>> {
    ...
    pub fn build(self) -> super::super::super::operation::describe_aggregation_authorizations::DescribeAggregationAuthorizationsOutput {
