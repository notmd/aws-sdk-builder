...
impl DescribeAggregationAuthorizationsInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_aggregation_authorizations::builders::DescribeAggregationAuthorizationsInputBuilder {
        super::super::super::operation::describe_aggregation_authorizations::builders::DescribeAggregationAuthorizationsInputBuilder::default()
    }
}
