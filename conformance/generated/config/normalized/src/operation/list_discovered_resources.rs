...
impl ListDiscoveredResources {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::list_discovered_resources::ListDiscoveredResourcesInput,
    ) -> ::std::result::Result<
        super::super::operation::list_discovered_resources::ListDiscoveredResourcesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::list_discovered_resources::ListDiscoveredResourcesError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::list_discovered_resources::ListDiscoveredResourcesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::list_discovered_resources::ListDiscoveredResourcesOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListDiscoveredResources {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListDiscoveredResources")
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListDiscoveredResourcesTelemetryInputCaptureInterceptor {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListDiscoveredResourcesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_list_discovered_resources::de_list_discovered_resources_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_list_discovered_resources::de_list_discovered_resources_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListDiscoveredResourcesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::list_discovered_resources::ListDiscoveredResourcesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::list_discovered_resources::ListDiscoveredResourcesInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_list_discovered_resources::ser_list_discovered_resources_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::super::operation::list_discovered_resources::ListDiscoveredResourcesError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::list_discovered_resources::_list_discovered_resources_input::ListDiscoveredResourcesInput;

pub use super::super::operation::list_discovered_resources::_list_discovered_resources_output::ListDiscoveredResourcesOutput;
