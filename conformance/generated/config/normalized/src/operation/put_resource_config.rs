...
impl PutResourceConfig {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::put_resource_config::PutResourceConfigError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::put_resource_config::PutResourceConfigOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Config Service", "PutResourceConfig", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutResourceConfig {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutResourceConfig")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutResourceConfigResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_put_resource_config::de_put_resource_config_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_put_resource_config::de_put_resource_config_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutResourceConfigRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::put_resource_config::PutResourceConfigInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::put_resource_config::PutResourceConfigInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_put_resource_config::ser_put_resource_config_input(&input)?);
...
pub enum PutResourceConfigError {
    ...
    MaxActiveResourcesExceededException(super::super::types::error::MaxActiveResourcesExceededException),
...
impl PutResourceConfigError {
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::MaxActiveResourcesExceededException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for PutResourceConfigError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::MaxActiveResourcesExceededException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
...
impl ::aws_types::request_id::RequestId for super::super::operation::put_resource_config::PutResourceConfigError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::put_resource_config::_put_resource_config_input::PutResourceConfigInput;

pub use super::super::operation::put_resource_config::_put_resource_config_output::PutResourceConfigOutput;
