...
pub struct GetAggregateDiscoveredResourceCountsOutput {
    ...
    pub grouped_resource_counts: ::std::option::Option<::std::vec::Vec<super::super::super::types::GroupedResourceCount>>,
...
impl GetAggregateDiscoveredResourceCountsOutput {
    ...
    pub fn grouped_resource_counts(&self) -> &[super::super::super::types::GroupedResourceCount] {
...
pub struct GetAggregateDiscoveredResourceCountsOutputBuilder {
    ...
    pub(crate) grouped_resource_counts: ::std::option::Option<::std::vec::Vec<super::super::super::types::GroupedResourceCount>>,
...
impl GetAggregateDiscoveredResourceCountsOutputBuilder {
    ...
    ///
    /// <p>Returns a list of GroupedResourceCount objects.</p>
    pub fn grouped_resource_counts(mut self, input: super::super::super::types::GroupedResourceCount) -> Self {
    ...
    /// <p>Returns a list of GroupedResourceCount objects.</p>
    pub fn get_grouped_resource_counts(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::GroupedResourceCount>> {
    ...
    pub fn build(self) -> super::super::super::operation::get_aggregate_discovered_resource_counts::GetAggregateDiscoveredResourceCountsOutput {
