...
pub use super::super::super::operation::get_aggregate_discovered_resource_counts::_get_aggregate_discovered_resource_counts_input::GetAggregateDiscoveredResourceCountsInputBuilder;

pub use super::super::super::operation::get_aggregate_discovered_resource_counts::_get_aggregate_discovered_resource_counts_output::GetAggregateDiscoveredResourceCountsOutputBuilder;

impl super::super::super::operation::get_aggregate_discovered_resource_counts::builders::GetAggregateDiscoveredResourceCountsInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::get_aggregate_discovered_resource_counts::GetAggregateDiscoveredResourceCountsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::get_aggregate_discovered_resource_counts::GetAggregateDiscoveredResourceCountsError,
...
pub struct GetAggregateDiscoveredResourceCountsFluentBuilder {
    ...
    inner: super::super::super::operation::get_aggregate_discovered_resource_counts::builders::GetAggregateDiscoveredResourceCountsInputBuilder,
...
impl GetAggregateDiscoveredResourceCountsFluentBuilder {
    ...
    > {
        ...
        let runtime_plugins =
            super::super::super::operation::get_aggregate_discovered_resource_counts::GetAggregateDiscoveredResourceCounts::operation_runtime_plugins(
    ...
    pub fn into_paginator(
        self,
    ) -> super::super::super::operation::get_aggregate_discovered_resource_counts::paginator::GetAggregateDiscoveredResourceCountsPaginator {
        super::super::super::operation::get_aggregate_discovered_resource_counts::paginator::GetAggregateDiscoveredResourceCountsPaginator::new(
            self.handle,
            self.inner,
        )
    }
    ...
    pub fn filters(mut self, input: super::super::super::types::ResourceCountFilters) -> Self {
        self.inner = self.inner.filters(input);
        self
    }
    /// <p>Filters the results based on the <code>ResourceCountFilters</code> object.</p>
    pub fn set_filters(mut self, input: ::std::option::Option<super::super::super::types::ResourceCountFilters>) -> Self {
        self.inner = self.inner.set_filters(input);
        self
    }
    /// <p>Filters the results based on the <code>ResourceCountFilters</code> object.</p>
    pub fn get_filters(&self) -> &::std::option::Option<super::super::super::types::ResourceCountFilters> {
        self.inner.get_filters()
    }
    /// <p>The key to group the resource counts.</p>
    pub fn group_by_key(mut self, input: super::super::super::types::ResourceCountGroupKey) -> Self {
        self.inner = self.inner.group_by_key(input);
        self
    }
    /// <p>The key to group the resource counts.</p>
    pub fn set_group_by_key(mut self, input: ::std::option::Option<super::super::super::types::ResourceCountGroupKey>) -> Self {
        self.inner = self.inner.set_group_by_key(input);
        self
    }
    /// <p>The key to group the resource counts.</p>
    pub fn get_group_by_key(&self) -> &::std::option::Option<super::super::super::types::ResourceCountGroupKey> {
