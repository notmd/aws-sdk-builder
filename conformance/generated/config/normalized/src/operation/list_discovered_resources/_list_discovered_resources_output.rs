...
pub struct ListDiscoveredResourcesOutput {
    ...
    pub resource_identifiers: ::std::option::Option<::std::vec::Vec<super::super::super::types::ResourceIdentifier>>,
...
impl ListDiscoveredResourcesOutput {
    ...
    pub fn resource_identifiers(&self) -> &[super::super::super::types::ResourceIdentifier] {
...
impl ListDiscoveredResourcesOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_discovered_resources::builders::ListDiscoveredResourcesOutputBuilder {
        super::super::super::operation::list_discovered_resources::builders::ListDiscoveredResourcesOutputBuilder::default()
    }
}
...
pub struct ListDiscoveredResourcesOutputBuilder {
    pub(crate) resource_identifiers: ::std::option::Option<::std::vec::Vec<super::super::super::types::ResourceIdentifier>>,
...
impl ListDiscoveredResourcesOutputBuilder {
    ...
    ///
    /// <p>The details that identify a resource that is discovered by Config, including the resource type, ID, and (if available) the custom resource name.</p>
    pub fn resource_identifiers(mut self, input: super::super::super::types::ResourceIdentifier) -> Self {
    ...
    /// <p>The details that identify a resource that is discovered by Config, including the resource type, ID, and (if available) the custom resource name.</p>
    pub fn set_resource_identifiers(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::ResourceIdentifier>>) -> Self {
        self.resource_identifiers = input;
        self
    }
    /// <p>The details that identify a resource that is discovered by Config, including the resource type, ID, and (if available) the custom resource name.</p>
    pub fn get_resource_identifiers(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::ResourceIdentifier>> {
    ...
    pub fn build(self) -> super::super::super::operation::list_discovered_resources::ListDiscoveredResourcesOutput {
