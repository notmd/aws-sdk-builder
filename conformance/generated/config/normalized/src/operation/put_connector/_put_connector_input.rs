...
pub struct PutConnectorInput {
    ...
    pub connector_configuration: ::std::option::Option<super::super::super::types::ConnectorConfiguration>,
...
impl PutConnectorInput {
    /// <p>The provider-specific configuration for connecting to the third-party cloud service provider.</p>
    pub fn connector_configuration(&self) -> ::std::option::Option<&super::super::super::types::ConnectorConfiguration> {
...
impl PutConnectorInput {
    ...
    pub fn builder() -> super::super::super::operation::put_connector::builders::PutConnectorInputBuilder {
        super::super::super::operation::put_connector::builders::PutConnectorInputBuilder::default()
    }
}
...
pub struct PutConnectorInputBuilder {
    pub(crate) connector_configuration: ::std::option::Option<super::super::super::types::ConnectorConfiguration>,
