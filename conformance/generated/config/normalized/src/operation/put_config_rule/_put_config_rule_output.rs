...
impl PutConfigRuleOutput {
    ...
    pub fn builder() -> super::super::super::operation::put_config_rule::builders::PutConfigRuleOutputBuilder {
        super::super::super::operation::put_config_rule::builders::PutConfigRuleOutputBuilder::default()
    }
}
...
impl PutConfigRuleOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::put_config_rule::PutConfigRuleOutput {
