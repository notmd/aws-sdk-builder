...
pub use super::super::super::operation::put_config_rule::_put_config_rule_input::PutConfigRuleInputBuilder;

pub use super::super::super::operation::put_config_rule::_put_config_rule_output::PutConfigRuleOutputBuilder;

impl super::super::super::operation::put_config_rule::builders::PutConfigRuleInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::put_config_rule::PutConfigRuleOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::put_config_rule::PutConfigRuleError,
...
pub struct PutConfigRuleFluentBuilder {
    ...
    inner: super::super::super::operation::put_config_rule::builders::PutConfigRuleInputBuilder,
...
impl PutConfigRuleFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::put_config_rule::builders::PutConfigRuleInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::put_config_rule::PutConfigRule::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::put_config_rule::PutConfigRule::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn config_rule(mut self, input: super::super::super::types::ConfigRule) -> Self {
        self.inner = self.inner.config_rule(input);
        self
    }
    /// <p>The rule that you want to add to your account.</p>
    pub fn set_config_rule(mut self, input: ::std::option::Option<super::super::super::types::ConfigRule>) -> Self {
        self.inner = self.inner.set_config_rule(input);
        self
    }
    /// <p>The rule that you want to add to your account.</p>
    pub fn get_config_rule(&self) -> &::std::option::Option<super::super::super::types::ConfigRule> {
