...
pub use super::super::super::operation::deliver_config_snapshot::_deliver_config_snapshot_input::DeliverConfigSnapshotInputBuilder;

pub use super::super::super::operation::deliver_config_snapshot::_deliver_config_snapshot_output::DeliverConfigSnapshotOutputBuilder;

impl super::super::super::operation::deliver_config_snapshot::builders::DeliverConfigSnapshotInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::deliver_config_snapshot::DeliverConfigSnapshotOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::deliver_config_snapshot::DeliverConfigSnapshotError,
...
pub struct DeliverConfigSnapshotFluentBuilder {
    ...
    inner: super::super::super::operation::deliver_config_snapshot::builders::DeliverConfigSnapshotInputBuilder,
...
impl DeliverConfigSnapshotFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::deliver_config_snapshot::builders::DeliverConfigSnapshotInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::deliver_config_snapshot::DeliverConfigSnapshot::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::deliver_config_snapshot::DeliverConfigSnapshot::orchestrate(&runtime_plugins, input).await
    }
