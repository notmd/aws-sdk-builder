...
impl DeliverConfigSnapshotOutput {
    ...
    pub fn builder() -> super::super::super::operation::deliver_config_snapshot::builders::DeliverConfigSnapshotOutputBuilder {
        super::super::super::operation::deliver_config_snapshot::builders::DeliverConfigSnapshotOutputBuilder::default()
    }
}
...
impl DeliverConfigSnapshotOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::deliver_config_snapshot::DeliverConfigSnapshotOutput {
