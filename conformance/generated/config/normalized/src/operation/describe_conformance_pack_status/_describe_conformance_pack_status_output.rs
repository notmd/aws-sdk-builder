...
pub struct DescribeConformancePackStatusOutput {
    ...
    pub conformance_pack_status_details: ::std::option::Option<::std::vec::Vec<super::super::super::types::ConformancePackStatusDetail>>,
...
impl DescribeConformancePackStatusOutput {
    ...
    pub fn conformance_pack_status_details(&self) -> &[super::super::super::types::ConformancePackStatusDetail] {
...
impl DescribeConformancePackStatusOutput {
    ...
    pub fn builder() -> super::super::super::operation::describe_conformance_pack_status::builders::DescribeConformancePackStatusOutputBuilder {
        super::super::super::operation::describe_conformance_pack_status::builders::DescribeConformancePackStatusOutputBuilder::default()
    }
}
...
pub struct DescribeConformancePackStatusOutputBuilder {
    pub(crate) conformance_pack_status_details: ::std::option::Option<::std::vec::Vec<super::super::super::types::ConformancePackStatusDetail>>,
...
impl DescribeConformancePackStatusOutputBuilder {
    ...
    ///
    /// <p>A list of <code>ConformancePackStatusDetail</code> objects.</p>
    pub fn conformance_pack_status_details(mut self, input: super::super::super::types::ConformancePackStatusDetail) -> Self {
    ...
    pub fn set_conformance_pack_status_details(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::ConformancePackStatusDetail>>,
    ) -> Self {
    ...
    pub fn build(self) -> super::super::super::operation::describe_conformance_pack_status::DescribeConformancePackStatusOutput {
