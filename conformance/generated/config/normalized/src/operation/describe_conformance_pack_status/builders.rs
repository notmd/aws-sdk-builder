...
pub use super::super::super::operation::describe_conformance_pack_status::_describe_conformance_pack_status_input::DescribeConformancePackStatusInputBuilder;

pub use super::super::super::operation::describe_conformance_pack_status::_describe_conformance_pack_status_output::DescribeConformancePackStatusOutputBuilder;

impl super::super::super::operation::describe_conformance_pack_status::builders::DescribeConformancePackStatusInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::describe_conformance_pack_status::DescribeConformancePackStatusOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::describe_conformance_pack_status::DescribeConformancePackStatusError,
...
pub struct DescribeConformancePackStatusFluentBuilder {
    ...
    inner: super::super::super::operation::describe_conformance_pack_status::builders::DescribeConformancePackStatusInputBuilder,
...
impl DescribeConformancePackStatusFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::describe_conformance_pack_status::builders::DescribeConformancePackStatusInputBuilder {
        &self.inner
    }
