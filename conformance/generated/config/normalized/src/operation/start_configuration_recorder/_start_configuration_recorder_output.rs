...
impl StartConfigurationRecorderOutput {
    ...
    pub fn builder() -> super::super::super::operation::start_configuration_recorder::builders::StartConfigurationRecorderOutputBuilder {
        super::super::super::operation::start_configuration_recorder::builders::StartConfigurationRecorderOutputBuilder::default()
    }
}
...
impl StartConfigurationRecorderOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::start_configuration_recorder::StartConfigurationRecorderOutput {
