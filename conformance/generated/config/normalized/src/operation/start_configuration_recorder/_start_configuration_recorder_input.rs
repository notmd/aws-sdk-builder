...
impl StartConfigurationRecorderInput {
    ...
    pub fn builder() -> super::super::super::operation::start_configuration_recorder::builders::StartConfigurationRecorderInputBuilder {
        super::super::super::operation::start_configuration_recorder::builders::StartConfigurationRecorderInputBuilder::default()
    }
}
