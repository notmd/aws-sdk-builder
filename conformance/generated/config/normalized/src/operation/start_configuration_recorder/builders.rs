...
pub use super::super::super::operation::start_configuration_recorder::_start_configuration_recorder_input::StartConfigurationRecorderInputBuilder;

pub use super::super::super::operation::start_configuration_recorder::_start_configuration_recorder_output::StartConfigurationRecorderOutputBuilder;

impl super::super::super::operation::start_configuration_recorder::builders::StartConfigurationRecorderInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::start_configuration_recorder::StartConfigurationRecorderOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::start_configuration_recorder::StartConfigurationRecorderError,
...
pub struct StartConfigurationRecorderFluentBuilder {
    ...
    inner: super::super::super::operation::start_configuration_recorder::builders::StartConfigurationRecorderInputBuilder,
...
impl StartConfigurationRecorderFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::start_configuration_recorder::builders::StartConfigurationRecorderInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::start_configuration_recorder::StartConfigurationRecorder::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::start_configuration_recorder::StartConfigurationRecorder::orchestrate(&runtime_plugins, input).await
    }
