...
impl ListStoredQueries {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::list_stored_queries::ListStoredQueriesInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::list_stored_queries::ListStoredQueriesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::list_stored_queries::ListStoredQueriesOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Config Service", "ListStoredQueries", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListStoredQueries {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListStoredQueries")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListStoredQueriesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_list_stored_queries::de_list_stored_queries_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_list_stored_queries::de_list_stored_queries_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListStoredQueriesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::list_stored_queries::ListStoredQueriesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::list_stored_queries::ListStoredQueriesInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_list_stored_queries::ser_list_stored_queries_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::list_stored_queries::ListStoredQueriesError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::list_stored_queries::_list_stored_queries_input::ListStoredQueriesInput;

pub use super::super::operation::list_stored_queries::_list_stored_queries_output::ListStoredQueriesOutput;
