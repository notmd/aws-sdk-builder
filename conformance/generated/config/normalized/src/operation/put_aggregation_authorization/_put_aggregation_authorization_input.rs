...
impl PutAggregationAuthorizationInput {
    ...
    pub fn builder() -> super::super::super::operation::put_aggregation_authorization::builders::PutAggregationAuthorizationInputBuilder {
        super::super::super::operation::put_aggregation_authorization::builders::PutAggregationAuthorizationInputBuilder::default()
    }
}
