...
pub struct DescribeConfigurationAggregatorSourcesStatusInput {
    ...
    /// </ul>
    pub update_status: ::std::option::Option<::std::vec::Vec<super::super::super::types::AggregatedSourceStatusType>>,
...
impl DescribeConfigurationAggregatorSourcesStatusInput {
    ...
    pub fn update_status(&self) -> &[super::super::super::types::AggregatedSourceStatusType] {
...
pub struct DescribeConfigurationAggregatorSourcesStatusInputBuilder {
    ...
    pub(crate) update_status: ::std::option::Option<::std::vec::Vec<super::super::super::types::AggregatedSourceStatusType>>,
...
impl DescribeConfigurationAggregatorSourcesStatusInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::describe_configuration_aggregator_sources_status::DescribeConfigurationAggregatorSourcesStatusInput,
