...
pub struct DescribeConfigurationAggregatorSourcesStatusOutput {
    ...
    pub aggregated_source_status_list: ::std::option::Option<::std::vec::Vec<super::super::super::types::AggregatedSourceStatus>>,
...
impl DescribeConfigurationAggregatorSourcesStatusOutput {
    ...
    pub fn aggregated_source_status_list(&self) -> &[super::super::super::types::AggregatedSourceStatus] {
...
pub struct DescribeConfigurationAggregatorSourcesStatusOutputBuilder {
    pub(crate) aggregated_source_status_list: ::std::option::Option<::std::vec::Vec<super::super::super::types::AggregatedSourceStatus>>,
...
impl DescribeConfigurationAggregatorSourcesStatusOutputBuilder {
    ...
    ///
    /// <p>Returns an AggregatedSourceStatus object.</p>
    pub fn aggregated_source_status_list(mut self, input: super::super::super::types::AggregatedSourceStatus) -> Self {
    ...
    /// <p>Returns an AggregatedSourceStatus object.</p>
    pub fn get_aggregated_source_status_list(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::AggregatedSourceStatus>> {
