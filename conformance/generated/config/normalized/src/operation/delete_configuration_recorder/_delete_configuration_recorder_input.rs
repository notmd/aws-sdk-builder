...
impl DeleteConfigurationRecorderInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_configuration_recorder::builders::DeleteConfigurationRecorderInputBuilder {
        super::super::super::operation::delete_configuration_recorder::builders::DeleteConfigurationRecorderInputBuilder::default()
    }
}
