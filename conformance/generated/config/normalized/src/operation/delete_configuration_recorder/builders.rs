...
pub use super::super::super::operation::delete_configuration_recorder::_delete_configuration_recorder_input::DeleteConfigurationRecorderInputBuilder;

pub use super::super::super::operation::delete_configuration_recorder::_delete_configuration_recorder_output::DeleteConfigurationRecorderOutputBuilder;

impl super::super::super::operation::delete_configuration_recorder::builders::DeleteConfigurationRecorderInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_configuration_recorder::DeleteConfigurationRecorderOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_configuration_recorder::DeleteConfigurationRecorderError,
...
pub struct DeleteConfigurationRecorderFluentBuilder {
    ...
    inner: super::super::super::operation::delete_configuration_recorder::builders::DeleteConfigurationRecorderInputBuilder,
...
impl DeleteConfigurationRecorderFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_configuration_recorder::builders::DeleteConfigurationRecorderInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_configuration_recorder::DeleteConfigurationRecorder::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_configuration_recorder::DeleteConfigurationRecorder::orchestrate(&runtime_plugins, input).await
    }
