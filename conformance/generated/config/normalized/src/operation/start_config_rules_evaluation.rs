...
impl StartConfigRulesEvaluation {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::start_config_rules_evaluation::StartConfigRulesEvaluationInput,
    ) -> ::std::result::Result<
        super::super::operation::start_config_rules_evaluation::StartConfigRulesEvaluationOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::start_config_rules_evaluation::StartConfigRulesEvaluationError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::start_config_rules_evaluation::StartConfigRulesEvaluationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::start_config_rules_evaluation::StartConfigRulesEvaluationOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartConfigRulesEvaluationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_start_config_rules_evaluation::de_start_config_rules_evaluation_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_start_config_rules_evaluation::de_start_config_rules_evaluation_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartConfigRulesEvaluationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::start_config_rules_evaluation::StartConfigRulesEvaluationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::start_config_rules_evaluation::StartConfigRulesEvaluationInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_start_config_rules_evaluation::ser_start_config_rules_evaluation_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::super::operation::start_config_rules_evaluation::StartConfigRulesEvaluationError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::start_config_rules_evaluation::_start_config_rules_evaluation_input::StartConfigRulesEvaluationInput;

pub use super::super::operation::start_config_rules_evaluation::_start_config_rules_evaluation_output::StartConfigRulesEvaluationOutput;
