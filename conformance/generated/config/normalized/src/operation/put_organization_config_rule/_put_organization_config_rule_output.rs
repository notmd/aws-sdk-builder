...
impl PutOrganizationConfigRuleOutput {
    ...
    pub fn builder() -> super::super::super::operation::put_organization_config_rule::builders::PutOrganizationConfigRuleOutputBuilder {
        super::super::super::operation::put_organization_config_rule::builders::PutOrganizationConfigRuleOutputBuilder::default()
    }
}
...
impl PutOrganizationConfigRuleOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::put_organization_config_rule::PutOrganizationConfigRuleOutput {
