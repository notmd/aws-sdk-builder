...
pub use super::super::super::operation::put_organization_config_rule::_put_organization_config_rule_input::PutOrganizationConfigRuleInputBuilder;

pub use super::super::super::operation::put_organization_config_rule::_put_organization_config_rule_output::PutOrganizationConfigRuleOutputBuilder;

impl super::super::super::operation::put_organization_config_rule::builders::PutOrganizationConfigRuleInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::put_organization_config_rule::PutOrganizationConfigRuleOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::put_organization_config_rule::PutOrganizationConfigRuleError,
...
pub struct PutOrganizationConfigRuleFluentBuilder {
    ...
    inner: super::super::super::operation::put_organization_config_rule::builders::PutOrganizationConfigRuleInputBuilder,
...
impl PutOrganizationConfigRuleFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::put_organization_config_rule::builders::PutOrganizationConfigRuleInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::put_organization_config_rule::PutOrganizationConfigRule::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::put_organization_config_rule::PutOrganizationConfigRule::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn organization_managed_rule_metadata(mut self, input: super::super::super::types::OrganizationManagedRuleMetadata) -> Self {
    ...
    /// <p>An <code>OrganizationManagedRuleMetadata</code> object. This object specifies organization managed rule metadata such as resource type and ID of Amazon Web Services resource along with the rule identifier. It also provides the frequency with which you want Config to run evaluations for the rule if the trigger type is periodic.</p>
    pub fn get_organization_managed_rule_metadata(&self) -> &::std::option::Option<super::super::super::types::OrganizationManagedRuleMetadata> {
    ...
    pub fn organization_custom_rule_metadata(mut self, input: super::super::super::types::OrganizationCustomRuleMetadata) -> Self {
    ...
    /// <p>An <code>OrganizationCustomRuleMetadata</code> object. This object specifies organization custom rule metadata such as resource type, resource ID of Amazon Web Services resource, Lambda function ARN, and organization trigger types that trigger Config to evaluate your Amazon Web Services resources against a rule. It also provides the frequency with which you want Config to run evaluations for the rule if the trigger type is periodic.</p>
    pub fn get_organization_custom_rule_metadata(&self) -> &::std::option::Option<super::super::super::types::OrganizationCustomRuleMetadata> {
    ...
    pub fn organization_custom_policy_rule_metadata(mut self, input: super::super::super::types::OrganizationCustomPolicyRuleMetadata) -> Self {
    ...
    pub fn set_organization_custom_policy_rule_metadata(
        mut self,
        input: ::std::option::Option<super::super::super::types::OrganizationCustomPolicyRuleMetadata>,
    ) -> Self {
