...
impl DeleteConnectorOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_connector::builders::DeleteConnectorOutputBuilder {
        super::super::super::operation::delete_connector::builders::DeleteConnectorOutputBuilder::default()
    }
}
...
impl DeleteConnectorOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_connector::DeleteConnectorOutput {
