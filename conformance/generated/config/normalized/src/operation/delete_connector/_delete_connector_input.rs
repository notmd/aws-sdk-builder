...
impl DeleteConnectorInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_connector::builders::DeleteConnectorInputBuilder {
        super::super::super::operation::delete_connector::builders::DeleteConnectorInputBuilder::default()
    }
}
