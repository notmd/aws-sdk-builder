...
pub use super::super::super::operation::delete_organization_config_rule::_delete_organization_config_rule_input::DeleteOrganizationConfigRuleInputBuilder;

pub use super::super::super::operation::delete_organization_config_rule::_delete_organization_config_rule_output::DeleteOrganizationConfigRuleOutputBuilder;

impl super::super::super::operation::delete_organization_config_rule::builders::DeleteOrganizationConfigRuleInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_organization_config_rule::DeleteOrganizationConfigRuleOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_organization_config_rule::DeleteOrganizationConfigRuleError,
...
/// <p>Config sets the state of a rule to DELETE_IN_PROGRESS until the deletion is complete. You cannot update a rule while it is in this state.</p><note>
...
pub struct DeleteOrganizationConfigRuleFluentBuilder {
    ...
    inner: super::super::super::operation::delete_organization_config_rule::builders::DeleteOrganizationConfigRuleInputBuilder,
...
impl DeleteOrganizationConfigRuleFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_organization_config_rule::builders::DeleteOrganizationConfigRuleInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_organization_config_rule::DeleteOrganizationConfigRule::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_organization_config_rule::DeleteOrganizationConfigRule::orchestrate(&runtime_plugins, input).await
    }
