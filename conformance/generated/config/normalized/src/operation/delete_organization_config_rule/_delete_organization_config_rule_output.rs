...
impl DeleteOrganizationConfigRuleOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_organization_config_rule::builders::DeleteOrganizationConfigRuleOutputBuilder {
        super::super::super::operation::delete_organization_config_rule::builders::DeleteOrganizationConfigRuleOutputBuilder::default()
    }
}
...
impl DeleteOrganizationConfigRuleOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_organization_config_rule::DeleteOrganizationConfigRuleOutput {
