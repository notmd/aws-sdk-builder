...
impl DeleteOrganizationConfigRuleInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_organization_config_rule::builders::DeleteOrganizationConfigRuleInputBuilder {
        super::super::super::operation::delete_organization_config_rule::builders::DeleteOrganizationConfigRuleInputBuilder::default()
    }
}
