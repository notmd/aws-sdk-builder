...
impl ListStoredQueriesInput {
    ...
    pub fn builder() -> super::super::super::operation::list_stored_queries::builders::ListStoredQueriesInputBuilder {
        super::super::super::operation::list_stored_queries::builders::ListStoredQueriesInputBuilder::default()
    }
}
