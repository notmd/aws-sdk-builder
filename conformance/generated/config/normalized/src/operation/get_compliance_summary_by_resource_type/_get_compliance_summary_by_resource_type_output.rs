...
pub struct GetComplianceSummaryByResourceTypeOutput {
    ...
    pub compliance_summaries_by_resource_type: ::std::option::Option<::std::vec::Vec<super::super::super::types::ComplianceSummaryByResourceType>>,
...
impl GetComplianceSummaryByResourceTypeOutput {
    ...
    pub fn compliance_summaries_by_resource_type(&self) -> &[super::super::super::types::ComplianceSummaryByResourceType] {
...
impl GetComplianceSummaryByResourceTypeOutputBuilder {
    ...
    ///
    /// <p>The number of resources that are compliant and the number that are noncompliant. If one or more resource types were provided with the request, the numbers are returned for each resource type. The maximum number returned is 100.</p>
    pub fn compliance_summaries_by_resource_type(mut self, input: super::super::super::types::ComplianceSummaryByResourceType) -> Self {
    ...
    pub fn set_compliance_summaries_by_resource_type(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::ComplianceSummaryByResourceType>>,
    ) -> Self {
    ...
    pub fn build(self) -> super::super::super::operation::get_compliance_summary_by_resource_type::GetComplianceSummaryByResourceTypeOutput {
