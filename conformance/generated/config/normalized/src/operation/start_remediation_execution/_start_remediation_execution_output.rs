...
pub struct StartRemediationExecutionOutput {
    ...
    pub failed_items: ::std::option::Option<::std::vec::Vec<super::super::super::types::ResourceKey>>,
...
impl StartRemediationExecutionOutput {
    ...
    pub fn failed_items(&self) -> &[super::super::super::types::ResourceKey] {
...
impl StartRemediationExecutionOutput {
    ...
    pub fn builder() -> super::super::super::operation::start_remediation_execution::builders::StartRemediationExecutionOutputBuilder {
        super::super::super::operation::start_remediation_execution::builders::StartRemediationExecutionOutputBuilder::default()
    }
}
...
pub struct StartRemediationExecutionOutputBuilder {
    ...
    pub(crate) failed_items: ::std::option::Option<::std::vec::Vec<super::super::super::types::ResourceKey>>,
    _request_id: Option<String>,
}
impl StartRemediationExecutionOutputBuilder {
    ...
    ///
    /// <p>For resources that have failed to start execution, the API returns a resource key object.</p>
    pub fn failed_items(mut self, input: super::super::super::types::ResourceKey) -> Self {
    ...
    /// <p>For resources that have failed to start execution, the API returns a resource key object.</p>
    pub fn set_failed_items(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::ResourceKey>>) -> Self {
        self.failed_items = input;
        self
    }
    /// <p>For resources that have failed to start execution, the API returns a resource key object.</p>
    pub fn get_failed_items(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::ResourceKey>> {
        &self.failed_items
    }
    ...
    pub fn build(self) -> super::super::super::operation::start_remediation_execution::StartRemediationExecutionOutput {
