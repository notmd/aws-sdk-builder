...
impl GetResourceConfigHistory {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::get_resource_config_history::GetResourceConfigHistoryInput,
    ) -> ::std::result::Result<
        super::super::operation::get_resource_config_history::GetResourceConfigHistoryOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::get_resource_config_history::GetResourceConfigHistoryError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::get_resource_config_history::GetResourceConfigHistoryError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::get_resource_config_history::GetResourceConfigHistoryOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetResourceConfigHistory {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetResourceConfigHistory")
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetResourceConfigHistoryTelemetryInputCaptureInterceptor {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetResourceConfigHistoryResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_get_resource_config_history::de_get_resource_config_history_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_get_resource_config_history::de_get_resource_config_history_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetResourceConfigHistoryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::get_resource_config_history::GetResourceConfigHistoryInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::get_resource_config_history::GetResourceConfigHistoryInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_get_resource_config_history::ser_get_resource_config_history_input(&input)?,
        );
...
pub enum GetResourceConfigHistoryError {
    ...
    InvalidTimeRangeException(super::super::types::error::InvalidTimeRangeException),
    ...
    ResourceNotDiscoveredException(super::super::types::error::ResourceNotDiscoveredException),
...
impl ::aws_types::request_id::RequestId for super::super::operation::get_resource_config_history::GetResourceConfigHistoryError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::get_resource_config_history::_get_resource_config_history_input::GetResourceConfigHistoryInput;

pub use super::super::operation::get_resource_config_history::_get_resource_config_history_output::GetResourceConfigHistoryOutput;
