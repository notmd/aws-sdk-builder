...
impl DeleteEvaluationResults {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::delete_evaluation_results::DeleteEvaluationResultsInput,
    ) -> ::std::result::Result<
        super::super::operation::delete_evaluation_results::DeleteEvaluationResultsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::delete_evaluation_results::DeleteEvaluationResultsError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::delete_evaluation_results::DeleteEvaluationResultsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::delete_evaluation_results::DeleteEvaluationResultsOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteEvaluationResults {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteEvaluationResults")
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteEvaluationResultsTelemetryInputCaptureInterceptor {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteEvaluationResultsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_delete_evaluation_results::de_delete_evaluation_results_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_delete_evaluation_results::de_delete_evaluation_results_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteEvaluationResultsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::delete_evaluation_results::DeleteEvaluationResultsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::delete_evaluation_results::DeleteEvaluationResultsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_delete_evaluation_results::ser_delete_evaluation_results_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::super::operation::delete_evaluation_results::DeleteEvaluationResultsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::delete_evaluation_results::_delete_evaluation_results_input::DeleteEvaluationResultsInput;

pub use super::super::operation::delete_evaluation_results::_delete_evaluation_results_output::DeleteEvaluationResultsOutput;
