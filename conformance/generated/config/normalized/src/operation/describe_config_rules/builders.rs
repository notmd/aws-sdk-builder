...
pub use super::super::super::operation::describe_config_rules::_describe_config_rules_input::DescribeConfigRulesInputBuilder;

pub use super::super::super::operation::describe_config_rules::_describe_config_rules_output::DescribeConfigRulesOutputBuilder;

impl super::super::super::operation::describe_config_rules::builders::DescribeConfigRulesInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::describe_config_rules::DescribeConfigRulesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::describe_config_rules::DescribeConfigRulesError,
...
pub struct DescribeConfigRulesFluentBuilder {
    ...
    inner: super::super::super::operation::describe_config_rules::builders::DescribeConfigRulesInputBuilder,
...
impl DescribeConfigRulesFluentBuilder {
    /// Creates a new `DescribeConfigRulesFluentBuilder`.
    ...
    pub fn as_input(&self) -> &super::super::super::operation::describe_config_rules::builders::DescribeConfigRulesInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::describe_config_rules::DescribeConfigRules::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::describe_config_rules::DescribeConfigRules::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::super::super::operation::describe_config_rules::paginator::DescribeConfigRulesPaginator {
        super::super::super::operation::describe_config_rules::paginator::DescribeConfigRulesPaginator::new(self.handle, self.inner)
    }
    ///
    ...
    pub fn filters(mut self, input: super::super::super::types::DescribeConfigRulesFilters) -> Self {
        self.inner = self.inner.filters(input);
        self
    }
    /// <p>Returns a list of Detective or Proactive Config rules. By default, this API returns an unfiltered list. For more information on Detective or Proactive Config rules, see <a href="https://docs.aws.amazon.com/config/latest/developerguide/evaluate-config-rules.html"> <b>Evaluation Mode</b> </a> in the <i>Config Developer Guide</i>.</p>
    pub fn set_filters(mut self, input: ::std::option::Option<super::super::super::types::DescribeConfigRulesFilters>) -> Self {
        self.inner = self.inner.set_filters(input);
        self
    }
    /// <p>Returns a list of Detective or Proactive Config rules. By default, this API returns an unfiltered list. For more information on Detective or Proactive Config rules, see <a href="https://docs.aws.amazon.com/config/latest/developerguide/evaluate-config-rules.html"> <b>Evaluation Mode</b> </a> in the <i>Config Developer Guide</i>.</p>
    pub fn get_filters(&self) -> &::std::option::Option<super::super::super::types::DescribeConfigRulesFilters> {
