...
pub struct DescribeConfigRulesPaginator {
    ...
    builder: super::super::super::operation::describe_config_rules::builders::DescribeConfigRulesInputBuilder,
...
impl DescribeConfigRulesPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::describe_config_rules::paginator::DescribeConfigRulesPaginatorItems {
        super::super::super::operation::describe_config_rules::paginator::DescribeConfigRulesPaginatorItems(self)
    }
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_describe_config_rules_output_output_next_token(resp);
...
impl DescribeConfigRulesPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::ConfigRule,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::describe_config_rules::DescribeConfigRulesError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_describe_config_rules_output_output_config_rules(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
