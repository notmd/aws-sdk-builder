...
pub use super::super::super::operation::get_compliance_details_by_config_rule::_get_compliance_details_by_config_rule_input::GetComplianceDetailsByConfigRuleInputBuilder;

pub use super::super::super::operation::get_compliance_details_by_config_rule::_get_compliance_details_by_config_rule_output::GetComplianceDetailsByConfigRuleOutputBuilder;

impl super::super::super::operation::get_compliance_details_by_config_rule::builders::GetComplianceDetailsByConfigRuleInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::get_compliance_details_by_config_rule::GetComplianceDetailsByConfigRuleOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::get_compliance_details_by_config_rule::GetComplianceDetailsByConfigRuleError,
...
pub struct GetComplianceDetailsByConfigRuleFluentBuilder {
    ...
    inner: super::super::super::operation::get_compliance_details_by_config_rule::builders::GetComplianceDetailsByConfigRuleInputBuilder,
