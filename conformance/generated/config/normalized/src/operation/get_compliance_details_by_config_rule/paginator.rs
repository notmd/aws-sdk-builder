...
pub struct GetComplianceDetailsByConfigRulePaginator {
    ...
    builder: super::super::super::operation::get_compliance_details_by_config_rule::builders::GetComplianceDetailsByConfigRuleInputBuilder,
...
impl GetComplianceDetailsByConfigRulePaginator {
    ...
    pub fn items(self) -> super::super::super::operation::get_compliance_details_by_config_rule::paginator::GetComplianceDetailsByConfigRulePaginatorItems {
        super::super::super::operation::get_compliance_details_by_config_rule::paginator::GetComplianceDetailsByConfigRulePaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::super::super::operation::get_compliance_details_by_config_rule::GetComplianceDetailsByConfigRule::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_get_compliance_details_by_config_rule_output_output_next_token(resp);
...
impl GetComplianceDetailsByConfigRulePaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::EvaluationResult,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::get_compliance_details_by_config_rule::GetComplianceDetailsByConfigRuleError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_get_compliance_details_by_config_rule_output_output_evaluation_results(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
