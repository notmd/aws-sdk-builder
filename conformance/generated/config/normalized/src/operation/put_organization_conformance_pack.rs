...
impl PutOrganizationConformancePack {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::put_organization_conformance_pack::PutOrganizationConformancePackInput,
    ) -> ::std::result::Result<
        super::super::operation::put_organization_conformance_pack::PutOrganizationConformancePackOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::put_organization_conformance_pack::PutOrganizationConformancePackError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::put_organization_conformance_pack::PutOrganizationConformancePackError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::put_organization_conformance_pack::PutOrganizationConformancePackOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutOrganizationConformancePackResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_put_organization_conformance_pack::de_put_organization_conformance_pack_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_put_organization_conformance_pack::de_put_organization_conformance_pack_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutOrganizationConformancePackRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::put_organization_conformance_pack::PutOrganizationConformancePackInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::put_organization_conformance_pack::PutOrganizationConformancePackInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_put_organization_conformance_pack::ser_put_organization_conformance_pack_input(&input)?,
        );
...
pub enum PutOrganizationConformancePackError {
    ...
    MaxNumberOfOrganizationConformancePacksExceededException(super::super::types::error::MaxNumberOfOrganizationConformancePacksExceededException),
    /// <p>Organization is no longer available.</p>
    NoAvailableOrganizationException(super::super::types::error::NoAvailableOrganizationException),
    ...
    OrganizationAllFeaturesNotEnabledException(super::super::types::error::OrganizationAllFeaturesNotEnabledException),
    /// <p>You have specified a template that is not valid or supported.</p>
    OrganizationConformancePackTemplateValidationException(super::super::types::error::OrganizationConformancePackTemplateValidationException),
...
impl ::aws_types::request_id::RequestId for super::super::operation::put_organization_conformance_pack::PutOrganizationConformancePackError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::put_organization_conformance_pack::_put_organization_conformance_pack_input::PutOrganizationConformancePackInput;

pub use super::super::operation::put_organization_conformance_pack::_put_organization_conformance_pack_output::PutOrganizationConformancePackOutput;
