...
pub struct PutConfigurationRecorderInput {
    ...
    pub configuration_recorder: ::std::option::Option<super::super::super::types::ConfigurationRecorder>,
...
impl PutConfigurationRecorderInput {
    /// <p>An object for the configuration recorder. A configuration recorder records configuration changes for the resource types in scope.</p>
    pub fn configuration_recorder(&self) -> ::std::option::Option<&super::super::super::types::ConfigurationRecorder> {
...
impl PutConfigurationRecorderInput {
    ...
    pub fn builder() -> super::super::super::operation::put_configuration_recorder::builders::PutConfigurationRecorderInputBuilder {
        super::super::super::operation::put_configuration_recorder::builders::PutConfigurationRecorderInputBuilder::default()
    }
}
...
pub struct PutConfigurationRecorderInputBuilder {
    pub(crate) configuration_recorder: ::std::option::Option<super::super::super::types::ConfigurationRecorder>,
