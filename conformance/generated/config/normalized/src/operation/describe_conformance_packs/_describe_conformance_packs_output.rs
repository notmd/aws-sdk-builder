...
pub struct DescribeConformancePacksOutput {
    ...
    pub conformance_pack_details: ::std::option::Option<::std::vec::Vec<super::super::super::types::ConformancePackDetail>>,
...
impl DescribeConformancePacksOutput {
    ...
    pub fn conformance_pack_details(&self) -> &[super::super::super::types::ConformancePackDetail] {
...
impl DescribeConformancePacksOutput {
    ...
    pub fn builder() -> super::super::super::operation::describe_conformance_packs::builders::DescribeConformancePacksOutputBuilder {
        super::super::super::operation::describe_conformance_packs::builders::DescribeConformancePacksOutputBuilder::default()
    }
}
...
pub struct DescribeConformancePacksOutputBuilder {
    pub(crate) conformance_pack_details: ::std::option::Option<::std::vec::Vec<super::super::super::types::ConformancePackDetail>>,
...
impl DescribeConformancePacksOutputBuilder {
    ...
    ///
    /// <p>Returns a list of <code>ConformancePackDetail</code> objects.</p>
    pub fn conformance_pack_details(mut self, input: super::super::super::types::ConformancePackDetail) -> Self {
    ...
    /// <p>Returns a list of <code>ConformancePackDetail</code> objects.</p>
    pub fn get_conformance_pack_details(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::ConformancePackDetail>> {
    ...
    pub fn build(self) -> super::super::super::operation::describe_conformance_packs::DescribeConformancePacksOutput {
