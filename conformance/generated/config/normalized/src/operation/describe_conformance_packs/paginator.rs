...
/// Paginator for [`DescribeConformancePacks`](crate::operation::describe_conformance_packs::DescribeConformancePacks)
pub struct DescribeConformancePacksPaginator {
    handle: std::sync::Arc<super::super::super::client::Handle>,
    builder: super::super::super::operation::describe_conformance_packs::builders::DescribeConformancePacksInputBuilder,
...
impl DescribeConformancePacksPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::describe_conformance_packs::paginator::DescribeConformancePacksPaginatorItems {
        super::super::super::operation::describe_conformance_packs::paginator::DescribeConformancePacksPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            super::super::super::operation::describe_conformance_packs::DescribeConformancePacks::orchestrate(&runtime_plugins, input.clone())
                                .await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_describe_conformance_packs_output_output_next_token(resp);
...
impl DescribeConformancePacksPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::ConformancePackDetail,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::describe_conformance_packs::DescribeConformancePacksError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_describe_conformance_packs_output_output_conformance_pack_details(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
