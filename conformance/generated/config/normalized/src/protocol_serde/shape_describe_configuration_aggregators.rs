...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::describe_configuration_aggregators::DescribeConfigurationAggregatorsError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InvalidLimitException" => {
            super::super::operation::describe_configuration_aggregators::DescribeConfigurationAggregatorsError::InvalidLimitException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidNextTokenException" => {
            super::super::operation::describe_configuration_aggregators::DescribeConfigurationAggregatorsError::InvalidNextTokenException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidParameterValueException" => {
            super::super::operation::describe_configuration_aggregators::DescribeConfigurationAggregatorsError::InvalidParameterValueException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
pub(crate) fn de_describe_configuration_aggregators(
    _value: &[u8],
    mut builder: super::super::operation::describe_configuration_aggregators::builders::DescribeConfigurationAggregatorsOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::describe_configuration_aggregators::builders::DescribeConfigurationAggregatorsOutputBuilder,
