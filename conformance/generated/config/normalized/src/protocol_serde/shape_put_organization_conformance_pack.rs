...
> {
    ...
    let mut generic_builder = super::super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::super::operation::put_organization_conformance_pack::PutOrganizationConformancePackError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::put_organization_conformance_pack::PutOrganizationConformancePackError::unhandled(generic)),
    };
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::put_organization_conformance_pack::builders::PutOrganizationConformancePackOutputBuilder::default();
        output = super::super::protocol_serde::shape_put_organization_conformance_pack::de_put_organization_conformance_pack(_response_body, output)
            .map_err(super::super::operation::put_organization_conformance_pack::PutOrganizationConformancePackError::unhandled)?;
...
pub(crate) fn de_put_organization_conformance_pack(
    _value: &[u8],
    mut builder: super::super::operation::put_organization_conformance_pack::builders::PutOrganizationConformancePackOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::put_organization_conformance_pack::builders::PutOrganizationConformancePackOutputBuilder,
