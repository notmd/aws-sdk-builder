...
pub(crate) fn de_invalid_configuration_recorder_name_exception_json_err(
    _value: &[u8],
    mut builder: super::super::types::error::builders::InvalidConfigurationRecorderNameExceptionBuilder,
) -> ::std::result::Result<
    super::super::types::error::builders::InvalidConfigurationRecorderNameExceptionBuilder,
