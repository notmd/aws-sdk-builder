...
pub(crate) fn de_max_number_of_organization_conformance_packs_exceeded_exception_json_err(
    _value: &[u8],
    mut builder: super::super::types::error::builders::MaxNumberOfOrganizationConformancePacksExceededExceptionBuilder,
) -> ::std::result::Result<
    super::super::types::error::builders::MaxNumberOfOrganizationConformancePacksExceededExceptionBuilder,
