...
> {
    ...
    let mut generic_builder = super::super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::super::operation::put_retention_configuration::PutRetentionConfigurationError::unhandled)?;
    ...
    Err(match error_code {
        "InvalidParameterValueException" => {
            super::super::operation::put_retention_configuration::PutRetentionConfigurationError::InvalidParameterValueException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::put_retention_configuration::builders::PutRetentionConfigurationOutputBuilder::default();
        output = super::super::protocol_serde::shape_put_retention_configuration::de_put_retention_configuration(_response_body, output)
            .map_err(super::super::operation::put_retention_configuration::PutRetentionConfigurationError::unhandled)?;
...
pub fn ser_put_retention_configuration_input(
    ...
    super::super::protocol_serde::shape_put_retention_configuration_input::ser_put_retention_configuration_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_put_retention_configuration(
    _value: &[u8],
    mut builder: super::super::operation::put_retention_configuration::builders::PutRetentionConfigurationOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::put_retention_configuration::builders::PutRetentionConfigurationOutputBuilder,
