...
pub(crate) fn de_invalid_recording_group_exception_json_err(
    _value: &[u8],
    mut builder: super::super::types::error::builders::InvalidRecordingGroupExceptionBuilder,
) -> ::std::result::Result<
    super::super::types::error::builders::InvalidRecordingGroupExceptionBuilder,
