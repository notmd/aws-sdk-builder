...
> {
    ...
    Err(match error_code {
        "InvalidLimitException" => super::super::operation::describe_conformance_packs::DescribeConformancePacksError::InvalidLimitException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NoSuchConformancePackException" => {
            super::super::operation::describe_conformance_packs::DescribeConformancePacksError::NoSuchConformancePackException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        _ => super::super::operation::describe_conformance_packs::DescribeConformancePacksError::generic(generic),
    })
}
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::describe_conformance_packs::builders::DescribeConformancePacksOutputBuilder::default();
        output = super::super::protocol_serde::shape_describe_conformance_packs::de_describe_conformance_packs(_response_body, output)
            .map_err(super::super::operation::describe_conformance_packs::DescribeConformancePacksError::unhandled)?;
...
pub fn ser_describe_conformance_packs_input(
    ...
    super::super::protocol_serde::shape_describe_conformance_packs_input::ser_describe_conformance_packs_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_describe_conformance_packs(
    _value: &[u8],
    mut builder: super::super::operation::describe_conformance_packs::builders::DescribeConformancePacksOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::describe_conformance_packs::builders::DescribeConformancePacksOutputBuilder,
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ConformancePackDetails" => {
                    builder = builder.set_conformance_pack_details(
                        super::super::protocol_serde::shape_conformance_pack_detail_list::de_conformance_pack_detail_list(tokens, _value, depth + 1)?,
                    );
                }
                "NextToken" => {
