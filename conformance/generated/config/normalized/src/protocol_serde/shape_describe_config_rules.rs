...
> {
    ...
    Err(match error_code {
        "InvalidNextTokenException" => super::super::operation::describe_config_rules::DescribeConfigRulesError::InvalidNextTokenException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::super::operation::describe_config_rules::DescribeConfigRulesError::generic(generic),
    })
}
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::describe_config_rules::builders::DescribeConfigRulesOutputBuilder::default();
        output = super::super::protocol_serde::shape_describe_config_rules::de_describe_config_rules(_response_body, output)
            .map_err(super::super::operation::describe_config_rules::DescribeConfigRulesError::unhandled)?;
...
pub fn ser_describe_config_rules_input(
    ...
    super::super::protocol_serde::shape_describe_config_rules_input::ser_describe_config_rules_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_describe_config_rules(
    _value: &[u8],
    mut builder: super::super::operation::describe_config_rules::builders::DescribeConfigRulesOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::describe_config_rules::builders::DescribeConfigRulesOutputBuilder,
