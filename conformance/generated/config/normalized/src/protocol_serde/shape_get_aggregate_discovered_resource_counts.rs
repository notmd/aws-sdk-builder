...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output =
            super::super::operation::get_aggregate_discovered_resource_counts::builders::GetAggregateDiscoveredResourceCountsOutputBuilder::default();
        output = super::super::protocol_serde::shape_get_aggregate_discovered_resource_counts::de_get_aggregate_discovered_resource_counts(
            _response_body,
            output,
        )
        .map_err(super::super::operation::get_aggregate_discovered_resource_counts::GetAggregateDiscoveredResourceCountsError::unhandled)?;
...
pub fn ser_get_aggregate_discovered_resource_counts_input(
    ...
    super::super::protocol_serde::shape_get_aggregate_discovered_resource_counts_input::ser_get_aggregate_discovered_resource_counts_input_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub(crate) fn de_get_aggregate_discovered_resource_counts(
    _value: &[u8],
    mut builder: super::super::operation::get_aggregate_discovered_resource_counts::builders::GetAggregateDiscoveredResourceCountsOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::get_aggregate_discovered_resource_counts::builders::GetAggregateDiscoveredResourceCountsOutputBuilder,
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "GroupedResourceCounts" => {
                    builder = builder.set_grouped_resource_counts(
                        super::super::protocol_serde::shape_grouped_resource_count_list::de_grouped_resource_count_list(tokens, _value, depth + 1)?,
                    );
                }
                "NextToken" => {
