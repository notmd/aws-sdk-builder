...
> {
    ...
    Err(match error_code {
        "InvalidNextTokenException" => {
            super::super::operation::describe_config_rule_evaluation_status::DescribeConfigRuleEvaluationStatusError::InvalidNextTokenException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        _ => super::super::operation::describe_config_rule_evaluation_status::DescribeConfigRuleEvaluationStatusError::generic(generic),
    })
}
...
pub fn ser_describe_config_rule_evaluation_status_input(
    ...
    super::super::protocol_serde::shape_describe_config_rule_evaluation_status_input::ser_describe_config_rule_evaluation_status_input_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub(crate) fn de_describe_config_rule_evaluation_status(
    _value: &[u8],
    mut builder: super::super::operation::describe_config_rule_evaluation_status::builders::DescribeConfigRuleEvaluationStatusOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::describe_config_rule_evaluation_status::builders::DescribeConfigRuleEvaluationStatusOutputBuilder,
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ConfigRulesEvaluationStatus" => {
                    builder = builder.set_config_rules_evaluation_status(
                        super::super::protocol_serde::shape_config_rule_evaluation_status_list::de_config_rule_evaluation_status_list(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
