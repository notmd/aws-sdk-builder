...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::describe_organization_config_rules::DescribeOrganizationConfigRulesError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InvalidLimitException" => {
            super::super::operation::describe_organization_config_rules::DescribeOrganizationConfigRulesError::InvalidLimitException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidNextTokenException" => {
            super::super::operation::describe_organization_config_rules::DescribeOrganizationConfigRulesError::InvalidNextTokenException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        _ => super::super::operation::describe_organization_config_rules::DescribeOrganizationConfigRulesError::generic(generic),
    })
}
...
pub(crate) fn de_describe_organization_config_rules(
    _value: &[u8],
    mut builder: super::super::operation::describe_organization_config_rules::builders::DescribeOrganizationConfigRulesOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::describe_organization_config_rules::builders::DescribeOrganizationConfigRulesOutputBuilder,
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "OrganizationConfigRules" => {
                    builder = builder.set_organization_config_rules(
                        super::super::protocol_serde::shape_organization_config_rules::de_organization_config_rules(tokens, _value, depth + 1)?,
                    );
                }
                "NextToken" => {
