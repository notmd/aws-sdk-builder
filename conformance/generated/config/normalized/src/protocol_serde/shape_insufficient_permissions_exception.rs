...
pub(crate) fn de_insufficient_permissions_exception_json_err(
    _value: &[u8],
    mut builder: super::super::types::error::builders::InsufficientPermissionsExceptionBuilder,
) -> ::std::result::Result<
    super::super::types::error::builders::InsufficientPermissionsExceptionBuilder,
