...
> {
    ...
    Err(match error_code {
        "InvalidNextTokenException" => super::super::operation::list_resource_evaluations::ListResourceEvaluationsError::InvalidNextTokenException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidParameterValueException" => {
            super::super::operation::list_resource_evaluations::ListResourceEvaluationsError::InvalidParameterValueException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidTimeRangeException" => super::super::operation::list_resource_evaluations::ListResourceEvaluationsError::InvalidTimeRangeException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::super::operation::list_resource_evaluations::ListResourceEvaluationsError::generic(generic),
    })
}
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_resource_evaluations::builders::ListResourceEvaluationsOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_resource_evaluations::de_list_resource_evaluations(_response_body, output)
            .map_err(super::super::operation::list_resource_evaluations::ListResourceEvaluationsError::unhandled)?;
...
pub fn ser_list_resource_evaluations_input(
    ...
    super::super::protocol_serde::shape_list_resource_evaluations_input::ser_list_resource_evaluations_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_list_resource_evaluations(
    _value: &[u8],
    mut builder: super::super::operation::list_resource_evaluations::builders::ListResourceEvaluationsOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::list_resource_evaluations::builders::ListResourceEvaluationsOutputBuilder,
