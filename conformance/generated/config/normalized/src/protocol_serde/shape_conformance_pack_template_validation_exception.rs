...
pub(crate) fn de_conformance_pack_template_validation_exception_json_err(
    _value: &[u8],
    mut builder: super::super::types::error::builders::ConformancePackTemplateValidationExceptionBuilder,
) -> ::std::result::Result<
    super::super::types::error::builders::ConformancePackTemplateValidationExceptionBuilder,
