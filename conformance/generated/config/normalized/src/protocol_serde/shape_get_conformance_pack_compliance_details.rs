...
pub fn ser_get_conformance_pack_compliance_details_input(
    ...
    super::super::protocol_serde::shape_get_conformance_pack_compliance_details_input::ser_get_conformance_pack_compliance_details_input_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub(crate) fn de_get_conformance_pack_compliance_details(
    _value: &[u8],
    mut builder: super::super::operation::get_conformance_pack_compliance_details::builders::GetConformancePackComplianceDetailsOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::get_conformance_pack_compliance_details::builders::GetConformancePackComplianceDetailsOutputBuilder,
