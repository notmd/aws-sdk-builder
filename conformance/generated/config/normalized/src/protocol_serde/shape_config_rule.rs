...
pub fn ser_config_rule(
    ...
    input: &super::super::types::ConfigRule,
    ...
    if let Some(var_5) = &input.scope {
        ...
        super::super::protocol_serde::shape_scope::ser_scope(&mut object_6, var_5)?;
        object_6.finish();
    }
    if let Some(var_7) = &input.source {
        #[allow(unused_mut)]
        let mut object_8 = object.key("Source").start_object();
        super::super::protocol_serde::shape_source::ser_source(&mut object_8, var_7)?;
        object_8.finish();
    }
        ...
        for item_15 in var_13 {
            {
                ...
                super::super::protocol_serde::shape_evaluation_mode_configuration::ser_evaluation_mode_configuration(&mut object_16, item_15)?;
                object_16.finish();
            }
        }
        array_14.finish();
...
pub(crate) fn de_config_rule<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::super::types::ConfigRule>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::super::types::builders::ConfigRuleBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Scope" => {
                            builder = builder.set_scope(super::super::protocol_serde::shape_scope::de_scope(tokens, _value, depth + 1)?);
                        }
                        "Source" => {
                            builder = builder.set_source(super::super::protocol_serde::shape_source::de_source(tokens, _value, depth + 1)?);
                        }
                        "InputParameters" => {
                        ...
                        "MaximumExecutionFrequency" => {
                            builder = builder.set_maximum_execution_frequency(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| super::super::types::MaximumExecutionFrequency::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "ConfigRuleState" => {
                            builder = builder.set_config_rule_state(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| super::super::types::ConfigRuleState::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "CreatedBy" => {
                        ...
                        "EvaluationModes" => {
                            builder = builder.set_evaluation_modes(super::super::protocol_serde::shape_evaluation_modes::de_evaluation_modes(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "RuleEvaluationVisibility" => {
                            builder = builder.set_rule_evaluation_visibility(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| super::super::types::RuleEvaluationVisibility::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
            ...
            Ok(Some(super::super::serde_util::config_rule_correct_errors(builder).build()))
        }
