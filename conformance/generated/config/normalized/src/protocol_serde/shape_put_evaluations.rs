...
) -> std::result::Result<super::super::operation::put_evaluations::PutEvaluationsOutput, super::super::operation::put_evaluations::PutEvaluationsError>
{
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::put_evaluations::PutEvaluationsError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InvalidParameterValueException" => super::super::operation::put_evaluations::PutEvaluationsError::InvalidParameterValueException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidResultTokenException" => super::super::operation::put_evaluations::PutEvaluationsError::InvalidResultTokenException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NoSuchConfigRuleException" => super::super::operation::put_evaluations::PutEvaluationsError::NoSuchConfigRuleException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::super::operation::put_evaluations::PutEvaluationsError::generic(generic),
    })
}
...
) -> std::result::Result<super::super::operation::put_evaluations::PutEvaluationsOutput, super::super::operation::put_evaluations::PutEvaluationsError>
{
    Ok({
        ...
        output = super::super::protocol_serde::shape_put_evaluations::de_put_evaluations(_response_body, output)
            .map_err(super::super::operation::put_evaluations::PutEvaluationsError::unhandled)?;
...
pub fn ser_put_evaluations_input(
    ...
    super::super::protocol_serde::shape_put_evaluations_input::ser_put_evaluations_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_put_evaluations(
    _value: &[u8],
    mut builder: super::super::operation::put_evaluations::builders::PutEvaluationsOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::put_evaluations::builders::PutEvaluationsOutputBuilder,
