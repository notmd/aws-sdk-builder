...
> {
    ...
    Err(match error_code {
        "InvalidNextTokenException" => {
            super::super::operation::get_compliance_details_by_config_rule::GetComplianceDetailsByConfigRuleError::InvalidNextTokenException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidParameterValueException" => {
            super::super::operation::get_compliance_details_by_config_rule::GetComplianceDetailsByConfigRuleError::InvalidParameterValueException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NoSuchConfigRuleException" => {
            super::super::operation::get_compliance_details_by_config_rule::GetComplianceDetailsByConfigRuleError::NoSuchConfigRuleException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        _ => super::super::operation::get_compliance_details_by_config_rule::GetComplianceDetailsByConfigRuleError::generic(generic),
    })
}
...
pub fn ser_get_compliance_details_by_config_rule_input(
    ...
    super::super::protocol_serde::shape_get_compliance_details_by_config_rule_input::ser_get_compliance_details_by_config_rule_input_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub(crate) fn de_get_compliance_details_by_config_rule(
    _value: &[u8],
    mut builder: super::super::operation::get_compliance_details_by_config_rule::builders::GetComplianceDetailsByConfigRuleOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::get_compliance_details_by_config_rule::builders::GetComplianceDetailsByConfigRuleOutputBuilder,
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "EvaluationResults" => {
                    builder = builder.set_evaluation_results(super::super::protocol_serde::shape_evaluation_results::de_evaluation_results(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
