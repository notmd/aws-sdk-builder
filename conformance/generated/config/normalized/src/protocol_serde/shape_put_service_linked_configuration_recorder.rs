...
> {
    ...
    let mut generic_builder = super::super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::super::operation::put_service_linked_configuration_recorder::PutServiceLinkedConfigurationRecorderError::unhandled)?;
...
pub fn ser_put_service_linked_configuration_recorder_input(
    ...
    super::super::protocol_serde::shape_put_service_linked_configuration_recorder_input::ser_put_service_linked_configuration_recorder_input_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub(crate) fn de_put_service_linked_configuration_recorder(
    _value: &[u8],
    mut builder: super::super::operation::put_service_linked_configuration_recorder::builders::PutServiceLinkedConfigurationRecorderOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::put_service_linked_configuration_recorder::builders::PutServiceLinkedConfigurationRecorderOutputBuilder,
