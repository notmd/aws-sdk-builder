...
pub(crate) fn de_organization_access_denied_exception_json_err(
    _value: &[u8],
    mut builder: super::super::types::error::builders::OrganizationAccessDeniedExceptionBuilder,
) -> ::std::result::Result<
    super::super::types::error::builders::OrganizationAccessDeniedExceptionBuilder,
