...
pub(crate) fn de_conformance_pack_evaluation_result<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::super::types::ConformancePackEvaluationResult>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::super::types::builders::ConformancePackEvaluationResultBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "EvaluationResultIdentifier" => {
                            builder = builder.set_evaluation_result_identifier(
                                super::super::protocol_serde::shape_evaluation_result_identifier::de_evaluation_result_identifier(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
            ...
            Ok(Some(
                super::super::serde_util::conformance_pack_evaluation_result_correct_errors(builder)
                    .build()
