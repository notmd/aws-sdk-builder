...
pub(crate) fn de_organization_all_features_not_enabled_exception_json_err(
    _value: &[u8],
    mut builder: super::super::types::error::builders::OrganizationAllFeaturesNotEnabledExceptionBuilder,
) -> ::std::result::Result<
    super::super::types::error::builders::OrganizationAllFeaturesNotEnabledExceptionBuilder,
