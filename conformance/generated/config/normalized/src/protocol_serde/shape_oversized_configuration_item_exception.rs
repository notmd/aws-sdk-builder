...
pub(crate) fn de_oversized_configuration_item_exception_json_err(
    _value: &[u8],
    mut builder: super::super::types::error::builders::OversizedConfigurationItemExceptionBuilder,
) -> ::std::result::Result<
    super::super::types::error::builders::OversizedConfigurationItemExceptionBuilder,
