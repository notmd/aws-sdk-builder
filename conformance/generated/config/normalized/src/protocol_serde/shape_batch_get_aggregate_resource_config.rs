...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::batch_get_aggregate_resource_config::BatchGetAggregateResourceConfigError::unhandled(generic)),
    };
...
pub(crate) fn de_batch_get_aggregate_resource_config(
    _value: &[u8],
    mut builder: super::super::operation::batch_get_aggregate_resource_config::builders::BatchGetAggregateResourceConfigOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::batch_get_aggregate_resource_config::builders::BatchGetAggregateResourceConfigOutputBuilder,
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "UnprocessedResourceIdentifiers" => {
                    builder = builder.set_unprocessed_resource_identifiers(
                        super::super::protocol_serde::shape_unprocessed_resource_identifier_list::de_unprocessed_resource_identifier_list(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
