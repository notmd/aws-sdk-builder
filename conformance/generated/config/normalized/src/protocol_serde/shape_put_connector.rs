...
pub fn de_put_connector_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::put_connector::PutConnectorOutput, super::super::operation::put_connector::PutConnectorError> {
    #[allow(unused_mut)]
    let mut generic_builder = super::super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::super::operation::put_connector::PutConnectorError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::put_connector::PutConnectorError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "ConflictException" => super::super::operation::put_connector::PutConnectorError::ConflictException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InsufficientPermissionsException" => super::super::operation::put_connector::PutConnectorError::InsufficientPermissionsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::super::operation::put_connector::PutConnectorError::generic(generic),
    })
}
...
pub fn de_put_connector_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::put_connector::builders::PutConnectorOutputBuilder::default();
        output = super::super::protocol_serde::shape_put_connector::de_put_connector(_response_body, output)
            .map_err(super::super::operation::put_connector::PutConnectorError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::super::serde_util::put_connector_output_output_correct_errors(output)
            .build()
            .map_err(super::super::operation::put_connector::PutConnectorError::unhandled)?
    })
}
...
pub fn ser_put_connector_input(
    ...
    super::super::protocol_serde::shape_put_connector_input::ser_put_connector_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_put_connector(
    _value: &[u8],
    mut builder: super::super::operation::put_connector::builders::PutConnectorOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::put_connector::builders::PutConnectorOutputBuilder,
