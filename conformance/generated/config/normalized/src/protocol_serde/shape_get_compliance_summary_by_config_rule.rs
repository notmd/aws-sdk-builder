...
> {
    ...
    Err(super::super::operation::get_compliance_summary_by_config_rule::GetComplianceSummaryByConfigRuleError::generic(generic))
}
...
pub(crate) fn de_get_compliance_summary_by_config_rule(
    ...
    super::super::operation::get_compliance_summary_by_config_rule::builders::GetComplianceSummaryByConfigRuleOutputBuilder,
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ComplianceSummary" => {
                    builder = builder.set_compliance_summary(super::super::protocol_serde::shape_compliance_summary::de_compliance_summary(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
