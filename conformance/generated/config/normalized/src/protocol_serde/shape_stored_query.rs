...
pub(crate) fn de_stored_query<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::super::types::StoredQuery>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::super::types::builders::StoredQueryBuilder::default();
            loop {
                match tokens.next().transpose()? {
            ...
            Ok(Some(super::super::serde_util::stored_query_correct_errors(builder).build().map_err(|err| {
