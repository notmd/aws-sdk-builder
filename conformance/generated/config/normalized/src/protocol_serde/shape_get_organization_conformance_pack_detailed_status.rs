...
pub fn ser_get_organization_conformance_pack_detailed_status_input(
    ...
    super::super::protocol_serde::shape_get_organization_conformance_pack_detailed_status_input::ser_get_organization_conformance_pack_detailed_status_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_get_organization_conformance_pack_detailed_status(
    _value: &[u8],
    mut builder: super::super::operation::get_organization_conformance_pack_detailed_status::builders::GetOrganizationConformancePackDetailedStatusOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::get_organization_conformance_pack_detailed_status::builders::GetOrganizationConformancePackDetailedStatusOutputBuilder,
