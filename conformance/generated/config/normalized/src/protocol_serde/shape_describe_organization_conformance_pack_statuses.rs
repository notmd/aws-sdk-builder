...
> {
    ...
    let mut generic_builder = super::super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::super::operation::describe_organization_conformance_pack_statuses::DescribeOrganizationConformancePackStatusesError::unhandled)?;
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                super::super::operation::describe_organization_conformance_pack_statuses::DescribeOrganizationConformancePackStatusesError::unhandled(
                    generic,
                ),
            )
        }
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::describe_organization_conformance_pack_statuses::builders::DescribeOrganizationConformancePackStatusesOutputBuilder::default();
        output = super::super::protocol_serde::shape_describe_organization_conformance_pack_statuses::de_describe_organization_conformance_pack_statuses(
            _response_body,
            output,
        )
        .map_err(super::super::operation::describe_organization_conformance_pack_statuses::DescribeOrganizationConformancePackStatusesError::unhandled)?;
...
pub fn ser_describe_organization_conformance_pack_statuses_input(
    ...
    super::super::protocol_serde::shape_describe_organization_conformance_pack_statuses_input::ser_describe_organization_conformance_pack_statuses_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_describe_organization_conformance_pack_statuses(
    _value: &[u8],
    mut builder: super::super::operation::describe_organization_conformance_pack_statuses::builders::DescribeOrganizationConformancePackStatusesOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::describe_organization_conformance_pack_statuses::builders::DescribeOrganizationConformancePackStatusesOutputBuilder,
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "OrganizationConformancePackStatuses" => {
                    builder = builder.set_organization_conformance_pack_statuses(
                        super::super::protocol_serde::shape_organization_conformance_pack_statuses::de_organization_conformance_pack_statuses(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
