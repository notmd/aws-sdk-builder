...
> {
    ...
    Err(match error_code {
        ...
        _ => super::super::operation::start_resource_evaluation::StartResourceEvaluationError::generic(generic),
    })
}
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::start_resource_evaluation::builders::StartResourceEvaluationOutputBuilder::default();
        output = super::super::protocol_serde::shape_start_resource_evaluation::de_start_resource_evaluation(_response_body, output)
            .map_err(super::super::operation::start_resource_evaluation::StartResourceEvaluationError::unhandled)?;
...
pub fn ser_start_resource_evaluation_input(
    ...
    super::super::protocol_serde::shape_start_resource_evaluation_input::ser_start_resource_evaluation_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_start_resource_evaluation(
    _value: &[u8],
    mut builder: super::super::operation::start_resource_evaluation::builders::StartResourceEvaluationOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::start_resource_evaluation::builders::StartResourceEvaluationOutputBuilder,
