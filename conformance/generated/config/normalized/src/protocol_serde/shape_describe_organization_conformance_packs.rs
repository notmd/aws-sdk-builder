...
pub fn ser_describe_organization_conformance_packs_input(
    ...
    super::super::protocol_serde::shape_describe_organization_conformance_packs_input::ser_describe_organization_conformance_packs_input_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub(crate) fn de_describe_organization_conformance_packs(
    _value: &[u8],
    mut builder: super::super::operation::describe_organization_conformance_packs::builders::DescribeOrganizationConformancePacksOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::describe_organization_conformance_packs::builders::DescribeOrganizationConformancePacksOutputBuilder,
