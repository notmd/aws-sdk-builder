...
> {
    ...
    Err(super::super::operation::describe_remediation_configurations::DescribeRemediationConfigurationsError::generic(generic))
}
...
pub(crate) fn de_describe_remediation_configurations(
    _value: &[u8],
    mut builder: super::super::operation::describe_remediation_configurations::builders::DescribeRemediationConfigurationsOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::describe_remediation_configurations::builders::DescribeRemediationConfigurationsOutputBuilder,
