...
pub(crate) fn de_invalid_delivery_channel_name_exception_json_err(
    _value: &[u8],
    mut builder: super::super::types::error::builders::InvalidDeliveryChannelNameExceptionBuilder,
) -> ::std::result::Result<
    super::super::types::error::builders::InvalidDeliveryChannelNameExceptionBuilder,
