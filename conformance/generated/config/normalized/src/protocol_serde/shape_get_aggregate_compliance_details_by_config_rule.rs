...
> {
    ...
    let mut generic_builder = super::super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::super::operation::get_aggregate_compliance_details_by_config_rule::GetAggregateComplianceDetailsByConfigRuleError::unhandled)?;
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                super::super::operation::get_aggregate_compliance_details_by_config_rule::GetAggregateComplianceDetailsByConfigRuleError::unhandled(generic),
            )
        }
    };
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::get_aggregate_compliance_details_by_config_rule::builders::GetAggregateComplianceDetailsByConfigRuleOutputBuilder::default();
        output = super::super::protocol_serde::shape_get_aggregate_compliance_details_by_config_rule::de_get_aggregate_compliance_details_by_config_rule(
            _response_body,
            output,
        )
        .map_err(super::super::operation::get_aggregate_compliance_details_by_config_rule::GetAggregateComplianceDetailsByConfigRuleError::unhandled)?;
...
pub fn ser_get_aggregate_compliance_details_by_config_rule_input(
    ...
    super::super::protocol_serde::shape_get_aggregate_compliance_details_by_config_rule_input::ser_get_aggregate_compliance_details_by_config_rule_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_get_aggregate_compliance_details_by_config_rule(
    _value: &[u8],
    mut builder: super::super::operation::get_aggregate_compliance_details_by_config_rule::builders::GetAggregateComplianceDetailsByConfigRuleOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::get_aggregate_compliance_details_by_config_rule::builders::GetAggregateComplianceDetailsByConfigRuleOutputBuilder,
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "AggregateEvaluationResults" => {
                    builder = builder.set_aggregate_evaluation_results(
                        super::super::protocol_serde::shape_aggregate_evaluation_result_list::de_aggregate_evaluation_result_list(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
