...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::get_organization_custom_rule_policy::GetOrganizationCustomRulePolicyError::unhandled(generic)),
    };
    ...
    Err(match error_code {
        ...
        _ => super::super::operation::get_organization_custom_rule_policy::GetOrganizationCustomRulePolicyError::generic(generic),
    })
}
...
pub(crate) fn de_get_organization_custom_rule_policy(
    _value: &[u8],
    mut builder: super::super::operation::get_organization_custom_rule_policy::builders::GetOrganizationCustomRulePolicyOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::get_organization_custom_rule_policy::builders::GetOrganizationCustomRulePolicyOutputBuilder,
