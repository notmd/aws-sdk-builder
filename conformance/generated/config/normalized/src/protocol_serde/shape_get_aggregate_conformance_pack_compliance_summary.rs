...
pub fn ser_get_aggregate_conformance_pack_compliance_summary_input(
    ...
    super::super::protocol_serde::shape_get_aggregate_conformance_pack_compliance_summary_input::ser_get_aggregate_conformance_pack_compliance_summary_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_get_aggregate_conformance_pack_compliance_summary(
    _value: &[u8],
    mut builder: super::super::operation::get_aggregate_conformance_pack_compliance_summary::builders::GetAggregateConformancePackComplianceSummaryOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::get_aggregate_conformance_pack_compliance_summary::builders::GetAggregateConformancePackComplianceSummaryOutputBuilder,
