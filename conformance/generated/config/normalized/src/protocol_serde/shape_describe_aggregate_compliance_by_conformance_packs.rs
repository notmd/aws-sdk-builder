...
pub fn ser_describe_aggregate_compliance_by_conformance_packs_input(
    ...
    super::super::protocol_serde::shape_describe_aggregate_compliance_by_conformance_packs_input::ser_describe_aggregate_compliance_by_conformance_packs_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_describe_aggregate_compliance_by_conformance_packs(
    _value: &[u8],
    mut builder: super::super::operation::describe_aggregate_compliance_by_conformance_packs::builders::DescribeAggregateComplianceByConformancePacksOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::describe_aggregate_compliance_by_conformance_packs::builders::DescribeAggregateComplianceByConformancePacksOutputBuilder,
