...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::start_config_rules_evaluation::StartConfigRulesEvaluationError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InvalidParameterValueException" => {
            super::super::operation::start_config_rules_evaluation::StartConfigRulesEvaluationError::InvalidParameterValueException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::start_config_rules_evaluation::builders::StartConfigRulesEvaluationOutputBuilder::default();
...
pub fn ser_start_config_rules_evaluation_input(
    ...
    super::super::protocol_serde::shape_start_config_rules_evaluation_input::ser_start_config_rules_evaluation_input_input(&mut object, input)?;
    object.finish();
