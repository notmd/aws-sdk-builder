...
pub fn ser_describe_configuration_recorder_status_input(
    ...
    super::super::protocol_serde::shape_describe_configuration_recorder_status_input::ser_describe_configuration_recorder_status_input_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub(crate) fn de_describe_configuration_recorder_status(
    _value: &[u8],
    mut builder: super::super::operation::describe_configuration_recorder_status::builders::DescribeConfigurationRecorderStatusOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::describe_configuration_recorder_status::builders::DescribeConfigurationRecorderStatusOutputBuilder,
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ConfigurationRecordersStatus" => {
                    builder = builder.set_configuration_recorders_status(
                        super::super::protocol_serde::shape_configuration_recorder_status_list::de_configuration_recorder_status_list(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
