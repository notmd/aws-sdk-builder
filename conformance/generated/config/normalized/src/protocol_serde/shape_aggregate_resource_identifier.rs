...
pub fn ser_aggregate_resource_identifier(
    ...
    input: &super::super::types::AggregateResourceIdentifier,
...
pub(crate) fn de_aggregate_resource_identifier<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::super::types::AggregateResourceIdentifier>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::super::types::builders::AggregateResourceIdentifierBuilder::default();
            loop {
                match tokens.next().transpose()? {
            ...
            Ok(Some(
                super::super::serde_util::aggregate_resource_identifier_correct_errors(builder)
                    .build()
