...
pub fn ser_describe_configuration_aggregator_sources_status_input(
    ...
    super::super::protocol_serde::shape_describe_configuration_aggregator_sources_status_input::ser_describe_configuration_aggregator_sources_status_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_describe_configuration_aggregator_sources_status(
    _value: &[u8],
    mut builder: super::super::operation::describe_configuration_aggregator_sources_status::builders::DescribeConfigurationAggregatorSourcesStatusOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::describe_configuration_aggregator_sources_status::builders::DescribeConfigurationAggregatorSourcesStatusOutputBuilder,
