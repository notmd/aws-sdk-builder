...
pub(crate) fn de_delete_service_linked_configuration_recorder(
    _value: &[u8],
    mut builder: super::super::operation::delete_service_linked_configuration_recorder::builders::DeleteServiceLinkedConfigurationRecorderOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::delete_service_linked_configuration_recorder::builders::DeleteServiceLinkedConfigurationRecorderOutputBuilder,
