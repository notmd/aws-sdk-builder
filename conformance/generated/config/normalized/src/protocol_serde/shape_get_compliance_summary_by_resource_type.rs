...
pub fn ser_get_compliance_summary_by_resource_type_input(
    ...
    super::super::protocol_serde::shape_get_compliance_summary_by_resource_type_input::ser_get_compliance_summary_by_resource_type_input_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub(crate) fn de_get_compliance_summary_by_resource_type(
    _value: &[u8],
    mut builder: super::super::operation::get_compliance_summary_by_resource_type::builders::GetComplianceSummaryByResourceTypeOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::get_compliance_summary_by_resource_type::builders::GetComplianceSummaryByResourceTypeOutputBuilder,
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ComplianceSummariesByResourceType" => {
                    builder = builder.set_compliance_summaries_by_resource_type(
                        super::super::protocol_serde::shape_compliance_summaries_by_resource_type::de_compliance_summaries_by_resource_type(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
