...
> {
    ...
    Err(match error_code {
        "InvalidLimitException" => {
            super::super::operation::list_conformance_pack_compliance_scores::ListConformancePackComplianceScoresError::InvalidLimitException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidNextTokenException" => {
            super::super::operation::list_conformance_pack_compliance_scores::ListConformancePackComplianceScoresError::InvalidNextTokenException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
pub fn ser_list_conformance_pack_compliance_scores_input(
    ...
    super::super::protocol_serde::shape_list_conformance_pack_compliance_scores_input::ser_list_conformance_pack_compliance_scores_input_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub(crate) fn de_list_conformance_pack_compliance_scores(
    _value: &[u8],
    mut builder: super::super::operation::list_conformance_pack_compliance_scores::builders::ListConformancePackComplianceScoresOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::list_conformance_pack_compliance_scores::builders::ListConformancePackComplianceScoresOutputBuilder,
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "ConformancePackComplianceScores" => {
                    builder = builder.set_conformance_pack_compliance_scores(
                        super::super::protocol_serde::shape_conformance_pack_compliance_scores::de_conformance_pack_compliance_scores(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
