...
impl super::Client {
    ...
    pub fn put_external_evaluation(&self) -> super::super::operation::put_external_evaluation::builders::PutExternalEvaluationFluentBuilder {
        super::super::operation::put_external_evaluation::builders::PutExternalEvaluationFluentBuilder::new(self.handle.clone())
    }
}
