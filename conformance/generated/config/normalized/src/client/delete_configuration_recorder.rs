...
impl super::Client {
    ...
    pub fn delete_configuration_recorder(
        &self,
    ) -> super::super::operation::delete_configuration_recorder::builders::DeleteConfigurationRecorderFluentBuilder {
        super::super::operation::delete_configuration_recorder::builders::DeleteConfigurationRecorderFluentBuilder::new(self.handle.clone())
    }
}
