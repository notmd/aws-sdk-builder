...
impl super::Client {
    ...
    pub fn get_connector(&self) -> super::super::operation::get_connector::builders::GetConnectorFluentBuilder {
        super::super::operation::get_connector::builders::GetConnectorFluentBuilder::new(self.handle.clone())
    }
}
