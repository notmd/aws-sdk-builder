...
impl super::Client {
    ...
    pub fn delete_evaluation_results(&self) -> super::super::operation::delete_evaluation_results::builders::DeleteEvaluationResultsFluentBuilder {
        super::super::operation::delete_evaluation_results::builders::DeleteEvaluationResultsFluentBuilder::new(self.handle.clone())
    }
}
