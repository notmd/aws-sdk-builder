...
impl super::Client {
    ...
    pub fn delete_retention_configuration(
        &self,
    ) -> super::super::operation::delete_retention_configuration::builders::DeleteRetentionConfigurationFluentBuilder {
        super::super::operation::delete_retention_configuration::builders::DeleteRetentionConfigurationFluentBuilder::new(self.handle.clone())
    }
}
