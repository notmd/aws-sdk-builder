...
impl super::Client {
    ...
    pub fn describe_delivery_channel_status(
        &self,
    ) -> super::super::operation::describe_delivery_channel_status::builders::DescribeDeliveryChannelStatusFluentBuilder {
        super::super::operation::describe_delivery_channel_status::builders::DescribeDeliveryChannelStatusFluentBuilder::new(self.handle.clone())
    }
}
