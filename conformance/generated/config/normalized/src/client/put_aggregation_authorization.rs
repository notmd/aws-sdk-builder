...
impl super::Client {
    ...
    pub fn put_aggregation_authorization(
        &self,
    ) -> super::super::operation::put_aggregation_authorization::builders::PutAggregationAuthorizationFluentBuilder {
        super::super::operation::put_aggregation_authorization::builders::PutAggregationAuthorizationFluentBuilder::new(self.handle.clone())
    }
}
