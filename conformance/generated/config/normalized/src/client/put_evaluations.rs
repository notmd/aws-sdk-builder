...
impl super::Client {
    ...
    pub fn put_evaluations(&self) -> super::super::operation::put_evaluations::builders::PutEvaluationsFluentBuilder {
        super::super::operation::put_evaluations::builders::PutEvaluationsFluentBuilder::new(self.handle.clone())
    }
}
