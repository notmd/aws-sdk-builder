...
impl super::Client {
    ...
    pub fn describe_remediation_exceptions(
        &self,
    ) -> super::super::operation::describe_remediation_exceptions::builders::DescribeRemediationExceptionsFluentBuilder {
        super::super::operation::describe_remediation_exceptions::builders::DescribeRemediationExceptionsFluentBuilder::new(self.handle.clone())
    }
}
