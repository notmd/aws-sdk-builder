...
impl super::Client {
    ...
    pub fn delete_delivery_channel(&self) -> super::super::operation::delete_delivery_channel::builders::DeleteDeliveryChannelFluentBuilder {
        super::super::operation::delete_delivery_channel::builders::DeleteDeliveryChannelFluentBuilder::new(self.handle.clone())
    }
}
