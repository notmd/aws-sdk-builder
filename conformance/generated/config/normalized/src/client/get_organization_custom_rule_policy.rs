...
impl super::Client {
    ...
    pub fn get_organization_custom_rule_policy(
        &self,
    ) -> super::super::operation::get_organization_custom_rule_policy::builders::GetOrganizationCustomRulePolicyFluentBuilder {
        super::super::operation::get_organization_custom_rule_policy::builders::GetOrganizationCustomRulePolicyFluentBuilder::new(self.handle.clone())
    }
}
