...
impl super::Client {
    ...
    pub fn list_connectors(&self) -> super::super::operation::list_connectors::builders::ListConnectorsFluentBuilder {
        super::super::operation::list_connectors::builders::ListConnectorsFluentBuilder::new(self.handle.clone())
    }
}
