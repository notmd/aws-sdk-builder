...
impl super::Client {
    ...
    pub fn deliver_config_snapshot(&self) -> super::super::operation::deliver_config_snapshot::builders::DeliverConfigSnapshotFluentBuilder {
        super::super::operation::deliver_config_snapshot::builders::DeliverConfigSnapshotFluentBuilder::new(self.handle.clone())
    }
}
