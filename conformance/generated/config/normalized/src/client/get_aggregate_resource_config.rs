...
impl super::Client {
    ...
    pub fn get_aggregate_resource_config(
        &self,
    ) -> super::super::operation::get_aggregate_resource_config::builders::GetAggregateResourceConfigFluentBuilder {
        super::super::operation::get_aggregate_resource_config::builders::GetAggregateResourceConfigFluentBuilder::new(self.handle.clone())
    }
}
