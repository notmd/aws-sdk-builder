...
impl super::Client {
    ...
    pub fn describe_organization_config_rule_statuses(
        &self,
    ) -> super::super::operation::describe_organization_config_rule_statuses::builders::DescribeOrganizationConfigRuleStatusesFluentBuilder {
        super::super::operation::describe_organization_config_rule_statuses::builders::DescribeOrganizationConfigRuleStatusesFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
