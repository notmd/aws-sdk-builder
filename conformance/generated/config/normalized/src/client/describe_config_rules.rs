...
impl super::Client {
    ...
    pub fn describe_config_rules(&self) -> super::super::operation::describe_config_rules::builders::DescribeConfigRulesFluentBuilder {
        super::super::operation::describe_config_rules::builders::DescribeConfigRulesFluentBuilder::new(self.handle.clone())
    }
}
