...
impl super::Client {
    ...
    pub fn batch_get_resource_config(&self) -> super::super::operation::batch_get_resource_config::builders::BatchGetResourceConfigFluentBuilder {
        super::super::operation::batch_get_resource_config::builders::BatchGetResourceConfigFluentBuilder::new(self.handle.clone())
    }
}
