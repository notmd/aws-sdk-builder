...
impl super::Client {
    ...
    pub fn put_remediation_exceptions(&self) -> super::super::operation::put_remediation_exceptions::builders::PutRemediationExceptionsFluentBuilder {
        super::super::operation::put_remediation_exceptions::builders::PutRemediationExceptionsFluentBuilder::new(self.handle.clone())
    }
}
