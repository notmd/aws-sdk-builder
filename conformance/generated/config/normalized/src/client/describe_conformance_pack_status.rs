...
impl super::Client {
    ...
    pub fn describe_conformance_pack_status(
        &self,
    ) -> super::super::operation::describe_conformance_pack_status::builders::DescribeConformancePackStatusFluentBuilder {
        super::super::operation::describe_conformance_pack_status::builders::DescribeConformancePackStatusFluentBuilder::new(self.handle.clone())
    }
}
