...
impl super::Client {
    ...
    pub fn describe_configuration_recorders(
        &self,
    ) -> super::super::operation::describe_configuration_recorders::builders::DescribeConfigurationRecordersFluentBuilder {
        super::super::operation::describe_configuration_recorders::builders::DescribeConfigurationRecordersFluentBuilder::new(self.handle.clone())
    }
}
