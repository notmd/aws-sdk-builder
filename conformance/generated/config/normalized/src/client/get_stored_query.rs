...
impl super::Client {
    ...
    ///   - [`query_name(impl Into<String>)`](crate::operation::get_stored_query::builders::GetStoredQueryFluentBuilder::query_name) / [`set_query_name(Option<String>)`](crate::operation::get_stored_query::builders::GetStoredQueryFluentBuilder::set_query_name):<br>required: **true**<br><p>The name of the query.</p><br>
    ...
    pub fn get_stored_query(&self) -> super::super::operation::get_stored_query::builders::GetStoredQueryFluentBuilder {
        super::super::operation::get_stored_query::builders::GetStoredQueryFluentBuilder::new(self.handle.clone())
    }
}
