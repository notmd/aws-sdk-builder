...
impl super::Client {
    ...
    ///   - [`configuration_aggregator_names(impl Into<String>)`](crate::operation::describe_configuration_aggregators::builders::DescribeConfigurationAggregatorsFluentBuilder::configuration_aggregator_names) / [`set_configuration_aggregator_names(Option<Vec::<String>>)`](crate::operation::describe_configuration_aggregators::builders::DescribeConfigurationAggregatorsFluentBuilder::set_configuration_aggregator_names):<br>required: **false**<br><p>The name of the configuration aggregators.</p><br>
    ...
    ///   - [`limit(i32)`](crate::operation::describe_configuration_aggregators::builders::DescribeConfigurationAggregatorsFluentBuilder::limit) / [`set_limit(Option<i32>)`](crate::operation::describe_configuration_aggregators::builders::DescribeConfigurationAggregatorsFluentBuilder::set_limit):<br>required: **false**<br><p>The maximum number of configuration aggregators returned on each page. The default is maximum. If you specify 0, Config uses the default.</p><br>
    ...
    pub fn describe_configuration_aggregators(
        &self,
    ) -> super::super::operation::describe_configuration_aggregators::builders::DescribeConfigurationAggregatorsFluentBuilder {
        super::super::operation::describe_configuration_aggregators::builders::DescribeConfigurationAggregatorsFluentBuilder::new(self.handle.clone())
    }
}
