...
impl super::Client {
    ...
    pub fn describe_delivery_channels(&self) -> super::super::operation::describe_delivery_channels::builders::DescribeDeliveryChannelsFluentBuilder {
        super::super::operation::describe_delivery_channels::builders::DescribeDeliveryChannelsFluentBuilder::new(self.handle.clone())
    }
}
