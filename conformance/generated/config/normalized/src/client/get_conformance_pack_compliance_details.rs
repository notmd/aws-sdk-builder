...
impl super::Client {
    ...
    pub fn get_conformance_pack_compliance_details(
        &self,
    ) -> super::super::operation::get_conformance_pack_compliance_details::builders::GetConformancePackComplianceDetailsFluentBuilder {
        super::super::operation::get_conformance_pack_compliance_details::builders::GetConformancePackComplianceDetailsFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
