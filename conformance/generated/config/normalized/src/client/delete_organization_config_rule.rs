...
impl super::Client {
    ...
    pub fn delete_organization_config_rule(
        &self,
    ) -> super::super::operation::delete_organization_config_rule::builders::DeleteOrganizationConfigRuleFluentBuilder {
        super::super::operation::delete_organization_config_rule::builders::DeleteOrganizationConfigRuleFluentBuilder::new(self.handle.clone())
    }
}
