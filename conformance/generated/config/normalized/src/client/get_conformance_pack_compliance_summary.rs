...
impl super::Client {
    ...
    pub fn get_conformance_pack_compliance_summary(
        &self,
    ) -> super::super::operation::get_conformance_pack_compliance_summary::builders::GetConformancePackComplianceSummaryFluentBuilder {
        super::super::operation::get_conformance_pack_compliance_summary::builders::GetConformancePackComplianceSummaryFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
