...
impl super::Client {
    ...
    pub fn delete_service_linked_configuration_recorder(
        &self,
    ) -> super::super::operation::delete_service_linked_configuration_recorder::builders::DeleteServiceLinkedConfigurationRecorderFluentBuilder {
        super::super::operation::delete_service_linked_configuration_recorder::builders::DeleteServiceLinkedConfigurationRecorderFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
