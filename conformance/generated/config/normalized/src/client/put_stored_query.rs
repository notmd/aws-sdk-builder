...
impl super::Client {
    ...
    pub fn put_stored_query(&self) -> super::super::operation::put_stored_query::builders::PutStoredQueryFluentBuilder {
        super::super::operation::put_stored_query::builders::PutStoredQueryFluentBuilder::new(self.handle.clone())
    }
}
