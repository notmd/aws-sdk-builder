...
impl super::Client {
    ...
    pub fn list_resource_evaluations(&self) -> super::operation::list_resource_evaluations::builders::ListResourceEvaluationsFluentBuilder {
        super::operation::list_resource_evaluations::builders::ListResourceEvaluationsFluentBuilder::new(self.handle.clone())
    }
}
