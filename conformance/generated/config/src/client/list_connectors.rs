...
impl super::Client {
    ...
    pub fn list_connectors(&self) -> super::operation::list_connectors::builders::ListConnectorsFluentBuilder {
        super::operation::list_connectors::builders::ListConnectorsFluentBuilder::new(self.handle.clone())
    }
}
