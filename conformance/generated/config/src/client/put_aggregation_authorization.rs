...
impl super::Client {
    ...
    pub fn put_aggregation_authorization(
        &self,
    ) -> super::operation::put_aggregation_authorization::builders::PutAggregationAuthorizationFluentBuilder {
        super::operation::put_aggregation_authorization::builders::PutAggregationAuthorizationFluentBuilder::new(self.handle.clone())
    }
}
