...
impl super::Client {
    ...
    pub fn delete_stored_query(&self) -> super::operation::delete_stored_query::builders::DeleteStoredQueryFluentBuilder {
        super::operation::delete_stored_query::builders::DeleteStoredQueryFluentBuilder::new(self.handle.clone())
    }
}
