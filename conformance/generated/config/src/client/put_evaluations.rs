...
impl super::Client {
    ...
    pub fn put_evaluations(&self) -> super::operation::put_evaluations::builders::PutEvaluationsFluentBuilder {
        super::operation::put_evaluations::builders::PutEvaluationsFluentBuilder::new(self.handle.clone())
    }
}
