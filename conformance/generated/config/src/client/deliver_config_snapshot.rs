...
impl super::Client {
    ...
    pub fn deliver_config_snapshot(&self) -> super::operation::deliver_config_snapshot::builders::DeliverConfigSnapshotFluentBuilder {
        super::operation::deliver_config_snapshot::builders::DeliverConfigSnapshotFluentBuilder::new(self.handle.clone())
    }
}
