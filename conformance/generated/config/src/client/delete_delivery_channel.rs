...
impl super::Client {
    ...
    pub fn delete_delivery_channel(&self) -> super::operation::delete_delivery_channel::builders::DeleteDeliveryChannelFluentBuilder {
        super::operation::delete_delivery_channel::builders::DeleteDeliveryChannelFluentBuilder::new(self.handle.clone())
    }
}
