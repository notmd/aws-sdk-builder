...
impl super::Client {
    ...
    pub fn delete_configuration_recorder(
        &self,
    ) -> super::operation::delete_configuration_recorder::builders::DeleteConfigurationRecorderFluentBuilder {
        super::operation::delete_configuration_recorder::builders::DeleteConfigurationRecorderFluentBuilder::new(self.handle.clone())
    }
}
