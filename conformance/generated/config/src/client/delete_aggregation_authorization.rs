...
impl super::Client {
    ...
    pub fn delete_aggregation_authorization(
        &self,
    ) -> super::operation::delete_aggregation_authorization::builders::DeleteAggregationAuthorizationFluentBuilder {
        super::operation::delete_aggregation_authorization::builders::DeleteAggregationAuthorizationFluentBuilder::new(self.handle.clone())
    }
}
