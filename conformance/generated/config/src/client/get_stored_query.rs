...
impl super::Client {
    ...
    pub fn get_stored_query(&self) -> super::operation::get_stored_query::builders::GetStoredQueryFluentBuilder {
        super::operation::get_stored_query::builders::GetStoredQueryFluentBuilder::new(self.handle.clone())
    }
}
