...
impl super::Client {
    ...
    pub fn get_connector(&self) -> super::operation::get_connector::builders::GetConnectorFluentBuilder {
        super::operation::get_connector::builders::GetConnectorFluentBuilder::new(self.handle.clone())
    }
}
