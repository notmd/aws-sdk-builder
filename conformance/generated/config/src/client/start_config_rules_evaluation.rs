...
impl super::Client {
    ...
    pub fn start_config_rules_evaluation(
        &self,
    ) -> super::operation::start_config_rules_evaluation::builders::StartConfigRulesEvaluationFluentBuilder {
        super::operation::start_config_rules_evaluation::builders::StartConfigRulesEvaluationFluentBuilder::new(self.handle.clone())
    }
}
