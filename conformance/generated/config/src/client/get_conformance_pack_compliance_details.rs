...
impl super::Client {
    ...
    pub fn get_conformance_pack_compliance_details(
        &self,
    ) -> super::operation::get_conformance_pack_compliance_details::builders::GetConformancePackComplianceDetailsFluentBuilder {
        super::operation::get_conformance_pack_compliance_details::builders::GetConformancePackComplianceDetailsFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
