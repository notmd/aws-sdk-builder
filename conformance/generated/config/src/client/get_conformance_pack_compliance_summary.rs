...
impl super::Client {
    ...
    pub fn get_conformance_pack_compliance_summary(
        &self,
    ) -> super::operation::get_conformance_pack_compliance_summary::builders::GetConformancePackComplianceSummaryFluentBuilder {
        super::operation::get_conformance_pack_compliance_summary::builders::GetConformancePackComplianceSummaryFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
