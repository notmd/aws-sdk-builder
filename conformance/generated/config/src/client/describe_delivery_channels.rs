...
impl super::Client {
    ...
    pub fn describe_delivery_channels(&self) -> super::operation::describe_delivery_channels::builders::DescribeDeliveryChannelsFluentBuilder {
        super::operation::describe_delivery_channels::builders::DescribeDeliveryChannelsFluentBuilder::new(self.handle.clone())
    }
}
