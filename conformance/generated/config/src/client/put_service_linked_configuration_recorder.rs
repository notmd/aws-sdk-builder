...
impl super::Client {
    ...
    pub fn put_service_linked_configuration_recorder(
        &self,
    ) -> super::operation::put_service_linked_configuration_recorder::builders::PutServiceLinkedConfigurationRecorderFluentBuilder {
        super::operation::put_service_linked_configuration_recorder::builders::PutServiceLinkedConfigurationRecorderFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
