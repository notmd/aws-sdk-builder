...
impl super::Client {
    ...
    pub fn describe_pending_aggregation_requests(
        &self,
    ) -> super::operation::describe_pending_aggregation_requests::builders::DescribePendingAggregationRequestsFluentBuilder {
        super::operation::describe_pending_aggregation_requests::builders::DescribePendingAggregationRequestsFluentBuilder::new(self.handle.clone())
    }
}
