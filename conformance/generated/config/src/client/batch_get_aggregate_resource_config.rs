...
impl super::Client {
    ...
    pub fn batch_get_aggregate_resource_config(
        &self,
    ) -> super::operation::batch_get_aggregate_resource_config::builders::BatchGetAggregateResourceConfigFluentBuilder {
        super::operation::batch_get_aggregate_resource_config::builders::BatchGetAggregateResourceConfigFluentBuilder::new(self.handle.clone())
    }
}
