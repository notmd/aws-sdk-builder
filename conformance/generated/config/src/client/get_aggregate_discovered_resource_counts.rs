...
impl super::Client {
    ...
    pub fn get_aggregate_discovered_resource_counts(
        &self,
    ) -> super::operation::get_aggregate_discovered_resource_counts::builders::GetAggregateDiscoveredResourceCountsFluentBuilder {
        super::operation::get_aggregate_discovered_resource_counts::builders::GetAggregateDiscoveredResourceCountsFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
