...
impl super::Client {
    ...
    pub fn put_remediation_exceptions(&self) -> super::operation::put_remediation_exceptions::builders::PutRemediationExceptionsFluentBuilder {
        super::operation::put_remediation_exceptions::builders::PutRemediationExceptionsFluentBuilder::new(self.handle.clone())
    }
}
