...
impl super::Client {
    ...
    pub fn get_resource_evaluation_summary(
        &self,
    ) -> super::operation::get_resource_evaluation_summary::builders::GetResourceEvaluationSummaryFluentBuilder {
        super::operation::get_resource_evaluation_summary::builders::GetResourceEvaluationSummaryFluentBuilder::new(self.handle.clone())
    }
}
