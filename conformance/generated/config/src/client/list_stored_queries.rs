...
impl super::Client {
    ...
    pub fn list_stored_queries(&self) -> super::operation::list_stored_queries::builders::ListStoredQueriesFluentBuilder {
        super::operation::list_stored_queries::builders::ListStoredQueriesFluentBuilder::new(self.handle.clone())
    }
}
