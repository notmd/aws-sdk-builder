...
impl super::Client {
    ...
    pub fn get_custom_rule_policy(&self) -> super::operation::get_custom_rule_policy::builders::GetCustomRulePolicyFluentBuilder {
        super::operation::get_custom_rule_policy::builders::GetCustomRulePolicyFluentBuilder::new(self.handle.clone())
    }
}
