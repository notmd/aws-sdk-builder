...
impl super::Client {
    ...
    pub fn describe_configuration_recorder_status(
        &self,
    ) -> super::operation::describe_configuration_recorder_status::builders::DescribeConfigurationRecorderStatusFluentBuilder {
        super::operation::describe_configuration_recorder_status::builders::DescribeConfigurationRecorderStatusFluentBuilder::new(self.handle.clone())
    }
}
