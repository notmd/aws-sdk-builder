...
impl super::Client {
    ...
    pub fn describe_configuration_aggregators(
        &self,
    ) -> super::operation::describe_configuration_aggregators::builders::DescribeConfigurationAggregatorsFluentBuilder {
        super::operation::describe_configuration_aggregators::builders::DescribeConfigurationAggregatorsFluentBuilder::new(self.handle.clone())
    }
}
