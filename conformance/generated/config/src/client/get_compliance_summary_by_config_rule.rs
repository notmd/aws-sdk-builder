...
impl super::Client {
    ...
    pub fn get_compliance_summary_by_config_rule(
        &self,
    ) -> super::operation::get_compliance_summary_by_config_rule::builders::GetComplianceSummaryByConfigRuleFluentBuilder {
        super::operation::get_compliance_summary_by_config_rule::builders::GetComplianceSummaryByConfigRuleFluentBuilder::new(self.handle.clone())
    }
}
