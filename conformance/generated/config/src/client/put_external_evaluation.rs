...
impl super::Client {
    ...
    pub fn put_external_evaluation(&self) -> super::operation::put_external_evaluation::builders::PutExternalEvaluationFluentBuilder {
        super::operation::put_external_evaluation::builders::PutExternalEvaluationFluentBuilder::new(self.handle.clone())
    }
}
