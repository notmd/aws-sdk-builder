...
impl super::Client {
    ...
    pub fn put_stored_query(&self) -> super::operation::put_stored_query::builders::PutStoredQueryFluentBuilder {
        super::operation::put_stored_query::builders::PutStoredQueryFluentBuilder::new(self.handle.clone())
    }
}
