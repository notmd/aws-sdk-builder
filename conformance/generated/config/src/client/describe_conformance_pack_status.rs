...
impl super::Client {
    ...
    pub fn describe_conformance_pack_status(
        &self,
    ) -> super::operation::describe_conformance_pack_status::builders::DescribeConformancePackStatusFluentBuilder {
        super::operation::describe_conformance_pack_status::builders::DescribeConformancePackStatusFluentBuilder::new(self.handle.clone())
    }
}
