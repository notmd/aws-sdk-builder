...
impl super::Client {
    ...
    pub fn put_configuration_recorder(&self) -> super::operation::put_configuration_recorder::builders::PutConfigurationRecorderFluentBuilder {
        super::operation::put_configuration_recorder::builders::PutConfigurationRecorderFluentBuilder::new(self.handle.clone())
    }
}
