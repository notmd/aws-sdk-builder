...
impl super::Client {
    ...
    pub fn delete_configuration_aggregator(
        &self,
    ) -> super::operation::delete_configuration_aggregator::builders::DeleteConfigurationAggregatorFluentBuilder {
        super::operation::delete_configuration_aggregator::builders::DeleteConfigurationAggregatorFluentBuilder::new(self.handle.clone())
    }
}
