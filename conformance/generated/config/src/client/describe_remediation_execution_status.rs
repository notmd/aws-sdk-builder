...
impl super::Client {
    ...
    pub fn describe_remediation_execution_status(
        &self,
    ) -> super::operation::describe_remediation_execution_status::builders::DescribeRemediationExecutionStatusFluentBuilder {
        super::operation::describe_remediation_execution_status::builders::DescribeRemediationExecutionStatusFluentBuilder::new(self.handle.clone())
    }
}
