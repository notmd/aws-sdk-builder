...
impl super::Client {
    ...
    pub fn put_config_rule(&self) -> super::operation::put_config_rule::builders::PutConfigRuleFluentBuilder {
        super::operation::put_config_rule::builders::PutConfigRuleFluentBuilder::new(self.handle.clone())
    }
}
