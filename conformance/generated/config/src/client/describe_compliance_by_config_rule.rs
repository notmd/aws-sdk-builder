...
impl super::Client {
    ...
    pub fn describe_compliance_by_config_rule(
        &self,
    ) -> super::operation::describe_compliance_by_config_rule::builders::DescribeComplianceByConfigRuleFluentBuilder {
        super::operation::describe_compliance_by_config_rule::builders::DescribeComplianceByConfigRuleFluentBuilder::new(self.handle.clone())
    }
}
