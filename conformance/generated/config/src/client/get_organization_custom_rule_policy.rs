...
impl super::Client {
    ...
    pub fn get_organization_custom_rule_policy(
        &self,
    ) -> super::operation::get_organization_custom_rule_policy::builders::GetOrganizationCustomRulePolicyFluentBuilder {
        super::operation::get_organization_custom_rule_policy::builders::GetOrganizationCustomRulePolicyFluentBuilder::new(self.handle.clone())
    }
}
