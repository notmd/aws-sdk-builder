...
impl super::Client {
    ...
    pub fn delete_connector(&self) -> super::operation::delete_connector::builders::DeleteConnectorFluentBuilder {
        super::operation::delete_connector::builders::DeleteConnectorFluentBuilder::new(self.handle.clone())
    }
}
