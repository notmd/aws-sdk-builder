...
impl ResourceFilters {
    ...
    pub fn builder() -> super::types::builders::ResourceFiltersBuilder {
        super::types::builders::ResourceFiltersBuilder::default()
    }
}
...
impl ResourceFiltersBuilder {
    ...
    pub fn build(self) -> super::types::ResourceFilters {
        super::types::ResourceFilters {
