...
impl FieldInfo {
    ...
    pub fn builder() -> super::types::builders::FieldInfoBuilder {
        super::types::builders::FieldInfoBuilder::default()
    }
}
...
impl FieldInfoBuilder {
    ...
    pub fn build(self) -> super::types::FieldInfo {
        super::types::FieldInfo { name: self.name }
    }
}
