...
impl AggregationAuthorization {
    ...
    pub fn builder() -> super::types::builders::AggregationAuthorizationBuilder {
        super::types::builders::AggregationAuthorizationBuilder::default()
    }
}
...
impl AggregationAuthorizationBuilder {
    ...
    pub fn build(self) -> super::types::AggregationAuthorization {
