...
impl ResourceIdentifier {
    ...
    pub fn builder() -> super::types::builders::ResourceIdentifierBuilder {
        super::types::builders::ResourceIdentifierBuilder::default()
    }
}
...
impl ResourceIdentifierBuilder {
    ...
    pub fn build(self) -> super::types::ResourceIdentifier {
