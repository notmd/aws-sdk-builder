...
pub struct RecordingMode {
    ...
    /// </important>
    pub recording_frequency: super::types::RecordingFrequency,
    ...
    pub recording_mode_overrides: ::std::option::Option<::std::vec::Vec<super::types::RecordingModeOverride>>,
}
impl RecordingMode {
    /// <p>The default recording frequency that Config uses to record configuration changes.</p><important>
    /// <p>Daily recording cannot be specified for the following resource types:</p>
    ...
    /// <p>For the <b>allSupported</b> (<code>ALL_SUPPORTED_RESOURCE_TYPES</code>) recording strategy, these resource types will be set to Continuous recording.</p>
    /// </important>
    pub fn recording_frequency(&self) -> &super::types::RecordingFrequency {
    ...
    pub fn recording_mode_overrides(&self) -> &[super::types::RecordingModeOverride] {
...
impl RecordingMode {
    ...
    pub fn builder() -> super::types::builders::RecordingModeBuilder {
        super::types::builders::RecordingModeBuilder::default()
    }
}
...
pub struct RecordingModeBuilder {
    ...
    pub(crate) recording_mode_overrides: ::std::option::Option<::std::vec::Vec<super::types::RecordingModeOverride>>,
}
impl RecordingModeBuilder {
    ...
    ///
    /// <p>An array of <code>recordingModeOverride</code> objects for you to specify your overrides for the recording mode. The <code>recordingModeOverride</code> object in the <code>recordingModeOverrides</code> array consists of three fields: a <code>description</code>, the new <code>recordingFrequency</code>, and an array of <code>resourceTypes</code> to override.</p>
    pub fn recording_mode_overrides(mut self, input: super::types::RecordingModeOverride) -> Self {
    ...
    /// <p>An array of <code>recordingModeOverride</code> objects for you to specify your overrides for the recording mode. The <code>recordingModeOverride</code> object in the <code>recordingModeOverrides</code> array consists of three fields: a <code>description</code>, the new <code>recordingFrequency</code>, and an array of <code>resourceTypes</code> to override.</p>
    pub fn set_recording_mode_overrides(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::RecordingModeOverride>>) -> Self {
        self.recording_mode_overrides = input;
        self
    }
    /// <p>An array of <code>recordingModeOverride</code> objects for you to specify your overrides for the recording mode. The <code>recordingModeOverride</code> object in the <code>recordingModeOverrides</code> array consists of three fields: a <code>description</code>, the new <code>recordingFrequency</code>, and an array of <code>resourceTypes</code> to override.</p>
    pub fn get_recording_mode_overrides(&self) -> &::std::option::Option<::std::vec::Vec<super::types::RecordingModeOverride>> {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::RecordingMode, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::RecordingMode {
