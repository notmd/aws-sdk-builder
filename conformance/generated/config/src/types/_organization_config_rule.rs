...
pub struct OrganizationConfigRule {
    ...
    pub organization_custom_policy_rule_metadata: ::std::option::Option<super::types::OrganizationCustomPolicyRuleMetadataNoPolicy>,
}
impl OrganizationConfigRule {
    ...
    /// <p>An object that specifies metadata for your organization's Config Custom Policy rule. The metadata includes the runtime system in use, which accounts have debug logging enabled, and other custom rule metadata, such as resource type, resource ID of Amazon Web Services resource, and organization trigger types that initiate Config to evaluate Amazon Web Services resources against a rule.</p>
    pub fn organization_custom_policy_rule_metadata(&self) -> ::std::option::Option<&super::types::OrganizationCustomPolicyRuleMetadataNoPolicy> {
...
impl OrganizationConfigRule {
    ...
    pub fn builder() -> super::types::builders::OrganizationConfigRuleBuilder {
        super::types::builders::OrganizationConfigRuleBuilder::default()
    }
}
...
pub struct OrganizationConfigRuleBuilder {
    ...
    pub(crate) organization_custom_policy_rule_metadata: ::std::option::Option<super::types::OrganizationCustomPolicyRuleMetadataNoPolicy>,
}
impl OrganizationConfigRuleBuilder {
    ...
    /// <p>An object that specifies metadata for your organization's Config Custom Policy rule. The metadata includes the runtime system in use, which accounts have debug logging enabled, and other custom rule metadata, such as resource type, resource ID of Amazon Web Services resource, and organization trigger types that initiate Config to evaluate Amazon Web Services resources against a rule.</p>
    pub fn organization_custom_policy_rule_metadata(mut self, input: super::types::OrganizationCustomPolicyRuleMetadataNoPolicy) -> Self {
    ...
    pub fn set_organization_custom_policy_rule_metadata(
        mut self,
        input: ::std::option::Option<super::types::OrganizationCustomPolicyRuleMetadataNoPolicy>,
    ) -> Self {
        self.organization_custom_policy_rule_metadata = input;
        self
    }
    /// <p>An object that specifies metadata for your organization's Config Custom Policy rule. The metadata includes the runtime system in use, which accounts have debug logging enabled, and other custom rule metadata, such as resource type, resource ID of Amazon Web Services resource, and organization trigger types that initiate Config to evaluate Amazon Web Services resources against a rule.</p>
    pub fn get_organization_custom_policy_rule_metadata(&self) -> &::std::option::Option<super::types::OrganizationCustomPolicyRuleMetadataNoPolicy> {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::OrganizationConfigRule, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::OrganizationConfigRule {
