...
impl SsmControls {
    ...
    pub fn builder() -> super::types::builders::SsmControlsBuilder {
        super::types::builders::SsmControlsBuilder::default()
    }
}
...
impl SsmControlsBuilder {
    ...
    pub fn build(self) -> super::types::SsmControls {
        super::types::SsmControls {
