...
pub struct RecordingModeOverride {
    ...
    /// </ul>
    /// </important>
    pub resource_types: ::std::vec::Vec<super::types::ResourceType>,
...
impl RecordingModeOverride {
    ...
    pub fn builder() -> super::types::builders::RecordingModeOverrideBuilder {
        super::types::builders::RecordingModeOverrideBuilder::default()
    }
}
...
impl RecordingModeOverrideBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::RecordingModeOverride, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::RecordingModeOverride {
