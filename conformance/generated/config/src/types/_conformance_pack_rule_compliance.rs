...
impl ConformancePackRuleCompliance {
    ...
    pub fn builder() -> super::types::builders::ConformancePackRuleComplianceBuilder {
        super::types::builders::ConformancePackRuleComplianceBuilder::default()
    }
}
...
impl ConformancePackRuleComplianceBuilder {
    ...
    pub fn build(self) -> super::types::ConformancePackRuleCompliance {
