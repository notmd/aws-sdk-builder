...
pub struct StatusDetailFilters {
    ...
    /// </ul>
    pub member_account_rule_status: ::std::option::Option<super::types::MemberAccountRuleStatus>,
}
impl StatusDetailFilters {
    ...
    /// <p><code>UPDATE_FAILED</code> when Config rule deletion has failed in the member account.</p></li>
    /// </ul>
    pub fn member_account_rule_status(&self) -> ::std::option::Option<&super::types::MemberAccountRuleStatus> {
...
impl StatusDetailFilters {
    ...
    pub fn builder() -> super::types::builders::StatusDetailFiltersBuilder {
        super::types::builders::StatusDetailFiltersBuilder::default()
    }
}
...
impl StatusDetailFiltersBuilder {
    ...
    pub fn build(self) -> super::types::StatusDetailFilters {
        super::types::StatusDetailFilters {
