...
impl ComplianceByConfigRule {
    ...
    pub fn builder() -> super::types::builders::ComplianceByConfigRuleBuilder {
        super::types::builders::ComplianceByConfigRuleBuilder::default()
    }
}
...
impl ComplianceByConfigRuleBuilder {
    ...
    pub fn build(self) -> super::types::ComplianceByConfigRule {
