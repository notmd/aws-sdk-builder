...
impl OrganizationAggregationSource {
    ...
    pub fn builder() -> super::types::builders::OrganizationAggregationSourceBuilder {
        super::types::builders::OrganizationAggregationSourceBuilder::default()
    }
}
...
impl OrganizationAggregationSourceBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::OrganizationAggregationSource, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::OrganizationAggregationSource {
