...
impl AggregateConformancePackComplianceCount {
    ...
    pub fn builder() -> super::types::builders::AggregateConformancePackComplianceCountBuilder {
        super::types::builders::AggregateConformancePackComplianceCountBuilder::default()
    }
}
...
impl AggregateConformancePackComplianceCountBuilder {
    ...
    pub fn build(self) -> super::types::AggregateConformancePackComplianceCount {
        super::types::AggregateConformancePackComplianceCount {
