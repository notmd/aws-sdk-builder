...
pub struct RemediationExecutionStatus {
    ...
    pub resource_key: ::std::option::Option<super::types::ResourceKey>,
    /// <p>ENUM of the values.</p>
    pub state: ::std::option::Option<super::types::RemediationExecutionState>,
    /// <p>Details of every step.</p>
    pub step_details: ::std::option::Option<::std::vec::Vec<super::types::RemediationExecutionStep>>,
...
impl RemediationExecutionStatus {
    /// <p>The details that identify a resource within Config, including the resource type and resource ID.</p>
    pub fn resource_key(&self) -> ::std::option::Option<&super::types::ResourceKey> {
        self.resource_key.as_ref()
    }
    /// <p>ENUM of the values.</p>
    pub fn state(&self) -> ::std::option::Option<&super::types::RemediationExecutionState> {
        self.state.as_ref()
    }
    /// <p>Details of every step.</p>
    ///
    ...
    pub fn step_details(&self) -> &[super::types::RemediationExecutionStep] {
...
impl RemediationExecutionStatus {
    ...
    pub fn builder() -> super::types::builders::RemediationExecutionStatusBuilder {
        super::types::builders::RemediationExecutionStatusBuilder::default()
    }
}
...
pub struct RemediationExecutionStatusBuilder {
    pub(crate) resource_key: ::std::option::Option<super::types::ResourceKey>,
    pub(crate) state: ::std::option::Option<super::types::RemediationExecutionState>,
    pub(crate) step_details: ::std::option::Option<::std::vec::Vec<super::types::RemediationExecutionStep>>,
...
impl RemediationExecutionStatusBuilder {
    /// <p>The details that identify a resource within Config, including the resource type and resource ID.</p>
    pub fn resource_key(mut self, input: super::types::ResourceKey) -> Self {
        self.resource_key = ::std::option::Option::Some(input);
        self
    }
    /// <p>The details that identify a resource within Config, including the resource type and resource ID.</p>
    pub fn set_resource_key(mut self, input: ::std::option::Option<super::types::ResourceKey>) -> Self {
        self.resource_key = input;
        self
    }
    /// <p>The details that identify a resource within Config, including the resource type and resource ID.</p>
    pub fn get_resource_key(&self) -> &::std::option::Option<super::types::ResourceKey> {
        &self.resource_key
    }
    /// <p>ENUM of the values.</p>
    pub fn state(mut self, input: super::types::RemediationExecutionState) -> Self {
        self.state = ::std::option::Option::Some(input);
        self
    }
    /// <p>ENUM of the values.</p>
    pub fn set_state(mut self, input: ::std::option::Option<super::types::RemediationExecutionState>) -> Self {
        self.state = input;
        self
    }
    /// <p>ENUM of the values.</p>
    pub fn get_state(&self) -> &::std::option::Option<super::types::RemediationExecutionState> {
        &self.state
    }
    ...
    ///
    /// <p>Details of every step.</p>
    pub fn step_details(mut self, input: super::types::RemediationExecutionStep) -> Self {
    ...
    /// <p>Details of every step.</p>
    pub fn set_step_details(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::RemediationExecutionStep>>) -> Self {
        self.step_details = input;
        self
    }
    /// <p>Details of every step.</p>
    pub fn get_step_details(&self) -> &::std::option::Option<::std::vec::Vec<super::types::RemediationExecutionStep>> {
        &self.step_details
    }
    /// <p>Start time when the remediation was executed.</p>
    ...
    pub fn build(self) -> super::types::RemediationExecutionStatus {
        super::types::RemediationExecutionStatus {
