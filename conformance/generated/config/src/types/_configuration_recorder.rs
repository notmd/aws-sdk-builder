...
pub struct ConfigurationRecorder {
    ...
    /// </note>
    pub recording_group: ::std::option::Option<super::types::RecordingGroup>,
    ...
    pub recording_mode: ::std::option::Option<super::types::RecordingMode>,
    ...
    pub recording_scope: ::std::option::Option<super::types::RecordingScope>,
    ...
    pub scope_configuration: ::std::option::Option<super::types::ScopeConfiguration>,
}
impl ConfigurationRecorder {
    ...
    /// <p>If you want to avoid the increased activity from running ephemeral workloads, you can set up the configuration recorder to exclude these resource types from being recorded, or run these types of workloads in a separate account with Config turned off to avoid increased configuration recording and rule evaluations.</p>
    /// </note>
    pub fn recording_group(&self) -> ::std::option::Option<&super::types::RecordingGroup> {
    ...
    /// </note>
    /// <p>You can also override the recording frequency for specific resource types.</p>
    pub fn recording_mode(&self) -> ::std::option::Option<&super::types::RecordingMode> {
        self.recording_mode.as_ref()
    }
    /// <p>Specifies whether the <a href="https://docs.aws.amazon.com/config/latest/APIReference/API_ConfigurationItem.html">ConfigurationItems</a> in scope for the specified configuration recorder are recorded for free (<code>INTERNAL</code>) or if it impacts the costs to your bill (<code>PAID</code>).</p>
    pub fn recording_scope(&self) -> ::std::option::Option<&super::types::RecordingScope> {
    ...
    /// <p>Specifies the scope of resources to record from the third-party cloud service provider connected through the connector.</p>
    pub fn scope_configuration(&self) -> ::std::option::Option<&super::types::ScopeConfiguration> {
...
impl ConfigurationRecorder {
    ...
    pub fn builder() -> super::types::builders::ConfigurationRecorderBuilder {
        super::types::builders::ConfigurationRecorderBuilder::default()
    }
}
...
pub struct ConfigurationRecorderBuilder {
    ...
    pub(crate) recording_group: ::std::option::Option<super::types::RecordingGroup>,
    pub(crate) recording_mode: ::std::option::Option<super::types::RecordingMode>,
    pub(crate) recording_scope: ::std::option::Option<super::types::RecordingScope>,
    pub(crate) service_principal: ::std::option::Option<::std::string::String>,
    pub(crate) connector_arn: ::std::option::Option<::std::string::String>,
    pub(crate) scope_configuration: ::std::option::Option<super::types::ScopeConfiguration>,
}
impl ConfigurationRecorderBuilder {
    ...
    /// <p>If you want to avoid the increased activity from running ephemeral workloads, you can set up the configuration recorder to exclude these resource types from being recorded, or run these types of workloads in a separate account with Config turned off to avoid increased configuration recording and rule evaluations.</p>
    /// </note>
    pub fn recording_group(mut self, input: super::types::RecordingGroup) -> Self {
    ...
    /// <p>If you want to avoid the increased activity from running ephemeral workloads, you can set up the configuration recorder to exclude these resource types from being recorded, or run these types of workloads in a separate account with Config turned off to avoid increased configuration recording and rule evaluations.</p>
    /// </note>
    pub fn set_recording_group(mut self, input: ::std::option::Option<super::types::RecordingGroup>) -> Self {
    ...
    /// <p>If you want to avoid the increased activity from running ephemeral workloads, you can set up the configuration recorder to exclude these resource types from being recorded, or run these types of workloads in a separate account with Config turned off to avoid increased configuration recording and rule evaluations.</p>
    /// </note>
    pub fn get_recording_group(&self) -> &::std::option::Option<super::types::RecordingGroup> {
    ...
    /// </note>
    /// <p>You can also override the recording frequency for specific resource types.</p>
    pub fn recording_mode(mut self, input: super::types::RecordingMode) -> Self {
    ...
    /// </note>
    /// <p>You can also override the recording frequency for specific resource types.</p>
    pub fn set_recording_mode(mut self, input: ::std::option::Option<super::types::RecordingMode>) -> Self {
    ...
    /// </note>
    /// <p>You can also override the recording frequency for specific resource types.</p>
    pub fn get_recording_mode(&self) -> &::std::option::Option<super::types::RecordingMode> {
        &self.recording_mode
    }
    /// <p>Specifies whether the <a href="https://docs.aws.amazon.com/config/latest/APIReference/API_ConfigurationItem.html">ConfigurationItems</a> in scope for the specified configuration recorder are recorded for free (<code>INTERNAL</code>) or if it impacts the costs to your bill (<code>PAID</code>).</p>
    pub fn recording_scope(mut self, input: super::types::RecordingScope) -> Self {
        self.recording_scope = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies whether the <a href="https://docs.aws.amazon.com/config/latest/APIReference/API_ConfigurationItem.html">ConfigurationItems</a> in scope for the specified configuration recorder are recorded for free (<code>INTERNAL</code>) or if it impacts the costs to your bill (<code>PAID</code>).</p>
    pub fn set_recording_scope(mut self, input: ::std::option::Option<super::types::RecordingScope>) -> Self {
        self.recording_scope = input;
        self
    }
    /// <p>Specifies whether the <a href="https://docs.aws.amazon.com/config/latest/APIReference/API_ConfigurationItem.html">ConfigurationItems</a> in scope for the specified configuration recorder are recorded for free (<code>INTERNAL</code>) or if it impacts the costs to your bill (<code>PAID</code>).</p>
    pub fn get_recording_scope(&self) -> &::std::option::Option<super::types::RecordingScope> {
    ...
    /// <p>Specifies the scope of resources to record from the third-party cloud service provider connected through the connector.</p>
    pub fn scope_configuration(mut self, input: super::types::ScopeConfiguration) -> Self {
        self.scope_configuration = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies the scope of resources to record from the third-party cloud service provider connected through the connector.</p>
    pub fn set_scope_configuration(mut self, input: ::std::option::Option<super::types::ScopeConfiguration>) -> Self {
        self.scope_configuration = input;
        self
    }
    /// <p>Specifies the scope of resources to record from the third-party cloud service provider connected through the connector.</p>
    pub fn get_scope_configuration(&self) -> &::std::option::Option<super::types::ScopeConfiguration> {
        &self.scope_configuration
    }
    /// Consumes the builder and constructs a [`ConfigurationRecorder`](crate::types::ConfigurationRecorder).
    pub fn build(self) -> super::types::ConfigurationRecorder {
        super::types::ConfigurationRecorder {
            arn: self.arn,
            name: self.name,
