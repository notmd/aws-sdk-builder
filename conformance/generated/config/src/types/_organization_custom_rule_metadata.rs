...
pub struct OrganizationCustomRuleMetadata {
    ...
    /// </ul>
    pub organization_config_rule_trigger_types: ::std::vec::Vec<super::types::OrganizationConfigRuleTriggerType>,
...
impl OrganizationCustomRuleMetadata {
    ...
    /// <p><code>ScheduledNotification</code> - Triggers a periodic evaluation at the frequency specified for <code>MaximumExecutionFrequency</code>.</p></li>
    /// </ul>
    pub fn organization_config_rule_trigger_types(&self) -> &[super::types::OrganizationConfigRuleTriggerType] {
        use std::ops::Deref;
...
impl OrganizationCustomRuleMetadata {
    ...
    pub fn builder() -> super::types::builders::OrganizationCustomRuleMetadataBuilder {
        super::types::builders::OrganizationCustomRuleMetadataBuilder::default()
    }
}
...
pub struct OrganizationCustomRuleMetadataBuilder {
    ...
    pub(crate) organization_config_rule_trigger_types: ::std::option::Option<::std::vec::Vec<super::types::OrganizationConfigRuleTriggerType>>,
...
impl OrganizationCustomRuleMetadataBuilder {
    ...
    /// <p><code>ScheduledNotification</code> - Triggers a periodic evaluation at the frequency specified for <code>MaximumExecutionFrequency</code>.</p></li>
    /// </ul>
    pub fn organization_config_rule_trigger_types(mut self, input: super::types::OrganizationConfigRuleTriggerType) -> Self {
    ...
    pub fn set_organization_config_rule_trigger_types(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::OrganizationConfigRuleTriggerType>>,
    ) -> Self {
    ...
    pub fn get_organization_config_rule_trigger_types(
        &self,
    ) -> &::std::option::Option<::std::vec::Vec<super::types::OrganizationConfigRuleTriggerType>> {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::OrganizationCustomRuleMetadata, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::OrganizationCustomRuleMetadata {
