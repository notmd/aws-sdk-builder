...
pub struct ConfigExportDeliveryInfo {
    ...
    pub last_status: ::std::option::Option<super::types::DeliveryStatus>,
...
impl ConfigExportDeliveryInfo {
    /// <p>Status of the last attempted delivery.</p>
    pub fn last_status(&self) -> ::std::option::Option<&super::types::DeliveryStatus> {
...
impl ConfigExportDeliveryInfo {
    ...
    pub fn builder() -> super::types::builders::ConfigExportDeliveryInfoBuilder {
        super::types::builders::ConfigExportDeliveryInfoBuilder::default()
    }
}
...
pub struct ConfigExportDeliveryInfoBuilder {
    pub(crate) last_status: ::std::option::Option<super::types::DeliveryStatus>,
...
impl ConfigExportDeliveryInfoBuilder {
    /// <p>Status of the last attempted delivery.</p>
    pub fn last_status(mut self, input: super::types::DeliveryStatus) -> Self {
        self.last_status = ::std::option::Option::Some(input);
        self
    }
    /// <p>Status of the last attempted delivery.</p>
    pub fn set_last_status(mut self, input: ::std::option::Option<super::types::DeliveryStatus>) -> Self {
        self.last_status = input;
        self
    }
    /// <p>Status of the last attempted delivery.</p>
    pub fn get_last_status(&self) -> &::std::option::Option<super::types::DeliveryStatus> {
        &self.last_status
    }
    /// <p>The error code from the last attempted delivery.</p>
    ...
    pub fn build(self) -> super::types::ConfigExportDeliveryInfo {
        super::types::ConfigExportDeliveryInfo {
