...
impl TemplateSsmDocumentDetails {
    ...
    pub fn builder() -> super::types::builders::TemplateSsmDocumentDetailsBuilder {
        super::types::builders::TemplateSsmDocumentDetailsBuilder::default()
    }
}
...
impl TemplateSsmDocumentDetailsBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::TemplateSsmDocumentDetails, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::TemplateSsmDocumentDetails {
