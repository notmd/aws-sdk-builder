...
pub struct FailedRemediationExceptionBatch {
    ...
    pub failed_items: ::std::option::Option<::std::vec::Vec<super::types::RemediationException>>,
}
impl FailedRemediationExceptionBatch {
    ...
    pub fn failed_items(&self) -> &[super::types::RemediationException] {
...
impl FailedRemediationExceptionBatch {
    ...
    pub fn builder() -> super::types::builders::FailedRemediationExceptionBatchBuilder {
        super::types::builders::FailedRemediationExceptionBatchBuilder::default()
    }
}
...
pub struct FailedRemediationExceptionBatchBuilder {
    ...
    pub(crate) failed_items: ::std::option::Option<::std::vec::Vec<super::types::RemediationException>>,
}
impl FailedRemediationExceptionBatchBuilder {
    ...
    ///
    /// <p>Returns remediation exception resource key object of the failed items.</p>
    pub fn failed_items(mut self, input: super::types::RemediationException) -> Self {
    ...
    /// <p>Returns remediation exception resource key object of the failed items.</p>
    pub fn set_failed_items(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::RemediationException>>) -> Self {
        self.failed_items = input;
        self
    }
    /// <p>Returns remediation exception resource key object of the failed items.</p>
    pub fn get_failed_items(&self) -> &::std::option::Option<::std::vec::Vec<super::types::RemediationException>> {
        &self.failed_items
    }
    /// Consumes the builder and constructs a [`FailedRemediationExceptionBatch`](crate::types::FailedRemediationExceptionBatch).
    pub fn build(self) -> super::types::FailedRemediationExceptionBatch {
        super::types::FailedRemediationExceptionBatch {
