...
impl PendingAggregationRequest {
    ...
    pub fn builder() -> super::types::builders::PendingAggregationRequestBuilder {
        super::types::builders::PendingAggregationRequestBuilder::default()
    }
}
...
impl PendingAggregationRequestBuilder {
    ...
    pub fn build(self) -> super::types::PendingAggregationRequest {
