...
impl StoredQuery {
    ...
    pub fn builder() -> super::types::builders::StoredQueryBuilder {
        super::types::builders::StoredQueryBuilder::default()
    }
}
...
impl StoredQueryBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::StoredQuery, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::StoredQuery {
