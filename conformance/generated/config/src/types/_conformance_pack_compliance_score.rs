...
impl ConformancePackComplianceScore {
    ...
    pub fn builder() -> super::types::builders::ConformancePackComplianceScoreBuilder {
        super::types::builders::ConformancePackComplianceScoreBuilder::default()
    }
}
...
impl ConformancePackComplianceScoreBuilder {
    ...
    pub fn build(self) -> super::types::ConformancePackComplianceScore {
        super::types::ConformancePackComplianceScore {
            score: self.score,
