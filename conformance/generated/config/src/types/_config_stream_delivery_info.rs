...
impl ConfigStreamDeliveryInfo {
    ...
    pub fn builder() -> super::types::builders::ConfigStreamDeliveryInfoBuilder {
        super::types::builders::ConfigStreamDeliveryInfoBuilder::default()
    }
}
...
impl ConfigStreamDeliveryInfoBuilder {
    ...
    pub fn build(self) -> super::types::ConfigStreamDeliveryInfo {
        super::types::ConfigStreamDeliveryInfo {
