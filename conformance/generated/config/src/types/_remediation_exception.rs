...
impl RemediationException {
    ...
    pub fn builder() -> super::types::builders::RemediationExceptionBuilder {
        super::types::builders::RemediationExceptionBuilder::default()
    }
}
...
impl RemediationExceptionBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::RemediationException, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::RemediationException {
