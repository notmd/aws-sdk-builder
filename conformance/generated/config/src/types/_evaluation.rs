...
impl Evaluation {
    ...
    pub fn builder() -> super::types::builders::EvaluationBuilder {
        super::types::builders::EvaluationBuilder::default()
    }
}
...
impl EvaluationBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::Evaluation, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::Evaluation {
