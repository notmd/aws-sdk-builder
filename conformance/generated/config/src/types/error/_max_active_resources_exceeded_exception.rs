...
impl ::aws_types::request_id::RequestId for super::types::error::MaxActiveResourcesExceededException {
...
impl MaxActiveResourcesExceededException {
    ...
    pub fn builder() -> super::types::error::builders::MaxActiveResourcesExceededExceptionBuilder {
        super::types::error::builders::MaxActiveResourcesExceededExceptionBuilder::default()
    }
}
...
impl MaxActiveResourcesExceededExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::MaxActiveResourcesExceededException {
        super::types::error::MaxActiveResourcesExceededException {
