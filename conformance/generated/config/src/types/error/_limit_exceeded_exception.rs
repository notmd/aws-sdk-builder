...
impl ::aws_types::request_id::RequestId for super::types::error::LimitExceededException {
...
impl LimitExceededException {
    ...
    pub fn builder() -> super::types::error::builders::LimitExceededExceptionBuilder {
        super::types::error::builders::LimitExceededExceptionBuilder::default()
    }
}
...
impl LimitExceededExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::LimitExceededException {
        super::types::error::LimitExceededException {
