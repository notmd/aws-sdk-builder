...
impl ::aws_types::request_id::RequestId for super::types::error::NoRunningConfigurationRecorderException {
...
impl NoRunningConfigurationRecorderException {
    ...
    pub fn builder() -> super::types::error::builders::NoRunningConfigurationRecorderExceptionBuilder {
        super::types::error::builders::NoRunningConfigurationRecorderExceptionBuilder::default()
    }
}
...
impl NoRunningConfigurationRecorderExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::NoRunningConfigurationRecorderException {
        super::types::error::NoRunningConfigurationRecorderException {
