...
impl ::aws_types::request_id::RequestId for super::types::error::NoSuchOrganizationConfigRuleException {
...
impl NoSuchOrganizationConfigRuleException {
    ...
    pub fn builder() -> super::types::error::builders::NoSuchOrganizationConfigRuleExceptionBuilder {
        super::types::error::builders::NoSuchOrganizationConfigRuleExceptionBuilder::default()
    }
}
...
impl NoSuchOrganizationConfigRuleExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::NoSuchOrganizationConfigRuleException {
        super::types::error::NoSuchOrganizationConfigRuleException {
