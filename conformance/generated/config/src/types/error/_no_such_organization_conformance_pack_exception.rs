...
impl ::aws_types::request_id::RequestId for super::types::error::NoSuchOrganizationConformancePackException {
...
impl NoSuchOrganizationConformancePackException {
    ...
    pub fn builder() -> super::types::error::builders::NoSuchOrganizationConformancePackExceptionBuilder {
        super::types::error::builders::NoSuchOrganizationConformancePackExceptionBuilder::default()
    }
}
...
impl NoSuchOrganizationConformancePackExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::NoSuchOrganizationConformancePackException {
        super::types::error::NoSuchOrganizationConformancePackException {
