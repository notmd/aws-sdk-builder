...
impl ::aws_types::request_id::RequestId for super::types::error::TooManyTagsException {
...
impl TooManyTagsException {
    ...
    pub fn builder() -> super::types::error::builders::TooManyTagsExceptionBuilder {
        super::types::error::builders::TooManyTagsExceptionBuilder::default()
    }
}
...
impl TooManyTagsExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::TooManyTagsException {
        super::types::error::TooManyTagsException {
