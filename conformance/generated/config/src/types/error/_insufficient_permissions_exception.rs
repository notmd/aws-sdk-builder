...
impl ::aws_types::request_id::RequestId for super::types::error::InsufficientPermissionsException {
...
impl InsufficientPermissionsException {
    ...
    pub fn builder() -> super::types::error::builders::InsufficientPermissionsExceptionBuilder {
        super::types::error::builders::InsufficientPermissionsExceptionBuilder::default()
    }
}
...
impl InsufficientPermissionsExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::InsufficientPermissionsException {
        super::types::error::InsufficientPermissionsException {
