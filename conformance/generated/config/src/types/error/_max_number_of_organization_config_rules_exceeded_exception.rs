...
impl ::aws_types::request_id::RequestId for super::types::error::MaxNumberOfOrganizationConfigRulesExceededException {
...
impl MaxNumberOfOrganizationConfigRulesExceededException {
    ...
    pub fn builder() -> super::types::error::builders::MaxNumberOfOrganizationConfigRulesExceededExceptionBuilder {
        super::types::error::builders::MaxNumberOfOrganizationConfigRulesExceededExceptionBuilder::default()
    }
}
...
impl MaxNumberOfOrganizationConfigRulesExceededExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::MaxNumberOfOrganizationConfigRulesExceededException {
        super::types::error::MaxNumberOfOrganizationConfigRulesExceededException {
