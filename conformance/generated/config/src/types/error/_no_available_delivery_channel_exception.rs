...
impl ::aws_types::request_id::RequestId for super::types::error::NoAvailableDeliveryChannelException {
...
impl NoAvailableDeliveryChannelException {
    ...
    pub fn builder() -> super::types::error::builders::NoAvailableDeliveryChannelExceptionBuilder {
        super::types::error::builders::NoAvailableDeliveryChannelExceptionBuilder::default()
    }
}
...
impl NoAvailableDeliveryChannelExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::NoAvailableDeliveryChannelException {
        super::types::error::NoAvailableDeliveryChannelException {
