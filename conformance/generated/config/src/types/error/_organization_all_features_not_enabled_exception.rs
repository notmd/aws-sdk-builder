...
impl ::aws_types::request_id::RequestId for super::types::error::OrganizationAllFeaturesNotEnabledException {
...
impl OrganizationAllFeaturesNotEnabledException {
    ...
    pub fn builder() -> super::types::error::builders::OrganizationAllFeaturesNotEnabledExceptionBuilder {
        super::types::error::builders::OrganizationAllFeaturesNotEnabledExceptionBuilder::default()
    }
}
...
impl OrganizationAllFeaturesNotEnabledExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::OrganizationAllFeaturesNotEnabledException {
        super::types::error::OrganizationAllFeaturesNotEnabledException {
