...
impl ::aws_types::request_id::RequestId for super::types::error::MaxNumberOfConfigRulesExceededException {
...
impl MaxNumberOfConfigRulesExceededException {
    ...
    pub fn builder() -> super::types::error::builders::MaxNumberOfConfigRulesExceededExceptionBuilder {
        super::types::error::builders::MaxNumberOfConfigRulesExceededExceptionBuilder::default()
    }
}
...
impl MaxNumberOfConfigRulesExceededExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::MaxNumberOfConfigRulesExceededException {
        super::types::error::MaxNumberOfConfigRulesExceededException {
