...
impl ::aws_types::request_id::RequestId for super::types::error::NoSuchBucketException {
...
impl NoSuchBucketException {
    ...
    pub fn builder() -> super::types::error::builders::NoSuchBucketExceptionBuilder {
        super::types::error::builders::NoSuchBucketExceptionBuilder::default()
    }
}
...
impl NoSuchBucketExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::NoSuchBucketException {
        super::types::error::NoSuchBucketException {
