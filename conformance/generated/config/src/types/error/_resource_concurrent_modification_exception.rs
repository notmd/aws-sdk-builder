...
impl ::aws_types::request_id::RequestId for super::types::error::ResourceConcurrentModificationException {
...
impl ResourceConcurrentModificationException {
    ...
    pub fn builder() -> super::types::error::builders::ResourceConcurrentModificationExceptionBuilder {
        super::types::error::builders::ResourceConcurrentModificationExceptionBuilder::default()
    }
}
...
impl ResourceConcurrentModificationExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::ResourceConcurrentModificationException {
        super::types::error::ResourceConcurrentModificationException {
