...
impl ::aws_types::request_id::RequestId for super::types::error::InvalidRecordingGroupException {
...
impl InvalidRecordingGroupException {
    ...
    pub fn builder() -> super::types::error::builders::InvalidRecordingGroupExceptionBuilder {
        super::types::error::builders::InvalidRecordingGroupExceptionBuilder::default()
    }
}
...
impl InvalidRecordingGroupExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::InvalidRecordingGroupException {
        super::types::error::InvalidRecordingGroupException {
