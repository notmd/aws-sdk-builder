...
impl ::aws_types::request_id::RequestId for super::types::error::OrganizationAccessDeniedException {
...
impl OrganizationAccessDeniedException {
    ...
    pub fn builder() -> super::types::error::builders::OrganizationAccessDeniedExceptionBuilder {
        super::types::error::builders::OrganizationAccessDeniedExceptionBuilder::default()
    }
}
...
impl OrganizationAccessDeniedExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::OrganizationAccessDeniedException {
        super::types::error::OrganizationAccessDeniedException {
