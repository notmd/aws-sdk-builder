...
impl ConfigurationAggregator {
    ...
    pub fn builder() -> super::types::builders::ConfigurationAggregatorBuilder {
        super::types::builders::ConfigurationAggregatorBuilder::default()
    }
}
...
impl ConfigurationAggregatorBuilder {
    ...
    pub fn build(self) -> super::types::ConfigurationAggregator {
        super::types::ConfigurationAggregator {
