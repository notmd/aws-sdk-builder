...
impl AggregateComplianceCount {
    ...
    pub fn builder() -> super::types::builders::AggregateComplianceCountBuilder {
        super::types::builders::AggregateComplianceCountBuilder::default()
    }
}
...
impl AggregateComplianceCountBuilder {
    ...
    pub fn build(self) -> super::types::AggregateComplianceCount {
        super::types::AggregateComplianceCount {
