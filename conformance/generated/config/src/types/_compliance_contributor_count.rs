...
impl ComplianceContributorCount {
    ...
    pub fn builder() -> super::types::builders::ComplianceContributorCountBuilder {
        super::types::builders::ComplianceContributorCountBuilder::default()
    }
}
...
impl ComplianceContributorCountBuilder {
    ...
    pub fn build(self) -> super::types::ComplianceContributorCount {
        super::types::ComplianceContributorCount {
