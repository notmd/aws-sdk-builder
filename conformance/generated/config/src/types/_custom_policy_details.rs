...
impl CustomPolicyDetails {
    ...
    pub fn builder() -> super::types::builders::CustomPolicyDetailsBuilder {
        super::types::builders::CustomPolicyDetailsBuilder::default()
    }
}
...
impl CustomPolicyDetailsBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::CustomPolicyDetails, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::CustomPolicyDetails {
