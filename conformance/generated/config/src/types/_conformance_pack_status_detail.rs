...
pub struct ConformancePackStatusDetail {
    ...
    /// </ul>
    pub conformance_pack_state: super::types::ConformancePackState,
...
impl ConformancePackStatusDetail {
    ...
    /// <p>DELETE_FAILED when a conformance pack deletion failed in your account.</p></li>
    /// </ul>
    pub fn conformance_pack_state(&self) -> &super::types::ConformancePackState {
...
impl ConformancePackStatusDetail {
    ...
    pub fn builder() -> super::types::builders::ConformancePackStatusDetailBuilder {
        super::types::builders::ConformancePackStatusDetailBuilder::default()
    }
}
...
pub struct ConformancePackStatusDetailBuilder {
    ...
    pub(crate) conformance_pack_state: ::std::option::Option<super::types::ConformancePackState>,
...
impl ConformancePackStatusDetailBuilder {
    ...
    /// </ul>
    /// This field is required.
    pub fn conformance_pack_state(mut self, input: super::types::ConformancePackState) -> Self {
    ...
    /// <p>DELETE_FAILED when a conformance pack deletion failed in your account.</p></li>
    /// </ul>
    pub fn set_conformance_pack_state(mut self, input: ::std::option::Option<super::types::ConformancePackState>) -> Self {
    ...
    /// <p>DELETE_FAILED when a conformance pack deletion failed in your account.</p></li>
    /// </ul>
    pub fn get_conformance_pack_state(&self) -> &::std::option::Option<super::types::ConformancePackState> {
        &self.conformance_pack_state
    }
    /// <p>Amazon Resource Name (ARN) of CloudFormation stack.</p>
    /// This field is required.
    ...
    pub fn build(self) -> ::std::result::Result<super::types::ConformancePackStatusDetail, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ConformancePackStatusDetail {
