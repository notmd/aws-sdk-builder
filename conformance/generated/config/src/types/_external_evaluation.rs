...
pub struct ExternalEvaluation {
    ...
    pub compliance_type: super::types::ComplianceType,
...
impl ExternalEvaluation {
    ...
    /// <p>The compliance of the Amazon Web Services resource. The valid values are <code>COMPLIANT, NON_COMPLIANT, </code> and <code>NOT_APPLICABLE</code>.</p>
    pub fn compliance_type(&self) -> &super::types::ComplianceType {
...
impl ExternalEvaluation {
    ...
    pub fn builder() -> super::types::builders::ExternalEvaluationBuilder {
        super::types::builders::ExternalEvaluationBuilder::default()
    }
}
...
impl ExternalEvaluationBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::ExternalEvaluation, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ExternalEvaluation {
