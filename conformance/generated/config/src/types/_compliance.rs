...
pub struct Compliance {
    ...
    pub compliance_contributor_count: ::std::option::Option<super::types::ComplianceContributorCount>,
}
impl Compliance {
    /// <p>Indicates whether an Amazon Web Services resource or Config rule is compliant.</p>
    /// <p>A resource is compliant if it complies with all of the Config rules that evaluate it. A resource is noncompliant if it does not comply with one or more of these rules.</p>
    ...
    /// <p>The number of Amazon Web Services resources or Config rules that cause a result of <code>NON_COMPLIANT</code>, up to a maximum number.</p>
    pub fn compliance_contributor_count(&self) -> ::std::option::Option<&super::types::ComplianceContributorCount> {
...
impl Compliance {
    ...
    pub fn builder() -> super::types::builders::ComplianceBuilder {
        super::types::builders::ComplianceBuilder::default()
    }
}
...
pub struct ComplianceBuilder {
    ...
    pub(crate) compliance_contributor_count: ::std::option::Option<super::types::ComplianceContributorCount>,
}
impl ComplianceBuilder {
    ...
    /// <p>The number of Amazon Web Services resources or Config rules that cause a result of <code>NON_COMPLIANT</code>, up to a maximum number.</p>
    pub fn compliance_contributor_count(mut self, input: super::types::ComplianceContributorCount) -> Self {
        self.compliance_contributor_count = ::std::option::Option::Some(input);
        self
    }
    /// <p>The number of Amazon Web Services resources or Config rules that cause a result of <code>NON_COMPLIANT</code>, up to a maximum number.</p>
    pub fn set_compliance_contributor_count(mut self, input: ::std::option::Option<super::types::ComplianceContributorCount>) -> Self {
        self.compliance_contributor_count = input;
        self
    }
    /// <p>The number of Amazon Web Services resources or Config rules that cause a result of <code>NON_COMPLIANT</code>, up to a maximum number.</p>
    pub fn get_compliance_contributor_count(&self) -> &::std::option::Option<super::types::ComplianceContributorCount> {
        &self.compliance_contributor_count
    }
    /// Consumes the builder and constructs a [`Compliance`](crate::types::Compliance).
    pub fn build(self) -> super::types::Compliance {
        super::types::Compliance {
