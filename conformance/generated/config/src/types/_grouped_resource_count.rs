...
impl GroupedResourceCount {
    ...
    pub fn builder() -> super::types::builders::GroupedResourceCountBuilder {
        super::types::builders::GroupedResourceCountBuilder::default()
    }
}
...
impl GroupedResourceCountBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::GroupedResourceCount, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::GroupedResourceCount {
