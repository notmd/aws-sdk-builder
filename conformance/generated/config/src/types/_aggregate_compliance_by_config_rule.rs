...
pub struct AggregateComplianceByConfigRule {
    ...
    pub compliance: ::std::option::Option<super::types::Compliance>,
...
impl AggregateComplianceByConfigRule {
    ...
    /// <p>Indicates whether an Amazon Web Services resource or Config rule is compliant and provides the number of contributors that affect the compliance.</p>
    pub fn compliance(&self) -> ::std::option::Option<&super::types::Compliance> {
...
impl AggregateComplianceByConfigRule {
    ...
    pub fn builder() -> super::types::builders::AggregateComplianceByConfigRuleBuilder {
        super::types::builders::AggregateComplianceByConfigRuleBuilder::default()
    }
}
...
pub struct AggregateComplianceByConfigRuleBuilder {
    ...
    pub(crate) compliance: ::std::option::Option<super::types::Compliance>,
...
impl AggregateComplianceByConfigRuleBuilder {
    ...
    /// <p>Indicates whether an Amazon Web Services resource or Config rule is compliant and provides the number of contributors that affect the compliance.</p>
    pub fn compliance(mut self, input: super::types::Compliance) -> Self {
        self.compliance = ::std::option::Option::Some(input);
        self
    }
    /// <p>Indicates whether an Amazon Web Services resource or Config rule is compliant and provides the number of contributors that affect the compliance.</p>
    pub fn set_compliance(mut self, input: ::std::option::Option<super::types::Compliance>) -> Self {
        self.compliance = input;
        self
    }
    /// <p>Indicates whether an Amazon Web Services resource or Config rule is compliant and provides the number of contributors that affect the compliance.</p>
    pub fn get_compliance(&self) -> &::std::option::Option<super::types::Compliance> {
        &self.compliance
    }
    /// <p>The 12-digit account ID of the source account.</p>
    ...
    pub fn build(self) -> super::types::AggregateComplianceByConfigRule {
        super::types::AggregateComplianceByConfigRule {
