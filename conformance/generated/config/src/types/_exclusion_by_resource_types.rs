...
impl ExclusionByResourceTypes {
    ...
    pub fn builder() -> super::types::builders::ExclusionByResourceTypesBuilder {
        super::types::builders::ExclusionByResourceTypesBuilder::default()
    }
}
...
impl ExclusionByResourceTypesBuilder {
    ...
    pub fn build(self) -> super::types::ExclusionByResourceTypes {
        super::types::ExclusionByResourceTypes {
