...
impl ComplianceByResource {
    ...
    pub fn builder() -> super::types::builders::ComplianceByResourceBuilder {
        super::types::builders::ComplianceByResourceBuilder::default()
    }
}
...
impl ComplianceByResourceBuilder {
    ...
    pub fn build(self) -> super::types::ComplianceByResource {
