...
impl AzureConnectorConfiguration {
    ...
    pub fn builder() -> super::types::builders::AzureConnectorConfigurationBuilder {
        super::types::builders::AzureConnectorConfigurationBuilder::default()
    }
}
...
impl AzureConnectorConfigurationBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::AzureConnectorConfiguration, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::AzureConnectorConfiguration {
