...
pub struct ConfigurationRecorderStatus {
    ...
    pub last_status: ::std::option::Option<super::types::RecorderStatus>,
...
impl ConfigurationRecorderStatus {
    ...
    /// <p>The status of the latest recording event processed by the recorder.</p>
    pub fn last_status(&self) -> ::std::option::Option<&super::types::RecorderStatus> {
...
impl ConfigurationRecorderStatus {
    ...
    pub fn builder() -> super::types::builders::ConfigurationRecorderStatusBuilder {
        super::types::builders::ConfigurationRecorderStatusBuilder::default()
    }
}
...
pub struct ConfigurationRecorderStatusBuilder {
    ...
    pub(crate) last_status: ::std::option::Option<super::types::RecorderStatus>,
...
impl ConfigurationRecorderStatusBuilder {
    ...
    /// <p>The status of the latest recording event processed by the recorder.</p>
    pub fn last_status(mut self, input: super::types::RecorderStatus) -> Self {
        self.last_status = ::std::option::Option::Some(input);
        self
    }
    /// <p>The status of the latest recording event processed by the recorder.</p>
    pub fn set_last_status(mut self, input: ::std::option::Option<super::types::RecorderStatus>) -> Self {
        self.last_status = input;
        self
    }
    /// <p>The status of the latest recording event processed by the recorder.</p>
    pub fn get_last_status(&self) -> &::std::option::Option<super::types::RecorderStatus> {
        &self.last_status
    }
    /// <p>The latest error code from when the recorder last failed.</p>
    ...
    pub fn build(self) -> super::types::ConfigurationRecorderStatus {
        super::types::ConfigurationRecorderStatus {
            arn: self.arn,
            name: self.name,
