...
impl RetentionConfiguration {
    ...
    pub fn builder() -> super::types::builders::RetentionConfigurationBuilder {
        super::types::builders::RetentionConfigurationBuilder::default()
    }
}
...
impl RetentionConfigurationBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::RetentionConfiguration, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::RetentionConfiguration {
