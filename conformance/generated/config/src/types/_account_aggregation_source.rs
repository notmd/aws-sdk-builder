...
impl AccountAggregationSource {
    ...
    pub fn builder() -> super::types::builders::AccountAggregationSourceBuilder {
        super::types::builders::AccountAggregationSourceBuilder::default()
    }
}
...
impl AccountAggregationSourceBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::AccountAggregationSource, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::AccountAggregationSource {
