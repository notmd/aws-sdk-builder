...
impl ConfigRuleComplianceSummaryFilters {
    ...
    pub fn builder() -> super::types::builders::ConfigRuleComplianceSummaryFiltersBuilder {
        super::types::builders::ConfigRuleComplianceSummaryFiltersBuilder::default()
    }
}
...
impl ConfigRuleComplianceSummaryFiltersBuilder {
    ...
    pub fn build(self) -> super::types::ConfigRuleComplianceSummaryFilters {
        super::types::ConfigRuleComplianceSummaryFilters {
