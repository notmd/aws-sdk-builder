...
impl OrganizationManagedRuleMetadata {
    ...
    pub fn builder() -> super::types::builders::OrganizationManagedRuleMetadataBuilder {
        super::types::builders::OrganizationManagedRuleMetadataBuilder::default()
    }
}
...
impl OrganizationManagedRuleMetadataBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::OrganizationManagedRuleMetadata, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::OrganizationManagedRuleMetadata {
