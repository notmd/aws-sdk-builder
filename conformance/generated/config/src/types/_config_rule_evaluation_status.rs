...
impl ConfigRuleEvaluationStatus {
    ...
    pub fn builder() -> super::types::builders::ConfigRuleEvaluationStatusBuilder {
        super::types::builders::ConfigRuleEvaluationStatusBuilder::default()
    }
}
...
impl ConfigRuleEvaluationStatusBuilder {
    ...
    pub fn build(self) -> super::types::ConfigRuleEvaluationStatus {
