...
impl ResourceEvaluation {
    ...
    pub fn builder() -> super::types::builders::ResourceEvaluationBuilder {
        super::types::builders::ResourceEvaluationBuilder::default()
    }
}
...
impl ResourceEvaluationBuilder {
    ...
    pub fn build(self) -> super::types::ResourceEvaluation {
