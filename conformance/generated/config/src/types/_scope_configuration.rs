...
impl ScopeConfiguration {
    ...
    pub fn builder() -> super::types::builders::ScopeConfigurationBuilder {
        super::types::builders::ScopeConfigurationBuilder::default()
    }
}
...
impl ScopeConfigurationBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::ScopeConfiguration, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ScopeConfiguration {
