...
pub struct EvaluationResultIdentifier {
    ...
    pub evaluation_result_qualifier: ::std::option::Option<super::types::EvaluationResultQualifier>,
...
impl EvaluationResultIdentifier {
    /// <p>Identifies an Config rule used to evaluate an Amazon Web Services resource, and provides the type and ID of the evaluated resource.</p>
    pub fn evaluation_result_qualifier(&self) -> ::std::option::Option<&super::types::EvaluationResultQualifier> {
...
impl EvaluationResultIdentifier {
    ...
    pub fn builder() -> super::types::builders::EvaluationResultIdentifierBuilder {
        super::types::builders::EvaluationResultIdentifierBuilder::default()
    }
}
...
pub struct EvaluationResultIdentifierBuilder {
    pub(crate) evaluation_result_qualifier: ::std::option::Option<super::types::EvaluationResultQualifier>,
...
impl EvaluationResultIdentifierBuilder {
    /// <p>Identifies an Config rule used to evaluate an Amazon Web Services resource, and provides the type and ID of the evaluated resource.</p>
    pub fn evaluation_result_qualifier(mut self, input: super::types::EvaluationResultQualifier) -> Self {
        self.evaluation_result_qualifier = ::std::option::Option::Some(input);
        self
    }
    /// <p>Identifies an Config rule used to evaluate an Amazon Web Services resource, and provides the type and ID of the evaluated resource.</p>
    pub fn set_evaluation_result_qualifier(mut self, input: ::std::option::Option<super::types::EvaluationResultQualifier>) -> Self {
        self.evaluation_result_qualifier = input;
        self
    }
    /// <p>Identifies an Config rule used to evaluate an Amazon Web Services resource, and provides the type and ID of the evaluated resource.</p>
    pub fn get_evaluation_result_qualifier(&self) -> &::std::option::Option<super::types::EvaluationResultQualifier> {
    ...
    pub fn build(self) -> super::types::EvaluationResultIdentifier {
        super::types::EvaluationResultIdentifier {
