...
impl StoredQueryMetadata {
    ...
    pub fn builder() -> super::types::builders::StoredQueryMetadataBuilder {
        super::types::builders::StoredQueryMetadataBuilder::default()
    }
}
...
impl StoredQueryMetadataBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::StoredQueryMetadata, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::StoredQueryMetadata {
