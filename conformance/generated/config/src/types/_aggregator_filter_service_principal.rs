...
pub struct AggregatorFilterServicePrincipal {
    ...
    pub r#type: ::std::option::Option<super::types::AggregatorFilterType>,
...
impl AggregatorFilterServicePrincipal {
    /// <p>The type of service principal filter to apply. <code>INCLUDE</code> specifies that the list of service principals in the <code>Value</code> field will be aggregated and no other service principals will be filtered.</p>
    pub fn r#type(&self) -> ::std::option::Option<&super::types::AggregatorFilterType> {
        self.r#type.as_ref()
    }
    /// <p>Comma-separated list of service principals for the linked Amazon Web Services services to filter your aggregated service-linked configuration recorders.</p>
    ///
...
impl AggregatorFilterServicePrincipal {
    ...
    pub fn builder() -> super::types::builders::AggregatorFilterServicePrincipalBuilder {
        super::types::builders::AggregatorFilterServicePrincipalBuilder::default()
    }
}
...
pub struct AggregatorFilterServicePrincipalBuilder {
    pub(crate) r#type: ::std::option::Option<super::types::AggregatorFilterType>,
    pub(crate) value: ::std::option::Option<::std::vec::Vec<::std::string::String>>,
}
impl AggregatorFilterServicePrincipalBuilder {
    /// <p>The type of service principal filter to apply. <code>INCLUDE</code> specifies that the list of service principals in the <code>Value</code> field will be aggregated and no other service principals will be filtered.</p>
    pub fn r#type(mut self, input: super::types::AggregatorFilterType) -> Self {
        self.r#type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The type of service principal filter to apply. <code>INCLUDE</code> specifies that the list of service principals in the <code>Value</code> field will be aggregated and no other service principals will be filtered.</p>
    pub fn set_type(mut self, input: ::std::option::Option<super::types::AggregatorFilterType>) -> Self {
        self.r#type = input;
        self
    }
    /// <p>The type of service principal filter to apply. <code>INCLUDE</code> specifies that the list of service principals in the <code>Value</code> field will be aggregated and no other service principals will be filtered.</p>
    pub fn get_type(&self) -> &::std::option::Option<super::types::AggregatorFilterType> {
        &self.r#type
    }
    ...
    pub fn build(self) -> super::types::AggregatorFilterServicePrincipal {
        super::types::AggregatorFilterServicePrincipal {
            r#type: self.r#type,
            value: self.value,
        }
    }
