...
impl ConformancePackDetail {
    ...
    pub fn builder() -> super::types::builders::ConformancePackDetailBuilder {
        super::types::builders::ConformancePackDetailBuilder::default()
    }
}
...
impl ConformancePackDetailBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::ConformancePackDetail, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ConformancePackDetail {
