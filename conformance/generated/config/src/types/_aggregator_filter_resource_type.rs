...
impl AggregatorFilterResourceType {
    ...
    pub fn builder() -> super::types::builders::AggregatorFilterResourceTypeBuilder {
        super::types::builders::AggregatorFilterResourceTypeBuilder::default()
    }
}
...
impl AggregatorFilterResourceTypeBuilder {
    ...
    pub fn build(self) -> super::types::AggregatorFilterResourceType {
        super::types::AggregatorFilterResourceType {
            r#type: self.r#type,
            value: self.value,
        }
    }
