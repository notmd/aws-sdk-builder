...
impl EvaluationContext {
    ...
    pub fn builder() -> super::types::builders::EvaluationContextBuilder {
        super::types::builders::EvaluationContextBuilder::default()
    }
}
...
impl EvaluationContextBuilder {
    ...
    pub fn build(self) -> super::types::EvaluationContext {
        super::types::EvaluationContext {
