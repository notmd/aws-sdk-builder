...
pub struct QueryInfo {
    ...
    pub select_fields: ::std::option::Option<::std::vec::Vec<super::types::FieldInfo>>,
}
impl QueryInfo {
    /// <p>Returns a <code>FieldInfo</code> object.</p>
    ///
    ...
    pub fn select_fields(&self) -> &[super::types::FieldInfo] {
...
pub struct QueryInfoBuilder {
    pub(crate) select_fields: ::std::option::Option<::std::vec::Vec<super::types::FieldInfo>>,
}
impl QueryInfoBuilder {
    ...
    ///
    /// <p>Returns a <code>FieldInfo</code> object.</p>
    pub fn select_fields(mut self, input: super::types::FieldInfo) -> Self {
    ...
    /// <p>Returns a <code>FieldInfo</code> object.</p>
    pub fn set_select_fields(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::FieldInfo>>) -> Self {
        self.select_fields = input;
        self
    }
    /// <p>Returns a <code>FieldInfo</code> object.</p>
    pub fn get_select_fields(&self) -> &::std::option::Option<::std::vec::Vec<super::types::FieldInfo>> {
        &self.select_fields
    }
