...
impl AggregateConformancePackCompliance {
    ...
    pub fn builder() -> super::types::builders::AggregateConformancePackComplianceBuilder {
        super::types::builders::AggregateConformancePackComplianceBuilder::default()
    }
}
...
impl AggregateConformancePackComplianceBuilder {
    ...
    pub fn build(self) -> super::types::AggregateConformancePackCompliance {
        super::types::AggregateConformancePackCompliance {
