...
impl BaseConfigurationItem {
    ...
    pub fn builder() -> super::types::builders::BaseConfigurationItemBuilder {
        super::types::builders::BaseConfigurationItemBuilder::default()
    }
}
...
impl BaseConfigurationItemBuilder {
    ...
    pub fn build(self) -> super::types::BaseConfigurationItem {
        super::types::BaseConfigurationItem {
