...
impl TimeWindow {
    ...
    pub fn builder() -> super::types::builders::TimeWindowBuilder {
        super::types::builders::TimeWindowBuilder::default()
    }
}
...
impl TimeWindowBuilder {
    ...
    pub fn build(self) -> super::types::TimeWindow {
        super::types::TimeWindow {
