...
impl ConfigRuleComplianceFilters {
    ...
    pub fn builder() -> super::types::builders::ConfigRuleComplianceFiltersBuilder {
        super::types::builders::ConfigRuleComplianceFiltersBuilder::default()
    }
}
...
impl ConfigRuleComplianceFiltersBuilder {
    ...
    pub fn build(self) -> super::types::ConfigRuleComplianceFilters {
        super::types::ConfigRuleComplianceFilters {
