...
impl EvaluationResultQualifier {
    ...
    pub fn builder() -> super::types::builders::EvaluationResultQualifierBuilder {
        super::types::builders::EvaluationResultQualifierBuilder::default()
    }
}
...
impl EvaluationResultQualifierBuilder {
    ...
    pub fn build(self) -> super::types::EvaluationResultQualifier {
        super::types::EvaluationResultQualifier {
