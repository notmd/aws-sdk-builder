...
pub struct ConformancePackEvaluationResult {
    ...
    pub compliance_type: super::types::ConformancePackComplianceType,
    /// <p>Uniquely identifies an evaluation result.</p>
    pub evaluation_result_identifier: ::std::option::Option<super::types::EvaluationResultIdentifier>,
...
impl ConformancePackEvaluationResult {
    /// <p>The compliance type. The allowed values are <code>COMPLIANT</code> and <code>NON_COMPLIANT</code>. <code>INSUFFICIENT_DATA</code> is not supported.</p>
    pub fn compliance_type(&self) -> &super::types::ConformancePackComplianceType {
        &self.compliance_type
    }
    /// <p>Uniquely identifies an evaluation result.</p>
    pub fn evaluation_result_identifier(&self) -> ::std::option::Option<&super::types::EvaluationResultIdentifier> {
...
impl ConformancePackEvaluationResult {
    ...
    pub fn builder() -> super::types::builders::ConformancePackEvaluationResultBuilder {
        super::types::builders::ConformancePackEvaluationResultBuilder::default()
    }
}
...
pub struct ConformancePackEvaluationResultBuilder {
    pub(crate) compliance_type: ::std::option::Option<super::types::ConformancePackComplianceType>,
    pub(crate) evaluation_result_identifier: ::std::option::Option<super::types::EvaluationResultIdentifier>,
...
impl ConformancePackEvaluationResultBuilder {
    ...
    pub fn compliance_type(mut self, input: super::types::ConformancePackComplianceType) -> Self {
        self.compliance_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The compliance type. The allowed values are <code>COMPLIANT</code> and <code>NON_COMPLIANT</code>. <code>INSUFFICIENT_DATA</code> is not supported.</p>
    pub fn set_compliance_type(mut self, input: ::std::option::Option<super::types::ConformancePackComplianceType>) -> Self {
        self.compliance_type = input;
        self
    }
    /// <p>The compliance type. The allowed values are <code>COMPLIANT</code> and <code>NON_COMPLIANT</code>. <code>INSUFFICIENT_DATA</code> is not supported.</p>
    pub fn get_compliance_type(&self) -> &::std::option::Option<super::types::ConformancePackComplianceType> {
        &self.compliance_type
    }
    /// <p>Uniquely identifies an evaluation result.</p>
    /// This field is required.
    pub fn evaluation_result_identifier(mut self, input: super::types::EvaluationResultIdentifier) -> Self {
        self.evaluation_result_identifier = ::std::option::Option::Some(input);
        self
    }
    /// <p>Uniquely identifies an evaluation result.</p>
    pub fn set_evaluation_result_identifier(mut self, input: ::std::option::Option<super::types::EvaluationResultIdentifier>) -> Self {
        self.evaluation_result_identifier = input;
        self
    }
    /// <p>Uniquely identifies an evaluation result.</p>
    pub fn get_evaluation_result_identifier(&self) -> &::std::option::Option<super::types::EvaluationResultIdentifier> {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::ConformancePackEvaluationResult, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ConformancePackEvaluationResult {
