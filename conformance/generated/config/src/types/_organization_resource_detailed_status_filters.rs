...
pub struct OrganizationResourceDetailedStatusFilters {
    ...
    /// </ul>
    pub status: ::std::option::Option<super::types::OrganizationResourceDetailedStatus>,
}
impl OrganizationResourceDetailedStatusFilters {
    ...
    /// <p><code>UPDATE_FAILED</code> when conformance pack deletion has failed in the member account.</p></li>
    /// </ul>
    pub fn status(&self) -> ::std::option::Option<&super::types::OrganizationResourceDetailedStatus> {
        self.status.as_ref()
    }
}
impl OrganizationResourceDetailedStatusFilters {
    ...
    pub fn builder() -> super::types::builders::OrganizationResourceDetailedStatusFiltersBuilder {
        super::types::builders::OrganizationResourceDetailedStatusFiltersBuilder::default()
    }
}
...
impl OrganizationResourceDetailedStatusFiltersBuilder {
    ...
    pub fn build(self) -> super::types::OrganizationResourceDetailedStatusFilters {
        super::types::OrganizationResourceDetailedStatusFilters {
