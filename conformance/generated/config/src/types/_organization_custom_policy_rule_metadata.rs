...
pub struct OrganizationCustomPolicyRuleMetadata {
    ...
    /// </ul>
    pub organization_config_rule_trigger_types: ::std::option::Option<::std::vec::Vec<super::types::OrganizationConfigRuleTriggerTypeNoSn>>,
...
impl OrganizationCustomPolicyRuleMetadata {
    ...
    pub fn organization_config_rule_trigger_types(&self) -> &[super::types::OrganizationConfigRuleTriggerTypeNoSn] {
...
impl OrganizationCustomPolicyRuleMetadata {
    ...
    pub fn builder() -> super::types::builders::OrganizationCustomPolicyRuleMetadataBuilder {
        super::types::builders::OrganizationCustomPolicyRuleMetadataBuilder::default()
    }
}
...
pub struct OrganizationCustomPolicyRuleMetadataBuilder {
    ...
    pub(crate) organization_config_rule_trigger_types: ::std::option::Option<::std::vec::Vec<super::types::OrganizationConfigRuleTriggerTypeNoSn>>,
...
impl OrganizationCustomPolicyRuleMetadataBuilder {
    ...
    /// <p><code>OversizedConfigurationItemChangeNotification</code> - Initiates an evaluation when Config delivers an oversized configuration item. Config may generate this notification type when a resource changes and the notification exceeds the maximum size allowed by Amazon SNS.</p></li>
    /// </ul>
    pub fn organization_config_rule_trigger_types(mut self, input: super::types::OrganizationConfigRuleTriggerTypeNoSn) -> Self {
    ...
    pub fn set_organization_config_rule_trigger_types(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::OrganizationConfigRuleTriggerTypeNoSn>>,
    ) -> Self {
    ...
    pub fn get_organization_config_rule_trigger_types(
        &self,
    ) -> &::std::option::Option<::std::vec::Vec<super::types::OrganizationConfigRuleTriggerTypeNoSn>> {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::types::OrganizationCustomPolicyRuleMetadata, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::OrganizationCustomPolicyRuleMetadata {
