...
impl OrganizationConformancePack {
    ...
    pub fn builder() -> super::types::builders::OrganizationConformancePackBuilder {
        super::types::builders::OrganizationConformancePackBuilder::default()
    }
}
...
impl OrganizationConformancePackBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::OrganizationConformancePack, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::OrganizationConformancePack {
