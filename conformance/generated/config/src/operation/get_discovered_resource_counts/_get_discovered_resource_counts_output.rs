...
pub struct GetDiscoveredResourceCountsOutput {
    ...
    pub resource_counts: ::std::option::Option<::std::vec::Vec<super::types::ResourceCount>>,
...
impl GetDiscoveredResourceCountsOutput {
    ...
    pub fn resource_counts(&self) -> &[super::types::ResourceCount] {
...
impl GetDiscoveredResourceCountsOutput {
    ...
    pub fn builder() -> super::operation::get_discovered_resource_counts::builders::GetDiscoveredResourceCountsOutputBuilder {
        super::operation::get_discovered_resource_counts::builders::GetDiscoveredResourceCountsOutputBuilder::default()
    }
}
...
pub struct GetDiscoveredResourceCountsOutputBuilder {
    ...
    pub(crate) resource_counts: ::std::option::Option<::std::vec::Vec<super::types::ResourceCount>>,
...
impl GetDiscoveredResourceCountsOutputBuilder {
    ...
    ///
    /// <p>The list of <code>ResourceCount</code> objects. Each object is listed in descending order by the number of resources.</p>
    pub fn resource_counts(mut self, input: super::types::ResourceCount) -> Self {
    ...
    /// <p>The list of <code>ResourceCount</code> objects. Each object is listed in descending order by the number of resources.</p>
    pub fn set_resource_counts(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::ResourceCount>>) -> Self {
        self.resource_counts = input;
        self
    }
    /// <p>The list of <code>ResourceCount</code> objects. Each object is listed in descending order by the number of resources.</p>
    pub fn get_resource_counts(&self) -> &::std::option::Option<::std::vec::Vec<super::types::ResourceCount>> {
    ...
    pub fn build(self) -> super::operation::get_discovered_resource_counts::GetDiscoveredResourceCountsOutput {
