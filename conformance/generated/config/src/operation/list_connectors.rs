    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_connectors::ListConnectorsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_connectors::ListConnectorsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListConnectorsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_connectors::de_list_connectors_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_connectors::de_list_connectors_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListConnectorsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_connectors::ListConnectorsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_connectors::ListConnectorsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_list_connectors::ser_list_connectors_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::list_connectors::ListConnectorsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_connectors::_list_connectors_input::ListConnectorsInput;

pub use super::operation::list_connectors::_list_connectors_output::ListConnectorsOutput;
