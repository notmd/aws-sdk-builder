...
pub struct PutConnectorInput {
    ...
    pub connector_configuration: ::std::option::Option<super::types::ConnectorConfiguration>,
...
impl PutConnectorInput {
    /// <p>The provider-specific configuration for connecting to the third-party cloud service provider.</p>
    pub fn connector_configuration(&self) -> ::std::option::Option<&super::types::ConnectorConfiguration> {
...
impl PutConnectorInput {
    ...
    pub fn builder() -> super::operation::put_connector::builders::PutConnectorInputBuilder {
        super::operation::put_connector::builders::PutConnectorInputBuilder::default()
    }
}
...
pub struct PutConnectorInputBuilder {
    pub(crate) connector_configuration: ::std::option::Option<super::types::ConnectorConfiguration>,
...
impl PutConnectorInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::put_connector::PutConnectorInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::put_connector::PutConnectorInput {
