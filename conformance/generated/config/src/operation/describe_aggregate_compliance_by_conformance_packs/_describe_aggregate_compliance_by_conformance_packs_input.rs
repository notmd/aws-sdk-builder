...
pub struct DescribeAggregateComplianceByConformancePacksInput {
    ...
    pub filters: ::std::option::Option<super::types::AggregateConformancePackComplianceFilters>,
...
impl DescribeAggregateComplianceByConformancePacksInput {
    ...
    /// <p>Filters the result by <code>AggregateConformancePackComplianceFilters</code> object.</p>
    pub fn filters(&self) -> ::std::option::Option<&super::types::AggregateConformancePackComplianceFilters> {
        self.filters.as_ref()
    }
    /// <p>The maximum number of conformance packs compliance details returned on each page. The default is maximum. If you specify 0, Config uses the default.</p>
...
impl DescribeAggregateComplianceByConformancePacksInput {
    ...
    {
        super::operation::describe_aggregate_compliance_by_conformance_packs::builders::DescribeAggregateComplianceByConformancePacksInputBuilder::default()
    }
}
...
pub struct DescribeAggregateComplianceByConformancePacksInputBuilder {
    ...
    pub(crate) filters: ::std::option::Option<super::types::AggregateConformancePackComplianceFilters>,
