...
pub struct DescribeAggregateComplianceByConformancePacksOutput {
    ...
    pub aggregate_compliance_by_conformance_packs: ::std::option::Option<::std::vec::Vec<super::types::AggregateComplianceByConformancePack>>,
...
impl DescribeAggregateComplianceByConformancePacksOutput {
    ...
    pub fn aggregate_compliance_by_conformance_packs(&self) -> &[super::types::AggregateComplianceByConformancePack] {
...
impl DescribeAggregateComplianceByConformancePacksOutput {
    ...
    {
        super::operation::describe_aggregate_compliance_by_conformance_packs::builders::DescribeAggregateComplianceByConformancePacksOutputBuilder::default()
    }
}
...
pub struct DescribeAggregateComplianceByConformancePacksOutputBuilder {
    pub(crate) aggregate_compliance_by_conformance_packs: ::std::option::Option<::std::vec::Vec<super::types::AggregateComplianceByConformancePack>>,
...
impl DescribeAggregateComplianceByConformancePacksOutputBuilder {
    ...
    ///
    /// <p>Returns the <code>AggregateComplianceByConformancePack</code> object.</p>
    pub fn aggregate_compliance_by_conformance_packs(mut self, input: super::types::AggregateComplianceByConformancePack) -> Self {
    ...
    pub fn set_aggregate_compliance_by_conformance_packs(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::AggregateComplianceByConformancePack>>,
    ) -> Self {
    ...
    pub fn build(self) -> super::operation::describe_aggregate_compliance_by_conformance_packs::DescribeAggregateComplianceByConformancePacksOutput {
