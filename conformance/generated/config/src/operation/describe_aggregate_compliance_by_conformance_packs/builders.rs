...
pub use super::operation::describe_aggregate_compliance_by_conformance_packs::_describe_aggregate_compliance_by_conformance_packs_input::DescribeAggregateComplianceByConformancePacksInputBuilder;

pub use super::operation::describe_aggregate_compliance_by_conformance_packs::_describe_aggregate_compliance_by_conformance_packs_output::DescribeAggregateComplianceByConformancePacksOutputBuilder;

impl super::operation::describe_aggregate_compliance_by_conformance_packs::builders::DescribeAggregateComplianceByConformancePacksInputBuilder {
...
pub struct DescribeAggregateComplianceByConformancePacksFluentBuilder {
    ...
    inner: super::operation::describe_aggregate_compliance_by_conformance_packs::builders::DescribeAggregateComplianceByConformancePacksInputBuilder,
...
impl DescribeAggregateComplianceByConformancePacksFluentBuilder {
    /// Creates a new `DescribeAggregateComplianceByConformancePacksFluentBuilder`.
    ...
    pub fn as_input(
        &self,
    ) -> &super::operation::describe_aggregate_compliance_by_conformance_packs::builders::DescribeAggregateComplianceByConformancePacksInputBuilder
    {
        &self.inner
    }
    ...
    > {
        ...
        super::operation::describe_aggregate_compliance_by_conformance_packs::DescribeAggregateComplianceByConformancePacks::orchestrate(
            &runtime_plugins,
            input,
        )
        .await
    ...
    pub fn into_paginator(
        self,
    ) -> super::operation::describe_aggregate_compliance_by_conformance_packs::paginator::DescribeAggregateComplianceByConformancePacksPaginator {
        super::operation::describe_aggregate_compliance_by_conformance_packs::paginator::DescribeAggregateComplianceByConformancePacksPaginator::new(
            self.handle,
            self.inner,
        )
    }
    ...
    pub fn filters(mut self, input: super::types::AggregateConformancePackComplianceFilters) -> Self {
        self.inner = self.inner.filters(input);
        self
    }
    /// <p>Filters the result by <code>AggregateConformancePackComplianceFilters</code> object.</p>
    pub fn set_filters(mut self, input: ::std::option::Option<super::types::AggregateConformancePackComplianceFilters>) -> Self {
        self.inner = self.inner.set_filters(input);
        self
    }
    /// <p>Filters the result by <code>AggregateConformancePackComplianceFilters</code> object.</p>
    pub fn get_filters(&self) -> &::std::option::Option<super::types::AggregateConformancePackComplianceFilters> {
