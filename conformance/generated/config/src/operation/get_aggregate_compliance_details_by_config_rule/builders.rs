...
pub use super::operation::get_aggregate_compliance_details_by_config_rule::_get_aggregate_compliance_details_by_config_rule_input::GetAggregateComplianceDetailsByConfigRuleInputBuilder;

pub use super::operation::get_aggregate_compliance_details_by_config_rule::_get_aggregate_compliance_details_by_config_rule_output::GetAggregateComplianceDetailsByConfigRuleOutputBuilder;

impl super::operation::get_aggregate_compliance_details_by_config_rule::builders::GetAggregateComplianceDetailsByConfigRuleInputBuilder {
...
pub struct GetAggregateComplianceDetailsByConfigRuleFluentBuilder {
    ...
    inner: super::operation::get_aggregate_compliance_details_by_config_rule::builders::GetAggregateComplianceDetailsByConfigRuleInputBuilder,
...
impl GetAggregateComplianceDetailsByConfigRuleFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &super::operation::get_aggregate_compliance_details_by_config_rule::builders::GetAggregateComplianceDetailsByConfigRuleInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            super::operation::get_aggregate_compliance_details_by_config_rule::GetAggregateComplianceDetailsByConfigRule::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        super::operation::get_aggregate_compliance_details_by_config_rule::GetAggregateComplianceDetailsByConfigRule::orchestrate(
            &runtime_plugins,
            input,
        )
        .await
    ...
    pub fn into_paginator(
        self,
    ) -> super::operation::get_aggregate_compliance_details_by_config_rule::paginator::GetAggregateComplianceDetailsByConfigRulePaginator {
        super::operation::get_aggregate_compliance_details_by_config_rule::paginator::GetAggregateComplianceDetailsByConfigRulePaginator::new(
            self.handle,
            self.inner,
        )
    }
    ...
    /// </note>
    pub fn compliance_type(mut self, input: super::types::ComplianceType) -> Self {
    ...
    /// <p>For the <code>GetAggregateComplianceDetailsByConfigRuleRequest</code> data type, Config supports only the <code>COMPLIANT</code> and <code>NON_COMPLIANT</code>. Config does not support the <code>NOT_APPLICABLE</code> and <code>INSUFFICIENT_DATA</code> values.</p>
    /// </note>
    pub fn set_compliance_type(mut self, input: ::std::option::Option<super::types::ComplianceType>) -> Self {
    ...
    /// <p>For the <code>GetAggregateComplianceDetailsByConfigRuleRequest</code> data type, Config supports only the <code>COMPLIANT</code> and <code>NON_COMPLIANT</code>. Config does not support the <code>NOT_APPLICABLE</code> and <code>INSUFFICIENT_DATA</code> values.</p>
    /// </note>
    pub fn get_compliance_type(&self) -> &::std::option::Option<super::types::ComplianceType> {
