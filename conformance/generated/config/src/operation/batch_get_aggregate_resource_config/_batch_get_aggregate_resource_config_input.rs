...
impl BatchGetAggregateResourceConfigInput {
    ...
    pub fn builder() -> super::operation::batch_get_aggregate_resource_config::builders::BatchGetAggregateResourceConfigInputBuilder {
        super::operation::batch_get_aggregate_resource_config::builders::BatchGetAggregateResourceConfigInputBuilder::default()
    }
}
...
impl BatchGetAggregateResourceConfigInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::batch_get_aggregate_resource_config::BatchGetAggregateResourceConfigInput,
