...
pub use super::operation::batch_get_aggregate_resource_config::_batch_get_aggregate_resource_config_input::BatchGetAggregateResourceConfigInputBuilder;

pub use super::operation::batch_get_aggregate_resource_config::_batch_get_aggregate_resource_config_output::BatchGetAggregateResourceConfigOutputBuilder;

impl super::operation::batch_get_aggregate_resource_config::builders::BatchGetAggregateResourceConfigInputBuilder {
...
pub struct BatchGetAggregateResourceConfigFluentBuilder {
    ...
    inner: super::operation::batch_get_aggregate_resource_config::builders::BatchGetAggregateResourceConfigInputBuilder,
...
impl BatchGetAggregateResourceConfigFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::batch_get_aggregate_resource_config::builders::BatchGetAggregateResourceConfigInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::batch_get_aggregate_resource_config::BatchGetAggregateResourceConfig::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::batch_get_aggregate_resource_config::BatchGetAggregateResourceConfig::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn resource_identifiers(mut self, input: super::types::AggregateResourceIdentifier) -> Self {
        self.inner = self.inner.resource_identifiers(input);
        self
    }
    /// <p>A list of aggregate ResourceIdentifiers objects.</p>
    pub fn set_resource_identifiers(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::AggregateResourceIdentifier>>) -> Self {
        self.inner = self.inner.set_resource_identifiers(input);
        self
    }
    /// <p>A list of aggregate ResourceIdentifiers objects.</p>
    pub fn get_resource_identifiers(&self) -> &::std::option::Option<::std::vec::Vec<super::types::AggregateResourceIdentifier>> {
