...
pub struct BatchGetAggregateResourceConfigOutput {
    ...
    pub base_configuration_items: ::std::option::Option<::std::vec::Vec<super::types::BaseConfigurationItem>>,
    ...
    pub unprocessed_resource_identifiers: ::std::option::Option<::std::vec::Vec<super::types::AggregateResourceIdentifier>>,
...
impl BatchGetAggregateResourceConfigOutput {
    ...
    pub fn base_configuration_items(&self) -> &[super::types::BaseConfigurationItem] {
    ...
    pub fn unprocessed_resource_identifiers(&self) -> &[super::types::AggregateResourceIdentifier] {
...
impl BatchGetAggregateResourceConfigOutput {
    ...
    pub fn builder() -> super::operation::batch_get_aggregate_resource_config::builders::BatchGetAggregateResourceConfigOutputBuilder {
        super::operation::batch_get_aggregate_resource_config::builders::BatchGetAggregateResourceConfigOutputBuilder::default()
    }
}
...
pub struct BatchGetAggregateResourceConfigOutputBuilder {
    pub(crate) base_configuration_items: ::std::option::Option<::std::vec::Vec<super::types::BaseConfigurationItem>>,
    pub(crate) unprocessed_resource_identifiers: ::std::option::Option<::std::vec::Vec<super::types::AggregateResourceIdentifier>>,
    _request_id: Option<String>,
}
impl BatchGetAggregateResourceConfigOutputBuilder {
    ...
    ///
    /// <p>A list that contains the current configuration of one or more resources.</p>
    pub fn base_configuration_items(mut self, input: super::types::BaseConfigurationItem) -> Self {
    ...
    /// <p>A list that contains the current configuration of one or more resources.</p>
    pub fn set_base_configuration_items(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::BaseConfigurationItem>>) -> Self {
        self.base_configuration_items = input;
        self
    }
    /// <p>A list that contains the current configuration of one or more resources.</p>
    pub fn get_base_configuration_items(&self) -> &::std::option::Option<::std::vec::Vec<super::types::BaseConfigurationItem>> {
    ...
    ///
    /// <p>A list of resource identifiers that were not processed with current scope. The list is empty if all the resources are processed.</p>
    pub fn unprocessed_resource_identifiers(mut self, input: super::types::AggregateResourceIdentifier) -> Self {
    ...
    pub fn set_unprocessed_resource_identifiers(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::AggregateResourceIdentifier>>,
    ) -> Self {
        self.unprocessed_resource_identifiers = input;
        self
    }
    /// <p>A list of resource identifiers that were not processed with current scope. The list is empty if all the resources are processed.</p>
    pub fn get_unprocessed_resource_identifiers(&self) -> &::std::option::Option<::std::vec::Vec<super::types::AggregateResourceIdentifier>> {
    ...
    pub fn build(self) -> super::operation::batch_get_aggregate_resource_config::BatchGetAggregateResourceConfigOutput {
