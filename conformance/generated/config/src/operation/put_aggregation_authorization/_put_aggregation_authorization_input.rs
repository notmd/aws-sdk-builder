...
impl PutAggregationAuthorizationInput {
    ...
    pub fn builder() -> super::operation::put_aggregation_authorization::builders::PutAggregationAuthorizationInputBuilder {
        super::operation::put_aggregation_authorization::builders::PutAggregationAuthorizationInputBuilder::default()
    }
}
...
impl PutAggregationAuthorizationInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::put_aggregation_authorization::PutAggregationAuthorizationInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::put_aggregation_authorization::PutAggregationAuthorizationInput {
