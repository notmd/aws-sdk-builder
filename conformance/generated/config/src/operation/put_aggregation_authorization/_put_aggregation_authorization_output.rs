...
pub struct PutAggregationAuthorizationOutput {
    ...
    pub aggregation_authorization: ::std::option::Option<super::types::AggregationAuthorization>,
    _request_id: Option<String>,
}
impl PutAggregationAuthorizationOutput {
    /// <p>Returns an AggregationAuthorization object.</p>
    pub fn aggregation_authorization(&self) -> ::std::option::Option<&super::types::AggregationAuthorization> {
...
impl PutAggregationAuthorizationOutput {
    ...
    pub fn builder() -> super::operation::put_aggregation_authorization::builders::PutAggregationAuthorizationOutputBuilder {
        super::operation::put_aggregation_authorization::builders::PutAggregationAuthorizationOutputBuilder::default()
    }
}
...
pub struct PutAggregationAuthorizationOutputBuilder {
    pub(crate) aggregation_authorization: ::std::option::Option<super::types::AggregationAuthorization>,
    _request_id: Option<String>,
}
impl PutAggregationAuthorizationOutputBuilder {
    /// <p>Returns an AggregationAuthorization object.</p>
    pub fn aggregation_authorization(mut self, input: super::types::AggregationAuthorization) -> Self {
        self.aggregation_authorization = ::std::option::Option::Some(input);
        self
    }
    /// <p>Returns an AggregationAuthorization object.</p>
    pub fn set_aggregation_authorization(mut self, input: ::std::option::Option<super::types::AggregationAuthorization>) -> Self {
        self.aggregation_authorization = input;
        self
    }
    /// <p>Returns an AggregationAuthorization object.</p>
    pub fn get_aggregation_authorization(&self) -> &::std::option::Option<super::types::AggregationAuthorization> {
    ...
    pub fn build(self) -> super::operation::put_aggregation_authorization::PutAggregationAuthorizationOutput {
