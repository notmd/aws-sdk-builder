    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::put_connector::PutConnectorError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::put_connector::PutConnectorOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutConnectorResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_put_connector::de_put_connector_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_put_connector::de_put_connector_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutConnectorRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::put_connector::PutConnectorInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::put_connector::PutConnectorInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_put_connector::ser_put_connector_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::put_connector::PutConnectorError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::put_connector::_put_connector_input::PutConnectorInput;

pub use super::operation::put_connector::_put_connector_output::PutConnectorOutput;
