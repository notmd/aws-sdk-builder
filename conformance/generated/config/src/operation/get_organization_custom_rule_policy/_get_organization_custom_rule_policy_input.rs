...
impl GetOrganizationCustomRulePolicyInput {
    ...
    pub fn builder() -> super::operation::get_organization_custom_rule_policy::builders::GetOrganizationCustomRulePolicyInputBuilder {
        super::operation::get_organization_custom_rule_policy::builders::GetOrganizationCustomRulePolicyInputBuilder::default()
    }
}
...
impl GetOrganizationCustomRulePolicyInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::get_organization_custom_rule_policy::GetOrganizationCustomRulePolicyInput,
