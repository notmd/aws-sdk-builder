...
impl GetOrganizationCustomRulePolicyOutput {
    ...
    pub fn builder() -> super::operation::get_organization_custom_rule_policy::builders::GetOrganizationCustomRulePolicyOutputBuilder {
        super::operation::get_organization_custom_rule_policy::builders::GetOrganizationCustomRulePolicyOutputBuilder::default()
    }
}
...
impl GetOrganizationCustomRulePolicyOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_organization_custom_rule_policy::GetOrganizationCustomRulePolicyOutput {
