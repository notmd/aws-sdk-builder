...
pub struct DescribeRemediationConfigurationsOutput {
    ...
    pub remediation_configurations: ::std::option::Option<::std::vec::Vec<super::types::RemediationConfiguration>>,
...
impl DescribeRemediationConfigurationsOutput {
    ...
    pub fn remediation_configurations(&self) -> &[super::types::RemediationConfiguration] {
...
impl DescribeRemediationConfigurationsOutput {
    ...
    pub fn builder() -> super::operation::describe_remediation_configurations::builders::DescribeRemediationConfigurationsOutputBuilder {
        super::operation::describe_remediation_configurations::builders::DescribeRemediationConfigurationsOutputBuilder::default()
    }
}
...
pub struct DescribeRemediationConfigurationsOutputBuilder {
    pub(crate) remediation_configurations: ::std::option::Option<::std::vec::Vec<super::types::RemediationConfiguration>>,
    _request_id: Option<String>,
}
impl DescribeRemediationConfigurationsOutputBuilder {
    ...
    pub fn build(self) -> super::operation::describe_remediation_configurations::DescribeRemediationConfigurationsOutput {
