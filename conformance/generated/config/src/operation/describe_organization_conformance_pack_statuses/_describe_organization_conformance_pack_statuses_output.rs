...
pub struct DescribeOrganizationConformancePackStatusesOutput {
    ...
    pub organization_conformance_pack_statuses: ::std::option::Option<::std::vec::Vec<super::types::OrganizationConformancePackStatus>>,
...
impl DescribeOrganizationConformancePackStatusesOutput {
    ...
    pub fn organization_conformance_pack_statuses(&self) -> &[super::types::OrganizationConformancePackStatus] {
...
impl DescribeOrganizationConformancePackStatusesOutput {
    ...
    pub fn builder(
        ...
        super::operation::describe_organization_conformance_pack_statuses::builders::DescribeOrganizationConformancePackStatusesOutputBuilder::default(
        )
    }
}
...
pub struct DescribeOrganizationConformancePackStatusesOutputBuilder {
    pub(crate) organization_conformance_pack_statuses: ::std::option::Option<::std::vec::Vec<super::types::OrganizationConformancePackStatus>>,
...
impl DescribeOrganizationConformancePackStatusesOutputBuilder {
    ...
    ///
    /// <p>A list of <code>OrganizationConformancePackStatus</code> objects.</p>
    pub fn organization_conformance_pack_statuses(mut self, input: super::types::OrganizationConformancePackStatus) -> Self {
    ...
    pub fn set_organization_conformance_pack_statuses(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::OrganizationConformancePackStatus>>,
    ) -> Self {
    ...
    pub fn build(self) -> super::operation::describe_organization_conformance_pack_statuses::DescribeOrganizationConformancePackStatusesOutput {
