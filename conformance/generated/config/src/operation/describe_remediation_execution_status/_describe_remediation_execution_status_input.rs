...
impl DescribeRemediationExecutionStatusInput {
    ...
    pub fn builder() -> super::operation::describe_remediation_execution_status::builders::DescribeRemediationExecutionStatusInputBuilder {
        super::operation::describe_remediation_execution_status::builders::DescribeRemediationExecutionStatusInputBuilder::default()
    }
}
