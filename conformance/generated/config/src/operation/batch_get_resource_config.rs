    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::batch_get_resource_config::BatchGetResourceConfigError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::batch_get_resource_config::BatchGetResourceConfigOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchGetResourceConfigResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_batch_get_resource_config::de_batch_get_resource_config_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_batch_get_resource_config::de_batch_get_resource_config_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchGetResourceConfigRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::batch_get_resource_config::BatchGetResourceConfigInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::batch_get_resource_config::BatchGetResourceConfigInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_batch_get_resource_config::ser_batch_get_resource_config_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::batch_get_resource_config::BatchGetResourceConfigError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::batch_get_resource_config::_batch_get_resource_config_input::BatchGetResourceConfigInput;

pub use super::operation::batch_get_resource_config::_batch_get_resource_config_output::BatchGetResourceConfigOutput;
