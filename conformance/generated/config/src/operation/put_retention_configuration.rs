    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::put_retention_configuration::PutRetentionConfigurationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::put_retention_configuration::PutRetentionConfigurationOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutRetentionConfigurationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_put_retention_configuration::de_put_retention_configuration_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_put_retention_configuration::de_put_retention_configuration_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutRetentionConfigurationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::put_retention_configuration::PutRetentionConfigurationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::put_retention_configuration::PutRetentionConfigurationInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_put_retention_configuration::ser_put_retention_configuration_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::put_retention_configuration::PutRetentionConfigurationError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::put_retention_configuration::_put_retention_configuration_input::PutRetentionConfigurationInput;

pub use super::operation::put_retention_configuration::_put_retention_configuration_output::PutRetentionConfigurationOutput;
