...
impl DeleteConnectorOutput {
    ...
    pub fn builder() -> super::operation::delete_connector::builders::DeleteConnectorOutputBuilder {
        super::operation::delete_connector::builders::DeleteConnectorOutputBuilder::default()
    }
}
...
impl DeleteConnectorOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_connector::DeleteConnectorOutput {
