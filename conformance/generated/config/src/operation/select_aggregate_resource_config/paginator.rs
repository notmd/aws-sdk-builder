...
pub struct SelectAggregateResourceConfigPaginator {
    ...
    builder: super::operation::select_aggregate_resource_config::builders::SelectAggregateResourceConfigInputBuilder,
...
impl SelectAggregateResourceConfigPaginator {
    ...
    pub fn items(self) -> super::operation::select_aggregate_resource_config::paginator::SelectAggregateResourceConfigPaginatorItems {
        super::operation::select_aggregate_resource_config::paginator::SelectAggregateResourceConfigPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::operation::select_aggregate_resource_config::SelectAggregateResourceConfig::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_select_aggregate_resource_config_output_output_next_token(resp);
...
impl SelectAggregateResourceConfigPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::lens::lens_select_aggregate_resource_config_output_output_results(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
