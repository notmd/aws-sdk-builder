    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::put_remediation_configurations::PutRemediationConfigurationsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::put_remediation_configurations::PutRemediationConfigurationsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutRemediationConfigurationsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_put_remediation_configurations::de_put_remediation_configurations_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_put_remediation_configurations::de_put_remediation_configurations_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutRemediationConfigurationsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::put_remediation_configurations::PutRemediationConfigurationsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::put_remediation_configurations::PutRemediationConfigurationsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_put_remediation_configurations::ser_put_remediation_configurations_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::put_remediation_configurations::PutRemediationConfigurationsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::put_remediation_configurations::_put_remediation_configurations_input::PutRemediationConfigurationsInput;

pub use super::operation::put_remediation_configurations::_put_remediation_configurations_output::PutRemediationConfigurationsOutput;
