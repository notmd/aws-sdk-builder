...
pub struct PutEvaluationsOutput {
    ...
    pub failed_evaluations: ::std::option::Option<::std::vec::Vec<super::types::Evaluation>>,
...
impl PutEvaluationsOutput {
    ...
    pub fn failed_evaluations(&self) -> &[super::types::Evaluation] {
...
impl PutEvaluationsOutput {
    ...
    pub fn builder() -> super::operation::put_evaluations::builders::PutEvaluationsOutputBuilder {
        super::operation::put_evaluations::builders::PutEvaluationsOutputBuilder::default()
    }
}
...
pub struct PutEvaluationsOutputBuilder {
    pub(crate) failed_evaluations: ::std::option::Option<::std::vec::Vec<super::types::Evaluation>>,
    _request_id: Option<String>,
}
impl PutEvaluationsOutputBuilder {
    ...
    ///
    /// <p>Requests that failed because of a client or server error.</p>
    pub fn failed_evaluations(mut self, input: super::types::Evaluation) -> Self {
    ...
    /// <p>Requests that failed because of a client or server error.</p>
    pub fn set_failed_evaluations(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::Evaluation>>) -> Self {
        self.failed_evaluations = input;
        self
    }
    /// <p>Requests that failed because of a client or server error.</p>
    pub fn get_failed_evaluations(&self) -> &::std::option::Option<::std::vec::Vec<super::types::Evaluation>> {
    ...
    pub fn build(self) -> super::operation::put_evaluations::PutEvaluationsOutput {
