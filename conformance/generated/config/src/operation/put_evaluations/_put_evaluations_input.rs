...
pub struct PutEvaluationsInput {
    ...
    pub evaluations: ::std::option::Option<::std::vec::Vec<super::types::Evaluation>>,
...
impl PutEvaluationsInput {
    ...
    pub fn evaluations(&self) -> &[super::types::Evaluation] {
...
impl PutEvaluationsInput {
    ...
    pub fn builder() -> super::operation::put_evaluations::builders::PutEvaluationsInputBuilder {
        super::operation::put_evaluations::builders::PutEvaluationsInputBuilder::default()
    }
}
...
pub struct PutEvaluationsInputBuilder {
    pub(crate) evaluations: ::std::option::Option<::std::vec::Vec<super::types::Evaluation>>,
...
impl PutEvaluationsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::put_evaluations::PutEvaluationsInput, ::aws_smithy_types::error::operation::BuildError> {
