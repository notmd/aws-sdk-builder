...
pub struct DescribeConfigRulesInput {
    ...
    pub filters: ::std::option::Option<super::types::DescribeConfigRulesFilters>,
...
impl DescribeConfigRulesInput {
    ...
    /// <p>Returns a list of Detective or Proactive Config rules. By default, this API returns an unfiltered list. For more information on Detective or Proactive Config rules, see <a href="https://docs.aws.amazon.com/config/latest/developerguide/evaluate-config-rules.html"> <b>Evaluation Mode</b> </a> in the <i>Config Developer Guide</i>.</p>
    pub fn filters(&self) -> ::std::option::Option<&super::types::DescribeConfigRulesFilters> {
        self.filters.as_ref()
    }
    /// <p>The <code>nextToken</code> string returned on a previous page that you use to get the next page of results in a paginated response.</p>
...
impl DescribeConfigRulesInput {
    ...
    pub fn builder() -> super::operation::describe_config_rules::builders::DescribeConfigRulesInputBuilder {
        super::operation::describe_config_rules::builders::DescribeConfigRulesInputBuilder::default()
    }
}
...
pub struct DescribeConfigRulesInputBuilder {
    ...
    pub(crate) filters: ::std::option::Option<super::types::DescribeConfigRulesFilters>,
...
impl DescribeConfigRulesInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::describe_config_rules::DescribeConfigRulesInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::describe_config_rules::DescribeConfigRulesInput {
