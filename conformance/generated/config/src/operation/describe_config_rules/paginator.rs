...
pub struct DescribeConfigRulesPaginator {
    ...
    builder: super::operation::describe_config_rules::builders::DescribeConfigRulesInputBuilder,
...
impl DescribeConfigRulesPaginator {
    ...
    pub fn items(self) -> super::operation::describe_config_rules::paginator::DescribeConfigRulesPaginatorItems {
        super::operation::describe_config_rules::paginator::DescribeConfigRulesPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::operation::describe_config_rules::DescribeConfigRules::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_describe_config_rules_output_output_next_token(resp);
...
impl DescribeConfigRulesPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::lens::lens_describe_config_rules_output_output_config_rules(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
