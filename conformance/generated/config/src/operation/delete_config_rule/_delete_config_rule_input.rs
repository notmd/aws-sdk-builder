...
impl DeleteConfigRuleInput {
    ...
    pub fn builder() -> super::operation::delete_config_rule::builders::DeleteConfigRuleInputBuilder {
        super::operation::delete_config_rule::builders::DeleteConfigRuleInputBuilder::default()
    }
}
...
impl DeleteConfigRuleInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::delete_config_rule::DeleteConfigRuleInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::delete_config_rule::DeleteConfigRuleInput {
