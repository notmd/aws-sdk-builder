...
impl DeleteConfigRuleOutput {
    ...
    pub fn builder() -> super::operation::delete_config_rule::builders::DeleteConfigRuleOutputBuilder {
        super::operation::delete_config_rule::builders::DeleteConfigRuleOutputBuilder::default()
    }
}
...
impl DeleteConfigRuleOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_config_rule::DeleteConfigRuleOutput {
