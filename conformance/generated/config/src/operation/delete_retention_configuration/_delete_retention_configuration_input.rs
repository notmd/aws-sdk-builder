...
impl DeleteRetentionConfigurationInput {
    ...
    pub fn builder() -> super::operation::delete_retention_configuration::builders::DeleteRetentionConfigurationInputBuilder {
        super::operation::delete_retention_configuration::builders::DeleteRetentionConfigurationInputBuilder::default()
    }
}
...
impl DeleteRetentionConfigurationInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::delete_retention_configuration::DeleteRetentionConfigurationInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::delete_retention_configuration::DeleteRetentionConfigurationInput {
