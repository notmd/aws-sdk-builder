...
impl DeleteRetentionConfigurationOutput {
    ...
    pub fn builder() -> super::operation::delete_retention_configuration::builders::DeleteRetentionConfigurationOutputBuilder {
        super::operation::delete_retention_configuration::builders::DeleteRetentionConfigurationOutputBuilder::default()
    }
}
...
impl DeleteRetentionConfigurationOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_retention_configuration::DeleteRetentionConfigurationOutput {
