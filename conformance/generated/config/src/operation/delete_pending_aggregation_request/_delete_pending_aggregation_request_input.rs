...
impl DeletePendingAggregationRequestInput {
    ...
    pub fn builder() -> super::operation::delete_pending_aggregation_request::builders::DeletePendingAggregationRequestInputBuilder {
        super::operation::delete_pending_aggregation_request::builders::DeletePendingAggregationRequestInputBuilder::default()
    }
}
...
impl DeletePendingAggregationRequestInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::delete_pending_aggregation_request::DeletePendingAggregationRequestInput,
