...
pub struct GetResourceConfigHistoryOutput {
    ...
    pub configuration_items: ::std::option::Option<::std::vec::Vec<super::types::ConfigurationItem>>,
...
impl GetResourceConfigHistoryOutput {
    ...
    pub fn configuration_items(&self) -> &[super::types::ConfigurationItem] {
...
impl GetResourceConfigHistoryOutput {
    ...
    pub fn builder() -> super::operation::get_resource_config_history::builders::GetResourceConfigHistoryOutputBuilder {
        super::operation::get_resource_config_history::builders::GetResourceConfigHistoryOutputBuilder::default()
    }
}
...
pub struct GetResourceConfigHistoryOutputBuilder {
    pub(crate) configuration_items: ::std::option::Option<::std::vec::Vec<super::types::ConfigurationItem>>,
...
impl GetResourceConfigHistoryOutputBuilder {
    ...
    ///
    /// <p>An array of <code>ConfigurationItems</code> Objects. Contatins the configuration history for one or more resources.</p>
    pub fn configuration_items(mut self, input: super::types::ConfigurationItem) -> Self {
    ...
    /// <p>An array of <code>ConfigurationItems</code> Objects. Contatins the configuration history for one or more resources.</p>
    pub fn set_configuration_items(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::ConfigurationItem>>) -> Self {
        self.configuration_items = input;
        self
    }
    /// <p>An array of <code>ConfigurationItems</code> Objects. Contatins the configuration history for one or more resources.</p>
    pub fn get_configuration_items(&self) -> &::std::option::Option<::std::vec::Vec<super::types::ConfigurationItem>> {
    ...
    pub fn build(self) -> super::operation::get_resource_config_history::GetResourceConfigHistoryOutput {
