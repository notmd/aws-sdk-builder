...
pub struct GetResourceConfigHistoryInput {
    ...
    pub chronological_order: ::std::option::Option<super::types::ChronologicalOrder>,
...
impl GetResourceConfigHistoryInput {
    ...
    /// <p>The chronological order for configuration items listed. By default, the results are listed in reverse chronological order.</p>
    pub fn chronological_order(&self) -> ::std::option::Option<&super::types::ChronologicalOrder> {
...
impl GetResourceConfigHistoryInput {
    ...
    pub fn builder() -> super::operation::get_resource_config_history::builders::GetResourceConfigHistoryInputBuilder {
        super::operation::get_resource_config_history::builders::GetResourceConfigHistoryInputBuilder::default()
    }
}
...
pub struct GetResourceConfigHistoryInputBuilder {
    ...
    pub(crate) chronological_order: ::std::option::Option<super::types::ChronologicalOrder>,
...
impl GetResourceConfigHistoryInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::get_resource_config_history::GetResourceConfigHistoryInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::get_resource_config_history::GetResourceConfigHistoryInput {
