...
impl ListConfigurationRecorders {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::list_configuration_recorders::ListConfigurationRecordersInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_configuration_recorders::ListConfigurationRecordersError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_configuration_recorders::ListConfigurationRecordersOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListConfigurationRecordersResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_configuration_recorders::de_list_configuration_recorders_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_configuration_recorders::de_list_configuration_recorders_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListConfigurationRecordersRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_configuration_recorders::ListConfigurationRecordersInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_configuration_recorders::ListConfigurationRecordersInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_list_configuration_recorders::ser_list_configuration_recorders_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::list_configuration_recorders::ListConfigurationRecordersError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_configuration_recorders::_list_configuration_recorders_input::ListConfigurationRecordersInput;

pub use super::operation::list_configuration_recorders::_list_configuration_recorders_output::ListConfigurationRecordersOutput;
