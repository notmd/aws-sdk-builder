...
impl DeleteEvaluationResultsOutput {
    ...
    pub fn builder() -> super::operation::delete_evaluation_results::builders::DeleteEvaluationResultsOutputBuilder {
        super::operation::delete_evaluation_results::builders::DeleteEvaluationResultsOutputBuilder::default()
    }
}
...
impl DeleteEvaluationResultsOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_evaluation_results::DeleteEvaluationResultsOutput {
