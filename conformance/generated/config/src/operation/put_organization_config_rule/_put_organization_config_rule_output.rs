...
impl PutOrganizationConfigRuleOutput {
    ...
    pub fn builder() -> super::operation::put_organization_config_rule::builders::PutOrganizationConfigRuleOutputBuilder {
        super::operation::put_organization_config_rule::builders::PutOrganizationConfigRuleOutputBuilder::default()
    }
}
...
impl PutOrganizationConfigRuleOutputBuilder {
    ...
    pub fn build(self) -> super::operation::put_organization_config_rule::PutOrganizationConfigRuleOutput {
