...
pub use super::operation::put_organization_config_rule::_put_organization_config_rule_input::PutOrganizationConfigRuleInputBuilder;

pub use super::operation::put_organization_config_rule::_put_organization_config_rule_output::PutOrganizationConfigRuleOutputBuilder;

impl super::operation::put_organization_config_rule::builders::PutOrganizationConfigRuleInputBuilder {
...
/// <p>There are two types of rules: <i>Config Managed Rules</i> and <i>Config Custom Rules</i>. You can use <code>PutOrganizationConfigRule</code> to create both Config Managed Rules and Config Custom Rules.</p>
...
/// <p>If you are adding a new Config Custom Lambda rule, you first need to create an Lambda function in the management account or a delegated administrator that the rule invokes to evaluate your resources. You also need to create an IAM role in the managed account that can be assumed by the Lambda function. When you use <code>PutOrganizationConfigRule</code> to add a Custom Lambda rule to Config, you must specify the Amazon Resource Name (ARN) that Lambda assigns to the function.</p><note>
...
pub struct PutOrganizationConfigRuleFluentBuilder {
    ...
    inner: super::operation::put_organization_config_rule::builders::PutOrganizationConfigRuleInputBuilder,
...
impl
    super::client::customize::internal::CustomizableSend<
        super::operation::put_organization_config_rule::PutOrganizationConfigRuleOutput,
        super::operation::put_organization_config_rule::PutOrganizationConfigRuleError,
    > for PutOrganizationConfigRuleFluentBuilder
{
    fn send(
        self,
...
impl PutOrganizationConfigRuleFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::put_organization_config_rule::builders::PutOrganizationConfigRuleInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::put_organization_config_rule::PutOrganizationConfigRule::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::put_organization_config_rule::PutOrganizationConfigRule::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn organization_managed_rule_metadata(mut self, input: super::types::OrganizationManagedRuleMetadata) -> Self {
        self.inner = self.inner.organization_managed_rule_metadata(input);
        self
    }
    /// <p>An <code>OrganizationManagedRuleMetadata</code> object. This object specifies organization managed rule metadata such as resource type and ID of Amazon Web Services resource along with the rule identifier. It also provides the frequency with which you want Config to run evaluations for the rule if the trigger type is periodic.</p>
    pub fn set_organization_managed_rule_metadata(mut self, input: ::std::option::Option<super::types::OrganizationManagedRuleMetadata>) -> Self {
        self.inner = self.inner.set_organization_managed_rule_metadata(input);
        self
    }
    /// <p>An <code>OrganizationManagedRuleMetadata</code> object. This object specifies organization managed rule metadata such as resource type and ID of Amazon Web Services resource along with the rule identifier. It also provides the frequency with which you want Config to run evaluations for the rule if the trigger type is periodic.</p>
    pub fn get_organization_managed_rule_metadata(&self) -> &::std::option::Option<super::types::OrganizationManagedRuleMetadata> {
    ...
    pub fn organization_custom_rule_metadata(mut self, input: super::types::OrganizationCustomRuleMetadata) -> Self {
        self.inner = self.inner.organization_custom_rule_metadata(input);
        self
    }
    /// <p>An <code>OrganizationCustomRuleMetadata</code> object. This object specifies organization custom rule metadata such as resource type, resource ID of Amazon Web Services resource, Lambda function ARN, and organization trigger types that trigger Config to evaluate your Amazon Web Services resources against a rule. It also provides the frequency with which you want Config to run evaluations for the rule if the trigger type is periodic.</p>
    pub fn set_organization_custom_rule_metadata(mut self, input: ::std::option::Option<super::types::OrganizationCustomRuleMetadata>) -> Self {
        self.inner = self.inner.set_organization_custom_rule_metadata(input);
        self
    }
    /// <p>An <code>OrganizationCustomRuleMetadata</code> object. This object specifies organization custom rule metadata such as resource type, resource ID of Amazon Web Services resource, Lambda function ARN, and organization trigger types that trigger Config to evaluate your Amazon Web Services resources against a rule. It also provides the frequency with which you want Config to run evaluations for the rule if the trigger type is periodic.</p>
    pub fn get_organization_custom_rule_metadata(&self) -> &::std::option::Option<super::types::OrganizationCustomRuleMetadata> {
    ...
    pub fn organization_custom_policy_rule_metadata(mut self, input: super::types::OrganizationCustomPolicyRuleMetadata) -> Self {
    ...
    pub fn set_organization_custom_policy_rule_metadata(
        mut self,
        input: ::std::option::Option<super::types::OrganizationCustomPolicyRuleMetadata>,
    ) -> Self {
        self.inner = self.inner.set_organization_custom_policy_rule_metadata(input);
        self
    }
    /// <p>An <code>OrganizationCustomPolicyRuleMetadata</code> object. This object specifies metadata for your organization's Config Custom Policy rule. The metadata includes the runtime system in use, which accounts have debug logging enabled, and other custom rule metadata, such as resource type, resource ID of Amazon Web Services resource, and organization trigger types that initiate Config to evaluate Amazon Web Services resources against a rule.</p>
    pub fn get_organization_custom_policy_rule_metadata(&self) -> &::std::option::Option<super::types::OrganizationCustomPolicyRuleMetadata> {
