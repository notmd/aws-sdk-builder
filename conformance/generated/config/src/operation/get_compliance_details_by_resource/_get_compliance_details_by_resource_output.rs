...
impl GetComplianceDetailsByResourceOutput {
    ...
    pub fn builder() -> super::operation::get_compliance_details_by_resource::builders::GetComplianceDetailsByResourceOutputBuilder {
        super::operation::get_compliance_details_by_resource::builders::GetComplianceDetailsByResourceOutputBuilder::default()
    }
}
...
impl GetComplianceDetailsByResourceOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_compliance_details_by_resource::GetComplianceDetailsByResourceOutput {
