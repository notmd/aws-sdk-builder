...
impl DeleteOrganizationConfigRuleInput {
    ...
    pub fn builder() -> super::operation::delete_organization_config_rule::builders::DeleteOrganizationConfigRuleInputBuilder {
        super::operation::delete_organization_config_rule::builders::DeleteOrganizationConfigRuleInputBuilder::default()
    }
}
...
impl DeleteOrganizationConfigRuleInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::delete_organization_config_rule::DeleteOrganizationConfigRuleInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::delete_organization_config_rule::DeleteOrganizationConfigRuleInput {
