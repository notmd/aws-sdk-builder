...
impl DeleteOrganizationConfigRuleOutput {
    ...
    pub fn builder() -> super::operation::delete_organization_config_rule::builders::DeleteOrganizationConfigRuleOutputBuilder {
        super::operation::delete_organization_config_rule::builders::DeleteOrganizationConfigRuleOutputBuilder::default()
    }
}
...
impl DeleteOrganizationConfigRuleOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_organization_config_rule::DeleteOrganizationConfigRuleOutput {
