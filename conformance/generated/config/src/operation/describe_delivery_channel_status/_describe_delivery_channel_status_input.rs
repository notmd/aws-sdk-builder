...
impl DescribeDeliveryChannelStatusInput {
    ...
    pub fn builder() -> super::operation::describe_delivery_channel_status::builders::DescribeDeliveryChannelStatusInputBuilder {
        super::operation::describe_delivery_channel_status::builders::DescribeDeliveryChannelStatusInputBuilder::default()
    }
}
...
impl DescribeDeliveryChannelStatusInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::describe_delivery_channel_status::DescribeDeliveryChannelStatusInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::describe_delivery_channel_status::DescribeDeliveryChannelStatusInput {
