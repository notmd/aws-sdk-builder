...
pub struct DescribeDeliveryChannelStatusOutput {
    ...
    pub delivery_channels_status: ::std::option::Option<::std::vec::Vec<super::types::DeliveryChannelStatus>>,
...
impl DescribeDeliveryChannelStatusOutput {
    ...
    pub fn delivery_channels_status(&self) -> &[super::types::DeliveryChannelStatus] {
...
impl DescribeDeliveryChannelStatusOutput {
    ...
    pub fn builder() -> super::operation::describe_delivery_channel_status::builders::DescribeDeliveryChannelStatusOutputBuilder {
        super::operation::describe_delivery_channel_status::builders::DescribeDeliveryChannelStatusOutputBuilder::default()
    }
}
...
pub struct DescribeDeliveryChannelStatusOutputBuilder {
    pub(crate) delivery_channels_status: ::std::option::Option<::std::vec::Vec<super::types::DeliveryChannelStatus>>,
    _request_id: Option<String>,
}
impl DescribeDeliveryChannelStatusOutputBuilder {
    ...
    ///
    /// <p>A list that contains the status of a specified delivery channel.</p>
    pub fn delivery_channels_status(mut self, input: super::types::DeliveryChannelStatus) -> Self {
    ...
    /// <p>A list that contains the status of a specified delivery channel.</p>
    pub fn set_delivery_channels_status(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::DeliveryChannelStatus>>) -> Self {
        self.delivery_channels_status = input;
        self
    }
    /// <p>A list that contains the status of a specified delivery channel.</p>
    pub fn get_delivery_channels_status(&self) -> &::std::option::Option<::std::vec::Vec<super::types::DeliveryChannelStatus>> {
    ...
    pub fn build(self) -> super::operation::describe_delivery_channel_status::DescribeDeliveryChannelStatusOutput {
