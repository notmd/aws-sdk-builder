...
pub use super::operation::list_aggregate_discovered_resources::_list_aggregate_discovered_resources_input::ListAggregateDiscoveredResourcesInputBuilder;

pub use super::operation::list_aggregate_discovered_resources::_list_aggregate_discovered_resources_output::ListAggregateDiscoveredResourcesOutputBuilder;

impl super::operation::list_aggregate_discovered_resources::builders::ListAggregateDiscoveredResourcesInputBuilder {
...
pub struct ListAggregateDiscoveredResourcesFluentBuilder {
    ...
    inner: super::operation::list_aggregate_discovered_resources::builders::ListAggregateDiscoveredResourcesInputBuilder,
...
impl ListAggregateDiscoveredResourcesFluentBuilder {
    /// Creates a new `ListAggregateDiscoveredResourcesFluentBuilder`.
    ...
    pub fn as_input(&self) -> &super::operation::list_aggregate_discovered_resources::builders::ListAggregateDiscoveredResourcesInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::list_aggregate_discovered_resources::ListAggregateDiscoveredResources::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::list_aggregate_discovered_resources::ListAggregateDiscoveredResources::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::operation::list_aggregate_discovered_resources::paginator::ListAggregateDiscoveredResourcesPaginator {
        super::operation::list_aggregate_discovered_resources::paginator::ListAggregateDiscoveredResourcesPaginator::new(self.handle, self.inner)
    }
    ...
    pub fn filters(mut self, input: super::types::ResourceFilters) -> Self {
        self.inner = self.inner.filters(input);
        self
    }
    /// <p>Filters the results based on the <code>ResourceFilters</code> object.</p>
    pub fn set_filters(mut self, input: ::std::option::Option<super::types::ResourceFilters>) -> Self {
        self.inner = self.inner.set_filters(input);
        self
    }
    /// <p>Filters the results based on the <code>ResourceFilters</code> object.</p>
    pub fn get_filters(&self) -> &::std::option::Option<super::types::ResourceFilters> {
