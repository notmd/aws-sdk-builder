...
pub struct ListAggregateDiscoveredResourcesOutput {
    ...
    pub resource_identifiers: ::std::option::Option<::std::vec::Vec<super::types::AggregateResourceIdentifier>>,
...
impl ListAggregateDiscoveredResourcesOutput {
    ...
    pub fn resource_identifiers(&self) -> &[super::types::AggregateResourceIdentifier] {
...
impl ListAggregateDiscoveredResourcesOutput {
    ...
    pub fn builder() -> super::operation::list_aggregate_discovered_resources::builders::ListAggregateDiscoveredResourcesOutputBuilder {
        super::operation::list_aggregate_discovered_resources::builders::ListAggregateDiscoveredResourcesOutputBuilder::default()
    }
}
...
pub struct ListAggregateDiscoveredResourcesOutputBuilder {
    pub(crate) resource_identifiers: ::std::option::Option<::std::vec::Vec<super::types::AggregateResourceIdentifier>>,
...
impl ListAggregateDiscoveredResourcesOutputBuilder {
    ...
    pub fn build(self) -> super::operation::list_aggregate_discovered_resources::ListAggregateDiscoveredResourcesOutput {
