...
pub struct ListAggregateDiscoveredResourcesInput {
    ...
    pub filters: ::std::option::Option<super::types::ResourceFilters>,
...
impl ListAggregateDiscoveredResourcesInput {
    ...
    /// <p>Filters the results based on the <code>ResourceFilters</code> object.</p>
    pub fn filters(&self) -> ::std::option::Option<&super::types::ResourceFilters> {
        self.filters.as_ref()
    }
    /// <p>The maximum number of resource identifiers returned on each page. You cannot specify a number greater than 100. If you specify 0, Config uses the default.</p>
...
impl ListAggregateDiscoveredResourcesInput {
    ...
    pub fn builder() -> super::operation::list_aggregate_discovered_resources::builders::ListAggregateDiscoveredResourcesInputBuilder {
        super::operation::list_aggregate_discovered_resources::builders::ListAggregateDiscoveredResourcesInputBuilder::default()
    }
}
...
pub struct ListAggregateDiscoveredResourcesInputBuilder {
    ...
    pub(crate) filters: ::std::option::Option<super::types::ResourceFilters>,
...
impl ListAggregateDiscoveredResourcesInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::list_aggregate_discovered_resources::ListAggregateDiscoveredResourcesInput,
