...
impl GetResourceEvaluationSummaryInput {
    ...
    pub fn builder() -> super::operation::get_resource_evaluation_summary::builders::GetResourceEvaluationSummaryInputBuilder {
        super::operation::get_resource_evaluation_summary::builders::GetResourceEvaluationSummaryInputBuilder::default()
    }
}
...
impl GetResourceEvaluationSummaryInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::get_resource_evaluation_summary::GetResourceEvaluationSummaryInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::get_resource_evaluation_summary::GetResourceEvaluationSummaryInput {
