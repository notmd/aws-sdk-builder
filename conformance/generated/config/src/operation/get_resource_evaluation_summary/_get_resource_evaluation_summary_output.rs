...
pub struct GetResourceEvaluationSummaryOutput {
    ...
    pub evaluation_mode: ::std::option::Option<super::types::EvaluationMode>,
    /// <p>Returns an <code>EvaluationStatus</code> object.</p>
    pub evaluation_status: ::std::option::Option<super::types::EvaluationStatus>,
    ...
    pub compliance: ::std::option::Option<super::types::ComplianceType>,
    /// <p>Returns an <code>EvaluationContext</code> object.</p>
    pub evaluation_context: ::std::option::Option<super::types::EvaluationContext>,
    /// <p>Returns a <code>ResourceDetails</code> object.</p>
    pub resource_details: ::std::option::Option<super::types::ResourceDetails>,
...
impl GetResourceEvaluationSummaryOutput {
    ...
    /// <p>Lists results of the mode that you requested to retrieve the resource evaluation summary. The valid values are Detective or Proactive.</p>
    pub fn evaluation_mode(&self) -> ::std::option::Option<&super::types::EvaluationMode> {
        self.evaluation_mode.as_ref()
    }
    /// <p>Returns an <code>EvaluationStatus</code> object.</p>
    pub fn evaluation_status(&self) -> ::std::option::Option<&super::types::EvaluationStatus> {
    ...
    /// <p>The compliance status of the resource evaluation summary.</p>
    pub fn compliance(&self) -> ::std::option::Option<&super::types::ComplianceType> {
        self.compliance.as_ref()
    }
    /// <p>Returns an <code>EvaluationContext</code> object.</p>
    pub fn evaluation_context(&self) -> ::std::option::Option<&super::types::EvaluationContext> {
        self.evaluation_context.as_ref()
    }
    /// <p>Returns a <code>ResourceDetails</code> object.</p>
    pub fn resource_details(&self) -> ::std::option::Option<&super::types::ResourceDetails> {
...
impl GetResourceEvaluationSummaryOutput {
    ...
    pub fn builder() -> super::operation::get_resource_evaluation_summary::builders::GetResourceEvaluationSummaryOutputBuilder {
        super::operation::get_resource_evaluation_summary::builders::GetResourceEvaluationSummaryOutputBuilder::default()
    }
}
...
pub struct GetResourceEvaluationSummaryOutputBuilder {
    ...
    pub(crate) evaluation_mode: ::std::option::Option<super::types::EvaluationMode>,
    pub(crate) evaluation_status: ::std::option::Option<super::types::EvaluationStatus>,
    pub(crate) evaluation_start_timestamp: ::std::option::Option<::aws_smithy_types::DateTime>,
    pub(crate) compliance: ::std::option::Option<super::types::ComplianceType>,
    pub(crate) evaluation_context: ::std::option::Option<super::types::EvaluationContext>,
    pub(crate) resource_details: ::std::option::Option<super::types::ResourceDetails>,
    _request_id: Option<String>,
}
impl GetResourceEvaluationSummaryOutputBuilder {
    ...
    /// <p>Lists results of the mode that you requested to retrieve the resource evaluation summary. The valid values are Detective or Proactive.</p>
    pub fn evaluation_mode(mut self, input: super::types::EvaluationMode) -> Self {
        self.evaluation_mode = ::std::option::Option::Some(input);
        self
    }
    /// <p>Lists results of the mode that you requested to retrieve the resource evaluation summary. The valid values are Detective or Proactive.</p>
    pub fn set_evaluation_mode(mut self, input: ::std::option::Option<super::types::EvaluationMode>) -> Self {
        self.evaluation_mode = input;
        self
    }
    /// <p>Lists results of the mode that you requested to retrieve the resource evaluation summary. The valid values are Detective or Proactive.</p>
    pub fn get_evaluation_mode(&self) -> &::std::option::Option<super::types::EvaluationMode> {
        &self.evaluation_mode
    }
    /// <p>Returns an <code>EvaluationStatus</code> object.</p>
    pub fn evaluation_status(mut self, input: super::types::EvaluationStatus) -> Self {
        self.evaluation_status = ::std::option::Option::Some(input);
        self
    }
    /// <p>Returns an <code>EvaluationStatus</code> object.</p>
    pub fn set_evaluation_status(mut self, input: ::std::option::Option<super::types::EvaluationStatus>) -> Self {
        self.evaluation_status = input;
        self
    }
    /// <p>Returns an <code>EvaluationStatus</code> object.</p>
    pub fn get_evaluation_status(&self) -> &::std::option::Option<super::types::EvaluationStatus> {
    ...
    /// <p>The compliance status of the resource evaluation summary.</p>
    pub fn compliance(mut self, input: super::types::ComplianceType) -> Self {
        self.compliance = ::std::option::Option::Some(input);
        self
    }
    /// <p>The compliance status of the resource evaluation summary.</p>
    pub fn set_compliance(mut self, input: ::std::option::Option<super::types::ComplianceType>) -> Self {
        self.compliance = input;
        self
    }
    /// <p>The compliance status of the resource evaluation summary.</p>
    pub fn get_compliance(&self) -> &::std::option::Option<super::types::ComplianceType> {
        &self.compliance
    }
    /// <p>Returns an <code>EvaluationContext</code> object.</p>
    pub fn evaluation_context(mut self, input: super::types::EvaluationContext) -> Self {
        self.evaluation_context = ::std::option::Option::Some(input);
        self
    }
    /// <p>Returns an <code>EvaluationContext</code> object.</p>
    pub fn set_evaluation_context(mut self, input: ::std::option::Option<super::types::EvaluationContext>) -> Self {
        self.evaluation_context = input;
        self
    }
    /// <p>Returns an <code>EvaluationContext</code> object.</p>
    pub fn get_evaluation_context(&self) -> &::std::option::Option<super::types::EvaluationContext> {
        &self.evaluation_context
    }
    /// <p>Returns a <code>ResourceDetails</code> object.</p>
    pub fn resource_details(mut self, input: super::types::ResourceDetails) -> Self {
        self.resource_details = ::std::option::Option::Some(input);
        self
    }
    /// <p>Returns a <code>ResourceDetails</code> object.</p>
    pub fn set_resource_details(mut self, input: ::std::option::Option<super::types::ResourceDetails>) -> Self {
        self.resource_details = input;
        self
    }
    /// <p>Returns a <code>ResourceDetails</code> object.</p>
    pub fn get_resource_details(&self) -> &::std::option::Option<super::types::ResourceDetails> {
    ...
    pub fn build(self) -> super::operation::get_resource_evaluation_summary::GetResourceEvaluationSummaryOutput {
        super::operation::get_resource_evaluation_summary::GetResourceEvaluationSummaryOutput {
