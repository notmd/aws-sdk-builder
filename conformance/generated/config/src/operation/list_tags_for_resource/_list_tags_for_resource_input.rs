...
impl ListTagsForResourceInput {
    ...
    pub fn builder() -> super::operation::list_tags_for_resource::builders::ListTagsForResourceInputBuilder {
        super::operation::list_tags_for_resource::builders::ListTagsForResourceInputBuilder::default()
    }
}
...
impl ListTagsForResourceInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_tags_for_resource::ListTagsForResourceInput, ::aws_smithy_types::error::operation::BuildError>
    {
