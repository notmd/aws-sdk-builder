...
impl StopConfigurationRecorder {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::stop_configuration_recorder::StopConfigurationRecorderInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::stop_configuration_recorder::StopConfigurationRecorderError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::stop_configuration_recorder::StopConfigurationRecorderOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopConfigurationRecorderResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_stop_configuration_recorder::de_stop_configuration_recorder_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_stop_configuration_recorder::de_stop_configuration_recorder_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StopConfigurationRecorderRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::stop_configuration_recorder::StopConfigurationRecorderInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::stop_configuration_recorder::StopConfigurationRecorderInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_stop_configuration_recorder::ser_stop_configuration_recorder_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::stop_configuration_recorder::StopConfigurationRecorderError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::stop_configuration_recorder::_stop_configuration_recorder_input::StopConfigurationRecorderInput;

pub use super::operation::stop_configuration_recorder::_stop_configuration_recorder_output::StopConfigurationRecorderOutput;
