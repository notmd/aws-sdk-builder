...
pub use super::operation::list_discovered_resources::_list_discovered_resources_input::ListDiscoveredResourcesInputBuilder;

pub use super::operation::list_discovered_resources::_list_discovered_resources_output::ListDiscoveredResourcesOutputBuilder;

impl super::operation::list_discovered_resources::builders::ListDiscoveredResourcesInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::Client,
    ) -> ::std::result::Result<
        super::operation::list_discovered_resources::ListDiscoveredResourcesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::list_discovered_resources::ListDiscoveredResourcesError,
...
pub struct ListDiscoveredResourcesFluentBuilder {
    ...
    inner: super::operation::list_discovered_resources::builders::ListDiscoveredResourcesInputBuilder,
...
impl ListDiscoveredResourcesFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::list_discovered_resources::builders::ListDiscoveredResourcesInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::list_discovered_resources::ListDiscoveredResources::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::list_discovered_resources::ListDiscoveredResources::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::operation::list_discovered_resources::paginator::ListDiscoveredResourcesPaginator {
        super::operation::list_discovered_resources::paginator::ListDiscoveredResourcesPaginator::new(self.handle, self.inner)
    }
    /// <p>The type of resources that you want Config to list in the response.</p>
    pub fn resource_type(mut self, input: super::types::ResourceType) -> Self {
        self.inner = self.inner.resource_type(input);
        self
    }
    /// <p>The type of resources that you want Config to list in the response.</p>
    pub fn set_resource_type(mut self, input: ::std::option::Option<super::types::ResourceType>) -> Self {
        self.inner = self.inner.set_resource_type(input);
        self
    }
    /// <p>The type of resources that you want Config to list in the response.</p>
    pub fn get_resource_type(&self) -> &::std::option::Option<super::types::ResourceType> {
