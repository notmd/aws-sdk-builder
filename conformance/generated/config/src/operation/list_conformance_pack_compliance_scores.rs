    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_conformance_pack_compliance_scores::ListConformancePackComplianceScoresError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_conformance_pack_compliance_scores::ListConformancePackComplianceScoresOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListConformancePackComplianceScoresResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_conformance_pack_compliance_scores::de_list_conformance_pack_compliance_scores_http_error(
                status, headers, body,
            )
        } else {
            super::protocol_serde::shape_list_conformance_pack_compliance_scores::de_list_conformance_pack_compliance_scores_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListConformancePackComplianceScoresRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_conformance_pack_compliance_scores::ListConformancePackComplianceScoresInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_conformance_pack_compliance_scores::ListConformancePackComplianceScoresInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_list_conformance_pack_compliance_scores::ser_list_conformance_pack_compliance_scores_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::list_conformance_pack_compliance_scores::ListConformancePackComplianceScoresError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_conformance_pack_compliance_scores::_list_conformance_pack_compliance_scores_input::ListConformancePackComplianceScoresInput;

pub use super::operation::list_conformance_pack_compliance_scores::_list_conformance_pack_compliance_scores_output::ListConformancePackComplianceScoresOutput;
