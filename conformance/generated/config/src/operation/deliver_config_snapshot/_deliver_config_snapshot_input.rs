...
impl DeliverConfigSnapshotInput {
    ...
    pub fn builder() -> super::operation::deliver_config_snapshot::builders::DeliverConfigSnapshotInputBuilder {
        super::operation::deliver_config_snapshot::builders::DeliverConfigSnapshotInputBuilder::default()
    }
}
...
impl DeliverConfigSnapshotInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::deliver_config_snapshot::DeliverConfigSnapshotInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::deliver_config_snapshot::DeliverConfigSnapshotInput {
