...
impl DeliverConfigSnapshotOutput {
    ...
    pub fn builder() -> super::operation::deliver_config_snapshot::builders::DeliverConfigSnapshotOutputBuilder {
        super::operation::deliver_config_snapshot::builders::DeliverConfigSnapshotOutputBuilder::default()
    }
}
...
impl DeliverConfigSnapshotOutputBuilder {
    ...
    pub fn build(self) -> super::operation::deliver_config_snapshot::DeliverConfigSnapshotOutput {
