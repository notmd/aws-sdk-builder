...
impl StartConfigurationRecorder {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::start_configuration_recorder::StartConfigurationRecorderInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::start_configuration_recorder::StartConfigurationRecorderError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::start_configuration_recorder::StartConfigurationRecorderOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartConfigurationRecorderResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_start_configuration_recorder::de_start_configuration_recorder_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_start_configuration_recorder::de_start_configuration_recorder_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartConfigurationRecorderRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::start_configuration_recorder::StartConfigurationRecorderInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::start_configuration_recorder::StartConfigurationRecorderInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_start_configuration_recorder::ser_start_configuration_recorder_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::start_configuration_recorder::StartConfigurationRecorderError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::start_configuration_recorder::_start_configuration_recorder_input::StartConfigurationRecorderInput;

pub use super::operation::start_configuration_recorder::_start_configuration_recorder_output::StartConfigurationRecorderOutput;
