...
pub struct DescribeConformancePackStatusOutput {
    ...
    pub conformance_pack_status_details: ::std::option::Option<::std::vec::Vec<super::types::ConformancePackStatusDetail>>,
...
impl DescribeConformancePackStatusOutput {
    ...
    pub fn conformance_pack_status_details(&self) -> &[super::types::ConformancePackStatusDetail] {
...
impl DescribeConformancePackStatusOutput {
    ...
    pub fn builder() -> super::operation::describe_conformance_pack_status::builders::DescribeConformancePackStatusOutputBuilder {
        super::operation::describe_conformance_pack_status::builders::DescribeConformancePackStatusOutputBuilder::default()
    }
}
...
pub struct DescribeConformancePackStatusOutputBuilder {
    pub(crate) conformance_pack_status_details: ::std::option::Option<::std::vec::Vec<super::types::ConformancePackStatusDetail>>,
...
impl DescribeConformancePackStatusOutputBuilder {
    ...
    ///
    /// <p>A list of <code>ConformancePackStatusDetail</code> objects.</p>
    pub fn conformance_pack_status_details(mut self, input: super::types::ConformancePackStatusDetail) -> Self {
    ...
    pub fn set_conformance_pack_status_details(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::ConformancePackStatusDetail>>,
    ) -> Self {
        self.conformance_pack_status_details = input;
        self
    }
    /// <p>A list of <code>ConformancePackStatusDetail</code> objects.</p>
    pub fn get_conformance_pack_status_details(&self) -> &::std::option::Option<::std::vec::Vec<super::types::ConformancePackStatusDetail>> {
    ...
    pub fn build(self) -> super::operation::describe_conformance_pack_status::DescribeConformancePackStatusOutput {
