...
pub struct DescribeConformancePackStatusPaginator {
    ...
    builder: super::operation::describe_conformance_pack_status::builders::DescribeConformancePackStatusInputBuilder,
...
impl DescribeConformancePackStatusPaginator {
    ...
    pub fn items(self) -> super::operation::describe_conformance_pack_status::paginator::DescribeConformancePackStatusPaginatorItems {
        super::operation::describe_conformance_pack_status::paginator::DescribeConformancePackStatusPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::operation::describe_conformance_pack_status::DescribeConformancePackStatus::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_describe_conformance_pack_status_output_output_next_token(resp);
...
impl DescribeConformancePackStatusPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::types::ConformancePackStatusDetail,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::operation::describe_conformance_pack_status::DescribeConformancePackStatusError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::lens::lens_describe_conformance_pack_status_output_output_conformance_pack_status_details(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
