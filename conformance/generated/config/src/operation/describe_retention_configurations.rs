    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::describe_retention_configurations::DescribeRetentionConfigurationsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::describe_retention_configurations::DescribeRetentionConfigurationsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeRetentionConfigurationsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_describe_retention_configurations::de_describe_retention_configurations_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_describe_retention_configurations::de_describe_retention_configurations_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeRetentionConfigurationsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::describe_retention_configurations::DescribeRetentionConfigurationsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::describe_retention_configurations::DescribeRetentionConfigurationsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_describe_retention_configurations::ser_describe_retention_configurations_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::describe_retention_configurations::DescribeRetentionConfigurationsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::describe_retention_configurations::_describe_retention_configurations_input::DescribeRetentionConfigurationsInput;

pub use super::operation::describe_retention_configurations::_describe_retention_configurations_output::DescribeRetentionConfigurationsOutput;
