    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::describe_pending_aggregation_requests::DescribePendingAggregationRequestsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::describe_pending_aggregation_requests::DescribePendingAggregationRequestsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribePendingAggregationRequestsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_describe_pending_aggregation_requests::de_describe_pending_aggregation_requests_http_error(
                status, headers, body,
            )
        } else {
            super::protocol_serde::shape_describe_pending_aggregation_requests::de_describe_pending_aggregation_requests_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribePendingAggregationRequestsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::describe_pending_aggregation_requests::DescribePendingAggregationRequestsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::describe_pending_aggregation_requests::DescribePendingAggregationRequestsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_describe_pending_aggregation_requests::ser_describe_pending_aggregation_requests_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::describe_pending_aggregation_requests::DescribePendingAggregationRequestsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::describe_pending_aggregation_requests::_describe_pending_aggregation_requests_input::DescribePendingAggregationRequestsInput;

pub use super::operation::describe_pending_aggregation_requests::_describe_pending_aggregation_requests_output::DescribePendingAggregationRequestsOutput;
