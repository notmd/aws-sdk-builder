...
impl PutRetentionConfigurationInput {
    ...
    pub fn builder() -> super::operation::put_retention_configuration::builders::PutRetentionConfigurationInputBuilder {
        super::operation::put_retention_configuration::builders::PutRetentionConfigurationInputBuilder::default()
    }
}
...
impl PutRetentionConfigurationInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::put_retention_configuration::PutRetentionConfigurationInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::put_retention_configuration::PutRetentionConfigurationInput {
