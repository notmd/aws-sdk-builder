...
pub struct GetComplianceDetailsByConfigRuleOutput {
    ...
    pub evaluation_results: ::std::option::Option<::std::vec::Vec<super::types::EvaluationResult>>,
...
impl GetComplianceDetailsByConfigRuleOutput {
    ...
    pub fn evaluation_results(&self) -> &[super::types::EvaluationResult] {
...
impl GetComplianceDetailsByConfigRuleOutput {
    ...
    pub fn builder() -> super::operation::get_compliance_details_by_config_rule::builders::GetComplianceDetailsByConfigRuleOutputBuilder {
        super::operation::get_compliance_details_by_config_rule::builders::GetComplianceDetailsByConfigRuleOutputBuilder::default()
    }
}
...
pub struct GetComplianceDetailsByConfigRuleOutputBuilder {
    pub(crate) evaluation_results: ::std::option::Option<::std::vec::Vec<super::types::EvaluationResult>>,
...
impl GetComplianceDetailsByConfigRuleOutputBuilder {
    ...
    ///
    /// <p>Indicates whether the Amazon Web Services resource complies with the specified Config rule.</p>
    pub fn evaluation_results(mut self, input: super::types::EvaluationResult) -> Self {
    ...
    /// <p>Indicates whether the Amazon Web Services resource complies with the specified Config rule.</p>
    pub fn set_evaluation_results(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::EvaluationResult>>) -> Self {
        self.evaluation_results = input;
        self
    }
    /// <p>Indicates whether the Amazon Web Services resource complies with the specified Config rule.</p>
    pub fn get_evaluation_results(&self) -> &::std::option::Option<::std::vec::Vec<super::types::EvaluationResult>> {
    ...
    pub fn build(self) -> super::operation::get_compliance_details_by_config_rule::GetComplianceDetailsByConfigRuleOutput {
