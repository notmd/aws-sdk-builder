...
impl GetComplianceSummaryByConfigRuleInput {
    ...
    pub fn builder() -> super::operation::get_compliance_summary_by_config_rule::builders::GetComplianceSummaryByConfigRuleInputBuilder {
        super::operation::get_compliance_summary_by_config_rule::builders::GetComplianceSummaryByConfigRuleInputBuilder::default()
    }
}
...
impl GetComplianceSummaryByConfigRuleInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::get_compliance_summary_by_config_rule::GetComplianceSummaryByConfigRuleInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::get_compliance_summary_by_config_rule::GetComplianceSummaryByConfigRuleInput {})
    }
}
