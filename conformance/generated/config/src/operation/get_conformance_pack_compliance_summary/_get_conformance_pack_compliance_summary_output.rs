...
pub struct GetConformancePackComplianceSummaryOutput {
    ...
    pub conformance_pack_compliance_summary_list: ::std::option::Option<::std::vec::Vec<super::types::ConformancePackComplianceSummary>>,
...
impl GetConformancePackComplianceSummaryOutput {
    ...
    pub fn conformance_pack_compliance_summary_list(&self) -> &[super::types::ConformancePackComplianceSummary] {
...
impl GetConformancePackComplianceSummaryOutput {
    ...
    pub fn builder() -> super::operation::get_conformance_pack_compliance_summary::builders::GetConformancePackComplianceSummaryOutputBuilder {
...
pub struct GetConformancePackComplianceSummaryOutputBuilder {
    pub(crate) conformance_pack_compliance_summary_list: ::std::option::Option<::std::vec::Vec<super::types::ConformancePackComplianceSummary>>,
...
impl GetConformancePackComplianceSummaryOutputBuilder {
    ...
    ///
    /// <p>A list of <code>ConformancePackComplianceSummary</code> objects.</p>
    pub fn conformance_pack_compliance_summary_list(mut self, input: super::types::ConformancePackComplianceSummary) -> Self {
    ...
    pub fn set_conformance_pack_compliance_summary_list(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::ConformancePackComplianceSummary>>,
    ) -> Self {
    ...
    pub fn build(self) -> super::operation::get_conformance_pack_compliance_summary::GetConformancePackComplianceSummaryOutput {
