...
impl SelectResourceConfigInput {
    ...
    pub fn builder() -> super::operation::select_resource_config::builders::SelectResourceConfigInputBuilder {
        super::operation::select_resource_config::builders::SelectResourceConfigInputBuilder::default()
    }
}
...
impl SelectResourceConfigInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::select_resource_config::SelectResourceConfigInput, ::aws_smithy_types::error::operation::BuildError>
    {
