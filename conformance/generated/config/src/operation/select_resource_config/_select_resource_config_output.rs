...
impl SelectResourceConfigOutput {
    ...
    pub fn builder() -> super::operation::select_resource_config::builders::SelectResourceConfigOutputBuilder {
        super::operation::select_resource_config::builders::SelectResourceConfigOutputBuilder::default()
    }
}
...
impl SelectResourceConfigOutputBuilder {
    ...
    pub fn build(self) -> super::operation::select_resource_config::SelectResourceConfigOutput {
