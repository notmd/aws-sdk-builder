...
pub struct StartRemediationExecutionInput {
    ...
    pub resource_keys: ::std::option::Option<::std::vec::Vec<super::types::ResourceKey>>,
}
impl StartRemediationExecutionInput {
    ...
    pub fn resource_keys(&self) -> &[super::types::ResourceKey] {
...
impl StartRemediationExecutionInput {
    ...
    pub fn builder() -> super::operation::start_remediation_execution::builders::StartRemediationExecutionInputBuilder {
        super::operation::start_remediation_execution::builders::StartRemediationExecutionInputBuilder::default()
    }
}
...
pub struct StartRemediationExecutionInputBuilder {
    ...
    pub(crate) resource_keys: ::std::option::Option<::std::vec::Vec<super::types::ResourceKey>>,
}
impl StartRemediationExecutionInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::start_remediation_execution::StartRemediationExecutionInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::start_remediation_execution::StartRemediationExecutionInput {
