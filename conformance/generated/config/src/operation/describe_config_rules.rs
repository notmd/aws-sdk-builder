    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::describe_config_rules::DescribeConfigRulesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::describe_config_rules::DescribeConfigRulesOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeConfigRulesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_describe_config_rules::de_describe_config_rules_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_describe_config_rules::de_describe_config_rules_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeConfigRulesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::describe_config_rules::DescribeConfigRulesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::describe_config_rules::DescribeConfigRulesInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_describe_config_rules::ser_describe_config_rules_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::operation::describe_config_rules::DescribeConfigRulesError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::describe_config_rules::_describe_config_rules_input::DescribeConfigRulesInput;

pub use super::operation::describe_config_rules::_describe_config_rules_output::DescribeConfigRulesOutput;
