...
impl GetComplianceSummaryByResourceTypeInput {
    ...
    pub fn builder() -> super::operation::get_compliance_summary_by_resource_type::builders::GetComplianceSummaryByResourceTypeInputBuilder {
        super::operation::get_compliance_summary_by_resource_type::builders::GetComplianceSummaryByResourceTypeInputBuilder::default()
    }
}
...
impl GetComplianceSummaryByResourceTypeInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::get_compliance_summary_by_resource_type::GetComplianceSummaryByResourceTypeInput,
