...
pub struct GetAggregateResourceConfigInput {
    ...
    pub resource_identifier: ::std::option::Option<super::types::AggregateResourceIdentifier>,
}
impl GetAggregateResourceConfigInput {
    ...
    /// <p>An object that identifies aggregate resource.</p>
    pub fn resource_identifier(&self) -> ::std::option::Option<&super::types::AggregateResourceIdentifier> {
...
impl GetAggregateResourceConfigInput {
    ...
    pub fn builder() -> super::operation::get_aggregate_resource_config::builders::GetAggregateResourceConfigInputBuilder {
        super::operation::get_aggregate_resource_config::builders::GetAggregateResourceConfigInputBuilder::default()
    }
}
...
pub struct GetAggregateResourceConfigInputBuilder {
    ...
    pub(crate) resource_identifier: ::std::option::Option<super::types::AggregateResourceIdentifier>,
}
impl GetAggregateResourceConfigInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::get_aggregate_resource_config::GetAggregateResourceConfigInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::get_aggregate_resource_config::GetAggregateResourceConfigInput {
