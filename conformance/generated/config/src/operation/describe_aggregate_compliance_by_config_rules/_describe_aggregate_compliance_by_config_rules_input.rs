...
pub struct DescribeAggregateComplianceByConfigRulesInput {
    ...
    pub filters: ::std::option::Option<super::types::ConfigRuleComplianceFilters>,
...
impl DescribeAggregateComplianceByConfigRulesInput {
    ...
    /// <p>Filters the results by ConfigRuleComplianceFilters object.</p>
    pub fn filters(&self) -> ::std::option::Option<&super::types::ConfigRuleComplianceFilters> {
        self.filters.as_ref()
    }
    /// <p>The maximum number of evaluation results returned on each page. The default is maximum. If you specify 0, Config uses the default.</p>
...
impl DescribeAggregateComplianceByConfigRulesInput {
    ...
    pub fn builder() -> super::operation::describe_aggregate_compliance_by_config_rules::builders::DescribeAggregateComplianceByConfigRulesInputBuilder
    {
        super::operation::describe_aggregate_compliance_by_config_rules::builders::DescribeAggregateComplianceByConfigRulesInputBuilder::default()
    }
}
...
pub struct DescribeAggregateComplianceByConfigRulesInputBuilder {
    ...
    pub(crate) filters: ::std::option::Option<super::types::ConfigRuleComplianceFilters>,
