...
pub struct DescribeAggregateComplianceByConfigRulesOutput {
    ...
    pub aggregate_compliance_by_config_rules: ::std::option::Option<::std::vec::Vec<super::types::AggregateComplianceByConfigRule>>,
...
impl DescribeAggregateComplianceByConfigRulesOutput {
    ...
    pub fn aggregate_compliance_by_config_rules(&self) -> &[super::types::AggregateComplianceByConfigRule] {
...
pub struct DescribeAggregateComplianceByConfigRulesOutputBuilder {
    pub(crate) aggregate_compliance_by_config_rules: ::std::option::Option<::std::vec::Vec<super::types::AggregateComplianceByConfigRule>>,
...
impl DescribeAggregateComplianceByConfigRulesOutputBuilder {
    ...
    ///
    /// <p>Returns a list of AggregateComplianceByConfigRule object.</p>
    pub fn aggregate_compliance_by_config_rules(mut self, input: super::types::AggregateComplianceByConfigRule) -> Self {
    ...
    pub fn set_aggregate_compliance_by_config_rules(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::AggregateComplianceByConfigRule>>,
    ) -> Self {
        self.aggregate_compliance_by_config_rules = input;
        self
    }
    /// <p>Returns a list of AggregateComplianceByConfigRule object.</p>
    pub fn get_aggregate_compliance_by_config_rules(&self) -> &::std::option::Option<::std::vec::Vec<super::types::AggregateComplianceByConfigRule>> {
    ...
    pub fn build(self) -> super::operation::describe_aggregate_compliance_by_config_rules::DescribeAggregateComplianceByConfigRulesOutput {
