...
pub struct GetOrganizationConfigRuleDetailedStatusInput {
    ...
    pub filters: ::std::option::Option<super::types::StatusDetailFilters>,
...
impl GetOrganizationConfigRuleDetailedStatusInput {
    ...
    /// <p>A <code>StatusDetailFilters</code> object.</p>
    pub fn filters(&self) -> ::std::option::Option<&super::types::StatusDetailFilters> {
        self.filters.as_ref()
    }
    /// <p>The maximum number of <code>OrganizationConfigRuleDetailedStatus</code> returned on each page. If you do not specify a number, Config uses the default. The default is 100.</p>
...
impl GetOrganizationConfigRuleDetailedStatusInput {
    ...
    pub fn builder() -> super::operation::get_organization_config_rule_detailed_status::builders::GetOrganizationConfigRuleDetailedStatusInputBuilder
    {
        super::operation::get_organization_config_rule_detailed_status::builders::GetOrganizationConfigRuleDetailedStatusInputBuilder::default()
    }
}
...
pub struct GetOrganizationConfigRuleDetailedStatusInputBuilder {
    ...
    pub(crate) filters: ::std::option::Option<super::types::StatusDetailFilters>,
