...
pub struct GetOrganizationConfigRuleDetailedStatusOutput {
    ...
    pub organization_config_rule_detailed_status: ::std::option::Option<::std::vec::Vec<super::types::MemberAccountStatus>>,
...
impl GetOrganizationConfigRuleDetailedStatusOutput {
    ...
    pub fn organization_config_rule_detailed_status(&self) -> &[super::types::MemberAccountStatus] {
...
impl GetOrganizationConfigRuleDetailedStatusOutput {
    ...
    pub fn builder() -> super::operation::get_organization_config_rule_detailed_status::builders::GetOrganizationConfigRuleDetailedStatusOutputBuilder
    {
...
pub struct GetOrganizationConfigRuleDetailedStatusOutputBuilder {
    pub(crate) organization_config_rule_detailed_status: ::std::option::Option<::std::vec::Vec<super::types::MemberAccountStatus>>,
...
impl GetOrganizationConfigRuleDetailedStatusOutputBuilder {
    ...
    ///
    /// <p>A list of <code>MemberAccountStatus</code> objects.</p>
    pub fn organization_config_rule_detailed_status(mut self, input: super::types::MemberAccountStatus) -> Self {
    ...
    pub fn set_organization_config_rule_detailed_status(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::MemberAccountStatus>>,
    ) -> Self {
        self.organization_config_rule_detailed_status = input;
        self
    }
    /// <p>A list of <code>MemberAccountStatus</code> objects.</p>
    pub fn get_organization_config_rule_detailed_status(&self) -> &::std::option::Option<::std::vec::Vec<super::types::MemberAccountStatus>> {
    ...
    pub fn build(self) -> super::operation::get_organization_config_rule_detailed_status::GetOrganizationConfigRuleDetailedStatusOutput {
