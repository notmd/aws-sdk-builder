...
pub use super::operation::get_organization_config_rule_detailed_status::_get_organization_config_rule_detailed_status_input::GetOrganizationConfigRuleDetailedStatusInputBuilder;

pub use super::operation::get_organization_config_rule_detailed_status::_get_organization_config_rule_detailed_status_output::GetOrganizationConfigRuleDetailedStatusOutputBuilder;

impl super::operation::get_organization_config_rule_detailed_status::builders::GetOrganizationConfigRuleDetailedStatusInputBuilder {
...
pub struct GetOrganizationConfigRuleDetailedStatusFluentBuilder {
    ...
    inner: super::operation::get_organization_config_rule_detailed_status::builders::GetOrganizationConfigRuleDetailedStatusInputBuilder,
...
impl GetOrganizationConfigRuleDetailedStatusFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &super::operation::get_organization_config_rule_detailed_status::builders::GetOrganizationConfigRuleDetailedStatusInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            super::operation::get_organization_config_rule_detailed_status::GetOrganizationConfigRuleDetailedStatus::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        super::operation::get_organization_config_rule_detailed_status::GetOrganizationConfigRuleDetailedStatus::orchestrate(&runtime_plugins, input)
            .await
    }
    ...
    pub fn into_paginator(
        self,
    ) -> super::operation::get_organization_config_rule_detailed_status::paginator::GetOrganizationConfigRuleDetailedStatusPaginator {
        super::operation::get_organization_config_rule_detailed_status::paginator::GetOrganizationConfigRuleDetailedStatusPaginator::new(
            self.handle,
            self.inner,
        )
    }
    ...
    pub fn filters(mut self, input: super::types::StatusDetailFilters) -> Self {
        self.inner = self.inner.filters(input);
        self
    }
    /// <p>A <code>StatusDetailFilters</code> object.</p>
    pub fn set_filters(mut self, input: ::std::option::Option<super::types::StatusDetailFilters>) -> Self {
        self.inner = self.inner.set_filters(input);
        self
    }
    /// <p>A <code>StatusDetailFilters</code> object.</p>
    pub fn get_filters(&self) -> &::std::option::Option<super::types::StatusDetailFilters> {
