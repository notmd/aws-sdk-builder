    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::describe_configuration_aggregator_sources_status::DescribeConfigurationAggregatorSourcesStatusError>(
                )
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::describe_configuration_aggregator_sources_status::DescribeConfigurationAggregatorSourcesStatusOutput>()
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeConfigurationAggregatorSourcesStatusTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DescribeConfigurationAggregatorSourcesStatusInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeConfigurationAggregatorSourcesStatusResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_describe_configuration_aggregator_sources_status::de_describe_configuration_aggregator_sources_status_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_describe_configuration_aggregator_sources_status::de_describe_configuration_aggregator_sources_status_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeConfigurationAggregatorSourcesStatusRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::describe_configuration_aggregator_sources_status::DescribeConfigurationAggregatorSourcesStatusInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::describe_configuration_aggregator_sources_status::DescribeConfigurationAggregatorSourcesStatusInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_describe_configuration_aggregator_sources_status::ser_describe_configuration_aggregator_sources_status_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeConfigurationAggregatorSourcesStatusError {
...
impl ::aws_types::request_id::RequestId
    for super::operation::describe_configuration_aggregator_sources_status::DescribeConfigurationAggregatorSourcesStatusError
{
...
pub use super::operation::describe_configuration_aggregator_sources_status::_describe_configuration_aggregator_sources_status_input::DescribeConfigurationAggregatorSourcesStatusInput;

pub use super::operation::describe_configuration_aggregator_sources_status::_describe_configuration_aggregator_sources_status_output::DescribeConfigurationAggregatorSourcesStatusOutput;
