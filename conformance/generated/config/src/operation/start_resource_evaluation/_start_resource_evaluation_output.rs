...
impl StartResourceEvaluationOutput {
    ...
    pub fn builder() -> super::operation::start_resource_evaluation::builders::StartResourceEvaluationOutputBuilder {
        super::operation::start_resource_evaluation::builders::StartResourceEvaluationOutputBuilder::default()
    }
}
...
impl StartResourceEvaluationOutputBuilder {
    ...
    pub fn build(self) -> super::operation::start_resource_evaluation::StartResourceEvaluationOutput {
