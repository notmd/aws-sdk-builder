...
pub struct DeleteRemediationExceptionsOutput {
    ...
    pub failed_batches: ::std::option::Option<::std::vec::Vec<super::types::FailedDeleteRemediationExceptionsBatch>>,
...
impl DeleteRemediationExceptionsOutput {
    ...
    pub fn failed_batches(&self) -> &[super::types::FailedDeleteRemediationExceptionsBatch] {
...
impl DeleteRemediationExceptionsOutput {
    ...
    pub fn builder() -> super::operation::delete_remediation_exceptions::builders::DeleteRemediationExceptionsOutputBuilder {
        super::operation::delete_remediation_exceptions::builders::DeleteRemediationExceptionsOutputBuilder::default()
    }
}
...
pub struct DeleteRemediationExceptionsOutputBuilder {
    pub(crate) failed_batches: ::std::option::Option<::std::vec::Vec<super::types::FailedDeleteRemediationExceptionsBatch>>,
    _request_id: Option<String>,
}
impl DeleteRemediationExceptionsOutputBuilder {
    ...
    ///
    /// <p>Returns a list of failed delete remediation exceptions batch objects. Each object in the batch consists of a list of failed items and failure messages.</p>
    pub fn failed_batches(mut self, input: super::types::FailedDeleteRemediationExceptionsBatch) -> Self {
    ...
    /// <p>Returns a list of failed delete remediation exceptions batch objects. Each object in the batch consists of a list of failed items and failure messages.</p>
    pub fn set_failed_batches(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::FailedDeleteRemediationExceptionsBatch>>) -> Self {
        self.failed_batches = input;
        self
    }
    /// <p>Returns a list of failed delete remediation exceptions batch objects. Each object in the batch consists of a list of failed items and failure messages.</p>
    pub fn get_failed_batches(&self) -> &::std::option::Option<::std::vec::Vec<super::types::FailedDeleteRemediationExceptionsBatch>> {
        &self.failed_batches
    }
    ...
    pub fn build(self) -> super::operation::delete_remediation_exceptions::DeleteRemediationExceptionsOutput {
