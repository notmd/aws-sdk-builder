    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::put_configuration_recorder::PutConfigurationRecorderError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::put_configuration_recorder::PutConfigurationRecorderOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutConfigurationRecorderResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_put_configuration_recorder::de_put_configuration_recorder_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_put_configuration_recorder::de_put_configuration_recorder_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutConfigurationRecorderRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::put_configuration_recorder::PutConfigurationRecorderInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::put_configuration_recorder::PutConfigurationRecorderInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_put_configuration_recorder::ser_put_configuration_recorder_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::put_configuration_recorder::PutConfigurationRecorderError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::put_configuration_recorder::_put_configuration_recorder_input::PutConfigurationRecorderInput;

pub use super::operation::put_configuration_recorder::_put_configuration_recorder_output::PutConfigurationRecorderOutput;
