...
pub struct PutConfigurationAggregatorOutput {
    ...
    pub configuration_aggregator: ::std::option::Option<super::types::ConfigurationAggregator>,
    _request_id: Option<String>,
}
impl PutConfigurationAggregatorOutput {
    /// <p>Returns a ConfigurationAggregator object.</p>
    pub fn configuration_aggregator(&self) -> ::std::option::Option<&super::types::ConfigurationAggregator> {
...
impl PutConfigurationAggregatorOutput {
    ...
    pub fn builder() -> super::operation::put_configuration_aggregator::builders::PutConfigurationAggregatorOutputBuilder {
        super::operation::put_configuration_aggregator::builders::PutConfigurationAggregatorOutputBuilder::default()
    }
}
...
pub struct PutConfigurationAggregatorOutputBuilder {
    pub(crate) configuration_aggregator: ::std::option::Option<super::types::ConfigurationAggregator>,
    _request_id: Option<String>,
}
impl PutConfigurationAggregatorOutputBuilder {
    /// <p>Returns a ConfigurationAggregator object.</p>
    pub fn configuration_aggregator(mut self, input: super::types::ConfigurationAggregator) -> Self {
        self.configuration_aggregator = ::std::option::Option::Some(input);
        self
    }
    /// <p>Returns a ConfigurationAggregator object.</p>
    pub fn set_configuration_aggregator(mut self, input: ::std::option::Option<super::types::ConfigurationAggregator>) -> Self {
        self.configuration_aggregator = input;
        self
    }
    /// <p>Returns a ConfigurationAggregator object.</p>
    pub fn get_configuration_aggregator(&self) -> &::std::option::Option<super::types::ConfigurationAggregator> {
    ...
    pub fn build(self) -> super::operation::put_configuration_aggregator::PutConfigurationAggregatorOutput {
