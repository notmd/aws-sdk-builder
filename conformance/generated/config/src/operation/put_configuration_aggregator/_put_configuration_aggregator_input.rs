...
pub struct PutConfigurationAggregatorInput {
    ...
    pub account_aggregation_sources: ::std::option::Option<::std::vec::Vec<super::types::AccountAggregationSource>>,
    /// <p>An OrganizationAggregationSource object.</p>
    pub organization_aggregation_source: ::std::option::Option<super::types::OrganizationAggregationSource>,
    ...
    pub aggregator_filters: ::std::option::Option<super::types::AggregatorFilters>,
}
impl PutConfigurationAggregatorInput {
    ...
    pub fn account_aggregation_sources(&self) -> &[super::types::AccountAggregationSource] {
        self.account_aggregation_sources.as_deref().unwrap_or_default()
    }
    /// <p>An OrganizationAggregationSource object.</p>
    pub fn organization_aggregation_source(&self) -> ::std::option::Option<&super::types::OrganizationAggregationSource> {
    ...
    /// <p>An object to filter configuration recorders in an aggregator. Either <code>ResourceType</code> or <code>ServicePrincipal</code> is required.</p>
    pub fn aggregator_filters(&self) -> ::std::option::Option<&super::types::AggregatorFilters> {
...
impl PutConfigurationAggregatorInput {
    ...
    pub fn builder() -> super::operation::put_configuration_aggregator::builders::PutConfigurationAggregatorInputBuilder {
        super::operation::put_configuration_aggregator::builders::PutConfigurationAggregatorInputBuilder::default()
    }
}
...
pub struct PutConfigurationAggregatorInputBuilder {
    ...
    pub(crate) account_aggregation_sources: ::std::option::Option<::std::vec::Vec<super::types::AccountAggregationSource>>,
    pub(crate) organization_aggregation_source: ::std::option::Option<super::types::OrganizationAggregationSource>,
    pub(crate) tags: ::std::option::Option<::std::vec::Vec<super::types::Tag>>,
    pub(crate) aggregator_filters: ::std::option::Option<super::types::AggregatorFilters>,
}
impl PutConfigurationAggregatorInputBuilder {
    ...
    ///
    /// <p>A list of AccountAggregationSource object.</p>
    pub fn account_aggregation_sources(mut self, input: super::types::AccountAggregationSource) -> Self {
    ...
    /// <p>A list of AccountAggregationSource object.</p>
    pub fn set_account_aggregation_sources(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::AccountAggregationSource>>) -> Self {
        self.account_aggregation_sources = input;
        self
    }
    /// <p>A list of AccountAggregationSource object.</p>
    pub fn get_account_aggregation_sources(&self) -> &::std::option::Option<::std::vec::Vec<super::types::AccountAggregationSource>> {
        &self.account_aggregation_sources
    }
    /// <p>An OrganizationAggregationSource object.</p>
    pub fn organization_aggregation_source(mut self, input: super::types::OrganizationAggregationSource) -> Self {
        self.organization_aggregation_source = ::std::option::Option::Some(input);
        self
    }
    /// <p>An OrganizationAggregationSource object.</p>
    pub fn set_organization_aggregation_source(mut self, input: ::std::option::Option<super::types::OrganizationAggregationSource>) -> Self {
        self.organization_aggregation_source = input;
        self
    }
    /// <p>An OrganizationAggregationSource object.</p>
    pub fn get_organization_aggregation_source(&self) -> &::std::option::Option<super::types::OrganizationAggregationSource> {
    ...
    /// <p>An object to filter configuration recorders in an aggregator. Either <code>ResourceType</code> or <code>ServicePrincipal</code> is required.</p>
    pub fn aggregator_filters(mut self, input: super::types::AggregatorFilters) -> Self {
        self.aggregator_filters = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object to filter configuration recorders in an aggregator. Either <code>ResourceType</code> or <code>ServicePrincipal</code> is required.</p>
    pub fn set_aggregator_filters(mut self, input: ::std::option::Option<super::types::AggregatorFilters>) -> Self {
        self.aggregator_filters = input;
        self
    }
    /// <p>An object to filter configuration recorders in an aggregator. Either <code>ResourceType</code> or <code>ServicePrincipal</code> is required.</p>
    pub fn get_aggregator_filters(&self) -> &::std::option::Option<super::types::AggregatorFilters> {
    ...
    pub fn build(
        ...
        super::operation::put_configuration_aggregator::PutConfigurationAggregatorInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::put_configuration_aggregator::PutConfigurationAggregatorInput {
