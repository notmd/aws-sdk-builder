    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::select_resource_config::SelectResourceConfigError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::select_resource_config::SelectResourceConfigOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SelectResourceConfigResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_select_resource_config::de_select_resource_config_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_select_resource_config::de_select_resource_config_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SelectResourceConfigRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::select_resource_config::SelectResourceConfigInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::select_resource_config::SelectResourceConfigInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_select_resource_config::ser_select_resource_config_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::operation::select_resource_config::SelectResourceConfigError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::select_resource_config::_select_resource_config_input::SelectResourceConfigInput;

pub use super::operation::select_resource_config::_select_resource_config_output::SelectResourceConfigOutput;
