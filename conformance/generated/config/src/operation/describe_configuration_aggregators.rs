    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::describe_configuration_aggregators::DescribeConfigurationAggregatorsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::describe_configuration_aggregators::DescribeConfigurationAggregatorsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeConfigurationAggregatorsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_describe_configuration_aggregators::de_describe_configuration_aggregators_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_describe_configuration_aggregators::de_describe_configuration_aggregators_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeConfigurationAggregatorsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::describe_configuration_aggregators::DescribeConfigurationAggregatorsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::describe_configuration_aggregators::DescribeConfigurationAggregatorsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_describe_configuration_aggregators::ser_describe_configuration_aggregators_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::describe_configuration_aggregators::DescribeConfigurationAggregatorsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::describe_configuration_aggregators::_describe_configuration_aggregators_input::DescribeConfigurationAggregatorsInput;

pub use super::operation::describe_configuration_aggregators::_describe_configuration_aggregators_output::DescribeConfigurationAggregatorsOutput;
