...
impl PutResourceConfig {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::operation::put_resource_config::PutResourceConfigOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::put_resource_config::PutResourceConfigError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::put_resource_config::PutResourceConfigError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::put_resource_config::PutResourceConfigOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutResourceConfigResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_put_resource_config::de_put_resource_config_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_put_resource_config::de_put_resource_config_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutResourceConfigRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::put_resource_config::PutResourceConfigInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::put_resource_config::PutResourceConfigInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_put_resource_config::ser_put_resource_config_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::put_resource_config::PutResourceConfigError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::put_resource_config::_put_resource_config_input::PutResourceConfigInput;

pub use super::operation::put_resource_config::_put_resource_config_output::PutResourceConfigOutput;
