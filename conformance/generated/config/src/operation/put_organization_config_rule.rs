    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::put_organization_config_rule::PutOrganizationConfigRuleError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::put_organization_config_rule::PutOrganizationConfigRuleOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutOrganizationConfigRuleResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_put_organization_config_rule::de_put_organization_config_rule_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_put_organization_config_rule::de_put_organization_config_rule_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutOrganizationConfigRuleRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::put_organization_config_rule::PutOrganizationConfigRuleInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::put_organization_config_rule::PutOrganizationConfigRuleInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_put_organization_config_rule::ser_put_organization_config_rule_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::put_organization_config_rule::PutOrganizationConfigRuleError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::put_organization_config_rule::_put_organization_config_rule_input::PutOrganizationConfigRuleInput;

pub use super::operation::put_organization_config_rule::_put_organization_config_rule_output::PutOrganizationConfigRuleOutput;
