...
impl GetStoredQueryInput {
    ...
    pub fn builder() -> super::operation::get_stored_query::builders::GetStoredQueryInputBuilder {
        super::operation::get_stored_query::builders::GetStoredQueryInputBuilder::default()
    }
}
...
impl GetStoredQueryInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_stored_query::GetStoredQueryInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_stored_query::GetStoredQueryInput { query_name: self.query_name })
    }
}
