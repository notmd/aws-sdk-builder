...
pub struct DescribeAggregationAuthorizationsOutput {
    ...
    pub aggregation_authorizations: ::std::option::Option<::std::vec::Vec<super::types::AggregationAuthorization>>,
...
impl DescribeAggregationAuthorizationsOutput {
    ...
    pub fn aggregation_authorizations(&self) -> &[super::types::AggregationAuthorization] {
...
impl DescribeAggregationAuthorizationsOutput {
    ...
    pub fn builder() -> super::operation::describe_aggregation_authorizations::builders::DescribeAggregationAuthorizationsOutputBuilder {
        super::operation::describe_aggregation_authorizations::builders::DescribeAggregationAuthorizationsOutputBuilder::default()
    }
}
...
pub struct DescribeAggregationAuthorizationsOutputBuilder {
    pub(crate) aggregation_authorizations: ::std::option::Option<::std::vec::Vec<super::types::AggregationAuthorization>>,
...
impl DescribeAggregationAuthorizationsOutputBuilder {
    ...
    ///
    /// <p>Returns a list of authorizations granted to various aggregator accounts and regions.</p>
    pub fn aggregation_authorizations(mut self, input: super::types::AggregationAuthorization) -> Self {
    ...
    /// <p>Returns a list of authorizations granted to various aggregator accounts and regions.</p>
    pub fn set_aggregation_authorizations(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::AggregationAuthorization>>) -> Self {
        self.aggregation_authorizations = input;
        self
    }
    /// <p>Returns a list of authorizations granted to various aggregator accounts and regions.</p>
    pub fn get_aggregation_authorizations(&self) -> &::std::option::Option<::std::vec::Vec<super::types::AggregationAuthorization>> {
    ...
    pub fn build(self) -> super::operation::describe_aggregation_authorizations::DescribeAggregationAuthorizationsOutput {
