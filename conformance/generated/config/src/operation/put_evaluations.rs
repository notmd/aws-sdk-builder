    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::put_evaluations::PutEvaluationsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::put_evaluations::PutEvaluationsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutEvaluationsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_put_evaluations::de_put_evaluations_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_put_evaluations::de_put_evaluations_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutEvaluationsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::put_evaluations::PutEvaluationsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::put_evaluations::PutEvaluationsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_put_evaluations::ser_put_evaluations_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::put_evaluations::PutEvaluationsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::put_evaluations::_put_evaluations_input::PutEvaluationsInput;

pub use super::operation::put_evaluations::_put_evaluations_output::PutEvaluationsOutput;
