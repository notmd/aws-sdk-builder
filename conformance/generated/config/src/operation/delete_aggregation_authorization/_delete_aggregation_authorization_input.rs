...
impl DeleteAggregationAuthorizationInput {
    ...
    pub fn builder() -> super::operation::delete_aggregation_authorization::builders::DeleteAggregationAuthorizationInputBuilder {
        super::operation::delete_aggregation_authorization::builders::DeleteAggregationAuthorizationInputBuilder::default()
    }
}
...
impl DeleteAggregationAuthorizationInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::delete_aggregation_authorization::DeleteAggregationAuthorizationInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::delete_aggregation_authorization::DeleteAggregationAuthorizationInput {
