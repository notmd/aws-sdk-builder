...
pub use super::operation::delete_aggregation_authorization::_delete_aggregation_authorization_input::DeleteAggregationAuthorizationInputBuilder;

pub use super::operation::delete_aggregation_authorization::_delete_aggregation_authorization_output::DeleteAggregationAuthorizationOutputBuilder;

impl super::operation::delete_aggregation_authorization::builders::DeleteAggregationAuthorizationInputBuilder {
...
pub struct DeleteAggregationAuthorizationFluentBuilder {
    ...
    inner: super::operation::delete_aggregation_authorization::builders::DeleteAggregationAuthorizationInputBuilder,
...
impl DeleteAggregationAuthorizationFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::delete_aggregation_authorization::builders::DeleteAggregationAuthorizationInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::delete_aggregation_authorization::DeleteAggregationAuthorization::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::delete_aggregation_authorization::DeleteAggregationAuthorization::orchestrate(&runtime_plugins, input).await
    }
