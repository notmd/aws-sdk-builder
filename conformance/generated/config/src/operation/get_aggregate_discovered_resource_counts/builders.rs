...
pub use super::operation::get_aggregate_discovered_resource_counts::_get_aggregate_discovered_resource_counts_input::GetAggregateDiscoveredResourceCountsInputBuilder;

pub use super::operation::get_aggregate_discovered_resource_counts::_get_aggregate_discovered_resource_counts_output::GetAggregateDiscoveredResourceCountsOutputBuilder;

impl super::operation::get_aggregate_discovered_resource_counts::builders::GetAggregateDiscoveredResourceCountsInputBuilder {
...
pub struct GetAggregateDiscoveredResourceCountsFluentBuilder {
    ...
    inner: super::operation::get_aggregate_discovered_resource_counts::builders::GetAggregateDiscoveredResourceCountsInputBuilder,
...
impl GetAggregateDiscoveredResourceCountsFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &super::operation::get_aggregate_discovered_resource_counts::builders::GetAggregateDiscoveredResourceCountsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            super::operation::get_aggregate_discovered_resource_counts::GetAggregateDiscoveredResourceCounts::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        super::operation::get_aggregate_discovered_resource_counts::GetAggregateDiscoveredResourceCounts::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(
        self,
    ) -> super::operation::get_aggregate_discovered_resource_counts::paginator::GetAggregateDiscoveredResourceCountsPaginator {
        super::operation::get_aggregate_discovered_resource_counts::paginator::GetAggregateDiscoveredResourceCountsPaginator::new(
            self.handle,
            self.inner,
        )
    }
    ...
    pub fn filters(mut self, input: super::types::ResourceCountFilters) -> Self {
        self.inner = self.inner.filters(input);
        self
    }
    /// <p>Filters the results based on the <code>ResourceCountFilters</code> object.</p>
    pub fn set_filters(mut self, input: ::std::option::Option<super::types::ResourceCountFilters>) -> Self {
        self.inner = self.inner.set_filters(input);
        self
    }
    /// <p>Filters the results based on the <code>ResourceCountFilters</code> object.</p>
    pub fn get_filters(&self) -> &::std::option::Option<super::types::ResourceCountFilters> {
        self.inner.get_filters()
    }
    /// <p>The key to group the resource counts.</p>
    pub fn group_by_key(mut self, input: super::types::ResourceCountGroupKey) -> Self {
        self.inner = self.inner.group_by_key(input);
        self
    }
    /// <p>The key to group the resource counts.</p>
    pub fn set_group_by_key(mut self, input: ::std::option::Option<super::types::ResourceCountGroupKey>) -> Self {
        self.inner = self.inner.set_group_by_key(input);
        self
    }
    /// <p>The key to group the resource counts.</p>
    pub fn get_group_by_key(&self) -> &::std::option::Option<super::types::ResourceCountGroupKey> {
