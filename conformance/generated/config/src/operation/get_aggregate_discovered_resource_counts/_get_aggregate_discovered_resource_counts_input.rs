...
pub struct GetAggregateDiscoveredResourceCountsInput {
    ...
    pub filters: ::std::option::Option<super::types::ResourceCountFilters>,
    /// <p>The key to group the resource counts.</p>
    pub group_by_key: ::std::option::Option<super::types::ResourceCountGroupKey>,
...
impl GetAggregateDiscoveredResourceCountsInput {
    ...
    /// <p>Filters the results based on the <code>ResourceCountFilters</code> object.</p>
    pub fn filters(&self) -> ::std::option::Option<&super::types::ResourceCountFilters> {
        self.filters.as_ref()
    }
    /// <p>The key to group the resource counts.</p>
    pub fn group_by_key(&self) -> ::std::option::Option<&super::types::ResourceCountGroupKey> {
...
impl GetAggregateDiscoveredResourceCountsInput {
    ...
    pub fn builder() -> super::operation::get_aggregate_discovered_resource_counts::builders::GetAggregateDiscoveredResourceCountsInputBuilder {
        super::operation::get_aggregate_discovered_resource_counts::builders::GetAggregateDiscoveredResourceCountsInputBuilder::default()
    }
}
...
pub struct GetAggregateDiscoveredResourceCountsInputBuilder {
    ...
    pub(crate) filters: ::std::option::Option<super::types::ResourceCountFilters>,
    pub(crate) group_by_key: ::std::option::Option<super::types::ResourceCountGroupKey>,
...
impl GetAggregateDiscoveredResourceCountsInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::get_aggregate_discovered_resource_counts::GetAggregateDiscoveredResourceCountsInput,
