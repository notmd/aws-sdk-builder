    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_resource_evaluations::ListResourceEvaluationsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_resource_evaluations::ListResourceEvaluationsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListResourceEvaluationsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_resource_evaluations::de_list_resource_evaluations_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_resource_evaluations::de_list_resource_evaluations_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListResourceEvaluationsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_resource_evaluations::ListResourceEvaluationsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_resource_evaluations::ListResourceEvaluationsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_list_resource_evaluations::ser_list_resource_evaluations_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::list_resource_evaluations::ListResourceEvaluationsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_resource_evaluations::_list_resource_evaluations_input::ListResourceEvaluationsInput;

pub use super::operation::list_resource_evaluations::_list_resource_evaluations_output::ListResourceEvaluationsOutput;
