...
impl DeleteEvaluationResults {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::delete_evaluation_results::DeleteEvaluationResultsInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_evaluation_results::DeleteEvaluationResultsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_evaluation_results::DeleteEvaluationResultsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteEvaluationResultsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_evaluation_results::de_delete_evaluation_results_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_evaluation_results::de_delete_evaluation_results_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteEvaluationResultsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_evaluation_results::DeleteEvaluationResultsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_evaluation_results::DeleteEvaluationResultsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_delete_evaluation_results::ser_delete_evaluation_results_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::delete_evaluation_results::DeleteEvaluationResultsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_evaluation_results::_delete_evaluation_results_input::DeleteEvaluationResultsInput;

pub use super::operation::delete_evaluation_results::_delete_evaluation_results_output::DeleteEvaluationResultsOutput;
