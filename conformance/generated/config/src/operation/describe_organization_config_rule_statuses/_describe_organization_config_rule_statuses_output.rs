...
pub struct DescribeOrganizationConfigRuleStatusesOutput {
    ...
    pub organization_config_rule_statuses: ::std::option::Option<::std::vec::Vec<super::types::OrganizationConfigRuleStatus>>,
...
impl DescribeOrganizationConfigRuleStatusesOutput {
    ...
    pub fn organization_config_rule_statuses(&self) -> &[super::types::OrganizationConfigRuleStatus] {
...
impl DescribeOrganizationConfigRuleStatusesOutput {
    ...
    pub fn builder() -> super::operation::describe_organization_config_rule_statuses::builders::DescribeOrganizationConfigRuleStatusesOutputBuilder {
...
pub struct DescribeOrganizationConfigRuleStatusesOutputBuilder {
    pub(crate) organization_config_rule_statuses: ::std::option::Option<::std::vec::Vec<super::types::OrganizationConfigRuleStatus>>,
...
impl DescribeOrganizationConfigRuleStatusesOutputBuilder {
    ...
    ///
    /// <p>A list of <code>OrganizationConfigRuleStatus</code> objects.</p>
    pub fn organization_config_rule_statuses(mut self, input: super::types::OrganizationConfigRuleStatus) -> Self {
    ...
    pub fn set_organization_config_rule_statuses(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::OrganizationConfigRuleStatus>>,
    ) -> Self {
        self.organization_config_rule_statuses = input;
        self
    }
    /// <p>A list of <code>OrganizationConfigRuleStatus</code> objects.</p>
    pub fn get_organization_config_rule_statuses(&self) -> &::std::option::Option<::std::vec::Vec<super::types::OrganizationConfigRuleStatus>> {
    ...
    pub fn build(self) -> super::operation::describe_organization_config_rule_statuses::DescribeOrganizationConfigRuleStatusesOutput {
