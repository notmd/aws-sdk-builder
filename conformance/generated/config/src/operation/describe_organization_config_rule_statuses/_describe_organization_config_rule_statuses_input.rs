...
impl DescribeOrganizationConfigRuleStatusesInput {
    ...
    pub fn builder() -> super::operation::describe_organization_config_rule_statuses::builders::DescribeOrganizationConfigRuleStatusesInputBuilder {
        super::operation::describe_organization_config_rule_statuses::builders::DescribeOrganizationConfigRuleStatusesInputBuilder::default()
    }
}
