...
impl DeleteConfigurationRecorderInput {
    ...
    pub fn builder() -> super::operation::delete_configuration_recorder::builders::DeleteConfigurationRecorderInputBuilder {
        super::operation::delete_configuration_recorder::builders::DeleteConfigurationRecorderInputBuilder::default()
    }
}
...
impl DeleteConfigurationRecorderInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::delete_configuration_recorder::DeleteConfigurationRecorderInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::delete_configuration_recorder::DeleteConfigurationRecorderInput {
