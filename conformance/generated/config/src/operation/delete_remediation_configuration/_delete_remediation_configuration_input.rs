...
impl DeleteRemediationConfigurationInput {
    ...
    pub fn builder() -> super::operation::delete_remediation_configuration::builders::DeleteRemediationConfigurationInputBuilder {
        super::operation::delete_remediation_configuration::builders::DeleteRemediationConfigurationInputBuilder::default()
    }
}
...
impl DeleteRemediationConfigurationInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::delete_remediation_configuration::DeleteRemediationConfigurationInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::delete_remediation_configuration::DeleteRemediationConfigurationInput {
