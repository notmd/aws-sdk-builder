...
impl DeleteRemediationConfigurationOutput {
    ...
    pub fn builder() -> super::operation::delete_remediation_configuration::builders::DeleteRemediationConfigurationOutputBuilder {
        super::operation::delete_remediation_configuration::builders::DeleteRemediationConfigurationOutputBuilder::default()
    }
}
...
impl DeleteRemediationConfigurationOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_remediation_configuration::DeleteRemediationConfigurationOutput {
