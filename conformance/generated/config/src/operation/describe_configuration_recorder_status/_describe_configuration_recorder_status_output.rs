...
pub struct DescribeConfigurationRecorderStatusOutput {
    ...
    pub configuration_recorders_status: ::std::option::Option<::std::vec::Vec<super::types::ConfigurationRecorderStatus>>,
...
impl DescribeConfigurationRecorderStatusOutput {
    ...
    pub fn configuration_recorders_status(&self) -> &[super::types::ConfigurationRecorderStatus] {
...
impl DescribeConfigurationRecorderStatusOutput {
    ...
    pub fn builder() -> super::operation::describe_configuration_recorder_status::builders::DescribeConfigurationRecorderStatusOutputBuilder {
...
pub struct DescribeConfigurationRecorderStatusOutputBuilder {
    pub(crate) configuration_recorders_status: ::std::option::Option<::std::vec::Vec<super::types::ConfigurationRecorderStatus>>,
    _request_id: Option<String>,
}
impl DescribeConfigurationRecorderStatusOutputBuilder {
    ...
    ///
    /// <p>A list that contains status of the specified recorders.</p>
    pub fn configuration_recorders_status(mut self, input: super::types::ConfigurationRecorderStatus) -> Self {
    ...
    pub fn set_configuration_recorders_status(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::ConfigurationRecorderStatus>>,
    ) -> Self {
        self.configuration_recorders_status = input;
        self
    }
    /// <p>A list that contains status of the specified recorders.</p>
    pub fn get_configuration_recorders_status(&self) -> &::std::option::Option<::std::vec::Vec<super::types::ConfigurationRecorderStatus>> {
    ...
    pub fn build(self) -> super::operation::describe_configuration_recorder_status::DescribeConfigurationRecorderStatusOutput {
