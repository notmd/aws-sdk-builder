...
impl DeleteConfigurationAggregatorInput {
    ...
    pub fn builder() -> super::operation::delete_configuration_aggregator::builders::DeleteConfigurationAggregatorInputBuilder {
        super::operation::delete_configuration_aggregator::builders::DeleteConfigurationAggregatorInputBuilder::default()
    }
}
...
impl DeleteConfigurationAggregatorInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::delete_configuration_aggregator::DeleteConfigurationAggregatorInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::delete_configuration_aggregator::DeleteConfigurationAggregatorInput {
