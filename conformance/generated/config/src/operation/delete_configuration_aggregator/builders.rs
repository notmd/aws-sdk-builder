...
pub use super::operation::delete_configuration_aggregator::_delete_configuration_aggregator_input::DeleteConfigurationAggregatorInputBuilder;

pub use super::operation::delete_configuration_aggregator::_delete_configuration_aggregator_output::DeleteConfigurationAggregatorOutputBuilder;

impl super::operation::delete_configuration_aggregator::builders::DeleteConfigurationAggregatorInputBuilder {
...
pub struct DeleteConfigurationAggregatorFluentBuilder {
    ...
    inner: super::operation::delete_configuration_aggregator::builders::DeleteConfigurationAggregatorInputBuilder,
...
impl DeleteConfigurationAggregatorFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::delete_configuration_aggregator::builders::DeleteConfigurationAggregatorInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::delete_configuration_aggregator::DeleteConfigurationAggregator::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::delete_configuration_aggregator::DeleteConfigurationAggregator::orchestrate(&runtime_plugins, input).await
    }
