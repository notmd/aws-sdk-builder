...
impl DescribeConfigurationRecorders {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::describe_configuration_recorders::DescribeConfigurationRecordersInput,
    ) -> ::std::result::Result<
        super::operation::describe_configuration_recorders::DescribeConfigurationRecordersOutput,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::describe_configuration_recorders::DescribeConfigurationRecordersError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::describe_configuration_recorders::DescribeConfigurationRecordersOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeConfigurationRecordersResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_describe_configuration_recorders::de_describe_configuration_recorders_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_describe_configuration_recorders::de_describe_configuration_recorders_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeConfigurationRecordersRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::describe_configuration_recorders::DescribeConfigurationRecordersInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::describe_configuration_recorders::DescribeConfigurationRecordersInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_describe_configuration_recorders::ser_describe_configuration_recorders_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::describe_configuration_recorders::DescribeConfigurationRecordersError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::describe_configuration_recorders::_describe_configuration_recorders_input::DescribeConfigurationRecordersInput;

pub use super::operation::describe_configuration_recorders::_describe_configuration_recorders_output::DescribeConfigurationRecordersOutput;
