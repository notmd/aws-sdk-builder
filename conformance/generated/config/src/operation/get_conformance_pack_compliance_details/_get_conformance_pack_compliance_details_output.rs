...
pub struct GetConformancePackComplianceDetailsOutput {
    ...
    pub conformance_pack_rule_evaluation_results: ::std::option::Option<::std::vec::Vec<super::types::ConformancePackEvaluationResult>>,
...
impl GetConformancePackComplianceDetailsOutput {
    ...
    pub fn conformance_pack_rule_evaluation_results(&self) -> &[super::types::ConformancePackEvaluationResult] {
...
impl GetConformancePackComplianceDetailsOutput {
    ...
    pub fn builder() -> super::operation::get_conformance_pack_compliance_details::builders::GetConformancePackComplianceDetailsOutputBuilder {
...
pub struct GetConformancePackComplianceDetailsOutputBuilder {
    ...
    pub(crate) conformance_pack_rule_evaluation_results: ::std::option::Option<::std::vec::Vec<super::types::ConformancePackEvaluationResult>>,
...
impl GetConformancePackComplianceDetailsOutputBuilder {
    ...
    ///
    /// <p>Returns a list of <code>ConformancePackEvaluationResult</code> objects.</p>
    pub fn conformance_pack_rule_evaluation_results(mut self, input: super::types::ConformancePackEvaluationResult) -> Self {
    ...
    pub fn set_conformance_pack_rule_evaluation_results(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::ConformancePackEvaluationResult>>,
    ) -> Self {
    ...
    pub fn get_conformance_pack_rule_evaluation_results(
        &self,
    ) -> &::std::option::Option<::std::vec::Vec<super::types::ConformancePackEvaluationResult>> {
