...
impl PutResourceConfigInput {
    ...
    pub fn builder() -> super::operation::put_resource_config::builders::PutResourceConfigInputBuilder {
        super::operation::put_resource_config::builders::PutResourceConfigInputBuilder::default()
    }
}
...
impl PutResourceConfigInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::put_resource_config::PutResourceConfigInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::put_resource_config::PutResourceConfigInput {
