...
pub use super::operation::put_configuration_recorder::_put_configuration_recorder_input::PutConfigurationRecorderInputBuilder;

pub use super::operation::put_configuration_recorder::_put_configuration_recorder_output::PutConfigurationRecorderOutputBuilder;

impl super::operation::put_configuration_recorder::builders::PutConfigurationRecorderInputBuilder {
...
pub struct PutConfigurationRecorderFluentBuilder {
    ...
    inner: super::operation::put_configuration_recorder::builders::PutConfigurationRecorderInputBuilder,
...
impl PutConfigurationRecorderFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::put_configuration_recorder::builders::PutConfigurationRecorderInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::put_configuration_recorder::PutConfigurationRecorder::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::put_configuration_recorder::PutConfigurationRecorder::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn configuration_recorder(mut self, input: super::types::ConfigurationRecorder) -> Self {
        self.inner = self.inner.configuration_recorder(input);
        self
    }
    /// <p>An object for the configuration recorder. A configuration recorder records configuration changes for the resource types in scope.</p>
    pub fn set_configuration_recorder(mut self, input: ::std::option::Option<super::types::ConfigurationRecorder>) -> Self {
        self.inner = self.inner.set_configuration_recorder(input);
        self
    }
    /// <p>An object for the configuration recorder. A configuration recorder records configuration changes for the resource types in scope.</p>
    pub fn get_configuration_recorder(&self) -> &::std::option::Option<super::types::ConfigurationRecorder> {
