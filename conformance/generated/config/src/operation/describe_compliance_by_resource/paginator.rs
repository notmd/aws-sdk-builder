...
/// Paginator for [`DescribeComplianceByResource`](crate::operation::describe_compliance_by_resource::DescribeComplianceByResource)
pub struct DescribeComplianceByResourcePaginator {
    handle: std::sync::Arc<super::client::Handle>,
    builder: super::operation::describe_compliance_by_resource::builders::DescribeComplianceByResourceInputBuilder,
...
impl DescribeComplianceByResourcePaginator {
    ...
    pub fn items(self) -> super::operation::describe_compliance_by_resource::paginator::DescribeComplianceByResourcePaginatorItems {
        super::operation::describe_compliance_by_resource::paginator::DescribeComplianceByResourcePaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::operation::describe_compliance_by_resource::DescribeComplianceByResource::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_describe_compliance_by_resource_output_output_next_token(resp);
...
impl DescribeComplianceByResourcePaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::types::ComplianceByResource,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::operation::describe_compliance_by_resource::DescribeComplianceByResourceError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::lens::lens_describe_compliance_by_resource_output_output_compliance_by_resources(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
