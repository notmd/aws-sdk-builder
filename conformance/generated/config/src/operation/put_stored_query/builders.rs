...
pub use super::operation::put_stored_query::_put_stored_query_input::PutStoredQueryInputBuilder;

pub use super::operation::put_stored_query::_put_stored_query_output::PutStoredQueryOutputBuilder;

impl super::operation::put_stored_query::builders::PutStoredQueryInputBuilder {
...
pub struct PutStoredQueryFluentBuilder {
    ...
    inner: super::operation::put_stored_query::builders::PutStoredQueryInputBuilder,
...
impl PutStoredQueryFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::put_stored_query::builders::PutStoredQueryInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::put_stored_query::PutStoredQuery::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::put_stored_query::PutStoredQuery::orchestrate(&runtime_plugins, input).await
    }
    ...
    /// </note>
    pub fn stored_query(mut self, input: super::types::StoredQuery) -> Self {
    ...
    /// <p>When you are creating a query, you must provide a query name and an expression. When you are updating a query, you must provide a query name but updating the description is optional.</p>
    /// </note>
    pub fn set_stored_query(mut self, input: ::std::option::Option<super::types::StoredQuery>) -> Self {
    ...
    /// <p>When you are creating a query, you must provide a query name and an expression. When you are updating a query, you must provide a query name but updating the description is optional.</p>
    /// </note>
    pub fn get_stored_query(&self) -> &::std::option::Option<super::types::StoredQuery> {
