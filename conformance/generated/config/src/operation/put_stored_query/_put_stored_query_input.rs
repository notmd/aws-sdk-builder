...
pub struct PutStoredQueryInput {
    ...
    /// </note>
    pub stored_query: ::std::option::Option<super::types::StoredQuery>,
...
impl PutStoredQueryInput {
    ...
    /// <p>When you are creating a query, you must provide a query name and an expression. When you are updating a query, you must provide a query name but updating the description is optional.</p>
    /// </note>
    pub fn stored_query(&self) -> ::std::option::Option<&super::types::StoredQuery> {
...
impl PutStoredQueryInput {
    ...
    pub fn builder() -> super::operation::put_stored_query::builders::PutStoredQueryInputBuilder {
        super::operation::put_stored_query::builders::PutStoredQueryInputBuilder::default()
    }
}
...
pub struct PutStoredQueryInputBuilder {
    pub(crate) stored_query: ::std::option::Option<super::types::StoredQuery>,
...
impl PutStoredQueryInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::put_stored_query::PutStoredQueryInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::put_stored_query::PutStoredQueryInput {
