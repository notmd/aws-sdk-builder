...
pub struct DescribeRemediationExceptionsInput {
    ...
    pub resource_keys: ::std::option::Option<::std::vec::Vec<super::types::RemediationExceptionResourceKey>>,
...
impl DescribeRemediationExceptionsInput {
    ...
    pub fn resource_keys(&self) -> &[super::types::RemediationExceptionResourceKey] {
...
impl DescribeRemediationExceptionsInput {
    ...
    pub fn builder() -> super::operation::describe_remediation_exceptions::builders::DescribeRemediationExceptionsInputBuilder {
        super::operation::describe_remediation_exceptions::builders::DescribeRemediationExceptionsInputBuilder::default()
    }
}
...
pub struct DescribeRemediationExceptionsInputBuilder {
    ...
    pub(crate) resource_keys: ::std::option::Option<::std::vec::Vec<super::types::RemediationExceptionResourceKey>>,
...
impl DescribeRemediationExceptionsInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::describe_remediation_exceptions::DescribeRemediationExceptionsInput,
