...
pub use super::operation::describe_remediation_exceptions::_describe_remediation_exceptions_input::DescribeRemediationExceptionsInputBuilder;

pub use super::operation::describe_remediation_exceptions::_describe_remediation_exceptions_output::DescribeRemediationExceptionsOutputBuilder;

impl super::operation::describe_remediation_exceptions::builders::DescribeRemediationExceptionsInputBuilder {
...
pub struct DescribeRemediationExceptionsFluentBuilder {
    ...
    inner: super::operation::describe_remediation_exceptions::builders::DescribeRemediationExceptionsInputBuilder,
...
impl DescribeRemediationExceptionsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::describe_remediation_exceptions::builders::DescribeRemediationExceptionsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::describe_remediation_exceptions::DescribeRemediationExceptions::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::describe_remediation_exceptions::DescribeRemediationExceptions::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::operation::describe_remediation_exceptions::paginator::DescribeRemediationExceptionsPaginator {
        super::operation::describe_remediation_exceptions::paginator::DescribeRemediationExceptionsPaginator::new(self.handle, self.inner)
    }
    ...
    pub fn resource_keys(mut self, input: super::types::RemediationExceptionResourceKey) -> Self {
        self.inner = self.inner.resource_keys(input);
        self
    }
    /// <p>An exception list of resource exception keys to be processed with the current request. Config adds exception for each resource key. For example, Config adds 3 exceptions for 3 resource keys.</p>
    pub fn set_resource_keys(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::RemediationExceptionResourceKey>>) -> Self {
        self.inner = self.inner.set_resource_keys(input);
        self
    }
    /// <p>An exception list of resource exception keys to be processed with the current request. Config adds exception for each resource key. For example, Config adds 3 exceptions for 3 resource keys.</p>
    pub fn get_resource_keys(&self) -> &::std::option::Option<::std::vec::Vec<super::types::RemediationExceptionResourceKey>> {
