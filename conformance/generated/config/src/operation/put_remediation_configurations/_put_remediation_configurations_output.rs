...
pub struct PutRemediationConfigurationsOutput {
    ...
    pub failed_batches: ::std::option::Option<::std::vec::Vec<super::types::FailedRemediationBatch>>,
...
impl PutRemediationConfigurationsOutput {
    ...
    pub fn failed_batches(&self) -> &[super::types::FailedRemediationBatch] {
...
impl PutRemediationConfigurationsOutput {
    ...
    pub fn builder() -> super::operation::put_remediation_configurations::builders::PutRemediationConfigurationsOutputBuilder {
        super::operation::put_remediation_configurations::builders::PutRemediationConfigurationsOutputBuilder::default()
    }
}
...
pub struct PutRemediationConfigurationsOutputBuilder {
    pub(crate) failed_batches: ::std::option::Option<::std::vec::Vec<super::types::FailedRemediationBatch>>,
    _request_id: Option<String>,
}
impl PutRemediationConfigurationsOutputBuilder {
    ...
    ///
    /// <p>Returns a list of failed remediation batch objects.</p>
    pub fn failed_batches(mut self, input: super::types::FailedRemediationBatch) -> Self {
    ...
    /// <p>Returns a list of failed remediation batch objects.</p>
    pub fn set_failed_batches(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::FailedRemediationBatch>>) -> Self {
        self.failed_batches = input;
        self
    }
    /// <p>Returns a list of failed remediation batch objects.</p>
    pub fn get_failed_batches(&self) -> &::std::option::Option<::std::vec::Vec<super::types::FailedRemediationBatch>> {
        &self.failed_batches
    }
    ...
    pub fn build(self) -> super::operation::put_remediation_configurations::PutRemediationConfigurationsOutput {
