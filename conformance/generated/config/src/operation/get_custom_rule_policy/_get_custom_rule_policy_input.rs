...
impl GetCustomRulePolicyInput {
    ...
    pub fn builder() -> super::operation::get_custom_rule_policy::builders::GetCustomRulePolicyInputBuilder {
        super::operation::get_custom_rule_policy::builders::GetCustomRulePolicyInputBuilder::default()
    }
}
...
impl GetCustomRulePolicyInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_custom_rule_policy::GetCustomRulePolicyInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::get_custom_rule_policy::GetCustomRulePolicyInput {
