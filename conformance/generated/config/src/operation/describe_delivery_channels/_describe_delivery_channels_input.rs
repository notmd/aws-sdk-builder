...
impl DescribeDeliveryChannelsInput {
    ...
    pub fn builder() -> super::operation::describe_delivery_channels::builders::DescribeDeliveryChannelsInputBuilder {
        super::operation::describe_delivery_channels::builders::DescribeDeliveryChannelsInputBuilder::default()
    }
}
...
impl DescribeDeliveryChannelsInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::describe_delivery_channels::DescribeDeliveryChannelsInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::describe_delivery_channels::DescribeDeliveryChannelsInput {
