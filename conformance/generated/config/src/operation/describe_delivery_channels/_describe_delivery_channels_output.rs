...
pub struct DescribeDeliveryChannelsOutput {
    ...
    pub delivery_channels: ::std::option::Option<::std::vec::Vec<super::types::DeliveryChannel>>,
...
impl DescribeDeliveryChannelsOutput {
    ...
    pub fn delivery_channels(&self) -> &[super::types::DeliveryChannel] {
...
impl DescribeDeliveryChannelsOutput {
    ...
    pub fn builder() -> super::operation::describe_delivery_channels::builders::DescribeDeliveryChannelsOutputBuilder {
        super::operation::describe_delivery_channels::builders::DescribeDeliveryChannelsOutputBuilder::default()
    }
}
...
pub struct DescribeDeliveryChannelsOutputBuilder {
    pub(crate) delivery_channels: ::std::option::Option<::std::vec::Vec<super::types::DeliveryChannel>>,
    _request_id: Option<String>,
}
impl DescribeDeliveryChannelsOutputBuilder {
    ...
    ///
    /// <p>A list that contains the descriptions of the specified delivery channel.</p>
    pub fn delivery_channels(mut self, input: super::types::DeliveryChannel) -> Self {
    ...
    /// <p>A list that contains the descriptions of the specified delivery channel.</p>
    pub fn set_delivery_channels(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::DeliveryChannel>>) -> Self {
        self.delivery_channels = input;
        self
    }
    /// <p>A list that contains the descriptions of the specified delivery channel.</p>
    pub fn get_delivery_channels(&self) -> &::std::option::Option<::std::vec::Vec<super::types::DeliveryChannel>> {
    ...
    pub fn build(self) -> super::operation::describe_delivery_channels::DescribeDeliveryChannelsOutput {
