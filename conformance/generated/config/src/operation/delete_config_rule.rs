...
impl DeleteConfigRule {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::operation::delete_config_rule::DeleteConfigRuleOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::delete_config_rule::DeleteConfigRuleError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_config_rule::DeleteConfigRuleError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_config_rule::DeleteConfigRuleOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteConfigRuleResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_config_rule::de_delete_config_rule_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_config_rule::de_delete_config_rule_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteConfigRuleRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_config_rule::DeleteConfigRuleInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_config_rule::DeleteConfigRuleInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_delete_config_rule::ser_delete_config_rule_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::delete_config_rule::DeleteConfigRuleError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_config_rule::_delete_config_rule_input::DeleteConfigRuleInput;

pub use super::operation::delete_config_rule::_delete_config_rule_output::DeleteConfigRuleOutput;
