...
impl DeleteConnector {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::delete_connector::DeleteConnectorInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_connector::DeleteConnectorError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_connector::DeleteConnectorOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteConnectorResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_connector::de_delete_connector_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_connector::de_delete_connector_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteConnectorRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_connector::DeleteConnectorInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_connector::DeleteConnectorInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_delete_connector::ser_delete_connector_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::delete_connector::DeleteConnectorError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_connector::_delete_connector_input::DeleteConnectorInput;

pub use super::operation::delete_connector::_delete_connector_output::DeleteConnectorOutput;
