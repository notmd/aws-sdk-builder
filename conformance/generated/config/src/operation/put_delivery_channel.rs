    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::put_delivery_channel::PutDeliveryChannelError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::put_delivery_channel::PutDeliveryChannelOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutDeliveryChannelResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_put_delivery_channel::de_put_delivery_channel_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_put_delivery_channel::de_put_delivery_channel_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutDeliveryChannelRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::put_delivery_channel::PutDeliveryChannelInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::put_delivery_channel::PutDeliveryChannelInput,
        ...
        let body =
            ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_put_delivery_channel::ser_put_delivery_channel_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::put_delivery_channel::PutDeliveryChannelError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::put_delivery_channel::_put_delivery_channel_input::PutDeliveryChannelInput;

pub use super::operation::put_delivery_channel::_put_delivery_channel_output::PutDeliveryChannelOutput;
