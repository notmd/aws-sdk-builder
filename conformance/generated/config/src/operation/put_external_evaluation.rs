...
impl PutExternalEvaluation {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::put_external_evaluation::PutExternalEvaluationInput,
    ) -> ::std::result::Result<
        super::operation::put_external_evaluation::PutExternalEvaluationOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::put_external_evaluation::PutExternalEvaluationError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::put_external_evaluation::PutExternalEvaluationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::put_external_evaluation::PutExternalEvaluationOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutExternalEvaluationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_put_external_evaluation::de_put_external_evaluation_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_put_external_evaluation::de_put_external_evaluation_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutExternalEvaluationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::put_external_evaluation::PutExternalEvaluationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::put_external_evaluation::PutExternalEvaluationInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_put_external_evaluation::ser_put_external_evaluation_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::operation::put_external_evaluation::PutExternalEvaluationError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::put_external_evaluation::_put_external_evaluation_input::PutExternalEvaluationInput;

pub use super::operation::put_external_evaluation::_put_external_evaluation_output::PutExternalEvaluationOutput;
