...
impl PutConfigRuleOutput {
    ...
    pub fn builder() -> super::operation::put_config_rule::builders::PutConfigRuleOutputBuilder {
        super::operation::put_config_rule::builders::PutConfigRuleOutputBuilder::default()
    }
}
...
impl PutConfigRuleOutputBuilder {
    ...
    pub fn build(self) -> super::operation::put_config_rule::PutConfigRuleOutput {
