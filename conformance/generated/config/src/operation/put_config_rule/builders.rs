...
pub use super::operation::put_config_rule::_put_config_rule_input::PutConfigRuleInputBuilder;

pub use super::operation::put_config_rule::_put_config_rule_output::PutConfigRuleOutputBuilder;

impl super::operation::put_config_rule::builders::PutConfigRuleInputBuilder {
...
pub struct PutConfigRuleFluentBuilder {
    ...
    inner: super::operation::put_config_rule::builders::PutConfigRuleInputBuilder,
...
impl PutConfigRuleFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::put_config_rule::builders::PutConfigRuleInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::put_config_rule::PutConfigRule::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::put_config_rule::PutConfigRule::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn config_rule(mut self, input: super::types::ConfigRule) -> Self {
        self.inner = self.inner.config_rule(input);
        self
    }
    /// <p>The rule that you want to add to your account.</p>
    pub fn set_config_rule(mut self, input: ::std::option::Option<super::types::ConfigRule>) -> Self {
        self.inner = self.inner.set_config_rule(input);
        self
    }
    /// <p>The rule that you want to add to your account.</p>
    pub fn get_config_rule(&self) -> &::std::option::Option<super::types::ConfigRule> {
