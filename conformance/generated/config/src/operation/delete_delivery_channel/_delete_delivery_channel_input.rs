...
impl DeleteDeliveryChannelInput {
    ...
    pub fn builder() -> super::operation::delete_delivery_channel::builders::DeleteDeliveryChannelInputBuilder {
        super::operation::delete_delivery_channel::builders::DeleteDeliveryChannelInputBuilder::default()
    }
}
...
impl DeleteDeliveryChannelInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::delete_delivery_channel::DeleteDeliveryChannelInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::delete_delivery_channel::DeleteDeliveryChannelInput {
