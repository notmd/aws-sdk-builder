...
pub struct GetAggregateConformancePackComplianceSummaryOutput {
    ...
    pub aggregate_conformance_pack_compliance_summaries:
        ::std::option::Option<::std::vec::Vec<super::types::AggregateConformancePackComplianceSummary>>,
...
impl GetAggregateConformancePackComplianceSummaryOutput {
    ...
    pub fn aggregate_conformance_pack_compliance_summaries(&self) -> &[super::types::AggregateConformancePackComplianceSummary] {
...
impl GetAggregateConformancePackComplianceSummaryOutput {
    ...
    {
        super::operation::get_aggregate_conformance_pack_compliance_summary::builders::GetAggregateConformancePackComplianceSummaryOutputBuilder::default()
    }
}
...
impl GetAggregateConformancePackComplianceSummaryOutputBuilder {
    ...
    ///
    /// <p>Returns a list of <code>AggregateConformancePackComplianceSummary</code> object.</p>
    pub fn aggregate_conformance_pack_compliance_summaries(mut self, input: super::types::AggregateConformancePackComplianceSummary) -> Self {
    ...
    pub fn set_aggregate_conformance_pack_compliance_summaries(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::AggregateConformancePackComplianceSummary>>,
    ) -> Self {
    ...
    pub fn build(self) -> super::operation::get_aggregate_conformance_pack_compliance_summary::GetAggregateConformancePackComplianceSummaryOutput {
