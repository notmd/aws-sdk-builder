...
pub struct BatchGetResourceConfigOutput {
    ...
    pub unprocessed_resource_keys: ::std::option::Option<::std::vec::Vec<super::types::ResourceKey>>,
...
impl BatchGetResourceConfigOutput {
    ...
    pub fn unprocessed_resource_keys(&self) -> &[super::types::ResourceKey] {
...
impl BatchGetResourceConfigOutput {
    ...
    pub fn builder() -> super::operation::batch_get_resource_config::builders::BatchGetResourceConfigOutputBuilder {
        super::operation::batch_get_resource_config::builders::BatchGetResourceConfigOutputBuilder::default()
    }
}
...
pub struct BatchGetResourceConfigOutputBuilder {
    ...
    pub(crate) unprocessed_resource_keys: ::std::option::Option<::std::vec::Vec<super::types::ResourceKey>>,
    _request_id: Option<String>,
}
impl BatchGetResourceConfigOutputBuilder {
    ...
    ///
    /// <p>A list of resource keys that were not processed with the current response. The unprocessesResourceKeys value is in the same form as ResourceKeys, so the value can be directly provided to a subsequent BatchGetResourceConfig operation. If there are no unprocessed resource keys, the response contains an empty unprocessedResourceKeys list.</p>
    pub fn unprocessed_resource_keys(mut self, input: super::types::ResourceKey) -> Self {
    ...
    /// <p>A list of resource keys that were not processed with the current response. The unprocessesResourceKeys value is in the same form as ResourceKeys, so the value can be directly provided to a subsequent BatchGetResourceConfig operation. If there are no unprocessed resource keys, the response contains an empty unprocessedResourceKeys list.</p>
    pub fn set_unprocessed_resource_keys(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::ResourceKey>>) -> Self {
        self.unprocessed_resource_keys = input;
        self
    }
    /// <p>A list of resource keys that were not processed with the current response. The unprocessesResourceKeys value is in the same form as ResourceKeys, so the value can be directly provided to a subsequent BatchGetResourceConfig operation. If there are no unprocessed resource keys, the response contains an empty unprocessedResourceKeys list.</p>
    pub fn get_unprocessed_resource_keys(&self) -> &::std::option::Option<::std::vec::Vec<super::types::ResourceKey>> {
    ...
    pub fn build(self) -> super::operation::batch_get_resource_config::BatchGetResourceConfigOutput {
