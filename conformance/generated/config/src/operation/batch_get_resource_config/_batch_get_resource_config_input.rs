...
impl BatchGetResourceConfigInput {
    ...
    pub fn builder() -> super::operation::batch_get_resource_config::builders::BatchGetResourceConfigInputBuilder {
        super::operation::batch_get_resource_config::builders::BatchGetResourceConfigInputBuilder::default()
    }
}
...
impl BatchGetResourceConfigInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::batch_get_resource_config::BatchGetResourceConfigInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::batch_get_resource_config::BatchGetResourceConfigInput {
