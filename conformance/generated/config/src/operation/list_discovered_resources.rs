    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_discovered_resources::ListDiscoveredResourcesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_discovered_resources::ListDiscoveredResourcesOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListDiscoveredResourcesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_discovered_resources::de_list_discovered_resources_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_discovered_resources::de_list_discovered_resources_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListDiscoveredResourcesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_discovered_resources::ListDiscoveredResourcesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_discovered_resources::ListDiscoveredResourcesInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_list_discovered_resources::ser_list_discovered_resources_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::list_discovered_resources::ListDiscoveredResourcesError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_discovered_resources::_list_discovered_resources_input::ListDiscoveredResourcesInput;

pub use super::operation::list_discovered_resources::_list_discovered_resources_output::ListDiscoveredResourcesOutput;
