...
pub struct GetAggregateConfigRuleComplianceSummaryOutput {
    ...
    pub aggregate_compliance_counts: ::std::option::Option<::std::vec::Vec<super::types::AggregateComplianceCount>>,
...
impl GetAggregateConfigRuleComplianceSummaryOutput {
    ...
    pub fn aggregate_compliance_counts(&self) -> &[super::types::AggregateComplianceCount] {
...
impl GetAggregateConfigRuleComplianceSummaryOutput {
    ...
    pub fn builder() -> super::operation::get_aggregate_config_rule_compliance_summary::builders::GetAggregateConfigRuleComplianceSummaryOutputBuilder
    {
...
pub struct GetAggregateConfigRuleComplianceSummaryOutputBuilder {
    ...
    pub(crate) aggregate_compliance_counts: ::std::option::Option<::std::vec::Vec<super::types::AggregateComplianceCount>>,
...
impl GetAggregateConfigRuleComplianceSummaryOutputBuilder {
    ...
    ///
    /// <p>Returns a list of AggregateComplianceCounts object.</p>
    pub fn aggregate_compliance_counts(mut self, input: super::types::AggregateComplianceCount) -> Self {
    ...
    /// <p>Returns a list of AggregateComplianceCounts object.</p>
    pub fn set_aggregate_compliance_counts(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::AggregateComplianceCount>>) -> Self {
        self.aggregate_compliance_counts = input;
        self
    }
    /// <p>Returns a list of AggregateComplianceCounts object.</p>
    pub fn get_aggregate_compliance_counts(&self) -> &::std::option::Option<::std::vec::Vec<super::types::AggregateComplianceCount>> {
    ...
    pub fn build(self) -> super::operation::get_aggregate_config_rule_compliance_summary::GetAggregateConfigRuleComplianceSummaryOutput {
