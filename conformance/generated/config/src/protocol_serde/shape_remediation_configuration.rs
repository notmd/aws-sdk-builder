...
pub fn ser_remediation_configuration(
    ...
    input: &super::types::RemediationConfiguration,
        ...
        for (key_4, value_5) in var_2 {
            {
                ...
                super::protocol_serde::shape_remediation_parameter_value::ser_remediation_parameter_value(&mut object_6, value_5)?;
                object_6.finish();
            }
        }
        object_3.finish();
    ...
    if let Some(var_8) = &input.execution_controls {
        ...
        super::protocol_serde::shape_execution_controls::ser_execution_controls(&mut object_9, var_8)?;
        object_9.finish();
    }
...
pub(crate) fn de_remediation_configuration<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::types::RemediationConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::types::builders::RemediationConfigurationBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "TargetType" => {
                            builder = builder.set_target_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| super::types::RemediationTargetType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "TargetId" => {
                        ...
                        "Parameters" => {
                            builder = builder.set_parameters(super::protocol_serde::shape_remediation_parameters::de_remediation_parameters(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "ExecutionControls" => {
                            builder = builder.set_execution_controls(super::protocol_serde::shape_execution_controls::de_execution_controls(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
            ...
            Ok(Some(
                super::serde_util::remediation_configuration_correct_errors(builder)
                    .build()
