...
pub(crate) fn de_scope<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::types::Scope>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::types::builders::ScopeBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "ComplianceResourceTypes" => {
                            builder = builder.set_compliance_resource_types(
                                super::protocol_serde::shape_compliance_resource_types::de_compliance_resource_types(tokens, _value, depth + 1)?,
                            );
                        }
                        "TagKey" => {
                        ...
                        "ServicePrincipals" => {
                            builder = builder.set_service_principals(super::protocol_serde::shape_service_principals::de_service_principals(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
