...
pub(crate) fn de_configuration_item<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::types::ConfigurationItem>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::types::builders::ConfigurationItemBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "configurationItemStatus" => {
                            builder = builder.set_configuration_item_status(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| super::types::ConfigurationItemStatus::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        ...
                        "resourceType" => {
                            builder = builder.set_resource_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| super::types::ResourceType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "resourceId" => {
                        ...
                        "relatedEvents" => {
                            builder = builder.set_related_events(super::protocol_serde::shape_related_event_list::de_related_event_list(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "relationships" => {
                            builder = builder.set_relationships(super::protocol_serde::shape_relationship_list::de_relationship_list(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "supplementaryConfiguration" => {
                            builder = builder.set_supplementary_configuration(
                                super::protocol_serde::shape_supplementary_configuration::de_supplementary_configuration(tokens, _value, depth + 1)?,
                            );
                        }
                        "recordingFrequency" => {
                            builder = builder.set_recording_frequency(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| super::types::RecordingFrequency::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
