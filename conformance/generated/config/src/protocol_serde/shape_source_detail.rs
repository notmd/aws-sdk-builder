...
pub fn ser_source_detail(
    ...
    input: &super::types::SourceDetail,
...
pub(crate) fn de_source_detail<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::types::SourceDetail>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::types::builders::SourceDetailBuilder::default();
            loop {
                match tokens.next().transpose()? {
                        ...
                        "EventSource" => {
                            builder = builder.set_event_source(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| super::types::EventSource::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "MessageType" => {
                            builder = builder.set_message_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| super::types::MessageType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
