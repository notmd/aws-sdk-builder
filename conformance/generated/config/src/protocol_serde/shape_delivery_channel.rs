...
pub fn ser_delivery_channel(
    ...
    input: &super::types::DeliveryChannel,
    ...
    if let Some(var_6) = &input.config_snapshot_delivery_properties {
        ...
        super::protocol_serde::shape_config_snapshot_delivery_properties::ser_config_snapshot_delivery_properties(&mut object_7, var_6)?;
        object_7.finish();
    }
    Ok(())
}
...
pub(crate) fn de_delivery_channel<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::types::DeliveryChannel>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::types::builders::DeliveryChannelBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "configSnapshotDeliveryProperties" => {
                            builder = builder.set_config_snapshot_delivery_properties(
                                super::protocol_serde::shape_config_snapshot_delivery_properties::de_config_snapshot_delivery_properties(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
