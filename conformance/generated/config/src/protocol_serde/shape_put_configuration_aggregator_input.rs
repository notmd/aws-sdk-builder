...
pub fn ser_put_configuration_aggregator_input_input(
        ...
        for item_4 in var_2 {
            {
                ...
                super::protocol_serde::shape_account_aggregation_source::ser_account_aggregation_source(&mut object_5, item_4)?;
                object_5.finish();
            }
        }
        array_3.finish();
    ...
    if let Some(var_6) = &input.organization_aggregation_source {
        ...
        super::protocol_serde::shape_organization_aggregation_source::ser_organization_aggregation_source(&mut object_7, var_6)?;
        object_7.finish();
    }
        ...
        for item_10 in var_8 {
            {
                ...
                super::protocol_serde::shape_tag::ser_tag(&mut object_11, item_10)?;
                object_11.finish();
            }
        }
        array_9.finish();
    ...
    if let Some(var_12) = &input.aggregator_filters {
        ...
        super::protocol_serde::shape_aggregator_filters::ser_aggregator_filters(&mut object_13, var_12)?;
        object_13.finish();
    }
    Ok(())
}
