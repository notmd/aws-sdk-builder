...
pub fn ser_start_resource_evaluation_input_input(
    ...
    if let Some(var_1) = &input.resource_details {
        ...
        super::protocol_serde::shape_resource_details::ser_resource_details(&mut object_2, var_1)?;
        object_2.finish();
    }
    if let Some(var_3) = &input.evaluation_context {
        #[allow(unused_mut)]
        let mut object_4 = object.key("EvaluationContext").start_object();
        super::protocol_serde::shape_evaluation_context::ser_evaluation_context(&mut object_4, var_3)?;
        object_4.finish();
    }
