...
pub(crate) fn de_last_delivery_channel_delete_failed_exception_json_err(
    _value: &[u8],
    mut builder: super::types::error::builders::LastDeliveryChannelDeleteFailedExceptionBuilder,
) -> ::std::result::Result<
    super::types::error::builders::LastDeliveryChannelDeleteFailedExceptionBuilder,
