...
pub fn ser_organization_custom_rule_metadata(
    ...
    input: &super::types::OrganizationCustomRuleMetadata,
...
pub(crate) fn de_organization_custom_rule_metadata<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::types::OrganizationCustomRuleMetadata>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::types::builders::OrganizationCustomRuleMetadataBuilder::default();
            loop {
                match tokens.next().transpose()? {
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "OrganizationConfigRuleTriggerTypes" => {
                                builder = builder.set_organization_config_rule_trigger_types(
                                    super::protocol_serde::shape_organization_config_rule_trigger_types::de_organization_config_rule_trigger_types(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
                            ...
                            "ResourceTypesScope" => {
                                builder = builder.set_resource_types_scope(
                                    super::protocol_serde::shape_resource_types_scope::de_resource_types_scope(tokens, _value, depth + 1)?,
                                );
                            }
                            "ResourceIdScope" => {
            ...
            Ok(Some(
                super::serde_util::organization_custom_rule_metadata_correct_errors(builder)
                    .build()
