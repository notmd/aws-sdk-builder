...
> {
    ...
    Err(match error_code {
        "InvalidLimitException" => super::operation::list_tags_for_resource::ListTagsForResourceError::InvalidLimitException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidNextTokenException" => super::operation::list_tags_for_resource::ListTagsForResourceError::InvalidNextTokenException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
