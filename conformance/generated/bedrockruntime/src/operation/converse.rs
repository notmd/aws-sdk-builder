    ...
    > {
        let map_err =
            |err: ::aws_smithy_runtime_api::client::result::SdkError<
                ...
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >| { err.map_service_error(|err| err.downcast::<super::operation::converse::ConverseError>().expect("correct error type")) };
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::converse::ConverseOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ConverseResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_converse::de_converse_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_converse::de_converse_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ConverseRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::converse::ConverseInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::converse::ConverseInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_converse::ser_converse_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::converse::ConverseError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::converse::_converse_input::ConverseInput;

pub use super::operation::converse::_converse_output::ConverseOutput;
