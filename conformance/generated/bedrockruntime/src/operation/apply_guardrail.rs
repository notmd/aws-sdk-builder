    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::apply_guardrail::ApplyGuardrailError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::apply_guardrail::ApplyGuardrailOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ApplyGuardrailResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_apply_guardrail::de_apply_guardrail_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_apply_guardrail::de_apply_guardrail_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ApplyGuardrailRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::apply_guardrail::ApplyGuardrailInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::apply_guardrail::ApplyGuardrailInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_apply_guardrail::ser_apply_guardrail_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::apply_guardrail::ApplyGuardrailError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::apply_guardrail::_apply_guardrail_input::ApplyGuardrailInput;

pub use super::operation::apply_guardrail::_apply_guardrail_output::ApplyGuardrailOutput;
