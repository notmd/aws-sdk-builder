...
pub struct ListAsyncInvokesOutput {
    ...
    pub async_invoke_summaries: ::std::option::Option<::std::vec::Vec<super::types::AsyncInvokeSummary>>,
...
impl ListAsyncInvokesOutput {
    ...
    pub fn async_invoke_summaries(&self) -> &[super::types::AsyncInvokeSummary] {
...
impl ListAsyncInvokesOutput {
    ...
    pub fn builder() -> super::operation::list_async_invokes::builders::ListAsyncInvokesOutputBuilder {
        super::operation::list_async_invokes::builders::ListAsyncInvokesOutputBuilder::default()
    }
}
...
pub struct ListAsyncInvokesOutputBuilder {
    ...
    pub(crate) async_invoke_summaries: ::std::option::Option<::std::vec::Vec<super::types::AsyncInvokeSummary>>,
    _request_id: Option<String>,
}
impl ListAsyncInvokesOutputBuilder {
    ...
    ///
    /// <p>A list of invocation summaries.</p>
    pub fn async_invoke_summaries(mut self, input: super::types::AsyncInvokeSummary) -> Self {
    ...
    /// <p>A list of invocation summaries.</p>
    pub fn set_async_invoke_summaries(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::AsyncInvokeSummary>>) -> Self {
        self.async_invoke_summaries = input;
        self
    }
    /// <p>A list of invocation summaries.</p>
    pub fn get_async_invoke_summaries(&self) -> &::std::option::Option<::std::vec::Vec<super::types::AsyncInvokeSummary>> {
    ...
    pub fn build(self) -> super::operation::list_async_invokes::ListAsyncInvokesOutput {
