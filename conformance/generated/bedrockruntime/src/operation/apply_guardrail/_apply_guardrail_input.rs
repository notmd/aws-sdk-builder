...
pub struct ApplyGuardrailInput {
    ...
    pub source: ::std::option::Option<super::types::GuardrailContentSource>,
    /// <p>The content details used in the request to apply the guardrail.</p>
    pub content: ::std::option::Option<::std::vec::Vec<super::types::GuardrailContentBlock>>,
    ...
    pub output_scope: ::std::option::Option<super::types::GuardrailOutputScope>,
}
impl ApplyGuardrailInput {
    ...
    /// <p>The source of data used in the request to apply the guardrail.</p>
    pub fn source(&self) -> ::std::option::Option<&super::types::GuardrailContentSource> {
        self.source.as_ref()
    }
    /// <p>The content details used in the request to apply the guardrail.</p>
    ///
    ...
    pub fn content(&self) -> &[super::types::GuardrailContentBlock] {
        self.content.as_deref().unwrap_or_default()
    }
    /// <p>Specifies the scope of the output that you get in the response. Set to <code>FULL</code> to return the entire output, including any detected and non-detected entries in the response for enhanced debugging.</p>
    /// <p>Note that the full output scope doesn't apply to word filters or regex in sensitive information filters. It does apply to all other filtering policies, including sensitive information with filters that can detect personally identifiable information (PII).</p>
    pub fn output_scope(&self) -> ::std::option::Option<&super::types::GuardrailOutputScope> {
...
impl ApplyGuardrailInput {
    ...
    pub fn builder() -> super::operation::apply_guardrail::builders::ApplyGuardrailInputBuilder {
        super::operation::apply_guardrail::builders::ApplyGuardrailInputBuilder::default()
    }
}
...
pub struct ApplyGuardrailInputBuilder {
    ...
    pub(crate) source: ::std::option::Option<super::types::GuardrailContentSource>,
    pub(crate) content: ::std::option::Option<::std::vec::Vec<super::types::GuardrailContentBlock>>,
    pub(crate) output_scope: ::std::option::Option<super::types::GuardrailOutputScope>,
}
impl ApplyGuardrailInputBuilder {
    ...
    /// <p>The source of data used in the request to apply the guardrail.</p>
    /// This field is required.
    pub fn source(mut self, input: super::types::GuardrailContentSource) -> Self {
        self.source = ::std::option::Option::Some(input);
        self
    }
    /// <p>The source of data used in the request to apply the guardrail.</p>
    pub fn set_source(mut self, input: ::std::option::Option<super::types::GuardrailContentSource>) -> Self {
        self.source = input;
        self
    }
    /// <p>The source of data used in the request to apply the guardrail.</p>
    pub fn get_source(&self) -> &::std::option::Option<super::types::GuardrailContentSource> {
        &self.source
    }
    ...
    ///
    /// <p>The content details used in the request to apply the guardrail.</p>
    pub fn content(mut self, input: super::types::GuardrailContentBlock) -> Self {
    ...
    /// <p>The content details used in the request to apply the guardrail.</p>
    pub fn set_content(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::GuardrailContentBlock>>) -> Self {
        self.content = input;
        self
    }
    /// <p>The content details used in the request to apply the guardrail.</p>
    pub fn get_content(&self) -> &::std::option::Option<::std::vec::Vec<super::types::GuardrailContentBlock>> {
        &self.content
    }
    /// <p>Specifies the scope of the output that you get in the response. Set to <code>FULL</code> to return the entire output, including any detected and non-detected entries in the response for enhanced debugging.</p>
    /// <p>Note that the full output scope doesn't apply to word filters or regex in sensitive information filters. It does apply to all other filtering policies, including sensitive information with filters that can detect personally identifiable information (PII).</p>
    pub fn output_scope(mut self, input: super::types::GuardrailOutputScope) -> Self {
        self.output_scope = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies the scope of the output that you get in the response. Set to <code>FULL</code> to return the entire output, including any detected and non-detected entries in the response for enhanced debugging.</p>
    /// <p>Note that the full output scope doesn't apply to word filters or regex in sensitive information filters. It does apply to all other filtering policies, including sensitive information with filters that can detect personally identifiable information (PII).</p>
    pub fn set_output_scope(mut self, input: ::std::option::Option<super::types::GuardrailOutputScope>) -> Self {
        self.output_scope = input;
        self
    }
    /// <p>Specifies the scope of the output that you get in the response. Set to <code>FULL</code> to return the entire output, including any detected and non-detected entries in the response for enhanced debugging.</p>
    /// <p>Note that the full output scope doesn't apply to word filters or regex in sensitive information filters. It does apply to all other filtering policies, including sensitive information with filters that can detect personally identifiable information (PII).</p>
    pub fn get_output_scope(&self) -> &::std::option::Option<super::types::GuardrailOutputScope> {
        &self.output_scope
    }
    /// Consumes the builder and constructs a [`ApplyGuardrailInput`](crate::operation::apply_guardrail::ApplyGuardrailInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::apply_guardrail::ApplyGuardrailInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::apply_guardrail::ApplyGuardrailInput {
