...
impl GetAsyncInvokeInput {
    ...
    pub fn builder() -> super::operation::get_async_invoke::builders::GetAsyncInvokeInputBuilder {
        super::operation::get_async_invoke::builders::GetAsyncInvokeInputBuilder::default()
    }
}
...
impl GetAsyncInvokeInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_async_invoke::GetAsyncInvokeInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_async_invoke::GetAsyncInvokeInput {
