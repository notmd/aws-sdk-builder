...
pub use super::operation::get_async_invoke::_get_async_invoke_input::GetAsyncInvokeInputBuilder;

pub use super::operation::get_async_invoke::_get_async_invoke_output::GetAsyncInvokeOutputBuilder;

impl super::operation::get_async_invoke::builders::GetAsyncInvokeInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::Client,
    ) -> ::std::result::Result<
        super::operation::get_async_invoke::GetAsyncInvokeOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::get_async_invoke::GetAsyncInvokeError,
...
pub struct GetAsyncInvokeFluentBuilder {
    ...
    inner: super::operation::get_async_invoke::builders::GetAsyncInvokeInputBuilder,
...
impl GetAsyncInvokeFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::get_async_invoke::builders::GetAsyncInvokeInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::get_async_invoke::GetAsyncInvoke::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::get_async_invoke::GetAsyncInvoke::orchestrate(&runtime_plugins, input).await
    }
