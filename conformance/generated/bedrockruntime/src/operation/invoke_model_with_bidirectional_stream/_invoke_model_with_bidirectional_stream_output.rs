...
pub struct InvokeModelWithBidirectionalStreamOutput {
    ...
    pub body: super::event_receiver::EventReceiver<
        super::types::InvokeModelWithBidirectionalStreamOutput,
        super::types::error::InvokeModelWithBidirectionalStreamOutputError,
    >,
...
impl InvokeModelWithBidirectionalStreamOutput {
    ...
    pub fn builder() -> super::operation::invoke_model_with_bidirectional_stream::builders::InvokeModelWithBidirectionalStreamOutputBuilder {
