...
impl StartAsyncInvokeInput {
    ...
    pub fn builder() -> super::operation::start_async_invoke::builders::StartAsyncInvokeInputBuilder {
        super::operation::start_async_invoke::builders::StartAsyncInvokeInputBuilder::default()
    }
}
...
impl StartAsyncInvokeInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::start_async_invoke::StartAsyncInvokeInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::start_async_invoke::StartAsyncInvokeInput {
