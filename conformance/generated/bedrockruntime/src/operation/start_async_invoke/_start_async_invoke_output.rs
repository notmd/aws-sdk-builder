...
impl StartAsyncInvokeOutput {
    ...
    pub fn builder() -> super::operation::start_async_invoke::builders::StartAsyncInvokeOutputBuilder {
        super::operation::start_async_invoke::builders::StartAsyncInvokeOutputBuilder::default()
    }
}
...
impl StartAsyncInvokeOutputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::start_async_invoke::StartAsyncInvokeOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::start_async_invoke::StartAsyncInvokeOutput {
