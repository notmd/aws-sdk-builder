...
impl CountTokensInput {
    ...
    pub fn builder() -> super::operation::count_tokens::builders::CountTokensInputBuilder {
        super::operation::count_tokens::builders::CountTokensInputBuilder::default()
    }
}
...
impl CountTokensInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::count_tokens::CountTokensInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::count_tokens::CountTokensInput {
