...
impl CountTokensOutput {
    ...
    pub fn builder() -> super::operation::count_tokens::builders::CountTokensOutputBuilder {
        super::operation::count_tokens::builders::CountTokensOutputBuilder::default()
    }
}
...
impl CountTokensOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::count_tokens::CountTokensOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::count_tokens::CountTokensOutput {
