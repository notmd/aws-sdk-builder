...
impl InvokeModelOutput {
    ...
    pub fn builder() -> super::operation::invoke_model::builders::InvokeModelOutputBuilder {
        super::operation::invoke_model::builders::InvokeModelOutputBuilder::default()
    }
}
...
impl InvokeModelOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::invoke_model::InvokeModelOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::invoke_model::InvokeModelOutput {
