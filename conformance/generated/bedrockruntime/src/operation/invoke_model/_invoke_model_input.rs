...
impl InvokeModelInput {
    ...
    pub fn builder() -> super::operation::invoke_model::builders::InvokeModelInputBuilder {
        super::operation::invoke_model::builders::InvokeModelInputBuilder::default()
    }
}
...
impl InvokeModelInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::invoke_model::InvokeModelInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::invoke_model::InvokeModelInput {
            body: self.body,
