...
pub struct InvokeModelWithResponseStreamOutput {
    ...
    pub body: super::event_receiver::EventReceiver<super::types::ResponseStream, super::types::error::ResponseStreamError>,
    /// <p>The MIME type of the inference result.</p>
    pub content_type: ::std::string::String,
    /// <p>Model performance settings for the request.</p>
    pub performance_config_latency: ::std::option::Option<super::types::PerformanceConfigLatency>,
    /// <p>Specifies the processing tier type used for serving the request.</p>
    pub service_tier: ::std::option::Option<super::types::ServiceTierType>,
    _request_id: Option<String>,
}
impl InvokeModelWithResponseStreamOutput {
    /// <p>Inference response from the model in the format specified by the <code>contentType</code> header. To see the format and content of this field for different models, refer to <a href="https://docs.aws.amazon.com/bedrock/latest/userguide/model-parameters.html">Inference parameters</a>.</p>
    pub fn body(&self) -> &super::event_receiver::EventReceiver<super::types::ResponseStream, super::types::error::ResponseStreamError> {
        &self.body
    }
    /// <p>The MIME type of the inference result.</p>
    ...
    /// <p>Model performance settings for the request.</p>
    pub fn performance_config_latency(&self) -> ::std::option::Option<&super::types::PerformanceConfigLatency> {
        self.performance_config_latency.as_ref()
    }
    /// <p>Specifies the processing tier type used for serving the request.</p>
    pub fn service_tier(&self) -> ::std::option::Option<&super::types::ServiceTierType> {
...
impl InvokeModelWithResponseStreamOutput {
    ...
    pub fn builder() -> super::operation::invoke_model_with_response_stream::builders::InvokeModelWithResponseStreamOutputBuilder {
        super::operation::invoke_model_with_response_stream::builders::InvokeModelWithResponseStreamOutputBuilder::default()
    }
}
...
pub struct InvokeModelWithResponseStreamOutputBuilder {
    pub(crate) body:
        ::std::option::Option<super::event_receiver::EventReceiver<super::types::ResponseStream, super::types::error::ResponseStreamError>>,
    pub(crate) content_type: ::std::option::Option<::std::string::String>,
    pub(crate) performance_config_latency: ::std::option::Option<super::types::PerformanceConfigLatency>,
    pub(crate) service_tier: ::std::option::Option<super::types::ServiceTierType>,
    _request_id: Option<String>,
}
impl InvokeModelWithResponseStreamOutputBuilder {
    ...
    pub fn body(
        mut self,
        input: super::event_receiver::EventReceiver<super::types::ResponseStream, super::types::error::ResponseStreamError>,
    ) -> Self {
    ...
    pub fn set_body(
        mut self,
        input: ::std::option::Option<super::event_receiver::EventReceiver<super::types::ResponseStream, super::types::error::ResponseStreamError>>,
    ) -> Self {
        self.body = input;
        self
    }
    ...
    /// <p>Model performance settings for the request.</p>
    pub fn performance_config_latency(mut self, input: super::types::PerformanceConfigLatency) -> Self {
        self.performance_config_latency = ::std::option::Option::Some(input);
        self
    }
    /// <p>Model performance settings for the request.</p>
    pub fn set_performance_config_latency(mut self, input: ::std::option::Option<super::types::PerformanceConfigLatency>) -> Self {
        self.performance_config_latency = input;
        self
    }
    /// <p>Model performance settings for the request.</p>
    pub fn get_performance_config_latency(&self) -> &::std::option::Option<super::types::PerformanceConfigLatency> {
        &self.performance_config_latency
    }
    /// <p>Specifies the processing tier type used for serving the request.</p>
    pub fn service_tier(mut self, input: super::types::ServiceTierType) -> Self {
        self.service_tier = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies the processing tier type used for serving the request.</p>
    pub fn set_service_tier(mut self, input: ::std::option::Option<super::types::ServiceTierType>) -> Self {
        self.service_tier = input;
        self
    }
    /// <p>Specifies the processing tier type used for serving the request.</p>
    pub fn get_service_tier(&self) -> &::std::option::Option<super::types::ServiceTierType> {
        &self.service_tier
    }
    ...
    > {
        ::std::result::Result::Ok(super::operation::invoke_model_with_response_stream::InvokeModelWithResponseStreamOutput {
