...
pub struct ConverseStreamInput {
    ...
    pub inference_config: ::std::option::Option<super::types::InferenceConfiguration>,
    ...
    pub performance_config: ::std::option::Option<super::types::PerformanceConfiguration>,
    /// <p>Specifies the processing tier configuration used for serving the request.</p>
    pub service_tier: ::std::option::Option<super::types::ServiceTier>,
    /// <p>Output configuration for a model response.</p>
    pub output_config: ::std::option::Option<super::types::OutputConfig>,
}
impl ConverseStreamInput {
    ...
    /// <p>Inference parameters to pass to the model. <code>Converse</code> and <code>ConverseStream</code> support a base set of inference parameters. If you need to pass additional parameters that the model supports, use the <code>additionalModelRequestFields</code> request field.</p>
    pub fn inference_config(&self) -> ::std::option::Option<&super::types::InferenceConfiguration> {
    ...
    /// <p>Configuration information for a guardrail that you want to use in the request. If you include <code>guardContent</code> blocks in the <code>content</code> field in the <code>messages</code> field, the guardrail operates only on those messages. If you include no <code>guardContent</code> blocks, the guardrail operates on all messages in the request body and in any included prompt resource.</p>
    pub fn guardrail_config(&self) -> ::std::option::Option<&super::types::GuardrailStreamConfiguration> {
    ...
    /// <p>Contains a map of variables in a prompt from Prompt management to objects containing the values to fill in for them when running model invocation. This field is ignored if you don't specify a prompt resource in the <code>modelId</code> field.</p>
    pub fn prompt_variables(&self) -> ::std::option::Option<&::std::collections::HashMap<::std::string::String, super::types::PromptVariableValues>> {
    ...
    /// <p>Model performance settings for the request.</p>
    pub fn performance_config(&self) -> ::std::option::Option<&super::types::PerformanceConfiguration> {
        self.performance_config.as_ref()
    }
    /// <p>Specifies the processing tier configuration used for serving the request.</p>
    pub fn service_tier(&self) -> ::std::option::Option<&super::types::ServiceTier> {
        self.service_tier.as_ref()
    }
    /// <p>Output configuration for a model response.</p>
    pub fn output_config(&self) -> ::std::option::Option<&super::types::OutputConfig> {
...
impl ConverseStreamInput {
    ...
    pub fn builder() -> super::operation::converse_stream::builders::ConverseStreamInputBuilder {
        super::operation::converse_stream::builders::ConverseStreamInputBuilder::default()
    }
}
...
pub struct ConverseStreamInputBuilder {
    ...
    pub(crate) output_config: ::std::option::Option<super::types::OutputConfig>,
}
impl ConverseStreamInputBuilder {
    ...
    /// <p>Inference parameters to pass to the model. <code>Converse</code> and <code>ConverseStream</code> support a base set of inference parameters. If you need to pass additional parameters that the model supports, use the <code>additionalModelRequestFields</code> request field.</p>
    pub fn inference_config(mut self, input: super::types::InferenceConfiguration) -> Self {
        self.inference_config = ::std::option::Option::Some(input);
        self
    }
    /// <p>Inference parameters to pass to the model. <code>Converse</code> and <code>ConverseStream</code> support a base set of inference parameters. If you need to pass additional parameters that the model supports, use the <code>additionalModelRequestFields</code> request field.</p>
    pub fn set_inference_config(mut self, input: ::std::option::Option<super::types::InferenceConfiguration>) -> Self {
        self.inference_config = input;
        self
    }
    /// <p>Inference parameters to pass to the model. <code>Converse</code> and <code>ConverseStream</code> support a base set of inference parameters. If you need to pass additional parameters that the model supports, use the <code>additionalModelRequestFields</code> request field.</p>
    pub fn get_inference_config(&self) -> &::std::option::Option<super::types::InferenceConfiguration> {
    ...
    /// <p>Configuration information for a guardrail that you want to use in the request. If you include <code>guardContent</code> blocks in the <code>content</code> field in the <code>messages</code> field, the guardrail operates only on those messages. If you include no <code>guardContent</code> blocks, the guardrail operates on all messages in the request body and in any included prompt resource.</p>
    pub fn guardrail_config(mut self, input: super::types::GuardrailStreamConfiguration) -> Self {
        self.guardrail_config = ::std::option::Option::Some(input);
        self
    }
    /// <p>Configuration information for a guardrail that you want to use in the request. If you include <code>guardContent</code> blocks in the <code>content</code> field in the <code>messages</code> field, the guardrail operates only on those messages. If you include no <code>guardContent</code> blocks, the guardrail operates on all messages in the request body and in any included prompt resource.</p>
    pub fn set_guardrail_config(mut self, input: ::std::option::Option<super::types::GuardrailStreamConfiguration>) -> Self {
        self.guardrail_config = input;
        self
    }
    /// <p>Configuration information for a guardrail that you want to use in the request. If you include <code>guardContent</code> blocks in the <code>content</code> field in the <code>messages</code> field, the guardrail operates only on those messages. If you include no <code>guardContent</code> blocks, the guardrail operates on all messages in the request body and in any included prompt resource.</p>
    pub fn get_guardrail_config(&self) -> &::std::option::Option<super::types::GuardrailStreamConfiguration> {
    ...
    ///
    /// <p>Contains a map of variables in a prompt from Prompt management to objects containing the values to fill in for them when running model invocation. This field is ignored if you don't specify a prompt resource in the <code>modelId</code> field.</p>
    pub fn prompt_variables(mut self, k: impl ::std::convert::Into<::std::string::String>, v: super::types::PromptVariableValues) -> Self {
    ...
    pub fn set_prompt_variables(
        mut self,
        input: ::std::option::Option<::std::collections::HashMap<::std::string::String, super::types::PromptVariableValues>>,
    ) -> Self {
    ...
    pub fn get_prompt_variables(
        &self,
    ) -> &::std::option::Option<::std::collections::HashMap<::std::string::String, super::types::PromptVariableValues>> {
    ...
    /// <p>Model performance settings for the request.</p>
    pub fn performance_config(mut self, input: super::types::PerformanceConfiguration) -> Self {
        self.performance_config = ::std::option::Option::Some(input);
        self
    }
    /// <p>Model performance settings for the request.</p>
    pub fn set_performance_config(mut self, input: ::std::option::Option<super::types::PerformanceConfiguration>) -> Self {
        self.performance_config = input;
        self
    }
    /// <p>Model performance settings for the request.</p>
    pub fn get_performance_config(&self) -> &::std::option::Option<super::types::PerformanceConfiguration> {
        &self.performance_config
    }
    /// <p>Specifies the processing tier configuration used for serving the request.</p>
    pub fn service_tier(mut self, input: super::types::ServiceTier) -> Self {
        self.service_tier = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies the processing tier configuration used for serving the request.</p>
    pub fn set_service_tier(mut self, input: ::std::option::Option<super::types::ServiceTier>) -> Self {
        self.service_tier = input;
        self
    }
    /// <p>Specifies the processing tier configuration used for serving the request.</p>
    pub fn get_service_tier(&self) -> &::std::option::Option<super::types::ServiceTier> {
        &self.service_tier
    }
    /// <p>Output configuration for a model response.</p>
    pub fn output_config(mut self, input: super::types::OutputConfig) -> Self {
        self.output_config = ::std::option::Option::Some(input);
        self
    }
    /// <p>Output configuration for a model response.</p>
    pub fn set_output_config(mut self, input: ::std::option::Option<super::types::OutputConfig>) -> Self {
        self.output_config = input;
        self
    }
    /// <p>Output configuration for a model response.</p>
    pub fn get_output_config(&self) -> &::std::option::Option<super::types::OutputConfig> {
        &self.output_config
    }
    /// Consumes the builder and constructs a [`ConverseStreamInput`](crate::operation::converse_stream::ConverseStreamInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::converse_stream::ConverseStreamInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::converse_stream::ConverseStreamInput {
