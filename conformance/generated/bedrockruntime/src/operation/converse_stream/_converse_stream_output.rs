...
pub struct ConverseStreamOutput {
    ...
    pub stream: super::event_receiver::EventReceiver<super::types::ConverseStreamOutput, super::types::error::ConverseStreamOutputError>,
...
impl ConverseStreamOutput {
    ...
    pub fn stream(
        &self,
    ) -> &super::event_receiver::EventReceiver<super::types::ConverseStreamOutput, super::types::error::ConverseStreamOutputError> {
        &self.stream
    }
}
...
impl ConverseStreamOutput {
    ...
    pub fn builder() -> super::operation::converse_stream::builders::ConverseStreamOutputBuilder {
        super::operation::converse_stream::builders::ConverseStreamOutputBuilder::default()
    }
}
...
impl ConverseStreamOutputBuilder {
    ...
    pub fn stream(
        mut self,
        input: super::event_receiver::EventReceiver<super::types::ConverseStreamOutput, super::types::error::ConverseStreamOutputError>,
    ) -> Self {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::converse_stream::ConverseStreamOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::converse_stream::ConverseStreamOutput {
