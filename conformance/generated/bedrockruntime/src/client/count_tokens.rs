...
impl super::Client {
    ...
    pub fn count_tokens(&self) -> super::operation::count_tokens::builders::CountTokensFluentBuilder {
        super::operation::count_tokens::builders::CountTokensFluentBuilder::new(self.handle.clone())
    }
}
