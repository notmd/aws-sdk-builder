...
impl super::Client {
    ...
    pub fn start_async_invoke(&self) -> super::operation::start_async_invoke::builders::StartAsyncInvokeFluentBuilder {
        super::operation::start_async_invoke::builders::StartAsyncInvokeFluentBuilder::new(self.handle.clone())
    }
}
