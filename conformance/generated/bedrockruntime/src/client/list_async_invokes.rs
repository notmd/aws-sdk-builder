...
impl super::Client {
    ...
    pub fn list_async_invokes(&self) -> super::operation::list_async_invokes::builders::ListAsyncInvokesFluentBuilder {
        super::operation::list_async_invokes::builders::ListAsyncInvokesFluentBuilder::new(self.handle.clone())
    }
}
