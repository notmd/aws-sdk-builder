...
impl super::Client {
    ...
    pub fn invoke_model_with_bidirectional_stream(
        &self,
    ) -> super::operation::invoke_model_with_bidirectional_stream::builders::InvokeModelWithBidirectionalStreamFluentBuilder {
        super::operation::invoke_model_with_bidirectional_stream::builders::InvokeModelWithBidirectionalStreamFluentBuilder::new(self.handle.clone())
    }
}
