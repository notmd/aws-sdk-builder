...
impl super::Client {
    ...
    pub fn apply_guardrail(&self) -> super::operation::apply_guardrail::builders::ApplyGuardrailFluentBuilder {
        super::operation::apply_guardrail::builders::ApplyGuardrailFluentBuilder::new(self.handle.clone())
    }
}
