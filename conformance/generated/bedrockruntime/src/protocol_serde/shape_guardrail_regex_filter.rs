...
pub(crate) fn de_guardrail_regex_filter<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::types::GuardrailRegexFilter>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::types::builders::GuardrailRegexFilterBuilder::default();
            loop {
                match tokens.next().transpose()? {
            ...
            Ok(Some(super::serde_util::guardrail_regex_filter_correct_errors(builder).build().map_err(
