...
pub fn ser_audio_source(
    ...
    match input {
        ...
        super::types::AudioSource::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("AudioSource")),
    }
    Ok(())
}
...
pub(crate) fn de_audio_source<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::types::AudioSource>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        ...
                        "s3Location" => Some(super::types::AudioSource::S3Location(
                            super::protocol_serde::shape_s3_location::de_s3_location(tokens, _value, depth + 1)?.ok_or_else(|| {
                                ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 's3Location' cannot be null")
                            })?,
                        )),
                        _ => {
                            ::aws_smithy_json::deserialize::token::skip_value(tokens)?;
                            Some(super::types::AudioSource::Unknown)
                        }
                    };
                }
                other => {
