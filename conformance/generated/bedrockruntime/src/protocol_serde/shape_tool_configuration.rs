...
pub fn ser_tool_configuration(
    ...
    input: &super::types::ToolConfiguration,
        ...
        for item_2 in &input.tools {
            {
                ...
                super::protocol_serde::shape_tool::ser_tool(&mut object_3, item_2)?;
                object_3.finish();
            }
        }
        array_1.finish();
    ...
    if let Some(var_4) = &input.tool_choice {
        ...
        super::protocol_serde::shape_tool_choice::ser_tool_choice(&mut object_5, var_4)?;
        object_5.finish();
    }
    Ok(())
}
