...
pub(crate) fn de_async_invoke_summary<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::types::AsyncInvokeSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::types::builders::AsyncInvokeSummaryBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "outputDataConfig" => {
                            builder = builder.set_output_data_config(
                                super::protocol_serde::shape_async_invoke_output_data_config::de_async_invoke_output_data_config(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
            ...
            Ok(Some(super::serde_util::async_invoke_summary_correct_errors(builder).build().map_err(
