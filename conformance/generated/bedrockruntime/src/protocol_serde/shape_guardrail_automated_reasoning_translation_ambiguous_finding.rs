...
pub(crate) fn de_guardrail_automated_reasoning_translation_ambiguous_finding<'a, I>(
    ...
    Option<super::types::GuardrailAutomatedReasoningTranslationAmbiguousFinding>,
    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::types::builders::GuardrailAutomatedReasoningTranslationAmbiguousFindingBuilder::default();
            loop {
                match tokens.next().transpose()? {
