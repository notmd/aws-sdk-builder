...
pub(crate) fn de_guardrail_converse_content_block<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::types::GuardrailConverseContentBlock>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            match tokens.next().transpose()? {
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "text" => Some(super::types::GuardrailConverseContentBlock::Text(
                            super::protocol_serde::shape_guardrail_converse_text_block::de_guardrail_converse_text_block(tokens, _value, depth + 1)?
                                .ok_or_else(|| ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'text' cannot be null"))?,
                        )),
                        "image" => Some(super::types::GuardrailConverseContentBlock::Image(
                            super::protocol_serde::shape_guardrail_converse_image_block::de_guardrail_converse_image_block(
                                tokens,
                                _value,
                                depth + 1,
                            )?
                        ...
                        _ => {
                            ::aws_smithy_json::deserialize::token::skip_value(tokens)?;
                            Some(super::types::GuardrailConverseContentBlock::Unknown)
                        }
                    };
                }
                other => {
