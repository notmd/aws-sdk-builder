...
pub(crate) fn de_async_invoke_output_data_config<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::types::AsyncInvokeOutputDataConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            match tokens.next().transpose()? {
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "s3OutputDataConfig" => Some(super::types::AsyncInvokeOutputDataConfig::S3OutputDataConfig(
                            super::protocol_serde::shape_async_invoke_s3_output_data_config::de_async_invoke_s3_output_data_config(
                                tokens,
                                _value,
                                depth + 1,
                            )?
                        ...
                        _ => {
                            ::aws_smithy_json::deserialize::token::skip_value(tokens)?;
                            Some(super::types::AsyncInvokeOutputDataConfig::Unknown)
                        }
                    };
                }
                other => {
