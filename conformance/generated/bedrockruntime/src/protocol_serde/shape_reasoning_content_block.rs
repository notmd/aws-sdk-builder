...
pub(crate) fn de_reasoning_content_block<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::types::ReasoningContentBlock>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            match tokens.next().transpose()? {
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "reasoningText" => Some(super::types::ReasoningContentBlock::ReasoningText(
                            super::protocol_serde::shape_reasoning_text_block::de_reasoning_text_block(tokens, _value, depth + 1)?.ok_or_else(
                        ...
                        _ => {
                            ::aws_smithy_json::deserialize::token::skip_value(tokens)?;
                            Some(super::types::ReasoningContentBlock::Unknown)
                        }
                    };
                }
                other => {
