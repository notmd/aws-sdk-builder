...
pub enum CountTokensInput {
    ...
    Converse(super::types::ConverseTokensRequest),
    ...
    InvokeModel(super::types::InvokeModelTokensRequest),
...
impl CountTokensInput {
    ...
    pub fn as_converse(&self) -> ::std::result::Result<&super::types::ConverseTokensRequest, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_invoke_model(&self) -> ::std::result::Result<&super::types::InvokeModelTokensRequest, &Self> {
