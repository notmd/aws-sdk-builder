...
pub struct Citation {
    ...
    pub source_content: ::std::option::Option<::std::vec::Vec<super::types::CitationSourceContent>>,
...
impl Citation {
    ...
    pub fn source_content(&self) -> &[super::types::CitationSourceContent] {
...
impl Citation {
    ...
    pub fn builder() -> super::types::builders::CitationBuilder {
        super::types::builders::CitationBuilder::default()
    }
}
...
pub struct CitationBuilder {
    ...
    pub(crate) source_content: ::std::option::Option<::std::vec::Vec<super::types::CitationSourceContent>>,
...
impl CitationBuilder {
    ...
    ///
    /// <p>The specific content from the source document that was referenced or cited in the generated response.</p>
    pub fn source_content(mut self, input: super::types::CitationSourceContent) -> Self {
    ...
    /// <p>The specific content from the source document that was referenced or cited in the generated response.</p>
    pub fn set_source_content(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::CitationSourceContent>>) -> Self {
        self.source_content = input;
        self
    }
    /// <p>The specific content from the source document that was referenced or cited in the generated response.</p>
    pub fn get_source_content(&self) -> &::std::option::Option<::std::vec::Vec<super::types::CitationSourceContent>> {
        &self.source_content
    }
    /// <p>The precise location within the source document where the cited content can be found, including character positions, page numbers, or chunk identifiers.</p>
    ...
    pub fn build(self) -> super::types::Citation {
        super::types::Citation {
            title: self.title,
            source: self.source,
