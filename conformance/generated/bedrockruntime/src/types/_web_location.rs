...
impl WebLocation {
    ...
    pub fn builder() -> super::types::builders::WebLocationBuilder {
        super::types::builders::WebLocationBuilder::default()
    }
}
...
impl WebLocationBuilder {
    ...
    pub fn build(self) -> super::types::WebLocation {
        super::types::WebLocation {
            url: self.url,
            domain: self.domain,
        }
    }
