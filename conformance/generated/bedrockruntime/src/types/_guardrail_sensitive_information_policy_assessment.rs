...
pub struct GuardrailSensitiveInformationPolicyAssessment {
    ...
    pub pii_entities: ::std::vec::Vec<super::types::GuardrailPiiEntityFilter>,
    /// <p>The regex queries in the assessment.</p>
    pub regexes: ::std::vec::Vec<super::types::GuardrailRegexFilter>,
}
impl GuardrailSensitiveInformationPolicyAssessment {
    /// <p>The PII entities in the assessment.</p>
    pub fn pii_entities(&self) -> &[super::types::GuardrailPiiEntityFilter] {
        use std::ops::Deref;
        self.pii_entities.deref()
    }
    /// <p>The regex queries in the assessment.</p>
    pub fn regexes(&self) -> &[super::types::GuardrailRegexFilter] {
        use std::ops::Deref;
        self.regexes.deref()
    }
}
impl GuardrailSensitiveInformationPolicyAssessment {
    ...
    pub fn builder() -> super::types::builders::GuardrailSensitiveInformationPolicyAssessmentBuilder {
        super::types::builders::GuardrailSensitiveInformationPolicyAssessmentBuilder::default()
    }
}
...
pub struct GuardrailSensitiveInformationPolicyAssessmentBuilder {
    pub(crate) pii_entities: ::std::option::Option<::std::vec::Vec<super::types::GuardrailPiiEntityFilter>>,
    pub(crate) regexes: ::std::option::Option<::std::vec::Vec<super::types::GuardrailRegexFilter>>,
}
impl GuardrailSensitiveInformationPolicyAssessmentBuilder {
    ...
    ///
    /// <p>The PII entities in the assessment.</p>
    pub fn pii_entities(mut self, input: super::types::GuardrailPiiEntityFilter) -> Self {
    ...
    /// <p>The PII entities in the assessment.</p>
    pub fn set_pii_entities(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::GuardrailPiiEntityFilter>>) -> Self {
        self.pii_entities = input;
        self
    }
    /// <p>The PII entities in the assessment.</p>
    pub fn get_pii_entities(&self) -> &::std::option::Option<::std::vec::Vec<super::types::GuardrailPiiEntityFilter>> {
        &self.pii_entities
    }
    ...
    ///
    /// <p>The regex queries in the assessment.</p>
    pub fn regexes(mut self, input: super::types::GuardrailRegexFilter) -> Self {
    ...
    /// <p>The regex queries in the assessment.</p>
    pub fn set_regexes(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::GuardrailRegexFilter>>) -> Self {
        self.regexes = input;
        self
    }
    /// <p>The regex queries in the assessment.</p>
    pub fn get_regexes(&self) -> &::std::option::Option<::std::vec::Vec<super::types::GuardrailRegexFilter>> {
        &self.regexes
    }
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::types::GuardrailSensitiveInformationPolicyAssessment, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::GuardrailSensitiveInformationPolicyAssessment {
