...
impl ToolUseBlock {
    ...
    pub fn builder() -> super::types::builders::ToolUseBlockBuilder {
        super::types::builders::ToolUseBlockBuilder::default()
    }
}
...
impl ToolUseBlockBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::ToolUseBlock, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ToolUseBlock {
