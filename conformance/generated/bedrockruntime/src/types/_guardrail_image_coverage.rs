...
impl GuardrailImageCoverage {
    ...
    pub fn builder() -> super::types::builders::GuardrailImageCoverageBuilder {
        super::types::builders::GuardrailImageCoverageBuilder::default()
    }
}
...
impl GuardrailImageCoverageBuilder {
    ...
    pub fn build(self) -> super::types::GuardrailImageCoverage {
        super::types::GuardrailImageCoverage {
