...
impl ContentBlockStartEvent {
    ...
    pub fn builder() -> super::types::builders::ContentBlockStartEventBuilder {
        super::types::builders::ContentBlockStartEventBuilder::default()
    }
}
...
pub struct ContentBlockStartEventBuilder {
    pub(crate) start: ::std::option::Option<super::types::ContentBlockStart>,
    pub(crate) content_block_index: ::std::option::Option<i32>,
}
impl ContentBlockStartEventBuilder {
    /// <p>Start information about a content block start event.</p>
    /// This field is required.
    pub fn start(mut self, input: super::types::ContentBlockStart) -> Self {
        self.start = ::std::option::Option::Some(input);
        self
    }
    /// <p>Start information about a content block start event.</p>
    pub fn set_start(mut self, input: ::std::option::Option<super::types::ContentBlockStart>) -> Self {
        self.start = input;
        self
    }
    /// <p>Start information about a content block start event.</p>
    pub fn get_start(&self) -> &::std::option::Option<super::types::ContentBlockStart> {
        &self.start
    }
    /// <p>The index for a content block start event.</p>
    /// This field is required.
