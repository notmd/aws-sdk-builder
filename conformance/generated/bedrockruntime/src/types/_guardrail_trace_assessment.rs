...
pub struct GuardrailTraceAssessment {
    ...
    pub input_assessment: ::std::option::Option<::std::collections::HashMap<::std::string::String, super::types::GuardrailAssessment>>,
    /// <p>the output assessments.</p>
    pub output_assessments:
        ::std::option::Option<::std::collections::HashMap<::std::string::String, ::std::vec::Vec<super::types::GuardrailAssessment>>>,
...
impl GuardrailTraceAssessment {
    ...
    /// <p>The input assessment.</p>
    pub fn input_assessment(&self) -> ::std::option::Option<&::std::collections::HashMap<::std::string::String, super::types::GuardrailAssessment>> {
...
impl GuardrailTraceAssessment {
    ...
    pub fn builder() -> super::types::builders::GuardrailTraceAssessmentBuilder {
        super::types::builders::GuardrailTraceAssessmentBuilder::default()
    }
}
...
pub struct GuardrailTraceAssessmentBuilder {
    ...
    pub(crate) input_assessment: ::std::option::Option<::std::collections::HashMap<::std::string::String, super::types::GuardrailAssessment>>,
...
impl GuardrailTraceAssessmentBuilder {
    ...
    ///
    /// <p>The input assessment.</p>
    pub fn input_assessment(mut self, k: impl ::std::convert::Into<::std::string::String>, v: super::types::GuardrailAssessment) -> Self {
    ...
    pub fn set_input_assessment(
        mut self,
        input: ::std::option::Option<::std::collections::HashMap<::std::string::String, super::types::GuardrailAssessment>>,
    ) -> Self {
    ...
    pub fn get_input_assessment(
        &self,
    ) -> &::std::option::Option<::std::collections::HashMap<::std::string::String, super::types::GuardrailAssessment>> {
    ...
    pub fn output_assessments(
        ...
        v: ::std::vec::Vec<super::types::GuardrailAssessment>,
    ) -> Self {
    ...
    pub fn set_output_assessments(
        mut self,
        input: ::std::option::Option<::std::collections::HashMap<::std::string::String, ::std::vec::Vec<super::types::GuardrailAssessment>>>,
    ) -> Self {
    ...
    pub fn build(self) -> super::types::GuardrailTraceAssessment {
        super::types::GuardrailTraceAssessment {
