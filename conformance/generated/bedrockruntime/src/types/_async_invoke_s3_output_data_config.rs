...
impl AsyncInvokeS3OutputDataConfig {
    ...
    pub fn builder() -> super::types::builders::AsyncInvokeS3OutputDataConfigBuilder {
        super::types::builders::AsyncInvokeS3OutputDataConfigBuilder::default()
    }
}
...
impl AsyncInvokeS3OutputDataConfigBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::AsyncInvokeS3OutputDataConfig, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::AsyncInvokeS3OutputDataConfig {
