...
impl GuardrailInvocationMetrics {
    ...
    pub fn builder() -> super::types::builders::GuardrailInvocationMetricsBuilder {
        super::types::builders::GuardrailInvocationMetricsBuilder::default()
    }
}
...
impl GuardrailInvocationMetricsBuilder {
    ...
    pub fn build(self) -> super::types::GuardrailInvocationMetrics {
        super::types::GuardrailInvocationMetrics {
