...
impl DocumentChunkLocation {
    ...
    pub fn builder() -> super::types::builders::DocumentChunkLocationBuilder {
        super::types::builders::DocumentChunkLocationBuilder::default()
    }
}
...
impl DocumentChunkLocationBuilder {
    ...
    pub fn build(self) -> super::types::DocumentChunkLocation {
        super::types::DocumentChunkLocation {
