...
pub struct GuardrailAutomatedReasoningScenario {
    ...
    pub statements: ::std::option::Option<::std::vec::Vec<super::types::GuardrailAutomatedReasoningStatement>>,
}
impl GuardrailAutomatedReasoningScenario {
    ...
    pub fn statements(&self) -> &[super::types::GuardrailAutomatedReasoningStatement] {
...
impl GuardrailAutomatedReasoningScenario {
    ...
    pub fn builder() -> super::types::builders::GuardrailAutomatedReasoningScenarioBuilder {
        super::types::builders::GuardrailAutomatedReasoningScenarioBuilder::default()
    }
}
...
pub struct GuardrailAutomatedReasoningScenarioBuilder {
    pub(crate) statements: ::std::option::Option<::std::vec::Vec<super::types::GuardrailAutomatedReasoningStatement>>,
}
impl GuardrailAutomatedReasoningScenarioBuilder {
    ...
    ///
    /// <p>List of logical assignments and statements that define this scenario.</p>
    pub fn statements(mut self, input: super::types::GuardrailAutomatedReasoningStatement) -> Self {
    ...
    /// <p>List of logical assignments and statements that define this scenario.</p>
    pub fn set_statements(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::GuardrailAutomatedReasoningStatement>>) -> Self {
        self.statements = input;
        self
    }
    /// <p>List of logical assignments and statements that define this scenario.</p>
    pub fn get_statements(&self) -> &::std::option::Option<::std::vec::Vec<super::types::GuardrailAutomatedReasoningStatement>> {
        &self.statements
    }
    ...
    pub fn build(self) -> super::types::GuardrailAutomatedReasoningScenario {
        super::types::GuardrailAutomatedReasoningScenario { statements: self.statements }
    }
}
