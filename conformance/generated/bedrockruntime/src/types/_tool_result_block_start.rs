...
impl ToolResultBlockStart {
    ...
    pub fn builder() -> super::types::builders::ToolResultBlockStartBuilder {
        super::types::builders::ToolResultBlockStartBuilder::default()
    }
}
...
impl ToolResultBlockStartBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::ToolResultBlockStart, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ToolResultBlockStart {
