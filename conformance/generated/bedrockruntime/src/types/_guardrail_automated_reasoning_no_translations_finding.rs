...
impl GuardrailAutomatedReasoningNoTranslationsFinding {
    ...
    pub fn builder() -> super::types::builders::GuardrailAutomatedReasoningNoTranslationsFindingBuilder {
        super::types::builders::GuardrailAutomatedReasoningNoTranslationsFindingBuilder::default()
    }
}
...
impl GuardrailAutomatedReasoningNoTranslationsFindingBuilder {
    ...
    pub fn build(self) -> super::types::GuardrailAutomatedReasoningNoTranslationsFinding {
        super::types::GuardrailAutomatedReasoningNoTranslationsFinding {}
    }
}
