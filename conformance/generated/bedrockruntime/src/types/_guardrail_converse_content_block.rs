...
pub enum GuardrailConverseContentBlock {
    ...
    Text(super::types::GuardrailConverseTextBlock),
...
impl GuardrailConverseContentBlock {
    ...
    pub fn as_image(&self) -> ::std::result::Result<&super::types::GuardrailConverseImageBlock, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_text(&self) -> ::std::result::Result<&super::types::GuardrailConverseTextBlock, &Self> {
