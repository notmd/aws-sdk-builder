...
impl InvokeModelTokensRequest {
    ...
    pub fn builder() -> super::types::builders::InvokeModelTokensRequestBuilder {
        super::types::builders::InvokeModelTokensRequestBuilder::default()
    }
}
...
impl InvokeModelTokensRequestBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::InvokeModelTokensRequest, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::InvokeModelTokensRequest {
