...
impl ConverseStreamMetrics {
    ...
    pub fn builder() -> super::types::builders::ConverseStreamMetricsBuilder {
        super::types::builders::ConverseStreamMetricsBuilder::default()
    }
}
...
impl ConverseStreamMetricsBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::ConverseStreamMetrics, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ConverseStreamMetrics {
