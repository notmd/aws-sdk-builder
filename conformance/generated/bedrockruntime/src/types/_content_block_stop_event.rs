...
impl ContentBlockStopEvent {
    ...
    pub fn builder() -> super::types::builders::ContentBlockStopEventBuilder {
        super::types::builders::ContentBlockStopEventBuilder::default()
    }
}
...
impl ContentBlockStopEventBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::ContentBlockStopEvent, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ContentBlockStopEvent {
