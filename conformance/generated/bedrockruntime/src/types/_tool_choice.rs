...
impl ToolChoice {
    ...
    pub fn as_any(&self) -> ::std::result::Result<&super::types::AnyToolChoice, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_auto(&self) -> ::std::result::Result<&super::types::AutoToolChoice, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_tool(&self) -> ::std::result::Result<&super::types::SpecificToolChoice, &Self> {
