...
pub struct GuardrailWordPolicyAssessment {
    ...
    pub custom_words: ::std::vec::Vec<super::types::GuardrailCustomWord>,
    /// <p>Managed word lists in the assessment.</p>
    pub managed_word_lists: ::std::vec::Vec<super::types::GuardrailManagedWord>,
}
impl GuardrailWordPolicyAssessment {
    /// <p>Custom words in the assessment.</p>
    pub fn custom_words(&self) -> &[super::types::GuardrailCustomWord] {
        use std::ops::Deref;
        self.custom_words.deref()
    }
    /// <p>Managed word lists in the assessment.</p>
    pub fn managed_word_lists(&self) -> &[super::types::GuardrailManagedWord] {
        use std::ops::Deref;
...
impl GuardrailWordPolicyAssessment {
    ...
    pub fn builder() -> super::types::builders::GuardrailWordPolicyAssessmentBuilder {
        super::types::builders::GuardrailWordPolicyAssessmentBuilder::default()
    }
}
...
pub struct GuardrailWordPolicyAssessmentBuilder {
    pub(crate) custom_words: ::std::option::Option<::std::vec::Vec<super::types::GuardrailCustomWord>>,
    pub(crate) managed_word_lists: ::std::option::Option<::std::vec::Vec<super::types::GuardrailManagedWord>>,
}
impl GuardrailWordPolicyAssessmentBuilder {
    ...
    ///
    /// <p>Custom words in the assessment.</p>
    pub fn custom_words(mut self, input: super::types::GuardrailCustomWord) -> Self {
    ...
    /// <p>Custom words in the assessment.</p>
    pub fn set_custom_words(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::GuardrailCustomWord>>) -> Self {
        self.custom_words = input;
        self
    }
    /// <p>Custom words in the assessment.</p>
    pub fn get_custom_words(&self) -> &::std::option::Option<::std::vec::Vec<super::types::GuardrailCustomWord>> {
        &self.custom_words
    }
    ...
    ///
    /// <p>Managed word lists in the assessment.</p>
    pub fn managed_word_lists(mut self, input: super::types::GuardrailManagedWord) -> Self {
    ...
    /// <p>Managed word lists in the assessment.</p>
    pub fn set_managed_word_lists(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::GuardrailManagedWord>>) -> Self {
        self.managed_word_lists = input;
        self
    }
    /// <p>Managed word lists in the assessment.</p>
    pub fn get_managed_word_lists(&self) -> &::std::option::Option<::std::vec::Vec<super::types::GuardrailManagedWord>> {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::GuardrailWordPolicyAssessment, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::GuardrailWordPolicyAssessment {
