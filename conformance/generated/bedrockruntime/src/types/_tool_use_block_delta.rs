...
impl ToolUseBlockDelta {
    ...
    pub fn builder() -> super::types::builders::ToolUseBlockDeltaBuilder {
        super::types::builders::ToolUseBlockDeltaBuilder::default()
    }
}
...
impl ToolUseBlockDeltaBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::ToolUseBlockDelta, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ToolUseBlockDelta {
