...
impl DocumentCharLocation {
    ...
    pub fn builder() -> super::types::builders::DocumentCharLocationBuilder {
        super::types::builders::DocumentCharLocationBuilder::default()
    }
}
...
impl DocumentCharLocationBuilder {
    ...
    pub fn build(self) -> super::types::DocumentCharLocation {
        super::types::DocumentCharLocation {
