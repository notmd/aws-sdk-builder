...
impl GuardrailAutomatedReasoningRule {
    ...
    pub fn builder() -> super::types::builders::GuardrailAutomatedReasoningRuleBuilder {
        super::types::builders::GuardrailAutomatedReasoningRuleBuilder::default()
    }
}
...
impl GuardrailAutomatedReasoningRuleBuilder {
    ...
    pub fn build(self) -> super::types::GuardrailAutomatedReasoningRule {
        super::types::GuardrailAutomatedReasoningRule {
