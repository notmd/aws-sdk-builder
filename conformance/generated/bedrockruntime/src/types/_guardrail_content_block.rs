...
pub enum GuardrailContentBlock {
    ...
    Text(super::types::GuardrailTextBlock),
...
impl GuardrailContentBlock {
    ...
    pub fn as_image(&self) -> ::std::result::Result<&super::types::GuardrailImageBlock, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_text(&self) -> ::std::result::Result<&super::types::GuardrailTextBlock, &Self> {
