...
impl BidirectionalOutputPayloadPart {
    ...
    pub fn builder() -> super::types::builders::BidirectionalOutputPayloadPartBuilder {
        super::types::builders::BidirectionalOutputPayloadPartBuilder::default()
    }
}
...
impl BidirectionalOutputPayloadPartBuilder {
    ...
    pub fn build(self) -> super::types::BidirectionalOutputPayloadPart {
        super::types::BidirectionalOutputPayloadPart { bytes: self.bytes }
    }
}
