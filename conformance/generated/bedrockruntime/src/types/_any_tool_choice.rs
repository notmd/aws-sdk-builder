...
impl AnyToolChoice {
    ...
    pub fn builder() -> super::types::builders::AnyToolChoiceBuilder {
        super::types::builders::AnyToolChoiceBuilder::default()
    }
}
...
impl AnyToolChoiceBuilder {
    ...
    pub fn build(self) -> super::types::AnyToolChoice {
        super::types::AnyToolChoice {}
    }
}
