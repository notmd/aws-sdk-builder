...
pub struct ToolConfiguration {
    ...
    pub tools: ::std::vec::Vec<super::types::Tool>,
    /// <p>If supported by model, forces the model to request a tool.</p>
    pub tool_choice: ::std::option::Option<super::types::ToolChoice>,
}
impl ToolConfiguration {
    /// <p>An array of tools that you want to pass to a model.</p>
    pub fn tools(&self) -> &[super::types::Tool] {
        use std::ops::Deref;
        self.tools.deref()
    }
    /// <p>If supported by model, forces the model to request a tool.</p>
    pub fn tool_choice(&self) -> ::std::option::Option<&super::types::ToolChoice> {
        self.tool_choice.as_ref()
    }
}
impl ToolConfiguration {
    /// Creates a new builder-style object to manufacture [`ToolConfiguration`](crate::types::ToolConfiguration).
    pub fn builder() -> super::types::builders::ToolConfigurationBuilder {
        super::types::builders::ToolConfigurationBuilder::default()
    }
}
...
pub struct ToolConfigurationBuilder {
    pub(crate) tools: ::std::option::Option<::std::vec::Vec<super::types::Tool>>,
    pub(crate) tool_choice: ::std::option::Option<super::types::ToolChoice>,
}
impl ToolConfigurationBuilder {
    ...
    ///
    /// <p>An array of tools that you want to pass to a model.</p>
    pub fn tools(mut self, input: super::types::Tool) -> Self {
    ...
    /// <p>An array of tools that you want to pass to a model.</p>
    pub fn set_tools(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::Tool>>) -> Self {
        self.tools = input;
        self
    }
    /// <p>An array of tools that you want to pass to a model.</p>
    pub fn get_tools(&self) -> &::std::option::Option<::std::vec::Vec<super::types::Tool>> {
        &self.tools
    }
    /// <p>If supported by model, forces the model to request a tool.</p>
    pub fn tool_choice(mut self, input: super::types::ToolChoice) -> Self {
        self.tool_choice = ::std::option::Option::Some(input);
        self
    }
    /// <p>If supported by model, forces the model to request a tool.</p>
    pub fn set_tool_choice(mut self, input: ::std::option::Option<super::types::ToolChoice>) -> Self {
        self.tool_choice = input;
        self
    }
    /// <p>If supported by model, forces the model to request a tool.</p>
    pub fn get_tool_choice(&self) -> &::std::option::Option<super::types::ToolChoice> {
        &self.tool_choice
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::types::ToolConfiguration, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ToolConfiguration {
