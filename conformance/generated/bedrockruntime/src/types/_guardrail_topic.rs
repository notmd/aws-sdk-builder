...
pub struct GuardrailTopic {
    ...
    pub r#type: super::types::GuardrailTopicType,
    /// <p>The action the guardrail should take when it intervenes on a topic.</p>
    pub action: super::types::GuardrailTopicPolicyAction,
...
impl GuardrailTopic {
    ...
    /// <p>The type behavior that the guardrail should perform when the model detects the topic.</p>
    pub fn r#type(&self) -> &super::types::GuardrailTopicType {
        &self.r#type
    }
    /// <p>The action the guardrail should take when it intervenes on a topic.</p>
    pub fn action(&self) -> &super::types::GuardrailTopicPolicyAction {
        &self.action
    }
    /// <p>Indicates whether topic content that breaches the guardrail configuration is detected.</p>
...
impl GuardrailTopic {
    ...
    pub fn builder() -> super::types::builders::GuardrailTopicBuilder {
        super::types::builders::GuardrailTopicBuilder::default()
    }
}
...
pub struct GuardrailTopicBuilder {
    ...
    pub(crate) r#type: ::std::option::Option<super::types::GuardrailTopicType>,
    pub(crate) action: ::std::option::Option<super::types::GuardrailTopicPolicyAction>,
...
impl GuardrailTopicBuilder {
    ...
    /// <p>The type behavior that the guardrail should perform when the model detects the topic.</p>
    /// This field is required.
    pub fn r#type(mut self, input: super::types::GuardrailTopicType) -> Self {
        self.r#type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The type behavior that the guardrail should perform when the model detects the topic.</p>
    pub fn set_type(mut self, input: ::std::option::Option<super::types::GuardrailTopicType>) -> Self {
        self.r#type = input;
        self
    }
    /// <p>The type behavior that the guardrail should perform when the model detects the topic.</p>
    pub fn get_type(&self) -> &::std::option::Option<super::types::GuardrailTopicType> {
        &self.r#type
    }
    /// <p>The action the guardrail should take when it intervenes on a topic.</p>
    /// This field is required.
    pub fn action(mut self, input: super::types::GuardrailTopicPolicyAction) -> Self {
        self.action = ::std::option::Option::Some(input);
        self
    }
    /// <p>The action the guardrail should take when it intervenes on a topic.</p>
    pub fn set_action(mut self, input: ::std::option::Option<super::types::GuardrailTopicPolicyAction>) -> Self {
        self.action = input;
        self
    }
    /// <p>The action the guardrail should take when it intervenes on a topic.</p>
    pub fn get_action(&self) -> &::std::option::Option<super::types::GuardrailTopicPolicyAction> {
        &self.action
    }
    /// <p>Indicates whether topic content that breaches the guardrail configuration is detected.</p>
    ...
    pub fn build(self) -> ::std::result::Result<super::types::GuardrailTopic, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::GuardrailTopic {
