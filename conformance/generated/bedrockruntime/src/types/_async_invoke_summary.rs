...
pub struct AsyncInvokeSummary {
    ...
    pub status: ::std::option::Option<super::types::AsyncInvokeStatus>,
...
impl AsyncInvokeSummary {
    ...
    /// <p>The invocation's status.</p>
    pub fn status(&self) -> ::std::option::Option<&super::types::AsyncInvokeStatus> {
        self.status.as_ref()
    }
    /// <p>An error message.</p>
...
impl AsyncInvokeSummary {
    ...
    pub fn builder() -> super::types::builders::AsyncInvokeSummaryBuilder {
        super::types::builders::AsyncInvokeSummaryBuilder::default()
    }
}
