...
impl PromptRouterTrace {
    ...
    pub fn builder() -> super::types::builders::PromptRouterTraceBuilder {
        super::types::builders::PromptRouterTraceBuilder::default()
    }
}
...
impl PromptRouterTraceBuilder {
    ...
    pub fn build(self) -> super::types::PromptRouterTrace {
        super::types::PromptRouterTrace {
