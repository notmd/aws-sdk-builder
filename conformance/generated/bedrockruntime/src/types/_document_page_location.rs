...
impl DocumentPageLocation {
    ...
    pub fn builder() -> super::types::builders::DocumentPageLocationBuilder {
        super::types::builders::DocumentPageLocationBuilder::default()
    }
}
...
impl DocumentPageLocationBuilder {
    ...
    pub fn build(self) -> super::types::DocumentPageLocation {
        super::types::DocumentPageLocation {
