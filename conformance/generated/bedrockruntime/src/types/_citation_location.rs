...
pub enum CitationLocation {
    ...
    DocumentChar(super::types::DocumentCharLocation),
    ...
    DocumentChunk(super::types::DocumentChunkLocation),
    /// <p>The page-level location within the document where the cited content is found.</p>
    DocumentPage(super::types::DocumentPageLocation),
    ...
    SearchResultLocation(super::types::SearchResultLocation),
    /// <p>The web URL that was cited for this reference.</p>
    Web(super::types::WebLocation),
...
impl CitationLocation {
    ...
    pub fn as_document_char(&self) -> ::std::result::Result<&super::types::DocumentCharLocation, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_document_chunk(&self) -> ::std::result::Result<&super::types::DocumentChunkLocation, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_document_page(&self) -> ::std::result::Result<&super::types::DocumentPageLocation, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_search_result_location(&self) -> ::std::result::Result<&super::types::SearchResultLocation, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_web(&self) -> ::std::result::Result<&super::types::WebLocation, &Self> {
