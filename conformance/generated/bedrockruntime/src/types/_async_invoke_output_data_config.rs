...
pub enum AsyncInvokeOutputDataConfig {
    ...
    S3OutputDataConfig(super::types::AsyncInvokeS3OutputDataConfig),
...
impl AsyncInvokeOutputDataConfig {
    ...
    pub fn as_s3_output_data_config(&self) -> ::std::result::Result<&super::types::AsyncInvokeS3OutputDataConfig, &Self> {
