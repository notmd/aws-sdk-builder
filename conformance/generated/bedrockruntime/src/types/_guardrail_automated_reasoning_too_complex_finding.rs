...
impl GuardrailAutomatedReasoningTooComplexFinding {
    ...
    pub fn builder() -> super::types::builders::GuardrailAutomatedReasoningTooComplexFindingBuilder {
        super::types::builders::GuardrailAutomatedReasoningTooComplexFindingBuilder::default()
    }
}
...
impl GuardrailAutomatedReasoningTooComplexFindingBuilder {
    ...
    pub fn build(self) -> super::types::GuardrailAutomatedReasoningTooComplexFinding {
        super::types::GuardrailAutomatedReasoningTooComplexFinding {}
    }
}
