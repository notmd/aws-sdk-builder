...
impl SpecificToolChoice {
    ...
    pub fn builder() -> super::types::builders::SpecificToolChoiceBuilder {
        super::types::builders::SpecificToolChoiceBuilder::default()
    }
}
...
impl SpecificToolChoiceBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::SpecificToolChoice, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::SpecificToolChoice {
