...
pub enum ContentBlock {
    ...
    CachePoint(super::types::CachePointBlock),
    ...
    CitationsContent(super::types::CitationsContentBlock),
    /// <p>A document to include in the message.</p>
    Document(super::types::DocumentBlock),
    ...
    GuardContent(super::types::GuardrailConverseContentBlock),
    ...
    ReasoningContent(super::types::ReasoningContentBlock),
    ...
    ToolAddition(super::types::ToolAdditionBlock),
...
impl ContentBlock {
    ...
    pub fn as_audio(&self) -> ::std::result::Result<&super::types::AudioBlock, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_cache_point(&self) -> ::std::result::Result<&super::types::CachePointBlock, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_citations_content(&self) -> ::std::result::Result<&super::types::CitationsContentBlock, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_document(&self) -> ::std::result::Result<&super::types::DocumentBlock, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_guard_content(&self) -> ::std::result::Result<&super::types::GuardrailConverseContentBlock, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_image(&self) -> ::std::result::Result<&super::types::ImageBlock, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_reasoning_content(&self) -> ::std::result::Result<&super::types::ReasoningContentBlock, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_search_result(&self) -> ::std::result::Result<&super::types::SearchResultBlock, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_tool_addition(&self) -> ::std::result::Result<&super::types::ToolAdditionBlock, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_tool_removal(&self) -> ::std::result::Result<&super::types::ToolRemovalBlock, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_tool_result(&self) -> ::std::result::Result<&super::types::ToolResultBlock, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_tool_use(&self) -> ::std::result::Result<&super::types::ToolUseBlock, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_video(&self) -> ::std::result::Result<&super::types::VideoBlock, &Self> {
