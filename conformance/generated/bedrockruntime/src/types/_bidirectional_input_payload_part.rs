...
impl BidirectionalInputPayloadPart {
    ...
    pub fn builder() -> super::types::builders::BidirectionalInputPayloadPartBuilder {
        super::types::builders::BidirectionalInputPayloadPartBuilder::default()
    }
}
...
impl BidirectionalInputPayloadPartBuilder {
    ...
    pub fn build(self) -> super::types::BidirectionalInputPayloadPart {
        super::types::BidirectionalInputPayloadPart { bytes: self.bytes }
    }
}
