...
impl GuardrailConfiguration {
    ...
    pub fn builder() -> super::types::builders::GuardrailConfigurationBuilder {
        super::types::builders::GuardrailConfigurationBuilder::default()
    }
}
...
impl GuardrailConfigurationBuilder {
    ...
    pub fn build(self) -> super::types::GuardrailConfiguration {
