...
impl ContentBlockDeltaEvent {
    ...
    pub fn builder() -> super::types::builders::ContentBlockDeltaEventBuilder {
        super::types::builders::ContentBlockDeltaEventBuilder::default()
    }
}
...
pub struct ContentBlockDeltaEventBuilder {
    pub(crate) delta: ::std::option::Option<super::types::ContentBlockDelta>,
    pub(crate) content_block_index: ::std::option::Option<i32>,
}
impl ContentBlockDeltaEventBuilder {
    /// <p>The delta for a content block delta event.</p>
    /// This field is required.
    pub fn delta(mut self, input: super::types::ContentBlockDelta) -> Self {
        self.delta = ::std::option::Option::Some(input);
        self
    }
    /// <p>The delta for a content block delta event.</p>
    pub fn set_delta(mut self, input: ::std::option::Option<super::types::ContentBlockDelta>) -> Self {
        self.delta = input;
        self
    }
    /// <p>The delta for a content block delta event.</p>
    pub fn get_delta(&self) -> &::std::option::Option<super::types::ContentBlockDelta> {
        &self.delta
    }
    /// <p>The block index for a content block delta event.</p>
    /// This field is required.
