...
impl ReasoningTextBlock {
    ...
    pub fn builder() -> super::types::builders::ReasoningTextBlockBuilder {
        super::types::builders::ReasoningTextBlockBuilder::default()
    }
}
...
impl ReasoningTextBlockBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::ReasoningTextBlock, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ReasoningTextBlock {
