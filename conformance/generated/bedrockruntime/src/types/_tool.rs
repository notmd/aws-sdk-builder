...
pub enum Tool {
    ...
    SystemTool(super::types::SystemTool),
    /// <p>The specfication for the tool.</p>
    ToolSpec(super::types::ToolSpecification),
...
impl Tool {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_system_tool(&self) -> ::std::result::Result<&super::types::SystemTool, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_tool_spec(&self) -> ::std::result::Result<&super::types::ToolSpecification, &Self> {
