...
impl SystemTool {
    ...
    pub fn builder() -> super::types::builders::SystemToolBuilder {
        super::types::builders::SystemToolBuilder::default()
    }
}
...
impl SystemToolBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::SystemTool, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::SystemTool {
