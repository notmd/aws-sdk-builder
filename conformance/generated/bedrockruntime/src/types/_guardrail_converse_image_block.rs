...
impl GuardrailConverseImageBlock {
    /// <p>The format details for the image type of the guardrail converse image block.</p>
    pub fn format(&self) -> &super::types::GuardrailConverseImageFormat {
        &self.format
    }
    /// <p>The image source (image bytes) of the guardrail converse image block.</p>
...
impl GuardrailConverseImageBlock {
    ...
    pub fn builder() -> super::types::builders::GuardrailConverseImageBlockBuilder {
        super::types::builders::GuardrailConverseImageBlockBuilder::default()
    }
}
...
pub struct GuardrailConverseImageBlockBuilder {
    pub(crate) format: ::std::option::Option<super::types::GuardrailConverseImageFormat>,
    pub(crate) source: ::std::option::Option<super::types::GuardrailConverseImageSource>,
}
impl GuardrailConverseImageBlockBuilder {
    /// <p>The format details for the image type of the guardrail converse image block.</p>
    /// This field is required.
    pub fn format(mut self, input: super::types::GuardrailConverseImageFormat) -> Self {
        self.format = ::std::option::Option::Some(input);
        self
    }
    /// <p>The format details for the image type of the guardrail converse image block.</p>
    pub fn set_format(mut self, input: ::std::option::Option<super::types::GuardrailConverseImageFormat>) -> Self {
        self.format = input;
        self
    }
    /// <p>The format details for the image type of the guardrail converse image block.</p>
    pub fn get_format(&self) -> &::std::option::Option<super::types::GuardrailConverseImageFormat> {
        &self.format
    }
    /// <p>The image source (image bytes) of the guardrail converse image block.</p>
    /// This field is required.
    pub fn source(mut self, input: super::types::GuardrailConverseImageSource) -> Self {
        self.source = ::std::option::Option::Some(input);
        self
    }
    /// <p>The image source (image bytes) of the guardrail converse image block.</p>
    pub fn set_source(mut self, input: ::std::option::Option<super::types::GuardrailConverseImageSource>) -> Self {
        self.source = input;
        self
    }
    /// <p>The image source (image bytes) of the guardrail converse image block.</p>
    pub fn get_source(&self) -> &::std::option::Option<super::types::GuardrailConverseImageSource> {
        &self.source
    }
