...
impl GuardrailTextCharactersCoverage {
    ...
    pub fn builder() -> super::types::builders::GuardrailTextCharactersCoverageBuilder {
        super::types::builders::GuardrailTextCharactersCoverageBuilder::default()
    }
}
...
impl GuardrailTextCharactersCoverageBuilder {
    ...
    pub fn build(self) -> super::types::GuardrailTextCharactersCoverage {
        super::types::GuardrailTextCharactersCoverage {
