...
impl GuardrailOutputContent {
    ...
    pub fn builder() -> super::types::builders::GuardrailOutputContentBuilder {
        super::types::builders::GuardrailOutputContentBuilder::default()
    }
}
...
impl GuardrailOutputContentBuilder {
    ...
    pub fn build(self) -> super::types::GuardrailOutputContent {
        super::types::GuardrailOutputContent { text: self.text }
    }
}
