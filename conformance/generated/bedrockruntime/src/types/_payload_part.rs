...
impl PayloadPart {
    ...
    pub fn builder() -> super::types::builders::PayloadPartBuilder {
        super::types::builders::PayloadPartBuilder::default()
    }
}
...
impl PayloadPartBuilder {
    ...
    pub fn build(self) -> super::types::PayloadPart {
        super::types::PayloadPart { bytes: self.bytes }
    }
}
