...
impl CitationSourceContentDelta {
    ...
    pub fn builder() -> super::types::builders::CitationSourceContentDeltaBuilder {
        super::types::builders::CitationSourceContentDeltaBuilder::default()
    }
}
...
impl CitationSourceContentDeltaBuilder {
    ...
    pub fn build(self) -> super::types::CitationSourceContentDelta {
        super::types::CitationSourceContentDelta { text: self.text }
    }
}
