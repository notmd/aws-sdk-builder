...
impl ::aws_types::request_id::RequestId for super::types::error::ServiceUnavailableException {
...
impl ServiceUnavailableException {
    ...
    pub fn builder() -> super::types::error::builders::ServiceUnavailableExceptionBuilder {
        super::types::error::builders::ServiceUnavailableExceptionBuilder::default()
    }
}
...
impl ServiceUnavailableExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::ServiceUnavailableException {
        super::types::error::ServiceUnavailableException {
