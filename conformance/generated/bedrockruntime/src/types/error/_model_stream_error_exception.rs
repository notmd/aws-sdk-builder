...
impl ::aws_types::request_id::RequestId for super::types::error::ModelStreamErrorException {
...
impl ModelStreamErrorException {
    ...
    pub fn builder() -> super::types::error::builders::ModelStreamErrorExceptionBuilder {
        super::types::error::builders::ModelStreamErrorExceptionBuilder::default()
    }
}
...
impl ModelStreamErrorExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::ModelStreamErrorException {
        super::types::error::ModelStreamErrorException {
