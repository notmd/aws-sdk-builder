...
impl ::aws_types::request_id::RequestId for super::types::error::ModelErrorException {
...
impl ModelErrorException {
    ...
    pub fn builder() -> super::types::error::builders::ModelErrorExceptionBuilder {
        super::types::error::builders::ModelErrorExceptionBuilder::default()
    }
}
...
impl ModelErrorExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::ModelErrorException {
        super::types::error::ModelErrorException {
