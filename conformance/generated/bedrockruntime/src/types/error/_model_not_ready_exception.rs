...
impl ::aws_types::request_id::RequestId for super::types::error::ModelNotReadyException {
...
impl ModelNotReadyException {
    ...
    pub fn builder() -> super::types::error::builders::ModelNotReadyExceptionBuilder {
        super::types::error::builders::ModelNotReadyExceptionBuilder::default()
    }
}
...
impl ModelNotReadyExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::ModelNotReadyException {
        super::types::error::ModelNotReadyException {
