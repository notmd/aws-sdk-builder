...
impl GuardrailAutomatedReasoningStatement {
    ...
    pub fn builder() -> super::types::builders::GuardrailAutomatedReasoningStatementBuilder {
        super::types::builders::GuardrailAutomatedReasoningStatementBuilder::default()
    }
}
...
impl GuardrailAutomatedReasoningStatementBuilder {
    ...
    pub fn build(self) -> super::types::GuardrailAutomatedReasoningStatement {
        super::types::GuardrailAutomatedReasoningStatement {
            logic: self.logic,
