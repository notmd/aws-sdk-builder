...
impl GuardrailImageBlock {
    /// <p>The format details for the file type of the image blocked by the guardrail.</p>
    pub fn format(&self) -> &super::types::GuardrailImageFormat {
        &self.format
    }
    /// <p>The image source (image bytes) details of the image blocked by the guardrail.</p>
...
impl GuardrailImageBlock {
    ...
    pub fn builder() -> super::types::builders::GuardrailImageBlockBuilder {
        super::types::builders::GuardrailImageBlockBuilder::default()
    }
}
...
pub struct GuardrailImageBlockBuilder {
    pub(crate) format: ::std::option::Option<super::types::GuardrailImageFormat>,
    pub(crate) source: ::std::option::Option<super::types::GuardrailImageSource>,
}
impl GuardrailImageBlockBuilder {
    /// <p>The format details for the file type of the image blocked by the guardrail.</p>
    /// This field is required.
    pub fn format(mut self, input: super::types::GuardrailImageFormat) -> Self {
        self.format = ::std::option::Option::Some(input);
        self
    }
    /// <p>The format details for the file type of the image blocked by the guardrail.</p>
    pub fn set_format(mut self, input: ::std::option::Option<super::types::GuardrailImageFormat>) -> Self {
        self.format = input;
        self
    }
    /// <p>The format details for the file type of the image blocked by the guardrail.</p>
    pub fn get_format(&self) -> &::std::option::Option<super::types::GuardrailImageFormat> {
        &self.format
    }
    /// <p>The image source (image bytes) details of the image blocked by the guardrail.</p>
    /// This field is required.
    pub fn source(mut self, input: super::types::GuardrailImageSource) -> Self {
        self.source = ::std::option::Option::Some(input);
        self
    }
    /// <p>The image source (image bytes) details of the image blocked by the guardrail.</p>
    pub fn set_source(mut self, input: ::std::option::Option<super::types::GuardrailImageSource>) -> Self {
        self.source = input;
        self
    }
    /// <p>The image source (image bytes) details of the image blocked by the guardrail.</p>
    pub fn get_source(&self) -> &::std::option::Option<super::types::GuardrailImageSource> {
        &self.source
    }
