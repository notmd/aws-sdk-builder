...
impl InferenceConfiguration {
    ...
    pub fn builder() -> super::types::builders::InferenceConfigurationBuilder {
        super::types::builders::InferenceConfigurationBuilder::default()
    }
}
...
impl InferenceConfigurationBuilder {
    ...
    pub fn build(self) -> super::types::InferenceConfiguration {
        super::types::InferenceConfiguration {
