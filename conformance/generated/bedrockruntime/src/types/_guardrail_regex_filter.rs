...
impl GuardrailRegexFilter {
    ...
    pub fn builder() -> super::types::builders::GuardrailRegexFilterBuilder {
        super::types::builders::GuardrailRegexFilterBuilder::default()
    }
}
...
impl GuardrailRegexFilterBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::GuardrailRegexFilter, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::GuardrailRegexFilter {
            name: self.name,
