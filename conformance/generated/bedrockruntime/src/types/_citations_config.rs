...
impl CitationsConfig {
    ...
    pub fn builder() -> super::types::builders::CitationsConfigBuilder {
        super::types::builders::CitationsConfigBuilder::default()
    }
}
...
impl CitationsConfigBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::CitationsConfig, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::CitationsConfig {
