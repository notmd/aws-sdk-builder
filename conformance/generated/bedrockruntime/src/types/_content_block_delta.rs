...
pub enum ContentBlockDelta {
    ...
    Image(super::types::ImageBlockDelta),
    ...
    ReasoningContent(super::types::ReasoningContentBlockDelta),
    /// <p>The content text.</p>
    Text(::std::string::String),
    /// <p>An incremental update that contains the results from a tool call.</p>
    ToolResult(::std::vec::Vec<super::types::ToolResultBlockDelta>),
    /// <p>Information about a tool that the model is requesting to use.</p>
    ToolUse(super::types::ToolUseBlockDelta),
...
impl ContentBlockDelta {
    ...
    pub fn as_citation(&self) -> ::std::result::Result<&super::types::CitationsDelta, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_image(&self) -> ::std::result::Result<&super::types::ImageBlockDelta, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_reasoning_content(&self) -> ::std::result::Result<&super::types::ReasoningContentBlockDelta, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_tool_use(&self) -> ::std::result::Result<&super::types::ToolUseBlockDelta, &Self> {
