...
impl SearchResultLocation {
    ...
    pub fn builder() -> super::types::builders::SearchResultLocationBuilder {
        super::types::builders::SearchResultLocationBuilder::default()
    }
}
...
impl SearchResultLocationBuilder {
    ...
    pub fn build(self) -> super::types::SearchResultLocation {
        super::types::SearchResultLocation {
