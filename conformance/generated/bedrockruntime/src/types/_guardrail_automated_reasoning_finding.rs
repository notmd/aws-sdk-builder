...
pub enum GuardrailAutomatedReasoningFinding {
    ...
    Impossible(super::types::GuardrailAutomatedReasoningImpossibleFinding),
    ...
    Invalid(super::types::GuardrailAutomatedReasoningInvalidFinding),
    ...
    NoTranslations(super::types::GuardrailAutomatedReasoningNoTranslationsFinding),
    ...
    Satisfiable(super::types::GuardrailAutomatedReasoningSatisfiableFinding),
    ...
    TooComplex(super::types::GuardrailAutomatedReasoningTooComplexFinding),
    ...
    TranslationAmbiguous(super::types::GuardrailAutomatedReasoningTranslationAmbiguousFinding),
    ...
    Valid(super::types::GuardrailAutomatedReasoningValidFinding),
...
impl GuardrailAutomatedReasoningFinding {
    ...
    pub fn as_impossible(&self) -> ::std::result::Result<&super::types::GuardrailAutomatedReasoningImpossibleFinding, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_invalid(&self) -> ::std::result::Result<&super::types::GuardrailAutomatedReasoningInvalidFinding, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_no_translations(&self) -> ::std::result::Result<&super::types::GuardrailAutomatedReasoningNoTranslationsFinding, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_satisfiable(&self) -> ::std::result::Result<&super::types::GuardrailAutomatedReasoningSatisfiableFinding, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_too_complex(&self) -> ::std::result::Result<&super::types::GuardrailAutomatedReasoningTooComplexFinding, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_translation_ambiguous(&self) -> ::std::result::Result<&super::types::GuardrailAutomatedReasoningTranslationAmbiguousFinding, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_valid(&self) -> ::std::result::Result<&super::types::GuardrailAutomatedReasoningValidFinding, &Self> {
