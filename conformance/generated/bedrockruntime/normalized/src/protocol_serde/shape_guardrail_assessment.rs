...
pub(crate) fn de_guardrail_assessment<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::super::types::GuardrailAssessment>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::super::types::builders::GuardrailAssessmentBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "topicPolicy" => {
                            builder = builder.set_topic_policy(
                                super::super::protocol_serde::shape_guardrail_topic_policy_assessment::de_guardrail_topic_policy_assessment(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "contentPolicy" => {
                            builder = builder.set_content_policy(
                                super::super::protocol_serde::shape_guardrail_content_policy_assessment::de_guardrail_content_policy_assessment(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "wordPolicy" => {
                            builder = builder.set_word_policy(
                                super::super::protocol_serde::shape_guardrail_word_policy_assessment::de_guardrail_word_policy_assessment(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "invocationMetrics" => {
                            builder = builder.set_invocation_metrics(
                                super::super::protocol_serde::shape_guardrail_invocation_metrics::de_guardrail_invocation_metrics(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
