...
impl JobCapacityUsageSummary {
    ...
    pub fn builder() -> super::types::builders::JobCapacityUsageSummaryBuilder {
        super::types::builders::JobCapacityUsageSummaryBuilder::default()
    }
}
...
impl JobCapacityUsageSummaryBuilder {
    ...
    pub fn build(self) -> super::types::JobCapacityUsageSummary {
        super::types::JobCapacityUsageSummary {
