...
impl FargatePlatformConfiguration {
    ...
    pub fn builder() -> super::types::builders::FargatePlatformConfigurationBuilder {
        super::types::builders::FargatePlatformConfigurationBuilder::default()
    }
}
...
impl FargatePlatformConfigurationBuilder {
    ...
    pub fn build(self) -> super::types::FargatePlatformConfiguration {
        super::types::FargatePlatformConfiguration {
