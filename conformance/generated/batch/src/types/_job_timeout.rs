...
impl JobTimeout {
    ...
    pub fn builder() -> super::types::builders::JobTimeoutBuilder {
        super::types::builders::JobTimeoutBuilder::default()
    }
}
...
impl JobTimeoutBuilder {
    ...
    pub fn build(self) -> super::types::JobTimeout {
        super::types::JobTimeout {
