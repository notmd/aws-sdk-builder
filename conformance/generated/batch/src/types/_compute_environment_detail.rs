...
pub struct ComputeEnvironmentDetail {
    ...
    pub r#type: ::std::option::Option<super::types::CeType>,
    ...
    pub compute_resources: ::std::option::Option<super::types::ComputeResource>,
    ...
    pub update_policy: ::std::option::Option<super::types::UpdatePolicy>,
    ...
    pub eks_configuration: ::std::option::Option<super::types::EksConfiguration>,
    ...
    pub ecs_settings: ::std::option::Option<super::types::EcsSettings>,
}
impl ComputeEnvironmentDetail {
    ...
    /// <p>The type of the compute environment: <code>MANAGED</code> or <code>UNMANAGED</code>. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/compute_environments.html">Compute environments</a> in the <i>Batch User Guide</i>.</p>
    pub fn r#type(&self) -> ::std::option::Option<&super::types::CeType> {
        self.r#type.as_ref()
    }
    /// <p>The state of the compute environment. The valid values are <code>ENABLED</code> or <code>DISABLED</code>.</p>
    /// <p>If the state is <code>ENABLED</code>, then the Batch scheduler can attempt to place jobs from an associated job queue on the compute resources within the environment. If the compute environment is managed, then it can scale its instances out or in automatically based on the job queue demand.</p>
    ...
    /// </note>
    /// <p>When an instance is idle, the instance scales down to the <code>minvCpus</code> value. However, the instance size doesn't change. For example, consider a <code>c5.8xlarge</code> instance with a <code>minvCpus</code> value of <code>4</code> and a <code>desiredvCpus</code> value of <code>36</code>. This instance doesn't scale down to a <code>c5.large</code> instance.</p>
    pub fn state(&self) -> ::std::option::Option<&super::types::CeState> {
        self.state.as_ref()
    }
    /// <p>The current status of the compute environment (for example, <code>CREATING</code> or <code>VALID</code>).</p>
    pub fn status(&self) -> ::std::option::Option<&super::types::CeStatus> {
        self.status.as_ref()
    }
    /// <p>A short, human-readable string to provide additional details for the current status of the compute environment.</p>
    ...
    /// <p>The compute resources defined for the compute environment. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/compute_environments.html">Compute environments</a> in the <i>Batch User Guide</i>.</p>
    pub fn compute_resources(&self) -> ::std::option::Option<&super::types::ComputeResource> {
    ...
    /// <p>Specifies the infrastructure update policy for the compute environment. For more information about infrastructure updates, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/updating-compute-environments.html">Updating compute environments</a> in the <i>Batch User Guide</i>.</p>
    pub fn update_policy(&self) -> ::std::option::Option<&super::types::UpdatePolicy> {
        self.update_policy.as_ref()
    }
    /// <p>The configuration for the Amazon EKS cluster that supports the Batch compute environment. Only specify this parameter if the <code>containerOrchestrationType</code> is <code>EKS</code>.</p>
    pub fn eks_configuration(&self) -> ::std::option::Option<&super::types::EksConfiguration> {
    ...
    /// <p>The Amazon ECS settings for the compute environment. These settings control CloudWatch Container Insights collection.</p>
    pub fn ecs_settings(&self) -> ::std::option::Option<&super::types::EcsSettings> {
...
impl ComputeEnvironmentDetail {
    ...
    pub fn builder() -> super::types::builders::ComputeEnvironmentDetailBuilder {
        super::types::builders::ComputeEnvironmentDetailBuilder::default()
    }
}
...
pub struct ComputeEnvironmentDetailBuilder {
    ...
    pub(crate) r#type: ::std::option::Option<super::types::CeType>,
    pub(crate) state: ::std::option::Option<super::types::CeState>,
    pub(crate) status: ::std::option::Option<super::types::CeStatus>,
    pub(crate) status_reason: ::std::option::Option<::std::string::String>,
    pub(crate) compute_resources: ::std::option::Option<super::types::ComputeResource>,
    pub(crate) service_role: ::std::option::Option<::std::string::String>,
    pub(crate) update_policy: ::std::option::Option<super::types::UpdatePolicy>,
    pub(crate) eks_configuration: ::std::option::Option<super::types::EksConfiguration>,
    pub(crate) container_orchestration_type: ::std::option::Option<super::types::OrchestrationType>,
    pub(crate) uuid: ::std::option::Option<::std::string::String>,
    pub(crate) context: ::std::option::Option<::std::string::String>,
    pub(crate) ecs_settings: ::std::option::Option<super::types::EcsSettings>,
}
impl ComputeEnvironmentDetailBuilder {
    ...
    /// <p>The type of the compute environment: <code>MANAGED</code> or <code>UNMANAGED</code>. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/compute_environments.html">Compute environments</a> in the <i>Batch User Guide</i>.</p>
    pub fn r#type(mut self, input: super::types::CeType) -> Self {
        self.r#type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The type of the compute environment: <code>MANAGED</code> or <code>UNMANAGED</code>. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/compute_environments.html">Compute environments</a> in the <i>Batch User Guide</i>.</p>
    pub fn set_type(mut self, input: ::std::option::Option<super::types::CeType>) -> Self {
        self.r#type = input;
        self
    }
    /// <p>The type of the compute environment: <code>MANAGED</code> or <code>UNMANAGED</code>. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/compute_environments.html">Compute environments</a> in the <i>Batch User Guide</i>.</p>
    pub fn get_type(&self) -> &::std::option::Option<super::types::CeType> {
        &self.r#type
    }
    /// <p>The state of the compute environment. The valid values are <code>ENABLED</code> or <code>DISABLED</code>.</p>
    /// <p>If the state is <code>ENABLED</code>, then the Batch scheduler can attempt to place jobs from an associated job queue on the compute resources within the environment. If the compute environment is managed, then it can scale its instances out or in automatically based on the job queue demand.</p>
    ...
    /// </note>
    /// <p>When an instance is idle, the instance scales down to the <code>minvCpus</code> value. However, the instance size doesn't change. For example, consider a <code>c5.8xlarge</code> instance with a <code>minvCpus</code> value of <code>4</code> and a <code>desiredvCpus</code> value of <code>36</code>. This instance doesn't scale down to a <code>c5.large</code> instance.</p>
    pub fn state(mut self, input: super::types::CeState) -> Self {
    ...
    /// </note>
    /// <p>When an instance is idle, the instance scales down to the <code>minvCpus</code> value. However, the instance size doesn't change. For example, consider a <code>c5.8xlarge</code> instance with a <code>minvCpus</code> value of <code>4</code> and a <code>desiredvCpus</code> value of <code>36</code>. This instance doesn't scale down to a <code>c5.large</code> instance.</p>
    pub fn set_state(mut self, input: ::std::option::Option<super::types::CeState>) -> Self {
        self.state = input;
        self
    }
    /// <p>The state of the compute environment. The valid values are <code>ENABLED</code> or <code>DISABLED</code>.</p>
    ...
    /// </note>
    /// <p>When an instance is idle, the instance scales down to the <code>minvCpus</code> value. However, the instance size doesn't change. For example, consider a <code>c5.8xlarge</code> instance with a <code>minvCpus</code> value of <code>4</code> and a <code>desiredvCpus</code> value of <code>36</code>. This instance doesn't scale down to a <code>c5.large</code> instance.</p>
    pub fn get_state(&self) -> &::std::option::Option<super::types::CeState> {
        &self.state
    }
    /// <p>The current status of the compute environment (for example, <code>CREATING</code> or <code>VALID</code>).</p>
    pub fn status(mut self, input: super::types::CeStatus) -> Self {
        self.status = ::std::option::Option::Some(input);
        self
    }
    /// <p>The current status of the compute environment (for example, <code>CREATING</code> or <code>VALID</code>).</p>
    pub fn set_status(mut self, input: ::std::option::Option<super::types::CeStatus>) -> Self {
        self.status = input;
        self
    }
    /// <p>The current status of the compute environment (for example, <code>CREATING</code> or <code>VALID</code>).</p>
    pub fn get_status(&self) -> &::std::option::Option<super::types::CeStatus> {
        &self.status
    }
    /// <p>A short, human-readable string to provide additional details for the current status of the compute environment.</p>
    ...
    /// <p>The compute resources defined for the compute environment. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/compute_environments.html">Compute environments</a> in the <i>Batch User Guide</i>.</p>
    pub fn compute_resources(mut self, input: super::types::ComputeResource) -> Self {
        self.compute_resources = ::std::option::Option::Some(input);
        self
    }
    /// <p>The compute resources defined for the compute environment. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/compute_environments.html">Compute environments</a> in the <i>Batch User Guide</i>.</p>
    pub fn set_compute_resources(mut self, input: ::std::option::Option<super::types::ComputeResource>) -> Self {
        self.compute_resources = input;
        self
    }
    /// <p>The compute resources defined for the compute environment. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/compute_environments.html">Compute environments</a> in the <i>Batch User Guide</i>.</p>
    pub fn get_compute_resources(&self) -> &::std::option::Option<super::types::ComputeResource> {
    ...
    /// <p>Specifies the infrastructure update policy for the compute environment. For more information about infrastructure updates, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/updating-compute-environments.html">Updating compute environments</a> in the <i>Batch User Guide</i>.</p>
    pub fn update_policy(mut self, input: super::types::UpdatePolicy) -> Self {
        self.update_policy = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies the infrastructure update policy for the compute environment. For more information about infrastructure updates, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/updating-compute-environments.html">Updating compute environments</a> in the <i>Batch User Guide</i>.</p>
    pub fn set_update_policy(mut self, input: ::std::option::Option<super::types::UpdatePolicy>) -> Self {
        self.update_policy = input;
        self
    }
    /// <p>Specifies the infrastructure update policy for the compute environment. For more information about infrastructure updates, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/updating-compute-environments.html">Updating compute environments</a> in the <i>Batch User Guide</i>.</p>
    pub fn get_update_policy(&self) -> &::std::option::Option<super::types::UpdatePolicy> {
        &self.update_policy
    }
    /// <p>The configuration for the Amazon EKS cluster that supports the Batch compute environment. Only specify this parameter if the <code>containerOrchestrationType</code> is <code>EKS</code>.</p>
    pub fn eks_configuration(mut self, input: super::types::EksConfiguration) -> Self {
        self.eks_configuration = ::std::option::Option::Some(input);
        self
    }
    /// <p>The configuration for the Amazon EKS cluster that supports the Batch compute environment. Only specify this parameter if the <code>containerOrchestrationType</code> is <code>EKS</code>.</p>
    pub fn set_eks_configuration(mut self, input: ::std::option::Option<super::types::EksConfiguration>) -> Self {
        self.eks_configuration = input;
        self
    }
    /// <p>The configuration for the Amazon EKS cluster that supports the Batch compute environment. Only specify this parameter if the <code>containerOrchestrationType</code> is <code>EKS</code>.</p>
    pub fn get_eks_configuration(&self) -> &::std::option::Option<super::types::EksConfiguration> {
    ...
    /// <p>The Amazon ECS settings for the compute environment. These settings control CloudWatch Container Insights collection.</p>
    pub fn ecs_settings(mut self, input: super::types::EcsSettings) -> Self {
        self.ecs_settings = ::std::option::Option::Some(input);
        self
    }
    /// <p>The Amazon ECS settings for the compute environment. These settings control CloudWatch Container Insights collection.</p>
    pub fn set_ecs_settings(mut self, input: ::std::option::Option<super::types::EcsSettings>) -> Self {
        self.ecs_settings = input;
        self
    }
    /// <p>The Amazon ECS settings for the compute environment. These settings control CloudWatch Container Insights collection.</p>
    pub fn get_ecs_settings(&self) -> &::std::option::Option<super::types::EcsSettings> {
        &self.ecs_settings
    }
