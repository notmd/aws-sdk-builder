...
impl ContainerSummary {
    ...
    pub fn builder() -> super::types::builders::ContainerSummaryBuilder {
        super::types::builders::ContainerSummaryBuilder::default()
    }
}
...
impl ContainerSummaryBuilder {
    ...
    pub fn build(self) -> super::types::ContainerSummary {
        super::types::ContainerSummary {
