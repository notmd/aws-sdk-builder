...
impl EksContainerResourceRequirements {
    ...
    pub fn builder() -> super::types::builders::EksContainerResourceRequirementsBuilder {
        super::types::builders::EksContainerResourceRequirementsBuilder::default()
    }
}
...
impl EksContainerResourceRequirementsBuilder {
    ...
    pub fn build(self) -> super::types::EksContainerResourceRequirements {
        super::types::EksContainerResourceRequirements {
            limits: self.limits,
