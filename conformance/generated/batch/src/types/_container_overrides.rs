...
impl ContainerOverrides {
    ...
    pub fn builder() -> super::types::builders::ContainerOverridesBuilder {
        super::types::builders::ContainerOverridesBuilder::default()
    }
}
...
impl ContainerOverridesBuilder {
    ...
    pub fn build(self) -> super::types::ContainerOverrides {
        super::types::ContainerOverrides {
            vcpus: self.vcpus,
            memory: self.memory,
