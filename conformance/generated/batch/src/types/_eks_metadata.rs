...
impl EksMetadata {
    ...
    pub fn builder() -> super::types::builders::EksMetadataBuilder {
        super::types::builders::EksMetadataBuilder::default()
    }
}
...
impl EksMetadataBuilder {
    ...
    pub fn build(self) -> super::types::EksMetadata {
        super::types::EksMetadata {
            labels: self.labels,
