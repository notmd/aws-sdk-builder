...
pub struct AttemptEcsTaskDetails {
    ...
    pub containers: ::std::option::Option<::std::vec::Vec<super::types::AttemptTaskContainerDetails>>,
}
impl AttemptEcsTaskDetails {
    ...
    pub fn containers(&self) -> &[super::types::AttemptTaskContainerDetails] {
...
impl AttemptEcsTaskDetails {
    ...
    pub fn builder() -> super::types::builders::AttemptEcsTaskDetailsBuilder {
        super::types::builders::AttemptEcsTaskDetailsBuilder::default()
    }
}
...
pub struct AttemptEcsTaskDetailsBuilder {
    ...
    pub(crate) containers: ::std::option::Option<::std::vec::Vec<super::types::AttemptTaskContainerDetails>>,
}
impl AttemptEcsTaskDetailsBuilder {
    ...
    ///
    /// <p>A list of containers that are included in the <code>taskProperties</code> list.</p>
    pub fn containers(mut self, input: super::types::AttemptTaskContainerDetails) -> Self {
    ...
    /// <p>A list of containers that are included in the <code>taskProperties</code> list.</p>
    pub fn set_containers(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::AttemptTaskContainerDetails>>) -> Self {
        self.containers = input;
        self
    }
    /// <p>A list of containers that are included in the <code>taskProperties</code> list.</p>
    pub fn get_containers(&self) -> &::std::option::Option<::std::vec::Vec<super::types::AttemptTaskContainerDetails>> {
        &self.containers
    }
    /// Consumes the builder and constructs a [`AttemptEcsTaskDetails`](crate::types::AttemptEcsTaskDetails).
    pub fn build(self) -> super::types::AttemptEcsTaskDetails {
        super::types::AttemptEcsTaskDetails {
