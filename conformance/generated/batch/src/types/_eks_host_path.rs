...
impl EksHostPath {
    ...
    pub fn builder() -> super::types::builders::EksHostPathBuilder {
        super::types::builders::EksHostPathBuilder::default()
    }
}
...
impl EksHostPathBuilder {
    ...
    pub fn build(self) -> super::types::EksHostPath {
        super::types::EksHostPath { path: self.path }
    }
}
