...
pub struct Volume {
    ...
    /// </note>
    pub host: ::std::option::Option<super::types::Host>,
    ...
    pub efs_volume_configuration: ::std::option::Option<super::types::EfsVolumeConfiguration>,
    /// <p>This parameter is specified when you're using an S3Files file system for job storage.</p>
    pub s3files_volume_configuration: ::std::option::Option<super::types::S3FilesVolumeConfiguration>,
}
impl Volume {
    /// <p>The contents of the <code>host</code> parameter determine whether your data volume persists on the host container instance and where it's stored. If the host parameter is empty, then the Docker daemon assigns a host path for your data volume. However, the data isn't guaranteed to persist after the containers that are associated with it stop running.</p><note>
    /// <p>This parameter isn't applicable to jobs that are running on Fargate resources and shouldn't be provided.</p>
    /// </note>
    pub fn host(&self) -> ::std::option::Option<&super::types::Host> {
        self.host.as_ref()
    }
    /// <p>The name of the volume. It can be up to 255 characters long. It can contain uppercase and lowercase letters, numbers, hyphens (-), and underscores (_). This name is referenced in the <code>sourceVolume</code> parameter of container definition <code>mountPoints</code>.</p>
    ...
    /// <p>This parameter is specified when you're using an Amazon Elastic File System file system for job storage. Jobs that are running on Fargate resources must specify a <code>platformVersion</code> of at least <code>1.4.0</code>.</p>
    pub fn efs_volume_configuration(&self) -> ::std::option::Option<&super::types::EfsVolumeConfiguration> {
        self.efs_volume_configuration.as_ref()
    }
    /// <p>This parameter is specified when you're using an S3Files file system for job storage.</p>
    pub fn s3files_volume_configuration(&self) -> ::std::option::Option<&super::types::S3FilesVolumeConfiguration> {
        self.s3files_volume_configuration.as_ref()
    }
}
impl Volume {
    /// Creates a new builder-style object to manufacture [`Volume`](crate::types::Volume).
    pub fn builder() -> super::types::builders::VolumeBuilder {
        super::types::builders::VolumeBuilder::default()
    }
}
...
pub struct VolumeBuilder {
    pub(crate) host: ::std::option::Option<super::types::Host>,
    pub(crate) name: ::std::option::Option<::std::string::String>,
    pub(crate) efs_volume_configuration: ::std::option::Option<super::types::EfsVolumeConfiguration>,
    pub(crate) s3files_volume_configuration: ::std::option::Option<super::types::S3FilesVolumeConfiguration>,
}
impl VolumeBuilder {
    /// <p>The contents of the <code>host</code> parameter determine whether your data volume persists on the host container instance and where it's stored. If the host parameter is empty, then the Docker daemon assigns a host path for your data volume. However, the data isn't guaranteed to persist after the containers that are associated with it stop running.</p><note>
    /// <p>This parameter isn't applicable to jobs that are running on Fargate resources and shouldn't be provided.</p>
    /// </note>
    pub fn host(mut self, input: super::types::Host) -> Self {
    ...
    /// <p>This parameter isn't applicable to jobs that are running on Fargate resources and shouldn't be provided.</p>
    /// </note>
    pub fn set_host(mut self, input: ::std::option::Option<super::types::Host>) -> Self {
        self.host = input;
        self
    }
    /// <p>The contents of the <code>host</code> parameter determine whether your data volume persists on the host container instance and where it's stored. If the host parameter is empty, then the Docker daemon assigns a host path for your data volume. However, the data isn't guaranteed to persist after the containers that are associated with it stop running.</p><note>
    /// <p>This parameter isn't applicable to jobs that are running on Fargate resources and shouldn't be provided.</p>
    /// </note>
    pub fn get_host(&self) -> &::std::option::Option<super::types::Host> {
        &self.host
    }
    /// <p>The name of the volume. It can be up to 255 characters long. It can contain uppercase and lowercase letters, numbers, hyphens (-), and underscores (_). This name is referenced in the <code>sourceVolume</code> parameter of container definition <code>mountPoints</code>.</p>
    ...
    /// <p>This parameter is specified when you're using an Amazon Elastic File System file system for job storage. Jobs that are running on Fargate resources must specify a <code>platformVersion</code> of at least <code>1.4.0</code>.</p>
    pub fn efs_volume_configuration(mut self, input: super::types::EfsVolumeConfiguration) -> Self {
        self.efs_volume_configuration = ::std::option::Option::Some(input);
        self
    }
    /// <p>This parameter is specified when you're using an Amazon Elastic File System file system for job storage. Jobs that are running on Fargate resources must specify a <code>platformVersion</code> of at least <code>1.4.0</code>.</p>
    pub fn set_efs_volume_configuration(mut self, input: ::std::option::Option<super::types::EfsVolumeConfiguration>) -> Self {
        self.efs_volume_configuration = input;
        self
    }
    /// <p>This parameter is specified when you're using an Amazon Elastic File System file system for job storage. Jobs that are running on Fargate resources must specify a <code>platformVersion</code> of at least <code>1.4.0</code>.</p>
    pub fn get_efs_volume_configuration(&self) -> &::std::option::Option<super::types::EfsVolumeConfiguration> {
        &self.efs_volume_configuration
    }
    /// <p>This parameter is specified when you're using an S3Files file system for job storage.</p>
    pub fn s3files_volume_configuration(mut self, input: super::types::S3FilesVolumeConfiguration) -> Self {
        self.s3files_volume_configuration = ::std::option::Option::Some(input);
        self
    }
    /// <p>This parameter is specified when you're using an S3Files file system for job storage.</p>
    pub fn set_s3files_volume_configuration(mut self, input: ::std::option::Option<super::types::S3FilesVolumeConfiguration>) -> Self {
        self.s3files_volume_configuration = input;
        self
    }
    /// <p>This parameter is specified when you're using an S3Files file system for job storage.</p>
    pub fn get_s3files_volume_configuration(&self) -> &::std::option::Option<super::types::S3FilesVolumeConfiguration> {
        &self.s3files_volume_configuration
    }
    /// Consumes the builder and constructs a [`Volume`](crate::types::Volume).
    pub fn build(self) -> super::types::Volume {
        super::types::Volume {
            host: self.host,
            name: self.name,
