...
impl ServiceJobTimeout {
    ...
    pub fn builder() -> super::types::builders::ServiceJobTimeoutBuilder {
        super::types::builders::ServiceJobTimeoutBuilder::default()
    }
}
...
impl ServiceJobTimeoutBuilder {
    ...
    pub fn build(self) -> super::types::ServiceJobTimeout {
        super::types::ServiceJobTimeout {
