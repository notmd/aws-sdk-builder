...
pub struct EfsVolumeConfiguration {
    ...
    pub transit_encryption: ::std::option::Option<super::types::EfsTransitEncryption>,
    ...
    pub authorization_config: ::std::option::Option<super::types::EfsAuthorizationConfig>,
}
impl EfsVolumeConfiguration {
    ...
    /// <p>Determines whether to enable encryption for Amazon EFS data in transit between the Amazon ECS host and the Amazon EFS server. Transit encryption must be enabled if Amazon EFS IAM authorization is used. If this parameter is omitted, the default value of <code>DISABLED</code> is used. For more information, see <a href="https://docs.aws.amazon.com/efs/latest/ug/encryption-in-transit.html">Encrypting data in transit</a> in the <i>Amazon Elastic File System User Guide</i>.</p>
    pub fn transit_encryption(&self) -> ::std::option::Option<&super::types::EfsTransitEncryption> {
    ...
    /// <p>The authorization configuration details for the Amazon EFS file system.</p>
    pub fn authorization_config(&self) -> ::std::option::Option<&super::types::EfsAuthorizationConfig> {
...
impl EfsVolumeConfiguration {
    ...
    pub fn builder() -> super::types::builders::EfsVolumeConfigurationBuilder {
        super::types::builders::EfsVolumeConfigurationBuilder::default()
    }
}
...
pub struct EfsVolumeConfigurationBuilder {
    ...
    pub(crate) transit_encryption: ::std::option::Option<super::types::EfsTransitEncryption>,
    pub(crate) transit_encryption_port: ::std::option::Option<i32>,
    pub(crate) authorization_config: ::std::option::Option<super::types::EfsAuthorizationConfig>,
}
impl EfsVolumeConfigurationBuilder {
    ...
    /// <p>Determines whether to enable encryption for Amazon EFS data in transit between the Amazon ECS host and the Amazon EFS server. Transit encryption must be enabled if Amazon EFS IAM authorization is used. If this parameter is omitted, the default value of <code>DISABLED</code> is used. For more information, see <a href="https://docs.aws.amazon.com/efs/latest/ug/encryption-in-transit.html">Encrypting data in transit</a> in the <i>Amazon Elastic File System User Guide</i>.</p>
    pub fn transit_encryption(mut self, input: super::types::EfsTransitEncryption) -> Self {
        self.transit_encryption = ::std::option::Option::Some(input);
        self
    }
    /// <p>Determines whether to enable encryption for Amazon EFS data in transit between the Amazon ECS host and the Amazon EFS server. Transit encryption must be enabled if Amazon EFS IAM authorization is used. If this parameter is omitted, the default value of <code>DISABLED</code> is used. For more information, see <a href="https://docs.aws.amazon.com/efs/latest/ug/encryption-in-transit.html">Encrypting data in transit</a> in the <i>Amazon Elastic File System User Guide</i>.</p>
    pub fn set_transit_encryption(mut self, input: ::std::option::Option<super::types::EfsTransitEncryption>) -> Self {
        self.transit_encryption = input;
        self
    }
    /// <p>Determines whether to enable encryption for Amazon EFS data in transit between the Amazon ECS host and the Amazon EFS server. Transit encryption must be enabled if Amazon EFS IAM authorization is used. If this parameter is omitted, the default value of <code>DISABLED</code> is used. For more information, see <a href="https://docs.aws.amazon.com/efs/latest/ug/encryption-in-transit.html">Encrypting data in transit</a> in the <i>Amazon Elastic File System User Guide</i>.</p>
    pub fn get_transit_encryption(&self) -> &::std::option::Option<super::types::EfsTransitEncryption> {
    ...
    /// <p>The authorization configuration details for the Amazon EFS file system.</p>
    pub fn authorization_config(mut self, input: super::types::EfsAuthorizationConfig) -> Self {
        self.authorization_config = ::std::option::Option::Some(input);
        self
    }
    /// <p>The authorization configuration details for the Amazon EFS file system.</p>
    pub fn set_authorization_config(mut self, input: ::std::option::Option<super::types::EfsAuthorizationConfig>) -> Self {
        self.authorization_config = input;
        self
    }
    /// <p>The authorization configuration details for the Amazon EFS file system.</p>
    pub fn get_authorization_config(&self) -> &::std::option::Option<super::types::EfsAuthorizationConfig> {
