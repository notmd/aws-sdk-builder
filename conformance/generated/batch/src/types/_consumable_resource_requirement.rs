...
impl ConsumableResourceRequirement {
    ...
    pub fn builder() -> super::types::builders::ConsumableResourceRequirementBuilder {
        super::types::builders::ConsumableResourceRequirementBuilder::default()
    }
}
...
impl ConsumableResourceRequirementBuilder {
    ...
    pub fn build(self) -> super::types::ConsumableResourceRequirement {
        super::types::ConsumableResourceRequirement {
