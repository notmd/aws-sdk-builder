...
impl ArrayPropertiesSummary {
    ...
    pub fn builder() -> super::types::builders::ArrayPropertiesSummaryBuilder {
        super::types::builders::ArrayPropertiesSummaryBuilder::default()
    }
}
...
impl ArrayPropertiesSummaryBuilder {
    ...
    pub fn build(self) -> super::types::ArrayPropertiesSummary {
        super::types::ArrayPropertiesSummary {
            size: self.size,
            index: self.index,
