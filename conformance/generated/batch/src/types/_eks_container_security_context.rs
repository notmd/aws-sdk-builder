...
impl EksContainerSecurityContext {
    ...
    pub fn builder() -> super::types::builders::EksContainerSecurityContextBuilder {
        super::types::builders::EksContainerSecurityContextBuilder::default()
    }
}
...
impl EksContainerSecurityContextBuilder {
    ...
    pub fn build(self) -> super::types::EksContainerSecurityContext {
        super::types::EksContainerSecurityContext {
