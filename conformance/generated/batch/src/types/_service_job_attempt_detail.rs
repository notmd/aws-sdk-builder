...
impl ServiceJobAttemptDetail {
    ...
    pub fn builder() -> super::types::builders::ServiceJobAttemptDetailBuilder {
        super::types::builders::ServiceJobAttemptDetailBuilder::default()
    }
}
...
impl ServiceJobAttemptDetailBuilder {
    ...
    pub fn build(self) -> super::types::ServiceJobAttemptDetail {
        super::types::ServiceJobAttemptDetail {
