...
impl EvaluateOnExit {
    ...
    pub fn builder() -> super::types::builders::EvaluateOnExitBuilder {
        super::types::builders::EvaluateOnExitBuilder::default()
    }
}
...
pub struct EvaluateOnExitBuilder {
    ...
    pub(crate) action: ::std::option::Option<super::types::RetryAction>,
}
impl EvaluateOnExitBuilder {
    ...
    pub fn action(mut self, input: super::types::RetryAction) -> Self {
        self.action = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies the action to take if all of the specified conditions (<code>onStatusReason</code>, <code>onReason</code>, and <code>onExitCode</code>) are met. The values aren't case sensitive.</p>
    pub fn set_action(mut self, input: ::std::option::Option<super::types::RetryAction>) -> Self {
        self.action = input;
        self
    }
    /// <p>Specifies the action to take if all of the specified conditions (<code>onStatusReason</code>, <code>onReason</code>, and <code>onExitCode</code>) are met. The values aren't case sensitive.</p>
    pub fn get_action(&self) -> &::std::option::Option<super::types::RetryAction> {
        &self.action
    }
