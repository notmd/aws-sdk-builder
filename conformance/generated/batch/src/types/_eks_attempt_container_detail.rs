...
impl EksAttemptContainerDetail {
    ...
    pub fn builder() -> super::types::builders::EksAttemptContainerDetailBuilder {
        super::types::builders::EksAttemptContainerDetailBuilder::default()
    }
}
...
impl EksAttemptContainerDetailBuilder {
    ...
    pub fn build(self) -> super::types::EksAttemptContainerDetail {
        super::types::EksAttemptContainerDetail {
            name: self.name,
