...
impl ComputeScalingPolicy {
    ...
    pub fn builder() -> super::types::builders::ComputeScalingPolicyBuilder {
        super::types::builders::ComputeScalingPolicyBuilder::default()
    }
}
...
impl ComputeScalingPolicyBuilder {
    ...
    pub fn build(self) -> super::types::ComputeScalingPolicy {
        super::types::ComputeScalingPolicy {
