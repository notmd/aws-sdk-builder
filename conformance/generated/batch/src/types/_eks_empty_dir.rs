...
impl EksEmptyDir {
    ...
    pub fn builder() -> super::types::builders::EksEmptyDirBuilder {
        super::types::builders::EksEmptyDirBuilder::default()
    }
}
...
impl EksEmptyDirBuilder {
    ...
    pub fn build(self) -> super::types::EksEmptyDir {
        super::types::EksEmptyDir {
            medium: self.medium,
