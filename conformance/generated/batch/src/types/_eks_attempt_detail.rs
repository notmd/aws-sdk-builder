...
pub struct EksAttemptDetail {
    ...
    pub containers: ::std::option::Option<::std::vec::Vec<super::types::EksAttemptContainerDetail>>,
    /// <p>The details for the init containers.</p>
    pub init_containers: ::std::option::Option<::std::vec::Vec<super::types::EksAttemptContainerDetail>>,
...
impl EksAttemptDetail {
    ...
    pub fn containers(&self) -> &[super::types::EksAttemptContainerDetail] {
    ...
    pub fn init_containers(&self) -> &[super::types::EksAttemptContainerDetail] {
...
impl EksAttemptDetail {
    ...
    pub fn builder() -> super::types::builders::EksAttemptDetailBuilder {
        super::types::builders::EksAttemptDetailBuilder::default()
    }
}
...
pub struct EksAttemptDetailBuilder {
    pub(crate) containers: ::std::option::Option<::std::vec::Vec<super::types::EksAttemptContainerDetail>>,
    pub(crate) init_containers: ::std::option::Option<::std::vec::Vec<super::types::EksAttemptContainerDetail>>,
...
impl EksAttemptDetailBuilder {
    ...
    ///
    /// <p>The details for the final status of the containers for this job attempt.</p>
    pub fn containers(mut self, input: super::types::EksAttemptContainerDetail) -> Self {
    ...
    /// <p>The details for the final status of the containers for this job attempt.</p>
    pub fn set_containers(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::EksAttemptContainerDetail>>) -> Self {
        self.containers = input;
        self
    }
    /// <p>The details for the final status of the containers for this job attempt.</p>
    pub fn get_containers(&self) -> &::std::option::Option<::std::vec::Vec<super::types::EksAttemptContainerDetail>> {
        &self.containers
    }
    ...
    ///
    /// <p>The details for the init containers.</p>
    pub fn init_containers(mut self, input: super::types::EksAttemptContainerDetail) -> Self {
    ...
    /// <p>The details for the init containers.</p>
    pub fn set_init_containers(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::EksAttemptContainerDetail>>) -> Self {
        self.init_containers = input;
        self
    }
    /// <p>The details for the init containers.</p>
    pub fn get_init_containers(&self) -> &::std::option::Option<::std::vec::Vec<super::types::EksAttemptContainerDetail>> {
    ...
    pub fn build(self) -> super::types::EksAttemptDetail {
        super::types::EksAttemptDetail {
