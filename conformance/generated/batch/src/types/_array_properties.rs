...
impl ArrayProperties {
    ...
    pub fn builder() -> super::types::builders::ArrayPropertiesBuilder {
        super::types::builders::ArrayPropertiesBuilder::default()
    }
}
...
impl ArrayPropertiesBuilder {
    ...
    pub fn build(self) -> super::types::ArrayProperties {
        super::types::ArrayProperties { size: self.size }
    }
}
