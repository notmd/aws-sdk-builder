...
impl ManagedInstancesProvider {
    ...
    pub fn builder() -> super::types::builders::ManagedInstancesProviderBuilder {
        super::types::builders::ManagedInstancesProviderBuilder::default()
    }
}
...
pub struct ManagedInstancesProviderBuilder {
    ...
    pub(crate) instance_launch_template: ::std::option::Option<super::types::InstanceLaunchTemplate>,
...
impl ManagedInstancesProviderBuilder {
    ...
    /// <p>The instance launch configuration for the Amazon ECS Managed Instances capacity provider. Contains networking, instance profile, instance requirements, capacity type, storage, and monitoring configuration.</p>
    /// This field is required.
    pub fn instance_launch_template(mut self, input: super::types::InstanceLaunchTemplate) -> Self {
        self.instance_launch_template = ::std::option::Option::Some(input);
        self
    }
    /// <p>The instance launch configuration for the Amazon ECS Managed Instances capacity provider. Contains networking, instance profile, instance requirements, capacity type, storage, and monitoring configuration.</p>
    pub fn set_instance_launch_template(mut self, input: ::std::option::Option<super::types::InstanceLaunchTemplate>) -> Self {
        self.instance_launch_template = input;
        self
    }
    /// <p>The instance launch configuration for the Amazon ECS Managed Instances capacity provider. Contains networking, instance profile, instance requirements, capacity type, storage, and monitoring configuration.</p>
    pub fn get_instance_launch_template(&self) -> &::std::option::Option<super::types::InstanceLaunchTemplate> {
