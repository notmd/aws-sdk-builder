...
impl ContainerProperties {
    ...
    pub fn builder() -> super::types::builders::ContainerPropertiesBuilder {
        super::types::builders::ContainerPropertiesBuilder::default()
    }
}
...
impl ContainerPropertiesBuilder {
    ...
    pub fn build(self) -> super::types::ContainerProperties {
        super::types::ContainerProperties {
            image: self.image,
            vcpus: self.vcpus,
            memory: self.memory,
