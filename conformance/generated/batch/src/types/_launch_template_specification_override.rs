...
impl LaunchTemplateSpecificationOverride {
    ...
    pub fn builder() -> super::types::builders::LaunchTemplateSpecificationOverrideBuilder {
        super::types::builders::LaunchTemplateSpecificationOverrideBuilder::default()
    }
}
...
impl LaunchTemplateSpecificationOverrideBuilder {
    ...
    pub fn build(self) -> super::types::LaunchTemplateSpecificationOverride {
        super::types::LaunchTemplateSpecificationOverride {
