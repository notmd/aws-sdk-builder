...
pub struct EksVolume {
    ...
    pub empty_dir: ::std::option::Option<super::types::EksEmptyDir>,
    ...
    pub secret: ::std::option::Option<super::types::EksSecret>,
    ...
    pub persistent_volume_claim: ::std::option::Option<super::types::EksPersistentVolumeClaim>,
}
impl EksVolume {
    /// <p>The name of the volume. The name must be allowed as a DNS subdomain name. For more information, see <a href="https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#dns-subdomain-names">DNS subdomain names</a> in the <i>Kubernetes documentation</i>.</p>
    ...
    /// <p>Specifies the configuration of a Kubernetes <code>emptyDir</code> volume. For more information, see <a href="https://kubernetes.io/docs/concepts/storage/volumes/#emptydir">emptyDir</a> in the <i>Kubernetes documentation</i>.</p>
    pub fn empty_dir(&self) -> ::std::option::Option<&super::types::EksEmptyDir> {
        self.empty_dir.as_ref()
    }
    /// <p>Specifies the configuration of a Kubernetes <code>secret</code> volume. For more information, see <a href="https://kubernetes.io/docs/concepts/storage/volumes/#secret">secret</a> in the <i>Kubernetes documentation</i>.</p>
    pub fn secret(&self) -> ::std::option::Option<&super::types::EksSecret> {
        self.secret.as_ref()
    }
    /// <p>Specifies the configuration of a Kubernetes <code>persistentVolumeClaim</code> bounded to a <code>persistentVolume</code>. For more information, see <a href="https://kubernetes.io/docs/concepts/storage/persistent-volumes/#persistentvolumeclaims"> Persistent Volume Claims</a> in the <i>Kubernetes documentation</i>.</p>
    pub fn persistent_volume_claim(&self) -> ::std::option::Option<&super::types::EksPersistentVolumeClaim> {
        self.persistent_volume_claim.as_ref()
    }
}
impl EksVolume {
    /// Creates a new builder-style object to manufacture [`EksVolume`](crate::types::EksVolume).
    pub fn builder() -> super::types::builders::EksVolumeBuilder {
        super::types::builders::EksVolumeBuilder::default()
    }
}
...
pub struct EksVolumeBuilder {
    ...
    pub(crate) host_path: ::std::option::Option<super::types::EksHostPath>,
    pub(crate) empty_dir: ::std::option::Option<super::types::EksEmptyDir>,
    pub(crate) secret: ::std::option::Option<super::types::EksSecret>,
    pub(crate) persistent_volume_claim: ::std::option::Option<super::types::EksPersistentVolumeClaim>,
}
impl EksVolumeBuilder {
    ...
    /// <p>Specifies the configuration of a Kubernetes <code>hostPath</code> volume. For more information, see <a href="https://kubernetes.io/docs/concepts/storage/volumes/#hostpath">hostPath</a> in the <i>Kubernetes documentation</i>.</p>
    pub fn host_path(mut self, input: super::types::EksHostPath) -> Self {
        self.host_path = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies the configuration of a Kubernetes <code>hostPath</code> volume. For more information, see <a href="https://kubernetes.io/docs/concepts/storage/volumes/#hostpath">hostPath</a> in the <i>Kubernetes documentation</i>.</p>
    pub fn set_host_path(mut self, input: ::std::option::Option<super::types::EksHostPath>) -> Self {
        self.host_path = input;
        self
    }
    /// <p>Specifies the configuration of a Kubernetes <code>hostPath</code> volume. For more information, see <a href="https://kubernetes.io/docs/concepts/storage/volumes/#hostpath">hostPath</a> in the <i>Kubernetes documentation</i>.</p>
    pub fn get_host_path(&self) -> &::std::option::Option<super::types::EksHostPath> {
        &self.host_path
    }
    /// <p>Specifies the configuration of a Kubernetes <code>emptyDir</code> volume. For more information, see <a href="https://kubernetes.io/docs/concepts/storage/volumes/#emptydir">emptyDir</a> in the <i>Kubernetes documentation</i>.</p>
    pub fn empty_dir(mut self, input: super::types::EksEmptyDir) -> Self {
        self.empty_dir = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies the configuration of a Kubernetes <code>emptyDir</code> volume. For more information, see <a href="https://kubernetes.io/docs/concepts/storage/volumes/#emptydir">emptyDir</a> in the <i>Kubernetes documentation</i>.</p>
    pub fn set_empty_dir(mut self, input: ::std::option::Option<super::types::EksEmptyDir>) -> Self {
        self.empty_dir = input;
        self
    }
    /// <p>Specifies the configuration of a Kubernetes <code>emptyDir</code> volume. For more information, see <a href="https://kubernetes.io/docs/concepts/storage/volumes/#emptydir">emptyDir</a> in the <i>Kubernetes documentation</i>.</p>
    pub fn get_empty_dir(&self) -> &::std::option::Option<super::types::EksEmptyDir> {
        &self.empty_dir
    }
    /// <p>Specifies the configuration of a Kubernetes <code>secret</code> volume. For more information, see <a href="https://kubernetes.io/docs/concepts/storage/volumes/#secret">secret</a> in the <i>Kubernetes documentation</i>.</p>
    pub fn secret(mut self, input: super::types::EksSecret) -> Self {
        self.secret = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies the configuration of a Kubernetes <code>secret</code> volume. For more information, see <a href="https://kubernetes.io/docs/concepts/storage/volumes/#secret">secret</a> in the <i>Kubernetes documentation</i>.</p>
    pub fn set_secret(mut self, input: ::std::option::Option<super::types::EksSecret>) -> Self {
        self.secret = input;
        self
    }
    /// <p>Specifies the configuration of a Kubernetes <code>secret</code> volume. For more information, see <a href="https://kubernetes.io/docs/concepts/storage/volumes/#secret">secret</a> in the <i>Kubernetes documentation</i>.</p>
    pub fn get_secret(&self) -> &::std::option::Option<super::types::EksSecret> {
        &self.secret
    }
    /// <p>Specifies the configuration of a Kubernetes <code>persistentVolumeClaim</code> bounded to a <code>persistentVolume</code>. For more information, see <a href="https://kubernetes.io/docs/concepts/storage/persistent-volumes/#persistentvolumeclaims"> Persistent Volume Claims</a> in the <i>Kubernetes documentation</i>.</p>
    pub fn persistent_volume_claim(mut self, input: super::types::EksPersistentVolumeClaim) -> Self {
        self.persistent_volume_claim = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies the configuration of a Kubernetes <code>persistentVolumeClaim</code> bounded to a <code>persistentVolume</code>. For more information, see <a href="https://kubernetes.io/docs/concepts/storage/persistent-volumes/#persistentvolumeclaims"> Persistent Volume Claims</a> in the <i>Kubernetes documentation</i>.</p>
    pub fn set_persistent_volume_claim(mut self, input: ::std::option::Option<super::types::EksPersistentVolumeClaim>) -> Self {
        self.persistent_volume_claim = input;
        self
    }
    /// <p>Specifies the configuration of a Kubernetes <code>persistentVolumeClaim</code> bounded to a <code>persistentVolume</code>. For more information, see <a href="https://kubernetes.io/docs/concepts/storage/persistent-volumes/#persistentvolumeclaims"> Persistent Volume Claims</a> in the <i>Kubernetes documentation</i>.</p>
    pub fn get_persistent_volume_claim(&self) -> &::std::option::Option<super::types::EksPersistentVolumeClaim> {
