...
impl TaskContainerDependency {
    ...
    pub fn builder() -> super::types::builders::TaskContainerDependencyBuilder {
        super::types::builders::TaskContainerDependencyBuilder::default()
    }
}
...
impl TaskContainerDependencyBuilder {
    ...
    pub fn build(self) -> super::types::TaskContainerDependency {
        super::types::TaskContainerDependency {
