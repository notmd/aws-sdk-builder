...
pub struct ContainerDetail {
    ...
    pub volumes: ::std::option::Option<::std::vec::Vec<super::types::Volume>>,
    ...
    /// </note>
    pub environment: ::std::option::Option<::std::vec::Vec<super::types::KeyValuePair>>,
    ...
    /// </note>
    pub ulimits: ::std::option::Option<::std::vec::Vec<super::types::Ulimit>>,
    ...
    pub network_interfaces: ::std::option::Option<::std::vec::Vec<super::types::NetworkInterface>>,
    ...
    pub resource_requirements: ::std::option::Option<::std::vec::Vec<super::types::ResourceRequirement>>,
    ...
    pub secrets: ::std::option::Option<::std::vec::Vec<super::types::Secret>>,
    ...
    pub network_configuration: ::std::option::Option<super::types::NetworkConfiguration>,
    ...
    pub fargate_platform_configuration: ::std::option::Option<super::types::FargatePlatformConfiguration>,
    ...
    pub runtime_platform: ::std::option::Option<super::types::RuntimePlatform>,
    /// <p>The private repository authentication credentials to use.</p>
    pub repository_credentials: ::std::option::Option<super::types::RepositoryCredentials>,
...
impl ContainerDetail {
    ...
    pub fn volumes(&self) -> &[super::types::Volume] {
    ...
    pub fn environment(&self) -> &[super::types::KeyValuePair] {
    ...
    pub fn mount_points(&self) -> &[super::types::MountPoint] {
    ...
    pub fn ulimits(&self) -> &[super::types::Ulimit] {
    ...
    pub fn network_interfaces(&self) -> &[super::types::NetworkInterface] {
    ...
    pub fn resource_requirements(&self) -> &[super::types::ResourceRequirement] {
    ...
    /// <p>The Amazon ECS container agent running on a container instance must register the logging drivers available on that instance with the <code>ECS_AVAILABLE_LOGGING_DRIVERS</code> environment variable before containers placed on that instance can use these log configuration options. For more information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-agent-config.html">Amazon ECS container agent configuration</a> in the <i>Amazon Elastic Container Service Developer Guide</i>.</p>
    /// </note>
    pub fn log_configuration(&self) -> ::std::option::Option<&super::types::LogConfiguration> {
    ...
    pub fn secrets(&self) -> &[super::types::Secret] {
        self.secrets.as_deref().unwrap_or_default()
    }
    /// <p>The network configuration for jobs that are running on Fargate resources. Jobs that are running on Amazon EC2 resources must not specify this parameter.</p>
    pub fn network_configuration(&self) -> ::std::option::Option<&super::types::NetworkConfiguration> {
        self.network_configuration.as_ref()
    }
    /// <p>The platform configuration for jobs that are running on Fargate resources. Jobs that are running on Amazon EC2 resources must not specify this parameter.</p>
    pub fn fargate_platform_configuration(&self) -> ::std::option::Option<&super::types::FargatePlatformConfiguration> {
    ...
    /// <p>An object that represents the compute environment architecture for Batch jobs on Fargate.</p>
    pub fn runtime_platform(&self) -> ::std::option::Option<&super::types::RuntimePlatform> {
        self.runtime_platform.as_ref()
    }
    /// <p>The private repository authentication credentials to use.</p>
    pub fn repository_credentials(&self) -> ::std::option::Option<&super::types::RepositoryCredentials> {
...
impl ContainerDetail {
    ...
    pub fn builder() -> super::types::builders::ContainerDetailBuilder {
        super::types::builders::ContainerDetailBuilder::default()
    }
}
...
pub struct ContainerDetailBuilder {
    ...
    pub(crate) volumes: ::std::option::Option<::std::vec::Vec<super::types::Volume>>,
    pub(crate) environment: ::std::option::Option<::std::vec::Vec<super::types::KeyValuePair>>,
    pub(crate) mount_points: ::std::option::Option<::std::vec::Vec<super::types::MountPoint>>,
    pub(crate) readonly_root_filesystem: ::std::option::Option<bool>,
    pub(crate) ulimits: ::std::option::Option<::std::vec::Vec<super::types::Ulimit>>,
    ...
    pub(crate) network_interfaces: ::std::option::Option<::std::vec::Vec<super::types::NetworkInterface>>,
    pub(crate) resource_requirements: ::std::option::Option<::std::vec::Vec<super::types::ResourceRequirement>>,
    pub(crate) linux_parameters: ::std::option::Option<super::types::LinuxParameters>,
    pub(crate) log_configuration: ::std::option::Option<super::types::LogConfiguration>,
    pub(crate) secrets: ::std::option::Option<::std::vec::Vec<super::types::Secret>>,
    pub(crate) network_configuration: ::std::option::Option<super::types::NetworkConfiguration>,
    pub(crate) fargate_platform_configuration: ::std::option::Option<super::types::FargatePlatformConfiguration>,
    pub(crate) ephemeral_storage: ::std::option::Option<super::types::EphemeralStorage>,
    pub(crate) runtime_platform: ::std::option::Option<super::types::RuntimePlatform>,
    pub(crate) repository_credentials: ::std::option::Option<super::types::RepositoryCredentials>,
...
impl ContainerDetailBuilder {
    ...
    ///
    /// <p>A list of volumes that are associated with the job.</p>
    pub fn volumes(mut self, input: super::types::Volume) -> Self {
    ...
    /// <p>A list of volumes that are associated with the job.</p>
    pub fn set_volumes(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::Volume>>) -> Self {
        self.volumes = input;
        self
    }
    /// <p>A list of volumes that are associated with the job.</p>
    pub fn get_volumes(&self) -> &::std::option::Option<::std::vec::Vec<super::types::Volume>> {
        &self.volumes
    }
    ...
    /// <p>Environment variables cannot start with "<code>AWS_BATCH</code>". This naming convention is reserved for variables that Batch sets.</p>
    /// </note>
    pub fn environment(mut self, input: super::types::KeyValuePair) -> Self {
    ...
    /// <p>Environment variables cannot start with "<code>AWS_BATCH</code>". This naming convention is reserved for variables that Batch sets.</p>
    /// </note>
    pub fn set_environment(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::KeyValuePair>>) -> Self {
    ...
    /// <p>Environment variables cannot start with "<code>AWS_BATCH</code>". This naming convention is reserved for variables that Batch sets.</p>
    /// </note>
    pub fn get_environment(&self) -> &::std::option::Option<::std::vec::Vec<super::types::KeyValuePair>> {
        &self.environment
    }
    ...
    /// <p>This parameter isn't applicable to jobs that are running on Fargate resources.</p>
    /// </note>
    pub fn ulimits(mut self, input: super::types::Ulimit) -> Self {
    ...
    /// <p>This parameter isn't applicable to jobs that are running on Fargate resources.</p>
    /// </note>
    pub fn set_ulimits(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::Ulimit>>) -> Self {
        self.ulimits = input;
        self
    }
    /// <p>A list of <code>ulimit</code> values to set in the container. This parameter maps to <code>Ulimits</code> in the <a href="https://docs.docker.com/engine/api/latest/#tag/Container/operation/ContainerCreate">Create a container</a> section of the <a href="https://docs.docker.com/engine/api/latest/">Docker Remote API</a> and the <code>--ulimit</code> option to <a href="https://docs.docker.com/engine/reference/run/">docker run</a>.</p><note>
    /// <p>This parameter isn't applicable to jobs that are running on Fargate resources.</p>
    /// </note>
    pub fn get_ulimits(&self) -> &::std::option::Option<::std::vec::Vec<super::types::Ulimit>> {
        &self.ulimits
    }
    /// <p>When this parameter is true, the container is given elevated permissions on the host container instance (similar to the <code>root</code> user). The default value is <code>false</code>.</p><note>
    /// <p>This parameter isn't applicable to jobs that are running on Fargate resources and shouldn't be provided, or specified as <code>false</code>.</p>
    ...
    ///
    /// <p>The network interfaces that are associated with the job.</p>
    pub fn network_interfaces(mut self, input: super::types::NetworkInterface) -> Self {
    ...
    /// <p>The network interfaces that are associated with the job.</p>
    pub fn set_network_interfaces(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::NetworkInterface>>) -> Self {
        self.network_interfaces = input;
        self
    }
    /// <p>The network interfaces that are associated with the job.</p>
    pub fn get_network_interfaces(&self) -> &::std::option::Option<::std::vec::Vec<super::types::NetworkInterface>> {
    ...
    ///
    /// <p>The type and amount of resources to assign to a container. The supported resources include <code>GPU</code>, <code>MEMORY</code>, and <code>VCPU</code>.</p>
    pub fn resource_requirements(mut self, input: super::types::ResourceRequirement) -> Self {
    ...
    /// <p>The type and amount of resources to assign to a container. The supported resources include <code>GPU</code>, <code>MEMORY</code>, and <code>VCPU</code>.</p>
    pub fn set_resource_requirements(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::ResourceRequirement>>) -> Self {
        self.resource_requirements = input;
        self
    }
    /// <p>The type and amount of resources to assign to a container. The supported resources include <code>GPU</code>, <code>MEMORY</code>, and <code>VCPU</code>.</p>
    pub fn get_resource_requirements(&self) -> &::std::option::Option<::std::vec::Vec<super::types::ResourceRequirement>> {
        &self.resource_requirements
    }
    /// <p>Linux-specific modifications that are applied to the container, such as details for device mappings.</p>
    pub fn linux_parameters(mut self, input: super::types::LinuxParameters) -> Self {
        self.linux_parameters = ::std::option::Option::Some(input);
        self
    }
    /// <p>Linux-specific modifications that are applied to the container, such as details for device mappings.</p>
    pub fn set_linux_parameters(mut self, input: ::std::option::Option<super::types::LinuxParameters>) -> Self {
        self.linux_parameters = input;
        self
    }
    /// <p>Linux-specific modifications that are applied to the container, such as details for device mappings.</p>
    pub fn get_linux_parameters(&self) -> &::std::option::Option<super::types::LinuxParameters> {
    ...
    /// <p>The Amazon ECS container agent running on a container instance must register the logging drivers available on that instance with the <code>ECS_AVAILABLE_LOGGING_DRIVERS</code> environment variable before containers placed on that instance can use these log configuration options. For more information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-agent-config.html">Amazon ECS container agent configuration</a> in the <i>Amazon Elastic Container Service Developer Guide</i>.</p>
    /// </note>
    pub fn log_configuration(mut self, input: super::types::LogConfiguration) -> Self {
    ...
    /// <p>The Amazon ECS container agent running on a container instance must register the logging drivers available on that instance with the <code>ECS_AVAILABLE_LOGGING_DRIVERS</code> environment variable before containers placed on that instance can use these log configuration options. For more information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-agent-config.html">Amazon ECS container agent configuration</a> in the <i>Amazon Elastic Container Service Developer Guide</i>.</p>
    /// </note>
    pub fn set_log_configuration(mut self, input: ::std::option::Option<super::types::LogConfiguration>) -> Self {
    ...
    /// <p>The Amazon ECS container agent running on a container instance must register the logging drivers available on that instance with the <code>ECS_AVAILABLE_LOGGING_DRIVERS</code> environment variable before containers placed on that instance can use these log configuration options. For more information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-agent-config.html">Amazon ECS container agent configuration</a> in the <i>Amazon Elastic Container Service Developer Guide</i>.</p>
    /// </note>
    pub fn get_log_configuration(&self) -> &::std::option::Option<super::types::LogConfiguration> {
    ...
    ///
    /// <p>The secrets to pass to the container. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/specifying-sensitive-data.html">Specifying sensitive data</a> in the <i>Batch User Guide</i>.</p>
    pub fn secrets(mut self, input: super::types::Secret) -> Self {
    ...
    /// <p>The secrets to pass to the container. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/specifying-sensitive-data.html">Specifying sensitive data</a> in the <i>Batch User Guide</i>.</p>
    pub fn set_secrets(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::Secret>>) -> Self {
        self.secrets = input;
        self
    }
    /// <p>The secrets to pass to the container. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/specifying-sensitive-data.html">Specifying sensitive data</a> in the <i>Batch User Guide</i>.</p>
    pub fn get_secrets(&self) -> &::std::option::Option<::std::vec::Vec<super::types::Secret>> {
        &self.secrets
    }
    /// <p>The network configuration for jobs that are running on Fargate resources. Jobs that are running on Amazon EC2 resources must not specify this parameter.</p>
    pub fn network_configuration(mut self, input: super::types::NetworkConfiguration) -> Self {
        self.network_configuration = ::std::option::Option::Some(input);
        self
    }
    /// <p>The network configuration for jobs that are running on Fargate resources. Jobs that are running on Amazon EC2 resources must not specify this parameter.</p>
    pub fn set_network_configuration(mut self, input: ::std::option::Option<super::types::NetworkConfiguration>) -> Self {
        self.network_configuration = input;
        self
    }
    /// <p>The network configuration for jobs that are running on Fargate resources. Jobs that are running on Amazon EC2 resources must not specify this parameter.</p>
    pub fn get_network_configuration(&self) -> &::std::option::Option<super::types::NetworkConfiguration> {
        &self.network_configuration
    }
    /// <p>The platform configuration for jobs that are running on Fargate resources. Jobs that are running on Amazon EC2 resources must not specify this parameter.</p>
    pub fn fargate_platform_configuration(mut self, input: super::types::FargatePlatformConfiguration) -> Self {
        self.fargate_platform_configuration = ::std::option::Option::Some(input);
        self
    }
    /// <p>The platform configuration for jobs that are running on Fargate resources. Jobs that are running on Amazon EC2 resources must not specify this parameter.</p>
    pub fn set_fargate_platform_configuration(mut self, input: ::std::option::Option<super::types::FargatePlatformConfiguration>) -> Self {
        self.fargate_platform_configuration = input;
        self
    }
    /// <p>The platform configuration for jobs that are running on Fargate resources. Jobs that are running on Amazon EC2 resources must not specify this parameter.</p>
    pub fn get_fargate_platform_configuration(&self) -> &::std::option::Option<super::types::FargatePlatformConfiguration> {
    ...
    /// <p>An object that represents the compute environment architecture for Batch jobs on Fargate.</p>
    pub fn runtime_platform(mut self, input: super::types::RuntimePlatform) -> Self {
        self.runtime_platform = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object that represents the compute environment architecture for Batch jobs on Fargate.</p>
    pub fn set_runtime_platform(mut self, input: ::std::option::Option<super::types::RuntimePlatform>) -> Self {
        self.runtime_platform = input;
        self
    }
    /// <p>An object that represents the compute environment architecture for Batch jobs on Fargate.</p>
    pub fn get_runtime_platform(&self) -> &::std::option::Option<super::types::RuntimePlatform> {
        &self.runtime_platform
    }
    /// <p>The private repository authentication credentials to use.</p>
    pub fn repository_credentials(mut self, input: super::types::RepositoryCredentials) -> Self {
        self.repository_credentials = ::std::option::Option::Some(input);
        self
    }
    /// <p>The private repository authentication credentials to use.</p>
    pub fn set_repository_credentials(mut self, input: ::std::option::Option<super::types::RepositoryCredentials>) -> Self {
        self.repository_credentials = input;
        self
    }
    /// <p>The private repository authentication credentials to use.</p>
    pub fn get_repository_credentials(&self) -> &::std::option::Option<super::types::RepositoryCredentials> {
    ...
    pub fn build(self) -> super::types::ContainerDetail {
        super::types::ContainerDetail {
            image: self.image,
            vcpus: self.vcpus,
            memory: self.memory,
