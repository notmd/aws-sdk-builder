...
pub struct TaskContainerDetails {
    ...
    pub depends_on: ::std::option::Option<::std::vec::Vec<super::types::TaskContainerDependency>>,
...
impl TaskContainerDetails {
    ...
    pub fn depends_on(&self) -> &[super::types::TaskContainerDependency] {
    ...
    /// <p>The FireLens configuration for the container. This is used to specify and configure a log router for container logs. For more information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/using_firelens.html">Custom log</a> routing in the <i>Amazon Elastic Container Service Developer Guide</i>.</p>
    pub fn firelens_configuration(&self) -> ::std::option::Option<&super::types::FirelensConfiguration> {
...
impl TaskContainerDetails {
    ...
    pub fn builder() -> super::types::builders::TaskContainerDetailsBuilder {
        super::types::builders::TaskContainerDetailsBuilder::default()
    }
}
...
pub struct TaskContainerDetailsBuilder {
    ...
    pub(crate) depends_on: ::std::option::Option<::std::vec::Vec<super::types::TaskContainerDependency>>,
    pub(crate) environment: ::std::option::Option<::std::vec::Vec<super::types::KeyValuePair>>,
    pub(crate) essential: ::std::option::Option<bool>,
    pub(crate) firelens_configuration: ::std::option::Option<super::types::FirelensConfiguration>,
...
impl TaskContainerDetailsBuilder {
    ...
    ///
    /// <p>A list of containers that this container depends on.</p>
    pub fn depends_on(mut self, input: super::types::TaskContainerDependency) -> Self {
    ...
    /// <p>A list of containers that this container depends on.</p>
    pub fn set_depends_on(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::TaskContainerDependency>>) -> Self {
        self.depends_on = input;
        self
    }
    /// <p>A list of containers that this container depends on.</p>
    pub fn get_depends_on(&self) -> &::std::option::Option<::std::vec::Vec<super::types::TaskContainerDependency>> {
        &self.depends_on
    }
    ...
    /// <p>The FireLens configuration for the container. This is used to specify and configure a log router for container logs. For more information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/using_firelens.html">Custom log</a> routing in the <i>Amazon Elastic Container Service Developer Guide</i>.</p>
    pub fn firelens_configuration(mut self, input: super::types::FirelensConfiguration) -> Self {
        self.firelens_configuration = ::std::option::Option::Some(input);
        self
    }
    /// <p>The FireLens configuration for the container. This is used to specify and configure a log router for container logs. For more information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/using_firelens.html">Custom log</a> routing in the <i>Amazon Elastic Container Service Developer Guide</i>.</p>
    pub fn set_firelens_configuration(mut self, input: ::std::option::Option<super::types::FirelensConfiguration>) -> Self {
        self.firelens_configuration = input;
        self
    }
    /// <p>The FireLens configuration for the container. This is used to specify and configure a log router for container logs. For more information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/using_firelens.html">Custom log</a> routing in the <i>Amazon Elastic Container Service Developer Guide</i>.</p>
    pub fn get_firelens_configuration(&self) -> &::std::option::Option<super::types::FirelensConfiguration> {
    ...
    pub fn build(self) -> super::types::TaskContainerDetails {
        super::types::TaskContainerDetails {
