...
impl QuotaShareDetail {
    ...
    pub fn builder() -> super::types::builders::QuotaShareDetailBuilder {
        super::types::builders::QuotaShareDetailBuilder::default()
    }
}
...
impl QuotaShareDetailBuilder {
    ...
    pub fn build(self) -> super::types::QuotaShareDetail {
        super::types::QuotaShareDetail {
