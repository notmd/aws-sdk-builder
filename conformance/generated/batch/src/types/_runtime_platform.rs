...
impl RuntimePlatform {
    ...
    pub fn builder() -> super::types::builders::RuntimePlatformBuilder {
        super::types::builders::RuntimePlatformBuilder::default()
    }
}
...
impl RuntimePlatformBuilder {
    ...
    pub fn build(self) -> super::types::RuntimePlatform {
        super::types::RuntimePlatform {
