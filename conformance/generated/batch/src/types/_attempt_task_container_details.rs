...
impl AttemptTaskContainerDetails {
    ...
    pub fn builder() -> super::types::builders::AttemptTaskContainerDetailsBuilder {
        super::types::builders::AttemptTaskContainerDetailsBuilder::default()
    }
}
...
impl AttemptTaskContainerDetailsBuilder {
    ...
    pub fn build(self) -> super::types::AttemptTaskContainerDetails {
        super::types::AttemptTaskContainerDetails {
