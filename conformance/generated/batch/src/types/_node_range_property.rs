...
impl NodeRangeProperty {
    ...
    pub fn builder() -> super::types::builders::NodeRangePropertyBuilder {
        super::types::builders::NodeRangePropertyBuilder::default()
    }
}
...
pub struct NodeRangePropertyBuilder {
    ...
    pub(crate) container: ::std::option::Option<super::types::ContainerProperties>,
...
impl NodeRangePropertyBuilder {
    ...
    /// <p>The container details for the node range.</p>
    pub fn container(mut self, input: super::types::ContainerProperties) -> Self {
        self.container = ::std::option::Option::Some(input);
        self
    }
    /// <p>The container details for the node range.</p>
    pub fn set_container(mut self, input: ::std::option::Option<super::types::ContainerProperties>) -> Self {
        self.container = input;
        self
    }
    /// <p>The container details for the node range.</p>
    pub fn get_container(&self) -> &::std::option::Option<super::types::ContainerProperties> {
        &self.container
    }
