...
pub struct QuotaShareCapacityUtilization {
    ...
    pub capacity_usage: ::std::option::Option<::std::vec::Vec<super::types::QuotaShareCapacityUsage>>,
}
impl QuotaShareCapacityUtilization {
    ...
    pub fn capacity_usage(&self) -> &[super::types::QuotaShareCapacityUsage] {
...
impl QuotaShareCapacityUtilization {
    ...
    pub fn builder() -> super::types::builders::QuotaShareCapacityUtilizationBuilder {
        super::types::builders::QuotaShareCapacityUtilizationBuilder::default()
    }
}
...
pub struct QuotaShareCapacityUtilizationBuilder {
    ...
    pub(crate) capacity_usage: ::std::option::Option<::std::vec::Vec<super::types::QuotaShareCapacityUsage>>,
}
impl QuotaShareCapacityUtilizationBuilder {
    ...
    ///
    /// <p>The capacity usage information for this quota share, including the units of compute capacity and quantity being used.</p>
    pub fn capacity_usage(mut self, input: super::types::QuotaShareCapacityUsage) -> Self {
    ...
    /// <p>The capacity usage information for this quota share, including the units of compute capacity and quantity being used.</p>
    pub fn set_capacity_usage(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::QuotaShareCapacityUsage>>) -> Self {
        self.capacity_usage = input;
        self
    }
    /// <p>The capacity usage information for this quota share, including the units of compute capacity and quantity being used.</p>
    pub fn get_capacity_usage(&self) -> &::std::option::Option<::std::vec::Vec<super::types::QuotaShareCapacityUsage>> {
        &self.capacity_usage
    }
    /// Consumes the builder and constructs a [`QuotaShareCapacityUtilization`](crate::types::QuotaShareCapacityUtilization).
    pub fn build(self) -> super::types::QuotaShareCapacityUtilization {
        super::types::QuotaShareCapacityUtilization {
