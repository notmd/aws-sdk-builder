...
impl CapacityLimit {
    ...
    pub fn builder() -> super::types::builders::CapacityLimitBuilder {
        super::types::builders::CapacityLimitBuilder::default()
    }
}
...
impl CapacityLimitBuilder {
    ...
    pub fn build(self) -> super::types::CapacityLimit {
        super::types::CapacityLimit {
