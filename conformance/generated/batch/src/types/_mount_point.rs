...
impl MountPoint {
    ...
    pub fn builder() -> super::types::builders::MountPointBuilder {
        super::types::builders::MountPointBuilder::default()
    }
}
...
impl MountPointBuilder {
    ...
    pub fn build(self) -> super::types::MountPoint {
        super::types::MountPoint {
