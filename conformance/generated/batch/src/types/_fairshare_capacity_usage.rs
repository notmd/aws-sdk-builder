...
impl FairshareCapacityUsage {
    ...
    pub fn builder() -> super::types::builders::FairshareCapacityUsageBuilder {
        super::types::builders::FairshareCapacityUsageBuilder::default()
    }
}
...
impl FairshareCapacityUsageBuilder {
    ...
    pub fn build(self) -> super::types::FairshareCapacityUsage {
        super::types::FairshareCapacityUsage {
