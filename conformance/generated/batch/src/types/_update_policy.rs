...
impl UpdatePolicy {
    ...
    pub fn builder() -> super::types::builders::UpdatePolicyBuilder {
        super::types::builders::UpdatePolicyBuilder::default()
    }
}
...
impl UpdatePolicyBuilder {
    ...
    pub fn build(self) -> super::types::UpdatePolicy {
        super::types::UpdatePolicy {
