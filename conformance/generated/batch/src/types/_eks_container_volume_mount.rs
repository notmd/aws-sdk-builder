...
impl EksContainerVolumeMount {
    ...
    pub fn builder() -> super::types::builders::EksContainerVolumeMountBuilder {
        super::types::builders::EksContainerVolumeMountBuilder::default()
    }
}
...
impl EksContainerVolumeMountBuilder {
    ...
    pub fn build(self) -> super::types::EksContainerVolumeMount {
        super::types::EksContainerVolumeMount {
            name: self.name,
