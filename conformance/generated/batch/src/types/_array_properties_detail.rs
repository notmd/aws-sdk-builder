...
impl ArrayPropertiesDetail {
    ...
    pub fn builder() -> super::types::builders::ArrayPropertiesDetailBuilder {
        super::types::builders::ArrayPropertiesDetailBuilder::default()
    }
}
...
impl ArrayPropertiesDetailBuilder {
    ...
    pub fn build(self) -> super::types::ArrayPropertiesDetail {
        super::types::ArrayPropertiesDetail {
