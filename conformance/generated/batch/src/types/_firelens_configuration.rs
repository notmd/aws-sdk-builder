...
impl FirelensConfiguration {
    ...
    pub fn builder() -> super::types::builders::FirelensConfigurationBuilder {
        super::types::builders::FirelensConfigurationBuilder::default()
    }
}
...
pub struct FirelensConfigurationBuilder {
    pub(crate) r#type: ::std::option::Option<super::types::FirelensConfigurationType>,
...
impl FirelensConfigurationBuilder {
    ...
    pub fn r#type(mut self, input: super::types::FirelensConfigurationType) -> Self {
        self.r#type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The log router to use. The valid values are <code>fluentd</code> or <code>fluentbit</code>.</p>
    pub fn set_type(mut self, input: ::std::option::Option<super::types::FirelensConfigurationType>) -> Self {
        self.r#type = input;
        self
    }
    /// <p>The log router to use. The valid values are <code>fluentd</code> or <code>fluentbit</code>.</p>
    pub fn get_type(&self) -> &::std::option::Option<super::types::FirelensConfigurationType> {
        &self.r#type
    }
