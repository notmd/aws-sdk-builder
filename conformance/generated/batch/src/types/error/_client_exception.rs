...
impl ::aws_types::request_id::RequestId for super::types::error::ClientException {
...
impl ClientException {
    ...
    pub fn builder() -> super::types::error::builders::ClientExceptionBuilder {
        super::types::error::builders::ClientExceptionBuilder::default()
    }
}
...
impl ClientExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::ClientException {
        super::types::error::ClientException {
