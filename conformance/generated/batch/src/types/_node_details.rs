...
impl NodeDetails {
    ...
    pub fn builder() -> super::types::builders::NodeDetailsBuilder {
        super::types::builders::NodeDetailsBuilder::default()
    }
}
...
impl NodeDetailsBuilder {
    ...
    pub fn build(self) -> super::types::NodeDetails {
        super::types::NodeDetails {
