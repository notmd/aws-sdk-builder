...
impl QuotaShareCapacityUsage {
    ...
    pub fn builder() -> super::types::builders::QuotaShareCapacityUsageBuilder {
        super::types::builders::QuotaShareCapacityUsageBuilder::default()
    }
}
...
impl QuotaShareCapacityUsageBuilder {
    ...
    pub fn build(self) -> super::types::QuotaShareCapacityUsage {
        super::types::QuotaShareCapacityUsage {
