...
impl ManagedInstancesNetworkConfiguration {
    ...
    pub fn builder() -> super::types::builders::ManagedInstancesNetworkConfigurationBuilder {
        super::types::builders::ManagedInstancesNetworkConfigurationBuilder::default()
    }
}
