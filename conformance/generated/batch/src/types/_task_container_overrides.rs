...
impl TaskContainerOverrides {
    ...
    pub fn builder() -> super::types::builders::TaskContainerOverridesBuilder {
        super::types::builders::TaskContainerOverridesBuilder::default()
    }
}
...
impl TaskContainerOverridesBuilder {
    ...
    pub fn build(self) -> super::types::TaskContainerOverrides {
        super::types::TaskContainerOverrides {
