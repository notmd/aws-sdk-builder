...
impl NodePropertiesSummary {
    ...
    pub fn builder() -> super::types::builders::NodePropertiesSummaryBuilder {
        super::types::builders::NodePropertiesSummaryBuilder::default()
    }
}
...
impl NodePropertiesSummaryBuilder {
    ...
    pub fn build(self) -> super::types::NodePropertiesSummary {
        super::types::NodePropertiesSummary {
