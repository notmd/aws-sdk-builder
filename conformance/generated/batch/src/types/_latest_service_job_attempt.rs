...
impl LatestServiceJobAttempt {
    ...
    pub fn builder() -> super::types::builders::LatestServiceJobAttemptBuilder {
        super::types::builders::LatestServiceJobAttemptBuilder::default()
    }
}
...
impl LatestServiceJobAttemptBuilder {
    ...
    pub fn build(self) -> super::types::LatestServiceJobAttempt {
        super::types::LatestServiceJobAttempt {
