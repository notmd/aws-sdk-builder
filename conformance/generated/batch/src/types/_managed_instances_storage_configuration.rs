...
impl ManagedInstancesStorageConfiguration {
    ...
    pub fn builder() -> super::types::builders::ManagedInstancesStorageConfigurationBuilder {
        super::types::builders::ManagedInstancesStorageConfigurationBuilder::default()
    }
}
