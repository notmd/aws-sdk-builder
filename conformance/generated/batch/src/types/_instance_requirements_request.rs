...
impl InstanceRequirementsRequest {
    ...
    pub fn builder() -> super::types::builders::InstanceRequirementsRequestBuilder {
        super::types::builders::InstanceRequirementsRequestBuilder::default()
    }
}
...
impl InstanceRequirementsRequestBuilder {
    ...
    pub fn build(self) -> super::types::InstanceRequirementsRequest {
        super::types::InstanceRequirementsRequest {
