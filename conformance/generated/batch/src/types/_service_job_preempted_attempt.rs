...
pub struct ServiceJobPreemptedAttempt {
    ...
    pub service_resource_id: ::std::option::Option<super::types::ServiceResourceId>,
...
impl ServiceJobPreemptedAttempt {
    /// <p>The service resource identifier associated with the service job attempt.</p>
    pub fn service_resource_id(&self) -> ::std::option::Option<&super::types::ServiceResourceId> {
...
impl ServiceJobPreemptedAttempt {
    ...
    pub fn builder() -> super::types::builders::ServiceJobPreemptedAttemptBuilder {
        super::types::builders::ServiceJobPreemptedAttemptBuilder::default()
    }
}
...
pub struct ServiceJobPreemptedAttemptBuilder {
    pub(crate) service_resource_id: ::std::option::Option<super::types::ServiceResourceId>,
...
impl ServiceJobPreemptedAttemptBuilder {
    /// <p>The service resource identifier associated with the service job attempt.</p>
    pub fn service_resource_id(mut self, input: super::types::ServiceResourceId) -> Self {
        self.service_resource_id = ::std::option::Option::Some(input);
        self
    }
    /// <p>The service resource identifier associated with the service job attempt.</p>
    pub fn set_service_resource_id(mut self, input: ::std::option::Option<super::types::ServiceResourceId>) -> Self {
        self.service_resource_id = input;
        self
    }
    /// <p>The service resource identifier associated with the service job attempt.</p>
    pub fn get_service_resource_id(&self) -> &::std::option::Option<super::types::ServiceResourceId> {
    ...
    pub fn build(self) -> super::types::ServiceJobPreemptedAttempt {
        super::types::ServiceJobPreemptedAttempt {
