...
impl KeyValuePair {
    ...
    pub fn builder() -> super::types::builders::KeyValuePairBuilder {
        super::types::builders::KeyValuePairBuilder::default()
    }
}
...
impl KeyValuePairBuilder {
    ...
    pub fn build(self) -> super::types::KeyValuePair {
        super::types::KeyValuePair {
            name: self.name,
            value: self.value,
        }
    }
