...
pub struct RetryStrategy {
    ...
    pub evaluate_on_exit: ::std::option::Option<::std::vec::Vec<super::types::EvaluateOnExit>>,
}
impl RetryStrategy {
    /// <p>The number of times to move a job to the <code>RUNNABLE</code> status. You can specify between 1 and 10 attempts. If the value of <code>attempts</code> is greater than one, the job is retried on failure the same number of attempts as the value.</p>
    ...
    pub fn evaluate_on_exit(&self) -> &[super::types::EvaluateOnExit] {
...
impl RetryStrategy {
    ...
    pub fn builder() -> super::types::builders::RetryStrategyBuilder {
        super::types::builders::RetryStrategyBuilder::default()
    }
}
...
pub struct RetryStrategyBuilder {
    ...
    pub(crate) evaluate_on_exit: ::std::option::Option<::std::vec::Vec<super::types::EvaluateOnExit>>,
}
impl RetryStrategyBuilder {
    ...
    ///
    /// <p>Array of up to 5 objects that specify the conditions where jobs are retried or failed. If this parameter is specified, then the <code>attempts</code> parameter must also be specified. If none of the listed conditions match, then the job is retried.</p>
    pub fn evaluate_on_exit(mut self, input: super::types::EvaluateOnExit) -> Self {
    ...
    /// <p>Array of up to 5 objects that specify the conditions where jobs are retried or failed. If this parameter is specified, then the <code>attempts</code> parameter must also be specified. If none of the listed conditions match, then the job is retried.</p>
    pub fn set_evaluate_on_exit(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::EvaluateOnExit>>) -> Self {
        self.evaluate_on_exit = input;
        self
    }
    /// <p>Array of up to 5 objects that specify the conditions where jobs are retried or failed. If this parameter is specified, then the <code>attempts</code> parameter must also be specified. If none of the listed conditions match, then the job is retried.</p>
    pub fn get_evaluate_on_exit(&self) -> &::std::option::Option<::std::vec::Vec<super::types::EvaluateOnExit>> {
        &self.evaluate_on_exit
    }
    /// Consumes the builder and constructs a [`RetryStrategy`](crate::types::RetryStrategy).
    pub fn build(self) -> super::types::RetryStrategy {
        super::types::RetryStrategy {
