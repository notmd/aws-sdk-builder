...
impl NetworkInterface {
    ...
    pub fn builder() -> super::types::builders::NetworkInterfaceBuilder {
        super::types::builders::NetworkInterfaceBuilder::default()
    }
}
...
impl NetworkInterfaceBuilder {
    ...
    pub fn build(self) -> super::types::NetworkInterface {
        super::types::NetworkInterface {
