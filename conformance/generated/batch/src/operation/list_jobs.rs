    ...
    > {
        let map_err =
            |err: ::aws_smithy_runtime_api::client::result::SdkError<
                ...
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >| { err.map_service_error(|err| err.downcast::<super::operation::list_jobs::ListJobsError>().expect("correct error type")) };
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_jobs::ListJobsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListJobsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_jobs::de_list_jobs_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_jobs::de_list_jobs_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListJobsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::list_jobs::ListJobsInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_jobs::ListJobsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_list_jobs::ser_list_jobs_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::list_jobs::ListJobsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_jobs::_list_jobs_input::ListJobsInput;

pub use super::operation::list_jobs::_list_jobs_output::ListJobsOutput;
