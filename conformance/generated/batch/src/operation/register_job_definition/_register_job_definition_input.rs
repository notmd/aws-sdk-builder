...
pub struct RegisterJobDefinitionInput {
    ...
    /// </note>
    pub r#type: ::std::option::Option<super::types::JobDefinitionType>,
    ...
    /// </note>
    pub container_properties: ::std::option::Option<super::types::ContainerProperties>,
    ...
    pub eks_properties: ::std::option::Option<super::types::EksProperties>,
    ...
    pub ecs_properties: ::std::option::Option<super::types::EcsProperties>,
...
impl RegisterJobDefinitionInput {
    ...
    /// <p>If the job is run on Fargate resources, then <code>multinode</code> isn't supported.</p>
    /// </note>
    pub fn r#type(&self) -> ::std::option::Option<&super::types::JobDefinitionType> {
        self.r#type.as_ref()
    }
    /// <p>Default parameter substitution placeholders to set in the job definition. Parameters are specified as a key-value pair mapping. Parameters in a <code>SubmitJob</code> request override any corresponding parameter defaults from the job definition.</p>
    ...
    /// <p>If the job runs on Fargate resources, then you must not specify <code>nodeProperties</code>; use only <code>containerProperties</code>.</p>
    /// </note>
    pub fn container_properties(&self) -> ::std::option::Option<&super::types::ContainerProperties> {
    ...
    /// <p>An object with properties that are specific to Amazon EKS-based jobs. This must not be specified for Amazon ECS based job definitions.</p>
    pub fn eks_properties(&self) -> ::std::option::Option<&super::types::EksProperties> {
        self.eks_properties.as_ref()
    }
    /// <p>An object with properties that are specific to Amazon ECS-based jobs. This must not be specified for Amazon EKS-based job definitions.</p>
    pub fn ecs_properties(&self) -> ::std::option::Option<&super::types::EcsProperties> {
...
impl RegisterJobDefinitionInput {
    ...
    pub fn builder() -> super::operation::register_job_definition::builders::RegisterJobDefinitionInputBuilder {
        super::operation::register_job_definition::builders::RegisterJobDefinitionInputBuilder::default()
    }
}
...
pub struct RegisterJobDefinitionInputBuilder {
    ...
    pub(crate) r#type: ::std::option::Option<super::types::JobDefinitionType>,
    pub(crate) parameters: ::std::option::Option<::std::collections::HashMap<::std::string::String, ::std::string::String>>,
    pub(crate) scheduling_priority: ::std::option::Option<i32>,
    pub(crate) container_properties: ::std::option::Option<super::types::ContainerProperties>,
    ...
    pub(crate) eks_properties: ::std::option::Option<super::types::EksProperties>,
    pub(crate) ecs_properties: ::std::option::Option<super::types::EcsProperties>,
...
impl RegisterJobDefinitionInputBuilder {
    ...
    /// </note>
    /// This field is required.
    pub fn r#type(mut self, input: super::types::JobDefinitionType) -> Self {
    ...
    /// <p>If the job is run on Fargate resources, then <code>multinode</code> isn't supported.</p>
    /// </note>
    pub fn set_type(mut self, input: ::std::option::Option<super::types::JobDefinitionType>) -> Self {
        self.r#type = input;
        self
    }
    /// <p>The type of job definition. For more information about multi-node parallel jobs, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/multi-node-job-def.html">Creating a multi-node parallel job definition</a> in the <i>Batch User Guide</i>.</p>
    ...
    /// <p>If the job is run on Fargate resources, then <code>multinode</code> isn't supported.</p>
    /// </note>
    pub fn get_type(&self) -> &::std::option::Option<super::types::JobDefinitionType> {
        &self.r#type
    }
    ...
    /// <p>If the job runs on Fargate resources, then you must not specify <code>nodeProperties</code>; use only <code>containerProperties</code>.</p>
    /// </note>
    pub fn container_properties(mut self, input: super::types::ContainerProperties) -> Self {
    ...
    /// <p>If the job runs on Fargate resources, then you must not specify <code>nodeProperties</code>; use only <code>containerProperties</code>.</p>
    /// </note>
    pub fn set_container_properties(mut self, input: ::std::option::Option<super::types::ContainerProperties>) -> Self {
    ...
    /// <p>If the job runs on Fargate resources, then you must not specify <code>nodeProperties</code>; use only <code>containerProperties</code>.</p>
    /// </note>
    pub fn get_container_properties(&self) -> &::std::option::Option<super::types::ContainerProperties> {
    ...
    /// <p>An object with properties that are specific to Amazon EKS-based jobs. This must not be specified for Amazon ECS based job definitions.</p>
    pub fn eks_properties(mut self, input: super::types::EksProperties) -> Self {
        self.eks_properties = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object with properties that are specific to Amazon EKS-based jobs. This must not be specified for Amazon ECS based job definitions.</p>
    pub fn set_eks_properties(mut self, input: ::std::option::Option<super::types::EksProperties>) -> Self {
        self.eks_properties = input;
        self
    }
    /// <p>An object with properties that are specific to Amazon EKS-based jobs. This must not be specified for Amazon ECS based job definitions.</p>
    pub fn get_eks_properties(&self) -> &::std::option::Option<super::types::EksProperties> {
        &self.eks_properties
    }
    /// <p>An object with properties that are specific to Amazon ECS-based jobs. This must not be specified for Amazon EKS-based job definitions.</p>
    pub fn ecs_properties(mut self, input: super::types::EcsProperties) -> Self {
        self.ecs_properties = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object with properties that are specific to Amazon ECS-based jobs. This must not be specified for Amazon EKS-based job definitions.</p>
    pub fn set_ecs_properties(mut self, input: ::std::option::Option<super::types::EcsProperties>) -> Self {
        self.ecs_properties = input;
        self
    }
    /// <p>An object with properties that are specific to Amazon ECS-based jobs. This must not be specified for Amazon EKS-based job definitions.</p>
    pub fn get_ecs_properties(&self) -> &::std::option::Option<super::types::EcsProperties> {
        &self.ecs_properties
    }
    /// <p>Contains a list of consumable resources required by the job.</p>
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::register_job_definition::RegisterJobDefinitionInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::register_job_definition::RegisterJobDefinitionInput {
