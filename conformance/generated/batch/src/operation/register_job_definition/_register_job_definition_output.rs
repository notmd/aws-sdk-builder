...
impl RegisterJobDefinitionOutput {
    ...
    pub fn builder() -> super::operation::register_job_definition::builders::RegisterJobDefinitionOutputBuilder {
        super::operation::register_job_definition::builders::RegisterJobDefinitionOutputBuilder::default()
    }
}
