...
impl UpdateJobQueueOutput {
    ...
    pub fn builder() -> super::operation::update_job_queue::builders::UpdateJobQueueOutputBuilder {
        super::operation::update_job_queue::builders::UpdateJobQueueOutputBuilder::default()
    }
}
...
impl UpdateJobQueueOutputBuilder {
    ...
    pub fn build(self) -> super::operation::update_job_queue::UpdateJobQueueOutput {
