...
impl UpdateJobQueueInput {
    ...
    pub fn builder() -> super::operation::update_job_queue::builders::UpdateJobQueueInputBuilder {
        super::operation::update_job_queue::builders::UpdateJobQueueInputBuilder::default()
    }
}
...
impl UpdateJobQueueInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::update_job_queue::UpdateJobQueueInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::update_job_queue::UpdateJobQueueInput {
