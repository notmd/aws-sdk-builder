...
impl DeleteQuotaShareInput {
    ...
    pub fn builder() -> super::operation::delete_quota_share::builders::DeleteQuotaShareInputBuilder {
        super::operation::delete_quota_share::builders::DeleteQuotaShareInputBuilder::default()
    }
}
...
impl DeleteQuotaShareInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::delete_quota_share::DeleteQuotaShareInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::delete_quota_share::DeleteQuotaShareInput {
