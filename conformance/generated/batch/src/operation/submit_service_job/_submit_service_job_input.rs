...
impl SubmitServiceJobInput {
    ...
    pub fn builder() -> super::operation::submit_service_job::builders::SubmitServiceJobInputBuilder {
        super::operation::submit_service_job::builders::SubmitServiceJobInputBuilder::default()
    }
}
...
impl SubmitServiceJobInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::submit_service_job::SubmitServiceJobInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::submit_service_job::SubmitServiceJobInput {
