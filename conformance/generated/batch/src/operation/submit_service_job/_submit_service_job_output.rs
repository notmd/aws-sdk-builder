...
impl SubmitServiceJobOutput {
    ...
    pub fn builder() -> super::operation::submit_service_job::builders::SubmitServiceJobOutputBuilder {
        super::operation::submit_service_job::builders::SubmitServiceJobOutputBuilder::default()
    }
}
