...
impl ListQuotaSharesInput {
    ...
    pub fn builder() -> super::operation::list_quota_shares::builders::ListQuotaSharesInputBuilder {
        super::operation::list_quota_shares::builders::ListQuotaSharesInputBuilder::default()
    }
}
...
impl ListQuotaSharesInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_quota_shares::ListQuotaSharesInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_quota_shares::ListQuotaSharesInput {
