...
impl DeregisterJobDefinitionInput {
    ...
    pub fn builder() -> super::operation::deregister_job_definition::builders::DeregisterJobDefinitionInputBuilder {
        super::operation::deregister_job_definition::builders::DeregisterJobDefinitionInputBuilder::default()
    }
}
...
impl DeregisterJobDefinitionInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::deregister_job_definition::DeregisterJobDefinitionInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::deregister_job_definition::DeregisterJobDefinitionInput {
