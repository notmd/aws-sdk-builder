...
pub struct UpdateComputeEnvironmentInput {
    ...
    pub compute_resources: ::std::option::Option<super::types::ComputeResourceUpdate>,
...
impl UpdateComputeEnvironmentInput {
    ...
    /// <p>Details of the compute resources managed by the compute environment. Required for a managed compute environment. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/compute_environments.html">Compute Environments</a> in the <i>Batch User Guide</i>.</p>
    pub fn compute_resources(&self) -> ::std::option::Option<&super::types::ComputeResourceUpdate> {
...
impl UpdateComputeEnvironmentInput {
    ...
    pub fn builder() -> super::operation::update_compute_environment::builders::UpdateComputeEnvironmentInputBuilder {
        super::operation::update_compute_environment::builders::UpdateComputeEnvironmentInputBuilder::default()
    }
}
...
pub struct UpdateComputeEnvironmentInputBuilder {
    ...
    pub(crate) compute_resources: ::std::option::Option<super::types::ComputeResourceUpdate>,
...
impl UpdateComputeEnvironmentInputBuilder {
    ...
    /// <p>Details of the compute resources managed by the compute environment. Required for a managed compute environment. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/compute_environments.html">Compute Environments</a> in the <i>Batch User Guide</i>.</p>
    pub fn compute_resources(mut self, input: super::types::ComputeResourceUpdate) -> Self {
        self.compute_resources = ::std::option::Option::Some(input);
        self
    }
    /// <p>Details of the compute resources managed by the compute environment. Required for a managed compute environment. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/compute_environments.html">Compute Environments</a> in the <i>Batch User Guide</i>.</p>
    pub fn set_compute_resources(mut self, input: ::std::option::Option<super::types::ComputeResourceUpdate>) -> Self {
        self.compute_resources = input;
        self
    }
    /// <p>Details of the compute resources managed by the compute environment. Required for a managed compute environment. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/compute_environments.html">Compute Environments</a> in the <i>Batch User Guide</i>.</p>
    pub fn get_compute_resources(&self) -> &::std::option::Option<super::types::ComputeResourceUpdate> {
    ...
    pub fn build(
        ...
        super::operation::update_compute_environment::UpdateComputeEnvironmentInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::update_compute_environment::UpdateComputeEnvironmentInput {
