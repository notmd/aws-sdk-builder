...
impl UpdateComputeEnvironmentOutput {
    ...
    pub fn builder() -> super::operation::update_compute_environment::builders::UpdateComputeEnvironmentOutputBuilder {
        super::operation::update_compute_environment::builders::UpdateComputeEnvironmentOutputBuilder::default()
    }
}
...
impl UpdateComputeEnvironmentOutputBuilder {
    ...
    pub fn build(self) -> super::operation::update_compute_environment::UpdateComputeEnvironmentOutput {
