...
impl UpdateSchedulingPolicyOutput {
    ...
    pub fn builder() -> super::operation::update_scheduling_policy::builders::UpdateSchedulingPolicyOutputBuilder {
        super::operation::update_scheduling_policy::builders::UpdateSchedulingPolicyOutputBuilder::default()
    }
}
...
impl UpdateSchedulingPolicyOutputBuilder {
    ...
    pub fn build(self) -> super::operation::update_scheduling_policy::UpdateSchedulingPolicyOutput {
