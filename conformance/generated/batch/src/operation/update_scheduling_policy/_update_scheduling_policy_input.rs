...
pub struct UpdateSchedulingPolicyInput {
    ...
    pub fairshare_policy: ::std::option::Option<super::types::FairsharePolicy>,
}
impl UpdateSchedulingPolicyInput {
    ...
    /// <p>The fair-share policy scheduling details. Once set during creation, a fairsharePolicy cannot be removed or changed to a quotaSharePolicy.</p>
    pub fn fairshare_policy(&self) -> ::std::option::Option<&super::types::FairsharePolicy> {
...
impl UpdateSchedulingPolicyInput {
    ...
    pub fn builder() -> super::operation::update_scheduling_policy::builders::UpdateSchedulingPolicyInputBuilder {
        super::operation::update_scheduling_policy::builders::UpdateSchedulingPolicyInputBuilder::default()
    }
}
...
pub struct UpdateSchedulingPolicyInputBuilder {
    ...
    pub(crate) quota_share_policy: ::std::option::Option<super::types::QuotaSharePolicy>,
    pub(crate) fairshare_policy: ::std::option::Option<super::types::FairsharePolicy>,
}
impl UpdateSchedulingPolicyInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::update_scheduling_policy::UpdateSchedulingPolicyInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::update_scheduling_policy::UpdateSchedulingPolicyInput {
            arn: self.arn,
