...
impl TerminateJobInput {
    ...
    pub fn builder() -> super::operation::terminate_job::builders::TerminateJobInputBuilder {
        super::operation::terminate_job::builders::TerminateJobInputBuilder::default()
    }
}
...
impl TerminateJobInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::terminate_job::TerminateJobInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::terminate_job::TerminateJobInput {
            job_id: self.job_id,
            reason: self.reason,
        })
    }
