...
impl ListJobsInput {
    ...
    pub fn builder() -> super::operation::list_jobs::builders::ListJobsInputBuilder {
        super::operation::list_jobs::builders::ListJobsInputBuilder::default()
    }
}
...
impl ListJobsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::list_jobs::ListJobsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_jobs::ListJobsInput {
