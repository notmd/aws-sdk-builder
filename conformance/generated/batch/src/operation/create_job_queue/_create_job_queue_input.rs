...
impl CreateJobQueueInput {
    ...
    pub fn builder() -> super::operation::create_job_queue::builders::CreateJobQueueInputBuilder {
        super::operation::create_job_queue::builders::CreateJobQueueInputBuilder::default()
    }
}
...
impl CreateJobQueueInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::create_job_queue::CreateJobQueueInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::create_job_queue::CreateJobQueueInput {
