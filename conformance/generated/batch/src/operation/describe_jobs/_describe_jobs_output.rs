...
pub struct DescribeJobsOutput {
    ...
    pub jobs: ::std::option::Option<::std::vec::Vec<super::types::JobDetail>>,
...
impl DescribeJobsOutput {
    ...
    pub fn jobs(&self) -> &[super::types::JobDetail] {
...
impl DescribeJobsOutput {
    ...
    pub fn builder() -> super::operation::describe_jobs::builders::DescribeJobsOutputBuilder {
        super::operation::describe_jobs::builders::DescribeJobsOutputBuilder::default()
    }
}
...
pub struct DescribeJobsOutputBuilder {
    pub(crate) jobs: ::std::option::Option<::std::vec::Vec<super::types::JobDetail>>,
    _request_id: Option<String>,
}
impl DescribeJobsOutputBuilder {
    ...
    ///
    /// <p>The list of jobs.</p>
    pub fn jobs(mut self, input: super::types::JobDetail) -> Self {
    ...
    /// <p>The list of jobs.</p>
    pub fn set_jobs(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::JobDetail>>) -> Self {
        self.jobs = input;
        self
    }
    /// <p>The list of jobs.</p>
    pub fn get_jobs(&self) -> &::std::option::Option<::std::vec::Vec<super::types::JobDetail>> {
        &self.jobs
    }
    ...
    pub fn build(self) -> super::operation::describe_jobs::DescribeJobsOutput {
