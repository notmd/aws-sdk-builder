...
impl DescribeJobsInput {
    ...
    pub fn builder() -> super::operation::describe_jobs::builders::DescribeJobsInputBuilder {
        super::operation::describe_jobs::builders::DescribeJobsInputBuilder::default()
    }
}
...
impl DescribeJobsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::describe_jobs::DescribeJobsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::describe_jobs::DescribeJobsInput { jobs: self.jobs })
    }
}
