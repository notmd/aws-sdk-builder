...
impl CreateComputeEnvironmentOutput {
    ...
    pub fn builder() -> super::operation::create_compute_environment::builders::CreateComputeEnvironmentOutputBuilder {
        super::operation::create_compute_environment::builders::CreateComputeEnvironmentOutputBuilder::default()
    }
}
...
impl CreateComputeEnvironmentOutputBuilder {
    ...
    pub fn build(self) -> super::operation::create_compute_environment::CreateComputeEnvironmentOutput {
