...
impl DescribeQuotaShareInput {
    ...
    pub fn builder() -> super::operation::describe_quota_share::builders::DescribeQuotaShareInputBuilder {
        super::operation::describe_quota_share::builders::DescribeQuotaShareInputBuilder::default()
    }
}
...
impl DescribeQuotaShareInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::describe_quota_share::DescribeQuotaShareInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::describe_quota_share::DescribeQuotaShareInput {
