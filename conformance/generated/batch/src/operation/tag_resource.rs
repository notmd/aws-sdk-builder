    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::tag_resource::TagResourceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::tag_resource::TagResourceOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for TagResourceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_tag_resource::de_tag_resource_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_tag_resource::de_tag_resource_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for TagResourceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::tag_resource::TagResourceInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::tag_resource::TagResourceInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_tag_resource::ser_tag_resource_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::tag_resource::TagResourceError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::tag_resource::_tag_resource_input::TagResourceInput;

pub use super::operation::tag_resource::_tag_resource_output::TagResourceOutput;
