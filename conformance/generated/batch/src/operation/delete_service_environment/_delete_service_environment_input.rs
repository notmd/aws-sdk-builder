...
impl DeleteServiceEnvironmentInput {
    ...
    pub fn builder() -> super::operation::delete_service_environment::builders::DeleteServiceEnvironmentInputBuilder {
        super::operation::delete_service_environment::builders::DeleteServiceEnvironmentInputBuilder::default()
    }
}
...
impl DeleteServiceEnvironmentInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::delete_service_environment::DeleteServiceEnvironmentInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::delete_service_environment::DeleteServiceEnvironmentInput {
