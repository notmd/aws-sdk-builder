...
impl DeleteConsumableResourceInput {
    ...
    pub fn builder() -> super::operation::delete_consumable_resource::builders::DeleteConsumableResourceInputBuilder {
        super::operation::delete_consumable_resource::builders::DeleteConsumableResourceInputBuilder::default()
    }
}
...
impl DeleteConsumableResourceInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::delete_consumable_resource::DeleteConsumableResourceInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::delete_consumable_resource::DeleteConsumableResourceInput {
