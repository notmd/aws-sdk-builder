...
pub struct ListSchedulingPoliciesPaginator {
    ...
    builder: super::operation::list_scheduling_policies::builders::ListSchedulingPoliciesInputBuilder,
...
impl ListSchedulingPoliciesPaginator {
    ...
    pub fn items(self) -> super::operation::list_scheduling_policies::paginator::ListSchedulingPoliciesPaginatorItems {
        super::operation::list_scheduling_policies::paginator::ListSchedulingPoliciesPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            super::operation::list_scheduling_policies::ListSchedulingPolicies::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_list_scheduling_policies_output_output_next_token(resp);
...
impl ListSchedulingPoliciesPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::types::SchedulingPolicyListingDetail,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::operation::list_scheduling_policies::ListSchedulingPoliciesError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::lens::lens_list_scheduling_policies_output_output_scheduling_policies(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
