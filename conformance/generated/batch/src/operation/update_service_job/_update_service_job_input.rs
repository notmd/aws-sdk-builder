...
impl UpdateServiceJobInput {
    ...
    pub fn builder() -> super::operation::update_service_job::builders::UpdateServiceJobInputBuilder {
        super::operation::update_service_job::builders::UpdateServiceJobInputBuilder::default()
    }
}
...
impl UpdateServiceJobInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::update_service_job::UpdateServiceJobInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::update_service_job::UpdateServiceJobInput {
            job_id: self.job_id,
