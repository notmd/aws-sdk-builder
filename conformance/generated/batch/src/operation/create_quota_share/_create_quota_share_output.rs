...
impl CreateQuotaShareOutput {
    ...
    pub fn builder() -> super::operation::create_quota_share::builders::CreateQuotaShareOutputBuilder {
        super::operation::create_quota_share::builders::CreateQuotaShareOutputBuilder::default()
    }
}
...
impl CreateQuotaShareOutputBuilder {
    ...
    pub fn build(self) -> super::operation::create_quota_share::CreateQuotaShareOutput {
