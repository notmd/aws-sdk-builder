...
impl CreateQuotaShareInput {
    ...
    pub fn builder() -> super::operation::create_quota_share::builders::CreateQuotaShareInputBuilder {
        super::operation::create_quota_share::builders::CreateQuotaShareInputBuilder::default()
    }
}
...
impl CreateQuotaShareInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::create_quota_share::CreateQuotaShareInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::create_quota_share::CreateQuotaShareInput {
