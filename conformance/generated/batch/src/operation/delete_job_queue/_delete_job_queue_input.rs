...
impl DeleteJobQueueInput {
    ...
    pub fn builder() -> super::operation::delete_job_queue::builders::DeleteJobQueueInputBuilder {
        super::operation::delete_job_queue::builders::DeleteJobQueueInputBuilder::default()
    }
}
...
impl DeleteJobQueueInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::delete_job_queue::DeleteJobQueueInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::delete_job_queue::DeleteJobQueueInput { job_queue: self.job_queue })
    }
}
