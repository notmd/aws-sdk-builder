...
impl DeleteComputeEnvironmentInput {
    ...
    pub fn builder() -> super::operation::delete_compute_environment::builders::DeleteComputeEnvironmentInputBuilder {
        super::operation::delete_compute_environment::builders::DeleteComputeEnvironmentInputBuilder::default()
    }
}
...
impl DeleteComputeEnvironmentInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::delete_compute_environment::DeleteComputeEnvironmentInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::delete_compute_environment::DeleteComputeEnvironmentInput {
