...
impl ListJobsByConsumableResourceOutput {
    ...
    pub fn builder() -> super::operation::list_jobs_by_consumable_resource::builders::ListJobsByConsumableResourceOutputBuilder {
        super::operation::list_jobs_by_consumable_resource::builders::ListJobsByConsumableResourceOutputBuilder::default()
    }
}
...
pub struct ListJobsByConsumableResourceOutputBuilder {
    pub(crate) jobs: ::std::option::Option<::std::vec::Vec<super::types::ListJobsByConsumableResourceSummary>>,
...
impl ListJobsByConsumableResourceOutputBuilder {
    ...
    ///
    /// <p>The list of jobs that require the specified consumable resources.</p>
    pub fn jobs(mut self, input: super::types::ListJobsByConsumableResourceSummary) -> Self {
    ...
    /// <p>The list of jobs that require the specified consumable resources.</p>
    pub fn set_jobs(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::ListJobsByConsumableResourceSummary>>) -> Self {
        self.jobs = input;
        self
    }
    /// <p>The list of jobs that require the specified consumable resources.</p>
    pub fn get_jobs(&self) -> &::std::option::Option<::std::vec::Vec<super::types::ListJobsByConsumableResourceSummary>> {
        &self.jobs
    }
    /// <p>The <code>nextToken</code> value to include in a future <code>ListJobsByConsumableResource</code> request. When the results of a <code>ListJobsByConsumableResource</code> request exceed <code>maxResults</code>, this value can be used to retrieve the next page of results. This value is <code>null</code> when there are no more results to return.</p>
