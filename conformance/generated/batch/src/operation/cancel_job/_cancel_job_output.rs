...
impl CancelJobOutput {
    ...
    pub fn builder() -> super::operation::cancel_job::builders::CancelJobOutputBuilder {
        super::operation::cancel_job::builders::CancelJobOutputBuilder::default()
    }
}
...
impl CancelJobOutputBuilder {
    ...
    pub fn build(self) -> super::operation::cancel_job::CancelJobOutput {
