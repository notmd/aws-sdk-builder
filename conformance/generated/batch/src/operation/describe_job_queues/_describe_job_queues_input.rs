...
impl DescribeJobQueuesInput {
    ...
    pub fn builder() -> super::operation::describe_job_queues::builders::DescribeJobQueuesInputBuilder {
        super::operation::describe_job_queues::builders::DescribeJobQueuesInputBuilder::default()
    }
}
...
impl DescribeJobQueuesInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::describe_job_queues::DescribeJobQueuesInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::describe_job_queues::DescribeJobQueuesInput {
