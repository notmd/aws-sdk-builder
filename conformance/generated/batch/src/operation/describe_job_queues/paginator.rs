...
pub struct DescribeJobQueuesPaginator {
    ...
    builder: super::operation::describe_job_queues::builders::DescribeJobQueuesInputBuilder,
...
impl DescribeJobQueuesPaginator {
    ...
    pub fn items(self) -> super::operation::describe_job_queues::paginator::DescribeJobQueuesPaginatorItems {
        super::operation::describe_job_queues::paginator::DescribeJobQueuesPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::operation::describe_job_queues::DescribeJobQueues::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_describe_job_queues_output_output_next_token(resp);
...
impl DescribeJobQueuesPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::lens::lens_describe_job_queues_output_output_job_queues(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
