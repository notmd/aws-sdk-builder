...
impl DescribeConsumableResourceOutput {
    ...
    pub fn builder() -> super::operation::describe_consumable_resource::builders::DescribeConsumableResourceOutputBuilder {
        super::operation::describe_consumable_resource::builders::DescribeConsumableResourceOutputBuilder::default()
    }
}
