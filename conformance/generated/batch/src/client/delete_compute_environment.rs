...
impl super::Client {
    ...
    pub fn delete_compute_environment(&self) -> super::operation::delete_compute_environment::builders::DeleteComputeEnvironmentFluentBuilder {
        super::operation::delete_compute_environment::builders::DeleteComputeEnvironmentFluentBuilder::new(self.handle.clone())
    }
}
