...
impl super::Client {
    ...
    pub fn describe_quota_share(&self) -> super::operation::describe_quota_share::builders::DescribeQuotaShareFluentBuilder {
        super::operation::describe_quota_share::builders::DescribeQuotaShareFluentBuilder::new(self.handle.clone())
    }
}
