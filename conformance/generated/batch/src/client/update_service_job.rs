...
impl super::Client {
    ...
    pub fn update_service_job(&self) -> super::operation::update_service_job::builders::UpdateServiceJobFluentBuilder {
        super::operation::update_service_job::builders::UpdateServiceJobFluentBuilder::new(self.handle.clone())
    }
}
