...
impl super::Client {
    ...
    pub fn delete_service_environment(&self) -> super::operation::delete_service_environment::builders::DeleteServiceEnvironmentFluentBuilder {
        super::operation::delete_service_environment::builders::DeleteServiceEnvironmentFluentBuilder::new(self.handle.clone())
    }
}
