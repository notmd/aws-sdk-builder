...
impl super::Client {
    ...
    pub fn terminate_service_job(&self) -> super::operation::terminate_service_job::builders::TerminateServiceJobFluentBuilder {
        super::operation::terminate_service_job::builders::TerminateServiceJobFluentBuilder::new(self.handle.clone())
    }
}
