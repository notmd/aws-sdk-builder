...
impl super::Client {
    ...
    pub fn describe_service_job(&self) -> super::operation::describe_service_job::builders::DescribeServiceJobFluentBuilder {
        super::operation::describe_service_job::builders::DescribeServiceJobFluentBuilder::new(self.handle.clone())
    }
}
