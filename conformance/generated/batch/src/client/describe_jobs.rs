...
impl super::Client {
    ...
    pub fn describe_jobs(&self) -> super::operation::describe_jobs::builders::DescribeJobsFluentBuilder {
        super::operation::describe_jobs::builders::DescribeJobsFluentBuilder::new(self.handle.clone())
    }
}
