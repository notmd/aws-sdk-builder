...
impl super::Client {
    ...
    pub fn delete_consumable_resource(&self) -> super::operation::delete_consumable_resource::builders::DeleteConsumableResourceFluentBuilder {
        super::operation::delete_consumable_resource::builders::DeleteConsumableResourceFluentBuilder::new(self.handle.clone())
    }
}
