...
impl super::Client {
    ...
    pub fn delete_quota_share(&self) -> super::operation::delete_quota_share::builders::DeleteQuotaShareFluentBuilder {
        super::operation::delete_quota_share::builders::DeleteQuotaShareFluentBuilder::new(self.handle.clone())
    }
}
