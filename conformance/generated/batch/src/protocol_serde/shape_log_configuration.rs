...
pub(crate) fn de_log_configuration<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::types::LogConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::types::builders::LogConfigurationBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "logDriver" => {
                            builder = builder.set_log_driver(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| super::types::LogDriver::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "options" => {
                            builder = builder.set_options(
                                super::protocol_serde::shape_log_configuration_options_map::de_log_configuration_options_map(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "secretOptions" => {
                            builder =
                                builder.set_secret_options(super::protocol_serde::shape_secret_list::de_secret_list(tokens, _value, depth + 1)?);
                        }
