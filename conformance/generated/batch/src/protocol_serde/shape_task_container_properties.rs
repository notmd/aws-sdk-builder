...
pub fn ser_task_container_properties(
    ...
    input: &super::types::TaskContainerProperties,
        ...
        for item_6 in var_4 {
            {
                ...
                super::protocol_serde::shape_task_container_dependency::ser_task_container_dependency(&mut object_7, item_6)?;
                object_7.finish();
            }
        }
        array_5.finish();
        ...
        for item_10 in var_8 {
            {
                ...
                super::protocol_serde::shape_key_value_pair::ser_key_value_pair(&mut object_11, item_10)?;
                object_11.finish();
            }
        }
        array_9.finish();
...
pub(crate) fn de_task_container_properties<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::types::TaskContainerProperties>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::types::builders::TaskContainerPropertiesBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "dependsOn" => {
                            builder = builder.set_depends_on(
                                super::protocol_serde::shape_task_container_dependency_list::de_task_container_dependency_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "firelensConfiguration" => {
                            builder = builder.set_firelens_configuration(
                                super::protocol_serde::shape_firelens_configuration::de_firelens_configuration(tokens, _value, depth + 1)?,
                            );
                        }
                        "image" => {
