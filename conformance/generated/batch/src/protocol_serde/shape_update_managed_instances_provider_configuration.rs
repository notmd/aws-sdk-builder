...
pub fn ser_update_managed_instances_provider_configuration(
    ...
    input: &super::types::UpdateManagedInstancesProviderConfiguration,
    ...
    if let Some(var_3) = &input.instance_launch_template {
        ...
        super::protocol_serde::shape_instance_launch_template_update::ser_instance_launch_template_update(&mut object_4, var_3)?;
        object_4.finish();
    }
