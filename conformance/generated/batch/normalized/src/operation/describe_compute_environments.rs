    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::describe_compute_environments::DescribeComputeEnvironmentsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::describe_compute_environments::DescribeComputeEnvironmentsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeComputeEnvironmentsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_describe_compute_environments::de_describe_compute_environments_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_describe_compute_environments::de_describe_compute_environments_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeComputeEnvironmentsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::describe_compute_environments::DescribeComputeEnvironmentsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::describe_compute_environments::DescribeComputeEnvironmentsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_describe_compute_environments::ser_describe_compute_environments_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::super::operation::describe_compute_environments::DescribeComputeEnvironmentsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::describe_compute_environments::_describe_compute_environments_input::DescribeComputeEnvironmentsInput;

pub use super::super::operation::describe_compute_environments::_describe_compute_environments_output::DescribeComputeEnvironmentsOutput;
