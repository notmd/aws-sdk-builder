...
impl DescribeConsumableResourceOutput {
    ...
    pub fn builder() -> super::super::super::operation::describe_consumable_resource::builders::DescribeConsumableResourceOutputBuilder {
        super::super::super::operation::describe_consumable_resource::builders::DescribeConsumableResourceOutputBuilder::default()
    }
}
