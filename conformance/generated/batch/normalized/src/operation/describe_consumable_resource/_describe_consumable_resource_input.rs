...
impl DescribeConsumableResourceInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_consumable_resource::builders::DescribeConsumableResourceInputBuilder {
        super::super::super::operation::describe_consumable_resource::builders::DescribeConsumableResourceInputBuilder::default()
    }
}
