...
impl UpdateSchedulingPolicyOutput {
    ...
    pub fn builder() -> super::super::super::operation::update_scheduling_policy::builders::UpdateSchedulingPolicyOutputBuilder {
        super::super::super::operation::update_scheduling_policy::builders::UpdateSchedulingPolicyOutputBuilder::default()
    }
}
...
impl UpdateSchedulingPolicyOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::update_scheduling_policy::UpdateSchedulingPolicyOutput {
