...
impl UpdateServiceJobInput {
    ...
    pub fn builder() -> super::super::super::operation::update_service_job::builders::UpdateServiceJobInputBuilder {
        super::super::super::operation::update_service_job::builders::UpdateServiceJobInputBuilder::default()
    }
}
