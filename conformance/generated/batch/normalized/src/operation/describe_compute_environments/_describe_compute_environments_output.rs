...
pub struct DescribeComputeEnvironmentsOutput {
    ...
    pub compute_environments: ::std::option::Option<::std::vec::Vec<super::super::super::types::ComputeEnvironmentDetail>>,
...
impl DescribeComputeEnvironmentsOutput {
    ...
    pub fn compute_environments(&self) -> &[super::super::super::types::ComputeEnvironmentDetail] {
...
impl DescribeComputeEnvironmentsOutput {
    ...
    pub fn builder() -> super::super::super::operation::describe_compute_environments::builders::DescribeComputeEnvironmentsOutputBuilder {
        super::super::super::operation::describe_compute_environments::builders::DescribeComputeEnvironmentsOutputBuilder::default()
    }
}
...
pub struct DescribeComputeEnvironmentsOutputBuilder {
    pub(crate) compute_environments: ::std::option::Option<::std::vec::Vec<super::super::super::types::ComputeEnvironmentDetail>>,
...
impl DescribeComputeEnvironmentsOutputBuilder {
    ...
    ///
    /// <p>The list of compute environments.</p>
    pub fn compute_environments(mut self, input: super::super::super::types::ComputeEnvironmentDetail) -> Self {
    ...
    /// <p>The list of compute environments.</p>
    pub fn get_compute_environments(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::ComputeEnvironmentDetail>> {
    ...
    pub fn build(self) -> super::super::super::operation::describe_compute_environments::DescribeComputeEnvironmentsOutput {
