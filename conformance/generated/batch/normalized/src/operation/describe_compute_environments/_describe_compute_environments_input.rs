...
impl DescribeComputeEnvironmentsInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_compute_environments::builders::DescribeComputeEnvironmentsInputBuilder {
        super::super::super::operation::describe_compute_environments::builders::DescribeComputeEnvironmentsInputBuilder::default()
    }
}
