...
impl ListServiceJobsOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_service_jobs::builders::ListServiceJobsOutputBuilder {
        super::super::super::operation::list_service_jobs::builders::ListServiceJobsOutputBuilder::default()
    }
}
...
pub struct ListServiceJobsOutputBuilder {
    pub(crate) job_summary_list: ::std::option::Option<::std::vec::Vec<super::super::super::types::ServiceJobSummary>>,
...
impl ListServiceJobsOutputBuilder {
    ...
    ///
    /// <p>A list of service job summaries.</p>
    pub fn job_summary_list(mut self, input: super::super::super::types::ServiceJobSummary) -> Self {
    ...
    /// <p>A list of service job summaries.</p>
    pub fn set_job_summary_list(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::ServiceJobSummary>>) -> Self {
        self.job_summary_list = input;
        self
    }
    /// <p>A list of service job summaries.</p>
    pub fn get_job_summary_list(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::ServiceJobSummary>> {
