...
pub use super::super::super::operation::list_service_jobs::_list_service_jobs_input::ListServiceJobsInputBuilder;

pub use super::super::super::operation::list_service_jobs::_list_service_jobs_output::ListServiceJobsOutputBuilder;

impl super::super::super::operation::list_service_jobs::builders::ListServiceJobsInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::list_service_jobs::ListServiceJobsError,
...
pub struct ListServiceJobsFluentBuilder {
    ...
    inner: super::super::super::operation::list_service_jobs::builders::ListServiceJobsInputBuilder,
...
impl ListServiceJobsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::list_service_jobs::builders::ListServiceJobsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::list_service_jobs::ListServiceJobs::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::list_service_jobs::ListServiceJobs::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::super::super::operation::list_service_jobs::paginator::ListServiceJobsPaginator {
        super::super::super::operation::list_service_jobs::paginator::ListServiceJobsPaginator::new(self.handle, self.inner)
    }
    ...
    /// </note>
    pub fn job_status(mut self, input: super::super::super::types::ServiceJobStatus) -> Self {
    ...
    /// <p>The <code>SHARE_IDENTIFIER</code> filter or <code>QUOTA_SHARE_NAME</code> filter can be used with the <code>jobStatus</code> field to filter results.</p>
    /// </note>
    pub fn set_job_status(mut self, input: ::std::option::Option<super::super::super::types::ServiceJobStatus>) -> Self {
    ...
    /// <p>The <code>SHARE_IDENTIFIER</code> filter or <code>QUOTA_SHARE_NAME</code> filter can be used with the <code>jobStatus</code> field to filter results.</p>
    /// </note>
    pub fn get_job_status(&self) -> &::std::option::Option<super::super::super::types::ServiceJobStatus> {
    ...
    ///
    /// <p>The filter to apply to the query. Only one filter can be used at a time. When the filter is used, <code>jobStatus</code> is ignored with the exception that <code>SHARE_IDENTIFIER</code> or <code>QUOTA_SHARE_NAME</code> and <code>jobStatus</code> can be used together. The results are sorted by the <code>createdAt</code> field, with the most recent jobs being first.</p><note>
    ...
    /// </dd>
    /// </dl>
    pub fn filters(mut self, input: super::super::super::types::KeyValuesPair) -> Self {
    ...
    /// </dd>
    /// </dl>
    pub fn set_filters(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::KeyValuesPair>>) -> Self {
    ...
    /// </dd>
    /// </dl>
    pub fn get_filters(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::KeyValuesPair>> {
