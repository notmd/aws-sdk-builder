...
impl UpdateConsumableResourceInput {
    ...
    pub fn builder() -> super::super::super::operation::update_consumable_resource::builders::UpdateConsumableResourceInputBuilder {
        super::super::super::operation::update_consumable_resource::builders::UpdateConsumableResourceInputBuilder::default()
    }
}
