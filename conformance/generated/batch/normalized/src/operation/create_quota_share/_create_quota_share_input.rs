...
impl CreateQuotaShareInput {
    ...
    pub fn builder() -> super::super::super::operation::create_quota_share::builders::CreateQuotaShareInputBuilder {
        super::super::super::operation::create_quota_share::builders::CreateQuotaShareInputBuilder::default()
    }
}
