...
impl CreateComputeEnvironmentOutput {
    ...
    pub fn builder() -> super::super::super::operation::create_compute_environment::builders::CreateComputeEnvironmentOutputBuilder {
        super::super::super::operation::create_compute_environment::builders::CreateComputeEnvironmentOutputBuilder::default()
    }
}
...
impl CreateComputeEnvironmentOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::create_compute_environment::CreateComputeEnvironmentOutput {
