...
impl DeregisterJobDefinitionInput {
    ...
    pub fn builder() -> super::super::super::operation::deregister_job_definition::builders::DeregisterJobDefinitionInputBuilder {
        super::super::super::operation::deregister_job_definition::builders::DeregisterJobDefinitionInputBuilder::default()
    }
}
...
impl DeregisterJobDefinitionInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::deregister_job_definition::DeregisterJobDefinitionInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::deregister_job_definition::DeregisterJobDefinitionInput {
