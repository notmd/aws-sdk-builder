...
impl DeregisterJobDefinitionOutput {
    ...
    pub fn builder() -> super::super::super::operation::deregister_job_definition::builders::DeregisterJobDefinitionOutputBuilder {
        super::super::super::operation::deregister_job_definition::builders::DeregisterJobDefinitionOutputBuilder::default()
    }
}
...
impl DeregisterJobDefinitionOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::deregister_job_definition::DeregisterJobDefinitionOutput {
