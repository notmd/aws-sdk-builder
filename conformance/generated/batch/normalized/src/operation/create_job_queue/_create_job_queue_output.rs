...
impl CreateJobQueueOutput {
    ...
    pub fn builder() -> super::super::super::operation::create_job_queue::builders::CreateJobQueueOutputBuilder {
        super::super::super::operation::create_job_queue::builders::CreateJobQueueOutputBuilder::default()
    }
}
