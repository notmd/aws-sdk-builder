...
impl CreateSchedulingPolicyOutput {
    ...
    pub fn builder() -> super::super::super::operation::create_scheduling_policy::builders::CreateSchedulingPolicyOutputBuilder {
        super::super::super::operation::create_scheduling_policy::builders::CreateSchedulingPolicyOutputBuilder::default()
    }
}
