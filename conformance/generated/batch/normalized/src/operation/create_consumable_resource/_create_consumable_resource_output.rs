...
impl CreateConsumableResourceOutput {
    ...
    pub fn builder() -> super::super::super::operation::create_consumable_resource::builders::CreateConsumableResourceOutputBuilder {
        super::super::super::operation::create_consumable_resource::builders::CreateConsumableResourceOutputBuilder::default()
    }
}
