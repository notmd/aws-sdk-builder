...
impl CreateConsumableResourceInput {
    ...
    pub fn builder() -> super::super::super::operation::create_consumable_resource::builders::CreateConsumableResourceInputBuilder {
        super::super::super::operation::create_consumable_resource::builders::CreateConsumableResourceInputBuilder::default()
    }
}
