...
impl UpdateQuotaShareInput {
    ...
    pub fn builder() -> super::super::super::operation::update_quota_share::builders::UpdateQuotaShareInputBuilder {
        super::super::super::operation::update_quota_share::builders::UpdateQuotaShareInputBuilder::default()
    }
}
