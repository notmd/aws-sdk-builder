...
impl UpdateQuotaShareOutput {
    ...
    pub fn builder() -> super::super::super::operation::update_quota_share::builders::UpdateQuotaShareOutputBuilder {
        super::super::super::operation::update_quota_share::builders::UpdateQuotaShareOutputBuilder::default()
    }
}
...
impl UpdateQuotaShareOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::update_quota_share::UpdateQuotaShareOutput {
