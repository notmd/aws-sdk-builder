...
impl DeleteJobQueueInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_job_queue::builders::DeleteJobQueueInputBuilder {
        super::super::super::operation::delete_job_queue::builders::DeleteJobQueueInputBuilder::default()
    }
}
