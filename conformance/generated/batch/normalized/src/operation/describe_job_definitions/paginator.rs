...
pub struct DescribeJobDefinitionsPaginator {
    ...
    builder: super::super::super::operation::describe_job_definitions::builders::DescribeJobDefinitionsInputBuilder,
...
impl DescribeJobDefinitionsPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::describe_job_definitions::paginator::DescribeJobDefinitionsPaginatorItems {
        super::super::super::operation::describe_job_definitions::paginator::DescribeJobDefinitionsPaginatorItems(self)
    }
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_describe_job_definitions_output_output_next_token(resp);
...
impl DescribeJobDefinitionsPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::JobDefinition,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::describe_job_definitions::DescribeJobDefinitionsError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_describe_job_definitions_output_output_job_definitions(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
