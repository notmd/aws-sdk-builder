...
impl DescribeServiceEnvironmentsInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_service_environments::builders::DescribeServiceEnvironmentsInputBuilder {
        super::super::super::operation::describe_service_environments::builders::DescribeServiceEnvironmentsInputBuilder::default()
    }
}
