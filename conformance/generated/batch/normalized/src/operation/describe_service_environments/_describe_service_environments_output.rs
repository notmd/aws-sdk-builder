...
pub struct DescribeServiceEnvironmentsOutput {
    ...
    pub service_environments: ::std::option::Option<::std::vec::Vec<super::super::super::types::ServiceEnvironmentDetail>>,
...
impl DescribeServiceEnvironmentsOutput {
    ...
    pub fn service_environments(&self) -> &[super::super::super::types::ServiceEnvironmentDetail] {
...
impl DescribeServiceEnvironmentsOutput {
    ...
    pub fn builder() -> super::super::super::operation::describe_service_environments::builders::DescribeServiceEnvironmentsOutputBuilder {
        super::super::super::operation::describe_service_environments::builders::DescribeServiceEnvironmentsOutputBuilder::default()
    }
}
...
pub struct DescribeServiceEnvironmentsOutputBuilder {
    pub(crate) service_environments: ::std::option::Option<::std::vec::Vec<super::super::super::types::ServiceEnvironmentDetail>>,
...
impl DescribeServiceEnvironmentsOutputBuilder {
    ...
    ///
    /// <p>The list of service environments that match the request.</p>
    pub fn service_environments(mut self, input: super::super::super::types::ServiceEnvironmentDetail) -> Self {
    ...
    /// <p>The list of service environments that match the request.</p>
    pub fn get_service_environments(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::ServiceEnvironmentDetail>> {
    ...
    pub fn build(self) -> super::super::super::operation::describe_service_environments::DescribeServiceEnvironmentsOutput {
