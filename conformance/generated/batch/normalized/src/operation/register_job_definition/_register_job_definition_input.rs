...
pub struct RegisterJobDefinitionInput {
    ...
    /// </note>
    pub r#type: ::std::option::Option<super::super::super::types::JobDefinitionType>,
    ...
    /// </note>
    pub container_properties: ::std::option::Option<super::super::super::types::ContainerProperties>,
    ...
    /// </note>
    pub node_properties: ::std::option::Option<super::super::super::types::NodeProperties>,
    ...
    /// </note>
    pub platform_capabilities: ::std::option::Option<::std::vec::Vec<super::super::super::types::PlatformCapability>>,
    ...
    pub eks_properties: ::std::option::Option<super::super::super::types::EksProperties>,
    ...
    pub ecs_properties: ::std::option::Option<super::super::super::types::EcsProperties>,
    /// <p>Contains a list of consumable resources required by the job.</p>
    pub consumable_resource_properties: ::std::option::Option<super::super::super::types::ConsumableResourceProperties>,
}
impl RegisterJobDefinitionInput {
    ...
    /// <p>If the job is run on Fargate resources, then <code>multinode</code> isn't supported.</p>
    /// </note>
    pub fn r#type(&self) -> ::std::option::Option<&super::super::super::types::JobDefinitionType> {
        self.r#type.as_ref()
    }
    /// <p>Default parameter substitution placeholders to set in the job definition. Parameters are specified as a key-value pair mapping. Parameters in a <code>SubmitJob</code> request override any corresponding parameter defaults from the job definition.</p>
    ...
    /// <p>If the job runs on Fargate resources, then you must not specify <code>nodeProperties</code>; use only <code>containerProperties</code>.</p>
    /// </note>
    pub fn container_properties(&self) -> ::std::option::Option<&super::super::super::types::ContainerProperties> {
    ...
    /// <p>If the job runs on Amazon EKS resources, then you must not specify <code>nodeProperties</code>.</p>
    /// </note>
    pub fn node_properties(&self) -> ::std::option::Option<&super::super::super::types::NodeProperties> {
    ...
    pub fn platform_capabilities(&self) -> &[super::super::super::types::PlatformCapability] {
        self.platform_capabilities.as_deref().unwrap_or_default()
    }
    /// <p>An object with properties that are specific to Amazon EKS-based jobs. This must not be specified for Amazon ECS based job definitions.</p>
    pub fn eks_properties(&self) -> ::std::option::Option<&super::super::super::types::EksProperties> {
        self.eks_properties.as_ref()
    }
    /// <p>An object with properties that are specific to Amazon ECS-based jobs. This must not be specified for Amazon EKS-based job definitions.</p>
    pub fn ecs_properties(&self) -> ::std::option::Option<&super::super::super::types::EcsProperties> {
        self.ecs_properties.as_ref()
    }
    /// <p>Contains a list of consumable resources required by the job.</p>
    pub fn consumable_resource_properties(&self) -> ::std::option::Option<&super::super::super::types::ConsumableResourceProperties> {
...
impl RegisterJobDefinitionInput {
    ...
    pub fn builder() -> super::super::super::operation::register_job_definition::builders::RegisterJobDefinitionInputBuilder {
        super::super::super::operation::register_job_definition::builders::RegisterJobDefinitionInputBuilder::default()
    }
}
...
pub struct RegisterJobDefinitionInputBuilder {
    ...
    pub(crate) r#type: ::std::option::Option<super::super::super::types::JobDefinitionType>,
    pub(crate) parameters: ::std::option::Option<::std::collections::HashMap<::std::string::String, ::std::string::String>>,
    pub(crate) scheduling_priority: ::std::option::Option<i32>,
    pub(crate) container_properties: ::std::option::Option<super::super::super::types::ContainerProperties>,
    pub(crate) node_properties: ::std::option::Option<super::super::super::types::NodeProperties>,
    ...
    pub(crate) platform_capabilities: ::std::option::Option<::std::vec::Vec<super::super::super::types::PlatformCapability>>,
    pub(crate) eks_properties: ::std::option::Option<super::super::super::types::EksProperties>,
    pub(crate) ecs_properties: ::std::option::Option<super::super::super::types::EcsProperties>,
    pub(crate) consumable_resource_properties: ::std::option::Option<super::super::super::types::ConsumableResourceProperties>,
}
impl RegisterJobDefinitionInputBuilder {
    ...
    /// </note>
    /// This field is required.
    pub fn r#type(mut self, input: super::super::super::types::JobDefinitionType) -> Self {
    ...
    /// <p>If the job is run on Fargate resources, then <code>multinode</code> isn't supported.</p>
    /// </note>
    pub fn set_type(mut self, input: ::std::option::Option<super::super::super::types::JobDefinitionType>) -> Self {
        self.r#type = input;
        self
    }
    /// <p>The type of job definition. For more information about multi-node parallel jobs, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/multi-node-job-def.html">Creating a multi-node parallel job definition</a> in the <i>Batch User Guide</i>.</p>
    ...
    /// <p>If the job is run on Fargate resources, then <code>multinode</code> isn't supported.</p>
    /// </note>
    pub fn get_type(&self) -> &::std::option::Option<super::super::super::types::JobDefinitionType> {
        &self.r#type
    }
    ...
    /// <p>If the job runs on Fargate resources, then you must not specify <code>nodeProperties</code>; use only <code>containerProperties</code>.</p>
    /// </note>
    pub fn container_properties(mut self, input: super::super::super::types::ContainerProperties) -> Self {
    ...
    /// <p>If the job runs on Fargate resources, then you must not specify <code>nodeProperties</code>; use only <code>containerProperties</code>.</p>
    /// </note>
    pub fn set_container_properties(mut self, input: ::std::option::Option<super::super::super::types::ContainerProperties>) -> Self {
    ...
    /// <p>If the job runs on Fargate resources, then you must not specify <code>nodeProperties</code>; use only <code>containerProperties</code>.</p>
    /// </note>
    pub fn get_container_properties(&self) -> &::std::option::Option<super::super::super::types::ContainerProperties> {
    ...
    /// <p>If the job runs on Amazon EKS resources, then you must not specify <code>nodeProperties</code>.</p>
    /// </note>
    pub fn node_properties(mut self, input: super::super::super::types::NodeProperties) -> Self {
    ...
    /// <p>If the job runs on Amazon EKS resources, then you must not specify <code>nodeProperties</code>.</p>
    /// </note>
    pub fn set_node_properties(mut self, input: ::std::option::Option<super::super::super::types::NodeProperties>) -> Self {
    ...
    /// <p>If the job runs on Amazon EKS resources, then you must not specify <code>nodeProperties</code>.</p>
    /// </note>
    pub fn get_node_properties(&self) -> &::std::option::Option<super::super::super::types::NodeProperties> {
    ...
    /// <p>If the job runs on Amazon EKS resources, then you must not specify <code>platformCapabilities</code>.</p>
    /// </note>
    pub fn platform_capabilities(mut self, input: super::super::super::types::PlatformCapability) -> Self {
    ...
    /// <p>If the job runs on Amazon EKS resources, then you must not specify <code>platformCapabilities</code>.</p>
    /// </note>
    pub fn get_platform_capabilities(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::PlatformCapability>> {
        &self.platform_capabilities
    }
    /// <p>An object with properties that are specific to Amazon EKS-based jobs. This must not be specified for Amazon ECS based job definitions.</p>
    pub fn eks_properties(mut self, input: super::super::super::types::EksProperties) -> Self {
        self.eks_properties = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object with properties that are specific to Amazon EKS-based jobs. This must not be specified for Amazon ECS based job definitions.</p>
    pub fn set_eks_properties(mut self, input: ::std::option::Option<super::super::super::types::EksProperties>) -> Self {
        self.eks_properties = input;
        self
    }
    /// <p>An object with properties that are specific to Amazon EKS-based jobs. This must not be specified for Amazon ECS based job definitions.</p>
    pub fn get_eks_properties(&self) -> &::std::option::Option<super::super::super::types::EksProperties> {
        &self.eks_properties
    }
    /// <p>An object with properties that are specific to Amazon ECS-based jobs. This must not be specified for Amazon EKS-based job definitions.</p>
    pub fn ecs_properties(mut self, input: super::super::super::types::EcsProperties) -> Self {
        self.ecs_properties = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object with properties that are specific to Amazon ECS-based jobs. This must not be specified for Amazon EKS-based job definitions.</p>
    pub fn set_ecs_properties(mut self, input: ::std::option::Option<super::super::super::types::EcsProperties>) -> Self {
        self.ecs_properties = input;
        self
    }
    /// <p>An object with properties that are specific to Amazon ECS-based jobs. This must not be specified for Amazon EKS-based job definitions.</p>
    pub fn get_ecs_properties(&self) -> &::std::option::Option<super::super::super::types::EcsProperties> {
        &self.ecs_properties
    }
    /// <p>Contains a list of consumable resources required by the job.</p>
    pub fn consumable_resource_properties(mut self, input: super::super::super::types::ConsumableResourceProperties) -> Self {
    ...
    /// <p>Contains a list of consumable resources required by the job.</p>
    pub fn get_consumable_resource_properties(&self) -> &::std::option::Option<super::super::super::types::ConsumableResourceProperties> {
