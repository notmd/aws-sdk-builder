...
impl DescribeJobsInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_jobs::builders::DescribeJobsInputBuilder {
        super::super::super::operation::describe_jobs::builders::DescribeJobsInputBuilder::default()
    }
}
