...
impl UpdateComputeEnvironmentOutput {
    ...
    pub fn builder() -> super::super::super::operation::update_compute_environment::builders::UpdateComputeEnvironmentOutputBuilder {
        super::super::super::operation::update_compute_environment::builders::UpdateComputeEnvironmentOutputBuilder::default()
    }
}
...
impl UpdateComputeEnvironmentOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::update_compute_environment::UpdateComputeEnvironmentOutput {
