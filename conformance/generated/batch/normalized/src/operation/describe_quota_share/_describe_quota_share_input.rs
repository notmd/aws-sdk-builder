...
impl DescribeQuotaShareInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_quota_share::builders::DescribeQuotaShareInputBuilder {
        super::super::super::operation::describe_quota_share::builders::DescribeQuotaShareInputBuilder::default()
    }
}
