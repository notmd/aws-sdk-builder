...
pub struct DescribeQuotaShareOutput {
    ...
    pub capacity_limits: ::std::option::Option<::std::vec::Vec<super::super::super::types::QuotaShareCapacityLimit>>,
    /// <p>Specifies whether a quota share reserves, lends, or both lends and borrows idle compute capacity.</p>
    pub resource_sharing_configuration: ::std::option::Option<super::super::super::types::QuotaShareResourceSharingConfiguration>,
    /// <p>Specifies the preemption behavior for jobs in a quota share.</p>
    pub preemption_configuration: ::std::option::Option<super::super::super::types::QuotaSharePreemptionConfiguration>,
    /// <p>The state of the quota share.</p>
    pub state: ::std::option::Option<super::super::super::types::QuotaShareState>,
    /// <p>The current status of the quota share.</p>
    pub status: ::std::option::Option<super::super::super::types::QuotaShareStatus>,
...
impl DescribeQuotaShareOutput {
    ...
    pub fn capacity_limits(&self) -> &[super::super::super::types::QuotaShareCapacityLimit] {
        self.capacity_limits.as_deref().unwrap_or_default()
    }
    /// <p>Specifies whether a quota share reserves, lends, or both lends and borrows idle compute capacity.</p>
    pub fn resource_sharing_configuration(&self) -> ::std::option::Option<&super::super::super::types::QuotaShareResourceSharingConfiguration> {
        self.resource_sharing_configuration.as_ref()
    }
    /// <p>Specifies the preemption behavior for jobs in a quota share.</p>
    pub fn preemption_configuration(&self) -> ::std::option::Option<&super::super::super::types::QuotaSharePreemptionConfiguration> {
        self.preemption_configuration.as_ref()
    }
    /// <p>The state of the quota share.</p>
    pub fn state(&self) -> ::std::option::Option<&super::super::super::types::QuotaShareState> {
        self.state.as_ref()
    }
    /// <p>The current status of the quota share.</p>
    pub fn status(&self) -> ::std::option::Option<&super::super::super::types::QuotaShareStatus> {
        self.status.as_ref()
    }
    /// <p>The tags applied to the quota share.</p>
...
impl DescribeQuotaShareOutput {
    ...
    pub fn builder() -> super::super::super::operation::describe_quota_share::builders::DescribeQuotaShareOutputBuilder {
        super::super::super::operation::describe_quota_share::builders::DescribeQuotaShareOutputBuilder::default()
    }
}
...
pub struct DescribeQuotaShareOutputBuilder {
    ...
    pub(crate) capacity_limits: ::std::option::Option<::std::vec::Vec<super::super::super::types::QuotaShareCapacityLimit>>,
    pub(crate) resource_sharing_configuration: ::std::option::Option<super::super::super::types::QuotaShareResourceSharingConfiguration>,
    pub(crate) preemption_configuration: ::std::option::Option<super::super::super::types::QuotaSharePreemptionConfiguration>,
    pub(crate) state: ::std::option::Option<super::super::super::types::QuotaShareState>,
    pub(crate) status: ::std::option::Option<super::super::super::types::QuotaShareStatus>,
...
impl DescribeQuotaShareOutputBuilder {
    ...
    ///
    /// <p>A list that specifies the quantity and type of compute capacity allocated to the quota share.</p>
    pub fn capacity_limits(mut self, input: super::super::super::types::QuotaShareCapacityLimit) -> Self {
    ...
    /// <p>A list that specifies the quantity and type of compute capacity allocated to the quota share.</p>
    pub fn set_capacity_limits(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::QuotaShareCapacityLimit>>) -> Self {
        self.capacity_limits = input;
        self
    }
    /// <p>A list that specifies the quantity and type of compute capacity allocated to the quota share.</p>
    pub fn get_capacity_limits(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::QuotaShareCapacityLimit>> {
        &self.capacity_limits
    }
    /// <p>Specifies whether a quota share reserves, lends, or both lends and borrows idle compute capacity.</p>
    pub fn resource_sharing_configuration(mut self, input: super::super::super::types::QuotaShareResourceSharingConfiguration) -> Self {
    ...
    /// <p>Specifies whether a quota share reserves, lends, or both lends and borrows idle compute capacity.</p>
    pub fn get_resource_sharing_configuration(&self) -> &::std::option::Option<super::super::super::types::QuotaShareResourceSharingConfiguration> {
        &self.resource_sharing_configuration
    }
    /// <p>Specifies the preemption behavior for jobs in a quota share.</p>
    pub fn preemption_configuration(mut self, input: super::super::super::types::QuotaSharePreemptionConfiguration) -> Self {
    ...
    /// <p>Specifies the preemption behavior for jobs in a quota share.</p>
    pub fn get_preemption_configuration(&self) -> &::std::option::Option<super::super::super::types::QuotaSharePreemptionConfiguration> {
        &self.preemption_configuration
    }
    /// <p>The state of the quota share.</p>
    pub fn state(mut self, input: super::super::super::types::QuotaShareState) -> Self {
        self.state = ::std::option::Option::Some(input);
        self
    }
    /// <p>The state of the quota share.</p>
    pub fn set_state(mut self, input: ::std::option::Option<super::super::super::types::QuotaShareState>) -> Self {
        self.state = input;
        self
    }
    /// <p>The state of the quota share.</p>
    pub fn get_state(&self) -> &::std::option::Option<super::super::super::types::QuotaShareState> {
        &self.state
    }
    /// <p>The current status of the quota share.</p>
    pub fn status(mut self, input: super::super::super::types::QuotaShareStatus) -> Self {
        self.status = ::std::option::Option::Some(input);
        self
    }
    /// <p>The current status of the quota share.</p>
    pub fn set_status(mut self, input: ::std::option::Option<super::super::super::types::QuotaShareStatus>) -> Self {
        self.status = input;
        self
    }
    /// <p>The current status of the quota share.</p>
    pub fn get_status(&self) -> &::std::option::Option<super::super::super::types::QuotaShareStatus> {
        &self.status
    }
    ...
    pub fn build(self) -> super::super::super::operation::describe_quota_share::DescribeQuotaShareOutput {
