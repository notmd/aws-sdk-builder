...
impl DescribeJobQueuesInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_job_queues::builders::DescribeJobQueuesInputBuilder {
        super::super::super::operation::describe_job_queues::builders::DescribeJobQueuesInputBuilder::default()
    }
}
