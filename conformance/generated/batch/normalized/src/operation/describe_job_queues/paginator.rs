...
/// Paginator for [`DescribeJobQueues`](crate::operation::describe_job_queues::DescribeJobQueues)
pub struct DescribeJobQueuesPaginator {
    handle: std::sync::Arc<super::super::super::client::Handle>,
    builder: super::super::super::operation::describe_job_queues::builders::DescribeJobQueuesInputBuilder,
...
impl DescribeJobQueuesPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::describe_job_queues::paginator::DescribeJobQueuesPaginatorItems {
        super::super::super::operation::describe_job_queues::paginator::DescribeJobQueuesPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::super::super::operation::describe_job_queues::DescribeJobQueues::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_describe_job_queues_output_output_next_token(resp);
...
impl DescribeJobQueuesPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::JobQueueDetail,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::describe_job_queues::DescribeJobQueuesError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_describe_job_queues_output_output_job_queues(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
