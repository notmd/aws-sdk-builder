...
impl ListJobsInput {
    ...
    pub fn builder() -> super::super::super::operation::list_jobs::builders::ListJobsInputBuilder {
        super::super::super::operation::list_jobs::builders::ListJobsInputBuilder::default()
    }
}
