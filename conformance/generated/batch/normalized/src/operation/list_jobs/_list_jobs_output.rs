...
impl ListJobsOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_jobs::builders::ListJobsOutputBuilder {
        super::super::super::operation::list_jobs::builders::ListJobsOutputBuilder::default()
    }
}
...
pub struct ListJobsOutputBuilder {
    pub(crate) job_summary_list: ::std::option::Option<::std::vec::Vec<super::super::super::types::JobSummary>>,
...
impl ListJobsOutputBuilder {
    ...
    ///
    /// <p>A list of job summaries that match the request.</p>
    pub fn job_summary_list(mut self, input: super::super::super::types::JobSummary) -> Self {
    ...
    /// <p>A list of job summaries that match the request.</p>
    pub fn set_job_summary_list(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::JobSummary>>) -> Self {
        self.job_summary_list = input;
        self
    }
    /// <p>A list of job summaries that match the request.</p>
    pub fn get_job_summary_list(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::JobSummary>> {
