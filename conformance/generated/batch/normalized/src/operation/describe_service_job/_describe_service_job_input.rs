...
impl DescribeServiceJobInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_service_job::builders::DescribeServiceJobInputBuilder {
        super::super::super::operation::describe_service_job::builders::DescribeServiceJobInputBuilder::default()
    }
}
