...
impl UpdateJobQueueInput {
    ...
    pub fn builder() -> super::super::super::operation::update_job_queue::builders::UpdateJobQueueInputBuilder {
        super::super::super::operation::update_job_queue::builders::UpdateJobQueueInputBuilder::default()
    }
}
