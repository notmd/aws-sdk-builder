...
pub struct DescribeSchedulingPoliciesOutput {
    ...
    pub scheduling_policies: ::std::option::Option<::std::vec::Vec<super::super::super::types::SchedulingPolicyDetail>>,
...
impl DescribeSchedulingPoliciesOutput {
    ...
    pub fn scheduling_policies(&self) -> &[super::super::super::types::SchedulingPolicyDetail] {
...
impl DescribeSchedulingPoliciesOutput {
    ...
    pub fn builder() -> super::super::super::operation::describe_scheduling_policies::builders::DescribeSchedulingPoliciesOutputBuilder {
        super::super::super::operation::describe_scheduling_policies::builders::DescribeSchedulingPoliciesOutputBuilder::default()
    }
}
...
pub struct DescribeSchedulingPoliciesOutputBuilder {
    pub(crate) scheduling_policies: ::std::option::Option<::std::vec::Vec<super::super::super::types::SchedulingPolicyDetail>>,
    _request_id: Option<String>,
}
impl DescribeSchedulingPoliciesOutputBuilder {
    ...
    ///
    /// <p>The list of scheduling policies.</p>
    pub fn scheduling_policies(mut self, input: super::super::super::types::SchedulingPolicyDetail) -> Self {
    ...
    /// <p>The list of scheduling policies.</p>
    pub fn get_scheduling_policies(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::SchedulingPolicyDetail>> {
    ...
    pub fn build(self) -> super::super::super::operation::describe_scheduling_policies::DescribeSchedulingPoliciesOutput {
