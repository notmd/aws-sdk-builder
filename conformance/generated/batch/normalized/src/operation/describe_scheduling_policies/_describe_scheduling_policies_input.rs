...
impl DescribeSchedulingPoliciesInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_scheduling_policies::builders::DescribeSchedulingPoliciesInputBuilder {
        super::super::super::operation::describe_scheduling_policies::builders::DescribeSchedulingPoliciesInputBuilder::default()
    }
}
...
impl DescribeSchedulingPoliciesInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::describe_scheduling_policies::DescribeSchedulingPoliciesInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::describe_scheduling_policies::DescribeSchedulingPoliciesInput { arns: self.arns })
    }
}
