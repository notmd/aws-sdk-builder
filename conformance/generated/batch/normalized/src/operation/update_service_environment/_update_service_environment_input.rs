...
impl UpdateServiceEnvironmentInput {
    ...
    pub fn builder() -> super::super::super::operation::update_service_environment::builders::UpdateServiceEnvironmentInputBuilder {
        super::super::super::operation::update_service_environment::builders::UpdateServiceEnvironmentInputBuilder::default()
    }
}
