...
impl DeleteQuotaShareInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_quota_share::builders::DeleteQuotaShareInputBuilder {
        super::super::super::operation::delete_quota_share::builders::DeleteQuotaShareInputBuilder::default()
    }
}
