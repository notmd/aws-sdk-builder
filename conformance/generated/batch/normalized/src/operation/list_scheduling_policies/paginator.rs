...
pub struct ListSchedulingPoliciesPaginator {
    ...
    builder: super::super::super::operation::list_scheduling_policies::builders::ListSchedulingPoliciesInputBuilder,
...
impl ListSchedulingPoliciesPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::list_scheduling_policies::paginator::ListSchedulingPoliciesPaginatorItems {
        super::super::super::operation::list_scheduling_policies::paginator::ListSchedulingPoliciesPaginatorItems(self)
    }
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_scheduling_policies_output_output_next_token(resp);
...
impl ListSchedulingPoliciesPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::SchedulingPolicyListingDetail,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::list_scheduling_policies::ListSchedulingPoliciesError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_list_scheduling_policies_output_output_scheduling_policies(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
