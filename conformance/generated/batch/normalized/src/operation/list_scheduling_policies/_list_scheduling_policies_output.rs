...
pub struct ListSchedulingPoliciesOutput {
    ...
    pub scheduling_policies: ::std::option::Option<::std::vec::Vec<super::super::super::types::SchedulingPolicyListingDetail>>,
...
impl ListSchedulingPoliciesOutput {
    ...
    pub fn scheduling_policies(&self) -> &[super::super::super::types::SchedulingPolicyListingDetail] {
...
impl ListSchedulingPoliciesOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_scheduling_policies::builders::ListSchedulingPoliciesOutputBuilder {
        super::super::super::operation::list_scheduling_policies::builders::ListSchedulingPoliciesOutputBuilder::default()
    }
}
...
pub struct ListSchedulingPoliciesOutputBuilder {
    pub(crate) scheduling_policies: ::std::option::Option<::std::vec::Vec<super::super::super::types::SchedulingPolicyListingDetail>>,
...
impl ListSchedulingPoliciesOutputBuilder {
    ...
    ///
    /// <p>A list of scheduling policies that match the request.</p>
    pub fn scheduling_policies(mut self, input: super::super::super::types::SchedulingPolicyListingDetail) -> Self {
    ...
    /// <p>A list of scheduling policies that match the request.</p>
    pub fn get_scheduling_policies(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::SchedulingPolicyListingDetail>> {
    ...
    pub fn build(self) -> super::super::super::operation::list_scheduling_policies::ListSchedulingPoliciesOutput {
