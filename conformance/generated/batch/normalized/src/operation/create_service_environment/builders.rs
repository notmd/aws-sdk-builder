...
pub use super::super::super::operation::create_service_environment::_create_service_environment_input::CreateServiceEnvironmentInputBuilder;

pub use super::super::super::operation::create_service_environment::_create_service_environment_output::CreateServiceEnvironmentOutputBuilder;

impl super::super::super::operation::create_service_environment::builders::CreateServiceEnvironmentInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::create_service_environment::CreateServiceEnvironmentError,
...
pub struct CreateServiceEnvironmentFluentBuilder {
    ...
    inner: super::super::super::operation::create_service_environment::builders::CreateServiceEnvironmentInputBuilder,
...
impl CreateServiceEnvironmentFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::create_service_environment::builders::CreateServiceEnvironmentInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::create_service_environment::CreateServiceEnvironment::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::create_service_environment::CreateServiceEnvironment::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn service_environment_type(mut self, input: super::super::super::types::ServiceEnvironmentType) -> Self {
        self.inner = self.inner.service_environment_type(input);
        self
    }
    /// <p>The type of service environment. For SageMaker Training jobs, specify <code>SAGEMAKER_TRAINING</code>.</p>
    pub fn set_service_environment_type(mut self, input: ::std::option::Option<super::super::super::types::ServiceEnvironmentType>) -> Self {
        self.inner = self.inner.set_service_environment_type(input);
        self
    }
    /// <p>The type of service environment. For SageMaker Training jobs, specify <code>SAGEMAKER_TRAINING</code>.</p>
    pub fn get_service_environment_type(&self) -> &::std::option::Option<super::super::super::types::ServiceEnvironmentType> {
    ...
    pub fn state(mut self, input: super::super::super::types::ServiceEnvironmentState) -> Self {
        self.inner = self.inner.state(input);
        self
    }
    /// <p>The state of the service environment. Valid values are <code>ENABLED</code> and <code>DISABLED</code>. The default value is <code>ENABLED</code>.</p>
    pub fn set_state(mut self, input: ::std::option::Option<super::super::super::types::ServiceEnvironmentState>) -> Self {
        self.inner = self.inner.set_state(input);
        self
    }
    /// <p>The state of the service environment. Valid values are <code>ENABLED</code> and <code>DISABLED</code>. The default value is <code>ENABLED</code>.</p>
    pub fn get_state(&self) -> &::std::option::Option<super::super::super::types::ServiceEnvironmentState> {
    ...
    pub fn capacity_limits(mut self, input: super::super::super::types::CapacityLimit) -> Self {
        self.inner = self.inner.capacity_limits(input);
        self
    }
    /// <p>The capacity limits for the service environment. The number of instances a job consumes is the total number of instances requested in the submit training job request resource configuration.</p>
    pub fn set_capacity_limits(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::CapacityLimit>>) -> Self {
        self.inner = self.inner.set_capacity_limits(input);
        self
    }
    /// <p>The capacity limits for the service environment. The number of instances a job consumes is the total number of instances requested in the submit training job request resource configuration.</p>
    pub fn get_capacity_limits(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::CapacityLimit>> {
