...
pub struct CreateServiceEnvironmentInput {
    ...
    pub service_environment_type: ::std::option::Option<super::super::super::types::ServiceEnvironmentType>,
    ...
    pub state: ::std::option::Option<super::super::super::types::ServiceEnvironmentState>,
    ...
    pub capacity_limits: ::std::option::Option<::std::vec::Vec<super::super::super::types::CapacityLimit>>,
...
impl CreateServiceEnvironmentInput {
    ...
    /// <p>The type of service environment. For SageMaker Training jobs, specify <code>SAGEMAKER_TRAINING</code>.</p>
    pub fn service_environment_type(&self) -> ::std::option::Option<&super::super::super::types::ServiceEnvironmentType> {
        self.service_environment_type.as_ref()
    }
    /// <p>The state of the service environment. Valid values are <code>ENABLED</code> and <code>DISABLED</code>. The default value is <code>ENABLED</code>.</p>
    pub fn state(&self) -> ::std::option::Option<&super::super::super::types::ServiceEnvironmentState> {
        self.state.as_ref()
    }
    /// <p>The capacity limits for the service environment. The number of instances a job consumes is the total number of instances requested in the submit training job request resource configuration.</p>
    ///
    ...
    pub fn capacity_limits(&self) -> &[super::super::super::types::CapacityLimit] {
...
impl CreateServiceEnvironmentInput {
    ...
    pub fn builder() -> super::super::super::operation::create_service_environment::builders::CreateServiceEnvironmentInputBuilder {
        super::super::super::operation::create_service_environment::builders::CreateServiceEnvironmentInputBuilder::default()
    }
}
...
pub struct CreateServiceEnvironmentInputBuilder {
    ...
    pub(crate) service_environment_type: ::std::option::Option<super::super::super::types::ServiceEnvironmentType>,
    pub(crate) state: ::std::option::Option<super::super::super::types::ServiceEnvironmentState>,
    pub(crate) capacity_limits: ::std::option::Option<::std::vec::Vec<super::super::super::types::CapacityLimit>>,
