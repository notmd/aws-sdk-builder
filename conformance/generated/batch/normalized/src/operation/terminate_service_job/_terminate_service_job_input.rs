...
impl TerminateServiceJobInput {
    ...
    pub fn builder() -> super::super::super::operation::terminate_service_job::builders::TerminateServiceJobInputBuilder {
        super::super::super::operation::terminate_service_job::builders::TerminateServiceJobInputBuilder::default()
    }
}
