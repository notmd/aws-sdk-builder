...
impl DeleteConsumableResourceInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_consumable_resource::builders::DeleteConsumableResourceInputBuilder {
        super::super::super::operation::delete_consumable_resource::builders::DeleteConsumableResourceInputBuilder::default()
    }
}
