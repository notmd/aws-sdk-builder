...
impl DeleteServiceEnvironmentInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_service_environment::builders::DeleteServiceEnvironmentInputBuilder {
        super::super::super::operation::delete_service_environment::builders::DeleteServiceEnvironmentInputBuilder::default()
    }
}
