...
impl GetJobQueueSnapshotInput {
    ...
    pub fn builder() -> super::super::super::operation::get_job_queue_snapshot::builders::GetJobQueueSnapshotInputBuilder {
        super::super::super::operation::get_job_queue_snapshot::builders::GetJobQueueSnapshotInputBuilder::default()
    }
}
