...
impl CancelJobOutput {
    ...
    pub fn builder() -> super::super::super::operation::cancel_job::builders::CancelJobOutputBuilder {
        super::super::super::operation::cancel_job::builders::CancelJobOutputBuilder::default()
    }
}
...
impl CancelJobOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::cancel_job::CancelJobOutput {
