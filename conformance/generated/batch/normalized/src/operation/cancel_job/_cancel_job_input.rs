...
impl CancelJobInput {
    ...
    pub fn builder() -> super::super::super::operation::cancel_job::builders::CancelJobInputBuilder {
        super::super::super::operation::cancel_job::builders::CancelJobInputBuilder::default()
    }
}
