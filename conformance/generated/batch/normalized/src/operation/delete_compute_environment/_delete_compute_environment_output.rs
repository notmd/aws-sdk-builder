...
impl DeleteComputeEnvironmentOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_compute_environment::builders::DeleteComputeEnvironmentOutputBuilder {
        super::super::super::operation::delete_compute_environment::builders::DeleteComputeEnvironmentOutputBuilder::default()
    }
}
...
impl DeleteComputeEnvironmentOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_compute_environment::DeleteComputeEnvironmentOutput {
