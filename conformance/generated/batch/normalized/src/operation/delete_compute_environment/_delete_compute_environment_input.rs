...
impl DeleteComputeEnvironmentInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_compute_environment::builders::DeleteComputeEnvironmentInputBuilder {
        super::super::super::operation::delete_compute_environment::builders::DeleteComputeEnvironmentInputBuilder::default()
    }
}
