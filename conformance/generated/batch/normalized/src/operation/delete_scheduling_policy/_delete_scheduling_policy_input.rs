...
impl DeleteSchedulingPolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_scheduling_policy::builders::DeleteSchedulingPolicyInputBuilder {
        super::super::super::operation::delete_scheduling_policy::builders::DeleteSchedulingPolicyInputBuilder::default()
    }
}
...
impl DeleteSchedulingPolicyInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::delete_scheduling_policy::DeleteSchedulingPolicyInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::delete_scheduling_policy::DeleteSchedulingPolicyInput { arn: self.arn })
    }
}
