...
pub fn de_create_job_queue_http_error(
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::create_job_queue::CreateJobQueueError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "ClientException" => super::super::operation::create_job_queue::CreateJobQueueError::ClientException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServerException" => super::super::operation::create_job_queue::CreateJobQueueError::ServerException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn ser_create_job_queue_input(
    ...
    super::super::protocol_serde::shape_create_job_queue_input::ser_create_job_queue_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_create_job_queue(
    _value: &[u8],
    mut builder: super::super::operation::create_job_queue::builders::CreateJobQueueOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::create_job_queue::builders::CreateJobQueueOutputBuilder,
