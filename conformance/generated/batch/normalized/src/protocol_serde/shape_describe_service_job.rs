...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::describe_service_job::DescribeServiceJobError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "ClientException" => super::super::operation::describe_service_job::DescribeServiceJobError::ClientException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServerException" => super::super::operation::describe_service_job::DescribeServiceJobError::ServerException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::describe_service_job::builders::DescribeServiceJobOutputBuilder::default();
...
pub fn ser_describe_service_job_input(
    ...
    super::super::protocol_serde::shape_describe_service_job_input::ser_describe_service_job_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_describe_service_job(
    _value: &[u8],
    mut builder: super::super::operation::describe_service_job::builders::DescribeServiceJobOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::describe_service_job::builders::DescribeServiceJobOutputBuilder,
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "capacityUsage" => {
                    builder = builder.set_capacity_usage(
                        super::super::protocol_serde::shape_service_job_capacity_usage_detail_list::de_service_job_capacity_usage_detail_list(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
                ...
                "status" => {
                    builder = builder.set_status(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| super::super::types::ServiceJobStatus::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "statusReason" => {
                ...
                "timeoutConfig" => {
                    builder = builder.set_timeout_config(super::super::protocol_serde::shape_service_job_timeout::de_service_job_timeout(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
