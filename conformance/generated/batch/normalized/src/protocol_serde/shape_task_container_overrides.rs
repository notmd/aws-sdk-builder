...
pub fn ser_task_container_overrides(
    ...
    input: &super::super::types::TaskContainerOverrides,
        ...
        for item_6 in var_4 {
            {
                ...
                super::super::protocol_serde::shape_key_value_pair::ser_key_value_pair(&mut object_7, item_6)?;
                object_7.finish();
            }
        }
        array_5.finish();
        ...
        for item_11 in var_9 {
            {
                ...
                super::super::protocol_serde::shape_resource_requirement::ser_resource_requirement(&mut object_12, item_11)?;
                object_12.finish();
            }
        }
        array_10.finish();
