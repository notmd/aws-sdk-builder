...
pub fn ser_compute_resource_update(
    ...
    input: &super::super::types::ComputeResourceUpdate,
    ...
    if let Some(var_22) = &input.launch_template {
        ...
        super::super::protocol_serde::shape_launch_template_specification::ser_launch_template_specification(&mut object_23, var_22)?;
        object_23.finish();
    }
        ...
        for item_26 in var_24 {
            {
                ...
                super::super::protocol_serde::shape_ec2_configuration::ser_ec2_configuration(&mut object_27, item_26)?;
                object_27.finish();
            }
        }
        array_25.finish();
    ...
    if let Some(var_33) = &input.managed_instances_provider {
        ...
        super::super::protocol_serde::shape_update_managed_instances_provider_configuration::ser_update_managed_instances_provider_configuration(
            &mut object_34,
            var_33,
        )?;
        object_34.finish();
