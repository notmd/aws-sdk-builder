...
pub(crate) fn de_instance_launch_template<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::super::types::InstanceLaunchTemplate>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::super::types::builders::InstanceLaunchTemplateBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "instanceRequirements" => {
                            builder = builder.set_instance_requirements(
                                super::super::protocol_serde::shape_instance_requirements_request::de_instance_requirements_request(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "capacityReservations" => {
                            builder = builder.set_capacity_reservations(
                                super::super::protocol_serde::shape_capacity_reservation_request::de_capacity_reservation_request(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
