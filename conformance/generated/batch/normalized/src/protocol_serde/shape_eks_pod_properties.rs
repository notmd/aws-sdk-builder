...
pub fn ser_eks_pod_properties(
    ...
    input: &super::super::types::EksPodProperties,
        ...
        for item_6 in var_4 {
            {
                ...
                super::super::protocol_serde::shape_image_pull_secret::ser_image_pull_secret(&mut object_7, item_6)?;
                object_7.finish();
            }
        }
        array_5.finish();
        ...
        for item_10 in var_8 {
            {
                ...
                super::super::protocol_serde::shape_eks_container::ser_eks_container(&mut object_11, item_10)?;
                object_11.finish();
            }
        }
        array_9.finish();
        ...
        for item_14 in var_12 {
            {
                ...
                super::super::protocol_serde::shape_eks_container::ser_eks_container(&mut object_15, item_14)?;
                object_15.finish();
            }
        }
        array_13.finish();
        ...
        for item_18 in var_16 {
            {
                ...
                super::super::protocol_serde::shape_eks_volume::ser_eks_volume(&mut object_19, item_18)?;
                object_19.finish();
            }
        }
        array_17.finish();
    ...
    if let Some(var_20) = &input.metadata {
        ...
        super::super::protocol_serde::shape_eks_metadata::ser_eks_metadata(&mut object_21, var_20)?;
        object_21.finish();
    }
...
pub(crate) fn de_eks_pod_properties<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::super::types::EksPodProperties>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::super::types::builders::EksPodPropertiesBuilder::default();
            loop {
                match tokens.next().transpose()? {
