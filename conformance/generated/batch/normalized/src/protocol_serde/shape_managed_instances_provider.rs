...
pub fn ser_managed_instances_provider(
    ...
    input: &super::super::types::ManagedInstancesProvider,
...
pub(crate) fn de_managed_instances_provider<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::super::types::ManagedInstancesProvider>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::super::types::builders::ManagedInstancesProviderBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "instanceLaunchTemplate" => {
                            builder = builder.set_instance_launch_template(
                                super::super::protocol_serde::shape_instance_launch_template::de_instance_launch_template(tokens, _value, depth + 1)?,
                            );
                        }
