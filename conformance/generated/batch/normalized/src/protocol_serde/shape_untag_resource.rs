...
pub fn de_untag_resource_http_error(
    ...
    Err(match error_code {
        "ClientException" => super::super::operation::untag_resource::UntagResourceError::ClientException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServerException" => super::super::operation::untag_resource::UntagResourceError::ServerException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
