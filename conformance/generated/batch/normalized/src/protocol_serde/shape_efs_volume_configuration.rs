...
pub(crate) fn de_efs_volume_configuration<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::super::types::EfsVolumeConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::super::types::builders::EfsVolumeConfigurationBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "transitEncryption" => {
                            builder = builder.set_transit_encryption(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| super::super::types::EfsTransitEncryption::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        ...
                        "authorizationConfig" => {
                            builder = builder.set_authorization_config(
                                super::super::protocol_serde::shape_efs_authorization_config::de_efs_authorization_config(tokens, _value, depth + 1)?,
                            );
                        }
