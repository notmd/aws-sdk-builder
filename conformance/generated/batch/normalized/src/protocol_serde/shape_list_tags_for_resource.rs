...
> {
    ...
    Err(match error_code {
        "ClientException" => super::super::operation::list_tags_for_resource::ListTagsForResourceError::ClientException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServerException" => super::super::operation::list_tags_for_resource::ListTagsForResourceError::ServerException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
