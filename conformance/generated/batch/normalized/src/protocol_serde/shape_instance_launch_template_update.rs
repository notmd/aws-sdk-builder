...
pub fn ser_instance_launch_template_update(
    ...
    input: &super::super::types::InstanceLaunchTemplateUpdate,
    ...
    if let Some(var_9) = &input.capacity_reservations {
        ...
        super::super::protocol_serde::shape_capacity_reservation_request::ser_capacity_reservation_request(&mut object_10, var_9)?;
        object_10.finish();
    }
