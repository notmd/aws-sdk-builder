...
pub(crate) fn de_log_configuration<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::super::types::LogConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::super::types::builders::LogConfigurationBuilder::default();
            loop {
                match tokens.next().transpose()? {
                        ...
                        "logDriver" => {
                            builder = builder.set_log_driver(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| super::super::types::LogDriver::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "options" => {
                            builder = builder.set_options(
                                super::super::protocol_serde::shape_log_configuration_options_map::de_log_configuration_options_map(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
