...
pub fn ser_container_overrides(
    ...
    input: &super::super::types::ContainerOverrides,
        ...
        for item_9 in var_7 {
            {
                ...
                super::super::protocol_serde::shape_key_value_pair::ser_key_value_pair(&mut object_10, item_9)?;
                object_10.finish();
            }
        }
        array_8.finish();
        ...
        for item_13 in var_11 {
            {
                ...
                super::super::protocol_serde::shape_resource_requirement::ser_resource_requirement(&mut object_14, item_13)?;
                object_14.finish();
            }
        }
        array_12.finish();
