...
pub(crate) fn de_compute_environment_detail<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::super::types::ComputeEnvironmentDetail>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::super::types::builders::ComputeEnvironmentDetailBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "type" => {
                            builder = builder.set_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| super::super::types::CeType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "state" => {
                            builder = builder.set_state(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| super::super::types::CeState::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "status" => {
                            builder = builder.set_status(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| super::super::types::CeStatus::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "statusReason" => {
                        ...
                        "computeResources" => {
                            builder = builder.set_compute_resources(super::super::protocol_serde::shape_compute_resource::de_compute_resource(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "containerOrchestrationType" => {
                            builder = builder.set_container_orchestration_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| super::super::types::OrchestrationType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "uuid" => {
