...
pub(crate) fn de_job_queue_detail<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::super::types::JobQueueDetail>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::super::types::builders::JobQueueDetailBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "state" => {
                            builder = builder.set_state(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| super::super::types::JqState::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "schedulingPolicyArn" => {
                        ...
                        "status" => {
                            builder = builder.set_status(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| super::super::types::JqStatus::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "statusReason" => {
                        ...
                        "jobQueueType" => {
                            builder = builder.set_job_queue_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| super::super::types::JobQueueType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "tags" => {
                        ...
                        "jobStateTimeLimitActions" => {
                            builder = builder.set_job_state_time_limit_actions(
                                super::super::protocol_serde::shape_job_state_time_limit_actions::de_job_state_time_limit_actions(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
