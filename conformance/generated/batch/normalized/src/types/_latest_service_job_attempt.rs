...
impl LatestServiceJobAttempt {
    ...
    pub fn builder() -> super::super::types::builders::LatestServiceJobAttemptBuilder {
        super::super::types::builders::LatestServiceJobAttemptBuilder::default()
    }
}
...
impl LatestServiceJobAttemptBuilder {
    ...
    pub fn build(self) -> super::super::types::LatestServiceJobAttempt {
        super::super::types::LatestServiceJobAttempt {
