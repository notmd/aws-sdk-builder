...
impl ServiceResourceId {
    ...
    pub fn builder() -> super::super::types::builders::ServiceResourceIdBuilder {
        super::super::types::builders::ServiceResourceIdBuilder::default()
    }
}
...
pub struct ServiceResourceIdBuilder {
    pub(crate) name: ::std::option::Option<super::super::types::ServiceResourceIdName>,
    pub(crate) value: ::std::option::Option<::std::string::String>,
}
impl ServiceResourceIdBuilder {
    /// <p>The name of the resource identifier.</p>
    /// This field is required.
    pub fn name(mut self, input: super::super::types::ServiceResourceIdName) -> Self {
        self.name = ::std::option::Option::Some(input);
        self
    }
    /// <p>The name of the resource identifier.</p>
    pub fn set_name(mut self, input: ::std::option::Option<super::super::types::ServiceResourceIdName>) -> Self {
        self.name = input;
        self
    }
    /// <p>The name of the resource identifier.</p>
    pub fn get_name(&self) -> &::std::option::Option<super::super::types::ServiceResourceIdName> {
        &self.name
    }
    /// <p>The value of the resource identifier.</p>
    /// This field is required.
