...
impl EksHostPath {
    ...
    pub fn builder() -> super::super::types::builders::EksHostPathBuilder {
        super::super::types::builders::EksHostPathBuilder::default()
    }
}
...
impl EksHostPathBuilder {
    ...
    pub fn build(self) -> super::super::types::EksHostPath {
        super::super::types::EksHostPath { path: self.path }
    }
}
