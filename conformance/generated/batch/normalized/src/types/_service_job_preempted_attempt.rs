...
pub struct ServiceJobPreemptedAttempt {
    ...
    pub service_resource_id: ::std::option::Option<super::super::types::ServiceResourceId>,
...
impl ServiceJobPreemptedAttempt {
    /// <p>The service resource identifier associated with the service job attempt.</p>
    pub fn service_resource_id(&self) -> ::std::option::Option<&super::super::types::ServiceResourceId> {
...
impl ServiceJobPreemptedAttempt {
    /// Creates a new builder-style object to manufacture [`ServiceJobPreemptedAttempt`](crate::types::ServiceJobPreemptedAttempt).
    pub fn builder() -> super::super::types::builders::ServiceJobPreemptedAttemptBuilder {
        super::super::types::builders::ServiceJobPreemptedAttemptBuilder::default()
    }
}

/// A builder for [`ServiceJobPreemptedAttempt`](crate::types::ServiceJobPreemptedAttempt).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ServiceJobPreemptedAttemptBuilder {
    pub(crate) service_resource_id: ::std::option::Option<super::super::types::ServiceResourceId>,
    pub(crate) started_at: ::std::option::Option<i64>,
    pub(crate) stopped_at: ::std::option::Option<i64>,
    pub(crate) status_reason: ::std::option::Option<::std::string::String>,
}
impl ServiceJobPreemptedAttemptBuilder {
    /// <p>The service resource identifier associated with the service job attempt.</p>
    pub fn service_resource_id(mut self, input: super::super::types::ServiceResourceId) -> Self {
        self.service_resource_id = ::std::option::Option::Some(input);
        self
    }
    /// <p>The service resource identifier associated with the service job attempt.</p>
    pub fn set_service_resource_id(mut self, input: ::std::option::Option<super::super::types::ServiceResourceId>) -> Self {
        self.service_resource_id = input;
        self
    }
    /// <p>The service resource identifier associated with the service job attempt.</p>
    pub fn get_service_resource_id(&self) -> &::std::option::Option<super::super::types::ServiceResourceId> {
    ...
    /// Consumes the builder and constructs a [`ServiceJobPreemptedAttempt`](crate::types::ServiceJobPreemptedAttempt).
    pub fn build(self) -> super::super::types::ServiceJobPreemptedAttempt {
        super::super::types::ServiceJobPreemptedAttempt {
