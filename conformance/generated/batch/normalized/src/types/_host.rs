...
impl Host {
    ...
    pub fn builder() -> super::super::types::builders::HostBuilder {
        super::super::types::builders::HostBuilder::default()
    }
}
...
impl HostBuilder {
    ...
    pub fn build(self) -> super::super::types::Host {
        super::super::types::Host {
