...
impl EksContainerVolumeMount {
    ...
    pub fn builder() -> super::super::types::builders::EksContainerVolumeMountBuilder {
        super::super::types::builders::EksContainerVolumeMountBuilder::default()
    }
}
...
impl EksContainerVolumeMountBuilder {
    ...
    pub fn build(self) -> super::super::types::EksContainerVolumeMount {
        super::super::types::EksContainerVolumeMount {
            name: self.name,
