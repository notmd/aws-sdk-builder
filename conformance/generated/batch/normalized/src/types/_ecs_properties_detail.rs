...
pub struct EcsPropertiesDetail {
    ...
    pub task_properties: ::std::option::Option<::std::vec::Vec<super::super::types::EcsTaskDetails>>,
}
impl EcsPropertiesDetail {
    ...
    pub fn task_properties(&self) -> &[super::super::types::EcsTaskDetails] {
...
impl EcsPropertiesDetail {
    ...
    pub fn builder() -> super::super::types::builders::EcsPropertiesDetailBuilder {
        super::super::types::builders::EcsPropertiesDetailBuilder::default()
    }
}
...
pub struct EcsPropertiesDetailBuilder {
    pub(crate) task_properties: ::std::option::Option<::std::vec::Vec<super::super::types::EcsTaskDetails>>,
}
impl EcsPropertiesDetailBuilder {
    ...
    ///
    /// <p>The properties for the Amazon ECS task definition of a job.</p>
    pub fn task_properties(mut self, input: super::super::types::EcsTaskDetails) -> Self {
    ...
    /// <p>The properties for the Amazon ECS task definition of a job.</p>
    pub fn set_task_properties(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::EcsTaskDetails>>) -> Self {
        self.task_properties = input;
        self
    }
    /// <p>The properties for the Amazon ECS task definition of a job.</p>
    pub fn get_task_properties(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::EcsTaskDetails>> {
        &self.task_properties
    }
    /// Consumes the builder and constructs a [`EcsPropertiesDetail`](crate::types::EcsPropertiesDetail).
    pub fn build(self) -> super::super::types::EcsPropertiesDetail {
        super::super::types::EcsPropertiesDetail {
