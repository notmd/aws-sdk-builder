...
impl LaunchTemplateSpecificationOverride {
    ...
    pub fn builder() -> super::super::types::builders::LaunchTemplateSpecificationOverrideBuilder {
        super::super::types::builders::LaunchTemplateSpecificationOverrideBuilder::default()
    }
}
...
impl LaunchTemplateSpecificationOverrideBuilder {
    ...
    pub fn build(self) -> super::super::types::LaunchTemplateSpecificationOverride {
        super::super::types::LaunchTemplateSpecificationOverride {
