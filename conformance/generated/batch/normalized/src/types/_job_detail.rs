...
pub struct JobDetail {
    ...
    pub attempts: ::std::option::Option<::std::vec::Vec<super::super::types::AttemptDetail>>,
    ...
    pub container: ::std::option::Option<super::super::types::ContainerDetail>,
    /// <p>An object that represents the details of a node that's associated with a multi-node parallel job.</p>
    pub node_details: ::std::option::Option<super::super::types::NodeDetails>,
    ...
    /// </note>
    pub node_properties: ::std::option::Option<super::super::types::NodeProperties>,
    /// <p>The array properties of the job, if it's an array job.</p>
    pub array_properties: ::std::option::Option<super::super::types::ArrayPropertiesDetail>,
    /// <p>The timeout configuration for the job.</p>
    pub timeout: ::std::option::Option<super::super::types::JobTimeout>,
    ...
    pub platform_capabilities: ::std::option::Option<::std::vec::Vec<super::super::types::PlatformCapability>>,
    /// <p>An object with various properties that are specific to Amazon EKS based jobs.</p>
    pub eks_properties: ::std::option::Option<super::super::types::EksPropertiesDetail>,
    /// <p>A list of job attempts that are associated with this job.</p>
    pub eks_attempts: ::std::option::Option<::std::vec::Vec<super::super::types::EksAttemptDetail>>,
    /// <p>An object with properties that are specific to Amazon ECS-based jobs.</p>
    pub ecs_properties: ::std::option::Option<super::super::types::EcsPropertiesDetail>,
...
impl JobDetail {
    ...
    pub fn attempts(&self) -> &[super::super::types::AttemptDetail] {
    ...
    /// <p>The retry strategy to use for this job if an attempt fails.</p>
    pub fn retry_strategy(&self) -> ::std::option::Option<&super::super::types::RetryStrategy> {
    ...
    pub fn depends_on(&self) -> &[super::super::types::JobDependency] {
    ...
    /// <p>An object that represents the details for the container that's associated with the job. If the details are for a multiple-container job, this object will be empty.</p>
    pub fn container(&self) -> ::std::option::Option<&super::super::types::ContainerDetail> {
        self.container.as_ref()
    }
    /// <p>An object that represents the details of a node that's associated with a multi-node parallel job.</p>
    pub fn node_details(&self) -> ::std::option::Option<&super::super::types::NodeDetails> {
        self.node_details.as_ref()
    }
    /// <p>An object that represents the node properties of a multi-node parallel job.</p><note>
    /// <p>This isn't applicable to jobs that are running on Fargate resources.</p>
    /// </note>
    pub fn node_properties(&self) -> ::std::option::Option<&super::super::types::NodeProperties> {
        self.node_properties.as_ref()
    }
    /// <p>The array properties of the job, if it's an array job.</p>
    pub fn array_properties(&self) -> ::std::option::Option<&super::super::types::ArrayPropertiesDetail> {
        self.array_properties.as_ref()
    }
    /// <p>The timeout configuration for the job.</p>
    pub fn timeout(&self) -> ::std::option::Option<&super::super::types::JobTimeout> {
        self.timeout.as_ref()
    }
    /// <p>The tags that are applied to the job.</p>
    ...
    pub fn platform_capabilities(&self) -> &[super::super::types::PlatformCapability] {
        self.platform_capabilities.as_deref().unwrap_or_default()
    }
    /// <p>An object with various properties that are specific to Amazon EKS based jobs.</p>
    pub fn eks_properties(&self) -> ::std::option::Option<&super::super::types::EksPropertiesDetail> {
    ...
    pub fn eks_attempts(&self) -> &[super::super::types::EksAttemptDetail] {
        self.eks_attempts.as_deref().unwrap_or_default()
    }
    /// <p>An object with properties that are specific to Amazon ECS-based jobs.</p>
    pub fn ecs_properties(&self) -> ::std::option::Option<&super::super::types::EcsPropertiesDetail> {
    ...
    /// <p>Contains a list of consumable resources required by the job.</p>
    pub fn consumable_resource_properties(&self) -> ::std::option::Option<&super::super::types::ConsumableResourceProperties> {
...
impl JobDetail {
    ...
    pub fn builder() -> super::super::types::builders::JobDetailBuilder {
        super::super::types::builders::JobDetailBuilder::default()
    }
}
...
pub struct JobDetailBuilder {
    ...
    pub(crate) status: ::std::option::Option<super::super::types::JobStatus>,
    pub(crate) share_identifier: ::std::option::Option<::std::string::String>,
    pub(crate) scheduling_priority: ::std::option::Option<i32>,
    pub(crate) attempts: ::std::option::Option<::std::vec::Vec<super::super::types::AttemptDetail>>,
    pub(crate) status_reason: ::std::option::Option<::std::string::String>,
    pub(crate) created_at: ::std::option::Option<i64>,
    pub(crate) retry_strategy: ::std::option::Option<super::super::types::RetryStrategy>,
    pub(crate) started_at: ::std::option::Option<i64>,
    pub(crate) stopped_at: ::std::option::Option<i64>,
    pub(crate) depends_on: ::std::option::Option<::std::vec::Vec<super::super::types::JobDependency>>,
    pub(crate) job_definition: ::std::option::Option<::std::string::String>,
    pub(crate) parameters: ::std::option::Option<::std::collections::HashMap<::std::string::String, ::std::string::String>>,
    pub(crate) container: ::std::option::Option<super::super::types::ContainerDetail>,
    pub(crate) node_details: ::std::option::Option<super::super::types::NodeDetails>,
    pub(crate) node_properties: ::std::option::Option<super::super::types::NodeProperties>,
    pub(crate) array_properties: ::std::option::Option<super::super::types::ArrayPropertiesDetail>,
    pub(crate) timeout: ::std::option::Option<super::super::types::JobTimeout>,
    pub(crate) tags: ::std::option::Option<::std::collections::HashMap<::std::string::String, ::std::string::String>>,
    pub(crate) propagate_tags: ::std::option::Option<bool>,
    pub(crate) platform_capabilities: ::std::option::Option<::std::vec::Vec<super::super::types::PlatformCapability>>,
    pub(crate) eks_properties: ::std::option::Option<super::super::types::EksPropertiesDetail>,
    pub(crate) eks_attempts: ::std::option::Option<::std::vec::Vec<super::super::types::EksAttemptDetail>>,
    pub(crate) ecs_properties: ::std::option::Option<super::super::types::EcsPropertiesDetail>,
    pub(crate) is_cancelled: ::std::option::Option<bool>,
    pub(crate) is_terminated: ::std::option::Option<bool>,
    pub(crate) consumable_resource_properties: ::std::option::Option<super::super::types::ConsumableResourceProperties>,
}
impl JobDetailBuilder {
    ...
    /// </note>
    /// This field is required.
    pub fn status(mut self, input: super::super::types::JobStatus) -> Self {
    ...
    /// <p>If your jobs don't progress to <code>STARTING</code>, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/troubleshooting.html#job_stuck_in_runnable">Jobs stuck in RUNNABLE status</a> in the troubleshooting section of the <i>Batch User Guide</i>.</p>
    /// </note>
    pub fn set_status(mut self, input: ::std::option::Option<super::super::types::JobStatus>) -> Self {
        self.status = input;
        self
    }
    /// <p>The current status for the job.</p><note>
    /// <p>If your jobs don't progress to <code>STARTING</code>, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/troubleshooting.html#job_stuck_in_runnable">Jobs stuck in RUNNABLE status</a> in the troubleshooting section of the <i>Batch User Guide</i>.</p>
    /// </note>
    pub fn get_status(&self) -> &::std::option::Option<super::super::types::JobStatus> {
        &self.status
    }
    /// <p>The share identifier for the job.</p>
    ...
    ///
    /// <p>A list of job attempts that are associated with this job.</p>
    pub fn attempts(mut self, input: super::super::types::AttemptDetail) -> Self {
    ...
    /// <p>A list of job attempts that are associated with this job.</p>
    pub fn set_attempts(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::AttemptDetail>>) -> Self {
        self.attempts = input;
        self
    }
    /// <p>A list of job attempts that are associated with this job.</p>
    pub fn get_attempts(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::AttemptDetail>> {
        &self.attempts
    }
    /// <p>A short, human-readable string to provide more details for the current status of the job.</p>
    /// <ul>
    ...
    /// <p>The retry strategy to use for this job if an attempt fails.</p>
    pub fn retry_strategy(mut self, input: super::super::types::RetryStrategy) -> Self {
        self.retry_strategy = ::std::option::Option::Some(input);
        self
    }
    /// <p>The retry strategy to use for this job if an attempt fails.</p>
    pub fn set_retry_strategy(mut self, input: ::std::option::Option<super::super::types::RetryStrategy>) -> Self {
        self.retry_strategy = input;
        self
    }
    /// <p>The retry strategy to use for this job if an attempt fails.</p>
    pub fn get_retry_strategy(&self) -> &::std::option::Option<super::super::types::RetryStrategy> {
        &self.retry_strategy
    }
    /// <p>The Unix timestamp (in milliseconds) for when the job was started. More specifically, it's when the job transitioned from the <code>STARTING</code> state to the <code>RUNNING</code> state.</p>
    /// This field is required.
    ...
    ///
    /// <p>A list of job IDs that this job depends on.</p>
    pub fn depends_on(mut self, input: super::super::types::JobDependency) -> Self {
    ...
    /// <p>A list of job IDs that this job depends on.</p>
    pub fn set_depends_on(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::JobDependency>>) -> Self {
        self.depends_on = input;
        self
    }
    /// <p>A list of job IDs that this job depends on.</p>
    pub fn get_depends_on(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::JobDependency>> {
        &self.depends_on
    }
    /// <p>The Amazon Resource Name (ARN) of the job definition that this job uses.</p>
    /// This field is required.
    ...
    /// <p>An object that represents the details for the container that's associated with the job. If the details are for a multiple-container job, this object will be empty.</p>
    pub fn container(mut self, input: super::super::types::ContainerDetail) -> Self {
        self.container = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object that represents the details for the container that's associated with the job. If the details are for a multiple-container job, this object will be empty.</p>
    pub fn set_container(mut self, input: ::std::option::Option<super::super::types::ContainerDetail>) -> Self {
        self.container = input;
        self
    }
    /// <p>An object that represents the details for the container that's associated with the job. If the details are for a multiple-container job, this object will be empty.</p>
    pub fn get_container(&self) -> &::std::option::Option<super::super::types::ContainerDetail> {
        &self.container
    }
    /// <p>An object that represents the details of a node that's associated with a multi-node parallel job.</p>
    pub fn node_details(mut self, input: super::super::types::NodeDetails) -> Self {
        self.node_details = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object that represents the details of a node that's associated with a multi-node parallel job.</p>
    pub fn set_node_details(mut self, input: ::std::option::Option<super::super::types::NodeDetails>) -> Self {
        self.node_details = input;
        self
    }
    /// <p>An object that represents the details of a node that's associated with a multi-node parallel job.</p>
    pub fn get_node_details(&self) -> &::std::option::Option<super::super::types::NodeDetails> {
        &self.node_details
    }
    /// <p>An object that represents the node properties of a multi-node parallel job.</p><note>
    /// <p>This isn't applicable to jobs that are running on Fargate resources.</p>
    /// </note>
    pub fn node_properties(mut self, input: super::super::types::NodeProperties) -> Self {
    ...
    /// <p>This isn't applicable to jobs that are running on Fargate resources.</p>
    /// </note>
    pub fn set_node_properties(mut self, input: ::std::option::Option<super::super::types::NodeProperties>) -> Self {
    ...
    /// <p>This isn't applicable to jobs that are running on Fargate resources.</p>
    /// </note>
    pub fn get_node_properties(&self) -> &::std::option::Option<super::super::types::NodeProperties> {
        &self.node_properties
    }
    /// <p>The array properties of the job, if it's an array job.</p>
    pub fn array_properties(mut self, input: super::super::types::ArrayPropertiesDetail) -> Self {
        self.array_properties = ::std::option::Option::Some(input);
        self
    }
    /// <p>The array properties of the job, if it's an array job.</p>
    pub fn set_array_properties(mut self, input: ::std::option::Option<super::super::types::ArrayPropertiesDetail>) -> Self {
        self.array_properties = input;
        self
    }
    /// <p>The array properties of the job, if it's an array job.</p>
    pub fn get_array_properties(&self) -> &::std::option::Option<super::super::types::ArrayPropertiesDetail> {
        &self.array_properties
    }
    /// <p>The timeout configuration for the job.</p>
    pub fn timeout(mut self, input: super::super::types::JobTimeout) -> Self {
        self.timeout = ::std::option::Option::Some(input);
        self
    }
    /// <p>The timeout configuration for the job.</p>
    pub fn set_timeout(mut self, input: ::std::option::Option<super::super::types::JobTimeout>) -> Self {
        self.timeout = input;
        self
    }
    /// <p>The timeout configuration for the job.</p>
    pub fn get_timeout(&self) -> &::std::option::Option<super::super::types::JobTimeout> {
        &self.timeout
    }
    ...
    ///
    /// <p>The platform capabilities required by the job definition. If no value is specified, it defaults to <code>EC2</code>. Jobs run on Fargate resources specify <code>FARGATE</code>. Jobs run on Amazon ECS Managed Instances specify <code>MANAGED_INSTANCES</code>.</p>
    pub fn platform_capabilities(mut self, input: super::super::types::PlatformCapability) -> Self {
    ...
    /// <p>The platform capabilities required by the job definition. If no value is specified, it defaults to <code>EC2</code>. Jobs run on Fargate resources specify <code>FARGATE</code>. Jobs run on Amazon ECS Managed Instances specify <code>MANAGED_INSTANCES</code>.</p>
    pub fn set_platform_capabilities(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::PlatformCapability>>) -> Self {
        self.platform_capabilities = input;
        self
    }
    /// <p>The platform capabilities required by the job definition. If no value is specified, it defaults to <code>EC2</code>. Jobs run on Fargate resources specify <code>FARGATE</code>. Jobs run on Amazon ECS Managed Instances specify <code>MANAGED_INSTANCES</code>.</p>
    pub fn get_platform_capabilities(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::PlatformCapability>> {
        &self.platform_capabilities
    }
    /// <p>An object with various properties that are specific to Amazon EKS based jobs.</p>
    pub fn eks_properties(mut self, input: super::super::types::EksPropertiesDetail) -> Self {
        self.eks_properties = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object with various properties that are specific to Amazon EKS based jobs.</p>
    pub fn set_eks_properties(mut self, input: ::std::option::Option<super::super::types::EksPropertiesDetail>) -> Self {
        self.eks_properties = input;
        self
    }
    /// <p>An object with various properties that are specific to Amazon EKS based jobs.</p>
    pub fn get_eks_properties(&self) -> &::std::option::Option<super::super::types::EksPropertiesDetail> {
        &self.eks_properties
    }
    ...
    ///
    /// <p>A list of job attempts that are associated with this job.</p>
    pub fn eks_attempts(mut self, input: super::super::types::EksAttemptDetail) -> Self {
    ...
    /// <p>A list of job attempts that are associated with this job.</p>
    pub fn set_eks_attempts(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::EksAttemptDetail>>) -> Self {
        self.eks_attempts = input;
        self
    }
    /// <p>A list of job attempts that are associated with this job.</p>
    pub fn get_eks_attempts(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::EksAttemptDetail>> {
        &self.eks_attempts
    }
    /// <p>An object with properties that are specific to Amazon ECS-based jobs.</p>
    pub fn ecs_properties(mut self, input: super::super::types::EcsPropertiesDetail) -> Self {
        self.ecs_properties = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object with properties that are specific to Amazon ECS-based jobs.</p>
    pub fn set_ecs_properties(mut self, input: ::std::option::Option<super::super::types::EcsPropertiesDetail>) -> Self {
        self.ecs_properties = input;
        self
    }
    /// <p>An object with properties that are specific to Amazon ECS-based jobs.</p>
    pub fn get_ecs_properties(&self) -> &::std::option::Option<super::super::types::EcsPropertiesDetail> {
        &self.ecs_properties
    }
    /// <p>Indicates whether the job is canceled.</p>
    ...
    /// <p>Contains a list of consumable resources required by the job.</p>
    pub fn consumable_resource_properties(mut self, input: super::super::types::ConsumableResourceProperties) -> Self {
        self.consumable_resource_properties = ::std::option::Option::Some(input);
        self
    }
    /// <p>Contains a list of consumable resources required by the job.</p>
    pub fn set_consumable_resource_properties(mut self, input: ::std::option::Option<super::super::types::ConsumableResourceProperties>) -> Self {
        self.consumable_resource_properties = input;
        self
    }
    /// <p>Contains a list of consumable resources required by the job.</p>
    pub fn get_consumable_resource_properties(&self) -> &::std::option::Option<super::super::types::ConsumableResourceProperties> {
