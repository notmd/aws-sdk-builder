...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::ClientException {
...
impl ClientException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::ClientExceptionBuilder {
        super::super::super::types::error::builders::ClientExceptionBuilder::default()
    }
}
...
impl ClientExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::ClientException {
        super::super::super::types::error::ClientException {
