...
impl ServiceJobTimeout {
    ...
    pub fn builder() -> super::super::types::builders::ServiceJobTimeoutBuilder {
        super::super::types::builders::ServiceJobTimeoutBuilder::default()
    }
}
...
impl ServiceJobTimeoutBuilder {
    ...
    pub fn build(self) -> super::super::types::ServiceJobTimeout {
        super::super::types::ServiceJobTimeout {
