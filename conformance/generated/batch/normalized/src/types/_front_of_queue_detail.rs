...
pub struct FrontOfQueueDetail {
    ...
    pub jobs: ::std::option::Option<::std::vec::Vec<super::super::types::FrontOfQueueJobSummary>>,
...
impl FrontOfQueueDetail {
    ...
    pub fn jobs(&self) -> &[super::super::types::FrontOfQueueJobSummary] {
...
impl FrontOfQueueDetail {
    ...
    pub fn builder() -> super::super::types::builders::FrontOfQueueDetailBuilder {
        super::super::types::builders::FrontOfQueueDetailBuilder::default()
    }
}
...
pub struct FrontOfQueueDetailBuilder {
    pub(crate) jobs: ::std::option::Option<::std::vec::Vec<super::super::types::FrontOfQueueJobSummary>>,
...
impl FrontOfQueueDetailBuilder {
    ...
    ///
    /// <p>The Amazon Resource Names (ARNs) of the first 100 <code>RUNNABLE</code> jobs in a named job queue. For first-in-first-out (FIFO) job queues, jobs are ordered based on their submission time. For fair-share scheduling (FSS) job queues, jobs are ordered based on their job priority and share usage.</p>
    pub fn jobs(mut self, input: super::super::types::FrontOfQueueJobSummary) -> Self {
    ...
    /// <p>The Amazon Resource Names (ARNs) of the first 100 <code>RUNNABLE</code> jobs in a named job queue. For first-in-first-out (FIFO) job queues, jobs are ordered based on their submission time. For fair-share scheduling (FSS) job queues, jobs are ordered based on their job priority and share usage.</p>
    pub fn set_jobs(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::FrontOfQueueJobSummary>>) -> Self {
        self.jobs = input;
        self
    }
    /// <p>The Amazon Resource Names (ARNs) of the first 100 <code>RUNNABLE</code> jobs in a named job queue. For first-in-first-out (FIFO) job queues, jobs are ordered based on their submission time. For fair-share scheduling (FSS) job queues, jobs are ordered based on their job priority and share usage.</p>
    pub fn get_jobs(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::FrontOfQueueJobSummary>> {
        &self.jobs
    }
    /// <p>The Unix timestamp (in milliseconds) for when each of the first 100 <code>RUNNABLE</code> jobs were last updated.</p>
    ...
    pub fn build(self) -> super::super::types::FrontOfQueueDetail {
        super::super::types::FrontOfQueueDetail {
            jobs: self.jobs,
