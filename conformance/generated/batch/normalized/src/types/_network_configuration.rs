...
pub struct NetworkConfiguration {
    ...
    pub assign_public_ip: ::std::option::Option<super::super::types::AssignPublicIp>,
}
impl NetworkConfiguration {
    /// <p>Indicates whether the job has a public IP address. For a job that's running on Fargate resources in a private subnet to send outbound traffic to the internet (for example, to pull container images), the private subnet requires a NAT gateway be attached to route requests to the internet. For more information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task-networking.html">Amazon ECS task networking</a> in the <i>Amazon Elastic Container Service Developer Guide</i>. The default value is "<code>DISABLED</code>".</p>
    pub fn assign_public_ip(&self) -> ::std::option::Option<&super::super::types::AssignPublicIp> {
...
impl NetworkConfiguration {
    ...
    pub fn builder() -> super::super::types::builders::NetworkConfigurationBuilder {
        super::super::types::builders::NetworkConfigurationBuilder::default()
    }
}
...
pub struct NetworkConfigurationBuilder {
    pub(crate) assign_public_ip: ::std::option::Option<super::super::types::AssignPublicIp>,
}
impl NetworkConfigurationBuilder {
    /// <p>Indicates whether the job has a public IP address. For a job that's running on Fargate resources in a private subnet to send outbound traffic to the internet (for example, to pull container images), the private subnet requires a NAT gateway be attached to route requests to the internet. For more information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task-networking.html">Amazon ECS task networking</a> in the <i>Amazon Elastic Container Service Developer Guide</i>. The default value is "<code>DISABLED</code>".</p>
    pub fn assign_public_ip(mut self, input: super::super::types::AssignPublicIp) -> Self {
        self.assign_public_ip = ::std::option::Option::Some(input);
        self
    }
    /// <p>Indicates whether the job has a public IP address. For a job that's running on Fargate resources in a private subnet to send outbound traffic to the internet (for example, to pull container images), the private subnet requires a NAT gateway be attached to route requests to the internet. For more information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task-networking.html">Amazon ECS task networking</a> in the <i>Amazon Elastic Container Service Developer Guide</i>. The default value is "<code>DISABLED</code>".</p>
    pub fn set_assign_public_ip(mut self, input: ::std::option::Option<super::super::types::AssignPublicIp>) -> Self {
        self.assign_public_ip = input;
        self
    }
    /// <p>Indicates whether the job has a public IP address. For a job that's running on Fargate resources in a private subnet to send outbound traffic to the internet (for example, to pull container images), the private subnet requires a NAT gateway be attached to route requests to the internet. For more information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task-networking.html">Amazon ECS task networking</a> in the <i>Amazon Elastic Container Service Developer Guide</i>. The default value is "<code>DISABLED</code>".</p>
    pub fn get_assign_public_ip(&self) -> &::std::option::Option<super::super::types::AssignPublicIp> {
        &self.assign_public_ip
    }
    /// Consumes the builder and constructs a [`NetworkConfiguration`](crate::types::NetworkConfiguration).
    pub fn build(self) -> super::super::types::NetworkConfiguration {
        super::super::types::NetworkConfiguration {
