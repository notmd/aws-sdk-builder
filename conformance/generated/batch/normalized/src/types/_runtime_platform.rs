...
impl RuntimePlatform {
    ...
    pub fn builder() -> super::super::types::builders::RuntimePlatformBuilder {
        super::super::types::builders::RuntimePlatformBuilder::default()
    }
}
...
impl RuntimePlatformBuilder {
    ...
    pub fn build(self) -> super::super::types::RuntimePlatform {
        super::super::types::RuntimePlatform {
