...
impl EksContainerSecurityContext {
    ...
    pub fn builder() -> super::super::types::builders::EksContainerSecurityContextBuilder {
        super::super::types::builders::EksContainerSecurityContextBuilder::default()
    }
}
...
impl EksContainerSecurityContextBuilder {
    ...
    pub fn build(self) -> super::super::types::EksContainerSecurityContext {
        super::super::types::EksContainerSecurityContext {
