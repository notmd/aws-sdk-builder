...
pub struct Device {
    ...
    pub permissions: ::std::option::Option<::std::vec::Vec<super::super::types::DeviceCgroupPermission>>,
}
impl Device {
    /// <p>The path for the device on the host container instance.</p>
    ...
    pub fn permissions(&self) -> &[super::super::types::DeviceCgroupPermission] {
        self.permissions.as_deref().unwrap_or_default()
    }
}
impl Device {
    /// Creates a new builder-style object to manufacture [`Device`](crate::types::Device).
    pub fn builder() -> super::super::types::builders::DeviceBuilder {
        super::super::types::builders::DeviceBuilder::default()
    }
}
...
pub struct DeviceBuilder {
    ...
    pub(crate) permissions: ::std::option::Option<::std::vec::Vec<super::super::types::DeviceCgroupPermission>>,
}
impl DeviceBuilder {
    /// <p>The path for the device on the host container instance.</p>
    ...
    ///
    /// <p>The explicit permissions to provide to the container for the device. By default, the container has permissions for <code>read</code>, <code>write</code>, and <code>mknod</code> for the device.</p>
    pub fn permissions(mut self, input: super::super::types::DeviceCgroupPermission) -> Self {
    ...
    /// <p>The explicit permissions to provide to the container for the device. By default, the container has permissions for <code>read</code>, <code>write</code>, and <code>mknod</code> for the device.</p>
    pub fn set_permissions(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::DeviceCgroupPermission>>) -> Self {
        self.permissions = input;
        self
    }
    /// <p>The explicit permissions to provide to the container for the device. By default, the container has permissions for <code>read</code>, <code>write</code>, and <code>mknod</code> for the device.</p>
    pub fn get_permissions(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::DeviceCgroupPermission>> {
        &self.permissions
    }
