...
impl EksContainerOverride {
    ...
    pub fn builder() -> super::super::types::builders::EksContainerOverrideBuilder {
        super::super::types::builders::EksContainerOverrideBuilder::default()
    }
}
...
impl EksContainerOverrideBuilder {
    ...
    pub fn build(self) -> super::super::types::EksContainerOverride {
        super::super::types::EksContainerOverride {
            name: self.name,
            image: self.image,
