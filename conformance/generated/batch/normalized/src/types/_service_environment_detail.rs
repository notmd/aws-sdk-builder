...
impl ServiceEnvironmentDetail {
    ...
    /// <p>The current status of the service environment.</p>
    pub fn status(&self) -> ::std::option::Option<&super::super::types::ServiceEnvironmentStatus> {
        self.status.as_ref()
    }
    /// <p>The capacity limits for the service environment. This defines the maximum resources that can be used by service jobs in this environment.</p>
...
impl ServiceEnvironmentDetail {
    ...
    pub fn builder() -> super::super::types::builders::ServiceEnvironmentDetailBuilder {
        super::super::types::builders::ServiceEnvironmentDetailBuilder::default()
    }
}
...
pub struct ServiceEnvironmentDetailBuilder {
    ...
    pub(crate) service_environment_type: ::std::option::Option<super::super::types::ServiceEnvironmentType>,
    pub(crate) state: ::std::option::Option<super::super::types::ServiceEnvironmentState>,
    pub(crate) status: ::std::option::Option<super::super::types::ServiceEnvironmentStatus>,
    pub(crate) capacity_limits: ::std::option::Option<::std::vec::Vec<super::super::types::CapacityLimit>>,
...
impl ServiceEnvironmentDetailBuilder {
    ...
    /// <p>The type of service environment. For SageMaker Training jobs, this value is <code>SAGEMAKER_TRAINING</code>.</p>
    /// This field is required.
    pub fn service_environment_type(mut self, input: super::super::types::ServiceEnvironmentType) -> Self {
        self.service_environment_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The type of service environment. For SageMaker Training jobs, this value is <code>SAGEMAKER_TRAINING</code>.</p>
    pub fn set_service_environment_type(mut self, input: ::std::option::Option<super::super::types::ServiceEnvironmentType>) -> Self {
        self.service_environment_type = input;
        self
    }
    /// <p>The type of service environment. For SageMaker Training jobs, this value is <code>SAGEMAKER_TRAINING</code>.</p>
    pub fn get_service_environment_type(&self) -> &::std::option::Option<super::super::types::ServiceEnvironmentType> {
        &self.service_environment_type
    }
    /// <p>The state of the service environment. Valid values are <code>ENABLED</code> and <code>DISABLED</code>.</p>
    pub fn state(mut self, input: super::super::types::ServiceEnvironmentState) -> Self {
        self.state = ::std::option::Option::Some(input);
        self
    }
    /// <p>The state of the service environment. Valid values are <code>ENABLED</code> and <code>DISABLED</code>.</p>
    pub fn set_state(mut self, input: ::std::option::Option<super::super::types::ServiceEnvironmentState>) -> Self {
        self.state = input;
        self
    }
    /// <p>The state of the service environment. Valid values are <code>ENABLED</code> and <code>DISABLED</code>.</p>
    pub fn get_state(&self) -> &::std::option::Option<super::super::types::ServiceEnvironmentState> {
        &self.state
    }
    /// <p>The current status of the service environment.</p>
    pub fn status(mut self, input: super::super::types::ServiceEnvironmentStatus) -> Self {
        self.status = ::std::option::Option::Some(input);
        self
    }
    /// <p>The current status of the service environment.</p>
    pub fn set_status(mut self, input: ::std::option::Option<super::super::types::ServiceEnvironmentStatus>) -> Self {
        self.status = input;
        self
    }
    /// <p>The current status of the service environment.</p>
    pub fn get_status(&self) -> &::std::option::Option<super::super::types::ServiceEnvironmentStatus> {
        &self.status
    }
    ...
    ///
    /// <p>The capacity limits for the service environment. This defines the maximum resources that can be used by service jobs in this environment.</p>
    pub fn capacity_limits(mut self, input: super::super::types::CapacityLimit) -> Self {
    ...
    /// <p>The capacity limits for the service environment. This defines the maximum resources that can be used by service jobs in this environment.</p>
    pub fn set_capacity_limits(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::CapacityLimit>>) -> Self {
        self.capacity_limits = input;
        self
    }
    /// <p>The capacity limits for the service environment. This defines the maximum resources that can be used by service jobs in this environment.</p>
    pub fn get_capacity_limits(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::CapacityLimit>> {
