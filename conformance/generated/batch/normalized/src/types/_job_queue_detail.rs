...
pub struct JobQueueDetail {
    ...
    pub status: ::std::option::Option<super::super::types::JqStatus>,
    ...
    pub job_queue_type: ::std::option::Option<super::super::types::JobQueueType>,
    ...
    pub job_state_time_limit_actions: ::std::option::Option<::std::vec::Vec<super::super::types::JobStateTimeLimitAction>>,
}
impl JobQueueDetail {
    /// <p>The job queue name.</p>
    ...
    /// <p>The status of the job queue (for example, <code>CREATING</code> or <code>VALID</code>).</p>
    pub fn status(&self) -> ::std::option::Option<&super::super::types::JqStatus> {
        self.status.as_ref()
    }
    /// <p>A short, human-readable string to provide additional details for the current status of the job queue.</p>
    ...
    pub fn service_environment_order(&self) -> &[super::super::types::ServiceEnvironmentOrder] {
        self.service_environment_order.as_deref().unwrap_or_default()
    }
    /// <p>The type of job queue. For service jobs that run on SageMaker Training, this value is <code>SAGEMAKER_TRAINING</code>. For regular container jobs, this value is <code>EKS</code>, <code>ECS</code>, or <code>ECS_FARGATE</code> depending on the compute environment.</p>
    pub fn job_queue_type(&self) -> ::std::option::Option<&super::super::types::JobQueueType> {
    ...
    pub fn job_state_time_limit_actions(&self) -> &[super::super::types::JobStateTimeLimitAction] {
...
impl JobQueueDetail {
    ...
    pub fn builder() -> super::super::types::builders::JobQueueDetailBuilder {
        super::super::types::builders::JobQueueDetailBuilder::default()
    }
}
...
pub struct JobQueueDetailBuilder {
    ...
    pub(crate) state: ::std::option::Option<super::super::types::JqState>,
    pub(crate) scheduling_policy_arn: ::std::option::Option<::std::string::String>,
    pub(crate) status: ::std::option::Option<super::super::types::JqStatus>,
    pub(crate) status_reason: ::std::option::Option<::std::string::String>,
    pub(crate) priority: ::std::option::Option<i32>,
    pub(crate) compute_environment_order: ::std::option::Option<::std::vec::Vec<super::super::types::ComputeEnvironmentOrder>>,
    pub(crate) service_environment_order: ::std::option::Option<::std::vec::Vec<super::super::types::ServiceEnvironmentOrder>>,
    pub(crate) job_queue_type: ::std::option::Option<super::super::types::JobQueueType>,
    pub(crate) tags: ::std::option::Option<::std::collections::HashMap<::std::string::String, ::std::string::String>>,
    pub(crate) job_state_time_limit_actions: ::std::option::Option<::std::vec::Vec<super::super::types::JobStateTimeLimitAction>>,
}
impl JobQueueDetailBuilder {
    ...
    /// <p>Describes the ability of the queue to accept new jobs. If the job queue state is <code>ENABLED</code>, it can accept jobs. If the job queue state is <code>DISABLED</code>, new jobs can't be added to the queue, but jobs already in the queue can finish.</p>
    /// This field is required.
    pub fn state(mut self, input: super::super::types::JqState) -> Self {
        self.state = ::std::option::Option::Some(input);
        self
    }
    /// <p>Describes the ability of the queue to accept new jobs. If the job queue state is <code>ENABLED</code>, it can accept jobs. If the job queue state is <code>DISABLED</code>, new jobs can't be added to the queue, but jobs already in the queue can finish.</p>
    pub fn set_state(mut self, input: ::std::option::Option<super::super::types::JqState>) -> Self {
        self.state = input;
        self
    }
    /// <p>Describes the ability of the queue to accept new jobs. If the job queue state is <code>ENABLED</code>, it can accept jobs. If the job queue state is <code>DISABLED</code>, new jobs can't be added to the queue, but jobs already in the queue can finish.</p>
    pub fn get_state(&self) -> &::std::option::Option<super::super::types::JqState> {
        &self.state
    }
    /// <p>The Amazon Resource Name (ARN) of the scheduling policy. The format is <code>aws:<i>Partition</i>:batch:<i>Region</i>:<i>Account</i>:scheduling-policy/<i>Name</i> </code>. For example, <code>aws:aws:batch:us-west-2:123456789012:scheduling-policy/MySchedulingPolicy</code>.</p>
    ...
    /// <p>The status of the job queue (for example, <code>CREATING</code> or <code>VALID</code>).</p>
    pub fn status(mut self, input: super::super::types::JqStatus) -> Self {
        self.status = ::std::option::Option::Some(input);
        self
    }
    /// <p>The status of the job queue (for example, <code>CREATING</code> or <code>VALID</code>).</p>
    pub fn set_status(mut self, input: ::std::option::Option<super::super::types::JqStatus>) -> Self {
        self.status = input;
        self
    }
    /// <p>The status of the job queue (for example, <code>CREATING</code> or <code>VALID</code>).</p>
    pub fn get_status(&self) -> &::std::option::Option<super::super::types::JqStatus> {
        &self.status
    }
    /// <p>A short, human-readable string to provide additional details for the current status of the job queue.</p>
    ...
    ///
    /// <p>The compute environments that are attached to the job queue and the order that job placement is preferred. Compute environments are selected for job placement in ascending order.</p>
    pub fn compute_environment_order(mut self, input: super::super::types::ComputeEnvironmentOrder) -> Self {
    ...
    /// <p>The compute environments that are attached to the job queue and the order that job placement is preferred. Compute environments are selected for job placement in ascending order.</p>
    pub fn get_compute_environment_order(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::ComputeEnvironmentOrder>> {
    ...
    ///
    /// <p>The order of the service environment associated with the job queue. Job queues with a higher priority are evaluated first when associated with the same service environment.</p>
    pub fn service_environment_order(mut self, input: super::super::types::ServiceEnvironmentOrder) -> Self {
    ...
    /// <p>The order of the service environment associated with the job queue. Job queues with a higher priority are evaluated first when associated with the same service environment.</p>
    pub fn get_service_environment_order(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::ServiceEnvironmentOrder>> {
        &self.service_environment_order
    }
    /// <p>The type of job queue. For service jobs that run on SageMaker Training, this value is <code>SAGEMAKER_TRAINING</code>. For regular container jobs, this value is <code>EKS</code>, <code>ECS</code>, or <code>ECS_FARGATE</code> depending on the compute environment.</p>
    pub fn job_queue_type(mut self, input: super::super::types::JobQueueType) -> Self {
        self.job_queue_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The type of job queue. For service jobs that run on SageMaker Training, this value is <code>SAGEMAKER_TRAINING</code>. For regular container jobs, this value is <code>EKS</code>, <code>ECS</code>, or <code>ECS_FARGATE</code> depending on the compute environment.</p>
    pub fn set_job_queue_type(mut self, input: ::std::option::Option<super::super::types::JobQueueType>) -> Self {
        self.job_queue_type = input;
        self
    }
    /// <p>The type of job queue. For service jobs that run on SageMaker Training, this value is <code>SAGEMAKER_TRAINING</code>. For regular container jobs, this value is <code>EKS</code>, <code>ECS</code>, or <code>ECS_FARGATE</code> depending on the compute environment.</p>
    pub fn get_job_queue_type(&self) -> &::std::option::Option<super::super::types::JobQueueType> {
        &self.job_queue_type
    }
    ...
    ///
    /// <p>The set of actions that Batch perform on jobs that remain at the head of the job queue in the specified state longer than specified times. Batch will perform each action after <code>maxTimeSeconds</code> has passed.</p>
    pub fn job_state_time_limit_actions(mut self, input: super::super::types::JobStateTimeLimitAction) -> Self {
    ...
    /// <p>The set of actions that Batch perform on jobs that remain at the head of the job queue in the specified state longer than specified times. Batch will perform each action after <code>maxTimeSeconds</code> has passed.</p>
    pub fn get_job_state_time_limit_actions(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::JobStateTimeLimitAction>> {
