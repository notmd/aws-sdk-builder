...
impl UpdatePolicy {
    ...
    pub fn builder() -> super::super::types::builders::UpdatePolicyBuilder {
        super::super::types::builders::UpdatePolicyBuilder::default()
    }
}
...
impl UpdatePolicyBuilder {
    ...
    pub fn build(self) -> super::super::types::UpdatePolicy {
        super::super::types::UpdatePolicy {
