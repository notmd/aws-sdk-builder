...
impl KeyValuePair {
    ...
    pub fn builder() -> super::super::types::builders::KeyValuePairBuilder {
        super::super::types::builders::KeyValuePairBuilder::default()
    }
}
...
impl KeyValuePairBuilder {
    ...
    pub fn build(self) -> super::super::types::KeyValuePair {
        super::super::types::KeyValuePair {
            name: self.name,
            value: self.value,
        }
    }
