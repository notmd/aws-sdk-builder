...
impl ServiceJobRetryStrategy {
    ...
    pub fn evaluate_on_exit(&self) -> &[super::super::types::ServiceJobEvaluateOnExit] {
...
impl ServiceJobRetryStrategy {
    ...
    pub fn builder() -> super::super::types::builders::ServiceJobRetryStrategyBuilder {
        super::super::types::builders::ServiceJobRetryStrategyBuilder::default()
    }
}
...
pub struct ServiceJobRetryStrategyBuilder {
    ...
    pub(crate) evaluate_on_exit: ::std::option::Option<::std::vec::Vec<super::super::types::ServiceJobEvaluateOnExit>>,
}
impl ServiceJobRetryStrategyBuilder {
    ...
    ///
    /// <p>Array of <code>ServiceJobEvaluateOnExit</code> objects that specify conditions under which the service job should be retried or failed.</p>
    pub fn evaluate_on_exit(mut self, input: super::super::types::ServiceJobEvaluateOnExit) -> Self {
    ...
    /// <p>Array of <code>ServiceJobEvaluateOnExit</code> objects that specify conditions under which the service job should be retried or failed.</p>
    pub fn set_evaluate_on_exit(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::ServiceJobEvaluateOnExit>>) -> Self {
        self.evaluate_on_exit = input;
        self
    }
    /// <p>Array of <code>ServiceJobEvaluateOnExit</code> objects that specify conditions under which the service job should be retried or failed.</p>
    pub fn get_evaluate_on_exit(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::ServiceJobEvaluateOnExit>> {
