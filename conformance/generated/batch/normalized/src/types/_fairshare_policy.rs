...
pub struct FairsharePolicy {
    ...
    pub share_distribution: ::std::option::Option<::std::vec::Vec<super::super::types::ShareAttributes>>,
}
impl FairsharePolicy {
    ...
    pub fn share_distribution(&self) -> &[super::super::types::ShareAttributes] {
...
impl FairsharePolicy {
    ...
    pub fn builder() -> super::super::types::builders::FairsharePolicyBuilder {
        super::super::types::builders::FairsharePolicyBuilder::default()
    }
}
...
pub struct FairsharePolicyBuilder {
    ...
    pub(crate) share_distribution: ::std::option::Option<::std::vec::Vec<super::super::types::ShareAttributes>>,
}
impl FairsharePolicyBuilder {
    ...
    ///
    /// <p>An array of <code>SharedIdentifier</code> objects that contain the weights for the share identifiers for the fair-share policy. Share identifiers that aren't included have a default weight of <code>1.0</code>.</p>
    pub fn share_distribution(mut self, input: super::super::types::ShareAttributes) -> Self {
    ...
    /// <p>An array of <code>SharedIdentifier</code> objects that contain the weights for the share identifiers for the fair-share policy. Share identifiers that aren't included have a default weight of <code>1.0</code>.</p>
    pub fn set_share_distribution(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::ShareAttributes>>) -> Self {
        self.share_distribution = input;
        self
    }
    /// <p>An array of <code>SharedIdentifier</code> objects that contain the weights for the share identifiers for the fair-share policy. Share identifiers that aren't included have a default weight of <code>1.0</code>.</p>
    pub fn get_share_distribution(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::ShareAttributes>> {
        &self.share_distribution
    }
    /// Consumes the builder and constructs a [`FairsharePolicy`](crate::types::FairsharePolicy).
    pub fn build(self) -> super::super::types::FairsharePolicy {
        super::super::types::FairsharePolicy {
