...
pub struct AttemptEcsTaskDetails {
    ...
    pub containers: ::std::option::Option<::std::vec::Vec<super::super::types::AttemptTaskContainerDetails>>,
}
impl AttemptEcsTaskDetails {
    ...
    pub fn containers(&self) -> &[super::super::types::AttemptTaskContainerDetails] {
...
impl AttemptEcsTaskDetails {
    ...
    pub fn builder() -> super::super::types::builders::AttemptEcsTaskDetailsBuilder {
        super::super::types::builders::AttemptEcsTaskDetailsBuilder::default()
    }
}
...
pub struct AttemptEcsTaskDetailsBuilder {
    ...
    pub(crate) containers: ::std::option::Option<::std::vec::Vec<super::super::types::AttemptTaskContainerDetails>>,
}
impl AttemptEcsTaskDetailsBuilder {
    ...
    ///
    /// <p>A list of containers that are included in the <code>taskProperties</code> list.</p>
    pub fn containers(mut self, input: super::super::types::AttemptTaskContainerDetails) -> Self {
    ...
    /// <p>A list of containers that are included in the <code>taskProperties</code> list.</p>
    pub fn set_containers(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::AttemptTaskContainerDetails>>) -> Self {
        self.containers = input;
        self
    }
    /// <p>A list of containers that are included in the <code>taskProperties</code> list.</p>
    pub fn get_containers(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::AttemptTaskContainerDetails>> {
        &self.containers
    }
    /// Consumes the builder and constructs a [`AttemptEcsTaskDetails`](crate::types::AttemptEcsTaskDetails).
    pub fn build(self) -> super::super::types::AttemptEcsTaskDetails {
        super::super::types::AttemptEcsTaskDetails {
