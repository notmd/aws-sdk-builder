...
impl ContainerSummary {
    ...
    pub fn builder() -> super::super::types::builders::ContainerSummaryBuilder {
        super::super::types::builders::ContainerSummaryBuilder::default()
    }
}
...
impl ContainerSummaryBuilder {
    ...
    pub fn build(self) -> super::super::types::ContainerSummary {
        super::super::types::ContainerSummary {
