...
impl ConsumableResourceRequirement {
    ...
    pub fn builder() -> super::super::types::builders::ConsumableResourceRequirementBuilder {
        super::super::types::builders::ConsumableResourceRequirementBuilder::default()
    }
}
...
impl ConsumableResourceRequirementBuilder {
    ...
    pub fn build(self) -> super::super::types::ConsumableResourceRequirement {
        super::super::types::ConsumableResourceRequirement {
