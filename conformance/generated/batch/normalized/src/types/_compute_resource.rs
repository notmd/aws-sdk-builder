...
pub struct ComputeResource {
    ...
    pub allocation_strategy: ::std::option::Option<super::super::types::CrAllocationStrategy>,
    ...
    /// <p>This parameter isn't applicable to jobs that are running on Fargate resources. Don't specify it.</p>
    /// </note>
    pub launch_template: ::std::option::Option<super::super::types::LaunchTemplateSpecification>,
    /// <p>Provides information that's used to select Amazon Machine Images (AMIs) for Amazon EC2 instances in the compute environment. If <code>Ec2Configuration</code> isn't specified, the default is <code>ECS_AL2023</code> for EC2 (ECS) compute environments and <code>EKS_AL2023</code> for EKS compute environments.</p>
    /// <p>One or two values can be provided.</p><note>
    /// <p>This parameter isn't applicable to jobs that are running on Fargate resources. Don't specify it.</p>
    /// </note>
    pub ec2_configuration: ::std::option::Option<::std::vec::Vec<super::super::types::Ec2Configuration>>,
    /// <p>The scaling policy configuration for the compute environment.</p><note>
    /// <p>This parameter isn't applicable to jobs that are running on Fargate resources. Don't specify it.</p>
    /// </note>
    pub scaling_policy: ::std::option::Option<super::super::types::ComputeScalingPolicy>,
    ...
    pub managed_instances_provider: ::std::option::Option<super::super::types::ManagedInstancesProvider>,
...
impl ComputeResource {
    ...
    /// </dl>
    /// <p>With any allocation strategy except <code>BEST_FIT</code> using On-Demand (<code>EC2</code>) compute resources, Batch might need to exceed <code>maxvCpus</code> to meet your capacity requirements. In this event, Batch never exceeds <code>maxvCpus</code> by more than a single instance.</p>
    pub fn allocation_strategy(&self) -> ::std::option::Option<&super::super::types::CrAllocationStrategy> {
    ...
    /// <p>This parameter isn't applicable to jobs that are running on Fargate resources. Don't specify it.</p>
    /// </note>
    pub fn launch_template(&self) -> ::std::option::Option<&super::super::types::LaunchTemplateSpecification> {
    ...
    pub fn ec2_configuration(&self) -> &[super::super::types::Ec2Configuration] {
        self.ec2_configuration.as_deref().unwrap_or_default()
    }
    /// <p>The scaling policy configuration for the compute environment.</p><note>
    /// <p>This parameter isn't applicable to jobs that are running on Fargate resources. Don't specify it.</p>
    /// </note>
    pub fn scaling_policy(&self) -> ::std::option::Option<&super::super::types::ComputeScalingPolicy> {
        self.scaling_policy.as_ref()
    }
    /// <p>The configuration for the Amazon ECS Managed Instances capacity provider. This parameter is required when <code>computeResources.type</code> is <code>ECS_MANAGED_INSTANCES</code> and must not be specified for other compute environment types.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/ecs_managed_instances.html">Amazon ECS Managed Instances compute environments</a> in the <i>Batch User Guide</i>.</p>
    pub fn managed_instances_provider(&self) -> ::std::option::Option<&super::super::types::ManagedInstancesProvider> {
...
impl ComputeResource {
    ...
    pub fn builder() -> super::super::types::builders::ComputeResourceBuilder {
        super::super::types::builders::ComputeResourceBuilder::default()
    }
}
...
pub struct ComputeResourceBuilder {
    pub(crate) r#type: ::std::option::Option<super::super::types::CrType>,
    pub(crate) allocation_strategy: ::std::option::Option<super::super::types::CrAllocationStrategy>,
    ...
    pub(crate) launch_template: ::std::option::Option<super::super::types::LaunchTemplateSpecification>,
    pub(crate) ec2_configuration: ::std::option::Option<::std::vec::Vec<super::super::types::Ec2Configuration>>,
    pub(crate) scaling_policy: ::std::option::Option<super::super::types::ComputeScalingPolicy>,
    pub(crate) managed_instances_provider: ::std::option::Option<super::super::types::ManagedInstancesProvider>,
...
impl ComputeResourceBuilder {
    ...
    pub fn r#type(mut self, input: super::super::types::CrType) -> Self {
    ...
    /// <p>Multi-node parallel jobs aren't supported on Spot Instances or Amazon ECS Managed Instances.</p>
    /// </note>
    pub fn set_type(mut self, input: ::std::option::Option<super::super::types::CrType>) -> Self {
        self.r#type = input;
        self
    }
    /// <p>The type of compute environment: <code>EC2</code>, <code>SPOT</code>, <code>FARGATE</code>, <code>FARGATE_SPOT</code>, or <code>ECS_MANAGED_INSTANCES</code>. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/compute_environments.html">Compute environments</a> in the <i>Batch User Guide</i>.</p>
    ...
    /// <p>Multi-node parallel jobs aren't supported on Spot Instances or Amazon ECS Managed Instances.</p>
    /// </note>
    pub fn get_type(&self) -> &::std::option::Option<super::super::types::CrType> {
        &self.r#type
    }
    /// <p>The allocation strategy to use for the compute resource if not enough instances of the best fitting instance type can be allocated. This might be because of availability of the instance type in the Region or <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-resource-limits.html">Amazon EC2 service limits</a>. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/allocation-strategies.html">Allocation strategies</a> in the <i>Batch User Guide</i>.</p><note>
    /// <p>This parameter isn't applicable to jobs that are running on Fargate resources. Don't specify it.</p>
    ...
    /// </dl>
    /// <p>With any allocation strategy except <code>BEST_FIT</code> using On-Demand (<code>EC2</code>) compute resources, Batch might need to exceed <code>maxvCpus</code> to meet your capacity requirements. In this event, Batch never exceeds <code>maxvCpus</code> by more than a single instance.</p>
    pub fn allocation_strategy(mut self, input: super::super::types::CrAllocationStrategy) -> Self {
    ...
    /// </dl>
    /// <p>With any allocation strategy except <code>BEST_FIT</code> using On-Demand (<code>EC2</code>) compute resources, Batch might need to exceed <code>maxvCpus</code> to meet your capacity requirements. In this event, Batch never exceeds <code>maxvCpus</code> by more than a single instance.</p>
    pub fn set_allocation_strategy(mut self, input: ::std::option::Option<super::super::types::CrAllocationStrategy>) -> Self {
    ...
    /// </dl>
    /// <p>With any allocation strategy except <code>BEST_FIT</code> using On-Demand (<code>EC2</code>) compute resources, Batch might need to exceed <code>maxvCpus</code> to meet your capacity requirements. In this event, Batch never exceeds <code>maxvCpus</code> by more than a single instance.</p>
    pub fn get_allocation_strategy(&self) -> &::std::option::Option<super::super::types::CrAllocationStrategy> {
    ...
    /// <p>This parameter isn't applicable to jobs that are running on Fargate resources. Don't specify it.</p>
    /// </note>
    pub fn launch_template(mut self, input: super::super::types::LaunchTemplateSpecification) -> Self {
    ...
    /// <p>This parameter isn't applicable to jobs that are running on Fargate resources. Don't specify it.</p>
    /// </note>
    pub fn set_launch_template(mut self, input: ::std::option::Option<super::super::types::LaunchTemplateSpecification>) -> Self {
    ...
    /// <p>This parameter isn't applicable to jobs that are running on Fargate resources. Don't specify it.</p>
    /// </note>
    pub fn get_launch_template(&self) -> &::std::option::Option<super::super::types::LaunchTemplateSpecification> {
    ...
    /// <p>This parameter isn't applicable to jobs that are running on Fargate resources. Don't specify it.</p>
    /// </note>
    pub fn ec2_configuration(mut self, input: super::super::types::Ec2Configuration) -> Self {
    ...
    /// <p>This parameter isn't applicable to jobs that are running on Fargate resources. Don't specify it.</p>
    /// </note>
    pub fn set_ec2_configuration(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::Ec2Configuration>>) -> Self {
    ...
    /// <p>This parameter isn't applicable to jobs that are running on Fargate resources. Don't specify it.</p>
    /// </note>
    pub fn get_ec2_configuration(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::Ec2Configuration>> {
        &self.ec2_configuration
    }
    /// <p>The scaling policy configuration for the compute environment.</p><note>
    /// <p>This parameter isn't applicable to jobs that are running on Fargate resources. Don't specify it.</p>
    /// </note>
    pub fn scaling_policy(mut self, input: super::super::types::ComputeScalingPolicy) -> Self {
    ...
    /// <p>This parameter isn't applicable to jobs that are running on Fargate resources. Don't specify it.</p>
    /// </note>
    pub fn set_scaling_policy(mut self, input: ::std::option::Option<super::super::types::ComputeScalingPolicy>) -> Self {
    ...
    /// <p>This parameter isn't applicable to jobs that are running on Fargate resources. Don't specify it.</p>
    /// </note>
    pub fn get_scaling_policy(&self) -> &::std::option::Option<super::super::types::ComputeScalingPolicy> {
        &self.scaling_policy
    }
    /// <p>The configuration for the Amazon ECS Managed Instances capacity provider. This parameter is required when <code>computeResources.type</code> is <code>ECS_MANAGED_INSTANCES</code> and must not be specified for other compute environment types.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/ecs_managed_instances.html">Amazon ECS Managed Instances compute environments</a> in the <i>Batch User Guide</i>.</p>
    pub fn managed_instances_provider(mut self, input: super::super::types::ManagedInstancesProvider) -> Self {
        self.managed_instances_provider = ::std::option::Option::Some(input);
        self
    }
    /// <p>The configuration for the Amazon ECS Managed Instances capacity provider. This parameter is required when <code>computeResources.type</code> is <code>ECS_MANAGED_INSTANCES</code> and must not be specified for other compute environment types.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/ecs_managed_instances.html">Amazon ECS Managed Instances compute environments</a> in the <i>Batch User Guide</i>.</p>
    pub fn set_managed_instances_provider(mut self, input: ::std::option::Option<super::super::types::ManagedInstancesProvider>) -> Self {
        self.managed_instances_provider = input;
        self
    }
    /// <p>The configuration for the Amazon ECS Managed Instances capacity provider. This parameter is required when <code>computeResources.type</code> is <code>ECS_MANAGED_INSTANCES</code> and must not be specified for other compute environment types.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/ecs_managed_instances.html">Amazon ECS Managed Instances compute environments</a> in the <i>Batch User Guide</i>.</p>
    pub fn get_managed_instances_provider(&self) -> &::std::option::Option<super::super::types::ManagedInstancesProvider> {
