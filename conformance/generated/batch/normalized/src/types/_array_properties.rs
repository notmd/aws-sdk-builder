...
impl ArrayProperties {
    ...
    pub fn builder() -> super::super::types::builders::ArrayPropertiesBuilder {
        super::super::types::builders::ArrayPropertiesBuilder::default()
    }
}
...
impl ArrayPropertiesBuilder {
    ...
    pub fn build(self) -> super::super::types::ArrayProperties {
        super::super::types::ArrayProperties { size: self.size }
    }
}
