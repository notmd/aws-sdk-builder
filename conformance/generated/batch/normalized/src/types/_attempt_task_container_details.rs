...
impl AttemptTaskContainerDetails {
    ...
    pub fn builder() -> super::super::types::builders::AttemptTaskContainerDetailsBuilder {
        super::super::types::builders::AttemptTaskContainerDetailsBuilder::default()
    }
}
...
impl AttemptTaskContainerDetailsBuilder {
    ...
    pub fn build(self) -> super::super::types::AttemptTaskContainerDetails {
        super::super::types::AttemptTaskContainerDetails {
