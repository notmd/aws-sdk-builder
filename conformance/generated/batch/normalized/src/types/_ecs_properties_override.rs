...
pub struct EcsPropertiesOverride {
    ...
    /// </note>
    pub task_properties: ::std::option::Option<::std::vec::Vec<super::super::types::TaskPropertiesOverride>>,
}
impl EcsPropertiesOverride {
    ...
    pub fn task_properties(&self) -> &[super::super::types::TaskPropertiesOverride] {
...
impl EcsPropertiesOverride {
    ...
    pub fn builder() -> super::super::types::builders::EcsPropertiesOverrideBuilder {
        super::super::types::builders::EcsPropertiesOverrideBuilder::default()
    }
}
...
pub struct EcsPropertiesOverrideBuilder {
    pub(crate) task_properties: ::std::option::Option<::std::vec::Vec<super::super::types::TaskPropertiesOverride>>,
}
impl EcsPropertiesOverrideBuilder {
    ...
    /// <p>This object is currently limited to one element.</p>
    /// </note>
    pub fn task_properties(mut self, input: super::super::types::TaskPropertiesOverride) -> Self {
    ...
    /// <p>This object is currently limited to one element.</p>
    /// </note>
    pub fn set_task_properties(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::TaskPropertiesOverride>>) -> Self {
    ...
    /// <p>This object is currently limited to one element.</p>
    /// </note>
    pub fn get_task_properties(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::TaskPropertiesOverride>> {
        &self.task_properties
    }
    /// Consumes the builder and constructs a [`EcsPropertiesOverride`](crate::types::EcsPropertiesOverride).
    pub fn build(self) -> super::super::types::EcsPropertiesOverride {
        super::super::types::EcsPropertiesOverride {
