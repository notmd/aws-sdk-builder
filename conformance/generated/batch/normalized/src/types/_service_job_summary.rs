...
pub struct ServiceJobSummary {
    ...
    pub latest_attempt: ::std::option::Option<super::super::types::LatestServiceJobAttempt>,
    ...
    pub capacity_usage: ::std::option::Option<::std::vec::Vec<super::super::types::ServiceJobCapacityUsageSummary>>,
    ...
    pub status: ::std::option::Option<super::super::types::ServiceJobStatus>,
...
impl ServiceJobSummary {
    /// <p>Information about the latest attempt for the service job.</p>
    pub fn latest_attempt(&self) -> ::std::option::Option<&super::super::types::LatestServiceJobAttempt> {
    ...
    pub fn capacity_usage(&self) -> &[super::super::types::ServiceJobCapacityUsageSummary] {
    ...
    /// <p>The current status of the service job.</p>
    pub fn status(&self) -> ::std::option::Option<&super::super::types::ServiceJobStatus> {
        self.status.as_ref()
    }
    /// <p>A short string to provide more details on the current status of the service job.</p>
...
impl ServiceJobSummary {
    ...
    pub fn builder() -> super::super::types::builders::ServiceJobSummaryBuilder {
        super::super::types::builders::ServiceJobSummaryBuilder::default()
    }
}
...
pub struct ServiceJobSummaryBuilder {
    pub(crate) latest_attempt: ::std::option::Option<super::super::types::LatestServiceJobAttempt>,
    pub(crate) capacity_usage: ::std::option::Option<::std::vec::Vec<super::super::types::ServiceJobCapacityUsageSummary>>,
    pub(crate) created_at: ::std::option::Option<i64>,
    pub(crate) job_arn: ::std::option::Option<::std::string::String>,
    pub(crate) job_id: ::std::option::Option<::std::string::String>,
    pub(crate) job_name: ::std::option::Option<::std::string::String>,
    pub(crate) scheduled_at: ::std::option::Option<i64>,
    pub(crate) service_job_type: ::std::option::Option<super::super::types::ServiceJobType>,
    ...
    pub(crate) status: ::std::option::Option<super::super::types::ServiceJobStatus>,
...
impl ServiceJobSummaryBuilder {
    /// <p>Information about the latest attempt for the service job.</p>
    pub fn latest_attempt(mut self, input: super::super::types::LatestServiceJobAttempt) -> Self {
        self.latest_attempt = ::std::option::Option::Some(input);
        self
    }
    /// <p>Information about the latest attempt for the service job.</p>
    pub fn set_latest_attempt(mut self, input: ::std::option::Option<super::super::types::LatestServiceJobAttempt>) -> Self {
        self.latest_attempt = input;
        self
    }
    /// <p>Information about the latest attempt for the service job.</p>
    pub fn get_latest_attempt(&self) -> &::std::option::Option<super::super::types::LatestServiceJobAttempt> {
        &self.latest_attempt
    }
    ...
    ///
    /// <p>The capacity usage information for this service job, including the unit of measure and quantity of resources being used.</p>
    pub fn capacity_usage(mut self, input: super::super::types::ServiceJobCapacityUsageSummary) -> Self {
    ...
    /// <p>The capacity usage information for this service job, including the unit of measure and quantity of resources being used.</p>
    pub fn set_capacity_usage(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::ServiceJobCapacityUsageSummary>>) -> Self {
        self.capacity_usage = input;
        self
    }
    /// <p>The capacity usage information for this service job, including the unit of measure and quantity of resources being used.</p>
    pub fn get_capacity_usage(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::ServiceJobCapacityUsageSummary>> {
        &self.capacity_usage
    }
    /// <p>The Unix timestamp (in milliseconds) for when the service job was created.</p>
    ...
    /// <p>The type of service job. For SageMaker Training jobs, this value is <code>SAGEMAKER_TRAINING</code>.</p>
    /// This field is required.
    pub fn service_job_type(mut self, input: super::super::types::ServiceJobType) -> Self {
        self.service_job_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The type of service job. For SageMaker Training jobs, this value is <code>SAGEMAKER_TRAINING</code>.</p>
    pub fn set_service_job_type(mut self, input: ::std::option::Option<super::super::types::ServiceJobType>) -> Self {
        self.service_job_type = input;
        self
    }
    /// <p>The type of service job. For SageMaker Training jobs, this value is <code>SAGEMAKER_TRAINING</code>.</p>
    pub fn get_service_job_type(&self) -> &::std::option::Option<super::super::types::ServiceJobType> {
    ...
    /// <p>The current status of the service job.</p>
    pub fn status(mut self, input: super::super::types::ServiceJobStatus) -> Self {
        self.status = ::std::option::Option::Some(input);
        self
    }
    /// <p>The current status of the service job.</p>
    pub fn set_status(mut self, input: ::std::option::Option<super::super::types::ServiceJobStatus>) -> Self {
        self.status = input;
        self
    }
    /// <p>The current status of the service job.</p>
    pub fn get_status(&self) -> &::std::option::Option<super::super::types::ServiceJobStatus> {
        &self.status
    }
    /// <p>A short string to provide more details on the current status of the service job.</p>
