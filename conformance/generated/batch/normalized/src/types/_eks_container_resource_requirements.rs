...
impl EksContainerResourceRequirements {
    ...
    pub fn builder() -> super::super::types::builders::EksContainerResourceRequirementsBuilder {
        super::super::types::builders::EksContainerResourceRequirementsBuilder::default()
    }
}
...
impl EksContainerResourceRequirementsBuilder {
    ...
    pub fn build(self) -> super::super::types::EksContainerResourceRequirements {
        super::super::types::EksContainerResourceRequirements {
            limits: self.limits,
