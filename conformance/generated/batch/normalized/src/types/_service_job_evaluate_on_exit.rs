...
pub struct ServiceJobEvaluateOnExit {
    ...
    pub action: ::std::option::Option<super::super::types::ServiceJobRetryAction>,
...
impl ServiceJobEvaluateOnExit {
    /// <p>The action to take if the service job exits with the specified condition. Valid values are <code>RETRY</code> and <code>EXIT</code>.</p>
    pub fn action(&self) -> ::std::option::Option<&super::super::types::ServiceJobRetryAction> {
        self.action.as_ref()
    }
    /// <p>Contains a glob pattern to match against the StatusReason returned for a job. The pattern can contain up to 512 characters and can contain all printable characters. It can optionally end with an asterisk (*) so that only the start of the string needs to be an exact match.</p>
...
impl ServiceJobEvaluateOnExit {
    ...
    pub fn builder() -> super::super::types::builders::ServiceJobEvaluateOnExitBuilder {
        super::super::types::builders::ServiceJobEvaluateOnExitBuilder::default()
    }
}
...
pub struct ServiceJobEvaluateOnExitBuilder {
    pub(crate) action: ::std::option::Option<super::super::types::ServiceJobRetryAction>,
    pub(crate) on_status_reason: ::std::option::Option<::std::string::String>,
}
impl ServiceJobEvaluateOnExitBuilder {
    /// <p>The action to take if the service job exits with the specified condition. Valid values are <code>RETRY</code> and <code>EXIT</code>.</p>
    pub fn action(mut self, input: super::super::types::ServiceJobRetryAction) -> Self {
        self.action = ::std::option::Option::Some(input);
        self
    }
    /// <p>The action to take if the service job exits with the specified condition. Valid values are <code>RETRY</code> and <code>EXIT</code>.</p>
    pub fn set_action(mut self, input: ::std::option::Option<super::super::types::ServiceJobRetryAction>) -> Self {
        self.action = input;
        self
    }
    /// <p>The action to take if the service job exits with the specified condition. Valid values are <code>RETRY</code> and <code>EXIT</code>.</p>
    pub fn get_action(&self) -> &::std::option::Option<super::super::types::ServiceJobRetryAction> {
        &self.action
    }
    /// <p>Contains a glob pattern to match against the StatusReason returned for a job. The pattern can contain up to 512 characters and can contain all printable characters. It can optionally end with an asterisk (*) so that only the start of the string needs to be an exact match.</p>
    ...
    pub fn build(self) -> super::super::types::ServiceJobEvaluateOnExit {
        super::super::types::ServiceJobEvaluateOnExit {
            action: self.action,
