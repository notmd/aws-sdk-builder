...
impl TaskContainerDependency {
    ...
    pub fn builder() -> super::super::types::builders::TaskContainerDependencyBuilder {
        super::super::types::builders::TaskContainerDependencyBuilder::default()
    }
}
...
impl TaskContainerDependencyBuilder {
    ...
    pub fn build(self) -> super::super::types::TaskContainerDependency {
        super::super::types::TaskContainerDependency {
