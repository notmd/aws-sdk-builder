...
impl ContainerOverrides {
    ...
    pub fn builder() -> super::super::types::builders::ContainerOverridesBuilder {
        super::super::types::builders::ContainerOverridesBuilder::default()
    }
}
...
impl ContainerOverridesBuilder {
    ...
    pub fn build(self) -> super::super::types::ContainerOverrides {
        super::super::types::ContainerOverrides {
            vcpus: self.vcpus,
            memory: self.memory,
