...
pub struct LogConfiguration {
    ...
    pub secret_options: ::std::option::Option<::std::vec::Vec<super::super::types::Secret>>,
}
impl LogConfiguration {
    ...
    pub fn secret_options(&self) -> &[super::super::types::Secret] {
...
impl LogConfiguration {
    ...
    pub fn builder() -> super::super::types::builders::LogConfigurationBuilder {
        super::super::types::builders::LogConfigurationBuilder::default()
    }
}
...
pub struct LogConfigurationBuilder {
    pub(crate) log_driver: ::std::option::Option<super::super::types::LogDriver>,
    pub(crate) options: ::std::option::Option<::std::collections::HashMap<::std::string::String, ::std::string::String>>,
    pub(crate) secret_options: ::std::option::Option<::std::vec::Vec<super::super::types::Secret>>,
}
impl LogConfigurationBuilder {
    ...
    pub fn log_driver(mut self, input: super::super::types::LogDriver) -> Self {
    ...
    /// </note>
    /// <p>This parameter requires version 1.18 of the Docker Remote API or greater on your container instance. To check the Docker Remote API version on your container instance, log in to your container instance and run the following command: <code>sudo docker version | grep "Server API version"</code></p>
    pub fn set_log_driver(mut self, input: ::std::option::Option<super::super::types::LogDriver>) -> Self {
    ...
    /// </note>
    /// <p>This parameter requires version 1.18 of the Docker Remote API or greater on your container instance. To check the Docker Remote API version on your container instance, log in to your container instance and run the following command: <code>sudo docker version | grep "Server API version"</code></p>
    pub fn get_log_driver(&self) -> &::std::option::Option<super::super::types::LogDriver> {
        &self.log_driver
    }
    ...
    ///
    /// <p>The secrets to pass to the log configuration. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/specifying-sensitive-data.html">Specifying sensitive data</a> in the <i>Batch User Guide</i>.</p>
    pub fn secret_options(mut self, input: super::super::types::Secret) -> Self {
    ...
    /// <p>The secrets to pass to the log configuration. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/specifying-sensitive-data.html">Specifying sensitive data</a> in the <i>Batch User Guide</i>.</p>
    pub fn set_secret_options(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::Secret>>) -> Self {
        self.secret_options = input;
        self
    }
    /// <p>The secrets to pass to the log configuration. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/specifying-sensitive-data.html">Specifying sensitive data</a> in the <i>Batch User Guide</i>.</p>
    pub fn get_secret_options(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::Secret>> {
        &self.secret_options
    }
