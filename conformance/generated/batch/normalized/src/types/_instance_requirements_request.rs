...
impl InstanceRequirementsRequest {
    ...
    pub fn builder() -> super::super::types::builders::InstanceRequirementsRequestBuilder {
        super::super::types::builders::InstanceRequirementsRequestBuilder::default()
    }
}
...
impl InstanceRequirementsRequestBuilder {
    ...
    pub fn build(self) -> super::super::types::InstanceRequirementsRequest {
        super::super::types::InstanceRequirementsRequest {
