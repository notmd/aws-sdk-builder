...
pub struct QuotaShareCapacityUtilization {
    ...
    pub capacity_usage: ::std::option::Option<::std::vec::Vec<super::super::types::QuotaShareCapacityUsage>>,
}
impl QuotaShareCapacityUtilization {
    ...
    pub fn capacity_usage(&self) -> &[super::super::types::QuotaShareCapacityUsage] {
...
impl QuotaShareCapacityUtilization {
    ...
    pub fn builder() -> super::super::types::builders::QuotaShareCapacityUtilizationBuilder {
        super::super::types::builders::QuotaShareCapacityUtilizationBuilder::default()
    }
}
...
pub struct QuotaShareCapacityUtilizationBuilder {
    ...
    pub(crate) capacity_usage: ::std::option::Option<::std::vec::Vec<super::super::types::QuotaShareCapacityUsage>>,
}
impl QuotaShareCapacityUtilizationBuilder {
    ...
    ///
    /// <p>The capacity usage information for this quota share, including the units of compute capacity and quantity being used.</p>
    pub fn capacity_usage(mut self, input: super::super::types::QuotaShareCapacityUsage) -> Self {
    ...
    /// <p>The capacity usage information for this quota share, including the units of compute capacity and quantity being used.</p>
    pub fn set_capacity_usage(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::QuotaShareCapacityUsage>>) -> Self {
        self.capacity_usage = input;
        self
    }
    /// <p>The capacity usage information for this quota share, including the units of compute capacity and quantity being used.</p>
    pub fn get_capacity_usage(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::QuotaShareCapacityUsage>> {
        &self.capacity_usage
    }
    /// Consumes the builder and constructs a [`QuotaShareCapacityUtilization`](crate::types::QuotaShareCapacityUtilization).
    pub fn build(self) -> super::super::types::QuotaShareCapacityUtilization {
        super::super::types::QuotaShareCapacityUtilization {
