...
impl EksMetadata {
    ...
    pub fn builder() -> super::super::types::builders::EksMetadataBuilder {
        super::super::types::builders::EksMetadataBuilder::default()
    }
}
...
impl EksMetadataBuilder {
    ...
    pub fn build(self) -> super::super::types::EksMetadata {
        super::super::types::EksMetadata {
            labels: self.labels,
