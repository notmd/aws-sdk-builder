...
impl EksAttemptContainerDetail {
    ...
    pub fn builder() -> super::super::types::builders::EksAttemptContainerDetailBuilder {
        super::super::types::builders::EksAttemptContainerDetailBuilder::default()
    }
}
...
impl EksAttemptContainerDetailBuilder {
    ...
    pub fn build(self) -> super::super::types::EksAttemptContainerDetail {
        super::super::types::EksAttemptContainerDetail {
            name: self.name,
