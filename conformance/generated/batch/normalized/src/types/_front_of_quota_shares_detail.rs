...
impl FrontOfQuotaSharesDetail {
    ...
    pub fn builder() -> super::super::types::builders::FrontOfQuotaSharesDetailBuilder {
        super::super::types::builders::FrontOfQuotaSharesDetailBuilder::default()
    }
}
...
impl FrontOfQuotaSharesDetailBuilder {
    ...
    pub fn quota_shares(
        ...
        v: ::std::vec::Vec<super::super::types::FrontOfQuotaShareJobSummary>,
    ) -> Self {
    ...
    pub fn build(self) -> super::super::types::FrontOfQuotaSharesDetail {
        super::super::types::FrontOfQuotaSharesDetail {
