...
pub struct FairshareCapacityUtilization {
    ...
    pub capacity_usage: ::std::option::Option<::std::vec::Vec<super::super::types::FairshareCapacityUsage>>,
}
impl FairshareCapacityUtilization {
    ...
    pub fn capacity_usage(&self) -> &[super::super::types::FairshareCapacityUsage] {
...
impl FairshareCapacityUtilization {
    ...
    pub fn builder() -> super::super::types::builders::FairshareCapacityUtilizationBuilder {
        super::super::types::builders::FairshareCapacityUtilizationBuilder::default()
    }
}
...
pub struct FairshareCapacityUtilizationBuilder {
    ...
    pub(crate) capacity_usage: ::std::option::Option<::std::vec::Vec<super::super::types::FairshareCapacityUsage>>,
}
impl FairshareCapacityUtilizationBuilder {
    ...
    ///
    /// <p>The capacity usage information for this share, including the unit of measure and quantity being used. This is <code>VCPU</code> for Amazon EC2 and <code>cpu</code> for Amazon EKS.</p>
    pub fn capacity_usage(mut self, input: super::super::types::FairshareCapacityUsage) -> Self {
    ...
    /// <p>The capacity usage information for this share, including the unit of measure and quantity being used. This is <code>VCPU</code> for Amazon EC2 and <code>cpu</code> for Amazon EKS.</p>
    pub fn set_capacity_usage(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::FairshareCapacityUsage>>) -> Self {
        self.capacity_usage = input;
        self
    }
    /// <p>The capacity usage information for this share, including the unit of measure and quantity being used. This is <code>VCPU</code> for Amazon EC2 and <code>cpu</code> for Amazon EKS.</p>
    pub fn get_capacity_usage(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::FairshareCapacityUsage>> {
        &self.capacity_usage
    }
    /// Consumes the builder and constructs a [`FairshareCapacityUtilization`](crate::types::FairshareCapacityUtilization).
    pub fn build(self) -> super::super::types::FairshareCapacityUtilization {
        super::super::types::FairshareCapacityUtilization {
