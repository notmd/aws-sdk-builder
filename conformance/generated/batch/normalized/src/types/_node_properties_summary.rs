...
impl NodePropertiesSummary {
    ...
    pub fn builder() -> super::super::types::builders::NodePropertiesSummaryBuilder {
        super::super::types::builders::NodePropertiesSummaryBuilder::default()
    }
}
...
impl NodePropertiesSummaryBuilder {
    ...
    pub fn build(self) -> super::super::types::NodePropertiesSummary {
        super::super::types::NodePropertiesSummary {
