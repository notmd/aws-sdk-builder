...
impl ServiceJobAttemptDetail {
    ...
    pub fn builder() -> super::super::types::builders::ServiceJobAttemptDetailBuilder {
        super::super::types::builders::ServiceJobAttemptDetailBuilder::default()
    }
}
...
impl ServiceJobAttemptDetailBuilder {
    ...
    pub fn build(self) -> super::super::types::ServiceJobAttemptDetail {
        super::super::types::ServiceJobAttemptDetail {
