...
pub struct AttemptDetail {
    ...
    pub container: ::std::option::Option<super::super::types::AttemptContainerDetail>,
    ...
    pub task_properties: ::std::option::Option<::std::vec::Vec<super::super::types::AttemptEcsTaskDetails>>,
}
impl AttemptDetail {
    /// <p>The details for the container in this job attempt.</p>
    pub fn container(&self) -> ::std::option::Option<&super::super::types::AttemptContainerDetail> {
    ...
    pub fn task_properties(&self) -> &[super::super::types::AttemptEcsTaskDetails] {
...
impl AttemptDetail {
    ...
    pub fn builder() -> super::super::types::builders::AttemptDetailBuilder {
        super::super::types::builders::AttemptDetailBuilder::default()
    }
}
...
pub struct AttemptDetailBuilder {
    pub(crate) container: ::std::option::Option<super::super::types::AttemptContainerDetail>,
    pub(crate) started_at: ::std::option::Option<i64>,
    pub(crate) stopped_at: ::std::option::Option<i64>,
    pub(crate) status_reason: ::std::option::Option<::std::string::String>,
    pub(crate) task_properties: ::std::option::Option<::std::vec::Vec<super::super::types::AttemptEcsTaskDetails>>,
}
impl AttemptDetailBuilder {
    /// <p>The details for the container in this job attempt.</p>
    pub fn container(mut self, input: super::super::types::AttemptContainerDetail) -> Self {
        self.container = ::std::option::Option::Some(input);
        self
    }
    /// <p>The details for the container in this job attempt.</p>
    pub fn set_container(mut self, input: ::std::option::Option<super::super::types::AttemptContainerDetail>) -> Self {
        self.container = input;
        self
    }
    /// <p>The details for the container in this job attempt.</p>
    pub fn get_container(&self) -> &::std::option::Option<super::super::types::AttemptContainerDetail> {
        &self.container
    }
    /// <p>The Unix timestamp (in milliseconds) for when the attempt was started (when the attempt transitioned from the <code>STARTING</code> state to the <code>RUNNING</code> state).</p>
    ...
    ///
    /// <p>The properties for a task definition that describes the container and volume definitions of an Amazon ECS task.</p>
    pub fn task_properties(mut self, input: super::super::types::AttemptEcsTaskDetails) -> Self {
    ...
    /// <p>The properties for a task definition that describes the container and volume definitions of an Amazon ECS task.</p>
    pub fn set_task_properties(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::AttemptEcsTaskDetails>>) -> Self {
        self.task_properties = input;
        self
    }
    /// <p>The properties for a task definition that describes the container and volume definitions of an Amazon ECS task.</p>
    pub fn get_task_properties(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::AttemptEcsTaskDetails>> {
        &self.task_properties
    }
    /// Consumes the builder and constructs a [`AttemptDetail`](crate::types::AttemptDetail).
    pub fn build(self) -> super::super::types::AttemptDetail {
        super::super::types::AttemptDetail {
