...
impl FairshareCapacityUsage {
    ...
    pub fn builder() -> super::super::types::builders::FairshareCapacityUsageBuilder {
        super::super::types::builders::FairshareCapacityUsageBuilder::default()
    }
}
...
impl FairshareCapacityUsageBuilder {
    ...
    pub fn build(self) -> super::super::types::FairshareCapacityUsage {
        super::super::types::FairshareCapacityUsage {
