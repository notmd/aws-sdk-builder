...
impl ArrayPropertiesDetail {
    ...
    pub fn builder() -> super::super::types::builders::ArrayPropertiesDetailBuilder {
        super::super::types::builders::ArrayPropertiesDetailBuilder::default()
    }
}
...
impl ArrayPropertiesDetailBuilder {
    ...
    pub fn build(self) -> super::super::types::ArrayPropertiesDetail {
        super::super::types::ArrayPropertiesDetail {
