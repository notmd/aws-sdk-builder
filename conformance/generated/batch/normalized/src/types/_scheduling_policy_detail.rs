...
pub struct SchedulingPolicyDetail {
    ...
    pub fairshare_policy: ::std::option::Option<super::super::types::FairsharePolicy>,
...
impl SchedulingPolicyDetail {
    ...
    /// <p>The fair-share scheduling policy details.</p>
    pub fn fairshare_policy(&self) -> ::std::option::Option<&super::super::types::FairsharePolicy> {
...
impl SchedulingPolicyDetail {
    ...
    pub fn builder() -> super::super::types::builders::SchedulingPolicyDetailBuilder {
        super::super::types::builders::SchedulingPolicyDetailBuilder::default()
    }
}
...
pub struct SchedulingPolicyDetailBuilder {
    ...
    pub(crate) quota_share_policy: ::std::option::Option<super::super::types::QuotaSharePolicy>,
    pub(crate) fairshare_policy: ::std::option::Option<super::super::types::FairsharePolicy>,
...
impl SchedulingPolicyDetailBuilder {
    ...
    /// <p>The quota share scheduling policy details.</p>
    pub fn quota_share_policy(mut self, input: super::super::types::QuotaSharePolicy) -> Self {
        self.quota_share_policy = ::std::option::Option::Some(input);
        self
    }
    /// <p>The quota share scheduling policy details.</p>
    pub fn set_quota_share_policy(mut self, input: ::std::option::Option<super::super::types::QuotaSharePolicy>) -> Self {
        self.quota_share_policy = input;
        self
    }
    /// <p>The quota share scheduling policy details.</p>
    pub fn get_quota_share_policy(&self) -> &::std::option::Option<super::super::types::QuotaSharePolicy> {
        &self.quota_share_policy
    }
    /// <p>The fair-share scheduling policy details.</p>
    pub fn fairshare_policy(mut self, input: super::super::types::FairsharePolicy) -> Self {
        self.fairshare_policy = ::std::option::Option::Some(input);
        self
    }
    /// <p>The fair-share scheduling policy details.</p>
    pub fn set_fairshare_policy(mut self, input: ::std::option::Option<super::super::types::FairsharePolicy>) -> Self {
        self.fairshare_policy = input;
        self
    }
    /// <p>The fair-share scheduling policy details.</p>
    pub fn get_fairshare_policy(&self) -> &::std::option::Option<super::super::types::FairsharePolicy> {
