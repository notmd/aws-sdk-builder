...
pub struct LaunchTemplateSpecification {
    ...
    /// </note>
    pub overrides: ::std::option::Option<::std::vec::Vec<super::super::types::LaunchTemplateSpecificationOverride>>,
    ...
    pub userdata_type: ::std::option::Option<super::super::types::UserdataType>,
}
impl LaunchTemplateSpecification {
    ...
    pub fn overrides(&self) -> &[super::super::types::LaunchTemplateSpecificationOverride] {
        self.overrides.as_deref().unwrap_or_default()
    }
    /// <p>The EKS node initialization process to use. You only need to specify this value if you are using a custom AMI. The default value is <code>EKS_BOOTSTRAP_SH</code>. If <i>imageType</i> is a custom AMI based on EKS_AL2023 or EKS_AL2023_NVIDIA then you must choose <code>EKS_NODEADM</code>.</p>
    pub fn userdata_type(&self) -> ::std::option::Option<&super::super::types::UserdataType> {
...
impl LaunchTemplateSpecification {
    ...
    pub fn builder() -> super::super::types::builders::LaunchTemplateSpecificationBuilder {
        super::super::types::builders::LaunchTemplateSpecificationBuilder::default()
    }
}
...
pub struct LaunchTemplateSpecificationBuilder {
    ...
    pub(crate) overrides: ::std::option::Option<::std::vec::Vec<super::super::types::LaunchTemplateSpecificationOverride>>,
    pub(crate) userdata_type: ::std::option::Option<super::super::types::UserdataType>,
}
impl LaunchTemplateSpecificationBuilder {
    ...
    /// <p>To unset all override templates for a compute environment, you can pass an empty array to the <a href="https://docs.aws.amazon.com/batch/latest/APIReference/API_UpdateComputeEnvironment.html">UpdateComputeEnvironment.overrides</a> parameter, or not include the <code>overrides</code> parameter when submitting the <code>UpdateComputeEnvironment</code> API operation.</p>
    /// </note>
    pub fn overrides(mut self, input: super::super::types::LaunchTemplateSpecificationOverride) -> Self {
    ...
    /// <p>To unset all override templates for a compute environment, you can pass an empty array to the <a href="https://docs.aws.amazon.com/batch/latest/APIReference/API_UpdateComputeEnvironment.html">UpdateComputeEnvironment.overrides</a> parameter, or not include the <code>overrides</code> parameter when submitting the <code>UpdateComputeEnvironment</code> API operation.</p>
    /// </note>
    pub fn set_overrides(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::LaunchTemplateSpecificationOverride>>) -> Self {
    ...
    /// <p>To unset all override templates for a compute environment, you can pass an empty array to the <a href="https://docs.aws.amazon.com/batch/latest/APIReference/API_UpdateComputeEnvironment.html">UpdateComputeEnvironment.overrides</a> parameter, or not include the <code>overrides</code> parameter when submitting the <code>UpdateComputeEnvironment</code> API operation.</p>
    /// </note>
    pub fn get_overrides(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::LaunchTemplateSpecificationOverride>> {
        &self.overrides
    }
    /// <p>The EKS node initialization process to use. You only need to specify this value if you are using a custom AMI. The default value is <code>EKS_BOOTSTRAP_SH</code>. If <i>imageType</i> is a custom AMI based on EKS_AL2023 or EKS_AL2023_NVIDIA then you must choose <code>EKS_NODEADM</code>.</p>
    pub fn userdata_type(mut self, input: super::super::types::UserdataType) -> Self {
        self.userdata_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The EKS node initialization process to use. You only need to specify this value if you are using a custom AMI. The default value is <code>EKS_BOOTSTRAP_SH</code>. If <i>imageType</i> is a custom AMI based on EKS_AL2023 or EKS_AL2023_NVIDIA then you must choose <code>EKS_NODEADM</code>.</p>
    pub fn set_userdata_type(mut self, input: ::std::option::Option<super::super::types::UserdataType>) -> Self {
        self.userdata_type = input;
        self
    }
    /// <p>The EKS node initialization process to use. You only need to specify this value if you are using a custom AMI. The default value is <code>EKS_BOOTSTRAP_SH</code>. If <i>imageType</i> is a custom AMI based on EKS_AL2023 or EKS_AL2023_NVIDIA then you must choose <code>EKS_NODEADM</code>.</p>
    pub fn get_userdata_type(&self) -> &::std::option::Option<super::super::types::UserdataType> {
        &self.userdata_type
    }
    /// Consumes the builder and constructs a [`LaunchTemplateSpecification`](crate::types::LaunchTemplateSpecification).
    pub fn build(self) -> super::super::types::LaunchTemplateSpecification {
        super::super::types::LaunchTemplateSpecification {
