...
impl JobCapacityUsageSummary {
    ...
    pub fn builder() -> super::super::types::builders::JobCapacityUsageSummaryBuilder {
        super::super::types::builders::JobCapacityUsageSummaryBuilder::default()
    }
}
...
impl JobCapacityUsageSummaryBuilder {
    ...
    pub fn build(self) -> super::super::types::JobCapacityUsageSummary {
        super::super::types::JobCapacityUsageSummary {
