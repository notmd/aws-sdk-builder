...
impl NodeProperties {
    ...
    pub fn builder() -> super::super::types::builders::NodePropertiesBuilder {
        super::super::types::builders::NodePropertiesBuilder::default()
    }
}
...
pub struct NodePropertiesBuilder {
    ...
    pub(crate) node_range_properties: ::std::option::Option<::std::vec::Vec<super::super::types::NodeRangeProperty>>,
}
impl NodePropertiesBuilder {
    ...
    ///
    /// <p>A list of node ranges and their properties that are associated with a multi-node parallel job.</p>
    pub fn node_range_properties(mut self, input: super::super::types::NodeRangeProperty) -> Self {
    ...
    /// <p>A list of node ranges and their properties that are associated with a multi-node parallel job.</p>
    pub fn set_node_range_properties(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::NodeRangeProperty>>) -> Self {
        self.node_range_properties = input;
        self
    }
    /// <p>A list of node ranges and their properties that are associated with a multi-node parallel job.</p>
    pub fn get_node_range_properties(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::NodeRangeProperty>> {
