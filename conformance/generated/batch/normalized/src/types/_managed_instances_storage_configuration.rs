...
impl ManagedInstancesStorageConfiguration {
    ...
    pub fn builder() -> super::super::types::builders::ManagedInstancesStorageConfigurationBuilder {
        super::super::types::builders::ManagedInstancesStorageConfigurationBuilder::default()
    }
}
