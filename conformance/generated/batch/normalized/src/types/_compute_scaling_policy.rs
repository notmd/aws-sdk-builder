...
impl ComputeScalingPolicy {
    ...
    pub fn builder() -> super::super::types::builders::ComputeScalingPolicyBuilder {
        super::super::types::builders::ComputeScalingPolicyBuilder::default()
    }
}
...
impl ComputeScalingPolicyBuilder {
    ...
    pub fn build(self) -> super::super::types::ComputeScalingPolicy {
        super::super::types::ComputeScalingPolicy {
