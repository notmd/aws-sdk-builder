...
impl JobTimeout {
    ...
    pub fn builder() -> super::super::types::builders::JobTimeoutBuilder {
        super::super::types::builders::JobTimeoutBuilder::default()
    }
}
...
impl JobTimeoutBuilder {
    ...
    pub fn build(self) -> super::super::types::JobTimeout {
        super::super::types::JobTimeout {
