...
impl QueueSnapshotCapacityUsage {
    ...
    pub fn builder() -> super::super::types::builders::QueueSnapshotCapacityUsageBuilder {
        super::super::types::builders::QueueSnapshotCapacityUsageBuilder::default()
    }
}
...
impl QueueSnapshotCapacityUsageBuilder {
    ...
    pub fn build(self) -> super::super::types::QueueSnapshotCapacityUsage {
        super::super::types::QueueSnapshotCapacityUsage {
