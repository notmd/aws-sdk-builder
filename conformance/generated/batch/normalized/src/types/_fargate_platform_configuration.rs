...
impl FargatePlatformConfiguration {
    ...
    pub fn builder() -> super::super::types::builders::FargatePlatformConfigurationBuilder {
        super::super::types::builders::FargatePlatformConfigurationBuilder::default()
    }
}
...
impl FargatePlatformConfigurationBuilder {
    ...
    pub fn build(self) -> super::super::types::FargatePlatformConfiguration {
        super::super::types::FargatePlatformConfiguration {
