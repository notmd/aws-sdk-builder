...
pub struct UpdateManagedInstancesProviderConfiguration {
    ...
    pub instance_launch_template: ::std::option::Option<super::super::types::InstanceLaunchTemplateUpdate>,
    /// <p>The updated infrastructure optimization configuration.</p>
    pub infrastructure_optimization: ::std::option::Option<super::super::types::InfrastructureOptimization>,
}
impl UpdateManagedInstancesProviderConfiguration {
    ...
    /// <p>The updated instance launch configuration for the Amazon ECS Managed Instances capacity provider.</p>
    pub fn instance_launch_template(&self) -> ::std::option::Option<&super::super::types::InstanceLaunchTemplateUpdate> {
        self.instance_launch_template.as_ref()
    }
    /// <p>The updated infrastructure optimization configuration.</p>
    pub fn infrastructure_optimization(&self) -> ::std::option::Option<&super::super::types::InfrastructureOptimization> {
...
impl UpdateManagedInstancesProviderConfiguration {
    ...
    pub fn builder() -> super::super::types::builders::UpdateManagedInstancesProviderConfigurationBuilder {
        super::super::types::builders::UpdateManagedInstancesProviderConfigurationBuilder::default()
    }
}
...
pub struct UpdateManagedInstancesProviderConfigurationBuilder {
    ...
    pub(crate) instance_launch_template: ::std::option::Option<super::super::types::InstanceLaunchTemplateUpdate>,
    pub(crate) infrastructure_optimization: ::std::option::Option<super::super::types::InfrastructureOptimization>,
}
impl UpdateManagedInstancesProviderConfigurationBuilder {
    ...
    /// <p>The updated instance launch configuration for the Amazon ECS Managed Instances capacity provider.</p>
    pub fn instance_launch_template(mut self, input: super::super::types::InstanceLaunchTemplateUpdate) -> Self {
        self.instance_launch_template = ::std::option::Option::Some(input);
        self
    }
    /// <p>The updated instance launch configuration for the Amazon ECS Managed Instances capacity provider.</p>
    pub fn set_instance_launch_template(mut self, input: ::std::option::Option<super::super::types::InstanceLaunchTemplateUpdate>) -> Self {
        self.instance_launch_template = input;
        self
    }
    /// <p>The updated instance launch configuration for the Amazon ECS Managed Instances capacity provider.</p>
    pub fn get_instance_launch_template(&self) -> &::std::option::Option<super::super::types::InstanceLaunchTemplateUpdate> {
        &self.instance_launch_template
    }
    /// <p>The updated infrastructure optimization configuration.</p>
    pub fn infrastructure_optimization(mut self, input: super::super::types::InfrastructureOptimization) -> Self {
        self.infrastructure_optimization = ::std::option::Option::Some(input);
        self
    }
    /// <p>The updated infrastructure optimization configuration.</p>
    pub fn set_infrastructure_optimization(mut self, input: ::std::option::Option<super::super::types::InfrastructureOptimization>) -> Self {
        self.infrastructure_optimization = input;
        self
    }
    /// <p>The updated infrastructure optimization configuration.</p>
    pub fn get_infrastructure_optimization(&self) -> &::std::option::Option<super::super::types::InfrastructureOptimization> {
    ...
    pub fn build(self) -> super::super::types::UpdateManagedInstancesProviderConfiguration {
        super::super::types::UpdateManagedInstancesProviderConfiguration {
