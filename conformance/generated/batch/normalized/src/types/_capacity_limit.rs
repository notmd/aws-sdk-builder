...
impl CapacityLimit {
    ...
    pub fn builder() -> super::super::types::builders::CapacityLimitBuilder {
        super::super::types::builders::CapacityLimitBuilder::default()
    }
}
...
impl CapacityLimitBuilder {
    ...
    pub fn build(self) -> super::super::types::CapacityLimit {
        super::super::types::CapacityLimit {
