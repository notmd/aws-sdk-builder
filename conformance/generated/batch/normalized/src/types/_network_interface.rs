...
impl NetworkInterface {
    ...
    pub fn builder() -> super::super::types::builders::NetworkInterfaceBuilder {
        super::super::types::builders::NetworkInterfaceBuilder::default()
    }
}
...
impl NetworkInterfaceBuilder {
    ...
    pub fn build(self) -> super::super::types::NetworkInterface {
        super::super::types::NetworkInterface {
