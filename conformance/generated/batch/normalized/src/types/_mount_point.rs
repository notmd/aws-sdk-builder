...
/// <p>Details for a Docker volume mount point that's used in a job's container properties. This parameter maps to <code>Volumes</code> in the <a href="https://docs.docker.com/engine/api/latest/#tag/Container/operation/ContainerCreate">Create a container</a> section of the <i>Docker Remote API</i> and the <code>--volume</code> option to docker run.</p>
#[non_exhaustive]
...
impl MountPoint {
    ...
    pub fn builder() -> super::super::types::builders::MountPointBuilder {
        super::super::types::builders::MountPointBuilder::default()
    }
}
...
impl MountPointBuilder {
    ...
    pub fn build(self) -> super::super::types::MountPoint {
        super::super::types::MountPoint {
