...
impl EcsTaskProperties {
    ...
    pub fn builder() -> super::super::types::builders::EcsTaskPropertiesBuilder {
        super::super::types::builders::EcsTaskPropertiesBuilder::default()
    }
}
...
pub struct EcsTaskPropertiesBuilder {
    pub(crate) containers: ::std::option::Option<::std::vec::Vec<super::super::types::TaskContainerProperties>>,
...
impl EcsTaskPropertiesBuilder {
    ...
    ///
    /// <p>This object is a list of containers.</p>
    pub fn containers(mut self, input: super::super::types::TaskContainerProperties) -> Self {
    ...
    /// <p>This object is a list of containers.</p>
    pub fn set_containers(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::TaskContainerProperties>>) -> Self {
        self.containers = input;
        self
    }
    /// <p>This object is a list of containers.</p>
    pub fn get_containers(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::TaskContainerProperties>> {
        &self.containers
    }
    /// <p>The amount of ephemeral storage to allocate for the task. This parameter is used to expand the total amount of ephemeral storage available, beyond the default amount, for tasks hosted on Fargate.</p>
