...
impl super::Client {
    ...
    pub fn delete_job_queue(&self) -> super::super::operation::delete_job_queue::builders::DeleteJobQueueFluentBuilder {
        super::super::operation::delete_job_queue::builders::DeleteJobQueueFluentBuilder::new(self.handle.clone())
    }
}
