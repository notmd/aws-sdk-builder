...
impl super::Client {
    ...
    pub fn delete_quota_share(&self) -> super::super::operation::delete_quota_share::builders::DeleteQuotaShareFluentBuilder {
        super::super::operation::delete_quota_share::builders::DeleteQuotaShareFluentBuilder::new(self.handle.clone())
    }
}
