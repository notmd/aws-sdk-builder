...
impl super::Client {
    ...
    pub fn describe_service_job(&self) -> super::super::operation::describe_service_job::builders::DescribeServiceJobFluentBuilder {
        super::super::operation::describe_service_job::builders::DescribeServiceJobFluentBuilder::new(self.handle.clone())
    }
}
