...
impl super::Client {
    ...
    pub fn delete_consumable_resource(&self) -> super::super::operation::delete_consumable_resource::builders::DeleteConsumableResourceFluentBuilder {
        super::super::operation::delete_consumable_resource::builders::DeleteConsumableResourceFluentBuilder::new(self.handle.clone())
    }
}
