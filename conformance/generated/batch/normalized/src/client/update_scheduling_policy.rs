...
impl super::Client {
    ...
    pub fn update_scheduling_policy(&self) -> super::super::operation::update_scheduling_policy::builders::UpdateSchedulingPolicyFluentBuilder {
        super::super::operation::update_scheduling_policy::builders::UpdateSchedulingPolicyFluentBuilder::new(self.handle.clone())
    }
}
