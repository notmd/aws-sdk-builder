...
impl super::Client {
    ...
    pub fn update_service_job(&self) -> super::super::operation::update_service_job::builders::UpdateServiceJobFluentBuilder {
        super::super::operation::update_service_job::builders::UpdateServiceJobFluentBuilder::new(self.handle.clone())
    }
}
