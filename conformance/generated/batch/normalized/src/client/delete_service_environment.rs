...
impl super::Client {
    ...
    pub fn delete_service_environment(&self) -> super::super::operation::delete_service_environment::builders::DeleteServiceEnvironmentFluentBuilder {
        super::super::operation::delete_service_environment::builders::DeleteServiceEnvironmentFluentBuilder::new(self.handle.clone())
    }
}
