...
pub(crate) fn de_event<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::super::types::Event>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::super::types::builders::EventBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "EventType" => {
                            builder = builder.set_event_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| super::super::types::EventType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "SubType" => {
                        ...
                        "ExecutionFailedDetails" => {
                            builder = builder.set_execution_failed_details(
                                super::super::protocol_serde::shape_execution_failed_details::de_execution_failed_details(tokens, _value, depth + 1)?,
                            );
                        }
                        ...
                        "ContextStartedDetails" => {
                            builder = builder.set_context_started_details(
                                super::super::protocol_serde::shape_context_started_details::de_context_started_details(tokens, _value, depth + 1)?,
                            );
                        }
                        ...
                        "ContextFailedDetails" => {
                            builder = builder.set_context_failed_details(
                                super::super::protocol_serde::shape_context_failed_details::de_context_failed_details(tokens, _value, depth + 1)?,
                            );
                        }
                        "WaitStartedDetails" => {
                        ...
                        "WaitSucceededDetails" => {
                            builder = builder.set_wait_succeeded_details(
                                super::super::protocol_serde::shape_wait_succeeded_details::de_wait_succeeded_details(tokens, _value, depth + 1)?,
                            );
                        }
                        "WaitCancelledDetails" => {
                            builder = builder.set_wait_cancelled_details(
                                super::super::protocol_serde::shape_wait_cancelled_details::de_wait_cancelled_details(tokens, _value, depth + 1)?,
                            );
                        }
                        "StepStartedDetails" => {
                        ...
                        "StepSucceededDetails" => {
                            builder = builder.set_step_succeeded_details(
                                super::super::protocol_serde::shape_step_succeeded_details::de_step_succeeded_details(tokens, _value, depth + 1)?,
                            );
                        }
                        "StepFailedDetails" => {
                        ...
                        "ChainedInvokeStartedDetails" => {
                            builder = builder.set_chained_invoke_started_details(
                                super::super::protocol_serde::shape_chained_invoke_started_details::de_chained_invoke_started_details(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "ChainedInvokeSucceededDetails" => {
                            builder = builder.set_chained_invoke_succeeded_details(
                                super::super::protocol_serde::shape_chained_invoke_succeeded_details::de_chained_invoke_succeeded_details(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "ChainedInvokeFailedDetails" => {
                            builder = builder.set_chained_invoke_failed_details(
                                super::super::protocol_serde::shape_chained_invoke_failed_details::de_chained_invoke_failed_details(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "ChainedInvokeTimedOutDetails" => {
                            builder = builder.set_chained_invoke_timed_out_details(
                                super::super::protocol_serde::shape_chained_invoke_timed_out_details::de_chained_invoke_timed_out_details(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "ChainedInvokeStoppedDetails" => {
                            builder = builder.set_chained_invoke_stopped_details(
                                super::super::protocol_serde::shape_chained_invoke_stopped_details::de_chained_invoke_stopped_details(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "CallbackStartedDetails" => {
                            builder = builder.set_callback_started_details(
                                super::super::protocol_serde::shape_callback_started_details::de_callback_started_details(tokens, _value, depth + 1)?,
                            );
                        }
                        ...
                        "CallbackFailedDetails" => {
                            builder = builder.set_callback_failed_details(
                                super::super::protocol_serde::shape_callback_failed_details::de_callback_failed_details(tokens, _value, depth + 1)?,
                            );
                        }
                        ...
                        "InvocationCompletedDetails" => {
                            builder = builder.set_invocation_completed_details(
                                super::super::protocol_serde::shape_invocation_completed_details::de_invocation_completed_details(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
