...
impl super::Client {
    ...
    pub fn send_durable_execution_callback_heartbeat(
        &self,
    ) -> super::super::operation::send_durable_execution_callback_heartbeat::builders::SendDurableExecutionCallbackHeartbeatFluentBuilder {
        super::super::operation::send_durable_execution_callback_heartbeat::builders::SendDurableExecutionCallbackHeartbeatFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
