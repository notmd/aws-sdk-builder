...
impl super::Client {
    ...
    pub fn get_function_recursion_config(
        &self,
    ) -> super::super::operation::get_function_recursion_config::builders::GetFunctionRecursionConfigFluentBuilder {
        super::super::operation::get_function_recursion_config::builders::GetFunctionRecursionConfigFluentBuilder::new(self.handle.clone())
    }
}
