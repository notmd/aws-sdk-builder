...
impl LayerVersionContentOutput {
    ...
    pub fn builder() -> super::types::builders::LayerVersionContentOutputBuilder {
        super::types::builders::LayerVersionContentOutputBuilder::default()
    }
}
...
impl LayerVersionContentOutputBuilder {
    ...
    pub fn build(self) -> super::types::LayerVersionContentOutput {
        super::types::LayerVersionContentOutput {
