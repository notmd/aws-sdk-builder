...
impl ExecutionDetails {
    ...
    pub fn builder() -> super::types::builders::ExecutionDetailsBuilder {
        super::types::builders::ExecutionDetailsBuilder::default()
    }
}
...
impl ExecutionDetailsBuilder {
    ...
    pub fn build(self) -> super::types::ExecutionDetails {
        super::types::ExecutionDetails {
