...
impl CapacityProviderPermissionsConfig {
    ...
    pub fn builder() -> super::types::builders::CapacityProviderPermissionsConfigBuilder {
        super::types::builders::CapacityProviderPermissionsConfigBuilder::default()
    }
}
...
impl CapacityProviderPermissionsConfigBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::CapacityProviderPermissionsConfig, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::CapacityProviderPermissionsConfig {
