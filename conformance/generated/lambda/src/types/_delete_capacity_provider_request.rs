...
impl DeleteCapacityProviderRequest {
    /// Creates a new builder-style object to manufacture [`DeleteCapacityProviderRequest`](crate::types::DeleteCapacityProviderRequest).
    pub fn builder() -> crate::types::builders::DeleteCapacityProviderRequestBuilder {
        crate::types::builders::DeleteCapacityProviderRequestBuilder::default()
    }
}

/// A builder for [`DeleteCapacityProviderRequest`](crate::types::DeleteCapacityProviderRequest).
