...
impl GetDurableExecutionStateResponse {
    /// Creates a new builder-style object to manufacture [`GetDurableExecutionStateResponse`](crate::types::GetDurableExecutionStateResponse).
    pub fn builder() -> crate::types::builders::GetDurableExecutionStateResponseBuilder {
        crate::types::builders::GetDurableExecutionStateResponseBuilder::default()
    }
}

/// A builder for [`GetDurableExecutionStateResponse`](crate::types::GetDurableExecutionStateResponse).
