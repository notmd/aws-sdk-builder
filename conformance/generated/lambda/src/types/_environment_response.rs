...
pub struct EnvironmentResponse {
    ...
    pub error: ::std::option::Option<super::types::EnvironmentError>,
}
impl EnvironmentResponse {
    ...
    /// <p>Error messages for environment variables that couldn't be applied.</p>
    pub fn error(&self) -> ::std::option::Option<&super::types::EnvironmentError> {
        self.error.as_ref()
    }
}
...
impl EnvironmentResponse {
    ...
    pub fn builder() -> super::types::builders::EnvironmentResponseBuilder {
        super::types::builders::EnvironmentResponseBuilder::default()
    }
}
...
pub struct EnvironmentResponseBuilder {
    ...
    pub(crate) error: ::std::option::Option<super::types::EnvironmentError>,
}
impl EnvironmentResponseBuilder {
    ...
    /// <p>Error messages for environment variables that couldn't be applied.</p>
    pub fn error(mut self, input: super::types::EnvironmentError) -> Self {
        self.error = ::std::option::Option::Some(input);
        self
    }
    /// <p>Error messages for environment variables that couldn't be applied.</p>
    pub fn set_error(mut self, input: ::std::option::Option<super::types::EnvironmentError>) -> Self {
        self.error = input;
        self
    }
    /// <p>Error messages for environment variables that couldn't be applied.</p>
    pub fn get_error(&self) -> &::std::option::Option<super::types::EnvironmentError> {
        &self.error
    }
    /// Consumes the builder and constructs a [`EnvironmentResponse`](crate::types::EnvironmentResponse).
    pub fn build(self) -> super::types::EnvironmentResponse {
        super::types::EnvironmentResponse {
