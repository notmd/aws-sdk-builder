...
impl ListAliasesRequestBuilder {
    ...
    /// - [`function_name`](crate::types::builders::ListAliasesRequestBuilder::function_name)
        ...
        ::std::result::Result::Ok(crate::types::ListAliasesRequest {
            function_name: self.function_name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "function_name",
                    "function_name was not specified but it is required when building ListAliasesRequest",
                )
            })?,
