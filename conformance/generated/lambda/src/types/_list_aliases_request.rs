...
impl ListAliasesRequest {
    /// Creates a new builder-style object to manufacture [`ListAliasesRequest`](crate::types::ListAliasesRequest).
    pub fn builder() -> crate::types::builders::ListAliasesRequestBuilder {
        crate::types::builders::ListAliasesRequestBuilder::default()
    }
}

/// A builder for [`ListAliasesRequest`](crate::types::ListAliasesRequest).
...
impl ListAliasesRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ListAliasesRequest`](crate::types::ListAliasesRequest).
    /// This method will fail if any of the following fields are not set:
    /// - [`function_name`](Self::function_name)
    pub fn build(self) -> ::std::result::Result<crate::types::ListAliasesRequest, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::ListAliasesRequest {
            function_name: self.function_name.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("function_name", "function_name was not specified but it is required when building ListAliasesRequest"))?,
