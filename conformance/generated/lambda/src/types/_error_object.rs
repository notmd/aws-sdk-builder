...
impl ErrorObject {
    ...
    pub fn builder() -> super::types::builders::ErrorObjectBuilder {
        super::types::builders::ErrorObjectBuilder::default()
    }
}
...
impl ErrorObjectBuilder {
    ...
    pub fn build(self) -> super::types::ErrorObject {
        super::types::ErrorObject {
