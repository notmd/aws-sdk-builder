...
impl InvokeWithResponseStreamResponse {
    /// Creates a new builder-style object to manufacture [`InvokeWithResponseStreamResponse`](crate::types::InvokeWithResponseStreamResponse).
    pub fn builder() -> crate::types::builders::InvokeWithResponseStreamResponseBuilder {
        crate::types::builders::InvokeWithResponseStreamResponseBuilder::default()
    }
}

/// A builder for [`InvokeWithResponseStreamResponse`](crate::types::InvokeWithResponseStreamResponse).
