...
impl ProvisionedConcurrencyConfigListItem {
    ...
    pub fn builder() -> super::types::builders::ProvisionedConcurrencyConfigListItemBuilder {
        super::types::builders::ProvisionedConcurrencyConfigListItemBuilder::default()
    }
}
...
impl ProvisionedConcurrencyConfigListItemBuilder {
    ...
    pub fn build(self) -> super::types::ProvisionedConcurrencyConfigListItem {
