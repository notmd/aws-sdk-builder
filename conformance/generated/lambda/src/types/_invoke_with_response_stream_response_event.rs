...
pub enum InvokeWithResponseStreamResponseEvent {
    ...
    InvokeComplete(super::types::InvokeWithResponseStreamCompleteEvent),
    /// <p>A chunk of the streamed response payload.</p>
    PayloadChunk(super::types::InvokeResponseStreamUpdate),
...
impl InvokeWithResponseStreamResponseEvent {
    ...
    pub fn as_invoke_complete(&self) -> ::std::result::Result<&super::types::InvokeWithResponseStreamCompleteEvent, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_payload_chunk(&self) -> ::std::result::Result<&super::types::InvokeResponseStreamUpdate, &Self> {
