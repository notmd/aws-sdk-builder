...
impl LayersListItemBuilder {
    ...
    pub fn set_latest_matching_version(mut self, input: ::std::option::Option<crate::types::LayerVersionsListItem>) -> Self { self.latest_matching_version = input; self }
    /// <p>The newest version of the layer.</p>
    pub fn get_latest_matching_version(&self) -> &::std::option::Option<crate::types::LayerVersionsListItem> { &self.latest_matching_version }
