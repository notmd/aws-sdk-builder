...
impl ListProvisionedConcurrencyConfigsResponse {
    /// Creates a new builder-style object to manufacture [`ListProvisionedConcurrencyConfigsResponse`](crate::types::ListProvisionedConcurrencyConfigsResponse).
    pub fn builder() -> crate::types::builders::ListProvisionedConcurrencyConfigsResponseBuilder {
        crate::types::builders::ListProvisionedConcurrencyConfigsResponseBuilder::default()
    }
}

/// A builder for [`ListProvisionedConcurrencyConfigsResponse`](crate::types::ListProvisionedConcurrencyConfigsResponse).
