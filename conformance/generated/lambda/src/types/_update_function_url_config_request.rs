...
impl UpdateFunctionUrlConfigRequest {
    /// Creates a new builder-style object to manufacture [`UpdateFunctionUrlConfigRequest`](crate::types::UpdateFunctionUrlConfigRequest).
    pub fn builder() -> crate::types::builders::UpdateFunctionUrlConfigRequestBuilder {
        crate::types::builders::UpdateFunctionUrlConfigRequestBuilder::default()
    }
}

/// A builder for [`UpdateFunctionUrlConfigRequest`](crate::types::UpdateFunctionUrlConfigRequest).
...
impl UpdateFunctionUrlConfigRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateFunctionUrlConfigRequest`](crate::types::UpdateFunctionUrlConfigRequest).
    /// This method will fail if any of the following fields are not set:
    /// - [`function_name`](Self::function_name)
    pub fn build(self) -> ::std::result::Result<crate::types::UpdateFunctionUrlConfigRequest, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::UpdateFunctionUrlConfigRequest {
            function_name: self.function_name.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("function_name", "function_name was not specified but it is required when building UpdateFunctionUrlConfigRequest"))?,
