        ...
        ::std::result::Result::Ok(crate::types::GetLayerVersionRequest {
            layer_name: self.layer_name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "layer_name",
                    "layer_name was not specified but it is required when building GetLayerVersionRequest",
                )
            })?,
            version_number: self.version_number.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "version_number",
                    "version_number was not specified but it is required when building GetLayerVersionRequest",
                )
            })?,
        })
    }
