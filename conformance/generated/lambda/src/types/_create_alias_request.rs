...
pub struct CreateAliasRequest {
    ...
    pub function_version: ::std::string::String,
...
impl CreateAliasRequest {
    /// Creates a new builder-style object to manufacture [`CreateAliasRequest`](crate::types::CreateAliasRequest).
    pub fn builder() -> crate::types::builders::CreateAliasRequestBuilder {
        crate::types::builders::CreateAliasRequestBuilder::default()
    }
}

/// A builder for [`CreateAliasRequest`](crate::types::CreateAliasRequest).
...
impl CreateAliasRequestBuilder {
    ...
    pub fn set_function_version(mut self, input: ::std::option::Option<::std::string::String>) -> Self { self.function_version = input; self }
    /// <p>The function version that the alias invokes.</p>
    pub fn get_function_version(&self) -> &::std::option::Option<::std::string::String> { &self.function_version }
    /// <p>A description of the alias.</p>
    ...
    pub fn set_routing_config(mut self, input: ::std::option::Option<crate::types::AliasRoutingConfiguration>) -> Self { self.routing_config = input; self }
    /// <p>The <a href="https://docs.aws.amazon.com/lambda/latest/dg/configuration-aliases.html#configuring-alias-routing">routing configuration</a> of the alias.</p>
    pub fn get_routing_config(&self) -> &::std::option::Option<crate::types::AliasRoutingConfiguration> { &self.routing_config }
    /// Consumes the builder and constructs a [`CreateAliasRequest`](crate::types::CreateAliasRequest).
    /// This method will fail if any of the following fields are not set:
    /// - [`function_name`](Self::function_name)
    /// - [`name`](Self::name)
    /// - [`function_version`](Self::function_version)
    pub fn build(self) -> ::std::result::Result<crate::types::CreateAliasRequest, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::CreateAliasRequest {
            function_name: self.function_name.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("function_name", "function_name was not specified but it is required when building CreateAliasRequest"))?,
            name: self.name.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("name", "name was not specified but it is required when building CreateAliasRequest"))?,
            function_version: self.function_version.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("function_version", "function_version was not specified but it is required when building CreateAliasRequest"))?,
