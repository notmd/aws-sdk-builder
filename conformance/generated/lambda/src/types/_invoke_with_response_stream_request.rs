...
impl InvokeWithResponseStreamRequestBuilder {
    ...
    pub fn set_log_type(mut self, input: ::std::option::Option<crate::types::LogType>) -> Self { self.log_type = input; self }
    /// <p>Set to <code>Tail</code> to include the execution log in the response. Applies to synchronously invoked functions only.</p>
    pub fn get_log_type(&self) -> &::std::option::Option<crate::types::LogType> { &self.log_type }
    /// <p>Up to 3,583 bytes of base64-encoded data about the invoking client to pass to the function in the context object.</p>
    ...
    pub fn set_client_context(mut self, input: ::std::option::Option<::std::string::String>) -> Self { self.client_context = input; self }
    /// <p>Up to 3,583 bytes of base64-encoded data about the invoking client to pass to the function in the context object.</p>
    pub fn get_client_context(&self) -> &::std::option::Option<::std::string::String> { &self.client_context }
    /// <p>The alias name.</p>
    ...
    pub fn set_invocation_type(mut self, input: ::std::option::Option<crate::types::ResponseStreamingInvocationType>) -> Self { self.invocation_type = input; self }
    /// <p>Use one of the following options:</p><ul><li><p><code>RequestResponse</code> (default) – Invoke the function synchronously. Keep the connection open until the function returns a response or times out. The API operation response includes the function response and additional data.</p></li><li><p><code>DryRun</code> – Validate parameter values and verify that the IAM user or role has permission to invoke the function.</p></li></ul>
    pub fn get_invocation_type(&self) -> &::std::option::Option<crate::types::ResponseStreamingInvocationType> { &self.invocation_type }
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::InvokeWithResponseStreamRequest, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::InvokeWithResponseStreamRequest {
            function_name: self.function_name.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("function_name", "function_name was not specified but it is required when building InvokeWithResponseStreamRequest"))?,
