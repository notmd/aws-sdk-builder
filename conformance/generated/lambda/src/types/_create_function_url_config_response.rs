...
impl CreateFunctionUrlConfigResponse {
    /// Creates a new builder-style object to manufacture [`CreateFunctionUrlConfigResponse`](crate::types::CreateFunctionUrlConfigResponse).
    pub fn builder() -> crate::types::builders::CreateFunctionUrlConfigResponseBuilder {
        crate::types::builders::CreateFunctionUrlConfigResponseBuilder::default()
    }
}

/// A builder for [`CreateFunctionUrlConfigResponse`](crate::types::CreateFunctionUrlConfigResponse).
