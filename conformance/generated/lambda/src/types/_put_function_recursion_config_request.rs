...
impl PutFunctionRecursionConfigRequestBuilder {
    ...
    /// - [`function_name`](crate::types::builders::PutFunctionRecursionConfigRequestBuilder::function_name)
    /// - [`recursive_loop`](crate::types::builders::PutFunctionRecursionConfigRequestBuilder::recursive_loop)
        ...
        ::std::result::Result::Ok(crate::types::PutFunctionRecursionConfigRequest {
            function_name: self.function_name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "function_name",
                    "function_name was not specified but it is required when building PutFunctionRecursionConfigRequest",
                )
            })?,
            recursive_loop: self.recursive_loop.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "recursive_loop",
                    "recursive_loop was not specified but it is required when building PutFunctionRecursionConfigRequest",
                )
            })?,
        })
    }
