...
pub struct PutFunctionRecursionConfigRequest {
    ...
    pub recursive_loop: crate::types::RecursiveLoop,
}
impl PutFunctionRecursionConfigRequest {
    ...
    /// <p>If you set your function's recursive loop detection configuration to <code>Terminate</code>, Lambda stops your function being invoked and notifies you when it detects your function being invoked as part of a recursive loop.</p>
    /// <p>By default, Lambda sets your function's configuration to <code>Terminate</code>.</p> <important><p>If your design intentionally uses a Lambda function to write data back to the same Amazon Web Services resource that invokes the function, then use caution and implement suitable guard rails to prevent unexpected charges being billed to your Amazon Web Services account. To learn more about best practices for using recursive invocation patterns, see <a href="https://serverlessland.com/content/service/lambda/guides/aws-lambda-operator-guide/recursive-runaway">Recursive patterns that cause run-away Lambda functions</a> in Serverless Land.</p></important>
    pub fn recursive_loop(&self) -> &crate::types::RecursiveLoop {
        &self.recursive_loop
    }
}
impl PutFunctionRecursionConfigRequest {
    /// Creates a new builder-style object to manufacture [`PutFunctionRecursionConfigRequest`](crate::types::PutFunctionRecursionConfigRequest).
    pub fn builder() -> crate::types::builders::PutFunctionRecursionConfigRequestBuilder {
        crate::types::builders::PutFunctionRecursionConfigRequestBuilder::default()
    }
}

/// A builder for [`PutFunctionRecursionConfigRequest`](crate::types::PutFunctionRecursionConfigRequest).
...
impl PutFunctionRecursionConfigRequestBuilder {
    ...
    pub fn set_recursive_loop(mut self, input: ::std::option::Option<crate::types::RecursiveLoop>) -> Self { self.recursive_loop = input; self }
    /// <p>If you set your function's recursive loop detection configuration to <code>Allow</code>, Lambda doesn't take any action when it detects your function being invoked as part of a recursive loop. We recommend that you only use this setting if your design intentionally uses a Lambda function to write data back to the same Amazon Web Services resource that invokes it.</p>
    /// <p>If you set your function's recursive loop detection configuration to <code>Terminate</code>, Lambda stops your function being invoked and notifies you when it detects your function being invoked as part of a recursive loop.</p>
    /// <p>By default, Lambda sets your function's configuration to <code>Terminate</code>.</p> <important><p>If your design intentionally uses a Lambda function to write data back to the same Amazon Web Services resource that invokes the function, then use caution and implement suitable guard rails to prevent unexpected charges being billed to your Amazon Web Services account. To learn more about best practices for using recursive invocation patterns, see <a href="https://serverlessland.com/content/service/lambda/guides/aws-lambda-operator-guide/recursive-runaway">Recursive patterns that cause run-away Lambda functions</a> in Serverless Land.</p></important>
    pub fn get_recursive_loop(&self) -> &::std::option::Option<crate::types::RecursiveLoop> { &self.recursive_loop }
    /// Consumes the builder and constructs a [`PutFunctionRecursionConfigRequest`](crate::types::PutFunctionRecursionConfigRequest).
    /// This method will fail if any of the following fields are not set:
    /// - [`function_name`](Self::function_name)
    /// - [`recursive_loop`](Self::recursive_loop)
    pub fn build(self) -> ::std::result::Result<crate::types::PutFunctionRecursionConfigRequest, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::PutFunctionRecursionConfigRequest {
            function_name: self.function_name.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("function_name", "function_name was not specified but it is required when building PutFunctionRecursionConfigRequest"))?,
            recursive_loop: self.recursive_loop.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("recursive_loop", "recursive_loop was not specified but it is required when building PutFunctionRecursionConfigRequest"))?,
        })
    }
}
