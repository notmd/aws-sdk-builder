...
pub struct AmazonManagedKafkaEventSourceConfig {
    ...
    pub schema_registry_config: ::std::option::Option<super::types::KafkaSchemaRegistryConfig>,
}
impl AmazonManagedKafkaEventSourceConfig {
    ...
    /// <p>Specific configuration settings for a Kafka schema registry.</p>
    pub fn schema_registry_config(&self) -> ::std::option::Option<&super::types::KafkaSchemaRegistryConfig> {
...
impl AmazonManagedKafkaEventSourceConfig {
    ...
    pub fn builder() -> super::types::builders::AmazonManagedKafkaEventSourceConfigBuilder {
        super::types::builders::AmazonManagedKafkaEventSourceConfigBuilder::default()
    }
}
...
pub struct AmazonManagedKafkaEventSourceConfigBuilder {
    ...
    pub(crate) schema_registry_config: ::std::option::Option<super::types::KafkaSchemaRegistryConfig>,
}
impl AmazonManagedKafkaEventSourceConfigBuilder {
    ...
    /// <p>Specific configuration settings for a Kafka schema registry.</p>
    pub fn schema_registry_config(mut self, input: super::types::KafkaSchemaRegistryConfig) -> Self {
        self.schema_registry_config = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specific configuration settings for a Kafka schema registry.</p>
    pub fn set_schema_registry_config(mut self, input: ::std::option::Option<super::types::KafkaSchemaRegistryConfig>) -> Self {
        self.schema_registry_config = input;
        self
    }
    /// <p>Specific configuration settings for a Kafka schema registry.</p>
    pub fn get_schema_registry_config(&self) -> &::std::option::Option<super::types::KafkaSchemaRegistryConfig> {
    ...
    pub fn build(self) -> super::types::AmazonManagedKafkaEventSourceConfig {
        super::types::AmazonManagedKafkaEventSourceConfig {
