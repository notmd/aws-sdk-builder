...
impl ::aws_types::request_id::RequestId for super::types::error::ProvisionedConcurrencyConfigNotFoundException {
...
impl ProvisionedConcurrencyConfigNotFoundException {
    ...
    pub fn builder() -> super::types::error::builders::ProvisionedConcurrencyConfigNotFoundExceptionBuilder {
        super::types::error::builders::ProvisionedConcurrencyConfigNotFoundExceptionBuilder::default()
    }
}
...
impl ProvisionedConcurrencyConfigNotFoundExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::ProvisionedConcurrencyConfigNotFoundException {
        super::types::error::ProvisionedConcurrencyConfigNotFoundException {
            r#type: self.r#type,
