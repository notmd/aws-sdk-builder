...
impl ::aws_types::request_id::RequestId for super::types::error::PreconditionFailedException {
...
impl PreconditionFailedException {
    ...
    pub fn builder() -> super::types::error::builders::PreconditionFailedExceptionBuilder {
        super::types::error::builders::PreconditionFailedExceptionBuilder::default()
    }
}
...
impl PreconditionFailedExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::PreconditionFailedException {
        super::types::error::PreconditionFailedException {
            r#type: self.r#type,
