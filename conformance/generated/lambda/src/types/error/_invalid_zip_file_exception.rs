...
impl ::aws_types::request_id::RequestId for super::types::error::InvalidZipFileException {
...
impl InvalidZipFileException {
    ...
    pub fn builder() -> super::types::error::builders::InvalidZipFileExceptionBuilder {
        super::types::error::builders::InvalidZipFileExceptionBuilder::default()
    }
}
...
impl InvalidZipFileExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::InvalidZipFileException {
        super::types::error::InvalidZipFileException {
            r#type: self.r#type,
