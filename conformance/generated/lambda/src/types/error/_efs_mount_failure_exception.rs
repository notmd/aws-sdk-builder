...
impl ::aws_types::request_id::RequestId for super::types::error::EfsMountFailureException {
...
impl EfsMountFailureException {
    ...
    pub fn builder() -> super::types::error::builders::EfsMountFailureExceptionBuilder {
        super::types::error::builders::EfsMountFailureExceptionBuilder::default()
    }
}
...
impl EfsMountFailureExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::EfsMountFailureException {
        super::types::error::EfsMountFailureException {
            r#type: self.r#type,
