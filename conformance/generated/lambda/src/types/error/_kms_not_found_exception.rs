...
impl ::aws_types::request_id::RequestId for super::types::error::KmsNotFoundException {
...
impl KmsNotFoundException {
    ...
    pub fn builder() -> super::types::error::builders::KmsNotFoundExceptionBuilder {
        super::types::error::builders::KmsNotFoundExceptionBuilder::default()
    }
}
...
impl KmsNotFoundExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::KmsNotFoundException {
        super::types::error::KmsNotFoundException {
            r#type: self.r#type,
