...
impl ::aws_types::request_id::RequestId for super::types::error::FunctionVersionsPerCapacityProviderLimitExceededException {
...
impl FunctionVersionsPerCapacityProviderLimitExceededException {
    ...
    pub fn builder() -> super::types::error::builders::FunctionVersionsPerCapacityProviderLimitExceededExceptionBuilder {
        super::types::error::builders::FunctionVersionsPerCapacityProviderLimitExceededExceptionBuilder::default()
    }
}
...
impl FunctionVersionsPerCapacityProviderLimitExceededExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::FunctionVersionsPerCapacityProviderLimitExceededException {
        super::types::error::FunctionVersionsPerCapacityProviderLimitExceededException {
            r#type: self.r#type,
