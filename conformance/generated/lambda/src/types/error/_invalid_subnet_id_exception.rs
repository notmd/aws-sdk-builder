...
impl ::aws_types::request_id::RequestId for super::types::error::InvalidSubnetIdException {
...
impl InvalidSubnetIdException {
    ...
    pub fn builder() -> super::types::error::builders::InvalidSubnetIdExceptionBuilder {
        super::types::error::builders::InvalidSubnetIdExceptionBuilder::default()
    }
}
...
impl InvalidSubnetIdExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::InvalidSubnetIdException {
        super::types::error::InvalidSubnetIdException {
            r#type: self.r#type,
