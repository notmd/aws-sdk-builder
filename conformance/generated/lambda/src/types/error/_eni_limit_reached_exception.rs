...
impl ::aws_types::request_id::RequestId for super::types::error::EniLimitReachedException {
...
impl EniLimitReachedException {
    ...
    pub fn builder() -> super::types::error::builders::EniLimitReachedExceptionBuilder {
        super::types::error::builders::EniLimitReachedExceptionBuilder::default()
    }
}
...
impl EniLimitReachedExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::EniLimitReachedException {
        super::types::error::EniLimitReachedException {
            r#type: self.r#type,
