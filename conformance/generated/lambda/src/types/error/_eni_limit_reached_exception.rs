...
impl EniLimitReachedException {
    /// Creates a new builder-style object to manufacture [`EniLimitReachedException`](crate::types::EniLimitReachedException).
    pub fn builder() -> crate::types::builders::EniLimitReachedExceptionBuilder {
        crate::types::builders::EniLimitReachedExceptionBuilder::default()
    }
}

/// A builder for [`EniLimitReachedException`](crate::types::EniLimitReachedException).
...
impl EniLimitReachedExceptionBuilder {
    ...
    /// Consumes the builder and constructs a [`EniLimitReachedException`](crate::types::EniLimitReachedException).
    pub fn build(self) -> crate::types::EniLimitReachedException {
        crate::types::EniLimitReachedException {
            r#type: self.r#type,
