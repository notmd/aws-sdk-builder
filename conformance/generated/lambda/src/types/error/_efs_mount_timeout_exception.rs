...
impl ::aws_types::request_id::RequestId for super::types::error::EfsMountTimeoutException {
...
impl EfsMountTimeoutException {
    ...
    pub fn builder() -> super::types::error::builders::EfsMountTimeoutExceptionBuilder {
        super::types::error::builders::EfsMountTimeoutExceptionBuilder::default()
    }
}
...
impl EfsMountTimeoutExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::EfsMountTimeoutException {
        super::types::error::EfsMountTimeoutException {
            r#type: self.r#type,
