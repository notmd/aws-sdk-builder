...
impl ::aws_types::request_id::RequestId for super::types::error::SnapStartException {
...
impl SnapStartException {
    ...
    pub fn builder() -> super::types::error::builders::SnapStartExceptionBuilder {
        super::types::error::builders::SnapStartExceptionBuilder::default()
    }
}
...
impl SnapStartExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::SnapStartException {
        super::types::error::SnapStartException {
            r#type: self.r#type,
