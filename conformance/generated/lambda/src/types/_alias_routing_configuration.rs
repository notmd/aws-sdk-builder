...
impl AliasRoutingConfiguration {
    ...
    pub fn builder() -> super::types::builders::AliasRoutingConfigurationBuilder {
        super::types::builders::AliasRoutingConfigurationBuilder::default()
    }
}
...
impl AliasRoutingConfigurationBuilder {
    ...
    pub fn build(self) -> super::types::AliasRoutingConfiguration {
        super::types::AliasRoutingConfiguration {
