...
impl GetDurableExecutionStateRequestBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::GetDurableExecutionStateRequest, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::GetDurableExecutionStateRequest {
            durable_execution_arn: self.durable_execution_arn.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("durable_execution_arn", "durable_execution_arn was not specified but it is required when building GetDurableExecutionStateRequest"))?,
            checkpoint_token: self.checkpoint_token.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("checkpoint_token", "checkpoint_token was not specified but it is required when building GetDurableExecutionStateRequest"))?,
            marker: self.marker,
