...
impl ListLayersRequest {
    /// Creates a new builder-style object to manufacture [`ListLayersRequest`](crate::types::ListLayersRequest).
    pub fn builder() -> crate::types::builders::ListLayersRequestBuilder {
        crate::types::builders::ListLayersRequestBuilder::default()
    }
}

/// A builder for [`ListLayersRequest`](crate::types::ListLayersRequest).
...
impl ListLayersRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ListLayersRequest`](crate::types::ListLayersRequest).
    pub fn build(self) -> crate::types::ListLayersRequest {
        crate::types::ListLayersRequest {
