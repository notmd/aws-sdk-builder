...
impl RuntimeVersionConfigBuilder {
    ...
    pub fn set_error(mut self, input: ::std::option::Option<crate::types::RuntimeVersionError>) -> Self { self.error = input; self }
    /// <p>Error response when Lambda is unable to retrieve the runtime version for a function.</p>
    pub fn get_error(&self) -> &::std::option::Option<crate::types::RuntimeVersionError> { &self.error }
