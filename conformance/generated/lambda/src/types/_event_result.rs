...
impl EventResult {
    ...
    pub fn builder() -> super::types::builders::EventResultBuilder {
        super::types::builders::EventResultBuilder::default()
    }
}
...
impl EventResultBuilder {
    ...
    pub fn build(self) -> super::types::EventResult {
        super::types::EventResult {
