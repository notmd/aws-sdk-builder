...
impl ListDurableExecutionsByFunctionRequest {
    /// Creates a new builder-style object to manufacture [`ListDurableExecutionsByFunctionRequest`](crate::types::ListDurableExecutionsByFunctionRequest).
    pub fn builder() -> crate::types::builders::ListDurableExecutionsByFunctionRequestBuilder {
        crate::types::builders::ListDurableExecutionsByFunctionRequestBuilder::default()
    }
}

/// A builder for [`ListDurableExecutionsByFunctionRequest`](crate::types::ListDurableExecutionsByFunctionRequest).
