...
impl LambdaManagedInstancesCapacityProviderConfig {
    ...
    pub fn builder() -> super::types::builders::LambdaManagedInstancesCapacityProviderConfigBuilder {
        super::types::builders::LambdaManagedInstancesCapacityProviderConfigBuilder::default()
    }
}
...
impl LambdaManagedInstancesCapacityProviderConfigBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::types::LambdaManagedInstancesCapacityProviderConfig, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::LambdaManagedInstancesCapacityProviderConfig {
