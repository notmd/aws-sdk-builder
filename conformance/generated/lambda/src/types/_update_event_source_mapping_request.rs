...
impl UpdateEventSourceMappingRequest {
    /// Creates a new builder-style object to manufacture [`UpdateEventSourceMappingRequest`](crate::types::UpdateEventSourceMappingRequest).
    pub fn builder() -> crate::types::builders::UpdateEventSourceMappingRequestBuilder {
        crate::types::builders::UpdateEventSourceMappingRequestBuilder::default()
    }
}

/// A builder for [`UpdateEventSourceMappingRequest`](crate::types::UpdateEventSourceMappingRequest).
...
impl UpdateEventSourceMappingRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateEventSourceMappingRequest`](crate::types::UpdateEventSourceMappingRequest).
    /// This method will fail if any of the following fields are not set:
    /// - [`uuid`](Self::uuid)
    pub fn build(self) -> ::std::result::Result<crate::types::UpdateEventSourceMappingRequest, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::UpdateEventSourceMappingRequest {
            uuid: self.uuid.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("uuid", "uuid was not specified but it is required when building UpdateEventSourceMappingRequest"))?,
