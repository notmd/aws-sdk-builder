...
impl RetryDetails {
    ...
    pub fn builder() -> super::types::builders::RetryDetailsBuilder {
        super::types::builders::RetryDetailsBuilder::default()
    }
}
...
impl RetryDetailsBuilder {
    ...
    pub fn build(self) -> super::types::RetryDetails {
        super::types::RetryDetails {
