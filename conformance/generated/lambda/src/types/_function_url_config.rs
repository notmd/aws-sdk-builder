...
impl FunctionUrlConfig {
    ...
    pub fn builder() -> super::types::builders::FunctionUrlConfigBuilder {
        super::types::builders::FunctionUrlConfigBuilder::default()
    }
}
...
impl FunctionUrlConfigBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::FunctionUrlConfig, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::FunctionUrlConfig {
