...
impl LayerVersionContentInput {
    ...
    pub fn builder() -> super::types::builders::LayerVersionContentInputBuilder {
        super::types::builders::LayerVersionContentInputBuilder::default()
    }
}
...
impl LayerVersionContentInputBuilder {
    ...
    pub fn build(self) -> super::types::LayerVersionContentInput {
        super::types::LayerVersionContentInput {
