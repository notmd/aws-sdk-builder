...
impl UpdateCapacityProviderRequest {
    /// Creates a new builder-style object to manufacture [`UpdateCapacityProviderRequest`](crate::types::UpdateCapacityProviderRequest).
    pub fn builder() -> crate::types::builders::UpdateCapacityProviderRequestBuilder {
        crate::types::builders::UpdateCapacityProviderRequestBuilder::default()
    }
}

/// A builder for [`UpdateCapacityProviderRequest`](crate::types::UpdateCapacityProviderRequest).
