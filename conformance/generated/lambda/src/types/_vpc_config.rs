...
impl VpcConfig {
    ...
    pub fn builder() -> super::types::builders::VpcConfigBuilder {
        super::types::builders::VpcConfigBuilder::default()
    }
}
...
impl VpcConfigBuilder {
    ...
    pub fn build(self) -> super::types::VpcConfig {
        super::types::VpcConfig {
