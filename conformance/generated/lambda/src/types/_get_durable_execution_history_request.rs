...
impl GetDurableExecutionHistoryRequest {
    /// Creates a new builder-style object to manufacture [`GetDurableExecutionHistoryRequest`](crate::types::GetDurableExecutionHistoryRequest).
    pub fn builder() -> crate::types::builders::GetDurableExecutionHistoryRequestBuilder {
        crate::types::builders::GetDurableExecutionHistoryRequestBuilder::default()
    }
}

/// A builder for [`GetDurableExecutionHistoryRequest`](crate::types::GetDurableExecutionHistoryRequest).
...
impl GetDurableExecutionHistoryRequestBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::GetDurableExecutionHistoryRequest, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::GetDurableExecutionHistoryRequest {
            durable_execution_arn: self.durable_execution_arn.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("durable_execution_arn", "durable_execution_arn was not specified but it is required when building GetDurableExecutionHistoryRequest"))?,
