...
impl UpdateAliasRequest {
    /// Creates a new builder-style object to manufacture [`UpdateAliasRequest`](crate::types::UpdateAliasRequest).
    pub fn builder() -> crate::types::builders::UpdateAliasRequestBuilder {
        crate::types::builders::UpdateAliasRequestBuilder::default()
    }
}

/// A builder for [`UpdateAliasRequest`](crate::types::UpdateAliasRequest).
...
impl UpdateAliasRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateAliasRequest`](crate::types::UpdateAliasRequest).
    /// This method will fail if any of the following fields are not set:
    /// - [`function_name`](Self::function_name)
    /// - [`name`](Self::name)
    pub fn build(self) -> ::std::result::Result<crate::types::UpdateAliasRequest, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::UpdateAliasRequest {
            function_name: self.function_name.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("function_name", "function_name was not specified but it is required when building UpdateAliasRequest"))?,
            name: self.name.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("name", "name was not specified but it is required when building UpdateAliasRequest"))?,
