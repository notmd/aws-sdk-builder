...
impl OnSuccess {
    ...
    pub fn builder() -> super::types::builders::OnSuccessBuilder {
        super::types::builders::OnSuccessBuilder::default()
    }
}
...
impl OnSuccessBuilder {
    ...
    pub fn build(self) -> super::types::OnSuccess {
        super::types::OnSuccess {
