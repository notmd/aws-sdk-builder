...
impl GetFunctionUrlConfigResponse {
    /// Creates a new builder-style object to manufacture [`GetFunctionUrlConfigResponse`](crate::types::GetFunctionUrlConfigResponse).
    pub fn builder() -> crate::types::builders::GetFunctionUrlConfigResponseBuilder {
        crate::types::builders::GetFunctionUrlConfigResponseBuilder::default()
    }
}

/// A builder for [`GetFunctionUrlConfigResponse`](crate::types::GetFunctionUrlConfigResponse).
...
impl GetFunctionUrlConfigResponseBuilder {
    ...
    /// Consumes the builder and constructs a [`GetFunctionUrlConfigResponse`](crate::types::GetFunctionUrlConfigResponse).
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::GetFunctionUrlConfigResponse, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::GetFunctionUrlConfigResponse {
            function_url: self.function_url.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("function_url", "function_url was not specified but it is required when building GetFunctionUrlConfigResponse"))?,
            function_arn: self.function_arn.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("function_arn", "function_arn was not specified but it is required when building GetFunctionUrlConfigResponse"))?,
            auth_type: self.auth_type.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("auth_type", "auth_type was not specified but it is required when building GetFunctionUrlConfigResponse"))?,
            cors: self.cors,
            creation_time: self.creation_time.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("creation_time", "creation_time was not specified but it is required when building GetFunctionUrlConfigResponse"))?,
            last_modified_time: self.last_modified_time.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("last_modified_time", "last_modified_time was not specified but it is required when building GetFunctionUrlConfigResponse"))?,
