...
impl ListFunctionsRequest {
    /// Creates a new builder-style object to manufacture [`ListFunctionsRequest`](crate::types::ListFunctionsRequest).
    pub fn builder() -> crate::types::builders::ListFunctionsRequestBuilder {
        crate::types::builders::ListFunctionsRequestBuilder::default()
    }
}

/// A builder for [`ListFunctionsRequest`](crate::types::ListFunctionsRequest).
...
impl ListFunctionsRequestBuilder {
    ...
    pub fn set_master_region(mut self, input: ::std::option::Option<::std::string::String>) -> Self { self.master_region = input; self }
    /// <p>For Lambda@Edge functions, the Amazon Web Services Region of the master function. For example, <code>us-east-1</code> filters the list of functions to include only Lambda@Edge functions replicated from a master function in US East (N. Virginia). If specified, you must set <code>FunctionVersion</code> to <code>ALL</code>.</p>
    pub fn get_master_region(&self) -> &::std::option::Option<::std::string::String> { &self.master_region }
    /// <p>Set to <code>ALL</code> to include entries for all published versions of each function.</p>
    ...
    pub fn set_function_version(mut self, input: ::std::option::Option<crate::types::FunctionVersion>) -> Self { self.function_version = input; self }
    /// <p>Set to <code>ALL</code> to include entries for all published versions of each function.</p>
    pub fn get_function_version(&self) -> &::std::option::Option<crate::types::FunctionVersion> { &self.function_version }
    /// <p>Specify the pagination token that's returned by a previous request to retrieve the next page of results.</p>
    ...
    /// Consumes the builder and constructs a [`ListFunctionsRequest`](crate::types::ListFunctionsRequest).
    pub fn build(self) -> crate::types::ListFunctionsRequest {
        crate::types::ListFunctionsRequest {
