...
impl CallbackOptions {
    ...
    pub fn builder() -> super::types::builders::CallbackOptionsBuilder {
        super::types::builders::CallbackOptionsBuilder::default()
    }
}
...
impl CallbackOptionsBuilder {
    ...
    pub fn build(self) -> super::types::CallbackOptions {
        super::types::CallbackOptions {
