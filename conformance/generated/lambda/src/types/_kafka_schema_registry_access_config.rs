...
pub struct KafkaSchemaRegistryAccessConfig {
    ...
    pub r#type: ::std::option::Option<super::types::KafkaSchemaRegistryAuthType>,
...
impl KafkaSchemaRegistryAccessConfig {
    /// <p>The type of authentication Lambda uses to access your schema registry.</p>
    pub fn r#type(&self) -> ::std::option::Option<&super::types::KafkaSchemaRegistryAuthType> {
        self.r#type.as_ref()
    }
    /// <p>The URI of the secret (Secrets Manager secret ARN) to authenticate with your schema registry.</p>
...
impl KafkaSchemaRegistryAccessConfig {
    ...
    pub fn builder() -> super::types::builders::KafkaSchemaRegistryAccessConfigBuilder {
        super::types::builders::KafkaSchemaRegistryAccessConfigBuilder::default()
    }
}
...
pub struct KafkaSchemaRegistryAccessConfigBuilder {
    pub(crate) r#type: ::std::option::Option<super::types::KafkaSchemaRegistryAuthType>,
    pub(crate) uri: ::std::option::Option<::std::string::String>,
}
impl KafkaSchemaRegistryAccessConfigBuilder {
    /// <p>The type of authentication Lambda uses to access your schema registry.</p>
    pub fn r#type(mut self, input: super::types::KafkaSchemaRegistryAuthType) -> Self {
        self.r#type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The type of authentication Lambda uses to access your schema registry.</p>
    pub fn set_type(mut self, input: ::std::option::Option<super::types::KafkaSchemaRegistryAuthType>) -> Self {
        self.r#type = input;
        self
    }
    /// <p>The type of authentication Lambda uses to access your schema registry.</p>
    pub fn get_type(&self) -> &::std::option::Option<super::types::KafkaSchemaRegistryAuthType> {
        &self.r#type
    }
    /// <p>The URI of the secret (Secrets Manager secret ARN) to authenticate with your schema registry.</p>
    ...
    pub fn build(self) -> super::types::KafkaSchemaRegistryAccessConfig {
        super::types::KafkaSchemaRegistryAccessConfig {
            r#type: self.r#type,
            uri: self.uri,
        }
    }
