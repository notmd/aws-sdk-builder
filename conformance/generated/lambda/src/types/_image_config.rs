...
impl ImageConfig {
    ...
    pub fn builder() -> super::types::builders::ImageConfigBuilder {
        super::types::builders::ImageConfigBuilder::default()
    }
}
...
impl ImageConfigBuilder {
    ...
    pub fn build(self) -> super::types::ImageConfig {
        super::types::ImageConfig {
