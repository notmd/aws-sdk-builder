...
impl FunctionScalingConfig {
    ...
    pub fn builder() -> super::types::builders::FunctionScalingConfigBuilder {
        super::types::builders::FunctionScalingConfigBuilder::default()
    }
}
...
impl FunctionScalingConfigBuilder {
    ...
    pub fn build(self) -> super::types::FunctionScalingConfig {
        super::types::FunctionScalingConfig {
