...
impl RemoveLayerVersionPermissionRequest {
    /// Creates a new builder-style object to manufacture [`RemoveLayerVersionPermissionRequest`](crate::types::RemoveLayerVersionPermissionRequest).
    pub fn builder() -> crate::types::builders::RemoveLayerVersionPermissionRequestBuilder {
        crate::types::builders::RemoveLayerVersionPermissionRequestBuilder::default()
    }
}

/// A builder for [`RemoveLayerVersionPermissionRequest`](crate::types::RemoveLayerVersionPermissionRequest).
