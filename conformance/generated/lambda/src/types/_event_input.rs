...
impl EventInput {
    ...
    pub fn builder() -> super::types::builders::EventInputBuilder {
        super::types::builders::EventInputBuilder::default()
    }
}
...
impl EventInputBuilder {
    ...
    pub fn build(self) -> super::types::EventInput {
        super::types::EventInput {
