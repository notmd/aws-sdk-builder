...
impl PublishLayerVersionResponse {
    /// Creates a new builder-style object to manufacture [`PublishLayerVersionResponse`](crate::types::PublishLayerVersionResponse).
    pub fn builder() -> crate::types::builders::PublishLayerVersionResponseBuilder {
        crate::types::builders::PublishLayerVersionResponseBuilder::default()
    }
}

/// A builder for [`PublishLayerVersionResponse`](crate::types::PublishLayerVersionResponse).
...
impl PublishLayerVersionResponseBuilder {
    ...
    /// Consumes the builder and constructs a [`PublishLayerVersionResponse`](crate::types::PublishLayerVersionResponse).
    pub fn build(self) -> crate::types::PublishLayerVersionResponse {
        crate::types::PublishLayerVersionResponse {
