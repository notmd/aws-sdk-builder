...
impl PutProvisionedConcurrencyConfigResponse {
    /// Creates a new builder-style object to manufacture [`PutProvisionedConcurrencyConfigResponse`](crate::types::PutProvisionedConcurrencyConfigResponse).
    pub fn builder() -> crate::types::builders::PutProvisionedConcurrencyConfigResponseBuilder {
        crate::types::builders::PutProvisionedConcurrencyConfigResponseBuilder::default()
    }
}

/// A builder for [`PutProvisionedConcurrencyConfigResponse`](crate::types::PutProvisionedConcurrencyConfigResponse).
...
impl PutProvisionedConcurrencyConfigResponseBuilder {
    ...
    /// Consumes the builder and constructs a [`PutProvisionedConcurrencyConfigResponse`](crate::types::PutProvisionedConcurrencyConfigResponse).
    pub fn build(self) -> crate::types::PutProvisionedConcurrencyConfigResponse {
        crate::types::PutProvisionedConcurrencyConfigResponse {
