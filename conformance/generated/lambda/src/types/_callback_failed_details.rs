...
impl CallbackFailedDetails {
    ...
    pub fn builder() -> super::types::builders::CallbackFailedDetailsBuilder {
        super::types::builders::CallbackFailedDetailsBuilder::default()
    }
}
...
impl CallbackFailedDetailsBuilder {
    ...
    pub fn build(self) -> super::types::CallbackFailedDetails {
        super::types::CallbackFailedDetails { error: self.error }
    }
}
