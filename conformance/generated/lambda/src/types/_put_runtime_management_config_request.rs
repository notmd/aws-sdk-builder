...
impl PutRuntimeManagementConfigRequest {
    /// Creates a new builder-style object to manufacture [`PutRuntimeManagementConfigRequest`](crate::types::PutRuntimeManagementConfigRequest).
    pub fn builder() -> crate::types::builders::PutRuntimeManagementConfigRequestBuilder {
        crate::types::builders::PutRuntimeManagementConfigRequestBuilder::default()
    }
}

/// A builder for [`PutRuntimeManagementConfigRequest`](crate::types::PutRuntimeManagementConfigRequest).
...
impl PutRuntimeManagementConfigRequestBuilder {
    ...
    pub fn set_update_runtime_on(mut self, input: ::std::option::Option<crate::types::UpdateRuntimeOn>) -> Self { self.update_runtime_on = input; self }
    /// <p>Specify the runtime update mode.</p><ul><li><p><b>Auto (default)</b> - Automatically update to the most recent and secure runtime version using a <a href="https://docs.aws.amazon.com/lambda/latest/dg/runtimes-update.html#runtime-management-two-phase">Two-phase runtime version rollout</a>. This is the best choice for most customers to ensure they always benefit from runtime updates.</p></li><li><p><b>Function update</b> - Lambda updates the runtime of your function to the most recent and secure runtime version when you update your function. This approach synchronizes runtime updates with function deployments, giving you control over when runtime updates are applied and allowing you to detect and mitigate rare runtime update incompatibilities early. When using this setting, you need to regularly update your functions to keep their runtime up-to-date.</p></li><li><p><b>Manual</b> - You specify a runtime version in your function configuration. The function will use this runtime version indefinitely. In the rare case where a new runtime version is incompatible with an existing function, this allows you to roll back your function to an earlier runtime version. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/runtimes-update.html#runtime-management-rollback">Roll back a runtime version</a>.</p></li></ul>
    pub fn get_update_runtime_on(&self) -> &::std::option::Option<crate::types::UpdateRuntimeOn> { &self.update_runtime_on }
    /// <p>The ARN of the runtime version you want the function to use.</p><note>
    /// <p>This is only required if you're using the <b>Manual</b> runtime update mode.</p>
    /// </note>
    ...
    pub fn set_runtime_version_arn(mut self, input: ::std::option::Option<::std::string::String>) -> Self { self.runtime_version_arn = input; self }
    /// <p>The ARN of the runtime version you want the function to use.</p><note>
    /// <p>This is only required if you're using the <b>Manual</b> runtime update mode.</p>
    /// </note>
    pub fn get_runtime_version_arn(&self) -> &::std::option::Option<::std::string::String> { &self.runtime_version_arn }
    /// Consumes the builder and constructs a [`PutRuntimeManagementConfigRequest`](crate::types::PutRuntimeManagementConfigRequest).
    /// This method will fail if any of the following fields are not set:
    /// - [`function_name`](Self::function_name)
    /// - [`update_runtime_on`](Self::update_runtime_on)
    pub fn build(self) -> ::std::result::Result<crate::types::PutRuntimeManagementConfigRequest, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::PutRuntimeManagementConfigRequest {
            function_name: self.function_name.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("function_name", "function_name was not specified but it is required when building PutRuntimeManagementConfigRequest"))?,
            qualifier: self.qualifier,
            update_runtime_on: self.update_runtime_on.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("update_runtime_on", "update_runtime_on was not specified but it is required when building PutRuntimeManagementConfigRequest"))?,
