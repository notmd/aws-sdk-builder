...
impl TraceHeader {
    ...
    pub fn builder() -> super::types::builders::TraceHeaderBuilder {
        super::types::builders::TraceHeaderBuilder::default()
    }
}
...
impl TraceHeaderBuilder {
    ...
    pub fn build(self) -> super::types::TraceHeader {
        super::types::TraceHeader {
