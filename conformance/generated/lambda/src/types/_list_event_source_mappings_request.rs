...
impl ListEventSourceMappingsRequest {
    /// Creates a new builder-style object to manufacture [`ListEventSourceMappingsRequest`](crate::types::ListEventSourceMappingsRequest).
    pub fn builder() -> crate::types::builders::ListEventSourceMappingsRequestBuilder {
        crate::types::builders::ListEventSourceMappingsRequestBuilder::default()
    }
}

/// A builder for [`ListEventSourceMappingsRequest`](crate::types::ListEventSourceMappingsRequest).
...
impl ListEventSourceMappingsRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ListEventSourceMappingsRequest`](crate::types::ListEventSourceMappingsRequest).
    pub fn build(self) -> crate::types::ListEventSourceMappingsRequest {
        crate::types::ListEventSourceMappingsRequest {
