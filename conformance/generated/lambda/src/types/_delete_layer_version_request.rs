...
impl DeleteLayerVersionRequest {
    /// Creates a new builder-style object to manufacture [`DeleteLayerVersionRequest`](crate::types::DeleteLayerVersionRequest).
    pub fn builder() -> crate::types::builders::DeleteLayerVersionRequestBuilder {
        crate::types::builders::DeleteLayerVersionRequestBuilder::default()
    }
}

/// A builder for [`DeleteLayerVersionRequest`](crate::types::DeleteLayerVersionRequest).
...
impl DeleteLayerVersionRequestBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::DeleteLayerVersionRequest, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::DeleteLayerVersionRequest {
            layer_name: self.layer_name.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("layer_name", "layer_name was not specified but it is required when building DeleteLayerVersionRequest"))?,
            version_number: self.version_number.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("version_number", "version_number was not specified but it is required when building DeleteLayerVersionRequest"))?,
        })
    }
}
