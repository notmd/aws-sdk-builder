...
impl ChainedInvokeDetails {
    ...
    pub fn builder() -> super::types::builders::ChainedInvokeDetailsBuilder {
        super::types::builders::ChainedInvokeDetailsBuilder::default()
    }
}
...
impl ChainedInvokeDetailsBuilder {
    ...
    pub fn build(self) -> super::types::ChainedInvokeDetails {
        super::types::ChainedInvokeDetails {
            result: self.result,
            error: self.error,
        }
    }
