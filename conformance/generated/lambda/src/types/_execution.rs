...
impl Execution {
    ...
    pub fn builder() -> super::types::builders::ExecutionBuilder {
        super::types::builders::ExecutionBuilder::default()
    }
}
...
impl ExecutionBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::Execution, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::Execution {
