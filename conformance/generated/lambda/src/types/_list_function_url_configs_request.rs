...
impl ListFunctionUrlConfigsRequest {
    /// Creates a new builder-style object to manufacture [`ListFunctionUrlConfigsRequest`](crate::types::ListFunctionUrlConfigsRequest).
    pub fn builder() -> crate::types::builders::ListFunctionUrlConfigsRequestBuilder {
        crate::types::builders::ListFunctionUrlConfigsRequestBuilder::default()
    }
}

/// A builder for [`ListFunctionUrlConfigsRequest`](crate::types::ListFunctionUrlConfigsRequest).
...
impl ListFunctionUrlConfigsRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ListFunctionUrlConfigsRequest`](crate::types::ListFunctionUrlConfigsRequest).
    /// This method will fail if any of the following fields are not set:
    /// - [`function_name`](Self::function_name)
    pub fn build(self) -> ::std::result::Result<crate::types::ListFunctionUrlConfigsRequest, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::ListFunctionUrlConfigsRequest {
            function_name: self.function_name.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("function_name", "function_name was not specified but it is required when building ListFunctionUrlConfigsRequest"))?,
            marker: self.marker,
