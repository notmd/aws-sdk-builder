...
impl ChainedInvokeOptions {
    ...
    pub fn builder() -> super::types::builders::ChainedInvokeOptionsBuilder {
        super::types::builders::ChainedInvokeOptionsBuilder::default()
    }
}
...
impl ChainedInvokeOptionsBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::ChainedInvokeOptions, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ChainedInvokeOptions {
