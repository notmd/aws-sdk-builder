...
impl StepDetails {
    ...
    pub fn builder() -> super::types::builders::StepDetailsBuilder {
        super::types::builders::StepDetailsBuilder::default()
    }
}
...
impl StepDetailsBuilder {
    ...
    pub fn build(self) -> super::types::StepDetails {
        super::types::StepDetails {
