...
impl ImageConfigError {
    ...
    pub fn builder() -> super::types::builders::ImageConfigErrorBuilder {
        super::types::builders::ImageConfigErrorBuilder::default()
    }
}
...
impl ImageConfigErrorBuilder {
    ...
    pub fn build(self) -> super::types::ImageConfigError {
        super::types::ImageConfigError {
