...
impl ListLayerVersionsRequest {
    /// Creates a new builder-style object to manufacture [`ListLayerVersionsRequest`](crate::types::ListLayerVersionsRequest).
    pub fn builder() -> crate::types::builders::ListLayerVersionsRequestBuilder {
        crate::types::builders::ListLayerVersionsRequestBuilder::default()
    }
}

/// A builder for [`ListLayerVersionsRequest`](crate::types::ListLayerVersionsRequest).
