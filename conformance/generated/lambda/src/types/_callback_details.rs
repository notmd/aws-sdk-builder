...
impl CallbackDetails {
    ...
    pub fn builder() -> super::types::builders::CallbackDetailsBuilder {
        super::types::builders::CallbackDetailsBuilder::default()
    }
}
...
impl CallbackDetailsBuilder {
    ...
    pub fn build(self) -> super::types::CallbackDetails {
        super::types::CallbackDetails {
