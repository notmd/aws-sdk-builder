...
impl CodeSigningConfig {
    ...
    pub fn builder() -> super::types::builders::CodeSigningConfigBuilder {
        super::types::builders::CodeSigningConfigBuilder::default()
    }
}
...
impl CodeSigningConfigBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::CodeSigningConfig, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::CodeSigningConfig {
