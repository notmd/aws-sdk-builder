...
impl GetFunctionResponse {
    /// Creates a new builder-style object to manufacture [`GetFunctionResponse`](crate::types::GetFunctionResponse).
    pub fn builder() -> crate::types::builders::GetFunctionResponseBuilder {
        crate::types::builders::GetFunctionResponseBuilder::default()
    }
}

/// A builder for [`GetFunctionResponse`](crate::types::GetFunctionResponse).
