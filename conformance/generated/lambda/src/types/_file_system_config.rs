...
impl FileSystemConfig {
    ...
    pub fn builder() -> super::types::builders::FileSystemConfigBuilder {
        super::types::builders::FileSystemConfigBuilder::default()
    }
}
...
impl FileSystemConfigBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::FileSystemConfig, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::FileSystemConfig {
