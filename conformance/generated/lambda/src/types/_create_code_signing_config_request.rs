...
impl CreateCodeSigningConfigRequest {
    /// Creates a new builder-style object to manufacture [`CreateCodeSigningConfigRequest`](crate::types::CreateCodeSigningConfigRequest).
    pub fn builder() -> crate::types::builders::CreateCodeSigningConfigRequestBuilder {
        crate::types::builders::CreateCodeSigningConfigRequestBuilder::default()
    }
}

/// A builder for [`CreateCodeSigningConfigRequest`](crate::types::CreateCodeSigningConfigRequest).
