...
impl SelfManagedKafkaEventSourceConfig {
    ...
    pub fn builder() -> super::types::builders::SelfManagedKafkaEventSourceConfigBuilder {
        super::types::builders::SelfManagedKafkaEventSourceConfigBuilder::default()
    }
}
...
impl SelfManagedKafkaEventSourceConfigBuilder {
    ...
    pub fn build(self) -> super::types::SelfManagedKafkaEventSourceConfig {
        super::types::SelfManagedKafkaEventSourceConfig {
