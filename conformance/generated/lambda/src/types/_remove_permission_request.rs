...
impl RemovePermissionRequestBuilder {
    ...
    /// - [`function_name`](crate::types::builders::RemovePermissionRequestBuilder::function_name)
    /// - [`statement_id`](crate::types::builders::RemovePermissionRequestBuilder::statement_id)
