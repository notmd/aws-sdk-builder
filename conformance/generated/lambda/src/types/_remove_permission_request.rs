...
impl RemovePermissionRequestBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::RemovePermissionRequest, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::RemovePermissionRequest {
            function_name: self.function_name.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("function_name", "function_name was not specified but it is required when building RemovePermissionRequest"))?,
            statement_id: self.statement_id.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("statement_id", "statement_id was not specified but it is required when building RemovePermissionRequest"))?,
