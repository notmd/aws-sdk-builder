...
impl super::Client {
    ...
    #[deprecated]
    pub fn invoke_async(&self) -> super::operation::invoke_async::builders::InvokeAsyncFluentBuilder {
        super::operation::invoke_async::builders::InvokeAsyncFluentBuilder::new(self.handle.clone())
    }
}
