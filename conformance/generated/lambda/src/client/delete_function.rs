...
impl super::Client {
    ...
    pub fn delete_function(&self) -> super::operation::delete_function::builders::DeleteFunctionFluentBuilder {
        super::operation::delete_function::builders::DeleteFunctionFluentBuilder::new(self.handle.clone())
    }
}
