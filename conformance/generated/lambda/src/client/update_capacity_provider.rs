...
impl super::Client {
    ...
    pub fn update_capacity_provider(&self) -> super::operation::update_capacity_provider::builders::UpdateCapacityProviderFluentBuilder {
        super::operation::update_capacity_provider::builders::UpdateCapacityProviderFluentBuilder::new(self.handle.clone())
    }
}
