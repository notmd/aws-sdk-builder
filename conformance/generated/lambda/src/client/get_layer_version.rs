...
impl super::Client {
    ...
    pub fn get_layer_version(&self) -> super::operation::get_layer_version::builders::GetLayerVersionFluentBuilder {
        super::operation::get_layer_version::builders::GetLayerVersionFluentBuilder::new(self.handle.clone())
    }
}
