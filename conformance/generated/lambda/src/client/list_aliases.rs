...
impl super::Client {
    ...
    pub fn list_aliases(&self) -> super::operation::list_aliases::builders::ListAliasesFluentBuilder {
        super::operation::list_aliases::builders::ListAliasesFluentBuilder::new(self.handle.clone())
    }
}
