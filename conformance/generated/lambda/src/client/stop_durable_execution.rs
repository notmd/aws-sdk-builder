...
impl super::Client {
    ...
    pub fn stop_durable_execution(&self) -> super::operation::stop_durable_execution::builders::StopDurableExecutionFluentBuilder {
        super::operation::stop_durable_execution::builders::StopDurableExecutionFluentBuilder::new(self.handle.clone())
    }
}
