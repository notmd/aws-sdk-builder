...
impl super::Client {
    ...
    pub fn get_function_concurrency(&self) -> super::operation::get_function_concurrency::builders::GetFunctionConcurrencyFluentBuilder {
        super::operation::get_function_concurrency::builders::GetFunctionConcurrencyFluentBuilder::new(self.handle.clone())
    }
}
