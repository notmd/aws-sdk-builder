...
impl super::Client {
    ...
    pub fn list_functions(&self) -> super::operation::list_functions::builders::ListFunctionsFluentBuilder {
        super::operation::list_functions::builders::ListFunctionsFluentBuilder::new(self.handle.clone())
    }
}
