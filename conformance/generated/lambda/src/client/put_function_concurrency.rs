...
impl super::Client {
    ...
    pub fn put_function_concurrency(&self) -> super::operation::put_function_concurrency::builders::PutFunctionConcurrencyFluentBuilder {
        super::operation::put_function_concurrency::builders::PutFunctionConcurrencyFluentBuilder::new(self.handle.clone())
    }
}
