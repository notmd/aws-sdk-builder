...
impl super::Client {
    ...
    pub fn get_function(&self) -> super::operation::get_function::builders::GetFunctionFluentBuilder {
        super::operation::get_function::builders::GetFunctionFluentBuilder::new(self.handle.clone())
    }
}
