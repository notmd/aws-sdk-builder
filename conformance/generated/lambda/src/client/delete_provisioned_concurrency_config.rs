...
impl super::Client {
    ...
    pub fn delete_provisioned_concurrency_config(
        &self,
    ) -> super::operation::delete_provisioned_concurrency_config::builders::DeleteProvisionedConcurrencyConfigFluentBuilder {
        super::operation::delete_provisioned_concurrency_config::builders::DeleteProvisionedConcurrencyConfigFluentBuilder::new(self.handle.clone())
    }
}
