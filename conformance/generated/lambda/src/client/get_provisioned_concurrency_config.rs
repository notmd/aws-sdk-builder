...
impl super::Client {
    ...
    pub fn get_provisioned_concurrency_config(
        &self,
    ) -> super::operation::get_provisioned_concurrency_config::builders::GetProvisionedConcurrencyConfigFluentBuilder {
        super::operation::get_provisioned_concurrency_config::builders::GetProvisionedConcurrencyConfigFluentBuilder::new(self.handle.clone())
    }
}
