...
pub mod _get_function_concurrency_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_function_concurrency/_get_function_concurrency_input.rs"
    ));
}
pub use _get_function_concurrency_input::GetFunctionConcurrencyInput;
pub type Input = GetFunctionConcurrencyInput;
pub mod _get_function_concurrency_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_function_concurrency/_get_function_concurrency_output.rs"
    ));
}
pub use _get_function_concurrency_output::GetFunctionConcurrencyOutput;
pub type Output = GetFunctionConcurrencyOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_function_concurrency/builders.rs"
    ));
}
pub type GetFunctionConcurrencyError = Error;
pub type GetFunctionConcurrencyFluentBuilder = builders::Builder;
