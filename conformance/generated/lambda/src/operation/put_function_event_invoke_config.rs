...
pub mod _put_function_event_invoke_config_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/put_function_event_invoke_config/_put_function_event_invoke_config_input.rs"
    ));
}
...
pub mod _put_function_event_invoke_config_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/put_function_event_invoke_config/_put_function_event_invoke_config_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/put_function_event_invoke_config/builders.rs"
    ));
}
