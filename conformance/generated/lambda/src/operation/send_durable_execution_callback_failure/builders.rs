...
pub use super::operation::send_durable_execution_callback_failure::_send_durable_execution_callback_failure_input::SendDurableExecutionCallbackFailureInputBuilder;

pub use super::operation::send_durable_execution_callback_failure::_send_durable_execution_callback_failure_output::SendDurableExecutionCallbackFailureOutputBuilder;

impl super::operation::send_durable_execution_callback_failure::builders::SendDurableExecutionCallbackFailureInputBuilder {
...
pub struct SendDurableExecutionCallbackFailureFluentBuilder {
    ...
    inner: super::operation::send_durable_execution_callback_failure::builders::SendDurableExecutionCallbackFailureInputBuilder,
...
impl SendDurableExecutionCallbackFailureFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::send_durable_execution_callback_failure::builders::SendDurableExecutionCallbackFailureInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            super::operation::send_durable_execution_callback_failure::SendDurableExecutionCallbackFailure::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        super::operation::send_durable_execution_callback_failure::SendDurableExecutionCallbackFailure::orchestrate(&runtime_plugins, input).await
    }
