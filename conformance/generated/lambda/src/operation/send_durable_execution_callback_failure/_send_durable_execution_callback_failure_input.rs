...
impl SendDurableExecutionCallbackFailureInput {
    ...
    pub fn builder() -> super::operation::send_durable_execution_callback_failure::builders::SendDurableExecutionCallbackFailureInputBuilder {
        super::operation::send_durable_execution_callback_failure::builders::SendDurableExecutionCallbackFailureInputBuilder::default()
    }
}
...
impl SendDurableExecutionCallbackFailureInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::send_durable_execution_callback_failure::SendDurableExecutionCallbackFailureInput,
