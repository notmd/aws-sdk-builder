    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_provisioned_concurrency_configs::ListProvisionedConcurrencyConfigsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_provisioned_concurrency_configs::ListProvisionedConcurrencyConfigsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListProvisionedConcurrencyConfigsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_provisioned_concurrency_configs::de_list_provisioned_concurrency_configs_http_error(
                status, headers, body,
            )
        } else {
            super::protocol_serde::shape_list_provisioned_concurrency_configs::de_list_provisioned_concurrency_configs_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListProvisionedConcurrencyConfigsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_provisioned_concurrency_configs::ListProvisionedConcurrencyConfigsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_provisioned_concurrency_configs::ListProvisionedConcurrencyConfigsInput,
...
impl ::aws_types::request_id::RequestId for super::operation::list_provisioned_concurrency_configs::ListProvisionedConcurrencyConfigsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_provisioned_concurrency_configs::_list_provisioned_concurrency_configs_input::ListProvisionedConcurrencyConfigsInput;

pub use super::operation::list_provisioned_concurrency_configs::_list_provisioned_concurrency_configs_output::ListProvisionedConcurrencyConfigsOutput;
