...
pub mod _get_policy_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_policy/_get_policy_input.rs"
    ));
}
...
pub mod _get_policy_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_policy/_get_policy_output.rs"
    ));
}
...
/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/lambda/src/operation/get_policy/builders.rs"));
}
