    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_policy::GetPolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_policy::GetPolicyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetPolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_policy::de_get_policy_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_policy::de_get_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetPolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::get_policy::GetPolicyInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_policy::GetPolicyInput,
...
impl ::aws_types::request_id::RequestId for super::operation::get_policy::GetPolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_policy::_get_policy_input::GetPolicyInput;

pub use super::operation::get_policy::_get_policy_output::GetPolicyOutput;
