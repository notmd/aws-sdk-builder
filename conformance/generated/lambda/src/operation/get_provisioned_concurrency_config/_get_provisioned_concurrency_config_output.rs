...
impl GetProvisionedConcurrencyConfigOutput {
    ...
    pub fn builder() -> super::operation::get_provisioned_concurrency_config::builders::GetProvisionedConcurrencyConfigOutputBuilder {
        super::operation::get_provisioned_concurrency_config::builders::GetProvisionedConcurrencyConfigOutputBuilder::default()
    }
}
...
impl GetProvisionedConcurrencyConfigOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_provisioned_concurrency_config::GetProvisionedConcurrencyConfigOutput {
