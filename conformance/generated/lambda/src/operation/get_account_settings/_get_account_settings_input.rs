...
impl GetAccountSettingsInput {
    ...
    pub fn builder() -> super::operation::get_account_settings::builders::GetAccountSettingsInputBuilder {
        super::operation::get_account_settings::builders::GetAccountSettingsInputBuilder::default()
    }
}
...
impl GetAccountSettingsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_account_settings::GetAccountSettingsInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::get_account_settings::GetAccountSettingsInput {})
    }
}
