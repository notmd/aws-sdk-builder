...
pub struct GetDurableExecutionStateOutput {
    ...
    pub operations: ::std::vec::Vec<super::types::Operation>,
...
impl GetDurableExecutionStateOutput {
    ...
    pub fn builder() -> super::operation::get_durable_execution_state::builders::GetDurableExecutionStateOutputBuilder {
        super::operation::get_durable_execution_state::builders::GetDurableExecutionStateOutputBuilder::default()
    }
}
...
impl GetDurableExecutionStateOutputBuilder {
    ...
    > {
        ::std::result::Result::Ok(super::operation::get_durable_execution_state::GetDurableExecutionStateOutput {
