...
pub struct ListFunctionsOutput {
    ...
    /// <p>A list of Lambda functions.</p>
    pub functions: ::std::option::Option<::std::vec::Vec<super::types::FunctionConfiguration>>,
...
impl ListFunctionsOutput {
    ...
    pub fn functions(&self) -> &[super::types::FunctionConfiguration] {
...
impl ListFunctionsOutput {
    ...
    pub fn builder() -> super::operation::list_functions::builders::ListFunctionsOutputBuilder {
        super::operation::list_functions::builders::ListFunctionsOutputBuilder::default()
    }
}
...
pub struct ListFunctionsOutputBuilder {
    ...
    pub(crate) functions: ::std::option::Option<::std::vec::Vec<super::types::FunctionConfiguration>>,
    _request_id: Option<String>,
}
impl ListFunctionsOutputBuilder {
    ...
    ///
    /// <p>A list of Lambda functions.</p>
    pub fn functions(mut self, input: super::types::FunctionConfiguration) -> Self {
    ...
    /// <p>A list of Lambda functions.</p>
    pub fn set_functions(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::FunctionConfiguration>>) -> Self {
        self.functions = input;
        self
    }
    /// <p>A list of Lambda functions.</p>
    pub fn get_functions(&self) -> &::std::option::Option<::std::vec::Vec<super::types::FunctionConfiguration>> {
        &self.functions
    }
    ...
    pub fn build(self) -> super::operation::list_functions::ListFunctionsOutput {
