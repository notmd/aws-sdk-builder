...
impl AddLayerVersionPermissionOutput {
    ...
    pub fn builder() -> super::operation::add_layer_version_permission::builders::AddLayerVersionPermissionOutputBuilder {
        super::operation::add_layer_version_permission::builders::AddLayerVersionPermissionOutputBuilder::default()
    }
}
...
impl AddLayerVersionPermissionOutputBuilder {
    ...
    pub fn build(self) -> super::operation::add_layer_version_permission::AddLayerVersionPermissionOutput {
