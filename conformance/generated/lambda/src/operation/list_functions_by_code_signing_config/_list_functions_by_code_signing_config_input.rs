...
impl ListFunctionsByCodeSigningConfigInput {
    ...
    pub fn builder() -> super::operation::list_functions_by_code_signing_config::builders::ListFunctionsByCodeSigningConfigInputBuilder {
        super::operation::list_functions_by_code_signing_config::builders::ListFunctionsByCodeSigningConfigInputBuilder::default()
    }
}
...
impl ListFunctionsByCodeSigningConfigInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::list_functions_by_code_signing_config::ListFunctionsByCodeSigningConfigInput,
