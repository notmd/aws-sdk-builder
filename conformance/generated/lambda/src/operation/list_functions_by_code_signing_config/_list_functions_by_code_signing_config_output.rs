...
impl ListFunctionsByCodeSigningConfigOutput {
    ...
    pub fn builder() -> super::operation::list_functions_by_code_signing_config::builders::ListFunctionsByCodeSigningConfigOutputBuilder {
        super::operation::list_functions_by_code_signing_config::builders::ListFunctionsByCodeSigningConfigOutputBuilder::default()
    }
}
...
impl ListFunctionsByCodeSigningConfigOutputBuilder {
    ...
    pub fn build(self) -> super::operation::list_functions_by_code_signing_config::ListFunctionsByCodeSigningConfigOutput {
