...
pub struct ListFunctionsByCodeSigningConfigPaginator {
    ...
    builder: super::operation::list_functions_by_code_signing_config::builders::ListFunctionsByCodeSigningConfigInputBuilder,
...
impl ListFunctionsByCodeSigningConfigPaginator {
    ...
    pub fn items(self) -> super::operation::list_functions_by_code_signing_config::paginator::ListFunctionsByCodeSigningConfigPaginatorItems {
        super::operation::list_functions_by_code_signing_config::paginator::ListFunctionsByCodeSigningConfigPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::operation::list_functions_by_code_signing_config::ListFunctionsByCodeSigningConfig::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_list_functions_by_code_signing_config_output_output_next_marker(resp);
...
impl ListFunctionsByCodeSigningConfigPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::lens::lens_list_functions_by_code_signing_config_output_output_function_arns(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
