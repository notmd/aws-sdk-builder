...
pub mod _update_event_source_mapping_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/update_event_source_mapping/_update_event_source_mapping_input.rs"
    ));
}
pub use _update_event_source_mapping_input::UpdateEventSourceMappingInput;
pub type Input = UpdateEventSourceMappingInput;
pub mod _update_event_source_mapping_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/update_event_source_mapping/_update_event_source_mapping_output.rs"
    ));
}
pub use _update_event_source_mapping_output::UpdateEventSourceMappingOutput;
pub type Output = UpdateEventSourceMappingOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/update_event_source_mapping/builders.rs"
    ));
}
pub type UpdateEventSourceMappingError = Error;
pub type UpdateEventSourceMappingFluentBuilder = builders::Builder;
