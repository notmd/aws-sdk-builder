    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::update_event_source_mapping::UpdateEventSourceMappingError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::update_event_source_mapping::UpdateEventSourceMappingOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateEventSourceMappingResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 202 || force_error {
            super::protocol_serde::shape_update_event_source_mapping::de_update_event_source_mapping_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_update_event_source_mapping::de_update_event_source_mapping_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateEventSourceMappingRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::update_event_source_mapping::UpdateEventSourceMappingInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::update_event_source_mapping::UpdateEventSourceMappingInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_update_event_source_mapping::ser_update_event_source_mapping_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::update_event_source_mapping::UpdateEventSourceMappingError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::update_event_source_mapping::_update_event_source_mapping_input::UpdateEventSourceMappingInput;

pub use super::operation::update_event_source_mapping::_update_event_source_mapping_output::UpdateEventSourceMappingOutput;
