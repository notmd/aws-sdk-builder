...
pub mod _delete_layer_version_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/delete_layer_version/_delete_layer_version_input.rs"
    ));
}
pub use _delete_layer_version_input::DeleteLayerVersionInput;
pub type Input = DeleteLayerVersionInput;
pub mod _delete_layer_version_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/delete_layer_version/_delete_layer_version_output.rs"
    ));
}
pub use _delete_layer_version_output::DeleteLayerVersionOutput;
pub type Output = DeleteLayerVersionOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/delete_layer_version/builders.rs"
    ));
}
pub type DeleteLayerVersionError = Error;
pub type DeleteLayerVersionFluentBuilder = builders::Builder;
