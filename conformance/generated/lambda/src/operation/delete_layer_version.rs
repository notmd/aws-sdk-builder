...
impl DeleteLayerVersion {
    ...
    pub(crate) async fn orchestrate(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::delete_layer_version::DeleteLayerVersionError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_layer_version::DeleteLayerVersionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_layer_version::DeleteLayerVersionOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteLayerVersionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 204 || force_error {
            super::protocol_serde::shape_delete_layer_version::de_delete_layer_version_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_layer_version::de_delete_layer_version_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteLayerVersionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_layer_version::DeleteLayerVersionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_layer_version::DeleteLayerVersionInput,
...
impl ::aws_types::request_id::RequestId for super::operation::delete_layer_version::DeleteLayerVersionError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_layer_version::_delete_layer_version_input::DeleteLayerVersionInput;

pub use super::operation::delete_layer_version::_delete_layer_version_output::DeleteLayerVersionOutput;
