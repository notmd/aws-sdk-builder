...
pub use super::operation::invoke::_invoke_input::InvokeInputBuilder;

pub use super::operation::invoke::_invoke_output::InvokeOutputBuilder;

impl super::operation::invoke::builders::InvokeInputBuilder {
...
pub struct InvokeFluentBuilder {
    ...
    inner: super::operation::invoke::builders::InvokeInputBuilder,
    config_override: ::std::option::Option<super::config::Builder>,
}
impl super::client::customize::internal::CustomizableSend<super::operation::invoke::InvokeOutput, super::operation::invoke::InvokeError>
    for InvokeFluentBuilder
{
    fn send(
        ...
        super::client::customize::internal::SendResult<super::operation::invoke::InvokeOutput, super::operation::invoke::InvokeError>,
    > {
...
impl InvokeFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::invoke::builders::InvokeInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            super::operation::invoke::Invoke::operation_runtime_plugins(self.handle.runtime_plugins.clone(), &self.handle.conf, self.config_override);
        super::operation::invoke::Invoke::orchestrate(&runtime_plugins, input).await
    }

    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
    pub fn customize(
        self,
    ) -> super::client::customize::CustomizableOperation<super::operation::invoke::InvokeOutput, super::operation::invoke::InvokeError, Self> {
    ...
    /// </ul>
    pub fn invocation_type(mut self, input: super::types::InvocationType) -> Self {
    ...
    /// <p><code>DryRun</code> – Validate parameter values and verify that the user or role has permission to invoke the function.</p></li>
    /// </ul>
    pub fn set_invocation_type(mut self, input: ::std::option::Option<super::types::InvocationType>) -> Self {
    ...
    /// <p><code>DryRun</code> – Validate parameter values and verify that the user or role has permission to invoke the function.</p></li>
    /// </ul>
    pub fn get_invocation_type(&self) -> &::std::option::Option<super::types::InvocationType> {
    ...
    pub fn log_type(mut self, input: super::types::LogType) -> Self {
        self.inner = self.inner.log_type(input);
        self
    }
    /// <p>Set to <code>Tail</code> to include the execution log in the response. Applies to synchronously invoked functions only.</p>
    pub fn set_log_type(mut self, input: ::std::option::Option<super::types::LogType>) -> Self {
        self.inner = self.inner.set_log_type(input);
        self
    }
    /// <p>Set to <code>Tail</code> to include the execution log in the response. Applies to synchronously invoked functions only.</p>
    pub fn get_log_type(&self) -> &::std::option::Option<super::types::LogType> {
