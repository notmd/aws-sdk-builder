...
impl InvokeOutput {
    ...
    pub fn builder() -> super::operation::invoke::builders::InvokeOutputBuilder {
        super::operation::invoke::builders::InvokeOutputBuilder::default()
    }
}
...
impl InvokeOutputBuilder {
    ...
    pub fn build(self) -> super::operation::invoke::InvokeOutput {
