...
impl GetAliasInput {
    ...
    pub fn builder() -> super::operation::get_alias::builders::GetAliasInputBuilder {
        super::operation::get_alias::builders::GetAliasInputBuilder::default()
    }
}
...
impl GetAliasInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::get_alias::GetAliasInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_alias::GetAliasInput {
