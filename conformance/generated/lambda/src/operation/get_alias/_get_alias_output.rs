...
impl GetAliasOutput {
    ...
    pub fn builder() -> super::operation::get_alias::builders::GetAliasOutputBuilder {
        super::operation::get_alias::builders::GetAliasOutputBuilder::default()
    }
}
...
impl GetAliasOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_alias::GetAliasOutput {
