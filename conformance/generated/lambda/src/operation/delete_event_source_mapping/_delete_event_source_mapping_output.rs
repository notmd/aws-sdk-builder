...
pub struct DeleteEventSourceMappingOutput {
    ...
    pub starting_position: ::std::option::Option<super::types::EventSourcePosition>,
    ...
    pub filter_criteria: ::std::option::Option<super::types::FilterCriteria>,
    /// <p>An object that contains details about an error related to filter criteria encryption.</p>
    pub filter_criteria_error: ::std::option::Option<super::types::FilterCriteriaError>,
    ...
    pub metrics_config: ::std::option::Option<super::types::EventSourceMappingMetricsConfig>,
    ...
    pub logging_config: ::std::option::Option<super::types::EventSourceMappingLoggingConfig>,
    /// <p>(Amazon SQS only) The scaling configuration for the event source. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/with-sqs.html#events-sqs-max-concurrency">Configuring maximum concurrency for Amazon SQS event sources</a>.</p>
    pub scaling_config: ::std::option::Option<super::types::ScalingConfig>,
    ...
    pub source_access_configurations: ::std::option::Option<::std::vec::Vec<super::types::SourceAccessConfiguration>>,
    /// <p>The self-managed Apache Kafka cluster for your event source.</p>
    pub self_managed_event_source: ::std::option::Option<super::types::SelfManagedEventSource>,
    ...
    pub function_response_types: ::std::option::Option<::std::vec::Vec<super::types::FunctionResponseType>>,
    /// <p>Specific configuration settings for an Amazon Managed Streaming for Apache Kafka (Amazon MSK) event source.</p>
    pub amazon_managed_kafka_event_source_config: ::std::option::Option<super::types::AmazonManagedKafkaEventSourceConfig>,
    /// <p>Specific configuration settings for a self-managed Apache Kafka event source.</p>
    pub self_managed_kafka_event_source_config: ::std::option::Option<super::types::SelfManagedKafkaEventSourceConfig>,
    /// <p>Specific configuration settings for a DocumentDB event source.</p>
    pub document_db_event_source_config: ::std::option::Option<super::types::DocumentDbEventSourceConfig>,
    ...
    pub provisioned_poller_config: ::std::option::Option<super::types::ProvisionedPollerConfig>,
...
impl DeleteEventSourceMappingOutput {
    ...
    /// <p>The position in a stream from which to start reading. Required for Amazon Kinesis and Amazon DynamoDB Stream event sources. <code>AT_TIMESTAMP</code> is supported only for Amazon Kinesis streams, Amazon DocumentDB, Amazon MSK, and self-managed Apache Kafka.</p>
    pub fn starting_position(&self) -> ::std::option::Option<&super::types::EventSourcePosition> {
    ...
    /// <p>An object that defines the filter criteria that determine whether Lambda should process an event. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/invocation-eventfiltering.html">Lambda event filtering</a>.</p>
    /// <p>If filter criteria is encrypted, this field shows up as <code>null</code> in the response of ListEventSourceMapping API calls. You can view this field in plaintext in the response of GetEventSourceMapping and DeleteEventSourceMapping calls if you have <code>kms:Decrypt</code> permissions for the correct KMS key.</p>
    pub fn filter_criteria(&self) -> ::std::option::Option<&super::types::FilterCriteria> {
        self.filter_criteria.as_ref()
    }
    /// <p>An object that contains details about an error related to filter criteria encryption.</p>
    pub fn filter_criteria_error(&self) -> ::std::option::Option<&super::types::FilterCriteriaError> {
    ...
    /// <p>The metrics configuration for your event source. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/monitoring-metrics-types.html#event-source-mapping-metrics">Event source mapping metrics</a>.</p>
    pub fn metrics_config(&self) -> ::std::option::Option<&super::types::EventSourceMappingMetricsConfig> {
        self.metrics_config.as_ref()
    }
    /// <p>(Amazon MSK, and self-managed Apache Kafka only) The logging configuration for your event source. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/esm-logging.html">Event source mapping logging</a>.</p>
    pub fn logging_config(&self) -> ::std::option::Option<&super::types::EventSourceMappingLoggingConfig> {
        self.logging_config.as_ref()
    }
    /// <p>(Amazon SQS only) The scaling configuration for the event source. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/with-sqs.html#events-sqs-max-concurrency">Configuring maximum concurrency for Amazon SQS event sources</a>.</p>
    pub fn scaling_config(&self) -> ::std::option::Option<&super::types::ScalingConfig> {
    ...
    pub fn source_access_configurations(&self) -> &[super::types::SourceAccessConfiguration] {
        self.source_access_configurations.as_deref().unwrap_or_default()
    }
    /// <p>The self-managed Apache Kafka cluster for your event source.</p>
    pub fn self_managed_event_source(&self) -> ::std::option::Option<&super::types::SelfManagedEventSource> {
    ...
    pub fn function_response_types(&self) -> &[super::types::FunctionResponseType] {
        self.function_response_types.as_deref().unwrap_or_default()
    }
    /// <p>Specific configuration settings for an Amazon Managed Streaming for Apache Kafka (Amazon MSK) event source.</p>
    pub fn amazon_managed_kafka_event_source_config(&self) -> ::std::option::Option<&super::types::AmazonManagedKafkaEventSourceConfig> {
        self.amazon_managed_kafka_event_source_config.as_ref()
    }
    /// <p>Specific configuration settings for a self-managed Apache Kafka event source.</p>
    pub fn self_managed_kafka_event_source_config(&self) -> ::std::option::Option<&super::types::SelfManagedKafkaEventSourceConfig> {
        self.self_managed_kafka_event_source_config.as_ref()
    }
    /// <p>Specific configuration settings for a DocumentDB event source.</p>
    pub fn document_db_event_source_config(&self) -> ::std::option::Option<&super::types::DocumentDbEventSourceConfig> {
    ...
    /// <p>(Amazon SQS, Amazon MSK, and self-managed Apache Kafka only) The provisioned mode configuration for the event source. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/invocation-eventsourcemapping.html#invocation-eventsourcemapping-provisioned-mode">provisioned mode</a>.</p>
    pub fn provisioned_poller_config(&self) -> ::std::option::Option<&super::types::ProvisionedPollerConfig> {
...
impl DeleteEventSourceMappingOutput {
    ...
    pub fn builder() -> super::operation::delete_event_source_mapping::builders::DeleteEventSourceMappingOutputBuilder {
        super::operation::delete_event_source_mapping::builders::DeleteEventSourceMappingOutputBuilder::default()
    }
}
...
pub struct DeleteEventSourceMappingOutputBuilder {
    ...
    pub(crate) starting_position: ::std::option::Option<super::types::EventSourcePosition>,
    ...
    pub(crate) filter_criteria: ::std::option::Option<super::types::FilterCriteria>,
    pub(crate) filter_criteria_error: ::std::option::Option<super::types::FilterCriteriaError>,
    pub(crate) kms_key_arn: ::std::option::Option<::std::string::String>,
    pub(crate) metrics_config: ::std::option::Option<super::types::EventSourceMappingMetricsConfig>,
    pub(crate) logging_config: ::std::option::Option<super::types::EventSourceMappingLoggingConfig>,
    pub(crate) scaling_config: ::std::option::Option<super::types::ScalingConfig>,
    ...
    pub(crate) source_access_configurations: ::std::option::Option<::std::vec::Vec<super::types::SourceAccessConfiguration>>,
    pub(crate) self_managed_event_source: ::std::option::Option<super::types::SelfManagedEventSource>,
    ...
    pub(crate) function_response_types: ::std::option::Option<::std::vec::Vec<super::types::FunctionResponseType>>,
    pub(crate) amazon_managed_kafka_event_source_config: ::std::option::Option<super::types::AmazonManagedKafkaEventSourceConfig>,
    pub(crate) self_managed_kafka_event_source_config: ::std::option::Option<super::types::SelfManagedKafkaEventSourceConfig>,
    pub(crate) document_db_event_source_config: ::std::option::Option<super::types::DocumentDbEventSourceConfig>,
    pub(crate) event_source_mapping_arn: ::std::option::Option<::std::string::String>,
    pub(crate) provisioned_poller_config: ::std::option::Option<super::types::ProvisionedPollerConfig>,
    _request_id: Option<String>,
}
impl DeleteEventSourceMappingOutputBuilder {
    ...
    /// <p>The position in a stream from which to start reading. Required for Amazon Kinesis and Amazon DynamoDB Stream event sources. <code>AT_TIMESTAMP</code> is supported only for Amazon Kinesis streams, Amazon DocumentDB, Amazon MSK, and self-managed Apache Kafka.</p>
    pub fn starting_position(mut self, input: super::types::EventSourcePosition) -> Self {
        self.starting_position = ::std::option::Option::Some(input);
        self
    }
    /// <p>The position in a stream from which to start reading. Required for Amazon Kinesis and Amazon DynamoDB Stream event sources. <code>AT_TIMESTAMP</code> is supported only for Amazon Kinesis streams, Amazon DocumentDB, Amazon MSK, and self-managed Apache Kafka.</p>
    pub fn set_starting_position(mut self, input: ::std::option::Option<super::types::EventSourcePosition>) -> Self {
        self.starting_position = input;
        self
    }
    /// <p>The position in a stream from which to start reading. Required for Amazon Kinesis and Amazon DynamoDB Stream event sources. <code>AT_TIMESTAMP</code> is supported only for Amazon Kinesis streams, Amazon DocumentDB, Amazon MSK, and self-managed Apache Kafka.</p>
    pub fn get_starting_position(&self) -> &::std::option::Option<super::types::EventSourcePosition> {
    ...
    /// <p>An object that defines the filter criteria that determine whether Lambda should process an event. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/invocation-eventfiltering.html">Lambda event filtering</a>.</p>
    /// <p>If filter criteria is encrypted, this field shows up as <code>null</code> in the response of ListEventSourceMapping API calls. You can view this field in plaintext in the response of GetEventSourceMapping and DeleteEventSourceMapping calls if you have <code>kms:Decrypt</code> permissions for the correct KMS key.</p>
    pub fn filter_criteria(mut self, input: super::types::FilterCriteria) -> Self {
        self.filter_criteria = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object that defines the filter criteria that determine whether Lambda should process an event. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/invocation-eventfiltering.html">Lambda event filtering</a>.</p>
    /// <p>If filter criteria is encrypted, this field shows up as <code>null</code> in the response of ListEventSourceMapping API calls. You can view this field in plaintext in the response of GetEventSourceMapping and DeleteEventSourceMapping calls if you have <code>kms:Decrypt</code> permissions for the correct KMS key.</p>
    pub fn set_filter_criteria(mut self, input: ::std::option::Option<super::types::FilterCriteria>) -> Self {
        self.filter_criteria = input;
        self
    }
    /// <p>An object that defines the filter criteria that determine whether Lambda should process an event. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/invocation-eventfiltering.html">Lambda event filtering</a>.</p>
    /// <p>If filter criteria is encrypted, this field shows up as <code>null</code> in the response of ListEventSourceMapping API calls. You can view this field in plaintext in the response of GetEventSourceMapping and DeleteEventSourceMapping calls if you have <code>kms:Decrypt</code> permissions for the correct KMS key.</p>
    pub fn get_filter_criteria(&self) -> &::std::option::Option<super::types::FilterCriteria> {
        &self.filter_criteria
    }
    /// <p>An object that contains details about an error related to filter criteria encryption.</p>
    pub fn filter_criteria_error(mut self, input: super::types::FilterCriteriaError) -> Self {
        self.filter_criteria_error = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object that contains details about an error related to filter criteria encryption.</p>
    pub fn set_filter_criteria_error(mut self, input: ::std::option::Option<super::types::FilterCriteriaError>) -> Self {
        self.filter_criteria_error = input;
        self
    }
    /// <p>An object that contains details about an error related to filter criteria encryption.</p>
    pub fn get_filter_criteria_error(&self) -> &::std::option::Option<super::types::FilterCriteriaError> {
    ...
    /// <p>The metrics configuration for your event source. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/monitoring-metrics-types.html#event-source-mapping-metrics">Event source mapping metrics</a>.</p>
    pub fn metrics_config(mut self, input: super::types::EventSourceMappingMetricsConfig) -> Self {
        self.metrics_config = ::std::option::Option::Some(input);
        self
    }
    /// <p>The metrics configuration for your event source. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/monitoring-metrics-types.html#event-source-mapping-metrics">Event source mapping metrics</a>.</p>
    pub fn set_metrics_config(mut self, input: ::std::option::Option<super::types::EventSourceMappingMetricsConfig>) -> Self {
        self.metrics_config = input;
        self
    }
    /// <p>The metrics configuration for your event source. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/monitoring-metrics-types.html#event-source-mapping-metrics">Event source mapping metrics</a>.</p>
    pub fn get_metrics_config(&self) -> &::std::option::Option<super::types::EventSourceMappingMetricsConfig> {
        &self.metrics_config
    }
    /// <p>(Amazon MSK, and self-managed Apache Kafka only) The logging configuration for your event source. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/esm-logging.html">Event source mapping logging</a>.</p>
    pub fn logging_config(mut self, input: super::types::EventSourceMappingLoggingConfig) -> Self {
        self.logging_config = ::std::option::Option::Some(input);
        self
    }
    /// <p>(Amazon MSK, and self-managed Apache Kafka only) The logging configuration for your event source. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/esm-logging.html">Event source mapping logging</a>.</p>
    pub fn set_logging_config(mut self, input: ::std::option::Option<super::types::EventSourceMappingLoggingConfig>) -> Self {
        self.logging_config = input;
        self
    }
    /// <p>(Amazon MSK, and self-managed Apache Kafka only) The logging configuration for your event source. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/esm-logging.html">Event source mapping logging</a>.</p>
    pub fn get_logging_config(&self) -> &::std::option::Option<super::types::EventSourceMappingLoggingConfig> {
        &self.logging_config
    }
    /// <p>(Amazon SQS only) The scaling configuration for the event source. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/with-sqs.html#events-sqs-max-concurrency">Configuring maximum concurrency for Amazon SQS event sources</a>.</p>
    pub fn scaling_config(mut self, input: super::types::ScalingConfig) -> Self {
        self.scaling_config = ::std::option::Option::Some(input);
        self
    }
    /// <p>(Amazon SQS only) The scaling configuration for the event source. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/with-sqs.html#events-sqs-max-concurrency">Configuring maximum concurrency for Amazon SQS event sources</a>.</p>
    pub fn set_scaling_config(mut self, input: ::std::option::Option<super::types::ScalingConfig>) -> Self {
        self.scaling_config = input;
        self
    }
    /// <p>(Amazon SQS only) The scaling configuration for the event source. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/with-sqs.html#events-sqs-max-concurrency">Configuring maximum concurrency for Amazon SQS event sources</a>.</p>
    pub fn get_scaling_config(&self) -> &::std::option::Option<super::types::ScalingConfig> {
        &self.scaling_config
    }
    /// <p>The ARN of the Lambda function.</p>
    ...
    ///
    /// <p>An array of the authentication protocol, VPC components, or virtual host to secure and define your event source.</p>
    pub fn source_access_configurations(mut self, input: super::types::SourceAccessConfiguration) -> Self {
    ...
    pub fn set_source_access_configurations(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::SourceAccessConfiguration>>,
    ) -> Self {
        self.source_access_configurations = input;
        self
    }
    /// <p>An array of the authentication protocol, VPC components, or virtual host to secure and define your event source.</p>
    pub fn get_source_access_configurations(&self) -> &::std::option::Option<::std::vec::Vec<super::types::SourceAccessConfiguration>> {
        &self.source_access_configurations
    }
    /// <p>The self-managed Apache Kafka cluster for your event source.</p>
    pub fn self_managed_event_source(mut self, input: super::types::SelfManagedEventSource) -> Self {
        self.self_managed_event_source = ::std::option::Option::Some(input);
        self
    }
    /// <p>The self-managed Apache Kafka cluster for your event source.</p>
    pub fn set_self_managed_event_source(mut self, input: ::std::option::Option<super::types::SelfManagedEventSource>) -> Self {
        self.self_managed_event_source = input;
        self
    }
    /// <p>The self-managed Apache Kafka cluster for your event source.</p>
    pub fn get_self_managed_event_source(&self) -> &::std::option::Option<super::types::SelfManagedEventSource> {
    ...
    ///
    /// <p>(Kinesis, DynamoDB Streams, Amazon MSK, self-managed Apache Kafka, and Amazon SQS) A list of current response type enums applied to the event source mapping.</p>
    pub fn function_response_types(mut self, input: super::types::FunctionResponseType) -> Self {
    ...
    /// <p>(Kinesis, DynamoDB Streams, Amazon MSK, self-managed Apache Kafka, and Amazon SQS) A list of current response type enums applied to the event source mapping.</p>
    pub fn set_function_response_types(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::FunctionResponseType>>) -> Self {
        self.function_response_types = input;
        self
    }
    /// <p>(Kinesis, DynamoDB Streams, Amazon MSK, self-managed Apache Kafka, and Amazon SQS) A list of current response type enums applied to the event source mapping.</p>
    pub fn get_function_response_types(&self) -> &::std::option::Option<::std::vec::Vec<super::types::FunctionResponseType>> {
        &self.function_response_types
    }
    /// <p>Specific configuration settings for an Amazon Managed Streaming for Apache Kafka (Amazon MSK) event source.</p>
    pub fn amazon_managed_kafka_event_source_config(mut self, input: super::types::AmazonManagedKafkaEventSourceConfig) -> Self {
    ...
    pub fn set_amazon_managed_kafka_event_source_config(
        mut self,
        input: ::std::option::Option<super::types::AmazonManagedKafkaEventSourceConfig>,
    ) -> Self {
        self.amazon_managed_kafka_event_source_config = input;
        self
    }
    /// <p>Specific configuration settings for an Amazon Managed Streaming for Apache Kafka (Amazon MSK) event source.</p>
    pub fn get_amazon_managed_kafka_event_source_config(&self) -> &::std::option::Option<super::types::AmazonManagedKafkaEventSourceConfig> {
        &self.amazon_managed_kafka_event_source_config
    }
    /// <p>Specific configuration settings for a self-managed Apache Kafka event source.</p>
    pub fn self_managed_kafka_event_source_config(mut self, input: super::types::SelfManagedKafkaEventSourceConfig) -> Self {
    ...
    pub fn set_self_managed_kafka_event_source_config(
        mut self,
        input: ::std::option::Option<super::types::SelfManagedKafkaEventSourceConfig>,
    ) -> Self {
        self.self_managed_kafka_event_source_config = input;
        self
    }
    /// <p>Specific configuration settings for a self-managed Apache Kafka event source.</p>
    pub fn get_self_managed_kafka_event_source_config(&self) -> &::std::option::Option<super::types::SelfManagedKafkaEventSourceConfig> {
        &self.self_managed_kafka_event_source_config
    }
    /// <p>Specific configuration settings for a DocumentDB event source.</p>
    pub fn document_db_event_source_config(mut self, input: super::types::DocumentDbEventSourceConfig) -> Self {
        self.document_db_event_source_config = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specific configuration settings for a DocumentDB event source.</p>
    pub fn set_document_db_event_source_config(mut self, input: ::std::option::Option<super::types::DocumentDbEventSourceConfig>) -> Self {
        self.document_db_event_source_config = input;
        self
    }
    /// <p>Specific configuration settings for a DocumentDB event source.</p>
    pub fn get_document_db_event_source_config(&self) -> &::std::option::Option<super::types::DocumentDbEventSourceConfig> {
    ...
    /// <p>(Amazon SQS, Amazon MSK, and self-managed Apache Kafka only) The provisioned mode configuration for the event source. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/invocation-eventsourcemapping.html#invocation-eventsourcemapping-provisioned-mode">provisioned mode</a>.</p>
    pub fn provisioned_poller_config(mut self, input: super::types::ProvisionedPollerConfig) -> Self {
        self.provisioned_poller_config = ::std::option::Option::Some(input);
        self
    }
    /// <p>(Amazon SQS, Amazon MSK, and self-managed Apache Kafka only) The provisioned mode configuration for the event source. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/invocation-eventsourcemapping.html#invocation-eventsourcemapping-provisioned-mode">provisioned mode</a>.</p>
    pub fn set_provisioned_poller_config(mut self, input: ::std::option::Option<super::types::ProvisionedPollerConfig>) -> Self {
        self.provisioned_poller_config = input;
        self
    }
    /// <p>(Amazon SQS, Amazon MSK, and self-managed Apache Kafka only) The provisioned mode configuration for the event source. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/invocation-eventsourcemapping.html#invocation-eventsourcemapping-provisioned-mode">provisioned mode</a>.</p>
    pub fn get_provisioned_poller_config(&self) -> &::std::option::Option<super::types::ProvisionedPollerConfig> {
    ...
    pub fn build(self) -> super::operation::delete_event_source_mapping::DeleteEventSourceMappingOutput {
        super::operation::delete_event_source_mapping::DeleteEventSourceMappingOutput {
            uuid: self.uuid,
