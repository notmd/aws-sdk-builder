...
impl DeleteEventSourceMappingInput {
    ...
    pub fn builder() -> super::operation::delete_event_source_mapping::builders::DeleteEventSourceMappingInputBuilder {
        super::operation::delete_event_source_mapping::builders::DeleteEventSourceMappingInputBuilder::default()
    }
}
...
impl DeleteEventSourceMappingInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::delete_event_source_mapping::DeleteEventSourceMappingInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::delete_event_source_mapping::DeleteEventSourceMappingInput { uuid: self.uuid })
    }
}
