...
pub mod _list_code_signing_configs_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/list_code_signing_configs/_list_code_signing_configs_input.rs"
    ));
}
pub use _list_code_signing_configs_input::ListCodeSigningConfigsInput;
pub type Input = ListCodeSigningConfigsInput;
pub mod _list_code_signing_configs_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/list_code_signing_configs/_list_code_signing_configs_output.rs"
    ));
}
pub use _list_code_signing_configs_output::ListCodeSigningConfigsOutput;
pub type Output = ListCodeSigningConfigsOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/list_code_signing_configs/builders.rs"
    ));
}

/// Paginator for this operation
pub mod paginator;
pub type ListCodeSigningConfigsError = Error;
pub type ListCodeSigningConfigsFluentBuilder = builders::Builder;
