    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_code_signing_configs::ListCodeSigningConfigsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_code_signing_configs::ListCodeSigningConfigsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListCodeSigningConfigsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_code_signing_configs::de_list_code_signing_configs_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_code_signing_configs::de_list_code_signing_configs_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListCodeSigningConfigsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_code_signing_configs::ListCodeSigningConfigsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_code_signing_configs::ListCodeSigningConfigsInput,
...
impl ::aws_types::request_id::RequestId for super::operation::list_code_signing_configs::ListCodeSigningConfigsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_code_signing_configs::_list_code_signing_configs_input::ListCodeSigningConfigsInput;

pub use super::operation::list_code_signing_configs::_list_code_signing_configs_output::ListCodeSigningConfigsOutput;
