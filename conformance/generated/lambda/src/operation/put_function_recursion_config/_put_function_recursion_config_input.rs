...
impl PutFunctionRecursionConfigInput {
    ...
    pub fn builder() -> super::operation::put_function_recursion_config::builders::PutFunctionRecursionConfigInputBuilder {
        super::operation::put_function_recursion_config::builders::PutFunctionRecursionConfigInputBuilder::default()
    }
}
...
impl PutFunctionRecursionConfigInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::put_function_recursion_config::PutFunctionRecursionConfigInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::put_function_recursion_config::PutFunctionRecursionConfigInput {
