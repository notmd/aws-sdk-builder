...
impl PutFunctionEventInvokeConfigInput {
    ...
    pub fn builder() -> super::operation::put_function_event_invoke_config::builders::PutFunctionEventInvokeConfigInputBuilder {
        super::operation::put_function_event_invoke_config::builders::PutFunctionEventInvokeConfigInputBuilder::default()
    }
}
...
impl PutFunctionEventInvokeConfigInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::put_function_event_invoke_config::PutFunctionEventInvokeConfigInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::put_function_event_invoke_config::PutFunctionEventInvokeConfigInput {
