...
impl StopDurableExecutionInput {
    ...
    pub fn builder() -> super::operation::stop_durable_execution::builders::StopDurableExecutionInputBuilder {
        super::operation::stop_durable_execution::builders::StopDurableExecutionInputBuilder::default()
    }
}
...
impl StopDurableExecutionInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::stop_durable_execution::StopDurableExecutionInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::stop_durable_execution::StopDurableExecutionInput {
