...
impl StopDurableExecutionOutput {
    ...
    pub fn builder() -> super::operation::stop_durable_execution::builders::StopDurableExecutionOutputBuilder {
        super::operation::stop_durable_execution::builders::StopDurableExecutionOutputBuilder::default()
    }
}
...
impl StopDurableExecutionOutputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::stop_durable_execution::StopDurableExecutionOutput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::stop_durable_execution::StopDurableExecutionOutput {
