...
pub mod _get_runtime_management_config_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_runtime_management_config/_get_runtime_management_config_input.rs"
    ));
}
pub use _get_runtime_management_config_input::GetRuntimeManagementConfigInput;
pub type Input = GetRuntimeManagementConfigInput;
pub mod _get_runtime_management_config_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_runtime_management_config/_get_runtime_management_config_output.rs"
    ));
}
pub use _get_runtime_management_config_output::GetRuntimeManagementConfigOutput;
pub type Output = GetRuntimeManagementConfigOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_runtime_management_config/builders.rs"
    ));
}
pub type GetRuntimeManagementConfigError = Error;
pub type GetRuntimeManagementConfigFluentBuilder = builders::Builder;
