    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_runtime_management_config::GetRuntimeManagementConfigError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_runtime_management_config::GetRuntimeManagementConfigOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetRuntimeManagementConfigResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_runtime_management_config::de_get_runtime_management_config_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_runtime_management_config::de_get_runtime_management_config_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetRuntimeManagementConfigRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_runtime_management_config::GetRuntimeManagementConfigInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_runtime_management_config::GetRuntimeManagementConfigInput,
...
impl ::aws_types::request_id::RequestId for super::operation::get_runtime_management_config::GetRuntimeManagementConfigError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_runtime_management_config::_get_runtime_management_config_input::GetRuntimeManagementConfigInput;

pub use super::operation::get_runtime_management_config::_get_runtime_management_config_output::GetRuntimeManagementConfigOutput;
