...
pub mod _list_capacity_providers_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/list_capacity_providers/_list_capacity_providers_input.rs"
    ));
}
pub use _list_capacity_providers_input::ListCapacityProvidersInput;
pub type Input = ListCapacityProvidersInput;
pub mod _list_capacity_providers_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/list_capacity_providers/_list_capacity_providers_output.rs"
    ));
}
pub use _list_capacity_providers_output::ListCapacityProvidersOutput;
pub type Output = ListCapacityProvidersOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/list_capacity_providers/builders.rs"
    ));
}

/// Paginator for this operation
pub mod paginator;
pub type ListCapacityProvidersError = Error;
pub type ListCapacityProvidersFluentBuilder = builders::Builder;
