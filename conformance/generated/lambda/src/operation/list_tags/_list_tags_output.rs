...
impl ListTagsOutput {
    ...
    pub fn builder() -> super::operation::list_tags::builders::ListTagsOutputBuilder {
        super::operation::list_tags::builders::ListTagsOutputBuilder::default()
    }
}
...
impl ListTagsOutputBuilder {
    ...
    pub fn build(self) -> super::operation::list_tags::ListTagsOutput {
