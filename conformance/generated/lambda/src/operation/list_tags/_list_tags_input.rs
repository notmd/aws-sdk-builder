...
impl ListTagsInput {
    ...
    pub fn builder() -> super::operation::list_tags::builders::ListTagsInputBuilder {
        super::operation::list_tags::builders::ListTagsInputBuilder::default()
    }
}
...
impl ListTagsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::list_tags::ListTagsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_tags::ListTagsInput { resource: self.resource })
    }
}
