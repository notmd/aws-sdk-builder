...
pub mod _get_function_url_config_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_function_url_config/_get_function_url_config_input.rs"
    ));
}
pub use _get_function_url_config_input::GetFunctionUrlConfigInput;
pub type Input = GetFunctionUrlConfigInput;
pub mod _get_function_url_config_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_function_url_config/_get_function_url_config_output.rs"
    ));
}
pub use _get_function_url_config_output::GetFunctionUrlConfigOutput;
pub type Output = GetFunctionUrlConfigOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_function_url_config/builders.rs"
    ));
}
pub type GetFunctionUrlConfigError = Error;
pub type GetFunctionUrlConfigFluentBuilder = builders::Builder;
