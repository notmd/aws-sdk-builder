...
pub use super::operation::get_function::_get_function_input::GetFunctionInputBuilder;

pub use super::operation::get_function::_get_function_output::GetFunctionOutputBuilder;

impl super::operation::get_function::builders::GetFunctionInputBuilder {
...
impl GetFunctionFluentBuilder {
    ...
    > {
        ...
        super::operation::get_function::GetFunction::orchestrate(&runtime_plugins, input).await
    }
