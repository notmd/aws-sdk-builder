...
impl GetLayerVersionPolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::get_layer_version_policy::GetLayerVersionPolicyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_layer_version_policy::GetLayerVersionPolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_layer_version_policy::GetLayerVersionPolicyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetLayerVersionPolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_layer_version_policy::de_get_layer_version_policy_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_layer_version_policy::de_get_layer_version_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetLayerVersionPolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_layer_version_policy::GetLayerVersionPolicyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_layer_version_policy::GetLayerVersionPolicyInput,
...
impl ::aws_types::request_id::RequestId for super::operation::get_layer_version_policy::GetLayerVersionPolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_layer_version_policy::_get_layer_version_policy_input::GetLayerVersionPolicyInput;

pub use super::operation::get_layer_version_policy::_get_layer_version_policy_output::GetLayerVersionPolicyOutput;
