...
pub mod _get_layer_version_policy_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_layer_version_policy/_get_layer_version_policy_input.rs"
    ));
}
pub use _get_layer_version_policy_input::GetLayerVersionPolicyInput;
pub type Input = GetLayerVersionPolicyInput;
pub mod _get_layer_version_policy_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_layer_version_policy/_get_layer_version_policy_output.rs"
    ));
}
pub use _get_layer_version_policy_output::GetLayerVersionPolicyOutput;
pub type Output = GetLayerVersionPolicyOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_layer_version_policy/builders.rs"
    ));
}
pub type GetLayerVersionPolicyError = Error;
pub type GetLayerVersionPolicyFluentBuilder = builders::Builder;
