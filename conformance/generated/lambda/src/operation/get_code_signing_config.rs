...
pub mod _get_code_signing_config_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_code_signing_config/_get_code_signing_config_input.rs"
    ));
}
pub use _get_code_signing_config_input::GetCodeSigningConfigInput;
pub type Input = GetCodeSigningConfigInput;
pub mod _get_code_signing_config_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_code_signing_config/_get_code_signing_config_output.rs"
    ));
}
pub use _get_code_signing_config_output::GetCodeSigningConfigOutput;
pub type Output = GetCodeSigningConfigOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_code_signing_config/builders.rs"
    ));
}
pub type GetCodeSigningConfigError = Error;
pub type GetCodeSigningConfigFluentBuilder = builders::Builder;
