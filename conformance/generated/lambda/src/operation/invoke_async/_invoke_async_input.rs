...
impl InvokeAsyncInput {
    ...
    pub fn builder() -> super::operation::invoke_async::builders::InvokeAsyncInputBuilder {
        super::operation::invoke_async::builders::InvokeAsyncInputBuilder::default()
    }
}
...
impl InvokeAsyncInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::invoke_async::InvokeAsyncInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::invoke_async::InvokeAsyncInput {
