...
impl InvokeAsyncOutput {
    ...
    pub fn builder() -> super::operation::invoke_async::builders::InvokeAsyncOutputBuilder {
        super::operation::invoke_async::builders::InvokeAsyncOutputBuilder::default()
    }
}
...
impl InvokeAsyncOutputBuilder {
    ...
    pub fn build(self) -> super::operation::invoke_async::InvokeAsyncOutput {
