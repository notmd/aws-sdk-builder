...
impl DeleteFunctionEventInvokeConfigInput {
    ...
    pub fn builder() -> super::operation::delete_function_event_invoke_config::builders::DeleteFunctionEventInvokeConfigInputBuilder {
        super::operation::delete_function_event_invoke_config::builders::DeleteFunctionEventInvokeConfigInputBuilder::default()
    }
}
...
impl DeleteFunctionEventInvokeConfigInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::delete_function_event_invoke_config::DeleteFunctionEventInvokeConfigInput,
