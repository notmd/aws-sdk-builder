...
impl PublishLayerVersionInput {
    ...
    pub fn builder() -> super::operation::publish_layer_version::builders::PublishLayerVersionInputBuilder {
        super::operation::publish_layer_version::builders::PublishLayerVersionInputBuilder::default()
    }
}
...
impl PublishLayerVersionInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::publish_layer_version::PublishLayerVersionInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::publish_layer_version::PublishLayerVersionInput {
