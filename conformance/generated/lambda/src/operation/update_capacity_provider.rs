...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateCapacityProviderResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 202 || force_error {
            crate::protocol_serde::shape_update_capacity_provider::de_update_capacity_provider_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_update_capacity_provider::de_update_capacity_provider_http_response(status, headers, body)
        };
