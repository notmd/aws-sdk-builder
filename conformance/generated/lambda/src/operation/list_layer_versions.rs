...
pub mod _list_layer_versions_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/list_layer_versions/_list_layer_versions_input.rs"
    ));
}
pub use _list_layer_versions_input::ListLayerVersionsInput;
pub type Input = ListLayerVersionsInput;
pub mod _list_layer_versions_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/list_layer_versions/_list_layer_versions_output.rs"
    ));
}
pub use _list_layer_versions_output::ListLayerVersionsOutput;
pub type Output = ListLayerVersionsOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/list_layer_versions/builders.rs"
    ));
}

/// Paginator for this operation
pub mod paginator;
pub type ListLayerVersionsError = Error;
pub type ListLayerVersionsFluentBuilder = builders::Builder;
