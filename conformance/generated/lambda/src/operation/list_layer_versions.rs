    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_layer_versions::ListLayerVersionsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_layer_versions::ListLayerVersionsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListLayerVersionsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_layer_versions::de_list_layer_versions_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_layer_versions::de_list_layer_versions_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListLayerVersionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_layer_versions::ListLayerVersionsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_layer_versions::ListLayerVersionsInput,
...
impl ::aws_types::request_id::RequestId for super::operation::list_layer_versions::ListLayerVersionsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_layer_versions::_list_layer_versions_input::ListLayerVersionsInput;

pub use super::operation::list_layer_versions::_list_layer_versions_output::ListLayerVersionsOutput;
