...
pub mod _put_function_recursion_config_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/put_function_recursion_config/_put_function_recursion_config_input.rs"
    ));
}
pub use _put_function_recursion_config_input::PutFunctionRecursionConfigInput;
pub type Input = PutFunctionRecursionConfigInput;
pub mod _put_function_recursion_config_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/put_function_recursion_config/_put_function_recursion_config_output.rs"
    ));
}
pub use _put_function_recursion_config_output::PutFunctionRecursionConfigOutput;
pub type Output = PutFunctionRecursionConfigOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/put_function_recursion_config/builders.rs"
    ));
}
pub type PutFunctionRecursionConfigError = Error;
pub type PutFunctionRecursionConfigFluentBuilder = builders::Builder;
