...
impl DeleteFunctionCodeSigningConfigInput {
    ...
    pub fn builder() -> super::operation::delete_function_code_signing_config::builders::DeleteFunctionCodeSigningConfigInputBuilder {
        super::operation::delete_function_code_signing_config::builders::DeleteFunctionCodeSigningConfigInputBuilder::default()
    }
}
...
impl DeleteFunctionCodeSigningConfigInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::delete_function_code_signing_config::DeleteFunctionCodeSigningConfigInput,
