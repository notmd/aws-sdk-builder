...
pub mod _update_alias_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/update_alias/_update_alias_input.rs"
    ));
}
...
pub mod _update_alias_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/update_alias/_update_alias_output.rs"
    ));
}
...
/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/lambda/src/operation/update_alias/builders.rs"));
}
