...
impl UpdateAlias {
    ...
    pub(crate) async fn orchestrate(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::update_alias::UpdateAliasError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::update_alias::UpdateAliasError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::update_alias::UpdateAliasOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateAliasResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_update_alias::de_update_alias_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_update_alias::de_update_alias_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateAliasRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::update_alias::UpdateAliasInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::update_alias::UpdateAliasInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_update_alias::ser_update_alias_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::update_alias::UpdateAliasError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::update_alias::_update_alias_input::UpdateAliasInput;

pub use super::operation::update_alias::_update_alias_output::UpdateAliasOutput;
