    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::update_function_code::UpdateFunctionCodeError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::update_function_code::UpdateFunctionCodeOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateFunctionCodeResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_update_function_code::de_update_function_code_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_update_function_code::de_update_function_code_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateFunctionCodeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::update_function_code::UpdateFunctionCodeInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::update_function_code::UpdateFunctionCodeInput,
        ...
        let body =
            ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_update_function_code::ser_update_function_code_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::update_function_code::UpdateFunctionCodeError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::update_function_code::_update_function_code_input::UpdateFunctionCodeInput;

pub use super::operation::update_function_code::_update_function_code_output::UpdateFunctionCodeOutput;
