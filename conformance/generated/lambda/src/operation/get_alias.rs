...
pub mod _get_alias_input {
    include!(concat!(env!("OUT_DIR"), "/generated/lambda/src/operation/get_alias/_get_alias_input.rs"));
}
pub use _get_alias_input::GetAliasInput;
pub type Input = GetAliasInput;
pub mod _get_alias_output {
    include!(concat!(env!("OUT_DIR"), "/generated/lambda/src/operation/get_alias/_get_alias_output.rs"));
}
pub use _get_alias_output::GetAliasOutput;
pub type Output = GetAliasOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/lambda/src/operation/get_alias/builders.rs"));
}
pub type GetAliasError = Error;
pub type GetAliasFluentBuilder = builders::Builder;
