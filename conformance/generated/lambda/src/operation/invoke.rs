...
impl Invoke {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::operation::invoke::InvokeOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::invoke::InvokeError,
    ...
    > {
        let map_err =
            |err: ::aws_smithy_runtime_api::client::result::SdkError<
                ...
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >| { err.map_service_error(|err| err.downcast::<super::operation::invoke::InvokeError>().expect("correct error type")) };
        let context = Self::orchestrate_with_stop_point(runtime_plugins, input, ::aws_smithy_runtime::client::orchestrator::StopPoint::None)
            .await
            .map_err(map_err)?;
        let output = context.finalize().map_err(map_err)?;
        ::std::result::Result::Ok(output.downcast::<super::operation::invoke::InvokeOutput>().expect("correct output type"))
    }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for InvokeResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_invoke::de_invoke_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_invoke::de_invoke_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for InvokeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::invoke::InvokeInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::invoke::InvokeInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::protocol_serde::shape_invoke::ser_invoke_headers(input, builder)?;
...
impl ::aws_types::request_id::RequestId for super::operation::invoke::InvokeError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::invoke::_invoke_input::InvokeInput;

pub use super::operation::invoke::_invoke_output::InvokeOutput;
