...
pub mod _delete_function_url_config_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/delete_function_url_config/_delete_function_url_config_input.rs"
    ));
}
pub use _delete_function_url_config_input::DeleteFunctionUrlConfigInput;
pub type Input = DeleteFunctionUrlConfigInput;
pub mod _delete_function_url_config_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/delete_function_url_config/_delete_function_url_config_output.rs"
    ));
}
pub use _delete_function_url_config_output::DeleteFunctionUrlConfigOutput;
pub type Output = DeleteFunctionUrlConfigOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/delete_function_url_config/builders.rs"
    ));
}
pub type DeleteFunctionUrlConfigError = Error;
pub type DeleteFunctionUrlConfigFluentBuilder = builders::Builder;
