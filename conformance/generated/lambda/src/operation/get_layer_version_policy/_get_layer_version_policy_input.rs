...
impl GetLayerVersionPolicyInput {
    ...
    pub fn builder() -> super::operation::get_layer_version_policy::builders::GetLayerVersionPolicyInputBuilder {
        super::operation::get_layer_version_policy::builders::GetLayerVersionPolicyInputBuilder::default()
    }
}
...
impl GetLayerVersionPolicyInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_layer_version_policy::GetLayerVersionPolicyInput, ::aws_smithy_types::error::operation::BuildError>
    {
