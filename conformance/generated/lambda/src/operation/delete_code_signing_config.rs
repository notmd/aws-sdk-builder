...
pub mod _delete_code_signing_config_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/delete_code_signing_config/_delete_code_signing_config_input.rs"
    ));
}
pub use _delete_code_signing_config_input::DeleteCodeSigningConfigInput;
pub type Input = DeleteCodeSigningConfigInput;
pub mod _delete_code_signing_config_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/delete_code_signing_config/_delete_code_signing_config_output.rs"
    ));
}
pub use _delete_code_signing_config_output::DeleteCodeSigningConfigOutput;
pub type Output = DeleteCodeSigningConfigOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/delete_code_signing_config/builders.rs"
    ));
}
pub type DeleteCodeSigningConfigError = Error;
pub type DeleteCodeSigningConfigFluentBuilder = builders::Builder;
