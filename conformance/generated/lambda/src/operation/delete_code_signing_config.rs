    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_code_signing_config::DeleteCodeSigningConfigError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_code_signing_config::DeleteCodeSigningConfigOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteCodeSigningConfigResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 204 || force_error {
            super::protocol_serde::shape_delete_code_signing_config::de_delete_code_signing_config_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_code_signing_config::de_delete_code_signing_config_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteCodeSigningConfigRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_code_signing_config::DeleteCodeSigningConfigInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_code_signing_config::DeleteCodeSigningConfigInput,
...
impl ::aws_types::request_id::RequestId for super::operation::delete_code_signing_config::DeleteCodeSigningConfigError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_code_signing_config::_delete_code_signing_config_input::DeleteCodeSigningConfigInput;

pub use super::operation::delete_code_signing_config::_delete_code_signing_config_output::DeleteCodeSigningConfigOutput;
