...
impl SendDurableExecutionCallbackHeartbeatInput {
    ...
    pub fn builder() -> super::operation::send_durable_execution_callback_heartbeat::builders::SendDurableExecutionCallbackHeartbeatInputBuilder {
        super::operation::send_durable_execution_callback_heartbeat::builders::SendDurableExecutionCallbackHeartbeatInputBuilder::default()
    }
}
...
impl SendDurableExecutionCallbackHeartbeatInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::send_durable_execution_callback_heartbeat::SendDurableExecutionCallbackHeartbeatInput,
