...
pub struct ListVersionsByFunctionPaginator {
    ...
    builder: super::operation::list_versions_by_function::builders::ListVersionsByFunctionInputBuilder,
...
impl ListVersionsByFunctionPaginator {
    ...
    pub fn items(self) -> super::operation::list_versions_by_function::paginator::ListVersionsByFunctionPaginatorItems {
        super::operation::list_versions_by_function::paginator::ListVersionsByFunctionPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            super::operation::list_versions_by_function::ListVersionsByFunction::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_list_versions_by_function_output_output_next_marker(resp);
...
impl ListVersionsByFunctionPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::lens::lens_list_versions_by_function_output_output_versions(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
