...
pub struct ListVersionsByFunctionOutput {
    ...
    pub versions: ::std::option::Option<::std::vec::Vec<super::types::FunctionConfiguration>>,
...
impl ListVersionsByFunctionOutput {
    ...
    pub fn versions(&self) -> &[super::types::FunctionConfiguration] {
...
impl ListVersionsByFunctionOutput {
    ...
    pub fn builder() -> super::operation::list_versions_by_function::builders::ListVersionsByFunctionOutputBuilder {
        super::operation::list_versions_by_function::builders::ListVersionsByFunctionOutputBuilder::default()
    }
}
...
pub struct ListVersionsByFunctionOutputBuilder {
    ...
    pub(crate) versions: ::std::option::Option<::std::vec::Vec<super::types::FunctionConfiguration>>,
    _request_id: Option<String>,
}
impl ListVersionsByFunctionOutputBuilder {
    ...
    ///
    /// <p>A list of Lambda function versions.</p>
    pub fn versions(mut self, input: super::types::FunctionConfiguration) -> Self {
    ...
    /// <p>A list of Lambda function versions.</p>
    pub fn set_versions(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::FunctionConfiguration>>) -> Self {
        self.versions = input;
        self
    }
    /// <p>A list of Lambda function versions.</p>
    pub fn get_versions(&self) -> &::std::option::Option<::std::vec::Vec<super::types::FunctionConfiguration>> {
        &self.versions
    }
    ...
    pub fn build(self) -> super::operation::list_versions_by_function::ListVersionsByFunctionOutput {
