...
impl GetCodeSigningConfigInput {
    ...
    pub fn builder() -> super::operation::get_code_signing_config::builders::GetCodeSigningConfigInputBuilder {
        super::operation::get_code_signing_config::builders::GetCodeSigningConfigInputBuilder::default()
    }
}
...
impl GetCodeSigningConfigInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_code_signing_config::GetCodeSigningConfigInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::get_code_signing_config::GetCodeSigningConfigInput {
