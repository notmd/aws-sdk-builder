...
pub mod _get_function_event_invoke_config_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_function_event_invoke_config/_get_function_event_invoke_config_input.rs"
    ));
}
...
pub mod _get_function_event_invoke_config_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_function_event_invoke_config/_get_function_event_invoke_config_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_function_event_invoke_config/builders.rs"
    ));
}
