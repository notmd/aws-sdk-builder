...
pub mod _remove_layer_version_permission_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/remove_layer_version_permission/_remove_layer_version_permission_input.rs"
    ));
}
pub use _remove_layer_version_permission_input::RemoveLayerVersionPermissionInput;
pub type Input = RemoveLayerVersionPermissionInput;
pub mod _remove_layer_version_permission_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/remove_layer_version_permission/_remove_layer_version_permission_output.rs"
    ));
}
pub use _remove_layer_version_permission_output::RemoveLayerVersionPermissionOutput;
pub type Output = RemoveLayerVersionPermissionOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/remove_layer_version_permission/builders.rs"
    ));
}
pub type RemoveLayerVersionPermissionError = Error;
pub type RemoveLayerVersionPermissionFluentBuilder = builders::Builder;
