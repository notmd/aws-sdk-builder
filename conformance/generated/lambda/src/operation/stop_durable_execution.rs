...
pub mod _stop_durable_execution_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/stop_durable_execution/_stop_durable_execution_input.rs"
    ));
}
pub use _stop_durable_execution_input::StopDurableExecutionInput;
pub type Input = StopDurableExecutionInput;
pub mod _stop_durable_execution_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/stop_durable_execution/_stop_durable_execution_output.rs"
    ));
}
pub use _stop_durable_execution_output::StopDurableExecutionOutput;
pub type Output = StopDurableExecutionOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/stop_durable_execution/builders.rs"
    ));
}
pub type StopDurableExecutionError = Error;
pub type StopDurableExecutionFluentBuilder = builders::Builder;
