    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::stop_durable_execution::StopDurableExecutionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::stop_durable_execution::StopDurableExecutionOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopDurableExecutionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_stop_durable_execution::de_stop_durable_execution_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_stop_durable_execution::de_stop_durable_execution_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StopDurableExecutionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::stop_durable_execution::StopDurableExecutionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::stop_durable_execution::StopDurableExecutionInput,
...
impl ::aws_types::request_id::RequestId for super::operation::stop_durable_execution::StopDurableExecutionError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::stop_durable_execution::_stop_durable_execution_input::StopDurableExecutionInput;

pub use super::operation::stop_durable_execution::_stop_durable_execution_output::StopDurableExecutionOutput;
