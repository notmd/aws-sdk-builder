...
pub struct ListLayerVersionsInput {
    ...
    pub compatible_architecture: ::std::option::Option<super::types::Architecture>,
    ...
    pub compatible_runtime: ::std::option::Option<super::types::Runtime>,
...
impl ListLayerVersionsInput {
    /// <p>The compatible <a href="https://docs.aws.amazon.com/lambda/latest/dg/foundation-arch.html">instruction set architecture</a>.</p>
    pub fn compatible_architecture(&self) -> ::std::option::Option<&super::types::Architecture> {
        self.compatible_architecture.as_ref()
    }
    /// <p>A runtime identifier.</p>
    /// <p>The following list includes deprecated runtimes. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/lambda-runtimes.html#runtime-deprecation-levels">Runtime use after deprecation</a>.</p>
    /// <p>For a list of all currently supported runtimes, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/lambda-runtimes.html#runtimes-supported">Supported runtimes</a>.</p>
    pub fn compatible_runtime(&self) -> ::std::option::Option<&super::types::Runtime> {
...
impl ListLayerVersionsInput {
    ...
    pub fn builder() -> super::operation::list_layer_versions::builders::ListLayerVersionsInputBuilder {
        super::operation::list_layer_versions::builders::ListLayerVersionsInputBuilder::default()
    }
}
...
pub struct ListLayerVersionsInputBuilder {
    pub(crate) compatible_architecture: ::std::option::Option<super::types::Architecture>,
    pub(crate) compatible_runtime: ::std::option::Option<super::types::Runtime>,
...
impl ListLayerVersionsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_layer_versions::ListLayerVersionsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_layer_versions::ListLayerVersionsInput {
