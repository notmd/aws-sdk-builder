...
impl DeleteProvisionedConcurrencyConfig {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::operation::delete_provisioned_concurrency_config::DeleteProvisionedConcurrencyConfigOutput,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_provisioned_concurrency_config::DeleteProvisionedConcurrencyConfigError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_provisioned_concurrency_config::DeleteProvisionedConcurrencyConfigOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteProvisionedConcurrencyConfigResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 204 || force_error {
            super::protocol_serde::shape_delete_provisioned_concurrency_config::de_delete_provisioned_concurrency_config_http_error(
                status, headers, body,
            )
        } else {
            super::protocol_serde::shape_delete_provisioned_concurrency_config::de_delete_provisioned_concurrency_config_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteProvisionedConcurrencyConfigRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_provisioned_concurrency_config::DeleteProvisionedConcurrencyConfigInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_provisioned_concurrency_config::DeleteProvisionedConcurrencyConfigInput,
...
impl ::aws_types::request_id::RequestId for super::operation::delete_provisioned_concurrency_config::DeleteProvisionedConcurrencyConfigError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_provisioned_concurrency_config::_delete_provisioned_concurrency_config_input::DeleteProvisionedConcurrencyConfigInput;

pub use super::operation::delete_provisioned_concurrency_config::_delete_provisioned_concurrency_config_output::DeleteProvisionedConcurrencyConfigOutput;
