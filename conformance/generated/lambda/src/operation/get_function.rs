    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_function::GetFunctionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_function::GetFunctionOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetFunctionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_function::de_get_function_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_function::de_get_function_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetFunctionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_function::GetFunctionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_function::GetFunctionInput,
...
impl ::aws_types::request_id::RequestId for super::operation::get_function::GetFunctionError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_function::_get_function_input::GetFunctionInput;

pub use super::operation::get_function::_get_function_output::GetFunctionOutput;
