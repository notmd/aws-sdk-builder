...
pub mod _get_function_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_function/_get_function_input.rs"
    ));
}
pub use _get_function_input::GetFunctionInput;
pub type Input = GetFunctionInput;
pub mod _get_function_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_function/_get_function_output.rs"
    ));
}
pub use _get_function_output::GetFunctionOutput;
pub type Output = GetFunctionOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/lambda/src/operation/get_function/builders.rs"));
}
pub type GetFunctionError = Error;
pub type GetFunctionFluentBuilder = builders::Builder;
