    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_durable_executions_by_function::ListDurableExecutionsByFunctionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_durable_executions_by_function::ListDurableExecutionsByFunctionOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListDurableExecutionsByFunctionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_durable_executions_by_function::de_list_durable_executions_by_function_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_durable_executions_by_function::de_list_durable_executions_by_function_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListDurableExecutionsByFunctionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_durable_executions_by_function::ListDurableExecutionsByFunctionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_durable_executions_by_function::ListDurableExecutionsByFunctionInput,
...
impl ::aws_types::request_id::RequestId for super::operation::list_durable_executions_by_function::ListDurableExecutionsByFunctionError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_durable_executions_by_function::_list_durable_executions_by_function_input::ListDurableExecutionsByFunctionInput;

pub use super::operation::list_durable_executions_by_function::_list_durable_executions_by_function_output::ListDurableExecutionsByFunctionOutput;
