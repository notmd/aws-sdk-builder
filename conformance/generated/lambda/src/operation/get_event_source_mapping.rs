...
pub mod _get_event_source_mapping_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_event_source_mapping/_get_event_source_mapping_input.rs"
    ));
}
pub use _get_event_source_mapping_input::GetEventSourceMappingInput;
pub type Input = GetEventSourceMappingInput;
pub mod _get_event_source_mapping_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_event_source_mapping/_get_event_source_mapping_output.rs"
    ));
}
pub use _get_event_source_mapping_output::GetEventSourceMappingOutput;
pub type Output = GetEventSourceMappingOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_event_source_mapping/builders.rs"
    ));
}
pub type GetEventSourceMappingError = Error;
pub type GetEventSourceMappingFluentBuilder = builders::Builder;
