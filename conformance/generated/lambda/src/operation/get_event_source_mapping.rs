    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_event_source_mapping::GetEventSourceMappingError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_event_source_mapping::GetEventSourceMappingOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetEventSourceMappingResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_event_source_mapping::de_get_event_source_mapping_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_event_source_mapping::de_get_event_source_mapping_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetEventSourceMappingRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_event_source_mapping::GetEventSourceMappingInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_event_source_mapping::GetEventSourceMappingInput,
...
impl ::aws_types::request_id::RequestId for super::operation::get_event_source_mapping::GetEventSourceMappingError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_event_source_mapping::_get_event_source_mapping_input::GetEventSourceMappingInput;

pub use super::operation::get_event_source_mapping::_get_event_source_mapping_output::GetEventSourceMappingOutput;
