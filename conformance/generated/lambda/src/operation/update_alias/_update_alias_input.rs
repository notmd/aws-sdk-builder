...
impl UpdateAliasInput {
    ...
    pub fn builder() -> super::operation::update_alias::builders::UpdateAliasInputBuilder {
        super::operation::update_alias::builders::UpdateAliasInputBuilder::default()
    }
}
...
impl UpdateAliasInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::update_alias::UpdateAliasInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::update_alias::UpdateAliasInput {
