...
pub mod _get_capacity_provider_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_capacity_provider/_get_capacity_provider_input.rs"
    ));
}
pub use _get_capacity_provider_input::GetCapacityProviderInput;
pub type Input = GetCapacityProviderInput;
pub mod _get_capacity_provider_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_capacity_provider/_get_capacity_provider_output.rs"
    ));
}
pub use _get_capacity_provider_output::GetCapacityProviderOutput;
pub type Output = GetCapacityProviderOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_capacity_provider/builders.rs"
    ));
}
pub type GetCapacityProviderError = Error;
pub type GetCapacityProviderFluentBuilder = builders::Builder;
