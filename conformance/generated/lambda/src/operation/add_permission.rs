...
pub mod _add_permission_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/add_permission/_add_permission_input.rs"
    ));
}
...
pub mod _add_permission_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/add_permission/_add_permission_output.rs"
    ));
}
...
/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/lambda/src/operation/add_permission/builders.rs"));
}
