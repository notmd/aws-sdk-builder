...
pub mod _update_function_url_config_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/update_function_url_config/_update_function_url_config_input.rs"
    ));
}
pub use _update_function_url_config_input::UpdateFunctionUrlConfigInput;
pub type Input = UpdateFunctionUrlConfigInput;
pub mod _update_function_url_config_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/update_function_url_config/_update_function_url_config_output.rs"
    ));
}
pub use _update_function_url_config_output::UpdateFunctionUrlConfigOutput;
pub type Output = UpdateFunctionUrlConfigOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/update_function_url_config/builders.rs"
    ));
}
pub type UpdateFunctionUrlConfigError = Error;
pub type UpdateFunctionUrlConfigFluentBuilder = builders::Builder;
