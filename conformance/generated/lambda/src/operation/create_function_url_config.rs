...
pub mod _create_function_url_config_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/create_function_url_config/_create_function_url_config_input.rs"
    ));
}
pub use _create_function_url_config_input::CreateFunctionUrlConfigInput;
pub type Input = CreateFunctionUrlConfigInput;
pub mod _create_function_url_config_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/create_function_url_config/_create_function_url_config_output.rs"
    ));
}
pub use _create_function_url_config_output::CreateFunctionUrlConfigOutput;
pub type Output = CreateFunctionUrlConfigOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/create_function_url_config/builders.rs"
    ));
}
pub type CreateFunctionUrlConfigError = Error;
pub type CreateFunctionUrlConfigFluentBuilder = builders::Builder;
