...
pub mod _get_function_configuration_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_function_configuration/_get_function_configuration_input.rs"
    ));
}
pub use _get_function_configuration_input::GetFunctionConfigurationInput;
pub type Input = GetFunctionConfigurationInput;
pub mod _get_function_configuration_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_function_configuration/_get_function_configuration_output.rs"
    ));
}
pub use _get_function_configuration_output::GetFunctionConfigurationOutput;
pub type Output = GetFunctionConfigurationOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_function_configuration/builders.rs"
    ));
}
pub type GetFunctionConfigurationError = Error;
pub type GetFunctionConfigurationFluentBuilder = builders::Builder;
