...
impl GetLayerVersionByArnOutput {
    ...
    pub fn builder() -> super::operation::get_layer_version_by_arn::builders::GetLayerVersionByArnOutputBuilder {
        super::operation::get_layer_version_by_arn::builders::GetLayerVersionByArnOutputBuilder::default()
    }
}
...
impl GetLayerVersionByArnOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_layer_version_by_arn::GetLayerVersionByArnOutput {
