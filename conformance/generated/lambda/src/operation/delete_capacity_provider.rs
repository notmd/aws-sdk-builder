...
pub mod _delete_capacity_provider_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/delete_capacity_provider/_delete_capacity_provider_input.rs"
    ));
}
pub use _delete_capacity_provider_input::DeleteCapacityProviderInput;
pub type Input = DeleteCapacityProviderInput;
pub mod _delete_capacity_provider_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/delete_capacity_provider/_delete_capacity_provider_output.rs"
    ));
}
pub use _delete_capacity_provider_output::DeleteCapacityProviderOutput;
pub type Output = DeleteCapacityProviderOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/delete_capacity_provider/builders.rs"
    ));
}
pub type DeleteCapacityProviderError = Error;
pub type DeleteCapacityProviderFluentBuilder = builders::Builder;
