    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_capacity_provider::DeleteCapacityProviderError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_capacity_provider::DeleteCapacityProviderOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteCapacityProviderResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 202 || force_error {
            super::protocol_serde::shape_delete_capacity_provider::de_delete_capacity_provider_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_capacity_provider::de_delete_capacity_provider_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteCapacityProviderRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_capacity_provider::DeleteCapacityProviderInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_capacity_provider::DeleteCapacityProviderInput,
...
impl ::aws_types::request_id::RequestId for super::operation::delete_capacity_provider::DeleteCapacityProviderError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_capacity_provider::_delete_capacity_provider_input::DeleteCapacityProviderInput;

pub use super::operation::delete_capacity_provider::_delete_capacity_provider_output::DeleteCapacityProviderOutput;
