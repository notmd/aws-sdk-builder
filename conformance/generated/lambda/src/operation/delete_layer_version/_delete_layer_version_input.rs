...
impl DeleteLayerVersionInput {
    ...
    pub fn builder() -> super::operation::delete_layer_version::builders::DeleteLayerVersionInputBuilder {
        super::operation::delete_layer_version::builders::DeleteLayerVersionInputBuilder::default()
    }
}
...
impl DeleteLayerVersionInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::delete_layer_version::DeleteLayerVersionInput, ::aws_smithy_types::error::operation::BuildError>
    {
