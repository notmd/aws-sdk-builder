...
pub mod _list_aliases_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/list_aliases/_list_aliases_input.rs"
    ));
}
...
pub mod _list_aliases_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/list_aliases/_list_aliases_output.rs"
    ));
}
...
/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/lambda/src/operation/list_aliases/builders.rs"));
}
