    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_aliases::ListAliasesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_aliases::ListAliasesOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAliasesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_aliases::de_list_aliases_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_aliases::de_list_aliases_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAliasesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_aliases::ListAliasesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_aliases::ListAliasesInput,
...
impl ::aws_types::request_id::RequestId for super::operation::list_aliases::ListAliasesError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_aliases::_list_aliases_input::ListAliasesInput;

pub use super::operation::list_aliases::_list_aliases_output::ListAliasesOutput;
