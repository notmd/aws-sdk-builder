...
pub mod _delete_function_event_invoke_config_input {
    include!(concat!(env!("OUT_DIR"), "/generated/lambda/src/operation/delete_function_event_invoke_config/_delete_function_event_invoke_config_input.rs"));
}
pub use _delete_function_event_invoke_config_input::DeleteFunctionEventInvokeConfigInput;
pub type Input = DeleteFunctionEventInvokeConfigInput;
pub mod _delete_function_event_invoke_config_output {
    include!(concat!(env!("OUT_DIR"), "/generated/lambda/src/operation/delete_function_event_invoke_config/_delete_function_event_invoke_config_output.rs"));
}
pub use _delete_function_event_invoke_config_output::DeleteFunctionEventInvokeConfigOutput;
pub type Output = DeleteFunctionEventInvokeConfigOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/lambda/src/operation/delete_function_event_invoke_config/builders.rs"));
}
