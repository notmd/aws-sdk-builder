...
pub mod _get_function_recursion_config_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_function_recursion_config/_get_function_recursion_config_input.rs"
    ));
}
pub use _get_function_recursion_config_input::GetFunctionRecursionConfigInput;
pub type Input = GetFunctionRecursionConfigInput;
pub mod _get_function_recursion_config_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_function_recursion_config/_get_function_recursion_config_output.rs"
    ));
}
pub use _get_function_recursion_config_output::GetFunctionRecursionConfigOutput;
pub type Output = GetFunctionRecursionConfigOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_function_recursion_config/builders.rs"
    ));
}
pub type GetFunctionRecursionConfigError = Error;
pub type GetFunctionRecursionConfigFluentBuilder = builders::Builder;
