...
pub mod _list_event_source_mappings_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/list_event_source_mappings/_list_event_source_mappings_input.rs"
    ));
}
pub use _list_event_source_mappings_input::ListEventSourceMappingsInput;
pub type Input = ListEventSourceMappingsInput;
pub mod _list_event_source_mappings_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/list_event_source_mappings/_list_event_source_mappings_output.rs"
    ));
}
pub use _list_event_source_mappings_output::ListEventSourceMappingsOutput;
pub type Output = ListEventSourceMappingsOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/list_event_source_mappings/builders.rs"
    ));
}

/// Paginator for this operation
pub mod paginator;
pub type ListEventSourceMappingsError = Error;
pub type ListEventSourceMappingsFluentBuilder = builders::Builder;
