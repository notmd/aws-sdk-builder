...
pub mod _delete_function_concurrency_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/delete_function_concurrency/_delete_function_concurrency_input.rs"
    ));
}
pub use _delete_function_concurrency_input::DeleteFunctionConcurrencyInput;
pub type Input = DeleteFunctionConcurrencyInput;
pub mod _delete_function_concurrency_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/delete_function_concurrency/_delete_function_concurrency_output.rs"
    ));
}
pub use _delete_function_concurrency_output::DeleteFunctionConcurrencyOutput;
pub type Output = DeleteFunctionConcurrencyOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/delete_function_concurrency/builders.rs"
    ));
}
pub type DeleteFunctionConcurrencyError = Error;
pub type DeleteFunctionConcurrencyFluentBuilder = builders::Builder;
