...
impl GetLayerVersion {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::operation::get_layer_version::GetLayerVersionOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::get_layer_version::GetLayerVersionError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_layer_version::GetLayerVersionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_layer_version::GetLayerVersionOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetLayerVersionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_layer_version::de_get_layer_version_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_layer_version::de_get_layer_version_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetLayerVersionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_layer_version::GetLayerVersionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_layer_version::GetLayerVersionInput,
...
impl ::aws_types::request_id::RequestId for super::operation::get_layer_version::GetLayerVersionError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_layer_version::_get_layer_version_input::GetLayerVersionInput;

pub use super::operation::get_layer_version::_get_layer_version_output::GetLayerVersionOutput;
