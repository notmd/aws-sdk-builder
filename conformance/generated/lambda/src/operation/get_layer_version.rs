...
pub mod _get_layer_version_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_layer_version/_get_layer_version_input.rs"
    ));
}
pub use _get_layer_version_input::GetLayerVersionInput;
pub type Input = GetLayerVersionInput;
pub mod _get_layer_version_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_layer_version/_get_layer_version_output.rs"
    ));
}
pub use _get_layer_version_output::GetLayerVersionOutput;
pub type Output = GetLayerVersionOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/lambda/src/operation/get_layer_version/builders.rs"));
}
pub type GetLayerVersionError = Error;
pub type GetLayerVersionFluentBuilder = builders::Builder;
