...
pub mod _put_function_concurrency_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/put_function_concurrency/_put_function_concurrency_input.rs"
    ));
}
pub use _put_function_concurrency_input::PutFunctionConcurrencyInput;
pub type Input = PutFunctionConcurrencyInput;
pub mod _put_function_concurrency_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/put_function_concurrency/_put_function_concurrency_output.rs"
    ));
}
pub use _put_function_concurrency_output::PutFunctionConcurrencyOutput;
pub type Output = PutFunctionConcurrencyOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/put_function_concurrency/builders.rs"
    ));
}
pub type PutFunctionConcurrencyError = Error;
pub type PutFunctionConcurrencyFluentBuilder = builders::Builder;
