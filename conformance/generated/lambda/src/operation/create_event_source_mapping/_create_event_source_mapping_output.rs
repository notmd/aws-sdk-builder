...
impl CreateEventSourceMappingOutput {
    ...
    pub fn builder() -> super::operation::create_event_source_mapping::builders::CreateEventSourceMappingOutputBuilder {
        super::operation::create_event_source_mapping::builders::CreateEventSourceMappingOutputBuilder::default()
    }
}
...
impl CreateEventSourceMappingOutputBuilder {
    ...
    pub fn build(self) -> super::operation::create_event_source_mapping::CreateEventSourceMappingOutput {
