...
impl GetFunctionCodeSigningConfigOutput {
    ...
    pub fn builder() -> super::operation::get_function_code_signing_config::builders::GetFunctionCodeSigningConfigOutputBuilder {
        super::operation::get_function_code_signing_config::builders::GetFunctionCodeSigningConfigOutputBuilder::default()
    }
}
...
impl GetFunctionCodeSigningConfigOutputBuilder {
    ...
    > {
        ::std::result::Result::Ok(super::operation::get_function_code_signing_config::GetFunctionCodeSigningConfigOutput {
