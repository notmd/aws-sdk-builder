...
impl GetFunctionCodeSigningConfigInput {
    ...
    pub fn builder() -> super::operation::get_function_code_signing_config::builders::GetFunctionCodeSigningConfigInputBuilder {
        super::operation::get_function_code_signing_config::builders::GetFunctionCodeSigningConfigInputBuilder::default()
    }
}
...
impl GetFunctionCodeSigningConfigInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::get_function_code_signing_config::GetFunctionCodeSigningConfigInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::get_function_code_signing_config::GetFunctionCodeSigningConfigInput {
