    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::publish_layer_version::PublishLayerVersionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::publish_layer_version::PublishLayerVersionOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PublishLayerVersionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 201 || force_error {
            super::protocol_serde::shape_publish_layer_version::de_publish_layer_version_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_publish_layer_version::de_publish_layer_version_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PublishLayerVersionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::publish_layer_version::PublishLayerVersionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::publish_layer_version::PublishLayerVersionInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_publish_layer_version::ser_publish_layer_version_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::operation::publish_layer_version::PublishLayerVersionError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::publish_layer_version::_publish_layer_version_input::PublishLayerVersionInput;

pub use super::operation::publish_layer_version::_publish_layer_version_output::PublishLayerVersionOutput;
