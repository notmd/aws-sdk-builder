...
pub struct ListDurableExecutionsByFunctionInput {
    ...
    pub statuses: ::std::option::Option<::std::vec::Vec<super::types::ExecutionStatus>>,
...
impl ListDurableExecutionsByFunctionInput {
    ...
    pub fn statuses(&self) -> &[super::types::ExecutionStatus] {
...
impl ListDurableExecutionsByFunctionInput {
    ...
    pub fn builder() -> super::operation::list_durable_executions_by_function::builders::ListDurableExecutionsByFunctionInputBuilder {
        super::operation::list_durable_executions_by_function::builders::ListDurableExecutionsByFunctionInputBuilder::default()
    }
}
...
pub struct ListDurableExecutionsByFunctionInputBuilder {
    ...
    pub(crate) statuses: ::std::option::Option<::std::vec::Vec<super::types::ExecutionStatus>>,
...
impl ListDurableExecutionsByFunctionInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::list_durable_executions_by_function::ListDurableExecutionsByFunctionInput,
