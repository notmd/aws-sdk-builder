...
pub use super::operation::list_durable_executions_by_function::_list_durable_executions_by_function_input::ListDurableExecutionsByFunctionInputBuilder;

pub use super::operation::list_durable_executions_by_function::_list_durable_executions_by_function_output::ListDurableExecutionsByFunctionOutputBuilder;

impl super::operation::list_durable_executions_by_function::builders::ListDurableExecutionsByFunctionInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::Client,
    ) -> ::std::result::Result<
        super::operation::list_durable_executions_by_function::ListDurableExecutionsByFunctionOutput,
...
pub struct ListDurableExecutionsByFunctionFluentBuilder {
    ...
    inner: super::operation::list_durable_executions_by_function::builders::ListDurableExecutionsByFunctionInputBuilder,
...
impl ListDurableExecutionsByFunctionFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::list_durable_executions_by_function::builders::ListDurableExecutionsByFunctionInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::list_durable_executions_by_function::ListDurableExecutionsByFunction::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::list_durable_executions_by_function::ListDurableExecutionsByFunction::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::operation::list_durable_executions_by_function::paginator::ListDurableExecutionsByFunctionPaginator {
        super::operation::list_durable_executions_by_function::paginator::ListDurableExecutionsByFunctionPaginator::new(self.handle, self.inner)
    }
    ...
    pub fn statuses(mut self, input: super::types::ExecutionStatus) -> Self {
        self.inner = self.inner.statuses(input);
        self
    }
    /// <p>Filter executions by status. Valid values: RUNNING, SUCCEEDED, FAILED, TIMED_OUT, STOPPED.</p>
    pub fn set_statuses(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::ExecutionStatus>>) -> Self {
        self.inner = self.inner.set_statuses(input);
        self
    }
    /// <p>Filter executions by status. Valid values: RUNNING, SUCCEEDED, FAILED, TIMED_OUT, STOPPED.</p>
    pub fn get_statuses(&self) -> &::std::option::Option<::std::vec::Vec<super::types::ExecutionStatus>> {
