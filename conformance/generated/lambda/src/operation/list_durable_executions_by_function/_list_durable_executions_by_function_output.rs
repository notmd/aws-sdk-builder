...
pub struct ListDurableExecutionsByFunctionOutput {
    ...
    pub durable_executions: ::std::option::Option<::std::vec::Vec<super::types::Execution>>,
...
impl ListDurableExecutionsByFunctionOutput {
    ...
    pub fn durable_executions(&self) -> &[super::types::Execution] {
...
impl ListDurableExecutionsByFunctionOutput {
    ...
    pub fn builder() -> super::operation::list_durable_executions_by_function::builders::ListDurableExecutionsByFunctionOutputBuilder {
        super::operation::list_durable_executions_by_function::builders::ListDurableExecutionsByFunctionOutputBuilder::default()
    }
}
...
pub struct ListDurableExecutionsByFunctionOutputBuilder {
    pub(crate) durable_executions: ::std::option::Option<::std::vec::Vec<super::types::Execution>>,
...
impl ListDurableExecutionsByFunctionOutputBuilder {
    ...
    ///
    /// <p>List of durable execution summaries matching the filter criteria.</p>
    pub fn durable_executions(mut self, input: super::types::Execution) -> Self {
    ...
    /// <p>List of durable execution summaries matching the filter criteria.</p>
    pub fn set_durable_executions(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::Execution>>) -> Self {
        self.durable_executions = input;
        self
    }
    /// <p>List of durable execution summaries matching the filter criteria.</p>
    pub fn get_durable_executions(&self) -> &::std::option::Option<::std::vec::Vec<super::types::Execution>> {
    ...
    pub fn build(self) -> super::operation::list_durable_executions_by_function::ListDurableExecutionsByFunctionOutput {
