...
pub struct CreateFunctionInput {
    ...
    pub code: ::std::option::Option<super::types::FunctionCode>,
    ...
    pub publish_to: ::std::option::Option<super::types::FunctionVersionLatestPublished>,
    ...
    pub vpc_config: ::std::option::Option<super::types::VpcConfig>,
    ...
    pub environment: ::std::option::Option<super::types::Environment>,
    ...
    pub tracing_config: ::std::option::Option<super::types::TracingConfig>,
    ...
    pub image_config: ::std::option::Option<super::types::ImageConfig>,
    ...
    pub snap_start: ::std::option::Option<super::types::SnapStart>,
...
impl CreateFunctionInput {
    ...
    /// <p>The code for the function.</p>
    pub fn code(&self) -> ::std::option::Option<&super::types::FunctionCode> {
        self.code.as_ref()
    }
    /// <p>A description of the function.</p>
    ...
    /// <p>Specifies where to publish the function version or configuration.</p>
    pub fn publish_to(&self) -> ::std::option::Option<&super::types::FunctionVersionLatestPublished> {
        self.publish_to.as_ref()
    }
    /// <p>For network connectivity to Amazon Web Services resources in a VPC, specify a list of security groups and subnets in the VPC. When you connect a function to a VPC, it can access resources and the internet only through that VPC. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/configuration-vpc.html">Configuring a Lambda function to access resources in a VPC</a>.</p>
    pub fn vpc_config(&self) -> ::std::option::Option<&super::types::VpcConfig> {
    ...
    /// <p>Environment variables that are accessible from function code during execution.</p>
    pub fn environment(&self) -> ::std::option::Option<&super::types::Environment> {
    ...
    /// <p>Set <code>Mode</code> to <code>Active</code> to sample and trace a subset of incoming requests with <a href="https://docs.aws.amazon.com/lambda/latest/dg/services-xray.html">X-Ray</a>.</p>
    pub fn tracing_config(&self) -> ::std::option::Option<&super::types::TracingConfig> {
    ...
    /// <p>Container image <a href="https://docs.aws.amazon.com/lambda/latest/dg/images-create.html#images-parms">configuration values</a> that override the values in the container image Dockerfile.</p>
    pub fn image_config(&self) -> ::std::option::Option<&super::types::ImageConfig> {
    ...
    /// <p>The function's <a href="https://docs.aws.amazon.com/lambda/latest/dg/snapstart.html">SnapStart</a> setting.</p>
    pub fn snap_start(&self) -> ::std::option::Option<&super::types::SnapStart> {
...
impl CreateFunctionInput {
    ...
    pub fn builder() -> super::operation::create_function::builders::CreateFunctionInputBuilder {
        super::operation::create_function::builders::CreateFunctionInputBuilder::default()
    }
}
...
pub struct CreateFunctionInputBuilder {
    ...
    pub(crate) code: ::std::option::Option<super::types::FunctionCode>,
    pub(crate) description: ::std::option::Option<::std::string::String>,
    pub(crate) timeout: ::std::option::Option<i32>,
    pub(crate) memory_size: ::std::option::Option<i32>,
    pub(crate) publish: ::std::option::Option<bool>,
    pub(crate) publish_to: ::std::option::Option<super::types::FunctionVersionLatestPublished>,
    pub(crate) vpc_config: ::std::option::Option<super::types::VpcConfig>,
    ...
    pub(crate) environment: ::std::option::Option<super::types::Environment>,
    pub(crate) kms_key_arn: ::std::option::Option<::std::string::String>,
    pub(crate) tracing_config: ::std::option::Option<super::types::TracingConfig>,
    ...
    pub(crate) image_config: ::std::option::Option<super::types::ImageConfig>,
    ...
    pub(crate) snap_start: ::std::option::Option<super::types::SnapStart>,
...
impl CreateFunctionInputBuilder {
    ...
    /// <p>The code for the function.</p>
    /// This field is required.
    pub fn code(mut self, input: super::types::FunctionCode) -> Self {
        self.code = ::std::option::Option::Some(input);
        self
    }
    /// <p>The code for the function.</p>
    pub fn set_code(mut self, input: ::std::option::Option<super::types::FunctionCode>) -> Self {
        self.code = input;
        self
    }
    /// <p>The code for the function.</p>
    pub fn get_code(&self) -> &::std::option::Option<super::types::FunctionCode> {
        &self.code
    }
    /// <p>A description of the function.</p>
    ...
    /// <p>Specifies where to publish the function version or configuration.</p>
    pub fn publish_to(mut self, input: super::types::FunctionVersionLatestPublished) -> Self {
        self.publish_to = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies where to publish the function version or configuration.</p>
    pub fn set_publish_to(mut self, input: ::std::option::Option<super::types::FunctionVersionLatestPublished>) -> Self {
        self.publish_to = input;
        self
    }
    /// <p>Specifies where to publish the function version or configuration.</p>
    pub fn get_publish_to(&self) -> &::std::option::Option<super::types::FunctionVersionLatestPublished> {
        &self.publish_to
    }
    /// <p>For network connectivity to Amazon Web Services resources in a VPC, specify a list of security groups and subnets in the VPC. When you connect a function to a VPC, it can access resources and the internet only through that VPC. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/configuration-vpc.html">Configuring a Lambda function to access resources in a VPC</a>.</p>
    pub fn vpc_config(mut self, input: super::types::VpcConfig) -> Self {
        self.vpc_config = ::std::option::Option::Some(input);
        self
    }
    /// <p>For network connectivity to Amazon Web Services resources in a VPC, specify a list of security groups and subnets in the VPC. When you connect a function to a VPC, it can access resources and the internet only through that VPC. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/configuration-vpc.html">Configuring a Lambda function to access resources in a VPC</a>.</p>
    pub fn set_vpc_config(mut self, input: ::std::option::Option<super::types::VpcConfig>) -> Self {
        self.vpc_config = input;
        self
    }
    /// <p>For network connectivity to Amazon Web Services resources in a VPC, specify a list of security groups and subnets in the VPC. When you connect a function to a VPC, it can access resources and the internet only through that VPC. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/configuration-vpc.html">Configuring a Lambda function to access resources in a VPC</a>.</p>
    pub fn get_vpc_config(&self) -> &::std::option::Option<super::types::VpcConfig> {
        &self.vpc_config
    }
    /// <p>The type of deployment package. Set to <code>Image</code> for container image and set to <code>Zip</code> for .zip file archive.</p>
    ...
    /// <p>Environment variables that are accessible from function code during execution.</p>
    pub fn environment(mut self, input: super::types::Environment) -> Self {
        self.environment = ::std::option::Option::Some(input);
        self
    }
    /// <p>Environment variables that are accessible from function code during execution.</p>
    pub fn set_environment(mut self, input: ::std::option::Option<super::types::Environment>) -> Self {
        self.environment = input;
        self
    }
    /// <p>Environment variables that are accessible from function code during execution.</p>
    pub fn get_environment(&self) -> &::std::option::Option<super::types::Environment> {
        &self.environment
    }
    /// <p>The ARN of the Key Management Service (KMS) customer managed key that's used to encrypt the following resources:</p>
    /// <ul>
    ...
    /// <p>Set <code>Mode</code> to <code>Active</code> to sample and trace a subset of incoming requests with <a href="https://docs.aws.amazon.com/lambda/latest/dg/services-xray.html">X-Ray</a>.</p>
    pub fn tracing_config(mut self, input: super::types::TracingConfig) -> Self {
        self.tracing_config = ::std::option::Option::Some(input);
        self
    }
    /// <p>Set <code>Mode</code> to <code>Active</code> to sample and trace a subset of incoming requests with <a href="https://docs.aws.amazon.com/lambda/latest/dg/services-xray.html">X-Ray</a>.</p>
    pub fn set_tracing_config(mut self, input: ::std::option::Option<super::types::TracingConfig>) -> Self {
        self.tracing_config = input;
        self
    }
    /// <p>Set <code>Mode</code> to <code>Active</code> to sample and trace a subset of incoming requests with <a href="https://docs.aws.amazon.com/lambda/latest/dg/services-xray.html">X-Ray</a>.</p>
    pub fn get_tracing_config(&self) -> &::std::option::Option<super::types::TracingConfig> {
        &self.tracing_config
    }
    ...
    /// <p>Container image <a href="https://docs.aws.amazon.com/lambda/latest/dg/images-create.html#images-parms">configuration values</a> that override the values in the container image Dockerfile.</p>
    pub fn image_config(mut self, input: super::types::ImageConfig) -> Self {
        self.image_config = ::std::option::Option::Some(input);
        self
    }
    /// <p>Container image <a href="https://docs.aws.amazon.com/lambda/latest/dg/images-create.html#images-parms">configuration values</a> that override the values in the container image Dockerfile.</p>
    pub fn set_image_config(mut self, input: ::std::option::Option<super::types::ImageConfig>) -> Self {
        self.image_config = input;
        self
    }
    /// <p>Container image <a href="https://docs.aws.amazon.com/lambda/latest/dg/images-create.html#images-parms">configuration values</a> that override the values in the container image Dockerfile.</p>
    pub fn get_image_config(&self) -> &::std::option::Option<super::types::ImageConfig> {
        &self.image_config
    }
    ...
    /// <p>The function's <a href="https://docs.aws.amazon.com/lambda/latest/dg/snapstart.html">SnapStart</a> setting.</p>
    pub fn snap_start(mut self, input: super::types::SnapStart) -> Self {
        self.snap_start = ::std::option::Option::Some(input);
        self
    }
    /// <p>The function's <a href="https://docs.aws.amazon.com/lambda/latest/dg/snapstart.html">SnapStart</a> setting.</p>
    pub fn set_snap_start(mut self, input: ::std::option::Option<super::types::SnapStart>) -> Self {
        self.snap_start = input;
        self
    }
    /// <p>The function's <a href="https://docs.aws.amazon.com/lambda/latest/dg/snapstart.html">SnapStart</a> setting.</p>
    pub fn get_snap_start(&self) -> &::std::option::Option<super::types::SnapStart> {
        &self.snap_start
    }
    /// <p>The function's Amazon CloudWatch Logs configuration settings.</p>
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::create_function::CreateFunctionInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::create_function::CreateFunctionInput {
