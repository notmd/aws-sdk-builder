...
pub mod _tag_resource_input {
    include!(concat!(env!("OUT_DIR"), "/generated/lambda/src/operation/tag_resource/_tag_resource_input.rs"));
}
pub use _tag_resource_input::TagResourceInput;
pub type Input = TagResourceInput;
pub mod _tag_resource_output {
    include!(concat!(env!("OUT_DIR"), "/generated/lambda/src/operation/tag_resource/_tag_resource_output.rs"));
}
...
/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/lambda/src/operation/tag_resource/builders.rs"));
}
