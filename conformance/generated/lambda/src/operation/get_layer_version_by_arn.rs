...
pub mod _get_layer_version_by_arn_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_layer_version_by_arn/_get_layer_version_by_arn_input.rs"
    ));
}
pub use _get_layer_version_by_arn_input::GetLayerVersionByArnInput;
pub type Input = GetLayerVersionByArnInput;
pub mod _get_layer_version_by_arn_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_layer_version_by_arn/_get_layer_version_by_arn_output.rs"
    ));
}
pub use _get_layer_version_by_arn_output::GetLayerVersionByArnOutput;
pub type Output = GetLayerVersionByArnOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_layer_version_by_arn/builders.rs"
    ));
}
pub type GetLayerVersionByArnError = Error;
pub type GetLayerVersionByArnFluentBuilder = builders::Builder;
