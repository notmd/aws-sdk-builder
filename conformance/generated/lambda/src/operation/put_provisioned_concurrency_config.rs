    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::put_provisioned_concurrency_config::PutProvisionedConcurrencyConfigError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::put_provisioned_concurrency_config::PutProvisionedConcurrencyConfigOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutProvisionedConcurrencyConfigResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 202 || force_error {
            super::protocol_serde::shape_put_provisioned_concurrency_config::de_put_provisioned_concurrency_config_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_put_provisioned_concurrency_config::de_put_provisioned_concurrency_config_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutProvisionedConcurrencyConfigRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::put_provisioned_concurrency_config::PutProvisionedConcurrencyConfigInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::put_provisioned_concurrency_config::PutProvisionedConcurrencyConfigInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_put_provisioned_concurrency_config::ser_put_provisioned_concurrency_config_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::put_provisioned_concurrency_config::PutProvisionedConcurrencyConfigError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::put_provisioned_concurrency_config::_put_provisioned_concurrency_config_input::PutProvisionedConcurrencyConfigInput;

pub use super::operation::put_provisioned_concurrency_config::_put_provisioned_concurrency_config_output::PutProvisionedConcurrencyConfigOutput;
