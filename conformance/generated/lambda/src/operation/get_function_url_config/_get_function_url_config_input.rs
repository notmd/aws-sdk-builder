...
impl GetFunctionUrlConfigInput {
    ...
    pub fn builder() -> super::operation::get_function_url_config::builders::GetFunctionUrlConfigInputBuilder {
        super::operation::get_function_url_config::builders::GetFunctionUrlConfigInputBuilder::default()
    }
}
...
impl GetFunctionUrlConfigInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_function_url_config::GetFunctionUrlConfigInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::get_function_url_config::GetFunctionUrlConfigInput {
