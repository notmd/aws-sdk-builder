...
impl GetEventSourceMappingOutput {
    ...
    pub fn builder() -> super::operation::get_event_source_mapping::builders::GetEventSourceMappingOutputBuilder {
        super::operation::get_event_source_mapping::builders::GetEventSourceMappingOutputBuilder::default()
    }
}
...
impl GetEventSourceMappingOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_event_source_mapping::GetEventSourceMappingOutput {
