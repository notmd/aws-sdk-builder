...
impl GetEventSourceMappingInput {
    ...
    pub fn builder() -> super::operation::get_event_source_mapping::builders::GetEventSourceMappingInputBuilder {
        super::operation::get_event_source_mapping::builders::GetEventSourceMappingInputBuilder::default()
    }
}
...
impl GetEventSourceMappingInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_event_source_mapping::GetEventSourceMappingInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::get_event_source_mapping::GetEventSourceMappingInput { uuid: self.uuid })
    }
}
