...
impl GetCapacityProviderInput {
    ...
    pub fn builder() -> super::operation::get_capacity_provider::builders::GetCapacityProviderInputBuilder {
        super::operation::get_capacity_provider::builders::GetCapacityProviderInputBuilder::default()
    }
}
...
impl GetCapacityProviderInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_capacity_provider::GetCapacityProviderInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::get_capacity_provider::GetCapacityProviderInput {
