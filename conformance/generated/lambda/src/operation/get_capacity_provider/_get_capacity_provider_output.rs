...
impl GetCapacityProviderOutput {
    ...
    pub fn builder() -> super::operation::get_capacity_provider::builders::GetCapacityProviderOutputBuilder {
        super::operation::get_capacity_provider::builders::GetCapacityProviderOutputBuilder::default()
    }
}
...
impl GetCapacityProviderOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_capacity_provider::GetCapacityProviderOutput {
