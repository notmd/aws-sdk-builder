...
impl ::std::fmt::Display for Error {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match self {
            ...
            Self::ProvisionedConcurrencyConfigNotFoundException(value) => value.fmt(f),
...
pub mod _get_provisioned_concurrency_config_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_provisioned_concurrency_config/_get_provisioned_concurrency_config_input.rs"
    ));
}
pub use _get_provisioned_concurrency_config_input::GetProvisionedConcurrencyConfigInput;
pub type Input = GetProvisionedConcurrencyConfigInput;
pub mod _get_provisioned_concurrency_config_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_provisioned_concurrency_config/_get_provisioned_concurrency_config_output.rs"
    ));
}
pub use _get_provisioned_concurrency_config_output::GetProvisionedConcurrencyConfigOutput;
pub type Output = GetProvisionedConcurrencyConfigOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_provisioned_concurrency_config/builders.rs"
    ));
}
pub type GetProvisionedConcurrencyConfigError = Error;
pub type GetProvisionedConcurrencyConfigFluentBuilder = builders::Builder;
