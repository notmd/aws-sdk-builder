...
pub struct UpdateFunctionUrlConfigInput {
    ...
    pub auth_type: ::std::option::Option<super::types::FunctionUrlAuthType>,
...
impl UpdateFunctionUrlConfigInput {
    ...
    /// <p>The type of authentication that your function URL uses. Set to <code>AWS_IAM</code> if you want to restrict access to authenticated users only. Set to <code>NONE</code> if you want to bypass IAM authentication to create a public endpoint. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/urls-auth.html">Control access to Lambda function URLs</a>.</p>
    pub fn auth_type(&self) -> ::std::option::Option<&super::types::FunctionUrlAuthType> {
...
impl UpdateFunctionUrlConfigInput {
    ...
    pub fn builder() -> super::operation::update_function_url_config::builders::UpdateFunctionUrlConfigInputBuilder {
        super::operation::update_function_url_config::builders::UpdateFunctionUrlConfigInputBuilder::default()
    }
}
...
impl UpdateFunctionUrlConfigInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::update_function_url_config::UpdateFunctionUrlConfigInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::update_function_url_config::UpdateFunctionUrlConfigInput {
