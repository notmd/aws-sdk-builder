...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CheckpointDurableExecutionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_checkpoint_durable_execution::de_checkpoint_durable_execution_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_checkpoint_durable_execution::de_checkpoint_durable_execution_http_response(status, headers, body)
        };
