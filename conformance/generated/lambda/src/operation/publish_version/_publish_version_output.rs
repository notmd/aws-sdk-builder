...
impl PublishVersionOutput {
    ...
    pub fn builder() -> super::operation::publish_version::builders::PublishVersionOutputBuilder {
        super::operation::publish_version::builders::PublishVersionOutputBuilder::default()
    }
}
...
impl PublishVersionOutputBuilder {
    ...
    pub fn build(self) -> super::operation::publish_version::PublishVersionOutput {
