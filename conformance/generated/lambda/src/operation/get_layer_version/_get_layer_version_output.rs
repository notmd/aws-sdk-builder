...
impl GetLayerVersionOutput {
    ...
    pub fn builder() -> super::operation::get_layer_version::builders::GetLayerVersionOutputBuilder {
        super::operation::get_layer_version::builders::GetLayerVersionOutputBuilder::default()
    }
}
...
impl GetLayerVersionOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_layer_version::GetLayerVersionOutput {
