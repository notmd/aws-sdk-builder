...
impl ListLayersInput {
    ...
    pub fn builder() -> super::operation::list_layers::builders::ListLayersInputBuilder {
        super::operation::list_layers::builders::ListLayersInputBuilder::default()
    }
}
...
impl ListLayersInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::list_layers::ListLayersInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_layers::ListLayersInput {
