...
pub mod _get_resource_policy_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_resource_policy/_get_resource_policy_input.rs"
    ));
}
...
pub mod _get_resource_policy_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_resource_policy/_get_resource_policy_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_resource_policy/builders.rs"
    ));
}
