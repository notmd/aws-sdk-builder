...
impl DeleteFunction {
    ...
    pub(crate) async fn orchestrate(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::delete_function::DeleteFunctionError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_function::DeleteFunctionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_function::DeleteFunctionOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteFunctionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_function::de_delete_function_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_function::de_delete_function_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteFunctionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_function::DeleteFunctionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_function::DeleteFunctionInput,
...
impl ::aws_types::request_id::RequestId for super::operation::delete_function::DeleteFunctionError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_function::_delete_function_input::DeleteFunctionInput;

pub use super::operation::delete_function::_delete_function_output::DeleteFunctionOutput;
