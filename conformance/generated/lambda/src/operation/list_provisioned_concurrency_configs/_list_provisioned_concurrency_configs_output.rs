...
pub struct ListProvisionedConcurrencyConfigsOutput {
    ...
    pub provisioned_concurrency_configs: ::std::option::Option<::std::vec::Vec<super::types::ProvisionedConcurrencyConfigListItem>>,
...
impl ListProvisionedConcurrencyConfigsOutput {
    ...
    pub fn provisioned_concurrency_configs(&self) -> &[super::types::ProvisionedConcurrencyConfigListItem] {
...
impl ListProvisionedConcurrencyConfigsOutput {
    ...
    pub fn builder() -> super::operation::list_provisioned_concurrency_configs::builders::ListProvisionedConcurrencyConfigsOutputBuilder {
        super::operation::list_provisioned_concurrency_configs::builders::ListProvisionedConcurrencyConfigsOutputBuilder::default()
    }
}
...
pub struct ListProvisionedConcurrencyConfigsOutputBuilder {
    pub(crate) provisioned_concurrency_configs: ::std::option::Option<::std::vec::Vec<super::types::ProvisionedConcurrencyConfigListItem>>,
...
impl ListProvisionedConcurrencyConfigsOutputBuilder {
    ...
    ///
    /// <p>A list of provisioned concurrency configurations.</p>
    pub fn provisioned_concurrency_configs(mut self, input: super::types::ProvisionedConcurrencyConfigListItem) -> Self {
    ...
    pub fn set_provisioned_concurrency_configs(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::ProvisionedConcurrencyConfigListItem>>,
    ) -> Self {
        self.provisioned_concurrency_configs = input;
        self
    }
    /// <p>A list of provisioned concurrency configurations.</p>
    pub fn get_provisioned_concurrency_configs(&self) -> &::std::option::Option<::std::vec::Vec<super::types::ProvisionedConcurrencyConfigListItem>> {
    ...
    pub fn build(self) -> super::operation::list_provisioned_concurrency_configs::ListProvisionedConcurrencyConfigsOutput {
