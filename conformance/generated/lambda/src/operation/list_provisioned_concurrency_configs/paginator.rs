...
pub struct ListProvisionedConcurrencyConfigsPaginator {
    ...
    builder: super::operation::list_provisioned_concurrency_configs::builders::ListProvisionedConcurrencyConfigsInputBuilder,
...
impl ListProvisionedConcurrencyConfigsPaginator {
    ...
    pub fn items(self) -> super::operation::list_provisioned_concurrency_configs::paginator::ListProvisionedConcurrencyConfigsPaginatorItems {
        super::operation::list_provisioned_concurrency_configs::paginator::ListProvisionedConcurrencyConfigsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::operation::list_provisioned_concurrency_configs::ListProvisionedConcurrencyConfigs::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_list_provisioned_concurrency_configs_output_output_next_marker(resp);
...
impl ListProvisionedConcurrencyConfigsPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::types::ProvisionedConcurrencyConfigListItem,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::operation::list_provisioned_concurrency_configs::ListProvisionedConcurrencyConfigsError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::lens::lens_list_provisioned_concurrency_configs_output_output_provisioned_concurrency_configs(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
