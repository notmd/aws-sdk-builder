...
impl ListFunctionEventInvokeConfigsOutputBuilder {
    ...
    pub fn set_function_event_invoke_configs(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::FunctionEventInvokeConfig>>) -> Self { self.function_event_invoke_configs = input; self }
    /// <p>A list of configurations.</p>
    pub fn get_function_event_invoke_configs(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::FunctionEventInvokeConfig>> { &self.function_event_invoke_configs }
    /// <p>The pagination token that's included if more results are available.</p>
