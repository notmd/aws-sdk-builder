...
pub struct ListFunctionEventInvokeConfigsOutput {
    ...
    pub function_event_invoke_configs: ::std::option::Option<::std::vec::Vec<super::types::FunctionEventInvokeConfig>>,
...
impl ListFunctionEventInvokeConfigsOutput {
    ...
    pub fn function_event_invoke_configs(&self) -> &[super::types::FunctionEventInvokeConfig] {
...
impl ListFunctionEventInvokeConfigsOutput {
    ...
    pub fn builder() -> super::operation::list_function_event_invoke_configs::builders::ListFunctionEventInvokeConfigsOutputBuilder {
        super::operation::list_function_event_invoke_configs::builders::ListFunctionEventInvokeConfigsOutputBuilder::default()
    }
}
...
pub struct ListFunctionEventInvokeConfigsOutputBuilder {
    pub(crate) function_event_invoke_configs: ::std::option::Option<::std::vec::Vec<super::types::FunctionEventInvokeConfig>>,
...
impl ListFunctionEventInvokeConfigsOutputBuilder {
    ...
    ///
    /// <p>A list of configurations.</p>
    pub fn function_event_invoke_configs(mut self, input: super::types::FunctionEventInvokeConfig) -> Self {
    ...
    pub fn set_function_event_invoke_configs(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::FunctionEventInvokeConfig>>,
    ) -> Self {
        self.function_event_invoke_configs = input;
        self
    }
    /// <p>A list of configurations.</p>
    pub fn get_function_event_invoke_configs(&self) -> &::std::option::Option<::std::vec::Vec<super::types::FunctionEventInvokeConfig>> {
    ...
    pub fn build(self) -> super::operation::list_function_event_invoke_configs::ListFunctionEventInvokeConfigsOutput {
