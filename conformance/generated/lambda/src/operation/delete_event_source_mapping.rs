...
impl DeleteEventSourceMapping {
    ...
    pub(crate) async fn orchestrate(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::delete_event_source_mapping::DeleteEventSourceMappingError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_event_source_mapping::DeleteEventSourceMappingError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_event_source_mapping::DeleteEventSourceMappingOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteEventSourceMappingResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 202 || force_error {
            super::protocol_serde::shape_delete_event_source_mapping::de_delete_event_source_mapping_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_event_source_mapping::de_delete_event_source_mapping_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteEventSourceMappingRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_event_source_mapping::DeleteEventSourceMappingInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_event_source_mapping::DeleteEventSourceMappingInput,
...
impl ::aws_types::request_id::RequestId for super::operation::delete_event_source_mapping::DeleteEventSourceMappingError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_event_source_mapping::_delete_event_source_mapping_input::DeleteEventSourceMappingInput;

pub use super::operation::delete_event_source_mapping::_delete_event_source_mapping_output::DeleteEventSourceMappingOutput;
