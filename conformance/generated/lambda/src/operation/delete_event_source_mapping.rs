...
pub mod _delete_event_source_mapping_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/delete_event_source_mapping/_delete_event_source_mapping_input.rs"
    ));
}
pub use _delete_event_source_mapping_input::DeleteEventSourceMappingInput;
pub type Input = DeleteEventSourceMappingInput;
pub mod _delete_event_source_mapping_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/delete_event_source_mapping/_delete_event_source_mapping_output.rs"
    ));
}
pub use _delete_event_source_mapping_output::DeleteEventSourceMappingOutput;
pub type Output = DeleteEventSourceMappingOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/delete_event_source_mapping/builders.rs"
    ));
}
pub type DeleteEventSourceMappingError = Error;
pub type DeleteEventSourceMappingFluentBuilder = builders::Builder;
