...
pub mod _delete_alias_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/delete_alias/_delete_alias_input.rs"
    ));
}
...
pub mod _delete_alias_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/delete_alias/_delete_alias_output.rs"
    ));
}
...
/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/lambda/src/operation/delete_alias/builders.rs"));
}
