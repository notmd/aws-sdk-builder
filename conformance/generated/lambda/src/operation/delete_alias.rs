...
impl DeleteAlias {
    ...
    pub(crate) async fn orchestrate(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::delete_alias::DeleteAliasError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_alias::DeleteAliasError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_alias::DeleteAliasOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteAliasResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 204 || force_error {
            super::protocol_serde::shape_delete_alias::de_delete_alias_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_alias::de_delete_alias_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteAliasRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_alias::DeleteAliasInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_alias::DeleteAliasInput,
...
impl ::aws_types::request_id::RequestId for super::operation::delete_alias::DeleteAliasError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_alias::_delete_alias_input::DeleteAliasInput;

pub use super::operation::delete_alias::_delete_alias_output::DeleteAliasOutput;
