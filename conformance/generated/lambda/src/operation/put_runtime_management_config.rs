...
pub mod _put_runtime_management_config_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/put_runtime_management_config/_put_runtime_management_config_input.rs"
    ));
}
pub use _put_runtime_management_config_input::PutRuntimeManagementConfigInput;
pub type Input = PutRuntimeManagementConfigInput;
pub mod _put_runtime_management_config_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/put_runtime_management_config/_put_runtime_management_config_output.rs"
    ));
}
pub use _put_runtime_management_config_output::PutRuntimeManagementConfigOutput;
pub type Output = PutRuntimeManagementConfigOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/put_runtime_management_config/builders.rs"
    ));
}
pub type PutRuntimeManagementConfigError = Error;
pub type PutRuntimeManagementConfigFluentBuilder = builders::Builder;
