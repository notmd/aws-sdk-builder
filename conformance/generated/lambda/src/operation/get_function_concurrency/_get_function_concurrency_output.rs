...
impl GetFunctionConcurrencyOutput {
    ...
    pub fn builder() -> super::operation::get_function_concurrency::builders::GetFunctionConcurrencyOutputBuilder {
        super::operation::get_function_concurrency::builders::GetFunctionConcurrencyOutputBuilder::default()
    }
}
...
impl GetFunctionConcurrencyOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_function_concurrency::GetFunctionConcurrencyOutput {
