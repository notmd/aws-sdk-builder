...
pub mod _list_function_event_invoke_configs_input {
    include!(concat!(env!("OUT_DIR"), "/generated/lambda/src/operation/list_function_event_invoke_configs/_list_function_event_invoke_configs_input.rs"));
}
pub use _list_function_event_invoke_configs_input::ListFunctionEventInvokeConfigsInput;
pub type Input = ListFunctionEventInvokeConfigsInput;
pub mod _list_function_event_invoke_configs_output {
    include!(concat!(env!("OUT_DIR"), "/generated/lambda/src/operation/list_function_event_invoke_configs/_list_function_event_invoke_configs_output.rs"));
}
pub use _list_function_event_invoke_configs_output::ListFunctionEventInvokeConfigsOutput;
pub type Output = ListFunctionEventInvokeConfigsOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/lambda/src/operation/list_function_event_invoke_configs/builders.rs"));
}
