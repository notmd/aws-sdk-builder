...
pub mod _list_versions_by_function_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/list_versions_by_function/_list_versions_by_function_input.rs"
    ));
}
pub use _list_versions_by_function_input::ListVersionsByFunctionInput;
pub type Input = ListVersionsByFunctionInput;
pub mod _list_versions_by_function_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/list_versions_by_function/_list_versions_by_function_output.rs"
    ));
}
pub use _list_versions_by_function_output::ListVersionsByFunctionOutput;
pub type Output = ListVersionsByFunctionOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/list_versions_by_function/builders.rs"
    ));
}

/// Paginator for this operation
pub mod paginator;
pub type ListVersionsByFunctionError = Error;
pub type ListVersionsByFunctionFluentBuilder = builders::Builder;
