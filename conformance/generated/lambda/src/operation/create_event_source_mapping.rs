    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::create_event_source_mapping::CreateEventSourceMappingError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::create_event_source_mapping::CreateEventSourceMappingOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateEventSourceMappingResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 202 || force_error {
            super::protocol_serde::shape_create_event_source_mapping::de_create_event_source_mapping_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_create_event_source_mapping::de_create_event_source_mapping_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateEventSourceMappingRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::create_event_source_mapping::CreateEventSourceMappingInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::create_event_source_mapping::CreateEventSourceMappingInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_create_event_source_mapping::ser_create_event_source_mapping_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::create_event_source_mapping::CreateEventSourceMappingError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::create_event_source_mapping::_create_event_source_mapping_input::CreateEventSourceMappingInput;

pub use super::operation::create_event_source_mapping::_create_event_source_mapping_output::CreateEventSourceMappingOutput;
