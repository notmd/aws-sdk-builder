...
pub mod _create_event_source_mapping_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/create_event_source_mapping/_create_event_source_mapping_input.rs"
    ));
}
pub use _create_event_source_mapping_input::CreateEventSourceMappingInput;
pub type Input = CreateEventSourceMappingInput;
pub mod _create_event_source_mapping_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/create_event_source_mapping/_create_event_source_mapping_output.rs"
    ));
}
pub use _create_event_source_mapping_output::CreateEventSourceMappingOutput;
pub type Output = CreateEventSourceMappingOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/create_event_source_mapping/builders.rs"
    ));
}
pub type CreateEventSourceMappingError = Error;
pub type CreateEventSourceMappingFluentBuilder = builders::Builder;
