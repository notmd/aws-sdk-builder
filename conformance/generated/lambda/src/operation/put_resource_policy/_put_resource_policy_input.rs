...
impl PutResourcePolicyInput {
    ...
    pub fn builder() -> super::operation::put_resource_policy::builders::PutResourcePolicyInputBuilder {
        super::operation::put_resource_policy::builders::PutResourcePolicyInputBuilder::default()
    }
}
...
impl PutResourcePolicyInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::put_resource_policy::PutResourcePolicyInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::put_resource_policy::PutResourcePolicyInput {
