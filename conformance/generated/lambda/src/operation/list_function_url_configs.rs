    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_function_url_configs::ListFunctionUrlConfigsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_function_url_configs::ListFunctionUrlConfigsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListFunctionUrlConfigsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_function_url_configs::de_list_function_url_configs_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_function_url_configs::de_list_function_url_configs_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListFunctionUrlConfigsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_function_url_configs::ListFunctionUrlConfigsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_function_url_configs::ListFunctionUrlConfigsInput,
...
impl ::aws_types::request_id::RequestId for super::operation::list_function_url_configs::ListFunctionUrlConfigsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_function_url_configs::_list_function_url_configs_input::ListFunctionUrlConfigsInput;

pub use super::operation::list_function_url_configs::_list_function_url_configs_output::ListFunctionUrlConfigsOutput;
