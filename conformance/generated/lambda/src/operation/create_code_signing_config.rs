...
pub mod _create_code_signing_config_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/create_code_signing_config/_create_code_signing_config_input.rs"
    ));
}
pub use _create_code_signing_config_input::CreateCodeSigningConfigInput;
pub type Input = CreateCodeSigningConfigInput;
pub mod _create_code_signing_config_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/create_code_signing_config/_create_code_signing_config_output.rs"
    ));
}
pub use _create_code_signing_config_output::CreateCodeSigningConfigOutput;
pub type Output = CreateCodeSigningConfigOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/create_code_signing_config/builders.rs"
    ));
}
pub type CreateCodeSigningConfigError = Error;
pub type CreateCodeSigningConfigFluentBuilder = builders::Builder;
