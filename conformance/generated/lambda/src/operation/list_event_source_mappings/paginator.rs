...
pub struct ListEventSourceMappingsPaginator {
    ...
    builder: super::operation::list_event_source_mappings::builders::ListEventSourceMappingsInputBuilder,
...
impl ListEventSourceMappingsPaginator {
    ...
    pub fn items(self) -> super::operation::list_event_source_mappings::paginator::ListEventSourceMappingsPaginatorItems {
        super::operation::list_event_source_mappings::paginator::ListEventSourceMappingsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            super::operation::list_event_source_mappings::ListEventSourceMappings::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_list_event_source_mappings_output_output_next_marker(resp);
...
impl ListEventSourceMappingsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::lens::lens_list_event_source_mappings_output_output_event_source_mappings(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
