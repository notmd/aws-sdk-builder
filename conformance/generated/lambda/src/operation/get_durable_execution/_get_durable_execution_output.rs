...
pub struct GetDurableExecutionOutput {
    ...
    pub status: super::types::ExecutionStatus,
    ...
    pub trace_header: ::std::option::Option<super::types::TraceHeader>,
...
impl GetDurableExecutionOutput {
    ...
    /// <p>The current status of the durable execution. Valid values are <code>RUNNING</code>, <code>SUCCEEDED</code>, <code>FAILED</code>, <code>TIMED_OUT</code>, and <code>STOPPED</code>.</p>
    pub fn status(&self) -> &super::types::ExecutionStatus {
        &self.status
    }
    /// <p>The date and time when the durable execution ended, in Unix timestamp format. This field is only present if the execution has completed (status is <code>SUCCEEDED</code>, <code>FAILED</code>, <code>TIMED_OUT</code>, or <code>STOPPED</code>).</p>
    ...
    /// <p>The trace headers associated with the durable execution.</p>
    pub fn trace_header(&self) -> ::std::option::Option<&super::types::TraceHeader> {
...
impl GetDurableExecutionOutput {
    ...
    pub fn builder() -> super::operation::get_durable_execution::builders::GetDurableExecutionOutputBuilder {
        super::operation::get_durable_execution::builders::GetDurableExecutionOutputBuilder::default()
    }
}
...
pub struct GetDurableExecutionOutputBuilder {
    ...
    pub(crate) status: ::std::option::Option<super::types::ExecutionStatus>,
    pub(crate) end_timestamp: ::std::option::Option<::aws_smithy_types::DateTime>,
    pub(crate) version: ::std::option::Option<::std::string::String>,
    pub(crate) trace_header: ::std::option::Option<super::types::TraceHeader>,
...
impl GetDurableExecutionOutputBuilder {
    ...
    /// <p>The current status of the durable execution. Valid values are <code>RUNNING</code>, <code>SUCCEEDED</code>, <code>FAILED</code>, <code>TIMED_OUT</code>, and <code>STOPPED</code>.</p>
    /// This field is required.
    pub fn status(mut self, input: super::types::ExecutionStatus) -> Self {
        self.status = ::std::option::Option::Some(input);
        self
    }
    /// <p>The current status of the durable execution. Valid values are <code>RUNNING</code>, <code>SUCCEEDED</code>, <code>FAILED</code>, <code>TIMED_OUT</code>, and <code>STOPPED</code>.</p>
    pub fn set_status(mut self, input: ::std::option::Option<super::types::ExecutionStatus>) -> Self {
        self.status = input;
        self
    }
    /// <p>The current status of the durable execution. Valid values are <code>RUNNING</code>, <code>SUCCEEDED</code>, <code>FAILED</code>, <code>TIMED_OUT</code>, and <code>STOPPED</code>.</p>
    pub fn get_status(&self) -> &::std::option::Option<super::types::ExecutionStatus> {
        &self.status
    }
    /// <p>The date and time when the durable execution ended, in Unix timestamp format. This field is only present if the execution has completed (status is <code>SUCCEEDED</code>, <code>FAILED</code>, <code>TIMED_OUT</code>, or <code>STOPPED</code>).</p>
    ...
    /// <p>The trace headers associated with the durable execution.</p>
    pub fn trace_header(mut self, input: super::types::TraceHeader) -> Self {
        self.trace_header = ::std::option::Option::Some(input);
        self
    }
    /// <p>The trace headers associated with the durable execution.</p>
    pub fn set_trace_header(mut self, input: ::std::option::Option<super::types::TraceHeader>) -> Self {
        self.trace_header = input;
        self
    }
    /// <p>The trace headers associated with the durable execution.</p>
    pub fn get_trace_header(&self) -> &::std::option::Option<super::types::TraceHeader> {
        &self.trace_header
    }
    /// <p>Indicates whether execution data is included in this response. Returns <code>false</code> when <code>IncludeExecutionData</code> is set to <code>false</code> in the request.</p>
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_durable_execution::GetDurableExecutionOutput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::get_durable_execution::GetDurableExecutionOutput {
