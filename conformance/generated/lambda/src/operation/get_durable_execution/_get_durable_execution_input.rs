...
impl GetDurableExecutionInput {
    ...
    pub fn builder() -> super::operation::get_durable_execution::builders::GetDurableExecutionInputBuilder {
        super::operation::get_durable_execution::builders::GetDurableExecutionInputBuilder::default()
    }
}
...
impl GetDurableExecutionInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_durable_execution::GetDurableExecutionInput, ::aws_smithy_types::error::operation::BuildError>
    {
