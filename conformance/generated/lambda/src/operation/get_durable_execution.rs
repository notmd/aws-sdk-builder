    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_durable_execution::GetDurableExecutionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_durable_execution::GetDurableExecutionOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetDurableExecutionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_durable_execution::de_get_durable_execution_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_durable_execution::de_get_durable_execution_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetDurableExecutionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_durable_execution::GetDurableExecutionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_durable_execution::GetDurableExecutionInput,
...
impl ::aws_types::request_id::RequestId for super::operation::get_durable_execution::GetDurableExecutionError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_durable_execution::_get_durable_execution_input::GetDurableExecutionInput;

pub use super::operation::get_durable_execution::_get_durable_execution_output::GetDurableExecutionOutput;
