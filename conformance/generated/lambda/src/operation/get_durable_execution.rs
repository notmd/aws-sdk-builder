...
pub mod _get_durable_execution_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_durable_execution/_get_durable_execution_input.rs"
    ));
}
pub use _get_durable_execution_input::GetDurableExecutionInput;
pub type Input = GetDurableExecutionInput;
pub mod _get_durable_execution_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_durable_execution/_get_durable_execution_output.rs"
    ));
}
pub use _get_durable_execution_output::GetDurableExecutionOutput;
pub type Output = GetDurableExecutionOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_durable_execution/builders.rs"
    ));
}
pub type GetDurableExecutionError = Error;
pub type GetDurableExecutionFluentBuilder = builders::Builder;
