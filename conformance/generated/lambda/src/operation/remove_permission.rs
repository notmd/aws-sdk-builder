...
pub mod _remove_permission_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/remove_permission/_remove_permission_input.rs"
    ));
}
...
pub mod _remove_permission_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/remove_permission/_remove_permission_output.rs"
    ));
}
...
/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/lambda/src/operation/remove_permission/builders.rs"));
}
