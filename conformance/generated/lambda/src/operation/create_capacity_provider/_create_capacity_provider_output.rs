...
impl CreateCapacityProviderOutput {
    ...
    pub fn builder() -> super::operation::create_capacity_provider::builders::CreateCapacityProviderOutputBuilder {
        super::operation::create_capacity_provider::builders::CreateCapacityProviderOutputBuilder::default()
    }
}
...
impl CreateCapacityProviderOutputBuilder {
    ...
    pub fn build(self) -> super::operation::create_capacity_provider::CreateCapacityProviderOutput {
