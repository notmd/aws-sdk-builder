...
pub mod _get_function_scaling_config_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_function_scaling_config/_get_function_scaling_config_input.rs"
    ));
}
pub use _get_function_scaling_config_input::GetFunctionScalingConfigInput;
pub type Input = GetFunctionScalingConfigInput;
pub mod _get_function_scaling_config_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_function_scaling_config/_get_function_scaling_config_output.rs"
    ));
}
pub use _get_function_scaling_config_output::GetFunctionScalingConfigOutput;
pub type Output = GetFunctionScalingConfigOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_function_scaling_config/builders.rs"
    ));
}
pub type GetFunctionScalingConfigError = Error;
pub type GetFunctionScalingConfigFluentBuilder = builders::Builder;
