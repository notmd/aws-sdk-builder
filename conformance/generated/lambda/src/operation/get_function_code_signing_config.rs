...
pub mod _get_function_code_signing_config_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_function_code_signing_config/_get_function_code_signing_config_input.rs"
    ));
}
pub use _get_function_code_signing_config_input::GetFunctionCodeSigningConfigInput;
pub type Input = GetFunctionCodeSigningConfigInput;
pub mod _get_function_code_signing_config_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_function_code_signing_config/_get_function_code_signing_config_output.rs"
    ));
}
pub use _get_function_code_signing_config_output::GetFunctionCodeSigningConfigOutput;
pub type Output = GetFunctionCodeSigningConfigOutput;

/// Builders
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/lambda/src/operation/get_function_code_signing_config/builders.rs"
    ));
}
pub type GetFunctionCodeSigningConfigError = Error;
pub type GetFunctionCodeSigningConfigFluentBuilder = builders::Builder;
