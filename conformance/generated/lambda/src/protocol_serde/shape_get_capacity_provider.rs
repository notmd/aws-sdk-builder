...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::get_capacity_provider::GetCapacityProviderError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InvalidParameterValueException" => super::operation::get_capacity_provider::GetCapacityProviderError::InvalidParameterValueException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => super::operation::get_capacity_provider::GetCapacityProviderError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceException" => super::operation::get_capacity_provider::GetCapacityProviderError::ServiceException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::operation::get_capacity_provider::GetCapacityProviderError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::get_capacity_provider::GetCapacityProviderError::generic(generic),
    })
}
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::get_capacity_provider::builders::GetCapacityProviderOutputBuilder::default();
        output = super::protocol_serde::shape_get_capacity_provider::de_get_capacity_provider(_response_body, output)
            .map_err(super::operation::get_capacity_provider::GetCapacityProviderError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::serde_util::get_capacity_provider_output_output_correct_errors(output).build()
    })
}
