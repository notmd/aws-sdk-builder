...
pub(crate) fn de_function_configuration<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::types::FunctionConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::types::builders::FunctionConfigurationBuilder::default();
            loop {
                match tokens.next().transpose()? {
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "TracingConfig" => {
                                builder = builder.set_tracing_config(
                                    super::protocol_serde::shape_tracing_config_response::de_tracing_config_response(tokens, _value, depth + 1)?,
                                );
                            }
                            "MasterArn" => {
                            ...
                            "FileSystemConfigs" => {
                                builder = builder.set_file_system_configs(
                                    super::protocol_serde::shape_file_system_config_list::de_file_system_config_list(tokens, _value, depth + 1)?,
                                );
                            }
                            ...
                            "ImageConfigResponse" => {
                                builder = builder.set_image_config_response(
                                    super::protocol_serde::shape_image_config_response::de_image_config_response(tokens, _value, depth + 1)?,
                                );
                            }
                            "Architectures" => {
                            ...
                            "RuntimeVersionConfig" => {
                                builder = builder.set_runtime_version_config(
                                    super::protocol_serde::shape_runtime_version_config::de_runtime_version_config(tokens, _value, depth + 1)?,
                                );
                            }
                            "LoggingConfig" => {
                                builder = builder.set_logging_config(super::protocol_serde::shape_logging_config::de_logging_config(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "TenancyConfig" => {
                                builder = builder.set_tenancy_config(super::protocol_serde::shape_tenancy_config::de_tenancy_config(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "DurableConfig" => {
                                builder = builder.set_durable_config(super::protocol_serde::shape_durable_config::de_durable_config(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
