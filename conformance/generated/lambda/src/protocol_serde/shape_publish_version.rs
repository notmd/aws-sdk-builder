...
pub fn de_publish_version_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::publish_version::PublishVersionOutput, super::operation::publish_version::PublishVersionError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::publish_version::PublishVersionError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "CodeStorageExceededException" => super::operation::publish_version::PublishVersionError::CodeStorageExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "FunctionVersionsPerCapacityProviderLimitExceededException" => {
            super::operation::publish_version::PublishVersionError::FunctionVersionsPerCapacityProviderLimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = super::types::error::builders::FunctionVersionsPerCapacityProviderLimitExceededExceptionBuilder::default();
                    output = super::protocol_serde::shape_function_versions_per_capacity_provider_limit_exceeded_exception::de_function_versions_per_capacity_provider_limit_exceeded_exception_json_err(_response_body, output).map_err(super::operation::publish_version::PublishVersionError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        "InvalidParameterValueException" => super::operation::publish_version::PublishVersionError::InvalidParameterValueException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "PreconditionFailedException" => super::operation::publish_version::PublishVersionError::PreconditionFailedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceConflictException" => super::operation::publish_version::PublishVersionError::ResourceConflictException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => super::operation::publish_version::PublishVersionError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceException" => super::operation::publish_version::PublishVersionError::ServiceException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::operation::publish_version::PublishVersionError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::publish_version::PublishVersionError::generic(generic),
    })
}
...
pub fn de_publish_version_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::publish_version::builders::PublishVersionOutputBuilder::default();
        output = super::protocol_serde::shape_publish_version::de_publish_version(_response_body, output)
            .map_err(super::operation::publish_version::PublishVersionError::unhandled)?;
...
pub fn ser_publish_version_input(
    ...
    super::protocol_serde::shape_publish_version_input::ser_publish_version_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_publish_version(
    _value: &[u8],
    mut builder: super::operation::publish_version::builders::PublishVersionOutputBuilder,
) -> ::std::result::Result<
    super::operation::publish_version::builders::PublishVersionOutputBuilder,
