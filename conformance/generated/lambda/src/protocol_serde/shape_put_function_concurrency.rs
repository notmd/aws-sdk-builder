...
pub fn de_put_function_concurrency_http_error(
    ...
    super::operation::put_function_concurrency::PutFunctionConcurrencyError,
> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(super::operation::put_function_concurrency::PutFunctionConcurrencyError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "InvalidParameterValueException" => {
            super::operation::put_function_concurrency::PutFunctionConcurrencyError::InvalidParameterValueException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceConflictException" => super::operation::put_function_concurrency::PutFunctionConcurrencyError::ResourceConflictException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => super::operation::put_function_concurrency::PutFunctionConcurrencyError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceException" => super::operation::put_function_concurrency::PutFunctionConcurrencyError::ServiceException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::operation::put_function_concurrency::PutFunctionConcurrencyError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::put_function_concurrency::PutFunctionConcurrencyError::generic(generic),
    })
}
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::put_function_concurrency::builders::PutFunctionConcurrencyOutputBuilder::default();
        output = super::protocol_serde::shape_put_function_concurrency::de_put_function_concurrency(_response_body, output)
            .map_err(super::operation::put_function_concurrency::PutFunctionConcurrencyError::unhandled)?;
...
pub fn ser_put_function_concurrency_input(
    ...
    super::protocol_serde::shape_put_function_concurrency_input::ser_put_function_concurrency_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_put_function_concurrency(
    _value: &[u8],
    mut builder: super::operation::put_function_concurrency::builders::PutFunctionConcurrencyOutputBuilder,
) -> ::std::result::Result<
    super::operation::put_function_concurrency::builders::PutFunctionConcurrencyOutputBuilder,
