...
pub fn de_put_runtime_management_config_http_error(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
    super::operation::put_runtime_management_config::PutRuntimeManagementConfigOutput,
    super::operation::put_runtime_management_config::PutRuntimeManagementConfigError,
> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::put_runtime_management_config::PutRuntimeManagementConfigError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InvalidParameterValueException" => {
            super::operation::put_runtime_management_config::PutRuntimeManagementConfigError::InvalidParameterValueException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceConflictException" => super::operation::put_runtime_management_config::PutRuntimeManagementConfigError::ResourceConflictException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => super::operation::put_runtime_management_config::PutRuntimeManagementConfigError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceException" => super::operation::put_runtime_management_config::PutRuntimeManagementConfigError::ServiceException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::operation::put_runtime_management_config::PutRuntimeManagementConfigError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::put_runtime_management_config::PutRuntimeManagementConfigError::generic(generic),
    })
}
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::put_runtime_management_config::builders::PutRuntimeManagementConfigOutputBuilder::default();
        output = super::protocol_serde::shape_put_runtime_management_config::de_put_runtime_management_config(_response_body, output)
            .map_err(super::operation::put_runtime_management_config::PutRuntimeManagementConfigError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::serde_util::put_runtime_management_config_output_output_correct_errors(output)
            .build()
            .map_err(super::operation::put_runtime_management_config::PutRuntimeManagementConfigError::unhandled)?
    })
}

pub fn ser_put_runtime_management_config_input(
    input: &super::operation::put_runtime_management_config::PutRuntimeManagementConfigInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    super::protocol_serde::shape_put_runtime_management_config_input::ser_put_runtime_management_config_input_input(&mut object, input)?;
    object.finish();
    Ok(::aws_smithy_types::body::SdkBody::from(out))
}

pub(crate) fn de_put_runtime_management_config(
    _value: &[u8],
