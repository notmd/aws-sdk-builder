...
pub fn de_update_alias_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::update_alias::UpdateAliasOutput, super::operation::update_alias::UpdateAliasError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::update_alias::UpdateAliasError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InvalidParameterValueException" => super::operation::update_alias::UpdateAliasError::InvalidParameterValueException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "PreconditionFailedException" => super::operation::update_alias::UpdateAliasError::PreconditionFailedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceConflictException" => super::operation::update_alias::UpdateAliasError::ResourceConflictException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => super::operation::update_alias::UpdateAliasError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceException" => super::operation::update_alias::UpdateAliasError::ServiceException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::operation::update_alias::UpdateAliasError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::update_alias::UpdateAliasError::generic(generic),
    })
}
...
pub fn de_update_alias_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::update_alias::builders::UpdateAliasOutputBuilder::default();
        output = super::protocol_serde::shape_update_alias::de_update_alias(_response_body, output)
            .map_err(super::operation::update_alias::UpdateAliasError::unhandled)?;
...
pub fn ser_update_alias_input(
    ...
    super::protocol_serde::shape_update_alias_input::ser_update_alias_input_input(&mut object, input)?;
    object.finish();
