...
pub(crate) fn de_provisioned_concurrency_config_not_found_exception_json_err(
    _value: &[u8],
    mut builder: super::types::error::builders::ProvisionedConcurrencyConfigNotFoundExceptionBuilder,
) -> ::std::result::Result<
    super::types::error::builders::ProvisionedConcurrencyConfigNotFoundExceptionBuilder,
