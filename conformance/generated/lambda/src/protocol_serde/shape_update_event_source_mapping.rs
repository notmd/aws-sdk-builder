...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(super::operation::update_event_source_mapping::UpdateEventSourceMappingError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "InvalidParameterValueException" => {
            super::operation::update_event_source_mapping::UpdateEventSourceMappingError::InvalidParameterValueException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceConflictException" => super::operation::update_event_source_mapping::UpdateEventSourceMappingError::ResourceConflictException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceInUseException" => super::operation::update_event_source_mapping::UpdateEventSourceMappingError::ResourceInUseException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => super::operation::update_event_source_mapping::UpdateEventSourceMappingError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceException" => super::operation::update_event_source_mapping::UpdateEventSourceMappingError::ServiceException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::operation::update_event_source_mapping::UpdateEventSourceMappingError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::update_event_source_mapping::UpdateEventSourceMappingError::generic(generic),
    })
}
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::update_event_source_mapping::builders::UpdateEventSourceMappingOutputBuilder::default();
        output = super::protocol_serde::shape_update_event_source_mapping::de_update_event_source_mapping(_response_body, output)
            .map_err(super::operation::update_event_source_mapping::UpdateEventSourceMappingError::unhandled)?;
...
pub fn ser_update_event_source_mapping_input(
    ...
    super::protocol_serde::shape_update_event_source_mapping_input::ser_update_event_source_mapping_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_update_event_source_mapping(
    _value: &[u8],
    mut builder: super::operation::update_event_source_mapping::builders::UpdateEventSourceMappingOutputBuilder,
) -> ::std::result::Result<
    super::operation::update_event_source_mapping::builders::UpdateEventSourceMappingOutputBuilder,
