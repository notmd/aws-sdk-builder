...
pub fn de_stop_durable_execution_http_error(
    ...
    super::operation::stop_durable_execution::StopDurableExecutionOutput,
    super::operation::stop_durable_execution::StopDurableExecutionError,
> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::stop_durable_execution::StopDurableExecutionError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InvalidParameterValueException" => super::operation::stop_durable_execution::StopDurableExecutionError::InvalidParameterValueException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSAccessDeniedException" => super::operation::stop_durable_execution::StopDurableExecutionError::KmsAccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSDisabledException" => super::operation::stop_durable_execution::StopDurableExecutionError::KmsDisabledException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInvalidStateException" => super::operation::stop_durable_execution::StopDurableExecutionError::KmsInvalidStateException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSNotFoundException" => super::operation::stop_durable_execution::StopDurableExecutionError::KmsNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => super::operation::stop_durable_execution::StopDurableExecutionError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceException" => super::operation::stop_durable_execution::StopDurableExecutionError::ServiceException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::operation::stop_durable_execution::StopDurableExecutionError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::stop_durable_execution::StopDurableExecutionError::generic(generic),
    })
}
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::stop_durable_execution::builders::StopDurableExecutionOutputBuilder::default();
        output = super::protocol_serde::shape_stop_durable_execution::de_stop_durable_execution(_response_body, output)
            .map_err(super::operation::stop_durable_execution::StopDurableExecutionError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::serde_util::stop_durable_execution_output_output_correct_errors(output)
            .build()
            .map_err(super::operation::stop_durable_execution::StopDurableExecutionError::unhandled)?
    })
}
