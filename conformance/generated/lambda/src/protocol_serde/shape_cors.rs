...
pub(crate) fn de_cors<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::types::Cors>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::types::builders::CorsBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "AllowHeaders" => {
                            builder =
                                builder.set_allow_headers(super::protocol_serde::shape_headers_list::de_headers_list(tokens, _value, depth + 1)?);
                        }
                        "AllowMethods" => {
                            builder = builder.set_allow_methods(super::protocol_serde::shape_allow_methods_list::de_allow_methods_list(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "AllowOrigins" => {
                            builder = builder.set_allow_origins(super::protocol_serde::shape_allow_origins_list::de_allow_origins_list(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "ExposeHeaders" => {
                            builder =
                                builder.set_expose_headers(super::protocol_serde::shape_headers_list::de_headers_list(tokens, _value, depth + 1)?);
                        }
                        "MaxAge" => {
