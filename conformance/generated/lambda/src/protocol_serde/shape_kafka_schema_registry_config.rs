...
pub(crate) fn de_kafka_schema_registry_config<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::types::KafkaSchemaRegistryConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::types::builders::KafkaSchemaRegistryConfigBuilder::default();
            loop {
                match tokens.next().transpose()? {
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "EventRecordFormat" => {
                                builder = builder.set_event_record_format(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                        .map(|s| s.to_unescaped().map(|u| super::types::SchemaRegistryEventRecordFormat::from(u.as_ref())))
                                        .transpose()?,
                                );
                            }
                            "AccessConfigs" => {
                            ...
                            "SchemaValidationConfigs" => {
                                builder = builder.set_schema_validation_configs(
                                    super::protocol_serde::shape_kafka_schema_validation_config_list::de_kafka_schema_validation_config_list(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
