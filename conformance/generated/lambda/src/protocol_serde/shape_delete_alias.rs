...
pub fn de_delete_alias_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::delete_alias::DeleteAliasOutput, super::operation::delete_alias::DeleteAliasError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::delete_alias::DeleteAliasError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InvalidParameterValueException" => super::operation::delete_alias::DeleteAliasError::InvalidParameterValueException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceConflictException" => super::operation::delete_alias::DeleteAliasError::ResourceConflictException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => super::operation::delete_alias::DeleteAliasError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceException" => super::operation::delete_alias::DeleteAliasError::ServiceException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::operation::delete_alias::DeleteAliasError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::delete_alias::DeleteAliasError::generic(generic),
    })
}
...
pub fn de_delete_alias_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::delete_alias::builders::DeleteAliasOutputBuilder::default();
