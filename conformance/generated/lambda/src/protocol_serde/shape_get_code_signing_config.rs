...
pub fn de_get_code_signing_config_http_error(
    ...
    super::operation::get_code_signing_config::GetCodeSigningConfigOutput,
    super::operation::get_code_signing_config::GetCodeSigningConfigError,
> {
    #[allow(unused_mut)]
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::get_code_signing_config::GetCodeSigningConfigError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::get_code_signing_config::GetCodeSigningConfigError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InvalidParameterValueException" => super::operation::get_code_signing_config::GetCodeSigningConfigError::InvalidParameterValueException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => super::operation::get_code_signing_config::GetCodeSigningConfigError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceException" => super::operation::get_code_signing_config::GetCodeSigningConfigError::ServiceException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::get_code_signing_config::GetCodeSigningConfigError::generic(generic),
    })
}
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::get_code_signing_config::builders::GetCodeSigningConfigOutputBuilder::default();
        output = super::protocol_serde::shape_get_code_signing_config::de_get_code_signing_config(_response_body, output)
            .map_err(super::operation::get_code_signing_config::GetCodeSigningConfigError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::serde_util::get_code_signing_config_output_output_correct_errors(output).build()
    })
}
