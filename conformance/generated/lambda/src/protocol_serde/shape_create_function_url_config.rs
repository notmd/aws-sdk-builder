...
pub fn de_create_function_url_config_http_error(
    ...
    super::operation::create_function_url_config::CreateFunctionUrlConfigError,
> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(super::operation::create_function_url_config::CreateFunctionUrlConfigError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "InvalidParameterValueException" => {
            super::operation::create_function_url_config::CreateFunctionUrlConfigError::InvalidParameterValueException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceConflictException" => super::operation::create_function_url_config::CreateFunctionUrlConfigError::ResourceConflictException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => super::operation::create_function_url_config::CreateFunctionUrlConfigError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceException" => super::operation::create_function_url_config::CreateFunctionUrlConfigError::ServiceException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::operation::create_function_url_config::CreateFunctionUrlConfigError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::create_function_url_config::CreateFunctionUrlConfigError::generic(generic),
    })
}
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::create_function_url_config::builders::CreateFunctionUrlConfigOutputBuilder::default();
        output = super::protocol_serde::shape_create_function_url_config::de_create_function_url_config(_response_body, output)
            .map_err(super::operation::create_function_url_config::CreateFunctionUrlConfigError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::serde_util::create_function_url_config_output_output_correct_errors(output)
            .build()
            .map_err(super::operation::create_function_url_config::CreateFunctionUrlConfigError::unhandled)?
    })
}
...
pub fn ser_create_function_url_config_input(
    ...
    super::protocol_serde::shape_create_function_url_config_input::ser_create_function_url_config_input_input(&mut object, input)?;
    object.finish();
