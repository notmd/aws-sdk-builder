...
pub fn de_get_alias_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::get_alias::GetAliasOutput, super::operation::get_alias::GetAliasError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::get_alias::GetAliasError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InvalidParameterValueException" => super::operation::get_alias::GetAliasError::InvalidParameterValueException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => super::operation::get_alias::GetAliasError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceException" => super::operation::get_alias::GetAliasError::ServiceException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::operation::get_alias::GetAliasError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::get_alias::GetAliasError::generic(generic),
    })
}
...
pub fn de_get_alias_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::get_alias::builders::GetAliasOutputBuilder::default();
        output = super::protocol_serde::shape_get_alias::de_get_alias(_response_body, output)
            .map_err(super::operation::get_alias::GetAliasError::unhandled)?;
...
) -> ::std::result::Result<super::operation::get_alias::builders::GetAliasOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
