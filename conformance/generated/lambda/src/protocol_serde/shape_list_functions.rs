...
pub fn de_list_functions_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::list_functions::ListFunctionsOutput, super::operation::list_functions::ListFunctionsError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::list_functions::ListFunctionsError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InvalidParameterValueException" => super::operation::list_functions::ListFunctionsError::InvalidParameterValueException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceException" => super::operation::list_functions::ListFunctionsError::ServiceException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::operation::list_functions::ListFunctionsError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::list_functions::ListFunctionsError::generic(generic),
    })
}
...
pub fn de_list_functions_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::list_functions::builders::ListFunctionsOutputBuilder::default();
        output = super::protocol_serde::shape_list_functions::de_list_functions(_response_body, output)
            .map_err(super::operation::list_functions::ListFunctionsError::unhandled)?;
...
pub(crate) fn de_list_functions(
    ...
    super::operation::list_functions::builders::ListFunctionsOutputBuilder,
