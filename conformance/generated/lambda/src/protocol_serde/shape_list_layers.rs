...
pub fn de_list_layers_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::list_layers::ListLayersOutput, super::operation::list_layers::ListLayersError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::list_layers::ListLayersError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InvalidParameterValueException" => super::operation::list_layers::ListLayersError::InvalidParameterValueException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceException" => super::operation::list_layers::ListLayersError::ServiceException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::operation::list_layers::ListLayersError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::list_layers::ListLayersError::generic(generic),
    })
}
...
pub fn de_list_layers_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::list_layers::builders::ListLayersOutputBuilder::default();
        output = super::protocol_serde::shape_list_layers::de_list_layers(_response_body, output)
            .map_err(super::operation::list_layers::ListLayersError::unhandled)?;
...
) -> ::std::result::Result<super::operation::list_layers::builders::ListLayersOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
