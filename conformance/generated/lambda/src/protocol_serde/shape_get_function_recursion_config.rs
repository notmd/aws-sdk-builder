...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::get_function_recursion_config::GetFunctionRecursionConfigError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InvalidParameterValueException" => {
            super::operation::get_function_recursion_config::GetFunctionRecursionConfigError::InvalidParameterValueException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => super::operation::get_function_recursion_config::GetFunctionRecursionConfigError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceException" => super::operation::get_function_recursion_config::GetFunctionRecursionConfigError::ServiceException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::operation::get_function_recursion_config::GetFunctionRecursionConfigError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::get_function_recursion_config::GetFunctionRecursionConfigError::generic(generic),
    })
}
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::get_function_recursion_config::builders::GetFunctionRecursionConfigOutputBuilder::default();
        output = super::protocol_serde::shape_get_function_recursion_config::de_get_function_recursion_config(_response_body, output)
            .map_err(super::operation::get_function_recursion_config::GetFunctionRecursionConfigError::unhandled)?;
...
pub(crate) fn de_get_function_recursion_config(
    ...
    super::operation::get_function_recursion_config::builders::GetFunctionRecursionConfigOutputBuilder,
