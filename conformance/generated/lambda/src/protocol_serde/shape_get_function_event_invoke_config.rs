...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::get_function_event_invoke_config::GetFunctionEventInvokeConfigError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InvalidParameterValueException" => {
            super::operation::get_function_event_invoke_config::GetFunctionEventInvokeConfigError::InvalidParameterValueException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            super::operation::get_function_event_invoke_config::GetFunctionEventInvokeConfigError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceException" => super::operation::get_function_event_invoke_config::GetFunctionEventInvokeConfigError::ServiceException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => {
            super::operation::get_function_event_invoke_config::GetFunctionEventInvokeConfigError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        _ => super::operation::get_function_event_invoke_config::GetFunctionEventInvokeConfigError::generic(generic),
    })
}
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::get_function_event_invoke_config::builders::GetFunctionEventInvokeConfigOutputBuilder::default();
        output = super::protocol_serde::shape_get_function_event_invoke_config::de_get_function_event_invoke_config(_response_body, output)
            .map_err(super::operation::get_function_event_invoke_config::GetFunctionEventInvokeConfigError::unhandled)?;
...
pub(crate) fn de_get_function_event_invoke_config(
    ...
    super::operation::get_function_event_invoke_config::builders::GetFunctionEventInvokeConfigOutputBuilder,
