...
pub fn de_get_account_settings_http_error(
    ...
    super::operation::get_account_settings::GetAccountSettingsError,
> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::get_account_settings::GetAccountSettingsError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "ServiceException" => super::operation::get_account_settings::GetAccountSettingsError::ServiceException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::operation::get_account_settings::GetAccountSettingsError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::get_account_settings::GetAccountSettingsError::generic(generic),
    })
}
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::get_account_settings::builders::GetAccountSettingsOutputBuilder::default();
        output = super::protocol_serde::shape_get_account_settings::de_get_account_settings(_response_body, output)
            .map_err(super::operation::get_account_settings::GetAccountSettingsError::unhandled)?;
...
pub(crate) fn de_get_account_settings(
    ...
    super::operation::get_account_settings::builders::GetAccountSettingsOutputBuilder,
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "AccountLimit" => {
                    builder = builder.set_account_limit(super::protocol_serde::shape_account_limit::de_account_limit(tokens, _value, depth + 1)?);
                }
                "AccountUsage" => {
                    builder = builder.set_account_usage(super::protocol_serde::shape_account_usage::de_account_usage(tokens, _value, depth + 1)?);
                }
