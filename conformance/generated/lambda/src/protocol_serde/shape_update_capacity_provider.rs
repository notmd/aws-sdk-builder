...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(super::operation::update_capacity_provider::UpdateCapacityProviderError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "InvalidParameterValueException" => {
            super::operation::update_capacity_provider::UpdateCapacityProviderError::InvalidParameterValueException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceConflictException" => super::operation::update_capacity_provider::UpdateCapacityProviderError::ResourceConflictException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => super::operation::update_capacity_provider::UpdateCapacityProviderError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceException" => super::operation::update_capacity_provider::UpdateCapacityProviderError::ServiceException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::operation::update_capacity_provider::UpdateCapacityProviderError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::update_capacity_provider::UpdateCapacityProviderError::generic(generic),
    })
}
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::update_capacity_provider::builders::UpdateCapacityProviderOutputBuilder::default();
        output = super::protocol_serde::shape_update_capacity_provider::de_update_capacity_provider(_response_body, output)
            .map_err(super::operation::update_capacity_provider::UpdateCapacityProviderError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::serde_util::update_capacity_provider_output_output_correct_errors(output).build()
    })
}
...
pub fn ser_update_capacity_provider_input(
    ...
    super::protocol_serde::shape_update_capacity_provider_input::ser_update_capacity_provider_input_input(&mut object, input)?;
    object.finish();
