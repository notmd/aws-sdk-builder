...
impl FunctionUpdatedFluentBuilder {
    ...
    pub async fn wait(
        ...
        super::waiters::function_updated::FunctionUpdatedFinalPoll,
        super::waiters::function_updated::WaitUntilFunctionUpdatedError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            ...
            if super::waiters::matchers::match_get_function_configuration_72b8f2e5744091428(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"output":{"path":"LastUpdateStatus","expected":"Failed","comparator":"stringEquals"}}
            if super::waiters::matchers::match_get_function_configuration_4a2442d74e6aa2cc0(result) {
            ...
            if super::waiters::matchers::match_get_function_configuration_ee72e8a7f6fced7db(result) {
