...
impl FunctionActiveV2FluentBuilder {
    ...
    pub async fn wait(
        ...
        super::waiters::function_active_v2::FunctionActiveV2FinalPoll,
        super::waiters::function_active_v2::WaitUntilFunctionActiveV2Error,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            ...
            if super::waiters::matchers::match_get_function_d9eb800ea4f674f85(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"output":{"path":"Configuration.State","expected":"Failed","comparator":"stringEquals"}}
            if super::waiters::matchers::match_get_function_ee0f14a7f1ed34282(result) {
            ...
            if super::waiters::matchers::match_get_function_1248046627b71c232(result) {
