...
> {
    ...
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::get_multi_region_endpoint::GetMultiRegionEndpointError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(super::operation::get_multi_region_endpoint::GetMultiRegionEndpointError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "BadRequestException" => super::operation::get_multi_region_endpoint::GetMultiRegionEndpointError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::operation::get_multi_region_endpoint::GetMultiRegionEndpointError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::operation::get_multi_region_endpoint::GetMultiRegionEndpointError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::get_multi_region_endpoint::GetMultiRegionEndpointError::generic(generic),
    })
}
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::get_multi_region_endpoint::builders::GetMultiRegionEndpointOutputBuilder::default();
        output = super::protocol_serde::shape_get_multi_region_endpoint::de_get_multi_region_endpoint(_response_body, output)
            .map_err(super::operation::get_multi_region_endpoint::GetMultiRegionEndpointError::unhandled)?;
...
pub(crate) fn de_get_multi_region_endpoint(
    ...
    super::operation::get_multi_region_endpoint::builders::GetMultiRegionEndpointOutputBuilder,
