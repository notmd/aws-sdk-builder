...
pub fn de_get_contact_list_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::get_contact_list::GetContactListOutput, super::operation::get_contact_list::GetContactListError> {
    #[allow(unused_mut)]
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::get_contact_list::GetContactListError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::get_contact_list::GetContactListError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "BadRequestException" => super::operation::get_contact_list::GetContactListError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::operation::get_contact_list::GetContactListError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::operation::get_contact_list::GetContactListError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::get_contact_list::GetContactListError::generic(generic),
    })
}
...
pub fn de_get_contact_list_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::get_contact_list::builders::GetContactListOutputBuilder::default();
        output = super::protocol_serde::shape_get_contact_list::de_get_contact_list(_response_body, output)
            .map_err(super::operation::get_contact_list::GetContactListError::unhandled)?;
...
pub(crate) fn de_get_contact_list(
    ...
    super::operation::get_contact_list::builders::GetContactListOutputBuilder,
