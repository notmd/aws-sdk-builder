...
pub fn de_get_message_insights_http_error(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
    super::operation::get_message_insights::GetMessageInsightsOutput,
    super::operation::get_message_insights::GetMessageInsightsError,
> {
    #[allow(unused_mut)]
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::get_message_insights::GetMessageInsightsError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::get_message_insights::GetMessageInsightsError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "BadRequestException" => super::operation::get_message_insights::GetMessageInsightsError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::operation::get_message_insights::GetMessageInsightsError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::operation::get_message_insights::GetMessageInsightsError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::get_message_insights::GetMessageInsightsError::generic(generic),
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_get_message_insights_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::get_message_insights::builders::GetMessageInsightsOutputBuilder::default();
        output = super::protocol_serde::shape_get_message_insights::de_get_message_insights(_response_body, output)
            .map_err(super::operation::get_message_insights::GetMessageInsightsError::unhandled)?;
...
pub(crate) fn de_get_message_insights(
    ...
    super::operation::get_message_insights::builders::GetMessageInsightsOutputBuilder,
