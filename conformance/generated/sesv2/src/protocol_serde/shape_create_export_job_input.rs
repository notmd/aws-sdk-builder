...
pub fn ser_create_export_job_input_input(
    ...
    if let Some(var_1) = &input.export_data_source {
        ...
        super::protocol_serde::shape_export_data_source::ser_export_data_source(&mut object_2, var_1)?;
        object_2.finish();
    }
    if let Some(var_3) = &input.export_destination {
        #[allow(unused_mut)]
        let mut object_4 = object.key("ExportDestination").start_object();
        super::protocol_serde::shape_export_destination::ser_export_destination(&mut object_4, var_3)?;
        object_4.finish();
    }
    Ok(())
}
