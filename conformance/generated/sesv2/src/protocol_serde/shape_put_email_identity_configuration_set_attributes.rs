...
pub fn de_put_email_identity_configuration_set_attributes_http_error(
...
> {
    ...
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::put_email_identity_configuration_set_attributes::PutEmailIdentityConfigurationSetAttributesError::unhandled)?;
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                super::operation::put_email_identity_configuration_set_attributes::PutEmailIdentityConfigurationSetAttributesError::unhandled(
                    generic,
                ),
            )
        }
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_email_identity_configuration_set_attributes_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::put_email_identity_configuration_set_attributes::builders::PutEmailIdentityConfigurationSetAttributesOutputBuilder::default();
...
pub fn ser_put_email_identity_configuration_set_attributes_input(
    ...
    super::protocol_serde::shape_put_email_identity_configuration_set_attributes_input::ser_put_email_identity_configuration_set_attributes_input_input(&mut object, input)?;
    object.finish();
