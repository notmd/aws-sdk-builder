...
pub fn de_delete_contact_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::delete_contact::DeleteContactOutput, super::operation::delete_contact::DeleteContactError> {
    #[allow(unused_mut)]
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::delete_contact::DeleteContactError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::delete_contact::DeleteContactError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "BadRequestException" => super::operation::delete_contact::DeleteContactError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::operation::delete_contact::DeleteContactError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::operation::delete_contact::DeleteContactError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::delete_contact::DeleteContactError::generic(generic),
    })
}
...
pub fn de_delete_contact_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::delete_contact::builders::DeleteContactOutputBuilder::default();
