...
pub fn de_create_contact_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::create_contact::CreateContactOutput, super::operation::create_contact::CreateContactError> {
    #[allow(unused_mut)]
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::create_contact::CreateContactError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::create_contact::CreateContactError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AlreadyExistsException" => super::operation::create_contact::CreateContactError::AlreadyExistsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "BadRequestException" => super::operation::create_contact::CreateContactError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::operation::create_contact::CreateContactError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::operation::create_contact::CreateContactError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::create_contact::CreateContactError::generic(generic),
    })
}
...
pub fn de_create_contact_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::create_contact::builders::CreateContactOutputBuilder::default();
...
pub fn ser_create_contact_input(
    ...
    super::protocol_serde::shape_create_contact_input::ser_create_contact_input_input(&mut object, input)?;
    object.finish();
