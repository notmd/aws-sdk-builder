...
> {
    ...
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::update_reputation_entity_customer_managed_status::UpdateReputationEntityCustomerManagedStatusError::unhandled)?;
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                super::operation::update_reputation_entity_customer_managed_status::UpdateReputationEntityCustomerManagedStatusError::unhandled(
                    generic,
                ),
            )
        }
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::update_reputation_entity_customer_managed_status::builders::UpdateReputationEntityCustomerManagedStatusOutputBuilder::default();
...
pub fn ser_update_reputation_entity_customer_managed_status_input(
    ...
    super::protocol_serde::shape_update_reputation_entity_customer_managed_status_input::ser_update_reputation_entity_customer_managed_status_input_input(&mut object, input)?;
    object.finish();
