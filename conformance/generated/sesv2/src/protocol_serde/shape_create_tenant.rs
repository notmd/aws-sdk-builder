...
pub fn de_create_tenant_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::create_tenant::CreateTenantOutput, super::operation::create_tenant::CreateTenantError> {
    #[allow(unused_mut)]
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::create_tenant::CreateTenantError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::create_tenant::CreateTenantError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AlreadyExistsException" => super::operation::create_tenant::CreateTenantError::AlreadyExistsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "BadRequestException" => super::operation::create_tenant::CreateTenantError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "LimitExceededException" => super::operation::create_tenant::CreateTenantError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::operation::create_tenant::CreateTenantError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::create_tenant::CreateTenantError::generic(generic),
    })
}
...
pub fn de_create_tenant_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::create_tenant::builders::CreateTenantOutputBuilder::default();
        output = super::protocol_serde::shape_create_tenant::de_create_tenant(_response_body, output)
            .map_err(super::operation::create_tenant::CreateTenantError::unhandled)?;
...
pub fn ser_create_tenant_input(
    ...
    super::protocol_serde::shape_create_tenant_input::ser_create_tenant_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_create_tenant(
    _value: &[u8],
    mut builder: super::operation::create_tenant::builders::CreateTenantOutputBuilder,
) -> ::std::result::Result<
    super::operation::create_tenant::builders::CreateTenantOutputBuilder,
