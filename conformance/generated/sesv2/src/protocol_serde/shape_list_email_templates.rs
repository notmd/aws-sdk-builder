...
> {
    ...
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::list_email_templates::ListEmailTemplatesError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::list_email_templates::ListEmailTemplatesError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "BadRequestException" => super::operation::list_email_templates::ListEmailTemplatesError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::operation::list_email_templates::ListEmailTemplatesError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::list_email_templates::ListEmailTemplatesError::generic(generic),
    })
}
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::list_email_templates::builders::ListEmailTemplatesOutputBuilder::default();
        output = super::protocol_serde::shape_list_email_templates::de_list_email_templates(_response_body, output)
            .map_err(super::operation::list_email_templates::ListEmailTemplatesError::unhandled)?;
...
pub(crate) fn de_list_email_templates(
    ...
    super::operation::list_email_templates::builders::ListEmailTemplatesOutputBuilder,
