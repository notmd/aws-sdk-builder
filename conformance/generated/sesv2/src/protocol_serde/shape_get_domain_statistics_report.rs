...
> {
    ...
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::get_domain_statistics_report::GetDomainStatisticsReportError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(super::operation::get_domain_statistics_report::GetDomainStatisticsReportError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "BadRequestException" => super::operation::get_domain_statistics_report::GetDomainStatisticsReportError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::operation::get_domain_statistics_report::GetDomainStatisticsReportError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::operation::get_domain_statistics_report::GetDomainStatisticsReportError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::get_domain_statistics_report::GetDomainStatisticsReportError::generic(generic),
    })
}
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::get_domain_statistics_report::builders::GetDomainStatisticsReportOutputBuilder::default();
        output = super::protocol_serde::shape_get_domain_statistics_report::de_get_domain_statistics_report(_response_body, output)
            .map_err(super::operation::get_domain_statistics_report::GetDomainStatisticsReportError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::serde_util::get_domain_statistics_report_output_output_correct_errors(output)
            .build()
            .map_err(super::operation::get_domain_statistics_report::GetDomainStatisticsReportError::unhandled)?
    })
}
