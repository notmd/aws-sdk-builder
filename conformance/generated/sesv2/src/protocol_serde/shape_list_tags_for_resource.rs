...
> {
    ...
    Err(match error_code {
        "BadRequestException" => super::operation::list_tags_for_resource::ListTagsForResourceError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::operation::list_tags_for_resource::ListTagsForResourceError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        ...
        super::serde_util::list_tags_for_resource_output_output_correct_errors(output)
            .build()
            .map_err(super::operation::list_tags_for_resource::ListTagsForResourceError::unhandled)?
    })
}
