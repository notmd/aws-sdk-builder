...
pub fn ser_domain_deliverability_tracking_option(
    ...
    input: &super::types::DomainDeliverabilityTrackingOption,
    ...
    if let Some(var_3) = &input.inbox_placement_tracking_option {
        ...
        super::protocol_serde::shape_inbox_placement_tracking_option::ser_inbox_placement_tracking_option(&mut object_4, var_3)?;
        object_4.finish();
    }
    Ok(())
}
...
pub(crate) fn de_domain_deliverability_tracking_option<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::types::DomainDeliverabilityTrackingOption>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::types::builders::DomainDeliverabilityTrackingOptionBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "InboxPlacementTrackingOption" => {
                            builder = builder.set_inbox_placement_tracking_option(
                                super::protocol_serde::shape_inbox_placement_tracking_option::de_inbox_placement_tracking_option(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
