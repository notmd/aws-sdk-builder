...
pub struct OverallVolume {
    ...
    pub volume_statistics: ::std::option::Option<super::types::VolumeStatistics>,
    ...
    pub domain_isp_placements: ::std::option::Option<::std::vec::Vec<super::types::DomainIspPlacement>>,
}
impl OverallVolume {
    /// <p>An object that contains information about the numbers of messages that arrived in recipients' inboxes and junk mail folders.</p>
    pub fn volume_statistics(&self) -> ::std::option::Option<&super::types::VolumeStatistics> {
    ...
    pub fn domain_isp_placements(&self) -> &[super::types::DomainIspPlacement] {
...
impl OverallVolume {
    ...
    pub fn builder() -> super::types::builders::OverallVolumeBuilder {
        super::types::builders::OverallVolumeBuilder::default()
    }
}
...
pub struct OverallVolumeBuilder {
    pub(crate) volume_statistics: ::std::option::Option<super::types::VolumeStatistics>,
    pub(crate) read_rate_percent: ::std::option::Option<f64>,
    pub(crate) domain_isp_placements: ::std::option::Option<::std::vec::Vec<super::types::DomainIspPlacement>>,
}
impl OverallVolumeBuilder {
    /// <p>An object that contains information about the numbers of messages that arrived in recipients' inboxes and junk mail folders.</p>
    pub fn volume_statistics(mut self, input: super::types::VolumeStatistics) -> Self {
        self.volume_statistics = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object that contains information about the numbers of messages that arrived in recipients' inboxes and junk mail folders.</p>
    pub fn set_volume_statistics(mut self, input: ::std::option::Option<super::types::VolumeStatistics>) -> Self {
        self.volume_statistics = input;
        self
    }
    /// <p>An object that contains information about the numbers of messages that arrived in recipients' inboxes and junk mail folders.</p>
    pub fn get_volume_statistics(&self) -> &::std::option::Option<super::types::VolumeStatistics> {
    ...
    ///
    /// <p>An object that contains inbox and junk mail placement metrics for individual email providers.</p>
    pub fn domain_isp_placements(mut self, input: super::types::DomainIspPlacement) -> Self {
    ...
    /// <p>An object that contains inbox and junk mail placement metrics for individual email providers.</p>
    pub fn set_domain_isp_placements(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::DomainIspPlacement>>) -> Self {
        self.domain_isp_placements = input;
        self
    }
    /// <p>An object that contains inbox and junk mail placement metrics for individual email providers.</p>
    pub fn get_domain_isp_placements(&self) -> &::std::option::Option<::std::vec::Vec<super::types::DomainIspPlacement>> {
        &self.domain_isp_placements
    }
    /// Consumes the builder and constructs a [`OverallVolume`](crate::types::OverallVolume).
    pub fn build(self) -> super::types::OverallVolume {
        super::types::OverallVolume {
