...
impl MetricDataResult {
    ...
    pub fn builder() -> super::types::builders::MetricDataResultBuilder {
        super::types::builders::MetricDataResultBuilder::default()
    }
}
...
impl MetricDataResultBuilder {
    ...
    pub fn build(self) -> super::types::MetricDataResult {
        super::types::MetricDataResult {
            id: self.id,
