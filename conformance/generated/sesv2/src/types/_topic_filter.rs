...
impl TopicFilter {
    ...
    pub fn builder() -> super::types::builders::TopicFilterBuilder {
        super::types::builders::TopicFilterBuilder::default()
    }
}
...
impl TopicFilterBuilder {
    ...
    pub fn build(self) -> super::types::TopicFilter {
        super::types::TopicFilter {
