...
impl DomainDeliverabilityCampaign {
    ...
    pub fn builder() -> super::types::builders::DomainDeliverabilityCampaignBuilder {
        super::types::builders::DomainDeliverabilityCampaignBuilder::default()
    }
}
...
impl DomainDeliverabilityCampaignBuilder {
    ...
    pub fn build(self) -> super::types::DomainDeliverabilityCampaign {
        super::types::DomainDeliverabilityCampaign {
