...
impl SuppressionAttributes {
    ...
    pub fn builder() -> super::types::builders::SuppressionAttributesBuilder {
        super::types::builders::SuppressionAttributesBuilder::default()
    }
}
...
impl SuppressionAttributesBuilder {
    ...
    pub fn build(self) -> super::types::SuppressionAttributes {
        super::types::SuppressionAttributes {
