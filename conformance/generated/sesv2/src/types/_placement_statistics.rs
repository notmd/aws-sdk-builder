...
impl PlacementStatistics {
    ...
    pub fn builder() -> super::types::builders::PlacementStatisticsBuilder {
        super::types::builders::PlacementStatisticsBuilder::default()
    }
}
...
impl PlacementStatisticsBuilder {
    ...
    pub fn build(self) -> super::types::PlacementStatistics {
        super::types::PlacementStatistics {
