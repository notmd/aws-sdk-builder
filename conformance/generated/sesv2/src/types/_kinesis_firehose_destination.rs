...
impl KinesisFirehoseDestination {
    ...
    pub fn builder() -> super::types::builders::KinesisFirehoseDestinationBuilder {
        super::types::builders::KinesisFirehoseDestinationBuilder::default()
    }
}
...
impl KinesisFirehoseDestinationBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::KinesisFirehoseDestination, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::KinesisFirehoseDestination {
