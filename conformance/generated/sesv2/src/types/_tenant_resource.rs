...
impl TenantResource {
    ...
    pub fn builder() -> super::types::builders::TenantResourceBuilder {
        super::types::builders::TenantResourceBuilder::default()
    }
}
...
impl TenantResourceBuilder {
    ...
    pub fn build(self) -> super::types::TenantResource {
