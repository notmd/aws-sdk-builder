...
impl VolumeStatistics {
    ...
    pub fn builder() -> super::types::builders::VolumeStatisticsBuilder {
        super::types::builders::VolumeStatisticsBuilder::default()
    }
}
...
impl VolumeStatisticsBuilder {
    ...
    pub fn build(self) -> super::types::VolumeStatistics {
        super::types::VolumeStatistics {
