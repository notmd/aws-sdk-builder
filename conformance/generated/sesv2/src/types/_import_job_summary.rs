...
impl ImportJobSummary {
    ...
    pub fn builder() -> super::types::builders::ImportJobSummaryBuilder {
        super::types::builders::ImportJobSummaryBuilder::default()
    }
}
...
impl ImportJobSummaryBuilder {
    ...
    pub fn build(self) -> super::types::ImportJobSummary {
        super::types::ImportJobSummary {
            job_id: self.job_id,
