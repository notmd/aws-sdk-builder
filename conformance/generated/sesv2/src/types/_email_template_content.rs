...
impl EmailTemplateContent {
    ...
    pub fn builder() -> super::types::builders::EmailTemplateContentBuilder {
        super::types::builders::EmailTemplateContentBuilder::default()
    }
}
...
impl EmailTemplateContentBuilder {
    ...
    pub fn build(self) -> super::types::EmailTemplateContent {
        super::types::EmailTemplateContent {
