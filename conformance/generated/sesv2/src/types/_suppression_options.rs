...
impl SuppressionOptions {
    ...
    pub fn builder() -> super::types::builders::SuppressionOptionsBuilder {
        super::types::builders::SuppressionOptionsBuilder::default()
    }
}
...
impl SuppressionOptionsBuilder {
    ...
    pub fn build(self) -> super::types::SuppressionOptions {
        super::types::SuppressionOptions {
