...
impl RawMessage {
    ...
    pub fn builder() -> super::types::builders::RawMessageBuilder {
        super::types::builders::RawMessageBuilder::default()
    }
}
...
impl RawMessageBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::RawMessage, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::RawMessage {
