...
impl ExportStatistics {
    ...
    pub fn builder() -> super::types::builders::ExportStatisticsBuilder {
        super::types::builders::ExportStatisticsBuilder::default()
    }
}
...
impl ExportStatisticsBuilder {
    ...
    pub fn build(self) -> super::types::ExportStatistics {
        super::types::ExportStatistics {
