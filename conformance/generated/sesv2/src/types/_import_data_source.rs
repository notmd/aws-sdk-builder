...
impl ImportDataSource {
    ...
    pub fn builder() -> super::types::builders::ImportDataSourceBuilder {
        super::types::builders::ImportDataSourceBuilder::default()
    }
}
...
impl ImportDataSourceBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::ImportDataSource, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ImportDataSource {
