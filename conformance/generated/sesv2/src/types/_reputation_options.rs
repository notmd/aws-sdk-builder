...
impl ReputationOptions {
    ...
    pub fn builder() -> super::types::builders::ReputationOptionsBuilder {
        super::types::builders::ReputationOptionsBuilder::default()
    }
}
...
impl ReputationOptionsBuilder {
    ...
    pub fn build(self) -> super::types::ReputationOptions {
        super::types::ReputationOptions {
