...
impl Complaint {
    ...
    pub fn builder() -> super::types::builders::ComplaintBuilder {
        super::types::builders::ComplaintBuilder::default()
    }
}
...
impl ComplaintBuilder {
    ...
    pub fn build(self) -> super::types::Complaint {
        super::types::Complaint {
