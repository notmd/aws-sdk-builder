...
pub struct Bounce {
    ...
    pub bounce_type: ::std::option::Option<super::types::BounceType>,
...
impl Bounce {
    /// <p>The type of the bounce, as determined by SES. Can be one of <code>UNDETERMINED</code>, <code>TRANSIENT</code>, or <code>PERMANENT</code></p>
    pub fn bounce_type(&self) -> ::std::option::Option<&super::types::BounceType> {
...
impl Bounce {
    ...
    pub fn builder() -> super::types::builders::BounceBuilder {
        super::types::builders::BounceBuilder::default()
    }
}
...
pub struct BounceBuilder {
    pub(crate) bounce_type: ::std::option::Option<super::types::BounceType>,
...
impl BounceBuilder {
    /// <p>The type of the bounce, as determined by SES. Can be one of <code>UNDETERMINED</code>, <code>TRANSIENT</code>, or <code>PERMANENT</code></p>
    pub fn bounce_type(mut self, input: super::types::BounceType) -> Self {
        self.bounce_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The type of the bounce, as determined by SES. Can be one of <code>UNDETERMINED</code>, <code>TRANSIENT</code>, or <code>PERMANENT</code></p>
    pub fn set_bounce_type(mut self, input: ::std::option::Option<super::types::BounceType>) -> Self {
        self.bounce_type = input;
        self
    }
    /// <p>The type of the bounce, as determined by SES. Can be one of <code>UNDETERMINED</code>, <code>TRANSIENT</code>, or <code>PERMANENT</code></p>
    pub fn get_bounce_type(&self) -> &::std::option::Option<super::types::BounceType> {
        &self.bounce_type
    }
    /// <p>The subtype of the bounce, as determined by SES.</p>
    ...
    pub fn build(self) -> super::types::Bounce {
        super::types::Bounce {
