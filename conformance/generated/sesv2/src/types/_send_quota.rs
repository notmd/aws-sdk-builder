...
impl SendQuota {
    ...
    pub fn builder() -> super::types::builders::SendQuotaBuilder {
        super::types::builders::SendQuotaBuilder::default()
    }
}
...
impl SendQuotaBuilder {
    ...
    pub fn build(self) -> super::types::SendQuota {
        super::types::SendQuota {
