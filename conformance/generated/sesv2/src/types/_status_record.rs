...
pub struct StatusRecord {
    ...
    /// </ul>
    pub status: ::std::option::Option<super::types::SendingStatus>,
...
impl StatusRecord {
    ...
    /// <p><code>REINSTATED</code> – Sending is allowed even with active reputation findings.</p></li>
    /// </ul>
    pub fn status(&self) -> ::std::option::Option<&super::types::SendingStatus> {
        self.status.as_ref()
    }
    /// <p>A description of the reason for the current status, or null if no specific cause is available.</p>
...
impl StatusRecord {
    ...
    pub fn builder() -> super::types::builders::StatusRecordBuilder {
        super::types::builders::StatusRecordBuilder::default()
    }
}
...
pub struct StatusRecordBuilder {
    pub(crate) status: ::std::option::Option<super::types::SendingStatus>,
...
impl StatusRecordBuilder {
    ...
    /// <p><code>REINSTATED</code> – Sending is allowed even with active reputation findings.</p></li>
    /// </ul>
    pub fn status(mut self, input: super::types::SendingStatus) -> Self {
    ...
    /// <p><code>REINSTATED</code> – Sending is allowed even with active reputation findings.</p></li>
    /// </ul>
    pub fn set_status(mut self, input: ::std::option::Option<super::types::SendingStatus>) -> Self {
        self.status = input;
        self
    }
    /// <p>The current sending status. This can be one of the following:</p>
    ...
    /// <p><code>REINSTATED</code> – Sending is allowed even with active reputation findings.</p></li>
    /// </ul>
    pub fn get_status(&self) -> &::std::option::Option<super::types::SendingStatus> {
        &self.status
    }
    /// <p>A description of the reason for the current status, or null if no specific cause is available.</p>
    ...
    pub fn build(self) -> super::types::StatusRecord {
        super::types::StatusRecord {
            status: self.status,
            cause: self.cause,
