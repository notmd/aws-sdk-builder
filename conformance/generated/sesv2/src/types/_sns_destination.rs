...
impl SnsDestination {
    ...
    pub fn builder() -> super::types::builders::SnsDestinationBuilder {
        super::types::builders::SnsDestinationBuilder::default()
    }
}
...
impl SnsDestinationBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::SnsDestination, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::SnsDestination {
