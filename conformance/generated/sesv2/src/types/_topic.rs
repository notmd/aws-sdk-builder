...
pub struct Topic {
    ...
    pub default_subscription_status: super::types::SubscriptionStatus,
}
impl Topic {
    /// <p>The name of the topic.</p>
    ...
    /// <p>The default subscription status to be applied to a contact if the contact has not noted their preference for subscribing to a topic.</p>
    pub fn default_subscription_status(&self) -> &super::types::SubscriptionStatus {
...
pub struct TopicBuilder {
    ...
    pub(crate) default_subscription_status: ::std::option::Option<super::types::SubscriptionStatus>,
}
impl TopicBuilder {
    /// <p>The name of the topic.</p>
    ...
    /// <p>The default subscription status to be applied to a contact if the contact has not noted their preference for subscribing to a topic.</p>
    /// This field is required.
    pub fn default_subscription_status(mut self, input: super::types::SubscriptionStatus) -> Self {
        self.default_subscription_status = ::std::option::Option::Some(input);
        self
    }
    /// <p>The default subscription status to be applied to a contact if the contact has not noted their preference for subscribing to a topic.</p>
    pub fn set_default_subscription_status(mut self, input: ::std::option::Option<super::types::SubscriptionStatus>) -> Self {
        self.default_subscription_status = input;
        self
    }
    /// <p>The default subscription status to be applied to a contact if the contact has not noted their preference for subscribing to a topic.</p>
    pub fn get_default_subscription_status(&self) -> &::std::option::Option<super::types::SubscriptionStatus> {
        &self.default_subscription_status
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::types::Topic, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::Topic {
