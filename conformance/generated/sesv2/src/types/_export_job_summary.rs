...
impl ExportJobSummary {
    ...
    pub fn builder() -> super::types::builders::ExportJobSummaryBuilder {
        super::types::builders::ExportJobSummaryBuilder::default()
    }
}
...
impl ExportJobSummaryBuilder {
    ...
    pub fn build(self) -> super::types::ExportJobSummary {
        super::types::ExportJobSummary {
            job_id: self.job_id,
