...
impl ReplacementTemplate {
    ...
    pub fn builder() -> super::types::builders::ReplacementTemplateBuilder {
        super::types::builders::ReplacementTemplateBuilder::default()
    }
}
...
impl ReplacementTemplateBuilder {
    ...
    pub fn build(self) -> super::types::ReplacementTemplate {
        super::types::ReplacementTemplate {
