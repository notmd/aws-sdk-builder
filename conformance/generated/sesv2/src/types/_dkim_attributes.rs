...
pub struct DkimAttributes {
    ...
    /// </ul>
    pub status: ::std::option::Option<super::types::DkimStatus>,
    ...
    /// </ul>
    pub signing_attributes_origin: ::std::option::Option<super::types::DkimSigningAttributesOrigin>,
    /// <p>\[Easy DKIM\] The key length of the future DKIM key pair to be generated. This can be changed at most once per day.</p>
    pub next_signing_key_length: ::std::option::Option<super::types::DkimSigningKeyLength>,
    /// <p>\[Easy DKIM\] The key length of the DKIM key pair in use.</p>
    pub current_signing_key_length: ::std::option::Option<super::types::DkimSigningKeyLength>,
...
impl DkimAttributes {
    ...
    /// <p><code>NOT_STARTED</code> – The DKIM verification process hasn't been initiated for the domain.</p></li>
    /// </ul>
    pub fn status(&self) -> ::std::option::Option<&super::types::DkimStatus> {
        self.status.as_ref()
    }
    /// <p>If you used <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/easy-dkim.html">Easy DKIM</a> to configure DKIM authentication for the domain, then this object contains a set of unique strings that you use to create a set of CNAME records that you add to the DNS configuration for your domain. When Amazon SES detects these records in the DNS configuration for your domain, the DKIM authentication process is complete.</p>
    /// <p>If you configured DKIM authentication for the domain by providing your own public-private key pair, then this object contains the selector for the public key.</p>
    ...
    /// <p><code>AWS_SES_US_GOV_WEST_1</code> – Indicates that DKIM was configured for the identity by replicating signing attributes from a parent identity in AWS GovCloud (US-West) region using Deterministic Easy-DKIM (DEED).</p></li>
    /// </ul>
    pub fn signing_attributes_origin(&self) -> ::std::option::Option<&super::types::DkimSigningAttributesOrigin> {
        self.signing_attributes_origin.as_ref()
    }
    /// <p>\[Easy DKIM\] The key length of the future DKIM key pair to be generated. This can be changed at most once per day.</p>
    pub fn next_signing_key_length(&self) -> ::std::option::Option<&super::types::DkimSigningKeyLength> {
        self.next_signing_key_length.as_ref()
    }
    /// <p>\[Easy DKIM\] The key length of the DKIM key pair in use.</p>
    pub fn current_signing_key_length(&self) -> ::std::option::Option<&super::types::DkimSigningKeyLength> {
...
impl DkimAttributes {
    ...
    pub fn builder() -> super::types::builders::DkimAttributesBuilder {
        super::types::builders::DkimAttributesBuilder::default()
    }
}
...
pub struct DkimAttributesBuilder {
    ...
    pub(crate) status: ::std::option::Option<super::types::DkimStatus>,
    ...
    pub(crate) signing_attributes_origin: ::std::option::Option<super::types::DkimSigningAttributesOrigin>,
    pub(crate) next_signing_key_length: ::std::option::Option<super::types::DkimSigningKeyLength>,
    pub(crate) current_signing_key_length: ::std::option::Option<super::types::DkimSigningKeyLength>,
...
impl DkimAttributesBuilder {
    ...
    /// <p><code>NOT_STARTED</code> – The DKIM verification process hasn't been initiated for the domain.</p></li>
    /// </ul>
    pub fn status(mut self, input: super::types::DkimStatus) -> Self {
    ...
    /// <p><code>NOT_STARTED</code> – The DKIM verification process hasn't been initiated for the domain.</p></li>
    /// </ul>
    pub fn set_status(mut self, input: ::std::option::Option<super::types::DkimStatus>) -> Self {
        self.status = input;
        self
    }
    /// <p>Describes whether or not Amazon SES has successfully located the DKIM records in the DNS records for the domain. The status can be one of the following:</p>
    ...
    /// <p><code>NOT_STARTED</code> – The DKIM verification process hasn't been initiated for the domain.</p></li>
    /// </ul>
    pub fn get_status(&self) -> &::std::option::Option<super::types::DkimStatus> {
        &self.status
    }
    ...
    /// <p><code>AWS_SES_US_GOV_WEST_1</code> – Indicates that DKIM was configured for the identity by replicating signing attributes from a parent identity in AWS GovCloud (US-West) region using Deterministic Easy-DKIM (DEED).</p></li>
    /// </ul>
    pub fn signing_attributes_origin(mut self, input: super::types::DkimSigningAttributesOrigin) -> Self {
    ...
    /// <p><code>AWS_SES_US_GOV_WEST_1</code> – Indicates that DKIM was configured for the identity by replicating signing attributes from a parent identity in AWS GovCloud (US-West) region using Deterministic Easy-DKIM (DEED).</p></li>
    /// </ul>
    pub fn set_signing_attributes_origin(mut self, input: ::std::option::Option<super::types::DkimSigningAttributesOrigin>) -> Self {
    ...
    /// <p><code>AWS_SES_US_GOV_WEST_1</code> – Indicates that DKIM was configured for the identity by replicating signing attributes from a parent identity in AWS GovCloud (US-West) region using Deterministic Easy-DKIM (DEED).</p></li>
    /// </ul>
    pub fn get_signing_attributes_origin(&self) -> &::std::option::Option<super::types::DkimSigningAttributesOrigin> {
        &self.signing_attributes_origin
    }
    /// <p>\[Easy DKIM\] The key length of the future DKIM key pair to be generated. This can be changed at most once per day.</p>
    pub fn next_signing_key_length(mut self, input: super::types::DkimSigningKeyLength) -> Self {
        self.next_signing_key_length = ::std::option::Option::Some(input);
        self
    }
    /// <p>\[Easy DKIM\] The key length of the future DKIM key pair to be generated. This can be changed at most once per day.</p>
    pub fn set_next_signing_key_length(mut self, input: ::std::option::Option<super::types::DkimSigningKeyLength>) -> Self {
        self.next_signing_key_length = input;
        self
    }
    /// <p>\[Easy DKIM\] The key length of the future DKIM key pair to be generated. This can be changed at most once per day.</p>
    pub fn get_next_signing_key_length(&self) -> &::std::option::Option<super::types::DkimSigningKeyLength> {
        &self.next_signing_key_length
    }
    /// <p>\[Easy DKIM\] The key length of the DKIM key pair in use.</p>
    pub fn current_signing_key_length(mut self, input: super::types::DkimSigningKeyLength) -> Self {
        self.current_signing_key_length = ::std::option::Option::Some(input);
        self
    }
    /// <p>\[Easy DKIM\] The key length of the DKIM key pair in use.</p>
    pub fn set_current_signing_key_length(mut self, input: ::std::option::Option<super::types::DkimSigningKeyLength>) -> Self {
        self.current_signing_key_length = input;
        self
    }
    /// <p>\[Easy DKIM\] The key length of the DKIM key pair in use.</p>
    pub fn get_current_signing_key_length(&self) -> &::std::option::Option<super::types::DkimSigningKeyLength> {
    ...
    pub fn build(self) -> super::types::DkimAttributes {
        super::types::DkimAttributes {
