...
pub struct ExportMetric {
    ...
    /// </ul>
    pub name: ::std::option::Option<super::types::Metric>,
    ...
    /// </ul>
    pub aggregation: ::std::option::Option<super::types::MetricAggregation>,
}
impl ExportMetric {
    /// <p>The metric to export, can be one of the following:</p>
    /// <ul>
    ...
    /// <p><code>DELIVERY_COMPLAINT</code> - Successful deliveries for email sending attempts. Excludes deliveries to the mailbox simulator, for emails addressed to more than one recipient, and emails addressed to recipients hosted by ISPs with which Amazon SES does not have a feedback loop agreement.</p></li>
    /// </ul>
    pub fn name(&self) -> ::std::option::Option<&super::types::Metric> {
        self.name.as_ref()
    }
    /// <p>The aggregation to apply to a metric, can be one of the following:</p>
    /// <ul>
    ...
    /// <p><code>RATE</code> - The rate for this metric relative to the <code>SEND</code> metric volume.</p></li>
    /// </ul>
    pub fn aggregation(&self) -> ::std::option::Option<&super::types::MetricAggregation> {
        self.aggregation.as_ref()
    }
}
impl ExportMetric {
    /// Creates a new builder-style object to manufacture [`ExportMetric`](crate::types::ExportMetric).
    pub fn builder() -> super::types::builders::ExportMetricBuilder {
        super::types::builders::ExportMetricBuilder::default()
    }
}
...
pub struct ExportMetricBuilder {
    pub(crate) name: ::std::option::Option<super::types::Metric>,
    pub(crate) aggregation: ::std::option::Option<super::types::MetricAggregation>,
}
impl ExportMetricBuilder {
    ...
    /// <p><code>DELIVERY_COMPLAINT</code> - Successful deliveries for email sending attempts. Excludes deliveries to the mailbox simulator, for emails addressed to more than one recipient, and emails addressed to recipients hosted by ISPs with which Amazon SES does not have a feedback loop agreement.</p></li>
    /// </ul>
    pub fn name(mut self, input: super::types::Metric) -> Self {
    ...
    /// <p><code>DELIVERY_COMPLAINT</code> - Successful deliveries for email sending attempts. Excludes deliveries to the mailbox simulator, for emails addressed to more than one recipient, and emails addressed to recipients hosted by ISPs with which Amazon SES does not have a feedback loop agreement.</p></li>
    /// </ul>
    pub fn set_name(mut self, input: ::std::option::Option<super::types::Metric>) -> Self {
        self.name = input;
        self
    }
    /// <p>The metric to export, can be one of the following:</p>
    ...
    /// <p><code>DELIVERY_COMPLAINT</code> - Successful deliveries for email sending attempts. Excludes deliveries to the mailbox simulator, for emails addressed to more than one recipient, and emails addressed to recipients hosted by ISPs with which Amazon SES does not have a feedback loop agreement.</p></li>
    /// </ul>
    pub fn get_name(&self) -> &::std::option::Option<super::types::Metric> {
        &self.name
    }
    /// <p>The aggregation to apply to a metric, can be one of the following:</p>
    /// <ul>
    ...
    /// <p><code>RATE</code> - The rate for this metric relative to the <code>SEND</code> metric volume.</p></li>
    /// </ul>
    pub fn aggregation(mut self, input: super::types::MetricAggregation) -> Self {
    ...
    /// <p><code>RATE</code> - The rate for this metric relative to the <code>SEND</code> metric volume.</p></li>
    /// </ul>
    pub fn set_aggregation(mut self, input: ::std::option::Option<super::types::MetricAggregation>) -> Self {
    ...
    /// <p><code>RATE</code> - The rate for this metric relative to the <code>SEND</code> metric volume.</p></li>
    /// </ul>
    pub fn get_aggregation(&self) -> &::std::option::Option<super::types::MetricAggregation> {
        &self.aggregation
    }
    /// Consumes the builder and constructs a [`ExportMetric`](crate::types::ExportMetric).
    pub fn build(self) -> super::types::ExportMetric {
        super::types::ExportMetric {
            name: self.name,
