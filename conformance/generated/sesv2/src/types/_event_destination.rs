...
pub struct EventDestination {
    ...
    /// </ul>
    pub matching_event_types: ::std::vec::Vec<super::types::EventType>,
    ...
    pub kinesis_firehose_destination: ::std::option::Option<super::types::KinesisFirehoseDestination>,
    ...
    pub cloud_watch_destination: ::std::option::Option<super::types::CloudWatchDestination>,
    ...
    pub sns_destination: ::std::option::Option<super::types::SnsDestination>,
    ...
    pub event_bridge_destination: ::std::option::Option<super::types::EventBridgeDestination>,
    ...
    pub pinpoint_destination: ::std::option::Option<super::types::PinpointDestination>,
}
impl EventDestination {
    ...
    /// <p><code>SUBSCRIPTION</code> - The email was successfully delivered, but the recipient updated their subscription preferences by clicking on an <i>unsubscribe</i> link as part of your <a href="https://docs.aws.amazon.com/ses/latest/dg/sending-email-subscription-management.html">subscription management</a>.</p></li>
    /// </ul>
    pub fn matching_event_types(&self) -> &[super::types::EventType] {
        use std::ops::Deref;
        self.matching_event_types.deref()
    }
    /// <p>An object that defines an Amazon Kinesis Data Firehose destination for email events. You can use Amazon Kinesis Data Firehose to stream data to other services, such as Amazon S3 and Amazon Redshift.</p>
    pub fn kinesis_firehose_destination(&self) -> ::std::option::Option<&super::types::KinesisFirehoseDestination> {
        self.kinesis_firehose_destination.as_ref()
    }
    /// <p>An object that defines an Amazon CloudWatch destination for email events. You can use Amazon CloudWatch to monitor and gain insights on your email sending metrics.</p>
    pub fn cloud_watch_destination(&self) -> ::std::option::Option<&super::types::CloudWatchDestination> {
        self.cloud_watch_destination.as_ref()
    }
    /// <p>An object that defines an Amazon SNS destination for email events. You can use Amazon SNS to send notifications when certain email events occur.</p>
    pub fn sns_destination(&self) -> ::std::option::Option<&super::types::SnsDestination> {
        self.sns_destination.as_ref()
    }
    /// <p>An object that defines an Amazon EventBridge destination for email events. You can use Amazon EventBridge to send notifications when certain email events occur.</p>
    pub fn event_bridge_destination(&self) -> ::std::option::Option<&super::types::EventBridgeDestination> {
        self.event_bridge_destination.as_ref()
    }
    /// <p>An object that defines an Amazon Pinpoint project destination for email events. You can send email event data to a Amazon Pinpoint project to view metrics using the Transactional Messaging dashboards that are built in to Amazon Pinpoint. For more information, see <a href="https://docs.aws.amazon.com/pinpoint/latest/userguide/analytics-transactional-messages.html">Transactional Messaging Charts</a> in the <i>Amazon Pinpoint User Guide</i>.</p>
    pub fn pinpoint_destination(&self) -> ::std::option::Option<&super::types::PinpointDestination> {
...
impl EventDestination {
    ...
    pub fn builder() -> super::types::builders::EventDestinationBuilder {
        super::types::builders::EventDestinationBuilder::default()
    }
}
...
pub struct EventDestinationBuilder {
    ...
    pub(crate) matching_event_types: ::std::option::Option<::std::vec::Vec<super::types::EventType>>,
    pub(crate) kinesis_firehose_destination: ::std::option::Option<super::types::KinesisFirehoseDestination>,
    pub(crate) cloud_watch_destination: ::std::option::Option<super::types::CloudWatchDestination>,
    pub(crate) sns_destination: ::std::option::Option<super::types::SnsDestination>,
    pub(crate) event_bridge_destination: ::std::option::Option<super::types::EventBridgeDestination>,
    pub(crate) pinpoint_destination: ::std::option::Option<super::types::PinpointDestination>,
}
impl EventDestinationBuilder {
    ...
    /// <p><code>SUBSCRIPTION</code> - The email was successfully delivered, but the recipient updated their subscription preferences by clicking on an <i>unsubscribe</i> link as part of your <a href="https://docs.aws.amazon.com/ses/latest/dg/sending-email-subscription-management.html">subscription management</a>.</p></li>
    /// </ul>
    pub fn matching_event_types(mut self, input: super::types::EventType) -> Self {
    ...
    /// <p><code>SUBSCRIPTION</code> - The email was successfully delivered, but the recipient updated their subscription preferences by clicking on an <i>unsubscribe</i> link as part of your <a href="https://docs.aws.amazon.com/ses/latest/dg/sending-email-subscription-management.html">subscription management</a>.</p></li>
    /// </ul>
    pub fn set_matching_event_types(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::EventType>>) -> Self {
    ...
    /// <p><code>SUBSCRIPTION</code> - The email was successfully delivered, but the recipient updated their subscription preferences by clicking on an <i>unsubscribe</i> link as part of your <a href="https://docs.aws.amazon.com/ses/latest/dg/sending-email-subscription-management.html">subscription management</a>.</p></li>
    /// </ul>
    pub fn get_matching_event_types(&self) -> &::std::option::Option<::std::vec::Vec<super::types::EventType>> {
        &self.matching_event_types
    }
    /// <p>An object that defines an Amazon Kinesis Data Firehose destination for email events. You can use Amazon Kinesis Data Firehose to stream data to other services, such as Amazon S3 and Amazon Redshift.</p>
    pub fn kinesis_firehose_destination(mut self, input: super::types::KinesisFirehoseDestination) -> Self {
        self.kinesis_firehose_destination = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object that defines an Amazon Kinesis Data Firehose destination for email events. You can use Amazon Kinesis Data Firehose to stream data to other services, such as Amazon S3 and Amazon Redshift.</p>
    pub fn set_kinesis_firehose_destination(mut self, input: ::std::option::Option<super::types::KinesisFirehoseDestination>) -> Self {
        self.kinesis_firehose_destination = input;
        self
    }
    /// <p>An object that defines an Amazon Kinesis Data Firehose destination for email events. You can use Amazon Kinesis Data Firehose to stream data to other services, such as Amazon S3 and Amazon Redshift.</p>
    pub fn get_kinesis_firehose_destination(&self) -> &::std::option::Option<super::types::KinesisFirehoseDestination> {
        &self.kinesis_firehose_destination
    }
    /// <p>An object that defines an Amazon CloudWatch destination for email events. You can use Amazon CloudWatch to monitor and gain insights on your email sending metrics.</p>
    pub fn cloud_watch_destination(mut self, input: super::types::CloudWatchDestination) -> Self {
        self.cloud_watch_destination = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object that defines an Amazon CloudWatch destination for email events. You can use Amazon CloudWatch to monitor and gain insights on your email sending metrics.</p>
    pub fn set_cloud_watch_destination(mut self, input: ::std::option::Option<super::types::CloudWatchDestination>) -> Self {
        self.cloud_watch_destination = input;
        self
    }
    /// <p>An object that defines an Amazon CloudWatch destination for email events. You can use Amazon CloudWatch to monitor and gain insights on your email sending metrics.</p>
    pub fn get_cloud_watch_destination(&self) -> &::std::option::Option<super::types::CloudWatchDestination> {
        &self.cloud_watch_destination
    }
    /// <p>An object that defines an Amazon SNS destination for email events. You can use Amazon SNS to send notifications when certain email events occur.</p>
    pub fn sns_destination(mut self, input: super::types::SnsDestination) -> Self {
        self.sns_destination = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object that defines an Amazon SNS destination for email events. You can use Amazon SNS to send notifications when certain email events occur.</p>
    pub fn set_sns_destination(mut self, input: ::std::option::Option<super::types::SnsDestination>) -> Self {
        self.sns_destination = input;
        self
    }
    /// <p>An object that defines an Amazon SNS destination for email events. You can use Amazon SNS to send notifications when certain email events occur.</p>
    pub fn get_sns_destination(&self) -> &::std::option::Option<super::types::SnsDestination> {
        &self.sns_destination
    }
    /// <p>An object that defines an Amazon EventBridge destination for email events. You can use Amazon EventBridge to send notifications when certain email events occur.</p>
    pub fn event_bridge_destination(mut self, input: super::types::EventBridgeDestination) -> Self {
        self.event_bridge_destination = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object that defines an Amazon EventBridge destination for email events. You can use Amazon EventBridge to send notifications when certain email events occur.</p>
    pub fn set_event_bridge_destination(mut self, input: ::std::option::Option<super::types::EventBridgeDestination>) -> Self {
        self.event_bridge_destination = input;
        self
    }
    /// <p>An object that defines an Amazon EventBridge destination for email events. You can use Amazon EventBridge to send notifications when certain email events occur.</p>
    pub fn get_event_bridge_destination(&self) -> &::std::option::Option<super::types::EventBridgeDestination> {
        &self.event_bridge_destination
    }
    /// <p>An object that defines an Amazon Pinpoint project destination for email events. You can send email event data to a Amazon Pinpoint project to view metrics using the Transactional Messaging dashboards that are built in to Amazon Pinpoint. For more information, see <a href="https://docs.aws.amazon.com/pinpoint/latest/userguide/analytics-transactional-messages.html">Transactional Messaging Charts</a> in the <i>Amazon Pinpoint User Guide</i>.</p>
    pub fn pinpoint_destination(mut self, input: super::types::PinpointDestination) -> Self {
        self.pinpoint_destination = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object that defines an Amazon Pinpoint project destination for email events. You can send email event data to a Amazon Pinpoint project to view metrics using the Transactional Messaging dashboards that are built in to Amazon Pinpoint. For more information, see <a href="https://docs.aws.amazon.com/pinpoint/latest/userguide/analytics-transactional-messages.html">Transactional Messaging Charts</a> in the <i>Amazon Pinpoint User Guide</i>.</p>
    pub fn set_pinpoint_destination(mut self, input: ::std::option::Option<super::types::PinpointDestination>) -> Self {
        self.pinpoint_destination = input;
        self
    }
    /// <p>An object that defines an Amazon Pinpoint project destination for email events. You can send email event data to a Amazon Pinpoint project to view metrics using the Transactional Messaging dashboards that are built in to Amazon Pinpoint. For more information, see <a href="https://docs.aws.amazon.com/pinpoint/latest/userguide/analytics-transactional-messages.html">Transactional Messaging Charts</a> in the <i>Amazon Pinpoint User Guide</i>.</p>
    pub fn get_pinpoint_destination(&self) -> &::std::option::Option<super::types::PinpointDestination> {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::EventDestination, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::EventDestination {
