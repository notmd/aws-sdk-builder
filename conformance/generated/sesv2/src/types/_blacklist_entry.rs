...
impl BlacklistEntry {
    ...
    pub fn builder() -> super::types::builders::BlacklistEntryBuilder {
        super::types::builders::BlacklistEntryBuilder::default()
    }
}
...
impl BlacklistEntryBuilder {
    ...
    pub fn build(self) -> super::types::BlacklistEntry {
        super::types::BlacklistEntry {
