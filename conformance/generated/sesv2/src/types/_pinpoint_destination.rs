...
impl PinpointDestination {
    ...
    pub fn builder() -> super::types::builders::PinpointDestinationBuilder {
        super::types::builders::PinpointDestinationBuilder::default()
    }
}
...
impl PinpointDestinationBuilder {
    ...
    pub fn build(self) -> super::types::PinpointDestination {
        super::types::PinpointDestination {
