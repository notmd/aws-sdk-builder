...
pub struct ReputationEntity {
    ...
    pub reputation_entity_type: ::std::option::Option<super::types::ReputationEntityType>,
    ...
    pub customer_managed_status: ::std::option::Option<super::types::StatusRecord>,
    ...
    pub aws_ses_managed_status: ::std::option::Option<super::types::StatusRecord>,
    ...
    pub sending_status_aggregate: ::std::option::Option<super::types::SendingStatus>,
    ...
    pub reputation_impact: ::std::option::Option<super::types::RecommendationImpact>,
}
impl ReputationEntity {
    ...
    /// <p>The type of reputation entity. Currently, only <code>RESOURCE</code> type entities are supported.</p>
    pub fn reputation_entity_type(&self) -> ::std::option::Option<&super::types::ReputationEntityType> {
    ...
    /// <p>The customer-managed status record for this reputation entity, including the current status, cause description, and last updated timestamp.</p>
    pub fn customer_managed_status(&self) -> ::std::option::Option<&super::types::StatusRecord> {
        self.customer_managed_status.as_ref()
    }
    /// <p>The Amazon Web Services Amazon SES-managed status record for this reputation entity, including the current status, cause description, and last updated timestamp.</p>
    pub fn aws_ses_managed_status(&self) -> ::std::option::Option<&super::types::StatusRecord> {
        self.aws_ses_managed_status.as_ref()
    }
    /// <p>The aggregate sending status that determines whether the entity is allowed to send emails. This status is derived from both the customer-managed and Amazon Web Services Amazon SES-managed statuses. If either the customer-managed status or the Amazon Web Services Amazon SES-managed status is <code>DISABLED</code>, the aggregate status will be <code>DISABLED</code> and the entity will not be allowed to send emails. When the customer-managed status is set to <code>REINSTATED</code>, the entity can continue sending even if there are active reputation findings, provided the Amazon Web Services Amazon SES-managed status also permits sending. The entity can only send emails when both statuses permit sending.</p>
    pub fn sending_status_aggregate(&self) -> ::std::option::Option<&super::types::SendingStatus> {
        self.sending_status_aggregate.as_ref()
    }
    /// <p>The reputation impact level for this entity, representing the highest impact reputation finding currently active. Reputation findings can be retrieved using the <code>ListRecommendations</code> operation.</p>
    pub fn reputation_impact(&self) -> ::std::option::Option<&super::types::RecommendationImpact> {
...
impl ReputationEntity {
    ...
    pub fn builder() -> super::types::builders::ReputationEntityBuilder {
        super::types::builders::ReputationEntityBuilder::default()
    }
}
...
pub struct ReputationEntityBuilder {
    ...
    pub(crate) reputation_entity_type: ::std::option::Option<super::types::ReputationEntityType>,
    pub(crate) reputation_management_policy: ::std::option::Option<::std::string::String>,
    pub(crate) customer_managed_status: ::std::option::Option<super::types::StatusRecord>,
    pub(crate) aws_ses_managed_status: ::std::option::Option<super::types::StatusRecord>,
    pub(crate) sending_status_aggregate: ::std::option::Option<super::types::SendingStatus>,
    pub(crate) reputation_impact: ::std::option::Option<super::types::RecommendationImpact>,
}
impl ReputationEntityBuilder {
    ...
    /// <p>The type of reputation entity. Currently, only <code>RESOURCE</code> type entities are supported.</p>
    pub fn reputation_entity_type(mut self, input: super::types::ReputationEntityType) -> Self {
        self.reputation_entity_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The type of reputation entity. Currently, only <code>RESOURCE</code> type entities are supported.</p>
    pub fn set_reputation_entity_type(mut self, input: ::std::option::Option<super::types::ReputationEntityType>) -> Self {
        self.reputation_entity_type = input;
        self
    }
    /// <p>The type of reputation entity. Currently, only <code>RESOURCE</code> type entities are supported.</p>
    pub fn get_reputation_entity_type(&self) -> &::std::option::Option<super::types::ReputationEntityType> {
    ...
    /// <p>The customer-managed status record for this reputation entity, including the current status, cause description, and last updated timestamp.</p>
    pub fn customer_managed_status(mut self, input: super::types::StatusRecord) -> Self {
        self.customer_managed_status = ::std::option::Option::Some(input);
        self
    }
    /// <p>The customer-managed status record for this reputation entity, including the current status, cause description, and last updated timestamp.</p>
    pub fn set_customer_managed_status(mut self, input: ::std::option::Option<super::types::StatusRecord>) -> Self {
        self.customer_managed_status = input;
        self
    }
    /// <p>The customer-managed status record for this reputation entity, including the current status, cause description, and last updated timestamp.</p>
    pub fn get_customer_managed_status(&self) -> &::std::option::Option<super::types::StatusRecord> {
        &self.customer_managed_status
    }
    /// <p>The Amazon Web Services Amazon SES-managed status record for this reputation entity, including the current status, cause description, and last updated timestamp.</p>
    pub fn aws_ses_managed_status(mut self, input: super::types::StatusRecord) -> Self {
        self.aws_ses_managed_status = ::std::option::Option::Some(input);
        self
    }
    /// <p>The Amazon Web Services Amazon SES-managed status record for this reputation entity, including the current status, cause description, and last updated timestamp.</p>
    pub fn set_aws_ses_managed_status(mut self, input: ::std::option::Option<super::types::StatusRecord>) -> Self {
        self.aws_ses_managed_status = input;
        self
    }
    /// <p>The Amazon Web Services Amazon SES-managed status record for this reputation entity, including the current status, cause description, and last updated timestamp.</p>
    pub fn get_aws_ses_managed_status(&self) -> &::std::option::Option<super::types::StatusRecord> {
        &self.aws_ses_managed_status
    }
    /// <p>The aggregate sending status that determines whether the entity is allowed to send emails. This status is derived from both the customer-managed and Amazon Web Services Amazon SES-managed statuses. If either the customer-managed status or the Amazon Web Services Amazon SES-managed status is <code>DISABLED</code>, the aggregate status will be <code>DISABLED</code> and the entity will not be allowed to send emails. When the customer-managed status is set to <code>REINSTATED</code>, the entity can continue sending even if there are active reputation findings, provided the Amazon Web Services Amazon SES-managed status also permits sending. The entity can only send emails when both statuses permit sending.</p>
    pub fn sending_status_aggregate(mut self, input: super::types::SendingStatus) -> Self {
        self.sending_status_aggregate = ::std::option::Option::Some(input);
        self
    }
    /// <p>The aggregate sending status that determines whether the entity is allowed to send emails. This status is derived from both the customer-managed and Amazon Web Services Amazon SES-managed statuses. If either the customer-managed status or the Amazon Web Services Amazon SES-managed status is <code>DISABLED</code>, the aggregate status will be <code>DISABLED</code> and the entity will not be allowed to send emails. When the customer-managed status is set to <code>REINSTATED</code>, the entity can continue sending even if there are active reputation findings, provided the Amazon Web Services Amazon SES-managed status also permits sending. The entity can only send emails when both statuses permit sending.</p>
    pub fn set_sending_status_aggregate(mut self, input: ::std::option::Option<super::types::SendingStatus>) -> Self {
        self.sending_status_aggregate = input;
        self
    }
    /// <p>The aggregate sending status that determines whether the entity is allowed to send emails. This status is derived from both the customer-managed and Amazon Web Services Amazon SES-managed statuses. If either the customer-managed status or the Amazon Web Services Amazon SES-managed status is <code>DISABLED</code>, the aggregate status will be <code>DISABLED</code> and the entity will not be allowed to send emails. When the customer-managed status is set to <code>REINSTATED</code>, the entity can continue sending even if there are active reputation findings, provided the Amazon Web Services Amazon SES-managed status also permits sending. The entity can only send emails when both statuses permit sending.</p>
    pub fn get_sending_status_aggregate(&self) -> &::std::option::Option<super::types::SendingStatus> {
        &self.sending_status_aggregate
    }
    /// <p>The reputation impact level for this entity, representing the highest impact reputation finding currently active. Reputation findings can be retrieved using the <code>ListRecommendations</code> operation.</p>
    pub fn reputation_impact(mut self, input: super::types::RecommendationImpact) -> Self {
        self.reputation_impact = ::std::option::Option::Some(input);
        self
    }
    /// <p>The reputation impact level for this entity, representing the highest impact reputation finding currently active. Reputation findings can be retrieved using the <code>ListRecommendations</code> operation.</p>
    pub fn set_reputation_impact(mut self, input: ::std::option::Option<super::types::RecommendationImpact>) -> Self {
        self.reputation_impact = input;
        self
    }
    /// <p>The reputation impact level for this entity, representing the highest impact reputation finding currently active. Reputation findings can be retrieved using the <code>ListRecommendations</code> operation.</p>
    pub fn get_reputation_impact(&self) -> &::std::option::Option<super::types::RecommendationImpact> {
        &self.reputation_impact
    }
    /// Consumes the builder and constructs a [`ReputationEntity`](crate::types::ReputationEntity).
    pub fn build(self) -> super::types::ReputationEntity {
        super::types::ReputationEntity {
