...
impl ListManagementOptions {
    ...
    pub fn builder() -> super::types::builders::ListManagementOptionsBuilder {
        super::types::builders::ListManagementOptionsBuilder::default()
    }
}
...
impl ListManagementOptionsBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::ListManagementOptions, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ListManagementOptions {
