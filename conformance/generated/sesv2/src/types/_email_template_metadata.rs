...
impl EmailTemplateMetadata {
    ...
    pub fn builder() -> super::types::builders::EmailTemplateMetadataBuilder {
        super::types::builders::EmailTemplateMetadataBuilder::default()
    }
}
...
impl EmailTemplateMetadataBuilder {
    ...
    pub fn build(self) -> super::types::EmailTemplateMetadata {
        super::types::EmailTemplateMetadata {
