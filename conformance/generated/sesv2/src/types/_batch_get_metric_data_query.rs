...
pub struct BatchGetMetricDataQuery {
    ...
    pub namespace: super::types::MetricNamespace,
    ...
    pub dimensions: ::std::option::Option<::std::collections::HashMap<super::types::MetricDimensionName, ::std::string::String>>,
...
impl BatchGetMetricDataQuery {
    ...
    /// <p>The query namespace - e.g. <code>VDM</code></p>
    pub fn namespace(&self) -> &super::types::MetricNamespace {
        &self.namespace
    }
    /// <p>The queried metric. This can be one of the following:</p>
    /// <ul>
    ...
    /// <p><code>DELIVERY_COMPLAINT</code> – Successful deliveries for email sending attempts. Excludes deliveries to the mailbox simulator, for emails addressed to more than one recipient, and emails addressed to recipients hosted by ISPs with which Amazon SES does not have a feedback loop agreement.</p></li>
    /// </ul>
    pub fn metric(&self) -> &super::types::Metric {
        &self.metric
    }
    /// <p>An object that contains mapping between <code>MetricDimensionName</code> and <code>MetricDimensionValue</code> to filter metrics by.</p>
    pub fn dimensions(&self) -> ::std::option::Option<&::std::collections::HashMap<super::types::MetricDimensionName, ::std::string::String>> {
...
impl BatchGetMetricDataQuery {
    ...
    pub fn builder() -> super::types::builders::BatchGetMetricDataQueryBuilder {
        super::types::builders::BatchGetMetricDataQueryBuilder::default()
    }
}
...
pub struct BatchGetMetricDataQueryBuilder {
    ...
    pub(crate) namespace: ::std::option::Option<super::types::MetricNamespace>,
    pub(crate) metric: ::std::option::Option<super::types::Metric>,
    pub(crate) dimensions: ::std::option::Option<::std::collections::HashMap<super::types::MetricDimensionName, ::std::string::String>>,
...
impl BatchGetMetricDataQueryBuilder {
    ...
    /// <p>The query namespace - e.g. <code>VDM</code></p>
    /// This field is required.
    pub fn namespace(mut self, input: super::types::MetricNamespace) -> Self {
        self.namespace = ::std::option::Option::Some(input);
        self
    }
    /// <p>The query namespace - e.g. <code>VDM</code></p>
    pub fn set_namespace(mut self, input: ::std::option::Option<super::types::MetricNamespace>) -> Self {
        self.namespace = input;
        self
    }
    /// <p>The query namespace - e.g. <code>VDM</code></p>
    pub fn get_namespace(&self) -> &::std::option::Option<super::types::MetricNamespace> {
        &self.namespace
    }
    /// <p>The queried metric. This can be one of the following:</p>
    /// <ul>
    ...
    /// </ul>
    /// This field is required.
    pub fn metric(mut self, input: super::types::Metric) -> Self {
    ...
    /// <p><code>DELIVERY_COMPLAINT</code> – Successful deliveries for email sending attempts. Excludes deliveries to the mailbox simulator, for emails addressed to more than one recipient, and emails addressed to recipients hosted by ISPs with which Amazon SES does not have a feedback loop agreement.</p></li>
    /// </ul>
    pub fn set_metric(mut self, input: ::std::option::Option<super::types::Metric>) -> Self {
        self.metric = input;
        self
    }
    /// <p>The queried metric. This can be one of the following:</p>
    ...
    /// <p><code>DELIVERY_COMPLAINT</code> – Successful deliveries for email sending attempts. Excludes deliveries to the mailbox simulator, for emails addressed to more than one recipient, and emails addressed to recipients hosted by ISPs with which Amazon SES does not have a feedback loop agreement.</p></li>
    /// </ul>
    pub fn get_metric(&self) -> &::std::option::Option<super::types::Metric> {
        &self.metric
    }
    ...
    ///
    /// <p>An object that contains mapping between <code>MetricDimensionName</code> and <code>MetricDimensionValue</code> to filter metrics by.</p>
    pub fn dimensions(mut self, k: super::types::MetricDimensionName, v: impl ::std::convert::Into<::std::string::String>) -> Self {
    ...
    pub fn set_dimensions(
        mut self,
        input: ::std::option::Option<::std::collections::HashMap<super::types::MetricDimensionName, ::std::string::String>>,
    ) -> Self {
        self.dimensions = input;
        self
    }
    /// <p>An object that contains mapping between <code>MetricDimensionName</code> and <code>MetricDimensionValue</code> to filter metrics by.</p>
    pub fn get_dimensions(&self) -> &::std::option::Option<::std::collections::HashMap<super::types::MetricDimensionName, ::std::string::String>> {
        &self.dimensions
    }
    /// <p>Represents the start date for the query interval.</p>
    /// This field is required.
    ...
    pub fn build(self) -> ::std::result::Result<super::types::BatchGetMetricDataQuery, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::BatchGetMetricDataQuery {
