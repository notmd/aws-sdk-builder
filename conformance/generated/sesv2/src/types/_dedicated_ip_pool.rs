...
pub struct DedicatedIpPool {
    ...
    /// </ul>
    pub scaling_mode: super::types::ScalingMode,
}
impl DedicatedIpPool {
    ...
    /// <p><code>MANAGED</code> – A dedicated IP pool where the reputation and number of IPs are automatically managed by Amazon SES.</p></li>
    /// </ul>
    pub fn scaling_mode(&self) -> &super::types::ScalingMode {
        &self.scaling_mode
    }
}
impl DedicatedIpPool {
    /// Creates a new builder-style object to manufacture [`DedicatedIpPool`](crate::types::DedicatedIpPool).
    pub fn builder() -> super::types::builders::DedicatedIpPoolBuilder {
        super::types::builders::DedicatedIpPoolBuilder::default()
    }
}
...
impl DedicatedIpPoolBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::DedicatedIpPool, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::DedicatedIpPool {
