...
pub struct EmailInsights {
    ...
    pub events: ::std::option::Option<::std::vec::Vec<super::types::InsightsEvent>>,
}
impl EmailInsights {
    /// <p>The recipient of the email.</p>
    ...
    pub fn events(&self) -> &[super::types::InsightsEvent] {
...
impl EmailInsights {
    ...
    pub fn builder() -> super::types::builders::EmailInsightsBuilder {
        super::types::builders::EmailInsightsBuilder::default()
    }
}
...
pub struct EmailInsightsBuilder {
    ...
    pub(crate) events: ::std::option::Option<::std::vec::Vec<super::types::InsightsEvent>>,
}
impl EmailInsightsBuilder {
    ...
    ///
    /// <p>A list of events associated with the sent email.</p>
    pub fn events(mut self, input: super::types::InsightsEvent) -> Self {
    ...
    /// <p>A list of events associated with the sent email.</p>
    pub fn set_events(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::InsightsEvent>>) -> Self {
        self.events = input;
        self
    }
    /// <p>A list of events associated with the sent email.</p>
    pub fn get_events(&self) -> &::std::option::Option<::std::vec::Vec<super::types::InsightsEvent>> {
        &self.events
    }
    /// Consumes the builder and constructs a [`EmailInsights`](crate::types::EmailInsights).
    pub fn build(self) -> super::types::EmailInsights {
        super::types::EmailInsights {
