...
pub struct AccountDetails {
    ...
    /// </ul>
    pub mail_type: ::std::option::Option<super::types::MailType>,
    ...
    pub contact_language: ::std::option::Option<super::types::ContactLanguage>,
    ...
    pub review_details: ::std::option::Option<super::types::ReviewDetails>,
}
impl AccountDetails {
    /// <p>The type of email your account is sending. The mail type can be one of the following:</p>
    /// <ul>
    ...
    /// <p><code>TRANSACTIONAL</code> – Most of your sending traffic is to communicate during a transaction with a customer.</p></li>
    /// </ul>
    pub fn mail_type(&self) -> ::std::option::Option<&super::types::MailType> {
    ...
    /// <p>The language you would prefer for the case. The contact language can be one of <code>ENGLISH</code> or <code>JAPANESE</code>.</p>
    pub fn contact_language(&self) -> ::std::option::Option<&super::types::ContactLanguage> {
    ...
    /// <p>Information about the review of the latest details you submitted.</p>
    pub fn review_details(&self) -> ::std::option::Option<&super::types::ReviewDetails> {
...
impl AccountDetails {
    ...
    pub fn builder() -> super::types::builders::AccountDetailsBuilder {
        super::types::builders::AccountDetailsBuilder::default()
    }
}
...
pub struct AccountDetailsBuilder {
    pub(crate) mail_type: ::std::option::Option<super::types::MailType>,
    pub(crate) website_url: ::std::option::Option<::std::string::String>,
    pub(crate) contact_language: ::std::option::Option<super::types::ContactLanguage>,
    ...
    pub(crate) review_details: ::std::option::Option<super::types::ReviewDetails>,
}
impl AccountDetailsBuilder {
    ...
    /// <p><code>TRANSACTIONAL</code> – Most of your sending traffic is to communicate during a transaction with a customer.</p></li>
    /// </ul>
    pub fn mail_type(mut self, input: super::types::MailType) -> Self {
    ...
    /// <p><code>TRANSACTIONAL</code> – Most of your sending traffic is to communicate during a transaction with a customer.</p></li>
    /// </ul>
    pub fn set_mail_type(mut self, input: ::std::option::Option<super::types::MailType>) -> Self {
    ...
    /// <p><code>TRANSACTIONAL</code> – Most of your sending traffic is to communicate during a transaction with a customer.</p></li>
    /// </ul>
    pub fn get_mail_type(&self) -> &::std::option::Option<super::types::MailType> {
        &self.mail_type
    }
    /// <p>The URL of your website. This information helps us better understand the type of content that you plan to send.</p>
    ...
    /// <p>The language you would prefer for the case. The contact language can be one of <code>ENGLISH</code> or <code>JAPANESE</code>.</p>
    pub fn contact_language(mut self, input: super::types::ContactLanguage) -> Self {
        self.contact_language = ::std::option::Option::Some(input);
        self
    }
    /// <p>The language you would prefer for the case. The contact language can be one of <code>ENGLISH</code> or <code>JAPANESE</code>.</p>
    pub fn set_contact_language(mut self, input: ::std::option::Option<super::types::ContactLanguage>) -> Self {
        self.contact_language = input;
        self
    }
    /// <p>The language you would prefer for the case. The contact language can be one of <code>ENGLISH</code> or <code>JAPANESE</code>.</p>
    pub fn get_contact_language(&self) -> &::std::option::Option<super::types::ContactLanguage> {
    ...
    /// <p>Information about the review of the latest details you submitted.</p>
    pub fn review_details(mut self, input: super::types::ReviewDetails) -> Self {
        self.review_details = ::std::option::Option::Some(input);
        self
    }
    /// <p>Information about the review of the latest details you submitted.</p>
    pub fn set_review_details(mut self, input: ::std::option::Option<super::types::ReviewDetails>) -> Self {
        self.review_details = input;
        self
    }
    /// <p>Information about the review of the latest details you submitted.</p>
    pub fn get_review_details(&self) -> &::std::option::Option<super::types::ReviewDetails> {
        &self.review_details
    }
    /// Consumes the builder and constructs a [`AccountDetails`](crate::types::AccountDetails).
    pub fn build(self) -> super::types::AccountDetails {
        super::types::AccountDetails {
