...
impl DomainIspPlacement {
    ...
    pub fn builder() -> super::types::builders::DomainIspPlacementBuilder {
        super::types::builders::DomainIspPlacementBuilder::default()
    }
}
...
impl DomainIspPlacementBuilder {
    ...
    pub fn build(self) -> super::types::DomainIspPlacement {
        super::types::DomainIspPlacement {
