...
pub struct EventDestinationDefinition {
    ...
    pub matching_event_types: ::std::option::Option<::std::vec::Vec<super::types::EventType>>,
...
impl EventDestinationDefinition {
    ...
    pub fn builder() -> super::types::builders::EventDestinationDefinitionBuilder {
        super::types::builders::EventDestinationDefinitionBuilder::default()
    }
}
...
impl EventDestinationDefinitionBuilder {
    ...
    pub fn build(self) -> super::types::EventDestinationDefinition {
        super::types::EventDestinationDefinition {
