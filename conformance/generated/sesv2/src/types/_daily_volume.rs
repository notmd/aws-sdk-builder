...
impl DailyVolume {
    ...
    pub fn builder() -> super::types::builders::DailyVolumeBuilder {
        super::types::builders::DailyVolumeBuilder::default()
    }
}
...
impl DailyVolumeBuilder {
    ...
    pub fn build(self) -> super::types::DailyVolume {
        super::types::DailyVolume {
