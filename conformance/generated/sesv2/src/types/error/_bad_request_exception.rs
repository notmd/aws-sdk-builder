...
impl ::aws_types::request_id::RequestId for super::types::error::BadRequestException {
...
impl BadRequestException {
    ...
    pub fn builder() -> super::types::error::builders::BadRequestExceptionBuilder {
        super::types::error::builders::BadRequestExceptionBuilder::default()
    }
}
...
impl BadRequestExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::BadRequestException {
        super::types::error::BadRequestException {
