...
impl ::aws_types::request_id::RequestId for super::types::error::MailFromDomainNotVerifiedException {
...
impl MailFromDomainNotVerifiedException {
    ...
    pub fn builder() -> super::types::error::builders::MailFromDomainNotVerifiedExceptionBuilder {
        super::types::error::builders::MailFromDomainNotVerifiedExceptionBuilder::default()
    }
}
...
impl MailFromDomainNotVerifiedExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::MailFromDomainNotVerifiedException {
        super::types::error::MailFromDomainNotVerifiedException {
