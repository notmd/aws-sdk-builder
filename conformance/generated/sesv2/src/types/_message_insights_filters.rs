...
pub struct MessageInsightsFilters {
    ...
    pub last_delivery_event: ::std::option::Option<::std::vec::Vec<super::types::DeliveryEventType>>,
    ...
    pub last_engagement_event: ::std::option::Option<::std::vec::Vec<super::types::EngagementEventType>>,
}
impl MessageInsightsFilters {
    ...
    pub fn last_delivery_event(&self) -> &[super::types::DeliveryEventType] {
    ...
    pub fn last_engagement_event(&self) -> &[super::types::EngagementEventType] {
...
impl MessageInsightsFilters {
    ...
    pub fn builder() -> super::types::builders::MessageInsightsFiltersBuilder {
        super::types::builders::MessageInsightsFiltersBuilder::default()
    }
}
...
pub struct MessageInsightsFiltersBuilder {
    ...
    pub(crate) last_delivery_event: ::std::option::Option<::std::vec::Vec<super::types::DeliveryEventType>>,
    pub(crate) last_engagement_event: ::std::option::Option<::std::vec::Vec<super::types::EngagementEventType>>,
}
impl MessageInsightsFiltersBuilder {
    ...
    ///
    /// <p>The last delivery-related event for the email, where the ordering is as follows: <code>SEND</code> &lt; <code>BOUNCE</code> &lt; <code>DELIVERY</code> &lt; <code>COMPLAINT</code>.</p>
    pub fn last_delivery_event(mut self, input: super::types::DeliveryEventType) -> Self {
    ...
    /// <p>The last delivery-related event for the email, where the ordering is as follows: <code>SEND</code> &lt; <code>BOUNCE</code> &lt; <code>DELIVERY</code> &lt; <code>COMPLAINT</code>.</p>
    pub fn set_last_delivery_event(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::DeliveryEventType>>) -> Self {
        self.last_delivery_event = input;
        self
    }
    /// <p>The last delivery-related event for the email, where the ordering is as follows: <code>SEND</code> &lt; <code>BOUNCE</code> &lt; <code>DELIVERY</code> &lt; <code>COMPLAINT</code>.</p>
    pub fn get_last_delivery_event(&self) -> &::std::option::Option<::std::vec::Vec<super::types::DeliveryEventType>> {
    ...
    /// <p>The last engagement-related event for the email, where the ordering is as follows: <code>OPEN</code> &lt; <code>CLICK</code>.</p>
    /// <p>Engagement events are only available if <a href="https://docs.aws.amazon.com/ses/latest/dg/vdm-settings.html">Engagement tracking</a> is enabled.</p>
    pub fn last_engagement_event(mut self, input: super::types::EngagementEventType) -> Self {
    ...
    /// <p>The last engagement-related event for the email, where the ordering is as follows: <code>OPEN</code> &lt; <code>CLICK</code>.</p>
    /// <p>Engagement events are only available if <a href="https://docs.aws.amazon.com/ses/latest/dg/vdm-settings.html">Engagement tracking</a> is enabled.</p>
    pub fn set_last_engagement_event(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::EngagementEventType>>) -> Self {
        self.last_engagement_event = input;
        self
    }
    /// <p>The last engagement-related event for the email, where the ordering is as follows: <code>OPEN</code> &lt; <code>CLICK</code>.</p>
    /// <p>Engagement events are only available if <a href="https://docs.aws.amazon.com/ses/latest/dg/vdm-settings.html">Engagement tracking</a> is enabled.</p>
    pub fn get_last_engagement_event(&self) -> &::std::option::Option<::std::vec::Vec<super::types::EngagementEventType>> {
    ...
    pub fn build(self) -> super::types::MessageInsightsFilters {
        super::types::MessageInsightsFilters {
