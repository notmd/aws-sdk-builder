...
impl SuppressedDestinationSummary {
    ...
    pub fn builder() -> super::types::builders::SuppressedDestinationSummaryBuilder {
        super::types::builders::SuppressedDestinationSummaryBuilder::default()
    }
}
...
impl SuppressedDestinationSummaryBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::SuppressedDestinationSummary, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::SuppressedDestinationSummary {
