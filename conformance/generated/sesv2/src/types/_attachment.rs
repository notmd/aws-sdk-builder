...
pub struct Attachment {
    ...
    pub content_disposition: ::std::option::Option<super::types::AttachmentContentDisposition>,
    ...
    pub content_transfer_encoding: ::std::option::Option<super::types::AttachmentContentTransferEncoding>,
...
impl Attachment {
    ...
    /// <p>A standard descriptor indicating how the attachment should be rendered in the email. Supported values: <code>ATTACHMENT</code> or <code>INLINE</code>.</p>
    pub fn content_disposition(&self) -> ::std::option::Option<&super::types::AttachmentContentDisposition> {
    ...
    /// <p>Specifies how the attachment is encoded. Supported values: <code>BASE64</code>, <code>QUOTED_PRINTABLE</code>, <code>SEVEN_BIT</code>.</p>
    pub fn content_transfer_encoding(&self) -> ::std::option::Option<&super::types::AttachmentContentTransferEncoding> {
...
impl Attachment {
    ...
    pub fn builder() -> super::types::builders::AttachmentBuilder {
        super::types::builders::AttachmentBuilder::default()
    }
}
...
pub struct AttachmentBuilder {
    ...
    pub(crate) content_disposition: ::std::option::Option<super::types::AttachmentContentDisposition>,
    ...
    pub(crate) content_transfer_encoding: ::std::option::Option<super::types::AttachmentContentTransferEncoding>,
...
impl AttachmentBuilder {
    ...
    /// <p>A standard descriptor indicating how the attachment should be rendered in the email. Supported values: <code>ATTACHMENT</code> or <code>INLINE</code>.</p>
    pub fn content_disposition(mut self, input: super::types::AttachmentContentDisposition) -> Self {
        self.content_disposition = ::std::option::Option::Some(input);
        self
    }
    /// <p>A standard descriptor indicating how the attachment should be rendered in the email. Supported values: <code>ATTACHMENT</code> or <code>INLINE</code>.</p>
    pub fn set_content_disposition(mut self, input: ::std::option::Option<super::types::AttachmentContentDisposition>) -> Self {
        self.content_disposition = input;
        self
    }
    /// <p>A standard descriptor indicating how the attachment should be rendered in the email. Supported values: <code>ATTACHMENT</code> or <code>INLINE</code>.</p>
    pub fn get_content_disposition(&self) -> &::std::option::Option<super::types::AttachmentContentDisposition> {
    ...
    /// <p>Specifies how the attachment is encoded. Supported values: <code>BASE64</code>, <code>QUOTED_PRINTABLE</code>, <code>SEVEN_BIT</code>.</p>
    pub fn content_transfer_encoding(mut self, input: super::types::AttachmentContentTransferEncoding) -> Self {
        self.content_transfer_encoding = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies how the attachment is encoded. Supported values: <code>BASE64</code>, <code>QUOTED_PRINTABLE</code>, <code>SEVEN_BIT</code>.</p>
    pub fn set_content_transfer_encoding(mut self, input: ::std::option::Option<super::types::AttachmentContentTransferEncoding>) -> Self {
        self.content_transfer_encoding = input;
        self
    }
    /// <p>Specifies how the attachment is encoded. Supported values: <code>BASE64</code>, <code>QUOTED_PRINTABLE</code>, <code>SEVEN_BIT</code>.</p>
    pub fn get_content_transfer_encoding(&self) -> &::std::option::Option<super::types::AttachmentContentTransferEncoding> {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::Attachment, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::Attachment {
