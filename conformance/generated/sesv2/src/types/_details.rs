...
pub struct Details {
    ...
    pub routes_details: ::std::vec::Vec<super::types::RouteDetails>,
}
impl Details {
    /// <p>A list of route configuration details. Must contain exactly one route configuration.</p>
    pub fn routes_details(&self) -> &[super::types::RouteDetails] {
        use std::ops::Deref;
...
impl Details {
    ...
    pub fn builder() -> super::types::builders::DetailsBuilder {
        super::types::builders::DetailsBuilder::default()
    }
}
...
pub struct DetailsBuilder {
    pub(crate) routes_details: ::std::option::Option<::std::vec::Vec<super::types::RouteDetails>>,
}
impl DetailsBuilder {
    ...
    ///
    /// <p>A list of route configuration details. Must contain exactly one route configuration.</p>
    pub fn routes_details(mut self, input: super::types::RouteDetails) -> Self {
    ...
    /// <p>A list of route configuration details. Must contain exactly one route configuration.</p>
    pub fn set_routes_details(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::RouteDetails>>) -> Self {
        self.routes_details = input;
        self
    }
    /// <p>A list of route configuration details. Must contain exactly one route configuration.</p>
    pub fn get_routes_details(&self) -> &::std::option::Option<::std::vec::Vec<super::types::RouteDetails>> {
        &self.routes_details
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::types::Details, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::Details {
