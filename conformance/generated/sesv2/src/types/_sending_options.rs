...
impl SendingOptions {
    ...
    pub fn builder() -> super::types::builders::SendingOptionsBuilder {
        super::types::builders::SendingOptionsBuilder::default()
    }
}
...
impl SendingOptionsBuilder {
    ...
    pub fn build(self) -> super::types::SendingOptions {
        super::types::SendingOptions {
