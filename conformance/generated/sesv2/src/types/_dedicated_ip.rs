...
pub struct DedicatedIp {
    ...
    /// </ul>
    pub warmup_status: super::types::WarmupStatus,
...
impl DedicatedIp {
    ...
    /// <p><code>NOT_APPLICABLE</code> – The warm-up status doesn't apply to this IP address. This status is used for IP addresses in managed dedicated IP pools, where Amazon SES automatically handles the warm-up process.</p></li>
    /// </ul>
    pub fn warmup_status(&self) -> &super::types::WarmupStatus {
        &self.warmup_status
    }
    /// <p>Indicates the progress of your dedicated IP warm-up:</p>
    /// <ul>
...
impl DedicatedIp {
    ...
    pub fn builder() -> super::types::builders::DedicatedIpBuilder {
        super::types::builders::DedicatedIpBuilder::default()
    }
}
...
pub struct DedicatedIpBuilder {
    ...
    pub(crate) warmup_status: ::std::option::Option<super::types::WarmupStatus>,
...
impl DedicatedIpBuilder {
    ...
    /// </ul>
    /// This field is required.
    pub fn warmup_status(mut self, input: super::types::WarmupStatus) -> Self {
    ...
    /// <p><code>NOT_APPLICABLE</code> – The warm-up status doesn't apply to this IP address. This status is used for IP addresses in managed dedicated IP pools, where Amazon SES automatically handles the warm-up process.</p></li>
    /// </ul>
    pub fn set_warmup_status(mut self, input: ::std::option::Option<super::types::WarmupStatus>) -> Self {
    ...
    /// <p><code>NOT_APPLICABLE</code> – The warm-up status doesn't apply to this IP address. This status is used for IP addresses in managed dedicated IP pools, where Amazon SES automatically handles the warm-up process.</p></li>
    /// </ul>
    pub fn get_warmup_status(&self) -> &::std::option::Option<super::types::WarmupStatus> {
        &self.warmup_status
    }
    /// <p>Indicates the progress of your dedicated IP warm-up:</p>
    /// <ul>
    ...
    pub fn build(self) -> ::std::result::Result<super::types::DedicatedIp, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::DedicatedIp {
