...
pub struct MetricsDataSource {
    ...
    pub dimensions: ::std::collections::HashMap<super::types::MetricDimensionName, ::std::vec::Vec<::std::string::String>>,
    ...
    pub metrics: ::std::vec::Vec<super::types::ExportMetric>,
...
impl MetricsDataSource {
    /// <p>An object that contains a mapping between a <code>MetricDimensionName</code> and <code>MetricDimensionValue</code> to filter metrics by. Must contain a least 1 dimension but no more than 3 unique ones.</p>
    pub fn dimensions(&self) -> &::std::collections::HashMap<super::types::MetricDimensionName, ::std::vec::Vec<::std::string::String>> {
        &self.dimensions
    }
    /// <p>The metrics namespace - e.g., <code>VDM</code>.</p>
    ...
    /// <p>A list of <code>ExportMetric</code> objects to export.</p>
    pub fn metrics(&self) -> &[super::types::ExportMetric] {
        use std::ops::Deref;
        self.metrics.deref()
    }
    /// <p>Represents the start date for the export interval as a timestamp.</p>
...
impl MetricsDataSource {
    ...
    pub fn builder() -> super::types::builders::MetricsDataSourceBuilder {
        super::types::builders::MetricsDataSourceBuilder::default()
    }
}
...
pub struct MetricsDataSourceBuilder {
    pub(crate) dimensions:
        ::std::option::Option<::std::collections::HashMap<super::types::MetricDimensionName, ::std::vec::Vec<::std::string::String>>>,
    pub(crate) namespace: ::std::option::Option<super::types::MetricNamespace>,
    pub(crate) metrics: ::std::option::Option<::std::vec::Vec<super::types::ExportMetric>>,
...
impl MetricsDataSourceBuilder {
    ...
    ///
    /// <p>An object that contains a mapping between a <code>MetricDimensionName</code> and <code>MetricDimensionValue</code> to filter metrics by. Must contain a least 1 dimension but no more than 3 unique ones.</p>
    pub fn dimensions(mut self, k: super::types::MetricDimensionName, v: ::std::vec::Vec<::std::string::String>) -> Self {
    ...
    pub fn set_dimensions(
        mut self,
        input: ::std::option::Option<::std::collections::HashMap<super::types::MetricDimensionName, ::std::vec::Vec<::std::string::String>>>,
    ) -> Self {
    ...
    ///
    /// <p>A list of <code>ExportMetric</code> objects to export.</p>
    pub fn metrics(mut self, input: super::types::ExportMetric) -> Self {
    ...
    /// <p>A list of <code>ExportMetric</code> objects to export.</p>
    pub fn set_metrics(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::ExportMetric>>) -> Self {
        self.metrics = input;
        self
    }
    /// <p>A list of <code>ExportMetric</code> objects to export.</p>
    pub fn get_metrics(&self) -> &::std::option::Option<::std::vec::Vec<super::types::ExportMetric>> {
        &self.metrics
    }
    /// <p>Represents the start date for the export interval as a timestamp.</p>
    /// This field is required.
    ...
    pub fn build(self) -> ::std::result::Result<super::types::MetricsDataSource, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::MetricsDataSource {
