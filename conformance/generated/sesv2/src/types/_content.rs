...
impl Content {
    ...
    pub fn builder() -> super::types::builders::ContentBuilder {
        super::types::builders::ContentBuilder::default()
    }
}
...
impl ContentBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::Content, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::Content {
