...
pub struct ContactListDestination {
    ...
    /// </ul>
    pub contact_list_import_action: super::types::ContactListImportAction,
}
impl ContactListDestination {
    ...
    /// <p>DELETE: remove the addresses from the contact list.</p></li>
    /// </ul>
    pub fn contact_list_import_action(&self) -> &super::types::ContactListImportAction {
...
impl ContactListDestination {
    ...
    pub fn builder() -> super::types::builders::ContactListDestinationBuilder {
        super::types::builders::ContactListDestinationBuilder::default()
    }
}
...
pub struct ContactListDestinationBuilder {
    ...
    pub(crate) contact_list_import_action: ::std::option::Option<super::types::ContactListImportAction>,
}
impl ContactListDestinationBuilder {
    ...
    /// </ul>
    /// This field is required.
    pub fn contact_list_import_action(mut self, input: super::types::ContactListImportAction) -> Self {
    ...
    /// <p>DELETE: remove the addresses from the contact list.</p></li>
    /// </ul>
    pub fn set_contact_list_import_action(mut self, input: ::std::option::Option<super::types::ContactListImportAction>) -> Self {
    ...
    /// <p>DELETE: remove the addresses from the contact list.</p></li>
    /// </ul>
    pub fn get_contact_list_import_action(&self) -> &::std::option::Option<super::types::ContactListImportAction> {
        &self.contact_list_import_action
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::types::ContactListDestination, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ContactListDestination {
