...
impl SoaRecord {
    ...
    pub fn builder() -> super::types::builders::SoaRecordBuilder {
        super::types::builders::SoaRecordBuilder::default()
    }
}
...
impl SoaRecordBuilder {
    ...
    pub fn build(self) -> super::types::SoaRecord {
        super::types::SoaRecord {
