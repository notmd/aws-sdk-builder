...
impl ResourceTenantMetadata {
    ...
    pub fn builder() -> super::types::builders::ResourceTenantMetadataBuilder {
        super::types::builders::ResourceTenantMetadataBuilder::default()
    }
}
...
impl ResourceTenantMetadataBuilder {
    ...
    pub fn build(self) -> super::types::ResourceTenantMetadata {
