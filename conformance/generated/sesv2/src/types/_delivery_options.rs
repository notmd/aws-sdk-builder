...
impl DeliveryOptions {
    ...
    pub fn builder() -> super::types::builders::DeliveryOptionsBuilder {
        super::types::builders::DeliveryOptionsBuilder::default()
    }
}
...
impl DeliveryOptionsBuilder {
    ...
    pub fn build(self) -> super::types::DeliveryOptions {
        super::types::DeliveryOptions {
