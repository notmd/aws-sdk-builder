...
impl InboxPlacementTrackingOption {
    ...
    pub fn builder() -> super::types::builders::InboxPlacementTrackingOptionBuilder {
        super::types::builders::InboxPlacementTrackingOptionBuilder::default()
    }
}
...
impl InboxPlacementTrackingOptionBuilder {
    ...
    pub fn build(self) -> super::types::InboxPlacementTrackingOption {
        super::types::InboxPlacementTrackingOption {
