...
impl super::Client {
    ...
    pub fn put_suppressed_destination(&self) -> super::operation::put_suppressed_destination::builders::PutSuppressedDestinationFluentBuilder {
        super::operation::put_suppressed_destination::builders::PutSuppressedDestinationFluentBuilder::new(self.handle.clone())
    }
}
