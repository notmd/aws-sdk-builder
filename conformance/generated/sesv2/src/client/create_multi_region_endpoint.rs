...
impl super::Client {
    ...
    pub fn create_multi_region_endpoint(&self) -> super::operation::create_multi_region_endpoint::builders::CreateMultiRegionEndpointFluentBuilder {
        super::operation::create_multi_region_endpoint::builders::CreateMultiRegionEndpointFluentBuilder::new(self.handle.clone())
    }
}
