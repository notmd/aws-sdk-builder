...
impl super::Client {
    ...
    pub fn get_dedicated_ips(&self) -> super::operation::get_dedicated_ips::builders::GetDedicatedIpsFluentBuilder {
        super::operation::get_dedicated_ips::builders::GetDedicatedIpsFluentBuilder::new(self.handle.clone())
    }
}
