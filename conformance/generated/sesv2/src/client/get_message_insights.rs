...
impl super::Client {
    ...
    pub fn get_message_insights(&self) -> super::operation::get_message_insights::builders::GetMessageInsightsFluentBuilder {
        super::operation::get_message_insights::builders::GetMessageInsightsFluentBuilder::new(self.handle.clone())
    }
}
