...
impl super::Client {
    ...
    pub fn get_import_job(&self) -> super::operation::get_import_job::builders::GetImportJobFluentBuilder {
        super::operation::get_import_job::builders::GetImportJobFluentBuilder::new(self.handle.clone())
    }
}
