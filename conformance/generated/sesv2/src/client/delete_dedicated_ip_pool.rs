...
impl super::Client {
    ...
    pub fn delete_dedicated_ip_pool(&self) -> super::operation::delete_dedicated_ip_pool::builders::DeleteDedicatedIpPoolFluentBuilder {
        super::operation::delete_dedicated_ip_pool::builders::DeleteDedicatedIpPoolFluentBuilder::new(self.handle.clone())
    }
}
