...
impl super::Client {
    ...
    pub fn list_recommendations(&self) -> super::operation::list_recommendations::builders::ListRecommendationsFluentBuilder {
        super::operation::list_recommendations::builders::ListRecommendationsFluentBuilder::new(self.handle.clone())
    }
}
