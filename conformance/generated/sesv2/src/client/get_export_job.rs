...
impl super::Client {
    ...
    pub fn get_export_job(&self) -> super::operation::get_export_job::builders::GetExportJobFluentBuilder {
        super::operation::get_export_job::builders::GetExportJobFluentBuilder::new(self.handle.clone())
    }
}
