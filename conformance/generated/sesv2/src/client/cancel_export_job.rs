...
impl super::Client {
    ...
    pub fn cancel_export_job(&self) -> super::operation::cancel_export_job::builders::CancelExportJobFluentBuilder {
        super::operation::cancel_export_job::builders::CancelExportJobFluentBuilder::new(self.handle.clone())
    }
}
