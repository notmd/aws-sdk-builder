...
impl super::Client {
    ...
    pub fn put_account_sending_attributes(
        &self,
    ) -> super::operation::put_account_sending_attributes::builders::PutAccountSendingAttributesFluentBuilder {
        super::operation::put_account_sending_attributes::builders::PutAccountSendingAttributesFluentBuilder::new(self.handle.clone())
    }
}
