...
impl super::Client {
    ...
    pub fn get_tenant(&self) -> super::operation::get_tenant::builders::GetTenantFluentBuilder {
        super::operation::get_tenant::builders::GetTenantFluentBuilder::new(self.handle.clone())
    }
}
