...
impl super::Client {
    ...
    pub fn delete_contact_list(&self) -> super::operation::delete_contact_list::builders::DeleteContactListFluentBuilder {
        super::operation::delete_contact_list::builders::DeleteContactListFluentBuilder::new(self.handle.clone())
    }
}
