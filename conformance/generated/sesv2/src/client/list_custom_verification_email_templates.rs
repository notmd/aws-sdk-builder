...
impl super::Client {
    ...
    pub fn list_custom_verification_email_templates(
        &self,
    ) -> super::operation::list_custom_verification_email_templates::builders::ListCustomVerificationEmailTemplatesFluentBuilder {
        super::operation::list_custom_verification_email_templates::builders::ListCustomVerificationEmailTemplatesFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
