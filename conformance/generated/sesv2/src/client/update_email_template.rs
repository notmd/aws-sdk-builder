...
impl super::Client {
    ...
    pub fn update_email_template(&self) -> super::operation::update_email_template::builders::UpdateEmailTemplateFluentBuilder {
        super::operation::update_email_template::builders::UpdateEmailTemplateFluentBuilder::new(self.handle.clone())
    }
}
