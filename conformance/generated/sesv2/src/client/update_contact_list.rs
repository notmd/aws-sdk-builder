...
impl super::Client {
    ...
    pub fn update_contact_list(&self) -> super::operation::update_contact_list::builders::UpdateContactListFluentBuilder {
        super::operation::update_contact_list::builders::UpdateContactListFluentBuilder::new(self.handle.clone())
    }
}
