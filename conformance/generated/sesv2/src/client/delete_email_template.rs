...
impl super::Client {
    ...
    pub fn delete_email_template(&self) -> super::operation::delete_email_template::builders::DeleteEmailTemplateFluentBuilder {
        super::operation::delete_email_template::builders::DeleteEmailTemplateFluentBuilder::new(self.handle.clone())
    }
}
