...
impl super::Client {
    ...
    pub fn create_email_identity_policy(&self) -> super::operation::create_email_identity_policy::builders::CreateEmailIdentityPolicyFluentBuilder {
        super::operation::create_email_identity_policy::builders::CreateEmailIdentityPolicyFluentBuilder::new(self.handle.clone())
    }
}
