...
impl super::Client {
    ...
    pub fn list_tenant_resources(&self) -> super::operation::list_tenant_resources::builders::ListTenantResourcesFluentBuilder {
        super::operation::list_tenant_resources::builders::ListTenantResourcesFluentBuilder::new(self.handle.clone())
    }
}
