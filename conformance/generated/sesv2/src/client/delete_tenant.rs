...
impl super::Client {
    ...
    pub fn delete_tenant(&self) -> super::operation::delete_tenant::builders::DeleteTenantFluentBuilder {
        super::operation::delete_tenant::builders::DeleteTenantFluentBuilder::new(self.handle.clone())
    }
}
