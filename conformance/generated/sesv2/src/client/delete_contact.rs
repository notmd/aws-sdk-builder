...
impl super::Client {
    ...
    pub fn delete_contact(&self) -> super::operation::delete_contact::builders::DeleteContactFluentBuilder {
        super::operation::delete_contact::builders::DeleteContactFluentBuilder::new(self.handle.clone())
    }
}
