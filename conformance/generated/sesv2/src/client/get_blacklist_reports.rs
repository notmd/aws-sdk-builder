...
impl super::Client {
    ...
    pub fn get_blacklist_reports(&self) -> super::operation::get_blacklist_reports::builders::GetBlacklistReportsFluentBuilder {
        super::operation::get_blacklist_reports::builders::GetBlacklistReportsFluentBuilder::new(self.handle.clone())
    }
}
