...
impl super::Client {
    ...
    pub fn get_dedicated_ip_pool(&self) -> super::operation::get_dedicated_ip_pool::builders::GetDedicatedIpPoolFluentBuilder {
        super::operation::get_dedicated_ip_pool::builders::GetDedicatedIpPoolFluentBuilder::new(self.handle.clone())
    }
}
