...
impl super::Client {
    ...
    pub fn get_account(&self) -> super::operation::get_account::builders::GetAccountFluentBuilder {
        super::operation::get_account::builders::GetAccountFluentBuilder::new(self.handle.clone())
    }
}
