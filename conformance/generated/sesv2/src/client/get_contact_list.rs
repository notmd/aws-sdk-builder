...
impl super::Client {
    ...
    pub fn get_contact_list(&self) -> super::operation::get_contact_list::builders::GetContactListFluentBuilder {
        super::operation::get_contact_list::builders::GetContactListFluentBuilder::new(self.handle.clone())
    }
}
