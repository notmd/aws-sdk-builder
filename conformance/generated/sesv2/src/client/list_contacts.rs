...
impl super::Client {
    ...
    pub fn list_contacts(&self) -> super::operation::list_contacts::builders::ListContactsFluentBuilder {
        super::operation::list_contacts::builders::ListContactsFluentBuilder::new(self.handle.clone())
    }
}
