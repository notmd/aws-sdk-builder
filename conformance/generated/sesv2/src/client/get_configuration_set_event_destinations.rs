...
impl super::Client {
    ...
    pub fn get_configuration_set_event_destinations(
        &self,
    ) -> super::operation::get_configuration_set_event_destinations::builders::GetConfigurationSetEventDestinationsFluentBuilder {
        super::operation::get_configuration_set_event_destinations::builders::GetConfigurationSetEventDestinationsFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
