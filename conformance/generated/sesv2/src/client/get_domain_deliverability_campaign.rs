...
impl super::Client {
    ...
    pub fn get_domain_deliverability_campaign(
        &self,
    ) -> super::operation::get_domain_deliverability_campaign::builders::GetDomainDeliverabilityCampaignFluentBuilder {
        super::operation::get_domain_deliverability_campaign::builders::GetDomainDeliverabilityCampaignFluentBuilder::new(self.handle.clone())
    }
}
