...
impl super::Client {
    ...
    pub fn list_tenants(&self) -> super::operation::list_tenants::builders::ListTenantsFluentBuilder {
        super::operation::list_tenants::builders::ListTenantsFluentBuilder::new(self.handle.clone())
    }
}
