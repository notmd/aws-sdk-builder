...
impl super::Client {
    ...
    pub fn list_configuration_sets(&self) -> super::operation::list_configuration_sets::builders::ListConfigurationSetsFluentBuilder {
        super::operation::list_configuration_sets::builders::ListConfigurationSetsFluentBuilder::new(self.handle.clone())
    }
}
