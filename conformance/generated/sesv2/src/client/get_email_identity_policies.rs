...
impl super::Client {
    ...
    pub fn get_email_identity_policies(&self) -> super::operation::get_email_identity_policies::builders::GetEmailIdentityPoliciesFluentBuilder {
        super::operation::get_email_identity_policies::builders::GetEmailIdentityPoliciesFluentBuilder::new(self.handle.clone())
    }
}
