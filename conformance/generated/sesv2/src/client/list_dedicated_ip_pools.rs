...
impl super::Client {
    ...
    pub fn list_dedicated_ip_pools(&self) -> super::operation::list_dedicated_ip_pools::builders::ListDedicatedIpPoolsFluentBuilder {
        super::operation::list_dedicated_ip_pools::builders::ListDedicatedIpPoolsFluentBuilder::new(self.handle.clone())
    }
}
