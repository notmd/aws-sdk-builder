...
impl super::Client {
    ...
    pub fn put_dedicated_ip_warmup_attributes(
        &self,
    ) -> super::operation::put_dedicated_ip_warmup_attributes::builders::PutDedicatedIpWarmupAttributesFluentBuilder {
        super::operation::put_dedicated_ip_warmup_attributes::builders::PutDedicatedIpWarmupAttributesFluentBuilder::new(self.handle.clone())
    }
}
