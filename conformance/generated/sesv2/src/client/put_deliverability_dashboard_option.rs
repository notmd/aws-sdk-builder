...
impl super::Client {
    ...
    pub fn put_deliverability_dashboard_option(
        &self,
    ) -> super::operation::put_deliverability_dashboard_option::builders::PutDeliverabilityDashboardOptionFluentBuilder {
        super::operation::put_deliverability_dashboard_option::builders::PutDeliverabilityDashboardOptionFluentBuilder::new(self.handle.clone())
    }
}
