...
impl super::Client {
    ...
    pub fn get_dedicated_ip(&self) -> super::operation::get_dedicated_ip::builders::GetDedicatedIpFluentBuilder {
        super::operation::get_dedicated_ip::builders::GetDedicatedIpFluentBuilder::new(self.handle.clone())
    }
}
