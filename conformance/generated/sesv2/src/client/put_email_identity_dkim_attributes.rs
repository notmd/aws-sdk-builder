...
impl super::Client {
    ...
    pub fn put_email_identity_dkim_attributes(
        &self,
    ) -> super::operation::put_email_identity_dkim_attributes::builders::PutEmailIdentityDkimAttributesFluentBuilder {
        super::operation::put_email_identity_dkim_attributes::builders::PutEmailIdentityDkimAttributesFluentBuilder::new(self.handle.clone())
    }
}
