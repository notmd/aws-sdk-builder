...
impl super::Client {
    ...
    pub fn get_configuration_set(&self) -> super::operation::get_configuration_set::builders::GetConfigurationSetFluentBuilder {
        super::operation::get_configuration_set::builders::GetConfigurationSetFluentBuilder::new(self.handle.clone())
    }
}
