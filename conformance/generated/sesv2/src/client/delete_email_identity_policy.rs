...
impl super::Client {
    ...
    pub fn delete_email_identity_policy(&self) -> super::operation::delete_email_identity_policy::builders::DeleteEmailIdentityPolicyFluentBuilder {
        super::operation::delete_email_identity_policy::builders::DeleteEmailIdentityPolicyFluentBuilder::new(self.handle.clone())
    }
}
