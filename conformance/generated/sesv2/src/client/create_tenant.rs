...
impl super::Client {
    ...
    pub fn create_tenant(&self) -> super::operation::create_tenant::builders::CreateTenantFluentBuilder {
        super::operation::create_tenant::builders::CreateTenantFluentBuilder::new(self.handle.clone())
    }
}
