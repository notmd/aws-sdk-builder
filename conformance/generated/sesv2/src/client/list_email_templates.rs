...
impl super::Client {
    ...
    pub fn list_email_templates(&self) -> super::operation::list_email_templates::builders::ListEmailTemplatesFluentBuilder {
        super::operation::list_email_templates::builders::ListEmailTemplatesFluentBuilder::new(self.handle.clone())
    }
}
