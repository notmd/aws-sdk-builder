...
impl super::Client {
    ...
    pub fn put_dedicated_ip_pool_scaling_attributes(
        &self,
    ) -> super::operation::put_dedicated_ip_pool_scaling_attributes::builders::PutDedicatedIpPoolScalingAttributesFluentBuilder {
        super::operation::put_dedicated_ip_pool_scaling_attributes::builders::PutDedicatedIpPoolScalingAttributesFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
