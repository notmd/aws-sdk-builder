...
impl DeleteConfigurationSetInput {
    ...
    pub fn builder() -> super::operation::delete_configuration_set::builders::DeleteConfigurationSetInputBuilder {
        super::operation::delete_configuration_set::builders::DeleteConfigurationSetInputBuilder::default()
    }
}
...
impl DeleteConfigurationSetInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::delete_configuration_set::DeleteConfigurationSetInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::delete_configuration_set::DeleteConfigurationSetInput {
