...
impl DeleteConfigurationSetOutput {
    ...
    pub fn builder() -> super::operation::delete_configuration_set::builders::DeleteConfigurationSetOutputBuilder {
        super::operation::delete_configuration_set::builders::DeleteConfigurationSetOutputBuilder::default()
    }
}
...
impl DeleteConfigurationSetOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_configuration_set::DeleteConfigurationSetOutput {
