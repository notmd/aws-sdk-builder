...
impl PutEmailIdentityMailFromAttributesOutput {
    ...
    pub fn builder() -> super::operation::put_email_identity_mail_from_attributes::builders::PutEmailIdentityMailFromAttributesOutputBuilder {
...
impl PutEmailIdentityMailFromAttributesOutputBuilder {
    ...
    pub fn build(self) -> super::operation::put_email_identity_mail_from_attributes::PutEmailIdentityMailFromAttributesOutput {
