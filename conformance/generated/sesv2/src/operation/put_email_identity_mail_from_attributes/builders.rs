...
pub use super::operation::put_email_identity_mail_from_attributes::_put_email_identity_mail_from_attributes_input::PutEmailIdentityMailFromAttributesInputBuilder;

pub use super::operation::put_email_identity_mail_from_attributes::_put_email_identity_mail_from_attributes_output::PutEmailIdentityMailFromAttributesOutputBuilder;

impl super::operation::put_email_identity_mail_from_attributes::builders::PutEmailIdentityMailFromAttributesInputBuilder {
...
pub struct PutEmailIdentityMailFromAttributesFluentBuilder {
    ...
    inner: super::operation::put_email_identity_mail_from_attributes::builders::PutEmailIdentityMailFromAttributesInputBuilder,
...
impl PutEmailIdentityMailFromAttributesFluentBuilder {
    /// Creates a new `PutEmailIdentityMailFromAttributesFluentBuilder`.
    ...
    pub fn as_input(&self) -> &super::operation::put_email_identity_mail_from_attributes::builders::PutEmailIdentityMailFromAttributesInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            super::operation::put_email_identity_mail_from_attributes::PutEmailIdentityMailFromAttributes::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        super::operation::put_email_identity_mail_from_attributes::PutEmailIdentityMailFromAttributes::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn behavior_on_mx_failure(mut self, input: super::types::BehaviorOnMxFailure) -> Self {
        self.inner = self.inner.behavior_on_mx_failure(input);
        self
    }
    /// <p>The action to take if the required MX record isn't found when you send an email. When you set this value to <code>UseDefaultValue</code>, the mail is sent using <i>amazonses.com</i> as the MAIL FROM domain. When you set this value to <code>RejectMessage</code>, the Amazon SES API v2 returns a <code>MailFromDomainNotVerified</code> error, and doesn't attempt to deliver the email.</p>
    /// <p>These behaviors are taken when the custom MAIL FROM domain configuration is in the <code>Pending</code>, <code>Failed</code>, and <code>TemporaryFailure</code> states.</p>
    pub fn set_behavior_on_mx_failure(mut self, input: ::std::option::Option<super::types::BehaviorOnMxFailure>) -> Self {
        self.inner = self.inner.set_behavior_on_mx_failure(input);
        self
    }
    /// <p>The action to take if the required MX record isn't found when you send an email. When you set this value to <code>UseDefaultValue</code>, the mail is sent using <i>amazonses.com</i> as the MAIL FROM domain. When you set this value to <code>RejectMessage</code>, the Amazon SES API v2 returns a <code>MailFromDomainNotVerified</code> error, and doesn't attempt to deliver the email.</p>
    /// <p>These behaviors are taken when the custom MAIL FROM domain configuration is in the <code>Pending</code>, <code>Failed</code>, and <code>TemporaryFailure</code> states.</p>
    pub fn get_behavior_on_mx_failure(&self) -> &::std::option::Option<super::types::BehaviorOnMxFailure> {
