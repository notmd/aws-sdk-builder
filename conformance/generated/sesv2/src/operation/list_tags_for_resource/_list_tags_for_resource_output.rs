...
impl ListTagsForResourceOutput {
    ...
    pub fn builder() -> super::operation::list_tags_for_resource::builders::ListTagsForResourceOutputBuilder {
        super::operation::list_tags_for_resource::builders::ListTagsForResourceOutputBuilder::default()
    }
}
...
impl ListTagsForResourceOutputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_tags_for_resource::ListTagsForResourceOutput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::list_tags_for_resource::ListTagsForResourceOutput {
