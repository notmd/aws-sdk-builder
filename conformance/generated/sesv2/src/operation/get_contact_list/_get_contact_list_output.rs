...
impl GetContactListOutput {
    ...
    pub fn builder() -> super::operation::get_contact_list::builders::GetContactListOutputBuilder {
        super::operation::get_contact_list::builders::GetContactListOutputBuilder::default()
    }
}
...
impl GetContactListOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_contact_list::GetContactListOutput {
