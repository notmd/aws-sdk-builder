...
pub use super::operation::put_configuration_set_suppression_options::_put_configuration_set_suppression_options_input::PutConfigurationSetSuppressionOptionsInputBuilder;

pub use super::operation::put_configuration_set_suppression_options::_put_configuration_set_suppression_options_output::PutConfigurationSetSuppressionOptionsOutputBuilder;

impl super::operation::put_configuration_set_suppression_options::builders::PutConfigurationSetSuppressionOptionsInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::Client,
    ) -> ::std::result::Result<
        super::operation::put_configuration_set_suppression_options::PutConfigurationSetSuppressionOptionsOutput,
...
pub struct PutConfigurationSetSuppressionOptionsFluentBuilder {
    ...
    inner: super::operation::put_configuration_set_suppression_options::builders::PutConfigurationSetSuppressionOptionsInputBuilder,
...
impl PutConfigurationSetSuppressionOptionsFluentBuilder {
    /// Creates a new `PutConfigurationSetSuppressionOptionsFluentBuilder`.
    ...
    pub fn as_input(
        &self,
    ) -> &super::operation::put_configuration_set_suppression_options::builders::PutConfigurationSetSuppressionOptionsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            super::operation::put_configuration_set_suppression_options::PutConfigurationSetSuppressionOptions::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        super::operation::put_configuration_set_suppression_options::PutConfigurationSetSuppressionOptions::orchestrate(&runtime_plugins, input).await
    }
    ...
    /// </ul>
    pub fn suppression_scope(mut self, input: super::types::SuppressionListScope) -> Self {
    ...
    /// <p><code>ACCOUNT</code> – Use the account-level suppression list.</p></li>
    /// </ul>
    pub fn set_suppression_scope(mut self, input: ::std::option::Option<super::types::SuppressionListScope>) -> Self {
    ...
    /// <p><code>ACCOUNT</code> – Use the account-level suppression list.</p></li>
    /// </ul>
    pub fn get_suppression_scope(&self) -> &::std::option::Option<super::types::SuppressionListScope> {
    ...
    /// </ul>
    pub fn suppressed_reasons(mut self, input: super::types::SuppressionListReason) -> Self {
    ...
    /// <p><code>BOUNCE</code> – Amazon SES adds an email address to the suppression list for your account or for a specific tenant when a message sent to that address results in a hard bounce.</p></li>
    /// </ul>
    pub fn set_suppressed_reasons(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::SuppressionListReason>>) -> Self {
    ...
    /// <p><code>BOUNCE</code> – Amazon SES adds an email address to the suppression list for your account or for a specific tenant when a message sent to that address results in a hard bounce.</p></li>
    /// </ul>
    pub fn get_suppressed_reasons(&self) -> &::std::option::Option<::std::vec::Vec<super::types::SuppressionListReason>> {
    ...
    pub fn validation_options(mut self, input: super::types::SuppressionValidationOptions) -> Self {
        self.inner = self.inner.validation_options(input);
        self
    }
    /// <p>An object that contains information about the email address suppression preferences for the configuration set in the current Amazon Web Services Region.</p>
    pub fn set_validation_options(mut self, input: ::std::option::Option<super::types::SuppressionValidationOptions>) -> Self {
        self.inner = self.inner.set_validation_options(input);
        self
    }
    /// <p>An object that contains information about the email address suppression preferences for the configuration set in the current Amazon Web Services Region.</p>
    pub fn get_validation_options(&self) -> &::std::option::Option<super::types::SuppressionValidationOptions> {
