...
impl PutConfigurationSetSuppressionOptionsOutput {
    ...
    pub fn builder() -> super::operation::put_configuration_set_suppression_options::builders::PutConfigurationSetSuppressionOptionsOutputBuilder {
...
impl PutConfigurationSetSuppressionOptionsOutputBuilder {
    ...
    pub fn build(self) -> super::operation::put_configuration_set_suppression_options::PutConfigurationSetSuppressionOptionsOutput {
