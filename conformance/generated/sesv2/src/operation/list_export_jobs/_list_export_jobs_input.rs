...
impl ListExportJobsInput {
    ...
    pub fn builder() -> super::operation::list_export_jobs::builders::ListExportJobsInputBuilder {
        super::operation::list_export_jobs::builders::ListExportJobsInputBuilder::default()
    }
}
...
impl ListExportJobsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_export_jobs::ListExportJobsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_export_jobs::ListExportJobsInput {
