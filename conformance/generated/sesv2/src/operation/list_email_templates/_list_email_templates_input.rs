...
impl ListEmailTemplatesInput {
    ...
    pub fn builder() -> super::operation::list_email_templates::builders::ListEmailTemplatesInputBuilder {
        super::operation::list_email_templates::builders::ListEmailTemplatesInputBuilder::default()
    }
}
...
impl ListEmailTemplatesInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_email_templates::ListEmailTemplatesInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::list_email_templates::ListEmailTemplatesInput {
