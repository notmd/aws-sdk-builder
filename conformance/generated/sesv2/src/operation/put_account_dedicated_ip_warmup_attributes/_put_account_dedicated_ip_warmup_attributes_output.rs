...
impl PutAccountDedicatedIpWarmupAttributesOutput {
    ...
    pub fn builder() -> super::operation::put_account_dedicated_ip_warmup_attributes::builders::PutAccountDedicatedIpWarmupAttributesOutputBuilder {
...
impl PutAccountDedicatedIpWarmupAttributesOutputBuilder {
    ...
    pub fn build(self) -> super::operation::put_account_dedicated_ip_warmup_attributes::PutAccountDedicatedIpWarmupAttributesOutput {
