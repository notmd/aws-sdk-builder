...
impl PutDedicatedIpWarmupAttributesOutput {
    ...
    pub fn builder() -> super::operation::put_dedicated_ip_warmup_attributes::builders::PutDedicatedIpWarmupAttributesOutputBuilder {
        super::operation::put_dedicated_ip_warmup_attributes::builders::PutDedicatedIpWarmupAttributesOutputBuilder::default()
    }
}
...
impl PutDedicatedIpWarmupAttributesOutputBuilder {
    ...
    pub fn build(self) -> super::operation::put_dedicated_ip_warmup_attributes::PutDedicatedIpWarmupAttributesOutput {
