...
impl PutDedicatedIpWarmupAttributesInput {
    ...
    pub fn builder() -> super::operation::put_dedicated_ip_warmup_attributes::builders::PutDedicatedIpWarmupAttributesInputBuilder {
        super::operation::put_dedicated_ip_warmup_attributes::builders::PutDedicatedIpWarmupAttributesInputBuilder::default()
    }
}
...
impl PutDedicatedIpWarmupAttributesInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::put_dedicated_ip_warmup_attributes::PutDedicatedIpWarmupAttributesInput,
