...
impl DeleteEmailIdentityInput {
    ...
    pub fn builder() -> super::operation::delete_email_identity::builders::DeleteEmailIdentityInputBuilder {
        super::operation::delete_email_identity::builders::DeleteEmailIdentityInputBuilder::default()
    }
}
...
impl DeleteEmailIdentityInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::delete_email_identity::DeleteEmailIdentityInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::delete_email_identity::DeleteEmailIdentityInput {
