...
impl CreateEmailIdentityPolicyInput {
    ...
    pub fn builder() -> super::operation::create_email_identity_policy::builders::CreateEmailIdentityPolicyInputBuilder {
        super::operation::create_email_identity_policy::builders::CreateEmailIdentityPolicyInputBuilder::default()
    }
}
...
impl CreateEmailIdentityPolicyInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::create_email_identity_policy::CreateEmailIdentityPolicyInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::create_email_identity_policy::CreateEmailIdentityPolicyInput {
