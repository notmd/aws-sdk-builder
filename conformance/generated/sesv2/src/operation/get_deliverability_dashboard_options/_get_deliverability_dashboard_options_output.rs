...
pub struct GetDeliverabilityDashboardOptionsOutput {
    ...
    pub account_status: ::std::option::Option<super::types::DeliverabilityDashboardAccountStatus>,
    ...
    pub active_subscribed_domains: ::std::option::Option<::std::vec::Vec<super::types::DomainDeliverabilityTrackingOption>>,
    ...
    pub pending_expiration_subscribed_domains: ::std::option::Option<::std::vec::Vec<super::types::DomainDeliverabilityTrackingOption>>,
...
impl GetDeliverabilityDashboardOptionsOutput {
    ...
    /// <p>The current status of your Deliverability dashboard subscription. If this value is <code>PENDING_EXPIRATION</code>, your subscription is scheduled to expire at the end of the current calendar month.</p>
    pub fn account_status(&self) -> ::std::option::Option<&super::types::DeliverabilityDashboardAccountStatus> {
    ...
    pub fn active_subscribed_domains(&self) -> &[super::types::DomainDeliverabilityTrackingOption] {
    ...
    pub fn pending_expiration_subscribed_domains(&self) -> &[super::types::DomainDeliverabilityTrackingOption] {
...
impl GetDeliverabilityDashboardOptionsOutput {
    ...
    pub fn builder() -> super::operation::get_deliverability_dashboard_options::builders::GetDeliverabilityDashboardOptionsOutputBuilder {
        super::operation::get_deliverability_dashboard_options::builders::GetDeliverabilityDashboardOptionsOutputBuilder::default()
    }
}
...
pub struct GetDeliverabilityDashboardOptionsOutputBuilder {
    ...
    pub(crate) account_status: ::std::option::Option<super::types::DeliverabilityDashboardAccountStatus>,
    pub(crate) active_subscribed_domains: ::std::option::Option<::std::vec::Vec<super::types::DomainDeliverabilityTrackingOption>>,
    pub(crate) pending_expiration_subscribed_domains: ::std::option::Option<::std::vec::Vec<super::types::DomainDeliverabilityTrackingOption>>,
    _request_id: Option<String>,
}
impl GetDeliverabilityDashboardOptionsOutputBuilder {
    ...
    /// <p>The current status of your Deliverability dashboard subscription. If this value is <code>PENDING_EXPIRATION</code>, your subscription is scheduled to expire at the end of the current calendar month.</p>
    pub fn account_status(mut self, input: super::types::DeliverabilityDashboardAccountStatus) -> Self {
        self.account_status = ::std::option::Option::Some(input);
        self
    }
    /// <p>The current status of your Deliverability dashboard subscription. If this value is <code>PENDING_EXPIRATION</code>, your subscription is scheduled to expire at the end of the current calendar month.</p>
    pub fn set_account_status(mut self, input: ::std::option::Option<super::types::DeliverabilityDashboardAccountStatus>) -> Self {
        self.account_status = input;
        self
    }
    /// <p>The current status of your Deliverability dashboard subscription. If this value is <code>PENDING_EXPIRATION</code>, your subscription is scheduled to expire at the end of the current calendar month.</p>
    pub fn get_account_status(&self) -> &::std::option::Option<super::types::DeliverabilityDashboardAccountStatus> {
        &self.account_status
    }
    ...
    ///
    /// <p>An array of objects, one for each verified domain that you use to send email and currently has an active Deliverability dashboard subscription that isn’t scheduled to expire at the end of the current calendar month.</p>
    pub fn active_subscribed_domains(mut self, input: super::types::DomainDeliverabilityTrackingOption) -> Self {
    ...
    pub fn set_active_subscribed_domains(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::DomainDeliverabilityTrackingOption>>,
    ) -> Self {
        self.active_subscribed_domains = input;
        self
    }
    /// <p>An array of objects, one for each verified domain that you use to send email and currently has an active Deliverability dashboard subscription that isn’t scheduled to expire at the end of the current calendar month.</p>
    pub fn get_active_subscribed_domains(&self) -> &::std::option::Option<::std::vec::Vec<super::types::DomainDeliverabilityTrackingOption>> {
    ...
    ///
    /// <p>An array of objects, one for each verified domain that you use to send email and currently has an active Deliverability dashboard subscription that's scheduled to expire at the end of the current calendar month.</p>
    pub fn pending_expiration_subscribed_domains(mut self, input: super::types::DomainDeliverabilityTrackingOption) -> Self {
    ...
    pub fn get_pending_expiration_subscribed_domains(
        &self,
    ) -> &::std::option::Option<::std::vec::Vec<super::types::DomainDeliverabilityTrackingOption>> {
    ...
    pub fn build(self) -> super::operation::get_deliverability_dashboard_options::GetDeliverabilityDashboardOptionsOutput {
        super::operation::get_deliverability_dashboard_options::GetDeliverabilityDashboardOptionsOutput {
