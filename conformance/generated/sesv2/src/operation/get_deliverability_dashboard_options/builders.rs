...
pub use super::operation::get_deliverability_dashboard_options::_get_deliverability_dashboard_options_input::GetDeliverabilityDashboardOptionsInputBuilder;

pub use super::operation::get_deliverability_dashboard_options::_get_deliverability_dashboard_options_output::GetDeliverabilityDashboardOptionsOutputBuilder;

impl super::operation::get_deliverability_dashboard_options::builders::GetDeliverabilityDashboardOptionsInputBuilder {
...
pub struct GetDeliverabilityDashboardOptionsFluentBuilder {
    ...
    inner: super::operation::get_deliverability_dashboard_options::builders::GetDeliverabilityDashboardOptionsInputBuilder,
...
impl GetDeliverabilityDashboardOptionsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::get_deliverability_dashboard_options::builders::GetDeliverabilityDashboardOptionsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::get_deliverability_dashboard_options::GetDeliverabilityDashboardOptions::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::get_deliverability_dashboard_options::GetDeliverabilityDashboardOptions::orchestrate(&runtime_plugins, input).await
    }
