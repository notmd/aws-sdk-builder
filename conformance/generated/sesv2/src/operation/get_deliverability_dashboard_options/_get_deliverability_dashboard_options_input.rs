...
impl GetDeliverabilityDashboardOptionsInput {
    ...
    pub fn builder() -> super::operation::get_deliverability_dashboard_options::builders::GetDeliverabilityDashboardOptionsInputBuilder {
        super::operation::get_deliverability_dashboard_options::builders::GetDeliverabilityDashboardOptionsInputBuilder::default()
    }
}
...
impl GetDeliverabilityDashboardOptionsInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::get_deliverability_dashboard_options::GetDeliverabilityDashboardOptionsInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::get_deliverability_dashboard_options::GetDeliverabilityDashboardOptionsInput {})
    }
}
