    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_message_insights::GetMessageInsightsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_message_insights::GetMessageInsightsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetMessageInsightsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_message_insights::de_get_message_insights_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_message_insights::de_get_message_insights_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetMessageInsightsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_message_insights::GetMessageInsightsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_message_insights::GetMessageInsightsInput,
...
impl ::aws_types::request_id::RequestId for super::operation::get_message_insights::GetMessageInsightsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_message_insights::_get_message_insights_input::GetMessageInsightsInput;

pub use super::operation::get_message_insights::_get_message_insights_output::GetMessageInsightsOutput;
