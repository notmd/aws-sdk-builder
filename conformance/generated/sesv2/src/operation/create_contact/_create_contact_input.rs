...
impl CreateContactInput {
    ...
    pub fn builder() -> super::operation::create_contact::builders::CreateContactInputBuilder {
        super::operation::create_contact::builders::CreateContactInputBuilder::default()
    }
}
...
impl CreateContactInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::create_contact::CreateContactInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::create_contact::CreateContactInput {
