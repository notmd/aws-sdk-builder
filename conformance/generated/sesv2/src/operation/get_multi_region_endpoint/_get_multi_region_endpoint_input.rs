...
impl GetMultiRegionEndpointInput {
    ...
    pub fn builder() -> super::operation::get_multi_region_endpoint::builders::GetMultiRegionEndpointInputBuilder {
        super::operation::get_multi_region_endpoint::builders::GetMultiRegionEndpointInputBuilder::default()
    }
}
...
impl GetMultiRegionEndpointInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::get_multi_region_endpoint::GetMultiRegionEndpointInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::get_multi_region_endpoint::GetMultiRegionEndpointInput {
