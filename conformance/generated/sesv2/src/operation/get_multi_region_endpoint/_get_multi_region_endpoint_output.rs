...
pub struct GetMultiRegionEndpointOutput {
    ...
    pub routes: ::std::option::Option<::std::vec::Vec<super::types::Route>>,
    ...
    /// </ul>
    pub status: ::std::option::Option<super::types::Status>,
...
impl GetMultiRegionEndpointOutput {
    ...
    /// <p><code>DELETING</code> – The resource is being deleted as requested.</p></li>
    /// </ul>
    pub fn status(&self) -> ::std::option::Option<&super::types::Status> {
        self.status.as_ref()
    }
    /// <p>The time stamp of when the multi-region endpoint (global-endpoint) was created.</p>
...
impl GetMultiRegionEndpointOutput {
    ...
    pub fn builder() -> super::operation::get_multi_region_endpoint::builders::GetMultiRegionEndpointOutputBuilder {
        super::operation::get_multi_region_endpoint::builders::GetMultiRegionEndpointOutputBuilder::default()
    }
}
...
pub struct GetMultiRegionEndpointOutputBuilder {
    ...
    pub(crate) routes: ::std::option::Option<::std::vec::Vec<super::types::Route>>,
    pub(crate) status: ::std::option::Option<super::types::Status>,
...
impl GetMultiRegionEndpointOutputBuilder {
    ...
    ///
    /// <p>Contains routes information for the multi-region endpoint (global-endpoint).</p>
    pub fn routes(mut self, input: super::types::Route) -> Self {
    ...
    /// <p>Contains routes information for the multi-region endpoint (global-endpoint).</p>
    pub fn set_routes(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::Route>>) -> Self {
        self.routes = input;
        self
    }
    /// <p>Contains routes information for the multi-region endpoint (global-endpoint).</p>
    pub fn get_routes(&self) -> &::std::option::Option<::std::vec::Vec<super::types::Route>> {
        &self.routes
    }
    /// <p>The status of the multi-region endpoint (global-endpoint).</p>
    /// <ul>
    ...
    /// <p><code>DELETING</code> – The resource is being deleted as requested.</p></li>
    /// </ul>
    pub fn status(mut self, input: super::types::Status) -> Self {
    ...
    /// <p><code>DELETING</code> – The resource is being deleted as requested.</p></li>
    /// </ul>
    pub fn set_status(mut self, input: ::std::option::Option<super::types::Status>) -> Self {
        self.status = input;
        self
    }
    /// <p>The status of the multi-region endpoint (global-endpoint).</p>
    ...
    /// <p><code>DELETING</code> – The resource is being deleted as requested.</p></li>
    /// </ul>
    pub fn get_status(&self) -> &::std::option::Option<super::types::Status> {
        &self.status
    }
    /// <p>The time stamp of when the multi-region endpoint (global-endpoint) was created.</p>
    ...
    pub fn build(self) -> super::operation::get_multi_region_endpoint::GetMultiRegionEndpointOutput {
