...
pub struct UpdateReputationEntityCustomerManagedStatusInput {
    ...
    /// </ul>
    pub sending_status: ::std::option::Option<super::types::SendingStatus>,
}
impl UpdateReputationEntityCustomerManagedStatusInput {
    ...
    /// <p><code>REINSTATED</code> – Allow sending even if there are active reputation findings.</p></li>
    /// </ul>
    pub fn sending_status(&self) -> ::std::option::Option<&super::types::SendingStatus> {
...
impl UpdateReputationEntityCustomerManagedStatusInput {
    ...
    pub fn builder(
        ...
        super::operation::update_reputation_entity_customer_managed_status::builders::UpdateReputationEntityCustomerManagedStatusInputBuilder::default(
        )
    }
}
...
pub struct UpdateReputationEntityCustomerManagedStatusInputBuilder {
    ...
    pub(crate) sending_status: ::std::option::Option<super::types::SendingStatus>,
}
impl UpdateReputationEntityCustomerManagedStatusInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::update_reputation_entity_customer_managed_status::UpdateReputationEntityCustomerManagedStatusInput,
