...
impl UpdateReputationEntityCustomerManagedStatusOutput {
    ...
    pub fn builder(
        ...
        super::operation::update_reputation_entity_customer_managed_status::builders::UpdateReputationEntityCustomerManagedStatusOutputBuilder::default()
    }
}
...
impl UpdateReputationEntityCustomerManagedStatusOutputBuilder {
    ...
    pub fn build(self) -> super::operation::update_reputation_entity_customer_managed_status::UpdateReputationEntityCustomerManagedStatusOutput {
