...
pub struct GetEmailIdentityOutput {
    ...
    pub identity_type: ::std::option::Option<super::types::IdentityType>,
    ...
    pub dkim_attributes: ::std::option::Option<super::types::DkimAttributes>,
    /// <p>An object that contains information about the Mail-From attributes for the email identity.</p>
    pub mail_from_attributes: ::std::option::Option<super::types::MailFromAttributes>,
    ...
    /// </ul>
    pub verification_status: ::std::option::Option<super::types::VerificationStatus>,
    /// <p>An object that contains additional information about the verification status for the identity.</p>
    pub verification_info: ::std::option::Option<super::types::VerificationInfo>,
    _request_id: Option<String>,
}
impl GetEmailIdentityOutput {
    /// <p>The email identity type. Note: the <code>MANAGED_DOMAIN</code> identity type is not supported.</p>
    pub fn identity_type(&self) -> ::std::option::Option<&super::types::IdentityType> {
    ...
    /// <p>An object that contains information about the DKIM attributes for the identity.</p>
    pub fn dkim_attributes(&self) -> ::std::option::Option<&super::types::DkimAttributes> {
        self.dkim_attributes.as_ref()
    }
    /// <p>An object that contains information about the Mail-From attributes for the email identity.</p>
    pub fn mail_from_attributes(&self) -> ::std::option::Option<&super::types::MailFromAttributes> {
    ...
    /// <p><code>NOT_STARTED</code> – The verification process hasn't been initiated for the identity.</p></li>
    /// </ul>
    pub fn verification_status(&self) -> ::std::option::Option<&super::types::VerificationStatus> {
        self.verification_status.as_ref()
    }
    /// <p>An object that contains additional information about the verification status for the identity.</p>
    pub fn verification_info(&self) -> ::std::option::Option<&super::types::VerificationInfo> {
...
impl GetEmailIdentityOutput {
    ...
    pub fn builder() -> super::operation::get_email_identity::builders::GetEmailIdentityOutputBuilder {
        super::operation::get_email_identity::builders::GetEmailIdentityOutputBuilder::default()
    }
}
...
pub struct GetEmailIdentityOutputBuilder {
    pub(crate) identity_type: ::std::option::Option<super::types::IdentityType>,
    pub(crate) feedback_forwarding_status: ::std::option::Option<bool>,
    pub(crate) verified_for_sending_status: ::std::option::Option<bool>,
    pub(crate) dkim_attributes: ::std::option::Option<super::types::DkimAttributes>,
    pub(crate) mail_from_attributes: ::std::option::Option<super::types::MailFromAttributes>,
    ...
    pub(crate) verification_status: ::std::option::Option<super::types::VerificationStatus>,
    pub(crate) verification_info: ::std::option::Option<super::types::VerificationInfo>,
    _request_id: Option<String>,
}
impl GetEmailIdentityOutputBuilder {
    /// <p>The email identity type. Note: the <code>MANAGED_DOMAIN</code> identity type is not supported.</p>
    pub fn identity_type(mut self, input: super::types::IdentityType) -> Self {
        self.identity_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The email identity type. Note: the <code>MANAGED_DOMAIN</code> identity type is not supported.</p>
    pub fn set_identity_type(mut self, input: ::std::option::Option<super::types::IdentityType>) -> Self {
        self.identity_type = input;
        self
    }
    /// <p>The email identity type. Note: the <code>MANAGED_DOMAIN</code> identity type is not supported.</p>
    pub fn get_identity_type(&self) -> &::std::option::Option<super::types::IdentityType> {
        &self.identity_type
    }
    /// <p>The feedback forwarding configuration for the identity.</p>
    /// <p>If the value is <code>true</code>, you receive email notifications when bounce or complaint events occur. These notifications are sent to the address that you specified in the <code>Return-Path</code> header of the original email.</p>
    ...
    /// <p>An object that contains information about the DKIM attributes for the identity.</p>
    pub fn dkim_attributes(mut self, input: super::types::DkimAttributes) -> Self {
        self.dkim_attributes = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object that contains information about the DKIM attributes for the identity.</p>
    pub fn set_dkim_attributes(mut self, input: ::std::option::Option<super::types::DkimAttributes>) -> Self {
        self.dkim_attributes = input;
        self
    }
    /// <p>An object that contains information about the DKIM attributes for the identity.</p>
    pub fn get_dkim_attributes(&self) -> &::std::option::Option<super::types::DkimAttributes> {
        &self.dkim_attributes
    }
    /// <p>An object that contains information about the Mail-From attributes for the email identity.</p>
    pub fn mail_from_attributes(mut self, input: super::types::MailFromAttributes) -> Self {
        self.mail_from_attributes = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object that contains information about the Mail-From attributes for the email identity.</p>
    pub fn set_mail_from_attributes(mut self, input: ::std::option::Option<super::types::MailFromAttributes>) -> Self {
        self.mail_from_attributes = input;
        self
    }
    /// <p>An object that contains information about the Mail-From attributes for the email identity.</p>
    pub fn get_mail_from_attributes(&self) -> &::std::option::Option<super::types::MailFromAttributes> {
    ...
    /// <p><code>NOT_STARTED</code> – The verification process hasn't been initiated for the identity.</p></li>
    /// </ul>
    pub fn verification_status(mut self, input: super::types::VerificationStatus) -> Self {
    ...
    /// <p><code>NOT_STARTED</code> – The verification process hasn't been initiated for the identity.</p></li>
    /// </ul>
    pub fn set_verification_status(mut self, input: ::std::option::Option<super::types::VerificationStatus>) -> Self {
    ...
    /// <p><code>NOT_STARTED</code> – The verification process hasn't been initiated for the identity.</p></li>
    /// </ul>
    pub fn get_verification_status(&self) -> &::std::option::Option<super::types::VerificationStatus> {
        &self.verification_status
    }
    /// <p>An object that contains additional information about the verification status for the identity.</p>
    pub fn verification_info(mut self, input: super::types::VerificationInfo) -> Self {
        self.verification_info = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object that contains additional information about the verification status for the identity.</p>
    pub fn set_verification_info(mut self, input: ::std::option::Option<super::types::VerificationInfo>) -> Self {
        self.verification_info = input;
        self
    }
    /// <p>An object that contains additional information about the verification status for the identity.</p>
    pub fn get_verification_info(&self) -> &::std::option::Option<super::types::VerificationInfo> {
    ...
    pub fn build(self) -> super::operation::get_email_identity::GetEmailIdentityOutput {
        super::operation::get_email_identity::GetEmailIdentityOutput {
