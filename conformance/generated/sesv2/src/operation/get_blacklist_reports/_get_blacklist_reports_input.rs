...
impl GetBlacklistReportsInput {
    ...
    pub fn builder() -> super::operation::get_blacklist_reports::builders::GetBlacklistReportsInputBuilder {
        super::operation::get_blacklist_reports::builders::GetBlacklistReportsInputBuilder::default()
    }
}
...
impl GetBlacklistReportsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_blacklist_reports::GetBlacklistReportsInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::get_blacklist_reports::GetBlacklistReportsInput {
