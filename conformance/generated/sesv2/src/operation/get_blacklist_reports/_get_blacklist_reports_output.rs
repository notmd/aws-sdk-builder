...
pub struct GetBlacklistReportsOutput {
    ...
    pub blacklist_report: ::std::collections::HashMap<::std::string::String, ::std::vec::Vec<super::types::BlacklistEntry>>,
    _request_id: Option<String>,
}
impl GetBlacklistReportsOutput {
    /// <p>An object that contains information about a blacklist that one of your dedicated IP addresses appears on.</p>
    pub fn blacklist_report(&self) -> &::std::collections::HashMap<::std::string::String, ::std::vec::Vec<super::types::BlacklistEntry>> {
...
impl GetBlacklistReportsOutput {
    ...
    pub fn builder() -> super::operation::get_blacklist_reports::builders::GetBlacklistReportsOutputBuilder {
        super::operation::get_blacklist_reports::builders::GetBlacklistReportsOutputBuilder::default()
    }
}
...
pub struct GetBlacklistReportsOutputBuilder {
    pub(crate) blacklist_report:
        ::std::option::Option<::std::collections::HashMap<::std::string::String, ::std::vec::Vec<super::types::BlacklistEntry>>>,
    _request_id: Option<String>,
}
impl GetBlacklistReportsOutputBuilder {
    ...
    ///
    /// <p>An object that contains information about a blacklist that one of your dedicated IP addresses appears on.</p>
    pub fn blacklist_report(mut self, k: impl ::std::convert::Into<::std::string::String>, v: ::std::vec::Vec<super::types::BlacklistEntry>) -> Self {
    ...
    pub fn set_blacklist_report(
        mut self,
        input: ::std::option::Option<::std::collections::HashMap<::std::string::String, ::std::vec::Vec<super::types::BlacklistEntry>>>,
    ) -> Self {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_blacklist_reports::GetBlacklistReportsOutput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::get_blacklist_reports::GetBlacklistReportsOutput {
