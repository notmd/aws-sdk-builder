...
impl TestRenderEmailTemplateOutput {
    ...
    pub fn builder() -> super::operation::test_render_email_template::builders::TestRenderEmailTemplateOutputBuilder {
        super::operation::test_render_email_template::builders::TestRenderEmailTemplateOutputBuilder::default()
    }
}
...
impl TestRenderEmailTemplateOutputBuilder {
    ...
    > {
        ::std::result::Result::Ok(super::operation::test_render_email_template::TestRenderEmailTemplateOutput {
