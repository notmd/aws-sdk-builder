...
impl DeleteTenantResourceAssociationInput {
    ...
    pub fn builder() -> super::operation::delete_tenant_resource_association::builders::DeleteTenantResourceAssociationInputBuilder {
        super::operation::delete_tenant_resource_association::builders::DeleteTenantResourceAssociationInputBuilder::default()
    }
}
...
impl DeleteTenantResourceAssociationInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::delete_tenant_resource_association::DeleteTenantResourceAssociationInput,
