...
pub struct ListCustomVerificationEmailTemplatesOutput {
    ...
    pub custom_verification_email_templates: ::std::option::Option<::std::vec::Vec<super::types::CustomVerificationEmailTemplateMetadata>>,
...
impl ListCustomVerificationEmailTemplatesOutput {
    ...
    pub fn custom_verification_email_templates(&self) -> &[super::types::CustomVerificationEmailTemplateMetadata] {
...
impl ListCustomVerificationEmailTemplatesOutput {
    ...
    pub fn builder() -> super::operation::list_custom_verification_email_templates::builders::ListCustomVerificationEmailTemplatesOutputBuilder {
...
pub struct ListCustomVerificationEmailTemplatesOutputBuilder {
    pub(crate) custom_verification_email_templates: ::std::option::Option<::std::vec::Vec<super::types::CustomVerificationEmailTemplateMetadata>>,
...
impl ListCustomVerificationEmailTemplatesOutputBuilder {
    ...
    ///
    /// <p>A list of the custom verification email templates that exist in your account.</p>
    pub fn custom_verification_email_templates(mut self, input: super::types::CustomVerificationEmailTemplateMetadata) -> Self {
    ...
    pub fn set_custom_verification_email_templates(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::CustomVerificationEmailTemplateMetadata>>,
    ) -> Self {
    ...
    pub fn get_custom_verification_email_templates(
        &self,
    ) -> &::std::option::Option<::std::vec::Vec<super::types::CustomVerificationEmailTemplateMetadata>> {
    ...
    pub fn build(self) -> super::operation::list_custom_verification_email_templates::ListCustomVerificationEmailTemplatesOutput {
