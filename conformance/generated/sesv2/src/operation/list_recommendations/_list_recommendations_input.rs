...
pub struct ListRecommendationsInput {
    ...
    pub filter: ::std::option::Option<::std::collections::HashMap<super::types::ListRecommendationsFilterKey, ::std::string::String>>,
...
impl ListRecommendationsInput {
    /// <p>Filters applied when retrieving recommendations. Can eiter be an individual filter, or combinations of <code>STATUS</code> and <code>IMPACT</code> or <code>STATUS</code> and <code>TYPE</code></p>
    pub fn filter(&self) -> ::std::option::Option<&::std::collections::HashMap<super::types::ListRecommendationsFilterKey, ::std::string::String>> {
        self.filter.as_ref()
    }
    /// <p>A token returned from a previous call to <code>ListRecommendations</code> to indicate the position in the list of recommendations.</p>
...
impl ListRecommendationsInput {
    ...
    pub fn builder() -> super::operation::list_recommendations::builders::ListRecommendationsInputBuilder {
        super::operation::list_recommendations::builders::ListRecommendationsInputBuilder::default()
    }
}
...
pub struct ListRecommendationsInputBuilder {
    pub(crate) filter: ::std::option::Option<::std::collections::HashMap<super::types::ListRecommendationsFilterKey, ::std::string::String>>,
...
impl ListRecommendationsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_recommendations::ListRecommendationsInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::list_recommendations::ListRecommendationsInput {
            filter: self.filter,
