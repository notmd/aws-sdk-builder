...
pub use super::operation::list_reputation_entities::_list_reputation_entities_input::ListReputationEntitiesInputBuilder;

pub use super::operation::list_reputation_entities::_list_reputation_entities_output::ListReputationEntitiesOutputBuilder;

impl super::operation::list_reputation_entities::builders::ListReputationEntitiesInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::Client,
    ) -> ::std::result::Result<
        super::operation::list_reputation_entities::ListReputationEntitiesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::list_reputation_entities::ListReputationEntitiesError,
...
pub struct ListReputationEntitiesFluentBuilder {
    ...
    inner: super::operation::list_reputation_entities::builders::ListReputationEntitiesInputBuilder,
...
impl ListReputationEntitiesFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::list_reputation_entities::builders::ListReputationEntitiesInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::list_reputation_entities::ListReputationEntities::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::list_reputation_entities::ListReputationEntities::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::operation::list_reputation_entities::paginator::ListReputationEntitiesPaginator {
        super::operation::list_reputation_entities::paginator::ListReputationEntitiesPaginator::new(self.handle, self.inner)
    }
    ///
    ...
    pub fn filter(mut self, k: super::types::ReputationEntityFilterKey, v: impl ::std::convert::Into<::std::string::String>) -> Self {
    ...
    pub fn set_filter(
        mut self,
        input: ::std::option::Option<::std::collections::HashMap<super::types::ReputationEntityFilterKey, ::std::string::String>>,
    ) -> Self {
        self.inner = self.inner.set_filter(input);
        self
    }
    /// <p>An object that contains filters to apply when listing reputation entities. You can filter by entity type, reputation impact, sending status, or entity reference prefix.</p>
    pub fn get_filter(&self) -> &::std::option::Option<::std::collections::HashMap<super::types::ReputationEntityFilterKey, ::std::string::String>> {
