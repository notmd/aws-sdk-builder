...
pub struct ListReputationEntitiesInput {
    ...
    pub filter: ::std::option::Option<::std::collections::HashMap<super::types::ReputationEntityFilterKey, ::std::string::String>>,
...
impl ListReputationEntitiesInput {
    /// <p>An object that contains filters to apply when listing reputation entities. You can filter by entity type, reputation impact, sending status, or entity reference prefix.</p>
    pub fn filter(&self) -> ::std::option::Option<&::std::collections::HashMap<super::types::ReputationEntityFilterKey, ::std::string::String>> {
        self.filter.as_ref()
    }
    /// <p>A token returned from a previous call to <code>ListReputationEntities</code> to indicate the position in the list of reputation entities.</p>
...
impl ListReputationEntitiesInput {
    ...
    pub fn builder() -> super::operation::list_reputation_entities::builders::ListReputationEntitiesInputBuilder {
        super::operation::list_reputation_entities::builders::ListReputationEntitiesInputBuilder::default()
    }
}
...
pub struct ListReputationEntitiesInputBuilder {
    pub(crate) filter: ::std::option::Option<::std::collections::HashMap<super::types::ReputationEntityFilterKey, ::std::string::String>>,
...
impl ListReputationEntitiesInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::list_reputation_entities::ListReputationEntitiesInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::list_reputation_entities::ListReputationEntitiesInput {
            filter: self.filter,
