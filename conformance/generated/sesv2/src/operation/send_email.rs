    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::send_email::SendEmailError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::send_email::SendEmailOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SendEmailResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_send_email::de_send_email_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_send_email::de_send_email_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SendEmailRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::send_email::SendEmailInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::send_email::SendEmailInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_send_email::ser_send_email_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::send_email::SendEmailError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::send_email::_send_email_input::SendEmailInput;

pub use super::operation::send_email::_send_email_output::SendEmailOutput;
