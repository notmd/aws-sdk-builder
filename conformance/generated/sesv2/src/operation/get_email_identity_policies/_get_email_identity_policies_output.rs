...
impl GetEmailIdentityPoliciesOutput {
    ...
    pub fn builder() -> super::operation::get_email_identity_policies::builders::GetEmailIdentityPoliciesOutputBuilder {
        super::operation::get_email_identity_policies::builders::GetEmailIdentityPoliciesOutputBuilder::default()
    }
}
...
impl GetEmailIdentityPoliciesOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_email_identity_policies::GetEmailIdentityPoliciesOutput {
