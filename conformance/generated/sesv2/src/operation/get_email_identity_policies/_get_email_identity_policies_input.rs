...
impl GetEmailIdentityPoliciesInput {
    ...
    pub fn builder() -> super::operation::get_email_identity_policies::builders::GetEmailIdentityPoliciesInputBuilder {
        super::operation::get_email_identity_policies::builders::GetEmailIdentityPoliciesInputBuilder::default()
    }
}
...
impl GetEmailIdentityPoliciesInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::get_email_identity_policies::GetEmailIdentityPoliciesInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::get_email_identity_policies::GetEmailIdentityPoliciesInput {
