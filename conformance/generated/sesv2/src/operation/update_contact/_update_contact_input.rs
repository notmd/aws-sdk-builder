...
impl UpdateContactInput {
    ...
    pub fn builder() -> super::operation::update_contact::builders::UpdateContactInputBuilder {
        super::operation::update_contact::builders::UpdateContactInputBuilder::default()
    }
}
...
impl UpdateContactInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::update_contact::UpdateContactInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::update_contact::UpdateContactInput {
