...
impl ListContactListsInput {
    ...
    pub fn builder() -> super::operation::list_contact_lists::builders::ListContactListsInputBuilder {
        super::operation::list_contact_lists::builders::ListContactListsInputBuilder::default()
    }
}
...
impl ListContactListsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_contact_lists::ListContactListsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_contact_lists::ListContactListsInput {
