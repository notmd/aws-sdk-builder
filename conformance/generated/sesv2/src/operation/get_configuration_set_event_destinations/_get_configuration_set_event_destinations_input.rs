...
impl GetConfigurationSetEventDestinationsInput {
    ...
    pub fn builder() -> super::operation::get_configuration_set_event_destinations::builders::GetConfigurationSetEventDestinationsInputBuilder {
        super::operation::get_configuration_set_event_destinations::builders::GetConfigurationSetEventDestinationsInputBuilder::default()
    }
}
...
impl GetConfigurationSetEventDestinationsInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::get_configuration_set_event_destinations::GetConfigurationSetEventDestinationsInput,
