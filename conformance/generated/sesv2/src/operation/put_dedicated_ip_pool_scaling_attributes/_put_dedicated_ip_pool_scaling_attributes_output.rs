...
impl PutDedicatedIpPoolScalingAttributesOutput {
    ...
    pub fn builder() -> super::operation::put_dedicated_ip_pool_scaling_attributes::builders::PutDedicatedIpPoolScalingAttributesOutputBuilder {
...
impl PutDedicatedIpPoolScalingAttributesOutputBuilder {
    ...
    pub fn build(self) -> super::operation::put_dedicated_ip_pool_scaling_attributes::PutDedicatedIpPoolScalingAttributesOutput {
