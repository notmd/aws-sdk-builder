...
impl GetAccountInput {
    ...
    pub fn builder() -> super::operation::get_account::builders::GetAccountInputBuilder {
        super::operation::get_account::builders::GetAccountInputBuilder::default()
    }
}
...
impl GetAccountInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::get_account::GetAccountInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_account::GetAccountInput {})
    }
}
