...
pub struct GetAccountOutput {
    ...
    pub send_quota: ::std::option::Option<super::types::SendQuota>,
    ...
    pub suppression_attributes: ::std::option::Option<super::types::SuppressionAttributes>,
    /// <p>An object that defines your account details.</p>
    pub details: ::std::option::Option<super::types::AccountDetails>,
    /// <p>The VDM attributes that apply to your Amazon SES account.</p>
    pub vdm_attributes: ::std::option::Option<super::types::VdmAttributes>,
    ...
    pub pricing_attributes: ::std::option::Option<super::types::PricingAttributes>,
...
impl GetAccountOutput {
    ...
    /// <p>An object that contains information about the per-day and per-second sending limits for your Amazon SES account in the current Amazon Web Services Region.</p>
    pub fn send_quota(&self) -> ::std::option::Option<&super::types::SendQuota> {
    ...
    /// <p>An object that contains information about the email address suppression preferences for your account in the current Amazon Web Services Region.</p>
    pub fn suppression_attributes(&self) -> ::std::option::Option<&super::types::SuppressionAttributes> {
        self.suppression_attributes.as_ref()
    }
    /// <p>An object that defines your account details.</p>
    pub fn details(&self) -> ::std::option::Option<&super::types::AccountDetails> {
        self.details.as_ref()
    }
    /// <p>The VDM attributes that apply to your Amazon SES account.</p>
    pub fn vdm_attributes(&self) -> ::std::option::Option<&super::types::VdmAttributes> {
        self.vdm_attributes.as_ref()
    }
    /// <p>The pricing attributes that apply to your Amazon SES account, including the currently active pricing plan and any scheduled change.</p>
    pub fn pricing_attributes(&self) -> ::std::option::Option<&super::types::PricingAttributes> {
...
impl GetAccountOutput {
    ...
    pub fn builder() -> super::operation::get_account::builders::GetAccountOutputBuilder {
        super::operation::get_account::builders::GetAccountOutputBuilder::default()
    }
}
...
pub struct GetAccountOutputBuilder {
    ...
    pub(crate) send_quota: ::std::option::Option<super::types::SendQuota>,
    pub(crate) sending_enabled: ::std::option::Option<bool>,
    pub(crate) suppression_attributes: ::std::option::Option<super::types::SuppressionAttributes>,
    pub(crate) details: ::std::option::Option<super::types::AccountDetails>,
    pub(crate) vdm_attributes: ::std::option::Option<super::types::VdmAttributes>,
    pub(crate) pricing_attributes: ::std::option::Option<super::types::PricingAttributes>,
    _request_id: Option<String>,
}
impl GetAccountOutputBuilder {
    ...
    /// <p>An object that contains information about the per-day and per-second sending limits for your Amazon SES account in the current Amazon Web Services Region.</p>
    pub fn send_quota(mut self, input: super::types::SendQuota) -> Self {
        self.send_quota = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object that contains information about the per-day and per-second sending limits for your Amazon SES account in the current Amazon Web Services Region.</p>
    pub fn set_send_quota(mut self, input: ::std::option::Option<super::types::SendQuota>) -> Self {
        self.send_quota = input;
        self
    }
    /// <p>An object that contains information about the per-day and per-second sending limits for your Amazon SES account in the current Amazon Web Services Region.</p>
    pub fn get_send_quota(&self) -> &::std::option::Option<super::types::SendQuota> {
        &self.send_quota
    }
    /// <p>Indicates whether or not email sending is enabled for your Amazon SES account in the current Amazon Web Services Region.</p>
    ...
    /// <p>An object that contains information about the email address suppression preferences for your account in the current Amazon Web Services Region.</p>
    pub fn suppression_attributes(mut self, input: super::types::SuppressionAttributes) -> Self {
        self.suppression_attributes = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object that contains information about the email address suppression preferences for your account in the current Amazon Web Services Region.</p>
    pub fn set_suppression_attributes(mut self, input: ::std::option::Option<super::types::SuppressionAttributes>) -> Self {
        self.suppression_attributes = input;
        self
    }
    /// <p>An object that contains information about the email address suppression preferences for your account in the current Amazon Web Services Region.</p>
    pub fn get_suppression_attributes(&self) -> &::std::option::Option<super::types::SuppressionAttributes> {
        &self.suppression_attributes
    }
    /// <p>An object that defines your account details.</p>
    pub fn details(mut self, input: super::types::AccountDetails) -> Self {
        self.details = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object that defines your account details.</p>
    pub fn set_details(mut self, input: ::std::option::Option<super::types::AccountDetails>) -> Self {
        self.details = input;
        self
    }
    /// <p>An object that defines your account details.</p>
    pub fn get_details(&self) -> &::std::option::Option<super::types::AccountDetails> {
        &self.details
    }
    /// <p>The VDM attributes that apply to your Amazon SES account.</p>
    pub fn vdm_attributes(mut self, input: super::types::VdmAttributes) -> Self {
        self.vdm_attributes = ::std::option::Option::Some(input);
        self
    }
    /// <p>The VDM attributes that apply to your Amazon SES account.</p>
    pub fn set_vdm_attributes(mut self, input: ::std::option::Option<super::types::VdmAttributes>) -> Self {
        self.vdm_attributes = input;
        self
    }
    /// <p>The VDM attributes that apply to your Amazon SES account.</p>
    pub fn get_vdm_attributes(&self) -> &::std::option::Option<super::types::VdmAttributes> {
        &self.vdm_attributes
    }
    /// <p>The pricing attributes that apply to your Amazon SES account, including the currently active pricing plan and any scheduled change.</p>
    pub fn pricing_attributes(mut self, input: super::types::PricingAttributes) -> Self {
        self.pricing_attributes = ::std::option::Option::Some(input);
        self
    }
    /// <p>The pricing attributes that apply to your Amazon SES account, including the currently active pricing plan and any scheduled change.</p>
    pub fn set_pricing_attributes(mut self, input: ::std::option::Option<super::types::PricingAttributes>) -> Self {
        self.pricing_attributes = input;
        self
    }
    /// <p>The pricing attributes that apply to your Amazon SES account, including the currently active pricing plan and any scheduled change.</p>
    pub fn get_pricing_attributes(&self) -> &::std::option::Option<super::types::PricingAttributes> {
    ...
    pub fn build(self) -> super::operation::get_account::GetAccountOutput {
        super::operation::get_account::GetAccountOutput {
