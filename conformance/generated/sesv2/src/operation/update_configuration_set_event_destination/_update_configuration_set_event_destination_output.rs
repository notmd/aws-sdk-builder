...
impl UpdateConfigurationSetEventDestinationOutput {
    ...
    pub fn builder() -> super::operation::update_configuration_set_event_destination::builders::UpdateConfigurationSetEventDestinationOutputBuilder {
...
impl UpdateConfigurationSetEventDestinationOutputBuilder {
    ...
    pub fn build(self) -> super::operation::update_configuration_set_event_destination::UpdateConfigurationSetEventDestinationOutput {
