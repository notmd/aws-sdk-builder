...
pub struct UpdateConfigurationSetEventDestinationInput {
    ...
    pub event_destination: ::std::option::Option<super::types::EventDestinationDefinition>,
}
impl UpdateConfigurationSetEventDestinationInput {
    ...
    /// <p>An object that defines the event destination.</p>
    pub fn event_destination(&self) -> ::std::option::Option<&super::types::EventDestinationDefinition> {
...
impl UpdateConfigurationSetEventDestinationInput {
    ...
    pub fn builder() -> super::operation::update_configuration_set_event_destination::builders::UpdateConfigurationSetEventDestinationInputBuilder {
        super::operation::update_configuration_set_event_destination::builders::UpdateConfigurationSetEventDestinationInputBuilder::default()
    }
}
...
pub struct UpdateConfigurationSetEventDestinationInputBuilder {
    ...
    pub(crate) event_destination: ::std::option::Option<super::types::EventDestinationDefinition>,
}
impl UpdateConfigurationSetEventDestinationInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::update_configuration_set_event_destination::UpdateConfigurationSetEventDestinationInput,
