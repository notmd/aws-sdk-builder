...
impl PutAccountDetailsInput {
    ...
    pub fn builder() -> super::operation::put_account_details::builders::PutAccountDetailsInputBuilder {
        super::operation::put_account_details::builders::PutAccountDetailsInputBuilder::default()
    }
}
...
impl PutAccountDetailsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::put_account_details::PutAccountDetailsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::put_account_details::PutAccountDetailsInput {
