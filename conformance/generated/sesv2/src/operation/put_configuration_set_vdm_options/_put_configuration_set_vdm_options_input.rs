...
impl PutConfigurationSetVdmOptionsInput {
    ...
    pub fn builder() -> super::operation::put_configuration_set_vdm_options::builders::PutConfigurationSetVdmOptionsInputBuilder {
        super::operation::put_configuration_set_vdm_options::builders::PutConfigurationSetVdmOptionsInputBuilder::default()
    }
}
...
impl PutConfigurationSetVdmOptionsInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::put_configuration_set_vdm_options::PutConfigurationSetVdmOptionsInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::put_configuration_set_vdm_options::PutConfigurationSetVdmOptionsInput {
