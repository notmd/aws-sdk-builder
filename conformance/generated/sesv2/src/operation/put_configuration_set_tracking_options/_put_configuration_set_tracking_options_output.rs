...
impl PutConfigurationSetTrackingOptionsOutput {
    ...
    pub fn builder() -> super::operation::put_configuration_set_tracking_options::builders::PutConfigurationSetTrackingOptionsOutputBuilder {
...
impl PutConfigurationSetTrackingOptionsOutputBuilder {
    ...
    pub fn build(self) -> super::operation::put_configuration_set_tracking_options::PutConfigurationSetTrackingOptionsOutput {
