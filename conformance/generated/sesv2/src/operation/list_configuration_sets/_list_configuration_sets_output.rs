...
impl ListConfigurationSetsOutput {
    ...
    pub fn builder() -> super::operation::list_configuration_sets::builders::ListConfigurationSetsOutputBuilder {
        super::operation::list_configuration_sets::builders::ListConfigurationSetsOutputBuilder::default()
    }
}
...
impl ListConfigurationSetsOutputBuilder {
    ...
    pub fn build(self) -> super::operation::list_configuration_sets::ListConfigurationSetsOutput {
