...
impl GetCustomVerificationEmailTemplateOutput {
    ...
    pub fn builder() -> super::operation::get_custom_verification_email_template::builders::GetCustomVerificationEmailTemplateOutputBuilder {
...
impl GetCustomVerificationEmailTemplateOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_custom_verification_email_template::GetCustomVerificationEmailTemplateOutput {
