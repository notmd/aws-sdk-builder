...
impl GetCustomVerificationEmailTemplateInput {
    ...
    pub fn builder() -> super::operation::get_custom_verification_email_template::builders::GetCustomVerificationEmailTemplateInputBuilder {
        super::operation::get_custom_verification_email_template::builders::GetCustomVerificationEmailTemplateInputBuilder::default()
    }
}
...
impl GetCustomVerificationEmailTemplateInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::get_custom_verification_email_template::GetCustomVerificationEmailTemplateInput,
