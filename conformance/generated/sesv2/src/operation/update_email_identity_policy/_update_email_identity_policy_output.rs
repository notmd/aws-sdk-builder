...
impl UpdateEmailIdentityPolicyOutput {
    ...
    pub fn builder() -> super::operation::update_email_identity_policy::builders::UpdateEmailIdentityPolicyOutputBuilder {
        super::operation::update_email_identity_policy::builders::UpdateEmailIdentityPolicyOutputBuilder::default()
    }
}
...
impl UpdateEmailIdentityPolicyOutputBuilder {
    ...
    pub fn build(self) -> super::operation::update_email_identity_policy::UpdateEmailIdentityPolicyOutput {
