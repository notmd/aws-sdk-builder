...
impl UpdateEmailIdentityPolicyInput {
    ...
    pub fn builder() -> super::operation::update_email_identity_policy::builders::UpdateEmailIdentityPolicyInputBuilder {
        super::operation::update_email_identity_policy::builders::UpdateEmailIdentityPolicyInputBuilder::default()
    }
}
...
impl UpdateEmailIdentityPolicyInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::update_email_identity_policy::UpdateEmailIdentityPolicyInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::update_email_identity_policy::UpdateEmailIdentityPolicyInput {
