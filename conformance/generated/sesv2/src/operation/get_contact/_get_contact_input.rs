...
impl GetContactInput {
    ...
    pub fn builder() -> super::operation::get_contact::builders::GetContactInputBuilder {
        super::operation::get_contact::builders::GetContactInputBuilder::default()
    }
}
...
impl GetContactInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::get_contact::GetContactInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_contact::GetContactInput {
