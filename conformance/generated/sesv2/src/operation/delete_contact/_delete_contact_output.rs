...
impl DeleteContactOutput {
    ...
    pub fn builder() -> super::operation::delete_contact::builders::DeleteContactOutputBuilder {
        super::operation::delete_contact::builders::DeleteContactOutputBuilder::default()
    }
}
...
impl DeleteContactOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_contact::DeleteContactOutput {
