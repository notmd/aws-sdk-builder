...
impl CreateConfigurationSetEventDestinationOutput {
    ...
    pub fn builder() -> super::operation::create_configuration_set_event_destination::builders::CreateConfigurationSetEventDestinationOutputBuilder {
...
impl CreateConfigurationSetEventDestinationOutputBuilder {
    ...
    pub fn build(self) -> super::operation::create_configuration_set_event_destination::CreateConfigurationSetEventDestinationOutput {
