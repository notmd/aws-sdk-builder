...
impl CreateContactListInput {
    ...
    pub fn builder() -> super::operation::create_contact_list::builders::CreateContactListInputBuilder {
        super::operation::create_contact_list::builders::CreateContactListInputBuilder::default()
    }
}
...
impl CreateContactListInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::create_contact_list::CreateContactListInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::create_contact_list::CreateContactListInput {
