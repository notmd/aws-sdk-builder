...
impl PutAccountSendingAttributesInput {
    ...
    pub fn builder() -> super::operation::put_account_sending_attributes::builders::PutAccountSendingAttributesInputBuilder {
        super::operation::put_account_sending_attributes::builders::PutAccountSendingAttributesInputBuilder::default()
    }
}
...
impl PutAccountSendingAttributesInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::put_account_sending_attributes::PutAccountSendingAttributesInput,
