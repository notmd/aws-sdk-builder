...
impl PutEmailIdentityDkimAttributesOutput {
    ...
    pub fn builder() -> super::operation::put_email_identity_dkim_attributes::builders::PutEmailIdentityDkimAttributesOutputBuilder {
        super::operation::put_email_identity_dkim_attributes::builders::PutEmailIdentityDkimAttributesOutputBuilder::default()
    }
}
...
impl PutEmailIdentityDkimAttributesOutputBuilder {
    ...
    pub fn build(self) -> super::operation::put_email_identity_dkim_attributes::PutEmailIdentityDkimAttributesOutput {
