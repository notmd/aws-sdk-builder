...
pub use super::operation::put_email_identity_dkim_attributes::_put_email_identity_dkim_attributes_input::PutEmailIdentityDkimAttributesInputBuilder;

pub use super::operation::put_email_identity_dkim_attributes::_put_email_identity_dkim_attributes_output::PutEmailIdentityDkimAttributesOutputBuilder;

impl super::operation::put_email_identity_dkim_attributes::builders::PutEmailIdentityDkimAttributesInputBuilder {
...
pub struct PutEmailIdentityDkimAttributesFluentBuilder {
    ...
    inner: super::operation::put_email_identity_dkim_attributes::builders::PutEmailIdentityDkimAttributesInputBuilder,
...
impl PutEmailIdentityDkimAttributesFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::put_email_identity_dkim_attributes::builders::PutEmailIdentityDkimAttributesInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::put_email_identity_dkim_attributes::PutEmailIdentityDkimAttributes::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::put_email_identity_dkim_attributes::PutEmailIdentityDkimAttributes::orchestrate(&runtime_plugins, input).await
    }
