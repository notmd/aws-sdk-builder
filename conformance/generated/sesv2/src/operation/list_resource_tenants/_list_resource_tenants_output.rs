...
pub struct ListResourceTenantsOutput {
    ...
    pub resource_tenants: ::std::option::Option<::std::vec::Vec<super::types::ResourceTenantMetadata>>,
...
impl ListResourceTenantsOutput {
    ...
    pub fn resource_tenants(&self) -> &[super::types::ResourceTenantMetadata] {
...
impl ListResourceTenantsOutput {
    ...
    pub fn builder() -> super::operation::list_resource_tenants::builders::ListResourceTenantsOutputBuilder {
        super::operation::list_resource_tenants::builders::ListResourceTenantsOutputBuilder::default()
    }
}
...
pub struct ListResourceTenantsOutputBuilder {
    pub(crate) resource_tenants: ::std::option::Option<::std::vec::Vec<super::types::ResourceTenantMetadata>>,
...
impl ListResourceTenantsOutputBuilder {
    ...
    ///
    /// <p>An array that contains information about each tenant associated with the resource.</p>
    pub fn resource_tenants(mut self, input: super::types::ResourceTenantMetadata) -> Self {
    ...
    /// <p>An array that contains information about each tenant associated with the resource.</p>
    pub fn set_resource_tenants(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::ResourceTenantMetadata>>) -> Self {
        self.resource_tenants = input;
        self
    }
    /// <p>An array that contains information about each tenant associated with the resource.</p>
    pub fn get_resource_tenants(&self) -> &::std::option::Option<::std::vec::Vec<super::types::ResourceTenantMetadata>> {
    ...
    pub fn build(self) -> super::operation::list_resource_tenants::ListResourceTenantsOutput {
