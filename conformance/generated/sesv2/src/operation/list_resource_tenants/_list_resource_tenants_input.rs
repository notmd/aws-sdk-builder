...
impl ListResourceTenantsInput {
    ...
    pub fn builder() -> super::operation::list_resource_tenants::builders::ListResourceTenantsInputBuilder {
        super::operation::list_resource_tenants::builders::ListResourceTenantsInputBuilder::default()
    }
}
...
impl ListResourceTenantsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_resource_tenants::ListResourceTenantsInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::list_resource_tenants::ListResourceTenantsInput {
