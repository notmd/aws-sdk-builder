...
impl CreateConfigurationSetOutput {
    ...
    pub fn builder() -> super::operation::create_configuration_set::builders::CreateConfigurationSetOutputBuilder {
        super::operation::create_configuration_set::builders::CreateConfigurationSetOutputBuilder::default()
    }
}
...
impl CreateConfigurationSetOutputBuilder {
    ...
    pub fn build(self) -> super::operation::create_configuration_set::CreateConfigurationSetOutput {
