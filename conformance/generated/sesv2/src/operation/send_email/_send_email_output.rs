...
impl SendEmailOutput {
    ...
    pub fn builder() -> super::operation::send_email::builders::SendEmailOutputBuilder {
        super::operation::send_email::builders::SendEmailOutputBuilder::default()
    }
}
...
impl SendEmailOutputBuilder {
    ...
    pub fn build(self) -> super::operation::send_email::SendEmailOutput {
