...
pub struct SendEmailInput {
    ...
    pub content: ::std::option::Option<super::types::EmailContent>,
    ...
    pub email_tags: ::std::option::Option<::std::vec::Vec<super::types::MessageTag>>,
    ...
    pub list_management_options: ::std::option::Option<super::types::ListManagementOptions>,
    ...
    pub configuration_overrides: ::std::option::Option<super::types::ConfigurationOverrides>,
}
impl SendEmailInput {
    /// <p>The email address to use as the "From" address for the email. The address that you specify has to be verified.</p>
    ...
    /// <p>An object that contains the body of the message. You can send either a Simple message, Raw message, or a Templated message.</p>
    pub fn content(&self) -> ::std::option::Option<&super::types::EmailContent> {
        self.content.as_ref()
    }
    /// <p>A list of tags, in the form of name/value pairs, to apply to an email that you send using the <code>SendEmail</code> operation. Tags correspond to characteristics of the email that you define, so that you can publish email sending events.</p>
    ///
    ...
    pub fn email_tags(&self) -> &[super::types::MessageTag] {
    ...
    /// <p>An object used to specify a list or topic to which an email belongs, which will be used when a contact chooses to unsubscribe.</p>
    pub fn list_management_options(&self) -> ::std::option::Option<&super::types::ListManagementOptions> {
        self.list_management_options.as_ref()
    }
    /// <p>An object that overrides, for this message only, settings that would otherwise apply to it. Each setting that you don't override keeps the value that already applies.</p>
    pub fn configuration_overrides(&self) -> ::std::option::Option<&super::types::ConfigurationOverrides> {
...
impl SendEmailInput {
    ...
    pub fn builder() -> super::operation::send_email::builders::SendEmailInputBuilder {
        super::operation::send_email::builders::SendEmailInputBuilder::default()
    }
}
...
pub struct SendEmailInputBuilder {
    ...
    pub(crate) content: ::std::option::Option<super::types::EmailContent>,
    pub(crate) email_tags: ::std::option::Option<::std::vec::Vec<super::types::MessageTag>>,
    pub(crate) configuration_set_name: ::std::option::Option<::std::string::String>,
    pub(crate) endpoint_id: ::std::option::Option<::std::string::String>,
    pub(crate) tenant_name: ::std::option::Option<::std::string::String>,
    pub(crate) list_management_options: ::std::option::Option<super::types::ListManagementOptions>,
    pub(crate) configuration_overrides: ::std::option::Option<super::types::ConfigurationOverrides>,
}
impl SendEmailInputBuilder {
    ...
    pub fn content(mut self, input: super::types::EmailContent) -> Self {
        self.content = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object that contains the body of the message. You can send either a Simple message, Raw message, or a Templated message.</p>
    pub fn set_content(mut self, input: ::std::option::Option<super::types::EmailContent>) -> Self {
        self.content = input;
        self
    }
    /// <p>An object that contains the body of the message. You can send either a Simple message, Raw message, or a Templated message.</p>
    pub fn get_content(&self) -> &::std::option::Option<super::types::EmailContent> {
        &self.content
    }
    ...
    ///
    /// <p>A list of tags, in the form of name/value pairs, to apply to an email that you send using the <code>SendEmail</code> operation. Tags correspond to characteristics of the email that you define, so that you can publish email sending events.</p>
    pub fn email_tags(mut self, input: super::types::MessageTag) -> Self {
    ...
    /// <p>A list of tags, in the form of name/value pairs, to apply to an email that you send using the <code>SendEmail</code> operation. Tags correspond to characteristics of the email that you define, so that you can publish email sending events.</p>
    pub fn set_email_tags(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::MessageTag>>) -> Self {
        self.email_tags = input;
        self
    }
    /// <p>A list of tags, in the form of name/value pairs, to apply to an email that you send using the <code>SendEmail</code> operation. Tags correspond to characteristics of the email that you define, so that you can publish email sending events.</p>
    pub fn get_email_tags(&self) -> &::std::option::Option<::std::vec::Vec<super::types::MessageTag>> {
        &self.email_tags
    }
    /// <p>The name of the configuration set to use when sending the email.</p>
    ...
    /// <p>An object used to specify a list or topic to which an email belongs, which will be used when a contact chooses to unsubscribe.</p>
    pub fn list_management_options(mut self, input: super::types::ListManagementOptions) -> Self {
        self.list_management_options = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object used to specify a list or topic to which an email belongs, which will be used when a contact chooses to unsubscribe.</p>
    pub fn set_list_management_options(mut self, input: ::std::option::Option<super::types::ListManagementOptions>) -> Self {
        self.list_management_options = input;
        self
    }
    /// <p>An object used to specify a list or topic to which an email belongs, which will be used when a contact chooses to unsubscribe.</p>
    pub fn get_list_management_options(&self) -> &::std::option::Option<super::types::ListManagementOptions> {
        &self.list_management_options
    }
    /// <p>An object that overrides, for this message only, settings that would otherwise apply to it. Each setting that you don't override keeps the value that already applies.</p>
    pub fn configuration_overrides(mut self, input: super::types::ConfigurationOverrides) -> Self {
        self.configuration_overrides = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object that overrides, for this message only, settings that would otherwise apply to it. Each setting that you don't override keeps the value that already applies.</p>
    pub fn set_configuration_overrides(mut self, input: ::std::option::Option<super::types::ConfigurationOverrides>) -> Self {
        self.configuration_overrides = input;
        self
    }
    /// <p>An object that overrides, for this message only, settings that would otherwise apply to it. Each setting that you don't override keeps the value that already applies.</p>
    pub fn get_configuration_overrides(&self) -> &::std::option::Option<super::types::ConfigurationOverrides> {
        &self.configuration_overrides
    }
    /// Consumes the builder and constructs a [`SendEmailInput`](crate::operation::send_email::SendEmailInput).
    pub fn build(self) -> ::std::result::Result<super::operation::send_email::SendEmailInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::send_email::SendEmailInput {
