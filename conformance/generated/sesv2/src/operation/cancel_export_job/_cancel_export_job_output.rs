...
impl CancelExportJobOutput {
    ...
    pub fn builder() -> super::operation::cancel_export_job::builders::CancelExportJobOutputBuilder {
        super::operation::cancel_export_job::builders::CancelExportJobOutputBuilder::default()
    }
}
...
impl CancelExportJobOutputBuilder {
    ...
    pub fn build(self) -> super::operation::cancel_export_job::CancelExportJobOutput {
