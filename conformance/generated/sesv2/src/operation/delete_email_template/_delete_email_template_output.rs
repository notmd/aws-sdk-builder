...
impl DeleteEmailTemplateOutput {
    ...
    pub fn builder() -> super::operation::delete_email_template::builders::DeleteEmailTemplateOutputBuilder {
        super::operation::delete_email_template::builders::DeleteEmailTemplateOutputBuilder::default()
    }
}
...
impl DeleteEmailTemplateOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_email_template::DeleteEmailTemplateOutput {
