...
impl PutConfigurationSetReputationOptionsInput {
    ...
    pub fn builder() -> super::operation::put_configuration_set_reputation_options::builders::PutConfigurationSetReputationOptionsInputBuilder {
        super::operation::put_configuration_set_reputation_options::builders::PutConfigurationSetReputationOptionsInputBuilder::default()
    }
}
