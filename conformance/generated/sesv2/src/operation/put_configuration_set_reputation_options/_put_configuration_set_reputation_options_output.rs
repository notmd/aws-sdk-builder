...
impl PutConfigurationSetReputationOptionsOutput {
    ...
    pub fn builder() -> super::operation::put_configuration_set_reputation_options::builders::PutConfigurationSetReputationOptionsOutputBuilder {
...
impl PutConfigurationSetReputationOptionsOutputBuilder {
    ...
    pub fn build(self) -> super::operation::put_configuration_set_reputation_options::PutConfigurationSetReputationOptionsOutput {
