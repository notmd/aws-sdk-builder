...
impl PutConfigurationSetArchivingOptionsOutput {
    ...
    pub fn builder() -> super::operation::put_configuration_set_archiving_options::builders::PutConfigurationSetArchivingOptionsOutputBuilder {
...
impl PutConfigurationSetArchivingOptionsOutputBuilder {
    ...
    pub fn build(self) -> super::operation::put_configuration_set_archiving_options::PutConfigurationSetArchivingOptionsOutput {
