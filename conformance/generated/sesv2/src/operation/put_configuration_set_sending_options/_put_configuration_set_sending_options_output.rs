...
impl PutConfigurationSetSendingOptionsOutput {
    ...
    pub fn builder() -> super::operation::put_configuration_set_sending_options::builders::PutConfigurationSetSendingOptionsOutputBuilder {
        super::operation::put_configuration_set_sending_options::builders::PutConfigurationSetSendingOptionsOutputBuilder::default()
    }
}
...
impl PutConfigurationSetSendingOptionsOutputBuilder {
    ...
    pub fn build(self) -> super::operation::put_configuration_set_sending_options::PutConfigurationSetSendingOptionsOutput {
