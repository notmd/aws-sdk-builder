...
pub struct SendBulkEmailOutput {
    ...
    pub bulk_email_entry_results: ::std::vec::Vec<super::types::BulkEmailEntryResult>,
    _request_id: Option<String>,
}
impl SendBulkEmailOutput {
    /// <p>One object per intended recipient. Check each response object and retry any messages with a failure status.</p>
    pub fn bulk_email_entry_results(&self) -> &[super::types::BulkEmailEntryResult] {
        use std::ops::Deref;
...
impl SendBulkEmailOutput {
    ...
    pub fn builder() -> super::operation::send_bulk_email::builders::SendBulkEmailOutputBuilder {
        super::operation::send_bulk_email::builders::SendBulkEmailOutputBuilder::default()
    }
}
...
pub struct SendBulkEmailOutputBuilder {
    pub(crate) bulk_email_entry_results: ::std::option::Option<::std::vec::Vec<super::types::BulkEmailEntryResult>>,
    _request_id: Option<String>,
}
impl SendBulkEmailOutputBuilder {
    ...
    ///
    /// <p>One object per intended recipient. Check each response object and retry any messages with a failure status.</p>
    pub fn bulk_email_entry_results(mut self, input: super::types::BulkEmailEntryResult) -> Self {
    ...
    /// <p>One object per intended recipient. Check each response object and retry any messages with a failure status.</p>
    pub fn set_bulk_email_entry_results(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::BulkEmailEntryResult>>) -> Self {
        self.bulk_email_entry_results = input;
        self
    }
    /// <p>One object per intended recipient. Check each response object and retry any messages with a failure status.</p>
    pub fn get_bulk_email_entry_results(&self) -> &::std::option::Option<::std::vec::Vec<super::types::BulkEmailEntryResult>> {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::send_bulk_email::SendBulkEmailOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::send_bulk_email::SendBulkEmailOutput {
