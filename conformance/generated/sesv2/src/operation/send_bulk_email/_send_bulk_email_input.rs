...
pub struct SendBulkEmailInput {
    ...
    pub default_email_tags: ::std::option::Option<::std::vec::Vec<super::types::MessageTag>>,
    /// <p>An object that contains the body of the message. You can specify a template message.</p>
    pub default_content: ::std::option::Option<super::types::BulkEmailContent>,
    /// <p>The list of bulk email entry objects.</p>
    pub bulk_email_entries: ::std::option::Option<::std::vec::Vec<super::types::BulkEmailEntry>>,
...
impl SendBulkEmailInput {
    ...
    pub fn default_email_tags(&self) -> &[super::types::MessageTag] {
        self.default_email_tags.as_deref().unwrap_or_default()
    }
    /// <p>An object that contains the body of the message. You can specify a template message.</p>
    pub fn default_content(&self) -> ::std::option::Option<&super::types::BulkEmailContent> {
    ...
    pub fn bulk_email_entries(&self) -> &[super::types::BulkEmailEntry] {
...
impl SendBulkEmailInput {
    ...
    pub fn builder() -> super::operation::send_bulk_email::builders::SendBulkEmailInputBuilder {
        super::operation::send_bulk_email::builders::SendBulkEmailInputBuilder::default()
    }
}
...
pub struct SendBulkEmailInputBuilder {
    ...
    pub(crate) default_email_tags: ::std::option::Option<::std::vec::Vec<super::types::MessageTag>>,
    pub(crate) default_content: ::std::option::Option<super::types::BulkEmailContent>,
    pub(crate) bulk_email_entries: ::std::option::Option<::std::vec::Vec<super::types::BulkEmailEntry>>,
...
impl SendBulkEmailInputBuilder {
    ...
    ///
    /// <p>A list of tags, in the form of name/value pairs, to apply to an email that you send using the <code>SendEmail</code> operation. Tags correspond to characteristics of the email that you define, so that you can publish email sending events.</p>
    pub fn default_email_tags(mut self, input: super::types::MessageTag) -> Self {
    ...
    /// <p>A list of tags, in the form of name/value pairs, to apply to an email that you send using the <code>SendEmail</code> operation. Tags correspond to characteristics of the email that you define, so that you can publish email sending events.</p>
    pub fn set_default_email_tags(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::MessageTag>>) -> Self {
        self.default_email_tags = input;
        self
    }
    /// <p>A list of tags, in the form of name/value pairs, to apply to an email that you send using the <code>SendEmail</code> operation. Tags correspond to characteristics of the email that you define, so that you can publish email sending events.</p>
    pub fn get_default_email_tags(&self) -> &::std::option::Option<::std::vec::Vec<super::types::MessageTag>> {
        &self.default_email_tags
    }
    /// <p>An object that contains the body of the message. You can specify a template message.</p>
    /// This field is required.
    pub fn default_content(mut self, input: super::types::BulkEmailContent) -> Self {
        self.default_content = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object that contains the body of the message. You can specify a template message.</p>
    pub fn set_default_content(mut self, input: ::std::option::Option<super::types::BulkEmailContent>) -> Self {
        self.default_content = input;
        self
    }
    /// <p>An object that contains the body of the message. You can specify a template message.</p>
    pub fn get_default_content(&self) -> &::std::option::Option<super::types::BulkEmailContent> {
    ...
    ///
    /// <p>The list of bulk email entry objects.</p>
    pub fn bulk_email_entries(mut self, input: super::types::BulkEmailEntry) -> Self {
    ...
    /// <p>The list of bulk email entry objects.</p>
    pub fn set_bulk_email_entries(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::BulkEmailEntry>>) -> Self {
        self.bulk_email_entries = input;
        self
    }
    /// <p>The list of bulk email entry objects.</p>
    pub fn get_bulk_email_entries(&self) -> &::std::option::Option<::std::vec::Vec<super::types::BulkEmailEntry>> {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::send_bulk_email::SendBulkEmailInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::send_bulk_email::SendBulkEmailInput {
