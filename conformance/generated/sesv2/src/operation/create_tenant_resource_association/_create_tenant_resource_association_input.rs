...
impl CreateTenantResourceAssociationInput {
    ...
    pub fn builder() -> super::operation::create_tenant_resource_association::builders::CreateTenantResourceAssociationInputBuilder {
        super::operation::create_tenant_resource_association::builders::CreateTenantResourceAssociationInputBuilder::default()
    }
}
...
impl CreateTenantResourceAssociationInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::create_tenant_resource_association::CreateTenantResourceAssociationInput,
