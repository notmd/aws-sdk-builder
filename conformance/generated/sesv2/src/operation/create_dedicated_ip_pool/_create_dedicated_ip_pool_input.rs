...
pub struct CreateDedicatedIpPoolInput {
    ...
    pub scaling_mode: ::std::option::Option<super::types::ScalingMode>,
}
impl CreateDedicatedIpPoolInput {
    ...
    /// <p>The type of scaling mode.</p>
    pub fn scaling_mode(&self) -> ::std::option::Option<&super::types::ScalingMode> {
...
impl CreateDedicatedIpPoolInput {
    ...
    pub fn builder() -> super::operation::create_dedicated_ip_pool::builders::CreateDedicatedIpPoolInputBuilder {
        super::operation::create_dedicated_ip_pool::builders::CreateDedicatedIpPoolInputBuilder::default()
    }
}
...
pub struct CreateDedicatedIpPoolInputBuilder {
    ...
    pub(crate) scaling_mode: ::std::option::Option<super::types::ScalingMode>,
}
impl CreateDedicatedIpPoolInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::create_dedicated_ip_pool::CreateDedicatedIpPoolInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::create_dedicated_ip_pool::CreateDedicatedIpPoolInput {
