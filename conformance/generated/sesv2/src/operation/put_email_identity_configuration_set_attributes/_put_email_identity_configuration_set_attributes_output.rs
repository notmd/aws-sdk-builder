...
impl PutEmailIdentityConfigurationSetAttributesOutput {
    ...
    pub fn builder(
        ...
        super::operation::put_email_identity_configuration_set_attributes::builders::PutEmailIdentityConfigurationSetAttributesOutputBuilder::default(
        )
    }
}
...
impl PutEmailIdentityConfigurationSetAttributesOutputBuilder {
    ...
    pub fn build(self) -> super::operation::put_email_identity_configuration_set_attributes::PutEmailIdentityConfigurationSetAttributesOutput {
