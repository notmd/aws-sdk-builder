...
impl PutEmailIdentityConfigurationSetAttributesInput {
    ...
    pub fn builder(
        ...
        super::operation::put_email_identity_configuration_set_attributes::builders::PutEmailIdentityConfigurationSetAttributesInputBuilder::default()
    }
}
...
impl PutEmailIdentityConfigurationSetAttributesInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::put_email_identity_configuration_set_attributes::PutEmailIdentityConfigurationSetAttributesInput,
