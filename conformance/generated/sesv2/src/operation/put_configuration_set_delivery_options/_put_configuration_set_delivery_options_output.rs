...
impl PutConfigurationSetDeliveryOptionsOutput {
    ...
    pub fn builder() -> super::operation::put_configuration_set_delivery_options::builders::PutConfigurationSetDeliveryOptionsOutputBuilder {
...
impl PutConfigurationSetDeliveryOptionsOutputBuilder {
    ...
    pub fn build(self) -> super::operation::put_configuration_set_delivery_options::PutConfigurationSetDeliveryOptionsOutput {
