...
pub use super::operation::put_configuration_set_delivery_options::_put_configuration_set_delivery_options_input::PutConfigurationSetDeliveryOptionsInputBuilder;

pub use super::operation::put_configuration_set_delivery_options::_put_configuration_set_delivery_options_output::PutConfigurationSetDeliveryOptionsOutputBuilder;

impl super::operation::put_configuration_set_delivery_options::builders::PutConfigurationSetDeliveryOptionsInputBuilder {
...
pub struct PutConfigurationSetDeliveryOptionsFluentBuilder {
    ...
    inner: super::operation::put_configuration_set_delivery_options::builders::PutConfigurationSetDeliveryOptionsInputBuilder,
...
impl PutConfigurationSetDeliveryOptionsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::put_configuration_set_delivery_options::builders::PutConfigurationSetDeliveryOptionsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::put_configuration_set_delivery_options::PutConfigurationSetDeliveryOptions::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::put_configuration_set_delivery_options::PutConfigurationSetDeliveryOptions::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn tls_policy(mut self, input: super::types::TlsPolicy) -> Self {
        self.inner = self.inner.tls_policy(input);
        self
    }
    /// <p>Specifies whether messages that use the configuration set are required to use Transport Layer Security (TLS). If the value is <code>Require</code>, messages are only delivered if a TLS connection can be established. If the value is <code>Optional</code>, messages can be delivered in plain text if a TLS connection can't be established.</p>
    pub fn set_tls_policy(mut self, input: ::std::option::Option<super::types::TlsPolicy>) -> Self {
        self.inner = self.inner.set_tls_policy(input);
        self
    }
    /// <p>Specifies whether messages that use the configuration set are required to use Transport Layer Security (TLS). If the value is <code>Require</code>, messages are only delivered if a TLS connection can be established. If the value is <code>Optional</code>, messages can be delivered in plain text if a TLS connection can't be established.</p>
    pub fn get_tls_policy(&self) -> &::std::option::Option<super::types::TlsPolicy> {
