...
pub struct ListDomainDeliverabilityCampaignsOutput {
    ...
    pub domain_deliverability_campaigns: ::std::vec::Vec<super::types::DomainDeliverabilityCampaign>,
...
impl ListDomainDeliverabilityCampaignsOutput {
    /// <p>An array of responses, one for each campaign that used the domain to send email during the specified time range.</p>
    pub fn domain_deliverability_campaigns(&self) -> &[super::types::DomainDeliverabilityCampaign] {
        use std::ops::Deref;
...
impl ListDomainDeliverabilityCampaignsOutput {
    ...
    pub fn builder() -> super::operation::list_domain_deliverability_campaigns::builders::ListDomainDeliverabilityCampaignsOutputBuilder {
        super::operation::list_domain_deliverability_campaigns::builders::ListDomainDeliverabilityCampaignsOutputBuilder::default()
    }
}
...
pub struct ListDomainDeliverabilityCampaignsOutputBuilder {
    pub(crate) domain_deliverability_campaigns: ::std::option::Option<::std::vec::Vec<super::types::DomainDeliverabilityCampaign>>,
...
impl ListDomainDeliverabilityCampaignsOutputBuilder {
    ...
    ///
    /// <p>An array of responses, one for each campaign that used the domain to send email during the specified time range.</p>
    pub fn domain_deliverability_campaigns(mut self, input: super::types::DomainDeliverabilityCampaign) -> Self {
    ...
    pub fn set_domain_deliverability_campaigns(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::DomainDeliverabilityCampaign>>,
    ) -> Self {
        self.domain_deliverability_campaigns = input;
        self
    }
    /// <p>An array of responses, one for each campaign that used the domain to send email during the specified time range.</p>
    pub fn get_domain_deliverability_campaigns(&self) -> &::std::option::Option<::std::vec::Vec<super::types::DomainDeliverabilityCampaign>> {
