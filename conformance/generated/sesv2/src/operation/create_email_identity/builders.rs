...
pub use super::operation::create_email_identity::_create_email_identity_input::CreateEmailIdentityInputBuilder;

pub use super::operation::create_email_identity::_create_email_identity_output::CreateEmailIdentityOutputBuilder;

impl super::operation::create_email_identity::builders::CreateEmailIdentityInputBuilder {
...
pub struct CreateEmailIdentityFluentBuilder {
    ...
    inner: super::operation::create_email_identity::builders::CreateEmailIdentityInputBuilder,
...
impl CreateEmailIdentityFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::create_email_identity::builders::CreateEmailIdentityInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::create_email_identity::CreateEmailIdentity::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::create_email_identity::CreateEmailIdentity::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn dkim_signing_attributes(mut self, input: super::types::DkimSigningAttributes) -> Self {
        self.inner = self.inner.dkim_signing_attributes(input);
        self
    }
    /// <p>If your request includes this object, Amazon SES configures the identity to use Bring Your Own DKIM (BYODKIM) for DKIM authentication purposes, or, configures the key length to be used for <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/easy-dkim.html">Easy DKIM</a>.</p>
    /// <p>You can only specify this object if the email identity is a domain, as opposed to an address.</p>
    pub fn set_dkim_signing_attributes(mut self, input: ::std::option::Option<super::types::DkimSigningAttributes>) -> Self {
        self.inner = self.inner.set_dkim_signing_attributes(input);
        self
    }
    /// <p>If your request includes this object, Amazon SES configures the identity to use Bring Your Own DKIM (BYODKIM) for DKIM authentication purposes, or, configures the key length to be used for <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/easy-dkim.html">Easy DKIM</a>.</p>
    /// <p>You can only specify this object if the email identity is a domain, as opposed to an address.</p>
    pub fn get_dkim_signing_attributes(&self) -> &::std::option::Option<super::types::DkimSigningAttributes> {
