...
impl ListDedicatedIpPoolsOutput {
    ...
    pub fn builder() -> super::operation::list_dedicated_ip_pools::builders::ListDedicatedIpPoolsOutputBuilder {
        super::operation::list_dedicated_ip_pools::builders::ListDedicatedIpPoolsOutputBuilder::default()
    }
}
...
impl ListDedicatedIpPoolsOutputBuilder {
    ...
    pub fn build(self) -> super::operation::list_dedicated_ip_pools::ListDedicatedIpPoolsOutput {
