...
impl ListDedicatedIpPoolsInput {
    ...
    pub fn builder() -> super::operation::list_dedicated_ip_pools::builders::ListDedicatedIpPoolsInputBuilder {
        super::operation::list_dedicated_ip_pools::builders::ListDedicatedIpPoolsInputBuilder::default()
    }
}
...
impl ListDedicatedIpPoolsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_dedicated_ip_pools::ListDedicatedIpPoolsInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::list_dedicated_ip_pools::ListDedicatedIpPoolsInput {
