...
pub struct ListEmailIdentitiesOutput {
    ...
    pub email_identities: ::std::option::Option<::std::vec::Vec<super::types::IdentityInfo>>,
...
impl ListEmailIdentitiesOutput {
    ...
    pub fn email_identities(&self) -> &[super::types::IdentityInfo] {
...
impl ListEmailIdentitiesOutput {
    ...
    pub fn builder() -> super::operation::list_email_identities::builders::ListEmailIdentitiesOutputBuilder {
        super::operation::list_email_identities::builders::ListEmailIdentitiesOutputBuilder::default()
    }
}
...
pub struct ListEmailIdentitiesOutputBuilder {
    pub(crate) email_identities: ::std::option::Option<::std::vec::Vec<super::types::IdentityInfo>>,
...
impl ListEmailIdentitiesOutputBuilder {
    ...
    ///
    /// <p>An array that includes all of the email identities associated with your Amazon Web Services account.</p>
    pub fn email_identities(mut self, input: super::types::IdentityInfo) -> Self {
    ...
    /// <p>An array that includes all of the email identities associated with your Amazon Web Services account.</p>
    pub fn set_email_identities(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::IdentityInfo>>) -> Self {
        self.email_identities = input;
        self
    }
    /// <p>An array that includes all of the email identities associated with your Amazon Web Services account.</p>
    pub fn get_email_identities(&self) -> &::std::option::Option<::std::vec::Vec<super::types::IdentityInfo>> {
    ...
    pub fn build(self) -> super::operation::list_email_identities::ListEmailIdentitiesOutput {
