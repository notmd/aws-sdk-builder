...
impl ListEmailIdentitiesInput {
    ...
    pub fn builder() -> super::operation::list_email_identities::builders::ListEmailIdentitiesInputBuilder {
        super::operation::list_email_identities::builders::ListEmailIdentitiesInputBuilder::default()
    }
}
...
impl ListEmailIdentitiesInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_email_identities::ListEmailIdentitiesInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::list_email_identities::ListEmailIdentitiesInput {
