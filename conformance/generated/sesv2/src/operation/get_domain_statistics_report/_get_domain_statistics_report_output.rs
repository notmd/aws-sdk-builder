...
pub struct GetDomainStatisticsReportOutput {
    ...
    pub overall_volume: ::std::option::Option<super::types::OverallVolume>,
    ...
    pub daily_volumes: ::std::vec::Vec<super::types::DailyVolume>,
    _request_id: Option<String>,
}
impl GetDomainStatisticsReportOutput {
    /// <p>An object that contains deliverability metrics for the domain that you specified. The data in this object is a summary of all of the data that was collected from the <code>StartDate</code> to the <code>EndDate</code>.</p>
    pub fn overall_volume(&self) -> ::std::option::Option<&super::types::OverallVolume> {
        self.overall_volume.as_ref()
    }
    /// <p>An object that contains deliverability metrics for the domain that you specified. This object contains data for each day, starting on the <code>StartDate</code> and ending on the <code>EndDate</code>.</p>
    pub fn daily_volumes(&self) -> &[super::types::DailyVolume] {
        use std::ops::Deref;
...
impl GetDomainStatisticsReportOutput {
    ...
    pub fn builder() -> super::operation::get_domain_statistics_report::builders::GetDomainStatisticsReportOutputBuilder {
        super::operation::get_domain_statistics_report::builders::GetDomainStatisticsReportOutputBuilder::default()
    }
}
...
pub struct GetDomainStatisticsReportOutputBuilder {
    pub(crate) overall_volume: ::std::option::Option<super::types::OverallVolume>,
    pub(crate) daily_volumes: ::std::option::Option<::std::vec::Vec<super::types::DailyVolume>>,
    _request_id: Option<String>,
}
impl GetDomainStatisticsReportOutputBuilder {
    /// <p>An object that contains deliverability metrics for the domain that you specified. The data in this object is a summary of all of the data that was collected from the <code>StartDate</code> to the <code>EndDate</code>.</p>
    /// This field is required.
    pub fn overall_volume(mut self, input: super::types::OverallVolume) -> Self {
        self.overall_volume = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object that contains deliverability metrics for the domain that you specified. The data in this object is a summary of all of the data that was collected from the <code>StartDate</code> to the <code>EndDate</code>.</p>
    pub fn set_overall_volume(mut self, input: ::std::option::Option<super::types::OverallVolume>) -> Self {
        self.overall_volume = input;
        self
    }
    /// <p>An object that contains deliverability metrics for the domain that you specified. The data in this object is a summary of all of the data that was collected from the <code>StartDate</code> to the <code>EndDate</code>.</p>
    pub fn get_overall_volume(&self) -> &::std::option::Option<super::types::OverallVolume> {
        &self.overall_volume
    }
    ...
    ///
    /// <p>An object that contains deliverability metrics for the domain that you specified. This object contains data for each day, starting on the <code>StartDate</code> and ending on the <code>EndDate</code>.</p>
    pub fn daily_volumes(mut self, input: super::types::DailyVolume) -> Self {
    ...
    /// <p>An object that contains deliverability metrics for the domain that you specified. This object contains data for each day, starting on the <code>StartDate</code> and ending on the <code>EndDate</code>.</p>
    pub fn set_daily_volumes(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::DailyVolume>>) -> Self {
        self.daily_volumes = input;
        self
    }
    /// <p>An object that contains deliverability metrics for the domain that you specified. This object contains data for each day, starting on the <code>StartDate</code> and ending on the <code>EndDate</code>.</p>
    pub fn get_daily_volumes(&self) -> &::std::option::Option<::std::vec::Vec<super::types::DailyVolume>> {
        &self.daily_volumes
    }
    ...
    > {
        ::std::result::Result::Ok(super::operation::get_domain_statistics_report::GetDomainStatisticsReportOutput {
