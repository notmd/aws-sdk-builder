...
impl GetDomainStatisticsReportInput {
    ...
    pub fn builder() -> super::operation::get_domain_statistics_report::builders::GetDomainStatisticsReportInputBuilder {
        super::operation::get_domain_statistics_report::builders::GetDomainStatisticsReportInputBuilder::default()
    }
}
...
impl GetDomainStatisticsReportInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::get_domain_statistics_report::GetDomainStatisticsReportInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::get_domain_statistics_report::GetDomainStatisticsReportInput {
            domain: self.domain,
