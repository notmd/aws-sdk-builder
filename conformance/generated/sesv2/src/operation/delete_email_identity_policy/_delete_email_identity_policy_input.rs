...
impl DeleteEmailIdentityPolicyInput {
    ...
    pub fn builder() -> super::operation::delete_email_identity_policy::builders::DeleteEmailIdentityPolicyInputBuilder {
        super::operation::delete_email_identity_policy::builders::DeleteEmailIdentityPolicyInputBuilder::default()
    }
}
...
impl DeleteEmailIdentityPolicyInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::delete_email_identity_policy::DeleteEmailIdentityPolicyInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::delete_email_identity_policy::DeleteEmailIdentityPolicyInput {
