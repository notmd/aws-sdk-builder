...
impl DeleteEmailIdentityPolicyOutput {
    ...
    pub fn builder() -> super::operation::delete_email_identity_policy::builders::DeleteEmailIdentityPolicyOutputBuilder {
        super::operation::delete_email_identity_policy::builders::DeleteEmailIdentityPolicyOutputBuilder::default()
    }
}
...
impl DeleteEmailIdentityPolicyOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_email_identity_policy::DeleteEmailIdentityPolicyOutput {
