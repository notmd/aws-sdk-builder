...
pub struct PutEmailIdentityDkimSigningAttributesInput {
    ...
    pub signing_attributes: ::std::option::Option<super::types::DkimSigningAttributes>,
}
impl PutEmailIdentityDkimSigningAttributesInput {
    ...
    /// <p>An object that contains information about the private key and selector that you want to use to configure DKIM for the identity for Bring Your Own DKIM (BYODKIM) for the identity, or, configures the key length to be used for <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/easy-dkim.html">Easy DKIM</a>.</p>
    pub fn signing_attributes(&self) -> ::std::option::Option<&super::types::DkimSigningAttributes> {
...
impl PutEmailIdentityDkimSigningAttributesInput {
    ...
    pub fn builder() -> super::operation::put_email_identity_dkim_signing_attributes::builders::PutEmailIdentityDkimSigningAttributesInputBuilder {
        super::operation::put_email_identity_dkim_signing_attributes::builders::PutEmailIdentityDkimSigningAttributesInputBuilder::default()
    }
}
...
pub struct PutEmailIdentityDkimSigningAttributesInputBuilder {
    ...
    pub(crate) signing_attributes: ::std::option::Option<super::types::DkimSigningAttributes>,
}
impl PutEmailIdentityDkimSigningAttributesInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::put_email_identity_dkim_signing_attributes::PutEmailIdentityDkimSigningAttributesInput,
