...
pub use super::operation::put_email_identity_dkim_signing_attributes::_put_email_identity_dkim_signing_attributes_input::PutEmailIdentityDkimSigningAttributesInputBuilder;

pub use super::operation::put_email_identity_dkim_signing_attributes::_put_email_identity_dkim_signing_attributes_output::PutEmailIdentityDkimSigningAttributesOutputBuilder;

impl super::operation::put_email_identity_dkim_signing_attributes::builders::PutEmailIdentityDkimSigningAttributesInputBuilder {
...
pub struct PutEmailIdentityDkimSigningAttributesFluentBuilder {
    ...
    inner: super::operation::put_email_identity_dkim_signing_attributes::builders::PutEmailIdentityDkimSigningAttributesInputBuilder,
...
impl PutEmailIdentityDkimSigningAttributesFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &super::operation::put_email_identity_dkim_signing_attributes::builders::PutEmailIdentityDkimSigningAttributesInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            super::operation::put_email_identity_dkim_signing_attributes::PutEmailIdentityDkimSigningAttributes::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        super::operation::put_email_identity_dkim_signing_attributes::PutEmailIdentityDkimSigningAttributes::orchestrate(&runtime_plugins, input)
            .await
    }
    ...
    pub fn signing_attributes(mut self, input: super::types::DkimSigningAttributes) -> Self {
        self.inner = self.inner.signing_attributes(input);
        self
    }
    /// <p>An object that contains information about the private key and selector that you want to use to configure DKIM for the identity for Bring Your Own DKIM (BYODKIM) for the identity, or, configures the key length to be used for <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/easy-dkim.html">Easy DKIM</a>.</p>
    pub fn set_signing_attributes(mut self, input: ::std::option::Option<super::types::DkimSigningAttributes>) -> Self {
        self.inner = self.inner.set_signing_attributes(input);
        self
    }
    /// <p>An object that contains information about the private key and selector that you want to use to configure DKIM for the identity for Bring Your Own DKIM (BYODKIM) for the identity, or, configures the key length to be used for <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/easy-dkim.html">Easy DKIM</a>.</p>
    pub fn get_signing_attributes(&self) -> &::std::option::Option<super::types::DkimSigningAttributes> {
