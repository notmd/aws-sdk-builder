...
impl DeleteConfigurationSetEventDestinationOutput {
    ...
    pub fn builder() -> super::operation::delete_configuration_set_event_destination::builders::DeleteConfigurationSetEventDestinationOutputBuilder {
...
impl DeleteConfigurationSetEventDestinationOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_configuration_set_event_destination::DeleteConfigurationSetEventDestinationOutput {
