...
impl DeleteContactListOutput {
    ...
    pub fn builder() -> super::operation::delete_contact_list::builders::DeleteContactListOutputBuilder {
        super::operation::delete_contact_list::builders::DeleteContactListOutputBuilder::default()
    }
}
...
impl DeleteContactListOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_contact_list::DeleteContactListOutput {
