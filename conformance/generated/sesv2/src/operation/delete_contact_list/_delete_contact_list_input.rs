...
impl DeleteContactListInput {
    ...
    pub fn builder() -> super::operation::delete_contact_list::builders::DeleteContactListInputBuilder {
        super::operation::delete_contact_list::builders::DeleteContactListInputBuilder::default()
    }
}
...
impl DeleteContactListInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::delete_contact_list::DeleteContactListInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::delete_contact_list::DeleteContactListInput {
