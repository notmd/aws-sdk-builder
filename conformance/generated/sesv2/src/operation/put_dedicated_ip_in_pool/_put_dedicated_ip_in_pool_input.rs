...
impl PutDedicatedIpInPoolInput {
    ...
    pub fn builder() -> super::operation::put_dedicated_ip_in_pool::builders::PutDedicatedIpInPoolInputBuilder {
        super::operation::put_dedicated_ip_in_pool::builders::PutDedicatedIpInPoolInputBuilder::default()
    }
}
...
impl PutDedicatedIpInPoolInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::put_dedicated_ip_in_pool::PutDedicatedIpInPoolInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::put_dedicated_ip_in_pool::PutDedicatedIpInPoolInput {
            ip: self.ip,
