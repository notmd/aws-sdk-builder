...
impl SendCustomVerificationEmailInput {
    ...
    pub fn builder() -> super::operation::send_custom_verification_email::builders::SendCustomVerificationEmailInputBuilder {
        super::operation::send_custom_verification_email::builders::SendCustomVerificationEmailInputBuilder::default()
    }
}
...
impl SendCustomVerificationEmailInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::send_custom_verification_email::SendCustomVerificationEmailInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::send_custom_verification_email::SendCustomVerificationEmailInput {
