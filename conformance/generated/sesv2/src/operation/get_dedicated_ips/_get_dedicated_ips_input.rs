...
impl GetDedicatedIpsInput {
    ...
    pub fn builder() -> super::operation::get_dedicated_ips::builders::GetDedicatedIpsInputBuilder {
        super::operation::get_dedicated_ips::builders::GetDedicatedIpsInputBuilder::default()
    }
}
...
impl GetDedicatedIpsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_dedicated_ips::GetDedicatedIpsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_dedicated_ips::GetDedicatedIpsInput {
