    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_configuration_set::DeleteConfigurationSetError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_configuration_set::DeleteConfigurationSetOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteConfigurationSetResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_configuration_set::de_delete_configuration_set_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_configuration_set::de_delete_configuration_set_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteConfigurationSetRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_configuration_set::DeleteConfigurationSetInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_configuration_set::DeleteConfigurationSetInput,
...
impl ::aws_types::request_id::RequestId for super::operation::delete_configuration_set::DeleteConfigurationSetError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_configuration_set::_delete_configuration_set_input::DeleteConfigurationSetInput;

pub use super::operation::delete_configuration_set::_delete_configuration_set_output::DeleteConfigurationSetOutput;
