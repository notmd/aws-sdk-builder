...
impl GetDeliverabilityTestReportInput {
    ...
    pub fn builder() -> super::operation::get_deliverability_test_report::builders::GetDeliverabilityTestReportInputBuilder {
        super::operation::get_deliverability_test_report::builders::GetDeliverabilityTestReportInputBuilder::default()
    }
}
...
impl GetDeliverabilityTestReportInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::get_deliverability_test_report::GetDeliverabilityTestReportInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::get_deliverability_test_report::GetDeliverabilityTestReportInput { report_id: self.report_id })
    }
}
