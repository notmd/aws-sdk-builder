...
impl PutSuppressedDestinationOutput {
    ...
    pub fn builder() -> super::operation::put_suppressed_destination::builders::PutSuppressedDestinationOutputBuilder {
        super::operation::put_suppressed_destination::builders::PutSuppressedDestinationOutputBuilder::default()
    }
}
...
impl PutSuppressedDestinationOutputBuilder {
    ...
    pub fn build(self) -> super::operation::put_suppressed_destination::PutSuppressedDestinationOutput {
