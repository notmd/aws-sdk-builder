...
impl GetEmailTemplateOutput {
    ...
    pub fn builder() -> super::operation::get_email_template::builders::GetEmailTemplateOutputBuilder {
        super::operation::get_email_template::builders::GetEmailTemplateOutputBuilder::default()
    }
}
...
impl GetEmailTemplateOutputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_email_template::GetEmailTemplateOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_email_template::GetEmailTemplateOutput {
