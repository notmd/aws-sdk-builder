...
impl DeleteSuppressedDestinationOutput {
    ...
    pub fn builder() -> super::operation::delete_suppressed_destination::builders::DeleteSuppressedDestinationOutputBuilder {
        super::operation::delete_suppressed_destination::builders::DeleteSuppressedDestinationOutputBuilder::default()
    }
}
...
impl DeleteSuppressedDestinationOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_suppressed_destination::DeleteSuppressedDestinationOutput {
