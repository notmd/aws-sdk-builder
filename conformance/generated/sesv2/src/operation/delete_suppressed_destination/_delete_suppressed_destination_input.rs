...
/// <p>A request to remove an email address from the suppression list for your account or for a specific tenant.</p>
#[non_exhaustive]
...
impl DeleteSuppressedDestinationInput {
    ...
    pub fn builder() -> super::operation::delete_suppressed_destination::builders::DeleteSuppressedDestinationInputBuilder {
        super::operation::delete_suppressed_destination::builders::DeleteSuppressedDestinationInputBuilder::default()
    }
}
...
impl DeleteSuppressedDestinationInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::delete_suppressed_destination::DeleteSuppressedDestinationInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::delete_suppressed_destination::DeleteSuppressedDestinationInput {
