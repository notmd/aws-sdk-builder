...
impl GetDomainDeliverabilityCampaignInput {
    ...
    pub fn builder() -> super::operation::get_domain_deliverability_campaign::builders::GetDomainDeliverabilityCampaignInputBuilder {
        super::operation::get_domain_deliverability_campaign::builders::GetDomainDeliverabilityCampaignInputBuilder::default()
    }
}
...
impl GetDomainDeliverabilityCampaignInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::get_domain_deliverability_campaign::GetDomainDeliverabilityCampaignInput,
