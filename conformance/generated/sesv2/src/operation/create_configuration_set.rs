    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::create_configuration_set::CreateConfigurationSetError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::create_configuration_set::CreateConfigurationSetOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateConfigurationSetResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_create_configuration_set::de_create_configuration_set_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_create_configuration_set::de_create_configuration_set_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateConfigurationSetRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::create_configuration_set::CreateConfigurationSetInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::create_configuration_set::CreateConfigurationSetInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_create_configuration_set::ser_create_configuration_set_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::create_configuration_set::CreateConfigurationSetError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::create_configuration_set::_create_configuration_set_input::CreateConfigurationSetInput;

pub use super::operation::create_configuration_set::_create_configuration_set_output::CreateConfigurationSetOutput;
