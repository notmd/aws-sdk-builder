...
pub struct ListSuppressedDestinationsOutput {
    ...
    pub suppressed_destination_summaries: ::std::option::Option<::std::vec::Vec<super::types::SuppressedDestinationSummary>>,
...
impl ListSuppressedDestinationsOutput {
    ...
    pub fn suppressed_destination_summaries(&self) -> &[super::types::SuppressedDestinationSummary] {
...
impl ListSuppressedDestinationsOutput {
    ...
    pub fn builder() -> super::operation::list_suppressed_destinations::builders::ListSuppressedDestinationsOutputBuilder {
        super::operation::list_suppressed_destinations::builders::ListSuppressedDestinationsOutputBuilder::default()
    }
}
...
pub struct ListSuppressedDestinationsOutputBuilder {
    pub(crate) suppressed_destination_summaries: ::std::option::Option<::std::vec::Vec<super::types::SuppressedDestinationSummary>>,
...
impl ListSuppressedDestinationsOutputBuilder {
    ...
    ///
    /// <p>A list of summaries, each containing a summary for a suppressed email destination.</p>
    pub fn suppressed_destination_summaries(mut self, input: super::types::SuppressedDestinationSummary) -> Self {
    ...
    pub fn set_suppressed_destination_summaries(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::SuppressedDestinationSummary>>,
    ) -> Self {
        self.suppressed_destination_summaries = input;
        self
    }
    /// <p>A list of summaries, each containing a summary for a suppressed email destination.</p>
    pub fn get_suppressed_destination_summaries(&self) -> &::std::option::Option<::std::vec::Vec<super::types::SuppressedDestinationSummary>> {
    ...
    pub fn build(self) -> super::operation::list_suppressed_destinations::ListSuppressedDestinationsOutput {
