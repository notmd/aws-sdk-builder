...
impl UpdateContactListInput {
    ...
    pub fn builder() -> super::operation::update_contact_list::builders::UpdateContactListInputBuilder {
        super::operation::update_contact_list::builders::UpdateContactListInputBuilder::default()
    }
}
...
impl UpdateContactListInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::update_contact_list::UpdateContactListInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::update_contact_list::UpdateContactListInput {
