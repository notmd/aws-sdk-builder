...
impl PutDeliverabilityDashboardOptionOutput {
    ...
    pub fn builder() -> super::operation::put_deliverability_dashboard_option::builders::PutDeliverabilityDashboardOptionOutputBuilder {
        super::operation::put_deliverability_dashboard_option::builders::PutDeliverabilityDashboardOptionOutputBuilder::default()
    }
}
...
impl PutDeliverabilityDashboardOptionOutputBuilder {
    ...
    pub fn build(self) -> super::operation::put_deliverability_dashboard_option::PutDeliverabilityDashboardOptionOutput {
