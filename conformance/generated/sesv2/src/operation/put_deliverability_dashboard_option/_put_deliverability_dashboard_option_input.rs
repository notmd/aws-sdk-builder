...
pub struct PutDeliverabilityDashboardOptionInput {
    ...
    pub subscribed_domains: ::std::option::Option<::std::vec::Vec<super::types::DomainDeliverabilityTrackingOption>>,
}
impl PutDeliverabilityDashboardOptionInput {
    ...
    pub fn subscribed_domains(&self) -> &[super::types::DomainDeliverabilityTrackingOption] {
...
impl PutDeliverabilityDashboardOptionInput {
    ...
    pub fn builder() -> super::operation::put_deliverability_dashboard_option::builders::PutDeliverabilityDashboardOptionInputBuilder {
        super::operation::put_deliverability_dashboard_option::builders::PutDeliverabilityDashboardOptionInputBuilder::default()
    }
}
...
pub struct PutDeliverabilityDashboardOptionInputBuilder {
    ...
    pub(crate) subscribed_domains: ::std::option::Option<::std::vec::Vec<super::types::DomainDeliverabilityTrackingOption>>,
}
