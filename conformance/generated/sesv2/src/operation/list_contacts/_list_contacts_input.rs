...
pub struct ListContactsInput {
    ...
    pub filter: ::std::option::Option<super::types::ListContactsFilter>,
...
impl ListContactsInput {
    ...
    /// <p>A filter that can be applied to a list of contacts.</p>
    pub fn filter(&self) -> ::std::option::Option<&super::types::ListContactsFilter> {
        self.filter.as_ref()
    }
    /// <p>The number of contacts that may be returned at once, which is dependent on if there are more or less contacts than the value of the PageSize. Use this parameter to paginate results. If additional contacts exist beyond the specified limit, the <code>NextToken</code> element is sent in the response. Use the <code>NextToken</code> value in subsequent requests to retrieve additional contacts.</p>
...
impl ListContactsInput {
    ...
    pub fn builder() -> super::operation::list_contacts::builders::ListContactsInputBuilder {
        super::operation::list_contacts::builders::ListContactsInputBuilder::default()
    }
}
...
pub struct ListContactsInputBuilder {
    ...
    pub(crate) filter: ::std::option::Option<super::types::ListContactsFilter>,
...
impl ListContactsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_contacts::ListContactsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_contacts::ListContactsInput {
