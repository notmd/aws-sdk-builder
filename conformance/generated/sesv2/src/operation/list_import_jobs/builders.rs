...
pub use super::operation::list_import_jobs::_list_import_jobs_input::ListImportJobsInputBuilder;

pub use super::operation::list_import_jobs::_list_import_jobs_output::ListImportJobsOutputBuilder;

impl super::operation::list_import_jobs::builders::ListImportJobsInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::Client,
    ) -> ::std::result::Result<
        super::operation::list_import_jobs::ListImportJobsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::list_import_jobs::ListImportJobsError,
...
pub struct ListImportJobsFluentBuilder {
    ...
    inner: super::operation::list_import_jobs::builders::ListImportJobsInputBuilder,
...
impl ListImportJobsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::list_import_jobs::builders::ListImportJobsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::list_import_jobs::ListImportJobs::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::list_import_jobs::ListImportJobs::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::operation::list_import_jobs::paginator::ListImportJobsPaginator {
        super::operation::list_import_jobs::paginator::ListImportJobsPaginator::new(self.handle, self.inner)
    }
    ...
    pub fn import_destination_type(mut self, input: super::types::ImportDestinationType) -> Self {
        self.inner = self.inner.import_destination_type(input);
        self
    }
    /// <p>The destination of the import job, which can be used to list import jobs that have a certain <code>ImportDestinationType</code>.</p>
    pub fn set_import_destination_type(mut self, input: ::std::option::Option<super::types::ImportDestinationType>) -> Self {
        self.inner = self.inner.set_import_destination_type(input);
        self
    }
    /// <p>The destination of the import job, which can be used to list import jobs that have a certain <code>ImportDestinationType</code>.</p>
    pub fn get_import_destination_type(&self) -> &::std::option::Option<super::types::ImportDestinationType> {
