...
impl DeleteMultiRegionEndpointOutput {
    ...
    pub fn builder() -> super::operation::delete_multi_region_endpoint::builders::DeleteMultiRegionEndpointOutputBuilder {
        super::operation::delete_multi_region_endpoint::builders::DeleteMultiRegionEndpointOutputBuilder::default()
    }
}
...
impl DeleteMultiRegionEndpointOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_multi_region_endpoint::DeleteMultiRegionEndpointOutput {
