...
impl ListEmailTemplatesInput {
    ...
    pub fn builder() -> super::super::super::operation::list_email_templates::builders::ListEmailTemplatesInputBuilder {
        super::super::super::operation::list_email_templates::builders::ListEmailTemplatesInputBuilder::default()
    }
}
