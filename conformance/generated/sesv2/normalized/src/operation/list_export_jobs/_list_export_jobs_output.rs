...
pub struct ListExportJobsOutput {
    ...
    pub export_jobs: ::std::option::Option<::std::vec::Vec<super::super::super::types::ExportJobSummary>>,
...
impl ListExportJobsOutput {
    ...
    pub fn export_jobs(&self) -> &[super::super::super::types::ExportJobSummary] {
...
impl ListExportJobsOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_export_jobs::builders::ListExportJobsOutputBuilder {
        super::super::super::operation::list_export_jobs::builders::ListExportJobsOutputBuilder::default()
    }
}
...
pub struct ListExportJobsOutputBuilder {
    pub(crate) export_jobs: ::std::option::Option<::std::vec::Vec<super::super::super::types::ExportJobSummary>>,
...
impl ListExportJobsOutputBuilder {
    ...
    ///
    /// <p>A list of the export job summaries.</p>
    pub fn export_jobs(mut self, input: super::super::super::types::ExportJobSummary) -> Self {
    ...
    /// <p>A list of the export job summaries.</p>
    pub fn set_export_jobs(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::ExportJobSummary>>) -> Self {
        self.export_jobs = input;
        self
    }
    /// <p>A list of the export job summaries.</p>
    pub fn get_export_jobs(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::ExportJobSummary>> {
        &self.export_jobs
    }
    /// <p>A string token indicating that there might be additional export jobs available to be listed. Use this token to a subsequent call to <code>ListExportJobs</code> with the same parameters to retrieve the next page of export jobs.</p>
    ...
    pub fn build(self) -> super::super::super::operation::list_export_jobs::ListExportJobsOutput {
