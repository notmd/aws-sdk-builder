...
impl CreateContactListInput {
    ...
    pub fn builder() -> super::super::super::operation::create_contact_list::builders::CreateContactListInputBuilder {
        super::super::super::operation::create_contact_list::builders::CreateContactListInputBuilder::default()
    }
}
