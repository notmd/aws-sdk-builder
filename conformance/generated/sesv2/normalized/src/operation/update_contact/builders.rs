...
pub use super::super::super::operation::update_contact::_update_contact_input::UpdateContactInputBuilder;

pub use super::super::super::operation::update_contact::_update_contact_output::UpdateContactOutputBuilder;

impl super::super::super::operation::update_contact::builders::UpdateContactInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::update_contact::UpdateContactOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::update_contact::UpdateContactError,
...
pub struct UpdateContactFluentBuilder {
    ...
    inner: super::super::super::operation::update_contact::builders::UpdateContactInputBuilder,
...
impl UpdateContactFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::update_contact::builders::UpdateContactInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::update_contact::UpdateContact::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::update_contact::UpdateContact::orchestrate(&runtime_plugins, input).await
    }
