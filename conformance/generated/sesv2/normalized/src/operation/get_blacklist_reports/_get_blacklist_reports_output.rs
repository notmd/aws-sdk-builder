...
pub struct GetBlacklistReportsOutput {
    ...
    pub blacklist_report: ::std::collections::HashMap<::std::string::String, ::std::vec::Vec<super::super::super::types::BlacklistEntry>>,
...
impl GetBlacklistReportsOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_blacklist_reports::builders::GetBlacklistReportsOutputBuilder {
        super::super::super::operation::get_blacklist_reports::builders::GetBlacklistReportsOutputBuilder::default()
    }
}
...
pub struct GetBlacklistReportsOutputBuilder {
    pub(crate) blacklist_report:
        ::std::option::Option<::std::collections::HashMap<::std::string::String, ::std::vec::Vec<super::super::super::types::BlacklistEntry>>>,
    _request_id: Option<String>,
}
impl GetBlacklistReportsOutputBuilder {
    ...
    pub fn set_blacklist_report(
        mut self,
        input: ::std::option::Option<::std::collections::HashMap<::std::string::String, ::std::vec::Vec<super::super::super::types::BlacklistEntry>>>,
    ) -> Self {
