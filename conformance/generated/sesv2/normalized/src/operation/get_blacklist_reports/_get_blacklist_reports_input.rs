...
impl GetBlacklistReportsInput {
    ...
    pub fn builder() -> super::super::super::operation::get_blacklist_reports::builders::GetBlacklistReportsInputBuilder {
        super::super::super::operation::get_blacklist_reports::builders::GetBlacklistReportsInputBuilder::default()
    }
}
