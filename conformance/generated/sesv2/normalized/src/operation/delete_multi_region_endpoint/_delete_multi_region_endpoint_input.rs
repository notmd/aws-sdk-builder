...
impl DeleteMultiRegionEndpointInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_multi_region_endpoint::builders::DeleteMultiRegionEndpointInputBuilder {
        super::super::super::operation::delete_multi_region_endpoint::builders::DeleteMultiRegionEndpointInputBuilder::default()
    }
}
