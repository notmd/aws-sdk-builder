...
pub use super::super::super::operation::put_account_dedicated_ip_warmup_attributes::_put_account_dedicated_ip_warmup_attributes_input::PutAccountDedicatedIpWarmupAttributesInputBuilder;

pub use super::super::super::operation::put_account_dedicated_ip_warmup_attributes::_put_account_dedicated_ip_warmup_attributes_output::PutAccountDedicatedIpWarmupAttributesOutputBuilder;

impl super::super::super::operation::put_account_dedicated_ip_warmup_attributes::builders::PutAccountDedicatedIpWarmupAttributesInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::put_account_dedicated_ip_warmup_attributes::PutAccountDedicatedIpWarmupAttributesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::put_account_dedicated_ip_warmup_attributes::PutAccountDedicatedIpWarmupAttributesError,
...
pub struct PutAccountDedicatedIpWarmupAttributesFluentBuilder {
    ...
    inner: super::super::super::operation::put_account_dedicated_ip_warmup_attributes::builders::PutAccountDedicatedIpWarmupAttributesInputBuilder,
