...
pub use super::super::super::operation::send_custom_verification_email::_send_custom_verification_email_input::SendCustomVerificationEmailInputBuilder;

pub use super::super::super::operation::send_custom_verification_email::_send_custom_verification_email_output::SendCustomVerificationEmailOutputBuilder;

impl super::super::super::operation::send_custom_verification_email::builders::SendCustomVerificationEmailInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::send_custom_verification_email::SendCustomVerificationEmailOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::send_custom_verification_email::SendCustomVerificationEmailError,
...
pub struct SendCustomVerificationEmailFluentBuilder {
    ...
    inner: super::super::super::operation::send_custom_verification_email::builders::SendCustomVerificationEmailInputBuilder,
...
impl SendCustomVerificationEmailFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::send_custom_verification_email::builders::SendCustomVerificationEmailInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::send_custom_verification_email::SendCustomVerificationEmail::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::send_custom_verification_email::SendCustomVerificationEmail::orchestrate(&runtime_plugins, input).await
    }
