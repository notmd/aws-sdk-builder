...
impl SendCustomVerificationEmailOutput {
    ...
    pub fn builder() -> super::super::super::operation::send_custom_verification_email::builders::SendCustomVerificationEmailOutputBuilder {
        super::super::super::operation::send_custom_verification_email::builders::SendCustomVerificationEmailOutputBuilder::default()
    }
}
...
impl SendCustomVerificationEmailOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::send_custom_verification_email::SendCustomVerificationEmailOutput {
