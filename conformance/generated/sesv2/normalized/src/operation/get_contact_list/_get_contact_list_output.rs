...
impl GetContactListOutput {
    ...
    pub fn topics(&self) -> &[super::super::super::types::Topic] {
...
impl GetContactListOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_contact_list::builders::GetContactListOutputBuilder {
        super::super::super::operation::get_contact_list::builders::GetContactListOutputBuilder::default()
    }
}
...
pub struct GetContactListOutputBuilder {
    ...
    pub(crate) topics: ::std::option::Option<::std::vec::Vec<super::super::super::types::Topic>>,
...
impl GetContactListOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::get_contact_list::GetContactListOutput {
