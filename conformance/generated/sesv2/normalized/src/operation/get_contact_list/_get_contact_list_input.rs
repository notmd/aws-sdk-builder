...
impl GetContactListInput {
    ...
    pub fn builder() -> super::super::super::operation::get_contact_list::builders::GetContactListInputBuilder {
        super::super::super::operation::get_contact_list::builders::GetContactListInputBuilder::default()
    }
}
...
impl GetContactListInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::get_contact_list::GetContactListInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::get_contact_list::GetContactListInput {
