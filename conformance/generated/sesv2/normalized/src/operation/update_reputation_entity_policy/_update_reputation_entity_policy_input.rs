...
impl UpdateReputationEntityPolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::update_reputation_entity_policy::builders::UpdateReputationEntityPolicyInputBuilder {
        super::super::super::operation::update_reputation_entity_policy::builders::UpdateReputationEntityPolicyInputBuilder::default()
    }
}
