...
impl SendEmailOutput {
    ...
    pub fn builder() -> super::super::super::operation::send_email::builders::SendEmailOutputBuilder {
        super::super::super::operation::send_email::builders::SendEmailOutputBuilder::default()
    }
}
...
impl SendEmailOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::send_email::SendEmailOutput {
