...
impl DeleteContactListOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_contact_list::builders::DeleteContactListOutputBuilder {
        super::super::super::operation::delete_contact_list::builders::DeleteContactListOutputBuilder::default()
    }
}
...
impl DeleteContactListOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_contact_list::DeleteContactListOutput {
