...
impl DeleteContactListInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_contact_list::builders::DeleteContactListInputBuilder {
        super::super::super::operation::delete_contact_list::builders::DeleteContactListInputBuilder::default()
    }
}
