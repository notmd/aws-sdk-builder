...
impl CreateMultiRegionEndpointOutput {
    ...
    pub fn builder() -> super::super::super::operation::create_multi_region_endpoint::builders::CreateMultiRegionEndpointOutputBuilder {
        super::super::super::operation::create_multi_region_endpoint::builders::CreateMultiRegionEndpointOutputBuilder::default()
    }
}
...
impl CreateMultiRegionEndpointOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::create_multi_region_endpoint::CreateMultiRegionEndpointOutput {
