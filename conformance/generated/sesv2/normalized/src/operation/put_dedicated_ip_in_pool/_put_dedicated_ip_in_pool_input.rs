...
impl PutDedicatedIpInPoolInput {
    ...
    pub fn builder() -> super::super::super::operation::put_dedicated_ip_in_pool::builders::PutDedicatedIpInPoolInputBuilder {
        super::super::super::operation::put_dedicated_ip_in_pool::builders::PutDedicatedIpInPoolInputBuilder::default()
    }
}
