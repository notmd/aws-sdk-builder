...
impl ListTenantsInput {
    ...
    pub fn builder() -> super::super::super::operation::list_tenants::builders::ListTenantsInputBuilder {
        super::super::super::operation::list_tenants::builders::ListTenantsInputBuilder::default()
    }
}
