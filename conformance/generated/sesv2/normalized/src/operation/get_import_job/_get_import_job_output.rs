...
pub struct GetImportJobOutput {
    ...
    pub import_destination: ::std::option::Option<super::super::super::types::ImportDestination>,
    /// <p>The data source of the import job.</p>
    pub import_data_source: ::std::option::Option<super::super::super::types::ImportDataSource>,
...
impl GetImportJobOutput {
    ...
    /// <p>The destination of the import job.</p>
    pub fn import_destination(&self) -> ::std::option::Option<&super::super::super::types::ImportDestination> {
        self.import_destination.as_ref()
    }
    /// <p>The data source of the import job.</p>
    pub fn import_data_source(&self) -> ::std::option::Option<&super::super::super::types::ImportDataSource> {
...
impl GetImportJobOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_import_job::builders::GetImportJobOutputBuilder {
        super::super::super::operation::get_import_job::builders::GetImportJobOutputBuilder::default()
    }
}
...
pub struct GetImportJobOutputBuilder {
    ...
    pub(crate) import_destination: ::std::option::Option<super::super::super::types::ImportDestination>,
    pub(crate) import_data_source: ::std::option::Option<super::super::super::types::ImportDataSource>,
...
impl GetImportJobOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::get_import_job::GetImportJobOutput {
        super::super::super::operation::get_import_job::GetImportJobOutput {
            job_id: self.job_id,
