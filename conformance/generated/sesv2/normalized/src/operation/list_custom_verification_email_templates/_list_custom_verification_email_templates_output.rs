...
impl ListCustomVerificationEmailTemplatesOutput {
    ...
    pub fn custom_verification_email_templates(&self) -> &[super::super::super::types::CustomVerificationEmailTemplateMetadata] {
...
impl ListCustomVerificationEmailTemplatesOutputBuilder {
    ...
    ///
    /// <p>A list of the custom verification email templates that exist in your account.</p>
    pub fn custom_verification_email_templates(mut self, input: super::super::super::types::CustomVerificationEmailTemplateMetadata) -> Self {
    ...
    pub fn set_custom_verification_email_templates(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::CustomVerificationEmailTemplateMetadata>>,
    ) -> Self {
    ...
    pub fn build(self) -> super::super::super::operation::list_custom_verification_email_templates::ListCustomVerificationEmailTemplatesOutput {
