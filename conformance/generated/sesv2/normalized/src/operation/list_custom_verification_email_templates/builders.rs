...
pub use super::super::super::operation::list_custom_verification_email_templates::_list_custom_verification_email_templates_input::ListCustomVerificationEmailTemplatesInputBuilder;

pub use super::super::super::operation::list_custom_verification_email_templates::_list_custom_verification_email_templates_output::ListCustomVerificationEmailTemplatesOutputBuilder;

impl super::super::super::operation::list_custom_verification_email_templates::builders::ListCustomVerificationEmailTemplatesInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::list_custom_verification_email_templates::ListCustomVerificationEmailTemplatesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::list_custom_verification_email_templates::ListCustomVerificationEmailTemplatesError,
...
pub struct ListCustomVerificationEmailTemplatesFluentBuilder {
    ...
    inner: super::super::super::operation::list_custom_verification_email_templates::builders::ListCustomVerificationEmailTemplatesInputBuilder,
...
impl ListCustomVerificationEmailTemplatesFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &super::super::super::operation::list_custom_verification_email_templates::builders::ListCustomVerificationEmailTemplatesInputBuilder {
        &self.inner
    }
    ...
    pub fn into_paginator(
        self,
    ) -> super::super::super::operation::list_custom_verification_email_templates::paginator::ListCustomVerificationEmailTemplatesPaginator {
        super::super::super::operation::list_custom_verification_email_templates::paginator::ListCustomVerificationEmailTemplatesPaginator::new(
            self.handle,
            self.inner,
        )
    }
