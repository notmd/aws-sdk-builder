...
pub use super::super::super::operation::get_dedicated_ip::_get_dedicated_ip_input::GetDedicatedIpInputBuilder;

pub use super::super::super::operation::get_dedicated_ip::_get_dedicated_ip_output::GetDedicatedIpOutputBuilder;

impl super::super::super::operation::get_dedicated_ip::builders::GetDedicatedIpInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::get_dedicated_ip::GetDedicatedIpOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::get_dedicated_ip::GetDedicatedIpError,
...
pub struct GetDedicatedIpFluentBuilder {
    ...
    inner: super::super::super::operation::get_dedicated_ip::builders::GetDedicatedIpInputBuilder,
...
impl GetDedicatedIpFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::get_dedicated_ip::builders::GetDedicatedIpInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::get_dedicated_ip::GetDedicatedIp::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::get_dedicated_ip::GetDedicatedIp::orchestrate(&runtime_plugins, input).await
    }
