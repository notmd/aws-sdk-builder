...
impl GetMultiRegionEndpointInput {
    ...
    pub fn builder() -> super::super::super::operation::get_multi_region_endpoint::builders::GetMultiRegionEndpointInputBuilder {
        super::super::super::operation::get_multi_region_endpoint::builders::GetMultiRegionEndpointInputBuilder::default()
    }
}
...
impl GetMultiRegionEndpointInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::get_multi_region_endpoint::GetMultiRegionEndpointInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::get_multi_region_endpoint::GetMultiRegionEndpointInput {
