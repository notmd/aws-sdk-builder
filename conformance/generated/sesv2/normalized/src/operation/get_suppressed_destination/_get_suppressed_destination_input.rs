...
impl GetSuppressedDestinationInput {
    ...
    pub fn builder() -> super::super::super::operation::get_suppressed_destination::builders::GetSuppressedDestinationInputBuilder {
        super::super::super::operation::get_suppressed_destination::builders::GetSuppressedDestinationInputBuilder::default()
    }
}
