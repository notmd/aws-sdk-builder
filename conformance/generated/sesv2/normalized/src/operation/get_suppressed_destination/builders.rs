...
pub use super::super::super::operation::get_suppressed_destination::_get_suppressed_destination_input::GetSuppressedDestinationInputBuilder;

pub use super::super::super::operation::get_suppressed_destination::_get_suppressed_destination_output::GetSuppressedDestinationOutputBuilder;

impl super::super::super::operation::get_suppressed_destination::builders::GetSuppressedDestinationInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::get_suppressed_destination::GetSuppressedDestinationOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::get_suppressed_destination::GetSuppressedDestinationError,
...
pub struct GetSuppressedDestinationFluentBuilder {
    ...
    inner: super::super::super::operation::get_suppressed_destination::builders::GetSuppressedDestinationInputBuilder,
...
impl GetSuppressedDestinationFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::get_suppressed_destination::builders::GetSuppressedDestinationInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::get_suppressed_destination::GetSuppressedDestination::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::get_suppressed_destination::GetSuppressedDestination::orchestrate(&runtime_plugins, input).await
    }
