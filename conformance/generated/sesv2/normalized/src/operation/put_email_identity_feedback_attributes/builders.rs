...
pub use super::super::super::operation::put_email_identity_feedback_attributes::_put_email_identity_feedback_attributes_input::PutEmailIdentityFeedbackAttributesInputBuilder;

pub use super::super::super::operation::put_email_identity_feedback_attributes::_put_email_identity_feedback_attributes_output::PutEmailIdentityFeedbackAttributesOutputBuilder;

impl super::super::super::operation::put_email_identity_feedback_attributes::builders::PutEmailIdentityFeedbackAttributesInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::put_email_identity_feedback_attributes::PutEmailIdentityFeedbackAttributesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::put_email_identity_feedback_attributes::PutEmailIdentityFeedbackAttributesError,
...
pub struct PutEmailIdentityFeedbackAttributesFluentBuilder {
    ...
    inner: super::super::super::operation::put_email_identity_feedback_attributes::builders::PutEmailIdentityFeedbackAttributesInputBuilder,
