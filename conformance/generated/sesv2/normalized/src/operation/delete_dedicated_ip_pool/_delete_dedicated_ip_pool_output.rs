...
impl DeleteDedicatedIpPoolOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_dedicated_ip_pool::builders::DeleteDedicatedIpPoolOutputBuilder {
        super::super::super::operation::delete_dedicated_ip_pool::builders::DeleteDedicatedIpPoolOutputBuilder::default()
    }
}
...
impl DeleteDedicatedIpPoolOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_dedicated_ip_pool::DeleteDedicatedIpPoolOutput {
