...
impl DeleteDedicatedIpPoolInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_dedicated_ip_pool::builders::DeleteDedicatedIpPoolInputBuilder {
        super::super::super::operation::delete_dedicated_ip_pool::builders::DeleteDedicatedIpPoolInputBuilder::default()
    }
}
