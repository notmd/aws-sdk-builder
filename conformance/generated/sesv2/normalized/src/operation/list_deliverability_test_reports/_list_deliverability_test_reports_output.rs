...
pub struct ListDeliverabilityTestReportsOutput {
    ...
    pub deliverability_test_reports: ::std::vec::Vec<super::super::super::types::DeliverabilityTestReport>,
...
impl ListDeliverabilityTestReportsOutput {
    /// <p>An object that contains a lists of predictive inbox placement tests that you've performed.</p>
    pub fn deliverability_test_reports(&self) -> &[super::super::super::types::DeliverabilityTestReport] {
        use std::ops::Deref;
...
impl ListDeliverabilityTestReportsOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_deliverability_test_reports::builders::ListDeliverabilityTestReportsOutputBuilder {
        super::super::super::operation::list_deliverability_test_reports::builders::ListDeliverabilityTestReportsOutputBuilder::default()
    }
}
...
pub struct ListDeliverabilityTestReportsOutputBuilder {
    pub(crate) deliverability_test_reports: ::std::option::Option<::std::vec::Vec<super::super::super::types::DeliverabilityTestReport>>,
...
impl ListDeliverabilityTestReportsOutputBuilder {
    ...
    ///
    /// <p>An object that contains a lists of predictive inbox placement tests that you've performed.</p>
    pub fn deliverability_test_reports(mut self, input: super::super::super::types::DeliverabilityTestReport) -> Self {
    ...
    /// <p>An object that contains a lists of predictive inbox placement tests that you've performed.</p>
    pub fn get_deliverability_test_reports(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::DeliverabilityTestReport>> {
