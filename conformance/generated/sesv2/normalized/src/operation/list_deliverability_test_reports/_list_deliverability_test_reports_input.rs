...
impl ListDeliverabilityTestReportsInput {
    ...
    pub fn builder() -> super::super::super::operation::list_deliverability_test_reports::builders::ListDeliverabilityTestReportsInputBuilder {
        super::super::super::operation::list_deliverability_test_reports::builders::ListDeliverabilityTestReportsInputBuilder::default()
    }
}
