...
impl CreateConfigurationSetOutput {
    ...
    pub fn builder() -> super::super::super::operation::create_configuration_set::builders::CreateConfigurationSetOutputBuilder {
        super::super::super::operation::create_configuration_set::builders::CreateConfigurationSetOutputBuilder::default()
    }
}
...
impl CreateConfigurationSetOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::create_configuration_set::CreateConfigurationSetOutput {
