...
impl GetDedicatedIpsInput {
    ...
    pub fn builder() -> super::super::super::operation::get_dedicated_ips::builders::GetDedicatedIpsInputBuilder {
        super::super::super::operation::get_dedicated_ips::builders::GetDedicatedIpsInputBuilder::default()
    }
}
