...
pub struct GetDeliverabilityTestReportOutput {
    ...
    pub deliverability_test_report: ::std::option::Option<super::super::super::types::DeliverabilityTestReport>,
    ...
    pub overall_placement: ::std::option::Option<super::super::super::types::PlacementStatistics>,
    ...
    pub isp_placements: ::std::vec::Vec<super::super::super::types::IspPlacement>,
...
impl GetDeliverabilityTestReportOutput {
    /// <p>An object that contains the results of the predictive inbox placement test.</p>
    pub fn deliverability_test_report(&self) -> ::std::option::Option<&super::super::super::types::DeliverabilityTestReport> {
        self.deliverability_test_report.as_ref()
    }
    /// <p>An object that specifies how many test messages that were sent during the predictive inbox placement test were delivered to recipients' inboxes, how many were sent to recipients' spam folders, and how many weren't delivered.</p>
    pub fn overall_placement(&self) -> ::std::option::Option<&super::super::super::types::PlacementStatistics> {
        self.overall_placement.as_ref()
    }
    /// <p>An object that describes how the test email was handled by several email providers, including Gmail, Hotmail, Yahoo, AOL, and others.</p>
    pub fn isp_placements(&self) -> &[super::super::super::types::IspPlacement] {
        use std::ops::Deref;
...
impl GetDeliverabilityTestReportOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_deliverability_test_report::builders::GetDeliverabilityTestReportOutputBuilder {
        super::super::super::operation::get_deliverability_test_report::builders::GetDeliverabilityTestReportOutputBuilder::default()
    }
}
...
pub struct GetDeliverabilityTestReportOutputBuilder {
    pub(crate) deliverability_test_report: ::std::option::Option<super::super::super::types::DeliverabilityTestReport>,
    pub(crate) overall_placement: ::std::option::Option<super::super::super::types::PlacementStatistics>,
    pub(crate) isp_placements: ::std::option::Option<::std::vec::Vec<super::super::super::types::IspPlacement>>,
...
impl GetDeliverabilityTestReportOutputBuilder {
    ...
    pub fn deliverability_test_report(mut self, input: super::super::super::types::DeliverabilityTestReport) -> Self {
        self.deliverability_test_report = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object that contains the results of the predictive inbox placement test.</p>
    pub fn set_deliverability_test_report(mut self, input: ::std::option::Option<super::super::super::types::DeliverabilityTestReport>) -> Self {
        self.deliverability_test_report = input;
        self
    }
    /// <p>An object that contains the results of the predictive inbox placement test.</p>
    pub fn get_deliverability_test_report(&self) -> &::std::option::Option<super::super::super::types::DeliverabilityTestReport> {
        &self.deliverability_test_report
    }
    /// <p>An object that specifies how many test messages that were sent during the predictive inbox placement test were delivered to recipients' inboxes, how many were sent to recipients' spam folders, and how many weren't delivered.</p>
    /// This field is required.
    pub fn overall_placement(mut self, input: super::super::super::types::PlacementStatistics) -> Self {
        self.overall_placement = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object that specifies how many test messages that were sent during the predictive inbox placement test were delivered to recipients' inboxes, how many were sent to recipients' spam folders, and how many weren't delivered.</p>
    pub fn set_overall_placement(mut self, input: ::std::option::Option<super::super::super::types::PlacementStatistics>) -> Self {
        self.overall_placement = input;
        self
    }
    /// <p>An object that specifies how many test messages that were sent during the predictive inbox placement test were delivered to recipients' inboxes, how many were sent to recipients' spam folders, and how many weren't delivered.</p>
    pub fn get_overall_placement(&self) -> &::std::option::Option<super::super::super::types::PlacementStatistics> {
    ...
    ///
    /// <p>An object that describes how the test email was handled by several email providers, including Gmail, Hotmail, Yahoo, AOL, and others.</p>
    pub fn isp_placements(mut self, input: super::super::super::types::IspPlacement) -> Self {
    ...
    /// <p>An object that describes how the test email was handled by several email providers, including Gmail, Hotmail, Yahoo, AOL, and others.</p>
    pub fn set_isp_placements(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::IspPlacement>>) -> Self {
        self.isp_placements = input;
        self
    }
    /// <p>An object that describes how the test email was handled by several email providers, including Gmail, Hotmail, Yahoo, AOL, and others.</p>
    pub fn get_isp_placements(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::IspPlacement>> {
        &self.isp_placements
    }
    /// <p>An object that contains the message that you sent when you performed this predictive inbox placement test.</p>
