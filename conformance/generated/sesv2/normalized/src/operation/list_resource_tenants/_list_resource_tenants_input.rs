...
impl ListResourceTenantsInput {
    ...
    pub fn builder() -> super::super::super::operation::list_resource_tenants::builders::ListResourceTenantsInputBuilder {
        super::super::super::operation::list_resource_tenants::builders::ListResourceTenantsInputBuilder::default()
    }
}
