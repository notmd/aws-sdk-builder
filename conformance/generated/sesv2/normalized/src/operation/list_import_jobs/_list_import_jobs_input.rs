...
pub struct ListImportJobsInput {
    ...
    pub import_destination_type: ::std::option::Option<super::super::super::types::ImportDestinationType>,
...
impl ListImportJobsInput {
    /// <p>The destination of the import job, which can be used to list import jobs that have a certain <code>ImportDestinationType</code>.</p>
    pub fn import_destination_type(&self) -> ::std::option::Option<&super::super::super::types::ImportDestinationType> {
...
impl ListImportJobsInput {
    ...
    pub fn builder() -> super::super::super::operation::list_import_jobs::builders::ListImportJobsInputBuilder {
        super::super::super::operation::list_import_jobs::builders::ListImportJobsInputBuilder::default()
    }
}
...
pub struct ListImportJobsInputBuilder {
    pub(crate) import_destination_type: ::std::option::Option<super::super::super::types::ImportDestinationType>,
...
impl ListImportJobsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::list_import_jobs::ListImportJobsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::super::operation::list_import_jobs::ListImportJobsInput {
