...
impl PutConfigurationSetVdmOptionsOutput {
    ...
    pub fn builder() -> super::super::super::operation::put_configuration_set_vdm_options::builders::PutConfigurationSetVdmOptionsOutputBuilder {
        super::super::super::operation::put_configuration_set_vdm_options::builders::PutConfigurationSetVdmOptionsOutputBuilder::default()
    }
}
...
impl PutConfigurationSetVdmOptionsOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::put_configuration_set_vdm_options::PutConfigurationSetVdmOptionsOutput {
