...
impl PutConfigurationSetVdmOptionsInput {
    ...
    pub fn builder() -> super::super::super::operation::put_configuration_set_vdm_options::builders::PutConfigurationSetVdmOptionsInputBuilder {
        super::super::super::operation::put_configuration_set_vdm_options::builders::PutConfigurationSetVdmOptionsInputBuilder::default()
    }
}
