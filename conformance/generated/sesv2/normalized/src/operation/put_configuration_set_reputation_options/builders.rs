...
pub use super::super::super::operation::put_configuration_set_reputation_options::_put_configuration_set_reputation_options_input::PutConfigurationSetReputationOptionsInputBuilder;

pub use super::super::super::operation::put_configuration_set_reputation_options::_put_configuration_set_reputation_options_output::PutConfigurationSetReputationOptionsOutputBuilder;

impl super::super::super::operation::put_configuration_set_reputation_options::builders::PutConfigurationSetReputationOptionsInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::put_configuration_set_reputation_options::PutConfigurationSetReputationOptionsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::put_configuration_set_reputation_options::PutConfigurationSetReputationOptionsError,
...
pub struct PutConfigurationSetReputationOptionsFluentBuilder {
    ...
    inner: super::super::super::operation::put_configuration_set_reputation_options::builders::PutConfigurationSetReputationOptionsInputBuilder,
...
impl PutConfigurationSetReputationOptionsFluentBuilder {
    ...
    > {
        ...
        let runtime_plugins =
            super::super::super::operation::put_configuration_set_reputation_options::PutConfigurationSetReputationOptions::operation_runtime_plugins(
