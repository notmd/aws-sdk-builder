...
pub use super::super::super::operation::put_account_details::_put_account_details_input::PutAccountDetailsInputBuilder;

pub use super::super::super::operation::put_account_details::_put_account_details_output::PutAccountDetailsOutputBuilder;

impl super::super::super::operation::put_account_details::builders::PutAccountDetailsInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::put_account_details::PutAccountDetailsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::put_account_details::PutAccountDetailsError,
...
pub struct PutAccountDetailsFluentBuilder {
    ...
    inner: super::super::super::operation::put_account_details::builders::PutAccountDetailsInputBuilder,
...
impl PutAccountDetailsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::put_account_details::builders::PutAccountDetailsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::put_account_details::PutAccountDetails::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::put_account_details::PutAccountDetails::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn mail_type(mut self, input: super::super::super::types::MailType) -> Self {
        self.inner = self.inner.mail_type(input);
        self
    }
    /// <p>The type of email your account will send.</p>
    pub fn set_mail_type(mut self, input: ::std::option::Option<super::super::super::types::MailType>) -> Self {
        self.inner = self.inner.set_mail_type(input);
        self
    }
    /// <p>The type of email your account will send.</p>
    pub fn get_mail_type(&self) -> &::std::option::Option<super::super::super::types::MailType> {
    ...
    pub fn contact_language(mut self, input: super::super::super::types::ContactLanguage) -> Self {
        self.inner = self.inner.contact_language(input);
        self
    }
    /// <p>The language you would prefer to be contacted with.</p>
    pub fn set_contact_language(mut self, input: ::std::option::Option<super::super::super::types::ContactLanguage>) -> Self {
        self.inner = self.inner.set_contact_language(input);
        self
    }
    /// <p>The language you would prefer to be contacted with.</p>
    pub fn get_contact_language(&self) -> &::std::option::Option<super::super::super::types::ContactLanguage> {
