...
pub struct PutAccountDetailsInput {
    ...
    pub mail_type: ::std::option::Option<super::super::super::types::MailType>,
    ...
    pub contact_language: ::std::option::Option<super::super::super::types::ContactLanguage>,
...
impl PutAccountDetailsInput {
    /// <p>The type of email your account will send.</p>
    pub fn mail_type(&self) -> ::std::option::Option<&super::super::super::types::MailType> {
    ...
    /// <p>The language you would prefer to be contacted with.</p>
    pub fn contact_language(&self) -> ::std::option::Option<&super::super::super::types::ContactLanguage> {
...
impl PutAccountDetailsInput {
    ...
    pub fn builder() -> super::super::super::operation::put_account_details::builders::PutAccountDetailsInputBuilder {
        super::super::super::operation::put_account_details::builders::PutAccountDetailsInputBuilder::default()
    }
}
...
pub struct PutAccountDetailsInputBuilder {
    pub(crate) mail_type: ::std::option::Option<super::super::super::types::MailType>,
    pub(crate) website_url: ::std::option::Option<::std::string::String>,
    pub(crate) contact_language: ::std::option::Option<super::super::super::types::ContactLanguage>,
