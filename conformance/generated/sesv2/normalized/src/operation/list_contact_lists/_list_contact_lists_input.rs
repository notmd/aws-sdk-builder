...
impl ListContactListsInput {
    ...
    pub fn builder() -> super::super::super::operation::list_contact_lists::builders::ListContactListsInputBuilder {
        super::super::super::operation::list_contact_lists::builders::ListContactListsInputBuilder::default()
    }
}
