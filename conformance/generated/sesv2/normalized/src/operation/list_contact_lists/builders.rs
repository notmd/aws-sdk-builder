...
pub use super::super::super::operation::list_contact_lists::_list_contact_lists_input::ListContactListsInputBuilder;

pub use super::super::super::operation::list_contact_lists::_list_contact_lists_output::ListContactListsOutputBuilder;

impl super::super::super::operation::list_contact_lists::builders::ListContactListsInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::list_contact_lists::ListContactListsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::list_contact_lists::ListContactListsError,
            ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
        >,
    > {
        let mut fluent_builder = client.list_contact_lists();
...
pub struct ListContactListsFluentBuilder {
    ...
    inner: super::super::super::operation::list_contact_lists::builders::ListContactListsInputBuilder,
...
impl
    super::super::super::client::customize::internal::CustomizableSend<
        super::super::super::operation::list_contact_lists::ListContactListsOutput,
        super::super::super::operation::list_contact_lists::ListContactListsError,
    > for ListContactListsFluentBuilder
{
    fn send(
        self,
...
impl ListContactListsFluentBuilder {
    /// Creates a new `ListContactListsFluentBuilder`.
    ...
    pub fn as_input(&self) -> &super::super::super::operation::list_contact_lists::builders::ListContactListsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::list_contact_lists::ListContactLists::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::list_contact_lists::ListContactLists::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::super::super::operation::list_contact_lists::paginator::ListContactListsPaginator {
        super::super::super::operation::list_contact_lists::paginator::ListContactListsPaginator::new(self.handle, self.inner)
    }
