...
pub use super::super::super::operation::put_configuration_set_delivery_options::_put_configuration_set_delivery_options_input::PutConfigurationSetDeliveryOptionsInputBuilder;

pub use super::super::super::operation::put_configuration_set_delivery_options::_put_configuration_set_delivery_options_output::PutConfigurationSetDeliveryOptionsOutputBuilder;

impl super::super::super::operation::put_configuration_set_delivery_options::builders::PutConfigurationSetDeliveryOptionsInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::put_configuration_set_delivery_options::PutConfigurationSetDeliveryOptionsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::put_configuration_set_delivery_options::PutConfigurationSetDeliveryOptionsError,
...
pub struct PutConfigurationSetDeliveryOptionsFluentBuilder {
    ...
    inner: super::super::super::operation::put_configuration_set_delivery_options::builders::PutConfigurationSetDeliveryOptionsInputBuilder,
...
impl PutConfigurationSetDeliveryOptionsFluentBuilder {
    ...
    pub fn tls_policy(mut self, input: super::super::super::types::TlsPolicy) -> Self {
        self.inner = self.inner.tls_policy(input);
        self
    }
    /// <p>Specifies whether messages that use the configuration set are required to use Transport Layer Security (TLS). If the value is <code>Require</code>, messages are only delivered if a TLS connection can be established. If the value is <code>Optional</code>, messages can be delivered in plain text if a TLS connection can't be established.</p>
    pub fn set_tls_policy(mut self, input: ::std::option::Option<super::super::super::types::TlsPolicy>) -> Self {
        self.inner = self.inner.set_tls_policy(input);
        self
    }
    /// <p>Specifies whether messages that use the configuration set are required to use Transport Layer Security (TLS). If the value is <code>Require</code>, messages are only delivered if a TLS connection can be established. If the value is <code>Optional</code>, messages can be delivered in plain text if a TLS connection can't be established.</p>
    pub fn get_tls_policy(&self) -> &::std::option::Option<super::super::super::types::TlsPolicy> {
