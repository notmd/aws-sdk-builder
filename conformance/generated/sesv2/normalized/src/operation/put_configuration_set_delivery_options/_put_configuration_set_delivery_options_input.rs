...
pub struct PutConfigurationSetDeliveryOptionsInput {
    ...
    pub tls_policy: ::std::option::Option<super::super::super::types::TlsPolicy>,
...
impl PutConfigurationSetDeliveryOptionsInput {
    ...
    /// <p>Specifies whether messages that use the configuration set are required to use Transport Layer Security (TLS). If the value is <code>Require</code>, messages are only delivered if a TLS connection can be established. If the value is <code>Optional</code>, messages can be delivered in plain text if a TLS connection can't be established.</p>
    pub fn tls_policy(&self) -> ::std::option::Option<&super::super::super::types::TlsPolicy> {
...
pub struct PutConfigurationSetDeliveryOptionsInputBuilder {
    ...
    pub(crate) tls_policy: ::std::option::Option<super::super::super::types::TlsPolicy>,
...
impl PutConfigurationSetDeliveryOptionsInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::put_configuration_set_delivery_options::PutConfigurationSetDeliveryOptionsInput,
