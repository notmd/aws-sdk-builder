...
impl CreateContactOutput {
    ...
    pub fn builder() -> super::super::super::operation::create_contact::builders::CreateContactOutputBuilder {
        super::super::super::operation::create_contact::builders::CreateContactOutputBuilder::default()
    }
}
...
impl CreateContactOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::create_contact::CreateContactOutput {
