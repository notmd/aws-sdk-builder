...
pub use super::super::super::operation::create_contact::_create_contact_input::CreateContactInputBuilder;

pub use super::super::super::operation::create_contact::_create_contact_output::CreateContactOutputBuilder;

impl super::super::super::operation::create_contact::builders::CreateContactInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::create_contact::CreateContactOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::create_contact::CreateContactError,
...
pub struct CreateContactFluentBuilder {
    ...
    inner: super::super::super::operation::create_contact::builders::CreateContactInputBuilder,
...
impl CreateContactFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::create_contact::builders::CreateContactInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::create_contact::CreateContact::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::create_contact::CreateContact::orchestrate(&runtime_plugins, input).await
    }
