...
pub struct GetContactOutput {
    ...
    pub topic_preferences: ::std::option::Option<::std::vec::Vec<super::super::super::types::TopicPreference>>,
    /// <p>The default topic preferences applied to the contact.</p>
    pub topic_default_preferences: ::std::option::Option<::std::vec::Vec<super::super::super::types::TopicPreference>>,
...
impl GetContactOutput {
    ...
    pub fn topic_preferences(&self) -> &[super::super::super::types::TopicPreference] {
    ...
    pub fn topic_default_preferences(&self) -> &[super::super::super::types::TopicPreference] {
...
impl GetContactOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_contact::builders::GetContactOutputBuilder {
        super::super::super::operation::get_contact::builders::GetContactOutputBuilder::default()
    }
}
...
pub struct GetContactOutputBuilder {
    ...
    pub(crate) topic_preferences: ::std::option::Option<::std::vec::Vec<super::super::super::types::TopicPreference>>,
    pub(crate) topic_default_preferences: ::std::option::Option<::std::vec::Vec<super::super::super::types::TopicPreference>>,
...
impl GetContactOutputBuilder {
    ...
    ///
    /// <p>The contact's preference for being opted-in to or opted-out of a topic.&gt;</p>
    pub fn topic_preferences(mut self, input: super::super::super::types::TopicPreference) -> Self {
    ...
    /// <p>The contact's preference for being opted-in to or opted-out of a topic.&gt;</p>
    pub fn set_topic_preferences(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::TopicPreference>>) -> Self {
        self.topic_preferences = input;
        self
    }
    /// <p>The contact's preference for being opted-in to or opted-out of a topic.&gt;</p>
    pub fn get_topic_preferences(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::TopicPreference>> {
    ...
    ///
    /// <p>The default topic preferences applied to the contact.</p>
    pub fn topic_default_preferences(mut self, input: super::super::super::types::TopicPreference) -> Self {
    ...
    /// <p>The default topic preferences applied to the contact.</p>
    pub fn get_topic_default_preferences(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::TopicPreference>> {
    ...
    pub fn build(self) -> super::super::super::operation::get_contact::GetContactOutput {
        super::super::super::operation::get_contact::GetContactOutput {
