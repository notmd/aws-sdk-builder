...
impl GetContactInput {
    ...
    pub fn builder() -> super::super::super::operation::get_contact::builders::GetContactInputBuilder {
        super::super::super::operation::get_contact::builders::GetContactInputBuilder::default()
    }
}
