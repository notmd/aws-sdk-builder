...
impl CreateEmailTemplateInput {
    ...
    pub fn builder() -> super::super::super::operation::create_email_template::builders::CreateEmailTemplateInputBuilder {
        super::super::super::operation::create_email_template::builders::CreateEmailTemplateInputBuilder::default()
    }
}
