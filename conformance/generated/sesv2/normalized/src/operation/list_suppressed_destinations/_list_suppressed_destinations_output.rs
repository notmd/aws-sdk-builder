...
pub struct ListSuppressedDestinationsOutput {
    ...
    pub suppressed_destination_summaries: ::std::option::Option<::std::vec::Vec<super::super::super::types::SuppressedDestinationSummary>>,
...
impl ListSuppressedDestinationsOutput {
    ...
    pub fn suppressed_destination_summaries(&self) -> &[super::super::super::types::SuppressedDestinationSummary] {
...
impl ListSuppressedDestinationsOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_suppressed_destinations::builders::ListSuppressedDestinationsOutputBuilder {
        super::super::super::operation::list_suppressed_destinations::builders::ListSuppressedDestinationsOutputBuilder::default()
    }
}
...
pub struct ListSuppressedDestinationsOutputBuilder {
    pub(crate) suppressed_destination_summaries: ::std::option::Option<::std::vec::Vec<super::super::super::types::SuppressedDestinationSummary>>,
...
impl ListSuppressedDestinationsOutputBuilder {
    ...
    ///
    /// <p>A list of summaries, each containing a summary for a suppressed email destination.</p>
    pub fn suppressed_destination_summaries(mut self, input: super::super::super::types::SuppressedDestinationSummary) -> Self {
    ...
    pub fn set_suppressed_destination_summaries(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::SuppressedDestinationSummary>>,
    ) -> Self {
    ...
    pub fn build(self) -> super::super::super::operation::list_suppressed_destinations::ListSuppressedDestinationsOutput {
