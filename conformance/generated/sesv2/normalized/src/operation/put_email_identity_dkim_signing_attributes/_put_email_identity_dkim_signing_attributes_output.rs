...
pub struct PutEmailIdentityDkimSigningAttributesOutput {
    ...
    /// </ul>
    pub dkim_status: ::std::option::Option<super::super::super::types::DkimStatus>,
...
impl PutEmailIdentityDkimSigningAttributesOutput {
    ...
    /// <p><code>NOT_STARTED</code> – The DKIM verification process hasn't been initiated for the domain.</p></li>
    /// </ul>
    pub fn dkim_status(&self) -> ::std::option::Option<&super::super::super::types::DkimStatus> {
...
pub struct PutEmailIdentityDkimSigningAttributesOutputBuilder {
    pub(crate) dkim_status: ::std::option::Option<super::super::super::types::DkimStatus>,
...
impl PutEmailIdentityDkimSigningAttributesOutputBuilder {
    ...
    /// <p><code>NOT_STARTED</code> – The DKIM verification process hasn't been initiated for the domain.</p></li>
    /// </ul>
    pub fn dkim_status(mut self, input: super::super::super::types::DkimStatus) -> Self {
    ...
    /// <p><code>NOT_STARTED</code> – The DKIM verification process hasn't been initiated for the domain.</p></li>
    /// </ul>
    pub fn set_dkim_status(mut self, input: ::std::option::Option<super::super::super::types::DkimStatus>) -> Self {
    ...
    /// <p><code>NOT_STARTED</code> – The DKIM verification process hasn't been initiated for the domain.</p></li>
    /// </ul>
    pub fn get_dkim_status(&self) -> &::std::option::Option<super::super::super::types::DkimStatus> {
        &self.dkim_status
    }
    ...
    pub fn build(self) -> super::super::super::operation::put_email_identity_dkim_signing_attributes::PutEmailIdentityDkimSigningAttributesOutput {
