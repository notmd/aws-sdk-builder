...
pub struct PutEmailIdentityDkimSigningAttributesInput {
    ...
    /// </ul>
    pub signing_attributes_origin: ::std::option::Option<super::super::super::types::DkimSigningAttributesOrigin>,
    ...
    pub signing_attributes: ::std::option::Option<super::super::super::types::DkimSigningAttributes>,
}
impl PutEmailIdentityDkimSigningAttributesInput {
    ...
    /// <p><code>EXTERNAL</code> – Configure DKIM for the identity by using Bring Your Own DKIM (BYODKIM).</p></li>
    /// </ul>
    pub fn signing_attributes_origin(&self) -> ::std::option::Option<&super::super::super::types::DkimSigningAttributesOrigin> {
        self.signing_attributes_origin.as_ref()
    }
    /// <p>An object that contains information about the private key and selector that you want to use to configure DKIM for the identity for Bring Your Own DKIM (BYODKIM) for the identity, or, configures the key length to be used for <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/easy-dkim.html">Easy DKIM</a>.</p>
    pub fn signing_attributes(&self) -> ::std::option::Option<&super::super::super::types::DkimSigningAttributes> {
...
pub struct PutEmailIdentityDkimSigningAttributesInputBuilder {
    ...
    pub(crate) signing_attributes_origin: ::std::option::Option<super::super::super::types::DkimSigningAttributesOrigin>,
    pub(crate) signing_attributes: ::std::option::Option<super::super::super::types::DkimSigningAttributes>,
}
impl PutEmailIdentityDkimSigningAttributesInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::put_email_identity_dkim_signing_attributes::PutEmailIdentityDkimSigningAttributesInput,
