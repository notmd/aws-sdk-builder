...
pub use super::super::super::operation::put_email_identity_dkim_signing_attributes::_put_email_identity_dkim_signing_attributes_input::PutEmailIdentityDkimSigningAttributesInputBuilder;

pub use super::super::super::operation::put_email_identity_dkim_signing_attributes::_put_email_identity_dkim_signing_attributes_output::PutEmailIdentityDkimSigningAttributesOutputBuilder;

impl super::super::super::operation::put_email_identity_dkim_signing_attributes::builders::PutEmailIdentityDkimSigningAttributesInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::put_email_identity_dkim_signing_attributes::PutEmailIdentityDkimSigningAttributesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::put_email_identity_dkim_signing_attributes::PutEmailIdentityDkimSigningAttributesError,
...
pub struct PutEmailIdentityDkimSigningAttributesFluentBuilder {
    ...
    inner: super::super::super::operation::put_email_identity_dkim_signing_attributes::builders::PutEmailIdentityDkimSigningAttributesInputBuilder,
...
impl PutEmailIdentityDkimSigningAttributesFluentBuilder {
    ...
    /// </ul>
    pub fn signing_attributes_origin(mut self, input: super::super::super::types::DkimSigningAttributesOrigin) -> Self {
    ...
    /// <p><code>EXTERNAL</code> – Configure DKIM for the identity by using Bring Your Own DKIM (BYODKIM).</p></li>
    /// </ul>
    pub fn set_signing_attributes_origin(mut self, input: ::std::option::Option<super::super::super::types::DkimSigningAttributesOrigin>) -> Self {
    ...
    /// <p><code>EXTERNAL</code> – Configure DKIM for the identity by using Bring Your Own DKIM (BYODKIM).</p></li>
    /// </ul>
    pub fn get_signing_attributes_origin(&self) -> &::std::option::Option<super::super::super::types::DkimSigningAttributesOrigin> {
    ...
    pub fn signing_attributes(mut self, input: super::super::super::types::DkimSigningAttributes) -> Self {
        self.inner = self.inner.signing_attributes(input);
        self
    }
    /// <p>An object that contains information about the private key and selector that you want to use to configure DKIM for the identity for Bring Your Own DKIM (BYODKIM) for the identity, or, configures the key length to be used for <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/easy-dkim.html">Easy DKIM</a>.</p>
    pub fn set_signing_attributes(mut self, input: ::std::option::Option<super::super::super::types::DkimSigningAttributes>) -> Self {
        self.inner = self.inner.set_signing_attributes(input);
        self
    }
    /// <p>An object that contains information about the private key and selector that you want to use to configure DKIM for the identity for Bring Your Own DKIM (BYODKIM) for the identity, or, configures the key length to be used for <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/easy-dkim.html">Easy DKIM</a>.</p>
    pub fn get_signing_attributes(&self) -> &::std::option::Option<super::super::super::types::DkimSigningAttributes> {
