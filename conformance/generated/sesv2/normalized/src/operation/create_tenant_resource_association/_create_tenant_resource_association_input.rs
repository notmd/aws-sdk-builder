...
impl CreateTenantResourceAssociationInput {
    ...
    pub fn builder() -> super::super::super::operation::create_tenant_resource_association::builders::CreateTenantResourceAssociationInputBuilder {
        super::super::super::operation::create_tenant_resource_association::builders::CreateTenantResourceAssociationInputBuilder::default()
    }
}
...
impl CreateTenantResourceAssociationInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::create_tenant_resource_association::CreateTenantResourceAssociationInput,
