...
impl DeleteConfigurationSetInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_configuration_set::builders::DeleteConfigurationSetInputBuilder {
        super::super::super::operation::delete_configuration_set::builders::DeleteConfigurationSetInputBuilder::default()
    }
}
...
impl DeleteConfigurationSetInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::delete_configuration_set::DeleteConfigurationSetInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::delete_configuration_set::DeleteConfigurationSetInput {
