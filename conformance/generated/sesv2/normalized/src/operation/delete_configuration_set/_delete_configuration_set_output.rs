...
impl DeleteConfigurationSetOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_configuration_set::builders::DeleteConfigurationSetOutputBuilder {
        super::super::super::operation::delete_configuration_set::builders::DeleteConfigurationSetOutputBuilder::default()
    }
}
...
impl DeleteConfigurationSetOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_configuration_set::DeleteConfigurationSetOutput {
