...
impl ListSuppressedDestinations {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::super::operation::list_suppressed_destinations::ListSuppressedDestinationsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::list_suppressed_destinations::ListSuppressedDestinationsError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::list_suppressed_destinations::ListSuppressedDestinationsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::list_suppressed_destinations::ListSuppressedDestinationsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SESv2", "ListSuppressedDestinations", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListSuppressedDestinationsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListSuppressedDestinationsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListSuppressedDestinationsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_list_suppressed_destinations::de_list_suppressed_destinations_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_list_suppressed_destinations::de_list_suppressed_destinations_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListSuppressedDestinationsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::list_suppressed_destinations::ListSuppressedDestinationsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::list_suppressed_destinations::ListSuppressedDestinationsInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::list_suppressed_destinations::ListSuppressedDestinationsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::list_suppressed_destinations::_list_suppressed_destinations_input::ListSuppressedDestinationsInput;

pub use super::super::operation::list_suppressed_destinations::_list_suppressed_destinations_output::ListSuppressedDestinationsOutput;
