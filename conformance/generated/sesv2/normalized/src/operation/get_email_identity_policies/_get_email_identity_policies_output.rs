...
impl GetEmailIdentityPoliciesOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_email_identity_policies::builders::GetEmailIdentityPoliciesOutputBuilder {
        super::super::super::operation::get_email_identity_policies::builders::GetEmailIdentityPoliciesOutputBuilder::default()
    }
}
...
impl GetEmailIdentityPoliciesOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::get_email_identity_policies::GetEmailIdentityPoliciesOutput {
