...
impl GetEmailIdentityPoliciesInput {
    ...
    pub fn builder() -> super::super::super::operation::get_email_identity_policies::builders::GetEmailIdentityPoliciesInputBuilder {
        super::super::super::operation::get_email_identity_policies::builders::GetEmailIdentityPoliciesInputBuilder::default()
    }
}
