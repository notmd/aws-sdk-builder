...
pub use super::super::super::operation::update_reputation_entity_customer_managed_status::_update_reputation_entity_customer_managed_status_input::UpdateReputationEntityCustomerManagedStatusInputBuilder;

pub use super::super::super::operation::update_reputation_entity_customer_managed_status::_update_reputation_entity_customer_managed_status_output::UpdateReputationEntityCustomerManagedStatusOutputBuilder;

impl super::super::super::operation::update_reputation_entity_customer_managed_status::builders::UpdateReputationEntityCustomerManagedStatusInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::update_reputation_entity_customer_managed_status::UpdateReputationEntityCustomerManagedStatusError,
...
pub struct UpdateReputationEntityCustomerManagedStatusFluentBuilder {
    ...
    inner: super::super::super::operation::update_reputation_entity_customer_managed_status::builders::UpdateReputationEntityCustomerManagedStatusInputBuilder,
...
impl UpdateReputationEntityCustomerManagedStatusFluentBuilder {
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::update_reputation_entity_customer_managed_status::UpdateReputationEntityCustomerManagedStatus::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
        super::super::super::operation::update_reputation_entity_customer_managed_status::UpdateReputationEntityCustomerManagedStatus::orchestrate(
            &runtime_plugins,
            input,
        )
        .await
    ...
    /// </ul>
    pub fn sending_status(mut self, input: super::super::super::types::SendingStatus) -> Self {
    ...
    /// <p><code>REINSTATED</code> – Allow sending even if there are active reputation findings.</p></li>
    /// </ul>
    pub fn set_sending_status(mut self, input: ::std::option::Option<super::super::super::types::SendingStatus>) -> Self {
    ...
    /// <p><code>REINSTATED</code> – Allow sending even if there are active reputation findings.</p></li>
    /// </ul>
    pub fn get_sending_status(&self) -> &::std::option::Option<super::super::super::types::SendingStatus> {
