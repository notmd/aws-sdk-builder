...
impl GetTenantInput {
    ...
    pub fn builder() -> super::super::super::operation::get_tenant::builders::GetTenantInputBuilder {
        super::super::super::operation::get_tenant::builders::GetTenantInputBuilder::default()
    }
}
