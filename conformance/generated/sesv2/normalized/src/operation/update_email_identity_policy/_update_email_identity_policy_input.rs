...
impl UpdateEmailIdentityPolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::update_email_identity_policy::builders::UpdateEmailIdentityPolicyInputBuilder {
        super::super::super::operation::update_email_identity_policy::builders::UpdateEmailIdentityPolicyInputBuilder::default()
    }
}
