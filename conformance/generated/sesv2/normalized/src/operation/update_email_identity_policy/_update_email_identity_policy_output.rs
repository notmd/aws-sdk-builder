...
impl UpdateEmailIdentityPolicyOutput {
    ...
    pub fn builder() -> super::super::super::operation::update_email_identity_policy::builders::UpdateEmailIdentityPolicyOutputBuilder {
        super::super::super::operation::update_email_identity_policy::builders::UpdateEmailIdentityPolicyOutputBuilder::default()
    }
}
...
impl UpdateEmailIdentityPolicyOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::update_email_identity_policy::UpdateEmailIdentityPolicyOutput {
