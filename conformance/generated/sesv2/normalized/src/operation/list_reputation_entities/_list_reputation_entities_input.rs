...
pub struct ListReputationEntitiesInput {
    ...
    pub filter: ::std::option::Option<::std::collections::HashMap<super::super::super::types::ReputationEntityFilterKey, ::std::string::String>>,
...
impl ListReputationEntitiesInput {
    ...
    pub fn builder() -> super::super::super::operation::list_reputation_entities::builders::ListReputationEntitiesInputBuilder {
        super::super::super::operation::list_reputation_entities::builders::ListReputationEntitiesInputBuilder::default()
    }
}
...
impl ListReputationEntitiesInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::list_reputation_entities::ListReputationEntitiesInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::list_reputation_entities::ListReputationEntitiesInput {
            filter: self.filter,
