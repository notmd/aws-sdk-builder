...
pub struct ListReputationEntitiesOutput {
    ...
    pub reputation_entities: ::std::option::Option<::std::vec::Vec<super::super::super::types::ReputationEntity>>,
...
impl ListReputationEntitiesOutput {
    ...
    pub fn reputation_entities(&self) -> &[super::super::super::types::ReputationEntity] {
...
impl ListReputationEntitiesOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_reputation_entities::builders::ListReputationEntitiesOutputBuilder {
        super::super::super::operation::list_reputation_entities::builders::ListReputationEntitiesOutputBuilder::default()
    }
}
...
pub struct ListReputationEntitiesOutputBuilder {
    pub(crate) reputation_entities: ::std::option::Option<::std::vec::Vec<super::super::super::types::ReputationEntity>>,
...
impl ListReputationEntitiesOutputBuilder {
    ...
    ///
    /// <p>An array that contains information about the reputation entities in your account.</p>
    pub fn reputation_entities(mut self, input: super::super::super::types::ReputationEntity) -> Self {
    ...
    /// <p>An array that contains information about the reputation entities in your account.</p>
    pub fn set_reputation_entities(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::ReputationEntity>>) -> Self {
        self.reputation_entities = input;
        self
    }
    /// <p>An array that contains information about the reputation entities in your account.</p>
    pub fn get_reputation_entities(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::ReputationEntity>> {
    ...
    pub fn build(self) -> super::super::super::operation::list_reputation_entities::ListReputationEntitiesOutput {
