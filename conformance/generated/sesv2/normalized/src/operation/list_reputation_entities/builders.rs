...
pub use super::super::super::operation::list_reputation_entities::_list_reputation_entities_input::ListReputationEntitiesInputBuilder;

pub use super::super::super::operation::list_reputation_entities::_list_reputation_entities_output::ListReputationEntitiesOutputBuilder;

impl super::super::super::operation::list_reputation_entities::builders::ListReputationEntitiesInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::list_reputation_entities::ListReputationEntitiesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::list_reputation_entities::ListReputationEntitiesError,
...
pub struct ListReputationEntitiesFluentBuilder {
    ...
    inner: super::super::super::operation::list_reputation_entities::builders::ListReputationEntitiesInputBuilder,
...
impl ListReputationEntitiesFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::list_reputation_entities::builders::ListReputationEntitiesInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::list_reputation_entities::ListReputationEntities::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::list_reputation_entities::ListReputationEntities::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::super::super::operation::list_reputation_entities::paginator::ListReputationEntitiesPaginator {
        super::super::super::operation::list_reputation_entities::paginator::ListReputationEntitiesPaginator::new(self.handle, self.inner)
    }
    ///
    ...
    pub fn filter(mut self, k: super::super::super::types::ReputationEntityFilterKey, v: impl ::std::convert::Into<::std::string::String>) -> Self {
    ...
    pub fn set_filter(
        mut self,
        input: ::std::option::Option<::std::collections::HashMap<super::super::super::types::ReputationEntityFilterKey, ::std::string::String>>,
    ) -> Self {
