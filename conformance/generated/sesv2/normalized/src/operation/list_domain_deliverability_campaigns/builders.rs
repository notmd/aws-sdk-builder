...
pub use super::super::super::operation::list_domain_deliverability_campaigns::_list_domain_deliverability_campaigns_input::ListDomainDeliverabilityCampaignsInputBuilder;

pub use super::super::super::operation::list_domain_deliverability_campaigns::_list_domain_deliverability_campaigns_output::ListDomainDeliverabilityCampaignsOutputBuilder;

impl super::super::super::operation::list_domain_deliverability_campaigns::builders::ListDomainDeliverabilityCampaignsInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::list_domain_deliverability_campaigns::ListDomainDeliverabilityCampaignsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::list_domain_deliverability_campaigns::ListDomainDeliverabilityCampaignsError,
...
pub struct ListDomainDeliverabilityCampaignsFluentBuilder {
    ...
    inner: super::super::super::operation::list_domain_deliverability_campaigns::builders::ListDomainDeliverabilityCampaignsInputBuilder,
