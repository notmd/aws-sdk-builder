...
impl ListConfigurationSetsInput {
    ...
    pub fn builder() -> super::super::super::operation::list_configuration_sets::builders::ListConfigurationSetsInputBuilder {
        super::super::super::operation::list_configuration_sets::builders::ListConfigurationSetsInputBuilder::default()
    }
}
