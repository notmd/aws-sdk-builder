...
impl ListConfigurationSetsOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_configuration_sets::builders::ListConfigurationSetsOutputBuilder {
        super::super::super::operation::list_configuration_sets::builders::ListConfigurationSetsOutputBuilder::default()
    }
}
...
impl ListConfigurationSetsOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::list_configuration_sets::ListConfigurationSetsOutput {
