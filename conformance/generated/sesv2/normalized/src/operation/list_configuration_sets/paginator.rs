...
pub struct ListConfigurationSetsPaginator {
    ...
    builder: super::super::super::operation::list_configuration_sets::builders::ListConfigurationSetsInputBuilder,
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_configuration_sets_output_output_next_token(resp);
