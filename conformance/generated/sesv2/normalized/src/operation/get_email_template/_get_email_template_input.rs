...
impl GetEmailTemplateInput {
    ...
    pub fn builder() -> super::super::super::operation::get_email_template::builders::GetEmailTemplateInputBuilder {
        super::super::super::operation::get_email_template::builders::GetEmailTemplateInputBuilder::default()
    }
}
