...
impl GetEmailTemplateOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_email_template::builders::GetEmailTemplateOutputBuilder {
        super::super::super::operation::get_email_template::builders::GetEmailTemplateOutputBuilder::default()
    }
}
