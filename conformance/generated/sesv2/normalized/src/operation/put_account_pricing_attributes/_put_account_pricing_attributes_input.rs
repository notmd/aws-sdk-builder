...
pub struct PutAccountPricingAttributesInput {
    ...
    /// </ul>
    pub plan: ::std::option::Option<super::super::super::types::PricingPlan>,
}
impl PutAccountPricingAttributesInput {
    ...
    /// <p><code>ENTERPRISE</code></p></li>
    /// </ul>
    pub fn plan(&self) -> ::std::option::Option<&super::super::super::types::PricingPlan> {
        self.plan.as_ref()
    }
}
impl PutAccountPricingAttributesInput {
    ...
    pub fn builder() -> super::super::super::operation::put_account_pricing_attributes::builders::PutAccountPricingAttributesInputBuilder {
        super::super::super::operation::put_account_pricing_attributes::builders::PutAccountPricingAttributesInputBuilder::default()
    }
}
...
pub struct PutAccountPricingAttributesInputBuilder {
    pub(crate) plan: ::std::option::Option<super::super::super::types::PricingPlan>,
}
