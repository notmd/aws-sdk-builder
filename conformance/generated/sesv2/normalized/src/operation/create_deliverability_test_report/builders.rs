...
pub use super::super::super::operation::create_deliverability_test_report::_create_deliverability_test_report_input::CreateDeliverabilityTestReportInputBuilder;

pub use super::super::super::operation::create_deliverability_test_report::_create_deliverability_test_report_output::CreateDeliverabilityTestReportOutputBuilder;

impl super::super::super::operation::create_deliverability_test_report::builders::CreateDeliverabilityTestReportInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::create_deliverability_test_report::CreateDeliverabilityTestReportOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::create_deliverability_test_report::CreateDeliverabilityTestReportError,
...
pub struct CreateDeliverabilityTestReportFluentBuilder {
    ...
    inner: super::super::super::operation::create_deliverability_test_report::builders::CreateDeliverabilityTestReportInputBuilder,
