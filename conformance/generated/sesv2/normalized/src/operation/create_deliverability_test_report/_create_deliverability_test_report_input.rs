...
impl CreateDeliverabilityTestReportInput {
    ...
    pub fn builder() -> super::super::super::operation::create_deliverability_test_report::builders::CreateDeliverabilityTestReportInputBuilder {
        super::super::super::operation::create_deliverability_test_report::builders::CreateDeliverabilityTestReportInputBuilder::default()
    }
}
