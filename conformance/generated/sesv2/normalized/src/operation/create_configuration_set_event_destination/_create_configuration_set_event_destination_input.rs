...
pub struct CreateConfigurationSetEventDestinationInput {
    ...
    pub event_destination: ::std::option::Option<super::super::super::types::EventDestinationDefinition>,
}
impl CreateConfigurationSetEventDestinationInput {
    ...
    /// <p>An object that defines the event destination.</p>
    pub fn event_destination(&self) -> ::std::option::Option<&super::super::super::types::EventDestinationDefinition> {
...
impl CreateConfigurationSetEventDestinationInput {
    ...
    pub fn builder() -> super::super::super::operation::create_configuration_set_event_destination::builders::CreateConfigurationSetEventDestinationInputBuilder {
        super::super::super::operation::create_configuration_set_event_destination::builders::CreateConfigurationSetEventDestinationInputBuilder::default()
    }
}
...
pub struct CreateConfigurationSetEventDestinationInputBuilder {
    ...
    pub(crate) event_destination: ::std::option::Option<super::super::super::types::EventDestinationDefinition>,
}
impl CreateConfigurationSetEventDestinationInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::create_configuration_set_event_destination::CreateConfigurationSetEventDestinationInput,
