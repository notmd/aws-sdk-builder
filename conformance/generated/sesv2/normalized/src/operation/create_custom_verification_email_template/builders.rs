...
pub use super::super::super::operation::create_custom_verification_email_template::_create_custom_verification_email_template_input::CreateCustomVerificationEmailTemplateInputBuilder;

pub use super::super::super::operation::create_custom_verification_email_template::_create_custom_verification_email_template_output::CreateCustomVerificationEmailTemplateOutputBuilder;

impl super::super::super::operation::create_custom_verification_email_template::builders::CreateCustomVerificationEmailTemplateInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::create_custom_verification_email_template::CreateCustomVerificationEmailTemplateOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::create_custom_verification_email_template::CreateCustomVerificationEmailTemplateError,
...
pub struct CreateCustomVerificationEmailTemplateFluentBuilder {
    ...
    inner: super::super::super::operation::create_custom_verification_email_template::builders::CreateCustomVerificationEmailTemplateInputBuilder,
...
impl CreateCustomVerificationEmailTemplateFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &super::super::super::operation::create_custom_verification_email_template::builders::CreateCustomVerificationEmailTemplateInputBuilder {
        &self.inner
    }
