...
impl ListEmailIdentitiesInput {
    ...
    pub fn builder() -> super::super::super::operation::list_email_identities::builders::ListEmailIdentitiesInputBuilder {
        super::super::super::operation::list_email_identities::builders::ListEmailIdentitiesInputBuilder::default()
    }
}
