...
pub use super::super::super::operation::list_email_identities::_list_email_identities_input::ListEmailIdentitiesInputBuilder;

pub use super::super::super::operation::list_email_identities::_list_email_identities_output::ListEmailIdentitiesOutputBuilder;

impl super::super::super::operation::list_email_identities::builders::ListEmailIdentitiesInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::list_email_identities::ListEmailIdentitiesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::list_email_identities::ListEmailIdentitiesError,
...
pub struct ListEmailIdentitiesFluentBuilder {
    ...
    inner: super::super::super::operation::list_email_identities::builders::ListEmailIdentitiesInputBuilder,
...
impl ListEmailIdentitiesFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::list_email_identities::builders::ListEmailIdentitiesInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::list_email_identities::ListEmailIdentities::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::list_email_identities::ListEmailIdentities::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::super::super::operation::list_email_identities::paginator::ListEmailIdentitiesPaginator {
        super::super::super::operation::list_email_identities::paginator::ListEmailIdentitiesPaginator::new(self.handle, self.inner)
    }
