...
impl GetDedicatedIpPoolInput {
    ...
    pub fn builder() -> super::super::super::operation::get_dedicated_ip_pool::builders::GetDedicatedIpPoolInputBuilder {
        super::super::super::operation::get_dedicated_ip_pool::builders::GetDedicatedIpPoolInputBuilder::default()
    }
}
