...
impl CreateEmailIdentityPolicyOutput {
    ...
    pub fn builder() -> super::super::super::operation::create_email_identity_policy::builders::CreateEmailIdentityPolicyOutputBuilder {
        super::super::super::operation::create_email_identity_policy::builders::CreateEmailIdentityPolicyOutputBuilder::default()
    }
}
...
impl CreateEmailIdentityPolicyOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::create_email_identity_policy::CreateEmailIdentityPolicyOutput {
