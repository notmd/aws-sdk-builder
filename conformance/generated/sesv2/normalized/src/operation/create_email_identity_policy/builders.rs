...
pub use super::super::super::operation::create_email_identity_policy::_create_email_identity_policy_input::CreateEmailIdentityPolicyInputBuilder;

pub use super::super::super::operation::create_email_identity_policy::_create_email_identity_policy_output::CreateEmailIdentityPolicyOutputBuilder;

impl super::super::super::operation::create_email_identity_policy::builders::CreateEmailIdentityPolicyInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::create_email_identity_policy::CreateEmailIdentityPolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::create_email_identity_policy::CreateEmailIdentityPolicyError,
...
pub struct CreateEmailIdentityPolicyFluentBuilder {
    ...
    inner: super::super::super::operation::create_email_identity_policy::builders::CreateEmailIdentityPolicyInputBuilder,
...
impl CreateEmailIdentityPolicyFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::create_email_identity_policy::builders::CreateEmailIdentityPolicyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::create_email_identity_policy::CreateEmailIdentityPolicy::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::create_email_identity_policy::CreateEmailIdentityPolicy::orchestrate(&runtime_plugins, input).await
    }
