...
impl CreateEmailIdentityPolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::create_email_identity_policy::builders::CreateEmailIdentityPolicyInputBuilder {
        super::super::super::operation::create_email_identity_policy::builders::CreateEmailIdentityPolicyInputBuilder::default()
    }
}
