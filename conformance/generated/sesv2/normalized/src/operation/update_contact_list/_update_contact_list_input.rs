...
impl UpdateContactListInput {
    ...
    pub fn builder() -> super::super::super::operation::update_contact_list::builders::UpdateContactListInputBuilder {
        super::super::super::operation::update_contact_list::builders::UpdateContactListInputBuilder::default()
    }
}
