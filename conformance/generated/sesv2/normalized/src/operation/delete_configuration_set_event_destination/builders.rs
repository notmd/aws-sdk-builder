...
pub use super::super::super::operation::delete_configuration_set_event_destination::_delete_configuration_set_event_destination_input::DeleteConfigurationSetEventDestinationInputBuilder;

pub use super::super::super::operation::delete_configuration_set_event_destination::_delete_configuration_set_event_destination_output::DeleteConfigurationSetEventDestinationOutputBuilder;

impl super::super::super::operation::delete_configuration_set_event_destination::builders::DeleteConfigurationSetEventDestinationInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_configuration_set_event_destination::DeleteConfigurationSetEventDestinationOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_configuration_set_event_destination::DeleteConfigurationSetEventDestinationError,
...
pub struct DeleteConfigurationSetEventDestinationFluentBuilder {
    ...
    inner: super::super::super::operation::delete_configuration_set_event_destination::builders::DeleteConfigurationSetEventDestinationInputBuilder,
