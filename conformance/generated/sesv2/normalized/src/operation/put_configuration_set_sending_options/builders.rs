...
pub use super::super::super::operation::put_configuration_set_sending_options::_put_configuration_set_sending_options_input::PutConfigurationSetSendingOptionsInputBuilder;

pub use super::super::super::operation::put_configuration_set_sending_options::_put_configuration_set_sending_options_output::PutConfigurationSetSendingOptionsOutputBuilder;

impl super::super::super::operation::put_configuration_set_sending_options::builders::PutConfigurationSetSendingOptionsInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::put_configuration_set_sending_options::PutConfigurationSetSendingOptionsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::put_configuration_set_sending_options::PutConfigurationSetSendingOptionsError,
...
pub struct PutConfigurationSetSendingOptionsFluentBuilder {
    ...
    inner: super::super::super::operation::put_configuration_set_sending_options::builders::PutConfigurationSetSendingOptionsInputBuilder,
