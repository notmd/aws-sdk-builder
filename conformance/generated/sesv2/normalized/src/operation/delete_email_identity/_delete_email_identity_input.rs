...
impl DeleteEmailIdentityInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_email_identity::builders::DeleteEmailIdentityInputBuilder {
        super::super::super::operation::delete_email_identity::builders::DeleteEmailIdentityInputBuilder::default()
    }
}
