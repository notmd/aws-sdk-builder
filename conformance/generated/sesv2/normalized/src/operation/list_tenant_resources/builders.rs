...
pub use super::super::super::operation::list_tenant_resources::_list_tenant_resources_input::ListTenantResourcesInputBuilder;

pub use super::super::super::operation::list_tenant_resources::_list_tenant_resources_output::ListTenantResourcesOutputBuilder;

impl super::super::super::operation::list_tenant_resources::builders::ListTenantResourcesInputBuilder {
...
pub struct ListTenantResourcesFluentBuilder {
    ...
    inner: super::super::super::operation::list_tenant_resources::builders::ListTenantResourcesInputBuilder,
...
impl ListTenantResourcesFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::list_tenant_resources::builders::ListTenantResourcesInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        super::super::super::operation::list_tenant_resources::ListTenantResources::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::super::super::operation::list_tenant_resources::paginator::ListTenantResourcesPaginator {
        super::super::super::operation::list_tenant_resources::paginator::ListTenantResourcesPaginator::new(self.handle, self.inner)
    }
    ...
    pub fn set_filter(
        mut self,
        input: ::std::option::Option<::std::collections::HashMap<super::super::super::types::ListTenantResourcesFilterKey, ::std::string::String>>,
    ) -> Self {
