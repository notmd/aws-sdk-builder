...
pub struct ListTenantResourcesInput {
    ...
    pub filter: ::std::option::Option<::std::collections::HashMap<super::super::super::types::ListTenantResourcesFilterKey, ::std::string::String>>,
...
impl ListTenantResourcesInput {
    ...
    pub fn builder() -> super::super::super::operation::list_tenant_resources::builders::ListTenantResourcesInputBuilder {
        super::super::super::operation::list_tenant_resources::builders::ListTenantResourcesInputBuilder::default()
    }
}
