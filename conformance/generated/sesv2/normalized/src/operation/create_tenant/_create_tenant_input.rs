...
impl CreateTenantInput {
    ...
    pub fn builder() -> super::super::super::operation::create_tenant::builders::CreateTenantInputBuilder {
        super::super::super::operation::create_tenant::builders::CreateTenantInputBuilder::default()
    }
}
