...
pub struct CreateTenantOutput {
    ...
    pub sending_status: ::std::option::Option<super::super::super::types::SendingStatus>,
    /// <p>An object that contains the suppression list preferences for a tenant.</p>
    pub suppression_attributes: ::std::option::Option<super::super::super::types::TenantSuppressionAttributes>,
...
impl CreateTenantOutput {
    ...
    /// <p>The status of email sending capability for the tenant.</p>
    pub fn sending_status(&self) -> ::std::option::Option<&super::super::super::types::SendingStatus> {
        self.sending_status.as_ref()
    }
    /// <p>An object that contains the suppression list preferences for a tenant.</p>
    pub fn suppression_attributes(&self) -> ::std::option::Option<&super::super::super::types::TenantSuppressionAttributes> {
...
impl CreateTenantOutput {
    ...
    pub fn builder() -> super::super::super::operation::create_tenant::builders::CreateTenantOutputBuilder {
        super::super::super::operation::create_tenant::builders::CreateTenantOutputBuilder::default()
    }
}
...
pub struct CreateTenantOutputBuilder {
    ...
    pub(crate) sending_status: ::std::option::Option<super::super::super::types::SendingStatus>,
    pub(crate) suppression_attributes: ::std::option::Option<super::super::super::types::TenantSuppressionAttributes>,
    _request_id: Option<String>,
}
impl CreateTenantOutputBuilder {
    ...
    /// <p>An object that contains the suppression list preferences for a tenant.</p>
    pub fn suppression_attributes(mut self, input: super::super::super::types::TenantSuppressionAttributes) -> Self {
        self.suppression_attributes = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object that contains the suppression list preferences for a tenant.</p>
    pub fn set_suppression_attributes(mut self, input: ::std::option::Option<super::super::super::types::TenantSuppressionAttributes>) -> Self {
        self.suppression_attributes = input;
        self
    }
    /// <p>An object that contains the suppression list preferences for a tenant.</p>
    pub fn get_suppression_attributes(&self) -> &::std::option::Option<super::super::super::types::TenantSuppressionAttributes> {
    ...
    pub fn build(self) -> super::super::super::operation::create_tenant::CreateTenantOutput {
        super::super::super::operation::create_tenant::CreateTenantOutput {
