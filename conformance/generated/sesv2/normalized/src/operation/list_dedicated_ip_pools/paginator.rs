...
pub struct ListDedicatedIpPoolsPaginator {
    ...
    builder: super::super::super::operation::list_dedicated_ip_pools::builders::ListDedicatedIpPoolsInputBuilder,
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_dedicated_ip_pools_output_output_next_token(resp);
