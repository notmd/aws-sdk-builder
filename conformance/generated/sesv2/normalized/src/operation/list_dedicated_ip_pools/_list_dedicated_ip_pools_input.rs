...
impl ListDedicatedIpPoolsInput {
    ...
    pub fn builder() -> super::super::super::operation::list_dedicated_ip_pools::builders::ListDedicatedIpPoolsInputBuilder {
        super::super::super::operation::list_dedicated_ip_pools::builders::ListDedicatedIpPoolsInputBuilder::default()
    }
}
