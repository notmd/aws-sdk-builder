...
impl ListDedicatedIpPoolsOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_dedicated_ip_pools::builders::ListDedicatedIpPoolsOutputBuilder {
        super::super::super::operation::list_dedicated_ip_pools::builders::ListDedicatedIpPoolsOutputBuilder::default()
    }
}
...
impl ListDedicatedIpPoolsOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::list_dedicated_ip_pools::ListDedicatedIpPoolsOutput {
