...
pub use super::super::super::operation::put_email_identity_mail_from_attributes::_put_email_identity_mail_from_attributes_input::PutEmailIdentityMailFromAttributesInputBuilder;

pub use super::super::super::operation::put_email_identity_mail_from_attributes::_put_email_identity_mail_from_attributes_output::PutEmailIdentityMailFromAttributesOutputBuilder;

impl super::super::super::operation::put_email_identity_mail_from_attributes::builders::PutEmailIdentityMailFromAttributesInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::put_email_identity_mail_from_attributes::PutEmailIdentityMailFromAttributesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::put_email_identity_mail_from_attributes::PutEmailIdentityMailFromAttributesError,
...
pub struct PutEmailIdentityMailFromAttributesFluentBuilder {
    ...
    inner: super::super::super::operation::put_email_identity_mail_from_attributes::builders::PutEmailIdentityMailFromAttributesInputBuilder,
...
impl PutEmailIdentityMailFromAttributesFluentBuilder {
    ...
    > {
        ...
        let runtime_plugins =
            super::super::super::operation::put_email_identity_mail_from_attributes::PutEmailIdentityMailFromAttributes::operation_runtime_plugins(
    ...
    pub fn behavior_on_mx_failure(mut self, input: super::super::super::types::BehaviorOnMxFailure) -> Self {
        self.inner = self.inner.behavior_on_mx_failure(input);
        self
    }
    /// <p>The action to take if the required MX record isn't found when you send an email. When you set this value to <code>UseDefaultValue</code>, the mail is sent using <i>amazonses.com</i> as the MAIL FROM domain. When you set this value to <code>RejectMessage</code>, the Amazon SES API v2 returns a <code>MailFromDomainNotVerified</code> error, and doesn't attempt to deliver the email.</p>
    /// <p>These behaviors are taken when the custom MAIL FROM domain configuration is in the <code>Pending</code>, <code>Failed</code>, and <code>TemporaryFailure</code> states.</p>
    pub fn set_behavior_on_mx_failure(mut self, input: ::std::option::Option<super::super::super::types::BehaviorOnMxFailure>) -> Self {
        self.inner = self.inner.set_behavior_on_mx_failure(input);
        self
    }
    /// <p>The action to take if the required MX record isn't found when you send an email. When you set this value to <code>UseDefaultValue</code>, the mail is sent using <i>amazonses.com</i> as the MAIL FROM domain. When you set this value to <code>RejectMessage</code>, the Amazon SES API v2 returns a <code>MailFromDomainNotVerified</code> error, and doesn't attempt to deliver the email.</p>
    /// <p>These behaviors are taken when the custom MAIL FROM domain configuration is in the <code>Pending</code>, <code>Failed</code>, and <code>TemporaryFailure</code> states.</p>
    pub fn get_behavior_on_mx_failure(&self) -> &::std::option::Option<super::super::super::types::BehaviorOnMxFailure> {
