...
impl TestRenderEmailTemplateInput {
    ...
    pub fn builder() -> super::super::super::operation::test_render_email_template::builders::TestRenderEmailTemplateInputBuilder {
        super::super::super::operation::test_render_email_template::builders::TestRenderEmailTemplateInputBuilder::default()
    }
}
...
impl TestRenderEmailTemplateInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::test_render_email_template::TestRenderEmailTemplateInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::test_render_email_template::TestRenderEmailTemplateInput {
