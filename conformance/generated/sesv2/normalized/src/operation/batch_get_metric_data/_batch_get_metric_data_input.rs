...
pub struct BatchGetMetricDataInput {
    ...
    pub queries: ::std::option::Option<::std::vec::Vec<super::super::super::types::BatchGetMetricDataQuery>>,
}
impl BatchGetMetricDataInput {
    ...
    pub fn queries(&self) -> &[super::super::super::types::BatchGetMetricDataQuery] {
...
impl BatchGetMetricDataInput {
    ...
    pub fn builder() -> super::super::super::operation::batch_get_metric_data::builders::BatchGetMetricDataInputBuilder {
        super::super::super::operation::batch_get_metric_data::builders::BatchGetMetricDataInputBuilder::default()
    }
}
...
pub struct BatchGetMetricDataInputBuilder {
    pub(crate) queries: ::std::option::Option<::std::vec::Vec<super::super::super::types::BatchGetMetricDataQuery>>,
}
