...
impl DeleteEmailTemplateInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_email_template::builders::DeleteEmailTemplateInputBuilder {
        super::super::super::operation::delete_email_template::builders::DeleteEmailTemplateInputBuilder::default()
    }
}
