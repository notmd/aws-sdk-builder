...
impl DeleteEmailTemplateOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_email_template::builders::DeleteEmailTemplateOutputBuilder {
        super::super::super::operation::delete_email_template::builders::DeleteEmailTemplateOutputBuilder::default()
    }
}
...
impl DeleteEmailTemplateOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_email_template::DeleteEmailTemplateOutput {
