...
impl DeleteContactOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_contact::builders::DeleteContactOutputBuilder {
        super::super::super::operation::delete_contact::builders::DeleteContactOutputBuilder::default()
    }
}
...
impl DeleteContactOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_contact::DeleteContactOutput {
