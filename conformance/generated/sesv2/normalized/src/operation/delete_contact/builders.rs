...
pub use super::super::super::operation::delete_contact::_delete_contact_input::DeleteContactInputBuilder;

pub use super::super::super::operation::delete_contact::_delete_contact_output::DeleteContactOutputBuilder;

impl super::super::super::operation::delete_contact::builders::DeleteContactInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_contact::DeleteContactOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_contact::DeleteContactError,
...
pub struct DeleteContactFluentBuilder {
    ...
    inner: super::super::super::operation::delete_contact::builders::DeleteContactInputBuilder,
...
impl DeleteContactFluentBuilder {
    /// Creates a new `DeleteContactFluentBuilder`.
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_contact::builders::DeleteContactInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_contact::DeleteContact::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_contact::DeleteContact::orchestrate(&runtime_plugins, input).await
    }
