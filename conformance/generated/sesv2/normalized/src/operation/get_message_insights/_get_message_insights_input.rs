...
impl GetMessageInsightsInput {
    ...
    pub fn builder() -> super::super::super::operation::get_message_insights::builders::GetMessageInsightsInputBuilder {
        super::super::super::operation::get_message_insights::builders::GetMessageInsightsInputBuilder::default()
    }
}
