...
pub struct GetMessageInsightsOutput {
    ...
    pub insights: ::std::option::Option<::std::vec::Vec<super::super::super::types::EmailInsights>>,
...
impl GetMessageInsightsOutput {
    ...
    pub fn insights(&self) -> &[super::super::super::types::EmailInsights] {
...
impl GetMessageInsightsOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_message_insights::builders::GetMessageInsightsOutputBuilder {
        super::super::super::operation::get_message_insights::builders::GetMessageInsightsOutputBuilder::default()
    }
}
...
pub struct GetMessageInsightsOutputBuilder {
    ...
    pub(crate) insights: ::std::option::Option<::std::vec::Vec<super::super::super::types::EmailInsights>>,
    _request_id: Option<String>,
}
impl GetMessageInsightsOutputBuilder {
    ...
    ///
    /// <p>A set of insights associated with the message.</p>
    pub fn insights(mut self, input: super::super::super::types::EmailInsights) -> Self {
    ...
    /// <p>A set of insights associated with the message.</p>
    pub fn set_insights(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::EmailInsights>>) -> Self {
        self.insights = input;
        self
    }
    /// <p>A set of insights associated with the message.</p>
    pub fn get_insights(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::EmailInsights>> {
        &self.insights
    }
    ...
    pub fn build(self) -> super::super::super::operation::get_message_insights::GetMessageInsightsOutput {
        super::super::super::operation::get_message_insights::GetMessageInsightsOutput {
