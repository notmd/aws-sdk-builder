...
impl GetAccountInput {
    ...
    pub fn builder() -> super::super::super::operation::get_account::builders::GetAccountInputBuilder {
        super::super::super::operation::get_account::builders::GetAccountInputBuilder::default()
    }
}
