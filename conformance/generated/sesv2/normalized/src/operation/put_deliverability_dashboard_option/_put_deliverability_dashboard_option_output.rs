...
impl PutDeliverabilityDashboardOptionOutput {
    ...
    pub fn builder() -> super::super::super::operation::put_deliverability_dashboard_option::builders::PutDeliverabilityDashboardOptionOutputBuilder {
        super::super::super::operation::put_deliverability_dashboard_option::builders::PutDeliverabilityDashboardOptionOutputBuilder::default()
    }
}
...
impl PutDeliverabilityDashboardOptionOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::put_deliverability_dashboard_option::PutDeliverabilityDashboardOptionOutput {
