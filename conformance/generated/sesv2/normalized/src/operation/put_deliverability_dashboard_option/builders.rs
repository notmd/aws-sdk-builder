...
pub use super::super::super::operation::put_deliverability_dashboard_option::_put_deliverability_dashboard_option_input::PutDeliverabilityDashboardOptionInputBuilder;

pub use super::super::super::operation::put_deliverability_dashboard_option::_put_deliverability_dashboard_option_output::PutDeliverabilityDashboardOptionOutputBuilder;

impl super::super::super::operation::put_deliverability_dashboard_option::builders::PutDeliverabilityDashboardOptionInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::put_deliverability_dashboard_option::PutDeliverabilityDashboardOptionOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::put_deliverability_dashboard_option::PutDeliverabilityDashboardOptionError,
...
pub struct PutDeliverabilityDashboardOptionFluentBuilder {
    ...
    inner: super::super::super::operation::put_deliverability_dashboard_option::builders::PutDeliverabilityDashboardOptionInputBuilder,
...
impl PutDeliverabilityDashboardOptionFluentBuilder {
    ...
    pub fn subscribed_domains(mut self, input: super::super::super::types::DomainDeliverabilityTrackingOption) -> Self {
    ...
    /// <p>An array of objects, one for each verified domain that you use to send email and enabled the Deliverability dashboard for.</p>
    pub fn get_subscribed_domains(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::DomainDeliverabilityTrackingOption>> {
