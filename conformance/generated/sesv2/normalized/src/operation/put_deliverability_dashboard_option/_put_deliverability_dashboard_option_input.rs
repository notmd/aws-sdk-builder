...
pub struct PutDeliverabilityDashboardOptionInput {
    ...
    pub subscribed_domains: ::std::option::Option<::std::vec::Vec<super::super::super::types::DomainDeliverabilityTrackingOption>>,
}
impl PutDeliverabilityDashboardOptionInput {
    ...
    pub fn subscribed_domains(&self) -> &[super::super::super::types::DomainDeliverabilityTrackingOption] {
...
impl PutDeliverabilityDashboardOptionInput {
    ...
    pub fn builder() -> super::super::super::operation::put_deliverability_dashboard_option::builders::PutDeliverabilityDashboardOptionInputBuilder {
        super::super::super::operation::put_deliverability_dashboard_option::builders::PutDeliverabilityDashboardOptionInputBuilder::default()
    }
}
...
pub struct PutDeliverabilityDashboardOptionInputBuilder {
    ...
    pub(crate) subscribed_domains: ::std::option::Option<::std::vec::Vec<super::super::super::types::DomainDeliverabilityTrackingOption>>,
}
