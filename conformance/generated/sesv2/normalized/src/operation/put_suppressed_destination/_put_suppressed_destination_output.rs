...
impl PutSuppressedDestinationOutput {
    ...
    pub fn builder() -> super::super::super::operation::put_suppressed_destination::builders::PutSuppressedDestinationOutputBuilder {
        super::super::super::operation::put_suppressed_destination::builders::PutSuppressedDestinationOutputBuilder::default()
    }
}
...
impl PutSuppressedDestinationOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::put_suppressed_destination::PutSuppressedDestinationOutput {
