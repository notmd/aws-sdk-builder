...
impl PutAccountSuppressionAttributesOutput {
    ...
    pub fn builder() -> super::super::super::operation::put_account_suppression_attributes::builders::PutAccountSuppressionAttributesOutputBuilder {
        super::super::super::operation::put_account_suppression_attributes::builders::PutAccountSuppressionAttributesOutputBuilder::default()
    }
}
...
impl PutAccountSuppressionAttributesOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::put_account_suppression_attributes::PutAccountSuppressionAttributesOutput {
