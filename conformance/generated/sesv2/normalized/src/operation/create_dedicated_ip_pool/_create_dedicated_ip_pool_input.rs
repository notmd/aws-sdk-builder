...
pub struct CreateDedicatedIpPoolInput {
    ...
    pub scaling_mode: ::std::option::Option<super::super::super::types::ScalingMode>,
}
impl CreateDedicatedIpPoolInput {
    ...
    /// <p>The type of scaling mode.</p>
    pub fn scaling_mode(&self) -> ::std::option::Option<&super::super::super::types::ScalingMode> {
...
impl CreateDedicatedIpPoolInput {
    ...
    pub fn builder() -> super::super::super::operation::create_dedicated_ip_pool::builders::CreateDedicatedIpPoolInputBuilder {
        super::super::super::operation::create_dedicated_ip_pool::builders::CreateDedicatedIpPoolInputBuilder::default()
    }
}
...
pub struct CreateDedicatedIpPoolInputBuilder {
    ...
    pub(crate) scaling_mode: ::std::option::Option<super::super::super::types::ScalingMode>,
}
