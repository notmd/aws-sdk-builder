...
pub struct GetConfigurationSetEventDestinationsOutput {
    ...
    pub event_destinations: ::std::option::Option<::std::vec::Vec<super::super::super::types::EventDestination>>,
...
impl GetConfigurationSetEventDestinationsOutput {
    ...
    pub fn event_destinations(&self) -> &[super::super::super::types::EventDestination] {
...
pub struct GetConfigurationSetEventDestinationsOutputBuilder {
    pub(crate) event_destinations: ::std::option::Option<::std::vec::Vec<super::super::super::types::EventDestination>>,
    _request_id: Option<String>,
}
impl GetConfigurationSetEventDestinationsOutputBuilder {
    ...
    ///
    /// <p>An array that includes all of the events destinations that have been configured for the configuration set.</p>
    pub fn event_destinations(mut self, input: super::super::super::types::EventDestination) -> Self {
    ...
    /// <p>An array that includes all of the events destinations that have been configured for the configuration set.</p>
    pub fn set_event_destinations(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::EventDestination>>) -> Self {
        self.event_destinations = input;
        self
    }
    /// <p>An array that includes all of the events destinations that have been configured for the configuration set.</p>
    pub fn get_event_destinations(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::EventDestination>> {
    ...
    pub fn build(self) -> super::super::super::operation::get_configuration_set_event_destinations::GetConfigurationSetEventDestinationsOutput {
