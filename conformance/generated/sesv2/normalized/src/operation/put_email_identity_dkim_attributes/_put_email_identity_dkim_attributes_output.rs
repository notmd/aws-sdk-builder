...
impl PutEmailIdentityDkimAttributesOutput {
    ...
    pub fn builder() -> super::super::super::operation::put_email_identity_dkim_attributes::builders::PutEmailIdentityDkimAttributesOutputBuilder {
        super::super::super::operation::put_email_identity_dkim_attributes::builders::PutEmailIdentityDkimAttributesOutputBuilder::default()
    }
}
...
impl PutEmailIdentityDkimAttributesOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::put_email_identity_dkim_attributes::PutEmailIdentityDkimAttributesOutput {
