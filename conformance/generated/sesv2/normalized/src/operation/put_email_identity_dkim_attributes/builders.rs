...
pub use super::super::super::operation::put_email_identity_dkim_attributes::_put_email_identity_dkim_attributes_input::PutEmailIdentityDkimAttributesInputBuilder;

pub use super::super::super::operation::put_email_identity_dkim_attributes::_put_email_identity_dkim_attributes_output::PutEmailIdentityDkimAttributesOutputBuilder;

impl super::super::super::operation::put_email_identity_dkim_attributes::builders::PutEmailIdentityDkimAttributesInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::put_email_identity_dkim_attributes::PutEmailIdentityDkimAttributesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::put_email_identity_dkim_attributes::PutEmailIdentityDkimAttributesError,
...
pub struct PutEmailIdentityDkimAttributesFluentBuilder {
    ...
    inner: super::super::super::operation::put_email_identity_dkim_attributes::builders::PutEmailIdentityDkimAttributesInputBuilder,
