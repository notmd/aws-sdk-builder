...
pub struct PutConfigurationSetSuppressionOptionsInput {
    ...
    /// </ul>
    pub suppression_scope: ::std::option::Option<super::super::super::types::SuppressionListScope>,
    ...
    /// </ul>
    pub suppressed_reasons: ::std::option::Option<::std::vec::Vec<super::super::super::types::SuppressionListReason>>,
    ...
    pub validation_options: ::std::option::Option<super::super::super::types::SuppressionValidationOptions>,
}
impl PutConfigurationSetSuppressionOptionsInput {
    ...
    /// <p><code>ACCOUNT</code> – Use the account-level suppression list.</p></li>
    /// </ul>
    pub fn suppression_scope(&self) -> ::std::option::Option<&super::super::super::types::SuppressionListScope> {
    ...
    pub fn suppressed_reasons(&self) -> &[super::super::super::types::SuppressionListReason] {
        self.suppressed_reasons.as_deref().unwrap_or_default()
    }
    /// <p>An object that contains information about the email address suppression preferences for the configuration set in the current Amazon Web Services Region.</p>
    pub fn validation_options(&self) -> ::std::option::Option<&super::super::super::types::SuppressionValidationOptions> {
...
pub struct PutConfigurationSetSuppressionOptionsInputBuilder {
    ...
    pub(crate) suppression_scope: ::std::option::Option<super::super::super::types::SuppressionListScope>,
    pub(crate) suppressed_reasons: ::std::option::Option<::std::vec::Vec<super::super::super::types::SuppressionListReason>>,
    pub(crate) validation_options: ::std::option::Option<super::super::super::types::SuppressionValidationOptions>,
}
impl PutConfigurationSetSuppressionOptionsInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::put_configuration_set_suppression_options::PutConfigurationSetSuppressionOptionsInput,
