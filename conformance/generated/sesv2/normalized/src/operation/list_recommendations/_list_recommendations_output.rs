...
pub struct ListRecommendationsOutput {
    ...
    pub recommendations: ::std::option::Option<::std::vec::Vec<super::super::super::types::Recommendation>>,
...
impl ListRecommendationsOutput {
    ...
    pub fn recommendations(&self) -> &[super::super::super::types::Recommendation] {
...
impl ListRecommendationsOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_recommendations::builders::ListRecommendationsOutputBuilder {
        super::super::super::operation::list_recommendations::builders::ListRecommendationsOutputBuilder::default()
    }
}
...
pub struct ListRecommendationsOutputBuilder {
    pub(crate) recommendations: ::std::option::Option<::std::vec::Vec<super::super::super::types::Recommendation>>,
...
impl ListRecommendationsOutputBuilder {
    ...
    ///
    /// <p>The recommendations applicable to your account.</p>
    pub fn recommendations(mut self, input: super::super::super::types::Recommendation) -> Self {
    ...
    /// <p>The recommendations applicable to your account.</p>
    pub fn set_recommendations(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::Recommendation>>) -> Self {
        self.recommendations = input;
        self
    }
    /// <p>The recommendations applicable to your account.</p>
    pub fn get_recommendations(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::Recommendation>> {
    ...
    pub fn build(self) -> super::super::super::operation::list_recommendations::ListRecommendationsOutput {
