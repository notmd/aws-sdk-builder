...
pub struct ListRecommendationsInput {
    ...
    pub filter: ::std::option::Option<::std::collections::HashMap<super::super::super::types::ListRecommendationsFilterKey, ::std::string::String>>,
...
impl ListRecommendationsInput {
    ...
    pub fn builder() -> super::super::super::operation::list_recommendations::builders::ListRecommendationsInputBuilder {
        super::super::super::operation::list_recommendations::builders::ListRecommendationsInputBuilder::default()
    }
}
