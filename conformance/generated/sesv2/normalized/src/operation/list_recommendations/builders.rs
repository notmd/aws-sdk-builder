...
pub use super::super::super::operation::list_recommendations::_list_recommendations_input::ListRecommendationsInputBuilder;

pub use super::super::super::operation::list_recommendations::_list_recommendations_output::ListRecommendationsOutputBuilder;

impl super::super::super::operation::list_recommendations::builders::ListRecommendationsInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::list_recommendations::ListRecommendationsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::list_recommendations::ListRecommendationsError,
...
pub struct ListRecommendationsFluentBuilder {
    ...
    inner: super::super::super::operation::list_recommendations::builders::ListRecommendationsInputBuilder,
...
impl ListRecommendationsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::list_recommendations::builders::ListRecommendationsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::list_recommendations::ListRecommendations::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::list_recommendations::ListRecommendations::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::super::super::operation::list_recommendations::paginator::ListRecommendationsPaginator {
        super::super::super::operation::list_recommendations::paginator::ListRecommendationsPaginator::new(self.handle, self.inner)
    }
    ///
    ...
    pub fn set_filter(
        mut self,
        input: ::std::option::Option<::std::collections::HashMap<super::super::super::types::ListRecommendationsFilterKey, ::std::string::String>>,
    ) -> Self {
