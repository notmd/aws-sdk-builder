...
impl GetDomainDeliverabilityCampaignInput {
    ...
    pub fn builder() -> super::super::super::operation::get_domain_deliverability_campaign::builders::GetDomainDeliverabilityCampaignInputBuilder {
        super::super::super::operation::get_domain_deliverability_campaign::builders::GetDomainDeliverabilityCampaignInputBuilder::default()
    }
}
...
impl GetDomainDeliverabilityCampaignInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::get_domain_deliverability_campaign::GetDomainDeliverabilityCampaignInput,
