...
pub use super::super::super::operation::put_dedicated_ip_warmup_attributes::_put_dedicated_ip_warmup_attributes_input::PutDedicatedIpWarmupAttributesInputBuilder;

pub use super::super::super::operation::put_dedicated_ip_warmup_attributes::_put_dedicated_ip_warmup_attributes_output::PutDedicatedIpWarmupAttributesOutputBuilder;

impl super::super::super::operation::put_dedicated_ip_warmup_attributes::builders::PutDedicatedIpWarmupAttributesInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::put_dedicated_ip_warmup_attributes::PutDedicatedIpWarmupAttributesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::put_dedicated_ip_warmup_attributes::PutDedicatedIpWarmupAttributesError,
...
pub struct PutDedicatedIpWarmupAttributesFluentBuilder {
    ...
    inner: super::super::super::operation::put_dedicated_ip_warmup_attributes::builders::PutDedicatedIpWarmupAttributesInputBuilder,
