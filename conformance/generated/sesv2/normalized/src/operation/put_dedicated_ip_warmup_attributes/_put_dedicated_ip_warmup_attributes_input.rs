...
impl PutDedicatedIpWarmupAttributesInput {
    ...
    pub fn builder() -> super::super::super::operation::put_dedicated_ip_warmup_attributes::builders::PutDedicatedIpWarmupAttributesInputBuilder {
        super::super::super::operation::put_dedicated_ip_warmup_attributes::builders::PutDedicatedIpWarmupAttributesInputBuilder::default()
    }
}
...
impl PutDedicatedIpWarmupAttributesInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::put_dedicated_ip_warmup_attributes::PutDedicatedIpWarmupAttributesInput,
