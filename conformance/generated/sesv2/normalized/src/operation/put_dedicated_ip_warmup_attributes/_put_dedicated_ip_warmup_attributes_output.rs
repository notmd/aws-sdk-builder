...
impl PutDedicatedIpWarmupAttributesOutput {
    ...
    pub fn builder() -> super::super::super::operation::put_dedicated_ip_warmup_attributes::builders::PutDedicatedIpWarmupAttributesOutputBuilder {
        super::super::super::operation::put_dedicated_ip_warmup_attributes::builders::PutDedicatedIpWarmupAttributesOutputBuilder::default()
    }
}
...
impl PutDedicatedIpWarmupAttributesOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::put_dedicated_ip_warmup_attributes::PutDedicatedIpWarmupAttributesOutput {
