...
impl DeleteEmailIdentityPolicyOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_email_identity_policy::builders::DeleteEmailIdentityPolicyOutputBuilder {
        super::super::super::operation::delete_email_identity_policy::builders::DeleteEmailIdentityPolicyOutputBuilder::default()
    }
}
...
impl DeleteEmailIdentityPolicyOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_email_identity_policy::DeleteEmailIdentityPolicyOutput {
