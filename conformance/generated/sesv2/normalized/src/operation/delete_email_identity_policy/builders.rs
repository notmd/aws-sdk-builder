...
pub use super::super::super::operation::delete_email_identity_policy::_delete_email_identity_policy_input::DeleteEmailIdentityPolicyInputBuilder;

pub use super::super::super::operation::delete_email_identity_policy::_delete_email_identity_policy_output::DeleteEmailIdentityPolicyOutputBuilder;

impl super::super::super::operation::delete_email_identity_policy::builders::DeleteEmailIdentityPolicyInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_email_identity_policy::DeleteEmailIdentityPolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_email_identity_policy::DeleteEmailIdentityPolicyError,
...
pub struct DeleteEmailIdentityPolicyFluentBuilder {
    ...
    inner: super::super::super::operation::delete_email_identity_policy::builders::DeleteEmailIdentityPolicyInputBuilder,
...
impl DeleteEmailIdentityPolicyFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_email_identity_policy::builders::DeleteEmailIdentityPolicyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_email_identity_policy::DeleteEmailIdentityPolicy::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_email_identity_policy::DeleteEmailIdentityPolicy::orchestrate(&runtime_plugins, input).await
    }
