...
impl DeleteEmailIdentityPolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_email_identity_policy::builders::DeleteEmailIdentityPolicyInputBuilder {
        super::super::super::operation::delete_email_identity_policy::builders::DeleteEmailIdentityPolicyInputBuilder::default()
    }
}
