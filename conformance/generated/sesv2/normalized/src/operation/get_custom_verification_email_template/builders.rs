...
pub use super::super::super::operation::get_custom_verification_email_template::_get_custom_verification_email_template_input::GetCustomVerificationEmailTemplateInputBuilder;

pub use super::super::super::operation::get_custom_verification_email_template::_get_custom_verification_email_template_output::GetCustomVerificationEmailTemplateOutputBuilder;

impl super::super::super::operation::get_custom_verification_email_template::builders::GetCustomVerificationEmailTemplateInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::get_custom_verification_email_template::GetCustomVerificationEmailTemplateOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::get_custom_verification_email_template::GetCustomVerificationEmailTemplateError,
...
pub struct GetCustomVerificationEmailTemplateFluentBuilder {
    ...
    inner: super::super::super::operation::get_custom_verification_email_template::builders::GetCustomVerificationEmailTemplateInputBuilder,
