...
impl DeleteSuppressedDestinationOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_suppressed_destination::builders::DeleteSuppressedDestinationOutputBuilder {
        super::super::super::operation::delete_suppressed_destination::builders::DeleteSuppressedDestinationOutputBuilder::default()
    }
}
...
impl DeleteSuppressedDestinationOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_suppressed_destination::DeleteSuppressedDestinationOutput {
