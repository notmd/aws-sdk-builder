...
pub use super::super::super::operation::delete_suppressed_destination::_delete_suppressed_destination_input::DeleteSuppressedDestinationInputBuilder;

pub use super::super::super::operation::delete_suppressed_destination::_delete_suppressed_destination_output::DeleteSuppressedDestinationOutputBuilder;

impl super::super::super::operation::delete_suppressed_destination::builders::DeleteSuppressedDestinationInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_suppressed_destination::DeleteSuppressedDestinationOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_suppressed_destination::DeleteSuppressedDestinationError,
...
pub struct DeleteSuppressedDestinationFluentBuilder {
    ...
    inner: super::super::super::operation::delete_suppressed_destination::builders::DeleteSuppressedDestinationInputBuilder,
...
impl DeleteSuppressedDestinationFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_suppressed_destination::builders::DeleteSuppressedDestinationInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_suppressed_destination::DeleteSuppressedDestination::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_suppressed_destination::DeleteSuppressedDestination::orchestrate(&runtime_plugins, input).await
    }
