...
impl DeleteSuppressedDestinationInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_suppressed_destination::builders::DeleteSuppressedDestinationInputBuilder {
        super::super::super::operation::delete_suppressed_destination::builders::DeleteSuppressedDestinationInputBuilder::default()
    }
}
