...
impl PutAccountSendingAttributesInput {
    ...
    pub fn builder() -> super::super::super::operation::put_account_sending_attributes::builders::PutAccountSendingAttributesInputBuilder {
        super::super::super::operation::put_account_sending_attributes::builders::PutAccountSendingAttributesInputBuilder::default()
    }
}
