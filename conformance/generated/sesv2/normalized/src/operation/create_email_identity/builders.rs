...
pub use super::super::super::operation::create_email_identity::_create_email_identity_input::CreateEmailIdentityInputBuilder;

pub use super::super::super::operation::create_email_identity::_create_email_identity_output::CreateEmailIdentityOutputBuilder;

impl super::super::super::operation::create_email_identity::builders::CreateEmailIdentityInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::create_email_identity::CreateEmailIdentityOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::create_email_identity::CreateEmailIdentityError,
...
pub struct CreateEmailIdentityFluentBuilder {
    ...
    inner: super::super::super::operation::create_email_identity::builders::CreateEmailIdentityInputBuilder,
...
impl CreateEmailIdentityFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::create_email_identity::builders::CreateEmailIdentityInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::create_email_identity::CreateEmailIdentity::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::create_email_identity::CreateEmailIdentity::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn dkim_signing_attributes(mut self, input: super::super::super::types::DkimSigningAttributes) -> Self {
        self.inner = self.inner.dkim_signing_attributes(input);
        self
    }
    /// <p>If your request includes this object, Amazon SES configures the identity to use Bring Your Own DKIM (BYODKIM) for DKIM authentication purposes, or, configures the key length to be used for <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/easy-dkim.html">Easy DKIM</a>.</p>
    /// <p>You can only specify this object if the email identity is a domain, as opposed to an address.</p>
    pub fn set_dkim_signing_attributes(mut self, input: ::std::option::Option<super::super::super::types::DkimSigningAttributes>) -> Self {
        self.inner = self.inner.set_dkim_signing_attributes(input);
        self
    }
    /// <p>If your request includes this object, Amazon SES configures the identity to use Bring Your Own DKIM (BYODKIM) for DKIM authentication purposes, or, configures the key length to be used for <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/easy-dkim.html">Easy DKIM</a>.</p>
    /// <p>You can only specify this object if the email identity is a domain, as opposed to an address.</p>
    pub fn get_dkim_signing_attributes(&self) -> &::std::option::Option<super::super::super::types::DkimSigningAttributes> {
