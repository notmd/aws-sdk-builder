...
impl CreateEmailIdentityOutput {
    ...
    pub fn builder() -> super::super::super::operation::create_email_identity::builders::CreateEmailIdentityOutputBuilder {
        super::super::super::operation::create_email_identity::builders::CreateEmailIdentityOutputBuilder::default()
    }
}
...
impl CreateEmailIdentityOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::create_email_identity::CreateEmailIdentityOutput {
