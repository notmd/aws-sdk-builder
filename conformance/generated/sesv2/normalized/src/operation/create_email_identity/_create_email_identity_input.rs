...
pub struct CreateEmailIdentityInput {
    ...
    pub dkim_signing_attributes: ::std::option::Option<super::super::super::types::DkimSigningAttributes>,
...
impl CreateEmailIdentityInput {
    ...
    /// <p>If your request includes this object, Amazon SES configures the identity to use Bring Your Own DKIM (BYODKIM) for DKIM authentication purposes, or, configures the key length to be used for <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/easy-dkim.html">Easy DKIM</a>.</p>
    /// <p>You can only specify this object if the email identity is a domain, as opposed to an address.</p>
    pub fn dkim_signing_attributes(&self) -> ::std::option::Option<&super::super::super::types::DkimSigningAttributes> {
...
impl CreateEmailIdentityInput {
    ...
    pub fn builder() -> super::super::super::operation::create_email_identity::builders::CreateEmailIdentityInputBuilder {
        super::super::super::operation::create_email_identity::builders::CreateEmailIdentityInputBuilder::default()
    }
}
...
pub struct CreateEmailIdentityInputBuilder {
    ...
    pub(crate) dkim_signing_attributes: ::std::option::Option<super::super::super::types::DkimSigningAttributes>,
