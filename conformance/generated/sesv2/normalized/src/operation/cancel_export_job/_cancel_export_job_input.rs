...
impl CancelExportJobInput {
    ...
    pub fn builder() -> super::super::super::operation::cancel_export_job::builders::CancelExportJobInputBuilder {
        super::super::super::operation::cancel_export_job::builders::CancelExportJobInputBuilder::default()
    }
}
