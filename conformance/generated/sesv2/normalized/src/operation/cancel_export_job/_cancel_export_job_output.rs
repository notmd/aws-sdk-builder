...
impl CancelExportJobOutput {
    ...
    pub fn builder() -> super::super::super::operation::cancel_export_job::builders::CancelExportJobOutputBuilder {
        super::super::super::operation::cancel_export_job::builders::CancelExportJobOutputBuilder::default()
    }
}
...
impl CancelExportJobOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::cancel_export_job::CancelExportJobOutput {
