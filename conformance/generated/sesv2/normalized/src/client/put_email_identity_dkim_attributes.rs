...
impl super::Client {
    ...
    ///   - [`signing_enabled(bool)`](crate::operation::put_email_identity_dkim_attributes::builders::PutEmailIdentityDkimAttributesFluentBuilder::signing_enabled) / [`set_signing_enabled(Option<bool>)`](crate::operation::put_email_identity_dkim_attributes::builders::PutEmailIdentityDkimAttributesFluentBuilder::set_signing_enabled):<br>required: **false**<br><p>Sets the DKIM signing configuration for the identity.</p> <p>When you set this value <code>true</code>, then the messages that are sent from the identity are signed using DKIM. If you set this value to <code>false</code>, your messages are sent without DKIM signing.</p><br>
    ...
    pub fn put_email_identity_dkim_attributes(
        &self,
    ) -> super::super::operation::put_email_identity_dkim_attributes::builders::PutEmailIdentityDkimAttributesFluentBuilder {
        super::super::operation::put_email_identity_dkim_attributes::builders::PutEmailIdentityDkimAttributesFluentBuilder::new(self.handle.clone())
    }
}
