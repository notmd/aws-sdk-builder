...
impl super::Client {
    ...
    ///   - [`suppression_attributes(TenantSuppressionAttributes)`](crate::operation::create_tenant::builders::CreateTenantFluentBuilder::suppression_attributes) / [`set_suppression_attributes(Option<TenantSuppressionAttributes>)`](crate::operation::create_tenant::builders::CreateTenantFluentBuilder::set_suppression_attributes):<br>required: **false**<br><p>An object that contains information about the suppression list preferences for the tenant. Use this to configure tenant-level suppression at creation time.</p><br>
    ...
    pub fn create_tenant(&self) -> super::super::operation::create_tenant::builders::CreateTenantFluentBuilder {
        super::super::operation::create_tenant::builders::CreateTenantFluentBuilder::new(self.handle.clone())
    }
}
