...
impl super::Client {
    ...
    pub fn put_dedicated_ip_warmup_attributes(
        &self,
    ) -> super::super::operation::put_dedicated_ip_warmup_attributes::builders::PutDedicatedIpWarmupAttributesFluentBuilder {
        super::super::operation::put_dedicated_ip_warmup_attributes::builders::PutDedicatedIpWarmupAttributesFluentBuilder::new(self.handle.clone())
    }
}
