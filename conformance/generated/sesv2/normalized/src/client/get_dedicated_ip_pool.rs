...
impl super::Client {
    ...
    ///   - [`pool_name(impl Into<String>)`](crate::operation::get_dedicated_ip_pool::builders::GetDedicatedIpPoolFluentBuilder::pool_name) / [`set_pool_name(Option<String>)`](crate::operation::get_dedicated_ip_pool::builders::GetDedicatedIpPoolFluentBuilder::set_pool_name):<br>required: **true**<br><p>The name of the dedicated IP pool to retrieve.</p><br>
    ...
    pub fn get_dedicated_ip_pool(&self) -> super::super::operation::get_dedicated_ip_pool::builders::GetDedicatedIpPoolFluentBuilder {
        super::super::operation::get_dedicated_ip_pool::builders::GetDedicatedIpPoolFluentBuilder::new(self.handle.clone())
    }
}
