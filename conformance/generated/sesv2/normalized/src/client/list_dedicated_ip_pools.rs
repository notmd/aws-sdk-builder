...
impl super::Client {
    ...
    pub fn list_dedicated_ip_pools(&self) -> super::super::operation::list_dedicated_ip_pools::builders::ListDedicatedIpPoolsFluentBuilder {
        super::super::operation::list_dedicated_ip_pools::builders::ListDedicatedIpPoolsFluentBuilder::new(self.handle.clone())
    }
}
