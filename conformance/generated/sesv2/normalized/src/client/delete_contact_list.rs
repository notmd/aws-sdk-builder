...
impl super::Client {
    ...
    pub fn delete_contact_list(&self) -> super::super::operation::delete_contact_list::builders::DeleteContactListFluentBuilder {
        super::super::operation::delete_contact_list::builders::DeleteContactListFluentBuilder::new(self.handle.clone())
    }
}
