...
impl super::Client {
    ...
    pub fn get_suppressed_destination(&self) -> super::super::operation::get_suppressed_destination::builders::GetSuppressedDestinationFluentBuilder {
        super::super::operation::get_suppressed_destination::builders::GetSuppressedDestinationFluentBuilder::new(self.handle.clone())
    }
}
