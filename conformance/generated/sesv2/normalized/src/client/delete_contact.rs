...
impl super::Client {
    ...
    pub fn delete_contact(&self) -> super::super::operation::delete_contact::builders::DeleteContactFluentBuilder {
        super::super::operation::delete_contact::builders::DeleteContactFluentBuilder::new(self.handle.clone())
    }
}
