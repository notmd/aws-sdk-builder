...
impl super::Client {
    ...
    pub fn get_configuration_set(&self) -> super::super::operation::get_configuration_set::builders::GetConfigurationSetFluentBuilder {
        super::super::operation::get_configuration_set::builders::GetConfigurationSetFluentBuilder::new(self.handle.clone())
    }
}
