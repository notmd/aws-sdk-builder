...
impl super::Client {
    ...
    pub fn get_dedicated_ip(&self) -> super::super::operation::get_dedicated_ip::builders::GetDedicatedIpFluentBuilder {
        super::super::operation::get_dedicated_ip::builders::GetDedicatedIpFluentBuilder::new(self.handle.clone())
    }
}
