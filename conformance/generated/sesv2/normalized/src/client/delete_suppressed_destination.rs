...
impl super::Client {
    ...
    pub fn delete_suppressed_destination(
        &self,
    ) -> super::super::operation::delete_suppressed_destination::builders::DeleteSuppressedDestinationFluentBuilder {
        super::super::operation::delete_suppressed_destination::builders::DeleteSuppressedDestinationFluentBuilder::new(self.handle.clone())
    }
}
