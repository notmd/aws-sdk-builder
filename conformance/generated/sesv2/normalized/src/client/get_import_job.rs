...
impl super::Client {
    ...
    pub fn get_import_job(&self) -> super::super::operation::get_import_job::builders::GetImportJobFluentBuilder {
        super::super::operation::get_import_job::builders::GetImportJobFluentBuilder::new(self.handle.clone())
    }
}
