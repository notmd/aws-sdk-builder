...
impl super::Client {
    ...
    pub fn put_dedicated_ip_in_pool(&self) -> super::super::operation::put_dedicated_ip_in_pool::builders::PutDedicatedIpInPoolFluentBuilder {
        super::super::operation::put_dedicated_ip_in_pool::builders::PutDedicatedIpInPoolFluentBuilder::new(self.handle.clone())
    }
}
