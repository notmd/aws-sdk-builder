...
impl super::Client {
    ...
    pub fn put_suppressed_destination(&self) -> super::super::operation::put_suppressed_destination::builders::PutSuppressedDestinationFluentBuilder {
        super::super::operation::put_suppressed_destination::builders::PutSuppressedDestinationFluentBuilder::new(self.handle.clone())
    }
}
