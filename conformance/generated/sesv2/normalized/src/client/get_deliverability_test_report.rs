...
impl super::Client {
    ...
    pub fn get_deliverability_test_report(
        &self,
    ) -> super::super::operation::get_deliverability_test_report::builders::GetDeliverabilityTestReportFluentBuilder {
        super::super::operation::get_deliverability_test_report::builders::GetDeliverabilityTestReportFluentBuilder::new(self.handle.clone())
    }
}
