...
impl super::Client {
    ...
    pub fn list_contact_lists(&self) -> super::super::operation::list_contact_lists::builders::ListContactListsFluentBuilder {
        super::super::operation::list_contact_lists::builders::ListContactListsFluentBuilder::new(self.handle.clone())
    }
}
