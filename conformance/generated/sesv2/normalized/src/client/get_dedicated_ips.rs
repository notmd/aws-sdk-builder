...
impl super::Client {
    ...
    pub fn get_dedicated_ips(&self) -> super::super::operation::get_dedicated_ips::builders::GetDedicatedIpsFluentBuilder {
        super::super::operation::get_dedicated_ips::builders::GetDedicatedIpsFluentBuilder::new(self.handle.clone())
    }
}
