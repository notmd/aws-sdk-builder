...
impl super::Client {
    ...
    pub fn list_import_jobs(&self) -> super::super::operation::list_import_jobs::builders::ListImportJobsFluentBuilder {
        super::super::operation::list_import_jobs::builders::ListImportJobsFluentBuilder::new(self.handle.clone())
    }
}
