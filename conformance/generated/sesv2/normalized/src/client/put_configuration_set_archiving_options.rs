...
impl super::Client {
    ...
    pub fn put_configuration_set_archiving_options(
        &self,
    ) -> super::super::operation::put_configuration_set_archiving_options::builders::PutConfigurationSetArchivingOptionsFluentBuilder {
        super::super::operation::put_configuration_set_archiving_options::builders::PutConfigurationSetArchivingOptionsFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
