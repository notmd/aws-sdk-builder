...
impl super::Client {
    ...
    pub fn list_tenant_resources(&self) -> super::super::operation::list_tenant_resources::builders::ListTenantResourcesFluentBuilder {
        super::super::operation::list_tenant_resources::builders::ListTenantResourcesFluentBuilder::new(self.handle.clone())
    }
}
