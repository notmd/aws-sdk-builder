...
impl super::Client {
    ...
    pub fn get_contact(&self) -> super::super::operation::get_contact::builders::GetContactFluentBuilder {
        super::super::operation::get_contact::builders::GetContactFluentBuilder::new(self.handle.clone())
    }
}
