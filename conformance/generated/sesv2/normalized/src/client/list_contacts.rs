...
impl super::Client {
    ...
    pub fn list_contacts(&self) -> super::super::operation::list_contacts::builders::ListContactsFluentBuilder {
        super::super::operation::list_contacts::builders::ListContactsFluentBuilder::new(self.handle.clone())
    }
}
