...
impl super::Client {
    ...
    pub fn update_contact_list(&self) -> super::super::operation::update_contact_list::builders::UpdateContactListFluentBuilder {
        super::super::operation::update_contact_list::builders::UpdateContactListFluentBuilder::new(self.handle.clone())
    }
}
