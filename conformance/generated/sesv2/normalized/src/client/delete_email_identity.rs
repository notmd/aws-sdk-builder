...
impl super::Client {
    ...
    pub fn delete_email_identity(&self) -> super::super::operation::delete_email_identity::builders::DeleteEmailIdentityFluentBuilder {
        super::super::operation::delete_email_identity::builders::DeleteEmailIdentityFluentBuilder::new(self.handle.clone())
    }
}
