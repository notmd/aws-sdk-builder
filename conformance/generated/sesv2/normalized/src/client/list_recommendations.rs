...
impl super::Client {
    ...
    pub fn list_recommendations(&self) -> super::super::operation::list_recommendations::builders::ListRecommendationsFluentBuilder {
        super::super::operation::list_recommendations::builders::ListRecommendationsFluentBuilder::new(self.handle.clone())
    }
}
