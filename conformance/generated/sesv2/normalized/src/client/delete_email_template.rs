...
impl super::Client {
    ...
    pub fn delete_email_template(&self) -> super::super::operation::delete_email_template::builders::DeleteEmailTemplateFluentBuilder {
        super::super::operation::delete_email_template::builders::DeleteEmailTemplateFluentBuilder::new(self.handle.clone())
    }
}
