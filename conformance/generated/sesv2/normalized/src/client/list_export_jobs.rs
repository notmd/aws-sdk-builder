...
impl super::Client {
    ...
    pub fn list_export_jobs(&self) -> super::super::operation::list_export_jobs::builders::ListExportJobsFluentBuilder {
        super::super::operation::list_export_jobs::builders::ListExportJobsFluentBuilder::new(self.handle.clone())
    }
}
