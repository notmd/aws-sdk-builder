...
impl super::Client {
    ...
    pub fn put_account_vdm_attributes(&self) -> super::super::operation::put_account_vdm_attributes::builders::PutAccountVdmAttributesFluentBuilder {
        super::super::operation::put_account_vdm_attributes::builders::PutAccountVdmAttributesFluentBuilder::new(self.handle.clone())
    }
}
