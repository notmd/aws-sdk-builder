...
impl super::Client {
    ...
    pub fn get_message_insights(&self) -> super::super::operation::get_message_insights::builders::GetMessageInsightsFluentBuilder {
        super::super::operation::get_message_insights::builders::GetMessageInsightsFluentBuilder::new(self.handle.clone())
    }
}
