...
impl super::Client {
    ...
    pub fn get_domain_deliverability_campaign(
        &self,
    ) -> super::super::operation::get_domain_deliverability_campaign::builders::GetDomainDeliverabilityCampaignFluentBuilder {
        super::super::operation::get_domain_deliverability_campaign::builders::GetDomainDeliverabilityCampaignFluentBuilder::new(self.handle.clone())
    }
}
