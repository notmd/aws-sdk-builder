...
pub struct Tenant {
    ...
    pub sending_status: ::std::option::Option<super::super::types::SendingStatus>,
    /// <p>An object that contains information about the suppression list preferences for the tenant.</p>
    pub suppression_attributes: ::std::option::Option<super::super::types::TenantSuppressionAttributes>,
}
impl Tenant {
    /// <p>The name of the tenant.</p>
    ...
    /// <p>The status of sending capability for the tenant.</p>
    pub fn sending_status(&self) -> ::std::option::Option<&super::super::types::SendingStatus> {
        self.sending_status.as_ref()
    }
    /// <p>An object that contains information about the suppression list preferences for the tenant.</p>
    pub fn suppression_attributes(&self) -> ::std::option::Option<&super::super::types::TenantSuppressionAttributes> {
        self.suppression_attributes.as_ref()
    }
}
impl Tenant {
    /// Creates a new builder-style object to manufacture [`Tenant`](crate::types::Tenant).
    pub fn builder() -> super::super::types::builders::TenantBuilder {
        super::super::types::builders::TenantBuilder::default()
    }
}
...
pub struct TenantBuilder {
    ...
    pub(crate) sending_status: ::std::option::Option<super::super::types::SendingStatus>,
    pub(crate) suppression_attributes: ::std::option::Option<super::super::types::TenantSuppressionAttributes>,
}
impl TenantBuilder {
    /// <p>The name of the tenant.</p>
    ...
    /// <p>The status of sending capability for the tenant.</p>
    pub fn sending_status(mut self, input: super::super::types::SendingStatus) -> Self {
        self.sending_status = ::std::option::Option::Some(input);
        self
    }
    /// <p>The status of sending capability for the tenant.</p>
    pub fn set_sending_status(mut self, input: ::std::option::Option<super::super::types::SendingStatus>) -> Self {
        self.sending_status = input;
        self
    }
    /// <p>The status of sending capability for the tenant.</p>
    pub fn get_sending_status(&self) -> &::std::option::Option<super::super::types::SendingStatus> {
        &self.sending_status
    }
    /// <p>An object that contains information about the suppression list preferences for the tenant.</p>
    pub fn suppression_attributes(mut self, input: super::super::types::TenantSuppressionAttributes) -> Self {
        self.suppression_attributes = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object that contains information about the suppression list preferences for the tenant.</p>
    pub fn set_suppression_attributes(mut self, input: ::std::option::Option<super::super::types::TenantSuppressionAttributes>) -> Self {
        self.suppression_attributes = input;
        self
    }
    /// <p>An object that contains information about the suppression list preferences for the tenant.</p>
    pub fn get_suppression_attributes(&self) -> &::std::option::Option<super::super::types::TenantSuppressionAttributes> {
        &self.suppression_attributes
    }
    /// Consumes the builder and constructs a [`Tenant`](crate::types::Tenant).
    pub fn build(self) -> super::super::types::Tenant {
        super::super::types::Tenant {
