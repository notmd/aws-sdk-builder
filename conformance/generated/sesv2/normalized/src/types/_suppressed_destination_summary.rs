...
impl SuppressedDestinationSummary {
    ...
    pub fn builder() -> super::super::types::builders::SuppressedDestinationSummaryBuilder {
        super::super::types::builders::SuppressedDestinationSummaryBuilder::default()
    }
}
...
impl SuppressedDestinationSummaryBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::SuppressedDestinationSummary, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::SuppressedDestinationSummary {
