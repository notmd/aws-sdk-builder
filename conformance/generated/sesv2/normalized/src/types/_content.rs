...
impl Content {
    ...
    pub fn builder() -> super::super::types::builders::ContentBuilder {
        super::super::types::builders::ContentBuilder::default()
    }
}
...
impl ContentBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::Content, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::Content {
