...
impl TenantInfo {
    ...
    pub fn builder() -> super::super::types::builders::TenantInfoBuilder {
        super::super::types::builders::TenantInfoBuilder::default()
    }
}
...
impl TenantInfoBuilder {
    ...
    pub fn build(self) -> super::super::types::TenantInfo {
        super::super::types::TenantInfo {
