...
impl ResourceTenantMetadata {
    ...
    pub fn builder() -> super::super::types::builders::ResourceTenantMetadataBuilder {
        super::super::types::builders::ResourceTenantMetadataBuilder::default()
    }
}
...
impl ResourceTenantMetadataBuilder {
    ...
    pub fn build(self) -> super::super::types::ResourceTenantMetadata {
        super::super::types::ResourceTenantMetadata {
