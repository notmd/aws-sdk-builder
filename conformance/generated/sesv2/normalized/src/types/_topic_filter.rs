...
impl TopicFilter {
    ...
    pub fn builder() -> super::super::types::builders::TopicFilterBuilder {
        super::super::types::builders::TopicFilterBuilder::default()
    }
}
...
impl TopicFilterBuilder {
    ...
    pub fn build(self) -> super::super::types::TopicFilter {
        super::super::types::TopicFilter {
