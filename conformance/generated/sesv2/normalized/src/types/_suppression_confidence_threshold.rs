...
pub struct SuppressionConfidenceThreshold {
    ...
    pub confidence_verdict_threshold: super::super::types::SuppressionConfidenceVerdictThreshold,
}
impl SuppressionConfidenceThreshold {
    /// <p>The confidence level threshold for suppression decisions.</p>
    pub fn confidence_verdict_threshold(&self) -> &super::super::types::SuppressionConfidenceVerdictThreshold {
...
impl SuppressionConfidenceThreshold {
    ...
    pub fn builder() -> super::super::types::builders::SuppressionConfidenceThresholdBuilder {
        super::super::types::builders::SuppressionConfidenceThresholdBuilder::default()
    }
}
...
pub struct SuppressionConfidenceThresholdBuilder {
    pub(crate) confidence_verdict_threshold: ::std::option::Option<super::super::types::SuppressionConfidenceVerdictThreshold>,
}
impl SuppressionConfidenceThresholdBuilder {
    /// <p>The confidence level threshold for suppression decisions.</p>
    /// This field is required.
    pub fn confidence_verdict_threshold(mut self, input: super::super::types::SuppressionConfidenceVerdictThreshold) -> Self {
    ...
    /// <p>The confidence level threshold for suppression decisions.</p>
    pub fn get_confidence_verdict_threshold(&self) -> &::std::option::Option<super::super::types::SuppressionConfidenceVerdictThreshold> {
        &self.confidence_verdict_threshold
    }
