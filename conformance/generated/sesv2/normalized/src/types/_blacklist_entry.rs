...
impl BlacklistEntry {
    ...
    pub fn builder() -> super::super::types::builders::BlacklistEntryBuilder {
        super::super::types::builders::BlacklistEntryBuilder::default()
    }
}
...
impl BlacklistEntryBuilder {
    ...
    pub fn build(self) -> super::super::types::BlacklistEntry {
        super::super::types::BlacklistEntry {
