...
impl PinpointDestination {
    ...
    pub fn builder() -> super::super::types::builders::PinpointDestinationBuilder {
        super::super::types::builders::PinpointDestinationBuilder::default()
    }
}
...
impl PinpointDestinationBuilder {
    ...
    pub fn build(self) -> super::super::types::PinpointDestination {
        super::super::types::PinpointDestination {
