...
pub struct Contact {
    ...
    pub topic_preferences: ::std::option::Option<::std::vec::Vec<super::super::types::TopicPreference>>,
    /// <p>The default topic preferences applied to the contact.</p>
    pub topic_default_preferences: ::std::option::Option<::std::vec::Vec<super::super::types::TopicPreference>>,
...
impl Contact {
    ...
    pub fn topic_preferences(&self) -> &[super::super::types::TopicPreference] {
    ...
    pub fn topic_default_preferences(&self) -> &[super::super::types::TopicPreference] {
...
impl Contact {
    ...
    pub fn builder() -> super::super::types::builders::ContactBuilder {
        super::super::types::builders::ContactBuilder::default()
    }
}
...
pub struct ContactBuilder {
    ...
    pub(crate) topic_preferences: ::std::option::Option<::std::vec::Vec<super::super::types::TopicPreference>>,
    pub(crate) topic_default_preferences: ::std::option::Option<::std::vec::Vec<super::super::types::TopicPreference>>,
...
impl ContactBuilder {
    ...
    ///
    /// <p>The contact's preference for being opted-in to or opted-out of a topic.</p>
    pub fn topic_preferences(mut self, input: super::super::types::TopicPreference) -> Self {
    ...
    /// <p>The contact's preference for being opted-in to or opted-out of a topic.</p>
    pub fn set_topic_preferences(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::TopicPreference>>) -> Self {
        self.topic_preferences = input;
        self
    }
    /// <p>The contact's preference for being opted-in to or opted-out of a topic.</p>
    pub fn get_topic_preferences(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::TopicPreference>> {
    ...
    ///
    /// <p>The default topic preferences applied to the contact.</p>
    pub fn topic_default_preferences(mut self, input: super::super::types::TopicPreference) -> Self {
    ...
    /// <p>The default topic preferences applied to the contact.</p>
    pub fn set_topic_default_preferences(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::TopicPreference>>) -> Self {
        self.topic_default_preferences = input;
        self
    }
    /// <p>The default topic preferences applied to the contact.</p>
    pub fn get_topic_default_preferences(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::TopicPreference>> {
    ...
    pub fn build(self) -> super::super::types::Contact {
        super::super::types::Contact {
