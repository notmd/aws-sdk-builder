...
pub struct MultiRegionEndpoint {
    ...
    /// </ul>
    pub status: ::std::option::Option<super::super::types::Status>,
...
impl MultiRegionEndpoint {
    ...
    /// <p><code>DELETING</code> – The resource is being deleted as requested.</p></li>
    /// </ul>
    pub fn status(&self) -> ::std::option::Option<&super::super::types::Status> {
        self.status.as_ref()
    }
    /// <p>The ID of the multi-region endpoint (global-endpoint).</p>
...
impl MultiRegionEndpoint {
    ...
    pub fn builder() -> super::super::types::builders::MultiRegionEndpointBuilder {
        super::super::types::builders::MultiRegionEndpointBuilder::default()
    }
}
...
pub struct MultiRegionEndpointBuilder {
    ...
    pub(crate) status: ::std::option::Option<super::super::types::Status>,
...
impl MultiRegionEndpointBuilder {
    ...
    /// <p><code>DELETING</code> – The resource is being deleted as requested.</p></li>
    /// </ul>
    pub fn status(mut self, input: super::super::types::Status) -> Self {
    ...
    /// <p><code>DELETING</code> – The resource is being deleted as requested.</p></li>
    /// </ul>
    pub fn set_status(mut self, input: ::std::option::Option<super::super::types::Status>) -> Self {
        self.status = input;
        self
    }
    /// <p>The status of the multi-region endpoint (global-endpoint).</p>
    ...
    /// <p><code>DELETING</code> – The resource is being deleted as requested.</p></li>
    /// </ul>
    pub fn get_status(&self) -> &::std::option::Option<super::super::types::Status> {
        &self.status
    }
    /// <p>The ID of the multi-region endpoint (global-endpoint).</p>
    ...
    pub fn build(self) -> super::super::types::MultiRegionEndpoint {
        super::super::types::MultiRegionEndpoint {
