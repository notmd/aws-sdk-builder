...
impl SendQuota {
    ...
    pub fn builder() -> super::super::types::builders::SendQuotaBuilder {
        super::super::types::builders::SendQuotaBuilder::default()
    }
}
...
impl SendQuotaBuilder {
    ...
    pub fn build(self) -> super::super::types::SendQuota {
        super::super::types::SendQuota {
