...
pub struct DeliveryOptions {
    ...
    pub tls_policy: ::std::option::Option<super::super::types::TlsPolicy>,
...
impl DeliveryOptions {
    /// <p>Specifies whether messages that use the configuration set are required to use Transport Layer Security (TLS). If the value is <code>Require</code>, messages are only delivered if a TLS connection can be established. If the value is <code>Optional</code>, messages can be delivered in plain text if a TLS connection can't be established.</p>
    pub fn tls_policy(&self) -> ::std::option::Option<&super::super::types::TlsPolicy> {
...
impl DeliveryOptions {
    ...
    pub fn builder() -> super::super::types::builders::DeliveryOptionsBuilder {
        super::super::types::builders::DeliveryOptionsBuilder::default()
    }
}
...
pub struct DeliveryOptionsBuilder {
    pub(crate) tls_policy: ::std::option::Option<super::super::types::TlsPolicy>,
...
impl DeliveryOptionsBuilder {
    /// <p>Specifies whether messages that use the configuration set are required to use Transport Layer Security (TLS). If the value is <code>Require</code>, messages are only delivered if a TLS connection can be established. If the value is <code>Optional</code>, messages can be delivered in plain text if a TLS connection can't be established.</p>
    pub fn tls_policy(mut self, input: super::super::types::TlsPolicy) -> Self {
        self.tls_policy = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies whether messages that use the configuration set are required to use Transport Layer Security (TLS). If the value is <code>Require</code>, messages are only delivered if a TLS connection can be established. If the value is <code>Optional</code>, messages can be delivered in plain text if a TLS connection can't be established.</p>
    pub fn set_tls_policy(mut self, input: ::std::option::Option<super::super::types::TlsPolicy>) -> Self {
        self.tls_policy = input;
        self
    }
    /// <p>Specifies whether messages that use the configuration set are required to use Transport Layer Security (TLS). If the value is <code>Require</code>, messages are only delivered if a TLS connection can be established. If the value is <code>Optional</code>, messages can be delivered in plain text if a TLS connection can't be established.</p>
    pub fn get_tls_policy(&self) -> &::std::option::Option<super::super::types::TlsPolicy> {
        &self.tls_policy
    }
    /// <p>The name of the dedicated IP pool to associate with the configuration set.</p>
    ...
    pub fn build(self) -> super::super::types::DeliveryOptions {
        super::super::types::DeliveryOptions {
