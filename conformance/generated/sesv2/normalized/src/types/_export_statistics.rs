...
impl ExportStatistics {
    ...
    pub fn builder() -> super::super::types::builders::ExportStatisticsBuilder {
        super::super::types::builders::ExportStatisticsBuilder::default()
    }
}
...
impl ExportStatisticsBuilder {
    ...
    pub fn build(self) -> super::super::types::ExportStatistics {
        super::super::types::ExportStatistics {
