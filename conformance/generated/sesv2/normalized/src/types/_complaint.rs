...
impl Complaint {
    ...
    pub fn builder() -> super::super::types::builders::ComplaintBuilder {
        super::super::types::builders::ComplaintBuilder::default()
    }
}
...
impl ComplaintBuilder {
    ...
    pub fn build(self) -> super::super::types::Complaint {
        super::super::types::Complaint {
