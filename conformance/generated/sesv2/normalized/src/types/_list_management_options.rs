...
impl ListManagementOptions {
    ...
    pub fn builder() -> super::super::types::builders::ListManagementOptionsBuilder {
        super::super::types::builders::ListManagementOptionsBuilder::default()
    }
}
...
impl ListManagementOptionsBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::ListManagementOptions, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::ListManagementOptions {
