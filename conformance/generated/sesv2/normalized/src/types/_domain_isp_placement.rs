...
impl DomainIspPlacement {
    ...
    pub fn builder() -> super::super::types::builders::DomainIspPlacementBuilder {
        super::super::types::builders::DomainIspPlacementBuilder::default()
    }
}
...
impl DomainIspPlacementBuilder {
    ...
    pub fn build(self) -> super::super::types::DomainIspPlacement {
        super::super::types::DomainIspPlacement {
