...
impl PlacementStatistics {
    ...
    pub fn builder() -> super::super::types::builders::PlacementStatisticsBuilder {
        super::super::types::builders::PlacementStatisticsBuilder::default()
    }
}
...
impl PlacementStatisticsBuilder {
    ...
    pub fn build(self) -> super::super::types::PlacementStatistics {
        super::super::types::PlacementStatistics {
