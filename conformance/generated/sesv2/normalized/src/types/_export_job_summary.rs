...
pub struct ExportJobSummary {
    ...
    pub export_source_type: ::std::option::Option<super::super::types::ExportSourceType>,
...
impl ExportJobSummary {
    ...
    /// <p>The source type of the export job.</p>
    pub fn export_source_type(&self) -> ::std::option::Option<&super::super::types::ExportSourceType> {
...
impl ExportJobSummary {
    ...
    pub fn builder() -> super::super::types::builders::ExportJobSummaryBuilder {
        super::super::types::builders::ExportJobSummaryBuilder::default()
    }
}
...
pub struct ExportJobSummaryBuilder {
    ...
    pub(crate) export_source_type: ::std::option::Option<super::super::types::ExportSourceType>,
...
impl ExportJobSummaryBuilder {
    ...
    /// <p>The source type of the export job.</p>
    pub fn export_source_type(mut self, input: super::super::types::ExportSourceType) -> Self {
        self.export_source_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The source type of the export job.</p>
    pub fn set_export_source_type(mut self, input: ::std::option::Option<super::super::types::ExportSourceType>) -> Self {
        self.export_source_type = input;
        self
    }
    /// <p>The source type of the export job.</p>
    pub fn get_export_source_type(&self) -> &::std::option::Option<super::super::types::ExportSourceType> {
    ...
    pub fn build(self) -> super::super::types::ExportJobSummary {
        super::super::types::ExportJobSummary {
            job_id: self.job_id,
