...
pub struct ReplacementEmailContent {
    ...
    pub replacement_template: ::std::option::Option<super::super::types::ReplacementTemplate>,
}
impl ReplacementEmailContent {
    /// <p>The <code>ReplacementTemplate</code> associated with <code>ReplacementEmailContent</code>.</p>
    pub fn replacement_template(&self) -> ::std::option::Option<&super::super::types::ReplacementTemplate> {
...
impl ReplacementEmailContent {
    ...
    pub fn builder() -> super::super::types::builders::ReplacementEmailContentBuilder {
        super::super::types::builders::ReplacementEmailContentBuilder::default()
    }
}
...
pub struct ReplacementEmailContentBuilder {
    pub(crate) replacement_template: ::std::option::Option<super::super::types::ReplacementTemplate>,
}
impl ReplacementEmailContentBuilder {
    /// <p>The <code>ReplacementTemplate</code> associated with <code>ReplacementEmailContent</code>.</p>
    pub fn replacement_template(mut self, input: super::super::types::ReplacementTemplate) -> Self {
        self.replacement_template = ::std::option::Option::Some(input);
        self
    }
    /// <p>The <code>ReplacementTemplate</code> associated with <code>ReplacementEmailContent</code>.</p>
    pub fn set_replacement_template(mut self, input: ::std::option::Option<super::super::types::ReplacementTemplate>) -> Self {
        self.replacement_template = input;
        self
    }
    /// <p>The <code>ReplacementTemplate</code> associated with <code>ReplacementEmailContent</code>.</p>
    pub fn get_replacement_template(&self) -> &::std::option::Option<super::super::types::ReplacementTemplate> {
    ...
    pub fn build(self) -> super::super::types::ReplacementEmailContent {
        super::super::types::ReplacementEmailContent {
