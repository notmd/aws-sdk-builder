...
pub struct DedicatedIpPool {
    ...
    /// </ul>
    pub scaling_mode: super::super::types::ScalingMode,
}
impl DedicatedIpPool {
    ...
    /// <p><code>MANAGED</code> – A dedicated IP pool where the reputation and number of IPs are automatically managed by Amazon SES.</p></li>
    /// </ul>
    pub fn scaling_mode(&self) -> &super::super::types::ScalingMode {
        &self.scaling_mode
    }
}
impl DedicatedIpPool {
    /// Creates a new builder-style object to manufacture [`DedicatedIpPool`](crate::types::DedicatedIpPool).
    pub fn builder() -> super::super::types::builders::DedicatedIpPoolBuilder {
        super::super::types::builders::DedicatedIpPoolBuilder::default()
    }
}
...
pub struct DedicatedIpPoolBuilder {
    ...
    pub(crate) scaling_mode: ::std::option::Option<super::super::types::ScalingMode>,
}
impl DedicatedIpPoolBuilder {
    ...
    /// </ul>
    /// This field is required.
    pub fn scaling_mode(mut self, input: super::super::types::ScalingMode) -> Self {
    ...
    /// <p><code>MANAGED</code> – A dedicated IP pool where the reputation and number of IPs are automatically managed by Amazon SES.</p></li>
    /// </ul>
    pub fn set_scaling_mode(mut self, input: ::std::option::Option<super::super::types::ScalingMode>) -> Self {
    ...
    /// <p><code>MANAGED</code> – A dedicated IP pool where the reputation and number of IPs are automatically managed by Amazon SES.</p></li>
    /// </ul>
    pub fn get_scaling_mode(&self) -> &::std::option::Option<super::super::types::ScalingMode> {
        &self.scaling_mode
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::DedicatedIpPool, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::DedicatedIpPool {
