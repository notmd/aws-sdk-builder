...
pub struct MailFromAttributes {
    ...
    /// </ul>
    pub mail_from_domain_status: super::super::types::MailFromDomainStatus,
    ...
    pub behavior_on_mx_failure: super::super::types::BehaviorOnMxFailure,
}
impl MailFromAttributes {
    ...
    /// <p><code>TEMPORARY_FAILURE</code> – A temporary issue occurred, which prevented Amazon SES from determining the status of the MAIL FROM domain.</p></li>
    /// </ul>
    pub fn mail_from_domain_status(&self) -> &super::super::types::MailFromDomainStatus {
        &self.mail_from_domain_status
    }
    /// <p>The action to take if the required MX record can't be found when you send an email. When you set this value to <code>USE_DEFAULT_VALUE</code>, the mail is sent using <i>amazonses.com</i> as the MAIL FROM domain. When you set this value to <code>REJECT_MESSAGE</code>, the Amazon SES API v2 returns a <code>MailFromDomainNotVerified</code> error, and doesn't attempt to deliver the email.</p>
    /// <p>These behaviors are taken when the custom MAIL FROM domain configuration is in the <code>Pending</code>, <code>Failed</code>, and <code>TemporaryFailure</code> states.</p>
    pub fn behavior_on_mx_failure(&self) -> &super::super::types::BehaviorOnMxFailure {
...
impl MailFromAttributes {
    ...
    pub fn builder() -> super::super::types::builders::MailFromAttributesBuilder {
        super::super::types::builders::MailFromAttributesBuilder::default()
    }
}
...
pub struct MailFromAttributesBuilder {
    ...
    pub(crate) mail_from_domain_status: ::std::option::Option<super::super::types::MailFromDomainStatus>,
    pub(crate) behavior_on_mx_failure: ::std::option::Option<super::super::types::BehaviorOnMxFailure>,
}
impl MailFromAttributesBuilder {
    ...
    /// </ul>
    /// This field is required.
    pub fn mail_from_domain_status(mut self, input: super::super::types::MailFromDomainStatus) -> Self {
    ...
    /// <p><code>TEMPORARY_FAILURE</code> – A temporary issue occurred, which prevented Amazon SES from determining the status of the MAIL FROM domain.</p></li>
    /// </ul>
    pub fn set_mail_from_domain_status(mut self, input: ::std::option::Option<super::super::types::MailFromDomainStatus>) -> Self {
    ...
    /// <p><code>TEMPORARY_FAILURE</code> – A temporary issue occurred, which prevented Amazon SES from determining the status of the MAIL FROM domain.</p></li>
    /// </ul>
    pub fn get_mail_from_domain_status(&self) -> &::std::option::Option<super::super::types::MailFromDomainStatus> {
        &self.mail_from_domain_status
    }
    /// <p>The action to take if the required MX record can't be found when you send an email. When you set this value to <code>USE_DEFAULT_VALUE</code>, the mail is sent using <i>amazonses.com</i> as the MAIL FROM domain. When you set this value to <code>REJECT_MESSAGE</code>, the Amazon SES API v2 returns a <code>MailFromDomainNotVerified</code> error, and doesn't attempt to deliver the email.</p>
    /// <p>These behaviors are taken when the custom MAIL FROM domain configuration is in the <code>Pending</code>, <code>Failed</code>, and <code>TemporaryFailure</code> states.</p>
    /// This field is required.
    pub fn behavior_on_mx_failure(mut self, input: super::super::types::BehaviorOnMxFailure) -> Self {
        self.behavior_on_mx_failure = ::std::option::Option::Some(input);
        self
    }
    /// <p>The action to take if the required MX record can't be found when you send an email. When you set this value to <code>USE_DEFAULT_VALUE</code>, the mail is sent using <i>amazonses.com</i> as the MAIL FROM domain. When you set this value to <code>REJECT_MESSAGE</code>, the Amazon SES API v2 returns a <code>MailFromDomainNotVerified</code> error, and doesn't attempt to deliver the email.</p>
    /// <p>These behaviors are taken when the custom MAIL FROM domain configuration is in the <code>Pending</code>, <code>Failed</code>, and <code>TemporaryFailure</code> states.</p>
    pub fn set_behavior_on_mx_failure(mut self, input: ::std::option::Option<super::super::types::BehaviorOnMxFailure>) -> Self {
        self.behavior_on_mx_failure = input;
        self
    }
    /// <p>The action to take if the required MX record can't be found when you send an email. When you set this value to <code>USE_DEFAULT_VALUE</code>, the mail is sent using <i>amazonses.com</i> as the MAIL FROM domain. When you set this value to <code>REJECT_MESSAGE</code>, the Amazon SES API v2 returns a <code>MailFromDomainNotVerified</code> error, and doesn't attempt to deliver the email.</p>
    /// <p>These behaviors are taken when the custom MAIL FROM domain configuration is in the <code>Pending</code>, <code>Failed</code>, and <code>TemporaryFailure</code> states.</p>
    pub fn get_behavior_on_mx_failure(&self) -> &::std::option::Option<super::super::types::BehaviorOnMxFailure> {
        &self.behavior_on_mx_failure
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::MailFromAttributes, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::MailFromAttributes {
