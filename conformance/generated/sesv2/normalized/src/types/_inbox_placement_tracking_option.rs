...
impl InboxPlacementTrackingOption {
    ...
    pub fn builder() -> super::super::types::builders::InboxPlacementTrackingOptionBuilder {
        super::super::types::builders::InboxPlacementTrackingOptionBuilder::default()
    }
}
...
impl InboxPlacementTrackingOptionBuilder {
    ...
    pub fn build(self) -> super::super::types::InboxPlacementTrackingOption {
        super::super::types::InboxPlacementTrackingOption {
