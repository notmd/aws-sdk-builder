...
impl SoaRecord {
    ...
    pub fn builder() -> super::super::types::builders::SoaRecordBuilder {
        super::super::types::builders::SoaRecordBuilder::default()
    }
}
...
impl SoaRecordBuilder {
    ...
    pub fn build(self) -> super::super::types::SoaRecord {
        super::super::types::SoaRecord {
