...
impl DomainDeliverabilityCampaign {
    ...
    pub fn builder() -> super::super::types::builders::DomainDeliverabilityCampaignBuilder {
        super::super::types::builders::DomainDeliverabilityCampaignBuilder::default()
    }
}
...
impl DomainDeliverabilityCampaignBuilder {
    ...
    pub fn build(self) -> super::super::types::DomainDeliverabilityCampaign {
        super::super::types::DomainDeliverabilityCampaign {
