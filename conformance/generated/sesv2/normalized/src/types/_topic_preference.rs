...
pub struct TopicPreference {
    ...
    pub subscription_status: super::super::types::SubscriptionStatus,
}
impl TopicPreference {
    ...
    /// <p>The contact's subscription status to a topic which is either <code>OPT_IN</code> or <code>OPT_OUT</code>.</p>
    pub fn subscription_status(&self) -> &super::super::types::SubscriptionStatus {
        &self.subscription_status
    }
}
impl TopicPreference {
    /// Creates a new builder-style object to manufacture [`TopicPreference`](crate::types::TopicPreference).
    pub fn builder() -> super::super::types::builders::TopicPreferenceBuilder {
        super::super::types::builders::TopicPreferenceBuilder::default()
    }
}
...
pub struct TopicPreferenceBuilder {
    ...
    pub(crate) subscription_status: ::std::option::Option<super::super::types::SubscriptionStatus>,
}
impl TopicPreferenceBuilder {
    ...
    /// <p>The contact's subscription status to a topic which is either <code>OPT_IN</code> or <code>OPT_OUT</code>.</p>
    /// This field is required.
    pub fn subscription_status(mut self, input: super::super::types::SubscriptionStatus) -> Self {
        self.subscription_status = ::std::option::Option::Some(input);
        self
    }
    /// <p>The contact's subscription status to a topic which is either <code>OPT_IN</code> or <code>OPT_OUT</code>.</p>
    pub fn set_subscription_status(mut self, input: ::std::option::Option<super::super::types::SubscriptionStatus>) -> Self {
        self.subscription_status = input;
        self
    }
    /// <p>The contact's subscription status to a topic which is either <code>OPT_IN</code> or <code>OPT_OUT</code>.</p>
    pub fn get_subscription_status(&self) -> &::std::option::Option<super::super::types::SubscriptionStatus> {
        &self.subscription_status
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::TopicPreference, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::TopicPreference {
