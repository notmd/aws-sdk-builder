...
impl EmailTemplateMetadata {
    ...
    pub fn builder() -> super::super::types::builders::EmailTemplateMetadataBuilder {
        super::super::types::builders::EmailTemplateMetadataBuilder::default()
    }
}
...
impl EmailTemplateMetadataBuilder {
    ...
    pub fn build(self) -> super::super::types::EmailTemplateMetadata {
        super::super::types::EmailTemplateMetadata {
