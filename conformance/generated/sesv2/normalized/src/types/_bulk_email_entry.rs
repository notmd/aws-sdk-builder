...
pub struct BulkEmailEntry {
    ...
    pub replacement_tags: ::std::option::Option<::std::vec::Vec<super::super::types::MessageTag>>,
    /// <p>The <code>ReplacementEmailContent</code> associated with a <code>BulkEmailEntry</code>.</p>
    pub replacement_email_content: ::std::option::Option<super::super::types::ReplacementEmailContent>,
    ...
    /// </ul></li>
    /// </ul>
    pub replacement_headers: ::std::option::Option<::std::vec::Vec<super::super::types::MessageHeader>>,
}
impl BulkEmailEntry {
    /// <p>Represents the destination of the message, consisting of To:, CC:, and BCC: fields.</p><note>
    /// <p>Amazon SES does not support the SMTPUTF8 extension, as described in <a href="https://tools.ietf.org/html/rfc6531">RFC6531</a>. For this reason, the local part of a destination email address (the part of the email address that precedes the @ sign) may only contain <a href="https://en.wikipedia.org/wiki/Email_address#Local-part">7-bit ASCII characters</a>. If the domain part of an address (the part after the @ sign) contains non-ASCII characters, they must be encoded using Punycode, as described in <a href="https://tools.ietf.org/html/rfc3492.html">RFC3492</a>.</p>
    ...
    pub fn replacement_tags(&self) -> &[super::super::types::MessageTag] {
        self.replacement_tags.as_deref().unwrap_or_default()
    }
    /// <p>The <code>ReplacementEmailContent</code> associated with a <code>BulkEmailEntry</code>.</p>
    pub fn replacement_email_content(&self) -> ::std::option::Option<&super::super::types::ReplacementEmailContent> {
    ...
    pub fn replacement_headers(&self) -> &[super::super::types::MessageHeader] {
...
impl BulkEmailEntry {
    ...
    pub fn builder() -> super::super::types::builders::BulkEmailEntryBuilder {
        super::super::types::builders::BulkEmailEntryBuilder::default()
    }
}
...
pub struct BulkEmailEntryBuilder {
    ...
    pub(crate) replacement_tags: ::std::option::Option<::std::vec::Vec<super::super::types::MessageTag>>,
    pub(crate) replacement_email_content: ::std::option::Option<super::super::types::ReplacementEmailContent>,
    pub(crate) replacement_headers: ::std::option::Option<::std::vec::Vec<super::super::types::MessageHeader>>,
}
impl BulkEmailEntryBuilder {
    ...
    ///
    /// <p>A list of tags, in the form of name/value pairs, to apply to an email that you send using the <code>SendBulkTemplatedEmail</code> operation. Tags correspond to characteristics of the email that you define, so that you can publish email sending events.</p>
    pub fn replacement_tags(mut self, input: super::super::types::MessageTag) -> Self {
    ...
    /// <p>A list of tags, in the form of name/value pairs, to apply to an email that you send using the <code>SendBulkTemplatedEmail</code> operation. Tags correspond to characteristics of the email that you define, so that you can publish email sending events.</p>
    pub fn set_replacement_tags(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::MessageTag>>) -> Self {
        self.replacement_tags = input;
        self
    }
    /// <p>A list of tags, in the form of name/value pairs, to apply to an email that you send using the <code>SendBulkTemplatedEmail</code> operation. Tags correspond to characteristics of the email that you define, so that you can publish email sending events.</p>
    pub fn get_replacement_tags(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::MessageTag>> {
        &self.replacement_tags
    }
    /// <p>The <code>ReplacementEmailContent</code> associated with a <code>BulkEmailEntry</code>.</p>
    pub fn replacement_email_content(mut self, input: super::super::types::ReplacementEmailContent) -> Self {
        self.replacement_email_content = ::std::option::Option::Some(input);
        self
    }
    /// <p>The <code>ReplacementEmailContent</code> associated with a <code>BulkEmailEntry</code>.</p>
    pub fn set_replacement_email_content(mut self, input: ::std::option::Option<super::super::types::ReplacementEmailContent>) -> Self {
        self.replacement_email_content = input;
        self
    }
    /// <p>The <code>ReplacementEmailContent</code> associated with a <code>BulkEmailEntry</code>.</p>
    pub fn get_replacement_email_content(&self) -> &::std::option::Option<super::super::types::ReplacementEmailContent> {
    ...
    /// </ul></li>
    /// </ul>
    pub fn replacement_headers(mut self, input: super::super::types::MessageHeader) -> Self {
    ...
    /// </ul></li>
    /// </ul>
    pub fn set_replacement_headers(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::MessageHeader>>) -> Self {
    ...
    /// </ul></li>
    /// </ul>
    pub fn get_replacement_headers(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::MessageHeader>> {
        &self.replacement_headers
    }
    /// Consumes the builder and constructs a [`BulkEmailEntry`](crate::types::BulkEmailEntry).
    pub fn build(self) -> super::super::types::BulkEmailEntry {
        super::super::types::BulkEmailEntry {
