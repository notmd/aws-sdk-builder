...
///
/// <p>The type of resource that can be associated with a tenant. Can be one of the following:</p>
/// <ul>
/// <li>
/// <p>
...
impl ::std::convert::From<&str> for ResourceType {
    fn from(s: &str) -> Self {
        match s {
            "CONFIGURATION_SET" => ResourceType::ConfigurationSet,
            "EMAIL_IDENTITY" => ResourceType::EmailIdentity,
            "EMAIL_TEMPLATE" => ResourceType::EmailTemplate,
...
impl ResourceType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ResourceType::ConfigurationSet => "CONFIGURATION_SET",
            ResourceType::EmailIdentity => "EMAIL_IDENTITY",
            ResourceType::EmailTemplate => "EMAIL_TEMPLATE",
            ResourceType::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["CONFIGURATION_SET", "EMAIL_IDENTITY", "EMAIL_TEMPLATE"]
    }
}
