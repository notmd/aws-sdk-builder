...
impl ReputationOptions {
    ...
    pub fn builder() -> super::super::types::builders::ReputationOptionsBuilder {
        super::super::types::builders::ReputationOptionsBuilder::default()
    }
}
...
impl ReputationOptionsBuilder {
    ...
    pub fn build(self) -> super::super::types::ReputationOptions {
        super::super::types::ReputationOptions {
