...
pub struct MessageInsightsDataSource {
    ...
    pub include: ::std::option::Option<super::super::types::MessageInsightsFilters>,
    /// <p>Filters for results to be excluded from the export file.</p>
    pub exclude: ::std::option::Option<super::super::types::MessageInsightsFilters>,
...
impl MessageInsightsDataSource {
    ...
    /// <p>Filters for results to be included in the export file.</p>
    pub fn include(&self) -> ::std::option::Option<&super::super::types::MessageInsightsFilters> {
        self.include.as_ref()
    }
    /// <p>Filters for results to be excluded from the export file.</p>
    pub fn exclude(&self) -> ::std::option::Option<&super::super::types::MessageInsightsFilters> {
        self.exclude.as_ref()
    }
    /// <p>The maximum number of results.</p>
...
impl MessageInsightsDataSource {
    ...
    pub fn builder() -> super::super::types::builders::MessageInsightsDataSourceBuilder {
        super::super::types::builders::MessageInsightsDataSourceBuilder::default()
    }
}
...
pub struct MessageInsightsDataSourceBuilder {
    ...
    pub(crate) include: ::std::option::Option<super::super::types::MessageInsightsFilters>,
    pub(crate) exclude: ::std::option::Option<super::super::types::MessageInsightsFilters>,
...
impl MessageInsightsDataSourceBuilder {
    ...
    /// <p>Filters for results to be included in the export file.</p>
    pub fn include(mut self, input: super::super::types::MessageInsightsFilters) -> Self {
        self.include = ::std::option::Option::Some(input);
        self
    }
    /// <p>Filters for results to be included in the export file.</p>
    pub fn set_include(mut self, input: ::std::option::Option<super::super::types::MessageInsightsFilters>) -> Self {
        self.include = input;
        self
    }
    /// <p>Filters for results to be included in the export file.</p>
    pub fn get_include(&self) -> &::std::option::Option<super::super::types::MessageInsightsFilters> {
        &self.include
    }
    /// <p>Filters for results to be excluded from the export file.</p>
    pub fn exclude(mut self, input: super::super::types::MessageInsightsFilters) -> Self {
        self.exclude = ::std::option::Option::Some(input);
        self
    }
    /// <p>Filters for results to be excluded from the export file.</p>
    pub fn set_exclude(mut self, input: ::std::option::Option<super::super::types::MessageInsightsFilters>) -> Self {
        self.exclude = input;
        self
    }
    /// <p>Filters for results to be excluded from the export file.</p>
    pub fn get_exclude(&self) -> &::std::option::Option<super::super::types::MessageInsightsFilters> {
        &self.exclude
    }
    /// <p>The maximum number of results.</p>
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::MessageInsightsDataSource, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::MessageInsightsDataSource {
