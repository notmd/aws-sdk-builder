...
impl ReplacementTemplate {
    ...
    pub fn builder() -> super::super::types::builders::ReplacementTemplateBuilder {
        super::super::types::builders::ReplacementTemplateBuilder::default()
    }
}
...
impl ReplacementTemplateBuilder {
    ...
    pub fn build(self) -> super::super::types::ReplacementTemplate {
        super::super::types::ReplacementTemplate {
