...
pub struct BatchGetMetricDataQuery {
    ...
    /// </ul>
    pub metric: super::super::types::Metric,
    ...
    pub dimensions: ::std::option::Option<::std::collections::HashMap<super::super::types::MetricDimensionName, ::std::string::String>>,
...
impl BatchGetMetricDataQuery {
    ...
    /// <p><code>DELIVERY_COMPLAINT</code> – Successful deliveries for email sending attempts. Excludes deliveries to the mailbox simulator, for emails addressed to more than one recipient, and emails addressed to recipients hosted by ISPs with which Amazon SES does not have a feedback loop agreement.</p></li>
    /// </ul>
    pub fn metric(&self) -> &super::super::types::Metric {
        &self.metric
    }
    /// <p>An object that contains mapping between <code>MetricDimensionName</code> and <code>MetricDimensionValue</code> to filter metrics by.</p>
    pub fn dimensions(&self) -> ::std::option::Option<&::std::collections::HashMap<super::super::types::MetricDimensionName, ::std::string::String>> {
...
impl BatchGetMetricDataQuery {
    ...
    pub fn builder() -> super::super::types::builders::BatchGetMetricDataQueryBuilder {
        super::super::types::builders::BatchGetMetricDataQueryBuilder::default()
    }
}
...
pub struct BatchGetMetricDataQueryBuilder {
    ...
    pub(crate) metric: ::std::option::Option<super::super::types::Metric>,
    pub(crate) dimensions: ::std::option::Option<::std::collections::HashMap<super::super::types::MetricDimensionName, ::std::string::String>>,
...
impl BatchGetMetricDataQueryBuilder {
    ...
    /// </ul>
    /// This field is required.
    pub fn metric(mut self, input: super::super::types::Metric) -> Self {
    ...
    /// <p><code>DELIVERY_COMPLAINT</code> – Successful deliveries for email sending attempts. Excludes deliveries to the mailbox simulator, for emails addressed to more than one recipient, and emails addressed to recipients hosted by ISPs with which Amazon SES does not have a feedback loop agreement.</p></li>
    /// </ul>
    pub fn set_metric(mut self, input: ::std::option::Option<super::super::types::Metric>) -> Self {
        self.metric = input;
        self
    }
    /// <p>The queried metric. This can be one of the following:</p>
    ...
    /// <p><code>DELIVERY_COMPLAINT</code> – Successful deliveries for email sending attempts. Excludes deliveries to the mailbox simulator, for emails addressed to more than one recipient, and emails addressed to recipients hosted by ISPs with which Amazon SES does not have a feedback loop agreement.</p></li>
    /// </ul>
    pub fn get_metric(&self) -> &::std::option::Option<super::super::types::Metric> {
        &self.metric
    }
    ...
    ///
    /// <p>An object that contains mapping between <code>MetricDimensionName</code> and <code>MetricDimensionValue</code> to filter metrics by.</p>
    pub fn dimensions(mut self, k: super::super::types::MetricDimensionName, v: impl ::std::convert::Into<::std::string::String>) -> Self {
    ...
    pub fn set_dimensions(
        mut self,
        input: ::std::option::Option<::std::collections::HashMap<super::super::types::MetricDimensionName, ::std::string::String>>,
    ) -> Self {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::BatchGetMetricDataQuery, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::BatchGetMetricDataQuery {
