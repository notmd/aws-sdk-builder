...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::BadRequestException {
...
impl BadRequestException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::BadRequestExceptionBuilder {
        super::super::super::types::error::builders::BadRequestExceptionBuilder::default()
    }
}
...
impl BadRequestExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::BadRequestException {
        super::super::super::types::error::BadRequestException {
