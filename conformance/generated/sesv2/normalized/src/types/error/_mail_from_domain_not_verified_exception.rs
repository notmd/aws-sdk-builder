...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::MailFromDomainNotVerifiedException {
...
impl MailFromDomainNotVerifiedException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::MailFromDomainNotVerifiedExceptionBuilder {
        super::super::super::types::error::builders::MailFromDomainNotVerifiedExceptionBuilder::default()
    }
}
...
impl MailFromDomainNotVerifiedExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::MailFromDomainNotVerifiedException {
        super::super::super::types::error::MailFromDomainNotVerifiedException {
