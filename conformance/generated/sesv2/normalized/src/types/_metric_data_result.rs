...
impl MetricDataResult {
    ...
    pub fn builder() -> super::super::types::builders::MetricDataResultBuilder {
        super::super::types::builders::MetricDataResultBuilder::default()
    }
}
...
impl MetricDataResultBuilder {
    ...
    pub fn build(self) -> super::super::types::MetricDataResult {
        super::super::types::MetricDataResult {
            id: self.id,
