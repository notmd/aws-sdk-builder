...
impl ImportDataSource {
    ...
    pub fn builder() -> super::super::types::builders::ImportDataSourceBuilder {
        super::super::types::builders::ImportDataSourceBuilder::default()
    }
}
...
impl ImportDataSourceBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::ImportDataSource, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::ImportDataSource {
