...
impl ContactList {
    ...
    pub fn builder() -> super::super::types::builders::ContactListBuilder {
        super::super::types::builders::ContactListBuilder::default()
    }
}
...
impl ContactListBuilder {
    ...
    pub fn build(self) -> super::super::types::ContactList {
        super::super::types::ContactList {
