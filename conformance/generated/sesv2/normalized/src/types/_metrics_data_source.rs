...
pub struct MetricsDataSource {
    ...
    pub dimensions: ::std::collections::HashMap<super::super::types::MetricDimensionName, ::std::vec::Vec<::std::string::String>>,
    /// <p>The metrics namespace - e.g., <code>VDM</code>.</p>
    pub namespace: super::super::types::MetricNamespace,
    /// <p>A list of <code>ExportMetric</code> objects to export.</p>
    pub metrics: ::std::vec::Vec<super::super::types::ExportMetric>,
...
impl MetricsDataSource {
    /// <p>An object that contains a mapping between a <code>MetricDimensionName</code> and <code>MetricDimensionValue</code> to filter metrics by. Must contain a least 1 dimension but no more than 3 unique ones.</p>
    pub fn dimensions(&self) -> &::std::collections::HashMap<super::super::types::MetricDimensionName, ::std::vec::Vec<::std::string::String>> {
        &self.dimensions
    }
    /// <p>The metrics namespace - e.g., <code>VDM</code>.</p>
    pub fn namespace(&self) -> &super::super::types::MetricNamespace {
        &self.namespace
    }
    /// <p>A list of <code>ExportMetric</code> objects to export.</p>
    pub fn metrics(&self) -> &[super::super::types::ExportMetric] {
        use std::ops::Deref;
        self.metrics.deref()
    }
    /// <p>Represents the start date for the export interval as a timestamp.</p>
...
impl MetricsDataSource {
    ...
    pub fn builder() -> super::super::types::builders::MetricsDataSourceBuilder {
        super::super::types::builders::MetricsDataSourceBuilder::default()
    }
}
...
pub struct MetricsDataSourceBuilder {
    pub(crate) dimensions:
        ::std::option::Option<::std::collections::HashMap<super::super::types::MetricDimensionName, ::std::vec::Vec<::std::string::String>>>,
    pub(crate) namespace: ::std::option::Option<super::super::types::MetricNamespace>,
    pub(crate) metrics: ::std::option::Option<::std::vec::Vec<super::super::types::ExportMetric>>,
...
impl MetricsDataSourceBuilder {
    ...
    ///
    /// <p>An object that contains a mapping between a <code>MetricDimensionName</code> and <code>MetricDimensionValue</code> to filter metrics by. Must contain a least 1 dimension but no more than 3 unique ones.</p>
    pub fn dimensions(mut self, k: super::super::types::MetricDimensionName, v: ::std::vec::Vec<::std::string::String>) -> Self {
    ...
    pub fn set_dimensions(
        mut self,
        input: ::std::option::Option<::std::collections::HashMap<super::super::types::MetricDimensionName, ::std::vec::Vec<::std::string::String>>>,
    ) -> Self {
    ...
    pub fn namespace(mut self, input: super::super::types::MetricNamespace) -> Self {
        self.namespace = ::std::option::Option::Some(input);
        self
    }
    /// <p>The metrics namespace - e.g., <code>VDM</code>.</p>
    pub fn set_namespace(mut self, input: ::std::option::Option<super::super::types::MetricNamespace>) -> Self {
        self.namespace = input;
        self
    }
    /// <p>The metrics namespace - e.g., <code>VDM</code>.</p>
    pub fn get_namespace(&self) -> &::std::option::Option<super::super::types::MetricNamespace> {
        &self.namespace
    }
    ...
    ///
    /// <p>A list of <code>ExportMetric</code> objects to export.</p>
    pub fn metrics(mut self, input: super::super::types::ExportMetric) -> Self {
    ...
    /// <p>A list of <code>ExportMetric</code> objects to export.</p>
    pub fn set_metrics(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::ExportMetric>>) -> Self {
        self.metrics = input;
        self
    }
    /// <p>A list of <code>ExportMetric</code> objects to export.</p>
    pub fn get_metrics(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::ExportMetric>> {
        &self.metrics
    }
    /// <p>Represents the start date for the export interval as a timestamp.</p>
    /// This field is required.
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::MetricsDataSource, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::MetricsDataSource {
