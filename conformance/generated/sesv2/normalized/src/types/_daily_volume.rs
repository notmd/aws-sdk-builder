...
impl DailyVolume {
    ...
    pub fn builder() -> super::super::types::builders::DailyVolumeBuilder {
        super::super::types::builders::DailyVolumeBuilder::default()
    }
}
...
impl DailyVolumeBuilder {
    ...
    pub fn build(self) -> super::super::types::DailyVolume {
        super::super::types::DailyVolume {
