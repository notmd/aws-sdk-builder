...
impl MessageTag {
    ...
    pub fn builder() -> super::super::types::builders::MessageTagBuilder {
        super::super::types::builders::MessageTagBuilder::default()
    }
}
...
impl MessageTagBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::MessageTag, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::MessageTag {
