...
pub struct DomainDeliverabilityTrackingOption {
    ...
    pub inbox_placement_tracking_option: ::std::option::Option<super::super::types::InboxPlacementTrackingOption>,
}
impl DomainDeliverabilityTrackingOption {
    ...
    /// <p>An object that contains information about the inbox placement data settings for the domain.</p>
    pub fn inbox_placement_tracking_option(&self) -> ::std::option::Option<&super::super::types::InboxPlacementTrackingOption> {
...
impl DomainDeliverabilityTrackingOption {
    ...
    pub fn builder() -> super::super::types::builders::DomainDeliverabilityTrackingOptionBuilder {
        super::super::types::builders::DomainDeliverabilityTrackingOptionBuilder::default()
    }
}
...
pub struct DomainDeliverabilityTrackingOptionBuilder {
    ...
    pub(crate) inbox_placement_tracking_option: ::std::option::Option<super::super::types::InboxPlacementTrackingOption>,
}
impl DomainDeliverabilityTrackingOptionBuilder {
    ...
    /// <p>An object that contains information about the inbox placement data settings for the domain.</p>
    pub fn inbox_placement_tracking_option(mut self, input: super::super::types::InboxPlacementTrackingOption) -> Self {
        self.inbox_placement_tracking_option = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object that contains information about the inbox placement data settings for the domain.</p>
    pub fn set_inbox_placement_tracking_option(mut self, input: ::std::option::Option<super::super::types::InboxPlacementTrackingOption>) -> Self {
        self.inbox_placement_tracking_option = input;
        self
    }
    /// <p>An object that contains information about the inbox placement data settings for the domain.</p>
    pub fn get_inbox_placement_tracking_option(&self) -> &::std::option::Option<super::super::types::InboxPlacementTrackingOption> {
    ...
    pub fn build(self) -> super::super::types::DomainDeliverabilityTrackingOption {
        super::super::types::DomainDeliverabilityTrackingOption {
            domain: self.domain,
