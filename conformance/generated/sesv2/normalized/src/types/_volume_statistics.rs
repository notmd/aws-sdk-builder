...
impl VolumeStatistics {
    ...
    pub fn builder() -> super::super::types::builders::VolumeStatisticsBuilder {
        super::super::types::builders::VolumeStatisticsBuilder::default()
    }
}
...
impl VolumeStatisticsBuilder {
    ...
    pub fn build(self) -> super::super::types::VolumeStatistics {
        super::super::types::VolumeStatistics {
