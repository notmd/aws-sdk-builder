...
impl RawMessage {
    ...
    pub fn builder() -> super::super::types::builders::RawMessageBuilder {
        super::super::types::builders::RawMessageBuilder::default()
    }
}
...
impl RawMessageBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::RawMessage, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::RawMessage {
