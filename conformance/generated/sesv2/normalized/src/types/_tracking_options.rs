...
pub struct TrackingOptions {
    ...
    pub https_policy: ::std::option::Option<super::super::types::HttpsPolicy>,
}
impl TrackingOptions {
    ...
    /// <p>The https policy to use for tracking open and click events.</p>
    pub fn https_policy(&self) -> ::std::option::Option<&super::super::types::HttpsPolicy> {
        self.https_policy.as_ref()
    }
}
impl TrackingOptions {
    /// Creates a new builder-style object to manufacture [`TrackingOptions`](crate::types::TrackingOptions).
    pub fn builder() -> super::super::types::builders::TrackingOptionsBuilder {
        super::super::types::builders::TrackingOptionsBuilder::default()
    }
}
...
pub struct TrackingOptionsBuilder {
    ...
    pub(crate) https_policy: ::std::option::Option<super::super::types::HttpsPolicy>,
}
impl TrackingOptionsBuilder {
    ...
    /// <p>The https policy to use for tracking open and click events.</p>
    pub fn https_policy(mut self, input: super::super::types::HttpsPolicy) -> Self {
        self.https_policy = ::std::option::Option::Some(input);
        self
    }
    /// <p>The https policy to use for tracking open and click events.</p>
    pub fn set_https_policy(mut self, input: ::std::option::Option<super::super::types::HttpsPolicy>) -> Self {
        self.https_policy = input;
        self
    }
    /// <p>The https policy to use for tracking open and click events.</p>
    pub fn get_https_policy(&self) -> &::std::option::Option<super::super::types::HttpsPolicy> {
        &self.https_policy
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::TrackingOptions, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::TrackingOptions {
