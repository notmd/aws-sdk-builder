...
pub struct ImportJobSummary {
    ...
    pub import_destination: ::std::option::Option<super::super::types::ImportDestination>,
    ...
    /// </ul>
    pub job_status: ::std::option::Option<super::super::types::JobStatus>,
...
impl ImportJobSummary {
    ...
    /// <p>An object that contains details about the resource destination the import job is going to target.</p>
    pub fn import_destination(&self) -> ::std::option::Option<&super::super::types::ImportDestination> {
    ...
    /// <p><code>COMPLETED</code> – Job has completed processing successfully.</p></li>
    /// </ul>
    pub fn job_status(&self) -> ::std::option::Option<&super::super::types::JobStatus> {
...
impl ImportJobSummary {
    ...
    pub fn builder() -> super::super::types::builders::ImportJobSummaryBuilder {
        super::super::types::builders::ImportJobSummaryBuilder::default()
    }
}
...
pub struct ImportJobSummaryBuilder {
    ...
    pub(crate) import_destination: ::std::option::Option<super::super::types::ImportDestination>,
    pub(crate) job_status: ::std::option::Option<super::super::types::JobStatus>,
...
impl ImportJobSummaryBuilder {
    ...
    /// <p>An object that contains details about the resource destination the import job is going to target.</p>
    pub fn import_destination(mut self, input: super::super::types::ImportDestination) -> Self {
        self.import_destination = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object that contains details about the resource destination the import job is going to target.</p>
    pub fn set_import_destination(mut self, input: ::std::option::Option<super::super::types::ImportDestination>) -> Self {
        self.import_destination = input;
        self
    }
    /// <p>An object that contains details about the resource destination the import job is going to target.</p>
    pub fn get_import_destination(&self) -> &::std::option::Option<super::super::types::ImportDestination> {
    ...
    /// <p><code>COMPLETED</code> – Job has completed processing successfully.</p></li>
    /// </ul>
    pub fn job_status(mut self, input: super::super::types::JobStatus) -> Self {
    ...
    /// <p><code>COMPLETED</code> – Job has completed processing successfully.</p></li>
    /// </ul>
    pub fn set_job_status(mut self, input: ::std::option::Option<super::super::types::JobStatus>) -> Self {
    ...
    /// <p><code>COMPLETED</code> – Job has completed processing successfully.</p></li>
    /// </ul>
    pub fn get_job_status(&self) -> &::std::option::Option<super::super::types::JobStatus> {
        &self.job_status
    }
    /// <p>The date and time when the import job was created.</p>
    ...
    pub fn build(self) -> super::super::types::ImportJobSummary {
        super::super::types::ImportJobSummary {
            job_id: self.job_id,
