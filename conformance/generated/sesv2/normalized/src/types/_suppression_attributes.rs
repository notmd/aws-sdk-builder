...
pub struct SuppressionAttributes {
    ...
    pub validation_attributes: ::std::option::Option<super::super::types::SuppressionValidationAttributes>,
}
impl SuppressionAttributes {
    ...
    /// <p>Structure containing validation attributes used for suppressing sending to specific destination on account level.</p>
    pub fn validation_attributes(&self) -> ::std::option::Option<&super::super::types::SuppressionValidationAttributes> {
...
impl SuppressionAttributes {
    ...
    pub fn builder() -> super::super::types::builders::SuppressionAttributesBuilder {
        super::super::types::builders::SuppressionAttributesBuilder::default()
    }
}
...
pub struct SuppressionAttributesBuilder {
    ...
    pub(crate) validation_attributes: ::std::option::Option<super::super::types::SuppressionValidationAttributes>,
}
impl SuppressionAttributesBuilder {
    ...
    /// <p>Structure containing validation attributes used for suppressing sending to specific destination on account level.</p>
    pub fn validation_attributes(mut self, input: super::super::types::SuppressionValidationAttributes) -> Self {
        self.validation_attributes = ::std::option::Option::Some(input);
        self
    }
    /// <p>Structure containing validation attributes used for suppressing sending to specific destination on account level.</p>
    pub fn set_validation_attributes(mut self, input: ::std::option::Option<super::super::types::SuppressionValidationAttributes>) -> Self {
        self.validation_attributes = input;
        self
    }
    /// <p>Structure containing validation attributes used for suppressing sending to specific destination on account level.</p>
    pub fn get_validation_attributes(&self) -> &::std::option::Option<super::super::types::SuppressionValidationAttributes> {
        &self.validation_attributes
    }
    /// Consumes the builder and constructs a [`SuppressionAttributes`](crate::types::SuppressionAttributes).
    pub fn build(self) -> super::super::types::SuppressionAttributes {
        super::super::types::SuppressionAttributes {
