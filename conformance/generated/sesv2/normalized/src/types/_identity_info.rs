...
pub struct IdentityInfo {
    ...
    pub identity_type: ::std::option::Option<super::super::types::IdentityType>,
    ...
    /// </ul>
    pub verification_status: ::std::option::Option<super::super::types::VerificationStatus>,
}
impl IdentityInfo {
    /// <p>The email identity type. Note: the <code>MANAGED_DOMAIN</code> type is not supported for email identity types.</p>
    pub fn identity_type(&self) -> ::std::option::Option<&super::super::types::IdentityType> {
    ...
    /// <p><code>NOT_STARTED</code> – The verification process hasn't been initiated for the identity.</p></li>
    /// </ul>
    pub fn verification_status(&self) -> ::std::option::Option<&super::super::types::VerificationStatus> {
        self.verification_status.as_ref()
    }
}
impl IdentityInfo {
    /// Creates a new builder-style object to manufacture [`IdentityInfo`](crate::types::IdentityInfo).
    pub fn builder() -> super::super::types::builders::IdentityInfoBuilder {
        super::super::types::builders::IdentityInfoBuilder::default()
    }
}
...
pub struct IdentityInfoBuilder {
    pub(crate) identity_type: ::std::option::Option<super::super::types::IdentityType>,
    pub(crate) identity_name: ::std::option::Option<::std::string::String>,
    pub(crate) sending_enabled: ::std::option::Option<bool>,
    pub(crate) verification_status: ::std::option::Option<super::super::types::VerificationStatus>,
}
impl IdentityInfoBuilder {
    /// <p>The email identity type. Note: the <code>MANAGED_DOMAIN</code> type is not supported for email identity types.</p>
    pub fn identity_type(mut self, input: super::super::types::IdentityType) -> Self {
        self.identity_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The email identity type. Note: the <code>MANAGED_DOMAIN</code> type is not supported for email identity types.</p>
    pub fn set_identity_type(mut self, input: ::std::option::Option<super::super::types::IdentityType>) -> Self {
        self.identity_type = input;
        self
    }
    /// <p>The email identity type. Note: the <code>MANAGED_DOMAIN</code> type is not supported for email identity types.</p>
    pub fn get_identity_type(&self) -> &::std::option::Option<super::super::types::IdentityType> {
        &self.identity_type
    }
    /// <p>The address or domain of the identity.</p>
    ...
    /// <p><code>NOT_STARTED</code> – The verification process hasn't been initiated for the identity.</p></li>
    /// </ul>
    pub fn verification_status(mut self, input: super::super::types::VerificationStatus) -> Self {
    ...
    /// <p><code>NOT_STARTED</code> – The verification process hasn't been initiated for the identity.</p></li>
    /// </ul>
    pub fn set_verification_status(mut self, input: ::std::option::Option<super::super::types::VerificationStatus>) -> Self {
    ...
    /// <p><code>NOT_STARTED</code> – The verification process hasn't been initiated for the identity.</p></li>
    /// </ul>
    pub fn get_verification_status(&self) -> &::std::option::Option<super::super::types::VerificationStatus> {
        &self.verification_status
    }
    /// Consumes the builder and constructs a [`IdentityInfo`](crate::types::IdentityInfo).
    pub fn build(self) -> super::super::types::IdentityInfo {
        super::super::types::IdentityInfo {
