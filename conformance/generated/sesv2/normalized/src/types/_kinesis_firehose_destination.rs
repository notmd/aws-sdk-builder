...
impl KinesisFirehoseDestination {
    ...
    pub fn builder() -> super::super::types::builders::KinesisFirehoseDestinationBuilder {
        super::super::types::builders::KinesisFirehoseDestinationBuilder::default()
    }
}
...
impl KinesisFirehoseDestinationBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::KinesisFirehoseDestination, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::KinesisFirehoseDestination {
