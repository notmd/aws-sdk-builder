...
impl EmailTemplateContent {
    ...
    pub fn builder() -> super::super::types::builders::EmailTemplateContentBuilder {
        super::super::types::builders::EmailTemplateContentBuilder::default()
    }
}
...
impl EmailTemplateContentBuilder {
    ...
    pub fn build(self) -> super::super::types::EmailTemplateContent {
        super::super::types::EmailTemplateContent {
