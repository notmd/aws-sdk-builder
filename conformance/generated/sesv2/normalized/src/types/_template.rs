...
pub struct Template {
    ...
    /// </note>
    pub template_content: ::std::option::Option<super::super::types::EmailTemplateContent>,
...
impl Template {
    ...
    /// <p>Amazon SES supports only simple substitions when you send email using the <code>SendEmail</code> or <code>SendBulkEmail</code> operations and you provide the full template content in the request.</p>
    /// </note>
    pub fn template_content(&self) -> ::std::option::Option<&super::super::types::EmailTemplateContent> {
...
impl Template {
    ...
    pub fn builder() -> super::super::types::builders::TemplateBuilder {
        super::super::types::builders::TemplateBuilder::default()
    }
}
...
pub struct TemplateBuilder {
    ...
    pub(crate) template_content: ::std::option::Option<super::super::types::EmailTemplateContent>,
...
impl TemplateBuilder {
    ...
    /// <p>Amazon SES supports only simple substitions when you send email using the <code>SendEmail</code> or <code>SendBulkEmail</code> operations and you provide the full template content in the request.</p>
    /// </note>
    pub fn template_content(mut self, input: super::super::types::EmailTemplateContent) -> Self {
    ...
    /// <p>Amazon SES supports only simple substitions when you send email using the <code>SendEmail</code> or <code>SendBulkEmail</code> operations and you provide the full template content in the request.</p>
    /// </note>
    pub fn set_template_content(mut self, input: ::std::option::Option<super::super::types::EmailTemplateContent>) -> Self {
    ...
    /// <p>Amazon SES supports only simple substitions when you send email using the <code>SendEmail</code> or <code>SendBulkEmail</code> operations and you provide the full template content in the request.</p>
    /// </note>
    pub fn get_template_content(&self) -> &::std::option::Option<super::super::types::EmailTemplateContent> {
    ...
    pub fn build(self) -> super::super::types::Template {
        super::super::types::Template {
