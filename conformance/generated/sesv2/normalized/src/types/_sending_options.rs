...
impl SendingOptions {
    ...
    pub fn builder() -> super::super::types::builders::SendingOptionsBuilder {
        super::super::types::builders::SendingOptionsBuilder::default()
    }
}
...
impl SendingOptionsBuilder {
    ...
    pub fn build(self) -> super::super::types::SendingOptions {
        super::super::types::SendingOptions {
