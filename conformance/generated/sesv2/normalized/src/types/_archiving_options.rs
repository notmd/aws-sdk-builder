...
impl ArchivingOptions {
    ...
    pub fn builder() -> super::super::types::builders::ArchivingOptionsBuilder {
        super::super::types::builders::ArchivingOptionsBuilder::default()
    }
}
...
impl ArchivingOptionsBuilder {
    ...
    pub fn build(self) -> super::super::types::ArchivingOptions {
        super::super::types::ArchivingOptions {
