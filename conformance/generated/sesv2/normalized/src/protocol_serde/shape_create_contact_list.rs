...
) -> std::result::Result<super::super::operation::create_contact_list::CreateContactListOutput, super::super::operation::create_contact_list::CreateContactListError>
{
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::create_contact_list::CreateContactListError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AlreadyExistsException" => super::super::operation::create_contact_list::CreateContactListError::AlreadyExistsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "BadRequestException" => super::super::operation::create_contact_list::CreateContactListError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "LimitExceededException" => super::super::operation::create_contact_list::CreateContactListError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::super::operation::create_contact_list::CreateContactListError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn ser_create_contact_list_input(
    ...
    super::super::protocol_serde::shape_create_contact_list_input::ser_create_contact_list_input_input(&mut object, input)?;
    object.finish();
