...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::update_reputation_entity_policy::UpdateReputationEntityPolicyError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "BadRequestException" => super::super::operation::update_reputation_entity_policy::UpdateReputationEntityPolicyError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ConflictException" => super::super::operation::update_reputation_entity_policy::UpdateReputationEntityPolicyError::ConflictException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => {
            super::super::operation::update_reputation_entity_policy::UpdateReputationEntityPolicyError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::update_reputation_entity_policy::builders::UpdateReputationEntityPolicyOutputBuilder::default();
...
pub fn ser_update_reputation_entity_policy_input(
    ...
    super::super::protocol_serde::shape_update_reputation_entity_policy_input::ser_update_reputation_entity_policy_input_input(&mut object, input)?;
    object.finish();
