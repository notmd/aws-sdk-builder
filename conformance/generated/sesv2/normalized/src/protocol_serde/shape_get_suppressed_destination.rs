...
> {
    ...
    Err(match error_code {
        "BadRequestException" => super::super::operation::get_suppressed_destination::GetSuppressedDestinationError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::super::operation::get_suppressed_destination::GetSuppressedDestinationError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::super::operation::get_suppressed_destination::GetSuppressedDestinationError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::get_suppressed_destination::builders::GetSuppressedDestinationOutputBuilder::default();
        output = super::super::protocol_serde::shape_get_suppressed_destination::de_get_suppressed_destination(_response_body, output)
            .map_err(super::super::operation::get_suppressed_destination::GetSuppressedDestinationError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::super::serde_util::get_suppressed_destination_output_output_correct_errors(output).build()
    })
}
...
pub(crate) fn de_get_suppressed_destination(
    ...
    super::super::operation::get_suppressed_destination::builders::GetSuppressedDestinationOutputBuilder,
