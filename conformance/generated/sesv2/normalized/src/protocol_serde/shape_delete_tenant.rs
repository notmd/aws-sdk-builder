...
pub fn de_delete_tenant_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::delete_tenant::DeleteTenantOutput, super::super::operation::delete_tenant::DeleteTenantError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::delete_tenant::DeleteTenantError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "BadRequestException" => super::super::operation::delete_tenant::DeleteTenantError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::super::operation::delete_tenant::DeleteTenantError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::super::operation::delete_tenant::DeleteTenantError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_delete_tenant_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::delete_tenant::builders::DeleteTenantOutputBuilder::default();
...
pub fn ser_delete_tenant_input(
    ...
    super::super::protocol_serde::shape_delete_tenant_input::ser_delete_tenant_input_input(&mut object, input)?;
    object.finish();
