...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::put_dedicated_ip_warmup_attributes::PutDedicatedIpWarmupAttributesError::unhandled(generic)),
    };
    ...
    Err(match error_code {
        ...
        "TooManyRequestsException" => {
            super::super::operation::put_dedicated_ip_warmup_attributes::PutDedicatedIpWarmupAttributesError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
