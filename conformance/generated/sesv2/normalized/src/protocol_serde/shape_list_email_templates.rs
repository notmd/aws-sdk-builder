...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::list_email_templates::ListEmailTemplatesError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "BadRequestException" => super::super::operation::list_email_templates::ListEmailTemplatesError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::super::operation::list_email_templates::ListEmailTemplatesError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_email_templates::builders::ListEmailTemplatesOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_email_templates::de_list_email_templates(_response_body, output)
            .map_err(super::super::operation::list_email_templates::ListEmailTemplatesError::unhandled)?;
...
pub(crate) fn de_list_email_templates(
    ...
    super::super::operation::list_email_templates::builders::ListEmailTemplatesOutputBuilder,
