...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::put_account_sending_attributes::PutAccountSendingAttributesError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "BadRequestException" => super::super::operation::put_account_sending_attributes::PutAccountSendingAttributesError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::put_account_sending_attributes::builders::PutAccountSendingAttributesOutputBuilder::default();
...
pub fn ser_put_account_sending_attributes_input(
    ...
    super::super::protocol_serde::shape_put_account_sending_attributes_input::ser_put_account_sending_attributes_input_input(&mut object, input)?;
    object.finish();
