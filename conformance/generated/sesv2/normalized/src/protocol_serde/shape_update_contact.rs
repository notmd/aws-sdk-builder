...
pub fn de_update_contact_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::update_contact::UpdateContactOutput, super::super::operation::update_contact::UpdateContactError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::update_contact::UpdateContactError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "BadRequestException" => super::super::operation::update_contact::UpdateContactError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ConcurrentModificationException" => super::super::operation::update_contact::UpdateContactError::ConcurrentModificationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::super::operation::update_contact::UpdateContactError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::super::operation::update_contact::UpdateContactError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_update_contact_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::update_contact::builders::UpdateContactOutputBuilder::default();
...
pub fn ser_update_contact_input(
    ...
    super::super::protocol_serde::shape_update_contact_input::ser_update_contact_input_input(&mut object, input)?;
    object.finish();
