...
> {
    ...
    Err(match error_code {
        "BadRequestException" => super::super::operation::list_multi_region_endpoints::ListMultiRegionEndpointsError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_multi_region_endpoints::builders::ListMultiRegionEndpointsOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_multi_region_endpoints::de_list_multi_region_endpoints(_response_body, output)
            .map_err(super::super::operation::list_multi_region_endpoints::ListMultiRegionEndpointsError::unhandled)?;
...
pub(crate) fn de_list_multi_region_endpoints(
    ...
    super::super::operation::list_multi_region_endpoints::builders::ListMultiRegionEndpointsOutputBuilder,
