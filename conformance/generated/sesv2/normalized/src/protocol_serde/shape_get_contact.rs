...
pub fn de_get_contact_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::get_contact::GetContactOutput, super::super::operation::get_contact::GetContactError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::get_contact::GetContactError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "BadRequestException" => super::super::operation::get_contact::GetContactError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::super::operation::get_contact::GetContactError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::super::operation::get_contact::GetContactError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_get_contact_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::get_contact::builders::GetContactOutputBuilder::default();
        output = super::super::protocol_serde::shape_get_contact::de_get_contact(_response_body, output)
            .map_err(super::super::operation::get_contact::GetContactError::unhandled)?;
