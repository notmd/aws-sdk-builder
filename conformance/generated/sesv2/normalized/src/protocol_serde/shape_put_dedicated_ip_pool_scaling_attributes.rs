...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output =
            super::super::operation::put_dedicated_ip_pool_scaling_attributes::builders::PutDedicatedIpPoolScalingAttributesOutputBuilder::default();
...
pub fn ser_put_dedicated_ip_pool_scaling_attributes_input(
    ...
    super::super::protocol_serde::shape_put_dedicated_ip_pool_scaling_attributes_input::ser_put_dedicated_ip_pool_scaling_attributes_input_input(
        &mut object,
        input,
    )?;
    object.finish();
