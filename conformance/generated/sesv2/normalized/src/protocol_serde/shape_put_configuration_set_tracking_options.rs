...
> {
    ...
    Err(match error_code {
        "BadRequestException" => {
            super::super::operation::put_configuration_set_tracking_options::PutConfigurationSetTrackingOptionsError::BadRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NotFoundException" => {
            super::super::operation::put_configuration_set_tracking_options::PutConfigurationSetTrackingOptionsError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => {
            super::super::operation::put_configuration_set_tracking_options::PutConfigurationSetTrackingOptionsError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output =
            super::super::operation::put_configuration_set_tracking_options::builders::PutConfigurationSetTrackingOptionsOutputBuilder::default();
...
pub fn ser_put_configuration_set_tracking_options_input(
    ...
    super::super::protocol_serde::shape_put_configuration_set_tracking_options_input::ser_put_configuration_set_tracking_options_input_input(
        &mut object,
        input,
    )?;
    object.finish();
