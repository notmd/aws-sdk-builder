...
> {
    ...
    Err(match error_code {
        "BadRequestException" => {
            super::super::operation::get_configuration_set_event_destinations::GetConfigurationSetEventDestinationsError::BadRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NotFoundException" => {
            super::super::operation::get_configuration_set_event_destinations::GetConfigurationSetEventDestinationsError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => {
            super::super::operation::get_configuration_set_event_destinations::GetConfigurationSetEventDestinationsError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output =
            super::super::operation::get_configuration_set_event_destinations::builders::GetConfigurationSetEventDestinationsOutputBuilder::default();
        output = super::super::protocol_serde::shape_get_configuration_set_event_destinations::de_get_configuration_set_event_destinations(
            _response_body,
            output,
        )
        .map_err(super::super::operation::get_configuration_set_event_destinations::GetConfigurationSetEventDestinationsError::unhandled)?;
...
pub(crate) fn de_get_configuration_set_event_destinations(
    ...
    super::super::operation::get_configuration_set_event_destinations::builders::GetConfigurationSetEventDestinationsOutputBuilder,
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "EventDestinations" => {
                    builder = builder.set_event_destinations(super::super::protocol_serde::shape_event_destinations::de_event_destinations(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
