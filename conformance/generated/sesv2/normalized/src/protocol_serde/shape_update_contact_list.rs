...
) -> std::result::Result<super::super::operation::update_contact_list::UpdateContactListOutput, super::super::operation::update_contact_list::UpdateContactListError>
{
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::update_contact_list::UpdateContactListError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "BadRequestException" => super::super::operation::update_contact_list::UpdateContactListError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ConcurrentModificationException" => super::super::operation::update_contact_list::UpdateContactListError::ConcurrentModificationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::super::operation::update_contact_list::UpdateContactListError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::super::operation::update_contact_list::UpdateContactListError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn ser_update_contact_list_input(
    ...
    super::super::protocol_serde::shape_update_contact_list_input::ser_update_contact_list_input_input(&mut object, input)?;
    object.finish();
