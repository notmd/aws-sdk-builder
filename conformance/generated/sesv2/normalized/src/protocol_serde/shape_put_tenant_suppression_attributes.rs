...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::put_tenant_suppression_attributes::PutTenantSuppressionAttributesError::unhandled(generic)),
    };
    ...
    Err(match error_code {
        ...
        "TooManyRequestsException" => {
            super::super::operation::put_tenant_suppression_attributes::PutTenantSuppressionAttributesError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::put_tenant_suppression_attributes::builders::PutTenantSuppressionAttributesOutputBuilder::default();
