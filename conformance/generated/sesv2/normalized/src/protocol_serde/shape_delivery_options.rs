...
pub fn ser_delivery_options(
    ...
    input: &super::super::types::DeliveryOptions,
...
pub(crate) fn de_delivery_options<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::super::types::DeliveryOptions>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::super::types::builders::DeliveryOptionsBuilder::default();
            loop {
                match tokens.next().transpose()? {
                        ...
                        "TlsPolicy" => {
                            builder = builder.set_tls_policy(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| super::super::types::TlsPolicy::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "SendingPoolName" => {
