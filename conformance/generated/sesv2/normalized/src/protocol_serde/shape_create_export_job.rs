...
pub fn de_create_export_job_http_error(
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::create_export_job::CreateExportJobError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "BadRequestException" => super::super::operation::create_export_job::CreateExportJobError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "LimitExceededException" => super::super::operation::create_export_job::CreateExportJobError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::super::operation::create_export_job::CreateExportJobError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::super::operation::create_export_job::CreateExportJobError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_create_export_job_http_response(
    ...
    Ok({
        ...
        output = super::super::protocol_serde::shape_create_export_job::de_create_export_job(_response_body, output)
            .map_err(super::super::operation::create_export_job::CreateExportJobError::unhandled)?;
...
pub fn ser_create_export_job_input(
    ...
    super::super::protocol_serde::shape_create_export_job_input::ser_create_export_job_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_create_export_job(
    _value: &[u8],
    mut builder: super::super::operation::create_export_job::builders::CreateExportJobOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::create_export_job::builders::CreateExportJobOutputBuilder,
