...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::update_reputation_entity_customer_managed_status::builders::UpdateReputationEntityCustomerManagedStatusOutputBuilder::default();
...
pub fn ser_update_reputation_entity_customer_managed_status_input(
    ...
    super::super::protocol_serde::shape_update_reputation_entity_customer_managed_status_input::ser_update_reputation_entity_customer_managed_status_input_input(&mut object, input)?;
    object.finish();
