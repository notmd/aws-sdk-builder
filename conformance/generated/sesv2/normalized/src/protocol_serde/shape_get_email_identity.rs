...
pub fn de_get_email_identity_http_error(
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::get_email_identity::GetEmailIdentityError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "BadRequestException" => super::super::operation::get_email_identity::GetEmailIdentityError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::super::operation::get_email_identity::GetEmailIdentityError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::super::operation::get_email_identity::GetEmailIdentityError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_get_email_identity_http_response(
    ...
    Ok({
        ...
        output = super::super::protocol_serde::shape_get_email_identity::de_get_email_identity(_response_body, output)
            .map_err(super::super::operation::get_email_identity::GetEmailIdentityError::unhandled)?;
...
pub(crate) fn de_get_email_identity(
    ...
    super::super::operation::get_email_identity::builders::GetEmailIdentityOutputBuilder,
