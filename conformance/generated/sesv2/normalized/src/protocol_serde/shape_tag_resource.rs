...
pub fn de_tag_resource_http_error(
    ...
    Err(match error_code {
        "BadRequestException" => super::super::operation::tag_resource::TagResourceError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ConcurrentModificationException" => super::super::operation::tag_resource::TagResourceError::ConcurrentModificationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
