...
) -> std::result::Result<super::super::operation::send_bulk_email::SendBulkEmailOutput, super::super::operation::send_bulk_email::SendBulkEmailError>
{
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::send_bulk_email::SendBulkEmailError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccountSuspendedException" => super::super::operation::send_bulk_email::SendBulkEmailError::AccountSuspendedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "BadRequestException" => super::super::operation::send_bulk_email::SendBulkEmailError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "LimitExceededException" => super::super::operation::send_bulk_email::SendBulkEmailError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::super::operation::send_bulk_email::SendBulkEmailError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "SendingPausedException" => super::super::operation::send_bulk_email::SendBulkEmailError::SendingPausedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::super::operation::send_bulk_email::SendBulkEmailError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
) -> std::result::Result<super::super::operation::send_bulk_email::SendBulkEmailOutput, super::super::operation::send_bulk_email::SendBulkEmailError>
{
    Ok({
        ...
        output = super::super::protocol_serde::shape_send_bulk_email::de_send_bulk_email(_response_body, output)
            .map_err(super::super::operation::send_bulk_email::SendBulkEmailError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::super::serde_util::send_bulk_email_output_output_correct_errors(output)
            .build()
            .map_err(super::super::operation::send_bulk_email::SendBulkEmailError::unhandled)?
    })
}
...
pub fn ser_send_bulk_email_input(
    ...
    super::super::protocol_serde::shape_send_bulk_email_input::ser_send_bulk_email_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_send_bulk_email(
    _value: &[u8],
    mut builder: super::super::operation::send_bulk_email::builders::SendBulkEmailOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::send_bulk_email::builders::SendBulkEmailOutputBuilder,
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "BulkEmailEntryResults" => {
                    builder = builder.set_bulk_email_entry_results(
                        super::super::protocol_serde::shape_bulk_email_entry_result_list::de_bulk_email_entry_result_list(tokens, _value, depth + 1)?,
                    );
                }
