...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::put_email_identity_configuration_set_attributes::builders::PutEmailIdentityConfigurationSetAttributesOutputBuilder::default();
...
pub fn ser_put_email_identity_configuration_set_attributes_input(
    ...
    super::super::protocol_serde::shape_put_email_identity_configuration_set_attributes_input::ser_put_email_identity_configuration_set_attributes_input_input(&mut object, input)?;
    object.finish();
