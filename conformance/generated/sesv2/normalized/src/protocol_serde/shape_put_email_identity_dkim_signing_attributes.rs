...
> {
    ...
    let mut generic_builder = super::super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::super::operation::put_email_identity_dkim_signing_attributes::PutEmailIdentityDkimSigningAttributesError::unhandled)?;
    ...
    Err(match error_code {
        "BadRequestException" => {
            super::super::operation::put_email_identity_dkim_signing_attributes::PutEmailIdentityDkimSigningAttributesError::BadRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NotFoundException" => {
            super::super::operation::put_email_identity_dkim_signing_attributes::PutEmailIdentityDkimSigningAttributesError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
pub fn ser_put_email_identity_dkim_signing_attributes_input(
    ...
    super::super::protocol_serde::shape_put_email_identity_dkim_signing_attributes_input::ser_put_email_identity_dkim_signing_attributes_input_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub(crate) fn de_put_email_identity_dkim_signing_attributes(
    _value: &[u8],
    mut builder: super::super::operation::put_email_identity_dkim_signing_attributes::builders::PutEmailIdentityDkimSigningAttributesOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::put_email_identity_dkim_signing_attributes::builders::PutEmailIdentityDkimSigningAttributesOutputBuilder,
                ...
                "DkimStatus" => {
                    builder = builder.set_dkim_status(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| super::super::types::DkimStatus::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "DkimTokens" => {
