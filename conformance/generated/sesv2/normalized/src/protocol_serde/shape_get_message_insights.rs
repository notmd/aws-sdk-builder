...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::get_message_insights::GetMessageInsightsError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "BadRequestException" => super::super::operation::get_message_insights::GetMessageInsightsError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::super::operation::get_message_insights::GetMessageInsightsError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::super::operation::get_message_insights::GetMessageInsightsError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::get_message_insights::builders::GetMessageInsightsOutputBuilder::default();
        output = super::super::protocol_serde::shape_get_message_insights::de_get_message_insights(_response_body, output)
            .map_err(super::super::operation::get_message_insights::GetMessageInsightsError::unhandled)?;
...
pub(crate) fn de_get_message_insights(
    ...
    super::super::operation::get_message_insights::builders::GetMessageInsightsOutputBuilder,
