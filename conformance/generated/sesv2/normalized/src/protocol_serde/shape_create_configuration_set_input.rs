...
pub fn ser_create_configuration_set_input_input(
    ...
    if let Some(var_4) = &input.delivery_options {
        ...
        super::super::protocol_serde::shape_delivery_options::ser_delivery_options(&mut object_5, var_4)?;
        object_5.finish();
    }
    if let Some(var_6) = &input.reputation_options {
        #[allow(unused_mut)]
        let mut object_7 = object.key("ReputationOptions").start_object();
        super::super::protocol_serde::shape_reputation_options::ser_reputation_options(&mut object_7, var_6)?;
        object_7.finish();
    }
