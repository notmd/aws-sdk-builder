...
pub fn de_untag_resource_http_error(
    ...
    Err(match error_code {
        "BadRequestException" => super::super::operation::untag_resource::UntagResourceError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ConcurrentModificationException" => super::super::operation::untag_resource::UntagResourceError::ConcurrentModificationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
