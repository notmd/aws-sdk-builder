...
> {
    ...
    Err(match error_code {
        "BadRequestException" => super::super::operation::get_blacklist_reports::GetBlacklistReportsError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::super::operation::get_blacklist_reports::GetBlacklistReportsError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::super::operation::get_blacklist_reports::GetBlacklistReportsError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::get_blacklist_reports::builders::GetBlacklistReportsOutputBuilder::default();
        output = super::super::protocol_serde::shape_get_blacklist_reports::de_get_blacklist_reports(_response_body, output)
            .map_err(super::super::operation::get_blacklist_reports::GetBlacklistReportsError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::super::serde_util::get_blacklist_reports_output_output_correct_errors(output)
            .build()
            .map_err(super::super::operation::get_blacklist_reports::GetBlacklistReportsError::unhandled)?
    })
}
...
pub(crate) fn de_get_blacklist_reports(
    ...
    super::super::operation::get_blacklist_reports::builders::GetBlacklistReportsOutputBuilder,
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "BlacklistReport" => {
                    builder = builder.set_blacklist_report(super::super::protocol_serde::shape_blacklist_report::de_blacklist_report(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
