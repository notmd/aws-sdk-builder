...
pub fn de_get_account_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::get_account::GetAccountOutput, super::super::operation::get_account::GetAccountError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::get_account::GetAccountError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "BadRequestException" => super::super::operation::get_account::GetAccountError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::super::operation::get_account::GetAccountError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_get_account_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::get_account::builders::GetAccountOutputBuilder::default();
        output = super::super::protocol_serde::shape_get_account::de_get_account(_response_body, output)
            .map_err(super::super::operation::get_account::GetAccountError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "SendQuota" => {
                    builder = builder.set_send_quota(super::super::protocol_serde::shape_send_quota::de_send_quota(tokens, _value, depth + 1)?);
                }
                "SendingEnabled" => {
