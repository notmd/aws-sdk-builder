...
> {
    ...
    Err(match error_code {
        "AlreadyExistsException" => super::super::operation::create_email_identity::CreateEmailIdentityError::AlreadyExistsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "BadRequestException" => super::super::operation::create_email_identity::CreateEmailIdentityError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::super::operation::create_email_identity::CreateEmailIdentityError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::super::operation::create_email_identity::CreateEmailIdentityError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::create_email_identity::builders::CreateEmailIdentityOutputBuilder::default();
        output = super::super::protocol_serde::shape_create_email_identity::de_create_email_identity(_response_body, output)
            .map_err(super::super::operation::create_email_identity::CreateEmailIdentityError::unhandled)?;
...
pub fn ser_create_email_identity_input(
    ...
    super::super::protocol_serde::shape_create_email_identity_input::ser_create_email_identity_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_create_email_identity(
    _value: &[u8],
    mut builder: super::super::operation::create_email_identity::builders::CreateEmailIdentityOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::create_email_identity::builders::CreateEmailIdentityOutputBuilder,
