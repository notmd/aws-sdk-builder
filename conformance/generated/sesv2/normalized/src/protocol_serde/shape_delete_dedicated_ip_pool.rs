...
> {
    ...
    Err(match error_code {
        "BadRequestException" => super::super::operation::delete_dedicated_ip_pool::DeleteDedicatedIpPoolError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ConcurrentModificationException" => {
            super::super::operation::delete_dedicated_ip_pool::DeleteDedicatedIpPoolError::ConcurrentModificationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NotFoundException" => super::super::operation::delete_dedicated_ip_pool::DeleteDedicatedIpPoolError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::super::operation::delete_dedicated_ip_pool::DeleteDedicatedIpPoolError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::delete_dedicated_ip_pool::builders::DeleteDedicatedIpPoolOutputBuilder::default();
