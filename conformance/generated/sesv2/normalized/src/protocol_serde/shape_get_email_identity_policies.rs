...
> {
    ...
    Err(match error_code {
        "BadRequestException" => super::super::operation::get_email_identity_policies::GetEmailIdentityPoliciesError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::super::operation::get_email_identity_policies::GetEmailIdentityPoliciesError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::get_email_identity_policies::builders::GetEmailIdentityPoliciesOutputBuilder::default();
        output = super::super::protocol_serde::shape_get_email_identity_policies::de_get_email_identity_policies(_response_body, output)
            .map_err(super::super::operation::get_email_identity_policies::GetEmailIdentityPoliciesError::unhandled)?;
...
pub(crate) fn de_get_email_identity_policies(
    ...
    super::super::operation::get_email_identity_policies::builders::GetEmailIdentityPoliciesOutputBuilder,
