...
> {
    ...
    Err(match error_code {
        "BadRequestException" => {
            super::super::operation::list_domain_deliverability_campaigns::ListDomainDeliverabilityCampaignsError::BadRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
pub(crate) fn de_list_domain_deliverability_campaigns(
    ...
    super::super::operation::list_domain_deliverability_campaigns::builders::ListDomainDeliverabilityCampaignsOutputBuilder,
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "DomainDeliverabilityCampaigns" => {
                    builder = builder.set_domain_deliverability_campaigns(
                        super::super::protocol_serde::shape_domain_deliverability_campaign_list::de_domain_deliverability_campaign_list(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
