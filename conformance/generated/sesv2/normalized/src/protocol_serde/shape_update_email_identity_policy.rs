...
> {
    ...
    Err(match error_code {
        "BadRequestException" => super::super::operation::update_email_identity_policy::UpdateEmailIdentityPolicyError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::super::operation::update_email_identity_policy::UpdateEmailIdentityPolicyError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::update_email_identity_policy::builders::UpdateEmailIdentityPolicyOutputBuilder::default();
...
pub fn ser_update_email_identity_policy_input(
    ...
    super::super::protocol_serde::shape_update_email_identity_policy_input::ser_update_email_identity_policy_input_input(&mut object, input)?;
    object.finish();
