...
> {
    ...
    let mut generic_builder = super::super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::super::operation::update_configuration_set_event_destination::UpdateConfigurationSetEventDestinationError::unhandled)?;
    ...
    Err(match error_code {
        "BadRequestException" => {
            super::super::operation::update_configuration_set_event_destination::UpdateConfigurationSetEventDestinationError::BadRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NotFoundException" => {
            super::super::operation::update_configuration_set_event_destination::UpdateConfigurationSetEventDestinationError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
pub fn ser_update_configuration_set_event_destination_input(
    ...
    super::super::protocol_serde::shape_update_configuration_set_event_destination_input::ser_update_configuration_set_event_destination_input_input(
        &mut object,
        input,
    )?;
    object.finish();
