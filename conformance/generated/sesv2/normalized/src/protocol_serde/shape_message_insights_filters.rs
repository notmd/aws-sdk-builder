...
pub fn ser_message_insights_filters(
    ...
    input: &super::super::types::MessageInsightsFilters,
...
pub(crate) fn de_message_insights_filters<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::super::types::MessageInsightsFilters>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::super::types::builders::MessageInsightsFiltersBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "LastDeliveryEvent" => {
                            builder = builder.set_last_delivery_event(
                                super::super::protocol_serde::shape_last_delivery_event_list::de_last_delivery_event_list(tokens, _value, depth + 1)?,
                            );
                        }
                        "LastEngagementEvent" => {
