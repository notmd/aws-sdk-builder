...
> {
    ...
    Err(match error_code {
        "BadRequestException" => super::super::operation::list_configuration_sets::ListConfigurationSetsError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::super::operation::list_configuration_sets::ListConfigurationSetsError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_configuration_sets::builders::ListConfigurationSetsOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_configuration_sets::de_list_configuration_sets(_response_body, output)
            .map_err(super::super::operation::list_configuration_sets::ListConfigurationSetsError::unhandled)?;
...
pub(crate) fn de_list_configuration_sets(
    ...
    super::super::operation::list_configuration_sets::builders::ListConfigurationSetsOutputBuilder,
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ConfigurationSets" => {
                    builder = builder.set_configuration_sets(
                        super::super::protocol_serde::shape_configuration_set_name_list::de_configuration_set_name_list(tokens, _value, depth + 1)?,
                    );
                }
                "NextToken" => {
