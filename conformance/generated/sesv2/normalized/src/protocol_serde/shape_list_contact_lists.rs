...
pub fn de_list_contact_lists_http_error(
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::list_contact_lists::ListContactListsError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "BadRequestException" => super::super::operation::list_contact_lists::ListContactListsError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => super::super::operation::list_contact_lists::ListContactListsError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_list_contact_lists_http_response(
    ...
    Ok({
        ...
        output = super::super::protocol_serde::shape_list_contact_lists::de_list_contact_lists(_response_body, output)
            .map_err(super::super::operation::list_contact_lists::ListContactListsError::unhandled)?;
...
pub(crate) fn de_list_contact_lists(
    ...
    super::super::operation::list_contact_lists::builders::ListContactListsOutputBuilder,
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ContactLists" => {
                    builder = builder.set_contact_lists(super::super::protocol_serde::shape_list_of_contact_lists::de_list_of_contact_lists(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
