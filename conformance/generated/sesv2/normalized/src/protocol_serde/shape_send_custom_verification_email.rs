...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::send_custom_verification_email::SendCustomVerificationEmailError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "BadRequestException" => super::super::operation::send_custom_verification_email::SendCustomVerificationEmailError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "MessageRejected" => super::super::operation::send_custom_verification_email::SendCustomVerificationEmailError::MessageRejected({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::super::operation::send_custom_verification_email::SendCustomVerificationEmailError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::send_custom_verification_email::builders::SendCustomVerificationEmailOutputBuilder::default();
        output = super::super::protocol_serde::shape_send_custom_verification_email::de_send_custom_verification_email(_response_body, output)
            .map_err(super::super::operation::send_custom_verification_email::SendCustomVerificationEmailError::unhandled)?;
...
pub fn ser_send_custom_verification_email_input(
    ...
    super::super::protocol_serde::shape_send_custom_verification_email_input::ser_send_custom_verification_email_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_send_custom_verification_email(
    _value: &[u8],
    mut builder: super::super::operation::send_custom_verification_email::builders::SendCustomVerificationEmailOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::send_custom_verification_email::builders::SendCustomVerificationEmailOutputBuilder,
