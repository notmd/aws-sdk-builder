...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::list_deliverability_test_reports::ListDeliverabilityTestReportsError::unhandled(generic)),
    };
    ...
    Err(match error_code {
        ...
        "TooManyRequestsException" => {
            super::super::operation::list_deliverability_test_reports::ListDeliverabilityTestReportsError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_deliverability_test_reports::builders::ListDeliverabilityTestReportsOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_deliverability_test_reports::de_list_deliverability_test_reports(_response_body, output)
            .map_err(super::super::operation::list_deliverability_test_reports::ListDeliverabilityTestReportsError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::super::serde_util::list_deliverability_test_reports_output_output_correct_errors(output)
            .build()
            .map_err(super::super::operation::list_deliverability_test_reports::ListDeliverabilityTestReportsError::unhandled)?
    })
}
...
pub(crate) fn de_list_deliverability_test_reports(
    ...
    super::super::operation::list_deliverability_test_reports::builders::ListDeliverabilityTestReportsOutputBuilder,
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "DeliverabilityTestReports" => {
                    builder = builder.set_deliverability_test_reports(
                        super::super::protocol_serde::shape_deliverability_test_reports::de_deliverability_test_reports(tokens, _value, depth + 1)?,
                    );
                }
                "NextToken" => {
