...
> {
    ...
    Err(match error_code {
        "BadRequestException" => super::super::operation::delete_multi_region_endpoint::DeleteMultiRegionEndpointError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ConcurrentModificationException" => {
            super::super::operation::delete_multi_region_endpoint::DeleteMultiRegionEndpointError::ConcurrentModificationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NotFoundException" => super::super::operation::delete_multi_region_endpoint::DeleteMultiRegionEndpointError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::delete_multi_region_endpoint::builders::DeleteMultiRegionEndpointOutputBuilder::default();
        output = super::super::protocol_serde::shape_delete_multi_region_endpoint::de_delete_multi_region_endpoint(_response_body, output)
            .map_err(super::super::operation::delete_multi_region_endpoint::DeleteMultiRegionEndpointError::unhandled)?;
...
pub(crate) fn de_delete_multi_region_endpoint(
    ...
    super::super::operation::delete_multi_region_endpoint::builders::DeleteMultiRegionEndpointOutputBuilder,
