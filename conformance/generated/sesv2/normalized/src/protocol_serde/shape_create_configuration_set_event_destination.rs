...
> {
    ...
    let mut generic_builder = super::super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::super::operation::create_configuration_set_event_destination::CreateConfigurationSetEventDestinationError::unhandled)?;
...
pub fn ser_create_configuration_set_event_destination_input(
    ...
    super::super::protocol_serde::shape_create_configuration_set_event_destination_input::ser_create_configuration_set_event_destination_input_input(
        &mut object,
        input,
    )?;
    object.finish();
