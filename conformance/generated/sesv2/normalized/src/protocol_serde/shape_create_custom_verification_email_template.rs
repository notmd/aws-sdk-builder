...
> {
    ...
    let mut generic_builder = super::super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::super::operation::create_custom_verification_email_template::CreateCustomVerificationEmailTemplateError::unhandled)?;
    ...
    Err(match error_code {
        "AlreadyExistsException" => {
            super::super::operation::create_custom_verification_email_template::CreateCustomVerificationEmailTemplateError::AlreadyExistsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "BadRequestException" => {
            super::super::operation::create_custom_verification_email_template::CreateCustomVerificationEmailTemplateError::BadRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "LimitExceededException" => {
            super::super::operation::create_custom_verification_email_template::CreateCustomVerificationEmailTemplateError::LimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NotFoundException" => {
            super::super::operation::create_custom_verification_email_template::CreateCustomVerificationEmailTemplateError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
pub fn ser_create_custom_verification_email_template_input(
    ...
    super::super::protocol_serde::shape_create_custom_verification_email_template_input::ser_create_custom_verification_email_template_input_input(
        &mut object,
        input,
    )?;
    object.finish();
