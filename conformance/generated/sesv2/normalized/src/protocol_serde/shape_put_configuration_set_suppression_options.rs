...
> {
    ...
    let mut generic_builder = super::super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::super::operation::put_configuration_set_suppression_options::PutConfigurationSetSuppressionOptionsError::unhandled)?;
    ...
    Err(match error_code {
        "BadRequestException" => {
            super::super::operation::put_configuration_set_suppression_options::PutConfigurationSetSuppressionOptionsError::BadRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NotFoundException" => {
            super::super::operation::put_configuration_set_suppression_options::PutConfigurationSetSuppressionOptionsError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
pub fn ser_put_configuration_set_suppression_options_input(
    ...
    super::super::protocol_serde::shape_put_configuration_set_suppression_options_input::ser_put_configuration_set_suppression_options_input_input(
        &mut object,
        input,
    )?;
    object.finish();
