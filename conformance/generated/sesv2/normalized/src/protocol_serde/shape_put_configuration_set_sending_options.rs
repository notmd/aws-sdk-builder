...
> {
    ...
    Err(match error_code {
        "BadRequestException" => {
            super::super::operation::put_configuration_set_sending_options::PutConfigurationSetSendingOptionsError::BadRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
pub fn ser_put_configuration_set_sending_options_input(
    ...
    super::super::protocol_serde::shape_put_configuration_set_sending_options_input::ser_put_configuration_set_sending_options_input_input(
        &mut object,
        input,
    )?;
    object.finish();
