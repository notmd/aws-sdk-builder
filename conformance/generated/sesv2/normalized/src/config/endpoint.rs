            ...
            match current_ref {
                ...
                ref_val => {
                    ...
                    let condition_result = match node.condition_index {
                        0 => region.is_some(),
                        1 => (|_diagnostic_collector: &mut super::super::endpoint_lib::diagnostic::DiagnosticCollector| -> bool {
                        ...
                        3 => (|_diagnostic_collector: &mut super::super::endpoint_lib::diagnostic::DiagnosticCollector| -> bool {
                            ...
                            super::super::endpoint_lib::host::is_valid_host_label(
                                if let Some(param) = endpoint_id { param } else { return false },
                                true,
...
const NODES: [super::super::endpoint_lib::bdd_interpreter::BddNode; 23] = [
