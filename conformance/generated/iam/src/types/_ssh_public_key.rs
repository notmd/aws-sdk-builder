...
impl SshPublicKeyBuilder {
    ...
    pub fn set_fingerprint(mut self, input: ::std::option::Option<::std::string::String>) -> Self { self.fingerprint = input; self }
    /// <p>The MD5 message digest of the SSH public key.</p>
    pub fn get_fingerprint(&self) -> &::std::option::Option<::std::string::String> { &self.fingerprint }
    /// <p>The SSH public key.</p>
    /// This field is required.
    ...
    pub fn set_ssh_public_key_body(mut self, input: ::std::option::Option<::std::string::String>) -> Self { self.ssh_public_key_body = input; self }
    /// <p>The SSH public key.</p>
    pub fn get_ssh_public_key_body(&self) -> &::std::option::Option<::std::string::String> { &self.ssh_public_key_body }
    /// <p>The status of the SSH public key. <code>Active</code> means that the key can be used for authentication with an CodeCommit repository. <code>Inactive</code> means that the key cannot be used.</p>
    /// This field is required.
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::SshPublicKey, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::SshPublicKey {
            user_name: self.user_name.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("user_name", "user_name was not specified but it is required when building SshPublicKey"))?,
            ssh_public_key_id: self.ssh_public_key_id.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("ssh_public_key_id", "ssh_public_key_id was not specified but it is required when building SshPublicKey"))?,
            fingerprint: self.fingerprint.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("fingerprint", "fingerprint was not specified but it is required when building SshPublicKey"))?,
            ssh_public_key_body: self.ssh_public_key_body.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("ssh_public_key_body", "ssh_public_key_body was not specified but it is required when building SshPublicKey"))?,
            status: self.status.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("status", "status was not specified but it is required when building SshPublicKey"))?,
