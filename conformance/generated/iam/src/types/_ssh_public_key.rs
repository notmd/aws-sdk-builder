...
impl SshPublicKey {
    ...
    pub fn builder() -> super::types::builders::SshPublicKeyBuilder {
        super::types::builders::SshPublicKeyBuilder::default()
    }
}
...
impl SshPublicKeyBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::SshPublicKey, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::SshPublicKey {
