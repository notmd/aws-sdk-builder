...
impl PolicyRole {
    ...
    pub fn builder() -> super::types::builders::PolicyRoleBuilder {
        super::types::builders::PolicyRoleBuilder::default()
    }
}
...
impl PolicyRoleBuilder {
    ...
    pub fn build(self) -> super::types::PolicyRole {
        super::types::PolicyRole {
