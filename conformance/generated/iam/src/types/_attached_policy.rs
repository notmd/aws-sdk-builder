...
impl AttachedPolicy {
    ...
    pub fn builder() -> super::types::builders::AttachedPolicyBuilder {
        super::types::builders::AttachedPolicyBuilder::default()
    }
}
...
impl AttachedPolicyBuilder {
    ...
    pub fn build(self) -> super::types::AttachedPolicy {
