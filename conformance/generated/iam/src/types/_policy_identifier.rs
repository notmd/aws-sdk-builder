...
pub enum PolicyIdentifier {
    ...
    InlinePolicyIdentifier(super::types::InlinePolicyIdentifierType),
    ...
    PolicyType(super::types::PolicyIdentifierPolicyType),
...
impl PolicyIdentifier {
    ...
    pub fn as_inline_policy_identifier(&self) -> ::std::result::Result<&super::types::InlinePolicyIdentifierType, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_policy_type(&self) -> ::std::result::Result<&super::types::PolicyIdentifierPolicyType, &Self> {
