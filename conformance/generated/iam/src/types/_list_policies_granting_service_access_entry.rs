...
impl ListPoliciesGrantingServiceAccessEntryBuilder {
    ...
    pub fn set_policies(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::PolicyGrantingServiceAccess>>) -> Self { self.policies = input; self }
    /// <p>The <code>PoliciesGrantingServiceAccess</code> object that contains details about the policy.</p>
    pub fn get_policies(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::PolicyGrantingServiceAccess>> { &self.policies }
