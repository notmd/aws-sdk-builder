...
pub struct ListPoliciesGrantingServiceAccessEntry {
    ...
    pub policies: ::std::option::Option<::std::vec::Vec<super::types::PolicyGrantingServiceAccess>>,
}
impl ListPoliciesGrantingServiceAccessEntry {
    ...
    pub fn policies(&self) -> &[super::types::PolicyGrantingServiceAccess] {
...
impl ListPoliciesGrantingServiceAccessEntry {
    ...
    pub fn builder() -> super::types::builders::ListPoliciesGrantingServiceAccessEntryBuilder {
        super::types::builders::ListPoliciesGrantingServiceAccessEntryBuilder::default()
    }
}
...
pub struct ListPoliciesGrantingServiceAccessEntryBuilder {
    ...
    pub(crate) policies: ::std::option::Option<::std::vec::Vec<super::types::PolicyGrantingServiceAccess>>,
}
impl ListPoliciesGrantingServiceAccessEntryBuilder {
    ...
    ///
    /// <p>The&nbsp;<code>PoliciesGrantingServiceAccess</code> object that contains details about the policy.</p>
    pub fn policies(mut self, input: super::types::PolicyGrantingServiceAccess) -> Self {
    ...
    /// <p>The&nbsp;<code>PoliciesGrantingServiceAccess</code> object that contains details about the policy.</p>
    pub fn set_policies(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::PolicyGrantingServiceAccess>>) -> Self {
        self.policies = input;
        self
    }
    /// <p>The&nbsp;<code>PoliciesGrantingServiceAccess</code> object that contains details about the policy.</p>
    pub fn get_policies(&self) -> &::std::option::Option<::std::vec::Vec<super::types::PolicyGrantingServiceAccess>> {
        &self.policies
    }
    ...
    pub fn build(self) -> super::types::ListPoliciesGrantingServiceAccessEntry {
        super::types::ListPoliciesGrantingServiceAccessEntry {
