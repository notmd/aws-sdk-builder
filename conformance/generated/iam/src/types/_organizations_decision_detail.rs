...
impl OrganizationsDecisionDetail {
    ...
    pub fn builder() -> super::types::builders::OrganizationsDecisionDetailBuilder {
        super::types::builders::OrganizationsDecisionDetailBuilder::default()
    }
}
...
impl OrganizationsDecisionDetailBuilder {
    ...
    pub fn build(self) -> super::types::OrganizationsDecisionDetail {
        super::types::OrganizationsDecisionDetail {
