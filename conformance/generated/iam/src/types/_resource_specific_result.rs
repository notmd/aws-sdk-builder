...
pub struct ResourceSpecificResult {
    ...
    pub eval_resource_decision: super::types::PolicyEvaluationDecisionType,
...
impl ResourceSpecificResult {
    ...
    /// <p>The result of the simulation of the simulated API operation on the resource specified in <code>EvalResourceName</code>.</p>
    pub fn eval_resource_decision(&self) -> &super::types::PolicyEvaluationDecisionType {
...
impl ResourceSpecificResult {
    ...
    pub fn builder() -> super::types::builders::ResourceSpecificResultBuilder {
        super::types::builders::ResourceSpecificResultBuilder::default()
    }
}
...
pub struct ResourceSpecificResultBuilder {
    ...
    pub(crate) eval_resource_decision: ::std::option::Option<super::types::PolicyEvaluationDecisionType>,
...
impl ResourceSpecificResultBuilder {
    ...
    /// <p>The result of the simulation of the simulated API operation on the resource specified in <code>EvalResourceName</code>.</p>
    /// This field is required.
    pub fn eval_resource_decision(mut self, input: super::types::PolicyEvaluationDecisionType) -> Self {
        self.eval_resource_decision = ::std::option::Option::Some(input);
        self
    }
    /// <p>The result of the simulation of the simulated API operation on the resource specified in <code>EvalResourceName</code>.</p>
    pub fn set_eval_resource_decision(mut self, input: ::std::option::Option<super::types::PolicyEvaluationDecisionType>) -> Self {
        self.eval_resource_decision = input;
        self
    }
    /// <p>The result of the simulation of the simulated API operation on the resource specified in <code>EvalResourceName</code>.</p>
    pub fn get_eval_resource_decision(&self) -> &::std::option::Option<super::types::PolicyEvaluationDecisionType> {
        &self.eval_resource_decision
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::types::ResourceSpecificResult, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ResourceSpecificResult {
