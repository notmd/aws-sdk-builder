...
pub struct VirtualMfaDevice {
    ...
    pub user: ::std::option::Option<super::types::User>,
...
impl VirtualMfaDevice {
    ...
    /// <p>The IAM user associated with this virtual MFA device.</p>
    pub fn user(&self) -> ::std::option::Option<&super::types::User> {
        self.user.as_ref()
    }
    /// <p>The date and time on which the virtual MFA device was enabled.</p>
...
impl VirtualMfaDevice {
    ...
    pub fn builder() -> super::types::builders::VirtualMfaDeviceBuilder {
        super::types::builders::VirtualMfaDeviceBuilder::default()
    }
}
...
pub struct VirtualMfaDeviceBuilder {
    ...
    pub(crate) user: ::std::option::Option<super::types::User>,
...
impl VirtualMfaDeviceBuilder {
    ...
    /// <p>The IAM user associated with this virtual MFA device.</p>
    pub fn user(mut self, input: super::types::User) -> Self {
        self.user = ::std::option::Option::Some(input);
        self
    }
    /// <p>The IAM user associated with this virtual MFA device.</p>
    pub fn set_user(mut self, input: ::std::option::Option<super::types::User>) -> Self {
        self.user = input;
        self
    }
    /// <p>The IAM user associated with this virtual MFA device.</p>
    pub fn get_user(&self) -> &::std::option::Option<super::types::User> {
        &self.user
    }
    /// <p>The date and time on which the virtual MFA device was enabled.</p>
    ...
    pub fn build(self) -> ::std::result::Result<super::types::VirtualMfaDevice, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::VirtualMfaDevice {
