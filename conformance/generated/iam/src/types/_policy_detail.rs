...
impl PolicyDetail {
    ...
    pub fn builder() -> super::types::builders::PolicyDetailBuilder {
        super::types::builders::PolicyDetailBuilder::default()
    }
}
...
impl PolicyDetailBuilder {
    ...
    pub fn build(self) -> super::types::PolicyDetail {
        super::types::PolicyDetail {
