// Generated by aws-sdk-build aws-sdk-build-rust-native-0.1.0. DO NOT EDIT.
    ...
    impl GetRoleRequest {
        pub fn builder() -> GetRoleRequestBuilder { GetRoleRequestBuilder::default() }
        pub fn role_name(&self) -> &::std::option::Option<self::RoleNameType> { &self.role_name }
    }

    #[derive(Clone, Debug, Default)]
    pub struct GetRoleRequestBuilder {
        role_name: ::std::option::Option<self::RoleNameType>,
    }

    impl GetRoleRequestBuilder {
        ...
        pub fn build(self) -> GetRoleRequest {
            GetRoleRequest {
