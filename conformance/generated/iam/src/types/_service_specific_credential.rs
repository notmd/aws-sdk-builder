...
impl ServiceSpecificCredentialBuilder {
    ...
    /// <p>The date and time when the service specific credential expires. This field is only present for Bedrock API keys and CloudWatch Logs API keys that were created with an expiration period.</p>
    pub fn get_expiration_date(&self) -> &::std::option::Option<::aws_smithy_types::DateTime> { &self.expiration_date }
    /// <p>The name of the service associated with the service-specific credential.</p>
    /// This field is required.
    ...
    pub fn set_service_user_name(mut self, input: ::std::option::Option<::std::string::String>) -> Self { self.service_user_name = input; self }
    /// <p>The generated user name for the service-specific credential. This value is generated by combining the IAM user's name combined with the ID number of the Amazon Web Services account, as in <code>jane-at-123456789012</code>, for example. This value cannot be configured by the user.</p>
    pub fn get_service_user_name(&self) -> &::std::option::Option<::std::string::String> { &self.service_user_name }
    /// <p>The generated password for the service-specific credential.</p>
    ...
    pub fn set_service_password(mut self, input: ::std::option::Option<::std::string::String>) -> Self { self.service_password = input; self }
    /// <p>The generated password for the service-specific credential.</p>
    pub fn get_service_password(&self) -> &::std::option::Option<::std::string::String> { &self.service_password }
    /// <p>For Bedrock API keys and CloudWatch Logs API keys, this is the public portion of the credential that includes the IAM user name and a suffix containing version and creation information.</p>
    ...
    pub fn set_service_credential_alias(mut self, input: ::std::option::Option<::std::string::String>) -> Self { self.service_credential_alias = input; self }
    /// <p>For Bedrock API keys and CloudWatch Logs API keys, this is the public portion of the credential that includes the IAM user name and a suffix containing version and creation information.</p>
    pub fn get_service_credential_alias(&self) -> &::std::option::Option<::std::string::String> { &self.service_credential_alias }
    /// <p>For Bedrock API keys and CloudWatch Logs API keys, this is the secret portion of the credential that should be used to authenticate API calls. This value is returned only when the credential is created.</p>
    ...
    pub fn set_service_credential_secret(mut self, input: ::std::option::Option<::std::string::String>) -> Self { self.service_credential_secret = input; self }
    /// <p>For Bedrock API keys and CloudWatch Logs API keys, this is the secret portion of the credential that should be used to authenticate API calls. This value is returned only when the credential is created.</p>
    pub fn get_service_credential_secret(&self) -> &::std::option::Option<::std::string::String> { &self.service_credential_secret }
    /// <p>The unique identifier for the service-specific credential.</p>
    /// This field is required.
    ...
    pub fn set_service_specific_credential_id(mut self, input: ::std::option::Option<::std::string::String>) -> Self { self.service_specific_credential_id = input; self }
    /// <p>The unique identifier for the service-specific credential.</p>
    pub fn get_service_specific_credential_id(&self) -> &::std::option::Option<::std::string::String> { &self.service_specific_credential_id }
    /// <p>The name of the IAM user associated with the service-specific credential.</p>
    /// This field is required.
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::ServiceSpecificCredential, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::ServiceSpecificCredential {
            create_date: self.create_date.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("create_date", "create_date was not specified but it is required when building ServiceSpecificCredential"))?,
            expiration_date: self.expiration_date,
            service_name: self.service_name.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("service_name", "service_name was not specified but it is required when building ServiceSpecificCredential"))?,
            ...
            service_specific_credential_id: self.service_specific_credential_id.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("service_specific_credential_id", "service_specific_credential_id was not specified but it is required when building ServiceSpecificCredential"))?,
            user_name: self.user_name.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("user_name", "user_name was not specified but it is required when building ServiceSpecificCredential"))?,
            status: self.status.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("status", "status was not specified but it is required when building ServiceSpecificCredential"))?,
        })
    }
}
