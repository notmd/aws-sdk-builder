...
pub struct ServiceLastAccessed {
    ...
    pub tracked_actions_last_accessed: ::std::option::Option<::std::vec::Vec<super::types::TrackedActionLastAccessed>>,
}
impl ServiceLastAccessed {
    ...
    pub fn tracked_actions_last_accessed(&self) -> &[super::types::TrackedActionLastAccessed] {
...
impl ServiceLastAccessed {
    ...
    pub fn builder() -> super::types::builders::ServiceLastAccessedBuilder {
        super::types::builders::ServiceLastAccessedBuilder::default()
    }
}
...
pub struct ServiceLastAccessedBuilder {
    ...
    pub(crate) tracked_actions_last_accessed: ::std::option::Option<::std::vec::Vec<super::types::TrackedActionLastAccessed>>,
}
impl ServiceLastAccessedBuilder {
    ...
    /// <p>An object that contains details about the most recent attempt to access a tracked action within the service.</p>
    /// <p>This field is null if there no tracked actions or if the principal did not use the tracked actions within the <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_access-advisor.html#service-last-accessed-reporting-period">tracking period</a>. This field is also null if the report was generated at the service level and not the action level. For more information, see the <code>Granularity</code> field in <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_GenerateServiceLastAccessedDetails.html">GenerateServiceLastAccessedDetails</a>.</p>
    pub fn tracked_actions_last_accessed(mut self, input: super::types::TrackedActionLastAccessed) -> Self {
    ...
    pub fn set_tracked_actions_last_accessed(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::TrackedActionLastAccessed>>,
    ) -> Self {
    ...
    /// <p>An object that contains details about the most recent attempt to access a tracked action within the service.</p>
    /// <p>This field is null if there no tracked actions or if the principal did not use the tracked actions within the <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_access-advisor.html#service-last-accessed-reporting-period">tracking period</a>. This field is also null if the report was generated at the service level and not the action level. For more information, see the <code>Granularity</code> field in <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_GenerateServiceLastAccessedDetails.html">GenerateServiceLastAccessedDetails</a>.</p>
    pub fn get_tracked_actions_last_accessed(&self) -> &::std::option::Option<::std::vec::Vec<super::types::TrackedActionLastAccessed>> {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::ServiceLastAccessed, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ServiceLastAccessed {
