...
pub struct EvaluationResult {
    ...
    pub eval_decision: super::types::PolicyEvaluationDecisionType,
    ...
    pub matched_statements: ::std::option::Option<::std::vec::Vec<super::types::Statement>>,
    ...
    pub organizations_decision_detail: ::std::option::Option<super::types::OrganizationsDecisionDetail>,
    ...
    pub permissions_boundary_decision_detail: ::std::option::Option<super::types::PermissionsBoundaryDecisionDetail>,
    ...
    pub eval_decision_details: ::std::option::Option<::std::collections::HashMap<::std::string::String, super::types::PolicyEvaluationDecisionType>>,
    /// <p>The individual results of the simulation of the API operation specified in EvalActionName on each resource.</p>
    pub resource_specific_results: ::std::option::Option<::std::vec::Vec<super::types::ResourceSpecificResult>>,
}
impl EvaluationResult {
    ...
    /// <p>The result of the simulation.</p>
    pub fn eval_decision(&self) -> &super::types::PolicyEvaluationDecisionType {
        &self.eval_decision
    }
    /// <p>A list of the statements in the input policies that determine the result for this scenario. Remember that even if multiple statements allow the operation on the resource, if only one statement denies that operation, then the explicit deny overrides any allow. In addition, the deny statement is the only entry included in the result.</p>
    /// <p>In the top-level result, this field contains the union of matched statements across all requested resources. Only statements that contributed to the reported decision are included. For per-resource matched statements, see <code>ResourceSpecificResults</code>. This field doesn't include statements from service control policies (SCPs). Only statements from identity-based and resource-based policies appear here.</p>
    ...
    pub fn matched_statements(&self) -> &[super::types::Statement] {
    ...
    /// <p>A structure that details how Organizations and its service control policies affect the results of the simulation. Only applies if the simulated user's account is part of an organization.</p>
    /// <p>For resources that don't support organization-level evaluation, this field is omitted from the top-level result. For per-resource details, see <code>ResourceSpecificResults</code>.</p>
    pub fn organizations_decision_detail(&self) -> ::std::option::Option<&super::types::OrganizationsDecisionDetail> {
        self.organizations_decision_detail.as_ref()
    }
    /// <p>Contains information about the effect that a permissions boundary has on a policy simulation when the boundary is applied to an IAM entity.</p>
    pub fn permissions_boundary_decision_detail(&self) -> ::std::option::Option<&super::types::PermissionsBoundaryDecisionDetail> {
    ...
    pub fn eval_decision_details(
        &self,
    ) -> ::std::option::Option<&::std::collections::HashMap<::std::string::String, super::types::PolicyEvaluationDecisionType>> {
    ...
    pub fn resource_specific_results(&self) -> &[super::types::ResourceSpecificResult] {
...
impl EvaluationResult {
    ...
    pub fn builder() -> super::types::builders::EvaluationResultBuilder {
        super::types::builders::EvaluationResultBuilder::default()
    }
}
...
pub struct EvaluationResultBuilder {
    ...
    pub(crate) eval_decision: ::std::option::Option<super::types::PolicyEvaluationDecisionType>,
    pub(crate) matched_statements: ::std::option::Option<::std::vec::Vec<super::types::Statement>>,
    pub(crate) missing_context_values: ::std::option::Option<::std::vec::Vec<::std::string::String>>,
    pub(crate) organizations_decision_detail: ::std::option::Option<super::types::OrganizationsDecisionDetail>,
    pub(crate) permissions_boundary_decision_detail: ::std::option::Option<super::types::PermissionsBoundaryDecisionDetail>,
    pub(crate) eval_decision_details:
        ::std::option::Option<::std::collections::HashMap<::std::string::String, super::types::PolicyEvaluationDecisionType>>,
    pub(crate) resource_specific_results: ::std::option::Option<::std::vec::Vec<super::types::ResourceSpecificResult>>,
}
impl EvaluationResultBuilder {
    ...
    /// <p>The result of the simulation.</p>
    /// This field is required.
    pub fn eval_decision(mut self, input: super::types::PolicyEvaluationDecisionType) -> Self {
        self.eval_decision = ::std::option::Option::Some(input);
        self
    }
    /// <p>The result of the simulation.</p>
    pub fn set_eval_decision(mut self, input: ::std::option::Option<super::types::PolicyEvaluationDecisionType>) -> Self {
        self.eval_decision = input;
        self
    }
    /// <p>The result of the simulation.</p>
    pub fn get_eval_decision(&self) -> &::std::option::Option<super::types::PolicyEvaluationDecisionType> {
        &self.eval_decision
    }
    ...
    /// <p>A list of the statements in the input policies that determine the result for this scenario. Remember that even if multiple statements allow the operation on the resource, if only one statement denies that operation, then the explicit deny overrides any allow. In addition, the deny statement is the only entry included in the result.</p>
    /// <p>In the top-level result, this field contains the union of matched statements across all requested resources. Only statements that contributed to the reported decision are included. For per-resource matched statements, see <code>ResourceSpecificResults</code>. This field doesn't include statements from service control policies (SCPs). Only statements from identity-based and resource-based policies appear here.</p>
    pub fn matched_statements(mut self, input: super::types::Statement) -> Self {
    ...
    /// <p>A list of the statements in the input policies that determine the result for this scenario. Remember that even if multiple statements allow the operation on the resource, if only one statement denies that operation, then the explicit deny overrides any allow. In addition, the deny statement is the only entry included in the result.</p>
    /// <p>In the top-level result, this field contains the union of matched statements across all requested resources. Only statements that contributed to the reported decision are included. For per-resource matched statements, see <code>ResourceSpecificResults</code>. This field doesn't include statements from service control policies (SCPs). Only statements from identity-based and resource-based policies appear here.</p>
    pub fn set_matched_statements(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::Statement>>) -> Self {
        self.matched_statements = input;
        self
    }
    /// <p>A list of the statements in the input policies that determine the result for this scenario. Remember that even if multiple statements allow the operation on the resource, if only one statement denies that operation, then the explicit deny overrides any allow. In addition, the deny statement is the only entry included in the result.</p>
    /// <p>In the top-level result, this field contains the union of matched statements across all requested resources. Only statements that contributed to the reported decision are included. For per-resource matched statements, see <code>ResourceSpecificResults</code>. This field doesn't include statements from service control policies (SCPs). Only statements from identity-based and resource-based policies appear here.</p>
    pub fn get_matched_statements(&self) -> &::std::option::Option<::std::vec::Vec<super::types::Statement>> {
    ...
    /// <p>A structure that details how Organizations and its service control policies affect the results of the simulation. Only applies if the simulated user's account is part of an organization.</p>
    /// <p>For resources that don't support organization-level evaluation, this field is omitted from the top-level result. For per-resource details, see <code>ResourceSpecificResults</code>.</p>
    pub fn organizations_decision_detail(mut self, input: super::types::OrganizationsDecisionDetail) -> Self {
        self.organizations_decision_detail = ::std::option::Option::Some(input);
        self
    }
    /// <p>A structure that details how Organizations and its service control policies affect the results of the simulation. Only applies if the simulated user's account is part of an organization.</p>
    /// <p>For resources that don't support organization-level evaluation, this field is omitted from the top-level result. For per-resource details, see <code>ResourceSpecificResults</code>.</p>
    pub fn set_organizations_decision_detail(mut self, input: ::std::option::Option<super::types::OrganizationsDecisionDetail>) -> Self {
        self.organizations_decision_detail = input;
        self
    }
    /// <p>A structure that details how Organizations and its service control policies affect the results of the simulation. Only applies if the simulated user's account is part of an organization.</p>
    /// <p>For resources that don't support organization-level evaluation, this field is omitted from the top-level result. For per-resource details, see <code>ResourceSpecificResults</code>.</p>
    pub fn get_organizations_decision_detail(&self) -> &::std::option::Option<super::types::OrganizationsDecisionDetail> {
        &self.organizations_decision_detail
    }
    /// <p>Contains information about the effect that a permissions boundary has on a policy simulation when the boundary is applied to an IAM entity.</p>
    pub fn permissions_boundary_decision_detail(mut self, input: super::types::PermissionsBoundaryDecisionDetail) -> Self {
        self.permissions_boundary_decision_detail = ::std::option::Option::Some(input);
        self
    }
    /// <p>Contains information about the effect that a permissions boundary has on a policy simulation when the boundary is applied to an IAM entity.</p>
    pub fn set_permissions_boundary_decision_detail(mut self, input: ::std::option::Option<super::types::PermissionsBoundaryDecisionDetail>) -> Self {
        self.permissions_boundary_decision_detail = input;
        self
    }
    /// <p>Contains information about the effect that a permissions boundary has on a policy simulation when the boundary is applied to an IAM entity.</p>
    pub fn get_permissions_boundary_decision_detail(&self) -> &::std::option::Option<super::types::PermissionsBoundaryDecisionDetail> {
    ...
    pub fn eval_decision_details(
        ...
        v: super::types::PolicyEvaluationDecisionType,
    ) -> Self {
    ...
    pub fn set_eval_decision_details(
        mut self,
        input: ::std::option::Option<::std::collections::HashMap<::std::string::String, super::types::PolicyEvaluationDecisionType>>,
    ) -> Self {
    ...
    ///
    /// <p>The individual results of the simulation of the API operation specified in EvalActionName on each resource.</p>
    pub fn resource_specific_results(mut self, input: super::types::ResourceSpecificResult) -> Self {
    ...
    /// <p>The individual results of the simulation of the API operation specified in EvalActionName on each resource.</p>
    pub fn set_resource_specific_results(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::ResourceSpecificResult>>) -> Self {
        self.resource_specific_results = input;
        self
    }
    /// <p>The individual results of the simulation of the API operation specified in EvalActionName on each resource.</p>
    pub fn get_resource_specific_results(&self) -> &::std::option::Option<::std::vec::Vec<super::types::ResourceSpecificResult>> {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::EvaluationResult, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::EvaluationResult {
