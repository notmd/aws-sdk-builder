...
pub struct RoleDetail {
    ...
    pub instance_profile_list: ::std::option::Option<::std::vec::Vec<super::types::InstanceProfile>>,
    /// <p>A list of inline policies embedded in the role. These policies are the role's access (permissions) policies.</p>
    pub role_policy_list: ::std::option::Option<::std::vec::Vec<super::types::PolicyDetail>>,
    ...
    pub role_last_used: ::std::option::Option<super::types::RoleLastUsed>,
}
impl RoleDetail {
    /// <p>The path to the role. For more information about paths, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/Using_Identifiers.html">IAM identifiers</a> in the <i>IAM User Guide</i>.</p>
    ...
    pub fn instance_profile_list(&self) -> &[super::types::InstanceProfile] {
    ...
    pub fn role_policy_list(&self) -> &[super::types::PolicyDetail] {
    ...
    /// <p>Contains information about the last time that an IAM role was used. This includes the date and time and the Region in which the role was last used. Activity is only reported for the trailing 400 days. This period can be shorter if your Region began supporting these features within the last year. The role might have been used more than 400 days ago. For more information, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_access-advisor.html#access-advisor_tracking-period">Regions where data is tracked</a> in the <i>IAM User Guide</i>.</p>
    pub fn role_last_used(&self) -> ::std::option::Option<&super::types::RoleLastUsed> {
        self.role_last_used.as_ref()
    }
}
impl RoleDetail {
    /// Creates a new builder-style object to manufacture [`RoleDetail`](crate::types::RoleDetail).
    pub fn builder() -> super::types::builders::RoleDetailBuilder {
        super::types::builders::RoleDetailBuilder::default()
    }
}
...
pub struct RoleDetailBuilder {
    ...
    pub(crate) instance_profile_list: ::std::option::Option<::std::vec::Vec<super::types::InstanceProfile>>,
    pub(crate) role_policy_list: ::std::option::Option<::std::vec::Vec<super::types::PolicyDetail>>,
    ...
    pub(crate) role_last_used: ::std::option::Option<super::types::RoleLastUsed>,
}
impl RoleDetailBuilder {
    ...
    ///
    /// <p>A list of instance profiles that contain this role.</p>
    pub fn instance_profile_list(mut self, input: super::types::InstanceProfile) -> Self {
    ...
    /// <p>A list of instance profiles that contain this role.</p>
    pub fn set_instance_profile_list(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::InstanceProfile>>) -> Self {
        self.instance_profile_list = input;
        self
    }
    /// <p>A list of instance profiles that contain this role.</p>
    pub fn get_instance_profile_list(&self) -> &::std::option::Option<::std::vec::Vec<super::types::InstanceProfile>> {
    ...
    ///
    /// <p>A list of inline policies embedded in the role. These policies are the role's access (permissions) policies.</p>
    pub fn role_policy_list(mut self, input: super::types::PolicyDetail) -> Self {
    ...
    /// <p>A list of inline policies embedded in the role. These policies are the role's access (permissions) policies.</p>
    pub fn set_role_policy_list(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::PolicyDetail>>) -> Self {
        self.role_policy_list = input;
        self
    }
    /// <p>A list of inline policies embedded in the role. These policies are the role's access (permissions) policies.</p>
    pub fn get_role_policy_list(&self) -> &::std::option::Option<::std::vec::Vec<super::types::PolicyDetail>> {
    ...
    /// <p>Contains information about the last time that an IAM role was used. This includes the date and time and the Region in which the role was last used. Activity is only reported for the trailing 400 days. This period can be shorter if your Region began supporting these features within the last year. The role might have been used more than 400 days ago. For more information, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_access-advisor.html#access-advisor_tracking-period">Regions where data is tracked</a> in the <i>IAM User Guide</i>.</p>
    pub fn role_last_used(mut self, input: super::types::RoleLastUsed) -> Self {
        self.role_last_used = ::std::option::Option::Some(input);
        self
    }
    /// <p>Contains information about the last time that an IAM role was used. This includes the date and time and the Region in which the role was last used. Activity is only reported for the trailing 400 days. This period can be shorter if your Region began supporting these features within the last year. The role might have been used more than 400 days ago. For more information, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_access-advisor.html#access-advisor_tracking-period">Regions where data is tracked</a> in the <i>IAM User Guide</i>.</p>
    pub fn set_role_last_used(mut self, input: ::std::option::Option<super::types::RoleLastUsed>) -> Self {
        self.role_last_used = input;
        self
    }
    /// <p>Contains information about the last time that an IAM role was used. This includes the date and time and the Region in which the role was last used. Activity is only reported for the trailing 400 days. This period can be shorter if your Region began supporting these features within the last year. The role might have been used more than 400 days ago. For more information, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_access-advisor.html#access-advisor_tracking-period">Regions where data is tracked</a> in the <i>IAM User Guide</i>.</p>
    pub fn get_role_last_used(&self) -> &::std::option::Option<super::types::RoleLastUsed> {
        &self.role_last_used
    }
    /// Consumes the builder and constructs a [`RoleDetail`](crate::types::RoleDetail).
    pub fn build(self) -> super::types::RoleDetail {
        super::types::RoleDetail {
            path: self.path,
