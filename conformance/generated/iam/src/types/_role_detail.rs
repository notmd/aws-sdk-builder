...
impl RoleDetailBuilder {
    ...
    pub fn set_instance_profile_list(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::InstanceProfile>>) -> Self { self.instance_profile_list = input; self }
    /// <p>A list of instance profiles that contain this role.</p>
    pub fn get_instance_profile_list(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::InstanceProfile>> { &self.instance_profile_list }
    /// <p>A list of inline policies embedded in the role. These policies are the role's access (permissions) policies.</p>
    ...
    pub fn set_role_policy_list(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::PolicyDetail>>) -> Self { self.role_policy_list = input; self }
    /// <p>A list of inline policies embedded in the role. These policies are the role's access (permissions) policies.</p>
    pub fn get_role_policy_list(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::PolicyDetail>> { &self.role_policy_list }
    /// <p>A list of managed policies attached to the role. These policies are the role's access (permissions) policies.</p>
