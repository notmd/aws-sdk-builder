...
impl ::aws_types::request_id::RequestId for super::types::error::AccountNotManagementOrDelegatedAdministratorException {
...
impl AccountNotManagementOrDelegatedAdministratorException {
    ...
    pub fn builder() -> super::types::error::builders::AccountNotManagementOrDelegatedAdministratorExceptionBuilder {
        super::types::error::builders::AccountNotManagementOrDelegatedAdministratorExceptionBuilder::default()
    }
}
...
impl AccountNotManagementOrDelegatedAdministratorExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::AccountNotManagementOrDelegatedAdministratorException {
        super::types::error::AccountNotManagementOrDelegatedAdministratorException {
