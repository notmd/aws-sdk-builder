...
impl ::aws_types::request_id::RequestId for super::types::error::ReportGenerationLimitExceededException {
...
impl ReportGenerationLimitExceededException {
    ...
    pub fn builder() -> super::types::error::builders::ReportGenerationLimitExceededExceptionBuilder {
        super::types::error::builders::ReportGenerationLimitExceededExceptionBuilder::default()
    }
}
...
impl ReportGenerationLimitExceededExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::ReportGenerationLimitExceededException {
        super::types::error::ReportGenerationLimitExceededException {
