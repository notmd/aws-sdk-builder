...
impl ::aws_types::request_id::RequestId for super::types::error::EntityTemporarilyUnmodifiableException {
...
impl EntityTemporarilyUnmodifiableException {
    ...
    pub fn builder() -> super::types::error::builders::EntityTemporarilyUnmodifiableExceptionBuilder {
        super::types::error::builders::EntityTemporarilyUnmodifiableExceptionBuilder::default()
    }
}
...
impl EntityTemporarilyUnmodifiableExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::EntityTemporarilyUnmodifiableException {
        super::types::error::EntityTemporarilyUnmodifiableException {
