...
impl ::aws_types::request_id::RequestId for super::types::error::InvalidInputException {
...
impl InvalidInputException {
    ...
    pub fn builder() -> super::types::error::builders::InvalidInputExceptionBuilder {
        super::types::error::builders::InvalidInputExceptionBuilder::default()
    }
}
...
impl InvalidInputExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::InvalidInputException {
        super::types::error::InvalidInputException {
