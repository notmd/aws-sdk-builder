// Generated by aws-sdk-build aws-sdk-build-rust-native-0.1.0. DO NOT EDIT.
    ...
    impl GetLoginProfileRequest {
        pub fn builder() -> GetLoginProfileRequestBuilder { GetLoginProfileRequestBuilder::default() }
        pub fn user_name(&self) -> &::std::option::Option<self::UserNameType> { &self.user_name }
    }

    #[derive(Clone, Debug, Default)]
    pub struct GetLoginProfileRequestBuilder {
        user_name: ::std::option::Option<self::UserNameType>,
    }

    impl GetLoginProfileRequestBuilder {
        ...
        pub fn build(self) -> GetLoginProfileRequest {
