...
impl PolicyUser {
    ...
    pub fn builder() -> super::types::builders::PolicyUserBuilder {
        super::types::builders::PolicyUserBuilder::default()
    }
}
...
impl PolicyUserBuilder {
    ...
    pub fn build(self) -> super::types::PolicyUser {
        super::types::PolicyUser {
