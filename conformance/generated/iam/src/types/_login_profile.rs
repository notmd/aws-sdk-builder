...
impl LoginProfile {
    ...
    pub fn builder() -> super::types::builders::LoginProfileBuilder {
        super::types::builders::LoginProfileBuilder::default()
    }
}
...
impl LoginProfileBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::LoginProfile, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::LoginProfile {
