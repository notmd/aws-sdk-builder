...
impl ServiceSpecificCredentialMetadata {
    ...
    pub fn builder() -> super::types::builders::ServiceSpecificCredentialMetadataBuilder {
        super::types::builders::ServiceSpecificCredentialMetadataBuilder::default()
    }
}
...
impl ServiceSpecificCredentialMetadataBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::ServiceSpecificCredentialMetadata, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ServiceSpecificCredentialMetadata {
