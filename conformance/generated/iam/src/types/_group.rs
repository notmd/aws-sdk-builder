...
impl Group {
    ...
    pub fn builder() -> super::types::builders::GroupBuilder {
        super::types::builders::GroupBuilder::default()
    }
}
...
impl GroupBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::Group, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::Group {
