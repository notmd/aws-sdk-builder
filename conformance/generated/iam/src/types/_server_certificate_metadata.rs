...
impl ServerCertificateMetadata {
    ...
    pub fn builder() -> super::types::builders::ServerCertificateMetadataBuilder {
        super::types::builders::ServerCertificateMetadataBuilder::default()
    }
}
...
impl ServerCertificateMetadataBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::ServerCertificateMetadata, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ServerCertificateMetadata {
