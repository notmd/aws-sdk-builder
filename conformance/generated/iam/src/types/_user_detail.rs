...
impl UserDetailBuilder {
    ...
    pub fn set_user_policy_list(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::PolicyDetail>>) -> Self { self.user_policy_list = input; self }
    /// <p>A list of the inline policies embedded in the user.</p>
    pub fn get_user_policy_list(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::PolicyDetail>> { &self.user_policy_list }
    /// <p>A list of IAM groups that the user is in.</p>
    ...
    pub fn set_group_list(mut self, input: ::std::option::Option<::std::vec::Vec<::std::string::String>>) -> Self { self.group_list = input; self }
    /// <p>A list of IAM groups that the user is in.</p>
    pub fn get_group_list(&self) -> &::std::option::Option<::std::vec::Vec<::std::string::String>> { &self.group_list }
    /// <p>A list of the managed policies attached to the user.</p>
