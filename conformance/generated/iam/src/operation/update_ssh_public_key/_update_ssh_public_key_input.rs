...
impl UpdateSshPublicKeyInput {
    ...
    pub fn builder() -> super::operation::update_ssh_public_key::builders::UpdateSshPublicKeyInputBuilder {
        super::operation::update_ssh_public_key::builders::UpdateSshPublicKeyInputBuilder::default()
    }
}
...
impl UpdateSshPublicKeyInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::update_ssh_public_key::UpdateSshPublicKeyInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::update_ssh_public_key::UpdateSshPublicKeyInput {
