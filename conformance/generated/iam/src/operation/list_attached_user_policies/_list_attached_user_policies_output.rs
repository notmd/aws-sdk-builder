...
impl ListAttachedUserPoliciesOutput {
    pub fn builder() -> ListAttachedUserPoliciesOutputBuilder { ListAttachedUserPoliciesOutputBuilder::default() }
}
#[derive(Clone, Debug, Default)]
...
impl ListAttachedUserPoliciesOutputBuilder {
    ...
    pub fn build(self) -> ListAttachedUserPoliciesOutput { ListAttachedUserPoliciesOutput {
