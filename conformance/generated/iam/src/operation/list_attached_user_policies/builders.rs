...
pub struct Builder {
    input: super::_list_attached_user_policies_input::ListAttachedUserPoliciesInputBuilder,
...
impl Builder {
    ...
    pub async fn send(self) -> ::std::result::Result<super::ListAttachedUserPoliciesOutput, super::ListAttachedUserPoliciesError> {
        let input = self
            .input
            .build()
            .map_err(|error| super::ListAttachedUserPoliciesError::Unhandled(error.to_string()))?;
        let path = "/";
        ...
        let response = self
            ...
            .await
            .map_err(super::ListAttachedUserPoliciesError::Unhandled)?;
        let status = response.status();
        if !status.is_success() {
            return Err(super::ListAttachedUserPoliciesError::unhandled_with_request_ids(
                format!("ListAttachedUserPolicies returned HTTP {}", status),
