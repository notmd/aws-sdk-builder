...
pub struct ListAttachedUserPoliciesPaginator {
    ...
    builder: super::operation::list_attached_user_policies::builders::ListAttachedUserPoliciesInputBuilder,
...
impl ListAttachedUserPoliciesPaginator {
    ...
    pub fn items(self) -> super::operation::list_attached_user_policies::paginator::ListAttachedUserPoliciesPaginatorItems {
        super::operation::list_attached_user_policies::paginator::ListAttachedUserPoliciesPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            super::operation::list_attached_user_policies::ListAttachedUserPolicies::orchestrate(&runtime_plugins, input.clone())
                                .await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_list_attached_user_policies_output_output_marker(resp);
...
impl ListAttachedUserPoliciesPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::lens::lens_list_attached_user_policies_output_output_attached_policies(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
