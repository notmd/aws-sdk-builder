...
impl AttachUserPolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::attach_user_policy::AttachUserPolicyInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::attach_user_policy::AttachUserPolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::attach_user_policy::AttachUserPolicyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AttachUserPolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_attach_user_policy::de_attach_user_policy_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_attach_user_policy::de_attach_user_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AttachUserPolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::attach_user_policy::AttachUserPolicyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::attach_user_policy::AttachUserPolicyInput,
...
impl ::aws_types::request_id::RequestId for super::operation::attach_user_policy::AttachUserPolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::attach_user_policy::_attach_user_policy_input::AttachUserPolicyInput;

pub use super::operation::attach_user_policy::_attach_user_policy_output::AttachUserPolicyOutput;
