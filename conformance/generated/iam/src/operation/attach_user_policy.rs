...
pub mod _attach_user_policy_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/attach_user_policy/_attach_user_policy_input.rs"
    ));
}
...
pub mod _attach_user_policy_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/attach_user_policy/_attach_user_policy_output.rs"
    ));
}
