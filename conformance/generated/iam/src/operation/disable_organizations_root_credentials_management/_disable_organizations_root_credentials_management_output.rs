...
impl DisableOrganizationsRootCredentialsManagementOutput {
    pub fn builder() -> DisableOrganizationsRootCredentialsManagementOutputBuilder { DisableOrganizationsRootCredentialsManagementOutputBuilder::default() }
}
#[derive(Clone, Debug, Default)]
...
impl DisableOrganizationsRootCredentialsManagementOutputBuilder {
    ...
    pub fn build(self) -> DisableOrganizationsRootCredentialsManagementOutput { DisableOrganizationsRootCredentialsManagementOutput {
