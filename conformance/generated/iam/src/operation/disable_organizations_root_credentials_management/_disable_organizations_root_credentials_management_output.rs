...
impl DisableOrganizationsRootCredentialsManagementOutput {
    ...
    pub fn builder(
    ) -> super::operation::disable_organizations_root_credentials_management::builders::DisableOrganizationsRootCredentialsManagementOutputBuilder
    {
        super::operation::disable_organizations_root_credentials_management::builders::DisableOrganizationsRootCredentialsManagementOutputBuilder::default()
    }
}
...
impl DisableOrganizationsRootCredentialsManagementOutputBuilder {
    ...
    pub fn build(self) -> super::operation::disable_organizations_root_credentials_management::DisableOrganizationsRootCredentialsManagementOutput {
