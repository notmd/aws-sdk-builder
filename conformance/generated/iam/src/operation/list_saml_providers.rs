...
pub mod _list_saml_providers_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/list_saml_providers/_list_saml_providers_input.rs"
    ));
}
...
pub mod _list_saml_providers_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/list_saml_providers/_list_saml_providers_output.rs"
    ));
}
