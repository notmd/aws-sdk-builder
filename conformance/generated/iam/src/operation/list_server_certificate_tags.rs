...
pub mod _list_server_certificate_tags_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/list_server_certificate_tags/_list_server_certificate_tags_input.rs"
    ));
}
...
pub mod _list_server_certificate_tags_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/list_server_certificate_tags/_list_server_certificate_tags_output.rs"
    ));
}
