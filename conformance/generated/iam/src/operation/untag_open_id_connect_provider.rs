...
pub mod _untag_open_id_connect_provider_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/untag_open_id_connect_provider/_untag_open_id_connect_provider_input.rs"));
}
pub use _untag_open_id_connect_provider_input::UntagOpenIdConnectProviderInput;
pub type Input = UntagOpenIdConnectProviderInput;
pub mod _untag_open_id_connect_provider_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/untag_open_id_connect_provider/_untag_open_id_connect_provider_output.rs"));
}
pub use _untag_open_id_connect_provider_output::UntagOpenIdConnectProviderOutput;
pub type Output = UntagOpenIdConnectProviderOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/untag_open_id_connect_provider/builders.rs"));
}
