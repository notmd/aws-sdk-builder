...
impl UntagOpenIdConnectProvider {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::untag_open_id_connect_provider::UntagOpenIdConnectProviderInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::untag_open_id_connect_provider::UntagOpenIDConnectProviderError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::untag_open_id_connect_provider::UntagOpenIdConnectProviderOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UntagOpenIDConnectProviderResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_untag_open_id_connect_provider::de_untag_open_id_connect_provider_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_untag_open_id_connect_provider::de_untag_open_id_connect_provider_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UntagOpenIDConnectProviderRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::untag_open_id_connect_provider::UntagOpenIdConnectProviderInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::untag_open_id_connect_provider::UntagOpenIdConnectProviderInput,
...
impl ::aws_types::request_id::RequestId for super::operation::untag_open_id_connect_provider::UntagOpenIDConnectProviderError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::untag_open_id_connect_provider::_untag_open_id_connect_provider_input::UntagOpenIdConnectProviderInput;

pub use super::operation::untag_open_id_connect_provider::_untag_open_id_connect_provider_output::UntagOpenIdConnectProviderOutput;
