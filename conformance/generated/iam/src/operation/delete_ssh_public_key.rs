...
impl DeleteSshPublicKey {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::delete_ssh_public_key::DeleteSshPublicKeyInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_ssh_public_key::DeleteSSHPublicKeyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_ssh_public_key::DeleteSshPublicKeyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteSSHPublicKeyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_ssh_public_key::de_delete_ssh_public_key_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_ssh_public_key::de_delete_ssh_public_key_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteSSHPublicKeyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_ssh_public_key::DeleteSshPublicKeyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_ssh_public_key::DeleteSshPublicKeyInput,
...
impl ::aws_types::request_id::RequestId for super::operation::delete_ssh_public_key::DeleteSSHPublicKeyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_ssh_public_key::_delete_ssh_public_key_input::DeleteSshPublicKeyInput;

pub use super::operation::delete_ssh_public_key::_delete_ssh_public_key_output::DeleteSshPublicKeyOutput;
