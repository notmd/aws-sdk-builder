...
pub use super::operation::list_entities_for_policy::_list_entities_for_policy_input::ListEntitiesForPolicyInputBuilder;

pub use super::operation::list_entities_for_policy::_list_entities_for_policy_output::ListEntitiesForPolicyOutputBuilder;

impl super::operation::list_entities_for_policy::builders::ListEntitiesForPolicyInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::list_entities_for_policy::ListEntitiesForPolicyError,
...
pub struct ListEntitiesForPolicyFluentBuilder {
    ...
    inner: super::operation::list_entities_for_policy::builders::ListEntitiesForPolicyInputBuilder,
...
impl ListEntitiesForPolicyFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::list_entities_for_policy::builders::ListEntitiesForPolicyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::list_entities_for_policy::ListEntitiesForPolicy::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::list_entities_for_policy::ListEntitiesForPolicy::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::operation::list_entities_for_policy::paginator::ListEntitiesForPolicyPaginator {
        super::operation::list_entities_for_policy::paginator::ListEntitiesForPolicyPaginator::new(self.handle, self.inner)
    }
    ...
    pub fn entity_filter(mut self, input: super::types::EntityType) -> Self {
        self.inner = self.inner.entity_filter(input);
        self
    }
    /// <p>The entity type to use for filtering the results.</p>
    /// <p>For example, when <code>EntityFilter</code> is <code>Role</code>, only the roles that are attached to the specified policy are returned. This parameter is optional. If it is not included, all attached entities (users, groups, and roles) are returned. The argument for this parameter must be one of the valid values listed below.</p>
    pub fn set_entity_filter(mut self, input: ::std::option::Option<super::types::EntityType>) -> Self {
        self.inner = self.inner.set_entity_filter(input);
        self
    }
    /// <p>The entity type to use for filtering the results.</p>
    /// <p>For example, when <code>EntityFilter</code> is <code>Role</code>, only the roles that are attached to the specified policy are returned. This parameter is optional. If it is not included, all attached entities (users, groups, and roles) are returned. The argument for this parameter must be one of the valid values listed below.</p>
    pub fn get_entity_filter(&self) -> &::std::option::Option<super::types::EntityType> {
