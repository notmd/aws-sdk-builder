// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        pub type ListRolePoliciesInput = Input;
        pub type ListRolePoliciesOutput = Output;
        pub type ListRolePoliciesError = Error;
        #[derive(Clone, Debug)]
        pub enum Error {
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::ListRolePoliciesOutput, super::ListRolePoliciesError> {
                         let path = "/";
                         let body = ::std::vec::Vec::new();
                         let headers = ::std::vec::Vec::new();
                         let response = self.client.request(super::super::super::transport::Method::Post, &path, &headers, &body).await.map_err(super::ListRolePoliciesError::Unhandled)?;
                         let status = response.status();
                         if !status.is_success() {
                             return Err(super::ListRolePoliciesError::Unhandled(format!("ListRolePolicies returned HTTP {}", status)));
                         }
                         Ok(super::ListRolePoliciesOutput::default())
                     }
                 }
}
pub use builders::Builder;
        pub type ListRolePoliciesFluentBuilder = builders::Builder;
