...
pub mod _list_role_policies_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/list_role_policies/_list_role_policies_input.rs"));
}
pub use _list_role_policies_input::ListRolePoliciesInput;
pub type Input = ListRolePoliciesInput;
pub mod _list_role_policies_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/list_role_policies/_list_role_policies_output.rs"));
}
pub use _list_role_policies_output::ListRolePoliciesOutput;
pub type Output = ListRolePoliciesOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/list_role_policies/builders.rs"));
}
