...
pub mod _list_role_policies_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/list_role_policies/_list_role_policies_input.rs"
    ));
}
...
pub mod _list_role_policies_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/list_role_policies/_list_role_policies_output.rs"
    ));
}
