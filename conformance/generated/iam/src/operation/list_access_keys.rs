// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output {
            pub access_key_metadata: ::std::option::Option<super::super::types::AccessKeyMetadataListType>,
        ...
        impl Output {
            pub fn access_key_metadata(&self) -> &[super::super::types::AccessKeyMetadata] { self.access_key_metadata.as_deref().unwrap_or(&[]) }
            pub fn is_truncated(&self) -> ::std::option::Option<bool> { self.is_truncated }
            pub fn marker(&self) -> ::std::option::Option<&str> { self.marker.as_deref() }
        }
        pub type ListAccessKeysInput = Input;
        pub type ListAccessKeysOutput = Output;
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::ListAccessKeysOutput, super::ListAccessKeysError> {
                         let path = "/";
                         ...
                         Ok(super::ListAccessKeysOutput::default())
                     }
                 }
}
