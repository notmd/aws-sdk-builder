...
impl DeletePolicyInput {
    ...
    pub fn builder() -> super::operation::delete_policy::builders::DeletePolicyInputBuilder {
        super::operation::delete_policy::builders::DeletePolicyInputBuilder::default()
    }
}
...
impl DeletePolicyInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::delete_policy::DeletePolicyInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::delete_policy::DeletePolicyInput { policy_arn: self.policy_arn })
    }
}
