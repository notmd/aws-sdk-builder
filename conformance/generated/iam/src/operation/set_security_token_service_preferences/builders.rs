...
pub use super::operation::set_security_token_service_preferences::_set_security_token_service_preferences_input::SetSecurityTokenServicePreferencesInputBuilder;

pub use super::operation::set_security_token_service_preferences::_set_security_token_service_preferences_output::SetSecurityTokenServicePreferencesOutputBuilder;

impl super::operation::set_security_token_service_preferences::builders::SetSecurityTokenServicePreferencesInputBuilder {
...
pub struct SetSecurityTokenServicePreferencesFluentBuilder {
    ...
    inner: super::operation::set_security_token_service_preferences::builders::SetSecurityTokenServicePreferencesInputBuilder,
...
impl SetSecurityTokenServicePreferencesFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::set_security_token_service_preferences::builders::SetSecurityTokenServicePreferencesInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::set_security_token_service_preferences::SetSecurityTokenServicePreferences::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::set_security_token_service_preferences::SetSecurityTokenServicePreferences::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn global_endpoint_token_version(mut self, input: super::types::GlobalEndpointTokenVersion) -> Self {
        self.inner = self.inner.global_endpoint_token_version(input);
        self
    }
    /// <p>The version of the global endpoint token. Version 1 tokens are valid only in Amazon Web Services Regions that are available by default. These tokens do not work in manually enabled Regions, such as Asia Pacific (Hong Kong). Version 2 tokens are valid in all Regions. However, version 2 tokens are longer and might affect systems where you temporarily store tokens.</p>
    /// <p>For information, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp_enable-regions.html">Activating and deactivating STS in an Amazon Web Services Region</a> in the <i>IAM User Guide</i>.</p>
    pub fn set_global_endpoint_token_version(mut self, input: ::std::option::Option<super::types::GlobalEndpointTokenVersion>) -> Self {
        self.inner = self.inner.set_global_endpoint_token_version(input);
        self
    }
    /// <p>The version of the global endpoint token. Version 1 tokens are valid only in Amazon Web Services Regions that are available by default. These tokens do not work in manually enabled Regions, such as Asia Pacific (Hong Kong). Version 2 tokens are valid in all Regions. However, version 2 tokens are longer and might affect systems where you temporarily store tokens.</p>
    /// <p>For information, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp_enable-regions.html">Activating and deactivating STS in an Amazon Web Services Region</a> in the <i>IAM User Guide</i>.</p>
    pub fn get_global_endpoint_token_version(&self) -> &::std::option::Option<super::types::GlobalEndpointTokenVersion> {
