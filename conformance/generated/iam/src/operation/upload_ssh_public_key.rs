...
impl UploadSshPublicKey {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::upload_ssh_public_key::UploadSshPublicKeyInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::upload_ssh_public_key::UploadSSHPublicKeyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::upload_ssh_public_key::UploadSshPublicKeyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UploadSSHPublicKeyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_upload_ssh_public_key::de_upload_ssh_public_key_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_upload_ssh_public_key::de_upload_ssh_public_key_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UploadSSHPublicKeyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::upload_ssh_public_key::UploadSshPublicKeyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::upload_ssh_public_key::UploadSshPublicKeyInput,
...
impl ::aws_types::request_id::RequestId for super::operation::upload_ssh_public_key::UploadSSHPublicKeyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::upload_ssh_public_key::_upload_ssh_public_key_input::UploadSshPublicKeyInput;

pub use super::operation::upload_ssh_public_key::_upload_ssh_public_key_output::UploadSshPublicKeyOutput;
