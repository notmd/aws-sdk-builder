...
pub mod _create_instance_profile_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/create_instance_profile/_create_instance_profile_input.rs"
    ));
}
...
pub mod _create_instance_profile_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/create_instance_profile/_create_instance_profile_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/create_instance_profile/builders.rs"
    ));
}
