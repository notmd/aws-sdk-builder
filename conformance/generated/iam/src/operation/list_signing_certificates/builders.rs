...
pub struct Builder {
    input: super::_list_signing_certificates_input::ListSigningCertificatesInputBuilder,
...
impl Builder {
    ...
    pub async fn send(self) -> ::std::result::Result<super::ListSigningCertificatesOutput, super::ListSigningCertificatesError> {
        let input = self
            .input
            .build()
            .map_err(|error| super::ListSigningCertificatesError::Unhandled(error.to_string()))?;
        let path = "/";
        ...
        let response = self
            ...
            .await
            .map_err(super::ListSigningCertificatesError::Unhandled)?;
        let status = response.status();
        if !status.is_success() {
            return Err(super::ListSigningCertificatesError::unhandled_with_request_ids(
                format!("ListSigningCertificates returned HTTP {}", status),
