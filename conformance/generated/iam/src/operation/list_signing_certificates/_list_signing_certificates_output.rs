...
impl ListSigningCertificatesOutputBuilder {
    ...
    pub fn set_certificates(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::SigningCertificate>>) -> Self { self.certificates = input; self }
    /// <p>A list of the user's signing certificate information.</p>
    pub fn get_certificates(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::SigningCertificate>> { &self.certificates }
    /// <p>A flag that indicates whether there are more items to return. If your results were truncated, you can make a subsequent pagination request using the <code>Marker</code> request parameter to retrieve more items. Note that IAM might return fewer than the <code>MaxItems</code> number of results even when there are more results available. We recommend that you check <code>IsTruncated</code> after every call to ensure that you receive all your results.</p>
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_signing_certificates::ListSigningCertificatesOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::list_signing_certificates::ListSigningCertificatesOutput {
            certificates: self.certificates.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("certificates", "certificates was not specified but it is required when building ListSigningCertificatesOutput"))?,
