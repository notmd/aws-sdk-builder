...
/// Paginator for [`ListSigningCertificates`](crate::operation::list_signing_certificates::ListSigningCertificates)
pub struct ListSigningCertificatesPaginator {
    handle: std::sync::Arc<super::client::Handle>,
    builder: super::operation::list_signing_certificates::builders::ListSigningCertificatesInputBuilder,
...
impl ListSigningCertificatesPaginator {
    ...
    pub fn items(self) -> super::operation::list_signing_certificates::paginator::ListSigningCertificatesPaginatorItems {
        super::operation::list_signing_certificates::paginator::ListSigningCertificatesPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            super::operation::list_signing_certificates::ListSigningCertificates::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_list_signing_certificates_output_output_marker(resp);
...
impl ListSigningCertificatesPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::types::SigningCertificate,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::operation::list_signing_certificates::ListSigningCertificatesError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::lens::lens_list_signing_certificates_output_output_certificates(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
