...
impl ListSigningCertificatesInput {
    pub fn builder() -> ListSigningCertificatesInputBuilder { ListSigningCertificatesInputBuilder::default() }
}
#[derive(Clone, Debug, Default)]
...
impl ListSigningCertificatesInputBuilder {
    ...
    pub fn build(self) -> ListSigningCertificatesInput { ListSigningCertificatesInput {
        marker: self.marker,
