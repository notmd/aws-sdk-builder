...
impl CreateAccessKey {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::create_access_key::CreateAccessKeyInput,
    ) -> ::std::result::Result<
        super::operation::create_access_key::CreateAccessKeyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::create_access_key::CreateAccessKeyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::create_access_key::CreateAccessKeyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::create_access_key::CreateAccessKeyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateAccessKeyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_create_access_key::de_create_access_key_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_create_access_key::de_create_access_key_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateAccessKeyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::create_access_key::CreateAccessKeyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::create_access_key::CreateAccessKeyInput,
...
impl ::aws_types::request_id::RequestId for super::operation::create_access_key::CreateAccessKeyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::create_access_key::_create_access_key_input::CreateAccessKeyInput;

pub use super::operation::create_access_key::_create_access_key_output::CreateAccessKeyOutput;
