// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output {
            pub access_key: ::std::option::Option<super::super::types::AccessKey>,
        }
        impl Output {
            pub fn access_key(&self) -> ::std::option::Option<&super::super::types::AccessKey> { self.access_key.as_ref() }
        }
        pub type CreateAccessKeyInput = Input;
        pub type CreateAccessKeyOutput = Output;
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::CreateAccessKeyOutput, super::CreateAccessKeyError> {
                         ...
                         let response = self.client.request(super::super::super::transport::Method::Post, &path, &headers, &body).await.map_err(super::CreateAccessKeyError::Unhandled)?;
