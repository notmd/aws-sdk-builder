...
impl DeleteUserPolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::delete_user_policy::DeleteUserPolicyInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_user_policy::DeleteUserPolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_user_policy::DeleteUserPolicyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteUserPolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_user_policy::de_delete_user_policy_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_user_policy::de_delete_user_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteUserPolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_user_policy::DeleteUserPolicyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_user_policy::DeleteUserPolicyInput,
...
impl ::aws_types::request_id::RequestId for super::operation::delete_user_policy::DeleteUserPolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_user_policy::_delete_user_policy_input::DeleteUserPolicyInput;

pub use super::operation::delete_user_policy::_delete_user_policy_output::DeleteUserPolicyOutput;
