...
pub mod _delete_user_policy_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/delete_user_policy/_delete_user_policy_input.rs"
    ));
}
...
pub mod _delete_user_policy_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/delete_user_policy/_delete_user_policy_output.rs"
    ));
}
