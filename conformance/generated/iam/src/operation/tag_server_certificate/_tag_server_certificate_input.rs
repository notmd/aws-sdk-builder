...
impl TagServerCertificateInput {
    ...
    pub fn builder() -> super::operation::tag_server_certificate::builders::TagServerCertificateInputBuilder {
        super::operation::tag_server_certificate::builders::TagServerCertificateInputBuilder::default()
    }
}
...
impl TagServerCertificateInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::tag_server_certificate::TagServerCertificateInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::tag_server_certificate::TagServerCertificateInput {
