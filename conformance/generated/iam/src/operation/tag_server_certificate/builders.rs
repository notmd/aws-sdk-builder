...
pub struct Builder {
    input: super::_tag_server_certificate_input::TagServerCertificateInputBuilder,
...
impl Builder {
    ...
    pub async fn send(self) -> ::std::result::Result<super::TagServerCertificateOutput, super::TagServerCertificateError> {
        let input = self
            .input
            .build()
            .map_err(|error| super::TagServerCertificateError::Unhandled(error.to_string()))?;
        let path = "/";
        ...
        let response = self
            ...
            .await
            .map_err(super::TagServerCertificateError::Unhandled)?;
        let status = response.status();
        if !status.is_success() {
            return Err(super::TagServerCertificateError::unhandled_with_request_ids(
                format!("TagServerCertificate returned HTTP {}", status),
