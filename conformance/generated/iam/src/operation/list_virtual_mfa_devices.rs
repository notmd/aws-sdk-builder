...
impl ListVirtualMfaDevices {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::list_virtual_mfa_devices::ListVirtualMfaDevicesInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_virtual_mfa_devices::ListVirtualMFADevicesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_virtual_mfa_devices::ListVirtualMfaDevicesOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListVirtualMFADevicesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_virtual_mfa_devices::de_list_virtual_mfa_devices_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_virtual_mfa_devices::de_list_virtual_mfa_devices_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListVirtualMFADevicesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_virtual_mfa_devices::ListVirtualMfaDevicesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_virtual_mfa_devices::ListVirtualMfaDevicesInput,
...
impl ::aws_types::request_id::RequestId for super::operation::list_virtual_mfa_devices::ListVirtualMFADevicesError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_virtual_mfa_devices::_list_virtual_mfa_devices_input::ListVirtualMfaDevicesInput;

pub use super::operation::list_virtual_mfa_devices::_list_virtual_mfa_devices_output::ListVirtualMfaDevicesOutput;
