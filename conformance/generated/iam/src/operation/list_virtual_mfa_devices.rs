...
pub mod _list_virtual_mfa_devices_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/list_virtual_mfa_devices/_list_virtual_mfa_devices_input.rs"
    ));
}
...
pub mod _list_virtual_mfa_devices_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/list_virtual_mfa_devices/_list_virtual_mfa_devices_output.rs"
    ));
}
