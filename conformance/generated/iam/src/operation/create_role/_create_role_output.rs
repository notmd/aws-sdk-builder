...
impl CreateRoleOutput {
    ...
    pub fn builder() -> super::operation::create_role::builders::CreateRoleOutputBuilder {
        super::operation::create_role::builders::CreateRoleOutputBuilder::default()
    }
}
...
impl CreateRoleOutputBuilder {
    ...
    pub fn build(self) -> super::operation::create_role::CreateRoleOutput {
