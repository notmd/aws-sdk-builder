...
pub mod _update_server_certificate_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/update_server_certificate/_update_server_certificate_input.rs"
    ));
}
...
pub mod _update_server_certificate_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/update_server_certificate/_update_server_certificate_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/update_server_certificate/builders.rs"
    ));
}
