...
impl CreateRole {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::create_role::CreateRoleInput,
    ) -> ::std::result::Result<
        super::operation::create_role::CreateRoleOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::create_role::CreateRoleError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::create_role::CreateRoleError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::create_role::CreateRoleOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateRoleResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_create_role::de_create_role_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_create_role::de_create_role_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateRoleRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::create_role::CreateRoleInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::create_role::CreateRoleInput,
...
impl ::aws_types::request_id::RequestId for super::operation::create_role::CreateRoleError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::create_role::_create_role_input::CreateRoleInput;

pub use super::operation::create_role::_create_role_output::CreateRoleOutput;
