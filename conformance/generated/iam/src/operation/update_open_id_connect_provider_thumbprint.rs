...
pub mod _update_open_id_connect_provider_thumbprint_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/update_open_id_connect_provider_thumbprint/_update_open_id_connect_provider_thumbprint_input.rs"
    ));
}
...
pub mod _update_open_id_connect_provider_thumbprint_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/update_open_id_connect_provider_thumbprint/_update_open_id_connect_provider_thumbprint_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/update_open_id_connect_provider_thumbprint/builders.rs"
    ));
}
