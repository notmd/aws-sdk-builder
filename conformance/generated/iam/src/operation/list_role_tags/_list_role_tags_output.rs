...
impl ListRoleTagsOutput {
    ...
    pub fn builder() -> super::operation::list_role_tags::builders::ListRoleTagsOutputBuilder {
        super::operation::list_role_tags::builders::ListRoleTagsOutputBuilder::default()
    }
}
...
impl ListRoleTagsOutputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_role_tags::ListRoleTagsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_role_tags::ListRoleTagsOutput {
