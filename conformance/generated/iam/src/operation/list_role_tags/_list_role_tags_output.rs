...
impl ListRoleTagsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_role_tags::ListRoleTagsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::list_role_tags::ListRoleTagsOutput {
            tags: self.tags.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("tags", "tags was not specified but it is required when building ListRoleTagsOutput"))?,
