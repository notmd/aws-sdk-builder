    ...
    pub fn build(self) -> super::Input { self.input }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::ListRoleTagsOutput, super::ListRoleTagsError> {
                         ...
                         if !status.is_success() {
                             return Err(super::ListRoleTagsError::unhandled_with_request_ids(format!("ListRoleTags returned HTTP {}", status), response.header("x-amzn-requestid").map(str::to_owned), ::std::option::Option::None));
                         }
