    ...
    pub fn build(self) -> super::Input { self.input }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::UpdateAccessKeyOutput, super::UpdateAccessKeyError> {
                         ...
                         if !status.is_success() {
                             return Err(super::UpdateAccessKeyError::unhandled_with_request_ids(format!("UpdateAccessKey returned HTTP {}", status), response.header("x-amzn-requestid").map(str::to_owned), ::std::option::Option::None));
                         }
