...
impl UpdateAccessKeyInput {
    ...
    pub fn builder() -> super::operation::update_access_key::builders::UpdateAccessKeyInputBuilder {
        super::operation::update_access_key::builders::UpdateAccessKeyInputBuilder::default()
    }
}
...
impl UpdateAccessKeyInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::update_access_key::UpdateAccessKeyInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::update_access_key::UpdateAccessKeyInput {
