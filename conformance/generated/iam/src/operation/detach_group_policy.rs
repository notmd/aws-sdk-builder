...
pub mod _detach_group_policy_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/detach_group_policy/_detach_group_policy_input.rs"));
}
pub use _detach_group_policy_input::DetachGroupPolicyInput;
pub type Input = DetachGroupPolicyInput;
pub mod _detach_group_policy_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/detach_group_policy/_detach_group_policy_output.rs"));
}
pub use _detach_group_policy_output::DetachGroupPolicyOutput;
pub type Output = DetachGroupPolicyOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/detach_group_policy/builders.rs"));
}
