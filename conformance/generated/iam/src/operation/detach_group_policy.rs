...
impl DetachGroupPolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::detach_group_policy::DetachGroupPolicyInput,
    ) -> ::std::result::Result<
        super::operation::detach_group_policy::DetachGroupPolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::detach_group_policy::DetachGroupPolicyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::detach_group_policy::DetachGroupPolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::detach_group_policy::DetachGroupPolicyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DetachGroupPolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_detach_group_policy::de_detach_group_policy_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_detach_group_policy::de_detach_group_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DetachGroupPolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::detach_group_policy::DetachGroupPolicyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::detach_group_policy::DetachGroupPolicyInput,
...
impl ::aws_types::request_id::RequestId for super::operation::detach_group_policy::DetachGroupPolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::detach_group_policy::_detach_group_policy_input::DetachGroupPolicyInput;

pub use super::operation::detach_group_policy::_detach_group_policy_output::DetachGroupPolicyOutput;
