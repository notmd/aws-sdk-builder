...
pub mod _detach_group_policy_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/detach_group_policy/_detach_group_policy_input.rs"
    ));
}
...
pub mod _detach_group_policy_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/detach_group_policy/_detach_group_policy_output.rs"
    ));
}
