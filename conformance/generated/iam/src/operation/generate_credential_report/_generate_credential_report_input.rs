...
impl GenerateCredentialReportInput {
    ...
    pub fn builder() -> super::operation::generate_credential_report::builders::GenerateCredentialReportInputBuilder {
        super::operation::generate_credential_report::builders::GenerateCredentialReportInputBuilder::default()
    }
}
...
impl GenerateCredentialReportInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::generate_credential_report::GenerateCredentialReportInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::generate_credential_report::GenerateCredentialReportInput {})
    }
}
