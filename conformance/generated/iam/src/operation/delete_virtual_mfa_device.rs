...
pub mod _delete_virtual_mfa_device_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/delete_virtual_mfa_device/_delete_virtual_mfa_device_input.rs"
    ));
}
...
pub mod _delete_virtual_mfa_device_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/delete_virtual_mfa_device/_delete_virtual_mfa_device_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/delete_virtual_mfa_device/builders.rs"
    ));
}
