...
impl DeleteVirtualMfaDevice {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::delete_virtual_mfa_device::DeleteVirtualMfaDeviceInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_virtual_mfa_device::DeleteVirtualMFADeviceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_virtual_mfa_device::DeleteVirtualMfaDeviceOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteVirtualMFADeviceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_virtual_mfa_device::de_delete_virtual_mfa_device_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_virtual_mfa_device::de_delete_virtual_mfa_device_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteVirtualMFADeviceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_virtual_mfa_device::DeleteVirtualMfaDeviceInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_virtual_mfa_device::DeleteVirtualMfaDeviceInput,
...
impl ::aws_types::request_id::RequestId for super::operation::delete_virtual_mfa_device::DeleteVirtualMFADeviceError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_virtual_mfa_device::_delete_virtual_mfa_device_input::DeleteVirtualMfaDeviceInput;

pub use super::operation::delete_virtual_mfa_device::_delete_virtual_mfa_device_output::DeleteVirtualMfaDeviceOutput;
