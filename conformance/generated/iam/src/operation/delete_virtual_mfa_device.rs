// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        impl DeleteVirtualMfaDevice { pub fn new() -> Self { Self } }
        #[derive(Clone, Debug, Default)]
        pub struct Input {
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output;
        pub type DeleteVirtualMfaDeviceInput = Input;
        pub type DeleteVirtualMfaDeviceOutput = Output;
        pub type DeleteVirtualMfaDeviceError = Error;
        #[derive(Clone, Debug)]
        pub enum Error {
...
pub use builders::Builder;
        pub type DeleteVirtualMfaDeviceFluentBuilder = builders::Builder;
