...
pub mod _delete_virtual_mfa_device_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/delete_virtual_mfa_device/_delete_virtual_mfa_device_input.rs"));
}
pub use _delete_virtual_mfa_device_input::DeleteVirtualMfaDeviceInput;
pub type Input = DeleteVirtualMfaDeviceInput;
pub mod _delete_virtual_mfa_device_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/delete_virtual_mfa_device/_delete_virtual_mfa_device_output.rs"));
}
pub use _delete_virtual_mfa_device_output::DeleteVirtualMfaDeviceOutput;
pub type Output = DeleteVirtualMfaDeviceOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/delete_virtual_mfa_device/builders.rs"));
}
