...
impl TagRole {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::tag_role::TagRoleInput,
    ) -> ::std::result::Result<
    ...
    > {
        let map_err =
            |err: ::aws_smithy_runtime_api::client::result::SdkError<
                ...
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >| { err.map_service_error(|err| err.downcast::<super::operation::tag_role::TagRoleError>().expect("correct error type")) };
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::tag_role::TagRoleOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for TagRoleResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_tag_role::de_tag_role_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_tag_role::de_tag_role_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for TagRoleRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::tag_role::TagRoleInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::tag_role::TagRoleInput,
...
impl ::aws_types::request_id::RequestId for super::operation::tag_role::TagRoleError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::tag_role::_tag_role_input::TagRoleInput;

pub use super::operation::tag_role::_tag_role_output::TagRoleOutput;
