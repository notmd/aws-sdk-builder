...
pub struct Builder {
    input: super::_list_user_tags_input::ListUserTagsInputBuilder,
...
impl Builder {
    ...
    pub async fn send(self) -> ::std::result::Result<super::ListUserTagsOutput, super::ListUserTagsError> {
        let input = self
            .input
            .build()
            .map_err(|error| super::ListUserTagsError::Unhandled(error.to_string()))?;
        let path = "/";
        ...
        let response = self
            ...
            .await
            .map_err(super::ListUserTagsError::Unhandled)?;
        let status = response.status();
        if !status.is_success() {
            return Err(super::ListUserTagsError::unhandled_with_request_ids(
                format!("ListUserTags returned HTTP {}", status),
