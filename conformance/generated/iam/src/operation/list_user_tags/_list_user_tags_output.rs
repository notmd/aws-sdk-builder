...
impl ListUserTagsOutput {
    ...
    pub fn builder() -> super::operation::list_user_tags::builders::ListUserTagsOutputBuilder {
        super::operation::list_user_tags::builders::ListUserTagsOutputBuilder::default()
    }
}
...
impl ListUserTagsOutputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_user_tags::ListUserTagsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_user_tags::ListUserTagsOutput {
