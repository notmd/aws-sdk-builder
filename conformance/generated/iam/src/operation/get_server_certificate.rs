...
impl GetServerCertificate {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::get_server_certificate::GetServerCertificateInput,
    ) -> ::std::result::Result<
        super::operation::get_server_certificate::GetServerCertificateOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::get_server_certificate::GetServerCertificateError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_server_certificate::GetServerCertificateError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_server_certificate::GetServerCertificateOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetServerCertificateResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_server_certificate::de_get_server_certificate_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_server_certificate::de_get_server_certificate_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetServerCertificateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_server_certificate::GetServerCertificateInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_server_certificate::GetServerCertificateInput,
...
impl ::aws_types::request_id::RequestId for super::operation::get_server_certificate::GetServerCertificateError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_server_certificate::_get_server_certificate_input::GetServerCertificateInput;

pub use super::operation::get_server_certificate::_get_server_certificate_output::GetServerCertificateOutput;
