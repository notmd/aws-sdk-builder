// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output {
            pub server_certificate: ::std::option::Option<super::super::types::ServerCertificate>,
        }
        impl Output {
            pub fn server_certificate(&self) -> ::std::option::Option<&super::super::types::ServerCertificate> { self.server_certificate.as_ref() }
        }
        pub type GetServerCertificateInput = Input;
        pub type GetServerCertificateOutput = Output;
