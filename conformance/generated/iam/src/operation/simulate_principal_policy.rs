...
impl SimulatePrincipalPolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::simulate_principal_policy::SimulatePrincipalPolicyInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::simulate_principal_policy::SimulatePrincipalPolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::simulate_principal_policy::SimulatePrincipalPolicyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SimulatePrincipalPolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_simulate_principal_policy::de_simulate_principal_policy_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_simulate_principal_policy::de_simulate_principal_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SimulatePrincipalPolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::simulate_principal_policy::SimulatePrincipalPolicyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::simulate_principal_policy::SimulatePrincipalPolicyInput,
...
impl ::aws_types::request_id::RequestId for super::operation::simulate_principal_policy::SimulatePrincipalPolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::simulate_principal_policy::_simulate_principal_policy_input::SimulatePrincipalPolicyInput;

pub use super::operation::simulate_principal_policy::_simulate_principal_policy_output::SimulatePrincipalPolicyOutput;
