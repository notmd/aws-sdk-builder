...
pub mod _list_saml_provider_tags_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/list_saml_provider_tags/_list_saml_provider_tags_input.rs"
    ));
}
...
pub mod _list_saml_provider_tags_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/list_saml_provider_tags/_list_saml_provider_tags_output.rs"
    ));
}
