...
impl ListSamlProviderTags {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::list_saml_provider_tags::ListSamlProviderTagsInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_saml_provider_tags::ListSAMLProviderTagsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_saml_provider_tags::ListSamlProviderTagsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListSAMLProviderTagsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_saml_provider_tags::de_list_saml_provider_tags_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_saml_provider_tags::de_list_saml_provider_tags_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListSAMLProviderTagsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_saml_provider_tags::ListSamlProviderTagsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_saml_provider_tags::ListSamlProviderTagsInput,
...
impl ::aws_types::request_id::RequestId for super::operation::list_saml_provider_tags::ListSAMLProviderTagsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_saml_provider_tags::_list_saml_provider_tags_input::ListSamlProviderTagsInput;

pub use super::operation::list_saml_provider_tags::_list_saml_provider_tags_output::ListSamlProviderTagsOutput;
