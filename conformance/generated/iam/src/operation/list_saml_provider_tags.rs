...
pub mod _list_saml_provider_tags_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/list_saml_provider_tags/_list_saml_provider_tags_input.rs"));
}
pub use _list_saml_provider_tags_input::ListSamlProviderTagsInput;
pub type Input = ListSamlProviderTagsInput;
pub mod _list_saml_provider_tags_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/list_saml_provider_tags/_list_saml_provider_tags_output.rs"));
}
pub use _list_saml_provider_tags_output::ListSamlProviderTagsOutput;
pub type Output = ListSamlProviderTagsOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/list_saml_provider_tags/builders.rs"));
}
