// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        impl ListSamlProviderTags { pub fn new() -> Self { Self } }
        #[derive(Clone, Debug, Default)]
        pub struct Input {
        ...
        pub type ListSamlProviderTagsInput = Input;
        pub type ListSamlProviderTagsOutput = Output;
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::ListSamlProviderTagsOutput, super::ListSamlProviderTagsError> {
                         let path = "/";
                         let body = ::std::vec::Vec::new();
                         let headers = ::std::vec::Vec::new();
                         let response = self.client.request(super::super::super::transport::Method::Post, &path, &headers, &body).await.map_err(super::ListSamlProviderTagsError::Unhandled)?;
                         let status = response.status();
                         if !status.is_success() {
                             return Err(super::ListSamlProviderTagsError::Unhandled(format!("ListSamlProviderTags returned HTTP {}", status)));
                         }
                         Ok(super::ListSamlProviderTagsOutput::default())
                     }
                 }
}
