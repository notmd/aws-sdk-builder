...
pub use super::operation::remove_role_from_instance_profile::_remove_role_from_instance_profile_input::RemoveRoleFromInstanceProfileInputBuilder;

pub use super::operation::remove_role_from_instance_profile::_remove_role_from_instance_profile_output::RemoveRoleFromInstanceProfileOutputBuilder;

impl super::operation::remove_role_from_instance_profile::builders::RemoveRoleFromInstanceProfileInputBuilder {
...
///
/// <p>Removes the specified IAM role from the specified Amazon EC2 instance profile.</p><important>
...
pub struct RemoveRoleFromInstanceProfileFluentBuilder {
    ...
    inner: super::operation::remove_role_from_instance_profile::builders::RemoveRoleFromInstanceProfileInputBuilder,
...
impl
    super::client::customize::internal::CustomizableSend<
        super::operation::remove_role_from_instance_profile::RemoveRoleFromInstanceProfileOutput,
        super::operation::remove_role_from_instance_profile::RemoveRoleFromInstanceProfileError,
    > for RemoveRoleFromInstanceProfileFluentBuilder
{
    fn send(
        self,
...
impl RemoveRoleFromInstanceProfileFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::remove_role_from_instance_profile::builders::RemoveRoleFromInstanceProfileInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::remove_role_from_instance_profile::RemoveRoleFromInstanceProfile::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::remove_role_from_instance_profile::RemoveRoleFromInstanceProfile::orchestrate(&runtime_plugins, input).await
    }
