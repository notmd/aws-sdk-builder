...
pub mod _reset_service_specific_credential_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/reset_service_specific_credential/_reset_service_specific_credential_input.rs"));
}
pub use _reset_service_specific_credential_input::ResetServiceSpecificCredentialInput;
pub type Input = ResetServiceSpecificCredentialInput;
pub mod _reset_service_specific_credential_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/reset_service_specific_credential/_reset_service_specific_credential_output.rs"));
}
pub use _reset_service_specific_credential_output::ResetServiceSpecificCredentialOutput;
pub type Output = ResetServiceSpecificCredentialOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/reset_service_specific_credential/builders.rs"));
}
