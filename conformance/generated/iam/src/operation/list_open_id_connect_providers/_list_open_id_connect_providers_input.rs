...
impl ListOpenIdConnectProvidersInput {
    ...
    pub fn builder() -> super::operation::list_open_id_connect_providers::builders::ListOpenIdConnectProvidersInputBuilder {
        super::operation::list_open_id_connect_providers::builders::ListOpenIdConnectProvidersInputBuilder::default()
    }
}
...
impl ListOpenIdConnectProvidersInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::list_open_id_connect_providers::ListOpenIdConnectProvidersInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::list_open_id_connect_providers::ListOpenIdConnectProvidersInput {})
    }
}
