...
impl GetRolePolicyOutput {
    ...
    pub fn builder() -> super::operation::get_role_policy::builders::GetRolePolicyOutputBuilder {
        super::operation::get_role_policy::builders::GetRolePolicyOutputBuilder::default()
    }
}
...
impl GetRolePolicyOutputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_role_policy::GetRolePolicyOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_role_policy::GetRolePolicyOutput {
