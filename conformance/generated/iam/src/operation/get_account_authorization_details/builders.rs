...
pub use super::operation::get_account_authorization_details::_get_account_authorization_details_input::GetAccountAuthorizationDetailsInputBuilder;

pub use super::operation::get_account_authorization_details::_get_account_authorization_details_output::GetAccountAuthorizationDetailsOutputBuilder;

impl super::operation::get_account_authorization_details::builders::GetAccountAuthorizationDetailsInputBuilder {
...
pub struct GetAccountAuthorizationDetailsFluentBuilder {
    ...
    inner: super::operation::get_account_authorization_details::builders::GetAccountAuthorizationDetailsInputBuilder,
...
impl GetAccountAuthorizationDetailsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::get_account_authorization_details::builders::GetAccountAuthorizationDetailsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::get_account_authorization_details::GetAccountAuthorizationDetails::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::get_account_authorization_details::GetAccountAuthorizationDetails::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::operation::get_account_authorization_details::paginator::GetAccountAuthorizationDetailsPaginator {
        super::operation::get_account_authorization_details::paginator::GetAccountAuthorizationDetailsPaginator::new(self.handle, self.inner)
    }
    ///
    ...
    pub fn filter(mut self, input: super::types::EntityType) -> Self {
        self.inner = self.inner.filter(input);
        self
    }
    /// <p>A list of entity types used to filter the results. Only the entities that match the types you specify are included in the output. Use the value <code>LocalManagedPolicy</code> to include customer managed policies.</p>
    /// <p>The format for this parameter is a comma-separated (if more than one) list of strings. Each string value in the list must be one of the valid values listed below.</p>
    pub fn set_filter(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::EntityType>>) -> Self {
        self.inner = self.inner.set_filter(input);
        self
    }
    /// <p>A list of entity types used to filter the results. Only the entities that match the types you specify are included in the output. Use the value <code>LocalManagedPolicy</code> to include customer managed policies.</p>
    /// <p>The format for this parameter is a comma-separated (if more than one) list of strings. Each string value in the list must be one of the valid values listed below.</p>
    pub fn get_filter(&self) -> &::std::option::Option<::std::vec::Vec<super::types::EntityType>> {
