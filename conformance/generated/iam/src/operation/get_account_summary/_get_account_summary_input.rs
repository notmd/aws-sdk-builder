...
impl GetAccountSummaryInput {
    ...
    pub fn builder() -> super::operation::get_account_summary::builders::GetAccountSummaryInputBuilder {
        super::operation::get_account_summary::builders::GetAccountSummaryInputBuilder::default()
    }
}
...
impl GetAccountSummaryInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_account_summary::GetAccountSummaryInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_account_summary::GetAccountSummaryInput {})
    }
}
