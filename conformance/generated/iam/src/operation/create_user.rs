...
pub mod _create_user_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/create_user/_create_user_input.rs"));
}
pub use _create_user_input::CreateUserInput;
pub type Input = CreateUserInput;
pub mod _create_user_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/create_user/_create_user_output.rs"));
}
pub use _create_user_output::CreateUserOutput;
pub type Output = CreateUserOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/create_user/builders.rs"));
}
