...
impl CreateUser {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::create_user::CreateUserInput,
    ) -> ::std::result::Result<
        super::operation::create_user::CreateUserOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::create_user::CreateUserError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::create_user::CreateUserError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::create_user::CreateUserOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateUserResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_create_user::de_create_user_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_create_user::de_create_user_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateUserRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::create_user::CreateUserInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::create_user::CreateUserInput,
...
impl ::aws_types::request_id::RequestId for super::operation::create_user::CreateUserError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::create_user::_create_user_input::CreateUserInput;

pub use super::operation::create_user::_create_user_output::CreateUserOutput;
