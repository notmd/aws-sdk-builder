...
impl ListUserTags {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::list_user_tags::ListUserTagsInput,
    ) -> ::std::result::Result<
        super::operation::list_user_tags::ListUserTagsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::list_user_tags::ListUserTagsError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_user_tags::ListUserTagsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_user_tags::ListUserTagsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListUserTagsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_user_tags::de_list_user_tags_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_user_tags::de_list_user_tags_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListUserTagsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_user_tags::ListUserTagsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_user_tags::ListUserTagsInput,
...
impl ::aws_types::request_id::RequestId for super::operation::list_user_tags::ListUserTagsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_user_tags::_list_user_tags_input::ListUserTagsInput;

pub use super::operation::list_user_tags::_list_user_tags_output::ListUserTagsOutput;
