...
impl DeleteUserPolicyInput {
    ...
    pub fn builder() -> super::operation::delete_user_policy::builders::DeleteUserPolicyInputBuilder {
        super::operation::delete_user_policy::builders::DeleteUserPolicyInputBuilder::default()
    }
}
...
impl DeleteUserPolicyInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::delete_user_policy::DeleteUserPolicyInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::delete_user_policy::DeleteUserPolicyInput {
