...
pub struct Builder {
    input: super::_delete_user_policy_input::DeleteUserPolicyInputBuilder,
...
impl Builder {
    ...
    pub async fn send(self) -> ::std::result::Result<super::DeleteUserPolicyOutput, super::DeleteUserPolicyError> {
        let input = self
            .input
            .build()
            .map_err(|error| super::DeleteUserPolicyError::Unhandled(error.to_string()))?;
        let path = "/";
        ...
        let response = self
            ...
            .await
            .map_err(super::DeleteUserPolicyError::Unhandled)?;
        let status = response.status();
        if !status.is_success() {
            return Err(super::DeleteUserPolicyError::unhandled_with_request_ids(
                format!("DeleteUserPolicy returned HTTP {}", status),
