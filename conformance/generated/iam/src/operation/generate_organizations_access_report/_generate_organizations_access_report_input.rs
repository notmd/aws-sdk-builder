...
impl GenerateOrganizationsAccessReportInputBuilder {
    ...
    pub fn set_organizations_policy_id(mut self, input: ::std::option::Option<::std::string::String>) -> Self { self.organizations_policy_id = input; self }
    /// <p>The identifier of the Organizations service control policy (SCP). This parameter is optional.</p>
    /// <p>This ID is used to generate information about when an account principal that is limited by the SCP attempted to access an Amazon Web Services service.</p>
    pub fn get_organizations_policy_id(&self) -> &::std::option::Option<::std::string::String> { &self.organizations_policy_id }
    ...
    pub fn build(self) -> crate::operation::generate_organizations_access_report::GenerateOrganizationsAccessReportInput {
