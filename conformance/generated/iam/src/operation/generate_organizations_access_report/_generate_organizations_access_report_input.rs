...
impl GenerateOrganizationsAccessReportInput {
    ...
    pub fn builder() -> super::operation::generate_organizations_access_report::builders::GenerateOrganizationsAccessReportInputBuilder {
        super::operation::generate_organizations_access_report::builders::GenerateOrganizationsAccessReportInputBuilder::default()
    }
}
...
impl GenerateOrganizationsAccessReportInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::generate_organizations_access_report::GenerateOrganizationsAccessReportInput,
