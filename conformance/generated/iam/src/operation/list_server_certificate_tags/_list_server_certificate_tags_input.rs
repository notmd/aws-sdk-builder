...
impl ListServerCertificateTagsInput {
    pub fn builder() -> ListServerCertificateTagsInputBuilder { ListServerCertificateTagsInputBuilder::default() }
}
#[derive(Clone, Debug, Default)]
...
impl ListServerCertificateTagsInputBuilder {
    ...
    pub fn build(self) -> ListServerCertificateTagsInput { ListServerCertificateTagsInput {
        marker: self.marker,
