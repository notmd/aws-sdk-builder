...
impl ListServerCertificateTagsOutput {
    ...
    pub fn builder() -> super::operation::list_server_certificate_tags::builders::ListServerCertificateTagsOutputBuilder {
        super::operation::list_server_certificate_tags::builders::ListServerCertificateTagsOutputBuilder::default()
    }
}
...
impl ListServerCertificateTagsOutputBuilder {
    ...
    > {
        ::std::result::Result::Ok(super::operation::list_server_certificate_tags::ListServerCertificateTagsOutput {
