...
pub mod _get_ssh_public_key_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/get_ssh_public_key/_get_ssh_public_key_input.rs"
    ));
}
...
pub mod _get_ssh_public_key_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/get_ssh_public_key/_get_ssh_public_key_output.rs"
    ));
}
