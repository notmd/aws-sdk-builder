...
impl UntagRole {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::untag_role::UntagRoleInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::untag_role::UntagRoleError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::untag_role::UntagRoleOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UntagRoleResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_untag_role::de_untag_role_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_untag_role::de_untag_role_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UntagRoleRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::untag_role::UntagRoleInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::untag_role::UntagRoleInput,
...
impl ::aws_types::request_id::RequestId for super::operation::untag_role::UntagRoleError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::untag_role::_untag_role_input::UntagRoleInput;

pub use super::operation::untag_role::_untag_role_output::UntagRoleOutput;
