...
pub mod _untag_role_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/untag_role/_untag_role_input.rs"));
}
pub use _untag_role_input::UntagRoleInput;
pub type Input = UntagRoleInput;
pub mod _untag_role_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/untag_role/_untag_role_output.rs"));
}
pub use _untag_role_output::UntagRoleOutput;
pub type Output = UntagRoleOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/untag_role/builders.rs"));
}
