...
impl GetServerCertificateInput {
    ...
    pub fn builder() -> super::operation::get_server_certificate::builders::GetServerCertificateInputBuilder {
        super::operation::get_server_certificate::builders::GetServerCertificateInputBuilder::default()
    }
}
...
impl GetServerCertificateInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_server_certificate::GetServerCertificateInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::get_server_certificate::GetServerCertificateInput {
