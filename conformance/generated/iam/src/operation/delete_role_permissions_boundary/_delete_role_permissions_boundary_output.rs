...
impl DeleteRolePermissionsBoundaryOutput {
    ...
    pub fn builder() -> super::operation::delete_role_permissions_boundary::builders::DeleteRolePermissionsBoundaryOutputBuilder {
        super::operation::delete_role_permissions_boundary::builders::DeleteRolePermissionsBoundaryOutputBuilder::default()
    }
}
...
impl DeleteRolePermissionsBoundaryOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_role_permissions_boundary::DeleteRolePermissionsBoundaryOutput {
