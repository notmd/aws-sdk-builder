// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        pub type GetUserInput = Input;
        pub type GetUserOutput = Output;
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::GetUserOutput, super::GetUserError> {
                         let path = "/";
                         ...
                         Ok(super::GetUserOutput::default())
                     }
                 }
}
