...
impl TagUser {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::tag_user::TagUserInput,
    ) -> ::std::result::Result<
    ...
    > {
        let map_err =
            |err: ::aws_smithy_runtime_api::client::result::SdkError<
                ...
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >| { err.map_service_error(|err| err.downcast::<super::operation::tag_user::TagUserError>().expect("correct error type")) };
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::tag_user::TagUserOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for TagUserResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_tag_user::de_tag_user_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_tag_user::de_tag_user_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for TagUserRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::tag_user::TagUserInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::tag_user::TagUserInput,
...
impl ::aws_types::request_id::RequestId for super::operation::tag_user::TagUserError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::tag_user::_tag_user_input::TagUserInput;

pub use super::operation::tag_user::_tag_user_output::TagUserOutput;
