...
pub mod _tag_user_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/tag_user/_tag_user_input.rs"));
}
pub use _tag_user_input::TagUserInput;
pub type Input = TagUserInput;
pub mod _tag_user_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/tag_user/_tag_user_output.rs"));
}
pub use _tag_user_output::TagUserOutput;
pub type Output = TagUserOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/tag_user/builders.rs"));
}
