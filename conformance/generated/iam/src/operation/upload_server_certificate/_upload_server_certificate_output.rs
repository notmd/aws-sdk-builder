...
impl UploadServerCertificateOutput {
    ...
    pub fn builder() -> super::operation::upload_server_certificate::builders::UploadServerCertificateOutputBuilder {
        super::operation::upload_server_certificate::builders::UploadServerCertificateOutputBuilder::default()
    }
}
...
impl UploadServerCertificateOutputBuilder {
    ...
    pub fn build(self) -> super::operation::upload_server_certificate::UploadServerCertificateOutput {
