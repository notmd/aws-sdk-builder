// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output;
        pub type DeleteLoginProfileInput = Input;
        pub type DeleteLoginProfileOutput = Output;
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::DeleteLoginProfileOutput, super::DeleteLoginProfileError> {
                         let path = "/";
