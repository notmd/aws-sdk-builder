...
pub mod _delete_login_profile_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/delete_login_profile/_delete_login_profile_input.rs"
    ));
}
...
pub mod _delete_login_profile_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/delete_login_profile/_delete_login_profile_output.rs"
    ));
}
