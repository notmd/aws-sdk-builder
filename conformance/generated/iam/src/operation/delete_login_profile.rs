...
impl DeleteLoginProfile {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::delete_login_profile::DeleteLoginProfileInput,
    ) -> ::std::result::Result<
        super::operation::delete_login_profile::DeleteLoginProfileOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::delete_login_profile::DeleteLoginProfileError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_login_profile::DeleteLoginProfileError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_login_profile::DeleteLoginProfileOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteLoginProfileResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_login_profile::de_delete_login_profile_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_login_profile::de_delete_login_profile_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteLoginProfileRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_login_profile::DeleteLoginProfileInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_login_profile::DeleteLoginProfileInput,
...
impl ::aws_types::request_id::RequestId for super::operation::delete_login_profile::DeleteLoginProfileError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_login_profile::_delete_login_profile_input::DeleteLoginProfileInput;

pub use super::operation::delete_login_profile::_delete_login_profile_output::DeleteLoginProfileOutput;
