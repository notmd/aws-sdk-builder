...
pub mod _set_default_policy_version_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/set_default_policy_version/_set_default_policy_version_input.rs"
    ));
}
...
pub mod _set_default_policy_version_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/set_default_policy_version/_set_default_policy_version_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/set_default_policy_version/builders.rs"
    ));
}
