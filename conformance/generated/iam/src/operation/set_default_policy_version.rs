...
impl SetDefaultPolicyVersion {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::set_default_policy_version::SetDefaultPolicyVersionInput,
    ) -> ::std::result::Result<
        super::operation::set_default_policy_version::SetDefaultPolicyVersionOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::set_default_policy_version::SetDefaultPolicyVersionError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::set_default_policy_version::SetDefaultPolicyVersionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::set_default_policy_version::SetDefaultPolicyVersionOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetDefaultPolicyVersionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_set_default_policy_version::de_set_default_policy_version_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_set_default_policy_version::de_set_default_policy_version_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetDefaultPolicyVersionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::set_default_policy_version::SetDefaultPolicyVersionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::set_default_policy_version::SetDefaultPolicyVersionInput,
...
impl ::aws_types::request_id::RequestId for super::operation::set_default_policy_version::SetDefaultPolicyVersionError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::set_default_policy_version::_set_default_policy_version_input::SetDefaultPolicyVersionInput;

pub use super::operation::set_default_policy_version::_set_default_policy_version_output::SetDefaultPolicyVersionOutput;
