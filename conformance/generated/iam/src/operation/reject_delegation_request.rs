...
pub mod _reject_delegation_request_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/reject_delegation_request/_reject_delegation_request_input.rs"));
}
pub use _reject_delegation_request_input::RejectDelegationRequestInput;
pub type Input = RejectDelegationRequestInput;
pub mod _reject_delegation_request_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/reject_delegation_request/_reject_delegation_request_output.rs"));
}
pub use _reject_delegation_request_output::RejectDelegationRequestOutput;
pub type Output = RejectDelegationRequestOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/reject_delegation_request/builders.rs"));
}
