...
pub use super::operation::untag_role::_untag_role_input::UntagRoleInputBuilder;

pub use super::operation::untag_role::_untag_role_output::UntagRoleOutputBuilder;

impl super::operation::untag_role::builders::UntagRoleInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::untag_role::UntagRoleError,
...
pub struct UntagRoleFluentBuilder {
    ...
    inner: super::operation::untag_role::builders::UntagRoleInputBuilder,
    config_override: ::std::option::Option<super::config::Builder>,
}
impl super::client::customize::internal::CustomizableSend<super::operation::untag_role::UntagRoleOutput, super::operation::untag_role::UntagRoleError>
    for UntagRoleFluentBuilder
{
    fn send(
        ...
        super::client::customize::internal::SendResult<super::operation::untag_role::UntagRoleOutput, super::operation::untag_role::UntagRoleError>,
    > {
        ::std::boxed::Box::pin(async move { self.config_override(config_override).send().await })
    }
}
impl UntagRoleFluentBuilder {
    /// Creates a new `UntagRoleFluentBuilder`.
    ...
    pub fn as_input(&self) -> &super::operation::untag_role::builders::UntagRoleInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::untag_role::UntagRole::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::untag_role::UntagRole::orchestrate(&runtime_plugins, input).await
    }
