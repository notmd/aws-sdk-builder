...
impl GetAccessKeyLastUsedInput {
    ...
    pub fn builder() -> super::operation::get_access_key_last_used::builders::GetAccessKeyLastUsedInputBuilder {
        super::operation::get_access_key_last_used::builders::GetAccessKeyLastUsedInputBuilder::default()
    }
}
...
impl GetAccessKeyLastUsedInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_access_key_last_used::GetAccessKeyLastUsedInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::get_access_key_last_used::GetAccessKeyLastUsedInput {
