...
impl EnableMfaDeviceInput {
    ...
    pub fn builder() -> super::operation::enable_mfa_device::builders::EnableMfaDeviceInputBuilder {
        super::operation::enable_mfa_device::builders::EnableMfaDeviceInputBuilder::default()
    }
}
...
impl EnableMfaDeviceInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::enable_mfa_device::EnableMfaDeviceInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::enable_mfa_device::EnableMfaDeviceInput {
