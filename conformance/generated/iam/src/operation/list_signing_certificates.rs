...
pub mod _list_signing_certificates_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/list_signing_certificates/_list_signing_certificates_input.rs"
    ));
}
...
pub mod _list_signing_certificates_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/list_signing_certificates/_list_signing_certificates_output.rs"
    ));
}
