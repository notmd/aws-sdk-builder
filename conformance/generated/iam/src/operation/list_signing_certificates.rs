// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output {
            pub certificates: ::std::option::Option<super::super::types::CertificateListType>,
        ...
        impl Output {
            pub fn certificates(&self) -> &[super::super::types::SigningCertificate] { self.certificates.as_deref().unwrap_or(&[]) }
            pub fn is_truncated(&self) -> ::std::option::Option<bool> { self.is_truncated }
            pub fn marker(&self) -> ::std::option::Option<&str> { self.marker.as_deref() }
        }
        pub type ListSigningCertificatesInput = Input;
        pub type ListSigningCertificatesOutput = Output;
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::ListSigningCertificatesOutput, super::ListSigningCertificatesError> {
                         let path = "/";
                         let body = ::std::vec::Vec::new();
                         let headers = ::std::vec::Vec::new();
                         let response = self.client.request(super::super::super::transport::Method::Post, &path, &headers, &body).await.map_err(super::ListSigningCertificatesError::Unhandled)?;
                         let status = response.status();
                         if !status.is_success() {
                             return Err(super::ListSigningCertificatesError::Unhandled(format!("ListSigningCertificates returned HTTP {}", status)));
                         }
                         Ok(super::ListSigningCertificatesOutput::default())
                     }
                 }
}
