    ...
    pub fn build(self) -> super::Input { self.input }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::CreateServiceSpecificCredentialOutput, super::CreateServiceSpecificCredentialError> {
                         ...
                         if !status.is_success() {
                             return Err(super::CreateServiceSpecificCredentialError::unhandled_with_request_ids(format!("CreateServiceSpecificCredential returned HTTP {}", status), response.header("x-amzn-requestid").map(str::to_owned), ::std::option::Option::None));
                         }
