...
impl ListMfaDeviceTagsOutput {
    ...
    pub fn builder() -> super::operation::list_mfa_device_tags::builders::ListMfaDeviceTagsOutputBuilder {
        super::operation::list_mfa_device_tags::builders::ListMfaDeviceTagsOutputBuilder::default()
    }
}
...
impl ListMfaDeviceTagsOutputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_mfa_device_tags::ListMfaDeviceTagsOutput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::list_mfa_device_tags::ListMfaDeviceTagsOutput {
