...
impl ListMfaDeviceTagsInput {
    ...
    pub fn builder() -> super::operation::list_mfa_device_tags::builders::ListMfaDeviceTagsInputBuilder {
        super::operation::list_mfa_device_tags::builders::ListMfaDeviceTagsInputBuilder::default()
    }
}
...
impl ListMfaDeviceTagsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_mfa_device_tags::ListMfaDeviceTagsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_mfa_device_tags::ListMfaDeviceTagsInput {
