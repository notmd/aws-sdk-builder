...
pub use super::operation::list_mfa_device_tags::_list_mfa_device_tags_input::ListMfaDeviceTagsInputBuilder;

pub use super::operation::list_mfa_device_tags::_list_mfa_device_tags_output::ListMfaDeviceTagsOutputBuilder;

impl super::operation::list_mfa_device_tags::builders::ListMfaDeviceTagsInputBuilder {
...
impl ListMfaDeviceTagsFluentBuilder {
    ...
    pub fn into_paginator(self) -> super::operation::list_mfa_device_tags::paginator::ListMfaDeviceTagsPaginator {
        super::operation::list_mfa_device_tags::paginator::ListMfaDeviceTagsPaginator::new(self.handle, self.inner)
    }
