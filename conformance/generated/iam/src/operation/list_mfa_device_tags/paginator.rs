...
pub struct ListMfaDeviceTagsPaginator {
    ...
    builder: super::operation::list_mfa_device_tags::builders::ListMfaDeviceTagsInputBuilder,
...
impl ListMfaDeviceTagsPaginator {
    ...
    pub fn items(self) -> super::operation::list_mfa_device_tags::paginator::ListMfaDeviceTagsPaginatorItems {
        super::operation::list_mfa_device_tags::paginator::ListMfaDeviceTagsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::operation::list_mfa_device_tags::ListMFADeviceTags::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_list_mfa_device_tags_output_output_marker(resp);
...
impl ListMfaDeviceTagsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::lens::lens_list_mfa_device_tags_output_output_tags(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
