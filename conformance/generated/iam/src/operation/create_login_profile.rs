...
pub mod _create_login_profile_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/create_login_profile/_create_login_profile_input.rs"
    ));
}
...
pub mod _create_login_profile_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/create_login_profile/_create_login_profile_output.rs"
    ));
}
