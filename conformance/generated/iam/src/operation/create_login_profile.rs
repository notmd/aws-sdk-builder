...
impl CreateLoginProfile {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::create_login_profile::CreateLoginProfileInput,
    ) -> ::std::result::Result<
        super::operation::create_login_profile::CreateLoginProfileOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::create_login_profile::CreateLoginProfileError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::create_login_profile::CreateLoginProfileError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::create_login_profile::CreateLoginProfileOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateLoginProfileResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_create_login_profile::de_create_login_profile_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_create_login_profile::de_create_login_profile_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateLoginProfileRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::create_login_profile::CreateLoginProfileInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::create_login_profile::CreateLoginProfileInput,
...
impl ::aws_types::request_id::RequestId for super::operation::create_login_profile::CreateLoginProfileError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::create_login_profile::_create_login_profile_input::CreateLoginProfileInput;

pub use super::operation::create_login_profile::_create_login_profile_output::CreateLoginProfileOutput;
