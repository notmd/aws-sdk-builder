...
impl GetLoginProfile {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::get_login_profile::GetLoginProfileInput,
    ) -> ::std::result::Result<
        super::operation::get_login_profile::GetLoginProfileOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::get_login_profile::GetLoginProfileError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_login_profile::GetLoginProfileError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_login_profile::GetLoginProfileOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetLoginProfileResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_login_profile::de_get_login_profile_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_login_profile::de_get_login_profile_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetLoginProfileRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_login_profile::GetLoginProfileInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_login_profile::GetLoginProfileInput,
...
impl ::aws_types::request_id::RequestId for super::operation::get_login_profile::GetLoginProfileError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_login_profile::_get_login_profile_input::GetLoginProfileInput;

pub use super::operation::get_login_profile::_get_login_profile_output::GetLoginProfileOutput;
