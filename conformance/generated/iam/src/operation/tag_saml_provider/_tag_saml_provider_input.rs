...
impl TagSamlProviderInput {
    ...
    pub fn builder() -> super::operation::tag_saml_provider::builders::TagSamlProviderInputBuilder {
        super::operation::tag_saml_provider::builders::TagSamlProviderInputBuilder::default()
    }
}
...
impl TagSamlProviderInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::tag_saml_provider::TagSamlProviderInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::tag_saml_provider::TagSamlProviderInput {
