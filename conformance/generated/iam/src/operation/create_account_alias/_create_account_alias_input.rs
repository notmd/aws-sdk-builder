...
impl CreateAccountAliasInput {
    ...
    pub fn builder() -> super::operation::create_account_alias::builders::CreateAccountAliasInputBuilder {
        super::operation::create_account_alias::builders::CreateAccountAliasInputBuilder::default()
    }
}
...
impl CreateAccountAliasInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::create_account_alias::CreateAccountAliasInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::create_account_alias::CreateAccountAliasInput {
