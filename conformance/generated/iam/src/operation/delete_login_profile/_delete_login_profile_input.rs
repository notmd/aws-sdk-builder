...
impl DeleteLoginProfileInputBuilder {
    ...
    pub fn build(self) -> crate::operation::delete_login_profile::DeleteLoginProfileInput {
        crate::operation::delete_login_profile::DeleteLoginProfileInput { user_name: self.user_name }
    }
}
