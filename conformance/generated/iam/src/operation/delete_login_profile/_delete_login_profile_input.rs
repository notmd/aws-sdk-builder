...
impl DeleteLoginProfileInput {
    ...
    pub fn builder() -> super::operation::delete_login_profile::builders::DeleteLoginProfileInputBuilder {
        super::operation::delete_login_profile::builders::DeleteLoginProfileInputBuilder::default()
    }
}
...
impl DeleteLoginProfileInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::delete_login_profile::DeleteLoginProfileInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::delete_login_profile::DeleteLoginProfileInput { user_name: self.user_name })
    }
}
