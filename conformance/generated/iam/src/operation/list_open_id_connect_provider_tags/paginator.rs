...
pub struct ListOpenIdConnectProviderTagsPaginator {
    ...
    builder: super::operation::list_open_id_connect_provider_tags::builders::ListOpenIdConnectProviderTagsInputBuilder,
...
impl ListOpenIdConnectProviderTagsPaginator {
    ...
    pub fn items(self) -> super::operation::list_open_id_connect_provider_tags::paginator::ListOpenIdConnectProviderTagsPaginatorItems {
        super::operation::list_open_id_connect_provider_tags::paginator::ListOpenIdConnectProviderTagsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::operation::list_open_id_connect_provider_tags::ListOpenIDConnectProviderTags::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_list_open_id_connect_provider_tags_output_output_marker(resp);
...
impl ListOpenIdConnectProviderTagsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::lens::lens_list_open_id_connect_provider_tags_output_output_tags(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
