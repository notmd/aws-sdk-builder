...
impl ListOpenIdConnectProviderTagsOutput {
    ...
    pub fn builder() -> super::operation::list_open_id_connect_provider_tags::builders::ListOpenIdConnectProviderTagsOutputBuilder {
        super::operation::list_open_id_connect_provider_tags::builders::ListOpenIdConnectProviderTagsOutputBuilder::default()
    }
}
