...
impl ListOpenIdConnectProviderTagsOutputBuilder {
    ...
    /// - [`tags`](Self::tags)
    pub fn build(self) -> ::std::result::Result<crate::operation::list_open_id_connect_provider_tags::ListOpenIdConnectProviderTagsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::list_open_id_connect_provider_tags::ListOpenIdConnectProviderTagsOutput {
            tags: self.tags.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("tags", "tags was not specified but it is required when building ListOpenIdConnectProviderTagsOutput"))?,
