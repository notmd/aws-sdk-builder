...
impl ListOpenIdConnectProviderTagsInput {
    ...
    pub fn builder() -> super::operation::list_open_id_connect_provider_tags::builders::ListOpenIdConnectProviderTagsInputBuilder {
        super::operation::list_open_id_connect_provider_tags::builders::ListOpenIdConnectProviderTagsInputBuilder::default()
    }
}
...
impl ListOpenIdConnectProviderTagsInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::list_open_id_connect_provider_tags::ListOpenIdConnectProviderTagsInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::list_open_id_connect_provider_tags::ListOpenIdConnectProviderTagsInput {
