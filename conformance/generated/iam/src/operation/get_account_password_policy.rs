...
pub mod _get_account_password_policy_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/get_account_password_policy/_get_account_password_policy_input.rs"
    ));
}
...
pub mod _get_account_password_policy_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/get_account_password_policy/_get_account_password_policy_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/get_account_password_policy/builders.rs"
    ));
}
