// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        pub type ListGroupPoliciesInput = Input;
        pub type ListGroupPoliciesOutput = Output;
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::ListGroupPoliciesOutput, super::ListGroupPoliciesError> {
                         ...
                         let response = self.client.request(super::super::super::transport::Method::Post, &path, &headers, &body).await.map_err(super::ListGroupPoliciesError::Unhandled)?;
                         let status = response.status();
                         if !status.is_success() {
                             return Err(super::ListGroupPoliciesError::Unhandled(format!("ListGroupPolicies returned HTTP {}", status)));
                         }
                         Ok(super::ListGroupPoliciesOutput::default())
                     }
                 }
}
