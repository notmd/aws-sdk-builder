    ...
    pub fn build(self) -> super::Input { self.input }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::ListDelegationRequestsOutput, super::ListDelegationRequestsError> {
                         ...
                         if !status.is_success() {
                             return Err(super::ListDelegationRequestsError::unhandled_with_request_ids(format!("ListDelegationRequests returned HTTP {}", status), response.header("x-amzn-requestid").map(str::to_owned), ::std::option::Option::None));
                         }
