...
impl ResyncMfaDevice {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::resync_mfa_device::ResyncMfaDeviceInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::resync_mfa_device::ResyncMFADeviceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::resync_mfa_device::ResyncMfaDeviceOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ResyncMFADeviceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_resync_mfa_device::de_resync_mfa_device_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_resync_mfa_device::de_resync_mfa_device_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ResyncMFADeviceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::resync_mfa_device::ResyncMfaDeviceInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::resync_mfa_device::ResyncMfaDeviceInput,
...
impl ::aws_types::request_id::RequestId for super::operation::resync_mfa_device::ResyncMFADeviceError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::resync_mfa_device::_resync_mfa_device_input::ResyncMfaDeviceInput;

pub use super::operation::resync_mfa_device::_resync_mfa_device_output::ResyncMfaDeviceOutput;
