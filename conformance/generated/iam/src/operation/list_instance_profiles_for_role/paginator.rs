...
/// Paginator for [`ListInstanceProfilesForRole`](crate::operation::list_instance_profiles_for_role::ListInstanceProfilesForRole)
pub struct ListInstanceProfilesForRolePaginator {
    handle: std::sync::Arc<super::client::Handle>,
    builder: super::operation::list_instance_profiles_for_role::builders::ListInstanceProfilesForRoleInputBuilder,
...
impl ListInstanceProfilesForRolePaginator {
    ...
    pub fn items(self) -> super::operation::list_instance_profiles_for_role::paginator::ListInstanceProfilesForRolePaginatorItems {
        super::operation::list_instance_profiles_for_role::paginator::ListInstanceProfilesForRolePaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::operation::list_instance_profiles_for_role::ListInstanceProfilesForRole::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_list_instance_profiles_for_role_output_output_marker(resp);
...
impl ListInstanceProfilesForRolePaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::lens::lens_list_instance_profiles_for_role_output_output_instance_profiles(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
