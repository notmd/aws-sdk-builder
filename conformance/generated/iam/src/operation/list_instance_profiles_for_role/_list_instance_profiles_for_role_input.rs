...
impl ListInstanceProfilesForRoleInput {
    pub fn builder() -> ListInstanceProfilesForRoleInputBuilder { ListInstanceProfilesForRoleInputBuilder::default() }
}
#[derive(Clone, Debug, Default)]
...
impl ListInstanceProfilesForRoleInputBuilder {
    ...
    pub fn build(self) -> ListInstanceProfilesForRoleInput { ListInstanceProfilesForRoleInput {
        marker: self.marker,
