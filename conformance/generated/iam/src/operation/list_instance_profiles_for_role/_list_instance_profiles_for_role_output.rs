...
impl ListInstanceProfilesForRoleOutputBuilder {
    ...
    pub fn set_instance_profiles(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::InstanceProfile>>) -> Self { self.instance_profiles = input; self }
    /// <p>A list of instance profiles.</p>
    pub fn get_instance_profiles(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::InstanceProfile>> { &self.instance_profiles }
    /// <p>A flag that indicates whether there are more items to return. If your results were truncated, you can make a subsequent pagination request using the <code>Marker</code> request parameter to retrieve more items. Note that IAM might return fewer than the <code>MaxItems</code> number of results even when there are more results available. We recommend that you check <code>IsTruncated</code> after every call to ensure that you receive all your results.</p>
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_instance_profiles_for_role::ListInstanceProfilesForRoleOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::list_instance_profiles_for_role::ListInstanceProfilesForRoleOutput {
            instance_profiles: self.instance_profiles.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("instance_profiles", "instance_profiles was not specified but it is required when building ListInstanceProfilesForRoleOutput"))?,
