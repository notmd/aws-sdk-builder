...
impl ListInstanceProfilesForRoleOutput {
    pub fn builder() -> ListInstanceProfilesForRoleOutputBuilder { ListInstanceProfilesForRoleOutputBuilder::default() }
}
#[derive(Clone, Debug, Default)]
...
impl ListInstanceProfilesForRoleOutputBuilder {
    ...
    pub fn build(self) -> ListInstanceProfilesForRoleOutput { ListInstanceProfilesForRoleOutput {
