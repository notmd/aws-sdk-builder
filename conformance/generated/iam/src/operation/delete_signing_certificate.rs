// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        impl DeleteSigningCertificate { pub fn new() -> Self { Self } }
        #[derive(Clone, Debug, Default)]
        pub struct Input {
            pub certificate_id: ::std::option::Option<super::super::types::CertificateIdType>,
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output;
        pub type DeleteSigningCertificateInput = Input;
        pub type DeleteSigningCertificateOutput = Output;
        pub type DeleteSigningCertificateError = Error;
        #[derive(Clone, Debug)]
        pub enum Error {
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::DeleteSigningCertificateOutput, super::DeleteSigningCertificateError> {
                         let path = "/";
                         let body = ::std::vec::Vec::new();
                         let headers = ::std::vec::Vec::new();
                         let response = self.client.request(super::super::super::transport::Method::Post, &path, &headers, &body).await.map_err(super::DeleteSigningCertificateError::Unhandled)?;
...
pub use builders::Builder;
        pub type DeleteSigningCertificateFluentBuilder = builders::Builder;
