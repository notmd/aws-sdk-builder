...
pub mod _delete_signing_certificate_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/delete_signing_certificate/_delete_signing_certificate_input.rs"
    ));
}
...
pub mod _delete_signing_certificate_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/delete_signing_certificate/_delete_signing_certificate_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/delete_signing_certificate/builders.rs"
    ));
}
