...
impl DeleteGroupPolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::delete_group_policy::DeleteGroupPolicyInput,
    ) -> ::std::result::Result<
        super::operation::delete_group_policy::DeleteGroupPolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::delete_group_policy::DeleteGroupPolicyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_group_policy::DeleteGroupPolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_group_policy::DeleteGroupPolicyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteGroupPolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_group_policy::de_delete_group_policy_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_group_policy::de_delete_group_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteGroupPolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_group_policy::DeleteGroupPolicyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_group_policy::DeleteGroupPolicyInput,
...
impl ::aws_types::request_id::RequestId for super::operation::delete_group_policy::DeleteGroupPolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_group_policy::_delete_group_policy_input::DeleteGroupPolicyInput;

pub use super::operation::delete_group_policy::_delete_group_policy_output::DeleteGroupPolicyOutput;
