...
pub struct Builder {
    input: super::_put_role_permissions_boundary_input::PutRolePermissionsBoundaryInputBuilder,
...
impl Builder {
    ...
    pub async fn send(self) -> ::std::result::Result<super::PutRolePermissionsBoundaryOutput, super::PutRolePermissionsBoundaryError> {
        let input = self
            .input
            .build()
            .map_err(|error| super::PutRolePermissionsBoundaryError::Unhandled(error.to_string()))?;
        let path = "/";
        ...
        let response = self
            ...
            .await
            .map_err(super::PutRolePermissionsBoundaryError::Unhandled)?;
        let status = response.status();
        if !status.is_success() {
            return Err(super::PutRolePermissionsBoundaryError::unhandled_with_request_ids(
                format!("PutRolePermissionsBoundary returned HTTP {}", status),
