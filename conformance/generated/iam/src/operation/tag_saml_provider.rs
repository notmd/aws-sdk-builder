// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        impl TagSamlProvider { pub fn new() -> Self { Self } }
        #[derive(Clone, Debug, Default)]
        pub struct Input {
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output;
        pub type TagSamlProviderInput = Input;
        pub type TagSamlProviderOutput = Output;
        pub type TagSamlProviderError = Error;
        #[derive(Clone, Debug)]
        pub enum Error {
...
pub use builders::Builder;
        pub type TagSamlProviderFluentBuilder = builders::Builder;
