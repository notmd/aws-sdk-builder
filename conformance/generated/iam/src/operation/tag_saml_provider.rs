...
pub mod _tag_saml_provider_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/tag_saml_provider/_tag_saml_provider_input.rs"));
}
pub use _tag_saml_provider_input::TagSamlProviderInput;
pub type Input = TagSamlProviderInput;
pub mod _tag_saml_provider_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/tag_saml_provider/_tag_saml_provider_output.rs"));
}
pub use _tag_saml_provider_output::TagSamlProviderOutput;
pub type Output = TagSamlProviderOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/tag_saml_provider/builders.rs"));
}
