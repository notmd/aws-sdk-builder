...
impl ListOpenIdConnectProviderTags {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::list_open_id_connect_provider_tags::ListOpenIdConnectProviderTagsInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_open_id_connect_provider_tags::ListOpenIDConnectProviderTagsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_open_id_connect_provider_tags::ListOpenIdConnectProviderTagsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListOpenIDConnectProviderTagsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_open_id_connect_provider_tags::de_list_open_id_connect_provider_tags_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_open_id_connect_provider_tags::de_list_open_id_connect_provider_tags_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListOpenIDConnectProviderTagsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_open_id_connect_provider_tags::ListOpenIdConnectProviderTagsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_open_id_connect_provider_tags::ListOpenIdConnectProviderTagsInput,
...
impl ::aws_types::request_id::RequestId for super::operation::list_open_id_connect_provider_tags::ListOpenIDConnectProviderTagsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_open_id_connect_provider_tags::_list_open_id_connect_provider_tags_input::ListOpenIdConnectProviderTagsInput;

pub use super::operation::list_open_id_connect_provider_tags::_list_open_id_connect_provider_tags_output::ListOpenIdConnectProviderTagsOutput;
