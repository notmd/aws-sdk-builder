// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        impl ListOpenIdConnectProviderTags { pub fn new() -> Self { Self } }
        #[derive(Clone, Debug, Default)]
        pub struct Input {
        ...
        pub type ListOpenIdConnectProviderTagsInput = Input;
        pub type ListOpenIdConnectProviderTagsOutput = Output;
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::ListOpenIdConnectProviderTagsOutput, super::ListOpenIdConnectProviderTagsError> {
                         let path = "/";
                         let body = ::std::vec::Vec::new();
                         let headers = ::std::vec::Vec::new();
                         let response = self.client.request(super::super::super::transport::Method::Post, &path, &headers, &body).await.map_err(super::ListOpenIdConnectProviderTagsError::Unhandled)?;
                         let status = response.status();
                         if !status.is_success() {
                             return Err(super::ListOpenIdConnectProviderTagsError::Unhandled(format!("ListOpenIdConnectProviderTags returned HTTP {}", status)));
                         }
                         Ok(super::ListOpenIdConnectProviderTagsOutput::default())
                     }
                 }
}
