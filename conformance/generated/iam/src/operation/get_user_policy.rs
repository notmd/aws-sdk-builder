...
impl GetUserPolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::get_user_policy::GetUserPolicyInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_user_policy::GetUserPolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_user_policy::GetUserPolicyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetUserPolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_user_policy::de_get_user_policy_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_user_policy::de_get_user_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetUserPolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_user_policy::GetUserPolicyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_user_policy::GetUserPolicyInput,
...
impl ::aws_types::request_id::RequestId for super::operation::get_user_policy::GetUserPolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_user_policy::_get_user_policy_input::GetUserPolicyInput;

pub use super::operation::get_user_policy::_get_user_policy_output::GetUserPolicyOutput;
