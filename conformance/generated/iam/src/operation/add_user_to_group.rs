...
impl AddUserToGroup {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::add_user_to_group::AddUserToGroupInput,
    ) -> ::std::result::Result<
        super::operation::add_user_to_group::AddUserToGroupOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::add_user_to_group::AddUserToGroupError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::add_user_to_group::AddUserToGroupError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::add_user_to_group::AddUserToGroupOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AddUserToGroupResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_add_user_to_group::de_add_user_to_group_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_add_user_to_group::de_add_user_to_group_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AddUserToGroupRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::add_user_to_group::AddUserToGroupInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::add_user_to_group::AddUserToGroupInput,
...
impl ::aws_types::request_id::RequestId for super::operation::add_user_to_group::AddUserToGroupError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::add_user_to_group::_add_user_to_group_input::AddUserToGroupInput;

pub use super::operation::add_user_to_group::_add_user_to_group_output::AddUserToGroupOutput;
