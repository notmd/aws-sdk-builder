// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        pub struct GetRole;
        impl GetRole { pub fn new() -> Self { Self } }
        #[derive(Clone, Debug, Default)]
        pub struct Input {
        ...
        pub type GetRoleInput = Input;
        pub type GetRoleOutput = Output;
        pub type GetRoleError = Error;
        #[derive(Clone, Debug)]
        pub enum Error {
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::GetRoleOutput, super::GetRoleError> {
                         let path = "/";
                         let body = ::std::vec::Vec::new();
                         let headers = ::std::vec::Vec::new();
                         let response = self.client.request(super::super::super::transport::Method::Post, &path, &headers, &body).await.map_err(super::GetRoleError::Unhandled)?;
                         let status = response.status();
                         if !status.is_success() {
                             return Err(super::GetRoleError::Unhandled(format!("GetRole returned HTTP {}", status)));
                         }
                         Ok(super::GetRoleOutput::default())
                     }
                 }
}
pub use builders::Builder;
        pub type GetRoleFluentBuilder = builders::Builder;
