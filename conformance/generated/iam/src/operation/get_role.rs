...
pub mod _get_role_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/get_role/_get_role_input.rs"));
}
pub use _get_role_input::GetRoleInput;
pub type Input = GetRoleInput;
pub mod _get_role_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/get_role/_get_role_output.rs"));
}
pub use _get_role_output::GetRoleOutput;
pub type Output = GetRoleOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/get_role/builders.rs"));
}
