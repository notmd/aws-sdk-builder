...
impl GetRole {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::get_role::GetRoleInput,
    ) -> ::std::result::Result<
    ...
    > {
        let map_err =
            |err: ::aws_smithy_runtime_api::client::result::SdkError<
                ...
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >| { err.map_service_error(|err| err.downcast::<super::operation::get_role::GetRoleError>().expect("correct error type")) };
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_role::GetRoleOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetRoleResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_role::de_get_role_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_role::de_get_role_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetRoleRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::get_role::GetRoleInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_role::GetRoleInput,
...
impl ::aws_types::request_id::RequestId for super::operation::get_role::GetRoleError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_role::_get_role_input::GetRoleInput;

pub use super::operation::get_role::_get_role_output::GetRoleOutput;
