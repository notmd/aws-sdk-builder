...
impl AttachGroupPolicyInput {
    ...
    pub fn builder() -> super::operation::attach_group_policy::builders::AttachGroupPolicyInputBuilder {
        super::operation::attach_group_policy::builders::AttachGroupPolicyInputBuilder::default()
    }
}
...
impl AttachGroupPolicyInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::attach_group_policy::AttachGroupPolicyInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::attach_group_policy::AttachGroupPolicyInput {
