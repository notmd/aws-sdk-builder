...
impl Builder {
    ...
    pub async fn send(self) -> ::std::result::Result<super::DeleteAccessKeyOutput, super::DeleteAccessKeyError> {
        ...
        let response = self
            ...
            .await
            .map_err(super::DeleteAccessKeyError::Unhandled)?;
        let status = response.status();
        if !status.is_success() {
            return Err(super::DeleteAccessKeyError::unhandled_with_request_ids(
                format!("DeleteAccessKey returned HTTP {}", status),
