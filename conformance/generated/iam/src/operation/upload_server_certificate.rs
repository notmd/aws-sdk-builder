...
impl UploadServerCertificate {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::upload_server_certificate::UploadServerCertificateInput,
    ) -> ::std::result::Result<
        super::operation::upload_server_certificate::UploadServerCertificateOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::upload_server_certificate::UploadServerCertificateError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::upload_server_certificate::UploadServerCertificateError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::upload_server_certificate::UploadServerCertificateOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UploadServerCertificateResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_upload_server_certificate::de_upload_server_certificate_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_upload_server_certificate::de_upload_server_certificate_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UploadServerCertificateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::upload_server_certificate::UploadServerCertificateInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::upload_server_certificate::UploadServerCertificateInput,
...
impl ::aws_types::request_id::RequestId for super::operation::upload_server_certificate::UploadServerCertificateError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::upload_server_certificate::_upload_server_certificate_input::UploadServerCertificateInput;

pub use super::operation::upload_server_certificate::_upload_server_certificate_output::UploadServerCertificateOutput;
