...
impl CreateLoginProfileInput {
    ...
    pub fn builder() -> super::operation::create_login_profile::builders::CreateLoginProfileInputBuilder {
        super::operation::create_login_profile::builders::CreateLoginProfileInputBuilder::default()
    }
}
...
impl CreateLoginProfileInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::create_login_profile::CreateLoginProfileInput, ::aws_smithy_types::error::operation::BuildError>
    {
