...
pub struct SimulatePrincipalPolicyInput {
    ...
    pub policy_exclusion_list: ::std::option::Option<::std::vec::Vec<super::types::PolicyIdentifier>>,
...
impl SimulatePrincipalPolicyInput {
    ...
    pub fn policy_exclusion_list(&self) -> &[super::types::PolicyIdentifier] {
...
impl SimulatePrincipalPolicyInput {
    ...
    pub fn builder() -> super::operation::simulate_principal_policy::builders::SimulatePrincipalPolicyInputBuilder {
        super::operation::simulate_principal_policy::builders::SimulatePrincipalPolicyInputBuilder::default()
    }
}
...
pub struct SimulatePrincipalPolicyInputBuilder {
    ...
    pub(crate) policy_exclusion_list: ::std::option::Option<::std::vec::Vec<super::types::PolicyIdentifier>>,
...
impl SimulatePrincipalPolicyInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::simulate_principal_policy::SimulatePrincipalPolicyInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::simulate_principal_policy::SimulatePrincipalPolicyInput {
