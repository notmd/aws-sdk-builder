...
pub struct SimulatePrincipalPolicyPaginator {
    ...
    builder: super::operation::simulate_principal_policy::builders::SimulatePrincipalPolicyInputBuilder,
...
impl SimulatePrincipalPolicyPaginator {
    ...
    pub fn items(self) -> super::operation::simulate_principal_policy::paginator::SimulatePrincipalPolicyPaginatorItems {
        super::operation::simulate_principal_policy::paginator::SimulatePrincipalPolicyPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            super::operation::simulate_principal_policy::SimulatePrincipalPolicy::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_simulate_principal_policy_output_output_marker(resp);
...
impl SimulatePrincipalPolicyPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::lens::lens_simulate_principal_policy_output_output_evaluation_results(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
