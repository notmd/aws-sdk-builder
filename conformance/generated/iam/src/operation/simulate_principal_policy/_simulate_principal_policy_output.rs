...
impl SimulatePrincipalPolicyOutput {
    ...
    pub fn builder() -> super::operation::simulate_principal_policy::builders::SimulatePrincipalPolicyOutputBuilder {
        super::operation::simulate_principal_policy::builders::SimulatePrincipalPolicyOutputBuilder::default()
    }
}
...
impl SimulatePrincipalPolicyOutputBuilder {
    ...
    pub fn build(self) -> super::operation::simulate_principal_policy::SimulatePrincipalPolicyOutput {
