...
impl ListSshPublicKeysInput {
    ...
    pub fn builder() -> super::operation::list_ssh_public_keys::builders::ListSshPublicKeysInputBuilder {
        super::operation::list_ssh_public_keys::builders::ListSshPublicKeysInputBuilder::default()
    }
}
...
impl ListSshPublicKeysInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_ssh_public_keys::ListSshPublicKeysInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_ssh_public_keys::ListSshPublicKeysInput {
