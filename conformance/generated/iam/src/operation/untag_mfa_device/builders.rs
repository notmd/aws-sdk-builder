...
pub struct Builder {
    input: super::_untag_mfa_device_input::UntagMfaDeviceInputBuilder,
...
impl Builder {
    ...
    pub async fn send(self) -> ::std::result::Result<super::UntagMfaDeviceOutput, super::UntagMfaDeviceError> {
        let input = self
            .input
            .build()
            .map_err(|error| super::UntagMfaDeviceError::Unhandled(error.to_string()))?;
        let path = "/";
        ...
        let response = self
            ...
            .await
            .map_err(super::UntagMfaDeviceError::Unhandled)?;
        let status = response.status();
        if !status.is_success() {
            return Err(super::UntagMfaDeviceError::unhandled_with_request_ids(
                format!("UntagMfaDevice returned HTTP {}", status),
