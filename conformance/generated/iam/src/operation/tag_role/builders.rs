...
pub use super::operation::tag_role::_tag_role_input::TagRoleInputBuilder;

pub use super::operation::tag_role::_tag_role_output::TagRoleOutputBuilder;

impl super::operation::tag_role::builders::TagRoleInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::tag_role::TagRoleError,
...
pub struct TagRoleFluentBuilder {
    ...
    inner: super::operation::tag_role::builders::TagRoleInputBuilder,
    config_override: ::std::option::Option<super::config::Builder>,
}
impl super::client::customize::internal::CustomizableSend<super::operation::tag_role::TagRoleOutput, super::operation::tag_role::TagRoleError>
    for TagRoleFluentBuilder
{
    fn send(
        ...
        super::client::customize::internal::SendResult<super::operation::tag_role::TagRoleOutput, super::operation::tag_role::TagRoleError>,
    > {
        ::std::boxed::Box::pin(async move { self.config_override(config_override).send().await })
    }
}
impl TagRoleFluentBuilder {
    /// Creates a new `TagRoleFluentBuilder`.
    ...
    pub fn as_input(&self) -> &super::operation::tag_role::builders::TagRoleInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::tag_role::TagRole::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::tag_role::TagRole::orchestrate(&runtime_plugins, input).await
    }

    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
    pub fn customize(
        self,
    ) -> super::client::customize::CustomizableOperation<super::operation::tag_role::TagRoleOutput, super::operation::tag_role::TagRoleError, Self>
    {
