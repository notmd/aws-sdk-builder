...
impl RemoveClientIdFromOpenIdConnectProviderInput {
    pub fn builder() -> RemoveClientIdFromOpenIdConnectProviderInputBuilder { RemoveClientIdFromOpenIdConnectProviderInputBuilder::default() }
}
#[derive(Clone, Debug, Default)]
...
impl RemoveClientIdFromOpenIdConnectProviderInputBuilder {
    ...
    pub fn build(self) -> RemoveClientIdFromOpenIdConnectProviderInput { RemoveClientIdFromOpenIdConnectProviderInput {
