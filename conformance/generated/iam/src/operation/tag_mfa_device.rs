...
pub mod _tag_mfa_device_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/tag_mfa_device/_tag_mfa_device_input.rs"));
}
pub use _tag_mfa_device_input::TagMfaDeviceInput;
pub type Input = TagMfaDeviceInput;
pub mod _tag_mfa_device_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/tag_mfa_device/_tag_mfa_device_output.rs"));
}
pub use _tag_mfa_device_output::TagMfaDeviceOutput;
pub type Output = TagMfaDeviceOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/tag_mfa_device/builders.rs"));
}
