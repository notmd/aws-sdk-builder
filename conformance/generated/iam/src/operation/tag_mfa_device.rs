...
impl TagMfaDevice {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::tag_mfa_device::TagMfaDeviceInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::tag_mfa_device::TagMFADeviceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::tag_mfa_device::TagMfaDeviceOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for TagMFADeviceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_tag_mfa_device::de_tag_mfa_device_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_tag_mfa_device::de_tag_mfa_device_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for TagMFADeviceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::tag_mfa_device::TagMfaDeviceInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::tag_mfa_device::TagMfaDeviceInput,
...
impl ::aws_types::request_id::RequestId for super::operation::tag_mfa_device::TagMFADeviceError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::tag_mfa_device::_tag_mfa_device_input::TagMfaDeviceInput;

pub use super::operation::tag_mfa_device::_tag_mfa_device_output::TagMfaDeviceOutput;
