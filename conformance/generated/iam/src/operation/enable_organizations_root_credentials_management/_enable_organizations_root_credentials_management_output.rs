...
impl EnableOrganizationsRootCredentialsManagementOutput {
    ...
    pub fn builder(
    ) -> super::operation::enable_organizations_root_credentials_management::builders::EnableOrganizationsRootCredentialsManagementOutputBuilder {
        super::operation::enable_organizations_root_credentials_management::builders::EnableOrganizationsRootCredentialsManagementOutputBuilder::default()
    }
}
...
impl EnableOrganizationsRootCredentialsManagementOutputBuilder {
    ...
    pub fn build(self) -> super::operation::enable_organizations_root_credentials_management::EnableOrganizationsRootCredentialsManagementOutput {
