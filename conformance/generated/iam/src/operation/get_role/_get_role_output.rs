...
impl GetRoleOutput {
    ...
    pub fn builder() -> super::operation::get_role::builders::GetRoleOutputBuilder {
        super::operation::get_role::builders::GetRoleOutputBuilder::default()
    }
}
...
impl GetRoleOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_role::GetRoleOutput {
