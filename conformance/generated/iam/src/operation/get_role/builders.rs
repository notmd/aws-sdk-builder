...
pub use super::operation::get_role::_get_role_input::GetRoleInputBuilder;

pub use super::operation::get_role::_get_role_output::GetRoleOutputBuilder;

impl super::operation::get_role::builders::GetRoleInputBuilder {
...
impl super::client::customize::internal::CustomizableSend<super::operation::get_role::GetRoleOutput, super::operation::get_role::GetRoleError>
    for GetRoleFluentBuilder
{
    fn send(
        ...
        super::client::customize::internal::SendResult<super::operation::get_role::GetRoleOutput, super::operation::get_role::GetRoleError>,
    > {
...
impl GetRoleFluentBuilder {
    ...
    > {
        ...
        super::operation::get_role::GetRole::orchestrate(&runtime_plugins, input).await
    }

    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
    pub fn customize(
        self,
    ) -> super::client::customize::CustomizableOperation<super::operation::get_role::GetRoleOutput, super::operation::get_role::GetRoleError, Self>
    {
