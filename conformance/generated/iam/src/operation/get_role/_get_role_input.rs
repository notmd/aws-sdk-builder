...
impl GetRoleInput {
    ...
    pub fn builder() -> super::operation::get_role::builders::GetRoleInputBuilder {
        super::operation::get_role::builders::GetRoleInputBuilder::default()
    }
}
...
impl GetRoleInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::get_role::GetRoleInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_role::GetRoleInput { role_name: self.role_name })
    }
}
