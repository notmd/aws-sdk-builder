...
impl ListVirtualMfaDevicesOutputBuilder {
    ...
    pub fn set_virtual_mfa_devices(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::VirtualMfaDevice>>) -> Self { self.virtual_mfa_devices = input; self }
    /// <p>The list of virtual MFA devices in the current account that match the <code>AssignmentStatus</code> value that was passed in the request.</p>
    pub fn get_virtual_mfa_devices(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::VirtualMfaDevice>> { &self.virtual_mfa_devices }
    /// <p>A flag that indicates whether there are more items to return. If your results were truncated, you can make a subsequent pagination request using the <code>Marker</code> request parameter to retrieve more items. Note that IAM might return fewer than the <code>MaxItems</code> number of results even when there are more results available. We recommend that you check <code>IsTruncated</code> after every call to ensure that you receive all your results.</p>
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_virtual_mfa_devices::ListVirtualMfaDevicesOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::list_virtual_mfa_devices::ListVirtualMfaDevicesOutput {
            virtual_mfa_devices: self.virtual_mfa_devices.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("virtual_mfa_devices", "virtual_mfa_devices was not specified but it is required when building ListVirtualMfaDevicesOutput"))?,
