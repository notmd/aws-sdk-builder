...
pub use super::operation::list_virtual_mfa_devices::_list_virtual_mfa_devices_input::ListVirtualMfaDevicesInputBuilder;

pub use super::operation::list_virtual_mfa_devices::_list_virtual_mfa_devices_output::ListVirtualMfaDevicesOutputBuilder;

impl super::operation::list_virtual_mfa_devices::builders::ListVirtualMfaDevicesInputBuilder {
...
impl ListVirtualMfaDevicesFluentBuilder {
    ...
    pub fn into_paginator(self) -> super::operation::list_virtual_mfa_devices::paginator::ListVirtualMfaDevicesPaginator {
        super::operation::list_virtual_mfa_devices::paginator::ListVirtualMfaDevicesPaginator::new(self.handle, self.inner)
    }
    ...
    pub fn assignment_status(mut self, input: super::types::AssignmentStatusType) -> Self {
        self.inner = self.inner.assignment_status(input);
        self
    }
    /// <p>The status (<code>Unassigned</code> or <code>Assigned</code>) of the devices to list. If you do not specify an <code>AssignmentStatus</code>, the operation defaults to <code>Any</code>, which lists both assigned and unassigned virtual MFA devices.,</p>
    pub fn set_assignment_status(mut self, input: ::std::option::Option<super::types::AssignmentStatusType>) -> Self {
        self.inner = self.inner.set_assignment_status(input);
        self
    }
    /// <p>The status (<code>Unassigned</code> or <code>Assigned</code>) of the devices to list. If you do not specify an <code>AssignmentStatus</code>, the operation defaults to <code>Any</code>, which lists both assigned and unassigned virtual MFA devices.,</p>
    pub fn get_assignment_status(&self) -> &::std::option::Option<super::types::AssignmentStatusType> {
