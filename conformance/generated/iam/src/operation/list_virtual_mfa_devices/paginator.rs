...
pub struct ListVirtualMfaDevicesPaginator {
    ...
    builder: super::operation::list_virtual_mfa_devices::builders::ListVirtualMfaDevicesInputBuilder,
...
impl ListVirtualMfaDevicesPaginator {
    ...
    pub fn items(self) -> super::operation::list_virtual_mfa_devices::paginator::ListVirtualMfaDevicesPaginatorItems {
        super::operation::list_virtual_mfa_devices::paginator::ListVirtualMfaDevicesPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            super::operation::list_virtual_mfa_devices::ListVirtualMFADevices::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_list_virtual_mfa_devices_output_output_marker(resp);
...
impl ListVirtualMfaDevicesPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::lens::lens_list_virtual_mfa_devices_output_output_virtual_mfa_devices(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
