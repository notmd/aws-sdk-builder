...
impl DeleteSamlProvider {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::delete_saml_provider::DeleteSamlProviderInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_saml_provider::DeleteSAMLProviderError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_saml_provider::DeleteSamlProviderOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteSAMLProviderResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_saml_provider::de_delete_saml_provider_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_saml_provider::de_delete_saml_provider_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteSAMLProviderRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_saml_provider::DeleteSamlProviderInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_saml_provider::DeleteSamlProviderInput,
...
impl ::aws_types::request_id::RequestId for super::operation::delete_saml_provider::DeleteSAMLProviderError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_saml_provider::_delete_saml_provider_input::DeleteSamlProviderInput;

pub use super::operation::delete_saml_provider::_delete_saml_provider_output::DeleteSamlProviderOutput;
