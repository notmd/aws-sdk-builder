...
pub mod _delete_saml_provider_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/delete_saml_provider/_delete_saml_provider_input.rs"
    ));
}
...
pub mod _delete_saml_provider_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/delete_saml_provider/_delete_saml_provider_output.rs"
    ));
}
