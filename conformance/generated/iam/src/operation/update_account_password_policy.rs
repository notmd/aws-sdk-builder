...
impl UpdateAccountPasswordPolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::update_account_password_policy::UpdateAccountPasswordPolicyInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::update_account_password_policy::UpdateAccountPasswordPolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::update_account_password_policy::UpdateAccountPasswordPolicyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateAccountPasswordPolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_update_account_password_policy::de_update_account_password_policy_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_update_account_password_policy::de_update_account_password_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateAccountPasswordPolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::update_account_password_policy::UpdateAccountPasswordPolicyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::update_account_password_policy::UpdateAccountPasswordPolicyInput,
...
impl ::aws_types::request_id::RequestId for super::operation::update_account_password_policy::UpdateAccountPasswordPolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::update_account_password_policy::_update_account_password_policy_input::UpdateAccountPasswordPolicyInput;

pub use super::operation::update_account_password_policy::_update_account_password_policy_output::UpdateAccountPasswordPolicyOutput;
