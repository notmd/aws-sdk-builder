...
pub struct GetAccountPasswordPolicyOutput {
    ...
    pub password_policy: ::std::option::Option<super::types::PasswordPolicy>,
    _request_id: Option<String>,
}
impl GetAccountPasswordPolicyOutput {
    /// <p>A structure that contains details about the account's password policy.</p>
    pub fn password_policy(&self) -> ::std::option::Option<&super::types::PasswordPolicy> {
...
impl GetAccountPasswordPolicyOutput {
    ...
    pub fn builder() -> super::operation::get_account_password_policy::builders::GetAccountPasswordPolicyOutputBuilder {
        super::operation::get_account_password_policy::builders::GetAccountPasswordPolicyOutputBuilder::default()
    }
}
...
pub struct GetAccountPasswordPolicyOutputBuilder {
    pub(crate) password_policy: ::std::option::Option<super::types::PasswordPolicy>,
    _request_id: Option<String>,
}
impl GetAccountPasswordPolicyOutputBuilder {
    /// <p>A structure that contains details about the account's password policy.</p>
    /// This field is required.
    pub fn password_policy(mut self, input: super::types::PasswordPolicy) -> Self {
        self.password_policy = ::std::option::Option::Some(input);
        self
    }
    /// <p>A structure that contains details about the account's password policy.</p>
    pub fn set_password_policy(mut self, input: ::std::option::Option<super::types::PasswordPolicy>) -> Self {
        self.password_policy = input;
        self
    }
    /// <p>A structure that contains details about the account's password policy.</p>
    pub fn get_password_policy(&self) -> &::std::option::Option<super::types::PasswordPolicy> {
    ...
    pub fn build(self) -> super::operation::get_account_password_policy::GetAccountPasswordPolicyOutput {
