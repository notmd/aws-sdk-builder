...
pub mod _detach_user_policy_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/detach_user_policy/_detach_user_policy_input.rs"
    ));
}
...
pub mod _detach_user_policy_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/detach_user_policy/_detach_user_policy_output.rs"
    ));
}
