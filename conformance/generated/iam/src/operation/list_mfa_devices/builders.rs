...
pub use super::operation::list_mfa_devices::_list_mfa_devices_input::ListMfaDevicesInputBuilder;

pub use super::operation::list_mfa_devices::_list_mfa_devices_output::ListMfaDevicesOutputBuilder;

impl super::operation::list_mfa_devices::builders::ListMfaDevicesInputBuilder {
...
impl ListMfaDevicesFluentBuilder {
    ...
    pub fn into_paginator(self) -> super::operation::list_mfa_devices::paginator::ListMfaDevicesPaginator {
        super::operation::list_mfa_devices::paginator::ListMfaDevicesPaginator::new(self.handle, self.inner)
    }
