...
pub struct ListMfaDevicesPaginator {
    ...
    builder: super::operation::list_mfa_devices::builders::ListMfaDevicesInputBuilder,
...
impl ListMfaDevicesPaginator {
    ...
    pub fn items(self) -> super::operation::list_mfa_devices::paginator::ListMfaDevicesPaginatorItems {
        super::operation::list_mfa_devices::paginator::ListMfaDevicesPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::operation::list_mfa_devices::ListMFADevices::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_list_mfa_devices_output_output_marker(resp);
...
impl ListMfaDevicesPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::lens::lens_list_mfa_devices_output_output_mfa_devices(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
