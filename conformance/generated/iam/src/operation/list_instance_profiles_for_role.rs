// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output {
            pub instance_profiles: ::std::option::Option<super::super::types::InstanceProfileListType>,
        ...
        impl Output {
            pub fn instance_profiles(&self) -> &[super::super::types::InstanceProfile] { self.instance_profiles.as_deref().unwrap_or(&[]) }
            pub fn is_truncated(&self) -> ::std::option::Option<bool> { self.is_truncated }
            pub fn marker(&self) -> ::std::option::Option<&str> { self.marker.as_deref() }
        }
        pub type ListInstanceProfilesForRoleInput = Input;
        pub type ListInstanceProfilesForRoleOutput = Output;
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::ListInstanceProfilesForRoleOutput, super::ListInstanceProfilesForRoleError> {
                         let path = "/";
                         let body = ::std::vec::Vec::new();
                         let headers = ::std::vec::Vec::new();
                         let response = self.client.request(super::super::super::transport::Method::Post, &path, &headers, &body).await.map_err(super::ListInstanceProfilesForRoleError::Unhandled)?;
                         let status = response.status();
                         if !status.is_success() {
                             return Err(super::ListInstanceProfilesForRoleError::Unhandled(format!("ListInstanceProfilesForRole returned HTTP {}", status)));
                         }
                         Ok(super::ListInstanceProfilesForRoleOutput::default())
                     }
                 }
}
