...
pub mod _list_instance_profiles_for_role_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/list_instance_profiles_for_role/_list_instance_profiles_for_role_input.rs"
    ));
}
...
pub mod _list_instance_profiles_for_role_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/list_instance_profiles_for_role/_list_instance_profiles_for_role_output.rs"
    ));
}
