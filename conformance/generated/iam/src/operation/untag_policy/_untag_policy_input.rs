...
impl UntagPolicyInput {
    ...
    pub fn builder() -> super::operation::untag_policy::builders::UntagPolicyInputBuilder {
        super::operation::untag_policy::builders::UntagPolicyInputBuilder::default()
    }
}
...
impl UntagPolicyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::untag_policy::UntagPolicyInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::untag_policy::UntagPolicyInput {
