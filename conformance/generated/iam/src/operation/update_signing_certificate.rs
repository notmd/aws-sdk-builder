...
impl UpdateSigningCertificate {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::update_signing_certificate::UpdateSigningCertificateInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::update_signing_certificate::UpdateSigningCertificateError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::update_signing_certificate::UpdateSigningCertificateOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateSigningCertificateResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_update_signing_certificate::de_update_signing_certificate_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_update_signing_certificate::de_update_signing_certificate_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateSigningCertificateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::update_signing_certificate::UpdateSigningCertificateInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::update_signing_certificate::UpdateSigningCertificateInput,
...
impl ::aws_types::request_id::RequestId for super::operation::update_signing_certificate::UpdateSigningCertificateError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::update_signing_certificate::_update_signing_certificate_input::UpdateSigningCertificateInput;

pub use super::operation::update_signing_certificate::_update_signing_certificate_output::UpdateSigningCertificateOutput;
