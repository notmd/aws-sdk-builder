...
pub mod _update_signing_certificate_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/update_signing_certificate/_update_signing_certificate_input.rs"
    ));
}
...
pub mod _update_signing_certificate_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/update_signing_certificate/_update_signing_certificate_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/update_signing_certificate/builders.rs"
    ));
}
