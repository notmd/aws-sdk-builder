...
impl ListPolicyTags {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::list_policy_tags::ListPolicyTagsInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_policy_tags::ListPolicyTagsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_policy_tags::ListPolicyTagsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListPolicyTagsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_policy_tags::de_list_policy_tags_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_policy_tags::de_list_policy_tags_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListPolicyTagsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_policy_tags::ListPolicyTagsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_policy_tags::ListPolicyTagsInput,
...
impl ::aws_types::request_id::RequestId for super::operation::list_policy_tags::ListPolicyTagsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_policy_tags::_list_policy_tags_input::ListPolicyTagsInput;

pub use super::operation::list_policy_tags::_list_policy_tags_output::ListPolicyTagsOutput;
