...
pub mod _list_policy_tags_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/list_policy_tags/_list_policy_tags_input.rs"));
}
pub use _list_policy_tags_input::ListPolicyTagsInput;
pub type Input = ListPolicyTagsInput;
pub mod _list_policy_tags_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/list_policy_tags/_list_policy_tags_output.rs"));
}
pub use _list_policy_tags_output::ListPolicyTagsOutput;
pub type Output = ListPolicyTagsOutput;
