...
impl UpdateUser {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::update_user::UpdateUserInput,
    ) -> ::std::result::Result<
        super::operation::update_user::UpdateUserOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::update_user::UpdateUserError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::update_user::UpdateUserError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::update_user::UpdateUserOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateUserResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_update_user::de_update_user_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_update_user::de_update_user_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateUserRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::update_user::UpdateUserInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::update_user::UpdateUserInput,
...
impl ::aws_types::request_id::RequestId for super::operation::update_user::UpdateUserError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::update_user::_update_user_input::UpdateUserInput;

pub use super::operation::update_user::_update_user_output::UpdateUserOutput;
