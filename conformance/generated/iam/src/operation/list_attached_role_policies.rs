...
pub mod _list_attached_role_policies_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/list_attached_role_policies/_list_attached_role_policies_input.rs"));
}
pub use _list_attached_role_policies_input::ListAttachedRolePoliciesInput;
pub type Input = ListAttachedRolePoliciesInput;
pub mod _list_attached_role_policies_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/list_attached_role_policies/_list_attached_role_policies_output.rs"));
}
pub use _list_attached_role_policies_output::ListAttachedRolePoliciesOutput;
pub type Output = ListAttachedRolePoliciesOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/list_attached_role_policies/builders.rs"));
}
