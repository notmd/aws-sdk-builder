...
impl ListAttachedRolePolicies {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::list_attached_role_policies::ListAttachedRolePoliciesInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_attached_role_policies::ListAttachedRolePoliciesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_attached_role_policies::ListAttachedRolePoliciesOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAttachedRolePoliciesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_attached_role_policies::de_list_attached_role_policies_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_attached_role_policies::de_list_attached_role_policies_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAttachedRolePoliciesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_attached_role_policies::ListAttachedRolePoliciesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_attached_role_policies::ListAttachedRolePoliciesInput,
...
impl ::aws_types::request_id::RequestId for super::operation::list_attached_role_policies::ListAttachedRolePoliciesError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_attached_role_policies::_list_attached_role_policies_input::ListAttachedRolePoliciesInput;

pub use super::operation::list_attached_role_policies::_list_attached_role_policies_output::ListAttachedRolePoliciesOutput;
