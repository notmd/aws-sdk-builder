...
impl CreateOpenIdConnectProvider {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::create_open_id_connect_provider::CreateOpenIdConnectProviderInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::create_open_id_connect_provider::CreateOpenIDConnectProviderError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::create_open_id_connect_provider::CreateOpenIdConnectProviderOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateOpenIDConnectProviderResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_create_open_id_connect_provider::de_create_open_id_connect_provider_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_create_open_id_connect_provider::de_create_open_id_connect_provider_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateOpenIDConnectProviderRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::create_open_id_connect_provider::CreateOpenIdConnectProviderInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::create_open_id_connect_provider::CreateOpenIdConnectProviderInput,
...
impl ::aws_types::request_id::RequestId for super::operation::create_open_id_connect_provider::CreateOpenIDConnectProviderError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::create_open_id_connect_provider::_create_open_id_connect_provider_input::CreateOpenIdConnectProviderInput;

pub use super::operation::create_open_id_connect_provider::_create_open_id_connect_provider_output::CreateOpenIdConnectProviderOutput;
