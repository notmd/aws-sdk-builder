...
impl GetMfaDeviceOutput {
    ...
    pub fn builder() -> super::operation::get_mfa_device::builders::GetMfaDeviceOutputBuilder {
        super::operation::get_mfa_device::builders::GetMfaDeviceOutputBuilder::default()
    }
}
...
impl GetMfaDeviceOutputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_mfa_device::GetMfaDeviceOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_mfa_device::GetMfaDeviceOutput {
