// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        impl UntagMfaDevice { pub fn new() -> Self { Self } }
        #[derive(Clone, Debug, Default)]
        pub struct Input {
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output;
        pub type UntagMfaDeviceInput = Input;
        pub type UntagMfaDeviceOutput = Output;
        pub type UntagMfaDeviceError = Error;
        #[derive(Clone, Debug)]
        pub enum Error {
...
pub use builders::Builder;
        pub type UntagMfaDeviceFluentBuilder = builders::Builder;
