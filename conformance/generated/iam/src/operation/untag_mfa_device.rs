...
pub mod _untag_mfa_device_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/untag_mfa_device/_untag_mfa_device_input.rs"));
}
pub use _untag_mfa_device_input::UntagMfaDeviceInput;
pub type Input = UntagMfaDeviceInput;
pub mod _untag_mfa_device_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/untag_mfa_device/_untag_mfa_device_output.rs"));
}
pub use _untag_mfa_device_output::UntagMfaDeviceOutput;
pub type Output = UntagMfaDeviceOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/untag_mfa_device/builders.rs"));
}
