// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output {
            pub account_aliases: ::std::option::Option<super::super::types::AccountAliasListType>,
        ...
        impl Output {
            pub fn account_aliases(&self) -> &[super::super::types::AccountAliasType] { self.account_aliases.as_deref().unwrap_or(&[]) }
            pub fn is_truncated(&self) -> ::std::option::Option<bool> { self.is_truncated }
            pub fn marker(&self) -> ::std::option::Option<&str> { self.marker.as_deref() }
        }
        pub type ListAccountAliasesInput = Input;
        pub type ListAccountAliasesOutput = Output;
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::ListAccountAliasesOutput, super::ListAccountAliasesError> {
                         let path = "/";
                         ...
                         Ok(super::ListAccountAliasesOutput::default())
                     }
                 }
}
