...
pub mod _list_account_aliases_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/list_account_aliases/_list_account_aliases_input.rs"
    ));
}
...
pub mod _list_account_aliases_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/list_account_aliases/_list_account_aliases_output.rs"
    ));
}
