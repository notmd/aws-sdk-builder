...
impl ListAccountAliases {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::list_account_aliases::ListAccountAliasesInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_account_aliases::ListAccountAliasesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_account_aliases::ListAccountAliasesOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAccountAliasesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_account_aliases::de_list_account_aliases_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_account_aliases::de_list_account_aliases_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAccountAliasesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_account_aliases::ListAccountAliasesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_account_aliases::ListAccountAliasesInput,
...
impl ::aws_types::request_id::RequestId for super::operation::list_account_aliases::ListAccountAliasesError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_account_aliases::_list_account_aliases_input::ListAccountAliasesInput;

pub use super::operation::list_account_aliases::_list_account_aliases_output::ListAccountAliasesOutput;
