...
impl CreateUserInput {
    ...
    pub fn builder() -> super::operation::create_user::builders::CreateUserInputBuilder {
        super::operation::create_user::builders::CreateUserInputBuilder::default()
    }
}
...
impl CreateUserInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::create_user::CreateUserInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::create_user::CreateUserInput {
            path: self.path,
