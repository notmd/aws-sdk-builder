...
pub mod _delete_role_policy_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/delete_role_policy/_delete_role_policy_input.rs"
    ));
}
...
pub mod _delete_role_policy_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/delete_role_policy/_delete_role_policy_output.rs"
    ));
}
