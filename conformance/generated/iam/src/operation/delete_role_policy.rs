...
impl DeleteRolePolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::delete_role_policy::DeleteRolePolicyInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_role_policy::DeleteRolePolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_role_policy::DeleteRolePolicyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteRolePolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_role_policy::de_delete_role_policy_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_role_policy::de_delete_role_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteRolePolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_role_policy::DeleteRolePolicyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_role_policy::DeleteRolePolicyInput,
...
impl ::aws_types::request_id::RequestId for super::operation::delete_role_policy::DeleteRolePolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_role_policy::_delete_role_policy_input::DeleteRolePolicyInput;

pub use super::operation::delete_role_policy::_delete_role_policy_output::DeleteRolePolicyOutput;
