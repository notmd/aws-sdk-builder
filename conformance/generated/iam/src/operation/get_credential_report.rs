...
impl GetCredentialReport {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::get_credential_report::GetCredentialReportInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_credential_report::GetCredentialReportError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_credential_report::GetCredentialReportOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetCredentialReportResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_credential_report::de_get_credential_report_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_credential_report::de_get_credential_report_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetCredentialReportRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_credential_report::GetCredentialReportInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_credential_report::GetCredentialReportInput,
...
impl ::aws_types::request_id::RequestId for super::operation::get_credential_report::GetCredentialReportError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_credential_report::_get_credential_report_input::GetCredentialReportInput;

pub use super::operation::get_credential_report::_get_credential_report_output::GetCredentialReportOutput;
