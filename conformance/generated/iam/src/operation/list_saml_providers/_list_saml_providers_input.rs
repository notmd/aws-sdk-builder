...
impl ListSamlProvidersInput {
    ...
    pub fn builder() -> super::operation::list_saml_providers::builders::ListSamlProvidersInputBuilder {
        super::operation::list_saml_providers::builders::ListSamlProvidersInputBuilder::default()
    }
}
...
impl ListSamlProvidersInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_saml_providers::ListSamlProvidersInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_saml_providers::ListSamlProvidersInput {})
    }
}
