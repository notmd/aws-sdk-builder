...
impl RemoveUserFromGroup {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::remove_user_from_group::RemoveUserFromGroupInput,
    ) -> ::std::result::Result<
        super::operation::remove_user_from_group::RemoveUserFromGroupOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::remove_user_from_group::RemoveUserFromGroupError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::remove_user_from_group::RemoveUserFromGroupError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::remove_user_from_group::RemoveUserFromGroupOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RemoveUserFromGroupResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_remove_user_from_group::de_remove_user_from_group_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_remove_user_from_group::de_remove_user_from_group_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RemoveUserFromGroupRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::remove_user_from_group::RemoveUserFromGroupInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::remove_user_from_group::RemoveUserFromGroupInput,
...
impl ::aws_types::request_id::RequestId for super::operation::remove_user_from_group::RemoveUserFromGroupError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::remove_user_from_group::_remove_user_from_group_input::RemoveUserFromGroupInput;

pub use super::operation::remove_user_from_group::_remove_user_from_group_output::RemoveUserFromGroupOutput;
