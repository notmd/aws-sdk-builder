...
pub mod _generate_credential_report_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/generate_credential_report/_generate_credential_report_input.rs"
    ));
}
...
pub mod _generate_credential_report_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/generate_credential_report/_generate_credential_report_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/generate_credential_report/builders.rs"
    ));
}
