...
impl GenerateCredentialReport {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::generate_credential_report::GenerateCredentialReportInput,
    ) -> ::std::result::Result<
        super::operation::generate_credential_report::GenerateCredentialReportOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::generate_credential_report::GenerateCredentialReportError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::generate_credential_report::GenerateCredentialReportError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::generate_credential_report::GenerateCredentialReportOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GenerateCredentialReportResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_generate_credential_report::de_generate_credential_report_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_generate_credential_report::de_generate_credential_report_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GenerateCredentialReportRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::generate_credential_report::GenerateCredentialReportInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::generate_credential_report::GenerateCredentialReportInput,
...
impl ::aws_types::request_id::RequestId for super::operation::generate_credential_report::GenerateCredentialReportError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::generate_credential_report::_generate_credential_report_input::GenerateCredentialReportInput;

pub use super::operation::generate_credential_report::_generate_credential_report_output::GenerateCredentialReportOutput;
