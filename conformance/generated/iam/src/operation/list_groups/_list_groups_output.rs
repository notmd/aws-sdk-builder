...
impl ListGroupsOutput {
    ...
    pub fn builder() -> super::operation::list_groups::builders::ListGroupsOutputBuilder {
        super::operation::list_groups::builders::ListGroupsOutputBuilder::default()
    }
}
...
impl ListGroupsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::list_groups::ListGroupsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_groups::ListGroupsOutput {
