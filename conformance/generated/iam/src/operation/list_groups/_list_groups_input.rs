...
impl ListGroupsInput {
    ...
    pub fn builder() -> super::operation::list_groups::builders::ListGroupsInputBuilder {
        super::operation::list_groups::builders::ListGroupsInputBuilder::default()
    }
}
...
impl ListGroupsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::list_groups::ListGroupsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_groups::ListGroupsInput {
