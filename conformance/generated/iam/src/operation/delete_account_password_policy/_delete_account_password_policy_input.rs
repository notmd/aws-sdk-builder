...
impl DeleteAccountPasswordPolicyInput {
    ...
    pub fn builder() -> super::operation::delete_account_password_policy::builders::DeleteAccountPasswordPolicyInputBuilder {
        super::operation::delete_account_password_policy::builders::DeleteAccountPasswordPolicyInputBuilder::default()
    }
}
...
impl DeleteAccountPasswordPolicyInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::delete_account_password_policy::DeleteAccountPasswordPolicyInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::delete_account_password_policy::DeleteAccountPasswordPolicyInput {})
    }
}
