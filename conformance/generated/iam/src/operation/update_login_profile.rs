...
pub mod _update_login_profile_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/update_login_profile/_update_login_profile_input.rs"));
}
pub use _update_login_profile_input::UpdateLoginProfileInput;
pub type Input = UpdateLoginProfileInput;
pub mod _update_login_profile_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/update_login_profile/_update_login_profile_output.rs"));
}
pub use _update_login_profile_output::UpdateLoginProfileOutput;
pub type Output = UpdateLoginProfileOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/update_login_profile/builders.rs"));
}
