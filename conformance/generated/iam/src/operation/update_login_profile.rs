...
pub mod _update_login_profile_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/update_login_profile/_update_login_profile_input.rs"
    ));
}
...
pub mod _update_login_profile_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/update_login_profile/_update_login_profile_output.rs"
    ));
}
