// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output;
        pub type UpdateLoginProfileInput = Input;
        pub type UpdateLoginProfileOutput = Output;
        pub type UpdateLoginProfileError = Error;
        #[derive(Clone, Debug)]
        pub enum Error {
...
pub use builders::Builder;
        pub type UpdateLoginProfileFluentBuilder = builders::Builder;
