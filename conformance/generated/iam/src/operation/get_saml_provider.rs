...
impl GetSamlProvider {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::get_saml_provider::GetSamlProviderInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_saml_provider::GetSAMLProviderError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_saml_provider::GetSamlProviderOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetSAMLProviderResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_saml_provider::de_get_saml_provider_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_saml_provider::de_get_saml_provider_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetSAMLProviderRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_saml_provider::GetSamlProviderInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_saml_provider::GetSamlProviderInput,
...
impl ::aws_types::request_id::RequestId for super::operation::get_saml_provider::GetSAMLProviderError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_saml_provider::_get_saml_provider_input::GetSamlProviderInput;

pub use super::operation::get_saml_provider::_get_saml_provider_output::GetSamlProviderOutput;
