    ...
    pub fn build(self) -> super::Input { self.input }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::UpdateGroupOutput, super::UpdateGroupError> {
                         ...
                         if !status.is_success() {
                             return Err(super::UpdateGroupError::unhandled_with_request_ids(format!("UpdateGroup returned HTTP {}", status), response.header("x-amzn-requestid").map(str::to_owned), ::std::option::Option::None));
                         }
                         let mut output = super::_update_group_output::UpdateGroupOutputBuilder::default();
