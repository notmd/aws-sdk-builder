...
impl UpdateGroupInput {
    ...
    pub fn builder() -> super::operation::update_group::builders::UpdateGroupInputBuilder {
        super::operation::update_group::builders::UpdateGroupInputBuilder::default()
    }
}
...
impl UpdateGroupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::update_group::UpdateGroupInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::update_group::UpdateGroupInput {
