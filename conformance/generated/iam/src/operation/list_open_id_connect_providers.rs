...
impl ListOpenIdConnectProviders {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::list_open_id_connect_providers::ListOpenIdConnectProvidersInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_open_id_connect_providers::ListOpenIDConnectProvidersError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_open_id_connect_providers::ListOpenIdConnectProvidersOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListOpenIDConnectProvidersResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_open_id_connect_providers::de_list_open_id_connect_providers_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_open_id_connect_providers::de_list_open_id_connect_providers_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListOpenIDConnectProvidersRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_open_id_connect_providers::ListOpenIdConnectProvidersInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_open_id_connect_providers::ListOpenIdConnectProvidersInput,
...
impl ::aws_types::request_id::RequestId for super::operation::list_open_id_connect_providers::ListOpenIDConnectProvidersError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_open_id_connect_providers::_list_open_id_connect_providers_input::ListOpenIdConnectProvidersInput;

pub use super::operation::list_open_id_connect_providers::_list_open_id_connect_providers_output::ListOpenIdConnectProvidersOutput;
