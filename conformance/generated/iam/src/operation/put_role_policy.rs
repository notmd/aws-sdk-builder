...
impl PutRolePolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::put_role_policy::PutRolePolicyInput,
    ) -> ::std::result::Result<
        super::operation::put_role_policy::PutRolePolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::put_role_policy::PutRolePolicyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::put_role_policy::PutRolePolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::put_role_policy::PutRolePolicyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutRolePolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_put_role_policy::de_put_role_policy_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_put_role_policy::de_put_role_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutRolePolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::put_role_policy::PutRolePolicyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::put_role_policy::PutRolePolicyInput,
...
impl ::aws_types::request_id::RequestId for super::operation::put_role_policy::PutRolePolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::put_role_policy::_put_role_policy_input::PutRolePolicyInput;

pub use super::operation::put_role_policy::_put_role_policy_output::PutRolePolicyOutput;
