...
impl PutGroupPolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::put_group_policy::PutGroupPolicyInput,
    ) -> ::std::result::Result<
        super::operation::put_group_policy::PutGroupPolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::put_group_policy::PutGroupPolicyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::put_group_policy::PutGroupPolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::put_group_policy::PutGroupPolicyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutGroupPolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_put_group_policy::de_put_group_policy_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_put_group_policy::de_put_group_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutGroupPolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::put_group_policy::PutGroupPolicyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::put_group_policy::PutGroupPolicyInput,
...
impl ::aws_types::request_id::RequestId for super::operation::put_group_policy::PutGroupPolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::put_group_policy::_put_group_policy_input::PutGroupPolicyInput;

pub use super::operation::put_group_policy::_put_group_policy_output::PutGroupPolicyOutput;
