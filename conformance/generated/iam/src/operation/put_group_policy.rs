// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output;
        pub type PutGroupPolicyInput = Input;
        pub type PutGroupPolicyOutput = Output;
        pub type PutGroupPolicyError = Error;
        #[derive(Clone, Debug)]
        pub enum Error {
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::PutGroupPolicyOutput, super::PutGroupPolicyError> {
                         ...
                         let response = self.client.request(super::super::super::transport::Method::Post, &path, &headers, &body).await.map_err(super::PutGroupPolicyError::Unhandled)?;
...
pub use builders::Builder;
        pub type PutGroupPolicyFluentBuilder = builders::Builder;
