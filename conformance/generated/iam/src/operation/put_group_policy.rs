...
pub mod _put_group_policy_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/put_group_policy/_put_group_policy_input.rs"));
}
pub use _put_group_policy_input::PutGroupPolicyInput;
pub type Input = PutGroupPolicyInput;
pub mod _put_group_policy_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/put_group_policy/_put_group_policy_output.rs"));
}
pub use _put_group_policy_output::PutGroupPolicyOutput;
pub type Output = PutGroupPolicyOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/put_group_policy/builders.rs"));
}
