// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        impl UpdateGroup { pub fn new() -> Self { Self } }
        #[derive(Clone, Debug, Default)]
        pub struct Input {
            pub group_name: ::std::option::Option<super::super::types::GroupNameType>,
            pub new_group_name: ::std::option::Option<super::super::types::GroupNameType>,
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output;
        pub type UpdateGroupInput = Input;
        pub type UpdateGroupOutput = Output;
        pub type UpdateGroupError = Error;
        #[derive(Clone, Debug)]
        pub enum Error {
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::UpdateGroupOutput, super::UpdateGroupError> {
                         ...
                         let response = self.client.request(super::super::super::transport::Method::Post, &path, &headers, &body).await.map_err(super::UpdateGroupError::Unhandled)?;
...
pub use builders::Builder;
        pub type UpdateGroupFluentBuilder = builders::Builder;
