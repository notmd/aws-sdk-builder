...
pub mod _update_role_description_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/update_role_description/_update_role_description_input.rs"));
}
pub use _update_role_description_input::UpdateRoleDescriptionInput;
pub type Input = UpdateRoleDescriptionInput;
pub mod _update_role_description_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/update_role_description/_update_role_description_output.rs"));
}
pub use _update_role_description_output::UpdateRoleDescriptionOutput;
pub type Output = UpdateRoleDescriptionOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/update_role_description/builders.rs"));
}
pub type UpdateRoleDescriptionError = Error;
pub type UpdateRoleDescriptionFluentBuilder = builders::Builder;
