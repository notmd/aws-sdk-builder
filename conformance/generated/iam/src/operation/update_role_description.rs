...
pub mod _update_role_description_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/update_role_description/_update_role_description_input.rs"
    ));
}
...
pub mod _update_role_description_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/update_role_description/_update_role_description_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/update_role_description/builders.rs"
    ));
}
