...
impl DeleteOpenIdConnectProvider {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::delete_open_id_connect_provider::DeleteOpenIdConnectProviderInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_open_id_connect_provider::DeleteOpenIDConnectProviderError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_open_id_connect_provider::DeleteOpenIdConnectProviderOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteOpenIDConnectProviderResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_open_id_connect_provider::de_delete_open_id_connect_provider_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_open_id_connect_provider::de_delete_open_id_connect_provider_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteOpenIDConnectProviderRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_open_id_connect_provider::DeleteOpenIdConnectProviderInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_open_id_connect_provider::DeleteOpenIdConnectProviderInput,
...
impl ::aws_types::request_id::RequestId for super::operation::delete_open_id_connect_provider::DeleteOpenIDConnectProviderError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_open_id_connect_provider::_delete_open_id_connect_provider_input::DeleteOpenIdConnectProviderInput;

pub use super::operation::delete_open_id_connect_provider::_delete_open_id_connect_provider_output::DeleteOpenIdConnectProviderOutput;
