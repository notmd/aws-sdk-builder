...
impl DeleteOpenIdConnectProvider { pub fn new() -> Self { Self } }
#[derive(Clone, Debug)]
pub enum Error {
...
pub mod _delete_open_id_connect_provider_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/delete_open_id_connect_provider/_delete_open_id_connect_provider_input.rs"));
}
pub use _delete_open_id_connect_provider_input::DeleteOpenIdConnectProviderInput;
pub type Input = DeleteOpenIdConnectProviderInput;
pub mod _delete_open_id_connect_provider_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/delete_open_id_connect_provider/_delete_open_id_connect_provider_output.rs"));
}
pub use _delete_open_id_connect_provider_output::DeleteOpenIdConnectProviderOutput;
pub type Output = DeleteOpenIdConnectProviderOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/delete_open_id_connect_provider/builders.rs"));
}
pub type DeleteOpenIdConnectProviderError = Error;
pub type DeleteOpenIdConnectProviderFluentBuilder = builders::Builder;
