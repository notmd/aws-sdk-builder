...
impl UpdateServiceSpecificCredentialOutput {
    ...
    pub fn builder() -> super::operation::update_service_specific_credential::builders::UpdateServiceSpecificCredentialOutputBuilder {
        super::operation::update_service_specific_credential::builders::UpdateServiceSpecificCredentialOutputBuilder::default()
    }
}
...
impl UpdateServiceSpecificCredentialOutputBuilder {
    ...
    pub fn build(self) -> super::operation::update_service_specific_credential::UpdateServiceSpecificCredentialOutput {
