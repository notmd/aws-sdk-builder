...
impl UntagSamlProviderInput {
    ...
    pub fn builder() -> super::operation::untag_saml_provider::builders::UntagSamlProviderInputBuilder {
        super::operation::untag_saml_provider::builders::UntagSamlProviderInputBuilder::default()
    }
}
...
impl UntagSamlProviderInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::untag_saml_provider::UntagSamlProviderInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::untag_saml_provider::UntagSamlProviderInput {
