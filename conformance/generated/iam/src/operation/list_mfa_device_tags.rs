...
pub mod _list_mfa_device_tags_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/list_mfa_device_tags/_list_mfa_device_tags_input.rs"));
}
pub use _list_mfa_device_tags_input::ListMfaDeviceTagsInput;
pub type Input = ListMfaDeviceTagsInput;
pub mod _list_mfa_device_tags_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/list_mfa_device_tags/_list_mfa_device_tags_output.rs"));
}
pub use _list_mfa_device_tags_output::ListMfaDeviceTagsOutput;
pub type Output = ListMfaDeviceTagsOutput;
