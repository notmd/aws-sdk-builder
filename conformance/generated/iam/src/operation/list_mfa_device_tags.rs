...
impl ListMfaDeviceTags {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::list_mfa_device_tags::ListMfaDeviceTagsInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_mfa_device_tags::ListMFADeviceTagsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_mfa_device_tags::ListMfaDeviceTagsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListMFADeviceTagsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_mfa_device_tags::de_list_mfa_device_tags_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_mfa_device_tags::de_list_mfa_device_tags_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListMFADeviceTagsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_mfa_device_tags::ListMfaDeviceTagsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_mfa_device_tags::ListMfaDeviceTagsInput,
...
impl ::aws_types::request_id::RequestId for super::operation::list_mfa_device_tags::ListMFADeviceTagsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_mfa_device_tags::_list_mfa_device_tags_input::ListMfaDeviceTagsInput;

pub use super::operation::list_mfa_device_tags::_list_mfa_device_tags_output::ListMfaDeviceTagsOutput;
