...
pub use super::operation::get_organizations_access_report::_get_organizations_access_report_input::GetOrganizationsAccessReportInputBuilder;

pub use super::operation::get_organizations_access_report::_get_organizations_access_report_output::GetOrganizationsAccessReportOutputBuilder;

impl super::operation::get_organizations_access_report::builders::GetOrganizationsAccessReportInputBuilder {
...
pub struct GetOrganizationsAccessReportFluentBuilder {
    ...
    inner: super::operation::get_organizations_access_report::builders::GetOrganizationsAccessReportInputBuilder,
...
impl GetOrganizationsAccessReportFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::get_organizations_access_report::builders::GetOrganizationsAccessReportInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::get_organizations_access_report::GetOrganizationsAccessReport::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::get_organizations_access_report::GetOrganizationsAccessReport::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn sort_key(mut self, input: super::types::SortKeyType) -> Self {
        self.inner = self.inner.sort_key(input);
        self
    }
    /// <p>The key that is used to sort the results. If you choose the namespace key, the results are returned in alphabetical order. If you choose the time key, the results are sorted numerically by the date and time.</p>
    pub fn set_sort_key(mut self, input: ::std::option::Option<super::types::SortKeyType>) -> Self {
        self.inner = self.inner.set_sort_key(input);
        self
    }
    /// <p>The key that is used to sort the results. If you choose the namespace key, the results are returned in alphabetical order. If you choose the time key, the results are sorted numerically by the date and time.</p>
    pub fn get_sort_key(&self) -> &::std::option::Option<super::types::SortKeyType> {
