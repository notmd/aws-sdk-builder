...
impl GetOrganizationsAccessReportInputBuilder {
    ...
    pub fn set_sort_key(mut self, input: ::std::option::Option<crate::types::SortKeyType>) -> Self { self.sort_key = input; self }
    /// <p>The key that is used to sort the results. If you choose the namespace key, the results are returned in alphabetical order. If you choose the time key, the results are sorted numerically by the date and time.</p>
    pub fn get_sort_key(&self) -> &::std::option::Option<crate::types::SortKeyType> { &self.sort_key }
    ...
    pub fn build(self) -> crate::operation::get_organizations_access_report::GetOrganizationsAccessReportInput {
