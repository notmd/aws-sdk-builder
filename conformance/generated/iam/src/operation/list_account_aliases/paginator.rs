...
/// Paginator for [`ListAccountAliases`](crate::operation::list_account_aliases::ListAccountAliases)
pub struct ListAccountAliasesPaginator {
    handle: std::sync::Arc<super::client::Handle>,
    builder: super::operation::list_account_aliases::builders::ListAccountAliasesInputBuilder,
...
impl ListAccountAliasesPaginator {
    ...
    pub fn items(self) -> super::operation::list_account_aliases::paginator::ListAccountAliasesPaginatorItems {
        super::operation::list_account_aliases::paginator::ListAccountAliasesPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::operation::list_account_aliases::ListAccountAliases::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_list_account_aliases_output_output_marker(resp);
...
impl ListAccountAliasesPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::lens::lens_list_account_aliases_output_output_account_aliases(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
