...
pub struct Builder {
    input: super::_list_account_aliases_input::ListAccountAliasesInputBuilder,
...
impl Builder {
    ...
    pub async fn send(self) -> ::std::result::Result<super::ListAccountAliasesOutput, super::ListAccountAliasesError> {
        let input = self
            .input
            .build()
            .map_err(|error| super::ListAccountAliasesError::Unhandled(error.to_string()))?;
        let path = "/";
        ...
        let response = self
            ...
            .await
            .map_err(super::ListAccountAliasesError::Unhandled)?;
        let status = response.status();
        if !status.is_success() {
            return Err(super::ListAccountAliasesError::unhandled_with_request_ids(
                format!("ListAccountAliases returned HTTP {}", status),
