...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateServiceLinkedRoleResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_service_linked_role::de_create_service_linked_role_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_create_service_linked_role::de_create_service_linked_role_http_response(status, headers, body)
        };
