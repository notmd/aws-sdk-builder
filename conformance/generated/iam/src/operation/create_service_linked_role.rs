...
impl CreateServiceLinkedRole {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::create_service_linked_role::CreateServiceLinkedRoleInput,
    ) -> ::std::result::Result<
        super::operation::create_service_linked_role::CreateServiceLinkedRoleOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::create_service_linked_role::CreateServiceLinkedRoleError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::create_service_linked_role::CreateServiceLinkedRoleError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::create_service_linked_role::CreateServiceLinkedRoleOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateServiceLinkedRoleResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_create_service_linked_role::de_create_service_linked_role_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_create_service_linked_role::de_create_service_linked_role_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateServiceLinkedRoleRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::create_service_linked_role::CreateServiceLinkedRoleInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::create_service_linked_role::CreateServiceLinkedRoleInput,
...
impl ::aws_types::request_id::RequestId for super::operation::create_service_linked_role::CreateServiceLinkedRoleError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::create_service_linked_role::_create_service_linked_role_input::CreateServiceLinkedRoleInput;

pub use super::operation::create_service_linked_role::_create_service_linked_role_output::CreateServiceLinkedRoleOutput;
