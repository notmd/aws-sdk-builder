...
impl GetAccountPropertiesInput {
    ...
    pub fn builder() -> super::operation::get_account_properties::builders::GetAccountPropertiesInputBuilder {
        super::operation::get_account_properties::builders::GetAccountPropertiesInputBuilder::default()
    }
}
...
impl GetAccountPropertiesInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_account_properties::GetAccountPropertiesInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::get_account_properties::GetAccountPropertiesInput {})
    }
}
