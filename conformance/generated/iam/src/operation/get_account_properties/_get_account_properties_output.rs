...
impl GetAccountPropertiesOutput {
    ...
    pub fn builder() -> super::operation::get_account_properties::builders::GetAccountPropertiesOutputBuilder {
        super::operation::get_account_properties::builders::GetAccountPropertiesOutputBuilder::default()
    }
}
...
impl GetAccountPropertiesOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_account_properties::GetAccountPropertiesOutput {
