...
impl GenerateServiceLastAccessedDetails {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::generate_service_last_accessed_details::GenerateServiceLastAccessedDetailsInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::generate_service_last_accessed_details::GenerateServiceLastAccessedDetailsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::generate_service_last_accessed_details::GenerateServiceLastAccessedDetailsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GenerateServiceLastAccessedDetailsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_generate_service_last_accessed_details::de_generate_service_last_accessed_details_http_error(
                status, headers, body,
            )
        } else {
            super::protocol_serde::shape_generate_service_last_accessed_details::de_generate_service_last_accessed_details_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GenerateServiceLastAccessedDetailsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::generate_service_last_accessed_details::GenerateServiceLastAccessedDetailsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::generate_service_last_accessed_details::GenerateServiceLastAccessedDetailsInput,
...
impl ::aws_types::request_id::RequestId for super::operation::generate_service_last_accessed_details::GenerateServiceLastAccessedDetailsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::generate_service_last_accessed_details::_generate_service_last_accessed_details_input::GenerateServiceLastAccessedDetailsInput;

pub use super::operation::generate_service_last_accessed_details::_generate_service_last_accessed_details_output::GenerateServiceLastAccessedDetailsOutput;
