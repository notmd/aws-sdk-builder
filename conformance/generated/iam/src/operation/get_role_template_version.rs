...
pub mod _get_role_template_version_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/get_role_template_version/_get_role_template_version_input.rs"
    ));
}
...
pub mod _get_role_template_version_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/get_role_template_version/_get_role_template_version_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/get_role_template_version/builders.rs"
    ));
}
