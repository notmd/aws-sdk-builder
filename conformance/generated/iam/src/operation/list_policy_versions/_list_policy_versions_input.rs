...
impl ListPolicyVersionsInput {
    ...
    pub fn builder() -> super::operation::list_policy_versions::builders::ListPolicyVersionsInputBuilder {
        super::operation::list_policy_versions::builders::ListPolicyVersionsInputBuilder::default()
    }
}
...
impl ListPolicyVersionsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_policy_versions::ListPolicyVersionsInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::list_policy_versions::ListPolicyVersionsInput {
