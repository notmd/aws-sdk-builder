...
impl PutRolePolicyInput {
    ...
    pub fn builder() -> super::operation::put_role_policy::builders::PutRolePolicyInputBuilder {
        super::operation::put_role_policy::builders::PutRolePolicyInputBuilder::default()
    }
}
...
impl PutRolePolicyInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::put_role_policy::PutRolePolicyInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::put_role_policy::PutRolePolicyInput {
