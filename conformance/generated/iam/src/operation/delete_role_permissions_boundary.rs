...
pub mod _delete_role_permissions_boundary_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/delete_role_permissions_boundary/_delete_role_permissions_boundary_input.rs"
    ));
}
...
pub mod _delete_role_permissions_boundary_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/delete_role_permissions_boundary/_delete_role_permissions_boundary_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/delete_role_permissions_boundary/builders.rs"
    ));
}
