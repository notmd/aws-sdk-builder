...
pub mod _update_role_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/update_role/_update_role_input.rs"));
}
pub use _update_role_input::UpdateRoleInput;
pub type Input = UpdateRoleInput;
pub mod _update_role_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/update_role/_update_role_output.rs"));
}
pub use _update_role_output::UpdateRoleOutput;
pub type Output = UpdateRoleOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/update_role/builders.rs"));
}
