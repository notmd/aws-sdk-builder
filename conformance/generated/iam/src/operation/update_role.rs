...
impl UpdateRole {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::update_role::UpdateRoleInput,
    ) -> ::std::result::Result<
        super::operation::update_role::UpdateRoleOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::update_role::UpdateRoleError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::update_role::UpdateRoleError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::update_role::UpdateRoleOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateRoleResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_update_role::de_update_role_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_update_role::de_update_role_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateRoleRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::update_role::UpdateRoleInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::update_role::UpdateRoleInput,
...
impl ::aws_types::request_id::RequestId for super::operation::update_role::UpdateRoleError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::update_role::_update_role_input::UpdateRoleInput;

pub use super::operation::update_role::_update_role_output::UpdateRoleOutput;
