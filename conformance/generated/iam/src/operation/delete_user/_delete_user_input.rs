...
impl DeleteUserInput {
    ...
    pub fn builder() -> super::operation::delete_user::builders::DeleteUserInputBuilder {
        super::operation::delete_user::builders::DeleteUserInputBuilder::default()
    }
}
...
impl DeleteUserInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::delete_user::DeleteUserInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::delete_user::DeleteUserInput { user_name: self.user_name })
    }
}
