...
impl UntagSamlProvider {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::untag_saml_provider::UntagSamlProviderInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::untag_saml_provider::UntagSAMLProviderError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::untag_saml_provider::UntagSamlProviderOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UntagSAMLProviderResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_untag_saml_provider::de_untag_saml_provider_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_untag_saml_provider::de_untag_saml_provider_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UntagSAMLProviderRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::untag_saml_provider::UntagSamlProviderInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::untag_saml_provider::UntagSamlProviderInput,
...
impl ::aws_types::request_id::RequestId for super::operation::untag_saml_provider::UntagSAMLProviderError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::untag_saml_provider::_untag_saml_provider_input::UntagSamlProviderInput;

pub use super::operation::untag_saml_provider::_untag_saml_provider_output::UntagSamlProviderOutput;
