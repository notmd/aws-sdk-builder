...
impl CreateOpenIdConnectProviderOutput {
    ...
    pub fn builder() -> super::operation::create_open_id_connect_provider::builders::CreateOpenIdConnectProviderOutputBuilder {
        super::operation::create_open_id_connect_provider::builders::CreateOpenIdConnectProviderOutputBuilder::default()
    }
}
...
impl CreateOpenIdConnectProviderOutputBuilder {
    ...
    pub fn build(self) -> super::operation::create_open_id_connect_provider::CreateOpenIdConnectProviderOutput {
