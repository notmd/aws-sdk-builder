...
pub use super::operation::acquire_role::_acquire_role_input::AcquireRoleInputBuilder;

pub use super::operation::acquire_role::_acquire_role_output::AcquireRoleOutputBuilder;

impl super::operation::acquire_role::builders::AcquireRoleInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::acquire_role::AcquireRoleError,
...
pub struct AcquireRoleFluentBuilder {
    ...
    inner: super::operation::acquire_role::builders::AcquireRoleInputBuilder,
...
impl AcquireRoleFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::acquire_role::builders::AcquireRoleInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::acquire_role::AcquireRole::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::acquire_role::AcquireRole::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn replacement_values(mut self, k: impl ::std::convert::Into<::std::string::String>, v: super::types::ReplacementValueEntry) -> Self {
    ...
    pub fn set_replacement_values(
        mut self,
        input: ::std::option::Option<::std::collections::HashMap<::std::string::String, super::types::ReplacementValueEntry>>,
    ) -> Self {
    ...
    pub fn get_replacement_values(
        &self,
    ) -> &::std::option::Option<::std::collections::HashMap<::std::string::String, super::types::ReplacementValueEntry>> {
