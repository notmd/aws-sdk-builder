...
impl DeleteInstanceProfileInput {
    ...
    pub fn builder() -> super::operation::delete_instance_profile::builders::DeleteInstanceProfileInputBuilder {
        super::operation::delete_instance_profile::builders::DeleteInstanceProfileInputBuilder::default()
    }
}
...
impl DeleteInstanceProfileInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::delete_instance_profile::DeleteInstanceProfileInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::delete_instance_profile::DeleteInstanceProfileInput {
