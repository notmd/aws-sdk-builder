...
pub use super::operation::get_service_last_accessed_details_with_entities::_get_service_last_accessed_details_with_entities_input::GetServiceLastAccessedDetailsWithEntitiesInputBuilder;

pub use super::operation::get_service_last_accessed_details_with_entities::_get_service_last_accessed_details_with_entities_output::GetServiceLastAccessedDetailsWithEntitiesOutputBuilder;

impl super::operation::get_service_last_accessed_details_with_entities::builders::GetServiceLastAccessedDetailsWithEntitiesInputBuilder {
...
/// <ul>
/// <li>
/// <p><b>Group</b> – For a group report, this operation returns a list of users in the group that could have used the group’s policies in an attempt to access the service.</p></li>
/// <li>
/// <p><b>Policy</b> – For a policy report, this operation returns a list of entities (users or roles) that could have used the policy in an attempt to access the service.</p></li>
/// </ul>
...
pub struct GetServiceLastAccessedDetailsWithEntitiesFluentBuilder {
    ...
    inner: super::operation::get_service_last_accessed_details_with_entities::builders::GetServiceLastAccessedDetailsWithEntitiesInputBuilder,
...
impl GetServiceLastAccessedDetailsWithEntitiesFluentBuilder {
    /// Creates a new `GetServiceLastAccessedDetailsWithEntitiesFluentBuilder`.
    ...
    > {
        ...
        let runtime_plugins =
            super::operation::get_service_last_accessed_details_with_entities::GetServiceLastAccessedDetailsWithEntities::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        super::operation::get_service_last_accessed_details_with_entities::GetServiceLastAccessedDetailsWithEntities::orchestrate(
            &runtime_plugins,
            input,
        )
        .await
