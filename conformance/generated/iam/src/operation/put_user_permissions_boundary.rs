...
pub mod _put_user_permissions_boundary_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/put_user_permissions_boundary/_put_user_permissions_boundary_input.rs"
    ));
}
...
pub mod _put_user_permissions_boundary_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/put_user_permissions_boundary/_put_user_permissions_boundary_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/put_user_permissions_boundary/builders.rs"
    ));
}
