...
impl PutUserPermissionsBoundary {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::put_user_permissions_boundary::PutUserPermissionsBoundaryInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::put_user_permissions_boundary::PutUserPermissionsBoundaryError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::put_user_permissions_boundary::PutUserPermissionsBoundaryOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutUserPermissionsBoundaryResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_put_user_permissions_boundary::de_put_user_permissions_boundary_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_put_user_permissions_boundary::de_put_user_permissions_boundary_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutUserPermissionsBoundaryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::put_user_permissions_boundary::PutUserPermissionsBoundaryInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::put_user_permissions_boundary::PutUserPermissionsBoundaryInput,
...
impl ::aws_types::request_id::RequestId for super::operation::put_user_permissions_boundary::PutUserPermissionsBoundaryError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::put_user_permissions_boundary::_put_user_permissions_boundary_input::PutUserPermissionsBoundaryInput;

pub use super::operation::put_user_permissions_boundary::_put_user_permissions_boundary_output::PutUserPermissionsBoundaryOutput;
