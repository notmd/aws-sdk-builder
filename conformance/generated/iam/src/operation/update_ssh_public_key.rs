...
pub mod _update_ssh_public_key_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/update_ssh_public_key/_update_ssh_public_key_input.rs"
    ));
}
...
pub mod _update_ssh_public_key_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/update_ssh_public_key/_update_ssh_public_key_output.rs"
    ));
}
