...
impl UpdateSshPublicKey {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::update_ssh_public_key::UpdateSshPublicKeyInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::update_ssh_public_key::UpdateSSHPublicKeyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::update_ssh_public_key::UpdateSshPublicKeyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateSSHPublicKeyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_update_ssh_public_key::de_update_ssh_public_key_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_update_ssh_public_key::de_update_ssh_public_key_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateSSHPublicKeyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::update_ssh_public_key::UpdateSshPublicKeyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::update_ssh_public_key::UpdateSshPublicKeyInput,
...
impl ::aws_types::request_id::RequestId for super::operation::update_ssh_public_key::UpdateSSHPublicKeyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::update_ssh_public_key::_update_ssh_public_key_input::UpdateSshPublicKeyInput;

pub use super::operation::update_ssh_public_key::_update_ssh_public_key_output::UpdateSshPublicKeyOutput;
