...
pub mod _delete_instance_profile_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/delete_instance_profile/_delete_instance_profile_input.rs"
    ));
}
...
pub mod _delete_instance_profile_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/delete_instance_profile/_delete_instance_profile_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/delete_instance_profile/builders.rs"
    ));
}
