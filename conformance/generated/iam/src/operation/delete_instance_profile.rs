...
impl DeleteInstanceProfile {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::delete_instance_profile::DeleteInstanceProfileInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_instance_profile::DeleteInstanceProfileError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_instance_profile::DeleteInstanceProfileOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteInstanceProfileResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_instance_profile::de_delete_instance_profile_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_instance_profile::de_delete_instance_profile_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteInstanceProfileRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_instance_profile::DeleteInstanceProfileInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_instance_profile::DeleteInstanceProfileInput,
...
impl ::aws_types::request_id::RequestId for super::operation::delete_instance_profile::DeleteInstanceProfileError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_instance_profile::_delete_instance_profile_input::DeleteInstanceProfileInput;

pub use super::operation::delete_instance_profile::_delete_instance_profile_output::DeleteInstanceProfileOutput;
