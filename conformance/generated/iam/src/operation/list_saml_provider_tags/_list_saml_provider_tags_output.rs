...
pub struct ListSamlProviderTagsOutput {
    ...
    pub tags: ::std::vec::Vec<super::types::Tag>,
...
impl ListSamlProviderTagsOutput {
    ...
    pub fn builder() -> super::operation::list_saml_provider_tags::builders::ListSamlProviderTagsOutputBuilder {
        super::operation::list_saml_provider_tags::builders::ListSamlProviderTagsOutputBuilder::default()
    }
}
...
impl ListSamlProviderTagsOutputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_saml_provider_tags::ListSamlProviderTagsOutput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::list_saml_provider_tags::ListSamlProviderTagsOutput {
