...
pub use super::operation::list_saml_provider_tags::_list_saml_provider_tags_input::ListSamlProviderTagsInputBuilder;

pub use super::operation::list_saml_provider_tags::_list_saml_provider_tags_output::ListSamlProviderTagsOutputBuilder;

impl super::operation::list_saml_provider_tags::builders::ListSamlProviderTagsInputBuilder {
...
impl ListSamlProviderTagsFluentBuilder {
    ...
    pub fn into_paginator(self) -> super::operation::list_saml_provider_tags::paginator::ListSamlProviderTagsPaginator {
        super::operation::list_saml_provider_tags::paginator::ListSamlProviderTagsPaginator::new(self.handle, self.inner)
    }
