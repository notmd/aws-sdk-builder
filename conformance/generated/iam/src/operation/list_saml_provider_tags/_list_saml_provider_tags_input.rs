...
impl ListSamlProviderTagsInput {
    pub fn builder() -> ListSamlProviderTagsInputBuilder { ListSamlProviderTagsInputBuilder::default() }
}
#[derive(Clone, Debug, Default)]
...
impl ListSamlProviderTagsInputBuilder {
    ...
    pub fn build(self) -> ListSamlProviderTagsInput { ListSamlProviderTagsInput {
        marker: self.marker,
