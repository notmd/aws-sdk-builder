...
impl ListSamlProviderTagsInput {
    ...
    pub fn builder() -> super::operation::list_saml_provider_tags::builders::ListSamlProviderTagsInputBuilder {
        super::operation::list_saml_provider_tags::builders::ListSamlProviderTagsInputBuilder::default()
    }
}
...
impl ListSamlProviderTagsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_saml_provider_tags::ListSamlProviderTagsInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::list_saml_provider_tags::ListSamlProviderTagsInput {
