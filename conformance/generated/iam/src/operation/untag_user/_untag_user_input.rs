...
impl UntagUserInput {
    ...
    pub fn builder() -> super::operation::untag_user::builders::UntagUserInputBuilder {
        super::operation::untag_user::builders::UntagUserInputBuilder::default()
    }
}
...
impl UntagUserInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::untag_user::UntagUserInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::untag_user::UntagUserInput {
