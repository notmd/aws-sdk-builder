...
pub struct Builder {
    input: super::_delete_role_policy_input::DeleteRolePolicyInputBuilder,
...
impl Builder {
    ...
    pub async fn send(self) -> ::std::result::Result<super::DeleteRolePolicyOutput, super::DeleteRolePolicyError> {
        let input = self
            .input
            .build()
            .map_err(|error| super::DeleteRolePolicyError::Unhandled(error.to_string()))?;
        let path = "/";
        ...
        let response = self
            ...
            .await
            .map_err(super::DeleteRolePolicyError::Unhandled)?;
        let status = response.status();
        if !status.is_success() {
            return Err(super::DeleteRolePolicyError::unhandled_with_request_ids(
                format!("DeleteRolePolicy returned HTTP {}", status),
