...
impl DeleteRolePolicyInput {
    ...
    pub fn builder() -> super::operation::delete_role_policy::builders::DeleteRolePolicyInputBuilder {
        super::operation::delete_role_policy::builders::DeleteRolePolicyInputBuilder::default()
    }
}
...
impl DeleteRolePolicyInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::delete_role_policy::DeleteRolePolicyInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::delete_role_policy::DeleteRolePolicyInput {
