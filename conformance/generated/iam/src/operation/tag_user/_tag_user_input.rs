...
impl TagUserInput {
    ...
    pub fn builder() -> super::operation::tag_user::builders::TagUserInputBuilder {
        super::operation::tag_user::builders::TagUserInputBuilder::default()
    }
}
...
impl TagUserInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::tag_user::TagUserInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::tag_user::TagUserInput {
