...
pub mod _get_service_last_accessed_details_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/get_service_last_accessed_details/_get_service_last_accessed_details_input.rs"));
}
pub use _get_service_last_accessed_details_input::GetServiceLastAccessedDetailsInput;
pub type Input = GetServiceLastAccessedDetailsInput;
pub mod _get_service_last_accessed_details_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/get_service_last_accessed_details/_get_service_last_accessed_details_output.rs"));
}
pub use _get_service_last_accessed_details_output::GetServiceLastAccessedDetailsOutput;
pub type Output = GetServiceLastAccessedDetailsOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/get_service_last_accessed_details/builders.rs"));
}
