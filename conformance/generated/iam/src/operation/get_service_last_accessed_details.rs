...
impl GetServiceLastAccessedDetails {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::get_service_last_accessed_details::GetServiceLastAccessedDetailsInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_service_last_accessed_details::GetServiceLastAccessedDetailsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_service_last_accessed_details::GetServiceLastAccessedDetailsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetServiceLastAccessedDetailsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_service_last_accessed_details::de_get_service_last_accessed_details_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_service_last_accessed_details::de_get_service_last_accessed_details_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetServiceLastAccessedDetailsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_service_last_accessed_details::GetServiceLastAccessedDetailsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_service_last_accessed_details::GetServiceLastAccessedDetailsInput,
...
impl ::aws_types::request_id::RequestId for super::operation::get_service_last_accessed_details::GetServiceLastAccessedDetailsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_service_last_accessed_details::_get_service_last_accessed_details_input::GetServiceLastAccessedDetailsInput;

pub use super::operation::get_service_last_accessed_details::_get_service_last_accessed_details_output::GetServiceLastAccessedDetailsOutput;
