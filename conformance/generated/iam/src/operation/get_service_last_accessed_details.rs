...
pub mod _get_service_last_accessed_details_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/get_service_last_accessed_details/_get_service_last_accessed_details_input.rs"
    ));
}
...
pub mod _get_service_last_accessed_details_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/get_service_last_accessed_details/_get_service_last_accessed_details_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/get_service_last_accessed_details/builders.rs"
    ));
}
