...
pub mod _update_saml_provider_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/update_saml_provider/_update_saml_provider_input.rs"
    ));
}
...
pub mod _update_saml_provider_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/update_saml_provider/_update_saml_provider_output.rs"
    ));
}
