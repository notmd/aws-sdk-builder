...
impl UpdateSamlProviderInput {
    ...
    pub fn builder() -> super::operation::update_saml_provider::builders::UpdateSamlProviderInputBuilder {
        super::operation::update_saml_provider::builders::UpdateSamlProviderInputBuilder::default()
    }
}
...
impl UpdateSamlProviderInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::update_saml_provider::UpdateSamlProviderInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::update_saml_provider::UpdateSamlProviderInput {
