...
pub struct GetGroupPaginator {
    ...
    builder: super::operation::get_group::builders::GetGroupInputBuilder,
    stop_on_duplicate_token: bool,
}

impl GetGroupPaginator {
    /// Create a new paginator-wrapper
    pub(crate) fn new(handle: std::sync::Arc<super::client::Handle>, builder: super::operation::get_group::builders::GetGroupInputBuilder) -> Self {
        Self {
            handle,
            builder,
    ...
    pub fn items(self) -> super::operation::get_group::paginator::GetGroupPaginatorItems {
        super::operation::get_group::paginator::GetGroupPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::operation::get_group::GetGroup::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_get_group_output_output_marker(resp);
...
impl GetGroupPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| super::lens::lens_get_group_output_output_users(page).unwrap_or_default().into_iter())
    }
}
