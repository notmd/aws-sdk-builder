...
impl GetContextKeysForCustomPolicyOutput {
    ...
    pub fn builder() -> super::operation::get_context_keys_for_custom_policy::builders::GetContextKeysForCustomPolicyOutputBuilder {
        super::operation::get_context_keys_for_custom_policy::builders::GetContextKeysForCustomPolicyOutputBuilder::default()
    }
}
...
impl GetContextKeysForCustomPolicyOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_context_keys_for_custom_policy::GetContextKeysForCustomPolicyOutput {
