...
impl DeletePolicyVersion {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::delete_policy_version::DeletePolicyVersionInput,
    ) -> ::std::result::Result<
        super::operation::delete_policy_version::DeletePolicyVersionOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::delete_policy_version::DeletePolicyVersionError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_policy_version::DeletePolicyVersionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_policy_version::DeletePolicyVersionOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeletePolicyVersionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_policy_version::de_delete_policy_version_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_policy_version::de_delete_policy_version_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeletePolicyVersionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_policy_version::DeletePolicyVersionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_policy_version::DeletePolicyVersionInput,
...
impl ::aws_types::request_id::RequestId for super::operation::delete_policy_version::DeletePolicyVersionError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_policy_version::_delete_policy_version_input::DeletePolicyVersionInput;

pub use super::operation::delete_policy_version::_delete_policy_version_output::DeletePolicyVersionOutput;
