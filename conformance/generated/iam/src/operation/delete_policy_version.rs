...
pub mod _delete_policy_version_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/delete_policy_version/_delete_policy_version_input.rs"
    ));
}
...
pub mod _delete_policy_version_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/delete_policy_version/_delete_policy_version_output.rs"
    ));
}
