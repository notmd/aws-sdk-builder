...
pub mod _delete_policy_version_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/delete_policy_version/_delete_policy_version_input.rs"));
}
pub use _delete_policy_version_input::DeletePolicyVersionInput;
pub type Input = DeletePolicyVersionInput;
pub mod _delete_policy_version_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/delete_policy_version/_delete_policy_version_output.rs"));
}
pub use _delete_policy_version_output::DeletePolicyVersionOutput;
pub type Output = DeletePolicyVersionOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/delete_policy_version/builders.rs"));
}
