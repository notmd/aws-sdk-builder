// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        impl DeletePolicyVersion { pub fn new() -> Self { Self } }
        #[derive(Clone, Debug, Default)]
        pub struct Input {
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output;
        pub type DeletePolicyVersionInput = Input;
        pub type DeletePolicyVersionOutput = Output;
        pub type DeletePolicyVersionError = Error;
        #[derive(Clone, Debug)]
        pub enum Error {
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::DeletePolicyVersionOutput, super::DeletePolicyVersionError> {
                         let path = "/";
...
pub use builders::Builder;
        pub type DeletePolicyVersionFluentBuilder = builders::Builder;
