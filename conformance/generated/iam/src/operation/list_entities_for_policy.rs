...
pub mod _list_entities_for_policy_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/list_entities_for_policy/_list_entities_for_policy_input.rs"));
}
pub use _list_entities_for_policy_input::ListEntitiesForPolicyInput;
pub type Input = ListEntitiesForPolicyInput;
pub mod _list_entities_for_policy_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/list_entities_for_policy/_list_entities_for_policy_output.rs"));
}
pub use _list_entities_for_policy_output::ListEntitiesForPolicyOutput;
pub type Output = ListEntitiesForPolicyOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/list_entities_for_policy/builders.rs"));
}
