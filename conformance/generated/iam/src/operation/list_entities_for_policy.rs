...
impl ListEntitiesForPolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::list_entities_for_policy::ListEntitiesForPolicyInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_entities_for_policy::ListEntitiesForPolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_entities_for_policy::ListEntitiesForPolicyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListEntitiesForPolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_entities_for_policy::de_list_entities_for_policy_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_entities_for_policy::de_list_entities_for_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListEntitiesForPolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_entities_for_policy::ListEntitiesForPolicyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_entities_for_policy::ListEntitiesForPolicyInput,
...
impl ::aws_types::request_id::RequestId for super::operation::list_entities_for_policy::ListEntitiesForPolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_entities_for_policy::_list_entities_for_policy_input::ListEntitiesForPolicyInput;

pub use super::operation::list_entities_for_policy::_list_entities_for_policy_output::ListEntitiesForPolicyOutput;
