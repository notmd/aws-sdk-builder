...
pub mod _list_entities_for_policy_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/list_entities_for_policy/_list_entities_for_policy_input.rs"
    ));
}
...
pub mod _list_entities_for_policy_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/list_entities_for_policy/_list_entities_for_policy_output.rs"
    ));
}
