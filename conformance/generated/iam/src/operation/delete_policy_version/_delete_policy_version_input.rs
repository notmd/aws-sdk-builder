...
impl DeletePolicyVersionInput {
    ...
    pub fn builder() -> super::operation::delete_policy_version::builders::DeletePolicyVersionInputBuilder {
        super::operation::delete_policy_version::builders::DeletePolicyVersionInputBuilder::default()
    }
}
...
impl DeletePolicyVersionInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::delete_policy_version::DeletePolicyVersionInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::delete_policy_version::DeletePolicyVersionInput {
