...
impl CreateSamlProviderInput {
    ...
    pub fn builder() -> super::operation::create_saml_provider::builders::CreateSamlProviderInputBuilder {
        super::operation::create_saml_provider::builders::CreateSamlProviderInputBuilder::default()
    }
}
...
impl CreateSamlProviderInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::create_saml_provider::CreateSamlProviderInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::create_saml_provider::CreateSamlProviderInput {
