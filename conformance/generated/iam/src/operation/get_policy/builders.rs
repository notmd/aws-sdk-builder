...
pub use super::operation::get_policy::_get_policy_input::GetPolicyInputBuilder;

pub use super::operation::get_policy::_get_policy_output::GetPolicyOutputBuilder;

impl super::operation::get_policy::builders::GetPolicyInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::Client,
    ) -> ::std::result::Result<
        super::operation::get_policy::GetPolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::get_policy::GetPolicyError,
...
pub struct GetPolicyFluentBuilder {
    ...
    inner: super::operation::get_policy::builders::GetPolicyInputBuilder,
    config_override: ::std::option::Option<super::config::Builder>,
}
impl super::client::customize::internal::CustomizableSend<super::operation::get_policy::GetPolicyOutput, super::operation::get_policy::GetPolicyError>
    for GetPolicyFluentBuilder
{
    fn send(
        ...
        super::client::customize::internal::SendResult<super::operation::get_policy::GetPolicyOutput, super::operation::get_policy::GetPolicyError>,
    > {
...
impl GetPolicyFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::get_policy::builders::GetPolicyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::get_policy::GetPolicy::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::get_policy::GetPolicy::orchestrate(&runtime_plugins, input).await
    }
