// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        impl ListUserPolicies { pub fn new() -> Self { Self } }
        #[derive(Clone, Debug, Default)]
        pub struct Input {
        ...
        pub type ListUserPoliciesInput = Input;
        pub type ListUserPoliciesOutput = Output;
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::ListUserPoliciesOutput, super::ListUserPoliciesError> {
                         let path = "/";
                         let body = ::std::vec::Vec::new();
                         let headers = ::std::vec::Vec::new();
                         let response = self.client.request(super::super::super::transport::Method::Post, &path, &headers, &body).await.map_err(super::ListUserPoliciesError::Unhandled)?;
                         let status = response.status();
                         if !status.is_success() {
                             return Err(super::ListUserPoliciesError::Unhandled(format!("ListUserPolicies returned HTTP {}", status)));
                         }
                         Ok(super::ListUserPoliciesOutput::default())
                     }
                 }
}
