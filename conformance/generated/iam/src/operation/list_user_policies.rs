...
impl ListUserPolicies {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::list_user_policies::ListUserPoliciesInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_user_policies::ListUserPoliciesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_user_policies::ListUserPoliciesOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListUserPoliciesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_user_policies::de_list_user_policies_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_user_policies::de_list_user_policies_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListUserPoliciesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_user_policies::ListUserPoliciesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_user_policies::ListUserPoliciesInput,
...
impl ::aws_types::request_id::RequestId for super::operation::list_user_policies::ListUserPoliciesError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_user_policies::_list_user_policies_input::ListUserPoliciesInput;

pub use super::operation::list_user_policies::_list_user_policies_output::ListUserPoliciesOutput;
