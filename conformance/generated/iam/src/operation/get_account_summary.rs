...
impl GetAccountSummary {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::get_account_summary::GetAccountSummaryInput,
    ) -> ::std::result::Result<
        super::operation::get_account_summary::GetAccountSummaryOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::get_account_summary::GetAccountSummaryError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_account_summary::GetAccountSummaryError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_account_summary::GetAccountSummaryOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetAccountSummaryResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_account_summary::de_get_account_summary_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_account_summary::de_get_account_summary_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetAccountSummaryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_account_summary::GetAccountSummaryInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_account_summary::GetAccountSummaryInput,
...
impl ::aws_types::request_id::RequestId for super::operation::get_account_summary::GetAccountSummaryError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_account_summary::_get_account_summary_input::GetAccountSummaryInput;

pub use super::operation::get_account_summary::_get_account_summary_output::GetAccountSummaryOutput;
