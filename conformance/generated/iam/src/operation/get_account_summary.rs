...
pub mod _get_account_summary_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/get_account_summary/_get_account_summary_input.rs"
    ));
}
...
pub mod _get_account_summary_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/get_account_summary/_get_account_summary_output.rs"
    ));
}
