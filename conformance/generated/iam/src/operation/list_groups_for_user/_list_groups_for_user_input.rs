...
impl ListGroupsForUserInput {
    ...
    pub fn builder() -> super::operation::list_groups_for_user::builders::ListGroupsForUserInputBuilder {
        super::operation::list_groups_for_user::builders::ListGroupsForUserInputBuilder::default()
    }
}
...
impl ListGroupsForUserInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_groups_for_user::ListGroupsForUserInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_groups_for_user::ListGroupsForUserInput {
