...
pub struct Builder {
    input: super::_list_groups_for_user_input::ListGroupsForUserInputBuilder,
...
impl Builder {
    ...
    pub async fn send(self) -> ::std::result::Result<super::ListGroupsForUserOutput, super::ListGroupsForUserError> {
        let input = self
            .input
            .build()
            .map_err(|error| super::ListGroupsForUserError::Unhandled(error.to_string()))?;
        let path = "/";
        ...
        let response = self
            ...
            .await
            .map_err(super::ListGroupsForUserError::Unhandled)?;
        let status = response.status();
        if !status.is_success() {
            return Err(super::ListGroupsForUserError::unhandled_with_request_ids(
                format!("ListGroupsForUser returned HTTP {}", status),
