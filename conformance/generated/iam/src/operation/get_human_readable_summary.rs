...
pub mod _get_human_readable_summary_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/get_human_readable_summary/_get_human_readable_summary_input.rs"));
}
pub use _get_human_readable_summary_input::GetHumanReadableSummaryInput;
pub type Input = GetHumanReadableSummaryInput;
pub mod _get_human_readable_summary_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/get_human_readable_summary/_get_human_readable_summary_output.rs"));
}
pub use _get_human_readable_summary_output::GetHumanReadableSummaryOutput;
pub type Output = GetHumanReadableSummaryOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/get_human_readable_summary/builders.rs"));
}
