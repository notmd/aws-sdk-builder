...
pub mod _get_human_readable_summary_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/get_human_readable_summary/_get_human_readable_summary_input.rs"
    ));
}
...
pub mod _get_human_readable_summary_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/get_human_readable_summary/_get_human_readable_summary_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/get_human_readable_summary/builders.rs"
    ));
}
