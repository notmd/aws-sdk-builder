...
impl AddClientIdToOpenIdConnectProviderInput {
    ...
    pub fn builder() -> super::operation::add_client_id_to_open_id_connect_provider::builders::AddClientIdToOpenIdConnectProviderInputBuilder {
        super::operation::add_client_id_to_open_id_connect_provider::builders::AddClientIdToOpenIdConnectProviderInputBuilder::default()
    }
}
...
impl AddClientIdToOpenIdConnectProviderInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::add_client_id_to_open_id_connect_provider::AddClientIdToOpenIdConnectProviderInput,
