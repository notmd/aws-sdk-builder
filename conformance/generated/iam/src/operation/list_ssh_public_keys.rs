...
impl ListSshPublicKeys {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::list_ssh_public_keys::ListSshPublicKeysInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_ssh_public_keys::ListSSHPublicKeysError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_ssh_public_keys::ListSshPublicKeysOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListSSHPublicKeysResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_ssh_public_keys::de_list_ssh_public_keys_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_ssh_public_keys::de_list_ssh_public_keys_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListSSHPublicKeysRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_ssh_public_keys::ListSshPublicKeysInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_ssh_public_keys::ListSshPublicKeysInput,
...
impl ::aws_types::request_id::RequestId for super::operation::list_ssh_public_keys::ListSSHPublicKeysError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_ssh_public_keys::_list_ssh_public_keys_input::ListSshPublicKeysInput;

pub use super::operation::list_ssh_public_keys::_list_ssh_public_keys_output::ListSshPublicKeysOutput;
