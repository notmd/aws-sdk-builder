...
pub struct Builder {
    input: super::_set_default_policy_version_input::SetDefaultPolicyVersionInputBuilder,
...
impl Builder {
    ...
    pub async fn send(self) -> ::std::result::Result<super::SetDefaultPolicyVersionOutput, super::SetDefaultPolicyVersionError> {
        let input = self
            .input
            .build()
            .map_err(|error| super::SetDefaultPolicyVersionError::Unhandled(error.to_string()))?;
        let path = "/";
        ...
        let response = self
            ...
            .await
            .map_err(super::SetDefaultPolicyVersionError::Unhandled)?;
        let status = response.status();
        if !status.is_success() {
            return Err(super::SetDefaultPolicyVersionError::unhandled_with_request_ids(
                format!("SetDefaultPolicyVersion returned HTTP {}", status),
