...
impl GetCredentialReportInput {
    ...
    pub fn builder() -> super::operation::get_credential_report::builders::GetCredentialReportInputBuilder {
        super::operation::get_credential_report::builders::GetCredentialReportInputBuilder::default()
    }
}
...
impl GetCredentialReportInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_credential_report::GetCredentialReportInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::get_credential_report::GetCredentialReportInput {})
    }
}
