...
pub mod _deactivate_mfa_device_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/deactivate_mfa_device/_deactivate_mfa_device_input.rs"
    ));
}
...
pub mod _deactivate_mfa_device_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/deactivate_mfa_device/_deactivate_mfa_device_output.rs"
    ));
}
