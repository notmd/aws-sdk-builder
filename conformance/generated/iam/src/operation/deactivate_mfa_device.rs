...
impl DeactivateMfaDevice {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::deactivate_mfa_device::DeactivateMfaDeviceInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::deactivate_mfa_device::DeactivateMFADeviceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::deactivate_mfa_device::DeactivateMfaDeviceOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeactivateMFADeviceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_deactivate_mfa_device::de_deactivate_mfa_device_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_deactivate_mfa_device::de_deactivate_mfa_device_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeactivateMFADeviceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::deactivate_mfa_device::DeactivateMfaDeviceInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::deactivate_mfa_device::DeactivateMfaDeviceInput,
...
impl ::aws_types::request_id::RequestId for super::operation::deactivate_mfa_device::DeactivateMFADeviceError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::deactivate_mfa_device::_deactivate_mfa_device_input::DeactivateMfaDeviceInput;

pub use super::operation::deactivate_mfa_device::_deactivate_mfa_device_output::DeactivateMfaDeviceOutput;
