...
pub struct Builder {
    input: super::_delete_service_linked_role_input::DeleteServiceLinkedRoleInputBuilder,
...
impl Builder {
    ...
    pub async fn send(self) -> ::std::result::Result<super::DeleteServiceLinkedRoleOutput, super::DeleteServiceLinkedRoleError> {
        let input = self
            .input
            .build()
            .map_err(|error| super::DeleteServiceLinkedRoleError::Unhandled(error.to_string()))?;
        let path = "/";
        ...
        let response = self
            ...
            .await
            .map_err(super::DeleteServiceLinkedRoleError::Unhandled)?;
        let status = response.status();
        if !status.is_success() {
            return Err(super::DeleteServiceLinkedRoleError::unhandled_with_request_ids(
                format!("DeleteServiceLinkedRole returned HTTP {}", status),
