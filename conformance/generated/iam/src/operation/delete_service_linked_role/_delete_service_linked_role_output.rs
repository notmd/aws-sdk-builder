...
impl DeleteServiceLinkedRoleOutput {
    ...
    pub fn builder() -> super::operation::delete_service_linked_role::builders::DeleteServiceLinkedRoleOutputBuilder {
        super::operation::delete_service_linked_role::builders::DeleteServiceLinkedRoleOutputBuilder::default()
    }
}
...
impl DeleteServiceLinkedRoleOutputBuilder {
    ...
    > {
        ::std::result::Result::Ok(super::operation::delete_service_linked_role::DeleteServiceLinkedRoleOutput {
