...
pub struct ListServiceSpecificCredentialsOutput {
    ...
    pub service_specific_credentials: ::std::option::Option<::std::vec::Vec<super::types::ServiceSpecificCredentialMetadata>>,
...
impl ListServiceSpecificCredentialsOutput {
    ...
    pub fn service_specific_credentials(&self) -> &[super::types::ServiceSpecificCredentialMetadata] {
...
impl ListServiceSpecificCredentialsOutput {
    ...
    pub fn builder() -> super::operation::list_service_specific_credentials::builders::ListServiceSpecificCredentialsOutputBuilder {
        super::operation::list_service_specific_credentials::builders::ListServiceSpecificCredentialsOutputBuilder::default()
    }
}
...
pub struct ListServiceSpecificCredentialsOutputBuilder {
    pub(crate) service_specific_credentials: ::std::option::Option<::std::vec::Vec<super::types::ServiceSpecificCredentialMetadata>>,
...
impl ListServiceSpecificCredentialsOutputBuilder {
    ...
    ///
    /// <p>A list of structures that each contain details about a service-specific credential.</p>
    pub fn service_specific_credentials(mut self, input: super::types::ServiceSpecificCredentialMetadata) -> Self {
    ...
    pub fn set_service_specific_credentials(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::ServiceSpecificCredentialMetadata>>,
    ) -> Self {
        self.service_specific_credentials = input;
        self
    }
    /// <p>A list of structures that each contain details about a service-specific credential.</p>
    pub fn get_service_specific_credentials(&self) -> &::std::option::Option<::std::vec::Vec<super::types::ServiceSpecificCredentialMetadata>> {
    ...
    pub fn build(self) -> super::operation::list_service_specific_credentials::ListServiceSpecificCredentialsOutput {
