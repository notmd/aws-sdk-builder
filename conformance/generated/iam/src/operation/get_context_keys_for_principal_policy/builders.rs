...
pub struct Builder {
    input: super::_get_context_keys_for_principal_policy_input::GetContextKeysForPrincipalPolicyInputBuilder,
...
impl Builder {
    ...
    pub async fn send(self) -> ::std::result::Result<super::GetContextKeysForPrincipalPolicyOutput, super::GetContextKeysForPrincipalPolicyError> {
        let input = self
            .input
            .build()
            .map_err(|error| super::GetContextKeysForPrincipalPolicyError::Unhandled(error.to_string()))?;
        let path = "/";
        ...
        let response = self
            ...
            .await
            .map_err(super::GetContextKeysForPrincipalPolicyError::Unhandled)?;
        let status = response.status();
        if !status.is_success() {
            return Err(super::GetContextKeysForPrincipalPolicyError::unhandled_with_request_ids(
                format!("GetContextKeysForPrincipalPolicy returned HTTP {}", status),
