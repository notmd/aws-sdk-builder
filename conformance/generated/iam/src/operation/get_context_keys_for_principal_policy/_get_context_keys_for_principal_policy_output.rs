...
impl GetContextKeysForPrincipalPolicyOutput {
    ...
    pub fn builder() -> super::operation::get_context_keys_for_principal_policy::builders::GetContextKeysForPrincipalPolicyOutputBuilder {
        super::operation::get_context_keys_for_principal_policy::builders::GetContextKeysForPrincipalPolicyOutputBuilder::default()
    }
}
...
impl GetContextKeysForPrincipalPolicyOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_context_keys_for_principal_policy::GetContextKeysForPrincipalPolicyOutput {
