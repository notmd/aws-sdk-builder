...
impl GetContextKeysForPrincipalPolicyInput {
    ...
    pub fn builder() -> super::operation::get_context_keys_for_principal_policy::builders::GetContextKeysForPrincipalPolicyInputBuilder {
        super::operation::get_context_keys_for_principal_policy::builders::GetContextKeysForPrincipalPolicyInputBuilder::default()
    }
}
...
impl GetContextKeysForPrincipalPolicyInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::get_context_keys_for_principal_policy::GetContextKeysForPrincipalPolicyInput,
