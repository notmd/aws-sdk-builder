// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        impl AddClientIdToOpenIdConnectProvider { pub fn new() -> Self { Self } }
        #[derive(Clone, Debug, Default)]
        pub struct Input {
            pub client_id: ::std::option::Option<super::super::types::ClientIdType>,
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output;
        pub type AddClientIdToOpenIdConnectProviderInput = Input;
        pub type AddClientIdToOpenIdConnectProviderOutput = Output;
        pub type AddClientIdToOpenIdConnectProviderError = Error;
        #[derive(Clone, Debug)]
        pub enum Error {
...
pub use builders::Builder;
        pub type AddClientIdToOpenIdConnectProviderFluentBuilder = builders::Builder;
