...
pub mod _add_client_id_to_open_id_connect_provider_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/add_client_id_to_open_id_connect_provider/_add_client_id_to_open_id_connect_provider_input.rs"));
}
pub use _add_client_id_to_open_id_connect_provider_input::AddClientIdToOpenIdConnectProviderInput;
pub type Input = AddClientIdToOpenIdConnectProviderInput;
pub mod _add_client_id_to_open_id_connect_provider_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/add_client_id_to_open_id_connect_provider/_add_client_id_to_open_id_connect_provider_output.rs"));
}
pub use _add_client_id_to_open_id_connect_provider_output::AddClientIdToOpenIdConnectProviderOutput;
pub type Output = AddClientIdToOpenIdConnectProviderOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/add_client_id_to_open_id_connect_provider/builders.rs"));
}
