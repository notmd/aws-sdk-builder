...
impl TagOpenIdConnectProviderInput {
    ...
    pub fn builder() -> super::operation::tag_open_id_connect_provider::builders::TagOpenIdConnectProviderInputBuilder {
        super::operation::tag_open_id_connect_provider::builders::TagOpenIdConnectProviderInputBuilder::default()
    }
}
...
impl TagOpenIdConnectProviderInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::tag_open_id_connect_provider::TagOpenIdConnectProviderInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::tag_open_id_connect_provider::TagOpenIdConnectProviderInput {
