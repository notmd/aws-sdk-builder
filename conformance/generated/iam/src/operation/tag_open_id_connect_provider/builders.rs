...
pub struct Builder {
    input: super::_tag_open_id_connect_provider_input::TagOpenIdConnectProviderInputBuilder,
...
impl Builder {
    ...
    pub async fn send(self) -> ::std::result::Result<super::TagOpenIdConnectProviderOutput, super::TagOpenIDConnectProviderError> {
        let input = self
            .input
            .build()
            .map_err(|error| super::TagOpenIDConnectProviderError::Unhandled(error.to_string()))?;
        let path = "/";
        ...
        let response = self
            ...
            .await
            .map_err(super::TagOpenIDConnectProviderError::Unhandled)?;
        let status = response.status();
        if !status.is_success() {
            return Err(super::TagOpenIDConnectProviderError::unhandled_with_request_ids(
                format!("TagOpenIDConnectProvider returned HTTP {}", status),
