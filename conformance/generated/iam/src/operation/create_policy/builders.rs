    ...
    pub fn build(self) -> super::Input { self.input }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::CreatePolicyOutput, super::CreatePolicyError> {
                         ...
                         if !status.is_success() {
                             return Err(super::CreatePolicyError::unhandled_with_request_ids(format!("CreatePolicy returned HTTP {}", status), response.header("x-amzn-requestid").map(str::to_owned), ::std::option::Option::None));
                         }
                         let mut output = super::_create_policy_output::CreatePolicyOutputBuilder::default();
