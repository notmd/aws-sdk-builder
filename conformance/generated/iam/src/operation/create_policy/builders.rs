...
pub struct Builder {
    input: super::_create_policy_input::CreatePolicyInputBuilder,
...
impl Builder {
    ...
    pub async fn send(self) -> ::std::result::Result<super::CreatePolicyOutput, super::CreatePolicyError> {
        let input = self
            .input
            .build()
            .map_err(|error| super::CreatePolicyError::Unhandled(error.to_string()))?;
        let path = "/";
        ...
        let response = self
            ...
            .await
            .map_err(super::CreatePolicyError::Unhandled)?;
        let status = response.status();
        if !status.is_success() {
            return Err(super::CreatePolicyError::unhandled_with_request_ids(
                format!("CreatePolicy returned HTTP {}", status),
