...
impl CreatePolicyInput {
    ...
    pub fn builder() -> super::operation::create_policy::builders::CreatePolicyInputBuilder {
        super::operation::create_policy::builders::CreatePolicyInputBuilder::default()
    }
}
...
impl CreatePolicyInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::create_policy::CreatePolicyInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::create_policy::CreatePolicyInput {
