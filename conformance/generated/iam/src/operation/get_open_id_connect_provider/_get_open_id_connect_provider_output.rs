...
impl GetOpenIdConnectProviderOutput {
    ...
    pub fn builder() -> super::operation::get_open_id_connect_provider::builders::GetOpenIdConnectProviderOutputBuilder {
        super::operation::get_open_id_connect_provider::builders::GetOpenIdConnectProviderOutputBuilder::default()
    }
}
...
impl GetOpenIdConnectProviderOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_open_id_connect_provider::GetOpenIdConnectProviderOutput {
