...
impl GetOpenIdConnectProviderInput {
    ...
    pub fn builder() -> super::operation::get_open_id_connect_provider::builders::GetOpenIdConnectProviderInputBuilder {
        super::operation::get_open_id_connect_provider::builders::GetOpenIdConnectProviderInputBuilder::default()
    }
}
...
impl GetOpenIdConnectProviderInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::get_open_id_connect_provider::GetOpenIdConnectProviderInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::get_open_id_connect_provider::GetOpenIdConnectProviderInput {
