// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        impl UntagInstanceProfile { pub fn new() -> Self { Self } }
        #[derive(Clone, Debug, Default)]
        pub struct Input {
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output;
        pub type UntagInstanceProfileInput = Input;
        pub type UntagInstanceProfileOutput = Output;
        pub type UntagInstanceProfileError = Error;
        #[derive(Clone, Debug)]
        pub enum Error {
...
pub use builders::Builder;
        pub type UntagInstanceProfileFluentBuilder = builders::Builder;
