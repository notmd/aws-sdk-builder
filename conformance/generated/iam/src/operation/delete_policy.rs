...
pub mod _delete_policy_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/delete_policy/_delete_policy_input.rs"));
}
pub use _delete_policy_input::DeletePolicyInput;
pub type Input = DeletePolicyInput;
pub mod _delete_policy_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/delete_policy/_delete_policy_output.rs"));
}
pub use _delete_policy_output::DeletePolicyOutput;
pub type Output = DeletePolicyOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/delete_policy/builders.rs"));
}
