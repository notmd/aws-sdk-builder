...
impl DeletePolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::delete_policy::DeletePolicyInput,
    ) -> ::std::result::Result<
        super::operation::delete_policy::DeletePolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::delete_policy::DeletePolicyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_policy::DeletePolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_policy::DeletePolicyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeletePolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_policy::de_delete_policy_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_policy::de_delete_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeletePolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_policy::DeletePolicyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_policy::DeletePolicyInput,
...
impl ::aws_types::request_id::RequestId for super::operation::delete_policy::DeletePolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_policy::_delete_policy_input::DeletePolicyInput;

pub use super::operation::delete_policy::_delete_policy_output::DeletePolicyOutput;
