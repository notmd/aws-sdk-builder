// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        impl ListGroupsForUser { pub fn new() -> Self { Self } }
        #[derive(Clone, Debug, Default)]
        pub struct Input {
        ...
        pub type ListGroupsForUserInput = Input;
        pub type ListGroupsForUserOutput = Output;
        pub type ListGroupsForUserError = Error;
        #[derive(Clone, Debug)]
        pub enum Error {
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::ListGroupsForUserOutput, super::ListGroupsForUserError> {
                         let path = "/";
                         ...
                         Ok(super::ListGroupsForUserOutput::default())
                     }
                 }
}
pub use builders::Builder;
        pub type ListGroupsForUserFluentBuilder = builders::Builder;
