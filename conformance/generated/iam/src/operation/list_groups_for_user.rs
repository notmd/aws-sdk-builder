...
pub mod _list_groups_for_user_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/list_groups_for_user/_list_groups_for_user_input.rs"
    ));
}
...
pub mod _list_groups_for_user_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/list_groups_for_user/_list_groups_for_user_output.rs"
    ));
}
