...
impl ListGroupsForUser {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::list_groups_for_user::ListGroupsForUserInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_groups_for_user::ListGroupsForUserError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_groups_for_user::ListGroupsForUserOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListGroupsForUserResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_groups_for_user::de_list_groups_for_user_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_groups_for_user::de_list_groups_for_user_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListGroupsForUserRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_groups_for_user::ListGroupsForUserInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_groups_for_user::ListGroupsForUserInput,
...
impl ::aws_types::request_id::RequestId for super::operation::list_groups_for_user::ListGroupsForUserError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_groups_for_user::_list_groups_for_user_input::ListGroupsForUserInput;

pub use super::operation::list_groups_for_user::_list_groups_for_user_output::ListGroupsForUserOutput;
