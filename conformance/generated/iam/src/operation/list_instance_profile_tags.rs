// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        impl ListInstanceProfileTags { pub fn new() -> Self { Self } }
        #[derive(Clone, Debug, Default)]
        pub struct Input {
        ...
        pub type ListInstanceProfileTagsInput = Input;
        pub type ListInstanceProfileTagsOutput = Output;
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::ListInstanceProfileTagsOutput, super::ListInstanceProfileTagsError> {
                         ...
                         let response = self.client.request(super::super::super::transport::Method::Post, &path, &headers, &body).await.map_err(super::ListInstanceProfileTagsError::Unhandled)?;
                         let status = response.status();
                         if !status.is_success() {
                             return Err(super::ListInstanceProfileTagsError::Unhandled(format!("ListInstanceProfileTags returned HTTP {}", status)));
                         }
                         Ok(super::ListInstanceProfileTagsOutput::default())
                     }
                 }
}
