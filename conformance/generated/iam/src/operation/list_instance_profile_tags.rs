...
pub mod _list_instance_profile_tags_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/list_instance_profile_tags/_list_instance_profile_tags_input.rs"
    ));
}
...
pub mod _list_instance_profile_tags_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/list_instance_profile_tags/_list_instance_profile_tags_output.rs"
    ));
}
