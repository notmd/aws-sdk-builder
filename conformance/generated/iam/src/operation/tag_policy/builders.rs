...
pub use super::operation::tag_policy::_tag_policy_input::TagPolicyInputBuilder;

pub use super::operation::tag_policy::_tag_policy_output::TagPolicyOutputBuilder;

impl super::operation::tag_policy::builders::TagPolicyInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::Client,
    ) -> ::std::result::Result<
        super::operation::tag_policy::TagPolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::tag_policy::TagPolicyError,
...
pub struct TagPolicyFluentBuilder {
    ...
    inner: super::operation::tag_policy::builders::TagPolicyInputBuilder,
    config_override: ::std::option::Option<super::config::Builder>,
}
impl super::client::customize::internal::CustomizableSend<super::operation::tag_policy::TagPolicyOutput, super::operation::tag_policy::TagPolicyError>
    for TagPolicyFluentBuilder
{
    fn send(
        ...
        super::client::customize::internal::SendResult<super::operation::tag_policy::TagPolicyOutput, super::operation::tag_policy::TagPolicyError>,
    > {
...
impl TagPolicyFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::tag_policy::builders::TagPolicyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::tag_policy::TagPolicy::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::tag_policy::TagPolicy::orchestrate(&runtime_plugins, input).await
    }
