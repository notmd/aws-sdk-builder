...
pub mod _delete_server_certificate_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/delete_server_certificate/_delete_server_certificate_input.rs"));
}
pub use _delete_server_certificate_input::DeleteServerCertificateInput;
pub type Input = DeleteServerCertificateInput;
pub mod _delete_server_certificate_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/delete_server_certificate/_delete_server_certificate_output.rs"));
}
pub use _delete_server_certificate_output::DeleteServerCertificateOutput;
pub type Output = DeleteServerCertificateOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/delete_server_certificate/builders.rs"));
}
