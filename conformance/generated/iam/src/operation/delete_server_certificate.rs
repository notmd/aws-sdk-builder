...
impl DeleteServerCertificate {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::delete_server_certificate::DeleteServerCertificateInput,
    ) -> ::std::result::Result<
        super::operation::delete_server_certificate::DeleteServerCertificateOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::delete_server_certificate::DeleteServerCertificateError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_server_certificate::DeleteServerCertificateError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_server_certificate::DeleteServerCertificateOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteServerCertificateResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_server_certificate::de_delete_server_certificate_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_server_certificate::de_delete_server_certificate_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteServerCertificateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_server_certificate::DeleteServerCertificateInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_server_certificate::DeleteServerCertificateInput,
...
impl ::aws_types::request_id::RequestId for super::operation::delete_server_certificate::DeleteServerCertificateError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_server_certificate::_delete_server_certificate_input::DeleteServerCertificateInput;

pub use super::operation::delete_server_certificate::_delete_server_certificate_output::DeleteServerCertificateOutput;
