...
impl ListUserPoliciesInput {
    ...
    pub fn builder() -> super::operation::list_user_policies::builders::ListUserPoliciesInputBuilder {
        super::operation::list_user_policies::builders::ListUserPoliciesInputBuilder::default()
    }
}
...
impl ListUserPoliciesInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_user_policies::ListUserPoliciesInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_user_policies::ListUserPoliciesInput {
