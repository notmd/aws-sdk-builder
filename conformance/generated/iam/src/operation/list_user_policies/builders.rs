...
pub struct Builder {
    input: super::_list_user_policies_input::ListUserPoliciesInputBuilder,
...
impl Builder {
    ...
    pub async fn send(self) -> ::std::result::Result<super::ListUserPoliciesOutput, super::ListUserPoliciesError> {
        let input = self
            .input
            .build()
            .map_err(|error| super::ListUserPoliciesError::Unhandled(error.to_string()))?;
        let path = "/";
        ...
        let response = self
            ...
            .await
            .map_err(super::ListUserPoliciesError::Unhandled)?;
        let status = response.status();
        if !status.is_success() {
            return Err(super::ListUserPoliciesError::unhandled_with_request_ids(
                format!("ListUserPolicies returned HTTP {}", status),
