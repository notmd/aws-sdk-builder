...
impl CreateInstanceProfileInput {
    ...
    pub fn builder() -> super::operation::create_instance_profile::builders::CreateInstanceProfileInputBuilder {
        super::operation::create_instance_profile::builders::CreateInstanceProfileInputBuilder::default()
    }
}
...
impl CreateInstanceProfileInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::create_instance_profile::CreateInstanceProfileInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::create_instance_profile::CreateInstanceProfileInput {
