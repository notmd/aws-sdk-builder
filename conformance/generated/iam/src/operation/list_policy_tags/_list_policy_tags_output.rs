...
impl ListPolicyTagsOutput {
    ...
    pub fn builder() -> super::operation::list_policy_tags::builders::ListPolicyTagsOutputBuilder {
        super::operation::list_policy_tags::builders::ListPolicyTagsOutputBuilder::default()
    }
}
...
impl ListPolicyTagsOutputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_policy_tags::ListPolicyTagsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_policy_tags::ListPolicyTagsOutput {
