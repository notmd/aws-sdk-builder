...
pub mod _attach_group_policy_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/attach_group_policy/_attach_group_policy_input.rs"
    ));
}
...
pub mod _attach_group_policy_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/attach_group_policy/_attach_group_policy_output.rs"
    ));
}
