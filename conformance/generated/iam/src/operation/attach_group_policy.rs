...
pub mod _attach_group_policy_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/attach_group_policy/_attach_group_policy_input.rs"));
}
pub use _attach_group_policy_input::AttachGroupPolicyInput;
pub type Input = AttachGroupPolicyInput;
pub mod _attach_group_policy_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/attach_group_policy/_attach_group_policy_output.rs"));
}
pub use _attach_group_policy_output::AttachGroupPolicyOutput;
pub type Output = AttachGroupPolicyOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/attach_group_policy/builders.rs"));
}
