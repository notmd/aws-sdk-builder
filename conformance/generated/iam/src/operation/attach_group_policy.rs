// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        impl AttachGroupPolicy { pub fn new() -> Self { Self } }
        #[derive(Clone, Debug, Default)]
        pub struct Input {
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output;
        pub type AttachGroupPolicyInput = Input;
        pub type AttachGroupPolicyOutput = Output;
        pub type AttachGroupPolicyError = Error;
        #[derive(Clone, Debug)]
        pub enum Error {
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::AttachGroupPolicyOutput, super::AttachGroupPolicyError> {
                         let path = "/";
                         let body = ::std::vec::Vec::new();
                         let headers = ::std::vec::Vec::new();
                         let response = self.client.request(super::super::super::transport::Method::Post, &path, &headers, &body).await.map_err(super::AttachGroupPolicyError::Unhandled)?;
...
pub use builders::Builder;
        pub type AttachGroupPolicyFluentBuilder = builders::Builder;
