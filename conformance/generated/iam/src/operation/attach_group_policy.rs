...
impl AttachGroupPolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::attach_group_policy::AttachGroupPolicyInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::attach_group_policy::AttachGroupPolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::attach_group_policy::AttachGroupPolicyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AttachGroupPolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_attach_group_policy::de_attach_group_policy_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_attach_group_policy::de_attach_group_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AttachGroupPolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::attach_group_policy::AttachGroupPolicyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::attach_group_policy::AttachGroupPolicyInput,
...
impl ::aws_types::request_id::RequestId for super::operation::attach_group_policy::AttachGroupPolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::attach_group_policy::_attach_group_policy_input::AttachGroupPolicyInput;

pub use super::operation::attach_group_policy::_attach_group_policy_output::AttachGroupPolicyOutput;
