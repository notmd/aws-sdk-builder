...
impl DeactivateMfaDeviceInput {
    ...
    pub fn builder() -> super::operation::deactivate_mfa_device::builders::DeactivateMfaDeviceInputBuilder {
        super::operation::deactivate_mfa_device::builders::DeactivateMfaDeviceInputBuilder::default()
    }
}
...
impl DeactivateMfaDeviceInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::deactivate_mfa_device::DeactivateMfaDeviceInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::deactivate_mfa_device::DeactivateMfaDeviceInput {
