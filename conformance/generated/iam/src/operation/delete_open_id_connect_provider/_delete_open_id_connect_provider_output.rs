...
impl DeleteOpenIdConnectProviderOutput {
    ...
    pub fn builder() -> super::operation::delete_open_id_connect_provider::builders::DeleteOpenIdConnectProviderOutputBuilder {
        super::operation::delete_open_id_connect_provider::builders::DeleteOpenIdConnectProviderOutputBuilder::default()
    }
}
...
impl DeleteOpenIdConnectProviderOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_open_id_connect_provider::DeleteOpenIdConnectProviderOutput {
