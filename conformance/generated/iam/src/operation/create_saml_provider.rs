...
pub mod _create_saml_provider_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/create_saml_provider/_create_saml_provider_input.rs"
    ));
}
...
pub mod _create_saml_provider_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/create_saml_provider/_create_saml_provider_output.rs"
    ));
}
