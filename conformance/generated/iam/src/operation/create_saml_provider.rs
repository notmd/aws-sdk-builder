...
impl CreateSamlProvider {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::create_saml_provider::CreateSamlProviderInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::create_saml_provider::CreateSAMLProviderError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::create_saml_provider::CreateSamlProviderOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateSAMLProviderResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_create_saml_provider::de_create_saml_provider_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_create_saml_provider::de_create_saml_provider_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateSAMLProviderRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::create_saml_provider::CreateSamlProviderInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::create_saml_provider::CreateSamlProviderInput,
...
impl ::aws_types::request_id::RequestId for super::operation::create_saml_provider::CreateSAMLProviderError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::create_saml_provider::_create_saml_provider_input::CreateSamlProviderInput;

pub use super::operation::create_saml_provider::_create_saml_provider_output::CreateSamlProviderOutput;
