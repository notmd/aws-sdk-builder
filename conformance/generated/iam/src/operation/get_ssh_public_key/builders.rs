    ...
    pub fn build(self) -> super::Input { self.input }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::GetSshPublicKeyOutput, super::GetSshPublicKeyError> {
                         ...
                         if !status.is_success() {
                             return Err(super::GetSshPublicKeyError::unhandled_with_request_ids(format!("GetSshPublicKey returned HTTP {}", status), response.header("x-amzn-requestid").map(str::to_owned), ::std::option::Option::None));
                         }
