...
impl GetInstanceProfile {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::get_instance_profile::GetInstanceProfileInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_instance_profile::GetInstanceProfileError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_instance_profile::GetInstanceProfileOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetInstanceProfileResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_instance_profile::de_get_instance_profile_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_instance_profile::de_get_instance_profile_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetInstanceProfileRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_instance_profile::GetInstanceProfileInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_instance_profile::GetInstanceProfileInput,
...
impl ::aws_types::request_id::RequestId for super::operation::get_instance_profile::GetInstanceProfileError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_instance_profile::_get_instance_profile_input::GetInstanceProfileInput;

pub use super::operation::get_instance_profile::_get_instance_profile_output::GetInstanceProfileOutput;
