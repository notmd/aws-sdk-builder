...
pub mod _get_instance_profile_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/get_instance_profile/_get_instance_profile_input.rs"
    ));
}
...
pub mod _get_instance_profile_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/get_instance_profile/_get_instance_profile_output.rs"
    ));
}
