...
impl DeleteRole {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::delete_role::DeleteRoleInput,
    ) -> ::std::result::Result<
        super::operation::delete_role::DeleteRoleOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::delete_role::DeleteRoleError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_role::DeleteRoleError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_role::DeleteRoleOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteRoleResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_role::de_delete_role_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_role::de_delete_role_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteRoleRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::delete_role::DeleteRoleInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_role::DeleteRoleInput,
...
impl ::aws_types::request_id::RequestId for super::operation::delete_role::DeleteRoleError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_role::_delete_role_input::DeleteRoleInput;

pub use super::operation::delete_role::_delete_role_output::DeleteRoleOutput;
