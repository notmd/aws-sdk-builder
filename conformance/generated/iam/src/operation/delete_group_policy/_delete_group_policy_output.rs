...
impl DeleteGroupPolicyOutput {
    ...
    pub fn builder() -> super::operation::delete_group_policy::builders::DeleteGroupPolicyOutputBuilder {
        super::operation::delete_group_policy::builders::DeleteGroupPolicyOutputBuilder::default()
    }
}
...
impl DeleteGroupPolicyOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_group_policy::DeleteGroupPolicyOutput {
