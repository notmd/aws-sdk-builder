...
impl DeleteGroupPolicyInput {
    ...
    pub fn builder() -> super::operation::delete_group_policy::builders::DeleteGroupPolicyInputBuilder {
        super::operation::delete_group_policy::builders::DeleteGroupPolicyInputBuilder::default()
    }
}
...
impl DeleteGroupPolicyInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::delete_group_policy::DeleteGroupPolicyInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::delete_group_policy::DeleteGroupPolicyInput {
