...
pub mod _get_account_properties_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/get_account_properties/_get_account_properties_input.rs"
    ));
}
...
pub mod _get_account_properties_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/get_account_properties/_get_account_properties_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/get_account_properties/builders.rs"
    ));
}
