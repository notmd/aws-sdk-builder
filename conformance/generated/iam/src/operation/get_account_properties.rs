...
pub mod _get_account_properties_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/get_account_properties/_get_account_properties_input.rs"));
}
pub use _get_account_properties_input::GetAccountPropertiesInput;
pub type Input = GetAccountPropertiesInput;
pub mod _get_account_properties_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/get_account_properties/_get_account_properties_output.rs"));
}
pub use _get_account_properties_output::GetAccountPropertiesOutput;
pub type Output = GetAccountPropertiesOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/get_account_properties/builders.rs"));
}
