...
impl GetPolicyVersionInput {
    ...
    pub fn builder() -> super::operation::get_policy_version::builders::GetPolicyVersionInputBuilder {
        super::operation::get_policy_version::builders::GetPolicyVersionInputBuilder::default()
    }
}
...
impl GetPolicyVersionInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_policy_version::GetPolicyVersionInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_policy_version::GetPolicyVersionInput {
