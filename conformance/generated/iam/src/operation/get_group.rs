...
pub mod _get_group_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/get_group/_get_group_input.rs"));
}
pub use _get_group_input::GetGroupInput;
pub type Input = GetGroupInput;
pub mod _get_group_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/get_group/_get_group_output.rs"));
}
pub use _get_group_output::GetGroupOutput;
pub type Output = GetGroupOutput;
