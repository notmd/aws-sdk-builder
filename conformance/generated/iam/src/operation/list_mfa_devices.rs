// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        pub struct Output {
            ...
            pub mfa_devices: ::std::option::Option<super::super::types::MfaDeviceListType>,
        ...
        impl Output {
            ...
            pub fn mfa_devices(&self) -> &[super::super::types::MfaDevice] { self.mfa_devices.as_deref().unwrap_or(&[]) }
            pub fn marker(&self) -> ::std::option::Option<&str> { self.marker.as_deref() }
        }
        pub type ListMfaDevicesInput = Input;
        pub type ListMfaDevicesOutput = Output;
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::ListMfaDevicesOutput, super::ListMfaDevicesError> {
                         ...
                         Ok(super::ListMfaDevicesOutput::default())
                     }
                 }
}
