...
impl DeleteAccessKey {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::delete_access_key::DeleteAccessKeyInput,
    ) -> ::std::result::Result<
        super::operation::delete_access_key::DeleteAccessKeyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::delete_access_key::DeleteAccessKeyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_access_key::DeleteAccessKeyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_access_key::DeleteAccessKeyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteAccessKeyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_access_key::de_delete_access_key_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_access_key::de_delete_access_key_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteAccessKeyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_access_key::DeleteAccessKeyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_access_key::DeleteAccessKeyInput,
...
impl ::aws_types::request_id::RequestId for super::operation::delete_access_key::DeleteAccessKeyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_access_key::_delete_access_key_input::DeleteAccessKeyInput;

pub use super::operation::delete_access_key::_delete_access_key_output::DeleteAccessKeyOutput;
