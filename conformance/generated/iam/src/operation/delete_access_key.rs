...
impl DeleteAccessKey { pub fn new() -> Self { Self } }
#[derive(Clone, Debug)]
pub enum Error {
...
pub mod _delete_access_key_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/delete_access_key/_delete_access_key_input.rs"));
}
pub use _delete_access_key_input::DeleteAccessKeyInput;
pub type Input = DeleteAccessKeyInput;
pub mod _delete_access_key_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/delete_access_key/_delete_access_key_output.rs"));
}
pub use _delete_access_key_output::DeleteAccessKeyOutput;
pub type Output = DeleteAccessKeyOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/delete_access_key/builders.rs"));
}
pub type DeleteAccessKeyError = Error;
pub type DeleteAccessKeyFluentBuilder = builders::Builder;
