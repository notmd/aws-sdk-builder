...
pub mod _send_delegation_token_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/send_delegation_token/_send_delegation_token_input.rs"
    ));
}
...
pub mod _send_delegation_token_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/send_delegation_token/_send_delegation_token_output.rs"
    ));
}
