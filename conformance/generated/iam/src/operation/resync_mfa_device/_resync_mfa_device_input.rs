...
impl ResyncMfaDeviceInput {
    ...
    pub fn builder() -> super::operation::resync_mfa_device::builders::ResyncMfaDeviceInputBuilder {
        super::operation::resync_mfa_device::builders::ResyncMfaDeviceInputBuilder::default()
    }
}
...
impl ResyncMfaDeviceInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::resync_mfa_device::ResyncMfaDeviceInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::resync_mfa_device::ResyncMfaDeviceInput {
