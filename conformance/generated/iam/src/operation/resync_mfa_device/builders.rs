    ...
    pub fn build(self) -> super::Input { self.input }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::ResyncMfaDeviceOutput, super::ResyncMfaDeviceError> {
                         ...
                         if !status.is_success() {
                             return Err(super::ResyncMfaDeviceError::unhandled_with_request_ids(format!("ResyncMfaDevice returned HTTP {}", status), response.header("x-amzn-requestid").map(str::to_owned), ::std::option::Option::None));
                         }
