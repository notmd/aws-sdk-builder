...
impl TagInstanceProfile {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::tag_instance_profile::TagInstanceProfileInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::tag_instance_profile::TagInstanceProfileError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::tag_instance_profile::TagInstanceProfileOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for TagInstanceProfileResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_tag_instance_profile::de_tag_instance_profile_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_tag_instance_profile::de_tag_instance_profile_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for TagInstanceProfileRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::tag_instance_profile::TagInstanceProfileInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::tag_instance_profile::TagInstanceProfileInput,
...
impl ::aws_types::request_id::RequestId for super::operation::tag_instance_profile::TagInstanceProfileError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::tag_instance_profile::_tag_instance_profile_input::TagInstanceProfileInput;

pub use super::operation::tag_instance_profile::_tag_instance_profile_output::TagInstanceProfileOutput;
