...
pub mod _tag_instance_profile_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/tag_instance_profile/_tag_instance_profile_input.rs"
    ));
}
...
pub mod _tag_instance_profile_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/tag_instance_profile/_tag_instance_profile_output.rs"
    ));
}
