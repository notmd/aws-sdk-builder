// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        impl TagInstanceProfile { pub fn new() -> Self { Self } }
        #[derive(Clone, Debug, Default)]
        pub struct Input {
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output;
        pub type TagInstanceProfileInput = Input;
        pub type TagInstanceProfileOutput = Output;
        pub type TagInstanceProfileError = Error;
        #[derive(Clone, Debug)]
        pub enum Error {
...
pub use builders::Builder;
        pub type TagInstanceProfileFluentBuilder = builders::Builder;
