...
impl DeleteAccountAliasInput {
    ...
    pub fn builder() -> super::operation::delete_account_alias::builders::DeleteAccountAliasInputBuilder {
        super::operation::delete_account_alias::builders::DeleteAccountAliasInputBuilder::default()
    }
}
...
impl DeleteAccountAliasInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::delete_account_alias::DeleteAccountAliasInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::delete_account_alias::DeleteAccountAliasInput {
