...
impl UntagOpenIdConnectProviderInput {
    ...
    pub fn builder() -> super::operation::untag_open_id_connect_provider::builders::UntagOpenIdConnectProviderInputBuilder {
        super::operation::untag_open_id_connect_provider::builders::UntagOpenIdConnectProviderInputBuilder::default()
    }
}
...
impl UntagOpenIdConnectProviderInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::untag_open_id_connect_provider::UntagOpenIdConnectProviderInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::untag_open_id_connect_provider::UntagOpenIdConnectProviderInput {
