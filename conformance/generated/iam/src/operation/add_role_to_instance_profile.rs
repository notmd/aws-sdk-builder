// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        impl AddRoleToInstanceProfile { pub fn new() -> Self { Self } }
        #[derive(Clone, Debug, Default)]
        pub struct Input {
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output;
        pub type AddRoleToInstanceProfileInput = Input;
        pub type AddRoleToInstanceProfileOutput = Output;
        pub type AddRoleToInstanceProfileError = Error;
        #[derive(Clone, Debug)]
        pub enum Error {
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::AddRoleToInstanceProfileOutput, super::AddRoleToInstanceProfileError> {
                         let path = "/";
...
pub use builders::Builder;
        pub type AddRoleToInstanceProfileFluentBuilder = builders::Builder;
