...
pub mod _list_attached_group_policies_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/list_attached_group_policies/_list_attached_group_policies_input.rs"
    ));
}
...
pub mod _list_attached_group_policies_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/list_attached_group_policies/_list_attached_group_policies_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/list_attached_group_policies/builders.rs"
    ));
}
