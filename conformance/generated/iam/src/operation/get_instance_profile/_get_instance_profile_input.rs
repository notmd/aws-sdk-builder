...
impl GetInstanceProfileInput {
    ...
    pub fn builder() -> super::operation::get_instance_profile::builders::GetInstanceProfileInputBuilder {
        super::operation::get_instance_profile::builders::GetInstanceProfileInputBuilder::default()
    }
}
...
impl GetInstanceProfileInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_instance_profile::GetInstanceProfileInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::get_instance_profile::GetInstanceProfileInput {
