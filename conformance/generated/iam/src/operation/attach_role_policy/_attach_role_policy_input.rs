...
impl AttachRolePolicyInput {
    ...
    pub fn builder() -> super::operation::attach_role_policy::builders::AttachRolePolicyInputBuilder {
        super::operation::attach_role_policy::builders::AttachRolePolicyInputBuilder::default()
    }
}
...
impl AttachRolePolicyInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::attach_role_policy::AttachRolePolicyInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::attach_role_policy::AttachRolePolicyInput {
