...
pub mod _get_group_policy_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/get_group_policy/_get_group_policy_input.rs"));
}
pub use _get_group_policy_input::GetGroupPolicyInput;
pub type Input = GetGroupPolicyInput;
pub mod _get_group_policy_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/get_group_policy/_get_group_policy_output.rs"));
}
pub use _get_group_policy_output::GetGroupPolicyOutput;
pub type Output = GetGroupPolicyOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/get_group_policy/builders.rs"));
}
