...
impl GetGroupPolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::get_group_policy::GetGroupPolicyInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_group_policy::GetGroupPolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_group_policy::GetGroupPolicyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetGroupPolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_group_policy::de_get_group_policy_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_group_policy::de_get_group_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetGroupPolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_group_policy::GetGroupPolicyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_group_policy::GetGroupPolicyInput,
...
impl ::aws_types::request_id::RequestId for super::operation::get_group_policy::GetGroupPolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_group_policy::_get_group_policy_input::GetGroupPolicyInput;

pub use super::operation::get_group_policy::_get_group_policy_output::GetGroupPolicyOutput;
