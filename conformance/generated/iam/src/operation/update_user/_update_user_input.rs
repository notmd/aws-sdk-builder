...
impl UpdateUserInput {
    ...
    pub fn builder() -> super::operation::update_user::builders::UpdateUserInputBuilder {
        super::operation::update_user::builders::UpdateUserInputBuilder::default()
    }
}
...
impl UpdateUserInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::update_user::UpdateUserInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::update_user::UpdateUserInput {
