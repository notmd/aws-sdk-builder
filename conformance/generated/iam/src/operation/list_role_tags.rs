...
impl ListRoleTags {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::list_role_tags::ListRoleTagsInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_role_tags::ListRoleTagsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_role_tags::ListRoleTagsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListRoleTagsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_role_tags::de_list_role_tags_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_role_tags::de_list_role_tags_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListRoleTagsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_role_tags::ListRoleTagsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_role_tags::ListRoleTagsInput,
...
impl ::aws_types::request_id::RequestId for super::operation::list_role_tags::ListRoleTagsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_role_tags::_list_role_tags_input::ListRoleTagsInput;

pub use super::operation::list_role_tags::_list_role_tags_output::ListRoleTagsOutput;
