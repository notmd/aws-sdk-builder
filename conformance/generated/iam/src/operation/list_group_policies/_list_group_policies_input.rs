...
impl ListGroupPoliciesInput {
    ...
    pub fn builder() -> super::operation::list_group_policies::builders::ListGroupPoliciesInputBuilder {
        super::operation::list_group_policies::builders::ListGroupPoliciesInputBuilder::default()
    }
}
...
impl ListGroupPoliciesInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_group_policies::ListGroupPoliciesInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_group_policies::ListGroupPoliciesInput {
