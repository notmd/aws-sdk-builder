...
/// Paginator for [`ListGroupPolicies`](crate::operation::list_group_policies::ListGroupPolicies)
pub struct ListGroupPoliciesPaginator {
    handle: std::sync::Arc<super::client::Handle>,
    builder: super::operation::list_group_policies::builders::ListGroupPoliciesInputBuilder,
...
impl ListGroupPoliciesPaginator {
    ...
    pub fn items(self) -> super::operation::list_group_policies::paginator::ListGroupPoliciesPaginatorItems {
        super::operation::list_group_policies::paginator::ListGroupPoliciesPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::operation::list_group_policies::ListGroupPolicies::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_list_group_policies_output_output_marker(resp);
...
impl ListGroupPoliciesPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::lens::lens_list_group_policies_output_output_policy_names(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
