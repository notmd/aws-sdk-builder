...
pub mod _accept_delegation_request_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/accept_delegation_request/_accept_delegation_request_input.rs"));
}
pub use _accept_delegation_request_input::AcceptDelegationRequestInput;
pub type Input = AcceptDelegationRequestInput;
pub mod _accept_delegation_request_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/accept_delegation_request/_accept_delegation_request_output.rs"));
}
pub use _accept_delegation_request_output::AcceptDelegationRequestOutput;
pub type Output = AcceptDelegationRequestOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/accept_delegation_request/builders.rs"));
}
