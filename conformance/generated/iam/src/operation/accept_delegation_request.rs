...
pub mod _accept_delegation_request_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/accept_delegation_request/_accept_delegation_request_input.rs"
    ));
}
...
pub mod _accept_delegation_request_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/accept_delegation_request/_accept_delegation_request_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/accept_delegation_request/builders.rs"
    ));
}
