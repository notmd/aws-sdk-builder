...
pub mod _create_group_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/create_group/_create_group_input.rs"));
}
pub use _create_group_input::CreateGroupInput;
pub type Input = CreateGroupInput;
pub mod _create_group_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/create_group/_create_group_output.rs"));
}
pub use _create_group_output::CreateGroupOutput;
pub type Output = CreateGroupOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/create_group/builders.rs"));
}
