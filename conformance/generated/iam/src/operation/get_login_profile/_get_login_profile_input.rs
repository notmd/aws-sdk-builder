...
impl GetLoginProfileInput {
    ...
    pub fn builder() -> super::operation::get_login_profile::builders::GetLoginProfileInputBuilder {
        super::operation::get_login_profile::builders::GetLoginProfileInputBuilder::default()
    }
}
...
impl GetLoginProfileInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_login_profile::GetLoginProfileInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_login_profile::GetLoginProfileInput { user_name: self.user_name })
    }
}
