...
impl GetLoginProfileInputBuilder {
    ...
    pub fn build(self) -> crate::operation::get_login_profile::GetLoginProfileInput {
        crate::operation::get_login_profile::GetLoginProfileInput { user_name: self.user_name }
    }
}
