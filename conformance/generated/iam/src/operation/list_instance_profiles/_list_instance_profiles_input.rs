...
impl ListInstanceProfilesInput {
    pub fn builder() -> ListInstanceProfilesInputBuilder { ListInstanceProfilesInputBuilder::default() }
}
#[derive(Clone, Debug, Default)]
...
impl ListInstanceProfilesInputBuilder {
    ...
    pub fn build(self) -> ListInstanceProfilesInput { ListInstanceProfilesInput {
        marker: self.marker,
