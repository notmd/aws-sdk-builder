...
impl ListInstanceProfilesInput {
    ...
    pub fn builder() -> super::operation::list_instance_profiles::builders::ListInstanceProfilesInputBuilder {
        super::operation::list_instance_profiles::builders::ListInstanceProfilesInputBuilder::default()
    }
}
...
impl ListInstanceProfilesInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_instance_profiles::ListInstanceProfilesInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::list_instance_profiles::ListInstanceProfilesInput {
