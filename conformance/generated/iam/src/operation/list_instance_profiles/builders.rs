...
pub struct Builder {
    input: super::_list_instance_profiles_input::ListInstanceProfilesInputBuilder,
...
impl Builder {
    ...
    pub async fn send(self) -> ::std::result::Result<super::ListInstanceProfilesOutput, super::ListInstanceProfilesError> {
        let input = self
            .input
            .build()
            .map_err(|error| super::ListInstanceProfilesError::Unhandled(error.to_string()))?;
        let path = "/";
        ...
        let response = self
            ...
            .await
            .map_err(super::ListInstanceProfilesError::Unhandled)?;
        let status = response.status();
        if !status.is_success() {
            return Err(super::ListInstanceProfilesError::unhandled_with_request_ids(
                format!("ListInstanceProfiles returned HTTP {}", status),
