...
/// Paginator for [`ListInstanceProfiles`](crate::operation::list_instance_profiles::ListInstanceProfiles)
pub struct ListInstanceProfilesPaginator {
    handle: std::sync::Arc<super::client::Handle>,
    builder: super::operation::list_instance_profiles::builders::ListInstanceProfilesInputBuilder,
...
impl ListInstanceProfilesPaginator {
    ...
    pub fn items(self) -> super::operation::list_instance_profiles::paginator::ListInstanceProfilesPaginatorItems {
        super::operation::list_instance_profiles::paginator::ListInstanceProfilesPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::operation::list_instance_profiles::ListInstanceProfiles::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_list_instance_profiles_output_output_marker(resp);
...
impl ListInstanceProfilesPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::lens::lens_list_instance_profiles_output_output_instance_profiles(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
