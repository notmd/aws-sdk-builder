...
impl GetPolicyVersion {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::get_policy_version::GetPolicyVersionInput,
    ) -> ::std::result::Result<
        super::operation::get_policy_version::GetPolicyVersionOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::get_policy_version::GetPolicyVersionError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_policy_version::GetPolicyVersionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_policy_version::GetPolicyVersionOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetPolicyVersionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_policy_version::de_get_policy_version_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_policy_version::de_get_policy_version_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetPolicyVersionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_policy_version::GetPolicyVersionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_policy_version::GetPolicyVersionInput,
...
impl ::aws_types::request_id::RequestId for super::operation::get_policy_version::GetPolicyVersionError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_policy_version::_get_policy_version_input::GetPolicyVersionInput;

pub use super::operation::get_policy_version::_get_policy_version_output::GetPolicyVersionOutput;
