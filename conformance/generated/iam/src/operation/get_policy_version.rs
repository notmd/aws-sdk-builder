...
pub mod _get_policy_version_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/get_policy_version/_get_policy_version_input.rs"));
}
pub use _get_policy_version_input::GetPolicyVersionInput;
pub type Input = GetPolicyVersionInput;
pub mod _get_policy_version_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/get_policy_version/_get_policy_version_output.rs"));
}
pub use _get_policy_version_output::GetPolicyVersionOutput;
pub type Output = GetPolicyVersionOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/get_policy_version/builders.rs"));
}
