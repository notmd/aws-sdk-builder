...
pub mod _get_policy_version_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/get_policy_version/_get_policy_version_input.rs"
    ));
}
...
pub mod _get_policy_version_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/get_policy_version/_get_policy_version_output.rs"
    ));
}
