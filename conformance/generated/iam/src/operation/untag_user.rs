...
impl UntagUser {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::untag_user::UntagUserInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::untag_user::UntagUserError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::untag_user::UntagUserOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UntagUserResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_untag_user::de_untag_user_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_untag_user::de_untag_user_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UntagUserRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::untag_user::UntagUserInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::untag_user::UntagUserInput,
...
impl ::aws_types::request_id::RequestId for super::operation::untag_user::UntagUserError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::untag_user::_untag_user_input::UntagUserInput;

pub use super::operation::untag_user::_untag_user_output::UntagUserOutput;
