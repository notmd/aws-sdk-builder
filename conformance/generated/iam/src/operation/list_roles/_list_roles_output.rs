...
impl ListRolesOutput {
    ...
    pub fn builder() -> super::operation::list_roles::builders::ListRolesOutputBuilder {
        super::operation::list_roles::builders::ListRolesOutputBuilder::default()
    }
}
...
impl ListRolesOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::list_roles::ListRolesOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_roles::ListRolesOutput {
