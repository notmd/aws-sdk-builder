...
pub mod _create_policy_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/create_policy/_create_policy_input.rs"));
}
pub use _create_policy_input::CreatePolicyInput;
pub type Input = CreatePolicyInput;
pub mod _create_policy_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/create_policy/_create_policy_output.rs"));
}
pub use _create_policy_output::CreatePolicyOutput;
pub type Output = CreatePolicyOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/create_policy/builders.rs"));
}
