...
impl CreatePolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::create_policy::CreatePolicyInput,
    ) -> ::std::result::Result<
        super::operation::create_policy::CreatePolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::create_policy::CreatePolicyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::create_policy::CreatePolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::create_policy::CreatePolicyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreatePolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_create_policy::de_create_policy_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_create_policy::de_create_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreatePolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::create_policy::CreatePolicyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::create_policy::CreatePolicyInput,
...
impl ::aws_types::request_id::RequestId for super::operation::create_policy::CreatePolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::create_policy::_create_policy_input::CreatePolicyInput;

pub use super::operation::create_policy::_create_policy_output::CreatePolicyOutput;
