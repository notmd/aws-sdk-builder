...
pub mod _list_delegation_requests_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/list_delegation_requests/_list_delegation_requests_input.rs"
    ));
}
...
pub mod _list_delegation_requests_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/list_delegation_requests/_list_delegation_requests_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/list_delegation_requests/builders.rs"
    ));
}
