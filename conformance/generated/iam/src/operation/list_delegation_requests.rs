...
pub mod _list_delegation_requests_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/list_delegation_requests/_list_delegation_requests_input.rs"));
}
pub use _list_delegation_requests_input::ListDelegationRequestsInput;
pub type Input = ListDelegationRequestsInput;
pub mod _list_delegation_requests_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/list_delegation_requests/_list_delegation_requests_output.rs"));
}
pub use _list_delegation_requests_output::ListDelegationRequestsOutput;
pub type Output = ListDelegationRequestsOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/list_delegation_requests/builders.rs"));
}
