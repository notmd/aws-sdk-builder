// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output {
            pub delegation_requests: ::std::option::Option<super::super::types::DelegationRequestsListType>,
            pub marker: ::std::option::Option<super::super::types::MarkerType>,
            pub is_truncated: ::std::option::Option<super::super::types::BooleanType>,
        }
        impl Output {
            pub fn delegation_requests(&self) -> &[super::super::types::DelegationRequest] { self.delegation_requests.as_deref().unwrap_or(&[]) }
            pub fn marker(&self) -> ::std::option::Option<&str> { self.marker.as_deref() }
            pub fn is_truncated(&self) -> ::std::option::Option<bool> { self.is_truncated }
        }
        pub type ListDelegationRequestsInput = Input;
        pub type ListDelegationRequestsOutput = Output;
        pub type ListDelegationRequestsError = Error;
        #[derive(Clone, Debug)]
        pub enum Error {
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::ListDelegationRequestsOutput, super::ListDelegationRequestsError> {
                         ...
                         let response = self.client.request(super::super::super::transport::Method::Post, &path, &headers, &body).await.map_err(super::ListDelegationRequestsError::Unhandled)?;
...
pub use builders::Builder;
        pub type ListDelegationRequestsFluentBuilder = builders::Builder;
