...
pub struct GetDelegationRequestOutput {
    ...
    pub delegation_request: ::std::option::Option<super::types::DelegationRequest>,
    ...
    /// </ul>
    pub permission_check_status: ::std::option::Option<super::types::PermissionCheckStatusType>,
    ...
    /// </ul>
    pub permission_check_result: ::std::option::Option<super::types::PermissionCheckResultType>,
    _request_id: Option<String>,
}
impl GetDelegationRequestOutput {
    /// <p>The delegation request object containing all details about the request.</p>
    pub fn delegation_request(&self) -> ::std::option::Option<&super::types::DelegationRequest> {
    ...
    /// <p><code>FAILED</code> : The permission check process has failed.</p></li>
    /// </ul>
    pub fn permission_check_status(&self) -> ::std::option::Option<&super::types::PermissionCheckStatusType> {
    ...
    /// <p><code>UNSURE</code> : It is not possible to determine whether the caller has all the permissions needed. This output is most likely for cases when the caller has permissions with conditions.</p></li>
    /// </ul>
    pub fn permission_check_result(&self) -> ::std::option::Option<&super::types::PermissionCheckResultType> {
...
impl GetDelegationRequestOutput {
    ...
    pub fn builder() -> super::operation::get_delegation_request::builders::GetDelegationRequestOutputBuilder {
        super::operation::get_delegation_request::builders::GetDelegationRequestOutputBuilder::default()
    }
}
...
pub struct GetDelegationRequestOutputBuilder {
    pub(crate) delegation_request: ::std::option::Option<super::types::DelegationRequest>,
    pub(crate) permission_check_status: ::std::option::Option<super::types::PermissionCheckStatusType>,
    pub(crate) permission_check_result: ::std::option::Option<super::types::PermissionCheckResultType>,
    _request_id: Option<String>,
}
impl GetDelegationRequestOutputBuilder {
    /// <p>The delegation request object containing all details about the request.</p>
    pub fn delegation_request(mut self, input: super::types::DelegationRequest) -> Self {
        self.delegation_request = ::std::option::Option::Some(input);
        self
    }
    /// <p>The delegation request object containing all details about the request.</p>
    pub fn set_delegation_request(mut self, input: ::std::option::Option<super::types::DelegationRequest>) -> Self {
        self.delegation_request = input;
        self
    }
    /// <p>The delegation request object containing all details about the request.</p>
    pub fn get_delegation_request(&self) -> &::std::option::Option<super::types::DelegationRequest> {
    ...
    /// <p><code>FAILED</code> : The permission check process has failed.</p></li>
    /// </ul>
    pub fn permission_check_status(mut self, input: super::types::PermissionCheckStatusType) -> Self {
    ...
    /// <p><code>FAILED</code> : The permission check process has failed.</p></li>
    /// </ul>
    pub fn set_permission_check_status(mut self, input: ::std::option::Option<super::types::PermissionCheckStatusType>) -> Self {
    ...
    /// <p><code>FAILED</code> : The permission check process has failed.</p></li>
    /// </ul>
    pub fn get_permission_check_status(&self) -> &::std::option::Option<super::types::PermissionCheckStatusType> {
    ...
    /// <p><code>UNSURE</code> : It is not possible to determine whether the caller has all the permissions needed. This output is most likely for cases when the caller has permissions with conditions.</p></li>
    /// </ul>
    pub fn permission_check_result(mut self, input: super::types::PermissionCheckResultType) -> Self {
    ...
    /// <p><code>UNSURE</code> : It is not possible to determine whether the caller has all the permissions needed. This output is most likely for cases when the caller has permissions with conditions.</p></li>
    /// </ul>
    pub fn set_permission_check_result(mut self, input: ::std::option::Option<super::types::PermissionCheckResultType>) -> Self {
    ...
    /// <p><code>UNSURE</code> : It is not possible to determine whether the caller has all the permissions needed. This output is most likely for cases when the caller has permissions with conditions.</p></li>
    /// </ul>
    pub fn get_permission_check_result(&self) -> &::std::option::Option<super::types::PermissionCheckResultType> {
    ...
    pub fn build(self) -> super::operation::get_delegation_request::GetDelegationRequestOutput {
        super::operation::get_delegation_request::GetDelegationRequestOutput {
