...
impl CreateAccountAlias {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::create_account_alias::CreateAccountAliasInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::create_account_alias::CreateAccountAliasError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::create_account_alias::CreateAccountAliasOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateAccountAliasResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_create_account_alias::de_create_account_alias_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_create_account_alias::de_create_account_alias_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateAccountAliasRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::create_account_alias::CreateAccountAliasInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::create_account_alias::CreateAccountAliasInput,
...
impl ::aws_types::request_id::RequestId for super::operation::create_account_alias::CreateAccountAliasError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::create_account_alias::_create_account_alias_input::CreateAccountAliasInput;

pub use super::operation::create_account_alias::_create_account_alias_output::CreateAccountAliasOutput;
