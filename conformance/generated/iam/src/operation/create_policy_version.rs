...
pub mod _create_policy_version_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/create_policy_version/_create_policy_version_input.rs"
    ));
}
...
pub mod _create_policy_version_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/create_policy_version/_create_policy_version_output.rs"
    ));
}
