...
impl CreatePolicyVersion {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::create_policy_version::CreatePolicyVersionInput,
    ) -> ::std::result::Result<
        super::operation::create_policy_version::CreatePolicyVersionOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::create_policy_version::CreatePolicyVersionError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::create_policy_version::CreatePolicyVersionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::create_policy_version::CreatePolicyVersionOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreatePolicyVersionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_create_policy_version::de_create_policy_version_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_create_policy_version::de_create_policy_version_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreatePolicyVersionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::create_policy_version::CreatePolicyVersionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::create_policy_version::CreatePolicyVersionInput,
...
impl ::aws_types::request_id::RequestId for super::operation::create_policy_version::CreatePolicyVersionError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::create_policy_version::_create_policy_version_input::CreatePolicyVersionInput;

pub use super::operation::create_policy_version::_create_policy_version_output::CreatePolicyVersionOutput;
