...
impl GetMfaDevice {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::get_mfa_device::GetMfaDeviceInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_mfa_device::GetMFADeviceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_mfa_device::GetMfaDeviceOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetMFADeviceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_mfa_device::de_get_mfa_device_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_mfa_device::de_get_mfa_device_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetMFADeviceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_mfa_device::GetMfaDeviceInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_mfa_device::GetMfaDeviceInput,
...
impl ::aws_types::request_id::RequestId for super::operation::get_mfa_device::GetMFADeviceError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_mfa_device::_get_mfa_device_input::GetMfaDeviceInput;

pub use super::operation::get_mfa_device::_get_mfa_device_output::GetMfaDeviceOutput;
