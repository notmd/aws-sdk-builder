...
pub mod _delete_account_alias_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/delete_account_alias/_delete_account_alias_input.rs"));
}
pub use _delete_account_alias_input::DeleteAccountAliasInput;
pub type Input = DeleteAccountAliasInput;
pub mod _delete_account_alias_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/delete_account_alias/_delete_account_alias_output.rs"));
}
pub use _delete_account_alias_output::DeleteAccountAliasOutput;
pub type Output = DeleteAccountAliasOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/delete_account_alias/builders.rs"));
}
