...
impl DeleteAccountAlias {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::delete_account_alias::DeleteAccountAliasInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_account_alias::DeleteAccountAliasError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_account_alias::DeleteAccountAliasOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteAccountAliasResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_account_alias::de_delete_account_alias_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_account_alias::de_delete_account_alias_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteAccountAliasRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_account_alias::DeleteAccountAliasInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_account_alias::DeleteAccountAliasInput,
...
impl ::aws_types::request_id::RequestId for super::operation::delete_account_alias::DeleteAccountAliasError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_account_alias::_delete_account_alias_input::DeleteAccountAliasInput;

pub use super::operation::delete_account_alias::_delete_account_alias_output::DeleteAccountAliasOutput;
