...
pub mod _delete_account_alias_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/delete_account_alias/_delete_account_alias_input.rs"
    ));
}
...
pub mod _delete_account_alias_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/delete_account_alias/_delete_account_alias_output.rs"
    ));
}
