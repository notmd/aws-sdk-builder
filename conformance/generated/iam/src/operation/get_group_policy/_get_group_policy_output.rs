...
impl GetGroupPolicyOutput {
    ...
    pub fn builder() -> super::operation::get_group_policy::builders::GetGroupPolicyOutputBuilder {
        super::operation::get_group_policy::builders::GetGroupPolicyOutputBuilder::default()
    }
}
...
impl GetGroupPolicyOutputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_group_policy::GetGroupPolicyOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_group_policy::GetGroupPolicyOutput {
