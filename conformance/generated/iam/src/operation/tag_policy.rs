...
impl TagPolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::tag_policy::TagPolicyInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::tag_policy::TagPolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::tag_policy::TagPolicyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for TagPolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_tag_policy::de_tag_policy_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_tag_policy::de_tag_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for TagPolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::tag_policy::TagPolicyInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::tag_policy::TagPolicyInput,
...
impl ::aws_types::request_id::RequestId for super::operation::tag_policy::TagPolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::tag_policy::_tag_policy_input::TagPolicyInput;

pub use super::operation::tag_policy::_tag_policy_output::TagPolicyOutput;
