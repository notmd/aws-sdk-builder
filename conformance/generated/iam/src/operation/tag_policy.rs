// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        impl TagPolicy { pub fn new() -> Self { Self } }
        #[derive(Clone, Debug, Default)]
        pub struct Input {
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output;
        pub type TagPolicyInput = Input;
        pub type TagPolicyOutput = Output;
        pub type TagPolicyError = Error;
        #[derive(Clone, Debug)]
        pub enum Error {
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::TagPolicyOutput, super::TagPolicyError> {
                         ...
                         let response = self.client.request(super::super::super::transport::Method::Post, &path, &headers, &body).await.map_err(super::TagPolicyError::Unhandled)?;
...
pub use builders::Builder;
        pub type TagPolicyFluentBuilder = builders::Builder;
