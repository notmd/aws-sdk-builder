...
pub mod _tag_policy_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/tag_policy/_tag_policy_input.rs"));
}
pub use _tag_policy_input::TagPolicyInput;
pub type Input = TagPolicyInput;
pub mod _tag_policy_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/tag_policy/_tag_policy_output.rs"));
}
pub use _tag_policy_output::TagPolicyOutput;
pub type Output = TagPolicyOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/tag_policy/builders.rs"));
}
