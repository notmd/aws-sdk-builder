...
impl TagInstanceProfileInput {
    ...
    pub fn builder() -> super::operation::tag_instance_profile::builders::TagInstanceProfileInputBuilder {
        super::operation::tag_instance_profile::builders::TagInstanceProfileInputBuilder::default()
    }
}
...
impl TagInstanceProfileInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::tag_instance_profile::TagInstanceProfileInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::tag_instance_profile::TagInstanceProfileInput {
