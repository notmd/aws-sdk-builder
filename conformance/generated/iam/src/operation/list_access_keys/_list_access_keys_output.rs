...
pub struct ListAccessKeysOutput {
    ...
    pub access_key_metadata: ::std::vec::Vec<super::types::AccessKeyMetadata>,
...
impl ListAccessKeysOutput {
    /// <p>A list of objects containing metadata about the access keys.</p>
    pub fn access_key_metadata(&self) -> &[super::types::AccessKeyMetadata] {
        use std::ops::Deref;
...
impl ListAccessKeysOutput {
    ...
    pub fn builder() -> super::operation::list_access_keys::builders::ListAccessKeysOutputBuilder {
        super::operation::list_access_keys::builders::ListAccessKeysOutputBuilder::default()
    }
}
...
pub struct ListAccessKeysOutputBuilder {
    pub(crate) access_key_metadata: ::std::option::Option<::std::vec::Vec<super::types::AccessKeyMetadata>>,
...
impl ListAccessKeysOutputBuilder {
    ...
    ///
    /// <p>A list of objects containing metadata about the access keys.</p>
    pub fn access_key_metadata(mut self, input: super::types::AccessKeyMetadata) -> Self {
    ...
    /// <p>A list of objects containing metadata about the access keys.</p>
    pub fn set_access_key_metadata(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::AccessKeyMetadata>>) -> Self {
        self.access_key_metadata = input;
        self
    }
    /// <p>A list of objects containing metadata about the access keys.</p>
    pub fn get_access_key_metadata(&self) -> &::std::option::Option<::std::vec::Vec<super::types::AccessKeyMetadata>> {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_access_keys::ListAccessKeysOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_access_keys::ListAccessKeysOutput {
