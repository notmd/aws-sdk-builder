...
pub struct Builder {
    input: super::_list_access_keys_input::ListAccessKeysInputBuilder,
...
impl Builder {
    ...
    pub async fn send(self) -> ::std::result::Result<super::ListAccessKeysOutput, super::ListAccessKeysError> {
        let input = self
            .input
            .build()
            .map_err(|error| super::ListAccessKeysError::Unhandled(error.to_string()))?;
        let path = "/";
        ...
        let response = self
            ...
            .await
            .map_err(super::ListAccessKeysError::Unhandled)?;
        let status = response.status();
        if !status.is_success() {
            return Err(super::ListAccessKeysError::unhandled_with_request_ids(
                format!("ListAccessKeys returned HTTP {}", status),
