...
pub struct ListAccessKeysPaginator {
    ...
    builder: super::operation::list_access_keys::builders::ListAccessKeysInputBuilder,
...
impl ListAccessKeysPaginator {
    ...
    pub fn items(self) -> super::operation::list_access_keys::paginator::ListAccessKeysPaginatorItems {
        super::operation::list_access_keys::paginator::ListAccessKeysPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::operation::list_access_keys::ListAccessKeys::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_list_access_keys_output_output_marker(resp);
...
impl ListAccessKeysPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::lens::lens_list_access_keys_output_output_access_key_metadata(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
