// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        impl Input {
            ...
            pub fn status(&self) -> ::std::option::Option<&super::super::types::StatusType> { self.status.as_ref() }
            pub fn user_name(&self) -> ::std::option::Option<&str> { self.user_name.as_deref() }
        }
        #[derive(Clone, Debug, Default)]
        pub struct Output;
        pub type UpdateAccessKeyInput = Input;
        pub type UpdateAccessKeyOutput = Output;
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::UpdateAccessKeyOutput, super::UpdateAccessKeyError> {
                         ...
                         let response = self.client.request(super::super::super::transport::Method::Post, &path, &headers, &body).await.map_err(super::UpdateAccessKeyError::Unhandled)?;
