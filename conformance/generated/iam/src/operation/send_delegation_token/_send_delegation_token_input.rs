...
impl SendDelegationTokenInput {
    ...
    pub fn builder() -> super::operation::send_delegation_token::builders::SendDelegationTokenInputBuilder {
        super::operation::send_delegation_token::builders::SendDelegationTokenInputBuilder::default()
    }
}
...
impl SendDelegationTokenInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::send_delegation_token::SendDelegationTokenInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::send_delegation_token::SendDelegationTokenInput {
