...
impl ListPoliciesGrantingServiceAccessInput {
    ...
    pub fn builder() -> super::operation::list_policies_granting_service_access::builders::ListPoliciesGrantingServiceAccessInputBuilder {
        super::operation::list_policies_granting_service_access::builders::ListPoliciesGrantingServiceAccessInputBuilder::default()
    }
}
...
impl ListPoliciesGrantingServiceAccessInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::list_policies_granting_service_access::ListPoliciesGrantingServiceAccessInput,
