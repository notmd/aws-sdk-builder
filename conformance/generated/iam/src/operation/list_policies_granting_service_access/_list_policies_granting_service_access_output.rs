...
pub struct ListPoliciesGrantingServiceAccessOutput {
    ...
    pub policies_granting_service_access: ::std::vec::Vec<super::types::ListPoliciesGrantingServiceAccessEntry>,
...
impl ListPoliciesGrantingServiceAccessOutput {
    /// <p>A <code>ListPoliciesGrantingServiceAccess</code> object that contains details about the permissions policies attached to the specified identity (user, group, or role).</p>
    pub fn policies_granting_service_access(&self) -> &[super::types::ListPoliciesGrantingServiceAccessEntry] {
        use std::ops::Deref;
...
impl ListPoliciesGrantingServiceAccessOutput {
    ...
    pub fn builder() -> super::operation::list_policies_granting_service_access::builders::ListPoliciesGrantingServiceAccessOutputBuilder {
        super::operation::list_policies_granting_service_access::builders::ListPoliciesGrantingServiceAccessOutputBuilder::default()
    }
}
...
pub struct ListPoliciesGrantingServiceAccessOutputBuilder {
    pub(crate) policies_granting_service_access: ::std::option::Option<::std::vec::Vec<super::types::ListPoliciesGrantingServiceAccessEntry>>,
...
impl ListPoliciesGrantingServiceAccessOutputBuilder {
    ...
    ///
    /// <p>A <code>ListPoliciesGrantingServiceAccess</code> object that contains details about the permissions policies attached to the specified identity (user, group, or role).</p>
    pub fn policies_granting_service_access(mut self, input: super::types::ListPoliciesGrantingServiceAccessEntry) -> Self {
    ...
    pub fn set_policies_granting_service_access(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::ListPoliciesGrantingServiceAccessEntry>>,
    ) -> Self {
    ...
    pub fn get_policies_granting_service_access(
        &self,
    ) -> &::std::option::Option<::std::vec::Vec<super::types::ListPoliciesGrantingServiceAccessEntry>> {
