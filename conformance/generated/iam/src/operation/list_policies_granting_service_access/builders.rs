...
pub use super::operation::list_policies_granting_service_access::_list_policies_granting_service_access_input::ListPoliciesGrantingServiceAccessInputBuilder;

pub use super::operation::list_policies_granting_service_access::_list_policies_granting_service_access_output::ListPoliciesGrantingServiceAccessOutputBuilder;

impl super::operation::list_policies_granting_service_access::builders::ListPoliciesGrantingServiceAccessInputBuilder {
...
/// <ul>
/// <li>
/// <p><b>User</b> – The list of policies includes the managed and inline policies that are attached to the user directly. The list also includes any additional managed and inline policies that are attached to the group to which the user belongs.</p></li>
/// <li>
/// <p><b>Group</b> – The list of policies includes only the managed and inline policies that are attached to the group directly. Policies that are attached to the group’s user are not included.</p></li>
/// <li>
...
pub struct ListPoliciesGrantingServiceAccessFluentBuilder {
    ...
    inner: super::operation::list_policies_granting_service_access::builders::ListPoliciesGrantingServiceAccessInputBuilder,
...
impl ListPoliciesGrantingServiceAccessFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::list_policies_granting_service_access::builders::ListPoliciesGrantingServiceAccessInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::list_policies_granting_service_access::ListPoliciesGrantingServiceAccess::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::list_policies_granting_service_access::ListPoliciesGrantingServiceAccess::orchestrate(&runtime_plugins, input).await
    }
