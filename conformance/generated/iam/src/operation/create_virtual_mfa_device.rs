...
pub mod _create_virtual_mfa_device_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/create_virtual_mfa_device/_create_virtual_mfa_device_input.rs"
    ));
}
...
pub mod _create_virtual_mfa_device_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/create_virtual_mfa_device/_create_virtual_mfa_device_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/operation/create_virtual_mfa_device/builders.rs"
    ));
}
