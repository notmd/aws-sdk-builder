...
pub struct Builder {
    input: super::_list_role_policies_input::ListRolePoliciesInputBuilder,
...
impl Builder {
    ...
    pub async fn send(self) -> ::std::result::Result<super::ListRolePoliciesOutput, super::ListRolePoliciesError> {
        let input = self
            .input
            .build()
            .map_err(|error| super::ListRolePoliciesError::Unhandled(error.to_string()))?;
        let path = "/";
        ...
        let response = self
            ...
            .await
            .map_err(super::ListRolePoliciesError::Unhandled)?;
        let status = response.status();
        if !status.is_success() {
            return Err(super::ListRolePoliciesError::unhandled_with_request_ids(
                format!("ListRolePolicies returned HTTP {}", status),
