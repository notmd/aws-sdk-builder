...
/// Paginator for [`ListRolePolicies`](crate::operation::list_role_policies::ListRolePolicies)
pub struct ListRolePoliciesPaginator {
    handle: std::sync::Arc<super::client::Handle>,
    builder: super::operation::list_role_policies::builders::ListRolePoliciesInputBuilder,
...
impl ListRolePoliciesPaginator {
    ...
    pub fn items(self) -> super::operation::list_role_policies::paginator::ListRolePoliciesPaginatorItems {
        super::operation::list_role_policies::paginator::ListRolePoliciesPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::operation::list_role_policies::ListRolePolicies::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_list_role_policies_output_output_marker(resp);
...
impl ListRolePoliciesPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::lens::lens_list_role_policies_output_output_policy_names(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
