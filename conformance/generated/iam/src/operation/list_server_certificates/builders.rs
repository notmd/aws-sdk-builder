...
pub struct Builder {
    input: super::_list_server_certificates_input::ListServerCertificatesInputBuilder,
...
impl Builder {
    ...
    pub async fn send(self) -> ::std::result::Result<super::ListServerCertificatesOutput, super::ListServerCertificatesError> {
        let input = self
            .input
            .build()
            .map_err(|error| super::ListServerCertificatesError::Unhandled(error.to_string()))?;
        let path = "/";
        ...
        let response = self
            ...
            .await
            .map_err(super::ListServerCertificatesError::Unhandled)?;
        let status = response.status();
        if !status.is_success() {
            return Err(super::ListServerCertificatesError::unhandled_with_request_ids(
                format!("ListServerCertificates returned HTTP {}", status),
