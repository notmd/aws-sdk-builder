...
pub struct ListServerCertificatesPaginator {
    ...
    builder: super::operation::list_server_certificates::builders::ListServerCertificatesInputBuilder,
...
impl ListServerCertificatesPaginator {
    ...
    pub fn items(self) -> super::operation::list_server_certificates::paginator::ListServerCertificatesPaginatorItems {
        super::operation::list_server_certificates::paginator::ListServerCertificatesPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            super::operation::list_server_certificates::ListServerCertificates::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_list_server_certificates_output_output_marker(resp);
...
impl ListServerCertificatesPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::types::ServerCertificateMetadata,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::operation::list_server_certificates::ListServerCertificatesError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::lens::lens_list_server_certificates_output_output_server_certificate_metadata_list(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
