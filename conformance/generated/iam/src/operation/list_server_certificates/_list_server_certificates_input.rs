...
pub struct ListServerCertificatesInput {
    ...
    pub path_prefix: ::std::option::Option<super::super::super::types::PathPrefixType>,
}
...
impl ListServerCertificatesInput {
    pub fn builder() -> ListServerCertificatesInputBuilder { ListServerCertificatesInputBuilder::default() }
}
#[derive(Clone, Debug, Default)]
pub struct ListServerCertificatesInputBuilder {
    ...
    path_prefix: ::std::option::Option<super::super::super::types::PathPrefixType>,
}
impl ListServerCertificatesInputBuilder {
    ...
    pub fn path_prefix(mut self, input: impl ::std::convert::Into<super::super::super::types::PathPrefixType>) -> Self { self.path_prefix = Some(input.into()); self }
    pub fn set_path_prefix(mut self, input: ::std::option::Option<super::super::super::types::PathPrefixType>) -> Self { self.path_prefix = input; self }
    pub fn get_path_prefix(&self) -> &::std::option::Option<super::super::super::types::PathPrefixType> { &self.path_prefix }
    pub fn build(self) -> ListServerCertificatesInput { ListServerCertificatesInput {
        marker: self.marker,
