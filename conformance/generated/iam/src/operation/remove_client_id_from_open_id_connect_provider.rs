...
impl RemoveClientIdFromOpenIdConnectProvider {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::remove_client_id_from_open_id_connect_provider::RemoveClientIdFromOpenIdConnectProviderInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::remove_client_id_from_open_id_connect_provider::RemoveClientIDFromOpenIDConnectProviderError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::remove_client_id_from_open_id_connect_provider::RemoveClientIdFromOpenIdConnectProviderOutput>()
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RemoveClientIdFromOpenIdConnectProviderTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RemoveClientIdFromOpenIdConnectProviderInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RemoveClientIDFromOpenIDConnectProviderResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_remove_client_id_from_open_id_connect_provider::de_remove_client_id_from_open_id_connect_provider_http_error(
                status, headers, body,
            )
        } else {
            super::protocol_serde::shape_remove_client_id_from_open_id_connect_provider::de_remove_client_id_from_open_id_connect_provider_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RemoveClientIDFromOpenIDConnectProviderRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::remove_client_id_from_open_id_connect_provider::RemoveClientIdFromOpenIdConnectProviderInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::remove_client_id_from_open_id_connect_provider::RemoveClientIdFromOpenIdConnectProviderInput,
...
impl ::aws_types::request_id::RequestId
    for super::operation::remove_client_id_from_open_id_connect_provider::RemoveClientIDFromOpenIDConnectProviderError
{
...
pub use super::operation::remove_client_id_from_open_id_connect_provider::_remove_client_id_from_open_id_connect_provider_input::RemoveClientIdFromOpenIdConnectProviderInput;

pub use super::operation::remove_client_id_from_open_id_connect_provider::_remove_client_id_from_open_id_connect_provider_output::RemoveClientIdFromOpenIdConnectProviderOutput;
