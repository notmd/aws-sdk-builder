...
impl RemoveClientIdFromOpenIdConnectProvider { pub fn new() -> Self { Self } }
#[derive(Clone, Debug)]
pub enum Error {
...
pub mod _remove_client_id_from_open_id_connect_provider_input {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/remove_client_id_from_open_id_connect_provider/_remove_client_id_from_open_id_connect_provider_input.rs"));
}
pub use _remove_client_id_from_open_id_connect_provider_input::RemoveClientIdFromOpenIdConnectProviderInput;
pub type Input = RemoveClientIdFromOpenIdConnectProviderInput;
pub mod _remove_client_id_from_open_id_connect_provider_output {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/remove_client_id_from_open_id_connect_provider/_remove_client_id_from_open_id_connect_provider_output.rs"));
}
pub use _remove_client_id_from_open_id_connect_provider_output::RemoveClientIdFromOpenIdConnectProviderOutput;
pub type Output = RemoveClientIdFromOpenIdConnectProviderOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/iam/src/operation/remove_client_id_from_open_id_connect_provider/builders.rs"));
}
pub type RemoveClientIdFromOpenIdConnectProviderError = Error;
pub type RemoveClientIdFromOpenIdConnectProviderFluentBuilder = builders::Builder;
