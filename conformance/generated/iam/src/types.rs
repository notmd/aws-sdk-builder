...
pub mod types {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/types/_access_advisor_usage_granularity_type.rs"
    ));
    ...
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/types/_list_policies_granting_service_access_entry.rs"
    ));
    ...
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/types/_open_id_connect_provider_list_entry.rs"
    ));
    ...
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/types/_permissions_boundary_attachment_type.rs"
    ));
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/types/_permissions_boundary_decision_detail.rs"
    ));
    ...
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/iam/src/types/_service_specific_credential_metadata.rs"
    ));
    ...
    pub mod error {
        include!(concat!(
            env!("OUT_DIR"),
            "/generated/iam/src/types/error/_concurrent_modification_exception.rs"
        ));
        ...
        include!(concat!(
            env!("OUT_DIR"),
            "/generated/iam/src/types/error/_entity_already_exists_exception.rs"
        ));
        ...
        include!(concat!(
            env!("OUT_DIR"),
            "/generated/iam/src/types/error/_malformed_policy_document_exception.rs"
        ));
        ...
        include!(concat!(
            env!("OUT_DIR"),
            "/generated/iam/src/types/error/_role_template_disabled_exception.rs"
        ));
        include!(concat!(
            env!("OUT_DIR"),
            "/generated/iam/src/types/error/_unmodifiable_entity_exception.rs"
        ));
        include!(concat!(
            env!("OUT_DIR"),
            "/generated/iam/src/types/error/_policy_not_attachable_exception.rs"
        ));
        include!(concat!(
            env!("OUT_DIR"),
            "/generated/iam/src/types/error/_entity_temporarily_unmodifiable_exception.rs"
        ));
        include!(concat!(env!("OUT_DIR"), "/generated/iam/src/types/error/_invalid_user_type_exception.rs"));
        include!(concat!(
            env!("OUT_DIR"),
            "/generated/iam/src/types/error/_password_policy_violation_exception.rs"
        ));
        include!(concat!(
            env!("OUT_DIR"),
            "/generated/iam/src/types/error/_open_id_idp_communication_error_exception.rs"
        ));
        include!(concat!(
            env!("OUT_DIR"),
            "/generated/iam/src/types/error/_service_not_supported_exception.rs"
        ));
        include!(concat!(env!("OUT_DIR"), "/generated/iam/src/types/error/_delete_conflict_exception.rs"));
        include!(concat!(
            env!("OUT_DIR"),
            "/generated/iam/src/types/error/_account_not_management_or_delegated_administrator_exception.rs"
        ));
        include!(concat!(
            env!("OUT_DIR"),
            "/generated/iam/src/types/error/_organization_not_found_exception.rs"
        ));
        include!(concat!(
            env!("OUT_DIR"),
            "/generated/iam/src/types/error/_organization_not_in_all_features_mode_exception.rs"
        ));
        include!(concat!(
            env!("OUT_DIR"),
            "/generated/iam/src/types/error/_service_access_not_enabled_exception.rs"
        ));
        include!(concat!(env!("OUT_DIR"), "/generated/iam/src/types/error/_feature_disabled_exception.rs"));
        include!(concat!(
            env!("OUT_DIR"),
            "/generated/iam/src/types/error/_invalid_authentication_code_exception.rs"
        ));
        include!(concat!(
            env!("OUT_DIR"),
            "/generated/iam/src/types/error/_caller_is_not_management_account_exception.rs"
        ));
        include!(concat!(env!("OUT_DIR"), "/generated/iam/src/types/error/_feature_enabled_exception.rs"));
        include!(concat!(
            env!("OUT_DIR"),
            "/generated/iam/src/types/error/_report_generation_limit_exceeded_exception.rs"
        ));
        include!(concat!(
            env!("OUT_DIR"),
            "/generated/iam/src/types/error/_credential_report_expired_exception.rs"
        ));
        include!(concat!(
            env!("OUT_DIR"),
            "/generated/iam/src/types/error/_credential_report_not_present_exception.rs"
        ));
        include!(concat!(
            env!("OUT_DIR"),
            "/generated/iam/src/types/error/_credential_report_not_ready_exception.rs"
        ));
        include!(concat!(
            env!("OUT_DIR"),
            "/generated/iam/src/types/error/_unrecognized_public_key_encoding_exception.rs"
        ));
        ...
        include!(concat!(
            env!("OUT_DIR"),
            "/generated/iam/src/types/error/_malformed_certificate_exception.rs"
        ));
        include!(concat!(
            env!("OUT_DIR"),
            "/generated/iam/src/types/error/_duplicate_certificate_exception.rs"
        ));
        include!(concat!(
            env!("OUT_DIR"),
            "/generated/iam/src/types/error/_invalid_certificate_exception.rs"
        ));
        include!(concat!(
            env!("OUT_DIR"),
            "/generated/iam/src/types/error/_duplicate_ssh_public_key_exception.rs"
        ));
        include!(concat!(
            env!("OUT_DIR"),
            "/generated/iam/src/types/error/_invalid_public_key_exception.rs"
        ));
        pub mod builders {
            include!(concat!(env!("OUT_DIR"), "/generated/iam/src/types/error/builders.rs"));
        }
    }
}
