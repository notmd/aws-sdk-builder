...
impl InstanceProfileExistsFluentBuilder {
    ...
    pub async fn wait(
        ...
        super::waiters::instance_profile_exists::InstanceProfileExistsFinalPoll,
        super::waiters::instance_profile_exists::WaitUntilInstanceProfileExistsError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            ...
            if super::waiters::matchers::match_get_instance_profile_c955e57777ec0d736(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"errorType":"NoSuchEntityException"}
            if super::waiters::matchers::match_get_instance_profile_73f4bff11904ca908(result) {
        ...
        let operation = move || {
            ...
            async move { super::operation::get_instance_profile::GetInstanceProfile::orchestrate(&runtime_plugins, input).await }
        };
