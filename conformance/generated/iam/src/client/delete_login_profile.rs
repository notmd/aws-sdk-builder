...
impl super::Client {
    ...
    pub fn delete_login_profile(&self) -> super::operation::delete_login_profile::builders::DeleteLoginProfileFluentBuilder {
        super::operation::delete_login_profile::builders::DeleteLoginProfileFluentBuilder::new(self.handle.clone())
    }
}
