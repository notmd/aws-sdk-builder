...
impl super::Client {
    ...
    pub fn get_instance_profile(&self) -> super::operation::get_instance_profile::builders::GetInstanceProfileFluentBuilder {
        super::operation::get_instance_profile::builders::GetInstanceProfileFluentBuilder::new(self.handle.clone())
    }
}
