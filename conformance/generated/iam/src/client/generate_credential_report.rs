...
impl super::Client {
    ...
    pub fn generate_credential_report(&self) -> super::operation::generate_credential_report::builders::GenerateCredentialReportFluentBuilder {
        super::operation::generate_credential_report::builders::GenerateCredentialReportFluentBuilder::new(self.handle.clone())
    }
}
