...
impl super::Client {
    ...
    pub fn upload_signing_certificate(&self) -> super::operation::upload_signing_certificate::builders::UploadSigningCertificateFluentBuilder {
        super::operation::upload_signing_certificate::builders::UploadSigningCertificateFluentBuilder::new(self.handle.clone())
    }
}
