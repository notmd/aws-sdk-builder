...
impl super::Client {
    ...
    pub fn untag_role(&self) -> super::operation::untag_role::builders::UntagRoleFluentBuilder {
        super::operation::untag_role::builders::UntagRoleFluentBuilder::new(self.handle.clone())
    }
}
