...
impl super::Client {
    ...
    pub fn list_saml_providers(&self) -> super::operation::list_saml_providers::builders::ListSAMLProvidersFluentBuilder {
        super::operation::list_saml_providers::builders::ListSAMLProvidersFluentBuilder::new(self.handle.clone())
    }
}
