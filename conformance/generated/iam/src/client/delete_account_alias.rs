...
impl super::Client {
    ...
    pub fn delete_account_alias(&self) -> super::operation::delete_account_alias::builders::DeleteAccountAliasFluentBuilder {
        super::operation::delete_account_alias::builders::DeleteAccountAliasFluentBuilder::new(self.handle.clone())
    }
}
