...
impl super::Client {
    ...
    pub fn get_service_linked_role_deletion_status(
        &self,
    ) -> super::operation::get_service_linked_role_deletion_status::builders::GetServiceLinkedRoleDeletionStatusFluentBuilder {
        super::operation::get_service_linked_role_deletion_status::builders::GetServiceLinkedRoleDeletionStatusFluentBuilder::new(self.handle.clone())
    }
}
