...
impl super::Client {
    ...
    pub fn delete_open_id_connect_provider(
        &self,
    ) -> super::operation::delete_open_id_connect_provider::builders::DeleteOpenIDConnectProviderFluentBuilder {
        super::operation::delete_open_id_connect_provider::builders::DeleteOpenIDConnectProviderFluentBuilder::new(self.handle.clone())
    }
}
