...
impl super::Client {
    ...
    pub fn get_mfa_device(&self) -> super::operation::get_mfa_device::builders::GetMFADeviceFluentBuilder {
        super::operation::get_mfa_device::builders::GetMFADeviceFluentBuilder::new(self.handle.clone())
    }
}
