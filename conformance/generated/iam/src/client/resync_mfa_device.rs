...
impl super::Client {
    ...
    pub fn resync_mfa_device(&self) -> super::operation::resync_mfa_device::builders::ResyncMFADeviceFluentBuilder {
        super::operation::resync_mfa_device::builders::ResyncMFADeviceFluentBuilder::new(self.handle.clone())
    }
}
