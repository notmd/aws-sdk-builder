...
impl super::Client {
    ...
    pub fn tag_user(&self) -> super::operation::tag_user::builders::TagUserFluentBuilder {
        super::operation::tag_user::builders::TagUserFluentBuilder::new(self.handle.clone())
    }
}
