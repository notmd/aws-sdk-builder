...
impl super::Client {
    ...
    pub fn set_security_token_service_preferences(
        &self,
    ) -> super::operation::set_security_token_service_preferences::builders::SetSecurityTokenServicePreferencesFluentBuilder {
        super::operation::set_security_token_service_preferences::builders::SetSecurityTokenServicePreferencesFluentBuilder::new(self.handle.clone())
    }
}
