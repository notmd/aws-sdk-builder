...
impl super::Client {
    ...
    pub fn tag_role(&self) -> super::operation::tag_role::builders::TagRoleFluentBuilder {
        super::operation::tag_role::builders::TagRoleFluentBuilder::new(self.handle.clone())
    }
}
