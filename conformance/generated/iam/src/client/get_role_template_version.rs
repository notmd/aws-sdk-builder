...
impl super::Client {
    ...
    pub fn get_role_template_version(&self) -> super::operation::get_role_template_version::builders::GetRoleTemplateVersionFluentBuilder {
        super::operation::get_role_template_version::builders::GetRoleTemplateVersionFluentBuilder::new(self.handle.clone())
    }
}
