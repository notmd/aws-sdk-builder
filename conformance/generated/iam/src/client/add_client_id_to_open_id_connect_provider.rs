...
impl super::Client {
    ...
    pub fn add_client_id_to_open_id_connect_provider(
        &self,
    ) -> super::operation::add_client_id_to_open_id_connect_provider::builders::AddClientIDToOpenIDConnectProviderFluentBuilder {
        super::operation::add_client_id_to_open_id_connect_provider::builders::AddClientIDToOpenIDConnectProviderFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
