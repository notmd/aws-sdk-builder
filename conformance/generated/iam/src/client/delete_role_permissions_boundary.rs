...
impl super::Client {
    ...
    pub fn delete_role_permissions_boundary(
        &self,
    ) -> super::operation::delete_role_permissions_boundary::builders::DeleteRolePermissionsBoundaryFluentBuilder {
        super::operation::delete_role_permissions_boundary::builders::DeleteRolePermissionsBoundaryFluentBuilder::new(self.handle.clone())
    }
}
