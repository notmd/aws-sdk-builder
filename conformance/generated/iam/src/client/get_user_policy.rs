...
impl super::Client {
    ...
    pub fn get_user_policy(&self) -> super::operation::get_user_policy::builders::GetUserPolicyFluentBuilder {
        super::operation::get_user_policy::builders::GetUserPolicyFluentBuilder::new(self.handle.clone())
    }
}
