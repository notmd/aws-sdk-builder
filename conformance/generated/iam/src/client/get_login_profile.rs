...
impl super::Client {
    ...
    pub fn get_login_profile(&self) -> super::operation::get_login_profile::builders::GetLoginProfileFluentBuilder {
        super::operation::get_login_profile::builders::GetLoginProfileFluentBuilder::new(self.handle.clone())
    }
}
