...
impl super::Client {
    ...
    pub fn create_group(&self) -> super::operation::create_group::builders::CreateGroupFluentBuilder {
        super::operation::create_group::builders::CreateGroupFluentBuilder::new(self.handle.clone())
    }
}
