...
impl super::Client {
    ...
    pub fn get_saml_provider(&self) -> super::operation::get_saml_provider::builders::GetSAMLProviderFluentBuilder {
        super::operation::get_saml_provider::builders::GetSAMLProviderFluentBuilder::new(self.handle.clone())
    }
}
