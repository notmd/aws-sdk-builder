...
impl super::Client {
    ...
    pub fn get_credential_report(&self) -> super::operation::get_credential_report::builders::GetCredentialReportFluentBuilder {
        super::operation::get_credential_report::builders::GetCredentialReportFluentBuilder::new(self.handle.clone())
    }
}
