...
impl super::Client {
    ...
    pub fn update_role_description(&self) -> super::operation::update_role_description::builders::UpdateRoleDescriptionFluentBuilder {
        super::operation::update_role_description::builders::UpdateRoleDescriptionFluentBuilder::new(self.handle.clone())
    }
}
