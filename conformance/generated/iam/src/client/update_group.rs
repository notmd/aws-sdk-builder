...
impl super::Client {
    ...
    pub fn update_group(&self) -> super::operation::update_group::builders::UpdateGroupFluentBuilder {
        super::operation::update_group::builders::UpdateGroupFluentBuilder::new(self.handle.clone())
    }
}
