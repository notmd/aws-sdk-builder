...
impl super::Client {
    ...
    pub fn get_ssh_public_key(&self) -> super::operation::get_ssh_public_key::builders::GetSSHPublicKeyFluentBuilder {
        super::operation::get_ssh_public_key::builders::GetSSHPublicKeyFluentBuilder::new(self.handle.clone())
    }
}
