...
impl super::Client {
    ...
    pub fn generate_organizations_access_report(
        &self,
    ) -> super::operation::generate_organizations_access_report::builders::GenerateOrganizationsAccessReportFluentBuilder {
        super::operation::generate_organizations_access_report::builders::GenerateOrganizationsAccessReportFluentBuilder::new(self.handle.clone())
    }
}
