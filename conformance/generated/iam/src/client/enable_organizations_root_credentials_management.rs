...
impl super::Client {
    ...
    pub fn enable_organizations_root_credentials_management(
        &self,
    ) -> super::operation::enable_organizations_root_credentials_management::builders::EnableOrganizationsRootCredentialsManagementFluentBuilder {
        super::operation::enable_organizations_root_credentials_management::builders::EnableOrganizationsRootCredentialsManagementFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
