...
impl super::Client {
    ...
    pub fn add_user_to_group(&self) -> super::operation::add_user_to_group::builders::AddUserToGroupFluentBuilder {
        super::operation::add_user_to_group::builders::AddUserToGroupFluentBuilder::new(self.handle.clone())
    }
}
