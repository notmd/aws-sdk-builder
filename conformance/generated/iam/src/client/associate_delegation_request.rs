...
impl super::Client {
    ...
    pub fn associate_delegation_request(&self) -> super::operation::associate_delegation_request::builders::AssociateDelegationRequestFluentBuilder {
        super::operation::associate_delegation_request::builders::AssociateDelegationRequestFluentBuilder::new(self.handle.clone())
    }
}
