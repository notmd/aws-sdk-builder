...
impl super::Client {
    ...
    pub fn delete_access_key(&self) -> super::operation::delete_access_key::builders::DeleteAccessKeyFluentBuilder {
        super::operation::delete_access_key::builders::DeleteAccessKeyFluentBuilder::new(self.handle.clone())
    }
}
