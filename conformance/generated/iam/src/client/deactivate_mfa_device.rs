...
impl super::Client {
    ...
    pub fn deactivate_mfa_device(&self) -> super::operation::deactivate_mfa_device::builders::DeactivateMFADeviceFluentBuilder {
        super::operation::deactivate_mfa_device::builders::DeactivateMFADeviceFluentBuilder::new(self.handle.clone())
    }
}
