...
impl super::Client {
    ...
    pub fn get_role(&self) -> super::operation::get_role::builders::GetRoleFluentBuilder {
        super::operation::get_role::builders::GetRoleFluentBuilder::new(self.handle.clone())
    }
}
