...
impl super::Client {
    ...
    pub fn accept_delegation_request(&self) -> super::operation::accept_delegation_request::builders::AcceptDelegationRequestFluentBuilder {
        super::operation::accept_delegation_request::builders::AcceptDelegationRequestFluentBuilder::new(self.handle.clone())
    }
}
