...
impl super::Client {
    ...
    pub fn attach_role_policy(&self) -> super::operation::attach_role_policy::builders::AttachRolePolicyFluentBuilder {
        super::operation::attach_role_policy::builders::AttachRolePolicyFluentBuilder::new(self.handle.clone())
    }
}
