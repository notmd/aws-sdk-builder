...
impl super::Client {
    ...
    pub fn list_organizations_features(&self) -> super::operation::list_organizations_features::builders::ListOrganizationsFeaturesFluentBuilder {
        super::operation::list_organizations_features::builders::ListOrganizationsFeaturesFluentBuilder::new(self.handle.clone())
    }
}
