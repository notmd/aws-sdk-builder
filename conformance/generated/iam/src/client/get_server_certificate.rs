...
impl super::Client {
    ...
    pub fn get_server_certificate(&self) -> super::operation::get_server_certificate::builders::GetServerCertificateFluentBuilder {
        super::operation::get_server_certificate::builders::GetServerCertificateFluentBuilder::new(self.handle.clone())
    }
}
