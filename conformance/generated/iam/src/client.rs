...
pub trait Waiters {
    ...
    fn wait_until_instance_profile_exists(&self) -> super::waiters::instance_profile_exists::InstanceProfileExistsFluentBuilder;
    /// Wait for `policy_exists`
    fn wait_until_policy_exists(&self) -> super::waiters::policy_exists::PolicyExistsFluentBuilder;
    /// Wait for `role_exists`
    fn wait_until_role_exists(&self) -> super::waiters::role_exists::RoleExistsFluentBuilder;
    /// Wait for `user_exists`
    fn wait_until_user_exists(&self) -> super::waiters::user_exists::UserExistsFluentBuilder;
}
impl Waiters for Client {
    fn wait_until_instance_profile_exists(&self) -> super::waiters::instance_profile_exists::InstanceProfileExistsFluentBuilder {
        super::waiters::instance_profile_exists::InstanceProfileExistsFluentBuilder::new(self.handle.clone())
    }
    fn wait_until_policy_exists(&self) -> super::waiters::policy_exists::PolicyExistsFluentBuilder {
        super::waiters::policy_exists::PolicyExistsFluentBuilder::new(self.handle.clone())
    }
    fn wait_until_role_exists(&self) -> super::waiters::role_exists::RoleExistsFluentBuilder {
        super::waiters::role_exists::RoleExistsFluentBuilder::new(self.handle.clone())
    }
    fn wait_until_user_exists(&self) -> super::waiters::user_exists::UserExistsFluentBuilder {
        super::waiters::user_exists::UserExistsFluentBuilder::new(self.handle.clone())
    }
}
