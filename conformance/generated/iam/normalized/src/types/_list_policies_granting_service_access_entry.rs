...
pub struct ListPoliciesGrantingServiceAccessEntry {
    ...
    pub policies: ::std::option::Option<::std::vec::Vec<super::super::types::PolicyGrantingServiceAccess>>,
}
impl ListPoliciesGrantingServiceAccessEntry {
    ...
    pub fn policies(&self) -> &[super::super::types::PolicyGrantingServiceAccess] {
...
impl ListPoliciesGrantingServiceAccessEntry {
    ...
    pub fn builder() -> super::super::types::builders::ListPoliciesGrantingServiceAccessEntryBuilder {
        super::super::types::builders::ListPoliciesGrantingServiceAccessEntryBuilder::default()
    }
}
...
pub struct ListPoliciesGrantingServiceAccessEntryBuilder {
    ...
    pub(crate) policies: ::std::option::Option<::std::vec::Vec<super::super::types::PolicyGrantingServiceAccess>>,
}
impl ListPoliciesGrantingServiceAccessEntryBuilder {
    ...
    ///
    /// <p>The&nbsp;<code>PoliciesGrantingServiceAccess</code> object that contains details about the policy.</p>
    pub fn policies(mut self, input: super::super::types::PolicyGrantingServiceAccess) -> Self {
    ...
    /// <p>The&nbsp;<code>PoliciesGrantingServiceAccess</code> object that contains details about the policy.</p>
    pub fn set_policies(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::PolicyGrantingServiceAccess>>) -> Self {
        self.policies = input;
        self
    }
    /// <p>The&nbsp;<code>PoliciesGrantingServiceAccess</code> object that contains details about the policy.</p>
    pub fn get_policies(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::PolicyGrantingServiceAccess>> {
        &self.policies
    }
    ...
    pub fn build(self) -> super::super::types::ListPoliciesGrantingServiceAccessEntry {
        super::super::types::ListPoliciesGrantingServiceAccessEntry {
