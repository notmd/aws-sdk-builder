...
impl User {
    ...
    pub fn builder() -> super::super::types::builders::UserBuilder {
        super::super::types::builders::UserBuilder::default()
    }
}
...
impl UserBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::User, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::User {
