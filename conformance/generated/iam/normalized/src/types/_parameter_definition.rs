...
pub struct ParameterDefinition {
    ...
    pub r#type: super::super::types::ParameterTypeType,
...
impl ParameterDefinition {
    ...
    /// <p>The data type of the parameter. Valid values are <code>String</code>, <code>StringList</code>, <code>Number</code>, <code>NumberList</code>, <code>Arn</code>, and <code>ArnList</code>.</p>
    pub fn r#type(&self) -> &super::super::types::ParameterTypeType {
        &self.r#type
    }
    /// <p>An optional subtype that further constrains the values that are allowed for the parameter.</p>
...
impl ParameterDefinition {
    ...
    pub fn builder() -> super::super::types::builders::ParameterDefinitionBuilder {
        super::super::types::builders::ParameterDefinitionBuilder::default()
    }
}
...
pub struct ParameterDefinitionBuilder {
    ...
    pub(crate) r#type: ::std::option::Option<super::super::types::ParameterTypeType>,
...
impl ParameterDefinitionBuilder {
    ...
    /// <p>The data type of the parameter. Valid values are <code>String</code>, <code>StringList</code>, <code>Number</code>, <code>NumberList</code>, <code>Arn</code>, and <code>ArnList</code>.</p>
    /// This field is required.
    pub fn r#type(mut self, input: super::super::types::ParameterTypeType) -> Self {
        self.r#type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The data type of the parameter. Valid values are <code>String</code>, <code>StringList</code>, <code>Number</code>, <code>NumberList</code>, <code>Arn</code>, and <code>ArnList</code>.</p>
    pub fn set_type(mut self, input: ::std::option::Option<super::super::types::ParameterTypeType>) -> Self {
        self.r#type = input;
        self
    }
    /// <p>The data type of the parameter. Valid values are <code>String</code>, <code>StringList</code>, <code>Number</code>, <code>NumberList</code>, <code>Arn</code>, and <code>ArnList</code>.</p>
    pub fn get_type(&self) -> &::std::option::Option<super::super::types::ParameterTypeType> {
        &self.r#type
    }
    /// <p>An optional subtype that further constrains the values that are allowed for the parameter.</p>
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::ParameterDefinition, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::ParameterDefinition {
