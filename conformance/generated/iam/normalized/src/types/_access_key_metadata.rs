...
impl AccessKeyMetadata {
    ...
    pub fn builder() -> super::super::types::builders::AccessKeyMetadataBuilder {
        super::super::types::builders::AccessKeyMetadataBuilder::default()
    }
}
...
impl AccessKeyMetadataBuilder {
    ...
    pub fn build(self) -> super::super::types::AccessKeyMetadata {
        super::super::types::AccessKeyMetadata {
