...
pub struct ManagedPolicyDetail {
    ...
    pub policy_version_list: ::std::option::Option<::std::vec::Vec<super::super::types::PolicyVersion>>,
}
impl ManagedPolicyDetail {
    ...
    pub fn policy_version_list(&self) -> &[super::super::types::PolicyVersion] {
...
impl ManagedPolicyDetail {
    ...
    pub fn builder() -> super::super::types::builders::ManagedPolicyDetailBuilder {
        super::super::types::builders::ManagedPolicyDetailBuilder::default()
    }
}
...
pub struct ManagedPolicyDetailBuilder {
    ...
    pub(crate) policy_version_list: ::std::option::Option<::std::vec::Vec<super::super::types::PolicyVersion>>,
}
impl ManagedPolicyDetailBuilder {
    ...
    ///
    /// <p>A list containing information about the versions of the policy.</p>
    pub fn policy_version_list(mut self, input: super::super::types::PolicyVersion) -> Self {
    ...
    /// <p>A list containing information about the versions of the policy.</p>
    pub fn set_policy_version_list(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::PolicyVersion>>) -> Self {
        self.policy_version_list = input;
        self
    }
    /// <p>A list containing information about the versions of the policy.</p>
    pub fn get_policy_version_list(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::PolicyVersion>> {
        &self.policy_version_list
    }
    /// Consumes the builder and constructs a [`ManagedPolicyDetail`](crate::types::ManagedPolicyDetail).
    pub fn build(self) -> super::super::types::ManagedPolicyDetail {
        super::super::types::ManagedPolicyDetail {
