...
impl ServerCertificate {
    /// <p>The meta information of the server certificate, such as its name, path, ID, and ARN.</p>
    pub fn server_certificate_metadata(&self) -> ::std::option::Option<&super::super::types::ServerCertificateMetadata> {
...
impl ServerCertificate {
    ...
    pub fn builder() -> super::super::types::builders::ServerCertificateBuilder {
        super::super::types::builders::ServerCertificateBuilder::default()
    }
}
...
pub struct ServerCertificateBuilder {
    pub(crate) server_certificate_metadata: ::std::option::Option<super::super::types::ServerCertificateMetadata>,
...
impl ServerCertificateBuilder {
    ...
    pub fn server_certificate_metadata(mut self, input: super::super::types::ServerCertificateMetadata) -> Self {
        self.server_certificate_metadata = ::std::option::Option::Some(input);
        self
    }
    /// <p>The meta information of the server certificate, such as its name, path, ID, and ARN.</p>
    pub fn set_server_certificate_metadata(mut self, input: ::std::option::Option<super::super::types::ServerCertificateMetadata>) -> Self {
        self.server_certificate_metadata = input;
        self
    }
    /// <p>The meta information of the server certificate, such as its name, path, ID, and ARN.</p>
    pub fn get_server_certificate_metadata(&self) -> &::std::option::Option<super::super::types::ServerCertificateMetadata> {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::ServerCertificate, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::ServerCertificate {
