...
pub struct ServiceSpecificCredential {
    ...
    pub status: super::super::types::StatusType,
}
impl ServiceSpecificCredential {
    ...
    /// <p>The status of the service-specific credential. <code>Active</code> means that the key is valid for API calls, while <code>Inactive</code> means it is not.</p>
    pub fn status(&self) -> &super::super::types::StatusType {
        &self.status
    }
}
...
impl ServiceSpecificCredential {
    ...
    pub fn builder() -> super::super::types::builders::ServiceSpecificCredentialBuilder {
        super::super::types::builders::ServiceSpecificCredentialBuilder::default()
    }
}
...
impl ServiceSpecificCredentialBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::ServiceSpecificCredential, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::ServiceSpecificCredential {
