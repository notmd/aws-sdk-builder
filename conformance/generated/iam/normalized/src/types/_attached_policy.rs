...
impl AttachedPolicy {
    ...
    pub fn builder() -> super::super::types::builders::AttachedPolicyBuilder {
        super::super::types::builders::AttachedPolicyBuilder::default()
    }
}
...
impl AttachedPolicyBuilder {
    ...
    pub fn build(self) -> super::super::types::AttachedPolicy {
        super::super::types::AttachedPolicy {
