...
impl RoleLastUsed {
    ...
    pub fn builder() -> super::super::types::builders::RoleLastUsedBuilder {
        super::super::types::builders::RoleLastUsedBuilder::default()
    }
}
...
impl RoleLastUsedBuilder {
    ...
    pub fn build(self) -> super::super::types::RoleLastUsed {
        super::super::types::RoleLastUsed {
