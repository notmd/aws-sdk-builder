...
impl PermissionsBoundaryDecisionDetail {
    ...
    pub fn builder() -> super::super::types::builders::PermissionsBoundaryDecisionDetailBuilder {
        super::super::types::builders::PermissionsBoundaryDecisionDetailBuilder::default()
    }
}
...
impl PermissionsBoundaryDecisionDetailBuilder {
    ...
    pub fn build(self) -> super::super::types::PermissionsBoundaryDecisionDetail {
        super::super::types::PermissionsBoundaryDecisionDetail {
