...
impl TrackedActionLastAccessed {
    ...
    pub fn builder() -> super::super::types::builders::TrackedActionLastAccessedBuilder {
        super::super::types::builders::TrackedActionLastAccessedBuilder::default()
    }
}
...
impl TrackedActionLastAccessedBuilder {
    ...
    pub fn build(self) -> super::super::types::TrackedActionLastAccessed {
        super::super::types::TrackedActionLastAccessed {
