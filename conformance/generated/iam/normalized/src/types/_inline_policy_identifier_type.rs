...
pub struct InlinePolicyIdentifierType {
    ...
    pub attachment_type: super::super::types::AttachmentType,
...
impl InlinePolicyIdentifierType {
    ...
    /// <p>The type of IAM entity that the inline policy is attached to.</p>
    pub fn attachment_type(&self) -> &super::super::types::AttachmentType {
...
impl InlinePolicyIdentifierType {
    ...
    pub fn builder() -> super::super::types::builders::InlinePolicyIdentifierTypeBuilder {
        super::super::types::builders::InlinePolicyIdentifierTypeBuilder::default()
    }
}
...
pub struct InlinePolicyIdentifierTypeBuilder {
    ...
    pub(crate) attachment_type: ::std::option::Option<super::super::types::AttachmentType>,
...
impl InlinePolicyIdentifierTypeBuilder {
    ...
    /// <p>The type of IAM entity that the inline policy is attached to.</p>
    /// This field is required.
    pub fn attachment_type(mut self, input: super::super::types::AttachmentType) -> Self {
        self.attachment_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The type of IAM entity that the inline policy is attached to.</p>
    pub fn set_attachment_type(mut self, input: ::std::option::Option<super::super::types::AttachmentType>) -> Self {
        self.attachment_type = input;
        self
    }
    /// <p>The type of IAM entity that the inline policy is attached to.</p>
    pub fn get_attachment_type(&self) -> &::std::option::Option<super::super::types::AttachmentType> {
        &self.attachment_type
    }
    /// <p>The name of the IAM user, group, or role that the inline policy is attached to. Wildcard characters are supported to match multiple entities: use at most one <code>*</code> (matches any sequence of characters, including none), and any number of <code>?</code> (each matches exactly one character).</p>
    /// This field is required.
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::InlinePolicyIdentifierType, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::InlinePolicyIdentifierType {
