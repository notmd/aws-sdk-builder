...
impl ServerCertificateMetadata {
    ...
    pub fn builder() -> super::super::types::builders::ServerCertificateMetadataBuilder {
        super::super::types::builders::ServerCertificateMetadataBuilder::default()
    }
}
...
impl ServerCertificateMetadataBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::ServerCertificateMetadata, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::ServerCertificateMetadata {
