...
impl SamlPrivateKey {
    ...
    pub fn builder() -> super::super::types::builders::SamlPrivateKeyBuilder {
        super::super::types::builders::SamlPrivateKeyBuilder::default()
    }
}
...
impl SamlPrivateKeyBuilder {
    ...
    pub fn build(self) -> super::super::types::SamlPrivateKey {
        super::super::types::SamlPrivateKey {
            key_id: self.key_id,
