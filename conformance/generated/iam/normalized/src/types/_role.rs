...
pub struct Role {
    ...
    pub source_role_template: ::std::option::Option<super::super::types::SourceRoleTemplate>,
}
impl Role {
    /// <p>The path to the role. For more information about paths, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/Using_Identifiers.html">IAM identifiers</a> in the <i>IAM User Guide</i>.</p>
    ...
    /// <p>Contains information about the role template that this role was created from. This member is present only for roles created with <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_AcquireRole.html">AcquireRole</a>.</p>
    pub fn source_role_template(&self) -> ::std::option::Option<&super::super::types::SourceRoleTemplate> {
        self.source_role_template.as_ref()
    }
}
impl Role {
    /// Creates a new builder-style object to manufacture [`Role`](crate::types::Role).
    pub fn builder() -> super::super::types::builders::RoleBuilder {
        super::super::types::builders::RoleBuilder::default()
    }
}
...
pub struct RoleBuilder {
    ...
    pub(crate) source_role_template: ::std::option::Option<super::super::types::SourceRoleTemplate>,
}
impl RoleBuilder {
    /// <p>The path to the role. For more information about paths, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/Using_Identifiers.html">IAM identifiers</a> in the <i>IAM User Guide</i>.</p>
    ...
    /// <p>Contains information about the role template that this role was created from. This member is present only for roles created with <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_AcquireRole.html">AcquireRole</a>.</p>
    pub fn source_role_template(mut self, input: super::super::types::SourceRoleTemplate) -> Self {
        self.source_role_template = ::std::option::Option::Some(input);
        self
    }
    /// <p>Contains information about the role template that this role was created from. This member is present only for roles created with <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_AcquireRole.html">AcquireRole</a>.</p>
    pub fn set_source_role_template(mut self, input: ::std::option::Option<super::super::types::SourceRoleTemplate>) -> Self {
        self.source_role_template = input;
        self
    }
    /// <p>Contains information about the role template that this role was created from. This member is present only for roles created with <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_AcquireRole.html">AcquireRole</a>.</p>
    pub fn get_source_role_template(&self) -> &::std::option::Option<super::super::types::SourceRoleTemplate> {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::Role, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::Role {
