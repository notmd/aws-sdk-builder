...
pub struct PolicyGrantingServiceAccess {
    ...
    pub policy_type: super::super::types::PolicyType,
    ...
    pub entity_type: ::std::option::Option<super::super::types::PolicyOwnerEntityType>,
...
impl PolicyGrantingServiceAccess {
    ...
    /// <p>The policy type. For more information about these policy types, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_managed-vs-inline.html">Managed policies and inline policies</a> in the <i>IAM User Guide</i>.</p>
    pub fn policy_type(&self) -> &super::super::types::PolicyType {
        &self.policy_type
    }
    /// <p>The Amazon Resource Name (ARN). ARNs are unique identifiers for Amazon Web Services resources.</p>
    /// <p>For more information about ARNs, go to <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Names (ARNs)</a> in the <i>Amazon Web Services General Reference</i>.</p>
    ...
    /// <p>The type of entity (user or role) that used the policy to access the service to which the inline policy is attached.</p>
    /// <p>This field is null for managed policies. For more information about these policy types, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_managed-vs-inline.html">Managed policies and inline policies</a> in the <i>IAM User Guide</i>.</p>
    pub fn entity_type(&self) -> ::std::option::Option<&super::super::types::PolicyOwnerEntityType> {
...
impl PolicyGrantingServiceAccess {
    ...
    pub fn builder() -> super::super::types::builders::PolicyGrantingServiceAccessBuilder {
        super::super::types::builders::PolicyGrantingServiceAccessBuilder::default()
    }
}
...
pub struct PolicyGrantingServiceAccessBuilder {
    ...
    pub(crate) policy_type: ::std::option::Option<super::super::types::PolicyType>,
    pub(crate) policy_arn: ::std::option::Option<::std::string::String>,
    pub(crate) entity_type: ::std::option::Option<super::super::types::PolicyOwnerEntityType>,
...
impl PolicyGrantingServiceAccessBuilder {
    ...
    /// <p>The policy type. For more information about these policy types, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_managed-vs-inline.html">Managed policies and inline policies</a> in the <i>IAM User Guide</i>.</p>
    /// This field is required.
    pub fn policy_type(mut self, input: super::super::types::PolicyType) -> Self {
        self.policy_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The policy type. For more information about these policy types, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_managed-vs-inline.html">Managed policies and inline policies</a> in the <i>IAM User Guide</i>.</p>
    pub fn set_policy_type(mut self, input: ::std::option::Option<super::super::types::PolicyType>) -> Self {
        self.policy_type = input;
        self
    }
    /// <p>The policy type. For more information about these policy types, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_managed-vs-inline.html">Managed policies and inline policies</a> in the <i>IAM User Guide</i>.</p>
    pub fn get_policy_type(&self) -> &::std::option::Option<super::super::types::PolicyType> {
        &self.policy_type
    }
    /// <p>The Amazon Resource Name (ARN). ARNs are unique identifiers for Amazon Web Services resources.</p>
    /// <p>For more information about ARNs, go to <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Names (ARNs)</a> in the <i>Amazon Web Services General Reference</i>.</p>
    ...
    /// <p>The type of entity (user or role) that used the policy to access the service to which the inline policy is attached.</p>
    /// <p>This field is null for managed policies. For more information about these policy types, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_managed-vs-inline.html">Managed policies and inline policies</a> in the <i>IAM User Guide</i>.</p>
    pub fn entity_type(mut self, input: super::super::types::PolicyOwnerEntityType) -> Self {
        self.entity_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The type of entity (user or role) that used the policy to access the service to which the inline policy is attached.</p>
    /// <p>This field is null for managed policies. For more information about these policy types, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_managed-vs-inline.html">Managed policies and inline policies</a> in the <i>IAM User Guide</i>.</p>
    pub fn set_entity_type(mut self, input: ::std::option::Option<super::super::types::PolicyOwnerEntityType>) -> Self {
        self.entity_type = input;
        self
    }
    /// <p>The type of entity (user or role) that used the policy to access the service to which the inline policy is attached.</p>
    /// <p>This field is null for managed policies. For more information about these policy types, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_managed-vs-inline.html">Managed policies and inline policies</a> in the <i>IAM User Guide</i>.</p>
    pub fn get_entity_type(&self) -> &::std::option::Option<super::super::types::PolicyOwnerEntityType> {
        &self.entity_type
    }
    /// <p>The name of the entity (user or role) to which the inline policy is attached.</p>
    /// <p>This field is null for managed policies. For more information about these policy types, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_managed-vs-inline.html">Managed policies and inline policies</a> in the <i>IAM User Guide</i>.</p>
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::PolicyGrantingServiceAccess, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::PolicyGrantingServiceAccess {
