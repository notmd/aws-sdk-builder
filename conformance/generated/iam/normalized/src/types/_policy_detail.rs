...
impl PolicyDetail {
    ...
    pub fn builder() -> super::super::types::builders::PolicyDetailBuilder {
        super::super::types::builders::PolicyDetailBuilder::default()
    }
}
...
impl PolicyDetailBuilder {
    ...
    pub fn build(self) -> super::super::types::PolicyDetail {
        super::super::types::PolicyDetail {
