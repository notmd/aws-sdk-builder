...
pub struct EntityInfo {
    ...
    pub r#type: super::super::types::PolicyOwnerEntityType,
...
impl EntityInfo {
    ...
    /// <p>The type of entity (user or role).</p>
    pub fn r#type(&self) -> &super::super::types::PolicyOwnerEntityType {
        &self.r#type
    }
    /// <p>The identifier of the entity (user or role).</p>
    pub fn id(&self) -> &str {
...
impl EntityInfo {
    ...
    pub fn builder() -> super::super::types::builders::EntityInfoBuilder {
        super::super::types::builders::EntityInfoBuilder::default()
    }
}
...
pub struct EntityInfoBuilder {
    ...
    pub(crate) r#type: ::std::option::Option<super::super::types::PolicyOwnerEntityType>,
...
impl EntityInfoBuilder {
    ...
    /// <p>The type of entity (user or role).</p>
    /// This field is required.
    pub fn r#type(mut self, input: super::super::types::PolicyOwnerEntityType) -> Self {
        self.r#type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The type of entity (user or role).</p>
    pub fn set_type(mut self, input: ::std::option::Option<super::super::types::PolicyOwnerEntityType>) -> Self {
        self.r#type = input;
        self
    }
    /// <p>The type of entity (user or role).</p>
    pub fn get_type(&self) -> &::std::option::Option<super::super::types::PolicyOwnerEntityType> {
        &self.r#type
    }
    /// <p>The identifier of the entity (user or role).</p>
    /// This field is required.
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::EntityInfo, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::EntityInfo {
