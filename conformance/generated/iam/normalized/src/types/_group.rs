...
impl Group {
    ...
    pub fn builder() -> super::super::types::builders::GroupBuilder {
        super::super::types::builders::GroupBuilder::default()
    }
}
...
impl GroupBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::Group, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::Group {
