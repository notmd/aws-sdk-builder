...
impl AccessDetail {
    ...
    pub fn builder() -> super::super::types::builders::AccessDetailBuilder {
        super::super::types::builders::AccessDetailBuilder::default()
    }
}
...
impl AccessDetailBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::AccessDetail, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::AccessDetail {
