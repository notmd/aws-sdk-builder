...
impl LoginProfile {
    ...
    pub fn builder() -> super::super::types::builders::LoginProfileBuilder {
        super::super::types::builders::LoginProfileBuilder::default()
    }
}
...
impl LoginProfileBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::LoginProfile, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::LoginProfile {
