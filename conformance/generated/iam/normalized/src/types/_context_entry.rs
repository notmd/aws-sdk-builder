...
pub struct ContextEntry {
    ...
    pub context_key_type: ::std::option::Option<super::super::types::ContextKeyTypeEnum>,
}
impl ContextEntry {
    /// <p>The full name of a condition context key, including the service prefix. For example, <code>aws:SourceIp</code> or <code>s3:VersionId</code>.</p>
    ...
    /// <p>The data type of the value (or values) specified in the <code>ContextKeyValues</code> parameter.</p>
    pub fn context_key_type(&self) -> ::std::option::Option<&super::super::types::ContextKeyTypeEnum> {
        self.context_key_type.as_ref()
    }
}
impl ContextEntry {
    /// Creates a new builder-style object to manufacture [`ContextEntry`](crate::types::ContextEntry).
    pub fn builder() -> super::super::types::builders::ContextEntryBuilder {
        super::super::types::builders::ContextEntryBuilder::default()
    }
}
...
pub struct ContextEntryBuilder {
    ...
    pub(crate) context_key_type: ::std::option::Option<super::super::types::ContextKeyTypeEnum>,
}
impl ContextEntryBuilder {
    ...
    /// <p>The data type of the value (or values) specified in the <code>ContextKeyValues</code> parameter.</p>
    pub fn context_key_type(mut self, input: super::super::types::ContextKeyTypeEnum) -> Self {
        self.context_key_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The data type of the value (or values) specified in the <code>ContextKeyValues</code> parameter.</p>
    pub fn set_context_key_type(mut self, input: ::std::option::Option<super::super::types::ContextKeyTypeEnum>) -> Self {
        self.context_key_type = input;
        self
    }
    /// <p>The data type of the value (or values) specified in the <code>ContextKeyValues</code> parameter.</p>
    pub fn get_context_key_type(&self) -> &::std::option::Option<super::super::types::ContextKeyTypeEnum> {
        &self.context_key_type
    }
    /// Consumes the builder and constructs a [`ContextEntry`](crate::types::ContextEntry).
    pub fn build(self) -> super::super::types::ContextEntry {
        super::super::types::ContextEntry {
