...
pub struct RoleTemplateVersion {
    ...
    pub managed_by_type: ::std::option::Option<super::super::types::ManagedByTypeType>,
    ...
    pub inline_policy_templates: ::std::option::Option<::std::vec::Vec<super::super::types::InlinePolicy>>,
    ...
    pub parameters_definition: ::std::option::Option<::std::vec::Vec<super::super::types::ParameterDefinition>>,
    /// <p>A list of tag templates that are applied to roles that are created from this template.</p>
    pub role_tags_template: ::std::option::Option<::std::vec::Vec<super::super::types::TagTemplate>>,
...
impl RoleTemplateVersion {
    ...
    /// <p>Indicates that the role template is managed by an Amazon Web Services service.</p>
    pub fn managed_by_type(&self) -> ::std::option::Option<&super::super::types::ManagedByTypeType> {
    ...
    pub fn inline_policy_templates(&self) -> &[super::super::types::InlinePolicy] {
    ...
    pub fn parameters_definition(&self) -> &[super::super::types::ParameterDefinition] {
    ...
    pub fn role_tags_template(&self) -> &[super::super::types::TagTemplate] {
...
impl RoleTemplateVersion {
    ...
    pub fn builder() -> super::super::types::builders::RoleTemplateVersionBuilder {
        super::super::types::builders::RoleTemplateVersionBuilder::default()
    }
}
...
pub struct RoleTemplateVersionBuilder {
    ...
    pub(crate) managed_by_type: ::std::option::Option<super::super::types::ManagedByTypeType>,
    ...
    pub(crate) inline_policy_templates: ::std::option::Option<::std::vec::Vec<super::super::types::InlinePolicy>>,
    ...
    pub(crate) parameters_definition: ::std::option::Option<::std::vec::Vec<super::super::types::ParameterDefinition>>,
    pub(crate) role_tags_template: ::std::option::Option<::std::vec::Vec<super::super::types::TagTemplate>>,
...
impl RoleTemplateVersionBuilder {
    ...
    /// <p>Indicates that the role template is managed by an Amazon Web Services service.</p>
    pub fn managed_by_type(mut self, input: super::super::types::ManagedByTypeType) -> Self {
        self.managed_by_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>Indicates that the role template is managed by an Amazon Web Services service.</p>
    pub fn set_managed_by_type(mut self, input: ::std::option::Option<super::super::types::ManagedByTypeType>) -> Self {
        self.managed_by_type = input;
        self
    }
    /// <p>Indicates that the role template is managed by an Amazon Web Services service.</p>
    pub fn get_managed_by_type(&self) -> &::std::option::Option<super::super::types::ManagedByTypeType> {
    ...
    ///
    /// <p>A list of inline policy templates that the service embeds in roles that you create from this template.</p>
    pub fn inline_policy_templates(mut self, input: super::super::types::InlinePolicy) -> Self {
    ...
    /// <p>A list of inline policy templates that the service embeds in roles that you create from this template.</p>
    pub fn set_inline_policy_templates(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::InlinePolicy>>) -> Self {
        self.inline_policy_templates = input;
        self
    }
    /// <p>A list of inline policy templates that the service embeds in roles that you create from this template.</p>
    pub fn get_inline_policy_templates(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::InlinePolicy>> {
    ...
    ///
    /// <p>A list of the parameters that are defined for this role template version. You supply values for these parameters when you create a role with <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_AcquireRole.html">AcquireRole</a>.</p>
    pub fn parameters_definition(mut self, input: super::super::types::ParameterDefinition) -> Self {
    ...
    /// <p>A list of the parameters that are defined for this role template version. You supply values for these parameters when you create a role with <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_AcquireRole.html">AcquireRole</a>.</p>
    pub fn set_parameters_definition(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::ParameterDefinition>>) -> Self {
        self.parameters_definition = input;
        self
    }
    /// <p>A list of the parameters that are defined for this role template version. You supply values for these parameters when you create a role with <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_AcquireRole.html">AcquireRole</a>.</p>
    pub fn get_parameters_definition(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::ParameterDefinition>> {
    ...
    ///
    /// <p>A list of tag templates that are applied to roles that are created from this template.</p>
    pub fn role_tags_template(mut self, input: super::super::types::TagTemplate) -> Self {
    ...
    /// <p>A list of tag templates that are applied to roles that are created from this template.</p>
    pub fn set_role_tags_template(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::TagTemplate>>) -> Self {
        self.role_tags_template = input;
        self
    }
    /// <p>A list of tag templates that are applied to roles that are created from this template.</p>
    pub fn get_role_tags_template(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::TagTemplate>> {
    ...
    pub fn build(self) -> super::super::types::RoleTemplateVersion {
        super::super::types::RoleTemplateVersion {
