...
impl MfaDevice {
    ...
    pub fn builder() -> super::super::types::builders::MfaDeviceBuilder {
        super::super::types::builders::MfaDeviceBuilder::default()
    }
}
...
impl MfaDeviceBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::MfaDevice, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::MfaDevice {
