...
pub struct RoleDetail {
    ...
    pub instance_profile_list: ::std::option::Option<::std::vec::Vec<super::super::types::InstanceProfile>>,
    /// <p>A list of inline policies embedded in the role. These policies are the role's access (permissions) policies.</p>
    pub role_policy_list: ::std::option::Option<::std::vec::Vec<super::super::types::PolicyDetail>>,
    /// <p>A list of managed policies attached to the role. These policies are the role's access (permissions) policies.</p>
    pub attached_managed_policies: ::std::option::Option<::std::vec::Vec<super::super::types::AttachedPolicy>>,
    ...
    pub permissions_boundary: ::std::option::Option<super::super::types::AttachedPermissionsBoundary>,
    ...
    pub tags: ::std::option::Option<::std::vec::Vec<super::super::types::Tag>>,
    ...
    pub role_last_used: ::std::option::Option<super::super::types::RoleLastUsed>,
}
impl RoleDetail {
    /// <p>The path to the role. For more information about paths, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/Using_Identifiers.html">IAM identifiers</a> in the <i>IAM User Guide</i>.</p>
    ...
    pub fn instance_profile_list(&self) -> &[super::super::types::InstanceProfile] {
    ...
    pub fn role_policy_list(&self) -> &[super::super::types::PolicyDetail] {
    ...
    pub fn attached_managed_policies(&self) -> &[super::super::types::AttachedPolicy] {
        self.attached_managed_policies.as_deref().unwrap_or_default()
    }
    /// <p>The ARN of the policy used to set the permissions boundary for the role.</p>
    /// <p>For more information about permissions boundaries, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_boundaries.html">Permissions boundaries for IAM identities </a> in the <i>IAM User Guide</i>.</p>
    pub fn permissions_boundary(&self) -> ::std::option::Option<&super::super::types::AttachedPermissionsBoundary> {
        self.permissions_boundary.as_ref()
    }
    /// <p>A list of tags that are attached to the role. For more information about tagging, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_tags.html">Tagging IAM resources</a> in the <i>IAM User Guide</i>.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.tags.is_none()`.
    pub fn tags(&self) -> &[super::super::types::Tag] {
        self.tags.as_deref().unwrap_or_default()
    }
    /// <p>Contains information about the last time that an IAM role was used. This includes the date and time and the Region in which the role was last used. Activity is only reported for the trailing 400 days. This period can be shorter if your Region began supporting these features within the last year. The role might have been used more than 400 days ago. For more information, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_access-advisor.html#access-advisor_tracking-period">Regions where data is tracked</a> in the <i>IAM User Guide</i>.</p>
    pub fn role_last_used(&self) -> ::std::option::Option<&super::super::types::RoleLastUsed> {
        self.role_last_used.as_ref()
    }
}
impl RoleDetail {
    /// Creates a new builder-style object to manufacture [`RoleDetail`](crate::types::RoleDetail).
    pub fn builder() -> super::super::types::builders::RoleDetailBuilder {
        super::super::types::builders::RoleDetailBuilder::default()
    }
}
...
pub struct RoleDetailBuilder {
    ...
    pub(crate) instance_profile_list: ::std::option::Option<::std::vec::Vec<super::super::types::InstanceProfile>>,
    pub(crate) role_policy_list: ::std::option::Option<::std::vec::Vec<super::super::types::PolicyDetail>>,
    pub(crate) attached_managed_policies: ::std::option::Option<::std::vec::Vec<super::super::types::AttachedPolicy>>,
    pub(crate) permissions_boundary: ::std::option::Option<super::super::types::AttachedPermissionsBoundary>,
    pub(crate) tags: ::std::option::Option<::std::vec::Vec<super::super::types::Tag>>,
    pub(crate) role_last_used: ::std::option::Option<super::super::types::RoleLastUsed>,
}
impl RoleDetailBuilder {
    ...
    ///
    /// <p>A list of instance profiles that contain this role.</p>
    pub fn instance_profile_list(mut self, input: super::super::types::InstanceProfile) -> Self {
    ...
    /// <p>A list of instance profiles that contain this role.</p>
    pub fn set_instance_profile_list(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::InstanceProfile>>) -> Self {
        self.instance_profile_list = input;
        self
    }
    /// <p>A list of instance profiles that contain this role.</p>
    pub fn get_instance_profile_list(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::InstanceProfile>> {
    ...
    ///
    /// <p>A list of inline policies embedded in the role. These policies are the role's access (permissions) policies.</p>
    pub fn role_policy_list(mut self, input: super::super::types::PolicyDetail) -> Self {
    ...
    /// <p>A list of inline policies embedded in the role. These policies are the role's access (permissions) policies.</p>
    pub fn set_role_policy_list(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::PolicyDetail>>) -> Self {
        self.role_policy_list = input;
        self
    }
    /// <p>A list of inline policies embedded in the role. These policies are the role's access (permissions) policies.</p>
    pub fn get_role_policy_list(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::PolicyDetail>> {
    ...
    ///
    /// <p>A list of managed policies attached to the role. These policies are the role's access (permissions) policies.</p>
    pub fn attached_managed_policies(mut self, input: super::super::types::AttachedPolicy) -> Self {
    ...
    /// <p>A list of managed policies attached to the role. These policies are the role's access (permissions) policies.</p>
    pub fn set_attached_managed_policies(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::AttachedPolicy>>) -> Self {
        self.attached_managed_policies = input;
        self
    }
    /// <p>A list of managed policies attached to the role. These policies are the role's access (permissions) policies.</p>
    pub fn get_attached_managed_policies(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::AttachedPolicy>> {
        &self.attached_managed_policies
    }
    /// <p>The ARN of the policy used to set the permissions boundary for the role.</p>
    /// <p>For more information about permissions boundaries, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_boundaries.html">Permissions boundaries for IAM identities </a> in the <i>IAM User Guide</i>.</p>
    pub fn permissions_boundary(mut self, input: super::super::types::AttachedPermissionsBoundary) -> Self {
        self.permissions_boundary = ::std::option::Option::Some(input);
        self
    }
    /// <p>The ARN of the policy used to set the permissions boundary for the role.</p>
    /// <p>For more information about permissions boundaries, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_boundaries.html">Permissions boundaries for IAM identities </a> in the <i>IAM User Guide</i>.</p>
    pub fn set_permissions_boundary(mut self, input: ::std::option::Option<super::super::types::AttachedPermissionsBoundary>) -> Self {
        self.permissions_boundary = input;
        self
    }
    /// <p>The ARN of the policy used to set the permissions boundary for the role.</p>
    /// <p>For more information about permissions boundaries, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_boundaries.html">Permissions boundaries for IAM identities </a> in the <i>IAM User Guide</i>.</p>
    pub fn get_permissions_boundary(&self) -> &::std::option::Option<super::super::types::AttachedPermissionsBoundary> {
    ...
    ///
    /// <p>A list of tags that are attached to the role. For more information about tagging, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_tags.html">Tagging IAM resources</a> in the <i>IAM User Guide</i>.</p>
    pub fn tags(mut self, input: super::super::types::Tag) -> Self {
    ...
    /// <p>A list of tags that are attached to the role. For more information about tagging, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_tags.html">Tagging IAM resources</a> in the <i>IAM User Guide</i>.</p>
    pub fn set_tags(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::Tag>>) -> Self {
        self.tags = input;
        self
    }
    /// <p>A list of tags that are attached to the role. For more information about tagging, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_tags.html">Tagging IAM resources</a> in the <i>IAM User Guide</i>.</p>
    pub fn get_tags(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::Tag>> {
        &self.tags
    }
    /// <p>Contains information about the last time that an IAM role was used. This includes the date and time and the Region in which the role was last used. Activity is only reported for the trailing 400 days. This period can be shorter if your Region began supporting these features within the last year. The role might have been used more than 400 days ago. For more information, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_access-advisor.html#access-advisor_tracking-period">Regions where data is tracked</a> in the <i>IAM User Guide</i>.</p>
    pub fn role_last_used(mut self, input: super::super::types::RoleLastUsed) -> Self {
        self.role_last_used = ::std::option::Option::Some(input);
        self
    }
    /// <p>Contains information about the last time that an IAM role was used. This includes the date and time and the Region in which the role was last used. Activity is only reported for the trailing 400 days. This period can be shorter if your Region began supporting these features within the last year. The role might have been used more than 400 days ago. For more information, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_access-advisor.html#access-advisor_tracking-period">Regions where data is tracked</a> in the <i>IAM User Guide</i>.</p>
    pub fn set_role_last_used(mut self, input: ::std::option::Option<super::super::types::RoleLastUsed>) -> Self {
        self.role_last_used = input;
        self
    }
    /// <p>Contains information about the last time that an IAM role was used. This includes the date and time and the Region in which the role was last used. Activity is only reported for the trailing 400 days. This period can be shorter if your Region began supporting these features within the last year. The role might have been used more than 400 days ago. For more information, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_access-advisor.html#access-advisor_tracking-period">Regions where data is tracked</a> in the <i>IAM User Guide</i>.</p>
    pub fn get_role_last_used(&self) -> &::std::option::Option<super::super::types::RoleLastUsed> {
        &self.role_last_used
    }
    /// Consumes the builder and constructs a [`RoleDetail`](crate::types::RoleDetail).
    pub fn build(self) -> super::super::types::RoleDetail {
        super::super::types::RoleDetail {
            path: self.path,
