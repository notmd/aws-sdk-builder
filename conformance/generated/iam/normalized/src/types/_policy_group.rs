...
impl PolicyGroup {
    ...
    pub fn builder() -> super::super::types::builders::PolicyGroupBuilder {
        super::super::types::builders::PolicyGroupBuilder::default()
    }
}
...
impl PolicyGroupBuilder {
    ...
    pub fn build(self) -> super::super::types::PolicyGroup {
        super::super::types::PolicyGroup {
