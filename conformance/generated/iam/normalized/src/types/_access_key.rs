...
impl AccessKey {
    ...
    pub fn builder() -> super::super::types::builders::AccessKeyBuilder {
        super::super::types::builders::AccessKeyBuilder::default()
    }
}
...
impl AccessKeyBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::AccessKey, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::AccessKey {
