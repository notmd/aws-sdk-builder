...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::EntityAlreadyExistsException {
...
impl EntityAlreadyExistsException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::EntityAlreadyExistsExceptionBuilder {
        super::super::super::types::error::builders::EntityAlreadyExistsExceptionBuilder::default()
    }
}
...
impl EntityAlreadyExistsExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::EntityAlreadyExistsException {
        super::super::super::types::error::EntityAlreadyExistsException {
