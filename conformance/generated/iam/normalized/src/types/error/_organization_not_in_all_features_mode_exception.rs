...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::OrganizationNotInAllFeaturesModeException {
...
impl OrganizationNotInAllFeaturesModeException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::OrganizationNotInAllFeaturesModeExceptionBuilder {
        super::super::super::types::error::builders::OrganizationNotInAllFeaturesModeExceptionBuilder::default()
    }
}
...
impl OrganizationNotInAllFeaturesModeExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::OrganizationNotInAllFeaturesModeException {
        super::super::super::types::error::OrganizationNotInAllFeaturesModeException {
