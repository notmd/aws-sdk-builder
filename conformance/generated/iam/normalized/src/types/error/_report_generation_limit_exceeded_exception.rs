...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::ReportGenerationLimitExceededException {
...
impl ReportGenerationLimitExceededException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::ReportGenerationLimitExceededExceptionBuilder {
        super::super::super::types::error::builders::ReportGenerationLimitExceededExceptionBuilder::default()
    }
}
...
impl ReportGenerationLimitExceededExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::ReportGenerationLimitExceededException {
        super::super::super::types::error::ReportGenerationLimitExceededException {
