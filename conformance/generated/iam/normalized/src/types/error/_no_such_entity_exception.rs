...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::NoSuchEntityException {
...
impl NoSuchEntityException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::NoSuchEntityExceptionBuilder {
        super::super::super::types::error::builders::NoSuchEntityExceptionBuilder::default()
    }
}
...
impl NoSuchEntityExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::NoSuchEntityException {
        super::super::super::types::error::NoSuchEntityException {
