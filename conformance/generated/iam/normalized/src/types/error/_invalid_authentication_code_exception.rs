...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::InvalidAuthenticationCodeException {
...
impl InvalidAuthenticationCodeException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::InvalidAuthenticationCodeExceptionBuilder {
        super::super::super::types::error::builders::InvalidAuthenticationCodeExceptionBuilder::default()
    }
}
...
impl InvalidAuthenticationCodeExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::InvalidAuthenticationCodeException {
        super::super::super::types::error::InvalidAuthenticationCodeException {
