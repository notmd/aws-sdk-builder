...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::AccountNotManagementOrDelegatedAdministratorException {
...
impl AccountNotManagementOrDelegatedAdministratorException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::AccountNotManagementOrDelegatedAdministratorExceptionBuilder {
        super::super::super::types::error::builders::AccountNotManagementOrDelegatedAdministratorExceptionBuilder::default()
    }
}
...
impl AccountNotManagementOrDelegatedAdministratorExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::AccountNotManagementOrDelegatedAdministratorException {
        super::super::super::types::error::AccountNotManagementOrDelegatedAdministratorException {
