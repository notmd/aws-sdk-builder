...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::PasswordPolicyViolationException {
...
impl PasswordPolicyViolationException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::PasswordPolicyViolationExceptionBuilder {
        super::super::super::types::error::builders::PasswordPolicyViolationExceptionBuilder::default()
    }
}
...
impl PasswordPolicyViolationExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::PasswordPolicyViolationException {
        super::super::super::types::error::PasswordPolicyViolationException {
