...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::EntityTemporarilyUnmodifiableException {
...
impl EntityTemporarilyUnmodifiableException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::EntityTemporarilyUnmodifiableExceptionBuilder {
        super::super::super::types::error::builders::EntityTemporarilyUnmodifiableExceptionBuilder::default()
    }
}
...
impl EntityTemporarilyUnmodifiableExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::EntityTemporarilyUnmodifiableException {
        super::super::super::types::error::EntityTemporarilyUnmodifiableException {
