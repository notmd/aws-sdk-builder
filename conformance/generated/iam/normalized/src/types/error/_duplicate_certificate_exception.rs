...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::DuplicateCertificateException {
...
impl DuplicateCertificateException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::DuplicateCertificateExceptionBuilder {
        super::super::super::types::error::builders::DuplicateCertificateExceptionBuilder::default()
    }
}
...
impl DuplicateCertificateExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::DuplicateCertificateException {
        super::super::super::types::error::DuplicateCertificateException {
