...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::CredentialReportExpiredException {
...
impl CredentialReportExpiredException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::CredentialReportExpiredExceptionBuilder {
        super::super::super::types::error::builders::CredentialReportExpiredExceptionBuilder::default()
    }
}
...
impl CredentialReportExpiredExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::CredentialReportExpiredException {
        super::super::super::types::error::CredentialReportExpiredException {
