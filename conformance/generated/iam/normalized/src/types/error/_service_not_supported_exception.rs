...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::ServiceNotSupportedException {
...
impl ServiceNotSupportedException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::ServiceNotSupportedExceptionBuilder {
        super::super::super::types::error::builders::ServiceNotSupportedExceptionBuilder::default()
    }
}
...
impl ServiceNotSupportedExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::ServiceNotSupportedException {
        super::super::super::types::error::ServiceNotSupportedException {
