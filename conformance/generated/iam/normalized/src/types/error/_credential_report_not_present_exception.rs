...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::CredentialReportNotPresentException {
...
impl CredentialReportNotPresentException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::CredentialReportNotPresentExceptionBuilder {
        super::super::super::types::error::builders::CredentialReportNotPresentExceptionBuilder::default()
    }
}
...
impl CredentialReportNotPresentExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::CredentialReportNotPresentException {
        super::super::super::types::error::CredentialReportNotPresentException {
