...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::MalformedCertificateException {
...
impl MalformedCertificateException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::MalformedCertificateExceptionBuilder {
        super::super::super::types::error::builders::MalformedCertificateExceptionBuilder::default()
    }
}
...
impl MalformedCertificateExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::MalformedCertificateException {
        super::super::super::types::error::MalformedCertificateException {
