...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::PolicyNotAttachableException {
...
impl PolicyNotAttachableException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::PolicyNotAttachableExceptionBuilder {
        super::super::super::types::error::builders::PolicyNotAttachableExceptionBuilder::default()
    }
}
...
impl PolicyNotAttachableExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::PolicyNotAttachableException {
        super::super::super::types::error::PolicyNotAttachableException {
