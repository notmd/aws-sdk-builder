...
impl SigningCertificate {
    ...
    pub fn builder() -> super::super::types::builders::SigningCertificateBuilder {
        super::super::types::builders::SigningCertificateBuilder::default()
    }
}
...
impl SigningCertificateBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::SigningCertificate, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::SigningCertificate {
