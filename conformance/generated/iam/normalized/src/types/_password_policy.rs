...
impl PasswordPolicy {
    ...
    pub fn builder() -> super::super::types::builders::PasswordPolicyBuilder {
        super::super::types::builders::PasswordPolicyBuilder::default()
    }
}
...
impl PasswordPolicyBuilder {
    ...
    pub fn build(self) -> super::super::types::PasswordPolicy {
        super::super::types::PasswordPolicy {
