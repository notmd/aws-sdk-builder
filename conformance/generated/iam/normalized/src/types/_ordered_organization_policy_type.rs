...
impl OrderedOrganizationPolicyType {
    ...
    pub fn builder() -> super::super::types::builders::OrderedOrganizationPolicyTypeBuilder {
        super::super::types::builders::OrderedOrganizationPolicyTypeBuilder::default()
    }
}
...
impl OrderedOrganizationPolicyTypeBuilder {
    ...
    pub fn build(self) -> super::super::types::OrderedOrganizationPolicyType {
        super::super::types::OrderedOrganizationPolicyType {
