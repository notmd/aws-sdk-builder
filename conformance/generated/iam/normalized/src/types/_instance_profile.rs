...
pub struct InstanceProfile {
    ...
    pub roles: ::std::vec::Vec<super::super::types::Role>,
...
impl InstanceProfile {
    ...
    /// <p>The role associated with the instance profile.</p>
    pub fn roles(&self) -> &[super::super::types::Role] {
        use std::ops::Deref;
        self.roles.deref()
    }
    /// <p>A list of tags that are attached to the instance profile. For more information about tagging, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_tags.html">Tagging IAM resources</a> in the <i>IAM User Guide</i>.</p>
...
impl InstanceProfile {
    ...
    pub fn builder() -> super::super::types::builders::InstanceProfileBuilder {
        super::super::types::builders::InstanceProfileBuilder::default()
    }
}
...
pub struct InstanceProfileBuilder {
    ...
    pub(crate) roles: ::std::option::Option<::std::vec::Vec<super::super::types::Role>>,
...
impl InstanceProfileBuilder {
    ...
    ///
    /// <p>The role associated with the instance profile.</p>
    pub fn roles(mut self, input: super::super::types::Role) -> Self {
    ...
    /// <p>The role associated with the instance profile.</p>
    pub fn set_roles(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::Role>>) -> Self {
        self.roles = input;
        self
    }
    /// <p>The role associated with the instance profile.</p>
    pub fn get_roles(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::Role>> {
        &self.roles
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::InstanceProfile, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::InstanceProfile {
