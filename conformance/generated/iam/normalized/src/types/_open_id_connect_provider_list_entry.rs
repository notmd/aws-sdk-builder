...
impl OpenIdConnectProviderListEntry {
    ...
    pub fn builder() -> super::super::types::builders::OpenIdConnectProviderListEntryBuilder {
        super::super::types::builders::OpenIdConnectProviderListEntryBuilder::default()
    }
}
...
impl OpenIdConnectProviderListEntryBuilder {
    ...
    pub fn build(self) -> super::super::types::OpenIdConnectProviderListEntry {
        super::super::types::OpenIdConnectProviderListEntry { arn: self.arn }
    }
}
