...
impl InlinePolicy {
    ...
    pub fn builder() -> super::super::types::builders::InlinePolicyBuilder {
        super::super::types::builders::InlinePolicyBuilder::default()
    }
}
...
impl InlinePolicyBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::InlinePolicy, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::InlinePolicy {
