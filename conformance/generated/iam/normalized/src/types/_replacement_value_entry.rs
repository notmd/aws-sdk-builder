...
impl ReplacementValueEntry {
    ...
    pub fn builder() -> super::super::types::builders::ReplacementValueEntryBuilder {
        super::super::types::builders::ReplacementValueEntryBuilder::default()
    }
}
...
impl ReplacementValueEntryBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::ReplacementValueEntry, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::ReplacementValueEntry {
