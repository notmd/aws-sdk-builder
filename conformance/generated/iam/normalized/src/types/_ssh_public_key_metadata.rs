...
impl SshPublicKeyMetadata {
    ...
    pub fn builder() -> super::super::types::builders::SshPublicKeyMetadataBuilder {
        super::super::types::builders::SshPublicKeyMetadataBuilder::default()
    }
}
...
impl SshPublicKeyMetadataBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::SshPublicKeyMetadata, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::SshPublicKeyMetadata {
