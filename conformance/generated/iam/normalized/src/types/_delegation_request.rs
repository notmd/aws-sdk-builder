...
pub struct DelegationRequest {
    ...
    pub state: ::std::option::Option<super::super::types::StateType>,
...
impl DelegationRequest {
    ...
    /// <p>Contains information about the permissions being delegated in a delegation request.</p>
    pub fn permissions(&self) -> ::std::option::Option<&super::super::types::DelegationPermission> {
    ...
    /// <p>The state of this delegation request.</p>
    /// <p>See the <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/temporary-delegation-building-integration.html#temporary-delegation-request-lifecycle">Understanding the Request Lifecycle</a> for an explanation of how these states are transitioned.</p>
    pub fn state(&self) -> ::std::option::Option<&super::super::types::StateType> {
        self.state.as_ref()
    }
    /// <p>The expiry time of this delegation request</p>
    /// <p>See the <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/temporary-delegation-building-integration.html#temporary-delegation-request-lifecycle">Understanding the Request Lifecycle</a> for details on the life time of a delegation request at each state.</p>
...
impl DelegationRequest {
    ...
    pub fn builder() -> super::super::types::builders::DelegationRequestBuilder {
        super::super::types::builders::DelegationRequestBuilder::default()
    }
}
...
pub struct DelegationRequestBuilder {
    ...
    pub(crate) permissions: ::std::option::Option<super::super::types::DelegationPermission>,
    ...
    pub(crate) state: ::std::option::Option<super::super::types::StateType>,
...
impl DelegationRequestBuilder {
    ...
    /// <p>Contains information about the permissions being delegated in a delegation request.</p>
    pub fn permissions(mut self, input: super::super::types::DelegationPermission) -> Self {
        self.permissions = ::std::option::Option::Some(input);
        self
    }
    /// <p>Contains information about the permissions being delegated in a delegation request.</p>
    pub fn set_permissions(mut self, input: ::std::option::Option<super::super::types::DelegationPermission>) -> Self {
        self.permissions = input;
        self
    }
    /// <p>Contains information about the permissions being delegated in a delegation request.</p>
    pub fn get_permissions(&self) -> &::std::option::Option<super::super::types::DelegationPermission> {
        &self.permissions
    }
    /// <p>JSON content of the associated permission policy of this delegation request.</p>
    ...
    /// <p>The state of this delegation request.</p>
    /// <p>See the <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/temporary-delegation-building-integration.html#temporary-delegation-request-lifecycle">Understanding the Request Lifecycle</a> for an explanation of how these states are transitioned.</p>
    pub fn state(mut self, input: super::super::types::StateType) -> Self {
        self.state = ::std::option::Option::Some(input);
        self
    }
    /// <p>The state of this delegation request.</p>
    /// <p>See the <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/temporary-delegation-building-integration.html#temporary-delegation-request-lifecycle">Understanding the Request Lifecycle</a> for an explanation of how these states are transitioned.</p>
    pub fn set_state(mut self, input: ::std::option::Option<super::super::types::StateType>) -> Self {
        self.state = input;
        self
    }
    /// <p>The state of this delegation request.</p>
    /// <p>See the <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/temporary-delegation-building-integration.html#temporary-delegation-request-lifecycle">Understanding the Request Lifecycle</a> for an explanation of how these states are transitioned.</p>
    pub fn get_state(&self) -> &::std::option::Option<super::super::types::StateType> {
        &self.state
    }
    /// <p>The expiry time of this delegation request</p>
    /// <p>See the <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/temporary-delegation-building-integration.html#temporary-delegation-request-lifecycle">Understanding the Request Lifecycle</a> for details on the life time of a delegation request at each state.</p>
    ...
    pub fn build(self) -> super::super::types::DelegationRequest {
        super::super::types::DelegationRequest {
