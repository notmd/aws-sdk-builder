...
pub struct Statement {
    ...
    pub source_policy_type: ::std::option::Option<super::super::types::PolicySourceType>,
    /// <p>The row and column of the beginning of the <code>Statement</code> in an IAM policy.</p>
    pub start_position: ::std::option::Option<super::super::types::Position>,
    /// <p>The row and column of the end of a <code>Statement</code> in an IAM policy.</p>
    pub end_position: ::std::option::Option<super::super::types::Position>,
}
impl Statement {
    /// <p>The identifier of the policy that was provided as an input.</p>
    ...
    /// <p>The type of the policy.</p>
    pub fn source_policy_type(&self) -> ::std::option::Option<&super::super::types::PolicySourceType> {
        self.source_policy_type.as_ref()
    }
    /// <p>The row and column of the beginning of the <code>Statement</code> in an IAM policy.</p>
    pub fn start_position(&self) -> ::std::option::Option<&super::super::types::Position> {
        self.start_position.as_ref()
    }
    /// <p>The row and column of the end of a <code>Statement</code> in an IAM policy.</p>
    pub fn end_position(&self) -> ::std::option::Option<&super::super::types::Position> {
        self.end_position.as_ref()
    }
}
impl Statement {
    /// Creates a new builder-style object to manufacture [`Statement`](crate::types::Statement).
    pub fn builder() -> super::super::types::builders::StatementBuilder {
        super::super::types::builders::StatementBuilder::default()
    }
}
...
pub struct StatementBuilder {
    ...
    pub(crate) source_policy_type: ::std::option::Option<super::super::types::PolicySourceType>,
    pub(crate) start_position: ::std::option::Option<super::super::types::Position>,
    pub(crate) end_position: ::std::option::Option<super::super::types::Position>,
}
impl StatementBuilder {
    ...
    /// <p>The type of the policy.</p>
    pub fn source_policy_type(mut self, input: super::super::types::PolicySourceType) -> Self {
        self.source_policy_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The type of the policy.</p>
    pub fn set_source_policy_type(mut self, input: ::std::option::Option<super::super::types::PolicySourceType>) -> Self {
        self.source_policy_type = input;
        self
    }
    /// <p>The type of the policy.</p>
    pub fn get_source_policy_type(&self) -> &::std::option::Option<super::super::types::PolicySourceType> {
        &self.source_policy_type
    }
    /// <p>The row and column of the beginning of the <code>Statement</code> in an IAM policy.</p>
    pub fn start_position(mut self, input: super::super::types::Position) -> Self {
        self.start_position = ::std::option::Option::Some(input);
        self
    }
    /// <p>The row and column of the beginning of the <code>Statement</code> in an IAM policy.</p>
    pub fn set_start_position(mut self, input: ::std::option::Option<super::super::types::Position>) -> Self {
        self.start_position = input;
        self
    }
    /// <p>The row and column of the beginning of the <code>Statement</code> in an IAM policy.</p>
    pub fn get_start_position(&self) -> &::std::option::Option<super::super::types::Position> {
        &self.start_position
    }
    /// <p>The row and column of the end of a <code>Statement</code> in an IAM policy.</p>
    pub fn end_position(mut self, input: super::super::types::Position) -> Self {
        self.end_position = ::std::option::Option::Some(input);
        self
    }
    /// <p>The row and column of the end of a <code>Statement</code> in an IAM policy.</p>
    pub fn set_end_position(mut self, input: ::std::option::Option<super::super::types::Position>) -> Self {
        self.end_position = input;
        self
    }
    /// <p>The row and column of the end of a <code>Statement</code> in an IAM policy.</p>
    pub fn get_end_position(&self) -> &::std::option::Option<super::super::types::Position> {
        &self.end_position
    }
    /// Consumes the builder and constructs a [`Statement`](crate::types::Statement).
    pub fn build(self) -> super::super::types::Statement {
        super::super::types::Statement {
