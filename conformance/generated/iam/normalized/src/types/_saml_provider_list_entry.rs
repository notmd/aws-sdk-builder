...
impl SamlProviderListEntry {
    ...
    pub fn builder() -> super::super::types::builders::SamlProviderListEntryBuilder {
        super::super::types::builders::SamlProviderListEntryBuilder::default()
    }
}
...
impl SamlProviderListEntryBuilder {
    ...
    pub fn build(self) -> super::super::types::SamlProviderListEntry {
        super::super::types::SamlProviderListEntry {
            arn: self.arn,
