...
impl OrganizationsDecisionDetail {
    ...
    pub fn builder() -> super::super::types::builders::OrganizationsDecisionDetailBuilder {
        super::super::types::builders::OrganizationsDecisionDetailBuilder::default()
    }
}
...
impl OrganizationsDecisionDetailBuilder {
    ...
    pub fn build(self) -> super::super::types::OrganizationsDecisionDetail {
        super::super::types::OrganizationsDecisionDetail {
