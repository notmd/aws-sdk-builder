...
impl RoleUsageType {
    ...
    pub fn builder() -> super::super::types::builders::RoleUsageTypeBuilder {
        super::super::types::builders::RoleUsageTypeBuilder::default()
    }
}
...
impl RoleUsageTypeBuilder {
    ...
    pub fn build(self) -> super::super::types::RoleUsageType {
        super::super::types::RoleUsageType {
            region: self.region,
