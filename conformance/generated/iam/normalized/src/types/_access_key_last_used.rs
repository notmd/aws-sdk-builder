...
impl AccessKeyLastUsed {
    ...
    pub fn builder() -> super::super::types::builders::AccessKeyLastUsedBuilder {
        super::super::types::builders::AccessKeyLastUsedBuilder::default()
    }
}
...
impl AccessKeyLastUsedBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::AccessKeyLastUsed, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::AccessKeyLastUsed {
