...
impl SourceRoleTemplate {
    ...
    pub fn builder() -> super::super::types::builders::SourceRoleTemplateBuilder {
        super::super::types::builders::SourceRoleTemplateBuilder::default()
    }
}
...
impl SourceRoleTemplateBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::SourceRoleTemplate, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::SourceRoleTemplate {
