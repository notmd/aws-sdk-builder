...
impl PolicyRole {
    ...
    pub fn builder() -> super::super::types::builders::PolicyRoleBuilder {
        super::super::types::builders::PolicyRoleBuilder::default()
    }
}
...
impl PolicyRoleBuilder {
    ...
    pub fn build(self) -> super::super::types::PolicyRole {
        super::super::types::PolicyRole {
