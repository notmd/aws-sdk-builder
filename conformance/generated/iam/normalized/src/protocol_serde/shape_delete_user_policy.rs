...
pub fn de_delete_user_policy_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::delete_user_policy::DeleteUserPolicyOutput, super::super::operation::delete_user_policy::DeleteUserPolicyError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::delete_user_policy::DeleteUserPolicyError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "LimitExceeded" => super::super::operation::delete_user_policy::DeleteUserPolicyError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NoSuchEntity" => super::super::operation::delete_user_policy::DeleteUserPolicyError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceFailure" => super::super::operation::delete_user_policy::DeleteUserPolicyError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_delete_user_policy_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::delete_user_policy::builders::DeleteUserPolicyOutputBuilder::default();
