...
pub fn de_duplicate_ssh_public_key_exception_xml_err(
    inp: &[u8],
    mut builder: super::super::types::error::builders::DuplicateSshPublicKeyExceptionBuilder,
) -> std::result::Result<super::super::types::error::builders::DuplicateSshPublicKeyExceptionBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    if inp.is_empty() {
        return Ok(builder);
    }
