...
pub fn de_unrecognized_public_key_encoding_exception_xml_err(
    inp: &[u8],
    mut builder: super::super::types::error::builders::UnrecognizedPublicKeyEncodingExceptionBuilder,
) -> std::result::Result<super::super::types::error::builders::UnrecognizedPublicKeyEncodingExceptionBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    if inp.is_empty() {
        return Ok(builder);
    }
