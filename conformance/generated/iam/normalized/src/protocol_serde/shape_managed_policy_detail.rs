...
pub fn de_managed_policy_detail(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::ManagedPolicyDetail, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::ManagedPolicyDetail::builder();
