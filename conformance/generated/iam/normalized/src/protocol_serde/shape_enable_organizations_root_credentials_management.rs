...
pub fn de_enable_organizations_root_credentials_management_http_error(
    ...
    super::super::operation::enable_organizations_root_credentials_management::EnableOrganizationsRootCredentialsManagementOutput,
    super::super::operation::enable_organizations_root_credentials_management::EnableOrganizationsRootCredentialsManagementError,
> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                super::super::operation::enable_organizations_root_credentials_management::EnableOrganizationsRootCredentialsManagementError::unhandled(
                    generic,
                ),
            )
        }
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::enable_organizations_root_credentials_management::builders::EnableOrganizationsRootCredentialsManagementOutputBuilder::default();
        output = super::super::protocol_serde::shape_enable_organizations_root_credentials_management::de_enable_organizations_root_credentials_management(
            _response_body,
            output,
        )
        .map_err(super::super::operation::enable_organizations_root_credentials_management::EnableOrganizationsRootCredentialsManagementError::unhandled)?;
...
pub fn de_enable_organizations_root_credentials_management(
    inp: &[u8],
    mut builder: super::super::operation::enable_organizations_root_credentials_management::builders::EnableOrganizationsRootCredentialsManagementOutputBuilder,
) -> std::result::Result<
    super::super::operation::enable_organizations_root_credentials_management::builders::EnableOrganizationsRootCredentialsManagementOutputBuilder,
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        while let Some(mut tag) = result_tag.next_tag() {
            ...
            s if s.matches("EnabledFeatures") /* EnabledFeatures com.amazonaws.iam.synthetic#EnableOrganizationsRootCredentialsManagementOutput$EnabledFeatures */ =>  {
                let var_2 =
                    Some(
                        super::super::protocol_serde::shape_features_list_type::de_features_list_type(&mut tag, depth + 1)
                        ?
                    )
                ;
