...
pub fn ser_simulate_custom_policy_input_input_input(
    ...
    if let Some(var_12) = &input.ordered_organization_policy_input_list {
        ...
        for item_13 in var_12 {
            ...
            super::super::protocol_serde::shape_ordered_organization_policy_type::ser_ordered_organization_policy_type(entry_15, item_13)?;
        }
        list_14.finish();
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_33) = &input.context_entries {
        ...
        for item_34 in var_33 {
            ...
            super::super::protocol_serde::shape_context_entry::ser_context_entry(entry_36, item_34)?;
        }
        list_35.finish();
    }
    #[allow(unused_mut)]
