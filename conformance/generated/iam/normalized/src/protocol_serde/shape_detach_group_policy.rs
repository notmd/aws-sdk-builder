...
pub fn de_detach_group_policy_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::detach_group_policy::DetachGroupPolicyOutput, super::super::operation::detach_group_policy::DetachGroupPolicyError>
{
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::detach_group_policy::DetachGroupPolicyError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InvalidInput" => super::super::operation::detach_group_policy::DetachGroupPolicyError::InvalidInputException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "LimitExceeded" => super::super::operation::detach_group_policy::DetachGroupPolicyError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NoSuchEntity" => super::super::operation::detach_group_policy::DetachGroupPolicyError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceFailure" => super::super::operation::detach_group_policy::DetachGroupPolicyError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
) -> std::result::Result<super::super::operation::detach_group_policy::DetachGroupPolicyOutput, super::super::operation::detach_group_policy::DetachGroupPolicyError>
{
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::detach_group_policy::builders::DetachGroupPolicyOutputBuilder::default();
