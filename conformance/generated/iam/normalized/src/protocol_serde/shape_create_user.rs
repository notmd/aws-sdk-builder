...
pub fn de_create_user_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::create_user::CreateUserOutput, super::super::operation::create_user::CreateUserError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::create_user::CreateUserError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "ConcurrentModification" => super::super::operation::create_user::CreateUserError::ConcurrentModificationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "EntityAlreadyExists" => super::super::operation::create_user::CreateUserError::EntityAlreadyExistsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidInput" => super::super::operation::create_user::CreateUserError::InvalidInputException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "LimitExceeded" => super::super::operation::create_user::CreateUserError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NoSuchEntity" => super::super::operation::create_user::CreateUserError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceFailure" => super::super::operation::create_user::CreateUserError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_create_user_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::create_user::builders::CreateUserOutputBuilder::default();
        output = super::super::protocol_serde::shape_create_user::de_create_user(_response_body, output)
            .map_err(super::super::operation::create_user::CreateUserError::unhandled)?;
...
pub fn de_create_user(
    inp: &[u8],
    mut builder: super::super::operation::create_user::builders::CreateUserOutputBuilder,
) -> std::result::Result<super::super::operation::create_user::builders::CreateUserOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("CreateUserResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected CreateUserResult got {start_el:?}"
            )));
        }
        while let Some(mut tag) = result_tag.next_tag() {
            ...
            s if s.matches("User") /* User com.amazonaws.iam.synthetic#CreateUserOutput$User */ =>  {
                let var_1 =
                    Some(
                        super::super::protocol_serde::shape_user::de_user(&mut tag, depth + 1)
                        ?
                    )
                ;
