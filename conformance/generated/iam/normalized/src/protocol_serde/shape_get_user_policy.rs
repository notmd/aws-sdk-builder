...
pub fn de_get_user_policy_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::get_user_policy::GetUserPolicyOutput, super::super::operation::get_user_policy::GetUserPolicyError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::get_user_policy::GetUserPolicyError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "NoSuchEntity" => super::super::operation::get_user_policy::GetUserPolicyError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceFailure" => super::super::operation::get_user_policy::GetUserPolicyError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_get_user_policy_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::get_user_policy::builders::GetUserPolicyOutputBuilder::default();
        output = super::super::protocol_serde::shape_get_user_policy::de_get_user_policy(_response_body, output)
            .map_err(super::super::operation::get_user_policy::GetUserPolicyError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::super::serde_util::get_user_policy_output_output_correct_errors(output)
            .build()
            .map_err(super::super::operation::get_user_policy::GetUserPolicyError::unhandled)?
    })
}
...
pub fn de_get_user_policy(
    inp: &[u8],
    mut builder: super::super::operation::get_user_policy::builders::GetUserPolicyOutputBuilder,
) -> std::result::Result<super::super::operation::get_user_policy::builders::GetUserPolicyOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
