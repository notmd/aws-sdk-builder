...
pub fn de_service_last_accessed(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::ServiceLastAccessed, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::ServiceLastAccessed::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("TrackedActionsLastAccessed") /* TrackedActionsLastAccessed com.amazonaws.iam#ServiceLastAccessed$TrackedActionsLastAccessed */ =>  {
                let var_7 =
                    Some(
                        super::super::protocol_serde::shape_tracked_actions_last_accessed::de_tracked_actions_last_accessed(&mut tag, depth + 1)
                        ?
                    )
                ;
    ...
    Ok(super::super::serde_util::service_last_accessed_correct_errors(builder)
        .build()
