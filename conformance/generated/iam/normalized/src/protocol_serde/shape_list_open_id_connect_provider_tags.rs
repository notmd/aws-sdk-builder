...
pub fn de_list_open_id_connect_provider_tags_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_open_id_connect_provider_tags_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
pub fn de_list_open_id_connect_provider_tags(
    inp: &[u8],
    mut builder: super::super::operation::list_open_id_connect_provider_tags::builders::ListOpenIdConnectProviderTagsOutputBuilder,
) -> std::result::Result<
    super::super::operation::list_open_id_connect_provider_tags::builders::ListOpenIdConnectProviderTagsOutputBuilder,
...
> {
    ...
    if !(start_el.matches("ListOpenIDConnectProviderTagsResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected ListOpenIDConnectProviderTagsResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("ListOpenIDConnectProviderTagsResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected ListOpenIDConnectProviderTagsResult got {start_el:?}"
            )));
        }
