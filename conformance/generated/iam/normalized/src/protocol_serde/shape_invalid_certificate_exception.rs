...
pub fn de_invalid_certificate_exception_xml_err(
    inp: &[u8],
    mut builder: super::super::types::error::builders::InvalidCertificateExceptionBuilder,
) -> std::result::Result<super::super::types::error::builders::InvalidCertificateExceptionBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    if inp.is_empty() {
        return Ok(builder);
    }
