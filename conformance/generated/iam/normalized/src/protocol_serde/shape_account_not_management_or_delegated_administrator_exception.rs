...
pub fn de_account_not_management_or_delegated_administrator_exception_xml_err(
    inp: &[u8],
    mut builder: super::super::types::error::builders::AccountNotManagementOrDelegatedAdministratorExceptionBuilder,
) -> std::result::Result<
    super::super::types::error::builders::AccountNotManagementOrDelegatedAdministratorExceptionBuilder,
