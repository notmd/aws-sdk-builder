...
pub fn de_list_saml_provider_tags(
    inp: &[u8],
    mut builder: super::super::operation::list_saml_provider_tags::builders::ListSamlProviderTagsOutputBuilder,
) -> std::result::Result<
    super::super::operation::list_saml_provider_tags::builders::ListSamlProviderTagsOutputBuilder,
