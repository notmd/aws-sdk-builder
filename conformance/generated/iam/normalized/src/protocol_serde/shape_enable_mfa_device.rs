...
pub fn de_enable_mfa_device_http_error(
    ...
    Err(match error_code {
        ...
        "InvalidAuthenticationCode" => super::super::operation::enable_mfa_device::EnableMfaDeviceError::InvalidAuthenticationCodeException({
            ...
            let mut tmp = {
                #[allow(unused_mut)]
                let mut output = super::super::types::error::builders::InvalidAuthenticationCodeExceptionBuilder::default();
                output = super::super::protocol_serde::shape_invalid_authentication_code_exception::de_invalid_authentication_code_exception_xml_err(
                    _response_body,
                    output,
                )
                .map_err(super::super::operation::enable_mfa_device::EnableMfaDeviceError::unhandled)?;
