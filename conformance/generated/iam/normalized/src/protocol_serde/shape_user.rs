...
pub fn de_user(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::User, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::User::builder();
    ...
    Ok(super::super::serde_util::user_correct_errors(builder)
        .build()
