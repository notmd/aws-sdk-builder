...
pub fn de_server_certificate_metadata(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::ServerCertificateMetadata, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::ServerCertificateMetadata::builder();
    ...
    Ok(super::super::serde_util::server_certificate_metadata_correct_errors(builder)
        .build()
