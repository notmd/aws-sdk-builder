...
pub fn de_put_user_policy_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::put_user_policy::PutUserPolicyOutput, super::super::operation::put_user_policy::PutUserPolicyError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::put_user_policy::PutUserPolicyError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "LimitExceeded" => super::super::operation::put_user_policy::PutUserPolicyError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "MalformedPolicyDocument" => super::super::operation::put_user_policy::PutUserPolicyError::MalformedPolicyDocumentException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NoSuchEntity" => super::super::operation::put_user_policy::PutUserPolicyError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceFailure" => super::super::operation::put_user_policy::PutUserPolicyError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_put_user_policy_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::put_user_policy::builders::PutUserPolicyOutputBuilder::default();
