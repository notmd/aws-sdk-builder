...
pub fn de_list_attached_group_policies_http_error(
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(super::super::operation::list_attached_group_policies::ListAttachedGroupPoliciesError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "InvalidInput" => super::super::operation::list_attached_group_policies::ListAttachedGroupPoliciesError::InvalidInputException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NoSuchEntity" => super::super::operation::list_attached_group_policies::ListAttachedGroupPoliciesError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceFailure" => super::super::operation::list_attached_group_policies::ListAttachedGroupPoliciesError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_attached_group_policies::builders::ListAttachedGroupPoliciesOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_attached_group_policies::de_list_attached_group_policies(_response_body, output)
            .map_err(super::super::operation::list_attached_group_policies::ListAttachedGroupPoliciesError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_list_attached_group_policies(
    inp: &[u8],
    mut builder: super::super::operation::list_attached_group_policies::builders::ListAttachedGroupPoliciesOutputBuilder,
) -> std::result::Result<
    super::super::operation::list_attached_group_policies::builders::ListAttachedGroupPoliciesOutputBuilder,
...
> {
    ...
    if !(start_el.matches("ListAttachedGroupPoliciesResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected ListAttachedGroupPoliciesResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("ListAttachedGroupPoliciesResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected ListAttachedGroupPoliciesResult got {start_el:?}"
            )));
        }
        while let Some(mut tag) = result_tag.next_tag() {
            ...
            s if s.matches("AttachedPolicies") /* AttachedPolicies com.amazonaws.iam.synthetic#ListAttachedGroupPoliciesOutput$AttachedPolicies */ =>  {
                let var_1 =
                    Some(
                        super::super::protocol_serde::shape_attached_policies_list_type::de_attached_policies_list_type(&mut tag, depth + 1)
                        ?
                    )
                ;
