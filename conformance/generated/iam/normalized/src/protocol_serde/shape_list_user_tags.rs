...
pub fn de_list_user_tags_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::list_user_tags::ListUserTagsOutput, super::super::operation::list_user_tags::ListUserTagsError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::list_user_tags::ListUserTagsError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "NoSuchEntity" => super::super::operation::list_user_tags::ListUserTagsError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceFailure" => super::super::operation::list_user_tags::ListUserTagsError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_list_user_tags_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_user_tags::builders::ListUserTagsOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_user_tags::de_list_user_tags(_response_body, output)
            .map_err(super::super::operation::list_user_tags::ListUserTagsError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::super::serde_util::list_user_tags_output_output_correct_errors(output)
            .build()
            .map_err(super::super::operation::list_user_tags::ListUserTagsError::unhandled)?
    })
}
...
pub fn de_list_user_tags(
    inp: &[u8],
    mut builder: super::super::operation::list_user_tags::builders::ListUserTagsOutputBuilder,
) -> std::result::Result<super::super::operation::list_user_tags::builders::ListUserTagsOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("ListUserTagsResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected ListUserTagsResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("ListUserTagsResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected ListUserTagsResult got {start_el:?}"
            )));
        }
        ...
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("expected ListUserTagsResult tag"));
    };
    Ok(builder)
}
