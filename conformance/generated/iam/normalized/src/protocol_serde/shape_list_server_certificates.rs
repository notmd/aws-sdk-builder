...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(super::super::operation::list_server_certificates::ListServerCertificatesError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "ServiceFailure" => super::super::operation::list_server_certificates::ListServerCertificatesError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_server_certificates::builders::ListServerCertificatesOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_server_certificates::de_list_server_certificates(_response_body, output)
            .map_err(super::super::operation::list_server_certificates::ListServerCertificatesError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::super::serde_util::list_server_certificates_output_output_correct_errors(output)
            .build()
            .map_err(super::super::operation::list_server_certificates::ListServerCertificatesError::unhandled)?
    })
}
...
pub fn de_list_server_certificates(
    inp: &[u8],
    mut builder: super::super::operation::list_server_certificates::builders::ListServerCertificatesOutputBuilder,
) -> std::result::Result<
    super::super::operation::list_server_certificates::builders::ListServerCertificatesOutputBuilder,
...
> {
    ...
    if !(start_el.matches("ListServerCertificatesResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected ListServerCertificatesResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("ListServerCertificatesResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected ListServerCertificatesResult got {start_el:?}"
            )));
        }
        while let Some(mut tag) = result_tag.next_tag() {
            ...
            s if s.matches("ServerCertificateMetadataList") /* ServerCertificateMetadataList com.amazonaws.iam.synthetic#ListServerCertificatesOutput$ServerCertificateMetadataList */ =>  {
                let var_1 =
                    Some(
                        super::super::protocol_serde::shape_server_certificate_metadata_list_type::de_server_certificate_metadata_list_type(&mut tag, depth + 1)
                        ?
                    )
                ;
