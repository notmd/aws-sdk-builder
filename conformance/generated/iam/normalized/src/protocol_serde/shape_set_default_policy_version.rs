...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(super::super::operation::set_default_policy_version::SetDefaultPolicyVersionError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "InvalidInput" => super::super::operation::set_default_policy_version::SetDefaultPolicyVersionError::InvalidInputException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "LimitExceeded" => super::super::operation::set_default_policy_version::SetDefaultPolicyVersionError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NoSuchEntity" => super::super::operation::set_default_policy_version::SetDefaultPolicyVersionError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceFailure" => super::super::operation::set_default_policy_version::SetDefaultPolicyVersionError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::set_default_policy_version::builders::SetDefaultPolicyVersionOutputBuilder::default();
