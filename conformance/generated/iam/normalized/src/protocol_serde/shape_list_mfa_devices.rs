...
pub fn de_list_mfa_devices(
    inp: &[u8],
    mut builder: super::super::operation::list_mfa_devices::builders::ListMfaDevicesOutputBuilder,
) -> std::result::Result<super::super::operation::list_mfa_devices::builders::ListMfaDevicesOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("ListMFADevicesResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected ListMFADevicesResult got {start_el:?}"
            )));
        }
