...
pub fn de_update_saml_provider(
    inp: &[u8],
    mut builder: super::super::operation::update_saml_provider::builders::UpdateSamlProviderOutputBuilder,
) -> std::result::Result<super::super::operation::update_saml_provider::builders::UpdateSamlProviderOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError>
{
