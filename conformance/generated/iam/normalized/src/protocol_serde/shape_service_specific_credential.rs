...
pub fn de_service_specific_credential(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::ServiceSpecificCredential, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::ServiceSpecificCredential::builder();
    ...
    Ok(super::super::serde_util::service_specific_credential_correct_errors(builder)
        .build()
