...
pub fn de_permissions_boundary_decision_detail(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::PermissionsBoundaryDecisionDetail, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::PermissionsBoundaryDecisionDetail::builder();
