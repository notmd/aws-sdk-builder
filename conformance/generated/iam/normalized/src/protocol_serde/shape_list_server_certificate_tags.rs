...
pub fn de_list_server_certificate_tags_http_error(
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(super::super::operation::list_server_certificate_tags::ListServerCertificateTagsError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "NoSuchEntity" => super::super::operation::list_server_certificate_tags::ListServerCertificateTagsError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceFailure" => super::super::operation::list_server_certificate_tags::ListServerCertificateTagsError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_server_certificate_tags::builders::ListServerCertificateTagsOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_server_certificate_tags::de_list_server_certificate_tags(_response_body, output)
            .map_err(super::super::operation::list_server_certificate_tags::ListServerCertificateTagsError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::super::serde_util::list_server_certificate_tags_output_output_correct_errors(output)
            .build()
            .map_err(super::super::operation::list_server_certificate_tags::ListServerCertificateTagsError::unhandled)?
    })
}
...
#[allow(unused_mut)]
pub fn de_list_server_certificate_tags(
    inp: &[u8],
    mut builder: super::super::operation::list_server_certificate_tags::builders::ListServerCertificateTagsOutputBuilder,
) -> std::result::Result<
    super::super::operation::list_server_certificate_tags::builders::ListServerCertificateTagsOutputBuilder,
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("ListServerCertificateTagsResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected ListServerCertificateTagsResult got {start_el:?}"
            )));
        }
