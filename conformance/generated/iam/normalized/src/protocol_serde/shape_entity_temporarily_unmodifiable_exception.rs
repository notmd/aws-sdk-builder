...
pub fn de_entity_temporarily_unmodifiable_exception_xml_err(
    inp: &[u8],
    mut builder: super::super::types::error::builders::EntityTemporarilyUnmodifiableExceptionBuilder,
) -> std::result::Result<super::super::types::error::builders::EntityTemporarilyUnmodifiableExceptionBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    if inp.is_empty() {
        return Ok(builder);
    }
