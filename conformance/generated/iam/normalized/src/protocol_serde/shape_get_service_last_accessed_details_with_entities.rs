...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                super::super::operation::get_service_last_accessed_details_with_entities::GetServiceLastAccessedDetailsWithEntitiesError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
        "InvalidInput" => {
            super::super::operation::get_service_last_accessed_details_with_entities::GetServiceLastAccessedDetailsWithEntitiesError::InvalidInputException(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
        ...
        "NoSuchEntity" => {
            super::super::operation::get_service_last_accessed_details_with_entities::GetServiceLastAccessedDetailsWithEntitiesError::NoSuchEntityException(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::get_service_last_accessed_details_with_entities::builders::GetServiceLastAccessedDetailsWithEntitiesOutputBuilder::default();
        output = super::super::protocol_serde::shape_get_service_last_accessed_details_with_entities::de_get_service_last_accessed_details_with_entities(
            _response_body,
            output,
        )
        .map_err(super::super::operation::get_service_last_accessed_details_with_entities::GetServiceLastAccessedDetailsWithEntitiesError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::super::serde_util::get_service_last_accessed_details_with_entities_output_output_correct_errors(output)
            .build()
            .map_err(super::super::operation::get_service_last_accessed_details_with_entities::GetServiceLastAccessedDetailsWithEntitiesError::unhandled)?
    })
}
...
pub fn de_get_service_last_accessed_details_with_entities(
    inp: &[u8],
    mut builder: super::super::operation::get_service_last_accessed_details_with_entities::builders::GetServiceLastAccessedDetailsWithEntitiesOutputBuilder,
) -> std::result::Result<
    super::super::operation::get_service_last_accessed_details_with_entities::builders::GetServiceLastAccessedDetailsWithEntitiesOutputBuilder,
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        while let Some(mut tag) = result_tag.next_tag() {
            ...
            s if s.matches("JobStatus") /* JobStatus com.amazonaws.iam.synthetic#GetServiceLastAccessedDetailsWithEntitiesOutput$JobStatus */ =>  {
                let var_1 =
                    Some(
                        Result::<super::super::types::JobStatusType, ::aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            super::super::types::JobStatusType::from(
            ...
            s if s.matches("EntityDetailsList") /* EntityDetailsList com.amazonaws.iam.synthetic#GetServiceLastAccessedDetailsWithEntitiesOutput$EntityDetailsList */ =>  {
                let var_4 =
                    Some(
                        super::super::protocol_serde::shape_entity_details_list_type::de_entity_details_list_type(&mut tag, depth + 1)
                        ?
                    )
                ;
            ...
            s if s.matches("Error") /* Error com.amazonaws.iam.synthetic#GetServiceLastAccessedDetailsWithEntitiesOutput$Error */ =>  {
                let var_7 =
                    Some(
                        super::super::protocol_serde::shape_error_details::de_error_details(&mut tag, depth + 1)
                        ?
                    )
                ;
