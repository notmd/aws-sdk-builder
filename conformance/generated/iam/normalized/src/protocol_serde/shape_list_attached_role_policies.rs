...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(super::super::operation::list_attached_role_policies::ListAttachedRolePoliciesError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "InvalidInput" => super::super::operation::list_attached_role_policies::ListAttachedRolePoliciesError::InvalidInputException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NoSuchEntity" => super::super::operation::list_attached_role_policies::ListAttachedRolePoliciesError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceFailure" => super::super::operation::list_attached_role_policies::ListAttachedRolePoliciesError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_attached_role_policies::builders::ListAttachedRolePoliciesOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_attached_role_policies::de_list_attached_role_policies(_response_body, output)
            .map_err(super::super::operation::list_attached_role_policies::ListAttachedRolePoliciesError::unhandled)?;
...
pub fn de_list_attached_role_policies(
    inp: &[u8],
    mut builder: super::super::operation::list_attached_role_policies::builders::ListAttachedRolePoliciesOutputBuilder,
) -> std::result::Result<
    super::super::operation::list_attached_role_policies::builders::ListAttachedRolePoliciesOutputBuilder,
