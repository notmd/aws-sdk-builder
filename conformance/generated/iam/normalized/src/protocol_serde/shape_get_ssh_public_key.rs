...
pub fn de_get_ssh_public_key(
    inp: &[u8],
    mut builder: super::super::operation::get_ssh_public_key::builders::GetSshPublicKeyOutputBuilder,
) -> std::result::Result<super::super::operation::get_ssh_public_key::builders::GetSshPublicKeyOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
