...
pub fn de_update_access_key_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::update_access_key::UpdateAccessKeyOutput, super::super::operation::update_access_key::UpdateAccessKeyError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::update_access_key::UpdateAccessKeyError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InvalidInput" => super::super::operation::update_access_key::UpdateAccessKeyError::InvalidInputException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "LimitExceeded" => super::super::operation::update_access_key::UpdateAccessKeyError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NoSuchEntity" => super::super::operation::update_access_key::UpdateAccessKeyError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceFailure" => super::super::operation::update_access_key::UpdateAccessKeyError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_update_access_key_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::update_access_key::builders::UpdateAccessKeyOutputBuilder::default();
