...
pub fn de_delete_policy_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::delete_policy::DeletePolicyOutput, super::super::operation::delete_policy::DeletePolicyError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::delete_policy::DeletePolicyError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "DeleteConflict" => super::super::operation::delete_policy::DeletePolicyError::DeleteConflictException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidInput" => super::super::operation::delete_policy::DeletePolicyError::InvalidInputException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "LimitExceeded" => super::super::operation::delete_policy::DeletePolicyError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NoSuchEntity" => super::super::operation::delete_policy::DeletePolicyError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceFailure" => super::super::operation::delete_policy::DeletePolicyError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_delete_policy_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::delete_policy::builders::DeletePolicyOutputBuilder::default();
