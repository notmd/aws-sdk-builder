...
pub fn de_update_server_certificate_http_error(
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(super::super::operation::update_server_certificate::UpdateServerCertificateError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "EntityAlreadyExists" => super::super::operation::update_server_certificate::UpdateServerCertificateError::EntityAlreadyExistsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "LimitExceeded" => super::super::operation::update_server_certificate::UpdateServerCertificateError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NoSuchEntity" => super::super::operation::update_server_certificate::UpdateServerCertificateError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceFailure" => super::super::operation::update_server_certificate::UpdateServerCertificateError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::update_server_certificate::builders::UpdateServerCertificateOutputBuilder::default();
