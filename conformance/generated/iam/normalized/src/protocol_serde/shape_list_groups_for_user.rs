...
pub fn de_list_groups_for_user_http_error(
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::list_groups_for_user::ListGroupsForUserError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "NoSuchEntity" => super::super::operation::list_groups_for_user::ListGroupsForUserError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceFailure" => super::super::operation::list_groups_for_user::ListGroupsForUserError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_groups_for_user_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_groups_for_user::builders::ListGroupsForUserOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_groups_for_user::de_list_groups_for_user(_response_body, output)
            .map_err(super::super::operation::list_groups_for_user::ListGroupsForUserError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::super::serde_util::list_groups_for_user_output_output_correct_errors(output)
            .build()
            .map_err(super::super::operation::list_groups_for_user::ListGroupsForUserError::unhandled)?
    })
}
...
pub fn de_list_groups_for_user(
    inp: &[u8],
    mut builder: super::super::operation::list_groups_for_user::builders::ListGroupsForUserOutputBuilder,
) -> std::result::Result<super::super::operation::list_groups_for_user::builders::ListGroupsForUserOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("ListGroupsForUserResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected ListGroupsForUserResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("ListGroupsForUserResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected ListGroupsForUserResult got {start_el:?}"
            )));
        }
        while let Some(mut tag) = result_tag.next_tag() {
            ...
            s if s.matches("Groups") /* Groups com.amazonaws.iam.synthetic#ListGroupsForUserOutput$Groups */ =>  {
                let var_1 =
                    Some(
                        super::super::protocol_serde::shape_group_list_type::de_group_list_type(&mut tag, depth + 1)
                        ?
                    )
                ;
