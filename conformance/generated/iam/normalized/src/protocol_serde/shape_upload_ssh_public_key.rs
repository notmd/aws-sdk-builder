...
> {
    ...
    Err(match error_code {
        "DuplicateSSHPublicKey" => super::super::operation::upload_ssh_public_key::UploadSSHPublicKeyError::DuplicateSshPublicKeyException({
            ...
            let mut tmp = {
                #[allow(unused_mut)]
                let mut output = super::super::types::error::builders::DuplicateSshPublicKeyExceptionBuilder::default();
                output = super::super::protocol_serde::shape_duplicate_ssh_public_key_exception::de_duplicate_ssh_public_key_exception_xml_err(
                    _response_body,
                    output,
                )
                .map_err(super::super::operation::upload_ssh_public_key::UploadSSHPublicKeyError::unhandled)?;
...
pub fn de_upload_ssh_public_key(
    inp: &[u8],
    mut builder: super::super::operation::upload_ssh_public_key::builders::UploadSshPublicKeyOutputBuilder,
) -> std::result::Result<super::super::operation::upload_ssh_public_key::builders::UploadSshPublicKeyOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError>
{
