...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::list_entities_for_policy::ListEntitiesForPolicyError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InvalidInput" => super::super::operation::list_entities_for_policy::ListEntitiesForPolicyError::InvalidInputException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NoSuchEntity" => super::super::operation::list_entities_for_policy::ListEntitiesForPolicyError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceFailure" => super::super::operation::list_entities_for_policy::ListEntitiesForPolicyError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_entities_for_policy::builders::ListEntitiesForPolicyOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_entities_for_policy::de_list_entities_for_policy(_response_body, output)
            .map_err(super::super::operation::list_entities_for_policy::ListEntitiesForPolicyError::unhandled)?;
...
pub fn de_list_entities_for_policy(
    inp: &[u8],
    mut builder: super::super::operation::list_entities_for_policy::builders::ListEntitiesForPolicyOutputBuilder,
) -> std::result::Result<
    super::super::operation::list_entities_for_policy::builders::ListEntitiesForPolicyOutputBuilder,
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        while let Some(mut tag) = result_tag.next_tag() {
            ...
            s if s.matches("PolicyGroups") /* PolicyGroups com.amazonaws.iam.synthetic#ListEntitiesForPolicyOutput$PolicyGroups */ =>  {
                let var_1 =
                    Some(
                        super::super::protocol_serde::shape_policy_group_list_type::de_policy_group_list_type(&mut tag, depth + 1)
                        ?
                    )
                ;
            ...
            s if s.matches("PolicyUsers") /* PolicyUsers com.amazonaws.iam.synthetic#ListEntitiesForPolicyOutput$PolicyUsers */ =>  {
                let var_2 =
                    Some(
                        super::super::protocol_serde::shape_policy_user_list_type::de_policy_user_list_type(&mut tag, depth + 1)
                        ?
                    )
                ;
            ...
            s if s.matches("PolicyRoles") /* PolicyRoles com.amazonaws.iam.synthetic#ListEntitiesForPolicyOutput$PolicyRoles */ =>  {
                let var_3 =
                    Some(
                        super::super::protocol_serde::shape_policy_role_list_type::de_policy_role_list_type(&mut tag, depth + 1)
                        ?
                    )
                ;
