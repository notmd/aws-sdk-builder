...
pub fn de_service_specific_credential_metadata(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::ServiceSpecificCredentialMetadata, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::ServiceSpecificCredentialMetadata::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("Status") /* Status com.amazonaws.iam#ServiceSpecificCredentialMetadata$Status */ =>  {
                let var_2 =
                    Some(
                        Result::<super::super::types::StatusType, ::aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            super::super::types::StatusType::from(
                                ::aws_smithy_xml::decode::try_data(&mut tag)?.as_ref()
                            )
                        )
                        ?
    ...
    Ok(super::super::serde_util::service_specific_credential_metadata_correct_errors(builder)
        .build()
