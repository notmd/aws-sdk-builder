...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(super::super::operation::list_instance_profile_tags::ListInstanceProfileTagsError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "NoSuchEntity" => super::super::operation::list_instance_profile_tags::ListInstanceProfileTagsError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceFailure" => super::super::operation::list_instance_profile_tags::ListInstanceProfileTagsError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_instance_profile_tags::builders::ListInstanceProfileTagsOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_instance_profile_tags::de_list_instance_profile_tags(_response_body, output)
            .map_err(super::super::operation::list_instance_profile_tags::ListInstanceProfileTagsError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::super::serde_util::list_instance_profile_tags_output_output_correct_errors(output)
            .build()
            .map_err(super::super::operation::list_instance_profile_tags::ListInstanceProfileTagsError::unhandled)?
    })
}
...
pub fn de_list_instance_profile_tags(
    inp: &[u8],
    mut builder: super::super::operation::list_instance_profile_tags::builders::ListInstanceProfileTagsOutputBuilder,
) -> std::result::Result<
    super::super::operation::list_instance_profile_tags::builders::ListInstanceProfileTagsOutputBuilder,
...
> {
    ...
    if !(start_el.matches("ListInstanceProfileTagsResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected ListInstanceProfileTagsResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("ListInstanceProfileTagsResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected ListInstanceProfileTagsResult got {start_el:?}"
            )));
        }
