...
pub fn de_delete_group_policy_http_error(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::delete_group_policy::DeleteGroupPolicyOutput, super::super::operation::delete_group_policy::DeleteGroupPolicyError>
{
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::delete_group_policy::DeleteGroupPolicyError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "LimitExceeded" => super::super::operation::delete_group_policy::DeleteGroupPolicyError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NoSuchEntity" => super::super::operation::delete_group_policy::DeleteGroupPolicyError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceFailure" => super::super::operation::delete_group_policy::DeleteGroupPolicyError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
) -> std::result::Result<super::super::operation::delete_group_policy::DeleteGroupPolicyOutput, super::super::operation::delete_group_policy::DeleteGroupPolicyError>
{
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::delete_group_policy::builders::DeleteGroupPolicyOutputBuilder::default();
