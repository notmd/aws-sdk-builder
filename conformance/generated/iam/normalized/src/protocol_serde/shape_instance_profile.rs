...
pub fn de_instance_profile(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::InstanceProfile, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::InstanceProfile::builder();
    ...
    Ok(super::super::serde_util::instance_profile_correct_errors(builder)
        .build()
