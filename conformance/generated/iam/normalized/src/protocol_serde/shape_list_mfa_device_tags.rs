...
pub fn de_list_mfa_device_tags(
    inp: &[u8],
    mut builder: super::super::operation::list_mfa_device_tags::builders::ListMfaDeviceTagsOutputBuilder,
) -> std::result::Result<super::super::operation::list_mfa_device_tags::builders::ListMfaDeviceTagsOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
