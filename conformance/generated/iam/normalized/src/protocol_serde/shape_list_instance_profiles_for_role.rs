...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::list_instance_profiles_for_role::ListInstanceProfilesForRoleError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "NoSuchEntity" => super::super::operation::list_instance_profiles_for_role::ListInstanceProfilesForRoleError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceFailure" => super::super::operation::list_instance_profiles_for_role::ListInstanceProfilesForRoleError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_instance_profiles_for_role::builders::ListInstanceProfilesForRoleOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_instance_profiles_for_role::de_list_instance_profiles_for_role(_response_body, output)
            .map_err(super::super::operation::list_instance_profiles_for_role::ListInstanceProfilesForRoleError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::super::serde_util::list_instance_profiles_for_role_output_output_correct_errors(output)
            .build()
            .map_err(super::super::operation::list_instance_profiles_for_role::ListInstanceProfilesForRoleError::unhandled)?
    })
}
...
pub fn de_list_instance_profiles_for_role(
    inp: &[u8],
    mut builder: super::super::operation::list_instance_profiles_for_role::builders::ListInstanceProfilesForRoleOutputBuilder,
) -> std::result::Result<
    super::super::operation::list_instance_profiles_for_role::builders::ListInstanceProfilesForRoleOutputBuilder,
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        while let Some(mut tag) = result_tag.next_tag() {
            ...
            s if s.matches("InstanceProfiles") /* InstanceProfiles com.amazonaws.iam.synthetic#ListInstanceProfilesForRoleOutput$InstanceProfiles */ =>  {
                let var_1 =
                    Some(
                        super::super::protocol_serde::shape_instance_profile_list_type::de_instance_profile_list_type(&mut tag, depth + 1)
                        ?
                    )
                ;
