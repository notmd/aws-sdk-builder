...
pub fn de_list_policy_tags_http_error(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::list_policy_tags::ListPolicyTagsOutput, super::super::operation::list_policy_tags::ListPolicyTagsError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::list_policy_tags::ListPolicyTagsError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InvalidInput" => super::super::operation::list_policy_tags::ListPolicyTagsError::InvalidInputException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NoSuchEntity" => super::super::operation::list_policy_tags::ListPolicyTagsError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceFailure" => super::super::operation::list_policy_tags::ListPolicyTagsError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_policy_tags_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::list_policy_tags::ListPolicyTagsOutput, super::super::operation::list_policy_tags::ListPolicyTagsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_policy_tags::builders::ListPolicyTagsOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_policy_tags::de_list_policy_tags(_response_body, output)
            .map_err(super::super::operation::list_policy_tags::ListPolicyTagsError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::super::serde_util::list_policy_tags_output_output_correct_errors(output)
            .build()
            .map_err(super::super::operation::list_policy_tags::ListPolicyTagsError::unhandled)?
    })
}
...
#[allow(unused_mut)]
pub fn de_list_policy_tags(
    inp: &[u8],
    mut builder: super::super::operation::list_policy_tags::builders::ListPolicyTagsOutputBuilder,
) -> std::result::Result<super::super::operation::list_policy_tags::builders::ListPolicyTagsOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("ListPolicyTagsResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected ListPolicyTagsResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("ListPolicyTagsResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected ListPolicyTagsResult got {start_el:?}"
            )));
        }
        ...
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("expected ListPolicyTagsResult tag"));
    };
    Ok(builder)
}
