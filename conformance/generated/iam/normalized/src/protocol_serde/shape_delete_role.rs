...
pub fn de_delete_role_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::delete_role::DeleteRoleOutput, super::super::operation::delete_role::DeleteRoleError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::delete_role::DeleteRoleError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "ConcurrentModification" => super::super::operation::delete_role::DeleteRoleError::ConcurrentModificationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "DeleteConflict" => super::super::operation::delete_role::DeleteRoleError::DeleteConflictException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "LimitExceeded" => super::super::operation::delete_role::DeleteRoleError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NoSuchEntity" => super::super::operation::delete_role::DeleteRoleError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceFailure" => super::super::operation::delete_role::DeleteRoleError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UnmodifiableEntity" => super::super::operation::delete_role::DeleteRoleError::UnmodifiableEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_delete_role_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::delete_role::builders::DeleteRoleOutputBuilder::default();
