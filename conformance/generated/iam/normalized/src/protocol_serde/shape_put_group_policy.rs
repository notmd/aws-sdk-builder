...
pub fn de_put_group_policy_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::put_group_policy::PutGroupPolicyOutput, super::super::operation::put_group_policy::PutGroupPolicyError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::put_group_policy::PutGroupPolicyError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "LimitExceeded" => super::super::operation::put_group_policy::PutGroupPolicyError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "MalformedPolicyDocument" => super::super::operation::put_group_policy::PutGroupPolicyError::MalformedPolicyDocumentException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NoSuchEntity" => super::super::operation::put_group_policy::PutGroupPolicyError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceFailure" => super::super::operation::put_group_policy::PutGroupPolicyError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_put_group_policy_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::put_group_policy::builders::PutGroupPolicyOutputBuilder::default();
