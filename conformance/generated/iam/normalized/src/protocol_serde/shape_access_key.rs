...
pub fn de_access_key(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::AccessKey, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::AccessKey::builder();
    ...
    Ok(super::super::serde_util::access_key_correct_errors(builder)
        .build()
