...
> {
    ...
    let mut generic_builder = super::super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(
        super::super::operation::disable_organizations_root_credentials_management::DisableOrganizationsRootCredentialsManagementError::unhandled,
    )?;
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::disable_organizations_root_credentials_management::builders::DisableOrganizationsRootCredentialsManagementOutputBuilder::default();
        output =
            super::super::protocol_serde::shape_disable_organizations_root_credentials_management::de_disable_organizations_root_credentials_management(
                _response_body,
                output,
            )
            .map_err(
...
pub fn de_disable_organizations_root_credentials_management(
    inp: &[u8],
    mut builder: super::super::operation::disable_organizations_root_credentials_management::builders::DisableOrganizationsRootCredentialsManagementOutputBuilder,
) -> std::result::Result<
    super::super::operation::disable_organizations_root_credentials_management::builders::DisableOrganizationsRootCredentialsManagementOutputBuilder,
