...
pub fn de_user_detail(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::UserDetail, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::UserDetail::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("GroupList") /* GroupList com.amazonaws.iam#UserDetail$GroupList */ =>  {
                let var_7 =
                    Some(
                        super::super::protocol_serde::shape_group_name_list_type::de_group_name_list_type(&mut tag, depth + 1)
                        ?
                    )
                ;
