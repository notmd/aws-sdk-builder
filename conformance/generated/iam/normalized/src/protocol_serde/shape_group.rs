...
pub fn de_group(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::Group, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::Group::builder();
    ...
    Ok(super::super::serde_util::group_correct_errors(builder)
        .build()
