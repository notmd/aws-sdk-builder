...
pub fn de_list_access_keys_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::list_access_keys::ListAccessKeysOutput, super::super::operation::list_access_keys::ListAccessKeysError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::list_access_keys::ListAccessKeysError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "NoSuchEntity" => super::super::operation::list_access_keys::ListAccessKeysError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceFailure" => super::super::operation::list_access_keys::ListAccessKeysError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_list_access_keys_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_access_keys::builders::ListAccessKeysOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_access_keys::de_list_access_keys(_response_body, output)
            .map_err(super::super::operation::list_access_keys::ListAccessKeysError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::super::serde_util::list_access_keys_output_output_correct_errors(output)
            .build()
            .map_err(super::super::operation::list_access_keys::ListAccessKeysError::unhandled)?
    })
}
...
pub fn de_list_access_keys(
    inp: &[u8],
    mut builder: super::super::operation::list_access_keys::builders::ListAccessKeysOutputBuilder,
) -> std::result::Result<super::super::operation::list_access_keys::builders::ListAccessKeysOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        while let Some(mut tag) = result_tag.next_tag() {
            ...
            s if s.matches("AccessKeyMetadata") /* AccessKeyMetadata com.amazonaws.iam.synthetic#ListAccessKeysOutput$AccessKeyMetadata */ =>  {
                let var_1 =
                    Some(
                        super::super::protocol_serde::shape_access_key_metadata_list_type::de_access_key_metadata_list_type(&mut tag, depth + 1)
                        ?
                    )
                ;
