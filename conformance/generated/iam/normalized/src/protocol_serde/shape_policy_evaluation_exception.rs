...
pub fn de_policy_evaluation_exception_xml_err(
    inp: &[u8],
    mut builder: super::super::types::error::builders::PolicyEvaluationExceptionBuilder,
) -> std::result::Result<super::super::types::error::builders::PolicyEvaluationExceptionBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    if inp.is_empty() {
        return Ok(builder);
    }
