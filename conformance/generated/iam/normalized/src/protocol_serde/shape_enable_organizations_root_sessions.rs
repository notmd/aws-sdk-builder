...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::enable_organizations_root_sessions::EnableOrganizationsRootSessionsError::unhandled(generic)),
    };
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::enable_organizations_root_sessions::builders::EnableOrganizationsRootSessionsOutputBuilder::default();
        output = super::super::protocol_serde::shape_enable_organizations_root_sessions::de_enable_organizations_root_sessions(_response_body, output)
            .map_err(super::super::operation::enable_organizations_root_sessions::EnableOrganizationsRootSessionsError::unhandled)?;
...
pub fn de_enable_organizations_root_sessions(
    inp: &[u8],
    mut builder: super::super::operation::enable_organizations_root_sessions::builders::EnableOrganizationsRootSessionsOutputBuilder,
) -> std::result::Result<
    super::super::operation::enable_organizations_root_sessions::builders::EnableOrganizationsRootSessionsOutputBuilder,
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        while let Some(mut tag) = result_tag.next_tag() {
            match tag.start_el() {
            s if s.matches("OrganizationId") /* OrganizationId com.amazonaws.iam.synthetic#EnableOrganizationsRootSessionsOutput$OrganizationId */ =>  {
                let var_1 =
                    Some(
            ...
            ,
            s if s.matches("EnabledFeatures") /* EnabledFeatures com.amazonaws.iam.synthetic#EnableOrganizationsRootSessionsOutput$EnabledFeatures */ =>  {
                let var_2 =
                    Some(
