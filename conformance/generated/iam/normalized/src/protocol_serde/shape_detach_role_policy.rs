...
pub fn de_detach_role_policy_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::detach_role_policy::DetachRolePolicyOutput, super::super::operation::detach_role_policy::DetachRolePolicyError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::detach_role_policy::DetachRolePolicyError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InvalidInput" => super::super::operation::detach_role_policy::DetachRolePolicyError::InvalidInputException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "LimitExceeded" => super::super::operation::detach_role_policy::DetachRolePolicyError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NoSuchEntity" => super::super::operation::detach_role_policy::DetachRolePolicyError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceFailure" => super::super::operation::detach_role_policy::DetachRolePolicyError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UnmodifiableEntity" => super::super::operation::detach_role_policy::DetachRolePolicyError::UnmodifiableEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_detach_role_policy_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::detach_role_policy::builders::DetachRolePolicyOutputBuilder::default();
