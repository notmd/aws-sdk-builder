...
pub fn de_ssh_public_key_metadata(
    decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder,
    depth: u32,
) -> ::std::result::Result<super::super::types::SshPublicKeyMetadata, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::SshPublicKeyMetadata::builder();
    ...
    Ok(super::super::serde_util::ssh_public_key_metadata_correct_errors(builder)
        .build()
