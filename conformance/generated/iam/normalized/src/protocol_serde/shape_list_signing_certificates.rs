...
pub fn de_list_signing_certificates_http_error(
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(super::super::operation::list_signing_certificates::ListSigningCertificatesError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "NoSuchEntity" => super::super::operation::list_signing_certificates::ListSigningCertificatesError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceFailure" => super::super::operation::list_signing_certificates::ListSigningCertificatesError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_signing_certificates::builders::ListSigningCertificatesOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_signing_certificates::de_list_signing_certificates(_response_body, output)
            .map_err(super::super::operation::list_signing_certificates::ListSigningCertificatesError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::super::serde_util::list_signing_certificates_output_output_correct_errors(output)
            .build()
            .map_err(super::super::operation::list_signing_certificates::ListSigningCertificatesError::unhandled)?
    })
}
...
pub fn de_list_signing_certificates(
    inp: &[u8],
    mut builder: super::super::operation::list_signing_certificates::builders::ListSigningCertificatesOutputBuilder,
) -> std::result::Result<
    super::super::operation::list_signing_certificates::builders::ListSigningCertificatesOutputBuilder,
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        while let Some(mut tag) = result_tag.next_tag() {
            ...
            s if s.matches("Certificates") /* Certificates com.amazonaws.iam.synthetic#ListSigningCertificatesOutput$Certificates */ =>  {
                let var_1 =
                    Some(
                        super::super::protocol_serde::shape_certificate_list_type::de_certificate_list_type(&mut tag, depth + 1)
                        ?
                    )
                ;
