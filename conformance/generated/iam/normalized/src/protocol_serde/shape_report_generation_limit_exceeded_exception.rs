...
pub fn de_report_generation_limit_exceeded_exception_xml_err(
    inp: &[u8],
    mut builder: super::super::types::error::builders::ReportGenerationLimitExceededExceptionBuilder,
) -> std::result::Result<super::super::types::error::builders::ReportGenerationLimitExceededExceptionBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    if inp.is_empty() {
        return Ok(builder);
    }
