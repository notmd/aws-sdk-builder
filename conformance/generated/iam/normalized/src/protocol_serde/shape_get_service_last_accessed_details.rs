...
pub fn de_get_service_last_accessed_details_http_error(
    ...
    super::super::operation::get_service_last_accessed_details::GetServiceLastAccessedDetailsOutput,
    super::super::operation::get_service_last_accessed_details::GetServiceLastAccessedDetailsError,
> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::get_service_last_accessed_details::GetServiceLastAccessedDetailsError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InvalidInput" => super::super::operation::get_service_last_accessed_details::GetServiceLastAccessedDetailsError::InvalidInputException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NoSuchEntity" => super::super::operation::get_service_last_accessed_details::GetServiceLastAccessedDetailsError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::get_service_last_accessed_details::builders::GetServiceLastAccessedDetailsOutputBuilder::default();
        output = super::super::protocol_serde::shape_get_service_last_accessed_details::de_get_service_last_accessed_details(_response_body, output)
            .map_err(super::super::operation::get_service_last_accessed_details::GetServiceLastAccessedDetailsError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::super::serde_util::get_service_last_accessed_details_output_output_correct_errors(output)
            .build()
            .map_err(super::super::operation::get_service_last_accessed_details::GetServiceLastAccessedDetailsError::unhandled)?
    })
}
...
pub fn de_get_service_last_accessed_details(
    inp: &[u8],
    mut builder: super::super::operation::get_service_last_accessed_details::builders::GetServiceLastAccessedDetailsOutputBuilder,
) -> std::result::Result<
    super::super::operation::get_service_last_accessed_details::builders::GetServiceLastAccessedDetailsOutputBuilder,
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        while let Some(mut tag) = result_tag.next_tag() {
            ...
            s if s.matches("JobType") /* JobType com.amazonaws.iam.synthetic#GetServiceLastAccessedDetailsOutput$JobType */ =>  {
                let var_2 =
                    Some(
                        Result::<super::super::types::AccessAdvisorUsageGranularityType, ::aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            super::super::types::AccessAdvisorUsageGranularityType::from(
                                ::aws_smithy_xml::decode::try_data(&mut tag)?.as_ref()
                            )
                        )
                        ?
            ...
            s if s.matches("ServicesLastAccessed") /* ServicesLastAccessed com.amazonaws.iam.synthetic#GetServiceLastAccessedDetailsOutput$ServicesLastAccessed */ =>  {
                let var_4 =
                    Some(
                        super::super::protocol_serde::shape_services_last_accessed::de_services_last_accessed(&mut tag, depth + 1)
                        ?
                    )
                ;
