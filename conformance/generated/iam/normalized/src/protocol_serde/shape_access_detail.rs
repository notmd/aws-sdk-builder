...
pub fn de_access_detail(
    decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder,
    depth: u32,
) -> ::std::result::Result<super::super::types::AccessDetail, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::AccessDetail::builder();
    ...
    Ok(super::super::serde_util::access_detail_correct_errors(builder)
        .build()
