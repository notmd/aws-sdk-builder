...
pub fn de_virtual_mfa_device(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::VirtualMfaDevice, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::VirtualMfaDevice::builder();
    ...
    Ok(super::super::serde_util::virtual_mfa_device_correct_errors(builder)
        .build()
