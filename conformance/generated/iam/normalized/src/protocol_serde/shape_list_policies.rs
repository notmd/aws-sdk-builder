...
pub fn de_list_policies_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::list_policies::ListPoliciesOutput, super::super::operation::list_policies::ListPoliciesError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::list_policies::ListPoliciesError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "ServiceFailure" => super::super::operation::list_policies::ListPoliciesError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_list_policies_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_policies::builders::ListPoliciesOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_policies::de_list_policies(_response_body, output)
            .map_err(super::super::operation::list_policies::ListPoliciesError::unhandled)?;
...
pub fn de_list_policies(
    inp: &[u8],
    mut builder: super::super::operation::list_policies::builders::ListPoliciesOutputBuilder,
) -> std::result::Result<super::super::operation::list_policies::builders::ListPoliciesOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        while let Some(mut tag) = result_tag.next_tag() {
            ...
            s if s.matches("Policies") /* Policies com.amazonaws.iam.synthetic#ListPoliciesOutput$Policies */ =>  {
                let var_1 =
                    Some(
                        super::super::protocol_serde::shape_policy_list_type::de_policy_list_type(&mut tag, depth + 1)
                        ?
                    )
                ;
