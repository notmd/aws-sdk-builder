...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::list_instance_profiles::ListInstanceProfilesError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "ServiceFailure" => super::super::operation::list_instance_profiles::ListInstanceProfilesError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_instance_profiles::builders::ListInstanceProfilesOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_instance_profiles::de_list_instance_profiles(_response_body, output)
            .map_err(super::super::operation::list_instance_profiles::ListInstanceProfilesError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::super::serde_util::list_instance_profiles_output_output_correct_errors(output)
            .build()
            .map_err(super::super::operation::list_instance_profiles::ListInstanceProfilesError::unhandled)?
    })
}
...
pub fn de_list_instance_profiles(
    inp: &[u8],
    mut builder: super::super::operation::list_instance_profiles::builders::ListInstanceProfilesOutputBuilder,
) -> std::result::Result<
    super::super::operation::list_instance_profiles::builders::ListInstanceProfilesOutputBuilder,
