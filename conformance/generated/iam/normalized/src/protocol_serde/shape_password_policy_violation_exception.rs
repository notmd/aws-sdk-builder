...
pub fn de_password_policy_violation_exception_xml_err(
    inp: &[u8],
    mut builder: super::super::types::error::builders::PasswordPolicyViolationExceptionBuilder,
) -> std::result::Result<super::super::types::error::builders::PasswordPolicyViolationExceptionBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    if inp.is_empty() {
        return Ok(builder);
    }
