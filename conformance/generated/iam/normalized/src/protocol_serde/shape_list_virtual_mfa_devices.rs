...
pub fn de_list_virtual_mfa_devices(
    inp: &[u8],
    mut builder: super::super::operation::list_virtual_mfa_devices::builders::ListVirtualMfaDevicesOutputBuilder,
) -> std::result::Result<
    super::super::operation::list_virtual_mfa_devices::builders::ListVirtualMfaDevicesOutputBuilder,
