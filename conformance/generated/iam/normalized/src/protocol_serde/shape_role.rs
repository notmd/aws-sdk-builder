...
pub fn de_role(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::Role, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::Role::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("SourceRoleTemplate") /* SourceRoleTemplate com.amazonaws.iam#Role$SourceRoleTemplate */ =>  {
                let var_12 =
                    Some(
                        super::super::protocol_serde::shape_source_role_template::de_source_role_template(&mut tag, depth + 1)
                        ?
                    )
                ;
    ...
    Ok(super::super::serde_util::role_correct_errors(builder)
        .build()
