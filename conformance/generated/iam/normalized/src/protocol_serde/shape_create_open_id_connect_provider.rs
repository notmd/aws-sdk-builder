    ...
    Err(match error_code {
        ...
        "OpenIdIdpCommunicationError" => {
            super::super::operation::create_open_id_connect_provider::CreateOpenIdConnectProviderError::OpenIdIdpCommunicationErrorException({
                ...
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = super::super::types::error::builders::OpenIdIdpCommunicationErrorExceptionBuilder::default();
                    output =
                        super::super::protocol_serde::shape_open_id_idp_communication_error_exception::de_open_id_idp_communication_error_exception_xml_err(
                            _response_body,
                            output,
                        )
                        .map_err(super::super::operation::create_open_id_connect_provider::CreateOpenIdConnectProviderError::unhandled)?;
...
pub fn de_create_open_id_connect_provider(
    inp: &[u8],
    mut builder: super::super::operation::create_open_id_connect_provider::builders::CreateOpenIdConnectProviderOutputBuilder,
) -> std::result::Result<
    super::super::operation::create_open_id_connect_provider::builders::CreateOpenIdConnectProviderOutputBuilder,
