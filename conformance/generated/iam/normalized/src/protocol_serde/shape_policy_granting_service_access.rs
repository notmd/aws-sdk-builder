...
pub fn de_policy_granting_service_access(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::PolicyGrantingServiceAccess, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::PolicyGrantingServiceAccess::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("PolicyType") /* PolicyType com.amazonaws.iam#PolicyGrantingServiceAccess$PolicyType */ =>  {
                let var_2 =
                    Some(
                        Result::<super::super::types::PolicyType, ::aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            super::super::types::PolicyType::from(
                                ::aws_smithy_xml::decode::try_data(&mut tag)?.as_ref()
                            )
                        )
                        ?
            ...
            s if s.matches("EntityType") /* EntityType com.amazonaws.iam#PolicyGrantingServiceAccess$EntityType */ =>  {
                let var_4 =
                    Some(
                        Result::<super::super::types::PolicyOwnerEntityType, ::aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            super::super::types::PolicyOwnerEntityType::from(
                                ::aws_smithy_xml::decode::try_data(&mut tag)?.as_ref()
                            )
                        )
                        ?
    ...
    Ok(super::super::serde_util::policy_granting_service_access_correct_errors(builder)
        .build()
