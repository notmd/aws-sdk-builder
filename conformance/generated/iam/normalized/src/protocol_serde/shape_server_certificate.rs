...
pub fn de_server_certificate(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::ServerCertificate, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::ServerCertificate::builder();
    ...
    Ok(super::super::serde_util::server_certificate_correct_errors(builder)
        .build()
