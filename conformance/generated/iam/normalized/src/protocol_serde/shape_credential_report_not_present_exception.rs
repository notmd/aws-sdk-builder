...
pub fn de_credential_report_not_present_exception_xml_err(
    inp: &[u8],
    mut builder: super::super::types::error::builders::CredentialReportNotPresentExceptionBuilder,
) -> std::result::Result<super::super::types::error::builders::CredentialReportNotPresentExceptionBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    if inp.is_empty() {
        return Ok(builder);
    }
