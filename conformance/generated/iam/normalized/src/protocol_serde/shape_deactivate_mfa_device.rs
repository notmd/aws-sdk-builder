...
pub fn de_deactivate_mfa_device_http_error(
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::deactivate_mfa_device::builders::DeactivateMfaDeviceOutputBuilder::default();
