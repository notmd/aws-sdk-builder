...
pub fn de_role_detail(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::RoleDetail, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::RoleDetail::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("RolePolicyList") /* RolePolicyList com.amazonaws.iam#RoleDetail$RolePolicyList */ =>  {
                let var_8 =
                    Some(
                        super::super::protocol_serde::shape_policy_detail_list_type::de_policy_detail_list_type(&mut tag, depth + 1)
                        ?
                    )
                ;
            ...
            s if s.matches("PermissionsBoundary") /* PermissionsBoundary com.amazonaws.iam#RoleDetail$PermissionsBoundary */ =>  {
                let var_10 =
                    Some(
                        super::super::protocol_serde::shape_attached_permissions_boundary::de_attached_permissions_boundary(&mut tag, depth + 1)
                        ?
                    )
                ;
            ...
            s if s.matches("RoleLastUsed") /* RoleLastUsed com.amazonaws.iam#RoleDetail$RoleLastUsed */ =>  {
                let var_12 =
                    Some(
                        super::super::protocol_serde::shape_role_last_used::de_role_last_used(&mut tag, depth + 1)
                        ?
                    )
                ;
