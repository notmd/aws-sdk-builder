...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::get_organizations_access_report::GetOrganizationsAccessReportError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "NoSuchEntity" => super::super::operation::get_organizations_access_report::GetOrganizationsAccessReportError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::get_organizations_access_report::builders::GetOrganizationsAccessReportOutputBuilder::default();
        output = super::super::protocol_serde::shape_get_organizations_access_report::de_get_organizations_access_report(_response_body, output)
            .map_err(super::super::operation::get_organizations_access_report::GetOrganizationsAccessReportError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::super::serde_util::get_organizations_access_report_output_output_correct_errors(output)
            .build()
            .map_err(super::super::operation::get_organizations_access_report::GetOrganizationsAccessReportError::unhandled)?
    })
}
...
pub fn de_get_organizations_access_report(
    inp: &[u8],
    mut builder: super::super::operation::get_organizations_access_report::builders::GetOrganizationsAccessReportOutputBuilder,
) -> std::result::Result<
    super::super::operation::get_organizations_access_report::builders::GetOrganizationsAccessReportOutputBuilder,
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("GetOrganizationsAccessReportResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected GetOrganizationsAccessReportResult got {start_el:?}"
            )));
        }
        while let Some(mut tag) = result_tag.next_tag() {
            ...
            s if s.matches("AccessDetails") /* AccessDetails com.amazonaws.iam.synthetic#GetOrganizationsAccessReportOutput$AccessDetails */ =>  {
                let var_6 =
                    Some(
                        super::super::protocol_serde::shape_access_details::de_access_details(&mut tag, depth + 1)
                        ?
                    )
                ;
