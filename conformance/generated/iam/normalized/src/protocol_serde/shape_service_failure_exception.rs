...
pub fn de_service_failure_exception_xml_err(
    inp: &[u8],
    mut builder: super::super::types::error::builders::ServiceFailureExceptionBuilder,
) -> std::result::Result<super::super::types::error::builders::ServiceFailureExceptionBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    if inp.is_empty() {
        return Ok(builder);
    }
