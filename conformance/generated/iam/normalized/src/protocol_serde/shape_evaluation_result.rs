...
pub fn de_evaluation_result(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::EvaluationResult, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::EvaluationResult::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("EvalDecision") /* EvalDecision com.amazonaws.iam#EvaluationResult$EvalDecision */ =>  {
                let var_3 =
                    Some(
                        Result::<super::super::types::PolicyEvaluationDecisionType, ::aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            super::super::types::PolicyEvaluationDecisionType::from(
                                ::aws_smithy_xml::decode::try_data(&mut tag)?.as_ref()
                            )
                        )
                        ?
            ...
            s if s.matches("MatchedStatements") /* MatchedStatements com.amazonaws.iam#EvaluationResult$MatchedStatements */ =>  {
                let var_4 =
                    Some(
                        super::super::protocol_serde::shape_statement_list_type::de_statement_list_type(&mut tag, depth + 1)
                        ?
                    )
                ;
            ...
            s if s.matches("OrganizationsDecisionDetail") /* OrganizationsDecisionDetail com.amazonaws.iam#EvaluationResult$OrganizationsDecisionDetail */ =>  {
                let var_6 =
                    Some(
                        super::super::protocol_serde::shape_organizations_decision_detail::de_organizations_decision_detail(&mut tag, depth + 1)
                        ?
                    )
                ;
            ...
            s if s.matches("PermissionsBoundaryDecisionDetail") /* PermissionsBoundaryDecisionDetail com.amazonaws.iam#EvaluationResult$PermissionsBoundaryDecisionDetail */ =>  {
                let var_7 =
                    Some(
                        super::super::protocol_serde::shape_permissions_boundary_decision_detail::de_permissions_boundary_decision_detail(&mut tag, depth + 1)
                        ?
                    )
                ;
            ...
            s if s.matches("EvalDecisionDetails") /* EvalDecisionDetails com.amazonaws.iam#EvaluationResult$EvalDecisionDetails */ =>  {
                let var_8 =
                    Some(
                        super::super::protocol_serde::shape_eval_decision_details_type::de_eval_decision_details_type(&mut tag, depth + 1)
                        ?
                    )
                ;
            ...
            s if s.matches("ResourceSpecificResults") /* ResourceSpecificResults com.amazonaws.iam#EvaluationResult$ResourceSpecificResults */ =>  {
                let var_9 =
                    Some(
                        super::super::protocol_serde::shape_resource_specific_result_list_type::de_resource_specific_result_list_type(&mut tag, depth + 1)
                        ?
                    )
                ;
    ...
    Ok(super::super::serde_util::evaluation_result_correct_errors(builder)
        .build()
