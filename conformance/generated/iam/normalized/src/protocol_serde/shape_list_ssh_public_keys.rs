...
pub fn de_list_ssh_public_keys(
    inp: &[u8],
    mut builder: super::super::operation::list_ssh_public_keys::builders::ListSshPublicKeysOutputBuilder,
) -> std::result::Result<super::super::operation::list_ssh_public_keys::builders::ListSshPublicKeysOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
