...
pub fn de_add_user_to_group_http_error(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::add_user_to_group::AddUserToGroupOutput, super::super::operation::add_user_to_group::AddUserToGroupError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::add_user_to_group::AddUserToGroupError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "LimitExceeded" => super::super::operation::add_user_to_group::AddUserToGroupError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NoSuchEntity" => super::super::operation::add_user_to_group::AddUserToGroupError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceFailure" => super::super::operation::add_user_to_group::AddUserToGroupError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_add_user_to_group_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::add_user_to_group::builders::AddUserToGroupOutputBuilder::default();
