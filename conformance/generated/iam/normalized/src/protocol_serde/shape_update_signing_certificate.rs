...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(super::super::operation::update_signing_certificate::UpdateSigningCertificateError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "InvalidInput" => super::super::operation::update_signing_certificate::UpdateSigningCertificateError::InvalidInputException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "LimitExceeded" => super::super::operation::update_signing_certificate::UpdateSigningCertificateError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NoSuchEntity" => super::super::operation::update_signing_certificate::UpdateSigningCertificateError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceFailure" => super::super::operation::update_signing_certificate::UpdateSigningCertificateError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::update_signing_certificate::builders::UpdateSigningCertificateOutputBuilder::default();
