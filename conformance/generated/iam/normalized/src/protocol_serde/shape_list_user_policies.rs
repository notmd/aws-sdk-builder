...
pub fn de_list_user_policies_http_error(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::list_user_policies::ListUserPoliciesOutput, super::super::operation::list_user_policies::ListUserPoliciesError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::list_user_policies::ListUserPoliciesError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "NoSuchEntity" => super::super::operation::list_user_policies::ListUserPoliciesError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceFailure" => super::super::operation::list_user_policies::ListUserPoliciesError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_list_user_policies_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_user_policies::builders::ListUserPoliciesOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_user_policies::de_list_user_policies(_response_body, output)
            .map_err(super::super::operation::list_user_policies::ListUserPoliciesError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::super::serde_util::list_user_policies_output_output_correct_errors(output)
            .build()
            .map_err(super::super::operation::list_user_policies::ListUserPoliciesError::unhandled)?
    })
}
...
#[allow(unused_mut)]
pub fn de_list_user_policies(
    inp: &[u8],
    mut builder: super::super::operation::list_user_policies::builders::ListUserPoliciesOutputBuilder,
) -> std::result::Result<super::super::operation::list_user_policies::builders::ListUserPoliciesOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("ListUserPoliciesResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected ListUserPoliciesResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("ListUserPoliciesResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected ListUserPoliciesResult got {start_el:?}"
            )));
        }
