...
pub fn de_access_key_last_used(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::AccessKeyLastUsed, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::AccessKeyLastUsed::builder();
    ...
    Ok(super::super::serde_util::access_key_last_used_correct_errors(builder)
        .build()
