...
pub fn de_role_usage_type(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::RoleUsageType, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::RoleUsageType::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("Resources") /* Resources com.amazonaws.iam#RoleUsageType$Resources */ =>  {
                let var_2 =
                    Some(
                        super::super::protocol_serde::shape_arn_list_type::de_arn_list_type(&mut tag, depth + 1)
                        ?
                    )
                ;
