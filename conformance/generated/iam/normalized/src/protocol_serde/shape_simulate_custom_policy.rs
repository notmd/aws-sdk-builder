...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::simulate_custom_policy::SimulateCustomPolicyError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InvalidInput" => super::super::operation::simulate_custom_policy::SimulateCustomPolicyError::InvalidInputException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "PolicyEvaluation" => super::super::operation::simulate_custom_policy::SimulateCustomPolicyError::PolicyEvaluationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::simulate_custom_policy::builders::SimulateCustomPolicyOutputBuilder::default();
        output = super::super::protocol_serde::shape_simulate_custom_policy::de_simulate_custom_policy(_response_body, output)
            .map_err(super::super::operation::simulate_custom_policy::SimulateCustomPolicyError::unhandled)?;
...
pub fn de_simulate_custom_policy(
    inp: &[u8],
    mut builder: super::super::operation::simulate_custom_policy::builders::SimulateCustomPolicyOutputBuilder,
) -> std::result::Result<
    super::super::operation::simulate_custom_policy::builders::SimulateCustomPolicyOutputBuilder,
