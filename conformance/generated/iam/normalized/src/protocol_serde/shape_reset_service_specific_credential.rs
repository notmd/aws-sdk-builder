...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::reset_service_specific_credential::ResetServiceSpecificCredentialError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "NoSuchEntity" => super::super::operation::reset_service_specific_credential::ResetServiceSpecificCredentialError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::reset_service_specific_credential::builders::ResetServiceSpecificCredentialOutputBuilder::default();
        output = super::super::protocol_serde::shape_reset_service_specific_credential::de_reset_service_specific_credential(_response_body, output)
            .map_err(super::super::operation::reset_service_specific_credential::ResetServiceSpecificCredentialError::unhandled)?;
...
pub fn de_reset_service_specific_credential(
    inp: &[u8],
    mut builder: super::super::operation::reset_service_specific_credential::builders::ResetServiceSpecificCredentialOutputBuilder,
) -> std::result::Result<
    super::super::operation::reset_service_specific_credential::builders::ResetServiceSpecificCredentialOutputBuilder,
