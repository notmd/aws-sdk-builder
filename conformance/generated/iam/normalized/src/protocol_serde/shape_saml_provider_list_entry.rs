...
pub fn de_saml_provider_list_entry(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::SamlProviderListEntry, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::SamlProviderListEntry::builder();
