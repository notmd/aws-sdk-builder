...
pub fn de_list_attached_user_policies_http_error(
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(super::super::operation::list_attached_user_policies::ListAttachedUserPoliciesError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "InvalidInput" => super::super::operation::list_attached_user_policies::ListAttachedUserPoliciesError::InvalidInputException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NoSuchEntity" => super::super::operation::list_attached_user_policies::ListAttachedUserPoliciesError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceFailure" => super::super::operation::list_attached_user_policies::ListAttachedUserPoliciesError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_attached_user_policies::builders::ListAttachedUserPoliciesOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_attached_user_policies::de_list_attached_user_policies(_response_body, output)
            .map_err(super::super::operation::list_attached_user_policies::ListAttachedUserPoliciesError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_list_attached_user_policies(
    inp: &[u8],
    mut builder: super::super::operation::list_attached_user_policies::builders::ListAttachedUserPoliciesOutputBuilder,
) -> std::result::Result<
    super::super::operation::list_attached_user_policies::builders::ListAttachedUserPoliciesOutputBuilder,
...
> {
    ...
    if !(start_el.matches("ListAttachedUserPoliciesResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected ListAttachedUserPoliciesResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("ListAttachedUserPoliciesResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected ListAttachedUserPoliciesResult got {start_el:?}"
            )));
        }
