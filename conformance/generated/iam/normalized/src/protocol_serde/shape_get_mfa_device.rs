...
pub fn de_get_mfa_device(
    inp: &[u8],
    mut builder: super::super::operation::get_mfa_device::builders::GetMfaDeviceOutputBuilder,
) -> std::result::Result<super::super::operation::get_mfa_device::builders::GetMfaDeviceOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
