...
pub fn de_policy_not_attachable_exception_xml_err(
    inp: &[u8],
    mut builder: super::super::types::error::builders::PolicyNotAttachableExceptionBuilder,
) -> std::result::Result<super::super::types::error::builders::PolicyNotAttachableExceptionBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    if inp.is_empty() {
        return Ok(builder);
    }
