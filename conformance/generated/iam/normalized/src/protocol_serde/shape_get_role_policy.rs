...
pub fn de_get_role_policy_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::get_role_policy::GetRolePolicyOutput, super::super::operation::get_role_policy::GetRolePolicyError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::get_role_policy::GetRolePolicyError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "NoSuchEntity" => super::super::operation::get_role_policy::GetRolePolicyError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceFailure" => super::super::operation::get_role_policy::GetRolePolicyError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_get_role_policy_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::get_role_policy::builders::GetRolePolicyOutputBuilder::default();
        output = super::super::protocol_serde::shape_get_role_policy::de_get_role_policy(_response_body, output)
            .map_err(super::super::operation::get_role_policy::GetRolePolicyError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::super::serde_util::get_role_policy_output_output_correct_errors(output)
            .build()
            .map_err(super::super::operation::get_role_policy::GetRolePolicyError::unhandled)?
    })
}
...
pub fn de_get_role_policy(
    inp: &[u8],
    mut builder: super::super::operation::get_role_policy::builders::GetRolePolicyOutputBuilder,
) -> std::result::Result<super::super::operation::get_role_policy::builders::GetRolePolicyOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("GetRolePolicyResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected GetRolePolicyResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("GetRolePolicyResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected GetRolePolicyResult got {start_el:?}"
            )));
        }
