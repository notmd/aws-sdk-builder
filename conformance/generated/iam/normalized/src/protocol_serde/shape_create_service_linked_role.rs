...
pub fn de_create_service_linked_role_http_error(
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(super::super::operation::create_service_linked_role::CreateServiceLinkedRoleError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "InvalidInput" => super::super::operation::create_service_linked_role::CreateServiceLinkedRoleError::InvalidInputException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "LimitExceeded" => super::super::operation::create_service_linked_role::CreateServiceLinkedRoleError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NoSuchEntity" => super::super::operation::create_service_linked_role::CreateServiceLinkedRoleError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceFailure" => super::super::operation::create_service_linked_role::CreateServiceLinkedRoleError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::create_service_linked_role::builders::CreateServiceLinkedRoleOutputBuilder::default();
        output = super::super::protocol_serde::shape_create_service_linked_role::de_create_service_linked_role(_response_body, output)
            .map_err(super::super::operation::create_service_linked_role::CreateServiceLinkedRoleError::unhandled)?;
...
pub fn de_create_service_linked_role(
    inp: &[u8],
    mut builder: super::super::operation::create_service_linked_role::builders::CreateServiceLinkedRoleOutputBuilder,
) -> std::result::Result<
    super::super::operation::create_service_linked_role::builders::CreateServiceLinkedRoleOutputBuilder,
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("CreateServiceLinkedRoleResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected CreateServiceLinkedRoleResult got {start_el:?}"
            )));
        }
