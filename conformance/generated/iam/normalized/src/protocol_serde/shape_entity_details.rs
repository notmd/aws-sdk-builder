...
pub fn de_entity_details(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::EntityDetails, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::EntityDetails::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("EntityInfo") /* EntityInfo com.amazonaws.iam#EntityDetails$EntityInfo */ =>  {
                let var_1 =
                    Some(
                        super::super::protocol_serde::shape_entity_info::de_entity_info(&mut tag, depth + 1)
                        ?
                    )
                ;
    ...
    Ok(super::super::serde_util::entity_details_correct_errors(builder).build())
}
