...
pub fn de_get_group_http_error(
    ...
    Err(match error_code {
        "NoSuchEntity" => super::super::operation::get_group::GetGroupError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceFailure" => super::super::operation::get_group::GetGroupError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_get_group_http_response(
    ...
    Ok({
        ...
        super::super::serde_util::get_group_output_output_correct_errors(output)
            .build()
            .map_err(super::super::operation::get_group::GetGroupError::unhandled)?
    })
}
...
) -> std::result::Result<super::super::operation::get_group::builders::GetGroupOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        while let Some(mut tag) = result_tag.next_tag() {
            ...
            s if s.matches("Users") /* Users com.amazonaws.iam.synthetic#GetGroupOutput$Users */ =>  {
                let var_2 =
                    Some(
                        super::super::protocol_serde::shape_user_list_type::de_user_list_type(&mut tag, depth + 1)
                        ?
                    )
                ;
