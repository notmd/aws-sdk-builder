...
pub fn de_tracked_action_last_accessed(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::TrackedActionLastAccessed, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::TrackedActionLastAccessed::builder();
