...
pub fn de_list_role_tags_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::list_role_tags::ListRoleTagsOutput, super::super::operation::list_role_tags::ListRoleTagsError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::list_role_tags::ListRoleTagsError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "NoSuchEntity" => super::super::operation::list_role_tags::ListRoleTagsError::NoSuchEntityException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceFailure" => super::super::operation::list_role_tags::ListRoleTagsError::ServiceFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_list_role_tags_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_role_tags::builders::ListRoleTagsOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_role_tags::de_list_role_tags(_response_body, output)
            .map_err(super::super::operation::list_role_tags::ListRoleTagsError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::super::serde_util::list_role_tags_output_output_correct_errors(output)
            .build()
            .map_err(super::super::operation::list_role_tags::ListRoleTagsError::unhandled)?
    })
}
...
pub fn de_list_role_tags(
    inp: &[u8],
    mut builder: super::super::operation::list_role_tags::builders::ListRoleTagsOutputBuilder,
) -> std::result::Result<super::super::operation::list_role_tags::builders::ListRoleTagsOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("ListRoleTagsResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected ListRoleTagsResult got {start_el:?}"
            )));
        }
        ...
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("expected ListRoleTagsResult tag"));
    };
    Ok(builder)
}
