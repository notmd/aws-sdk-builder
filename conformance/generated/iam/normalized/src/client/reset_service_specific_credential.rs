...
impl super::Client {
    ...
    pub fn reset_service_specific_credential(
        &self,
    ) -> super::super::operation::reset_service_specific_credential::builders::ResetServiceSpecificCredentialFluentBuilder {
        super::super::operation::reset_service_specific_credential::builders::ResetServiceSpecificCredentialFluentBuilder::new(self.handle.clone())
    }
}
