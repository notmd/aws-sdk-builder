...
impl super::Client {
    ...
    pub fn list_saml_providers(&self) -> super::super::operation::list_saml_providers::builders::ListSAMLProvidersFluentBuilder {
        super::super::operation::list_saml_providers::builders::ListSAMLProvidersFluentBuilder::new(self.handle.clone())
    }
}
