...
impl super::Client {
    ...
    ///   - [`policy_arn(impl Into<String>)`](crate::operation::get_policy::builders::GetPolicyFluentBuilder::policy_arn) / [`set_policy_arn(Option<String>)`](crate::operation::get_policy::builders::GetPolicyFluentBuilder::set_policy_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the managed policy that you want information about.</p> <p>For more information about ARNs, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Names (ARNs)</a> in the <i>Amazon Web Services General Reference</i>.</p><br>
    ...
    pub fn get_policy(&self) -> super::super::operation::get_policy::builders::GetPolicyFluentBuilder {
        super::super::operation::get_policy::builders::GetPolicyFluentBuilder::new(self.handle.clone())
    }
}
