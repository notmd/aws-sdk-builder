...
impl super::Client {
    ...
    pub fn get_policy_version(&self) -> super::super::operation::get_policy_version::builders::GetPolicyVersionFluentBuilder {
        super::super::operation::get_policy_version::builders::GetPolicyVersionFluentBuilder::new(self.handle.clone())
    }
}
