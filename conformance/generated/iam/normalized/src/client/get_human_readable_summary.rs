...
impl super::Client {
    ...
    pub fn get_human_readable_summary(&self) -> super::super::operation::get_human_readable_summary::builders::GetHumanReadableSummaryFluentBuilder {
        super::super::operation::get_human_readable_summary::builders::GetHumanReadableSummaryFluentBuilder::new(self.handle.clone())
    }
}
