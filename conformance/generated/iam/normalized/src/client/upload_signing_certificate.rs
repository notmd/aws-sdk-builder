...
impl super::Client {
    ...
    pub fn upload_signing_certificate(&self) -> super::super::operation::upload_signing_certificate::builders::UploadSigningCertificateFluentBuilder {
        super::super::operation::upload_signing_certificate::builders::UploadSigningCertificateFluentBuilder::new(self.handle.clone())
    }
}
