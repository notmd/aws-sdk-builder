...
impl super::Client {
    ...
    ///   - [`saml_provider_uuid(Option<String>)`](crate::operation::get_saml_provider::GetSamlProviderOutput::saml_provider_uuid): <p>The unique identifier assigned to the SAML provider.</p>
    ...
    pub fn get_saml_provider(&self) -> super::super::operation::get_saml_provider::builders::GetSAMLProviderFluentBuilder {
        super::super::operation::get_saml_provider::builders::GetSAMLProviderFluentBuilder::new(self.handle.clone())
    }
}
