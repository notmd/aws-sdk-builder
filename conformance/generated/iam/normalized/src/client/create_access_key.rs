...
impl super::Client {
    ...
    pub fn create_access_key(&self) -> super::super::operation::create_access_key::builders::CreateAccessKeyFluentBuilder {
        super::super::operation::create_access_key::builders::CreateAccessKeyFluentBuilder::new(self.handle.clone())
    }
}
