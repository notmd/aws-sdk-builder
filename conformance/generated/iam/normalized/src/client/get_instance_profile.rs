...
impl super::Client {
    ...
    pub fn get_instance_profile(&self) -> super::super::operation::get_instance_profile::builders::GetInstanceProfileFluentBuilder {
        super::super::operation::get_instance_profile::builders::GetInstanceProfileFluentBuilder::new(self.handle.clone())
    }
}
