...
impl super::Client {
    ...
    pub fn get_mfa_device(&self) -> super::super::operation::get_mfa_device::builders::GetMFADeviceFluentBuilder {
        super::super::operation::get_mfa_device::builders::GetMFADeviceFluentBuilder::new(self.handle.clone())
    }
}
