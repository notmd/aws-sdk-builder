...
impl super::Client {
    ...
    pub fn get_role_template_version(&self) -> super::super::operation::get_role_template_version::builders::GetRoleTemplateVersionFluentBuilder {
        super::super::operation::get_role_template_version::builders::GetRoleTemplateVersionFluentBuilder::new(self.handle.clone())
    }
}
