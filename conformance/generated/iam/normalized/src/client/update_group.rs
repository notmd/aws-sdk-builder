...
impl super::Client {
    ...
    pub fn update_group(&self) -> super::super::operation::update_group::builders::UpdateGroupFluentBuilder {
        super::super::operation::update_group::builders::UpdateGroupFluentBuilder::new(self.handle.clone())
    }
}
