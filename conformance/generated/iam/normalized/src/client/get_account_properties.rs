...
impl super::Client {
    ...
    pub fn get_account_properties(&self) -> super::super::operation::get_account_properties::builders::GetAccountPropertiesFluentBuilder {
        super::super::operation::get_account_properties::builders::GetAccountPropertiesFluentBuilder::new(self.handle.clone())
    }
}
