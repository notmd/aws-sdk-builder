...
impl super::Client {
    ...
    pub fn get_user_policy(&self) -> super::super::operation::get_user_policy::builders::GetUserPolicyFluentBuilder {
        super::super::operation::get_user_policy::builders::GetUserPolicyFluentBuilder::new(self.handle.clone())
    }
}
