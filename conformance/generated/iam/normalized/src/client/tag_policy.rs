...
impl super::Client {
    ...
    pub fn tag_policy(&self) -> super::super::operation::tag_policy::builders::TagPolicyFluentBuilder {
        super::super::operation::tag_policy::builders::TagPolicyFluentBuilder::new(self.handle.clone())
    }
}
