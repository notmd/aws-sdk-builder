...
impl super::Client {
    ...
    pub fn delete_open_id_connect_provider(
        &self,
    ) -> super::super::operation::delete_open_id_connect_provider::builders::DeleteOpenIDConnectProviderFluentBuilder {
        super::super::operation::delete_open_id_connect_provider::builders::DeleteOpenIDConnectProviderFluentBuilder::new(self.handle.clone())
    }
}
