...
impl super::Client {
    ...
    pub fn get_account_summary(&self) -> super::super::operation::get_account_summary::builders::GetAccountSummaryFluentBuilder {
        super::super::operation::get_account_summary::builders::GetAccountSummaryFluentBuilder::new(self.handle.clone())
    }
}
