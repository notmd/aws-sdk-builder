...
impl super::Client {
    ...
    pub fn update_delegation_request(&self) -> super::super::operation::update_delegation_request::builders::UpdateDelegationRequestFluentBuilder {
        super::super::operation::update_delegation_request::builders::UpdateDelegationRequestFluentBuilder::new(self.handle.clone())
    }
}
