...
impl super::Client {
    ...
    pub fn get_access_key_last_used(&self) -> super::super::operation::get_access_key_last_used::builders::GetAccessKeyLastUsedFluentBuilder {
        super::super::operation::get_access_key_last_used::builders::GetAccessKeyLastUsedFluentBuilder::new(self.handle.clone())
    }
}
