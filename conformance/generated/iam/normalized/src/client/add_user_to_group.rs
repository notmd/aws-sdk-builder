...
impl super::Client {
    ...
    pub fn add_user_to_group(&self) -> super::super::operation::add_user_to_group::builders::AddUserToGroupFluentBuilder {
        super::super::operation::add_user_to_group::builders::AddUserToGroupFluentBuilder::new(self.handle.clone())
    }
}
