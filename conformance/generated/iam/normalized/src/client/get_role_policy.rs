...
impl super::Client {
    ...
    pub fn get_role_policy(&self) -> super::super::operation::get_role_policy::builders::GetRolePolicyFluentBuilder {
        super::super::operation::get_role_policy::builders::GetRolePolicyFluentBuilder::new(self.handle.clone())
    }
}
