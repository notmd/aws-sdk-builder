...
impl super::Client {
    ...
    pub fn generate_credential_report(&self) -> super::super::operation::generate_credential_report::builders::GenerateCredentialReportFluentBuilder {
        super::super::operation::generate_credential_report::builders::GenerateCredentialReportFluentBuilder::new(self.handle.clone())
    }
}
