...
impl super::Client {
    ...
    pub fn delete_login_profile(&self) -> super::super::operation::delete_login_profile::builders::DeleteLoginProfileFluentBuilder {
        super::super::operation::delete_login_profile::builders::DeleteLoginProfileFluentBuilder::new(self.handle.clone())
    }
}
