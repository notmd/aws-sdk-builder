...
impl super::Client {
    ...
    pub fn get_credential_report(&self) -> super::super::operation::get_credential_report::builders::GetCredentialReportFluentBuilder {
        super::super::operation::get_credential_report::builders::GetCredentialReportFluentBuilder::new(self.handle.clone())
    }
}
