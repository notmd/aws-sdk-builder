...
impl super::Client {
    ...
    pub fn delete_role_permissions_boundary(
        &self,
    ) -> super::super::operation::delete_role_permissions_boundary::builders::DeleteRolePermissionsBoundaryFluentBuilder {
        super::super::operation::delete_role_permissions_boundary::builders::DeleteRolePermissionsBoundaryFluentBuilder::new(self.handle.clone())
    }
}
