...
impl super::Client {
    ...
    pub fn send_delegation_token(&self) -> super::super::operation::send_delegation_token::builders::SendDelegationTokenFluentBuilder {
        super::super::operation::send_delegation_token::builders::SendDelegationTokenFluentBuilder::new(self.handle.clone())
    }
}
