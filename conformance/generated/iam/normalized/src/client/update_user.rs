...
impl super::Client {
    ...
    pub fn update_user(&self) -> super::super::operation::update_user::builders::UpdateUserFluentBuilder {
        super::super::operation::update_user::builders::UpdateUserFluentBuilder::new(self.handle.clone())
    }
}
