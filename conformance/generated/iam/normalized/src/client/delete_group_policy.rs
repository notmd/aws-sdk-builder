...
impl super::Client {
    ...
    pub fn delete_group_policy(&self) -> super::super::operation::delete_group_policy::builders::DeleteGroupPolicyFluentBuilder {
        super::super::operation::delete_group_policy::builders::DeleteGroupPolicyFluentBuilder::new(self.handle.clone())
    }
}
