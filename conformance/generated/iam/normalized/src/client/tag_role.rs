...
impl super::Client {
    ...
    pub fn tag_role(&self) -> super::super::operation::tag_role::builders::TagRoleFluentBuilder {
        super::super::operation::tag_role::builders::TagRoleFluentBuilder::new(self.handle.clone())
    }
}
