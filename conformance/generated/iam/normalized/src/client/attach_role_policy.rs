...
impl super::Client {
    ...
    pub fn attach_role_policy(&self) -> super::super::operation::attach_role_policy::builders::AttachRolePolicyFluentBuilder {
        super::super::operation::attach_role_policy::builders::AttachRolePolicyFluentBuilder::new(self.handle.clone())
    }
}
