...
impl super::Client {
    ...
    pub fn get_login_profile(&self) -> super::super::operation::get_login_profile::builders::GetLoginProfileFluentBuilder {
        super::super::operation::get_login_profile::builders::GetLoginProfileFluentBuilder::new(self.handle.clone())
    }
}
