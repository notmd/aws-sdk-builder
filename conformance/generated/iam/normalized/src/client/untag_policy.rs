...
impl super::Client {
    ...
    pub fn untag_policy(&self) -> super::super::operation::untag_policy::builders::UntagPolicyFluentBuilder {
        super::super::operation::untag_policy::builders::UntagPolicyFluentBuilder::new(self.handle.clone())
    }
}
