...
impl super::Client {
    ...
    pub fn list_open_id_connect_providers(
        &self,
    ) -> super::super::operation::list_open_id_connect_providers::builders::ListOpenIDConnectProvidersFluentBuilder {
        super::super::operation::list_open_id_connect_providers::builders::ListOpenIDConnectProvidersFluentBuilder::new(self.handle.clone())
    }
}
