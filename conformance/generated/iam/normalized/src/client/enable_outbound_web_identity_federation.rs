...
impl super::Client {
    ...
    pub fn enable_outbound_web_identity_federation(
        &self,
    ) -> super::super::operation::enable_outbound_web_identity_federation::builders::EnableOutboundWebIdentityFederationFluentBuilder {
        super::super::operation::enable_outbound_web_identity_federation::builders::EnableOutboundWebIdentityFederationFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
