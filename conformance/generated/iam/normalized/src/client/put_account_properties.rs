...
impl super::Client {
    ...
    pub fn put_account_properties(&self) -> super::super::operation::put_account_properties::builders::PutAccountPropertiesFluentBuilder {
        super::super::operation::put_account_properties::builders::PutAccountPropertiesFluentBuilder::new(self.handle.clone())
    }
}
