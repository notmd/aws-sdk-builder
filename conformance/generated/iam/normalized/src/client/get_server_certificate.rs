...
impl super::Client {
    ...
    pub fn get_server_certificate(&self) -> super::super::operation::get_server_certificate::builders::GetServerCertificateFluentBuilder {
        super::super::operation::get_server_certificate::builders::GetServerCertificateFluentBuilder::new(self.handle.clone())
    }
}
