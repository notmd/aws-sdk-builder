...
impl super::Client {
    ...
    pub fn get_context_keys_for_custom_policy(
        &self,
    ) -> super::super::operation::get_context_keys_for_custom_policy::builders::GetContextKeysForCustomPolicyFluentBuilder {
        super::super::operation::get_context_keys_for_custom_policy::builders::GetContextKeysForCustomPolicyFluentBuilder::new(self.handle.clone())
    }
}
