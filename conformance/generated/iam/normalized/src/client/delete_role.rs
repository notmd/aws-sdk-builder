...
impl super::Client {
    ...
    pub fn delete_role(&self) -> super::super::operation::delete_role::builders::DeleteRoleFluentBuilder {
        super::super::operation::delete_role::builders::DeleteRoleFluentBuilder::new(self.handle.clone())
    }
}
