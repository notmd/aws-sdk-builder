...
impl super::Client {
    ...
    pub fn remove_role_from_instance_profile(
        &self,
    ) -> super::super::operation::remove_role_from_instance_profile::builders::RemoveRoleFromInstanceProfileFluentBuilder {
        super::super::operation::remove_role_from_instance_profile::builders::RemoveRoleFromInstanceProfileFluentBuilder::new(self.handle.clone())
    }
}
