...
impl super::Client {
    ...
    pub fn detach_group_policy(&self) -> super::super::operation::detach_group_policy::builders::DetachGroupPolicyFluentBuilder {
        super::super::operation::detach_group_policy::builders::DetachGroupPolicyFluentBuilder::new(self.handle.clone())
    }
}
