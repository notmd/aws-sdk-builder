...
impl super::Client {
    ...
    pub fn get_role(&self) -> super::super::operation::get_role::builders::GetRoleFluentBuilder {
        super::super::operation::get_role::builders::GetRoleFluentBuilder::new(self.handle.clone())
    }
}
