...
pub struct RoleExistsFluentBuilder {
    ...
    inner: super::super::operation::get_role::builders::GetRoleInputBuilder,
}
impl RoleExistsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::operation::get_role::builders::GetRoleInputBuilder {
        &self.inner
    }
    ...
    ) -> ::std::result::Result<super::super::waiters::role_exists::RoleExistsFinalPoll, super::super::waiters::role_exists::WaitUntilRoleExistsError>
    {
        ...
        let runtime_plugins = super::super::operation::get_role::GetRole::operation_runtime_plugins(
        ...
        >| {
            ...
            if super::super::waiters::matchers::match_get_role_606386b4be9df73c9(result) {
        ...
        let operation = move || {
            ...
            async move { super::super::operation::get_role::GetRole::orchestrate(&runtime_plugins, input).await }
        };
