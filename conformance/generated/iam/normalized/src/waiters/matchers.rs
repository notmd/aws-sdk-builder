...
pub(crate) fn match_get_policy_c955e57777ec0d736(
    _result: ::std::result::Result<&super::super::operation::get_policy::GetPolicyOutput, &super::super::operation::get_policy::GetPolicyError>,
) -> bool {
    _result.is_ok()
}
...
pub(crate) fn match_get_role_c955e57777ec0d736(
    _result: ::std::result::Result<&super::super::operation::get_role::GetRoleOutput, &super::super::operation::get_role::GetRoleError>,
) -> bool {
    _result.is_ok()
}
...
pub(crate) fn match_get_user_c955e57777ec0d736(
    _result: ::std::result::Result<&super::super::operation::get_user::GetUserOutput, &super::super::operation::get_user::GetUserError>,
) -> bool {
    _result.is_ok()
}
