...
pub struct InstanceProfileExistsFluentBuilder {
    ...
    inner: super::super::operation::get_instance_profile::builders::GetInstanceProfileInputBuilder,
}
impl InstanceProfileExistsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::operation::get_instance_profile::builders::GetInstanceProfileInputBuilder {
        &self.inner
    }
    ...
    pub async fn wait(
        ...
        super::super::waiters::instance_profile_exists::InstanceProfileExistsFinalPoll,
        super::super::waiters::instance_profile_exists::WaitUntilInstanceProfileExistsError,
    > {
        let input = self
            .inner
            .build()
            .map_err(::aws_smithy_runtime_api::client::waiters::error::WaiterError::construction_failure)?;
        let runtime_plugins = super::super::operation::get_instance_profile::GetInstanceProfile::operation_runtime_plugins(
        ...
        >| {
            ...
            if super::super::waiters::matchers::match_get_instance_profile_c955e57777ec0d736(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"errorType":"NoSuchEntityException"}
            if super::super::waiters::matchers::match_get_instance_profile_73f4bff11904ca908(result) {
        ...
        let operation = move || {
            ...
            async move { super::super::operation::get_instance_profile::GetInstanceProfile::orchestrate(&runtime_plugins, input).await }
        };
