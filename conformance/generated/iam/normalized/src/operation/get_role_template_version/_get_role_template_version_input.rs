...
impl GetRoleTemplateVersionInput {
    ...
    pub fn builder() -> super::super::super::operation::get_role_template_version::builders::GetRoleTemplateVersionInputBuilder {
        super::super::super::operation::get_role_template_version::builders::GetRoleTemplateVersionInputBuilder::default()
    }
}
...
impl GetRoleTemplateVersionInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::get_role_template_version::GetRoleTemplateVersionInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::get_role_template_version::GetRoleTemplateVersionInput {
