...
impl ListGroupPoliciesInput {
    ...
    pub fn builder() -> super::super::super::operation::list_group_policies::builders::ListGroupPoliciesInputBuilder {
        super::super::super::operation::list_group_policies::builders::ListGroupPoliciesInputBuilder::default()
    }
}
