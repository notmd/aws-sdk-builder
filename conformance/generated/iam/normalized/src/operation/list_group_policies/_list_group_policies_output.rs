...
impl ListGroupPoliciesOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_group_policies::builders::ListGroupPoliciesOutputBuilder {
        super::super::super::operation::list_group_policies::builders::ListGroupPoliciesOutputBuilder::default()
    }
}
