...
impl ListPolicyVersionsOutput {
    ...
    pub fn versions(&self) -> &[super::super::super::types::PolicyVersion] {
...
impl ListPolicyVersionsOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_policy_versions::builders::ListPolicyVersionsOutputBuilder {
        super::super::super::operation::list_policy_versions::builders::ListPolicyVersionsOutputBuilder::default()
    }
}
...
pub struct ListPolicyVersionsOutputBuilder {
    pub(crate) versions: ::std::option::Option<::std::vec::Vec<super::super::super::types::PolicyVersion>>,
...
impl ListPolicyVersionsOutputBuilder {
    ...
    /// <p>A list of policy versions.</p>
    /// <p>For more information about managed policy versions, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/policies-managed-versions.html">Versioning for managed policies</a> in the <i>IAM User Guide</i>.</p>
    pub fn versions(mut self, input: super::super::super::types::PolicyVersion) -> Self {
    ...
    /// <p>A list of policy versions.</p>
    /// <p>For more information about managed policy versions, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/policies-managed-versions.html">Versioning for managed policies</a> in the <i>IAM User Guide</i>.</p>
    pub fn set_versions(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::PolicyVersion>>) -> Self {
        self.versions = input;
        self
    }
    /// <p>A list of policy versions.</p>
    /// <p>For more information about managed policy versions, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/policies-managed-versions.html">Versioning for managed policies</a> in the <i>IAM User Guide</i>.</p>
    pub fn get_versions(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::PolicyVersion>> {
        &self.versions
    }
    /// <p>A flag that indicates whether there are more items to return. If your results were truncated, you can make a subsequent pagination request using the <code>Marker</code> request parameter to retrieve more items. Note that IAM might return fewer than the <code>MaxItems</code> number of results even when there are more results available. We recommend that you check <code>IsTruncated</code> after every call to ensure that you receive all your results.</p>
    ...
    pub fn build(self) -> super::super::super::operation::list_policy_versions::ListPolicyVersionsOutput {
