...
impl UntagUserInput {
    ...
    pub fn builder() -> super::super::super::operation::untag_user::builders::UntagUserInputBuilder {
        super::super::super::operation::untag_user::builders::UntagUserInputBuilder::default()
    }
}
