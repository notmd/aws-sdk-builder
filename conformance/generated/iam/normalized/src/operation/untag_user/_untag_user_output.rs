...
impl UntagUserOutput {
    ...
    pub fn builder() -> super::super::super::operation::untag_user::builders::UntagUserOutputBuilder {
        super::super::super::operation::untag_user::builders::UntagUserOutputBuilder::default()
    }
}
...
impl UntagUserOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::untag_user::UntagUserOutput {
