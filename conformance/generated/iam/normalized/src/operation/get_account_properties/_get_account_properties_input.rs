...
impl GetAccountPropertiesInput {
    ...
    pub fn builder() -> super::super::super::operation::get_account_properties::builders::GetAccountPropertiesInputBuilder {
        super::super::super::operation::get_account_properties::builders::GetAccountPropertiesInputBuilder::default()
    }
}
