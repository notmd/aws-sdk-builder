...
impl GetAccountPropertiesOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_account_properties::builders::GetAccountPropertiesOutputBuilder {
        super::super::super::operation::get_account_properties::builders::GetAccountPropertiesOutputBuilder::default()
    }
}
...
impl GetAccountPropertiesOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::get_account_properties::GetAccountPropertiesOutput {
