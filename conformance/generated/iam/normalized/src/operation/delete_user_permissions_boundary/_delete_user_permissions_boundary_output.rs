...
impl DeleteUserPermissionsBoundaryOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_user_permissions_boundary::builders::DeleteUserPermissionsBoundaryOutputBuilder {
        super::super::super::operation::delete_user_permissions_boundary::builders::DeleteUserPermissionsBoundaryOutputBuilder::default()
    }
}
...
impl DeleteUserPermissionsBoundaryOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_user_permissions_boundary::DeleteUserPermissionsBoundaryOutput {
