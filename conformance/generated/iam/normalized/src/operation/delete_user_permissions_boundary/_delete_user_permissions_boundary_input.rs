...
impl DeleteUserPermissionsBoundaryInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_user_permissions_boundary::builders::DeleteUserPermissionsBoundaryInputBuilder {
        super::super::super::operation::delete_user_permissions_boundary::builders::DeleteUserPermissionsBoundaryInputBuilder::default()
    }
}
