...
impl CreateOpenIdConnectProviderOutput {
    ...
    pub fn builder() -> super::super::super::operation::create_open_id_connect_provider::builders::CreateOpenIdConnectProviderOutputBuilder {
        super::super::super::operation::create_open_id_connect_provider::builders::CreateOpenIdConnectProviderOutputBuilder::default()
    }
}
...
impl CreateOpenIdConnectProviderOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::create_open_id_connect_provider::CreateOpenIdConnectProviderOutput {
