...
impl DeleteUserOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_user::builders::DeleteUserOutputBuilder {
        super::super::super::operation::delete_user::builders::DeleteUserOutputBuilder::default()
    }
}
...
impl DeleteUserOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_user::DeleteUserOutput {
