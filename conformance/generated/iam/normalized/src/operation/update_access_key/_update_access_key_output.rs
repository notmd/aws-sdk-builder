...
impl UpdateAccessKeyOutput {
    ...
    pub fn builder() -> super::super::super::operation::update_access_key::builders::UpdateAccessKeyOutputBuilder {
        super::super::super::operation::update_access_key::builders::UpdateAccessKeyOutputBuilder::default()
    }
}
...
impl UpdateAccessKeyOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::update_access_key::UpdateAccessKeyOutput {
