...
impl DeleteServiceLinkedRoleInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_service_linked_role::builders::DeleteServiceLinkedRoleInputBuilder {
        super::super::super::operation::delete_service_linked_role::builders::DeleteServiceLinkedRoleInputBuilder::default()
    }
}
