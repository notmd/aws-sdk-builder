...
impl DeleteServiceLinkedRoleOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_service_linked_role::builders::DeleteServiceLinkedRoleOutputBuilder {
        super::super::super::operation::delete_service_linked_role::builders::DeleteServiceLinkedRoleOutputBuilder::default()
    }
}
