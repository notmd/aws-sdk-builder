...
impl UpdateSSHPublicKey {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::update_ssh_public_key::UpdateSshPublicKeyInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::update_ssh_public_key::UpdateSSHPublicKeyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::update_ssh_public_key::UpdateSshPublicKeyOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "UpdateSSHPublicKey", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateSSHPublicKeyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_update_ssh_public_key::de_update_ssh_public_key_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_update_ssh_public_key::de_update_ssh_public_key_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateSSHPublicKeyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::update_ssh_public_key::UpdateSshPublicKeyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::update_ssh_public_key::UpdateSshPublicKeyInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::update_ssh_public_key::UpdateSSHPublicKeyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::update_ssh_public_key::_update_ssh_public_key_input::UpdateSshPublicKeyInput;

pub use super::super::operation::update_ssh_public_key::_update_ssh_public_key_output::UpdateSshPublicKeyOutput;
