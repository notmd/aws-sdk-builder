...
impl DeleteInstanceProfileOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_instance_profile::builders::DeleteInstanceProfileOutputBuilder {
        super::super::super::operation::delete_instance_profile::builders::DeleteInstanceProfileOutputBuilder::default()
    }
}
...
impl DeleteInstanceProfileOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_instance_profile::DeleteInstanceProfileOutput {
