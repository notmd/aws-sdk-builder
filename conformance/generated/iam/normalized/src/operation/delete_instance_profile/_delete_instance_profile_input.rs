...
impl DeleteInstanceProfileInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_instance_profile::builders::DeleteInstanceProfileInputBuilder {
        super::super::super::operation::delete_instance_profile::builders::DeleteInstanceProfileInputBuilder::default()
    }
}
