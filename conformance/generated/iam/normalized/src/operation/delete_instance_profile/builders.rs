...
pub use super::super::super::operation::delete_instance_profile::_delete_instance_profile_input::DeleteInstanceProfileInputBuilder;

pub use super::super::super::operation::delete_instance_profile::_delete_instance_profile_output::DeleteInstanceProfileOutputBuilder;

impl super::super::super::operation::delete_instance_profile::builders::DeleteInstanceProfileInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_instance_profile::DeleteInstanceProfileOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_instance_profile::DeleteInstanceProfileError,
...
pub struct DeleteInstanceProfileFluentBuilder {
    ...
    inner: super::super::super::operation::delete_instance_profile::builders::DeleteInstanceProfileInputBuilder,
...
impl DeleteInstanceProfileFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_instance_profile::builders::DeleteInstanceProfileInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_instance_profile::DeleteInstanceProfile::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_instance_profile::DeleteInstanceProfile::orchestrate(&runtime_plugins, input).await
    }
