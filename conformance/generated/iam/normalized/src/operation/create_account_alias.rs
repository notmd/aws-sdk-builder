...
impl CreateAccountAlias {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::create_account_alias::CreateAccountAliasInput,
    ) -> ::std::result::Result<
        super::super::operation::create_account_alias::CreateAccountAliasOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::create_account_alias::CreateAccountAliasError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::create_account_alias::CreateAccountAliasError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::create_account_alias::CreateAccountAliasOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "CreateAccountAlias", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateAccountAliasResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_create_account_alias::de_create_account_alias_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_create_account_alias::de_create_account_alias_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateAccountAliasRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::create_account_alias::CreateAccountAliasInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::create_account_alias::CreateAccountAliasInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::create_account_alias::CreateAccountAliasError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::create_account_alias::_create_account_alias_input::CreateAccountAliasInput;

pub use super::super::operation::create_account_alias::_create_account_alias_output::CreateAccountAliasOutput;
