...
impl ListServiceSpecificCredentialsOutput {
    ...
    pub fn service_specific_credentials(&self) -> &[super::super::super::types::ServiceSpecificCredentialMetadata] {
...
impl ListServiceSpecificCredentialsOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_service_specific_credentials::builders::ListServiceSpecificCredentialsOutputBuilder {
        super::super::super::operation::list_service_specific_credentials::builders::ListServiceSpecificCredentialsOutputBuilder::default()
    }
}
...
pub struct ListServiceSpecificCredentialsOutputBuilder {
    pub(crate) service_specific_credentials: ::std::option::Option<::std::vec::Vec<super::super::super::types::ServiceSpecificCredentialMetadata>>,
...
impl ListServiceSpecificCredentialsOutputBuilder {
    ...
    ///
    /// <p>A list of structures that each contain details about a service-specific credential.</p>
    pub fn service_specific_credentials(mut self, input: super::super::super::types::ServiceSpecificCredentialMetadata) -> Self {
    ...
    pub fn set_service_specific_credentials(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::ServiceSpecificCredentialMetadata>>,
    ) -> Self {
    ...
    pub fn build(self) -> super::super::super::operation::list_service_specific_credentials::ListServiceSpecificCredentialsOutput {
        super::super::super::operation::list_service_specific_credentials::ListServiceSpecificCredentialsOutput {
