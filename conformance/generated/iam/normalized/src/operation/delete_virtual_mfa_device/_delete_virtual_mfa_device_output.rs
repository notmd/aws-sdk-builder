...
impl DeleteVirtualMfaDeviceOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_virtual_mfa_device::builders::DeleteVirtualMfaDeviceOutputBuilder {
        super::super::super::operation::delete_virtual_mfa_device::builders::DeleteVirtualMfaDeviceOutputBuilder::default()
    }
}
...
impl DeleteVirtualMfaDeviceOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_virtual_mfa_device::DeleteVirtualMfaDeviceOutput {
