...
impl DeleteVirtualMfaDeviceInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_virtual_mfa_device::builders::DeleteVirtualMfaDeviceInputBuilder {
        super::super::super::operation::delete_virtual_mfa_device::builders::DeleteVirtualMfaDeviceInputBuilder::default()
    }
}
...
impl DeleteVirtualMfaDeviceInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::delete_virtual_mfa_device::DeleteVirtualMfaDeviceInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::delete_virtual_mfa_device::DeleteVirtualMfaDeviceInput {
