...
impl GetRoleInput {
    ...
    pub fn builder() -> super::super::super::operation::get_role::builders::GetRoleInputBuilder {
        super::super::super::operation::get_role::builders::GetRoleInputBuilder::default()
    }
}
