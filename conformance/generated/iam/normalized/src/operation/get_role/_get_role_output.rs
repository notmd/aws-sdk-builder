...
impl GetRoleOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_role::builders::GetRoleOutputBuilder {
        super::super::super::operation::get_role::builders::GetRoleOutputBuilder::default()
    }
}
...
impl GetRoleOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::get_role::GetRoleOutput {
