...
pub use super::super::super::operation::delete_policy_version::_delete_policy_version_input::DeletePolicyVersionInputBuilder;

pub use super::super::super::operation::delete_policy_version::_delete_policy_version_output::DeletePolicyVersionOutputBuilder;

impl super::super::super::operation::delete_policy_version::builders::DeletePolicyVersionInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_policy_version::DeletePolicyVersionOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_policy_version::DeletePolicyVersionError,
...
pub struct DeletePolicyVersionFluentBuilder {
    ...
    inner: super::super::super::operation::delete_policy_version::builders::DeletePolicyVersionInputBuilder,
...
impl DeletePolicyVersionFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_policy_version::builders::DeletePolicyVersionInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_policy_version::DeletePolicyVersion::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_policy_version::DeletePolicyVersion::orchestrate(&runtime_plugins, input).await
    }
