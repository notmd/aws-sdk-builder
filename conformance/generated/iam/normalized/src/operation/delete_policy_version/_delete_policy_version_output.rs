...
impl DeletePolicyVersionOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_policy_version::builders::DeletePolicyVersionOutputBuilder {
        super::super::super::operation::delete_policy_version::builders::DeletePolicyVersionOutputBuilder::default()
    }
}
...
impl DeletePolicyVersionOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_policy_version::DeletePolicyVersionOutput {
