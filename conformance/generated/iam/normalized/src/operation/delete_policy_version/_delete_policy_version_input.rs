...
impl DeletePolicyVersionInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_policy_version::builders::DeletePolicyVersionInputBuilder {
        super::super::super::operation::delete_policy_version::builders::DeletePolicyVersionInputBuilder::default()
    }
}
