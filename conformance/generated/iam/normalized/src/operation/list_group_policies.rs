...
impl ListGroupPolicies {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::list_group_policies::ListGroupPoliciesInput,
    ) -> ::std::result::Result<
        super::super::operation::list_group_policies::ListGroupPoliciesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::list_group_policies::ListGroupPoliciesError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::list_group_policies::ListGroupPoliciesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::list_group_policies::ListGroupPoliciesOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "ListGroupPolicies", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListGroupPoliciesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_list_group_policies::de_list_group_policies_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_list_group_policies::de_list_group_policies_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListGroupPoliciesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::list_group_policies::ListGroupPoliciesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::list_group_policies::ListGroupPoliciesInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::list_group_policies::ListGroupPoliciesError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::list_group_policies::_list_group_policies_input::ListGroupPoliciesInput;

pub use super::super::operation::list_group_policies::_list_group_policies_output::ListGroupPoliciesOutput;
