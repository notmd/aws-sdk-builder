...
impl DeletePolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::delete_policy::DeletePolicyInput,
    ) -> ::std::result::Result<
        super::super::operation::delete_policy::DeletePolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::delete_policy::DeletePolicyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::delete_policy::DeletePolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::delete_policy::DeletePolicyOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "DeletePolicy", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeletePolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_delete_policy::de_delete_policy_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_delete_policy::de_delete_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeletePolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::delete_policy::DeletePolicyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::delete_policy::DeletePolicyInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::delete_policy::DeletePolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::delete_policy::_delete_policy_input::DeletePolicyInput;

pub use super::super::operation::delete_policy::_delete_policy_output::DeletePolicyOutput;
