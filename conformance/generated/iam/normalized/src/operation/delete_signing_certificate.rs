...
impl DeleteSigningCertificate {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::delete_signing_certificate::DeleteSigningCertificateInput,
    ) -> ::std::result::Result<
        super::super::operation::delete_signing_certificate::DeleteSigningCertificateOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::delete_signing_certificate::DeleteSigningCertificateError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::delete_signing_certificate::DeleteSigningCertificateError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::delete_signing_certificate::DeleteSigningCertificateOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "DeleteSigningCertificate", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteSigningCertificate {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteSigningCertificate")
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteSigningCertificateTelemetryInputCaptureInterceptor {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteSigningCertificateResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_delete_signing_certificate::de_delete_signing_certificate_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_delete_signing_certificate::de_delete_signing_certificate_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteSigningCertificateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::delete_signing_certificate::DeleteSigningCertificateInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::delete_signing_certificate::DeleteSigningCertificateInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::delete_signing_certificate::DeleteSigningCertificateError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::delete_signing_certificate::_delete_signing_certificate_input::DeleteSigningCertificateInput;

pub use super::super::operation::delete_signing_certificate::_delete_signing_certificate_output::DeleteSigningCertificateOutput;
