...
impl ListRolePoliciesOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_role_policies::builders::ListRolePoliciesOutputBuilder {
        super::super::super::operation::list_role_policies::builders::ListRolePoliciesOutputBuilder::default()
    }
}
