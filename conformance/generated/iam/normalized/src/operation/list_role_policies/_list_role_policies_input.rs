...
impl ListRolePoliciesInput {
    ...
    pub fn builder() -> super::super::super::operation::list_role_policies::builders::ListRolePoliciesInputBuilder {
        super::super::super::operation::list_role_policies::builders::ListRolePoliciesInputBuilder::default()
    }
}
