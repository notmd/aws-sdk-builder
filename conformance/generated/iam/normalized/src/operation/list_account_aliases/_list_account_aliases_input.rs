...
impl ListAccountAliasesInput {
    ...
    pub fn builder() -> super::super::super::operation::list_account_aliases::builders::ListAccountAliasesInputBuilder {
        super::super::super::operation::list_account_aliases::builders::ListAccountAliasesInputBuilder::default()
    }
}
