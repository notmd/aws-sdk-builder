...
impl ListAccountAliasesOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_account_aliases::builders::ListAccountAliasesOutputBuilder {
        super::super::super::operation::list_account_aliases::builders::ListAccountAliasesOutputBuilder::default()
    }
}
