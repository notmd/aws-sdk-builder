...
pub struct ListAccountAliasesPaginator {
    ...
    builder: super::super::super::operation::list_account_aliases::builders::ListAccountAliasesInputBuilder,
...
impl ListAccountAliasesPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::list_account_aliases::paginator::ListAccountAliasesPaginatorItems {
        super::super::super::operation::list_account_aliases::paginator::ListAccountAliasesPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::super::super::operation::list_account_aliases::ListAccountAliases::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_account_aliases_output_output_marker(resp);
...
impl ListAccountAliasesPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_list_account_aliases_output_output_account_aliases(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
