...
impl PutAccountPropertiesInput {
    ...
    pub fn builder() -> super::super::super::operation::put_account_properties::builders::PutAccountPropertiesInputBuilder {
        super::super::super::operation::put_account_properties::builders::PutAccountPropertiesInputBuilder::default()
    }
}
