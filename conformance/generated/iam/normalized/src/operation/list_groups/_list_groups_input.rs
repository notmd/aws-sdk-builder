...
impl ListGroupsInput {
    ...
    pub fn builder() -> super::super::super::operation::list_groups::builders::ListGroupsInputBuilder {
        super::super::super::operation::list_groups::builders::ListGroupsInputBuilder::default()
    }
}
