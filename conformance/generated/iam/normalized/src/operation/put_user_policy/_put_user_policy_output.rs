...
impl PutUserPolicyOutput {
    ...
    pub fn builder() -> super::super::super::operation::put_user_policy::builders::PutUserPolicyOutputBuilder {
        super::super::super::operation::put_user_policy::builders::PutUserPolicyOutputBuilder::default()
    }
}
...
impl PutUserPolicyOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::put_user_policy::PutUserPolicyOutput {
