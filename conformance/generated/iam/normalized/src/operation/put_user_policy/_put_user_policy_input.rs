...
impl PutUserPolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::put_user_policy::builders::PutUserPolicyInputBuilder {
        super::super::super::operation::put_user_policy::builders::PutUserPolicyInputBuilder::default()
    }
}
...
impl PutUserPolicyInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::put_user_policy::PutUserPolicyInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::put_user_policy::PutUserPolicyInput {
