...
impl ListOpenIdConnectProvidersOutput {
    ...
    pub fn open_id_connect_provider_list(&self) -> &[super::super::super::types::OpenIdConnectProviderListEntry] {
...
impl ListOpenIdConnectProvidersOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_open_id_connect_providers::builders::ListOpenIdConnectProvidersOutputBuilder {
        super::super::super::operation::list_open_id_connect_providers::builders::ListOpenIdConnectProvidersOutputBuilder::default()
    }
}
...
pub struct ListOpenIdConnectProvidersOutputBuilder {
    pub(crate) open_id_connect_provider_list: ::std::option::Option<::std::vec::Vec<super::super::super::types::OpenIdConnectProviderListEntry>>,
    _request_id: Option<String>,
}
impl ListOpenIdConnectProvidersOutputBuilder {
    ...
    ///
    /// <p>The list of IAM OIDC provider resource objects defined in the Amazon Web Services account.</p>
    pub fn open_id_connect_provider_list(mut self, input: super::super::super::types::OpenIdConnectProviderListEntry) -> Self {
    ...
    pub fn set_open_id_connect_provider_list(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::OpenIdConnectProviderListEntry>>,
    ) -> Self {
    ...
    pub fn build(self) -> super::super::super::operation::list_open_id_connect_providers::ListOpenIdConnectProvidersOutput {
