...
impl ListOpenIdConnectProvidersInput {
    ...
    pub fn builder() -> super::super::super::operation::list_open_id_connect_providers::builders::ListOpenIdConnectProvidersInputBuilder {
        super::super::super::operation::list_open_id_connect_providers::builders::ListOpenIdConnectProvidersInputBuilder::default()
    }
}
...
impl ListOpenIdConnectProvidersInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::list_open_id_connect_providers::ListOpenIdConnectProvidersInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::list_open_id_connect_providers::ListOpenIdConnectProvidersInput {})
    }
}
