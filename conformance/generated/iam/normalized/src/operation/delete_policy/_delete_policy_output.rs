...
impl DeletePolicyOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_policy::builders::DeletePolicyOutputBuilder {
        super::super::super::operation::delete_policy::builders::DeletePolicyOutputBuilder::default()
    }
}
...
impl DeletePolicyOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_policy::DeletePolicyOutput {
