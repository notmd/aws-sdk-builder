...
pub use super::super::super::operation::delete_policy::_delete_policy_input::DeletePolicyInputBuilder;

pub use super::super::super::operation::delete_policy::_delete_policy_output::DeletePolicyOutputBuilder;

impl super::super::super::operation::delete_policy::builders::DeletePolicyInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_policy::DeletePolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_policy::DeletePolicyError,
...
pub struct DeletePolicyFluentBuilder {
    ...
    inner: super::super::super::operation::delete_policy::builders::DeletePolicyInputBuilder,
...
impl DeletePolicyFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_policy::builders::DeletePolicyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_policy::DeletePolicy::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_policy::DeletePolicy::orchestrate(&runtime_plugins, input).await
    }
