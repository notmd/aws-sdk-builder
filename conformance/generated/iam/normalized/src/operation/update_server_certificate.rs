...
impl UpdateServerCertificate {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::update_server_certificate::UpdateServerCertificateInput,
    ) -> ::std::result::Result<
        super::super::operation::update_server_certificate::UpdateServerCertificateOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::update_server_certificate::UpdateServerCertificateError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::update_server_certificate::UpdateServerCertificateError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::update_server_certificate::UpdateServerCertificateOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateServerCertificateResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_update_server_certificate::de_update_server_certificate_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_update_server_certificate::de_update_server_certificate_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateServerCertificateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::update_server_certificate::UpdateServerCertificateInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::update_server_certificate::UpdateServerCertificateInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::update_server_certificate::UpdateServerCertificateError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::update_server_certificate::_update_server_certificate_input::UpdateServerCertificateInput;

pub use super::super::operation::update_server_certificate::_update_server_certificate_output::UpdateServerCertificateOutput;
