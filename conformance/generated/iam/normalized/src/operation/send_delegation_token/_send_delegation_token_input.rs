...
impl SendDelegationTokenInput {
    ...
    pub fn builder() -> super::super::super::operation::send_delegation_token::builders::SendDelegationTokenInputBuilder {
        super::super::super::operation::send_delegation_token::builders::SendDelegationTokenInputBuilder::default()
    }
}
