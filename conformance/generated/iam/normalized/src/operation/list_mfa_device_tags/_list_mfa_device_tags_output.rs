...
impl ListMfaDeviceTagsOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_mfa_device_tags::builders::ListMfaDeviceTagsOutputBuilder {
        super::super::super::operation::list_mfa_device_tags::builders::ListMfaDeviceTagsOutputBuilder::default()
    }
}
