...
impl ListMfaDeviceTagsInput {
    ...
    pub fn builder() -> super::super::super::operation::list_mfa_device_tags::builders::ListMfaDeviceTagsInputBuilder {
        super::super::super::operation::list_mfa_device_tags::builders::ListMfaDeviceTagsInputBuilder::default()
    }
}
