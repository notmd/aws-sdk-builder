...
impl DeleteUserPolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_user_policy::builders::DeleteUserPolicyInputBuilder {
        super::super::super::operation::delete_user_policy::builders::DeleteUserPolicyInputBuilder::default()
    }
}
