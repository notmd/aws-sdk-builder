...
impl UpdateDelegationRequestInput {
    ...
    pub fn builder() -> super::super::super::operation::update_delegation_request::builders::UpdateDelegationRequestInputBuilder {
        super::super::super::operation::update_delegation_request::builders::UpdateDelegationRequestInputBuilder::default()
    }
}
...
impl UpdateDelegationRequestInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::update_delegation_request::UpdateDelegationRequestInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::update_delegation_request::UpdateDelegationRequestInput {
