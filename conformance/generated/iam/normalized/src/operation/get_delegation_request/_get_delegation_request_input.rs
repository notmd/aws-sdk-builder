...
impl GetDelegationRequestInput {
    ...
    pub fn builder() -> super::super::super::operation::get_delegation_request::builders::GetDelegationRequestInputBuilder {
        super::super::super::operation::get_delegation_request::builders::GetDelegationRequestInputBuilder::default()
    }
}
