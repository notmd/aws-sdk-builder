...
impl UntagMfaDeviceInput {
    ...
    pub fn builder() -> super::super::super::operation::untag_mfa_device::builders::UntagMfaDeviceInputBuilder {
        super::super::super::operation::untag_mfa_device::builders::UntagMfaDeviceInputBuilder::default()
    }
}
