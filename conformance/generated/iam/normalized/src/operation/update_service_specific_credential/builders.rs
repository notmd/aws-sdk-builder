...
pub use super::super::super::operation::update_service_specific_credential::_update_service_specific_credential_input::UpdateServiceSpecificCredentialInputBuilder;

pub use super::super::super::operation::update_service_specific_credential::_update_service_specific_credential_output::UpdateServiceSpecificCredentialOutputBuilder;

impl super::super::super::operation::update_service_specific_credential::builders::UpdateServiceSpecificCredentialInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::update_service_specific_credential::UpdateServiceSpecificCredentialOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::update_service_specific_credential::UpdateServiceSpecificCredentialError,
...
pub struct UpdateServiceSpecificCredentialFluentBuilder {
    ...
    inner: super::super::super::operation::update_service_specific_credential::builders::UpdateServiceSpecificCredentialInputBuilder,
