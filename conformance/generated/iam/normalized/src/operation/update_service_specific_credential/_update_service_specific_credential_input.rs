...
impl UpdateServiceSpecificCredentialInput {
    ...
    /// <p>The status to be assigned to the service-specific credential.</p>
    pub fn status(&self) -> ::std::option::Option<&super::super::super::types::StatusType> {
        self.status.as_ref()
    }
}
impl UpdateServiceSpecificCredentialInput {
    ...
    pub fn builder() -> super::super::super::operation::update_service_specific_credential::builders::UpdateServiceSpecificCredentialInputBuilder {
        super::super::super::operation::update_service_specific_credential::builders::UpdateServiceSpecificCredentialInputBuilder::default()
    }
}
...
pub struct UpdateServiceSpecificCredentialInputBuilder {
    ...
    pub(crate) status: ::std::option::Option<super::super::super::types::StatusType>,
}
impl UpdateServiceSpecificCredentialInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::update_service_specific_credential::UpdateServiceSpecificCredentialInput,
