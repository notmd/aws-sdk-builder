...
impl UpdateServiceSpecificCredentialOutput {
    ...
    pub fn builder() -> super::super::super::operation::update_service_specific_credential::builders::UpdateServiceSpecificCredentialOutputBuilder {
        super::super::super::operation::update_service_specific_credential::builders::UpdateServiceSpecificCredentialOutputBuilder::default()
    }
}
...
impl UpdateServiceSpecificCredentialOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::update_service_specific_credential::UpdateServiceSpecificCredentialOutput {
