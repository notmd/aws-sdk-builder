...
impl ListOrganizationsFeaturesInput {
    ...
    pub fn builder() -> super::super::super::operation::list_organizations_features::builders::ListOrganizationsFeaturesInputBuilder {
        super::super::super::operation::list_organizations_features::builders::ListOrganizationsFeaturesInputBuilder::default()
    }
}
...
impl ListOrganizationsFeaturesInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::list_organizations_features::ListOrganizationsFeaturesInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::list_organizations_features::ListOrganizationsFeaturesInput {})
    }
}
