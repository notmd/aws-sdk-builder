...
impl DeleteSshPublicKeyInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_ssh_public_key::builders::DeleteSshPublicKeyInputBuilder {
        super::super::super::operation::delete_ssh_public_key::builders::DeleteSshPublicKeyInputBuilder::default()
    }
}
