...
impl CreateVirtualMFADevice {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::create_virtual_mfa_device::CreateVirtualMfaDeviceInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::create_virtual_mfa_device::CreateVirtualMFADeviceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::create_virtual_mfa_device::CreateVirtualMfaDeviceOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "CreateVirtualMFADevice", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateVirtualMFADeviceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_create_virtual_mfa_device::de_create_virtual_mfa_device_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_create_virtual_mfa_device::de_create_virtual_mfa_device_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateVirtualMFADeviceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::create_virtual_mfa_device::CreateVirtualMfaDeviceInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::create_virtual_mfa_device::CreateVirtualMfaDeviceInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::create_virtual_mfa_device::CreateVirtualMFADeviceError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::create_virtual_mfa_device::_create_virtual_mfa_device_input::CreateVirtualMfaDeviceInput;

pub use super::super::operation::create_virtual_mfa_device::_create_virtual_mfa_device_output::CreateVirtualMfaDeviceOutput;
