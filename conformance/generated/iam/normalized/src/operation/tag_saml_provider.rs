...
impl TagSamlProvider {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::tag_saml_provider::TagSamlProviderInput,
    ) -> ::std::result::Result<
        super::super::operation::tag_saml_provider::TagSamlProviderOutput,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::tag_saml_provider::TagSAMLProviderError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::tag_saml_provider::TagSamlProviderOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "TagSAMLProvider", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for TagSAMLProviderResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_tag_saml_provider::de_tag_saml_provider_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_tag_saml_provider::de_tag_saml_provider_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for TagSAMLProviderRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::tag_saml_provider::TagSamlProviderInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::tag_saml_provider::TagSamlProviderInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::tag_saml_provider::TagSAMLProviderError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::tag_saml_provider::_tag_saml_provider_input::TagSamlProviderInput;

pub use super::super::operation::tag_saml_provider::_tag_saml_provider_output::TagSamlProviderOutput;
