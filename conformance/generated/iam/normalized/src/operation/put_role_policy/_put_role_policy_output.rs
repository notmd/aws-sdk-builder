...
impl PutRolePolicyOutput {
    ...
    pub fn builder() -> super::super::super::operation::put_role_policy::builders::PutRolePolicyOutputBuilder {
        super::super::super::operation::put_role_policy::builders::PutRolePolicyOutputBuilder::default()
    }
}
...
impl PutRolePolicyOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::put_role_policy::PutRolePolicyOutput {
