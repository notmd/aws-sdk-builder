...
impl DeleteRoleInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_role::builders::DeleteRoleInputBuilder {
        super::super::super::operation::delete_role::builders::DeleteRoleInputBuilder::default()
    }
}
