...
pub use super::super::super::operation::list_policies::_list_policies_input::ListPoliciesInputBuilder;

pub use super::super::super::operation::list_policies::_list_policies_output::ListPoliciesOutputBuilder;

impl super::super::super::operation::list_policies::builders::ListPoliciesInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::list_policies::ListPoliciesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::list_policies::ListPoliciesError,
...
pub struct ListPoliciesFluentBuilder {
    ...
    inner: super::super::super::operation::list_policies::builders::ListPoliciesInputBuilder,
...
impl ListPoliciesFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::list_policies::builders::ListPoliciesInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::list_policies::ListPolicies::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::list_policies::ListPolicies::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::super::super::operation::list_policies::paginator::ListPoliciesPaginator {
        super::super::super::operation::list_policies::paginator::ListPoliciesPaginator::new(self.handle, self.inner)
    }
    ...
    pub fn scope(mut self, input: super::super::super::types::PolicyScopeType) -> Self {
    ...
    /// <p>To list only Amazon Web Services managed policies, set <code>Scope</code> to <code>AWS</code>. To list only the customer managed policies in your Amazon Web Services account, set <code>Scope</code> to <code>Local</code>.</p>
    /// <p>This parameter is optional. If it is not included, or if it is set to <code>All</code>, all policies are returned.</p>
    pub fn set_scope(mut self, input: ::std::option::Option<super::super::super::types::PolicyScopeType>) -> Self {
    ...
    /// <p>To list only Amazon Web Services managed policies, set <code>Scope</code> to <code>AWS</code>. To list only the customer managed policies in your Amazon Web Services account, set <code>Scope</code> to <code>Local</code>.</p>
    /// <p>This parameter is optional. If it is not included, or if it is set to <code>All</code>, all policies are returned.</p>
    pub fn get_scope(&self) -> &::std::option::Option<super::super::super::types::PolicyScopeType> {
