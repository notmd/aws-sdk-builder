...
pub struct ListPoliciesPaginator {
    ...
    builder: super::super::super::operation::list_policies::builders::ListPoliciesInputBuilder,
...
impl ListPoliciesPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::list_policies::paginator::ListPoliciesPaginatorItems {
        super::super::super::operation::list_policies::paginator::ListPoliciesPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::super::super::operation::list_policies::ListPolicies::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_policies_output_output_marker(resp);
...
impl ListPoliciesPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::Policy,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::list_policies::ListPoliciesError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_list_policies_output_output_policies(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
