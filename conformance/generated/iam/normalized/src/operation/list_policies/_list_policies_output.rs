...
impl ListPoliciesOutput {
    ...
    pub fn policies(&self) -> &[super::super::super::types::Policy] {
...
impl ListPoliciesOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_policies::builders::ListPoliciesOutputBuilder {
        super::super::super::operation::list_policies::builders::ListPoliciesOutputBuilder::default()
    }
}
...
pub struct ListPoliciesOutputBuilder {
    pub(crate) policies: ::std::option::Option<::std::vec::Vec<super::super::super::types::Policy>>,
...
impl ListPoliciesOutputBuilder {
    ...
    ///
    /// <p>A list of policies.</p>
    pub fn policies(mut self, input: super::super::super::types::Policy) -> Self {
    ...
    /// <p>A list of policies.</p>
    pub fn set_policies(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::Policy>>) -> Self {
        self.policies = input;
        self
    }
    /// <p>A list of policies.</p>
    pub fn get_policies(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::Policy>> {
        &self.policies
    }
    /// <p>A flag that indicates whether there are more items to return. If your results were truncated, you can make a subsequent pagination request using the <code>Marker</code> request parameter to retrieve more items. Note that IAM might return fewer than the <code>MaxItems</code> number of results even when there are more results available. We recommend that you check <code>IsTruncated</code> after every call to ensure that you receive all your results.</p>
    ...
    pub fn build(self) -> super::super::super::operation::list_policies::ListPoliciesOutput {
