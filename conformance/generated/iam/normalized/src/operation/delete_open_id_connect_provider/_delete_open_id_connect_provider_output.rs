...
impl DeleteOpenIdConnectProviderOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_open_id_connect_provider::builders::DeleteOpenIdConnectProviderOutputBuilder {
        super::super::super::operation::delete_open_id_connect_provider::builders::DeleteOpenIdConnectProviderOutputBuilder::default()
    }
}
...
impl DeleteOpenIdConnectProviderOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_open_id_connect_provider::DeleteOpenIdConnectProviderOutput {
