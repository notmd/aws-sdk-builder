...
impl TagServerCertificate {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::tag_server_certificate::TagServerCertificateInput,
    ) -> ::std::result::Result<
        super::super::operation::tag_server_certificate::TagServerCertificateOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::tag_server_certificate::TagServerCertificateError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::tag_server_certificate::TagServerCertificateError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::tag_server_certificate::TagServerCertificateOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "TagServerCertificate", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for TagServerCertificateTelemetryInputCaptureInterceptor {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for TagServerCertificateResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_tag_server_certificate::de_tag_server_certificate_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_tag_server_certificate::de_tag_server_certificate_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for TagServerCertificateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::tag_server_certificate::TagServerCertificateInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::tag_server_certificate::TagServerCertificateInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::tag_server_certificate::TagServerCertificateError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::tag_server_certificate::_tag_server_certificate_input::TagServerCertificateInput;

pub use super::super::operation::tag_server_certificate::_tag_server_certificate_output::TagServerCertificateOutput;
