...
impl PutRolePolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::put_role_policy::PutRolePolicyInput,
    ) -> ::std::result::Result<
        super::super::operation::put_role_policy::PutRolePolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::put_role_policy::PutRolePolicyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::put_role_policy::PutRolePolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::put_role_policy::PutRolePolicyOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "PutRolePolicy", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutRolePolicy {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutRolePolicy")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutRolePolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_put_role_policy::de_put_role_policy_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_put_role_policy::de_put_role_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutRolePolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::put_role_policy::PutRolePolicyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::put_role_policy::PutRolePolicyInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::put_role_policy::PutRolePolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::put_role_policy::_put_role_policy_input::PutRolePolicyInput;

pub use super::super::operation::put_role_policy::_put_role_policy_output::PutRolePolicyOutput;
