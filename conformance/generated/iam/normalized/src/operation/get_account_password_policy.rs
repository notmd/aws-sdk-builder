...
impl GetAccountPasswordPolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::get_account_password_policy::GetAccountPasswordPolicyInput,
    ) -> ::std::result::Result<
        super::super::operation::get_account_password_policy::GetAccountPasswordPolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::get_account_password_policy::GetAccountPasswordPolicyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::get_account_password_policy::GetAccountPasswordPolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::get_account_password_policy::GetAccountPasswordPolicyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetAccountPasswordPolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_get_account_password_policy::de_get_account_password_policy_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_get_account_password_policy::de_get_account_password_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetAccountPasswordPolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::get_account_password_policy::GetAccountPasswordPolicyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::get_account_password_policy::GetAccountPasswordPolicyInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::get_account_password_policy::GetAccountPasswordPolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::get_account_password_policy::_get_account_password_policy_input::GetAccountPasswordPolicyInput;

pub use super::super::operation::get_account_password_policy::_get_account_password_policy_output::GetAccountPasswordPolicyOutput;
