...
impl UpdateSigningCertificateInput {
    ...
    pub fn builder() -> super::super::super::operation::update_signing_certificate::builders::UpdateSigningCertificateInputBuilder {
        super::super::super::operation::update_signing_certificate::builders::UpdateSigningCertificateInputBuilder::default()
    }
}
