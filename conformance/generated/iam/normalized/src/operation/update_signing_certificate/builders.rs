...
pub use super::super::super::operation::update_signing_certificate::_update_signing_certificate_input::UpdateSigningCertificateInputBuilder;

pub use super::super::super::operation::update_signing_certificate::_update_signing_certificate_output::UpdateSigningCertificateOutputBuilder;

impl super::super::super::operation::update_signing_certificate::builders::UpdateSigningCertificateInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::update_signing_certificate::UpdateSigningCertificateOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::update_signing_certificate::UpdateSigningCertificateError,
...
pub struct UpdateSigningCertificateFluentBuilder {
    ...
    inner: super::super::super::operation::update_signing_certificate::builders::UpdateSigningCertificateInputBuilder,
...
impl UpdateSigningCertificateFluentBuilder {
    /// Creates a new `UpdateSigningCertificateFluentBuilder`.
    ...
    pub fn as_input(&self) -> &super::super::super::operation::update_signing_certificate::builders::UpdateSigningCertificateInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::update_signing_certificate::UpdateSigningCertificate::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::update_signing_certificate::UpdateSigningCertificate::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn status(mut self, input: super::super::super::types::StatusType) -> Self {
        self.inner = self.inner.status(input);
        self
    }
    /// <p>The status you want to assign to the certificate. <code>Active</code> means that the certificate can be used for programmatic calls to Amazon Web Services <code>Inactive</code> means that the certificate cannot be used.</p>
    pub fn set_status(mut self, input: ::std::option::Option<super::super::super::types::StatusType>) -> Self {
        self.inner = self.inner.set_status(input);
        self
    }
    /// <p>The status you want to assign to the certificate. <code>Active</code> means that the certificate can be used for programmatic calls to Amazon Web Services <code>Inactive</code> means that the certificate cannot be used.</p>
    pub fn get_status(&self) -> &::std::option::Option<super::super::super::types::StatusType> {
