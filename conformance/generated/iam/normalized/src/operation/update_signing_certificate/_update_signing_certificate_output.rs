...
impl UpdateSigningCertificateOutput {
    ...
    pub fn builder() -> super::super::super::operation::update_signing_certificate::builders::UpdateSigningCertificateOutputBuilder {
        super::super::super::operation::update_signing_certificate::builders::UpdateSigningCertificateOutputBuilder::default()
    }
}
...
impl UpdateSigningCertificateOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::update_signing_certificate::UpdateSigningCertificateOutput {
