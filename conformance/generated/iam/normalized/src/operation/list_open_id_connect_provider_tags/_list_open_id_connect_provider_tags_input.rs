...
impl ListOpenIdConnectProviderTagsInput {
    ...
    pub fn builder() -> super::super::super::operation::list_open_id_connect_provider_tags::builders::ListOpenIdConnectProviderTagsInputBuilder {
        super::super::super::operation::list_open_id_connect_provider_tags::builders::ListOpenIdConnectProviderTagsInputBuilder::default()
    }
}
