...
impl AddRoleToInstanceProfileOutput {
    ...
    pub fn builder() -> super::super::super::operation::add_role_to_instance_profile::builders::AddRoleToInstanceProfileOutputBuilder {
        super::super::super::operation::add_role_to_instance_profile::builders::AddRoleToInstanceProfileOutputBuilder::default()
    }
}
...
impl AddRoleToInstanceProfileOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::add_role_to_instance_profile::AddRoleToInstanceProfileOutput {
