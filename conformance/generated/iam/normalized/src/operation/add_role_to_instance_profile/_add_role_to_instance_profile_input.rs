...
impl AddRoleToInstanceProfileInput {
    ...
    pub fn builder() -> super::super::super::operation::add_role_to_instance_profile::builders::AddRoleToInstanceProfileInputBuilder {
        super::super::super::operation::add_role_to_instance_profile::builders::AddRoleToInstanceProfileInputBuilder::default()
    }
}
