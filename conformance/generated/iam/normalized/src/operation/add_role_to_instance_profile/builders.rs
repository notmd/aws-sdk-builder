...
pub use super::super::super::operation::add_role_to_instance_profile::_add_role_to_instance_profile_input::AddRoleToInstanceProfileInputBuilder;

pub use super::super::super::operation::add_role_to_instance_profile::_add_role_to_instance_profile_output::AddRoleToInstanceProfileOutputBuilder;

impl super::super::super::operation::add_role_to_instance_profile::builders::AddRoleToInstanceProfileInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::add_role_to_instance_profile::AddRoleToInstanceProfileOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::add_role_to_instance_profile::AddRoleToInstanceProfileError,
...
pub struct AddRoleToInstanceProfileFluentBuilder {
    ...
    inner: super::super::super::operation::add_role_to_instance_profile::builders::AddRoleToInstanceProfileInputBuilder,
...
impl AddRoleToInstanceProfileFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::add_role_to_instance_profile::builders::AddRoleToInstanceProfileInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::add_role_to_instance_profile::AddRoleToInstanceProfile::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::add_role_to_instance_profile::AddRoleToInstanceProfile::orchestrate(&runtime_plugins, input).await
    }
