...
impl DeleteGroupPolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_group_policy::builders::DeleteGroupPolicyInputBuilder {
        super::super::super::operation::delete_group_policy::builders::DeleteGroupPolicyInputBuilder::default()
    }
}
