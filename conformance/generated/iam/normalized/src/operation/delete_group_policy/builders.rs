...
pub use super::super::super::operation::delete_group_policy::_delete_group_policy_input::DeleteGroupPolicyInputBuilder;

pub use super::super::super::operation::delete_group_policy::_delete_group_policy_output::DeleteGroupPolicyOutputBuilder;

impl super::super::super::operation::delete_group_policy::builders::DeleteGroupPolicyInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_group_policy::DeleteGroupPolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_group_policy::DeleteGroupPolicyError,
...
pub struct DeleteGroupPolicyFluentBuilder {
    ...
    inner: super::super::super::operation::delete_group_policy::builders::DeleteGroupPolicyInputBuilder,
...
impl DeleteGroupPolicyFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_group_policy::builders::DeleteGroupPolicyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_group_policy::DeleteGroupPolicy::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_group_policy::DeleteGroupPolicy::orchestrate(&runtime_plugins, input).await
    }
