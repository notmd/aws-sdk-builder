...
impl DeleteGroupPolicyOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_group_policy::builders::DeleteGroupPolicyOutputBuilder {
        super::super::super::operation::delete_group_policy::builders::DeleteGroupPolicyOutputBuilder::default()
    }
}
...
impl DeleteGroupPolicyOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_group_policy::DeleteGroupPolicyOutput {
