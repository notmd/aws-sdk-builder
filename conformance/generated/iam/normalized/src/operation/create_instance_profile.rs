...
impl CreateInstanceProfile {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::create_instance_profile::CreateInstanceProfileInput,
    ) -> ::std::result::Result<
        super::super::operation::create_instance_profile::CreateInstanceProfileOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::create_instance_profile::CreateInstanceProfileError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::create_instance_profile::CreateInstanceProfileError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::create_instance_profile::CreateInstanceProfileOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "CreateInstanceProfile", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateInstanceProfileTelemetryInputCaptureInterceptor {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateInstanceProfileResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_create_instance_profile::de_create_instance_profile_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_create_instance_profile::de_create_instance_profile_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateInstanceProfileRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::create_instance_profile::CreateInstanceProfileInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::create_instance_profile::CreateInstanceProfileInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::create_instance_profile::CreateInstanceProfileError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::create_instance_profile::_create_instance_profile_input::CreateInstanceProfileInput;

pub use super::super::operation::create_instance_profile::_create_instance_profile_output::CreateInstanceProfileOutput;
