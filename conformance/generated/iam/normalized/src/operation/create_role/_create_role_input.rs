...
impl CreateRoleInput {
    ...
    pub fn builder() -> super::super::super::operation::create_role::builders::CreateRoleInputBuilder {
        super::super::super::operation::create_role::builders::CreateRoleInputBuilder::default()
    }
}
