...
impl DeleteLoginProfile {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::delete_login_profile::DeleteLoginProfileInput,
    ) -> ::std::result::Result<
        super::super::operation::delete_login_profile::DeleteLoginProfileOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::delete_login_profile::DeleteLoginProfileError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::delete_login_profile::DeleteLoginProfileError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::delete_login_profile::DeleteLoginProfileOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "DeleteLoginProfile", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteLoginProfileResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_delete_login_profile::de_delete_login_profile_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_delete_login_profile::de_delete_login_profile_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteLoginProfileRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::delete_login_profile::DeleteLoginProfileInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::delete_login_profile::DeleteLoginProfileInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::delete_login_profile::DeleteLoginProfileError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::delete_login_profile::_delete_login_profile_input::DeleteLoginProfileInput;

pub use super::super::operation::delete_login_profile::_delete_login_profile_output::DeleteLoginProfileOutput;
