...
pub use super::super::super::operation::create_access_key::_create_access_key_input::CreateAccessKeyInputBuilder;

pub use super::super::super::operation::create_access_key::_create_access_key_output::CreateAccessKeyOutputBuilder;

impl super::super::super::operation::create_access_key::builders::CreateAccessKeyInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::create_access_key::CreateAccessKeyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::create_access_key::CreateAccessKeyError,
...
pub struct CreateAccessKeyFluentBuilder {
    ...
    inner: super::super::super::operation::create_access_key::builders::CreateAccessKeyInputBuilder,
...
impl CreateAccessKeyFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::create_access_key::builders::CreateAccessKeyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::create_access_key::CreateAccessKey::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::create_access_key::CreateAccessKey::orchestrate(&runtime_plugins, input).await
    }
