...
impl CreateAccessKeyOutput {
    /// <p>A structure with details about the access key.</p>
    pub fn access_key(&self) -> ::std::option::Option<&super::super::super::types::AccessKey> {
...
impl CreateAccessKeyOutput {
    ...
    pub fn builder() -> super::super::super::operation::create_access_key::builders::CreateAccessKeyOutputBuilder {
        super::super::super::operation::create_access_key::builders::CreateAccessKeyOutputBuilder::default()
    }
}
...
pub struct CreateAccessKeyOutputBuilder {
    pub(crate) access_key: ::std::option::Option<super::super::super::types::AccessKey>,
    _request_id: Option<String>,
}
impl CreateAccessKeyOutputBuilder {
    /// <p>A structure with details about the access key.</p>
    /// This field is required.
    pub fn access_key(mut self, input: super::super::super::types::AccessKey) -> Self {
        self.access_key = ::std::option::Option::Some(input);
        self
    }
    /// <p>A structure with details about the access key.</p>
    pub fn set_access_key(mut self, input: ::std::option::Option<super::super::super::types::AccessKey>) -> Self {
        self.access_key = input;
        self
    }
    /// <p>A structure with details about the access key.</p>
    pub fn get_access_key(&self) -> &::std::option::Option<super::super::super::types::AccessKey> {
        &self.access_key
    }
    ...
    pub fn build(self) -> super::super::super::operation::create_access_key::CreateAccessKeyOutput {
