...
impl UploadServerCertificateOutput {
    /// <p>The meta information of the uploaded server certificate without its certificate body, certificate chain, and private key.</p>
    pub fn server_certificate_metadata(&self) -> ::std::option::Option<&super::super::super::types::ServerCertificateMetadata> {
...
impl UploadServerCertificateOutput {
    ...
    pub fn builder() -> super::super::super::operation::upload_server_certificate::builders::UploadServerCertificateOutputBuilder {
        super::super::super::operation::upload_server_certificate::builders::UploadServerCertificateOutputBuilder::default()
    }
}
...
pub struct UploadServerCertificateOutputBuilder {
    pub(crate) server_certificate_metadata: ::std::option::Option<super::super::super::types::ServerCertificateMetadata>,
    pub(crate) tags: ::std::option::Option<::std::vec::Vec<super::super::super::types::Tag>>,
    _request_id: Option<String>,
}
impl UploadServerCertificateOutputBuilder {
    /// <p>The meta information of the uploaded server certificate without its certificate body, certificate chain, and private key.</p>
    pub fn server_certificate_metadata(mut self, input: super::super::super::types::ServerCertificateMetadata) -> Self {
        self.server_certificate_metadata = ::std::option::Option::Some(input);
        self
    }
    /// <p>The meta information of the uploaded server certificate without its certificate body, certificate chain, and private key.</p>
    pub fn set_server_certificate_metadata(mut self, input: ::std::option::Option<super::super::super::types::ServerCertificateMetadata>) -> Self {
        self.server_certificate_metadata = input;
        self
    }
    /// <p>The meta information of the uploaded server certificate without its certificate body, certificate chain, and private key.</p>
    pub fn get_server_certificate_metadata(&self) -> &::std::option::Option<super::super::super::types::ServerCertificateMetadata> {
    ...
    pub fn build(self) -> super::super::super::operation::upload_server_certificate::UploadServerCertificateOutput {
