...
pub use super::super::super::operation::delete_server_certificate::_delete_server_certificate_input::DeleteServerCertificateInputBuilder;

pub use super::super::super::operation::delete_server_certificate::_delete_server_certificate_output::DeleteServerCertificateOutputBuilder;

impl super::super::super::operation::delete_server_certificate::builders::DeleteServerCertificateInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_server_certificate::DeleteServerCertificateOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_server_certificate::DeleteServerCertificateError,
...
pub struct DeleteServerCertificateFluentBuilder {
    ...
    inner: super::super::super::operation::delete_server_certificate::builders::DeleteServerCertificateInputBuilder,
...
impl DeleteServerCertificateFluentBuilder {
    /// Creates a new `DeleteServerCertificateFluentBuilder`.
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_server_certificate::builders::DeleteServerCertificateInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_server_certificate::DeleteServerCertificate::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_server_certificate::DeleteServerCertificate::orchestrate(&runtime_plugins, input).await
    }
