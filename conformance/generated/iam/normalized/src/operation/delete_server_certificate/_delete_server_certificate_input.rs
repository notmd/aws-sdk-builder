...
impl DeleteServerCertificateInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_server_certificate::builders::DeleteServerCertificateInputBuilder {
        super::super::super::operation::delete_server_certificate::builders::DeleteServerCertificateInputBuilder::default()
    }
}
...
impl DeleteServerCertificateInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::delete_server_certificate::DeleteServerCertificateInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::delete_server_certificate::DeleteServerCertificateInput {
