...
impl DeleteServerCertificateOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_server_certificate::builders::DeleteServerCertificateOutputBuilder {
        super::super::super::operation::delete_server_certificate::builders::DeleteServerCertificateOutputBuilder::default()
    }
}
...
impl DeleteServerCertificateOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_server_certificate::DeleteServerCertificateOutput {
