...
impl UntagInstanceProfile {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::untag_instance_profile::UntagInstanceProfileInput,
    ) -> ::std::result::Result<
        super::super::operation::untag_instance_profile::UntagInstanceProfileOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::untag_instance_profile::UntagInstanceProfileError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::untag_instance_profile::UntagInstanceProfileError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::untag_instance_profile::UntagInstanceProfileOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "UntagInstanceProfile", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UntagInstanceProfileTelemetryInputCaptureInterceptor {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UntagInstanceProfileResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_untag_instance_profile::de_untag_instance_profile_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_untag_instance_profile::de_untag_instance_profile_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UntagInstanceProfileRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::untag_instance_profile::UntagInstanceProfileInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::untag_instance_profile::UntagInstanceProfileInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::untag_instance_profile::UntagInstanceProfileError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::untag_instance_profile::_untag_instance_profile_input::UntagInstanceProfileInput;

pub use super::super::operation::untag_instance_profile::_untag_instance_profile_output::UntagInstanceProfileOutput;
