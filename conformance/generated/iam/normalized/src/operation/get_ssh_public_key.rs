...
impl GetSshPublicKey {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::get_ssh_public_key::GetSshPublicKeyInput,
    ) -> ::std::result::Result<
        super::super::operation::get_ssh_public_key::GetSshPublicKeyOutput,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::get_ssh_public_key::GetSSHPublicKeyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::get_ssh_public_key::GetSshPublicKeyOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "GetSSHPublicKey", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetSSHPublicKeyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_get_ssh_public_key::de_get_ssh_public_key_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_get_ssh_public_key::de_get_ssh_public_key_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetSSHPublicKeyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::get_ssh_public_key::GetSshPublicKeyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::get_ssh_public_key::GetSshPublicKeyInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::get_ssh_public_key::GetSSHPublicKeyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::get_ssh_public_key::_get_ssh_public_key_input::GetSshPublicKeyInput;

pub use super::super::operation::get_ssh_public_key::_get_ssh_public_key_output::GetSshPublicKeyOutput;
