...
pub struct ListAttachedUserPoliciesPaginator {
    ...
    builder: super::super::super::operation::list_attached_user_policies::builders::ListAttachedUserPoliciesInputBuilder,
...
impl ListAttachedUserPoliciesPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::list_attached_user_policies::paginator::ListAttachedUserPoliciesPaginatorItems {
        super::super::super::operation::list_attached_user_policies::paginator::ListAttachedUserPoliciesPaginatorItems(self)
    }
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_attached_user_policies_output_output_marker(resp);
...
impl ListAttachedUserPoliciesPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_list_attached_user_policies_output_output_attached_policies(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
