...
impl ListAttachedUserPoliciesInput {
    ...
    pub fn builder() -> super::super::super::operation::list_attached_user_policies::builders::ListAttachedUserPoliciesInputBuilder {
        super::super::super::operation::list_attached_user_policies::builders::ListAttachedUserPoliciesInputBuilder::default()
    }
}
