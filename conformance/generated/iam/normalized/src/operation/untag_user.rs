...
impl UntagUser {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::untag_user::UntagUserInput,
    ) -> ::std::result::Result<
        super::super::operation::untag_user::UntagUserOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::untag_user::UntagUserError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::untag_user::UntagUserError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::untag_user::UntagUserOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "UntagUser", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UntagUserResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_untag_user::de_untag_user_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_untag_user::de_untag_user_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UntagUserRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::untag_user::UntagUserInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::untag_user::UntagUserError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::untag_user::_untag_user_input::UntagUserInput;

pub use super::super::operation::untag_user::_untag_user_output::UntagUserOutput;
