...
impl CreateSamlProviderOutput {
    ...
    pub fn builder() -> super::super::super::operation::create_saml_provider::builders::CreateSamlProviderOutputBuilder {
        super::super::super::operation::create_saml_provider::builders::CreateSamlProviderOutputBuilder::default()
    }
}
...
impl CreateSamlProviderOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::create_saml_provider::CreateSamlProviderOutput {
