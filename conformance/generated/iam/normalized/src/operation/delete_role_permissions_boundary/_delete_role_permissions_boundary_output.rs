...
impl DeleteRolePermissionsBoundaryOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_role_permissions_boundary::builders::DeleteRolePermissionsBoundaryOutputBuilder {
        super::super::super::operation::delete_role_permissions_boundary::builders::DeleteRolePermissionsBoundaryOutputBuilder::default()
    }
}
...
impl DeleteRolePermissionsBoundaryOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_role_permissions_boundary::DeleteRolePermissionsBoundaryOutput {
