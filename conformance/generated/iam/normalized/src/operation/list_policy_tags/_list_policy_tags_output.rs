...
impl ListPolicyTagsOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_policy_tags::builders::ListPolicyTagsOutputBuilder {
        super::super::super::operation::list_policy_tags::builders::ListPolicyTagsOutputBuilder::default()
    }
}
