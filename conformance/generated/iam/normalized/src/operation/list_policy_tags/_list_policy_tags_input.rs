...
impl ListPolicyTagsInput {
    ...
    pub fn builder() -> super::super::super::operation::list_policy_tags::builders::ListPolicyTagsInputBuilder {
        super::super::super::operation::list_policy_tags::builders::ListPolicyTagsInputBuilder::default()
    }
}
...
impl ListPolicyTagsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::list_policy_tags::ListPolicyTagsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::super::operation::list_policy_tags::ListPolicyTagsInput {
