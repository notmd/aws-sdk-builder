                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_saml_provider_tags_output_output_marker(resp);
...
impl ListSamlProviderTagsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_list_saml_provider_tags_output_output_tags(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
