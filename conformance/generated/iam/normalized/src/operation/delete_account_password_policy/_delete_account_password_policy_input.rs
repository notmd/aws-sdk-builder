...
impl DeleteAccountPasswordPolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_account_password_policy::builders::DeleteAccountPasswordPolicyInputBuilder {
        super::super::super::operation::delete_account_password_policy::builders::DeleteAccountPasswordPolicyInputBuilder::default()
    }
}
...
impl DeleteAccountPasswordPolicyInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::delete_account_password_policy::DeleteAccountPasswordPolicyInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::delete_account_password_policy::DeleteAccountPasswordPolicyInput {})
    }
}
