...
impl AddUserToGroup {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::add_user_to_group::AddUserToGroupInput,
    ) -> ::std::result::Result<
        super::super::operation::add_user_to_group::AddUserToGroupOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::add_user_to_group::AddUserToGroupError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::add_user_to_group::AddUserToGroupError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::add_user_to_group::AddUserToGroupOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "AddUserToGroup", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AddUserToGroup {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AddUserToGroup")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AddUserToGroupResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_add_user_to_group::de_add_user_to_group_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_add_user_to_group::de_add_user_to_group_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AddUserToGroupRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::add_user_to_group::AddUserToGroupInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::add_user_to_group::AddUserToGroupInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::add_user_to_group::AddUserToGroupError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::add_user_to_group::_add_user_to_group_input::AddUserToGroupInput;

pub use super::super::operation::add_user_to_group::_add_user_to_group_output::AddUserToGroupOutput;
