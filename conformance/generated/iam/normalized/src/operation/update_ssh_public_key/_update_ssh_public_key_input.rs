...
impl UpdateSshPublicKeyInput {
    ...
    pub fn builder() -> super::super::super::operation::update_ssh_public_key::builders::UpdateSshPublicKeyInputBuilder {
        super::super::super::operation::update_ssh_public_key::builders::UpdateSshPublicKeyInputBuilder::default()
    }
}
