...
impl UpdateSshPublicKeyOutput {
    ...
    pub fn builder() -> super::super::super::operation::update_ssh_public_key::builders::UpdateSshPublicKeyOutputBuilder {
        super::super::super::operation::update_ssh_public_key::builders::UpdateSshPublicKeyOutputBuilder::default()
    }
}
...
impl UpdateSshPublicKeyOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::update_ssh_public_key::UpdateSshPublicKeyOutput {
