...
impl UpdateSamlProvider {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::update_saml_provider::UpdateSamlProviderInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::update_saml_provider::UpdateSAMLProviderError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::update_saml_provider::UpdateSamlProviderOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "UpdateSAMLProvider", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateSAMLProviderResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_update_saml_provider::de_update_saml_provider_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_update_saml_provider::de_update_saml_provider_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateSAMLProviderRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::update_saml_provider::UpdateSamlProviderInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::update_saml_provider::UpdateSamlProviderInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::update_saml_provider::UpdateSAMLProviderError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::update_saml_provider::_update_saml_provider_input::UpdateSamlProviderInput;

pub use super::super::operation::update_saml_provider::_update_saml_provider_output::UpdateSamlProviderOutput;
