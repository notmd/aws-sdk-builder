...
impl GetSamlProviderOutput {
    ...
    /// <p>Specifies the encryption setting for the SAML provider.</p>
    pub fn assertion_encryption_mode(&self) -> ::std::option::Option<&super::super::super::types::AssertionEncryptionModeType> {
    ...
    pub fn private_key_list(&self) -> &[super::super::super::types::SamlPrivateKey] {
...
impl GetSamlProviderOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_saml_provider::builders::GetSamlProviderOutputBuilder {
        super::super::super::operation::get_saml_provider::builders::GetSamlProviderOutputBuilder::default()
    }
}
...
pub struct GetSamlProviderOutputBuilder {
    ...
    pub(crate) assertion_encryption_mode: ::std::option::Option<super::super::super::types::AssertionEncryptionModeType>,
    pub(crate) private_key_list: ::std::option::Option<::std::vec::Vec<super::super::super::types::SamlPrivateKey>>,
    _request_id: Option<String>,
}
impl GetSamlProviderOutputBuilder {
    ...
    /// <p>Specifies the encryption setting for the SAML provider.</p>
    pub fn assertion_encryption_mode(mut self, input: super::super::super::types::AssertionEncryptionModeType) -> Self {
        self.assertion_encryption_mode = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies the encryption setting for the SAML provider.</p>
    pub fn set_assertion_encryption_mode(mut self, input: ::std::option::Option<super::super::super::types::AssertionEncryptionModeType>) -> Self {
        self.assertion_encryption_mode = input;
        self
    }
    /// <p>Specifies the encryption setting for the SAML provider.</p>
    pub fn get_assertion_encryption_mode(&self) -> &::std::option::Option<super::super::super::types::AssertionEncryptionModeType> {
    ...
    ///
    /// <p>The private key metadata for the SAML provider.</p>
    pub fn private_key_list(mut self, input: super::super::super::types::SamlPrivateKey) -> Self {
    ...
    /// <p>The private key metadata for the SAML provider.</p>
    pub fn set_private_key_list(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::SamlPrivateKey>>) -> Self {
        self.private_key_list = input;
        self
    }
    /// <p>The private key metadata for the SAML provider.</p>
    pub fn get_private_key_list(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::SamlPrivateKey>> {
    ...
    pub fn build(self) -> super::super::super::operation::get_saml_provider::GetSamlProviderOutput {
