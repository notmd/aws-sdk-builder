...
impl GetSamlProviderInput {
    ...
    pub fn builder() -> super::super::super::operation::get_saml_provider::builders::GetSamlProviderInputBuilder {
        super::super::super::operation::get_saml_provider::builders::GetSamlProviderInputBuilder::default()
    }
}
