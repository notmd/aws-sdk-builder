...
pub use super::super::super::operation::attach_role_policy::_attach_role_policy_input::AttachRolePolicyInputBuilder;

pub use super::super::super::operation::attach_role_policy::_attach_role_policy_output::AttachRolePolicyOutputBuilder;

impl super::super::super::operation::attach_role_policy::builders::AttachRolePolicyInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::attach_role_policy::AttachRolePolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::attach_role_policy::AttachRolePolicyError,
...
pub struct AttachRolePolicyFluentBuilder {
    ...
    inner: super::super::super::operation::attach_role_policy::builders::AttachRolePolicyInputBuilder,
...
impl AttachRolePolicyFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::attach_role_policy::builders::AttachRolePolicyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::attach_role_policy::AttachRolePolicy::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::attach_role_policy::AttachRolePolicy::orchestrate(&runtime_plugins, input).await
    }
