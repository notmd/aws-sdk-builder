...
impl AttachRolePolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::attach_role_policy::builders::AttachRolePolicyInputBuilder {
        super::super::super::operation::attach_role_policy::builders::AttachRolePolicyInputBuilder::default()
    }
}
