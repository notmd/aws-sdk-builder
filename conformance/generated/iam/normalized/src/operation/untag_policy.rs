...
impl UntagPolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::untag_policy::UntagPolicyInput,
    ) -> ::std::result::Result<
        super::super::operation::untag_policy::UntagPolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::untag_policy::UntagPolicyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::untag_policy::UntagPolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::untag_policy::UntagPolicyOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "UntagPolicy", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UntagPolicy {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UntagPolicyResponseDeserializer,
        ));
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UntagPolicy")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UntagPolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_untag_policy::de_untag_policy_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_untag_policy::de_untag_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UntagPolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::untag_policy::UntagPolicyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::untag_policy::UntagPolicyInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::untag_policy::UntagPolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::untag_policy::_untag_policy_input::UntagPolicyInput;

pub use super::super::operation::untag_policy::_untag_policy_output::UntagPolicyOutput;
