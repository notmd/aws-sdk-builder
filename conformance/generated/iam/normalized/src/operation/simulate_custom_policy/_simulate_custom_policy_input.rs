...
impl SimulateCustomPolicyInput {
    ...
    pub fn ordered_organization_policy_input_list(&self) -> &[super::super::super::types::OrderedOrganizationPolicyType] {
...
impl SimulateCustomPolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::simulate_custom_policy::builders::SimulateCustomPolicyInputBuilder {
        super::super::super::operation::simulate_custom_policy::builders::SimulateCustomPolicyInputBuilder::default()
    }
}
