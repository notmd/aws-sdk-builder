...
pub struct SimulateCustomPolicyPaginator {
    ...
    builder: super::super::super::operation::simulate_custom_policy::builders::SimulateCustomPolicyInputBuilder,
...
impl SimulateCustomPolicyPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::simulate_custom_policy::paginator::SimulateCustomPolicyPaginatorItems {
        super::super::super::operation::simulate_custom_policy::paginator::SimulateCustomPolicyPaginatorItems(self)
    }
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_simulate_custom_policy_output_output_marker(resp);
...
impl SimulateCustomPolicyPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_simulate_custom_policy_output_output_evaluation_results(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
