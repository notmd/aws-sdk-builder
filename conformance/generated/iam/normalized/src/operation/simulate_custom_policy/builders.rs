...
pub use super::super::super::operation::simulate_custom_policy::_simulate_custom_policy_input::SimulateCustomPolicyInputBuilder;

pub use super::super::super::operation::simulate_custom_policy::_simulate_custom_policy_output::SimulateCustomPolicyOutputBuilder;

impl super::super::super::operation::simulate_custom_policy::builders::SimulateCustomPolicyInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::simulate_custom_policy::SimulateCustomPolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::simulate_custom_policy::SimulateCustomPolicyError,
...
/// <p>If you want to simulate existing policies that are attached to an IAM user, group, or role, use <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_SimulatePrincipalPolicy.html">SimulatePrincipalPolicy</a> instead.</p>
...
pub struct SimulateCustomPolicyFluentBuilder {
    ...
    inner: super::super::super::operation::simulate_custom_policy::builders::SimulateCustomPolicyInputBuilder,
...
impl
    super::super::super::client::customize::internal::CustomizableSend<
        super::super::super::operation::simulate_custom_policy::SimulateCustomPolicyOutput,
        super::super::super::operation::simulate_custom_policy::SimulateCustomPolicyError,
    > for SimulateCustomPolicyFluentBuilder
{
    fn send(
        self,
...
impl SimulateCustomPolicyFluentBuilder {
    ...
    /// Access the SimulateCustomPolicy as a reference.
    pub fn as_input(&self) -> &super::super::super::operation::simulate_custom_policy::builders::SimulateCustomPolicyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::simulate_custom_policy::SimulateCustomPolicy::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::simulate_custom_policy::SimulateCustomPolicy::orchestrate(&runtime_plugins, input).await
    }
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::simulate_custom_policy::paginator::SimulateCustomPolicyPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
    pub fn into_paginator(self) -> super::super::super::operation::simulate_custom_policy::paginator::SimulateCustomPolicyPaginator {
        super::super::super::operation::simulate_custom_policy::paginator::SimulateCustomPolicyPaginator::new(self.handle, self.inner)
    }
    ///
    ...
    ///
    /// Appends an item to `OrderedOrganizationPolicyInputList`.
    ///
    ...
    pub fn ordered_organization_policy_input_list(mut self, input: super::super::super::types::OrderedOrganizationPolicyType) -> Self {
        self.inner = self.inner.ordered_organization_policy_input_list(input);
        self
    }
    /// <p>An ordered list of service control policies (SCPs) to include in the simulation. Each element represents one level of an Organizations hierarchy, from the organization root to the account.</p>
    /// <p>The simulator evaluates SCPs in the order that you provide, consistent with how Organizations enforces SCPs. The first element must represent the organization root, and the last element must represent the account. Any elements between them represent organizational units (OUs) in descending order.</p>
    ...
    pub fn set_ordered_organization_policy_input_list(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::OrderedOrganizationPolicyType>>,
    ) -> Self {
        self.inner = self.inner.set_ordered_organization_policy_input_list(input);
        self
    }
    /// <p>An ordered list of service control policies (SCPs) to include in the simulation. Each element represents one level of an Organizations hierarchy, from the organization root to the account.</p>
    /// <p>The simulator evaluates SCPs in the order that you provide, consistent with how Organizations enforces SCPs. The first element must represent the organization root, and the last element must represent the account. Any elements between them represent organizational units (OUs) in descending order.</p>
    ...
    /// <p>The ARN of the IAM user, group, or role that you want to use as the simulated caller of the API operations. <code>CallerArn</code> is required if you include a <code>ResourcePolicy</code> so that the policy's <code>Principal</code> element has a value to use in evaluating the policy.</p>
    ...
    pub fn context_entries(mut self, input: super::super::super::types::ContextEntry) -> Self {
        self.inner = self.inner.context_entries(input);
        self
    }
    /// <p>A list of context keys and corresponding values for the simulation to use. Whenever a context key is evaluated in one of the simulated IAM permissions policies, the corresponding value is supplied.</p>
    pub fn set_context_entries(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::ContextEntry>>) -> Self {
        self.inner = self.inner.set_context_entries(input);
        self
    }
    /// <p>A list of context keys and corresponding values for the simulation to use. Whenever a context key is evaluated in one of the simulated IAM permissions policies, the corresponding value is supplied.</p>
    pub fn get_context_entries(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::ContextEntry>> {
