...
impl GetRolePolicyOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_role_policy::builders::GetRolePolicyOutputBuilder {
        super::super::super::operation::get_role_policy::builders::GetRolePolicyOutputBuilder::default()
    }
}
