...
impl GetRolePolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::get_role_policy::builders::GetRolePolicyInputBuilder {
        super::super::super::operation::get_role_policy::builders::GetRolePolicyInputBuilder::default()
    }
}
