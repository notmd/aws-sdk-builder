...
impl PutUserPolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::put_user_policy::PutUserPolicyInput,
    ) -> ::std::result::Result<
        super::super::operation::put_user_policy::PutUserPolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::put_user_policy::PutUserPolicyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::put_user_policy::PutUserPolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::put_user_policy::PutUserPolicyOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "PutUserPolicy", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutUserPolicy {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutUserPolicy")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutUserPolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_put_user_policy::de_put_user_policy_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_put_user_policy::de_put_user_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutUserPolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::put_user_policy::PutUserPolicyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::put_user_policy::PutUserPolicyInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::put_user_policy::PutUserPolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::put_user_policy::_put_user_policy_input::PutUserPolicyInput;

pub use super::super::operation::put_user_policy::_put_user_policy_output::PutUserPolicyOutput;
