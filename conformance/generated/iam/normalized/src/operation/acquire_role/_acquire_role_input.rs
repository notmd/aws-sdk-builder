...
impl AcquireRoleInput {
    ...
    pub fn builder() -> super::super::super::operation::acquire_role::builders::AcquireRoleInputBuilder {
        super::super::super::operation::acquire_role::builders::AcquireRoleInputBuilder::default()
    }
}
