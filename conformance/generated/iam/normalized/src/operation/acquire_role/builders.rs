...
pub use super::super::super::operation::acquire_role::_acquire_role_input::AcquireRoleInputBuilder;

pub use super::super::super::operation::acquire_role::_acquire_role_output::AcquireRoleOutputBuilder;

impl super::super::super::operation::acquire_role::builders::AcquireRoleInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::acquire_role::AcquireRoleOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::acquire_role::AcquireRoleError,
...
pub struct AcquireRoleFluentBuilder {
    ...
    inner: super::super::super::operation::acquire_role::builders::AcquireRoleInputBuilder,
...
impl AcquireRoleFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::acquire_role::builders::AcquireRoleInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::acquire_role::AcquireRole::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::acquire_role::AcquireRole::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn set_replacement_values(
        mut self,
        input: ::std::option::Option<::std::collections::HashMap<::std::string::String, super::super::super::types::ReplacementValueEntry>>,
    ) -> Self {
