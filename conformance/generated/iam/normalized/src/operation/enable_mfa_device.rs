...
impl EnableMfaDevice {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::enable_mfa_device::EnableMfaDeviceInput,
    ) -> ::std::result::Result<
        super::super::operation::enable_mfa_device::EnableMfaDeviceOutput,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::enable_mfa_device::EnableMFADeviceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::enable_mfa_device::EnableMfaDeviceOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "EnableMFADevice", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for EnableMFADeviceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_enable_mfa_device::de_enable_mfa_device_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_enable_mfa_device::de_enable_mfa_device_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for EnableMFADeviceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::enable_mfa_device::EnableMfaDeviceInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::enable_mfa_device::EnableMfaDeviceInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::enable_mfa_device::EnableMFADeviceError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::enable_mfa_device::_enable_mfa_device_input::EnableMfaDeviceInput;

pub use super::super::operation::enable_mfa_device::_enable_mfa_device_output::EnableMfaDeviceOutput;
