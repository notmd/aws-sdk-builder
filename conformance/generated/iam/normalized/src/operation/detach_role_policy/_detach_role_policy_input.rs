...
impl DetachRolePolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::detach_role_policy::builders::DetachRolePolicyInputBuilder {
        super::super::super::operation::detach_role_policy::builders::DetachRolePolicyInputBuilder::default()
    }
}
