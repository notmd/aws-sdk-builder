...
pub use super::super::super::operation::detach_role_policy::_detach_role_policy_input::DetachRolePolicyInputBuilder;

pub use super::super::super::operation::detach_role_policy::_detach_role_policy_output::DetachRolePolicyOutputBuilder;

impl super::super::super::operation::detach_role_policy::builders::DetachRolePolicyInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::detach_role_policy::DetachRolePolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::detach_role_policy::DetachRolePolicyError,
...
pub struct DetachRolePolicyFluentBuilder {
    ...
    inner: super::super::super::operation::detach_role_policy::builders::DetachRolePolicyInputBuilder,
...
impl DetachRolePolicyFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::detach_role_policy::builders::DetachRolePolicyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::detach_role_policy::DetachRolePolicy::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::detach_role_policy::DetachRolePolicy::orchestrate(&runtime_plugins, input).await
    }
