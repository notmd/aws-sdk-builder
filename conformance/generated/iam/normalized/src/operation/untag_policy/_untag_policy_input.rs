...
impl UntagPolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::untag_policy::builders::UntagPolicyInputBuilder {
        super::super::super::operation::untag_policy::builders::UntagPolicyInputBuilder::default()
    }
}
