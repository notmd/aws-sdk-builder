...
impl GetAccessKeyLastUsedOutput {
    ...
    /// <p>Contains information about the last time the access key was used.</p>
    pub fn access_key_last_used(&self) -> ::std::option::Option<&super::super::super::types::AccessKeyLastUsed> {
...
impl GetAccessKeyLastUsedOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_access_key_last_used::builders::GetAccessKeyLastUsedOutputBuilder {
        super::super::super::operation::get_access_key_last_used::builders::GetAccessKeyLastUsedOutputBuilder::default()
    }
}
...
pub struct GetAccessKeyLastUsedOutputBuilder {
    ...
    pub(crate) access_key_last_used: ::std::option::Option<super::super::super::types::AccessKeyLastUsed>,
    _request_id: Option<String>,
}
impl GetAccessKeyLastUsedOutputBuilder {
    ...
    /// <p>Contains information about the last time the access key was used.</p>
    pub fn access_key_last_used(mut self, input: super::super::super::types::AccessKeyLastUsed) -> Self {
        self.access_key_last_used = ::std::option::Option::Some(input);
        self
    }
    /// <p>Contains information about the last time the access key was used.</p>
    pub fn set_access_key_last_used(mut self, input: ::std::option::Option<super::super::super::types::AccessKeyLastUsed>) -> Self {
        self.access_key_last_used = input;
        self
    }
    /// <p>Contains information about the last time the access key was used.</p>
    pub fn get_access_key_last_used(&self) -> &::std::option::Option<super::super::super::types::AccessKeyLastUsed> {
    ...
    pub fn build(self) -> super::super::super::operation::get_access_key_last_used::GetAccessKeyLastUsedOutput {
