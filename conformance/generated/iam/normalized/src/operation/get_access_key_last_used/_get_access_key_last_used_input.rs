...
impl GetAccessKeyLastUsedInput {
    ...
    pub fn builder() -> super::super::super::operation::get_access_key_last_used::builders::GetAccessKeyLastUsedInputBuilder {
        super::super::super::operation::get_access_key_last_used::builders::GetAccessKeyLastUsedInputBuilder::default()
    }
}
