...
pub use super::super::super::operation::get_human_readable_summary::_get_human_readable_summary_input::GetHumanReadableSummaryInputBuilder;

pub use super::super::super::operation::get_human_readable_summary::_get_human_readable_summary_output::GetHumanReadableSummaryOutputBuilder;

impl super::super::super::operation::get_human_readable_summary::builders::GetHumanReadableSummaryInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::get_human_readable_summary::GetHumanReadableSummaryOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::get_human_readable_summary::GetHumanReadableSummaryError,
...
pub struct GetHumanReadableSummaryFluentBuilder {
    ...
    inner: super::super::super::operation::get_human_readable_summary::builders::GetHumanReadableSummaryInputBuilder,
...
impl GetHumanReadableSummaryFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::get_human_readable_summary::builders::GetHumanReadableSummaryInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::get_human_readable_summary::GetHumanReadableSummary::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::get_human_readable_summary::GetHumanReadableSummary::orchestrate(&runtime_plugins, input).await
    }
