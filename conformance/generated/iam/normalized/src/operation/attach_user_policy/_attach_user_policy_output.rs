...
impl AttachUserPolicyOutput {
    ...
    pub fn builder() -> super::super::super::operation::attach_user_policy::builders::AttachUserPolicyOutputBuilder {
        super::super::super::operation::attach_user_policy::builders::AttachUserPolicyOutputBuilder::default()
    }
}
...
impl AttachUserPolicyOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::attach_user_policy::AttachUserPolicyOutput {
