...
impl AttachUserPolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::attach_user_policy::builders::AttachUserPolicyInputBuilder {
        super::super::super::operation::attach_user_policy::builders::AttachUserPolicyInputBuilder::default()
    }
}
