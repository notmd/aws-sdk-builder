...
pub use super::super::super::operation::attach_user_policy::_attach_user_policy_input::AttachUserPolicyInputBuilder;

pub use super::super::super::operation::attach_user_policy::_attach_user_policy_output::AttachUserPolicyOutputBuilder;

impl super::super::super::operation::attach_user_policy::builders::AttachUserPolicyInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::attach_user_policy::AttachUserPolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::attach_user_policy::AttachUserPolicyError,
...
pub struct AttachUserPolicyFluentBuilder {
    ...
    inner: super::super::super::operation::attach_user_policy::builders::AttachUserPolicyInputBuilder,
...
impl AttachUserPolicyFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::attach_user_policy::builders::AttachUserPolicyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::attach_user_policy::AttachUserPolicy::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::attach_user_policy::AttachUserPolicy::orchestrate(&runtime_plugins, input).await
    }
