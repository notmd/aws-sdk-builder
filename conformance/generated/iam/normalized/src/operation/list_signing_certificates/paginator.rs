...
pub struct ListSigningCertificatesPaginator {
    ...
    builder: super::super::super::operation::list_signing_certificates::builders::ListSigningCertificatesInputBuilder,
...
impl ListSigningCertificatesPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::list_signing_certificates::paginator::ListSigningCertificatesPaginatorItems {
        super::super::super::operation::list_signing_certificates::paginator::ListSigningCertificatesPaginatorItems(self)
    }
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_signing_certificates_output_output_marker(resp);
...
impl ListSigningCertificatesPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::SigningCertificate,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::list_signing_certificates::ListSigningCertificatesError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_list_signing_certificates_output_output_certificates(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
