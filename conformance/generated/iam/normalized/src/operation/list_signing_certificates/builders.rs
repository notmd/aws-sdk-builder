...
pub use super::super::super::operation::list_signing_certificates::_list_signing_certificates_input::ListSigningCertificatesInputBuilder;

pub use super::super::super::operation::list_signing_certificates::_list_signing_certificates_output::ListSigningCertificatesOutputBuilder;

impl super::super::super::operation::list_signing_certificates::builders::ListSigningCertificatesInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::list_signing_certificates::ListSigningCertificatesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::list_signing_certificates::ListSigningCertificatesError,
...
pub struct ListSigningCertificatesFluentBuilder {
    ...
    inner: super::super::super::operation::list_signing_certificates::builders::ListSigningCertificatesInputBuilder,
...
impl
    super::super::super::client::customize::internal::CustomizableSend<
        super::super::super::operation::list_signing_certificates::ListSigningCertificatesOutput,
        super::super::super::operation::list_signing_certificates::ListSigningCertificatesError,
    > for ListSigningCertificatesFluentBuilder
{
    fn send(
        self,
...
impl ListSigningCertificatesFluentBuilder {
    /// Creates a new `ListSigningCertificatesFluentBuilder`.
    ...
    pub fn as_input(&self) -> &super::super::super::operation::list_signing_certificates::builders::ListSigningCertificatesInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::list_signing_certificates::ListSigningCertificates::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::list_signing_certificates::ListSigningCertificates::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::super::super::operation::list_signing_certificates::paginator::ListSigningCertificatesPaginator {
        super::super::super::operation::list_signing_certificates::paginator::ListSigningCertificatesPaginator::new(self.handle, self.inner)
    }
