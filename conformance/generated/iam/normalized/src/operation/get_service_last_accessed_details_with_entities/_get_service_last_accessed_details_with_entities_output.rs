...
pub struct GetServiceLastAccessedDetailsWithEntitiesOutput {
    ...
    pub entity_details_list: ::std::vec::Vec<super::super::super::types::EntityDetails>,
...
impl GetServiceLastAccessedDetailsWithEntitiesOutput {
    ...
    /// <p>An <code>EntityDetailsList</code> object that contains details about when an IAM entity (user or role) used group or policy permissions in an attempt to access the specified Amazon Web Services service.</p>
    pub fn entity_details_list(&self) -> &[super::super::super::types::EntityDetails] {
        use std::ops::Deref;
...
pub struct GetServiceLastAccessedDetailsWithEntitiesOutputBuilder {
    ...
    pub(crate) entity_details_list: ::std::option::Option<::std::vec::Vec<super::super::super::types::EntityDetails>>,
...
impl GetServiceLastAccessedDetailsWithEntitiesOutputBuilder {
    ...
    ///
    /// <p>An <code>EntityDetailsList</code> object that contains details about when an IAM entity (user or role) used group or policy permissions in an attempt to access the specified Amazon Web Services service.</p>
    pub fn entity_details_list(mut self, input: super::super::super::types::EntityDetails) -> Self {
    ...
    /// <p>An <code>EntityDetailsList</code> object that contains details about when an IAM entity (user or role) used group or policy permissions in an attempt to access the specified Amazon Web Services service.</p>
    pub fn set_entity_details_list(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::EntityDetails>>) -> Self {
        self.entity_details_list = input;
        self
    }
    /// <p>An <code>EntityDetailsList</code> object that contains details about when an IAM entity (user or role) used group or policy permissions in an attempt to access the specified Amazon Web Services service.</p>
    pub fn get_entity_details_list(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::EntityDetails>> {
    ...
    pub fn build(
        ...
        super::super::super::operation::get_service_last_accessed_details_with_entities::GetServiceLastAccessedDetailsWithEntitiesOutput,
