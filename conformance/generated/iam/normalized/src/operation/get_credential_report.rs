...
impl GetCredentialReport {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::get_credential_report::GetCredentialReportInput,
    ) -> ::std::result::Result<
        super::super::operation::get_credential_report::GetCredentialReportOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::get_credential_report::GetCredentialReportError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::get_credential_report::GetCredentialReportError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::get_credential_report::GetCredentialReportOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "GetCredentialReport", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetCredentialReportResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_get_credential_report::de_get_credential_report_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_get_credential_report::de_get_credential_report_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetCredentialReportRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::get_credential_report::GetCredentialReportInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::get_credential_report::GetCredentialReportInput,
...
impl GetCredentialReportError {
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::CredentialReportExpiredException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::CredentialReportNotPresentException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::CredentialReportNotReadyException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetCredentialReportError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::CredentialReportExpiredException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::CredentialReportNotPresentException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::CredentialReportNotReadyException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
...
impl ::aws_types::request_id::RequestId for super::super::operation::get_credential_report::GetCredentialReportError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::get_credential_report::_get_credential_report_input::GetCredentialReportInput;

pub use super::super::operation::get_credential_report::_get_credential_report_output::GetCredentialReportOutput;
