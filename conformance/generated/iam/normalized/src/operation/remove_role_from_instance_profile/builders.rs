...
pub use super::super::super::operation::remove_role_from_instance_profile::_remove_role_from_instance_profile_input::RemoveRoleFromInstanceProfileInputBuilder;

pub use super::super::super::operation::remove_role_from_instance_profile::_remove_role_from_instance_profile_output::RemoveRoleFromInstanceProfileOutputBuilder;

impl super::super::super::operation::remove_role_from_instance_profile::builders::RemoveRoleFromInstanceProfileInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::remove_role_from_instance_profile::RemoveRoleFromInstanceProfileOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::remove_role_from_instance_profile::RemoveRoleFromInstanceProfileError,
...
pub struct RemoveRoleFromInstanceProfileFluentBuilder {
    ...
    inner: super::super::super::operation::remove_role_from_instance_profile::builders::RemoveRoleFromInstanceProfileInputBuilder,
