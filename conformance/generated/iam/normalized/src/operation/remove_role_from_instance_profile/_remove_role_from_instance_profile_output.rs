...
impl RemoveRoleFromInstanceProfileOutput {
    ...
    pub fn builder() -> super::super::super::operation::remove_role_from_instance_profile::builders::RemoveRoleFromInstanceProfileOutputBuilder {
        super::super::super::operation::remove_role_from_instance_profile::builders::RemoveRoleFromInstanceProfileOutputBuilder::default()
    }
}
...
impl RemoveRoleFromInstanceProfileOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::remove_role_from_instance_profile::RemoveRoleFromInstanceProfileOutput {
