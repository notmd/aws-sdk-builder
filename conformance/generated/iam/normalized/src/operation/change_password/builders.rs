...
pub use super::super::super::operation::change_password::_change_password_input::ChangePasswordInputBuilder;

pub use super::super::super::operation::change_password::_change_password_output::ChangePasswordOutputBuilder;

impl super::super::super::operation::change_password::builders::ChangePasswordInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::change_password::ChangePasswordOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::change_password::ChangePasswordError,
...
pub struct ChangePasswordFluentBuilder {
    ...
    inner: super::super::super::operation::change_password::builders::ChangePasswordInputBuilder,
...
impl ChangePasswordFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::change_password::builders::ChangePasswordInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::change_password::ChangePassword::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::change_password::ChangePassword::orchestrate(&runtime_plugins, input).await
    }
