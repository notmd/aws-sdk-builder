...
impl ChangePasswordOutput {
    ...
    pub fn builder() -> super::super::super::operation::change_password::builders::ChangePasswordOutputBuilder {
        super::super::super::operation::change_password::builders::ChangePasswordOutputBuilder::default()
    }
}
...
impl ChangePasswordOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::change_password::ChangePasswordOutput {
