...
impl UploadSshPublicKeyInput {
    ...
    pub fn builder() -> super::super::super::operation::upload_ssh_public_key::builders::UploadSshPublicKeyInputBuilder {
        super::super::super::operation::upload_ssh_public_key::builders::UploadSshPublicKeyInputBuilder::default()
    }
}
