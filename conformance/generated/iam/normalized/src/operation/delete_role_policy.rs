...
impl DeleteRolePolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::delete_role_policy::DeleteRolePolicyInput,
    ) -> ::std::result::Result<
        super::super::operation::delete_role_policy::DeleteRolePolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::delete_role_policy::DeleteRolePolicyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::delete_role_policy::DeleteRolePolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::delete_role_policy::DeleteRolePolicyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteRolePolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_delete_role_policy::de_delete_role_policy_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_delete_role_policy::de_delete_role_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteRolePolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::delete_role_policy::DeleteRolePolicyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::delete_role_policy::DeleteRolePolicyInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::delete_role_policy::DeleteRolePolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::delete_role_policy::_delete_role_policy_input::DeleteRolePolicyInput;

pub use super::super::operation::delete_role_policy::_delete_role_policy_output::DeleteRolePolicyOutput;
