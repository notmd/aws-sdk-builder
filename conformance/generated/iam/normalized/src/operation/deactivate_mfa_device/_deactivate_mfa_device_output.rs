...
impl DeactivateMfaDeviceOutput {
    ...
    pub fn builder() -> super::super::super::operation::deactivate_mfa_device::builders::DeactivateMfaDeviceOutputBuilder {
        super::super::super::operation::deactivate_mfa_device::builders::DeactivateMfaDeviceOutputBuilder::default()
    }
}
...
impl DeactivateMfaDeviceOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::deactivate_mfa_device::DeactivateMfaDeviceOutput {
