...
impl DeactivateMfaDeviceInput {
    ...
    pub fn builder() -> super::super::super::operation::deactivate_mfa_device::builders::DeactivateMfaDeviceInputBuilder {
        super::super::super::operation::deactivate_mfa_device::builders::DeactivateMfaDeviceInputBuilder::default()
    }
}
