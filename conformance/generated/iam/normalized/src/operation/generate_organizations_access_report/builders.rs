...
pub use super::super::super::operation::generate_organizations_access_report::_generate_organizations_access_report_input::GenerateOrganizationsAccessReportInputBuilder;

pub use super::super::super::operation::generate_organizations_access_report::_generate_organizations_access_report_output::GenerateOrganizationsAccessReportOutputBuilder;

impl super::super::super::operation::generate_organizations_access_report::builders::GenerateOrganizationsAccessReportInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::generate_organizations_access_report::GenerateOrganizationsAccessReportOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::generate_organizations_access_report::GenerateOrganizationsAccessReportError,
...
pub struct GenerateOrganizationsAccessReportFluentBuilder {
    ...
    inner: super::super::super::operation::generate_organizations_access_report::builders::GenerateOrganizationsAccessReportInputBuilder,
