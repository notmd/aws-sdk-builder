...
impl TagMfaDeviceOutput {
    ...
    pub fn builder() -> super::super::super::operation::tag_mfa_device::builders::TagMfaDeviceOutputBuilder {
        super::super::super::operation::tag_mfa_device::builders::TagMfaDeviceOutputBuilder::default()
    }
}
...
impl TagMfaDeviceOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::tag_mfa_device::TagMfaDeviceOutput {
