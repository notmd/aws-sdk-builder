...
impl TagMfaDeviceInput {
    ...
    pub fn builder() -> super::super::super::operation::tag_mfa_device::builders::TagMfaDeviceInputBuilder {
        super::super::super::operation::tag_mfa_device::builders::TagMfaDeviceInputBuilder::default()
    }
}
...
impl TagMfaDeviceInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::tag_mfa_device::TagMfaDeviceInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::tag_mfa_device::TagMfaDeviceInput {
