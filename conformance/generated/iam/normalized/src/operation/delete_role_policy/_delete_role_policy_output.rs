...
impl DeleteRolePolicyOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_role_policy::builders::DeleteRolePolicyOutputBuilder {
        super::super::super::operation::delete_role_policy::builders::DeleteRolePolicyOutputBuilder::default()
    }
}
...
impl DeleteRolePolicyOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_role_policy::DeleteRolePolicyOutput {
