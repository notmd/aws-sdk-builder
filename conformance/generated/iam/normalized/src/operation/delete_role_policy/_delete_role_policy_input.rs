...
impl DeleteRolePolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_role_policy::builders::DeleteRolePolicyInputBuilder {
        super::super::super::operation::delete_role_policy::builders::DeleteRolePolicyInputBuilder::default()
    }
}
