...
impl UpdateAccessKey {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::update_access_key::UpdateAccessKeyInput,
    ) -> ::std::result::Result<
        super::super::operation::update_access_key::UpdateAccessKeyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::update_access_key::UpdateAccessKeyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::update_access_key::UpdateAccessKeyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::update_access_key::UpdateAccessKeyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateAccessKeyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_update_access_key::de_update_access_key_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_update_access_key::de_update_access_key_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateAccessKeyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::update_access_key::UpdateAccessKeyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::update_access_key::UpdateAccessKeyInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::update_access_key::UpdateAccessKeyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::update_access_key::_update_access_key_input::UpdateAccessKeyInput;

pub use super::super::operation::update_access_key::_update_access_key_output::UpdateAccessKeyOutput;
