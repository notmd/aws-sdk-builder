...
impl RejectDelegationRequestInput {
    ...
    pub fn builder() -> super::super::super::operation::reject_delegation_request::builders::RejectDelegationRequestInputBuilder {
        super::super::super::operation::reject_delegation_request::builders::RejectDelegationRequestInputBuilder::default()
    }
}
...
impl RejectDelegationRequestInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::reject_delegation_request::RejectDelegationRequestInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::reject_delegation_request::RejectDelegationRequestInput {
