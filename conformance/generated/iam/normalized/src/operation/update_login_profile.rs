...
impl UpdateLoginProfile {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::update_login_profile::UpdateLoginProfileInput,
    ) -> ::std::result::Result<
        super::super::operation::update_login_profile::UpdateLoginProfileOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::update_login_profile::UpdateLoginProfileError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::update_login_profile::UpdateLoginProfileError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::update_login_profile::UpdateLoginProfileOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateLoginProfileResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_update_login_profile::de_update_login_profile_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_update_login_profile::de_update_login_profile_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateLoginProfileRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::update_login_profile::UpdateLoginProfileInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::update_login_profile::UpdateLoginProfileInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::update_login_profile::UpdateLoginProfileError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::update_login_profile::_update_login_profile_input::UpdateLoginProfileInput;

pub use super::super::operation::update_login_profile::_update_login_profile_output::UpdateLoginProfileOutput;
