...
pub use super::super::super::operation::delete_signing_certificate::_delete_signing_certificate_input::DeleteSigningCertificateInputBuilder;

pub use super::super::super::operation::delete_signing_certificate::_delete_signing_certificate_output::DeleteSigningCertificateOutputBuilder;

impl super::super::super::operation::delete_signing_certificate::builders::DeleteSigningCertificateInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_signing_certificate::DeleteSigningCertificateOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_signing_certificate::DeleteSigningCertificateError,
...
pub struct DeleteSigningCertificateFluentBuilder {
    ...
    inner: super::super::super::operation::delete_signing_certificate::builders::DeleteSigningCertificateInputBuilder,
...
impl DeleteSigningCertificateFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_signing_certificate::builders::DeleteSigningCertificateInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_signing_certificate::DeleteSigningCertificate::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_signing_certificate::DeleteSigningCertificate::orchestrate(&runtime_plugins, input).await
    }
