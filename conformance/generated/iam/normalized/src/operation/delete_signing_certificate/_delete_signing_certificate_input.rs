...
impl DeleteSigningCertificateInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_signing_certificate::builders::DeleteSigningCertificateInputBuilder {
        super::super::super::operation::delete_signing_certificate::builders::DeleteSigningCertificateInputBuilder::default()
    }
}
