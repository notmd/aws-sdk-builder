...
impl DeleteSigningCertificateOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_signing_certificate::builders::DeleteSigningCertificateOutputBuilder {
        super::super::super::operation::delete_signing_certificate::builders::DeleteSigningCertificateOutputBuilder::default()
    }
}
...
impl DeleteSigningCertificateOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_signing_certificate::DeleteSigningCertificateOutput {
