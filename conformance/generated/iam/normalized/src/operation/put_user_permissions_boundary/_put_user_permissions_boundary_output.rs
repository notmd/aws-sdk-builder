...
impl PutUserPermissionsBoundaryOutput {
    ...
    pub fn builder() -> super::super::super::operation::put_user_permissions_boundary::builders::PutUserPermissionsBoundaryOutputBuilder {
        super::super::super::operation::put_user_permissions_boundary::builders::PutUserPermissionsBoundaryOutputBuilder::default()
    }
}
...
impl PutUserPermissionsBoundaryOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::put_user_permissions_boundary::PutUserPermissionsBoundaryOutput {
