...
impl PutUserPermissionsBoundaryInput {
    ...
    pub fn builder() -> super::super::super::operation::put_user_permissions_boundary::builders::PutUserPermissionsBoundaryInputBuilder {
        super::super::super::operation::put_user_permissions_boundary::builders::PutUserPermissionsBoundaryInputBuilder::default()
    }
}
