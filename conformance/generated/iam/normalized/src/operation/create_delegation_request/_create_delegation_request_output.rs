...
impl CreateDelegationRequestOutput {
    ...
    pub fn builder() -> super::super::super::operation::create_delegation_request::builders::CreateDelegationRequestOutputBuilder {
        super::super::super::operation::create_delegation_request::builders::CreateDelegationRequestOutputBuilder::default()
    }
}
...
impl CreateDelegationRequestOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::create_delegation_request::CreateDelegationRequestOutput {
