...
impl CreateUserInput {
    ...
    pub fn builder() -> super::super::super::operation::create_user::builders::CreateUserInputBuilder {
        super::super::super::operation::create_user::builders::CreateUserInputBuilder::default()
    }
}
