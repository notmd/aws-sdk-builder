...
pub struct ListServerCertificatesPaginator {
    ...
    builder: super::super::super::operation::list_server_certificates::builders::ListServerCertificatesInputBuilder,
...
impl ListServerCertificatesPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::list_server_certificates::paginator::ListServerCertificatesPaginatorItems {
        super::super::super::operation::list_server_certificates::paginator::ListServerCertificatesPaginatorItems(self)
    }
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_server_certificates_output_output_marker(resp);
...
impl ListServerCertificatesPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::ServerCertificateMetadata,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::list_server_certificates::ListServerCertificatesError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_list_server_certificates_output_output_server_certificate_metadata_list(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
