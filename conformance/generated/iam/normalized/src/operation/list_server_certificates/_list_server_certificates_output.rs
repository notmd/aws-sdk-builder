...
pub struct ListServerCertificatesOutput {
    ...
    pub server_certificate_metadata_list: ::std::vec::Vec<super::super::super::types::ServerCertificateMetadata>,
...
impl ListServerCertificatesOutput {
    /// <p>A list of server certificates.</p>
    pub fn server_certificate_metadata_list(&self) -> &[super::super::super::types::ServerCertificateMetadata] {
        use std::ops::Deref;
...
impl ListServerCertificatesOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_server_certificates::builders::ListServerCertificatesOutputBuilder {
        super::super::super::operation::list_server_certificates::builders::ListServerCertificatesOutputBuilder::default()
    }
}
...
pub struct ListServerCertificatesOutputBuilder {
    pub(crate) server_certificate_metadata_list: ::std::option::Option<::std::vec::Vec<super::super::super::types::ServerCertificateMetadata>>,
...
impl ListServerCertificatesOutputBuilder {
    ...
    ///
    /// <p>A list of server certificates.</p>
    pub fn server_certificate_metadata_list(mut self, input: super::super::super::types::ServerCertificateMetadata) -> Self {
    ...
    pub fn set_server_certificate_metadata_list(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::ServerCertificateMetadata>>,
    ) -> Self {
    ...
    > {
        ::std::result::Result::Ok(super::super::super::operation::list_server_certificates::ListServerCertificatesOutput {
