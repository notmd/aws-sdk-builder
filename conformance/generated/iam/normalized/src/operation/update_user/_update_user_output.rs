...
impl UpdateUserOutput {
    ...
    pub fn builder() -> super::super::super::operation::update_user::builders::UpdateUserOutputBuilder {
        super::super::super::operation::update_user::builders::UpdateUserOutputBuilder::default()
    }
}
...
impl UpdateUserOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::update_user::UpdateUserOutput {
