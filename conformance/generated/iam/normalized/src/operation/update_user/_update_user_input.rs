...
impl UpdateUserInput {
    ...
    pub fn builder() -> super::super::super::operation::update_user::builders::UpdateUserInputBuilder {
        super::super::super::operation::update_user::builders::UpdateUserInputBuilder::default()
    }
}
