...
pub struct GetAccountAuthorizationDetailsPaginator {
    ...
    builder: super::super::super::operation::get_account_authorization_details::builders::GetAccountAuthorizationDetailsInputBuilder,
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::super::super::operation::get_account_authorization_details::GetAccountAuthorizationDetails::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_get_account_authorization_details_output_output_marker(resp);
