...
impl GetAccountAuthorizationDetailsOutput {
    ...
    pub fn user_detail_list(&self) -> &[super::super::super::types::UserDetail] {
    ...
    pub fn group_detail_list(&self) -> &[super::super::super::types::GroupDetail] {
    ...
    pub fn role_detail_list(&self) -> &[super::super::super::types::RoleDetail] {
    ...
    pub fn policies(&self) -> &[super::super::super::types::ManagedPolicyDetail] {
...
impl GetAccountAuthorizationDetailsOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_account_authorization_details::builders::GetAccountAuthorizationDetailsOutputBuilder {
        super::super::super::operation::get_account_authorization_details::builders::GetAccountAuthorizationDetailsOutputBuilder::default()
    }
}
...
pub struct GetAccountAuthorizationDetailsOutputBuilder {
    pub(crate) user_detail_list: ::std::option::Option<::std::vec::Vec<super::super::super::types::UserDetail>>,
    pub(crate) group_detail_list: ::std::option::Option<::std::vec::Vec<super::super::super::types::GroupDetail>>,
    pub(crate) role_detail_list: ::std::option::Option<::std::vec::Vec<super::super::super::types::RoleDetail>>,
    pub(crate) policies: ::std::option::Option<::std::vec::Vec<super::super::super::types::ManagedPolicyDetail>>,
...
impl GetAccountAuthorizationDetailsOutputBuilder {
    ...
    ///
    /// <p>A list containing information about IAM users.</p>
    pub fn user_detail_list(mut self, input: super::super::super::types::UserDetail) -> Self {
    ...
    /// <p>A list containing information about IAM users.</p>
    pub fn set_user_detail_list(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::UserDetail>>) -> Self {
        self.user_detail_list = input;
        self
    }
    /// <p>A list containing information about IAM users.</p>
    pub fn get_user_detail_list(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::UserDetail>> {
    ...
    ///
    /// <p>A list containing information about IAM groups.</p>
    pub fn group_detail_list(mut self, input: super::super::super::types::GroupDetail) -> Self {
    ...
    /// <p>A list containing information about IAM groups.</p>
    pub fn set_group_detail_list(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::GroupDetail>>) -> Self {
        self.group_detail_list = input;
        self
    }
    /// <p>A list containing information about IAM groups.</p>
    pub fn get_group_detail_list(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::GroupDetail>> {
    ...
    ///
    /// <p>A list containing information about IAM roles.</p>
    pub fn role_detail_list(mut self, input: super::super::super::types::RoleDetail) -> Self {
    ...
    /// <p>A list containing information about IAM roles.</p>
    pub fn set_role_detail_list(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::RoleDetail>>) -> Self {
        self.role_detail_list = input;
        self
    }
    /// <p>A list containing information about IAM roles.</p>
    pub fn get_role_detail_list(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::RoleDetail>> {
    ...
    ///
    /// <p>A list containing information about managed policies.</p>
    pub fn policies(mut self, input: super::super::super::types::ManagedPolicyDetail) -> Self {
    ...
    /// <p>A list containing information about managed policies.</p>
    pub fn set_policies(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::ManagedPolicyDetail>>) -> Self {
        self.policies = input;
        self
    }
    /// <p>A list containing information about managed policies.</p>
    pub fn get_policies(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::ManagedPolicyDetail>> {
        &self.policies
    }
    /// <p>A flag that indicates whether there are more items to return. If your results were truncated, you can make a subsequent pagination request using the <code>Marker</code> request parameter to retrieve more items. Note that IAM might return fewer than the <code>MaxItems</code> number of results even when there are more results available. We recommend that you check <code>IsTruncated</code> after every call to ensure that you receive all your results.</p>
    ...
    pub fn build(self) -> super::super::super::operation::get_account_authorization_details::GetAccountAuthorizationDetailsOutput {
        super::super::super::operation::get_account_authorization_details::GetAccountAuthorizationDetailsOutput {
