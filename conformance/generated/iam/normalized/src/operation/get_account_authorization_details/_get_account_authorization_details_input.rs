...
impl GetAccountAuthorizationDetailsInput {
    ...
    pub fn filter(&self) -> &[super::super::super::types::EntityType] {
...
impl GetAccountAuthorizationDetailsInput {
    ...
    pub fn builder() -> super::super::super::operation::get_account_authorization_details::builders::GetAccountAuthorizationDetailsInputBuilder {
        super::super::super::operation::get_account_authorization_details::builders::GetAccountAuthorizationDetailsInputBuilder::default()
    }
}
...
pub struct GetAccountAuthorizationDetailsInputBuilder {
    pub(crate) filter: ::std::option::Option<::std::vec::Vec<super::super::super::types::EntityType>>,
