...
impl ListDelegationRequestsOutput {
    ...
    pub fn delegation_requests(&self) -> &[super::super::super::types::DelegationRequest] {
...
impl ListDelegationRequestsOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_delegation_requests::builders::ListDelegationRequestsOutputBuilder {
        super::super::super::operation::list_delegation_requests::builders::ListDelegationRequestsOutputBuilder::default()
    }
}
...
pub struct ListDelegationRequestsOutputBuilder {
    pub(crate) delegation_requests: ::std::option::Option<::std::vec::Vec<super::super::super::types::DelegationRequest>>,
...
impl ListDelegationRequestsOutputBuilder {
    ...
    ///
    /// <p>A list of delegation requests that match the specified criteria.</p>
    pub fn delegation_requests(mut self, input: super::super::super::types::DelegationRequest) -> Self {
    ...
    /// <p>A list of delegation requests that match the specified criteria.</p>
    pub fn set_delegation_requests(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::DelegationRequest>>) -> Self {
        self.delegation_requests = input;
        self
    }
    /// <p>A list of delegation requests that match the specified criteria.</p>
    pub fn get_delegation_requests(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::DelegationRequest>> {
    ...
    pub fn build(self) -> super::super::super::operation::list_delegation_requests::ListDelegationRequestsOutput {
