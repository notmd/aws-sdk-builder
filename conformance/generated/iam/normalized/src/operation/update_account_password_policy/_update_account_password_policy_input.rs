...
impl UpdateAccountPasswordPolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::update_account_password_policy::builders::UpdateAccountPasswordPolicyInputBuilder {
        super::super::super::operation::update_account_password_policy::builders::UpdateAccountPasswordPolicyInputBuilder::default()
    }
}
