...
impl UpdateAssumeRolePolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::update_assume_role_policy::UpdateAssumeRolePolicyInput,
    ) -> ::std::result::Result<
        super::super::operation::update_assume_role_policy::UpdateAssumeRolePolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::update_assume_role_policy::UpdateAssumeRolePolicyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::update_assume_role_policy::UpdateAssumeRolePolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::update_assume_role_policy::UpdateAssumeRolePolicyOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "UpdateAssumeRolePolicy", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateAssumeRolePolicyTelemetryInputCaptureInterceptor {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateAssumeRolePolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_update_assume_role_policy::de_update_assume_role_policy_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_update_assume_role_policy::de_update_assume_role_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateAssumeRolePolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::update_assume_role_policy::UpdateAssumeRolePolicyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::update_assume_role_policy::UpdateAssumeRolePolicyInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::update_assume_role_policy::UpdateAssumeRolePolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::update_assume_role_policy::_update_assume_role_policy_input::UpdateAssumeRolePolicyInput;

pub use super::super::operation::update_assume_role_policy::_update_assume_role_policy_output::UpdateAssumeRolePolicyOutput;
