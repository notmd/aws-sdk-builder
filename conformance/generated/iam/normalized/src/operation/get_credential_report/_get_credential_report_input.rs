...
impl GetCredentialReportInput {
    ...
    pub fn builder() -> super::super::super::operation::get_credential_report::builders::GetCredentialReportInputBuilder {
        super::super::super::operation::get_credential_report::builders::GetCredentialReportInputBuilder::default()
    }
}
