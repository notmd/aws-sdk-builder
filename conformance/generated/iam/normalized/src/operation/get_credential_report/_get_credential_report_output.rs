...
impl GetCredentialReportOutput {
    ...
    /// <p>The format (MIME type) of the credential report.</p>
    pub fn report_format(&self) -> ::std::option::Option<&super::super::super::types::ReportFormatType> {
...
impl GetCredentialReportOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_credential_report::builders::GetCredentialReportOutputBuilder {
        super::super::super::operation::get_credential_report::builders::GetCredentialReportOutputBuilder::default()
    }
}
...
pub struct GetCredentialReportOutputBuilder {
    ...
    pub(crate) report_format: ::std::option::Option<super::super::super::types::ReportFormatType>,
...
impl GetCredentialReportOutputBuilder {
    ...
    /// <p>The format (MIME type) of the credential report.</p>
    pub fn report_format(mut self, input: super::super::super::types::ReportFormatType) -> Self {
        self.report_format = ::std::option::Option::Some(input);
        self
    }
    /// <p>The format (MIME type) of the credential report.</p>
    pub fn set_report_format(mut self, input: ::std::option::Option<super::super::super::types::ReportFormatType>) -> Self {
        self.report_format = input;
        self
    }
    /// <p>The format (MIME type) of the credential report.</p>
    pub fn get_report_format(&self) -> &::std::option::Option<super::super::super::types::ReportFormatType> {
        &self.report_format
    }
    /// <p>The date and time when the credential report was created, in <a href="http://www.iso.org/iso/iso8601">ISO 8601 date-time format</a>.</p>
    ...
    pub fn build(self) -> super::super::super::operation::get_credential_report::GetCredentialReportOutput {
