...
impl GetGroupInput {
    ...
    pub fn builder() -> super::super::super::operation::get_group::builders::GetGroupInputBuilder {
        super::super::super::operation::get_group::builders::GetGroupInputBuilder::default()
    }
}
