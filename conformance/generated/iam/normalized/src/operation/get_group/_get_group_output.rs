...
pub struct GetGroupOutput {
    ...
    pub users: ::std::vec::Vec<super::super::super::types::User>,
...
impl GetGroupOutput {
    /// <p>A structure that contains details about the group.</p>
    pub fn group(&self) -> ::std::option::Option<&super::super::super::types::Group> {
        self.group.as_ref()
    }
    /// <p>A list of users in the group.</p>
    pub fn users(&self) -> &[super::super::super::types::User] {
        use std::ops::Deref;
        self.users.deref()
    }
    /// <p>A flag that indicates whether there are more items to return. If your results were truncated, you can make a subsequent pagination request using the <code>Marker</code> request parameter to retrieve more items. Note that IAM might return fewer than the <code>MaxItems</code> number of results even when there are more results available. We recommend that you check <code>IsTruncated</code> after every call to ensure that you receive all your results.</p>
...
impl GetGroupOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_group::builders::GetGroupOutputBuilder {
        super::super::super::operation::get_group::builders::GetGroupOutputBuilder::default()
    }
}
...
pub struct GetGroupOutputBuilder {
    pub(crate) group: ::std::option::Option<super::super::super::types::Group>,
    pub(crate) users: ::std::option::Option<::std::vec::Vec<super::super::super::types::User>>,
...
impl GetGroupOutputBuilder {
    ...
    pub fn group(mut self, input: super::super::super::types::Group) -> Self {
        self.group = ::std::option::Option::Some(input);
        self
    }
    /// <p>A structure that contains details about the group.</p>
    pub fn set_group(mut self, input: ::std::option::Option<super::super::super::types::Group>) -> Self {
        self.group = input;
        self
    }
    /// <p>A structure that contains details about the group.</p>
    pub fn get_group(&self) -> &::std::option::Option<super::super::super::types::Group> {
        &self.group
    }
    ...
    ///
    /// <p>A list of users in the group.</p>
    pub fn users(mut self, input: super::super::super::types::User) -> Self {
    ...
    /// <p>A list of users in the group.</p>
    pub fn set_users(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::User>>) -> Self {
        self.users = input;
        self
    }
    /// <p>A list of users in the group.</p>
    pub fn get_users(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::User>> {
        &self.users
    }
    /// <p>A flag that indicates whether there are more items to return. If your results were truncated, you can make a subsequent pagination request using the <code>Marker</code> request parameter to retrieve more items. Note that IAM might return fewer than the <code>MaxItems</code> number of results even when there are more results available. We recommend that you check <code>IsTruncated</code> after every call to ensure that you receive all your results.</p>
