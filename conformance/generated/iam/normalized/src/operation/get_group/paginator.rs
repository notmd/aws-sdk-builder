...
impl GetGroupPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::get_group::paginator::GetGroupPaginatorItems {
        super::super::super::operation::get_group::paginator::GetGroupPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::super::super::operation::get_group::GetGroup::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_get_group_output_output_marker(resp);
