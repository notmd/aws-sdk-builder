...
impl DeleteLoginProfileInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_login_profile::builders::DeleteLoginProfileInputBuilder {
        super::super::super::operation::delete_login_profile::builders::DeleteLoginProfileInputBuilder::default()
    }
}
