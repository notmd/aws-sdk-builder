...
impl UpdateRole {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::update_role::UpdateRoleInput,
    ) -> ::std::result::Result<
        super::super::operation::update_role::UpdateRoleOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::update_role::UpdateRoleError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::update_role::UpdateRoleError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::update_role::UpdateRoleOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateRoleResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_update_role::de_update_role_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_update_role::de_update_role_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateRoleRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::update_role::UpdateRoleInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::update_role::UpdateRoleError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::update_role::_update_role_input::UpdateRoleInput;

pub use super::super::operation::update_role::_update_role_output::UpdateRoleOutput;
