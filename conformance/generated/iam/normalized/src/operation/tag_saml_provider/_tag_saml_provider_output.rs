...
impl TagSamlProviderOutput {
    ...
    pub fn builder() -> super::super::super::operation::tag_saml_provider::builders::TagSamlProviderOutputBuilder {
        super::super::super::operation::tag_saml_provider::builders::TagSamlProviderOutputBuilder::default()
    }
}
...
impl TagSamlProviderOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::tag_saml_provider::TagSamlProviderOutput {
