...
impl TagSamlProviderInput {
    ...
    pub fn builder() -> super::super::super::operation::tag_saml_provider::builders::TagSamlProviderInputBuilder {
        super::super::super::operation::tag_saml_provider::builders::TagSamlProviderInputBuilder::default()
    }
}
