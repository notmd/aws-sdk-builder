...
impl TagPolicyOutput {
    ...
    pub fn builder() -> super::super::super::operation::tag_policy::builders::TagPolicyOutputBuilder {
        super::super::super::operation::tag_policy::builders::TagPolicyOutputBuilder::default()
    }
}
...
impl TagPolicyOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::tag_policy::TagPolicyOutput {
