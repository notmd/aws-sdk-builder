...
impl TagPolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::tag_policy::builders::TagPolicyInputBuilder {
        super::super::super::operation::tag_policy::builders::TagPolicyInputBuilder::default()
    }
}
