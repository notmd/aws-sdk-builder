...
impl UntagRoleInput {
    ...
    pub fn builder() -> super::super::super::operation::untag_role::builders::UntagRoleInputBuilder {
        super::super::super::operation::untag_role::builders::UntagRoleInputBuilder::default()
    }
}
