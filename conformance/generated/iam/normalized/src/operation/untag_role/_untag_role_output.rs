...
impl UntagRoleOutput {
    ...
    pub fn builder() -> super::super::super::operation::untag_role::builders::UntagRoleOutputBuilder {
        super::super::super::operation::untag_role::builders::UntagRoleOutputBuilder::default()
    }
}
...
impl UntagRoleOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::untag_role::UntagRoleOutput {
