...
impl ListRolesPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::list_roles::paginator::ListRolesPaginatorItems {
        super::super::super::operation::list_roles::paginator::ListRolesPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::super::super::operation::list_roles::ListRoles::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_roles_output_output_marker(resp);
