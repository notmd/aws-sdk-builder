...
pub struct ListRolesOutput {
    /// <p>A list of roles.</p>
    pub roles: ::std::vec::Vec<super::super::super::types::Role>,
...
impl ListRolesOutput {
    /// <p>A list of roles.</p>
    pub fn roles(&self) -> &[super::super::super::types::Role] {
        use std::ops::Deref;
        self.roles.deref()
    }
    /// <p>A flag that indicates whether there are more items to return. If your results were truncated, you can make a subsequent pagination request using the <code>Marker</code> request parameter to retrieve more items. Note that IAM might return fewer than the <code>MaxItems</code> number of results even when there are more results available. We recommend that you check <code>IsTruncated</code> after every call to ensure that you receive all your results.</p>
...
impl ListRolesOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_roles::builders::ListRolesOutputBuilder {
        super::super::super::operation::list_roles::builders::ListRolesOutputBuilder::default()
    }
}
...
pub struct ListRolesOutputBuilder {
    pub(crate) roles: ::std::option::Option<::std::vec::Vec<super::super::super::types::Role>>,
...
impl ListRolesOutputBuilder {
    ...
    ///
    /// <p>A list of roles.</p>
    pub fn roles(mut self, input: super::super::super::types::Role) -> Self {
    ...
    /// <p>A list of roles.</p>
    pub fn set_roles(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::Role>>) -> Self {
        self.roles = input;
        self
    }
    /// <p>A list of roles.</p>
    pub fn get_roles(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::Role>> {
        &self.roles
    }
    /// <p>A flag that indicates whether there are more items to return. If your results were truncated, you can make a subsequent pagination request using the <code>Marker</code> request parameter to retrieve more items. Note that IAM might return fewer than the <code>MaxItems</code> number of results even when there are more results available. We recommend that you check <code>IsTruncated</code> after every call to ensure that you receive all your results.</p>
