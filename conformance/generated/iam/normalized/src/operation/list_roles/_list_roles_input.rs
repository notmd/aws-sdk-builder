...
impl ListRolesInput {
    ...
    pub fn builder() -> super::super::super::operation::list_roles::builders::ListRolesInputBuilder {
        super::super::super::operation::list_roles::builders::ListRolesInputBuilder::default()
    }
}
