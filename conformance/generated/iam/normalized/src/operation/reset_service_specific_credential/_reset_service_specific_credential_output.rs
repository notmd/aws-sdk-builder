...
impl ResetServiceSpecificCredentialOutput {
    ...
    pub fn builder() -> super::super::super::operation::reset_service_specific_credential::builders::ResetServiceSpecificCredentialOutputBuilder {
        super::super::super::operation::reset_service_specific_credential::builders::ResetServiceSpecificCredentialOutputBuilder::default()
    }
}
...
impl ResetServiceSpecificCredentialOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::reset_service_specific_credential::ResetServiceSpecificCredentialOutput {
        super::super::super::operation::reset_service_specific_credential::ResetServiceSpecificCredentialOutput {
