...
impl ResetServiceSpecificCredentialInput {
    ...
    pub fn builder() -> super::super::super::operation::reset_service_specific_credential::builders::ResetServiceSpecificCredentialInputBuilder {
        super::super::super::operation::reset_service_specific_credential::builders::ResetServiceSpecificCredentialInputBuilder::default()
    }
}
