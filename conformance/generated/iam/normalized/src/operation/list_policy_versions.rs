...
impl ListPolicyVersions {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::list_policy_versions::ListPolicyVersionsInput,
    ) -> ::std::result::Result<
        super::super::operation::list_policy_versions::ListPolicyVersionsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::list_policy_versions::ListPolicyVersionsError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::list_policy_versions::ListPolicyVersionsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::list_policy_versions::ListPolicyVersionsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListPolicyVersionsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_list_policy_versions::de_list_policy_versions_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_list_policy_versions::de_list_policy_versions_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListPolicyVersionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::list_policy_versions::ListPolicyVersionsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::list_policy_versions::ListPolicyVersionsInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::list_policy_versions::ListPolicyVersionsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::list_policy_versions::_list_policy_versions_input::ListPolicyVersionsInput;

pub use super::super::operation::list_policy_versions::_list_policy_versions_output::ListPolicyVersionsOutput;
