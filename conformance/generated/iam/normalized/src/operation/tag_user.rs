...
impl TagUser {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::tag_user::TagUserInput,
    ) -> ::std::result::Result<
        super::super::operation::tag_user::TagUserOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::tag_user::TagUserError,
    ...
    > {
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::tag_user::TagUserOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "TagUser", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for TagUserResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_tag_user::de_tag_user_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_tag_user::de_tag_user_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for TagUserRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::super::operation::tag_user::TagUserInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::tag_user::TagUserInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::tag_user::TagUserError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::tag_user::_tag_user_input::TagUserInput;

pub use super::super::operation::tag_user::_tag_user_output::TagUserOutput;
