...
impl ListSamlProvidersInput {
    ...
    pub fn builder() -> super::super::super::operation::list_saml_providers::builders::ListSamlProvidersInputBuilder {
        super::super::super::operation::list_saml_providers::builders::ListSamlProvidersInputBuilder::default()
    }
}
