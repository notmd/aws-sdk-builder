...
impl ListSamlProvidersOutput {
    ...
    pub fn saml_provider_list(&self) -> &[super::super::super::types::SamlProviderListEntry] {
...
impl ListSamlProvidersOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_saml_providers::builders::ListSamlProvidersOutputBuilder {
        super::super::super::operation::list_saml_providers::builders::ListSamlProvidersOutputBuilder::default()
    }
}
...
pub struct ListSamlProvidersOutputBuilder {
    pub(crate) saml_provider_list: ::std::option::Option<::std::vec::Vec<super::super::super::types::SamlProviderListEntry>>,
    _request_id: Option<String>,
}
impl ListSamlProvidersOutputBuilder {
    ...
    ///
    /// <p>The list of SAML provider resource objects defined in IAM for this Amazon Web Services account.</p>
    pub fn saml_provider_list(mut self, input: super::super::super::types::SamlProviderListEntry) -> Self {
    ...
    /// <p>The list of SAML provider resource objects defined in IAM for this Amazon Web Services account.</p>
    pub fn get_saml_provider_list(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::SamlProviderListEntry>> {
    ...
    pub fn build(self) -> super::super::super::operation::list_saml_providers::ListSamlProvidersOutput {
