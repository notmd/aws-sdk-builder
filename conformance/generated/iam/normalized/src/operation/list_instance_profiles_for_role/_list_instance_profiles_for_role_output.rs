...
pub struct ListInstanceProfilesForRoleOutput {
    ...
    pub instance_profiles: ::std::vec::Vec<super::super::super::types::InstanceProfile>,
...
impl ListInstanceProfilesForRoleOutput {
    /// <p>A list of instance profiles.</p>
    pub fn instance_profiles(&self) -> &[super::super::super::types::InstanceProfile] {
        use std::ops::Deref;
...
impl ListInstanceProfilesForRoleOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_instance_profiles_for_role::builders::ListInstanceProfilesForRoleOutputBuilder {
        super::super::super::operation::list_instance_profiles_for_role::builders::ListInstanceProfilesForRoleOutputBuilder::default()
    }
}
...
pub struct ListInstanceProfilesForRoleOutputBuilder {
    pub(crate) instance_profiles: ::std::option::Option<::std::vec::Vec<super::super::super::types::InstanceProfile>>,
...
impl ListInstanceProfilesForRoleOutputBuilder {
    ...
    ///
    /// <p>A list of instance profiles.</p>
    pub fn instance_profiles(mut self, input: super::super::super::types::InstanceProfile) -> Self {
    ...
    /// <p>A list of instance profiles.</p>
    pub fn set_instance_profiles(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::InstanceProfile>>) -> Self {
        self.instance_profiles = input;
        self
    }
    /// <p>A list of instance profiles.</p>
    pub fn get_instance_profiles(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::InstanceProfile>> {
