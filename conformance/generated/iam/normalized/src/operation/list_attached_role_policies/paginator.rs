...
pub struct ListAttachedRolePoliciesPaginator {
    ...
    builder: super::super::super::operation::list_attached_role_policies::builders::ListAttachedRolePoliciesInputBuilder,
...
impl ListAttachedRolePoliciesPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::list_attached_role_policies::paginator::ListAttachedRolePoliciesPaginatorItems {
        super::super::super::operation::list_attached_role_policies::paginator::ListAttachedRolePoliciesPaginatorItems(self)
    }
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_attached_role_policies_output_output_marker(resp);
...
impl ListAttachedRolePoliciesPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_list_attached_role_policies_output_output_attached_policies(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
