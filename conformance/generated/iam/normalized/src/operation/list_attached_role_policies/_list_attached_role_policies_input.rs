...
impl ListAttachedRolePoliciesInput {
    ...
    pub fn builder() -> super::super::super::operation::list_attached_role_policies::builders::ListAttachedRolePoliciesInputBuilder {
        super::super::super::operation::list_attached_role_policies::builders::ListAttachedRolePoliciesInputBuilder::default()
    }
}
