...
pub use super::super::super::operation::list_attached_role_policies::_list_attached_role_policies_input::ListAttachedRolePoliciesInputBuilder;

pub use super::super::super::operation::list_attached_role_policies::_list_attached_role_policies_output::ListAttachedRolePoliciesOutputBuilder;

impl super::super::super::operation::list_attached_role_policies::builders::ListAttachedRolePoliciesInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::list_attached_role_policies::ListAttachedRolePoliciesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::list_attached_role_policies::ListAttachedRolePoliciesError,
...
/// <p>An IAM role can also have inline policies embedded with it. To list the inline policies for a role, use <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_ListRolePolicies.html">ListRolePolicies</a>. For information about policies, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/policies-managed-vs-inline.html">Managed policies and inline policies</a> in the <i>IAM User Guide</i>.</p>
...
pub struct ListAttachedRolePoliciesFluentBuilder {
    ...
    inner: super::super::super::operation::list_attached_role_policies::builders::ListAttachedRolePoliciesInputBuilder,
...
impl ListAttachedRolePoliciesFluentBuilder {
    /// Creates a new `ListAttachedRolePoliciesFluentBuilder`.
    ...
    pub fn as_input(&self) -> &super::super::super::operation::list_attached_role_policies::builders::ListAttachedRolePoliciesInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::list_attached_role_policies::ListAttachedRolePolicies::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::list_attached_role_policies::ListAttachedRolePolicies::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::super::super::operation::list_attached_role_policies::paginator::ListAttachedRolePoliciesPaginator {
        super::super::super::operation::list_attached_role_policies::paginator::ListAttachedRolePoliciesPaginator::new(self.handle, self.inner)
    }
