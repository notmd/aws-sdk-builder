...
impl ListAttachedRolePoliciesOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_attached_role_policies::builders::ListAttachedRolePoliciesOutputBuilder {
        super::super::super::operation::list_attached_role_policies::builders::ListAttachedRolePoliciesOutputBuilder::default()
    }
}
...
impl ListAttachedRolePoliciesOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::list_attached_role_policies::ListAttachedRolePoliciesOutput {
