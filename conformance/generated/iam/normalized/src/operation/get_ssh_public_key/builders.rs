...
pub use super::super::super::operation::get_ssh_public_key::_get_ssh_public_key_input::GetSshPublicKeyInputBuilder;

pub use super::super::super::operation::get_ssh_public_key::_get_ssh_public_key_output::GetSshPublicKeyOutputBuilder;

impl super::super::super::operation::get_ssh_public_key::builders::GetSshPublicKeyInputBuilder {
...
impl GetSSHPublicKeyFluentBuilder {
    ...
    pub fn encoding(mut self, input: super::super::super::types::EncodingType) -> Self {
        self.inner = self.inner.encoding(input);
        self
    }
    /// <p>Specifies the public key encoding format to use in the response. To retrieve the public key in ssh-rsa format, use <code>SSH</code>. To retrieve the public key in PEM format, use <code>PEM</code>.</p>
    pub fn set_encoding(mut self, input: ::std::option::Option<super::super::super::types::EncodingType>) -> Self {
        self.inner = self.inner.set_encoding(input);
        self
    }
    /// <p>Specifies the public key encoding format to use in the response. To retrieve the public key in ssh-rsa format, use <code>SSH</code>. To retrieve the public key in PEM format, use <code>PEM</code>.</p>
    pub fn get_encoding(&self) -> &::std::option::Option<super::super::super::types::EncodingType> {
