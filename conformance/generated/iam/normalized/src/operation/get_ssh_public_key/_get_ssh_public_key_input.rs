...
impl GetSshPublicKeyInput {
    ...
    /// <p>Specifies the public key encoding format to use in the response. To retrieve the public key in ssh-rsa format, use <code>SSH</code>. To retrieve the public key in PEM format, use <code>PEM</code>.</p>
    pub fn encoding(&self) -> ::std::option::Option<&super::super::super::types::EncodingType> {
...
impl GetSshPublicKeyInput {
    ...
    pub fn builder() -> super::super::super::operation::get_ssh_public_key::builders::GetSshPublicKeyInputBuilder {
        super::super::super::operation::get_ssh_public_key::builders::GetSshPublicKeyInputBuilder::default()
    }
}
...
pub struct GetSshPublicKeyInputBuilder {
    ...
    pub(crate) encoding: ::std::option::Option<super::super::super::types::EncodingType>,
}
