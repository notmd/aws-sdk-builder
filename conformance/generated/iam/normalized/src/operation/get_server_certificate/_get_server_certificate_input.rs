...
impl GetServerCertificateInput {
    ...
    pub fn builder() -> super::super::super::operation::get_server_certificate::builders::GetServerCertificateInputBuilder {
        super::super::super::operation::get_server_certificate::builders::GetServerCertificateInputBuilder::default()
    }
}
