...
impl UntagOpenIdConnectProviderOutput {
    ...
    pub fn builder() -> super::super::super::operation::untag_open_id_connect_provider::builders::UntagOpenIdConnectProviderOutputBuilder {
        super::super::super::operation::untag_open_id_connect_provider::builders::UntagOpenIdConnectProviderOutputBuilder::default()
    }
}
...
impl UntagOpenIdConnectProviderOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::untag_open_id_connect_provider::UntagOpenIdConnectProviderOutput {
