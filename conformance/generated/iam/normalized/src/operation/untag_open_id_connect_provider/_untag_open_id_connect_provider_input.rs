...
impl UntagOpenIdConnectProviderInput {
    ...
    pub fn builder() -> super::super::super::operation::untag_open_id_connect_provider::builders::UntagOpenIdConnectProviderInputBuilder {
        super::super::super::operation::untag_open_id_connect_provider::builders::UntagOpenIdConnectProviderInputBuilder::default()
    }
}
