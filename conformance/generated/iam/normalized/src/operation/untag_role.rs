...
impl UntagRole {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::untag_role::UntagRoleInput,
    ) -> ::std::result::Result<
        super::super::operation::untag_role::UntagRoleOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::untag_role::UntagRoleError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::untag_role::UntagRoleError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::untag_role::UntagRoleOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UntagRoleResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_untag_role::de_untag_role_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_untag_role::de_untag_role_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UntagRoleRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::untag_role::UntagRoleInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::untag_role::UntagRoleError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::untag_role::_untag_role_input::UntagRoleInput;

pub use super::super::operation::untag_role::_untag_role_output::UntagRoleOutput;
