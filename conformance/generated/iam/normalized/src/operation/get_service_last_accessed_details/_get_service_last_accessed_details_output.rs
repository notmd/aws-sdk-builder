...
pub struct GetServiceLastAccessedDetailsOutput {
    ...
    pub job_status: super::super::super::types::JobStatusType,
    ...
    pub services_last_accessed: ::std::vec::Vec<super::super::super::types::ServiceLastAccessed>,
...
impl GetServiceLastAccessedDetailsOutput {
    /// <p>The status of the job.</p>
    pub fn job_status(&self) -> &super::super::super::types::JobStatusType {
        &self.job_status
    }
    /// <p>The type of job. Service jobs return information about when each service was last accessed. Action jobs also include information about when tracked actions within the service were last accessed.</p>
    pub fn job_type(&self) -> ::std::option::Option<&super::super::super::types::AccessAdvisorUsageGranularityType> {
    ...
    /// <p>A <code>ServiceLastAccessed</code> object that contains details about the most recent attempt to access the service.</p>
    pub fn services_last_accessed(&self) -> &[super::super::super::types::ServiceLastAccessed] {
        use std::ops::Deref;
    ...
    /// <p>An object that contains details about the reason the operation failed.</p>
    pub fn error(&self) -> ::std::option::Option<&super::super::super::types::ErrorDetails> {
        self.error.as_ref()
    }
}
...
impl GetServiceLastAccessedDetailsOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_service_last_accessed_details::builders::GetServiceLastAccessedDetailsOutputBuilder {
        super::super::super::operation::get_service_last_accessed_details::builders::GetServiceLastAccessedDetailsOutputBuilder::default()
    }
}
...
pub struct GetServiceLastAccessedDetailsOutputBuilder {
    pub(crate) job_status: ::std::option::Option<super::super::super::types::JobStatusType>,
    pub(crate) job_type: ::std::option::Option<super::super::super::types::AccessAdvisorUsageGranularityType>,
    pub(crate) job_creation_date: ::std::option::Option<::aws_smithy_types::DateTime>,
    pub(crate) services_last_accessed: ::std::option::Option<::std::vec::Vec<super::super::super::types::ServiceLastAccessed>>,
    pub(crate) job_completion_date: ::std::option::Option<::aws_smithy_types::DateTime>,
    pub(crate) is_truncated: ::std::option::Option<bool>,
    pub(crate) marker: ::std::option::Option<::std::string::String>,
    pub(crate) error: ::std::option::Option<super::super::super::types::ErrorDetails>,
    _request_id: Option<String>,
}
impl GetServiceLastAccessedDetailsOutputBuilder {
    /// <p>The status of the job.</p>
    /// This field is required.
    pub fn job_status(mut self, input: super::super::super::types::JobStatusType) -> Self {
        self.job_status = ::std::option::Option::Some(input);
        self
    }
    /// <p>The status of the job.</p>
    pub fn set_job_status(mut self, input: ::std::option::Option<super::super::super::types::JobStatusType>) -> Self {
        self.job_status = input;
        self
    }
    /// <p>The status of the job.</p>
    pub fn get_job_status(&self) -> &::std::option::Option<super::super::super::types::JobStatusType> {
        &self.job_status
    }
    /// <p>The type of job. Service jobs return information about when each service was last accessed. Action jobs also include information about when tracked actions within the service were last accessed.</p>
    pub fn job_type(mut self, input: super::super::super::types::AccessAdvisorUsageGranularityType) -> Self {
        self.job_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The type of job. Service jobs return information about when each service was last accessed. Action jobs also include information about when tracked actions within the service were last accessed.</p>
    pub fn set_job_type(mut self, input: ::std::option::Option<super::super::super::types::AccessAdvisorUsageGranularityType>) -> Self {
        self.job_type = input;
        self
    }
    /// <p>The type of job. Service jobs return information about when each service was last accessed. Action jobs also include information about when tracked actions within the service were last accessed.</p>
    pub fn get_job_type(&self) -> &::std::option::Option<super::super::super::types::AccessAdvisorUsageGranularityType> {
        &self.job_type
    }
    /// <p>The date and time, in <a href="http://www.iso.org/iso/iso8601">ISO 8601 date-time format</a>, when the report job was created.</p>
    /// This field is required.
    ...
    ///
    /// <p>A <code>ServiceLastAccessed</code> object that contains details about the most recent attempt to access the service.</p>
    pub fn services_last_accessed(mut self, input: super::super::super::types::ServiceLastAccessed) -> Self {
    ...
    /// <p>A <code>ServiceLastAccessed</code> object that contains details about the most recent attempt to access the service.</p>
    pub fn get_services_last_accessed(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::ServiceLastAccessed>> {
    ...
    /// <p>An object that contains details about the reason the operation failed.</p>
    pub fn error(mut self, input: super::super::super::types::ErrorDetails) -> Self {
        self.error = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object that contains details about the reason the operation failed.</p>
    pub fn set_error(mut self, input: ::std::option::Option<super::super::super::types::ErrorDetails>) -> Self {
        self.error = input;
        self
    }
    /// <p>An object that contains details about the reason the operation failed.</p>
    pub fn get_error(&self) -> &::std::option::Option<super::super::super::types::ErrorDetails> {
        &self.error
    }
