...
impl AddUserToGroupOutput {
    ...
    pub fn builder() -> super::super::super::operation::add_user_to_group::builders::AddUserToGroupOutputBuilder {
        super::super::super::operation::add_user_to_group::builders::AddUserToGroupOutputBuilder::default()
    }
}
...
impl AddUserToGroupOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::add_user_to_group::AddUserToGroupOutput {
