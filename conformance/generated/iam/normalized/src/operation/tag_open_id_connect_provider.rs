...
impl TagOpenIdConnectProvider {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::tag_open_id_connect_provider::TagOpenIdConnectProviderInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::tag_open_id_connect_provider::TagOpenIDConnectProviderError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::tag_open_id_connect_provider::TagOpenIdConnectProviderOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "TagOpenIDConnectProvider", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for TagOpenIDConnectProviderResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_tag_open_id_connect_provider::de_tag_open_id_connect_provider_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_tag_open_id_connect_provider::de_tag_open_id_connect_provider_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for TagOpenIDConnectProviderRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::tag_open_id_connect_provider::TagOpenIdConnectProviderInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::tag_open_id_connect_provider::TagOpenIdConnectProviderInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::tag_open_id_connect_provider::TagOpenIDConnectProviderError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::tag_open_id_connect_provider::_tag_open_id_connect_provider_input::TagOpenIdConnectProviderInput;

pub use super::super::operation::tag_open_id_connect_provider::_tag_open_id_connect_provider_output::TagOpenIdConnectProviderOutput;
