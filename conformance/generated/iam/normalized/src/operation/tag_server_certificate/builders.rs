...
pub use super::super::super::operation::tag_server_certificate::_tag_server_certificate_input::TagServerCertificateInputBuilder;

pub use super::super::super::operation::tag_server_certificate::_tag_server_certificate_output::TagServerCertificateOutputBuilder;

impl super::super::super::operation::tag_server_certificate::builders::TagServerCertificateInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::tag_server_certificate::TagServerCertificateOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::tag_server_certificate::TagServerCertificateError,
...
pub struct TagServerCertificateFluentBuilder {
    ...
    inner: super::super::super::operation::tag_server_certificate::builders::TagServerCertificateInputBuilder,
...
impl TagServerCertificateFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::tag_server_certificate::builders::TagServerCertificateInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::tag_server_certificate::TagServerCertificate::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::tag_server_certificate::TagServerCertificate::orchestrate(&runtime_plugins, input).await
    }
