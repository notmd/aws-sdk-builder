...
impl TagServerCertificateInput {
    ...
    pub fn builder() -> super::super::super::operation::tag_server_certificate::builders::TagServerCertificateInputBuilder {
        super::super::super::operation::tag_server_certificate::builders::TagServerCertificateInputBuilder::default()
    }
}
