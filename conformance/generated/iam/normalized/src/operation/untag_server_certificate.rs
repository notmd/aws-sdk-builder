...
impl UntagServerCertificate {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::untag_server_certificate::UntagServerCertificateInput,
    ) -> ::std::result::Result<
        super::super::operation::untag_server_certificate::UntagServerCertificateOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::untag_server_certificate::UntagServerCertificateError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::untag_server_certificate::UntagServerCertificateError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::untag_server_certificate::UntagServerCertificateOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "UntagServerCertificate", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UntagServerCertificateTelemetryInputCaptureInterceptor {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UntagServerCertificateResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_untag_server_certificate::de_untag_server_certificate_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_untag_server_certificate::de_untag_server_certificate_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UntagServerCertificateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::untag_server_certificate::UntagServerCertificateInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::untag_server_certificate::UntagServerCertificateInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::untag_server_certificate::UntagServerCertificateError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::untag_server_certificate::_untag_server_certificate_input::UntagServerCertificateInput;

pub use super::super::operation::untag_server_certificate::_untag_server_certificate_output::UntagServerCertificateOutput;
