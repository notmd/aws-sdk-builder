...
impl CreatePolicyVersion {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::create_policy_version::CreatePolicyVersionInput,
    ) -> ::std::result::Result<
        super::super::operation::create_policy_version::CreatePolicyVersionOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::create_policy_version::CreatePolicyVersionError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::create_policy_version::CreatePolicyVersionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::create_policy_version::CreatePolicyVersionOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "CreatePolicyVersion", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreatePolicyVersionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_create_policy_version::de_create_policy_version_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_create_policy_version::de_create_policy_version_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreatePolicyVersionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::create_policy_version::CreatePolicyVersionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::create_policy_version::CreatePolicyVersionInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::create_policy_version::CreatePolicyVersionError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::create_policy_version::_create_policy_version_input::CreatePolicyVersionInput;

pub use super::super::operation::create_policy_version::_create_policy_version_output::CreatePolicyVersionOutput;
