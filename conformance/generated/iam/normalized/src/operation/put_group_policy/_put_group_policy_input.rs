...
impl PutGroupPolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::put_group_policy::builders::PutGroupPolicyInputBuilder {
        super::super::super::operation::put_group_policy::builders::PutGroupPolicyInputBuilder::default()
    }
}
