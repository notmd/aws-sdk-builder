...
impl PutGroupPolicyOutput {
    ...
    pub fn builder() -> super::super::super::operation::put_group_policy::builders::PutGroupPolicyOutputBuilder {
        super::super::super::operation::put_group_policy::builders::PutGroupPolicyOutputBuilder::default()
    }
}
...
impl PutGroupPolicyOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::put_group_policy::PutGroupPolicyOutput {
