...
impl GetAccountPasswordPolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::get_account_password_policy::builders::GetAccountPasswordPolicyInputBuilder {
        super::super::super::operation::get_account_password_policy::builders::GetAccountPasswordPolicyInputBuilder::default()
    }
}
...
impl GetAccountPasswordPolicyInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::get_account_password_policy::GetAccountPasswordPolicyInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::get_account_password_policy::GetAccountPasswordPolicyInput {})
    }
}
