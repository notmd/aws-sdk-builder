...
impl ListEntitiesForPolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::list_entities_for_policy::ListEntitiesForPolicyInput,
    ) -> ::std::result::Result<
        super::super::operation::list_entities_for_policy::ListEntitiesForPolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::list_entities_for_policy::ListEntitiesForPolicyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::list_entities_for_policy::ListEntitiesForPolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::list_entities_for_policy::ListEntitiesForPolicyOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "ListEntitiesForPolicy", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListEntitiesForPolicyTelemetryInputCaptureInterceptor {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListEntitiesForPolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_list_entities_for_policy::de_list_entities_for_policy_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_list_entities_for_policy::de_list_entities_for_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListEntitiesForPolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::list_entities_for_policy::ListEntitiesForPolicyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::list_entities_for_policy::ListEntitiesForPolicyInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::list_entities_for_policy::ListEntitiesForPolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::list_entities_for_policy::_list_entities_for_policy_input::ListEntitiesForPolicyInput;

pub use super::super::operation::list_entities_for_policy::_list_entities_for_policy_output::ListEntitiesForPolicyOutput;
