...
impl UpdateAssumeRolePolicyOutput {
    ...
    pub fn builder() -> super::super::super::operation::update_assume_role_policy::builders::UpdateAssumeRolePolicyOutputBuilder {
        super::super::super::operation::update_assume_role_policy::builders::UpdateAssumeRolePolicyOutputBuilder::default()
    }
}
...
impl UpdateAssumeRolePolicyOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::update_assume_role_policy::UpdateAssumeRolePolicyOutput {
