...
impl CreateAccountAliasOutput {
    ...
    pub fn builder() -> super::super::super::operation::create_account_alias::builders::CreateAccountAliasOutputBuilder {
        super::super::super::operation::create_account_alias::builders::CreateAccountAliasOutputBuilder::default()
    }
}
...
impl CreateAccountAliasOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::create_account_alias::CreateAccountAliasOutput {
