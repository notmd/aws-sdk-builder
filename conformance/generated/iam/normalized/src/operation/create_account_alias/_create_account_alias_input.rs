...
impl CreateAccountAliasInput {
    ...
    pub fn builder() -> super::super::super::operation::create_account_alias::builders::CreateAccountAliasInputBuilder {
        super::super::super::operation::create_account_alias::builders::CreateAccountAliasInputBuilder::default()
    }
}
