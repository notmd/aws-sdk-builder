...
pub use super::super::super::operation::create_account_alias::_create_account_alias_input::CreateAccountAliasInputBuilder;

pub use super::super::super::operation::create_account_alias::_create_account_alias_output::CreateAccountAliasOutputBuilder;

impl super::super::super::operation::create_account_alias::builders::CreateAccountAliasInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::create_account_alias::CreateAccountAliasOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::create_account_alias::CreateAccountAliasError,
...
pub struct CreateAccountAliasFluentBuilder {
    ...
    inner: super::super::super::operation::create_account_alias::builders::CreateAccountAliasInputBuilder,
...
impl CreateAccountAliasFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::create_account_alias::builders::CreateAccountAliasInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::create_account_alias::CreateAccountAlias::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::create_account_alias::CreateAccountAlias::orchestrate(&runtime_plugins, input).await
    }
