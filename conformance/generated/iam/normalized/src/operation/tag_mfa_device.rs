...
impl TagMfaDevice {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::tag_mfa_device::TagMfaDeviceInput,
    ) -> ::std::result::Result<
        super::super::operation::tag_mfa_device::TagMfaDeviceOutput,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::tag_mfa_device::TagMFADeviceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::tag_mfa_device::TagMfaDeviceOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "TagMFADevice", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for TagMFADeviceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_tag_mfa_device::de_tag_mfa_device_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_tag_mfa_device::de_tag_mfa_device_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for TagMFADeviceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::tag_mfa_device::TagMfaDeviceInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::tag_mfa_device::TagMfaDeviceInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::tag_mfa_device::TagMFADeviceError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::tag_mfa_device::_tag_mfa_device_input::TagMfaDeviceInput;

pub use super::super::operation::tag_mfa_device::_tag_mfa_device_output::TagMfaDeviceOutput;
