...
impl UntagSamlProviderOutput {
    ...
    pub fn builder() -> super::super::super::operation::untag_saml_provider::builders::UntagSamlProviderOutputBuilder {
        super::super::super::operation::untag_saml_provider::builders::UntagSamlProviderOutputBuilder::default()
    }
}
...
impl UntagSamlProviderOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::untag_saml_provider::UntagSamlProviderOutput {
