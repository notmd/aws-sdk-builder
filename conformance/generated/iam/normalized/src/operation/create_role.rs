...
impl CreateRole {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::create_role::CreateRoleInput,
    ) -> ::std::result::Result<
        super::super::operation::create_role::CreateRoleOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::create_role::CreateRoleError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::create_role::CreateRoleError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::create_role::CreateRoleOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "CreateRole", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateRole {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateRoleResponseDeserializer,
        ));
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateRoleResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_create_role::de_create_role_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_create_role::de_create_role_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateRoleRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::create_role::CreateRoleInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::create_role::CreateRoleError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::create_role::_create_role_input::CreateRoleInput;

pub use super::super::operation::create_role::_create_role_output::CreateRoleOutput;
