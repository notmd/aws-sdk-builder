...
impl GetInstanceProfileInput {
    ...
    pub fn builder() -> super::super::super::operation::get_instance_profile::builders::GetInstanceProfileInputBuilder {
        super::super::super::operation::get_instance_profile::builders::GetInstanceProfileInputBuilder::default()
    }
}
