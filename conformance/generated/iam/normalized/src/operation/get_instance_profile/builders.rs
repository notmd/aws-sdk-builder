...
pub use super::super::super::operation::get_instance_profile::_get_instance_profile_input::GetInstanceProfileInputBuilder;

pub use super::super::super::operation::get_instance_profile::_get_instance_profile_output::GetInstanceProfileOutputBuilder;

impl super::super::super::operation::get_instance_profile::builders::GetInstanceProfileInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::get_instance_profile::GetInstanceProfileOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::get_instance_profile::GetInstanceProfileError,
...
pub struct GetInstanceProfileFluentBuilder {
    ...
    inner: super::super::super::operation::get_instance_profile::builders::GetInstanceProfileInputBuilder,
...
impl GetInstanceProfileFluentBuilder {
    /// Creates a new `GetInstanceProfileFluentBuilder`.
    ...
    pub fn as_input(&self) -> &super::super::super::operation::get_instance_profile::builders::GetInstanceProfileInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::get_instance_profile::GetInstanceProfile::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::get_instance_profile::GetInstanceProfile::orchestrate(&runtime_plugins, input).await
    }
