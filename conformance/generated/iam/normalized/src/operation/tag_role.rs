...
impl TagRole {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::tag_role::TagRoleInput,
    ) -> ::std::result::Result<
        super::super::operation::tag_role::TagRoleOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::tag_role::TagRoleError,
    ...
    > {
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::tag_role::TagRoleOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for TagRoleResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_tag_role::de_tag_role_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_tag_role::de_tag_role_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for TagRoleRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::super::operation::tag_role::TagRoleInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::tag_role::TagRoleInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::tag_role::TagRoleError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::tag_role::_tag_role_input::TagRoleInput;

pub use super::super::operation::tag_role::_tag_role_output::TagRoleOutput;
