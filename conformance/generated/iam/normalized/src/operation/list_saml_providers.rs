...
impl ListSamlProviders {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::list_saml_providers::ListSamlProvidersInput,
    ) -> ::std::result::Result<
        super::super::operation::list_saml_providers::ListSamlProvidersOutput,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::list_saml_providers::ListSAMLProvidersError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::list_saml_providers::ListSamlProvidersOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListSAMLProvidersResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_list_saml_providers::de_list_saml_providers_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_list_saml_providers::de_list_saml_providers_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListSAMLProvidersRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::list_saml_providers::ListSamlProvidersInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::list_saml_providers::ListSamlProvidersInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::list_saml_providers::ListSAMLProvidersError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::list_saml_providers::_list_saml_providers_input::ListSamlProvidersInput;

pub use super::super::operation::list_saml_providers::_list_saml_providers_output::ListSamlProvidersOutput;
