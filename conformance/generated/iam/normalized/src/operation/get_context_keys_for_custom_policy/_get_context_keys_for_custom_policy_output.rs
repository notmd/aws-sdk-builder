...
impl GetContextKeysForCustomPolicyOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_context_keys_for_custom_policy::builders::GetContextKeysForCustomPolicyOutputBuilder {
        super::super::super::operation::get_context_keys_for_custom_policy::builders::GetContextKeysForCustomPolicyOutputBuilder::default()
    }
}
...
impl GetContextKeysForCustomPolicyOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::get_context_keys_for_custom_policy::GetContextKeysForCustomPolicyOutput {
