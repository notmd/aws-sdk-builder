...
impl RemoveRoleFromInstanceProfile {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::remove_role_from_instance_profile::RemoveRoleFromInstanceProfileInput,
    ) -> ::std::result::Result<
        super::super::operation::remove_role_from_instance_profile::RemoveRoleFromInstanceProfileOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::remove_role_from_instance_profile::RemoveRoleFromInstanceProfileError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::remove_role_from_instance_profile::RemoveRoleFromInstanceProfileError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::remove_role_from_instance_profile::RemoveRoleFromInstanceProfileOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "RemoveRoleFromInstanceProfile", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RemoveRoleFromInstanceProfile {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RemoveRoleFromInstanceProfile")
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RemoveRoleFromInstanceProfileTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RemoveRoleFromInstanceProfileInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RemoveRoleFromInstanceProfileRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::remove_role_from_instance_profile::RemoveRoleFromInstanceProfileInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::remove_role_from_instance_profile::RemoveRoleFromInstanceProfileInput,
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RemoveRoleFromInstanceProfileEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "RemoveRoleFromInstanceProfileEndpointParamsInterceptor"
    }
...
impl ::aws_types::request_id::RequestId for super::super::operation::remove_role_from_instance_profile::RemoveRoleFromInstanceProfileError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::remove_role_from_instance_profile::_remove_role_from_instance_profile_input::RemoveRoleFromInstanceProfileInput;

pub use super::super::operation::remove_role_from_instance_profile::_remove_role_from_instance_profile_output::RemoveRoleFromInstanceProfileOutput;
