...
impl AttachRolePolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::attach_role_policy::AttachRolePolicyInput,
    ) -> ::std::result::Result<
        super::super::operation::attach_role_policy::AttachRolePolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::attach_role_policy::AttachRolePolicyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::attach_role_policy::AttachRolePolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::attach_role_policy::AttachRolePolicyOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "AttachRolePolicy", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AttachRolePolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_attach_role_policy::de_attach_role_policy_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_attach_role_policy::de_attach_role_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AttachRolePolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::attach_role_policy::AttachRolePolicyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::attach_role_policy::AttachRolePolicyInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::attach_role_policy::AttachRolePolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::attach_role_policy::_attach_role_policy_input::AttachRolePolicyInput;

pub use super::super::operation::attach_role_policy::_attach_role_policy_output::AttachRolePolicyOutput;
