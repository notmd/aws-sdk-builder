...
impl GetGroupPolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::get_group_policy::builders::GetGroupPolicyInputBuilder {
        super::super::super::operation::get_group_policy::builders::GetGroupPolicyInputBuilder::default()
    }
}
