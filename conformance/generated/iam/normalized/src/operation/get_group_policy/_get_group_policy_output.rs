...
impl GetGroupPolicyOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_group_policy::builders::GetGroupPolicyOutputBuilder {
        super::super::super::operation::get_group_policy::builders::GetGroupPolicyOutputBuilder::default()
    }
}
