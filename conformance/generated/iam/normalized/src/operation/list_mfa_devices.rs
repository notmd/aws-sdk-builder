...
impl ListMfaDevices {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::list_mfa_devices::ListMfaDevicesInput,
    ) -> ::std::result::Result<
        super::super::operation::list_mfa_devices::ListMfaDevicesOutput,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::list_mfa_devices::ListMFADevicesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::list_mfa_devices::ListMfaDevicesOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "ListMFADevices", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListMFADevicesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_list_mfa_devices::de_list_mfa_devices_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_list_mfa_devices::de_list_mfa_devices_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListMFADevicesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::list_mfa_devices::ListMfaDevicesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::list_mfa_devices::ListMfaDevicesInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::list_mfa_devices::ListMFADevicesError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::list_mfa_devices::_list_mfa_devices_input::ListMfaDevicesInput;

pub use super::super::operation::list_mfa_devices::_list_mfa_devices_output::ListMfaDevicesOutput;
