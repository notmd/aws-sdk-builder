...
impl DeleteAccessKey {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::delete_access_key::DeleteAccessKeyInput,
    ) -> ::std::result::Result<
        super::super::operation::delete_access_key::DeleteAccessKeyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::delete_access_key::DeleteAccessKeyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::delete_access_key::DeleteAccessKeyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::delete_access_key::DeleteAccessKeyOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "DeleteAccessKey", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteAccessKey {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteAccessKey")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteAccessKeyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_delete_access_key::de_delete_access_key_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_delete_access_key::de_delete_access_key_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteAccessKeyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::delete_access_key::DeleteAccessKeyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::delete_access_key::DeleteAccessKeyInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::delete_access_key::DeleteAccessKeyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::delete_access_key::_delete_access_key_input::DeleteAccessKeyInput;

pub use super::super::operation::delete_access_key::_delete_access_key_output::DeleteAccessKeyOutput;
