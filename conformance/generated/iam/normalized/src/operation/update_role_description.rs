...
impl UpdateRoleDescription {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::update_role_description::UpdateRoleDescriptionInput,
    ) -> ::std::result::Result<
        super::super::operation::update_role_description::UpdateRoleDescriptionOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::update_role_description::UpdateRoleDescriptionError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::update_role_description::UpdateRoleDescriptionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::update_role_description::UpdateRoleDescriptionOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "UpdateRoleDescription", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateRoleDescriptionTelemetryInputCaptureInterceptor {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateRoleDescriptionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_update_role_description::de_update_role_description_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_update_role_description::de_update_role_description_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateRoleDescriptionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::update_role_description::UpdateRoleDescriptionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::update_role_description::UpdateRoleDescriptionInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::update_role_description::UpdateRoleDescriptionError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::update_role_description::_update_role_description_input::UpdateRoleDescriptionInput;

pub use super::super::operation::update_role_description::_update_role_description_output::UpdateRoleDescriptionOutput;
