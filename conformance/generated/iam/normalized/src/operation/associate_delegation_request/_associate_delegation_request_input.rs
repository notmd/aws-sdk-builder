...
impl AssociateDelegationRequestInput {
    ...
    pub fn builder() -> super::super::super::operation::associate_delegation_request::builders::AssociateDelegationRequestInputBuilder {
        super::super::super::operation::associate_delegation_request::builders::AssociateDelegationRequestInputBuilder::default()
    }
}
