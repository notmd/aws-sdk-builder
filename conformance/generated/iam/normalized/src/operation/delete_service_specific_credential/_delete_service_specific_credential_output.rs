...
impl DeleteServiceSpecificCredentialOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_service_specific_credential::builders::DeleteServiceSpecificCredentialOutputBuilder {
        super::super::super::operation::delete_service_specific_credential::builders::DeleteServiceSpecificCredentialOutputBuilder::default()
    }
}
...
impl DeleteServiceSpecificCredentialOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_service_specific_credential::DeleteServiceSpecificCredentialOutput {
