...
pub use super::super::super::operation::delete_service_specific_credential::_delete_service_specific_credential_input::DeleteServiceSpecificCredentialInputBuilder;

pub use super::super::super::operation::delete_service_specific_credential::_delete_service_specific_credential_output::DeleteServiceSpecificCredentialOutputBuilder;

impl super::super::super::operation::delete_service_specific_credential::builders::DeleteServiceSpecificCredentialInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_service_specific_credential::DeleteServiceSpecificCredentialOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_service_specific_credential::DeleteServiceSpecificCredentialError,
...
pub struct DeleteServiceSpecificCredentialFluentBuilder {
    ...
    inner: super::super::super::operation::delete_service_specific_credential::builders::DeleteServiceSpecificCredentialInputBuilder,
