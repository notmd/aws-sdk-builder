...
impl ResyncMfaDeviceInput {
    ...
    pub fn builder() -> super::super::super::operation::resync_mfa_device::builders::ResyncMfaDeviceInputBuilder {
        super::super::super::operation::resync_mfa_device::builders::ResyncMfaDeviceInputBuilder::default()
    }
}
