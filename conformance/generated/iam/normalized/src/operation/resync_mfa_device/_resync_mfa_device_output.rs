...
impl ResyncMfaDeviceOutput {
    ...
    pub fn builder() -> super::super::super::operation::resync_mfa_device::builders::ResyncMfaDeviceOutputBuilder {
        super::super::super::operation::resync_mfa_device::builders::ResyncMfaDeviceOutputBuilder::default()
    }
}
...
impl ResyncMfaDeviceOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::resync_mfa_device::ResyncMfaDeviceOutput {
