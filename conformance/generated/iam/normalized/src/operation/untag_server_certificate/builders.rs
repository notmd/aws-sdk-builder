...
pub use super::super::super::operation::untag_server_certificate::_untag_server_certificate_input::UntagServerCertificateInputBuilder;

pub use super::super::super::operation::untag_server_certificate::_untag_server_certificate_output::UntagServerCertificateOutputBuilder;

impl super::super::super::operation::untag_server_certificate::builders::UntagServerCertificateInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::untag_server_certificate::UntagServerCertificateOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::untag_server_certificate::UntagServerCertificateError,
...
pub struct UntagServerCertificateFluentBuilder {
    ...
    inner: super::super::super::operation::untag_server_certificate::builders::UntagServerCertificateInputBuilder,
...
impl UntagServerCertificateFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::untag_server_certificate::builders::UntagServerCertificateInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::untag_server_certificate::UntagServerCertificate::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::untag_server_certificate::UntagServerCertificate::orchestrate(&runtime_plugins, input).await
    }
