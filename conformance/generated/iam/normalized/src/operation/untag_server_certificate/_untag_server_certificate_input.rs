...
impl UntagServerCertificateInput {
    ...
    pub fn builder() -> super::super::super::operation::untag_server_certificate::builders::UntagServerCertificateInputBuilder {
        super::super::super::operation::untag_server_certificate::builders::UntagServerCertificateInputBuilder::default()
    }
}
...
impl UntagServerCertificateInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::untag_server_certificate::UntagServerCertificateInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::untag_server_certificate::UntagServerCertificateInput {
