...
impl UntagServerCertificateOutput {
    ...
    pub fn builder() -> super::super::super::operation::untag_server_certificate::builders::UntagServerCertificateOutputBuilder {
        super::super::super::operation::untag_server_certificate::builders::UntagServerCertificateOutputBuilder::default()
    }
}
...
impl UntagServerCertificateOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::untag_server_certificate::UntagServerCertificateOutput {
