...
impl DetachUserPolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::detach_user_policy::DetachUserPolicyInput,
    ) -> ::std::result::Result<
        super::super::operation::detach_user_policy::DetachUserPolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::detach_user_policy::DetachUserPolicyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::detach_user_policy::DetachUserPolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::detach_user_policy::DetachUserPolicyOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "DetachUserPolicy", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DetachUserPolicy {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DetachUserPolicy")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DetachUserPolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_detach_user_policy::de_detach_user_policy_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_detach_user_policy::de_detach_user_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DetachUserPolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::detach_user_policy::DetachUserPolicyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::detach_user_policy::DetachUserPolicyInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::detach_user_policy::DetachUserPolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::detach_user_policy::_detach_user_policy_input::DetachUserPolicyInput;

pub use super::super::operation::detach_user_policy::_detach_user_policy_output::DetachUserPolicyOutput;
