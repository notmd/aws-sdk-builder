...
impl CreateUser {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::create_user::CreateUserInput,
    ) -> ::std::result::Result<
        super::super::operation::create_user::CreateUserOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::create_user::CreateUserError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::create_user::CreateUserError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::create_user::CreateUserOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "CreateUser", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateUserResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_create_user::de_create_user_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_create_user::de_create_user_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateUserRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::create_user::CreateUserInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::create_user::CreateUserError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::create_user::_create_user_input::CreateUserInput;

pub use super::super::operation::create_user::_create_user_output::CreateUserOutput;
