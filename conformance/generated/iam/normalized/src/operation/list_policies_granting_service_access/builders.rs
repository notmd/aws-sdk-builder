...
pub use super::super::super::operation::list_policies_granting_service_access::_list_policies_granting_service_access_input::ListPoliciesGrantingServiceAccessInputBuilder;

pub use super::super::super::operation::list_policies_granting_service_access::_list_policies_granting_service_access_output::ListPoliciesGrantingServiceAccessOutputBuilder;

impl super::super::super::operation::list_policies_granting_service_access::builders::ListPoliciesGrantingServiceAccessInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::list_policies_granting_service_access::ListPoliciesGrantingServiceAccessOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::list_policies_granting_service_access::ListPoliciesGrantingServiceAccessError,
...
pub struct ListPoliciesGrantingServiceAccessFluentBuilder {
    ...
    inner: super::super::super::operation::list_policies_granting_service_access::builders::ListPoliciesGrantingServiceAccessInputBuilder,
