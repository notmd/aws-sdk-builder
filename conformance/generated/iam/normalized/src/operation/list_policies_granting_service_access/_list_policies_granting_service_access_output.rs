...
pub struct ListPoliciesGrantingServiceAccessOutput {
    ...
    pub policies_granting_service_access: ::std::vec::Vec<super::super::super::types::ListPoliciesGrantingServiceAccessEntry>,
...
impl ListPoliciesGrantingServiceAccessOutput {
    /// <p>A <code>ListPoliciesGrantingServiceAccess</code> object that contains details about the permissions policies attached to the specified identity (user, group, or role).</p>
    pub fn policies_granting_service_access(&self) -> &[super::super::super::types::ListPoliciesGrantingServiceAccessEntry] {
        use std::ops::Deref;
...
impl ListPoliciesGrantingServiceAccessOutputBuilder {
    ...
    ///
    /// <p>A <code>ListPoliciesGrantingServiceAccess</code> object that contains details about the permissions policies attached to the specified identity (user, group, or role).</p>
    pub fn policies_granting_service_access(mut self, input: super::super::super::types::ListPoliciesGrantingServiceAccessEntry) -> Self {
    ...
    pub fn set_policies_granting_service_access(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::ListPoliciesGrantingServiceAccessEntry>>,
    ) -> Self {
