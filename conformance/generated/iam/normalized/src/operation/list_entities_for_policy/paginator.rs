...
pub struct ListEntitiesForPolicyPaginator {
    ...
    builder: super::super::super::operation::list_entities_for_policy::builders::ListEntitiesForPolicyInputBuilder,
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_entities_for_policy_output_output_marker(resp);
