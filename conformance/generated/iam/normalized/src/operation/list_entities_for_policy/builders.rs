...
pub use super::super::super::operation::list_entities_for_policy::_list_entities_for_policy_input::ListEntitiesForPolicyInputBuilder;

pub use super::super::super::operation::list_entities_for_policy::_list_entities_for_policy_output::ListEntitiesForPolicyOutputBuilder;

impl super::super::super::operation::list_entities_for_policy::builders::ListEntitiesForPolicyInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::list_entities_for_policy::ListEntitiesForPolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::list_entities_for_policy::ListEntitiesForPolicyError,
...
pub struct ListEntitiesForPolicyFluentBuilder {
    handle: ::std::sync::Arc<super::super::super::client::Handle>,
    inner: super::super::super::operation::list_entities_for_policy::builders::ListEntitiesForPolicyInputBuilder,
...
impl
    super::super::super::client::customize::internal::CustomizableSend<
        super::super::super::operation::list_entities_for_policy::ListEntitiesForPolicyOutput,
        super::super::super::operation::list_entities_for_policy::ListEntitiesForPolicyError,
    > for ListEntitiesForPolicyFluentBuilder
{
    fn send(
        self,
...
impl ListEntitiesForPolicyFluentBuilder {
    /// Creates a new `ListEntitiesForPolicyFluentBuilder`.
    ...
    pub fn as_input(&self) -> &super::super::super::operation::list_entities_for_policy::builders::ListEntitiesForPolicyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::list_entities_for_policy::ListEntitiesForPolicy::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::list_entities_for_policy::ListEntitiesForPolicy::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::super::super::operation::list_entities_for_policy::paginator::ListEntitiesForPolicyPaginator {
        super::super::super::operation::list_entities_for_policy::paginator::ListEntitiesForPolicyPaginator::new(self.handle, self.inner)
    }
    ...
    pub fn entity_filter(mut self, input: super::super::super::types::EntityType) -> Self {
        self.inner = self.inner.entity_filter(input);
        self
    }
    /// <p>The entity type to use for filtering the results.</p>
    /// <p>For example, when <code>EntityFilter</code> is <code>Role</code>, only the roles that are attached to the specified policy are returned. This parameter is optional. If it is not included, all attached entities (users, groups, and roles) are returned. The argument for this parameter must be one of the valid values listed below.</p>
    pub fn set_entity_filter(mut self, input: ::std::option::Option<super::super::super::types::EntityType>) -> Self {
        self.inner = self.inner.set_entity_filter(input);
        self
    }
    /// <p>The entity type to use for filtering the results.</p>
    /// <p>For example, when <code>EntityFilter</code> is <code>Role</code>, only the roles that are attached to the specified policy are returned. This parameter is optional. If it is not included, all attached entities (users, groups, and roles) are returned. The argument for this parameter must be one of the valid values listed below.</p>
    pub fn get_entity_filter(&self) -> &::std::option::Option<super::super::super::types::EntityType> {
        self.inner.get_entity_filter()
    }
    ...
    pub fn policy_usage_filter(mut self, input: super::super::super::types::PolicyUsageType) -> Self {
    ...
    /// <p>To list only permissions policies, set <code>PolicyUsageFilter</code> to <code>PermissionsPolicy</code>. To list only the policies used to set permissions boundaries, set the value to <code>PermissionsBoundary</code>.</p>
    /// <p>This parameter is optional. If it is not included, all policies are returned.</p>
    pub fn set_policy_usage_filter(mut self, input: ::std::option::Option<super::super::super::types::PolicyUsageType>) -> Self {
    ...
    /// <p>To list only permissions policies, set <code>PolicyUsageFilter</code> to <code>PermissionsPolicy</code>. To list only the policies used to set permissions boundaries, set the value to <code>PermissionsBoundary</code>.</p>
    /// <p>This parameter is optional. If it is not included, all policies are returned.</p>
    pub fn get_policy_usage_filter(&self) -> &::std::option::Option<super::super::super::types::PolicyUsageType> {
