...
impl CreateLoginProfileInput {
    ...
    pub fn builder() -> super::super::super::operation::create_login_profile::builders::CreateLoginProfileInputBuilder {
        super::super::super::operation::create_login_profile::builders::CreateLoginProfileInputBuilder::default()
    }
}
