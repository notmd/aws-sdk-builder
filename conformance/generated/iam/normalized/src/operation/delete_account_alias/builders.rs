...
pub use super::super::super::operation::delete_account_alias::_delete_account_alias_input::DeleteAccountAliasInputBuilder;

pub use super::super::super::operation::delete_account_alias::_delete_account_alias_output::DeleteAccountAliasOutputBuilder;

impl super::super::super::operation::delete_account_alias::builders::DeleteAccountAliasInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_account_alias::DeleteAccountAliasOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_account_alias::DeleteAccountAliasError,
...
pub struct DeleteAccountAliasFluentBuilder {
    ...
    inner: super::super::super::operation::delete_account_alias::builders::DeleteAccountAliasInputBuilder,
...
impl DeleteAccountAliasFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_account_alias::builders::DeleteAccountAliasInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_account_alias::DeleteAccountAlias::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_account_alias::DeleteAccountAlias::orchestrate(&runtime_plugins, input).await
    }
