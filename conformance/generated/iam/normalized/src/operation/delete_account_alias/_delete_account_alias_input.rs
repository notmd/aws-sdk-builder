...
impl DeleteAccountAliasInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_account_alias::builders::DeleteAccountAliasInputBuilder {
        super::super::super::operation::delete_account_alias::builders::DeleteAccountAliasInputBuilder::default()
    }
}
