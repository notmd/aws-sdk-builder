...
impl CreateServiceSpecificCredentialOutput {
    ...
    /// <p>This is the only time that the password for this credential set is available. It cannot be recovered later. Instead, you must reset the password with <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_ResetServiceSpecificCredential.html">ResetServiceSpecificCredential</a>.</p>
    /// </important>
    pub fn service_specific_credential(&self) -> ::std::option::Option<&super::super::super::types::ServiceSpecificCredential> {
...
impl CreateServiceSpecificCredentialOutput {
    ...
    pub fn builder() -> super::super::super::operation::create_service_specific_credential::builders::CreateServiceSpecificCredentialOutputBuilder {
        super::super::super::operation::create_service_specific_credential::builders::CreateServiceSpecificCredentialOutputBuilder::default()
    }
}
...
pub struct CreateServiceSpecificCredentialOutputBuilder {
    pub(crate) service_specific_credential: ::std::option::Option<super::super::super::types::ServiceSpecificCredential>,
    _request_id: Option<String>,
}
impl CreateServiceSpecificCredentialOutputBuilder {
    ...
    /// <p>This is the only time that the password for this credential set is available. It cannot be recovered later. Instead, you must reset the password with <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_ResetServiceSpecificCredential.html">ResetServiceSpecificCredential</a>.</p>
    /// </important>
    pub fn service_specific_credential(mut self, input: super::super::super::types::ServiceSpecificCredential) -> Self {
    ...
    /// <p>This is the only time that the password for this credential set is available. It cannot be recovered later. Instead, you must reset the password with <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_ResetServiceSpecificCredential.html">ResetServiceSpecificCredential</a>.</p>
    /// </important>
    pub fn set_service_specific_credential(mut self, input: ::std::option::Option<super::super::super::types::ServiceSpecificCredential>) -> Self {
    ...
    /// <p>This is the only time that the password for this credential set is available. It cannot be recovered later. Instead, you must reset the password with <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_ResetServiceSpecificCredential.html">ResetServiceSpecificCredential</a>.</p>
    /// </important>
    pub fn get_service_specific_credential(&self) -> &::std::option::Option<super::super::super::types::ServiceSpecificCredential> {
    ...
    pub fn build(self) -> super::super::super::operation::create_service_specific_credential::CreateServiceSpecificCredentialOutput {
        super::super::super::operation::create_service_specific_credential::CreateServiceSpecificCredentialOutput {
