...
impl AddRoleToInstanceProfile {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::add_role_to_instance_profile::AddRoleToInstanceProfileInput,
    ) -> ::std::result::Result<
        super::super::operation::add_role_to_instance_profile::AddRoleToInstanceProfileOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::add_role_to_instance_profile::AddRoleToInstanceProfileError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::add_role_to_instance_profile::AddRoleToInstanceProfileError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::add_role_to_instance_profile::AddRoleToInstanceProfileOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AddRoleToInstanceProfileResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_add_role_to_instance_profile::de_add_role_to_instance_profile_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_add_role_to_instance_profile::de_add_role_to_instance_profile_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AddRoleToInstanceProfileRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::add_role_to_instance_profile::AddRoleToInstanceProfileInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::add_role_to_instance_profile::AddRoleToInstanceProfileInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::add_role_to_instance_profile::AddRoleToInstanceProfileError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::add_role_to_instance_profile::_add_role_to_instance_profile_input::AddRoleToInstanceProfileInput;

pub use super::super::operation::add_role_to_instance_profile::_add_role_to_instance_profile_output::AddRoleToInstanceProfileOutput;
