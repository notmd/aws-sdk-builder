...
impl GetAccountSummaryInput {
    ...
    pub fn builder() -> super::super::super::operation::get_account_summary::builders::GetAccountSummaryInputBuilder {
        super::super::super::operation::get_account_summary::builders::GetAccountSummaryInputBuilder::default()
    }
}
