...
pub struct GetAccountSummaryOutput {
    ...
    pub summary_map: ::std::option::Option<::std::collections::HashMap<super::super::super::types::SummaryKeyType, i32>>,
    _request_id: Option<String>,
}
impl GetAccountSummaryOutput {
    /// <p>A set of key–value pairs containing information about IAM entity usage and IAM quotas.</p>
    pub fn summary_map(&self) -> ::std::option::Option<&::std::collections::HashMap<super::super::super::types::SummaryKeyType, i32>> {
...
impl GetAccountSummaryOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_account_summary::builders::GetAccountSummaryOutputBuilder {
        super::super::super::operation::get_account_summary::builders::GetAccountSummaryOutputBuilder::default()
    }
}
...
pub struct GetAccountSummaryOutputBuilder {
    pub(crate) summary_map: ::std::option::Option<::std::collections::HashMap<super::super::super::types::SummaryKeyType, i32>>,
    _request_id: Option<String>,
}
impl GetAccountSummaryOutputBuilder {
    ...
    ///
    /// <p>A set of key–value pairs containing information about IAM entity usage and IAM quotas.</p>
    pub fn summary_map(mut self, k: super::super::super::types::SummaryKeyType, v: i32) -> Self {
    ...
    /// <p>A set of key–value pairs containing information about IAM entity usage and IAM quotas.</p>
    pub fn get_summary_map(&self) -> &::std::option::Option<::std::collections::HashMap<super::super::super::types::SummaryKeyType, i32>> {
        &self.summary_map
    }
    ...
    pub fn build(self) -> super::super::super::operation::get_account_summary::GetAccountSummaryOutput {
