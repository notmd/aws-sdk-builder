...
impl UpdateRoleInput {
    ...
    pub fn builder() -> super::super::super::operation::update_role::builders::UpdateRoleInputBuilder {
        super::super::super::operation::update_role::builders::UpdateRoleInputBuilder::default()
    }
}
