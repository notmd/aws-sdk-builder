...
impl PutRolePermissionsBoundaryOutput {
    ...
    pub fn builder() -> super::super::super::operation::put_role_permissions_boundary::builders::PutRolePermissionsBoundaryOutputBuilder {
        super::super::super::operation::put_role_permissions_boundary::builders::PutRolePermissionsBoundaryOutputBuilder::default()
    }
}
...
impl PutRolePermissionsBoundaryOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::put_role_permissions_boundary::PutRolePermissionsBoundaryOutput {
