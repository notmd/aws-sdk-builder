...
impl PutRolePermissionsBoundaryInput {
    ...
    pub fn builder() -> super::super::super::operation::put_role_permissions_boundary::builders::PutRolePermissionsBoundaryInputBuilder {
        super::super::super::operation::put_role_permissions_boundary::builders::PutRolePermissionsBoundaryInputBuilder::default()
    }
}
