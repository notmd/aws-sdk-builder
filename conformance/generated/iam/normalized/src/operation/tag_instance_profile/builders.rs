...
pub use super::super::super::operation::tag_instance_profile::_tag_instance_profile_input::TagInstanceProfileInputBuilder;

pub use super::super::super::operation::tag_instance_profile::_tag_instance_profile_output::TagInstanceProfileOutputBuilder;

impl super::super::super::operation::tag_instance_profile::builders::TagInstanceProfileInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::tag_instance_profile::TagInstanceProfileOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::tag_instance_profile::TagInstanceProfileError,
...
pub struct TagInstanceProfileFluentBuilder {
    ...
    inner: super::super::super::operation::tag_instance_profile::builders::TagInstanceProfileInputBuilder,
...
impl TagInstanceProfileFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::tag_instance_profile::builders::TagInstanceProfileInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::tag_instance_profile::TagInstanceProfile::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::tag_instance_profile::TagInstanceProfile::orchestrate(&runtime_plugins, input).await
    }
