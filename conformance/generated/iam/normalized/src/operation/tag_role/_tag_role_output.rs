...
impl TagRoleOutput {
    ...
    pub fn builder() -> super::super::super::operation::tag_role::builders::TagRoleOutputBuilder {
        super::super::super::operation::tag_role::builders::TagRoleOutputBuilder::default()
    }
}
...
impl TagRoleOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::tag_role::TagRoleOutput {
