...
impl TagRoleInput {
    ...
    pub fn builder() -> super::super::super::operation::tag_role::builders::TagRoleInputBuilder {
        super::super::super::operation::tag_role::builders::TagRoleInputBuilder::default()
    }
}
