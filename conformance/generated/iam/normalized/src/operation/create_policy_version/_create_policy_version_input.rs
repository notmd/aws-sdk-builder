...
impl CreatePolicyVersionInput {
    ...
    pub fn builder() -> super::super::super::operation::create_policy_version::builders::CreatePolicyVersionInputBuilder {
        super::super::super::operation::create_policy_version::builders::CreatePolicyVersionInputBuilder::default()
    }
}
