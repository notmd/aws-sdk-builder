...
impl ListMfaDevicesInput {
    ...
    pub fn builder() -> super::super::super::operation::list_mfa_devices::builders::ListMfaDevicesInputBuilder {
        super::super::super::operation::list_mfa_devices::builders::ListMfaDevicesInputBuilder::default()
    }
}
