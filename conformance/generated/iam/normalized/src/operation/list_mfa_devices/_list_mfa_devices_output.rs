...
pub struct ListMfaDevicesOutput {
    ...
    pub mfa_devices: ::std::vec::Vec<super::super::super::types::MfaDevice>,
...
impl ListMfaDevicesOutput {
    /// <p>A list of MFA devices.</p>
    pub fn mfa_devices(&self) -> &[super::super::super::types::MfaDevice] {
        use std::ops::Deref;
...
impl ListMfaDevicesOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_mfa_devices::builders::ListMfaDevicesOutputBuilder {
        super::super::super::operation::list_mfa_devices::builders::ListMfaDevicesOutputBuilder::default()
    }
}
...
pub struct ListMfaDevicesOutputBuilder {
    pub(crate) mfa_devices: ::std::option::Option<::std::vec::Vec<super::super::super::types::MfaDevice>>,
...
impl ListMfaDevicesOutputBuilder {
    ...
    ///
    /// <p>A list of MFA devices.</p>
    pub fn mfa_devices(mut self, input: super::super::super::types::MfaDevice) -> Self {
    ...
    /// <p>A list of MFA devices.</p>
    pub fn set_mfa_devices(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::MfaDevice>>) -> Self {
        self.mfa_devices = input;
        self
    }
    /// <p>A list of MFA devices.</p>
    pub fn get_mfa_devices(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::MfaDevice>> {
        &self.mfa_devices
    }
    /// <p>A flag that indicates whether there are more items to return. If your results were truncated, you can make a subsequent pagination request using the <code>Marker</code> request parameter to retrieve more items. Note that IAM might return fewer than the <code>MaxItems</code> number of results even when there are more results available. We recommend that you check <code>IsTruncated</code> after every call to ensure that you receive all your results.</p>
