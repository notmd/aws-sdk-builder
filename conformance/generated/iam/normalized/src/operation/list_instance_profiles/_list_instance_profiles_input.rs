...
impl ListInstanceProfilesInput {
    ...
    pub fn builder() -> super::super::super::operation::list_instance_profiles::builders::ListInstanceProfilesInputBuilder {
        super::super::super::operation::list_instance_profiles::builders::ListInstanceProfilesInputBuilder::default()
    }
}
