...
pub struct ListInstanceProfilesPaginator {
    ...
    builder: super::super::super::operation::list_instance_profiles::builders::ListInstanceProfilesInputBuilder,
...
impl ListInstanceProfilesPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::list_instance_profiles::paginator::ListInstanceProfilesPaginatorItems {
        super::super::super::operation::list_instance_profiles::paginator::ListInstanceProfilesPaginatorItems(self)
    }
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_instance_profiles_output_output_marker(resp);
...
impl ListInstanceProfilesPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_list_instance_profiles_output_output_instance_profiles(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
