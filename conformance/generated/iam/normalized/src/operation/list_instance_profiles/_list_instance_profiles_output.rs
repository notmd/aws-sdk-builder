...
impl ListInstanceProfilesOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_instance_profiles::builders::ListInstanceProfilesOutputBuilder {
        super::super::super::operation::list_instance_profiles::builders::ListInstanceProfilesOutputBuilder::default()
    }
}
