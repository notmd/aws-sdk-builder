...
impl UpdateGroupInput {
    ...
    pub fn builder() -> super::super::super::operation::update_group::builders::UpdateGroupInputBuilder {
        super::super::super::operation::update_group::builders::UpdateGroupInputBuilder::default()
    }
}
