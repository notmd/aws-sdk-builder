...
pub struct ListUserTagsPaginator {
    ...
    builder: super::super::super::operation::list_user_tags::builders::ListUserTagsInputBuilder,
...
impl ListUserTagsPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::list_user_tags::paginator::ListUserTagsPaginatorItems {
        super::super::super::operation::list_user_tags::paginator::ListUserTagsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::super::super::operation::list_user_tags::ListUserTags::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_user_tags_output_output_marker(resp);
