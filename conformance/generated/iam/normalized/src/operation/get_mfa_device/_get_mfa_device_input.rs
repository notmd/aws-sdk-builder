...
impl GetMfaDeviceInput {
    ...
    pub fn builder() -> super::super::super::operation::get_mfa_device::builders::GetMfaDeviceInputBuilder {
        super::super::super::operation::get_mfa_device::builders::GetMfaDeviceInputBuilder::default()
    }
}
