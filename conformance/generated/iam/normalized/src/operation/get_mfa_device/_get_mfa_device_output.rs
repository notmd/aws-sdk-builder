...
impl GetMfaDeviceOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_mfa_device::builders::GetMfaDeviceOutputBuilder {
        super::super::super::operation::get_mfa_device::builders::GetMfaDeviceOutputBuilder::default()
    }
}
