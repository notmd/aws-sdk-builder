...
impl DeleteAccessKeyInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_access_key::builders::DeleteAccessKeyInputBuilder {
        super::super::super::operation::delete_access_key::builders::DeleteAccessKeyInputBuilder::default()
    }
}
