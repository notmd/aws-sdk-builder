...
pub use super::super::super::operation::delete_access_key::_delete_access_key_input::DeleteAccessKeyInputBuilder;

pub use super::super::super::operation::delete_access_key::_delete_access_key_output::DeleteAccessKeyOutputBuilder;

impl super::super::super::operation::delete_access_key::builders::DeleteAccessKeyInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_access_key::DeleteAccessKeyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_access_key::DeleteAccessKeyError,
...
pub struct DeleteAccessKeyFluentBuilder {
    ...
    inner: super::super::super::operation::delete_access_key::builders::DeleteAccessKeyInputBuilder,
...
impl DeleteAccessKeyFluentBuilder {
    /// Creates a new `DeleteAccessKeyFluentBuilder`.
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_access_key::builders::DeleteAccessKeyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_access_key::DeleteAccessKey::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_access_key::DeleteAccessKey::orchestrate(&runtime_plugins, input).await
    }
