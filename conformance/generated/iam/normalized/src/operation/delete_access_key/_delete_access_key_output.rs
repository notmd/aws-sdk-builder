...
impl DeleteAccessKeyOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_access_key::builders::DeleteAccessKeyOutputBuilder {
        super::super::super::operation::delete_access_key::builders::DeleteAccessKeyOutputBuilder::default()
    }
}
...
impl DeleteAccessKeyOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_access_key::DeleteAccessKeyOutput {
