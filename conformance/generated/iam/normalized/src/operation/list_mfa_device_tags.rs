...
impl ListMfaDeviceTags {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::list_mfa_device_tags::ListMfaDeviceTagsInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::list_mfa_device_tags::ListMFADeviceTagsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::list_mfa_device_tags::ListMfaDeviceTagsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "ListMFADeviceTags", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListMFADeviceTagsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_list_mfa_device_tags::de_list_mfa_device_tags_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_list_mfa_device_tags::de_list_mfa_device_tags_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListMFADeviceTagsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::list_mfa_device_tags::ListMfaDeviceTagsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::list_mfa_device_tags::ListMfaDeviceTagsInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::list_mfa_device_tags::ListMFADeviceTagsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::list_mfa_device_tags::_list_mfa_device_tags_input::ListMfaDeviceTagsInput;

pub use super::super::operation::list_mfa_device_tags::_list_mfa_device_tags_output::ListMfaDeviceTagsOutput;
