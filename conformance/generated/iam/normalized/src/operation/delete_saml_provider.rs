...
impl DeleteSAMLProvider {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::delete_saml_provider::DeleteSamlProviderInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::delete_saml_provider::DeleteSAMLProviderError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::delete_saml_provider::DeleteSamlProviderOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "DeleteSAMLProvider", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteSAMLProviderResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_delete_saml_provider::de_delete_saml_provider_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_delete_saml_provider::de_delete_saml_provider_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteSAMLProviderRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::delete_saml_provider::DeleteSamlProviderInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::delete_saml_provider::DeleteSamlProviderInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::delete_saml_provider::DeleteSAMLProviderError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::delete_saml_provider::_delete_saml_provider_input::DeleteSamlProviderInput;

pub use super::super::operation::delete_saml_provider::_delete_saml_provider_output::DeleteSamlProviderOutput;
