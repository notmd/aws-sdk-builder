...
pub use super::super::super::operation::update_login_profile::_update_login_profile_input::UpdateLoginProfileInputBuilder;

pub use super::super::super::operation::update_login_profile::_update_login_profile_output::UpdateLoginProfileOutputBuilder;

impl super::super::super::operation::update_login_profile::builders::UpdateLoginProfileInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::update_login_profile::UpdateLoginProfileOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::update_login_profile::UpdateLoginProfileError,
...
pub struct UpdateLoginProfileFluentBuilder {
    ...
    inner: super::super::super::operation::update_login_profile::builders::UpdateLoginProfileInputBuilder,
...
impl UpdateLoginProfileFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::update_login_profile::builders::UpdateLoginProfileInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::update_login_profile::UpdateLoginProfile::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::update_login_profile::UpdateLoginProfile::orchestrate(&runtime_plugins, input).await
    }
