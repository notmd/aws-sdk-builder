...
impl UpdateLoginProfileOutput {
    ...
    pub fn builder() -> super::super::super::operation::update_login_profile::builders::UpdateLoginProfileOutputBuilder {
        super::super::super::operation::update_login_profile::builders::UpdateLoginProfileOutputBuilder::default()
    }
}
...
impl UpdateLoginProfileOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::update_login_profile::UpdateLoginProfileOutput {
