...
impl UpdateLoginProfileInput {
    ...
    pub fn builder() -> super::super::super::operation::update_login_profile::builders::UpdateLoginProfileInputBuilder {
        super::super::super::operation::update_login_profile::builders::UpdateLoginProfileInputBuilder::default()
    }
}
