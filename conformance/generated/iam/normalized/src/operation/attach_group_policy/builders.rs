...
pub use super::super::super::operation::attach_group_policy::_attach_group_policy_input::AttachGroupPolicyInputBuilder;

pub use super::super::super::operation::attach_group_policy::_attach_group_policy_output::AttachGroupPolicyOutputBuilder;

impl super::super::super::operation::attach_group_policy::builders::AttachGroupPolicyInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::attach_group_policy::AttachGroupPolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::attach_group_policy::AttachGroupPolicyError,
...
pub struct AttachGroupPolicyFluentBuilder {
    handle: ::std::sync::Arc<super::super::super::client::Handle>,
    inner: super::super::super::operation::attach_group_policy::builders::AttachGroupPolicyInputBuilder,
...
impl
    super::super::super::client::customize::internal::CustomizableSend<
        super::super::super::operation::attach_group_policy::AttachGroupPolicyOutput,
        super::super::super::operation::attach_group_policy::AttachGroupPolicyError,
    > for AttachGroupPolicyFluentBuilder
{
    fn send(
        self,
...
impl AttachGroupPolicyFluentBuilder {
    /// Creates a new `AttachGroupPolicyFluentBuilder`.
    ...
    /// Access the AttachGroupPolicy as a reference.
    pub fn as_input(&self) -> &super::super::super::operation::attach_group_policy::builders::AttachGroupPolicyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::attach_group_policy::AttachGroupPolicy::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::attach_group_policy::AttachGroupPolicy::orchestrate(&runtime_plugins, input).await
    }
