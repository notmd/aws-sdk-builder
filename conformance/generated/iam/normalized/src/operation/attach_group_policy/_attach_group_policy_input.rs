...
impl AttachGroupPolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::attach_group_policy::builders::AttachGroupPolicyInputBuilder {
        super::super::super::operation::attach_group_policy::builders::AttachGroupPolicyInputBuilder::default()
    }
}
