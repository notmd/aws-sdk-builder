...
impl ListRoleTagsOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_role_tags::builders::ListRoleTagsOutputBuilder {
        super::super::super::operation::list_role_tags::builders::ListRoleTagsOutputBuilder::default()
    }
}
