...
impl ListRoleTagsInput {
    ...
    pub fn builder() -> super::super::super::operation::list_role_tags::builders::ListRoleTagsInputBuilder {
        super::super::super::operation::list_role_tags::builders::ListRoleTagsInputBuilder::default()
    }
}
...
impl ListRoleTagsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::list_role_tags::ListRoleTagsInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::list_role_tags::ListRoleTagsInput {
