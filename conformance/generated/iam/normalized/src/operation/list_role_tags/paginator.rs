...
pub struct ListRoleTagsPaginator {
    ...
    builder: super::super::super::operation::list_role_tags::builders::ListRoleTagsInputBuilder,
...
impl ListRoleTagsPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::list_role_tags::paginator::ListRoleTagsPaginatorItems {
        super::super::super::operation::list_role_tags::paginator::ListRoleTagsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::super::super::operation::list_role_tags::ListRoleTags::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_role_tags_output_output_marker(resp);
