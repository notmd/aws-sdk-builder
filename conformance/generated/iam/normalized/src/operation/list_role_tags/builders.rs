...
pub use super::super::super::operation::list_role_tags::_list_role_tags_input::ListRoleTagsInputBuilder;

pub use super::super::super::operation::list_role_tags::_list_role_tags_output::ListRoleTagsOutputBuilder;

impl super::super::super::operation::list_role_tags::builders::ListRoleTagsInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::list_role_tags::ListRoleTagsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::list_role_tags::ListRoleTagsError,
            ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
        >,
    > {
        let mut fluent_builder = client.list_role_tags();
...
pub struct ListRoleTagsFluentBuilder {
    ...
    inner: super::super::super::operation::list_role_tags::builders::ListRoleTagsInputBuilder,
...
impl ListRoleTagsFluentBuilder {
    ...
    /// Access the ListRoleTags as a reference.
    pub fn as_input(&self) -> &super::super::super::operation::list_role_tags::builders::ListRoleTagsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::list_role_tags::ListRoleTags::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::list_role_tags::ListRoleTags::orchestrate(&runtime_plugins, input).await
    }
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_role_tags::paginator::ListRoleTagsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
    pub fn into_paginator(self) -> super::super::super::operation::list_role_tags::paginator::ListRoleTagsPaginator {
        super::super::super::operation::list_role_tags::paginator::ListRoleTagsPaginator::new(self.handle, self.inner)
    }
