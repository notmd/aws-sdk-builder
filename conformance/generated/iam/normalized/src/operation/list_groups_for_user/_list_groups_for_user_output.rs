...
pub struct ListGroupsForUserOutput {
    ...
    pub groups: ::std::vec::Vec<super::super::super::types::Group>,
...
impl ListGroupsForUserOutput {
    /// <p>A list of groups.</p>
    pub fn groups(&self) -> &[super::super::super::types::Group] {
        use std::ops::Deref;
        self.groups.deref()
    }
    /// <p>A flag that indicates whether there are more items to return. If your results were truncated, you can make a subsequent pagination request using the <code>Marker</code> request parameter to retrieve more items. Note that IAM might return fewer than the <code>MaxItems</code> number of results even when there are more results available. We recommend that you check <code>IsTruncated</code> after every call to ensure that you receive all your results.</p>
...
impl ListGroupsForUserOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_groups_for_user::builders::ListGroupsForUserOutputBuilder {
        super::super::super::operation::list_groups_for_user::builders::ListGroupsForUserOutputBuilder::default()
    }
}
...
pub struct ListGroupsForUserOutputBuilder {
    pub(crate) groups: ::std::option::Option<::std::vec::Vec<super::super::super::types::Group>>,
...
impl ListGroupsForUserOutputBuilder {
    ...
    ///
    /// <p>A list of groups.</p>
    pub fn groups(mut self, input: super::super::super::types::Group) -> Self {
    ...
    /// <p>A list of groups.</p>
    pub fn set_groups(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::Group>>) -> Self {
        self.groups = input;
        self
    }
    /// <p>A list of groups.</p>
    pub fn get_groups(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::Group>> {
        &self.groups
    }
    /// <p>A flag that indicates whether there are more items to return. If your results were truncated, you can make a subsequent pagination request using the <code>Marker</code> request parameter to retrieve more items. Note that IAM might return fewer than the <code>MaxItems</code> number of results even when there are more results available. We recommend that you check <code>IsTruncated</code> after every call to ensure that you receive all your results.</p>
