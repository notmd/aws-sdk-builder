...
pub struct ListGroupsForUserPaginator {
    ...
    builder: super::super::super::operation::list_groups_for_user::builders::ListGroupsForUserInputBuilder,
...
impl ListGroupsForUserPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::list_groups_for_user::paginator::ListGroupsForUserPaginatorItems {
        super::super::super::operation::list_groups_for_user::paginator::ListGroupsForUserPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::super::super::operation::list_groups_for_user::ListGroupsForUser::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_groups_for_user_output_output_marker(resp);
...
impl ListGroupsForUserPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_list_groups_for_user_output_output_groups(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
