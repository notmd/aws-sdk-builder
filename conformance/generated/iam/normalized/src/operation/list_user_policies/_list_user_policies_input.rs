...
impl ListUserPoliciesInput {
    ...
    pub fn builder() -> super::super::super::operation::list_user_policies::builders::ListUserPoliciesInputBuilder {
        super::super::super::operation::list_user_policies::builders::ListUserPoliciesInputBuilder::default()
    }
}
