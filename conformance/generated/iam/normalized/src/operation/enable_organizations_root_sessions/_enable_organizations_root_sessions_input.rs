...
impl EnableOrganizationsRootSessionsInput {
    ...
    pub fn builder() -> super::super::super::operation::enable_organizations_root_sessions::builders::EnableOrganizationsRootSessionsInputBuilder {
        super::super::super::operation::enable_organizations_root_sessions::builders::EnableOrganizationsRootSessionsInputBuilder::default()
    }
}
...
impl EnableOrganizationsRootSessionsInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::enable_organizations_root_sessions::EnableOrganizationsRootSessionsInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::enable_organizations_root_sessions::EnableOrganizationsRootSessionsInput {})
    }
}
