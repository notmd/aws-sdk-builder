...
pub use super::super::super::operation::enable_organizations_root_sessions::_enable_organizations_root_sessions_input::EnableOrganizationsRootSessionsInputBuilder;

pub use super::super::super::operation::enable_organizations_root_sessions::_enable_organizations_root_sessions_output::EnableOrganizationsRootSessionsOutputBuilder;

impl super::super::super::operation::enable_organizations_root_sessions::builders::EnableOrganizationsRootSessionsInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::enable_organizations_root_sessions::EnableOrganizationsRootSessionsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::enable_organizations_root_sessions::EnableOrganizationsRootSessionsError,
...
pub struct EnableOrganizationsRootSessionsFluentBuilder {
    ...
    inner: super::super::super::operation::enable_organizations_root_sessions::builders::EnableOrganizationsRootSessionsInputBuilder,
