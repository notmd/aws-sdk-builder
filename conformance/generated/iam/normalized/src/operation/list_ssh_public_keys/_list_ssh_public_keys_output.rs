...
impl ListSshPublicKeysOutput {
    ...
    pub fn ssh_public_keys(&self) -> &[super::super::super::types::SshPublicKeyMetadata] {
...
impl ListSshPublicKeysOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_ssh_public_keys::builders::ListSshPublicKeysOutputBuilder {
        super::super::super::operation::list_ssh_public_keys::builders::ListSshPublicKeysOutputBuilder::default()
    }
}
...
pub struct ListSshPublicKeysOutputBuilder {
    pub(crate) ssh_public_keys: ::std::option::Option<::std::vec::Vec<super::super::super::types::SshPublicKeyMetadata>>,
...
impl ListSshPublicKeysOutputBuilder {
    ...
    ///
    /// <p>A list of the SSH public keys assigned to IAM user.</p>
    pub fn ssh_public_keys(mut self, input: super::super::super::types::SshPublicKeyMetadata) -> Self {
    ...
    /// <p>A list of the SSH public keys assigned to IAM user.</p>
    pub fn set_ssh_public_keys(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::SshPublicKeyMetadata>>) -> Self {
        self.ssh_public_keys = input;
        self
    }
    /// <p>A list of the SSH public keys assigned to IAM user.</p>
    pub fn get_ssh_public_keys(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::SshPublicKeyMetadata>> {
    ...
    pub fn build(self) -> super::super::super::operation::list_ssh_public_keys::ListSshPublicKeysOutput {
