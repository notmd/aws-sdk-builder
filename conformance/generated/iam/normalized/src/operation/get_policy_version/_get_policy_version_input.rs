...
impl GetPolicyVersionInput {
    ...
    pub fn builder() -> super::super::super::operation::get_policy_version::builders::GetPolicyVersionInputBuilder {
        super::super::super::operation::get_policy_version::builders::GetPolicyVersionInputBuilder::default()
    }
}
