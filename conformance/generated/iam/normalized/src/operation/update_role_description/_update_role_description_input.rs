...
impl UpdateRoleDescriptionInput {
    ...
    pub fn builder() -> super::super::super::operation::update_role_description::builders::UpdateRoleDescriptionInputBuilder {
        super::super::super::operation::update_role_description::builders::UpdateRoleDescriptionInputBuilder::default()
    }
}
