...
impl DeleteSamlProviderInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_saml_provider::builders::DeleteSamlProviderInputBuilder {
        super::super::super::operation::delete_saml_provider::builders::DeleteSamlProviderInputBuilder::default()
    }
}
