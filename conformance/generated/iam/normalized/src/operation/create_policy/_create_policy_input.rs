...
impl CreatePolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::create_policy::builders::CreatePolicyInputBuilder {
        super::super::super::operation::create_policy::builders::CreatePolicyInputBuilder::default()
    }
}
