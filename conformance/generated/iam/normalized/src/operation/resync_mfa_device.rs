...
impl ResyncMfaDevice {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::resync_mfa_device::ResyncMfaDeviceInput,
    ) -> ::std::result::Result<
        super::super::operation::resync_mfa_device::ResyncMfaDeviceOutput,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::resync_mfa_device::ResyncMFADeviceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::resync_mfa_device::ResyncMfaDeviceOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ResyncMFADeviceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_resync_mfa_device::de_resync_mfa_device_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_resync_mfa_device::de_resync_mfa_device_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ResyncMFADeviceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::resync_mfa_device::ResyncMfaDeviceInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::resync_mfa_device::ResyncMfaDeviceInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::resync_mfa_device::ResyncMFADeviceError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::resync_mfa_device::_resync_mfa_device_input::ResyncMfaDeviceInput;

pub use super::super::operation::resync_mfa_device::_resync_mfa_device_output::ResyncMfaDeviceOutput;
