...
pub struct ListInstanceProfileTagsPaginator {
    ...
    builder: super::super::super::operation::list_instance_profile_tags::builders::ListInstanceProfileTagsInputBuilder,
...
impl ListInstanceProfileTagsPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::list_instance_profile_tags::paginator::ListInstanceProfileTagsPaginatorItems {
        super::super::super::operation::list_instance_profile_tags::paginator::ListInstanceProfileTagsPaginatorItems(self)
    }
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_instance_profile_tags_output_output_marker(resp);
...
impl ListInstanceProfileTagsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_list_instance_profile_tags_output_output_tags(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
