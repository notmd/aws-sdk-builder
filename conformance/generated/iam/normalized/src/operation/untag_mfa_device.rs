...
impl UntagMfaDevice {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::untag_mfa_device::UntagMfaDeviceInput,
    ) -> ::std::result::Result<
        super::super::operation::untag_mfa_device::UntagMfaDeviceOutput,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::untag_mfa_device::UntagMFADeviceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::untag_mfa_device::UntagMfaDeviceOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "UntagMFADevice", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UntagMFADeviceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_untag_mfa_device::de_untag_mfa_device_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_untag_mfa_device::de_untag_mfa_device_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UntagMFADeviceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::untag_mfa_device::UntagMfaDeviceInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::untag_mfa_device::UntagMfaDeviceInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::untag_mfa_device::UntagMFADeviceError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::untag_mfa_device::_untag_mfa_device_input::UntagMfaDeviceInput;

pub use super::super::operation::untag_mfa_device::_untag_mfa_device_output::UntagMfaDeviceOutput;
