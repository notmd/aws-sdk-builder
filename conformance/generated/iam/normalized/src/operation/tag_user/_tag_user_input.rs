...
impl TagUserInput {
    ...
    pub fn builder() -> super::super::super::operation::tag_user::builders::TagUserInputBuilder {
        super::super::super::operation::tag_user::builders::TagUserInputBuilder::default()
    }
}
