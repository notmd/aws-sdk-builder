...
impl UpdateSamlProviderInput {
    ...
    pub fn builder() -> super::super::super::operation::update_saml_provider::builders::UpdateSamlProviderInputBuilder {
        super::super::super::operation::update_saml_provider::builders::UpdateSamlProviderInputBuilder::default()
    }
}
