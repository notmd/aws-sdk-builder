...
impl UpdateSamlProviderOutput {
    ...
    pub fn builder() -> super::super::super::operation::update_saml_provider::builders::UpdateSamlProviderOutputBuilder {
        super::super::super::operation::update_saml_provider::builders::UpdateSamlProviderOutputBuilder::default()
    }
}
...
impl UpdateSamlProviderOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::update_saml_provider::UpdateSamlProviderOutput {
