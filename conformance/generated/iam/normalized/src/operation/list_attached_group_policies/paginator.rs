...
pub struct ListAttachedGroupPoliciesPaginator {
    ...
    builder: super::super::super::operation::list_attached_group_policies::builders::ListAttachedGroupPoliciesInputBuilder,
...
impl ListAttachedGroupPoliciesPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::list_attached_group_policies::paginator::ListAttachedGroupPoliciesPaginatorItems {
        super::super::super::operation::list_attached_group_policies::paginator::ListAttachedGroupPoliciesPaginatorItems(self)
    }
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_attached_group_policies_output_output_marker(resp);
...
impl ListAttachedGroupPoliciesPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::AttachedPolicy,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::list_attached_group_policies::ListAttachedGroupPoliciesError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_list_attached_group_policies_output_output_attached_policies(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
