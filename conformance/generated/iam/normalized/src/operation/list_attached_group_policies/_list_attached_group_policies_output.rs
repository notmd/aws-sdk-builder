...
impl ListAttachedGroupPoliciesOutput {
    ...
    pub fn attached_policies(&self) -> &[super::super::super::types::AttachedPolicy] {
...
impl ListAttachedGroupPoliciesOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_attached_group_policies::builders::ListAttachedGroupPoliciesOutputBuilder {
        super::super::super::operation::list_attached_group_policies::builders::ListAttachedGroupPoliciesOutputBuilder::default()
    }
}
...
pub struct ListAttachedGroupPoliciesOutputBuilder {
    pub(crate) attached_policies: ::std::option::Option<::std::vec::Vec<super::super::super::types::AttachedPolicy>>,
...
impl ListAttachedGroupPoliciesOutputBuilder {
    ...
    ///
    /// <p>A list of the attached policies.</p>
    pub fn attached_policies(mut self, input: super::super::super::types::AttachedPolicy) -> Self {
    ...
    /// <p>A list of the attached policies.</p>
    pub fn set_attached_policies(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::AttachedPolicy>>) -> Self {
        self.attached_policies = input;
        self
    }
    /// <p>A list of the attached policies.</p>
    pub fn get_attached_policies(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::AttachedPolicy>> {
    ...
    pub fn build(self) -> super::super::super::operation::list_attached_group_policies::ListAttachedGroupPoliciesOutput {
