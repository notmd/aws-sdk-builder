...
impl ListAttachedGroupPoliciesInput {
    ...
    pub fn builder() -> super::super::super::operation::list_attached_group_policies::builders::ListAttachedGroupPoliciesInputBuilder {
        super::super::super::operation::list_attached_group_policies::builders::ListAttachedGroupPoliciesInputBuilder::default()
    }
}
