...
impl GetOpenIdConnectProviderInput {
    ...
    pub fn builder() -> super::super::super::operation::get_open_id_connect_provider::builders::GetOpenIdConnectProviderInputBuilder {
        super::super::super::operation::get_open_id_connect_provider::builders::GetOpenIdConnectProviderInputBuilder::default()
    }
}
