...
impl GetUserPolicyOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_user_policy::builders::GetUserPolicyOutputBuilder {
        super::super::super::operation::get_user_policy::builders::GetUserPolicyOutputBuilder::default()
    }
}
