...
impl GetUserPolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::get_user_policy::builders::GetUserPolicyInputBuilder {
        super::super::super::operation::get_user_policy::builders::GetUserPolicyInputBuilder::default()
    }
}
