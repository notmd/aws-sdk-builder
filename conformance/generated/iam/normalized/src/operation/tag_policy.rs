...
impl TagPolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::tag_policy::TagPolicyInput,
    ) -> ::std::result::Result<
        super::super::operation::tag_policy::TagPolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::tag_policy::TagPolicyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::tag_policy::TagPolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::tag_policy::TagPolicyOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "TagPolicy", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for TagPolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_tag_policy::de_tag_policy_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_tag_policy::de_tag_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for TagPolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::tag_policy::TagPolicyInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::tag_policy::TagPolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::tag_policy::_tag_policy_input::TagPolicyInput;

pub use super::super::operation::tag_policy::_tag_policy_output::TagPolicyOutput;
