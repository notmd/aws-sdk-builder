...
impl RemoveUserFromGroupInput {
    ...
    pub fn builder() -> super::super::super::operation::remove_user_from_group::builders::RemoveUserFromGroupInputBuilder {
        super::super::super::operation::remove_user_from_group::builders::RemoveUserFromGroupInputBuilder::default()
    }
}
