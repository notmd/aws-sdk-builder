...
impl RemoveUserFromGroupOutput {
    ...
    pub fn builder() -> super::super::super::operation::remove_user_from_group::builders::RemoveUserFromGroupOutputBuilder {
        super::super::super::operation::remove_user_from_group::builders::RemoveUserFromGroupOutputBuilder::default()
    }
}
...
impl RemoveUserFromGroupOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::remove_user_from_group::RemoveUserFromGroupOutput {
