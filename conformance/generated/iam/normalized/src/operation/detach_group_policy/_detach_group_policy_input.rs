...
impl DetachGroupPolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::detach_group_policy::builders::DetachGroupPolicyInputBuilder {
        super::super::super::operation::detach_group_policy::builders::DetachGroupPolicyInputBuilder::default()
    }
}
