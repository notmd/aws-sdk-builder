...
impl SimulatePrincipalPolicyInput {
    ...
    pub fn policy_exclusion_list(&self) -> &[super::super::super::types::PolicyIdentifier] {
    ...
    pub fn context_entries(&self) -> &[super::super::super::types::ContextEntry] {
...
impl SimulatePrincipalPolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::simulate_principal_policy::builders::SimulatePrincipalPolicyInputBuilder {
        super::super::super::operation::simulate_principal_policy::builders::SimulatePrincipalPolicyInputBuilder::default()
    }
}
...
pub struct SimulatePrincipalPolicyInputBuilder {
    ...
    pub(crate) policy_exclusion_list: ::std::option::Option<::std::vec::Vec<super::super::super::types::PolicyIdentifier>>,
    ...
    pub(crate) context_entries: ::std::option::Option<::std::vec::Vec<super::super::super::types::ContextEntry>>,
...
impl SimulatePrincipalPolicyInputBuilder {
    ...
    pub fn set_policy_exclusion_list(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::PolicyIdentifier>>) -> Self {
        self.policy_exclusion_list = input;
        self
    }
    /// <p>A list of policies to exclude from the simulation. Use this parameter to test what the simulation result would be if a policy were removed, without changing which policies are actually attached to the principal identified by <code>PolicySourceArn</code>.</p>
    /// <p>Each entry is a <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_PolicyIdentifier.html">PolicyIdentifier</a> that identifies one or more policies to exclude by policy type, by Amazon Resource Name (ARN), or by the name of an inline policy and the entity it is attached to.</p>
    ...
    pub fn build(
        ...
        super::super::super::operation::simulate_principal_policy::SimulatePrincipalPolicyInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::simulate_principal_policy::SimulatePrincipalPolicyInput {
