...
impl SimulatePrincipalPolicyOutput {
    ...
    pub fn builder() -> super::super::super::operation::simulate_principal_policy::builders::SimulatePrincipalPolicyOutputBuilder {
        super::super::super::operation::simulate_principal_policy::builders::SimulatePrincipalPolicyOutputBuilder::default()
    }
}
...
impl SimulatePrincipalPolicyOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::simulate_principal_policy::SimulatePrincipalPolicyOutput {
