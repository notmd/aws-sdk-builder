...
pub use super::super::super::operation::simulate_principal_policy::_simulate_principal_policy_input::SimulatePrincipalPolicyInputBuilder;

pub use super::super::super::operation::simulate_principal_policy::_simulate_principal_policy_output::SimulatePrincipalPolicyOutputBuilder;

impl super::super::super::operation::simulate_principal_policy::builders::SimulatePrincipalPolicyInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::simulate_principal_policy::SimulatePrincipalPolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::simulate_principal_policy::SimulatePrincipalPolicyError,
...
pub struct SimulatePrincipalPolicyFluentBuilder {
    ...
    inner: super::super::super::operation::simulate_principal_policy::builders::SimulatePrincipalPolicyInputBuilder,
...
impl SimulatePrincipalPolicyFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::simulate_principal_policy::builders::SimulatePrincipalPolicyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::simulate_principal_policy::SimulatePrincipalPolicy::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::simulate_principal_policy::SimulatePrincipalPolicy::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::super::super::operation::simulate_principal_policy::paginator::SimulatePrincipalPolicyPaginator {
        super::super::super::operation::simulate_principal_policy::paginator::SimulatePrincipalPolicyPaginator::new(self.handle, self.inner)
    }
    ...
    pub fn policy_exclusion_list(mut self, input: super::super::super::types::PolicyIdentifier) -> Self {
    ...
    /// <p>Each entry is a <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_PolicyIdentifier.html">PolicyIdentifier</a> that identifies one or more policies to exclude by policy type, by Amazon Resource Name (ARN), or by the name of an inline policy and the entity it is attached to.</p>
    /// <p>Syntactically invalid identifiers, such as malformed ARNs or wildcards in disallowed positions, cause the request to fail with an <code>InvalidInput</code> error. Syntactically valid identifiers that don't match any attached policy are ignored. Resource control policies (RCPs) are not supported in this release; identifiers that target RCPs are also ignored.</p>
    pub fn set_policy_exclusion_list(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::PolicyIdentifier>>) -> Self {
    ...
    /// <p>Each entry is a <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_PolicyIdentifier.html">PolicyIdentifier</a> that identifies one or more policies to exclude by policy type, by Amazon Resource Name (ARN), or by the name of an inline policy and the entity it is attached to.</p>
    /// <p>Syntactically invalid identifiers, such as malformed ARNs or wildcards in disallowed positions, cause the request to fail with an <code>InvalidInput</code> error. Syntactically valid identifiers that don't match any attached policy are ignored. Resource control policies (RCPs) are not supported in this release; identifiers that target RCPs are also ignored.</p>
    pub fn get_policy_exclusion_list(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::PolicyIdentifier>> {
