...
pub struct SimulatePrincipalPolicyPaginator {
    ...
    builder: super::super::super::operation::simulate_principal_policy::builders::SimulatePrincipalPolicyInputBuilder,
...
impl SimulatePrincipalPolicyPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::simulate_principal_policy::paginator::SimulatePrincipalPolicyPaginatorItems {
        super::super::super::operation::simulate_principal_policy::paginator::SimulatePrincipalPolicyPaginatorItems(self)
    }
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_simulate_principal_policy_output_output_marker(resp);
...
impl SimulatePrincipalPolicyPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_simulate_principal_policy_output_output_evaluation_results(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
