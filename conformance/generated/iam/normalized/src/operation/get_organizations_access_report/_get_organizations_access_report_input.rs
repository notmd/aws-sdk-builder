...
impl GetOrganizationsAccessReportInput {
    ...
    /// <p>The key that is used to sort the results. If you choose the namespace key, the results are returned in alphabetical order. If you choose the time key, the results are sorted numerically by the date and time.</p>
    pub fn sort_key(&self) -> ::std::option::Option<&super::super::super::types::SortKeyType> {
...
impl GetOrganizationsAccessReportInput {
    ...
    pub fn builder() -> super::super::super::operation::get_organizations_access_report::builders::GetOrganizationsAccessReportInputBuilder {
        super::super::super::operation::get_organizations_access_report::builders::GetOrganizationsAccessReportInputBuilder::default()
    }
}
...
pub struct GetOrganizationsAccessReportInputBuilder {
    ...
    pub(crate) sort_key: ::std::option::Option<super::super::super::types::SortKeyType>,
}
