...
impl UploadServerCertificate {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::upload_server_certificate::UploadServerCertificateInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::upload_server_certificate::UploadServerCertificateError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::upload_server_certificate::UploadServerCertificateOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "UploadServerCertificate", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UploadServerCertificate {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UploadServerCertificate")
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UploadServerCertificateTelemetryInputCaptureInterceptor {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UploadServerCertificateResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_upload_server_certificate::de_upload_server_certificate_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_upload_server_certificate::de_upload_server_certificate_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UploadServerCertificateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::upload_server_certificate::UploadServerCertificateInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::upload_server_certificate::UploadServerCertificateInput,
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UploadServerCertificateError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::KeyPairMismatchException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
...
impl ::aws_types::request_id::RequestId for super::super::operation::upload_server_certificate::UploadServerCertificateError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::upload_server_certificate::_upload_server_certificate_input::UploadServerCertificateInput;

pub use super::super::operation::upload_server_certificate::_upload_server_certificate_output::UploadServerCertificateOutput;
