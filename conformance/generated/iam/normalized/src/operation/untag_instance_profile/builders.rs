...
pub use super::super::super::operation::untag_instance_profile::_untag_instance_profile_input::UntagInstanceProfileInputBuilder;

pub use super::super::super::operation::untag_instance_profile::_untag_instance_profile_output::UntagInstanceProfileOutputBuilder;

impl super::super::super::operation::untag_instance_profile::builders::UntagInstanceProfileInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::untag_instance_profile::UntagInstanceProfileOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::untag_instance_profile::UntagInstanceProfileError,
...
pub struct UntagInstanceProfileFluentBuilder {
    ...
    inner: super::super::super::operation::untag_instance_profile::builders::UntagInstanceProfileInputBuilder,
...
impl
    super::super::super::client::customize::internal::CustomizableSend<
        super::super::super::operation::untag_instance_profile::UntagInstanceProfileOutput,
        super::super::super::operation::untag_instance_profile::UntagInstanceProfileError,
    > for UntagInstanceProfileFluentBuilder
{
    fn send(
        self,
...
impl UntagInstanceProfileFluentBuilder {
    /// Creates a new `UntagInstanceProfileFluentBuilder`.
    ...
    pub fn as_input(&self) -> &super::super::super::operation::untag_instance_profile::builders::UntagInstanceProfileInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::untag_instance_profile::UntagInstanceProfile::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::untag_instance_profile::UntagInstanceProfile::orchestrate(&runtime_plugins, input).await
    }
