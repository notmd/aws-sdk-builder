...
impl UntagInstanceProfileInput {
    ...
    pub fn builder() -> super::super::super::operation::untag_instance_profile::builders::UntagInstanceProfileInputBuilder {
        super::super::super::operation::untag_instance_profile::builders::UntagInstanceProfileInputBuilder::default()
    }
}
