...
impl UntagInstanceProfileOutput {
    ...
    pub fn builder() -> super::super::super::operation::untag_instance_profile::builders::UntagInstanceProfileOutputBuilder {
        super::super::super::operation::untag_instance_profile::builders::UntagInstanceProfileOutputBuilder::default()
    }
}
...
impl UntagInstanceProfileOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::untag_instance_profile::UntagInstanceProfileOutput {
