...
impl ListServerCertificateTagsInput {
    ...
    pub fn builder() -> super::super::super::operation::list_server_certificate_tags::builders::ListServerCertificateTagsInputBuilder {
        super::super::super::operation::list_server_certificate_tags::builders::ListServerCertificateTagsInputBuilder::default()
    }
}
