...
impl ListServerCertificateTagsOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_server_certificate_tags::builders::ListServerCertificateTagsOutputBuilder {
        super::super::super::operation::list_server_certificate_tags::builders::ListServerCertificateTagsOutputBuilder::default()
    }
}
