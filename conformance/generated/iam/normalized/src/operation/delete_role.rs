...
impl DeleteRole {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::delete_role::DeleteRoleInput,
    ) -> ::std::result::Result<
        super::super::operation::delete_role::DeleteRoleOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::delete_role::DeleteRoleError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::delete_role::DeleteRoleError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::delete_role::DeleteRoleOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "DeleteRole", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteRole {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DeleteRoleResponseDeserializer,
        ));
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteRoleResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_delete_role::de_delete_role_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_delete_role::de_delete_role_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteRoleRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::delete_role::DeleteRoleInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::delete_role::DeleteRoleError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::delete_role::_delete_role_input::DeleteRoleInput;

pub use super::super::operation::delete_role::_delete_role_output::DeleteRoleOutput;
