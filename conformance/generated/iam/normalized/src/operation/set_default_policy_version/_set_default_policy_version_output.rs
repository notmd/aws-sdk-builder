...
impl SetDefaultPolicyVersionOutput {
    ...
    pub fn builder() -> super::super::super::operation::set_default_policy_version::builders::SetDefaultPolicyVersionOutputBuilder {
        super::super::super::operation::set_default_policy_version::builders::SetDefaultPolicyVersionOutputBuilder::default()
    }
}
...
impl SetDefaultPolicyVersionOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::set_default_policy_version::SetDefaultPolicyVersionOutput {
