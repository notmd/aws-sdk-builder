...
impl SetDefaultPolicyVersionInput {
    ...
    pub fn builder() -> super::super::super::operation::set_default_policy_version::builders::SetDefaultPolicyVersionInputBuilder {
        super::super::super::operation::set_default_policy_version::builders::SetDefaultPolicyVersionInputBuilder::default()
    }
}
...
impl SetDefaultPolicyVersionInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::set_default_policy_version::SetDefaultPolicyVersionInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::set_default_policy_version::SetDefaultPolicyVersionInput {
