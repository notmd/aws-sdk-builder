...
pub use super::super::super::operation::set_default_policy_version::_set_default_policy_version_input::SetDefaultPolicyVersionInputBuilder;

pub use super::super::super::operation::set_default_policy_version::_set_default_policy_version_output::SetDefaultPolicyVersionOutputBuilder;

impl super::super::super::operation::set_default_policy_version::builders::SetDefaultPolicyVersionInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::set_default_policy_version::SetDefaultPolicyVersionOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::set_default_policy_version::SetDefaultPolicyVersionError,
...
/// <p>This operation affects all users, groups, and roles that the policy is attached to. To list the users, groups, and roles that the policy is attached to, use <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_ListEntitiesForPolicy.html">ListEntitiesForPolicy</a>.</p>
...
pub struct SetDefaultPolicyVersionFluentBuilder {
    ...
    inner: super::super::super::operation::set_default_policy_version::builders::SetDefaultPolicyVersionInputBuilder,
...
impl SetDefaultPolicyVersionFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::set_default_policy_version::builders::SetDefaultPolicyVersionInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::set_default_policy_version::SetDefaultPolicyVersion::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::set_default_policy_version::SetDefaultPolicyVersion::orchestrate(&runtime_plugins, input).await
    }
