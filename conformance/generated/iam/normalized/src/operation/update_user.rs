...
impl UpdateUser {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::update_user::UpdateUserInput,
    ) -> ::std::result::Result<
        super::super::operation::update_user::UpdateUserOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::update_user::UpdateUserError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::update_user::UpdateUserError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::update_user::UpdateUserOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IAM", "UpdateUser", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateUserResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_update_user::de_update_user_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_update_user::de_update_user_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateUserRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::update_user::UpdateUserInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::update_user::UpdateUserError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::update_user::_update_user_input::UpdateUserInput;

pub use super::super::operation::update_user::_update_user_output::UpdateUserOutput;
