...
impl DetachUserPolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::detach_user_policy::builders::DetachUserPolicyInputBuilder {
        super::super::super::operation::detach_user_policy::builders::DetachUserPolicyInputBuilder::default()
    }
}
