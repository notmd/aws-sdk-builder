...
pub struct ListVirtualMfaDevicesOutput {
    ...
    pub virtual_mfa_devices: ::std::vec::Vec<super::super::super::types::VirtualMfaDevice>,
...
impl ListVirtualMfaDevicesOutput {
    /// <p>The list of virtual MFA devices in the current account that match the <code>AssignmentStatus</code> value that was passed in the request.</p>
    pub fn virtual_mfa_devices(&self) -> &[super::super::super::types::VirtualMfaDevice] {
        use std::ops::Deref;
...
impl ListVirtualMfaDevicesOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_virtual_mfa_devices::builders::ListVirtualMfaDevicesOutputBuilder {
        super::super::super::operation::list_virtual_mfa_devices::builders::ListVirtualMfaDevicesOutputBuilder::default()
    }
}
...
pub struct ListVirtualMfaDevicesOutputBuilder {
    pub(crate) virtual_mfa_devices: ::std::option::Option<::std::vec::Vec<super::super::super::types::VirtualMfaDevice>>,
...
impl ListVirtualMfaDevicesOutputBuilder {
    ...
    ///
    /// <p>The list of virtual MFA devices in the current account that match the <code>AssignmentStatus</code> value that was passed in the request.</p>
    pub fn virtual_mfa_devices(mut self, input: super::super::super::types::VirtualMfaDevice) -> Self {
    ...
    /// <p>The list of virtual MFA devices in the current account that match the <code>AssignmentStatus</code> value that was passed in the request.</p>
    pub fn set_virtual_mfa_devices(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::VirtualMfaDevice>>) -> Self {
        self.virtual_mfa_devices = input;
        self
    }
    /// <p>The list of virtual MFA devices in the current account that match the <code>AssignmentStatus</code> value that was passed in the request.</p>
    pub fn get_virtual_mfa_devices(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::VirtualMfaDevice>> {
    ...
    > {
        ::std::result::Result::Ok(super::super::super::operation::list_virtual_mfa_devices::ListVirtualMfaDevicesOutput {
