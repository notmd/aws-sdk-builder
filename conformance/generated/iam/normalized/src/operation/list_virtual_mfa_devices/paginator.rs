                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_virtual_mfa_devices_output_output_marker(resp);
...
impl ListVirtualMFADevicesPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::VirtualMfaDevice,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::list_virtual_mfa_devices::ListVirtualMFADevicesError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_list_virtual_mfa_devices_output_output_virtual_mfa_devices(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
