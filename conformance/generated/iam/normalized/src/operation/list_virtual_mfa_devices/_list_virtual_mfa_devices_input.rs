...
impl ListVirtualMfaDevicesInput {
    /// <p>The status (<code>Unassigned</code> or <code>Assigned</code>) of the devices to list. If you do not specify an <code>AssignmentStatus</code>, the operation defaults to <code>Any</code>, which lists both assigned and unassigned virtual MFA devices.,</p>
    pub fn assignment_status(&self) -> ::std::option::Option<&super::super::super::types::AssignmentStatusType> {
...
impl ListVirtualMfaDevicesInput {
    ...
    pub fn builder() -> super::super::super::operation::list_virtual_mfa_devices::builders::ListVirtualMfaDevicesInputBuilder {
        super::super::super::operation::list_virtual_mfa_devices::builders::ListVirtualMfaDevicesInputBuilder::default()
    }
}
...
pub struct ListVirtualMfaDevicesInputBuilder {
    pub(crate) assignment_status: ::std::option::Option<super::super::super::types::AssignmentStatusType>,
...
impl ListVirtualMfaDevicesInputBuilder {
    ...
    /// <p>The status (<code>Unassigned</code> or <code>Assigned</code>) of the devices to list. If you do not specify an <code>AssignmentStatus</code>, the operation defaults to <code>Any</code>, which lists both assigned and unassigned virtual MFA devices.,</p>
    pub fn set_assignment_status(mut self, input: ::std::option::Option<super::super::super::types::AssignmentStatusType>) -> Self {
        self.assignment_status = input;
        self
    }
    /// <p>The status (<code>Unassigned</code> or <code>Assigned</code>) of the devices to list. If you do not specify an <code>AssignmentStatus</code>, the operation defaults to <code>Any</code>, which lists both assigned and unassigned virtual MFA devices.,</p>
    pub fn get_assignment_status(&self) -> &::std::option::Option<super::super::super::types::AssignmentStatusType> {
