...
impl GenerateCredentialReportInput {
    ...
    pub fn builder() -> super::super::super::operation::generate_credential_report::builders::GenerateCredentialReportInputBuilder {
        super::super::super::operation::generate_credential_report::builders::GenerateCredentialReportInputBuilder::default()
    }
}
...
impl GenerateCredentialReportInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::generate_credential_report::GenerateCredentialReportInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::generate_credential_report::GenerateCredentialReportInput {})
    }
}
