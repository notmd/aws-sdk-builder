...
pub trait Waiters {
    ...
    fn wait_until_bucket_exists(&self) -> super::waiters::bucket_exists::BucketExistsFluentBuilder;
    /// Wait for `bucket_not_exists`
    fn wait_until_bucket_not_exists(&self) -> super::waiters::bucket_not_exists::BucketNotExistsFluentBuilder;
    /// Wait for `object_exists`
    fn wait_until_object_exists(&self) -> super::waiters::object_exists::ObjectExistsFluentBuilder;
    /// Wait for `object_not_exists`
    fn wait_until_object_not_exists(&self) -> super::waiters::object_not_exists::ObjectNotExistsFluentBuilder;
}
impl Waiters for Client {
    fn wait_until_bucket_exists(&self) -> super::waiters::bucket_exists::BucketExistsFluentBuilder {
        super::waiters::bucket_exists::BucketExistsFluentBuilder::new(self.handle.clone())
    }
    fn wait_until_bucket_not_exists(&self) -> super::waiters::bucket_not_exists::BucketNotExistsFluentBuilder {
        super::waiters::bucket_not_exists::BucketNotExistsFluentBuilder::new(self.handle.clone())
    }
    fn wait_until_object_exists(&self) -> super::waiters::object_exists::ObjectExistsFluentBuilder {
        super::waiters::object_exists::ObjectExistsFluentBuilder::new(self.handle.clone())
    }
    fn wait_until_object_not_exists(&self) -> super::waiters::object_not_exists::ObjectNotExistsFluentBuilder {
        super::waiters::object_not_exists::ObjectNotExistsFluentBuilder::new(self.handle.clone())
    }
}
