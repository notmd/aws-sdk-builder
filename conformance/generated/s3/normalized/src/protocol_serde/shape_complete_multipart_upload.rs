...
> {
    ...
    let mut generic_builder = super::super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::super::operation::complete_multipart_upload::CompleteMultipartUploadError::unhandled)?;
    ...
    Err(super::super::operation::complete_multipart_upload::CompleteMultipartUploadError::generic(
        generic,
    ))
}
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::complete_multipart_upload::builders::CompleteMultipartUploadOutputBuilder::default();
        output = super::super::protocol_serde::shape_complete_multipart_upload::de_complete_multipart_upload(_response_body, output)
            .map_err(super::super::operation::complete_multipart_upload::CompleteMultipartUploadError::unhandled)?;
        output = output.set_bucket_key_enabled(
            super::super::protocol_serde::shape_complete_multipart_upload_output::de_bucket_key_enabled_header(_response_headers).map_err(|_| {
        ...
        output = output.set_expiration(
            super::super::protocol_serde::shape_complete_multipart_upload_output::de_expiration_header(_response_headers).map_err(|_| {
                super::super::operation::complete_multipart_upload::CompleteMultipartUploadError::unhandled(
        ...
        output = output.set_request_charged(
            super::super::protocol_serde::shape_complete_multipart_upload_output::de_request_charged_header(_response_headers).map_err(|_| {
                super::super::operation::complete_multipart_upload::CompleteMultipartUploadError::unhandled(
        ...
        output = output.set_ssekms_key_id(
            super::super::protocol_serde::shape_complete_multipart_upload_output::de_ssekms_key_id_header(_response_headers).map_err(|_| {
                super::super::operation::complete_multipart_upload::CompleteMultipartUploadError::unhandled(
...
pub fn de_complete_multipart_upload(
    inp: &[u8],
    mut builder: super::super::operation::complete_multipart_upload::builders::CompleteMultipartUploadOutputBuilder,
) -> std::result::Result<
    super::super::operation::complete_multipart_upload::builders::CompleteMultipartUploadOutputBuilder,
