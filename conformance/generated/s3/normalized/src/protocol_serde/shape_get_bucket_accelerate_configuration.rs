...
> {
    ...
    Err(super::super::operation::get_bucket_accelerate_configuration::GetBucketAccelerateConfigurationError::generic(generic))
}
...
pub fn de_get_bucket_accelerate_configuration(
    inp: &[u8],
    mut builder: super::super::operation::get_bucket_accelerate_configuration::builders::GetBucketAccelerateConfigurationOutputBuilder,
) -> std::result::Result<
    super::super::operation::get_bucket_accelerate_configuration::builders::GetBucketAccelerateConfigurationOutputBuilder,
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("Status") /* Status com.amazonaws.s3.synthetic#GetBucketAccelerateConfigurationOutput$Status */ =>  {
                let var_5 =
                    Some(
                        Result::<super::super::types::BucketAccelerateStatus, ::aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            super::super::types::BucketAccelerateStatus::from(
