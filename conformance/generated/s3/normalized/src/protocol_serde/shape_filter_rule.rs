...
pub fn de_filter_rule(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::FilterRule, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::FilterRule::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("Name") /* Name com.amazonaws.s3#FilterRule$Name */ =>  {
                let var_1 =
                    Some(
                        Result::<super::super::types::FilterRuleName, ::aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            super::super::types::FilterRuleName::from(
...
pub fn ser_filter_rule(
    input: &super::super::types::FilterRule,
