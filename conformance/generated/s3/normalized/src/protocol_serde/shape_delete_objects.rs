...
pub fn de_delete_objects_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::delete_objects::DeleteObjectsOutput, super::super::operation::delete_objects::DeleteObjectsError> {
    #[allow(unused_mut)]
    ...
    Err(super::super::operation::delete_objects::DeleteObjectsError::generic(generic))
}
...
pub fn de_delete_objects_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::delete_objects::builders::DeleteObjectsOutputBuilder::default();
        output = super::super::protocol_serde::shape_delete_objects::de_delete_objects(_response_body, output)
            .map_err(super::super::operation::delete_objects::DeleteObjectsError::unhandled)?;
...
pub fn de_delete_objects(
    inp: &[u8],
    mut builder: super::super::operation::delete_objects::builders::DeleteObjectsOutputBuilder,
) -> std::result::Result<super::super::operation::delete_objects::builders::DeleteObjectsOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("Error") /* Errors com.amazonaws.s3.synthetic#DeleteObjectsOutput$Errors */ =>  {
                let var_11 =
                    Some(
                        Result::<::std::vec::Vec::<super::super::types::Error>, ::aws_smithy_xml::decode::XmlDecodeError>::Ok({
                            let mut list_12 = builder.errors.take().unwrap_or_default();
                            list_12.push(
                                super::super::protocol_serde::shape_error::de_error(&mut tag, depth + 1)
                                ?
                            );
                            list_12
                        })
            ...
            s if s.matches("Deleted") /* Deleted com.amazonaws.s3.synthetic#DeleteObjectsOutput$Deleted */ =>  {
                let var_13 =
                    Some(
                        Result::<::std::vec::Vec::<super::super::types::DeletedObject>, ::aws_smithy_xml::decode::XmlDecodeError>::Ok({
                            let mut list_14 = builder.deleted.take().unwrap_or_default();
                            list_14.push(
                                super::super::protocol_serde::shape_deleted_object::de_deleted_object(&mut tag, depth + 1)
                                ?
                            );
                            list_14
                        })
