...
pub fn ser_ownership_controls_http_payload(
    payload: &::std::option::Option<super::super::types::OwnershipControls>,
) -> ::std::result::Result<::std::vec::Vec<u8>, ::aws_smithy_types::error::operation::BuildError> {
    let payload = match payload.as_ref() {
        Some(t) => t,
        None => return Ok(super::super::protocol_serde::rest_xml_unset_struct_payload()),
    };
    Ok(super::super::protocol_serde::shape_put_bucket_ownership_controls_input::ser_ownership_controls_payload(payload)?)
}
...
pub fn ser_ownership_controls_payload(
    ...
    let mut out = String::new();
    {
        ...
        super::super::protocol_serde::shape_ownership_controls::ser_ownership_controls(input, root)?
    }
    Ok(out.into_bytes())
}
