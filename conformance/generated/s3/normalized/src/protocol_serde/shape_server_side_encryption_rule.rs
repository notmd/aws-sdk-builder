...
pub fn ser_server_side_encryption_rule(
    input: &super::super::types::ServerSideEncryptionRule,
    ...
    if let Some(var_1) = &input.apply_server_side_encryption_by_default {
        ...
        super::super::protocol_serde::shape_server_side_encryption_by_default::ser_server_side_encryption_by_default(var_1, inner_writer)?
    }
    ...
    if let Some(var_3) = &input.blocked_encryption_types {
        ...
        super::super::protocol_serde::shape_blocked_encryption_types::ser_blocked_encryption_types(var_3, inner_writer)?
    }
    scope.finish();
    Ok(())
}
...
pub fn de_server_side_encryption_rule(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::ServerSideEncryptionRule, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::ServerSideEncryptionRule::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("ApplyServerSideEncryptionByDefault") /* ApplyServerSideEncryptionByDefault com.amazonaws.s3#ServerSideEncryptionRule$ApplyServerSideEncryptionByDefault */ =>  {
                let var_4 =
                    Some(
                        super::super::protocol_serde::shape_server_side_encryption_by_default::de_server_side_encryption_by_default(&mut tag, depth + 1)
                        ?
                    )
                ;
            ...
            s if s.matches("BlockedEncryptionTypes") /* BlockedEncryptionTypes com.amazonaws.s3#ServerSideEncryptionRule$BlockedEncryptionTypes */ =>  {
                let var_6 =
                    Some(
                        super::super::protocol_serde::shape_blocked_encryption_types::de_blocked_encryption_types(&mut tag, depth + 1)
                        ?
                    )
                ;
