...
pub fn ser_inventory_table_configuration_http_payload(
    payload: &::std::option::Option<super::super::types::InventoryTableConfigurationUpdates>,
...
pub fn ser_inventory_table_configuration_payload(
    input: &super::super::types::InventoryTableConfigurationUpdates,
    ...
    let mut out = String::new();
    {
        ...
        super::super::protocol_serde::shape_inventory_table_configuration_updates::ser_inventory_table_configuration_updates(input, root)?
    }
    Ok(out.into_bytes())
}
