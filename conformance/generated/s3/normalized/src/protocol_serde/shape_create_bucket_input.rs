...
pub fn ser_create_bucket_configuration_http_payload(
    payload: &::std::option::Option<super::super::types::CreateBucketConfiguration>,
...
pub fn ser_create_bucket_configuration_payload(
    input: &super::super::types::CreateBucketConfiguration,
    ...
    let mut out = String::new();
    {
        ...
        super::super::protocol_serde::shape_create_bucket_configuration::ser_create_bucket_configuration(input, root)?
    }
    Ok(out.into_bytes())
}
