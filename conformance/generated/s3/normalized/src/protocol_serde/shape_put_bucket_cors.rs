...
pub fn de_put_bucket_cors_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::put_bucket_cors::PutBucketCorsOutput, super::super::operation::put_bucket_cors::PutBucketCorsError>
{
    #[allow(unused_mut)]
    let mut generic_builder = super::super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::super::operation::put_bucket_cors::PutBucketCorsError::unhandled)?;
    ...
    Err(super::super::operation::put_bucket_cors::PutBucketCorsError::generic(generic))
}
...
) -> std::result::Result<super::super::operation::put_bucket_cors::PutBucketCorsOutput, super::super::operation::put_bucket_cors::PutBucketCorsError>
{
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::put_bucket_cors::builders::PutBucketCorsOutputBuilder::default();
