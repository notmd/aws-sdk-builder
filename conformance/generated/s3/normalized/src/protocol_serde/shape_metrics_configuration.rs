...
pub fn de_metrics_configuration(
    ...
    #[allow(unused_mut)]
    let mut builder = super::super::types::MetricsConfiguration::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("Filter") /* Filter com.amazonaws.s3#MetricsConfiguration$Filter */ =>  {
                let var_2 =
                    Some(
                        super::super::protocol_serde::shape_metrics_filter::de_metrics_filter(&mut tag, depth + 1)
                        ?
                    )
                ;
    ...
    Ok(super::super::serde_util::metrics_configuration_correct_errors(builder)
        .build()
        .map_err(|_| ::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}

pub fn ser_metrics_configuration(
    input: &super::super::types::MetricsConfiguration,
    ...
    if let Some(var_3) = &input.filter {
        ...
        super::super::protocol_serde::shape_metrics_filter::ser_metrics_filter(var_3, inner_writer)?
    }
    scope.finish();
    Ok(())
}
