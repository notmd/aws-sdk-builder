...
pub fn de_rename_object_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::rename_object::RenameObjectOutput, super::super::operation::rename_object::RenameObjectError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::rename_object::RenameObjectError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "IdempotencyParameterMismatch" => super::super::operation::rename_object::RenameObjectError::IdempotencyParameterMismatch({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_rename_object_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::rename_object::builders::RenameObjectOutputBuilder::default();
