...
> {
    ...
    Err(match error_code {
        "NoSuchUpload" => super::super::operation::abort_multipart_upload::AbortMultipartUploadError::NoSuchUpload({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                let mut output = super::super::types::error::builders::NoSuchUploadBuilder::default();
                output = super::super::protocol_serde::shape_no_such_upload::de_no_such_upload_xml_err(_response_body, output)
                    .map_err(super::super::operation::abort_multipart_upload::AbortMultipartUploadError::unhandled)?;
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::abort_multipart_upload::builders::AbortMultipartUploadOutputBuilder::default();
        output = output.set_request_charged(
            super::super::protocol_serde::shape_abort_multipart_upload_output::de_request_charged_header(_response_headers).map_err(|_| {
                super::super::operation::abort_multipart_upload::AbortMultipartUploadError::unhandled(
