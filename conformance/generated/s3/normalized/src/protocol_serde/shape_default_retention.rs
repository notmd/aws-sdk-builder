...
pub fn ser_default_retention(
    input: &super::super::types::DefaultRetention,
...
pub fn de_default_retention(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::DefaultRetention, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::DefaultRetention::builder();
