...
) -> std::result::Result<::aws_smithy_types::byte_stream::ByteStream, super::super::operation::get_object::GetObjectError> {
...
pub(crate) fn de_checksum_type_header(
    header_map: &::aws_smithy_runtime_api::http::Headers,
) -> ::std::result::Result<::std::option::Option<super::super::types::ChecksumType>, ::aws_smithy_http::header::ParseError> {
...
> {
    ...
    let out: std::result::Result<_, _> = headers.map(|(key, header_name)| {
                            ...
                            super::super::protocol_serde::shape_get_object_output::de_metadata_inner(values).map(|v| (key.to_string(), v.expect(
...
pub(crate) fn de_object_lock_legal_hold_status_header(
    header_map: &::aws_smithy_runtime_api::http::Headers,
) -> ::std::result::Result<::std::option::Option<super::super::types::ObjectLockLegalHoldStatus>, ::aws_smithy_http::header::ParseError> {
...
pub(crate) fn de_object_lock_mode_header(
    header_map: &::aws_smithy_runtime_api::http::Headers,
) -> ::std::result::Result<::std::option::Option<super::super::types::ObjectLockMode>, ::aws_smithy_http::header::ParseError> {
...
pub(crate) fn de_replication_status_header(
    header_map: &::aws_smithy_runtime_api::http::Headers,
) -> ::std::result::Result<::std::option::Option<super::super::types::ReplicationStatus>, ::aws_smithy_http::header::ParseError> {
...
pub(crate) fn de_request_charged_header(
    header_map: &::aws_smithy_runtime_api::http::Headers,
) -> ::std::result::Result<::std::option::Option<super::super::types::RequestCharged>, ::aws_smithy_http::header::ParseError> {
...
pub(crate) fn de_server_side_encryption_header(
    header_map: &::aws_smithy_runtime_api::http::Headers,
) -> ::std::result::Result<::std::option::Option<super::super::types::ServerSideEncryption>, ::aws_smithy_http::header::ParseError> {
...
pub(crate) fn de_storage_class_header(
    header_map: &::aws_smithy_runtime_api::http::Headers,
) -> ::std::result::Result<::std::option::Option<super::super::types::StorageClass>, ::aws_smithy_http::header::ParseError> {
