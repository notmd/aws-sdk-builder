...
> {
    ...
    let mut generic_builder = super::super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::super::operation::list_bucket_analytics_configurations::ListBucketAnalyticsConfigurationsError::unhandled)?;
    ...
    Err(super::super::operation::list_bucket_analytics_configurations::ListBucketAnalyticsConfigurationsError::generic(generic))
}
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_bucket_analytics_configurations::builders::ListBucketAnalyticsConfigurationsOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_bucket_analytics_configurations::de_list_bucket_analytics_configurations(_response_body, output)
            .map_err(super::super::operation::list_bucket_analytics_configurations::ListBucketAnalyticsConfigurationsError::unhandled)?;
...
pub fn de_list_bucket_analytics_configurations(
    inp: &[u8],
    mut builder: super::super::operation::list_bucket_analytics_configurations::builders::ListBucketAnalyticsConfigurationsOutputBuilder,
) -> std::result::Result<
    super::super::operation::list_bucket_analytics_configurations::builders::ListBucketAnalyticsConfigurationsOutputBuilder,
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("AnalyticsConfiguration") /* AnalyticsConfigurationList com.amazonaws.s3.synthetic#ListBucketAnalyticsConfigurationsOutput$AnalyticsConfigurationList */ =>  {
                let var_6 =
                    Some(
                        Result::<::std::vec::Vec::<super::super::types::AnalyticsConfiguration>, ::aws_smithy_xml::decode::XmlDecodeError>::Ok({
                            let mut list_7 = builder.analytics_configuration_list.take().unwrap_or_default();
                            list_7.push(
                                super::super::protocol_serde::shape_analytics_configuration::de_analytics_configuration(&mut tag, depth + 1)
                                ?
                            );
                            list_7
                        })
