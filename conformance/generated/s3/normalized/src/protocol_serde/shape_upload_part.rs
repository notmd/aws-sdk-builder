...
pub fn de_upload_part_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::upload_part::UploadPartOutput, super::super::operation::upload_part::UploadPartError> {
    #[allow(unused_mut)]
    let mut generic_builder = super::super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::super::operation::upload_part::UploadPartError::unhandled)?;
    ...
    Err(super::super::operation::upload_part::UploadPartError::generic(generic))
}
...
pub fn de_upload_part_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::upload_part::builders::UploadPartOutputBuilder::default();
        output = output.set_bucket_key_enabled(
            super::super::protocol_serde::shape_upload_part_output::de_bucket_key_enabled_header(_response_headers).map_err(|_| {
        ...
        output = output.set_checksum_crc32(
            super::super::protocol_serde::shape_upload_part_output::de_checksum_crc32_header(_response_headers).map_err(|_| {
                super::super::operation::upload_part::UploadPartError::unhandled("Failed to parse ChecksumCRC32 from header `x-amz-checksum-crc32")
            })?,
        );
        output = output.set_checksum_crc32_c(
            super::super::protocol_serde::shape_upload_part_output::de_checksum_crc32_c_header(_response_headers).map_err(|_| {
                super::super::operation::upload_part::UploadPartError::unhandled("Failed to parse ChecksumCRC32C from header `x-amz-checksum-crc32c")
            })?,
        );
        ...
        output = output.set_checksum_md5(
            super::super::protocol_serde::shape_upload_part_output::de_checksum_md5_header(_response_headers).map_err(|_| {
                super::super::operation::upload_part::UploadPartError::unhandled("Failed to parse ChecksumMD5 from header `x-amz-checksum-md5")
            })?,
        );
        output = output.set_checksum_sha1(
            super::super::protocol_serde::shape_upload_part_output::de_checksum_sha1_header(_response_headers).map_err(|_| {
                super::super::operation::upload_part::UploadPartError::unhandled("Failed to parse ChecksumSHA1 from header `x-amz-checksum-sha1")
            })?,
        );
        output = output.set_checksum_sha256(
            super::super::protocol_serde::shape_upload_part_output::de_checksum_sha256_header(_response_headers).map_err(|_| {
                super::super::operation::upload_part::UploadPartError::unhandled("Failed to parse ChecksumSHA256 from header `x-amz-checksum-sha256")
            })?,
        );
        output = output.set_checksum_sha512(
            super::super::protocol_serde::shape_upload_part_output::de_checksum_sha512_header(_response_headers).map_err(|_| {
                super::super::operation::upload_part::UploadPartError::unhandled("Failed to parse ChecksumSHA512 from header `x-amz-checksum-sha512")
            })?,
        );
        ...
        output = output.set_e_tag(
            super::super::protocol_serde::shape_upload_part_output::de_e_tag_header(_response_headers)
                .map_err(|_| super::super::operation::upload_part::UploadPartError::unhandled("Failed to parse ETag from header `ETag"))?,
        );
        output = output.set_request_charged(
            super::super::protocol_serde::shape_upload_part_output::de_request_charged_header(_response_headers).map_err(|_| {
                super::super::operation::upload_part::UploadPartError::unhandled("Failed to parse RequestCharged from header `x-amz-request-charged")
            })?,
        );
        output = output.set_sse_customer_algorithm(
            super::super::protocol_serde::shape_upload_part_output::de_sse_customer_algorithm_header(_response_headers).map_err(|_| {
                super::super::operation::upload_part::UploadPartError::unhandled(
        ...
        output = output.set_sse_customer_key_md5(
            super::super::protocol_serde::shape_upload_part_output::de_sse_customer_key_md5_header(_response_headers).map_err(|_| {
                super::super::operation::upload_part::UploadPartError::unhandled(
        ...
        output = output.set_ssekms_key_id(
            super::super::protocol_serde::shape_upload_part_output::de_ssekms_key_id_header(_response_headers).map_err(|_| {
                super::super::operation::upload_part::UploadPartError::unhandled(
        ...
        output = output.set_server_side_encryption(
            super::super::protocol_serde::shape_upload_part_output::de_server_side_encryption_header(_response_headers).map_err(|_| {
                super::super::operation::upload_part::UploadPartError::unhandled(
...
pub fn ser_upload_part_headers(
    input: &super::super::operation::upload_part::UploadPartInput,
