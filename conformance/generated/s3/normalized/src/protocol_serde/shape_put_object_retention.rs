...
> {
    ...
    let mut generic_builder = super::super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::super::operation::put_object_retention::PutObjectRetentionError::unhandled)?;
    ...
    Err(super::super::operation::put_object_retention::PutObjectRetentionError::generic(generic))
}
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::put_object_retention::builders::PutObjectRetentionOutputBuilder::default();
        output = output.set_request_charged(
            super::super::protocol_serde::shape_put_object_retention_output::de_request_charged_header(_response_headers).map_err(|_| {
                super::super::operation::put_object_retention::PutObjectRetentionError::unhandled(
