...
pub fn de_tiering(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::Tiering, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::Tiering::builder();
    ...
    Ok(super::super::serde_util::tiering_correct_errors(builder)
        .build()
        .map_err(|_| ::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}

pub fn ser_tiering(
    input: &super::super::types::Tiering,
