...
pub fn de_list_objects_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::list_objects::ListObjectsOutput, super::super::operation::list_objects::ListObjectsError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::list_objects::ListObjectsError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "NoSuchBucket" => super::super::operation::list_objects::ListObjectsError::NoSuchBucket({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_list_objects_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_objects::builders::ListObjectsOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_objects::de_list_objects(_response_body, output)
            .map_err(super::super::operation::list_objects::ListObjectsError::unhandled)?;
...
pub fn de_list_objects(
    inp: &[u8],
    mut builder: super::super::operation::list_objects::builders::ListObjectsOutputBuilder,
) -> std::result::Result<super::super::operation::list_objects::builders::ListObjectsOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("CommonPrefixes") /* CommonPrefixes com.amazonaws.s3.synthetic#ListObjectsOutput$CommonPrefixes */ =>  {
                let var_8 =
                    Some(
                        Result::<::std::vec::Vec::<super::super::types::CommonPrefix>, ::aws_smithy_xml::decode::XmlDecodeError>::Ok({
                            let mut list_9 = builder.common_prefixes.take().unwrap_or_default();
                            list_9.push(
                                super::super::protocol_serde::shape_common_prefix::de_common_prefix(&mut tag, depth + 1)
                                ?
                            );
                            list_9
                        })
            ...
            s if s.matches("Contents") /* Contents com.amazonaws.s3.synthetic#ListObjectsOutput$Contents */ =>  {
                let var_10 =
                    Some(
                        Result::<::std::vec::Vec::<super::super::types::Object>, ::aws_smithy_xml::decode::XmlDecodeError>::Ok({
                            let mut list_11 = builder.contents.take().unwrap_or_default();
                            list_11.push(
                                super::super::protocol_serde::shape_object::de_object(&mut tag, depth + 1)
                                ?
                            );
                            list_11
                        })
            ...
            s if s.matches("EncodingType") /* EncodingType com.amazonaws.s3.synthetic#ListObjectsOutput$EncodingType */ =>  {
                let var_13 =
                    Some(
                        Result::<super::super::types::EncodingType, ::aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            super::super::types::EncodingType::from(
                                ::aws_smithy_xml::decode::try_data(&mut tag)?.as_ref()
                            )
                        )
                        ?
