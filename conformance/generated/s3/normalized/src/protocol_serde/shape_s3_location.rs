...
pub fn ser_s3_location(
    input: &super::super::types::S3Location,
    ...
    if let Some(var_1) = &input.encryption {
        ...
        super::super::protocol_serde::shape_encryption::ser_encryption(var_1, inner_writer)?
    }
        ...
        for list_item_4 in var_3 {
            {
                ...
                super::super::protocol_serde::shape_grant::ser_grant(list_item_4, inner_writer)?
            }
        }
    }
    if let Some(var_5) = &input.tagging {
        let inner_writer = scope.start_el("Tagging");
        super::super::protocol_serde::shape_tagging::ser_tagging(var_5, inner_writer)?
    }
        ...
        for list_item_7 in var_6 {
            {
                ...
                super::super::protocol_serde::shape_metadata_entry::ser_metadata_entry(list_item_7, inner_writer)?
            }
        }
    }
