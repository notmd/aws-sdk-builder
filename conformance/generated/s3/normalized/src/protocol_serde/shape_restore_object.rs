...
pub fn de_restore_object_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::restore_object::RestoreObjectOutput, super::super::operation::restore_object::RestoreObjectError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::restore_object::RestoreObjectError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "ObjectAlreadyInActiveTierError" => super::super::operation::restore_object::RestoreObjectError::ObjectAlreadyInActiveTierError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                let mut output = super::super::types::error::builders::ObjectAlreadyInActiveTierErrorBuilder::default();
                output = super::super::protocol_serde::shape_object_already_in_active_tier_error::de_object_already_in_active_tier_error_xml_err(
                    _response_body,
                    output,
                )
                .map_err(super::super::operation::restore_object::RestoreObjectError::unhandled)?;
...
pub fn de_restore_object_http_response(
    ...
    Ok({
        ...
        output = output.set_restore_output_path(
            super::super::protocol_serde::shape_restore_object_output::de_restore_output_path_header(_response_headers).map_err(|_| {
