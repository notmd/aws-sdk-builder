...
pub fn de_upload_part_copy_http_error(
    ...
    Err(super::super::operation::upload_part_copy::UploadPartCopyError::generic(generic))
}
...
pub fn de_upload_part_copy_http_response(
    ...
    Ok({
        ...
        output = output.set_bucket_key_enabled(
            super::super::protocol_serde::shape_upload_part_copy_output::de_bucket_key_enabled_header(_response_headers).map_err(|_| {
                super::super::operation::upload_part_copy::UploadPartCopyError::unhandled(
                    "Failed to parse BucketKeyEnabled from header `x-amz-server-side-encryption-bucket-key-enabled",
                )
            })?,
        );
        output = output.set_copy_part_result(super::super::protocol_serde::shape_upload_part_copy_output::de_copy_part_result_payload(
            _response_body,
        )?);
        output = output.set_copy_source_version_id(
            super::super::protocol_serde::shape_upload_part_copy_output::de_copy_source_version_id_header(_response_headers).map_err(|_| {
                super::super::operation::upload_part_copy::UploadPartCopyError::unhandled(
        ...
        output = output.set_request_charged(
            super::super::protocol_serde::shape_upload_part_copy_output::de_request_charged_header(_response_headers).map_err(|_| {
                super::super::operation::upload_part_copy::UploadPartCopyError::unhandled(
        ...
        output = output.set_sse_customer_algorithm(
            super::super::protocol_serde::shape_upload_part_copy_output::de_sse_customer_algorithm_header(_response_headers).map_err(|_| {
                super::super::operation::upload_part_copy::UploadPartCopyError::unhandled(
        ...
        output = output.set_sse_customer_key_md5(
            super::super::protocol_serde::shape_upload_part_copy_output::de_sse_customer_key_md5_header(_response_headers).map_err(|_| {
                super::super::operation::upload_part_copy::UploadPartCopyError::unhandled(
        ...
        output = output.set_ssekms_key_id(
            super::super::protocol_serde::shape_upload_part_copy_output::de_ssekms_key_id_header(_response_headers).map_err(|_| {
                super::super::operation::upload_part_copy::UploadPartCopyError::unhandled(
        ...
        output = output.set_server_side_encryption(
            super::super::protocol_serde::shape_upload_part_copy_output::de_server_side_encryption_header(_response_headers).map_err(|_| {
                super::super::operation::upload_part_copy::UploadPartCopyError::unhandled(
