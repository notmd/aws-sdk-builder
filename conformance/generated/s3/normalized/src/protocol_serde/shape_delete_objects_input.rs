...
pub fn ser_delete_http_payload(
    payload: &::std::option::Option<super::super::types::Delete>,
) -> ::std::result::Result<::std::vec::Vec<u8>, ::aws_smithy_types::error::operation::BuildError> {
    let payload = match payload.as_ref() {
        Some(t) => t,
        None => return Ok(super::super::protocol_serde::rest_xml_unset_struct_payload()),
    };
    Ok(super::super::protocol_serde::shape_delete_objects_input::ser_delete_payload(payload)?)
}

pub fn ser_delete_payload(
    input: &super::super::types::Delete,
    ...
    let mut out = String::new();
    {
        ...
        super::super::protocol_serde::shape_delete::ser_delete(input, root)?
    }
    Ok(out.into_bytes())
}
