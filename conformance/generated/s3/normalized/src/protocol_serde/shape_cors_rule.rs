...
pub fn de_cors_rule(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::CorsRule, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::CorsRule::builder();
    ...
    Ok(super::super::serde_util::cors_rule_correct_errors(builder)
        .build()
        .map_err(|_| ::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}

pub fn ser_cors_rule(
    input: &super::super::types::CorsRule,
