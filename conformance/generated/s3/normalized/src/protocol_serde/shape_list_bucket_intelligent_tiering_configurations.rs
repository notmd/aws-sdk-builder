...
> {
    ...
    Err(super::super::operation::list_bucket_intelligent_tiering_configurations::ListBucketIntelligentTieringConfigurationsError::generic(generic))
}
...
pub fn de_list_bucket_intelligent_tiering_configurations(
    inp: &[u8],
    mut builder: super::super::operation::list_bucket_intelligent_tiering_configurations::builders::ListBucketIntelligentTieringConfigurationsOutputBuilder,
) -> std::result::Result<
    super::super::operation::list_bucket_intelligent_tiering_configurations::builders::ListBucketIntelligentTieringConfigurationsOutputBuilder,
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("IntelligentTieringConfiguration") /* IntelligentTieringConfigurationList com.amazonaws.s3.synthetic#ListBucketIntelligentTieringConfigurationsOutput$IntelligentTieringConfigurationList */ =>  {
                let var_3 =
                    Some(
                        Result::<::std::vec::Vec::<super::super::types::IntelligentTieringConfiguration>, ::aws_smithy_xml::decode::XmlDecodeError>::Ok({
                            let mut list_4 = builder.intelligent_tiering_configuration_list.take().unwrap_or_default();
                            list_4.push(
                                super::super::protocol_serde::shape_intelligent_tiering_configuration::de_intelligent_tiering_configuration(&mut tag, depth + 1)
                                ?
                            );
                            list_4
                        })
