...
> {
    ...
    Ok({
        ...
        output
            .build()
            .map_err(super::super::operation::select_object_content::SelectObjectContentError::unhandled)?
    })
}
...
> {
    ...
    Err(super::super::operation::select_object_content::SelectObjectContentError::generic(generic))
}
...
pub fn ser_select_object_content_op_input(
    ...
    let mut out = String::new();
    {
        ...
        super::super::protocol_serde::shape_select_object_content_input::ser_select_object_content_input_input_input(input, root)?
    }
