...
> {
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::get_object_torrent::builders::GetObjectTorrentOutputBuilder::default();
        output = output.set_body(Some(super::super::protocol_serde::shape_get_object_torrent_output::de_body_payload(
            _response_body,
        )?));
        output = output.set_request_charged(
            super::super::protocol_serde::shape_get_object_torrent_output::de_request_charged_header(_response_headers).map_err(|_| {
                super::super::operation::get_object_torrent::GetObjectTorrentError::unhandled(
...
> {
    ...
    Err(super::super::operation::get_object_torrent::GetObjectTorrentError::generic(generic))
}
