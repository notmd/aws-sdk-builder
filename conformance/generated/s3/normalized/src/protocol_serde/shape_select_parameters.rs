...
pub fn ser_select_parameters(
    input: &super::super::types::SelectParameters,
    ...
    if let Some(var_1) = &input.input_serialization {
        ...
        super::super::protocol_serde::shape_input_serialization::ser_input_serialization(var_1, inner_writer)?
    }
    {
    ...
    if let Some(var_2) = &input.output_serialization {
        ...
        super::super::protocol_serde::shape_output_serialization::ser_output_serialization(var_2, inner_writer)?
    }
    scope.finish();
    Ok(())
}
