...
pub fn de_delete_object_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::delete_object::DeleteObjectOutput, super::super::operation::delete_object::DeleteObjectError> {
    #[allow(unused_mut)]
    let mut generic_builder = super::super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::super::operation::delete_object::DeleteObjectError::unhandled)?;
    ...
    Err(super::super::operation::delete_object::DeleteObjectError::generic(generic))
}
...
pub fn de_delete_object_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::delete_object::builders::DeleteObjectOutputBuilder::default();
        output = output.set_delete_marker(
            super::super::protocol_serde::shape_delete_object_output::de_delete_marker_header(_response_headers).map_err(|_| {
                super::super::operation::delete_object::DeleteObjectError::unhandled("Failed to parse DeleteMarker from header `x-amz-delete-marker")
            })?,
        );
        ...
        output = output.set_version_id(
            super::super::protocol_serde::shape_delete_object_output::de_version_id_header(_response_headers).map_err(|_| {
                super::super::operation::delete_object::DeleteObjectError::unhandled("Failed to parse VersionId from header `x-amz-version-id")
            })?,
        );
