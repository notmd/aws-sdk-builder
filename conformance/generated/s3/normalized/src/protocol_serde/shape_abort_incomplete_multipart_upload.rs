...
pub fn de_abort_incomplete_multipart_upload(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::AbortIncompleteMultipartUpload, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::AbortIncompleteMultipartUpload::builder();
...
pub fn ser_abort_incomplete_multipart_upload(
    input: &super::super::types::AbortIncompleteMultipartUpload,
