...
> {
    ...
    Err(match error_code {
        "NoSuchKey" => super::super::operation::get_object_attributes::GetObjectAttributesError::NoSuchKey({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::get_object_attributes::builders::GetObjectAttributesOutputBuilder::default();
        output = super::super::protocol_serde::shape_get_object_attributes::de_get_object_attributes(_response_body, output)
            .map_err(super::super::operation::get_object_attributes::GetObjectAttributesError::unhandled)?;
        output = output.set_delete_marker(
            super::super::protocol_serde::shape_get_object_attributes_output::de_delete_marker_header(_response_headers).map_err(|_| {
                super::super::operation::get_object_attributes::GetObjectAttributesError::unhandled(
                    "Failed to parse DeleteMarker from header `x-amz-delete-marker",
                )
            })?,
        );
        output = output.set_last_modified(
            super::super::protocol_serde::shape_get_object_attributes_output::de_last_modified_header(_response_headers).map_err(|_| {
                super::super::operation::get_object_attributes::GetObjectAttributesError::unhandled(
        ...
        output = output.set_request_charged(
            super::super::protocol_serde::shape_get_object_attributes_output::de_request_charged_header(_response_headers).map_err(|_| {
                super::super::operation::get_object_attributes::GetObjectAttributesError::unhandled(
        ...
        output = output.set_version_id(
            super::super::protocol_serde::shape_get_object_attributes_output::de_version_id_header(_response_headers).map_err(|_| {
                super::super::operation::get_object_attributes::GetObjectAttributesError::unhandled(
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("Checksum") /* Checksum com.amazonaws.s3.synthetic#GetObjectAttributesOutput$Checksum */ =>  {
                let var_19 =
                    Some(
                        super::super::protocol_serde::shape_checksum::de_checksum(&mut tag, depth + 1)
                        ?
                    )
                ;
            ...
            s if s.matches("ObjectParts") /* ObjectParts com.amazonaws.s3.synthetic#GetObjectAttributesOutput$ObjectParts */ =>  {
                let var_22 =
                    Some(
                        super::super::protocol_serde::shape_get_object_attributes_parts::de_get_object_attributes_parts(&mut tag, depth + 1)
                        ?
                    )
                ;
