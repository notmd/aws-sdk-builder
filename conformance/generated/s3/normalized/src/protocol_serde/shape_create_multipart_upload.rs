...
> {
    ...
    let mut generic_builder = super::super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::super::operation::create_multipart_upload::CreateMultipartUploadError::unhandled)?;
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::create_multipart_upload::builders::CreateMultipartUploadOutputBuilder::default();
        output = super::super::protocol_serde::shape_create_multipart_upload::de_create_multipart_upload(_response_body, output)
            .map_err(super::super::operation::create_multipart_upload::CreateMultipartUploadError::unhandled)?;
        output = output.set_abort_date(
            super::super::protocol_serde::shape_create_multipart_upload_output::de_abort_date_header(_response_headers).map_err(|_| {
        ...
        output = output.set_abort_rule_id(
            super::super::protocol_serde::shape_create_multipart_upload_output::de_abort_rule_id_header(_response_headers).map_err(|_| {
                super::super::operation::create_multipart_upload::CreateMultipartUploadError::unhandled(
        ...
        output = output.set_bucket_key_enabled(
            super::super::protocol_serde::shape_create_multipart_upload_output::de_bucket_key_enabled_header(_response_headers).map_err(|_| {
                super::super::operation::create_multipart_upload::CreateMultipartUploadError::unhandled(
        ...
        output = output.set_checksum_algorithm(
            super::super::protocol_serde::shape_create_multipart_upload_output::de_checksum_algorithm_header(_response_headers).map_err(|_| {
                super::super::operation::create_multipart_upload::CreateMultipartUploadError::unhandled(
        ...
        output = output.set_checksum_type(
            super::super::protocol_serde::shape_create_multipart_upload_output::de_checksum_type_header(_response_headers).map_err(|_| {
                super::super::operation::create_multipart_upload::CreateMultipartUploadError::unhandled(
        ...
        output = output.set_request_charged(
            super::super::protocol_serde::shape_create_multipart_upload_output::de_request_charged_header(_response_headers).map_err(|_| {
                super::super::operation::create_multipart_upload::CreateMultipartUploadError::unhandled(
...
pub fn de_create_multipart_upload(
    inp: &[u8],
    mut builder: super::super::operation::create_multipart_upload::builders::CreateMultipartUploadOutputBuilder,
) -> std::result::Result<
    super::super::operation::create_multipart_upload::builders::CreateMultipartUploadOutputBuilder,
