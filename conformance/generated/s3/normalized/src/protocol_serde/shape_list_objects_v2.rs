...
) -> std::result::Result<super::super::operation::list_objects_v2::ListObjectsV2Output, super::super::operation::list_objects_v2::ListObjectsV2Error>
{
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::list_objects_v2::ListObjectsV2Error::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "NoSuchBucket" => super::super::operation::list_objects_v2::ListObjectsV2Error::NoSuchBucket({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
) -> std::result::Result<super::super::operation::list_objects_v2::ListObjectsV2Output, super::super::operation::list_objects_v2::ListObjectsV2Error>
{
    Ok({
        ...
        output = super::super::protocol_serde::shape_list_objects_v2::de_list_objects_v2(_response_body, output)
            .map_err(super::super::operation::list_objects_v2::ListObjectsV2Error::unhandled)?;
...
pub fn de_list_objects_v2(
    inp: &[u8],
    mut builder: super::super::operation::list_objects_v2::builders::ListObjectsV2OutputBuilder,
) -> std::result::Result<super::super::operation::list_objects_v2::builders::ListObjectsV2OutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
