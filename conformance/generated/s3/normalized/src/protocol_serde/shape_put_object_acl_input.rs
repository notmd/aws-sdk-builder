...
pub fn ser_access_control_policy_http_payload(
    payload: &::std::option::Option<super::super::types::AccessControlPolicy>,
...
pub fn ser_access_control_policy_payload(
    input: &super::super::types::AccessControlPolicy,
    ...
    let mut out = String::new();
    {
        ...
        super::super::protocol_serde::shape_access_control_policy::ser_access_control_policy(input, root)?
    }
    Ok(out.into_bytes())
}
