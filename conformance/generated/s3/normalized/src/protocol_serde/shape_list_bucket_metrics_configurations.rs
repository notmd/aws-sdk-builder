...
> {
    ...
    let mut generic_builder = super::super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::super::operation::list_bucket_metrics_configurations::ListBucketMetricsConfigurationsError::unhandled)?;
    ...
    Err(super::super::operation::list_bucket_metrics_configurations::ListBucketMetricsConfigurationsError::generic(generic))
}
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_bucket_metrics_configurations::builders::ListBucketMetricsConfigurationsOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_bucket_metrics_configurations::de_list_bucket_metrics_configurations(_response_body, output)
            .map_err(super::super::operation::list_bucket_metrics_configurations::ListBucketMetricsConfigurationsError::unhandled)?;
...
pub fn de_list_bucket_metrics_configurations(
    inp: &[u8],
    mut builder: super::super::operation::list_bucket_metrics_configurations::builders::ListBucketMetricsConfigurationsOutputBuilder,
) -> std::result::Result<
    super::super::operation::list_bucket_metrics_configurations::builders::ListBucketMetricsConfigurationsOutputBuilder,
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("MetricsConfiguration") /* MetricsConfigurationList com.amazonaws.s3.synthetic#ListBucketMetricsConfigurationsOutput$MetricsConfigurationList */ =>  {
                let var_5 =
                    Some(
                        Result::<::std::vec::Vec::<super::super::types::MetricsConfiguration>, ::aws_smithy_xml::decode::XmlDecodeError>::Ok({
                            let mut list_6 = builder.metrics_configuration_list.take().unwrap_or_default();
                            list_6.push(
                                super::super::protocol_serde::shape_metrics_configuration::de_metrics_configuration(&mut tag, depth + 1)
                                ?
                            );
                            list_6
                        })
