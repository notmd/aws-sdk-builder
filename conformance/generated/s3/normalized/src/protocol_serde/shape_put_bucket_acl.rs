...
pub fn de_put_bucket_acl_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::put_bucket_acl::PutBucketAclOutput, super::super::operation::put_bucket_acl::PutBucketAclError> {
    #[allow(unused_mut)]
    let mut generic_builder = super::super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::super::operation::put_bucket_acl::PutBucketAclError::unhandled)?;
    ...
    Err(super::super::operation::put_bucket_acl::PutBucketAclError::generic(generic))
}
...
pub fn de_put_bucket_acl_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::put_bucket_acl::builders::PutBucketAclOutputBuilder::default();
