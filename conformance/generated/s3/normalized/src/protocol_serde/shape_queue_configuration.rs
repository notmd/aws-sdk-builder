...
pub fn de_queue_configuration(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::QueueConfiguration, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::QueueConfiguration::builder();
    ...
    Ok(super::super::serde_util::queue_configuration_correct_errors(builder)
        .build()
        .map_err(|_| ::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}

pub fn ser_queue_configuration(
    input: &super::super::types::QueueConfiguration,
