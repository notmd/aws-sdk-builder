...
> {
    ...
    let mut generic_builder = super::super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::super::operation::list_object_versions::ListObjectVersionsError::unhandled)?;
    ...
    Err(super::super::operation::list_object_versions::ListObjectVersionsError::generic(generic))
}
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_object_versions::builders::ListObjectVersionsOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_object_versions::de_list_object_versions(_response_body, output)
            .map_err(super::super::operation::list_object_versions::ListObjectVersionsError::unhandled)?;
        output = output.set_request_charged(
            super::super::protocol_serde::shape_list_object_versions_output::de_request_charged_header(_response_headers).map_err(|_| {
                super::super::operation::list_object_versions::ListObjectVersionsError::unhandled(
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("Version") /* Versions com.amazonaws.s3.synthetic#ListObjectVersionsOutput$Versions */ =>  {
                let var_18 =
                    Some(
                        Result::<::std::vec::Vec::<super::super::types::ObjectVersion>, ::aws_smithy_xml::decode::XmlDecodeError>::Ok({
                            let mut list_19 = builder.versions.take().unwrap_or_default();
                            list_19.push(
                                super::super::protocol_serde::shape_object_version::de_object_version(&mut tag, depth + 1)
                                ?
                            );
                            list_19
                        })
            ...
            s if s.matches("DeleteMarker") /* DeleteMarkers com.amazonaws.s3.synthetic#ListObjectVersionsOutput$DeleteMarkers */ =>  {
                let var_21 =
                    Some(
                        Result::<::std::vec::Vec::<super::super::types::DeleteMarkerEntry>, ::aws_smithy_xml::decode::XmlDecodeError>::Ok({
                            let mut list_22 = builder.delete_markers.take().unwrap_or_default();
                            list_22.push(
                                super::super::protocol_serde::shape_delete_marker_entry::de_delete_marker_entry(&mut tag, depth + 1)
                                ?
                            );
                            list_22
                        })
