...
pub fn de_noncurrent_version_expiration(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::NoncurrentVersionExpiration, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::NoncurrentVersionExpiration::builder();
...
pub fn ser_noncurrent_version_expiration(
    input: &super::super::types::NoncurrentVersionExpiration,
