...
pub fn de_copy_object_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::copy_object::CopyObjectOutput, super::super::operation::copy_object::CopyObjectError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::copy_object::CopyObjectError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "ObjectNotInActiveTierError" => super::super::operation::copy_object::CopyObjectError::ObjectNotInActiveTierError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_copy_object_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::copy_object::builders::CopyObjectOutputBuilder::default();
        output = output.set_bucket_key_enabled(
            super::super::protocol_serde::shape_copy_object_output::de_bucket_key_enabled_header(_response_headers).map_err(|_| {
                super::super::operation::copy_object::CopyObjectError::unhandled(
                    "Failed to parse BucketKeyEnabled from header `x-amz-server-side-encryption-bucket-key-enabled",
                )
            })?,
        );
        output = output.set_copy_object_result(super::super::protocol_serde::shape_copy_object_output::de_copy_object_result_payload(
            _response_body,
        )?);
        output = output.set_copy_source_version_id(
            super::super::protocol_serde::shape_copy_object_output::de_copy_source_version_id_header(_response_headers).map_err(|_| {
                super::super::operation::copy_object::CopyObjectError::unhandled(
        ...
        output = output.set_request_charged(
            super::super::protocol_serde::shape_copy_object_output::de_request_charged_header(_response_headers).map_err(|_| {
                super::super::operation::copy_object::CopyObjectError::unhandled("Failed to parse RequestCharged from header `x-amz-request-charged")
            })?,
        );
        output = output.set_sse_customer_algorithm(
            super::super::protocol_serde::shape_copy_object_output::de_sse_customer_algorithm_header(_response_headers).map_err(|_| {
                super::super::operation::copy_object::CopyObjectError::unhandled(
        ...
        output = output.set_sse_customer_key_md5(
            super::super::protocol_serde::shape_copy_object_output::de_sse_customer_key_md5_header(_response_headers).map_err(|_| {
                super::super::operation::copy_object::CopyObjectError::unhandled(
        ...
        output = output.set_ssekms_encryption_context(
            super::super::protocol_serde::shape_copy_object_output::de_ssekms_encryption_context_header(_response_headers).map_err(|_| {
                super::super::operation::copy_object::CopyObjectError::unhandled(
        ...
        output = output.set_ssekms_key_id(
            super::super::protocol_serde::shape_copy_object_output::de_ssekms_key_id_header(_response_headers).map_err(|_| {
                super::super::operation::copy_object::CopyObjectError::unhandled(
        ...
        output = output.set_server_side_encryption(
            super::super::protocol_serde::shape_copy_object_output::de_server_side_encryption_header(_response_headers).map_err(|_| {
                super::super::operation::copy_object::CopyObjectError::unhandled(
