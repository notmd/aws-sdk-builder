...
> {
    ...
    let mut generic_builder = super::super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::super::operation::list_directory_buckets::ListDirectoryBucketsError::unhandled)?;
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_directory_buckets::builders::ListDirectoryBucketsOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_directory_buckets::de_list_directory_buckets(_response_body, output)
            .map_err(super::super::operation::list_directory_buckets::ListDirectoryBucketsError::unhandled)?;
...
pub fn de_list_directory_buckets(
    inp: &[u8],
    mut builder: super::super::operation::list_directory_buckets::builders::ListDirectoryBucketsOutputBuilder,
) -> std::result::Result<
    super::super::operation::list_directory_buckets::builders::ListDirectoryBucketsOutputBuilder,
