...
pub fn de_list_parts_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::list_parts::ListPartsOutput, super::super::operation::list_parts::ListPartsError> {
    #[allow(unused_mut)]
    ...
    Err(super::super::operation::list_parts::ListPartsError::generic(generic))
}
...
pub fn de_list_parts_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_parts::builders::ListPartsOutputBuilder::default();
        ...
        output = output.set_abort_rule_id(
            super::super::protocol_serde::shape_list_parts_output::de_abort_rule_id_header(_response_headers).map_err(|_| {
                super::super::operation::list_parts::ListPartsError::unhandled("Failed to parse AbortRuleId from header `x-amz-abort-rule-id")
            })?,
        );
        output = output.set_request_charged(
            super::super::protocol_serde::shape_list_parts_output::de_request_charged_header(_response_headers).map_err(|_| {
                super::super::operation::list_parts::ListPartsError::unhandled("Failed to parse RequestCharged from header `x-amz-request-charged")
            })?,
        );
...
pub fn de_list_parts(
    inp: &[u8],
    mut builder: super::super::operation::list_parts::builders::ListPartsOutputBuilder,
) -> std::result::Result<super::super::operation::list_parts::builders::ListPartsOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("Owner") /* Owner com.amazonaws.s3.synthetic#ListPartsOutput$Owner */ =>  {
                let var_11 =
                    Some(
                        super::super::protocol_serde::shape_owner::de_owner(&mut tag, depth + 1)
                        ?
                    )
                ;
            ...
            s if s.matches("ChecksumAlgorithm") /* ChecksumAlgorithm com.amazonaws.s3.synthetic#ListPartsOutput$ChecksumAlgorithm */ =>  {
                let var_14 =
                    Some(
                        Result::<super::super::types::ChecksumAlgorithm, ::aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            super::super::types::ChecksumAlgorithm::from(
                                ::aws_smithy_xml::decode::try_data(&mut tag)?.as_ref()
                            )
                        )
                        ?
            ...
            s if s.matches("ChecksumType") /* ChecksumType com.amazonaws.s3.synthetic#ListPartsOutput$ChecksumType */ =>  {
                let var_17 =
                    Some(
                        Result::<super::super::types::ChecksumType, ::aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            super::super::types::ChecksumType::from(
                                ::aws_smithy_xml::decode::try_data(&mut tag)?.as_ref()
                            )
                        )
                        ?
            ...
            s if s.matches("Part") /* Parts com.amazonaws.s3.synthetic#ListPartsOutput$Parts */ =>  {
                let var_21 =
                    Some(
                        Result::<::std::vec::Vec::<super::super::types::Part>, ::aws_smithy_xml::decode::XmlDecodeError>::Ok({
                            let mut list_22 = builder.parts.take().unwrap_or_default();
                            list_22.push(
                                super::super::protocol_serde::shape_part::de_part(&mut tag, depth + 1)
                                ?
                            );
                            list_22
                        })
            ...
            s if s.matches("Initiator") /* Initiator com.amazonaws.s3.synthetic#ListPartsOutput$Initiator */ =>  {
                let var_23 =
                    Some(
                        super::super::protocol_serde::shape_initiator::de_initiator(&mut tag, depth + 1)
                        ?
                    )
                ;
