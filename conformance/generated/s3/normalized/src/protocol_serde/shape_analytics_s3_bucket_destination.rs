...
pub fn de_analytics_s3_bucket_destination(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::AnalyticsS3BucketDestination, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::AnalyticsS3BucketDestination::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("Format") /* Format com.amazonaws.s3#AnalyticsS3BucketDestination$Format */ =>  {
                let var_1 =
                    Some(
                        Result::<super::super::types::AnalyticsS3ExportFileFormat, ::aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            super::super::types::AnalyticsS3ExportFileFormat::from(
    ...
    Ok(super::super::serde_util::analytics_s3_bucket_destination_correct_errors(builder)
        .build()
        .map_err(|_| ::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}

pub fn ser_analytics_s3_bucket_destination(
    input: &super::super::types::AnalyticsS3BucketDestination,
