...
pub fn de_lambda_function_configuration(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::LambdaFunctionConfiguration, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::LambdaFunctionConfiguration::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("Event") /* Events com.amazonaws.s3#LambdaFunctionConfiguration$Events */ =>  {
                let var_3 =
                    Some(
                        Result::<::std::vec::Vec::<super::super::types::Event>, ::aws_smithy_xml::decode::XmlDecodeError>::Ok({
                            let mut list_4 = builder.events.take().unwrap_or_default();
                            list_4.push(
                                Result::<super::super::types::Event, ::aws_smithy_xml::decode::XmlDecodeError>::Ok(
                                    super::super::types::Event::from(
                                        ::aws_smithy_xml::decode::try_data(&mut tag)?.as_ref()
                                    )
                                )
                                ?
            ...
            s if s.matches("Filter") /* Filter com.amazonaws.s3#LambdaFunctionConfiguration$Filter */ =>  {
                let var_5 =
                    Some(
                        super::super::protocol_serde::shape_notification_configuration_filter::de_notification_configuration_filter(&mut tag, depth + 1)
                        ?
                    )
                ;
    ...
    Ok(super::super::serde_util::lambda_function_configuration_correct_errors(builder)
        .build()
        .map_err(|_| ::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}

pub fn ser_lambda_function_configuration(
    input: &super::super::types::LambdaFunctionConfiguration,
    ...
    if let Some(var_8) = &input.filter {
        ...
        super::super::protocol_serde::shape_notification_configuration_filter::ser_notification_configuration_filter(var_8, inner_writer)?
    }
    scope.finish();
    Ok(())
}
