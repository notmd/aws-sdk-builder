...
pub fn ser_cors_configuration_http_payload(
    payload: &::std::option::Option<super::super::types::CorsConfiguration>,
) -> ::std::result::Result<::std::vec::Vec<u8>, ::aws_smithy_types::error::operation::BuildError> {
    let payload = match payload.as_ref() {
        Some(t) => t,
        None => return Ok(super::super::protocol_serde::rest_xml_unset_struct_payload()),
    };
    Ok(super::super::protocol_serde::shape_put_bucket_cors_input::ser_cors_configuration_payload(
        payload,
    )?)
}

pub fn ser_cors_configuration_payload(
    input: &super::super::types::CorsConfiguration,
    ...
    let mut out = String::new();
    {
        ...
        super::super::protocol_serde::shape_cors_configuration::ser_cors_configuration(input, root)?
    }
    Ok(out.into_bytes())
}
