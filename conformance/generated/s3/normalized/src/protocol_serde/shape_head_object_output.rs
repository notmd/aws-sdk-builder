...
pub(crate) fn de_archive_status_header(
    header_map: &::aws_smithy_runtime_api::http::Headers,
) -> ::std::result::Result<::std::option::Option<super::super::types::ArchiveStatus>, ::aws_smithy_http::header::ParseError> {
...
> {
    ...
    let out: std::result::Result<_, _> = headers.map(|(key, header_name)| {
                            ...
                            super::super::protocol_serde::shape_head_object_output::de_metadata_inner(values).map(|v| (key.to_string(), v.expect(
