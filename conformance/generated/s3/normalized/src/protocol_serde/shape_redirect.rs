...
pub fn de_redirect(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::Redirect, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::Redirect::builder();
...
pub fn ser_redirect(
    input: &super::super::types::Redirect,
