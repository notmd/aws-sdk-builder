...
) -> std::result::Result<super::super::operation::get_object::GetObjectOutput, super::super::operation::get_object::GetObjectError> {
    ...
    Ok({
        ...
        output = output.set_checksum_crc32(
            super::super::protocol_serde::shape_get_object_output::de_checksum_crc32_header(_response_headers).map_err(|_| {
                super::super::operation::get_object::GetObjectError::unhandled("Failed to parse ChecksumCRC32 from header `x-amz-checksum-crc32")
            })?,
        );
        output = output.set_checksum_crc32_c(
            super::super::protocol_serde::shape_get_object_output::de_checksum_crc32_c_header(_response_headers).map_err(|_| {
                super::super::operation::get_object::GetObjectError::unhandled("Failed to parse ChecksumCRC32C from header `x-amz-checksum-crc32c")
            })?,
        );
        ...
        output = output.set_checksum_md5(
            super::super::protocol_serde::shape_get_object_output::de_checksum_md5_header(_response_headers).map_err(|_| {
                super::super::operation::get_object::GetObjectError::unhandled("Failed to parse ChecksumMD5 from header `x-amz-checksum-md5")
            })?,
        );
        output = output.set_checksum_sha1(
            super::super::protocol_serde::shape_get_object_output::de_checksum_sha1_header(_response_headers).map_err(|_| {
                super::super::operation::get_object::GetObjectError::unhandled("Failed to parse ChecksumSHA1 from header `x-amz-checksum-sha1")
            })?,
        );
        output = output.set_checksum_sha256(
            super::super::protocol_serde::shape_get_object_output::de_checksum_sha256_header(_response_headers).map_err(|_| {
                super::super::operation::get_object::GetObjectError::unhandled("Failed to parse ChecksumSHA256 from header `x-amz-checksum-sha256")
            })?,
        );
        output = output.set_checksum_sha512(
            super::super::protocol_serde::shape_get_object_output::de_checksum_sha512_header(_response_headers).map_err(|_| {
                super::super::operation::get_object::GetObjectError::unhandled("Failed to parse ChecksumSHA512 from header `x-amz-checksum-sha512")
            })?,
        );
        output = output.set_checksum_type(
            super::super::protocol_serde::shape_get_object_output::de_checksum_type_header(_response_headers).map_err(|_| {
                super::super::operation::get_object::GetObjectError::unhandled("Failed to parse ChecksumType from header `x-amz-checksum-type")
            })?,
        );
        ...
        output = output.set_checksum_xxhash3(
            super::super::protocol_serde::shape_get_object_output::de_checksum_xxhash3_header(_response_headers).map_err(|_| {
                super::super::operation::get_object::GetObjectError::unhandled("Failed to parse ChecksumXXHASH3 from header `x-amz-checksum-xxhash3")
            })?,
        );
        ...
        output = output.set_content_disposition(
            super::super::protocol_serde::shape_get_object_output::de_content_disposition_header(_response_headers).map_err(|_| {
                super::super::operation::get_object::GetObjectError::unhandled("Failed to parse ContentDisposition from header `Content-Disposition")
            })?,
        );
        output = output.set_content_encoding(
            super::super::protocol_serde::shape_get_object_output::de_content_encoding_header(_response_headers).map_err(|_| {
                super::super::operation::get_object::GetObjectError::unhandled("Failed to parse ContentEncoding from header `Content-Encoding")
            })?,
        );
        output = output.set_content_language(
            super::super::protocol_serde::shape_get_object_output::de_content_language_header(_response_headers).map_err(|_| {
                super::super::operation::get_object::GetObjectError::unhandled("Failed to parse ContentLanguage from header `Content-Language")
            })?,
        );
        ...
        output = output.set_delete_marker(
            super::super::protocol_serde::shape_get_object_output::de_delete_marker_header(_response_headers).map_err(|_| {
                super::super::operation::get_object::GetObjectError::unhandled("Failed to parse DeleteMarker from header `x-amz-delete-marker")
            })?,
        );
        output = output.set_e_tag(
            super::super::protocol_serde::shape_get_object_output::de_e_tag_header(_response_headers)
        ...
        output = output.set_missing_meta(
            super::super::protocol_serde::shape_get_object_output::de_missing_meta_header(_response_headers).map_err(|_| {
                super::super::operation::get_object::GetObjectError::unhandled("Failed to parse MissingMeta from header `x-amz-missing-meta")
            })?,
        );
        output = output.set_object_lock_legal_hold_status(
            super::super::protocol_serde::shape_get_object_output::de_object_lock_legal_hold_status_header(_response_headers).map_err(|_| {
                super::super::operation::get_object::GetObjectError::unhandled(
        ...
        output = output.set_object_lock_mode(
            super::super::protocol_serde::shape_get_object_output::de_object_lock_mode_header(_response_headers).map_err(|_| {
                super::super::operation::get_object::GetObjectError::unhandled("Failed to parse ObjectLockMode from header `x-amz-object-lock-mode")
            })?,
        );
        output = output.set_object_lock_retain_until_date(
            super::super::protocol_serde::shape_get_object_output::de_object_lock_retain_until_date_header(_response_headers).map_err(|_| {
                super::super::operation::get_object::GetObjectError::unhandled(
        ...
        output = output.set_parts_count(
            super::super::protocol_serde::shape_get_object_output::de_parts_count_header(_response_headers).map_err(|_| {
                super::super::operation::get_object::GetObjectError::unhandled("Failed to parse PartsCount from header `x-amz-mp-parts-count")
            })?,
        );
        ...
        output = output.set_request_charged(
            super::super::protocol_serde::shape_get_object_output::de_request_charged_header(_response_headers).map_err(|_| {
                super::super::operation::get_object::GetObjectError::unhandled("Failed to parse RequestCharged from header `x-amz-request-charged")
            })?,
        );
        output = output.set_restore(
            super::super::protocol_serde::shape_get_object_output::de_restore_header(_response_headers)
                .map_err(|_| super::super::operation::get_object::GetObjectError::unhandled("Failed to parse Restore from header `x-amz-restore"))?,
        );
        output = output.set_sse_customer_algorithm(
            super::super::protocol_serde::shape_get_object_output::de_sse_customer_algorithm_header(_response_headers).map_err(|_| {
                super::super::operation::get_object::GetObjectError::unhandled(
        ...
        output = output.set_sse_customer_key_md5(
            super::super::protocol_serde::shape_get_object_output::de_sse_customer_key_md5_header(_response_headers).map_err(|_| {
                super::super::operation::get_object::GetObjectError::unhandled(
        ...
        output = output.set_ssekms_key_id(
            super::super::protocol_serde::shape_get_object_output::de_ssekms_key_id_header(_response_headers).map_err(|_| {
                super::super::operation::get_object::GetObjectError::unhandled(
        ...
        output = output.set_server_side_encryption(
            super::super::protocol_serde::shape_get_object_output::de_server_side_encryption_header(_response_headers).map_err(|_| {
                super::super::operation::get_object::GetObjectError::unhandled(
        ...
        output = output.set_storage_class(
            super::super::protocol_serde::shape_get_object_output::de_storage_class_header(_response_headers).map_err(|_| {
                super::super::operation::get_object::GetObjectError::unhandled("Failed to parse StorageClass from header `x-amz-storage-class")
            })?,
        );
...
pub fn de_get_object_http_error(
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::get_object::GetObjectError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InvalidObjectState" => super::super::operation::get_object::GetObjectError::InvalidObjectState({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                let mut output = super::super::types::error::builders::InvalidObjectStateBuilder::default();
                output = super::super::protocol_serde::shape_invalid_object_state::de_invalid_object_state_xml_err(_response_body, output)
                    .map_err(super::super::operation::get_object::GetObjectError::unhandled)?;
        ...
        "NoSuchKey" => super::super::operation::get_object::GetObjectError::NoSuchKey({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                let mut output = super::super::types::error::builders::NoSuchKeyBuilder::default();
                output = super::super::protocol_serde::shape_no_such_key::de_no_such_key_xml_err(_response_body, output)
                    .map_err(super::super::operation::get_object::GetObjectError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
...
pub fn ser_get_object_headers(
    input: &super::super::operation::get_object::GetObjectInput,
