...
pub fn de_get_bucket_website_http_error(
    ...
    Err(super::super::operation::get_bucket_website::GetBucketWebsiteError::generic(generic))
}
...
pub fn de_get_bucket_website_http_response(
    ...
    Ok({
        ...
        output = super::super::protocol_serde::shape_get_bucket_website::de_get_bucket_website(_response_body, output)
            .map_err(super::super::operation::get_bucket_website::GetBucketWebsiteError::unhandled)?;
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("IndexDocument") /* IndexDocument com.amazonaws.s3.synthetic#GetBucketWebsiteOutput$IndexDocument */ =>  {
                let var_3 =
                    Some(
                        super::super::protocol_serde::shape_index_document::de_index_document(&mut tag, depth + 1)
                        ?
                    )
                ;
            ...
            s if s.matches("RedirectAllRequestsTo") /* RedirectAllRequestsTo com.amazonaws.s3.synthetic#GetBucketWebsiteOutput$RedirectAllRequestsTo */ =>  {
                let var_4 =
                    Some(
                        super::super::protocol_serde::shape_redirect_all_requests_to::de_redirect_all_requests_to(&mut tag, depth + 1)
                        ?
                    )
                ;
            ...
            s if s.matches("RoutingRules") /* RoutingRules com.amazonaws.s3.synthetic#GetBucketWebsiteOutput$RoutingRules */ =>  {
                let var_5 =
                    Some(
                        super::super::protocol_serde::shape_routing_rules::de_routing_rules(&mut tag, depth + 1)
                        ?
                    )
                ;
            ...
            s if s.matches("ErrorDocument") /* ErrorDocument com.amazonaws.s3.synthetic#GetBucketWebsiteOutput$ErrorDocument */ =>  {
                let var_6 =
                    Some(
                        super::super::protocol_serde::shape_error_document::de_error_document(&mut tag, depth + 1)
                        ?
                    )
                ;
