...
pub fn de_metadata_configuration_result(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::MetadataConfigurationResult, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::MetadataConfigurationResult::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("DestinationResult") /* DestinationResult com.amazonaws.s3#MetadataConfigurationResult$DestinationResult */ =>  {
                let var_1 =
                    Some(
                        super::super::protocol_serde::shape_destination_result::de_destination_result(&mut tag, depth + 1)
                        ?
                    )
                ;
            ...
            s if s.matches("JournalTableConfigurationResult") /* JournalTableConfigurationResult com.amazonaws.s3#MetadataConfigurationResult$JournalTableConfigurationResult */ =>  {
                let var_2 =
                    Some(
                        super::super::protocol_serde::shape_journal_table_configuration_result::de_journal_table_configuration_result(&mut tag, depth + 1)
                        ?
                    )
                ;
            ...
            s if s.matches("InventoryTableConfigurationResult") /* InventoryTableConfigurationResult com.amazonaws.s3#MetadataConfigurationResult$InventoryTableConfigurationResult */ =>  {
                let var_3 =
                    Some(
                        super::super::protocol_serde::shape_inventory_table_configuration_result::de_inventory_table_configuration_result(&mut tag, depth + 1)
                        ?
                    )
                ;
            ...
            s if s.matches("AnnotationTableConfigurationResult") /* AnnotationTableConfigurationResult com.amazonaws.s3#MetadataConfigurationResult$AnnotationTableConfigurationResult */ =>  {
                let var_4 =
                    Some(
                        super::super::protocol_serde::shape_annotation_table_configuration_result::de_annotation_table_configuration_result(&mut tag, depth + 1)
                        ?
                    )
                ;
    ...
    Ok(super::super::serde_util::metadata_configuration_result_correct_errors(builder).build())
}
