...
pub fn de_get_bucket_logging_http_error(
    ...
    Err(super::super::operation::get_bucket_logging::GetBucketLoggingError::generic(generic))
}
...
pub fn de_get_bucket_logging_http_response(
    ...
    Ok({
        ...
        output = super::super::protocol_serde::shape_get_bucket_logging::de_get_bucket_logging(_response_body, output)
            .map_err(super::super::operation::get_bucket_logging::GetBucketLoggingError::unhandled)?;
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("LoggingEnabled") /* LoggingEnabled com.amazonaws.s3.synthetic#GetBucketLoggingOutput$LoggingEnabled */ =>  {
                let var_3 =
                    Some(
                        super::super::protocol_serde::shape_logging_enabled::de_logging_enabled(&mut tag, depth + 1)
                        ?
                    )
                ;
