...
pub fn ser_bucket_logging_status_http_payload(
    payload: &::std::option::Option<super::super::types::BucketLoggingStatus>,
...
pub fn ser_bucket_logging_status_payload(
    input: &super::super::types::BucketLoggingStatus,
    ...
    let mut out = String::new();
    {
        ...
        super::super::protocol_serde::shape_bucket_logging_status::ser_bucket_logging_status(input, root)?
    }
    Ok(out.into_bytes())
}
