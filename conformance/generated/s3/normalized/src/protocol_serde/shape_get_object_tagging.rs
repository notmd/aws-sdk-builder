...
pub fn de_get_object_tagging_http_error(
    ...
    Err(super::super::operation::get_object_tagging::GetObjectTaggingError::generic(generic))
}
...
pub fn de_get_object_tagging_http_response(
    ...
    Ok({
        ...
        output = super::super::protocol_serde::shape_get_object_tagging::de_get_object_tagging(_response_body, output)
            .map_err(super::super::operation::get_object_tagging::GetObjectTaggingError::unhandled)?;
        ...
        super::super::serde_util::get_object_tagging_output_output_correct_errors(output)
            .build()
            .map_err(super::super::operation::get_object_tagging::GetObjectTaggingError::unhandled)?
    })
}
