...
pub fn de_redirect_all_requests_to(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::RedirectAllRequestsTo, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::RedirectAllRequestsTo::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("Protocol") /* Protocol com.amazonaws.s3#RedirectAllRequestsTo$Protocol */ =>  {
                let var_2 =
                    Some(
                        Result::<super::super::types::Protocol, ::aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            super::super::types::Protocol::from(
                                ::aws_smithy_xml::decode::try_data(&mut tag)?.as_ref()
                            )
                        )
                        ?
    ...
    Ok(super::super::serde_util::redirect_all_requests_to_correct_errors(builder)
        .build()
        .map_err(|_| ::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}

pub fn ser_redirect_all_requests_to(
    input: &super::super::types::RedirectAllRequestsTo,
