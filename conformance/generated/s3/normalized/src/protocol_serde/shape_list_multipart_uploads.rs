...
> {
    ...
    let mut generic_builder = super::super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::super::operation::list_multipart_uploads::ListMultipartUploadsError::unhandled)?;
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_multipart_uploads::builders::ListMultipartUploadsOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_multipart_uploads::de_list_multipart_uploads(_response_body, output)
            .map_err(super::super::operation::list_multipart_uploads::ListMultipartUploadsError::unhandled)?;
        output = output.set_request_charged(
            super::super::protocol_serde::shape_list_multipart_uploads_output::de_request_charged_header(_response_headers).map_err(|_| {
                super::super::operation::list_multipart_uploads::ListMultipartUploadsError::unhandled(
...
pub fn de_list_multipart_uploads(
    inp: &[u8],
    mut builder: super::super::operation::list_multipart_uploads::builders::ListMultipartUploadsOutputBuilder,
) -> std::result::Result<
    super::super::operation::list_multipart_uploads::builders::ListMultipartUploadsOutputBuilder,
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("Upload") /* Uploads com.amazonaws.s3.synthetic#ListMultipartUploadsOutput$Uploads */ =>  {
                let var_10 =
                    Some(
                        Result::<::std::vec::Vec::<super::super::types::MultipartUpload>, ::aws_smithy_xml::decode::XmlDecodeError>::Ok({
                            let mut list_11 = builder.uploads.take().unwrap_or_default();
                            list_11.push(
                                super::super::protocol_serde::shape_multipart_upload::de_multipart_upload(&mut tag, depth + 1)
                                ?
                            );
                            list_11
                        })
