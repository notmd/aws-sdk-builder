...
pub fn de_create_bucket_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::create_bucket::CreateBucketOutput, super::super::operation::create_bucket::CreateBucketError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::create_bucket::CreateBucketError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "BucketAlreadyExists" => super::super::operation::create_bucket::CreateBucketError::BucketAlreadyExists({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                let mut output = super::super::types::error::builders::BucketAlreadyExistsBuilder::default();
                output = super::super::protocol_serde::shape_bucket_already_exists::de_bucket_already_exists_xml_err(_response_body, output)
                    .map_err(super::super::operation::create_bucket::CreateBucketError::unhandled)?;
        ...
        "BucketAlreadyOwnedByYou" => super::super::operation::create_bucket::CreateBucketError::BucketAlreadyOwnedByYou({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_create_bucket_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::create_bucket::builders::CreateBucketOutputBuilder::default();
        output = output.set_bucket_arn(
            super::super::protocol_serde::shape_create_bucket_output::de_bucket_arn_header(_response_headers).map_err(|_| {
                super::super::operation::create_bucket::CreateBucketError::unhandled("Failed to parse BucketArn from header `x-amz-bucket-arn")
            })?,
        );
