...
pub fn de_transition(
    ...
    depth: u32,
) -> ::std::result::Result<super::super::types::Transition, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::super::types::Transition::builder();
...
pub fn ser_transition(
    input: &super::super::types::Transition,
