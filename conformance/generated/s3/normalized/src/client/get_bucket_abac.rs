...
impl super::Client {
    ...
    pub fn get_bucket_abac(&self) -> super::super::operation::get_bucket_abac::builders::GetBucketAbacFluentBuilder {
        super::super::operation::get_bucket_abac::builders::GetBucketAbacFluentBuilder::new(self.handle.clone())
    }
}
