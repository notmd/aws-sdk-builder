...
impl super::Client {
    ...
    pub fn get_bucket_logging(&self) -> super::super::operation::get_bucket_logging::builders::GetBucketLoggingFluentBuilder {
        super::super::operation::get_bucket_logging::builders::GetBucketLoggingFluentBuilder::new(self.handle.clone())
    }
}
