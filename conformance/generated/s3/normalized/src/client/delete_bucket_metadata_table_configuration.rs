...
impl super::Client {
    ...
    pub fn delete_bucket_metadata_table_configuration(
        &self,
    ) -> super::super::operation::delete_bucket_metadata_table_configuration::builders::DeleteBucketMetadataTableConfigurationFluentBuilder {
        super::super::operation::delete_bucket_metadata_table_configuration::builders::DeleteBucketMetadataTableConfigurationFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
