...
impl super::Client {
    ...
    pub fn get_bucket_cors(&self) -> super::super::operation::get_bucket_cors::builders::GetBucketCorsFluentBuilder {
        super::super::operation::get_bucket_cors::builders::GetBucketCorsFluentBuilder::new(self.handle.clone())
    }
}
