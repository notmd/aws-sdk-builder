...
impl super::Client {
    ...
    pub fn delete_bucket_website(&self) -> super::super::operation::delete_bucket_website::builders::DeleteBucketWebsiteFluentBuilder {
        super::super::operation::delete_bucket_website::builders::DeleteBucketWebsiteFluentBuilder::new(self.handle.clone())
    }
}
