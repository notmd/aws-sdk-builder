...
impl super::Client {
    ...
    pub fn get_bucket_ownership_controls(
        &self,
    ) -> super::super::operation::get_bucket_ownership_controls::builders::GetBucketOwnershipControlsFluentBuilder {
        super::super::operation::get_bucket_ownership_controls::builders::GetBucketOwnershipControlsFluentBuilder::new(self.handle.clone())
    }
}
