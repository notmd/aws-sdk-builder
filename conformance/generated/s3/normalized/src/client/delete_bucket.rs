...
impl super::Client {
    ...
    pub fn delete_bucket(&self) -> super::super::operation::delete_bucket::builders::DeleteBucketFluentBuilder {
        super::super::operation::delete_bucket::builders::DeleteBucketFluentBuilder::new(self.handle.clone())
    }
}
