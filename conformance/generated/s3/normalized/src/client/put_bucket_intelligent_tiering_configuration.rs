...
impl super::Client {
    ...
    pub fn put_bucket_intelligent_tiering_configuration(
        &self,
    ) -> super::super::operation::put_bucket_intelligent_tiering_configuration::builders::PutBucketIntelligentTieringConfigurationFluentBuilder {
        super::super::operation::put_bucket_intelligent_tiering_configuration::builders::PutBucketIntelligentTieringConfigurationFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
