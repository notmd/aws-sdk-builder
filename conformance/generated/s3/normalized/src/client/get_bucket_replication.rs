...
impl super::Client {
    ...
    pub fn get_bucket_replication(&self) -> super::super::operation::get_bucket_replication::builders::GetBucketReplicationFluentBuilder {
        super::super::operation::get_bucket_replication::builders::GetBucketReplicationFluentBuilder::new(self.handle.clone())
    }
}
