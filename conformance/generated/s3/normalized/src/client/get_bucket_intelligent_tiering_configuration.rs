...
impl super::Client {
    ...
    pub fn get_bucket_intelligent_tiering_configuration(
        &self,
    ) -> super::super::operation::get_bucket_intelligent_tiering_configuration::builders::GetBucketIntelligentTieringConfigurationFluentBuilder {
        super::super::operation::get_bucket_intelligent_tiering_configuration::builders::GetBucketIntelligentTieringConfigurationFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
