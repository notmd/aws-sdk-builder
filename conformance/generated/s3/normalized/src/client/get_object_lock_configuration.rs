...
impl super::Client {
    ...
    pub fn get_object_lock_configuration(
        &self,
    ) -> super::super::operation::get_object_lock_configuration::builders::GetObjectLockConfigurationFluentBuilder {
        super::super::operation::get_object_lock_configuration::builders::GetObjectLockConfigurationFluentBuilder::new(self.handle.clone())
    }
}
