...
impl super::Client {
    ...
    pub fn put_bucket_analytics_configuration(
        &self,
    ) -> super::super::operation::put_bucket_analytics_configuration::builders::PutBucketAnalyticsConfigurationFluentBuilder {
        super::super::operation::put_bucket_analytics_configuration::builders::PutBucketAnalyticsConfigurationFluentBuilder::new(self.handle.clone())
    }
}
