...
impl super::Client {
    ...
    pub fn get_bucket_tagging(&self) -> super::super::operation::get_bucket_tagging::builders::GetBucketTaggingFluentBuilder {
        super::super::operation::get_bucket_tagging::builders::GetBucketTaggingFluentBuilder::new(self.handle.clone())
    }
}
