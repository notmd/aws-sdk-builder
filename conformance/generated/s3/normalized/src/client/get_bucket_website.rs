...
impl super::Client {
    ...
    pub fn get_bucket_website(&self) -> super::super::operation::get_bucket_website::builders::GetBucketWebsiteFluentBuilder {
        super::super::operation::get_bucket_website::builders::GetBucketWebsiteFluentBuilder::new(self.handle.clone())
    }
}
