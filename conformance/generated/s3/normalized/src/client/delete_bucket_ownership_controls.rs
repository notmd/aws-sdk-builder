...
impl super::Client {
    ...
    pub fn delete_bucket_ownership_controls(
        &self,
    ) -> super::super::operation::delete_bucket_ownership_controls::builders::DeleteBucketOwnershipControlsFluentBuilder {
        super::super::operation::delete_bucket_ownership_controls::builders::DeleteBucketOwnershipControlsFluentBuilder::new(self.handle.clone())
    }
}
