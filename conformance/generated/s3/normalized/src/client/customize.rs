...
impl<E, B> CustomizableOperation<super::super::operation::put_object::PutObjectOutput, E, B> {
...
impl<E, B> CustomizableOperation<super::super::operation::upload_part::UploadPartOutput, E, B> {
    /// Disable payload signing for this request.
    ///
    /// **WARNING:** This is an advanced feature that removes
    /// the cost of signing a request payload by removing a data
...
impl<T, E, B> CustomizableOperation<T, E, B> {
    ...
    pub(crate) fn execute<U>(self, f: impl ::std::ops::FnOnce(B, super::super::config::Builder) -> U) -> U {
    ...
    pub fn config_override(mut self, config_override: impl ::std::convert::Into<super::super::config::Builder>) -> Self {
        self.config_override = Some(config_override.into());
        self
    }

    /// Sends the request and returns the response.
    pub async fn send(self) -> super::super::client::customize::internal::SendResult<T, E>
    where
        E: std::error::Error + ::std::marker::Send + ::std::marker::Sync + 'static,
        B: super::super::client::customize::internal::CustomizableSend<T, E>,
    {
    ...
    pub async fn presigned(
        mut self,
        presigning_config: super::super::presigning::PresigningConfig,
    ) -> ::std::result::Result<super::super::presigning::PresignedRequest, super::super::error::SdkError<E>>
    where
        E: std::error::Error + ::std::marker::Send + ::std::marker::Sync + 'static,
        B: super::super::client::customize::internal::CustomizablePresigned<E>,
    {
