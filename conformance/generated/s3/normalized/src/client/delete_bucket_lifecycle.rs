...
impl super::Client {
    ...
    pub fn delete_bucket_lifecycle(&self) -> super::super::operation::delete_bucket_lifecycle::builders::DeleteBucketLifecycleFluentBuilder {
        super::super::operation::delete_bucket_lifecycle::builders::DeleteBucketLifecycleFluentBuilder::new(self.handle.clone())
    }
}
