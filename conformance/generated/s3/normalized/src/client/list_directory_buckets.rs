...
impl super::Client {
    ...
    pub fn list_directory_buckets(&self) -> super::super::operation::list_directory_buckets::builders::ListDirectoryBucketsFluentBuilder {
        super::super::operation::list_directory_buckets::builders::ListDirectoryBucketsFluentBuilder::new(self.handle.clone())
    }
}
