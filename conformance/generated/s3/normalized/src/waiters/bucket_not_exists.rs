...
pub struct BucketNotExistsFluentBuilder {
    ...
    inner: super::super::operation::head_bucket::builders::HeadBucketInputBuilder,
}
impl BucketNotExistsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::operation::head_bucket::builders::HeadBucketInputBuilder {
        &self.inner
    }
    ...
    pub async fn wait(
        ...
        super::super::waiters::bucket_not_exists::BucketNotExistsFinalPoll,
        super::super::waiters::bucket_not_exists::WaitUntilBucketNotExistsError,
    > {
        let input = self
            .inner
            .build()
            .map_err(::aws_smithy_runtime_api::client::waiters::error::WaiterError::construction_failure)?;
        let runtime_plugins = super::super::operation::head_bucket::HeadBucket::operation_runtime_plugins(
        ...
        >| {
            ...
            if super::super::waiters::matchers::match_head_bucket_01223db2f9ae15f05(result) {
        ...
        let operation = move || {
            ...
            async move { super::super::operation::head_bucket::HeadBucket::orchestrate(&runtime_plugins, input).await }
        };
