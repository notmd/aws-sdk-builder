...
pub struct ObjectNotExistsFluentBuilder {
    ...
    inner: super::super::operation::head_object::builders::HeadObjectInputBuilder,
}
impl ObjectNotExistsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::operation::head_object::builders::HeadObjectInputBuilder {
        &self.inner
    }
    ...
    pub async fn wait(
        ...
        super::super::waiters::object_not_exists::ObjectNotExistsFinalPoll,
        super::super::waiters::object_not_exists::WaitUntilObjectNotExistsError,
    > {
        let input = self
            .inner
            .build()
            .map_err(::aws_smithy_runtime_api::client::waiters::error::WaiterError::construction_failure)?;
        let runtime_plugins = super::super::operation::head_object::HeadObject::operation_runtime_plugins(
        ...
        >| {
            ...
            if super::super::waiters::matchers::match_head_object_01223db2f9ae15f05(result) {
        ...
        let operation = move || {
            ...
            async move { super::super::operation::head_object::HeadObject::orchestrate(&runtime_plugins, input).await }
        };
    ...
    /// <p>This functionality is not supported for directory buckets.</p>
    /// </note>
    pub fn request_payer(mut self, input: super::super::types::RequestPayer) -> Self {
    ...
    /// <p>This functionality is not supported for directory buckets.</p>
    /// </note>
    pub fn set_request_payer(mut self, input: ::std::option::Option<super::super::types::RequestPayer>) -> Self {
    ...
    /// <p>This functionality is not supported for directory buckets.</p>
    /// </note>
    pub fn get_request_payer(&self) -> &::std::option::Option<super::super::types::RequestPayer> {
    ...
    pub fn checksum_mode(mut self, input: super::super::types::ChecksumMode) -> Self {
    ...
    /// <p><b>General purpose buckets</b> - If you enable checksum mode and the object is uploaded with a <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_Checksum.html">checksum</a> and encrypted with an Key Management Service (KMS) key, you must have permission to use the <code>kms:Decrypt</code> action to retrieve the checksum.</p>
    /// <p><b>Directory buckets</b> - If you enable <code>ChecksumMode</code> and the object is encrypted with Amazon Web Services Key Management Service (Amazon Web Services KMS), you must also have the <code>kms:GenerateDataKey</code> and <code>kms:Decrypt</code> permissions in IAM identity-based policies and KMS key policies for the KMS key to retrieve the checksum of the object.</p>
    pub fn set_checksum_mode(mut self, input: ::std::option::Option<super::super::types::ChecksumMode>) -> Self {
    ...
    /// <p><b>General purpose buckets</b> - If you enable checksum mode and the object is uploaded with a <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_Checksum.html">checksum</a> and encrypted with an Key Management Service (KMS) key, you must have permission to use the <code>kms:Decrypt</code> action to retrieve the checksum.</p>
    /// <p><b>Directory buckets</b> - If you enable <code>ChecksumMode</code> and the object is encrypted with Amazon Web Services Key Management Service (Amazon Web Services KMS), you must also have the <code>kms:GenerateDataKey</code> and <code>kms:Decrypt</code> permissions in IAM identity-based policies and KMS key policies for the KMS key to retrieve the checksum of the object.</p>
    pub fn get_checksum_mode(&self) -> &::std::option::Option<super::super::types::ChecksumMode> {
