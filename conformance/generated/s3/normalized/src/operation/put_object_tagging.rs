...
impl PutObjectTagging {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::put_object_tagging::PutObjectTaggingInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::put_object_tagging::PutObjectTaggingError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::put_object_tagging::PutObjectTaggingOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutObjectTaggingResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_put_object_tagging::de_put_object_tagging_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_put_object_tagging::de_put_object_tagging_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutObjectTaggingRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::put_object_tagging::PutObjectTaggingInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::put_object_tagging::PutObjectTaggingInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::super::protocol_serde::shape_put_object_tagging::ser_put_object_tagging_headers(input, builder)?;
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_put_object_tagging_input::ser_tagging_http_payload(
            &input.tagging,
        )?);
...
impl super::super::s3_request_id::RequestIdExt for super::super::operation::put_object_tagging::PutObjectTaggingError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::super::operation::put_object_tagging::PutObjectTaggingError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::put_object_tagging::_put_object_tagging_input::PutObjectTaggingInput;

pub use super::super::operation::put_object_tagging::_put_object_tagging_output::PutObjectTaggingOutput;
