...
impl super::super::super::s3_request_id::RequestIdExt for DeleteBucketMetadataConfigurationOutput {
...
impl DeleteBucketMetadataConfigurationOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_bucket_metadata_configuration::DeleteBucketMetadataConfigurationOutput {
