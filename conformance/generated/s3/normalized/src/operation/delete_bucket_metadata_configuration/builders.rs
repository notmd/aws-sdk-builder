...
pub use super::super::super::operation::delete_bucket_metadata_configuration::_delete_bucket_metadata_configuration_input::DeleteBucketMetadataConfigurationInputBuilder;

pub use super::super::super::operation::delete_bucket_metadata_configuration::_delete_bucket_metadata_configuration_output::DeleteBucketMetadataConfigurationOutputBuilder;

impl super::super::super::operation::delete_bucket_metadata_configuration::builders::DeleteBucketMetadataConfigurationInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_bucket_metadata_configuration::DeleteBucketMetadataConfigurationOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_bucket_metadata_configuration::DeleteBucketMetadataConfigurationError,
...
pub struct DeleteBucketMetadataConfigurationFluentBuilder {
    ...
    inner: super::super::super::operation::delete_bucket_metadata_configuration::builders::DeleteBucketMetadataConfigurationInputBuilder,
