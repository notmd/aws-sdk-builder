...
pub use super::super::super::operation::delete_bucket_website::_delete_bucket_website_input::DeleteBucketWebsiteInputBuilder;

pub use super::super::super::operation::delete_bucket_website::_delete_bucket_website_output::DeleteBucketWebsiteOutputBuilder;

impl super::super::super::operation::delete_bucket_website::builders::DeleteBucketWebsiteInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_bucket_website::DeleteBucketWebsiteOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_bucket_website::DeleteBucketWebsiteError,
...
pub struct DeleteBucketWebsiteFluentBuilder {
    ...
    inner: super::super::super::operation::delete_bucket_website::builders::DeleteBucketWebsiteInputBuilder,
...
impl DeleteBucketWebsiteFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_bucket_website::builders::DeleteBucketWebsiteInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_bucket_website::DeleteBucketWebsite::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_bucket_website::DeleteBucketWebsite::orchestrate(&runtime_plugins, input).await
    }
