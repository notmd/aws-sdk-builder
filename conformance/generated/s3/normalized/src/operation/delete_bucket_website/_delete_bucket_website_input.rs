...
impl DeleteBucketWebsiteInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_bucket_website::builders::DeleteBucketWebsiteInputBuilder {
        super::super::super::operation::delete_bucket_website::builders::DeleteBucketWebsiteInputBuilder::default()
    }
}
