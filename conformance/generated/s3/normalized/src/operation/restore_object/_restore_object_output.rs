...
impl super::super::super::s3_request_id::RequestIdExt for RestoreObjectOutput {
...
impl RestoreObjectOutput {
    ...
    pub fn builder() -> super::super::super::operation::restore_object::builders::RestoreObjectOutputBuilder {
        super::super::super::operation::restore_object::builders::RestoreObjectOutputBuilder::default()
    }
}
...
impl RestoreObjectOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::restore_object::RestoreObjectOutput {
