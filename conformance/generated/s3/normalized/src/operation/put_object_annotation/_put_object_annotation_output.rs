...
impl super::super::super::s3_request_id::RequestIdExt for PutObjectAnnotationOutput {
...
impl PutObjectAnnotationOutput {
    ...
    pub fn builder() -> super::super::super::operation::put_object_annotation::builders::PutObjectAnnotationOutputBuilder {
        super::super::super::operation::put_object_annotation::builders::PutObjectAnnotationOutputBuilder::default()
    }
}
...
impl PutObjectAnnotationOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::put_object_annotation::PutObjectAnnotationOutput {
        super::super::super::operation::put_object_annotation::PutObjectAnnotationOutput {
            key: self.key,
