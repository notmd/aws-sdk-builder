...
impl super::super::super::s3_request_id::RequestIdExt for DeleteObjectAnnotationOutput {
...
impl DeleteObjectAnnotationOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_object_annotation::builders::DeleteObjectAnnotationOutputBuilder {
        super::super::super::operation::delete_object_annotation::builders::DeleteObjectAnnotationOutputBuilder::default()
    }
}
...
impl DeleteObjectAnnotationOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_object_annotation::DeleteObjectAnnotationOutput {
