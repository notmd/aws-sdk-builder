...
impl super::super::super::s3_request_id::RequestIdExt for PutPublicAccessBlockOutput {
...
impl PutPublicAccessBlockOutput {
    ...
    pub fn builder() -> super::super::super::operation::put_public_access_block::builders::PutPublicAccessBlockOutputBuilder {
        super::super::super::operation::put_public_access_block::builders::PutPublicAccessBlockOutputBuilder::default()
    }
}
...
impl PutPublicAccessBlockOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::put_public_access_block::PutPublicAccessBlockOutput {
