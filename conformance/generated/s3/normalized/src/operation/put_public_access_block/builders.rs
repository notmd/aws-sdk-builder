...
pub use super::super::super::operation::put_public_access_block::_put_public_access_block_input::PutPublicAccessBlockInputBuilder;

pub use super::super::super::operation::put_public_access_block::_put_public_access_block_output::PutPublicAccessBlockOutputBuilder;

impl super::super::super::operation::put_public_access_block::builders::PutPublicAccessBlockInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::put_public_access_block::PutPublicAccessBlockOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::put_public_access_block::PutPublicAccessBlockError,
...
pub struct PutPublicAccessBlockFluentBuilder {
    ...
    inner: super::super::super::operation::put_public_access_block::builders::PutPublicAccessBlockInputBuilder,
...
impl PutPublicAccessBlockFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::put_public_access_block::builders::PutPublicAccessBlockInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::put_public_access_block::PutPublicAccessBlock::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::put_public_access_block::PutPublicAccessBlock::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn public_access_block_configuration(mut self, input: super::super::super::types::PublicAccessBlockConfiguration) -> Self {
    ...
    /// <p>The <code>PublicAccessBlock</code> configuration that you want to apply to this Amazon S3 bucket. You can enable the configuration options in any combination. For more information about when Amazon S3 considers a bucket or object public, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/access-control-block-public-access.html#access-control-block-public-access-policy-status">The Meaning of "Public"</a> in the <i>Amazon S3 User Guide</i>.</p>
    pub fn get_public_access_block_configuration(&self) -> &::std::option::Option<super::super::super::types::PublicAccessBlockConfiguration> {
