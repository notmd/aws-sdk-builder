...
impl GetBucketAbacInput {
    ...
    pub fn builder() -> super::super::super::operation::get_bucket_abac::builders::GetBucketAbacInputBuilder {
        super::super::super::operation::get_bucket_abac::builders::GetBucketAbacInputBuilder::default()
    }
}
