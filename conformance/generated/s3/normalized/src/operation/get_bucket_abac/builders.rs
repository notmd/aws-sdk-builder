...
pub use super::super::super::operation::get_bucket_abac::_get_bucket_abac_input::GetBucketAbacInputBuilder;

pub use super::super::super::operation::get_bucket_abac::_get_bucket_abac_output::GetBucketAbacOutputBuilder;

impl super::super::super::operation::get_bucket_abac::builders::GetBucketAbacInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::get_bucket_abac::GetBucketAbacOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::get_bucket_abac::GetBucketAbacError,
...
pub struct GetBucketAbacFluentBuilder {
    ...
    inner: super::super::super::operation::get_bucket_abac::builders::GetBucketAbacInputBuilder,
...
impl GetBucketAbacFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::get_bucket_abac::builders::GetBucketAbacInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::get_bucket_abac::GetBucketAbac::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::get_bucket_abac::GetBucketAbac::orchestrate(&runtime_plugins, input).await
    }
