...
impl GetObjectTaggingInput {
    ...
    pub fn builder() -> super::super::super::operation::get_object_tagging::builders::GetObjectTaggingInputBuilder {
        super::super::super::operation::get_object_tagging::builders::GetObjectTaggingInputBuilder::default()
    }
}
