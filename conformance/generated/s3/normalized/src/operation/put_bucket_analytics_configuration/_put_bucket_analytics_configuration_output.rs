...
impl super::super::super::s3_request_id::RequestIdExt for PutBucketAnalyticsConfigurationOutput {
...
impl PutBucketAnalyticsConfigurationOutput {
    ...
    pub fn builder() -> super::super::super::operation::put_bucket_analytics_configuration::builders::PutBucketAnalyticsConfigurationOutputBuilder {
        super::super::super::operation::put_bucket_analytics_configuration::builders::PutBucketAnalyticsConfigurationOutputBuilder::default()
    }
}
...
impl PutBucketAnalyticsConfigurationOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::put_bucket_analytics_configuration::PutBucketAnalyticsConfigurationOutput {
