...
impl GetObjectLockConfigurationInput {
    ...
    pub fn builder() -> super::super::super::operation::get_object_lock_configuration::builders::GetObjectLockConfigurationInputBuilder {
        super::super::super::operation::get_object_lock_configuration::builders::GetObjectLockConfigurationInputBuilder::default()
    }
}
