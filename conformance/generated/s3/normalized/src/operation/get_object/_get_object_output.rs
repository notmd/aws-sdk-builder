...
impl super::super::super::s3_request_id::RequestIdExt for GetObjectOutput {
...
impl GetObjectOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_object::builders::GetObjectOutputBuilder {
        super::super::super::operation::get_object::builders::GetObjectOutputBuilder::default()
    }
}
...
impl GetObjectOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::get_object::GetObjectOutput {
