...
pub use super::super::super::operation::get_object::_get_object_input::GetObjectInputBuilder;

pub use super::super::super::operation::get_object::_get_object_output::GetObjectOutputBuilder;

impl super::super::super::operation::get_object::builders::GetObjectInputBuilder {
...
impl GetObjectFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::get_object::builders::GetObjectInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::get_object::GetObject::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::get_object::GetObject::orchestrate(&runtime_plugins, input).await
    }
    ...
    > {
        ...
        let input = self
            ...
            .build()
            .map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
        let mut context = super::super::super::operation::get_object::GetObject::orchestrate_with_stop_point(
            &runtime_plugins,
            input,
        ...
        .map_err(|err| {
            err.map_service_error(|err| {
                err.downcast::<super::super::super::operation::get_object::GetObjectError>()
    ...
    pub fn checksum_mode(mut self, input: super::super::super::types::ChecksumMode) -> Self {
        self.inner = self.inner.checksum_mode(input);
        self
    }
    /// <p>To retrieve the checksum, this mode must be enabled.</p>
    pub fn set_checksum_mode(mut self, input: ::std::option::Option<super::super::super::types::ChecksumMode>) -> Self {
        self.inner = self.inner.set_checksum_mode(input);
        self
    }
    /// <p>To retrieve the checksum, this mode must be enabled.</p>
    pub fn get_checksum_mode(&self) -> &::std::option::Option<super::super::super::types::ChecksumMode> {
