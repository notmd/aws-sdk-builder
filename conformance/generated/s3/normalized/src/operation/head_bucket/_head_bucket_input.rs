...
impl HeadBucketInput {
    ...
    pub fn builder() -> super::super::super::operation::head_bucket::builders::HeadBucketInputBuilder {
        super::super::super::operation::head_bucket::builders::HeadBucketInputBuilder::default()
    }
}
