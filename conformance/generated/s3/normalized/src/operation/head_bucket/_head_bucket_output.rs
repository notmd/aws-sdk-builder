...
impl HeadBucketOutput {
    ...
    /// <p>This functionality is only supported by directory buckets.</p>
    /// </note>
    pub fn bucket_location_type(&self) -> ::std::option::Option<&super::super::super::types::LocationType> {
...
impl super::super::super::s3_request_id::RequestIdExt for HeadBucketOutput {
...
impl HeadBucketOutput {
    ...
    pub fn builder() -> super::super::super::operation::head_bucket::builders::HeadBucketOutputBuilder {
        super::super::super::operation::head_bucket::builders::HeadBucketOutputBuilder::default()
    }
}
...
pub struct HeadBucketOutputBuilder {
    ...
    pub(crate) bucket_location_type: ::std::option::Option<super::super::super::types::LocationType>,
...
impl HeadBucketOutputBuilder {
    ...
    /// <p>This functionality is only supported by directory buckets.</p>
    /// </note>
    pub fn bucket_location_type(mut self, input: super::super::super::types::LocationType) -> Self {
    ...
    /// <p>This functionality is only supported by directory buckets.</p>
    /// </note>
    pub fn set_bucket_location_type(mut self, input: ::std::option::Option<super::super::super::types::LocationType>) -> Self {
    ...
    /// <p>This functionality is only supported by directory buckets.</p>
    /// </note>
    pub fn get_bucket_location_type(&self) -> &::std::option::Option<super::super::super::types::LocationType> {
    ...
    pub fn build(self) -> super::super::super::operation::head_bucket::HeadBucketOutput {
