...
pub use super::super::super::operation::head_bucket::_head_bucket_input::HeadBucketInputBuilder;

pub use super::super::super::operation::head_bucket::_head_bucket_output::HeadBucketOutputBuilder;

impl super::super::super::operation::head_bucket::builders::HeadBucketInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::head_bucket::HeadBucketOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::head_bucket::HeadBucketError,
...
/// <li>
/// <p><b>Directory bucket permissions</b> - You must have the <b> <code>s3express:CreateSession</code> </b> permission in the <code>Action</code> element of a policy. If no session mode is specified, the session will be created with the maximum allowable privilege, attempting <code>ReadWrite</code> first, then <code>ReadOnly</code> if <code>ReadWrite</code> is not permitted. If you want to explicitly restrict the access to be read-only, you can set the <code>s3express:SessionMode</code> condition key to <code>ReadOnly</code> on the bucket.</p>
...
pub struct HeadBucketFluentBuilder {
    ...
    inner: super::super::super::operation::head_bucket::builders::HeadBucketInputBuilder,
...
impl HeadBucketFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::head_bucket::builders::HeadBucketInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::head_bucket::HeadBucket::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::head_bucket::HeadBucket::orchestrate(&runtime_plugins, input).await
    }
