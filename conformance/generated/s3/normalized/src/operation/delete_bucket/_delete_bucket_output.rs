...
impl super::super::super::s3_request_id::RequestIdExt for DeleteBucketOutput {
...
impl DeleteBucketOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_bucket::builders::DeleteBucketOutputBuilder {
        super::super::super::operation::delete_bucket::builders::DeleteBucketOutputBuilder::default()
    }
}
...
impl DeleteBucketOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_bucket::DeleteBucketOutput {
