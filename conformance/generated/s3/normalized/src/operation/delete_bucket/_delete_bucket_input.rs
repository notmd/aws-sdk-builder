...
impl DeleteBucketInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_bucket::builders::DeleteBucketInputBuilder {
        super::super::super::operation::delete_bucket::builders::DeleteBucketInputBuilder::default()
    }
}
