...
impl CreateBucketMetadataTableConfigurationInput {
    ...
    /// <p>The contents of your metadata table configuration.</p>
    pub fn metadata_table_configuration(&self) -> ::std::option::Option<&super::super::super::types::MetadataTableConfiguration> {
...
pub struct CreateBucketMetadataTableConfigurationInputBuilder {
    ...
    pub(crate) metadata_table_configuration: ::std::option::Option<super::super::super::types::MetadataTableConfiguration>,
...
impl CreateBucketMetadataTableConfigurationInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::create_bucket_metadata_table_configuration::CreateBucketMetadataTableConfigurationInput,
