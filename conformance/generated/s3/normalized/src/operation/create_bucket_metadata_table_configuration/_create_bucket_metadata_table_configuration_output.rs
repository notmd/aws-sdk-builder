...
impl super::super::super::s3_request_id::RequestIdExt for CreateBucketMetadataTableConfigurationOutput {
...
impl CreateBucketMetadataTableConfigurationOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::create_bucket_metadata_table_configuration::CreateBucketMetadataTableConfigurationOutput {
