...
impl UpdateBucketMetadataInventoryTableConfigurationInput {
    ...
    /// <p>The contents of your inventory table configuration.</p>
    pub fn inventory_table_configuration(&self) -> ::std::option::Option<&super::super::super::types::InventoryTableConfigurationUpdates> {
...
pub struct UpdateBucketMetadataInventoryTableConfigurationInputBuilder {
    ...
    pub(crate) inventory_table_configuration: ::std::option::Option<super::super::super::types::InventoryTableConfigurationUpdates>,
