...
impl ListObjectAnnotationsInput {
    ...
    pub fn builder() -> super::super::super::operation::list_object_annotations::builders::ListObjectAnnotationsInputBuilder {
        super::super::super::operation::list_object_annotations::builders::ListObjectAnnotationsInputBuilder::default()
    }
}
