...
pub use super::super::super::operation::delete_bucket_tagging::_delete_bucket_tagging_input::DeleteBucketTaggingInputBuilder;

pub use super::super::super::operation::delete_bucket_tagging::_delete_bucket_tagging_output::DeleteBucketTaggingOutputBuilder;

impl super::super::super::operation::delete_bucket_tagging::builders::DeleteBucketTaggingInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_bucket_tagging::DeleteBucketTaggingOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_bucket_tagging::DeleteBucketTaggingError,
...
pub struct DeleteBucketTaggingFluentBuilder {
    ...
    inner: super::super::super::operation::delete_bucket_tagging::builders::DeleteBucketTaggingInputBuilder,
...
impl DeleteBucketTaggingFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_bucket_tagging::builders::DeleteBucketTaggingInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_bucket_tagging::DeleteBucketTagging::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_bucket_tagging::DeleteBucketTagging::orchestrate(&runtime_plugins, input).await
    }
