...
impl DeleteBucketTaggingInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_bucket_tagging::builders::DeleteBucketTaggingInputBuilder {
        super::super::super::operation::delete_bucket_tagging::builders::DeleteBucketTaggingInputBuilder::default()
    }
}
