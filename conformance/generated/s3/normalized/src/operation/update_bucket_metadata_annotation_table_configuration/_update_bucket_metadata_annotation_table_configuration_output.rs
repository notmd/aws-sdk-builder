...
impl super::super::super::s3_request_id::RequestIdExt for UpdateBucketMetadataAnnotationTableConfigurationOutput {
    fn extended_request_id(&self) -> Option<&str> {
        self._extended_request_id.as_deref()
    }
}
impl ::aws_types::request_id::RequestId for UpdateBucketMetadataAnnotationTableConfigurationOutput {
...
impl UpdateBucketMetadataAnnotationTableConfigurationOutput {
    ...
    pub fn builder() -> super::super::super::operation::update_bucket_metadata_annotation_table_configuration::builders::UpdateBucketMetadataAnnotationTableConfigurationOutputBuilder{
        super::super::super::operation::update_bucket_metadata_annotation_table_configuration::builders::UpdateBucketMetadataAnnotationTableConfigurationOutputBuilder::default()
    }
}
...
impl UpdateBucketMetadataAnnotationTableConfigurationOutputBuilder {
