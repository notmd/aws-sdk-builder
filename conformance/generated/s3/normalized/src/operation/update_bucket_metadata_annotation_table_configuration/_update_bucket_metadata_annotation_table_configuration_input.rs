...
impl UpdateBucketMetadataAnnotationTableConfigurationInput {
    ...
    /// <p>The annotation table configuration updates to apply.</p>
    pub fn annotation_table_configuration(&self) -> ::std::option::Option<&super::super::super::types::AnnotationTableConfigurationUpdates> {
...
pub struct UpdateBucketMetadataAnnotationTableConfigurationInputBuilder {
    ...
    pub(crate) annotation_table_configuration: ::std::option::Option<super::super::super::types::AnnotationTableConfigurationUpdates>,
