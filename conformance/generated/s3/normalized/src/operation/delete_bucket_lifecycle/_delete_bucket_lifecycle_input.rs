...
impl DeleteBucketLifecycleInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_bucket_lifecycle::builders::DeleteBucketLifecycleInputBuilder {
        super::super::super::operation::delete_bucket_lifecycle::builders::DeleteBucketLifecycleInputBuilder::default()
    }
}
