...
impl super::super::super::s3_request_id::RequestIdExt for CreateBucketOutput {
...
impl CreateBucketOutput {
    ...
    pub fn builder() -> super::super::super::operation::create_bucket::builders::CreateBucketOutputBuilder {
        super::super::super::operation::create_bucket::builders::CreateBucketOutputBuilder::default()
    }
}
...
impl CreateBucketOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::create_bucket::CreateBucketOutput {
