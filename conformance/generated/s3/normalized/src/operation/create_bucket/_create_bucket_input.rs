...
impl CreateBucketInput {
    ...
    /// <p>This functionality is not supported for directory buckets.</p>
    /// </note>
    pub fn acl(&self) -> ::std::option::Option<&super::super::super::types::BucketCannedAcl> {
        self.acl.as_ref()
    }
    /// <p>The name of the bucket to create.</p>
    /// <p><b>General purpose buckets</b> - For information about bucket naming restrictions, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/bucketnamingrules.html">Bucket naming rules</a> in the <i>Amazon S3 User Guide</i>.</p>
    ...
    /// <p>The configuration information for the bucket.</p>
    pub fn create_bucket_configuration(&self) -> ::std::option::Option<&super::super::super::types::CreateBucketConfiguration> {
    ...
    /// <p>This functionality is not supported for directory buckets. Directory buckets use the bucket owner enforced setting for S3 Object Ownership.</p>
    /// </note>
    pub fn object_ownership(&self) -> ::std::option::Option<&super::super::super::types::ObjectOwnership> {
    ...
    /// <p>This functionality is not supported for directory buckets.</p>
    /// </note>
    pub fn bucket_namespace(&self) -> ::std::option::Option<&super::super::super::types::BucketNamespace> {
...
impl CreateBucketInput {
    ...
    pub fn builder() -> super::super::super::operation::create_bucket::builders::CreateBucketInputBuilder {
        super::super::super::operation::create_bucket::builders::CreateBucketInputBuilder::default()
    }
}
...
pub struct CreateBucketInputBuilder {
    pub(crate) acl: ::std::option::Option<super::super::super::types::BucketCannedAcl>,
    pub(crate) bucket: ::std::option::Option<::std::string::String>,
    pub(crate) create_bucket_configuration: ::std::option::Option<super::super::super::types::CreateBucketConfiguration>,
    ...
    pub(crate) object_ownership: ::std::option::Option<super::super::super::types::ObjectOwnership>,
    pub(crate) bucket_namespace: ::std::option::Option<super::super::super::types::BucketNamespace>,
}
impl CreateBucketInputBuilder {
    /// <p>The canned ACL to apply to the bucket.</p><note>
    /// <p>This functionality is not supported for directory buckets.</p>
    /// </note>
    pub fn acl(mut self, input: super::super::super::types::BucketCannedAcl) -> Self {
    ...
    /// <p>This functionality is not supported for directory buckets.</p>
    /// </note>
    pub fn set_acl(mut self, input: ::std::option::Option<super::super::super::types::BucketCannedAcl>) -> Self {
        self.acl = input;
        self
    }
    /// <p>The canned ACL to apply to the bucket.</p><note>
    /// <p>This functionality is not supported for directory buckets.</p>
    /// </note>
    pub fn get_acl(&self) -> &::std::option::Option<super::super::super::types::BucketCannedAcl> {
        &self.acl
    }
    /// <p>The name of the bucket to create.</p>
    /// <p><b>General purpose buckets</b> - For information about bucket naming restrictions, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/bucketnamingrules.html">Bucket naming rules</a> in the <i>Amazon S3 User Guide</i>.</p>
    ...
    /// <p>The configuration information for the bucket.</p>
    pub fn create_bucket_configuration(mut self, input: super::super::super::types::CreateBucketConfiguration) -> Self {
        self.create_bucket_configuration = ::std::option::Option::Some(input);
        self
    }
    /// <p>The configuration information for the bucket.</p>
    pub fn set_create_bucket_configuration(mut self, input: ::std::option::Option<super::super::super::types::CreateBucketConfiguration>) -> Self {
        self.create_bucket_configuration = input;
        self
    }
    /// <p>The configuration information for the bucket.</p>
    pub fn get_create_bucket_configuration(&self) -> &::std::option::Option<super::super::super::types::CreateBucketConfiguration> {
    ...
    /// <p>This functionality is not supported for directory buckets. Directory buckets use the bucket owner enforced setting for S3 Object Ownership.</p>
    /// </note>
    pub fn object_ownership(mut self, input: super::super::super::types::ObjectOwnership) -> Self {
    ...
    /// <p>This functionality is not supported for directory buckets. Directory buckets use the bucket owner enforced setting for S3 Object Ownership.</p>
    /// </note>
    pub fn set_object_ownership(mut self, input: ::std::option::Option<super::super::super::types::ObjectOwnership>) -> Self {
    ...
    /// <p>This functionality is not supported for directory buckets. Directory buckets use the bucket owner enforced setting for S3 Object Ownership.</p>
    /// </note>
    pub fn get_object_ownership(&self) -> &::std::option::Option<super::super::super::types::ObjectOwnership> {
    ...
    /// <p>This functionality is not supported for directory buckets.</p>
    /// </note>
    pub fn bucket_namespace(mut self, input: super::super::super::types::BucketNamespace) -> Self {
    ...
    /// <p>This functionality is not supported for directory buckets.</p>
    /// </note>
    pub fn set_bucket_namespace(mut self, input: ::std::option::Option<super::super::super::types::BucketNamespace>) -> Self {
    ...
    /// <p>This functionality is not supported for directory buckets.</p>
    /// </note>
    pub fn get_bucket_namespace(&self) -> &::std::option::Option<super::super::super::types::BucketNamespace> {
