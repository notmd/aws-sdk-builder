...
impl GetObjectRetentionInput {
    ...
    pub fn builder() -> super::super::super::operation::get_object_retention::builders::GetObjectRetentionInputBuilder {
        super::super::super::operation::get_object_retention::builders::GetObjectRetentionInputBuilder::default()
    }
}
