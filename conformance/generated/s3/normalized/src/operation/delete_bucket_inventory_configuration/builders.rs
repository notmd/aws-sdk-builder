...
pub use super::super::super::operation::delete_bucket_inventory_configuration::_delete_bucket_inventory_configuration_input::DeleteBucketInventoryConfigurationInputBuilder;

pub use super::super::super::operation::delete_bucket_inventory_configuration::_delete_bucket_inventory_configuration_output::DeleteBucketInventoryConfigurationOutputBuilder;

impl super::super::super::operation::delete_bucket_inventory_configuration::builders::DeleteBucketInventoryConfigurationInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_bucket_inventory_configuration::DeleteBucketInventoryConfigurationOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_bucket_inventory_configuration::DeleteBucketInventoryConfigurationError,
...
pub struct DeleteBucketInventoryConfigurationFluentBuilder {
    ...
    inner: super::super::super::operation::delete_bucket_inventory_configuration::builders::DeleteBucketInventoryConfigurationInputBuilder,
