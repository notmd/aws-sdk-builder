...
impl super::super::super::s3_request_id::RequestIdExt for DeleteBucketInventoryConfigurationOutput {
...
impl DeleteBucketInventoryConfigurationOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_bucket_inventory_configuration::DeleteBucketInventoryConfigurationOutput {
