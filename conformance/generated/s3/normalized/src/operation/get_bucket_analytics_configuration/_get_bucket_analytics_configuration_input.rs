...
impl GetBucketAnalyticsConfigurationInput {
    ...
    pub fn builder() -> super::super::super::operation::get_bucket_analytics_configuration::builders::GetBucketAnalyticsConfigurationInputBuilder {
        super::super::super::operation::get_bucket_analytics_configuration::builders::GetBucketAnalyticsConfigurationInputBuilder::default()
    }
}
...
impl GetBucketAnalyticsConfigurationInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::get_bucket_analytics_configuration::GetBucketAnalyticsConfigurationInput,
