...
impl super::super::super::s3_request_id::RequestIdExt for GetBucketPolicyOutput {
...
impl GetBucketPolicyOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_bucket_policy::builders::GetBucketPolicyOutputBuilder {
        super::super::super::operation::get_bucket_policy::builders::GetBucketPolicyOutputBuilder::default()
    }
}
...
impl GetBucketPolicyOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::get_bucket_policy::GetBucketPolicyOutput {
