...
impl CreateSessionOutput {
    ...
    /// <p>The established temporary security credentials for the created session.</p>
    pub fn credentials(&self) -> ::std::option::Option<&super::super::super::types::SessionCredentials> {
...
impl super::super::super::s3_request_id::RequestIdExt for CreateSessionOutput {
...
impl CreateSessionOutput {
    ...
    pub fn builder() -> super::super::super::operation::create_session::builders::CreateSessionOutputBuilder {
        super::super::super::operation::create_session::builders::CreateSessionOutputBuilder::default()
    }
}
...
pub struct CreateSessionOutputBuilder {
    ...
    pub(crate) credentials: ::std::option::Option<super::super::super::types::SessionCredentials>,
    _extended_request_id: Option<String>,
    _request_id: Option<String>,
}
impl CreateSessionOutputBuilder {
    ...
    pub fn credentials(mut self, input: super::super::super::types::SessionCredentials) -> Self {
        self.credentials = ::std::option::Option::Some(input);
        self
    }
    /// <p>The established temporary security credentials for the created session.</p>
    pub fn set_credentials(mut self, input: ::std::option::Option<super::super::super::types::SessionCredentials>) -> Self {
        self.credentials = input;
        self
    }
    /// <p>The established temporary security credentials for the created session.</p>
    pub fn get_credentials(&self) -> &::std::option::Option<super::super::super::types::SessionCredentials> {
        &self.credentials
    }
    ...
    pub fn build(self) -> super::super::super::operation::create_session::CreateSessionOutput {
        super::super::super::operation::create_session::CreateSessionOutput {
