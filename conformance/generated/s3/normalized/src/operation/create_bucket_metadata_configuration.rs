...
impl CreateBucketMetadataConfiguration {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::create_bucket_metadata_configuration::CreateBucketMetadataConfigurationInput,
    ) -> ::std::result::Result<
        super::super::operation::create_bucket_metadata_configuration::CreateBucketMetadataConfigurationOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::create_bucket_metadata_configuration::CreateBucketMetadataConfigurationError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::create_bucket_metadata_configuration::CreateBucketMetadataConfigurationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::create_bucket_metadata_configuration::CreateBucketMetadataConfigurationOutput>()
            ...
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                super::super::http_request_checksum::RequestChecksumInterceptor::new(
                    |input: &::aws_smithy_runtime_api::client::interceptors::context::Input| {
                        let input: &super::super::operation::create_bucket_metadata_configuration::CreateBucketMetadataConfigurationInput =
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateBucketMetadataConfigurationTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateBucketMetadataConfigurationInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateBucketMetadataConfigurationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_create_bucket_metadata_configuration::de_create_bucket_metadata_configuration_http_error(
                status, headers, body,
            )
        } else {
            super::super::protocol_serde::shape_create_bucket_metadata_configuration::de_create_bucket_metadata_configuration_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateBucketMetadataConfigurationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::create_bucket_metadata_configuration::CreateBucketMetadataConfigurationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::create_bucket_metadata_configuration::CreateBucketMetadataConfigurationInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::super::protocol_serde::shape_create_bucket_metadata_configuration::ser_create_bucket_metadata_configuration_headers(
                    input, builder,
                )?;
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_create_bucket_metadata_configuration_input::ser_metadata_configuration_http_payload(
...
impl super::super::s3_request_id::RequestIdExt for super::super::operation::create_bucket_metadata_configuration::CreateBucketMetadataConfigurationError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::super::operation::create_bucket_metadata_configuration::CreateBucketMetadataConfigurationError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::create_bucket_metadata_configuration::_create_bucket_metadata_configuration_input::CreateBucketMetadataConfigurationInput;

pub use super::super::operation::create_bucket_metadata_configuration::_create_bucket_metadata_configuration_output::CreateBucketMetadataConfigurationOutput;
