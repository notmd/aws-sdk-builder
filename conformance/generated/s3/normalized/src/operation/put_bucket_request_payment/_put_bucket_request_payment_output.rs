...
impl super::super::super::s3_request_id::RequestIdExt for PutBucketRequestPaymentOutput {
...
impl PutBucketRequestPaymentOutput {
    ...
    pub fn builder() -> super::super::super::operation::put_bucket_request_payment::builders::PutBucketRequestPaymentOutputBuilder {
        super::super::super::operation::put_bucket_request_payment::builders::PutBucketRequestPaymentOutputBuilder::default()
    }
}
...
impl PutBucketRequestPaymentOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::put_bucket_request_payment::PutBucketRequestPaymentOutput {
