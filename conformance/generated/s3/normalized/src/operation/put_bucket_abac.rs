...
impl PutBucketAbac {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::put_bucket_abac::PutBucketAbacInput,
    ) -> ::std::result::Result<
        super::super::operation::put_bucket_abac::PutBucketAbacOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::put_bucket_abac::PutBucketAbacError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::put_bucket_abac::PutBucketAbacError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::put_bucket_abac::PutBucketAbacOutput>()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutBucketAbac")
            ...
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                super::super::http_request_checksum::RequestChecksumInterceptor::new(
                    |input: &::aws_smithy_runtime_api::client::interceptors::context::Input| {
                        let input: &super::super::operation::put_bucket_abac::PutBucketAbacInput = input.downcast_ref().expect("correct type");
            ...
            .with_retry_classifier(
                ::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::super::operation::put_bucket_abac::PutBucketAbacError>::builder(
                )
                .transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutBucketAbacResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_put_bucket_abac::de_put_bucket_abac_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_put_bucket_abac::de_put_bucket_abac_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutBucketAbacRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::put_bucket_abac::PutBucketAbacInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::put_bucket_abac::PutBucketAbacInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::super::protocol_serde::shape_put_bucket_abac::ser_put_bucket_abac_headers(input, builder)?;
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_put_bucket_abac_input::ser_abac_status_http_payload(
            &input.abac_status,
        )?);
...
impl super::super::s3_request_id::RequestIdExt for super::super::operation::put_bucket_abac::PutBucketAbacError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::super::operation::put_bucket_abac::PutBucketAbacError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::put_bucket_abac::_put_bucket_abac_input::PutBucketAbacInput;

pub use super::super::operation::put_bucket_abac::_put_bucket_abac_output::PutBucketAbacOutput;
