...
impl super::super::super::s3_request_id::RequestIdExt for GetPublicAccessBlockOutput {
...
impl GetPublicAccessBlockOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_public_access_block::builders::GetPublicAccessBlockOutputBuilder {
        super::super::super::operation::get_public_access_block::builders::GetPublicAccessBlockOutputBuilder::default()
    }
}
...
impl GetPublicAccessBlockOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::get_public_access_block::GetPublicAccessBlockOutput {
