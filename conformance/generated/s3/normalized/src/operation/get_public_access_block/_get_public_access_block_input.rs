...
impl GetPublicAccessBlockInput {
    ...
    pub fn builder() -> super::super::super::operation::get_public_access_block::builders::GetPublicAccessBlockInputBuilder {
        super::super::super::operation::get_public_access_block::builders::GetPublicAccessBlockInputBuilder::default()
    }
}
