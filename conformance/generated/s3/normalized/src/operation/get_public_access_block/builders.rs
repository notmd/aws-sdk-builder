...
pub use super::super::super::operation::get_public_access_block::_get_public_access_block_input::GetPublicAccessBlockInputBuilder;

pub use super::super::super::operation::get_public_access_block::_get_public_access_block_output::GetPublicAccessBlockOutputBuilder;

impl super::super::super::operation::get_public_access_block::builders::GetPublicAccessBlockInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::get_public_access_block::GetPublicAccessBlockOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::get_public_access_block::GetPublicAccessBlockError,
...
pub struct GetPublicAccessBlockFluentBuilder {
    ...
    inner: super::super::super::operation::get_public_access_block::builders::GetPublicAccessBlockInputBuilder,
...
impl GetPublicAccessBlockFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::get_public_access_block::builders::GetPublicAccessBlockInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::get_public_access_block::GetPublicAccessBlock::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::get_public_access_block::GetPublicAccessBlock::orchestrate(&runtime_plugins, input).await
    }
