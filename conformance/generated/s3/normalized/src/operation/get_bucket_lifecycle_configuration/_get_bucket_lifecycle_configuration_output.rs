...
impl GetBucketLifecycleConfigurationOutput {
    ...
    pub fn rules(&self) -> &[super::super::super::types::LifecycleRule] {
...
impl super::super::super::s3_request_id::RequestIdExt for GetBucketLifecycleConfigurationOutput {
...
impl GetBucketLifecycleConfigurationOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_bucket_lifecycle_configuration::builders::GetBucketLifecycleConfigurationOutputBuilder {
        super::super::super::operation::get_bucket_lifecycle_configuration::builders::GetBucketLifecycleConfigurationOutputBuilder::default()
    }
}
...
pub struct GetBucketLifecycleConfigurationOutputBuilder {
    pub(crate) rules: ::std::option::Option<::std::vec::Vec<super::super::super::types::LifecycleRule>>,
...
impl GetBucketLifecycleConfigurationOutputBuilder {
    ...
    ///
    /// <p>Container for a lifecycle rule.</p>
    pub fn rules(mut self, input: super::super::super::types::LifecycleRule) -> Self {
    ...
    /// <p>Container for a lifecycle rule.</p>
    pub fn set_rules(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::LifecycleRule>>) -> Self {
        self.rules = input;
        self
    }
    /// <p>Container for a lifecycle rule.</p>
    pub fn get_rules(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::LifecycleRule>> {
        &self.rules
    }
    /// <p>Indicates which default minimum object size behavior is applied to the lifecycle configuration.</p><note>
    /// <p>This parameter applies to general purpose buckets only. It isn't supported for directory bucket lifecycle configurations.</p>
    ...
    pub fn build(self) -> super::super::super::operation::get_bucket_lifecycle_configuration::GetBucketLifecycleConfigurationOutput {
        super::super::super::operation::get_bucket_lifecycle_configuration::GetBucketLifecycleConfigurationOutput {
            rules: self.rules,
