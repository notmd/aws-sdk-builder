...
impl PutObjectRetentionInput {
    ...
    /// <p>The container element for the Object Retention configuration.</p>
    pub fn retention(&self) -> ::std::option::Option<&super::super::super::types::ObjectLockRetention> {
...
impl PutObjectRetentionInput {
    ...
    pub fn builder() -> super::super::super::operation::put_object_retention::builders::PutObjectRetentionInputBuilder {
        super::super::super::operation::put_object_retention::builders::PutObjectRetentionInputBuilder::default()
    }
}
...
pub struct PutObjectRetentionInputBuilder {
    ...
    pub(crate) retention: ::std::option::Option<super::super::super::types::ObjectLockRetention>,
