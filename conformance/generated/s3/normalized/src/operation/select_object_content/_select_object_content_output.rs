...
impl super::super::super::s3_request_id::RequestIdExt for SelectObjectContentOutput {
...
impl SelectObjectContentOutput {
    ...
    pub fn builder() -> super::super::super::operation::select_object_content::builders::SelectObjectContentOutputBuilder {
        super::super::super::operation::select_object_content::builders::SelectObjectContentOutputBuilder::default()
    }
}
