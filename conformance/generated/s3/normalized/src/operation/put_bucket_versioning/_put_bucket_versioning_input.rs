...
impl PutBucketVersioningInput {
    ...
    /// <p>Container for setting the versioning state.</p>
    pub fn versioning_configuration(&self) -> ::std::option::Option<&super::super::super::types::VersioningConfiguration> {
...
impl PutBucketVersioningInput {
    ...
    pub fn builder() -> super::super::super::operation::put_bucket_versioning::builders::PutBucketVersioningInputBuilder {
        super::super::super::operation::put_bucket_versioning::builders::PutBucketVersioningInputBuilder::default()
    }
}
...
pub struct PutBucketVersioningInputBuilder {
    ...
    pub(crate) versioning_configuration: ::std::option::Option<super::super::super::types::VersioningConfiguration>,
