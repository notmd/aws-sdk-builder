...
impl super::super::super::s3_request_id::RequestIdExt for PutBucketLoggingOutput {
...
impl PutBucketLoggingOutput {
    ...
    pub fn builder() -> super::super::super::operation::put_bucket_logging::builders::PutBucketLoggingOutputBuilder {
        super::super::super::operation::put_bucket_logging::builders::PutBucketLoggingOutputBuilder::default()
    }
}
...
impl PutBucketLoggingOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::put_bucket_logging::PutBucketLoggingOutput {
