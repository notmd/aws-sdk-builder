...
impl PutBucketCors {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::put_bucket_cors::PutBucketCorsInput,
    ) -> ::std::result::Result<
        super::super::operation::put_bucket_cors::PutBucketCorsOutput,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::put_bucket_cors::PutBucketCorsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::put_bucket_cors::PutBucketCorsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("S3", "PutBucketCors", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutBucketCors {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("PutBucketCors", "S3"));
            ...
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                super::super::http_request_checksum::RequestChecksumInterceptor::new(
                    |input: &::aws_smithy_runtime_api::client::interceptors::context::Input| {
                        let input: &super::super::operation::put_bucket_cors::PutBucketCorsInput = input.downcast_ref().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutBucketCorsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_put_bucket_cors::de_put_bucket_cors_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_put_bucket_cors::de_put_bucket_cors_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutBucketCorsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::put_bucket_cors::PutBucketCorsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::put_bucket_cors::PutBucketCorsInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::super::protocol_serde::shape_put_bucket_cors::ser_put_bucket_cors_headers(input, builder)?;
...
impl super::super::s3_request_id::RequestIdExt for super::super::operation::put_bucket_cors::PutBucketCorsError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::super::operation::put_bucket_cors::PutBucketCorsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::put_bucket_cors::_put_bucket_cors_input::PutBucketCorsInput;

pub use super::super::operation::put_bucket_cors::_put_bucket_cors_output::PutBucketCorsOutput;
