...
impl HeadObject {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::super::operation::head_object::HeadObjectOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::head_object::HeadObjectError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::head_object::HeadObjectError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::head_object::HeadObjectOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for HeadObject {
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("HeadObject")
            ...
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                super::super::s3_expires_interceptor::S3ExpiresInterceptor,
            ))
            ...
            .with_retry_classifier(
                ::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::super::operation::head_object::HeadObjectError>::builder()
                    .transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for HeadObjectResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_head_object::de_head_object_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_head_object::de_head_object_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for HeadObjectRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::super::operation::head_object::HeadObjectInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::head_object::HeadObjectInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::super::protocol_serde::shape_head_object::ser_head_object_headers(input, builder)?;
...
impl super::super::s3_request_id::RequestIdExt for super::super::operation::head_object::HeadObjectError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::super::operation::head_object::HeadObjectError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::head_object::_head_object_input::HeadObjectInput;

pub use super::super::operation::head_object::_head_object_output::HeadObjectOutput;
