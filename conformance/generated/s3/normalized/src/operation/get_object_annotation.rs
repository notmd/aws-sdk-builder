...
impl GetObjectAnnotation {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::get_object_annotation::GetObjectAnnotationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::get_object_annotation::GetObjectAnnotationOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("S3", "GetObjectAnnotation", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetObjectAnnotation {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("GetObjectAnnotation", "S3"));
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetObjectAnnotationResponseDeserializer {
    fn deserialize_streaming(
        ...
        ::std::option::Option::Some(super::super::protocol_serde::type_erase_result(
            super::super::protocol_serde::shape_get_object_annotation::de_get_object_annotation_http_response(response),
        ))
    }
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetObjectAnnotationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::get_object_annotation::GetObjectAnnotationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::get_object_annotation::GetObjectAnnotationInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::super::protocol_serde::shape_get_object_annotation::ser_get_object_annotation_headers(input, builder)?;
...
impl super::super::s3_request_id::RequestIdExt for super::super::operation::get_object_annotation::GetObjectAnnotationError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::super::operation::get_object_annotation::GetObjectAnnotationError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::get_object_annotation::_get_object_annotation_input::GetObjectAnnotationInput;

pub use super::super::operation::get_object_annotation::_get_object_annotation_output::GetObjectAnnotationOutput;
