...
impl GetBucketEncryptionInput {
    ...
    pub fn builder() -> super::super::super::operation::get_bucket_encryption::builders::GetBucketEncryptionInputBuilder {
        super::super::super::operation::get_bucket_encryption::builders::GetBucketEncryptionInputBuilder::default()
    }
}
