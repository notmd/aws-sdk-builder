...
impl PutObjectAcl {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::put_object_acl::PutObjectAclInput,
    ) -> ::std::result::Result<
        super::super::operation::put_object_acl::PutObjectAclOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::put_object_acl::PutObjectAclError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::put_object_acl::PutObjectAclError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::put_object_acl::PutObjectAclOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutObjectAcl {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            PutObjectAclResponseDeserializer,
        ));
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutObjectAcl")
            ...
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                super::super::http_request_checksum::RequestChecksumInterceptor::new(
                    |input: &::aws_smithy_runtime_api::client::interceptors::context::Input| {
                        let input: &super::super::operation::put_object_acl::PutObjectAclInput = input.downcast_ref().expect("correct type");
            ...
            .with_retry_classifier(
                ::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::super::operation::put_object_acl::PutObjectAclError>::builder()
                    .transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutObjectAclResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_put_object_acl::de_put_object_acl_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_put_object_acl::de_put_object_acl_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutObjectAclRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::put_object_acl::PutObjectAclInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::put_object_acl::PutObjectAclInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::super::protocol_serde::shape_put_object_acl::ser_put_object_acl_headers(input, builder)?;
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_put_object_acl_input::ser_access_control_policy_http_payload(&input.access_control_policy)?,
        );
...
impl super::super::s3_request_id::RequestIdExt for super::super::operation::put_object_acl::PutObjectAclError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::super::operation::put_object_acl::PutObjectAclError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::put_object_acl::_put_object_acl_input::PutObjectAclInput;

pub use super::super::operation::put_object_acl::_put_object_acl_output::PutObjectAclOutput;
