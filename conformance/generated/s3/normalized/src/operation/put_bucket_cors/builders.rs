...
pub use super::super::super::operation::put_bucket_cors::_put_bucket_cors_input::PutBucketCorsInputBuilder;

pub use super::super::super::operation::put_bucket_cors::_put_bucket_cors_output::PutBucketCorsOutputBuilder;

impl super::super::super::operation::put_bucket_cors::builders::PutBucketCorsInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::put_bucket_cors::PutBucketCorsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::put_bucket_cors::PutBucketCorsError,
...
pub struct PutBucketCorsFluentBuilder {
    ...
    inner: super::super::super::operation::put_bucket_cors::builders::PutBucketCorsInputBuilder,
...
impl PutBucketCorsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::put_bucket_cors::builders::PutBucketCorsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::put_bucket_cors::PutBucketCors::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::put_bucket_cors::PutBucketCors::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn cors_configuration(mut self, input: super::super::super::types::CorsConfiguration) -> Self {
        self.inner = self.inner.cors_configuration(input);
        self
    }
    /// <p>Describes the cross-origin access configuration for objects in an Amazon S3 bucket. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/cors.html">Enabling Cross-Origin Resource Sharing</a> in the <i>Amazon S3 User Guide</i>.</p>
    pub fn set_cors_configuration(mut self, input: ::std::option::Option<super::super::super::types::CorsConfiguration>) -> Self {
        self.inner = self.inner.set_cors_configuration(input);
        self
    }
    /// <p>Describes the cross-origin access configuration for objects in an Amazon S3 bucket. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/cors.html">Enabling Cross-Origin Resource Sharing</a> in the <i>Amazon S3 User Guide</i>.</p>
    pub fn get_cors_configuration(&self) -> &::std::option::Option<super::super::super::types::CorsConfiguration> {
