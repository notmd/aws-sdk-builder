...
impl super::super::super::s3_request_id::RequestIdExt for PutBucketInventoryConfigurationOutput {
...
impl PutBucketInventoryConfigurationOutput {
    ...
    pub fn builder() -> super::super::super::operation::put_bucket_inventory_configuration::builders::PutBucketInventoryConfigurationOutputBuilder {
        super::super::super::operation::put_bucket_inventory_configuration::builders::PutBucketInventoryConfigurationOutputBuilder::default()
    }
}
...
impl PutBucketInventoryConfigurationOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::put_bucket_inventory_configuration::PutBucketInventoryConfigurationOutput {
