...
impl GetBucketCorsInput {
    ...
    pub fn builder() -> super::super::super::operation::get_bucket_cors::builders::GetBucketCorsInputBuilder {
        super::super::super::operation::get_bucket_cors::builders::GetBucketCorsInputBuilder::default()
    }
}
...
impl GetBucketCorsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::get_bucket_cors::GetBucketCorsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::super::operation::get_bucket_cors::GetBucketCorsInput {
            bucket: self.bucket,
