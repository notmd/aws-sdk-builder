...
impl GetBucketCorsOutput {
    ...
    pub fn cors_rules(&self) -> &[super::super::super::types::CorsRule] {
        self.cors_rules.as_deref().unwrap_or_default()
    }
}
impl super::super::super::s3_request_id::RequestIdExt for GetBucketCorsOutput {
...
impl GetBucketCorsOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_bucket_cors::builders::GetBucketCorsOutputBuilder {
        super::super::super::operation::get_bucket_cors::builders::GetBucketCorsOutputBuilder::default()
    }
}
...
pub struct GetBucketCorsOutputBuilder {
    pub(crate) cors_rules: ::std::option::Option<::std::vec::Vec<super::super::super::types::CorsRule>>,
    _extended_request_id: Option<String>,
    _request_id: Option<String>,
}
impl GetBucketCorsOutputBuilder {
    ...
    ///
    /// <p>A set of origins and methods (cross-origin access that you want to allow). You can add up to 100 rules to the configuration.</p>
    pub fn cors_rules(mut self, input: super::super::super::types::CorsRule) -> Self {
    ...
    /// <p>A set of origins and methods (cross-origin access that you want to allow). You can add up to 100 rules to the configuration.</p>
    pub fn set_cors_rules(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::CorsRule>>) -> Self {
        self.cors_rules = input;
        self
    }
    /// <p>A set of origins and methods (cross-origin access that you want to allow). You can add up to 100 rules to the configuration.</p>
    pub fn get_cors_rules(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::CorsRule>> {
        &self.cors_rules
    }
    ...
    pub fn build(self) -> super::super::super::operation::get_bucket_cors::GetBucketCorsOutput {
