...
impl super::super::super::s3_request_id::RequestIdExt for PutBucketAbacOutput {
...
impl PutBucketAbacOutput {
    ...
    pub fn builder() -> super::super::super::operation::put_bucket_abac::builders::PutBucketAbacOutputBuilder {
        super::super::super::operation::put_bucket_abac::builders::PutBucketAbacOutputBuilder::default()
    }
}
...
impl PutBucketAbacOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::put_bucket_abac::PutBucketAbacOutput {
