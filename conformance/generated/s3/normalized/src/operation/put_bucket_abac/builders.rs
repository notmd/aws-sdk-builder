...
pub use super::super::super::operation::put_bucket_abac::_put_bucket_abac_input::PutBucketAbacInputBuilder;

pub use super::super::super::operation::put_bucket_abac::_put_bucket_abac_output::PutBucketAbacOutputBuilder;

impl super::super::super::operation::put_bucket_abac::builders::PutBucketAbacInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::put_bucket_abac::PutBucketAbacOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::put_bucket_abac::PutBucketAbacError,
...
pub struct PutBucketAbacFluentBuilder {
    ...
    inner: super::super::super::operation::put_bucket_abac::builders::PutBucketAbacInputBuilder,
...
impl PutBucketAbacFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::put_bucket_abac::builders::PutBucketAbacInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::put_bucket_abac::PutBucketAbac::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::put_bucket_abac::PutBucketAbac::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn abac_status(mut self, input: super::super::super::types::AbacStatus) -> Self {
        self.inner = self.inner.abac_status(input);
        self
    }
    /// <p>The ABAC status of the general purpose bucket. When ABAC is enabled for the general purpose bucket, you can use tags to manage access to the general purpose buckets as well as for cost tracking purposes. When ABAC is disabled for the general purpose buckets, you can only use tags for cost tracking purposes. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/buckets-tagging.html">Using tags with S3 general purpose buckets</a>.</p>
    pub fn set_abac_status(mut self, input: ::std::option::Option<super::super::super::types::AbacStatus>) -> Self {
        self.inner = self.inner.set_abac_status(input);
        self
    }
    /// <p>The ABAC status of the general purpose bucket. When ABAC is enabled for the general purpose bucket, you can use tags to manage access to the general purpose buckets as well as for cost tracking purposes. When ABAC is disabled for the general purpose buckets, you can only use tags for cost tracking purposes. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/buckets-tagging.html">Using tags with S3 general purpose buckets</a>.</p>
    pub fn get_abac_status(&self) -> &::std::option::Option<super::super::super::types::AbacStatus> {
