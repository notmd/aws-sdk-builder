...
impl super::super::super::s3_request_id::RequestIdExt for PutObjectTaggingOutput {
...
impl PutObjectTaggingOutput {
    ...
    pub fn builder() -> super::super::super::operation::put_object_tagging::builders::PutObjectTaggingOutputBuilder {
        super::super::super::operation::put_object_tagging::builders::PutObjectTaggingOutputBuilder::default()
    }
}
...
impl PutObjectTaggingOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::put_object_tagging::PutObjectTaggingOutput {
