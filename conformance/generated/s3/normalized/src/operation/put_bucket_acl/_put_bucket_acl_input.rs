...
impl PutBucketAclInput {
    ...
    pub fn builder() -> super::super::super::operation::put_bucket_acl::builders::PutBucketAclInputBuilder {
        super::super::super::operation::put_bucket_acl::builders::PutBucketAclInputBuilder::default()
    }
}
