...
pub use super::super::super::operation::update_object_encryption::_update_object_encryption_input::UpdateObjectEncryptionInputBuilder;

pub use super::super::super::operation::update_object_encryption::_update_object_encryption_output::UpdateObjectEncryptionOutputBuilder;

impl super::super::super::operation::update_object_encryption::builders::UpdateObjectEncryptionInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::update_object_encryption::UpdateObjectEncryptionOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::update_object_encryption::UpdateObjectEncryptionError,
...
pub struct UpdateObjectEncryptionFluentBuilder {
    ...
    inner: super::super::super::operation::update_object_encryption::builders::UpdateObjectEncryptionInputBuilder,
...
impl UpdateObjectEncryptionFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::update_object_encryption::builders::UpdateObjectEncryptionInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::update_object_encryption::UpdateObjectEncryption::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::update_object_encryption::UpdateObjectEncryption::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn object_encryption(mut self, input: super::super::super::types::ObjectEncryption) -> Self {
        self.inner = self.inner.object_encryption(input);
        self
    }
    /// <p>The updated server-side encryption type for this object. The <code>UpdateObjectEncryption</code> operation supports the SSE-S3 and SSE-KMS encryption types.</p>
    /// <p>Valid Values: <code>SSES3</code> | <code>SSEKMS</code></p>
    pub fn set_object_encryption(mut self, input: ::std::option::Option<super::super::super::types::ObjectEncryption>) -> Self {
        self.inner = self.inner.set_object_encryption(input);
        self
    }
    /// <p>The updated server-side encryption type for this object. The <code>UpdateObjectEncryption</code> operation supports the SSE-S3 and SSE-KMS encryption types.</p>
    /// <p>Valid Values: <code>SSES3</code> | <code>SSEKMS</code></p>
    pub fn get_object_encryption(&self) -> &::std::option::Option<super::super::super::types::ObjectEncryption> {
