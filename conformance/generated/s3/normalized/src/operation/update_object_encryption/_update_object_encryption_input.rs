...
impl UpdateObjectEncryptionInput {
    ...
    /// <p>The updated server-side encryption type for this object. The <code>UpdateObjectEncryption</code> operation supports the SSE-S3 and SSE-KMS encryption types.</p>
    /// <p>Valid Values: <code>SSES3</code> | <code>SSEKMS</code></p>
    pub fn object_encryption(&self) -> ::std::option::Option<&super::super::super::types::ObjectEncryption> {
...
impl UpdateObjectEncryptionInput {
    ...
    pub fn builder() -> super::super::super::operation::update_object_encryption::builders::UpdateObjectEncryptionInputBuilder {
        super::super::super::operation::update_object_encryption::builders::UpdateObjectEncryptionInputBuilder::default()
    }
}
...
pub struct UpdateObjectEncryptionInputBuilder {
    ...
    pub(crate) object_encryption: ::std::option::Option<super::super::super::types::ObjectEncryption>,
...
impl UpdateObjectEncryptionInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::update_object_encryption::UpdateObjectEncryptionInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::update_object_encryption::UpdateObjectEncryptionInput {
            bucket: self.bucket,
            key: self.key,
