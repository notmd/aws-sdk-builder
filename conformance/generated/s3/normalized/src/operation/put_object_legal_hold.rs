...
impl PutObjectLegalHold {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::put_object_legal_hold::PutObjectLegalHoldInput,
    ) -> ::std::result::Result<
        super::super::operation::put_object_legal_hold::PutObjectLegalHoldOutput,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::put_object_legal_hold::PutObjectLegalHoldError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::put_object_legal_hold::PutObjectLegalHoldOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutObjectLegalHoldResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_put_object_legal_hold::de_put_object_legal_hold_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_put_object_legal_hold::de_put_object_legal_hold_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutObjectLegalHoldRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::put_object_legal_hold::PutObjectLegalHoldInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::put_object_legal_hold::PutObjectLegalHoldInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::super::protocol_serde::shape_put_object_legal_hold::ser_put_object_legal_hold_headers(input, builder)?;
...
impl super::super::s3_request_id::RequestIdExt for super::super::operation::put_object_legal_hold::PutObjectLegalHoldError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::super::operation::put_object_legal_hold::PutObjectLegalHoldError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::put_object_legal_hold::_put_object_legal_hold_input::PutObjectLegalHoldInput;

pub use super::super::operation::put_object_legal_hold::_put_object_legal_hold_output::PutObjectLegalHoldOutput;
