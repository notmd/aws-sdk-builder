...
pub use super::super::super::operation::get_bucket_inventory_configuration::_get_bucket_inventory_configuration_input::GetBucketInventoryConfigurationInputBuilder;

pub use super::super::super::operation::get_bucket_inventory_configuration::_get_bucket_inventory_configuration_output::GetBucketInventoryConfigurationOutputBuilder;

impl super::super::super::operation::get_bucket_inventory_configuration::builders::GetBucketInventoryConfigurationInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::get_bucket_inventory_configuration::GetBucketInventoryConfigurationOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::get_bucket_inventory_configuration::GetBucketInventoryConfigurationError,
...
///
/// <p>Returns an S3 Inventory configuration (identified by the inventory configuration ID) from the bucket.</p><note>
...
pub struct GetBucketInventoryConfigurationFluentBuilder {
    ...
    inner: super::super::super::operation::get_bucket_inventory_configuration::builders::GetBucketInventoryConfigurationInputBuilder,
