...
impl PutBucketVersioning {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::put_bucket_versioning::PutBucketVersioningInput,
    ) -> ::std::result::Result<
        super::super::operation::put_bucket_versioning::PutBucketVersioningOutput,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::put_bucket_versioning::PutBucketVersioningError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::put_bucket_versioning::PutBucketVersioningOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("S3", "PutBucketVersioning", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutBucketVersioning {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("PutBucketVersioning", "S3"));
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutBucketVersioningResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_put_bucket_versioning::de_put_bucket_versioning_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_put_bucket_versioning::de_put_bucket_versioning_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutBucketVersioningRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::put_bucket_versioning::PutBucketVersioningInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::put_bucket_versioning::PutBucketVersioningInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::super::protocol_serde::shape_put_bucket_versioning::ser_put_bucket_versioning_headers(input, builder)?;
...
impl super::super::s3_request_id::RequestIdExt for super::super::operation::put_bucket_versioning::PutBucketVersioningError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::super::operation::put_bucket_versioning::PutBucketVersioningError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::put_bucket_versioning::_put_bucket_versioning_input::PutBucketVersioningInput;

pub use super::super::operation::put_bucket_versioning::_put_bucket_versioning_output::PutBucketVersioningOutput;
