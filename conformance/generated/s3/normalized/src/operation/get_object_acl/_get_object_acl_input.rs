...
impl GetObjectAclInput {
    ...
    pub fn builder() -> super::super::super::operation::get_object_acl::builders::GetObjectAclInputBuilder {
        super::super::super::operation::get_object_acl::builders::GetObjectAclInputBuilder::default()
    }
}
