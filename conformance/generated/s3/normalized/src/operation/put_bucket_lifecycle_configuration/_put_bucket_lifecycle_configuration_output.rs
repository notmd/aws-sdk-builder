...
impl super::super::super::s3_request_id::RequestIdExt for PutBucketLifecycleConfigurationOutput {
...
impl PutBucketLifecycleConfigurationOutput {
    ...
    pub fn builder() -> super::super::super::operation::put_bucket_lifecycle_configuration::builders::PutBucketLifecycleConfigurationOutputBuilder {
        super::super::super::operation::put_bucket_lifecycle_configuration::builders::PutBucketLifecycleConfigurationOutputBuilder::default()
    }
}
...
impl PutBucketLifecycleConfigurationOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::put_bucket_lifecycle_configuration::PutBucketLifecycleConfigurationOutput {
