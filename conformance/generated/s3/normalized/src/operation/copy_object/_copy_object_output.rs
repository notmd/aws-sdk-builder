...
impl CopyObjectOutput {
    /// <p>Container for all response elements.</p>
    pub fn copy_object_result(&self) -> ::std::option::Option<&super::super::super::types::CopyObjectResult> {
...
impl super::super::super::s3_request_id::RequestIdExt for CopyObjectOutput {
...
impl CopyObjectOutput {
    ...
    pub fn builder() -> super::super::super::operation::copy_object::builders::CopyObjectOutputBuilder {
        super::super::super::operation::copy_object::builders::CopyObjectOutputBuilder::default()
    }
}
...
pub struct CopyObjectOutputBuilder {
    pub(crate) copy_object_result: ::std::option::Option<super::super::super::types::CopyObjectResult>,
...
impl CopyObjectOutputBuilder {
    /// <p>Container for all response elements.</p>
    pub fn copy_object_result(mut self, input: super::super::super::types::CopyObjectResult) -> Self {
        self.copy_object_result = ::std::option::Option::Some(input);
        self
    }
    /// <p>Container for all response elements.</p>
    pub fn set_copy_object_result(mut self, input: ::std::option::Option<super::super::super::types::CopyObjectResult>) -> Self {
        self.copy_object_result = input;
        self
    }
    /// <p>Container for all response elements.</p>
    pub fn get_copy_object_result(&self) -> &::std::option::Option<super::super::super::types::CopyObjectResult> {
    ...
    pub fn build(self) -> super::super::super::operation::copy_object::CopyObjectOutput {
