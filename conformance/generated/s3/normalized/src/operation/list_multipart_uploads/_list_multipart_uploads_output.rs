...
impl ListMultipartUploadsOutput {
    ...
    pub fn uploads(&self) -> &[super::super::super::types::MultipartUpload] {
...
impl super::super::super::s3_request_id::RequestIdExt for ListMultipartUploadsOutput {
...
impl ListMultipartUploadsOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_multipart_uploads::builders::ListMultipartUploadsOutputBuilder {
        super::super::super::operation::list_multipart_uploads::builders::ListMultipartUploadsOutputBuilder::default()
    }
}
...
pub struct ListMultipartUploadsOutputBuilder {
    ...
    pub(crate) uploads: ::std::option::Option<::std::vec::Vec<super::super::super::types::MultipartUpload>>,
...
impl ListMultipartUploadsOutputBuilder {
    ...
    ///
    /// <p>Container for elements related to a particular multipart upload. A response can contain zero or more <code>Upload</code> elements.</p>
    pub fn uploads(mut self, input: super::super::super::types::MultipartUpload) -> Self {
    ...
    /// <p>Container for elements related to a particular multipart upload. A response can contain zero or more <code>Upload</code> elements.</p>
    pub fn set_uploads(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::MultipartUpload>>) -> Self {
        self.uploads = input;
        self
    }
    /// <p>Container for elements related to a particular multipart upload. A response can contain zero or more <code>Upload</code> elements.</p>
    pub fn get_uploads(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::MultipartUpload>> {
        &self.uploads
    }
    ...
    pub fn build(self) -> super::super::super::operation::list_multipart_uploads::ListMultipartUploadsOutput {
        super::super::super::operation::list_multipart_uploads::ListMultipartUploadsOutput {
            bucket: self.bucket,
