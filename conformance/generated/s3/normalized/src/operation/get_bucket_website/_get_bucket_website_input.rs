...
impl GetBucketWebsiteInput {
    ...
    pub fn builder() -> super::super::super::operation::get_bucket_website::builders::GetBucketWebsiteInputBuilder {
        super::super::super::operation::get_bucket_website::builders::GetBucketWebsiteInputBuilder::default()
    }
}
