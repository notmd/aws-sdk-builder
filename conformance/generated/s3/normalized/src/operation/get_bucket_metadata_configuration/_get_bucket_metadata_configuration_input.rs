...
impl GetBucketMetadataConfigurationInput {
    ...
    pub fn builder() -> super::super::super::operation::get_bucket_metadata_configuration::builders::GetBucketMetadataConfigurationInputBuilder {
        super::super::super::operation::get_bucket_metadata_configuration::builders::GetBucketMetadataConfigurationInputBuilder::default()
    }
}
