...
impl super::super::super::s3_request_id::RequestIdExt for GetBucketMetadataConfigurationOutput {
...
impl GetBucketMetadataConfigurationOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_bucket_metadata_configuration::builders::GetBucketMetadataConfigurationOutputBuilder {
        super::super::super::operation::get_bucket_metadata_configuration::builders::GetBucketMetadataConfigurationOutputBuilder::default()
    }
}
...
pub struct GetBucketMetadataConfigurationOutputBuilder {
    pub(crate) get_bucket_metadata_configuration_result: ::std::option::Option<super::super::super::types::GetBucketMetadataConfigurationResult>,
    _extended_request_id: Option<String>,
    _request_id: Option<String>,
}
impl GetBucketMetadataConfigurationOutputBuilder {
    /// <p>The metadata configuration for the general purpose bucket.</p>
    pub fn get_bucket_metadata_configuration_result(mut self, input: super::super::super::types::GetBucketMetadataConfigurationResult) -> Self {
    ...
    pub fn set_get_bucket_metadata_configuration_result(
        mut self,
        input: ::std::option::Option<super::super::super::types::GetBucketMetadataConfigurationResult>,
    ) -> Self {
    ...
    pub fn build(self) -> super::super::super::operation::get_bucket_metadata_configuration::GetBucketMetadataConfigurationOutput {
