...
impl super::super::super::s3_request_id::RequestIdExt for DeleteBucketOwnershipControlsOutput {
...
impl DeleteBucketOwnershipControlsOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_bucket_ownership_controls::builders::DeleteBucketOwnershipControlsOutputBuilder {
        super::super::super::operation::delete_bucket_ownership_controls::builders::DeleteBucketOwnershipControlsOutputBuilder::default()
    }
}
...
impl DeleteBucketOwnershipControlsOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_bucket_ownership_controls::DeleteBucketOwnershipControlsOutput {
