...
impl PutBucketPolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::put_bucket_policy::PutBucketPolicyInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::put_bucket_policy::PutBucketPolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::put_bucket_policy::PutBucketPolicyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutBucketPolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_put_bucket_policy::de_put_bucket_policy_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_put_bucket_policy::de_put_bucket_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutBucketPolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::put_bucket_policy::PutBucketPolicyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::put_bucket_policy::PutBucketPolicyInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::super::protocol_serde::shape_put_bucket_policy::ser_put_bucket_policy_headers(input, builder)?;
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_put_bucket_policy_input::ser_policy_http_payload(
            input.policy,
        )?);
...
impl super::super::s3_request_id::RequestIdExt for super::super::operation::put_bucket_policy::PutBucketPolicyError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::super::operation::put_bucket_policy::PutBucketPolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::put_bucket_policy::_put_bucket_policy_input::PutBucketPolicyInput;

pub use super::super::operation::put_bucket_policy::_put_bucket_policy_output::PutBucketPolicyOutput;
