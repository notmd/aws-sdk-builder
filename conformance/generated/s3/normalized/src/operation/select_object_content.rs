...
impl SelectObjectContent {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::select_object_content::SelectObjectContentInput,
    ) -> ::std::result::Result<
        super::super::operation::select_object_content::SelectObjectContentOutput,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::select_object_content::SelectObjectContentError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::select_object_content::SelectObjectContentOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SelectObjectContentResponseDeserializer {
    fn deserialize_streaming(
        ...
        ::std::option::Option::Some(super::super::protocol_serde::type_erase_result(
            super::super::protocol_serde::shape_select_object_content::de_select_object_content_http_response(response),
        ))
    }
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SelectObjectContentRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::select_object_content::SelectObjectContentInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::select_object_content::SelectObjectContentInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::super::protocol_serde::shape_select_object_content::ser_select_object_content_headers(input, builder)?;
...
impl super::super::s3_request_id::RequestIdExt for super::super::operation::select_object_content::SelectObjectContentError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::super::operation::select_object_content::SelectObjectContentError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::select_object_content::_select_object_content_input::SelectObjectContentInput;

pub use super::super::operation::select_object_content::_select_object_content_output::SelectObjectContentOutput;
