...
impl super::super::super::s3_request_id::RequestIdExt for DeleteBucketAnalyticsConfigurationOutput {
...
impl DeleteBucketAnalyticsConfigurationOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_bucket_analytics_configuration::DeleteBucketAnalyticsConfigurationOutput {
