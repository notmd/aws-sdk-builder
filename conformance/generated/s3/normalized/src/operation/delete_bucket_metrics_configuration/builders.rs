...
pub use super::super::super::operation::delete_bucket_metrics_configuration::_delete_bucket_metrics_configuration_input::DeleteBucketMetricsConfigurationInputBuilder;

pub use super::super::super::operation::delete_bucket_metrics_configuration::_delete_bucket_metrics_configuration_output::DeleteBucketMetricsConfigurationOutputBuilder;

impl super::super::super::operation::delete_bucket_metrics_configuration::builders::DeleteBucketMetricsConfigurationInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_bucket_metrics_configuration::DeleteBucketMetricsConfigurationOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_bucket_metrics_configuration::DeleteBucketMetricsConfigurationError,
...
///
/// <p>Deletes a metrics configuration for the Amazon CloudWatch request metrics (specified by the metrics configuration ID) from the bucket. Note that this doesn't include the daily storage metrics.</p><note>
...
pub struct DeleteBucketMetricsConfigurationFluentBuilder {
    ...
    inner: super::super::super::operation::delete_bucket_metrics_configuration::builders::DeleteBucketMetricsConfigurationInputBuilder,
