...
impl PutObject {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::super::operation::put_object::PutObjectOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::put_object::PutObjectError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::put_object::PutObjectError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::put_object::PutObjectOutput>()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutObject")
            ...
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                super::super::http_request_checksum::RequestChecksumInterceptor::new(
                    |input: &::aws_smithy_runtime_api::client::interceptors::context::Input| {
                        let input: &super::super::operation::put_object::PutObjectInput = input.downcast_ref().expect("correct type");
            ...
            .with_retry_classifier(
                ::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::super::operation::put_object::PutObjectError>::builder()
                    .transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutObjectResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_put_object::de_put_object_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_put_object::de_put_object_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutObjectRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::super::operation::put_object::PutObjectInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::put_object::PutObjectInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::super::protocol_serde::shape_put_object::ser_put_object_headers(input, builder)?;
        ...
        let body = super::super::protocol_serde::shape_put_object_input::ser_body_http_payload(input.body)?.into_inner();
...
impl super::super::s3_request_id::RequestIdExt for super::super::operation::put_object::PutObjectError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::super::operation::put_object::PutObjectError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::put_object::_put_object_input::PutObjectInput;

pub use super::super::operation::put_object::_put_object_output::PutObjectOutput;
