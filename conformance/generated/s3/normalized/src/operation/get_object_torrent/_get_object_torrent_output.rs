...
impl super::super::super::s3_request_id::RequestIdExt for GetObjectTorrentOutput {
...
impl GetObjectTorrentOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_object_torrent::builders::GetObjectTorrentOutputBuilder {
        super::super::super::operation::get_object_torrent::builders::GetObjectTorrentOutputBuilder::default()
    }
}
...
impl GetObjectTorrentOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::get_object_torrent::GetObjectTorrentOutput {
