...
impl GetObjectTorrentInput {
    ...
    pub fn builder() -> super::super::super::operation::get_object_torrent::builders::GetObjectTorrentInputBuilder {
        super::super::super::operation::get_object_torrent::builders::GetObjectTorrentInputBuilder::default()
    }
}
