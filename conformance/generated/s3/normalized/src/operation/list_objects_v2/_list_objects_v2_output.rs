...
impl ListObjectsV2Output {
    ...
    pub fn contents(&self) -> &[super::super::super::types::Object] {
...
impl super::super::super::s3_request_id::RequestIdExt for ListObjectsV2Output {
...
impl ListObjectsV2Output {
    ...
    pub fn builder() -> super::super::super::operation::list_objects_v2::builders::ListObjectsV2OutputBuilder {
        super::super::super::operation::list_objects_v2::builders::ListObjectsV2OutputBuilder::default()
    }
}
...
pub struct ListObjectsV2OutputBuilder {
    ...
    pub(crate) contents: ::std::option::Option<::std::vec::Vec<super::super::super::types::Object>>,
...
impl ListObjectsV2OutputBuilder {
    ...
    ///
    /// <p>Metadata about each object returned.</p>
    pub fn contents(mut self, input: super::super::super::types::Object) -> Self {
    ...
    /// <p>Metadata about each object returned.</p>
    pub fn set_contents(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::Object>>) -> Self {
        self.contents = input;
        self
    }
    /// <p>Metadata about each object returned.</p>
    pub fn get_contents(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::Object>> {
        &self.contents
    }
    /// <p>The bucket name.</p>
    ...
    pub fn build(self) -> super::super::super::operation::list_objects_v2::ListObjectsV2Output {
        super::super::super::operation::list_objects_v2::ListObjectsV2Output {
