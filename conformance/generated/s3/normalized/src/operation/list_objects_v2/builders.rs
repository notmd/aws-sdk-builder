...
pub use super::super::super::operation::list_objects_v2::_list_objects_v2_input::ListObjectsV2InputBuilder;

pub use super::super::super::operation::list_objects_v2::_list_objects_v2_output::ListObjectsV2OutputBuilder;

impl super::super::super::operation::list_objects_v2::builders::ListObjectsV2InputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::list_objects_v2::ListObjectsV2Error,
...
pub struct ListObjectsV2FluentBuilder {
    ...
    inner: super::super::super::operation::list_objects_v2::builders::ListObjectsV2InputBuilder,
...
impl ListObjectsV2FluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::list_objects_v2::builders::ListObjectsV2InputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::list_objects_v2::ListObjectsV2::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::list_objects_v2::ListObjectsV2::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::super::super::operation::list_objects_v2::paginator::ListObjectsV2Paginator {
        super::super::super::operation::list_objects_v2::paginator::ListObjectsV2Paginator::new(self.handle, self.inner)
    }
    ...
    /// <p>This functionality is not supported for directory buckets.</p>
    /// </note>
    pub fn optional_object_attributes(mut self, input: super::super::super::types::OptionalObjectAttributes) -> Self {
    ...
    /// <p>This functionality is not supported for directory buckets.</p>
    /// </note>
    pub fn get_optional_object_attributes(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::OptionalObjectAttributes>> {
