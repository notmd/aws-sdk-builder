...
pub struct ListObjectsV2Paginator {
    ...
    builder: super::super::super::operation::list_objects_v2::builders::ListObjectsV2InputBuilder,
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::super::super::operation::list_objects_v2::ListObjectsV2::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_objects_v2_output_output_next_continuation_token(resp);
