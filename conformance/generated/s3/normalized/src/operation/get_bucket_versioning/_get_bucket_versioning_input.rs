...
impl GetBucketVersioningInput {
    ...
    pub fn builder() -> super::super::super::operation::get_bucket_versioning::builders::GetBucketVersioningInputBuilder {
        super::super::super::operation::get_bucket_versioning::builders::GetBucketVersioningInputBuilder::default()
    }
}
