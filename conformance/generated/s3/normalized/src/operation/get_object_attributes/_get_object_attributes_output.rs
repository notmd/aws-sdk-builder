...
impl GetObjectAttributesOutput {
    ...
    /// <p>The checksum or digest of the object.</p>
    pub fn checksum(&self) -> ::std::option::Option<&super::super::super::types::Checksum> {
        self.checksum.as_ref()
    }
    /// <p>A collection of parts associated with a multipart upload.</p>
    pub fn object_parts(&self) -> ::std::option::Option<&super::super::super::types::GetObjectAttributesParts> {
...
impl super::super::super::s3_request_id::RequestIdExt for GetObjectAttributesOutput {
...
impl GetObjectAttributesOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_object_attributes::builders::GetObjectAttributesOutputBuilder {
        super::super::super::operation::get_object_attributes::builders::GetObjectAttributesOutputBuilder::default()
    }
}
...
pub struct GetObjectAttributesOutputBuilder {
    ...
    pub(crate) checksum: ::std::option::Option<super::super::super::types::Checksum>,
    pub(crate) object_parts: ::std::option::Option<super::super::super::types::GetObjectAttributesParts>,
...
impl GetObjectAttributesOutputBuilder {
    ...
    /// <p>The checksum or digest of the object.</p>
    pub fn checksum(mut self, input: super::super::super::types::Checksum) -> Self {
        self.checksum = ::std::option::Option::Some(input);
        self
    }
    /// <p>The checksum or digest of the object.</p>
    pub fn set_checksum(mut self, input: ::std::option::Option<super::super::super::types::Checksum>) -> Self {
        self.checksum = input;
        self
    }
    /// <p>The checksum or digest of the object.</p>
    pub fn get_checksum(&self) -> &::std::option::Option<super::super::super::types::Checksum> {
        &self.checksum
    }
    /// <p>A collection of parts associated with a multipart upload.</p>
    pub fn object_parts(mut self, input: super::super::super::types::GetObjectAttributesParts) -> Self {
        self.object_parts = ::std::option::Option::Some(input);
        self
    }
    /// <p>A collection of parts associated with a multipart upload.</p>
    pub fn set_object_parts(mut self, input: ::std::option::Option<super::super::super::types::GetObjectAttributesParts>) -> Self {
        self.object_parts = input;
        self
    }
    /// <p>A collection of parts associated with a multipart upload.</p>
    pub fn get_object_parts(&self) -> &::std::option::Option<super::super::super::types::GetObjectAttributesParts> {
        &self.object_parts
    }
    /// <p>Provides the storage class information of the object. Amazon S3 returns this header for all objects except for S3 Standard storage class objects.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/storage-class-intro.html">Storage Classes</a>.</p><note>
    ...
    pub fn build(self) -> super::super::super::operation::get_object_attributes::GetObjectAttributesOutput {
        super::super::super::operation::get_object_attributes::GetObjectAttributesOutput {
