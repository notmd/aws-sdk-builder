...
impl GetBucketAclInput {
    ...
    pub fn builder() -> super::super::super::operation::get_bucket_acl::builders::GetBucketAclInputBuilder {
        super::super::super::operation::get_bucket_acl::builders::GetBucketAclInputBuilder::default()
    }
}
...
impl GetBucketAclInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::get_bucket_acl::GetBucketAclInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::super::operation::get_bucket_acl::GetBucketAclInput {
            bucket: self.bucket,
