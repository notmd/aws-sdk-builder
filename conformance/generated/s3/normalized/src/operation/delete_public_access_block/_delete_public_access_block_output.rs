...
impl super::super::super::s3_request_id::RequestIdExt for DeletePublicAccessBlockOutput {
...
impl DeletePublicAccessBlockOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_public_access_block::builders::DeletePublicAccessBlockOutputBuilder {
        super::super::super::operation::delete_public_access_block::builders::DeletePublicAccessBlockOutputBuilder::default()
    }
}
...
impl DeletePublicAccessBlockOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_public_access_block::DeletePublicAccessBlockOutput {
