...
pub use super::super::super::operation::delete_public_access_block::_delete_public_access_block_input::DeletePublicAccessBlockInputBuilder;

pub use super::super::super::operation::delete_public_access_block::_delete_public_access_block_output::DeletePublicAccessBlockOutputBuilder;

impl super::super::super::operation::delete_public_access_block::builders::DeletePublicAccessBlockInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_public_access_block::DeletePublicAccessBlockOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_public_access_block::DeletePublicAccessBlockError,
...
pub struct DeletePublicAccessBlockFluentBuilder {
    ...
    inner: super::super::super::operation::delete_public_access_block::builders::DeletePublicAccessBlockInputBuilder,
...
impl DeletePublicAccessBlockFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_public_access_block::builders::DeletePublicAccessBlockInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_public_access_block::DeletePublicAccessBlock::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_public_access_block::DeletePublicAccessBlock::orchestrate(&runtime_plugins, input).await
    }
