...
impl GetBucketTaggingInput {
    ...
    pub fn builder() -> super::super::super::operation::get_bucket_tagging::builders::GetBucketTaggingInputBuilder {
        super::super::super::operation::get_bucket_tagging::builders::GetBucketTaggingInputBuilder::default()
    }
}
