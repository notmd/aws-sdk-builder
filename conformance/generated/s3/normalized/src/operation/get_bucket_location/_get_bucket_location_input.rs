...
impl GetBucketLocationInput {
    ...
    pub fn builder() -> super::super::super::operation::get_bucket_location::builders::GetBucketLocationInputBuilder {
        super::super::super::operation::get_bucket_location::builders::GetBucketLocationInputBuilder::default()
    }
}
