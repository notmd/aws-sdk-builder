...
impl CreateMultipartUploadInput {
    ...
    /// <p>Indicates the checksum type that you want Amazon S3 to use to calculate the object’s checksum value. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking object integrity in the Amazon S3 User Guide</a>.</p>
    pub fn checksum_type(&self) -> ::std::option::Option<&super::super::super::types::ChecksumType> {
...
impl CreateMultipartUploadInput {
    ...
    pub fn builder() -> super::super::super::operation::create_multipart_upload::builders::CreateMultipartUploadInputBuilder {
        super::super::super::operation::create_multipart_upload::builders::CreateMultipartUploadInputBuilder::default()
    }
}
...
pub struct CreateMultipartUploadInputBuilder {
    ...
    pub(crate) checksum_type: ::std::option::Option<super::super::super::types::ChecksumType>,
}
impl CreateMultipartUploadInputBuilder {
    ...
    /// <p>Indicates the checksum type that you want Amazon S3 to use to calculate the object’s checksum value. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking object integrity in the Amazon S3 User Guide</a>.</p>
    pub fn checksum_type(mut self, input: super::super::super::types::ChecksumType) -> Self {
        self.checksum_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>Indicates the checksum type that you want Amazon S3 to use to calculate the object’s checksum value. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking object integrity in the Amazon S3 User Guide</a>.</p>
    pub fn set_checksum_type(mut self, input: ::std::option::Option<super::super::super::types::ChecksumType>) -> Self {
        self.checksum_type = input;
        self
    }
    /// <p>Indicates the checksum type that you want Amazon S3 to use to calculate the object’s checksum value. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking object integrity in the Amazon S3 User Guide</a>.</p>
    pub fn get_checksum_type(&self) -> &::std::option::Option<super::super::super::types::ChecksumType> {
        &self.checksum_type
    }
