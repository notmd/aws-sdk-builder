...
impl super::super::super::s3_request_id::RequestIdExt for PutBucketNotificationConfigurationOutput {
...
impl PutBucketNotificationConfigurationOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::put_bucket_notification_configuration::PutBucketNotificationConfigurationOutput {
