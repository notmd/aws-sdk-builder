...
pub use super::super::super::operation::get_bucket_ownership_controls::_get_bucket_ownership_controls_input::GetBucketOwnershipControlsInputBuilder;

pub use super::super::super::operation::get_bucket_ownership_controls::_get_bucket_ownership_controls_output::GetBucketOwnershipControlsOutputBuilder;

impl super::super::super::operation::get_bucket_ownership_controls::builders::GetBucketOwnershipControlsInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::get_bucket_ownership_controls::GetBucketOwnershipControlsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::get_bucket_ownership_controls::GetBucketOwnershipControlsError,
...
pub struct GetBucketOwnershipControlsFluentBuilder {
    ...
    inner: super::super::super::operation::get_bucket_ownership_controls::builders::GetBucketOwnershipControlsInputBuilder,
...
impl GetBucketOwnershipControlsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::get_bucket_ownership_controls::builders::GetBucketOwnershipControlsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::get_bucket_ownership_controls::GetBucketOwnershipControls::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::get_bucket_ownership_controls::GetBucketOwnershipControls::orchestrate(&runtime_plugins, input).await
    }
