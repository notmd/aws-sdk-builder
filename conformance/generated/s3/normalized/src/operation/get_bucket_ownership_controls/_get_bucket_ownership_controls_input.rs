...
impl GetBucketOwnershipControlsInput {
    ...
    pub fn builder() -> super::super::super::operation::get_bucket_ownership_controls::builders::GetBucketOwnershipControlsInputBuilder {
        super::super::super::operation::get_bucket_ownership_controls::builders::GetBucketOwnershipControlsInputBuilder::default()
    }
}
