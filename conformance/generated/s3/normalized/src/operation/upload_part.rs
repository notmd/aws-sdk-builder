...
impl UploadPart {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::super::operation::upload_part::UploadPartOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::upload_part::UploadPartError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::upload_part::UploadPartError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::upload_part::UploadPartOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("S3", "UploadPart", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UploadPart {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UploadPartResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("UploadPart", "S3"));
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UploadPart")
            ...
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                super::super::http_request_checksum::RequestChecksumInterceptor::new(
                    |input: &::aws_smithy_runtime_api::client::interceptors::context::Input| {
                        let input: &super::super::operation::upload_part::UploadPartInput = input.downcast_ref().expect("correct type");
            ...
            .with_retry_classifier(
                ::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::super::operation::upload_part::UploadPartError>::builder()
                    .transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UploadPartResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_upload_part::de_upload_part_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_upload_part::de_upload_part_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UploadPartRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::super::operation::upload_part::UploadPartInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::upload_part::UploadPartInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::super::protocol_serde::shape_upload_part::ser_upload_part_headers(input, builder)?;
        ...
        let body = super::super::protocol_serde::shape_upload_part_input::ser_body_http_payload(input.body)?.into_inner();
...
impl super::super::s3_request_id::RequestIdExt for super::super::operation::upload_part::UploadPartError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::super::operation::upload_part::UploadPartError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::upload_part::_upload_part_input::UploadPartInput;

pub use super::super::operation::upload_part::_upload_part_output::UploadPartOutput;
