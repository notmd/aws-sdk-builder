...
impl super::super::super::s3_request_id::RequestIdExt for PutBucketEncryptionOutput {
...
impl PutBucketEncryptionOutput {
    ...
    pub fn builder() -> super::super::super::operation::put_bucket_encryption::builders::PutBucketEncryptionOutputBuilder {
        super::super::super::operation::put_bucket_encryption::builders::PutBucketEncryptionOutputBuilder::default()
    }
}
...
impl PutBucketEncryptionOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::put_bucket_encryption::PutBucketEncryptionOutput {
