...
impl PutBucketEncryptionInput {
    ...
    /// <p>Specifies the default server-side-encryption configuration.</p>
    pub fn server_side_encryption_configuration(&self) -> ::std::option::Option<&super::super::super::types::ServerSideEncryptionConfiguration> {
...
impl PutBucketEncryptionInput {
    ...
    pub fn builder() -> super::super::super::operation::put_bucket_encryption::builders::PutBucketEncryptionInputBuilder {
        super::super::super::operation::put_bucket_encryption::builders::PutBucketEncryptionInputBuilder::default()
    }
}
...
pub struct PutBucketEncryptionInputBuilder {
    ...
    pub(crate) server_side_encryption_configuration: ::std::option::Option<super::super::super::types::ServerSideEncryptionConfiguration>,
