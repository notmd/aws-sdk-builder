...
pub use super::super::super::operation::get_bucket_metadata_table_configuration::_get_bucket_metadata_table_configuration_input::GetBucketMetadataTableConfigurationInputBuilder;

pub use super::super::super::operation::get_bucket_metadata_table_configuration::_get_bucket_metadata_table_configuration_output::GetBucketMetadataTableConfigurationOutputBuilder;

impl super::super::super::operation::get_bucket_metadata_table_configuration::builders::GetBucketMetadataTableConfigurationInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::get_bucket_metadata_table_configuration::GetBucketMetadataTableConfigurationOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::get_bucket_metadata_table_configuration::GetBucketMetadataTableConfigurationError,
...
pub struct GetBucketMetadataTableConfigurationFluentBuilder {
    ...
    inner: super::super::super::operation::get_bucket_metadata_table_configuration::builders::GetBucketMetadataTableConfigurationInputBuilder,
...
impl GetBucketMetadataTableConfigurationFluentBuilder {
    ...
    > {
        ...
        let runtime_plugins =
            super::super::super::operation::get_bucket_metadata_table_configuration::GetBucketMetadataTableConfiguration::operation_runtime_plugins(
