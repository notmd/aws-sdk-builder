...
impl super::super::super::s3_request_id::RequestIdExt for GetBucketMetadataTableConfigurationOutput {
...
impl GetBucketMetadataTableConfigurationOutputBuilder {
    ...
    pub fn set_get_bucket_metadata_table_configuration_result(
        mut self,
        input: ::std::option::Option<super::super::super::types::GetBucketMetadataTableConfigurationResult>,
    ) -> Self {
    ...
    pub fn build(self) -> super::super::super::operation::get_bucket_metadata_table_configuration::GetBucketMetadataTableConfigurationOutput {
