...
impl ListObjectVersionsOutput {
    ...
    pub fn versions(&self) -> &[super::super::super::types::ObjectVersion] {
    ...
    pub fn delete_markers(&self) -> &[super::super::super::types::DeleteMarkerEntry] {
    ...
    pub fn common_prefixes(&self) -> &[super::super::super::types::CommonPrefix] {
        self.common_prefixes.as_deref().unwrap_or_default()
    }
    /// <p>Encoding type used by Amazon S3 to encode object key names in the XML response.</p>
    /// <p>If you specify the <code>encoding-type</code> request parameter, Amazon S3 includes this element in the response, and returns encoded key name values in the following response elements:</p>
    /// <p><code>KeyMarker, NextKeyMarker, Prefix, Key</code>, and <code>Delimiter</code>.</p>
    pub fn encoding_type(&self) -> ::std::option::Option<&super::super::super::types::EncodingType> {
...
impl super::super::super::s3_request_id::RequestIdExt for ListObjectVersionsOutput {
...
impl ListObjectVersionsOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_object_versions::builders::ListObjectVersionsOutputBuilder {
        super::super::super::operation::list_object_versions::builders::ListObjectVersionsOutputBuilder::default()
    }
}
...
pub struct ListObjectVersionsOutputBuilder {
    ...
    pub(crate) versions: ::std::option::Option<::std::vec::Vec<super::super::super::types::ObjectVersion>>,
    pub(crate) delete_markers: ::std::option::Option<::std::vec::Vec<super::super::super::types::DeleteMarkerEntry>>,
    pub(crate) name: ::std::option::Option<::std::string::String>,
    pub(crate) prefix: ::std::option::Option<::std::string::String>,
    pub(crate) delimiter: ::std::option::Option<::std::string::String>,
    pub(crate) max_keys: ::std::option::Option<i32>,
    pub(crate) common_prefixes: ::std::option::Option<::std::vec::Vec<super::super::super::types::CommonPrefix>>,
    pub(crate) encoding_type: ::std::option::Option<super::super::super::types::EncodingType>,
...
impl ListObjectVersionsOutputBuilder {
    ...
    ///
    /// <p>Container for version information.</p>
    pub fn versions(mut self, input: super::super::super::types::ObjectVersion) -> Self {
    ...
    /// <p>Container for version information.</p>
    pub fn set_versions(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::ObjectVersion>>) -> Self {
        self.versions = input;
        self
    }
    /// <p>Container for version information.</p>
    pub fn get_versions(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::ObjectVersion>> {
        &self.versions
    }
    ...
    ///
    /// <p>Container for an object that is a delete marker. To learn more about delete markers, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/DeleteMarker.html">Working with delete markers</a>.</p>
    pub fn delete_markers(mut self, input: super::super::super::types::DeleteMarkerEntry) -> Self {
    ...
    /// <p>Container for an object that is a delete marker. To learn more about delete markers, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/DeleteMarker.html">Working with delete markers</a>.</p>
    pub fn set_delete_markers(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::DeleteMarkerEntry>>) -> Self {
        self.delete_markers = input;
        self
    }
    /// <p>Container for an object that is a delete marker. To learn more about delete markers, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/DeleteMarker.html">Working with delete markers</a>.</p>
    pub fn get_delete_markers(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::DeleteMarkerEntry>> {
        &self.delete_markers
    }
    /// <p>The bucket name.</p>
    ...
    ///
    /// <p>All of the keys rolled up into a common prefix count as a single return when calculating the number of returns.</p>
    pub fn common_prefixes(mut self, input: super::super::super::types::CommonPrefix) -> Self {
    ...
    /// <p>All of the keys rolled up into a common prefix count as a single return when calculating the number of returns.</p>
    pub fn set_common_prefixes(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::CommonPrefix>>) -> Self {
        self.common_prefixes = input;
        self
    }
    /// <p>All of the keys rolled up into a common prefix count as a single return when calculating the number of returns.</p>
    pub fn get_common_prefixes(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::CommonPrefix>> {
        &self.common_prefixes
    }
    /// <p>Encoding type used by Amazon S3 to encode object key names in the XML response.</p>
    /// <p>If you specify the <code>encoding-type</code> request parameter, Amazon S3 includes this element in the response, and returns encoded key name values in the following response elements:</p>
    /// <p><code>KeyMarker, NextKeyMarker, Prefix, Key</code>, and <code>Delimiter</code>.</p>
    pub fn encoding_type(mut self, input: super::super::super::types::EncodingType) -> Self {
    ...
    /// <p>If you specify the <code>encoding-type</code> request parameter, Amazon S3 includes this element in the response, and returns encoded key name values in the following response elements:</p>
    /// <p><code>KeyMarker, NextKeyMarker, Prefix, Key</code>, and <code>Delimiter</code>.</p>
    pub fn set_encoding_type(mut self, input: ::std::option::Option<super::super::super::types::EncodingType>) -> Self {
    ...
    /// <p>If you specify the <code>encoding-type</code> request parameter, Amazon S3 includes this element in the response, and returns encoded key name values in the following response elements:</p>
    /// <p><code>KeyMarker, NextKeyMarker, Prefix, Key</code>, and <code>Delimiter</code>.</p>
    pub fn get_encoding_type(&self) -> &::std::option::Option<super::super::super::types::EncodingType> {
        &self.encoding_type
    }
    /// <p>If present, indicates that the requester was successfully charged for the request. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/RequesterPaysBuckets.html">Using Requester Pays buckets for storage transfers and usage</a> in the <i>Amazon Simple Storage Service user guide</i>.</p><note>
    /// <p>This functionality is not supported for directory buckets.</p>
    ...
    pub fn build(self) -> super::super::super::operation::list_object_versions::ListObjectVersionsOutput {
        super::super::super::operation::list_object_versions::ListObjectVersionsOutput {
