...
impl GetObjectLegalHoldInput {
    ...
    pub fn builder() -> super::super::super::operation::get_object_legal_hold::builders::GetObjectLegalHoldInputBuilder {
        super::super::super::operation::get_object_legal_hold::builders::GetObjectLegalHoldInputBuilder::default()
    }
}
