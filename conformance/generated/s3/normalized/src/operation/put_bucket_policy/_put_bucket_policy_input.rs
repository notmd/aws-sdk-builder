...
impl PutBucketPolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::put_bucket_policy::builders::PutBucketPolicyInputBuilder {
        super::super::super::operation::put_bucket_policy::builders::PutBucketPolicyInputBuilder::default()
    }
}
