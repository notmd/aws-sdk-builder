...
impl PutObjectLockConfiguration {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::put_object_lock_configuration::PutObjectLockConfigurationInput,
    ) -> ::std::result::Result<
        super::super::operation::put_object_lock_configuration::PutObjectLockConfigurationOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::put_object_lock_configuration::PutObjectLockConfigurationError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::put_object_lock_configuration::PutObjectLockConfigurationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::put_object_lock_configuration::PutObjectLockConfigurationOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("S3", "PutObjectLockConfiguration", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutObjectLockConfiguration {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutObjectLockConfiguration")
            ...
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                super::super::http_request_checksum::RequestChecksumInterceptor::new(
                    |input: &::aws_smithy_runtime_api::client::interceptors::context::Input| {
                        let input: &super::super::operation::put_object_lock_configuration::PutObjectLockConfigurationInput =
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutObjectLockConfigurationTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<PutObjectLockConfigurationInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutObjectLockConfigurationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_put_object_lock_configuration::de_put_object_lock_configuration_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_put_object_lock_configuration::de_put_object_lock_configuration_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutObjectLockConfigurationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::put_object_lock_configuration::PutObjectLockConfigurationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::put_object_lock_configuration::PutObjectLockConfigurationInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::super::protocol_serde::shape_put_object_lock_configuration::ser_put_object_lock_configuration_headers(input, builder)?;
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_put_object_lock_configuration_input::ser_object_lock_configuration_http_payload(
...
impl super::super::s3_request_id::RequestIdExt for super::super::operation::put_object_lock_configuration::PutObjectLockConfigurationError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::super::operation::put_object_lock_configuration::PutObjectLockConfigurationError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::put_object_lock_configuration::_put_object_lock_configuration_input::PutObjectLockConfigurationInput;

pub use super::super::operation::put_object_lock_configuration::_put_object_lock_configuration_output::PutObjectLockConfigurationOutput;
