...
impl UploadPartCopyInput {
    ...
    pub fn builder() -> super::super::super::operation::upload_part_copy::builders::UploadPartCopyInputBuilder {
        super::super::super::operation::upload_part_copy::builders::UploadPartCopyInputBuilder::default()
    }
}
...
impl UploadPartCopyInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::upload_part_copy::UploadPartCopyInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::super::operation::upload_part_copy::UploadPartCopyInput {
            bucket: self.bucket,
