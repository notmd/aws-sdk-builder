...
impl UploadPartCopyOutput {
    ...
    /// <p>Container for all response elements.</p>
    pub fn copy_part_result(&self) -> ::std::option::Option<&super::super::super::types::CopyPartResult> {
...
impl super::super::super::s3_request_id::RequestIdExt for UploadPartCopyOutput {
...
impl UploadPartCopyOutput {
    ...
    pub fn builder() -> super::super::super::operation::upload_part_copy::builders::UploadPartCopyOutputBuilder {
        super::super::super::operation::upload_part_copy::builders::UploadPartCopyOutputBuilder::default()
    }
}
...
pub struct UploadPartCopyOutputBuilder {
    ...
    pub(crate) copy_part_result: ::std::option::Option<super::super::super::types::CopyPartResult>,
...
impl UploadPartCopyOutputBuilder {
    ...
    /// <p>Container for all response elements.</p>
    pub fn copy_part_result(mut self, input: super::super::super::types::CopyPartResult) -> Self {
        self.copy_part_result = ::std::option::Option::Some(input);
        self
    }
    /// <p>Container for all response elements.</p>
    pub fn set_copy_part_result(mut self, input: ::std::option::Option<super::super::super::types::CopyPartResult>) -> Self {
        self.copy_part_result = input;
        self
    }
    /// <p>Container for all response elements.</p>
    pub fn get_copy_part_result(&self) -> &::std::option::Option<super::super::super::types::CopyPartResult> {
    ...
    pub fn build(self) -> super::super::super::operation::upload_part_copy::UploadPartCopyOutput {
        super::super::super::operation::upload_part_copy::UploadPartCopyOutput {
