...
impl UploadPartCopy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::upload_part_copy::UploadPartCopyInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::upload_part_copy::UploadPartCopyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::upload_part_copy::UploadPartCopyOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("S3", "UploadPartCopy", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UploadPartCopy {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("UploadPartCopy", "S3"));
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UploadPartCopyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_upload_part_copy::de_upload_part_copy_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_upload_part_copy::de_upload_part_copy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UploadPartCopyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::upload_part_copy::UploadPartCopyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::upload_part_copy::UploadPartCopyInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::super::protocol_serde::shape_upload_part_copy::ser_upload_part_copy_headers(input, builder)?;
...
impl super::super::s3_request_id::RequestIdExt for super::super::operation::upload_part_copy::UploadPartCopyError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::super::operation::upload_part_copy::UploadPartCopyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::upload_part_copy::_upload_part_copy_input::UploadPartCopyInput;

pub use super::super::operation::upload_part_copy::_upload_part_copy_output::UploadPartCopyOutput;
