...
impl PutBucketIntelligentTieringConfigurationInput {
    ...
    /// <p>Container for S3 Intelligent-Tiering configuration.</p>
    pub fn intelligent_tiering_configuration(&self) -> ::std::option::Option<&super::super::super::types::IntelligentTieringConfiguration> {
...
pub struct PutBucketIntelligentTieringConfigurationInputBuilder {
    ...
    pub(crate) intelligent_tiering_configuration: ::std::option::Option<super::super::super::types::IntelligentTieringConfiguration>,
}
impl PutBucketIntelligentTieringConfigurationInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::put_bucket_intelligent_tiering_configuration::PutBucketIntelligentTieringConfigurationInput,
