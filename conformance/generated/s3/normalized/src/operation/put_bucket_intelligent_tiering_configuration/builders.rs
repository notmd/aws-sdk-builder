...
pub use super::super::super::operation::put_bucket_intelligent_tiering_configuration::_put_bucket_intelligent_tiering_configuration_input::PutBucketIntelligentTieringConfigurationInputBuilder;

pub use super::super::super::operation::put_bucket_intelligent_tiering_configuration::_put_bucket_intelligent_tiering_configuration_output::PutBucketIntelligentTieringConfigurationOutputBuilder;

impl super::super::super::operation::put_bucket_intelligent_tiering_configuration::builders::PutBucketIntelligentTieringConfigurationInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::put_bucket_intelligent_tiering_configuration::PutBucketIntelligentTieringConfigurationError,
...
impl PutBucketIntelligentTieringConfigurationFluentBuilder {
    ...
    pub fn intelligent_tiering_configuration(mut self, input: super::super::super::types::IntelligentTieringConfiguration) -> Self {
    ...
    /// <p>Container for S3 Intelligent-Tiering configuration.</p>
    pub fn get_intelligent_tiering_configuration(&self) -> &::std::option::Option<super::super::super::types::IntelligentTieringConfiguration> {
