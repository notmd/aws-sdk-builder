...
impl CompleteMultipartUpload {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::complete_multipart_upload::CompleteMultipartUploadInput,
    ) -> ::std::result::Result<
        super::super::operation::complete_multipart_upload::CompleteMultipartUploadOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::complete_multipart_upload::CompleteMultipartUploadError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::complete_multipart_upload::CompleteMultipartUploadError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::complete_multipart_upload::CompleteMultipartUploadOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("S3", "CompleteMultipartUpload", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CompleteMultipartUploadTelemetryInputCaptureInterceptor {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CompleteMultipartUploadResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_complete_multipart_upload::de_complete_multipart_upload_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_complete_multipart_upload::de_complete_multipart_upload_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CompleteMultipartUploadRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::complete_multipart_upload::CompleteMultipartUploadInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::complete_multipart_upload::CompleteMultipartUploadInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::super::protocol_serde::shape_complete_multipart_upload::ser_complete_multipart_upload_headers(input, builder)?;
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_complete_multipart_upload_input::ser_multipart_upload_http_payload(&input.multipart_upload)?,
        );
...
impl super::super::s3_request_id::RequestIdExt for super::super::operation::complete_multipart_upload::CompleteMultipartUploadError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::super::operation::complete_multipart_upload::CompleteMultipartUploadError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::complete_multipart_upload::_complete_multipart_upload_input::CompleteMultipartUploadInput;

pub use super::super::operation::complete_multipart_upload::_complete_multipart_upload_output::CompleteMultipartUploadOutput;
