...
impl super::super::super::s3_request_id::RequestIdExt for DeleteBucketPolicyOutput {
...
impl DeleteBucketPolicyOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_bucket_policy::builders::DeleteBucketPolicyOutputBuilder {
        super::super::super::operation::delete_bucket_policy::builders::DeleteBucketPolicyOutputBuilder::default()
    }
}
...
impl DeleteBucketPolicyOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_bucket_policy::DeleteBucketPolicyOutput {
