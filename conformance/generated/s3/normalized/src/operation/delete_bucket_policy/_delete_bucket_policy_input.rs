...
impl DeleteBucketPolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_bucket_policy::builders::DeleteBucketPolicyInputBuilder {
        super::super::super::operation::delete_bucket_policy::builders::DeleteBucketPolicyInputBuilder::default()
    }
}
