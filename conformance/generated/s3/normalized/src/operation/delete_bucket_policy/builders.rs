...
pub use super::super::super::operation::delete_bucket_policy::_delete_bucket_policy_input::DeleteBucketPolicyInputBuilder;

pub use super::super::super::operation::delete_bucket_policy::_delete_bucket_policy_output::DeleteBucketPolicyOutputBuilder;

impl super::super::super::operation::delete_bucket_policy::builders::DeleteBucketPolicyInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_bucket_policy::DeleteBucketPolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_bucket_policy::DeleteBucketPolicyError,
...
///
/// <p>Deletes the policy of a specified bucket.</p><note>
...
/// </dt>
/// <dd>
/// <p>If you are using an identity other than the root user of the Amazon Web Services account that owns the bucket, the calling identity must both have the <code>DeleteBucketPolicy</code> permissions on the specified bucket and belong to the bucket owner's account in order to use this operation.</p>
...
/// <ul>
/// <li>
/// <p><b>General purpose bucket permissions</b> - The <code>s3:DeleteBucketPolicy</code> permission is required in a policy. For more information about general purpose buckets bucket policies, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/using-iam-policies.html">Using Bucket Policies and User Policies</a> in the <i>Amazon S3 User Guide</i>.</p></li>
/// <li>
...
pub struct DeleteBucketPolicyFluentBuilder {
    ...
    inner: super::super::super::operation::delete_bucket_policy::builders::DeleteBucketPolicyInputBuilder,
...
impl DeleteBucketPolicyFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_bucket_policy::builders::DeleteBucketPolicyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_bucket_policy::DeleteBucketPolicy::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_bucket_policy::DeleteBucketPolicy::orchestrate(&runtime_plugins, input).await
    }
