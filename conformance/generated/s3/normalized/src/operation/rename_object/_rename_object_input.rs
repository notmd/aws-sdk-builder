...
impl RenameObjectInput {
    ...
    pub fn builder() -> super::super::super::operation::rename_object::builders::RenameObjectInputBuilder {
        super::super::super::operation::rename_object::builders::RenameObjectInputBuilder::default()
    }
}
