...
impl super::super::super::s3_request_id::RequestIdExt for RenameObjectOutput {
...
impl RenameObjectOutput {
    ...
    pub fn builder() -> super::super::super::operation::rename_object::builders::RenameObjectOutputBuilder {
        super::super::super::operation::rename_object::builders::RenameObjectOutputBuilder::default()
    }
}
...
impl RenameObjectOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::rename_object::RenameObjectOutput {
