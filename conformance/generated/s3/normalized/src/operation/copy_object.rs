...
impl CopyObject {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::copy_object::CopyObjectInput,
    ) -> ::std::result::Result<
        super::super::operation::copy_object::CopyObjectOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::copy_object::CopyObjectError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::copy_object::CopyObjectError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::copy_object::CopyObjectOutput>()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CopyObject")
            ...
            .with_retry_classifier(
                ::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::super::operation::copy_object::CopyObjectError>::builder()
                    .transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CopyObjectResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_copy_object::de_copy_object_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_copy_object::de_copy_object_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CopyObjectRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::super::operation::copy_object::CopyObjectInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::copy_object::CopyObjectInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::super::protocol_serde::shape_copy_object::ser_copy_object_headers(input, builder)?;
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CopyObjectError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::ObjectNotInActiveTierError(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
...
impl super::super::s3_request_id::RequestIdExt for super::super::operation::copy_object::CopyObjectError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::super::operation::copy_object::CopyObjectError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::copy_object::_copy_object_input::CopyObjectInput;

pub use super::super::operation::copy_object::_copy_object_output::CopyObjectOutput;
