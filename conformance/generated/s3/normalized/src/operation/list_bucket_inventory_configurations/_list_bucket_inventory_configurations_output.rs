...
impl ListBucketInventoryConfigurationsOutput {
    ...
    pub fn inventory_configuration_list(&self) -> &[super::super::super::types::InventoryConfiguration] {
...
impl super::super::super::s3_request_id::RequestIdExt for ListBucketInventoryConfigurationsOutput {
...
pub struct ListBucketInventoryConfigurationsOutputBuilder {
    ...
    pub(crate) inventory_configuration_list: ::std::option::Option<::std::vec::Vec<super::super::super::types::InventoryConfiguration>>,
...
impl ListBucketInventoryConfigurationsOutputBuilder {
    ...
    ///
    /// <p>The list of inventory configurations for a bucket.</p>
    pub fn inventory_configuration_list(mut self, input: super::super::super::types::InventoryConfiguration) -> Self {
    ...
    /// <p>The list of inventory configurations for a bucket.</p>
    pub fn get_inventory_configuration_list(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::InventoryConfiguration>> {
    ...
    pub fn build(self) -> super::super::super::operation::list_bucket_inventory_configurations::ListBucketInventoryConfigurationsOutput {
