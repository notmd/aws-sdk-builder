...
impl super::super::super::s3_request_id::RequestIdExt for PutBucketWebsiteOutput {
...
impl PutBucketWebsiteOutput {
    ...
    pub fn builder() -> super::super::super::operation::put_bucket_website::builders::PutBucketWebsiteOutputBuilder {
        super::super::super::operation::put_bucket_website::builders::PutBucketWebsiteOutputBuilder::default()
    }
}
...
impl PutBucketWebsiteOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::put_bucket_website::PutBucketWebsiteOutput {
