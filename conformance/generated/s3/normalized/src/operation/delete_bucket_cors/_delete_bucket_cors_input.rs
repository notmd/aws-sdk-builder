...
impl DeleteBucketCorsInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_bucket_cors::builders::DeleteBucketCorsInputBuilder {
        super::super::super::operation::delete_bucket_cors::builders::DeleteBucketCorsInputBuilder::default()
    }
}
