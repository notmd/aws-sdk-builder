...
impl PutObjectRetention {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::put_object_retention::PutObjectRetentionInput,
    ) -> ::std::result::Result<
        super::super::operation::put_object_retention::PutObjectRetentionOutput,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::put_object_retention::PutObjectRetentionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::put_object_retention::PutObjectRetentionOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("S3", "PutObjectRetention", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutObjectRetentionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_put_object_retention::de_put_object_retention_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_put_object_retention::de_put_object_retention_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutObjectRetentionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::put_object_retention::PutObjectRetentionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::put_object_retention::PutObjectRetentionInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::super::protocol_serde::shape_put_object_retention::ser_put_object_retention_headers(input, builder)?;
...
impl super::super::s3_request_id::RequestIdExt for super::super::operation::put_object_retention::PutObjectRetentionError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::super::operation::put_object_retention::PutObjectRetentionError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::put_object_retention::_put_object_retention_input::PutObjectRetentionInput;

pub use super::super::operation::put_object_retention::_put_object_retention_output::PutObjectRetentionOutput;
