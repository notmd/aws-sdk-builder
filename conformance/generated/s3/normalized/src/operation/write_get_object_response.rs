    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::write_get_object_response::WriteGetObjectResponseError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::write_get_object_response::WriteGetObjectResponseOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for WriteGetObjectResponseResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_write_get_object_response::de_write_get_object_response_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_write_get_object_response::de_write_get_object_response_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for WriteGetObjectResponseRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::write_get_object_response::WriteGetObjectResponseInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::write_get_object_response::WriteGetObjectResponseInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::super::protocol_serde::shape_write_get_object_response::ser_write_get_object_response_headers(input, builder)?;
        ...
        let body = super::super::protocol_serde::shape_write_get_object_response_input::ser_body_http_payload(input.body)?.into_inner();
...
impl super::super::s3_request_id::RequestIdExt for super::super::operation::write_get_object_response::WriteGetObjectResponseError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::super::operation::write_get_object_response::WriteGetObjectResponseError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::write_get_object_response::_write_get_object_response_input::WriteGetObjectResponseInput;

pub use super::super::operation::write_get_object_response::_write_get_object_response_output::WriteGetObjectResponseOutput;
