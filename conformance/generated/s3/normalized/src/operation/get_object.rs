...
impl GetObject {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::super::operation::get_object::GetObjectOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::get_object::GetObjectError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::get_object::GetObjectError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::get_object::GetObjectOutput>()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetObject")
            ...
            .with_retry_classifier(
                ::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::super::operation::get_object::GetObjectError>::builder()
                    .transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetObjectResponseDeserializer {
    fn deserialize_streaming(
        ...
        ::std::option::Option::Some(super::super::protocol_serde::type_erase_result(
            super::super::protocol_serde::shape_get_object::de_get_object_http_response(response),
        ))
    }
    ...
    fn deserialize_nonstreaming_with_config(
        ...
        super::super::protocol_serde::type_erase_result(super::super::protocol_serde::shape_get_object::de_get_object_http_error(
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetObjectRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::get_object::GetObjectInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::super::protocol_serde::shape_get_object::ser_get_object_headers(input, builder)?;
...
impl super::super::s3_request_id::RequestIdExt for super::super::operation::get_object::GetObjectError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::super::operation::get_object::GetObjectError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::get_object::_get_object_input::GetObjectInput;

pub use super::super::operation::get_object::_get_object_output::GetObjectOutput;
