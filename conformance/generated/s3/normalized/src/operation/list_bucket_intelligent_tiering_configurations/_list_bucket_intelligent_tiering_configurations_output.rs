...
impl ListBucketIntelligentTieringConfigurationsOutput {
    ...
    pub fn intelligent_tiering_configuration_list(&self) -> &[super::super::super::types::IntelligentTieringConfiguration] {
        self.intelligent_tiering_configuration_list.as_deref().unwrap_or_default()
    }
}
impl super::super::super::s3_request_id::RequestIdExt for ListBucketIntelligentTieringConfigurationsOutput {
...
impl ListBucketIntelligentTieringConfigurationsOutputBuilder {
    ...
    ///
    /// <p>The list of S3 Intelligent-Tiering configurations for a bucket.</p>
    pub fn intelligent_tiering_configuration_list(mut self, input: super::super::super::types::IntelligentTieringConfiguration) -> Self {
    ...
    pub fn set_intelligent_tiering_configuration_list(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::IntelligentTieringConfiguration>>,
    ) -> Self {
