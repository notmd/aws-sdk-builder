...
impl GetObjectAnnotationInput {
    ...
    /// <p>Set to <code>ENABLED</code> to validate the checksum of the annotation payload on retrieval.</p>
    pub fn checksum_mode(&self) -> ::std::option::Option<&super::super::super::types::ChecksumMode> {
...
impl GetObjectAnnotationInput {
    ...
    pub fn builder() -> super::super::super::operation::get_object_annotation::builders::GetObjectAnnotationInputBuilder {
        super::super::super::operation::get_object_annotation::builders::GetObjectAnnotationInputBuilder::default()
    }
}
...
pub struct GetObjectAnnotationInputBuilder {
    ...
    pub(crate) checksum_mode: ::std::option::Option<super::super::super::types::ChecksumMode>,
}
