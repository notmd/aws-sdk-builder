...
impl super::super::super::s3_request_id::RequestIdExt for GetObjectAnnotationOutput {
...
impl GetObjectAnnotationOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_object_annotation::builders::GetObjectAnnotationOutputBuilder {
        super::super::super::operation::get_object_annotation::builders::GetObjectAnnotationOutputBuilder::default()
    }
}
...
impl GetObjectAnnotationOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::get_object_annotation::GetObjectAnnotationOutput {
        super::super::super::operation::get_object_annotation::GetObjectAnnotationOutput {
