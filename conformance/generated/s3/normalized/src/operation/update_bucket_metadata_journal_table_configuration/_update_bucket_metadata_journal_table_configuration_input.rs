...
impl UpdateBucketMetadataJournalTableConfigurationInput {
    ...
    /// <p>The contents of your journal table configuration.</p>
    pub fn journal_table_configuration(&self) -> ::std::option::Option<&super::super::super::types::JournalTableConfigurationUpdates> {
...
pub struct UpdateBucketMetadataJournalTableConfigurationInputBuilder {
    ...
    pub(crate) journal_table_configuration: ::std::option::Option<super::super::super::types::JournalTableConfigurationUpdates>,
...
impl UpdateBucketMetadataJournalTableConfigurationInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::update_bucket_metadata_journal_table_configuration::UpdateBucketMetadataJournalTableConfigurationInput,
