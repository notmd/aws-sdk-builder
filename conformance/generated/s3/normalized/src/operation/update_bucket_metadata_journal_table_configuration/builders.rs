...
pub use super::super::super::operation::update_bucket_metadata_journal_table_configuration::_update_bucket_metadata_journal_table_configuration_input::UpdateBucketMetadataJournalTableConfigurationInputBuilder;

pub use super::super::super::operation::update_bucket_metadata_journal_table_configuration::_update_bucket_metadata_journal_table_configuration_output::UpdateBucketMetadataJournalTableConfigurationOutputBuilder;

impl super::super::super::operation::update_bucket_metadata_journal_table_configuration::builders::UpdateBucketMetadataJournalTableConfigurationInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::update_bucket_metadata_journal_table_configuration::UpdateBucketMetadataJournalTableConfigurationError,
...
pub struct UpdateBucketMetadataJournalTableConfigurationFluentBuilder {
    ...
    inner: super::super::super::operation::update_bucket_metadata_journal_table_configuration::builders::UpdateBucketMetadataJournalTableConfigurationInputBuilder,
...
impl UpdateBucketMetadataJournalTableConfigurationFluentBuilder {
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::update_bucket_metadata_journal_table_configuration::UpdateBucketMetadataJournalTableConfiguration::operation_runtime_plugins(
    ...
    pub fn journal_table_configuration(mut self, input: super::super::super::types::JournalTableConfigurationUpdates) -> Self {
    ...
    /// <p>The contents of your journal table configuration.</p>
    pub fn get_journal_table_configuration(&self) -> &::std::option::Option<super::super::super::types::JournalTableConfigurationUpdates> {
