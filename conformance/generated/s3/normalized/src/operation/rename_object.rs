...
impl RenameObject {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::rename_object::RenameObjectInput,
    ) -> ::std::result::Result<
        super::super::operation::rename_object::RenameObjectOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::rename_object::RenameObjectError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::rename_object::RenameObjectError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::rename_object::RenameObjectOutput>()
    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(super::super::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut super::super::operation::rename_object::RenameObjectInput = input.downcast_mut().expect("correct type");
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RenameObject")
            ...
            .with_retry_classifier(
                ::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::super::operation::rename_object::RenameObjectError>::builder()
                    .transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RenameObjectResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_rename_object::de_rename_object_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_rename_object::de_rename_object_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RenameObjectRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::rename_object::RenameObjectInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::rename_object::RenameObjectInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::super::protocol_serde::shape_rename_object::ser_rename_object_headers(input, builder)?;
...
impl super::super::s3_request_id::RequestIdExt for super::super::operation::rename_object::RenameObjectError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::super::operation::rename_object::RenameObjectError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::rename_object::_rename_object_input::RenameObjectInput;

pub use super::super::operation::rename_object::_rename_object_output::RenameObjectOutput;
