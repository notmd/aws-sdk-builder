...
impl UploadPartInput {
    ...
    pub fn builder() -> super::super::super::operation::upload_part::builders::UploadPartInputBuilder {
        super::super::super::operation::upload_part::builders::UploadPartInputBuilder::default()
    }
}
