...
impl super::super::super::s3_request_id::RequestIdExt for UploadPartOutput {
...
impl UploadPartOutput {
    ...
    pub fn builder() -> super::super::super::operation::upload_part::builders::UploadPartOutputBuilder {
        super::super::super::operation::upload_part::builders::UploadPartOutputBuilder::default()
    }
}
...
impl UploadPartOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::upload_part::UploadPartOutput {
