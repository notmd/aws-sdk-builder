...
impl ListDirectoryBucketsInput {
    ...
    pub fn builder() -> super::super::super::operation::list_directory_buckets::builders::ListDirectoryBucketsInputBuilder {
        super::super::super::operation::list_directory_buckets::builders::ListDirectoryBucketsInputBuilder::default()
    }
}
