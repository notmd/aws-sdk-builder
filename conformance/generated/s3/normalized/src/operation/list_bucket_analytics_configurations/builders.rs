...
pub use super::super::super::operation::list_bucket_analytics_configurations::_list_bucket_analytics_configurations_input::ListBucketAnalyticsConfigurationsInputBuilder;

pub use super::super::super::operation::list_bucket_analytics_configurations::_list_bucket_analytics_configurations_output::ListBucketAnalyticsConfigurationsOutputBuilder;

impl super::super::super::operation::list_bucket_analytics_configurations::builders::ListBucketAnalyticsConfigurationsInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::list_bucket_analytics_configurations::ListBucketAnalyticsConfigurationsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::list_bucket_analytics_configurations::ListBucketAnalyticsConfigurationsError,
...
pub struct ListBucketAnalyticsConfigurationsFluentBuilder {
    ...
    inner: super::super::super::operation::list_bucket_analytics_configurations::builders::ListBucketAnalyticsConfigurationsInputBuilder,
