...
impl ListBucketAnalyticsConfigurationsOutput {
    ...
    pub fn analytics_configuration_list(&self) -> &[super::super::super::types::AnalyticsConfiguration] {
        self.analytics_configuration_list.as_deref().unwrap_or_default()
    }
}
impl super::super::super::s3_request_id::RequestIdExt for ListBucketAnalyticsConfigurationsOutput {
...
pub struct ListBucketAnalyticsConfigurationsOutputBuilder {
    ...
    pub(crate) analytics_configuration_list: ::std::option::Option<::std::vec::Vec<super::super::super::types::AnalyticsConfiguration>>,
    _extended_request_id: Option<String>,
    _request_id: Option<String>,
}
impl ListBucketAnalyticsConfigurationsOutputBuilder {
    ...
    ///
    /// <p>The list of analytics configurations for a bucket.</p>
    pub fn analytics_configuration_list(mut self, input: super::super::super::types::AnalyticsConfiguration) -> Self {
    ...
    /// <p>The list of analytics configurations for a bucket.</p>
    pub fn get_analytics_configuration_list(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::AnalyticsConfiguration>> {
    ...
    pub fn build(self) -> super::super::super::operation::list_bucket_analytics_configurations::ListBucketAnalyticsConfigurationsOutput {
