...
impl super::super::super::s3_request_id::RequestIdExt for ListObjectsOutput {
...
impl ListObjectsOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_objects::builders::ListObjectsOutputBuilder {
        super::super::super::operation::list_objects::builders::ListObjectsOutputBuilder::default()
    }
}
...
impl ListObjectsOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::list_objects::ListObjectsOutput {
        super::super::super::operation::list_objects::ListObjectsOutput {
