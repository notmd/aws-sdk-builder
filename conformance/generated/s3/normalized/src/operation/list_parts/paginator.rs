...
impl ListPartsPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::list_parts::paginator::ListPartsPaginatorItems {
        super::super::super::operation::list_parts::paginator::ListPartsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::super::super::operation::list_parts::ListParts::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_parts_output_output_next_part_number_marker(resp);
