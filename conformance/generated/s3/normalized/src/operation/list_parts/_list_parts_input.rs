...
impl ListPartsInput {
    ...
    pub fn builder() -> super::super::super::operation::list_parts::builders::ListPartsInputBuilder {
        super::super::super::operation::list_parts::builders::ListPartsInputBuilder::default()
    }
}
