...
impl DeleteObjectInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_object::builders::DeleteObjectInputBuilder {
        super::super::super::operation::delete_object::builders::DeleteObjectInputBuilder::default()
    }
}
