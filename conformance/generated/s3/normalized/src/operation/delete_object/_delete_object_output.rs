...
impl super::super::super::s3_request_id::RequestIdExt for DeleteObjectOutput {
...
impl DeleteObjectOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_object::builders::DeleteObjectOutputBuilder {
        super::super::super::operation::delete_object::builders::DeleteObjectOutputBuilder::default()
    }
}
...
impl DeleteObjectOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_object::DeleteObjectOutput {
