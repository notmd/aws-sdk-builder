...
impl ListBucketsOutput {
    ...
    pub fn buckets(&self) -> &[super::super::super::types::Bucket] {
...
impl super::super::super::s3_request_id::RequestIdExt for ListBucketsOutput {
...
impl ListBucketsOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_buckets::builders::ListBucketsOutputBuilder {
        super::super::super::operation::list_buckets::builders::ListBucketsOutputBuilder::default()
    }
}
...
pub struct ListBucketsOutputBuilder {
    pub(crate) buckets: ::std::option::Option<::std::vec::Vec<super::super::super::types::Bucket>>,
...
impl ListBucketsOutputBuilder {
    ...
    ///
    /// <p>The list of buckets owned by the requester.</p>
    pub fn buckets(mut self, input: super::super::super::types::Bucket) -> Self {
    ...
    /// <p>The list of buckets owned by the requester.</p>
    pub fn set_buckets(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::Bucket>>) -> Self {
        self.buckets = input;
        self
    }
    /// <p>The list of buckets owned by the requester.</p>
    pub fn get_buckets(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::Bucket>> {
        &self.buckets
    }
    /// <p>The owner of the buckets listed.</p>
    ...
    pub fn build(self) -> super::super::super::operation::list_buckets::ListBucketsOutput {
        super::super::super::operation::list_buckets::ListBucketsOutput {
