...
impl ListBucketsInput {
    ...
    pub fn builder() -> super::super::super::operation::list_buckets::builders::ListBucketsInputBuilder {
        super::super::super::operation::list_buckets::builders::ListBucketsInputBuilder::default()
    }
}
