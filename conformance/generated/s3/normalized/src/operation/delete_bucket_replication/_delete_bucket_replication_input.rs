...
impl DeleteBucketReplicationInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_bucket_replication::builders::DeleteBucketReplicationInputBuilder {
        super::super::super::operation::delete_bucket_replication::builders::DeleteBucketReplicationInputBuilder::default()
    }
}
...
impl DeleteBucketReplicationInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::delete_bucket_replication::DeleteBucketReplicationInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::delete_bucket_replication::DeleteBucketReplicationInput {
            bucket: self.bucket,
