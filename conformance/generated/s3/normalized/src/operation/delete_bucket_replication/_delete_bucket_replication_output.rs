...
impl super::super::super::s3_request_id::RequestIdExt for DeleteBucketReplicationOutput {
...
impl DeleteBucketReplicationOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_bucket_replication::builders::DeleteBucketReplicationOutputBuilder {
        super::super::super::operation::delete_bucket_replication::builders::DeleteBucketReplicationOutputBuilder::default()
    }
}
...
impl DeleteBucketReplicationOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_bucket_replication::DeleteBucketReplicationOutput {
