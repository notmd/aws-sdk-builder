...
impl ListObjectVersions {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::list_object_versions::ListObjectVersionsInput,
    ) -> ::std::result::Result<
        super::super::operation::list_object_versions::ListObjectVersionsOutput,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::list_object_versions::ListObjectVersionsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::list_object_versions::ListObjectVersionsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListObjectVersionsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_list_object_versions::de_list_object_versions_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_list_object_versions::de_list_object_versions_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListObjectVersionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::list_object_versions::ListObjectVersionsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::list_object_versions::ListObjectVersionsInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::super::protocol_serde::shape_list_object_versions::ser_list_object_versions_headers(input, builder)?;
...
impl super::super::s3_request_id::RequestIdExt for super::super::operation::list_object_versions::ListObjectVersionsError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::super::operation::list_object_versions::ListObjectVersionsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::list_object_versions::_list_object_versions_input::ListObjectVersionsInput;

pub use super::super::operation::list_object_versions::_list_object_versions_output::ListObjectVersionsOutput;
