...
pub struct BucketLifecycleConfiguration {
    ...
    pub rules: ::std::vec::Vec<super::super::types::LifecycleRule>,
}
impl BucketLifecycleConfiguration {
    /// <p>A lifecycle rule for individual objects in an Amazon S3 bucket.</p>
    pub fn rules(&self) -> &[super::super::types::LifecycleRule] {
        use std::ops::Deref;
        self.rules.deref()
    }
}
impl BucketLifecycleConfiguration {
    ...
    pub fn builder() -> super::super::types::builders::BucketLifecycleConfigurationBuilder {
        super::super::types::builders::BucketLifecycleConfigurationBuilder::default()
    }
}
...
pub struct BucketLifecycleConfigurationBuilder {
    pub(crate) rules: ::std::option::Option<::std::vec::Vec<super::super::types::LifecycleRule>>,
}
impl BucketLifecycleConfigurationBuilder {
    ...
    ///
    /// <p>A lifecycle rule for individual objects in an Amazon S3 bucket.</p>
    pub fn rules(mut self, input: super::super::types::LifecycleRule) -> Self {
    ...
    /// <p>A lifecycle rule for individual objects in an Amazon S3 bucket.</p>
    pub fn set_rules(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::LifecycleRule>>) -> Self {
        self.rules = input;
        self
    }
    /// <p>A lifecycle rule for individual objects in an Amazon S3 bucket.</p>
    pub fn get_rules(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::LifecycleRule>> {
        &self.rules
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::BucketLifecycleConfiguration, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::BucketLifecycleConfiguration {
