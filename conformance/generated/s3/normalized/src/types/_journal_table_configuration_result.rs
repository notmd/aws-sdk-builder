...
impl JournalTableConfigurationResult {
    ...
    pub fn builder() -> super::super::types::builders::JournalTableConfigurationResultBuilder {
        super::super::types::builders::JournalTableConfigurationResultBuilder::default()
    }
}
