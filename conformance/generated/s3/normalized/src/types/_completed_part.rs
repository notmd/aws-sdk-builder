...
impl CompletedPart {
    ...
    pub fn builder() -> super::super::types::builders::CompletedPartBuilder {
        super::super::types::builders::CompletedPartBuilder::default()
    }
}
...
impl CompletedPartBuilder {
    ...
    pub fn build(self) -> super::super::types::CompletedPart {
        super::super::types::CompletedPart {
            e_tag: self.e_tag,
