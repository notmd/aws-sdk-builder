...
impl PublicAccessBlockConfiguration {
    ...
    pub fn builder() -> super::super::types::builders::PublicAccessBlockConfigurationBuilder {
        super::super::types::builders::PublicAccessBlockConfigurationBuilder::default()
    }
}
...
impl PublicAccessBlockConfigurationBuilder {
    ...
    pub fn build(self) -> super::super::types::PublicAccessBlockConfiguration {
        super::super::types::PublicAccessBlockConfiguration {
