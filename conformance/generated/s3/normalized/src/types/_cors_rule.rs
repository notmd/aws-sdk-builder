...
impl CorsRule {
    ...
    pub fn builder() -> super::super::types::builders::CorsRuleBuilder {
        super::super::types::builders::CorsRuleBuilder::default()
    }
}
...
impl CorsRuleBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::CorsRule, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::CorsRule {
            id: self.id,
