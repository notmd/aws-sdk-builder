...
pub struct MetadataTableEncryptionConfiguration {
    ...
    pub sse_algorithm: super::super::types::TableSseAlgorithm,
...
impl MetadataTableEncryptionConfiguration {
    /// <p>The encryption type specified for a metadata table. To specify server-side encryption with Key Management Service (KMS) keys (SSE-KMS), use the <code>aws:kms</code> value. To specify server-side encryption with Amazon S3 managed keys (SSE-S3), use the <code>AES256</code> value.</p>
    pub fn sse_algorithm(&self) -> &super::super::types::TableSseAlgorithm {
        &self.sse_algorithm
    }
    /// <p>If server-side encryption with Key Management Service (KMS) keys (SSE-KMS) is specified, you must also specify the KMS key Amazon Resource Name (ARN). You must specify a customer-managed KMS key that's located in the same Region as the general purpose bucket that corresponds to the metadata table configuration.</p>
...
impl MetadataTableEncryptionConfiguration {
    ...
    pub fn builder() -> super::super::types::builders::MetadataTableEncryptionConfigurationBuilder {
        super::super::types::builders::MetadataTableEncryptionConfigurationBuilder::default()
    }
}
...
pub struct MetadataTableEncryptionConfigurationBuilder {
    pub(crate) sse_algorithm: ::std::option::Option<super::super::types::TableSseAlgorithm>,
    pub(crate) kms_key_arn: ::std::option::Option<::std::string::String>,
}
impl MetadataTableEncryptionConfigurationBuilder {
    /// <p>The encryption type specified for a metadata table. To specify server-side encryption with Key Management Service (KMS) keys (SSE-KMS), use the <code>aws:kms</code> value. To specify server-side encryption with Amazon S3 managed keys (SSE-S3), use the <code>AES256</code> value.</p>
    /// This field is required.
    pub fn sse_algorithm(mut self, input: super::super::types::TableSseAlgorithm) -> Self {
        self.sse_algorithm = ::std::option::Option::Some(input);
        self
    }
    /// <p>The encryption type specified for a metadata table. To specify server-side encryption with Key Management Service (KMS) keys (SSE-KMS), use the <code>aws:kms</code> value. To specify server-side encryption with Amazon S3 managed keys (SSE-S3), use the <code>AES256</code> value.</p>
    pub fn set_sse_algorithm(mut self, input: ::std::option::Option<super::super::types::TableSseAlgorithm>) -> Self {
        self.sse_algorithm = input;
        self
    }
    /// <p>The encryption type specified for a metadata table. To specify server-side encryption with Key Management Service (KMS) keys (SSE-KMS), use the <code>aws:kms</code> value. To specify server-side encryption with Amazon S3 managed keys (SSE-S3), use the <code>AES256</code> value.</p>
    pub fn get_sse_algorithm(&self) -> &::std::option::Option<super::super::types::TableSseAlgorithm> {
        &self.sse_algorithm
    }
    /// <p>If server-side encryption with Key Management Service (KMS) keys (SSE-KMS) is specified, you must also specify the KMS key Amazon Resource Name (ARN). You must specify a customer-managed KMS key that's located in the same Region as the general purpose bucket that corresponds to the metadata table configuration.</p>
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::types::MetadataTableEncryptionConfiguration, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::MetadataTableEncryptionConfiguration {
