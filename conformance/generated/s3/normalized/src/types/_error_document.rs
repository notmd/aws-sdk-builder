...
impl ErrorDocument {
    ...
    pub fn builder() -> super::super::types::builders::ErrorDocumentBuilder {
        super::super::types::builders::ErrorDocumentBuilder::default()
    }
}
...
impl ErrorDocumentBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::ErrorDocument, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::ErrorDocument {
