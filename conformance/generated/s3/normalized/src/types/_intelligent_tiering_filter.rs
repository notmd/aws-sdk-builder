...
pub struct IntelligentTieringFilter {
    ...
    pub tag: ::std::option::Option<super::super::types::Tag>,
    ...
    pub and: ::std::option::Option<super::super::types::IntelligentTieringAndOperator>,
}
impl IntelligentTieringFilter {
    ...
    /// <p>A container of a key value name pair.</p>
    pub fn tag(&self) -> ::std::option::Option<&super::super::types::Tag> {
        self.tag.as_ref()
    }
    /// <p>A conjunction (logical AND) of predicates, which is used in evaluating a metrics filter. The operator must have at least two predicates, and an object must match all of the predicates in order for the filter to apply.</p>
    pub fn and(&self) -> ::std::option::Option<&super::super::types::IntelligentTieringAndOperator> {
        self.and.as_ref()
    }
}
impl IntelligentTieringFilter {
    /// Creates a new builder-style object to manufacture [`IntelligentTieringFilter`](crate::types::IntelligentTieringFilter).
    pub fn builder() -> super::super::types::builders::IntelligentTieringFilterBuilder {
        super::super::types::builders::IntelligentTieringFilterBuilder::default()
    }
}
...
pub struct IntelligentTieringFilterBuilder {
    ...
    pub(crate) tag: ::std::option::Option<super::super::types::Tag>,
    pub(crate) and: ::std::option::Option<super::super::types::IntelligentTieringAndOperator>,
}
impl IntelligentTieringFilterBuilder {
    ...
    /// <p>A container of a key value name pair.</p>
    pub fn tag(mut self, input: super::super::types::Tag) -> Self {
        self.tag = ::std::option::Option::Some(input);
        self
    }
    /// <p>A container of a key value name pair.</p>
    pub fn set_tag(mut self, input: ::std::option::Option<super::super::types::Tag>) -> Self {
        self.tag = input;
        self
    }
    /// <p>A container of a key value name pair.</p>
    pub fn get_tag(&self) -> &::std::option::Option<super::super::types::Tag> {
        &self.tag
    }
    /// <p>A conjunction (logical AND) of predicates, which is used in evaluating a metrics filter. The operator must have at least two predicates, and an object must match all of the predicates in order for the filter to apply.</p>
    pub fn and(mut self, input: super::super::types::IntelligentTieringAndOperator) -> Self {
        self.and = ::std::option::Option::Some(input);
        self
    }
    /// <p>A conjunction (logical AND) of predicates, which is used in evaluating a metrics filter. The operator must have at least two predicates, and an object must match all of the predicates in order for the filter to apply.</p>
    pub fn set_and(mut self, input: ::std::option::Option<super::super::types::IntelligentTieringAndOperator>) -> Self {
        self.and = input;
        self
    }
    /// <p>A conjunction (logical AND) of predicates, which is used in evaluating a metrics filter. The operator must have at least two predicates, and an object must match all of the predicates in order for the filter to apply.</p>
    pub fn get_and(&self) -> &::std::option::Option<super::super::types::IntelligentTieringAndOperator> {
        &self.and
    }
    /// Consumes the builder and constructs a [`IntelligentTieringFilter`](crate::types::IntelligentTieringFilter).
    pub fn build(self) -> super::super::types::IntelligentTieringFilter {
        super::super::types::IntelligentTieringFilter {
            prefix: self.prefix,
            tag: self.tag,
            and: self.and,
        }
