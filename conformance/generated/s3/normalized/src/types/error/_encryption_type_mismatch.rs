...
impl super::super::super::s3_request_id::RequestIdExt for super::super::super::types::error::EncryptionTypeMismatch {
    fn extended_request_id(&self) -> Option<&str> {
        use ::aws_smithy_types::error::metadata::ProvideErrorMetadata;
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::super::super::types::error::EncryptionTypeMismatch {
...
impl EncryptionTypeMismatch {
    ...
    pub fn builder() -> super::super::super::types::error::builders::EncryptionTypeMismatchBuilder {
        super::super::super::types::error::builders::EncryptionTypeMismatchBuilder::default()
    }
}
...
impl EncryptionTypeMismatchBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::EncryptionTypeMismatch {
        super::super::super::types::error::EncryptionTypeMismatch {
