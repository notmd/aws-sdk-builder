...
impl super::super::super::s3_request_id::RequestIdExt for super::super::super::types::error::NoSuchKey {
    fn extended_request_id(&self) -> Option<&str> {
        use ::aws_smithy_types::error::metadata::ProvideErrorMetadata;
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::super::super::types::error::NoSuchKey {
...
impl NoSuchKey {
    ...
    pub fn builder() -> super::super::super::types::error::builders::NoSuchKeyBuilder {
        super::super::super::types::error::builders::NoSuchKeyBuilder::default()
    }
}
...
impl NoSuchKeyBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::NoSuchKey {
        super::super::super::types::error::NoSuchKey {
