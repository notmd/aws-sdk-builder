...
impl super::super::super::s3_request_id::RequestIdExt for super::super::super::types::error::IdempotencyParameterMismatch {
    fn extended_request_id(&self) -> Option<&str> {
        use ::aws_smithy_types::error::metadata::ProvideErrorMetadata;
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::super::super::types::error::IdempotencyParameterMismatch {
...
impl IdempotencyParameterMismatch {
    ...
    pub fn builder() -> super::super::super::types::error::builders::IdempotencyParameterMismatchBuilder {
        super::super::super::types::error::builders::IdempotencyParameterMismatchBuilder::default()
    }
}
...
impl IdempotencyParameterMismatchBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::IdempotencyParameterMismatch {
        super::super::super::types::error::IdempotencyParameterMismatch {
