...
impl super::super::super::s3_request_id::RequestIdExt for super::super::super::types::error::BucketAlreadyOwnedByYou {
    fn extended_request_id(&self) -> Option<&str> {
        use ::aws_smithy_types::error::metadata::ProvideErrorMetadata;
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::super::super::types::error::BucketAlreadyOwnedByYou {
...
impl BucketAlreadyOwnedByYou {
    ...
    pub fn builder() -> super::super::super::types::error::builders::BucketAlreadyOwnedByYouBuilder {
        super::super::super::types::error::builders::BucketAlreadyOwnedByYouBuilder::default()
    }
}
...
impl BucketAlreadyOwnedByYouBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::BucketAlreadyOwnedByYou {
        super::super::super::types::error::BucketAlreadyOwnedByYou {
