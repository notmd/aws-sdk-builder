...
impl super::super::super::s3_request_id::RequestIdExt for super::super::super::types::error::TooManyParts {
    fn extended_request_id(&self) -> Option<&str> {
        use ::aws_smithy_types::error::metadata::ProvideErrorMetadata;
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::super::super::types::error::TooManyParts {
...
impl TooManyParts {
    ...
    pub fn builder() -> super::super::super::types::error::builders::TooManyPartsBuilder {
        super::super::super::types::error::builders::TooManyPartsBuilder::default()
    }
}
...
impl TooManyPartsBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::TooManyParts {
        super::super::super::types::error::TooManyParts {
