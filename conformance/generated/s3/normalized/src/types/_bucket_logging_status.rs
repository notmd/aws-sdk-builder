...
impl BucketLoggingStatus {
    /// <p>Describes where logs are stored and the prefix that Amazon S3 assigns to all log object keys for a bucket. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/RESTBucketPUTlogging.html">PUT Bucket logging</a> in the <i>Amazon S3 API Reference</i>.</p>
    pub fn logging_enabled(&self) -> ::std::option::Option<&super::super::types::LoggingEnabled> {
...
impl BucketLoggingStatus {
    ...
    pub fn builder() -> super::super::types::builders::BucketLoggingStatusBuilder {
        super::super::types::builders::BucketLoggingStatusBuilder::default()
    }
}
...
pub struct BucketLoggingStatusBuilder {
    pub(crate) logging_enabled: ::std::option::Option<super::super::types::LoggingEnabled>,
}
impl BucketLoggingStatusBuilder {
    /// <p>Describes where logs are stored and the prefix that Amazon S3 assigns to all log object keys for a bucket. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/RESTBucketPUTlogging.html">PUT Bucket logging</a> in the <i>Amazon S3 API Reference</i>.</p>
    pub fn logging_enabled(mut self, input: super::super::types::LoggingEnabled) -> Self {
        self.logging_enabled = ::std::option::Option::Some(input);
        self
    }
    /// <p>Describes where logs are stored and the prefix that Amazon S3 assigns to all log object keys for a bucket. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/RESTBucketPUTlogging.html">PUT Bucket logging</a> in the <i>Amazon S3 API Reference</i>.</p>
    pub fn set_logging_enabled(mut self, input: ::std::option::Option<super::super::types::LoggingEnabled>) -> Self {
        self.logging_enabled = input;
        self
    }
    /// <p>Describes where logs are stored and the prefix that Amazon S3 assigns to all log object keys for a bucket. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/RESTBucketPUTlogging.html">PUT Bucket logging</a> in the <i>Amazon S3 API Reference</i>.</p>
    pub fn get_logging_enabled(&self) -> &::std::option::Option<super::super::types::LoggingEnabled> {
        &self.logging_enabled
    }
    /// Consumes the builder and constructs a [`BucketLoggingStatus`](crate::types::BucketLoggingStatus).
    pub fn build(self) -> super::super::types::BucketLoggingStatus {
        super::super::types::BucketLoggingStatus {
