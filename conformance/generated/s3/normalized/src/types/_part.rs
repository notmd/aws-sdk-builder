...
impl Part {
    ...
    pub fn builder() -> super::super::types::builders::PartBuilder {
        super::super::types::builders::PartBuilder::default()
    }
}
...
impl PartBuilder {
    ...
    pub fn build(self) -> super::super::types::Part {
        super::super::types::Part {
