...
impl MetricsAndOperator {
    ...
    pub fn builder() -> super::super::types::builders::MetricsAndOperatorBuilder {
        super::super::types::builders::MetricsAndOperatorBuilder::default()
    }
}
...
impl MetricsAndOperatorBuilder {
    ...
    pub fn build(self) -> super::super::types::MetricsAndOperator {
        super::super::types::MetricsAndOperator {
            prefix: self.prefix,
            tags: self.tags,
