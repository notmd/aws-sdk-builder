...
impl SsekmsEncryption {
    ...
    pub fn builder() -> super::super::types::builders::SsekmsEncryptionBuilder {
        super::super::types::builders::SsekmsEncryptionBuilder::default()
    }
}
...
impl SsekmsEncryptionBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::SsekmsEncryption, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::SsekmsEncryption {
