...
pub struct ObjectLockRetention {
    ...
    pub mode: ::std::option::Option<super::super::types::ObjectLockRetentionMode>,
    /// <p>The date on which this Object Lock Retention will expire.</p>
    pub retain_until_date: ::std::option::Option<::aws_smithy_types::DateTime>,
}
impl ObjectLockRetention {
    /// <p>Indicates the Retention mode for the specified object.</p>
    pub fn mode(&self) -> ::std::option::Option<&super::super::types::ObjectLockRetentionMode> {
        self.mode.as_ref()
    }
    /// <p>The date on which this Object Lock Retention will expire.</p>
...
impl ObjectLockRetention {
    ...
    pub fn builder() -> super::super::types::builders::ObjectLockRetentionBuilder {
        super::super::types::builders::ObjectLockRetentionBuilder::default()
    }
}
...
pub struct ObjectLockRetentionBuilder {
    pub(crate) mode: ::std::option::Option<super::super::types::ObjectLockRetentionMode>,
    pub(crate) retain_until_date: ::std::option::Option<::aws_smithy_types::DateTime>,
}
impl ObjectLockRetentionBuilder {
    /// <p>Indicates the Retention mode for the specified object.</p>
    pub fn mode(mut self, input: super::super::types::ObjectLockRetentionMode) -> Self {
        self.mode = ::std::option::Option::Some(input);
        self
    }
    /// <p>Indicates the Retention mode for the specified object.</p>
    pub fn set_mode(mut self, input: ::std::option::Option<super::super::types::ObjectLockRetentionMode>) -> Self {
        self.mode = input;
        self
    }
    /// <p>Indicates the Retention mode for the specified object.</p>
    pub fn get_mode(&self) -> &::std::option::Option<super::super::types::ObjectLockRetentionMode> {
        &self.mode
    }
    /// <p>The date on which this Object Lock Retention will expire.</p>
    ...
    pub fn build(self) -> super::super::types::ObjectLockRetention {
        super::super::types::ObjectLockRetention {
            mode: self.mode,
