...
impl LifecycleExpiration {
    ...
    pub fn builder() -> super::super::types::builders::LifecycleExpirationBuilder {
        super::super::types::builders::LifecycleExpirationBuilder::default()
    }
}
...
impl LifecycleExpirationBuilder {
    ...
    pub fn build(self) -> super::super::types::LifecycleExpiration {
        super::super::types::LifecycleExpiration {
            date: self.date,
            days: self.days,
