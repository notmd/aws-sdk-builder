...
impl AnnotationEntry {
    ...
    /// <p>The replication status of the annotation.</p>
    pub fn replication_status(&self) -> ::std::option::Option<&super::super::types::ReplicationStatus> {
...
impl AnnotationEntry {
    ...
    pub fn builder() -> super::super::types::builders::AnnotationEntryBuilder {
        super::super::types::builders::AnnotationEntryBuilder::default()
    }
}
...
pub struct AnnotationEntryBuilder {
    ...
    pub(crate) replication_status: ::std::option::Option<super::super::types::ReplicationStatus>,
}
impl AnnotationEntryBuilder {
    ...
    /// <p>The replication status of the annotation.</p>
    pub fn replication_status(mut self, input: super::super::types::ReplicationStatus) -> Self {
        self.replication_status = ::std::option::Option::Some(input);
        self
    }
    /// <p>The replication status of the annotation.</p>
    pub fn set_replication_status(mut self, input: ::std::option::Option<super::super::types::ReplicationStatus>) -> Self {
        self.replication_status = input;
        self
    }
    /// <p>The replication status of the annotation.</p>
    pub fn get_replication_status(&self) -> &::std::option::Option<super::super::types::ReplicationStatus> {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::AnnotationEntry, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::AnnotationEntry {
