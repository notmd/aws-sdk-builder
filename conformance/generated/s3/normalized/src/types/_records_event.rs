...
impl RecordsEvent {
    ...
    pub fn builder() -> super::super::types::builders::RecordsEventBuilder {
        super::super::types::builders::RecordsEventBuilder::default()
    }
}
...
impl RecordsEventBuilder {
    ...
    pub fn build(self) -> super::super::types::RecordsEvent {
        super::super::types::RecordsEvent { payload: self.payload }
    }
}
