...
impl RequestProgress {
    ...
    pub fn builder() -> super::super::types::builders::RequestProgressBuilder {
        super::super::types::builders::RequestProgressBuilder::default()
    }
}
...
impl RequestProgressBuilder {
    ...
    pub fn build(self) -> super::super::types::RequestProgress {
        super::super::types::RequestProgress { enabled: self.enabled }
    }
}
