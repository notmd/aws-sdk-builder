...
pub struct LambdaFunctionConfiguration {
    ...
    pub events: ::std::vec::Vec<super::super::types::Event>,
    ...
    pub filter: ::std::option::Option<super::super::types::NotificationConfigurationFilter>,
}
impl LambdaFunctionConfiguration {
    ...
    /// <p>The Amazon S3 bucket event for which to invoke the Lambda function. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/NotificationHowTo.html">Supported Event Types</a> in the <i>Amazon S3 User Guide</i>.</p>
    pub fn events(&self) -> &[super::super::types::Event] {
        use std::ops::Deref;
        self.events.deref()
    }
    /// <p>Specifies object key name filtering rules. For information about key name filtering, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/notification-how-to-filtering.html">Configuring event notifications using object key name filtering</a> in the <i>Amazon S3 User Guide</i>.</p>
    pub fn filter(&self) -> ::std::option::Option<&super::super::types::NotificationConfigurationFilter> {
        self.filter.as_ref()
    }
}
impl LambdaFunctionConfiguration {
    /// Creates a new builder-style object to manufacture [`LambdaFunctionConfiguration`](crate::types::LambdaFunctionConfiguration).
    pub fn builder() -> super::super::types::builders::LambdaFunctionConfigurationBuilder {
        super::super::types::builders::LambdaFunctionConfigurationBuilder::default()
    }
}
...
pub struct LambdaFunctionConfigurationBuilder {
    ...
    pub(crate) events: ::std::option::Option<::std::vec::Vec<super::super::types::Event>>,
    pub(crate) filter: ::std::option::Option<super::super::types::NotificationConfigurationFilter>,
}
impl LambdaFunctionConfigurationBuilder {
    ...
    ///
    /// <p>The Amazon S3 bucket event for which to invoke the Lambda function. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/NotificationHowTo.html">Supported Event Types</a> in the <i>Amazon S3 User Guide</i>.</p>
    pub fn events(mut self, input: super::super::types::Event) -> Self {
    ...
    /// <p>The Amazon S3 bucket event for which to invoke the Lambda function. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/NotificationHowTo.html">Supported Event Types</a> in the <i>Amazon S3 User Guide</i>.</p>
    pub fn set_events(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::Event>>) -> Self {
        self.events = input;
        self
    }
    /// <p>The Amazon S3 bucket event for which to invoke the Lambda function. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/NotificationHowTo.html">Supported Event Types</a> in the <i>Amazon S3 User Guide</i>.</p>
    pub fn get_events(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::Event>> {
        &self.events
    }
    /// <p>Specifies object key name filtering rules. For information about key name filtering, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/notification-how-to-filtering.html">Configuring event notifications using object key name filtering</a> in the <i>Amazon S3 User Guide</i>.</p>
    pub fn filter(mut self, input: super::super::types::NotificationConfigurationFilter) -> Self {
        self.filter = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies object key name filtering rules. For information about key name filtering, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/notification-how-to-filtering.html">Configuring event notifications using object key name filtering</a> in the <i>Amazon S3 User Guide</i>.</p>
    pub fn set_filter(mut self, input: ::std::option::Option<super::super::types::NotificationConfigurationFilter>) -> Self {
        self.filter = input;
        self
    }
    /// <p>Specifies object key name filtering rules. For information about key name filtering, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/notification-how-to-filtering.html">Configuring event notifications using object key name filtering</a> in the <i>Amazon S3 User Guide</i>.</p>
    pub fn get_filter(&self) -> &::std::option::Option<super::super::types::NotificationConfigurationFilter> {
        &self.filter
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::LambdaFunctionConfiguration, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::LambdaFunctionConfiguration {
            id: self.id,
