...
pub struct MetadataTableConfigurationResult {
    ...
    pub s3_tables_destination_result: ::std::option::Option<super::super::types::S3TablesDestinationResult>,
}
impl MetadataTableConfigurationResult {
    /// <p>The destination information for the metadata table configuration. The destination table bucket must be in the same Region and Amazon Web Services account as the general purpose bucket. The specified metadata table name must be unique within the <code>aws_s3_metadata</code> namespace in the destination table bucket.</p>
    pub fn s3_tables_destination_result(&self) -> ::std::option::Option<&super::super::types::S3TablesDestinationResult> {
...
impl MetadataTableConfigurationResult {
    ...
    pub fn builder() -> super::super::types::builders::MetadataTableConfigurationResultBuilder {
        super::super::types::builders::MetadataTableConfigurationResultBuilder::default()
    }
}
...
pub struct MetadataTableConfigurationResultBuilder {
    pub(crate) s3_tables_destination_result: ::std::option::Option<super::super::types::S3TablesDestinationResult>,
}
impl MetadataTableConfigurationResultBuilder {
    /// <p>The destination information for the metadata table configuration. The destination table bucket must be in the same Region and Amazon Web Services account as the general purpose bucket. The specified metadata table name must be unique within the <code>aws_s3_metadata</code> namespace in the destination table bucket.</p>
    /// This field is required.
    pub fn s3_tables_destination_result(mut self, input: super::super::types::S3TablesDestinationResult) -> Self {
        self.s3_tables_destination_result = ::std::option::Option::Some(input);
        self
    }
    /// <p>The destination information for the metadata table configuration. The destination table bucket must be in the same Region and Amazon Web Services account as the general purpose bucket. The specified metadata table name must be unique within the <code>aws_s3_metadata</code> namespace in the destination table bucket.</p>
    pub fn set_s3_tables_destination_result(mut self, input: ::std::option::Option<super::super::types::S3TablesDestinationResult>) -> Self {
        self.s3_tables_destination_result = input;
        self
    }
    /// <p>The destination information for the metadata table configuration. The destination table bucket must be in the same Region and Amazon Web Services account as the general purpose bucket. The specified metadata table name must be unique within the <code>aws_s3_metadata</code> namespace in the destination table bucket.</p>
    pub fn get_s3_tables_destination_result(&self) -> &::std::option::Option<super::super::types::S3TablesDestinationResult> {
    ...
    pub fn build(self) -> super::super::types::MetadataTableConfigurationResult {
        super::super::types::MetadataTableConfigurationResult {
