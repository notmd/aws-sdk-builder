...
impl S3TablesDestinationResult {
    ...
    pub fn builder() -> super::super::types::builders::S3TablesDestinationResultBuilder {
        super::super::types::builders::S3TablesDestinationResultBuilder::default()
    }
}
...
impl S3TablesDestinationResultBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::S3TablesDestinationResult, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::S3TablesDestinationResult {
