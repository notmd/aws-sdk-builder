...
impl SimplePrefix {
    ...
    pub fn builder() -> super::super::types::builders::SimplePrefixBuilder {
        super::super::types::builders::SimplePrefixBuilder::default()
    }
}
...
impl SimplePrefixBuilder {
    ...
    pub fn build(self) -> super::super::types::SimplePrefix {
        super::super::types::SimplePrefix {}
    }
}
