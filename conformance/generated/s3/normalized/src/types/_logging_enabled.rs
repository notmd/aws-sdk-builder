...
pub struct LoggingEnabled {
    ...
    pub target_grants: ::std::option::Option<::std::vec::Vec<super::super::types::TargetGrant>>,
    ...
    pub target_object_key_format: ::std::option::Option<super::super::types::TargetObjectKeyFormat>,
}
impl LoggingEnabled {
    /// <p>Specifies the bucket where you want Amazon S3 to store server access logs. You can have your logs delivered to any bucket that you own, including the same bucket that is being logged. You can also configure multiple buckets to deliver their logs to the same target bucket. In this case, you should choose a different <code>TargetPrefix</code> for each source bucket so that the delivered log files can be distinguished by key.</p>
    ...
    pub fn target_grants(&self) -> &[super::super::types::TargetGrant] {
    ...
    /// <p>Amazon S3 key format for log objects.</p>
    pub fn target_object_key_format(&self) -> ::std::option::Option<&super::super::types::TargetObjectKeyFormat> {
...
impl LoggingEnabled {
    ...
    pub fn builder() -> super::super::types::builders::LoggingEnabledBuilder {
        super::super::types::builders::LoggingEnabledBuilder::default()
    }
}
...
pub struct LoggingEnabledBuilder {
    ...
    pub(crate) target_grants: ::std::option::Option<::std::vec::Vec<super::super::types::TargetGrant>>,
    pub(crate) target_prefix: ::std::option::Option<::std::string::String>,
    pub(crate) target_object_key_format: ::std::option::Option<super::super::types::TargetObjectKeyFormat>,
}
impl LoggingEnabledBuilder {
    ...
    /// <p>Container for granting information.</p>
    /// <p>Buckets that use the bucket owner enforced setting for Object Ownership don't support target grants. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/enable-server-access-logging.html#grant-log-delivery-permissions-general">Permissions for server access log delivery</a> in the <i>Amazon S3 User Guide</i>.</p>
    pub fn target_grants(mut self, input: super::super::types::TargetGrant) -> Self {
    ...
    /// <p>Container for granting information.</p>
    /// <p>Buckets that use the bucket owner enforced setting for Object Ownership don't support target grants. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/enable-server-access-logging.html#grant-log-delivery-permissions-general">Permissions for server access log delivery</a> in the <i>Amazon S3 User Guide</i>.</p>
    pub fn set_target_grants(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::TargetGrant>>) -> Self {
        self.target_grants = input;
        self
    }
    /// <p>Container for granting information.</p>
    /// <p>Buckets that use the bucket owner enforced setting for Object Ownership don't support target grants. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/enable-server-access-logging.html#grant-log-delivery-permissions-general">Permissions for server access log delivery</a> in the <i>Amazon S3 User Guide</i>.</p>
    pub fn get_target_grants(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::TargetGrant>> {
        &self.target_grants
    }
    /// <p>A prefix for all log object keys. If you store log files from multiple Amazon S3 buckets in a single bucket, you can use a prefix to distinguish which log files came from which bucket.</p>
    /// This field is required.
    ...
    /// <p>Amazon S3 key format for log objects.</p>
    pub fn target_object_key_format(mut self, input: super::super::types::TargetObjectKeyFormat) -> Self {
        self.target_object_key_format = ::std::option::Option::Some(input);
        self
    }
    /// <p>Amazon S3 key format for log objects.</p>
    pub fn set_target_object_key_format(mut self, input: ::std::option::Option<super::super::types::TargetObjectKeyFormat>) -> Self {
        self.target_object_key_format = input;
        self
    }
    /// <p>Amazon S3 key format for log objects.</p>
    pub fn get_target_object_key_format(&self) -> &::std::option::Option<super::super::types::TargetObjectKeyFormat> {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::LoggingEnabled, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::LoggingEnabled {
