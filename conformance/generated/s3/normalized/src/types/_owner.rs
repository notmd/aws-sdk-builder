...
impl Owner {
    ...
    pub fn builder() -> super::super::types::builders::OwnerBuilder {
        super::super::types::builders::OwnerBuilder::default()
    }
}
...
impl OwnerBuilder {
    ...
    pub fn build(self) -> super::super::types::Owner {
        super::super::types::Owner {
