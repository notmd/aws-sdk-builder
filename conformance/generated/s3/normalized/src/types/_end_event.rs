...
impl EndEvent {
    ...
    pub fn builder() -> super::super::types::builders::EndEventBuilder {
        super::super::types::builders::EndEventBuilder::default()
    }
}
...
impl EndEventBuilder {
    ...
    pub fn build(self) -> super::super::types::EndEvent {
        super::super::types::EndEvent {}
    }
}
