...
impl Bucket {
    ...
    pub fn builder() -> super::super::types::builders::BucketBuilder {
        super::super::types::builders::BucketBuilder::default()
    }
}
...
impl BucketBuilder {
    ...
    pub fn build(self) -> super::super::types::Bucket {
        super::super::types::Bucket {
            name: self.name,
