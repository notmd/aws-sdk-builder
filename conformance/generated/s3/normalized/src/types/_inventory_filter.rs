...
impl InventoryFilter {
    ...
    pub fn builder() -> super::super::types::builders::InventoryFilterBuilder {
        super::super::types::builders::InventoryFilterBuilder::default()
    }
}
...
impl InventoryFilterBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::InventoryFilter, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::InventoryFilter {
