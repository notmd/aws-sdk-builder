...
impl InventoryTableConfigurationResult {
    ...
    pub fn builder() -> super::super::types::builders::InventoryTableConfigurationResultBuilder {
        super::super::types::builders::InventoryTableConfigurationResultBuilder::default()
    }
}
