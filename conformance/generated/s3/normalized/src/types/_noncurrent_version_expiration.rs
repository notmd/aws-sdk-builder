...
impl NoncurrentVersionExpiration {
    ...
    pub fn builder() -> super::super::types::builders::NoncurrentVersionExpirationBuilder {
        super::super::types::builders::NoncurrentVersionExpirationBuilder::default()
    }
}
...
impl NoncurrentVersionExpirationBuilder {
    ...
    pub fn build(self) -> super::super::types::NoncurrentVersionExpiration {
        super::super::types::NoncurrentVersionExpiration {
