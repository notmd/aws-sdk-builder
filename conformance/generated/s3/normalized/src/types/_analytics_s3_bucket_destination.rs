...
pub struct AnalyticsS3BucketDestination {
    ...
    pub format: super::super::types::AnalyticsS3ExportFileFormat,
...
impl AnalyticsS3BucketDestination {
    /// <p>Specifies the file format used when exporting data to Amazon S3.</p>
    pub fn format(&self) -> &super::super::types::AnalyticsS3ExportFileFormat {
        &self.format
    }
    /// <p>The account ID that owns the destination S3 bucket. If no account ID is provided, the owner is not validated before exporting data.</p><note>
    /// <p>Although this value is optional, we strongly recommend that you set it to help prevent problems if the destination bucket ownership changes.</p>
...
impl AnalyticsS3BucketDestination {
    ...
    pub fn builder() -> super::super::types::builders::AnalyticsS3BucketDestinationBuilder {
        super::super::types::builders::AnalyticsS3BucketDestinationBuilder::default()
    }
}
...
pub struct AnalyticsS3BucketDestinationBuilder {
    pub(crate) format: ::std::option::Option<super::super::types::AnalyticsS3ExportFileFormat>,
...
impl AnalyticsS3BucketDestinationBuilder {
    ...
    pub fn format(mut self, input: super::super::types::AnalyticsS3ExportFileFormat) -> Self {
        self.format = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies the file format used when exporting data to Amazon S3.</p>
    pub fn set_format(mut self, input: ::std::option::Option<super::super::types::AnalyticsS3ExportFileFormat>) -> Self {
        self.format = input;
        self
    }
    /// <p>Specifies the file format used when exporting data to Amazon S3.</p>
    pub fn get_format(&self) -> &::std::option::Option<super::super::types::AnalyticsS3ExportFileFormat> {
        &self.format
    }
    /// <p>The account ID that owns the destination S3 bucket. If no account ID is provided, the owner is not validated before exporting data.</p><note>
    /// <p>Although this value is optional, we strongly recommend that you set it to help prevent problems if the destination bucket ownership changes.</p>
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::AnalyticsS3BucketDestination, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::AnalyticsS3BucketDestination {
