...
impl JsonOutput {
    ...
    pub fn builder() -> super::super::types::builders::JsonOutputBuilder {
        super::super::types::builders::JsonOutputBuilder::default()
    }
}
...
impl JsonOutputBuilder {
    ...
    pub fn build(self) -> super::super::types::JsonOutput {
        super::super::types::JsonOutput {
