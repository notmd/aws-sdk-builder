...
pub struct AccessControlTranslation {
    ...
    pub owner: super::super::types::OwnerOverride,
}
impl AccessControlTranslation {
    /// <p>Specifies the replica ownership. For default and valid values, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/RESTBucketPUTreplication.html">PUT bucket replication</a> in the <i>Amazon S3 API Reference</i>.</p>
    pub fn owner(&self) -> &super::super::types::OwnerOverride {
        &self.owner
    }
}
impl AccessControlTranslation {
    /// Creates a new builder-style object to manufacture [`AccessControlTranslation`](crate::types::AccessControlTranslation).
    pub fn builder() -> super::super::types::builders::AccessControlTranslationBuilder {
        super::super::types::builders::AccessControlTranslationBuilder::default()
    }
}
...
pub struct AccessControlTranslationBuilder {
    pub(crate) owner: ::std::option::Option<super::super::types::OwnerOverride>,
}
impl AccessControlTranslationBuilder {
    /// <p>Specifies the replica ownership. For default and valid values, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/RESTBucketPUTreplication.html">PUT bucket replication</a> in the <i>Amazon S3 API Reference</i>.</p>
    /// This field is required.
    pub fn owner(mut self, input: super::super::types::OwnerOverride) -> Self {
        self.owner = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies the replica ownership. For default and valid values, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/RESTBucketPUTreplication.html">PUT bucket replication</a> in the <i>Amazon S3 API Reference</i>.</p>
    pub fn set_owner(mut self, input: ::std::option::Option<super::super::types::OwnerOverride>) -> Self {
        self.owner = input;
        self
    }
    /// <p>Specifies the replica ownership. For default and valid values, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/RESTBucketPUTreplication.html">PUT bucket replication</a> in the <i>Amazon S3 API Reference</i>.</p>
    pub fn get_owner(&self) -> &::std::option::Option<super::super::types::OwnerOverride> {
        &self.owner
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::AccessControlTranslation, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::AccessControlTranslation {
