...
pub struct CorsConfiguration {
    ...
    pub cors_rules: ::std::vec::Vec<super::super::types::CorsRule>,
}
impl CorsConfiguration {
    /// <p>A set of origins and methods (cross-origin access that you want to allow). You can add up to 100 rules to the configuration.</p>
    pub fn cors_rules(&self) -> &[super::super::types::CorsRule] {
        use std::ops::Deref;
...
impl CorsConfiguration {
    ...
    pub fn builder() -> super::super::types::builders::CorsConfigurationBuilder {
        super::super::types::builders::CorsConfigurationBuilder::default()
    }
}
...
pub struct CorsConfigurationBuilder {
    pub(crate) cors_rules: ::std::option::Option<::std::vec::Vec<super::super::types::CorsRule>>,
}
impl CorsConfigurationBuilder {
    ...
    ///
    /// <p>A set of origins and methods (cross-origin access that you want to allow). You can add up to 100 rules to the configuration.</p>
    pub fn cors_rules(mut self, input: super::super::types::CorsRule) -> Self {
    ...
    /// <p>A set of origins and methods (cross-origin access that you want to allow). You can add up to 100 rules to the configuration.</p>
    pub fn set_cors_rules(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::CorsRule>>) -> Self {
        self.cors_rules = input;
        self
    }
    /// <p>A set of origins and methods (cross-origin access that you want to allow). You can add up to 100 rules to the configuration.</p>
    pub fn get_cors_rules(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::CorsRule>> {
        &self.cors_rules
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::CorsConfiguration, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::CorsConfiguration {
