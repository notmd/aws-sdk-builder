...
impl SessionCredentials {
    ...
    pub fn builder() -> super::super::types::builders::SessionCredentialsBuilder {
        super::super::types::builders::SessionCredentialsBuilder::default()
    }
}
...
impl SessionCredentialsBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::SessionCredentials, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::SessionCredentials {
