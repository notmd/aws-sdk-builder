...
impl EventBridgeConfiguration {
    ...
    pub fn builder() -> super::super::types::builders::EventBridgeConfigurationBuilder {
        super::super::types::builders::EventBridgeConfigurationBuilder::default()
    }
}
...
impl EventBridgeConfigurationBuilder {
    ...
    pub fn build(self) -> super::super::types::EventBridgeConfiguration {
        super::super::types::EventBridgeConfiguration {}
    }
}
