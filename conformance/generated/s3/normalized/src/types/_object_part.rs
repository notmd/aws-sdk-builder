...
impl ObjectPart {
    ...
    pub fn builder() -> super::super::types::builders::ObjectPartBuilder {
        super::super::types::builders::ObjectPartBuilder::default()
    }
}
...
impl ObjectPartBuilder {
    ...
    pub fn build(self) -> super::super::types::ObjectPart {
        super::super::types::ObjectPart {
