...
pub struct LifecycleRuleFilter {
    ...
    pub and: ::std::option::Option<super::super::types::LifecycleRuleAndOperator>,
}
impl LifecycleRuleFilter {
    ...
    /// <p>This is used in a Lifecycle Rule Filter to apply a logical AND to two or more predicates. The Lifecycle Rule will apply to any object matching all of the predicates configured inside the And operator.</p>
    pub fn and(&self) -> ::std::option::Option<&super::super::types::LifecycleRuleAndOperator> {
        self.and.as_ref()
    }
}
impl LifecycleRuleFilter {
    /// Creates a new builder-style object to manufacture [`LifecycleRuleFilter`](crate::types::LifecycleRuleFilter).
    pub fn builder() -> super::super::types::builders::LifecycleRuleFilterBuilder {
        super::super::types::builders::LifecycleRuleFilterBuilder::default()
    }
}
...
pub struct LifecycleRuleFilterBuilder {
    ...
    pub(crate) and: ::std::option::Option<super::super::types::LifecycleRuleAndOperator>,
}
impl LifecycleRuleFilterBuilder {
    ...
    /// <p>This is used in a Lifecycle Rule Filter to apply a logical AND to two or more predicates. The Lifecycle Rule will apply to any object matching all of the predicates configured inside the And operator.</p>
    pub fn and(mut self, input: super::super::types::LifecycleRuleAndOperator) -> Self {
        self.and = ::std::option::Option::Some(input);
        self
    }
    /// <p>This is used in a Lifecycle Rule Filter to apply a logical AND to two or more predicates. The Lifecycle Rule will apply to any object matching all of the predicates configured inside the And operator.</p>
    pub fn set_and(mut self, input: ::std::option::Option<super::super::types::LifecycleRuleAndOperator>) -> Self {
        self.and = input;
        self
    }
    /// <p>This is used in a Lifecycle Rule Filter to apply a logical AND to two or more predicates. The Lifecycle Rule will apply to any object matching all of the predicates configured inside the And operator.</p>
    pub fn get_and(&self) -> &::std::option::Option<super::super::types::LifecycleRuleAndOperator> {
        &self.and
    }
    /// Consumes the builder and constructs a [`LifecycleRuleFilter`](crate::types::LifecycleRuleFilter).
    pub fn build(self) -> super::super::types::LifecycleRuleFilter {
        super::super::types::LifecycleRuleFilter {
            prefix: self.prefix,
            tag: self.tag,
