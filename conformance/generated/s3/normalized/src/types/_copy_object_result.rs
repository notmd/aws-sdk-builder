...
impl CopyObjectResult {
    ...
    pub fn builder() -> super::super::types::builders::CopyObjectResultBuilder {
        super::super::types::builders::CopyObjectResultBuilder::default()
    }
}
...
impl CopyObjectResultBuilder {
    ...
    pub fn build(self) -> super::super::types::CopyObjectResult {
        super::super::types::CopyObjectResult {
            e_tag: self.e_tag,
