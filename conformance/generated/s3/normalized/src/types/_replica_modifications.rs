...
pub struct ReplicaModifications {
    ...
    pub status: super::super::types::ReplicaModificationsStatus,
}
impl ReplicaModifications {
    /// <p>Specifies whether Amazon S3 replicates modifications on replicas.</p>
    pub fn status(&self) -> &super::super::types::ReplicaModificationsStatus {
        &self.status
    }
}
impl ReplicaModifications {
    /// Creates a new builder-style object to manufacture [`ReplicaModifications`](crate::types::ReplicaModifications).
    pub fn builder() -> super::super::types::builders::ReplicaModificationsBuilder {
        super::super::types::builders::ReplicaModificationsBuilder::default()
    }
}
...
pub struct ReplicaModificationsBuilder {
    pub(crate) status: ::std::option::Option<super::super::types::ReplicaModificationsStatus>,
}
impl ReplicaModificationsBuilder {
    /// <p>Specifies whether Amazon S3 replicates modifications on replicas.</p>
    /// This field is required.
    pub fn status(mut self, input: super::super::types::ReplicaModificationsStatus) -> Self {
        self.status = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies whether Amazon S3 replicates modifications on replicas.</p>
    pub fn set_status(mut self, input: ::std::option::Option<super::super::types::ReplicaModificationsStatus>) -> Self {
        self.status = input;
        self
    }
    /// <p>Specifies whether Amazon S3 replicates modifications on replicas.</p>
    pub fn get_status(&self) -> &::std::option::Option<super::super::types::ReplicaModificationsStatus> {
        &self.status
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::ReplicaModifications, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::ReplicaModifications {
