...
impl RestoreStatus {
    ...
    pub fn builder() -> super::super::types::builders::RestoreStatusBuilder {
        super::super::types::builders::RestoreStatusBuilder::default()
    }
}
...
impl RestoreStatusBuilder {
    ...
    pub fn build(self) -> super::super::types::RestoreStatus {
        super::super::types::RestoreStatus {
