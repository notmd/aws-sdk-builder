...
impl CommonPrefix {
    ...
    pub fn builder() -> super::super::types::builders::CommonPrefixBuilder {
        super::super::types::builders::CommonPrefixBuilder::default()
    }
}
...
impl CommonPrefixBuilder {
    ...
    pub fn build(self) -> super::super::types::CommonPrefix {
        super::super::types::CommonPrefix { prefix: self.prefix }
    }
}
