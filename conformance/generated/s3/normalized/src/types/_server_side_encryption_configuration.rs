...
pub struct ServerSideEncryptionConfiguration {
    ...
    pub rules: ::std::vec::Vec<super::super::types::ServerSideEncryptionRule>,
}
impl ServerSideEncryptionConfiguration {
    /// <p>Container for information about a particular server-side encryption configuration rule.</p>
    pub fn rules(&self) -> &[super::super::types::ServerSideEncryptionRule] {
        use std::ops::Deref;
        self.rules.deref()
    }
}
impl ServerSideEncryptionConfiguration {
    ...
    pub fn builder() -> super::super::types::builders::ServerSideEncryptionConfigurationBuilder {
        super::super::types::builders::ServerSideEncryptionConfigurationBuilder::default()
    }
}
...
pub struct ServerSideEncryptionConfigurationBuilder {
    pub(crate) rules: ::std::option::Option<::std::vec::Vec<super::super::types::ServerSideEncryptionRule>>,
}
impl ServerSideEncryptionConfigurationBuilder {
    ...
    ///
    /// <p>Container for information about a particular server-side encryption configuration rule.</p>
    pub fn rules(mut self, input: super::super::types::ServerSideEncryptionRule) -> Self {
    ...
    /// <p>Container for information about a particular server-side encryption configuration rule.</p>
    pub fn set_rules(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::ServerSideEncryptionRule>>) -> Self {
        self.rules = input;
        self
    }
    /// <p>Container for information about a particular server-side encryption configuration rule.</p>
    pub fn get_rules(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::ServerSideEncryptionRule>> {
        &self.rules
    }
