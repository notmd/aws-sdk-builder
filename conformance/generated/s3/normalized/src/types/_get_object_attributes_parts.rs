...
pub struct GetObjectAttributesParts {
    ...
    /// </ul>
    /// </note>
    pub parts: ::std::option::Option<::std::vec::Vec<super::super::types::ObjectPart>>,
}
impl GetObjectAttributesParts {
    ...
    pub fn parts(&self) -> &[super::super::types::ObjectPart] {
...
impl GetObjectAttributesParts {
    ...
    pub fn builder() -> super::super::types::builders::GetObjectAttributesPartsBuilder {
        super::super::types::builders::GetObjectAttributesPartsBuilder::default()
    }
}
...
pub struct GetObjectAttributesPartsBuilder {
    ...
    pub(crate) parts: ::std::option::Option<::std::vec::Vec<super::super::types::ObjectPart>>,
}
impl GetObjectAttributesPartsBuilder {
    ...
    /// </ul>
    /// </note>
    pub fn parts(mut self, input: super::super::types::ObjectPart) -> Self {
    ...
    /// </ul>
    /// </note>
    pub fn set_parts(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::ObjectPart>>) -> Self {
        self.parts = input;
        self
    }
    /// <p>A container for elements related to a particular part. A response can contain zero or more <code>Parts</code> elements.</p><note>
    ...
    /// </ul>
    /// </note>
    pub fn get_parts(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::ObjectPart>> {
        &self.parts
    }
    /// Consumes the builder and constructs a [`GetObjectAttributesParts`](crate::types::GetObjectAttributesParts).
    pub fn build(self) -> super::super::types::GetObjectAttributesParts {
        super::super::types::GetObjectAttributesParts {
