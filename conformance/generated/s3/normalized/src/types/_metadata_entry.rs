...
impl MetadataEntry {
    ...
    pub fn builder() -> super::super::types::builders::MetadataEntryBuilder {
        super::super::types::builders::MetadataEntryBuilder::default()
    }
}
...
impl MetadataEntryBuilder {
    ...
    pub fn build(self) -> super::super::types::MetadataEntry {
        super::super::types::MetadataEntry {
            name: self.name,
            value: self.value,
        }
    }
