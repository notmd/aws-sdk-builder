...
impl QueueConfiguration {
    ...
    pub fn builder() -> super::super::types::builders::QueueConfigurationBuilder {
        super::super::types::builders::QueueConfigurationBuilder::default()
    }
}
...
impl QueueConfigurationBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::QueueConfiguration, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::QueueConfiguration {
            id: self.id,
