...
impl Ssekms {
    ...
    pub fn builder() -> super::super::types::builders::SsekmsBuilder {
        super::super::types::builders::SsekmsBuilder::default()
    }
}
...
impl SsekmsBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::Ssekms, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::Ssekms {
