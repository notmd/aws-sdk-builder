...
pub struct RoutingRule {
    ...
    pub condition: ::std::option::Option<super::super::types::Condition>,
    ...
    pub redirect: ::std::option::Option<super::super::types::Redirect>,
}
impl RoutingRule {
    /// <p>A container for describing a condition that must be met for the specified redirect to apply. For example, 1. If request is for pages in the <code>/docs</code> folder, redirect to the <code>/documents</code> folder. 2. If request results in HTTP error 4xx, redirect request to another host where you might process the error.</p>
    pub fn condition(&self) -> ::std::option::Option<&super::super::types::Condition> {
        self.condition.as_ref()
    }
    /// <p>Container for redirect information. You can redirect requests to another host, to another page, or with another protocol. In the event of an error, you can specify a different error code to return.</p>
    pub fn redirect(&self) -> ::std::option::Option<&super::super::types::Redirect> {
        self.redirect.as_ref()
    }
}
impl RoutingRule {
    /// Creates a new builder-style object to manufacture [`RoutingRule`](crate::types::RoutingRule).
    pub fn builder() -> super::super::types::builders::RoutingRuleBuilder {
        super::super::types::builders::RoutingRuleBuilder::default()
    }
}
...
pub struct RoutingRuleBuilder {
    pub(crate) condition: ::std::option::Option<super::super::types::Condition>,
    pub(crate) redirect: ::std::option::Option<super::super::types::Redirect>,
}
impl RoutingRuleBuilder {
    /// <p>A container for describing a condition that must be met for the specified redirect to apply. For example, 1. If request is for pages in the <code>/docs</code> folder, redirect to the <code>/documents</code> folder. 2. If request results in HTTP error 4xx, redirect request to another host where you might process the error.</p>
    pub fn condition(mut self, input: super::super::types::Condition) -> Self {
        self.condition = ::std::option::Option::Some(input);
        self
    }
    /// <p>A container for describing a condition that must be met for the specified redirect to apply. For example, 1. If request is for pages in the <code>/docs</code> folder, redirect to the <code>/documents</code> folder. 2. If request results in HTTP error 4xx, redirect request to another host where you might process the error.</p>
    pub fn set_condition(mut self, input: ::std::option::Option<super::super::types::Condition>) -> Self {
        self.condition = input;
        self
    }
    /// <p>A container for describing a condition that must be met for the specified redirect to apply. For example, 1. If request is for pages in the <code>/docs</code> folder, redirect to the <code>/documents</code> folder. 2. If request results in HTTP error 4xx, redirect request to another host where you might process the error.</p>
    pub fn get_condition(&self) -> &::std::option::Option<super::super::types::Condition> {
        &self.condition
    }
    /// <p>Container for redirect information. You can redirect requests to another host, to another page, or with another protocol. In the event of an error, you can specify a different error code to return.</p>
    /// This field is required.
    pub fn redirect(mut self, input: super::super::types::Redirect) -> Self {
        self.redirect = ::std::option::Option::Some(input);
        self
    }
    /// <p>Container for redirect information. You can redirect requests to another host, to another page, or with another protocol. In the event of an error, you can specify a different error code to return.</p>
    pub fn set_redirect(mut self, input: ::std::option::Option<super::super::types::Redirect>) -> Self {
        self.redirect = input;
        self
    }
    /// <p>Container for redirect information. You can redirect requests to another host, to another page, or with another protocol. In the event of an error, you can specify a different error code to return.</p>
    pub fn get_redirect(&self) -> &::std::option::Option<super::super::types::Redirect> {
        &self.redirect
    }
    /// Consumes the builder and constructs a [`RoutingRule`](crate::types::RoutingRule).
    pub fn build(self) -> super::super::types::RoutingRule {
        super::super::types::RoutingRule {
