...
pub struct DestinationResult {
    ...
    pub table_bucket_type: ::std::option::Option<super::super::types::S3TablesBucketType>,
...
impl DestinationResult {
    /// <p>The type of the table bucket where the metadata configuration is stored. The <code>aws</code> value indicates an Amazon Web Services managed table bucket, and the <code>customer</code> value indicates a customer-managed table bucket. V2 metadata configurations are stored in Amazon Web Services managed table buckets, and V1 metadata configurations are stored in customer-managed table buckets.</p>
    pub fn table_bucket_type(&self) -> ::std::option::Option<&super::super::types::S3TablesBucketType> {
...
impl DestinationResult {
    ...
    pub fn builder() -> super::super::types::builders::DestinationResultBuilder {
        super::super::types::builders::DestinationResultBuilder::default()
    }
}
...
pub struct DestinationResultBuilder {
    pub(crate) table_bucket_type: ::std::option::Option<super::super::types::S3TablesBucketType>,
...
impl DestinationResultBuilder {
    /// <p>The type of the table bucket where the metadata configuration is stored. The <code>aws</code> value indicates an Amazon Web Services managed table bucket, and the <code>customer</code> value indicates a customer-managed table bucket. V2 metadata configurations are stored in Amazon Web Services managed table buckets, and V1 metadata configurations are stored in customer-managed table buckets.</p>
    pub fn table_bucket_type(mut self, input: super::super::types::S3TablesBucketType) -> Self {
        self.table_bucket_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The type of the table bucket where the metadata configuration is stored. The <code>aws</code> value indicates an Amazon Web Services managed table bucket, and the <code>customer</code> value indicates a customer-managed table bucket. V2 metadata configurations are stored in Amazon Web Services managed table buckets, and V1 metadata configurations are stored in customer-managed table buckets.</p>
    pub fn set_table_bucket_type(mut self, input: ::std::option::Option<super::super::types::S3TablesBucketType>) -> Self {
        self.table_bucket_type = input;
        self
    }
    /// <p>The type of the table bucket where the metadata configuration is stored. The <code>aws</code> value indicates an Amazon Web Services managed table bucket, and the <code>customer</code> value indicates a customer-managed table bucket. V2 metadata configurations are stored in Amazon Web Services managed table buckets, and V1 metadata configurations are stored in customer-managed table buckets.</p>
    pub fn get_table_bucket_type(&self) -> &::std::option::Option<super::super::types::S3TablesBucketType> {
    ...
    pub fn build(self) -> super::super::types::DestinationResult {
        super::super::types::DestinationResult {
