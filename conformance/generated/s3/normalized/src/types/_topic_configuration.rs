...
impl TopicConfiguration {
    ...
    pub fn builder() -> super::super::types::builders::TopicConfigurationBuilder {
        super::super::types::builders::TopicConfigurationBuilder::default()
    }
}
...
impl TopicConfigurationBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::TopicConfiguration, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::TopicConfiguration {
            id: self.id,
