...
impl ReplicationTimeValue {
    ...
    pub fn builder() -> super::super::types::builders::ReplicationTimeValueBuilder {
        super::super::types::builders::ReplicationTimeValueBuilder::default()
    }
}
...
impl ReplicationTimeValueBuilder {
    ...
    pub fn build(self) -> super::super::types::ReplicationTimeValue {
        super::super::types::ReplicationTimeValue { minutes: self.minutes }
    }
}
