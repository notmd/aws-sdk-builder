...
pub struct ServerSideEncryptionRule {
    ...
    pub apply_server_side_encryption_by_default: ::std::option::Option<super::super::types::ServerSideEncryptionByDefault>,
    ...
    /// </note>
    pub blocked_encryption_types: ::std::option::Option<super::super::types::BlockedEncryptionTypes>,
}
impl ServerSideEncryptionRule {
    /// <p>Specifies the default server-side encryption to apply to new objects in the bucket. If a PUT Object request doesn't specify any server-side encryption, this default encryption will be applied.</p>
    pub fn apply_server_side_encryption_by_default(&self) -> ::std::option::Option<&super::super::types::ServerSideEncryptionByDefault> {
    ...
    /// <p>Currently, this parameter only supports blocking or unblocking server-side encryption with customer-provided keys (SSE-C). For more information about SSE-C, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/ServerSideEncryptionCustomerKeys.html">Using server-side encryption with customer-provided keys (SSE-C)</a>.</p>
    /// </note>
    pub fn blocked_encryption_types(&self) -> ::std::option::Option<&super::super::types::BlockedEncryptionTypes> {
...
impl ServerSideEncryptionRule {
    ...
    pub fn builder() -> super::super::types::builders::ServerSideEncryptionRuleBuilder {
        super::super::types::builders::ServerSideEncryptionRuleBuilder::default()
    }
}
...
pub struct ServerSideEncryptionRuleBuilder {
    pub(crate) apply_server_side_encryption_by_default: ::std::option::Option<super::super::types::ServerSideEncryptionByDefault>,
    pub(crate) bucket_key_enabled: ::std::option::Option<bool>,
    pub(crate) blocked_encryption_types: ::std::option::Option<super::super::types::BlockedEncryptionTypes>,
}
impl ServerSideEncryptionRuleBuilder {
    /// <p>Specifies the default server-side encryption to apply to new objects in the bucket. If a PUT Object request doesn't specify any server-side encryption, this default encryption will be applied.</p>
    pub fn apply_server_side_encryption_by_default(mut self, input: super::super::types::ServerSideEncryptionByDefault) -> Self {
    ...
    /// <p>Specifies the default server-side encryption to apply to new objects in the bucket. If a PUT Object request doesn't specify any server-side encryption, this default encryption will be applied.</p>
    pub fn get_apply_server_side_encryption_by_default(&self) -> &::std::option::Option<super::super::types::ServerSideEncryptionByDefault> {
    ...
    /// <p>Currently, this parameter only supports blocking or unblocking server-side encryption with customer-provided keys (SSE-C). For more information about SSE-C, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/ServerSideEncryptionCustomerKeys.html">Using server-side encryption with customer-provided keys (SSE-C)</a>.</p>
    /// </note>
    pub fn blocked_encryption_types(mut self, input: super::super::types::BlockedEncryptionTypes) -> Self {
    ...
    /// <p>Currently, this parameter only supports blocking or unblocking server-side encryption with customer-provided keys (SSE-C). For more information about SSE-C, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/ServerSideEncryptionCustomerKeys.html">Using server-side encryption with customer-provided keys (SSE-C)</a>.</p>
    /// </note>
    pub fn set_blocked_encryption_types(mut self, input: ::std::option::Option<super::super::types::BlockedEncryptionTypes>) -> Self {
    ...
    /// <p>Currently, this parameter only supports blocking or unblocking server-side encryption with customer-provided keys (SSE-C). For more information about SSE-C, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/ServerSideEncryptionCustomerKeys.html">Using server-side encryption with customer-provided keys (SSE-C)</a>.</p>
    /// </note>
    pub fn get_blocked_encryption_types(&self) -> &::std::option::Option<super::super::types::BlockedEncryptionTypes> {
    ...
    pub fn build(self) -> super::super::types::ServerSideEncryptionRule {
        super::super::types::ServerSideEncryptionRule {
