...
impl DefaultRetention {
    ...
    pub fn builder() -> super::super::types::builders::DefaultRetentionBuilder {
        super::super::types::builders::DefaultRetentionBuilder::default()
    }
}
...
impl DefaultRetentionBuilder {
    ...
    pub fn build(self) -> super::super::types::DefaultRetention {
        super::super::types::DefaultRetention {
            mode: self.mode,
            days: self.days,
            years: self.years,
        }
