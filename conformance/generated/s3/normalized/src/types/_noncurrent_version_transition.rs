...
pub struct NoncurrentVersionTransition {
    ...
    pub storage_class: ::std::option::Option<super::super::types::TransitionStorageClass>,
...
impl NoncurrentVersionTransition {
    ...
    /// <p>The class of storage used to store the object.</p>
    pub fn storage_class(&self) -> ::std::option::Option<&super::super::types::TransitionStorageClass> {
...
impl NoncurrentVersionTransition {
    ...
    pub fn builder() -> super::super::types::builders::NoncurrentVersionTransitionBuilder {
        super::super::types::builders::NoncurrentVersionTransitionBuilder::default()
    }
}
...
pub struct NoncurrentVersionTransitionBuilder {
    ...
    pub(crate) storage_class: ::std::option::Option<super::super::types::TransitionStorageClass>,
...
impl NoncurrentVersionTransitionBuilder {
    ...
    /// <p>The class of storage used to store the object.</p>
    pub fn storage_class(mut self, input: super::super::types::TransitionStorageClass) -> Self {
        self.storage_class = ::std::option::Option::Some(input);
        self
    }
    /// <p>The class of storage used to store the object.</p>
    pub fn set_storage_class(mut self, input: ::std::option::Option<super::super::types::TransitionStorageClass>) -> Self {
        self.storage_class = input;
        self
    }
    /// <p>The class of storage used to store the object.</p>
    pub fn get_storage_class(&self) -> &::std::option::Option<super::super::types::TransitionStorageClass> {
        &self.storage_class
    }
    /// <p>Specifies how many noncurrent versions Amazon S3 will retain in the same storage class before transitioning objects. You can specify up to 100 noncurrent versions to retain. Amazon S3 will transition any additional noncurrent versions beyond the specified number to retain. For more information about noncurrent versions, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/intro-lifecycle-rules.html">Lifecycle configuration elements</a> in the <i>Amazon S3 User Guide</i>.</p>
    ...
    pub fn build(self) -> super::super::types::NoncurrentVersionTransition {
        super::super::types::NoncurrentVersionTransition {
