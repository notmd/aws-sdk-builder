...
impl IndexDocument {
    ...
    pub fn builder() -> super::super::types::builders::IndexDocumentBuilder {
        super::super::types::builders::IndexDocumentBuilder::default()
    }
}
...
impl IndexDocumentBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::IndexDocument, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::IndexDocument {
