...
pub struct BlockedEncryptionTypes {
    ...
    /// </note>
    pub encryption_type: ::std::option::Option<::std::vec::Vec<super::super::types::EncryptionType>>,
}
impl BlockedEncryptionTypes {
    ...
    pub fn encryption_type(&self) -> &[super::super::types::EncryptionType] {
...
impl BlockedEncryptionTypes {
    ...
    pub fn builder() -> super::super::types::builders::BlockedEncryptionTypesBuilder {
        super::super::types::builders::BlockedEncryptionTypesBuilder::default()
    }
}
...
pub struct BlockedEncryptionTypesBuilder {
    pub(crate) encryption_type: ::std::option::Option<::std::vec::Vec<super::super::types::EncryptionType>>,
}
impl BlockedEncryptionTypesBuilder {
    ...
    /// <p>Currently, this parameter only supports blocking or unblocking server side encryption with customer-provided keys (SSE-C). For more information about SSE-C, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/ServerSideEncryptionCustomerKeys.html">Using server-side encryption with customer-provided keys (SSE-C)</a>.</p>
    /// </note>
    pub fn encryption_type(mut self, input: super::super::types::EncryptionType) -> Self {
    ...
    /// <p>Currently, this parameter only supports blocking or unblocking server side encryption with customer-provided keys (SSE-C). For more information about SSE-C, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/ServerSideEncryptionCustomerKeys.html">Using server-side encryption with customer-provided keys (SSE-C)</a>.</p>
    /// </note>
    pub fn set_encryption_type(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::EncryptionType>>) -> Self {
    ...
    /// <p>Currently, this parameter only supports blocking or unblocking server side encryption with customer-provided keys (SSE-C). For more information about SSE-C, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/ServerSideEncryptionCustomerKeys.html">Using server-side encryption with customer-provided keys (SSE-C)</a>.</p>
    /// </note>
    pub fn get_encryption_type(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::EncryptionType>> {
        &self.encryption_type
    }
    /// Consumes the builder and constructs a [`BlockedEncryptionTypes`](crate::types::BlockedEncryptionTypes).
    pub fn build(self) -> super::super::types::BlockedEncryptionTypes {
        super::super::types::BlockedEncryptionTypes {
