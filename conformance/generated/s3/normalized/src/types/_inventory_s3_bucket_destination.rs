...
pub struct InventoryS3BucketDestination {
    ...
    pub format: super::super::types::InventoryFormat,
    /// <p>The prefix that is prepended to all inventory results.</p>
    pub prefix: ::std::option::Option<::std::string::String>,
    /// <p>Contains the type of server-side encryption used to encrypt the inventory results.</p>
    pub encryption: ::std::option::Option<super::super::types::InventoryEncryption>,
}
impl InventoryS3BucketDestination {
    ...
    /// <p>Specifies the output format of the inventory results.</p>
    pub fn format(&self) -> &super::super::types::InventoryFormat {
        &self.format
    }
    /// <p>The prefix that is prepended to all inventory results.</p>
    ...
    /// <p>Contains the type of server-side encryption used to encrypt the inventory results.</p>
    pub fn encryption(&self) -> ::std::option::Option<&super::super::types::InventoryEncryption> {
...
impl InventoryS3BucketDestination {
    ...
    pub fn builder() -> super::super::types::builders::InventoryS3BucketDestinationBuilder {
        super::super::types::builders::InventoryS3BucketDestinationBuilder::default()
    }
}
...
pub struct InventoryS3BucketDestinationBuilder {
    ...
    pub(crate) format: ::std::option::Option<super::super::types::InventoryFormat>,
    pub(crate) prefix: ::std::option::Option<::std::string::String>,
    pub(crate) encryption: ::std::option::Option<super::super::types::InventoryEncryption>,
}
impl InventoryS3BucketDestinationBuilder {
    ...
    /// <p>Specifies the output format of the inventory results.</p>
    /// This field is required.
    pub fn format(mut self, input: super::super::types::InventoryFormat) -> Self {
        self.format = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies the output format of the inventory results.</p>
    pub fn set_format(mut self, input: ::std::option::Option<super::super::types::InventoryFormat>) -> Self {
        self.format = input;
        self
    }
    /// <p>Specifies the output format of the inventory results.</p>
    pub fn get_format(&self) -> &::std::option::Option<super::super::types::InventoryFormat> {
        &self.format
    }
    /// <p>The prefix that is prepended to all inventory results.</p>
    ...
    /// <p>Contains the type of server-side encryption used to encrypt the inventory results.</p>
    pub fn encryption(mut self, input: super::super::types::InventoryEncryption) -> Self {
        self.encryption = ::std::option::Option::Some(input);
        self
    }
    /// <p>Contains the type of server-side encryption used to encrypt the inventory results.</p>
    pub fn set_encryption(mut self, input: ::std::option::Option<super::super::types::InventoryEncryption>) -> Self {
        self.encryption = input;
        self
    }
    /// <p>Contains the type of server-side encryption used to encrypt the inventory results.</p>
    pub fn get_encryption(&self) -> &::std::option::Option<super::super::types::InventoryEncryption> {
        &self.encryption
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::InventoryS3BucketDestination, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::InventoryS3BucketDestination {
