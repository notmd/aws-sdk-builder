...
pub enum SelectObjectContentEventStream {
    ...
    Cont(super::super::types::ContinuationEvent),
    /// <p>The End Event.</p>
    End(super::super::types::EndEvent),
    /// <p>The Progress Event.</p>
    Progress(super::super::types::ProgressEvent),
    /// <p>The Records Event.</p>
    Records(super::super::types::RecordsEvent),
    /// <p>The Stats Event.</p>
    Stats(super::super::types::StatsEvent),
...
impl SelectObjectContentEventStream {
    ...
    pub fn as_cont(&self) -> ::std::result::Result<&super::super::types::ContinuationEvent, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_end(&self) -> ::std::result::Result<&super::super::types::EndEvent, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_progress(&self) -> ::std::result::Result<&super::super::types::ProgressEvent, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_records(&self) -> ::std::result::Result<&super::super::types::RecordsEvent, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_stats(&self) -> ::std::result::Result<&super::super::types::StatsEvent, &Self> {
