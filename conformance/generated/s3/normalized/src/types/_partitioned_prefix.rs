...
pub struct PartitionedPrefix {
    ...
    pub partition_date_source: ::std::option::Option<super::super::types::PartitionDateSource>,
}
impl PartitionedPrefix {
    /// <p>Specifies the partition date source for the partitioned prefix. <code>PartitionDateSource</code> can be <code>EventTime</code> or <code>DeliveryTime</code>.</p>
    /// <p>For <code>DeliveryTime</code>, the time in the log file names corresponds to the delivery time for the log files.</p>
    /// <p>For <code>EventTime</code>, The logs delivered are for a specific day only. The year, month, and day correspond to the day on which the event occurred, and the hour, minutes and seconds are set to 00 in the key.</p>
    pub fn partition_date_source(&self) -> ::std::option::Option<&super::super::types::PartitionDateSource> {
...
impl PartitionedPrefix {
    ...
    pub fn builder() -> super::super::types::builders::PartitionedPrefixBuilder {
        super::super::types::builders::PartitionedPrefixBuilder::default()
    }
}
...
pub struct PartitionedPrefixBuilder {
    pub(crate) partition_date_source: ::std::option::Option<super::super::types::PartitionDateSource>,
}
impl PartitionedPrefixBuilder {
    /// <p>Specifies the partition date source for the partitioned prefix. <code>PartitionDateSource</code> can be <code>EventTime</code> or <code>DeliveryTime</code>.</p>
    /// <p>For <code>DeliveryTime</code>, the time in the log file names corresponds to the delivery time for the log files.</p>
    /// <p>For <code>EventTime</code>, The logs delivered are for a specific day only. The year, month, and day correspond to the day on which the event occurred, and the hour, minutes and seconds are set to 00 in the key.</p>
    pub fn partition_date_source(mut self, input: super::super::types::PartitionDateSource) -> Self {
    ...
    /// <p>For <code>DeliveryTime</code>, the time in the log file names corresponds to the delivery time for the log files.</p>
    /// <p>For <code>EventTime</code>, The logs delivered are for a specific day only. The year, month, and day correspond to the day on which the event occurred, and the hour, minutes and seconds are set to 00 in the key.</p>
    pub fn set_partition_date_source(mut self, input: ::std::option::Option<super::super::types::PartitionDateSource>) -> Self {
    ...
    /// <p>For <code>DeliveryTime</code>, the time in the log file names corresponds to the delivery time for the log files.</p>
    /// <p>For <code>EventTime</code>, The logs delivered are for a specific day only. The year, month, and day correspond to the day on which the event occurred, and the hour, minutes and seconds are set to 00 in the key.</p>
    pub fn get_partition_date_source(&self) -> &::std::option::Option<super::super::types::PartitionDateSource> {
        &self.partition_date_source
    }
    /// Consumes the builder and constructs a [`PartitionedPrefix`](crate::types::PartitionedPrefix).
    pub fn build(self) -> super::super::types::PartitionedPrefix {
        super::super::types::PartitionedPrefix {
