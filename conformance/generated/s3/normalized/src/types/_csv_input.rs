...
pub struct CsvInput {
    ...
    /// </ul>
    pub file_header_info: ::std::option::Option<super::super::types::FileHeaderInfo>,
...
impl CsvInput {
    ...
    /// <p><code>Use</code>: First line is a header, and you can use the header value to identify a column in an expression (<code>SELECT "name" FROM OBJECT</code>).</p></li>
    /// </ul>
    pub fn file_header_info(&self) -> ::std::option::Option<&super::super::types::FileHeaderInfo> {
...
impl CsvInput {
    ...
    pub fn builder() -> super::super::types::builders::CsvInputBuilder {
        super::super::types::builders::CsvInputBuilder::default()
    }
}
...
pub struct CsvInputBuilder {
    pub(crate) file_header_info: ::std::option::Option<super::super::types::FileHeaderInfo>,
...
impl CsvInputBuilder {
    ...
    /// <p><code>Use</code>: First line is a header, and you can use the header value to identify a column in an expression (<code>SELECT "name" FROM OBJECT</code>).</p></li>
    /// </ul>
    pub fn file_header_info(mut self, input: super::super::types::FileHeaderInfo) -> Self {
    ...
    /// <p><code>Use</code>: First line is a header, and you can use the header value to identify a column in an expression (<code>SELECT "name" FROM OBJECT</code>).</p></li>
    /// </ul>
    pub fn set_file_header_info(mut self, input: ::std::option::Option<super::super::types::FileHeaderInfo>) -> Self {
    ...
    /// <p><code>Use</code>: First line is a header, and you can use the header value to identify a column in an expression (<code>SELECT "name" FROM OBJECT</code>).</p></li>
    /// </ul>
    pub fn get_file_header_info(&self) -> &::std::option::Option<super::super::types::FileHeaderInfo> {
    ...
    pub fn build(self) -> super::super::types::CsvInput {
        super::super::types::CsvInput {
