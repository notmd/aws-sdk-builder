...
impl Redirect {
    ...
    pub fn builder() -> super::super::types::builders::RedirectBuilder {
        super::super::types::builders::RedirectBuilder::default()
    }
}
...
impl RedirectBuilder {
    ...
    pub fn build(self) -> super::super::types::Redirect {
        super::super::types::Redirect {
