...
impl ContinuationEvent {
    ...
    pub fn builder() -> super::super::types::builders::ContinuationEventBuilder {
        super::super::types::builders::ContinuationEventBuilder::default()
    }
}
...
impl ContinuationEventBuilder {
    ...
    pub fn build(self) -> super::super::types::ContinuationEvent {
        super::super::types::ContinuationEvent {}
    }
}
