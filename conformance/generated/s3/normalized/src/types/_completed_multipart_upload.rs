...
pub struct CompletedMultipartUpload {
    ...
    pub parts: ::std::option::Option<::std::vec::Vec<super::super::types::CompletedPart>>,
}
impl CompletedMultipartUpload {
    ...
    pub fn parts(&self) -> &[super::super::types::CompletedPart] {
...
impl CompletedMultipartUpload {
    ...
    pub fn builder() -> super::super::types::builders::CompletedMultipartUploadBuilder {
        super::super::types::builders::CompletedMultipartUploadBuilder::default()
    }
}
...
pub struct CompletedMultipartUploadBuilder {
    pub(crate) parts: ::std::option::Option<::std::vec::Vec<super::super::types::CompletedPart>>,
}
impl CompletedMultipartUploadBuilder {
    ...
    /// <p>Array of CompletedPart data types.</p>
    /// <p>If you do not supply a valid <code>Part</code> with your request, the service sends back an HTTP 400 response.</p>
    pub fn parts(mut self, input: super::super::types::CompletedPart) -> Self {
    ...
    /// <p>Array of CompletedPart data types.</p>
    /// <p>If you do not supply a valid <code>Part</code> with your request, the service sends back an HTTP 400 response.</p>
    pub fn set_parts(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::CompletedPart>>) -> Self {
        self.parts = input;
        self
    }
    /// <p>Array of CompletedPart data types.</p>
    /// <p>If you do not supply a valid <code>Part</code> with your request, the service sends back an HTTP 400 response.</p>
    pub fn get_parts(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::CompletedPart>> {
        &self.parts
    }
    /// Consumes the builder and constructs a [`CompletedMultipartUpload`](crate::types::CompletedMultipartUpload).
    pub fn build(self) -> super::super::types::CompletedMultipartUpload {
        super::super::types::CompletedMultipartUpload { parts: self.parts }
    }
}
