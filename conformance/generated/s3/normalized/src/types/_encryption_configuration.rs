...
impl EncryptionConfiguration {
    ...
    pub fn builder() -> super::super::types::builders::EncryptionConfigurationBuilder {
        super::super::types::builders::EncryptionConfigurationBuilder::default()
    }
}
...
impl EncryptionConfigurationBuilder {
    ...
    pub fn build(self) -> super::super::types::EncryptionConfiguration {
        super::super::types::EncryptionConfiguration {
