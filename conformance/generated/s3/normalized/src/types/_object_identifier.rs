...
impl ObjectIdentifier {
    ...
    pub fn builder() -> super::super::types::builders::ObjectIdentifierBuilder {
        super::super::types::builders::ObjectIdentifierBuilder::default()
    }
}
...
impl ObjectIdentifierBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::ObjectIdentifier, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::ObjectIdentifier {
