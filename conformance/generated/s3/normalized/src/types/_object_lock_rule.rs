...
pub struct ObjectLockRule {
    ...
    pub default_retention: ::std::option::Option<super::super::types::DefaultRetention>,
}
impl ObjectLockRule {
    /// <p>The default Object Lock retention mode and period that you want to apply to new objects placed in the specified bucket. Bucket settings require both a mode and a period. The period can be either <code>Days</code> or <code>Years</code> but you must select one. You cannot specify <code>Days</code> and <code>Years</code> at the same time.</p>
    pub fn default_retention(&self) -> ::std::option::Option<&super::super::types::DefaultRetention> {
        self.default_retention.as_ref()
    }
}
impl ObjectLockRule {
    /// Creates a new builder-style object to manufacture [`ObjectLockRule`](crate::types::ObjectLockRule).
    pub fn builder() -> super::super::types::builders::ObjectLockRuleBuilder {
        super::super::types::builders::ObjectLockRuleBuilder::default()
    }
}
...
pub struct ObjectLockRuleBuilder {
    pub(crate) default_retention: ::std::option::Option<super::super::types::DefaultRetention>,
}
impl ObjectLockRuleBuilder {
    /// <p>The default Object Lock retention mode and period that you want to apply to new objects placed in the specified bucket. Bucket settings require both a mode and a period. The period can be either <code>Days</code> or <code>Years</code> but you must select one. You cannot specify <code>Days</code> and <code>Years</code> at the same time.</p>
    pub fn default_retention(mut self, input: super::super::types::DefaultRetention) -> Self {
        self.default_retention = ::std::option::Option::Some(input);
        self
    }
    /// <p>The default Object Lock retention mode and period that you want to apply to new objects placed in the specified bucket. Bucket settings require both a mode and a period. The period can be either <code>Days</code> or <code>Years</code> but you must select one. You cannot specify <code>Days</code> and <code>Years</code> at the same time.</p>
    pub fn set_default_retention(mut self, input: ::std::option::Option<super::super::types::DefaultRetention>) -> Self {
        self.default_retention = input;
        self
    }
    /// <p>The default Object Lock retention mode and period that you want to apply to new objects placed in the specified bucket. Bucket settings require both a mode and a period. The period can be either <code>Days</code> or <code>Years</code> but you must select one. You cannot specify <code>Days</code> and <code>Years</code> at the same time.</p>
    pub fn get_default_retention(&self) -> &::std::option::Option<super::super::types::DefaultRetention> {
        &self.default_retention
    }
    /// Consumes the builder and constructs a [`ObjectLockRule`](crate::types::ObjectLockRule).
    pub fn build(self) -> super::super::types::ObjectLockRule {
        super::super::types::ObjectLockRule {
