...
impl CopyPartResult {
    ...
    pub fn builder() -> super::super::types::builders::CopyPartResultBuilder {
        super::super::types::builders::CopyPartResultBuilder::default()
    }
}
...
impl CopyPartResultBuilder {
    ...
    pub fn build(self) -> super::super::types::CopyPartResult {
        super::super::types::CopyPartResult {
            e_tag: self.e_tag,
