...
impl LifecycleRuleAndOperator {
    ...
    pub fn builder() -> super::super::types::builders::LifecycleRuleAndOperatorBuilder {
        super::super::types::builders::LifecycleRuleAndOperatorBuilder::default()
    }
}
...
impl LifecycleRuleAndOperatorBuilder {
    ...
    pub fn build(self) -> super::super::types::LifecycleRuleAndOperator {
        super::super::types::LifecycleRuleAndOperator {
            prefix: self.prefix,
            tags: self.tags,
