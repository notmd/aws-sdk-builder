...
pub struct RecordExpiration {
    ...
    pub expiration: super::super::types::ExpirationState,
...
impl RecordExpiration {
    /// <p>Specifies whether journal table record expiration is enabled or disabled.</p>
    pub fn expiration(&self) -> &super::super::types::ExpirationState {
        &self.expiration
    }
    /// <p>If you enable journal table record expiration, you can set the number of days to retain your journal table records. Journal table records must be retained for a minimum of 7 days. To set this value, specify any whole number from <code>7</code> to <code>2147483647</code>. For example, to retain your journal table records for one year, set this value to <code>365</code>.</p>
...
impl RecordExpiration {
    ...
    pub fn builder() -> super::super::types::builders::RecordExpirationBuilder {
        super::super::types::builders::RecordExpirationBuilder::default()
    }
}
...
pub struct RecordExpirationBuilder {
    pub(crate) expiration: ::std::option::Option<super::super::types::ExpirationState>,
    pub(crate) days: ::std::option::Option<i32>,
}
impl RecordExpirationBuilder {
    /// <p>Specifies whether journal table record expiration is enabled or disabled.</p>
    /// This field is required.
    pub fn expiration(mut self, input: super::super::types::ExpirationState) -> Self {
        self.expiration = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies whether journal table record expiration is enabled or disabled.</p>
    pub fn set_expiration(mut self, input: ::std::option::Option<super::super::types::ExpirationState>) -> Self {
        self.expiration = input;
        self
    }
    /// <p>Specifies whether journal table record expiration is enabled or disabled.</p>
    pub fn get_expiration(&self) -> &::std::option::Option<super::super::types::ExpirationState> {
        &self.expiration
    }
    /// <p>If you enable journal table record expiration, you can set the number of days to retain your journal table records. Journal table records must be retained for a minimum of 7 days. To set this value, specify any whole number from <code>7</code> to <code>2147483647</code>. For example, to retain your journal table records for one year, set this value to <code>365</code>.</p>
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::RecordExpiration, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::RecordExpiration {
