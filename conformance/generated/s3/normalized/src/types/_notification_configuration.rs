...
pub struct NotificationConfiguration {
    ...
    pub topic_configurations: ::std::option::Option<::std::vec::Vec<super::super::types::TopicConfiguration>>,
    /// <p>The Amazon Simple Queue Service queues to publish messages to and the events for which to publish messages.</p>
    pub queue_configurations: ::std::option::Option<::std::vec::Vec<super::super::types::QueueConfiguration>>,
    /// <p>Describes the Lambda functions to invoke and the events for which to invoke them.</p>
    pub lambda_function_configurations: ::std::option::Option<::std::vec::Vec<super::super::types::LambdaFunctionConfiguration>>,
...
impl NotificationConfiguration {
    ...
    pub fn topic_configurations(&self) -> &[super::super::types::TopicConfiguration] {
    ...
    pub fn queue_configurations(&self) -> &[super::super::types::QueueConfiguration] {
    ...
    pub fn lambda_function_configurations(&self) -> &[super::super::types::LambdaFunctionConfiguration] {
        self.lambda_function_configurations.as_deref().unwrap_or_default()
    }
    /// <p>Enables delivery of events to Amazon EventBridge.</p>
    pub fn event_bridge_configuration(&self) -> ::std::option::Option<&super::super::types::EventBridgeConfiguration> {
...
impl NotificationConfiguration {
    ...
    pub fn builder() -> super::super::types::builders::NotificationConfigurationBuilder {
        super::super::types::builders::NotificationConfigurationBuilder::default()
    }
}
...
pub struct NotificationConfigurationBuilder {
    pub(crate) topic_configurations: ::std::option::Option<::std::vec::Vec<super::super::types::TopicConfiguration>>,
    pub(crate) queue_configurations: ::std::option::Option<::std::vec::Vec<super::super::types::QueueConfiguration>>,
    pub(crate) lambda_function_configurations: ::std::option::Option<::std::vec::Vec<super::super::types::LambdaFunctionConfiguration>>,
    pub(crate) event_bridge_configuration: ::std::option::Option<super::super::types::EventBridgeConfiguration>,
}
impl NotificationConfigurationBuilder {
    ...
    ///
    /// <p>The topic to which notifications are sent and the events for which notifications are generated.</p>
    pub fn topic_configurations(mut self, input: super::super::types::TopicConfiguration) -> Self {
    ...
    /// <p>The topic to which notifications are sent and the events for which notifications are generated.</p>
    pub fn set_topic_configurations(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::TopicConfiguration>>) -> Self {
        self.topic_configurations = input;
        self
    }
    /// <p>The topic to which notifications are sent and the events for which notifications are generated.</p>
    pub fn get_topic_configurations(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::TopicConfiguration>> {
    ...
    ///
    /// <p>The Amazon Simple Queue Service queues to publish messages to and the events for which to publish messages.</p>
    pub fn queue_configurations(mut self, input: super::super::types::QueueConfiguration) -> Self {
    ...
    /// <p>The Amazon Simple Queue Service queues to publish messages to and the events for which to publish messages.</p>
    pub fn set_queue_configurations(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::QueueConfiguration>>) -> Self {
        self.queue_configurations = input;
        self
    }
    /// <p>The Amazon Simple Queue Service queues to publish messages to and the events for which to publish messages.</p>
    pub fn get_queue_configurations(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::QueueConfiguration>> {
    ...
    ///
    /// <p>Describes the Lambda functions to invoke and the events for which to invoke them.</p>
    pub fn lambda_function_configurations(mut self, input: super::super::types::LambdaFunctionConfiguration) -> Self {
    ...
    pub fn set_lambda_function_configurations(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::types::LambdaFunctionConfiguration>>,
    ) -> Self {
        self.lambda_function_configurations = input;
        self
    }
    /// <p>Describes the Lambda functions to invoke and the events for which to invoke them.</p>
    pub fn get_lambda_function_configurations(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::LambdaFunctionConfiguration>> {
        &self.lambda_function_configurations
    }
    /// <p>Enables delivery of events to Amazon EventBridge.</p>
    pub fn event_bridge_configuration(mut self, input: super::super::types::EventBridgeConfiguration) -> Self {
        self.event_bridge_configuration = ::std::option::Option::Some(input);
        self
    }
    /// <p>Enables delivery of events to Amazon EventBridge.</p>
    pub fn set_event_bridge_configuration(mut self, input: ::std::option::Option<super::super::types::EventBridgeConfiguration>) -> Self {
        self.event_bridge_configuration = input;
        self
    }
    /// <p>Enables delivery of events to Amazon EventBridge.</p>
    pub fn get_event_bridge_configuration(&self) -> &::std::option::Option<super::super::types::EventBridgeConfiguration> {
    ...
    pub fn build(self) -> super::super::types::NotificationConfiguration {
        super::super::types::NotificationConfiguration {
