...
impl JournalTableConfigurationUpdates {
    ...
    pub fn builder() -> super::super::types::builders::JournalTableConfigurationUpdatesBuilder {
        super::super::types::builders::JournalTableConfigurationUpdatesBuilder::default()
    }
}
...
impl JournalTableConfigurationUpdatesBuilder {
    ...
    pub fn build(self) -> super::super::types::JournalTableConfigurationUpdates {
        super::super::types::JournalTableConfigurationUpdates {
