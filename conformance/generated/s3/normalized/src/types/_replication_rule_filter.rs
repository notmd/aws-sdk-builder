...
pub struct ReplicationRuleFilter {
    ...
    /// </ul>
    pub and: ::std::option::Option<super::super::types::ReplicationRuleAndOperator>,
}
impl ReplicationRuleFilter {
    ...
    /// <p>If you specify a filter based on multiple tags, wrap the <code>Tag</code> elements in an <code>And</code> tag.</p></li>
    /// </ul>
    pub fn and(&self) -> ::std::option::Option<&super::super::types::ReplicationRuleAndOperator> {
        self.and.as_ref()
    }
}
impl ReplicationRuleFilter {
    /// Creates a new builder-style object to manufacture [`ReplicationRuleFilter`](crate::types::ReplicationRuleFilter).
    pub fn builder() -> super::super::types::builders::ReplicationRuleFilterBuilder {
        super::super::types::builders::ReplicationRuleFilterBuilder::default()
    }
}
...
pub struct ReplicationRuleFilterBuilder {
    ...
    pub(crate) and: ::std::option::Option<super::super::types::ReplicationRuleAndOperator>,
}
impl ReplicationRuleFilterBuilder {
    ...
    /// <p>If you specify a filter based on multiple tags, wrap the <code>Tag</code> elements in an <code>And</code> tag.</p></li>
    /// </ul>
    pub fn and(mut self, input: super::super::types::ReplicationRuleAndOperator) -> Self {
    ...
    /// <p>If you specify a filter based on multiple tags, wrap the <code>Tag</code> elements in an <code>And</code> tag.</p></li>
    /// </ul>
    pub fn set_and(mut self, input: ::std::option::Option<super::super::types::ReplicationRuleAndOperator>) -> Self {
        self.and = input;
        self
    }
    /// <p>A container for specifying rule filters. The filters determine the subset of objects to which the rule applies. This element is required only if you specify more than one filter. For example:</p>
    ...
    /// <p>If you specify a filter based on multiple tags, wrap the <code>Tag</code> elements in an <code>And</code> tag.</p></li>
    /// </ul>
    pub fn get_and(&self) -> &::std::option::Option<super::super::types::ReplicationRuleAndOperator> {
        &self.and
    }
    /// Consumes the builder and constructs a [`ReplicationRuleFilter`](crate::types::ReplicationRuleFilter).
    pub fn build(self) -> super::super::types::ReplicationRuleFilter {
        super::super::types::ReplicationRuleFilter {
            prefix: self.prefix,
            tag: self.tag,
            and: self.and,
        }
