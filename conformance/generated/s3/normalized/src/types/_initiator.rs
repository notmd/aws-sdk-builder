...
impl Initiator {
    ...
    pub fn builder() -> super::super::types::builders::InitiatorBuilder {
        super::super::types::builders::InitiatorBuilder::default()
    }
}
...
impl InitiatorBuilder {
    ...
    pub fn build(self) -> super::super::types::Initiator {
        super::super::types::Initiator {
            id: self.id,
