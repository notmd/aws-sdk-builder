...
pub struct Delete {
    ...
    /// </note>
    pub objects: ::std::vec::Vec<super::super::types::ObjectIdentifier>,
...
impl Delete {
    ...
    /// <p><b>Directory buckets</b> - For directory buckets, an object that's composed entirely of whitespace characters is not supported by the <code>DeleteObjects</code> API operation. The request will receive a <code>400 Bad Request</code> error and none of the objects in the request will be deleted.</p>
    /// </note>
    pub fn objects(&self) -> &[super::super::types::ObjectIdentifier] {
        use std::ops::Deref;
        self.objects.deref()
    }
    /// <p>Element to enable quiet mode for the request. When you add this element, you must set its value to <code>true</code>.</p>
...
pub struct DeleteBuilder {
    pub(crate) objects: ::std::option::Option<::std::vec::Vec<super::super::types::ObjectIdentifier>>,
...
impl DeleteBuilder {
    ...
    /// <p><b>Directory buckets</b> - For directory buckets, an object that's composed entirely of whitespace characters is not supported by the <code>DeleteObjects</code> API operation. The request will receive a <code>400 Bad Request</code> error and none of the objects in the request will be deleted.</p>
    /// </note>
    pub fn objects(mut self, input: super::super::types::ObjectIdentifier) -> Self {
    ...
    /// <p><b>Directory buckets</b> - For directory buckets, an object that's composed entirely of whitespace characters is not supported by the <code>DeleteObjects</code> API operation. The request will receive a <code>400 Bad Request</code> error and none of the objects in the request will be deleted.</p>
    /// </note>
    pub fn set_objects(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::ObjectIdentifier>>) -> Self {
        self.objects = input;
        self
    }
    /// <p>The object to delete.</p><note>
    /// <p><b>Directory buckets</b> - For directory buckets, an object that's composed entirely of whitespace characters is not supported by the <code>DeleteObjects</code> API operation. The request will receive a <code>400 Bad Request</code> error and none of the objects in the request will be deleted.</p>
    /// </note>
    pub fn get_objects(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::ObjectIdentifier>> {
        &self.objects
    }
    /// <p>Element to enable quiet mode for the request. When you add this element, you must set its value to <code>true</code>.</p>
