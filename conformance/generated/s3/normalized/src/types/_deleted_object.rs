...
impl DeletedObject {
    ...
    pub fn builder() -> super::super::types::builders::DeletedObjectBuilder {
        super::super::types::builders::DeletedObjectBuilder::default()
    }
}
...
impl DeletedObjectBuilder {
    ...
    pub fn build(self) -> super::super::types::DeletedObject {
        super::super::types::DeletedObject {
            key: self.key,
