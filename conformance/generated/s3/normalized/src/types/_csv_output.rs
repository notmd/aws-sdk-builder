...
pub struct CsvOutput {
    ...
    /// </ul>
    pub quote_fields: ::std::option::Option<super::super::types::QuoteFields>,
...
impl CsvOutput {
    ...
    /// <p><code>ASNEEDED</code>: Use quotation marks for output fields when needed.</p></li>
    /// </ul>
    pub fn quote_fields(&self) -> ::std::option::Option<&super::super::types::QuoteFields> {
...
impl CsvOutput {
    ...
    pub fn builder() -> super::super::types::builders::CsvOutputBuilder {
        super::super::types::builders::CsvOutputBuilder::default()
    }
}
...
pub struct CsvOutputBuilder {
    pub(crate) quote_fields: ::std::option::Option<super::super::types::QuoteFields>,
...
impl CsvOutputBuilder {
    ...
    /// <p><code>ASNEEDED</code>: Use quotation marks for output fields when needed.</p></li>
    /// </ul>
    pub fn quote_fields(mut self, input: super::super::types::QuoteFields) -> Self {
    ...
    /// <p><code>ASNEEDED</code>: Use quotation marks for output fields when needed.</p></li>
    /// </ul>
    pub fn set_quote_fields(mut self, input: ::std::option::Option<super::super::types::QuoteFields>) -> Self {
    ...
    /// <p><code>ASNEEDED</code>: Use quotation marks for output fields when needed.</p></li>
    /// </ul>
    pub fn get_quote_fields(&self) -> &::std::option::Option<super::super::types::QuoteFields> {
        &self.quote_fields
    }
    /// <p>The single character used for escaping the quote character inside an already escaped value.</p>
    ...
    pub fn build(self) -> super::super::types::CsvOutput {
        super::super::types::CsvOutput {
