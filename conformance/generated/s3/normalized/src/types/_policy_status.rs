...
impl PolicyStatus {
    ...
    pub fn builder() -> super::super::types::builders::PolicyStatusBuilder {
        super::super::types::builders::PolicyStatusBuilder::default()
    }
}
...
impl PolicyStatusBuilder {
    ...
    pub fn build(self) -> super::super::types::PolicyStatus {
        super::super::types::PolicyStatus { is_public: self.is_public }
    }
}
