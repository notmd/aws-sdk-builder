...
pub struct NotificationConfigurationFilter {
    ...
    pub key: ::std::option::Option<super::super::types::S3KeyFilter>,
}
impl NotificationConfigurationFilter {
    /// <p>A container for object key name prefix and suffix filtering rules.</p>
    pub fn key(&self) -> ::std::option::Option<&super::super::types::S3KeyFilter> {
        self.key.as_ref()
    }
}
impl NotificationConfigurationFilter {
    ...
    pub fn builder() -> super::super::types::builders::NotificationConfigurationFilterBuilder {
        super::super::types::builders::NotificationConfigurationFilterBuilder::default()
    }
}
...
pub struct NotificationConfigurationFilterBuilder {
    pub(crate) key: ::std::option::Option<super::super::types::S3KeyFilter>,
}
impl NotificationConfigurationFilterBuilder {
    /// <p>A container for object key name prefix and suffix filtering rules.</p>
    pub fn key(mut self, input: super::super::types::S3KeyFilter) -> Self {
        self.key = ::std::option::Option::Some(input);
        self
    }
    /// <p>A container for object key name prefix and suffix filtering rules.</p>
    pub fn set_key(mut self, input: ::std::option::Option<super::super::types::S3KeyFilter>) -> Self {
        self.key = input;
        self
    }
    /// <p>A container for object key name prefix and suffix filtering rules.</p>
    pub fn get_key(&self) -> &::std::option::Option<super::super::types::S3KeyFilter> {
        &self.key
    }
    /// Consumes the builder and constructs a [`NotificationConfigurationFilter`](crate::types::NotificationConfigurationFilter).
    pub fn build(self) -> super::super::types::NotificationConfigurationFilter {
        super::super::types::NotificationConfigurationFilter { key: self.key }
    }
}
