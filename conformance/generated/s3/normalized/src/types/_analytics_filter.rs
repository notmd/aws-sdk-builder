...
pub enum AnalyticsFilter {
    ...
    And(super::super::types::AnalyticsAndOperator),
    /// <p>The prefix to use when evaluating an analytics filter.</p>
    Prefix(::std::string::String),
    /// <p>The tag to use when evaluating an analytics filter.</p>
    Tag(super::super::types::Tag),
...
impl AnalyticsFilter {
    ...
    pub fn as_and(&self) -> ::std::result::Result<&super::super::types::AnalyticsAndOperator, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_tag(&self) -> ::std::result::Result<&super::super::types::Tag, &Self> {
