...
pub struct OwnershipControlsRule {
    ...
    /// </note>
    pub object_ownership: super::super::types::ObjectOwnership,
}
impl OwnershipControlsRule {
    ...
    /// <p>This functionality is not supported for directory buckets. Directory buckets use the bucket owner enforced setting for S3 Object Ownership.</p>
    /// </note>
    pub fn object_ownership(&self) -> &super::super::types::ObjectOwnership {
...
impl OwnershipControlsRule {
    ...
    pub fn builder() -> super::super::types::builders::OwnershipControlsRuleBuilder {
        super::super::types::builders::OwnershipControlsRuleBuilder::default()
    }
}
...
pub struct OwnershipControlsRuleBuilder {
    pub(crate) object_ownership: ::std::option::Option<super::super::types::ObjectOwnership>,
}
impl OwnershipControlsRuleBuilder {
    ...
    pub fn object_ownership(mut self, input: super::super::types::ObjectOwnership) -> Self {
    ...
    /// <p>This functionality is not supported for directory buckets. Directory buckets use the bucket owner enforced setting for S3 Object Ownership.</p>
    /// </note>
    pub fn set_object_ownership(mut self, input: ::std::option::Option<super::super::types::ObjectOwnership>) -> Self {
    ...
    /// <p>This functionality is not supported for directory buckets. Directory buckets use the bucket owner enforced setting for S3 Object Ownership.</p>
    /// </note>
    pub fn get_object_ownership(&self) -> &::std::option::Option<super::super::types::ObjectOwnership> {
        &self.object_ownership
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::OwnershipControlsRule, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::OwnershipControlsRule {
