...
impl ParquetInput {
    ...
    pub fn builder() -> super::super::types::builders::ParquetInputBuilder {
        super::super::types::builders::ParquetInputBuilder::default()
    }
}
...
impl ParquetInputBuilder {
    ...
    pub fn build(self) -> super::super::types::ParquetInput {
        super::super::types::ParquetInput {}
    }
}
