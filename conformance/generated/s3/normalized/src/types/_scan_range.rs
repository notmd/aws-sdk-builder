...
impl ScanRange {
    ...
    pub fn builder() -> super::super::types::builders::ScanRangeBuilder {
        super::super::types::builders::ScanRangeBuilder::default()
    }
}
...
impl ScanRangeBuilder {
    ...
    pub fn build(self) -> super::super::types::ScanRange {
        super::super::types::ScanRange {
            start: self.start,
            end: self.end,
        }
    }
