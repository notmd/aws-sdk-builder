...
impl PutObjectInput {
    ...
    pub fn builder() -> super::operation::put_object::builders::PutObjectInputBuilder {
        super::operation::put_object::builders::PutObjectInputBuilder::default()
    }
}
...
impl PutObjectInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::put_object::PutObjectInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::put_object::PutObjectInput {
            acl: self.acl,
