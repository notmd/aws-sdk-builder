...
pub use super::operation::put_object::_put_object_input::PutObjectInputBuilder;

pub use super::operation::put_object::_put_object_output::PutObjectOutputBuilder;

impl super::operation::put_object::builders::PutObjectInputBuilder {
...
pub struct PutObjectFluentBuilder {
    ...
    inner: super::operation::put_object::builders::PutObjectInputBuilder,
    config_override: ::std::option::Option<super::config::Builder>,
}
impl super::client::customize::internal::CustomizableSend<super::operation::put_object::PutObjectOutput, super::operation::put_object::PutObjectError>
    for PutObjectFluentBuilder
{
    fn send(
        ...
        super::client::customize::internal::SendResult<super::operation::put_object::PutObjectOutput, super::operation::put_object::PutObjectError>,
    > {
...
impl PutObjectFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::put_object::builders::PutObjectInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::put_object::PutObject::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::put_object::PutObject::orchestrate(&runtime_plugins, input).await
    }
    ...
    > {
        ...
        let input = self
            ...
            .build()
            .map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
        let mut context = super::operation::put_object::PutObject::orchestrate_with_stop_point(
            &runtime_plugins,
            input,
...
impl super::client::customize::internal::CustomizablePresigned<super::operation::put_object::PutObjectError> for PutObjectFluentBuilder {
    fn presign(
        self,
        config_override: super::config::Builder,
        presigning_config: super::presigning::PresigningConfig,
    ) -> super::client::customize::internal::BoxFuture<
        super::client::customize::internal::SendResult<super::presigning::PresignedRequest, super::operation::put_object::PutObjectError>,
    > {
