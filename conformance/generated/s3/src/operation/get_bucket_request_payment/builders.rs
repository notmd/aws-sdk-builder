...
pub struct Builder {
    input: super::_get_bucket_request_payment_input::GetBucketRequestPaymentInputBuilder,
...
impl Builder {
    ...
    pub async fn send(self) -> ::std::result::Result<super::GetBucketRequestPaymentOutput, super::GetBucketRequestPaymentError> {
        let input = self
            .input
            .build()
            .map_err(|error| super::GetBucketRequestPaymentError::Unhandled(error.to_string()))?;
        let bucket = input
            .bucket
            .as_deref()
            .ok_or_else(|| super::GetBucketRequestPaymentError::Unhandled("GetBucketRequestPayment requires bucket".to_owned()))?;
        let path = {
        ...
        let response = self
            ...
            .await
            .map_err(super::GetBucketRequestPaymentError::Unhandled)?;
        let status = response.status();
        if !status.is_success() {
            return Err(super::GetBucketRequestPaymentError::unhandled_with_request_ids(
                format!("GetBucketRequestPayment returned HTTP {}", status),
...
pub use Builder as GetBucketRequestPaymentFluentBuilder;
