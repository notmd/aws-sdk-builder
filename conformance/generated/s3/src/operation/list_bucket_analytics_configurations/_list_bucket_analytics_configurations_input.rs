...
impl ListBucketAnalyticsConfigurationsInput {
    pub fn builder() -> ListBucketAnalyticsConfigurationsInputBuilder { ListBucketAnalyticsConfigurationsInputBuilder::default() }
}
#[derive(Clone, Debug, Default)]
...
impl ListBucketAnalyticsConfigurationsInputBuilder {
    ...
    pub fn build(self) -> ListBucketAnalyticsConfigurationsInput { ListBucketAnalyticsConfigurationsInput {
        bucket: self.bucket,
