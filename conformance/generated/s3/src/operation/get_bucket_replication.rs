...
pub mod _get_bucket_replication_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/get_bucket_replication/_get_bucket_replication_input.rs"
    ));
}
...
pub mod _get_bucket_replication_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/get_bucket_replication/_get_bucket_replication_output.rs"
    ));
}
