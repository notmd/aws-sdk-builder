...
impl super::s3_request_id::RequestIdExt for DeleteBucketOutput {
...
impl DeleteBucketOutput {
    ...
    pub fn builder() -> super::operation::delete_bucket::builders::DeleteBucketOutputBuilder {
        super::operation::delete_bucket::builders::DeleteBucketOutputBuilder::default()
    }
}
...
impl DeleteBucketOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_bucket::DeleteBucketOutput {
