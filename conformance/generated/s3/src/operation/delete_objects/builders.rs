...
pub struct Builder {
    input: super::_delete_objects_input::DeleteObjectsInputBuilder,
...
impl Builder {
    ...
    pub fn delete(mut self, value: impl ::std::convert::Into<crate::types::Delete>) -> Self {
        self.input = self.input.set_delete(Some(value.into()));
        self
    }
    ...
    pub async fn send(self) -> ::std::result::Result<super::DeleteObjectsOutput, super::DeleteObjectsError> {
        let input = self
            .input
            .build()
            .map_err(|error| super::DeleteObjectsError::Unhandled(error.to_string()))?;
        let bucket = input
            .bucket
            .as_deref()
        ...
        let body = {
            ...
            if let Some(value) = input.delete.as_ref() {
