...
impl DeleteObjectsInput {
    ...
    pub fn builder() -> super::operation::delete_objects::builders::DeleteObjectsInputBuilder {
        super::operation::delete_objects::builders::DeleteObjectsInputBuilder::default()
    }
}
...
impl DeleteObjectsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::delete_objects::DeleteObjectsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::delete_objects::DeleteObjectsInput {
            bucket: self.bucket,
            delete: self.delete,
            mfa: self.mfa,
