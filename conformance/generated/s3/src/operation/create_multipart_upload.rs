    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::create_multipart_upload::CreateMultipartUploadError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::create_multipart_upload::CreateMultipartUploadOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateMultipartUploadResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_create_multipart_upload::de_create_multipart_upload_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_create_multipart_upload::de_create_multipart_upload_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateMultipartUploadRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::create_multipart_upload::CreateMultipartUploadInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::create_multipart_upload::CreateMultipartUploadInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::protocol_serde::shape_create_multipart_upload::ser_create_multipart_upload_headers(input, builder)?;
...
impl super::s3_request_id::RequestIdExt for super::operation::create_multipart_upload::CreateMultipartUploadError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::create_multipart_upload::CreateMultipartUploadError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::create_multipart_upload::_create_multipart_upload_input::CreateMultipartUploadInput;

pub use super::operation::create_multipart_upload::_create_multipart_upload_output::CreateMultipartUploadOutput;
