...
pub struct Builder {
    input: super::_get_bucket_cors_input::GetBucketCorsInputBuilder,
...
impl Builder {
    ...
    pub async fn send(self) -> ::std::result::Result<super::GetBucketCorsOutput, super::GetBucketCorsError> {
        let input = self
            .input
            .build()
            .map_err(|error| super::GetBucketCorsError::Unhandled(error.to_string()))?;
        let bucket = input
            .bucket
            .as_deref()
            .ok_or_else(|| super::GetBucketCorsError::Unhandled("GetBucketCors requires bucket".to_owned()))?;
        let path = {
        ...
        let response = self
            ...
            .await
            .map_err(super::GetBucketCorsError::Unhandled)?;
        let status = response.status();
        if !status.is_success() {
            return Err(super::GetBucketCorsError::unhandled_with_request_ids(
                format!("GetBucketCors returned HTTP {}", status),
        ...
        let values = super::super::super::transport::xml_tags(&body, "CORSRule")
            .into_iter()
            .filter_map(|value| {
                let mut item: crate::types::CorsRuleBuilder = ::std::default::Default::default();
