...
pub mod _get_object_annotation_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/get_object_annotation/_get_object_annotation_input.rs"
    ));
}
...
pub mod _get_object_annotation_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/get_object_annotation/_get_object_annotation_output.rs"
    ));
}
