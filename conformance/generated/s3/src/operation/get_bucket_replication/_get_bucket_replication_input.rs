...
impl GetBucketReplicationInput {
    ...
    pub fn builder() -> super::operation::get_bucket_replication::builders::GetBucketReplicationInputBuilder {
        super::operation::get_bucket_replication::builders::GetBucketReplicationInputBuilder::default()
    }
}
...
impl GetBucketReplicationInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_bucket_replication::GetBucketReplicationInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::get_bucket_replication::GetBucketReplicationInput {
            bucket: self.bucket,
