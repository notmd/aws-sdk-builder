...
impl GetBucketReplicationInput {
    pub fn builder() -> GetBucketReplicationInputBuilder { GetBucketReplicationInputBuilder::default() }
}
#[derive(Clone, Debug, Default)]
...
impl GetBucketReplicationInputBuilder {
    ...
    pub fn build(self) -> GetBucketReplicationInput { GetBucketReplicationInput {
        bucket: self.bucket,
