...
impl DeleteBucketWebsiteInput {
    ...
    pub fn builder() -> super::operation::delete_bucket_website::builders::DeleteBucketWebsiteInputBuilder {
        super::operation::delete_bucket_website::builders::DeleteBucketWebsiteInputBuilder::default()
    }
}
...
impl DeleteBucketWebsiteInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::delete_bucket_website::DeleteBucketWebsiteInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::delete_bucket_website::DeleteBucketWebsiteInput {
            bucket: self.bucket,
