...
impl GetPublicAccessBlockInput {
    ...
    pub fn builder() -> super::operation::get_public_access_block::builders::GetPublicAccessBlockInputBuilder {
        super::operation::get_public_access_block::builders::GetPublicAccessBlockInputBuilder::default()
    }
}
...
impl GetPublicAccessBlockInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_public_access_block::GetPublicAccessBlockInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::get_public_access_block::GetPublicAccessBlockInput {
            bucket: self.bucket,
