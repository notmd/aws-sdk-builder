...
impl GetObjectAclInput {
    ...
    pub fn builder() -> super::operation::get_object_acl::builders::GetObjectAclInputBuilder {
        super::operation::get_object_acl::builders::GetObjectAclInputBuilder::default()
    }
}
...
impl GetObjectAclInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_object_acl::GetObjectAclInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_object_acl::GetObjectAclInput {
            bucket: self.bucket,
            key: self.key,
