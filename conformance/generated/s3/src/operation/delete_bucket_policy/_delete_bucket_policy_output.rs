...
impl super::s3_request_id::RequestIdExt for DeleteBucketPolicyOutput {
...
impl DeleteBucketPolicyOutput {
    ...
    pub fn builder() -> super::operation::delete_bucket_policy::builders::DeleteBucketPolicyOutputBuilder {
        super::operation::delete_bucket_policy::builders::DeleteBucketPolicyOutputBuilder::default()
    }
}
...
impl DeleteBucketPolicyOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_bucket_policy::DeleteBucketPolicyOutput {
