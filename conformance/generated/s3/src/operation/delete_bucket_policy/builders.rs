...
pub struct Builder {
    input: super::_delete_bucket_policy_input::DeleteBucketPolicyInputBuilder,
...
impl Builder {
    ...
    pub async fn send(self) -> ::std::result::Result<super::DeleteBucketPolicyOutput, super::DeleteBucketPolicyError> {
        let input = self
            .input
            .build()
            .map_err(|error| super::DeleteBucketPolicyError::Unhandled(error.to_string()))?;
        let bucket = input
            .bucket
            .as_deref()
            .ok_or_else(|| super::DeleteBucketPolicyError::Unhandled("DeleteBucketPolicy requires bucket".to_owned()))?;
        let path = {
        ...
        let response = self
            ...
            .await
            .map_err(super::DeleteBucketPolicyError::Unhandled)?;
        let status = response.status();
        if !status.is_success() {
            return Err(super::DeleteBucketPolicyError::unhandled_with_request_ids(
                format!("DeleteBucketPolicy returned HTTP {}", status),
