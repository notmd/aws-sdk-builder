...
pub mod _put_bucket_versioning_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/put_bucket_versioning/_put_bucket_versioning_input.rs"
    ));
}
...
pub mod _put_bucket_versioning_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/put_bucket_versioning/_put_bucket_versioning_output.rs"
    ));
}
