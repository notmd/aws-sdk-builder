    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::put_object_annotation::PutObjectAnnotationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::put_object_annotation::PutObjectAnnotationOutput>()
...
.with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(super::http_request_checksum::RequestChecksumInterceptor::new(
                                |input: &::aws_smithy_runtime_api::client::interceptors::context::Input| {
                                    let input: &super::operation::put_object_annotation::PutObjectAnnotationInput = input.downcast_ref().expect("correct type");
...
.with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(super::aws_chunked::AwsChunkedContentEncodingInterceptor))
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<super::operation::put_object_annotation::PutObjectAnnotationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<super::operation::put_object_annotation::PutObjectAnnotationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::operation::put_object_annotation::PutObjectAnnotationError>::builder().transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutObjectAnnotationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_put_object_annotation::de_put_object_annotation_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_put_object_annotation::de_put_object_annotation_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutObjectAnnotationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::put_object_annotation::PutObjectAnnotationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::put_object_annotation::PutObjectAnnotationInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::protocol_serde::shape_put_object_annotation::ser_put_object_annotation_headers(input, builder)?;
        ...
        let body =
            super::protocol_serde::shape_put_object_annotation_input::ser_annotation_payload_http_payload(input.annotation_payload)?.into_inner();
...
impl super::s3_request_id::RequestIdExt for super::operation::put_object_annotation::PutObjectAnnotationError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::put_object_annotation::PutObjectAnnotationError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::put_object_annotation::_put_object_annotation_input::PutObjectAnnotationInput;

pub use super::operation::put_object_annotation::_put_object_annotation_output::PutObjectAnnotationOutput;
