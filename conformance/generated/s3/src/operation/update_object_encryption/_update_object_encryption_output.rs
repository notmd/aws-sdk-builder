...
impl UpdateObjectEncryptionOutput {
    pub fn builder() -> UpdateObjectEncryptionOutputBuilder { UpdateObjectEncryptionOutputBuilder::default() }
}
#[derive(Clone, Debug, Default)]
...
impl UpdateObjectEncryptionOutputBuilder {
    ...
    pub fn build(self) -> UpdateObjectEncryptionOutput { UpdateObjectEncryptionOutput {
