...
impl super::s3_request_id::RequestIdExt for UpdateObjectEncryptionOutput {
...
impl UpdateObjectEncryptionOutput {
    ...
    pub fn builder() -> super::operation::update_object_encryption::builders::UpdateObjectEncryptionOutputBuilder {
        super::operation::update_object_encryption::builders::UpdateObjectEncryptionOutputBuilder::default()
    }
}
...
impl UpdateObjectEncryptionOutputBuilder {
    ...
    pub fn build(self) -> super::operation::update_object_encryption::UpdateObjectEncryptionOutput {
