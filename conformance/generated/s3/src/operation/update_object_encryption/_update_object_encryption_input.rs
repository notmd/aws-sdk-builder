...
impl UpdateObjectEncryptionInputBuilder {
    ...
    pub fn set_object_encryption(mut self, input: ::std::option::Option<crate::types::ObjectEncryption>) -> Self { self.object_encryption = input; self }
    /// <p>The updated server-side encryption type for this object. The <code>UpdateObjectEncryption</code> operation supports the SSE-S3 and SSE-KMS encryption types.</p>
    /// <p>Valid Values: <code>SSES3</code> | <code>SSEKMS</code></p>
    pub fn get_object_encryption(&self) -> &::std::option::Option<crate::types::ObjectEncryption> { &self.object_encryption }
    ...
    pub fn build(self) -> crate::operation::update_object_encryption::UpdateObjectEncryptionInput {
