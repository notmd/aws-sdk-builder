...
impl ListObjectVersionsInput {
    ...
    pub fn builder() -> super::operation::list_object_versions::builders::ListObjectVersionsInputBuilder {
        super::operation::list_object_versions::builders::ListObjectVersionsInputBuilder::default()
    }
}
...
impl ListObjectVersionsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_object_versions::ListObjectVersionsInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::list_object_versions::ListObjectVersionsInput {
            bucket: self.bucket,
