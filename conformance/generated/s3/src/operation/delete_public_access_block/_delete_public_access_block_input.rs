...
impl DeletePublicAccessBlockInput {
    pub fn builder() -> DeletePublicAccessBlockInputBuilder { DeletePublicAccessBlockInputBuilder::default() }
}
#[derive(Clone, Debug, Default)]
...
impl DeletePublicAccessBlockInputBuilder {
    ...
    pub fn build(self) -> DeletePublicAccessBlockInput { DeletePublicAccessBlockInput {
        bucket: self.bucket,
