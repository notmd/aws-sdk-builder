...
impl DeletePublicAccessBlockInput {
    ...
    pub fn builder() -> super::operation::delete_public_access_block::builders::DeletePublicAccessBlockInputBuilder {
        super::operation::delete_public_access_block::builders::DeletePublicAccessBlockInputBuilder::default()
    }
}
...
impl DeletePublicAccessBlockInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::delete_public_access_block::DeletePublicAccessBlockInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::delete_public_access_block::DeletePublicAccessBlockInput {
            bucket: self.bucket,
