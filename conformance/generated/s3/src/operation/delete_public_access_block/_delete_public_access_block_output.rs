...
impl super::s3_request_id::RequestIdExt for DeletePublicAccessBlockOutput {
...
impl DeletePublicAccessBlockOutput {
    ...
    pub fn builder() -> super::operation::delete_public_access_block::builders::DeletePublicAccessBlockOutputBuilder {
        super::operation::delete_public_access_block::builders::DeletePublicAccessBlockOutputBuilder::default()
    }
}
...
impl DeletePublicAccessBlockOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_public_access_block::DeletePublicAccessBlockOutput {
