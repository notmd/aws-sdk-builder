...
impl UploadPartInput {
    ...
    pub fn builder() -> super::operation::upload_part::builders::UploadPartInputBuilder {
        super::operation::upload_part::builders::UploadPartInputBuilder::default()
    }
}
...
impl UploadPartInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::upload_part::UploadPartInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::upload_part::UploadPartInput {
