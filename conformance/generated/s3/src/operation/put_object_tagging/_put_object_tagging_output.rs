...
impl super::s3_request_id::RequestIdExt for PutObjectTaggingOutput {
...
impl PutObjectTaggingOutput {
    ...
    pub fn builder() -> super::operation::put_object_tagging::builders::PutObjectTaggingOutputBuilder {
        super::operation::put_object_tagging::builders::PutObjectTaggingOutputBuilder::default()
    }
}
...
impl PutObjectTaggingOutputBuilder {
    ...
    pub fn build(self) -> super::operation::put_object_tagging::PutObjectTaggingOutput {
