...
impl Builder {
    ...
    pub fn build(self) -> super::Input { self.input }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::PutObjectTaggingOutput, super::PutObjectTaggingError> {
                         ...
                         let body = { let mut body = ::std::string::String::new(); if let Some(value) = self.input.tagging.as_ref() { body.push_str("<Tagging>"); if let Some(value) = value.tag_set.as_ref() { body.push_str("<TagSet>"); for item in value { body.push_str("<Tag>"); if let Some(value) = item.key.as_ref() { body.push_str("<Key>"); body.push_str(&super::super::super::transport::xml_escape(&value.to_string())); body.push_str("</Key>"); } if let Some(value) = item.value.as_ref() { body.push_str("<Value>"); body.push_str(&super::super::super::transport::xml_escape(&value.to_string())); body.push_str("</Value>"); } body.push_str("</Tag>"); } body.push_str("</TagSet>"); } body.push_str("</Tagging>"); } body.into_bytes() };
