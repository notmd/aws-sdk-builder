...
impl GetBucketMetricsConfiguration {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::get_bucket_metrics_configuration::GetBucketMetricsConfigurationInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_bucket_metrics_configuration::GetBucketMetricsConfigurationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_bucket_metrics_configuration::GetBucketMetricsConfigurationOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetBucketMetricsConfigurationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_bucket_metrics_configuration::de_get_bucket_metrics_configuration_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_bucket_metrics_configuration::de_get_bucket_metrics_configuration_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetBucketMetricsConfigurationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_bucket_metrics_configuration::GetBucketMetricsConfigurationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_bucket_metrics_configuration::GetBucketMetricsConfigurationInput,
            ...
            fn update_http_builder(
                ...
                let builder =
                    super::protocol_serde::shape_get_bucket_metrics_configuration::ser_get_bucket_metrics_configuration_headers(input, builder)?;
...
impl super::s3_request_id::RequestIdExt for super::operation::get_bucket_metrics_configuration::GetBucketMetricsConfigurationError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::get_bucket_metrics_configuration::GetBucketMetricsConfigurationError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_bucket_metrics_configuration::_get_bucket_metrics_configuration_input::GetBucketMetricsConfigurationInput;

pub use super::operation::get_bucket_metrics_configuration::_get_bucket_metrics_configuration_output::GetBucketMetricsConfigurationOutput;
