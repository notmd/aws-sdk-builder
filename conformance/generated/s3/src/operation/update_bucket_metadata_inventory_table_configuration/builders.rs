...
pub use super::operation::update_bucket_metadata_inventory_table_configuration::_update_bucket_metadata_inventory_table_configuration_input::UpdateBucketMetadataInventoryTableConfigurationInputBuilder;

pub use super::operation::update_bucket_metadata_inventory_table_configuration::_update_bucket_metadata_inventory_table_configuration_output::UpdateBucketMetadataInventoryTableConfigurationOutputBuilder;

impl super::operation::update_bucket_metadata_inventory_table_configuration::builders::UpdateBucketMetadataInventoryTableConfigurationInputBuilder {
...
pub struct UpdateBucketMetadataInventoryTableConfigurationFluentBuilder {
    ...
    inner:
        super::operation::update_bucket_metadata_inventory_table_configuration::builders::UpdateBucketMetadataInventoryTableConfigurationInputBuilder,
...
impl UpdateBucketMetadataInventoryTableConfigurationFluentBuilder {
    ...
    > {
        ...
        let runtime_plugins = super::operation::update_bucket_metadata_inventory_table_configuration::UpdateBucketMetadataInventoryTableConfiguration::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
        super::operation::update_bucket_metadata_inventory_table_configuration::UpdateBucketMetadataInventoryTableConfiguration::orchestrate(
            &runtime_plugins,
            input,
        )
        .await
    ...
    pub fn inventory_table_configuration(mut self, input: super::types::InventoryTableConfigurationUpdates) -> Self {
        self.inner = self.inner.inventory_table_configuration(input);
        self
    }
    /// <p>The contents of your inventory table configuration.</p>
    pub fn set_inventory_table_configuration(mut self, input: ::std::option::Option<super::types::InventoryTableConfigurationUpdates>) -> Self {
        self.inner = self.inner.set_inventory_table_configuration(input);
        self
    }
    /// <p>The contents of your inventory table configuration.</p>
    pub fn get_inventory_table_configuration(&self) -> &::std::option::Option<super::types::InventoryTableConfigurationUpdates> {
