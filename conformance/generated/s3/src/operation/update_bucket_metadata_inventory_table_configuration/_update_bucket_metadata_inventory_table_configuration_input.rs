...
pub struct UpdateBucketMetadataInventoryTableConfigurationInput {
    ...
    pub inventory_table_configuration: ::std::option::Option<super::types::InventoryTableConfigurationUpdates>,
...
impl UpdateBucketMetadataInventoryTableConfigurationInput {
    ...
    /// <p>The contents of your inventory table configuration.</p>
    pub fn inventory_table_configuration(&self) -> ::std::option::Option<&super::types::InventoryTableConfigurationUpdates> {
...
impl UpdateBucketMetadataInventoryTableConfigurationInput {
    ...
    {
        super::operation::update_bucket_metadata_inventory_table_configuration::builders::UpdateBucketMetadataInventoryTableConfigurationInputBuilder::default()
    }
}
...
pub struct UpdateBucketMetadataInventoryTableConfigurationInputBuilder {
    ...
    pub(crate) inventory_table_configuration: ::std::option::Option<super::types::InventoryTableConfigurationUpdates>,
...
impl UpdateBucketMetadataInventoryTableConfigurationInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::update_bucket_metadata_inventory_table_configuration::UpdateBucketMetadataInventoryTableConfigurationInput,
