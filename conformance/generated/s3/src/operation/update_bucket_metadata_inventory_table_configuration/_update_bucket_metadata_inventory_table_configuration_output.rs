...
impl super::s3_request_id::RequestIdExt for UpdateBucketMetadataInventoryTableConfigurationOutput {
...
impl UpdateBucketMetadataInventoryTableConfigurationOutput {
    ...
    pub fn builder(
    ) -> super::operation::update_bucket_metadata_inventory_table_configuration::builders::UpdateBucketMetadataInventoryTableConfigurationOutputBuilder
    {
        super::operation::update_bucket_metadata_inventory_table_configuration::builders::UpdateBucketMetadataInventoryTableConfigurationOutputBuilder::default()
    }
}
