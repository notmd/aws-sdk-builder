...
pub mod _put_bucket_encryption_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/put_bucket_encryption/_put_bucket_encryption_input.rs"
    ));
}
...
pub mod _put_bucket_encryption_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/put_bucket_encryption/_put_bucket_encryption_output.rs"
    ));
}
