...
impl PutBucketEncryption {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::put_bucket_encryption::PutBucketEncryptionInput,
    ) -> ::std::result::Result<
        super::operation::put_bucket_encryption::PutBucketEncryptionOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::put_bucket_encryption::PutBucketEncryptionError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::put_bucket_encryption::PutBucketEncryptionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::put_bucket_encryption::PutBucketEncryptionOutput>()
...
.with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(super::http_request_checksum::RequestChecksumInterceptor::new(
                                |input: &::aws_smithy_runtime_api::client::interceptors::context::Input| {
                                    let input: &super::operation::put_bucket_encryption::PutBucketEncryptionInput = input.downcast_ref().expect("correct type");
                            ...
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<super::operation::put_bucket_encryption::PutBucketEncryptionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<super::operation::put_bucket_encryption::PutBucketEncryptionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::operation::put_bucket_encryption::PutBucketEncryptionError>::builder().transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutBucketEncryptionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_put_bucket_encryption::de_put_bucket_encryption_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_put_bucket_encryption::de_put_bucket_encryption_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutBucketEncryptionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::put_bucket_encryption::PutBucketEncryptionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::put_bucket_encryption::PutBucketEncryptionInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::protocol_serde::shape_put_bucket_encryption::ser_put_bucket_encryption_headers(input, builder)?;
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_put_bucket_encryption_input::ser_server_side_encryption_configuration_http_payload(
...
impl super::s3_request_id::RequestIdExt for super::operation::put_bucket_encryption::PutBucketEncryptionError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::put_bucket_encryption::PutBucketEncryptionError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::put_bucket_encryption::_put_bucket_encryption_input::PutBucketEncryptionInput;

pub use super::operation::put_bucket_encryption::_put_bucket_encryption_output::PutBucketEncryptionOutput;
