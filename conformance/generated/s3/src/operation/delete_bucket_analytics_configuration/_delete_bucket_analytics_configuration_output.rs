...
impl super::s3_request_id::RequestIdExt for DeleteBucketAnalyticsConfigurationOutput {
...
impl DeleteBucketAnalyticsConfigurationOutput {
    ...
    pub fn builder() -> super::operation::delete_bucket_analytics_configuration::builders::DeleteBucketAnalyticsConfigurationOutputBuilder {
...
impl DeleteBucketAnalyticsConfigurationOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_bucket_analytics_configuration::DeleteBucketAnalyticsConfigurationOutput {
