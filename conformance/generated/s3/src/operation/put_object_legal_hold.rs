...
pub mod _put_object_legal_hold_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/put_object_legal_hold/_put_object_legal_hold_input.rs"
    ));
}
...
pub mod _put_object_legal_hold_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/put_object_legal_hold/_put_object_legal_hold_output.rs"
    ));
}
