...
impl PutObjectLegalHold {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::put_object_legal_hold::PutObjectLegalHoldInput,
    ) -> ::std::result::Result<
        super::operation::put_object_legal_hold::PutObjectLegalHoldOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::put_object_legal_hold::PutObjectLegalHoldError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::put_object_legal_hold::PutObjectLegalHoldError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::put_object_legal_hold::PutObjectLegalHoldOutput>()
...
.with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(super::http_request_checksum::RequestChecksumInterceptor::new(
                                |input: &::aws_smithy_runtime_api::client::interceptors::context::Input| {
                                    let input: &super::operation::put_object_legal_hold::PutObjectLegalHoldInput = input.downcast_ref().expect("correct type");
                            ...
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<super::operation::put_object_legal_hold::PutObjectLegalHoldError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<super::operation::put_object_legal_hold::PutObjectLegalHoldError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::operation::put_object_legal_hold::PutObjectLegalHoldError>::builder().transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutObjectLegalHoldResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_put_object_legal_hold::de_put_object_legal_hold_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_put_object_legal_hold::de_put_object_legal_hold_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutObjectLegalHoldRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::put_object_legal_hold::PutObjectLegalHoldInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::put_object_legal_hold::PutObjectLegalHoldInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::protocol_serde::shape_put_object_legal_hold::ser_put_object_legal_hold_headers(input, builder)?;
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_put_object_legal_hold_input::ser_legal_hold_http_payload(
            &input.legal_hold,
        )?);
...
impl super::s3_request_id::RequestIdExt for super::operation::put_object_legal_hold::PutObjectLegalHoldError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::put_object_legal_hold::PutObjectLegalHoldError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::put_object_legal_hold::_put_object_legal_hold_input::PutObjectLegalHoldInput;

pub use super::operation::put_object_legal_hold::_put_object_legal_hold_output::PutObjectLegalHoldOutput;
