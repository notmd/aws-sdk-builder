...
impl AbortMultipartUploadInput {
    ...
    pub fn builder() -> super::operation::abort_multipart_upload::builders::AbortMultipartUploadInputBuilder {
        super::operation::abort_multipart_upload::builders::AbortMultipartUploadInputBuilder::default()
    }
}
...
impl AbortMultipartUploadInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::abort_multipart_upload::AbortMultipartUploadInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::abort_multipart_upload::AbortMultipartUploadInput {
            bucket: self.bucket,
            key: self.key,
