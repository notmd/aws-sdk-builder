...
impl super::s3_request_id::RequestIdExt for AbortMultipartUploadOutput {
...
impl AbortMultipartUploadOutput {
    ...
    pub fn builder() -> super::operation::abort_multipart_upload::builders::AbortMultipartUploadOutputBuilder {
        super::operation::abort_multipart_upload::builders::AbortMultipartUploadOutputBuilder::default()
    }
}
...
impl AbortMultipartUploadOutputBuilder {
    ...
    pub fn build(self) -> super::operation::abort_multipart_upload::AbortMultipartUploadOutput {
