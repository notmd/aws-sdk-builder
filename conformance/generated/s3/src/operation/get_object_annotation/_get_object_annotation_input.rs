...
pub struct GetObjectAnnotationInput {
    ...
    pub checksum_mode: ::std::option::Option<super::types::ChecksumMode>,
}
impl GetObjectAnnotationInput {
    ...
    /// <p>Set to <code>ENABLED</code> to validate the checksum of the annotation payload on retrieval.</p>
    pub fn checksum_mode(&self) -> ::std::option::Option<&super::types::ChecksumMode> {
...
impl GetObjectAnnotationInput {
    ...
    pub fn builder() -> super::operation::get_object_annotation::builders::GetObjectAnnotationInputBuilder {
        super::operation::get_object_annotation::builders::GetObjectAnnotationInputBuilder::default()
    }
}
...
pub struct GetObjectAnnotationInputBuilder {
    ...
    pub(crate) checksum_mode: ::std::option::Option<super::types::ChecksumMode>,
}
impl GetObjectAnnotationInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_object_annotation::GetObjectAnnotationInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::get_object_annotation::GetObjectAnnotationInput {
            bucket: self.bucket,
            key: self.key,
