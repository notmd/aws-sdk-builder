...
impl super::s3_request_id::RequestIdExt for GetObjectAnnotationOutput {
...
impl GetObjectAnnotationOutput {
    ...
    pub fn builder() -> super::operation::get_object_annotation::builders::GetObjectAnnotationOutputBuilder {
        super::operation::get_object_annotation::builders::GetObjectAnnotationOutputBuilder::default()
    }
}
...
impl GetObjectAnnotationOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_object_annotation::GetObjectAnnotationOutput {
