...
pub mod _get_bucket_request_payment_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/get_bucket_request_payment/_get_bucket_request_payment_input.rs"
    ));
}
...
pub mod _get_bucket_request_payment_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/get_bucket_request_payment/_get_bucket_request_payment_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/get_bucket_request_payment/builders.rs"
    ));
}
