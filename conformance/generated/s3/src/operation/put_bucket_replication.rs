...
pub mod _put_bucket_replication_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/put_bucket_replication/_put_bucket_replication_input.rs"
    ));
}
...
pub mod _put_bucket_replication_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/put_bucket_replication/_put_bucket_replication_output.rs"
    ));
}
