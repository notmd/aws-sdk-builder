// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        impl DeleteBucketReplication { pub fn new() -> Self { Self } }
        #[derive(Clone, Debug, Default)]
        pub struct Input {
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output;
        pub type DeleteBucketReplicationInput = Input;
        pub type DeleteBucketReplicationOutput = Output;
        pub type DeleteBucketReplicationError = Error;
        #[derive(Clone, Debug)]
        pub enum Error {
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::DeleteBucketReplicationOutput, super::DeleteBucketReplicationError> {
                         let bucket = self.input.bucket.as_deref().ok_or_else(|| super::DeleteBucketReplicationError::Unhandled("DeleteBucketReplication requires bucket".to_owned()))?;
...
pub use builders::Builder;
        pub type DeleteBucketReplicationFluentBuilder = builders::Builder;
