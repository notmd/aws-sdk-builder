    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_bucket_replication::DeleteBucketReplicationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_bucket_replication::DeleteBucketReplicationOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteBucketReplicationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 204 || force_error {
            super::protocol_serde::shape_delete_bucket_replication::de_delete_bucket_replication_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_bucket_replication::de_delete_bucket_replication_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteBucketReplicationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_bucket_replication::DeleteBucketReplicationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_bucket_replication::DeleteBucketReplicationInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::protocol_serde::shape_delete_bucket_replication::ser_delete_bucket_replication_headers(input, builder)?;
...
impl super::s3_request_id::RequestIdExt for super::operation::delete_bucket_replication::DeleteBucketReplicationError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::delete_bucket_replication::DeleteBucketReplicationError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_bucket_replication::_delete_bucket_replication_input::DeleteBucketReplicationInput;

pub use super::operation::delete_bucket_replication::_delete_bucket_replication_output::DeleteBucketReplicationOutput;
