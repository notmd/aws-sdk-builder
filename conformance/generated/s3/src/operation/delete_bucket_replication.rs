...
pub mod _delete_bucket_replication_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/delete_bucket_replication/_delete_bucket_replication_input.rs"
    ));
}
...
pub mod _delete_bucket_replication_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/delete_bucket_replication/_delete_bucket_replication_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/delete_bucket_replication/builders.rs"
    ));
}
