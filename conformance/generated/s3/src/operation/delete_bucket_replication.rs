...
pub mod _delete_bucket_replication_input {
    include!(concat!(env!("OUT_DIR"), "/generated/s3/src/operation/delete_bucket_replication/_delete_bucket_replication_input.rs"));
}
pub use _delete_bucket_replication_input::DeleteBucketReplicationInput;
pub type Input = DeleteBucketReplicationInput;
pub mod _delete_bucket_replication_output {
    include!(concat!(env!("OUT_DIR"), "/generated/s3/src/operation/delete_bucket_replication/_delete_bucket_replication_output.rs"));
}
pub use _delete_bucket_replication_output::DeleteBucketReplicationOutput;
pub type Output = DeleteBucketReplicationOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/s3/src/operation/delete_bucket_replication/builders.rs"));
}
