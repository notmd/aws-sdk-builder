// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        pub type GetBucketAbacInput = Input;
        pub type GetBucketAbacOutput = Output;
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::GetBucketAbacOutput, super::GetBucketAbacError> {
                         let bucket = self.input.bucket.as_deref().ok_or_else(|| super::GetBucketAbacError::Unhandled("GetBucketAbac requires bucket".to_owned()))?;
                         ...
                         Ok(super::GetBucketAbacOutput::default())
                     }
                 }
}
