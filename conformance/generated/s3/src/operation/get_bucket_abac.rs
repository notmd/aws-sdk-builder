...
impl GetBucketAbac {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::get_bucket_abac::GetBucketAbacInput,
    ) -> ::std::result::Result<
        super::operation::get_bucket_abac::GetBucketAbacOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::get_bucket_abac::GetBucketAbacError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_bucket_abac::GetBucketAbacError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_bucket_abac::GetBucketAbacOutput>()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetBucketAbac")
            ...
            .with_retry_classifier(
                ::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::operation::get_bucket_abac::GetBucketAbacError>::builder()
                    .transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetBucketAbacResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_bucket_abac::de_get_bucket_abac_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_bucket_abac::de_get_bucket_abac_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetBucketAbacRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_bucket_abac::GetBucketAbacInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_bucket_abac::GetBucketAbacInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::protocol_serde::shape_get_bucket_abac::ser_get_bucket_abac_headers(input, builder)?;
...
impl super::s3_request_id::RequestIdExt for super::operation::get_bucket_abac::GetBucketAbacError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::get_bucket_abac::GetBucketAbacError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_bucket_abac::_get_bucket_abac_input::GetBucketAbacInput;

pub use super::operation::get_bucket_abac::_get_bucket_abac_output::GetBucketAbacOutput;
