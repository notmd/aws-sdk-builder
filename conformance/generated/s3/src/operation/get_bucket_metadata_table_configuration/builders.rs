...
pub struct Builder {
    input: super::_get_bucket_metadata_table_configuration_input::GetBucketMetadataTableConfigurationInputBuilder,
...
impl Builder {
    ...
    pub async fn send(
        ...
        let input = self
            .input
            .build()
            .map_err(|error| super::GetBucketMetadataTableConfigurationError::Unhandled(error.to_string()))?;
