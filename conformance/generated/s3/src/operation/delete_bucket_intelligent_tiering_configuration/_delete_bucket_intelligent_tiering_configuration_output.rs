...
impl super::s3_request_id::RequestIdExt for DeleteBucketIntelligentTieringConfigurationOutput {
...
impl DeleteBucketIntelligentTieringConfigurationOutput {
    ...
    pub fn builder(
    ) -> super::operation::delete_bucket_intelligent_tiering_configuration::builders::DeleteBucketIntelligentTieringConfigurationOutputBuilder {
        super::operation::delete_bucket_intelligent_tiering_configuration::builders::DeleteBucketIntelligentTieringConfigurationOutputBuilder::default(
        )
    }
}
...
impl DeleteBucketIntelligentTieringConfigurationOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_bucket_intelligent_tiering_configuration::DeleteBucketIntelligentTieringConfigurationOutput {
