...
pub struct Builder {
    input: super::_delete_bucket_intelligent_tiering_configuration_input::DeleteBucketIntelligentTieringConfigurationInputBuilder,
...
impl Builder {
    ...
    ) -> ::std::result::Result<super::DeleteBucketIntelligentTieringConfigurationOutput, super::DeleteBucketIntelligentTieringConfigurationError>
    {
        let input = self
            .input
            .build()
            .map_err(|error| super::DeleteBucketIntelligentTieringConfigurationError::Unhandled(error.to_string()))?;
