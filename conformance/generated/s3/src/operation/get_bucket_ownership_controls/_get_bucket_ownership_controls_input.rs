...
impl GetBucketOwnershipControlsInput {
    pub fn builder() -> GetBucketOwnershipControlsInputBuilder { GetBucketOwnershipControlsInputBuilder::default() }
}
#[derive(Clone, Debug, Default)]
...
impl GetBucketOwnershipControlsInputBuilder {
    ...
    pub fn build(self) -> GetBucketOwnershipControlsInput { GetBucketOwnershipControlsInput {
        bucket: self.bucket,
