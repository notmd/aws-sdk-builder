...
pub mod _delete_bucket_tagging_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/delete_bucket_tagging/_delete_bucket_tagging_input.rs"
    ));
}
...
pub mod _delete_bucket_tagging_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/delete_bucket_tagging/_delete_bucket_tagging_output.rs"
    ));
}
