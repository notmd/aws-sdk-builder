...
impl GetBucketTagging {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::get_bucket_tagging::GetBucketTaggingInput,
    ) -> ::std::result::Result<
        super::operation::get_bucket_tagging::GetBucketTaggingOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::get_bucket_tagging::GetBucketTaggingError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_bucket_tagging::GetBucketTaggingError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_bucket_tagging::GetBucketTaggingOutput>()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetBucketTagging")
            ...
            .with_retry_classifier(
                ::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::operation::get_bucket_tagging::GetBucketTaggingError>::builder()
                    .transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetBucketTaggingResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_bucket_tagging::de_get_bucket_tagging_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_bucket_tagging::de_get_bucket_tagging_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetBucketTaggingRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_bucket_tagging::GetBucketTaggingInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_bucket_tagging::GetBucketTaggingInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::protocol_serde::shape_get_bucket_tagging::ser_get_bucket_tagging_headers(input, builder)?;
...
impl super::s3_request_id::RequestIdExt for super::operation::get_bucket_tagging::GetBucketTaggingError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::get_bucket_tagging::GetBucketTaggingError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_bucket_tagging::_get_bucket_tagging_input::GetBucketTaggingInput;

pub use super::operation::get_bucket_tagging::_get_bucket_tagging_output::GetBucketTaggingOutput;
