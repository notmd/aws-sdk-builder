...
impl CompleteMultipartUploadInputBuilder {
    ...
    pub fn set_multipart_upload(mut self, input: ::std::option::Option<crate::types::CompletedMultipartUpload>) -> Self { self.multipart_upload = input; self }
    /// <p>The container for the multipart upload request information.</p>
    pub fn get_multipart_upload(&self) -> &::std::option::Option<crate::types::CompletedMultipartUpload> { &self.multipart_upload }
    /// <p>ID for the initiated multipart upload.</p>
    /// This field is required.
    ...
    pub fn set_mpu_object_size(mut self, input: ::std::option::Option<i64>) -> Self { self.mpu_object_size = input; self }
    /// <p>The expected total object size of the multipart upload request. If there’s a mismatch between the specified object size value and the actual object size value, it results in an <code>HTTP 400 InvalidRequest</code> error.</p>
    pub fn get_mpu_object_size(&self) -> &::std::option::Option<i64> { &self.mpu_object_size }
    ...
    pub fn build(self) -> crate::operation::complete_multipart_upload::CompleteMultipartUploadInput {
