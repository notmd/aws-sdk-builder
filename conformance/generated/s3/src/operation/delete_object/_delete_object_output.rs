...
impl super::s3_request_id::RequestIdExt for DeleteObjectOutput {
...
impl DeleteObjectOutput {
    ...
    pub fn builder() -> super::operation::delete_object::builders::DeleteObjectOutputBuilder {
        super::operation::delete_object::builders::DeleteObjectOutputBuilder::default()
    }
}
...
impl DeleteObjectOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_object::DeleteObjectOutput {
