...
impl Builder {
    ...
    pub fn accelerate_configuration(mut self, value: impl ::std::convert::Into<crate::types::AccelerateConfiguration>) -> Self {
        self.input.accelerate_configuration = Some(value.into());
        self
    }
    ...
    pub async fn send(self) -> ::std::result::Result<super::PutBucketAccelerateConfigurationOutput, super::PutBucketAccelerateConfigurationError> {
        let bucket =
            self.input.bucket.as_deref().ok_or_else(|| {
                super::PutBucketAccelerateConfigurationError::Unhandled("PutBucketAccelerateConfiguration requires bucket".to_owned())
            })?;
        let path = {
        ...
        let body = {
            ...
            if let Some(value) = self.input.accelerate_configuration.as_ref() {
