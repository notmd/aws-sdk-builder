...
impl ListObjects {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::operation::list_objects::ListObjectsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::list_objects::ListObjectsError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_objects::ListObjectsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_objects::ListObjectsOutput>()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListObjects")
            ...
            .with_retry_classifier(
                ::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::operation::list_objects::ListObjectsError>::builder()
                    .transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListObjectsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_objects::de_list_objects_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_objects::de_list_objects_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListObjectsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_objects::ListObjectsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_objects::ListObjectsInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::protocol_serde::shape_list_objects::ser_list_objects_headers(input, builder)?;
...
impl super::s3_request_id::RequestIdExt for super::operation::list_objects::ListObjectsError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::list_objects::ListObjectsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_objects::_list_objects_input::ListObjectsInput;

pub use super::operation::list_objects::_list_objects_output::ListObjectsOutput;
