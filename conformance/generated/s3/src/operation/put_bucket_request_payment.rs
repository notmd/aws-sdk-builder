...
impl PutBucketRequestPayment {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::put_bucket_request_payment::PutBucketRequestPaymentInput,
    ) -> ::std::result::Result<
        super::operation::put_bucket_request_payment::PutBucketRequestPaymentOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::put_bucket_request_payment::PutBucketRequestPaymentError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::put_bucket_request_payment::PutBucketRequestPaymentError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::put_bucket_request_payment::PutBucketRequestPaymentOutput>()
            ...
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                super::http_request_checksum::RequestChecksumInterceptor::new(
                    |input: &::aws_smithy_runtime_api::client::interceptors::context::Input| {
                        let input: &super::operation::put_bucket_request_payment::PutBucketRequestPaymentInput =
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutBucketRequestPaymentResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_put_bucket_request_payment::de_put_bucket_request_payment_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_put_bucket_request_payment::de_put_bucket_request_payment_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutBucketRequestPaymentRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::put_bucket_request_payment::PutBucketRequestPaymentInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::put_bucket_request_payment::PutBucketRequestPaymentInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::protocol_serde::shape_put_bucket_request_payment::ser_put_bucket_request_payment_headers(input, builder)?;
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_put_bucket_request_payment_input::ser_request_payment_configuration_http_payload(
...
impl super::s3_request_id::RequestIdExt for super::operation::put_bucket_request_payment::PutBucketRequestPaymentError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::put_bucket_request_payment::PutBucketRequestPaymentError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::put_bucket_request_payment::_put_bucket_request_payment_input::PutBucketRequestPaymentInput;

pub use super::operation::put_bucket_request_payment::_put_bucket_request_payment_output::PutBucketRequestPaymentOutput;
