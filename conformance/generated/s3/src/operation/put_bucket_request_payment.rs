...
pub mod _put_bucket_request_payment_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/put_bucket_request_payment/_put_bucket_request_payment_input.rs"
    ));
}
...
pub mod _put_bucket_request_payment_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/put_bucket_request_payment/_put_bucket_request_payment_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/put_bucket_request_payment/builders.rs"
    ));
}
