...
pub mod _write_get_object_response_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/write_get_object_response/_write_get_object_response_input.rs"
    ));
}
...
pub mod _write_get_object_response_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/write_get_object_response/_write_get_object_response_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/write_get_object_response/builders.rs"
    ));
}
