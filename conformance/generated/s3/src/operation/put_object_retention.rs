...
pub mod _put_object_retention_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/put_object_retention/_put_object_retention_input.rs"
    ));
}
...
pub mod _put_object_retention_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/put_object_retention/_put_object_retention_output.rs"
    ));
}
