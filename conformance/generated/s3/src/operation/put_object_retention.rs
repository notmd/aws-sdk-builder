...
impl PutObjectRetention {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::put_object_retention::PutObjectRetentionInput,
    ) -> ::std::result::Result<
        super::operation::put_object_retention::PutObjectRetentionOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::put_object_retention::PutObjectRetentionError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::put_object_retention::PutObjectRetentionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::put_object_retention::PutObjectRetentionOutput>()
...
.with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(super::http_request_checksum::RequestChecksumInterceptor::new(
                                |input: &::aws_smithy_runtime_api::client::interceptors::context::Input| {
                                    let input: &super::operation::put_object_retention::PutObjectRetentionInput = input.downcast_ref().expect("correct type");
                            ...
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<super::operation::put_object_retention::PutObjectRetentionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<super::operation::put_object_retention::PutObjectRetentionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::operation::put_object_retention::PutObjectRetentionError>::builder().transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutObjectRetentionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_put_object_retention::de_put_object_retention_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_put_object_retention::de_put_object_retention_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutObjectRetentionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::put_object_retention::PutObjectRetentionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::put_object_retention::PutObjectRetentionInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::protocol_serde::shape_put_object_retention::ser_put_object_retention_headers(input, builder)?;
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_put_object_retention_input::ser_retention_http_payload(
            &input.retention,
        )?);
...
impl super::s3_request_id::RequestIdExt for super::operation::put_object_retention::PutObjectRetentionError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::put_object_retention::PutObjectRetentionError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::put_object_retention::_put_object_retention_input::PutObjectRetentionInput;

pub use super::operation::put_object_retention::_put_object_retention_output::PutObjectRetentionOutput;
