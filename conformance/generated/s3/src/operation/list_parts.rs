    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_parts::ListPartsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_parts::ListPartsOutput>()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListParts")
            ...
            .with_retry_classifier(
                ::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::operation::list_parts::ListPartsError>::builder()
                    .transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListPartsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_parts::de_list_parts_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_parts::de_list_parts_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListPartsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::list_parts::ListPartsInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_parts::ListPartsInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::protocol_serde::shape_list_parts::ser_list_parts_headers(input, builder)?;
...
impl super::s3_request_id::RequestIdExt for super::operation::list_parts::ListPartsError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::list_parts::ListPartsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_parts::_list_parts_input::ListPartsInput;

pub use super::operation::list_parts::_list_parts_output::ListPartsOutput;
