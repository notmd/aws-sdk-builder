...
pub mod _delete_bucket_encryption_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/delete_bucket_encryption/_delete_bucket_encryption_input.rs"
    ));
}
...
pub mod _delete_bucket_encryption_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/delete_bucket_encryption/_delete_bucket_encryption_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/delete_bucket_encryption/builders.rs"
    ));
}
