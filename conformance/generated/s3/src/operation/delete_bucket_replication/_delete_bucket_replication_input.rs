...
impl DeleteBucketReplicationInput {
    pub fn builder() -> DeleteBucketReplicationInputBuilder { DeleteBucketReplicationInputBuilder::default() }
}
#[derive(Clone, Debug, Default)]
...
impl DeleteBucketReplicationInputBuilder {
    ...
    pub fn build(self) -> DeleteBucketReplicationInput { DeleteBucketReplicationInput {
        bucket: self.bucket,
