...
impl GetObjectTorrent {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::get_object_torrent::GetObjectTorrentInput,
    ) -> ::std::result::Result<
        super::operation::get_object_torrent::GetObjectTorrentOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::get_object_torrent::GetObjectTorrentError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_object_torrent::GetObjectTorrentError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_object_torrent::GetObjectTorrentOutput>()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetObjectTorrent")
            ...
            .with_retry_classifier(
                ::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::operation::get_object_torrent::GetObjectTorrentError>::builder()
                    .transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetObjectTorrentResponseDeserializer {
    fn deserialize_streaming(
        ...
        ::std::option::Option::Some(super::protocol_serde::type_erase_result(
            super::protocol_serde::shape_get_object_torrent::de_get_object_torrent_http_response(response),
        ))
    }
    ...
    fn deserialize_nonstreaming_with_config(
        ...
        super::protocol_serde::type_erase_result(super::protocol_serde::shape_get_object_torrent::de_get_object_torrent_http_error(
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetObjectTorrentRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_object_torrent::GetObjectTorrentInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_object_torrent::GetObjectTorrentInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::protocol_serde::shape_get_object_torrent::ser_get_object_torrent_headers(input, builder)?;
...
impl super::s3_request_id::RequestIdExt for super::operation::get_object_torrent::GetObjectTorrentError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::get_object_torrent::GetObjectTorrentError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_object_torrent::_get_object_torrent_input::GetObjectTorrentInput;

pub use super::operation::get_object_torrent::_get_object_torrent_output::GetObjectTorrentOutput;
