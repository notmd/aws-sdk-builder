...
pub mod _get_object_torrent_input {
    include!(concat!(env!("OUT_DIR"), "/generated/s3/src/operation/get_object_torrent/_get_object_torrent_input.rs"));
}
pub use _get_object_torrent_input::GetObjectTorrentInput;
pub type Input = GetObjectTorrentInput;
pub mod _get_object_torrent_output {
    include!(concat!(env!("OUT_DIR"), "/generated/s3/src/operation/get_object_torrent/_get_object_torrent_output.rs"));
}
pub use _get_object_torrent_output::GetObjectTorrentOutput;
pub type Output = GetObjectTorrentOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/s3/src/operation/get_object_torrent/builders.rs"));
}
