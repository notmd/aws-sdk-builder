...
impl GetBucketVersioningInput {
    ...
    pub fn builder() -> super::operation::get_bucket_versioning::builders::GetBucketVersioningInputBuilder {
        super::operation::get_bucket_versioning::builders::GetBucketVersioningInputBuilder::default()
    }
}
...
impl GetBucketVersioningInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_bucket_versioning::GetBucketVersioningInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::get_bucket_versioning::GetBucketVersioningInput {
            bucket: self.bucket,
