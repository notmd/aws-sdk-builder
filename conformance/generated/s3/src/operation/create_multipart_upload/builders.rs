...
impl Builder {
    ...
    pub async fn send(self) -> ::std::result::Result<super::CreateMultipartUploadOutput, super::CreateMultipartUploadError> {
        ...
        let path = {
            let mut path = ::std::string::String::from("/{Bucket}/{Key+}?uploads");
        ...
        let response = self
            ...
            .await
            .map_err(super::CreateMultipartUploadError::Unhandled)?;
        let status = response.status();
        if !status.is_success() {
            return Err(super::CreateMultipartUploadError::unhandled_with_request_ids(
                format!("CreateMultipartUpload returned HTTP {}", status),
