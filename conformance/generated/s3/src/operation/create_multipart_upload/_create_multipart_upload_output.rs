...
impl super::s3_request_id::RequestIdExt for CreateMultipartUploadOutput {
...
impl CreateMultipartUploadOutput {
    ...
    pub fn builder() -> super::operation::create_multipart_upload::builders::CreateMultipartUploadOutputBuilder {
        super::operation::create_multipart_upload::builders::CreateMultipartUploadOutputBuilder::default()
    }
}
...
impl CreateMultipartUploadOutputBuilder {
    ...
    pub fn build(self) -> super::operation::create_multipart_upload::CreateMultipartUploadOutput {
