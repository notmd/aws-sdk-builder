...
impl ListMultipartUploadsInput {
    ...
    pub fn builder() -> super::operation::list_multipart_uploads::builders::ListMultipartUploadsInputBuilder {
        super::operation::list_multipart_uploads::builders::ListMultipartUploadsInputBuilder::default()
    }
}
...
impl ListMultipartUploadsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_multipart_uploads::ListMultipartUploadsInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::list_multipart_uploads::ListMultipartUploadsInput {
            bucket: self.bucket,
