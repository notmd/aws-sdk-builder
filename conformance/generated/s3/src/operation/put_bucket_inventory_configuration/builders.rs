...
pub struct Builder {
    input: super::_put_bucket_inventory_configuration_input::PutBucketInventoryConfigurationInputBuilder,
...
impl Builder {
    ...
    pub fn inventory_configuration(mut self, value: impl ::std::convert::Into<crate::types::InventoryConfiguration>) -> Self {
        self.input = self.input.set_inventory_configuration(Some(value.into()));
        self
    }
    ...
    pub async fn send(self) -> ::std::result::Result<super::PutBucketInventoryConfigurationOutput, super::PutBucketInventoryConfigurationError> {
        let input = self
            .input
            .build()
            .map_err(|error| super::PutBucketInventoryConfigurationError::Unhandled(error.to_string()))?;
        let bucket = input
            .bucket
            .as_deref()
            .ok_or_else(|| super::PutBucketInventoryConfigurationError::Unhandled("PutBucketInventoryConfiguration requires bucket".to_owned()))?;
        let path = {
        ...
        let body = {
            ...
            if let Some(value) = input.inventory_configuration.as_ref() {
