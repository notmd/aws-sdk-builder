...
impl super::s3_request_id::RequestIdExt for PutBucketLoggingOutput {
...
impl PutBucketLoggingOutput {
    ...
    pub fn builder() -> super::operation::put_bucket_logging::builders::PutBucketLoggingOutputBuilder {
        super::operation::put_bucket_logging::builders::PutBucketLoggingOutputBuilder::default()
    }
}
...
impl PutBucketLoggingOutputBuilder {
    ...
    pub fn build(self) -> super::operation::put_bucket_logging::PutBucketLoggingOutput {
