...
pub use super::operation::put_bucket_logging::_put_bucket_logging_input::PutBucketLoggingInputBuilder;

pub use super::operation::put_bucket_logging::_put_bucket_logging_output::PutBucketLoggingOutputBuilder;

impl super::operation::put_bucket_logging::builders::PutBucketLoggingInputBuilder {
...
pub struct PutBucketLoggingFluentBuilder {
    ...
    inner: super::operation::put_bucket_logging::builders::PutBucketLoggingInputBuilder,
...
impl PutBucketLoggingFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::put_bucket_logging::builders::PutBucketLoggingInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::put_bucket_logging::PutBucketLogging::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::put_bucket_logging::PutBucketLogging::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn bucket_logging_status(mut self, input: super::types::BucketLoggingStatus) -> Self {
        self.inner = self.inner.bucket_logging_status(input);
        self
    }
    /// <p>Container for logging status information.</p>
    pub fn set_bucket_logging_status(mut self, input: ::std::option::Option<super::types::BucketLoggingStatus>) -> Self {
        self.inner = self.inner.set_bucket_logging_status(input);
        self
    }
    /// <p>Container for logging status information.</p>
    pub fn get_bucket_logging_status(&self) -> &::std::option::Option<super::types::BucketLoggingStatus> {
