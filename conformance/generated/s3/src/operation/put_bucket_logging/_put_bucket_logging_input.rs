...
pub struct PutBucketLoggingInput {
    ...
    pub bucket_logging_status: ::std::option::Option<super::types::BucketLoggingStatus>,
...
impl PutBucketLoggingInput {
    ...
    /// <p>Container for logging status information.</p>
    pub fn bucket_logging_status(&self) -> ::std::option::Option<&super::types::BucketLoggingStatus> {
...
impl PutBucketLoggingInput {
    ...
    pub fn builder() -> super::operation::put_bucket_logging::builders::PutBucketLoggingInputBuilder {
        super::operation::put_bucket_logging::builders::PutBucketLoggingInputBuilder::default()
    }
}
...
pub struct PutBucketLoggingInputBuilder {
    ...
    pub(crate) bucket_logging_status: ::std::option::Option<super::types::BucketLoggingStatus>,
...
impl PutBucketLoggingInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::put_bucket_logging::PutBucketLoggingInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::put_bucket_logging::PutBucketLoggingInput {
            bucket: self.bucket,
