...
impl PutPublicAccessBlock {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::put_public_access_block::PutPublicAccessBlockInput,
    ) -> ::std::result::Result<
        super::operation::put_public_access_block::PutPublicAccessBlockOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::put_public_access_block::PutPublicAccessBlockError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::put_public_access_block::PutPublicAccessBlockError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::put_public_access_block::PutPublicAccessBlockOutput>()
...
.with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(super::http_request_checksum::RequestChecksumInterceptor::new(
                                |input: &::aws_smithy_runtime_api::client::interceptors::context::Input| {
                                    let input: &super::operation::put_public_access_block::PutPublicAccessBlockInput = input.downcast_ref().expect("correct type");
                            ...
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<super::operation::put_public_access_block::PutPublicAccessBlockError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<super::operation::put_public_access_block::PutPublicAccessBlockError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::operation::put_public_access_block::PutPublicAccessBlockError>::builder().transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutPublicAccessBlockResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_put_public_access_block::de_put_public_access_block_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_put_public_access_block::de_put_public_access_block_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutPublicAccessBlockRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::put_public_access_block::PutPublicAccessBlockInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::put_public_access_block::PutPublicAccessBlockInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::protocol_serde::shape_put_public_access_block::ser_put_public_access_block_headers(input, builder)?;
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_put_public_access_block_input::ser_public_access_block_configuration_http_payload(
...
impl super::s3_request_id::RequestIdExt for super::operation::put_public_access_block::PutPublicAccessBlockError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::put_public_access_block::PutPublicAccessBlockError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::put_public_access_block::_put_public_access_block_input::PutPublicAccessBlockInput;

pub use super::operation::put_public_access_block::_put_public_access_block_output::PutPublicAccessBlockOutput;
