...
impl super::s3_request_id::RequestIdExt for GetBucketIntelligentTieringConfigurationOutput {
...
impl GetBucketIntelligentTieringConfigurationOutput {
    ...
    pub fn builder() -> super::operation::get_bucket_intelligent_tiering_configuration::builders::GetBucketIntelligentTieringConfigurationOutputBuilder
    {
...
impl GetBucketIntelligentTieringConfigurationOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_bucket_intelligent_tiering_configuration::GetBucketIntelligentTieringConfigurationOutput {
