    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::head_bucket::HeadBucketError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::head_bucket::HeadBucketOutput>()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("HeadBucket")
            ...
            .with_retry_classifier(
                ::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::operation::head_bucket::HeadBucketError>::builder()
                    .transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for HeadBucketResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_head_bucket::de_head_bucket_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_head_bucket::de_head_bucket_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for HeadBucketRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::head_bucket::HeadBucketInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::head_bucket::HeadBucketInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::protocol_serde::shape_head_bucket::ser_head_bucket_headers(input, builder)?;
...
impl super::s3_request_id::RequestIdExt for super::operation::head_bucket::HeadBucketError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::head_bucket::HeadBucketError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::head_bucket::_head_bucket_input::HeadBucketInput;

pub use super::operation::head_bucket::_head_bucket_output::HeadBucketOutput;
