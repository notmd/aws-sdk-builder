...
impl super::s3_request_id::RequestIdExt for PutBucketLifecycleConfigurationOutput {
...
impl PutBucketLifecycleConfigurationOutput {
    ...
    pub fn builder() -> super::operation::put_bucket_lifecycle_configuration::builders::PutBucketLifecycleConfigurationOutputBuilder {
        super::operation::put_bucket_lifecycle_configuration::builders::PutBucketLifecycleConfigurationOutputBuilder::default()
    }
}
...
impl PutBucketLifecycleConfigurationOutputBuilder {
    ...
    pub fn build(self) -> super::operation::put_bucket_lifecycle_configuration::PutBucketLifecycleConfigurationOutput {
