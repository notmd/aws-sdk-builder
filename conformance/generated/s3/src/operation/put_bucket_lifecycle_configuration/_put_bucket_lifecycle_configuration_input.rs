...
pub struct PutBucketLifecycleConfigurationInput {
    ...
    pub lifecycle_configuration: ::std::option::Option<super::types::BucketLifecycleConfiguration>,
    ...
    pub transition_default_minimum_object_size: ::std::option::Option<super::types::TransitionDefaultMinimumObjectSize>,
}
impl PutBucketLifecycleConfigurationInput {
    ...
    /// <p>Container for lifecycle rules. You can add as many as 1,000 rules.</p>
    pub fn lifecycle_configuration(&self) -> ::std::option::Option<&super::types::BucketLifecycleConfiguration> {
    ...
    /// </ul>
    /// <p>To customize the minimum object size for any transition you can add a filter that specifies a custom <code>ObjectSizeGreaterThan</code> or <code>ObjectSizeLessThan</code> in the body of your transition rule. Custom filters always take precedence over the default transition behavior.</p>
    pub fn transition_default_minimum_object_size(&self) -> ::std::option::Option<&super::types::TransitionDefaultMinimumObjectSize> {
...
impl PutBucketLifecycleConfigurationInput {
    ...
    pub fn builder() -> super::operation::put_bucket_lifecycle_configuration::builders::PutBucketLifecycleConfigurationInputBuilder {
        super::operation::put_bucket_lifecycle_configuration::builders::PutBucketLifecycleConfigurationInputBuilder::default()
    }
}
...
pub struct PutBucketLifecycleConfigurationInputBuilder {
    ...
    pub(crate) lifecycle_configuration: ::std::option::Option<super::types::BucketLifecycleConfiguration>,
    pub(crate) expected_bucket_owner: ::std::option::Option<::std::string::String>,
    pub(crate) transition_default_minimum_object_size: ::std::option::Option<super::types::TransitionDefaultMinimumObjectSize>,
}
impl PutBucketLifecycleConfigurationInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::put_bucket_lifecycle_configuration::PutBucketLifecycleConfigurationInput,
