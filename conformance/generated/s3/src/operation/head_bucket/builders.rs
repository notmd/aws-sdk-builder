...
pub use super::operation::head_bucket::_head_bucket_input::HeadBucketInputBuilder;

pub use super::operation::head_bucket::_head_bucket_output::HeadBucketOutputBuilder;

impl super::operation::head_bucket::builders::HeadBucketInputBuilder {
...
impl HeadBucketFluentBuilder {
    ...
    > {
        ...
        super::operation::head_bucket::HeadBucket::orchestrate(&runtime_plugins, input).await
    }
