...
pub mod _get_bucket_location_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/get_bucket_location/_get_bucket_location_input.rs"
    ));
}
...
pub mod _get_bucket_location_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/get_bucket_location/_get_bucket_location_output.rs"
    ));
}
