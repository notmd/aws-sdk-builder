...
impl RestoreObjectInputBuilder {
    ...
    pub fn set_restore_request(mut self, input: ::std::option::Option<crate::types::RestoreRequest>) -> Self { self.restore_request = input; self }
    pub fn get_restore_request(&self) -> &::std::option::Option<crate::types::RestoreRequest> { &self.restore_request }
    ...
    pub fn build(self) -> crate::operation::restore_object::RestoreObjectInput {
