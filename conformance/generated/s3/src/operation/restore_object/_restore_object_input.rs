...
pub struct RestoreObjectInput {
    ...
    pub restore_request: ::std::option::Option<super::types::RestoreRequest>,
...
impl RestoreObjectInput {
    ...
    /// <p>Container for restore job parameters.</p>
    pub fn restore_request(&self) -> ::std::option::Option<&super::types::RestoreRequest> {
...
impl RestoreObjectInput {
    ...
    pub fn builder() -> super::operation::restore_object::builders::RestoreObjectInputBuilder {
        super::operation::restore_object::builders::RestoreObjectInputBuilder::default()
    }
}
...
pub struct RestoreObjectInputBuilder {
    ...
    pub(crate) restore_request: ::std::option::Option<super::types::RestoreRequest>,
...
impl RestoreObjectInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::restore_object::RestoreObjectInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::restore_object::RestoreObjectInput {
            bucket: self.bucket,
            key: self.key,
