...
impl ListBuckets {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::list_buckets::ListBucketsInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_buckets::ListBucketsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_buckets::ListBucketsOutput>()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListBuckets")
            ...
            .with_retry_classifier(
                ::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::operation::list_buckets::ListBucketsError>::builder()
                    .transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListBucketsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_buckets::de_list_buckets_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_buckets::de_list_buckets_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListBucketsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_buckets::ListBucketsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_buckets::ListBucketsInput,
...
impl super::s3_request_id::RequestIdExt for super::operation::list_buckets::ListBucketsError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::list_buckets::ListBucketsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_buckets::_list_buckets_input::ListBucketsInput;

pub use super::operation::list_buckets::_list_buckets_output::ListBucketsOutput;
