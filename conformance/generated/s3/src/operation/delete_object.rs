...
impl DeleteObject {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::delete_object::DeleteObjectInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_object::DeleteObjectOutput>()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteObject")
            ...
            .with_retry_classifier(
                ::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::operation::delete_object::DeleteObjectError>::builder()
                    .transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteObjectResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 204 || force_error {
            super::protocol_serde::shape_delete_object::de_delete_object_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_object::de_delete_object_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteObjectRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_object::DeleteObjectInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_object::DeleteObjectInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::protocol_serde::shape_delete_object::ser_delete_object_headers(input, builder)?;
...
impl super::s3_request_id::RequestIdExt for super::operation::delete_object::DeleteObjectError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::delete_object::DeleteObjectError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_object::_delete_object_input::DeleteObjectInput;

pub use super::operation::delete_object::_delete_object_output::DeleteObjectOutput;
