    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::abort_multipart_upload::AbortMultipartUploadError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::abort_multipart_upload::AbortMultipartUploadOutput>()
...
.with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(AbortMultipartUploadEndpointParamsInterceptor))
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<super::operation::abort_multipart_upload::AbortMultipartUploadError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<super::operation::abort_multipart_upload::AbortMultipartUploadError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::operation::abort_multipart_upload::AbortMultipartUploadError>::builder().transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AbortMultipartUploadResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 204 || force_error {
            super::protocol_serde::shape_abort_multipart_upload::de_abort_multipart_upload_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_abort_multipart_upload::de_abort_multipart_upload_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AbortMultipartUploadRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::abort_multipart_upload::AbortMultipartUploadInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::abort_multipart_upload::AbortMultipartUploadInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::protocol_serde::shape_abort_multipart_upload::ser_abort_multipart_upload_headers(input, builder)?;
...
impl super::s3_request_id::RequestIdExt for super::operation::abort_multipart_upload::AbortMultipartUploadError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::abort_multipart_upload::AbortMultipartUploadError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::abort_multipart_upload::_abort_multipart_upload_input::AbortMultipartUploadInput;

pub use super::operation::abort_multipart_upload::_abort_multipart_upload_output::AbortMultipartUploadOutput;
