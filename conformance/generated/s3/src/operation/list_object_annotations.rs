...
pub mod _list_object_annotations_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/list_object_annotations/_list_object_annotations_input.rs"
    ));
}
...
pub mod _list_object_annotations_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/list_object_annotations/_list_object_annotations_output.rs"
    ));
}
