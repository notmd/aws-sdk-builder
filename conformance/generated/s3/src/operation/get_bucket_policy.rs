// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        pub type GetBucketPolicyInput = Input;
        pub type GetBucketPolicyOutput = Output;
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::GetBucketPolicyOutput, super::GetBucketPolicyError> {
                         let bucket = self.input.bucket.as_deref().ok_or_else(|| super::GetBucketPolicyError::Unhandled("GetBucketPolicy requires bucket".to_owned()))?;
                         ...
                         Ok(super::GetBucketPolicyOutput::default())
                     }
                 }
}
