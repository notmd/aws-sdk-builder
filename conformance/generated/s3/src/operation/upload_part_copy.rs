...
impl UploadPartCopy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::upload_part_copy::UploadPartCopyInput,
    ) -> ::std::result::Result<
        super::operation::upload_part_copy::UploadPartCopyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::upload_part_copy::UploadPartCopyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::upload_part_copy::UploadPartCopyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::upload_part_copy::UploadPartCopyOutput>()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UploadPartCopy")
            ...
            .with_retry_classifier(
                ::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::operation::upload_part_copy::UploadPartCopyError>::builder()
                    .transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UploadPartCopyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_upload_part_copy::de_upload_part_copy_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_upload_part_copy::de_upload_part_copy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UploadPartCopyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::upload_part_copy::UploadPartCopyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::upload_part_copy::UploadPartCopyInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::protocol_serde::shape_upload_part_copy::ser_upload_part_copy_headers(input, builder)?;
...
impl super::s3_request_id::RequestIdExt for super::operation::upload_part_copy::UploadPartCopyError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::upload_part_copy::UploadPartCopyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::upload_part_copy::_upload_part_copy_input::UploadPartCopyInput;

pub use super::operation::upload_part_copy::_upload_part_copy_output::UploadPartCopyOutput;
