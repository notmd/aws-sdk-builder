...
pub struct CreateBucketMetadataTableConfigurationInput {
    ...
    pub metadata_table_configuration: ::std::option::Option<super::types::MetadataTableConfiguration>,
...
impl CreateBucketMetadataTableConfigurationInput {
    ...
    /// <p>The contents of your metadata table configuration.</p>
    pub fn metadata_table_configuration(&self) -> ::std::option::Option<&super::types::MetadataTableConfiguration> {
...
impl CreateBucketMetadataTableConfigurationInput {
    ...
    pub fn builder() -> super::operation::create_bucket_metadata_table_configuration::builders::CreateBucketMetadataTableConfigurationInputBuilder {
        super::operation::create_bucket_metadata_table_configuration::builders::CreateBucketMetadataTableConfigurationInputBuilder::default()
    }
}
...
pub struct CreateBucketMetadataTableConfigurationInputBuilder {
    ...
    pub(crate) metadata_table_configuration: ::std::option::Option<super::types::MetadataTableConfiguration>,
...
impl CreateBucketMetadataTableConfigurationInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::create_bucket_metadata_table_configuration::CreateBucketMetadataTableConfigurationInput,
