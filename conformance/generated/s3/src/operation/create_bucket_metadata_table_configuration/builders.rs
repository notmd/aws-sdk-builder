...
pub use super::operation::create_bucket_metadata_table_configuration::_create_bucket_metadata_table_configuration_input::CreateBucketMetadataTableConfigurationInputBuilder;

pub use super::operation::create_bucket_metadata_table_configuration::_create_bucket_metadata_table_configuration_output::CreateBucketMetadataTableConfigurationOutputBuilder;

impl super::operation::create_bucket_metadata_table_configuration::builders::CreateBucketMetadataTableConfigurationInputBuilder {
...
pub struct CreateBucketMetadataTableConfigurationFluentBuilder {
    ...
    inner: super::operation::create_bucket_metadata_table_configuration::builders::CreateBucketMetadataTableConfigurationInputBuilder,
...
impl CreateBucketMetadataTableConfigurationFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &super::operation::create_bucket_metadata_table_configuration::builders::CreateBucketMetadataTableConfigurationInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            super::operation::create_bucket_metadata_table_configuration::CreateBucketMetadataTableConfiguration::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        super::operation::create_bucket_metadata_table_configuration::CreateBucketMetadataTableConfiguration::orchestrate(&runtime_plugins, input)
            .await
    }
    ...
    pub fn metadata_table_configuration(mut self, input: super::types::MetadataTableConfiguration) -> Self {
        self.inner = self.inner.metadata_table_configuration(input);
        self
    }
    /// <p>The contents of your metadata table configuration.</p>
    pub fn set_metadata_table_configuration(mut self, input: ::std::option::Option<super::types::MetadataTableConfiguration>) -> Self {
        self.inner = self.inner.set_metadata_table_configuration(input);
        self
    }
    /// <p>The contents of your metadata table configuration.</p>
    pub fn get_metadata_table_configuration(&self) -> &::std::option::Option<super::types::MetadataTableConfiguration> {
