...
impl GetBucketTaggingInput {
    ...
    pub fn builder() -> super::operation::get_bucket_tagging::builders::GetBucketTaggingInputBuilder {
        super::operation::get_bucket_tagging::builders::GetBucketTaggingInputBuilder::default()
    }
}
...
impl GetBucketTaggingInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_bucket_tagging::GetBucketTaggingInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_bucket_tagging::GetBucketTaggingInput {
            bucket: self.bucket,
