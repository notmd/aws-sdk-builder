...
impl super::s3_request_id::RequestIdExt for GetObjectRetentionOutput {
...
impl GetObjectRetentionOutput {
    ...
    pub fn builder() -> super::operation::get_object_retention::builders::GetObjectRetentionOutputBuilder {
        super::operation::get_object_retention::builders::GetObjectRetentionOutputBuilder::default()
    }
}
...
impl GetObjectRetentionOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_object_retention::GetObjectRetentionOutput {
