...
impl GetObjectRetentionInput {
    ...
    pub fn builder() -> super::operation::get_object_retention::builders::GetObjectRetentionInputBuilder {
        super::operation::get_object_retention::builders::GetObjectRetentionInputBuilder::default()
    }
}
...
impl GetObjectRetentionInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_object_retention::GetObjectRetentionInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::get_object_retention::GetObjectRetentionInput {
            bucket: self.bucket,
            key: self.key,
