    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_object_attributes::GetObjectAttributesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_object_attributes::GetObjectAttributesOutput>()
...
.with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(GetObjectAttributesEndpointParamsInterceptor))
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<super::operation::get_object_attributes::GetObjectAttributesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<super::operation::get_object_attributes::GetObjectAttributesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::operation::get_object_attributes::GetObjectAttributesError>::builder().transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetObjectAttributesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_object_attributes::de_get_object_attributes_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_object_attributes::de_get_object_attributes_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetObjectAttributesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_object_attributes::GetObjectAttributesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_object_attributes::GetObjectAttributesInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::protocol_serde::shape_get_object_attributes::ser_get_object_attributes_headers(input, builder)?;
...
impl super::s3_request_id::RequestIdExt for super::operation::get_object_attributes::GetObjectAttributesError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::get_object_attributes::GetObjectAttributesError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_object_attributes::_get_object_attributes_input::GetObjectAttributesInput;

pub use super::operation::get_object_attributes::_get_object_attributes_output::GetObjectAttributesOutput;
