...
pub mod _put_bucket_intelligent_tiering_configuration_input {
    include!(concat!(env!("OUT_DIR"), "/generated/s3/src/operation/put_bucket_intelligent_tiering_configuration/_put_bucket_intelligent_tiering_configuration_input.rs"));
}
pub use _put_bucket_intelligent_tiering_configuration_input::PutBucketIntelligentTieringConfigurationInput;
pub type Input = PutBucketIntelligentTieringConfigurationInput;
pub mod _put_bucket_intelligent_tiering_configuration_output {
    include!(concat!(env!("OUT_DIR"), "/generated/s3/src/operation/put_bucket_intelligent_tiering_configuration/_put_bucket_intelligent_tiering_configuration_output.rs"));
}
pub use _put_bucket_intelligent_tiering_configuration_output::PutBucketIntelligentTieringConfigurationOutput;
pub type Output = PutBucketIntelligentTieringConfigurationOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/s3/src/operation/put_bucket_intelligent_tiering_configuration/builders.rs"));
}
