...
impl GetObjectLockConfiguration {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::get_object_lock_configuration::GetObjectLockConfigurationInput,
    ) -> ::std::result::Result<
        super::operation::get_object_lock_configuration::GetObjectLockConfigurationOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::get_object_lock_configuration::GetObjectLockConfigurationError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_object_lock_configuration::GetObjectLockConfigurationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_object_lock_configuration::GetObjectLockConfigurationOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetObjectLockConfigurationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_object_lock_configuration::de_get_object_lock_configuration_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_object_lock_configuration::de_get_object_lock_configuration_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetObjectLockConfigurationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_object_lock_configuration::GetObjectLockConfigurationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_object_lock_configuration::GetObjectLockConfigurationInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::protocol_serde::shape_get_object_lock_configuration::ser_get_object_lock_configuration_headers(input, builder)?;
...
impl super::s3_request_id::RequestIdExt for super::operation::get_object_lock_configuration::GetObjectLockConfigurationError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::get_object_lock_configuration::GetObjectLockConfigurationError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_object_lock_configuration::_get_object_lock_configuration_input::GetObjectLockConfigurationInput;

pub use super::operation::get_object_lock_configuration::_get_object_lock_configuration_output::GetObjectLockConfigurationOutput;
