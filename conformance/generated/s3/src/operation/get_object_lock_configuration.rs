// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        pub type GetObjectLockConfigurationInput = Input;
        pub type GetObjectLockConfigurationOutput = Output;
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::GetObjectLockConfigurationOutput, super::GetObjectLockConfigurationError> {
                         let bucket = self.input.bucket.as_deref().ok_or_else(|| super::GetObjectLockConfigurationError::Unhandled("GetObjectLockConfiguration requires bucket".to_owned()))?;
                         ...
                         Ok(super::GetObjectLockConfigurationOutput::default())
                     }
                 }
}
