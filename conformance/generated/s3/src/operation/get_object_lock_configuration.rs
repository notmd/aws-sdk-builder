...
pub mod _get_object_lock_configuration_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/get_object_lock_configuration/_get_object_lock_configuration_input.rs"
    ));
}
...
pub mod _get_object_lock_configuration_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/get_object_lock_configuration/_get_object_lock_configuration_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/get_object_lock_configuration/builders.rs"
    ));
}
