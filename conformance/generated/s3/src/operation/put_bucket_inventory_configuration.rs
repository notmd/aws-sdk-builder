// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        impl PutBucketInventoryConfiguration { pub fn new() -> Self { Self } }
        #[derive(Clone, Debug, Default)]
        pub struct Input {
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output;
        pub type PutBucketInventoryConfigurationInput = Input;
        pub type PutBucketInventoryConfigurationOutput = Output;
        pub type PutBucketInventoryConfigurationError = Error;
        #[derive(Clone, Debug)]
        pub enum Error {
...
pub use builders::Builder;
        pub type PutBucketInventoryConfigurationFluentBuilder = builders::Builder;
