...
pub mod _put_bucket_inventory_configuration_input {
    include!(concat!(env!("OUT_DIR"), "/generated/s3/src/operation/put_bucket_inventory_configuration/_put_bucket_inventory_configuration_input.rs"));
}
pub use _put_bucket_inventory_configuration_input::PutBucketInventoryConfigurationInput;
pub type Input = PutBucketInventoryConfigurationInput;
pub mod _put_bucket_inventory_configuration_output {
    include!(concat!(env!("OUT_DIR"), "/generated/s3/src/operation/put_bucket_inventory_configuration/_put_bucket_inventory_configuration_output.rs"));
}
pub use _put_bucket_inventory_configuration_output::PutBucketInventoryConfigurationOutput;
pub type Output = PutBucketInventoryConfigurationOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/s3/src/operation/put_bucket_inventory_configuration/builders.rs"));
}
