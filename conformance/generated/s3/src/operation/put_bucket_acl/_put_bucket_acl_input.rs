...
impl PutBucketAclInput {
    ...
    pub fn builder() -> super::operation::put_bucket_acl::builders::PutBucketAclInputBuilder {
        super::operation::put_bucket_acl::builders::PutBucketAclInputBuilder::default()
    }
}
...
impl PutBucketAclInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::put_bucket_acl::PutBucketAclInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::put_bucket_acl::PutBucketAclInput {
            acl: self.acl,
