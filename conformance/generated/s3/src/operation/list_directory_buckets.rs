...
pub mod _list_directory_buckets_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/list_directory_buckets/_list_directory_buckets_input.rs"
    ));
}
...
pub mod _list_directory_buckets_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/list_directory_buckets/_list_directory_buckets_output.rs"
    ));
}
