...
impl GetObjectLockConfigurationInput {
    pub fn builder() -> GetObjectLockConfigurationInputBuilder { GetObjectLockConfigurationInputBuilder::default() }
}
#[derive(Clone, Debug, Default)]
...
impl GetObjectLockConfigurationInputBuilder {
    ...
    pub fn build(self) -> GetObjectLockConfigurationInput { GetObjectLockConfigurationInput {
        bucket: self.bucket,
