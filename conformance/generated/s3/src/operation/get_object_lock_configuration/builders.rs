...
impl Builder {
    ...
    pub fn build(self) -> super::Input { self.input }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::GetObjectLockConfigurationOutput, super::GetObjectLockConfigurationError> {
                         ...
                         let mut output = super::GetObjectLockConfigurationOutput::default();
                         let body = response.text().await.map_err(super::GetObjectLockConfigurationError::Unhandled)?;
                         if let Some(value) = super::super::super::transport::xml_first(&body, "ObjectLockConfiguration") { let mut item: super::super::super::types::ObjectLockConfiguration = ::std::default::Default::default(); item; output.object_lock_configuration = Some(item); }
                         Ok(output)
                     }
}
