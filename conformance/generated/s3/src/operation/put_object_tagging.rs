...
impl PutObjectTagging {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::operation::put_object_tagging::PutObjectTaggingOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::put_object_tagging::PutObjectTaggingError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::put_object_tagging::PutObjectTaggingError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::put_object_tagging::PutObjectTaggingOutput>()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutObjectTagging")
            ...
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                super::http_request_checksum::RequestChecksumInterceptor::new(
                    |input: &::aws_smithy_runtime_api::client::interceptors::context::Input| {
                        let input: &super::operation::put_object_tagging::PutObjectTaggingInput = input.downcast_ref().expect("correct type");
            ...
            .with_retry_classifier(
                ::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::operation::put_object_tagging::PutObjectTaggingError>::builder()
                    .transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutObjectTaggingResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_put_object_tagging::de_put_object_tagging_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_put_object_tagging::de_put_object_tagging_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutObjectTaggingRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::put_object_tagging::PutObjectTaggingInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::put_object_tagging::PutObjectTaggingInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::protocol_serde::shape_put_object_tagging::ser_put_object_tagging_headers(input, builder)?;
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_put_object_tagging_input::ser_tagging_http_payload(
            &input.tagging,
        )?);
...
impl super::s3_request_id::RequestIdExt for super::operation::put_object_tagging::PutObjectTaggingError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::put_object_tagging::PutObjectTaggingError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::put_object_tagging::_put_object_tagging_input::PutObjectTaggingInput;

pub use super::operation::put_object_tagging::_put_object_tagging_output::PutObjectTaggingOutput;
