...
pub struct Builder {
    input: super::_delete_bucket_metrics_configuration_input::DeleteBucketMetricsConfigurationInputBuilder,
...
impl Builder {
    ...
    pub async fn send(self) -> ::std::result::Result<super::DeleteBucketMetricsConfigurationOutput, super::DeleteBucketMetricsConfigurationError> {
        let input = self
            .input
            .build()
            .map_err(|error| super::DeleteBucketMetricsConfigurationError::Unhandled(error.to_string()))?;
        let bucket = input
            .bucket
            .as_deref()
            .ok_or_else(|| super::DeleteBucketMetricsConfigurationError::Unhandled("DeleteBucketMetricsConfiguration requires bucket".to_owned()))?;
        let path = {
        ...
        let response = self
            ...
            .await
            .map_err(super::DeleteBucketMetricsConfigurationError::Unhandled)?;
        let status = response.status();
        if !status.is_success() {
            return Err(super::DeleteBucketMetricsConfigurationError::unhandled_with_request_ids(
                format!("DeleteBucketMetricsConfiguration returned HTTP {}", status),
