...
impl GetObjectAcl {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::get_object_acl::GetObjectAclInput,
    ) -> ::std::result::Result<
        super::operation::get_object_acl::GetObjectAclOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::get_object_acl::GetObjectAclError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_object_acl::GetObjectAclError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_object_acl::GetObjectAclOutput>()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetObjectAcl")
            ...
            .with_retry_classifier(
                ::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::operation::get_object_acl::GetObjectAclError>::builder()
                    .transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetObjectAclResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_object_acl::de_get_object_acl_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_object_acl::de_get_object_acl_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetObjectAclRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_object_acl::GetObjectAclInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_object_acl::GetObjectAclInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::protocol_serde::shape_get_object_acl::ser_get_object_acl_headers(input, builder)?;
...
impl super::s3_request_id::RequestIdExt for super::operation::get_object_acl::GetObjectAclError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::get_object_acl::GetObjectAclError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_object_acl::_get_object_acl_input::GetObjectAclInput;

pub use super::operation::get_object_acl::_get_object_acl_output::GetObjectAclOutput;
