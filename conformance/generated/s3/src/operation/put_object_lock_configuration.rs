...
pub mod _put_object_lock_configuration_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/put_object_lock_configuration/_put_object_lock_configuration_input.rs"
    ));
}
...
pub mod _put_object_lock_configuration_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/put_object_lock_configuration/_put_object_lock_configuration_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/put_object_lock_configuration/builders.rs"
    ));
}
