...
impl ListBucketsInput {
    ...
    pub fn builder() -> super::operation::list_buckets::builders::ListBucketsInputBuilder {
        super::operation::list_buckets::builders::ListBucketsInputBuilder::default()
    }
}
...
impl ListBucketsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::list_buckets::ListBucketsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_buckets::ListBucketsInput {
