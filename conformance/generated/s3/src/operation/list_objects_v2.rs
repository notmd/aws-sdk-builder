...
impl ListObjectsV2 {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::list_objects_v2::ListObjectsV2Input,
    ) -> ::std::result::Result<
        super::operation::list_objects_v2::ListObjectsV2Output,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::list_objects_v2::ListObjectsV2Error,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_objects_v2::ListObjectsV2Error>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_objects_v2::ListObjectsV2Output>()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListObjectsV2")
            ...
            .with_retry_classifier(
                ::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::operation::list_objects_v2::ListObjectsV2Error>::builder()
                    .transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListObjectsV2ResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_objects_v2::de_list_objects_v2_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_objects_v2::de_list_objects_v2_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListObjectsV2RequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_objects_v2::ListObjectsV2Input>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_objects_v2::ListObjectsV2Input,
            ...
            fn update_http_builder(
                ...
                let builder = super::protocol_serde::shape_list_objects_v2::ser_list_objects_v2_headers(input, builder)?;
...
impl super::s3_request_id::RequestIdExt for super::operation::list_objects_v2::ListObjectsV2Error {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::list_objects_v2::ListObjectsV2Error {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_objects_v2::_list_objects_v2_input::ListObjectsV2Input;

pub use super::operation::list_objects_v2::_list_objects_v2_output::ListObjectsV2Output;
