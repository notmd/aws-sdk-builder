...
pub mod _delete_bucket_lifecycle_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/delete_bucket_lifecycle/_delete_bucket_lifecycle_input.rs"
    ));
}
...
pub mod _delete_bucket_lifecycle_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/delete_bucket_lifecycle/_delete_bucket_lifecycle_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/delete_bucket_lifecycle/builders.rs"
    ));
}
