...
impl UpdateObjectEncryption {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::update_object_encryption::UpdateObjectEncryptionInput,
    ) -> ::std::result::Result<
        super::operation::update_object_encryption::UpdateObjectEncryptionOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::update_object_encryption::UpdateObjectEncryptionError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::update_object_encryption::UpdateObjectEncryptionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::update_object_encryption::UpdateObjectEncryptionOutput>()
                ...
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                    super::http_request_checksum::RequestChecksumInterceptor::new(
                        |input: &::aws_smithy_runtime_api::client::interceptors::context::Input| {
                            let input: &super::operation::update_object_encryption::UpdateObjectEncryptionInput =
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateObjectEncryptionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_update_object_encryption::de_update_object_encryption_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_update_object_encryption::de_update_object_encryption_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateObjectEncryptionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::update_object_encryption::UpdateObjectEncryptionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::update_object_encryption::UpdateObjectEncryptionInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::protocol_serde::shape_update_object_encryption::ser_update_object_encryption_headers(input, builder)?;
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_update_object_encryption_input::ser_object_encryption_http_payload(&input.object_encryption)?,
        );
...
impl super::s3_request_id::RequestIdExt for super::operation::update_object_encryption::UpdateObjectEncryptionError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::update_object_encryption::UpdateObjectEncryptionError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::update_object_encryption::_update_object_encryption_input::UpdateObjectEncryptionInput;

pub use super::operation::update_object_encryption::_update_object_encryption_output::UpdateObjectEncryptionOutput;
