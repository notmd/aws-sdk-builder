...
pub struct CreateBucketMetadataConfigurationInput {
    ...
    pub metadata_configuration: ::std::option::Option<super::types::MetadataConfiguration>,
...
impl CreateBucketMetadataConfigurationInput {
    ...
    /// <p>The contents of your metadata configuration.</p>
    pub fn metadata_configuration(&self) -> ::std::option::Option<&super::types::MetadataConfiguration> {
...
impl CreateBucketMetadataConfigurationInput {
    ...
    pub fn builder() -> super::operation::create_bucket_metadata_configuration::builders::CreateBucketMetadataConfigurationInputBuilder {
        super::operation::create_bucket_metadata_configuration::builders::CreateBucketMetadataConfigurationInputBuilder::default()
    }
}
...
pub struct CreateBucketMetadataConfigurationInputBuilder {
    ...
    pub(crate) metadata_configuration: ::std::option::Option<super::types::MetadataConfiguration>,
...
impl CreateBucketMetadataConfigurationInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::create_bucket_metadata_configuration::CreateBucketMetadataConfigurationInput,
