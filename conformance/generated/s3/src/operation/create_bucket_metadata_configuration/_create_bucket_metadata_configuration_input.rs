...
impl CreateBucketMetadataConfigurationInputBuilder {
    ...
    pub fn set_metadata_configuration(mut self, input: ::std::option::Option<crate::types::MetadataConfiguration>) -> Self { self.metadata_configuration = input; self }
    /// <p>The contents of your metadata configuration.</p>
    pub fn get_metadata_configuration(&self) -> &::std::option::Option<crate::types::MetadataConfiguration> { &self.metadata_configuration }
    /// <p>The expected owner of the general purpose bucket that corresponds to your metadata configuration.</p>
    ...
    pub fn build(self) -> crate::operation::create_bucket_metadata_configuration::CreateBucketMetadataConfigurationInput {
