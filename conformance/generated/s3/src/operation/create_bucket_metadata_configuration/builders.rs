...
pub use super::operation::create_bucket_metadata_configuration::_create_bucket_metadata_configuration_input::CreateBucketMetadataConfigurationInputBuilder;

pub use super::operation::create_bucket_metadata_configuration::_create_bucket_metadata_configuration_output::CreateBucketMetadataConfigurationOutputBuilder;

impl super::operation::create_bucket_metadata_configuration::builders::CreateBucketMetadataConfigurationInputBuilder {
...
pub struct CreateBucketMetadataConfigurationFluentBuilder {
    ...
    inner: super::operation::create_bucket_metadata_configuration::builders::CreateBucketMetadataConfigurationInputBuilder,
...
impl CreateBucketMetadataConfigurationFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::create_bucket_metadata_configuration::builders::CreateBucketMetadataConfigurationInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::create_bucket_metadata_configuration::CreateBucketMetadataConfiguration::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::create_bucket_metadata_configuration::CreateBucketMetadataConfiguration::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn metadata_configuration(mut self, input: super::types::MetadataConfiguration) -> Self {
        self.inner = self.inner.metadata_configuration(input);
        self
    }
    /// <p>The contents of your metadata configuration.</p>
    pub fn set_metadata_configuration(mut self, input: ::std::option::Option<super::types::MetadataConfiguration>) -> Self {
        self.inner = self.inner.set_metadata_configuration(input);
        self
    }
    /// <p>The contents of your metadata configuration.</p>
    pub fn get_metadata_configuration(&self) -> &::std::option::Option<super::types::MetadataConfiguration> {
