...
impl super::s3_request_id::RequestIdExt for CreateBucketMetadataConfigurationOutput {
...
impl CreateBucketMetadataConfigurationOutput {
    ...
    pub fn builder() -> super::operation::create_bucket_metadata_configuration::builders::CreateBucketMetadataConfigurationOutputBuilder {
        super::operation::create_bucket_metadata_configuration::builders::CreateBucketMetadataConfigurationOutputBuilder::default()
    }
}
...
impl CreateBucketMetadataConfigurationOutputBuilder {
    ...
    pub fn build(self) -> super::operation::create_bucket_metadata_configuration::CreateBucketMetadataConfigurationOutput {
