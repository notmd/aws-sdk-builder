...
pub use super::operation::list_objects_v2::_list_objects_v2_input::ListObjectsV2InputBuilder;

pub use super::operation::list_objects_v2::_list_objects_v2_output::ListObjectsV2OutputBuilder;

impl super::operation::list_objects_v2::builders::ListObjectsV2InputBuilder {
...
pub struct ListObjectsV2FluentBuilder {
    ...
    inner: super::operation::list_objects_v2::builders::ListObjectsV2InputBuilder,
...
impl ListObjectsV2FluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::list_objects_v2::builders::ListObjectsV2InputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::list_objects_v2::ListObjectsV2::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::list_objects_v2::ListObjectsV2::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::operation::list_objects_v2::paginator::ListObjectsV2Paginator {
        super::operation::list_objects_v2::paginator::ListObjectsV2Paginator::new(self.handle, self.inner)
    }
