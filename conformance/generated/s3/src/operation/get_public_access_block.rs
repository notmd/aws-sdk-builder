...
pub mod _get_public_access_block_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/get_public_access_block/_get_public_access_block_input.rs"
    ));
}
...
pub mod _get_public_access_block_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/get_public_access_block/_get_public_access_block_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/get_public_access_block/builders.rs"
    ));
}
