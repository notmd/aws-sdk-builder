...
pub struct GetObjectAttributesInput {
    ...
    pub version_id: ::std::option::Option<super::super::super::types::ObjectVersionId>,
        ...
        impl GetObjectAttributesInput {
            ...
            pub fn object_attributes(&self) -> &[super::super::super::types::ObjectAttributes] { self.object_attributes.as_deref().unwrap_or(&[]) }
...
impl GetObjectAttributesInput {
    pub fn builder() -> GetObjectAttributesInputBuilder { GetObjectAttributesInputBuilder::default() }
}
#[derive(Clone, Debug, Default)]
...
impl GetObjectAttributesInputBuilder {
    ...
    pub fn build(self) -> GetObjectAttributesInput { GetObjectAttributesInput {
        bucket: self.bucket,
