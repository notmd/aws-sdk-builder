...
impl GetObjectAttributesInputBuilder {
    ...
    pub fn set_object_attributes(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::ObjectAttributes>>) -> Self { self.object_attributes = input; self }
    /// <p>Specifies the fields at the root level that you want returned in the response. Fields that you do not specify are not returned.</p>
    pub fn get_object_attributes(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::ObjectAttributes>> { &self.object_attributes }
    ...
    pub fn build(self) -> crate::operation::get_object_attributes::GetObjectAttributesInput {
