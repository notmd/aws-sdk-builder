...
pub mod _list_bucket_inventory_configurations_input {
    include!(concat!(env!("OUT_DIR"), "/generated/s3/src/operation/list_bucket_inventory_configurations/_list_bucket_inventory_configurations_input.rs"));
}
pub use _list_bucket_inventory_configurations_input::ListBucketInventoryConfigurationsInput;
pub type Input = ListBucketInventoryConfigurationsInput;
pub mod _list_bucket_inventory_configurations_output {
    include!(concat!(env!("OUT_DIR"), "/generated/s3/src/operation/list_bucket_inventory_configurations/_list_bucket_inventory_configurations_output.rs"));
}
pub use _list_bucket_inventory_configurations_output::ListBucketInventoryConfigurationsOutput;
pub type Output = ListBucketInventoryConfigurationsOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/s3/src/operation/list_bucket_inventory_configurations/builders.rs"));
}
