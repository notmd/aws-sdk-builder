...
impl Builder {
    ...
    pub fn website_configuration(mut self, value: impl ::std::convert::Into<super::super::super::types::WebsiteConfiguration>) -> Self { self.input.website_configuration = Some(value.into()); self }
    pub fn build(self) -> super::Input { self.input }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::PutBucketWebsiteOutput, super::PutBucketWebsiteError> {
                         ...
                         let body = { let mut body = ::std::string::String::new(); if let Some(value) = self.input.website_configuration.as_ref() { body.push_str("<WebsiteConfiguration>"); if let Some(value) = value.error_document.as_ref() { body.push_str("<ErrorDocument>"); if let Some(value) = value.key.as_ref() { body.push_str("<Key>"); body.push_str(&super::super::super::transport::xml_escape(&value.to_string())); body.push_str("</Key>"); } body.push_str("</ErrorDocument>"); } if let Some(value) = value.index_document.as_ref() { body.push_str("<IndexDocument>"); if let Some(value) = value.suffix.as_ref() { body.push_str("<Suffix>"); body.push_str(&super::super::super::transport::xml_escape(&value.to_string())); body.push_str("</Suffix>"); } body.push_str("</IndexDocument>"); } if let Some(value) = value.redirect_all_requests_to.as_ref() { body.push_str("<RedirectAllRequestsTo>"); if let Some(value) = value.host_name.as_ref() { body.push_str("<HostName>"); body.push_str(&super::super::super::transport::xml_escape(&value.to_string())); body.push_str("</HostName>"); } if let Some(value) = value.protocol.as_ref() { body.push_str("<Protocol>"); body.push_str(&super::super::super::transport::xml_escape(&value.to_string())); body.push_str("</Protocol>"); } body.push_str("</RedirectAllRequestsTo>"); } if let Some(value) = value.routing_rules.as_ref() { body.push_str("<RoutingRules>"); for item in value { body.push_str("<RoutingRule>"); if let Some(value) = item.condition.as_ref() { body.push_str("<Condition>"); if let Some(value) = value.http_error_code_returned_equals.as_ref() { body.push_str("<HttpErrorCodeReturnedEquals>"); body.push_str(&super::super::super::transport::xml_escape(&value.to_string())); body.push_str("</HttpErrorCodeReturnedEquals>"); } if let Some(value) = value.key_prefix_equals.as_ref() { body.push_str("<KeyPrefixEquals>"); body.push_str(&super::super::super::transport::xml_escape(&value.to_string())); body.push_str("</KeyPrefixEquals>"); } body.push_str("</Condition>"); } if let Some(value) = item.redirect.as_ref() { body.push_str("<Redirect>"); if let Some(value) = value.host_name.as_ref() { body.push_str("<HostName>"); body.push_str(&super::super::super::transport::xml_escape(&value.to_string())); body.push_str("</HostName>"); } if let Some(value) = value.http_redirect_code.as_ref() { body.push_str("<HttpRedirectCode>"); body.push_str(&super::super::super::transport::xml_escape(&value.to_string())); body.push_str("</HttpRedirectCode>"); } if let Some(value) = value.protocol.as_ref() { body.push_str("<Protocol>"); body.push_str(&super::super::super::transport::xml_escape(&value.to_string())); body.push_str("</Protocol>"); } if let Some(value) = value.replace_key_prefix_with.as_ref() { body.push_str("<ReplaceKeyPrefixWith>"); body.push_str(&super::super::super::transport::xml_escape(&value.to_string())); body.push_str("</ReplaceKeyPrefixWith>"); } if let Some(value) = value.replace_key_with.as_ref() { body.push_str("<ReplaceKeyWith>"); body.push_str(&super::super::super::transport::xml_escape(&value.to_string())); body.push_str("</ReplaceKeyWith>"); } body.push_str("</Redirect>"); } body.push_str("</RoutingRule>"); } body.push_str("</RoutingRules>"); } body.push_str("</WebsiteConfiguration>"); } body.into_bytes() };
