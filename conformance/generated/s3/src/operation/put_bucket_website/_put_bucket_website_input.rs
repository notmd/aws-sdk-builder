...
pub struct PutBucketWebsiteInput {
    ...
    pub website_configuration: ::std::option::Option<super::types::WebsiteConfiguration>,
...
impl PutBucketWebsiteInput {
    ...
    /// <p>Container for the request.</p>
    pub fn website_configuration(&self) -> ::std::option::Option<&super::types::WebsiteConfiguration> {
...
impl PutBucketWebsiteInput {
    ...
    pub fn builder() -> super::operation::put_bucket_website::builders::PutBucketWebsiteInputBuilder {
        super::operation::put_bucket_website::builders::PutBucketWebsiteInputBuilder::default()
    }
}
...
pub struct PutBucketWebsiteInputBuilder {
    ...
    pub(crate) website_configuration: ::std::option::Option<super::types::WebsiteConfiguration>,
...
impl PutBucketWebsiteInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::put_bucket_website::PutBucketWebsiteInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::put_bucket_website::PutBucketWebsiteInput {
            bucket: self.bucket,
