...
impl PutBucketWebsiteInputBuilder {
    ...
    pub fn set_website_configuration(mut self, input: ::std::option::Option<crate::types::WebsiteConfiguration>) -> Self { self.website_configuration = input; self }
    /// <p>Container for the request.</p>
    pub fn get_website_configuration(&self) -> &::std::option::Option<crate::types::WebsiteConfiguration> { &self.website_configuration }
    /// <p>The account ID of the expected bucket owner. If the account ID that you provide does not match the actual owner of the bucket, the request fails with the HTTP status code <code>403 Forbidden</code> (access denied).</p>
    ...
    pub fn build(self) -> crate::operation::put_bucket_website::PutBucketWebsiteInput {
