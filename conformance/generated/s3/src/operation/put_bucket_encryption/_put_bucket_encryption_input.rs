...
impl PutBucketEncryptionInput {
    ...
    pub fn builder() -> super::operation::put_bucket_encryption::builders::PutBucketEncryptionInputBuilder {
        super::operation::put_bucket_encryption::builders::PutBucketEncryptionInputBuilder::default()
    }
}
...
impl PutBucketEncryptionInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::put_bucket_encryption::PutBucketEncryptionInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::put_bucket_encryption::PutBucketEncryptionInput {
            bucket: self.bucket,
