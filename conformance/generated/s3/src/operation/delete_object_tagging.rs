// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        pub type DeleteObjectTaggingInput = Input;
        pub type DeleteObjectTaggingOutput = Output;
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::DeleteObjectTaggingOutput, super::DeleteObjectTaggingError> {
                         let bucket = self.input.bucket.as_deref().ok_or_else(|| super::DeleteObjectTaggingError::Unhandled("DeleteObjectTagging requires bucket".to_owned()))?;
                         let key = self.input.key.as_deref().ok_or_else(|| super::DeleteObjectTaggingError::Unhandled("DeleteObjectTagging requires key".to_owned()))?;
                         ...
                         let response = self.client.request(super::super::super::transport::Method::Delete, &path, &headers, &body).await.map_err(super::DeleteObjectTaggingError::Unhandled)?;
                         let status = response.status();
                         if !status.is_success() {
                             return Err(super::DeleteObjectTaggingError::Unhandled(format!("DeleteObjectTagging returned HTTP {}", status)));
                         }
                         let mut output = super::DeleteObjectTaggingOutput::default();
