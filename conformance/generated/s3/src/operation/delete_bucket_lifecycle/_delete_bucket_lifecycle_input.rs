...
impl DeleteBucketLifecycleInput {
    pub fn builder() -> DeleteBucketLifecycleInputBuilder { DeleteBucketLifecycleInputBuilder::default() }
}
#[derive(Clone, Debug, Default)]
...
impl DeleteBucketLifecycleInputBuilder {
    ...
    pub fn build(self) -> DeleteBucketLifecycleInput { DeleteBucketLifecycleInput {
        bucket: self.bucket,
