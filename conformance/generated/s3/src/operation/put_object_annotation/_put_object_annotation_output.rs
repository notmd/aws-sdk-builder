...
impl super::s3_request_id::RequestIdExt for PutObjectAnnotationOutput {
...
impl PutObjectAnnotationOutput {
    ...
    pub fn builder() -> super::operation::put_object_annotation::builders::PutObjectAnnotationOutputBuilder {
        super::operation::put_object_annotation::builders::PutObjectAnnotationOutputBuilder::default()
    }
}
...
impl PutObjectAnnotationOutputBuilder {
    ...
    pub fn build(self) -> super::operation::put_object_annotation::PutObjectAnnotationOutput {
