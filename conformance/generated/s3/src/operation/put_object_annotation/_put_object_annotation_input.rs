...
impl PutObjectAnnotationInput {
    ...
    pub fn builder() -> super::operation::put_object_annotation::builders::PutObjectAnnotationInputBuilder {
        super::operation::put_object_annotation::builders::PutObjectAnnotationInputBuilder::default()
    }
}
...
impl PutObjectAnnotationInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::put_object_annotation::PutObjectAnnotationInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::put_object_annotation::PutObjectAnnotationInput {
            bucket: self.bucket,
            key: self.key,
