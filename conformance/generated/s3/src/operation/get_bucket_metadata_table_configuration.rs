// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output {
            pub get_bucket_metadata_table_configuration_result: ::std::option::Option<super::super::types::GetBucketMetadataTableConfigurationResult>,
        }
        impl Output {
            pub fn get_bucket_metadata_table_configuration_result(&self) -> ::std::option::Option<&super::super::types::GetBucketMetadataTableConfigurationResult> { self.get_bucket_metadata_table_configuration_result.as_ref() }
        }
        pub type GetBucketMetadataTableConfigurationInput = Input;
        pub type GetBucketMetadataTableConfigurationOutput = Output;
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::GetBucketMetadataTableConfigurationOutput, super::GetBucketMetadataTableConfigurationError> {
                         ...
                         Ok(super::GetBucketMetadataTableConfigurationOutput::default())
                     }
                 }
}
