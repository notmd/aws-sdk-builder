...
impl PutBucketReplicationInput {
    ...
    pub fn builder() -> super::operation::put_bucket_replication::builders::PutBucketReplicationInputBuilder {
        super::operation::put_bucket_replication::builders::PutBucketReplicationInputBuilder::default()
    }
}
...
impl PutBucketReplicationInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::put_bucket_replication::PutBucketReplicationInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::put_bucket_replication::PutBucketReplicationInput {
            bucket: self.bucket,
