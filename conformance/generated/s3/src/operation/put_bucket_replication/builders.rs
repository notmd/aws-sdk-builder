...
pub use super::operation::put_bucket_replication::_put_bucket_replication_input::PutBucketReplicationInputBuilder;

pub use super::operation::put_bucket_replication::_put_bucket_replication_output::PutBucketReplicationOutputBuilder;

impl super::operation::put_bucket_replication::builders::PutBucketReplicationInputBuilder {
...
pub struct PutBucketReplicationFluentBuilder {
    ...
    inner: super::operation::put_bucket_replication::builders::PutBucketReplicationInputBuilder,
...
impl PutBucketReplicationFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::put_bucket_replication::builders::PutBucketReplicationInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::put_bucket_replication::PutBucketReplication::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::put_bucket_replication::PutBucketReplication::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn replication_configuration(mut self, input: super::types::ReplicationConfiguration) -> Self {
        self.inner = self.inner.replication_configuration(input);
        self
    }
    /// <p>A container for replication rules. You can add up to 1,000 rules. The maximum size of a replication configuration is 2 MB.</p>
    pub fn set_replication_configuration(mut self, input: ::std::option::Option<super::types::ReplicationConfiguration>) -> Self {
        self.inner = self.inner.set_replication_configuration(input);
        self
    }
    /// <p>A container for replication rules. You can add up to 1,000 rules. The maximum size of a replication configuration is 2 MB.</p>
    pub fn get_replication_configuration(&self) -> &::std::option::Option<super::types::ReplicationConfiguration> {
