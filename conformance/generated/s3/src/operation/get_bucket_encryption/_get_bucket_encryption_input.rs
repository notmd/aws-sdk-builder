...
impl GetBucketEncryptionInput {
    pub fn builder() -> GetBucketEncryptionInputBuilder { GetBucketEncryptionInputBuilder::default() }
}
#[derive(Clone, Debug, Default)]
...
impl GetBucketEncryptionInputBuilder {
    ...
    pub fn build(self) -> GetBucketEncryptionInput { GetBucketEncryptionInput {
        bucket: self.bucket,
