...
pub struct Builder {
    input: super::_put_bucket_cors_input::PutBucketCorsInputBuilder,
...
impl Builder {
    ...
    pub fn cors_configuration(mut self, value: impl ::std::convert::Into<crate::types::CorsConfiguration>) -> Self {
        self.input = self.input.set_cors_configuration(Some(value.into()));
        self
    }
    ...
    pub async fn send(self) -> ::std::result::Result<super::PutBucketCorsOutput, super::PutBucketCorsError> {
        let input = self
            .input
            .build()
            .map_err(|error| super::PutBucketCorsError::Unhandled(error.to_string()))?;
        let bucket = input
            .bucket
            .as_deref()
        ...
        let body = {
            ...
            if let Some(value) = input.cors_configuration.as_ref() {
