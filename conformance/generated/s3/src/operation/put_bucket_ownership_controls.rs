...
pub mod _put_bucket_ownership_controls_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/put_bucket_ownership_controls/_put_bucket_ownership_controls_input.rs"
    ));
}
...
pub mod _put_bucket_ownership_controls_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/put_bucket_ownership_controls/_put_bucket_ownership_controls_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/put_bucket_ownership_controls/builders.rs"
    ));
}
