// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output {
            pub logging_enabled: ::std::option::Option<super::super::types::LoggingEnabled>,
        }
        impl Output {
            pub fn logging_enabled(&self) -> ::std::option::Option<&super::super::types::LoggingEnabled> { self.logging_enabled.as_ref() }
        }
        pub type GetBucketLoggingInput = Input;
        pub type GetBucketLoggingOutput = Output;
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::GetBucketLoggingOutput, super::GetBucketLoggingError> {
                         let bucket = self.input.bucket.as_deref().ok_or_else(|| super::GetBucketLoggingError::Unhandled("GetBucketLogging requires bucket".to_owned()))?;
                         ...
                         Ok(super::GetBucketLoggingOutput::default())
                     }
                 }
}
