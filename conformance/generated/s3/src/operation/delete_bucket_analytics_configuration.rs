// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output;
        pub type DeleteBucketAnalyticsConfigurationInput = Input;
        pub type DeleteBucketAnalyticsConfigurationOutput = Output;
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::DeleteBucketAnalyticsConfigurationOutput, super::DeleteBucketAnalyticsConfigurationError> {
                         let bucket = self.input.bucket.as_deref().ok_or_else(|| super::DeleteBucketAnalyticsConfigurationError::Unhandled("DeleteBucketAnalyticsConfiguration requires bucket".to_owned()))?;
