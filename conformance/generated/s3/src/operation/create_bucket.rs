...
impl CreateBucket {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::create_bucket::CreateBucketInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::create_bucket::CreateBucketError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::create_bucket::CreateBucketOutput>()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateBucket")
            ...
            .with_retry_classifier(
                ::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::operation::create_bucket::CreateBucketError>::builder()
                    .transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateBucketResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_create_bucket::de_create_bucket_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_create_bucket::de_create_bucket_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateBucketRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::create_bucket::CreateBucketInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::create_bucket::CreateBucketInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::protocol_serde::shape_create_bucket::ser_create_bucket_headers(input, builder)?;
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_create_bucket_input::ser_create_bucket_configuration_http_payload(&input.create_bucket_configuration)?,
        );
...
impl super::s3_request_id::RequestIdExt for super::operation::create_bucket::CreateBucketError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::create_bucket::CreateBucketError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::create_bucket::_create_bucket_input::CreateBucketInput;

pub use super::operation::create_bucket::_create_bucket_output::CreateBucketOutput;
