...
pub mod _delete_bucket_policy_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/delete_bucket_policy/_delete_bucket_policy_input.rs"
    ));
}
...
pub mod _delete_bucket_policy_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/delete_bucket_policy/_delete_bucket_policy_output.rs"
    ));
}
