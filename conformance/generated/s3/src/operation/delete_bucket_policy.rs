...
pub mod _delete_bucket_policy_input {
    include!(concat!(env!("OUT_DIR"), "/generated/s3/src/operation/delete_bucket_policy/_delete_bucket_policy_input.rs"));
}
pub use _delete_bucket_policy_input::DeleteBucketPolicyInput;
pub type Input = DeleteBucketPolicyInput;
pub mod _delete_bucket_policy_output {
    include!(concat!(env!("OUT_DIR"), "/generated/s3/src/operation/delete_bucket_policy/_delete_bucket_policy_output.rs"));
}
pub use _delete_bucket_policy_output::DeleteBucketPolicyOutput;
pub type Output = DeleteBucketPolicyOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/s3/src/operation/delete_bucket_policy/builders.rs"));
}
