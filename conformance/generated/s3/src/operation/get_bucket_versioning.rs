...
pub mod _get_bucket_versioning_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/get_bucket_versioning/_get_bucket_versioning_input.rs"
    ));
}
...
pub mod _get_bucket_versioning_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/get_bucket_versioning/_get_bucket_versioning_output.rs"
    ));
}
