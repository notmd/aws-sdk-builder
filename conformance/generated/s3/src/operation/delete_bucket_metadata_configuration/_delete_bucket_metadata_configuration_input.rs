...
impl DeleteBucketMetadataConfigurationInput {
    ...
    pub fn builder() -> super::operation::delete_bucket_metadata_configuration::builders::DeleteBucketMetadataConfigurationInputBuilder {
        super::operation::delete_bucket_metadata_configuration::builders::DeleteBucketMetadataConfigurationInputBuilder::default()
    }
}
...
impl DeleteBucketMetadataConfigurationInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::delete_bucket_metadata_configuration::DeleteBucketMetadataConfigurationInput,
