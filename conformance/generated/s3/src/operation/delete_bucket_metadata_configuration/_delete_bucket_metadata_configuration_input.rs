...
impl DeleteBucketMetadataConfigurationInput {
    pub fn builder() -> DeleteBucketMetadataConfigurationInputBuilder { DeleteBucketMetadataConfigurationInputBuilder::default() }
}
#[derive(Clone, Debug, Default)]
...
impl DeleteBucketMetadataConfigurationInputBuilder {
    ...
    pub fn build(self) -> DeleteBucketMetadataConfigurationInput { DeleteBucketMetadataConfigurationInput {
        bucket: self.bucket,
