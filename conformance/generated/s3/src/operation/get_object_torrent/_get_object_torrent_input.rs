...
impl GetObjectTorrentInput {
    ...
    pub fn builder() -> super::operation::get_object_torrent::builders::GetObjectTorrentInputBuilder {
        super::operation::get_object_torrent::builders::GetObjectTorrentInputBuilder::default()
    }
}
...
impl GetObjectTorrentInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_object_torrent::GetObjectTorrentInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_object_torrent::GetObjectTorrentInput {
            bucket: self.bucket,
            key: self.key,
