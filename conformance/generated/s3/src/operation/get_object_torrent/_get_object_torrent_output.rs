...
impl super::s3_request_id::RequestIdExt for GetObjectTorrentOutput {
...
impl GetObjectTorrentOutput {
    ...
    pub fn builder() -> super::operation::get_object_torrent::builders::GetObjectTorrentOutputBuilder {
        super::operation::get_object_torrent::builders::GetObjectTorrentOutputBuilder::default()
    }
}
...
impl GetObjectTorrentOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_object_torrent::GetObjectTorrentOutput {
