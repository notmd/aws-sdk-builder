...
impl DeleteBucketOwnershipControlsInput {
    pub fn builder() -> DeleteBucketOwnershipControlsInputBuilder { DeleteBucketOwnershipControlsInputBuilder::default() }
}
#[derive(Clone, Debug, Default)]
...
impl DeleteBucketOwnershipControlsInputBuilder {
    ...
    pub fn build(self) -> DeleteBucketOwnershipControlsInput { DeleteBucketOwnershipControlsInput {
        bucket: self.bucket,
