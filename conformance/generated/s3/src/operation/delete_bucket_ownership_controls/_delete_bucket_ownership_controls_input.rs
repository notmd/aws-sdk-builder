...
impl DeleteBucketOwnershipControlsInput {
    ...
    pub fn builder() -> super::operation::delete_bucket_ownership_controls::builders::DeleteBucketOwnershipControlsInputBuilder {
        super::operation::delete_bucket_ownership_controls::builders::DeleteBucketOwnershipControlsInputBuilder::default()
    }
}
...
impl DeleteBucketOwnershipControlsInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::delete_bucket_ownership_controls::DeleteBucketOwnershipControlsInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::delete_bucket_ownership_controls::DeleteBucketOwnershipControlsInput {
            bucket: self.bucket,
