// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output {
            pub policy_status: ::std::option::Option<super::super::types::PolicyStatus>,
        }
        impl Output {
            pub fn policy_status(&self) -> ::std::option::Option<&super::super::types::PolicyStatus> { self.policy_status.as_ref() }
        }
        pub type GetBucketPolicyStatusInput = Input;
        pub type GetBucketPolicyStatusOutput = Output;
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::GetBucketPolicyStatusOutput, super::GetBucketPolicyStatusError> {
                         let bucket = self.input.bucket.as_deref().ok_or_else(|| super::GetBucketPolicyStatusError::Unhandled("GetBucketPolicyStatus requires bucket".to_owned()))?;
                         let path = { let mut path = ::std::string::String::from("/{Bucket}?policyStatus"); path = path.replace("{Bucket}", &super::super::super::transport::encode_path(bucket)); path };
                         ...
                         Ok(super::GetBucketPolicyStatusOutput::default())
                     }
                 }
}
