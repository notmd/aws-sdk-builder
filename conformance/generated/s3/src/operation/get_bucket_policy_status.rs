...
pub mod _get_bucket_policy_status_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/get_bucket_policy_status/_get_bucket_policy_status_input.rs"
    ));
}
...
pub mod _get_bucket_policy_status_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/get_bucket_policy_status/_get_bucket_policy_status_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/get_bucket_policy_status/builders.rs"
    ));
}
