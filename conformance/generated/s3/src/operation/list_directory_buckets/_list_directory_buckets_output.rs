...
impl super::s3_request_id::RequestIdExt for ListDirectoryBucketsOutput {
...
impl ListDirectoryBucketsOutput {
    ...
    pub fn builder() -> super::operation::list_directory_buckets::builders::ListDirectoryBucketsOutputBuilder {
        super::operation::list_directory_buckets::builders::ListDirectoryBucketsOutputBuilder::default()
    }
}
...
impl ListDirectoryBucketsOutputBuilder {
    ...
    pub fn build(self) -> super::operation::list_directory_buckets::ListDirectoryBucketsOutput {
