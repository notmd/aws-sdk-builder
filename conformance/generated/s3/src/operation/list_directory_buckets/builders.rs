...
pub use super::operation::list_directory_buckets::_list_directory_buckets_input::ListDirectoryBucketsInputBuilder;

pub use super::operation::list_directory_buckets::_list_directory_buckets_output::ListDirectoryBucketsOutputBuilder;

impl super::operation::list_directory_buckets::builders::ListDirectoryBucketsInputBuilder {
...
pub struct ListDirectoryBucketsFluentBuilder {
    ...
    inner: super::operation::list_directory_buckets::builders::ListDirectoryBucketsInputBuilder,
...
impl ListDirectoryBucketsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::list_directory_buckets::builders::ListDirectoryBucketsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::list_directory_buckets::ListDirectoryBuckets::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::list_directory_buckets::ListDirectoryBuckets::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::operation::list_directory_buckets::paginator::ListDirectoryBucketsPaginator {
        super::operation::list_directory_buckets::paginator::ListDirectoryBucketsPaginator::new(self.handle, self.inner)
    }
