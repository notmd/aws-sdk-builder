...
impl ListDirectoryBucketsInput {
    ...
    pub fn builder() -> super::operation::list_directory_buckets::builders::ListDirectoryBucketsInputBuilder {
        super::operation::list_directory_buckets::builders::ListDirectoryBucketsInputBuilder::default()
    }
}
...
impl ListDirectoryBucketsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_directory_buckets::ListDirectoryBucketsInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::list_directory_buckets::ListDirectoryBucketsInput {
