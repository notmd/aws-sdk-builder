...
pub struct ListPartsPaginator {
    ...
    builder: super::operation::list_parts::builders::ListPartsInputBuilder,
    stop_on_duplicate_token: bool,
}

impl ListPartsPaginator {
    /// Create a new paginator-wrapper
    pub(crate) fn new(handle: std::sync::Arc<super::client::Handle>, builder: super::operation::list_parts::builders::ListPartsInputBuilder) -> Self {
        Self {
            handle,
            builder,
    ...
    pub fn items(self) -> super::operation::list_parts::paginator::ListPartsPaginatorItems {
        super::operation::list_parts::paginator::ListPartsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::operation::list_parts::ListParts::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_list_parts_output_output_next_part_number_marker(resp);
...
impl ListPartsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| super::lens::lens_list_parts_output_output_parts(page).unwrap_or_default().into_iter())
    }
}
