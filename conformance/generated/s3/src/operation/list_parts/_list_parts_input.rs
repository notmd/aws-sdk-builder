...
impl ListPartsInput {
    ...
    pub fn builder() -> super::operation::list_parts::builders::ListPartsInputBuilder {
        super::operation::list_parts::builders::ListPartsInputBuilder::default()
    }
}
...
impl ListPartsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::list_parts::ListPartsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_parts::ListPartsInput {
            bucket: self.bucket,
            key: self.key,
