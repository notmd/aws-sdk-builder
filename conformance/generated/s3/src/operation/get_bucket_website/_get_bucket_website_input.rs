...
impl GetBucketWebsiteInput {
    ...
    pub fn builder() -> super::operation::get_bucket_website::builders::GetBucketWebsiteInputBuilder {
        super::operation::get_bucket_website::builders::GetBucketWebsiteInputBuilder::default()
    }
}
...
impl GetBucketWebsiteInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_bucket_website::GetBucketWebsiteInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_bucket_website::GetBucketWebsiteInput {
            bucket: self.bucket,
