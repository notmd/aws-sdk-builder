// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output;
        pub type DeleteBucketInventoryConfigurationInput = Input;
        pub type DeleteBucketInventoryConfigurationOutput = Output;
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::DeleteBucketInventoryConfigurationOutput, super::DeleteBucketInventoryConfigurationError> {
                         let bucket = self.input.bucket.as_deref().ok_or_else(|| super::DeleteBucketInventoryConfigurationError::Unhandled("DeleteBucketInventoryConfiguration requires bucket".to_owned()))?;
                         ...
                         let response = self.client.request(super::super::super::transport::Method::Delete, &path, &headers, &body).await.map_err(super::DeleteBucketInventoryConfigurationError::Unhandled)?;
