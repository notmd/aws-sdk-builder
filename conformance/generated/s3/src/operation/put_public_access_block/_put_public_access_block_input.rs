...
impl PutPublicAccessBlockInput {
    ...
    pub fn builder() -> super::operation::put_public_access_block::builders::PutPublicAccessBlockInputBuilder {
        super::operation::put_public_access_block::builders::PutPublicAccessBlockInputBuilder::default()
    }
}
...
impl PutPublicAccessBlockInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::put_public_access_block::PutPublicAccessBlockInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::put_public_access_block::PutPublicAccessBlockInput {
            bucket: self.bucket,
