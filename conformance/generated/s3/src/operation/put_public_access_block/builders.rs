...
impl Builder {
    ...
    pub fn build(self) -> super::Input { self.input }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::PutPublicAccessBlockOutput, super::PutPublicAccessBlockError> {
                         ...
                         let body = { let mut body = ::std::string::String::new(); if let Some(value) = self.input.public_access_block_configuration.as_ref() { body.push_str("<PublicAccessBlockConfiguration>"); if let Some(value) = value.block_public_acls.as_ref() { body.push_str("<BlockPublicAcls>"); body.push_str(&super::super::super::transport::xml_escape(&value.to_string())); body.push_str("</BlockPublicAcls>"); } if let Some(value) = value.block_public_policy.as_ref() { body.push_str("<BlockPublicPolicy>"); body.push_str(&super::super::super::transport::xml_escape(&value.to_string())); body.push_str("</BlockPublicPolicy>"); } if let Some(value) = value.ignore_public_acls.as_ref() { body.push_str("<IgnorePublicAcls>"); body.push_str(&super::super::super::transport::xml_escape(&value.to_string())); body.push_str("</IgnorePublicAcls>"); } if let Some(value) = value.restrict_public_buckets.as_ref() { body.push_str("<RestrictPublicBuckets>"); body.push_str(&super::super::super::transport::xml_escape(&value.to_string())); body.push_str("</RestrictPublicBuckets>"); } body.push_str("</PublicAccessBlockConfiguration>"); } body.into_bytes() };
