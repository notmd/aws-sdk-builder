...
impl GetObjectInput {
    ...
    pub fn builder() -> super::operation::get_object::builders::GetObjectInputBuilder {
        super::operation::get_object::builders::GetObjectInputBuilder::default()
    }
}
...
impl GetObjectInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::get_object::GetObjectInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_object::GetObjectInput {
            bucket: self.bucket,
