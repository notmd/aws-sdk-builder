...
pub use super::operation::get_object::_get_object_input::GetObjectInputBuilder;

pub use super::operation::get_object::_get_object_output::GetObjectOutputBuilder;

impl super::operation::get_object::builders::GetObjectInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::get_object::GetObjectError,
...
pub struct GetObjectFluentBuilder {
    ...
    inner: super::operation::get_object::builders::GetObjectInputBuilder,
    config_override: ::std::option::Option<super::config::Builder>,
}
impl super::client::customize::internal::CustomizableSend<super::operation::get_object::GetObjectOutput, super::operation::get_object::GetObjectError>
    for GetObjectFluentBuilder
{
    fn send(
        ...
        super::client::customize::internal::SendResult<super::operation::get_object::GetObjectOutput, super::operation::get_object::GetObjectError>,
    > {
...
impl GetObjectFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::get_object::builders::GetObjectInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::get_object::GetObject::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::get_object::GetObject::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub async fn presigned(
        ...
        super::presigning::PresignedRequest,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::get_object::GetObjectError,
            ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
        >,
    > {
        ...
        .with_client_plugin(super::presigning_interceptors::SigV4PresigningRuntimePlugin::new(
            presigning_config,
        ...
        let input = self
            ...
            .build()
            .map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
        let mut context = super::operation::get_object::GetObject::orchestrate_with_stop_point(
            &runtime_plugins,
            input,
        ...
        .map_err(|err| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_object::GetObjectError>()
                    .expect("correct error type")
            })
        })?;
        let request = context.take_request().expect("request set before transmit");
        super::presigning::PresignedRequest::new(request).map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)
    }
    ...
    pub fn checksum_mode(mut self, input: super::types::ChecksumMode) -> Self {
        self.inner = self.inner.checksum_mode(input);
        self
    }
    /// <p>To retrieve the checksum, this mode must be enabled.</p>
    pub fn set_checksum_mode(mut self, input: ::std::option::Option<super::types::ChecksumMode>) -> Self {
        self.inner = self.inner.set_checksum_mode(input);
        self
    }
    /// <p>To retrieve the checksum, this mode must be enabled.</p>
    pub fn get_checksum_mode(&self) -> &::std::option::Option<super::types::ChecksumMode> {
        self.inner.get_checksum_mode()
    }
}

impl super::client::customize::internal::CustomizablePresigned<super::operation::get_object::GetObjectError> for GetObjectFluentBuilder {
    fn presign(
        self,
        config_override: super::config::Builder,
        presigning_config: super::presigning::PresigningConfig,
    ) -> super::client::customize::internal::BoxFuture<
        super::client::customize::internal::SendResult<super::presigning::PresignedRequest, super::operation::get_object::GetObjectError>,
    > {
