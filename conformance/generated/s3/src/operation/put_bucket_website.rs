// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        pub struct Input {
            ...
            pub website_configuration: ::std::option::Option<super::super::types::WebsiteConfiguration>,
        }
        impl Input {
            ...
            pub fn website_configuration(&self) -> ::std::option::Option<&super::super::types::WebsiteConfiguration> { self.website_configuration.as_ref() }
        }
        #[derive(Clone, Debug, Default)]
        pub struct Output;
        pub type PutBucketWebsiteInput = Input;
        pub type PutBucketWebsiteOutput = Output;
