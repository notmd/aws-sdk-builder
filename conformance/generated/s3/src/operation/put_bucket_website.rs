...
impl PutBucketWebsite {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::put_bucket_website::PutBucketWebsiteInput,
    ) -> ::std::result::Result<
        super::operation::put_bucket_website::PutBucketWebsiteOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::put_bucket_website::PutBucketWebsiteError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::put_bucket_website::PutBucketWebsiteError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::put_bucket_website::PutBucketWebsiteOutput>()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutBucketWebsite")
            ...
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                super::http_request_checksum::RequestChecksumInterceptor::new(
                    |input: &::aws_smithy_runtime_api::client::interceptors::context::Input| {
                        let input: &super::operation::put_bucket_website::PutBucketWebsiteInput = input.downcast_ref().expect("correct type");
            ...
            .with_retry_classifier(
                ::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::operation::put_bucket_website::PutBucketWebsiteError>::builder()
                    .transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutBucketWebsiteResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_put_bucket_website::de_put_bucket_website_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_put_bucket_website::de_put_bucket_website_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutBucketWebsiteRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::put_bucket_website::PutBucketWebsiteInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::put_bucket_website::PutBucketWebsiteInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::protocol_serde::shape_put_bucket_website::ser_put_bucket_website_headers(input, builder)?;
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_put_bucket_website_input::ser_website_configuration_http_payload(&input.website_configuration)?,
        );
...
impl super::s3_request_id::RequestIdExt for super::operation::put_bucket_website::PutBucketWebsiteError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::put_bucket_website::PutBucketWebsiteError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::put_bucket_website::_put_bucket_website_input::PutBucketWebsiteInput;

pub use super::operation::put_bucket_website::_put_bucket_website_output::PutBucketWebsiteOutput;
