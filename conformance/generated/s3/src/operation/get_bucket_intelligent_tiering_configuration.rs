// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        pub type GetBucketIntelligentTieringConfigurationInput = Input;
        pub type GetBucketIntelligentTieringConfigurationOutput = Output;
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::GetBucketIntelligentTieringConfigurationOutput, super::GetBucketIntelligentTieringConfigurationError> {
                         let bucket = self.input.bucket.as_deref().ok_or_else(|| super::GetBucketIntelligentTieringConfigurationError::Unhandled("GetBucketIntelligentTieringConfiguration requires bucket".to_owned()))?;
                         let path = { let mut path = ::std::string::String::from("/{Bucket}?intelligent-tiering&x-id=GetBucketIntelligentTieringConfiguration"); if let Some(value) = self.input.id.as_deref() { path.push_str(if path.contains('?') { "&" } else { "?" }); path.push_str("id"); path.push('='); path.push_str(&super::super::super::transport::encode_path(value)); } path = path.replace("{Bucket}", &super::super::super::transport::encode_path(bucket)); path };
                         ...
                         Ok(super::GetBucketIntelligentTieringConfigurationOutput::default())
                     }
                 }
}
