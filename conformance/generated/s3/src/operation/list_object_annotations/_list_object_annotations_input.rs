...
impl ListObjectAnnotationsInput {
    ...
    pub fn builder() -> super::operation::list_object_annotations::builders::ListObjectAnnotationsInputBuilder {
        super::operation::list_object_annotations::builders::ListObjectAnnotationsInputBuilder::default()
    }
}
...
impl ListObjectAnnotationsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_object_annotations::ListObjectAnnotationsInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::list_object_annotations::ListObjectAnnotationsInput {
            bucket: self.bucket,
            key: self.key,
