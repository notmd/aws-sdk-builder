...
pub struct SelectObjectContentInput {
    ...
    pub expression_type: ::std::option::Option<super::types::ExpressionType>,
    /// <p>Specifies if periodic request progress information should be enabled.</p>
    pub request_progress: ::std::option::Option<super::types::RequestProgress>,
    /// <p>Describes the format of the data in the object that is being queried.</p>
    pub input_serialization: ::std::option::Option<super::types::InputSerialization>,
    /// <p>Describes the format of the data that you want Amazon S3 to return in response.</p>
    pub output_serialization: ::std::option::Option<super::types::OutputSerialization>,
    ...
    /// </ul>
    pub scan_range: ::std::option::Option<super::types::ScanRange>,
...
impl SelectObjectContentInput {
    ...
    /// <p>The type of the provided expression (for example, SQL).</p>
    pub fn expression_type(&self) -> ::std::option::Option<&super::types::ExpressionType> {
        self.expression_type.as_ref()
    }
    /// <p>Specifies if periodic request progress information should be enabled.</p>
    pub fn request_progress(&self) -> ::std::option::Option<&super::types::RequestProgress> {
        self.request_progress.as_ref()
    }
    /// <p>Describes the format of the data in the object that is being queried.</p>
    pub fn input_serialization(&self) -> ::std::option::Option<&super::types::InputSerialization> {
        self.input_serialization.as_ref()
    }
    /// <p>Describes the format of the data that you want Amazon S3 to return in response.</p>
    pub fn output_serialization(&self) -> ::std::option::Option<&super::types::OutputSerialization> {
    ...
    /// </scanrange></code> - process only the records within the last 50 bytes of the file.</p></li>
    /// </ul>
    pub fn scan_range(&self) -> ::std::option::Option<&super::types::ScanRange> {
...
impl SelectObjectContentInput {
    ...
    pub fn builder() -> super::operation::select_object_content::builders::SelectObjectContentInputBuilder {
        super::operation::select_object_content::builders::SelectObjectContentInputBuilder::default()
    }
}
...
pub struct SelectObjectContentInputBuilder {
    ...
    pub(crate) expression_type: ::std::option::Option<super::types::ExpressionType>,
    pub(crate) request_progress: ::std::option::Option<super::types::RequestProgress>,
    pub(crate) input_serialization: ::std::option::Option<super::types::InputSerialization>,
    pub(crate) output_serialization: ::std::option::Option<super::types::OutputSerialization>,
    pub(crate) scan_range: ::std::option::Option<super::types::ScanRange>,
...
impl SelectObjectContentInputBuilder {
    ...
    /// <p>The type of the provided expression (for example, SQL).</p>
    /// This field is required.
    pub fn expression_type(mut self, input: super::types::ExpressionType) -> Self {
        self.expression_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The type of the provided expression (for example, SQL).</p>
    pub fn set_expression_type(mut self, input: ::std::option::Option<super::types::ExpressionType>) -> Self {
        self.expression_type = input;
        self
    }
    /// <p>The type of the provided expression (for example, SQL).</p>
    pub fn get_expression_type(&self) -> &::std::option::Option<super::types::ExpressionType> {
        &self.expression_type
    }
    /// <p>Specifies if periodic request progress information should be enabled.</p>
    pub fn request_progress(mut self, input: super::types::RequestProgress) -> Self {
        self.request_progress = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies if periodic request progress information should be enabled.</p>
    pub fn set_request_progress(mut self, input: ::std::option::Option<super::types::RequestProgress>) -> Self {
        self.request_progress = input;
        self
    }
    /// <p>Specifies if periodic request progress information should be enabled.</p>
    pub fn get_request_progress(&self) -> &::std::option::Option<super::types::RequestProgress> {
        &self.request_progress
    }
    /// <p>Describes the format of the data in the object that is being queried.</p>
    /// This field is required.
    pub fn input_serialization(mut self, input: super::types::InputSerialization) -> Self {
        self.input_serialization = ::std::option::Option::Some(input);
        self
    }
    /// <p>Describes the format of the data in the object that is being queried.</p>
    pub fn set_input_serialization(mut self, input: ::std::option::Option<super::types::InputSerialization>) -> Self {
        self.input_serialization = input;
        self
    }
    /// <p>Describes the format of the data in the object that is being queried.</p>
    pub fn get_input_serialization(&self) -> &::std::option::Option<super::types::InputSerialization> {
        &self.input_serialization
    }
    /// <p>Describes the format of the data that you want Amazon S3 to return in response.</p>
    /// This field is required.
    pub fn output_serialization(mut self, input: super::types::OutputSerialization) -> Self {
        self.output_serialization = ::std::option::Option::Some(input);
        self
    }
    /// <p>Describes the format of the data that you want Amazon S3 to return in response.</p>
    pub fn set_output_serialization(mut self, input: ::std::option::Option<super::types::OutputSerialization>) -> Self {
        self.output_serialization = input;
        self
    }
    /// <p>Describes the format of the data that you want Amazon S3 to return in response.</p>
    pub fn get_output_serialization(&self) -> &::std::option::Option<super::types::OutputSerialization> {
    ...
    /// </scanrange></code> - process only the records within the last 50 bytes of the file.</p></li>
    /// </ul>
    pub fn scan_range(mut self, input: super::types::ScanRange) -> Self {
    ...
    /// </scanrange></code> - process only the records within the last 50 bytes of the file.</p></li>
    /// </ul>
    pub fn set_scan_range(mut self, input: ::std::option::Option<super::types::ScanRange>) -> Self {
    ...
    /// </scanrange></code> - process only the records within the last 50 bytes of the file.</p></li>
    /// </ul>
    pub fn get_scan_range(&self) -> &::std::option::Option<super::types::ScanRange> {
        &self.scan_range
    }
    /// <p>The account ID of the expected bucket owner. If the account ID that you provide does not match the actual owner of the bucket, the request fails with the HTTP status code <code>403 Forbidden</code> (access denied).</p>
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::select_object_content::SelectObjectContentInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::select_object_content::SelectObjectContentInput {
            bucket: self.bucket,
            key: self.key,
