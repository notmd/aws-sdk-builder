...
impl super::s3_request_id::RequestIdExt for SelectObjectContentOutput {
...
impl SelectObjectContentOutput {
    ...
    pub fn builder() -> super::operation::select_object_content::builders::SelectObjectContentOutputBuilder {
        super::operation::select_object_content::builders::SelectObjectContentOutputBuilder::default()
    }
}
...
impl SelectObjectContentOutputBuilder {
    ...
    pub fn payload(
        ...
        input: super::event_receiver::EventReceiver<
            super::types::SelectObjectContentEventStream,
            super::types::error::SelectObjectContentEventStreamError,
        >,
    ) -> Self {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::select_object_content::SelectObjectContentOutput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::select_object_content::SelectObjectContentOutput {
