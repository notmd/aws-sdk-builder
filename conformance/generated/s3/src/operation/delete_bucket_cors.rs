...
impl DeleteBucketCors { pub fn new() -> Self { Self } }
#[derive(Clone, Debug)]
pub enum Error {
...
pub mod _delete_bucket_cors_input {
    include!(concat!(env!("OUT_DIR"), "/generated/s3/src/operation/delete_bucket_cors/_delete_bucket_cors_input.rs"));
}
pub use _delete_bucket_cors_input::DeleteBucketCorsInput;
pub type Input = DeleteBucketCorsInput;
pub mod _delete_bucket_cors_output {
    include!(concat!(env!("OUT_DIR"), "/generated/s3/src/operation/delete_bucket_cors/_delete_bucket_cors_output.rs"));
}
pub use _delete_bucket_cors_output::DeleteBucketCorsOutput;
pub type Output = DeleteBucketCorsOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/s3/src/operation/delete_bucket_cors/builders.rs"));
}
pub type DeleteBucketCorsError = Error;
pub type DeleteBucketCorsFluentBuilder = builders::Builder;
