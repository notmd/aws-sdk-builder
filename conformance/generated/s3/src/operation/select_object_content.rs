...
pub mod _select_object_content_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/select_object_content/_select_object_content_input.rs"
    ));
}
...
pub mod _select_object_content_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/select_object_content/_select_object_content_output.rs"
    ));
}
