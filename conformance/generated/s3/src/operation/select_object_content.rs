...
impl SelectObjectContent {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::select_object_content::SelectObjectContentInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::select_object_content::SelectObjectContentError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::select_object_content::SelectObjectContentOutput>()
...
.with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(SelectObjectContentEndpointParamsInterceptor))
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<super::operation::select_object_content::SelectObjectContentError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<super::operation::select_object_content::SelectObjectContentError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::operation::select_object_content::SelectObjectContentError>::builder().transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SelectObjectContentResponseDeserializer {
    fn deserialize_streaming(
        ...
        ::std::option::Option::Some(super::protocol_serde::type_erase_result(
            super::protocol_serde::shape_select_object_content::de_select_object_content_http_response(response),
        ))
    }
    ...
    fn deserialize_nonstreaming_with_config(
        ...
        super::protocol_serde::type_erase_result(super::protocol_serde::shape_select_object_content::de_select_object_content_http_error(
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SelectObjectContentRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::select_object_content::SelectObjectContentInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::select_object_content::SelectObjectContentInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::protocol_serde::shape_select_object_content::ser_select_object_content_headers(input, builder)?;
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_select_object_content::ser_select_object_content_op_input(
            &input,
        )?);
...
impl super::s3_request_id::RequestIdExt for super::operation::select_object_content::SelectObjectContentError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::select_object_content::SelectObjectContentError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::select_object_content::_select_object_content_input::SelectObjectContentInput;

pub use super::operation::select_object_content::_select_object_content_output::SelectObjectContentOutput;
