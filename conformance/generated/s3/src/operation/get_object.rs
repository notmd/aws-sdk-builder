...
impl GetObject {
    ...
    > {
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_object::GetObjectOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetObject {
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetObject")
            ...
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                super::http_response_checksum::ResponseChecksumInterceptor::new(
                    [
                        "crc64nvme",
                        "crc32",
                        "crc32c",
                    ...
                    |input: &::aws_smithy_runtime_api::client::interceptors::context::Input| {
                        let input: &super::operation::get_object::GetObjectInput = input.downcast_ref().expect("correct type");
                    ...
                    |input: &mut ::aws_smithy_runtime_api::client::interceptors::context::Input, cfg: &::aws_smithy_types::config_bag::ConfigBag| {
                        let input = input
                            .downcast_mut::<super::operation::get_object::GetObjectInput>()
            ...
            .with_retry_classifier(
                ::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::operation::get_object::GetObjectError>::builder()
                    .transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetObjectResponseDeserializer {
    fn deserialize_streaming(
        ...
        ::std::option::Option::Some(super::protocol_serde::type_erase_result(
            super::protocol_serde::shape_get_object::de_get_object_http_response(response),
        ))
    }
    ...
    fn deserialize_nonstreaming_with_config(
        ...
        super::protocol_serde::type_erase_result(super::protocol_serde::shape_get_object::de_get_object_http_error(
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetObjectRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::get_object::GetObjectInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_object::GetObjectInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::protocol_serde::shape_get_object::ser_get_object_headers(input, builder)?;
...
impl super::s3_request_id::RequestIdExt for super::operation::get_object::GetObjectError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::get_object::GetObjectError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_object::_get_object_input::GetObjectInput;

pub use super::operation::get_object::_get_object_output::GetObjectOutput;
