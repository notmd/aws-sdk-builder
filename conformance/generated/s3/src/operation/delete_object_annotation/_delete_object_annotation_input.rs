...
impl DeleteObjectAnnotationInput {
    ...
    pub fn builder() -> super::operation::delete_object_annotation::builders::DeleteObjectAnnotationInputBuilder {
        super::operation::delete_object_annotation::builders::DeleteObjectAnnotationInputBuilder::default()
    }
}
...
impl DeleteObjectAnnotationInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::delete_object_annotation::DeleteObjectAnnotationInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::delete_object_annotation::DeleteObjectAnnotationInput {
            bucket: self.bucket,
            key: self.key,
