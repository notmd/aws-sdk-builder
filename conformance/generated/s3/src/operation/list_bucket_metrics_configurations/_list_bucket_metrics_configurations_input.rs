...
impl ListBucketMetricsConfigurationsInput {
    pub fn builder() -> ListBucketMetricsConfigurationsInputBuilder { ListBucketMetricsConfigurationsInputBuilder::default() }
}
#[derive(Clone, Debug, Default)]
...
impl ListBucketMetricsConfigurationsInputBuilder {
    ...
    pub fn build(self) -> ListBucketMetricsConfigurationsInput { ListBucketMetricsConfigurationsInput {
        bucket: self.bucket,
