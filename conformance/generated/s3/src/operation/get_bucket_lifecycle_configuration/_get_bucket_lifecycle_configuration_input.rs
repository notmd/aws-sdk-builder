...
impl GetBucketLifecycleConfigurationInput {
    pub fn builder() -> GetBucketLifecycleConfigurationInputBuilder { GetBucketLifecycleConfigurationInputBuilder::default() }
}
#[derive(Clone, Debug, Default)]
...
impl GetBucketLifecycleConfigurationInputBuilder {
    ...
    pub fn build(self) -> GetBucketLifecycleConfigurationInput { GetBucketLifecycleConfigurationInput {
        bucket: self.bucket,
