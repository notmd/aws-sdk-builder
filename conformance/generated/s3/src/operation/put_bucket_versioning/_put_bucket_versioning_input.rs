...
pub struct PutBucketVersioningInput {
    ...
    pub versioning_configuration: ::std::option::Option<super::types::VersioningConfiguration>,
...
impl PutBucketVersioningInput {
    ...
    /// <p>Container for setting the versioning state.</p>
    pub fn versioning_configuration(&self) -> ::std::option::Option<&super::types::VersioningConfiguration> {
...
impl PutBucketVersioningInput {
    ...
    pub fn builder() -> super::operation::put_bucket_versioning::builders::PutBucketVersioningInputBuilder {
        super::operation::put_bucket_versioning::builders::PutBucketVersioningInputBuilder::default()
    }
}
...
pub struct PutBucketVersioningInputBuilder {
    ...
    pub(crate) versioning_configuration: ::std::option::Option<super::types::VersioningConfiguration>,
...
impl PutBucketVersioningInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::put_bucket_versioning::PutBucketVersioningInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::put_bucket_versioning::PutBucketVersioningInput {
            bucket: self.bucket,
