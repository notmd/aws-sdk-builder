...
impl PutBucketVersioningInputBuilder {
    ...
    pub fn set_versioning_configuration(mut self, input: ::std::option::Option<crate::types::VersioningConfiguration>) -> Self { self.versioning_configuration = input; self }
    /// <p>Container for setting the versioning state.</p>
    pub fn get_versioning_configuration(&self) -> &::std::option::Option<crate::types::VersioningConfiguration> { &self.versioning_configuration }
    /// <p>The account ID of the expected bucket owner. If the account ID that you provide does not match the actual owner of the bucket, the request fails with the HTTP status code <code>403 Forbidden</code> (access denied).</p>
    ...
    pub fn build(self) -> crate::operation::put_bucket_versioning::PutBucketVersioningInput {
