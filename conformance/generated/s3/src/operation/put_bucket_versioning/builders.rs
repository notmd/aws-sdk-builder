...
pub use super::operation::put_bucket_versioning::_put_bucket_versioning_input::PutBucketVersioningInputBuilder;

pub use super::operation::put_bucket_versioning::_put_bucket_versioning_output::PutBucketVersioningOutputBuilder;

impl super::operation::put_bucket_versioning::builders::PutBucketVersioningInputBuilder {
...
pub struct PutBucketVersioningFluentBuilder {
    ...
    inner: super::operation::put_bucket_versioning::builders::PutBucketVersioningInputBuilder,
...
impl PutBucketVersioningFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::put_bucket_versioning::builders::PutBucketVersioningInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::put_bucket_versioning::PutBucketVersioning::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::put_bucket_versioning::PutBucketVersioning::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn versioning_configuration(mut self, input: super::types::VersioningConfiguration) -> Self {
        self.inner = self.inner.versioning_configuration(input);
        self
    }
    /// <p>Container for setting the versioning state.</p>
    pub fn set_versioning_configuration(mut self, input: ::std::option::Option<super::types::VersioningConfiguration>) -> Self {
        self.inner = self.inner.set_versioning_configuration(input);
        self
    }
    /// <p>Container for setting the versioning state.</p>
    pub fn get_versioning_configuration(&self) -> &::std::option::Option<super::types::VersioningConfiguration> {
