...
pub mod _get_object_tagging_input {
    include!(concat!(env!("OUT_DIR"), "/generated/s3/src/operation/get_object_tagging/_get_object_tagging_input.rs"));
}
pub use _get_object_tagging_input::GetObjectTaggingInput;
pub type Input = GetObjectTaggingInput;
pub mod _get_object_tagging_output {
    include!(concat!(env!("OUT_DIR"), "/generated/s3/src/operation/get_object_tagging/_get_object_tagging_output.rs"));
}
pub use _get_object_tagging_output::GetObjectTaggingOutput;
pub type Output = GetObjectTaggingOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/s3/src/operation/get_object_tagging/builders.rs"));
}
