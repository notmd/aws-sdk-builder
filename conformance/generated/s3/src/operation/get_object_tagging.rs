// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        impl GetObjectTagging { pub fn new() -> Self { Self } }
        #[derive(Clone, Debug, Default)]
        pub struct Input {
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output {
            pub tag_set: ::std::option::Option<super::super::types::TagSet>,
            pub version_id: ::std::option::Option<super::super::types::ObjectVersionId>,
        }
        impl Output {
            pub fn tag_set(&self) -> &[super::super::types::Tag] { self.tag_set.as_deref().unwrap_or(&[]) }
            pub fn version_id(&self) -> ::std::option::Option<&str> { self.version_id.as_deref() }
        }
        pub type GetObjectTaggingInput = Input;
        pub type GetObjectTaggingOutput = Output;
        pub type GetObjectTaggingError = Error;
        #[derive(Clone, Debug)]
        pub enum Error {
...
pub use builders::Builder;
        pub type GetObjectTaggingFluentBuilder = builders::Builder;
