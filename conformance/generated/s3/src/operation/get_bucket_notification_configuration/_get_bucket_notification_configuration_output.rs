...
impl GetBucketNotificationConfigurationOutputBuilder {
    ...
    pub fn set_topic_configurations(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::TopicConfiguration>>) -> Self { self.topic_configurations = input; self }
    /// <p>The topic to which notifications are sent and the events for which notifications are generated.</p>
    pub fn get_topic_configurations(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::TopicConfiguration>> { &self.topic_configurations }
    /// <p>The Amazon Simple Queue Service queues to publish messages to and the events for which to publish messages.</p>
    ...
    pub fn set_queue_configurations(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::QueueConfiguration>>) -> Self { self.queue_configurations = input; self }
    /// <p>The Amazon Simple Queue Service queues to publish messages to and the events for which to publish messages.</p>
    pub fn get_queue_configurations(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::QueueConfiguration>> { &self.queue_configurations }
    /// <p>Describes the Lambda functions to invoke and the events for which to invoke them.</p>
    ...
    pub fn set_lambda_function_configurations(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::LambdaFunctionConfiguration>>) -> Self { self.lambda_function_configurations = input; self }
    /// <p>Describes the Lambda functions to invoke and the events for which to invoke them.</p>
    pub fn get_lambda_function_configurations(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::LambdaFunctionConfiguration>> { &self.lambda_function_configurations }
    /// <p>Enables delivery of events to Amazon EventBridge.</p>
