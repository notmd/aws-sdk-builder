...
impl GetBucketNotificationConfigurationInput {
    pub fn builder() -> GetBucketNotificationConfigurationInputBuilder { GetBucketNotificationConfigurationInputBuilder::default() }
}
#[derive(Clone, Debug, Default)]
...
impl GetBucketNotificationConfigurationInputBuilder {
    ...
    pub fn build(self) -> GetBucketNotificationConfigurationInput { GetBucketNotificationConfigurationInput {
        bucket: self.bucket,
