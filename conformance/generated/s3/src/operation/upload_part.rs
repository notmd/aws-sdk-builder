...
impl UploadPart {
    ...
    pub(crate) async fn orchestrate(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::upload_part::UploadPartError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::upload_part::UploadPartError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::upload_part::UploadPartOutput>()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UploadPart")
            ...
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                super::http_request_checksum::RequestChecksumInterceptor::new(
                    |input: &::aws_smithy_runtime_api::client::interceptors::context::Input| {
                        let input: &super::operation::upload_part::UploadPartInput = input.downcast_ref().expect("correct type");
            ...
            .with_retry_classifier(
                ::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::operation::upload_part::UploadPartError>::builder()
                    .transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UploadPartResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_upload_part::de_upload_part_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_upload_part::de_upload_part_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UploadPartRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::upload_part::UploadPartInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::upload_part::UploadPartInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::protocol_serde::shape_upload_part::ser_upload_part_headers(input, builder)?;
        ...
        let body = super::protocol_serde::shape_upload_part_input::ser_body_http_payload(input.body)?.into_inner();
...
impl super::s3_request_id::RequestIdExt for super::operation::upload_part::UploadPartError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::upload_part::UploadPartError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::upload_part::_upload_part_input::UploadPartInput;

pub use super::operation::upload_part::_upload_part_output::UploadPartOutput;
