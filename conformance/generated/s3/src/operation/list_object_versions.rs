...
pub mod _list_object_versions_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/list_object_versions/_list_object_versions_input.rs"
    ));
}
...
pub mod _list_object_versions_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/list_object_versions/_list_object_versions_output.rs"
    ));
}
