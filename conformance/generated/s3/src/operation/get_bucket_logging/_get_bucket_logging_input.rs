...
impl GetBucketLoggingInput {
    ...
    pub fn builder() -> super::operation::get_bucket_logging::builders::GetBucketLoggingInputBuilder {
        super::operation::get_bucket_logging::builders::GetBucketLoggingInputBuilder::default()
    }
}
...
impl GetBucketLoggingInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_bucket_logging::GetBucketLoggingInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_bucket_logging::GetBucketLoggingInput {
            bucket: self.bucket,
