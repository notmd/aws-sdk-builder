...
pub use super::operation::put_bucket_notification_configuration::_put_bucket_notification_configuration_input::PutBucketNotificationConfigurationInputBuilder;

pub use super::operation::put_bucket_notification_configuration::_put_bucket_notification_configuration_output::PutBucketNotificationConfigurationOutputBuilder;

impl super::operation::put_bucket_notification_configuration::builders::PutBucketNotificationConfigurationInputBuilder {
...
pub struct PutBucketNotificationConfigurationFluentBuilder {
    ...
    inner: super::operation::put_bucket_notification_configuration::builders::PutBucketNotificationConfigurationInputBuilder,
...
impl PutBucketNotificationConfigurationFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::put_bucket_notification_configuration::builders::PutBucketNotificationConfigurationInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::put_bucket_notification_configuration::PutBucketNotificationConfiguration::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::put_bucket_notification_configuration::PutBucketNotificationConfiguration::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn notification_configuration(mut self, input: super::types::NotificationConfiguration) -> Self {
        self.inner = self.inner.notification_configuration(input);
        self
    }
    /// <p>A container for specifying the notification configuration of the bucket. If this element is empty, notifications are turned off for the bucket.</p>
    pub fn set_notification_configuration(mut self, input: ::std::option::Option<super::types::NotificationConfiguration>) -> Self {
        self.inner = self.inner.set_notification_configuration(input);
        self
    }
    /// <p>A container for specifying the notification configuration of the bucket. If this element is empty, notifications are turned off for the bucket.</p>
    pub fn get_notification_configuration(&self) -> &::std::option::Option<super::types::NotificationConfiguration> {
