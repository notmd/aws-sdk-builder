...
impl Builder {
    ...
    pub async fn send(
        ...
        let body = {
            ...
            if let Some(value) = self.input.notification_configuration.as_ref() {
                ...
                if let Some(value) = value.topic_configurations.as_ref() {
                    for item in value {
                        body.push_str("<TopicConfiguration>");
                        ...
                        body.push_str("<Topic>");
                        body.push_str(&super::super::super::transport::xml_escape(&item.topic_arn.to_string()));
                        body.push_str("</Topic>");
                        ...
                        if let Some(value) = item.filter.as_ref() {
                            ...
                            if let Some(value) = value.key.as_ref() {
                                body.push_str("<S3Key>");
                                if let Some(value) = value.filter_rules.as_ref() {
                                    for item in value {
                                        body.push_str("<FilterRule>");
                ...
                if let Some(value) = value.queue_configurations.as_ref() {
                    for item in value {
                        body.push_str("<QueueConfiguration>");
                        if let Some(value) = item.id.as_ref() {
                            body.push_str("<Id>");
                            body.push_str(&super::super::super::transport::xml_escape(&value.to_string()));
                            body.push_str("</Id>");
                        ...
                        body.push_str("<Queue>");
                        body.push_str(&super::super::super::transport::xml_escape(&item.queue_arn.to_string()));
                        body.push_str("</Queue>");
                        for item in item.events {
                            body.push_str("<Event>");
                            body.push_str(&super::super::super::transport::xml_escape(&item.to_string()));
                ...
                if let Some(value) = value.lambda_function_configurations.as_ref() {
                    for item in value {
                        body.push_str("<CloudFunctionConfiguration>");
                        if let Some(value) = item.id.as_ref() {
                            body.push_str("<Id>");
                            body.push_str(&super::super::super::transport::xml_escape(&value.to_string()));
                            body.push_str("</Id>");
                        }
                        body.push_str("<CloudFunction>");
                        body.push_str(&super::super::super::transport::xml_escape(&item.lambda_function_arn.to_string()));
                        body.push_str("</CloudFunction>");
                        for item in item.events {
                            body.push_str("<Event>");
                            body.push_str(&super::super::super::transport::xml_escape(&item.to_string()));
                ...
                if let Some(value) = value.event_bridge_configuration.as_ref() {
                    body.push_str("<EventBridgeConfiguration>");
                    body.push_str("</EventBridgeConfiguration>");
                }
                body.push_str("</NotificationConfiguration>");
            }
        ...
        let response = self
            ...
            .await
            .map_err(super::PutBucketNotificationConfigurationError::Unhandled)?;
        let status = response.status();
        if !status.is_success() {
            return Err(super::PutBucketNotificationConfigurationError::unhandled_with_request_ids(
                format!("PutBucketNotificationConfiguration returned HTTP {}", status),
                response.header("x-amzn-requestid").map(str::to_owned),
                response.header("x-amz-id-2").map(str::to_owned),
            ));
        }
        let mut output = super::_put_bucket_notification_configuration_output::PutBucketNotificationConfigurationOutputBuilder::default();
