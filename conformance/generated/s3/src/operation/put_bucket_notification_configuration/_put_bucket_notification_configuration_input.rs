...
pub struct PutBucketNotificationConfigurationInput {
    ...
    pub notification_configuration: ::std::option::Option<super::types::NotificationConfiguration>,
...
impl PutBucketNotificationConfigurationInput {
    ...
    /// <p>A container for specifying the notification configuration of the bucket. If this element is empty, notifications are turned off for the bucket.</p>
    pub fn notification_configuration(&self) -> ::std::option::Option<&super::types::NotificationConfiguration> {
...
impl PutBucketNotificationConfigurationInput {
    ...
    pub fn builder() -> super::operation::put_bucket_notification_configuration::builders::PutBucketNotificationConfigurationInputBuilder {
        super::operation::put_bucket_notification_configuration::builders::PutBucketNotificationConfigurationInputBuilder::default()
    }
}
...
pub struct PutBucketNotificationConfigurationInputBuilder {
    ...
    pub(crate) notification_configuration: ::std::option::Option<super::types::NotificationConfiguration>,
...
impl PutBucketNotificationConfigurationInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::put_bucket_notification_configuration::PutBucketNotificationConfigurationInput,
