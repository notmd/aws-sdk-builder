    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_multipart_uploads::ListMultipartUploadsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_multipart_uploads::ListMultipartUploadsOutput>()
...
.with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(ListMultipartUploadsEndpointParamsInterceptor))
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<super::operation::list_multipart_uploads::ListMultipartUploadsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<super::operation::list_multipart_uploads::ListMultipartUploadsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::operation::list_multipart_uploads::ListMultipartUploadsError>::builder().transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListMultipartUploadsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_multipart_uploads::de_list_multipart_uploads_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_multipart_uploads::de_list_multipart_uploads_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListMultipartUploadsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_multipart_uploads::ListMultipartUploadsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_multipart_uploads::ListMultipartUploadsInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::protocol_serde::shape_list_multipart_uploads::ser_list_multipart_uploads_headers(input, builder)?;
...
impl super::s3_request_id::RequestIdExt for super::operation::list_multipart_uploads::ListMultipartUploadsError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::list_multipart_uploads::ListMultipartUploadsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_multipart_uploads::_list_multipart_uploads_input::ListMultipartUploadsInput;

pub use super::operation::list_multipart_uploads::_list_multipart_uploads_output::ListMultipartUploadsOutput;
