...
pub mod _list_multipart_uploads_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/list_multipart_uploads/_list_multipart_uploads_input.rs"
    ));
}
...
pub mod _list_multipart_uploads_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/list_multipart_uploads/_list_multipart_uploads_output.rs"
    ));
}
