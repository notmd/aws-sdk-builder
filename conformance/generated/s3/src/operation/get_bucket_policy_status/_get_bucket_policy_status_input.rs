...
impl GetBucketPolicyStatusInput {
    ...
    pub fn builder() -> super::operation::get_bucket_policy_status::builders::GetBucketPolicyStatusInputBuilder {
        super::operation::get_bucket_policy_status::builders::GetBucketPolicyStatusInputBuilder::default()
    }
}
...
impl GetBucketPolicyStatusInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_bucket_policy_status::GetBucketPolicyStatusInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::get_bucket_policy_status::GetBucketPolicyStatusInput {
            bucket: self.bucket,
