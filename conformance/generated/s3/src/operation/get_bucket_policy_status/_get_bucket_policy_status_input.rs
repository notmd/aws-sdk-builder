...
impl GetBucketPolicyStatusInput {
    pub fn builder() -> GetBucketPolicyStatusInputBuilder { GetBucketPolicyStatusInputBuilder::default() }
}
#[derive(Clone, Debug, Default)]
...
impl GetBucketPolicyStatusInputBuilder {
    ...
    pub fn build(self) -> GetBucketPolicyStatusInput { GetBucketPolicyStatusInput {
        bucket: self.bucket,
