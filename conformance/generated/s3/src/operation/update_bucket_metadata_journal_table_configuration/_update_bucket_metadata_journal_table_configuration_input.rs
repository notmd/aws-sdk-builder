...
pub struct UpdateBucketMetadataJournalTableConfigurationInput {
    ...
    pub journal_table_configuration: ::std::option::Option<super::types::JournalTableConfigurationUpdates>,
...
impl UpdateBucketMetadataJournalTableConfigurationInput {
    ...
    /// <p>The contents of your journal table configuration.</p>
    pub fn journal_table_configuration(&self) -> ::std::option::Option<&super::types::JournalTableConfigurationUpdates> {
...
impl UpdateBucketMetadataJournalTableConfigurationInput {
    ...
    {
        super::operation::update_bucket_metadata_journal_table_configuration::builders::UpdateBucketMetadataJournalTableConfigurationInputBuilder::default()
    }
}
...
pub struct UpdateBucketMetadataJournalTableConfigurationInputBuilder {
    ...
    pub(crate) journal_table_configuration: ::std::option::Option<super::types::JournalTableConfigurationUpdates>,
...
impl UpdateBucketMetadataJournalTableConfigurationInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::update_bucket_metadata_journal_table_configuration::UpdateBucketMetadataJournalTableConfigurationInput,
