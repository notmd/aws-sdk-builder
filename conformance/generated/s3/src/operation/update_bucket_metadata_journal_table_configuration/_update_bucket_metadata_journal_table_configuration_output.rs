...
impl super::s3_request_id::RequestIdExt for UpdateBucketMetadataJournalTableConfigurationOutput {
...
impl UpdateBucketMetadataJournalTableConfigurationOutput {
    ...
    pub fn builder(
    ) -> super::operation::update_bucket_metadata_journal_table_configuration::builders::UpdateBucketMetadataJournalTableConfigurationOutputBuilder
    {
        super::operation::update_bucket_metadata_journal_table_configuration::builders::UpdateBucketMetadataJournalTableConfigurationOutputBuilder::default()
    }
}
...
impl UpdateBucketMetadataJournalTableConfigurationOutputBuilder {
    ...
    pub fn build(self) -> super::operation::update_bucket_metadata_journal_table_configuration::UpdateBucketMetadataJournalTableConfigurationOutput {
