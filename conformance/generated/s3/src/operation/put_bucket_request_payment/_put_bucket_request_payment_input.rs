...
impl PutBucketRequestPaymentInputBuilder {
    ...
    pub fn set_request_payment_configuration(mut self, input: ::std::option::Option<crate::types::RequestPaymentConfiguration>) -> Self { self.request_payment_configuration = input; self }
    /// <p>Container for Payer.</p>
    pub fn get_request_payment_configuration(&self) -> &::std::option::Option<crate::types::RequestPaymentConfiguration> { &self.request_payment_configuration }
    /// <p>The account ID of the expected bucket owner. If the account ID that you provide does not match the actual owner of the bucket, the request fails with the HTTP status code <code>403 Forbidden</code> (access denied).</p>
    ...
    pub fn build(self) -> crate::operation::put_bucket_request_payment::PutBucketRequestPaymentInput {
