...
pub struct ListBucketInventoryConfigurationsOutput {
    ...
    pub inventory_configuration_list: ::std::option::Option<::std::vec::Vec<super::types::InventoryConfiguration>>,
...
impl ListBucketInventoryConfigurationsOutput {
    ...
    pub fn inventory_configuration_list(&self) -> &[super::types::InventoryConfiguration] {
...
impl super::s3_request_id::RequestIdExt for ListBucketInventoryConfigurationsOutput {
...
impl ListBucketInventoryConfigurationsOutput {
    ...
    pub fn builder() -> super::operation::list_bucket_inventory_configurations::builders::ListBucketInventoryConfigurationsOutputBuilder {
        super::operation::list_bucket_inventory_configurations::builders::ListBucketInventoryConfigurationsOutputBuilder::default()
    }
}
...
pub struct ListBucketInventoryConfigurationsOutputBuilder {
    ...
    pub(crate) inventory_configuration_list: ::std::option::Option<::std::vec::Vec<super::types::InventoryConfiguration>>,
...
impl ListBucketInventoryConfigurationsOutputBuilder {
    ...
    ///
    /// <p>The list of inventory configurations for a bucket.</p>
    pub fn inventory_configuration_list(mut self, input: super::types::InventoryConfiguration) -> Self {
    ...
    /// <p>The list of inventory configurations for a bucket.</p>
    pub fn set_inventory_configuration_list(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::InventoryConfiguration>>) -> Self {
        self.inventory_configuration_list = input;
        self
    }
    /// <p>The list of inventory configurations for a bucket.</p>
    pub fn get_inventory_configuration_list(&self) -> &::std::option::Option<::std::vec::Vec<super::types::InventoryConfiguration>> {
    ...
    pub fn build(self) -> super::operation::list_bucket_inventory_configurations::ListBucketInventoryConfigurationsOutput {
