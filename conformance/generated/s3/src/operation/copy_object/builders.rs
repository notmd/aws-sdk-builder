...
impl Builder {
    ...
    pub fn build(self) -> super::Input { self.input }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::CopyObjectOutput, super::CopyObjectError> {
                         ...
                         if let Some(value) = super::super::super::transport::xml_first(&body, "CopyObjectResult") { let mut item: super::super::super::types::CopyObjectResult = ::std::default::Default::default(); item.checksum_crc32 = super::super::super::transport::xml_first(&value, "ChecksumCRC32").and_then(|value| value.parse().ok());
 ...
 item; output.copy_object_result = Some(item); }
