...
pub struct CopyObjectInput {
    ...
    /// </ul>
    /// </note>
    pub acl: ::std::option::Option<super::types::ObjectCannedAcl>,
    ...
    /// </note>
    pub metadata_directive: ::std::option::Option<super::types::MetadataDirective>,
    ...
    /// </ul>
    /// </note>
    pub tagging_directive: ::std::option::Option<super::types::TaggingDirective>,
    ...
    /// </note>
    pub annotation_directive: ::std::option::Option<super::types::AnnotationDirective>,
...
impl CopyObjectInput {
    ...
    /// </ul>
    /// </note>
    pub fn acl(&self) -> ::std::option::Option<&super::types::ObjectCannedAcl> {
        self.acl.as_ref()
    }
    /// <p>The name of the destination bucket.</p>
    /// <p><b>Directory buckets</b> - When you use this operation with a directory bucket, you must use virtual-hosted-style requests in the format <code> <i>Bucket-name</i>.s3express-<i>zone-id</i>.<i>region-code</i>.amazonaws.com</code>. Path-style requests are not supported. Directory bucket names must be unique in the chosen Zone (Availability Zone or Local Zone). Bucket names must follow the format <code> <i>bucket-base-name</i>--<i>zone-id</i>--x-s3</code> (for example, <code> <i>amzn-s3-demo-bucket</i>--<i>usw2-az1</i>--x-s3</code>). For information about bucket naming restrictions, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/directory-bucket-naming-rules.html">Directory bucket naming rules</a> in the <i>Amazon S3 User Guide</i>.</p><note>
    ...
    /// <p><code>x-amz-website-redirect-location</code> is unique to each object and is not copied when using the <code>x-amz-metadata-directive</code> header. To copy the value, you must specify <code>x-amz-website-redirect-location</code> in the request header.</p>
    /// </note>
    pub fn metadata_directive(&self) -> ::std::option::Option<&super::types::MetadataDirective> {
    ...
    /// </ul>
    /// </note>
    pub fn tagging_directive(&self) -> ::std::option::Option<&super::types::TaggingDirective> {
    ...
    /// <p>When you copy objects using multipart upload (for example, when the Amazon Web Services CLI or Amazon Web Services SDKs use Transfer Manager for objects larger than approximately 8 MB), annotations are not copied by default. To include annotations, specify <code>--copy-props default</code> in the Amazon Web Services CLI or the equivalent SDK configuration. With this opt-in, the SDK reads source annotations, completes the multipart upload, and then writes each annotation to the destination. Between the upload completion and the last annotation write, the destination object exists without all its annotations.</p>
    /// </note>
    pub fn annotation_directive(&self) -> ::std::option::Option<&super::types::AnnotationDirective> {
...
impl CopyObjectInput {
    ...
    pub fn builder() -> super::operation::copy_object::builders::CopyObjectInputBuilder {
        super::operation::copy_object::builders::CopyObjectInputBuilder::default()
    }
}
...
pub struct CopyObjectInputBuilder {
    pub(crate) acl: ::std::option::Option<super::types::ObjectCannedAcl>,
    ...
    pub(crate) metadata_directive: ::std::option::Option<super::types::MetadataDirective>,
    pub(crate) tagging_directive: ::std::option::Option<super::types::TaggingDirective>,
    pub(crate) annotation_directive: ::std::option::Option<super::types::AnnotationDirective>,
...
impl CopyObjectInputBuilder {
    ...
    /// </ul>
    /// </note>
    pub fn acl(mut self, input: super::types::ObjectCannedAcl) -> Self {
    ...
    /// </ul>
    /// </note>
    pub fn set_acl(mut self, input: ::std::option::Option<super::types::ObjectCannedAcl>) -> Self {
        self.acl = input;
        self
    }
    /// <p>The canned access control list (ACL) to apply to the object.</p>
    ...
    /// </ul>
    /// </note>
    pub fn get_acl(&self) -> &::std::option::Option<super::types::ObjectCannedAcl> {
        &self.acl
    }
    /// <p>The name of the destination bucket.</p>
    /// <p><b>Directory buckets</b> - When you use this operation with a directory bucket, you must use virtual-hosted-style requests in the format <code> <i>Bucket-name</i>.s3express-<i>zone-id</i>.<i>region-code</i>.amazonaws.com</code>. Path-style requests are not supported. Directory bucket names must be unique in the chosen Zone (Availability Zone or Local Zone). Bucket names must follow the format <code> <i>bucket-base-name</i>--<i>zone-id</i>--x-s3</code> (for example, <code> <i>amzn-s3-demo-bucket</i>--<i>usw2-az1</i>--x-s3</code>). For information about bucket naming restrictions, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/directory-bucket-naming-rules.html">Directory bucket naming rules</a> in the <i>Amazon S3 User Guide</i>.</p><note>
    ...
    /// <p><code>x-amz-website-redirect-location</code> is unique to each object and is not copied when using the <code>x-amz-metadata-directive</code> header. To copy the value, you must specify <code>x-amz-website-redirect-location</code> in the request header.</p>
    /// </note>
    pub fn metadata_directive(mut self, input: super::types::MetadataDirective) -> Self {
    ...
    /// <p><code>x-amz-website-redirect-location</code> is unique to each object and is not copied when using the <code>x-amz-metadata-directive</code> header. To copy the value, you must specify <code>x-amz-website-redirect-location</code> in the request header.</p>
    /// </note>
    pub fn set_metadata_directive(mut self, input: ::std::option::Option<super::types::MetadataDirective>) -> Self {
    ...
    /// <p><code>x-amz-website-redirect-location</code> is unique to each object and is not copied when using the <code>x-amz-metadata-directive</code> header. To copy the value, you must specify <code>x-amz-website-redirect-location</code> in the request header.</p>
    /// </note>
    pub fn get_metadata_directive(&self) -> &::std::option::Option<super::types::MetadataDirective> {
    ...
    /// </ul>
    /// </note>
    pub fn tagging_directive(mut self, input: super::types::TaggingDirective) -> Self {
    ...
    /// </ul>
    /// </note>
    pub fn set_tagging_directive(mut self, input: ::std::option::Option<super::types::TaggingDirective>) -> Self {
    ...
    /// </ul>
    /// </note>
    pub fn get_tagging_directive(&self) -> &::std::option::Option<super::types::TaggingDirective> {
    ...
    /// <p>When you copy objects using multipart upload (for example, when the Amazon Web Services CLI or Amazon Web Services SDKs use Transfer Manager for objects larger than approximately 8 MB), annotations are not copied by default. To include annotations, specify <code>--copy-props default</code> in the Amazon Web Services CLI or the equivalent SDK configuration. With this opt-in, the SDK reads source annotations, completes the multipart upload, and then writes each annotation to the destination. Between the upload completion and the last annotation write, the destination object exists without all its annotations.</p>
    /// </note>
    pub fn annotation_directive(mut self, input: super::types::AnnotationDirective) -> Self {
    ...
    /// <p>When you copy objects using multipart upload (for example, when the Amazon Web Services CLI or Amazon Web Services SDKs use Transfer Manager for objects larger than approximately 8 MB), annotations are not copied by default. To include annotations, specify <code>--copy-props default</code> in the Amazon Web Services CLI or the equivalent SDK configuration. With this opt-in, the SDK reads source annotations, completes the multipart upload, and then writes each annotation to the destination. Between the upload completion and the last annotation write, the destination object exists without all its annotations.</p>
    /// </note>
    pub fn set_annotation_directive(mut self, input: ::std::option::Option<super::types::AnnotationDirective>) -> Self {
    ...
    /// <p>When you copy objects using multipart upload (for example, when the Amazon Web Services CLI or Amazon Web Services SDKs use Transfer Manager for objects larger than approximately 8 MB), annotations are not copied by default. To include annotations, specify <code>--copy-props default</code> in the Amazon Web Services CLI or the equivalent SDK configuration. With this opt-in, the SDK reads source annotations, completes the multipart upload, and then writes each annotation to the destination. Between the upload completion and the last annotation write, the destination object exists without all its annotations.</p>
    /// </note>
    pub fn get_annotation_directive(&self) -> &::std::option::Option<super::types::AnnotationDirective> {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::copy_object::CopyObjectInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::copy_object::CopyObjectInput {
            acl: self.acl,
            bucket: self.bucket,
