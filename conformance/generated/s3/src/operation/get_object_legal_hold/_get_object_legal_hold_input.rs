...
impl GetObjectLegalHoldInput {
    ...
    pub fn builder() -> super::operation::get_object_legal_hold::builders::GetObjectLegalHoldInputBuilder {
        super::operation::get_object_legal_hold::builders::GetObjectLegalHoldInputBuilder::default()
    }
}
...
impl GetObjectLegalHoldInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_object_legal_hold::GetObjectLegalHoldInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::get_object_legal_hold::GetObjectLegalHoldInput {
            bucket: self.bucket,
            key: self.key,
