...
impl super::s3_request_id::RequestIdExt for PutObjectAclOutput {
...
impl PutObjectAclOutput {
    ...
    pub fn builder() -> super::operation::put_object_acl::builders::PutObjectAclOutputBuilder {
        super::operation::put_object_acl::builders::PutObjectAclOutputBuilder::default()
    }
}
...
impl PutObjectAclOutputBuilder {
    ...
    pub fn build(self) -> super::operation::put_object_acl::PutObjectAclOutput {
