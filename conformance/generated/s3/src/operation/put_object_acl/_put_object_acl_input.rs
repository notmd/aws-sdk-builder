...
pub struct PutObjectAclInput {
    ...
    pub access_control_policy: ::std::option::Option<super::types::AccessControlPolicy>,
...
impl PutObjectAclInput {
    ...
    /// <p>Contains the elements that set the ACL permissions for an object per grantee.</p>
    pub fn access_control_policy(&self) -> ::std::option::Option<&super::types::AccessControlPolicy> {
...
impl PutObjectAclInput {
    ...
    pub fn builder() -> super::operation::put_object_acl::builders::PutObjectAclInputBuilder {
        super::operation::put_object_acl::builders::PutObjectAclInputBuilder::default()
    }
}
...
pub struct PutObjectAclInputBuilder {
    ...
    pub(crate) access_control_policy: ::std::option::Option<super::types::AccessControlPolicy>,
...
impl PutObjectAclInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::put_object_acl::PutObjectAclInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::put_object_acl::PutObjectAclInput {
            acl: self.acl,
