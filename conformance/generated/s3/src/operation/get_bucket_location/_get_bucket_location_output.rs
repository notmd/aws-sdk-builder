...
impl super::s3_request_id::RequestIdExt for GetBucketLocationOutput {
...
impl GetBucketLocationOutput {
    ...
    pub fn builder() -> super::operation::get_bucket_location::builders::GetBucketLocationOutputBuilder {
        super::operation::get_bucket_location::builders::GetBucketLocationOutputBuilder::default()
    }
}
...
impl GetBucketLocationOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_bucket_location::GetBucketLocationOutput {
