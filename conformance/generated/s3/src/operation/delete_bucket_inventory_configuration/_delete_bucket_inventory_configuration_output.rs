...
impl super::s3_request_id::RequestIdExt for DeleteBucketInventoryConfigurationOutput {
...
impl DeleteBucketInventoryConfigurationOutput {
    ...
    pub fn builder() -> super::operation::delete_bucket_inventory_configuration::builders::DeleteBucketInventoryConfigurationOutputBuilder {
...
impl DeleteBucketInventoryConfigurationOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_bucket_inventory_configuration::DeleteBucketInventoryConfigurationOutput {
