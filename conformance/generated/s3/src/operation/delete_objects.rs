...
impl DeleteObjects {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::delete_objects::DeleteObjectsInput,
    ) -> ::std::result::Result<
        super::operation::delete_objects::DeleteObjectsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::delete_objects::DeleteObjectsError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_objects::DeleteObjectsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_objects::DeleteObjectsOutput>()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteObjects")
            ...
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                super::http_request_checksum::RequestChecksumInterceptor::new(
                    |input: &::aws_smithy_runtime_api::client::interceptors::context::Input| {
                        let input: &super::operation::delete_objects::DeleteObjectsInput = input.downcast_ref().expect("correct type");
            ...
            .with_retry_classifier(
                ::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::operation::delete_objects::DeleteObjectsError>::builder()
                    .transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteObjectsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_objects::de_delete_objects_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_objects::de_delete_objects_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteObjectsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_objects::DeleteObjectsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_objects::DeleteObjectsInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::protocol_serde::shape_delete_objects::ser_delete_objects_headers(input, builder)?;
        ...
        let body =
            ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_delete_objects_input::ser_delete_http_payload(&input.delete)?);
...
impl super::s3_request_id::RequestIdExt for super::operation::delete_objects::DeleteObjectsError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::delete_objects::DeleteObjectsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_objects::_delete_objects_input::DeleteObjectsInput;

pub use super::operation::delete_objects::_delete_objects_output::DeleteObjectsOutput;
