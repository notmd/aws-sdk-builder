...
pub mod _delete_objects_input {
    include!(concat!(env!("OUT_DIR"), "/generated/s3/src/operation/delete_objects/_delete_objects_input.rs"));
}
pub use _delete_objects_input::DeleteObjectsInput;
pub type Input = DeleteObjectsInput;
pub mod _delete_objects_output {
    include!(concat!(env!("OUT_DIR"), "/generated/s3/src/operation/delete_objects/_delete_objects_output.rs"));
}
pub use _delete_objects_output::DeleteObjectsOutput;
pub type Output = DeleteObjectsOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/s3/src/operation/delete_objects/builders.rs"));
}
