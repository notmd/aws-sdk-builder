...
impl super::s3_request_id::RequestIdExt for ListObjectsOutput {
...
impl ListObjectsOutput {
    ...
    pub fn builder() -> super::operation::list_objects::builders::ListObjectsOutputBuilder {
        super::operation::list_objects::builders::ListObjectsOutputBuilder::default()
    }
}
...
impl ListObjectsOutputBuilder {
    ...
    pub fn build(self) -> super::operation::list_objects::ListObjectsOutput {
