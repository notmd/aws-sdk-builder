...
pub struct Builder {
    input: super::_delete_bucket_cors_input::DeleteBucketCorsInputBuilder,
...
impl Builder {
    ...
    pub async fn send(self) -> ::std::result::Result<super::DeleteBucketCorsOutput, super::DeleteBucketCorsError> {
        let input = self
            .input
            .build()
            .map_err(|error| super::DeleteBucketCorsError::Unhandled(error.to_string()))?;
        let bucket = input
            .bucket
            .as_deref()
            .ok_or_else(|| super::DeleteBucketCorsError::Unhandled("DeleteBucketCors requires bucket".to_owned()))?;
        let path = {
        ...
        let response = self
            ...
            .await
            .map_err(super::DeleteBucketCorsError::Unhandled)?;
        let status = response.status();
        if !status.is_success() {
            return Err(super::DeleteBucketCorsError::unhandled_with_request_ids(
                format!("DeleteBucketCors returned HTTP {}", status),
