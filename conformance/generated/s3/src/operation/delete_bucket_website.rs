// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output;
        pub type DeleteBucketWebsiteInput = Input;
        pub type DeleteBucketWebsiteOutput = Output;
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::DeleteBucketWebsiteOutput, super::DeleteBucketWebsiteError> {
                         let bucket = self.input.bucket.as_deref().ok_or_else(|| super::DeleteBucketWebsiteError::Unhandled("DeleteBucketWebsite requires bucket".to_owned()))?;
                         ...
                         let response = self.client.request(super::super::super::transport::Method::Delete, &path, &headers, &body).await.map_err(super::DeleteBucketWebsiteError::Unhandled)?;
