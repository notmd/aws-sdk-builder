...
pub mod _delete_bucket_website_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/delete_bucket_website/_delete_bucket_website_input.rs"
    ));
}
...
pub mod _delete_bucket_website_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/delete_bucket_website/_delete_bucket_website_output.rs"
    ));
}
