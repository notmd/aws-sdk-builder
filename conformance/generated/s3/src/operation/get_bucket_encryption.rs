// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        pub type GetBucketEncryptionInput = Input;
        pub type GetBucketEncryptionOutput = Output;
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::GetBucketEncryptionOutput, super::GetBucketEncryptionError> {
                         let bucket = self.input.bucket.as_deref().ok_or_else(|| super::GetBucketEncryptionError::Unhandled("GetBucketEncryption requires bucket".to_owned()))?;
                         ...
                         Ok(super::GetBucketEncryptionOutput::default())
                     }
                 }
}
