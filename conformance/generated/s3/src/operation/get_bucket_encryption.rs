...
pub mod _get_bucket_encryption_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/get_bucket_encryption/_get_bucket_encryption_input.rs"
    ));
}
...
pub mod _get_bucket_encryption_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/s3/src/operation/get_bucket_encryption/_get_bucket_encryption_output.rs"
    ));
}
