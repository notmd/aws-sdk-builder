...
impl super::s3_request_id::RequestIdExt for PutObjectLockConfigurationOutput {
...
impl PutObjectLockConfigurationOutput {
    ...
    pub fn builder() -> super::operation::put_object_lock_configuration::builders::PutObjectLockConfigurationOutputBuilder {
        super::operation::put_object_lock_configuration::builders::PutObjectLockConfigurationOutputBuilder::default()
    }
}
...
impl PutObjectLockConfigurationOutputBuilder {
    ...
    pub fn build(self) -> super::operation::put_object_lock_configuration::PutObjectLockConfigurationOutput {
