    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::copy_object::CopyObjectError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::copy_object::CopyObjectOutput>()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CopyObject")
            ...
            .with_retry_classifier(
                ::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<super::operation::copy_object::CopyObjectError>::builder()
                    .transient_errors({
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CopyObjectResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_copy_object::de_copy_object_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_copy_object::de_copy_object_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CopyObjectRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::copy_object::CopyObjectInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::copy_object::CopyObjectInput,
            ...
            fn update_http_builder(
                ...
                let builder = super::protocol_serde::shape_copy_object::ser_copy_object_headers(input, builder)?;
...
impl super::s3_request_id::RequestIdExt for super::operation::copy_object::CopyObjectError {
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::operation::copy_object::CopyObjectError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::copy_object::_copy_object_input::CopyObjectInput;

pub use super::operation::copy_object::_copy_object_output::CopyObjectOutput;
