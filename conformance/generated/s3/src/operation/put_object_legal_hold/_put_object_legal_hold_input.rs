...
pub struct PutObjectLegalHoldInput {
    ...
    pub legal_hold: ::std::option::Option<super::types::ObjectLockLegalHold>,
...
impl PutObjectLegalHoldInput {
    ...
    /// <p>Container element for the legal hold configuration you want to apply to the specified object.</p>
    pub fn legal_hold(&self) -> ::std::option::Option<&super::types::ObjectLockLegalHold> {
...
impl PutObjectLegalHoldInput {
    ...
    pub fn builder() -> super::operation::put_object_legal_hold::builders::PutObjectLegalHoldInputBuilder {
        super::operation::put_object_legal_hold::builders::PutObjectLegalHoldInputBuilder::default()
    }
}
...
pub struct PutObjectLegalHoldInputBuilder {
    ...
    pub(crate) legal_hold: ::std::option::Option<super::types::ObjectLockLegalHold>,
...
impl PutObjectLegalHoldInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::put_object_legal_hold::PutObjectLegalHoldInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::put_object_legal_hold::PutObjectLegalHoldInput {
            bucket: self.bucket,
            key: self.key,
