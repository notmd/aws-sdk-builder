...
impl super::s3_request_id::RequestIdExt for PutObjectLegalHoldOutput {
...
impl PutObjectLegalHoldOutput {
    ...
    pub fn builder() -> super::operation::put_object_legal_hold::builders::PutObjectLegalHoldOutputBuilder {
        super::operation::put_object_legal_hold::builders::PutObjectLegalHoldOutputBuilder::default()
    }
}
...
impl PutObjectLegalHoldOutputBuilder {
    ...
    pub fn build(self) -> super::operation::put_object_legal_hold::PutObjectLegalHoldOutput {
