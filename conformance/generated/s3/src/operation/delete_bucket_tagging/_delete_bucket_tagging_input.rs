...
impl DeleteBucketTaggingInput {
    pub fn builder() -> DeleteBucketTaggingInputBuilder { DeleteBucketTaggingInputBuilder::default() }
}
#[derive(Clone, Debug, Default)]
...
impl DeleteBucketTaggingInputBuilder {
    ...
    pub fn build(self) -> DeleteBucketTaggingInput { DeleteBucketTaggingInput {
        bucket: self.bucket,
