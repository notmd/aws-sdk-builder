...
pub mod _delete_bucket_metrics_configuration_input {
    include!(concat!(env!("OUT_DIR"), "/generated/s3/src/operation/delete_bucket_metrics_configuration/_delete_bucket_metrics_configuration_input.rs"));
}
pub use _delete_bucket_metrics_configuration_input::DeleteBucketMetricsConfigurationInput;
pub type Input = DeleteBucketMetricsConfigurationInput;
pub mod _delete_bucket_metrics_configuration_output {
    include!(concat!(env!("OUT_DIR"), "/generated/s3/src/operation/delete_bucket_metrics_configuration/_delete_bucket_metrics_configuration_output.rs"));
}
pub use _delete_bucket_metrics_configuration_output::DeleteBucketMetricsConfigurationOutput;
pub type Output = DeleteBucketMetricsConfigurationOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/s3/src/operation/delete_bucket_metrics_configuration/builders.rs"));
}
