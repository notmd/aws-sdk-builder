...
> {
    ...
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::complete_multipart_upload::CompleteMultipartUploadError::unhandled)?;
    generic_builder = super::s3_request_id::apply_extended_request_id(generic_builder, _response_headers);
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(super::operation::complete_multipart_upload::CompleteMultipartUploadError::generic(
        generic,
    ))
}
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::complete_multipart_upload::builders::CompleteMultipartUploadOutputBuilder::default();
        output = super::protocol_serde::shape_complete_multipart_upload::de_complete_multipart_upload(_response_body, output)
            .map_err(super::operation::complete_multipart_upload::CompleteMultipartUploadError::unhandled)?;
        output = output.set_bucket_key_enabled(
            super::protocol_serde::shape_complete_multipart_upload_output::de_bucket_key_enabled_header(_response_headers).map_err(|_| {
                super::operation::complete_multipart_upload::CompleteMultipartUploadError::unhandled(
                    "Failed to parse BucketKeyEnabled from header `x-amz-server-side-encryption-bucket-key-enabled",
                )
            })?,
        );
        output = output.set_expiration(
            super::protocol_serde::shape_complete_multipart_upload_output::de_expiration_header(_response_headers).map_err(|_| {
                super::operation::complete_multipart_upload::CompleteMultipartUploadError::unhandled(
        ...
        output = output.set_request_charged(
            super::protocol_serde::shape_complete_multipart_upload_output::de_request_charged_header(_response_headers).map_err(|_| {
                super::operation::complete_multipart_upload::CompleteMultipartUploadError::unhandled(
        ...
        output = output.set_ssekms_key_id(
            super::protocol_serde::shape_complete_multipart_upload_output::de_ssekms_key_id_header(_response_headers).map_err(|_| {
                super::operation::complete_multipart_upload::CompleteMultipartUploadError::unhandled(
        ...
        output = output.set_server_side_encryption(
            super::protocol_serde::shape_complete_multipart_upload_output::de_server_side_encryption_header(_response_headers).map_err(|_| {
                super::operation::complete_multipart_upload::CompleteMultipartUploadError::unhandled(
        ...
        output = output.set_version_id(
            super::protocol_serde::shape_complete_multipart_upload_output::de_version_id_header(_response_headers).map_err(|_| {
                super::operation::complete_multipart_upload::CompleteMultipartUploadError::unhandled(
...
pub fn de_complete_multipart_upload(
    inp: &[u8],
    mut builder: super::operation::complete_multipart_upload::builders::CompleteMultipartUploadOutputBuilder,
) -> std::result::Result<
    super::operation::complete_multipart_upload::builders::CompleteMultipartUploadOutputBuilder,
