...
> {
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::select_object_content::builders::SelectObjectContentOutputBuilder::default();
        output = output.set_payload(Some(super::protocol_serde::shape_select_object_content_output::de_payload_payload(
            _response_body,
        )?));
        ...
        output
            .build()
            .map_err(super::operation::select_object_content::SelectObjectContentError::unhandled)?
    })
}
...
> {
    ...
    Err(super::operation::select_object_content::SelectObjectContentError::generic(generic))
}
...
pub fn ser_select_object_content_op_input(
    ...
    let mut out = String::new();
    {
        ...
        super::protocol_serde::shape_select_object_content_input::ser_select_object_content_input_input_input(input, root)?
    }
