...
pub fn ser_record_expiration(
    input: &super::types::RecordExpiration,
...
pub fn de_record_expiration(
    ...
    depth: u32,
) -> ::std::result::Result<super::types::RecordExpiration, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::types::RecordExpiration::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("Expiration") /* Expiration com.amazonaws.s3#RecordExpiration$Expiration */ =>  {
                let var_2 =
                    Some(
                        Result::<super::types::ExpirationState, ::aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            super::types::ExpirationState::from(
    ...
    Ok(super::serde_util::record_expiration_correct_errors(builder)
        .build()
