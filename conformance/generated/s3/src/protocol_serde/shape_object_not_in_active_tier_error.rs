...
pub fn de_object_not_in_active_tier_error_xml_err(
    inp: &[u8],
    mut builder: super::types::error::builders::ObjectNotInActiveTierErrorBuilder,
) -> std::result::Result<super::types::error::builders::ObjectNotInActiveTierErrorBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    if inp.is_empty() {
        return Ok(builder);
    }
