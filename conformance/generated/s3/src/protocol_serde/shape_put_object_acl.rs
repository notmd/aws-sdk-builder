...
pub fn de_put_object_acl_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::put_object_acl::PutObjectAclOutput, super::operation::put_object_acl::PutObjectAclError> {
    #[allow(unused_mut)]
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::put_object_acl::PutObjectAclError::unhandled)?;
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::put_object_acl::PutObjectAclError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "NoSuchKey" => super::operation::put_object_acl::PutObjectAclError::NoSuchKey({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::put_object_acl::PutObjectAclError::generic(generic),
    })
}
...
pub fn de_put_object_acl_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::put_object_acl::builders::PutObjectAclOutputBuilder::default();
        output = output.set_request_charged(
            super::protocol_serde::shape_put_object_acl_output::de_request_charged_header(_response_headers).map_err(|_| {
                super::operation::put_object_acl::PutObjectAclError::unhandled("Failed to parse RequestCharged from header `x-amz-request-charged")
            })?,
        );
