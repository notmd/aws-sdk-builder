...
pub fn ser_encryption_configuration(
    input: &super::types::EncryptionConfiguration,
...
pub fn de_encryption_configuration(
    ...
    depth: u32,
) -> ::std::result::Result<super::types::EncryptionConfiguration, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::types::EncryptionConfiguration::builder();
