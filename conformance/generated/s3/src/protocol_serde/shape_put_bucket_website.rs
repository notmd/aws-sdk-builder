...
pub fn de_put_bucket_website_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::put_bucket_website::PutBucketWebsiteOutput, super::operation::put_bucket_website::PutBucketWebsiteError> {
    #[allow(unused_mut)]
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::put_bucket_website::PutBucketWebsiteError::unhandled)?;
    generic_builder = super::s3_request_id::apply_extended_request_id(generic_builder, _response_headers);
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(super::operation::put_bucket_website::PutBucketWebsiteError::generic(generic))
}
...
pub fn de_put_bucket_website_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::put_bucket_website::builders::PutBucketWebsiteOutputBuilder::default();
