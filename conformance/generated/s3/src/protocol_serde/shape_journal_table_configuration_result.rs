...
pub fn de_journal_table_configuration_result(
    ...
    depth: u32,
) -> ::std::result::Result<super::types::JournalTableConfigurationResult, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::types::JournalTableConfigurationResult::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("RecordExpiration") /* RecordExpiration com.amazonaws.s3#JournalTableConfigurationResult$RecordExpiration */ =>  {
                let var_5 =
                    Some(
                        super::protocol_serde::shape_record_expiration::de_record_expiration(&mut tag, depth + 1)
                        ?
                    )
                ;
    ...
    Ok(super::serde_util::journal_table_configuration_result_correct_errors(builder)
        .build()
