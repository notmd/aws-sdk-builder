...
pub fn de_get_object_acl_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::get_object_acl::GetObjectAclOutput, super::operation::get_object_acl::GetObjectAclError> {
    #[allow(unused_mut)]
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::get_object_acl::GetObjectAclError::unhandled)?;
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::get_object_acl::GetObjectAclError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "NoSuchKey" => super::operation::get_object_acl::GetObjectAclError::NoSuchKey({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::get_object_acl::GetObjectAclError::generic(generic),
    })
}
...
pub fn de_get_object_acl_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::get_object_acl::builders::GetObjectAclOutputBuilder::default();
        output = super::protocol_serde::shape_get_object_acl::de_get_object_acl(_response_body, output)
            .map_err(super::operation::get_object_acl::GetObjectAclError::unhandled)?;
        output = output.set_request_charged(
            super::protocol_serde::shape_get_object_acl_output::de_request_charged_header(_response_headers).map_err(|_| {
                super::operation::get_object_acl::GetObjectAclError::unhandled("Failed to parse RequestCharged from header `x-amz-request-charged")
            })?,
        );
...
pub fn de_get_object_acl(
    inp: &[u8],
    mut builder: super::operation::get_object_acl::builders::GetObjectAclOutputBuilder,
) -> std::result::Result<super::operation::get_object_acl::builders::GetObjectAclOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("AccessControlList") /* Grants com.amazonaws.s3.synthetic#GetObjectAclOutput$Grants */ =>  {
                let var_6 =
                    Some(
                        super::protocol_serde::shape_grants::de_grants(&mut tag, depth + 1)
                        ?
                    )
                ;
