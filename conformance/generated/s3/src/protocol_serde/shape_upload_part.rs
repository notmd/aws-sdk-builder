...
pub fn de_upload_part_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::upload_part::builders::UploadPartOutputBuilder::default();
        output = output.set_bucket_key_enabled(
            super::protocol_serde::shape_upload_part_output::de_bucket_key_enabled_header(_response_headers).map_err(|_| {
                super::operation::upload_part::UploadPartError::unhandled(
        ...
        output = output.set_checksum_crc32(
            super::protocol_serde::shape_upload_part_output::de_checksum_crc32_header(_response_headers).map_err(|_| {
                super::operation::upload_part::UploadPartError::unhandled("Failed to parse ChecksumCRC32 from header `x-amz-checksum-crc32")
            })?,
        );
        output = output.set_checksum_crc32_c(
            super::protocol_serde::shape_upload_part_output::de_checksum_crc32_c_header(_response_headers).map_err(|_| {
                super::operation::upload_part::UploadPartError::unhandled("Failed to parse ChecksumCRC32C from header `x-amz-checksum-crc32c")
            })?,
        );
        output = output.set_checksum_crc64_nvme(
            super::protocol_serde::shape_upload_part_output::de_checksum_crc64_nvme_header(_response_headers).map_err(|_| {
                super::operation::upload_part::UploadPartError::unhandled("Failed to parse ChecksumCRC64NVME from header `x-amz-checksum-crc64nvme")
            })?,
        );
        output = output.set_checksum_md5(
            super::protocol_serde::shape_upload_part_output::de_checksum_md5_header(_response_headers).map_err(|_| {
                super::operation::upload_part::UploadPartError::unhandled("Failed to parse ChecksumMD5 from header `x-amz-checksum-md5")
            })?,
        );
        output = output.set_checksum_sha1(
            super::protocol_serde::shape_upload_part_output::de_checksum_sha1_header(_response_headers).map_err(|_| {
                super::operation::upload_part::UploadPartError::unhandled("Failed to parse ChecksumSHA1 from header `x-amz-checksum-sha1")
            })?,
        );
        output = output.set_checksum_sha256(
            super::protocol_serde::shape_upload_part_output::de_checksum_sha256_header(_response_headers).map_err(|_| {
                super::operation::upload_part::UploadPartError::unhandled("Failed to parse ChecksumSHA256 from header `x-amz-checksum-sha256")
            })?,
        );
        output = output.set_checksum_sha512(
            super::protocol_serde::shape_upload_part_output::de_checksum_sha512_header(_response_headers).map_err(|_| {
                super::operation::upload_part::UploadPartError::unhandled("Failed to parse ChecksumSHA512 from header `x-amz-checksum-sha512")
            })?,
        );
        output = output.set_checksum_xxhash128(
            super::protocol_serde::shape_upload_part_output::de_checksum_xxhash128_header(_response_headers).map_err(|_| {
                super::operation::upload_part::UploadPartError::unhandled("Failed to parse ChecksumXXHASH128 from header `x-amz-checksum-xxhash128")
            })?,
        );
        output = output.set_checksum_xxhash3(
            super::protocol_serde::shape_upload_part_output::de_checksum_xxhash3_header(_response_headers).map_err(|_| {
                super::operation::upload_part::UploadPartError::unhandled("Failed to parse ChecksumXXHASH3 from header `x-amz-checksum-xxhash3")
            })?,
        );
        output = output.set_checksum_xxhash64(
            super::protocol_serde::shape_upload_part_output::de_checksum_xxhash64_header(_response_headers).map_err(|_| {
                super::operation::upload_part::UploadPartError::unhandled("Failed to parse ChecksumXXHASH64 from header `x-amz-checksum-xxhash64")
            })?,
        );
        output = output.set_e_tag(
            super::protocol_serde::shape_upload_part_output::de_e_tag_header(_response_headers)
                .map_err(|_| super::operation::upload_part::UploadPartError::unhandled("Failed to parse ETag from header `ETag"))?,
        );
        output = output.set_request_charged(
            super::protocol_serde::shape_upload_part_output::de_request_charged_header(_response_headers).map_err(|_| {
                super::operation::upload_part::UploadPartError::unhandled("Failed to parse RequestCharged from header `x-amz-request-charged")
            })?,
        );
        output = output.set_sse_customer_algorithm(
            super::protocol_serde::shape_upload_part_output::de_sse_customer_algorithm_header(_response_headers).map_err(|_| {
                super::operation::upload_part::UploadPartError::unhandled(
        ...
        output = output.set_sse_customer_key_md5(
            super::protocol_serde::shape_upload_part_output::de_sse_customer_key_md5_header(_response_headers).map_err(|_| {
                super::operation::upload_part::UploadPartError::unhandled(
        ...
        output = output.set_ssekms_key_id(
            super::protocol_serde::shape_upload_part_output::de_ssekms_key_id_header(_response_headers).map_err(|_| {
                super::operation::upload_part::UploadPartError::unhandled(
        ...
        output = output.set_server_side_encryption(
            super::protocol_serde::shape_upload_part_output::de_server_side_encryption_header(_response_headers).map_err(|_| {
                super::operation::upload_part::UploadPartError::unhandled(
...
pub fn ser_upload_part_headers(
    input: &super::operation::upload_part::UploadPartInput,
