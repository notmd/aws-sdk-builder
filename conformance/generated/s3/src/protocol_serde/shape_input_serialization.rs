...
pub fn ser_input_serialization(
    input: &super::types::InputSerialization,
    ...
    if let Some(var_1) = &input.csv {
        ...
        super::protocol_serde::shape_csv_input::ser_csv_input(var_1, inner_writer)?
    }
    ...
    if let Some(var_3) = &input.json {
        ...
        super::protocol_serde::shape_json_input::ser_json_input(var_3, inner_writer)?
    }
