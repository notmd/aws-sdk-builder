...
pub fn de_destination_result(
    ...
    depth: u32,
) -> ::std::result::Result<super::types::DestinationResult, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::types::DestinationResult::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("TableBucketType") /* TableBucketType com.amazonaws.s3#DestinationResult$TableBucketType */ =>  {
                let var_1 =
                    Some(
                        Result::<super::types::S3TablesBucketType, ::aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            super::types::S3TablesBucketType::from(
