...
pub(crate) fn de_copy_object_result_payload(
    body: &[u8],
) -> std::result::Result<::std::option::Option<super::types::CopyObjectResult>, super::operation::copy_object::CopyObjectError> {
    (!body.is_empty())
        .then(|| {
            super::protocol_serde::shape_copy_object_output::de_copy_object_result(body)
...
pub fn de_copy_object_result(inp: &[u8]) -> std::result::Result<super::types::CopyObjectResult, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    let depth = 0u32;
    super::protocol_serde::shape_copy_object_result::de_copy_object_result(&mut decoder, depth + 1)
}
