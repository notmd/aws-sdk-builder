...
pub fn ser_create_bucket_configuration(
    ...
    if let Some(var_2) = &input.location {
        ...
        super::protocol_serde::shape_location_info::ser_location_info(var_2, inner_writer)?
    }
    if let Some(var_3) = &input.bucket {
        let inner_writer = scope.start_el("Bucket");
        super::protocol_serde::shape_bucket_info::ser_bucket_info(var_3, inner_writer)?
    }
        ...
        for list_item_5 in var_4 {
            {
                ...
                super::protocol_serde::shape_tag::ser_tag(list_item_5, inner_writer)?
            }
        }
    }
    scope.finish();
