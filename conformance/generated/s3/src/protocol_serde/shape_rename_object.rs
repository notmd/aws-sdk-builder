...
pub fn de_rename_object_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::rename_object::RenameObjectOutput, super::operation::rename_object::RenameObjectError> {
    #[allow(unused_mut)]
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::rename_object::RenameObjectError::unhandled)?;
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::rename_object::RenameObjectError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "IdempotencyParameterMismatch" => super::operation::rename_object::RenameObjectError::IdempotencyParameterMismatch({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                let mut output = super::types::error::builders::IdempotencyParameterMismatchBuilder::default();
                output =
                    super::protocol_serde::shape_idempotency_parameter_mismatch::de_idempotency_parameter_mismatch_xml_err(_response_body, output)
                        .map_err(super::operation::rename_object::RenameObjectError::unhandled)?;
        ...
        _ => super::operation::rename_object::RenameObjectError::generic(generic),
    })
}
...
pub fn de_rename_object_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::rename_object::builders::RenameObjectOutputBuilder::default();
