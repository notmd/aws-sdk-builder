...
) -> std::result::Result<::aws_smithy_types::byte_stream::ByteStream, super::operation::get_object::GetObjectError> {
...
> {
    ...
    let out: std::result::Result<_, _> = headers.map(|(key, header_name)| {
                            ...
                            super::protocol_serde::shape_get_object_output::de_metadata_inner(values).map(|v| (key.to_string(), v.expect(
