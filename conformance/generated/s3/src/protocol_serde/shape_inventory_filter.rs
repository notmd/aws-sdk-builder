...
pub fn de_inventory_filter(
    ...
    depth: u32,
) -> ::std::result::Result<super::types::InventoryFilter, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::types::InventoryFilter::builder();
    ...
    Ok(super::serde_util::inventory_filter_correct_errors(builder)
        .build()
        .map_err(|_| ::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}

pub fn ser_inventory_filter(
    input: &super::types::InventoryFilter,
