...
pub fn ser_replication_time_value(
    input: &super::types::ReplicationTimeValue,
...
pub fn de_replication_time_value(
    ...
    depth: u32,
) -> ::std::result::Result<super::types::ReplicationTimeValue, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::types::ReplicationTimeValue::builder();
