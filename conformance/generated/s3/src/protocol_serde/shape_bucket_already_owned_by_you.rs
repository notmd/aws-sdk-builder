...
pub fn de_bucket_already_owned_by_you_xml_err(
    inp: &[u8],
    mut builder: super::types::error::builders::BucketAlreadyOwnedByYouBuilder,
) -> std::result::Result<super::types::error::builders::BucketAlreadyOwnedByYouBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    if inp.is_empty() {
        return Ok(builder);
    }
