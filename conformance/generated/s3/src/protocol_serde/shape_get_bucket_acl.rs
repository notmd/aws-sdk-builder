...
pub fn de_get_bucket_acl_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::get_bucket_acl::GetBucketAclOutput, super::operation::get_bucket_acl::GetBucketAclError> {
    #[allow(unused_mut)]
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::get_bucket_acl::GetBucketAclError::unhandled)?;
    generic_builder = super::s3_request_id::apply_extended_request_id(generic_builder, _response_headers);
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(super::operation::get_bucket_acl::GetBucketAclError::generic(generic))
}
...
pub fn de_get_bucket_acl_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::get_bucket_acl::builders::GetBucketAclOutputBuilder::default();
        output = super::protocol_serde::shape_get_bucket_acl::de_get_bucket_acl(_response_body, output)
            .map_err(super::operation::get_bucket_acl::GetBucketAclError::unhandled)?;
...
pub fn de_get_bucket_acl(
    inp: &[u8],
    mut builder: super::operation::get_bucket_acl::builders::GetBucketAclOutputBuilder,
) -> std::result::Result<super::operation::get_bucket_acl::builders::GetBucketAclOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
