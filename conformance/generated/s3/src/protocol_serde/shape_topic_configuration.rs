...
pub fn de_topic_configuration(
    ...
    depth: u32,
) -> ::std::result::Result<super::types::TopicConfiguration, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::types::TopicConfiguration::builder();
    ...
    Ok(super::serde_util::topic_configuration_correct_errors(builder)
        .build()
        .map_err(|_| ::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}

pub fn ser_topic_configuration(
    input: &super::types::TopicConfiguration,
