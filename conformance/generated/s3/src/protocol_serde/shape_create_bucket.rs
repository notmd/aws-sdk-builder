...
pub fn de_create_bucket_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::create_bucket::CreateBucketOutput, super::operation::create_bucket::CreateBucketError> {
    #[allow(unused_mut)]
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::create_bucket::CreateBucketError::unhandled)?;
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::create_bucket::CreateBucketError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "BucketAlreadyExists" => super::operation::create_bucket::CreateBucketError::BucketAlreadyExists({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                let mut output = super::types::error::builders::BucketAlreadyExistsBuilder::default();
                output = super::protocol_serde::shape_bucket_already_exists::de_bucket_already_exists_xml_err(_response_body, output)
                    .map_err(super::operation::create_bucket::CreateBucketError::unhandled)?;
        ...
        "BucketAlreadyOwnedByYou" => super::operation::create_bucket::CreateBucketError::BucketAlreadyOwnedByYou({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                let mut output = super::types::error::builders::BucketAlreadyOwnedByYouBuilder::default();
                output = super::protocol_serde::shape_bucket_already_owned_by_you::de_bucket_already_owned_by_you_xml_err(_response_body, output)
                    .map_err(super::operation::create_bucket::CreateBucketError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
        ...
        _ => super::operation::create_bucket::CreateBucketError::generic(generic),
    })
}
...
pub fn de_create_bucket_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::create_bucket::builders::CreateBucketOutputBuilder::default();
        output = output.set_bucket_arn(
            super::protocol_serde::shape_create_bucket_output::de_bucket_arn_header(_response_headers).map_err(|_| {
                super::operation::create_bucket::CreateBucketError::unhandled("Failed to parse BucketArn from header `x-amz-bucket-arn")
            })?,
        );
        output = output.set_location(
            super::protocol_serde::shape_create_bucket_output::de_location_header(_response_headers)
                .map_err(|_| super::operation::create_bucket::CreateBucketError::unhandled("Failed to parse Location from header `Location"))?,
        );
