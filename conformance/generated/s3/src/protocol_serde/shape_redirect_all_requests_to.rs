...
pub fn de_redirect_all_requests_to(
    ...
    depth: u32,
) -> ::std::result::Result<super::types::RedirectAllRequestsTo, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::types::RedirectAllRequestsTo::builder();
    ...
    Ok(super::serde_util::redirect_all_requests_to_correct_errors(builder)
        .build()
        .map_err(|_| ::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}

pub fn ser_redirect_all_requests_to(
    input: &super::types::RedirectAllRequestsTo,
