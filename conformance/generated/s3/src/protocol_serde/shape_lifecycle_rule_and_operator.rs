...
pub fn de_lifecycle_rule_and_operator(
    ...
    depth: u32,
) -> ::std::result::Result<super::types::LifecycleRuleAndOperator, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::types::LifecycleRuleAndOperator::builder();
...
pub fn ser_lifecycle_rule_and_operator(
    input: &super::types::LifecycleRuleAndOperator,
        ...
        for list_item_8 in var_7 {
            {
                ...
                super::protocol_serde::shape_tag::ser_tag(list_item_8, inner_writer)?
            }
        }
    }
