...
pub fn de_lifecycle_rule(
    ...
    depth: u32,
) -> ::std::result::Result<super::types::LifecycleRule, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::types::LifecycleRule::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("Expiration") /* Expiration com.amazonaws.s3#LifecycleRule$Expiration */ =>  {
                let var_1 =
                    Some(
                        super::protocol_serde::shape_lifecycle_expiration::de_lifecycle_expiration(&mut tag, depth + 1)
                        ?
                    )
                ;
            ...
            s if s.matches("Filter") /* Filter com.amazonaws.s3#LifecycleRule$Filter */ =>  {
                let var_4 =
                    Some(
                        super::protocol_serde::shape_lifecycle_rule_filter::de_lifecycle_rule_filter(&mut tag, depth + 1)
                        ?
                    )
                ;
            ...
            s if s.matches("Status") /* Status com.amazonaws.s3#LifecycleRule$Status */ =>  {
                let var_5 =
                    Some(
                        Result::<super::types::ExpirationStatus, ::aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            super::types::ExpirationStatus::from(
                                ::aws_smithy_xml::decode::try_data(&mut tag)?.as_ref()
                            )
                        )
                        ?
            ...
            s if s.matches("Transition") /* Transitions com.amazonaws.s3#LifecycleRule$Transitions */ =>  {
                let var_6 =
                    Some(
                        Result::<::std::vec::Vec::<super::types::Transition>, ::aws_smithy_xml::decode::XmlDecodeError>::Ok({
                            let mut list_7 = builder.transitions.take().unwrap_or_default();
                            list_7.push(
                                super::protocol_serde::shape_transition::de_transition(&mut tag, depth + 1)
                                ?
                            );
                            list_7
                        })
            ...
            s if s.matches("NoncurrentVersionTransition") /* NoncurrentVersionTransitions com.amazonaws.s3#LifecycleRule$NoncurrentVersionTransitions */ =>  {
                let var_8 =
                    Some(
                        Result::<::std::vec::Vec::<super::types::NoncurrentVersionTransition>, ::aws_smithy_xml::decode::XmlDecodeError>::Ok({
                            let mut list_9 = builder.noncurrent_version_transitions.take().unwrap_or_default();
                            list_9.push(
                                super::protocol_serde::shape_noncurrent_version_transition::de_noncurrent_version_transition(&mut tag, depth + 1)
                                ?
                            );
                            list_9
                        })
            ...
            s if s.matches("NoncurrentVersionExpiration") /* NoncurrentVersionExpiration com.amazonaws.s3#LifecycleRule$NoncurrentVersionExpiration */ =>  {
                let var_10 =
                    Some(
                        super::protocol_serde::shape_noncurrent_version_expiration::de_noncurrent_version_expiration(&mut tag, depth + 1)
                        ?
                    )
                ;
            ...
            s if s.matches("AbortIncompleteMultipartUpload") /* AbortIncompleteMultipartUpload com.amazonaws.s3#LifecycleRule$AbortIncompleteMultipartUpload */ =>  {
                let var_11 =
                    Some(
                        super::protocol_serde::shape_abort_incomplete_multipart_upload::de_abort_incomplete_multipart_upload(&mut tag, depth + 1)
                        ?
                    )
                ;
    ...
    Ok(super::serde_util::lifecycle_rule_correct_errors(builder)
        .build()
        .map_err(|_| ::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}

pub fn ser_lifecycle_rule(
    input: &super::types::LifecycleRule,
    ...
    if let Some(var_12) = &input.expiration {
        ...
        super::protocol_serde::shape_lifecycle_expiration::ser_lifecycle_expiration(var_12, inner_writer)?
    }
    ...
    if let Some(var_15) = &input.filter {
        ...
        super::protocol_serde::shape_lifecycle_rule_filter::ser_lifecycle_rule_filter(var_15, inner_writer)?
    }
    {
        ...
        for list_item_17 in var_16 {
            {
                ...
                super::protocol_serde::shape_transition::ser_transition(list_item_17, inner_writer)?
            }
        }
    }
        ...
        for list_item_19 in var_18 {
            {
                ...
                super::protocol_serde::shape_noncurrent_version_transition::ser_noncurrent_version_transition(list_item_19, inner_writer)?
            }
        }
    }
    if let Some(var_20) = &input.noncurrent_version_expiration {
        let inner_writer = scope.start_el("NoncurrentVersionExpiration");
        super::protocol_serde::shape_noncurrent_version_expiration::ser_noncurrent_version_expiration(var_20, inner_writer)?
    }
    if let Some(var_21) = &input.abort_incomplete_multipart_upload {
        let inner_writer = scope.start_el("AbortIncompleteMultipartUpload");
        super::protocol_serde::shape_abort_incomplete_multipart_upload::ser_abort_incomplete_multipart_upload(var_21, inner_writer)?
    }
    scope.finish();
    Ok(())
}
