...
pub fn de_get_bucket_metadata_table_configuration_http_error(
...
> {
    ...
    Err(super::operation::get_bucket_metadata_table_configuration::GetBucketMetadataTableConfigurationError::generic(generic))
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_get_bucket_metadata_table_configuration_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = output.set_get_bucket_metadata_table_configuration_result(
            super::protocol_serde::shape_get_bucket_metadata_table_configuration_output::de_get_bucket_metadata_table_configuration_result_payload(
                _response_body,
            )?,
        );
