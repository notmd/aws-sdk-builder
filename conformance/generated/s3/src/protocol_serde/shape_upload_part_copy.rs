...
pub fn de_upload_part_copy_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::upload_part_copy::UploadPartCopyOutput, super::operation::upload_part_copy::UploadPartCopyError> {
    #[allow(unused_mut)]
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::upload_part_copy::UploadPartCopyError::unhandled)?;
    generic_builder = super::s3_request_id::apply_extended_request_id(generic_builder, _response_headers);
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(super::operation::upload_part_copy::UploadPartCopyError::generic(generic))
}
...
pub fn de_upload_part_copy_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::upload_part_copy::builders::UploadPartCopyOutputBuilder::default();
        output = output.set_bucket_key_enabled(
            super::protocol_serde::shape_upload_part_copy_output::de_bucket_key_enabled_header(_response_headers).map_err(|_| {
                super::operation::upload_part_copy::UploadPartCopyError::unhandled(
                    "Failed to parse BucketKeyEnabled from header `x-amz-server-side-encryption-bucket-key-enabled",
                )
            })?,
        );
        output = output.set_copy_part_result(super::protocol_serde::shape_upload_part_copy_output::de_copy_part_result_payload(
            _response_body,
        )?);
        output = output.set_copy_source_version_id(
            super::protocol_serde::shape_upload_part_copy_output::de_copy_source_version_id_header(_response_headers).map_err(|_| {
                super::operation::upload_part_copy::UploadPartCopyError::unhandled(
        ...
        output = output.set_request_charged(
            super::protocol_serde::shape_upload_part_copy_output::de_request_charged_header(_response_headers).map_err(|_| {
                super::operation::upload_part_copy::UploadPartCopyError::unhandled(
        ...
        output = output.set_sse_customer_algorithm(
            super::protocol_serde::shape_upload_part_copy_output::de_sse_customer_algorithm_header(_response_headers).map_err(|_| {
                super::operation::upload_part_copy::UploadPartCopyError::unhandled(
        ...
        output = output.set_sse_customer_key_md5(
            super::protocol_serde::shape_upload_part_copy_output::de_sse_customer_key_md5_header(_response_headers).map_err(|_| {
                super::operation::upload_part_copy::UploadPartCopyError::unhandled(
        ...
        output = output.set_ssekms_key_id(
            super::protocol_serde::shape_upload_part_copy_output::de_ssekms_key_id_header(_response_headers).map_err(|_| {
                super::operation::upload_part_copy::UploadPartCopyError::unhandled(
        ...
        output = output.set_server_side_encryption(
            super::protocol_serde::shape_upload_part_copy_output::de_server_side_encryption_header(_response_headers).map_err(|_| {
                super::operation::upload_part_copy::UploadPartCopyError::unhandled(
