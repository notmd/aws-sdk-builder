...
pub fn de_get_bucket_abac_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::get_bucket_abac::GetBucketAbacOutput, super::operation::get_bucket_abac::GetBucketAbacError> {
    #[allow(unused_mut)]
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::get_bucket_abac::GetBucketAbacError::unhandled)?;
    generic_builder = super::s3_request_id::apply_extended_request_id(generic_builder, _response_headers);
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(super::operation::get_bucket_abac::GetBucketAbacError::generic(generic))
}
...
pub fn de_get_bucket_abac_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::get_bucket_abac::builders::GetBucketAbacOutputBuilder::default();
        output = output.set_abac_status(super::protocol_serde::shape_get_bucket_abac_output::de_abac_status_payload(
            _response_body,
        )?);
