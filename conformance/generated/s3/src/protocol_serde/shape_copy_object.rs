...
pub fn de_copy_object_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::copy_object::CopyObjectOutput, super::operation::copy_object::CopyObjectError> {
    #[allow(unused_mut)]
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::copy_object::CopyObjectError::unhandled)?;
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::copy_object::CopyObjectError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "ObjectNotInActiveTierError" => super::operation::copy_object::CopyObjectError::ObjectNotInActiveTierError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                let mut output = super::types::error::builders::ObjectNotInActiveTierErrorBuilder::default();
                output =
                    super::protocol_serde::shape_object_not_in_active_tier_error::de_object_not_in_active_tier_error_xml_err(_response_body, output)
                        .map_err(super::operation::copy_object::CopyObjectError::unhandled)?;
        ...
        _ => super::operation::copy_object::CopyObjectError::generic(generic),
    })
}
...
pub fn de_copy_object_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::copy_object::builders::CopyObjectOutputBuilder::default();
        output = output.set_bucket_key_enabled(
            super::protocol_serde::shape_copy_object_output::de_bucket_key_enabled_header(_response_headers).map_err(|_| {
                super::operation::copy_object::CopyObjectError::unhandled(
                    "Failed to parse BucketKeyEnabled from header `x-amz-server-side-encryption-bucket-key-enabled",
                )
            })?,
        );
        output = output.set_copy_object_result(super::protocol_serde::shape_copy_object_output::de_copy_object_result_payload(
            _response_body,
        )?);
        output = output.set_copy_source_version_id(
            super::protocol_serde::shape_copy_object_output::de_copy_source_version_id_header(_response_headers).map_err(|_| {
                super::operation::copy_object::CopyObjectError::unhandled(
        ...
        output = output.set_expiration(
            super::protocol_serde::shape_copy_object_output::de_expiration_header(_response_headers)
                .map_err(|_| super::operation::copy_object::CopyObjectError::unhandled("Failed to parse Expiration from header `x-amz-expiration"))?,
        );
        output = output.set_request_charged(
            super::protocol_serde::shape_copy_object_output::de_request_charged_header(_response_headers).map_err(|_| {
                super::operation::copy_object::CopyObjectError::unhandled("Failed to parse RequestCharged from header `x-amz-request-charged")
            })?,
        );
        output = output.set_sse_customer_algorithm(
            super::protocol_serde::shape_copy_object_output::de_sse_customer_algorithm_header(_response_headers).map_err(|_| {
                super::operation::copy_object::CopyObjectError::unhandled(
        ...
        output = output.set_sse_customer_key_md5(
            super::protocol_serde::shape_copy_object_output::de_sse_customer_key_md5_header(_response_headers).map_err(|_| {
                super::operation::copy_object::CopyObjectError::unhandled(
        ...
        output = output.set_ssekms_encryption_context(
            super::protocol_serde::shape_copy_object_output::de_ssekms_encryption_context_header(_response_headers).map_err(|_| {
                super::operation::copy_object::CopyObjectError::unhandled(
        ...
        output = output.set_ssekms_key_id(
            super::protocol_serde::shape_copy_object_output::de_ssekms_key_id_header(_response_headers).map_err(|_| {
                super::operation::copy_object::CopyObjectError::unhandled(
        ...
        output = output.set_server_side_encryption(
            super::protocol_serde::shape_copy_object_output::de_server_side_encryption_header(_response_headers).map_err(|_| {
                super::operation::copy_object::CopyObjectError::unhandled(
        ...
        output = output.set_version_id(
            super::protocol_serde::shape_copy_object_output::de_version_id_header(_response_headers)
                .map_err(|_| super::operation::copy_object::CopyObjectError::unhandled("Failed to parse VersionId from header `x-amz-version-id"))?,
        );
...
pub fn ser_copy_object_headers(
    input: &super::operation::copy_object::CopyObjectInput,
    ...
    if let ::std::option::Option::Some(inner_79) = &input.expected_bucket_owner {
    ...
    if let ::std::option::Option::Some(inner_81) = &input.expected_source_bucket_owner {
    ...
    if let ::std::option::Option::Some(inner_83) = &input.metadata {
        {
            for (k, v) in inner_83 {
                use std::str::FromStr;
