...
pub fn de_grant(
    ...
    depth: u32,
) -> ::std::result::Result<super::types::Grant, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::types::Grant::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("Permission") /* Permission com.amazonaws.s3#Grant$Permission */ =>  {
                let var_4 =
                    Some(
                        Result::<super::types::Permission, ::aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            super::types::Permission::from(
