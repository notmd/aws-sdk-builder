...
pub fn de_not_found_xml_err(
    inp: &[u8],
    mut builder: super::types::error::builders::NotFoundBuilder,
) -> std::result::Result<super::types::error::builders::NotFoundBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    if inp.is_empty() {
        return Ok(builder);
    }
