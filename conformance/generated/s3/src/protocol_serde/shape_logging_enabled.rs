...
pub fn de_logging_enabled(
    ...
    depth: u32,
) -> ::std::result::Result<super::types::LoggingEnabled, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::types::LoggingEnabled::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("TargetGrants") /* TargetGrants com.amazonaws.s3#LoggingEnabled$TargetGrants */ =>  {
                let var_2 =
                    Some(
                        super::protocol_serde::shape_target_grants::de_target_grants(&mut tag, depth + 1)
                        ?
                    )
                ;
            ...
            s if s.matches("TargetObjectKeyFormat") /* TargetObjectKeyFormat com.amazonaws.s3#LoggingEnabled$TargetObjectKeyFormat */ =>  {
                let var_4 =
                    Some(
                        super::protocol_serde::shape_target_object_key_format::de_target_object_key_format(&mut tag, depth + 1)
                        ?
                    )
                ;
    ...
    Ok(super::serde_util::logging_enabled_correct_errors(builder)
        .build()
        .map_err(|_| ::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}

pub fn ser_logging_enabled(
    input: &super::types::LoggingEnabled,
        ...
        for list_item_6 in var_5 {
            {
                ...
                super::protocol_serde::shape_target_grant::ser_target_grant(list_item_6, inner_writer)?
            }
        }
    }
    {
    ...
    if let Some(var_7) = &input.target_object_key_format {
        ...
        super::protocol_serde::shape_target_object_key_format::ser_target_object_key_format(var_7, inner_writer)?
    }
    scope.finish();
    Ok(())
}
