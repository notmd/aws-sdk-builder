...
> {
    ...
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::list_bucket_inventory_configurations::ListBucketInventoryConfigurationsError::unhandled)?;
    generic_builder = super::s3_request_id::apply_extended_request_id(generic_builder, _response_headers);
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(super::operation::list_bucket_inventory_configurations::ListBucketInventoryConfigurationsError::generic(generic))
}
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::list_bucket_inventory_configurations::builders::ListBucketInventoryConfigurationsOutputBuilder::default();
        output = super::protocol_serde::shape_list_bucket_inventory_configurations::de_list_bucket_inventory_configurations(_response_body, output)
            .map_err(super::operation::list_bucket_inventory_configurations::ListBucketInventoryConfigurationsError::unhandled)?;
...
pub fn de_list_bucket_inventory_configurations(
    inp: &[u8],
    mut builder: super::operation::list_bucket_inventory_configurations::builders::ListBucketInventoryConfigurationsOutputBuilder,
) -> std::result::Result<
    super::operation::list_bucket_inventory_configurations::builders::ListBucketInventoryConfigurationsOutputBuilder,
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("InventoryConfiguration") /* InventoryConfigurationList com.amazonaws.s3.synthetic#ListBucketInventoryConfigurationsOutput$InventoryConfigurationList */ =>  {
                let var_6 =
                    Some(
                        Result::<::std::vec::Vec::<super::types::InventoryConfiguration>, ::aws_smithy_xml::decode::XmlDecodeError>::Ok({
                            let mut list_7 = builder.inventory_configuration_list.take().unwrap_or_default();
                            list_7.push(
                                super::protocol_serde::shape_inventory_configuration::de_inventory_configuration(&mut tag, depth + 1)
                                ?
                            );
                            list_7
                        })
