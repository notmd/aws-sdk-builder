...
pub(crate) fn de_copy_part_result_payload(
    body: &[u8],
) -> std::result::Result<::std::option::Option<super::types::CopyPartResult>, super::operation::upload_part_copy::UploadPartCopyError> {
    (!body.is_empty())
        .then(|| {
            super::protocol_serde::shape_upload_part_copy_output::de_copy_part_result(body)
...
pub fn de_copy_part_result(inp: &[u8]) -> std::result::Result<super::types::CopyPartResult, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    let depth = 0u32;
    super::protocol_serde::shape_copy_part_result::de_copy_part_result(&mut decoder, depth + 1)
}
