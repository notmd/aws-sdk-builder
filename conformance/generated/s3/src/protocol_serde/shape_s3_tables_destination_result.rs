...
pub fn de_s3_tables_destination_result(
    ...
    depth: u32,
) -> ::std::result::Result<super::types::S3TablesDestinationResult, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::types::S3TablesDestinationResult::builder();
    ...
    Ok(super::serde_util::s3_tables_destination_result_correct_errors(builder)
        .build()
