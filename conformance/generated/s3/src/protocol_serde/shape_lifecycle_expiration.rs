...
pub fn de_lifecycle_expiration(
    ...
    depth: u32,
) -> ::std::result::Result<super::types::LifecycleExpiration, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::types::LifecycleExpiration::builder();
...
pub fn ser_lifecycle_expiration(
    input: &super::types::LifecycleExpiration,
