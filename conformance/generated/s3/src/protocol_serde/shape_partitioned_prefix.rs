...
pub fn de_partitioned_prefix(
    ...
    depth: u32,
) -> ::std::result::Result<super::types::PartitionedPrefix, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::types::PartitionedPrefix::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("PartitionDateSource") /* PartitionDateSource com.amazonaws.s3#PartitionedPrefix$PartitionDateSource */ =>  {
                let var_1 =
                    Some(
                        Result::<super::types::PartitionDateSource, ::aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            super::types::PartitionDateSource::from(
...
pub fn ser_partitioned_prefix(
    input: &super::types::PartitionedPrefix,
