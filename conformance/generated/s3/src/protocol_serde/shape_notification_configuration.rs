        ...
        for list_item_2 in var_1 {
            {
                ...
                super::protocol_serde::shape_topic_configuration::ser_topic_configuration(list_item_2, inner_writer)?
            }
        }
    }
        ...
        for list_item_4 in var_3 {
            {
                ...
                super::protocol_serde::shape_queue_configuration::ser_queue_configuration(list_item_4, inner_writer)?
            }
        }
    }
        ...
        for list_item_6 in var_5 {
            {
                ...
                super::protocol_serde::shape_lambda_function_configuration::ser_lambda_function_configuration(list_item_6, inner_writer)?
            }
        }
    }
