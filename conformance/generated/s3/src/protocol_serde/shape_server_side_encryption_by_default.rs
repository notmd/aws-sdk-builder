...
pub fn ser_server_side_encryption_by_default(
    input: &super::types::ServerSideEncryptionByDefault,
...
pub fn de_server_side_encryption_by_default(
    ...
    depth: u32,
) -> ::std::result::Result<super::types::ServerSideEncryptionByDefault, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::types::ServerSideEncryptionByDefault::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("SSEAlgorithm") /* SSEAlgorithm com.amazonaws.s3#ServerSideEncryptionByDefault$SSEAlgorithm */ =>  {
                let var_2 =
                    Some(
                        Result::<super::types::ServerSideEncryption, ::aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            super::types::ServerSideEncryption::from(
    ...
    Ok(super::serde_util::server_side_encryption_by_default_correct_errors(builder)
        .build()
