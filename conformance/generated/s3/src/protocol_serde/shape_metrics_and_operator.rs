...
pub fn de_metrics_and_operator(
    ...
    depth: u32,
) -> ::std::result::Result<super::types::MetricsAndOperator, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("maximum nesting depth exceeded"));
    }
    #[allow(unused_mut)]
    let mut builder = super::types::MetricsAndOperator::builder();
...
pub fn ser_metrics_and_operator(
    input: &super::types::MetricsAndOperator,
        ...
        for list_item_7 in var_6 {
            {
                ...
                super::protocol_serde::shape_tag::ser_tag(list_item_7, inner_writer)?
            }
        }
    }
