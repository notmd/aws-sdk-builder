...
impl super::Client {
    ...
    pub fn delete_bucket_website(&self) -> super::operation::delete_bucket_website::builders::DeleteBucketWebsiteFluentBuilder {
        super::operation::delete_bucket_website::builders::DeleteBucketWebsiteFluentBuilder::new(self.handle.clone())
    }
}
