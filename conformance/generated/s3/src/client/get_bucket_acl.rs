...
impl super::Client {
    ...
    pub fn get_bucket_acl(&self) -> super::operation::get_bucket_acl::builders::GetBucketAclFluentBuilder {
        super::operation::get_bucket_acl::builders::GetBucketAclFluentBuilder::new(self.handle.clone())
    }
}
