...
impl super::Client {
    ...
    pub fn get_bucket_replication(&self) -> super::operation::get_bucket_replication::builders::GetBucketReplicationFluentBuilder {
        super::operation::get_bucket_replication::builders::GetBucketReplicationFluentBuilder::new(self.handle.clone())
    }
}
