...
impl super::Client {
    ...
    pub fn list_directory_buckets(&self) -> super::operation::list_directory_buckets::builders::ListDirectoryBucketsFluentBuilder {
        super::operation::list_directory_buckets::builders::ListDirectoryBucketsFluentBuilder::new(self.handle.clone())
    }
}
