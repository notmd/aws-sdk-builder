...
impl super::Client {
    ...
    pub fn delete_bucket(&self) -> super::operation::delete_bucket::builders::DeleteBucketFluentBuilder {
        super::operation::delete_bucket::builders::DeleteBucketFluentBuilder::new(self.handle.clone())
    }
}
