...
impl super::Client {
    ...
    pub fn put_bucket_analytics_configuration(
        &self,
    ) -> super::operation::put_bucket_analytics_configuration::builders::PutBucketAnalyticsConfigurationFluentBuilder {
        super::operation::put_bucket_analytics_configuration::builders::PutBucketAnalyticsConfigurationFluentBuilder::new(self.handle.clone())
    }
}
