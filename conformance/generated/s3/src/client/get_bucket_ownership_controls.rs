...
impl super::Client {
    ...
    pub fn get_bucket_ownership_controls(
        &self,
    ) -> super::operation::get_bucket_ownership_controls::builders::GetBucketOwnershipControlsFluentBuilder {
        super::operation::get_bucket_ownership_controls::builders::GetBucketOwnershipControlsFluentBuilder::new(self.handle.clone())
    }
}
