...
impl super::Client {
    ...
    pub fn get_bucket_request_payment(&self) -> super::operation::get_bucket_request_payment::builders::GetBucketRequestPaymentFluentBuilder {
        super::operation::get_bucket_request_payment::builders::GetBucketRequestPaymentFluentBuilder::new(self.handle.clone())
    }
}
