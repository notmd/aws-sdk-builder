...
impl super::Client {
    ...
    pub fn get_bucket_abac(&self) -> super::operation::get_bucket_abac::builders::GetBucketAbacFluentBuilder {
        super::operation::get_bucket_abac::builders::GetBucketAbacFluentBuilder::new(self.handle.clone())
    }
}
