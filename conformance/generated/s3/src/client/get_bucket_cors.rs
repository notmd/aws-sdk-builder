...
impl super::Client {
    ...
    pub fn get_bucket_cors(&self) -> super::operation::get_bucket_cors::builders::GetBucketCorsFluentBuilder {
        super::operation::get_bucket_cors::builders::GetBucketCorsFluentBuilder::new(self.handle.clone())
    }
}
