...
impl super::Client {
    ...
    pub fn delete_bucket_intelligent_tiering_configuration(
        &self,
    ) -> super::operation::delete_bucket_intelligent_tiering_configuration::builders::DeleteBucketIntelligentTieringConfigurationFluentBuilder {
        super::operation::delete_bucket_intelligent_tiering_configuration::builders::DeleteBucketIntelligentTieringConfigurationFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
