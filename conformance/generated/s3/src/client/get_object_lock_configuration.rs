...
impl super::Client {
    ...
    pub fn get_object_lock_configuration(
        &self,
    ) -> super::operation::get_object_lock_configuration::builders::GetObjectLockConfigurationFluentBuilder {
        super::operation::get_object_lock_configuration::builders::GetObjectLockConfigurationFluentBuilder::new(self.handle.clone())
    }
}
