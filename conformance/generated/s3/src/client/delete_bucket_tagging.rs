...
impl super::Client {
    ...
    pub fn delete_bucket_tagging(&self) -> super::operation::delete_bucket_tagging::builders::DeleteBucketTaggingFluentBuilder {
        super::operation::delete_bucket_tagging::builders::DeleteBucketTaggingFluentBuilder::new(self.handle.clone())
    }
}
