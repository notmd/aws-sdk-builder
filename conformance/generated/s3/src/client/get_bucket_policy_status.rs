...
impl super::Client {
    ...
    pub fn get_bucket_policy_status(&self) -> super::operation::get_bucket_policy_status::builders::GetBucketPolicyStatusFluentBuilder {
        super::operation::get_bucket_policy_status::builders::GetBucketPolicyStatusFluentBuilder::new(self.handle.clone())
    }
}
