...
impl super::Client {
    ...
    pub fn get_bucket_website(&self) -> super::operation::get_bucket_website::builders::GetBucketWebsiteFluentBuilder {
        super::operation::get_bucket_website::builders::GetBucketWebsiteFluentBuilder::new(self.handle.clone())
    }
}
