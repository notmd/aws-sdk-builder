...
impl super::Client {
    ...
    pub fn get_bucket_tagging(&self) -> super::operation::get_bucket_tagging::builders::GetBucketTaggingFluentBuilder {
        super::operation::get_bucket_tagging::builders::GetBucketTaggingFluentBuilder::new(self.handle.clone())
    }
}
