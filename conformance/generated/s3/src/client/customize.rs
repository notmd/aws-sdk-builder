...
impl<E, B> CustomizableOperation<super::operation::put_object::PutObjectOutput, E, B> {
...
impl<E, B> CustomizableOperation<super::operation::upload_part::UploadPartOutput, E, B> {
    /// Disable payload signing for this request.
    ///
    /// **WARNING:** This is an advanced feature that removes
    /// the cost of signing a request payload by removing a data
...
impl<T, E, B> CustomizableOperation<T, E, B> {
    ...
    ) -> ::std::result::Result<super::presigning::PresignedRequest, super::error::SdkError<E>>
    where
        E: std::error::Error + ::std::marker::Send + ::std::marker::Sync + 'static,
        B: super::client::customize::internal::CustomizablePresigned<E>,
    {
