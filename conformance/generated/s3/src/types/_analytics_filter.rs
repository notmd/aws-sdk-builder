...
pub enum AnalyticsFilter {
    ...
    And(super::types::AnalyticsAndOperator),
...
impl AnalyticsFilter {
    ...
    pub fn as_and(&self) -> ::std::result::Result<&super::types::AnalyticsAndOperator, &Self> {
    ...
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_tag(&self) -> ::std::result::Result<&super::types::Tag, &Self> {
