...
impl InventoryScheduleBuilder {
    ...
    pub fn set_frequency(mut self, input: ::std::option::Option<crate::types::InventoryFrequency>) -> Self { self.frequency = input; self }
    /// <p>Specifies how frequently inventory results are produced.</p>
    pub fn get_frequency(&self) -> &::std::option::Option<crate::types::InventoryFrequency> { &self.frequency }
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::InventorySchedule, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::InventorySchedule {
            frequency: self.frequency.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("frequency", "frequency was not specified but it is required when building InventorySchedule"))?,
        })
    }
}
