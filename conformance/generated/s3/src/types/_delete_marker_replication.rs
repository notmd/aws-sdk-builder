...
pub struct DeleteMarkerReplication {
    ...
    /// </note>
    pub status: ::std::option::Option<super::types::DeleteMarkerReplicationStatus>,
}
impl DeleteMarkerReplication {
    /// <p>Indicates whether to replicate delete markers.</p><note>
    /// <p>Indicates whether to replicate delete markers.</p>
    /// </note>
    pub fn status(&self) -> ::std::option::Option<&super::types::DeleteMarkerReplicationStatus> {
        self.status.as_ref()
    }
}
impl DeleteMarkerReplication {
    /// Creates a new builder-style object to manufacture [`DeleteMarkerReplication`](crate::types::DeleteMarkerReplication).
    pub fn builder() -> super::types::builders::DeleteMarkerReplicationBuilder {
        super::types::builders::DeleteMarkerReplicationBuilder::default()
    }
}
...
pub struct DeleteMarkerReplicationBuilder {
    pub(crate) status: ::std::option::Option<super::types::DeleteMarkerReplicationStatus>,
}
impl DeleteMarkerReplicationBuilder {
    /// <p>Indicates whether to replicate delete markers.</p><note>
    /// <p>Indicates whether to replicate delete markers.</p>
    /// </note>
    pub fn status(mut self, input: super::types::DeleteMarkerReplicationStatus) -> Self {
    ...
    /// <p>Indicates whether to replicate delete markers.</p>
    /// </note>
    pub fn set_status(mut self, input: ::std::option::Option<super::types::DeleteMarkerReplicationStatus>) -> Self {
        self.status = input;
        self
    }
    /// <p>Indicates whether to replicate delete markers.</p><note>
    /// <p>Indicates whether to replicate delete markers.</p>
    /// </note>
    pub fn get_status(&self) -> &::std::option::Option<super::types::DeleteMarkerReplicationStatus> {
        &self.status
    }
    /// Consumes the builder and constructs a [`DeleteMarkerReplication`](crate::types::DeleteMarkerReplication).
    pub fn build(self) -> super::types::DeleteMarkerReplication {
        super::types::DeleteMarkerReplication { status: self.status }
    }
}
