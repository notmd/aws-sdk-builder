...
impl PolicyStatus {
    ...
    pub fn builder() -> super::types::builders::PolicyStatusBuilder {
        super::types::builders::PolicyStatusBuilder::default()
    }
}
...
impl PolicyStatusBuilder {
    ...
    pub fn build(self) -> super::types::PolicyStatus {
        super::types::PolicyStatus { is_public: self.is_public }
    }
}
