...
impl ObjectPart {
    ...
    pub fn builder() -> super::types::builders::ObjectPartBuilder {
        super::types::builders::ObjectPartBuilder::default()
    }
}
...
impl ObjectPartBuilder {
    ...
    pub fn build(self) -> super::types::ObjectPart {
        super::types::ObjectPart {
