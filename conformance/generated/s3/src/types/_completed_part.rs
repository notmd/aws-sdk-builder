...
impl CompletedPart {
    ...
    pub fn builder() -> super::types::builders::CompletedPartBuilder {
        super::types::builders::CompletedPartBuilder::default()
    }
}
...
impl CompletedPartBuilder {
    ...
    pub fn build(self) -> super::types::CompletedPart {
        super::types::CompletedPart {
            e_tag: self.e_tag,
