...
impl NotificationConfiguration {
    ...
    pub fn builder() -> super::types::builders::NotificationConfigurationBuilder {
        super::types::builders::NotificationConfigurationBuilder::default()
    }
}
...
impl NotificationConfigurationBuilder {
    ...
    pub fn build(self) -> super::types::NotificationConfiguration {
        super::types::NotificationConfiguration {
