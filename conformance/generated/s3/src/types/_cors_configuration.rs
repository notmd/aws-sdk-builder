...
pub struct CorsConfiguration {
    ...
    pub cors_rules: ::std::vec::Vec<super::types::CorsRule>,
}
...
impl CorsConfiguration {
    ...
    pub fn builder() -> super::types::builders::CorsConfigurationBuilder {
        super::types::builders::CorsConfigurationBuilder::default()
    }
}
...
impl CorsConfigurationBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::CorsConfiguration, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::CorsConfiguration {
