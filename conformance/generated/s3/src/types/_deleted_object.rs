...
impl DeletedObject {
    ...
    pub fn builder() -> super::types::builders::DeletedObjectBuilder {
        super::types::builders::DeletedObjectBuilder::default()
    }
}
...
impl DeletedObjectBuilder {
    ...
    pub fn build(self) -> super::types::DeletedObject {
        super::types::DeletedObject {
            key: self.key,
