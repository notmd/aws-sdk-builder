...
impl NoncurrentVersionExpiration {
    ...
    pub fn builder() -> super::types::builders::NoncurrentVersionExpirationBuilder {
        super::types::builders::NoncurrentVersionExpirationBuilder::default()
    }
}
...
impl NoncurrentVersionExpirationBuilder {
    ...
    pub fn build(self) -> super::types::NoncurrentVersionExpiration {
        super::types::NoncurrentVersionExpiration {
