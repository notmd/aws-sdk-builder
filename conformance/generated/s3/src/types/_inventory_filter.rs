...
impl InventoryFilter {
    ...
    pub fn builder() -> super::types::builders::InventoryFilterBuilder {
        super::types::builders::InventoryFilterBuilder::default()
    }
}
...
impl InventoryFilterBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::InventoryFilter, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::InventoryFilter {
