...
impl InventoryTableConfigurationResult {
    ...
    pub fn builder() -> super::types::builders::InventoryTableConfigurationResultBuilder {
        super::types::builders::InventoryTableConfigurationResultBuilder::default()
    }
}
...
impl InventoryTableConfigurationResultBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::InventoryTableConfigurationResult, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::InventoryTableConfigurationResult {
