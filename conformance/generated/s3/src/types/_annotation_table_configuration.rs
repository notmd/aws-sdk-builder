...
impl AnnotationTableConfigurationBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::AnnotationTableConfiguration, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::AnnotationTableConfiguration {
            configuration_state: self.configuration_state.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("configuration_state", "configuration_state was not specified but it is required when building AnnotationTableConfiguration"))?,
