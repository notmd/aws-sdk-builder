...
impl Ssekms {
    ...
    pub fn builder() -> super::types::builders::SsekmsBuilder {
        super::types::builders::SsekmsBuilder::default()
    }
}
...
impl SsekmsBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::Ssekms, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::Ssekms {
