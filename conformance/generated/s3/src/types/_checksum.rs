...
impl Checksum {
    ...
    pub fn builder() -> super::types::builders::ChecksumBuilder {
        super::types::builders::ChecksumBuilder::default()
    }
}
...
impl ChecksumBuilder {
    ...
    pub fn build(self) -> super::types::Checksum {
        super::types::Checksum {
