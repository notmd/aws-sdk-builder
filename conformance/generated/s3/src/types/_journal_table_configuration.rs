...
impl JournalTableConfiguration {
    ...
    pub fn builder() -> super::types::builders::JournalTableConfigurationBuilder {
        super::types::builders::JournalTableConfigurationBuilder::default()
    }
}
...
impl JournalTableConfigurationBuilder {
    ...
    pub fn build(self) -> super::types::JournalTableConfiguration {
        super::types::JournalTableConfiguration {
