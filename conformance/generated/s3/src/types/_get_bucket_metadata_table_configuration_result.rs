...
pub struct GetBucketMetadataTableConfigurationResult {
    ...
    pub metadata_table_configuration_result: ::std::option::Option<super::types::MetadataTableConfigurationResult>,
...
impl GetBucketMetadataTableConfigurationResult {
    /// <p>The V1 S3 Metadata configuration for a general purpose bucket.</p>
    pub fn metadata_table_configuration_result(&self) -> ::std::option::Option<&super::types::MetadataTableConfigurationResult> {
...
impl GetBucketMetadataTableConfigurationResult {
    ...
    pub fn builder() -> super::types::builders::GetBucketMetadataTableConfigurationResultBuilder {
        super::types::builders::GetBucketMetadataTableConfigurationResultBuilder::default()
    }
}
...
pub struct GetBucketMetadataTableConfigurationResultBuilder {
    pub(crate) metadata_table_configuration_result: ::std::option::Option<super::types::MetadataTableConfigurationResult>,
...
impl GetBucketMetadataTableConfigurationResultBuilder {
    ...
    pub fn metadata_table_configuration_result(mut self, input: super::types::MetadataTableConfigurationResult) -> Self {
        self.metadata_table_configuration_result = ::std::option::Option::Some(input);
        self
    }
    /// <p>The V1 S3 Metadata configuration for a general purpose bucket.</p>
    pub fn set_metadata_table_configuration_result(mut self, input: ::std::option::Option<super::types::MetadataTableConfigurationResult>) -> Self {
        self.metadata_table_configuration_result = input;
        self
    }
    /// <p>The V1 S3 Metadata configuration for a general purpose bucket.</p>
    pub fn get_metadata_table_configuration_result(&self) -> &::std::option::Option<super::types::MetadataTableConfigurationResult> {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::types::GetBucketMetadataTableConfigurationResult, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::GetBucketMetadataTableConfigurationResult {
