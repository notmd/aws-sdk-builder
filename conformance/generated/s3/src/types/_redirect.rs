...
impl Redirect {
    ...
    pub fn builder() -> super::types::builders::RedirectBuilder {
        super::types::builders::RedirectBuilder::default()
    }
}
...
impl RedirectBuilder {
    ...
    pub fn build(self) -> super::types::Redirect {
        super::types::Redirect {
