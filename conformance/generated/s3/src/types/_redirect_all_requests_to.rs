...
pub struct RedirectAllRequestsTo {
    ...
    pub protocol: ::std::option::Option<super::types::Protocol>,
}
impl RedirectAllRequestsTo {
    ...
    /// <p>Protocol to use when redirecting requests. The default is the protocol that is used in the original request.</p>
    pub fn protocol(&self) -> ::std::option::Option<&super::types::Protocol> {
        self.protocol.as_ref()
    }
}
impl RedirectAllRequestsTo {
    /// Creates a new builder-style object to manufacture [`RedirectAllRequestsTo`](crate::types::RedirectAllRequestsTo).
    pub fn builder() -> super::types::builders::RedirectAllRequestsToBuilder {
        super::types::builders::RedirectAllRequestsToBuilder::default()
    }
}
...
pub struct RedirectAllRequestsToBuilder {
    ...
    pub(crate) protocol: ::std::option::Option<super::types::Protocol>,
}
impl RedirectAllRequestsToBuilder {
    ...
    /// <p>Protocol to use when redirecting requests. The default is the protocol that is used in the original request.</p>
    pub fn protocol(mut self, input: super::types::Protocol) -> Self {
        self.protocol = ::std::option::Option::Some(input);
        self
    }
    /// <p>Protocol to use when redirecting requests. The default is the protocol that is used in the original request.</p>
    pub fn set_protocol(mut self, input: ::std::option::Option<super::types::Protocol>) -> Self {
        self.protocol = input;
        self
    }
    /// <p>Protocol to use when redirecting requests. The default is the protocol that is used in the original request.</p>
    pub fn get_protocol(&self) -> &::std::option::Option<super::types::Protocol> {
        &self.protocol
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::types::RedirectAllRequestsTo, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::RedirectAllRequestsTo {
