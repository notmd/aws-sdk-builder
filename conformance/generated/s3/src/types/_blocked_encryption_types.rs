...
/// <p>This data type is used with the following actions:</p><ul><li><p><a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_PutBucketEncryption.html">PutBucketEncryption</a></p></li><li><p><a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_GetBucketEncryption.html">GetBucketEncryption</a></p></li><li><p><a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_DeleteBucketEncryption.html">DeleteBucketEncryption</a></p></li></ul> <dl><dt>Permissions</dt> <dd><p>You must have the <code>s3:PutEncryptionConfiguration</code> permission to block or unblock an encryption type for a bucket.</p>
/// <p>You must have the <code>s3:GetEncryptionConfiguration</code> permission to view a bucket's encryption type.</p></dd></dl>
#[non_exhaustive]
...
impl BlockedEncryptionTypesBuilder {
    ...
    pub fn set_encryption_type(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::EncryptionType>>) -> Self { self.encryption_type = input; self }
    /// <p>The object encryption type that you want to block or unblock for an Amazon S3 general purpose bucket.</p><note>
    /// <p>Currently, this parameter only supports blocking or unblocking server side encryption with customer-provided keys (SSE-C). For more information about SSE-C, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/ServerSideEncryptionCustomerKeys.html">Using server-side encryption with customer-provided keys (SSE-C)</a>.</p>
    /// </note>
    pub fn get_encryption_type(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::EncryptionType>> { &self.encryption_type }
