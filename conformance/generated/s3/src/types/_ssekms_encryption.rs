...
impl SsekmsEncryption {
    ...
    pub fn builder() -> super::types::builders::SsekmsEncryptionBuilder {
        super::types::builders::SsekmsEncryptionBuilder::default()
    }
}
...
impl SsekmsEncryptionBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::SsekmsEncryption, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::SsekmsEncryption {
