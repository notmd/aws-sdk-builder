...
impl LifecycleRuleAndOperator {
    ...
    pub fn builder() -> super::types::builders::LifecycleRuleAndOperatorBuilder {
        super::types::builders::LifecycleRuleAndOperatorBuilder::default()
    }
}
...
impl LifecycleRuleAndOperatorBuilder {
    ...
    pub fn build(self) -> super::types::LifecycleRuleAndOperator {
        super::types::LifecycleRuleAndOperator {
            prefix: self.prefix,
            tags: self.tags,
