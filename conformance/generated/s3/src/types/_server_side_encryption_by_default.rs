...
pub struct ServerSideEncryptionByDefault {
    ...
    /// </note>
    pub sse_algorithm: super::types::ServerSideEncryption,
...
impl ServerSideEncryptionByDefault {
    ...
    /// <p>For directory buckets, there are only two supported values for server-side encryption: <code>AES256</code> and <code>aws:kms</code>.</p>
    /// </note>
    pub fn sse_algorithm(&self) -> &super::types::ServerSideEncryption {
        &self.sse_algorithm
    }
    /// <p>Amazon Web Services Key Management Service (KMS) customer managed key ID to use for the default encryption.</p><note>
    /// <ul>
...
impl ServerSideEncryptionByDefault {
    ...
    pub fn builder() -> super::types::builders::ServerSideEncryptionByDefaultBuilder {
        super::types::builders::ServerSideEncryptionByDefaultBuilder::default()
    }
}
...
pub struct ServerSideEncryptionByDefaultBuilder {
    pub(crate) sse_algorithm: ::std::option::Option<super::types::ServerSideEncryption>,
...
impl ServerSideEncryptionByDefaultBuilder {
    ...
    pub fn sse_algorithm(mut self, input: super::types::ServerSideEncryption) -> Self {
    ...
    /// <p>For directory buckets, there are only two supported values for server-side encryption: <code>AES256</code> and <code>aws:kms</code>.</p>
    /// </note>
    pub fn set_sse_algorithm(mut self, input: ::std::option::Option<super::types::ServerSideEncryption>) -> Self {
    ...
    /// <p>For directory buckets, there are only two supported values for server-side encryption: <code>AES256</code> and <code>aws:kms</code>.</p>
    /// </note>
    pub fn get_sse_algorithm(&self) -> &::std::option::Option<super::types::ServerSideEncryption> {
        &self.sse_algorithm
    }
    /// <p>Amazon Web Services Key Management Service (KMS) customer managed key ID to use for the default encryption.</p><note>
    /// <ul>
    ...
    pub fn build(self) -> ::std::result::Result<super::types::ServerSideEncryptionByDefault, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ServerSideEncryptionByDefault {
