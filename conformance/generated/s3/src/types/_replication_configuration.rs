...
pub struct ReplicationConfiguration {
    ...
    pub rules: ::std::vec::Vec<super::types::ReplicationRule>,
}
impl ReplicationConfiguration {
    ...
    /// <p>A container for one or more replication rules. A replication configuration must have at least one rule and can contain a maximum of 1,000 rules.</p>
    pub fn rules(&self) -> &[super::types::ReplicationRule] {
        use std::ops::Deref;
        self.rules.deref()
    }
}
impl ReplicationConfiguration {
    ...
    pub fn builder() -> super::types::builders::ReplicationConfigurationBuilder {
        super::types::builders::ReplicationConfigurationBuilder::default()
    }
}
...
pub struct ReplicationConfigurationBuilder {
    ...
    pub(crate) rules: ::std::option::Option<::std::vec::Vec<super::types::ReplicationRule>>,
}
impl ReplicationConfigurationBuilder {
    ...
    ///
    /// <p>A container for one or more replication rules. A replication configuration must have at least one rule and can contain a maximum of 1,000 rules.</p>
    pub fn rules(mut self, input: super::types::ReplicationRule) -> Self {
    ...
    /// <p>A container for one or more replication rules. A replication configuration must have at least one rule and can contain a maximum of 1,000 rules.</p>
    pub fn set_rules(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::ReplicationRule>>) -> Self {
        self.rules = input;
        self
    }
    /// <p>A container for one or more replication rules. A replication configuration must have at least one rule and can contain a maximum of 1,000 rules.</p>
    pub fn get_rules(&self) -> &::std::option::Option<::std::vec::Vec<super::types::ReplicationRule>> {
        &self.rules
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::types::ReplicationConfiguration, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ReplicationConfiguration {
