...
pub struct IntelligentTieringFilter {
    ...
    pub and: ::std::option::Option<super::types::IntelligentTieringAndOperator>,
}
impl IntelligentTieringFilter {
    ...
    /// <p>A conjunction (logical AND) of predicates, which is used in evaluating a metrics filter. The operator must have at least two predicates, and an object must match all of the predicates in order for the filter to apply.</p>
    pub fn and(&self) -> ::std::option::Option<&super::types::IntelligentTieringAndOperator> {
        self.and.as_ref()
    }
}
impl IntelligentTieringFilter {
    /// Creates a new builder-style object to manufacture [`IntelligentTieringFilter`](crate::types::IntelligentTieringFilter).
    pub fn builder() -> super::types::builders::IntelligentTieringFilterBuilder {
        super::types::builders::IntelligentTieringFilterBuilder::default()
    }
}
...
pub struct IntelligentTieringFilterBuilder {
    ...
    pub(crate) and: ::std::option::Option<super::types::IntelligentTieringAndOperator>,
}
impl IntelligentTieringFilterBuilder {
    ...
    /// <p>A conjunction (logical AND) of predicates, which is used in evaluating a metrics filter. The operator must have at least two predicates, and an object must match all of the predicates in order for the filter to apply.</p>
    pub fn and(mut self, input: super::types::IntelligentTieringAndOperator) -> Self {
        self.and = ::std::option::Option::Some(input);
        self
    }
    /// <p>A conjunction (logical AND) of predicates, which is used in evaluating a metrics filter. The operator must have at least two predicates, and an object must match all of the predicates in order for the filter to apply.</p>
    pub fn set_and(mut self, input: ::std::option::Option<super::types::IntelligentTieringAndOperator>) -> Self {
        self.and = input;
        self
    }
    /// <p>A conjunction (logical AND) of predicates, which is used in evaluating a metrics filter. The operator must have at least two predicates, and an object must match all of the predicates in order for the filter to apply.</p>
    pub fn get_and(&self) -> &::std::option::Option<super::types::IntelligentTieringAndOperator> {
        &self.and
    }
    /// Consumes the builder and constructs a [`IntelligentTieringFilter`](crate::types::IntelligentTieringFilter).
    pub fn build(self) -> super::types::IntelligentTieringFilter {
        super::types::IntelligentTieringFilter {
            prefix: self.prefix,
            tag: self.tag,
            and: self.and,
        }
