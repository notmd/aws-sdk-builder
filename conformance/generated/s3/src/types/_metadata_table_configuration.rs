...
pub struct MetadataTableConfiguration {
    ...
    pub s3_tables_destination: ::std::option::Option<super::types::S3TablesDestination>,
}
impl MetadataTableConfiguration {
    /// <p>The destination information for the metadata table configuration. The destination table bucket must be in the same Region and Amazon Web Services account as the general purpose bucket. The specified metadata table name must be unique within the <code>aws_s3_metadata</code> namespace in the destination table bucket.</p>
    pub fn s3_tables_destination(&self) -> ::std::option::Option<&super::types::S3TablesDestination> {
...
impl MetadataTableConfiguration {
    ...
    pub fn builder() -> super::types::builders::MetadataTableConfigurationBuilder {
        super::types::builders::MetadataTableConfigurationBuilder::default()
    }
}
...
pub struct MetadataTableConfigurationBuilder {
    pub(crate) s3_tables_destination: ::std::option::Option<super::types::S3TablesDestination>,
}
impl MetadataTableConfigurationBuilder {
    /// <p>The destination information for the metadata table configuration. The destination table bucket must be in the same Region and Amazon Web Services account as the general purpose bucket. The specified metadata table name must be unique within the <code>aws_s3_metadata</code> namespace in the destination table bucket.</p>
    /// This field is required.
    pub fn s3_tables_destination(mut self, input: super::types::S3TablesDestination) -> Self {
        self.s3_tables_destination = ::std::option::Option::Some(input);
        self
    }
    /// <p>The destination information for the metadata table configuration. The destination table bucket must be in the same Region and Amazon Web Services account as the general purpose bucket. The specified metadata table name must be unique within the <code>aws_s3_metadata</code> namespace in the destination table bucket.</p>
    pub fn set_s3_tables_destination(mut self, input: ::std::option::Option<super::types::S3TablesDestination>) -> Self {
        self.s3_tables_destination = input;
        self
    }
    /// <p>The destination information for the metadata table configuration. The destination table bucket must be in the same Region and Amazon Web Services account as the general purpose bucket. The specified metadata table name must be unique within the <code>aws_s3_metadata</code> namespace in the destination table bucket.</p>
    pub fn get_s3_tables_destination(&self) -> &::std::option::Option<super::types::S3TablesDestination> {
    ...
    pub fn build(self) -> super::types::MetadataTableConfiguration {
        super::types::MetadataTableConfiguration {
