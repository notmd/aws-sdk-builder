...
impl S3TablesDestination {
    ...
    pub fn builder() -> super::types::builders::S3TablesDestinationBuilder {
        super::types::builders::S3TablesDestinationBuilder::default()
    }
}
...
impl S3TablesDestinationBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::S3TablesDestination, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::S3TablesDestination {
