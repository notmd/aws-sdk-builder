...
pub struct ObjectVersion {
    ...
    pub storage_class: ::std::option::Option<super::types::ObjectVersionStorageClass>,
    /// <p>The object key.</p>
    ...
    pub owner: ::std::option::Option<super::types::Owner>,
    ...
    pub restore_status: ::std::option::Option<super::types::RestoreStatus>,
}
impl ObjectVersion {
    /// <p>The entity tag is an MD5 hash of that version of the object.</p>
    ...
    /// <p>The class of storage used to store the object.</p>
    pub fn storage_class(&self) -> ::std::option::Option<&super::types::ObjectVersionStorageClass> {
    ...
    /// <p>Specifies the owner of the object.</p>
    pub fn owner(&self) -> ::std::option::Option<&super::types::Owner> {
        self.owner.as_ref()
    }
    /// <p>Specifies the restoration status of an object. Objects in certain storage classes must be restored before they can be retrieved. For more information about these storage classes and how to work with archived objects, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/archived-objects.html"> Working with archived objects</a> in the <i>Amazon S3 User Guide</i>.</p>
    pub fn restore_status(&self) -> ::std::option::Option<&super::types::RestoreStatus> {
        self.restore_status.as_ref()
    }
}
impl ObjectVersion {
    /// Creates a new builder-style object to manufacture [`ObjectVersion`](crate::types::ObjectVersion).
    pub fn builder() -> super::types::builders::ObjectVersionBuilder {
        super::types::builders::ObjectVersionBuilder::default()
    }
}
...
pub struct ObjectVersionBuilder {
    ...
    pub(crate) storage_class: ::std::option::Option<super::types::ObjectVersionStorageClass>,
    ...
    pub(crate) restore_status: ::std::option::Option<super::types::RestoreStatus>,
}
impl ObjectVersionBuilder {
    ...
    /// <p>The class of storage used to store the object.</p>
    pub fn storage_class(mut self, input: super::types::ObjectVersionStorageClass) -> Self {
        self.storage_class = ::std::option::Option::Some(input);
        self
    }
    /// <p>The class of storage used to store the object.</p>
    pub fn set_storage_class(mut self, input: ::std::option::Option<super::types::ObjectVersionStorageClass>) -> Self {
        self.storage_class = input;
        self
    }
    /// <p>The class of storage used to store the object.</p>
    pub fn get_storage_class(&self) -> &::std::option::Option<super::types::ObjectVersionStorageClass> {
        &self.storage_class
    }
    /// <p>The object key.</p>
    ...
    /// <p>Specifies the restoration status of an object. Objects in certain storage classes must be restored before they can be retrieved. For more information about these storage classes and how to work with archived objects, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/archived-objects.html"> Working with archived objects</a> in the <i>Amazon S3 User Guide</i>.</p>
    pub fn restore_status(mut self, input: super::types::RestoreStatus) -> Self {
        self.restore_status = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies the restoration status of an object. Objects in certain storage classes must be restored before they can be retrieved. For more information about these storage classes and how to work with archived objects, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/archived-objects.html"> Working with archived objects</a> in the <i>Amazon S3 User Guide</i>.</p>
    pub fn set_restore_status(mut self, input: ::std::option::Option<super::types::RestoreStatus>) -> Self {
        self.restore_status = input;
        self
    }
    /// <p>Specifies the restoration status of an object. Objects in certain storage classes must be restored before they can be retrieved. For more information about these storage classes and how to work with archived objects, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/archived-objects.html"> Working with archived objects</a> in the <i>Amazon S3 User Guide</i>.</p>
    pub fn get_restore_status(&self) -> &::std::option::Option<super::types::RestoreStatus> {
        &self.restore_status
    }
    /// Consumes the builder and constructs a [`ObjectVersion`](crate::types::ObjectVersion).
    pub fn build(self) -> super::types::ObjectVersion {
        super::types::ObjectVersion {
            e_tag: self.e_tag,
