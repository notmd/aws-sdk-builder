...
impl CopyObjectResult {
    ...
    pub fn builder() -> super::types::builders::CopyObjectResultBuilder {
        super::types::builders::CopyObjectResultBuilder::default()
    }
}
...
impl CopyObjectResultBuilder {
    ...
    pub fn build(self) -> super::types::CopyObjectResult {
        super::types::CopyObjectResult {
            e_tag: self.e_tag,
