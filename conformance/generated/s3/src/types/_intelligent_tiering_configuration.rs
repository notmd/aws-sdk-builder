...
pub struct IntelligentTieringConfiguration {
    ...
    pub filter: ::std::option::Option<super::types::IntelligentTieringFilter>,
    /// <p>Specifies the status of the configuration.</p>
    pub status: super::types::IntelligentTieringStatus,
    /// <p>Specifies the S3 Intelligent-Tiering storage class tier of the configuration.</p>
    pub tierings: ::std::vec::Vec<super::types::Tiering>,
}
impl IntelligentTieringConfiguration {
    ...
    /// <p>Specifies a bucket filter. The configuration only includes objects that meet the filter's criteria.</p>
    pub fn filter(&self) -> ::std::option::Option<&super::types::IntelligentTieringFilter> {
        self.filter.as_ref()
    }
    /// <p>Specifies the status of the configuration.</p>
    pub fn status(&self) -> &super::types::IntelligentTieringStatus {
        &self.status
    }
    /// <p>Specifies the S3 Intelligent-Tiering storage class tier of the configuration.</p>
    pub fn tierings(&self) -> &[super::types::Tiering] {
        use std::ops::Deref;
        self.tierings.deref()
    }
}
impl IntelligentTieringConfiguration {
    ...
    pub fn builder() -> super::types::builders::IntelligentTieringConfigurationBuilder {
        super::types::builders::IntelligentTieringConfigurationBuilder::default()
    }
}
...
pub struct IntelligentTieringConfigurationBuilder {
    ...
    pub(crate) filter: ::std::option::Option<super::types::IntelligentTieringFilter>,
    pub(crate) status: ::std::option::Option<super::types::IntelligentTieringStatus>,
    pub(crate) tierings: ::std::option::Option<::std::vec::Vec<super::types::Tiering>>,
}
impl IntelligentTieringConfigurationBuilder {
    ...
    /// <p>Specifies a bucket filter. The configuration only includes objects that meet the filter's criteria.</p>
    pub fn filter(mut self, input: super::types::IntelligentTieringFilter) -> Self {
        self.filter = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies a bucket filter. The configuration only includes objects that meet the filter's criteria.</p>
    pub fn set_filter(mut self, input: ::std::option::Option<super::types::IntelligentTieringFilter>) -> Self {
        self.filter = input;
        self
    }
    /// <p>Specifies a bucket filter. The configuration only includes objects that meet the filter's criteria.</p>
    pub fn get_filter(&self) -> &::std::option::Option<super::types::IntelligentTieringFilter> {
        &self.filter
    }
    /// <p>Specifies the status of the configuration.</p>
    /// This field is required.
    pub fn status(mut self, input: super::types::IntelligentTieringStatus) -> Self {
        self.status = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies the status of the configuration.</p>
    pub fn set_status(mut self, input: ::std::option::Option<super::types::IntelligentTieringStatus>) -> Self {
        self.status = input;
        self
    }
    /// <p>Specifies the status of the configuration.</p>
    pub fn get_status(&self) -> &::std::option::Option<super::types::IntelligentTieringStatus> {
        &self.status
    }
    ...
    ///
    /// <p>Specifies the S3 Intelligent-Tiering storage class tier of the configuration.</p>
    pub fn tierings(mut self, input: super::types::Tiering) -> Self {
    ...
    /// <p>Specifies the S3 Intelligent-Tiering storage class tier of the configuration.</p>
    pub fn set_tierings(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::Tiering>>) -> Self {
        self.tierings = input;
        self
    }
    /// <p>Specifies the S3 Intelligent-Tiering storage class tier of the configuration.</p>
    pub fn get_tierings(&self) -> &::std::option::Option<::std::vec::Vec<super::types::Tiering>> {
        &self.tierings
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::types::IntelligentTieringConfiguration, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::IntelligentTieringConfiguration {
