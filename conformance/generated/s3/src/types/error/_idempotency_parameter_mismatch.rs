...
impl super::s3_request_id::RequestIdExt for super::types::error::IdempotencyParameterMismatch {
    fn extended_request_id(&self) -> Option<&str> {
        use ::aws_smithy_types::error::metadata::ProvideErrorMetadata;
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::types::error::IdempotencyParameterMismatch {
...
impl IdempotencyParameterMismatch {
    ...
    pub fn builder() -> super::types::error::builders::IdempotencyParameterMismatchBuilder {
        super::types::error::builders::IdempotencyParameterMismatchBuilder::default()
    }
}
...
impl IdempotencyParameterMismatchBuilder {
    ...
    pub fn build(self) -> super::types::error::IdempotencyParameterMismatch {
        super::types::error::IdempotencyParameterMismatch {
