...
impl super::s3_request_id::RequestIdExt for super::types::error::BucketAlreadyOwnedByYou {
    fn extended_request_id(&self) -> Option<&str> {
        use ::aws_smithy_types::error::metadata::ProvideErrorMetadata;
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::types::error::BucketAlreadyOwnedByYou {
...
impl BucketAlreadyOwnedByYou {
    ...
    pub fn builder() -> super::types::error::builders::BucketAlreadyOwnedByYouBuilder {
        super::types::error::builders::BucketAlreadyOwnedByYouBuilder::default()
    }
}
...
impl BucketAlreadyOwnedByYouBuilder {
    ...
    pub fn build(self) -> super::types::error::BucketAlreadyOwnedByYou {
        super::types::error::BucketAlreadyOwnedByYou {
