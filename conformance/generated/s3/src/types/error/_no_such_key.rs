...
impl super::s3_request_id::RequestIdExt for super::types::error::NoSuchKey {
    fn extended_request_id(&self) -> Option<&str> {
        use ::aws_smithy_types::error::metadata::ProvideErrorMetadata;
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::types::error::NoSuchKey {
...
impl NoSuchKey {
    ...
    pub fn builder() -> super::types::error::builders::NoSuchKeyBuilder {
        super::types::error::builders::NoSuchKeyBuilder::default()
    }
}
...
impl NoSuchKeyBuilder {
    ...
    pub fn build(self) -> super::types::error::NoSuchKey {
        super::types::error::NoSuchKey {
