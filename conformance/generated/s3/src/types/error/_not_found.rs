...
impl super::s3_request_id::RequestIdExt for super::types::error::NotFound {
    fn extended_request_id(&self) -> Option<&str> {
        use ::aws_smithy_types::error::metadata::ProvideErrorMetadata;
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::types::error::NotFound {
...
impl NotFound {
    ...
    pub fn builder() -> super::types::error::builders::NotFoundBuilder {
        super::types::error::builders::NotFoundBuilder::default()
    }
}
...
impl NotFoundBuilder {
    ...
    pub fn build(self) -> super::types::error::NotFound {
        super::types::error::NotFound {
