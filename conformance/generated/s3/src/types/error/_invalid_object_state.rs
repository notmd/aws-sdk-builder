...
pub struct InvalidObjectState {
    ...
    #[allow(missing_docs)] // documentation missing in model
    pub access_tier: ::std::option::Option<super::types::IntelligentTieringAccessTier>,
    #[allow(missing_docs)] // documentation missing in model
...
impl InvalidObjectState {
    ...
    #[allow(missing_docs)] // documentation missing in model
    pub fn access_tier(&self) -> ::std::option::Option<&super::types::IntelligentTieringAccessTier> {
...
impl super::s3_request_id::RequestIdExt for super::types::error::InvalidObjectState {
    fn extended_request_id(&self) -> Option<&str> {
        use ::aws_smithy_types::error::metadata::ProvideErrorMetadata;
        self.meta().extended_request_id()
    }
}
impl ::aws_types::request_id::RequestId for super::types::error::InvalidObjectState {
...
impl InvalidObjectState {
    ...
    pub fn builder() -> super::types::error::builders::InvalidObjectStateBuilder {
        super::types::error::builders::InvalidObjectStateBuilder::default()
    }
}
...
pub struct InvalidObjectStateBuilder {
    ...
    pub(crate) access_tier: ::std::option::Option<super::types::IntelligentTieringAccessTier>,
...
impl InvalidObjectStateBuilder {
    ...
    #[allow(missing_docs)] // documentation missing in model
    pub fn access_tier(mut self, input: super::types::IntelligentTieringAccessTier) -> Self {
        self.access_tier = ::std::option::Option::Some(input);
        self
    }
    #[allow(missing_docs)] // documentation missing in model
    pub fn set_access_tier(mut self, input: ::std::option::Option<super::types::IntelligentTieringAccessTier>) -> Self {
        self.access_tier = input;
        self
    }
    #[allow(missing_docs)] // documentation missing in model
    pub fn get_access_tier(&self) -> &::std::option::Option<super::types::IntelligentTieringAccessTier> {
        &self.access_tier
    }
    #[allow(missing_docs)] // documentation missing in model
    ...
    pub fn build(self) -> super::types::error::InvalidObjectState {
        super::types::error::InvalidObjectState {
