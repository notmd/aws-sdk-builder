...
pub struct ExistingObjectReplication {
    ...
    pub status: super::types::ExistingObjectReplicationStatus,
}
impl ExistingObjectReplication {
    /// <p>Specifies whether Amazon S3 replicates existing source bucket objects.</p>
    pub fn status(&self) -> &super::types::ExistingObjectReplicationStatus {
        &self.status
    }
}
impl ExistingObjectReplication {
    /// Creates a new builder-style object to manufacture [`ExistingObjectReplication`](crate::types::ExistingObjectReplication).
    pub fn builder() -> super::types::builders::ExistingObjectReplicationBuilder {
        super::types::builders::ExistingObjectReplicationBuilder::default()
    }
}
...
pub struct ExistingObjectReplicationBuilder {
    pub(crate) status: ::std::option::Option<super::types::ExistingObjectReplicationStatus>,
}
impl ExistingObjectReplicationBuilder {
    /// <p>Specifies whether Amazon S3 replicates existing source bucket objects.</p>
    /// This field is required.
    pub fn status(mut self, input: super::types::ExistingObjectReplicationStatus) -> Self {
        self.status = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies whether Amazon S3 replicates existing source bucket objects.</p>
    pub fn set_status(mut self, input: ::std::option::Option<super::types::ExistingObjectReplicationStatus>) -> Self {
        self.status = input;
        self
    }
    /// <p>Specifies whether Amazon S3 replicates existing source bucket objects.</p>
    pub fn get_status(&self) -> &::std::option::Option<super::types::ExistingObjectReplicationStatus> {
        &self.status
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::types::ExistingObjectReplication, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ExistingObjectReplication {
