...
impl SimplePrefix {
    ...
    pub fn builder() -> super::types::builders::SimplePrefixBuilder {
        super::types::builders::SimplePrefixBuilder::default()
    }
}
...
impl SimplePrefixBuilder {
    ...
    pub fn build(self) -> super::types::SimplePrefix {
        super::types::SimplePrefix {}
    }
}
