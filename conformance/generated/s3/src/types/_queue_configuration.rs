...
impl QueueConfiguration {
    ...
    pub fn builder() -> super::types::builders::QueueConfigurationBuilder {
        super::types::builders::QueueConfigurationBuilder::default()
    }
}
...
impl QueueConfigurationBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::QueueConfiguration, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::QueueConfiguration {
            id: self.id,
