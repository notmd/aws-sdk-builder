...
impl Tagging {
    ...
    pub fn builder() -> super::types::builders::TaggingBuilder {
        super::types::builders::TaggingBuilder::default()
    }
}
...
impl TaggingBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::Tagging, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::Tagging {
