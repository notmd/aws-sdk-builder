...
impl AnnotationTableConfigurationResult {
    ...
    pub fn builder() -> super::types::builders::AnnotationTableConfigurationResultBuilder {
        super::types::builders::AnnotationTableConfigurationResultBuilder::default()
    }
}
...
impl AnnotationTableConfigurationResultBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::AnnotationTableConfigurationResult, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::AnnotationTableConfigurationResult {
