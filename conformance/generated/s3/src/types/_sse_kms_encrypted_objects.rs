...
pub struct SseKmsEncryptedObjects {
    ...
    pub status: super::types::SseKmsEncryptedObjectsStatus,
}
impl SseKmsEncryptedObjects {
    /// <p>Specifies whether Amazon S3 replicates objects created with server-side encryption using an Amazon Web Services KMS key stored in Amazon Web Services Key Management Service.</p>
    pub fn status(&self) -> &super::types::SseKmsEncryptedObjectsStatus {
        &self.status
    }
}
impl SseKmsEncryptedObjects {
    /// Creates a new builder-style object to manufacture [`SseKmsEncryptedObjects`](crate::types::SseKmsEncryptedObjects).
    pub fn builder() -> super::types::builders::SseKmsEncryptedObjectsBuilder {
        super::types::builders::SseKmsEncryptedObjectsBuilder::default()
    }
}
...
pub struct SseKmsEncryptedObjectsBuilder {
    pub(crate) status: ::std::option::Option<super::types::SseKmsEncryptedObjectsStatus>,
}
impl SseKmsEncryptedObjectsBuilder {
    /// <p>Specifies whether Amazon S3 replicates objects created with server-side encryption using an Amazon Web Services KMS key stored in Amazon Web Services Key Management Service.</p>
    /// This field is required.
    pub fn status(mut self, input: super::types::SseKmsEncryptedObjectsStatus) -> Self {
        self.status = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies whether Amazon S3 replicates objects created with server-side encryption using an Amazon Web Services KMS key stored in Amazon Web Services Key Management Service.</p>
    pub fn set_status(mut self, input: ::std::option::Option<super::types::SseKmsEncryptedObjectsStatus>) -> Self {
        self.status = input;
        self
    }
    /// <p>Specifies whether Amazon S3 replicates objects created with server-side encryption using an Amazon Web Services KMS key stored in Amazon Web Services Key Management Service.</p>
    pub fn get_status(&self) -> &::std::option::Option<super::types::SseKmsEncryptedObjectsStatus> {
        &self.status
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::types::SseKmsEncryptedObjects, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::SseKmsEncryptedObjects {
