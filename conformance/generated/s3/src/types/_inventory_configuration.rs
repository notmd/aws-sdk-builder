...
pub struct InventoryConfiguration {
    ...
    pub destination: ::std::option::Option<super::types::InventoryDestination>,
    ...
    pub filter: ::std::option::Option<super::types::InventoryFilter>,
    ...
    pub included_object_versions: super::types::InventoryIncludedObjectVersions,
    ...
    /// </note>
    pub optional_fields: ::std::option::Option<::std::vec::Vec<super::types::InventoryOptionalField>>,
    /// <p>Specifies the schedule for generating inventory results.</p>
    pub schedule: ::std::option::Option<super::types::InventorySchedule>,
}
impl InventoryConfiguration {
    /// <p>Contains information about where to publish the inventory results.</p>
    pub fn destination(&self) -> ::std::option::Option<&super::types::InventoryDestination> {
    ...
    /// <p>Specifies an inventory filter. The inventory only includes objects that meet the filter's criteria.</p>
    pub fn filter(&self) -> ::std::option::Option<&super::types::InventoryFilter> {
        self.filter.as_ref()
    }
    /// <p>The ID used to identify the inventory configuration.</p>
    pub fn id(&self) -> &str {
    ...
    /// <p>Object versions to include in the inventory list. If set to <code>All</code>, the list includes all the object versions, which adds the version-related fields <code>VersionId</code>, <code>IsLatest</code>, and <code>DeleteMarker</code> to the list. If set to <code>Current</code>, the list does not contain these version-related fields.</p>
    pub fn included_object_versions(&self) -> &super::types::InventoryIncludedObjectVersions {
    ...
    pub fn optional_fields(&self) -> &[super::types::InventoryOptionalField] {
        self.optional_fields.as_deref().unwrap_or_default()
    }
    /// <p>Specifies the schedule for generating inventory results.</p>
    pub fn schedule(&self) -> ::std::option::Option<&super::types::InventorySchedule> {
        self.schedule.as_ref()
    }
}
impl InventoryConfiguration {
    /// Creates a new builder-style object to manufacture [`InventoryConfiguration`](crate::types::InventoryConfiguration).
    pub fn builder() -> super::types::builders::InventoryConfigurationBuilder {
        super::types::builders::InventoryConfigurationBuilder::default()
    }
}
...
pub struct InventoryConfigurationBuilder {
    pub(crate) destination: ::std::option::Option<super::types::InventoryDestination>,
    pub(crate) is_enabled: ::std::option::Option<bool>,
    pub(crate) filter: ::std::option::Option<super::types::InventoryFilter>,
    pub(crate) id: ::std::option::Option<::std::string::String>,
    pub(crate) included_object_versions: ::std::option::Option<super::types::InventoryIncludedObjectVersions>,
    pub(crate) optional_fields: ::std::option::Option<::std::vec::Vec<super::types::InventoryOptionalField>>,
    pub(crate) schedule: ::std::option::Option<super::types::InventorySchedule>,
}
impl InventoryConfigurationBuilder {
    /// <p>Contains information about where to publish the inventory results.</p>
    /// This field is required.
    pub fn destination(mut self, input: super::types::InventoryDestination) -> Self {
        self.destination = ::std::option::Option::Some(input);
        self
    }
    /// <p>Contains information about where to publish the inventory results.</p>
    pub fn set_destination(mut self, input: ::std::option::Option<super::types::InventoryDestination>) -> Self {
        self.destination = input;
        self
    }
    /// <p>Contains information about where to publish the inventory results.</p>
    pub fn get_destination(&self) -> &::std::option::Option<super::types::InventoryDestination> {
        &self.destination
    }
    /// <p>Specifies whether the inventory is enabled or disabled. If set to <code>True</code>, an inventory list is generated. If set to <code>False</code>, no inventory list is generated.</p>
    /// This field is required.
    ...
    /// <p>Specifies an inventory filter. The inventory only includes objects that meet the filter's criteria.</p>
    pub fn filter(mut self, input: super::types::InventoryFilter) -> Self {
        self.filter = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies an inventory filter. The inventory only includes objects that meet the filter's criteria.</p>
    pub fn set_filter(mut self, input: ::std::option::Option<super::types::InventoryFilter>) -> Self {
        self.filter = input;
        self
    }
    /// <p>Specifies an inventory filter. The inventory only includes objects that meet the filter's criteria.</p>
    pub fn get_filter(&self) -> &::std::option::Option<super::types::InventoryFilter> {
        &self.filter
    }
    /// <p>The ID used to identify the inventory configuration.</p>
    /// This field is required.
    ...
    /// <p>Object versions to include in the inventory list. If set to <code>All</code>, the list includes all the object versions, which adds the version-related fields <code>VersionId</code>, <code>IsLatest</code>, and <code>DeleteMarker</code> to the list. If set to <code>Current</code>, the list does not contain these version-related fields.</p>
    /// This field is required.
    pub fn included_object_versions(mut self, input: super::types::InventoryIncludedObjectVersions) -> Self {
        self.included_object_versions = ::std::option::Option::Some(input);
        self
    }
    /// <p>Object versions to include in the inventory list. If set to <code>All</code>, the list includes all the object versions, which adds the version-related fields <code>VersionId</code>, <code>IsLatest</code>, and <code>DeleteMarker</code> to the list. If set to <code>Current</code>, the list does not contain these version-related fields.</p>
    pub fn set_included_object_versions(mut self, input: ::std::option::Option<super::types::InventoryIncludedObjectVersions>) -> Self {
        self.included_object_versions = input;
        self
    }
    /// <p>Object versions to include in the inventory list. If set to <code>All</code>, the list includes all the object versions, which adds the version-related fields <code>VersionId</code>, <code>IsLatest</code>, and <code>DeleteMarker</code> to the list. If set to <code>Current</code>, the list does not contain these version-related fields.</p>
    pub fn get_included_object_versions(&self) -> &::std::option::Option<super::types::InventoryIncludedObjectVersions> {
        &self.included_object_versions
    }
    ...
    /// <p>The following optional fields are supported for directory buckets <code>Size | LastModifiedDate | StorageClass | ETag | IsMultipartUploaded | EncryptionStatus | BucketKeyStatus | ChecksumAlgorithm | LifecycleExpirationDate.</code> Throws MalformedXML error if unsupported optional field is provided.</p>
    /// </note>
    pub fn optional_fields(mut self, input: super::types::InventoryOptionalField) -> Self {
    ...
    /// <p>The following optional fields are supported for directory buckets <code>Size | LastModifiedDate | StorageClass | ETag | IsMultipartUploaded | EncryptionStatus | BucketKeyStatus | ChecksumAlgorithm | LifecycleExpirationDate.</code> Throws MalformedXML error if unsupported optional field is provided.</p>
    /// </note>
    pub fn set_optional_fields(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::InventoryOptionalField>>) -> Self {
    ...
    /// <p>The following optional fields are supported for directory buckets <code>Size | LastModifiedDate | StorageClass | ETag | IsMultipartUploaded | EncryptionStatus | BucketKeyStatus | ChecksumAlgorithm | LifecycleExpirationDate.</code> Throws MalformedXML error if unsupported optional field is provided.</p>
    /// </note>
    pub fn get_optional_fields(&self) -> &::std::option::Option<::std::vec::Vec<super::types::InventoryOptionalField>> {
        &self.optional_fields
    }
    /// <p>Specifies the schedule for generating inventory results.</p>
    /// This field is required.
    pub fn schedule(mut self, input: super::types::InventorySchedule) -> Self {
        self.schedule = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies the schedule for generating inventory results.</p>
    pub fn set_schedule(mut self, input: ::std::option::Option<super::types::InventorySchedule>) -> Self {
        self.schedule = input;
        self
    }
    /// <p>Specifies the schedule for generating inventory results.</p>
    pub fn get_schedule(&self) -> &::std::option::Option<super::types::InventorySchedule> {
        &self.schedule
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::types::InventoryConfiguration, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::InventoryConfiguration {
