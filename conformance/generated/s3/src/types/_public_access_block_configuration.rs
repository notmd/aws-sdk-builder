...
impl PublicAccessBlockConfiguration {
    ...
    pub fn builder() -> super::types::builders::PublicAccessBlockConfigurationBuilder {
        super::types::builders::PublicAccessBlockConfigurationBuilder::default()
    }
}
...
impl PublicAccessBlockConfigurationBuilder {
    ...
    pub fn build(self) -> super::types::PublicAccessBlockConfiguration {
        super::types::PublicAccessBlockConfiguration {
