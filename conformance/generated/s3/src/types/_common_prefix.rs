...
impl CommonPrefix {
    ...
    pub fn builder() -> super::types::builders::CommonPrefixBuilder {
        super::types::builders::CommonPrefixBuilder::default()
    }
}
...
impl CommonPrefixBuilder {
    ...
    pub fn build(self) -> super::types::CommonPrefix {
        super::types::CommonPrefix { prefix: self.prefix }
    }
}
