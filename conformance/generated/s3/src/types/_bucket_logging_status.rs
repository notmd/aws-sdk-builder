...
impl BucketLoggingStatus {
    ...
    pub fn builder() -> super::types::builders::BucketLoggingStatusBuilder {
        super::types::builders::BucketLoggingStatusBuilder::default()
    }
}
...
impl BucketLoggingStatusBuilder {
    ...
    pub fn build(self) -> super::types::BucketLoggingStatus {
        super::types::BucketLoggingStatus {
