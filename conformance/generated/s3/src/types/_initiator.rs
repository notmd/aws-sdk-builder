...
impl Initiator {
    ...
    pub fn builder() -> super::types::builders::InitiatorBuilder {
        super::types::builders::InitiatorBuilder::default()
    }
}
...
impl InitiatorBuilder {
    ...
    pub fn build(self) -> super::types::Initiator {
        super::types::Initiator {
            id: self.id,
