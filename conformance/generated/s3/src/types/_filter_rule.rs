...
pub struct FilterRule {
    ...
    pub name: ::std::option::Option<super::types::FilterRuleName>,
    /// <p>The value that the filter searches for in object key names.</p>
    pub value: ::std::option::Option<::std::string::String>,
}
impl FilterRule {
    /// <p>The object key name prefix or suffix identifying one or more objects to which the filtering rule applies. The maximum length is 1,024 characters. Overlapping prefixes and suffixes are not supported. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/NotificationHowTo.html">Configuring Event Notifications</a> in the <i>Amazon S3 User Guide</i>.</p>
    pub fn name(&self) -> ::std::option::Option<&super::types::FilterRuleName> {
        self.name.as_ref()
    }
    /// <p>The value that the filter searches for in object key names.</p>
...
impl FilterRule {
    ...
    pub fn builder() -> super::types::builders::FilterRuleBuilder {
        super::types::builders::FilterRuleBuilder::default()
    }
}
...
pub struct FilterRuleBuilder {
    pub(crate) name: ::std::option::Option<super::types::FilterRuleName>,
    pub(crate) value: ::std::option::Option<::std::string::String>,
}
impl FilterRuleBuilder {
    /// <p>The object key name prefix or suffix identifying one or more objects to which the filtering rule applies. The maximum length is 1,024 characters. Overlapping prefixes and suffixes are not supported. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/NotificationHowTo.html">Configuring Event Notifications</a> in the <i>Amazon S3 User Guide</i>.</p>
    pub fn name(mut self, input: super::types::FilterRuleName) -> Self {
        self.name = ::std::option::Option::Some(input);
        self
    }
    /// <p>The object key name prefix or suffix identifying one or more objects to which the filtering rule applies. The maximum length is 1,024 characters. Overlapping prefixes and suffixes are not supported. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/NotificationHowTo.html">Configuring Event Notifications</a> in the <i>Amazon S3 User Guide</i>.</p>
    pub fn set_name(mut self, input: ::std::option::Option<super::types::FilterRuleName>) -> Self {
        self.name = input;
        self
    }
    /// <p>The object key name prefix or suffix identifying one or more objects to which the filtering rule applies. The maximum length is 1,024 characters. Overlapping prefixes and suffixes are not supported. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/NotificationHowTo.html">Configuring Event Notifications</a> in the <i>Amazon S3 User Guide</i>.</p>
    pub fn get_name(&self) -> &::std::option::Option<super::types::FilterRuleName> {
        &self.name
    }
    /// <p>The value that the filter searches for in object key names.</p>
    ...
    pub fn build(self) -> super::types::FilterRule {
        super::types::FilterRule {
            name: self.name,
            value: self.value,
        }
    }
