...
pub struct LifecycleRule {
    ...
    pub expiration: ::std::option::Option<super::types::LifecycleExpiration>,
    ...
    /// </note>
    pub filter: ::std::option::Option<super::types::LifecycleRuleFilter>,
    /// <p>If 'Enabled', the rule is currently being applied. If 'Disabled', the rule is not currently being applied.</p>
    pub status: super::types::ExpirationStatus,
    ...
    /// </note>
    pub transitions: ::std::option::Option<::std::vec::Vec<super::types::Transition>>,
    /// <p>Specifies the transition rule for the lifecycle rule that describes when noncurrent objects transition to a specific storage class. If your bucket is versioning-enabled (or versioning is suspended), you can set this action to request that Amazon S3 transition noncurrent object versions to a specific storage class at a set period in the object's lifetime.</p><note>
    /// <p>This parameter applies to general purpose buckets only. It is not supported for directory bucket lifecycle configurations.</p>
    /// </note>
    pub noncurrent_version_transitions: ::std::option::Option<::std::vec::Vec<super::types::NoncurrentVersionTransition>>,
    ...
    /// <p>This parameter applies to general purpose buckets only. It is not supported for directory bucket lifecycle configurations.</p>
    /// </note>
    pub noncurrent_version_expiration: ::std::option::Option<super::types::NoncurrentVersionExpiration>,
    ...
    pub abort_incomplete_multipart_upload: ::std::option::Option<super::types::AbortIncompleteMultipartUpload>,
}
impl LifecycleRule {
    /// <p>Specifies the expiration for the lifecycle of the object in the form of date, days and, whether the object has a delete marker.</p>
    pub fn expiration(&self) -> ::std::option::Option<&super::types::LifecycleExpiration> {
    ...
    /// <p><code>Tag</code> filters are not supported for directory buckets.</p>
    /// </note>
    pub fn filter(&self) -> ::std::option::Option<&super::types::LifecycleRuleFilter> {
        self.filter.as_ref()
    }
    /// <p>If 'Enabled', the rule is currently being applied. If 'Disabled', the rule is not currently being applied.</p>
    pub fn status(&self) -> &super::types::ExpirationStatus {
        &self.status
    }
    /// <p>Specifies when an Amazon S3 object transitions to a specified storage class.</p><note>
    /// <p>This parameter applies to general purpose buckets only. It is not supported for directory bucket lifecycle configurations.</p>
    ...
    pub fn transitions(&self) -> &[super::types::Transition] {
    ...
    pub fn noncurrent_version_transitions(&self) -> &[super::types::NoncurrentVersionTransition] {
        self.noncurrent_version_transitions.as_deref().unwrap_or_default()
    }
    /// <p>Specifies when noncurrent object versions expire. Upon expiration, Amazon S3 permanently deletes the noncurrent object versions. You set this lifecycle configuration action on a bucket that has versioning enabled (or suspended) to request that Amazon S3 delete noncurrent object versions at a specific period in the object's lifetime.</p><note>
    /// <p>This parameter applies to general purpose buckets only. It is not supported for directory bucket lifecycle configurations.</p>
    /// </note>
    pub fn noncurrent_version_expiration(&self) -> ::std::option::Option<&super::types::NoncurrentVersionExpiration> {
        self.noncurrent_version_expiration.as_ref()
    }
    /// <p>Specifies the days since the initiation of an incomplete multipart upload that Amazon S3 will wait before permanently removing all parts of the upload. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/mpuoverview.html#mpu-abort-incomplete-mpu-lifecycle-config"> Aborting Incomplete Multipart Uploads Using a Bucket Lifecycle Configuration</a> in the <i>Amazon S3 User Guide</i>.</p>
    pub fn abort_incomplete_multipart_upload(&self) -> ::std::option::Option<&super::types::AbortIncompleteMultipartUpload> {
...
impl LifecycleRule {
    ...
    pub fn builder() -> super::types::builders::LifecycleRuleBuilder {
        super::types::builders::LifecycleRuleBuilder::default()
    }
}
...
pub struct LifecycleRuleBuilder {
    pub(crate) expiration: ::std::option::Option<super::types::LifecycleExpiration>,
    pub(crate) id: ::std::option::Option<::std::string::String>,
    pub(crate) prefix: ::std::option::Option<::std::string::String>,
    pub(crate) filter: ::std::option::Option<super::types::LifecycleRuleFilter>,
    pub(crate) status: ::std::option::Option<super::types::ExpirationStatus>,
    pub(crate) transitions: ::std::option::Option<::std::vec::Vec<super::types::Transition>>,
    pub(crate) noncurrent_version_transitions: ::std::option::Option<::std::vec::Vec<super::types::NoncurrentVersionTransition>>,
    pub(crate) noncurrent_version_expiration: ::std::option::Option<super::types::NoncurrentVersionExpiration>,
    pub(crate) abort_incomplete_multipart_upload: ::std::option::Option<super::types::AbortIncompleteMultipartUpload>,
}
impl LifecycleRuleBuilder {
    /// <p>Specifies the expiration for the lifecycle of the object in the form of date, days and, whether the object has a delete marker.</p>
    pub fn expiration(mut self, input: super::types::LifecycleExpiration) -> Self {
        self.expiration = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies the expiration for the lifecycle of the object in the form of date, days and, whether the object has a delete marker.</p>
    pub fn set_expiration(mut self, input: ::std::option::Option<super::types::LifecycleExpiration>) -> Self {
        self.expiration = input;
        self
    }
    /// <p>Specifies the expiration for the lifecycle of the object in the form of date, days and, whether the object has a delete marker.</p>
    pub fn get_expiration(&self) -> &::std::option::Option<super::types::LifecycleExpiration> {
        &self.expiration
    }
    /// <p>Unique identifier for the rule. The value cannot be longer than 255 characters.</p>
    ...
    /// <p><code>Tag</code> filters are not supported for directory buckets.</p>
    /// </note>
    pub fn filter(mut self, input: super::types::LifecycleRuleFilter) -> Self {
    ...
    /// <p><code>Tag</code> filters are not supported for directory buckets.</p>
    /// </note>
    pub fn set_filter(mut self, input: ::std::option::Option<super::types::LifecycleRuleFilter>) -> Self {
        self.filter = input;
        self
    }
    /// <p>The <code>Filter</code> is used to identify objects that a Lifecycle Rule applies to. A <code>Filter</code> must have exactly one of <code>Prefix</code>, <code>Tag</code>, <code>ObjectSizeGreaterThan</code>, <code>ObjectSizeLessThan</code>, or <code>And</code> specified. <code>Filter</code> is required if the <code>LifecycleRule</code> does not contain a <code>Prefix</code> element.</p>
    ...
    /// <p><code>Tag</code> filters are not supported for directory buckets.</p>
    /// </note>
    pub fn get_filter(&self) -> &::std::option::Option<super::types::LifecycleRuleFilter> {
        &self.filter
    }
    /// <p>If 'Enabled', the rule is currently being applied. If 'Disabled', the rule is not currently being applied.</p>
    /// This field is required.
    pub fn status(mut self, input: super::types::ExpirationStatus) -> Self {
        self.status = ::std::option::Option::Some(input);
        self
    }
    /// <p>If 'Enabled', the rule is currently being applied. If 'Disabled', the rule is not currently being applied.</p>
    pub fn set_status(mut self, input: ::std::option::Option<super::types::ExpirationStatus>) -> Self {
        self.status = input;
        self
    }
    /// <p>If 'Enabled', the rule is currently being applied. If 'Disabled', the rule is not currently being applied.</p>
    pub fn get_status(&self) -> &::std::option::Option<super::types::ExpirationStatus> {
        &self.status
    }
    ...
    /// <p>This parameter applies to general purpose buckets only. It is not supported for directory bucket lifecycle configurations.</p>
    /// </note>
    pub fn transitions(mut self, input: super::types::Transition) -> Self {
    ...
    /// <p>This parameter applies to general purpose buckets only. It is not supported for directory bucket lifecycle configurations.</p>
    /// </note>
    pub fn set_transitions(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::Transition>>) -> Self {
    ...
    /// <p>This parameter applies to general purpose buckets only. It is not supported for directory bucket lifecycle configurations.</p>
    /// </note>
    pub fn get_transitions(&self) -> &::std::option::Option<::std::vec::Vec<super::types::Transition>> {
        &self.transitions
    }
    ...
    /// <p>This parameter applies to general purpose buckets only. It is not supported for directory bucket lifecycle configurations.</p>
    /// </note>
    pub fn noncurrent_version_transitions(mut self, input: super::types::NoncurrentVersionTransition) -> Self {
    ...
    pub fn set_noncurrent_version_transitions(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::NoncurrentVersionTransition>>,
    ) -> Self {
    ...
    /// <p>This parameter applies to general purpose buckets only. It is not supported for directory bucket lifecycle configurations.</p>
    /// </note>
    pub fn get_noncurrent_version_transitions(&self) -> &::std::option::Option<::std::vec::Vec<super::types::NoncurrentVersionTransition>> {
        &self.noncurrent_version_transitions
    }
    /// <p>Specifies when noncurrent object versions expire. Upon expiration, Amazon S3 permanently deletes the noncurrent object versions. You set this lifecycle configuration action on a bucket that has versioning enabled (or suspended) to request that Amazon S3 delete noncurrent object versions at a specific period in the object's lifetime.</p><note>
    /// <p>This parameter applies to general purpose buckets only. It is not supported for directory bucket lifecycle configurations.</p>
    /// </note>
    pub fn noncurrent_version_expiration(mut self, input: super::types::NoncurrentVersionExpiration) -> Self {
    ...
    /// <p>This parameter applies to general purpose buckets only. It is not supported for directory bucket lifecycle configurations.</p>
    /// </note>
    pub fn set_noncurrent_version_expiration(mut self, input: ::std::option::Option<super::types::NoncurrentVersionExpiration>) -> Self {
    ...
    /// <p>This parameter applies to general purpose buckets only. It is not supported for directory bucket lifecycle configurations.</p>
    /// </note>
    pub fn get_noncurrent_version_expiration(&self) -> &::std::option::Option<super::types::NoncurrentVersionExpiration> {
        &self.noncurrent_version_expiration
    }
    /// <p>Specifies the days since the initiation of an incomplete multipart upload that Amazon S3 will wait before permanently removing all parts of the upload. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/mpuoverview.html#mpu-abort-incomplete-mpu-lifecycle-config"> Aborting Incomplete Multipart Uploads Using a Bucket Lifecycle Configuration</a> in the <i>Amazon S3 User Guide</i>.</p>
    pub fn abort_incomplete_multipart_upload(mut self, input: super::types::AbortIncompleteMultipartUpload) -> Self {
        self.abort_incomplete_multipart_upload = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies the days since the initiation of an incomplete multipart upload that Amazon S3 will wait before permanently removing all parts of the upload. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/mpuoverview.html#mpu-abort-incomplete-mpu-lifecycle-config"> Aborting Incomplete Multipart Uploads Using a Bucket Lifecycle Configuration</a> in the <i>Amazon S3 User Guide</i>.</p>
    pub fn set_abort_incomplete_multipart_upload(mut self, input: ::std::option::Option<super::types::AbortIncompleteMultipartUpload>) -> Self {
        self.abort_incomplete_multipart_upload = input;
        self
    }
    /// <p>Specifies the days since the initiation of an incomplete multipart upload that Amazon S3 will wait before permanently removing all parts of the upload. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/mpuoverview.html#mpu-abort-incomplete-mpu-lifecycle-config"> Aborting Incomplete Multipart Uploads Using a Bucket Lifecycle Configuration</a> in the <i>Amazon S3 User Guide</i>.</p>
    pub fn get_abort_incomplete_multipart_upload(&self) -> &::std::option::Option<super::types::AbortIncompleteMultipartUpload> {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::LifecycleRule, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::LifecycleRule {
