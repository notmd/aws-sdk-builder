...
impl RequestProgress {
    ...
    pub fn builder() -> super::types::builders::RequestProgressBuilder {
        super::types::builders::RequestProgressBuilder::default()
    }
}
...
impl RequestProgressBuilder {
    ...
    pub fn build(self) -> super::types::RequestProgress {
        super::types::RequestProgress { enabled: self.enabled }
    }
}
