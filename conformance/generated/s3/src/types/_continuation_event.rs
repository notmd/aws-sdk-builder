...
impl ContinuationEvent {
    ...
    pub fn builder() -> super::types::builders::ContinuationEventBuilder {
        super::types::builders::ContinuationEventBuilder::default()
    }
}
...
impl ContinuationEventBuilder {
    ...
    pub fn build(self) -> super::types::ContinuationEvent {
        super::types::ContinuationEvent {}
    }
}
