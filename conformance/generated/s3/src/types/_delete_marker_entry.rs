...
impl DeleteMarkerEntry {
    ...
    pub fn builder() -> super::types::builders::DeleteMarkerEntryBuilder {
        super::types::builders::DeleteMarkerEntryBuilder::default()
    }
}
...
impl DeleteMarkerEntryBuilder {
    ...
    pub fn build(self) -> super::types::DeleteMarkerEntry {
        super::types::DeleteMarkerEntry {
            owner: self.owner,
            key: self.key,
