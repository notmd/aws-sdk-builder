...
impl AnalyticsAndOperator {
    ...
    pub fn builder() -> super::types::builders::AnalyticsAndOperatorBuilder {
        super::types::builders::AnalyticsAndOperatorBuilder::default()
    }
}
...
impl AnalyticsAndOperatorBuilder {
    ...
    pub fn build(self) -> super::types::AnalyticsAndOperator {
        super::types::AnalyticsAndOperator {
            prefix: self.prefix,
            tags: self.tags,
        }
    }
