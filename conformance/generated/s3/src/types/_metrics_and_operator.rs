...
impl MetricsAndOperator {
    ...
    pub fn builder() -> super::types::builders::MetricsAndOperatorBuilder {
        super::types::builders::MetricsAndOperatorBuilder::default()
    }
}
...
impl MetricsAndOperatorBuilder {
    ...
    pub fn build(self) -> super::types::MetricsAndOperator {
        super::types::MetricsAndOperator {
            prefix: self.prefix,
            tags: self.tags,
