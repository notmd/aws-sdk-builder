...
impl MultipartUpload {
    ...
    pub fn builder() -> super::types::builders::MultipartUploadBuilder {
        super::types::builders::MultipartUploadBuilder::default()
    }
}
...
impl MultipartUploadBuilder {
    ...
    pub fn build(self) -> super::types::MultipartUpload {
        super::types::MultipartUpload {
