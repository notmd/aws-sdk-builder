...
impl EncryptionConfiguration {
    ...
    pub fn builder() -> super::types::builders::EncryptionConfigurationBuilder {
        super::types::builders::EncryptionConfigurationBuilder::default()
    }
}
...
impl EncryptionConfigurationBuilder {
    ...
    pub fn build(self) -> super::types::EncryptionConfiguration {
        super::types::EncryptionConfiguration {
