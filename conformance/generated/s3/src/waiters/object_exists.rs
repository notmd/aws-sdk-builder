...
impl ObjectExistsFluentBuilder {
    ...
    pub async fn wait(
    ...
    ) -> ::std::result::Result<super::waiters::object_exists::ObjectExistsFinalPoll, super::waiters::object_exists::WaitUntilObjectExistsError> {
        let input = self
            .inner
            .build()
        ...
        >| {
            ...
            if super::waiters::matchers::match_head_object_c955e57777ec0d736(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"errorType":"NotFound"}
            if super::waiters::matchers::match_head_object_01223db2f9ae15f05(result) {
        ...
        let operation = move || {
            ...
            async move { super::operation::head_object::HeadObject::orchestrate(&runtime_plugins, input).await }
        };
