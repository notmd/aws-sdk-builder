...
pub(crate) fn match_head_bucket_c955e57777ec0d736(
    _result: ::std::result::Result<&super::operation::head_bucket::HeadBucketOutput, &super::operation::head_bucket::HeadBucketError>,
) -> bool {
    _result.is_ok()
}
...
pub(crate) fn match_head_object_c955e57777ec0d736(
    _result: ::std::result::Result<&super::operation::head_object::HeadObjectOutput, &super::operation::head_object::HeadObjectError>,
) -> bool {
    _result.is_ok()
}
