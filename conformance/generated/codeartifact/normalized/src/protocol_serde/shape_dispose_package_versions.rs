...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(super::super::operation::dispose_package_versions::DisposePackageVersionsError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "AccessDeniedException" => super::super::operation::dispose_package_versions::DisposePackageVersionsError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::dispose_package_versions::builders::DisposePackageVersionsOutputBuilder::default();
        output = super::super::protocol_serde::shape_dispose_package_versions::de_dispose_package_versions(_response_body, output)
            .map_err(super::super::operation::dispose_package_versions::DisposePackageVersionsError::unhandled)?;
...
pub fn ser_dispose_package_versions_input(
    ...
    super::super::protocol_serde::shape_dispose_package_versions_input::ser_dispose_package_versions_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_dispose_package_versions(
    _value: &[u8],
    mut builder: super::super::operation::dispose_package_versions::builders::DisposePackageVersionsOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::dispose_package_versions::builders::DisposePackageVersionsOutputBuilder,
