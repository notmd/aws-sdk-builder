...
> {
    ...
    Err(match error_code {
        "AccessDeniedException" => super::super::operation::delete_package_versions::DeletePackageVersionsError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::delete_package_versions::builders::DeletePackageVersionsOutputBuilder::default();
        output = super::super::protocol_serde::shape_delete_package_versions::de_delete_package_versions(_response_body, output)
            .map_err(super::super::operation::delete_package_versions::DeletePackageVersionsError::unhandled)?;
...
pub fn ser_delete_package_versions_input(
    ...
    super::super::protocol_serde::shape_delete_package_versions_input::ser_delete_package_versions_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_delete_package_versions(
    _value: &[u8],
    mut builder: super::super::operation::delete_package_versions::builders::DeletePackageVersionsOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::delete_package_versions::builders::DeletePackageVersionsOutputBuilder,
