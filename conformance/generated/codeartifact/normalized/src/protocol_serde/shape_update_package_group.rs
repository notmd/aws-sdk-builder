...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::update_package_group::UpdatePackageGroupError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => super::super::operation::update_package_group::UpdatePackageGroupError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::update_package_group::builders::UpdatePackageGroupOutputBuilder::default();
        output = super::super::protocol_serde::shape_update_package_group::de_update_package_group(_response_body, output)
            .map_err(super::super::operation::update_package_group::UpdatePackageGroupError::unhandled)?;
...
pub fn ser_update_package_group_input(
    ...
    super::super::protocol_serde::shape_update_package_group_input::ser_update_package_group_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_update_package_group(
    _value: &[u8],
    mut builder: super::super::operation::update_package_group::builders::UpdatePackageGroupOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::update_package_group::builders::UpdatePackageGroupOutputBuilder,
