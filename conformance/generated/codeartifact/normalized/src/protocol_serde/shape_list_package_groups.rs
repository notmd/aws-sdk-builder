...
) -> std::result::Result<super::super::operation::list_package_groups::ListPackageGroupsOutput, super::super::operation::list_package_groups::ListPackageGroupsError>
{
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::list_package_groups::ListPackageGroupsError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => super::super::operation::list_package_groups::ListPackageGroupsError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
) -> std::result::Result<super::super::operation::list_package_groups::ListPackageGroupsOutput, super::super::operation::list_package_groups::ListPackageGroupsError>
{
    Ok({
        ...
        output = super::super::protocol_serde::shape_list_package_groups::de_list_package_groups(_response_body, output)
            .map_err(super::super::operation::list_package_groups::ListPackageGroupsError::unhandled)?;
...
pub(crate) fn de_list_package_groups(
    ...
    super::super::operation::list_package_groups::builders::ListPackageGroupsOutputBuilder,
