...
pub fn de_delete_domain_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::delete_domain::DeleteDomainOutput, super::super::operation::delete_domain::DeleteDomainError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::delete_domain::DeleteDomainError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => super::super::operation::delete_domain::DeleteDomainError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_delete_domain_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::delete_domain::builders::DeleteDomainOutputBuilder::default();
        output = super::super::protocol_serde::shape_delete_domain::de_delete_domain(_response_body, output)
            .map_err(super::super::operation::delete_domain::DeleteDomainError::unhandled)?;
...
pub(crate) fn de_delete_domain(
    ...
    super::super::operation::delete_domain::builders::DeleteDomainOutputBuilder,
