...
pub fn de_list_domains_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::list_domains::ListDomainsOutput, super::super::operation::list_domains::ListDomainsError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::list_domains::ListDomainsError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => super::super::operation::list_domains::ListDomainsError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_list_domains_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_domains::builders::ListDomainsOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_domains::de_list_domains(_response_body, output)
            .map_err(super::super::operation::list_domains::ListDomainsError::unhandled)?;
...
pub fn ser_list_domains_input(
    ...
    super::super::protocol_serde::shape_list_domains_input::ser_list_domains_input_input(&mut object, input)?;
    object.finish();
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "domains" => {
                    builder = builder.set_domains(super::super::protocol_serde::shape_domain_summary_list::de_domain_summary_list(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
