...
pub fn de_create_domain_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::create_domain::CreateDomainOutput, super::super::operation::create_domain::CreateDomainError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::create_domain::CreateDomainError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => super::super::operation::create_domain::CreateDomainError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_create_domain_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::create_domain::builders::CreateDomainOutputBuilder::default();
        output = super::super::protocol_serde::shape_create_domain::de_create_domain(_response_body, output)
            .map_err(super::super::operation::create_domain::CreateDomainError::unhandled)?;
...
pub fn ser_create_domain_input(
    ...
    super::super::protocol_serde::shape_create_domain_input::ser_create_domain_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_create_domain(
    _value: &[u8],
    mut builder: super::super::operation::create_domain::builders::CreateDomainOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::create_domain::builders::CreateDomainOutputBuilder,
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "domain" => {
                    builder = builder.set_domain(super::super::protocol_serde::shape_domain_description::de_domain_description(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
