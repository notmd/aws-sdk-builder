...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::describe_repository::DescribeRepositoryError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => super::super::operation::describe_repository::DescribeRepositoryError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::describe_repository::builders::DescribeRepositoryOutputBuilder::default();
        output = super::super::protocol_serde::shape_describe_repository::de_describe_repository(_response_body, output)
            .map_err(super::super::operation::describe_repository::DescribeRepositoryError::unhandled)?;
...
pub(crate) fn de_describe_repository(
    ...
    super::super::operation::describe_repository::builders::DescribeRepositoryOutputBuilder,
