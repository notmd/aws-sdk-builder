...
pub fn de_describe_domain_http_error(
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::describe_domain::DescribeDomainError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => super::super::operation::describe_domain::DescribeDomainError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_describe_domain_http_response(
    ...
    Ok({
        ...
        output = super::super::protocol_serde::shape_describe_domain::de_describe_domain(_response_body, output)
            .map_err(super::super::operation::describe_domain::DescribeDomainError::unhandled)?;
...
pub(crate) fn de_describe_domain(
    ...
    super::super::operation::describe_domain::builders::DescribeDomainOutputBuilder,
