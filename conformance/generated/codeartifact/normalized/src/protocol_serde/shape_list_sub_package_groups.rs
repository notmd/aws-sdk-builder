...
> {
    ...
    Err(match error_code {
        "AccessDeniedException" => super::super::operation::list_sub_package_groups::ListSubPackageGroupsError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_sub_package_groups::builders::ListSubPackageGroupsOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_sub_package_groups::de_list_sub_package_groups(_response_body, output)
            .map_err(super::super::operation::list_sub_package_groups::ListSubPackageGroupsError::unhandled)?;
...
pub(crate) fn de_list_sub_package_groups(
    ...
    super::super::operation::list_sub_package_groups::builders::ListSubPackageGroupsOutputBuilder,
