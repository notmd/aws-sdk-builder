...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::put_package_origin_configuration::PutPackageOriginConfigurationError::unhandled(generic)),
    };
    ...
    Err(match error_code {
        ...
        "ResourceNotFoundException" => {
            super::super::operation::put_package_origin_configuration::PutPackageOriginConfigurationError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::put_package_origin_configuration::builders::PutPackageOriginConfigurationOutputBuilder::default();
        output = super::super::protocol_serde::shape_put_package_origin_configuration::de_put_package_origin_configuration(_response_body, output)
            .map_err(super::super::operation::put_package_origin_configuration::PutPackageOriginConfigurationError::unhandled)?;
...
pub fn ser_put_package_origin_configuration_input(
    ...
    super::super::protocol_serde::shape_put_package_origin_configuration_input::ser_put_package_origin_configuration_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_put_package_origin_configuration(
    _value: &[u8],
    mut builder: super::super::operation::put_package_origin_configuration::builders::PutPackageOriginConfigurationOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::put_package_origin_configuration::builders::PutPackageOriginConfigurationOutputBuilder,
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "originConfiguration" => {
                    builder = builder.set_origin_configuration(
                        super::super::protocol_serde::shape_package_origin_configuration::de_package_origin_configuration(tokens, _value, depth + 1)?,
                    );
                }
