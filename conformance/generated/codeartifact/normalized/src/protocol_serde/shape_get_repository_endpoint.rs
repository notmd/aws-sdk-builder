...
> {
    ...
    Err(match error_code {
        "AccessDeniedException" => super::super::operation::get_repository_endpoint::GetRepositoryEndpointError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::get_repository_endpoint::builders::GetRepositoryEndpointOutputBuilder::default();
        output = super::super::protocol_serde::shape_get_repository_endpoint::de_get_repository_endpoint(_response_body, output)
            .map_err(super::super::operation::get_repository_endpoint::GetRepositoryEndpointError::unhandled)?;
...
pub(crate) fn de_get_repository_endpoint(
    ...
    super::super::operation::get_repository_endpoint::builders::GetRepositoryEndpointOutputBuilder,
