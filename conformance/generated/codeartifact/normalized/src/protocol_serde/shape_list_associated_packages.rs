...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(super::super::operation::list_associated_packages::ListAssociatedPackagesError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "AccessDeniedException" => super::super::operation::list_associated_packages::ListAssociatedPackagesError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_associated_packages::builders::ListAssociatedPackagesOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_associated_packages::de_list_associated_packages(_response_body, output)
            .map_err(super::super::operation::list_associated_packages::ListAssociatedPackagesError::unhandled)?;
...
pub(crate) fn de_list_associated_packages(
    ...
    super::super::operation::list_associated_packages::builders::ListAssociatedPackagesOutputBuilder,
