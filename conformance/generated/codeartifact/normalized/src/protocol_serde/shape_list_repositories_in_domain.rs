...
> {
    ...
    Err(match error_code {
        "AccessDeniedException" => super::super::operation::list_repositories_in_domain::ListRepositoriesInDomainError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_repositories_in_domain::builders::ListRepositoriesInDomainOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_repositories_in_domain::de_list_repositories_in_domain(_response_body, output)
            .map_err(super::super::operation::list_repositories_in_domain::ListRepositoriesInDomainError::unhandled)?;
...
pub(crate) fn de_list_repositories_in_domain(
    ...
    super::super::operation::list_repositories_in_domain::builders::ListRepositoriesInDomainOutputBuilder,
