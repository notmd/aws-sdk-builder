...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::list_repositories::ListRepositoriesError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => super::super::operation::list_repositories::ListRepositoriesError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = super::super::protocol_serde::shape_list_repositories::de_list_repositories(_response_body, output)
            .map_err(super::super::operation::list_repositories::ListRepositoriesError::unhandled)?;
...
pub(crate) fn de_list_repositories(
    ...
    super::super::operation::list_repositories::builders::ListRepositoriesOutputBuilder,
