...
> {
    ...
    Err(match error_code {
        "AccessDeniedException" => super::super::operation::get_authorization_token::GetAuthorizationTokenError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::get_authorization_token::builders::GetAuthorizationTokenOutputBuilder::default();
        output = super::super::protocol_serde::shape_get_authorization_token::de_get_authorization_token(_response_body, output)
            .map_err(super::super::operation::get_authorization_token::GetAuthorizationTokenError::unhandled)?;
...
pub(crate) fn de_get_authorization_token(
    ...
    super::super::operation::get_authorization_token::builders::GetAuthorizationTokenOutputBuilder,
