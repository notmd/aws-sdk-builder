...
> {
    ...
    Err(match error_code {
        "AccessDeniedException" => super::super::operation::list_package_versions::ListPackageVersionsError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_package_versions::builders::ListPackageVersionsOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_package_versions::de_list_package_versions(_response_body, output)
            .map_err(super::super::operation::list_package_versions::ListPackageVersionsError::unhandled)?;
...
pub(crate) fn de_list_package_versions(
    ...
    super::super::operation::list_package_versions::builders::ListPackageVersionsOutputBuilder,
