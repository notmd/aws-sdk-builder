...
> {
    ...
    Err(match error_code {
        "AccessDeniedException" => super::super::operation::describe_package_group::DescribePackageGroupError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::describe_package_group::builders::DescribePackageGroupOutputBuilder::default();
        output = super::super::protocol_serde::shape_describe_package_group::de_describe_package_group(_response_body, output)
            .map_err(super::super::operation::describe_package_group::DescribePackageGroupError::unhandled)?;
...
pub(crate) fn de_describe_package_group(
    ...
    super::super::operation::describe_package_group::builders::DescribePackageGroupOutputBuilder,
