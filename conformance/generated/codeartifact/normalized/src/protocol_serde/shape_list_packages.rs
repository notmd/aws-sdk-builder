...
pub fn de_list_packages_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::list_packages::ListPackagesOutput, super::super::operation::list_packages::ListPackagesError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::list_packages::ListPackagesError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => super::super::operation::list_packages::ListPackagesError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_list_packages_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_packages::builders::ListPackagesOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_packages::de_list_packages(_response_body, output)
            .map_err(super::super::operation::list_packages::ListPackagesError::unhandled)?;
...
pub(crate) fn de_list_packages(
    ...
    super::super::operation::list_packages::builders::ListPackagesOutputBuilder,
