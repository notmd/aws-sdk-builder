...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::put_repository_permissions_policy::PutRepositoryPermissionsPolicyError::unhandled(generic)),
    };
    ...
    Err(match error_code {
        ...
        "InternalServerException" => {
            super::super::operation::put_repository_permissions_policy::PutRepositoryPermissionsPolicyError::InternalServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            super::super::operation::put_repository_permissions_policy::PutRepositoryPermissionsPolicyError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceQuotaExceededException" => {
            super::super::operation::put_repository_permissions_policy::PutRepositoryPermissionsPolicyError::ServiceQuotaExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::put_repository_permissions_policy::builders::PutRepositoryPermissionsPolicyOutputBuilder::default();
        output = super::super::protocol_serde::shape_put_repository_permissions_policy::de_put_repository_permissions_policy(_response_body, output)
            .map_err(super::super::operation::put_repository_permissions_policy::PutRepositoryPermissionsPolicyError::unhandled)?;
...
pub(crate) fn de_put_repository_permissions_policy(
    _value: &[u8],
    mut builder: super::super::operation::put_repository_permissions_policy::builders::PutRepositoryPermissionsPolicyOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::put_repository_permissions_policy::builders::PutRepositoryPermissionsPolicyOutputBuilder,
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "policy" => {
                    builder = builder.set_policy(super::super::protocol_serde::shape_resource_policy::de_resource_policy(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
