...
pub fn ser_update_package_group_origin_configuration_input(
    ...
    super::super::protocol_serde::shape_update_package_group_origin_configuration_input::ser_update_package_group_origin_configuration_input_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub(crate) fn de_update_package_group_origin_configuration(
    _value: &[u8],
    mut builder: super::super::operation::update_package_group_origin_configuration::builders::UpdatePackageGroupOriginConfigurationOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::update_package_group_origin_configuration::builders::UpdatePackageGroupOriginConfigurationOutputBuilder,
