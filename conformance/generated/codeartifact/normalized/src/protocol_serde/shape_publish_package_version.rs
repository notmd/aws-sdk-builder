...
> {
    ...
    Err(match error_code {
        "AccessDeniedException" => super::super::operation::publish_package_version::PublishPackageVersionError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::publish_package_version::builders::PublishPackageVersionOutputBuilder::default();
        output = super::super::protocol_serde::shape_publish_package_version::de_publish_package_version(_response_body, output)
            .map_err(super::super::operation::publish_package_version::PublishPackageVersionError::unhandled)?;
...
pub(crate) fn de_publish_package_version(
    ...
    super::super::operation::publish_package_version::builders::PublishPackageVersionOutputBuilder,
