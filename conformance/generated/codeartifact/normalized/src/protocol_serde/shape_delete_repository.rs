...
pub fn de_delete_repository_http_error(
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::delete_repository::DeleteRepositoryError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => super::super::operation::delete_repository::DeleteRepositoryError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_delete_repository_http_response(
    ...
    Ok({
        ...
        output = super::super::protocol_serde::shape_delete_repository::de_delete_repository(_response_body, output)
            .map_err(super::super::operation::delete_repository::DeleteRepositoryError::unhandled)?;
...
pub(crate) fn de_delete_repository(
    ...
    super::super::operation::delete_repository::builders::DeleteRepositoryOutputBuilder,
