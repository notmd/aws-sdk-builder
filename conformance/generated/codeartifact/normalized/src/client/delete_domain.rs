...
impl super::Client {
    ...
    pub fn delete_domain(&self) -> super::super::operation::delete_domain::builders::DeleteDomainFluentBuilder {
        super::super::operation::delete_domain::builders::DeleteDomainFluentBuilder::new(self.handle.clone())
    }
}
