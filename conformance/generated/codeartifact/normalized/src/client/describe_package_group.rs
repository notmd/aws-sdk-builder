...
impl super::Client {
    ...
    pub fn describe_package_group(&self) -> super::super::operation::describe_package_group::builders::DescribePackageGroupFluentBuilder {
        super::super::operation::describe_package_group::builders::DescribePackageGroupFluentBuilder::new(self.handle.clone())
    }
}
