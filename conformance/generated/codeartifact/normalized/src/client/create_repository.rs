...
impl super::Client {
    ...
    pub fn create_repository(&self) -> super::super::operation::create_repository::builders::CreateRepositoryFluentBuilder {
        super::super::operation::create_repository::builders::CreateRepositoryFluentBuilder::new(self.handle.clone())
    }
}
