...
impl super::Client {
    ...
    pub fn disassociate_external_connection(
        &self,
    ) -> super::super::operation::disassociate_external_connection::builders::DisassociateExternalConnectionFluentBuilder {
        super::super::operation::disassociate_external_connection::builders::DisassociateExternalConnectionFluentBuilder::new(self.handle.clone())
    }
}
