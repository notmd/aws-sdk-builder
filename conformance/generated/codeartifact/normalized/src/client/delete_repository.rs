...
impl super::Client {
    ...
    ///   - [`domain(impl Into<String>)`](crate::operation::delete_repository::builders::DeleteRepositoryFluentBuilder::domain) / [`set_domain(Option<String>)`](crate::operation::delete_repository::builders::DeleteRepositoryFluentBuilder::set_domain):<br>required: **true**<br><p>The name of the domain that contains the repository to delete.</p><br>
    ...
    ///   - [`repository(impl Into<String>)`](crate::operation::delete_repository::builders::DeleteRepositoryFluentBuilder::repository) / [`set_repository(Option<String>)`](crate::operation::delete_repository::builders::DeleteRepositoryFluentBuilder::set_repository):<br>required: **true**<br><p>The name of the repository to delete.</p><br>
    ...
    pub fn delete_repository(&self) -> super::super::operation::delete_repository::builders::DeleteRepositoryFluentBuilder {
        super::super::operation::delete_repository::builders::DeleteRepositoryFluentBuilder::new(self.handle.clone())
    }
}
