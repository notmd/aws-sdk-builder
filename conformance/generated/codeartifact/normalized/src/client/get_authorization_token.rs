...
impl super::Client {
    ...
    pub fn get_authorization_token(&self) -> super::super::operation::get_authorization_token::builders::GetAuthorizationTokenFluentBuilder {
        super::super::operation::get_authorization_token::builders::GetAuthorizationTokenFluentBuilder::new(self.handle.clone())
    }
}
