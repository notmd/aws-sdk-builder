...
impl super::Client {
    ...
    pub fn list_package_groups(&self) -> super::super::operation::list_package_groups::builders::ListPackageGroupsFluentBuilder {
        super::super::operation::list_package_groups::builders::ListPackageGroupsFluentBuilder::new(self.handle.clone())
    }
}
