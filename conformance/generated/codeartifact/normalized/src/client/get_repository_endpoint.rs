...
impl super::Client {
    ...
    pub fn get_repository_endpoint(&self) -> super::super::operation::get_repository_endpoint::builders::GetRepositoryEndpointFluentBuilder {
        super::super::operation::get_repository_endpoint::builders::GetRepositoryEndpointFluentBuilder::new(self.handle.clone())
    }
}
