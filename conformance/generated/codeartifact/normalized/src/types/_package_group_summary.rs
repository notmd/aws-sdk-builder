...
impl PackageGroupSummary {
    ...
    pub fn builder() -> super::super::types::builders::PackageGroupSummaryBuilder {
        super::super::types::builders::PackageGroupSummaryBuilder::default()
    }
}
...
impl PackageGroupSummaryBuilder {
    ...
    pub fn build(self) -> super::super::types::PackageGroupSummary {
        super::super::types::PackageGroupSummary {
            arn: self.arn,
