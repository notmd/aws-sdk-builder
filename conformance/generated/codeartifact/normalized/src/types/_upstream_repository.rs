...
impl UpstreamRepository {
    ...
    pub fn builder() -> super::super::types::builders::UpstreamRepositoryBuilder {
        super::super::types::builders::UpstreamRepositoryBuilder::default()
    }
}
...
impl UpstreamRepositoryBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::UpstreamRepository, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::UpstreamRepository {
