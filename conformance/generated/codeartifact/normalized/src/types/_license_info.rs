...
impl LicenseInfo {
    ...
    pub fn builder() -> super::super::types::builders::LicenseInfoBuilder {
        super::super::types::builders::LicenseInfoBuilder::default()
    }
}
...
impl LicenseInfoBuilder {
    ...
    pub fn build(self) -> super::super::types::LicenseInfo {
        super::super::types::LicenseInfo {
            name: self.name,
            url: self.url,
        }
    }
