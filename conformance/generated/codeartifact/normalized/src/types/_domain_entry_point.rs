...
impl DomainEntryPoint {
    ...
    pub fn builder() -> super::super::types::builders::DomainEntryPointBuilder {
        super::super::types::builders::DomainEntryPointBuilder::default()
    }
}
...
impl DomainEntryPointBuilder {
    ...
    pub fn build(self) -> super::super::types::DomainEntryPoint {
        super::super::types::DomainEntryPoint {
