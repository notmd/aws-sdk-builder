...
impl RepositorySummary {
    ...
    pub fn builder() -> super::super::types::builders::RepositorySummaryBuilder {
        super::super::types::builders::RepositorySummaryBuilder::default()
    }
}
...
impl RepositorySummaryBuilder {
    ...
    pub fn build(self) -> super::super::types::RepositorySummary {
        super::super::types::RepositorySummary {
            name: self.name,
