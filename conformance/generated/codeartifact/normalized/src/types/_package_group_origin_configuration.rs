...
pub struct PackageGroupOriginConfiguration {
    ...
    pub restrictions: ::std::option::Option<
        ::std::collections::HashMap<super::super::types::PackageGroupOriginRestrictionType, super::super::types::PackageGroupOriginRestriction>,
    >,
}
...
impl PackageGroupOriginConfiguration {
    ...
    pub fn builder() -> super::super::types::builders::PackageGroupOriginConfigurationBuilder {
        super::super::types::builders::PackageGroupOriginConfigurationBuilder::default()
    }
}
...
impl PackageGroupOriginConfigurationBuilder {
    ...
    pub fn build(self) -> super::super::types::PackageGroupOriginConfiguration {
        super::super::types::PackageGroupOriginConfiguration {
