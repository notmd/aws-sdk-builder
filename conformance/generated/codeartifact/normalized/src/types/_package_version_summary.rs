...
pub struct PackageVersionSummary {
    ...
    pub status: super::super::types::PackageVersionStatus,
...
impl PackageVersionSummary {
    ...
    /// <p>A string that contains the status of the package version. It can be one of the following:</p>
    pub fn status(&self) -> &super::super::types::PackageVersionStatus {
        &self.status
    }
    /// <p>A <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageVersionOrigin.html">PackageVersionOrigin</a> object that contains information about how the package version was added to the repository.</p>
...
impl PackageVersionSummary {
    ...
    pub fn builder() -> super::super::types::builders::PackageVersionSummaryBuilder {
        super::super::types::builders::PackageVersionSummaryBuilder::default()
    }
}
...
impl PackageVersionSummaryBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::PackageVersionSummary, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::PackageVersionSummary {
