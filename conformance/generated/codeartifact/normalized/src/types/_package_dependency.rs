...
impl PackageDependency {
    ...
    pub fn builder() -> super::super::types::builders::PackageDependencyBuilder {
        super::super::types::builders::PackageDependencyBuilder::default()
    }
}
...
impl PackageDependencyBuilder {
    ...
    pub fn build(self) -> super::super::types::PackageDependency {
        super::super::types::PackageDependency {
