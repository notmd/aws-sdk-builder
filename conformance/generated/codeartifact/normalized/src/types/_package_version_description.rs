...
pub struct PackageVersionDescription {
    ...
    pub format: ::std::option::Option<super::super::types::PackageFormat>,
    ...
    pub licenses: ::std::option::Option<::std::vec::Vec<super::super::types::LicenseInfo>>,
    /// <p>The revision of the package version.</p>
    pub revision: ::std::option::Option<::std::string::String>,
    /// <p>A string that contains the status of the package version.</p>
    pub status: ::std::option::Option<super::super::types::PackageVersionStatus>,
    ...
    pub origin: ::std::option::Option<super::super::types::PackageVersionOrigin>,
}
impl PackageVersionDescription {
    /// <p>The format of the package version.</p>
    pub fn format(&self) -> ::std::option::Option<&super::super::types::PackageFormat> {
        self.format.as_ref()
    }
    /// <p>The namespace of the package version. The package component that specifies its namespace depends on its type. For example:</p>
    /// <ul>
    ...
    pub fn licenses(&self) -> &[super::super::types::LicenseInfo] {
    ...
    /// <p>A string that contains the status of the package version.</p>
    pub fn status(&self) -> ::std::option::Option<&super::super::types::PackageVersionStatus> {
        self.status.as_ref()
    }
    /// <p>A <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageVersionOrigin.html">PackageVersionOrigin</a> object that contains information about how the package version was added to the repository.</p>
    pub fn origin(&self) -> ::std::option::Option<&super::super::types::PackageVersionOrigin> {
        self.origin.as_ref()
    }
}
impl PackageVersionDescription {
    /// Creates a new builder-style object to manufacture [`PackageVersionDescription`](crate::types::PackageVersionDescription).
    pub fn builder() -> super::super::types::builders::PackageVersionDescriptionBuilder {
        super::super::types::builders::PackageVersionDescriptionBuilder::default()
    }
}
...
pub struct PackageVersionDescriptionBuilder {
    pub(crate) format: ::std::option::Option<super::super::types::PackageFormat>,
    ...
    pub(crate) licenses: ::std::option::Option<::std::vec::Vec<super::super::types::LicenseInfo>>,
    pub(crate) revision: ::std::option::Option<::std::string::String>,
    pub(crate) status: ::std::option::Option<super::super::types::PackageVersionStatus>,
    pub(crate) origin: ::std::option::Option<super::super::types::PackageVersionOrigin>,
}
impl PackageVersionDescriptionBuilder {
    /// <p>The format of the package version.</p>
    pub fn format(mut self, input: super::super::types::PackageFormat) -> Self {
        self.format = ::std::option::Option::Some(input);
        self
    }
    /// <p>The format of the package version.</p>
    pub fn set_format(mut self, input: ::std::option::Option<super::super::types::PackageFormat>) -> Self {
        self.format = input;
        self
    }
    /// <p>The format of the package version.</p>
    pub fn get_format(&self) -> &::std::option::Option<super::super::types::PackageFormat> {
        &self.format
    }
    /// <p>The namespace of the package version. The package component that specifies its namespace depends on its type. For example:</p>
    /// <ul>
    ...
    ///
    /// <p>Information about licenses associated with the package version.</p>
    pub fn licenses(mut self, input: super::super::types::LicenseInfo) -> Self {
    ...
    /// <p>Information about licenses associated with the package version.</p>
    pub fn set_licenses(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::LicenseInfo>>) -> Self {
        self.licenses = input;
        self
    }
    /// <p>Information about licenses associated with the package version.</p>
    pub fn get_licenses(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::LicenseInfo>> {
        &self.licenses
    }
    /// <p>The revision of the package version.</p>
    ...
    /// <p>A string that contains the status of the package version.</p>
    pub fn status(mut self, input: super::super::types::PackageVersionStatus) -> Self {
        self.status = ::std::option::Option::Some(input);
        self
    }
    /// <p>A string that contains the status of the package version.</p>
    pub fn set_status(mut self, input: ::std::option::Option<super::super::types::PackageVersionStatus>) -> Self {
        self.status = input;
        self
    }
    /// <p>A string that contains the status of the package version.</p>
    pub fn get_status(&self) -> &::std::option::Option<super::super::types::PackageVersionStatus> {
        &self.status
    }
    /// <p>A <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageVersionOrigin.html">PackageVersionOrigin</a> object that contains information about how the package version was added to the repository.</p>
    pub fn origin(mut self, input: super::super::types::PackageVersionOrigin) -> Self {
        self.origin = ::std::option::Option::Some(input);
        self
    }
    /// <p>A <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageVersionOrigin.html">PackageVersionOrigin</a> object that contains information about how the package version was added to the repository.</p>
    pub fn set_origin(mut self, input: ::std::option::Option<super::super::types::PackageVersionOrigin>) -> Self {
        self.origin = input;
        self
    }
    /// <p>A <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageVersionOrigin.html">PackageVersionOrigin</a> object that contains information about how the package version was added to the repository.</p>
    pub fn get_origin(&self) -> &::std::option::Option<super::super::types::PackageVersionOrigin> {
        &self.origin
    }
    /// Consumes the builder and constructs a [`PackageVersionDescription`](crate::types::PackageVersionDescription).
    pub fn build(self) -> super::super::types::PackageVersionDescription {
        super::super::types::PackageVersionDescription {
            format: self.format,
