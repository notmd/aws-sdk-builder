...
pub struct ValidationException {
    ...
    /// <p></p>
    pub reason: ::std::option::Option<super::super::super::types::ValidationExceptionReason>,
    pub(crate) meta: ::aws_smithy_types::error::ErrorMetadata,
}
impl ValidationException {
    /// <p></p>
    pub fn reason(&self) -> ::std::option::Option<&super::super::super::types::ValidationExceptionReason> {
        self.reason.as_ref()
    }
}
impl ValidationException {
...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::ValidationException {
...
impl ValidationException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::ValidationExceptionBuilder {
        super::super::super::types::error::builders::ValidationExceptionBuilder::default()
    }
}
...
pub struct ValidationExceptionBuilder {
    ...
    pub(crate) reason: ::std::option::Option<super::super::super::types::ValidationExceptionReason>,
...
impl ValidationExceptionBuilder {
    ...
    /// <p></p>
    pub fn reason(mut self, input: super::super::super::types::ValidationExceptionReason) -> Self {
        self.reason = ::std::option::Option::Some(input);
        self
    }
    /// <p></p>
    pub fn set_reason(mut self, input: ::std::option::Option<super::super::super::types::ValidationExceptionReason>) -> Self {
        self.reason = input;
        self
    }
    /// <p></p>
    pub fn get_reason(&self) -> &::std::option::Option<super::super::super::types::ValidationExceptionReason> {
        &self.reason
    }
    /// Sets error metadata
