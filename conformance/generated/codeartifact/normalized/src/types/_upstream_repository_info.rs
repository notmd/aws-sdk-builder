...
impl UpstreamRepositoryInfo {
    ...
    pub fn builder() -> super::super::types::builders::UpstreamRepositoryInfoBuilder {
        super::super::types::builders::UpstreamRepositoryInfoBuilder::default()
    }
}
...
impl UpstreamRepositoryInfoBuilder {
    ...
    pub fn build(self) -> super::super::types::UpstreamRepositoryInfo {
        super::super::types::UpstreamRepositoryInfo {
