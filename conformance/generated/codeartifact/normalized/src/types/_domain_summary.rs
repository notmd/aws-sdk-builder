...
impl DomainSummary {
    ...
    pub fn builder() -> super::super::types::builders::DomainSummaryBuilder {
        super::super::types::builders::DomainSummaryBuilder::default()
    }
}
...
impl DomainSummaryBuilder {
    ...
    pub fn build(self) -> super::super::types::DomainSummary {
        super::super::types::DomainSummary {
            name: self.name,
            owner: self.owner,
            arn: self.arn,
            status: self.status,
