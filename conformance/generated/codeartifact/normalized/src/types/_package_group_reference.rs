...
impl PackageGroupReference {
    ...
    pub fn builder() -> super::super::types::builders::PackageGroupReferenceBuilder {
        super::super::types::builders::PackageGroupReferenceBuilder::default()
    }
}
...
impl PackageGroupReferenceBuilder {
    ...
    pub fn build(self) -> super::super::types::PackageGroupReference {
        super::super::types::PackageGroupReference {
            arn: self.arn,
