...
impl SuccessfulPackageVersionInfo {
    ...
    pub fn builder() -> super::super::types::builders::SuccessfulPackageVersionInfoBuilder {
        super::super::types::builders::SuccessfulPackageVersionInfoBuilder::default()
    }
}
...
impl SuccessfulPackageVersionInfoBuilder {
    ...
    pub fn build(self) -> super::super::types::SuccessfulPackageVersionInfo {
        super::super::types::SuccessfulPackageVersionInfo {
