...
pub struct PublishPackageVersionOutput {
    ...
    pub asset: ::std::option::Option<super::super::super::types::AssetSummary>,
...
impl PublishPackageVersionOutput {
    ...
    /// <p>An <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_AssetSummary.html">AssetSummary</a> for the published asset.</p>
    pub fn asset(&self) -> ::std::option::Option<&super::super::super::types::AssetSummary> {
        self.asset.as_ref()
    }
}
...
impl PublishPackageVersionOutput {
    ...
    pub fn builder() -> super::super::super::operation::publish_package_version::builders::PublishPackageVersionOutputBuilder {
        super::super::super::operation::publish_package_version::builders::PublishPackageVersionOutputBuilder::default()
    }
}
...
pub struct PublishPackageVersionOutputBuilder {
    ...
    pub(crate) asset: ::std::option::Option<super::super::super::types::AssetSummary>,
    _request_id: Option<String>,
}
impl PublishPackageVersionOutputBuilder {
    ...
    /// <p>An <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_AssetSummary.html">AssetSummary</a> for the published asset.</p>
    pub fn asset(mut self, input: super::super::super::types::AssetSummary) -> Self {
        self.asset = ::std::option::Option::Some(input);
        self
    }
    /// <p>An <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_AssetSummary.html">AssetSummary</a> for the published asset.</p>
    pub fn set_asset(mut self, input: ::std::option::Option<super::super::super::types::AssetSummary>) -> Self {
        self.asset = input;
        self
    }
    /// <p>An <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_AssetSummary.html">AssetSummary</a> for the published asset.</p>
    pub fn get_asset(&self) -> &::std::option::Option<super::super::super::types::AssetSummary> {
        &self.asset
    }
    ...
    pub fn build(self) -> super::super::super::operation::publish_package_version::PublishPackageVersionOutput {
        super::super::super::operation::publish_package_version::PublishPackageVersionOutput {
            format: self.format,
