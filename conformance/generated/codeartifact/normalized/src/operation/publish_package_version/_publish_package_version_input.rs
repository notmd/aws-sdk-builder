...
impl PublishPackageVersionInput {
    ...
    pub fn builder() -> super::super::super::operation::publish_package_version::builders::PublishPackageVersionInputBuilder {
        super::super::super::operation::publish_package_version::builders::PublishPackageVersionInputBuilder::default()
    }
}
