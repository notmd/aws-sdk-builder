...
impl DeletePackageVersionsOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_package_versions::builders::DeletePackageVersionsOutputBuilder {
        super::super::super::operation::delete_package_versions::builders::DeletePackageVersionsOutputBuilder::default()
    }
}
...
impl DeletePackageVersionsOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_package_versions::DeletePackageVersionsOutput {
