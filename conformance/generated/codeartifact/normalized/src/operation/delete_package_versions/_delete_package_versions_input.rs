...
impl DeletePackageVersionsInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_package_versions::builders::DeletePackageVersionsInputBuilder {
        super::super::super::operation::delete_package_versions::builders::DeletePackageVersionsInputBuilder::default()
    }
}
