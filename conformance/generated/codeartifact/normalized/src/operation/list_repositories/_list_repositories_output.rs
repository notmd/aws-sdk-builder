...
impl ListRepositoriesOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_repositories::builders::ListRepositoriesOutputBuilder {
        super::super::super::operation::list_repositories::builders::ListRepositoriesOutputBuilder::default()
    }
}
...
impl ListRepositoriesOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::list_repositories::ListRepositoriesOutput {
