...
impl ListRepositoriesInput {
    ...
    pub fn builder() -> super::super::super::operation::list_repositories::builders::ListRepositoriesInputBuilder {
        super::super::super::operation::list_repositories::builders::ListRepositoriesInputBuilder::default()
    }
}
