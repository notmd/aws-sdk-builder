...
impl DeleteDomainPermissionsPolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_domain_permissions_policy::builders::DeleteDomainPermissionsPolicyInputBuilder {
        super::super::super::operation::delete_domain_permissions_policy::builders::DeleteDomainPermissionsPolicyInputBuilder::default()
    }
}
