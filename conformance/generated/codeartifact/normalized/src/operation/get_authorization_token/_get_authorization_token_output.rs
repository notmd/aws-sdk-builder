...
impl GetAuthorizationTokenOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_authorization_token::builders::GetAuthorizationTokenOutputBuilder {
        super::super::super::operation::get_authorization_token::builders::GetAuthorizationTokenOutputBuilder::default()
    }
}
...
impl GetAuthorizationTokenOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::get_authorization_token::GetAuthorizationTokenOutput {
