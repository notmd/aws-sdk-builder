...
impl GetAuthorizationTokenInput {
    ...
    pub fn builder() -> super::super::super::operation::get_authorization_token::builders::GetAuthorizationTokenInputBuilder {
        super::super::super::operation::get_authorization_token::builders::GetAuthorizationTokenInputBuilder::default()
    }
}
