...
impl DescribePackageGroupInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_package_group::builders::DescribePackageGroupInputBuilder {
        super::super::super::operation::describe_package_group::builders::DescribePackageGroupInputBuilder::default()
    }
}
