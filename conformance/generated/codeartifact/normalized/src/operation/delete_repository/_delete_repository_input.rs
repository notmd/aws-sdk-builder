...
impl DeleteRepositoryInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_repository::builders::DeleteRepositoryInputBuilder {
        super::super::super::operation::delete_repository::builders::DeleteRepositoryInputBuilder::default()
    }
}
