...
pub use super::super::super::operation::delete_repository_permissions_policy::_delete_repository_permissions_policy_input::DeleteRepositoryPermissionsPolicyInputBuilder;

pub use super::super::super::operation::delete_repository_permissions_policy::_delete_repository_permissions_policy_output::DeleteRepositoryPermissionsPolicyOutputBuilder;

impl super::super::super::operation::delete_repository_permissions_policy::builders::DeleteRepositoryPermissionsPolicyInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_repository_permissions_policy::DeleteRepositoryPermissionsPolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_repository_permissions_policy::DeleteRepositoryPermissionsPolicyError,
...
pub struct DeleteRepositoryPermissionsPolicyFluentBuilder {
    ...
    inner: super::super::super::operation::delete_repository_permissions_policy::builders::DeleteRepositoryPermissionsPolicyInputBuilder,
