...
impl ListAllowedRepositoriesForGroupOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_allowed_repositories_for_group::builders::ListAllowedRepositoriesForGroupOutputBuilder {
        super::super::super::operation::list_allowed_repositories_for_group::builders::ListAllowedRepositoriesForGroupOutputBuilder::default()
    }
}
...
impl ListAllowedRepositoriesForGroupOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::list_allowed_repositories_for_group::ListAllowedRepositoriesForGroupOutput {
