...
pub struct ListAllowedRepositoriesForGroupPaginator {
    ...
    builder: super::super::super::operation::list_allowed_repositories_for_group::builders::ListAllowedRepositoriesForGroupInputBuilder,
...
impl ListAllowedRepositoriesForGroupPaginator {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::operation::list_allowed_repositories_for_group::ListAllowedRepositoriesForGroupOutput,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::list_allowed_repositories_for_group::ListAllowedRepositoriesForGroupError,
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::super::super::operation::list_allowed_repositories_for_group::ListAllowedRepositoriesForGroup::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_allowed_repositories_for_group_output_output_next_token(resp);
...
impl ListAllowedRepositoriesForGroupPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_list_allowed_repositories_for_group_output_output_allowed_repositories(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
