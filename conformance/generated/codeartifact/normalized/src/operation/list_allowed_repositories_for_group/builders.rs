...
pub use super::super::super::operation::list_allowed_repositories_for_group::_list_allowed_repositories_for_group_input::ListAllowedRepositoriesForGroupInputBuilder;

pub use super::super::super::operation::list_allowed_repositories_for_group::_list_allowed_repositories_for_group_output::ListAllowedRepositoriesForGroupOutputBuilder;

impl super::super::super::operation::list_allowed_repositories_for_group::builders::ListAllowedRepositoriesForGroupInputBuilder {
...
pub struct ListAllowedRepositoriesForGroupFluentBuilder {
    ...
    inner: super::super::super::operation::list_allowed_repositories_for_group::builders::ListAllowedRepositoriesForGroupInputBuilder,
...
impl ListAllowedRepositoriesForGroupFluentBuilder {
    ...
    pub fn origin_restriction_type(mut self, input: super::super::super::types::PackageGroupOriginRestrictionType) -> Self {
    ...
    /// <p>The origin configuration restriction type of which to list allowed repositories.</p>
    pub fn get_origin_restriction_type(&self) -> &::std::option::Option<super::super::super::types::PackageGroupOriginRestrictionType> {
