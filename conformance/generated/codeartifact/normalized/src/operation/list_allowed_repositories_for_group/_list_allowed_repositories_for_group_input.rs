...
pub struct ListAllowedRepositoriesForGroupInput {
    ...
    pub origin_restriction_type: ::std::option::Option<super::super::super::types::PackageGroupOriginRestrictionType>,
...
impl ListAllowedRepositoriesForGroupInput {
    ...
    /// <p>The origin configuration restriction type of which to list allowed repositories.</p>
    pub fn origin_restriction_type(&self) -> ::std::option::Option<&super::super::super::types::PackageGroupOriginRestrictionType> {
...
impl ListAllowedRepositoriesForGroupInput {
    ...
    pub fn builder() -> super::super::super::operation::list_allowed_repositories_for_group::builders::ListAllowedRepositoriesForGroupInputBuilder {
        super::super::super::operation::list_allowed_repositories_for_group::builders::ListAllowedRepositoriesForGroupInputBuilder::default()
    }
}
...
pub struct ListAllowedRepositoriesForGroupInputBuilder {
    ...
    pub(crate) origin_restriction_type: ::std::option::Option<super::super::super::types::PackageGroupOriginRestrictionType>,
...
impl ListAllowedRepositoriesForGroupInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::list_allowed_repositories_for_group::ListAllowedRepositoriesForGroupInput,
