...
pub use super::super::super::operation::update_package_group::_update_package_group_input::UpdatePackageGroupInputBuilder;

pub use super::super::super::operation::update_package_group::_update_package_group_output::UpdatePackageGroupOutputBuilder;

impl super::super::super::operation::update_package_group::builders::UpdatePackageGroupInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::update_package_group::UpdatePackageGroupOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::update_package_group::UpdatePackageGroupError,
            ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
        >,
    > {
        let mut fluent_builder = client.update_package_group();
        fluent_builder.inner = self;
        fluent_builder.send().await
    }
}
/// Fluent builder constructing a request to `UpdatePackageGroup`.
///
...
pub struct UpdatePackageGroupFluentBuilder {
    handle: ::std::sync::Arc<super::super::super::client::Handle>,
    inner: super::super::super::operation::update_package_group::builders::UpdatePackageGroupInputBuilder,
...
impl
    super::super::super::client::customize::internal::CustomizableSend<
        super::super::super::operation::update_package_group::UpdatePackageGroupOutput,
        super::super::super::operation::update_package_group::UpdatePackageGroupError,
    > for UpdatePackageGroupFluentBuilder
{
    fn send(
        self,
...
impl UpdatePackageGroupFluentBuilder {
    /// Creates a new `UpdatePackageGroupFluentBuilder`.
    ...
    /// Access the UpdatePackageGroup as a reference.
    pub fn as_input(&self) -> &super::super::super::operation::update_package_group::builders::UpdatePackageGroupInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::update_package_group::UpdatePackageGroup::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::update_package_group::UpdatePackageGroup::orchestrate(&runtime_plugins, input).await
    }
