...
impl UpdatePackageGroupInput {
    ...
    pub fn builder() -> super::super::super::operation::update_package_group::builders::UpdatePackageGroupInputBuilder {
        super::super::super::operation::update_package_group::builders::UpdatePackageGroupInputBuilder::default()
    }
}
