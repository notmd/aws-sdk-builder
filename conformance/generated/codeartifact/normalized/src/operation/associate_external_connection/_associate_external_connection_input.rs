...
impl AssociateExternalConnectionInput {
    ...
    pub fn builder() -> super::super::super::operation::associate_external_connection::builders::AssociateExternalConnectionInputBuilder {
        super::super::super::operation::associate_external_connection::builders::AssociateExternalConnectionInputBuilder::default()
    }
}
