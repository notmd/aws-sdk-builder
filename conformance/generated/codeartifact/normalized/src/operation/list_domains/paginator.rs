...
pub struct ListDomainsPaginator {
    ...
    builder: super::super::super::operation::list_domains::builders::ListDomainsInputBuilder,
...
impl ListDomainsPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::list_domains::paginator::ListDomainsPaginatorItems {
        super::super::super::operation::list_domains::paginator::ListDomainsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::super::super::operation::list_domains::ListDomains::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_domains_output_output_next_token(resp);
...
impl ListDomainsPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::DomainSummary,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::list_domains::ListDomainsError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
