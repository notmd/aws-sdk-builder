...
impl ListDomainsInput {
    ...
    pub fn builder() -> super::super::super::operation::list_domains::builders::ListDomainsInputBuilder {
        super::super::super::operation::list_domains::builders::ListDomainsInputBuilder::default()
    }
}
