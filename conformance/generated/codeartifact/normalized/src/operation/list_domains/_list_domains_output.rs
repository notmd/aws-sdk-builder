...
pub struct ListDomainsOutput {
    ...
    pub domains: ::std::option::Option<::std::vec::Vec<super::super::super::types::DomainSummary>>,
...
impl ListDomainsOutput {
    ...
    pub fn domains(&self) -> &[super::super::super::types::DomainSummary] {
...
impl ListDomainsOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_domains::builders::ListDomainsOutputBuilder {
        super::super::super::operation::list_domains::builders::ListDomainsOutputBuilder::default()
    }
}
...
pub struct ListDomainsOutputBuilder {
    pub(crate) domains: ::std::option::Option<::std::vec::Vec<super::super::super::types::DomainSummary>>,
...
impl ListDomainsOutputBuilder {
    ...
    ///
    /// <p>The returned list of <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_DomainSummary.html">DomainSummary</a> objects.</p>
    pub fn domains(mut self, input: super::super::super::types::DomainSummary) -> Self {
    ...
    /// <p>The returned list of <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_DomainSummary.html">DomainSummary</a> objects.</p>
    pub fn set_domains(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::DomainSummary>>) -> Self {
        self.domains = input;
        self
    }
    /// <p>The returned list of <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_DomainSummary.html">DomainSummary</a> objects.</p>
    pub fn get_domains(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::DomainSummary>> {
        &self.domains
    }
    /// <p>The token for the next set of results. Use the value returned in the previous response in the next request to retrieve the next set of results.</p>
    ...
    pub fn build(self) -> super::super::super::operation::list_domains::ListDomainsOutput {
