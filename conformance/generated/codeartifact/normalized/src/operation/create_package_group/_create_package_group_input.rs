...
impl CreatePackageGroupInput {
    ...
    pub fn builder() -> super::super::super::operation::create_package_group::builders::CreatePackageGroupInputBuilder {
        super::super::super::operation::create_package_group::builders::CreatePackageGroupInputBuilder::default()
    }
}
