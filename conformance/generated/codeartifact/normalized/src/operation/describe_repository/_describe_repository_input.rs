...
impl DescribeRepositoryInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_repository::builders::DescribeRepositoryInputBuilder {
        super::super::super::operation::describe_repository::builders::DescribeRepositoryInputBuilder::default()
    }
}
