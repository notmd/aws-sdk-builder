...
impl CopyPackageVersionsInput {
    ...
    pub fn builder() -> super::super::super::operation::copy_package_versions::builders::CopyPackageVersionsInputBuilder {
        super::super::super::operation::copy_package_versions::builders::CopyPackageVersionsInputBuilder::default()
    }
}
