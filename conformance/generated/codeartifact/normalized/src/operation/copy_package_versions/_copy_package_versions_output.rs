...
impl CopyPackageVersionsOutput {
    ...
    pub fn builder() -> super::super::super::operation::copy_package_versions::builders::CopyPackageVersionsOutputBuilder {
        super::super::super::operation::copy_package_versions::builders::CopyPackageVersionsOutputBuilder::default()
    }
}
...
impl CopyPackageVersionsOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::copy_package_versions::CopyPackageVersionsOutput {
