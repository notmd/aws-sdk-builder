...
impl DisassociateExternalConnectionInput {
    ...
    pub fn builder() -> super::super::super::operation::disassociate_external_connection::builders::DisassociateExternalConnectionInputBuilder {
        super::super::super::operation::disassociate_external_connection::builders::DisassociateExternalConnectionInputBuilder::default()
    }
}
