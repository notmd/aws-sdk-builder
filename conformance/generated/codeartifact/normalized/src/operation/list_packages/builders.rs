...
pub use super::super::super::operation::list_packages::_list_packages_input::ListPackagesInputBuilder;

pub use super::super::super::operation::list_packages::_list_packages_output::ListPackagesOutputBuilder;

impl super::super::super::operation::list_packages::builders::ListPackagesInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::list_packages::ListPackagesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::list_packages::ListPackagesError,
...
pub struct ListPackagesFluentBuilder {
    ...
    inner: super::super::super::operation::list_packages::builders::ListPackagesInputBuilder,
...
impl ListPackagesFluentBuilder {
    /// Creates a new `ListPackagesFluentBuilder`.
    ...
    pub fn as_input(&self) -> &super::super::super::operation::list_packages::builders::ListPackagesInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::list_packages::ListPackages::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::list_packages::ListPackages::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::super::super::operation::list_packages::paginator::ListPackagesPaginator {
        super::super::super::operation::list_packages::paginator::ListPackagesPaginator::new(self.handle, self.inner)
    }
    ...
    pub fn publish(mut self, input: super::super::super::types::AllowPublish) -> Self {
        self.inner = self.inner.publish(input);
        self
    }
    /// <p>The value of the <code>Publish</code> package origin control restriction used to filter requested packages. Only packages with the provided restriction are returned. For more information, see <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageOriginRestrictions.html">PackageOriginRestrictions</a>.</p>
    pub fn set_publish(mut self, input: ::std::option::Option<super::super::super::types::AllowPublish>) -> Self {
        self.inner = self.inner.set_publish(input);
        self
    }
    /// <p>The value of the <code>Publish</code> package origin control restriction used to filter requested packages. Only packages with the provided restriction are returned. For more information, see <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageOriginRestrictions.html">PackageOriginRestrictions</a>.</p>
    pub fn get_publish(&self) -> &::std::option::Option<super::super::super::types::AllowPublish> {
        self.inner.get_publish()
    }
    /// <p>The value of the <code>Upstream</code> package origin control restriction used to filter requested packages. Only packages with the provided restriction are returned. For more information, see <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageOriginRestrictions.html">PackageOriginRestrictions</a>.</p>
    pub fn upstream(mut self, input: super::super::super::types::AllowUpstream) -> Self {
        self.inner = self.inner.upstream(input);
        self
    }
    /// <p>The value of the <code>Upstream</code> package origin control restriction used to filter requested packages. Only packages with the provided restriction are returned. For more information, see <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageOriginRestrictions.html">PackageOriginRestrictions</a>.</p>
    pub fn set_upstream(mut self, input: ::std::option::Option<super::super::super::types::AllowUpstream>) -> Self {
        self.inner = self.inner.set_upstream(input);
        self
    }
    /// <p>The value of the <code>Upstream</code> package origin control restriction used to filter requested packages. Only packages with the provided restriction are returned. For more information, see <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageOriginRestrictions.html">PackageOriginRestrictions</a>.</p>
    pub fn get_upstream(&self) -> &::std::option::Option<super::super::super::types::AllowUpstream> {
