...
/// Paginator for [`ListPackages`](crate::operation::list_packages::ListPackages)
pub struct ListPackagesPaginator {
    handle: std::sync::Arc<super::super::super::client::Handle>,
    builder: super::super::super::operation::list_packages::builders::ListPackagesInputBuilder,
...
impl ListPackagesPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::list_packages::paginator::ListPackagesPaginatorItems {
        super::super::super::operation::list_packages::paginator::ListPackagesPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::super::super::operation::list_packages::ListPackages::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_packages_output_output_next_token(resp);
...
impl ListPackagesPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::PackageSummary,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::list_packages::ListPackagesError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_list_packages_output_output_packages(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
