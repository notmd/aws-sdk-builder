...
impl GetPackageVersionAssetOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_package_version_asset::builders::GetPackageVersionAssetOutputBuilder {
        super::super::super::operation::get_package_version_asset::builders::GetPackageVersionAssetOutputBuilder::default()
    }
}
...
impl GetPackageVersionAssetOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::get_package_version_asset::GetPackageVersionAssetOutput {
