...
impl CreateDomainInput {
    ...
    pub fn builder() -> super::super::super::operation::create_domain::builders::CreateDomainInputBuilder {
        super::super::super::operation::create_domain::builders::CreateDomainInputBuilder::default()
    }
}
