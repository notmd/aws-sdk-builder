...
impl GetRepositoryEndpointOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_repository_endpoint::builders::GetRepositoryEndpointOutputBuilder {
        super::super::super::operation::get_repository_endpoint::builders::GetRepositoryEndpointOutputBuilder::default()
    }
}
...
impl GetRepositoryEndpointOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::get_repository_endpoint::GetRepositoryEndpointOutput {
