...
impl ListSubPackageGroupsInput {
    ...
    pub fn builder() -> super::super::super::operation::list_sub_package_groups::builders::ListSubPackageGroupsInputBuilder {
        super::super::super::operation::list_sub_package_groups::builders::ListSubPackageGroupsInputBuilder::default()
    }
}
