...
impl DescribeDomainInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_domain::builders::DescribeDomainInputBuilder {
        super::super::super::operation::describe_domain::builders::DescribeDomainInputBuilder::default()
    }
}
