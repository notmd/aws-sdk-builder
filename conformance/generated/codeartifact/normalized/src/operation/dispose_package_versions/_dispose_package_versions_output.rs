...
impl DisposePackageVersionsOutput {
    ...
    pub fn builder() -> super::super::super::operation::dispose_package_versions::builders::DisposePackageVersionsOutputBuilder {
        super::super::super::operation::dispose_package_versions::builders::DisposePackageVersionsOutputBuilder::default()
    }
}
...
impl DisposePackageVersionsOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::dispose_package_versions::DisposePackageVersionsOutput {
