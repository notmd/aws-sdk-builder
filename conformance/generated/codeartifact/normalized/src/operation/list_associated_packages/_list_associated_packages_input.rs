...
impl ListAssociatedPackagesInput {
    ...
    pub fn builder() -> super::super::super::operation::list_associated_packages::builders::ListAssociatedPackagesInputBuilder {
        super::super::super::operation::list_associated_packages::builders::ListAssociatedPackagesInputBuilder::default()
    }
}
...
impl ListAssociatedPackagesInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::list_associated_packages::ListAssociatedPackagesInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::list_associated_packages::ListAssociatedPackagesInput {
            domain: self.domain,
