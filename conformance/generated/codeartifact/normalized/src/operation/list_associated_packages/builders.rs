...
pub use super::super::super::operation::list_associated_packages::_list_associated_packages_input::ListAssociatedPackagesInputBuilder;

pub use super::super::super::operation::list_associated_packages::_list_associated_packages_output::ListAssociatedPackagesOutputBuilder;

impl super::super::super::operation::list_associated_packages::builders::ListAssociatedPackagesInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::list_associated_packages::ListAssociatedPackagesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::list_associated_packages::ListAssociatedPackagesError,
...
pub struct ListAssociatedPackagesFluentBuilder {
    ...
    inner: super::super::super::operation::list_associated_packages::builders::ListAssociatedPackagesInputBuilder,
...
impl ListAssociatedPackagesFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::list_associated_packages::builders::ListAssociatedPackagesInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::list_associated_packages::ListAssociatedPackages::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::list_associated_packages::ListAssociatedPackages::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::super::super::operation::list_associated_packages::paginator::ListAssociatedPackagesPaginator {
        super::super::super::operation::list_associated_packages::paginator::ListAssociatedPackagesPaginator::new(self.handle, self.inner)
    }
