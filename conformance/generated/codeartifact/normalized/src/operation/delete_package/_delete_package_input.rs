...
impl DeletePackageInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_package::builders::DeletePackageInputBuilder {
        super::super::super::operation::delete_package::builders::DeletePackageInputBuilder::default()
    }
}
...
impl DeletePackageInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::delete_package::DeletePackageInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::delete_package::DeletePackageInput {
            domain: self.domain,
