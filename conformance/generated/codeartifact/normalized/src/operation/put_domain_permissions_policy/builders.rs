...
pub use super::super::super::operation::put_domain_permissions_policy::_put_domain_permissions_policy_input::PutDomainPermissionsPolicyInputBuilder;

pub use super::super::super::operation::put_domain_permissions_policy::_put_domain_permissions_policy_output::PutDomainPermissionsPolicyOutputBuilder;

impl super::super::super::operation::put_domain_permissions_policy::builders::PutDomainPermissionsPolicyInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::put_domain_permissions_policy::PutDomainPermissionsPolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::put_domain_permissions_policy::PutDomainPermissionsPolicyError,
...
pub struct PutDomainPermissionsPolicyFluentBuilder {
    ...
    inner: super::super::super::operation::put_domain_permissions_policy::builders::PutDomainPermissionsPolicyInputBuilder,
...
impl
    super::super::super::client::customize::internal::CustomizableSend<
        super::super::super::operation::put_domain_permissions_policy::PutDomainPermissionsPolicyOutput,
        super::super::super::operation::put_domain_permissions_policy::PutDomainPermissionsPolicyError,
    > for PutDomainPermissionsPolicyFluentBuilder
{
    fn send(
        self,
...
impl PutDomainPermissionsPolicyFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::put_domain_permissions_policy::builders::PutDomainPermissionsPolicyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::put_domain_permissions_policy::PutDomainPermissionsPolicy::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::put_domain_permissions_policy::PutDomainPermissionsPolicy::orchestrate(&runtime_plugins, input).await
    }
