...
impl PutDomainPermissionsPolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::put_domain_permissions_policy::builders::PutDomainPermissionsPolicyInputBuilder {
        super::super::super::operation::put_domain_permissions_policy::builders::PutDomainPermissionsPolicyInputBuilder::default()
    }
}
