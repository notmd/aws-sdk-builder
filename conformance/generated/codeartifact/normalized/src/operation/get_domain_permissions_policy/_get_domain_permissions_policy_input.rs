...
impl GetDomainPermissionsPolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::get_domain_permissions_policy::builders::GetDomainPermissionsPolicyInputBuilder {
        super::super::super::operation::get_domain_permissions_policy::builders::GetDomainPermissionsPolicyInputBuilder::default()
    }
}
