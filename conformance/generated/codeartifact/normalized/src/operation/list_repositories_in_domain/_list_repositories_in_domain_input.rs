...
impl ListRepositoriesInDomainInput {
    ...
    pub fn builder() -> super::super::super::operation::list_repositories_in_domain::builders::ListRepositoriesInDomainInputBuilder {
        super::super::super::operation::list_repositories_in_domain::builders::ListRepositoriesInDomainInputBuilder::default()
    }
}
