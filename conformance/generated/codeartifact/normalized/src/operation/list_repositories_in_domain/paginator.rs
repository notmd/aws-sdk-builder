...
pub struct ListRepositoriesInDomainPaginator {
    ...
    builder: super::super::super::operation::list_repositories_in_domain::builders::ListRepositoriesInDomainInputBuilder,
...
impl ListRepositoriesInDomainPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::list_repositories_in_domain::paginator::ListRepositoriesInDomainPaginatorItems {
        super::super::super::operation::list_repositories_in_domain::paginator::ListRepositoriesInDomainPaginatorItems(self)
    }
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_repositories_in_domain_output_output_next_token(resp);
...
impl ListRepositoriesInDomainPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::RepositorySummary,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::list_repositories_in_domain::ListRepositoriesInDomainError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_list_repositories_in_domain_output_output_repositories(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
