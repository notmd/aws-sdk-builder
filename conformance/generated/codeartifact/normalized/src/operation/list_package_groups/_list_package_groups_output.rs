...
impl ListPackageGroupsOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_package_groups::builders::ListPackageGroupsOutputBuilder {
        super::super::super::operation::list_package_groups::builders::ListPackageGroupsOutputBuilder::default()
    }
}
...
impl ListPackageGroupsOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::list_package_groups::ListPackageGroupsOutput {
