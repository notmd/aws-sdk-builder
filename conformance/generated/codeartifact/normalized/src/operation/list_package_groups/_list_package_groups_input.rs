...
impl ListPackageGroupsInput {
    ...
    pub fn builder() -> super::super::super::operation::list_package_groups::builders::ListPackageGroupsInputBuilder {
        super::super::super::operation::list_package_groups::builders::ListPackageGroupsInputBuilder::default()
    }
}
