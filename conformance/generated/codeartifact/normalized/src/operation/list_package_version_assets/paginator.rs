...
pub struct ListPackageVersionAssetsPaginator {
    ...
    builder: super::super::super::operation::list_package_version_assets::builders::ListPackageVersionAssetsInputBuilder,
...
impl ListPackageVersionAssetsPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::list_package_version_assets::paginator::ListPackageVersionAssetsPaginatorItems {
        super::super::super::operation::list_package_version_assets::paginator::ListPackageVersionAssetsPaginatorItems(self)
    }
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_package_version_assets_output_output_next_token(resp);
...
impl ListPackageVersionAssetsPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::AssetSummary,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::list_package_version_assets::ListPackageVersionAssetsError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_list_package_version_assets_output_output_assets(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
