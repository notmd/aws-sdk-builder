...
impl ListPackageVersionAssetsInput {
    ...
    pub fn builder() -> super::super::super::operation::list_package_version_assets::builders::ListPackageVersionAssetsInputBuilder {
        super::super::super::operation::list_package_version_assets::builders::ListPackageVersionAssetsInputBuilder::default()
    }
}
