...
impl GetRepositoryPermissionsPolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::get_repository_permissions_policy::builders::GetRepositoryPermissionsPolicyInputBuilder {
        super::super::super::operation::get_repository_permissions_policy::builders::GetRepositoryPermissionsPolicyInputBuilder::default()
    }
}
