...
pub use super::super::super::operation::put_package_origin_configuration::_put_package_origin_configuration_input::PutPackageOriginConfigurationInputBuilder;

pub use super::super::super::operation::put_package_origin_configuration::_put_package_origin_configuration_output::PutPackageOriginConfigurationOutputBuilder;

impl super::super::super::operation::put_package_origin_configuration::builders::PutPackageOriginConfigurationInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::put_package_origin_configuration::PutPackageOriginConfigurationOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::put_package_origin_configuration::PutPackageOriginConfigurationError,
...
pub struct PutPackageOriginConfigurationFluentBuilder {
    ...
    inner: super::super::super::operation::put_package_origin_configuration::builders::PutPackageOriginConfigurationInputBuilder,
...
impl PutPackageOriginConfigurationFluentBuilder {
    /// Creates a new `PutPackageOriginConfigurationFluentBuilder`.
    ...
    pub fn as_input(&self) -> &super::super::super::operation::put_package_origin_configuration::builders::PutPackageOriginConfigurationInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::put_package_origin_configuration::PutPackageOriginConfiguration::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::put_package_origin_configuration::PutPackageOriginConfiguration::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn restrictions(mut self, input: super::super::super::types::PackageOriginRestrictions) -> Self {
        self.inner = self.inner.restrictions(input);
        self
    }
    /// <p>A <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageOriginRestrictions.html">PackageOriginRestrictions</a> object that contains information about the <code>upstream</code> and <code>publish</code> package origin restrictions. The <code>upstream</code> restriction determines if new package versions can be ingested or retained from external connections or upstream repositories. The <code>publish</code> restriction determines if new package versions can be published directly to the repository.</p>
    /// <p>You must include both the desired <code>upstream</code> and <code>publish</code> restrictions.</p>
    pub fn set_restrictions(mut self, input: ::std::option::Option<super::super::super::types::PackageOriginRestrictions>) -> Self {
        self.inner = self.inner.set_restrictions(input);
        self
    }
    /// <p>A <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageOriginRestrictions.html">PackageOriginRestrictions</a> object that contains information about the <code>upstream</code> and <code>publish</code> package origin restrictions. The <code>upstream</code> restriction determines if new package versions can be ingested or retained from external connections or upstream repositories. The <code>publish</code> restriction determines if new package versions can be published directly to the repository.</p>
    /// <p>You must include both the desired <code>upstream</code> and <code>publish</code> restrictions.</p>
    pub fn get_restrictions(&self) -> &::std::option::Option<super::super::super::types::PackageOriginRestrictions> {
