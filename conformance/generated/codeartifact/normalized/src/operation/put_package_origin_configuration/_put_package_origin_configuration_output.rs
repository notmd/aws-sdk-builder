...
pub struct PutPackageOriginConfigurationOutput {
    ...
    pub origin_configuration: ::std::option::Option<super::super::super::types::PackageOriginConfiguration>,
    _request_id: Option<String>,
}
impl PutPackageOriginConfigurationOutput {
    /// <p>A <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageOriginConfiguration.html">PackageOriginConfiguration</a> object that describes the origin configuration set for the package. It contains a <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageOriginRestrictions.html">PackageOriginRestrictions</a> object that describes how new versions of the package can be introduced to the repository.</p>
    pub fn origin_configuration(&self) -> ::std::option::Option<&super::super::super::types::PackageOriginConfiguration> {
...
impl PutPackageOriginConfigurationOutput {
    ...
    pub fn builder() -> super::super::super::operation::put_package_origin_configuration::builders::PutPackageOriginConfigurationOutputBuilder {
        super::super::super::operation::put_package_origin_configuration::builders::PutPackageOriginConfigurationOutputBuilder::default()
    }
}
...
pub struct PutPackageOriginConfigurationOutputBuilder {
    pub(crate) origin_configuration: ::std::option::Option<super::super::super::types::PackageOriginConfiguration>,
    _request_id: Option<String>,
}
impl PutPackageOriginConfigurationOutputBuilder {
    /// <p>A <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageOriginConfiguration.html">PackageOriginConfiguration</a> object that describes the origin configuration set for the package. It contains a <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageOriginRestrictions.html">PackageOriginRestrictions</a> object that describes how new versions of the package can be introduced to the repository.</p>
    pub fn origin_configuration(mut self, input: super::super::super::types::PackageOriginConfiguration) -> Self {
        self.origin_configuration = ::std::option::Option::Some(input);
        self
    }
    /// <p>A <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageOriginConfiguration.html">PackageOriginConfiguration</a> object that describes the origin configuration set for the package. It contains a <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageOriginRestrictions.html">PackageOriginRestrictions</a> object that describes how new versions of the package can be introduced to the repository.</p>
    pub fn set_origin_configuration(mut self, input: ::std::option::Option<super::super::super::types::PackageOriginConfiguration>) -> Self {
        self.origin_configuration = input;
        self
    }
    /// <p>A <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageOriginConfiguration.html">PackageOriginConfiguration</a> object that describes the origin configuration set for the package. It contains a <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageOriginRestrictions.html">PackageOriginRestrictions</a> object that describes how new versions of the package can be introduced to the repository.</p>
    pub fn get_origin_configuration(&self) -> &::std::option::Option<super::super::super::types::PackageOriginConfiguration> {
    ...
    pub fn build(self) -> super::super::super::operation::put_package_origin_configuration::PutPackageOriginConfigurationOutput {
