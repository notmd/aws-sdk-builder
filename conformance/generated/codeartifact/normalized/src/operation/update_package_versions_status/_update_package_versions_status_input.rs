...
pub struct UpdatePackageVersionsStatusInput {
    ...
    pub expected_status: ::std::option::Option<super::super::super::types::PackageVersionStatus>,
    /// <p>The status you want to change the package version status to.</p>
    pub target_status: ::std::option::Option<super::super::super::types::PackageVersionStatus>,
}
impl UpdatePackageVersionsStatusInput {
    ...
    /// <p>The package version’s expected status before it is updated. If <code>expectedStatus</code> is provided, the package version's status is updated only if its status at the time <code>UpdatePackageVersionsStatus</code> is called matches <code>expectedStatus</code>.</p>
    pub fn expected_status(&self) -> ::std::option::Option<&super::super::super::types::PackageVersionStatus> {
        self.expected_status.as_ref()
    }
    /// <p>The status you want to change the package version status to.</p>
    pub fn target_status(&self) -> ::std::option::Option<&super::super::super::types::PackageVersionStatus> {
...
impl UpdatePackageVersionsStatusInput {
    ...
    pub fn builder() -> super::super::super::operation::update_package_versions_status::builders::UpdatePackageVersionsStatusInputBuilder {
        super::super::super::operation::update_package_versions_status::builders::UpdatePackageVersionsStatusInputBuilder::default()
    }
}
...
pub struct UpdatePackageVersionsStatusInputBuilder {
    ...
    pub(crate) expected_status: ::std::option::Option<super::super::super::types::PackageVersionStatus>,
    pub(crate) target_status: ::std::option::Option<super::super::super::types::PackageVersionStatus>,
}
