...
pub use super::super::super::operation::update_package_versions_status::_update_package_versions_status_input::UpdatePackageVersionsStatusInputBuilder;

pub use super::super::super::operation::update_package_versions_status::_update_package_versions_status_output::UpdatePackageVersionsStatusOutputBuilder;

impl super::super::super::operation::update_package_versions_status::builders::UpdatePackageVersionsStatusInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::update_package_versions_status::UpdatePackageVersionsStatusOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::update_package_versions_status::UpdatePackageVersionsStatusError,
...
pub struct UpdatePackageVersionsStatusFluentBuilder {
    ...
    inner: super::super::super::operation::update_package_versions_status::builders::UpdatePackageVersionsStatusInputBuilder,
...
impl UpdatePackageVersionsStatusFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::update_package_versions_status::builders::UpdatePackageVersionsStatusInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::update_package_versions_status::UpdatePackageVersionsStatus::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::update_package_versions_status::UpdatePackageVersionsStatus::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn expected_status(mut self, input: super::super::super::types::PackageVersionStatus) -> Self {
        self.inner = self.inner.expected_status(input);
        self
    }
    /// <p>The package version’s expected status before it is updated. If <code>expectedStatus</code> is provided, the package version's status is updated only if its status at the time <code>UpdatePackageVersionsStatus</code> is called matches <code>expectedStatus</code>.</p>
    pub fn set_expected_status(mut self, input: ::std::option::Option<super::super::super::types::PackageVersionStatus>) -> Self {
        self.inner = self.inner.set_expected_status(input);
        self
    }
    /// <p>The package version’s expected status before it is updated. If <code>expectedStatus</code> is provided, the package version's status is updated only if its status at the time <code>UpdatePackageVersionsStatus</code> is called matches <code>expectedStatus</code>.</p>
    pub fn get_expected_status(&self) -> &::std::option::Option<super::super::super::types::PackageVersionStatus> {
        self.inner.get_expected_status()
    }
    /// <p>The status you want to change the package version status to.</p>
    pub fn target_status(mut self, input: super::super::super::types::PackageVersionStatus) -> Self {
        self.inner = self.inner.target_status(input);
        self
    }
    /// <p>The status you want to change the package version status to.</p>
    pub fn set_target_status(mut self, input: ::std::option::Option<super::super::super::types::PackageVersionStatus>) -> Self {
        self.inner = self.inner.set_target_status(input);
        self
    }
    /// <p>The status you want to change the package version status to.</p>
    pub fn get_target_status(&self) -> &::std::option::Option<super::super::super::types::PackageVersionStatus> {
