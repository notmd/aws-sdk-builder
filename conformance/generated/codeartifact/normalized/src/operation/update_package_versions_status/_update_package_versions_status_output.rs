...
impl UpdatePackageVersionsStatusOutput {
    ...
    pub fn builder() -> super::super::super::operation::update_package_versions_status::builders::UpdatePackageVersionsStatusOutputBuilder {
        super::super::super::operation::update_package_versions_status::builders::UpdatePackageVersionsStatusOutputBuilder::default()
    }
}
...
impl UpdatePackageVersionsStatusOutputBuilder {
    ...
    pub fn set_successful_versions(
        mut self,
        input: ::std::option::Option<::std::collections::HashMap<::std::string::String, super::super::super::types::SuccessfulPackageVersionInfo>>,
    ) -> Self {
    ...
    pub fn set_failed_versions(
        mut self,
        input: ::std::option::Option<::std::collections::HashMap<::std::string::String, super::super::super::types::PackageVersionError>>,
    ) -> Self {
    ...
    pub fn build(self) -> super::super::super::operation::update_package_versions_status::UpdatePackageVersionsStatusOutput {
