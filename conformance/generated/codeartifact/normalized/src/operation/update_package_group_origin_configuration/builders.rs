...
pub use super::super::super::operation::update_package_group_origin_configuration::_update_package_group_origin_configuration_input::UpdatePackageGroupOriginConfigurationInputBuilder;

pub use super::super::super::operation::update_package_group_origin_configuration::_update_package_group_origin_configuration_output::UpdatePackageGroupOriginConfigurationOutputBuilder;

impl super::super::super::operation::update_package_group_origin_configuration::builders::UpdatePackageGroupOriginConfigurationInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::update_package_group_origin_configuration::UpdatePackageGroupOriginConfigurationOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::update_package_group_origin_configuration::UpdatePackageGroupOriginConfigurationError,
...
pub struct UpdatePackageGroupOriginConfigurationFluentBuilder {
    ...
    inner: super::super::super::operation::update_package_group_origin_configuration::builders::UpdatePackageGroupOriginConfigurationInputBuilder,
...
impl UpdatePackageGroupOriginConfigurationFluentBuilder {
    ...
    pub fn add_allowed_repositories(mut self, input: super::super::super::types::PackageGroupAllowedRepository) -> Self {
    ...
    pub fn set_add_allowed_repositories(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::PackageGroupAllowedRepository>>,
    ) -> Self {
        self.inner = self.inner.set_add_allowed_repositories(input);
        self
    }
    /// <p>The repository name and restrictions to add to the allowed repository list of the specified package group.</p>
    pub fn get_add_allowed_repositories(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::PackageGroupAllowedRepository>> {
    ...
    pub fn remove_allowed_repositories(mut self, input: super::super::super::types::PackageGroupAllowedRepository) -> Self {
