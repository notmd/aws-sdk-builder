...
pub struct UpdatePackageGroupOriginConfigurationInput {
    ...
    pub remove_allowed_repositories: ::std::option::Option<::std::vec::Vec<super::super::super::types::PackageGroupAllowedRepository>>,
}
impl UpdatePackageGroupOriginConfigurationInput {
    ...
    pub fn add_allowed_repositories(&self) -> &[super::super::super::types::PackageGroupAllowedRepository] {
    ...
    pub fn remove_allowed_repositories(&self) -> &[super::super::super::types::PackageGroupAllowedRepository] {
...
impl UpdatePackageGroupOriginConfigurationInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::update_package_group_origin_configuration::UpdatePackageGroupOriginConfigurationInput,
