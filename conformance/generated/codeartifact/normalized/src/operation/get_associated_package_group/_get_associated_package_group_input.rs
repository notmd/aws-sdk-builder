...
impl GetAssociatedPackageGroupInput {
    ...
    pub fn builder() -> super::super::super::operation::get_associated_package_group::builders::GetAssociatedPackageGroupInputBuilder {
        super::super::super::operation::get_associated_package_group::builders::GetAssociatedPackageGroupInputBuilder::default()
    }
}
