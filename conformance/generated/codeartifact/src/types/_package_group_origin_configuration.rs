...
pub struct PackageGroupOriginConfiguration {
    ...
    pub restrictions: ::std::option::Option<
        ::std::collections::HashMap<super::types::PackageGroupOriginRestrictionType, super::types::PackageGroupOriginRestriction>,
    >,
}
...
impl PackageGroupOriginConfiguration {
    ...
    pub fn builder() -> super::types::builders::PackageGroupOriginConfigurationBuilder {
        super::types::builders::PackageGroupOriginConfigurationBuilder::default()
    }
}
...
impl PackageGroupOriginConfigurationBuilder {
    ...
    ///
    /// <p>The origin configuration settings that determine how package versions can enter repositories.</p>
    pub fn restrictions(mut self, k: super::types::PackageGroupOriginRestrictionType, v: super::types::PackageGroupOriginRestriction) -> Self {
    ...
    pub fn build(self) -> super::types::PackageGroupOriginConfiguration {
        super::types::PackageGroupOriginConfiguration {
