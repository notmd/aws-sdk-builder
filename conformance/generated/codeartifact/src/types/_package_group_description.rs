...
pub struct PackageGroupDescription {
    ...
    pub origin_configuration: ::std::option::Option<super::types::PackageGroupOriginConfiguration>,
    /// <p>The direct parent package group of the package group.</p>
    pub parent: ::std::option::Option<super::types::PackageGroupReference>,
}
impl PackageGroupDescription {
    ...
    /// <p>The package group origin configuration that determines how package versions can enter repositories.</p>
    pub fn origin_configuration(&self) -> ::std::option::Option<&super::types::PackageGroupOriginConfiguration> {
        self.origin_configuration.as_ref()
    }
    /// <p>The direct parent package group of the package group.</p>
    pub fn parent(&self) -> ::std::option::Option<&super::types::PackageGroupReference> {
        self.parent.as_ref()
    }
}
impl PackageGroupDescription {
    /// Creates a new builder-style object to manufacture [`PackageGroupDescription`](crate::types::PackageGroupDescription).
    pub fn builder() -> super::types::builders::PackageGroupDescriptionBuilder {
        super::types::builders::PackageGroupDescriptionBuilder::default()
    }
}
...
pub struct PackageGroupDescriptionBuilder {
    ...
    pub(crate) origin_configuration: ::std::option::Option<super::types::PackageGroupOriginConfiguration>,
    pub(crate) parent: ::std::option::Option<super::types::PackageGroupReference>,
}
impl PackageGroupDescriptionBuilder {
    ...
    /// <p>The package group origin configuration that determines how package versions can enter repositories.</p>
    pub fn origin_configuration(mut self, input: super::types::PackageGroupOriginConfiguration) -> Self {
        self.origin_configuration = ::std::option::Option::Some(input);
        self
    }
    /// <p>The package group origin configuration that determines how package versions can enter repositories.</p>
    pub fn set_origin_configuration(mut self, input: ::std::option::Option<super::types::PackageGroupOriginConfiguration>) -> Self {
        self.origin_configuration = input;
        self
    }
    /// <p>The package group origin configuration that determines how package versions can enter repositories.</p>
    pub fn get_origin_configuration(&self) -> &::std::option::Option<super::types::PackageGroupOriginConfiguration> {
        &self.origin_configuration
    }
    /// <p>The direct parent package group of the package group.</p>
    pub fn parent(mut self, input: super::types::PackageGroupReference) -> Self {
        self.parent = ::std::option::Option::Some(input);
        self
    }
    /// <p>The direct parent package group of the package group.</p>
    pub fn set_parent(mut self, input: ::std::option::Option<super::types::PackageGroupReference>) -> Self {
        self.parent = input;
        self
    }
    /// <p>The direct parent package group of the package group.</p>
    pub fn get_parent(&self) -> &::std::option::Option<super::types::PackageGroupReference> {
        &self.parent
    }
    /// Consumes the builder and constructs a [`PackageGroupDescription`](crate::types::PackageGroupDescription).
    pub fn build(self) -> super::types::PackageGroupDescription {
        super::types::PackageGroupDescription {
            arn: self.arn,
