...
impl UpstreamRepositoryInfo {
    ...
    pub fn builder() -> super::types::builders::UpstreamRepositoryInfoBuilder {
        super::types::builders::UpstreamRepositoryInfoBuilder::default()
    }
}
...
impl UpstreamRepositoryInfoBuilder {
    ...
    pub fn build(self) -> super::types::UpstreamRepositoryInfo {
        super::types::UpstreamRepositoryInfo {
