...
impl LicenseInfo {
    ...
    pub fn builder() -> super::types::builders::LicenseInfoBuilder {
        super::types::builders::LicenseInfoBuilder::default()
    }
}
...
impl LicenseInfoBuilder {
    ...
    pub fn build(self) -> super::types::LicenseInfo {
        super::types::LicenseInfo {
            name: self.name,
            url: self.url,
        }
    }
