...
impl DomainEntryPoint {
    ...
    pub fn builder() -> super::types::builders::DomainEntryPointBuilder {
        super::types::builders::DomainEntryPointBuilder::default()
    }
}
...
impl DomainEntryPointBuilder {
    ...
    pub fn build(self) -> super::types::DomainEntryPoint {
        super::types::DomainEntryPoint {
