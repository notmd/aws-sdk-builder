...
impl PackageGroupAllowedRepository {
    ...
    pub fn builder() -> super::types::builders::PackageGroupAllowedRepositoryBuilder {
        super::types::builders::PackageGroupAllowedRepositoryBuilder::default()
    }
}
...
impl PackageGroupAllowedRepositoryBuilder {
    ...
    pub fn build(self) -> super::types::PackageGroupAllowedRepository {
        super::types::PackageGroupAllowedRepository {
