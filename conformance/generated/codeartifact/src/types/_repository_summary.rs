...
impl RepositorySummary {
    ...
    pub fn builder() -> super::types::builders::RepositorySummaryBuilder {
        super::types::builders::RepositorySummaryBuilder::default()
    }
}
...
impl RepositorySummaryBuilder {
    ...
    pub fn build(self) -> super::types::RepositorySummary {
