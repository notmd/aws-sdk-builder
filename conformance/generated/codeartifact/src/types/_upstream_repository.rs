...
impl UpstreamRepository {
    ...
    pub fn builder() -> super::types::builders::UpstreamRepositoryBuilder {
        super::types::builders::UpstreamRepositoryBuilder::default()
    }
}
...
impl UpstreamRepositoryBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::UpstreamRepository, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::UpstreamRepository {
