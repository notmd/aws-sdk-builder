...
pub struct RepositoryDescription {
    ...
    pub upstreams: ::std::option::Option<::std::vec::Vec<super::types::UpstreamRepositoryInfo>>,
    /// <p>An array of external connections associated with the repository.</p>
    pub external_connections: ::std::option::Option<::std::vec::Vec<super::types::RepositoryExternalConnectionInfo>>,
...
impl RepositoryDescription {
    ...
    pub fn upstreams(&self) -> &[super::types::UpstreamRepositoryInfo] {
    ...
    pub fn external_connections(&self) -> &[super::types::RepositoryExternalConnectionInfo] {
...
impl RepositoryDescription {
    ...
    pub fn builder() -> super::types::builders::RepositoryDescriptionBuilder {
        super::types::builders::RepositoryDescriptionBuilder::default()
    }
}
...
pub struct RepositoryDescriptionBuilder {
    ...
    pub(crate) upstreams: ::std::option::Option<::std::vec::Vec<super::types::UpstreamRepositoryInfo>>,
    pub(crate) external_connections: ::std::option::Option<::std::vec::Vec<super::types::RepositoryExternalConnectionInfo>>,
...
impl RepositoryDescriptionBuilder {
    ...
    ///
    /// <p>A list of upstream repositories to associate with the repository. The order of the upstream repositories in the list determines their priority order when CodeArtifact looks for a requested package version. For more information, see <a href="https://docs.aws.amazon.com/codeartifact/latest/ug/repos-upstream.html">Working with upstream repositories</a>.</p>
    pub fn upstreams(mut self, input: super::types::UpstreamRepositoryInfo) -> Self {
    ...
    /// <p>A list of upstream repositories to associate with the repository. The order of the upstream repositories in the list determines their priority order when CodeArtifact looks for a requested package version. For more information, see <a href="https://docs.aws.amazon.com/codeartifact/latest/ug/repos-upstream.html">Working with upstream repositories</a>.</p>
    pub fn set_upstreams(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::UpstreamRepositoryInfo>>) -> Self {
        self.upstreams = input;
        self
    }
    /// <p>A list of upstream repositories to associate with the repository. The order of the upstream repositories in the list determines their priority order when CodeArtifact looks for a requested package version. For more information, see <a href="https://docs.aws.amazon.com/codeartifact/latest/ug/repos-upstream.html">Working with upstream repositories</a>.</p>
    pub fn get_upstreams(&self) -> &::std::option::Option<::std::vec::Vec<super::types::UpstreamRepositoryInfo>> {
        &self.upstreams
    }
    ...
    ///
    /// <p>An array of external connections associated with the repository.</p>
    pub fn external_connections(mut self, input: super::types::RepositoryExternalConnectionInfo) -> Self {
    ...
    /// <p>An array of external connections associated with the repository.</p>
    pub fn set_external_connections(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::RepositoryExternalConnectionInfo>>) -> Self {
        self.external_connections = input;
        self
    }
    /// <p>An array of external connections associated with the repository.</p>
    pub fn get_external_connections(&self) -> &::std::option::Option<::std::vec::Vec<super::types::RepositoryExternalConnectionInfo>> {
    ...
    pub fn build(self) -> super::types::RepositoryDescription {
        super::types::RepositoryDescription {
            name: self.name,
