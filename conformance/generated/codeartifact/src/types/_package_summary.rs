...
impl PackageSummary {
    ...
    pub fn builder() -> super::types::builders::PackageSummaryBuilder {
        super::types::builders::PackageSummaryBuilder::default()
    }
}
...
impl PackageSummaryBuilder {
    ...
    pub fn build(self) -> super::types::PackageSummary {
        super::types::PackageSummary {
            format: self.format,
