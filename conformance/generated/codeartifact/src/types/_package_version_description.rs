...
pub struct PackageVersionDescription {
    ...
    pub licenses: ::std::option::Option<::std::vec::Vec<super::types::LicenseInfo>>,
    ...
    pub origin: ::std::option::Option<super::types::PackageVersionOrigin>,
}
impl PackageVersionDescription {
    ...
    pub fn licenses(&self) -> &[super::types::LicenseInfo] {
    ...
    /// <p>A <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageVersionOrigin.html">PackageVersionOrigin</a> object that contains information about how the package version was added to the repository.</p>
    pub fn origin(&self) -> ::std::option::Option<&super::types::PackageVersionOrigin> {
        self.origin.as_ref()
    }
}
impl PackageVersionDescription {
    /// Creates a new builder-style object to manufacture [`PackageVersionDescription`](crate::types::PackageVersionDescription).
    pub fn builder() -> super::types::builders::PackageVersionDescriptionBuilder {
        super::types::builders::PackageVersionDescriptionBuilder::default()
    }
}
...
pub struct PackageVersionDescriptionBuilder {
    ...
    pub(crate) licenses: ::std::option::Option<::std::vec::Vec<super::types::LicenseInfo>>,
    ...
    pub(crate) origin: ::std::option::Option<super::types::PackageVersionOrigin>,
}
impl PackageVersionDescriptionBuilder {
    ...
    ///
    /// <p>Information about licenses associated with the package version.</p>
    pub fn licenses(mut self, input: super::types::LicenseInfo) -> Self {
    ...
    /// <p>Information about licenses associated with the package version.</p>
    pub fn set_licenses(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::LicenseInfo>>) -> Self {
        self.licenses = input;
        self
    }
    /// <p>Information about licenses associated with the package version.</p>
    pub fn get_licenses(&self) -> &::std::option::Option<::std::vec::Vec<super::types::LicenseInfo>> {
        &self.licenses
    }
    /// <p>The revision of the package version.</p>
    ...
    /// <p>A <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageVersionOrigin.html">PackageVersionOrigin</a> object that contains information about how the package version was added to the repository.</p>
    pub fn origin(mut self, input: super::types::PackageVersionOrigin) -> Self {
        self.origin = ::std::option::Option::Some(input);
        self
    }
    /// <p>A <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageVersionOrigin.html">PackageVersionOrigin</a> object that contains information about how the package version was added to the repository.</p>
    pub fn set_origin(mut self, input: ::std::option::Option<super::types::PackageVersionOrigin>) -> Self {
        self.origin = input;
        self
    }
    /// <p>A <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageVersionOrigin.html">PackageVersionOrigin</a> object that contains information about how the package version was added to the repository.</p>
    pub fn get_origin(&self) -> &::std::option::Option<super::types::PackageVersionOrigin> {
        &self.origin
    }
    /// Consumes the builder and constructs a [`PackageVersionDescription`](crate::types::PackageVersionDescription).
    pub fn build(self) -> super::types::PackageVersionDescription {
        super::types::PackageVersionDescription {
            format: self.format,
