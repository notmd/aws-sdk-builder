...
impl AssociatedPackage {
    ...
    pub fn builder() -> super::types::builders::AssociatedPackageBuilder {
        super::types::builders::AssociatedPackageBuilder::default()
    }
}
...
impl AssociatedPackageBuilder {
    ...
    pub fn build(self) -> super::types::AssociatedPackage {
