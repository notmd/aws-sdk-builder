...
pub struct DomainDescription {
    ...
    pub status: ::std::option::Option<super::types::DomainStatus>,
...
impl DomainDescription {
    ...
    /// <p>The current status of a domain.</p>
    pub fn status(&self) -> ::std::option::Option<&super::types::DomainStatus> {
        self.status.as_ref()
    }
    /// <p>A timestamp that represents the date and time the domain was created.</p>
...
impl DomainDescription {
    ...
    pub fn builder() -> super::types::builders::DomainDescriptionBuilder {
        super::types::builders::DomainDescriptionBuilder::default()
    }
}
...
pub struct DomainDescriptionBuilder {
    ...
    pub(crate) status: ::std::option::Option<super::types::DomainStatus>,
...
impl DomainDescriptionBuilder {
    ...
    /// <p>The current status of a domain.</p>
    pub fn status(mut self, input: super::types::DomainStatus) -> Self {
        self.status = ::std::option::Option::Some(input);
        self
    }
    /// <p>The current status of a domain.</p>
    pub fn set_status(mut self, input: ::std::option::Option<super::types::DomainStatus>) -> Self {
        self.status = input;
        self
    }
    /// <p>The current status of a domain.</p>
    pub fn get_status(&self) -> &::std::option::Option<super::types::DomainStatus> {
        &self.status
    }
    /// <p>A timestamp that represents the date and time the domain was created.</p>
    ...
    pub fn build(self) -> super::types::DomainDescription {
        super::types::DomainDescription {
            name: self.name,
            owner: self.owner,
            arn: self.arn,
            status: self.status,
