...
impl ::aws_types::request_id::RequestId for super::types::error::AccessDeniedException {
...
impl AccessDeniedException {
    ...
    pub fn builder() -> super::types::error::builders::AccessDeniedExceptionBuilder {
        super::types::error::builders::AccessDeniedExceptionBuilder::default()
    }
}
...
impl AccessDeniedExceptionBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::error::AccessDeniedException, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::error::AccessDeniedException {
