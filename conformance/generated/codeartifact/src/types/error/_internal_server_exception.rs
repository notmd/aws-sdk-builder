...
impl ::aws_types::request_id::RequestId for super::types::error::InternalServerException {
...
impl InternalServerException {
    ...
    pub fn builder() -> super::types::error::builders::InternalServerExceptionBuilder {
        super::types::error::builders::InternalServerExceptionBuilder::default()
    }
}
...
impl InternalServerExceptionBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::error::InternalServerException, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::error::InternalServerException {
