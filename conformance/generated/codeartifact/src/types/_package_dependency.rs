...
impl PackageDependency {
    ...
    pub fn builder() -> super::types::builders::PackageDependencyBuilder {
        super::types::builders::PackageDependencyBuilder::default()
    }
}
...
impl PackageDependencyBuilder {
    ...
    pub fn build(self) -> super::types::PackageDependency {
        super::types::PackageDependency {
