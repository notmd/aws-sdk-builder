...
impl super::Client {
    ...
    pub fn get_authorization_token(&self) -> super::operation::get_authorization_token::builders::GetAuthorizationTokenFluentBuilder {
        super::operation::get_authorization_token::builders::GetAuthorizationTokenFluentBuilder::new(self.handle.clone())
    }
}
