...
impl super::Client {
    ...
    pub fn delete_domain(&self) -> super::operation::delete_domain::builders::DeleteDomainFluentBuilder {
        super::operation::delete_domain::builders::DeleteDomainFluentBuilder::new(self.handle.clone())
    }
}
