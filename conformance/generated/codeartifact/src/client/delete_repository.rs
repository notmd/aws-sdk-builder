...
impl super::Client {
    ...
    pub fn delete_repository(&self) -> super::operation::delete_repository::builders::DeleteRepositoryFluentBuilder {
        super::operation::delete_repository::builders::DeleteRepositoryFluentBuilder::new(self.handle.clone())
    }
}
