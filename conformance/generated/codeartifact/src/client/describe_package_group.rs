...
impl super::Client {
    ...
    pub fn describe_package_group(&self) -> super::operation::describe_package_group::builders::DescribePackageGroupFluentBuilder {
        super::operation::describe_package_group::builders::DescribePackageGroupFluentBuilder::new(self.handle.clone())
    }
}
