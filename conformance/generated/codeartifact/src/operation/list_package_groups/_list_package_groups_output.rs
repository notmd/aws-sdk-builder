...
impl ListPackageGroupsOutput {
    ...
    pub fn builder() -> super::operation::list_package_groups::builders::ListPackageGroupsOutputBuilder {
        super::operation::list_package_groups::builders::ListPackageGroupsOutputBuilder::default()
    }
}
...
impl ListPackageGroupsOutputBuilder {
    ...
    pub fn build(self) -> super::operation::list_package_groups::ListPackageGroupsOutput {
