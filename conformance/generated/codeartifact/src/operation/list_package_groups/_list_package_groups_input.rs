...
impl ListPackageGroupsInput {
    ...
    pub fn builder() -> super::operation::list_package_groups::builders::ListPackageGroupsInputBuilder {
        super::operation::list_package_groups::builders::ListPackageGroupsInputBuilder::default()
    }
}
...
impl ListPackageGroupsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_package_groups::ListPackageGroupsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_package_groups::ListPackageGroupsInput {
            domain: self.domain,
