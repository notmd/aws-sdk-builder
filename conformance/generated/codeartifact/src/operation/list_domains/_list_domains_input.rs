...
impl ListDomainsInput {
    ...
    pub fn builder() -> super::operation::list_domains::builders::ListDomainsInputBuilder {
        super::operation::list_domains::builders::ListDomainsInputBuilder::default()
    }
}
...
impl ListDomainsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::list_domains::ListDomainsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_domains::ListDomainsInput {
