...
impl PutDomainPermissionsPolicyInput {
    ...
    pub fn builder() -> super::operation::put_domain_permissions_policy::builders::PutDomainPermissionsPolicyInputBuilder {
        super::operation::put_domain_permissions_policy::builders::PutDomainPermissionsPolicyInputBuilder::default()
    }
}
...
impl PutDomainPermissionsPolicyInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::put_domain_permissions_policy::PutDomainPermissionsPolicyInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::put_domain_permissions_policy::PutDomainPermissionsPolicyInput {
            domain: self.domain,
