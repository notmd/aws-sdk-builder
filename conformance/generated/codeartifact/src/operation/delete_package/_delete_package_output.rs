...
pub struct DeletePackageOutput {
    ...
    pub deleted_package: ::std::option::Option<super::types::PackageSummary>,
    _request_id: Option<String>,
}
impl DeletePackageOutput {
    /// <p>Details about a package, including its format, namespace, and name.</p>
    pub fn deleted_package(&self) -> ::std::option::Option<&super::types::PackageSummary> {
...
impl DeletePackageOutput {
    ...
    pub fn builder() -> super::operation::delete_package::builders::DeletePackageOutputBuilder {
        super::operation::delete_package::builders::DeletePackageOutputBuilder::default()
    }
}
...
pub struct DeletePackageOutputBuilder {
    pub(crate) deleted_package: ::std::option::Option<super::types::PackageSummary>,
    _request_id: Option<String>,
}
impl DeletePackageOutputBuilder {
    /// <p>Details about a package, including its format, namespace, and name.</p>
    pub fn deleted_package(mut self, input: super::types::PackageSummary) -> Self {
        self.deleted_package = ::std::option::Option::Some(input);
        self
    }
    /// <p>Details about a package, including its format, namespace, and name.</p>
    pub fn set_deleted_package(mut self, input: ::std::option::Option<super::types::PackageSummary>) -> Self {
        self.deleted_package = input;
        self
    }
    /// <p>Details about a package, including its format, namespace, and name.</p>
    pub fn get_deleted_package(&self) -> &::std::option::Option<super::types::PackageSummary> {
    ...
    pub fn build(self) -> super::operation::delete_package::DeletePackageOutput {
