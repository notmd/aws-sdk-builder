...
impl GetDomainPermissionsPolicyInput {
    ...
    pub fn builder() -> super::operation::get_domain_permissions_policy::builders::GetDomainPermissionsPolicyInputBuilder {
        super::operation::get_domain_permissions_policy::builders::GetDomainPermissionsPolicyInputBuilder::default()
    }
}
...
impl GetDomainPermissionsPolicyInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::get_domain_permissions_policy::GetDomainPermissionsPolicyInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::get_domain_permissions_policy::GetDomainPermissionsPolicyInput {
            domain: self.domain,
