...
impl GetRepositoryPermissionsPolicyInput {
    ...
    pub fn builder() -> super::operation::get_repository_permissions_policy::builders::GetRepositoryPermissionsPolicyInputBuilder {
        super::operation::get_repository_permissions_policy::builders::GetRepositoryPermissionsPolicyInputBuilder::default()
    }
}
...
impl GetRepositoryPermissionsPolicyInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::get_repository_permissions_policy::GetRepositoryPermissionsPolicyInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::get_repository_permissions_policy::GetRepositoryPermissionsPolicyInput {
            domain: self.domain,
