...
impl CopyPackageVersionsOutput {
    ...
    pub fn builder() -> super::operation::copy_package_versions::builders::CopyPackageVersionsOutputBuilder {
        super::operation::copy_package_versions::builders::CopyPackageVersionsOutputBuilder::default()
    }
}
...
impl CopyPackageVersionsOutputBuilder {
    ...
    pub fn build(self) -> super::operation::copy_package_versions::CopyPackageVersionsOutput {
        super::operation::copy_package_versions::CopyPackageVersionsOutput {
