...
impl CopyPackageVersionsInput {
    ...
    pub fn builder() -> super::operation::copy_package_versions::builders::CopyPackageVersionsInputBuilder {
        super::operation::copy_package_versions::builders::CopyPackageVersionsInputBuilder::default()
    }
}
...
impl CopyPackageVersionsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::copy_package_versions::CopyPackageVersionsInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::copy_package_versions::CopyPackageVersionsInput {
            domain: self.domain,
