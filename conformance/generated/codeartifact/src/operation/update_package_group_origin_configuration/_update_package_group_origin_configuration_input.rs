...
pub struct UpdatePackageGroupOriginConfigurationInput {
    ...
    pub add_allowed_repositories: ::std::option::Option<::std::vec::Vec<super::types::PackageGroupAllowedRepository>>,
    /// <p>The repository name and restrictions to remove from the allowed repository list of the specified package group.</p>
    pub remove_allowed_repositories: ::std::option::Option<::std::vec::Vec<super::types::PackageGroupAllowedRepository>>,
}
impl UpdatePackageGroupOriginConfigurationInput {
    ...
    pub fn add_allowed_repositories(&self) -> &[super::types::PackageGroupAllowedRepository] {
    ...
    pub fn remove_allowed_repositories(&self) -> &[super::types::PackageGroupAllowedRepository] {
...
impl UpdatePackageGroupOriginConfigurationInput {
    ...
    pub fn builder() -> super::operation::update_package_group_origin_configuration::builders::UpdatePackageGroupOriginConfigurationInputBuilder {
        super::operation::update_package_group_origin_configuration::builders::UpdatePackageGroupOriginConfigurationInputBuilder::default()
    }
}
...
pub struct UpdatePackageGroupOriginConfigurationInputBuilder {
    ...
    pub(crate) restrictions: ::std::option::Option<
        ::std::collections::HashMap<super::types::PackageGroupOriginRestrictionType, super::types::PackageGroupOriginRestrictionMode>,
    >,
    pub(crate) add_allowed_repositories: ::std::option::Option<::std::vec::Vec<super::types::PackageGroupAllowedRepository>>,
    pub(crate) remove_allowed_repositories: ::std::option::Option<::std::vec::Vec<super::types::PackageGroupAllowedRepository>>,
}
impl UpdatePackageGroupOriginConfigurationInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::update_package_group_origin_configuration::UpdatePackageGroupOriginConfigurationInput,
