...
pub use super::operation::update_package_group_origin_configuration::_update_package_group_origin_configuration_input::UpdatePackageGroupOriginConfigurationInputBuilder;

pub use super::operation::update_package_group_origin_configuration::_update_package_group_origin_configuration_output::UpdatePackageGroupOriginConfigurationOutputBuilder;

impl super::operation::update_package_group_origin_configuration::builders::UpdatePackageGroupOriginConfigurationInputBuilder {
...
pub struct UpdatePackageGroupOriginConfigurationFluentBuilder {
    ...
    inner: super::operation::update_package_group_origin_configuration::builders::UpdatePackageGroupOriginConfigurationInputBuilder,
...
impl UpdatePackageGroupOriginConfigurationFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &super::operation::update_package_group_origin_configuration::builders::UpdatePackageGroupOriginConfigurationInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            super::operation::update_package_group_origin_configuration::UpdatePackageGroupOriginConfiguration::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        super::operation::update_package_group_origin_configuration::UpdatePackageGroupOriginConfiguration::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn restrictions(mut self, k: super::types::PackageGroupOriginRestrictionType, v: super::types::PackageGroupOriginRestrictionMode) -> Self {
    ...
    pub fn set_restrictions(
        ...
        input: ::std::option::Option<
            ::std::collections::HashMap<super::types::PackageGroupOriginRestrictionType, super::types::PackageGroupOriginRestrictionMode>,
        >,
    ) -> Self {
    ...
    pub fn add_allowed_repositories(mut self, input: super::types::PackageGroupAllowedRepository) -> Self {
    ...
    pub fn set_add_allowed_repositories(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::PackageGroupAllowedRepository>>,
    ) -> Self {
        self.inner = self.inner.set_add_allowed_repositories(input);
        self
    }
    /// <p>The repository name and restrictions to add to the allowed repository list of the specified package group.</p>
    pub fn get_add_allowed_repositories(&self) -> &::std::option::Option<::std::vec::Vec<super::types::PackageGroupAllowedRepository>> {
    ...
    pub fn remove_allowed_repositories(mut self, input: super::types::PackageGroupAllowedRepository) -> Self {
    ...
    /// <p>The repository name and restrictions to remove from the allowed repository list of the specified package group.</p>
    pub fn get_remove_allowed_repositories(&self) -> &::std::option::Option<::std::vec::Vec<super::types::PackageGroupAllowedRepository>> {
