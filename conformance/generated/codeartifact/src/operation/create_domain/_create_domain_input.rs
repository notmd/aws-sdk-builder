...
impl CreateDomainInput {
    ...
    pub fn builder() -> super::operation::create_domain::builders::CreateDomainInputBuilder {
        super::operation::create_domain::builders::CreateDomainInputBuilder::default()
    }
}
...
impl CreateDomainInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::create_domain::CreateDomainInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::create_domain::CreateDomainInput {
            domain: self.domain,
