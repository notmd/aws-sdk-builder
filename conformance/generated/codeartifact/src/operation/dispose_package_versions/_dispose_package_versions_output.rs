...
impl DisposePackageVersionsOutput {
    ...
    pub fn builder() -> super::operation::dispose_package_versions::builders::DisposePackageVersionsOutputBuilder {
        super::operation::dispose_package_versions::builders::DisposePackageVersionsOutputBuilder::default()
    }
}
...
impl DisposePackageVersionsOutputBuilder {
    ...
    pub fn build(self) -> super::operation::dispose_package_versions::DisposePackageVersionsOutput {
