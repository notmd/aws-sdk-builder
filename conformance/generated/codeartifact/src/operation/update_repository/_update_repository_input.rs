...
impl UpdateRepositoryInput {
    ...
    pub fn builder() -> super::operation::update_repository::builders::UpdateRepositoryInputBuilder {
        super::operation::update_repository::builders::UpdateRepositoryInputBuilder::default()
    }
}
...
impl UpdateRepositoryInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::update_repository::UpdateRepositoryInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::update_repository::UpdateRepositoryInput {
            domain: self.domain,
