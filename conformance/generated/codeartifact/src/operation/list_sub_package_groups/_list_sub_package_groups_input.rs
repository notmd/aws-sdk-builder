...
impl ListSubPackageGroupsInput {
    ...
    pub fn builder() -> super::operation::list_sub_package_groups::builders::ListSubPackageGroupsInputBuilder {
        super::operation::list_sub_package_groups::builders::ListSubPackageGroupsInputBuilder::default()
    }
}
...
impl ListSubPackageGroupsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_sub_package_groups::ListSubPackageGroupsInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::list_sub_package_groups::ListSubPackageGroupsInput {
            domain: self.domain,
