...
pub struct ListPackageVersionDependenciesOutput {
    ...
    pub dependencies: ::std::option::Option<::std::vec::Vec<super::types::PackageDependency>>,
...
impl ListPackageVersionDependenciesOutput {
    ...
    pub fn dependencies(&self) -> &[super::types::PackageDependency] {
...
impl ListPackageVersionDependenciesOutput {
    ...
    pub fn builder() -> super::operation::list_package_version_dependencies::builders::ListPackageVersionDependenciesOutputBuilder {
        super::operation::list_package_version_dependencies::builders::ListPackageVersionDependenciesOutputBuilder::default()
    }
}
...
pub struct ListPackageVersionDependenciesOutputBuilder {
    ...
    pub(crate) dependencies: ::std::option::Option<::std::vec::Vec<super::types::PackageDependency>>,
    _request_id: Option<String>,
}
impl ListPackageVersionDependenciesOutputBuilder {
    ...
    ///
    /// <p>The returned list of <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageDependency.html">PackageDependency</a> objects.</p>
    pub fn dependencies(mut self, input: super::types::PackageDependency) -> Self {
    ...
    /// <p>The returned list of <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageDependency.html">PackageDependency</a> objects.</p>
    pub fn set_dependencies(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::PackageDependency>>) -> Self {
        self.dependencies = input;
        self
    }
    /// <p>The returned list of <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageDependency.html">PackageDependency</a> objects.</p>
    pub fn get_dependencies(&self) -> &::std::option::Option<::std::vec::Vec<super::types::PackageDependency>> {
        &self.dependencies
    }
    ...
    pub fn build(self) -> super::operation::list_package_version_dependencies::ListPackageVersionDependenciesOutput {
