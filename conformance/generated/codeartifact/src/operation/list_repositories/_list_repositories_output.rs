...
impl ListRepositoriesOutput {
    ...
    pub fn builder() -> super::operation::list_repositories::builders::ListRepositoriesOutputBuilder {
        super::operation::list_repositories::builders::ListRepositoriesOutputBuilder::default()
    }
}
...
impl ListRepositoriesOutputBuilder {
    ...
    pub fn build(self) -> super::operation::list_repositories::ListRepositoriesOutput {
