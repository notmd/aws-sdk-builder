...
pub use super::operation::list_repositories::_list_repositories_input::ListRepositoriesInputBuilder;

pub use super::operation::list_repositories::_list_repositories_output::ListRepositoriesOutputBuilder;

impl super::operation::list_repositories::builders::ListRepositoriesInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::Client,
    ) -> ::std::result::Result<
        super::operation::list_repositories::ListRepositoriesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::list_repositories::ListRepositoriesError,
...
pub struct ListRepositoriesFluentBuilder {
    ...
    inner: super::operation::list_repositories::builders::ListRepositoriesInputBuilder,
...
impl ListRepositoriesFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::list_repositories::builders::ListRepositoriesInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::list_repositories::ListRepositories::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::list_repositories::ListRepositories::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::operation::list_repositories::paginator::ListRepositoriesPaginator {
        super::operation::list_repositories::paginator::ListRepositoriesPaginator::new(self.handle, self.inner)
    }
