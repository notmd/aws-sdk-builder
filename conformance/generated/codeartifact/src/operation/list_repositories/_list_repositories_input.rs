...
impl ListRepositoriesInput {
    ...
    pub fn builder() -> super::operation::list_repositories::builders::ListRepositoriesInputBuilder {
        super::operation::list_repositories::builders::ListRepositoriesInputBuilder::default()
    }
}
...
impl ListRepositoriesInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_repositories::ListRepositoriesInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_repositories::ListRepositoriesInput {
