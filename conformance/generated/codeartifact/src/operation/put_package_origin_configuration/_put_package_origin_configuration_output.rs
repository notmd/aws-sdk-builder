...
impl PutPackageOriginConfigurationOutput {
    ...
    pub fn builder() -> super::operation::put_package_origin_configuration::builders::PutPackageOriginConfigurationOutputBuilder {
        super::operation::put_package_origin_configuration::builders::PutPackageOriginConfigurationOutputBuilder::default()
    }
}
...
impl PutPackageOriginConfigurationOutputBuilder {
    ...
    pub fn build(self) -> super::operation::put_package_origin_configuration::PutPackageOriginConfigurationOutput {
