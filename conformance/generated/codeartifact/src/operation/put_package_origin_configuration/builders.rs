...
pub use super::operation::put_package_origin_configuration::_put_package_origin_configuration_input::PutPackageOriginConfigurationInputBuilder;

pub use super::operation::put_package_origin_configuration::_put_package_origin_configuration_output::PutPackageOriginConfigurationOutputBuilder;

impl super::operation::put_package_origin_configuration::builders::PutPackageOriginConfigurationInputBuilder {
...
pub struct PutPackageOriginConfigurationFluentBuilder {
    ...
    inner: super::operation::put_package_origin_configuration::builders::PutPackageOriginConfigurationInputBuilder,
...
impl PutPackageOriginConfigurationFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::put_package_origin_configuration::builders::PutPackageOriginConfigurationInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::put_package_origin_configuration::PutPackageOriginConfiguration::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::put_package_origin_configuration::PutPackageOriginConfiguration::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn restrictions(mut self, input: super::types::PackageOriginRestrictions) -> Self {
        self.inner = self.inner.restrictions(input);
        self
    }
    /// <p>A <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageOriginRestrictions.html">PackageOriginRestrictions</a> object that contains information about the <code>upstream</code> and <code>publish</code> package origin restrictions. The <code>upstream</code> restriction determines if new package versions can be ingested or retained from external connections or upstream repositories. The <code>publish</code> restriction determines if new package versions can be published directly to the repository.</p>
    /// <p>You must include both the desired <code>upstream</code> and <code>publish</code> restrictions.</p>
    pub fn set_restrictions(mut self, input: ::std::option::Option<super::types::PackageOriginRestrictions>) -> Self {
        self.inner = self.inner.set_restrictions(input);
        self
    }
    /// <p>A <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageOriginRestrictions.html">PackageOriginRestrictions</a> object that contains information about the <code>upstream</code> and <code>publish</code> package origin restrictions. The <code>upstream</code> restriction determines if new package versions can be ingested or retained from external connections or upstream repositories. The <code>publish</code> restriction determines if new package versions can be published directly to the repository.</p>
    /// <p>You must include both the desired <code>upstream</code> and <code>publish</code> restrictions.</p>
    pub fn get_restrictions(&self) -> &::std::option::Option<super::types::PackageOriginRestrictions> {
