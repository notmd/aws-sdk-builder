...
pub struct ListPackageVersionAssetsOutput {
    ...
    pub assets: ::std::option::Option<::std::vec::Vec<super::types::AssetSummary>>,
...
impl ListPackageVersionAssetsOutput {
    ...
    pub fn assets(&self) -> &[super::types::AssetSummary] {
...
impl ListPackageVersionAssetsOutput {
    ...
    pub fn builder() -> super::operation::list_package_version_assets::builders::ListPackageVersionAssetsOutputBuilder {
        super::operation::list_package_version_assets::builders::ListPackageVersionAssetsOutputBuilder::default()
    }
}
...
pub struct ListPackageVersionAssetsOutputBuilder {
    ...
    pub(crate) assets: ::std::option::Option<::std::vec::Vec<super::types::AssetSummary>>,
    _request_id: Option<String>,
}
impl ListPackageVersionAssetsOutputBuilder {
    ...
    ///
    /// <p>The returned list of <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_AssetSummary.html">AssetSummary</a> objects.</p>
    pub fn assets(mut self, input: super::types::AssetSummary) -> Self {
    ...
    /// <p>The returned list of <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_AssetSummary.html">AssetSummary</a> objects.</p>
    pub fn set_assets(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::AssetSummary>>) -> Self {
        self.assets = input;
        self
    }
    /// <p>The returned list of <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_AssetSummary.html">AssetSummary</a> objects.</p>
    pub fn get_assets(&self) -> &::std::option::Option<::std::vec::Vec<super::types::AssetSummary>> {
        &self.assets
    }
    ...
    pub fn build(self) -> super::operation::list_package_version_assets::ListPackageVersionAssetsOutput {
