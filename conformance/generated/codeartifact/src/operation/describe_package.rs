    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::describe_package::DescribePackageError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::describe_package::DescribePackageOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribePackageResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_describe_package::de_describe_package_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_describe_package::de_describe_package_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribePackageRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::describe_package::DescribePackageInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::describe_package::DescribePackageInput,
...
impl ::aws_types::request_id::RequestId for super::operation::describe_package::DescribePackageError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::describe_package::_describe_package_input::DescribePackageInput;

pub use super::operation::describe_package::_describe_package_output::DescribePackageOutput;
