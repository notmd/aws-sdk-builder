    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_packages::ListPackagesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_packages::ListPackagesOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListPackagesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_packages::de_list_packages_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_packages::de_list_packages_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListPackagesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_packages::ListPackagesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_packages::ListPackagesInput,
...
impl ::aws_types::request_id::RequestId for super::operation::list_packages::ListPackagesError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_packages::_list_packages_input::ListPackagesInput;

pub use super::operation::list_packages::_list_packages_output::ListPackagesOutput;
