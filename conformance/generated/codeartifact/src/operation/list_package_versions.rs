    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_package_versions::ListPackageVersionsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_package_versions::ListPackageVersionsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListPackageVersionsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_package_versions::de_list_package_versions_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_package_versions::de_list_package_versions_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListPackageVersionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_package_versions::ListPackageVersionsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_package_versions::ListPackageVersionsInput,
...
impl ::aws_types::request_id::RequestId for super::operation::list_package_versions::ListPackageVersionsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_package_versions::_list_package_versions_input::ListPackageVersionsInput;

pub use super::operation::list_package_versions::_list_package_versions_output::ListPackageVersionsOutput;
