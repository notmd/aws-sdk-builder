...
pub struct ListPackageVersionsPaginator {
    ...
    builder: super::operation::list_package_versions::builders::ListPackageVersionsInputBuilder,
...
impl ListPackageVersionsPaginator {
    ...
    pub fn items(self) -> super::operation::list_package_versions::paginator::ListPackageVersionsPaginatorItems {
        super::operation::list_package_versions::paginator::ListPackageVersionsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::operation::list_package_versions::ListPackageVersions::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_list_package_versions_output_output_next_token(resp);
...
impl ListPackageVersionsPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::types::PackageVersionSummary,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::operation::list_package_versions::ListPackageVersionsError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::lens::lens_list_package_versions_output_output_versions(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
