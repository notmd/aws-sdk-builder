...
pub struct ListPackageVersionsOutput {
    ...
    pub versions: ::std::option::Option<::std::vec::Vec<super::types::PackageVersionSummary>>,
...
impl ListPackageVersionsOutput {
    ...
    pub fn versions(&self) -> &[super::types::PackageVersionSummary] {
...
impl ListPackageVersionsOutput {
    ...
    pub fn builder() -> super::operation::list_package_versions::builders::ListPackageVersionsOutputBuilder {
        super::operation::list_package_versions::builders::ListPackageVersionsOutputBuilder::default()
    }
}
...
pub struct ListPackageVersionsOutputBuilder {
    ...
    pub(crate) versions: ::std::option::Option<::std::vec::Vec<super::types::PackageVersionSummary>>,
...
impl ListPackageVersionsOutputBuilder {
    ...
    ///
    /// <p>The returned list of <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageVersionSummary.html">PackageVersionSummary</a> objects.</p>
    pub fn versions(mut self, input: super::types::PackageVersionSummary) -> Self {
    ...
    /// <p>The returned list of <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageVersionSummary.html">PackageVersionSummary</a> objects.</p>
    pub fn set_versions(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::PackageVersionSummary>>) -> Self {
        self.versions = input;
        self
    }
    /// <p>The returned list of <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageVersionSummary.html">PackageVersionSummary</a> objects.</p>
    pub fn get_versions(&self) -> &::std::option::Option<::std::vec::Vec<super::types::PackageVersionSummary>> {
        &self.versions
    }
    /// <p>If there are additional results, this is the token for the next set of results.</p>
    ...
    pub fn build(self) -> super::operation::list_package_versions::ListPackageVersionsOutput {
