...
pub use super::operation::list_package_versions::_list_package_versions_input::ListPackageVersionsInputBuilder;

pub use super::operation::list_package_versions::_list_package_versions_output::ListPackageVersionsOutputBuilder;

impl super::operation::list_package_versions::builders::ListPackageVersionsInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::Client,
    ) -> ::std::result::Result<
        super::operation::list_package_versions::ListPackageVersionsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::list_package_versions::ListPackageVersionsError,
...
pub struct ListPackageVersionsFluentBuilder {
    ...
    inner: super::operation::list_package_versions::builders::ListPackageVersionsInputBuilder,
...
impl ListPackageVersionsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::list_package_versions::builders::ListPackageVersionsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::list_package_versions::ListPackageVersions::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::list_package_versions::ListPackageVersions::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::operation::list_package_versions::paginator::ListPackageVersionsPaginator {
        super::operation::list_package_versions::paginator::ListPackageVersionsPaginator::new(self.handle, self.inner)
    }
    ...
    pub fn status(mut self, input: super::types::PackageVersionStatus) -> Self {
        self.inner = self.inner.status(input);
        self
    }
    /// <p>A string that filters the requested package versions by status.</p>
    pub fn set_status(mut self, input: ::std::option::Option<super::types::PackageVersionStatus>) -> Self {
        self.inner = self.inner.set_status(input);
        self
    }
    /// <p>A string that filters the requested package versions by status.</p>
    pub fn get_status(&self) -> &::std::option::Option<super::types::PackageVersionStatus> {
        self.inner.get_status()
    }
    /// <p>How to sort the requested list of package versions.</p>
    pub fn sort_by(mut self, input: super::types::PackageVersionSortType) -> Self {
        self.inner = self.inner.sort_by(input);
        self
    }
    /// <p>How to sort the requested list of package versions.</p>
    pub fn set_sort_by(mut self, input: ::std::option::Option<super::types::PackageVersionSortType>) -> Self {
        self.inner = self.inner.set_sort_by(input);
        self
    }
    /// <p>How to sort the requested list of package versions.</p>
    pub fn get_sort_by(&self) -> &::std::option::Option<super::types::PackageVersionSortType> {
    ...
    pub fn origin_type(mut self, input: super::types::PackageVersionOriginType) -> Self {
        self.inner = self.inner.origin_type(input);
        self
    }
    /// <p>The <code>originType</code> used to filter package versions. Only package versions with the provided <code>originType</code> will be returned.</p>
    pub fn set_origin_type(mut self, input: ::std::option::Option<super::types::PackageVersionOriginType>) -> Self {
        self.inner = self.inner.set_origin_type(input);
        self
    }
    /// <p>The <code>originType</code> used to filter package versions. Only package versions with the provided <code>originType</code> will be returned.</p>
    pub fn get_origin_type(&self) -> &::std::option::Option<super::types::PackageVersionOriginType> {
