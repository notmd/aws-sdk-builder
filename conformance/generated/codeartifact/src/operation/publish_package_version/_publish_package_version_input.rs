...
impl PublishPackageVersionInput {
    ...
    pub fn builder() -> super::operation::publish_package_version::builders::PublishPackageVersionInputBuilder {
        super::operation::publish_package_version::builders::PublishPackageVersionInputBuilder::default()
    }
}
...
impl PublishPackageVersionInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::publish_package_version::PublishPackageVersionInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::publish_package_version::PublishPackageVersionInput {
            domain: self.domain,
