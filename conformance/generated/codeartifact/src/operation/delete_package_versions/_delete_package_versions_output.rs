...
impl DeletePackageVersionsOutput {
    ...
    pub fn builder() -> super::operation::delete_package_versions::builders::DeletePackageVersionsOutputBuilder {
        super::operation::delete_package_versions::builders::DeletePackageVersionsOutputBuilder::default()
    }
}
...
impl DeletePackageVersionsOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_package_versions::DeletePackageVersionsOutput {
