...
impl DeletePackageVersionsInput {
    ...
    pub fn builder() -> super::operation::delete_package_versions::builders::DeletePackageVersionsInputBuilder {
        super::operation::delete_package_versions::builders::DeletePackageVersionsInputBuilder::default()
    }
}
...
impl DeletePackageVersionsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::delete_package_versions::DeletePackageVersionsInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::delete_package_versions::DeletePackageVersionsInput {
            domain: self.domain,
