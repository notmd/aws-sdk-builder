...
impl GetRepositoryEndpointOutput {
    ...
    pub fn builder() -> super::operation::get_repository_endpoint::builders::GetRepositoryEndpointOutputBuilder {
        super::operation::get_repository_endpoint::builders::GetRepositoryEndpointOutputBuilder::default()
    }
}
...
impl GetRepositoryEndpointOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_repository_endpoint::GetRepositoryEndpointOutput {
