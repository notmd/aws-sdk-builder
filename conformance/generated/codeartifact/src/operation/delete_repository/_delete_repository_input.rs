...
impl DeleteRepositoryInput {
    ...
    pub fn builder() -> super::operation::delete_repository::builders::DeleteRepositoryInputBuilder {
        super::operation::delete_repository::builders::DeleteRepositoryInputBuilder::default()
    }
}
...
impl DeleteRepositoryInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::delete_repository::DeleteRepositoryInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::delete_repository::DeleteRepositoryInput {
            domain: self.domain,
