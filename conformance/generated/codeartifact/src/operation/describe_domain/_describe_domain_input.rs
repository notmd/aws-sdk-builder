...
impl DescribeDomainInput {
    ...
    pub fn builder() -> super::operation::describe_domain::builders::DescribeDomainInputBuilder {
        super::operation::describe_domain::builders::DescribeDomainInputBuilder::default()
    }
}
...
impl DescribeDomainInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::describe_domain::DescribeDomainInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::describe_domain::DescribeDomainInput {
            domain: self.domain,
