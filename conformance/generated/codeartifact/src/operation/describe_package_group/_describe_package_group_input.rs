...
impl DescribePackageGroupInput {
    ...
    pub fn builder() -> super::operation::describe_package_group::builders::DescribePackageGroupInputBuilder {
        super::operation::describe_package_group::builders::DescribePackageGroupInputBuilder::default()
    }
}
...
impl DescribePackageGroupInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::describe_package_group::DescribePackageGroupInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::describe_package_group::DescribePackageGroupInput {
            domain: self.domain,
