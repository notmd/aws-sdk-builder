...
impl DescribePackageGroupOutput {
    ...
    pub fn builder() -> super::operation::describe_package_group::builders::DescribePackageGroupOutputBuilder {
        super::operation::describe_package_group::builders::DescribePackageGroupOutputBuilder::default()
    }
}
...
impl DescribePackageGroupOutputBuilder {
    ...
    pub fn build(self) -> super::operation::describe_package_group::DescribePackageGroupOutput {
