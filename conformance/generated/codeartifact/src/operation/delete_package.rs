    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_package::DeletePackageError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_package::DeletePackageOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeletePackageResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_package::de_delete_package_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_package::de_delete_package_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeletePackageRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_package::DeletePackageInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_package::DeletePackageInput,
...
impl ::aws_types::request_id::RequestId for super::operation::delete_package::DeletePackageError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_package::_delete_package_input::DeletePackageInput;

pub use super::operation::delete_package::_delete_package_output::DeletePackageOutput;
