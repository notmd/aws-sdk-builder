...
impl GetPackageVersionAssetOutput {
    ...
    pub fn builder() -> super::operation::get_package_version_asset::builders::GetPackageVersionAssetOutputBuilder {
        super::operation::get_package_version_asset::builders::GetPackageVersionAssetOutputBuilder::default()
    }
}
...
impl GetPackageVersionAssetOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_package_version_asset::GetPackageVersionAssetOutput {
