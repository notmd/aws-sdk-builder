    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::describe_package_version::DescribePackageVersionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::describe_package_version::DescribePackageVersionOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribePackageVersionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_describe_package_version::de_describe_package_version_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_describe_package_version::de_describe_package_version_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribePackageVersionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::describe_package_version::DescribePackageVersionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::describe_package_version::DescribePackageVersionInput,
...
impl ::aws_types::request_id::RequestId for super::operation::describe_package_version::DescribePackageVersionError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::describe_package_version::_describe_package_version_input::DescribePackageVersionInput;

pub use super::operation::describe_package_version::_describe_package_version_output::DescribePackageVersionOutput;
