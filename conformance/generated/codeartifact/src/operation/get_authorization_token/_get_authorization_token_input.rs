...
impl GetAuthorizationTokenInput {
    ...
    pub fn builder() -> super::operation::get_authorization_token::builders::GetAuthorizationTokenInputBuilder {
        super::operation::get_authorization_token::builders::GetAuthorizationTokenInputBuilder::default()
    }
}
...
impl GetAuthorizationTokenInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_authorization_token::GetAuthorizationTokenInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::get_authorization_token::GetAuthorizationTokenInput {
            domain: self.domain,
