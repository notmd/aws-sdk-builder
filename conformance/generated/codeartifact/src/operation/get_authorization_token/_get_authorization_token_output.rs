...
impl GetAuthorizationTokenOutput {
    ...
    pub fn builder() -> super::operation::get_authorization_token::builders::GetAuthorizationTokenOutputBuilder {
        super::operation::get_authorization_token::builders::GetAuthorizationTokenOutputBuilder::default()
    }
}
...
impl GetAuthorizationTokenOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_authorization_token::GetAuthorizationTokenOutput {
