...
impl DeleteDomainPermissionsPolicyInput {
    ...
    pub fn builder() -> super::operation::delete_domain_permissions_policy::builders::DeleteDomainPermissionsPolicyInputBuilder {
        super::operation::delete_domain_permissions_policy::builders::DeleteDomainPermissionsPolicyInputBuilder::default()
    }
}
...
impl DeleteDomainPermissionsPolicyInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::delete_domain_permissions_policy::DeleteDomainPermissionsPolicyInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::delete_domain_permissions_policy::DeleteDomainPermissionsPolicyInput {
            domain: self.domain,
