...
pub use super::operation::create_repository::_create_repository_input::CreateRepositoryInputBuilder;

pub use super::operation::create_repository::_create_repository_output::CreateRepositoryOutputBuilder;

impl super::operation::create_repository::builders::CreateRepositoryInputBuilder {
...
pub struct CreateRepositoryFluentBuilder {
    ...
    inner: super::operation::create_repository::builders::CreateRepositoryInputBuilder,
...
impl CreateRepositoryFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::create_repository::builders::CreateRepositoryInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::create_repository::CreateRepository::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::create_repository::CreateRepository::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn upstreams(mut self, input: super::types::UpstreamRepository) -> Self {
        self.inner = self.inner.upstreams(input);
        self
    }
    /// <p>A list of upstream repositories to associate with the repository. The order of the upstream repositories in the list determines their priority order when CodeArtifact looks for a requested package version. For more information, see <a href="https://docs.aws.amazon.com/codeartifact/latest/ug/repos-upstream.html">Working with upstream repositories</a>.</p>
    pub fn set_upstreams(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::UpstreamRepository>>) -> Self {
        self.inner = self.inner.set_upstreams(input);
        self
    }
    /// <p>A list of upstream repositories to associate with the repository. The order of the upstream repositories in the list determines their priority order when CodeArtifact looks for a requested package version. For more information, see <a href="https://docs.aws.amazon.com/codeartifact/latest/ug/repos-upstream.html">Working with upstream repositories</a>.</p>
    pub fn get_upstreams(&self) -> &::std::option::Option<::std::vec::Vec<super::types::UpstreamRepository>> {
