...
impl CreatePackageGroupInput {
    ...
    pub fn builder() -> super::operation::create_package_group::builders::CreatePackageGroupInputBuilder {
        super::operation::create_package_group::builders::CreatePackageGroupInputBuilder::default()
    }
}
...
impl CreatePackageGroupInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::create_package_group::CreatePackageGroupInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::create_package_group::CreatePackageGroupInput {
            domain: self.domain,
