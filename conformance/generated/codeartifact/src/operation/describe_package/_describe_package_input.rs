...
impl DescribePackageInput {
    ...
    pub fn builder() -> super::operation::describe_package::builders::DescribePackageInputBuilder {
        super::operation::describe_package::builders::DescribePackageInputBuilder::default()
    }
}
...
impl DescribePackageInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::describe_package::DescribePackageInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::describe_package::DescribePackageInput {
            domain: self.domain,
