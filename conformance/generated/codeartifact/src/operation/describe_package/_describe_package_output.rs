...
pub struct DescribePackageOutput {
    ...
    pub package: ::std::option::Option<super::types::PackageDescription>,
    _request_id: Option<String>,
}
impl DescribePackageOutput {
    /// <p>A <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageDescription.html">PackageDescription</a> object that contains information about the requested package.</p>
    pub fn package(&self) -> ::std::option::Option<&super::types::PackageDescription> {
        self.package.as_ref()
    }
}
...
impl DescribePackageOutput {
    ...
    pub fn builder() -> super::operation::describe_package::builders::DescribePackageOutputBuilder {
        super::operation::describe_package::builders::DescribePackageOutputBuilder::default()
    }
}
...
pub struct DescribePackageOutputBuilder {
    pub(crate) package: ::std::option::Option<super::types::PackageDescription>,
    _request_id: Option<String>,
}
impl DescribePackageOutputBuilder {
    /// <p>A <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageDescription.html">PackageDescription</a> object that contains information about the requested package.</p>
    /// This field is required.
    pub fn package(mut self, input: super::types::PackageDescription) -> Self {
        self.package = ::std::option::Option::Some(input);
        self
    }
    /// <p>A <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageDescription.html">PackageDescription</a> object that contains information about the requested package.</p>
    pub fn set_package(mut self, input: ::std::option::Option<super::types::PackageDescription>) -> Self {
        self.package = input;
        self
    }
    /// <p>A <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageDescription.html">PackageDescription</a> object that contains information about the requested package.</p>
    pub fn get_package(&self) -> &::std::option::Option<super::types::PackageDescription> {
        &self.package
    }
    ...
    pub fn build(self) -> super::operation::describe_package::DescribePackageOutput {
