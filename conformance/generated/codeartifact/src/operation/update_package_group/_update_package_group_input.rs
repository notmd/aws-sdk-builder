...
impl UpdatePackageGroupInput {
    ...
    pub fn builder() -> super::operation::update_package_group::builders::UpdatePackageGroupInputBuilder {
        super::operation::update_package_group::builders::UpdatePackageGroupInputBuilder::default()
    }
}
...
impl UpdatePackageGroupInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::update_package_group::UpdatePackageGroupInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::update_package_group::UpdatePackageGroupInput {
            domain: self.domain,
