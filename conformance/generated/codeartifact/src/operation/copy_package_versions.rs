    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::copy_package_versions::CopyPackageVersionsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::copy_package_versions::CopyPackageVersionsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CopyPackageVersionsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_copy_package_versions::de_copy_package_versions_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_copy_package_versions::de_copy_package_versions_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CopyPackageVersionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::copy_package_versions::CopyPackageVersionsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::copy_package_versions::CopyPackageVersionsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_copy_package_versions::ser_copy_package_versions_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::operation::copy_package_versions::CopyPackageVersionsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::copy_package_versions::_copy_package_versions_input::CopyPackageVersionsInput;

pub use super::operation::copy_package_versions::_copy_package_versions_output::CopyPackageVersionsOutput;
