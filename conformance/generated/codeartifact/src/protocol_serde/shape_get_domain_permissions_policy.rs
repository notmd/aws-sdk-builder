...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::get_domain_permissions_policy::GetDomainPermissionsPolicyError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => super::operation::get_domain_permissions_policy::GetDomainPermissionsPolicyError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::get_domain_permissions_policy::builders::GetDomainPermissionsPolicyOutputBuilder::default();
        output = super::protocol_serde::shape_get_domain_permissions_policy::de_get_domain_permissions_policy(_response_body, output)
            .map_err(super::operation::get_domain_permissions_policy::GetDomainPermissionsPolicyError::unhandled)?;
...
pub(crate) fn de_get_domain_permissions_policy(
    ...
    super::operation::get_domain_permissions_policy::builders::GetDomainPermissionsPolicyOutputBuilder,
