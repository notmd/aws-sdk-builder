...
pub fn de_create_package_group_http_error(
    ...
    super::operation::create_package_group::CreatePackageGroupOutput,
    super::operation::create_package_group::CreatePackageGroupError,
> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::create_package_group::CreatePackageGroupError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => super::operation::create_package_group::CreatePackageGroupError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::create_package_group::builders::CreatePackageGroupOutputBuilder::default();
        output = super::protocol_serde::shape_create_package_group::de_create_package_group(_response_body, output)
            .map_err(super::operation::create_package_group::CreatePackageGroupError::unhandled)?;
...
pub fn ser_create_package_group_input(
    ...
    super::protocol_serde::shape_create_package_group_input::ser_create_package_group_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_create_package_group(
    _value: &[u8],
    mut builder: super::operation::create_package_group::builders::CreatePackageGroupOutputBuilder,
) -> ::std::result::Result<
    super::operation::create_package_group::builders::CreatePackageGroupOutputBuilder,
