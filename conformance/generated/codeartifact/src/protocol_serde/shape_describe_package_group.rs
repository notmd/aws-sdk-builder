...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::describe_package_group::DescribePackageGroupError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => super::operation::describe_package_group::DescribePackageGroupError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::describe_package_group::builders::DescribePackageGroupOutputBuilder::default();
        output = super::protocol_serde::shape_describe_package_group::de_describe_package_group(_response_body, output)
            .map_err(super::operation::describe_package_group::DescribePackageGroupError::unhandled)?;
...
pub(crate) fn de_describe_package_group(
    ...
    super::operation::describe_package_group::builders::DescribePackageGroupOutputBuilder,
