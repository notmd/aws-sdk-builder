...
pub fn de_describe_repository_http_error(
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::describe_repository::DescribeRepositoryError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => super::operation::describe_repository::DescribeRepositoryError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_repository_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::describe_repository::builders::DescribeRepositoryOutputBuilder::default();
        output = super::protocol_serde::shape_describe_repository::de_describe_repository(_response_body, output)
            .map_err(super::operation::describe_repository::DescribeRepositoryError::unhandled)?;
...
pub(crate) fn de_describe_repository(
    ...
    super::operation::describe_repository::builders::DescribeRepositoryOutputBuilder,
