...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::list_sub_package_groups::ListSubPackageGroupsError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => super::operation::list_sub_package_groups::ListSubPackageGroupsError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::list_sub_package_groups::builders::ListSubPackageGroupsOutputBuilder::default();
        output = super::protocol_serde::shape_list_sub_package_groups::de_list_sub_package_groups(_response_body, output)
            .map_err(super::operation::list_sub_package_groups::ListSubPackageGroupsError::unhandled)?;
...
pub(crate) fn de_list_sub_package_groups(
    ...
    super::operation::list_sub_package_groups::builders::ListSubPackageGroupsOutputBuilder,
