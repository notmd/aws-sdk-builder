...
pub(crate) fn de_repository_description<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::types::RepositoryDescription>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::types::builders::RepositoryDescriptionBuilder::default();
            loop {
                match tokens.next().transpose()? {
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "upstreams" => {
                                builder = builder.set_upstreams(
                                    super::protocol_serde::shape_upstream_repository_info_list::de_upstream_repository_info_list(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
