...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::copy_package_versions::CopyPackageVersionsError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => super::operation::copy_package_versions::CopyPackageVersionsError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::copy_package_versions::builders::CopyPackageVersionsOutputBuilder::default();
        output = super::protocol_serde::shape_copy_package_versions::de_copy_package_versions(_response_body, output)
            .map_err(super::operation::copy_package_versions::CopyPackageVersionsError::unhandled)?;
...
pub fn ser_copy_package_versions_input(
    ...
    super::protocol_serde::shape_copy_package_versions_input::ser_copy_package_versions_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_copy_package_versions(
    _value: &[u8],
    mut builder: super::operation::copy_package_versions::builders::CopyPackageVersionsOutputBuilder,
) -> ::std::result::Result<
    super::operation::copy_package_versions::builders::CopyPackageVersionsOutputBuilder,
