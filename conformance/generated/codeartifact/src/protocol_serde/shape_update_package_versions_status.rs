...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::update_package_versions_status::UpdatePackageVersionsStatusError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => super::operation::update_package_versions_status::UpdatePackageVersionsStatusError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            super::operation::update_package_versions_status::UpdatePackageVersionsStatusError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ThrottlingException" => super::operation::update_package_versions_status::UpdatePackageVersionsStatusError::ThrottlingException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::update_package_versions_status::builders::UpdatePackageVersionsStatusOutputBuilder::default();
        output = super::protocol_serde::shape_update_package_versions_status::de_update_package_versions_status(_response_body, output)
            .map_err(super::operation::update_package_versions_status::UpdatePackageVersionsStatusError::unhandled)?;
...
pub fn ser_update_package_versions_status_input(
    ...
    super::protocol_serde::shape_update_package_versions_status_input::ser_update_package_versions_status_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_update_package_versions_status(
    _value: &[u8],
    mut builder: super::operation::update_package_versions_status::builders::UpdatePackageVersionsStatusOutputBuilder,
) -> ::std::result::Result<
    super::operation::update_package_versions_status::builders::UpdatePackageVersionsStatusOutputBuilder,
