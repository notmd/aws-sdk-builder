...
pub fn de_create_repository_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::create_repository::CreateRepositoryOutput, super::operation::create_repository::CreateRepositoryError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::create_repository::CreateRepositoryError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => super::operation::create_repository::CreateRepositoryError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_create_repository_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::create_repository::builders::CreateRepositoryOutputBuilder::default();
        output = super::protocol_serde::shape_create_repository::de_create_repository(_response_body, output)
            .map_err(super::operation::create_repository::CreateRepositoryError::unhandled)?;
...
pub fn ser_create_repository_input(
    ...
    super::protocol_serde::shape_create_repository_input::ser_create_repository_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_create_repository(
    _value: &[u8],
    mut builder: super::operation::create_repository::builders::CreateRepositoryOutputBuilder,
) -> ::std::result::Result<
    super::operation::create_repository::builders::CreateRepositoryOutputBuilder,
