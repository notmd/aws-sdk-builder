...
pub fn de_put_domain_permissions_policy_http_error(
    ...
    super::operation::put_domain_permissions_policy::PutDomainPermissionsPolicyOutput,
    super::operation::put_domain_permissions_policy::PutDomainPermissionsPolicyError,
> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::put_domain_permissions_policy::PutDomainPermissionsPolicyError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => super::operation::put_domain_permissions_policy::PutDomainPermissionsPolicyError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceQuotaExceededException" => {
            super::operation::put_domain_permissions_policy::PutDomainPermissionsPolicyError::ServiceQuotaExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ThrottlingException" => super::operation::put_domain_permissions_policy::PutDomainPermissionsPolicyError::ThrottlingException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::put_domain_permissions_policy::builders::PutDomainPermissionsPolicyOutputBuilder::default();
        output = super::protocol_serde::shape_put_domain_permissions_policy::de_put_domain_permissions_policy(_response_body, output)
            .map_err(super::operation::put_domain_permissions_policy::PutDomainPermissionsPolicyError::unhandled)?;
...
pub fn ser_put_domain_permissions_policy_input(
    input: &super::operation::put_domain_permissions_policy::PutDomainPermissionsPolicyInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    super::protocol_serde::shape_put_domain_permissions_policy_input::ser_put_domain_permissions_policy_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_put_domain_permissions_policy(
    _value: &[u8],
    mut builder: super::operation::put_domain_permissions_policy::builders::PutDomainPermissionsPolicyOutputBuilder,
) -> ::std::result::Result<
    super::operation::put_domain_permissions_policy::builders::PutDomainPermissionsPolicyOutputBuilder,
