...
pub fn de_update_repository_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::update_repository::UpdateRepositoryOutput, super::operation::update_repository::UpdateRepositoryError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::update_repository::UpdateRepositoryError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => super::operation::update_repository::UpdateRepositoryError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_update_repository_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::update_repository::builders::UpdateRepositoryOutputBuilder::default();
        output = super::protocol_serde::shape_update_repository::de_update_repository(_response_body, output)
            .map_err(super::operation::update_repository::UpdateRepositoryError::unhandled)?;
...
pub fn ser_update_repository_input(
    ...
    super::protocol_serde::shape_update_repository_input::ser_update_repository_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_update_repository(
    _value: &[u8],
    mut builder: super::operation::update_repository::builders::UpdateRepositoryOutputBuilder,
) -> ::std::result::Result<
    super::operation::update_repository::builders::UpdateRepositoryOutputBuilder,
