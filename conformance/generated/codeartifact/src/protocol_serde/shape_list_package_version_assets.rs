...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(super::operation::list_package_version_assets::ListPackageVersionAssetsError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "AccessDeniedException" => super::operation::list_package_version_assets::ListPackageVersionAssetsError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::list_package_version_assets::builders::ListPackageVersionAssetsOutputBuilder::default();
        output = super::protocol_serde::shape_list_package_version_assets::de_list_package_version_assets(_response_body, output)
            .map_err(super::operation::list_package_version_assets::ListPackageVersionAssetsError::unhandled)?;
...
pub(crate) fn de_list_package_version_assets(
    ...
    super::operation::list_package_version_assets::builders::ListPackageVersionAssetsOutputBuilder,
