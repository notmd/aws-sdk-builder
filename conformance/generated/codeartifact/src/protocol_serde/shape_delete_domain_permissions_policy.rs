...
pub fn de_delete_domain_permissions_policy_http_error(
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::delete_domain_permissions_policy::DeleteDomainPermissionsPolicyError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => super::operation::delete_domain_permissions_policy::DeleteDomainPermissionsPolicyError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalServerException" => {
            super::operation::delete_domain_permissions_policy::DeleteDomainPermissionsPolicyError::InternalServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            super::operation::delete_domain_permissions_policy::DeleteDomainPermissionsPolicyError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ThrottlingException" => super::operation::delete_domain_permissions_policy::DeleteDomainPermissionsPolicyError::ThrottlingException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_domain_permissions_policy_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::delete_domain_permissions_policy::builders::DeleteDomainPermissionsPolicyOutputBuilder::default();
        output = super::protocol_serde::shape_delete_domain_permissions_policy::de_delete_domain_permissions_policy(_response_body, output)
            .map_err(super::operation::delete_domain_permissions_policy::DeleteDomainPermissionsPolicyError::unhandled)?;
...
pub(crate) fn de_delete_domain_permissions_policy(
    ...
    super::operation::delete_domain_permissions_policy::builders::DeleteDomainPermissionsPolicyOutputBuilder,
