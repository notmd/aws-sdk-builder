...
pub fn de_associate_external_connection_http_error(
    ...
    super::operation::associate_external_connection::AssociateExternalConnectionOutput,
    super::operation::associate_external_connection::AssociateExternalConnectionError,
> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::associate_external_connection::AssociateExternalConnectionError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => super::operation::associate_external_connection::AssociateExternalConnectionError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            super::operation::associate_external_connection::AssociateExternalConnectionError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceQuotaExceededException" => {
            super::operation::associate_external_connection::AssociateExternalConnectionError::ServiceQuotaExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ThrottlingException" => super::operation::associate_external_connection::AssociateExternalConnectionError::ThrottlingException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::associate_external_connection::builders::AssociateExternalConnectionOutputBuilder::default();
        output = super::protocol_serde::shape_associate_external_connection::de_associate_external_connection(_response_body, output)
            .map_err(super::operation::associate_external_connection::AssociateExternalConnectionError::unhandled)?;
...
pub(crate) fn de_associate_external_connection(
    ...
    super::operation::associate_external_connection::builders::AssociateExternalConnectionOutputBuilder,
