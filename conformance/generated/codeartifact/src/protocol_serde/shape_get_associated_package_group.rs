...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(super::operation::get_associated_package_group::GetAssociatedPackageGroupError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "AccessDeniedException" => super::operation::get_associated_package_group::GetAssociatedPackageGroupError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::get_associated_package_group::builders::GetAssociatedPackageGroupOutputBuilder::default();
        output = super::protocol_serde::shape_get_associated_package_group::de_get_associated_package_group(_response_body, output)
            .map_err(super::operation::get_associated_package_group::GetAssociatedPackageGroupError::unhandled)?;
...
pub(crate) fn de_get_associated_package_group(
    ...
    super::operation::get_associated_package_group::builders::GetAssociatedPackageGroupOutputBuilder,
                ...
                "associationType" => {
                    builder = builder.set_association_type(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| super::types::PackageGroupAssociationType::from(u.as_ref())))
                            .transpose()?,
                    );
                }
