...
pub fn de_describe_package_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::describe_package::DescribePackageOutput, super::operation::describe_package::DescribePackageError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::describe_package::DescribePackageError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => super::operation::describe_package::DescribePackageError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_describe_package_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::describe_package::builders::DescribePackageOutputBuilder::default();
        output = super::protocol_serde::shape_describe_package::de_describe_package(_response_body, output)
            .map_err(super::operation::describe_package::DescribePackageError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::serde_util::describe_package_output_output_correct_errors(output).build()
    })
}
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "package" => {
                    builder = builder.set_package(super::protocol_serde::shape_package_description::de_package_description(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
