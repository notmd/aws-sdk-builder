...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::delete_package_group::DeletePackageGroupError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => super::operation::delete_package_group::DeletePackageGroupError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::delete_package_group::builders::DeletePackageGroupOutputBuilder::default();
        output = super::protocol_serde::shape_delete_package_group::de_delete_package_group(_response_body, output)
            .map_err(super::operation::delete_package_group::DeletePackageGroupError::unhandled)?;
...
pub(crate) fn de_delete_package_group(
    ...
    super::operation::delete_package_group::builders::DeletePackageGroupOutputBuilder,
