...
pub fn de_list_repositories_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::list_repositories::ListRepositoriesOutput, super::operation::list_repositories::ListRepositoriesError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::list_repositories::ListRepositoriesError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => super::operation::list_repositories::ListRepositoriesError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_list_repositories_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::list_repositories::builders::ListRepositoriesOutputBuilder::default();
        output = super::protocol_serde::shape_list_repositories::de_list_repositories(_response_body, output)
            .map_err(super::operation::list_repositories::ListRepositoriesError::unhandled)?;
...
pub(crate) fn de_list_repositories(
    ...
    super::operation::list_repositories::builders::ListRepositoriesOutputBuilder,
