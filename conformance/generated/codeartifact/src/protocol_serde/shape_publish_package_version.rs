...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::publish_package_version::PublishPackageVersionError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => super::operation::publish_package_version::PublishPackageVersionError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::publish_package_version::builders::PublishPackageVersionOutputBuilder::default();
        output = super::protocol_serde::shape_publish_package_version::de_publish_package_version(_response_body, output)
            .map_err(super::operation::publish_package_version::PublishPackageVersionError::unhandled)?;
...
pub(crate) fn de_publish_package_version(
    _value: &[u8],
    mut builder: super::operation::publish_package_version::builders::PublishPackageVersionOutputBuilder,
) -> ::std::result::Result<
    super::operation::publish_package_version::builders::PublishPackageVersionOutputBuilder,
