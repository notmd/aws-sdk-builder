...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::get_repository_endpoint::GetRepositoryEndpointError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => super::operation::get_repository_endpoint::GetRepositoryEndpointError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::get_repository_endpoint::builders::GetRepositoryEndpointOutputBuilder::default();
        output = super::protocol_serde::shape_get_repository_endpoint::de_get_repository_endpoint(_response_body, output)
            .map_err(super::operation::get_repository_endpoint::GetRepositoryEndpointError::unhandled)?;
...
pub(crate) fn de_get_repository_endpoint(
    ...
    super::operation::get_repository_endpoint::builders::GetRepositoryEndpointOutputBuilder,
