...
pub fn de_list_package_groups_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::list_package_groups::ListPackageGroupsOutput, super::operation::list_package_groups::ListPackageGroupsError>
{
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::list_package_groups::ListPackageGroupsError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => super::operation::list_package_groups::ListPackageGroupsError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
) -> std::result::Result<super::operation::list_package_groups::ListPackageGroupsOutput, super::operation::list_package_groups::ListPackageGroupsError>
{
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::list_package_groups::builders::ListPackageGroupsOutputBuilder::default();
        output = super::protocol_serde::shape_list_package_groups::de_list_package_groups(_response_body, output)
            .map_err(super::operation::list_package_groups::ListPackageGroupsError::unhandled)?;
...
pub(crate) fn de_list_package_groups(
    ...
    super::operation::list_package_groups::builders::ListPackageGroupsOutputBuilder,
