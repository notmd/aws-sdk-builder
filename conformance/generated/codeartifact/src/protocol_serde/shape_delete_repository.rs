...
pub fn de_delete_repository_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::delete_repository::DeleteRepositoryOutput, super::operation::delete_repository::DeleteRepositoryError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::delete_repository::DeleteRepositoryError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => super::operation::delete_repository::DeleteRepositoryError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_delete_repository_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::delete_repository::builders::DeleteRepositoryOutputBuilder::default();
        output = super::protocol_serde::shape_delete_repository::de_delete_repository(_response_body, output)
            .map_err(super::operation::delete_repository::DeleteRepositoryError::unhandled)?;
...
pub(crate) fn de_delete_repository(
    ...
    super::operation::delete_repository::builders::DeleteRepositoryOutputBuilder,
