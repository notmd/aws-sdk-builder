...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(super::operation::get_package_version_readme::GetPackageVersionReadmeError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "AccessDeniedException" => super::operation::get_package_version_readme::GetPackageVersionReadmeError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::get_package_version_readme::builders::GetPackageVersionReadmeOutputBuilder::default();
        output = super::protocol_serde::shape_get_package_version_readme::de_get_package_version_readme(_response_body, output)
            .map_err(super::operation::get_package_version_readme::GetPackageVersionReadmeError::unhandled)?;
...
pub(crate) fn de_get_package_version_readme(
    ...
    super::operation::get_package_version_readme::builders::GetPackageVersionReadmeOutputBuilder,
