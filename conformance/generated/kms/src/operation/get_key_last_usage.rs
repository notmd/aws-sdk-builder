...
pub mod _get_key_last_usage_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/kms/src/operation/get_key_last_usage/_get_key_last_usage_input.rs"
    ));
}
...
pub mod _get_key_last_usage_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/kms/src/operation/get_key_last_usage/_get_key_last_usage_output.rs"
    ));
}
