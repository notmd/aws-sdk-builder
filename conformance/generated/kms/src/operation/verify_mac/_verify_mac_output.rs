...
impl VerifyMacOutput {
    ...
    pub fn builder() -> super::operation::verify_mac::builders::VerifyMacOutputBuilder {
        super::operation::verify_mac::builders::VerifyMacOutputBuilder::default()
    }
}
...
impl VerifyMacOutputBuilder {
    ...
    pub fn build(self) -> super::operation::verify_mac::VerifyMacOutput {
