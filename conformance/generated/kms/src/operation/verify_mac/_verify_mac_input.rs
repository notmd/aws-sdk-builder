...
impl VerifyMacInput {
    ...
    pub fn builder() -> super::operation::verify_mac::builders::VerifyMacInputBuilder {
        super::operation::verify_mac::builders::VerifyMacInputBuilder::default()
    }
}
...
impl VerifyMacInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::verify_mac::VerifyMacInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::verify_mac::VerifyMacInput {
