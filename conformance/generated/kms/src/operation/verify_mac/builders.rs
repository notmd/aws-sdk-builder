...
pub use super::operation::verify_mac::_verify_mac_input::VerifyMacInputBuilder;

pub use super::operation::verify_mac::_verify_mac_output::VerifyMacOutputBuilder;

impl super::operation::verify_mac::builders::VerifyMacInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::Client,
    ) -> ::std::result::Result<
        super::operation::verify_mac::VerifyMacOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::verify_mac::VerifyMacError,
...
pub struct VerifyMacFluentBuilder {
    ...
    inner: super::operation::verify_mac::builders::VerifyMacInputBuilder,
    config_override: ::std::option::Option<super::config::Builder>,
}
impl super::client::customize::internal::CustomizableSend<super::operation::verify_mac::VerifyMacOutput, super::operation::verify_mac::VerifyMacError>
    for VerifyMacFluentBuilder
{
    fn send(
        ...
        super::client::customize::internal::SendResult<super::operation::verify_mac::VerifyMacOutput, super::operation::verify_mac::VerifyMacError>,
    > {
...
impl VerifyMacFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::verify_mac::builders::VerifyMacInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::verify_mac::VerifyMac::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::verify_mac::VerifyMac::orchestrate(&runtime_plugins, input).await
    }
