    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::generate_data_key_without_plaintext::GenerateDataKeyWithoutPlaintextError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::generate_data_key_without_plaintext::GenerateDataKeyWithoutPlaintextOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GenerateDataKeyWithoutPlaintextResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_generate_data_key_without_plaintext::de_generate_data_key_without_plaintext_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_generate_data_key_without_plaintext::de_generate_data_key_without_plaintext_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GenerateDataKeyWithoutPlaintextRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::generate_data_key_without_plaintext::GenerateDataKeyWithoutPlaintextInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::generate_data_key_without_plaintext::GenerateDataKeyWithoutPlaintextInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_generate_data_key_without_plaintext::ser_generate_data_key_without_plaintext_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::generate_data_key_without_plaintext::GenerateDataKeyWithoutPlaintextError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::generate_data_key_without_plaintext::_generate_data_key_without_plaintext_input::GenerateDataKeyWithoutPlaintextInput;

pub use super::operation::generate_data_key_without_plaintext::_generate_data_key_without_plaintext_output::GenerateDataKeyWithoutPlaintextOutput;
