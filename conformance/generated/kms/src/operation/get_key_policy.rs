...
impl GetKeyPolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::get_key_policy::GetKeyPolicyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_key_policy::GetKeyPolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_key_policy::GetKeyPolicyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetKeyPolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_key_policy::de_get_key_policy_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_key_policy::de_get_key_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetKeyPolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_key_policy::GetKeyPolicyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_key_policy::GetKeyPolicyInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_get_key_policy::ser_get_key_policy_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::get_key_policy::GetKeyPolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_key_policy::_get_key_policy_input::GetKeyPolicyInput;

pub use super::operation::get_key_policy::_get_key_policy_output::GetKeyPolicyOutput;
