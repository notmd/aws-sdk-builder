...
impl GenerateDataKeyPairInput {
    ...
    pub fn builder() -> super::operation::generate_data_key_pair::builders::GenerateDataKeyPairInputBuilder {
        super::operation::generate_data_key_pair::builders::GenerateDataKeyPairInputBuilder::default()
    }
}
...
impl GenerateDataKeyPairInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::generate_data_key_pair::GenerateDataKeyPairInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::generate_data_key_pair::GenerateDataKeyPairInput {
