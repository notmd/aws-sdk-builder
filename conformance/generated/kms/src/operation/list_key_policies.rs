...
impl ListKeyPolicies {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::operation::list_key_policies::ListKeyPoliciesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::list_key_policies::ListKeyPoliciesError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_key_policies::ListKeyPoliciesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_key_policies::ListKeyPoliciesOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListKeyPoliciesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_key_policies::de_list_key_policies_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_key_policies::de_list_key_policies_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListKeyPoliciesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_key_policies::ListKeyPoliciesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_key_policies::ListKeyPoliciesInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_list_key_policies::ser_list_key_policies_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::list_key_policies::ListKeyPoliciesError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_key_policies::_list_key_policies_input::ListKeyPoliciesInput;

pub use super::operation::list_key_policies::_list_key_policies_output::ListKeyPoliciesOutput;
