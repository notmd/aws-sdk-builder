...
impl UpdateKeyDescriptionInput {
    ...
    pub fn builder() -> super::operation::update_key_description::builders::UpdateKeyDescriptionInputBuilder {
        super::operation::update_key_description::builders::UpdateKeyDescriptionInputBuilder::default()
    }
}
...
impl UpdateKeyDescriptionInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::update_key_description::UpdateKeyDescriptionInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::update_key_description::UpdateKeyDescriptionInput {
            key_id: self.key_id,
