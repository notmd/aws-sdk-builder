...
impl RetireGrant {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::operation::retire_grant::RetireGrantOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::retire_grant::RetireGrantError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::retire_grant::RetireGrantError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::retire_grant::RetireGrantOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RetireGrantResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_retire_grant::de_retire_grant_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_retire_grant::de_retire_grant_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RetireGrantRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::retire_grant::RetireGrantInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::retire_grant::RetireGrantInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_retire_grant::ser_retire_grant_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::retire_grant::RetireGrantError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::retire_grant::_retire_grant_input::RetireGrantInput;

pub use super::operation::retire_grant::_retire_grant_output::RetireGrantOutput;
