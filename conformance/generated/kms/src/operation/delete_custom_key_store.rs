    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_custom_key_store::DeleteCustomKeyStoreError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_custom_key_store::DeleteCustomKeyStoreOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteCustomKeyStoreResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_custom_key_store::de_delete_custom_key_store_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_custom_key_store::de_delete_custom_key_store_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteCustomKeyStoreRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_custom_key_store::DeleteCustomKeyStoreInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_custom_key_store::DeleteCustomKeyStoreInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_delete_custom_key_store::ser_delete_custom_key_store_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::operation::delete_custom_key_store::DeleteCustomKeyStoreError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_custom_key_store::_delete_custom_key_store_input::DeleteCustomKeyStoreInput;

pub use super::operation::delete_custom_key_store::_delete_custom_key_store_output::DeleteCustomKeyStoreOutput;
