// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        pub type DeleteCustomKeyStoreInput = Input;
        pub type DeleteCustomKeyStoreOutput = Output;
        ...
        #[derive(Clone, Debug)]
        pub struct CustomKeyStoreHasCmKsException { pub meta: super::super::ErrorMetadata }
        impl CustomKeyStoreHasCmKsException { pub fn meta(&self) -> &super::super::ErrorMetadata { &self.meta } }
        #[derive(Clone, Debug)]
...
Self::Unhandled(message) => f.write_str(message),
                         Self::CustomKeyStoreHasCmKsException(_) => f.write_str("CustomKeyStoreHasCmKsException"),
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::DeleteCustomKeyStoreOutput, super::DeleteCustomKeyStoreError> {
                         ...
                         let response = self.client.request(super::super::super::transport::Method::Post, &path, &headers, &body).await.map_err(super::DeleteCustomKeyStoreError::Unhandled)?;
