    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::verify_mac::VerifyMacError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::verify_mac::VerifyMacOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for VerifyMacResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_verify_mac::de_verify_mac_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_verify_mac::de_verify_mac_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for VerifyMacRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::verify_mac::VerifyMacInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::verify_mac::VerifyMacInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_verify_mac::ser_verify_mac_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::verify_mac::VerifyMacError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::verify_mac::_verify_mac_input::VerifyMacInput;

pub use super::operation::verify_mac::_verify_mac_output::VerifyMacOutput;
