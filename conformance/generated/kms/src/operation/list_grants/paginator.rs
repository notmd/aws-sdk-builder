...
/// Paginator for [`ListGrants`](crate::operation::list_grants::ListGrants)
pub struct ListGrantsPaginator {
    handle: std::sync::Arc<super::client::Handle>,
    builder: super::operation::list_grants::builders::ListGrantsInputBuilder,
...
impl ListGrantsPaginator {
    ...
    pub fn items(self) -> super::operation::list_grants::paginator::ListGrantsPaginatorItems {
        super::operation::list_grants::paginator::ListGrantsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::operation::list_grants::ListGrants::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_list_grants_output_output_next_marker(resp);
...
impl ListGrantsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| super::lens::lens_list_grants_output_output_grants(page).unwrap_or_default().into_iter())
    }
}
