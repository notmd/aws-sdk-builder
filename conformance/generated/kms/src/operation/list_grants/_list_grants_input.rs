...
impl ListGrantsInput {
    ...
    pub fn builder() -> super::operation::list_grants::builders::ListGrantsInputBuilder {
        super::operation::list_grants::builders::ListGrantsInputBuilder::default()
    }
}
...
impl ListGrantsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::list_grants::ListGrantsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_grants::ListGrantsInput {
            limit: self.limit,
            marker: self.marker,
            key_id: self.key_id,
