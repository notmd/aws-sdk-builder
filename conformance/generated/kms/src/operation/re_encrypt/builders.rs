...
pub use super::operation::re_encrypt::_re_encrypt_input::ReEncryptInputBuilder;

pub use super::operation::re_encrypt::_re_encrypt_output::ReEncryptOutputBuilder;

impl super::operation::re_encrypt::builders::ReEncryptInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::Client,
    ) -> ::std::result::Result<
        super::operation::re_encrypt::ReEncryptOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::re_encrypt::ReEncryptError,
...
pub struct ReEncryptFluentBuilder {
    ...
    inner: super::operation::re_encrypt::builders::ReEncryptInputBuilder,
    config_override: ::std::option::Option<super::config::Builder>,
}
impl super::client::customize::internal::CustomizableSend<super::operation::re_encrypt::ReEncryptOutput, super::operation::re_encrypt::ReEncryptError>
    for ReEncryptFluentBuilder
{
    fn send(
        ...
        super::client::customize::internal::SendResult<super::operation::re_encrypt::ReEncryptOutput, super::operation::re_encrypt::ReEncryptError>,
    > {
...
impl ReEncryptFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::re_encrypt::builders::ReEncryptInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::re_encrypt::ReEncrypt::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::re_encrypt::ReEncrypt::orchestrate(&runtime_plugins, input).await
    }
    ...
    ///
    /// Appends an item to `DryRunModifiers`.
    ///
    ...
    pub fn dry_run_modifiers(mut self, input: super::types::DryRunModifierType) -> Self {
        self.inner = self.inner.dry_run_modifiers(input);
        self
    }
    /// <p>Specifies the modifiers to apply to the dry run operation. <code>DryRunModifiers</code> is an optional parameter that only applies when <code>DryRun</code> is set to <code>true</code>.</p>
    /// <p>When set to <code>IGNORE_CIPHERTEXT</code>, KMS performs only authorization validation without ciphertext validation. This allows you to test permissions without requiring a valid ciphertext blob.</p>
    ...
    pub fn set_dry_run_modifiers(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::DryRunModifierType>>) -> Self {
        self.inner = self.inner.set_dry_run_modifiers(input);
        self
    }
    /// <p>Specifies the modifiers to apply to the dry run operation. <code>DryRunModifiers</code> is an optional parameter that only applies when <code>DryRun</code> is set to <code>true</code>.</p>
    /// <p>When set to <code>IGNORE_CIPHERTEXT</code>, KMS performs only authorization validation without ciphertext validation. This allows you to test permissions without requiring a valid ciphertext blob.</p>
