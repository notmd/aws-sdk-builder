...
impl ReEncryptOutput {
    ...
    pub fn builder() -> super::operation::re_encrypt::builders::ReEncryptOutputBuilder {
        super::operation::re_encrypt::builders::ReEncryptOutputBuilder::default()
    }
}
...
impl ReEncryptOutputBuilder {
    ...
    pub fn build(self) -> super::operation::re_encrypt::ReEncryptOutput {
