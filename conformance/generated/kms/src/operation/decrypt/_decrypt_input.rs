...
impl DecryptInput {
    ...
    pub fn builder() -> super::operation::decrypt::builders::DecryptInputBuilder {
        super::operation::decrypt::builders::DecryptInputBuilder::default()
    }
}
...
impl DecryptInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::decrypt::DecryptInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::decrypt::DecryptInput {
