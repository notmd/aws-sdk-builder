...
impl RetireGrantInput {
    ...
    pub fn builder() -> super::operation::retire_grant::builders::RetireGrantInputBuilder {
        super::operation::retire_grant::builders::RetireGrantInputBuilder::default()
    }
}
...
impl RetireGrantInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::retire_grant::RetireGrantInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::retire_grant::RetireGrantInput {
