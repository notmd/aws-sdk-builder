    ...
    > {
        let map_err =
            |err: ::aws_smithy_runtime_api::client::result::SdkError<
                ...
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >| { err.map_service_error(|err| err.downcast::<super::operation::encrypt::EncryptError>().expect("correct error type")) };
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::encrypt::EncryptOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for EncryptResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_encrypt::de_encrypt_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_encrypt::de_encrypt_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for EncryptRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::encrypt::EncryptInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::encrypt::EncryptInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_encrypt::ser_encrypt_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::encrypt::EncryptError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::encrypt::_encrypt_input::EncryptInput;

pub use super::operation::encrypt::_encrypt_output::EncryptOutput;
