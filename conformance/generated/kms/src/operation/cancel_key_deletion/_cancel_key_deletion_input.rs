...
impl CancelKeyDeletionInput {
    ...
    pub fn builder() -> super::operation::cancel_key_deletion::builders::CancelKeyDeletionInputBuilder {
        super::operation::cancel_key_deletion::builders::CancelKeyDeletionInputBuilder::default()
    }
}
...
impl CancelKeyDeletionInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::cancel_key_deletion::CancelKeyDeletionInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::cancel_key_deletion::CancelKeyDeletionInput { key_id: self.key_id })
    }
}
