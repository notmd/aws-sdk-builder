...
impl CancelKeyDeletionInputBuilder {
    ...
    pub fn build(self) -> crate::operation::cancel_key_deletion::CancelKeyDeletionInput {
        crate::operation::cancel_key_deletion::CancelKeyDeletionInput { key_id: self.key_id }
    }
}
