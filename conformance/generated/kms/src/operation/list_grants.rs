...
impl ListGrants {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::operation::list_grants::ListGrantsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::list_grants::ListGrantsError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_grants::ListGrantsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_grants::ListGrantsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListGrantsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_grants::de_list_grants_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_grants::de_list_grants_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListGrantsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::list_grants::ListGrantsInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_grants::ListGrantsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_list_grants::ser_list_grants_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::list_grants::ListGrantsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_grants::_list_grants_input::ListGrantsInput;

pub use super::operation::list_grants::_list_grants_output::ListGrantsOutput;
