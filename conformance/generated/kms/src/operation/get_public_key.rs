...
impl GetPublicKey {
    ...
    pub(crate) async fn orchestrate(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::get_public_key::GetPublicKeyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_public_key::GetPublicKeyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_public_key::GetPublicKeyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetPublicKeyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_public_key::de_get_public_key_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_public_key::de_get_public_key_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetPublicKeyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_public_key::GetPublicKeyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_public_key::GetPublicKeyInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_get_public_key::ser_get_public_key_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::get_public_key::GetPublicKeyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_public_key::_get_public_key_input::GetPublicKeyInput;

pub use super::operation::get_public_key::_get_public_key_output::GetPublicKeyOutput;
