...
impl CreateGrantInput {
    ...
    pub fn builder() -> super::operation::create_grant::builders::CreateGrantInputBuilder {
        super::operation::create_grant::builders::CreateGrantInputBuilder::default()
    }
}
...
impl CreateGrantInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::create_grant::CreateGrantInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::create_grant::CreateGrantInput {
            key_id: self.key_id,
