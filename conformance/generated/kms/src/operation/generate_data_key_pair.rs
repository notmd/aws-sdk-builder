    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::generate_data_key_pair::GenerateDataKeyPairError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::generate_data_key_pair::GenerateDataKeyPairOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GenerateDataKeyPairResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_generate_data_key_pair::de_generate_data_key_pair_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_generate_data_key_pair::de_generate_data_key_pair_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GenerateDataKeyPairRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::generate_data_key_pair::GenerateDataKeyPairInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::generate_data_key_pair::GenerateDataKeyPairInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_generate_data_key_pair::ser_generate_data_key_pair_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::operation::generate_data_key_pair::GenerateDataKeyPairError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::generate_data_key_pair::_generate_data_key_pair_input::GenerateDataKeyPairInput;

pub use super::operation::generate_data_key_pair::_generate_data_key_pair_output::GenerateDataKeyPairOutput;
