...
impl Builder {
    ...
    pub async fn send(self) -> ::std::result::Result<super::ListKeyRotationsOutput, super::ListKeyRotationsError> {
        ...
        let response = self
            ...
            .await
            .map_err(super::ListKeyRotationsError::Unhandled)?;
        let status = response.status();
        if !status.is_success() {
            return Err(super::ListKeyRotationsError::unhandled_with_request_ids(
                format!("ListKeyRotations returned HTTP {}", status),
