...
pub use super::operation::list_key_rotations::_list_key_rotations_input::ListKeyRotationsInputBuilder;

pub use super::operation::list_key_rotations::_list_key_rotations_output::ListKeyRotationsOutputBuilder;

impl super::operation::list_key_rotations::builders::ListKeyRotationsInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::list_key_rotations::ListKeyRotationsError,
...
pub struct ListKeyRotationsFluentBuilder {
    ...
    inner: super::operation::list_key_rotations::builders::ListKeyRotationsInputBuilder,
...
impl ListKeyRotationsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::list_key_rotations::builders::ListKeyRotationsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::list_key_rotations::ListKeyRotations::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::list_key_rotations::ListKeyRotations::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::operation::list_key_rotations::paginator::ListKeyRotationsPaginator {
        super::operation::list_key_rotations::paginator::ListKeyRotationsPaginator::new(self.handle, self.inner)
    }
    ...
    pub fn include_key_material(mut self, input: super::types::IncludeKeyMaterial) -> Self {
        self.inner = self.inner.include_key_material(input);
        self
    }
    /// <p>Use this optional parameter to control which key materials associated with this key are listed in the response. The default value of this parameter is <code>ROTATIONS_ONLY</code>. If you omit this parameter, KMS returns information on the key materials created by automatic or on-demand key rotation. When you specify a value of <code>ALL_KEY_MATERIAL</code>, KMS adds the first key material and any imported key material pending rotation to the response. This parameter can only be used with KMS keys that support automatic or on-demand key rotation.</p>
    pub fn set_include_key_material(mut self, input: ::std::option::Option<super::types::IncludeKeyMaterial>) -> Self {
        self.inner = self.inner.set_include_key_material(input);
        self
    }
    /// <p>Use this optional parameter to control which key materials associated with this key are listed in the response. The default value of this parameter is <code>ROTATIONS_ONLY</code>. If you omit this parameter, KMS returns information on the key materials created by automatic or on-demand key rotation. When you specify a value of <code>ALL_KEY_MATERIAL</code>, KMS adds the first key material and any imported key material pending rotation to the response. This parameter can only be used with KMS keys that support automatic or on-demand key rotation.</p>
    pub fn get_include_key_material(&self) -> &::std::option::Option<super::types::IncludeKeyMaterial> {
