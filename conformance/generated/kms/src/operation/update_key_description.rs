// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        impl UpdateKeyDescription { pub fn new() -> Self { Self } }
        #[derive(Clone, Debug, Default)]
        pub struct Input {
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output;
        pub type UpdateKeyDescriptionInput = Input;
        pub type UpdateKeyDescriptionOutput = Output;
        pub type UpdateKeyDescriptionError = Error;
        #[derive(Clone, Debug)]
        pub enum Error {
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::UpdateKeyDescriptionOutput, super::UpdateKeyDescriptionError> {
                         let path = "/";
                         let body = ::std::vec::Vec::new();
                         let headers = ::std::vec::Vec::new();
                         let response = self.client.request(super::super::super::transport::Method::Post, &path, &headers, &body).await.map_err(super::UpdateKeyDescriptionError::Unhandled)?;
...
pub use builders::Builder;
        pub type UpdateKeyDescriptionFluentBuilder = builders::Builder;
