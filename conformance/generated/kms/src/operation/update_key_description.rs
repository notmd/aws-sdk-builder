    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::update_key_description::UpdateKeyDescriptionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::update_key_description::UpdateKeyDescriptionOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateKeyDescriptionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_update_key_description::de_update_key_description_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_update_key_description::de_update_key_description_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateKeyDescriptionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::update_key_description::UpdateKeyDescriptionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::update_key_description::UpdateKeyDescriptionInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_update_key_description::ser_update_key_description_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::operation::update_key_description::UpdateKeyDescriptionError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::update_key_description::_update_key_description_input::UpdateKeyDescriptionInput;

pub use super::operation::update_key_description::_update_key_description_output::UpdateKeyDescriptionOutput;
