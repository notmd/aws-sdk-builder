...
pub mod _update_key_description_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/kms/src/operation/update_key_description/_update_key_description_input.rs"
    ));
}
...
pub mod _update_key_description_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/kms/src/operation/update_key_description/_update_key_description_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/kms/src/operation/update_key_description/builders.rs"
    ));
}
