...
impl RevokeGrant {
    ...
    pub(crate) async fn orchestrate(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::revoke_grant::RevokeGrantError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::revoke_grant::RevokeGrantError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::revoke_grant::RevokeGrantOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RevokeGrantResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_revoke_grant::de_revoke_grant_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_revoke_grant::de_revoke_grant_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RevokeGrantRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::revoke_grant::RevokeGrantInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::revoke_grant::RevokeGrantInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_revoke_grant::ser_revoke_grant_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::revoke_grant::RevokeGrantError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::revoke_grant::_revoke_grant_input::RevokeGrantInput;

pub use super::operation::revoke_grant::_revoke_grant_output::RevokeGrantOutput;
