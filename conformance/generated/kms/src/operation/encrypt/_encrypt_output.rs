...
impl EncryptOutput {
    ...
    pub fn builder() -> super::operation::encrypt::builders::EncryptOutputBuilder {
        super::operation::encrypt::builders::EncryptOutputBuilder::default()
    }
}
...
impl EncryptOutputBuilder {
    ...
    pub fn build(self) -> super::operation::encrypt::EncryptOutput {
