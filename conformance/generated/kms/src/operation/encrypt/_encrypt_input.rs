...
impl EncryptInput {
    ...
    pub fn builder() -> super::operation::encrypt::builders::EncryptInputBuilder {
        super::operation::encrypt::builders::EncryptInputBuilder::default()
    }
}
...
impl EncryptInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::encrypt::EncryptInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::encrypt::EncryptInput {
            key_id: self.key_id,
