...
pub use super::operation::encrypt::_encrypt_input::EncryptInputBuilder;

pub use super::operation::encrypt::_encrypt_output::EncryptOutputBuilder;

impl super::operation::encrypt::builders::EncryptInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::Client,
    ) -> ::std::result::Result<
        super::operation::encrypt::EncryptOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::encrypt::EncryptError,
...
pub struct EncryptFluentBuilder {
    ...
    inner: super::operation::encrypt::builders::EncryptInputBuilder,
    config_override: ::std::option::Option<super::config::Builder>,
}
impl super::client::customize::internal::CustomizableSend<super::operation::encrypt::EncryptOutput, super::operation::encrypt::EncryptError>
    for EncryptFluentBuilder
{
    fn send(
        ...
        super::client::customize::internal::SendResult<super::operation::encrypt::EncryptOutput, super::operation::encrypt::EncryptError>,
    > {
...
impl EncryptFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::encrypt::builders::EncryptInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::encrypt::Encrypt::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::encrypt::Encrypt::orchestrate(&runtime_plugins, input).await
    }

    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
    pub fn customize(
        self,
    ) -> super::client::customize::CustomizableOperation<super::operation::encrypt::EncryptOutput, super::operation::encrypt::EncryptError, Self>
    {
