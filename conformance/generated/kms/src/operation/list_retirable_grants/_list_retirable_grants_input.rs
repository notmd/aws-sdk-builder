...
impl ListRetirableGrantsInput {
    ...
    pub fn builder() -> super::operation::list_retirable_grants::builders::ListRetirableGrantsInputBuilder {
        super::operation::list_retirable_grants::builders::ListRetirableGrantsInputBuilder::default()
    }
}
...
impl ListRetirableGrantsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_retirable_grants::ListRetirableGrantsInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::list_retirable_grants::ListRetirableGrantsInput {
            limit: self.limit,
            marker: self.marker,
