...
impl ListRetirableGrantsOutput {
    ...
    pub fn builder() -> super::operation::list_retirable_grants::builders::ListRetirableGrantsOutputBuilder {
        super::operation::list_retirable_grants::builders::ListRetirableGrantsOutputBuilder::default()
    }
}
...
impl ListRetirableGrantsOutputBuilder {
    ...
    pub fn build(self) -> super::operation::list_retirable_grants::ListRetirableGrantsOutput {
