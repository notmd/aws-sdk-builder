    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::re_encrypt::ReEncryptError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::re_encrypt::ReEncryptOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ReEncryptResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_re_encrypt::de_re_encrypt_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_re_encrypt::de_re_encrypt_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ReEncryptRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::re_encrypt::ReEncryptInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::re_encrypt::ReEncryptInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_re_encrypt::ser_re_encrypt_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::re_encrypt::ReEncryptError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::re_encrypt::_re_encrypt_input::ReEncryptInput;

pub use super::operation::re_encrypt::_re_encrypt_output::ReEncryptOutput;
