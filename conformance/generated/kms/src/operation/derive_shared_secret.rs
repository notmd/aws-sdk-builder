...
pub mod _derive_shared_secret_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/kms/src/operation/derive_shared_secret/_derive_shared_secret_input.rs"
    ));
}
...
pub mod _derive_shared_secret_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/kms/src/operation/derive_shared_secret/_derive_shared_secret_output.rs"
    ));
}
