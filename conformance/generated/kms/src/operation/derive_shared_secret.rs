    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::derive_shared_secret::DeriveSharedSecretError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::derive_shared_secret::DeriveSharedSecretOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeriveSharedSecretResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_derive_shared_secret::de_derive_shared_secret_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_derive_shared_secret::de_derive_shared_secret_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeriveSharedSecretRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::derive_shared_secret::DeriveSharedSecretInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::derive_shared_secret::DeriveSharedSecretInput,
        ...
        let body =
            ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_derive_shared_secret::ser_derive_shared_secret_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::derive_shared_secret::DeriveSharedSecretError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::derive_shared_secret::_derive_shared_secret_input::DeriveSharedSecretInput;

pub use super::operation::derive_shared_secret::_derive_shared_secret_output::DeriveSharedSecretOutput;
