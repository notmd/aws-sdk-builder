...
pub mod _derive_shared_secret_input {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/derive_shared_secret/_derive_shared_secret_input.rs"));
}
pub use _derive_shared_secret_input::DeriveSharedSecretInput;
pub type Input = DeriveSharedSecretInput;
pub mod _derive_shared_secret_output {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/derive_shared_secret/_derive_shared_secret_output.rs"));
}
pub use _derive_shared_secret_output::DeriveSharedSecretOutput;
pub type Output = DeriveSharedSecretOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/derive_shared_secret/builders.rs"));
}
