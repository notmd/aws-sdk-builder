...
impl DescribeKey {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::operation::describe_key::DescribeKeyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::describe_key::DescribeKeyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::describe_key::DescribeKeyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::describe_key::DescribeKeyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeKeyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_describe_key::de_describe_key_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_describe_key::de_describe_key_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeKeyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::describe_key::DescribeKeyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::describe_key::DescribeKeyInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_describe_key::ser_describe_key_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::describe_key::DescribeKeyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::describe_key::_describe_key_input::DescribeKeyInput;

pub use super::operation::describe_key::_describe_key_output::DescribeKeyOutput;
