...
impl ReplicateKey {
    ...
    pub(crate) async fn orchestrate(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::replicate_key::ReplicateKeyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::replicate_key::ReplicateKeyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::replicate_key::ReplicateKeyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ReplicateKeyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_replicate_key::de_replicate_key_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_replicate_key::de_replicate_key_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ReplicateKeyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::replicate_key::ReplicateKeyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::replicate_key::ReplicateKeyInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_replicate_key::ser_replicate_key_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::replicate_key::ReplicateKeyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::replicate_key::_replicate_key_input::ReplicateKeyInput;

pub use super::operation::replicate_key::_replicate_key_output::ReplicateKeyOutput;
