    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::connect_custom_key_store::ConnectCustomKeyStoreError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::connect_custom_key_store::ConnectCustomKeyStoreOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ConnectCustomKeyStoreResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_connect_custom_key_store::de_connect_custom_key_store_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_connect_custom_key_store::de_connect_custom_key_store_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ConnectCustomKeyStoreRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::connect_custom_key_store::ConnectCustomKeyStoreInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::connect_custom_key_store::ConnectCustomKeyStoreInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_connect_custom_key_store::ser_connect_custom_key_store_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::connect_custom_key_store::ConnectCustomKeyStoreError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::connect_custom_key_store::_connect_custom_key_store_input::ConnectCustomKeyStoreInput;

pub use super::operation::connect_custom_key_store::_connect_custom_key_store_output::ConnectCustomKeyStoreOutput;
