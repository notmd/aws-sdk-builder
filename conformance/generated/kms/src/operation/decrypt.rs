    ...
    > {
        let map_err =
            |err: ::aws_smithy_runtime_api::client::result::SdkError<
                ...
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >| { err.map_service_error(|err| err.downcast::<super::operation::decrypt::DecryptError>().expect("correct error type")) };
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::decrypt::DecryptOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DecryptResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_decrypt::de_decrypt_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_decrypt::de_decrypt_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DecryptRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::decrypt::DecryptInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::decrypt::DecryptInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_decrypt::ser_decrypt_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::decrypt::DecryptError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::decrypt::_decrypt_input::DecryptInput;

pub use super::operation::decrypt::_decrypt_output::DecryptOutput;
