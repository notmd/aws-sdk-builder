...
impl VerifyOutput {
    ...
    pub fn builder() -> super::operation::verify::builders::VerifyOutputBuilder {
        super::operation::verify::builders::VerifyOutputBuilder::default()
    }
}
...
impl VerifyOutputBuilder {
    ...
    pub fn build(self) -> super::operation::verify::VerifyOutput {
