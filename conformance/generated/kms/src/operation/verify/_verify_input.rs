...
impl VerifyInput {
    ...
    pub fn builder() -> super::operation::verify::builders::VerifyInputBuilder {
        super::operation::verify::builders::VerifyInputBuilder::default()
    }
}
...
impl VerifyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::verify::VerifyInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::verify::VerifyInput {
            key_id: self.key_id,
