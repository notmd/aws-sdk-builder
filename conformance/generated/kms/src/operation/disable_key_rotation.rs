...
pub mod _disable_key_rotation_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/kms/src/operation/disable_key_rotation/_disable_key_rotation_input.rs"
    ));
}
...
pub mod _disable_key_rotation_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/kms/src/operation/disable_key_rotation/_disable_key_rotation_output.rs"
    ));
}
