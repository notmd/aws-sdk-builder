...
pub mod _disable_key_rotation_input {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/disable_key_rotation/_disable_key_rotation_input.rs"));
}
pub use _disable_key_rotation_input::DisableKeyRotationInput;
pub type Input = DisableKeyRotationInput;
pub mod _disable_key_rotation_output {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/disable_key_rotation/_disable_key_rotation_output.rs"));
}
pub use _disable_key_rotation_output::DisableKeyRotationOutput;
pub type Output = DisableKeyRotationOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/disable_key_rotation/builders.rs"));
}
