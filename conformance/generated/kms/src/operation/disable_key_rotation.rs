    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::disable_key_rotation::DisableKeyRotationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::disable_key_rotation::DisableKeyRotationOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisableKeyRotationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_disable_key_rotation::de_disable_key_rotation_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_disable_key_rotation::de_disable_key_rotation_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisableKeyRotationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::disable_key_rotation::DisableKeyRotationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::disable_key_rotation::DisableKeyRotationInput,
        ...
        let body =
            ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_disable_key_rotation::ser_disable_key_rotation_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::disable_key_rotation::DisableKeyRotationError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::disable_key_rotation::_disable_key_rotation_input::DisableKeyRotationInput;

pub use super::operation::disable_key_rotation::_disable_key_rotation_output::DisableKeyRotationOutput;
