...
impl Builder {
    ...
    pub async fn send(self) -> ::std::result::Result<super::CreateCustomKeyStoreOutput, super::CreateCustomKeyStoreError> {
        ...
        let response = self
            ...
            .await
            .map_err(super::CreateCustomKeyStoreError::Unhandled)?;
        let status = response.status();
        if !status.is_success() {
            return Err(super::CreateCustomKeyStoreError::unhandled_with_request_ids(
                format!("CreateCustomKeyStore returned HTTP {}", status),
