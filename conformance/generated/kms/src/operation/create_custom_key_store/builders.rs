    ...
    pub fn build(self) -> super::Input { self.input }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::CreateCustomKeyStoreOutput, super::CreateCustomKeyStoreError> {
                         ...
                         if !status.is_success() {
                             return Err(super::CreateCustomKeyStoreError::unhandled_with_request_ids(format!("CreateCustomKeyStore returned HTTP {}", status), response.header("x-amzn-requestid").map(str::to_owned), ::std::option::Option::None));
                         }
                         let mut output = super::_create_custom_key_store_output::CreateCustomKeyStoreOutputBuilder::default();
