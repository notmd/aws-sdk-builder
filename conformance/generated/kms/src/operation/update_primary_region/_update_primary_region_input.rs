...
impl UpdatePrimaryRegionInput {
    ...
    pub fn builder() -> super::operation::update_primary_region::builders::UpdatePrimaryRegionInputBuilder {
        super::operation::update_primary_region::builders::UpdatePrimaryRegionInputBuilder::default()
    }
}
...
impl UpdatePrimaryRegionInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::update_primary_region::UpdatePrimaryRegionInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::update_primary_region::UpdatePrimaryRegionInput {
            key_id: self.key_id,
