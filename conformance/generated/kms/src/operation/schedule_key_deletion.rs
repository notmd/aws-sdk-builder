...
pub mod _schedule_key_deletion_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/kms/src/operation/schedule_key_deletion/_schedule_key_deletion_input.rs"
    ));
}
...
pub mod _schedule_key_deletion_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/kms/src/operation/schedule_key_deletion/_schedule_key_deletion_output.rs"
    ));
}
