    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::schedule_key_deletion::ScheduleKeyDeletionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::schedule_key_deletion::ScheduleKeyDeletionOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ScheduleKeyDeletionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_schedule_key_deletion::de_schedule_key_deletion_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_schedule_key_deletion::de_schedule_key_deletion_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ScheduleKeyDeletionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::schedule_key_deletion::ScheduleKeyDeletionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::schedule_key_deletion::ScheduleKeyDeletionInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_schedule_key_deletion::ser_schedule_key_deletion_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::operation::schedule_key_deletion::ScheduleKeyDeletionError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::schedule_key_deletion::_schedule_key_deletion_input::ScheduleKeyDeletionInput;

pub use super::operation::schedule_key_deletion::_schedule_key_deletion_output::ScheduleKeyDeletionOutput;
