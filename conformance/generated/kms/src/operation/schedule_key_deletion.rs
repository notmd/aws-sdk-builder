...
pub mod _schedule_key_deletion_input {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/schedule_key_deletion/_schedule_key_deletion_input.rs"));
}
pub use _schedule_key_deletion_input::ScheduleKeyDeletionInput;
pub type Input = ScheduleKeyDeletionInput;
pub mod _schedule_key_deletion_output {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/schedule_key_deletion/_schedule_key_deletion_output.rs"));
}
pub use _schedule_key_deletion_output::ScheduleKeyDeletionOutput;
pub type Output = ScheduleKeyDeletionOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/schedule_key_deletion/builders.rs"));
}
