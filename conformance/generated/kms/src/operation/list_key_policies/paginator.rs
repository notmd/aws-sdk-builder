...
pub struct ListKeyPoliciesPaginator {
    ...
    builder: super::operation::list_key_policies::builders::ListKeyPoliciesInputBuilder,
...
impl ListKeyPoliciesPaginator {
    ...
    pub fn items(self) -> super::operation::list_key_policies::paginator::ListKeyPoliciesPaginatorItems {
        super::operation::list_key_policies::paginator::ListKeyPoliciesPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::operation::list_key_policies::ListKeyPolicies::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_list_key_policies_output_output_next_marker(resp);
...
impl ListKeyPoliciesPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::lens::lens_list_key_policies_output_output_policy_names(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
