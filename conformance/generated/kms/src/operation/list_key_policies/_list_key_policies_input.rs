...
impl ListKeyPoliciesInput {
    ...
    pub fn builder() -> super::operation::list_key_policies::builders::ListKeyPoliciesInputBuilder {
        super::operation::list_key_policies::builders::ListKeyPoliciesInputBuilder::default()
    }
}
...
impl ListKeyPoliciesInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_key_policies::ListKeyPoliciesInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_key_policies::ListKeyPoliciesInput {
            key_id: self.key_id,
            limit: self.limit,
            marker: self.marker,
        })
