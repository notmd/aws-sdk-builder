...
impl ListKeyPoliciesOutput {
    ...
    pub fn builder() -> super::operation::list_key_policies::builders::ListKeyPoliciesOutputBuilder {
        super::operation::list_key_policies::builders::ListKeyPoliciesOutputBuilder::default()
    }
}
...
impl ListKeyPoliciesOutputBuilder {
    ...
    pub fn build(self) -> super::operation::list_key_policies::ListKeyPoliciesOutput {
