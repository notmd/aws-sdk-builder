    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::update_custom_key_store::UpdateCustomKeyStoreError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::update_custom_key_store::UpdateCustomKeyStoreOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateCustomKeyStoreResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_update_custom_key_store::de_update_custom_key_store_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_update_custom_key_store::de_update_custom_key_store_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateCustomKeyStoreRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::update_custom_key_store::UpdateCustomKeyStoreInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::update_custom_key_store::UpdateCustomKeyStoreInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_update_custom_key_store::ser_update_custom_key_store_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::operation::update_custom_key_store::UpdateCustomKeyStoreError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::update_custom_key_store::_update_custom_key_store_input::UpdateCustomKeyStoreInput;

pub use super::operation::update_custom_key_store::_update_custom_key_store_output::UpdateCustomKeyStoreOutput;
