...
impl TagResourceInput {
    ...
    pub fn builder() -> super::operation::tag_resource::builders::TagResourceInputBuilder {
        super::operation::tag_resource::builders::TagResourceInputBuilder::default()
    }
}
...
impl TagResourceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::tag_resource::TagResourceInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::tag_resource::TagResourceInput {
            key_id: self.key_id,
            tags: self.tags,
        })
    }
