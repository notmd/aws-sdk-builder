...
impl GenerateDataKeyPairWithoutPlaintextOutput {
    ...
    pub fn builder() -> super::operation::generate_data_key_pair_without_plaintext::builders::GenerateDataKeyPairWithoutPlaintextOutputBuilder {
...
impl GenerateDataKeyPairWithoutPlaintextOutputBuilder {
    ...
    pub fn build(self) -> super::operation::generate_data_key_pair_without_plaintext::GenerateDataKeyPairWithoutPlaintextOutput {
