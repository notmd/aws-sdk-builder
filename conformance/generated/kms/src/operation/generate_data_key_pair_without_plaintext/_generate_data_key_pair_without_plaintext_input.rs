...
impl GenerateDataKeyPairWithoutPlaintextInput {
    pub fn builder() -> GenerateDataKeyPairWithoutPlaintextInputBuilder { GenerateDataKeyPairWithoutPlaintextInputBuilder::default() }
}
#[derive(Clone, Debug, Default)]
...
impl GenerateDataKeyPairWithoutPlaintextInputBuilder {
    ...
    pub fn build(self) -> GenerateDataKeyPairWithoutPlaintextInput { GenerateDataKeyPairWithoutPlaintextInput {
