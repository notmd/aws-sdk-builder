// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output {
            pub aliases: ::std::option::Option<super::super::types::AliasList>,
        ...
        impl Output {
            pub fn aliases(&self) -> &[super::super::types::AliasListEntry] { self.aliases.as_deref().unwrap_or(&[]) }
        ...
        pub type ListAliasesInput = Input;
        pub type ListAliasesOutput = Output;
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::ListAliasesOutput, super::ListAliasesError> {
                         ...
                         let response = self.client.request(super::super::super::transport::Method::Post, &path, &headers, &body).await.map_err(super::ListAliasesError::Unhandled)?;
                         let status = response.status();
                         if !status.is_success() {
                             return Err(super::ListAliasesError::Unhandled(format!("ListAliases returned HTTP {}", status)));
                         }
                         Ok(super::ListAliasesOutput::default())
                     }
                 }
}
