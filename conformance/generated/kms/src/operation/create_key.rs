// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        impl Input {
            ...
            pub fn customer_master_key_spec(&self) -> ::std::option::Option<&super::super::types::CustomerMasterKeySpec> { self.customer_master_key_spec.as_ref() }
            pub fn description(&self) -> ::std::option::Option<&str> { self.description.as_deref() }
            pub fn key_spec(&self) -> ::std::option::Option<&super::super::types::KeySpec> { self.key_spec.as_ref() }
            pub fn key_usage(&self) -> ::std::option::Option<&super::super::types::KeyUsageType> { self.key_usage.as_ref() }
            pub fn multi_region(&self) -> ::std::option::Option<bool> { self.multi_region }
            pub fn origin(&self) -> ::std::option::Option<&super::super::types::OriginType> { self.origin.as_ref() }
        ...
        pub type CreateKeyInput = Input;
        pub type CreateKeyOutput = Output;
