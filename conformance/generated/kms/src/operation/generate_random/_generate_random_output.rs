...
impl GenerateRandomOutput {
    ...
    pub fn builder() -> super::operation::generate_random::builders::GenerateRandomOutputBuilder {
        super::operation::generate_random::builders::GenerateRandomOutputBuilder::default()
    }
}
...
impl GenerateRandomOutputBuilder {
    ...
    pub fn build(self) -> super::operation::generate_random::GenerateRandomOutput {
