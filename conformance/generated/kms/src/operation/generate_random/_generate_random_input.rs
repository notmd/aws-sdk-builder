...
impl GenerateRandomInput {
    ...
    pub fn builder() -> super::operation::generate_random::builders::GenerateRandomInputBuilder {
        super::operation::generate_random::builders::GenerateRandomInputBuilder::default()
    }
}
...
impl GenerateRandomInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::generate_random::GenerateRandomInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::generate_random::GenerateRandomInput {
