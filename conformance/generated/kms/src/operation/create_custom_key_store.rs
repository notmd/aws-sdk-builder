    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::create_custom_key_store::CreateCustomKeyStoreError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::create_custom_key_store::CreateCustomKeyStoreOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateCustomKeyStoreResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_create_custom_key_store::de_create_custom_key_store_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_create_custom_key_store::de_create_custom_key_store_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateCustomKeyStoreRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::create_custom_key_store::CreateCustomKeyStoreInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::create_custom_key_store::CreateCustomKeyStoreInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_create_custom_key_store::ser_create_custom_key_store_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::operation::create_custom_key_store::CreateCustomKeyStoreError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::create_custom_key_store::_create_custom_key_store_input::CreateCustomKeyStoreInput;

pub use super::operation::create_custom_key_store::_create_custom_key_store_output::CreateCustomKeyStoreOutput;
