...
pub mod _rotate_key_on_demand_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/kms/src/operation/rotate_key_on_demand/_rotate_key_on_demand_input.rs"
    ));
}
...
pub mod _rotate_key_on_demand_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/kms/src/operation/rotate_key_on_demand/_rotate_key_on_demand_output.rs"
    ));
}
