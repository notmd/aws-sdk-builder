    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::cancel_key_deletion::CancelKeyDeletionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::cancel_key_deletion::CancelKeyDeletionOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CancelKeyDeletionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_cancel_key_deletion::de_cancel_key_deletion_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_cancel_key_deletion::de_cancel_key_deletion_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CancelKeyDeletionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::cancel_key_deletion::CancelKeyDeletionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::cancel_key_deletion::CancelKeyDeletionInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_cancel_key_deletion::ser_cancel_key_deletion_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::cancel_key_deletion::CancelKeyDeletionError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::cancel_key_deletion::_cancel_key_deletion_input::CancelKeyDeletionInput;

pub use super::operation::cancel_key_deletion::_cancel_key_deletion_output::CancelKeyDeletionOutput;
