// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        pub type CancelKeyDeletionInput = Input;
        pub type CancelKeyDeletionOutput = Output;
        pub type CancelKeyDeletionError = Error;
        #[derive(Clone, Debug)]
        pub enum Error {
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::CancelKeyDeletionOutput, super::CancelKeyDeletionError> {
                         let path = "/";
                         ...
                         Ok(super::CancelKeyDeletionOutput::default())
                     }
                 }
}
pub use builders::Builder;
        pub type CancelKeyDeletionFluentBuilder = builders::Builder;
