...
pub struct ListKeysOutput {
    ...
    pub keys: ::std::option::Option<::std::vec::Vec<super::types::KeyListEntry>>,
...
impl ListKeysOutput {
    ...
    pub fn keys(&self) -> &[super::types::KeyListEntry] {
...
impl ListKeysOutput {
    ...
    pub fn builder() -> super::operation::list_keys::builders::ListKeysOutputBuilder {
        super::operation::list_keys::builders::ListKeysOutputBuilder::default()
    }
}
...
pub struct ListKeysOutputBuilder {
    pub(crate) keys: ::std::option::Option<::std::vec::Vec<super::types::KeyListEntry>>,
...
impl ListKeysOutputBuilder {
    ...
    ///
    /// <p>A list of KMS keys.</p>
    pub fn keys(mut self, input: super::types::KeyListEntry) -> Self {
    ...
    /// <p>A list of KMS keys.</p>
    pub fn set_keys(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::KeyListEntry>>) -> Self {
        self.keys = input;
        self
    }
    /// <p>A list of KMS keys.</p>
    pub fn get_keys(&self) -> &::std::option::Option<::std::vec::Vec<super::types::KeyListEntry>> {
        &self.keys
    }
    /// <p>When <code>Truncated</code> is true, this element is present and contains the value to use for the <code>Marker</code> parameter in a subsequent request.</p>
    ...
    pub fn build(self) -> super::operation::list_keys::ListKeysOutput {
