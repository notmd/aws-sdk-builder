...
impl ListKeysInput {
    ...
    pub fn builder() -> super::operation::list_keys::builders::ListKeysInputBuilder {
        super::operation::list_keys::builders::ListKeysInputBuilder::default()
    }
}
...
impl ListKeysInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::list_keys::ListKeysInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_keys::ListKeysInput {
            limit: self.limit,
            marker: self.marker,
        })
    }
