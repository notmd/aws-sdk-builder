...
impl ScheduleKeyDeletionOutput {
    ...
    pub fn builder() -> super::operation::schedule_key_deletion::builders::ScheduleKeyDeletionOutputBuilder {
        super::operation::schedule_key_deletion::builders::ScheduleKeyDeletionOutputBuilder::default()
    }
}
...
impl ScheduleKeyDeletionOutputBuilder {
    ...
    pub fn build(self) -> super::operation::schedule_key_deletion::ScheduleKeyDeletionOutput {
