...
impl ScheduleKeyDeletionInput {
    ...
    pub fn builder() -> super::operation::schedule_key_deletion::builders::ScheduleKeyDeletionInputBuilder {
        super::operation::schedule_key_deletion::builders::ScheduleKeyDeletionInputBuilder::default()
    }
}
...
impl ScheduleKeyDeletionInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::schedule_key_deletion::ScheduleKeyDeletionInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::schedule_key_deletion::ScheduleKeyDeletionInput {
            key_id: self.key_id,
