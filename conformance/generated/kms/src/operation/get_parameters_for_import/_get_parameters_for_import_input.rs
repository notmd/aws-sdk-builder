...
pub struct GetParametersForImportInput {
    ...
    /// </ul>
    pub wrapping_algorithm: ::std::option::Option<super::types::AlgorithmSpec>,
    ...
    pub wrapping_key_spec: ::std::option::Option<super::types::WrappingKeySpec>,
}
impl GetParametersForImportInput {
    ...
    /// <p><b>RSAES_PKCS1_V1_5</b> (Deprecated) — As of October 10, 2023, KMS does not support the RSAES_PKCS1_V1_5 wrapping algorithm.</p></li>
    /// </ul>
    pub fn wrapping_algorithm(&self) -> ::std::option::Option<&super::types::AlgorithmSpec> {
        self.wrapping_algorithm.as_ref()
    }
    /// <p>The type of RSA public key to return in the response. You will use this wrapping key with the specified wrapping algorithm to protect your key material during import.</p>
    /// <p>Use the longest RSA wrapping key that is practical.</p>
    /// <p>You cannot use an RSA_2048 public key to directly wrap an ECC_NIST_P521 private key. Instead, use an RSA_AES wrapping algorithm or choose a longer RSA public key.</p>
    pub fn wrapping_key_spec(&self) -> ::std::option::Option<&super::types::WrappingKeySpec> {
...
impl GetParametersForImportInput {
    ...
    pub fn builder() -> super::operation::get_parameters_for_import::builders::GetParametersForImportInputBuilder {
        super::operation::get_parameters_for_import::builders::GetParametersForImportInputBuilder::default()
    }
}
...
pub struct GetParametersForImportInputBuilder {
    ...
    pub(crate) wrapping_algorithm: ::std::option::Option<super::types::AlgorithmSpec>,
    pub(crate) wrapping_key_spec: ::std::option::Option<super::types::WrappingKeySpec>,
}
impl GetParametersForImportInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::get_parameters_for_import::GetParametersForImportInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::get_parameters_for_import::GetParametersForImportInput {
            key_id: self.key_id,
