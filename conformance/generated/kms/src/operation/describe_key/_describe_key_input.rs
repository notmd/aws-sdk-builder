...
impl DescribeKeyInput {
    ...
    pub fn builder() -> super::operation::describe_key::builders::DescribeKeyInputBuilder {
        super::operation::describe_key::builders::DescribeKeyInputBuilder::default()
    }
}
...
impl DescribeKeyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::describe_key::DescribeKeyInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::describe_key::DescribeKeyInput {
            key_id: self.key_id,
