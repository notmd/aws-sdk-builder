...
impl GetKeyRotationStatusInputBuilder {
    ...
    pub fn build(self) -> crate::operation::get_key_rotation_status::GetKeyRotationStatusInput {
        crate::operation::get_key_rotation_status::GetKeyRotationStatusInput { key_id: self.key_id }
    }
}
