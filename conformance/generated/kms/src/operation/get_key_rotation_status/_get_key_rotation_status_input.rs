...
impl GetKeyRotationStatusInput {
    pub fn builder() -> GetKeyRotationStatusInputBuilder { GetKeyRotationStatusInputBuilder::default() }
}
#[derive(Clone, Debug, Default)]
...
impl GetKeyRotationStatusInputBuilder {
    ...
    pub fn build(self) -> GetKeyRotationStatusInput { GetKeyRotationStatusInput {
        key_id: self.key_id,
    } }
}
