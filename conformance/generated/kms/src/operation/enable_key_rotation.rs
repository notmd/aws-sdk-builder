// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        impl EnableKeyRotation { pub fn new() -> Self { Self } }
        #[derive(Clone, Debug, Default)]
        pub struct Input {
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output;
        pub type EnableKeyRotationInput = Input;
        pub type EnableKeyRotationOutput = Output;
        pub type EnableKeyRotationError = Error;
        #[derive(Clone, Debug)]
        pub enum Error {
...
pub use builders::Builder;
        pub type EnableKeyRotationFluentBuilder = builders::Builder;
