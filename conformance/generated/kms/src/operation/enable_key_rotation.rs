...
pub mod _enable_key_rotation_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/kms/src/operation/enable_key_rotation/_enable_key_rotation_input.rs"
    ));
}
...
pub mod _enable_key_rotation_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/kms/src/operation/enable_key_rotation/_enable_key_rotation_output.rs"
    ));
}
