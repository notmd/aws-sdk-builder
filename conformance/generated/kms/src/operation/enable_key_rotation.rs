...
pub mod _enable_key_rotation_input {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/enable_key_rotation/_enable_key_rotation_input.rs"));
}
pub use _enable_key_rotation_input::EnableKeyRotationInput;
pub type Input = EnableKeyRotationInput;
pub mod _enable_key_rotation_output {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/enable_key_rotation/_enable_key_rotation_output.rs"));
}
pub use _enable_key_rotation_output::EnableKeyRotationOutput;
pub type Output = EnableKeyRotationOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/enable_key_rotation/builders.rs"));
}
