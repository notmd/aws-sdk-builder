...
pub use super::operation::enable_key::_enable_key_input::EnableKeyInputBuilder;

pub use super::operation::enable_key::_enable_key_output::EnableKeyOutputBuilder;

impl super::operation::enable_key::builders::EnableKeyInputBuilder {
...
///
/// <p>Sets the key state of a KMS key to enabled. This allows you to use the KMS key for <a href="https://docs.aws.amazon.com/kms/latest/developerguide/kms-cryptography.html#cryptographic-operations">cryptographic operations</a>.</p>
...
pub struct EnableKeyFluentBuilder {
    ...
    inner: super::operation::enable_key::builders::EnableKeyInputBuilder,
    config_override: ::std::option::Option<super::config::Builder>,
}
impl super::client::customize::internal::CustomizableSend<super::operation::enable_key::EnableKeyOutput, super::operation::enable_key::EnableKeyError>
    for EnableKeyFluentBuilder
{
    fn send(
        ...
        super::client::customize::internal::SendResult<super::operation::enable_key::EnableKeyOutput, super::operation::enable_key::EnableKeyError>,
    > {
...
impl EnableKeyFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::enable_key::builders::EnableKeyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::enable_key::EnableKey::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::enable_key::EnableKey::orchestrate(&runtime_plugins, input).await
    }
