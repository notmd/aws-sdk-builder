...
pub mod _create_grant_input {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/create_grant/_create_grant_input.rs"));
}
pub use _create_grant_input::CreateGrantInput;
pub type Input = CreateGrantInput;
pub mod _create_grant_output {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/create_grant/_create_grant_output.rs"));
}
pub use _create_grant_output::CreateGrantOutput;
pub type Output = CreateGrantOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/create_grant/builders.rs"));
}
