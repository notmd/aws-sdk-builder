    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::create_grant::CreateGrantError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::create_grant::CreateGrantOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateGrantResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_create_grant::de_create_grant_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_create_grant::de_create_grant_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateGrantRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::create_grant::CreateGrantInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::create_grant::CreateGrantInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_create_grant::ser_create_grant_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::create_grant::CreateGrantError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::create_grant::_create_grant_input::CreateGrantInput;

pub use super::operation::create_grant::_create_grant_output::CreateGrantOutput;
