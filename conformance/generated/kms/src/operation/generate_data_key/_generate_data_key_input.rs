...
impl GenerateDataKeyInput {
    ...
    pub fn builder() -> super::operation::generate_data_key::builders::GenerateDataKeyInputBuilder {
        super::operation::generate_data_key::builders::GenerateDataKeyInputBuilder::default()
    }
}
...
impl GenerateDataKeyInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::generate_data_key::GenerateDataKeyInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::generate_data_key::GenerateDataKeyInput {
            key_id: self.key_id,
