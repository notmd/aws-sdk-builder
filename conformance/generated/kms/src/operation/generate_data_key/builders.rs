    ...
    pub fn build(self) -> super::Input { self.input }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::GenerateDataKeyOutput, super::GenerateDataKeyError> {
                         ...
                         if !status.is_success() {
                             return Err(super::GenerateDataKeyError::unhandled_with_request_ids(format!("GenerateDataKey returned HTTP {}", status), response.header("x-amzn-requestid").map(str::to_owned), ::std::option::Option::None));
                         }
