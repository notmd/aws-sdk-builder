...
impl DisconnectCustomKeyStoreInput {
    ...
    pub fn builder() -> super::operation::disconnect_custom_key_store::builders::DisconnectCustomKeyStoreInputBuilder {
        super::operation::disconnect_custom_key_store::builders::DisconnectCustomKeyStoreInputBuilder::default()
    }
}
...
impl DisconnectCustomKeyStoreInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::disconnect_custom_key_store::DisconnectCustomKeyStoreInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::disconnect_custom_key_store::DisconnectCustomKeyStoreInput {
