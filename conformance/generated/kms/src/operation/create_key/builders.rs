...
pub use super::operation::create_key::_create_key_input::CreateKeyInputBuilder;

pub use super::operation::create_key::_create_key_output::CreateKeyOutputBuilder;

impl super::operation::create_key::builders::CreateKeyInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::create_key::CreateKeyError,
...
/// </dt>
/// <dd>
/// <p>A <a href="https://docs.aws.amazon.com/kms/latest/developerguide/key-store-overview.html">custom key store</a> lets you protect your Amazon Web Services resources using keys in a backing key store that you own and manage. When you request a cryptographic operation with a KMS key in a custom key store, the operation is performed in the backing key store using its cryptographic keys.</p>
...
/// <p>To create a KMS key in an <a href="https://docs.aws.amazon.com/kms/latest/developerguide/create-xks-keys.html">external key store</a>, use the <code>Origin</code> parameter with a value of <code>EXTERNAL_KEY_STORE</code> and an <code>XksKeyId</code> parameter that identifies an existing external key.</p><note>
/// <p>Some external key managers provide a simpler method for creating a KMS key in an external key store. For details, see your external key manager documentation.</p>
/// </note>
/// </dd>
/// </dl>
...
pub struct CreateKeyFluentBuilder {
    ...
    inner: super::operation::create_key::builders::CreateKeyInputBuilder,
    config_override: ::std::option::Option<super::config::Builder>,
}
impl super::client::customize::internal::CustomizableSend<super::operation::create_key::CreateKeyOutput, super::operation::create_key::CreateKeyError>
    for CreateKeyFluentBuilder
{
    fn send(
        ...
        super::client::customize::internal::SendResult<super::operation::create_key::CreateKeyOutput, super::operation::create_key::CreateKeyError>,
    > {
...
impl CreateKeyFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::create_key::builders::CreateKeyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::create_key::CreateKey::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::create_key::CreateKey::orchestrate(&runtime_plugins, input).await
    }
