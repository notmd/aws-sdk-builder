...
impl CreateKeyInput {
    ...
    pub fn builder() -> super::operation::create_key::builders::CreateKeyInputBuilder {
        super::operation::create_key::builders::CreateKeyInputBuilder::default()
    }
}
...
impl CreateKeyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::create_key::CreateKeyInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::create_key::CreateKeyInput {
            policy: self.policy,
