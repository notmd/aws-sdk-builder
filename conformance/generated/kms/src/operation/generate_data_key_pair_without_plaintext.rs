...
pub mod _generate_data_key_pair_without_plaintext_input {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/generate_data_key_pair_without_plaintext/_generate_data_key_pair_without_plaintext_input.rs"));
}
pub use _generate_data_key_pair_without_plaintext_input::GenerateDataKeyPairWithoutPlaintextInput;
pub type Input = GenerateDataKeyPairWithoutPlaintextInput;
pub mod _generate_data_key_pair_without_plaintext_output {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/generate_data_key_pair_without_plaintext/_generate_data_key_pair_without_plaintext_output.rs"));
}
pub use _generate_data_key_pair_without_plaintext_output::GenerateDataKeyPairWithoutPlaintextOutput;
pub type Output = GenerateDataKeyPairWithoutPlaintextOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/generate_data_key_pair_without_plaintext/builders.rs"));
}
