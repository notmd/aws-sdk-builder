...
impl ListResourceTags {
    ...
    pub(crate) async fn orchestrate(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::list_resource_tags::ListResourceTagsError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_resource_tags::ListResourceTagsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_resource_tags::ListResourceTagsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListResourceTagsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_resource_tags::de_list_resource_tags_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_resource_tags::de_list_resource_tags_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListResourceTagsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_resource_tags::ListResourceTagsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_resource_tags::ListResourceTagsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_list_resource_tags::ser_list_resource_tags_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::list_resource_tags::ListResourceTagsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_resource_tags::_list_resource_tags_input::ListResourceTagsInput;

pub use super::operation::list_resource_tags::_list_resource_tags_output::ListResourceTagsOutput;
