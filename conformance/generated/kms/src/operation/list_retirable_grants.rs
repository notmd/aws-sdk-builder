...
pub mod _list_retirable_grants_input {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/list_retirable_grants/_list_retirable_grants_input.rs"));
}
...
pub mod _list_retirable_grants_output {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/list_retirable_grants/_list_retirable_grants_output.rs"));
}
