...
impl ImportKeyMaterial {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::operation::import_key_material::ImportKeyMaterialOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::import_key_material::ImportKeyMaterialError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::import_key_material::ImportKeyMaterialError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::import_key_material::ImportKeyMaterialOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ImportKeyMaterialResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_import_key_material::de_import_key_material_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_import_key_material::de_import_key_material_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ImportKeyMaterialRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::import_key_material::ImportKeyMaterialInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::import_key_material::ImportKeyMaterialInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_import_key_material::ser_import_key_material_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::import_key_material::ImportKeyMaterialError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::import_key_material::_import_key_material_input::ImportKeyMaterialInput;

pub use super::operation::import_key_material::_import_key_material_output::ImportKeyMaterialOutput;
