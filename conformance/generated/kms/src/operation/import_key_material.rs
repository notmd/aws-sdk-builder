...
pub mod _import_key_material_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/kms/src/operation/import_key_material/_import_key_material_input.rs"
    ));
}
...
pub mod _import_key_material_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/kms/src/operation/import_key_material/_import_key_material_output.rs"
    ));
}
