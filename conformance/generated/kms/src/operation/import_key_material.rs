...
pub enum Error {
    ...
    ExpiredImportTokenException(super::super::types::error::ExpiredImportTokenException),
    IncorrectKeyMaterialException(super::super::types::error::IncorrectKeyMaterialException),
    ...
    InvalidImportTokenException(super::super::types::error::InvalidImportTokenException),
...
impl ::std::fmt::Display for Error {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match self {
            ...
            Self::ExpiredImportTokenException(value) => value.fmt(f),
            Self::IncorrectKeyMaterialException(value) => value.fmt(f),
            Self::InvalidArnException(value) => value.fmt(f),
            Self::InvalidCiphertextException(value) => value.fmt(f),
            Self::InvalidImportTokenException(value) => value.fmt(f),
...
pub mod _import_key_material_input {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/import_key_material/_import_key_material_input.rs"));
}
pub use _import_key_material_input::ImportKeyMaterialInput;
pub type Input = ImportKeyMaterialInput;
pub mod _import_key_material_output {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/import_key_material/_import_key_material_output.rs"));
}
pub use _import_key_material_output::ImportKeyMaterialOutput;
pub type Output = ImportKeyMaterialOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/import_key_material/builders.rs"));
}
