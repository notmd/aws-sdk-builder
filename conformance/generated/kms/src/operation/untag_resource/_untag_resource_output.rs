...
impl UntagResourceOutput {
    ...
    pub fn builder() -> super::operation::untag_resource::builders::UntagResourceOutputBuilder {
        super::operation::untag_resource::builders::UntagResourceOutputBuilder::default()
    }
}
...
impl UntagResourceOutputBuilder {
    ...
    pub fn build(self) -> super::operation::untag_resource::UntagResourceOutput {
