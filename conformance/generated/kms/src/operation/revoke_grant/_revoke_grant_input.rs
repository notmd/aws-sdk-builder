...
impl RevokeGrantInput {
    ...
    pub fn builder() -> super::operation::revoke_grant::builders::RevokeGrantInputBuilder {
        super::operation::revoke_grant::builders::RevokeGrantInputBuilder::default()
    }
}
...
impl RevokeGrantInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::revoke_grant::RevokeGrantInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::revoke_grant::RevokeGrantInput {
            key_id: self.key_id,
