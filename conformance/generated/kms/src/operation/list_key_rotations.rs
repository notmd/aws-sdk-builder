    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_key_rotations::ListKeyRotationsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_key_rotations::ListKeyRotationsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListKeyRotationsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_key_rotations::de_list_key_rotations_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_key_rotations::de_list_key_rotations_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListKeyRotationsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_key_rotations::ListKeyRotationsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_key_rotations::ListKeyRotationsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_list_key_rotations::ser_list_key_rotations_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::list_key_rotations::ListKeyRotationsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_key_rotations::_list_key_rotations_input::ListKeyRotationsInput;

pub use super::operation::list_key_rotations::_list_key_rotations_output::ListKeyRotationsOutput;
