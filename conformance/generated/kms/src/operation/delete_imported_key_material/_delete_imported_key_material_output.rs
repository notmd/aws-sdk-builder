...
impl DeleteImportedKeyMaterialOutput {
    ...
    pub fn builder() -> super::operation::delete_imported_key_material::builders::DeleteImportedKeyMaterialOutputBuilder {
        super::operation::delete_imported_key_material::builders::DeleteImportedKeyMaterialOutputBuilder::default()
    }
}
...
impl DeleteImportedKeyMaterialOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_imported_key_material::DeleteImportedKeyMaterialOutput {
