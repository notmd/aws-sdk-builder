    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_imported_key_material::DeleteImportedKeyMaterialError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_imported_key_material::DeleteImportedKeyMaterialOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteImportedKeyMaterialResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_imported_key_material::de_delete_imported_key_material_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_imported_key_material::de_delete_imported_key_material_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteImportedKeyMaterialRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_imported_key_material::DeleteImportedKeyMaterialInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_imported_key_material::DeleteImportedKeyMaterialInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_delete_imported_key_material::ser_delete_imported_key_material_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::delete_imported_key_material::DeleteImportedKeyMaterialError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_imported_key_material::_delete_imported_key_material_input::DeleteImportedKeyMaterialInput;

pub use super::operation::delete_imported_key_material::_delete_imported_key_material_output::DeleteImportedKeyMaterialOutput;
