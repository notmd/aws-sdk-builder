// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        impl DeleteImportedKeyMaterial { pub fn new() -> Self { Self } }
        #[derive(Clone, Debug, Default)]
        pub struct Input {
        ...
        pub struct Output {
            pub key_id: ::std::option::Option<super::super::types::KeyIdType>,
            pub key_material_id: ::std::option::Option<super::super::types::BackingKeyIdResponseType>,
        }
        impl Output {
            pub fn key_id(&self) -> ::std::option::Option<&str> { self.key_id.as_deref() }
            pub fn key_material_id(&self) -> ::std::option::Option<&str> { self.key_material_id.as_deref() }
        }
        pub type DeleteImportedKeyMaterialInput = Input;
        pub type DeleteImportedKeyMaterialOutput = Output;
        pub type DeleteImportedKeyMaterialError = Error;
        #[derive(Clone, Debug)]
        pub enum Error {
...
pub use builders::Builder;
        pub type DeleteImportedKeyMaterialFluentBuilder = builders::Builder;
