...
pub mod _get_key_rotation_status_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/kms/src/operation/get_key_rotation_status/_get_key_rotation_status_input.rs"
    ));
}
...
pub mod _get_key_rotation_status_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/kms/src/operation/get_key_rotation_status/_get_key_rotation_status_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/kms/src/operation/get_key_rotation_status/builders.rs"
    ));
}
