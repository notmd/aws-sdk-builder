...
impl RotateKeyOnDemandInputBuilder {
    ...
    pub fn build(self) -> crate::operation::rotate_key_on_demand::RotateKeyOnDemandInput {
        crate::operation::rotate_key_on_demand::RotateKeyOnDemandInput { key_id: self.key_id }
    }
}
