...
pub mod _list_keys_input {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/list_keys/_list_keys_input.rs"));
}
pub use _list_keys_input::ListKeysInput;
pub type Input = ListKeysInput;
pub mod _list_keys_output {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/list_keys/_list_keys_output.rs"));
}
pub use _list_keys_output::ListKeysOutput;
pub type Output = ListKeysOutput;
