...
pub mod _generate_data_key_input {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/generate_data_key/_generate_data_key_input.rs"));
}
pub use _generate_data_key_input::GenerateDataKeyInput;
pub type Input = GenerateDataKeyInput;
pub mod _generate_data_key_output {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/generate_data_key/_generate_data_key_output.rs"));
}
pub use _generate_data_key_output::GenerateDataKeyOutput;
pub type Output = GenerateDataKeyOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/generate_data_key/builders.rs"));
}
