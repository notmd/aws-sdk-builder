...
impl GenerateDataKey {
    ...
    pub(crate) async fn orchestrate(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::generate_data_key::GenerateDataKeyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::generate_data_key::GenerateDataKeyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::generate_data_key::GenerateDataKeyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GenerateDataKeyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_generate_data_key::de_generate_data_key_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_generate_data_key::de_generate_data_key_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GenerateDataKeyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::generate_data_key::GenerateDataKeyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::generate_data_key::GenerateDataKeyInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_generate_data_key::ser_generate_data_key_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::generate_data_key::GenerateDataKeyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::generate_data_key::_generate_data_key_input::GenerateDataKeyInput;

pub use super::operation::generate_data_key::_generate_data_key_output::GenerateDataKeyOutput;
