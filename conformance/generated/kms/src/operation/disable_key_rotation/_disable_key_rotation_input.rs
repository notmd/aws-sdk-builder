...
impl DisableKeyRotationInput {
    ...
    pub fn builder() -> super::operation::disable_key_rotation::builders::DisableKeyRotationInputBuilder {
        super::operation::disable_key_rotation::builders::DisableKeyRotationInputBuilder::default()
    }
}
...
impl DisableKeyRotationInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::disable_key_rotation::DisableKeyRotationInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::disable_key_rotation::DisableKeyRotationInput { key_id: self.key_id })
    }
}
