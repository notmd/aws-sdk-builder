...
impl DisableKeyRotationInputBuilder {
    ...
    pub fn build(self) -> crate::operation::disable_key_rotation::DisableKeyRotationInput {
        crate::operation::disable_key_rotation::DisableKeyRotationInput { key_id: self.key_id }
    }
}
