...
impl DisableKeyRotationOutput {
    ...
    pub fn builder() -> super::operation::disable_key_rotation::builders::DisableKeyRotationOutputBuilder {
        super::operation::disable_key_rotation::builders::DisableKeyRotationOutputBuilder::default()
    }
}
...
impl DisableKeyRotationOutputBuilder {
    ...
    pub fn build(self) -> super::operation::disable_key_rotation::DisableKeyRotationOutput {
