...
impl SignOutput {
    ...
    pub fn builder() -> super::operation::sign::builders::SignOutputBuilder {
        super::operation::sign::builders::SignOutputBuilder::default()
    }
}
...
impl SignOutputBuilder {
    ...
    pub fn build(self) -> super::operation::sign::SignOutput {
