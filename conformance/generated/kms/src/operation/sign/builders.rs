...
pub use super::operation::sign::_sign_input::SignInputBuilder;

pub use super::operation::sign::_sign_output::SignOutputBuilder;

impl super::operation::sign::builders::SignInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::Client,
    ) -> ::std::result::Result<
        super::operation::sign::SignOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::sign::SignError,
...
pub struct SignFluentBuilder {
    ...
    inner: super::operation::sign::builders::SignInputBuilder,
    config_override: ::std::option::Option<super::config::Builder>,
}
impl super::client::customize::internal::CustomizableSend<super::operation::sign::SignOutput, super::operation::sign::SignError>
    for SignFluentBuilder
{
    fn send(
        ...
        super::client::customize::internal::SendResult<super::operation::sign::SignOutput, super::operation::sign::SignError>,
    > {
...
impl SignFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::sign::builders::SignInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            super::operation::sign::Sign::operation_runtime_plugins(self.handle.runtime_plugins.clone(), &self.handle.conf, self.config_override);
        super::operation::sign::Sign::orchestrate(&runtime_plugins, input).await
    }

    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
    pub fn customize(
        self,
    ) -> super::client::customize::CustomizableOperation<super::operation::sign::SignOutput, super::operation::sign::SignError, Self> {
