...
impl ListResourceTagsInput {
    ...
    pub fn builder() -> super::operation::list_resource_tags::builders::ListResourceTagsInputBuilder {
        super::operation::list_resource_tags::builders::ListResourceTagsInputBuilder::default()
    }
}
...
impl ListResourceTagsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_resource_tags::ListResourceTagsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_resource_tags::ListResourceTagsInput {
            key_id: self.key_id,
            limit: self.limit,
            marker: self.marker,
        })
