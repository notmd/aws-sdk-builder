...
impl ::std::fmt::Display for Error {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match self {
            ...
            Self::KmsInvalidSignatureException(value) => value.fmt(f),
...
pub mod _verify_input {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/verify/_verify_input.rs"));
}
pub use _verify_input::VerifyInput;
pub type Input = VerifyInput;
pub mod _verify_output {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/verify/_verify_output.rs"));
}
pub use _verify_output::VerifyOutput;
pub type Output = VerifyOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/verify/builders.rs"));
}
