...
pub mod _generate_mac_input {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/generate_mac/_generate_mac_input.rs"));
}
pub use _generate_mac_input::GenerateMacInput;
pub type Input = GenerateMacInput;
pub mod _generate_mac_output {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/generate_mac/_generate_mac_output.rs"));
}
pub use _generate_mac_output::GenerateMacOutput;
pub type Output = GenerateMacOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/generate_mac/builders.rs"));
}
