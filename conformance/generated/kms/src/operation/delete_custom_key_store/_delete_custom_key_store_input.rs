...
impl DeleteCustomKeyStoreInput {
    ...
    pub fn builder() -> super::operation::delete_custom_key_store::builders::DeleteCustomKeyStoreInputBuilder {
        super::operation::delete_custom_key_store::builders::DeleteCustomKeyStoreInputBuilder::default()
    }
}
...
impl DeleteCustomKeyStoreInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::delete_custom_key_store::DeleteCustomKeyStoreInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::delete_custom_key_store::DeleteCustomKeyStoreInput {
