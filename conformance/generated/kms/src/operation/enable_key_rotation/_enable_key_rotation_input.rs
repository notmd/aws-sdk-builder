...
impl EnableKeyRotationInput {
    ...
    pub fn builder() -> super::operation::enable_key_rotation::builders::EnableKeyRotationInputBuilder {
        super::operation::enable_key_rotation::builders::EnableKeyRotationInputBuilder::default()
    }
}
...
impl EnableKeyRotationInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::enable_key_rotation::EnableKeyRotationInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::enable_key_rotation::EnableKeyRotationInput {
            key_id: self.key_id,
