...
impl GetKeyPolicyInput {
    ...
    pub fn builder() -> super::operation::get_key_policy::builders::GetKeyPolicyInputBuilder {
        super::operation::get_key_policy::builders::GetKeyPolicyInputBuilder::default()
    }
}
...
impl GetKeyPolicyInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_key_policy::GetKeyPolicyInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_key_policy::GetKeyPolicyInput {
            key_id: self.key_id,
