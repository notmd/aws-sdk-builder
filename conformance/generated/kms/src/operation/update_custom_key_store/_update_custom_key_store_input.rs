...
impl UpdateCustomKeyStoreInput {
    ...
    pub fn builder() -> super::operation::update_custom_key_store::builders::UpdateCustomKeyStoreInputBuilder {
        super::operation::update_custom_key_store::builders::UpdateCustomKeyStoreInputBuilder::default()
    }
}
...
impl UpdateCustomKeyStoreInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::update_custom_key_store::UpdateCustomKeyStoreInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::update_custom_key_store::UpdateCustomKeyStoreInput {
