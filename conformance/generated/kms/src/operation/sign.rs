...
pub mod _sign_input {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/sign/_sign_input.rs"));
}
pub use _sign_input::SignInput;
pub type Input = SignInput;
pub mod _sign_output {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/sign/_sign_output.rs"));
}
pub use _sign_output::SignOutput;
pub type Output = SignOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/kms/src/operation/sign/builders.rs"));
}
