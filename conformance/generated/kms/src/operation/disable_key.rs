...
impl DisableKey {
    ...
    pub(crate) async fn orchestrate(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::disable_key::DisableKeyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::disable_key::DisableKeyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::disable_key::DisableKeyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisableKeyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_disable_key::de_disable_key_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_disable_key::de_disable_key_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisableKeyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::disable_key::DisableKeyInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::disable_key::DisableKeyInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_disable_key::ser_disable_key_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::disable_key::DisableKeyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::disable_key::_disable_key_input::DisableKeyInput;

pub use super::operation::disable_key::_disable_key_output::DisableKeyOutput;
