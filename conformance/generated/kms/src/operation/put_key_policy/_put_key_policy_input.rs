...
impl PutKeyPolicyInput {
    ...
    pub fn builder() -> super::operation::put_key_policy::builders::PutKeyPolicyInputBuilder {
        super::operation::put_key_policy::builders::PutKeyPolicyInputBuilder::default()
    }
}
...
impl PutKeyPolicyInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::put_key_policy::PutKeyPolicyInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::put_key_policy::PutKeyPolicyInput {
            key_id: self.key_id,
