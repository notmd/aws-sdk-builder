...
pub fn de_create_alias_http_error(
    ...
    Err(match error_code {
        "AlreadyExistsException" => super::operation::create_alias::CreateAliasError::AlreadyExistsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "DependencyTimeoutException" => super::operation::create_alias::CreateAliasError::DependencyTimeoutException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidAliasNameException" => super::operation::create_alias::CreateAliasError::InvalidAliasNameException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                let mut output = super::types::error::builders::InvalidAliasNameExceptionBuilder::default();
                output = super::protocol_serde::shape_invalid_alias_name_exception::de_invalid_alias_name_exception_json_err(_response_body, output)
                    .map_err(super::operation::create_alias::CreateAliasError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
        ...
        "KMSInternalException" => super::operation::create_alias::CreateAliasError::KmsInternalException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInvalidStateException" => super::operation::create_alias::CreateAliasError::KmsInvalidStateException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "LimitExceededException" => super::operation::create_alias::CreateAliasError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::operation::create_alias::CreateAliasError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
