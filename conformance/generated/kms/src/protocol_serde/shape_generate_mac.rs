...
pub fn de_generate_mac_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::generate_mac::GenerateMacOutput, super::operation::generate_mac::GenerateMacError> {
    #[allow(unused_mut)]
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::generate_mac::GenerateMacError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::generate_mac::GenerateMacError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "DisabledException" => super::operation::generate_mac::GenerateMacError::DisabledException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "DryRunOperationException" => super::operation::generate_mac::GenerateMacError::DryRunOperationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidGrantTokenException" => super::operation::generate_mac::GenerateMacError::InvalidGrantTokenException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidKeyUsageException" => super::operation::generate_mac::GenerateMacError::InvalidKeyUsageException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KeyUnavailableException" => super::operation::generate_mac::GenerateMacError::KeyUnavailableException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInternalException" => super::operation::generate_mac::GenerateMacError::KmsInternalException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInvalidStateException" => super::operation::generate_mac::GenerateMacError::KmsInvalidStateException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::operation::generate_mac::GenerateMacError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::generate_mac::GenerateMacError::generic(generic),
    })
}
...
pub fn de_generate_mac_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::generate_mac::builders::GenerateMacOutputBuilder::default();
        output = super::protocol_serde::shape_generate_mac::de_generate_mac(_response_body, output)
            .map_err(super::operation::generate_mac::GenerateMacError::unhandled)?;
...
pub fn ser_generate_mac_input(
    input: &super::operation::generate_mac::GenerateMacInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    super::protocol_serde::shape_generate_mac_input::ser_generate_mac_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_generate_mac(
    _value: &[u8],
    mut builder: super::operation::generate_mac::builders::GenerateMacOutputBuilder,
) -> ::std::result::Result<super::operation::generate_mac::builders::GenerateMacOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
