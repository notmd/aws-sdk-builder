...
pub fn de_verify_mac_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::verify_mac::VerifyMacOutput, super::operation::verify_mac::VerifyMacError> {
    #[allow(unused_mut)]
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::verify_mac::VerifyMacError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::verify_mac::VerifyMacError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "DisabledException" => super::operation::verify_mac::VerifyMacError::DisabledException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "DryRunOperationException" => super::operation::verify_mac::VerifyMacError::DryRunOperationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidGrantTokenException" => super::operation::verify_mac::VerifyMacError::InvalidGrantTokenException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidKeyUsageException" => super::operation::verify_mac::VerifyMacError::InvalidKeyUsageException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KeyUnavailableException" => super::operation::verify_mac::VerifyMacError::KeyUnavailableException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInternalException" => super::operation::verify_mac::VerifyMacError::KmsInternalException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInvalidMacException" => super::operation::verify_mac::VerifyMacError::KmsInvalidMacException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                let mut output = super::types::error::builders::KmsInvalidMacExceptionBuilder::default();
                output = super::protocol_serde::shape_kms_invalid_mac_exception::de_kms_invalid_mac_exception_json_err(_response_body, output)
                    .map_err(super::operation::verify_mac::VerifyMacError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
        ...
        "KMSInvalidStateException" => super::operation::verify_mac::VerifyMacError::KmsInvalidStateException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::operation::verify_mac::VerifyMacError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::verify_mac::VerifyMacError::generic(generic),
    })
}
...
pub fn de_verify_mac_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::verify_mac::builders::VerifyMacOutputBuilder::default();
        output = super::protocol_serde::shape_verify_mac::de_verify_mac(_response_body, output)
            .map_err(super::operation::verify_mac::VerifyMacError::unhandled)?;
...
pub fn ser_verify_mac_input(
    input: &super::operation::verify_mac::VerifyMacInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    super::protocol_serde::shape_verify_mac_input::ser_verify_mac_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_verify_mac(
    _value: &[u8],
    mut builder: super::operation::verify_mac::builders::VerifyMacOutputBuilder,
) -> ::std::result::Result<super::operation::verify_mac::builders::VerifyMacOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "MacAlgorithm" => {
                    builder = builder.set_mac_algorithm(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| super::types::MacAlgorithmSpec::from(u.as_ref())))
                            .transpose()?,
                    );
                }
