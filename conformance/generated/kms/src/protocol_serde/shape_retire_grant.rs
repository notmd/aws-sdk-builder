...
pub fn de_retire_grant_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::retire_grant::RetireGrantOutput, super::operation::retire_grant::RetireGrantError> {
    #[allow(unused_mut)]
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::retire_grant::RetireGrantError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::retire_grant::RetireGrantError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "DependencyTimeoutException" => super::operation::retire_grant::RetireGrantError::DependencyTimeoutException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "DryRunOperationException" => super::operation::retire_grant::RetireGrantError::DryRunOperationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidArnException" => super::operation::retire_grant::RetireGrantError::InvalidArnException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidGrantIdException" => super::operation::retire_grant::RetireGrantError::InvalidGrantIdException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidGrantTokenException" => super::operation::retire_grant::RetireGrantError::InvalidGrantTokenException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInternalException" => super::operation::retire_grant::RetireGrantError::KmsInternalException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInvalidStateException" => super::operation::retire_grant::RetireGrantError::KmsInvalidStateException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::operation::retire_grant::RetireGrantError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::retire_grant::RetireGrantError::generic(generic),
    })
}
...
pub fn de_retire_grant_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::retire_grant::builders::RetireGrantOutputBuilder::default();
...
pub fn ser_retire_grant_input(
    input: &super::operation::retire_grant::RetireGrantInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    super::protocol_serde::shape_retire_grant_input::ser_retire_grant_input_input(&mut object, input)?;
    object.finish();
