...
pub fn de_enable_key_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::enable_key::EnableKeyOutput, super::operation::enable_key::EnableKeyError> {
    #[allow(unused_mut)]
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::enable_key::EnableKeyError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::enable_key::EnableKeyError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "DependencyTimeoutException" => super::operation::enable_key::EnableKeyError::DependencyTimeoutException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidArnException" => super::operation::enable_key::EnableKeyError::InvalidArnException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInternalException" => super::operation::enable_key::EnableKeyError::KmsInternalException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInvalidStateException" => super::operation::enable_key::EnableKeyError::KmsInvalidStateException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "LimitExceededException" => super::operation::enable_key::EnableKeyError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::operation::enable_key::EnableKeyError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::enable_key::EnableKeyError::generic(generic),
    })
}
...
pub fn de_enable_key_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::enable_key::builders::EnableKeyOutputBuilder::default();
...
pub fn ser_enable_key_input(
    ...
    super::protocol_serde::shape_enable_key_input::ser_enable_key_input_input(&mut object, input)?;
    object.finish();
