...
pub fn de_decrypt_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::decrypt::DecryptOutput, super::operation::decrypt::DecryptError> {
    #[allow(unused_mut)]
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::decrypt::DecryptError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::decrypt::DecryptError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "DependencyTimeoutException" => super::operation::decrypt::DecryptError::DependencyTimeoutException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "DisabledException" => super::operation::decrypt::DecryptError::DisabledException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "DryRunOperationException" => super::operation::decrypt::DecryptError::DryRunOperationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "IncorrectKeyException" => super::operation::decrypt::DecryptError::IncorrectKeyException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidCiphertextException" => super::operation::decrypt::DecryptError::InvalidCiphertextException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidGrantTokenException" => super::operation::decrypt::DecryptError::InvalidGrantTokenException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidKeyUsageException" => super::operation::decrypt::DecryptError::InvalidKeyUsageException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KeyUnavailableException" => super::operation::decrypt::DecryptError::KeyUnavailableException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInternalException" => super::operation::decrypt::DecryptError::KmsInternalException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInvalidStateException" => super::operation::decrypt::DecryptError::KmsInvalidStateException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::operation::decrypt::DecryptError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::decrypt::DecryptError::generic(generic),
    })
}
...
pub fn de_decrypt_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::decrypt::builders::DecryptOutputBuilder::default();
        output =
            super::protocol_serde::shape_decrypt::de_decrypt(_response_body, output).map_err(super::operation::decrypt::DecryptError::unhandled)?;
...
pub fn ser_decrypt_input(
    input: &super::operation::decrypt::DecryptInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    super::protocol_serde::shape_decrypt_input::ser_decrypt_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_decrypt(
    _value: &[u8],
    mut builder: super::operation::decrypt::builders::DecryptOutputBuilder,
) -> ::std::result::Result<super::operation::decrypt::builders::DecryptOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
