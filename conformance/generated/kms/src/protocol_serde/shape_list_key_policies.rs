...
pub fn de_list_key_policies_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::list_key_policies::ListKeyPoliciesOutput, super::operation::list_key_policies::ListKeyPoliciesError> {
    #[allow(unused_mut)]
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::list_key_policies::ListKeyPoliciesError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::list_key_policies::ListKeyPoliciesError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "DependencyTimeoutException" => super::operation::list_key_policies::ListKeyPoliciesError::DependencyTimeoutException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidArnException" => super::operation::list_key_policies::ListKeyPoliciesError::InvalidArnException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInternalException" => super::operation::list_key_policies::ListKeyPoliciesError::KmsInternalException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInvalidStateException" => super::operation::list_key_policies::ListKeyPoliciesError::KmsInvalidStateException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::operation::list_key_policies::ListKeyPoliciesError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::list_key_policies::ListKeyPoliciesError::generic(generic),
    })
}
...
pub fn de_list_key_policies_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::list_key_policies::builders::ListKeyPoliciesOutputBuilder::default();
        output = super::protocol_serde::shape_list_key_policies::de_list_key_policies(_response_body, output)
            .map_err(super::operation::list_key_policies::ListKeyPoliciesError::unhandled)?;
...
pub fn ser_list_key_policies_input(
    input: &super::operation::list_key_policies::ListKeyPoliciesInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    super::protocol_serde::shape_list_key_policies_input::ser_list_key_policies_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_list_key_policies(
    _value: &[u8],
    mut builder: super::operation::list_key_policies::builders::ListKeyPoliciesOutputBuilder,
) -> ::std::result::Result<
    super::operation::list_key_policies::builders::ListKeyPoliciesOutputBuilder,
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "PolicyNames" => {
                    builder = builder.set_policy_names(super::protocol_serde::shape_policy_name_list::de_policy_name_list(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
