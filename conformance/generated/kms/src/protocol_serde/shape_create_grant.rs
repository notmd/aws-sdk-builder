...
pub fn de_create_grant_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::create_grant::CreateGrantOutput, super::operation::create_grant::CreateGrantError> {
    #[allow(unused_mut)]
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::create_grant::CreateGrantError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::create_grant::CreateGrantError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "DependencyTimeoutException" => super::operation::create_grant::CreateGrantError::DependencyTimeoutException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "DisabledException" => super::operation::create_grant::CreateGrantError::DisabledException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "DryRunOperationException" => super::operation::create_grant::CreateGrantError::DryRunOperationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidArnException" => super::operation::create_grant::CreateGrantError::InvalidArnException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidGrantTokenException" => super::operation::create_grant::CreateGrantError::InvalidGrantTokenException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInternalException" => super::operation::create_grant::CreateGrantError::KmsInternalException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInvalidStateException" => super::operation::create_grant::CreateGrantError::KmsInvalidStateException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "LimitExceededException" => super::operation::create_grant::CreateGrantError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::operation::create_grant::CreateGrantError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::create_grant::CreateGrantError::generic(generic),
    })
}
...
pub fn de_create_grant_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::create_grant::builders::CreateGrantOutputBuilder::default();
        output = super::protocol_serde::shape_create_grant::de_create_grant(_response_body, output)
            .map_err(super::operation::create_grant::CreateGrantError::unhandled)?;
...
pub fn ser_create_grant_input(
    input: &super::operation::create_grant::CreateGrantInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    super::protocol_serde::shape_create_grant_input::ser_create_grant_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_create_grant(
    _value: &[u8],
    mut builder: super::operation::create_grant::builders::CreateGrantOutputBuilder,
) -> ::std::result::Result<super::operation::create_grant::builders::CreateGrantOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
