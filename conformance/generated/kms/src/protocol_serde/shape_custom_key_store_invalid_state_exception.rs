...
pub(crate) fn de_custom_key_store_invalid_state_exception_json_err(
    _value: &[u8],
    mut builder: super::types::error::builders::CustomKeyStoreInvalidStateExceptionBuilder,
) -> ::std::result::Result<
    super::types::error::builders::CustomKeyStoreInvalidStateExceptionBuilder,
