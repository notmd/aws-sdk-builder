...
pub fn de_schedule_key_deletion_http_error(
    ...
    super::operation::schedule_key_deletion::ScheduleKeyDeletionOutput,
    super::operation::schedule_key_deletion::ScheduleKeyDeletionError,
> {
    #[allow(unused_mut)]
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::schedule_key_deletion::ScheduleKeyDeletionError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::schedule_key_deletion::ScheduleKeyDeletionError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "DependencyTimeoutException" => super::operation::schedule_key_deletion::ScheduleKeyDeletionError::DependencyTimeoutException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidArnException" => super::operation::schedule_key_deletion::ScheduleKeyDeletionError::InvalidArnException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInternalException" => super::operation::schedule_key_deletion::ScheduleKeyDeletionError::KmsInternalException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInvalidStateException" => super::operation::schedule_key_deletion::ScheduleKeyDeletionError::KmsInvalidStateException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::operation::schedule_key_deletion::ScheduleKeyDeletionError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::schedule_key_deletion::ScheduleKeyDeletionError::generic(generic),
    })
}
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::schedule_key_deletion::builders::ScheduleKeyDeletionOutputBuilder::default();
        output = super::protocol_serde::shape_schedule_key_deletion::de_schedule_key_deletion(_response_body, output)
            .map_err(super::operation::schedule_key_deletion::ScheduleKeyDeletionError::unhandled)?;
...
pub fn ser_schedule_key_deletion_input(
    input: &super::operation::schedule_key_deletion::ScheduleKeyDeletionInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    super::protocol_serde::shape_schedule_key_deletion_input::ser_schedule_key_deletion_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_schedule_key_deletion(
    _value: &[u8],
    mut builder: super::operation::schedule_key_deletion::builders::ScheduleKeyDeletionOutputBuilder,
) -> ::std::result::Result<
    super::operation::schedule_key_deletion::builders::ScheduleKeyDeletionOutputBuilder,
