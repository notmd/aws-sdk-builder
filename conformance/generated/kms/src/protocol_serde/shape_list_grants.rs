...
pub fn de_list_grants_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::list_grants::ListGrantsOutput, super::operation::list_grants::ListGrantsError> {
    #[allow(unused_mut)]
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::list_grants::ListGrantsError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::list_grants::ListGrantsError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "DependencyTimeoutException" => super::operation::list_grants::ListGrantsError::DependencyTimeoutException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidArnException" => super::operation::list_grants::ListGrantsError::InvalidArnException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidGrantIdException" => super::operation::list_grants::ListGrantsError::InvalidGrantIdException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                let mut output = super::types::error::builders::InvalidGrantIdExceptionBuilder::default();
                output = super::protocol_serde::shape_invalid_grant_id_exception::de_invalid_grant_id_exception_json_err(_response_body, output)
                    .map_err(super::operation::list_grants::ListGrantsError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
        ...
        "InvalidMarkerException" => super::operation::list_grants::ListGrantsError::InvalidMarkerException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInternalException" => super::operation::list_grants::ListGrantsError::KmsInternalException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInvalidStateException" => super::operation::list_grants::ListGrantsError::KmsInvalidStateException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::operation::list_grants::ListGrantsError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::list_grants::ListGrantsError::generic(generic),
    })
}
...
pub fn de_list_grants_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::list_grants::builders::ListGrantsOutputBuilder::default();
        output = super::protocol_serde::shape_list_grants::de_list_grants(_response_body, output)
            .map_err(super::operation::list_grants::ListGrantsError::unhandled)?;
...
pub fn ser_list_grants_input(
    input: &super::operation::list_grants::ListGrantsInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    super::protocol_serde::shape_list_grants_input::ser_list_grants_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_list_grants(
    _value: &[u8],
    mut builder: super::operation::list_grants::builders::ListGrantsOutputBuilder,
) -> ::std::result::Result<super::operation::list_grants::builders::ListGrantsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
