...
pub(crate) fn de_xks_proxy_vpc_endpoint_service_invalid_configuration_exception_json_err(
    _value: &[u8],
    mut builder: super::types::error::builders::XksProxyVpcEndpointServiceInvalidConfigurationExceptionBuilder,
) -> ::std::result::Result<
    super::types::error::builders::XksProxyVpcEndpointServiceInvalidConfigurationExceptionBuilder,
