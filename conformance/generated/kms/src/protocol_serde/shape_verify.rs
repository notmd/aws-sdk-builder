...
pub fn de_verify_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::verify::VerifyOutput, super::operation::verify::VerifyError> {
    #[allow(unused_mut)]
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::verify::VerifyError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::verify::VerifyError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "DependencyTimeoutException" => super::operation::verify::VerifyError::DependencyTimeoutException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "DisabledException" => super::operation::verify::VerifyError::DisabledException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "DryRunOperationException" => super::operation::verify::VerifyError::DryRunOperationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidGrantTokenException" => super::operation::verify::VerifyError::InvalidGrantTokenException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidKeyUsageException" => super::operation::verify::VerifyError::InvalidKeyUsageException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KeyUnavailableException" => super::operation::verify::VerifyError::KeyUnavailableException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInternalException" => super::operation::verify::VerifyError::KmsInternalException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInvalidSignatureException" => super::operation::verify::VerifyError::KmsInvalidSignatureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                let mut output = super::types::error::builders::KmsInvalidSignatureExceptionBuilder::default();
                output =
                    super::protocol_serde::shape_kms_invalid_signature_exception::de_kms_invalid_signature_exception_json_err(_response_body, output)
                        .map_err(super::operation::verify::VerifyError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
        ...
        "KMSInvalidStateException" => super::operation::verify::VerifyError::KmsInvalidStateException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::operation::verify::VerifyError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::verify::VerifyError::generic(generic),
    })
}
...
pub fn de_verify_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::verify::builders::VerifyOutputBuilder::default();
        output = super::protocol_serde::shape_verify::de_verify(_response_body, output).map_err(super::operation::verify::VerifyError::unhandled)?;
...
pub fn ser_verify_input(
    input: &super::operation::verify::VerifyInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    super::protocol_serde::shape_verify_input::ser_verify_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_verify(
    _value: &[u8],
    mut builder: super::operation::verify::builders::VerifyOutputBuilder,
) -> ::std::result::Result<super::operation::verify::builders::VerifyOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "SigningAlgorithm" => {
                    builder = builder.set_signing_algorithm(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| super::types::SigningAlgorithmSpec::from(u.as_ref())))
                            .transpose()?,
                    );
                }
