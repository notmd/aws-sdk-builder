...
impl ::aws_types::request_id::RequestId for super::types::error::XksProxyVpcEndpointServiceInvalidConfigurationException {
...
impl XksProxyVpcEndpointServiceInvalidConfigurationException {
    ...
    pub fn builder() -> super::types::error::builders::XksProxyVpcEndpointServiceInvalidConfigurationExceptionBuilder {
        super::types::error::builders::XksProxyVpcEndpointServiceInvalidConfigurationExceptionBuilder::default()
    }
}
...
impl XksProxyVpcEndpointServiceInvalidConfigurationExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::XksProxyVpcEndpointServiceInvalidConfigurationException {
        super::types::error::XksProxyVpcEndpointServiceInvalidConfigurationException {
