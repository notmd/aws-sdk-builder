...
impl ::aws_types::request_id::RequestId for super::types::error::XksProxyIncorrectAuthenticationCredentialException {
...
impl XksProxyIncorrectAuthenticationCredentialException {
    ...
    pub fn builder() -> super::types::error::builders::XksProxyIncorrectAuthenticationCredentialExceptionBuilder {
        super::types::error::builders::XksProxyIncorrectAuthenticationCredentialExceptionBuilder::default()
    }
}
...
impl XksProxyIncorrectAuthenticationCredentialExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::XksProxyIncorrectAuthenticationCredentialException {
        super::types::error::XksProxyIncorrectAuthenticationCredentialException {
