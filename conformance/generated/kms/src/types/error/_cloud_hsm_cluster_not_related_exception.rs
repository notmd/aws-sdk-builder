...
impl ::aws_types::request_id::RequestId for super::types::error::CloudHsmClusterNotRelatedException {
...
impl CloudHsmClusterNotRelatedException {
    ...
    pub fn builder() -> super::types::error::builders::CloudHsmClusterNotRelatedExceptionBuilder {
        super::types::error::builders::CloudHsmClusterNotRelatedExceptionBuilder::default()
    }
}
...
impl CloudHsmClusterNotRelatedExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::CloudHsmClusterNotRelatedException {
        super::types::error::CloudHsmClusterNotRelatedException {
