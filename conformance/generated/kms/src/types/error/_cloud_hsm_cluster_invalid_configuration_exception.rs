...
impl ::aws_types::request_id::RequestId for super::types::error::CloudHsmClusterInvalidConfigurationException {
...
impl CloudHsmClusterInvalidConfigurationException {
    ...
    pub fn builder() -> super::types::error::builders::CloudHsmClusterInvalidConfigurationExceptionBuilder {
        super::types::error::builders::CloudHsmClusterInvalidConfigurationExceptionBuilder::default()
    }
}
...
impl CloudHsmClusterInvalidConfigurationExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::CloudHsmClusterInvalidConfigurationException {
        super::types::error::CloudHsmClusterInvalidConfigurationException {
