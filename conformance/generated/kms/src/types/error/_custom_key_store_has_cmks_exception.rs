...
impl ::aws_types::request_id::RequestId for super::types::error::CustomKeyStoreHasCmKsException {
...
impl CustomKeyStoreHasCmKsException {
    ...
    pub fn builder() -> super::types::error::builders::CustomKeyStoreHasCmKsExceptionBuilder {
        super::types::error::builders::CustomKeyStoreHasCmKsExceptionBuilder::default()
    }
}
...
impl CustomKeyStoreHasCmKsExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::CustomKeyStoreHasCmKsException {
        super::types::error::CustomKeyStoreHasCmKsException {
