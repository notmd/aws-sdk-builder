...
impl ::aws_types::request_id::RequestId for super::types::error::XksProxyVpcEndpointServiceNotFoundException {
...
impl XksProxyVpcEndpointServiceNotFoundException {
    ...
    pub fn builder() -> super::types::error::builders::XksProxyVpcEndpointServiceNotFoundExceptionBuilder {
        super::types::error::builders::XksProxyVpcEndpointServiceNotFoundExceptionBuilder::default()
    }
}
...
impl XksProxyVpcEndpointServiceNotFoundExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::XksProxyVpcEndpointServiceNotFoundException {
        super::types::error::XksProxyVpcEndpointServiceNotFoundException {
