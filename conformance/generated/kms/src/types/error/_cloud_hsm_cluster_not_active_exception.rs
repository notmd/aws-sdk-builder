...
impl ::aws_types::request_id::RequestId for super::types::error::CloudHsmClusterNotActiveException {
...
impl CloudHsmClusterNotActiveException {
    ...
    pub fn builder() -> super::types::error::builders::CloudHsmClusterNotActiveExceptionBuilder {
        super::types::error::builders::CloudHsmClusterNotActiveExceptionBuilder::default()
    }
}
...
impl CloudHsmClusterNotActiveExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::CloudHsmClusterNotActiveException {
        super::types::error::CloudHsmClusterNotActiveException {
