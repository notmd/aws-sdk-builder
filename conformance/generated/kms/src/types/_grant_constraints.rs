...
impl GrantConstraints {
    ...
    pub fn builder() -> super::types::builders::GrantConstraintsBuilder {
        super::types::builders::GrantConstraintsBuilder::default()
    }
}
...
impl GrantConstraintsBuilder {
    ...
    pub fn build(self) -> super::types::GrantConstraints {
        super::types::GrantConstraints {
