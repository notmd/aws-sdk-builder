...
pub struct MultiRegionConfiguration {
    ...
    pub multi_region_key_type: ::std::option::Option<super::types::MultiRegionKeyType>,
    /// <p>Displays the key ARN and Region of the primary key. This field includes the current KMS key if it is the primary key.</p>
    pub primary_key: ::std::option::Option<super::types::MultiRegionKey>,
    /// <p>displays the key ARNs and Regions of all replica keys. This field includes the current KMS key if it is a replica key.</p>
    pub replica_keys: ::std::option::Option<::std::vec::Vec<super::types::MultiRegionKey>>,
}
impl MultiRegionConfiguration {
    /// <p>Indicates whether the KMS key is a <code>PRIMARY</code> or <code>REPLICA</code> key.</p>
    pub fn multi_region_key_type(&self) -> ::std::option::Option<&super::types::MultiRegionKeyType> {
        self.multi_region_key_type.as_ref()
    }
    /// <p>Displays the key ARN and Region of the primary key. This field includes the current KMS key if it is the primary key.</p>
    pub fn primary_key(&self) -> ::std::option::Option<&super::types::MultiRegionKey> {
    ...
    pub fn replica_keys(&self) -> &[super::types::MultiRegionKey] {
...
impl MultiRegionConfiguration {
    ...
    pub fn builder() -> super::types::builders::MultiRegionConfigurationBuilder {
        super::types::builders::MultiRegionConfigurationBuilder::default()
    }
}
...
pub struct MultiRegionConfigurationBuilder {
    pub(crate) multi_region_key_type: ::std::option::Option<super::types::MultiRegionKeyType>,
    pub(crate) primary_key: ::std::option::Option<super::types::MultiRegionKey>,
    pub(crate) replica_keys: ::std::option::Option<::std::vec::Vec<super::types::MultiRegionKey>>,
}
impl MultiRegionConfigurationBuilder {
    /// <p>Indicates whether the KMS key is a <code>PRIMARY</code> or <code>REPLICA</code> key.</p>
    pub fn multi_region_key_type(mut self, input: super::types::MultiRegionKeyType) -> Self {
        self.multi_region_key_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>Indicates whether the KMS key is a <code>PRIMARY</code> or <code>REPLICA</code> key.</p>
    pub fn set_multi_region_key_type(mut self, input: ::std::option::Option<super::types::MultiRegionKeyType>) -> Self {
        self.multi_region_key_type = input;
        self
    }
    /// <p>Indicates whether the KMS key is a <code>PRIMARY</code> or <code>REPLICA</code> key.</p>
    pub fn get_multi_region_key_type(&self) -> &::std::option::Option<super::types::MultiRegionKeyType> {
        &self.multi_region_key_type
    }
    /// <p>Displays the key ARN and Region of the primary key. This field includes the current KMS key if it is the primary key.</p>
    pub fn primary_key(mut self, input: super::types::MultiRegionKey) -> Self {
        self.primary_key = ::std::option::Option::Some(input);
        self
    }
    /// <p>Displays the key ARN and Region of the primary key. This field includes the current KMS key if it is the primary key.</p>
    pub fn set_primary_key(mut self, input: ::std::option::Option<super::types::MultiRegionKey>) -> Self {
        self.primary_key = input;
        self
    }
    /// <p>Displays the key ARN and Region of the primary key. This field includes the current KMS key if it is the primary key.</p>
    pub fn get_primary_key(&self) -> &::std::option::Option<super::types::MultiRegionKey> {
        &self.primary_key
    }
    ...
    ///
    /// <p>displays the key ARNs and Regions of all replica keys. This field includes the current KMS key if it is a replica key.</p>
    pub fn replica_keys(mut self, input: super::types::MultiRegionKey) -> Self {
    ...
    /// <p>displays the key ARNs and Regions of all replica keys. This field includes the current KMS key if it is a replica key.</p>
    pub fn set_replica_keys(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::MultiRegionKey>>) -> Self {
        self.replica_keys = input;
        self
    }
    /// <p>displays the key ARNs and Regions of all replica keys. This field includes the current KMS key if it is a replica key.</p>
    pub fn get_replica_keys(&self) -> &::std::option::Option<::std::vec::Vec<super::types::MultiRegionKey>> {
        &self.replica_keys
    }
    /// Consumes the builder and constructs a [`MultiRegionConfiguration`](crate::types::MultiRegionConfiguration).
    pub fn build(self) -> super::types::MultiRegionConfiguration {
        super::types::MultiRegionConfiguration {
