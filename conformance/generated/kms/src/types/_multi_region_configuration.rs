...
/// <p>For more information about any listed KMS key, use the <a>DescribeKey</a> operation.</p>
#[non_exhaustive]
...
impl MultiRegionConfigurationBuilder {
    ...
    pub fn set_multi_region_key_type(mut self, input: ::std::option::Option<crate::types::MultiRegionKeyType>) -> Self { self.multi_region_key_type = input; self }
    /// <p>Indicates whether the KMS key is a <code>PRIMARY</code> or <code>REPLICA</code> key.</p>
    pub fn get_multi_region_key_type(&self) -> &::std::option::Option<crate::types::MultiRegionKeyType> { &self.multi_region_key_type }
    /// <p>Displays the key ARN and Region of the primary key. This field includes the current KMS key if it is the primary key.</p>
    pub fn primary_key(mut self, input: crate::types::MultiRegionKey) -> Self {
        self.primary_key = ::std::option::Option::Some(input);
        self
    }
    pub fn set_primary_key(mut self, input: ::std::option::Option<crate::types::MultiRegionKey>) -> Self { self.primary_key = input; self }
    /// <p>Displays the key ARN and Region of the primary key. This field includes the current KMS key if it is the primary key.</p>
    pub fn get_primary_key(&self) -> &::std::option::Option<crate::types::MultiRegionKey> { &self.primary_key }
    /// <p>displays the key ARNs and Regions of all replica keys. This field includes the current KMS key if it is a replica key.</p>
    ...
    pub fn set_replica_keys(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::MultiRegionKey>>) -> Self { self.replica_keys = input; self }
    /// <p>displays the key ARNs and Regions of all replica keys. This field includes the current KMS key if it is a replica key.</p>
    pub fn get_replica_keys(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::MultiRegionKey>> { &self.replica_keys }
