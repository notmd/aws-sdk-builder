...
impl XksKeyConfigurationType {
    ...
    pub fn builder() -> super::types::builders::XksKeyConfigurationTypeBuilder {
        super::types::builders::XksKeyConfigurationTypeBuilder::default()
    }
}
...
impl XksKeyConfigurationTypeBuilder {
    ...
    pub fn build(self) -> super::types::XksKeyConfigurationType {
        super::types::XksKeyConfigurationType { id: self.id }
    }
}
