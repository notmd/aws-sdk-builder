...
impl super::Client {
    ...
    pub fn update_primary_region(&self) -> super::operation::update_primary_region::builders::UpdatePrimaryRegionFluentBuilder {
        super::operation::update_primary_region::builders::UpdatePrimaryRegionFluentBuilder::new(self.handle.clone())
    }
}
