...
impl super::Client {
    ...
    pub fn get_key_last_usage(&self) -> super::operation::get_key_last_usage::builders::GetKeyLastUsageFluentBuilder {
        super::operation::get_key_last_usage::builders::GetKeyLastUsageFluentBuilder::new(self.handle.clone())
    }
}
