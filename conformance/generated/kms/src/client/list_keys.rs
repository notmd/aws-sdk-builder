...
impl super::Client {
    ...
    pub fn list_keys(&self) -> super::operation::list_keys::builders::ListKeysFluentBuilder {
        super::operation::list_keys::builders::ListKeysFluentBuilder::new(self.handle.clone())
    }
}
