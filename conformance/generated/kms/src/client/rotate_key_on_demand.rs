...
impl super::Client {
    ...
    pub fn rotate_key_on_demand(&self) -> super::operation::rotate_key_on_demand::builders::RotateKeyOnDemandFluentBuilder {
        super::operation::rotate_key_on_demand::builders::RotateKeyOnDemandFluentBuilder::new(self.handle.clone())
    }
}
