...
impl super::Client {
    ...
    pub fn revoke_grant(&self) -> super::operation::revoke_grant::builders::RevokeGrantFluentBuilder {
        super::operation::revoke_grant::builders::RevokeGrantFluentBuilder::new(self.handle.clone())
    }
}
