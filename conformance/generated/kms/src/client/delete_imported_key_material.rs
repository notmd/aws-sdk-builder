...
impl super::Client {
    ...
    pub fn delete_imported_key_material(&self) -> super::operation::delete_imported_key_material::builders::DeleteImportedKeyMaterialFluentBuilder {
        super::operation::delete_imported_key_material::builders::DeleteImportedKeyMaterialFluentBuilder::new(self.handle.clone())
    }
}
