...
impl super::Client {
    ...
    pub fn get_key_policy(&self) -> super::operation::get_key_policy::builders::GetKeyPolicyFluentBuilder {
        super::operation::get_key_policy::builders::GetKeyPolicyFluentBuilder::new(self.handle.clone())
    }
}
