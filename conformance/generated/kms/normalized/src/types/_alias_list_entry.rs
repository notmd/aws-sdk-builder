...
impl AliasListEntry {
    ...
    pub fn builder() -> super::super::types::builders::AliasListEntryBuilder {
        super::super::types::builders::AliasListEntryBuilder::default()
    }
}
...
impl AliasListEntryBuilder {
    ...
    pub fn build(self) -> super::super::types::AliasListEntry {
        super::super::types::AliasListEntry {
