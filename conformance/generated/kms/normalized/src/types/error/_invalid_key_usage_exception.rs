...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::InvalidKeyUsageException {
...
impl InvalidKeyUsageException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::InvalidKeyUsageExceptionBuilder {
        super::super::super::types::error::builders::InvalidKeyUsageExceptionBuilder::default()
    }
}
...
impl InvalidKeyUsageExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::InvalidKeyUsageException {
        super::super::super::types::error::InvalidKeyUsageException {
