...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::NotFoundException {
...
impl NotFoundException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::NotFoundExceptionBuilder {
        super::super::super::types::error::builders::NotFoundExceptionBuilder::default()
    }
}
...
impl NotFoundExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::NotFoundException {
        super::super::super::types::error::NotFoundException {
