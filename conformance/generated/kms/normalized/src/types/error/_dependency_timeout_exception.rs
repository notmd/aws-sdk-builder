...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::DependencyTimeoutException {
...
impl DependencyTimeoutException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::DependencyTimeoutExceptionBuilder {
        super::super::super::types::error::builders::DependencyTimeoutExceptionBuilder::default()
    }
}
...
impl DependencyTimeoutExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::DependencyTimeoutException {
        super::super::super::types::error::DependencyTimeoutException {
