...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::XksProxyUriUnreachableException {
...
impl XksProxyUriUnreachableException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::XksProxyUriUnreachableExceptionBuilder {
        super::super::super::types::error::builders::XksProxyUriUnreachableExceptionBuilder::default()
    }
}
...
impl XksProxyUriUnreachableExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::XksProxyUriUnreachableException {
        super::super::super::types::error::XksProxyUriUnreachableException {
