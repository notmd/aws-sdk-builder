...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::CustomKeyStoreNameInUseException {
...
impl CustomKeyStoreNameInUseException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::CustomKeyStoreNameInUseExceptionBuilder {
        super::super::super::types::error::builders::CustomKeyStoreNameInUseExceptionBuilder::default()
    }
}
...
impl CustomKeyStoreNameInUseExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::CustomKeyStoreNameInUseException {
        super::super::super::types::error::CustomKeyStoreNameInUseException {
