...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::IncorrectKeyException {
...
impl IncorrectKeyException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::IncorrectKeyExceptionBuilder {
        super::super::super::types::error::builders::IncorrectKeyExceptionBuilder::default()
    }
}
...
impl IncorrectKeyExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::IncorrectKeyException {
        super::super::super::types::error::IncorrectKeyException {
