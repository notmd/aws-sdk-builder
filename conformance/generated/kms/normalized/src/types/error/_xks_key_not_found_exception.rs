...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::XksKeyNotFoundException {
...
impl XksKeyNotFoundException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::XksKeyNotFoundExceptionBuilder {
        super::super::super::types::error::builders::XksKeyNotFoundExceptionBuilder::default()
    }
}
...
impl XksKeyNotFoundExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::XksKeyNotFoundException {
        super::super::super::types::error::XksKeyNotFoundException {
