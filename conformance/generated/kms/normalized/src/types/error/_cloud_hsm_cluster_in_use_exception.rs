...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::CloudHsmClusterInUseException {
...
impl CloudHsmClusterInUseException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::CloudHsmClusterInUseExceptionBuilder {
        super::super::super::types::error::builders::CloudHsmClusterInUseExceptionBuilder::default()
    }
}
...
impl CloudHsmClusterInUseExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::CloudHsmClusterInUseException {
        super::super::super::types::error::CloudHsmClusterInUseException {
