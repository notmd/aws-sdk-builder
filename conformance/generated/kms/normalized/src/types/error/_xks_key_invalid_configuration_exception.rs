...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::XksKeyInvalidConfigurationException {
...
impl XksKeyInvalidConfigurationException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::XksKeyInvalidConfigurationExceptionBuilder {
        super::super::super::types::error::builders::XksKeyInvalidConfigurationExceptionBuilder::default()
    }
}
...
impl XksKeyInvalidConfigurationExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::XksKeyInvalidConfigurationException {
        super::super::super::types::error::XksKeyInvalidConfigurationException {
