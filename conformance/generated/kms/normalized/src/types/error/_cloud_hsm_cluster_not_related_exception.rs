...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::CloudHsmClusterNotRelatedException {
...
impl CloudHsmClusterNotRelatedException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::CloudHsmClusterNotRelatedExceptionBuilder {
        super::super::super::types::error::builders::CloudHsmClusterNotRelatedExceptionBuilder::default()
    }
}
...
impl CloudHsmClusterNotRelatedExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::CloudHsmClusterNotRelatedException {
        super::super::super::types::error::CloudHsmClusterNotRelatedException {
