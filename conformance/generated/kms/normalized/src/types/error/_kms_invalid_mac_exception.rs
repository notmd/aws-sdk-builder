...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::KmsInvalidMacException {
...
impl KmsInvalidMacException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::KmsInvalidMacExceptionBuilder {
        super::super::super::types::error::builders::KmsInvalidMacExceptionBuilder::default()
    }
}
...
impl KmsInvalidMacExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::KmsInvalidMacException {
        super::super::super::types::error::KmsInvalidMacException {
