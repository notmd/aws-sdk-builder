...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::ExpiredImportTokenException {
...
impl ExpiredImportTokenException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::ExpiredImportTokenExceptionBuilder {
        super::super::super::types::error::builders::ExpiredImportTokenExceptionBuilder::default()
    }
}
...
impl ExpiredImportTokenExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::ExpiredImportTokenException {
        super::super::super::types::error::ExpiredImportTokenException {
