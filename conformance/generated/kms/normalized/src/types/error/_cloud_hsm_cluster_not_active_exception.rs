...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::CloudHsmClusterNotActiveException {
...
impl CloudHsmClusterNotActiveException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::CloudHsmClusterNotActiveExceptionBuilder {
        super::super::super::types::error::builders::CloudHsmClusterNotActiveExceptionBuilder::default()
    }
}
...
impl CloudHsmClusterNotActiveExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::CloudHsmClusterNotActiveException {
        super::super::super::types::error::CloudHsmClusterNotActiveException {
