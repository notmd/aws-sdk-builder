...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::IncorrectKeyMaterialException {
...
impl IncorrectKeyMaterialException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::IncorrectKeyMaterialExceptionBuilder {
        super::super::super::types::error::builders::IncorrectKeyMaterialExceptionBuilder::default()
    }
}
...
impl IncorrectKeyMaterialExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::IncorrectKeyMaterialException {
        super::super::super::types::error::IncorrectKeyMaterialException {
