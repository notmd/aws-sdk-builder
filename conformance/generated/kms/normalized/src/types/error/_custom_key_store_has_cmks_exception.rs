...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::CustomKeyStoreHasCmKsException {
...
impl CustomKeyStoreHasCmKsException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::CustomKeyStoreHasCmKsExceptionBuilder {
        super::super::super::types::error::builders::CustomKeyStoreHasCmKsExceptionBuilder::default()
    }
}
...
impl CustomKeyStoreHasCmKsExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::CustomKeyStoreHasCmKsException {
        super::super::super::types::error::CustomKeyStoreHasCmKsException {
