...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::XksProxyIncorrectAuthenticationCredentialException {
...
impl XksProxyIncorrectAuthenticationCredentialException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::XksProxyIncorrectAuthenticationCredentialExceptionBuilder {
        super::super::super::types::error::builders::XksProxyIncorrectAuthenticationCredentialExceptionBuilder::default()
    }
}
...
impl XksProxyIncorrectAuthenticationCredentialExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::XksProxyIncorrectAuthenticationCredentialException {
        super::super::super::types::error::XksProxyIncorrectAuthenticationCredentialException {
