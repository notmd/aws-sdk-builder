...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::KmsInvalidSignatureException {
...
impl KmsInvalidSignatureException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::KmsInvalidSignatureExceptionBuilder {
        super::super::super::types::error::builders::KmsInvalidSignatureExceptionBuilder::default()
    }
}
...
impl KmsInvalidSignatureExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::KmsInvalidSignatureException {
        super::super::super::types::error::KmsInvalidSignatureException {
