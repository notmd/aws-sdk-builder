...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::XksProxyUriInUseException {
...
impl XksProxyUriInUseException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::XksProxyUriInUseExceptionBuilder {
        super::super::super::types::error::builders::XksProxyUriInUseExceptionBuilder::default()
    }
}
...
impl XksProxyUriInUseExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::XksProxyUriInUseException {
        super::super::super::types::error::XksProxyUriInUseException {
