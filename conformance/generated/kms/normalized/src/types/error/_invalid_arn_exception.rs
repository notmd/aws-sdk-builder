...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::InvalidArnException {
...
impl InvalidArnException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::InvalidArnExceptionBuilder {
        super::super::super::types::error::builders::InvalidArnExceptionBuilder::default()
    }
}
...
impl InvalidArnExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::InvalidArnException {
        super::super::super::types::error::InvalidArnException {
