...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::CloudHsmClusterInvalidConfigurationException {
...
impl CloudHsmClusterInvalidConfigurationException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::CloudHsmClusterInvalidConfigurationExceptionBuilder {
        super::super::super::types::error::builders::CloudHsmClusterInvalidConfigurationExceptionBuilder::default()
    }
}
...
impl CloudHsmClusterInvalidConfigurationExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::CloudHsmClusterInvalidConfigurationException {
        super::super::super::types::error::CloudHsmClusterInvalidConfigurationException {
