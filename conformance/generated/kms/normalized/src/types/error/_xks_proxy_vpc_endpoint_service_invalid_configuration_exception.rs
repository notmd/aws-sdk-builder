...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::XksProxyVpcEndpointServiceInvalidConfigurationException {
...
impl XksProxyVpcEndpointServiceInvalidConfigurationException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::XksProxyVpcEndpointServiceInvalidConfigurationExceptionBuilder {
        super::super::super::types::error::builders::XksProxyVpcEndpointServiceInvalidConfigurationExceptionBuilder::default()
    }
}
...
impl XksProxyVpcEndpointServiceInvalidConfigurationExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::XksProxyVpcEndpointServiceInvalidConfigurationException {
        super::super::super::types::error::XksProxyVpcEndpointServiceInvalidConfigurationException {
