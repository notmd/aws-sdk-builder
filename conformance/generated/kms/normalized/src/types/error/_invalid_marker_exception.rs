...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::InvalidMarkerException {
...
impl InvalidMarkerException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::InvalidMarkerExceptionBuilder {
        super::super::super::types::error::builders::InvalidMarkerExceptionBuilder::default()
    }
}
...
impl InvalidMarkerExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::InvalidMarkerException {
        super::super::super::types::error::InvalidMarkerException {
