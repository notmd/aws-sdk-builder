...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::CustomKeyStoreInvalidStateException {
...
impl CustomKeyStoreInvalidStateException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::CustomKeyStoreInvalidStateExceptionBuilder {
        super::super::super::types::error::builders::CustomKeyStoreInvalidStateExceptionBuilder::default()
    }
}
...
impl CustomKeyStoreInvalidStateExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::CustomKeyStoreInvalidStateException {
        super::super::super::types::error::CustomKeyStoreInvalidStateException {
