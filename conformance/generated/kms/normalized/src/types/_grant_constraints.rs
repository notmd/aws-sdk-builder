...
impl GrantConstraints {
    ...
    pub fn builder() -> super::super::types::builders::GrantConstraintsBuilder {
        super::super::types::builders::GrantConstraintsBuilder::default()
    }
}
...
impl GrantConstraintsBuilder {
    ...
    pub fn build(self) -> super::super::types::GrantConstraints {
        super::super::types::GrantConstraints {
