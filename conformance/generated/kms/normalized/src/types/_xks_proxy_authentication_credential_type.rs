...
impl XksProxyAuthenticationCredentialType {
    ...
    pub fn builder() -> super::super::types::builders::XksProxyAuthenticationCredentialTypeBuilder {
        super::super::types::builders::XksProxyAuthenticationCredentialTypeBuilder::default()
    }
}
...
impl XksProxyAuthenticationCredentialTypeBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::types::XksProxyAuthenticationCredentialType, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::XksProxyAuthenticationCredentialType {
