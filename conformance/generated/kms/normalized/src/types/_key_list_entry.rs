...
impl KeyListEntry {
    ...
    pub fn builder() -> super::super::types::builders::KeyListEntryBuilder {
        super::super::types::builders::KeyListEntryBuilder::default()
    }
}
...
impl KeyListEntryBuilder {
    ...
    pub fn build(self) -> super::super::types::KeyListEntry {
        super::super::types::KeyListEntry {
            key_id: self.key_id,
