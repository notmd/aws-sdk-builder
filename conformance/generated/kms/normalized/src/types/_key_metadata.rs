...
pub struct KeyMetadata {
    ...
    pub key_manager: ::std::option::Option<super::super::types::KeyManagerType>,
    ...
    pub encryption_algorithms: ::std::option::Option<::std::vec::Vec<super::super::types::EncryptionAlgorithmSpec>>,
    ...
    pub signing_algorithms: ::std::option::Option<::std::vec::Vec<super::super::types::SigningAlgorithmSpec>>,
    /// <p>The key agreement algorithm used to derive a shared secret.</p>
    pub key_agreement_algorithms: ::std::option::Option<::std::vec::Vec<super::super::types::KeyAgreementAlgorithmSpec>>,
    ...
    /// </ul>
    pub multi_region_configuration: ::std::option::Option<super::super::types::MultiRegionConfiguration>,
    ...
    pub mac_algorithms: ::std::option::Option<::std::vec::Vec<super::super::types::MacAlgorithmSpec>>,
    ...
    pub xks_key_configuration: ::std::option::Option<super::super::types::XksKeyConfigurationType>,
...
impl KeyMetadata {
    ...
    /// <p>The <a href="https://docs.aws.amazon.com/kms/latest/developerguide/kms-cryptography.html#cryptographic-operations">cryptographic operations</a> for which you can use the KMS key.</p>
    pub fn key_usage(&self) -> ::std::option::Option<&super::super::types::KeyUsageType> {
        self.key_usage.as_ref()
    }
    /// <p>The current status of the KMS key.</p>
    /// <p>For more information about how key state affects the use of a KMS key, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html">Key states of KMS keys</a> in the <i>Key Management Service Developer Guide</i>.</p>
    pub fn key_state(&self) -> ::std::option::Option<&super::super::types::KeyState> {
    ...
    /// <p>The source of the key material for the KMS key. When this value is <code>AWS_KMS</code>, KMS created the key material. When this value is <code>EXTERNAL</code>, the key material was imported or the KMS key doesn't have any key material. When this value is <code>AWS_CLOUDHSM</code>, the key material was created in the CloudHSM cluster associated with a custom key store.</p>
    pub fn origin(&self) -> ::std::option::Option<&super::super::types::OriginType> {
        self.origin.as_ref()
    }
    /// <p>A unique identifier for the <a href="https://docs.aws.amazon.com/kms/latest/developerguide/key-store-overview.html">custom key store</a> that contains the KMS key. This field is present only when the KMS key is created in a custom key store.</p>
    ...
    /// <p>Specifies whether the KMS key's key material expires. This value is present only when <code>Origin</code> is <code>EXTERNAL</code>, otherwise this value is omitted.</p>
    pub fn expiration_model(&self) -> ::std::option::Option<&super::super::types::ExpirationModelType> {
        self.expiration_model.as_ref()
    }
    /// <p>The manager of the KMS key. KMS keys in your Amazon Web Services account are either customer managed or Amazon Web Services managed. For more information about the difference, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#kms_keys">KMS keys</a> in the <i>Key Management Service Developer Guide</i>.</p>
    pub fn key_manager(&self) -> ::std::option::Option<&super::super::types::KeyManagerType> {
        self.key_manager.as_ref()
    }
    /// <p>Instead, use the <code>KeySpec</code> field.</p>
    /// <p>The <code>KeySpec</code> and <code>CustomerMasterKeySpec</code> fields have the same value. We recommend that you use the <code>KeySpec</code> field in your code. However, to avoid breaking changes, KMS supports both fields.</p>
    #[deprecated(note = "This field has been deprecated. Instead, use the KeySpec field.")]
    pub fn customer_master_key_spec(&self) -> ::std::option::Option<&super::super::types::CustomerMasterKeySpec> {
        self.customer_master_key_spec.as_ref()
    }
    /// <p>Describes the type of key material in the KMS key.</p>
    pub fn key_spec(&self) -> ::std::option::Option<&super::super::types::KeySpec> {
    ...
    pub fn encryption_algorithms(&self) -> &[super::super::types::EncryptionAlgorithmSpec] {
    ...
    pub fn signing_algorithms(&self) -> &[super::super::types::SigningAlgorithmSpec] {
    ...
    pub fn key_agreement_algorithms(&self) -> &[super::super::types::KeyAgreementAlgorithmSpec] {
    ...
    /// <p><code>ReplicaKeys</code> displays the key ARNs and Regions of all replica keys. This field includes the current KMS key if it is a replica key.</p></li>
    /// </ul>
    pub fn multi_region_configuration(&self) -> ::std::option::Option<&super::super::types::MultiRegionConfiguration> {
    ...
    pub fn mac_algorithms(&self) -> &[super::super::types::MacAlgorithmSpec] {
        self.mac_algorithms.as_deref().unwrap_or_default()
    }
    /// <p>Information about the external key that is associated with a KMS key in an external key store.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/keystore-external.html#concept-external-key">External key</a> in the <i>Key Management Service Developer Guide</i>.</p>
    pub fn xks_key_configuration(&self) -> ::std::option::Option<&super::super::types::XksKeyConfigurationType> {
...
impl KeyMetadata {
    ...
    pub fn builder() -> super::super::types::builders::KeyMetadataBuilder {
        super::super::types::builders::KeyMetadataBuilder::default()
    }
}
...
pub struct KeyMetadataBuilder {
    ...
    pub(crate) key_usage: ::std::option::Option<super::super::types::KeyUsageType>,
    pub(crate) key_state: ::std::option::Option<super::super::types::KeyState>,
    ...
    pub(crate) origin: ::std::option::Option<super::super::types::OriginType>,
    ...
    pub(crate) expiration_model: ::std::option::Option<super::super::types::ExpirationModelType>,
    pub(crate) key_manager: ::std::option::Option<super::super::types::KeyManagerType>,
    pub(crate) customer_master_key_spec: ::std::option::Option<super::super::types::CustomerMasterKeySpec>,
    pub(crate) key_spec: ::std::option::Option<super::super::types::KeySpec>,
    pub(crate) encryption_algorithms: ::std::option::Option<::std::vec::Vec<super::super::types::EncryptionAlgorithmSpec>>,
    pub(crate) signing_algorithms: ::std::option::Option<::std::vec::Vec<super::super::types::SigningAlgorithmSpec>>,
    pub(crate) key_agreement_algorithms: ::std::option::Option<::std::vec::Vec<super::super::types::KeyAgreementAlgorithmSpec>>,
    pub(crate) multi_region: ::std::option::Option<bool>,
    pub(crate) multi_region_configuration: ::std::option::Option<super::super::types::MultiRegionConfiguration>,
    pub(crate) pending_deletion_window_in_days: ::std::option::Option<i32>,
    pub(crate) mac_algorithms: ::std::option::Option<::std::vec::Vec<super::super::types::MacAlgorithmSpec>>,
    pub(crate) xks_key_configuration: ::std::option::Option<super::super::types::XksKeyConfigurationType>,
...
impl KeyMetadataBuilder {
    ...
    /// <p>The <a href="https://docs.aws.amazon.com/kms/latest/developerguide/kms-cryptography.html#cryptographic-operations">cryptographic operations</a> for which you can use the KMS key.</p>
    pub fn key_usage(mut self, input: super::super::types::KeyUsageType) -> Self {
        self.key_usage = ::std::option::Option::Some(input);
        self
    }
    /// <p>The <a href="https://docs.aws.amazon.com/kms/latest/developerguide/kms-cryptography.html#cryptographic-operations">cryptographic operations</a> for which you can use the KMS key.</p>
    pub fn set_key_usage(mut self, input: ::std::option::Option<super::super::types::KeyUsageType>) -> Self {
        self.key_usage = input;
        self
    }
    /// <p>The <a href="https://docs.aws.amazon.com/kms/latest/developerguide/kms-cryptography.html#cryptographic-operations">cryptographic operations</a> for which you can use the KMS key.</p>
    pub fn get_key_usage(&self) -> &::std::option::Option<super::super::types::KeyUsageType> {
        &self.key_usage
    }
    /// <p>The current status of the KMS key.</p>
    /// <p>For more information about how key state affects the use of a KMS key, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html">Key states of KMS keys</a> in the <i>Key Management Service Developer Guide</i>.</p>
    pub fn key_state(mut self, input: super::super::types::KeyState) -> Self {
        self.key_state = ::std::option::Option::Some(input);
        self
    }
    /// <p>The current status of the KMS key.</p>
    /// <p>For more information about how key state affects the use of a KMS key, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html">Key states of KMS keys</a> in the <i>Key Management Service Developer Guide</i>.</p>
    pub fn set_key_state(mut self, input: ::std::option::Option<super::super::types::KeyState>) -> Self {
        self.key_state = input;
        self
    }
    /// <p>The current status of the KMS key.</p>
    /// <p>For more information about how key state affects the use of a KMS key, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html">Key states of KMS keys</a> in the <i>Key Management Service Developer Guide</i>.</p>
    pub fn get_key_state(&self) -> &::std::option::Option<super::super::types::KeyState> {
        &self.key_state
    }
    /// <p>The date and time after which KMS deletes this KMS key. This value is present only when the KMS key is scheduled for deletion, that is, when its <code>KeyState</code> is <code>PendingDeletion</code>.</p>
    /// <p>When the primary key in a multi-Region key is scheduled for deletion but still has replica keys, its key state is <code>PendingReplicaDeletion</code> and the length of its waiting period is displayed in the <code>PendingDeletionWindowInDays</code> field.</p>
    ...
    /// <p>The source of the key material for the KMS key. When this value is <code>AWS_KMS</code>, KMS created the key material. When this value is <code>EXTERNAL</code>, the key material was imported or the KMS key doesn't have any key material. When this value is <code>AWS_CLOUDHSM</code>, the key material was created in the CloudHSM cluster associated with a custom key store.</p>
    pub fn origin(mut self, input: super::super::types::OriginType) -> Self {
        self.origin = ::std::option::Option::Some(input);
        self
    }
    /// <p>The source of the key material for the KMS key. When this value is <code>AWS_KMS</code>, KMS created the key material. When this value is <code>EXTERNAL</code>, the key material was imported or the KMS key doesn't have any key material. When this value is <code>AWS_CLOUDHSM</code>, the key material was created in the CloudHSM cluster associated with a custom key store.</p>
    pub fn set_origin(mut self, input: ::std::option::Option<super::super::types::OriginType>) -> Self {
        self.origin = input;
        self
    }
    /// <p>The source of the key material for the KMS key. When this value is <code>AWS_KMS</code>, KMS created the key material. When this value is <code>EXTERNAL</code>, the key material was imported or the KMS key doesn't have any key material. When this value is <code>AWS_CLOUDHSM</code>, the key material was created in the CloudHSM cluster associated with a custom key store.</p>
    pub fn get_origin(&self) -> &::std::option::Option<super::super::types::OriginType> {
        &self.origin
    }
    /// <p>A unique identifier for the <a href="https://docs.aws.amazon.com/kms/latest/developerguide/key-store-overview.html">custom key store</a> that contains the KMS key. This field is present only when the KMS key is created in a custom key store.</p>
    ...
    /// <p>Specifies whether the KMS key's key material expires. This value is present only when <code>Origin</code> is <code>EXTERNAL</code>, otherwise this value is omitted.</p>
    pub fn expiration_model(mut self, input: super::super::types::ExpirationModelType) -> Self {
        self.expiration_model = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies whether the KMS key's key material expires. This value is present only when <code>Origin</code> is <code>EXTERNAL</code>, otherwise this value is omitted.</p>
    pub fn set_expiration_model(mut self, input: ::std::option::Option<super::super::types::ExpirationModelType>) -> Self {
        self.expiration_model = input;
        self
    }
    /// <p>Specifies whether the KMS key's key material expires. This value is present only when <code>Origin</code> is <code>EXTERNAL</code>, otherwise this value is omitted.</p>
    pub fn get_expiration_model(&self) -> &::std::option::Option<super::super::types::ExpirationModelType> {
        &self.expiration_model
    }
    /// <p>The manager of the KMS key. KMS keys in your Amazon Web Services account are either customer managed or Amazon Web Services managed. For more information about the difference, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#kms_keys">KMS keys</a> in the <i>Key Management Service Developer Guide</i>.</p>
    pub fn key_manager(mut self, input: super::super::types::KeyManagerType) -> Self {
        self.key_manager = ::std::option::Option::Some(input);
        self
    }
    /// <p>The manager of the KMS key. KMS keys in your Amazon Web Services account are either customer managed or Amazon Web Services managed. For more information about the difference, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#kms_keys">KMS keys</a> in the <i>Key Management Service Developer Guide</i>.</p>
    pub fn set_key_manager(mut self, input: ::std::option::Option<super::super::types::KeyManagerType>) -> Self {
        self.key_manager = input;
        self
    }
    /// <p>The manager of the KMS key. KMS keys in your Amazon Web Services account are either customer managed or Amazon Web Services managed. For more information about the difference, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#kms_keys">KMS keys</a> in the <i>Key Management Service Developer Guide</i>.</p>
    pub fn get_key_manager(&self) -> &::std::option::Option<super::super::types::KeyManagerType> {
        &self.key_manager
    }
    /// <p>Instead, use the <code>KeySpec</code> field.</p>
    /// <p>The <code>KeySpec</code> and <code>CustomerMasterKeySpec</code> fields have the same value. We recommend that you use the <code>KeySpec</code> field in your code. However, to avoid breaking changes, KMS supports both fields.</p>
    #[deprecated(note = "This field has been deprecated. Instead, use the KeySpec field.")]
    pub fn customer_master_key_spec(mut self, input: super::super::types::CustomerMasterKeySpec) -> Self {
    ...
    /// <p>The <code>KeySpec</code> and <code>CustomerMasterKeySpec</code> fields have the same value. We recommend that you use the <code>KeySpec</code> field in your code. However, to avoid breaking changes, KMS supports both fields.</p>
    #[deprecated(note = "This field has been deprecated. Instead, use the KeySpec field.")]
    pub fn set_customer_master_key_spec(mut self, input: ::std::option::Option<super::super::types::CustomerMasterKeySpec>) -> Self {
    ...
    /// <p>The <code>KeySpec</code> and <code>CustomerMasterKeySpec</code> fields have the same value. We recommend that you use the <code>KeySpec</code> field in your code. However, to avoid breaking changes, KMS supports both fields.</p>
    #[deprecated(note = "This field has been deprecated. Instead, use the KeySpec field.")]
    pub fn get_customer_master_key_spec(&self) -> &::std::option::Option<super::super::types::CustomerMasterKeySpec> {
        &self.customer_master_key_spec
    }
    /// <p>Describes the type of key material in the KMS key.</p>
    pub fn key_spec(mut self, input: super::super::types::KeySpec) -> Self {
        self.key_spec = ::std::option::Option::Some(input);
        self
    }
    /// <p>Describes the type of key material in the KMS key.</p>
    pub fn set_key_spec(mut self, input: ::std::option::Option<super::super::types::KeySpec>) -> Self {
        self.key_spec = input;
        self
    }
    /// <p>Describes the type of key material in the KMS key.</p>
    pub fn get_key_spec(&self) -> &::std::option::Option<super::super::types::KeySpec> {
        &self.key_spec
    }
    ...
    /// <p>The encryption algorithms that the KMS key supports. You cannot use the KMS key with other encryption algorithms within KMS.</p>
    /// <p>This value is present only when the <code>KeyUsage</code> of the KMS key is <code>ENCRYPT_DECRYPT</code>.</p>
    pub fn encryption_algorithms(mut self, input: super::super::types::EncryptionAlgorithmSpec) -> Self {
    ...
    /// <p>The encryption algorithms that the KMS key supports. You cannot use the KMS key with other encryption algorithms within KMS.</p>
    /// <p>This value is present only when the <code>KeyUsage</code> of the KMS key is <code>ENCRYPT_DECRYPT</code>.</p>
    pub fn set_encryption_algorithms(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::EncryptionAlgorithmSpec>>) -> Self {
        self.encryption_algorithms = input;
        self
    }
    /// <p>The encryption algorithms that the KMS key supports. You cannot use the KMS key with other encryption algorithms within KMS.</p>
    /// <p>This value is present only when the <code>KeyUsage</code> of the KMS key is <code>ENCRYPT_DECRYPT</code>.</p>
    pub fn get_encryption_algorithms(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::EncryptionAlgorithmSpec>> {
    ...
    /// <p>The signing algorithms that the KMS key supports. You cannot use the KMS key with other signing algorithms within KMS.</p>
    /// <p>This field appears only when the <code>KeyUsage</code> of the KMS key is <code>SIGN_VERIFY</code>.</p>
    pub fn signing_algorithms(mut self, input: super::super::types::SigningAlgorithmSpec) -> Self {
    ...
    /// <p>The signing algorithms that the KMS key supports. You cannot use the KMS key with other signing algorithms within KMS.</p>
    /// <p>This field appears only when the <code>KeyUsage</code> of the KMS key is <code>SIGN_VERIFY</code>.</p>
    pub fn set_signing_algorithms(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::SigningAlgorithmSpec>>) -> Self {
        self.signing_algorithms = input;
        self
    }
    /// <p>The signing algorithms that the KMS key supports. You cannot use the KMS key with other signing algorithms within KMS.</p>
    /// <p>This field appears only when the <code>KeyUsage</code> of the KMS key is <code>SIGN_VERIFY</code>.</p>
    pub fn get_signing_algorithms(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::SigningAlgorithmSpec>> {
    ...
    ///
    /// <p>The key agreement algorithm used to derive a shared secret.</p>
    pub fn key_agreement_algorithms(mut self, input: super::super::types::KeyAgreementAlgorithmSpec) -> Self {
    ...
    /// <p>The key agreement algorithm used to derive a shared secret.</p>
    pub fn get_key_agreement_algorithms(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::KeyAgreementAlgorithmSpec>> {
    ...
    /// <p><code>ReplicaKeys</code> displays the key ARNs and Regions of all replica keys. This field includes the current KMS key if it is a replica key.</p></li>
    /// </ul>
    pub fn multi_region_configuration(mut self, input: super::super::types::MultiRegionConfiguration) -> Self {
    ...
    /// <p><code>ReplicaKeys</code> displays the key ARNs and Regions of all replica keys. This field includes the current KMS key if it is a replica key.</p></li>
    /// </ul>
    pub fn set_multi_region_configuration(mut self, input: ::std::option::Option<super::super::types::MultiRegionConfiguration>) -> Self {
    ...
    /// <p><code>ReplicaKeys</code> displays the key ARNs and Regions of all replica keys. This field includes the current KMS key if it is a replica key.</p></li>
    /// </ul>
    pub fn get_multi_region_configuration(&self) -> &::std::option::Option<super::super::types::MultiRegionConfiguration> {
    ...
    /// <p>The message authentication code (MAC) algorithm that the HMAC KMS key supports.</p>
    /// <p>This value is present only when the <code>KeyUsage</code> of the KMS key is <code>GENERATE_VERIFY_MAC</code>.</p>
    pub fn mac_algorithms(mut self, input: super::super::types::MacAlgorithmSpec) -> Self {
    ...
    /// <p>The message authentication code (MAC) algorithm that the HMAC KMS key supports.</p>
    /// <p>This value is present only when the <code>KeyUsage</code> of the KMS key is <code>GENERATE_VERIFY_MAC</code>.</p>
    pub fn set_mac_algorithms(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::MacAlgorithmSpec>>) -> Self {
        self.mac_algorithms = input;
        self
    }
    /// <p>The message authentication code (MAC) algorithm that the HMAC KMS key supports.</p>
    /// <p>This value is present only when the <code>KeyUsage</code> of the KMS key is <code>GENERATE_VERIFY_MAC</code>.</p>
    pub fn get_mac_algorithms(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::MacAlgorithmSpec>> {
        &self.mac_algorithms
    }
    /// <p>Information about the external key that is associated with a KMS key in an external key store.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/keystore-external.html#concept-external-key">External key</a> in the <i>Key Management Service Developer Guide</i>.</p>
    pub fn xks_key_configuration(mut self, input: super::super::types::XksKeyConfigurationType) -> Self {
        self.xks_key_configuration = ::std::option::Option::Some(input);
        self
    }
    /// <p>Information about the external key that is associated with a KMS key in an external key store.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/keystore-external.html#concept-external-key">External key</a> in the <i>Key Management Service Developer Guide</i>.</p>
    pub fn set_xks_key_configuration(mut self, input: ::std::option::Option<super::super::types::XksKeyConfigurationType>) -> Self {
        self.xks_key_configuration = input;
        self
    }
    /// <p>Information about the external key that is associated with a KMS key in an external key store.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/keystore-external.html#concept-external-key">External key</a> in the <i>Key Management Service Developer Guide</i>.</p>
    pub fn get_xks_key_configuration(&self) -> &::std::option::Option<super::super::types::XksKeyConfigurationType> {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::KeyMetadata, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::KeyMetadata {
