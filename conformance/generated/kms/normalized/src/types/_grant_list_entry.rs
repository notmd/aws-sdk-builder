...
pub struct GrantListEntry {
    ...
    pub operations: ::std::option::Option<::std::vec::Vec<super::super::types::GrantOperation>>,
...
impl GrantListEntry {
    ...
    pub fn operations(&self) -> &[super::super::types::GrantOperation] {
        self.operations.as_deref().unwrap_or_default()
    }
    /// <p>The constraints on the grant, such as encryption context pairs or a SourceArn, that restrict the subsequent operations the grant allows.</p>
    pub fn constraints(&self) -> ::std::option::Option<&super::super::types::GrantConstraints> {
...
impl GrantListEntry {
    ...
    pub fn builder() -> super::super::types::builders::GrantListEntryBuilder {
        super::super::types::builders::GrantListEntryBuilder::default()
    }
}
...
pub struct GrantListEntryBuilder {
    ...
    pub(crate) operations: ::std::option::Option<::std::vec::Vec<super::super::types::GrantOperation>>,
    pub(crate) constraints: ::std::option::Option<super::super::types::GrantConstraints>,
...
impl GrantListEntryBuilder {
    ...
    ///
    /// <p>The list of operations permitted by the grant.</p>
    pub fn operations(mut self, input: super::super::types::GrantOperation) -> Self {
    ...
    /// <p>The list of operations permitted by the grant.</p>
    pub fn set_operations(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::GrantOperation>>) -> Self {
        self.operations = input;
        self
    }
    /// <p>The list of operations permitted by the grant.</p>
    pub fn get_operations(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::GrantOperation>> {
        &self.operations
    }
    /// <p>The constraints on the grant, such as encryption context pairs or a SourceArn, that restrict the subsequent operations the grant allows.</p>
    pub fn constraints(mut self, input: super::super::types::GrantConstraints) -> Self {
        self.constraints = ::std::option::Option::Some(input);
        self
    }
    /// <p>The constraints on the grant, such as encryption context pairs or a SourceArn, that restrict the subsequent operations the grant allows.</p>
    pub fn set_constraints(mut self, input: ::std::option::Option<super::super::types::GrantConstraints>) -> Self {
        self.constraints = input;
        self
    }
    /// <p>The constraints on the grant, such as encryption context pairs or a SourceArn, that restrict the subsequent operations the grant allows.</p>
    pub fn get_constraints(&self) -> &::std::option::Option<super::super::types::GrantConstraints> {
        &self.constraints
    }
    /// <p>The Amazon Web Services <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_elements_principal.html#principal-services">service principal</a> that gets the permissions in the grant.</p>
    ...
    pub fn build(self) -> super::super::types::GrantListEntry {
        super::super::types::GrantListEntry {
            key_id: self.key_id,
