...
impl XksKeyConfigurationType {
    ...
    pub fn builder() -> super::super::types::builders::XksKeyConfigurationTypeBuilder {
        super::super::types::builders::XksKeyConfigurationTypeBuilder::default()
    }
}
...
impl XksKeyConfigurationTypeBuilder {
    ...
    pub fn build(self) -> super::super::types::XksKeyConfigurationType {
        super::super::types::XksKeyConfigurationType { id: self.id }
    }
}
