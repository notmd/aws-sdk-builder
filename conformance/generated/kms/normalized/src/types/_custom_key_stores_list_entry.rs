...
pub struct CustomKeyStoresListEntry {
    ...
    pub connection_state: ::std::option::Option<super::super::types::ConnectionStateType>,
    ...
    /// </ul>
    pub connection_error_code: ::std::option::Option<super::super::types::ConnectionErrorCodeType>,
    ...
    pub xks_proxy_configuration: ::std::option::Option<super::super::types::XksProxyConfigurationType>,
}
impl CustomKeyStoresListEntry {
    ...
    /// <p>The <code>ConnectionState</code> value is <code>DISCONNECTED</code> only if the key store has never been connected or you use the <code>DisconnectCustomKeyStore</code> operation to disconnect it. If the value is <code>CONNECTED</code> but you are having trouble using the custom key store, make sure that the backing key store is reachable and active. For an CloudHSM key store, verify that its associated CloudHSM cluster is active and contains at least one active HSM. For an external key store, verify that the external key store proxy and external key manager are connected and enabled.</p>
    /// <p>A value of <code>FAILED</code> indicates that an attempt to connect was unsuccessful. The <code>ConnectionErrorCode</code> field in the response indicates the cause of the failure. For help resolving a connection failure, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/fix-keystore.html">Troubleshooting a custom key store</a> in the <i>Key Management Service Developer Guide</i>.</p>
    pub fn connection_state(&self) -> ::std::option::Option<&super::super::types::ConnectionStateType> {
    ...
    /// <p><code>XKS_VPC_ENDPOINT_SERVICE_NOT_FOUND</code> — KMS can't find the VPC endpoint service that it uses to communicate with the external key store proxy. Verify that the <code>XksProxyVpcEndpointServiceName</code> is correct and the KMS service principal has service consumer permissions on the Amazon VPC endpoint service.</p></li>
    /// </ul>
    pub fn connection_error_code(&self) -> ::std::option::Option<&super::super::types::ConnectionErrorCodeType> {
    ...
    /// <p>Indicates the type of the custom key store. <code>AWS_CLOUDHSM</code> indicates a custom key store backed by an CloudHSM cluster. <code>EXTERNAL_KEY_STORE</code> indicates a custom key store backed by an external key store proxy and external key manager outside of Amazon Web Services.</p>
    pub fn custom_key_store_type(&self) -> ::std::option::Option<&super::super::types::CustomKeyStoreType> {
        self.custom_key_store_type.as_ref()
    }
    /// <p>Configuration settings for the external key store proxy (XKS proxy). The external key store proxy translates KMS requests into a format that your external key manager can understand. The proxy configuration includes connection information that KMS requires.</p>
    /// <p>This field appears only when the <code>CustomKeyStoreType</code> is <code>EXTERNAL_KEY_STORE</code>.</p>
    pub fn xks_proxy_configuration(&self) -> ::std::option::Option<&super::super::types::XksProxyConfigurationType> {
...
impl CustomKeyStoresListEntry {
    ...
    pub fn builder() -> super::super::types::builders::CustomKeyStoresListEntryBuilder {
        super::super::types::builders::CustomKeyStoresListEntryBuilder::default()
    }
}
...
pub struct CustomKeyStoresListEntryBuilder {
    ...
    pub(crate) connection_state: ::std::option::Option<super::super::types::ConnectionStateType>,
    pub(crate) connection_error_code: ::std::option::Option<super::super::types::ConnectionErrorCodeType>,
    pub(crate) creation_date: ::std::option::Option<::aws_smithy_types::DateTime>,
    pub(crate) custom_key_store_type: ::std::option::Option<super::super::types::CustomKeyStoreType>,
    pub(crate) xks_proxy_configuration: ::std::option::Option<super::super::types::XksProxyConfigurationType>,
}
impl CustomKeyStoresListEntryBuilder {
    ...
    /// <p>The <code>ConnectionState</code> value is <code>DISCONNECTED</code> only if the key store has never been connected or you use the <code>DisconnectCustomKeyStore</code> operation to disconnect it. If the value is <code>CONNECTED</code> but you are having trouble using the custom key store, make sure that the backing key store is reachable and active. For an CloudHSM key store, verify that its associated CloudHSM cluster is active and contains at least one active HSM. For an external key store, verify that the external key store proxy and external key manager are connected and enabled.</p>
    /// <p>A value of <code>FAILED</code> indicates that an attempt to connect was unsuccessful. The <code>ConnectionErrorCode</code> field in the response indicates the cause of the failure. For help resolving a connection failure, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/fix-keystore.html">Troubleshooting a custom key store</a> in the <i>Key Management Service Developer Guide</i>.</p>
    pub fn connection_state(mut self, input: super::super::types::ConnectionStateType) -> Self {
    ...
    /// <p>The <code>ConnectionState</code> value is <code>DISCONNECTED</code> only if the key store has never been connected or you use the <code>DisconnectCustomKeyStore</code> operation to disconnect it. If the value is <code>CONNECTED</code> but you are having trouble using the custom key store, make sure that the backing key store is reachable and active. For an CloudHSM key store, verify that its associated CloudHSM cluster is active and contains at least one active HSM. For an external key store, verify that the external key store proxy and external key manager are connected and enabled.</p>
    /// <p>A value of <code>FAILED</code> indicates that an attempt to connect was unsuccessful. The <code>ConnectionErrorCode</code> field in the response indicates the cause of the failure. For help resolving a connection failure, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/fix-keystore.html">Troubleshooting a custom key store</a> in the <i>Key Management Service Developer Guide</i>.</p>
    pub fn set_connection_state(mut self, input: ::std::option::Option<super::super::types::ConnectionStateType>) -> Self {
    ...
    /// <p>The <code>ConnectionState</code> value is <code>DISCONNECTED</code> only if the key store has never been connected or you use the <code>DisconnectCustomKeyStore</code> operation to disconnect it. If the value is <code>CONNECTED</code> but you are having trouble using the custom key store, make sure that the backing key store is reachable and active. For an CloudHSM key store, verify that its associated CloudHSM cluster is active and contains at least one active HSM. For an external key store, verify that the external key store proxy and external key manager are connected and enabled.</p>
    /// <p>A value of <code>FAILED</code> indicates that an attempt to connect was unsuccessful. The <code>ConnectionErrorCode</code> field in the response indicates the cause of the failure. For help resolving a connection failure, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/fix-keystore.html">Troubleshooting a custom key store</a> in the <i>Key Management Service Developer Guide</i>.</p>
    pub fn get_connection_state(&self) -> &::std::option::Option<super::super::types::ConnectionStateType> {
    ...
    /// <p><code>XKS_VPC_ENDPOINT_SERVICE_NOT_FOUND</code> — KMS can't find the VPC endpoint service that it uses to communicate with the external key store proxy. Verify that the <code>XksProxyVpcEndpointServiceName</code> is correct and the KMS service principal has service consumer permissions on the Amazon VPC endpoint service.</p></li>
    /// </ul>
    pub fn connection_error_code(mut self, input: super::super::types::ConnectionErrorCodeType) -> Self {
    ...
    /// <p><code>XKS_VPC_ENDPOINT_SERVICE_NOT_FOUND</code> — KMS can't find the VPC endpoint service that it uses to communicate with the external key store proxy. Verify that the <code>XksProxyVpcEndpointServiceName</code> is correct and the KMS service principal has service consumer permissions on the Amazon VPC endpoint service.</p></li>
    /// </ul>
    pub fn set_connection_error_code(mut self, input: ::std::option::Option<super::super::types::ConnectionErrorCodeType>) -> Self {
    ...
    /// <p><code>XKS_VPC_ENDPOINT_SERVICE_NOT_FOUND</code> — KMS can't find the VPC endpoint service that it uses to communicate with the external key store proxy. Verify that the <code>XksProxyVpcEndpointServiceName</code> is correct and the KMS service principal has service consumer permissions on the Amazon VPC endpoint service.</p></li>
    /// </ul>
    pub fn get_connection_error_code(&self) -> &::std::option::Option<super::super::types::ConnectionErrorCodeType> {
    ...
    /// <p>Indicates the type of the custom key store. <code>AWS_CLOUDHSM</code> indicates a custom key store backed by an CloudHSM cluster. <code>EXTERNAL_KEY_STORE</code> indicates a custom key store backed by an external key store proxy and external key manager outside of Amazon Web Services.</p>
    pub fn custom_key_store_type(mut self, input: super::super::types::CustomKeyStoreType) -> Self {
        self.custom_key_store_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>Indicates the type of the custom key store. <code>AWS_CLOUDHSM</code> indicates a custom key store backed by an CloudHSM cluster. <code>EXTERNAL_KEY_STORE</code> indicates a custom key store backed by an external key store proxy and external key manager outside of Amazon Web Services.</p>
    pub fn set_custom_key_store_type(mut self, input: ::std::option::Option<super::super::types::CustomKeyStoreType>) -> Self {
        self.custom_key_store_type = input;
        self
    }
    /// <p>Indicates the type of the custom key store. <code>AWS_CLOUDHSM</code> indicates a custom key store backed by an CloudHSM cluster. <code>EXTERNAL_KEY_STORE</code> indicates a custom key store backed by an external key store proxy and external key manager outside of Amazon Web Services.</p>
    pub fn get_custom_key_store_type(&self) -> &::std::option::Option<super::super::types::CustomKeyStoreType> {
        &self.custom_key_store_type
    }
    /// <p>Configuration settings for the external key store proxy (XKS proxy). The external key store proxy translates KMS requests into a format that your external key manager can understand. The proxy configuration includes connection information that KMS requires.</p>
    /// <p>This field appears only when the <code>CustomKeyStoreType</code> is <code>EXTERNAL_KEY_STORE</code>.</p>
    pub fn xks_proxy_configuration(mut self, input: super::super::types::XksProxyConfigurationType) -> Self {
        self.xks_proxy_configuration = ::std::option::Option::Some(input);
        self
    }
    /// <p>Configuration settings for the external key store proxy (XKS proxy). The external key store proxy translates KMS requests into a format that your external key manager can understand. The proxy configuration includes connection information that KMS requires.</p>
    /// <p>This field appears only when the <code>CustomKeyStoreType</code> is <code>EXTERNAL_KEY_STORE</code>.</p>
    pub fn set_xks_proxy_configuration(mut self, input: ::std::option::Option<super::super::types::XksProxyConfigurationType>) -> Self {
        self.xks_proxy_configuration = input;
        self
    }
    /// <p>Configuration settings for the external key store proxy (XKS proxy). The external key store proxy translates KMS requests into a format that your external key manager can understand. The proxy configuration includes connection information that KMS requires.</p>
    /// <p>This field appears only when the <code>CustomKeyStoreType</code> is <code>EXTERNAL_KEY_STORE</code>.</p>
    pub fn get_xks_proxy_configuration(&self) -> &::std::option::Option<super::super::types::XksProxyConfigurationType> {
    ...
    pub fn build(self) -> super::super::types::CustomKeyStoresListEntry {
        super::super::types::CustomKeyStoresListEntry {
