...
pub struct XksProxyConfigurationType {
    ...
    pub connectivity: ::std::option::Option<super::super::types::XksProxyConnectivityType>,
...
impl XksProxyConfigurationType {
    /// <p>Indicates whether the external key store proxy uses a public endpoint or an Amazon VPC endpoint service to communicate with KMS.</p>
    pub fn connectivity(&self) -> ::std::option::Option<&super::super::types::XksProxyConnectivityType> {
...
impl XksProxyConfigurationType {
    ...
    pub fn builder() -> super::super::types::builders::XksProxyConfigurationTypeBuilder {
        super::super::types::builders::XksProxyConfigurationTypeBuilder::default()
    }
}
...
pub struct XksProxyConfigurationTypeBuilder {
    pub(crate) connectivity: ::std::option::Option<super::super::types::XksProxyConnectivityType>,
...
impl XksProxyConfigurationTypeBuilder {
    /// <p>Indicates whether the external key store proxy uses a public endpoint or an Amazon VPC endpoint service to communicate with KMS.</p>
    pub fn connectivity(mut self, input: super::super::types::XksProxyConnectivityType) -> Self {
        self.connectivity = ::std::option::Option::Some(input);
        self
    }
    /// <p>Indicates whether the external key store proxy uses a public endpoint or an Amazon VPC endpoint service to communicate with KMS.</p>
    pub fn set_connectivity(mut self, input: ::std::option::Option<super::super::types::XksProxyConnectivityType>) -> Self {
        self.connectivity = input;
        self
    }
    /// <p>Indicates whether the external key store proxy uses a public endpoint or an Amazon VPC endpoint service to communicate with KMS.</p>
    pub fn get_connectivity(&self) -> &::std::option::Option<super::super::types::XksProxyConnectivityType> {
        &self.connectivity
    }
    /// <p>The part of the external key store <a href="https://docs.aws.amazon.com/kms/latest/APIReference/API_CreateCustomKeyStore.html#KMS-CreateCustomKeyStore-request-XksProxyAuthenticationCredential">proxy authentication credential</a> that uniquely identifies the secret access key.</p>
    ...
    pub fn build(self) -> super::super::types::XksProxyConfigurationType {
        super::super::types::XksProxyConfigurationType {
