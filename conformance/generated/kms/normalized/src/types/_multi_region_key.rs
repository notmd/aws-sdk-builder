...
impl MultiRegionKey {
    ...
    pub fn builder() -> super::super::types::builders::MultiRegionKeyBuilder {
        super::super::types::builders::MultiRegionKeyBuilder::default()
    }
}
...
impl MultiRegionKeyBuilder {
    ...
    pub fn build(self) -> super::super::types::MultiRegionKey {
        super::super::types::MultiRegionKey {
            arn: self.arn,
            region: self.region,
        }
    }
