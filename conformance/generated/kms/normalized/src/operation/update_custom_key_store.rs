...
impl UpdateCustomKeyStore {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::update_custom_key_store::UpdateCustomKeyStoreError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::update_custom_key_store::UpdateCustomKeyStoreOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("KMS", "UpdateCustomKeyStore", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateCustomKeyStoreResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_update_custom_key_store::de_update_custom_key_store_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_update_custom_key_store::de_update_custom_key_store_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateCustomKeyStoreRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::update_custom_key_store::UpdateCustomKeyStoreInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::update_custom_key_store::UpdateCustomKeyStoreInput,
...
pub enum UpdateCustomKeyStoreError {
    ...
    CloudHsmClusterNotRelatedException(super::super::types::error::CloudHsmClusterNotRelatedException),
...
impl ::aws_types::request_id::RequestId for super::super::operation::update_custom_key_store::UpdateCustomKeyStoreError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::update_custom_key_store::_update_custom_key_store_input::UpdateCustomKeyStoreInput;

pub use super::super::operation::update_custom_key_store::_update_custom_key_store_output::UpdateCustomKeyStoreOutput;
