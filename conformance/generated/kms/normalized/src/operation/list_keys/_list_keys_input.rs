...
impl ListKeysInput {
    ...
    pub fn builder() -> super::super::super::operation::list_keys::builders::ListKeysInputBuilder {
        super::super::super::operation::list_keys::builders::ListKeysInputBuilder::default()
    }
}
