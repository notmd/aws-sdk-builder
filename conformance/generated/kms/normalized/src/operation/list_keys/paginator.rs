...
impl ListKeysPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::list_keys::paginator::ListKeysPaginatorItems {
        super::super::super::operation::list_keys::paginator::ListKeysPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::super::super::operation::list_keys::ListKeys::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_keys_output_output_next_marker(resp);
...
impl ListKeysPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::KeyListEntry,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::list_keys::ListKeysError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
