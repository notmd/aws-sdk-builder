...
impl ListKeyRotations {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::list_key_rotations::ListKeyRotationsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::list_key_rotations::ListKeyRotationsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("KMS", "ListKeyRotations", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListKeyRotations {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListKeyRotations")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListKeyRotationsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_list_key_rotations::de_list_key_rotations_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_list_key_rotations::de_list_key_rotations_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListKeyRotationsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::list_key_rotations::ListKeyRotationsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::list_key_rotations::ListKeyRotationsInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::list_key_rotations::ListKeyRotationsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::list_key_rotations::_list_key_rotations_input::ListKeyRotationsInput;

pub use super::super::operation::list_key_rotations::_list_key_rotations_output::ListKeyRotationsOutput;
