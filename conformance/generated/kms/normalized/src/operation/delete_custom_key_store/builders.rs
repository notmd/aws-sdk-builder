...
pub use super::super::super::operation::delete_custom_key_store::_delete_custom_key_store_input::DeleteCustomKeyStoreInputBuilder;

pub use super::super::super::operation::delete_custom_key_store::_delete_custom_key_store_output::DeleteCustomKeyStoreOutputBuilder;

impl super::super::super::operation::delete_custom_key_store::builders::DeleteCustomKeyStoreInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_custom_key_store::DeleteCustomKeyStoreOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_custom_key_store::DeleteCustomKeyStoreError,
...
pub struct DeleteCustomKeyStoreFluentBuilder {
    ...
    inner: super::super::super::operation::delete_custom_key_store::builders::DeleteCustomKeyStoreInputBuilder,
...
impl DeleteCustomKeyStoreFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_custom_key_store::builders::DeleteCustomKeyStoreInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_custom_key_store::DeleteCustomKeyStore::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_custom_key_store::DeleteCustomKeyStore::orchestrate(&runtime_plugins, input).await
    }
