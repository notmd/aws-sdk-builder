...
impl DeleteCustomKeyStoreInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_custom_key_store::builders::DeleteCustomKeyStoreInputBuilder {
        super::super::super::operation::delete_custom_key_store::builders::DeleteCustomKeyStoreInputBuilder::default()
    }
}
