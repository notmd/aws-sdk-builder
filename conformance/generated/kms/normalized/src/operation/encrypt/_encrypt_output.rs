...
impl EncryptOutput {
    ...
    pub fn builder() -> super::super::super::operation::encrypt::builders::EncryptOutputBuilder {
        super::super::super::operation::encrypt::builders::EncryptOutputBuilder::default()
    }
}
...
impl EncryptOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::encrypt::EncryptOutput {
