...
impl EncryptInput {
    ...
    pub fn builder() -> super::super::super::operation::encrypt::builders::EncryptInputBuilder {
        super::super::super::operation::encrypt::builders::EncryptInputBuilder::default()
    }
}
