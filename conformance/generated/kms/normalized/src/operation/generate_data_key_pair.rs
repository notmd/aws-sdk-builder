    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::generate_data_key_pair::GenerateDataKeyPairError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::generate_data_key_pair::GenerateDataKeyPairOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GenerateDataKeyPairResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_generate_data_key_pair::de_generate_data_key_pair_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_generate_data_key_pair::de_generate_data_key_pair_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GenerateDataKeyPairRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::generate_data_key_pair::GenerateDataKeyPairInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::generate_data_key_pair::GenerateDataKeyPairInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::generate_data_key_pair::GenerateDataKeyPairError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::generate_data_key_pair::_generate_data_key_pair_input::GenerateDataKeyPairInput;

pub use super::super::operation::generate_data_key_pair::_generate_data_key_pair_output::GenerateDataKeyPairOutput;
