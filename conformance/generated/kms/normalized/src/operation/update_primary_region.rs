...
impl UpdatePrimaryRegion {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::update_primary_region::UpdatePrimaryRegionInput,
    ) -> ::std::result::Result<
        super::super::operation::update_primary_region::UpdatePrimaryRegionOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::update_primary_region::UpdatePrimaryRegionError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::update_primary_region::UpdatePrimaryRegionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::update_primary_region::UpdatePrimaryRegionOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdatePrimaryRegionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_update_primary_region::de_update_primary_region_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_update_primary_region::de_update_primary_region_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdatePrimaryRegionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::update_primary_region::UpdatePrimaryRegionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::update_primary_region::UpdatePrimaryRegionInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::update_primary_region::UpdatePrimaryRegionError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::update_primary_region::_update_primary_region_input::UpdatePrimaryRegionInput;

pub use super::super::operation::update_primary_region::_update_primary_region_output::UpdatePrimaryRegionOutput;
