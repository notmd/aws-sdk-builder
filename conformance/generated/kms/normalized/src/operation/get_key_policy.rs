...
impl GetKeyPolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::get_key_policy::GetKeyPolicyInput,
    ) -> ::std::result::Result<
        super::super::operation::get_key_policy::GetKeyPolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::get_key_policy::GetKeyPolicyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::get_key_policy::GetKeyPolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::get_key_policy::GetKeyPolicyOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("KMS", "GetKeyPolicy", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetKeyPolicy {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetKeyPolicyResponseDeserializer,
        ));
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetKeyPolicy")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetKeyPolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_get_key_policy::de_get_key_policy_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_get_key_policy::de_get_key_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetKeyPolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::get_key_policy::GetKeyPolicyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::get_key_policy::GetKeyPolicyInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_get_key_policy::ser_get_key_policy_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::get_key_policy::GetKeyPolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::get_key_policy::_get_key_policy_input::GetKeyPolicyInput;

pub use super::super::operation::get_key_policy::_get_key_policy_output::GetKeyPolicyOutput;
