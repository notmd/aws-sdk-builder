...
impl DisconnectCustomKeyStoreOutput {
    ...
    pub fn builder() -> super::super::super::operation::disconnect_custom_key_store::builders::DisconnectCustomKeyStoreOutputBuilder {
        super::super::super::operation::disconnect_custom_key_store::builders::DisconnectCustomKeyStoreOutputBuilder::default()
    }
}
...
impl DisconnectCustomKeyStoreOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::disconnect_custom_key_store::DisconnectCustomKeyStoreOutput {
