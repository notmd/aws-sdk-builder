...
pub use super::super::super::operation::disconnect_custom_key_store::_disconnect_custom_key_store_input::DisconnectCustomKeyStoreInputBuilder;

pub use super::super::super::operation::disconnect_custom_key_store::_disconnect_custom_key_store_output::DisconnectCustomKeyStoreOutputBuilder;

impl super::super::super::operation::disconnect_custom_key_store::builders::DisconnectCustomKeyStoreInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::disconnect_custom_key_store::DisconnectCustomKeyStoreOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::disconnect_custom_key_store::DisconnectCustomKeyStoreError,
...
/// <p>While a custom key store is disconnected, all attempts to create KMS keys in the custom key store or to use existing KMS keys in <a href="https://docs.aws.amazon.com/kms/latest/developerguide/kms-cryptography.html#cryptographic-operations">cryptographic operations</a> will fail. This action can prevent users from storing and accessing sensitive data.</p>
/// </note>
...
pub struct DisconnectCustomKeyStoreFluentBuilder {
    ...
    inner: super::super::super::operation::disconnect_custom_key_store::builders::DisconnectCustomKeyStoreInputBuilder,
...
impl DisconnectCustomKeyStoreFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::disconnect_custom_key_store::builders::DisconnectCustomKeyStoreInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::disconnect_custom_key_store::DisconnectCustomKeyStore::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::disconnect_custom_key_store::DisconnectCustomKeyStore::orchestrate(&runtime_plugins, input).await
    }
