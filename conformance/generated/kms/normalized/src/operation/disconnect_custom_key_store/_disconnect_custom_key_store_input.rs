...
impl DisconnectCustomKeyStoreInput {
    ...
    pub fn builder() -> super::super::super::operation::disconnect_custom_key_store::builders::DisconnectCustomKeyStoreInputBuilder {
        super::super::super::operation::disconnect_custom_key_store::builders::DisconnectCustomKeyStoreInputBuilder::default()
    }
}
