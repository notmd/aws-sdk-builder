...
impl GenerateDataKeyWithoutPlaintextOutput {
    ...
    pub fn builder() -> super::super::super::operation::generate_data_key_without_plaintext::builders::GenerateDataKeyWithoutPlaintextOutputBuilder {
        super::super::super::operation::generate_data_key_without_plaintext::builders::GenerateDataKeyWithoutPlaintextOutputBuilder::default()
    }
}
...
impl GenerateDataKeyWithoutPlaintextOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::generate_data_key_without_plaintext::GenerateDataKeyWithoutPlaintextOutput {
