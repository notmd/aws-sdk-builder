...
impl UpdateKeyDescriptionInput {
    ...
    pub fn builder() -> super::super::super::operation::update_key_description::builders::UpdateKeyDescriptionInputBuilder {
        super::super::super::operation::update_key_description::builders::UpdateKeyDescriptionInputBuilder::default()
    }
}
