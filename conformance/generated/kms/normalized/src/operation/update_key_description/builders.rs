...
pub use super::super::super::operation::update_key_description::_update_key_description_input::UpdateKeyDescriptionInputBuilder;

pub use super::super::super::operation::update_key_description::_update_key_description_output::UpdateKeyDescriptionOutputBuilder;

impl super::super::super::operation::update_key_description::builders::UpdateKeyDescriptionInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::update_key_description::UpdateKeyDescriptionOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::update_key_description::UpdateKeyDescriptionError,
...
pub struct UpdateKeyDescriptionFluentBuilder {
    ...
    inner: super::super::super::operation::update_key_description::builders::UpdateKeyDescriptionInputBuilder,
...
impl UpdateKeyDescriptionFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::update_key_description::builders::UpdateKeyDescriptionInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::update_key_description::UpdateKeyDescription::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::update_key_description::UpdateKeyDescription::orchestrate(&runtime_plugins, input).await
    }
