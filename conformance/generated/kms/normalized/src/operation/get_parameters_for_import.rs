...
impl GetParametersForImport {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::get_parameters_for_import::GetParametersForImportInput,
    ) -> ::std::result::Result<
        super::super::operation::get_parameters_for_import::GetParametersForImportOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::get_parameters_for_import::GetParametersForImportError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::get_parameters_for_import::GetParametersForImportError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::get_parameters_for_import::GetParametersForImportOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("KMS", "GetParametersForImport", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetParametersForImportTelemetryInputCaptureInterceptor {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetParametersForImportResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_get_parameters_for_import::de_get_parameters_for_import_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_get_parameters_for_import::de_get_parameters_for_import_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetParametersForImportRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::get_parameters_for_import::GetParametersForImportInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::get_parameters_for_import::GetParametersForImportInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_get_parameters_for_import::ser_get_parameters_for_import_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::super::operation::get_parameters_for_import::GetParametersForImportError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::get_parameters_for_import::_get_parameters_for_import_input::GetParametersForImportInput;

pub use super::super::operation::get_parameters_for_import::_get_parameters_for_import_output::GetParametersForImportOutput;
