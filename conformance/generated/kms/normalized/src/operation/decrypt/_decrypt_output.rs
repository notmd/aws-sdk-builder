...
impl DecryptOutput {
    ...
    pub fn builder() -> super::super::super::operation::decrypt::builders::DecryptOutputBuilder {
        super::super::super::operation::decrypt::builders::DecryptOutputBuilder::default()
    }
}
...
impl DecryptOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::decrypt::DecryptOutput {
