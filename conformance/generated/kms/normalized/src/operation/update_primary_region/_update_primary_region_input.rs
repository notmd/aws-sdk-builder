...
impl UpdatePrimaryRegionInput {
    ...
    pub fn builder() -> super::super::super::operation::update_primary_region::builders::UpdatePrimaryRegionInputBuilder {
        super::super::super::operation::update_primary_region::builders::UpdatePrimaryRegionInputBuilder::default()
    }
}
