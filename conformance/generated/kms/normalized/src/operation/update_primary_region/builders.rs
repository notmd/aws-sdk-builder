...
pub use super::super::super::operation::update_primary_region::_update_primary_region_input::UpdatePrimaryRegionInputBuilder;

pub use super::super::super::operation::update_primary_region::_update_primary_region_output::UpdatePrimaryRegionOutputBuilder;

impl super::super::super::operation::update_primary_region::builders::UpdatePrimaryRegionInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::update_primary_region::UpdatePrimaryRegionOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::update_primary_region::UpdatePrimaryRegionError,
...
pub struct UpdatePrimaryRegionFluentBuilder {
    ...
    inner: super::super::super::operation::update_primary_region::builders::UpdatePrimaryRegionInputBuilder,
...
impl UpdatePrimaryRegionFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::update_primary_region::builders::UpdatePrimaryRegionInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::update_primary_region::UpdatePrimaryRegion::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::update_primary_region::UpdatePrimaryRegion::orchestrate(&runtime_plugins, input).await
    }
