...
impl UpdatePrimaryRegionOutput {
    ...
    pub fn builder() -> super::super::super::operation::update_primary_region::builders::UpdatePrimaryRegionOutputBuilder {
        super::super::super::operation::update_primary_region::builders::UpdatePrimaryRegionOutputBuilder::default()
    }
}
...
impl UpdatePrimaryRegionOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::update_primary_region::UpdatePrimaryRegionOutput {
