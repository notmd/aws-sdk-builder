...
pub use super::super::super::operation::derive_shared_secret::_derive_shared_secret_input::DeriveSharedSecretInputBuilder;

pub use super::super::super::operation::derive_shared_secret::_derive_shared_secret_output::DeriveSharedSecretOutputBuilder;

impl super::super::super::operation::derive_shared_secret::builders::DeriveSharedSecretInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::derive_shared_secret::DeriveSharedSecretOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::derive_shared_secret::DeriveSharedSecretError,
...
pub struct DeriveSharedSecretFluentBuilder {
    ...
    inner: super::super::super::operation::derive_shared_secret::builders::DeriveSharedSecretInputBuilder,
...
impl DeriveSharedSecretFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::derive_shared_secret::builders::DeriveSharedSecretInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::derive_shared_secret::DeriveSharedSecret::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::derive_shared_secret::DeriveSharedSecret::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn key_agreement_algorithm(mut self, input: super::super::super::types::KeyAgreementAlgorithmSpec) -> Self {
        self.inner = self.inner.key_agreement_algorithm(input);
        self
    }
    /// <p>Specifies the key agreement algorithm used to derive the shared secret. The only valid value is <code>ECDH</code>.</p>
    pub fn set_key_agreement_algorithm(mut self, input: ::std::option::Option<super::super::super::types::KeyAgreementAlgorithmSpec>) -> Self {
        self.inner = self.inner.set_key_agreement_algorithm(input);
        self
    }
    /// <p>Specifies the key agreement algorithm used to derive the shared secret. The only valid value is <code>ECDH</code>.</p>
    pub fn get_key_agreement_algorithm(&self) -> &::std::option::Option<super::super::super::types::KeyAgreementAlgorithmSpec> {
