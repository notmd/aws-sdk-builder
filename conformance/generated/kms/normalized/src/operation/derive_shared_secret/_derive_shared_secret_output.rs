...
impl DeriveSharedSecretOutput {
    ...
    /// <p>Identifies the key agreement algorithm used to derive the shared secret.</p>
    pub fn key_agreement_algorithm(&self) -> ::std::option::Option<&super::super::super::types::KeyAgreementAlgorithmSpec> {
        self.key_agreement_algorithm.as_ref()
    }
    /// <p>The source of the key material for the specified KMS key.</p>
    /// <p>When this value is <code>AWS_KMS</code>, KMS created the key material. When this value is <code>EXTERNAL</code>, the key material was imported or the KMS key doesn't have any key material.</p>
    /// <p>The only valid values for DeriveSharedSecret are <code>AWS_KMS</code> and <code>EXTERNAL</code>. DeriveSharedSecret does not support KMS keys with a <code>KeyOrigin</code> value of <code>AWS_CLOUDHSM</code> or <code>EXTERNAL_KEY_STORE</code>.</p>
    pub fn key_origin(&self) -> ::std::option::Option<&super::super::super::types::OriginType> {
...
impl DeriveSharedSecretOutput {
    ...
    pub fn builder() -> super::super::super::operation::derive_shared_secret::builders::DeriveSharedSecretOutputBuilder {
        super::super::super::operation::derive_shared_secret::builders::DeriveSharedSecretOutputBuilder::default()
    }
}
...
pub struct DeriveSharedSecretOutputBuilder {
    ...
    pub(crate) key_agreement_algorithm: ::std::option::Option<super::super::super::types::KeyAgreementAlgorithmSpec>,
    pub(crate) key_origin: ::std::option::Option<super::super::super::types::OriginType>,
    _request_id: Option<String>,
}
impl DeriveSharedSecretOutputBuilder {
    ...
    /// <p>When this value is <code>AWS_KMS</code>, KMS created the key material. When this value is <code>EXTERNAL</code>, the key material was imported or the KMS key doesn't have any key material.</p>
    /// <p>The only valid values for DeriveSharedSecret are <code>AWS_KMS</code> and <code>EXTERNAL</code>. DeriveSharedSecret does not support KMS keys with a <code>KeyOrigin</code> value of <code>AWS_CLOUDHSM</code> or <code>EXTERNAL_KEY_STORE</code>.</p>
    pub fn key_origin(mut self, input: super::super::super::types::OriginType) -> Self {
    ...
    /// <p>When this value is <code>AWS_KMS</code>, KMS created the key material. When this value is <code>EXTERNAL</code>, the key material was imported or the KMS key doesn't have any key material.</p>
    /// <p>The only valid values for DeriveSharedSecret are <code>AWS_KMS</code> and <code>EXTERNAL</code>. DeriveSharedSecret does not support KMS keys with a <code>KeyOrigin</code> value of <code>AWS_CLOUDHSM</code> or <code>EXTERNAL_KEY_STORE</code>.</p>
    pub fn set_key_origin(mut self, input: ::std::option::Option<super::super::super::types::OriginType>) -> Self {
    ...
    /// <p>When this value is <code>AWS_KMS</code>, KMS created the key material. When this value is <code>EXTERNAL</code>, the key material was imported or the KMS key doesn't have any key material.</p>
    /// <p>The only valid values for DeriveSharedSecret are <code>AWS_KMS</code> and <code>EXTERNAL</code>. DeriveSharedSecret does not support KMS keys with a <code>KeyOrigin</code> value of <code>AWS_CLOUDHSM</code> or <code>EXTERNAL_KEY_STORE</code>.</p>
    pub fn get_key_origin(&self) -> &::std::option::Option<super::super::super::types::OriginType> {
        &self.key_origin
    }
    ...
    pub fn build(self) -> super::super::super::operation::derive_shared_secret::DeriveSharedSecretOutput {
