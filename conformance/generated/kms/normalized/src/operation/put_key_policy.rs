...
impl PutKeyPolicy {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::put_key_policy::PutKeyPolicyInput,
    ) -> ::std::result::Result<
        super::super::operation::put_key_policy::PutKeyPolicyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::put_key_policy::PutKeyPolicyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::put_key_policy::PutKeyPolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::put_key_policy::PutKeyPolicyOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("KMS", "PutKeyPolicy", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutKeyPolicy {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            PutKeyPolicyResponseDeserializer,
        ));
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutKeyPolicy")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutKeyPolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_put_key_policy::de_put_key_policy_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_put_key_policy::de_put_key_policy_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutKeyPolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::put_key_policy::PutKeyPolicyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::put_key_policy::PutKeyPolicyInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_put_key_policy::ser_put_key_policy_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::put_key_policy::PutKeyPolicyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::put_key_policy::_put_key_policy_input::PutKeyPolicyInput;

pub use super::super::operation::put_key_policy::_put_key_policy_output::PutKeyPolicyOutput;
