...
impl ListRetirableGrantsInput {
    ...
    pub fn builder() -> super::super::super::operation::list_retirable_grants::builders::ListRetirableGrantsInputBuilder {
        super::super::super::operation::list_retirable_grants::builders::ListRetirableGrantsInputBuilder::default()
    }
}
