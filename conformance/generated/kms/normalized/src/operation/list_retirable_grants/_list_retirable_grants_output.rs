...
impl ListRetirableGrantsOutput {
    ...
    pub fn grants(&self) -> &[super::super::super::types::GrantListEntry] {
...
impl ListRetirableGrantsOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_retirable_grants::builders::ListRetirableGrantsOutputBuilder {
        super::super::super::operation::list_retirable_grants::builders::ListRetirableGrantsOutputBuilder::default()
    }
}
...
pub struct ListRetirableGrantsOutputBuilder {
    pub(crate) grants: ::std::option::Option<::std::vec::Vec<super::super::super::types::GrantListEntry>>,
...
impl ListRetirableGrantsOutputBuilder {
    ...
    ///
    /// <p>A list of grants.</p>
    pub fn grants(mut self, input: super::super::super::types::GrantListEntry) -> Self {
    ...
    /// <p>A list of grants.</p>
    pub fn set_grants(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::GrantListEntry>>) -> Self {
        self.grants = input;
        self
    }
    /// <p>A list of grants.</p>
    pub fn get_grants(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::GrantListEntry>> {
        &self.grants
    }
    /// <p>When <code>Truncated</code> is true, this element is present and contains the value to use for the <code>Marker</code> parameter in a subsequent request.</p>
    ...
    pub fn build(self) -> super::super::super::operation::list_retirable_grants::ListRetirableGrantsOutput {
