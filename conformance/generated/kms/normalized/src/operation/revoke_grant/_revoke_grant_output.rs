...
impl RevokeGrantOutput {
    ...
    pub fn builder() -> super::super::super::operation::revoke_grant::builders::RevokeGrantOutputBuilder {
        super::super::super::operation::revoke_grant::builders::RevokeGrantOutputBuilder::default()
    }
}
...
impl RevokeGrantOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::revoke_grant::RevokeGrantOutput {
