...
impl DisableKeyRotation {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::disable_key_rotation::DisableKeyRotationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::disable_key_rotation::DisableKeyRotationOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("KMS", "DisableKeyRotation", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisableKeyRotationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_disable_key_rotation::de_disable_key_rotation_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_disable_key_rotation::de_disable_key_rotation_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisableKeyRotationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::disable_key_rotation::DisableKeyRotationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::disable_key_rotation::DisableKeyRotationInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::disable_key_rotation::DisableKeyRotationError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::disable_key_rotation::_disable_key_rotation_input::DisableKeyRotationInput;

pub use super::super::operation::disable_key_rotation::_disable_key_rotation_output::DisableKeyRotationOutput;
