...
impl UpdateCustomKeyStoreOutput {
    ...
    pub fn builder() -> super::super::super::operation::update_custom_key_store::builders::UpdateCustomKeyStoreOutputBuilder {
        super::super::super::operation::update_custom_key_store::builders::UpdateCustomKeyStoreOutputBuilder::default()
    }
}
...
impl UpdateCustomKeyStoreOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::update_custom_key_store::UpdateCustomKeyStoreOutput {
