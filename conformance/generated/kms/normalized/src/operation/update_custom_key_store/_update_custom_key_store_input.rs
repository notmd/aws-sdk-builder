...
impl UpdateCustomKeyStoreInput {
    ...
    pub fn builder() -> super::super::super::operation::update_custom_key_store::builders::UpdateCustomKeyStoreInputBuilder {
        super::super::super::operation::update_custom_key_store::builders::UpdateCustomKeyStoreInputBuilder::default()
    }
}
