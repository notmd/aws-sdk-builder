...
impl GenerateDataKey {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::generate_data_key::GenerateDataKeyInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::generate_data_key::GenerateDataKeyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::generate_data_key::GenerateDataKeyOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("KMS", "GenerateDataKey", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GenerateDataKey {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GenerateDataKey")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GenerateDataKeyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_generate_data_key::de_generate_data_key_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_generate_data_key::de_generate_data_key_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GenerateDataKeyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::generate_data_key::GenerateDataKeyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::generate_data_key::GenerateDataKeyInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::generate_data_key::GenerateDataKeyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::generate_data_key::_generate_data_key_input::GenerateDataKeyInput;

pub use super::super::operation::generate_data_key::_generate_data_key_output::GenerateDataKeyOutput;
