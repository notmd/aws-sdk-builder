...
impl DisableKeyInput {
    ...
    pub fn builder() -> super::super::super::operation::disable_key::builders::DisableKeyInputBuilder {
        super::super::super::operation::disable_key::builders::DisableKeyInputBuilder::default()
    }
}
