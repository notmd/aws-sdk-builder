...
impl DisableKeyOutput {
    ...
    pub fn builder() -> super::super::super::operation::disable_key::builders::DisableKeyOutputBuilder {
        super::super::super::operation::disable_key::builders::DisableKeyOutputBuilder::default()
    }
}
...
impl DisableKeyOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::disable_key::DisableKeyOutput {
