...
impl GenerateMac {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::generate_mac::GenerateMacInput,
    ) -> ::std::result::Result<
        super::super::operation::generate_mac::GenerateMacOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::generate_mac::GenerateMacError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::generate_mac::GenerateMacError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::generate_mac::GenerateMacOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GenerateMacResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_generate_mac::de_generate_mac_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_generate_mac::de_generate_mac_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GenerateMacRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::generate_mac::GenerateMacInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::generate_mac::GenerateMacInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_generate_mac::ser_generate_mac_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::generate_mac::GenerateMacError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::generate_mac::_generate_mac_input::GenerateMacInput;

pub use super::super::operation::generate_mac::_generate_mac_output::GenerateMacOutput;
