...
impl DescribeCustomKeyStoresOutput {
    ...
    pub fn custom_key_stores(&self) -> &[super::super::super::types::CustomKeyStoresListEntry] {
...
impl DescribeCustomKeyStoresOutput {
    ...
    pub fn builder() -> super::super::super::operation::describe_custom_key_stores::builders::DescribeCustomKeyStoresOutputBuilder {
        super::super::super::operation::describe_custom_key_stores::builders::DescribeCustomKeyStoresOutputBuilder::default()
    }
}
...
pub struct DescribeCustomKeyStoresOutputBuilder {
    pub(crate) custom_key_stores: ::std::option::Option<::std::vec::Vec<super::super::super::types::CustomKeyStoresListEntry>>,
...
impl DescribeCustomKeyStoresOutputBuilder {
    ...
    ///
    /// <p>Contains metadata about each custom key store.</p>
    pub fn custom_key_stores(mut self, input: super::super::super::types::CustomKeyStoresListEntry) -> Self {
    ...
    /// <p>Contains metadata about each custom key store.</p>
    pub fn get_custom_key_stores(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::CustomKeyStoresListEntry>> {
    ...
    pub fn build(self) -> super::super::super::operation::describe_custom_key_stores::DescribeCustomKeyStoresOutput {
