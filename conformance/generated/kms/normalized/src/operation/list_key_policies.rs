...
impl ListKeyPolicies {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::list_key_policies::ListKeyPoliciesInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::list_key_policies::ListKeyPoliciesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::list_key_policies::ListKeyPoliciesOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("KMS", "ListKeyPolicies", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListKeyPolicies {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListKeyPolicies")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListKeyPoliciesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_list_key_policies::de_list_key_policies_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_list_key_policies::de_list_key_policies_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListKeyPoliciesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::list_key_policies::ListKeyPoliciesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::list_key_policies::ListKeyPoliciesInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::list_key_policies::ListKeyPoliciesError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::list_key_policies::_list_key_policies_input::ListKeyPoliciesInput;

pub use super::super::operation::list_key_policies::_list_key_policies_output::ListKeyPoliciesOutput;
