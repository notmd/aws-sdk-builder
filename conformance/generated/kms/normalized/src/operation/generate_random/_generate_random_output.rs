...
impl GenerateRandomOutput {
    ...
    pub fn builder() -> super::super::super::operation::generate_random::builders::GenerateRandomOutputBuilder {
        super::super::super::operation::generate_random::builders::GenerateRandomOutputBuilder::default()
    }
}
...
impl GenerateRandomOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::generate_random::GenerateRandomOutput {
