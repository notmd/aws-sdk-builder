...
impl GetKeyLastUsageInput {
    ...
    pub fn builder() -> super::super::super::operation::get_key_last_usage::builders::GetKeyLastUsageInputBuilder {
        super::super::super::operation::get_key_last_usage::builders::GetKeyLastUsageInputBuilder::default()
    }
}
