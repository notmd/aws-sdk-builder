...
impl DescribeCustomKeyStores {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::describe_custom_key_stores::DescribeCustomKeyStoresInput,
    ) -> ::std::result::Result<
        super::super::operation::describe_custom_key_stores::DescribeCustomKeyStoresOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::describe_custom_key_stores::DescribeCustomKeyStoresError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::describe_custom_key_stores::DescribeCustomKeyStoresError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::describe_custom_key_stores::DescribeCustomKeyStoresOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("KMS", "DescribeCustomKeyStores", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeCustomKeyStores {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeCustomKeyStores")
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeCustomKeyStoresTelemetryInputCaptureInterceptor {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeCustomKeyStoresResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_describe_custom_key_stores::de_describe_custom_key_stores_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_describe_custom_key_stores::de_describe_custom_key_stores_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeCustomKeyStoresRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::describe_custom_key_stores::DescribeCustomKeyStoresInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::describe_custom_key_stores::DescribeCustomKeyStoresInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_describe_custom_key_stores::ser_describe_custom_key_stores_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::super::operation::describe_custom_key_stores::DescribeCustomKeyStoresError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::describe_custom_key_stores::_describe_custom_key_stores_input::DescribeCustomKeyStoresInput;

pub use super::super::operation::describe_custom_key_stores::_describe_custom_key_stores_output::DescribeCustomKeyStoresOutput;
