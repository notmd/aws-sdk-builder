...
impl ScheduleKeyDeletion {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::schedule_key_deletion::ScheduleKeyDeletionInput,
    ) -> ::std::result::Result<
        super::super::operation::schedule_key_deletion::ScheduleKeyDeletionOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::schedule_key_deletion::ScheduleKeyDeletionError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::schedule_key_deletion::ScheduleKeyDeletionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::schedule_key_deletion::ScheduleKeyDeletionOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("KMS", "ScheduleKeyDeletion", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ScheduleKeyDeletionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_schedule_key_deletion::de_schedule_key_deletion_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_schedule_key_deletion::de_schedule_key_deletion_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ScheduleKeyDeletionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::schedule_key_deletion::ScheduleKeyDeletionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::schedule_key_deletion::ScheduleKeyDeletionInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::schedule_key_deletion::ScheduleKeyDeletionError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::schedule_key_deletion::_schedule_key_deletion_input::ScheduleKeyDeletionInput;

pub use super::super::operation::schedule_key_deletion::_schedule_key_deletion_output::ScheduleKeyDeletionOutput;
