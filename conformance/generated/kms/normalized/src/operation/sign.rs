...
impl Sign {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::sign::SignInput,
    ) -> ::std::result::Result<
        super::super::operation::sign::SignOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::sign::SignError,
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("KMS", "Sign", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SignResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_sign::de_sign_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_sign::de_sign_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SignRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::super::operation::sign::SignInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::sign::SignInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_sign::ser_sign_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SignEndpointParamsInterceptor {
    ...
    fn read_before_execution(
        ...
        let _input = context.input().downcast_ref::<SignInput>().ok_or("failed to downcast to SignInput")?;
...
impl ::aws_types::request_id::RequestId for super::super::operation::sign::SignError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::sign::_sign_input::SignInput;

pub use super::super::operation::sign::_sign_output::SignOutput;
