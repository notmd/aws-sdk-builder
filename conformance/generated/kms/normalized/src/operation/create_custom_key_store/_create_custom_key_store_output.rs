...
impl CreateCustomKeyStoreOutput {
    ...
    pub fn builder() -> super::super::super::operation::create_custom_key_store::builders::CreateCustomKeyStoreOutputBuilder {
        super::super::super::operation::create_custom_key_store::builders::CreateCustomKeyStoreOutputBuilder::default()
    }
}
...
impl CreateCustomKeyStoreOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::create_custom_key_store::CreateCustomKeyStoreOutput {
