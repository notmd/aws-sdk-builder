...
impl ListResourceTags {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::list_resource_tags::ListResourceTagsInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::list_resource_tags::ListResourceTagsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::list_resource_tags::ListResourceTagsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("KMS", "ListResourceTags", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListResourceTags {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListResourceTags")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListResourceTagsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_list_resource_tags::de_list_resource_tags_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_list_resource_tags::de_list_resource_tags_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListResourceTagsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::list_resource_tags::ListResourceTagsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::list_resource_tags::ListResourceTagsInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::list_resource_tags::ListResourceTagsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::list_resource_tags::_list_resource_tags_input::ListResourceTagsInput;

pub use super::super::operation::list_resource_tags::_list_resource_tags_output::ListResourceTagsOutput;
