...
impl GetParametersForImportOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_parameters_for_import::builders::GetParametersForImportOutputBuilder {
        super::super::super::operation::get_parameters_for_import::builders::GetParametersForImportOutputBuilder::default()
    }
}
...
impl GetParametersForImportOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::get_parameters_for_import::GetParametersForImportOutput {
