...
impl RetireGrantInput {
    ...
    pub fn builder() -> super::super::super::operation::retire_grant::builders::RetireGrantInputBuilder {
        super::super::super::operation::retire_grant::builders::RetireGrantInputBuilder::default()
    }
}
