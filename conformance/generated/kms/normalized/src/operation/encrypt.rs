...
impl Encrypt {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::encrypt::EncryptInput,
    ) -> ::std::result::Result<
        super::super::operation::encrypt::EncryptOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::encrypt::EncryptError,
    ...
    > {
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::encrypt::EncryptOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("KMS", "Encrypt", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for EncryptResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_encrypt::de_encrypt_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_encrypt::de_encrypt_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for EncryptRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::super::operation::encrypt::EncryptInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::encrypt::EncryptInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_encrypt::ser_encrypt_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::encrypt::EncryptError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::encrypt::_encrypt_input::EncryptInput;

pub use super::super::operation::encrypt::_encrypt_output::EncryptOutput;
