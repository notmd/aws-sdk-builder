...
pub use super::super::super::operation::sign::_sign_input::SignInputBuilder;

pub use super::super::super::operation::sign::_sign_output::SignOutputBuilder;

impl super::super::super::operation::sign::builders::SignInputBuilder {
...
impl SignFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::sign::builders::SignInputBuilder {
        &self.inner
    }
