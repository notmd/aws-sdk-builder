...
impl SignOutput {
    ...
    pub fn builder() -> super::super::super::operation::sign::builders::SignOutputBuilder {
        super::super::super::operation::sign::builders::SignOutputBuilder::default()
    }
}
...
impl SignOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::sign::SignOutput {
