...
pub use super::super::super::operation::disable_key_rotation::_disable_key_rotation_input::DisableKeyRotationInputBuilder;

pub use super::super::super::operation::disable_key_rotation::_disable_key_rotation_output::DisableKeyRotationOutputBuilder;

impl super::super::super::operation::disable_key_rotation::builders::DisableKeyRotationInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::disable_key_rotation::DisableKeyRotationOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::disable_key_rotation::DisableKeyRotationError,
...
///
/// <p>Disables <a href="https://docs.aws.amazon.com/kms/latest/developerguide/rotating-keys-enable-disable.html">automatic rotation of the key material</a> of the specified symmetric encryption KMS key.</p>
...
pub struct DisableKeyRotationFluentBuilder {
    ...
    inner: super::super::super::operation::disable_key_rotation::builders::DisableKeyRotationInputBuilder,
...
impl DisableKeyRotationFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::disable_key_rotation::builders::DisableKeyRotationInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::disable_key_rotation::DisableKeyRotation::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::disable_key_rotation::DisableKeyRotation::orchestrate(&runtime_plugins, input).await
    }
