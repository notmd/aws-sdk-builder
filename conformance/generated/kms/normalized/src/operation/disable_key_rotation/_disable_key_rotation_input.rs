...
impl DisableKeyRotationInput {
    ...
    pub fn builder() -> super::super::super::operation::disable_key_rotation::builders::DisableKeyRotationInputBuilder {
        super::super::super::operation::disable_key_rotation::builders::DisableKeyRotationInputBuilder::default()
    }
}
