...
impl ListKeys {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::list_keys::ListKeysInput,
    ) -> ::std::result::Result<
        super::super::operation::list_keys::ListKeysOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::list_keys::ListKeysError,
    ...
    > {
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::list_keys::ListKeysOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListKeysResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_list_keys::de_list_keys_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_list_keys::de_list_keys_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListKeysRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::list_keys::ListKeysInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_list_keys::ser_list_keys_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::list_keys::ListKeysError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::list_keys::_list_keys_input::ListKeysInput;

pub use super::super::operation::list_keys::_list_keys_output::ListKeysOutput;
