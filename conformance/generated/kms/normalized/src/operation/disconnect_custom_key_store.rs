...
impl DisconnectCustomKeyStore {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::disconnect_custom_key_store::DisconnectCustomKeyStoreInput,
    ) -> ::std::result::Result<
        super::super::operation::disconnect_custom_key_store::DisconnectCustomKeyStoreOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::disconnect_custom_key_store::DisconnectCustomKeyStoreError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::disconnect_custom_key_store::DisconnectCustomKeyStoreError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::disconnect_custom_key_store::DisconnectCustomKeyStoreOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisconnectCustomKeyStoreResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_disconnect_custom_key_store::de_disconnect_custom_key_store_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_disconnect_custom_key_store::de_disconnect_custom_key_store_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisconnectCustomKeyStoreRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::disconnect_custom_key_store::DisconnectCustomKeyStoreInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::disconnect_custom_key_store::DisconnectCustomKeyStoreInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_disconnect_custom_key_store::ser_disconnect_custom_key_store_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::super::operation::disconnect_custom_key_store::DisconnectCustomKeyStoreError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::disconnect_custom_key_store::_disconnect_custom_key_store_input::DisconnectCustomKeyStoreInput;

pub use super::super::operation::disconnect_custom_key_store::_disconnect_custom_key_store_output::DisconnectCustomKeyStoreOutput;
