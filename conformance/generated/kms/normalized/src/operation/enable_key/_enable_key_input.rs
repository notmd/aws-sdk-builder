...
impl EnableKeyInput {
    ...
    pub fn builder() -> super::super::super::operation::enable_key::builders::EnableKeyInputBuilder {
        super::super::super::operation::enable_key::builders::EnableKeyInputBuilder::default()
    }
}
