...
impl EnableKeyOutput {
    ...
    pub fn builder() -> super::super::super::operation::enable_key::builders::EnableKeyOutputBuilder {
        super::super::super::operation::enable_key::builders::EnableKeyOutputBuilder::default()
    }
}
...
impl EnableKeyOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::enable_key::EnableKeyOutput {
