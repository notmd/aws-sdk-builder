...
impl ListKeyPoliciesInput {
    ...
    pub fn builder() -> super::super::super::operation::list_key_policies::builders::ListKeyPoliciesInputBuilder {
        super::super::super::operation::list_key_policies::builders::ListKeyPoliciesInputBuilder::default()
    }
}
