...
pub struct ListKeyPoliciesPaginator {
    ...
    builder: super::super::super::operation::list_key_policies::builders::ListKeyPoliciesInputBuilder,
...
impl ListKeyPoliciesPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::list_key_policies::paginator::ListKeyPoliciesPaginatorItems {
        super::super::super::operation::list_key_policies::paginator::ListKeyPoliciesPaginatorItems(self)
    }
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_key_policies_output_output_next_marker(resp);
...
impl ListKeyPoliciesPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_list_key_policies_output_output_policy_names(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
