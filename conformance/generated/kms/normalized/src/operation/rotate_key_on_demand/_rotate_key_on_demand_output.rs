...
impl RotateKeyOnDemandOutput {
    ...
    pub fn builder() -> super::super::super::operation::rotate_key_on_demand::builders::RotateKeyOnDemandOutputBuilder {
        super::super::super::operation::rotate_key_on_demand::builders::RotateKeyOnDemandOutputBuilder::default()
    }
}
...
impl RotateKeyOnDemandOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::rotate_key_on_demand::RotateKeyOnDemandOutput {
