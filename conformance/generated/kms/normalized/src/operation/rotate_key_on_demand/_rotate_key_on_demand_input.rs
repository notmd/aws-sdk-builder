...
impl RotateKeyOnDemandInput {
    ...
    pub fn builder() -> super::super::super::operation::rotate_key_on_demand::builders::RotateKeyOnDemandInputBuilder {
        super::super::super::operation::rotate_key_on_demand::builders::RotateKeyOnDemandInputBuilder::default()
    }
}
