...
impl VerifyMacOutput {
    ...
    pub fn builder() -> super::super::super::operation::verify_mac::builders::VerifyMacOutputBuilder {
        super::super::super::operation::verify_mac::builders::VerifyMacOutputBuilder::default()
    }
}
...
impl VerifyMacOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::verify_mac::VerifyMacOutput {
