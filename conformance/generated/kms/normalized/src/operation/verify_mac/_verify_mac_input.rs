...
impl VerifyMacInput {
    ...
    pub fn builder() -> super::super::super::operation::verify_mac::builders::VerifyMacInputBuilder {
        super::super::super::operation::verify_mac::builders::VerifyMacInputBuilder::default()
    }
}
