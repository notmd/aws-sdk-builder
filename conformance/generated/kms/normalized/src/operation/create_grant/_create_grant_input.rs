...
impl CreateGrantInput {
    ...
    pub fn operations(&self) -> &[super::super::super::types::GrantOperation] {
    ...
    /// </ul>
    /// <p>For information about grant constraints, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/create-grant-overview.html#grant-constraints">Using grant constraints</a> in the <i>Key Management Service Developer Guide</i>.</p>
    pub fn constraints(&self) -> ::std::option::Option<&super::super::super::types::GrantConstraints> {
...
impl CreateGrantInput {
    ...
    pub fn builder() -> super::super::super::operation::create_grant::builders::CreateGrantInputBuilder {
        super::super::super::operation::create_grant::builders::CreateGrantInputBuilder::default()
    }
}
...
pub struct CreateGrantInputBuilder {
    ...
    pub(crate) operations: ::std::option::Option<::std::vec::Vec<super::super::super::types::GrantOperation>>,
    pub(crate) constraints: ::std::option::Option<super::super::super::types::GrantConstraints>,
