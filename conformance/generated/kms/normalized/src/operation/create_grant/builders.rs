...
pub use super::super::super::operation::create_grant::_create_grant_input::CreateGrantInputBuilder;

pub use super::super::super::operation::create_grant::_create_grant_output::CreateGrantOutputBuilder;

impl super::super::super::operation::create_grant::builders::CreateGrantInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::create_grant::CreateGrantOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::create_grant::CreateGrantError,
...
/// <p>However, to use the permissions in the grant immediately, use the <code>GrantToken</code> that <code>CreateGrant</code> returns. For details, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/using-grant-token.html">Using a grant token</a> in the <i> <i>Key Management Service Developer Guide</i> </i>.</p></li>
/// <li>
...
pub struct CreateGrantFluentBuilder {
    ...
    inner: super::super::super::operation::create_grant::builders::CreateGrantInputBuilder,
...
impl CreateGrantFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::create_grant::builders::CreateGrantInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::create_grant::CreateGrant::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::create_grant::CreateGrant::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn operations(mut self, input: super::super::super::types::GrantOperation) -> Self {
        self.inner = self.inner.operations(input);
        self
    }
    /// <p>A list of operations that the grant permits.</p>
    /// <p>This list must include only operations that are permitted in a grant. Also, the operation must be supported on the KMS key. For example, you cannot create a grant for a symmetric encryption KMS key that allows the <code>Sign</code> operation, or a grant for an asymmetric KMS key that allows the <code>GenerateDataKey</code> operation. If you try, KMS returns a <code>ValidationError</code> exception. For details, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/grants.html#terms-grant-operations">Grant operations</a> in the <i>Key Management Service Developer Guide</i>.</p>
    pub fn set_operations(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::GrantOperation>>) -> Self {
        self.inner = self.inner.set_operations(input);
        self
    }
    /// <p>A list of operations that the grant permits.</p>
    /// <p>This list must include only operations that are permitted in a grant. Also, the operation must be supported on the KMS key. For example, you cannot create a grant for a symmetric encryption KMS key that allows the <code>Sign</code> operation, or a grant for an asymmetric KMS key that allows the <code>GenerateDataKey</code> operation. If you try, KMS returns a <code>ValidationError</code> exception. For details, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/grants.html#terms-grant-operations">Grant operations</a> in the <i>Key Management Service Developer Guide</i>.</p>
    pub fn get_operations(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::GrantOperation>> {
    ...
    pub fn constraints(mut self, input: super::super::super::types::GrantConstraints) -> Self {
    ...
    /// </ul>
    /// <p>For information about grant constraints, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/create-grant-overview.html#grant-constraints">Using grant constraints</a> in the <i>Key Management Service Developer Guide</i>.</p>
    pub fn set_constraints(mut self, input: ::std::option::Option<super::super::super::types::GrantConstraints>) -> Self {
    ...
    /// </ul>
    /// <p>For information about grant constraints, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/create-grant-overview.html#grant-constraints">Using grant constraints</a> in the <i>Key Management Service Developer Guide</i>.</p>
    pub fn get_constraints(&self) -> &::std::option::Option<super::super::super::types::GrantConstraints> {
