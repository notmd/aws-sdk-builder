...
impl CreateGrantOutput {
    ...
    pub fn builder() -> super::super::super::operation::create_grant::builders::CreateGrantOutputBuilder {
        super::super::super::operation::create_grant::builders::CreateGrantOutputBuilder::default()
    }
}
...
impl CreateGrantOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::create_grant::CreateGrantOutput {
