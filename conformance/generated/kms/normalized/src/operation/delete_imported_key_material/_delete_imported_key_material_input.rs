...
impl DeleteImportedKeyMaterialInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_imported_key_material::builders::DeleteImportedKeyMaterialInputBuilder {
        super::super::super::operation::delete_imported_key_material::builders::DeleteImportedKeyMaterialInputBuilder::default()
    }
}
