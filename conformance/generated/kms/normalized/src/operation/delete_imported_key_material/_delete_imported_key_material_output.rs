...
impl DeleteImportedKeyMaterialOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_imported_key_material::builders::DeleteImportedKeyMaterialOutputBuilder {
        super::super::super::operation::delete_imported_key_material::builders::DeleteImportedKeyMaterialOutputBuilder::default()
    }
}
...
impl DeleteImportedKeyMaterialOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_imported_key_material::DeleteImportedKeyMaterialOutput {
