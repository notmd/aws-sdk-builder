...
impl RotateKeyOnDemand {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::rotate_key_on_demand::RotateKeyOnDemandError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::rotate_key_on_demand::RotateKeyOnDemandOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("KMS", "RotateKeyOnDemand", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RotateKeyOnDemandResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_rotate_key_on_demand::de_rotate_key_on_demand_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_rotate_key_on_demand::de_rotate_key_on_demand_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RotateKeyOnDemandRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::rotate_key_on_demand::RotateKeyOnDemandInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::rotate_key_on_demand::RotateKeyOnDemandInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::rotate_key_on_demand::RotateKeyOnDemandError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::rotate_key_on_demand::_rotate_key_on_demand_input::RotateKeyOnDemandInput;

pub use super::super::operation::rotate_key_on_demand::_rotate_key_on_demand_output::RotateKeyOnDemandOutput;
