...
impl ListGrants {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::super::operation::list_grants::ListGrantsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::list_grants::ListGrantsError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::list_grants::ListGrantsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::list_grants::ListGrantsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("KMS", "ListGrants", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListGrants {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListGrantsResponseDeserializer,
        ));
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListGrantsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_list_grants::de_list_grants_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_list_grants::de_list_grants_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListGrantsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::super::operation::list_grants::ListGrantsInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::list_grants::ListGrantsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_list_grants::ser_list_grants_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::list_grants::ListGrantsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::list_grants::_list_grants_input::ListGrantsInput;

pub use super::super::operation::list_grants::_list_grants_output::ListGrantsOutput;
