...
impl VerifyOutput {
    ...
    pub fn builder() -> super::super::super::operation::verify::builders::VerifyOutputBuilder {
        super::super::super::operation::verify::builders::VerifyOutputBuilder::default()
    }
}
...
impl VerifyOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::verify::VerifyOutput {
