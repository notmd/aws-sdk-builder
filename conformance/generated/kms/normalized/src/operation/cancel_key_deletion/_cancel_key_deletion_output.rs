...
impl CancelKeyDeletionOutput {
    ...
    pub fn builder() -> super::super::super::operation::cancel_key_deletion::builders::CancelKeyDeletionOutputBuilder {
        super::super::super::operation::cancel_key_deletion::builders::CancelKeyDeletionOutputBuilder::default()
    }
}
...
impl CancelKeyDeletionOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::cancel_key_deletion::CancelKeyDeletionOutput {
