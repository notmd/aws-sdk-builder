...
impl CancelKeyDeletionInput {
    ...
    pub fn builder() -> super::super::super::operation::cancel_key_deletion::builders::CancelKeyDeletionInputBuilder {
        super::super::super::operation::cancel_key_deletion::builders::CancelKeyDeletionInputBuilder::default()
    }
}
