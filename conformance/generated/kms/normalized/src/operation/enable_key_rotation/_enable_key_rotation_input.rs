...
impl EnableKeyRotationInput {
    ...
    pub fn builder() -> super::super::super::operation::enable_key_rotation::builders::EnableKeyRotationInputBuilder {
        super::super::super::operation::enable_key_rotation::builders::EnableKeyRotationInputBuilder::default()
    }
}
