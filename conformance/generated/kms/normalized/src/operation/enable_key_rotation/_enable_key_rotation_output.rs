...
impl EnableKeyRotationOutput {
    ...
    pub fn builder() -> super::super::super::operation::enable_key_rotation::builders::EnableKeyRotationOutputBuilder {
        super::super::super::operation::enable_key_rotation::builders::EnableKeyRotationOutputBuilder::default()
    }
}
...
impl EnableKeyRotationOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::enable_key_rotation::EnableKeyRotationOutput {
