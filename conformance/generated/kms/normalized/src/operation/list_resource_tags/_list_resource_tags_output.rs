...
impl ListResourceTagsOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_resource_tags::builders::ListResourceTagsOutputBuilder {
        super::super::super::operation::list_resource_tags::builders::ListResourceTagsOutputBuilder::default()
    }
}
...
impl ListResourceTagsOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::list_resource_tags::ListResourceTagsOutput {
