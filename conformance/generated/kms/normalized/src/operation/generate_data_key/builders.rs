...
pub use super::super::super::operation::generate_data_key::_generate_data_key_input::GenerateDataKeyInputBuilder;

pub use super::super::super::operation::generate_data_key::_generate_data_key_output::GenerateDataKeyOutputBuilder;

impl super::super::super::operation::generate_data_key::builders::GenerateDataKeyInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::generate_data_key::GenerateDataKeyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::generate_data_key::GenerateDataKeyError,
...
pub struct GenerateDataKeyFluentBuilder {
    ...
    inner: super::super::super::operation::generate_data_key::builders::GenerateDataKeyInputBuilder,
...
impl GenerateDataKeyFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::generate_data_key::builders::GenerateDataKeyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::generate_data_key::GenerateDataKey::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::generate_data_key::GenerateDataKey::orchestrate(&runtime_plugins, input).await
    }
    ...
    /// <p>You must specify either the <code>KeySpec</code> or the <code>NumberOfBytes</code> parameter (but not both) in every <code>GenerateDataKey</code> request.</p>
    pub fn key_spec(mut self, input: super::super::super::types::DataKeySpec) -> Self {
        self.inner = self.inner.key_spec(input);
        self
    }
    /// <p>Specifies the length of the data key. Use <code>AES_128</code> to generate a 128-bit symmetric key, or <code>AES_256</code> to generate a 256-bit symmetric key.</p>
    /// <p>You must specify either the <code>KeySpec</code> or the <code>NumberOfBytes</code> parameter (but not both) in every <code>GenerateDataKey</code> request.</p>
    pub fn set_key_spec(mut self, input: ::std::option::Option<super::super::super::types::DataKeySpec>) -> Self {
        self.inner = self.inner.set_key_spec(input);
        self
    }
    /// <p>Specifies the length of the data key. Use <code>AES_128</code> to generate a 128-bit symmetric key, or <code>AES_256</code> to generate a 256-bit symmetric key.</p>
    /// <p>You must specify either the <code>KeySpec</code> or the <code>NumberOfBytes</code> parameter (but not both) in every <code>GenerateDataKey</code> request.</p>
    pub fn get_key_spec(&self) -> &::std::option::Option<super::super::super::types::DataKeySpec> {
