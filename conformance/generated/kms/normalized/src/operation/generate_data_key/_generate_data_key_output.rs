...
impl GenerateDataKeyOutput {
    ...
    pub fn builder() -> super::super::super::operation::generate_data_key::builders::GenerateDataKeyOutputBuilder {
        super::super::super::operation::generate_data_key::builders::GenerateDataKeyOutputBuilder::default()
    }
}
...
impl GenerateDataKeyOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::generate_data_key::GenerateDataKeyOutput {
