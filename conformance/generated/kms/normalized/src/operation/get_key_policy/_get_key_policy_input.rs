...
impl GetKeyPolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::get_key_policy::builders::GetKeyPolicyInputBuilder {
        super::super::super::operation::get_key_policy::builders::GetKeyPolicyInputBuilder::default()
    }
}
...
impl GetKeyPolicyInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::get_key_policy::GetKeyPolicyInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::get_key_policy::GetKeyPolicyInput {
            key_id: self.key_id,
