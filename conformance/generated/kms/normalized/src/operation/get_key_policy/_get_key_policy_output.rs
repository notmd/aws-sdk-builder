...
impl GetKeyPolicyOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_key_policy::builders::GetKeyPolicyOutputBuilder {
        super::super::super::operation::get_key_policy::builders::GetKeyPolicyOutputBuilder::default()
    }
}
...
impl GetKeyPolicyOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::get_key_policy::GetKeyPolicyOutput {
