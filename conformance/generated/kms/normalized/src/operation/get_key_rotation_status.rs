...
impl GetKeyRotationStatus {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::get_key_rotation_status::GetKeyRotationStatusInput,
    ) -> ::std::result::Result<
        super::super::operation::get_key_rotation_status::GetKeyRotationStatusOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::get_key_rotation_status::GetKeyRotationStatusError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::get_key_rotation_status::GetKeyRotationStatusError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::get_key_rotation_status::GetKeyRotationStatusOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("KMS", "GetKeyRotationStatus", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetKeyRotationStatusTelemetryInputCaptureInterceptor {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetKeyRotationStatusResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_get_key_rotation_status::de_get_key_rotation_status_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_get_key_rotation_status::de_get_key_rotation_status_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetKeyRotationStatusRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::get_key_rotation_status::GetKeyRotationStatusInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::get_key_rotation_status::GetKeyRotationStatusInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::get_key_rotation_status::GetKeyRotationStatusError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::get_key_rotation_status::_get_key_rotation_status_input::GetKeyRotationStatusInput;

pub use super::super::operation::get_key_rotation_status::_get_key_rotation_status_output::GetKeyRotationStatusOutput;
