...
impl ScheduleKeyDeletionInput {
    ...
    pub fn builder() -> super::super::super::operation::schedule_key_deletion::builders::ScheduleKeyDeletionInputBuilder {
        super::super::super::operation::schedule_key_deletion::builders::ScheduleKeyDeletionInputBuilder::default()
    }
}
