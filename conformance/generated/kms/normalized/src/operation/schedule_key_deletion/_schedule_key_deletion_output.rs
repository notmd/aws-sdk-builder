...
impl ScheduleKeyDeletionOutput {
    ...
    /// <p>The current status of the KMS key.</p>
    /// <p>For more information about how key state affects the use of a KMS key, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html">Key states of KMS keys</a> in the <i>Key Management Service Developer Guide</i>.</p>
    pub fn key_state(&self) -> ::std::option::Option<&super::super::super::types::KeyState> {
...
impl ScheduleKeyDeletionOutput {
    ...
    pub fn builder() -> super::super::super::operation::schedule_key_deletion::builders::ScheduleKeyDeletionOutputBuilder {
        super::super::super::operation::schedule_key_deletion::builders::ScheduleKeyDeletionOutputBuilder::default()
    }
}
...
pub struct ScheduleKeyDeletionOutputBuilder {
    ...
    pub(crate) key_state: ::std::option::Option<super::super::super::types::KeyState>,
...
impl ScheduleKeyDeletionOutputBuilder {
    ...
    /// <p>The current status of the KMS key.</p>
    /// <p>For more information about how key state affects the use of a KMS key, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html">Key states of KMS keys</a> in the <i>Key Management Service Developer Guide</i>.</p>
    pub fn key_state(mut self, input: super::super::super::types::KeyState) -> Self {
        self.key_state = ::std::option::Option::Some(input);
        self
    }
    /// <p>The current status of the KMS key.</p>
    /// <p>For more information about how key state affects the use of a KMS key, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html">Key states of KMS keys</a> in the <i>Key Management Service Developer Guide</i>.</p>
    pub fn set_key_state(mut self, input: ::std::option::Option<super::super::super::types::KeyState>) -> Self {
        self.key_state = input;
        self
    }
    /// <p>The current status of the KMS key.</p>
    /// <p>For more information about how key state affects the use of a KMS key, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html">Key states of KMS keys</a> in the <i>Key Management Service Developer Guide</i>.</p>
    pub fn get_key_state(&self) -> &::std::option::Option<super::super::super::types::KeyState> {
        &self.key_state
    }
    /// <p>The waiting period before the KMS key is deleted.</p>
    /// <p>If the KMS key is a multi-Region primary key with replicas, the waiting period begins when the last of its replica keys is deleted. Otherwise, the waiting period begins immediately.</p>
    ...
    pub fn build(self) -> super::super::super::operation::schedule_key_deletion::ScheduleKeyDeletionOutput {
