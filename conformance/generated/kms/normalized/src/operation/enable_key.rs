...
impl EnableKey {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::enable_key::EnableKeyInput,
    ) -> ::std::result::Result<
        super::super::operation::enable_key::EnableKeyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::enable_key::EnableKeyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::enable_key::EnableKeyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::enable_key::EnableKeyOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("KMS", "EnableKey", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for EnableKeyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_enable_key::de_enable_key_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_enable_key::de_enable_key_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for EnableKeyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::super::operation::enable_key::EnableKeyInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::enable_key::EnableKeyInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_enable_key::ser_enable_key_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::enable_key::EnableKeyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::enable_key::_enable_key_input::EnableKeyInput;

pub use super::super::operation::enable_key::_enable_key_output::EnableKeyOutput;
