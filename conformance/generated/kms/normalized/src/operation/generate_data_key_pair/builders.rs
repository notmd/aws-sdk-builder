...
pub use super::super::super::operation::generate_data_key_pair::_generate_data_key_pair_input::GenerateDataKeyPairInputBuilder;

pub use super::super::super::operation::generate_data_key_pair::_generate_data_key_pair_output::GenerateDataKeyPairOutputBuilder;

impl super::super::super::operation::generate_data_key_pair::builders::GenerateDataKeyPairInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::generate_data_key_pair::GenerateDataKeyPairOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::generate_data_key_pair::GenerateDataKeyPairError,
...
pub struct GenerateDataKeyPairFluentBuilder {
    ...
    inner: super::super::super::operation::generate_data_key_pair::builders::GenerateDataKeyPairInputBuilder,
...
impl GenerateDataKeyPairFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::generate_data_key_pair::builders::GenerateDataKeyPairInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::generate_data_key_pair::GenerateDataKeyPair::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::generate_data_key_pair::GenerateDataKeyPair::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn key_pair_spec(mut self, input: super::super::super::types::DataKeyPairSpec) -> Self {
        self.inner = self.inner.key_pair_spec(input);
        self
    }
    /// <p>Determines the type of data key pair that is generated.</p>
    /// <p>The KMS rule that restricts the use of asymmetric RSA and SM2 KMS keys to encrypt and decrypt or to sign and verify (but not both), the rule that permits you to use ECC KMS keys only to sign and verify, and the rule that permits you to use ML-DSA key pairs to sign and verify only are not effective on data key pairs, which are used outside of KMS. The SM2 key spec is only available in China Regions.</p>
    pub fn set_key_pair_spec(mut self, input: ::std::option::Option<super::super::super::types::DataKeyPairSpec>) -> Self {
        self.inner = self.inner.set_key_pair_spec(input);
        self
    }
    /// <p>Determines the type of data key pair that is generated.</p>
    /// <p>The KMS rule that restricts the use of asymmetric RSA and SM2 KMS keys to encrypt and decrypt or to sign and verify (but not both), the rule that permits you to use ECC KMS keys only to sign and verify, and the rule that permits you to use ML-DSA key pairs to sign and verify only are not effective on data key pairs, which are used outside of KMS. The SM2 key spec is only available in China Regions.</p>
    pub fn get_key_pair_spec(&self) -> &::std::option::Option<super::super::super::types::DataKeyPairSpec> {
