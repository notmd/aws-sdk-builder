...
impl Verify {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::verify::VerifyInput,
    ) -> ::std::result::Result<
        super::super::operation::verify::VerifyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::verify::VerifyError,
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("KMS", "Verify", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for VerifyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_verify::de_verify_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_verify::de_verify_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for VerifyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::super::operation::verify::VerifyInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::verify::VerifyInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_verify::ser_verify_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for VerifyEndpointParamsInterceptor {
    ...
    fn read_before_execution(
        ...
        let _input = context.input().downcast_ref::<VerifyInput>().ok_or("failed to downcast to VerifyInput")?;
...
pub enum VerifyError {
    ...
    KmsInvalidSignatureException(super::super::types::error::KmsInvalidSignatureException),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for VerifyError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::KmsInvalidSignatureException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
...
impl ::aws_types::request_id::RequestId for super::super::operation::verify::VerifyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::verify::_verify_input::VerifyInput;

pub use super::super::operation::verify::_verify_output::VerifyOutput;
