...
impl GetKeyRotationStatusOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_key_rotation_status::builders::GetKeyRotationStatusOutputBuilder {
        super::super::super::operation::get_key_rotation_status::builders::GetKeyRotationStatusOutputBuilder::default()
    }
}
...
impl GetKeyRotationStatusOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::get_key_rotation_status::GetKeyRotationStatusOutput {
