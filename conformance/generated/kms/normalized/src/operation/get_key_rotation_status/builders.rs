...
pub use super::super::super::operation::get_key_rotation_status::_get_key_rotation_status_input::GetKeyRotationStatusInputBuilder;

pub use super::super::super::operation::get_key_rotation_status::_get_key_rotation_status_output::GetKeyRotationStatusOutputBuilder;

impl super::super::super::operation::get_key_rotation_status::builders::GetKeyRotationStatusInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::get_key_rotation_status::GetKeyRotationStatusOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::get_key_rotation_status::GetKeyRotationStatusError,
...
/// <p>You can enable (<code>EnableKeyRotation</code>) and disable automatic rotation (<code>DisableKeyRotation</code>) of the key material in customer managed KMS keys. Key material rotation of <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#aws-managed-key">Amazon Web Services managed KMS keys</a> is not configurable. KMS always rotates the key material in Amazon Web Services managed KMS keys every year. The key rotation status for Amazon Web Services managed KMS keys is always <code>true</code>.</p>
...
pub struct GetKeyRotationStatusFluentBuilder {
    ...
    inner: super::super::super::operation::get_key_rotation_status::builders::GetKeyRotationStatusInputBuilder,
...
impl GetKeyRotationStatusFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::get_key_rotation_status::builders::GetKeyRotationStatusInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::get_key_rotation_status::GetKeyRotationStatus::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::get_key_rotation_status::GetKeyRotationStatus::orchestrate(&runtime_plugins, input).await
    }
