...
impl ImportKeyMaterial {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::import_key_material::ImportKeyMaterialError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::import_key_material::ImportKeyMaterialOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("KMS", "ImportKeyMaterial", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ImportKeyMaterialResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_import_key_material::de_import_key_material_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_import_key_material::de_import_key_material_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ImportKeyMaterialRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::import_key_material::ImportKeyMaterialInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::import_key_material::ImportKeyMaterialInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::import_key_material::ImportKeyMaterialError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::import_key_material::_import_key_material_input::ImportKeyMaterialInput;

pub use super::super::operation::import_key_material::_import_key_material_output::ImportKeyMaterialOutput;
