...
pub use super::super::super::operation::connect_custom_key_store::_connect_custom_key_store_input::ConnectCustomKeyStoreInputBuilder;

pub use super::super::super::operation::connect_custom_key_store::_connect_custom_key_store_output::ConnectCustomKeyStoreOutputBuilder;

impl super::super::super::operation::connect_custom_key_store::builders::ConnectCustomKeyStoreInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::connect_custom_key_store::ConnectCustomKeyStoreOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::connect_custom_key_store::ConnectCustomKeyStoreError,
...
pub struct ConnectCustomKeyStoreFluentBuilder {
    ...
    inner: super::super::super::operation::connect_custom_key_store::builders::ConnectCustomKeyStoreInputBuilder,
...
impl ConnectCustomKeyStoreFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::connect_custom_key_store::builders::ConnectCustomKeyStoreInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::connect_custom_key_store::ConnectCustomKeyStore::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::connect_custom_key_store::ConnectCustomKeyStore::orchestrate(&runtime_plugins, input).await
    }
