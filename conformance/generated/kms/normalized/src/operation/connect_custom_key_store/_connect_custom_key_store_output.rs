...
impl ConnectCustomKeyStoreOutput {
    ...
    pub fn builder() -> super::super::super::operation::connect_custom_key_store::builders::ConnectCustomKeyStoreOutputBuilder {
        super::super::super::operation::connect_custom_key_store::builders::ConnectCustomKeyStoreOutputBuilder::default()
    }
}
...
impl ConnectCustomKeyStoreOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::connect_custom_key_store::ConnectCustomKeyStoreOutput {
