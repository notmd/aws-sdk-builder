...
impl ConnectCustomKeyStoreInput {
    ...
    pub fn builder() -> super::super::super::operation::connect_custom_key_store::builders::ConnectCustomKeyStoreInputBuilder {
        super::super::super::operation::connect_custom_key_store::builders::ConnectCustomKeyStoreInputBuilder::default()
    }
}
