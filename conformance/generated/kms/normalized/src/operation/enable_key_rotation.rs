...
impl EnableKeyRotation {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::enable_key_rotation::EnableKeyRotationInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::enable_key_rotation::EnableKeyRotationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::enable_key_rotation::EnableKeyRotationOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for EnableKeyRotationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_enable_key_rotation::de_enable_key_rotation_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_enable_key_rotation::de_enable_key_rotation_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for EnableKeyRotationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::enable_key_rotation::EnableKeyRotationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::enable_key_rotation::EnableKeyRotationInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::enable_key_rotation::EnableKeyRotationError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::enable_key_rotation::_enable_key_rotation_input::EnableKeyRotationInput;

pub use super::super::operation::enable_key_rotation::_enable_key_rotation_output::EnableKeyRotationOutput;
