...
impl PutKeyPolicyInput {
    ...
    pub fn builder() -> super::super::super::operation::put_key_policy::builders::PutKeyPolicyInputBuilder {
        super::super::super::operation::put_key_policy::builders::PutKeyPolicyInputBuilder::default()
    }
}
