...
impl PutKeyPolicyOutput {
    ...
    pub fn builder() -> super::super::super::operation::put_key_policy::builders::PutKeyPolicyOutputBuilder {
        super::super::super::operation::put_key_policy::builders::PutKeyPolicyOutputBuilder::default()
    }
}
...
impl PutKeyPolicyOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::put_key_policy::PutKeyPolicyOutput {
