...
impl DescribeKeyInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_key::builders::DescribeKeyInputBuilder {
        super::super::super::operation::describe_key::builders::DescribeKeyInputBuilder::default()
    }
}
