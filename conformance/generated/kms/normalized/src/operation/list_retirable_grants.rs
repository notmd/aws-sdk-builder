    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::list_retirable_grants::ListRetirableGrantsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::list_retirable_grants::ListRetirableGrantsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListRetirableGrantsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_list_retirable_grants::de_list_retirable_grants_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_list_retirable_grants::de_list_retirable_grants_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListRetirableGrantsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::list_retirable_grants::ListRetirableGrantsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::list_retirable_grants::ListRetirableGrantsInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::list_retirable_grants::ListRetirableGrantsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::list_retirable_grants::_list_retirable_grants_input::ListRetirableGrantsInput;

pub use super::super::operation::list_retirable_grants::_list_retirable_grants_output::ListRetirableGrantsOutput;
