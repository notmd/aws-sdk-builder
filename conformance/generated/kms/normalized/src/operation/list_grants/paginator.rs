...
pub struct ListGrantsPaginator {
    ...
    builder: super::super::super::operation::list_grants::builders::ListGrantsInputBuilder,
...
impl ListGrantsPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::list_grants::paginator::ListGrantsPaginatorItems {
        super::super::super::operation::list_grants::paginator::ListGrantsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::super::super::operation::list_grants::ListGrants::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_grants_output_output_next_marker(resp);
