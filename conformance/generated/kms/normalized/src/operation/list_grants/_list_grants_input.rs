...
impl ListGrantsInput {
    ...
    pub fn builder() -> super::super::super::operation::list_grants::builders::ListGrantsInputBuilder {
        super::super::super::operation::list_grants::builders::ListGrantsInputBuilder::default()
    }
}
