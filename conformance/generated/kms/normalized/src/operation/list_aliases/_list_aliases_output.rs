...
impl ListAliasesOutput {
    ...
    pub fn aliases(&self) -> &[super::super::super::types::AliasListEntry] {
...
pub struct ListAliasesOutputBuilder {
    pub(crate) aliases: ::std::option::Option<::std::vec::Vec<super::super::super::types::AliasListEntry>>,
...
impl ListAliasesOutputBuilder {
    ...
    ///
    /// <p>A list of aliases.</p>
    pub fn aliases(mut self, input: super::super::super::types::AliasListEntry) -> Self {
    ...
    /// <p>A list of aliases.</p>
    pub fn set_aliases(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::AliasListEntry>>) -> Self {
        self.aliases = input;
        self
    }
    /// <p>A list of aliases.</p>
    pub fn get_aliases(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::AliasListEntry>> {
        &self.aliases
    }
    /// <p>When <code>Truncated</code> is true, this element is present and contains the value to use for the <code>Marker</code> parameter in a subsequent request.</p>
