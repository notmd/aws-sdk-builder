...
pub use super::super::super::operation::import_key_material::_import_key_material_input::ImportKeyMaterialInputBuilder;

pub use super::super::super::operation::import_key_material::_import_key_material_output::ImportKeyMaterialOutputBuilder;

impl super::super::super::operation::import_key_material::builders::ImportKeyMaterialInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::import_key_material::ImportKeyMaterialOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::import_key_material::ImportKeyMaterialError,
...
pub struct ImportKeyMaterialFluentBuilder {
    ...
    inner: super::super::super::operation::import_key_material::builders::ImportKeyMaterialInputBuilder,
...
impl ImportKeyMaterialFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::import_key_material::builders::ImportKeyMaterialInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::import_key_material::ImportKeyMaterial::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::import_key_material::ImportKeyMaterial::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn expiration_model(mut self, input: super::super::super::types::ExpirationModelType) -> Self {
    ...
    /// <p>When the value of <code>ExpirationModel</code> is <code>KEY_MATERIAL_EXPIRES</code>, you must specify a value for the <code>ValidTo</code> parameter. When value is <code>KEY_MATERIAL_DOES_NOT_EXPIRE</code>, you must omit the <code>ValidTo</code> parameter.</p>
    /// <p>You cannot change the <code>ExpirationModel</code> or <code>ValidTo</code> values for the current import after the request completes. To change either value, you must reimport the key material.</p>
    pub fn set_expiration_model(mut self, input: ::std::option::Option<super::super::super::types::ExpirationModelType>) -> Self {
    ...
    /// <p>When the value of <code>ExpirationModel</code> is <code>KEY_MATERIAL_EXPIRES</code>, you must specify a value for the <code>ValidTo</code> parameter. When value is <code>KEY_MATERIAL_DOES_NOT_EXPIRE</code>, you must omit the <code>ValidTo</code> parameter.</p>
    /// <p>You cannot change the <code>ExpirationModel</code> or <code>ValidTo</code> values for the current import after the request completes. To change either value, you must reimport the key material.</p>
    pub fn get_expiration_model(&self) -> &::std::option::Option<super::super::super::types::ExpirationModelType> {
    ...
    pub fn import_type(mut self, input: super::super::super::types::ImportType) -> Self {
        self.inner = self.inner.import_type(input);
        self
    }
    /// <p>Indicates whether the key material being imported is previously associated with this KMS key or not. This parameter is optional and only usable with symmetric encryption keys. If no key material has ever been imported into the KMS key, and this parameter is omitted, the parameter defaults to <code>NEW_KEY_MATERIAL</code>. After the first key material is imported, if this parameter is omitted then the parameter defaults to <code>EXISTING_KEY_MATERIAL</code>.</p>
    /// <p>For multi-Region keys, you must first import new key material into the primary Region key. You should use the <code>NEW_KEY_MATERIAL</code> import type when importing key material into the primary Region key. Then, you can import the same key material into the replica Region key. The import type for the replica Region key should be <code>EXISTING_KEY_MATERIAL</code>.</p>
    pub fn set_import_type(mut self, input: ::std::option::Option<super::super::super::types::ImportType>) -> Self {
        self.inner = self.inner.set_import_type(input);
        self
    }
    /// <p>Indicates whether the key material being imported is previously associated with this KMS key or not. This parameter is optional and only usable with symmetric encryption keys. If no key material has ever been imported into the KMS key, and this parameter is omitted, the parameter defaults to <code>NEW_KEY_MATERIAL</code>. After the first key material is imported, if this parameter is omitted then the parameter defaults to <code>EXISTING_KEY_MATERIAL</code>.</p>
    /// <p>For multi-Region keys, you must first import new key material into the primary Region key. You should use the <code>NEW_KEY_MATERIAL</code> import type when importing key material into the primary Region key. Then, you can import the same key material into the replica Region key. The import type for the replica Region key should be <code>EXISTING_KEY_MATERIAL</code>.</p>
    pub fn get_import_type(&self) -> &::std::option::Option<super::super::super::types::ImportType> {
