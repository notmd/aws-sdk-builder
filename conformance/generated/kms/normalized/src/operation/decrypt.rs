...
impl Decrypt {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::super::operation::decrypt::DecryptOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::decrypt::DecryptError,
    ...
    > {
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::decrypt::DecryptOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("KMS", "Decrypt", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DecryptResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_decrypt::de_decrypt_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_decrypt::de_decrypt_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DecryptRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::super::operation::decrypt::DecryptInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::decrypt::DecryptInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_decrypt::ser_decrypt_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::decrypt::DecryptError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::decrypt::_decrypt_input::DecryptInput;

pub use super::super::operation::decrypt::_decrypt_output::DecryptOutput;
