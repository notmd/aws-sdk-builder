...
impl GetPublicKeyInput {
    ...
    pub fn builder() -> super::super::super::operation::get_public_key::builders::GetPublicKeyInputBuilder {
        super::super::super::operation::get_public_key::builders::GetPublicKeyInputBuilder::default()
    }
}
...
impl GetPublicKeyInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::get_public_key::GetPublicKeyInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::get_public_key::GetPublicKeyInput {
            key_id: self.key_id,
