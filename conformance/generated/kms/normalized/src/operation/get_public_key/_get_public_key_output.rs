...
impl GetPublicKeyOutput {
    ...
    /// <p>The <code>KeySpec</code> and <code>CustomerMasterKeySpec</code> fields have the same value. We recommend that you use the <code>KeySpec</code> field in your code. However, to avoid breaking changes, KMS supports both fields.</p>
    #[deprecated(note = "This field has been deprecated. Instead, use the KeySpec field.")]
    pub fn customer_master_key_spec(&self) -> ::std::option::Option<&super::super::super::types::CustomerMasterKeySpec> {
        self.customer_master_key_spec.as_ref()
    }
    /// <p>The type of the of the public key that was downloaded.</p>
    pub fn key_spec(&self) -> ::std::option::Option<&super::super::super::types::KeySpec> {
        self.key_spec.as_ref()
    }
    /// <p>The permitted use of the public key. Valid values for asymmetric key pairs are <code>ENCRYPT_DECRYPT</code>, <code>SIGN_VERIFY</code>, and <code>KEY_AGREEMENT</code>.</p>
    /// <p>This information is critical. For example, if a public key with <code>SIGN_VERIFY</code> key usage encrypts data outside of KMS, the ciphertext cannot be decrypted.</p>
    pub fn key_usage(&self) -> ::std::option::Option<&super::super::super::types::KeyUsageType> {
    ...
    pub fn encryption_algorithms(&self) -> &[super::super::super::types::EncryptionAlgorithmSpec] {
    ...
    pub fn signing_algorithms(&self) -> &[super::super::super::types::SigningAlgorithmSpec] {
    ...
    pub fn key_agreement_algorithms(&self) -> &[super::super::super::types::KeyAgreementAlgorithmSpec] {
...
impl GetPublicKeyOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_public_key::builders::GetPublicKeyOutputBuilder {
        super::super::super::operation::get_public_key::builders::GetPublicKeyOutputBuilder::default()
    }
}
...
pub struct GetPublicKeyOutputBuilder {
    ...
    pub(crate) customer_master_key_spec: ::std::option::Option<super::super::super::types::CustomerMasterKeySpec>,
    pub(crate) key_spec: ::std::option::Option<super::super::super::types::KeySpec>,
    pub(crate) key_usage: ::std::option::Option<super::super::super::types::KeyUsageType>,
    pub(crate) encryption_algorithms: ::std::option::Option<::std::vec::Vec<super::super::super::types::EncryptionAlgorithmSpec>>,
    pub(crate) signing_algorithms: ::std::option::Option<::std::vec::Vec<super::super::super::types::SigningAlgorithmSpec>>,
    pub(crate) key_agreement_algorithms: ::std::option::Option<::std::vec::Vec<super::super::super::types::KeyAgreementAlgorithmSpec>>,
    _request_id: Option<String>,
}
impl GetPublicKeyOutputBuilder {
    ...
    /// <p>The <code>KeySpec</code> and <code>CustomerMasterKeySpec</code> fields have the same value. We recommend that you use the <code>KeySpec</code> field in your code. However, to avoid breaking changes, KMS supports both fields.</p>
    #[deprecated(note = "This field has been deprecated. Instead, use the KeySpec field.")]
    pub fn customer_master_key_spec(mut self, input: super::super::super::types::CustomerMasterKeySpec) -> Self {
    ...
    /// <p>The <code>KeySpec</code> and <code>CustomerMasterKeySpec</code> fields have the same value. We recommend that you use the <code>KeySpec</code> field in your code. However, to avoid breaking changes, KMS supports both fields.</p>
    #[deprecated(note = "This field has been deprecated. Instead, use the KeySpec field.")]
    pub fn set_customer_master_key_spec(mut self, input: ::std::option::Option<super::super::super::types::CustomerMasterKeySpec>) -> Self {
    ...
    /// <p>The <code>KeySpec</code> and <code>CustomerMasterKeySpec</code> fields have the same value. We recommend that you use the <code>KeySpec</code> field in your code. However, to avoid breaking changes, KMS supports both fields.</p>
    #[deprecated(note = "This field has been deprecated. Instead, use the KeySpec field.")]
    pub fn get_customer_master_key_spec(&self) -> &::std::option::Option<super::super::super::types::CustomerMasterKeySpec> {
        &self.customer_master_key_spec
    }
    /// <p>The type of the of the public key that was downloaded.</p>
    pub fn key_spec(mut self, input: super::super::super::types::KeySpec) -> Self {
        self.key_spec = ::std::option::Option::Some(input);
        self
    }
    /// <p>The type of the of the public key that was downloaded.</p>
    pub fn set_key_spec(mut self, input: ::std::option::Option<super::super::super::types::KeySpec>) -> Self {
        self.key_spec = input;
        self
    }
    /// <p>The type of the of the public key that was downloaded.</p>
    pub fn get_key_spec(&self) -> &::std::option::Option<super::super::super::types::KeySpec> {
        &self.key_spec
    }
    /// <p>The permitted use of the public key. Valid values for asymmetric key pairs are <code>ENCRYPT_DECRYPT</code>, <code>SIGN_VERIFY</code>, and <code>KEY_AGREEMENT</code>.</p>
    /// <p>This information is critical. For example, if a public key with <code>SIGN_VERIFY</code> key usage encrypts data outside of KMS, the ciphertext cannot be decrypted.</p>
    pub fn key_usage(mut self, input: super::super::super::types::KeyUsageType) -> Self {
        self.key_usage = ::std::option::Option::Some(input);
        self
    }
    /// <p>The permitted use of the public key. Valid values for asymmetric key pairs are <code>ENCRYPT_DECRYPT</code>, <code>SIGN_VERIFY</code>, and <code>KEY_AGREEMENT</code>.</p>
    /// <p>This information is critical. For example, if a public key with <code>SIGN_VERIFY</code> key usage encrypts data outside of KMS, the ciphertext cannot be decrypted.</p>
    pub fn set_key_usage(mut self, input: ::std::option::Option<super::super::super::types::KeyUsageType>) -> Self {
        self.key_usage = input;
        self
    }
    /// <p>The permitted use of the public key. Valid values for asymmetric key pairs are <code>ENCRYPT_DECRYPT</code>, <code>SIGN_VERIFY</code>, and <code>KEY_AGREEMENT</code>.</p>
    /// <p>This information is critical. For example, if a public key with <code>SIGN_VERIFY</code> key usage encrypts data outside of KMS, the ciphertext cannot be decrypted.</p>
    pub fn get_key_usage(&self) -> &::std::option::Option<super::super::super::types::KeyUsageType> {
        &self.key_usage
    }
    ...
    /// <p>This information is critical. If a public key encrypts data outside of KMS by using an unsupported encryption algorithm, the ciphertext cannot be decrypted.</p>
    /// <p>This field appears in the response only when the <code>KeyUsage</code> of the public key is <code>ENCRYPT_DECRYPT</code>.</p>
    pub fn encryption_algorithms(mut self, input: super::super::super::types::EncryptionAlgorithmSpec) -> Self {
    ...
    /// <p>This information is critical. If a public key encrypts data outside of KMS by using an unsupported encryption algorithm, the ciphertext cannot be decrypted.</p>
    /// <p>This field appears in the response only when the <code>KeyUsage</code> of the public key is <code>ENCRYPT_DECRYPT</code>.</p>
    pub fn get_encryption_algorithms(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::EncryptionAlgorithmSpec>> {
    ...
    /// <p>The signing algorithms that KMS supports for this key.</p>
    /// <p>This field appears in the response only when the <code>KeyUsage</code> of the public key is <code>SIGN_VERIFY</code>.</p>
    pub fn signing_algorithms(mut self, input: super::super::super::types::SigningAlgorithmSpec) -> Self {
    ...
    /// <p>The signing algorithms that KMS supports for this key.</p>
    /// <p>This field appears in the response only when the <code>KeyUsage</code> of the public key is <code>SIGN_VERIFY</code>.</p>
    pub fn set_signing_algorithms(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::SigningAlgorithmSpec>>) -> Self {
        self.signing_algorithms = input;
        self
    }
    /// <p>The signing algorithms that KMS supports for this key.</p>
    /// <p>This field appears in the response only when the <code>KeyUsage</code> of the public key is <code>SIGN_VERIFY</code>.</p>
    pub fn get_signing_algorithms(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::SigningAlgorithmSpec>> {
    ...
    ///
    /// <p>The key agreement algorithm used to derive a shared secret. This field is present only when the KMS key has a <code>KeyUsage</code> value of <code>KEY_AGREEMENT</code>.</p>
    pub fn key_agreement_algorithms(mut self, input: super::super::super::types::KeyAgreementAlgorithmSpec) -> Self {
    ...
    /// <p>The key agreement algorithm used to derive a shared secret. This field is present only when the KMS key has a <code>KeyUsage</code> value of <code>KEY_AGREEMENT</code>.</p>
    pub fn get_key_agreement_algorithms(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::KeyAgreementAlgorithmSpec>> {
    ...
    pub fn build(self) -> super::super::super::operation::get_public_key::GetPublicKeyOutput {
        super::super::super::operation::get_public_key::GetPublicKeyOutput {
            key_id: self.key_id,
