...
impl ReEncryptOutput {
    ...
    pub fn builder() -> super::super::super::operation::re_encrypt::builders::ReEncryptOutputBuilder {
        super::super::super::operation::re_encrypt::builders::ReEncryptOutputBuilder::default()
    }
}
...
impl ReEncryptOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::re_encrypt::ReEncryptOutput {
