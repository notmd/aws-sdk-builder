...
impl GenerateRandom {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::generate_random::GenerateRandomInput,
    ) -> ::std::result::Result<
        super::super::operation::generate_random::GenerateRandomOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::generate_random::GenerateRandomError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::generate_random::GenerateRandomError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::generate_random::GenerateRandomOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("KMS", "GenerateRandom", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GenerateRandomResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_generate_random::de_generate_random_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_generate_random::de_generate_random_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GenerateRandomRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::generate_random::GenerateRandomInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::generate_random::GenerateRandomInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_generate_random::ser_generate_random_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::generate_random::GenerateRandomError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::generate_random::_generate_random_input::GenerateRandomInput;

pub use super::super::operation::generate_random::_generate_random_output::GenerateRandomOutput;
