...
impl DescribeKey {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::describe_key::DescribeKeyInput,
    ) -> ::std::result::Result<
        super::super::operation::describe_key::DescribeKeyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::describe_key::DescribeKeyError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::describe_key::DescribeKeyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::describe_key::DescribeKeyOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("KMS", "DescribeKey", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeKey {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DescribeKeyResponseDeserializer,
        ));
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeKey")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeKeyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_describe_key::de_describe_key_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_describe_key::de_describe_key_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeKeyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::describe_key::DescribeKeyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::describe_key::DescribeKeyInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_describe_key::ser_describe_key_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::describe_key::DescribeKeyError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::describe_key::_describe_key_input::DescribeKeyInput;

pub use super::super::operation::describe_key::_describe_key_output::DescribeKeyOutput;
