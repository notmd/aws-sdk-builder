...
impl ListKeyRotationsOutput {
    ...
    pub fn rotations(&self) -> &[super::super::super::types::RotationsListEntry] {
...
impl ListKeyRotationsOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_key_rotations::builders::ListKeyRotationsOutputBuilder {
        super::super::super::operation::list_key_rotations::builders::ListKeyRotationsOutputBuilder::default()
    }
}
...
pub struct ListKeyRotationsOutputBuilder {
    pub(crate) rotations: ::std::option::Option<::std::vec::Vec<super::super::super::types::RotationsListEntry>>,
...
impl ListKeyRotationsOutputBuilder {
    ...
    ///
    /// <p>A list of completed key material rotations. When the optional input parameter <code>IncludeKeyMaterial</code> is specified with a value of <code>ALL_KEY_MATERIAL</code>, this list includes the first key material and any imported key material pending rotation.</p>
    pub fn rotations(mut self, input: super::super::super::types::RotationsListEntry) -> Self {
    ...
    /// <p>A list of completed key material rotations. When the optional input parameter <code>IncludeKeyMaterial</code> is specified with a value of <code>ALL_KEY_MATERIAL</code>, this list includes the first key material and any imported key material pending rotation.</p>
    pub fn set_rotations(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::RotationsListEntry>>) -> Self {
        self.rotations = input;
        self
    }
    /// <p>A list of completed key material rotations. When the optional input parameter <code>IncludeKeyMaterial</code> is specified with a value of <code>ALL_KEY_MATERIAL</code>, this list includes the first key material and any imported key material pending rotation.</p>
    pub fn get_rotations(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::RotationsListEntry>> {
        &self.rotations
    }
    /// <p>When <code>Truncated</code> is true, this element is present and contains the value to use for the <code>Marker</code> parameter in a subsequent request.</p>
    ...
    pub fn build(self) -> super::super::super::operation::list_key_rotations::ListKeyRotationsOutput {
