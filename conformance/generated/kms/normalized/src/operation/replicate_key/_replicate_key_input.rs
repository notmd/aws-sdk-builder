...
impl ReplicateKeyInput {
    ...
    pub fn builder() -> super::super::super::operation::replicate_key::builders::ReplicateKeyInputBuilder {
        super::super::super::operation::replicate_key::builders::ReplicateKeyInputBuilder::default()
    }
}
