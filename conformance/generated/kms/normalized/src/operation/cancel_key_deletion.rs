...
impl CancelKeyDeletion {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::cancel_key_deletion::CancelKeyDeletionInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::cancel_key_deletion::CancelKeyDeletionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::cancel_key_deletion::CancelKeyDeletionOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CancelKeyDeletionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_cancel_key_deletion::de_cancel_key_deletion_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_cancel_key_deletion::de_cancel_key_deletion_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CancelKeyDeletionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::cancel_key_deletion::CancelKeyDeletionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::cancel_key_deletion::CancelKeyDeletionInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::cancel_key_deletion::CancelKeyDeletionError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::cancel_key_deletion::_cancel_key_deletion_input::CancelKeyDeletionInput;

pub use super::super::operation::cancel_key_deletion::_cancel_key_deletion_output::CancelKeyDeletionOutput;
