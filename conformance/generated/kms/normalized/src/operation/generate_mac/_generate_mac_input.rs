...
impl GenerateMacInput {
    ...
    pub fn builder() -> super::super::super::operation::generate_mac::builders::GenerateMacInputBuilder {
        super::super::super::operation::generate_mac::builders::GenerateMacInputBuilder::default()
    }
}
