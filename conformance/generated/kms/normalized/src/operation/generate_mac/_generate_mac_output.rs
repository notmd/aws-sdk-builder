...
impl GenerateMacOutput {
    ...
    /// <p>The MAC algorithm that was used to generate the HMAC.</p>
    pub fn mac_algorithm(&self) -> ::std::option::Option<&super::super::super::types::MacAlgorithmSpec> {
...
impl GenerateMacOutput {
    ...
    pub fn builder() -> super::super::super::operation::generate_mac::builders::GenerateMacOutputBuilder {
        super::super::super::operation::generate_mac::builders::GenerateMacOutputBuilder::default()
    }
}
...
pub struct GenerateMacOutputBuilder {
    ...
    pub(crate) mac_algorithm: ::std::option::Option<super::super::super::types::MacAlgorithmSpec>,
...
impl GenerateMacOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::generate_mac::GenerateMacOutput {
