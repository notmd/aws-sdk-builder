...
pub use super::super::super::operation::generate_mac::_generate_mac_input::GenerateMacInputBuilder;

pub use super::super::super::operation::generate_mac::_generate_mac_output::GenerateMacOutputBuilder;

impl super::super::super::operation::generate_mac::builders::GenerateMacInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::generate_mac::GenerateMacOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::generate_mac::GenerateMacError,
...
pub struct GenerateMacFluentBuilder {
    ...
    inner: super::super::super::operation::generate_mac::builders::GenerateMacInputBuilder,
...
impl GenerateMacFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::generate_mac::builders::GenerateMacInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::generate_mac::GenerateMac::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::generate_mac::GenerateMac::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn mac_algorithm(mut self, input: super::super::super::types::MacAlgorithmSpec) -> Self {
        self.inner = self.inner.mac_algorithm(input);
        self
    }
    /// <p>The MAC algorithm used in the operation.</p>
    /// <p>The algorithm must be compatible with the HMAC KMS key that you specify. To find the MAC algorithms that your HMAC KMS key supports, use the <code>DescribeKey</code> operation and see the <code>MacAlgorithms</code> field in the <code>DescribeKey</code> response.</p>
    pub fn set_mac_algorithm(mut self, input: ::std::option::Option<super::super::super::types::MacAlgorithmSpec>) -> Self {
        self.inner = self.inner.set_mac_algorithm(input);
        self
    }
    /// <p>The MAC algorithm used in the operation.</p>
    /// <p>The algorithm must be compatible with the HMAC KMS key that you specify. To find the MAC algorithms that your HMAC KMS key supports, use the <code>DescribeKey</code> operation and see the <code>MacAlgorithms</code> field in the <code>DescribeKey</code> response.</p>
    pub fn get_mac_algorithm(&self) -> &::std::option::Option<super::super::super::types::MacAlgorithmSpec> {
