...
impl super::Client {
    ...
    pub fn update_key_description(&self) -> super::super::operation::update_key_description::builders::UpdateKeyDescriptionFluentBuilder {
        super::super::operation::update_key_description::builders::UpdateKeyDescriptionFluentBuilder::new(self.handle.clone())
    }
}
