...
impl super::Client {
    ...
    pub fn rotate_key_on_demand(&self) -> super::super::operation::rotate_key_on_demand::builders::RotateKeyOnDemandFluentBuilder {
        super::super::operation::rotate_key_on_demand::builders::RotateKeyOnDemandFluentBuilder::new(self.handle.clone())
    }
}
