...
impl super::Client {
    ...
    pub fn revoke_grant(&self) -> super::super::operation::revoke_grant::builders::RevokeGrantFluentBuilder {
        super::super::operation::revoke_grant::builders::RevokeGrantFluentBuilder::new(self.handle.clone())
    }
}
