...
impl super::Client {
    ...
    pub fn cancel_key_deletion(&self) -> super::super::operation::cancel_key_deletion::builders::CancelKeyDeletionFluentBuilder {
        super::super::operation::cancel_key_deletion::builders::CancelKeyDeletionFluentBuilder::new(self.handle.clone())
    }
}
