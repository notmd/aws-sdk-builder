...
impl super::Client {
    ...
    pub fn get_key_policy(&self) -> super::super::operation::get_key_policy::builders::GetKeyPolicyFluentBuilder {
        super::super::operation::get_key_policy::builders::GetKeyPolicyFluentBuilder::new(self.handle.clone())
    }
}
