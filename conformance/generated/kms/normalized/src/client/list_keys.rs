...
impl super::Client {
    ...
    pub fn list_keys(&self) -> super::super::operation::list_keys::builders::ListKeysFluentBuilder {
        super::super::operation::list_keys::builders::ListKeysFluentBuilder::new(self.handle.clone())
    }
}
