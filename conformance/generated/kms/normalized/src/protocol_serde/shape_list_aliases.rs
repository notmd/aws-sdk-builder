...
pub fn de_list_aliases_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::list_aliases::ListAliasesOutput, super::super::operation::list_aliases::ListAliasesError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::list_aliases::ListAliasesError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "DependencyTimeoutException" => super::super::operation::list_aliases::ListAliasesError::DependencyTimeoutException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidArnException" => super::super::operation::list_aliases::ListAliasesError::InvalidArnException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidMarkerException" => super::super::operation::list_aliases::ListAliasesError::InvalidMarkerException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInternalException" => super::super::operation::list_aliases::ListAliasesError::KmsInternalException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::super::operation::list_aliases::ListAliasesError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_list_aliases_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_aliases::builders::ListAliasesOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_aliases::de_list_aliases(_response_body, output)
            .map_err(super::super::operation::list_aliases::ListAliasesError::unhandled)?;
