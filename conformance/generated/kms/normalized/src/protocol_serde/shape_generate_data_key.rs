...
pub fn de_generate_data_key_http_error(
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::generate_data_key::GenerateDataKeyError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "DependencyTimeoutException" => super::super::operation::generate_data_key::GenerateDataKeyError::DependencyTimeoutException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "DisabledException" => super::super::operation::generate_data_key::GenerateDataKeyError::DisabledException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "DryRunOperationException" => super::super::operation::generate_data_key::GenerateDataKeyError::DryRunOperationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidGrantTokenException" => super::super::operation::generate_data_key::GenerateDataKeyError::InvalidGrantTokenException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidKeyUsageException" => super::super::operation::generate_data_key::GenerateDataKeyError::InvalidKeyUsageException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KeyUnavailableException" => super::super::operation::generate_data_key::GenerateDataKeyError::KeyUnavailableException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInternalException" => super::super::operation::generate_data_key::GenerateDataKeyError::KmsInternalException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInvalidStateException" => super::super::operation::generate_data_key::GenerateDataKeyError::KmsInvalidStateException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::super::operation::generate_data_key::GenerateDataKeyError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_generate_data_key_http_response(
    ...
    Ok({
        ...
        output = super::super::protocol_serde::shape_generate_data_key::de_generate_data_key(_response_body, output)
            .map_err(super::super::operation::generate_data_key::GenerateDataKeyError::unhandled)?;
...
pub fn ser_generate_data_key_input(
    ...
    super::super::protocol_serde::shape_generate_data_key_input::ser_generate_data_key_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_generate_data_key(
    _value: &[u8],
    mut builder: super::super::operation::generate_data_key::builders::GenerateDataKeyOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::generate_data_key::builders::GenerateDataKeyOutputBuilder,
