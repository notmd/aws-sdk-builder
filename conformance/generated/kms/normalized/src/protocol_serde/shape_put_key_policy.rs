...
pub fn de_put_key_policy_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::put_key_policy::PutKeyPolicyOutput, super::super::operation::put_key_policy::PutKeyPolicyError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::put_key_policy::PutKeyPolicyError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "DependencyTimeoutException" => super::super::operation::put_key_policy::PutKeyPolicyError::DependencyTimeoutException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidArnException" => super::super::operation::put_key_policy::PutKeyPolicyError::InvalidArnException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInternalException" => super::super::operation::put_key_policy::PutKeyPolicyError::KmsInternalException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInvalidStateException" => super::super::operation::put_key_policy::PutKeyPolicyError::KmsInvalidStateException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "LimitExceededException" => super::super::operation::put_key_policy::PutKeyPolicyError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "MalformedPolicyDocumentException" => super::super::operation::put_key_policy::PutKeyPolicyError::MalformedPolicyDocumentException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::super::operation::put_key_policy::PutKeyPolicyError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UnsupportedOperationException" => super::super::operation::put_key_policy::PutKeyPolicyError::UnsupportedOperationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_put_key_policy_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::put_key_policy::builders::PutKeyPolicyOutputBuilder::default();
...
pub fn ser_put_key_policy_input(
    ...
    super::super::protocol_serde::shape_put_key_policy_input::ser_put_key_policy_input_input(&mut object, input)?;
    object.finish();
