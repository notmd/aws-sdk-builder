...
pub fn de_list_key_policies_http_error(
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::list_key_policies::ListKeyPoliciesError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "DependencyTimeoutException" => super::super::operation::list_key_policies::ListKeyPoliciesError::DependencyTimeoutException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidArnException" => super::super::operation::list_key_policies::ListKeyPoliciesError::InvalidArnException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInternalException" => super::super::operation::list_key_policies::ListKeyPoliciesError::KmsInternalException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInvalidStateException" => super::super::operation::list_key_policies::ListKeyPoliciesError::KmsInvalidStateException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::super::operation::list_key_policies::ListKeyPoliciesError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_list_key_policies_http_response(
    ...
    Ok({
        ...
        output = super::super::protocol_serde::shape_list_key_policies::de_list_key_policies(_response_body, output)
            .map_err(super::super::operation::list_key_policies::ListKeyPoliciesError::unhandled)?;
...
pub fn ser_list_key_policies_input(
    ...
    super::super::protocol_serde::shape_list_key_policies_input::ser_list_key_policies_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_list_key_policies(
    _value: &[u8],
    mut builder: super::super::operation::list_key_policies::builders::ListKeyPoliciesOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::list_key_policies::builders::ListKeyPoliciesOutputBuilder,
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "PolicyNames" => {
                    builder = builder.set_policy_names(super::super::protocol_serde::shape_policy_name_list::de_policy_name_list(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
