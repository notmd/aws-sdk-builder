...
pub fn de_sign_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::sign::SignOutput, super::super::operation::sign::SignError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::sign::SignError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "DependencyTimeoutException" => super::super::operation::sign::SignError::DependencyTimeoutException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "DisabledException" => super::super::operation::sign::SignError::DisabledException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "DryRunOperationException" => super::super::operation::sign::SignError::DryRunOperationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidGrantTokenException" => super::super::operation::sign::SignError::InvalidGrantTokenException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidKeyUsageException" => super::super::operation::sign::SignError::InvalidKeyUsageException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KeyUnavailableException" => super::super::operation::sign::SignError::KeyUnavailableException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInternalException" => super::super::operation::sign::SignError::KmsInternalException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInvalidStateException" => super::super::operation::sign::SignError::KmsInvalidStateException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::super::operation::sign::SignError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn ser_sign_input(
    ...
    super::super::protocol_serde::shape_sign_input::ser_sign_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_sign(
    _value: &[u8],
    mut builder: super::super::operation::sign::builders::SignOutputBuilder,
) -> ::std::result::Result<super::super::operation::sign::builders::SignOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
