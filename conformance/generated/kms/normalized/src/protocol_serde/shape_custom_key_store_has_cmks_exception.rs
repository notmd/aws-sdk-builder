...
pub(crate) fn de_custom_key_store_has_cmks_exception_json_err(
    _value: &[u8],
    mut builder: super::super::types::error::builders::CustomKeyStoreHasCmKsExceptionBuilder,
) -> ::std::result::Result<
    super::super::types::error::builders::CustomKeyStoreHasCmKsExceptionBuilder,
