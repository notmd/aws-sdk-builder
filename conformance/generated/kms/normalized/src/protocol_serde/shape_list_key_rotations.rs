...
pub fn de_list_key_rotations_http_error(
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::list_key_rotations::ListKeyRotationsError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InvalidArnException" => super::super::operation::list_key_rotations::ListKeyRotationsError::InvalidArnException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidMarkerException" => super::super::operation::list_key_rotations::ListKeyRotationsError::InvalidMarkerException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInternalException" => super::super::operation::list_key_rotations::ListKeyRotationsError::KmsInternalException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInvalidStateException" => super::super::operation::list_key_rotations::ListKeyRotationsError::KmsInvalidStateException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::super::operation::list_key_rotations::ListKeyRotationsError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UnsupportedOperationException" => super::super::operation::list_key_rotations::ListKeyRotationsError::UnsupportedOperationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_list_key_rotations_http_response(
    ...
    Ok({
        ...
        output = super::super::protocol_serde::shape_list_key_rotations::de_list_key_rotations(_response_body, output)
            .map_err(super::super::operation::list_key_rotations::ListKeyRotationsError::unhandled)?;
...
pub fn ser_list_key_rotations_input(
    input: &super::super::operation::list_key_rotations::ListKeyRotationsInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    super::super::protocol_serde::shape_list_key_rotations_input::ser_list_key_rotations_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_list_key_rotations(
    _value: &[u8],
    mut builder: super::super::operation::list_key_rotations::builders::ListKeyRotationsOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::list_key_rotations::builders::ListKeyRotationsOutputBuilder,
