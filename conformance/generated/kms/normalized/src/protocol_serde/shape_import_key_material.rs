...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::import_key_material::ImportKeyMaterialError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "DependencyTimeoutException" => super::super::operation::import_key_material::ImportKeyMaterialError::DependencyTimeoutException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ExpiredImportTokenException" => super::super::operation::import_key_material::ImportKeyMaterialError::ExpiredImportTokenException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "IncorrectKeyMaterialException" => super::super::operation::import_key_material::ImportKeyMaterialError::IncorrectKeyMaterialException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                let mut output = super::super::types::error::builders::IncorrectKeyMaterialExceptionBuilder::default();
                output = super::super::protocol_serde::shape_incorrect_key_material_exception::de_incorrect_key_material_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(super::super::operation::import_key_material::ImportKeyMaterialError::unhandled)?;
        ...
        "InvalidArnException" => super::super::operation::import_key_material::ImportKeyMaterialError::InvalidArnException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidCiphertextException" => super::super::operation::import_key_material::ImportKeyMaterialError::InvalidCiphertextException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidImportTokenException" => super::super::operation::import_key_material::ImportKeyMaterialError::InvalidImportTokenException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInternalException" => super::super::operation::import_key_material::ImportKeyMaterialError::KmsInternalException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInvalidStateException" => super::super::operation::import_key_material::ImportKeyMaterialError::KmsInvalidStateException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::super::operation::import_key_material::ImportKeyMaterialError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UnsupportedOperationException" => super::super::operation::import_key_material::ImportKeyMaterialError::UnsupportedOperationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = super::super::protocol_serde::shape_import_key_material::de_import_key_material(_response_body, output)
            .map_err(super::super::operation::import_key_material::ImportKeyMaterialError::unhandled)?;
...
pub fn ser_import_key_material_input(
    input: &super::super::operation::import_key_material::ImportKeyMaterialInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    super::super::protocol_serde::shape_import_key_material_input::ser_import_key_material_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_import_key_material(
    _value: &[u8],
    mut builder: super::super::operation::import_key_material::builders::ImportKeyMaterialOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::import_key_material::builders::ImportKeyMaterialOutputBuilder,
