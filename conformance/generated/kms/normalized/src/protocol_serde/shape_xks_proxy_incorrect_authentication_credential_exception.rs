...
pub(crate) fn de_xks_proxy_incorrect_authentication_credential_exception_json_err(
    _value: &[u8],
    mut builder: super::super::types::error::builders::XksProxyIncorrectAuthenticationCredentialExceptionBuilder,
) -> ::std::result::Result<
    super::super::types::error::builders::XksProxyIncorrectAuthenticationCredentialExceptionBuilder,
