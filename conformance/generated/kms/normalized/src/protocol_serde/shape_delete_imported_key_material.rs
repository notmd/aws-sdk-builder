...
> {
    ...
    Err(match error_code {
        ...
        "KMSInternalException" => super::super::operation::delete_imported_key_material::DeleteImportedKeyMaterialError::KmsInternalException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UnsupportedOperationException" => {
            super::super::operation::delete_imported_key_material::DeleteImportedKeyMaterialError::UnsupportedOperationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::delete_imported_key_material::builders::DeleteImportedKeyMaterialOutputBuilder::default();
        output = super::super::protocol_serde::shape_delete_imported_key_material::de_delete_imported_key_material(_response_body, output)
            .map_err(super::super::operation::delete_imported_key_material::DeleteImportedKeyMaterialError::unhandled)?;
...
pub fn ser_delete_imported_key_material_input(
    ...
    super::super::protocol_serde::shape_delete_imported_key_material_input::ser_delete_imported_key_material_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_delete_imported_key_material(
    _value: &[u8],
    mut builder: super::super::operation::delete_imported_key_material::builders::DeleteImportedKeyMaterialOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::delete_imported_key_material::builders::DeleteImportedKeyMaterialOutputBuilder,
