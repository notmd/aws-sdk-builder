...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::delete_custom_key_store::builders::DeleteCustomKeyStoreOutputBuilder::default();
...
pub fn ser_delete_custom_key_store_input(
    ...
    super::super::protocol_serde::shape_delete_custom_key_store_input::ser_delete_custom_key_store_input_input(&mut object, input)?;
    object.finish();
