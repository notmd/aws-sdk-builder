...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::cancel_key_deletion::CancelKeyDeletionError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "DependencyTimeoutException" => super::super::operation::cancel_key_deletion::CancelKeyDeletionError::DependencyTimeoutException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidArnException" => super::super::operation::cancel_key_deletion::CancelKeyDeletionError::InvalidArnException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInternalException" => super::super::operation::cancel_key_deletion::CancelKeyDeletionError::KmsInternalException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInvalidStateException" => super::super::operation::cancel_key_deletion::CancelKeyDeletionError::KmsInvalidStateException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::super::operation::cancel_key_deletion::CancelKeyDeletionError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = super::super::protocol_serde::shape_cancel_key_deletion::de_cancel_key_deletion(_response_body, output)
            .map_err(super::super::operation::cancel_key_deletion::CancelKeyDeletionError::unhandled)?;
...
pub fn ser_cancel_key_deletion_input(
    ...
    super::super::protocol_serde::shape_cancel_key_deletion_input::ser_cancel_key_deletion_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_cancel_key_deletion(
    _value: &[u8],
    mut builder: super::super::operation::cancel_key_deletion::builders::CancelKeyDeletionOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::cancel_key_deletion::builders::CancelKeyDeletionOutputBuilder,
