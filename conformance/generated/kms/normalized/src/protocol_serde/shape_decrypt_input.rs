...
pub fn ser_decrypt_input_input(
    ...
    if let Some(var_11) = &input.recipient {
        ...
        super::super::protocol_serde::shape_recipient_info::ser_recipient_info(&mut object_12, var_11)?;
        object_12.finish();
    }
    if let Some(var_13) = &input.dry_run {
        object.key("DryRun").boolean(*var_13);
    }
    if let Some(var_14) = &input.dry_run_modifiers {
        let mut array_15 = object.key("DryRunModifiers").start_array();
