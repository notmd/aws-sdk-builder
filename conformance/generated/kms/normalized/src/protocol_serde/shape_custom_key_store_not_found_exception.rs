...
pub(crate) fn de_custom_key_store_not_found_exception_json_err(
    _value: &[u8],
    mut builder: super::super::types::error::builders::CustomKeyStoreNotFoundExceptionBuilder,
) -> ::std::result::Result<
    super::super::types::error::builders::CustomKeyStoreNotFoundExceptionBuilder,
