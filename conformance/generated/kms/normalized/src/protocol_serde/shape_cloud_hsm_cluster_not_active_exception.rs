...
pub(crate) fn de_cloud_hsm_cluster_not_active_exception_json_err(
    _value: &[u8],
    mut builder: super::super::types::error::builders::CloudHsmClusterNotActiveExceptionBuilder,
) -> ::std::result::Result<
    super::super::types::error::builders::CloudHsmClusterNotActiveExceptionBuilder,
