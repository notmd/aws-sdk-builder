...
pub(crate) fn de_custom_key_store_name_in_use_exception_json_err(
    _value: &[u8],
    mut builder: super::super::types::error::builders::CustomKeyStoreNameInUseExceptionBuilder,
) -> ::std::result::Result<
    super::super::types::error::builders::CustomKeyStoreNameInUseExceptionBuilder,
