...
pub fn de_derive_shared_secret_http_error(
    ...
    super::super::operation::derive_shared_secret::DeriveSharedSecretOutput,
    super::super::operation::derive_shared_secret::DeriveSharedSecretError,
> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::derive_shared_secret::DeriveSharedSecretError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "DependencyTimeoutException" => super::super::operation::derive_shared_secret::DeriveSharedSecretError::DependencyTimeoutException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "DisabledException" => super::super::operation::derive_shared_secret::DeriveSharedSecretError::DisabledException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "DryRunOperationException" => super::super::operation::derive_shared_secret::DeriveSharedSecretError::DryRunOperationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidGrantTokenException" => super::super::operation::derive_shared_secret::DeriveSharedSecretError::InvalidGrantTokenException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidKeyUsageException" => super::super::operation::derive_shared_secret::DeriveSharedSecretError::InvalidKeyUsageException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KeyUnavailableException" => super::super::operation::derive_shared_secret::DeriveSharedSecretError::KeyUnavailableException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInternalException" => super::super::operation::derive_shared_secret::DeriveSharedSecretError::KmsInternalException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInvalidStateException" => super::super::operation::derive_shared_secret::DeriveSharedSecretError::KmsInvalidStateException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::super::operation::derive_shared_secret::DeriveSharedSecretError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::derive_shared_secret::builders::DeriveSharedSecretOutputBuilder::default();
        output = super::super::protocol_serde::shape_derive_shared_secret::de_derive_shared_secret(_response_body, output)
            .map_err(super::super::operation::derive_shared_secret::DeriveSharedSecretError::unhandled)?;
...
pub fn ser_derive_shared_secret_input(
    input: &super::super::operation::derive_shared_secret::DeriveSharedSecretInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    super::super::protocol_serde::shape_derive_shared_secret_input::ser_derive_shared_secret_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_derive_shared_secret(
    _value: &[u8],
    mut builder: super::super::operation::derive_shared_secret::builders::DeriveSharedSecretOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::derive_shared_secret::builders::DeriveSharedSecretOutputBuilder,
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "KeyAgreementAlgorithm" => {
                    builder = builder.set_key_agreement_algorithm(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| super::super::types::KeyAgreementAlgorithmSpec::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "KeyOrigin" => {
                    builder = builder.set_key_origin(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| super::super::types::OriginType::from(u.as_ref())))
                            .transpose()?,
                    );
                }
