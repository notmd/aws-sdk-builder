...
pub fn de_generate_data_key_pair_http_error(
    ...
    super::super::operation::generate_data_key_pair::GenerateDataKeyPairOutput,
    super::super::operation::generate_data_key_pair::GenerateDataKeyPairError,
> {
    #[allow(unused_mut)]
    ...
    Err(match error_code {
        "DependencyTimeoutException" => super::super::operation::generate_data_key_pair::GenerateDataKeyPairError::DependencyTimeoutException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "DisabledException" => super::super::operation::generate_data_key_pair::GenerateDataKeyPairError::DisabledException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "DryRunOperationException" => super::super::operation::generate_data_key_pair::GenerateDataKeyPairError::DryRunOperationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidGrantTokenException" => super::super::operation::generate_data_key_pair::GenerateDataKeyPairError::InvalidGrantTokenException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidKeyUsageException" => super::super::operation::generate_data_key_pair::GenerateDataKeyPairError::InvalidKeyUsageException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KeyUnavailableException" => super::super::operation::generate_data_key_pair::GenerateDataKeyPairError::KeyUnavailableException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInternalException" => super::super::operation::generate_data_key_pair::GenerateDataKeyPairError::KmsInternalException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInvalidStateException" => super::super::operation::generate_data_key_pair::GenerateDataKeyPairError::KmsInvalidStateException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::super::operation::generate_data_key_pair::GenerateDataKeyPairError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::generate_data_key_pair::builders::GenerateDataKeyPairOutputBuilder::default();
        output = super::super::protocol_serde::shape_generate_data_key_pair::de_generate_data_key_pair(_response_body, output)
            .map_err(super::super::operation::generate_data_key_pair::GenerateDataKeyPairError::unhandled)?;
...
pub fn ser_generate_data_key_pair_input(
    input: &super::super::operation::generate_data_key_pair::GenerateDataKeyPairInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    super::super::protocol_serde::shape_generate_data_key_pair_input::ser_generate_data_key_pair_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_generate_data_key_pair(
    _value: &[u8],
    mut builder: super::super::operation::generate_data_key_pair::builders::GenerateDataKeyPairOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::generate_data_key_pair::builders::GenerateDataKeyPairOutputBuilder,
