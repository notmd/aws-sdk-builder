...
pub fn de_rotate_key_on_demand_http_error(
    ...
    super::super::operation::rotate_key_on_demand::RotateKeyOnDemandOutput,
    super::super::operation::rotate_key_on_demand::RotateKeyOnDemandError,
> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::rotate_key_on_demand::RotateKeyOnDemandError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "ConflictException" => super::super::operation::rotate_key_on_demand::RotateKeyOnDemandError::ConflictException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "DependencyTimeoutException" => super::super::operation::rotate_key_on_demand::RotateKeyOnDemandError::DependencyTimeoutException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "DisabledException" => super::super::operation::rotate_key_on_demand::RotateKeyOnDemandError::DisabledException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidArnException" => super::super::operation::rotate_key_on_demand::RotateKeyOnDemandError::InvalidArnException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInternalException" => super::super::operation::rotate_key_on_demand::RotateKeyOnDemandError::KmsInternalException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInvalidStateException" => super::super::operation::rotate_key_on_demand::RotateKeyOnDemandError::KmsInvalidStateException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "LimitExceededException" => super::super::operation::rotate_key_on_demand::RotateKeyOnDemandError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::super::operation::rotate_key_on_demand::RotateKeyOnDemandError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UnsupportedOperationException" => super::super::operation::rotate_key_on_demand::RotateKeyOnDemandError::UnsupportedOperationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::rotate_key_on_demand::builders::RotateKeyOnDemandOutputBuilder::default();
        output = super::super::protocol_serde::shape_rotate_key_on_demand::de_rotate_key_on_demand(_response_body, output)
            .map_err(super::super::operation::rotate_key_on_demand::RotateKeyOnDemandError::unhandled)?;
...
pub fn ser_rotate_key_on_demand_input(
    input: &super::super::operation::rotate_key_on_demand::RotateKeyOnDemandInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    super::super::protocol_serde::shape_rotate_key_on_demand_input::ser_rotate_key_on_demand_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_rotate_key_on_demand(
    _value: &[u8],
    mut builder: super::super::operation::rotate_key_on_demand::builders::RotateKeyOnDemandOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::rotate_key_on_demand::builders::RotateKeyOnDemandOutputBuilder,
