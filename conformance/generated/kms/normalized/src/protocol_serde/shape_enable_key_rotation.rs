...
) -> std::result::Result<super::super::operation::enable_key_rotation::EnableKeyRotationOutput, super::super::operation::enable_key_rotation::EnableKeyRotationError>
{
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::enable_key_rotation::EnableKeyRotationError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "DependencyTimeoutException" => super::super::operation::enable_key_rotation::EnableKeyRotationError::DependencyTimeoutException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "DisabledException" => super::super::operation::enable_key_rotation::EnableKeyRotationError::DisabledException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidArnException" => super::super::operation::enable_key_rotation::EnableKeyRotationError::InvalidArnException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInternalException" => super::super::operation::enable_key_rotation::EnableKeyRotationError::KmsInternalException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInvalidStateException" => super::super::operation::enable_key_rotation::EnableKeyRotationError::KmsInvalidStateException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::super::operation::enable_key_rotation::EnableKeyRotationError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UnsupportedOperationException" => super::super::operation::enable_key_rotation::EnableKeyRotationError::UnsupportedOperationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn ser_enable_key_rotation_input(
    ...
    super::super::protocol_serde::shape_enable_key_rotation_input::ser_enable_key_rotation_input_input(&mut object, input)?;
    object.finish();
