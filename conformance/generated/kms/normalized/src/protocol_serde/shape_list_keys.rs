...
pub fn de_list_keys_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::list_keys::ListKeysOutput, super::super::operation::list_keys::ListKeysError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::list_keys::ListKeysError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "DependencyTimeoutException" => super::super::operation::list_keys::ListKeysError::DependencyTimeoutException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidMarkerException" => super::super::operation::list_keys::ListKeysError::InvalidMarkerException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInternalException" => super::super::operation::list_keys::ListKeysError::KmsInternalException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_list_keys_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_keys::builders::ListKeysOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_keys::de_list_keys(_response_body, output)
            .map_err(super::super::operation::list_keys::ListKeysError::unhandled)?;
...
pub fn ser_list_keys_input(
    ...
    super::super::protocol_serde::shape_list_keys_input::ser_list_keys_input_input(&mut object, input)?;
    object.finish();
