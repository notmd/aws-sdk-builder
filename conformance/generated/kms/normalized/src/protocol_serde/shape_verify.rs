...
pub fn de_verify_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::verify::VerifyOutput, super::super::operation::verify::VerifyError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::verify::VerifyError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "DependencyTimeoutException" => super::super::operation::verify::VerifyError::DependencyTimeoutException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "DisabledException" => super::super::operation::verify::VerifyError::DisabledException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "DryRunOperationException" => super::super::operation::verify::VerifyError::DryRunOperationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidGrantTokenException" => super::super::operation::verify::VerifyError::InvalidGrantTokenException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidKeyUsageException" => super::super::operation::verify::VerifyError::InvalidKeyUsageException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KeyUnavailableException" => super::super::operation::verify::VerifyError::KeyUnavailableException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInternalException" => super::super::operation::verify::VerifyError::KmsInternalException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInvalidSignatureException" => super::super::operation::verify::VerifyError::KmsInvalidSignatureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInvalidStateException" => super::super::operation::verify::VerifyError::KmsInvalidStateException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::super::operation::verify::VerifyError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn ser_verify_input(
    ...
    super::super::protocol_serde::shape_verify_input::ser_verify_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_verify(
    _value: &[u8],
    mut builder: super::super::operation::verify::builders::VerifyOutputBuilder,
) -> ::std::result::Result<super::super::operation::verify::builders::VerifyOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "SigningAlgorithm" => {
                    builder = builder.set_signing_algorithm(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| super::super::types::SigningAlgorithmSpec::from(u.as_ref())))
                            .transpose()?,
                    );
                }
