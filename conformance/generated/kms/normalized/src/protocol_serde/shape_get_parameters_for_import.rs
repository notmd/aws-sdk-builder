...
> {
    ...
    Err(match error_code {
        ...
        "KMSInternalException" => super::super::operation::get_parameters_for_import::GetParametersForImportError::KmsInternalException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInvalidStateException" => super::super::operation::get_parameters_for_import::GetParametersForImportError::KmsInvalidStateException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::super::operation::get_parameters_for_import::GetParametersForImportError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::get_parameters_for_import::builders::GetParametersForImportOutputBuilder::default();
        output = super::super::protocol_serde::shape_get_parameters_for_import::de_get_parameters_for_import(_response_body, output)
            .map_err(super::super::operation::get_parameters_for_import::GetParametersForImportError::unhandled)?;
...
pub fn ser_get_parameters_for_import_input(
    ...
    super::super::protocol_serde::shape_get_parameters_for_import_input::ser_get_parameters_for_import_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_get_parameters_for_import(
    _value: &[u8],
    mut builder: super::super::operation::get_parameters_for_import::builders::GetParametersForImportOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::get_parameters_for_import::builders::GetParametersForImportOutputBuilder,
