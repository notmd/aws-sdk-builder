...
pub fn de_get_public_key_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::get_public_key::GetPublicKeyOutput, super::super::operation::get_public_key::GetPublicKeyError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::get_public_key::GetPublicKeyError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "DependencyTimeoutException" => super::super::operation::get_public_key::GetPublicKeyError::DependencyTimeoutException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "DisabledException" => super::super::operation::get_public_key::GetPublicKeyError::DisabledException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidArnException" => super::super::operation::get_public_key::GetPublicKeyError::InvalidArnException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidGrantTokenException" => super::super::operation::get_public_key::GetPublicKeyError::InvalidGrantTokenException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidKeyUsageException" => super::super::operation::get_public_key::GetPublicKeyError::InvalidKeyUsageException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KeyUnavailableException" => super::super::operation::get_public_key::GetPublicKeyError::KeyUnavailableException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInternalException" => super::super::operation::get_public_key::GetPublicKeyError::KmsInternalException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KMSInvalidStateException" => super::super::operation::get_public_key::GetPublicKeyError::KmsInvalidStateException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NotFoundException" => super::super::operation::get_public_key::GetPublicKeyError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UnsupportedOperationException" => super::super::operation::get_public_key::GetPublicKeyError::UnsupportedOperationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_get_public_key_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::get_public_key::builders::GetPublicKeyOutputBuilder::default();
        output = super::super::protocol_serde::shape_get_public_key::de_get_public_key(_response_body, output)
            .map_err(super::super::operation::get_public_key::GetPublicKeyError::unhandled)?;
...
pub fn ser_get_public_key_input(
    input: &super::super::operation::get_public_key::GetPublicKeyInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    super::super::protocol_serde::shape_get_public_key_input::ser_get_public_key_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_get_public_key(
    _value: &[u8],
    mut builder: super::super::operation::get_public_key::builders::GetPublicKeyOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::get_public_key::builders::GetPublicKeyOutputBuilder,
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "CustomerMasterKeySpec" => {
                    builder = builder.set_customer_master_key_spec(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| super::super::types::CustomerMasterKeySpec::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "KeySpec" => {
                    builder = builder.set_key_spec(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| super::super::types::KeySpec::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "KeyUsage" => {
                    builder = builder.set_key_usage(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| super::super::types::KeyUsageType::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                ...
                "KeyAgreementAlgorithms" => {
                    builder = builder.set_key_agreement_algorithms(
                        super::super::protocol_serde::shape_key_agreement_algorithm_spec_list::de_key_agreement_algorithm_spec_list(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
