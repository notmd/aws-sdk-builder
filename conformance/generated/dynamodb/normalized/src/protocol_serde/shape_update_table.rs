...
pub fn de_update_table_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::update_table::UpdateTableOutput, super::super::operation::update_table::UpdateTableError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::update_table::UpdateTableError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InternalServerError" => super::super::operation::update_table::UpdateTableError::InternalServerError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidEndpointException" => super::super::operation::update_table::UpdateTableError::InvalidEndpointException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "LimitExceededException" => super::super::operation::update_table::UpdateTableError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceInUseException" => super::super::operation::update_table::UpdateTableError::ResourceInUseException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => super::super::operation::update_table::UpdateTableError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::super::operation::update_table::UpdateTableError::generic(generic),
    })
}
...
pub fn de_update_table_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::update_table::builders::UpdateTableOutputBuilder::default();
        output = super::super::protocol_serde::shape_update_table::de_update_table(_response_body, output)
            .map_err(super::super::operation::update_table::UpdateTableError::unhandled)?;
...
pub fn ser_update_table_input(
    ...
    super::super::protocol_serde::shape_update_table_input::ser_update_table_input_input(&mut object, input)?;
    object.finish();
