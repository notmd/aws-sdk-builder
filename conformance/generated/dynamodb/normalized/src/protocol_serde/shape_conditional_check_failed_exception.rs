...
pub(crate) fn de_conditional_check_failed_exception_json_err(
    _value: &[u8],
    mut builder: super::super::types::error::builders::ConditionalCheckFailedExceptionBuilder,
) -> ::std::result::Result<
    super::super::types::error::builders::ConditionalCheckFailedExceptionBuilder,
