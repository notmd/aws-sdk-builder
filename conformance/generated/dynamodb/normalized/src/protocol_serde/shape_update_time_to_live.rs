...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::update_time_to_live::UpdateTimeToLiveError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InternalServerError" => super::super::operation::update_time_to_live::UpdateTimeToLiveError::InternalServerError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidEndpointException" => super::super::operation::update_time_to_live::UpdateTimeToLiveError::InvalidEndpointException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "LimitExceededException" => super::super::operation::update_time_to_live::UpdateTimeToLiveError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceInUseException" => super::super::operation::update_time_to_live::UpdateTimeToLiveError::ResourceInUseException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => super::super::operation::update_time_to_live::UpdateTimeToLiveError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::super::operation::update_time_to_live::UpdateTimeToLiveError::generic(generic),
    })
}
...
> {
    Ok({
        ...
        output = super::super::protocol_serde::shape_update_time_to_live::de_update_time_to_live(_response_body, output)
            .map_err(super::super::operation::update_time_to_live::UpdateTimeToLiveError::unhandled)?;
...
pub fn ser_update_time_to_live_input(
    input: &super::super::operation::update_time_to_live::UpdateTimeToLiveInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    super::super::protocol_serde::shape_update_time_to_live_input::ser_update_time_to_live_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_update_time_to_live(
    _value: &[u8],
    mut builder: super::super::operation::update_time_to_live::builders::UpdateTimeToLiveOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::update_time_to_live::builders::UpdateTimeToLiveOutputBuilder,
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "TimeToLiveSpecification" => {
                    builder = builder.set_time_to_live_specification(
                        super::super::protocol_serde::shape_time_to_live_specification::de_time_to_live_specification(tokens, _value, depth + 1)?,
                    );
                }
