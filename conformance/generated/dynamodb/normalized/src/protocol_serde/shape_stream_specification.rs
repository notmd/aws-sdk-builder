...
pub fn ser_stream_specification(
    ...
    input: &super::super::types::StreamSpecification,
...
pub(crate) fn de_stream_specification<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::super::types::StreamSpecification>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::super::types::builders::StreamSpecificationBuilder::default();
            loop {
                match tokens.next().transpose()? {
                        ...
                        "StreamViewType" => {
                            builder = builder.set_stream_view_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| super::super::types::StreamViewType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
