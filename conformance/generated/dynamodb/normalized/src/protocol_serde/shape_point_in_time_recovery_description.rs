...
pub(crate) fn de_point_in_time_recovery_description<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::super::types::PointInTimeRecoveryDescription>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::super::types::builders::PointInTimeRecoveryDescriptionBuilder::default();
            loop {
                match tokens.next().transpose()? {
                        ...
                        "PointInTimeRecoveryStatus" => {
                            builder = builder.set_point_in_time_recovery_status(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| super::super::types::PointInTimeRecoveryStatus::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
