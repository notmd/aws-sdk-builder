...
pub fn de_update_kinesis_streaming_destination_http_error(
...
> {
    ...
    Err(match error_code {
        "InternalServerError" => {
            super::super::operation::update_kinesis_streaming_destination::UpdateKinesisStreamingDestinationError::InternalServerError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidEndpointException" => {
            super::super::operation::update_kinesis_streaming_destination::UpdateKinesisStreamingDestinationError::InvalidEndpointException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "LimitExceededException" => {
            super::super::operation::update_kinesis_streaming_destination::UpdateKinesisStreamingDestinationError::LimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceInUseException" => {
            super::super::operation::update_kinesis_streaming_destination::UpdateKinesisStreamingDestinationError::ResourceInUseException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            super::super::operation::update_kinesis_streaming_destination::UpdateKinesisStreamingDestinationError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        _ => super::super::operation::update_kinesis_streaming_destination::UpdateKinesisStreamingDestinationError::generic(generic),
    })
}
...
pub fn ser_update_kinesis_streaming_destination_input(
    ...
    super::super::protocol_serde::shape_update_kinesis_streaming_destination_input::ser_update_kinesis_streaming_destination_input_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub(crate) fn de_update_kinesis_streaming_destination(
    _value: &[u8],
    mut builder: super::super::operation::update_kinesis_streaming_destination::builders::UpdateKinesisStreamingDestinationOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::update_kinesis_streaming_destination::builders::UpdateKinesisStreamingDestinationOutputBuilder,
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "DestinationStatus" => {
                    builder = builder.set_destination_status(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| super::super::types::DestinationStatus::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "UpdateKinesisStreamingConfiguration" => {
                    builder = builder.set_update_kinesis_streaming_configuration(
                        super::super::protocol_serde::shape_update_kinesis_streaming_configuration::de_update_kinesis_streaming_configuration(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
