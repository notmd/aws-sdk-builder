...
pub(crate) fn de_replica_global_secondary_index_auto_scaling_description<'a, I>(
    ...
    Option<super::super::types::ReplicaGlobalSecondaryIndexAutoScalingDescription>,
    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::super::types::builders::ReplicaGlobalSecondaryIndexAutoScalingDescriptionBuilder::default();
            loop {
                match tokens.next().transpose()? {
