...
) -> std::result::Result<super::super::operation::create_global_table::CreateGlobalTableOutput, super::super::operation::create_global_table::CreateGlobalTableError>
{
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::create_global_table::CreateGlobalTableError::unhandled(generic)),
    };
    ...
    Err(match error_code {
        ...
        "InvalidEndpointException" => super::super::operation::create_global_table::CreateGlobalTableError::InvalidEndpointException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "LimitExceededException" => super::super::operation::create_global_table::CreateGlobalTableError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TableNotFoundException" => super::super::operation::create_global_table::CreateGlobalTableError::TableNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::super::operation::create_global_table::CreateGlobalTableError::generic(generic),
    })
}
...
) -> std::result::Result<super::super::operation::create_global_table::CreateGlobalTableOutput, super::super::operation::create_global_table::CreateGlobalTableError>
{
    Ok({
        ...
        output = super::super::protocol_serde::shape_create_global_table::de_create_global_table(_response_body, output)
            .map_err(super::super::operation::create_global_table::CreateGlobalTableError::unhandled)?;
...
pub fn ser_create_global_table_input(
    ...
    super::super::protocol_serde::shape_create_global_table_input::ser_create_global_table_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_create_global_table(
    _value: &[u8],
    mut builder: super::super::operation::create_global_table::builders::CreateGlobalTableOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::create_global_table::builders::CreateGlobalTableOutputBuilder,
