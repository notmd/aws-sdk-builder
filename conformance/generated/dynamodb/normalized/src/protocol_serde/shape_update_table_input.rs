...
pub fn ser_update_table_input_input(
    ...
    if let Some(var_7) = &input.provisioned_throughput {
        ...
        super::super::protocol_serde::shape_provisioned_throughput::ser_provisioned_throughput(&mut object_8, var_7)?;
        object_8.finish();
    }
        ...
        for item_11 in var_9 {
            {
                ...
                super::super::protocol_serde::shape_global_secondary_index_update::ser_global_secondary_index_update(&mut object_12, item_11)?;
                object_12.finish();
            }
        }
        array_10.finish();
    ...
    if let Some(var_13) = &input.stream_specification {
        ...
        super::super::protocol_serde::shape_stream_specification::ser_stream_specification(&mut object_14, var_13)?;
        object_14.finish();
    }
    if let Some(var_15) = &input.sse_specification {
        #[allow(unused_mut)]
        let mut object_16 = object.key("SSESpecification").start_object();
        super::super::protocol_serde::shape_sse_specification::ser_sse_specification(&mut object_16, var_15)?;
        object_16.finish();
    }
        ...
        for item_19 in var_17 {
            {
                ...
                super::super::protocol_serde::shape_replication_group_update::ser_replication_group_update(&mut object_20, item_19)?;
                object_20.finish();
            }
        }
        array_18.finish();
    ...
    if let Some(var_28) = &input.on_demand_throughput {
        ...
        super::super::protocol_serde::shape_on_demand_throughput::ser_on_demand_throughput(&mut object_29, var_28)?;
        object_29.finish();
    }
    if let Some(var_30) = &input.warm_throughput {
        #[allow(unused_mut)]
        let mut object_31 = object.key("WarmThroughput").start_object();
        super::super::protocol_serde::shape_warm_throughput::ser_warm_throughput(&mut object_31, var_30)?;
        object_31.finish();
    }
        ...
        for item_35 in var_33 {
            {
                ...
                super::super::protocol_serde::shape_vector_index_update::ser_vector_index_update(&mut object_36, item_35)?;
                object_36.finish();
            }
        }
        array_34.finish();
