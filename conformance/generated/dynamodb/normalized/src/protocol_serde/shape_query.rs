...
pub fn de_query_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::query::QueryOutput, super::super::operation::query::QueryError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::query::QueryError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InternalServerError" => super::super::operation::query::QueryError::InternalServerError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidEndpointException" => super::super::operation::query::QueryError::InvalidEndpointException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => super::super::operation::query::QueryError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ThrottlingException" => super::super::operation::query::QueryError::ThrottlingException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::super::operation::query::QueryError::generic(generic),
    })
}
...
pub fn ser_query_input(
    input: &super::super::operation::query::QueryInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    super::super::protocol_serde::shape_query_input::ser_query_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_query(
    _value: &[u8],
    mut builder: super::super::operation::query::builders::QueryOutputBuilder,
) -> ::std::result::Result<super::super::operation::query::builders::QueryOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
