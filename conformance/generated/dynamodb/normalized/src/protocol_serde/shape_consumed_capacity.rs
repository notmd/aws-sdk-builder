...
pub(crate) fn de_consumed_capacity<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::super::types::ConsumedCapacity>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::super::types::builders::ConsumedCapacityBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Table" => {
                            builder = builder.set_table(super::super::protocol_serde::shape_capacity::de_capacity(tokens, _value, depth + 1)?);
                        }
                        "LocalSecondaryIndexes" => {
                            builder = builder.set_local_secondary_indexes(
                                super::super::protocol_serde::shape_secondary_indexes_capacity_map::de_secondary_indexes_capacity_map(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
