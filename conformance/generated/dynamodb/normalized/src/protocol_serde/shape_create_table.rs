...
pub fn de_create_table_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::create_table::CreateTableOutput, super::super::operation::create_table::CreateTableError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::create_table::CreateTableError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InternalServerError" => super::super::operation::create_table::CreateTableError::InternalServerError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidEndpointException" => super::super::operation::create_table::CreateTableError::InvalidEndpointException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "LimitExceededException" => super::super::operation::create_table::CreateTableError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceInUseException" => super::super::operation::create_table::CreateTableError::ResourceInUseException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::super::operation::create_table::CreateTableError::generic(generic),
    })
}
...
pub fn de_create_table_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::create_table::builders::CreateTableOutputBuilder::default();
        output = super::super::protocol_serde::shape_create_table::de_create_table(_response_body, output)
            .map_err(super::super::operation::create_table::CreateTableError::unhandled)?;
...
pub fn ser_create_table_input(
    ...
    super::super::protocol_serde::shape_create_table_input::ser_create_table_input_input(&mut object, input)?;
    object.finish();
