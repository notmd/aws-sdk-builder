...
pub fn de_list_global_tables_http_error(
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::list_global_tables::ListGlobalTablesError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InternalServerError" => super::super::operation::list_global_tables::ListGlobalTablesError::InternalServerError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidEndpointException" => super::super::operation::list_global_tables::ListGlobalTablesError::InvalidEndpointException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::super::operation::list_global_tables::ListGlobalTablesError::generic(generic),
    })
}
...
pub fn de_list_global_tables_http_response(
    ...
    Ok({
        ...
        output = super::super::protocol_serde::shape_list_global_tables::de_list_global_tables(_response_body, output)
            .map_err(super::super::operation::list_global_tables::ListGlobalTablesError::unhandled)?;
...
pub fn ser_list_global_tables_input(
    ...
    super::super::protocol_serde::shape_list_global_tables_input::ser_list_global_tables_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_list_global_tables(
    _value: &[u8],
    mut builder: super::super::operation::list_global_tables::builders::ListGlobalTablesOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::list_global_tables::builders::ListGlobalTablesOutputBuilder,
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "GlobalTables" => {
                    builder = builder.set_global_tables(super::super::protocol_serde::shape_global_table_list::de_global_table_list(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
