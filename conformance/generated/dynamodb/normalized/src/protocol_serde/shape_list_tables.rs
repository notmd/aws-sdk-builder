...
pub fn de_list_tables_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::list_tables::ListTablesOutput, super::super::operation::list_tables::ListTablesError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::list_tables::ListTablesError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InternalServerError" => super::super::operation::list_tables::ListTablesError::InternalServerError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidEndpointException" => super::super::operation::list_tables::ListTablesError::InvalidEndpointException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::super::operation::list_tables::ListTablesError::generic(generic),
    })
}
...
pub fn de_list_tables_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_tables::builders::ListTablesOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_tables::de_list_tables(_response_body, output)
            .map_err(super::super::operation::list_tables::ListTablesError::unhandled)?;
...
pub fn ser_list_tables_input(
    ...
    super::super::protocol_serde::shape_list_tables_input::ser_list_tables_input_input(&mut object, input)?;
    object.finish();
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "TableNames" => {
                    builder = builder.set_table_names(super::super::protocol_serde::shape_table_name_list::de_table_name_list(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
