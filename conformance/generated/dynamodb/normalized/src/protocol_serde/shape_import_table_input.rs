...
pub fn ser_import_table_input_input(
    ...
    if let Some(var_2) = &input.s3_bucket_source {
        ...
        super::super::protocol_serde::shape_s3_bucket_source::ser_s3_bucket_source(&mut object_3, var_2)?;
        object_3.finish();
    }
    ...
    if let Some(var_5) = &input.input_format_options {
        ...
        super::super::protocol_serde::shape_input_format_options::ser_input_format_options(&mut object_6, var_5)?;
        object_6.finish();
    }
    ...
    if let Some(var_8) = &input.table_creation_parameters {
        ...
        super::super::protocol_serde::shape_table_creation_parameters::ser_table_creation_parameters(&mut object_9, var_8)?;
        object_9.finish();
    }
    Ok(())
}
