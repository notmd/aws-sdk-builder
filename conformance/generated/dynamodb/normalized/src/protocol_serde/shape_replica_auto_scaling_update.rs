...
pub fn ser_replica_auto_scaling_update(
    ...
    input: &super::super::types::ReplicaAutoScalingUpdate,
        ...
        for item_3 in var_1 {
            {
                ...
                super::super::protocol_serde::shape_replica_global_secondary_index_auto_scaling_update::ser_replica_global_secondary_index_auto_scaling_update(&mut object_4, item_3)?;
                object_4.finish();
            }
        }
        array_2.finish();
    ...
    if let Some(var_5) = &input.replica_provisioned_read_capacity_auto_scaling_update {
        ...
        super::super::protocol_serde::shape_auto_scaling_settings_update::ser_auto_scaling_settings_update(&mut object_6, var_5)?;
        object_6.finish();
    }
    Ok(())
}
