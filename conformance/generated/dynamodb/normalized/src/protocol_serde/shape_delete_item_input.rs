...
pub fn ser_delete_item_input_input(
        ...
        for (key_4, value_5) in var_2 {
            {
                ...
                super::super::protocol_serde::shape_attribute_value::ser_attribute_value(&mut object_6, value_5)?;
                object_6.finish();
            }
        }
        object_3.finish();
        ...
        for (key_9, value_10) in var_7 {
            {
                ...
                super::super::protocol_serde::shape_expected_attribute_value::ser_expected_attribute_value(&mut object_11, value_10)?;
                object_11.finish();
            }
        }
        object_8.finish();
    }
    if let Some(var_12) = &input.conditional_operator {
        object.key("ConditionalOperator").string(var_12.as_str());
    }
    if let Some(var_13) = &input.return_values {
        object.key("ReturnValues").string(var_13.as_str());
    }
    if let Some(var_14) = &input.return_consumed_capacity {
        ...
        for (key_23, value_24) in var_21 {
            {
                ...
                super::super::protocol_serde::shape_attribute_value::ser_attribute_value(&mut object_25, value_24)?;
                object_25.finish();
            }
        }
        object_22.finish();
