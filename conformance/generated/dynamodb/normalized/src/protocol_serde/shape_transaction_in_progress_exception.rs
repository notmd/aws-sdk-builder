...
pub(crate) fn de_transaction_in_progress_exception_json_err(
    _value: &[u8],
    mut builder: super::super::types::error::builders::TransactionInProgressExceptionBuilder,
) -> ::std::result::Result<
    super::super::types::error::builders::TransactionInProgressExceptionBuilder,
