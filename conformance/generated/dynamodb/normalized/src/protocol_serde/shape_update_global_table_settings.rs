...
> {
    ...
    Err(match error_code {
        "GlobalTableNotFoundException" => {
            super::super::operation::update_global_table_settings::UpdateGlobalTableSettingsError::GlobalTableNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "IndexNotFoundException" => super::super::operation::update_global_table_settings::UpdateGlobalTableSettingsError::IndexNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                let mut output = super::super::types::error::builders::IndexNotFoundExceptionBuilder::default();
                output = super::super::protocol_serde::shape_index_not_found_exception::de_index_not_found_exception_json_err(_response_body, output)
                    .map_err(super::super::operation::update_global_table_settings::UpdateGlobalTableSettingsError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
        ...
        "InternalServerError" => super::super::operation::update_global_table_settings::UpdateGlobalTableSettingsError::InternalServerError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::super::operation::update_global_table_settings::UpdateGlobalTableSettingsError::generic(generic),
    })
}
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::update_global_table_settings::builders::UpdateGlobalTableSettingsOutputBuilder::default();
        output = super::super::protocol_serde::shape_update_global_table_settings::de_update_global_table_settings(_response_body, output)
            .map_err(super::super::operation::update_global_table_settings::UpdateGlobalTableSettingsError::unhandled)?;
...
pub fn ser_update_global_table_settings_input(
    ...
    super::super::protocol_serde::shape_update_global_table_settings_input::ser_update_global_table_settings_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_update_global_table_settings(
    _value: &[u8],
    mut builder: super::super::operation::update_global_table_settings::builders::UpdateGlobalTableSettingsOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::update_global_table_settings::builders::UpdateGlobalTableSettingsOutputBuilder,
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "ReplicaSettings" => {
                    builder = builder.set_replica_settings(
                        super::super::protocol_serde::shape_replica_settings_description_list::de_replica_settings_description_list(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
