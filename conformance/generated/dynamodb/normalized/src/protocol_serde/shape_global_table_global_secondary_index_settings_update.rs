...
pub fn ser_global_table_global_secondary_index_settings_update(
    ...
    input: &super::super::types::GlobalTableGlobalSecondaryIndexSettingsUpdate,
    ...
    if let Some(var_2) = &input.provisioned_write_capacity_auto_scaling_settings_update {
        ...
        super::super::protocol_serde::shape_auto_scaling_settings_update::ser_auto_scaling_settings_update(&mut object_3, var_2)?;
        object_3.finish();
    }
    Ok(())
}
