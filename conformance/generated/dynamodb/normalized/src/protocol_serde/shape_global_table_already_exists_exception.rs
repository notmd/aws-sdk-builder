...
pub(crate) fn de_global_table_already_exists_exception_json_err(
    _value: &[u8],
    mut builder: super::super::types::error::builders::GlobalTableAlreadyExistsExceptionBuilder,
) -> ::std::result::Result<
    super::super::types::error::builders::GlobalTableAlreadyExistsExceptionBuilder,
