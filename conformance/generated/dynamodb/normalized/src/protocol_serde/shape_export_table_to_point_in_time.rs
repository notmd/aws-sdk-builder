...
> {
    ...
    Err(match error_code {
        ...
        "PointInTimeRecoveryUnavailableException" => {
            super::super::operation::export_table_to_point_in_time::ExportTableToPointInTimeError::PointInTimeRecoveryUnavailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = super::super::types::error::builders::PointInTimeRecoveryUnavailableExceptionBuilder::default();
                    output = super::super::protocol_serde::shape_point_in_time_recovery_unavailable_exception::de_point_in_time_recovery_unavailable_exception_json_err(_response_body, output).map_err(super::super::operation::export_table_to_point_in_time::ExportTableToPointInTimeError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        "TableNotFoundException" => super::super::operation::export_table_to_point_in_time::ExportTableToPointInTimeError::TableNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::super::operation::export_table_to_point_in_time::ExportTableToPointInTimeError::generic(generic),
    })
}
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::export_table_to_point_in_time::builders::ExportTableToPointInTimeOutputBuilder::default();
        output = super::super::protocol_serde::shape_export_table_to_point_in_time::de_export_table_to_point_in_time(_response_body, output)
            .map_err(super::super::operation::export_table_to_point_in_time::ExportTableToPointInTimeError::unhandled)?;
...
pub fn ser_export_table_to_point_in_time_input(
    ...
    super::super::protocol_serde::shape_export_table_to_point_in_time_input::ser_export_table_to_point_in_time_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_export_table_to_point_in_time(
    _value: &[u8],
    mut builder: super::super::operation::export_table_to_point_in_time::builders::ExportTableToPointInTimeOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::export_table_to_point_in_time::builders::ExportTableToPointInTimeOutputBuilder,
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ExportDescription" => {
                    builder = builder.set_export_description(super::super::protocol_serde::shape_export_description::de_export_description(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
