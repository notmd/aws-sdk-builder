...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::describe_table_replica_auto_scaling::DescribeTableReplicaAutoScalingError::unhandled(generic)),
    };
    ...
    Err(match error_code {
        ...
        _ => super::super::operation::describe_table_replica_auto_scaling::DescribeTableReplicaAutoScalingError::generic(generic),
    })
}
...
pub(crate) fn de_describe_table_replica_auto_scaling(
    _value: &[u8],
    mut builder: super::super::operation::describe_table_replica_auto_scaling::builders::DescribeTableReplicaAutoScalingOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::describe_table_replica_auto_scaling::builders::DescribeTableReplicaAutoScalingOutputBuilder,
