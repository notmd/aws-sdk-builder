...
> {
    ...
    Err(super::super::operation::describe_endpoints::DescribeEndpointsError::generic(generic))
}
...
> {
    Ok({
        ...
        output = super::super::protocol_serde::shape_describe_endpoints::de_describe_endpoints(_response_body, output)
            .map_err(super::super::operation::describe_endpoints::DescribeEndpointsError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::super::serde_util::describe_endpoints_output_output_correct_errors(output)
            .build()
            .map_err(super::super::operation::describe_endpoints::DescribeEndpointsError::unhandled)?
    })
}
...
pub(crate) fn de_describe_endpoints(
    ...
    super::super::operation::describe_endpoints::builders::DescribeEndpointsOutputBuilder,
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "Endpoints" => {
                    builder = builder.set_endpoints(super::super::protocol_serde::shape_endpoints::de_endpoints(tokens, _value, depth + 1)?);
                }
