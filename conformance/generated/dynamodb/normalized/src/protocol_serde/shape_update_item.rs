...
pub fn de_update_item_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::update_item::UpdateItemOutput, super::super::operation::update_item::UpdateItemError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::update_item::UpdateItemError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "ConditionalCheckFailedException" => super::super::operation::update_item::UpdateItemError::ConditionalCheckFailedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalServerError" => super::super::operation::update_item::UpdateItemError::InternalServerError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidEndpointException" => super::super::operation::update_item::UpdateItemError::InvalidEndpointException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "RequestLimitExceeded" => super::super::operation::update_item::UpdateItemError::RequestLimitExceeded({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => super::super::operation::update_item::UpdateItemError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ThrottlingException" => super::super::operation::update_item::UpdateItemError::ThrottlingException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TransactionConflictException" => super::super::operation::update_item::UpdateItemError::TransactionConflictException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::super::operation::update_item::UpdateItemError::generic(generic),
    })
}
...
pub fn de_update_item_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::update_item::builders::UpdateItemOutputBuilder::default();
        output = super::super::protocol_serde::shape_update_item::de_update_item(_response_body, output)
            .map_err(super::super::operation::update_item::UpdateItemError::unhandled)?;
...
pub fn ser_update_item_input(
    input: &super::super::operation::update_item::UpdateItemInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    super::super::protocol_serde::shape_update_item_input::ser_update_item_input_input(&mut object, input)?;
    object.finish();
