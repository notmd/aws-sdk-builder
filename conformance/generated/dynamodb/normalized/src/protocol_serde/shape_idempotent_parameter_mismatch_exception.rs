...
pub(crate) fn de_idempotent_parameter_mismatch_exception_json_err(
    _value: &[u8],
    mut builder: super::super::types::error::builders::IdempotentParameterMismatchExceptionBuilder,
) -> ::std::result::Result<
    super::super::types::error::builders::IdempotentParameterMismatchExceptionBuilder,
