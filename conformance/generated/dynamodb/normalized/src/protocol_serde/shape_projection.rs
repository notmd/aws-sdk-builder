...
pub fn ser_projection(
    ...
    input: &super::super::types::Projection,
...
pub(crate) fn de_projection<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::super::types::Projection>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::super::types::builders::ProjectionBuilder::default();
            loop {
                match tokens.next().transpose()? {
                        ...
                        "ProjectionType" => {
                            builder = builder.set_projection_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| super::super::types::ProjectionType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "NonKeyAttributes" => {
