...
pub(crate) fn de_replicated_write_conflict_exception_json_err(
    _value: &[u8],
    mut builder: super::super::types::error::builders::ReplicatedWriteConflictExceptionBuilder,
) -> ::std::result::Result<
    super::super::types::error::builders::ReplicatedWriteConflictExceptionBuilder,
