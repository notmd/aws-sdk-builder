...
pub fn de_list_backups_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::list_backups::ListBackupsOutput, super::super::operation::list_backups::ListBackupsError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::list_backups::ListBackupsError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InternalServerError" => super::super::operation::list_backups::ListBackupsError::InternalServerError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidEndpointException" => super::super::operation::list_backups::ListBackupsError::InvalidEndpointException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::super::operation::list_backups::ListBackupsError::generic(generic),
    })
}
...
pub fn de_list_backups_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::list_backups::builders::ListBackupsOutputBuilder::default();
        output = super::super::protocol_serde::shape_list_backups::de_list_backups(_response_body, output)
            .map_err(super::super::operation::list_backups::ListBackupsError::unhandled)?;
...
pub fn ser_list_backups_input(
    ...
    super::super::protocol_serde::shape_list_backups_input::ser_list_backups_input_input(&mut object, input)?;
    object.finish();
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "BackupSummaries" => {
                    builder = builder.set_backup_summaries(super::super::protocol_serde::shape_backup_summaries::de_backup_summaries(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
