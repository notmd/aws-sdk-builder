...
pub(crate) fn de_table_description<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::super::types::TableDescription>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::super::types::builders::TableDescriptionBuilder::default();
            loop {
                match tokens.next().transpose()? {
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "BillingModeSummary" => {
                                builder = builder.set_billing_mode_summary(
                                    super::super::protocol_serde::shape_billing_mode_summary::de_billing_mode_summary(tokens, _value, depth + 1)?,
                                );
                            }
                            ...
                            "GlobalTableSettingsReplicationMode" => {
                                builder = builder.set_global_table_settings_replication_mode(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                        .map(|s| {
                                            s.to_unescaped()
                                                .map(|u| super::super::types::GlobalTableSettingsReplicationMode::from(u.as_ref()))
                                        })
                                        .transpose()?,
                                );
                            }
                            "RestoreSummary" => {
                                builder = builder.set_restore_summary(super::super::protocol_serde::shape_restore_summary::de_restore_summary(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "SSEDescription" => {
                                builder = builder.set_sse_description(super::super::protocol_serde::shape_sse_description::de_sse_description(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "ArchivalSummary" => {
                                builder = builder.set_archival_summary(super::super::protocol_serde::shape_archival_summary::de_archival_summary(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "WarmThroughput" => {
                                builder = builder.set_warm_throughput(
                                    super::super::protocol_serde::shape_table_warm_throughput_description::de_table_warm_throughput_description(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
                            ...
                            "MultiRegionConsistency" => {
                                builder = builder.set_multi_region_consistency(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                        .map(|s| s.to_unescaped().map(|u| super::super::types::MultiRegionConsistency::from(u.as_ref())))
                                        .transpose()?,
                                );
                            }
                            "VectorIndexes" => {
                                builder = builder.set_vector_indexes(
                                    super::super::protocol_serde::shape_vector_index_description_list::de_vector_index_description_list(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
