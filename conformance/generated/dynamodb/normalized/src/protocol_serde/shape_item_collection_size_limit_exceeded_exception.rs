...
pub(crate) fn de_item_collection_size_limit_exceeded_exception_json_err(
    _value: &[u8],
    mut builder: super::super::types::error::builders::ItemCollectionSizeLimitExceededExceptionBuilder,
) -> ::std::result::Result<
    super::super::types::error::builders::ItemCollectionSizeLimitExceededExceptionBuilder,
