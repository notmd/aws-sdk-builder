...
pub fn ser_restore_table_to_point_in_time_input_input(
        ...
        for item_9 in var_7 {
            {
                ...
                super::super::protocol_serde::shape_global_secondary_index::ser_global_secondary_index(&mut object_10, item_9)?;
                object_10.finish();
            }
        }
        array_8.finish();
        ...
        for item_13 in var_11 {
            {
                ...
                super::super::protocol_serde::shape_local_secondary_index::ser_local_secondary_index(&mut object_14, item_13)?;
                object_14.finish();
            }
        }
        array_12.finish();
    ...
    if let Some(var_15) = &input.provisioned_throughput_override {
        ...
        super::super::protocol_serde::shape_provisioned_throughput::ser_provisioned_throughput(&mut object_16, var_15)?;
        object_16.finish();
    }
    if let Some(var_17) = &input.on_demand_throughput_override {
        ...
        super::super::protocol_serde::shape_on_demand_throughput::ser_on_demand_throughput(&mut object_18, var_17)?;
        object_18.finish();
    }
    if let Some(var_19) = &input.sse_specification_override {
        #[allow(unused_mut)]
        let mut object_20 = object.key("SSESpecificationOverride").start_object();
        super::super::protocol_serde::shape_sse_specification::ser_sse_specification(&mut object_20, var_19)?;
        object_20.finish();
    }
        ...
        for item_23 in var_21 {
            {
                ...
                super::super::protocol_serde::shape_vector_index::ser_vector_index(&mut object_24, item_23)?;
                object_24.finish();
            }
        }
        array_22.finish();
