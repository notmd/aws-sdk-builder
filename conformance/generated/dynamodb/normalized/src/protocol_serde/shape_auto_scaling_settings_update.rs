...
pub fn ser_auto_scaling_settings_update(
    ...
    input: &super::super::types::AutoScalingSettingsUpdate,
    ...
    if let Some(var_5) = &input.scaling_policy_update {
        ...
        super::super::protocol_serde::shape_auto_scaling_policy_update::ser_auto_scaling_policy_update(&mut object_6, var_5)?;
        object_6.finish();
    }
    Ok(())
}
