...
pub(crate) fn de_continuous_backups_unavailable_exception_json_err(
    _value: &[u8],
    mut builder: super::super::types::error::builders::ContinuousBackupsUnavailableExceptionBuilder,
) -> ::std::result::Result<
    super::super::types::error::builders::ContinuousBackupsUnavailableExceptionBuilder,
