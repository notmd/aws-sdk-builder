...
pub fn ser_expected_attribute_value(
    ...
    input: &super::super::types::ExpectedAttributeValue,
) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    if let Some(var_1) = &input.value {
        #[allow(unused_mut)]
        let mut object_2 = object.key("Value").start_object();
        super::super::protocol_serde::shape_attribute_value::ser_attribute_value(&mut object_2, var_1)?;
        object_2.finish();
    }
        ...
        for item_7 in var_5 {
            {
                ...
                super::super::protocol_serde::shape_attribute_value::ser_attribute_value(&mut object_8, item_7)?;
                object_8.finish();
            }
        }
        array_6.finish();
