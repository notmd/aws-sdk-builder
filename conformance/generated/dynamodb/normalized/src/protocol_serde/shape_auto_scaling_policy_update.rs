...
pub fn ser_auto_scaling_policy_update(
    ...
    input: &super::super::types::AutoScalingPolicyUpdate,
    ...
    if let Some(var_2) = &input.target_tracking_scaling_policy_configuration {
        ...
        super::super::protocol_serde::shape_auto_scaling_target_tracking_scaling_policy_configuration_update::ser_auto_scaling_target_tracking_scaling_policy_configuration_update(&mut object_3, var_2)?;
        object_3.finish();
    }
    Ok(())
}
