...
> {
    ...
    Err(match error_code {
        "InternalServerError" => {
            super::super::operation::enable_kinesis_streaming_destination::EnableKinesisStreamingDestinationError::InternalServerError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidEndpointException" => {
            super::super::operation::enable_kinesis_streaming_destination::EnableKinesisStreamingDestinationError::InvalidEndpointException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "LimitExceededException" => {
            super::super::operation::enable_kinesis_streaming_destination::EnableKinesisStreamingDestinationError::LimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceInUseException" => {
            super::super::operation::enable_kinesis_streaming_destination::EnableKinesisStreamingDestinationError::ResourceInUseException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            super::super::operation::enable_kinesis_streaming_destination::EnableKinesisStreamingDestinationError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        _ => super::super::operation::enable_kinesis_streaming_destination::EnableKinesisStreamingDestinationError::generic(generic),
    })
}
...
pub fn ser_enable_kinesis_streaming_destination_input(
    ...
    super::super::protocol_serde::shape_enable_kinesis_streaming_destination_input::ser_enable_kinesis_streaming_destination_input_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub(crate) fn de_enable_kinesis_streaming_destination(
    _value: &[u8],
    mut builder: super::super::operation::enable_kinesis_streaming_destination::builders::EnableKinesisStreamingDestinationOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::enable_kinesis_streaming_destination::builders::EnableKinesisStreamingDestinationOutputBuilder,
