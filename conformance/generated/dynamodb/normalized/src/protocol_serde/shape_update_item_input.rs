        ...
        for (key_9, value_10) in var_7 {
            {
                ...
                super::super::protocol_serde::shape_attribute_value_update::ser_attribute_value_update(&mut object_11, value_10)?;
                object_11.finish();
            }
        }
        object_8.finish();
        ...
        for (key_14, value_15) in var_12 {
            {
                ...
                super::super::protocol_serde::shape_expected_attribute_value::ser_expected_attribute_value(&mut object_16, value_15)?;
                object_16.finish();
            }
        }
        object_13.finish();
        ...
        for (key_29, value_30) in var_27 {
            {
                ...
                super::super::protocol_serde::shape_attribute_value::ser_attribute_value(&mut object_31, value_30)?;
                object_31.finish();
            }
        }
        object_28.finish();
