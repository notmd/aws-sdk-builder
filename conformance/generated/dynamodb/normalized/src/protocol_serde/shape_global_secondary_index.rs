...
pub fn ser_global_secondary_index(
    ...
    input: &super::super::types::GlobalSecondaryIndex,
        ...
        for item_2 in &input.key_schema {
            {
                ...
                super::super::protocol_serde::shape_key_schema_element::ser_key_schema_element(&mut object_3, item_2)?;
                object_3.finish();
            }
        }
        array_1.finish();
    ...
    if let Some(var_4) = &input.projection {
        ...
        super::super::protocol_serde::shape_projection::ser_projection(&mut object_5, var_4)?;
        object_5.finish();
    }
    if let Some(var_6) = &input.provisioned_throughput {
        #[allow(unused_mut)]
        let mut object_7 = object.key("ProvisionedThroughput").start_object();
        super::super::protocol_serde::shape_provisioned_throughput::ser_provisioned_throughput(&mut object_7, var_6)?;
        object_7.finish();
    }
    if let Some(var_8) = &input.on_demand_throughput {
        #[allow(unused_mut)]
        let mut object_9 = object.key("OnDemandThroughput").start_object();
        super::super::protocol_serde::shape_on_demand_throughput::ser_on_demand_throughput(&mut object_9, var_8)?;
        object_9.finish();
    }
    if let Some(var_10) = &input.warm_throughput {
        #[allow(unused_mut)]
        let mut object_11 = object.key("WarmThroughput").start_object();
        super::super::protocol_serde::shape_warm_throughput::ser_warm_throughput(&mut object_11, var_10)?;
        object_11.finish();
    }
    Ok(())
}
...
pub(crate) fn de_global_secondary_index<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::super::types::GlobalSecondaryIndex>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::super::types::builders::GlobalSecondaryIndexBuilder::default();
            loop {
                match tokens.next().transpose()? {
