...
> {
    ...
    Err(match error_code {
        "InternalServerError" => super::super::operation::describe_continuous_backups::DescribeContinuousBackupsError::InternalServerError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::super::operation::describe_continuous_backups::DescribeContinuousBackupsError::generic(generic),
    })
}
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::describe_continuous_backups::builders::DescribeContinuousBackupsOutputBuilder::default();
        output = super::super::protocol_serde::shape_describe_continuous_backups::de_describe_continuous_backups(_response_body, output)
            .map_err(super::super::operation::describe_continuous_backups::DescribeContinuousBackupsError::unhandled)?;
...
pub fn ser_describe_continuous_backups_input(
    ...
    super::super::protocol_serde::shape_describe_continuous_backups_input::ser_describe_continuous_backups_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_describe_continuous_backups(
    _value: &[u8],
    mut builder: super::super::operation::describe_continuous_backups::builders::DescribeContinuousBackupsOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::describe_continuous_backups::builders::DescribeContinuousBackupsOutputBuilder,
