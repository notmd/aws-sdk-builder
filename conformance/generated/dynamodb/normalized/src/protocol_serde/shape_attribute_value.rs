...
pub(crate) fn de_attribute_value<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::super::types::AttributeValue>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            match tokens.next().transpose()? {
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        ...
                        "SS" => Some(super::super::types::AttributeValue::Ss(
                        ...
                        "NS" => Some(super::super::types::AttributeValue::Ns(
                        ...
                        "BS" => Some(super::super::types::AttributeValue::Bs(
                        ...
                        "M" => Some(super::super::types::AttributeValue::M(
                        ...
                        "L" => Some(super::super::types::AttributeValue::L(
