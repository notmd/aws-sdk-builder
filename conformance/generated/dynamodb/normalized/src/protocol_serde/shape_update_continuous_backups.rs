...
> {
    ...
    Err(match error_code {
        "ContinuousBackupsUnavailableException" => {
            super::super::operation::update_continuous_backups::UpdateContinuousBackupsError::ContinuousBackupsUnavailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InternalServerError" => super::super::operation::update_continuous_backups::UpdateContinuousBackupsError::InternalServerError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidEndpointException" => super::super::operation::update_continuous_backups::UpdateContinuousBackupsError::InvalidEndpointException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TableNotFoundException" => super::super::operation::update_continuous_backups::UpdateContinuousBackupsError::TableNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::super::operation::update_continuous_backups::UpdateContinuousBackupsError::generic(generic),
    })
}
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::update_continuous_backups::builders::UpdateContinuousBackupsOutputBuilder::default();
        output = super::super::protocol_serde::shape_update_continuous_backups::de_update_continuous_backups(_response_body, output)
            .map_err(super::super::operation::update_continuous_backups::UpdateContinuousBackupsError::unhandled)?;
...
pub fn ser_update_continuous_backups_input(
    ...
    super::super::protocol_serde::shape_update_continuous_backups_input::ser_update_continuous_backups_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_update_continuous_backups(
    _value: &[u8],
    mut builder: super::super::operation::update_continuous_backups::builders::UpdateContinuousBackupsOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::update_continuous_backups::builders::UpdateContinuousBackupsOutputBuilder,
