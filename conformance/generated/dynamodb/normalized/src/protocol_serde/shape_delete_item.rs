...
pub fn de_delete_item_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::delete_item::DeleteItemOutput, super::super::operation::delete_item::DeleteItemError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::delete_item::DeleteItemError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "ConditionalCheckFailedException" => super::super::operation::delete_item::DeleteItemError::ConditionalCheckFailedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalServerError" => super::super::operation::delete_item::DeleteItemError::InternalServerError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidEndpointException" => super::super::operation::delete_item::DeleteItemError::InvalidEndpointException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "RequestLimitExceeded" => super::super::operation::delete_item::DeleteItemError::RequestLimitExceeded({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => super::super::operation::delete_item::DeleteItemError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ThrottlingException" => super::super::operation::delete_item::DeleteItemError::ThrottlingException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TransactionConflictException" => super::super::operation::delete_item::DeleteItemError::TransactionConflictException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::super::operation::delete_item::DeleteItemError::generic(generic),
    })
}
...
pub fn de_delete_item_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::delete_item::builders::DeleteItemOutputBuilder::default();
        output = super::super::protocol_serde::shape_delete_item::de_delete_item(_response_body, output)
            .map_err(super::super::operation::delete_item::DeleteItemError::unhandled)?;
...
pub fn ser_delete_item_input(
    input: &super::super::operation::delete_item::DeleteItemInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    super::super::protocol_serde::shape_delete_item_input::ser_delete_item_input_input(&mut object, input)?;
    object.finish();
