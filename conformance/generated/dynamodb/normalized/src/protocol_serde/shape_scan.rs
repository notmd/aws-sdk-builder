...
pub fn de_scan_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::super::operation::scan::ScanOutput, super::super::operation::scan::ScanError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::scan::ScanError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InternalServerError" => super::super::operation::scan::ScanError::InternalServerError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidEndpointException" => super::super::operation::scan::ScanError::InvalidEndpointException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => super::super::operation::scan::ScanError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ThrottlingException" => super::super::operation::scan::ScanError::ThrottlingException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::super::operation::scan::ScanError::generic(generic),
    })
}
...
pub fn ser_scan_input(
    input: &super::super::operation::scan::ScanInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    super::super::protocol_serde::shape_scan_input::ser_scan_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_scan(
    _value: &[u8],
    mut builder: super::super::operation::scan::builders::ScanOutputBuilder,
) -> ::std::result::Result<super::super::operation::scan::builders::ScanOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
