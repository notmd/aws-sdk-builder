...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::transact_get_items::TransactGetItemsError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InternalServerError" => super::super::operation::transact_get_items::TransactGetItemsError::InternalServerError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidEndpointException" => super::super::operation::transact_get_items::TransactGetItemsError::InvalidEndpointException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ProvisionedThroughputExceededException" => {
            super::super::operation::transact_get_items::TransactGetItemsError::ProvisionedThroughputExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = super::super::types::error::builders::ProvisionedThroughputExceededExceptionBuilder::default();
                    output = super::super::protocol_serde::shape_provisioned_throughput_exceeded_exception::de_provisioned_throughput_exceeded_exception_json_err(_response_body, output).map_err(super::super::operation::transact_get_items::TransactGetItemsError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        "RequestLimitExceeded" => super::super::operation::transact_get_items::TransactGetItemsError::RequestLimitExceeded({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => super::super::operation::transact_get_items::TransactGetItemsError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ThrottlingException" => super::super::operation::transact_get_items::TransactGetItemsError::ThrottlingException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TransactionCanceledException" => super::super::operation::transact_get_items::TransactGetItemsError::TransactionCanceledException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::super::operation::transact_get_items::TransactGetItemsError::generic(generic),
    })
}
...
> {
    Ok({
        ...
        output = super::super::protocol_serde::shape_transact_get_items::de_transact_get_items(_response_body, output)
            .map_err(super::super::operation::transact_get_items::TransactGetItemsError::unhandled)?;
...
pub fn ser_transact_get_items_input(
    ...
    super::super::protocol_serde::shape_transact_get_items_input::ser_transact_get_items_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_transact_get_items(
    _value: &[u8],
    mut builder: super::super::operation::transact_get_items::builders::TransactGetItemsOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::transact_get_items::builders::TransactGetItemsOutputBuilder,
