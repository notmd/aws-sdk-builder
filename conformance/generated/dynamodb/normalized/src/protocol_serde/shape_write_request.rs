...
pub fn ser_write_request(
    ...
    input: &super::super::types::WriteRequest,
) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    if let Some(var_1) = &input.put_request {
        #[allow(unused_mut)]
        let mut object_2 = object.key("PutRequest").start_object();
        super::super::protocol_serde::shape_put_request::ser_put_request(&mut object_2, var_1)?;
        object_2.finish();
    }
    if let Some(var_3) = &input.delete_request {
        #[allow(unused_mut)]
        let mut object_4 = object.key("DeleteRequest").start_object();
        super::super::protocol_serde::shape_delete_request::ser_delete_request(&mut object_4, var_3)?;
        object_4.finish();
    }
    Ok(())
}
...
pub(crate) fn de_write_request<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::super::types::WriteRequest>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::super::types::builders::WriteRequestBuilder::default();
            loop {
                match tokens.next().transpose()? {
