...
pub fn de_describe_limits_http_error(
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::describe_limits::DescribeLimitsError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InternalServerError" => super::super::operation::describe_limits::DescribeLimitsError::InternalServerError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidEndpointException" => super::super::operation::describe_limits::DescribeLimitsError::InvalidEndpointException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::super::operation::describe_limits::DescribeLimitsError::generic(generic),
    })
}
...
pub fn de_describe_limits_http_response(
    ...
    Ok({
        ...
        output = super::super::protocol_serde::shape_describe_limits::de_describe_limits(_response_body, output)
            .map_err(super::super::operation::describe_limits::DescribeLimitsError::unhandled)?;
...
pub(crate) fn de_describe_limits(
    ...
    super::super::operation::describe_limits::builders::DescribeLimitsOutputBuilder,
