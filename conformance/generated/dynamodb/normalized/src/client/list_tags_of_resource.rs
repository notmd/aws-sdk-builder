...
impl super::Client {
    ...
    pub fn list_tags_of_resource(&self) -> super::super::operation::list_tags_of_resource::builders::ListTagsOfResourceFluentBuilder {
        super::super::operation::list_tags_of_resource::builders::ListTagsOfResourceFluentBuilder::new(self.handle.clone())
    }
}
