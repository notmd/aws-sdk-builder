...
impl super::Client {
    ...
    ///   - [`table_name(impl Into<String>)`](crate::operation::update_time_to_live::builders::UpdateTimeToLiveFluentBuilder::table_name) / [`set_table_name(Option<String>)`](crate::operation::update_time_to_live::builders::UpdateTimeToLiveFluentBuilder::set_table_name):<br>required: **true**<br><p>The name of the table to be configured. You can also provide the Amazon Resource Name (ARN) of the table in this parameter.</p><br>
    ...
    pub fn update_time_to_live(&self) -> super::super::operation::update_time_to_live::builders::UpdateTimeToLiveFluentBuilder {
        super::super::operation::update_time_to_live::builders::UpdateTimeToLiveFluentBuilder::new(self.handle.clone())
    }
}
