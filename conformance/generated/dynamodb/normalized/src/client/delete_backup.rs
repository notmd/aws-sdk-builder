...
impl super::Client {
    ...
    pub fn delete_backup(&self) -> super::super::operation::delete_backup::builders::DeleteBackupFluentBuilder {
        super::super::operation::delete_backup::builders::DeleteBackupFluentBuilder::new(self.handle.clone())
    }
}
