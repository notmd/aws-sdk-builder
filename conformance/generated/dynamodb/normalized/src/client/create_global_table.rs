...
impl super::Client {
    ...
    pub fn create_global_table(&self) -> super::super::operation::create_global_table::builders::CreateGlobalTableFluentBuilder {
        super::super::operation::create_global_table::builders::CreateGlobalTableFluentBuilder::new(self.handle.clone())
    }
}
