...
impl super::Client {
    ...
    pub fn update_continuous_backups(&self) -> super::super::operation::update_continuous_backups::builders::UpdateContinuousBackupsFluentBuilder {
        super::super::operation::update_continuous_backups::builders::UpdateContinuousBackupsFluentBuilder::new(self.handle.clone())
    }
}
