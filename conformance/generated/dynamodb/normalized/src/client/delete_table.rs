...
impl super::Client {
    ...
    pub fn delete_table(&self) -> super::super::operation::delete_table::builders::DeleteTableFluentBuilder {
        super::super::operation::delete_table::builders::DeleteTableFluentBuilder::new(self.handle.clone())
    }
}
