...
impl super::Client {
    ...
    pub fn describe_endpoints(&self) -> super::super::operation::describe_endpoints::builders::DescribeEndpointsFluentBuilder {
        super::super::operation::describe_endpoints::builders::DescribeEndpointsFluentBuilder::new(self.handle.clone())
    }
}
