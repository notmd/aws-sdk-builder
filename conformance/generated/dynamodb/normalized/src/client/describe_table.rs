...
impl super::Client {
    ...
    pub fn describe_table(&self) -> super::super::operation::describe_table::builders::DescribeTableFluentBuilder {
        super::super::operation::describe_table::builders::DescribeTableFluentBuilder::new(self.handle.clone())
    }
}
