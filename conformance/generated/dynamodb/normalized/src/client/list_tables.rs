...
impl super::Client {
    ...
    pub fn list_tables(&self) -> super::super::operation::list_tables::builders::ListTablesFluentBuilder {
        super::super::operation::list_tables::builders::ListTablesFluentBuilder::new(self.handle.clone())
    }
}
