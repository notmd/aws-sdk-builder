...
impl super::Client {
    ...
    pub fn describe_limits(&self) -> super::super::operation::describe_limits::builders::DescribeLimitsFluentBuilder {
        super::super::operation::describe_limits::builders::DescribeLimitsFluentBuilder::new(self.handle.clone())
    }
}
