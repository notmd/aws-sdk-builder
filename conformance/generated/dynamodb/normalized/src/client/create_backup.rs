...
impl super::Client {
    ...
    pub fn create_backup(&self) -> super::super::operation::create_backup::builders::CreateBackupFluentBuilder {
        super::super::operation::create_backup::builders::CreateBackupFluentBuilder::new(self.handle.clone())
    }
}
