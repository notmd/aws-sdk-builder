...
impl super::Client {
    ...
    pub fn describe_export(&self) -> super::super::operation::describe_export::builders::DescribeExportFluentBuilder {
        super::super::operation::describe_export::builders::DescribeExportFluentBuilder::new(self.handle.clone())
    }
}
