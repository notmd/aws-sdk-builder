...
impl super::Client {
    ...
    pub fn execute_transaction(&self) -> super::super::operation::execute_transaction::builders::ExecuteTransactionFluentBuilder {
        super::super::operation::execute_transaction::builders::ExecuteTransactionFluentBuilder::new(self.handle.clone())
    }
}
