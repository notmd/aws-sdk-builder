...
impl super::Client {
    ...
    pub fn describe_backup(&self) -> super::super::operation::describe_backup::builders::DescribeBackupFluentBuilder {
        super::super::operation::describe_backup::builders::DescribeBackupFluentBuilder::new(self.handle.clone())
    }
}
