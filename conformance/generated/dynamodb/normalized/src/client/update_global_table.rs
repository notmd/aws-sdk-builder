...
impl super::Client {
    ...
    pub fn update_global_table(&self) -> super::super::operation::update_global_table::builders::UpdateGlobalTableFluentBuilder {
        super::super::operation::update_global_table::builders::UpdateGlobalTableFluentBuilder::new(self.handle.clone())
    }
}
