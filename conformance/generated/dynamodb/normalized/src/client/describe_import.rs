...
impl super::Client {
    ...
    ///   - [`import_arn(impl Into<String>)`](crate::operation::describe_import::builders::DescribeImportFluentBuilder::import_arn) / [`set_import_arn(Option<String>)`](crate::operation::describe_import::builders::DescribeImportFluentBuilder::set_import_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) associated with the table you're importing to.</p><br>
    ...
    pub fn describe_import(&self) -> super::super::operation::describe_import::builders::DescribeImportFluentBuilder {
        super::super::operation::describe_import::builders::DescribeImportFluentBuilder::new(self.handle.clone())
    }
}
