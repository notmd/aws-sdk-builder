...
impl super::Client {
    ...
    pub fn list_imports(&self) -> super::super::operation::list_imports::builders::ListImportsFluentBuilder {
        super::super::operation::list_imports::builders::ListImportsFluentBuilder::new(self.handle.clone())
    }
}
