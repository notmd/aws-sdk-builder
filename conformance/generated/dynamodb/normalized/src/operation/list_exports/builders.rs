...
pub use super::super::super::operation::list_exports::_list_exports_input::ListExportsInputBuilder;

pub use super::super::super::operation::list_exports::_list_exports_output::ListExportsOutputBuilder;

impl super::super::super::operation::list_exports::builders::ListExportsInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::list_exports::ListExportsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::list_exports::ListExportsError,
...
pub struct ListExportsFluentBuilder {
    ...
    inner: super::super::super::operation::list_exports::builders::ListExportsInputBuilder,
...
impl ListExportsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::list_exports::builders::ListExportsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::list_exports::ListExports::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::list_exports::ListExports::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::super::super::operation::list_exports::paginator::ListExportsPaginator {
        super::super::super::operation::list_exports::paginator::ListExportsPaginator::new(self.handle, self.inner)
    }
