...
impl ListExportsOutput {
    ...
    pub fn export_summaries(&self) -> &[super::super::super::types::ExportSummary] {
...
impl ListExportsOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_exports::builders::ListExportsOutputBuilder {
        super::super::super::operation::list_exports::builders::ListExportsOutputBuilder::default()
    }
}
...
pub struct ListExportsOutputBuilder {
    pub(crate) export_summaries: ::std::option::Option<::std::vec::Vec<super::super::super::types::ExportSummary>>,
...
impl ListExportsOutputBuilder {
    ...
    ///
    /// <p>A list of <code>ExportSummary</code> objects.</p>
    pub fn export_summaries(mut self, input: super::super::super::types::ExportSummary) -> Self {
    ...
    /// <p>A list of <code>ExportSummary</code> objects.</p>
    pub fn set_export_summaries(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::ExportSummary>>) -> Self {
        self.export_summaries = input;
        self
    }
    /// <p>A list of <code>ExportSummary</code> objects.</p>
    pub fn get_export_summaries(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::ExportSummary>> {
    ...
    pub fn build(self) -> super::super::super::operation::list_exports::ListExportsOutput {
