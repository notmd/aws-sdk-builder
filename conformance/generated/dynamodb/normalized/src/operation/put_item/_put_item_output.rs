...
impl PutItemOutput {
    ...
    pub fn builder() -> super::super::super::operation::put_item::builders::PutItemOutputBuilder {
        super::super::super::operation::put_item::builders::PutItemOutputBuilder::default()
    }
}
...
impl PutItemOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::put_item::PutItemOutput {
