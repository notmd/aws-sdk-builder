...
impl DescribeTableReplicaAutoScalingInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_table_replica_auto_scaling::builders::DescribeTableReplicaAutoScalingInputBuilder {
        super::super::super::operation::describe_table_replica_auto_scaling::builders::DescribeTableReplicaAutoScalingInputBuilder::default()
    }
}
...
impl DescribeTableReplicaAutoScalingInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::describe_table_replica_auto_scaling::DescribeTableReplicaAutoScalingInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(
            super::super::super::operation::describe_table_replica_auto_scaling::DescribeTableReplicaAutoScalingInput { table_name: self.table_name },
        )
    }
}
