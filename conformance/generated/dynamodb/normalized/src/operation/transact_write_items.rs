...
impl TransactWriteItems {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::transact_write_items::TransactWriteItemsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::transact_write_items::TransactWriteItemsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("DynamoDB", "TransactWriteItems", input, runtime_plugins, stop_point)
    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(super::super::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut super::super::operation::transact_write_items::TransactWriteItemsInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for TransactWriteItemsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_transact_write_items::de_transact_write_items_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_transact_write_items::de_transact_write_items_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for TransactWriteItemsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::transact_write_items::TransactWriteItemsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::transact_write_items::TransactWriteItemsInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::transact_write_items::TransactWriteItemsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::transact_write_items::_transact_write_items_input::TransactWriteItemsInput;

pub use super::super::operation::transact_write_items::_transact_write_items_output::TransactWriteItemsOutput;
