...
impl UpdateKinesisStreamingDestinationOutput {
    ...
    /// <p>The command to update the Kinesis streaming destination configuration.</p>
    pub fn update_kinesis_streaming_configuration(&self) -> ::std::option::Option<&super::super::super::types::UpdateKinesisStreamingConfiguration> {
...
pub struct UpdateKinesisStreamingDestinationOutputBuilder {
    ...
    pub(crate) update_kinesis_streaming_configuration: ::std::option::Option<super::super::super::types::UpdateKinesisStreamingConfiguration>,
    _request_id: Option<String>,
}
impl UpdateKinesisStreamingDestinationOutputBuilder {
    ...
    /// <p>The command to update the Kinesis streaming destination configuration.</p>
    pub fn update_kinesis_streaming_configuration(mut self, input: super::super::super::types::UpdateKinesisStreamingConfiguration) -> Self {
    ...
    pub fn set_update_kinesis_streaming_configuration(
        mut self,
        input: ::std::option::Option<super::super::super::types::UpdateKinesisStreamingConfiguration>,
    ) -> Self {
    ...
    pub fn build(self) -> super::super::super::operation::update_kinesis_streaming_destination::UpdateKinesisStreamingDestinationOutput {
        super::super::super::operation::update_kinesis_streaming_destination::UpdateKinesisStreamingDestinationOutput {
