    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::execute_transaction::ExecuteTransactionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::execute_transaction::ExecuteTransactionOutput>()
    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(super::super::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut super::super::operation::execute_transaction::ExecuteTransactionInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ExecuteTransactionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_execute_transaction::de_execute_transaction_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_execute_transaction::de_execute_transaction_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ExecuteTransactionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::execute_transaction::ExecuteTransactionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::execute_transaction::ExecuteTransactionInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::execute_transaction::ExecuteTransactionError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::execute_transaction::_execute_transaction_input::ExecuteTransactionInput;

pub use super::super::operation::execute_transaction::_execute_transaction_output::ExecuteTransactionOutput;
