...
impl DescribeGlobalTableSettingsInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_global_table_settings::builders::DescribeGlobalTableSettingsInputBuilder {
        super::super::super::operation::describe_global_table_settings::builders::DescribeGlobalTableSettingsInputBuilder::default()
    }
}
