...
impl DescribeGlobalTableSettingsOutput {
    ...
    pub fn replica_settings(&self) -> &[super::super::super::types::ReplicaSettingsDescription] {
...
impl DescribeGlobalTableSettingsOutput {
    ...
    pub fn builder() -> super::super::super::operation::describe_global_table_settings::builders::DescribeGlobalTableSettingsOutputBuilder {
        super::super::super::operation::describe_global_table_settings::builders::DescribeGlobalTableSettingsOutputBuilder::default()
    }
}
...
pub struct DescribeGlobalTableSettingsOutputBuilder {
    ...
    pub(crate) replica_settings: ::std::option::Option<::std::vec::Vec<super::super::super::types::ReplicaSettingsDescription>>,
    _request_id: Option<String>,
}
impl DescribeGlobalTableSettingsOutputBuilder {
    ...
    ///
    /// <p>The Region-specific settings for the global table.</p>
    pub fn replica_settings(mut self, input: super::super::super::types::ReplicaSettingsDescription) -> Self {
    ...
    /// <p>The Region-specific settings for the global table.</p>
    pub fn get_replica_settings(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::ReplicaSettingsDescription>> {
    ...
    pub fn build(self) -> super::super::super::operation::describe_global_table_settings::DescribeGlobalTableSettingsOutput {
