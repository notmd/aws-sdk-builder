...
pub use super::super::super::operation::describe_global_table_settings::_describe_global_table_settings_input::DescribeGlobalTableSettingsInputBuilder;

pub use super::super::super::operation::describe_global_table_settings::_describe_global_table_settings_output::DescribeGlobalTableSettingsOutputBuilder;

impl super::super::super::operation::describe_global_table_settings::builders::DescribeGlobalTableSettingsInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::describe_global_table_settings::DescribeGlobalTableSettingsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::describe_global_table_settings::DescribeGlobalTableSettingsError,
...
pub struct DescribeGlobalTableSettingsFluentBuilder {
    ...
    inner: super::super::super::operation::describe_global_table_settings::builders::DescribeGlobalTableSettingsInputBuilder,
...
impl DescribeGlobalTableSettingsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::describe_global_table_settings::builders::DescribeGlobalTableSettingsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::describe_global_table_settings::DescribeGlobalTableSettings::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::describe_global_table_settings::DescribeGlobalTableSettings::orchestrate(&runtime_plugins, input).await
    }
