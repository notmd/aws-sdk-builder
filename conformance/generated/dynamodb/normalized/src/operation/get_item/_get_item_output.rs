...
impl GetItemOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_item::builders::GetItemOutputBuilder {
        super::super::super::operation::get_item::builders::GetItemOutputBuilder::default()
    }
}
...
impl GetItemOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::get_item::GetItemOutput {
