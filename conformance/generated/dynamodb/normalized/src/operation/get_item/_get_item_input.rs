...
impl GetItemInput {
    ...
    pub fn builder() -> super::super::super::operation::get_item::builders::GetItemInputBuilder {
        super::super::super::operation::get_item::builders::GetItemInputBuilder::default()
    }
}
