...
impl DescribeBackup {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::describe_backup::DescribeBackupInput,
    ) -> ::std::result::Result<
        super::super::operation::describe_backup::DescribeBackupOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::describe_backup::DescribeBackupError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::describe_backup::DescribeBackupError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::describe_backup::DescribeBackupOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("DynamoDB", "DescribeBackup", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeBackupResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_describe_backup::de_describe_backup_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_describe_backup::de_describe_backup_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeBackupRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::describe_backup::DescribeBackupInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::describe_backup::DescribeBackupInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_describe_backup::ser_describe_backup_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::describe_backup::DescribeBackupError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::describe_backup::_describe_backup_input::DescribeBackupInput;

pub use super::super::operation::describe_backup::_describe_backup_output::DescribeBackupOutput;
