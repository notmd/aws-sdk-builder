...
pub use super::super::super::operation::describe_export::_describe_export_input::DescribeExportInputBuilder;

pub use super::super::super::operation::describe_export::_describe_export_output::DescribeExportOutputBuilder;

impl super::super::super::operation::describe_export::builders::DescribeExportInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::describe_export::DescribeExportOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::describe_export::DescribeExportError,
...
pub struct DescribeExportFluentBuilder {
    ...
    inner: super::super::super::operation::describe_export::builders::DescribeExportInputBuilder,
...
impl DescribeExportFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::describe_export::builders::DescribeExportInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::describe_export::DescribeExport::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::describe_export::DescribeExport::orchestrate(&runtime_plugins, input).await
    }
