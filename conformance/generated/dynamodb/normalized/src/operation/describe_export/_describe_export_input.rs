...
impl DescribeExportInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_export::builders::DescribeExportInputBuilder {
        super::super::super::operation::describe_export::builders::DescribeExportInputBuilder::default()
    }
}
