...
pub use super::super::super::operation::describe_global_table::_describe_global_table_input::DescribeGlobalTableInputBuilder;

pub use super::super::super::operation::describe_global_table::_describe_global_table_output::DescribeGlobalTableOutputBuilder;

impl super::super::super::operation::describe_global_table::builders::DescribeGlobalTableInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::describe_global_table::DescribeGlobalTableOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::describe_global_table::DescribeGlobalTableError,
...
pub struct DescribeGlobalTableFluentBuilder {
    ...
    inner: super::super::super::operation::describe_global_table::builders::DescribeGlobalTableInputBuilder,
...
impl DescribeGlobalTableFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::describe_global_table::builders::DescribeGlobalTableInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::describe_global_table::DescribeGlobalTable::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::describe_global_table::DescribeGlobalTable::orchestrate(&runtime_plugins, input).await
    }
