...
impl DescribeGlobalTableInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_global_table::builders::DescribeGlobalTableInputBuilder {
        super::super::super::operation::describe_global_table::builders::DescribeGlobalTableInputBuilder::default()
    }
}
