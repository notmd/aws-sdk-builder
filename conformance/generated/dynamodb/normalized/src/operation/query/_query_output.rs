...
impl QueryOutput {
    ...
    pub fn builder() -> super::super::super::operation::query::builders::QueryOutputBuilder {
        super::super::super::operation::query::builders::QueryOutputBuilder::default()
    }
}
...
impl QueryOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::query::QueryOutput {
