...
impl QueryPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::query::paginator::QueryPaginatorItems {
        super::super::super::operation::query::paginator::QueryPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::super::super::operation::query::Query::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_query_output_output_last_evaluated_key(resp);
...
impl QueryPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            ::std::collections::HashMap<::std::string::String, super::super::super::types::AttributeValue>,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::query::QueryError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
