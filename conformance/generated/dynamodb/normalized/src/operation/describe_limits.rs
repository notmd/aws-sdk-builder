...
impl DescribeLimits {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::describe_limits::DescribeLimitsInput,
    ) -> ::std::result::Result<
        super::super::operation::describe_limits::DescribeLimitsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::describe_limits::DescribeLimitsError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::describe_limits::DescribeLimitsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::describe_limits::DescribeLimitsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeLimitsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_describe_limits::de_describe_limits_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_describe_limits::de_describe_limits_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeLimitsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::describe_limits::DescribeLimitsInput>()
            .expect("correct type");
...
impl ::aws_types::request_id::RequestId for super::super::operation::describe_limits::DescribeLimitsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::describe_limits::_describe_limits_input::DescribeLimitsInput;

pub use super::super::operation::describe_limits::_describe_limits_output::DescribeLimitsOutput;
