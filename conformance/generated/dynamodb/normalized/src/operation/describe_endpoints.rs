...
impl DescribeEndpoints {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::describe_endpoints::DescribeEndpointsInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::describe_endpoints::DescribeEndpointsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::describe_endpoints::DescribeEndpointsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeEndpointsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_describe_endpoints::de_describe_endpoints_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_describe_endpoints::de_describe_endpoints_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeEndpointsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::describe_endpoints::DescribeEndpointsInput>()
            .expect("correct type");
...
impl ::aws_types::request_id::RequestId for super::super::operation::describe_endpoints::DescribeEndpointsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::describe_endpoints::_describe_endpoints_input::DescribeEndpointsInput;

pub use super::super::operation::describe_endpoints::_describe_endpoints_output::DescribeEndpointsOutput;
