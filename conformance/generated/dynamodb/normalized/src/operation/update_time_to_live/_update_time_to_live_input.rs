...
impl UpdateTimeToLiveInput {
    ...
    pub fn builder() -> super::super::super::operation::update_time_to_live::builders::UpdateTimeToLiveInputBuilder {
        super::super::super::operation::update_time_to_live::builders::UpdateTimeToLiveInputBuilder::default()
    }
}
