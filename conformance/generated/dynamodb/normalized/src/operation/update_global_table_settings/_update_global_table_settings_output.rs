...
impl UpdateGlobalTableSettingsOutput {
    ...
    pub fn builder() -> super::super::super::operation::update_global_table_settings::builders::UpdateGlobalTableSettingsOutputBuilder {
        super::super::super::operation::update_global_table_settings::builders::UpdateGlobalTableSettingsOutputBuilder::default()
    }
}
...
impl UpdateGlobalTableSettingsOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::update_global_table_settings::UpdateGlobalTableSettingsOutput {
