...
impl UpdateGlobalTableSettingsInput {
    ...
    /// <p><code>PAY_PER_REQUEST</code> - We recommend using <code>PAY_PER_REQUEST</code> for unpredictable workloads. <code>PAY_PER_REQUEST</code> sets the billing mode to <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/on-demand-capacity-mode.html">On-demand capacity mode</a>.</p></li>
    /// </ul>
    pub fn global_table_billing_mode(&self) -> ::std::option::Option<&super::super::super::types::BillingMode> {
    ...
    pub fn replica_settings_update(&self) -> &[super::super::super::types::ReplicaSettingsUpdate] {
...
impl UpdateGlobalTableSettingsInput {
    ...
    pub fn builder() -> super::super::super::operation::update_global_table_settings::builders::UpdateGlobalTableSettingsInputBuilder {
        super::super::super::operation::update_global_table_settings::builders::UpdateGlobalTableSettingsInputBuilder::default()
    }
}
