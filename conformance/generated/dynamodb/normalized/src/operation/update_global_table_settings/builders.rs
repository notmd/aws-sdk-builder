...
pub use super::super::super::operation::update_global_table_settings::_update_global_table_settings_input::UpdateGlobalTableSettingsInputBuilder;

pub use super::super::super::operation::update_global_table_settings::_update_global_table_settings_output::UpdateGlobalTableSettingsOutputBuilder;

impl super::super::super::operation::update_global_table_settings::builders::UpdateGlobalTableSettingsInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::update_global_table_settings::UpdateGlobalTableSettingsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::update_global_table_settings::UpdateGlobalTableSettingsError,
...
pub struct UpdateGlobalTableSettingsFluentBuilder {
    ...
    inner: super::super::super::operation::update_global_table_settings::builders::UpdateGlobalTableSettingsInputBuilder,
...
impl UpdateGlobalTableSettingsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::update_global_table_settings::builders::UpdateGlobalTableSettingsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::update_global_table_settings::UpdateGlobalTableSettings::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::update_global_table_settings::UpdateGlobalTableSettings::orchestrate(&runtime_plugins, input).await
    }
    ...
    /// </ul>
    pub fn global_table_billing_mode(mut self, input: super::super::super::types::BillingMode) -> Self {
    ...
    /// <p><code>PAY_PER_REQUEST</code> - We recommend using <code>PAY_PER_REQUEST</code> for unpredictable workloads. <code>PAY_PER_REQUEST</code> sets the billing mode to <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/on-demand-capacity-mode.html">On-demand capacity mode</a>.</p></li>
    /// </ul>
    pub fn set_global_table_billing_mode(mut self, input: ::std::option::Option<super::super::super::types::BillingMode>) -> Self {
    ...
    /// <p><code>PAY_PER_REQUEST</code> - We recommend using <code>PAY_PER_REQUEST</code> for unpredictable workloads. <code>PAY_PER_REQUEST</code> sets the billing mode to <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/on-demand-capacity-mode.html">On-demand capacity mode</a>.</p></li>
    /// </ul>
    pub fn get_global_table_billing_mode(&self) -> &::std::option::Option<super::super::super::types::BillingMode> {
    ...
    pub fn set_global_table_provisioned_write_capacity_auto_scaling_settings_update(
        mut self,
        input: ::std::option::Option<super::super::super::types::AutoScalingSettingsUpdate>,
    ) -> Self {
    ...
    pub fn set_global_table_global_secondary_index_settings_update(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::GlobalTableGlobalSecondaryIndexSettingsUpdate>>,
    ) -> Self {
    ...
    pub fn replica_settings_update(mut self, input: super::super::super::types::ReplicaSettingsUpdate) -> Self {
    ...
    /// <p>Represents the settings for a global table in a Region that will be modified.</p>
    pub fn get_replica_settings_update(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::ReplicaSettingsUpdate>> {
