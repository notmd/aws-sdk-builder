...
impl TransactWriteItemsOutput {
    ...
    pub fn builder() -> super::super::super::operation::transact_write_items::builders::TransactWriteItemsOutputBuilder {
        super::super::super::operation::transact_write_items::builders::TransactWriteItemsOutputBuilder::default()
    }
}
...
impl TransactWriteItemsOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::transact_write_items::TransactWriteItemsOutput {
