...
pub use super::super::super::operation::transact_write_items::_transact_write_items_input::TransactWriteItemsInputBuilder;

pub use super::super::super::operation::transact_write_items::_transact_write_items_output::TransactWriteItemsOutputBuilder;

impl super::super::super::operation::transact_write_items::builders::TransactWriteItemsInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::transact_write_items::TransactWriteItemsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::transact_write_items::TransactWriteItemsError,
...
pub struct TransactWriteItemsFluentBuilder {
    ...
    inner: super::super::super::operation::transact_write_items::builders::TransactWriteItemsInputBuilder,
...
impl TransactWriteItemsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::transact_write_items::builders::TransactWriteItemsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::transact_write_items::TransactWriteItems::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::transact_write_items::TransactWriteItems::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn transact_items(mut self, input: super::super::super::types::TransactWriteItem) -> Self {
        self.inner = self.inner.transact_items(input);
        self
    }
    /// <p>An ordered array of up to 100 <code>TransactWriteItem</code> objects, each of which contains a <code>ConditionCheck</code>, <code>Put</code>, <code>Update</code>, or <code>Delete</code> object. These can operate on items in different tables, but the tables must reside in the same Amazon Web Services account and Region, and no two of them can operate on the same item.</p>
    pub fn set_transact_items(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::TransactWriteItem>>) -> Self {
        self.inner = self.inner.set_transact_items(input);
        self
    }
    /// <p>An ordered array of up to 100 <code>TransactWriteItem</code> objects, each of which contains a <code>ConditionCheck</code>, <code>Put</code>, <code>Update</code>, or <code>Delete</code> object. These can operate on items in different tables, but the tables must reside in the same Amazon Web Services account and Region, and no two of them can operate on the same item.</p>
    pub fn get_transact_items(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::TransactWriteItem>> {
