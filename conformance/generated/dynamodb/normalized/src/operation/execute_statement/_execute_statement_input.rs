...
impl ExecuteStatementInput {
    ...
    pub fn parameters(&self) -> &[super::super::super::types::AttributeValue] {
...
impl ExecuteStatementInput {
    ...
    pub fn builder() -> super::super::super::operation::execute_statement::builders::ExecuteStatementInputBuilder {
        super::super::super::operation::execute_statement::builders::ExecuteStatementInputBuilder::default()
    }
}
...
pub struct ExecuteStatementInputBuilder {
    ...
    pub(crate) parameters: ::std::option::Option<::std::vec::Vec<super::super::super::types::AttributeValue>>,
