...
impl PutItem {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::super::operation::put_item::PutItemOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::put_item::PutItemError,
    ...
    > {
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::put_item::PutItemOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutItemResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_put_item::de_put_item_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_put_item::de_put_item_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutItemRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::super::operation::put_item::PutItemInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::put_item::PutItemInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_put_item::ser_put_item_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::put_item::PutItemError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::put_item::_put_item_input::PutItemInput;

pub use super::super::operation::put_item::_put_item_output::PutItemOutput;
