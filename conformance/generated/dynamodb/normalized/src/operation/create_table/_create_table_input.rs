...
impl CreateTableInput {
    ...
    pub fn key_schema(&self) -> &[super::super::super::types::KeySchemaElement] {
    ...
    pub fn local_secondary_indexes(&self) -> &[super::super::super::types::LocalSecondaryIndex] {
    ...
    pub fn global_secondary_indexes(&self) -> &[super::super::super::types::GlobalSecondaryIndex] {
    ...
    pub fn tags(&self) -> &[super::super::super::types::Tag] {
    ...
    pub fn vector_indexes(&self) -> &[super::super::super::types::VectorIndex] {
...
impl CreateTableInput {
    ...
    pub fn builder() -> super::super::super::operation::create_table::builders::CreateTableInputBuilder {
        super::super::super::operation::create_table::builders::CreateTableInputBuilder::default()
    }
}
...
pub struct CreateTableInputBuilder {
    ...
    pub(crate) key_schema: ::std::option::Option<::std::vec::Vec<super::super::super::types::KeySchemaElement>>,
    pub(crate) local_secondary_indexes: ::std::option::Option<::std::vec::Vec<super::super::super::types::LocalSecondaryIndex>>,
    pub(crate) global_secondary_indexes: ::std::option::Option<::std::vec::Vec<super::super::super::types::GlobalSecondaryIndex>>,
    ...
    pub(crate) vector_indexes: ::std::option::Option<::std::vec::Vec<super::super::super::types::VectorIndex>>,
}
impl CreateTableInputBuilder {
    ...
    /// <p>For a composite primary key (partition key and sort key), you must provide exactly two elements, in this order: The first element must have a <code>KeyType</code> of <code>HASH</code>, and the second element must have a <code>KeyType</code> of <code>RANGE</code>.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/WorkingWithTables.html#WorkingWithTables.primary.key">Working with Tables</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p>
    pub fn key_schema(mut self, input: super::super::super::types::KeySchemaElement) -> Self {
    ...
    /// <p>For a composite primary key (partition key and sort key), you must provide exactly two elements, in this order: The first element must have a <code>KeyType</code> of <code>HASH</code>, and the second element must have a <code>KeyType</code> of <code>RANGE</code>.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/WorkingWithTables.html#WorkingWithTables.primary.key">Working with Tables</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p>
    pub fn set_key_schema(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::KeySchemaElement>>) -> Self {
    ...
    /// <p>For a composite primary key (partition key and sort key), you must provide exactly two elements, in this order: The first element must have a <code>KeyType</code> of <code>HASH</code>, and the second element must have a <code>KeyType</code> of <code>RANGE</code>.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/WorkingWithTables.html#WorkingWithTables.primary.key">Working with Tables</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p>
    pub fn get_key_schema(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::KeySchemaElement>> {
        &self.key_schema
    }
    ...
    /// </ul></li>
    /// </ul>
    pub fn local_secondary_indexes(mut self, input: super::super::super::types::LocalSecondaryIndex) -> Self {
    ...
    /// </ul></li>
    /// </ul>
    pub fn get_local_secondary_indexes(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::LocalSecondaryIndex>> {
    ...
    /// <p><code>ProvisionedThroughput</code> - The provisioned throughput settings for the global secondary index, consisting of read and write capacity units.</p></li>
    /// </ul>
    pub fn global_secondary_indexes(mut self, input: super::super::super::types::GlobalSecondaryIndex) -> Self {
    ...
    /// <p><code>ProvisionedThroughput</code> - The provisioned throughput settings for the global secondary index, consisting of read and write capacity units.</p></li>
    /// </ul>
    pub fn get_global_secondary_indexes(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::GlobalSecondaryIndex>> {
    ...
    /// <p><code>SearchSchema</code> - (Optional) Defines the partition key (<code>HASH</code>) and inline filter (<code>INLINE_FILTER</code>) attributes for the vector index.</p></li>
    /// </ul>
    pub fn vector_indexes(mut self, input: super::super::super::types::VectorIndex) -> Self {
    ...
    /// <p><code>SearchSchema</code> - (Optional) Defines the partition key (<code>HASH</code>) and inline filter (<code>INLINE_FILTER</code>) attributes for the vector index.</p></li>
    /// </ul>
    pub fn set_vector_indexes(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::VectorIndex>>) -> Self {
    ...
    /// <p><code>SearchSchema</code> - (Optional) Defines the partition key (<code>HASH</code>) and inline filter (<code>INLINE_FILTER</code>) attributes for the vector index.</p></li>
    /// </ul>
    pub fn get_vector_indexes(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::VectorIndex>> {
        &self.vector_indexes
    }
