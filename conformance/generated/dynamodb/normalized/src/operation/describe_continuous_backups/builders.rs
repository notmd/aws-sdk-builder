...
pub use super::super::super::operation::describe_continuous_backups::_describe_continuous_backups_input::DescribeContinuousBackupsInputBuilder;

pub use super::super::super::operation::describe_continuous_backups::_describe_continuous_backups_output::DescribeContinuousBackupsOutputBuilder;

impl super::super::super::operation::describe_continuous_backups::builders::DescribeContinuousBackupsInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::describe_continuous_backups::DescribeContinuousBackupsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::describe_continuous_backups::DescribeContinuousBackupsError,
...
pub struct DescribeContinuousBackupsFluentBuilder {
    ...
    inner: super::super::super::operation::describe_continuous_backups::builders::DescribeContinuousBackupsInputBuilder,
...
impl DescribeContinuousBackupsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::describe_continuous_backups::builders::DescribeContinuousBackupsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::describe_continuous_backups::DescribeContinuousBackups::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::describe_continuous_backups::DescribeContinuousBackups::orchestrate(&runtime_plugins, input).await
    }
