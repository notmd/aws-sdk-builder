...
impl DescribeContinuousBackupsInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_continuous_backups::builders::DescribeContinuousBackupsInputBuilder {
        super::super::super::operation::describe_continuous_backups::builders::DescribeContinuousBackupsInputBuilder::default()
    }
}
