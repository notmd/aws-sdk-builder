...
impl ListExports {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::list_exports::ListExportsInput,
    ) -> ::std::result::Result<
        super::super::operation::list_exports::ListExportsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::list_exports::ListExportsError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::list_exports::ListExportsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::list_exports::ListExportsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("DynamoDB", "ListExports", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListExportsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_list_exports::de_list_exports_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_list_exports::de_list_exports_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListExportsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::list_exports::ListExportsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::list_exports::ListExportsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_list_exports::ser_list_exports_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::list_exports::ListExportsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::list_exports::_list_exports_input::ListExportsInput;

pub use super::super::operation::list_exports::_list_exports_output::ListExportsOutput;
