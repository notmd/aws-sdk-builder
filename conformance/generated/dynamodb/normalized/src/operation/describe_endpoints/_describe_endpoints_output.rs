...
pub struct DescribeEndpointsOutput {
    ...
    pub endpoints: ::std::vec::Vec<super::super::super::types::Endpoint>,
    _request_id: Option<String>,
}
impl DescribeEndpointsOutput {
    /// <p>List of endpoints.</p>
    pub fn endpoints(&self) -> &[super::super::super::types::Endpoint] {
        use std::ops::Deref;
...
impl DescribeEndpointsOutput {
    ...
    pub fn builder() -> super::super::super::operation::describe_endpoints::builders::DescribeEndpointsOutputBuilder {
        super::super::super::operation::describe_endpoints::builders::DescribeEndpointsOutputBuilder::default()
    }
}
...
pub struct DescribeEndpointsOutputBuilder {
    pub(crate) endpoints: ::std::option::Option<::std::vec::Vec<super::super::super::types::Endpoint>>,
    _request_id: Option<String>,
}
impl DescribeEndpointsOutputBuilder {
    ...
    ///
    /// <p>List of endpoints.</p>
    pub fn endpoints(mut self, input: super::super::super::types::Endpoint) -> Self {
    ...
    /// <p>List of endpoints.</p>
    pub fn set_endpoints(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::Endpoint>>) -> Self {
        self.endpoints = input;
        self
    }
    /// <p>List of endpoints.</p>
    pub fn get_endpoints(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::Endpoint>> {
        &self.endpoints
    }
