...
pub use super::super::super::operation::describe_endpoints::_describe_endpoints_input::DescribeEndpointsInputBuilder;

pub use super::super::super::operation::describe_endpoints::_describe_endpoints_output::DescribeEndpointsOutputBuilder;

impl super::super::super::operation::describe_endpoints::builders::DescribeEndpointsInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::describe_endpoints::DescribeEndpointsError,
...
pub struct DescribeEndpointsFluentBuilder {
    ...
    inner: super::super::super::operation::describe_endpoints::builders::DescribeEndpointsInputBuilder,
...
impl DescribeEndpointsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::describe_endpoints::builders::DescribeEndpointsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::describe_endpoints::DescribeEndpoints::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::describe_endpoints::DescribeEndpoints::orchestrate(&runtime_plugins, input).await
    }
