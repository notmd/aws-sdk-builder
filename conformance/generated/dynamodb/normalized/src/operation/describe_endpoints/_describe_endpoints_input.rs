...
impl DescribeEndpointsInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_endpoints::builders::DescribeEndpointsInputBuilder {
        super::super::super::operation::describe_endpoints::builders::DescribeEndpointsInputBuilder::default()
    }
}
