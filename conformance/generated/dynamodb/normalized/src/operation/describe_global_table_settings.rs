...
impl DescribeGlobalTableSettings {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::describe_global_table_settings::DescribeGlobalTableSettingsInput,
    ) -> ::std::result::Result<
        super::super::operation::describe_global_table_settings::DescribeGlobalTableSettingsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::describe_global_table_settings::DescribeGlobalTableSettingsError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::describe_global_table_settings::DescribeGlobalTableSettingsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::describe_global_table_settings::DescribeGlobalTableSettingsOutput>()
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeGlobalTableSettingsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DescribeGlobalTableSettingsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeGlobalTableSettingsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_describe_global_table_settings::de_describe_global_table_settings_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_describe_global_table_settings::de_describe_global_table_settings_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeGlobalTableSettingsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::describe_global_table_settings::DescribeGlobalTableSettingsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::describe_global_table_settings::DescribeGlobalTableSettingsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_describe_global_table_settings::ser_describe_global_table_settings_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::super::operation::describe_global_table_settings::DescribeGlobalTableSettingsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::describe_global_table_settings::_describe_global_table_settings_input::DescribeGlobalTableSettingsInput;

pub use super::super::operation::describe_global_table_settings::_describe_global_table_settings_output::DescribeGlobalTableSettingsOutput;
