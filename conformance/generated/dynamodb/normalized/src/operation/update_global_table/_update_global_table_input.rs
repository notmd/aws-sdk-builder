...
impl UpdateGlobalTableInput {
    ...
    pub fn replica_updates(&self) -> &[super::super::super::types::ReplicaUpdate] {
...
impl UpdateGlobalTableInput {
    ...
    pub fn builder() -> super::super::super::operation::update_global_table::builders::UpdateGlobalTableInputBuilder {
        super::super::super::operation::update_global_table::builders::UpdateGlobalTableInputBuilder::default()
    }
}
...
pub struct UpdateGlobalTableInputBuilder {
    ...
    pub(crate) replica_updates: ::std::option::Option<::std::vec::Vec<super::super::super::types::ReplicaUpdate>>,
}
