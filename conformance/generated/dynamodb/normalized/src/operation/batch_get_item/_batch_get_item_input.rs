...
pub struct BatchGetItemInput {
    ...
    /// </ul>
    pub request_items: ::std::option::Option<::std::collections::HashMap<::std::string::String, super::super::super::types::KeysAndAttributes>>,
...
impl BatchGetItemInput {
    ...
    pub fn builder() -> super::super::super::operation::batch_get_item::builders::BatchGetItemInputBuilder {
        super::super::super::operation::batch_get_item::builders::BatchGetItemInputBuilder::default()
    }
}
