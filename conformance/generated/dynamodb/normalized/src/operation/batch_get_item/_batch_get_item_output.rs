...
pub struct BatchGetItemOutput {
    ...
    pub unprocessed_keys: ::std::option::Option<::std::collections::HashMap<::std::string::String, super::super::super::types::KeysAndAttributes>>,
...
impl BatchGetItemOutput {
    ...
    pub fn builder() -> super::super::super::operation::batch_get_item::builders::BatchGetItemOutputBuilder {
        super::super::super::operation::batch_get_item::builders::BatchGetItemOutputBuilder::default()
    }
}
...
impl BatchGetItemOutputBuilder {
    ...
    pub fn responses(
        ...
        v: ::std::vec::Vec<::std::collections::HashMap<::std::string::String, super::super::super::types::AttributeValue>>,
    ) -> Self {
    ...
    /// </ul>
    /// <p>If there are no unprocessed keys remaining, the response contains an empty <code>UnprocessedKeys</code> map.</p>
    pub fn unprocessed_keys(mut self, k: impl ::std::convert::Into<::std::string::String>, v: super::super::super::types::KeysAndAttributes) -> Self {
    ...
    pub fn build(self) -> super::super::super::operation::batch_get_item::BatchGetItemOutput {
