...
pub use super::super::super::operation::batch_get_item::_batch_get_item_input::BatchGetItemInputBuilder;

pub use super::super::super::operation::batch_get_item::_batch_get_item_output::BatchGetItemOutputBuilder;

impl super::super::super::operation::batch_get_item::builders::BatchGetItemInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::batch_get_item::BatchGetItemOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::batch_get_item::BatchGetItemError,
...
/// <p>If a requested item does not exist, it is not returned in the result. Requests for nonexistent items consume the minimum read capacity units according to the type of read. For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/WorkingWithTables.html#CapacityUnitCalculations">Working with Tables</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p><note>
/// <p><code>BatchGetItem</code> will result in a <code>ValidationException</code> if the same key is specified multiple times.</p>
/// </note>
#[derive(::std::clone::Clone, ::std::fmt::Debug)]
pub struct BatchGetItemFluentBuilder {
    handle: ::std::sync::Arc<super::super::super::client::Handle>,
    inner: super::super::super::operation::batch_get_item::builders::BatchGetItemInputBuilder,
...
impl BatchGetItemFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::batch_get_item::builders::BatchGetItemInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::batch_get_item::BatchGetItem::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::batch_get_item::BatchGetItem::orchestrate(&runtime_plugins, input).await
    }
    ...
    /// </ul>
    pub fn request_items(mut self, k: impl ::std::convert::Into<::std::string::String>, v: super::super::super::types::KeysAndAttributes) -> Self {
    ...
    pub fn set_request_items(
        mut self,
        input: ::std::option::Option<::std::collections::HashMap<::std::string::String, super::super::super::types::KeysAndAttributes>>,
    ) -> Self {
