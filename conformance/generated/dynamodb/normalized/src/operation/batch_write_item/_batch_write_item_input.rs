...
impl BatchWriteItemInput {
    ...
    pub fn builder() -> super::super::super::operation::batch_write_item::builders::BatchWriteItemInputBuilder {
        super::super::super::operation::batch_write_item::builders::BatchWriteItemInputBuilder::default()
    }
}
