...
impl BatchWriteItemOutput {
    ...
    pub fn builder() -> super::super::super::operation::batch_write_item::builders::BatchWriteItemOutputBuilder {
        super::super::super::operation::batch_write_item::builders::BatchWriteItemOutputBuilder::default()
    }
}
...
impl BatchWriteItemOutputBuilder {
    ...
    pub fn item_collection_metrics(
        ...
        v: ::std::vec::Vec<super::super::super::types::ItemCollectionMetrics>,
    ) -> Self {
    ...
    pub fn build(self) -> super::super::super::operation::batch_write_item::BatchWriteItemOutput {
