...
pub use super::super::super::operation::batch_write_item::_batch_write_item_input::BatchWriteItemInputBuilder;

pub use super::super::super::operation::batch_write_item::_batch_write_item_output::BatchWriteItemOutputBuilder;

impl super::super::super::operation::batch_write_item::builders::BatchWriteItemInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::batch_write_item::BatchWriteItemOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::batch_write_item::BatchWriteItemError,
...
/// <p>If <code>BatchWriteItem</code> cannot process any items due to throttling (for example, insufficient provisioned throughput on the tables in the request, or partition-level or account-level limits), it returns a <code>ProvisionedThroughputExceededException</code> or a <code>ThrottlingException</code>. Both indicate that the request was throttled; check the <code>ThrottlingReason</code> field in the returned exception for details.</p><important>
...
pub struct BatchWriteItemFluentBuilder {
    ...
    inner: super::super::super::operation::batch_write_item::builders::BatchWriteItemInputBuilder,
...
impl BatchWriteItemFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::batch_write_item::builders::BatchWriteItemInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::batch_write_item::BatchWriteItem::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::batch_write_item::BatchWriteItem::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn set_request_items(
        mut self,
        input: ::std::option::Option<::std::collections::HashMap<::std::string::String, ::std::vec::Vec<super::super::super::types::WriteRequest>>>,
    ) -> Self {
