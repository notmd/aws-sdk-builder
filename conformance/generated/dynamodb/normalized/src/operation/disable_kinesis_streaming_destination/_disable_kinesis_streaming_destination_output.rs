...
impl DisableKinesisStreamingDestinationOutput {
    ...
    /// <p>The current status of the replication.</p>
    pub fn destination_status(&self) -> ::std::option::Option<&super::super::super::types::DestinationStatus> {
        self.destination_status.as_ref()
    }
    /// <p>The destination for the Kinesis streaming information that is being enabled.</p>
    pub fn enable_kinesis_streaming_configuration(&self) -> ::std::option::Option<&super::super::super::types::EnableKinesisStreamingConfiguration> {
...
pub struct DisableKinesisStreamingDestinationOutputBuilder {
    ...
    pub(crate) destination_status: ::std::option::Option<super::super::super::types::DestinationStatus>,
    pub(crate) enable_kinesis_streaming_configuration: ::std::option::Option<super::super::super::types::EnableKinesisStreamingConfiguration>,
    _request_id: Option<String>,
}
impl DisableKinesisStreamingDestinationOutputBuilder {
    ...
    /// <p>The current status of the replication.</p>
    pub fn destination_status(mut self, input: super::super::super::types::DestinationStatus) -> Self {
        self.destination_status = ::std::option::Option::Some(input);
        self
    }
    /// <p>The current status of the replication.</p>
    pub fn set_destination_status(mut self, input: ::std::option::Option<super::super::super::types::DestinationStatus>) -> Self {
        self.destination_status = input;
        self
    }
    /// <p>The current status of the replication.</p>
    pub fn get_destination_status(&self) -> &::std::option::Option<super::super::super::types::DestinationStatus> {
        &self.destination_status
    }
    /// <p>The destination for the Kinesis streaming information that is being enabled.</p>
    pub fn enable_kinesis_streaming_configuration(mut self, input: super::super::super::types::EnableKinesisStreamingConfiguration) -> Self {
    ...
    pub fn set_enable_kinesis_streaming_configuration(
        mut self,
        input: ::std::option::Option<super::super::super::types::EnableKinesisStreamingConfiguration>,
    ) -> Self {
    ...
    pub fn build(self) -> super::super::super::operation::disable_kinesis_streaming_destination::DisableKinesisStreamingDestinationOutput {
        super::super::super::operation::disable_kinesis_streaming_destination::DisableKinesisStreamingDestinationOutput {
