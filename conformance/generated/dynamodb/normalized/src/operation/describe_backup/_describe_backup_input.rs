...
impl DescribeBackupInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_backup::builders::DescribeBackupInputBuilder {
        super::super::super::operation::describe_backup::builders::DescribeBackupInputBuilder::default()
    }
}
