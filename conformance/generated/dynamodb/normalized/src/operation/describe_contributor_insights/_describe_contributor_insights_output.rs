...
impl DescribeContributorInsightsOutput {
    ...
    /// <p>Current status of contributor insights.</p>
    pub fn contributor_insights_status(&self) -> ::std::option::Option<&super::super::super::types::ContributorInsightsStatus> {
    ...
    /// <p>InternalServerError - Failed to create Amazon CloudWatch Contributor Insights rules. Please retry request.</p></li>
    /// </ul>
    pub fn failure_exception(&self) -> ::std::option::Option<&super::super::super::types::FailureException> {
        self.failure_exception.as_ref()
    }
    /// <p>The mode of CloudWatch Contributor Insights for DynamoDB that determines which events are emitted. Can be set to track all access and throttled events or throttled events only.</p>
    pub fn contributor_insights_mode(&self) -> ::std::option::Option<&super::super::super::types::ContributorInsightsMode> {
...
impl DescribeContributorInsightsOutput {
    ...
    pub fn builder() -> super::super::super::operation::describe_contributor_insights::builders::DescribeContributorInsightsOutputBuilder {
        super::super::super::operation::describe_contributor_insights::builders::DescribeContributorInsightsOutputBuilder::default()
    }
}
...
pub struct DescribeContributorInsightsOutputBuilder {
    ...
    pub(crate) contributor_insights_status: ::std::option::Option<super::super::super::types::ContributorInsightsStatus>,
    pub(crate) last_update_date_time: ::std::option::Option<::aws_smithy_types::DateTime>,
    pub(crate) failure_exception: ::std::option::Option<super::super::super::types::FailureException>,
    pub(crate) contributor_insights_mode: ::std::option::Option<super::super::super::types::ContributorInsightsMode>,
    _request_id: Option<String>,
}
impl DescribeContributorInsightsOutputBuilder {
    ...
    /// <p>Current status of contributor insights.</p>
    pub fn contributor_insights_status(mut self, input: super::super::super::types::ContributorInsightsStatus) -> Self {
        self.contributor_insights_status = ::std::option::Option::Some(input);
        self
    }
    /// <p>Current status of contributor insights.</p>
    pub fn set_contributor_insights_status(mut self, input: ::std::option::Option<super::super::super::types::ContributorInsightsStatus>) -> Self {
        self.contributor_insights_status = input;
        self
    }
    /// <p>Current status of contributor insights.</p>
    pub fn get_contributor_insights_status(&self) -> &::std::option::Option<super::super::super::types::ContributorInsightsStatus> {
    ...
    /// <p>InternalServerError - Failed to create Amazon CloudWatch Contributor Insights rules. Please retry request.</p></li>
    /// </ul>
    pub fn failure_exception(mut self, input: super::super::super::types::FailureException) -> Self {
    ...
    /// <p>InternalServerError - Failed to create Amazon CloudWatch Contributor Insights rules. Please retry request.</p></li>
    /// </ul>
    pub fn set_failure_exception(mut self, input: ::std::option::Option<super::super::super::types::FailureException>) -> Self {
    ...
    /// <p>InternalServerError - Failed to create Amazon CloudWatch Contributor Insights rules. Please retry request.</p></li>
    /// </ul>
    pub fn get_failure_exception(&self) -> &::std::option::Option<super::super::super::types::FailureException> {
    ...
    pub fn build(self) -> super::super::super::operation::describe_contributor_insights::DescribeContributorInsightsOutput {
        super::super::super::operation::describe_contributor_insights::DescribeContributorInsightsOutput {
