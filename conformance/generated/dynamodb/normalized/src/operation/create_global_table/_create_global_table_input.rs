...
impl CreateGlobalTableInput {
    ...
    pub fn replication_group(&self) -> &[super::super::super::types::Replica] {
...
impl CreateGlobalTableInput {
    ...
    pub fn builder() -> super::super::super::operation::create_global_table::builders::CreateGlobalTableInputBuilder {
        super::super::super::operation::create_global_table::builders::CreateGlobalTableInputBuilder::default()
    }
}
...
pub struct CreateGlobalTableInputBuilder {
    ...
    pub(crate) replication_group: ::std::option::Option<::std::vec::Vec<super::super::super::types::Replica>>,
}
