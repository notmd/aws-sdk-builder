...
pub use super::super::super::operation::create_global_table::_create_global_table_input::CreateGlobalTableInputBuilder;

pub use super::super::super::operation::create_global_table::_create_global_table_output::CreateGlobalTableOutputBuilder;

impl super::super::super::operation::create_global_table::builders::CreateGlobalTableInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::create_global_table::CreateGlobalTableOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::create_global_table::CreateGlobalTableError,
...
pub struct CreateGlobalTableFluentBuilder {
    ...
    inner: super::super::super::operation::create_global_table::builders::CreateGlobalTableInputBuilder,
...
impl CreateGlobalTableFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::create_global_table::builders::CreateGlobalTableInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::create_global_table::CreateGlobalTable::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::create_global_table::CreateGlobalTable::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn replication_group(mut self, input: super::super::super::types::Replica) -> Self {
        self.inner = self.inner.replication_group(input);
        self
    }
    /// <p>The Regions where the global table needs to be created.</p>
    pub fn set_replication_group(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::Replica>>) -> Self {
        self.inner = self.inner.set_replication_group(input);
        self
    }
    /// <p>The Regions where the global table needs to be created.</p>
    pub fn get_replication_group(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::Replica>> {
