...
impl ListBackupsOutput {
    ...
    pub fn backup_summaries(&self) -> &[super::super::super::types::BackupSummary] {
...
impl ListBackupsOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_backups::builders::ListBackupsOutputBuilder {
        super::super::super::operation::list_backups::builders::ListBackupsOutputBuilder::default()
    }
}
...
pub struct ListBackupsOutputBuilder {
    pub(crate) backup_summaries: ::std::option::Option<::std::vec::Vec<super::super::super::types::BackupSummary>>,
...
impl ListBackupsOutputBuilder {
    ...
    ///
    /// <p>List of <code>BackupSummary</code> objects.</p>
    pub fn backup_summaries(mut self, input: super::super::super::types::BackupSummary) -> Self {
    ...
    /// <p>List of <code>BackupSummary</code> objects.</p>
    pub fn set_backup_summaries(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::BackupSummary>>) -> Self {
        self.backup_summaries = input;
        self
    }
    /// <p>List of <code>BackupSummary</code> objects.</p>
    pub fn get_backup_summaries(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::BackupSummary>> {
    ...
    pub fn build(self) -> super::super::super::operation::list_backups::ListBackupsOutput {
