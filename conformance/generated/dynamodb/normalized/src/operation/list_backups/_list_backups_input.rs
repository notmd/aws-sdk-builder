...
impl ListBackupsInput {
    ...
    /// <p><code>ALL</code> - All types of on-demand backups (USER and SYSTEM).</p></li>
    /// </ul>
    pub fn backup_type(&self) -> ::std::option::Option<&super::super::super::types::BackupTypeFilter> {
...
impl ListBackupsInput {
    ...
    pub fn builder() -> super::super::super::operation::list_backups::builders::ListBackupsInputBuilder {
        super::super::super::operation::list_backups::builders::ListBackupsInputBuilder::default()
    }
}
...
pub struct ListBackupsInputBuilder {
    ...
    pub(crate) backup_type: ::std::option::Option<super::super::super::types::BackupTypeFilter>,
}
