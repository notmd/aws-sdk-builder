...
impl ListGlobalTables {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::list_global_tables::ListGlobalTablesInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::list_global_tables::ListGlobalTablesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::list_global_tables::ListGlobalTablesOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListGlobalTablesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_list_global_tables::de_list_global_tables_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_list_global_tables::de_list_global_tables_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListGlobalTablesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::list_global_tables::ListGlobalTablesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::list_global_tables::ListGlobalTablesInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::list_global_tables::ListGlobalTablesError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::list_global_tables::_list_global_tables_input::ListGlobalTablesInput;

pub use super::super::operation::list_global_tables::_list_global_tables_output::ListGlobalTablesOutput;
