...
impl BatchWriteItem {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::batch_write_item::BatchWriteItemError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::batch_write_item::BatchWriteItemOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("DynamoDB", "BatchWriteItem", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchWriteItemResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_batch_write_item::de_batch_write_item_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_batch_write_item::de_batch_write_item_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchWriteItemRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::batch_write_item::BatchWriteItemInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::batch_write_item::BatchWriteItemInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_batch_write_item::ser_batch_write_item_input(&input)?);
...
fn get_resource_arn_list(input: &super::super::operation::batch_write_item::BatchWriteItemInput) -> Option<::std::vec::Vec<::std::string::String>> {
...
impl ::aws_types::request_id::RequestId for super::super::operation::batch_write_item::BatchWriteItemError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::batch_write_item::_batch_write_item_input::BatchWriteItemInput;

pub use super::super::operation::batch_write_item::_batch_write_item_output::BatchWriteItemOutput;
