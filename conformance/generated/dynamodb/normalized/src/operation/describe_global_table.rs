...
impl DescribeGlobalTable {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::describe_global_table::DescribeGlobalTableInput,
    ) -> ::std::result::Result<
        super::super::operation::describe_global_table::DescribeGlobalTableOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::describe_global_table::DescribeGlobalTableError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::describe_global_table::DescribeGlobalTableError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::describe_global_table::DescribeGlobalTableOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("DynamoDB", "DescribeGlobalTable", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeGlobalTableResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_describe_global_table::de_describe_global_table_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_describe_global_table::de_describe_global_table_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeGlobalTableRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::describe_global_table::DescribeGlobalTableInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::describe_global_table::DescribeGlobalTableInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::describe_global_table::DescribeGlobalTableError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::describe_global_table::_describe_global_table_input::DescribeGlobalTableInput;

pub use super::super::operation::describe_global_table::_describe_global_table_output::DescribeGlobalTableOutput;
