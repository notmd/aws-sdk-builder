...
impl UpdateTableReplicaAutoScalingInput {
    ...
    pub fn global_secondary_index_updates(&self) -> &[super::super::super::types::GlobalSecondaryIndexAutoScalingUpdate] {
    ...
    /// <p>Represents the auto scaling settings to be modified for a global table or global secondary index.</p>
    pub fn provisioned_write_capacity_auto_scaling_update(&self) -> ::std::option::Option<&super::super::super::types::AutoScalingSettingsUpdate> {
    ...
    pub fn replica_updates(&self) -> &[super::super::super::types::ReplicaAutoScalingUpdate] {
...
impl UpdateTableReplicaAutoScalingInput {
    ...
    pub fn builder() -> super::super::super::operation::update_table_replica_auto_scaling::builders::UpdateTableReplicaAutoScalingInputBuilder {
        super::super::super::operation::update_table_replica_auto_scaling::builders::UpdateTableReplicaAutoScalingInputBuilder::default()
    }
}
