...
pub use super::super::super::operation::update_table_replica_auto_scaling::_update_table_replica_auto_scaling_input::UpdateTableReplicaAutoScalingInputBuilder;

pub use super::super::super::operation::update_table_replica_auto_scaling::_update_table_replica_auto_scaling_output::UpdateTableReplicaAutoScalingOutputBuilder;

impl super::super::super::operation::update_table_replica_auto_scaling::builders::UpdateTableReplicaAutoScalingInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::update_table_replica_auto_scaling::UpdateTableReplicaAutoScalingOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::update_table_replica_auto_scaling::UpdateTableReplicaAutoScalingError,
...
pub struct UpdateTableReplicaAutoScalingFluentBuilder {
    ...
    inner: super::super::super::operation::update_table_replica_auto_scaling::builders::UpdateTableReplicaAutoScalingInputBuilder,
...
impl UpdateTableReplicaAutoScalingFluentBuilder {
    ...
    pub fn global_secondary_index_updates(mut self, input: super::super::super::types::GlobalSecondaryIndexAutoScalingUpdate) -> Self {
    ...
    pub fn set_global_secondary_index_updates(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::GlobalSecondaryIndexAutoScalingUpdate>>,
    ) -> Self {
    ...
    pub fn provisioned_write_capacity_auto_scaling_update(mut self, input: super::super::super::types::AutoScalingSettingsUpdate) -> Self {
    ...
    pub fn replica_updates(mut self, input: super::super::super::types::ReplicaAutoScalingUpdate) -> Self {
    ...
    /// <p>Represents the auto scaling settings of replicas of the table that will be modified.</p>
    pub fn get_replica_updates(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::ReplicaAutoScalingUpdate>> {
