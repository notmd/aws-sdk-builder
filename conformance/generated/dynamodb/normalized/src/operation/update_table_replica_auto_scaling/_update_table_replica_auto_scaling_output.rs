...
impl UpdateTableReplicaAutoScalingOutput {
    ...
    pub fn builder() -> super::super::super::operation::update_table_replica_auto_scaling::builders::UpdateTableReplicaAutoScalingOutputBuilder {
        super::super::super::operation::update_table_replica_auto_scaling::builders::UpdateTableReplicaAutoScalingOutputBuilder::default()
    }
}
...
impl UpdateTableReplicaAutoScalingOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::update_table_replica_auto_scaling::UpdateTableReplicaAutoScalingOutput {
