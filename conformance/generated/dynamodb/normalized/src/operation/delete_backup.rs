...
impl DeleteBackup {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::super::operation::delete_backup::DeleteBackupOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::delete_backup::DeleteBackupError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::delete_backup::DeleteBackupError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::delete_backup::DeleteBackupOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteBackupResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_delete_backup::de_delete_backup_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_delete_backup::de_delete_backup_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteBackupRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::delete_backup::DeleteBackupInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::delete_backup::DeleteBackupInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_delete_backup::ser_delete_backup_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::delete_backup::DeleteBackupError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::delete_backup::_delete_backup_input::DeleteBackupInput;

pub use super::super::operation::delete_backup::_delete_backup_output::DeleteBackupOutput;
