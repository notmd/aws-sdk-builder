...
impl TransactGetItemsInput {
    ...
    pub fn transact_items(&self) -> &[super::super::super::types::TransactGetItem] {
...
impl TransactGetItemsInput {
    ...
    pub fn builder() -> super::super::super::operation::transact_get_items::builders::TransactGetItemsInputBuilder {
        super::super::super::operation::transact_get_items::builders::TransactGetItemsInputBuilder::default()
    }
}
...
pub struct TransactGetItemsInputBuilder {
    pub(crate) transact_items: ::std::option::Option<::std::vec::Vec<super::super::super::types::TransactGetItem>>,
