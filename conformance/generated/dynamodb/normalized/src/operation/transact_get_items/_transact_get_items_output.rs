...
impl TransactGetItemsOutput {
    ...
    pub fn builder() -> super::super::super::operation::transact_get_items::builders::TransactGetItemsOutputBuilder {
        super::super::super::operation::transact_get_items::builders::TransactGetItemsOutputBuilder::default()
    }
}
...
impl TransactGetItemsOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::transact_get_items::TransactGetItemsOutput {
