...
impl Query {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::super::operation::query::QueryOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::query::QueryError,
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("DynamoDB", "Query", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for QueryResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_query::de_query_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_query::de_query_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for QueryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::super::operation::query::QueryInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::query::QueryInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_query::ser_query_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::query::QueryError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::query::_query_input::QueryInput;

pub use super::super::operation::query::_query_output::QueryOutput;
