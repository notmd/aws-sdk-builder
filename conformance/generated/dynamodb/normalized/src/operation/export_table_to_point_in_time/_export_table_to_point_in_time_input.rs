...
impl ExportTableToPointInTimeInput {
    ...
    /// <p><code>KMS</code> - server-side encryption with KMS managed keys</p></li>
    /// </ul>
    pub fn s3_sse_algorithm(&self) -> ::std::option::Option<&super::super::super::types::S3SseAlgorithm> {
    ...
    /// <p>The format for the exported data. Valid values for <code>ExportFormat</code> are <code>DYNAMODB_JSON</code> or <code>ION</code>.</p>
    pub fn export_format(&self) -> ::std::option::Option<&super::super::super::types::ExportFormat> {
        self.export_format.as_ref()
    }
    /// <p>Choice of whether to execute as a full export or incremental export. Valid values are FULL_EXPORT or INCREMENTAL_EXPORT. The default value is FULL_EXPORT. If INCREMENTAL_EXPORT is provided, the IncrementalExportSpecification must also be used.</p>
    pub fn export_type(&self) -> ::std::option::Option<&super::super::super::types::ExportType> {
        self.export_type.as_ref()
    }
    /// <p>Optional object containing the parameters specific to an incremental export.</p>
    pub fn incremental_export_specification(&self) -> ::std::option::Option<&super::super::super::types::IncrementalExportSpecification> {
...
impl ExportTableToPointInTimeInput {
    ...
    pub fn builder() -> super::super::super::operation::export_table_to_point_in_time::builders::ExportTableToPointInTimeInputBuilder {
        super::super::super::operation::export_table_to_point_in_time::builders::ExportTableToPointInTimeInputBuilder::default()
    }
}
...
pub struct ExportTableToPointInTimeInputBuilder {
    ...
    pub(crate) s3_sse_algorithm: ::std::option::Option<super::super::super::types::S3SseAlgorithm>,
    pub(crate) s3_sse_kms_key_id: ::std::option::Option<::std::string::String>,
    pub(crate) export_format: ::std::option::Option<super::super::super::types::ExportFormat>,
    pub(crate) export_type: ::std::option::Option<super::super::super::types::ExportType>,
    pub(crate) incremental_export_specification: ::std::option::Option<super::super::super::types::IncrementalExportSpecification>,
}
impl ExportTableToPointInTimeInputBuilder {
    ...
    /// <p><code>KMS</code> - server-side encryption with KMS managed keys</p></li>
    /// </ul>
    pub fn s3_sse_algorithm(mut self, input: super::super::super::types::S3SseAlgorithm) -> Self {
    ...
    /// <p><code>KMS</code> - server-side encryption with KMS managed keys</p></li>
    /// </ul>
    pub fn set_s3_sse_algorithm(mut self, input: ::std::option::Option<super::super::super::types::S3SseAlgorithm>) -> Self {
    ...
    /// <p><code>KMS</code> - server-side encryption with KMS managed keys</p></li>
    /// </ul>
    pub fn get_s3_sse_algorithm(&self) -> &::std::option::Option<super::super::super::types::S3SseAlgorithm> {
    ...
    /// <p>The format for the exported data. Valid values for <code>ExportFormat</code> are <code>DYNAMODB_JSON</code> or <code>ION</code>.</p>
    pub fn export_format(mut self, input: super::super::super::types::ExportFormat) -> Self {
        self.export_format = ::std::option::Option::Some(input);
        self
    }
    /// <p>The format for the exported data. Valid values for <code>ExportFormat</code> are <code>DYNAMODB_JSON</code> or <code>ION</code>.</p>
    pub fn set_export_format(mut self, input: ::std::option::Option<super::super::super::types::ExportFormat>) -> Self {
        self.export_format = input;
        self
    }
    /// <p>The format for the exported data. Valid values for <code>ExportFormat</code> are <code>DYNAMODB_JSON</code> or <code>ION</code>.</p>
    pub fn get_export_format(&self) -> &::std::option::Option<super::super::super::types::ExportFormat> {
        &self.export_format
    }
    /// <p>Choice of whether to execute as a full export or incremental export. Valid values are FULL_EXPORT or INCREMENTAL_EXPORT. The default value is FULL_EXPORT. If INCREMENTAL_EXPORT is provided, the IncrementalExportSpecification must also be used.</p>
    pub fn export_type(mut self, input: super::super::super::types::ExportType) -> Self {
        self.export_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>Choice of whether to execute as a full export or incremental export. Valid values are FULL_EXPORT or INCREMENTAL_EXPORT. The default value is FULL_EXPORT. If INCREMENTAL_EXPORT is provided, the IncrementalExportSpecification must also be used.</p>
    pub fn set_export_type(mut self, input: ::std::option::Option<super::super::super::types::ExportType>) -> Self {
        self.export_type = input;
        self
    }
    /// <p>Choice of whether to execute as a full export or incremental export. Valid values are FULL_EXPORT or INCREMENTAL_EXPORT. The default value is FULL_EXPORT. If INCREMENTAL_EXPORT is provided, the IncrementalExportSpecification must also be used.</p>
    pub fn get_export_type(&self) -> &::std::option::Option<super::super::super::types::ExportType> {
        &self.export_type
    }
    /// <p>Optional object containing the parameters specific to an incremental export.</p>
    pub fn incremental_export_specification(mut self, input: super::super::super::types::IncrementalExportSpecification) -> Self {
    ...
    /// <p>Optional object containing the parameters specific to an incremental export.</p>
    pub fn get_incremental_export_specification(&self) -> &::std::option::Option<super::super::super::types::IncrementalExportSpecification> {
