...
impl ListTagsOfResourceInput {
    ...
    pub fn builder() -> super::super::super::operation::list_tags_of_resource::builders::ListTagsOfResourceInputBuilder {
        super::super::super::operation::list_tags_of_resource::builders::ListTagsOfResourceInputBuilder::default()
    }
}
