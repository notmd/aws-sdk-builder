...
pub use super::super::super::operation::list_tags_of_resource::_list_tags_of_resource_input::ListTagsOfResourceInputBuilder;

pub use super::super::super::operation::list_tags_of_resource::_list_tags_of_resource_output::ListTagsOfResourceOutputBuilder;

impl super::super::super::operation::list_tags_of_resource::builders::ListTagsOfResourceInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::list_tags_of_resource::ListTagsOfResourceOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::list_tags_of_resource::ListTagsOfResourceError,
...
pub struct ListTagsOfResourceFluentBuilder {
    ...
    inner: super::super::super::operation::list_tags_of_resource::builders::ListTagsOfResourceInputBuilder,
...
impl ListTagsOfResourceFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::list_tags_of_resource::builders::ListTagsOfResourceInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::list_tags_of_resource::ListTagsOfResource::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::list_tags_of_resource::ListTagsOfResource::orchestrate(&runtime_plugins, input).await
    }
