...
impl ListTagsOfResourceOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_tags_of_resource::builders::ListTagsOfResourceOutputBuilder {
        super::super::super::operation::list_tags_of_resource::builders::ListTagsOfResourceOutputBuilder::default()
    }
}
...
impl ListTagsOfResourceOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::list_tags_of_resource::ListTagsOfResourceOutput {
