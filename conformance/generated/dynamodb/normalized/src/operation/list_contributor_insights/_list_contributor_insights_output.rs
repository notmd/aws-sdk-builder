...
impl ListContributorInsightsOutput {
    ...
    pub fn contributor_insights_summaries(&self) -> &[super::super::super::types::ContributorInsightsSummary] {
...
impl ListContributorInsightsOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_contributor_insights::builders::ListContributorInsightsOutputBuilder {
        super::super::super::operation::list_contributor_insights::builders::ListContributorInsightsOutputBuilder::default()
    }
}
...
pub struct ListContributorInsightsOutputBuilder {
    pub(crate) contributor_insights_summaries: ::std::option::Option<::std::vec::Vec<super::super::super::types::ContributorInsightsSummary>>,
...
impl ListContributorInsightsOutputBuilder {
    ...
    ///
    /// <p>A list of ContributorInsightsSummary.</p>
    pub fn contributor_insights_summaries(mut self, input: super::super::super::types::ContributorInsightsSummary) -> Self {
    ...
    pub fn set_contributor_insights_summaries(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::ContributorInsightsSummary>>,
    ) -> Self {
    ...
    pub fn build(self) -> super::super::super::operation::list_contributor_insights::ListContributorInsightsOutput {
