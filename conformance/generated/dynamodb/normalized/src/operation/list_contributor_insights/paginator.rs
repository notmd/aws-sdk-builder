...
pub struct ListContributorInsightsPaginator {
    ...
    builder: super::super::super::operation::list_contributor_insights::builders::ListContributorInsightsInputBuilder,
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_contributor_insights_output_output_next_token(resp);
