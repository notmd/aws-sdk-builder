...
impl ListContributorInsightsInput {
    ...
    pub fn builder() -> super::super::super::operation::list_contributor_insights::builders::ListContributorInsightsInputBuilder {
        super::super::super::operation::list_contributor_insights::builders::ListContributorInsightsInputBuilder::default()
    }
}
...
impl ListContributorInsightsInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::list_contributor_insights::ListContributorInsightsInput,
