...
impl Scan {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::super::operation::scan::ScanOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::scan::ScanError,
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("DynamoDB", "Scan", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ScanResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_scan::de_scan_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_scan::de_scan_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ScanRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::super::operation::scan::ScanInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::scan::ScanInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_scan::ser_scan_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::scan::ScanError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::scan::_scan_input::ScanInput;

pub use super::super::operation::scan::_scan_output::ScanOutput;
