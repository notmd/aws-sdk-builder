...
impl ExportTableToPointInTime {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::export_table_to_point_in_time::ExportTableToPointInTimeInput,
    ) -> ::std::result::Result<
        super::super::operation::export_table_to_point_in_time::ExportTableToPointInTimeOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::export_table_to_point_in_time::ExportTableToPointInTimeError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::export_table_to_point_in_time::ExportTableToPointInTimeError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::export_table_to_point_in_time::ExportTableToPointInTimeOutput>()
    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(super::super::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut super::super::operation::export_table_to_point_in_time::ExportTableToPointInTimeInput =
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ExportTableToPointInTimeResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_export_table_to_point_in_time::de_export_table_to_point_in_time_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_export_table_to_point_in_time::de_export_table_to_point_in_time_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ExportTableToPointInTimeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::export_table_to_point_in_time::ExportTableToPointInTimeInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::export_table_to_point_in_time::ExportTableToPointInTimeInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_export_table_to_point_in_time::ser_export_table_to_point_in_time_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::super::operation::export_table_to_point_in_time::ExportTableToPointInTimeError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::export_table_to_point_in_time::_export_table_to_point_in_time_input::ExportTableToPointInTimeInput;

pub use super::super::operation::export_table_to_point_in_time::_export_table_to_point_in_time_output::ExportTableToPointInTimeOutput;
