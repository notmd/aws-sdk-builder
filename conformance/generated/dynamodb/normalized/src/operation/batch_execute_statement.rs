    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::batch_execute_statement::BatchExecuteStatementError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::batch_execute_statement::BatchExecuteStatementOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchExecuteStatementResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_batch_execute_statement::de_batch_execute_statement_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_batch_execute_statement::de_batch_execute_statement_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchExecuteStatementRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::batch_execute_statement::BatchExecuteStatementInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::batch_execute_statement::BatchExecuteStatementInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::batch_execute_statement::BatchExecuteStatementError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::batch_execute_statement::_batch_execute_statement_input::BatchExecuteStatementInput;

pub use super::super::operation::batch_execute_statement::_batch_execute_statement_output::BatchExecuteStatementOutput;
