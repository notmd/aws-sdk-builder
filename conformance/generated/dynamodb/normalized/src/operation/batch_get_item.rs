...
impl BatchGetItem {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::super::operation::batch_get_item::BatchGetItemOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::batch_get_item::BatchGetItemError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::batch_get_item::BatchGetItemError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::batch_get_item::BatchGetItemOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchGetItemResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_batch_get_item::de_batch_get_item_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_batch_get_item::de_batch_get_item_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchGetItemRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::batch_get_item::BatchGetItemInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::batch_get_item::BatchGetItemInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_batch_get_item::ser_batch_get_item_input(&input)?);
...
fn get_resource_arn_list(input: &super::super::operation::batch_get_item::BatchGetItemInput) -> Option<::std::vec::Vec<::std::string::String>> {
...
impl ::aws_types::request_id::RequestId for super::super::operation::batch_get_item::BatchGetItemError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::batch_get_item::_batch_get_item_input::BatchGetItemInput;

pub use super::super::operation::batch_get_item::_batch_get_item_output::BatchGetItemOutput;
