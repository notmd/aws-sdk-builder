...
impl ListTagsOfResource {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::list_tags_of_resource::ListTagsOfResourceInput,
    ) -> ::std::result::Result<
        super::super::operation::list_tags_of_resource::ListTagsOfResourceOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::list_tags_of_resource::ListTagsOfResourceError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::list_tags_of_resource::ListTagsOfResourceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::list_tags_of_resource::ListTagsOfResourceOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListTagsOfResourceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_list_tags_of_resource::de_list_tags_of_resource_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_list_tags_of_resource::de_list_tags_of_resource_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListTagsOfResourceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::list_tags_of_resource::ListTagsOfResourceInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::list_tags_of_resource::ListTagsOfResourceInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::list_tags_of_resource::ListTagsOfResourceError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::list_tags_of_resource::_list_tags_of_resource_input::ListTagsOfResourceInput;

pub use super::super::operation::list_tags_of_resource::_list_tags_of_resource_output::ListTagsOfResourceOutput;
