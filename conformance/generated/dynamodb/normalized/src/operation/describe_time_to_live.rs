...
impl DescribeTimeToLive {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::describe_time_to_live::DescribeTimeToLiveInput,
    ) -> ::std::result::Result<
        super::super::operation::describe_time_to_live::DescribeTimeToLiveOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::describe_time_to_live::DescribeTimeToLiveError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::describe_time_to_live::DescribeTimeToLiveError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::describe_time_to_live::DescribeTimeToLiveOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("DynamoDB", "DescribeTimeToLive", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeTimeToLiveResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_describe_time_to_live::de_describe_time_to_live_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_describe_time_to_live::de_describe_time_to_live_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeTimeToLiveRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::describe_time_to_live::DescribeTimeToLiveInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::describe_time_to_live::DescribeTimeToLiveInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::describe_time_to_live::DescribeTimeToLiveError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::describe_time_to_live::_describe_time_to_live_input::DescribeTimeToLiveInput;

pub use super::super::operation::describe_time_to_live::_describe_time_to_live_output::DescribeTimeToLiveOutput;
