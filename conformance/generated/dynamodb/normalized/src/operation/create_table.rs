...
impl CreateTable {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::create_table::CreateTableInput,
    ) -> ::std::result::Result<
        super::super::operation::create_table::CreateTableOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::create_table::CreateTableError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::create_table::CreateTableError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::create_table::CreateTableOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("DynamoDB", "CreateTable", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateTableResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_create_table::de_create_table_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_create_table::de_create_table_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateTableRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::create_table::CreateTableInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::create_table::CreateTableInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_create_table::ser_create_table_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::create_table::CreateTableError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::create_table::_create_table_input::CreateTableInput;

pub use super::super::operation::create_table::_create_table_output::CreateTableOutput;
