...
impl DescribeTimeToLiveInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_time_to_live::builders::DescribeTimeToLiveInputBuilder {
        super::super::super::operation::describe_time_to_live::builders::DescribeTimeToLiveInputBuilder::default()
    }
}
