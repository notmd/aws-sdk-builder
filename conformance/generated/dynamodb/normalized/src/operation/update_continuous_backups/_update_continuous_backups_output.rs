...
impl UpdateContinuousBackupsOutput {
    ...
    pub fn builder() -> super::super::super::operation::update_continuous_backups::builders::UpdateContinuousBackupsOutputBuilder {
        super::super::super::operation::update_continuous_backups::builders::UpdateContinuousBackupsOutputBuilder::default()
    }
}
...
impl UpdateContinuousBackupsOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::update_continuous_backups::UpdateContinuousBackupsOutput {
