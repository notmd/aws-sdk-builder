...
impl UpdateContinuousBackupsInput {
    ...
    /// <p>Represents the settings used to enable point in time recovery.</p>
    pub fn point_in_time_recovery_specification(&self) -> ::std::option::Option<&super::super::super::types::PointInTimeRecoverySpecification> {
...
impl UpdateContinuousBackupsInput {
    ...
    pub fn builder() -> super::super::super::operation::update_continuous_backups::builders::UpdateContinuousBackupsInputBuilder {
        super::super::super::operation::update_continuous_backups::builders::UpdateContinuousBackupsInputBuilder::default()
    }
}
...
pub struct UpdateContinuousBackupsInputBuilder {
    ...
    pub(crate) point_in_time_recovery_specification: ::std::option::Option<super::super::super::types::PointInTimeRecoverySpecification>,
}
impl UpdateContinuousBackupsInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::update_continuous_backups::UpdateContinuousBackupsInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::update_continuous_backups::UpdateContinuousBackupsInput {
