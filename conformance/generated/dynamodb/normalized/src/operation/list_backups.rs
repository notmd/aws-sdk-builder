...
impl ListBackups {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::list_backups::ListBackupsInput,
    ) -> ::std::result::Result<
        super::super::operation::list_backups::ListBackupsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::list_backups::ListBackupsError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::list_backups::ListBackupsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::list_backups::ListBackupsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("DynamoDB", "ListBackups", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListBackupsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_list_backups::de_list_backups_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_list_backups::de_list_backups_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListBackupsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::list_backups::ListBackupsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::list_backups::ListBackupsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_list_backups::ser_list_backups_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::list_backups::ListBackupsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::list_backups::_list_backups_input::ListBackupsInput;

pub use super::super::operation::list_backups::_list_backups_output::ListBackupsOutput;
