...
impl DescribeTableInput {
    ...
    pub fn builder() -> super::super::super::operation::describe_table::builders::DescribeTableInputBuilder {
        super::super::super::operation::describe_table::builders::DescribeTableInputBuilder::default()
    }
}
