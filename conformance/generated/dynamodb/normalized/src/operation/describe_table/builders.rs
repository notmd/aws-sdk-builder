...
pub use super::super::super::operation::describe_table::_describe_table_input::DescribeTableInputBuilder;

pub use super::super::super::operation::describe_table::_describe_table_output::DescribeTableOutputBuilder;

impl super::super::super::operation::describe_table::builders::DescribeTableInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::describe_table::DescribeTableOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::describe_table::DescribeTableError,
...
pub struct DescribeTableFluentBuilder {
    ...
    inner: super::super::super::operation::describe_table::builders::DescribeTableInputBuilder,
...
impl DescribeTableFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::describe_table::builders::DescribeTableInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::describe_table::DescribeTable::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::describe_table::DescribeTable::orchestrate(&runtime_plugins, input).await
    }
