...
impl ListTables {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::list_tables::ListTablesInput,
    ) -> ::std::result::Result<
        super::super::operation::list_tables::ListTablesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::list_tables::ListTablesError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::list_tables::ListTablesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::list_tables::ListTablesOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("DynamoDB", "ListTables", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListTablesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_list_tables::de_list_tables_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_list_tables::de_list_tables_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListTablesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::super::operation::list_tables::ListTablesInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::list_tables::ListTablesInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_list_tables::ser_list_tables_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::list_tables::ListTablesError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::list_tables::_list_tables_input::ListTablesInput;

pub use super::super::operation::list_tables::_list_tables_output::ListTablesOutput;
