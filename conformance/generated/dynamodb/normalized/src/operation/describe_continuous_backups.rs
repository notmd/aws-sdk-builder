...
impl DescribeContinuousBackups {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::describe_continuous_backups::DescribeContinuousBackupsInput,
    ) -> ::std::result::Result<
        super::super::operation::describe_continuous_backups::DescribeContinuousBackupsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::describe_continuous_backups::DescribeContinuousBackupsError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::describe_continuous_backups::DescribeContinuousBackupsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::describe_continuous_backups::DescribeContinuousBackupsOutput>()
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeContinuousBackupsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DescribeContinuousBackupsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeContinuousBackupsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_describe_continuous_backups::de_describe_continuous_backups_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_describe_continuous_backups::de_describe_continuous_backups_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeContinuousBackupsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::describe_continuous_backups::DescribeContinuousBackupsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::describe_continuous_backups::DescribeContinuousBackupsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_describe_continuous_backups::ser_describe_continuous_backups_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::super::operation::describe_continuous_backups::DescribeContinuousBackupsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::describe_continuous_backups::_describe_continuous_backups_input::DescribeContinuousBackupsInput;

pub use super::super::operation::describe_continuous_backups::_describe_continuous_backups_output::DescribeContinuousBackupsOutput;
