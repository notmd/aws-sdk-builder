...
pub use super::super::super::operation::list_tables::_list_tables_input::ListTablesInputBuilder;

pub use super::super::super::operation::list_tables::_list_tables_output::ListTablesOutputBuilder;

impl super::super::super::operation::list_tables::builders::ListTablesInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::list_tables::ListTablesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::list_tables::ListTablesError,
...
pub struct ListTablesFluentBuilder {
    ...
    inner: super::super::super::operation::list_tables::builders::ListTablesInputBuilder,
...
impl ListTablesFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::list_tables::builders::ListTablesInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::list_tables::ListTables::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::list_tables::ListTables::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::super::super::operation::list_tables::paginator::ListTablesPaginator {
        super::super::super::operation::list_tables::paginator::ListTablesPaginator::new(self.handle, self.inner)
    }
