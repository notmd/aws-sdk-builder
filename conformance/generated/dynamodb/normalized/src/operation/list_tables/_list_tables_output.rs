...
impl ListTablesOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_tables::builders::ListTablesOutputBuilder {
        super::super::super::operation::list_tables::builders::ListTablesOutputBuilder::default()
    }
}
...
impl ListTablesOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::list_tables::ListTablesOutput {
