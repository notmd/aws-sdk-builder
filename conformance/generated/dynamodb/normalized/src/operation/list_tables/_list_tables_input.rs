...
impl ListTablesInput {
    ...
    pub fn builder() -> super::super::super::operation::list_tables::builders::ListTablesInputBuilder {
        super::super::super::operation::list_tables::builders::ListTablesInputBuilder::default()
    }
}
