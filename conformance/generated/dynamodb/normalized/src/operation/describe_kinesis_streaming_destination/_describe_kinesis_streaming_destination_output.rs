...
impl DescribeKinesisStreamingDestinationOutput {
    ...
    pub fn kinesis_data_stream_destinations(&self) -> &[super::super::super::types::KinesisDataStreamDestination] {
...
pub struct DescribeKinesisStreamingDestinationOutputBuilder {
    ...
    pub(crate) kinesis_data_stream_destinations: ::std::option::Option<::std::vec::Vec<super::super::super::types::KinesisDataStreamDestination>>,
    _request_id: Option<String>,
}
impl DescribeKinesisStreamingDestinationOutputBuilder {
    ...
    ///
    /// <p>The list of replica structures for the table being described.</p>
    pub fn kinesis_data_stream_destinations(mut self, input: super::super::super::types::KinesisDataStreamDestination) -> Self {
    ...
    pub fn set_kinesis_data_stream_destinations(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::super::types::KinesisDataStreamDestination>>,
    ) -> Self {
    ...
    pub fn build(self) -> super::super::super::operation::describe_kinesis_streaming_destination::DescribeKinesisStreamingDestinationOutput {
