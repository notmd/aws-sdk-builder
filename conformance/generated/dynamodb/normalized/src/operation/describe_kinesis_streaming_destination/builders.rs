...
pub use super::super::super::operation::describe_kinesis_streaming_destination::_describe_kinesis_streaming_destination_input::DescribeKinesisStreamingDestinationInputBuilder;

pub use super::super::super::operation::describe_kinesis_streaming_destination::_describe_kinesis_streaming_destination_output::DescribeKinesisStreamingDestinationOutputBuilder;

impl super::super::super::operation::describe_kinesis_streaming_destination::builders::DescribeKinesisStreamingDestinationInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::describe_kinesis_streaming_destination::DescribeKinesisStreamingDestinationOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::describe_kinesis_streaming_destination::DescribeKinesisStreamingDestinationError,
...
pub struct DescribeKinesisStreamingDestinationFluentBuilder {
    ...
    inner: super::super::super::operation::describe_kinesis_streaming_destination::builders::DescribeKinesisStreamingDestinationInputBuilder,
...
impl DescribeKinesisStreamingDestinationFluentBuilder {
    ...
    > {
        ...
        let runtime_plugins =
            super::super::super::operation::describe_kinesis_streaming_destination::DescribeKinesisStreamingDestination::operation_runtime_plugins(
