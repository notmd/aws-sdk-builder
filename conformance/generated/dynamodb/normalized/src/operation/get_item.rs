...
impl GetItem {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::get_item::GetItemInput,
    ) -> ::std::result::Result<
        super::super::operation::get_item::GetItemOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::get_item::GetItemError,
    ...
    > {
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::get_item::GetItemOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("DynamoDB", "GetItem", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetItemResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_get_item::de_get_item_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_get_item::de_get_item_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetItemRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::super::operation::get_item::GetItemInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::get_item::GetItemInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_get_item::ser_get_item_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::get_item::GetItemError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::get_item::_get_item_input::GetItemInput;

pub use super::super::operation::get_item::_get_item_output::GetItemOutput;
