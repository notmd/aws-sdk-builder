...
pub use super::super::super::operation::update_table::_update_table_input::UpdateTableInputBuilder;

pub use super::super::super::operation::update_table::_update_table_output::UpdateTableOutputBuilder;

impl super::super::super::operation::update_table::builders::UpdateTableInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::update_table::UpdateTableOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::update_table::UpdateTableError,
...
pub struct UpdateTableFluentBuilder {
    ...
    inner: super::super::super::operation::update_table::builders::UpdateTableInputBuilder,
...
impl UpdateTableFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::update_table::builders::UpdateTableInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::update_table::UpdateTable::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::update_table::UpdateTable::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn multi_region_consistency(mut self, input: super::super::super::types::MultiRegionConsistency) -> Self {
        self.inner = self.inner.multi_region_consistency(input);
        self
    }
    /// <p>Specifies the consistency mode for a new global table. This parameter is only valid when you create a global table by specifying one or more <a href="https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_ReplicationGroupUpdate.html#DDB-Type-ReplicationGroupUpdate-Create">Create</a> actions in the <a href="https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_UpdateTable.html#DDB-UpdateTable-request-ReplicaUpdates">ReplicaUpdates</a> action list.</p>
    /// <p>You can specify one of the following consistency modes:</p>
    ...
    pub fn set_multi_region_consistency(mut self, input: ::std::option::Option<super::super::super::types::MultiRegionConsistency>) -> Self {
        self.inner = self.inner.set_multi_region_consistency(input);
        self
    }
    /// <p>Specifies the consistency mode for a new global table. This parameter is only valid when you create a global table by specifying one or more <a href="https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_ReplicationGroupUpdate.html#DDB-Type-ReplicationGroupUpdate-Create">Create</a> actions in the <a href="https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_UpdateTable.html#DDB-UpdateTable-request-ReplicaUpdates">ReplicaUpdates</a> action list.</p>
    /// <p>You can specify one of the following consistency modes:</p>
    ...
    ///
    /// Appends an item to `GlobalTableWitnessUpdates`.
    ///
    ...
    pub fn set_global_table_witness_updates(
        ...
        self.inner = self.inner.set_global_table_witness_updates(input);
        self
    }
    /// <p>A list of witness updates for a MRSC global table. A witness provides a cost-effective alternative to a full replica in a MRSC global table by maintaining replicated change data written to global table replicas. You cannot perform read or write operations on a witness. For each witness, you can request one action:</p>
    /// <ul>
