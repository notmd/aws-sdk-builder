...
pub use super::super::super::operation::delete_backup::_delete_backup_input::DeleteBackupInputBuilder;

pub use super::super::super::operation::delete_backup::_delete_backup_output::DeleteBackupOutputBuilder;

impl super::super::super::operation::delete_backup::builders::DeleteBackupInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_backup::DeleteBackupOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_backup::DeleteBackupError,
...
pub struct DeleteBackupFluentBuilder {
    ...
    inner: super::super::super::operation::delete_backup::builders::DeleteBackupInputBuilder,
...
impl DeleteBackupFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_backup::builders::DeleteBackupInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_backup::DeleteBackup::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_backup::DeleteBackup::orchestrate(&runtime_plugins, input).await
    }
