...
impl DeleteBackupInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_backup::builders::DeleteBackupInputBuilder {
        super::super::super::operation::delete_backup::builders::DeleteBackupInputBuilder::default()
    }
}
