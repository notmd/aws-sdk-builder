    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::execute_statement::ExecuteStatementError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::execute_statement::ExecuteStatementOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ExecuteStatementResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_execute_statement::de_execute_statement_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_execute_statement::de_execute_statement_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ExecuteStatementRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::execute_statement::ExecuteStatementInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::execute_statement::ExecuteStatementInput,
...
pub enum ExecuteStatementError {
    ...
    DuplicateItemException(super::super::types::error::DuplicateItemException),
...
impl ::aws_types::request_id::RequestId for super::super::operation::execute_statement::ExecuteStatementError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::execute_statement::_execute_statement_input::ExecuteStatementInput;

pub use super::super::operation::execute_statement::_execute_statement_output::ExecuteStatementOutput;
