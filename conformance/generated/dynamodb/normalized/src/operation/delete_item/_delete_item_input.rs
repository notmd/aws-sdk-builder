...
impl DeleteItemInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_item::builders::DeleteItemInputBuilder {
        super::super::super::operation::delete_item::builders::DeleteItemInputBuilder::default()
    }
}
