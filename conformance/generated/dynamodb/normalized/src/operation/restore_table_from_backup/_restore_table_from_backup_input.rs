...
impl RestoreTableFromBackupInput {
    ...
    /// <p>The billing mode of the restored table.</p>
    pub fn billing_mode_override(&self) -> ::std::option::Option<&super::super::super::types::BillingMode> {
    ...
    pub fn global_secondary_index_override(&self) -> &[super::super::super::types::GlobalSecondaryIndex] {
    ...
    pub fn local_secondary_index_override(&self) -> &[super::super::super::types::LocalSecondaryIndex] {
        self.local_secondary_index_override.as_deref().unwrap_or_default()
    }
    /// <p>Provisioned throughput settings for the restored table.</p>
    pub fn provisioned_throughput_override(&self) -> ::std::option::Option<&super::super::super::types::ProvisionedThroughput> {
        self.provisioned_throughput_override.as_ref()
    }
    /// <p>Sets the maximum number of read and write units for the specified on-demand table. If you use this parameter, you must specify <code>MaxReadRequestUnits</code>, <code>MaxWriteRequestUnits</code>, or both.</p>
    pub fn on_demand_throughput_override(&self) -> ::std::option::Option<&super::super::super::types::OnDemandThroughput> {
        self.on_demand_throughput_override.as_ref()
    }
    /// <p>The new server-side encryption settings for the restored table.</p>
    pub fn sse_specification_override(&self) -> ::std::option::Option<&super::super::super::types::SseSpecification> {
    ...
    pub fn vector_index_override(&self) -> &[super::super::super::types::VectorIndex] {
...
impl RestoreTableFromBackupInput {
    ...
    pub fn builder() -> super::super::super::operation::restore_table_from_backup::builders::RestoreTableFromBackupInputBuilder {
        super::super::super::operation::restore_table_from_backup::builders::RestoreTableFromBackupInputBuilder::default()
    }
}
...
pub struct RestoreTableFromBackupInputBuilder {
    ...
    pub(crate) billing_mode_override: ::std::option::Option<super::super::super::types::BillingMode>,
    pub(crate) global_secondary_index_override: ::std::option::Option<::std::vec::Vec<super::super::super::types::GlobalSecondaryIndex>>,
    pub(crate) local_secondary_index_override: ::std::option::Option<::std::vec::Vec<super::super::super::types::LocalSecondaryIndex>>,
    pub(crate) provisioned_throughput_override: ::std::option::Option<super::super::super::types::ProvisionedThroughput>,
    pub(crate) on_demand_throughput_override: ::std::option::Option<super::super::super::types::OnDemandThroughput>,
    pub(crate) sse_specification_override: ::std::option::Option<super::super::super::types::SseSpecification>,
    pub(crate) vector_index_override: ::std::option::Option<::std::vec::Vec<super::super::super::types::VectorIndex>>,
}
impl RestoreTableFromBackupInputBuilder {
    ...
    /// <p>The billing mode of the restored table.</p>
    pub fn billing_mode_override(mut self, input: super::super::super::types::BillingMode) -> Self {
        self.billing_mode_override = ::std::option::Option::Some(input);
        self
    }
    /// <p>The billing mode of the restored table.</p>
    pub fn set_billing_mode_override(mut self, input: ::std::option::Option<super::super::super::types::BillingMode>) -> Self {
        self.billing_mode_override = input;
        self
    }
    /// <p>The billing mode of the restored table.</p>
    pub fn get_billing_mode_override(&self) -> &::std::option::Option<super::super::super::types::BillingMode> {
    ...
    ///
    /// <p>List of global secondary indexes for the restored table. The indexes provided should match existing secondary indexes. You can choose to exclude some or all of the indexes at the time of restore.</p>
    pub fn global_secondary_index_override(mut self, input: super::super::super::types::GlobalSecondaryIndex) -> Self {
    ...
    /// <p>List of global secondary indexes for the restored table. The indexes provided should match existing secondary indexes. You can choose to exclude some or all of the indexes at the time of restore.</p>
    pub fn get_global_secondary_index_override(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::GlobalSecondaryIndex>> {
    ...
    ///
    /// <p>List of local secondary indexes for the restored table. The indexes provided should match existing secondary indexes. You can choose to exclude some or all of the indexes at the time of restore.</p>
    pub fn local_secondary_index_override(mut self, input: super::super::super::types::LocalSecondaryIndex) -> Self {
    ...
    /// <p>List of local secondary indexes for the restored table. The indexes provided should match existing secondary indexes. You can choose to exclude some or all of the indexes at the time of restore.</p>
    pub fn get_local_secondary_index_override(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::LocalSecondaryIndex>> {
        &self.local_secondary_index_override
    }
    /// <p>Provisioned throughput settings for the restored table.</p>
    pub fn provisioned_throughput_override(mut self, input: super::super::super::types::ProvisionedThroughput) -> Self {
        self.provisioned_throughput_override = ::std::option::Option::Some(input);
        self
    }
    /// <p>Provisioned throughput settings for the restored table.</p>
    pub fn set_provisioned_throughput_override(mut self, input: ::std::option::Option<super::super::super::types::ProvisionedThroughput>) -> Self {
        self.provisioned_throughput_override = input;
        self
    }
    /// <p>Provisioned throughput settings for the restored table.</p>
    pub fn get_provisioned_throughput_override(&self) -> &::std::option::Option<super::super::super::types::ProvisionedThroughput> {
        &self.provisioned_throughput_override
    }
    /// <p>Sets the maximum number of read and write units for the specified on-demand table. If you use this parameter, you must specify <code>MaxReadRequestUnits</code>, <code>MaxWriteRequestUnits</code>, or both.</p>
    pub fn on_demand_throughput_override(mut self, input: super::super::super::types::OnDemandThroughput) -> Self {
        self.on_demand_throughput_override = ::std::option::Option::Some(input);
        self
    }
    /// <p>Sets the maximum number of read and write units for the specified on-demand table. If you use this parameter, you must specify <code>MaxReadRequestUnits</code>, <code>MaxWriteRequestUnits</code>, or both.</p>
    pub fn set_on_demand_throughput_override(mut self, input: ::std::option::Option<super::super::super::types::OnDemandThroughput>) -> Self {
        self.on_demand_throughput_override = input;
        self
    }
    /// <p>Sets the maximum number of read and write units for the specified on-demand table. If you use this parameter, you must specify <code>MaxReadRequestUnits</code>, <code>MaxWriteRequestUnits</code>, or both.</p>
    pub fn get_on_demand_throughput_override(&self) -> &::std::option::Option<super::super::super::types::OnDemandThroughput> {
        &self.on_demand_throughput_override
    }
    /// <p>The new server-side encryption settings for the restored table.</p>
    pub fn sse_specification_override(mut self, input: super::super::super::types::SseSpecification) -> Self {
        self.sse_specification_override = ::std::option::Option::Some(input);
        self
    }
    /// <p>The new server-side encryption settings for the restored table.</p>
    pub fn set_sse_specification_override(mut self, input: ::std::option::Option<super::super::super::types::SseSpecification>) -> Self {
        self.sse_specification_override = input;
        self
    }
    /// <p>The new server-side encryption settings for the restored table.</p>
    pub fn get_sse_specification_override(&self) -> &::std::option::Option<super::super::super::types::SseSpecification> {
    ...
    ///
    /// <p>The vector indexes for the restored table. If not specified, all vector indexes from the backup are restored. The indexes provided must match existing vector indexes from the backup. You can choose to exclude some or all of the vector indexes at the time of restore.</p>
    pub fn vector_index_override(mut self, input: super::super::super::types::VectorIndex) -> Self {
    ...
    /// <p>The vector indexes for the restored table. If not specified, all vector indexes from the backup are restored. The indexes provided must match existing vector indexes from the backup. You can choose to exclude some or all of the vector indexes at the time of restore.</p>
    pub fn set_vector_index_override(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::VectorIndex>>) -> Self {
        self.vector_index_override = input;
        self
    }
    /// <p>The vector indexes for the restored table. If not specified, all vector indexes from the backup are restored. The indexes provided must match existing vector indexes from the backup. You can choose to exclude some or all of the vector indexes at the time of restore.</p>
    pub fn get_vector_index_override(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::VectorIndex>> {
    ...
    pub fn build(
        ...
        super::super::super::operation::restore_table_from_backup::RestoreTableFromBackupInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::restore_table_from_backup::RestoreTableFromBackupInput {
