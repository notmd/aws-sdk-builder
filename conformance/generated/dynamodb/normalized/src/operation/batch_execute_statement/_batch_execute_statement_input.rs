...
impl BatchExecuteStatementInput {
    ...
    pub fn statements(&self) -> &[super::super::super::types::BatchStatementRequest] {
...
impl BatchExecuteStatementInput {
    ...
    pub fn builder() -> super::super::super::operation::batch_execute_statement::builders::BatchExecuteStatementInputBuilder {
        super::super::super::operation::batch_execute_statement::builders::BatchExecuteStatementInputBuilder::default()
    }
}
...
pub struct BatchExecuteStatementInputBuilder {
    pub(crate) statements: ::std::option::Option<::std::vec::Vec<super::super::super::types::BatchStatementRequest>>,
