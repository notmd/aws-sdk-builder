...
impl SearchVectorsInput {
    ...
    pub fn search_vector(&self) -> &[super::super::super::types::AttributeValue] {
...
impl SearchVectorsInput {
    ...
    pub fn builder() -> super::super::super::operation::search_vectors::builders::SearchVectorsInputBuilder {
        super::super::super::operation::search_vectors::builders::SearchVectorsInputBuilder::default()
    }
}
