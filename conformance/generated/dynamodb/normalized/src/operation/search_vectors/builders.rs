...
pub use super::super::super::operation::search_vectors::_search_vectors_input::SearchVectorsInputBuilder;

pub use super::super::super::operation::search_vectors::_search_vectors_output::SearchVectorsOutputBuilder;

impl super::super::super::operation::search_vectors::builders::SearchVectorsInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::search_vectors::SearchVectorsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::search_vectors::SearchVectorsError,
...
pub struct SearchVectorsFluentBuilder {
    ...
    inner: super::super::super::operation::search_vectors::builders::SearchVectorsInputBuilder,
...
impl SearchVectorsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::search_vectors::builders::SearchVectorsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::search_vectors::SearchVectors::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::search_vectors::SearchVectors::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn search_vector(mut self, input: super::super::super::types::AttributeValue) -> Self {
        self.inner = self.inner.search_vector(input);
        self
    }
    /// <p>The search vector to compare against the indexed vectors. Each element is a 32-bit IEEE-754 floating point number, provided in DynamoDB list format.</p>
    /// <p>The number of dimensions must match the number of dimensions configured for the vector index.</p>
    pub fn set_search_vector(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::AttributeValue>>) -> Self {
        self.inner = self.inner.set_search_vector(input);
        self
    }
    /// <p>The search vector to compare against the indexed vectors. Each element is a 32-bit IEEE-754 floating point number, provided in DynamoDB list format.</p>
    /// <p>The number of dimensions must match the number of dimensions configured for the vector index.</p>
    pub fn get_search_vector(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::AttributeValue>> {
