...
impl SearchVectorsOutput {
    /// <p>The capacity units consumed by the <code>SearchVectors</code> operation. Contains <code>VectorSearchRequestBytes</code>, which represents the vector search capacity consumed.</p>
    pub fn consumed_capacity(&self) -> ::std::option::Option<&super::super::super::types::VectorCapacity> {
    ...
    pub fn search_results(&self) -> &[super::super::super::types::SearchResultItem] {
...
impl SearchVectorsOutput {
    ...
    pub fn builder() -> super::super::super::operation::search_vectors::builders::SearchVectorsOutputBuilder {
        super::super::super::operation::search_vectors::builders::SearchVectorsOutputBuilder::default()
    }
}
...
pub struct SearchVectorsOutputBuilder {
    pub(crate) consumed_capacity: ::std::option::Option<super::super::super::types::VectorCapacity>,
    pub(crate) search_results: ::std::option::Option<::std::vec::Vec<super::super::super::types::SearchResultItem>>,
    _request_id: Option<String>,
}
impl SearchVectorsOutputBuilder {
    /// <p>The capacity units consumed by the <code>SearchVectors</code> operation. Contains <code>VectorSearchRequestBytes</code>, which represents the vector search capacity consumed.</p>
    pub fn consumed_capacity(mut self, input: super::super::super::types::VectorCapacity) -> Self {
        self.consumed_capacity = ::std::option::Option::Some(input);
        self
    }
    /// <p>The capacity units consumed by the <code>SearchVectors</code> operation. Contains <code>VectorSearchRequestBytes</code>, which represents the vector search capacity consumed.</p>
    pub fn set_consumed_capacity(mut self, input: ::std::option::Option<super::super::super::types::VectorCapacity>) -> Self {
        self.consumed_capacity = input;
        self
    }
    /// <p>The capacity units consumed by the <code>SearchVectors</code> operation. Contains <code>VectorSearchRequestBytes</code>, which represents the vector search capacity consumed.</p>
    pub fn get_consumed_capacity(&self) -> &::std::option::Option<super::super::super::types::VectorCapacity> {
    ...
    ///
    /// <p>A list of items returned by the vector similarity search, sorted by similarity with the most similar item first. Each item contains the projected attributes and a similarity score.</p>
    pub fn search_results(mut self, input: super::super::super::types::SearchResultItem) -> Self {
    ...
    /// <p>A list of items returned by the vector similarity search, sorted by similarity with the most similar item first. Each item contains the projected attributes and a similarity score.</p>
    pub fn set_search_results(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::SearchResultItem>>) -> Self {
        self.search_results = input;
        self
    }
    /// <p>A list of items returned by the vector similarity search, sorted by similarity with the most similar item first. Each item contains the projected attributes and a similarity score.</p>
    pub fn get_search_results(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::SearchResultItem>> {
        &self.search_results
    }
    ...
    pub fn build(self) -> super::super::super::operation::search_vectors::SearchVectorsOutput {
