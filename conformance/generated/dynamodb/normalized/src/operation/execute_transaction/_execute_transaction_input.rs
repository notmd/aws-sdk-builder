...
impl ExecuteTransactionInput {
    ...
    pub fn transact_statements(&self) -> &[super::super::super::types::ParameterizedStatement] {
...
impl ExecuteTransactionInput {
    ...
    pub fn builder() -> super::super::super::operation::execute_transaction::builders::ExecuteTransactionInputBuilder {
        super::super::super::operation::execute_transaction::builders::ExecuteTransactionInputBuilder::default()
    }
}
...
pub struct ExecuteTransactionInputBuilder {
    pub(crate) transact_statements: ::std::option::Option<::std::vec::Vec<super::super::super::types::ParameterizedStatement>>,
