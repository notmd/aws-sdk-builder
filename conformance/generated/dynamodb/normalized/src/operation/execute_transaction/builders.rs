...
pub use super::super::super::operation::execute_transaction::_execute_transaction_input::ExecuteTransactionInputBuilder;

pub use super::super::super::operation::execute_transaction::_execute_transaction_output::ExecuteTransactionOutputBuilder;

impl super::super::super::operation::execute_transaction::builders::ExecuteTransactionInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::execute_transaction::ExecuteTransactionOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::execute_transaction::ExecuteTransactionError,
...
pub struct ExecuteTransactionFluentBuilder {
    ...
    inner: super::super::super::operation::execute_transaction::builders::ExecuteTransactionInputBuilder,
...
impl ExecuteTransactionFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::execute_transaction::builders::ExecuteTransactionInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::execute_transaction::ExecuteTransaction::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::execute_transaction::ExecuteTransaction::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn transact_statements(mut self, input: super::super::super::types::ParameterizedStatement) -> Self {
    ...
    /// <p>The list of PartiQL statements representing the transaction to run.</p>
    pub fn get_transact_statements(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::ParameterizedStatement>> {
