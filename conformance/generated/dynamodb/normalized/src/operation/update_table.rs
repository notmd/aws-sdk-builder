...
impl UpdateTable {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::update_table::UpdateTableInput,
    ) -> ::std::result::Result<
        super::super::operation::update_table::UpdateTableOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::update_table::UpdateTableError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::update_table::UpdateTableError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::update_table::UpdateTableOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("DynamoDB", "UpdateTable", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateTableResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_update_table::de_update_table_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_update_table::de_update_table_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateTableRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::update_table::UpdateTableInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::update_table::UpdateTableInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_update_table::ser_update_table_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::update_table::UpdateTableError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::update_table::_update_table_input::UpdateTableInput;

pub use super::super::operation::update_table::_update_table_output::UpdateTableOutput;
