...
impl ListGlobalTablesInput {
    ...
    pub fn builder() -> super::super::super::operation::list_global_tables::builders::ListGlobalTablesInputBuilder {
        super::super::super::operation::list_global_tables::builders::ListGlobalTablesInputBuilder::default()
    }
}
