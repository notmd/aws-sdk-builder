...
pub use super::super::super::operation::list_global_tables::_list_global_tables_input::ListGlobalTablesInputBuilder;

pub use super::super::super::operation::list_global_tables::_list_global_tables_output::ListGlobalTablesOutputBuilder;

impl super::super::super::operation::list_global_tables::builders::ListGlobalTablesInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::list_global_tables::ListGlobalTablesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::list_global_tables::ListGlobalTablesError,
...
pub struct ListGlobalTablesFluentBuilder {
    ...
    inner: super::super::super::operation::list_global_tables::builders::ListGlobalTablesInputBuilder,
...
impl ListGlobalTablesFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::list_global_tables::builders::ListGlobalTablesInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::list_global_tables::ListGlobalTables::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::list_global_tables::ListGlobalTables::orchestrate(&runtime_plugins, input).await
    }
