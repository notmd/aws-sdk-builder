...
impl UpdateContributorInsightsInput {
    ...
    /// <p>Represents the contributor insights action.</p>
    pub fn contributor_insights_action(&self) -> ::std::option::Option<&super::super::super::types::ContributorInsightsAction> {
...
impl UpdateContributorInsightsInput {
    ...
    pub fn builder() -> super::super::super::operation::update_contributor_insights::builders::UpdateContributorInsightsInputBuilder {
        super::super::super::operation::update_contributor_insights::builders::UpdateContributorInsightsInputBuilder::default()
    }
}
...
pub struct UpdateContributorInsightsInputBuilder {
    ...
    pub(crate) contributor_insights_action: ::std::option::Option<super::super::super::types::ContributorInsightsAction>,
