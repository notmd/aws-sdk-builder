...
pub use super::super::super::operation::update_item::_update_item_input::UpdateItemInputBuilder;

pub use super::super::super::operation::update_item::_update_item_output::UpdateItemOutputBuilder;

impl super::super::super::operation::update_item::builders::UpdateItemInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::update_item::UpdateItemOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::update_item::UpdateItemError,
...
pub struct UpdateItemFluentBuilder {
    ...
    inner: super::super::super::operation::update_item::builders::UpdateItemInputBuilder,
...
impl UpdateItemFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::update_item::builders::UpdateItemInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::update_item::UpdateItem::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::update_item::UpdateItem::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn key(mut self, k: impl ::std::convert::Into<::std::string::String>, v: super::super::super::types::AttributeValue) -> Self {
    ...
    /// <p>The primary key of the item to be updated. Each element consists of an attribute name and a value for that attribute.</p>
    /// <p>For the primary key, you must provide all of the attributes. For example, with a simple primary key, you only need to provide a value for the partition key. For a composite primary key, you must provide values for both the partition key and the sort key.</p>
    pub fn get_key(&self) -> &::std::option::Option<::std::collections::HashMap<::std::string::String, super::super::super::types::AttributeValue>> {
        self.inner.get_key()
    }
    ///
    ...
    pub fn set_attribute_updates(
        mut self,
        input: ::std::option::Option<::std::collections::HashMap<::std::string::String, super::super::super::types::AttributeValueUpdate>>,
    ) -> Self {
    ...
    pub fn expected(mut self, k: impl ::std::convert::Into<::std::string::String>, v: super::super::super::types::ExpectedAttributeValue) -> Self {
    ...
    pub fn set_expected(
        mut self,
        input: ::std::option::Option<::std::collections::HashMap<::std::string::String, super::super::super::types::ExpectedAttributeValue>>,
    ) -> Self {
    ...
    pub fn conditional_operator(mut self, input: super::super::super::types::ConditionalOperator) -> Self {
        self.inner = self.inner.conditional_operator(input);
        self
    }
    /// <p>This is a legacy parameter. Use <code>ConditionExpression</code> instead. For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.ConditionalOperator.html">ConditionalOperator</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p>
    pub fn set_conditional_operator(mut self, input: ::std::option::Option<super::super::super::types::ConditionalOperator>) -> Self {
        self.inner = self.inner.set_conditional_operator(input);
        self
    }
    /// <p>This is a legacy parameter. Use <code>ConditionExpression</code> instead. For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.ConditionalOperator.html">ConditionalOperator</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p>
    pub fn get_conditional_operator(&self) -> &::std::option::Option<super::super::super::types::ConditionalOperator> {
    ...
    pub fn return_values(mut self, input: super::super::super::types::ReturnValue) -> Self {
    ...
    /// <p>There is no additional cost associated with requesting a return value aside from the small network and processing overhead of receiving a larger response. No read capacity units are consumed.</p>
    /// <p>The values returned are strongly consistent.</p>
    pub fn set_return_values(mut self, input: ::std::option::Option<super::super::super::types::ReturnValue>) -> Self {
    ...
    /// <p>There is no additional cost associated with requesting a return value aside from the small network and processing overhead of receiving a larger response. No read capacity units are consumed.</p>
    /// <p>The values returned are strongly consistent.</p>
    pub fn get_return_values(&self) -> &::std::option::Option<super::super::super::types::ReturnValue> {
    ...
    pub fn return_item_collection_metrics(mut self, input: super::super::super::types::ReturnItemCollectionMetrics) -> Self {
    ...
    /// <p>Determines whether item collection metrics are returned. If set to <code>SIZE</code>, the response includes statistics about item collections, if any, that were modified during the operation are returned in the response. If set to <code>NONE</code> (the default), no statistics are returned.</p>
    pub fn get_return_item_collection_metrics(&self) -> &::std::option::Option<super::super::super::types::ReturnItemCollectionMetrics> {
    ...
    /// <p>There is no additional cost associated with requesting a return value aside from the small network and processing overhead of receiving a larger response. No read capacity units are consumed.</p>
    pub fn return_values_on_condition_check_failure(mut self, input: super::super::super::types::ReturnValuesOnConditionCheckFailure) -> Self {
    ...
    pub fn set_return_values_on_condition_check_failure(
        mut self,
        input: ::std::option::Option<super::super::super::types::ReturnValuesOnConditionCheckFailure>,
    ) -> Self {
