...
impl UpdateItemOutput {
    ...
    pub fn builder() -> super::super::super::operation::update_item::builders::UpdateItemOutputBuilder {
        super::super::super::operation::update_item::builders::UpdateItemOutputBuilder::default()
    }
}
...
impl UpdateItemOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::update_item::UpdateItemOutput {
