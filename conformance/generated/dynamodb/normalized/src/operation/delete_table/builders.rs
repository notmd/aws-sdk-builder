...
pub use super::super::super::operation::delete_table::_delete_table_input::DeleteTableInputBuilder;

pub use super::super::super::operation::delete_table::_delete_table_output::DeleteTableOutputBuilder;

impl super::super::super::operation::delete_table::builders::DeleteTableInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_table::DeleteTableOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_table::DeleteTableError,
...
pub struct DeleteTableFluentBuilder {
    ...
    inner: super::super::super::operation::delete_table::builders::DeleteTableInputBuilder,
...
impl DeleteTableFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_table::builders::DeleteTableInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_table::DeleteTable::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_table::DeleteTable::orchestrate(&runtime_plugins, input).await
    }
