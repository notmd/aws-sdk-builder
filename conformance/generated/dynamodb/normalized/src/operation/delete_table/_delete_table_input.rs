...
impl DeleteTableInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_table::builders::DeleteTableInputBuilder {
        super::super::super::operation::delete_table::builders::DeleteTableInputBuilder::default()
    }
}
