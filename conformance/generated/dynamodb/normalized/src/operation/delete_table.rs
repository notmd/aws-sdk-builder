...
impl DeleteTable {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::delete_table::DeleteTableInput,
    ) -> ::std::result::Result<
        super::super::operation::delete_table::DeleteTableOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::delete_table::DeleteTableError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::delete_table::DeleteTableError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::delete_table::DeleteTableOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("DynamoDB", "DeleteTable", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteTableResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_delete_table::de_delete_table_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_delete_table::de_delete_table_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteTableRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::delete_table::DeleteTableInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::delete_table::DeleteTableInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::super::protocol_serde::shape_delete_table::ser_delete_table_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::super::operation::delete_table::DeleteTableError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::delete_table::_delete_table_input::DeleteTableInput;

pub use super::super::operation::delete_table::_delete_table_output::DeleteTableOutput;
