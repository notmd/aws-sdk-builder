...
pub struct ExportCompletedFluentBuilder {
    ...
    inner: super::super::operation::describe_export::builders::DescribeExportInputBuilder,
}
impl ExportCompletedFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::operation::describe_export::builders::DescribeExportInputBuilder {
        &self.inner
    }
    ...
    pub async fn wait(
        ...
        super::super::waiters::export_completed::ExportCompletedFinalPoll,
        super::super::waiters::export_completed::WaitUntilExportCompletedError,
    > {
        let input = self
            .inner
            .build()
            .map_err(::aws_smithy_runtime_api::client::waiters::error::WaiterError::construction_failure)?;
        let runtime_plugins = super::super::operation::describe_export::DescribeExport::operation_runtime_plugins(
        ...
        >| {
            ...
            if super::super::waiters::matchers::match_describe_export_a4219f96bc64309c4(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"output":{"path":"ExportDescription.ExportStatus","expected":"FAILED","comparator":"stringEquals"}}
            if super::super::waiters::matchers::match_describe_export_8d899fd0681b891e9(result) {
        ...
        let operation = move || {
            ...
            async move { super::super::operation::describe_export::DescribeExport::orchestrate(&runtime_plugins, input).await }
        };
