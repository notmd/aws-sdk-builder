...
pub struct KinesisStreamingDestinationActiveFluentBuilder {
    ...
    inner: super::super::operation::describe_kinesis_streaming_destination::builders::DescribeKinesisStreamingDestinationInputBuilder,
}
impl KinesisStreamingDestinationActiveFluentBuilder {
    ...
    pub async fn wait(
        ...
        super::super::waiters::kinesis_streaming_destination_active::KinesisStreamingDestinationActiveFinalPoll,
        super::super::waiters::kinesis_streaming_destination_active::WaitUntilKinesisStreamingDestinationActiveError,
    > {
        let input = self
            .inner
            .build()
        ...
        let runtime_plugins =
            super::super::operation::describe_kinesis_streaming_destination::DescribeKinesisStreamingDestination::operation_runtime_plugins(
        ...
        >| {
            ...
            if super::super::waiters::matchers::match_describe_kinesis_streaming_destination_56e18114fb2c2cf5a(result) {
            ...
            if super::super::waiters::matchers::match_describe_kinesis_streaming_destination_ce975c8fb2b65f98f(result) {
