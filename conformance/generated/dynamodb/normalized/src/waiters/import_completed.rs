...
pub struct ImportCompletedFluentBuilder {
    ...
    inner: super::super::operation::describe_import::builders::DescribeImportInputBuilder,
}
impl ImportCompletedFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::operation::describe_import::builders::DescribeImportInputBuilder {
        &self.inner
    }
    ...
    pub async fn wait(
        ...
        super::super::waiters::import_completed::ImportCompletedFinalPoll,
        super::super::waiters::import_completed::WaitUntilImportCompletedError,
    > {
        let input = self
            .inner
            .build()
            .map_err(::aws_smithy_runtime_api::client::waiters::error::WaiterError::construction_failure)?;
        let runtime_plugins = super::super::operation::describe_import::DescribeImport::operation_runtime_plugins(
        ...
        >| {
            ...
            if super::super::waiters::matchers::match_describe_import_6175a829c57972dc3(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"output":{"path":"ImportTableDescription.ImportStatus","expected":"FAILED","comparator":"stringEquals"}}
            if super::super::waiters::matchers::match_describe_import_ba4301a7fe05a6956(result) {
            ...
            if super::super::waiters::matchers::match_describe_import_b4c5c86bd60d42041(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Failure;
            }
        ...
        let operation = move || {
            ...
            async move { super::super::operation::describe_import::DescribeImport::orchestrate(&runtime_plugins, input).await }
        };
