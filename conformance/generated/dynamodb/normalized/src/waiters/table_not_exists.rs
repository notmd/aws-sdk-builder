...
pub struct TableNotExistsFluentBuilder {
    ...
    inner: super::super::operation::describe_table::builders::DescribeTableInputBuilder,
}
impl TableNotExistsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::operation::describe_table::builders::DescribeTableInputBuilder {
        &self.inner
    }
    ...
    pub async fn wait(
        ...
        super::super::waiters::table_not_exists::TableNotExistsFinalPoll,
        super::super::waiters::table_not_exists::WaitUntilTableNotExistsError,
    > {
        let input = self
            .inner
            .build()
            .map_err(::aws_smithy_runtime_api::client::waiters::error::WaiterError::construction_failure)?;
        let runtime_plugins = super::super::operation::describe_table::DescribeTable::operation_runtime_plugins(
        ...
        >| {
            ...
            if super::super::waiters::matchers::match_describe_table_1cce2c05524fb92d4(result) {
        ...
        let operation = move || {
            ...
            async move { super::super::operation::describe_table::DescribeTable::orchestrate(&runtime_plugins, input).await }
        };
