...
pub(crate) fn match_describe_contributor_insights_57787899eaa02d958(
    ...
    fn path_traversal<'a>(
        _output: &'a super::super::operation::describe_contributor_insights::DescribeContributorInsightsOutput,
    ) -> ::std::option::Option<&'a super::super::types::ContributorInsightsStatus> {
...
pub(crate) fn match_describe_export_a4219f96bc64309c4(
    ...
    ) -> ::std::option::Option<&'a super::super::types::ExportStatus> {
...
pub(crate) fn match_describe_import_6175a829c57972dc3(
    ...
    ) -> ::std::option::Option<&'a super::super::types::ImportStatus> {
...
pub(crate) fn match_describe_kinesis_streaming_destination_56e18114fb2c2cf5a(
    ...
    fn path_traversal<'a>(
        _output: &'a super::super::operation::describe_kinesis_streaming_destination::DescribeKinesisStreamingDestinationOutput,
    ) -> ::std::option::Option<::std::vec::Vec<&'a super::super::types::DestinationStatus>> {
        let _fld_1 = _output.kinesis_data_stream_destinations.as_ref()?;
        let _prj_3 = _fld_1
            .iter()
            .flat_map(|v| {
                #[allow(clippy::let_and_return)]
                fn map(_v: &super::super::types::KinesisDataStreamDestination) -> ::std::option::Option<&super::super::types::DestinationStatus> {
...
pub(crate) fn match_describe_kinesis_streaming_destination_ce975c8fb2b65f98f(
    ...
    fn path_traversal<'a>(
        ...
        let _fprj_14 = _fld_6
            .iter()
            .filter({
                fn filter(_v: &super::super::types::KinesisDataStreamDestination) -> ::std::option::Option<bool> {
...
pub(crate) fn match_describe_table_0429b99996ae6dab6(
    ...
    ) -> ::std::option::Option<&'a super::super::types::TableStatus> {
