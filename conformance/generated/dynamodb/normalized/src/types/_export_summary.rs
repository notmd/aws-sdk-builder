...
impl ExportSummary {
    ...
    pub fn builder() -> super::super::types::builders::ExportSummaryBuilder {
        super::super::types::builders::ExportSummaryBuilder::default()
    }
}
...
impl ExportSummaryBuilder {
    ...
    pub fn build(self) -> super::super::types::ExportSummary {
        super::super::types::ExportSummary {
