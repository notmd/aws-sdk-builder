...
pub struct ExportDescription {
    ...
    pub export_status: ::std::option::Option<super::super::types::ExportStatus>,
...
impl ExportDescription {
    ...
    /// <p>Export can be in one of the following states: IN_PROGRESS, COMPLETED, or FAILED.</p>
    pub fn export_status(&self) -> ::std::option::Option<&super::super::types::ExportStatus> {
    ...
    /// <p><code>KMS</code> - server-side encryption with KMS managed keys</p></li>
    /// </ul>
    pub fn s3_sse_algorithm(&self) -> ::std::option::Option<&super::super::types::S3SseAlgorithm> {
    ...
    /// <p>The format of the exported data. Valid values for <code>ExportFormat</code> are <code>DYNAMODB_JSON</code> or <code>ION</code>.</p>
    pub fn export_format(&self) -> ::std::option::Option<&super::super::types::ExportFormat> {
    ...
    /// <p>The type of export that was performed. Valid values are <code>FULL_EXPORT</code> or <code>INCREMENTAL_EXPORT</code>.</p>
    pub fn export_type(&self) -> ::std::option::Option<&super::super::types::ExportType> {
        self.export_type.as_ref()
    }
    /// <p>Optional object containing the parameters specific to an incremental export.</p>
    pub fn incremental_export_specification(&self) -> ::std::option::Option<&super::super::types::IncrementalExportSpecification> {
...
impl ExportDescription {
    ...
    pub fn builder() -> super::super::types::builders::ExportDescriptionBuilder {
        super::super::types::builders::ExportDescriptionBuilder::default()
    }
}
...
pub struct ExportDescriptionBuilder {
    ...
    pub(crate) export_status: ::std::option::Option<super::super::types::ExportStatus>,
    ...
    pub(crate) s3_sse_algorithm: ::std::option::Option<super::super::types::S3SseAlgorithm>,
    ...
    pub(crate) export_format: ::std::option::Option<super::super::types::ExportFormat>,
    pub(crate) billed_size_bytes: ::std::option::Option<i64>,
    pub(crate) item_count: ::std::option::Option<i64>,
    pub(crate) export_type: ::std::option::Option<super::super::types::ExportType>,
    pub(crate) incremental_export_specification: ::std::option::Option<super::super::types::IncrementalExportSpecification>,
}
impl ExportDescriptionBuilder {
    ...
    /// <p>Export can be in one of the following states: IN_PROGRESS, COMPLETED, or FAILED.</p>
    pub fn export_status(mut self, input: super::super::types::ExportStatus) -> Self {
        self.export_status = ::std::option::Option::Some(input);
        self
    }
    /// <p>Export can be in one of the following states: IN_PROGRESS, COMPLETED, or FAILED.</p>
    pub fn set_export_status(mut self, input: ::std::option::Option<super::super::types::ExportStatus>) -> Self {
        self.export_status = input;
        self
    }
    /// <p>Export can be in one of the following states: IN_PROGRESS, COMPLETED, or FAILED.</p>
    pub fn get_export_status(&self) -> &::std::option::Option<super::super::types::ExportStatus> {
        &self.export_status
    }
    /// <p>The time at which the export task began.</p>
    ...
    /// <p><code>KMS</code> - server-side encryption with KMS managed keys</p></li>
    /// </ul>
    pub fn s3_sse_algorithm(mut self, input: super::super::types::S3SseAlgorithm) -> Self {
    ...
    /// <p><code>KMS</code> - server-side encryption with KMS managed keys</p></li>
    /// </ul>
    pub fn set_s3_sse_algorithm(mut self, input: ::std::option::Option<super::super::types::S3SseAlgorithm>) -> Self {
    ...
    /// <p><code>KMS</code> - server-side encryption with KMS managed keys</p></li>
    /// </ul>
    pub fn get_s3_sse_algorithm(&self) -> &::std::option::Option<super::super::types::S3SseAlgorithm> {
    ...
    /// <p>The format of the exported data. Valid values for <code>ExportFormat</code> are <code>DYNAMODB_JSON</code> or <code>ION</code>.</p>
    pub fn export_format(mut self, input: super::super::types::ExportFormat) -> Self {
        self.export_format = ::std::option::Option::Some(input);
        self
    }
    /// <p>The format of the exported data. Valid values for <code>ExportFormat</code> are <code>DYNAMODB_JSON</code> or <code>ION</code>.</p>
    pub fn set_export_format(mut self, input: ::std::option::Option<super::super::types::ExportFormat>) -> Self {
        self.export_format = input;
        self
    }
    /// <p>The format of the exported data. Valid values for <code>ExportFormat</code> are <code>DYNAMODB_JSON</code> or <code>ION</code>.</p>
    pub fn get_export_format(&self) -> &::std::option::Option<super::super::types::ExportFormat> {
        &self.export_format
    }
    /// <p>The billable size of the table export.</p>
    ...
    /// <p>The type of export that was performed. Valid values are <code>FULL_EXPORT</code> or <code>INCREMENTAL_EXPORT</code>.</p>
    pub fn export_type(mut self, input: super::super::types::ExportType) -> Self {
        self.export_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The type of export that was performed. Valid values are <code>FULL_EXPORT</code> or <code>INCREMENTAL_EXPORT</code>.</p>
    pub fn set_export_type(mut self, input: ::std::option::Option<super::super::types::ExportType>) -> Self {
        self.export_type = input;
        self
    }
    /// <p>The type of export that was performed. Valid values are <code>FULL_EXPORT</code> or <code>INCREMENTAL_EXPORT</code>.</p>
    pub fn get_export_type(&self) -> &::std::option::Option<super::super::types::ExportType> {
        &self.export_type
    }
    /// <p>Optional object containing the parameters specific to an incremental export.</p>
    pub fn incremental_export_specification(mut self, input: super::super::types::IncrementalExportSpecification) -> Self {
        self.incremental_export_specification = ::std::option::Option::Some(input);
        self
    }
    /// <p>Optional object containing the parameters specific to an incremental export.</p>
    pub fn set_incremental_export_specification(mut self, input: ::std::option::Option<super::super::types::IncrementalExportSpecification>) -> Self {
        self.incremental_export_specification = input;
        self
    }
    /// <p>Optional object containing the parameters specific to an incremental export.</p>
    pub fn get_incremental_export_specification(&self) -> &::std::option::Option<super::super::types::IncrementalExportSpecification> {
    ...
    pub fn build(self) -> super::super::types::ExportDescription {
        super::super::types::ExportDescription {
