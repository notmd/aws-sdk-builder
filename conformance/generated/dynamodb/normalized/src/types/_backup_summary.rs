...
pub struct BackupSummary {
    ...
    pub backup_status: ::std::option::Option<super::super::types::BackupStatus>,
    /// <p>BackupType:</p>
    /// <ul>
    /// <li>
    ...
    /// </ul>
    pub backup_type: ::std::option::Option<super::super::types::BackupType>,
...
impl BackupSummary {
    ...
    /// <p>Backup can be in one of the following states: CREATING, ACTIVE, DELETED.</p>
    pub fn backup_status(&self) -> ::std::option::Option<&super::super::types::BackupStatus> {
    ...
    /// <p><code>AWS_BACKUP</code> - On-demand backup created by you from Backup service.</p></li>
    /// </ul>
    pub fn backup_type(&self) -> ::std::option::Option<&super::super::types::BackupType> {
...
impl BackupSummary {
    ...
    pub fn builder() -> super::super::types::builders::BackupSummaryBuilder {
        super::super::types::builders::BackupSummaryBuilder::default()
    }
}
...
impl BackupSummaryBuilder {
    ...
    pub fn build(self) -> super::super::types::BackupSummary {
        super::super::types::BackupSummary {
