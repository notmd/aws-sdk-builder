...
pub struct PointInTimeRecoveryDescription {
    ...
    /// </ul>
    pub point_in_time_recovery_status: ::std::option::Option<super::super::types::PointInTimeRecoveryStatus>,
...
impl PointInTimeRecoveryDescription {
    ...
    /// <p><code>DISABLED</code> - Point in time recovery is disabled.</p></li>
    /// </ul>
    pub fn point_in_time_recovery_status(&self) -> ::std::option::Option<&super::super::types::PointInTimeRecoveryStatus> {
...
impl PointInTimeRecoveryDescription {
    ...
    pub fn builder() -> super::super::types::builders::PointInTimeRecoveryDescriptionBuilder {
        super::super::types::builders::PointInTimeRecoveryDescriptionBuilder::default()
    }
}
...
pub struct PointInTimeRecoveryDescriptionBuilder {
    pub(crate) point_in_time_recovery_status: ::std::option::Option<super::super::types::PointInTimeRecoveryStatus>,
...
impl PointInTimeRecoveryDescriptionBuilder {
    ...
    /// <p><code>DISABLED</code> - Point in time recovery is disabled.</p></li>
    /// </ul>
    pub fn point_in_time_recovery_status(mut self, input: super::super::types::PointInTimeRecoveryStatus) -> Self {
    ...
    /// <p><code>DISABLED</code> - Point in time recovery is disabled.</p></li>
    /// </ul>
    pub fn set_point_in_time_recovery_status(mut self, input: ::std::option::Option<super::super::types::PointInTimeRecoveryStatus>) -> Self {
    ...
    /// <p><code>DISABLED</code> - Point in time recovery is disabled.</p></li>
    /// </ul>
    pub fn get_point_in_time_recovery_status(&self) -> &::std::option::Option<super::super::types::PointInTimeRecoveryStatus> {
    ...
    pub fn build(self) -> super::super::types::PointInTimeRecoveryDescription {
        super::super::types::PointInTimeRecoveryDescription {
