...
pub struct GlobalTable {
    ...
    pub replication_group: ::std::option::Option<::std::vec::Vec<super::super::types::Replica>>,
}
impl GlobalTable {
    /// <p>The global table name.</p>
    ...
    pub fn replication_group(&self) -> &[super::super::types::Replica] {
...
impl GlobalTable {
    ...
    pub fn builder() -> super::super::types::builders::GlobalTableBuilder {
        super::super::types::builders::GlobalTableBuilder::default()
    }
}
...
pub struct GlobalTableBuilder {
    ...
    pub(crate) replication_group: ::std::option::Option<::std::vec::Vec<super::super::types::Replica>>,
}
impl GlobalTableBuilder {
    ...
    ///
    /// <p>The Regions where the global table has replicas.</p>
    pub fn replication_group(mut self, input: super::super::types::Replica) -> Self {
    ...
    /// <p>The Regions where the global table has replicas.</p>
    pub fn set_replication_group(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::Replica>>) -> Self {
        self.replication_group = input;
        self
    }
    /// <p>The Regions where the global table has replicas.</p>
    pub fn get_replication_group(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::Replica>> {
        &self.replication_group
    }
    /// Consumes the builder and constructs a [`GlobalTable`](crate::types::GlobalTable).
    pub fn build(self) -> super::super::types::GlobalTable {
        super::super::types::GlobalTable {
