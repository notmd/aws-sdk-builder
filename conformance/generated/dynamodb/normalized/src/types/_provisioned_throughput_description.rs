...
impl ProvisionedThroughputDescription {
    ...
    pub fn builder() -> super::super::types::builders::ProvisionedThroughputDescriptionBuilder {
        super::super::types::builders::ProvisionedThroughputDescriptionBuilder::default()
    }
}
...
impl ProvisionedThroughputDescriptionBuilder {
    ...
    pub fn build(self) -> super::super::types::ProvisionedThroughputDescription {
        super::super::types::ProvisionedThroughputDescription {
