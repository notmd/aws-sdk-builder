...
impl S3BucketSource {
    ...
    pub fn builder() -> super::super::types::builders::S3BucketSourceBuilder {
        super::super::types::builders::S3BucketSourceBuilder::default()
    }
}
...
impl S3BucketSourceBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::S3BucketSource, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::S3BucketSource {
