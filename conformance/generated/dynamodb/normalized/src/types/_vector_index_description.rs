...
pub struct VectorIndexDescription {
    ...
    pub search_schema: ::std::option::Option<::std::vec::Vec<super::super::types::SearchSchemaElement>>,
    ...
    pub vector_attribute: ::std::option::Option<super::super::types::VectorAttributeDefinition>,
    ...
    pub distance_function: ::std::option::Option<super::super::types::VectorDistanceFunction>,
...
impl VectorIndexDescription {
    ...
    pub fn search_schema(&self) -> &[super::super::types::SearchSchemaElement] {
    ...
    /// <p>The vector attribute configuration for the index.</p>
    pub fn vector_attribute(&self) -> ::std::option::Option<&super::super::types::VectorAttributeDefinition> {
    ...
    /// <p>The distance function used to calculate similarity between vectors.</p>
    pub fn distance_function(&self) -> ::std::option::Option<&super::super::types::VectorDistanceFunction> {
...
impl VectorIndexDescription {
    ...
    pub fn builder() -> super::super::types::builders::VectorIndexDescriptionBuilder {
        super::super::types::builders::VectorIndexDescriptionBuilder::default()
    }
}
...
pub struct VectorIndexDescriptionBuilder {
    ...
    pub(crate) search_schema: ::std::option::Option<::std::vec::Vec<super::super::types::SearchSchemaElement>>,
    pub(crate) projection: ::std::option::Option<super::super::types::Projection>,
    pub(crate) vector_attribute: ::std::option::Option<super::super::types::VectorAttributeDefinition>,
    pub(crate) dimensions: ::std::option::Option<i64>,
    pub(crate) distance_function: ::std::option::Option<super::super::types::VectorDistanceFunction>,
...
impl VectorIndexDescriptionBuilder {
    ...
    ///
    /// <p>The search schema that defines partition key and inline filter attributes for the vector index.</p>
    pub fn search_schema(mut self, input: super::super::types::SearchSchemaElement) -> Self {
    ...
    /// <p>The search schema that defines partition key and inline filter attributes for the vector index.</p>
    pub fn set_search_schema(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::SearchSchemaElement>>) -> Self {
        self.search_schema = input;
        self
    }
    /// <p>The search schema that defines partition key and inline filter attributes for the vector index.</p>
    pub fn get_search_schema(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::SearchSchemaElement>> {
        &self.search_schema
    }
    /// <p>Specifies attributes that are copied (projected) from the table into the vector index.</p>
    ...
    /// <p>The vector attribute configuration for the index.</p>
    pub fn vector_attribute(mut self, input: super::super::types::VectorAttributeDefinition) -> Self {
        self.vector_attribute = ::std::option::Option::Some(input);
        self
    }
    /// <p>The vector attribute configuration for the index.</p>
    pub fn set_vector_attribute(mut self, input: ::std::option::Option<super::super::types::VectorAttributeDefinition>) -> Self {
        self.vector_attribute = input;
        self
    }
    /// <p>The vector attribute configuration for the index.</p>
    pub fn get_vector_attribute(&self) -> &::std::option::Option<super::super::types::VectorAttributeDefinition> {
    ...
    /// <p>The distance function used to calculate similarity between vectors.</p>
    pub fn distance_function(mut self, input: super::super::types::VectorDistanceFunction) -> Self {
        self.distance_function = ::std::option::Option::Some(input);
        self
    }
    /// <p>The distance function used to calculate similarity between vectors.</p>
    pub fn set_distance_function(mut self, input: ::std::option::Option<super::super::types::VectorDistanceFunction>) -> Self {
        self.distance_function = input;
        self
    }
    /// <p>The distance function used to calculate similarity between vectors.</p>
    pub fn get_distance_function(&self) -> &::std::option::Option<super::super::types::VectorDistanceFunction> {
    ...
    pub fn build(self) -> super::super::types::VectorIndexDescription {
        super::super::types::VectorIndexDescription {
