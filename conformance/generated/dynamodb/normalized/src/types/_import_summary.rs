...
impl ImportSummary {
    ...
    pub fn builder() -> super::super::types::builders::ImportSummaryBuilder {
        super::super::types::builders::ImportSummaryBuilder::default()
    }
}
...
impl ImportSummaryBuilder {
    ...
    pub fn build(self) -> super::super::types::ImportSummary {
        super::super::types::ImportSummary {
