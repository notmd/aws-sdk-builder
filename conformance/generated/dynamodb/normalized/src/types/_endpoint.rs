...
impl Endpoint {
    ...
    pub fn builder() -> super::super::types::builders::EndpointBuilder {
        super::super::types::builders::EndpointBuilder::default()
    }
}
...
impl EndpointBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::Endpoint, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::Endpoint {
