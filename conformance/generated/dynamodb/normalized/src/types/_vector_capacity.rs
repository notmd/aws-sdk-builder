...
impl VectorCapacity {
    ...
    pub fn builder() -> super::super::types::builders::VectorCapacityBuilder {
        super::super::types::builders::VectorCapacityBuilder::default()
    }
}
...
impl VectorCapacityBuilder {
    ...
    pub fn build(self) -> super::super::types::VectorCapacity {
        super::super::types::VectorCapacity {
