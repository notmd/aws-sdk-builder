...
pub struct KeysAndAttributes {
    ...
    pub keys: ::std::vec::Vec<::std::collections::HashMap<::std::string::String, super::super::types::AttributeValue>>,
...
impl KeysAndAttributes {
    /// <p>The primary key attribute values that define the items and the attributes associated with the items.</p>
    pub fn keys(&self) -> &[::std::collections::HashMap<::std::string::String, super::super::types::AttributeValue>] {
        use std::ops::Deref;
        self.keys.deref()
    }
    /// <p>This is a legacy parameter. Use <code>ProjectionExpression</code> instead. For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.html">Legacy Conditional Parameters</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p>
...
impl KeysAndAttributes {
    ...
    pub fn builder() -> super::super::types::builders::KeysAndAttributesBuilder {
        super::super::types::builders::KeysAndAttributesBuilder::default()
    }
}
...
pub struct KeysAndAttributesBuilder {
    pub(crate) keys: ::std::option::Option<::std::vec::Vec<::std::collections::HashMap<::std::string::String, super::super::types::AttributeValue>>>,
...
impl KeysAndAttributesBuilder {
    ...
    ///
    /// <p>The primary key attribute values that define the items and the attributes associated with the items.</p>
    pub fn keys(mut self, input: ::std::collections::HashMap<::std::string::String, super::super::types::AttributeValue>) -> Self {
    ...
    pub fn set_keys(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<::std::collections::HashMap<::std::string::String, super::super::types::AttributeValue>>>,
    ) -> Self {
        self.keys = input;
        self
    }
    ...
    pub fn get_keys(
        &self,
    ) -> &::std::option::Option<::std::vec::Vec<::std::collections::HashMap<::std::string::String, super::super::types::AttributeValue>>> {
        &self.keys
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::KeysAndAttributes, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::KeysAndAttributes {
