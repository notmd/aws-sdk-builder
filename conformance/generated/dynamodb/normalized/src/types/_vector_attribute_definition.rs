...
impl VectorAttributeDefinition {
    ...
    pub fn builder() -> super::super::types::builders::VectorAttributeDefinitionBuilder {
        super::super::types::builders::VectorAttributeDefinitionBuilder::default()
    }
}
...
impl VectorAttributeDefinitionBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::VectorAttributeDefinition, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::VectorAttributeDefinition {
