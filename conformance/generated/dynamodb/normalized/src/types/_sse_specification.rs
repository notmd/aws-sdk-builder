...
impl SseSpecification {
    ...
    pub fn builder() -> super::super::types::builders::SseSpecificationBuilder {
        super::super::types::builders::SseSpecificationBuilder::default()
    }
}
...
impl SseSpecificationBuilder {
    ...
    pub fn build(self) -> super::super::types::SseSpecification {
        super::super::types::SseSpecification {
