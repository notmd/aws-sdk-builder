...
impl Delete {
    ...
    pub fn builder() -> super::super::types::builders::DeleteBuilder {
        super::super::types::builders::DeleteBuilder::default()
    }
}
...
impl DeleteBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::Delete, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::Delete {
