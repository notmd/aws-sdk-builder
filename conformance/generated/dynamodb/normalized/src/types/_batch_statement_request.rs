...
impl BatchStatementRequest {
    ...
    pub fn builder() -> super::super::types::builders::BatchStatementRequestBuilder {
        super::super::types::builders::BatchStatementRequestBuilder::default()
    }
}
...
impl BatchStatementRequestBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::BatchStatementRequest, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::BatchStatementRequest {
