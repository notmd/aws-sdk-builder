...
pub struct GlobalSecondaryIndexDescription {
    ...
    pub projection: ::std::option::Option<super::super::types::Projection>,
    ...
    /// </ul>
    pub index_status: ::std::option::Option<super::super::types::IndexStatus>,
    ...
    pub warm_throughput: ::std::option::Option<super::super::types::GlobalSecondaryIndexWarmThroughputDescription>,
}
impl GlobalSecondaryIndexDescription {
    ...
    /// <p>Represents attributes that are copied (projected) from the table into the global secondary index. These are in addition to the primary key attributes and index key attributes, which are automatically projected.</p>
    pub fn projection(&self) -> ::std::option::Option<&super::super::types::Projection> {
    ...
    /// <p><code>ACTIVE</code> - The index is ready for use.</p></li>
    /// </ul>
    pub fn index_status(&self) -> ::std::option::Option<&super::super::types::IndexStatus> {
    ...
    /// <p>Represents the warm throughput value (in read units per second and write units per second) for the specified secondary index.</p>
    pub fn warm_throughput(&self) -> ::std::option::Option<&super::super::types::GlobalSecondaryIndexWarmThroughputDescription> {
...
impl GlobalSecondaryIndexDescription {
    ...
    pub fn builder() -> super::super::types::builders::GlobalSecondaryIndexDescriptionBuilder {
        super::super::types::builders::GlobalSecondaryIndexDescriptionBuilder::default()
    }
}
...
pub struct GlobalSecondaryIndexDescriptionBuilder {
    ...
    pub(crate) projection: ::std::option::Option<super::super::types::Projection>,
    pub(crate) index_status: ::std::option::Option<super::super::types::IndexStatus>,
    ...
    pub(crate) warm_throughput: ::std::option::Option<super::super::types::GlobalSecondaryIndexWarmThroughputDescription>,
}
impl GlobalSecondaryIndexDescriptionBuilder {
    ...
    /// <p>Represents attributes that are copied (projected) from the table into the global secondary index. These are in addition to the primary key attributes and index key attributes, which are automatically projected.</p>
    pub fn projection(mut self, input: super::super::types::Projection) -> Self {
        self.projection = ::std::option::Option::Some(input);
        self
    }
    /// <p>Represents attributes that are copied (projected) from the table into the global secondary index. These are in addition to the primary key attributes and index key attributes, which are automatically projected.</p>
    pub fn set_projection(mut self, input: ::std::option::Option<super::super::types::Projection>) -> Self {
        self.projection = input;
        self
    }
    /// <p>Represents attributes that are copied (projected) from the table into the global secondary index. These are in addition to the primary key attributes and index key attributes, which are automatically projected.</p>
    pub fn get_projection(&self) -> &::std::option::Option<super::super::types::Projection> {
        &self.projection
    }
    /// <p>The current state of the global secondary index:</p>
    /// <ul>
    ...
    /// <p><code>ACTIVE</code> - The index is ready for use.</p></li>
    /// </ul>
    pub fn index_status(mut self, input: super::super::types::IndexStatus) -> Self {
    ...
    /// <p><code>ACTIVE</code> - The index is ready for use.</p></li>
    /// </ul>
    pub fn set_index_status(mut self, input: ::std::option::Option<super::super::types::IndexStatus>) -> Self {
    ...
    /// <p><code>ACTIVE</code> - The index is ready for use.</p></li>
    /// </ul>
    pub fn get_index_status(&self) -> &::std::option::Option<super::super::types::IndexStatus> {
        &self.index_status
    }
    /// <p>Indicates whether the index is currently backfilling. <i>Backfilling</i> is the process of reading items from the table and determining whether they can be added to the index. (Not all items will qualify: For example, a partition key cannot have any duplicate values.) If an item can be added to the index, DynamoDB will do so. After all items have been processed, the backfilling operation is complete and <code>Backfilling</code> is false.</p>
    /// <p>You can delete an index that is being created during the <code>Backfilling</code> phase when <code>IndexStatus</code> is set to CREATING and <code>Backfilling</code> is true. You can't delete the index that is being created when <code>IndexStatus</code> is set to CREATING and <code>Backfilling</code> is false.</p><note>
    ...
    /// <p>Represents the warm throughput value (in read units per second and write units per second) for the specified secondary index.</p>
    pub fn warm_throughput(mut self, input: super::super::types::GlobalSecondaryIndexWarmThroughputDescription) -> Self {
        self.warm_throughput = ::std::option::Option::Some(input);
        self
    }
    /// <p>Represents the warm throughput value (in read units per second and write units per second) for the specified secondary index.</p>
    pub fn set_warm_throughput(mut self, input: ::std::option::Option<super::super::types::GlobalSecondaryIndexWarmThroughputDescription>) -> Self {
        self.warm_throughput = input;
        self
    }
    /// <p>Represents the warm throughput value (in read units per second and write units per second) for the specified secondary index.</p>
    pub fn get_warm_throughput(&self) -> &::std::option::Option<super::super::types::GlobalSecondaryIndexWarmThroughputDescription> {
    ...
    pub fn build(self) -> super::super::types::GlobalSecondaryIndexDescription {
        super::super::types::GlobalSecondaryIndexDescription {
