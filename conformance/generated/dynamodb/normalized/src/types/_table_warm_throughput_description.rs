...
pub struct TableWarmThroughputDescription {
    ...
    pub status: ::std::option::Option<super::super::types::TableStatus>,
}
impl TableWarmThroughputDescription {
    ...
    /// <p>Represents warm throughput value of the base table.</p>
    pub fn status(&self) -> ::std::option::Option<&super::super::types::TableStatus> {
        self.status.as_ref()
    }
}
impl TableWarmThroughputDescription {
    ...
    pub fn builder() -> super::super::types::builders::TableWarmThroughputDescriptionBuilder {
        super::super::types::builders::TableWarmThroughputDescriptionBuilder::default()
    }
}
...
pub struct TableWarmThroughputDescriptionBuilder {
    ...
    pub(crate) status: ::std::option::Option<super::super::types::TableStatus>,
}
impl TableWarmThroughputDescriptionBuilder {
    ...
    /// <p>Represents warm throughput value of the base table.</p>
    pub fn status(mut self, input: super::super::types::TableStatus) -> Self {
        self.status = ::std::option::Option::Some(input);
        self
    }
    /// <p>Represents warm throughput value of the base table.</p>
    pub fn set_status(mut self, input: ::std::option::Option<super::super::types::TableStatus>) -> Self {
        self.status = input;
        self
    }
    /// <p>Represents warm throughput value of the base table.</p>
    pub fn get_status(&self) -> &::std::option::Option<super::super::types::TableStatus> {
        &self.status
    }
    /// Consumes the builder and constructs a [`TableWarmThroughputDescription`](crate::types::TableWarmThroughputDescription).
    pub fn build(self) -> super::super::types::TableWarmThroughputDescription {
        super::super::types::TableWarmThroughputDescription {
