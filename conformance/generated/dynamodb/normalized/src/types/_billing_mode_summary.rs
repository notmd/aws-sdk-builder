...
impl BillingModeSummary {
    ...
    pub fn builder() -> super::super::types::builders::BillingModeSummaryBuilder {
        super::super::types::builders::BillingModeSummaryBuilder::default()
    }
}
...
impl BillingModeSummaryBuilder {
    ...
    pub fn build(self) -> super::super::types::BillingModeSummary {
        super::super::types::BillingModeSummary {
