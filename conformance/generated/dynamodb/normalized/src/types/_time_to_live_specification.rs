...
impl TimeToLiveSpecification {
    ...
    pub fn builder() -> super::super::types::builders::TimeToLiveSpecificationBuilder {
        super::super::types::builders::TimeToLiveSpecificationBuilder::default()
    }
}
...
impl TimeToLiveSpecificationBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::TimeToLiveSpecification, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::TimeToLiveSpecification {
