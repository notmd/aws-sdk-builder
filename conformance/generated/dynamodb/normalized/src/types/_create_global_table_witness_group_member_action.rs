...
impl CreateGlobalTableWitnessGroupMemberAction {
    ...
    pub fn builder() -> super::super::types::builders::CreateGlobalTableWitnessGroupMemberActionBuilder {
        super::super::types::builders::CreateGlobalTableWitnessGroupMemberActionBuilder::default()
    }
}
...
impl CreateGlobalTableWitnessGroupMemberActionBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::types::CreateGlobalTableWitnessGroupMemberAction, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::CreateGlobalTableWitnessGroupMemberAction {
