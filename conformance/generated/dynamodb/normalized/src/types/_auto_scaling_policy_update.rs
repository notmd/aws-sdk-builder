...
impl AutoScalingPolicyUpdate {
    ...
    pub fn builder() -> super::super::types::builders::AutoScalingPolicyUpdateBuilder {
        super::super::types::builders::AutoScalingPolicyUpdateBuilder::default()
    }
}
...
impl AutoScalingPolicyUpdateBuilder {
    ...
    pub fn target_tracking_scaling_policy_configuration(
        mut self,
        input: super::super::types::AutoScalingTargetTrackingScalingPolicyConfigurationUpdate,
    ) -> Self {
    ...
    pub fn set_target_tracking_scaling_policy_configuration(
        mut self,
        input: ::std::option::Option<super::super::types::AutoScalingTargetTrackingScalingPolicyConfigurationUpdate>,
    ) -> Self {
    ...
    pub fn build(self) -> super::super::types::AutoScalingPolicyUpdate {
        super::super::types::AutoScalingPolicyUpdate {
