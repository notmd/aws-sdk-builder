...
impl DeleteReplicationGroupMemberAction {
    ...
    pub fn builder() -> super::super::types::builders::DeleteReplicationGroupMemberActionBuilder {
        super::super::types::builders::DeleteReplicationGroupMemberActionBuilder::default()
    }
}
