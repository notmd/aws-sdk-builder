...
impl LocalSecondaryIndexInfo {
    ...
    pub fn builder() -> super::super::types::builders::LocalSecondaryIndexInfoBuilder {
        super::super::types::builders::LocalSecondaryIndexInfoBuilder::default()
    }
}
...
impl LocalSecondaryIndexInfoBuilder {
    ...
    pub fn build(self) -> super::super::types::LocalSecondaryIndexInfo {
        super::super::types::LocalSecondaryIndexInfo {
