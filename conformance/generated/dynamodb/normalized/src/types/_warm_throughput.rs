...
impl WarmThroughput {
    ...
    pub fn builder() -> super::super::types::builders::WarmThroughputBuilder {
        super::super::types::builders::WarmThroughputBuilder::default()
    }
}
...
impl WarmThroughputBuilder {
    ...
    pub fn build(self) -> super::super::types::WarmThroughput {
        super::super::types::WarmThroughput {
