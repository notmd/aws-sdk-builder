...
pub struct GlobalTableGlobalSecondaryIndexSettingsUpdate {
    ...
    pub provisioned_write_capacity_auto_scaling_settings_update: ::std::option::Option<super::super::types::AutoScalingSettingsUpdate>,
}
impl GlobalTableGlobalSecondaryIndexSettingsUpdate {
    ...
    /// <p>Auto scaling settings for managing a global secondary index's write capacity units.</p>
    pub fn provisioned_write_capacity_auto_scaling_settings_update(&self) -> ::std::option::Option<&super::super::types::AutoScalingSettingsUpdate> {
...
impl GlobalTableGlobalSecondaryIndexSettingsUpdate {
    ...
    pub fn builder() -> super::super::types::builders::GlobalTableGlobalSecondaryIndexSettingsUpdateBuilder {
        super::super::types::builders::GlobalTableGlobalSecondaryIndexSettingsUpdateBuilder::default()
    }
}
...
pub struct GlobalTableGlobalSecondaryIndexSettingsUpdateBuilder {
    ...
    pub(crate) provisioned_write_capacity_auto_scaling_settings_update: ::std::option::Option<super::super::types::AutoScalingSettingsUpdate>,
}
impl GlobalTableGlobalSecondaryIndexSettingsUpdateBuilder {
    ...
    /// <p>Auto scaling settings for managing a global secondary index's write capacity units.</p>
    pub fn provisioned_write_capacity_auto_scaling_settings_update(mut self, input: super::super::types::AutoScalingSettingsUpdate) -> Self {
