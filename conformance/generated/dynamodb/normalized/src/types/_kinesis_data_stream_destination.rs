...
impl KinesisDataStreamDestination {
    ...
    /// <p>The current status of replication.</p>
    pub fn destination_status(&self) -> ::std::option::Option<&super::super::types::DestinationStatus> {
...
impl KinesisDataStreamDestination {
    ...
    pub fn builder() -> super::super::types::builders::KinesisDataStreamDestinationBuilder {
        super::super::types::builders::KinesisDataStreamDestinationBuilder::default()
    }
}
...
pub struct KinesisDataStreamDestinationBuilder {
    ...
    pub(crate) destination_status: ::std::option::Option<super::super::types::DestinationStatus>,
...
impl KinesisDataStreamDestinationBuilder {
    ...
    /// <p>The current status of replication.</p>
    pub fn destination_status(mut self, input: super::super::types::DestinationStatus) -> Self {
        self.destination_status = ::std::option::Option::Some(input);
        self
    }
    /// <p>The current status of replication.</p>
    pub fn set_destination_status(mut self, input: ::std::option::Option<super::super::types::DestinationStatus>) -> Self {
        self.destination_status = input;
        self
    }
    /// <p>The current status of replication.</p>
    pub fn get_destination_status(&self) -> &::std::option::Option<super::super::types::DestinationStatus> {
    ...
    pub fn build(self) -> super::super::types::KinesisDataStreamDestination {
        super::super::types::KinesisDataStreamDestination {
