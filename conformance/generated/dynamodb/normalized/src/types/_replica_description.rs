...
pub struct ReplicaDescription {
    ...
    /// </note></li>
    /// </ul>
    pub replica_status: ::std::option::Option<super::super::types::ReplicaStatus>,
    ...
    pub provisioned_throughput_override: ::std::option::Option<super::super::types::ProvisionedThroughputOverride>,
    /// <p>Overrides the maximum on-demand throughput settings for the specified replica table.</p>
    pub on_demand_throughput_override: ::std::option::Option<super::super::types::OnDemandThroughputOverride>,
    ...
    pub global_secondary_indexes: ::std::option::Option<::std::vec::Vec<super::super::types::ReplicaGlobalSecondaryIndexDescription>>,
...
impl ReplicaDescription {
    ...
    /// </note></li>
    /// </ul>
    pub fn replica_status(&self) -> ::std::option::Option<&super::super::types::ReplicaStatus> {
    ...
    /// <p>Replica-specific provisioned throughput. If not described, uses the source table's provisioned throughput settings.</p>
    pub fn provisioned_throughput_override(&self) -> ::std::option::Option<&super::super::types::ProvisionedThroughputOverride> {
        self.provisioned_throughput_override.as_ref()
    }
    /// <p>Overrides the maximum on-demand throughput settings for the specified replica table.</p>
    pub fn on_demand_throughput_override(&self) -> ::std::option::Option<&super::super::types::OnDemandThroughputOverride> {
    ...
    pub fn global_secondary_indexes(&self) -> &[super::super::types::ReplicaGlobalSecondaryIndexDescription] {
    ...
    /// <p>Contains details of the table class.</p>
    pub fn replica_table_class_summary(&self) -> ::std::option::Option<&super::super::types::TableClassSummary> {
...
impl ReplicaDescription {
    ...
    pub fn builder() -> super::super::types::builders::ReplicaDescriptionBuilder {
        super::super::types::builders::ReplicaDescriptionBuilder::default()
    }
}
...
pub struct ReplicaDescriptionBuilder {
    ...
    pub(crate) provisioned_throughput_override: ::std::option::Option<super::super::types::ProvisionedThroughputOverride>,
    pub(crate) on_demand_throughput_override: ::std::option::Option<super::super::types::OnDemandThroughputOverride>,
    pub(crate) warm_throughput: ::std::option::Option<super::super::types::TableWarmThroughputDescription>,
    pub(crate) global_secondary_indexes: ::std::option::Option<::std::vec::Vec<super::super::types::ReplicaGlobalSecondaryIndexDescription>>,
    pub(crate) replica_inaccessible_date_time: ::std::option::Option<::aws_smithy_types::DateTime>,
    pub(crate) replica_table_class_summary: ::std::option::Option<super::super::types::TableClassSummary>,
...
impl ReplicaDescriptionBuilder {
    ...
    /// </note></li>
    /// </ul>
    pub fn replica_status(mut self, input: super::super::types::ReplicaStatus) -> Self {
    ...
    /// </note></li>
    /// </ul>
    pub fn set_replica_status(mut self, input: ::std::option::Option<super::super::types::ReplicaStatus>) -> Self {
    ...
    /// </note></li>
    /// </ul>
    pub fn get_replica_status(&self) -> &::std::option::Option<super::super::types::ReplicaStatus> {
        &self.replica_status
    }
    /// <p>The Amazon Resource Name (ARN) of the global table replica.</p>
    ...
    /// <p>Replica-specific provisioned throughput. If not described, uses the source table's provisioned throughput settings.</p>
    pub fn provisioned_throughput_override(mut self, input: super::super::types::ProvisionedThroughputOverride) -> Self {
        self.provisioned_throughput_override = ::std::option::Option::Some(input);
        self
    }
    /// <p>Replica-specific provisioned throughput. If not described, uses the source table's provisioned throughput settings.</p>
    pub fn set_provisioned_throughput_override(mut self, input: ::std::option::Option<super::super::types::ProvisionedThroughputOverride>) -> Self {
        self.provisioned_throughput_override = input;
        self
    }
    /// <p>Replica-specific provisioned throughput. If not described, uses the source table's provisioned throughput settings.</p>
    pub fn get_provisioned_throughput_override(&self) -> &::std::option::Option<super::super::types::ProvisionedThroughputOverride> {
        &self.provisioned_throughput_override
    }
    /// <p>Overrides the maximum on-demand throughput settings for the specified replica table.</p>
    pub fn on_demand_throughput_override(mut self, input: super::super::types::OnDemandThroughputOverride) -> Self {
        self.on_demand_throughput_override = ::std::option::Option::Some(input);
        self
    }
    /// <p>Overrides the maximum on-demand throughput settings for the specified replica table.</p>
    pub fn set_on_demand_throughput_override(mut self, input: ::std::option::Option<super::super::types::OnDemandThroughputOverride>) -> Self {
        self.on_demand_throughput_override = input;
        self
    }
    /// <p>Overrides the maximum on-demand throughput settings for the specified replica table.</p>
    pub fn get_on_demand_throughput_override(&self) -> &::std::option::Option<super::super::types::OnDemandThroughputOverride> {
    ...
    ///
    /// <p>Replica-specific global secondary index settings.</p>
    pub fn global_secondary_indexes(mut self, input: super::super::types::ReplicaGlobalSecondaryIndexDescription) -> Self {
    ...
    pub fn set_global_secondary_indexes(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::types::ReplicaGlobalSecondaryIndexDescription>>,
    ) -> Self {
    ...
    /// <p>Contains details of the table class.</p>
    pub fn replica_table_class_summary(mut self, input: super::super::types::TableClassSummary) -> Self {
        self.replica_table_class_summary = ::std::option::Option::Some(input);
        self
    }
    /// <p>Contains details of the table class.</p>
    pub fn set_replica_table_class_summary(mut self, input: ::std::option::Option<super::super::types::TableClassSummary>) -> Self {
        self.replica_table_class_summary = input;
        self
    }
    /// <p>Contains details of the table class.</p>
    pub fn get_replica_table_class_summary(&self) -> &::std::option::Option<super::super::types::TableClassSummary> {
    ...
    pub fn build(self) -> super::super::types::ReplicaDescription {
        super::super::types::ReplicaDescription {
