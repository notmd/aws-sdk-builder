...
impl OnDemandThroughput {
    ...
    pub fn builder() -> super::super::types::builders::OnDemandThroughputBuilder {
        super::super::types::builders::OnDemandThroughputBuilder::default()
    }
}
...
impl OnDemandThroughputBuilder {
    ...
    pub fn build(self) -> super::super::types::OnDemandThroughput {
        super::super::types::OnDemandThroughput {
