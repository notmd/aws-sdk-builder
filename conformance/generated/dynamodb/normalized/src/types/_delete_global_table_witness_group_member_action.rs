...
impl DeleteGlobalTableWitnessGroupMemberAction {
    ...
    pub fn builder() -> super::super::types::builders::DeleteGlobalTableWitnessGroupMemberActionBuilder {
        super::super::types::builders::DeleteGlobalTableWitnessGroupMemberActionBuilder::default()
    }
}
...
impl DeleteGlobalTableWitnessGroupMemberActionBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::types::DeleteGlobalTableWitnessGroupMemberAction, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::DeleteGlobalTableWitnessGroupMemberAction {
