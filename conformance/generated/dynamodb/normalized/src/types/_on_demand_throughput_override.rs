...
impl OnDemandThroughputOverride {
    ...
    pub fn builder() -> super::super::types::builders::OnDemandThroughputOverrideBuilder {
        super::super::types::builders::OnDemandThroughputOverrideBuilder::default()
    }
}
...
impl OnDemandThroughputOverrideBuilder {
    ...
    pub fn build(self) -> super::super::types::OnDemandThroughputOverride {
        super::super::types::OnDemandThroughputOverride {
