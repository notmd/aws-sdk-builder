...
pub struct ReplicaGlobalSecondaryIndexSettingsUpdate {
    ...
    pub provisioned_read_capacity_auto_scaling_settings_update: ::std::option::Option<super::super::types::AutoScalingSettingsUpdate>,
}
impl ReplicaGlobalSecondaryIndexSettingsUpdate {
    ...
    /// <p>Auto scaling settings for managing a global secondary index replica's read capacity units.</p>
    pub fn provisioned_read_capacity_auto_scaling_settings_update(&self) -> ::std::option::Option<&super::super::types::AutoScalingSettingsUpdate> {
...
impl ReplicaGlobalSecondaryIndexSettingsUpdate {
    ...
    pub fn builder() -> super::super::types::builders::ReplicaGlobalSecondaryIndexSettingsUpdateBuilder {
        super::super::types::builders::ReplicaGlobalSecondaryIndexSettingsUpdateBuilder::default()
    }
}
...
pub struct ReplicaGlobalSecondaryIndexSettingsUpdateBuilder {
    ...
    pub(crate) provisioned_read_capacity_auto_scaling_settings_update: ::std::option::Option<super::super::types::AutoScalingSettingsUpdate>,
}
impl ReplicaGlobalSecondaryIndexSettingsUpdateBuilder {
    ...
    /// <p>Auto scaling settings for managing a global secondary index replica's read capacity units.</p>
    pub fn provisioned_read_capacity_auto_scaling_settings_update(mut self, input: super::super::types::AutoScalingSettingsUpdate) -> Self {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::types::ReplicaGlobalSecondaryIndexSettingsUpdate, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::ReplicaGlobalSecondaryIndexSettingsUpdate {
