...
impl ProvisionedThroughputOverride {
    ...
    pub fn builder() -> super::super::types::builders::ProvisionedThroughputOverrideBuilder {
        super::super::types::builders::ProvisionedThroughputOverrideBuilder::default()
    }
}
...
impl ProvisionedThroughputOverrideBuilder {
    ...
    pub fn build(self) -> super::super::types::ProvisionedThroughputOverride {
        super::super::types::ProvisionedThroughputOverride {
