...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::TableInUseException {
...
impl TableInUseException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::TableInUseExceptionBuilder {
        super::super::super::types::error::builders::TableInUseExceptionBuilder::default()
    }
}
...
impl TableInUseExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::TableInUseException {
        super::super::super::types::error::TableInUseException {
