...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::PointInTimeRecoveryUnavailableException {
...
impl PointInTimeRecoveryUnavailableException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::PointInTimeRecoveryUnavailableExceptionBuilder {
        super::super::super::types::error::builders::PointInTimeRecoveryUnavailableExceptionBuilder::default()
    }
}
...
impl PointInTimeRecoveryUnavailableExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::PointInTimeRecoveryUnavailableException {
        super::super::super::types::error::PointInTimeRecoveryUnavailableException {
