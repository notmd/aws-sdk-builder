...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::TableNotFoundException {
...
impl TableNotFoundException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::TableNotFoundExceptionBuilder {
        super::super::super::types::error::builders::TableNotFoundExceptionBuilder::default()
    }
}
...
impl TableNotFoundExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::TableNotFoundException {
        super::super::super::types::error::TableNotFoundException {
