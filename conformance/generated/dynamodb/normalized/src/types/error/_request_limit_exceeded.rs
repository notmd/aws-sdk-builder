...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::RequestLimitExceeded {
...
impl RequestLimitExceeded {
    ...
    pub fn builder() -> super::super::super::types::error::builders::RequestLimitExceededBuilder {
        super::super::super::types::error::builders::RequestLimitExceededBuilder::default()
    }
}
...
impl RequestLimitExceededBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::RequestLimitExceeded {
        super::super::super::types::error::RequestLimitExceeded {
