...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::TransactionConflictException {
...
impl TransactionConflictException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::TransactionConflictExceptionBuilder {
        super::super::super::types::error::builders::TransactionConflictExceptionBuilder::default()
    }
}
...
impl TransactionConflictExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::TransactionConflictException {
        super::super::super::types::error::TransactionConflictException {
