...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::IdempotentParameterMismatchException {
...
impl IdempotentParameterMismatchException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::IdempotentParameterMismatchExceptionBuilder {
        super::super::super::types::error::builders::IdempotentParameterMismatchExceptionBuilder::default()
    }
}
...
impl IdempotentParameterMismatchExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::IdempotentParameterMismatchException {
        super::super::super::types::error::IdempotentParameterMismatchException {
