...
pub struct TransactionCanceledException {
    ...
    pub cancellation_reasons: ::std::option::Option<::std::vec::Vec<super::super::super::types::CancellationReason>>,
...
impl TransactionCanceledException {
    ...
    pub fn cancellation_reasons(&self) -> &[super::super::super::types::CancellationReason] {
...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::TransactionCanceledException {
...
impl TransactionCanceledException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::TransactionCanceledExceptionBuilder {
        super::super::super::types::error::builders::TransactionCanceledExceptionBuilder::default()
    }
}
...
pub struct TransactionCanceledExceptionBuilder {
    ...
    pub(crate) cancellation_reasons: ::std::option::Option<::std::vec::Vec<super::super::super::types::CancellationReason>>,
...
impl TransactionCanceledExceptionBuilder {
    ...
    ///
    /// <p>A list of cancellation reasons.</p>
    pub fn cancellation_reasons(mut self, input: super::super::super::types::CancellationReason) -> Self {
    ...
    /// <p>A list of cancellation reasons.</p>
    pub fn set_cancellation_reasons(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::CancellationReason>>) -> Self {
        self.cancellation_reasons = input;
        self
    }
    /// <p>A list of cancellation reasons.</p>
    pub fn get_cancellation_reasons(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::CancellationReason>> {
    ...
    pub fn build(self) -> super::super::super::types::error::TransactionCanceledException {
        super::super::super::types::error::TransactionCanceledException {
