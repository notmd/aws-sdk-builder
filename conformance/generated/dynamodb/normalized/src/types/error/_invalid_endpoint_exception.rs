...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::InvalidEndpointException {
...
impl InvalidEndpointException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::InvalidEndpointExceptionBuilder {
        super::super::super::types::error::builders::InvalidEndpointExceptionBuilder::default()
    }
}
...
impl InvalidEndpointExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::InvalidEndpointException {
        super::super::super::types::error::InvalidEndpointException {
