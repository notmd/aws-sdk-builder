...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::ItemCollectionSizeLimitExceededException {
...
impl ItemCollectionSizeLimitExceededException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::ItemCollectionSizeLimitExceededExceptionBuilder {
        super::super::super::types::error::builders::ItemCollectionSizeLimitExceededExceptionBuilder::default()
    }
}
...
impl ItemCollectionSizeLimitExceededExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::ItemCollectionSizeLimitExceededException {
        super::super::super::types::error::ItemCollectionSizeLimitExceededException {
