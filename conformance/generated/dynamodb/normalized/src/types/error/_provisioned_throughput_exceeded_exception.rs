...
pub struct ProvisionedThroughputExceededException {
    ...
    pub throttling_reasons: ::std::option::Option<::std::vec::Vec<super::super::super::types::ThrottlingReason>>,
...
impl ProvisionedThroughputExceededException {
    ...
    pub fn throttling_reasons(&self) -> &[super::super::super::types::ThrottlingReason] {
...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::ProvisionedThroughputExceededException {
...
impl ProvisionedThroughputExceededException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::ProvisionedThroughputExceededExceptionBuilder {
        super::super::super::types::error::builders::ProvisionedThroughputExceededExceptionBuilder::default()
    }
}
...
pub struct ProvisionedThroughputExceededExceptionBuilder {
    ...
    pub(crate) throttling_reasons: ::std::option::Option<::std::vec::Vec<super::super::super::types::ThrottlingReason>>,
...
impl ProvisionedThroughputExceededExceptionBuilder {
    ...
    ///
    /// <p>A list of <a href="https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_ThrottlingReason.html">ThrottlingReason</a> that provide detailed diagnostic information about why the request was throttled.</p>
    pub fn throttling_reasons(mut self, input: super::super::super::types::ThrottlingReason) -> Self {
    ...
    /// <p>A list of <a href="https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_ThrottlingReason.html">ThrottlingReason</a> that provide detailed diagnostic information about why the request was throttled.</p>
    pub fn set_throttling_reasons(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::ThrottlingReason>>) -> Self {
        self.throttling_reasons = input;
        self
    }
    /// <p>A list of <a href="https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_ThrottlingReason.html">ThrottlingReason</a> that provide detailed diagnostic information about why the request was throttled.</p>
    pub fn get_throttling_reasons(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::ThrottlingReason>> {
    ...
    pub fn build(self) -> super::super::super::types::error::ProvisionedThroughputExceededException {
        super::super::super::types::error::ProvisionedThroughputExceededException {
