...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::ReplicaNotFoundException {
...
impl ReplicaNotFoundException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::ReplicaNotFoundExceptionBuilder {
        super::super::super::types::error::builders::ReplicaNotFoundExceptionBuilder::default()
    }
}
...
impl ReplicaNotFoundExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::ReplicaNotFoundException {
        super::super::super::types::error::ReplicaNotFoundException {
