...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::GlobalTableNotFoundException {
...
impl GlobalTableNotFoundException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::GlobalTableNotFoundExceptionBuilder {
        super::super::super::types::error::builders::GlobalTableNotFoundExceptionBuilder::default()
    }
}
...
impl GlobalTableNotFoundExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::GlobalTableNotFoundException {
        super::super::super::types::error::GlobalTableNotFoundException {
