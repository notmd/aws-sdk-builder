...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::TransactionInProgressException {
...
impl TransactionInProgressException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::TransactionInProgressExceptionBuilder {
        super::super::super::types::error::builders::TransactionInProgressExceptionBuilder::default()
    }
}
...
impl TransactionInProgressExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::TransactionInProgressException {
        super::super::super::types::error::TransactionInProgressException {
