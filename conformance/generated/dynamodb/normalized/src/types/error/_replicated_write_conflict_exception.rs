...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::ReplicatedWriteConflictException {
...
impl ReplicatedWriteConflictException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::ReplicatedWriteConflictExceptionBuilder {
        super::super::super::types::error::builders::ReplicatedWriteConflictExceptionBuilder::default()
    }
}
...
impl ReplicatedWriteConflictExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::ReplicatedWriteConflictException {
        super::super::super::types::error::ReplicatedWriteConflictException {
