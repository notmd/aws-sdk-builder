...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::InternalServerError {
...
impl InternalServerError {
    ...
    pub fn builder() -> super::super::super::types::error::builders::InternalServerErrorBuilder {
        super::super::super::types::error::builders::InternalServerErrorBuilder::default()
    }
}
...
impl InternalServerErrorBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::InternalServerError {
        super::super::super::types::error::InternalServerError {
