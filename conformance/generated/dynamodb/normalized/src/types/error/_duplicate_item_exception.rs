...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::DuplicateItemException {
...
impl DuplicateItemException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::DuplicateItemExceptionBuilder {
        super::super::super::types::error::builders::DuplicateItemExceptionBuilder::default()
    }
}
...
impl DuplicateItemExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::DuplicateItemException {
        super::super::super::types::error::DuplicateItemException {
