...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::PolicyNotFoundException {
...
impl PolicyNotFoundException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::PolicyNotFoundExceptionBuilder {
        super::super::super::types::error::builders::PolicyNotFoundExceptionBuilder::default()
    }
}
...
impl PolicyNotFoundExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::PolicyNotFoundException {
        super::super::super::types::error::PolicyNotFoundException {
