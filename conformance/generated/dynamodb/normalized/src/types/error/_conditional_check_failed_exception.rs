...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::ConditionalCheckFailedException {
...
impl ConditionalCheckFailedException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::ConditionalCheckFailedExceptionBuilder {
        super::super::super::types::error::builders::ConditionalCheckFailedExceptionBuilder::default()
    }
}
...
impl ConditionalCheckFailedExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::ConditionalCheckFailedException {
        super::super::super::types::error::ConditionalCheckFailedException {
