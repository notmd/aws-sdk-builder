...
impl TableClassSummary {
    /// <p>The table class of the specified table. Valid values are <code>STANDARD</code> and <code>STANDARD_INFREQUENT_ACCESS</code>.</p>
    pub fn table_class(&self) -> ::std::option::Option<&super::super::types::TableClass> {
...
impl TableClassSummary {
    ...
    pub fn builder() -> super::super::types::builders::TableClassSummaryBuilder {
        super::super::types::builders::TableClassSummaryBuilder::default()
    }
}
...
pub struct TableClassSummaryBuilder {
    pub(crate) table_class: ::std::option::Option<super::super::types::TableClass>,
    pub(crate) last_update_date_time: ::std::option::Option<::aws_smithy_types::DateTime>,
}
impl TableClassSummaryBuilder {
    /// <p>The table class of the specified table. Valid values are <code>STANDARD</code> and <code>STANDARD_INFREQUENT_ACCESS</code>.</p>
    pub fn table_class(mut self, input: super::super::types::TableClass) -> Self {
        self.table_class = ::std::option::Option::Some(input);
        self
    }
    /// <p>The table class of the specified table. Valid values are <code>STANDARD</code> and <code>STANDARD_INFREQUENT_ACCESS</code>.</p>
    pub fn set_table_class(mut self, input: ::std::option::Option<super::super::types::TableClass>) -> Self {
        self.table_class = input;
        self
    }
    /// <p>The table class of the specified table. Valid values are <code>STANDARD</code> and <code>STANDARD_INFREQUENT_ACCESS</code>.</p>
    pub fn get_table_class(&self) -> &::std::option::Option<super::super::types::TableClass> {
        &self.table_class
    }
    /// <p>The date and time at which the table class was last updated.</p>
    ...
    pub fn build(self) -> super::super::types::TableClassSummary {
        super::super::types::TableClassSummary {
