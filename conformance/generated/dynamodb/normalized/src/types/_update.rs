...
impl Update {
    ...
    pub fn builder() -> super::super::types::builders::UpdateBuilder {
        super::super::types::builders::UpdateBuilder::default()
    }
}
...
impl UpdateBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::Update, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::Update {
