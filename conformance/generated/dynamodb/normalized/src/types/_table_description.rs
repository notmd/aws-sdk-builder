...
pub struct TableDescription {
    ...
    /// </ul>
    pub attribute_definitions: ::std::option::Option<::std::vec::Vec<super::super::types::AttributeDefinition>>,
    ...
    pub key_schema: ::std::option::Option<::std::vec::Vec<super::super::types::KeySchemaElement>>,
    ...
    /// </ul>
    pub table_status: ::std::option::Option<super::super::types::TableStatus>,
    ...
    pub provisioned_throughput: ::std::option::Option<super::super::types::ProvisionedThroughputDescription>,
    ...
    pub billing_mode_summary: ::std::option::Option<super::super::types::BillingModeSummary>,
    ...
    pub local_secondary_indexes: ::std::option::Option<::std::vec::Vec<super::super::types::LocalSecondaryIndexDescription>>,
    ...
    /// </ul>
    /// <p>If the table is in the <code>DELETING</code> state, no information about indexes will be returned.</p>
    pub global_secondary_indexes: ::std::option::Option<::std::vec::Vec<super::super::types::GlobalSecondaryIndexDescription>>,
    ...
    pub replicas: ::std::option::Option<::std::vec::Vec<super::super::types::ReplicaDescription>>,
    ...
    pub global_table_witnesses: ::std::option::Option<::std::vec::Vec<super::super::types::GlobalTableWitnessDescription>>,
    ...
    pub restore_summary: ::std::option::Option<super::super::types::RestoreSummary>,
    /// <p>The description of the server-side encryption status on the specified table.</p>
    pub sse_description: ::std::option::Option<super::super::types::SseDescription>,
    /// <p>Contains information about the table archive.</p>
    pub archival_summary: ::std::option::Option<super::super::types::ArchivalSummary>,
    /// <p>Contains details of the table class.</p>
    pub table_class_summary: ::std::option::Option<super::super::types::TableClassSummary>,
    ...
    pub warm_throughput: ::std::option::Option<super::super::types::TableWarmThroughputDescription>,
    ...
    /// <ul>
    /// <li>
    /// <p><code>IndexName</code> - The name of the vector index.</p></li>
    /// <li>
    /// <p><code>IndexStatus</code> - The current status of the vector index: <code>CREATING</code>, <code>ACTIVE</code>, or <code>DELETING</code>.</p></li>
    /// <li>
    /// <p><code>Backfilling</code> - Specifies whether the index is currently backfilling. During backfill, <code>SearchVectors</code> operations might return incomplete results.</p></li>
    /// <li>
    /// <p><code>VectorAttribute</code> - The attribute that contains vector embeddings.</p></li>
    /// <li>
    /// <p><code>Dimensions</code> - The number of dimensions in each vector.</p></li>
    /// <li>
    /// <p><code>DistanceFunction</code> - The distance function used to calculate similarity (<code>COSINE</code>, <code>EUCLIDEAN</code>, or <code>DOT_PRODUCT</code>).</p></li>
    /// <li>
    /// <p><code>SearchSchema</code> - The partition key and inline filter attributes for the vector index.</p></li>
    /// <li>
    /// <p><code>Projection</code> - Specifies attributes that are copied (projected) from the table into the vector index.</p></li>
    /// <li>
    /// <p><code>IndexArn</code> - The Amazon Resource Name (ARN) that uniquely identifies the index.</p></li>
    /// <li>
    /// <p><code>IndexSizeBytes</code> - The total size of the vector index, in bytes. Amazon DynamoDB updates this value approximately every six hours. Recent changes might not be reflected in this value.</p></li>
    /// <li>
    ...
    /// </ul>
    pub vector_indexes: ::std::option::Option<::std::vec::Vec<super::super::types::VectorIndexDescription>>,
}
impl TableDescription {
    ...
    pub fn attribute_definitions(&self) -> &[super::super::types::AttributeDefinition] {
    ...
    pub fn key_schema(&self) -> &[super::super::types::KeySchemaElement] {
    ...
    /// <p><code>ARCHIVED</code> - The table has been archived. See the ArchivalReason for more information.</p></li>
    /// </ul>
    pub fn table_status(&self) -> ::std::option::Option<&super::super::types::TableStatus> {
    ...
    /// <p>The provisioned throughput settings for the table, consisting of read and write capacity units, along with data about increases and decreases.</p>
    pub fn provisioned_throughput(&self) -> ::std::option::Option<&super::super::types::ProvisionedThroughputDescription> {
    ...
    /// <p>Contains the details for the read/write capacity mode.</p>
    pub fn billing_mode_summary(&self) -> ::std::option::Option<&super::super::types::BillingModeSummary> {
    ...
    pub fn local_secondary_indexes(&self) -> &[super::super::types::LocalSecondaryIndexDescription] {
    ...
    pub fn global_secondary_indexes(&self) -> &[super::super::types::GlobalSecondaryIndexDescription] {
        self.global_secondary_indexes.as_deref().unwrap_or_default()
    }
    /// <p>The current DynamoDB Streams configuration for the table.</p>
    pub fn stream_specification(&self) -> ::std::option::Option<&super::super::types::StreamSpecification> {
    ...
    pub fn replicas(&self) -> &[super::super::types::ReplicaDescription] {
    ...
    pub fn global_table_witnesses(&self) -> &[super::super::types::GlobalTableWitnessDescription] {
    ...
    /// <p><code>ENABLED_WITH_OVERRIDES</code>: This mode is set by default for a same account global table. Indicates that certain global table settings can be overridden.</p></li>
    /// </ul>
    pub fn global_table_settings_replication_mode(&self) -> ::std::option::Option<&super::super::types::GlobalTableSettingsReplicationMode> {
        self.global_table_settings_replication_mode.as_ref()
    }
    /// <p>Contains details for the restore.</p>
    pub fn restore_summary(&self) -> ::std::option::Option<&super::super::types::RestoreSummary> {
        self.restore_summary.as_ref()
    }
    /// <p>The description of the server-side encryption status on the specified table.</p>
    pub fn sse_description(&self) -> ::std::option::Option<&super::super::types::SseDescription> {
        self.sse_description.as_ref()
    }
    /// <p>Contains information about the table archive.</p>
    pub fn archival_summary(&self) -> ::std::option::Option<&super::super::types::ArchivalSummary> {
        self.archival_summary.as_ref()
    }
    /// <p>Contains details of the table class.</p>
    pub fn table_class_summary(&self) -> ::std::option::Option<&super::super::types::TableClassSummary> {
    ...
    /// <p>The maximum number of read and write units for the specified on-demand table. If you use this parameter, you must specify <code>MaxReadRequestUnits</code>, <code>MaxWriteRequestUnits</code>, or both.</p>
    pub fn on_demand_throughput(&self) -> ::std::option::Option<&super::super::types::OnDemandThroughput> {
        self.on_demand_throughput.as_ref()
    }
    /// <p>Describes the warm throughput value of the base table.</p>
    pub fn warm_throughput(&self) -> ::std::option::Option<&super::super::types::TableWarmThroughputDescription> {
    ...
    /// </ul>
    /// <p>If you don't specify this field, the global table consistency mode defaults to <code>EVENTUAL</code>. For more information about global tables consistency modes, see <a href="https://docs.aws.amazon.com/V2globaltables_HowItWorks.html#V2globaltables_HowItWorks.consistency-modes"> Consistency modes</a> in DynamoDB developer guide.</p>
    pub fn multi_region_consistency(&self) -> ::std::option::Option<&super::super::types::MultiRegionConsistency> {
    ...
    pub fn vector_indexes(&self) -> &[super::super::types::VectorIndexDescription] {
...
impl TableDescription {
    ...
    pub fn builder() -> super::super::types::builders::TableDescriptionBuilder {
        super::super::types::builders::TableDescriptionBuilder::default()
    }
}
...
pub struct TableDescriptionBuilder {
    pub(crate) attribute_definitions: ::std::option::Option<::std::vec::Vec<super::super::types::AttributeDefinition>>,
    pub(crate) table_name: ::std::option::Option<::std::string::String>,
    pub(crate) key_schema: ::std::option::Option<::std::vec::Vec<super::super::types::KeySchemaElement>>,
    pub(crate) table_status: ::std::option::Option<super::super::types::TableStatus>,
    pub(crate) creation_date_time: ::std::option::Option<::aws_smithy_types::DateTime>,
    pub(crate) provisioned_throughput: ::std::option::Option<super::super::types::ProvisionedThroughputDescription>,
    ...
    pub(crate) billing_mode_summary: ::std::option::Option<super::super::types::BillingModeSummary>,
    pub(crate) local_secondary_indexes: ::std::option::Option<::std::vec::Vec<super::super::types::LocalSecondaryIndexDescription>>,
    pub(crate) global_secondary_indexes: ::std::option::Option<::std::vec::Vec<super::super::types::GlobalSecondaryIndexDescription>>,
    pub(crate) stream_specification: ::std::option::Option<super::super::types::StreamSpecification>,
    ...
    pub(crate) replicas: ::std::option::Option<::std::vec::Vec<super::super::types::ReplicaDescription>>,
    pub(crate) global_table_witnesses: ::std::option::Option<::std::vec::Vec<super::super::types::GlobalTableWitnessDescription>>,
    pub(crate) global_table_settings_replication_mode: ::std::option::Option<super::super::types::GlobalTableSettingsReplicationMode>,
    pub(crate) restore_summary: ::std::option::Option<super::super::types::RestoreSummary>,
    pub(crate) sse_description: ::std::option::Option<super::super::types::SseDescription>,
    pub(crate) archival_summary: ::std::option::Option<super::super::types::ArchivalSummary>,
    pub(crate) table_class_summary: ::std::option::Option<super::super::types::TableClassSummary>,
    pub(crate) deletion_protection_enabled: ::std::option::Option<bool>,
    pub(crate) on_demand_throughput: ::std::option::Option<super::super::types::OnDemandThroughput>,
    pub(crate) warm_throughput: ::std::option::Option<super::super::types::TableWarmThroughputDescription>,
    pub(crate) multi_region_consistency: ::std::option::Option<super::super::types::MultiRegionConsistency>,
    pub(crate) vector_indexes: ::std::option::Option<::std::vec::Vec<super::super::types::VectorIndexDescription>>,
}
impl TableDescriptionBuilder {
    ...
    /// <p><code>AttributeType</code> - The data type for the attribute.</p></li>
    /// </ul>
    pub fn attribute_definitions(mut self, input: super::super::types::AttributeDefinition) -> Self {
    ...
    /// <p><code>AttributeType</code> - The data type for the attribute.</p></li>
    /// </ul>
    pub fn set_attribute_definitions(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::AttributeDefinition>>) -> Self {
    ...
    /// <p><code>AttributeType</code> - The data type for the attribute.</p></li>
    /// </ul>
    pub fn get_attribute_definitions(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::AttributeDefinition>> {
    ...
    /// </ul>
    /// <p>For more information about primary keys, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/DataModel.html#DataModelPrimaryKey">Primary Key</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p>
    pub fn key_schema(mut self, input: super::super::types::KeySchemaElement) -> Self {
    ...
    /// </ul>
    /// <p>For more information about primary keys, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/DataModel.html#DataModelPrimaryKey">Primary Key</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p>
    pub fn set_key_schema(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::KeySchemaElement>>) -> Self {
    ...
    /// </ul>
    /// <p>For more information about primary keys, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/DataModel.html#DataModelPrimaryKey">Primary Key</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p>
    pub fn get_key_schema(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::KeySchemaElement>> {
        &self.key_schema
    }
    /// <p>The current state of the table:</p>
    /// <ul>
    ...
    /// <p><code>ARCHIVED</code> - The table has been archived. See the ArchivalReason for more information.</p></li>
    /// </ul>
    pub fn table_status(mut self, input: super::super::types::TableStatus) -> Self {
    ...
    /// <p><code>ARCHIVED</code> - The table has been archived. See the ArchivalReason for more information.</p></li>
    /// </ul>
    pub fn set_table_status(mut self, input: ::std::option::Option<super::super::types::TableStatus>) -> Self {
    ...
    /// <p><code>ARCHIVED</code> - The table has been archived. See the ArchivalReason for more information.</p></li>
    /// </ul>
    pub fn get_table_status(&self) -> &::std::option::Option<super::super::types::TableStatus> {
        &self.table_status
    }
    /// <p>The date and time when the table was created, in <a href="http://www.epochconverter.com/">UNIX epoch time</a> format.</p>
    ...
    /// <p>The provisioned throughput settings for the table, consisting of read and write capacity units, along with data about increases and decreases.</p>
    pub fn provisioned_throughput(mut self, input: super::super::types::ProvisionedThroughputDescription) -> Self {
        self.provisioned_throughput = ::std::option::Option::Some(input);
        self
    }
    /// <p>The provisioned throughput settings for the table, consisting of read and write capacity units, along with data about increases and decreases.</p>
    pub fn set_provisioned_throughput(mut self, input: ::std::option::Option<super::super::types::ProvisionedThroughputDescription>) -> Self {
        self.provisioned_throughput = input;
        self
    }
    /// <p>The provisioned throughput settings for the table, consisting of read and write capacity units, along with data about increases and decreases.</p>
    pub fn get_provisioned_throughput(&self) -> &::std::option::Option<super::super::types::ProvisionedThroughputDescription> {
    ...
    /// <p>Contains the details for the read/write capacity mode.</p>
    pub fn billing_mode_summary(mut self, input: super::super::types::BillingModeSummary) -> Self {
        self.billing_mode_summary = ::std::option::Option::Some(input);
        self
    }
    /// <p>Contains the details for the read/write capacity mode.</p>
    pub fn set_billing_mode_summary(mut self, input: ::std::option::Option<super::super::types::BillingModeSummary>) -> Self {
        self.billing_mode_summary = input;
        self
    }
    /// <p>Contains the details for the read/write capacity mode.</p>
    pub fn get_billing_mode_summary(&self) -> &::std::option::Option<super::super::types::BillingModeSummary> {
    ...
    /// </ul>
    /// <p>If the table is in the <code>DELETING</code> state, no information about indexes will be returned.</p>
    pub fn local_secondary_indexes(mut self, input: super::super::types::LocalSecondaryIndexDescription) -> Self {
    ...
    pub fn set_local_secondary_indexes(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::types::LocalSecondaryIndexDescription>>,
    ) -> Self {
    ...
    /// </ul>
    /// <p>If the table is in the <code>DELETING</code> state, no information about indexes will be returned.</p>
    pub fn get_local_secondary_indexes(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::LocalSecondaryIndexDescription>> {
    ...
    /// </ul>
    /// <p>If the table is in the <code>DELETING</code> state, no information about indexes will be returned.</p>
    pub fn global_secondary_indexes(mut self, input: super::super::types::GlobalSecondaryIndexDescription) -> Self {
    ...
    pub fn set_global_secondary_indexes(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::types::GlobalSecondaryIndexDescription>>,
    ) -> Self {
    ...
    /// </ul>
    /// <p>If the table is in the <code>DELETING</code> state, no information about indexes will be returned.</p>
    pub fn get_global_secondary_indexes(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::GlobalSecondaryIndexDescription>> {
        &self.global_secondary_indexes
    }
    /// <p>The current DynamoDB Streams configuration for the table.</p>
    pub fn stream_specification(mut self, input: super::super::types::StreamSpecification) -> Self {
        self.stream_specification = ::std::option::Option::Some(input);
        self
    }
    /// <p>The current DynamoDB Streams configuration for the table.</p>
    pub fn set_stream_specification(mut self, input: ::std::option::Option<super::super::types::StreamSpecification>) -> Self {
        self.stream_specification = input;
        self
    }
    /// <p>The current DynamoDB Streams configuration for the table.</p>
    pub fn get_stream_specification(&self) -> &::std::option::Option<super::super::types::StreamSpecification> {
    ...
    ///
    /// <p>Represents replicas of the table.</p>
    pub fn replicas(mut self, input: super::super::types::ReplicaDescription) -> Self {
    ...
    /// <p>Represents replicas of the table.</p>
    pub fn set_replicas(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::ReplicaDescription>>) -> Self {
        self.replicas = input;
        self
    }
    /// <p>Represents replicas of the table.</p>
    pub fn get_replicas(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::ReplicaDescription>> {
        &self.replicas
    }
    ...
    ///
    /// <p>The witness Region and its current status in the MRSC global table. Only one witness Region can be configured per MRSC global table.</p>
    pub fn global_table_witnesses(mut self, input: super::super::types::GlobalTableWitnessDescription) -> Self {
    ...
    /// <p>The witness Region and its current status in the MRSC global table. Only one witness Region can be configured per MRSC global table.</p>
    pub fn get_global_table_witnesses(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::GlobalTableWitnessDescription>> {
    ...
    /// <p><code>ENABLED_WITH_OVERRIDES</code>: This mode is set by default for a same account global table. Indicates that certain global table settings can be overridden.</p></li>
    /// </ul>
    pub fn global_table_settings_replication_mode(mut self, input: super::super::types::GlobalTableSettingsReplicationMode) -> Self {
    ...
    pub fn set_global_table_settings_replication_mode(
        mut self,
        input: ::std::option::Option<super::super::types::GlobalTableSettingsReplicationMode>,
    ) -> Self {
    ...
    /// <p><code>ENABLED_WITH_OVERRIDES</code>: This mode is set by default for a same account global table. Indicates that certain global table settings can be overridden.</p></li>
    /// </ul>
    pub fn get_global_table_settings_replication_mode(&self) -> &::std::option::Option<super::super::types::GlobalTableSettingsReplicationMode> {
        &self.global_table_settings_replication_mode
    }
    /// <p>Contains details for the restore.</p>
    pub fn restore_summary(mut self, input: super::super::types::RestoreSummary) -> Self {
        self.restore_summary = ::std::option::Option::Some(input);
        self
    }
    /// <p>Contains details for the restore.</p>
    pub fn set_restore_summary(mut self, input: ::std::option::Option<super::super::types::RestoreSummary>) -> Self {
        self.restore_summary = input;
        self
    }
    /// <p>Contains details for the restore.</p>
    pub fn get_restore_summary(&self) -> &::std::option::Option<super::super::types::RestoreSummary> {
        &self.restore_summary
    }
    /// <p>The description of the server-side encryption status on the specified table.</p>
    pub fn sse_description(mut self, input: super::super::types::SseDescription) -> Self {
        self.sse_description = ::std::option::Option::Some(input);
        self
    }
    /// <p>The description of the server-side encryption status on the specified table.</p>
    pub fn set_sse_description(mut self, input: ::std::option::Option<super::super::types::SseDescription>) -> Self {
        self.sse_description = input;
        self
    }
    /// <p>The description of the server-side encryption status on the specified table.</p>
    pub fn get_sse_description(&self) -> &::std::option::Option<super::super::types::SseDescription> {
        &self.sse_description
    }
    /// <p>Contains information about the table archive.</p>
    pub fn archival_summary(mut self, input: super::super::types::ArchivalSummary) -> Self {
        self.archival_summary = ::std::option::Option::Some(input);
        self
    }
    /// <p>Contains information about the table archive.</p>
    pub fn set_archival_summary(mut self, input: ::std::option::Option<super::super::types::ArchivalSummary>) -> Self {
        self.archival_summary = input;
        self
    }
    /// <p>Contains information about the table archive.</p>
    pub fn get_archival_summary(&self) -> &::std::option::Option<super::super::types::ArchivalSummary> {
        &self.archival_summary
    }
    /// <p>Contains details of the table class.</p>
    pub fn table_class_summary(mut self, input: super::super::types::TableClassSummary) -> Self {
        self.table_class_summary = ::std::option::Option::Some(input);
        self
    }
    /// <p>Contains details of the table class.</p>
    pub fn set_table_class_summary(mut self, input: ::std::option::Option<super::super::types::TableClassSummary>) -> Self {
        self.table_class_summary = input;
        self
    }
    /// <p>Contains details of the table class.</p>
    pub fn get_table_class_summary(&self) -> &::std::option::Option<super::super::types::TableClassSummary> {
    ...
    /// <p>The maximum number of read and write units for the specified on-demand table. If you use this parameter, you must specify <code>MaxReadRequestUnits</code>, <code>MaxWriteRequestUnits</code>, or both.</p>
    pub fn on_demand_throughput(mut self, input: super::super::types::OnDemandThroughput) -> Self {
        self.on_demand_throughput = ::std::option::Option::Some(input);
        self
    }
    /// <p>The maximum number of read and write units for the specified on-demand table. If you use this parameter, you must specify <code>MaxReadRequestUnits</code>, <code>MaxWriteRequestUnits</code>, or both.</p>
    pub fn set_on_demand_throughput(mut self, input: ::std::option::Option<super::super::types::OnDemandThroughput>) -> Self {
        self.on_demand_throughput = input;
        self
    }
    /// <p>The maximum number of read and write units for the specified on-demand table. If you use this parameter, you must specify <code>MaxReadRequestUnits</code>, <code>MaxWriteRequestUnits</code>, or both.</p>
    pub fn get_on_demand_throughput(&self) -> &::std::option::Option<super::super::types::OnDemandThroughput> {
        &self.on_demand_throughput
    }
    /// <p>Describes the warm throughput value of the base table.</p>
    pub fn warm_throughput(mut self, input: super::super::types::TableWarmThroughputDescription) -> Self {
        self.warm_throughput = ::std::option::Option::Some(input);
        self
    }
    /// <p>Describes the warm throughput value of the base table.</p>
    pub fn set_warm_throughput(mut self, input: ::std::option::Option<super::super::types::TableWarmThroughputDescription>) -> Self {
        self.warm_throughput = input;
        self
    }
    /// <p>Describes the warm throughput value of the base table.</p>
    pub fn get_warm_throughput(&self) -> &::std::option::Option<super::super::types::TableWarmThroughputDescription> {
    ...
    /// </ul>
    /// <p>If you don't specify this field, the global table consistency mode defaults to <code>EVENTUAL</code>. For more information about global tables consistency modes, see <a href="https://docs.aws.amazon.com/V2globaltables_HowItWorks.html#V2globaltables_HowItWorks.consistency-modes"> Consistency modes</a> in DynamoDB developer guide.</p>
    pub fn multi_region_consistency(mut self, input: super::super::types::MultiRegionConsistency) -> Self {
    ...
    /// </ul>
    /// <p>If you don't specify this field, the global table consistency mode defaults to <code>EVENTUAL</code>. For more information about global tables consistency modes, see <a href="https://docs.aws.amazon.com/V2globaltables_HowItWorks.html#V2globaltables_HowItWorks.consistency-modes"> Consistency modes</a> in DynamoDB developer guide.</p>
    pub fn set_multi_region_consistency(mut self, input: ::std::option::Option<super::super::types::MultiRegionConsistency>) -> Self {
    ...
    /// </ul>
    /// <p>If you don't specify this field, the global table consistency mode defaults to <code>EVENTUAL</code>. For more information about global tables consistency modes, see <a href="https://docs.aws.amazon.com/V2globaltables_HowItWorks.html#V2globaltables_HowItWorks.consistency-modes"> Consistency modes</a> in DynamoDB developer guide.</p>
    pub fn get_multi_region_consistency(&self) -> &::std::option::Option<super::super::types::MultiRegionConsistency> {
    ...
    /// <p><code>ItemCount</code> - The number of items indexed in the vector index. Amazon DynamoDB updates this value approximately every six hours. Recent changes might not be reflected in this value.</p></li>
    /// </ul>
    pub fn vector_indexes(mut self, input: super::super::types::VectorIndexDescription) -> Self {
    ...
    /// <p><code>ItemCount</code> - The number of items indexed in the vector index. Amazon DynamoDB updates this value approximately every six hours. Recent changes might not be reflected in this value.</p></li>
    /// </ul>
    pub fn set_vector_indexes(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::VectorIndexDescription>>) -> Self {
    ...
    /// <p><code>ItemCount</code> - The number of items indexed in the vector index. Amazon DynamoDB updates this value approximately every six hours. Recent changes might not be reflected in this value.</p></li>
    /// </ul>
    pub fn get_vector_indexes(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::VectorIndexDescription>> {
        &self.vector_indexes
    }
    /// Consumes the builder and constructs a [`TableDescription`](crate::types::TableDescription).
    pub fn build(self) -> super::super::types::TableDescription {
        super::super::types::TableDescription {
