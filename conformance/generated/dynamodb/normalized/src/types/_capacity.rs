...
impl Capacity {
    ...
    pub fn builder() -> super::super::types::builders::CapacityBuilder {
        super::super::types::builders::CapacityBuilder::default()
    }
}
...
impl CapacityBuilder {
    ...
    pub fn build(self) -> super::super::types::Capacity {
        super::super::types::Capacity {
