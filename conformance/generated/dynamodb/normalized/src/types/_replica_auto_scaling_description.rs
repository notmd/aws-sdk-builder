...
pub struct ReplicaAutoScalingDescription {
    ...
    pub global_secondary_indexes: ::std::option::Option<::std::vec::Vec<super::super::types::ReplicaGlobalSecondaryIndexAutoScalingDescription>>,
...
impl ReplicaAutoScalingDescription {
    ...
    pub fn global_secondary_indexes(&self) -> &[super::super::types::ReplicaGlobalSecondaryIndexAutoScalingDescription] {
...
impl ReplicaAutoScalingDescription {
    ...
    pub fn builder() -> super::super::types::builders::ReplicaAutoScalingDescriptionBuilder {
        super::super::types::builders::ReplicaAutoScalingDescriptionBuilder::default()
    }
}
...
impl ReplicaAutoScalingDescriptionBuilder {
    ...
    ///
    /// <p>Replica-specific global secondary index auto scaling settings.</p>
    pub fn global_secondary_indexes(mut self, input: super::super::types::ReplicaGlobalSecondaryIndexAutoScalingDescription) -> Self {
    ...
    pub fn set_global_secondary_indexes(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::super::types::ReplicaGlobalSecondaryIndexAutoScalingDescription>>,
    ) -> Self {
    ...
    pub fn build(self) -> super::super::types::ReplicaAutoScalingDescription {
        super::super::types::ReplicaAutoScalingDescription {
