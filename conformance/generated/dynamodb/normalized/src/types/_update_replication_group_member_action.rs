...
pub struct UpdateReplicationGroupMemberAction {
    ...
    pub global_secondary_indexes: ::std::option::Option<::std::vec::Vec<super::super::types::ReplicaGlobalSecondaryIndex>>,
    /// <p>Replica-specific table class. If not specified, uses the source table's table class.</p>
    pub table_class_override: ::std::option::Option<super::super::types::TableClass>,
}
impl UpdateReplicationGroupMemberAction {
    ...
    pub fn global_secondary_indexes(&self) -> &[super::super::types::ReplicaGlobalSecondaryIndex] {
        self.global_secondary_indexes.as_deref().unwrap_or_default()
    }
    /// <p>Replica-specific table class. If not specified, uses the source table's table class.</p>
    pub fn table_class_override(&self) -> ::std::option::Option<&super::super::types::TableClass> {
...
impl UpdateReplicationGroupMemberAction {
    ...
    pub fn builder() -> super::super::types::builders::UpdateReplicationGroupMemberActionBuilder {
        super::super::types::builders::UpdateReplicationGroupMemberActionBuilder::default()
    }
}
...
pub struct UpdateReplicationGroupMemberActionBuilder {
    ...
    pub(crate) global_secondary_indexes: ::std::option::Option<::std::vec::Vec<super::super::types::ReplicaGlobalSecondaryIndex>>,
    pub(crate) table_class_override: ::std::option::Option<super::super::types::TableClass>,
}
impl UpdateReplicationGroupMemberActionBuilder {
    ...
    ///
    /// <p>Replica-specific global secondary index settings.</p>
    pub fn global_secondary_indexes(mut self, input: super::super::types::ReplicaGlobalSecondaryIndex) -> Self {
    ...
    /// <p>Replica-specific global secondary index settings.</p>
    pub fn get_global_secondary_indexes(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::ReplicaGlobalSecondaryIndex>> {
        &self.global_secondary_indexes
    }
    /// <p>Replica-specific table class. If not specified, uses the source table's table class.</p>
    pub fn table_class_override(mut self, input: super::super::types::TableClass) -> Self {
        self.table_class_override = ::std::option::Option::Some(input);
        self
    }
    /// <p>Replica-specific table class. If not specified, uses the source table's table class.</p>
    pub fn set_table_class_override(mut self, input: ::std::option::Option<super::super::types::TableClass>) -> Self {
        self.table_class_override = input;
        self
    }
    /// <p>Replica-specific table class. If not specified, uses the source table's table class.</p>
    pub fn get_table_class_override(&self) -> &::std::option::Option<super::super::types::TableClass> {
