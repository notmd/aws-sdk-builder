...
impl GlobalSecondaryIndexAutoScalingUpdate {
    ...
    /// <p>Represents the auto scaling settings to be modified for a global table or global secondary index.</p>
    pub fn provisioned_write_capacity_auto_scaling_update(&self) -> ::std::option::Option<&super::super::types::AutoScalingSettingsUpdate> {
...
impl GlobalSecondaryIndexAutoScalingUpdate {
    ...
    pub fn builder() -> super::super::types::builders::GlobalSecondaryIndexAutoScalingUpdateBuilder {
        super::super::types::builders::GlobalSecondaryIndexAutoScalingUpdateBuilder::default()
    }
}
...
pub struct GlobalSecondaryIndexAutoScalingUpdateBuilder {
    ...
    pub(crate) provisioned_write_capacity_auto_scaling_update: ::std::option::Option<super::super::types::AutoScalingSettingsUpdate>,
}
impl GlobalSecondaryIndexAutoScalingUpdateBuilder {
    ...
    /// <p>Represents the auto scaling settings to be modified for a global table or global secondary index.</p>
    pub fn provisioned_write_capacity_auto_scaling_update(mut self, input: super::super::types::AutoScalingSettingsUpdate) -> Self {
    ...
    /// <p>Represents the auto scaling settings to be modified for a global table or global secondary index.</p>
    pub fn get_provisioned_write_capacity_auto_scaling_update(&self) -> &::std::option::Option<super::super::types::AutoScalingSettingsUpdate> {
    ...
    pub fn build(self) -> super::super::types::GlobalSecondaryIndexAutoScalingUpdate {
        super::super::types::GlobalSecondaryIndexAutoScalingUpdate {
