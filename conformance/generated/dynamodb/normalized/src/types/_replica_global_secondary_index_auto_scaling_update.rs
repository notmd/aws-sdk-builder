...
pub struct ReplicaGlobalSecondaryIndexAutoScalingUpdate {
    ...
    pub provisioned_read_capacity_auto_scaling_update: ::std::option::Option<super::super::types::AutoScalingSettingsUpdate>,
}
impl ReplicaGlobalSecondaryIndexAutoScalingUpdate {
    ...
    /// <p>Represents the auto scaling settings to be modified for a global table or global secondary index.</p>
    pub fn provisioned_read_capacity_auto_scaling_update(&self) -> ::std::option::Option<&super::super::types::AutoScalingSettingsUpdate> {
...
impl ReplicaGlobalSecondaryIndexAutoScalingUpdate {
    ...
    pub fn builder() -> super::super::types::builders::ReplicaGlobalSecondaryIndexAutoScalingUpdateBuilder {
        super::super::types::builders::ReplicaGlobalSecondaryIndexAutoScalingUpdateBuilder::default()
    }
}
...
pub struct ReplicaGlobalSecondaryIndexAutoScalingUpdateBuilder {
    ...
    pub(crate) provisioned_read_capacity_auto_scaling_update: ::std::option::Option<super::super::types::AutoScalingSettingsUpdate>,
}
impl ReplicaGlobalSecondaryIndexAutoScalingUpdateBuilder {
    ...
    /// <p>Represents the auto scaling settings to be modified for a global table or global secondary index.</p>
    pub fn provisioned_read_capacity_auto_scaling_update(mut self, input: super::super::types::AutoScalingSettingsUpdate) -> Self {
    ...
    /// <p>Represents the auto scaling settings to be modified for a global table or global secondary index.</p>
    pub fn get_provisioned_read_capacity_auto_scaling_update(&self) -> &::std::option::Option<super::super::types::AutoScalingSettingsUpdate> {
    ...
    pub fn build(self) -> super::super::types::ReplicaGlobalSecondaryIndexAutoScalingUpdate {
        super::super::types::ReplicaGlobalSecondaryIndexAutoScalingUpdate {
