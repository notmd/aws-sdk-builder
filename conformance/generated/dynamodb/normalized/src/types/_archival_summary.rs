...
impl ArchivalSummary {
    ...
    pub fn builder() -> super::super::types::builders::ArchivalSummaryBuilder {
        super::super::types::builders::ArchivalSummaryBuilder::default()
    }
}
...
impl ArchivalSummaryBuilder {
    ...
    pub fn build(self) -> super::super::types::ArchivalSummary {
        super::super::types::ArchivalSummary {
