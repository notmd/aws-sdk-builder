...
impl LocalSecondaryIndexDescription {
    ...
    pub fn builder() -> super::super::types::builders::LocalSecondaryIndexDescriptionBuilder {
        super::super::types::builders::LocalSecondaryIndexDescriptionBuilder::default()
    }
}
...
impl LocalSecondaryIndexDescriptionBuilder {
    ...
    pub fn build(self) -> super::super::types::LocalSecondaryIndexDescription {
        super::super::types::LocalSecondaryIndexDescription {
