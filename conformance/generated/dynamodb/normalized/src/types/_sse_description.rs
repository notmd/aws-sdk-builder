...
pub struct SseDescription {
    ...
    /// </ul>
    pub status: ::std::option::Option<super::super::types::SseStatus>,
    ...
    /// </ul>
    pub sse_type: ::std::option::Option<super::super::types::SseType>,
...
impl SseDescription {
    ...
    /// <p><code>UPDATING</code> - Server-side encryption is being updated.</p></li>
    /// </ul>
    pub fn status(&self) -> ::std::option::Option<&super::super::types::SseStatus> {
        self.status.as_ref()
    }
    /// <p>Server-side encryption type. The only supported value is:</p>
    /// <ul>
    ...
    /// <p><code>KMS</code> - Server-side encryption that uses Key Management Service. The key is stored in your account and is managed by KMS (KMS charges apply).</p></li>
    /// </ul>
    pub fn sse_type(&self) -> ::std::option::Option<&super::super::types::SseType> {
...
impl SseDescription {
    ...
    pub fn builder() -> super::super::types::builders::SseDescriptionBuilder {
        super::super::types::builders::SseDescriptionBuilder::default()
    }
}
...
pub struct SseDescriptionBuilder {
    pub(crate) status: ::std::option::Option<super::super::types::SseStatus>,
    pub(crate) sse_type: ::std::option::Option<super::super::types::SseType>,
...
impl SseDescriptionBuilder {
    ...
    /// <p><code>UPDATING</code> - Server-side encryption is being updated.</p></li>
    /// </ul>
    pub fn status(mut self, input: super::super::types::SseStatus) -> Self {
    ...
    /// <p><code>UPDATING</code> - Server-side encryption is being updated.</p></li>
    /// </ul>
    pub fn set_status(mut self, input: ::std::option::Option<super::super::types::SseStatus>) -> Self {
        self.status = input;
        self
    }
    /// <p>Represents the current state of server-side encryption. The only supported values are:</p>
    ...
    /// <p><code>UPDATING</code> - Server-side encryption is being updated.</p></li>
    /// </ul>
    pub fn get_status(&self) -> &::std::option::Option<super::super::types::SseStatus> {
        &self.status
    }
    /// <p>Server-side encryption type. The only supported value is:</p>
    /// <ul>
    ...
    /// <p><code>KMS</code> - Server-side encryption that uses Key Management Service. The key is stored in your account and is managed by KMS (KMS charges apply).</p></li>
    /// </ul>
    pub fn sse_type(mut self, input: super::super::types::SseType) -> Self {
    ...
    /// <p><code>KMS</code> - Server-side encryption that uses Key Management Service. The key is stored in your account and is managed by KMS (KMS charges apply).</p></li>
    /// </ul>
    pub fn set_sse_type(mut self, input: ::std::option::Option<super::super::types::SseType>) -> Self {
        self.sse_type = input;
        self
    }
    /// <p>Server-side encryption type. The only supported value is:</p>
    ...
    /// <p><code>KMS</code> - Server-side encryption that uses Key Management Service. The key is stored in your account and is managed by KMS (KMS charges apply).</p></li>
    /// </ul>
    pub fn get_sse_type(&self) -> &::std::option::Option<super::super::types::SseType> {
        &self.sse_type
    }
    /// <p>The KMS key ARN used for the KMS encryption.</p>
    ...
    pub fn build(self) -> super::super::types::SseDescription {
        super::super::types::SseDescription {
            status: self.status,
