...
impl PointInTimeRecoverySpecification {
    ...
    pub fn builder() -> super::super::types::builders::PointInTimeRecoverySpecificationBuilder {
        super::super::types::builders::PointInTimeRecoverySpecificationBuilder::default()
    }
}
