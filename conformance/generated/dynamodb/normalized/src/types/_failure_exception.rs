...
impl FailureException {
    ...
    pub fn builder() -> super::super::types::builders::FailureExceptionBuilder {
        super::super::types::builders::FailureExceptionBuilder::default()
    }
}
...
impl FailureExceptionBuilder {
    ...
    pub fn build(self) -> super::super::types::FailureException {
        super::super::types::FailureException {
