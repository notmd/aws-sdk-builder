...
pub struct ExpectedAttributeValue {
    ...
    pub value: ::std::option::Option<super::super::types::AttributeValue>,
    ...
    /// </ul>
    pub comparison_operator: ::std::option::Option<super::super::types::ComparisonOperator>,
    ...
    pub attribute_value_list: ::std::option::Option<::std::vec::Vec<super::super::types::AttributeValue>>,
}
impl ExpectedAttributeValue {
    /// <p>Represents the data for the expected attribute.</p>
    /// <p>Each attribute value is described as a name-value pair. The name is the data type, and the value is the data itself.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/HowItWorks.NamingRulesDataTypes.html#HowItWorks.DataTypes">Data Types</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p>
    pub fn value(&self) -> ::std::option::Option<&super::super::types::AttributeValue> {
        self.value.as_ref()
    }
    /// <p>Causes DynamoDB to evaluate the value before attempting a conditional operation:</p>
    /// <ul>
    ...
    /// <p><code>AttributeValueList</code> must contain two <code>AttributeValue</code> elements of the same type, either String, Number, or Binary (not a set type). A target attribute matches if the target value is greater than, or equal to, the first element and less than, or equal to, the second element. If an item contains an <code>AttributeValue</code> element of a different type than the one provided in the request, the value does not match. For example, <code>{"S":"6"}</code> does not compare to <code>{"N":"6"}</code>. Also, <code>{"N":"6"}</code> does not compare to <code>{"NS":\["6", "2", "1"\]}</code></p></li>
    /// </ul>
    pub fn comparison_operator(&self) -> ::std::option::Option<&super::super::types::ComparisonOperator> {
    ...
    pub fn attribute_value_list(&self) -> &[super::super::types::AttributeValue] {
...
impl ExpectedAttributeValue {
    ...
    pub fn builder() -> super::super::types::builders::ExpectedAttributeValueBuilder {
        super::super::types::builders::ExpectedAttributeValueBuilder::default()
    }
}
...
pub struct ExpectedAttributeValueBuilder {
    pub(crate) value: ::std::option::Option<super::super::types::AttributeValue>,
    pub(crate) exists: ::std::option::Option<bool>,
    pub(crate) comparison_operator: ::std::option::Option<super::super::types::ComparisonOperator>,
    pub(crate) attribute_value_list: ::std::option::Option<::std::vec::Vec<super::super::types::AttributeValue>>,
}
impl ExpectedAttributeValueBuilder {
    /// <p>Represents the data for the expected attribute.</p>
    /// <p>Each attribute value is described as a name-value pair. The name is the data type, and the value is the data itself.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/HowItWorks.NamingRulesDataTypes.html#HowItWorks.DataTypes">Data Types</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p>
    pub fn value(mut self, input: super::super::types::AttributeValue) -> Self {
    ...
    /// <p>Each attribute value is described as a name-value pair. The name is the data type, and the value is the data itself.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/HowItWorks.NamingRulesDataTypes.html#HowItWorks.DataTypes">Data Types</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p>
    pub fn set_value(mut self, input: ::std::option::Option<super::super::types::AttributeValue>) -> Self {
        self.value = input;
        self
    }
    /// <p>Represents the data for the expected attribute.</p>
    /// <p>Each attribute value is described as a name-value pair. The name is the data type, and the value is the data itself.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/HowItWorks.NamingRulesDataTypes.html#HowItWorks.DataTypes">Data Types</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p>
    pub fn get_value(&self) -> &::std::option::Option<super::super::types::AttributeValue> {
        &self.value
    }
    /// <p>Causes DynamoDB to evaluate the value before attempting a conditional operation:</p>
    /// <ul>
    ...
    /// <p><code>AttributeValueList</code> must contain two <code>AttributeValue</code> elements of the same type, either String, Number, or Binary (not a set type). A target attribute matches if the target value is greater than, or equal to, the first element and less than, or equal to, the second element. If an item contains an <code>AttributeValue</code> element of a different type than the one provided in the request, the value does not match. For example, <code>{"S":"6"}</code> does not compare to <code>{"N":"6"}</code>. Also, <code>{"N":"6"}</code> does not compare to <code>{"NS":\["6", "2", "1"\]}</code></p></li>
    /// </ul>
    pub fn comparison_operator(mut self, input: super::super::types::ComparisonOperator) -> Self {
    ...
    /// <p><code>AttributeValueList</code> must contain two <code>AttributeValue</code> elements of the same type, either String, Number, or Binary (not a set type). A target attribute matches if the target value is greater than, or equal to, the first element and less than, or equal to, the second element. If an item contains an <code>AttributeValue</code> element of a different type than the one provided in the request, the value does not match. For example, <code>{"S":"6"}</code> does not compare to <code>{"N":"6"}</code>. Also, <code>{"N":"6"}</code> does not compare to <code>{"NS":\["6", "2", "1"\]}</code></p></li>
    /// </ul>
    pub fn set_comparison_operator(mut self, input: ::std::option::Option<super::super::types::ComparisonOperator>) -> Self {
    ...
    /// <p><code>AttributeValueList</code> must contain two <code>AttributeValue</code> elements of the same type, either String, Number, or Binary (not a set type). A target attribute matches if the target value is greater than, or equal to, the first element and less than, or equal to, the second element. If an item contains an <code>AttributeValue</code> element of a different type than the one provided in the request, the value does not match. For example, <code>{"S":"6"}</code> does not compare to <code>{"N":"6"}</code>. Also, <code>{"N":"6"}</code> does not compare to <code>{"NS":\["6", "2", "1"\]}</code></p></li>
    /// </ul>
    pub fn get_comparison_operator(&self) -> &::std::option::Option<super::super::types::ComparisonOperator> {
    ...
    /// <p>For Binary, DynamoDB treats each byte of the binary data as unsigned when it compares binary values.</p>
    /// <p>For information on specifying data types in JSON, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/DataFormat.html">JSON Data Format</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p>
    pub fn attribute_value_list(mut self, input: super::super::types::AttributeValue) -> Self {
    ...
    /// <p>For Binary, DynamoDB treats each byte of the binary data as unsigned when it compares binary values.</p>
    /// <p>For information on specifying data types in JSON, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/DataFormat.html">JSON Data Format</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p>
    pub fn set_attribute_value_list(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::AttributeValue>>) -> Self {
    ...
    /// <p>For Binary, DynamoDB treats each byte of the binary data as unsigned when it compares binary values.</p>
    /// <p>For information on specifying data types in JSON, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/DataFormat.html">JSON Data Format</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p>
    pub fn get_attribute_value_list(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::AttributeValue>> {
        &self.attribute_value_list
    }
    /// Consumes the builder and constructs a [`ExpectedAttributeValue`](crate::types::ExpectedAttributeValue).
    pub fn build(self) -> super::super::types::ExpectedAttributeValue {
        super::super::types::ExpectedAttributeValue {
            value: self.value,
            exists: self.exists,
