...
impl ProvisionedThroughput {
    ...
    pub fn builder() -> super::super::types::builders::ProvisionedThroughputBuilder {
        super::super::types::builders::ProvisionedThroughputBuilder::default()
    }
}
...
impl ProvisionedThroughputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::ProvisionedThroughput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::ProvisionedThroughput {
