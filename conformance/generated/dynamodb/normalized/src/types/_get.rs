...
impl Get {
    ...
    pub fn builder() -> super::super::types::builders::GetBuilder {
        super::super::types::builders::GetBuilder::default()
    }
}
...
impl GetBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::Get, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::Get {
