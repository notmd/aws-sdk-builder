...
pub struct GlobalTableWitnessDescription {
    ...
    pub witness_status: ::std::option::Option<super::super::types::WitnessStatus>,
}
impl GlobalTableWitnessDescription {
    ...
    /// <p>The current status of the witness Region in the MRSC global table.</p>
    pub fn witness_status(&self) -> ::std::option::Option<&super::super::types::WitnessStatus> {
...
impl GlobalTableWitnessDescription {
    ...
    pub fn builder() -> super::super::types::builders::GlobalTableWitnessDescriptionBuilder {
        super::super::types::builders::GlobalTableWitnessDescriptionBuilder::default()
    }
}
...
pub struct GlobalTableWitnessDescriptionBuilder {
    ...
    pub(crate) witness_status: ::std::option::Option<super::super::types::WitnessStatus>,
}
impl GlobalTableWitnessDescriptionBuilder {
    ...
    /// <p>The current status of the witness Region in the MRSC global table.</p>
    pub fn witness_status(mut self, input: super::super::types::WitnessStatus) -> Self {
        self.witness_status = ::std::option::Option::Some(input);
        self
    }
    /// <p>The current status of the witness Region in the MRSC global table.</p>
    pub fn set_witness_status(mut self, input: ::std::option::Option<super::super::types::WitnessStatus>) -> Self {
        self.witness_status = input;
        self
    }
    /// <p>The current status of the witness Region in the MRSC global table.</p>
    pub fn get_witness_status(&self) -> &::std::option::Option<super::super::types::WitnessStatus> {
        &self.witness_status
    }
    /// Consumes the builder and constructs a [`GlobalTableWitnessDescription`](crate::types::GlobalTableWitnessDescription).
    pub fn build(self) -> super::super::types::GlobalTableWitnessDescription {
        super::super::types::GlobalTableWitnessDescription {
