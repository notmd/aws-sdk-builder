...
pub struct KeySchemaElement {
    ...
    /// </note>
    pub key_type: super::super::types::KeyType,
}
impl KeySchemaElement {
    ...
    /// <p>The sort key of an item is also known as its <i>range attribute</i>. The term "range attribute" derives from the way DynamoDB stores items with the same partition key physically close together, in sorted order by the sort key value.</p>
    /// </note>
    pub fn key_type(&self) -> &super::super::types::KeyType {
        &self.key_type
    }
}
impl KeySchemaElement {
    /// Creates a new builder-style object to manufacture [`KeySchemaElement`](crate::types::KeySchemaElement).
    pub fn builder() -> super::super::types::builders::KeySchemaElementBuilder {
        super::super::types::builders::KeySchemaElementBuilder::default()
    }
}
...
pub struct KeySchemaElementBuilder {
    ...
    pub(crate) key_type: ::std::option::Option<super::super::types::KeyType>,
}
impl KeySchemaElementBuilder {
    ...
    /// </note>
    /// This field is required.
    pub fn key_type(mut self, input: super::super::types::KeyType) -> Self {
    ...
    /// <p>The sort key of an item is also known as its <i>range attribute</i>. The term "range attribute" derives from the way DynamoDB stores items with the same partition key physically close together, in sorted order by the sort key value.</p>
    /// </note>
    pub fn set_key_type(mut self, input: ::std::option::Option<super::super::types::KeyType>) -> Self {
        self.key_type = input;
        self
    }
    /// <p>The role that this key attribute will assume:</p>
    ...
    /// <p>The sort key of an item is also known as its <i>range attribute</i>. The term "range attribute" derives from the way DynamoDB stores items with the same partition key physically close together, in sorted order by the sort key value.</p>
    /// </note>
    pub fn get_key_type(&self) -> &::std::option::Option<super::super::types::KeyType> {
        &self.key_type
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::KeySchemaElement, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::KeySchemaElement {
