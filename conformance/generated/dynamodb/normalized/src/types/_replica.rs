...
impl Replica {
    ...
    pub fn builder() -> super::super::types::builders::ReplicaBuilder {
        super::super::types::builders::ReplicaBuilder::default()
    }
}
...
impl ReplicaBuilder {
    ...
    pub fn build(self) -> super::super::types::Replica {
        super::super::types::Replica {
