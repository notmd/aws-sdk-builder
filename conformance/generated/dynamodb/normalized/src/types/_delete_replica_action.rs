...
impl DeleteReplicaAction {
    ...
    pub fn builder() -> super::super::types::builders::DeleteReplicaActionBuilder {
        super::super::types::builders::DeleteReplicaActionBuilder::default()
    }
}
...
impl DeleteReplicaActionBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::DeleteReplicaAction, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::DeleteReplicaAction {
