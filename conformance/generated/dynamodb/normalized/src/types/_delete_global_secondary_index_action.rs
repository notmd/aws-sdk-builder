...
impl DeleteGlobalSecondaryIndexAction {
    ...
    pub fn builder() -> super::super::types::builders::DeleteGlobalSecondaryIndexActionBuilder {
        super::super::types::builders::DeleteGlobalSecondaryIndexActionBuilder::default()
    }
}
