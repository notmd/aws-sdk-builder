...
pub struct AutoScalingPolicyDescription {
    ...
    pub target_tracking_scaling_policy_configuration:
        ::std::option::Option<super::super::types::AutoScalingTargetTrackingScalingPolicyConfigurationDescription>,
}
...
impl AutoScalingPolicyDescription {
    ...
    pub fn builder() -> super::super::types::builders::AutoScalingPolicyDescriptionBuilder {
        super::super::types::builders::AutoScalingPolicyDescriptionBuilder::default()
    }
}
...
impl AutoScalingPolicyDescriptionBuilder {
    ...
    pub fn target_tracking_scaling_policy_configuration(
        mut self,
        input: super::super::types::AutoScalingTargetTrackingScalingPolicyConfigurationDescription,
    ) -> Self {
    ...
    pub fn set_target_tracking_scaling_policy_configuration(
        mut self,
        input: ::std::option::Option<super::super::types::AutoScalingTargetTrackingScalingPolicyConfigurationDescription>,
    ) -> Self {
    ...
    pub fn build(self) -> super::super::types::AutoScalingPolicyDescription {
        super::super::types::AutoScalingPolicyDescription {
