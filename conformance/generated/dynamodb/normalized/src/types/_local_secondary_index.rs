...
impl LocalSecondaryIndex {
    ...
    pub fn builder() -> super::super::types::builders::LocalSecondaryIndexBuilder {
        super::super::types::builders::LocalSecondaryIndexBuilder::default()
    }
}
...
impl LocalSecondaryIndexBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::LocalSecondaryIndex, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::LocalSecondaryIndex {
