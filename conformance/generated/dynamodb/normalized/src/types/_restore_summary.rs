...
impl RestoreSummary {
    ...
    pub fn builder() -> super::super::types::builders::RestoreSummaryBuilder {
        super::super::types::builders::RestoreSummaryBuilder::default()
    }
}
...
impl RestoreSummaryBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::RestoreSummary, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::RestoreSummary {
