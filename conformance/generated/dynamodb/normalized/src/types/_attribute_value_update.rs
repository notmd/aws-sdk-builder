...
pub struct AttributeValueUpdate {
    ...
    /// </ul>
    pub action: ::std::option::Option<super::super::types::AttributeAction>,
}
impl AttributeValueUpdate {
    ...
    /// <p><code>ADD</code> - DynamoDB creates a new item with the supplied primary key and number (or set) for the attribute value. The only data types allowed are number, number set, string set or binary set.</p></li>
    /// </ul>
    pub fn action(&self) -> ::std::option::Option<&super::super::types::AttributeAction> {
        self.action.as_ref()
    }
}
impl AttributeValueUpdate {
    /// Creates a new builder-style object to manufacture [`AttributeValueUpdate`](crate::types::AttributeValueUpdate).
    pub fn builder() -> super::super::types::builders::AttributeValueUpdateBuilder {
        super::super::types::builders::AttributeValueUpdateBuilder::default()
    }
}
...
pub struct AttributeValueUpdateBuilder {
    ...
    pub(crate) action: ::std::option::Option<super::super::types::AttributeAction>,
}
impl AttributeValueUpdateBuilder {
    ...
    /// <p><code>ADD</code> - DynamoDB creates a new item with the supplied primary key and number (or set) for the attribute value. The only data types allowed are number, number set, string set or binary set.</p></li>
    /// </ul>
    pub fn action(mut self, input: super::super::types::AttributeAction) -> Self {
    ...
    /// <p><code>ADD</code> - DynamoDB creates a new item with the supplied primary key and number (or set) for the attribute value. The only data types allowed are number, number set, string set or binary set.</p></li>
    /// </ul>
    pub fn set_action(mut self, input: ::std::option::Option<super::super::types::AttributeAction>) -> Self {
        self.action = input;
        self
    }
    /// <p>Specifies how to perform the update. Valid values are <code>PUT</code> (default), <code>DELETE</code>, and <code>ADD</code>. The behavior depends on whether the specified primary key already exists in the table.</p>
    ...
    /// <p><code>ADD</code> - DynamoDB creates a new item with the supplied primary key and number (or set) for the attribute value. The only data types allowed are number, number set, string set or binary set.</p></li>
    /// </ul>
    pub fn get_action(&self) -> &::std::option::Option<super::super::types::AttributeAction> {
        &self.action
    }
    /// Consumes the builder and constructs a [`AttributeValueUpdate`](crate::types::AttributeValueUpdate).
    pub fn build(self) -> super::super::types::AttributeValueUpdate {
        super::super::types::AttributeValueUpdate {
            value: self.value,
            action: self.action,
        }
    }
