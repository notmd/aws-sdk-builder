...
impl ThrottlingReason {
    ...
    pub fn builder() -> super::super::types::builders::ThrottlingReasonBuilder {
        super::super::types::builders::ThrottlingReasonBuilder::default()
    }
}
...
impl ThrottlingReasonBuilder {
    ...
    pub fn build(self) -> super::super::types::ThrottlingReason {
        super::super::types::ThrottlingReason {
            reason: self.reason,
