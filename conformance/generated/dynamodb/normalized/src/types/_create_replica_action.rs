...
impl CreateReplicaAction {
    ...
    pub fn builder() -> super::super::types::builders::CreateReplicaActionBuilder {
        super::super::types::builders::CreateReplicaActionBuilder::default()
    }
}
...
impl CreateReplicaActionBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::CreateReplicaAction, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::CreateReplicaAction {
