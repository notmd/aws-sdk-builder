...
impl SourceTableDetails {
    ...
    pub fn builder() -> super::super::types::builders::SourceTableDetailsBuilder {
        super::super::types::builders::SourceTableDetailsBuilder::default()
    }
}
...
impl SourceTableDetailsBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::SourceTableDetails, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::SourceTableDetails {
