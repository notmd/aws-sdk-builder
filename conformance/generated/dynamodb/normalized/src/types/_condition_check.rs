...
pub struct ConditionCheck {
    ...
    pub key: ::std::collections::HashMap<::std::string::String, super::super::types::AttributeValue>,
    ...
    pub expression_attribute_values: ::std::option::Option<::std::collections::HashMap<::std::string::String, super::super::types::AttributeValue>>,
...
impl ConditionCheck {
    /// <p>The primary key of the item to be checked. Each element consists of an attribute name and a value for that attribute.</p>
    pub fn key(&self) -> &::std::collections::HashMap<::std::string::String, super::super::types::AttributeValue> {
        &self.key
    }
    /// <p>Name of the table for the check item request. You can also provide the Amazon Resource Name (ARN) of the table in this parameter.</p>
    ...
    /// <p>Use <code>ReturnValuesOnConditionCheckFailure</code> to get the item attributes if the <code>ConditionCheck</code> condition fails. For <code>ReturnValuesOnConditionCheckFailure</code>, the valid values are: NONE and ALL_OLD.</p>
    pub fn return_values_on_condition_check_failure(&self) -> ::std::option::Option<&super::super::types::ReturnValuesOnConditionCheckFailure> {
...
impl ConditionCheck {
    ...
    pub fn builder() -> super::super::types::builders::ConditionCheckBuilder {
        super::super::types::builders::ConditionCheckBuilder::default()
    }
}
...
pub struct ConditionCheckBuilder {
    pub(crate) key: ::std::option::Option<::std::collections::HashMap<::std::string::String, super::super::types::AttributeValue>>,
...
impl ConditionCheckBuilder {
    ...
    ///
    /// <p>The primary key of the item to be checked. Each element consists of an attribute name and a value for that attribute.</p>
    pub fn key(mut self, k: impl ::std::convert::Into<::std::string::String>, v: super::super::types::AttributeValue) -> Self {
    ...
    /// <p>The primary key of the item to be checked. Each element consists of an attribute name and a value for that attribute.</p>
    pub fn get_key(&self) -> &::std::option::Option<::std::collections::HashMap<::std::string::String, super::super::types::AttributeValue>> {
        &self.key
    }
    /// <p>Name of the table for the check item request. You can also provide the Amazon Resource Name (ARN) of the table in this parameter.</p>
    ...
    /// <p>Use <code>ReturnValuesOnConditionCheckFailure</code> to get the item attributes if the <code>ConditionCheck</code> condition fails. For <code>ReturnValuesOnConditionCheckFailure</code>, the valid values are: NONE and ALL_OLD.</p>
    pub fn return_values_on_condition_check_failure(mut self, input: super::super::types::ReturnValuesOnConditionCheckFailure) -> Self {
    ...
    pub fn set_return_values_on_condition_check_failure(
        mut self,
        input: ::std::option::Option<super::super::types::ReturnValuesOnConditionCheckFailure>,
    ) -> Self {
        self.return_values_on_condition_check_failure = input;
        self
    }
    /// <p>Use <code>ReturnValuesOnConditionCheckFailure</code> to get the item attributes if the <code>ConditionCheck</code> condition fails. For <code>ReturnValuesOnConditionCheckFailure</code>, the valid values are: NONE and ALL_OLD.</p>
    pub fn get_return_values_on_condition_check_failure(&self) -> &::std::option::Option<super::super::types::ReturnValuesOnConditionCheckFailure> {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::ConditionCheck, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::ConditionCheck {
