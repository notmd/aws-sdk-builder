...
pub struct AttributeDefinition {
    ...
    /// </ul>
    pub attribute_type: super::super::types::ScalarAttributeType,
}
impl AttributeDefinition {
    ...
    /// <p><code>B</code> - the attribute is of type Binary</p></li>
    /// </ul>
    pub fn attribute_type(&self) -> &super::super::types::ScalarAttributeType {
        &self.attribute_type
    }
}
impl AttributeDefinition {
    /// Creates a new builder-style object to manufacture [`AttributeDefinition`](crate::types::AttributeDefinition).
    pub fn builder() -> super::super::types::builders::AttributeDefinitionBuilder {
        super::super::types::builders::AttributeDefinitionBuilder::default()
    }
}
...
pub struct AttributeDefinitionBuilder {
    ...
    pub(crate) attribute_type: ::std::option::Option<super::super::types::ScalarAttributeType>,
}
impl AttributeDefinitionBuilder {
    ...
    /// </ul>
    /// This field is required.
    pub fn attribute_type(mut self, input: super::super::types::ScalarAttributeType) -> Self {
    ...
    /// <p><code>B</code> - the attribute is of type Binary</p></li>
    /// </ul>
    pub fn set_attribute_type(mut self, input: ::std::option::Option<super::super::types::ScalarAttributeType>) -> Self {
    ...
    /// <p><code>B</code> - the attribute is of type Binary</p></li>
    /// </ul>
    pub fn get_attribute_type(&self) -> &::std::option::Option<super::super::types::ScalarAttributeType> {
        &self.attribute_type
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::AttributeDefinition, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::AttributeDefinition {
