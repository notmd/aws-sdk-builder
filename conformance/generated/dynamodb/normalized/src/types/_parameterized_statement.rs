...
pub struct ParameterizedStatement {
    ...
    pub parameters: ::std::option::Option<::std::vec::Vec<super::super::types::AttributeValue>>,
...
impl ParameterizedStatement {
    ...
    pub fn parameters(&self) -> &[super::super::types::AttributeValue] {
...
impl ParameterizedStatement {
    ...
    pub fn builder() -> super::super::types::builders::ParameterizedStatementBuilder {
        super::super::types::builders::ParameterizedStatementBuilder::default()
    }
}
...
pub struct ParameterizedStatementBuilder {
    ...
    pub(crate) parameters: ::std::option::Option<::std::vec::Vec<super::super::types::AttributeValue>>,
...
impl ParameterizedStatementBuilder {
    ...
    ///
    /// <p>The parameter values.</p>
    pub fn parameters(mut self, input: super::super::types::AttributeValue) -> Self {
    ...
    /// <p>The parameter values.</p>
    pub fn set_parameters(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::AttributeValue>>) -> Self {
        self.parameters = input;
        self
    }
    /// <p>The parameter values.</p>
    pub fn get_parameters(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::AttributeValue>> {
        &self.parameters
    }
    /// <p>An optional parameter that returns the item attributes for a PartiQL <code>ParameterizedStatement</code> operation that failed a condition check.</p>
    /// <p>There is no additional cost associated with requesting a return value aside from the small network and processing overhead of receiving a larger response. No read capacity units are consumed.</p>
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::ParameterizedStatement, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::ParameterizedStatement {
