...
impl CsvOptions {
    ...
    pub fn builder() -> super::super::types::builders::CsvOptionsBuilder {
        super::super::types::builders::CsvOptionsBuilder::default()
    }
}
...
impl CsvOptionsBuilder {
    ...
    pub fn build(self) -> super::super::types::CsvOptions {
        super::super::types::CsvOptions {
