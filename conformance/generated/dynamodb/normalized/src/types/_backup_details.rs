...
pub struct BackupDetails {
    ...
    pub backup_status: super::super::types::BackupStatus,
    /// <p>BackupType:</p>
    /// <ul>
    /// <li>
    ...
    /// </ul>
    pub backup_type: super::super::types::BackupType,
...
impl BackupDetails {
    ...
    /// <p>Backup can be in one of the following states: CREATING, ACTIVE, DELETED.</p>
    pub fn backup_status(&self) -> &super::super::types::BackupStatus {
        &self.backup_status
    }
    /// <p>BackupType:</p>
    /// <ul>
    ...
    /// <p><code>AWS_BACKUP</code> - On-demand backup created by you from Backup service.</p></li>
    /// </ul>
    pub fn backup_type(&self) -> &super::super::types::BackupType {
        &self.backup_type
    }
    /// <p>Time at which the backup was created. This is the request time of the backup.</p>
...
impl BackupDetails {
    ...
    pub fn builder() -> super::super::types::builders::BackupDetailsBuilder {
        super::super::types::builders::BackupDetailsBuilder::default()
    }
}
...
pub struct BackupDetailsBuilder {
    ...
    pub(crate) backup_status: ::std::option::Option<super::super::types::BackupStatus>,
    pub(crate) backup_type: ::std::option::Option<super::super::types::BackupType>,
...
impl BackupDetailsBuilder {
    ...
    /// <p>Backup can be in one of the following states: CREATING, ACTIVE, DELETED.</p>
    /// This field is required.
    pub fn backup_status(mut self, input: super::super::types::BackupStatus) -> Self {
        self.backup_status = ::std::option::Option::Some(input);
        self
    }
    /// <p>Backup can be in one of the following states: CREATING, ACTIVE, DELETED.</p>
    pub fn set_backup_status(mut self, input: ::std::option::Option<super::super::types::BackupStatus>) -> Self {
        self.backup_status = input;
        self
    }
    /// <p>Backup can be in one of the following states: CREATING, ACTIVE, DELETED.</p>
    pub fn get_backup_status(&self) -> &::std::option::Option<super::super::types::BackupStatus> {
        &self.backup_status
    }
    /// <p>BackupType:</p>
    /// <ul>
    ...
    /// </ul>
    /// This field is required.
    pub fn backup_type(mut self, input: super::super::types::BackupType) -> Self {
    ...
    /// <p><code>AWS_BACKUP</code> - On-demand backup created by you from Backup service.</p></li>
    /// </ul>
    pub fn set_backup_type(mut self, input: ::std::option::Option<super::super::types::BackupType>) -> Self {
    ...
    /// <p><code>AWS_BACKUP</code> - On-demand backup created by you from Backup service.</p></li>
    /// </ul>
    pub fn get_backup_type(&self) -> &::std::option::Option<super::super::types::BackupType> {
        &self.backup_type
    }
    /// <p>Time at which the backup was created. This is the request time of the backup.</p>
    /// This field is required.
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::BackupDetails, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::BackupDetails {
