...
impl CancellationReason {
    ...
    pub fn builder() -> super::super::types::builders::CancellationReasonBuilder {
        super::super::types::builders::CancellationReasonBuilder::default()
    }
}
...
impl CancellationReasonBuilder {
    ...
    pub fn build(self) -> super::super::types::CancellationReason {
        super::super::types::CancellationReason {
            item: self.item,
            code: self.code,
