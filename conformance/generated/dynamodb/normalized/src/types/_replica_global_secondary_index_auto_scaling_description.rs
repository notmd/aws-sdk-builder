...
pub struct ReplicaGlobalSecondaryIndexAutoScalingDescription {
    ...
    pub provisioned_read_capacity_auto_scaling_settings: ::std::option::Option<super::super::types::AutoScalingSettingsDescription>,
    /// <p>Represents the auto scaling settings for a global table or global secondary index.</p>
    pub provisioned_write_capacity_auto_scaling_settings: ::std::option::Option<super::super::types::AutoScalingSettingsDescription>,
}
impl ReplicaGlobalSecondaryIndexAutoScalingDescription {
    ...
    /// <p>Represents the auto scaling settings for a global table or global secondary index.</p>
    pub fn provisioned_read_capacity_auto_scaling_settings(&self) -> ::std::option::Option<&super::super::types::AutoScalingSettingsDescription> {
        self.provisioned_read_capacity_auto_scaling_settings.as_ref()
    }
    /// <p>Represents the auto scaling settings for a global table or global secondary index.</p>
    pub fn provisioned_write_capacity_auto_scaling_settings(&self) -> ::std::option::Option<&super::super::types::AutoScalingSettingsDescription> {
...
impl ReplicaGlobalSecondaryIndexAutoScalingDescription {
    ...
    pub fn builder() -> super::super::types::builders::ReplicaGlobalSecondaryIndexAutoScalingDescriptionBuilder {
        super::super::types::builders::ReplicaGlobalSecondaryIndexAutoScalingDescriptionBuilder::default()
    }
}
...
pub struct ReplicaGlobalSecondaryIndexAutoScalingDescriptionBuilder {
    ...
    pub(crate) provisioned_read_capacity_auto_scaling_settings: ::std::option::Option<super::super::types::AutoScalingSettingsDescription>,
    pub(crate) provisioned_write_capacity_auto_scaling_settings: ::std::option::Option<super::super::types::AutoScalingSettingsDescription>,
}
impl ReplicaGlobalSecondaryIndexAutoScalingDescriptionBuilder {
    ...
    /// <p>Represents the auto scaling settings for a global table or global secondary index.</p>
    pub fn provisioned_read_capacity_auto_scaling_settings(mut self, input: super::super::types::AutoScalingSettingsDescription) -> Self {
    ...
    /// <p>Represents the auto scaling settings for a global table or global secondary index.</p>
    pub fn get_provisioned_read_capacity_auto_scaling_settings(&self) -> &::std::option::Option<super::super::types::AutoScalingSettingsDescription> {
        &self.provisioned_read_capacity_auto_scaling_settings
    }
    /// <p>Represents the auto scaling settings for a global table or global secondary index.</p>
    pub fn provisioned_write_capacity_auto_scaling_settings(mut self, input: super::super::types::AutoScalingSettingsDescription) -> Self {
    ...
    pub fn build(self) -> super::super::types::ReplicaGlobalSecondaryIndexAutoScalingDescription {
        super::super::types::ReplicaGlobalSecondaryIndexAutoScalingDescription {
