...
impl TableExistsFluentBuilder {
    ...
    pub async fn wait(
    ...
    ) -> ::std::result::Result<super::waiters::table_exists::TableExistsFinalPoll, super::waiters::table_exists::WaitUntilTableExistsError> {
        let input = self
            .inner
            .build()
        ...
        >| {
            ...
            if super::waiters::matchers::match_describe_table_0429b99996ae6dab6(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"errorType":"ResourceNotFoundException"}
            if super::waiters::matchers::match_describe_table_1cce2c05524fb92d4(result) {
        ...
        let operation = move || {
            ...
            async move { super::operation::describe_table::DescribeTable::orchestrate(&runtime_plugins, input).await }
        };
