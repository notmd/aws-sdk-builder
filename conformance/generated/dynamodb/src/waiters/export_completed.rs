...
impl ExportCompletedFluentBuilder {
    ...
    pub async fn wait(
        ...
        super::waiters::export_completed::ExportCompletedFinalPoll,
        super::waiters::export_completed::WaitUntilExportCompletedError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            ...
            if super::waiters::matchers::match_describe_export_a4219f96bc64309c4(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"output":{"path":"ExportDescription.ExportStatus","expected":"FAILED","comparator":"stringEquals"}}
            if super::waiters::matchers::match_describe_export_8d899fd0681b891e9(result) {
        ...
        let operation = move || {
            ...
            async move { super::operation::describe_export::DescribeExport::orchestrate(&runtime_plugins, input).await }
        };
