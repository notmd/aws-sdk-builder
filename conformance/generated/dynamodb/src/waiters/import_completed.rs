...
impl ImportCompletedFluentBuilder {
    ...
    pub async fn wait(
        ...
        super::waiters::import_completed::ImportCompletedFinalPoll,
        super::waiters::import_completed::WaitUntilImportCompletedError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            ...
            if super::waiters::matchers::match_describe_import_6175a829c57972dc3(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"output":{"path":"ImportTableDescription.ImportStatus","expected":"FAILED","comparator":"stringEquals"}}
            if super::waiters::matchers::match_describe_import_ba4301a7fe05a6956(result) {
            ...
            if super::waiters::matchers::match_describe_import_b4c5c86bd60d42041(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Failure;
            }
        ...
        let operation = move || {
            ...
            async move { super::operation::describe_import::DescribeImport::orchestrate(&runtime_plugins, input).await }
        };
