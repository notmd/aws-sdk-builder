...
impl KinesisStreamingDestinationActiveFluentBuilder {
    ...
    pub async fn wait(
        ...
        super::waiters::kinesis_streaming_destination_active::KinesisStreamingDestinationActiveFinalPoll,
        super::waiters::kinesis_streaming_destination_active::WaitUntilKinesisStreamingDestinationActiveError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            ...
            if super::waiters::matchers::match_describe_kinesis_streaming_destination_56e18114fb2c2cf5a(result) {
            ...
            if super::waiters::matchers::match_describe_kinesis_streaming_destination_ce975c8fb2b65f98f(result) {
        ...
        let operation = move || {
            ...
            async move {
                super::operation::describe_kinesis_streaming_destination::DescribeKinesisStreamingDestination::orchestrate(&runtime_plugins, input)
                    .await
            }
        };
