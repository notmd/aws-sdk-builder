...
impl super::Client {
    ...
    pub fn describe_global_table_settings(
        &self,
    ) -> super::operation::describe_global_table_settings::builders::DescribeGlobalTableSettingsFluentBuilder {
        super::operation::describe_global_table_settings::builders::DescribeGlobalTableSettingsFluentBuilder::new(self.handle.clone())
    }
}
