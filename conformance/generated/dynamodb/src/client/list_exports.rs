...
impl super::Client {
    ...
    pub fn list_exports(&self) -> super::operation::list_exports::builders::ListExportsFluentBuilder {
        super::operation::list_exports::builders::ListExportsFluentBuilder::new(self.handle.clone())
    }
}
