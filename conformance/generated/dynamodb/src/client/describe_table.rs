...
impl super::Client {
    ...
    pub fn describe_table(&self) -> super::operation::describe_table::builders::DescribeTableFluentBuilder {
        super::operation::describe_table::builders::DescribeTableFluentBuilder::new(self.handle.clone())
    }
}
