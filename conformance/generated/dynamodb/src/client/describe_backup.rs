...
impl super::Client {
    ...
    pub fn describe_backup(&self) -> super::operation::describe_backup::builders::DescribeBackupFluentBuilder {
        super::operation::describe_backup::builders::DescribeBackupFluentBuilder::new(self.handle.clone())
    }
}
