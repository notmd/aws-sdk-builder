...
impl super::Client {
    ...
    pub fn describe_import(&self) -> super::operation::describe_import::builders::DescribeImportFluentBuilder {
        super::operation::describe_import::builders::DescribeImportFluentBuilder::new(self.handle.clone())
    }
}
