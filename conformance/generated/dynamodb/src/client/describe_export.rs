...
impl super::Client {
    ...
    pub fn describe_export(&self) -> super::operation::describe_export::builders::DescribeExportFluentBuilder {
        super::operation::describe_export::builders::DescribeExportFluentBuilder::new(self.handle.clone())
    }
}
