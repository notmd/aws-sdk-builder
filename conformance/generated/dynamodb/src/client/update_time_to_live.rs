...
impl super::Client {
    ...
    pub fn update_time_to_live(&self) -> super::operation::update_time_to_live::builders::UpdateTimeToLiveFluentBuilder {
        super::operation::update_time_to_live::builders::UpdateTimeToLiveFluentBuilder::new(self.handle.clone())
    }
}
