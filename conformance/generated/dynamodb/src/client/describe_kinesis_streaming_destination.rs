...
impl super::Client {
    ...
    pub fn describe_kinesis_streaming_destination(
        &self,
    ) -> super::operation::describe_kinesis_streaming_destination::builders::DescribeKinesisStreamingDestinationFluentBuilder {
        super::operation::describe_kinesis_streaming_destination::builders::DescribeKinesisStreamingDestinationFluentBuilder::new(self.handle.clone())
    }
}
