...
impl super::Client {
    ...
    pub fn update_continuous_backups(&self) -> super::operation::update_continuous_backups::builders::UpdateContinuousBackupsFluentBuilder {
        super::operation::update_continuous_backups::builders::UpdateContinuousBackupsFluentBuilder::new(self.handle.clone())
    }
}
