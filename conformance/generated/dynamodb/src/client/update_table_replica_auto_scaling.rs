...
impl super::Client {
    ...
    pub fn update_table_replica_auto_scaling(
        &self,
    ) -> super::operation::update_table_replica_auto_scaling::builders::UpdateTableReplicaAutoScalingFluentBuilder {
        super::operation::update_table_replica_auto_scaling::builders::UpdateTableReplicaAutoScalingFluentBuilder::new(self.handle.clone())
    }
}
