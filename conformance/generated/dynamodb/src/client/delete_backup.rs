...
impl super::Client {
    ...
    pub fn delete_backup(&self) -> super::operation::delete_backup::builders::DeleteBackupFluentBuilder {
        super::operation::delete_backup::builders::DeleteBackupFluentBuilder::new(self.handle.clone())
    }
}
