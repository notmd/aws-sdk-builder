...
impl super::Client {
    ...
    pub fn describe_global_table(&self) -> super::operation::describe_global_table::builders::DescribeGlobalTableFluentBuilder {
        super::operation::describe_global_table::builders::DescribeGlobalTableFluentBuilder::new(self.handle.clone())
    }
}
