...
impl super::Client {
    ...
    pub fn describe_limits(&self) -> super::operation::describe_limits::builders::DescribeLimitsFluentBuilder {
        super::operation::describe_limits::builders::DescribeLimitsFluentBuilder::new(self.handle.clone())
    }
}
