...
impl super::Client {
    ...
    pub fn describe_time_to_live(&self) -> super::operation::describe_time_to_live::builders::DescribeTimeToLiveFluentBuilder {
        super::operation::describe_time_to_live::builders::DescribeTimeToLiveFluentBuilder::new(self.handle.clone())
    }
}
