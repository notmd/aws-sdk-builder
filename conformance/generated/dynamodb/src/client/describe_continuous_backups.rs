...
impl super::Client {
    ...
    pub fn describe_continuous_backups(&self) -> super::operation::describe_continuous_backups::builders::DescribeContinuousBackupsFluentBuilder {
        super::operation::describe_continuous_backups::builders::DescribeContinuousBackupsFluentBuilder::new(self.handle.clone())
    }
}
