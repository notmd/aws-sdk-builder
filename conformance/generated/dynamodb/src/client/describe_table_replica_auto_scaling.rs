...
impl super::Client {
    ...
    pub fn describe_table_replica_auto_scaling(
        &self,
    ) -> super::operation::describe_table_replica_auto_scaling::builders::DescribeTableReplicaAutoScalingFluentBuilder {
        super::operation::describe_table_replica_auto_scaling::builders::DescribeTableReplicaAutoScalingFluentBuilder::new(self.handle.clone())
    }
}
