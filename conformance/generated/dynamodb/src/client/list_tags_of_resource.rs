...
impl super::Client {
    ...
    pub fn list_tags_of_resource(&self) -> super::operation::list_tags_of_resource::builders::ListTagsOfResourceFluentBuilder {
        super::operation::list_tags_of_resource::builders::ListTagsOfResourceFluentBuilder::new(self.handle.clone())
    }
}
