...
impl super::Client {
    ...
    pub fn describe_endpoints(&self) -> super::operation::describe_endpoints::builders::DescribeEndpointsFluentBuilder {
        super::operation::describe_endpoints::builders::DescribeEndpointsFluentBuilder::new(self.handle.clone())
    }
}
