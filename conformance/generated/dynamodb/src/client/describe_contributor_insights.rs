...
impl super::Client {
    ...
    pub fn describe_contributor_insights(
        &self,
    ) -> super::operation::describe_contributor_insights::builders::DescribeContributorInsightsFluentBuilder {
        super::operation::describe_contributor_insights::builders::DescribeContributorInsightsFluentBuilder::new(self.handle.clone())
    }
}
