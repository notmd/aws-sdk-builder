...
impl super::Client {
    ...
    pub fn list_contributor_insights(&self) -> super::operation::list_contributor_insights::builders::ListContributorInsightsFluentBuilder {
        super::operation::list_contributor_insights::builders::ListContributorInsightsFluentBuilder::new(self.handle.clone())
    }
}
