...
impl super::Client {
    ...
    pub fn execute_transaction(&self) -> super::operation::execute_transaction::builders::ExecuteTransactionFluentBuilder {
        super::operation::execute_transaction::builders::ExecuteTransactionFluentBuilder::new(self.handle.clone())
    }
}
