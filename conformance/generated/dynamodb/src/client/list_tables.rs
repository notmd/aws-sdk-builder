...
impl super::Client {
    ...
    pub fn list_tables(&self) -> super::operation::list_tables::builders::ListTablesFluentBuilder {
        super::operation::list_tables::builders::ListTablesFluentBuilder::new(self.handle.clone())
    }
}
