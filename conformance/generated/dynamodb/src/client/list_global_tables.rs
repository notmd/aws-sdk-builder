...
impl super::Client {
    ...
    pub fn list_global_tables(&self) -> super::operation::list_global_tables::builders::ListGlobalTablesFluentBuilder {
        super::operation::list_global_tables::builders::ListGlobalTablesFluentBuilder::new(self.handle.clone())
    }
}
