...
impl super::Client {
    ...
    pub fn enable_kinesis_streaming_destination(
        &self,
    ) -> super::operation::enable_kinesis_streaming_destination::builders::EnableKinesisStreamingDestinationFluentBuilder {
        super::operation::enable_kinesis_streaming_destination::builders::EnableKinesisStreamingDestinationFluentBuilder::new(self.handle.clone())
    }
}
