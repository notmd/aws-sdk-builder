...
impl super::Client {
    ...
    pub fn update_global_table(&self) -> super::operation::update_global_table::builders::UpdateGlobalTableFluentBuilder {
        super::operation::update_global_table::builders::UpdateGlobalTableFluentBuilder::new(self.handle.clone())
    }
}
