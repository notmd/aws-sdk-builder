...
impl super::Client {
    ...
    pub fn delete_table(&self) -> super::operation::delete_table::builders::DeleteTableFluentBuilder {
        super::operation::delete_table::builders::DeleteTableFluentBuilder::new(self.handle.clone())
    }
}
