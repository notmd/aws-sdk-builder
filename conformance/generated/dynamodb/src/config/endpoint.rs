    ...
    T: ResolveEndpoint,
{
    ...
    fn finalize_params<'a>(
        ...
        match (
            params.get_mut::<super::config::endpoint::Params>(),
            identity
                .as_ref()
            ...
            match current_ref {
                ...
                ref_val => {
                    ...
                    let condition_result = match node.condition_index {
                        ...
                        4 => (|_diagnostic_collector: &mut super::endpoint_lib::diagnostic::DiagnosticCollector| -> bool {
                        ...
                        7 => (|_diagnostic_collector: &mut super::endpoint_lib::diagnostic::DiagnosticCollector| -> bool {
                            ...
                            let partition_resolver = &self.partition_resolver;
                            {
                                *parsed_endpoint = super::endpoint_lib::parse_url::parse_url(
                        ...
                        15 => (|_diagnostic_collector: &mut super::endpoint_lib::diagnostic::DiagnosticCollector| -> bool {
                            ...
                            let partition_resolver = &self.partition_resolver;
                            {
                                *parsed_arn_ssa_2 = super::endpoint_lib::arn::parse_arn(
                        ...
                        22 => (|_diagnostic_collector: &mut super::endpoint_lib::diagnostic::DiagnosticCollector| -> bool {
                            ...
                            let partition_resolver = &self.partition_resolver;
                            {
                                *parsed_arn_ssa_1 = super::endpoint_lib::arn::parse_arn(
                        ...
                        31 => (|_diagnostic_collector: &mut super::endpoint_lib::diagnostic::DiagnosticCollector| -> bool {
                            let partition_resolver = &self.partition_resolver;
                            (super::endpoint_lib::coalesce::coalesce!(is_search_operation.clone(), false)) == (true)
                        })(&mut _diagnostic_collector),
...
const NODES: [super::endpoint_lib::bdd_interpreter::BddNode; 82] = [
...
pub(crate) struct ConditionContext<'a> {
    ...
    pub(crate) parsed_endpoint: Option<super::endpoint_lib::parse_url::Url<'a>>,
    pub(crate) parsed_arn_ssa_2: Option<super::endpoint_lib::arn::Arn<'a>>,
    pub(crate) first_arn: Option<&'a str>,
    pub(crate) parsed_arn_ssa_1: Option<super::endpoint_lib::arn::Arn<'a>>,
