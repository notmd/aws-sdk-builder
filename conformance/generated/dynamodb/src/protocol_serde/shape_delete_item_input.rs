        ...
        for (key_9, value_10) in var_7 {
            {
                ...
                super::protocol_serde::shape_expected_attribute_value::ser_expected_attribute_value(&mut object_11, value_10)?;
                object_11.finish();
            }
        }
        object_8.finish();
        ...
        for (key_23, value_24) in var_21 {
            {
                ...
                super::protocol_serde::shape_attribute_value::ser_attribute_value(&mut object_25, value_24)?;
                object_25.finish();
            }
        }
        object_22.finish();
