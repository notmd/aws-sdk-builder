...
pub(crate) fn de_auto_scaling_settings_description<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::types::AutoScalingSettingsDescription>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::types::builders::AutoScalingSettingsDescriptionBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ScalingPolicies" => {
                            builder = builder.set_scaling_policies(
                                super::protocol_serde::shape_auto_scaling_policy_description_list::de_auto_scaling_policy_description_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
