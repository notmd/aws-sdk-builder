        ...
        for (key_11, value_12) in var_9 {
            {
                ...
                super::protocol_serde::shape_condition::ser_condition(&mut object_13, value_12)?;
                object_13.finish();
            }
        }
        object_10.finish();
        ...
        for (key_16, value_17) in var_14 {
            {
                ...
                super::protocol_serde::shape_condition::ser_condition(&mut object_18, value_17)?;
                object_18.finish();
            }
        }
        object_15.finish();
        ...
        for (key_36, value_37) in var_34 {
            {
                ...
                super::protocol_serde::shape_attribute_value::ser_attribute_value(&mut object_38, value_37)?;
                object_38.finish();
            }
        }
        object_35.finish();
