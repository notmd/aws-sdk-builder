...
pub fn ser_keys_and_attributes(
    ...
    input: &super::types::KeysAndAttributes,
                ...
                for (key_4, value_5) in item_2 {
                    {
                        ...
                        super::protocol_serde::shape_attribute_value::ser_attribute_value(&mut object_6, value_5)?;
                        object_6.finish();
                    }
                }
                object_3.finish();
...
pub(crate) fn de_keys_and_attributes<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::types::KeysAndAttributes>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::types::builders::KeysAndAttributesBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "AttributesToGet" => {
                            builder = builder.set_attributes_to_get(super::protocol_serde::shape_attribute_name_list::de_attribute_name_list(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "ExpressionAttributeNames" => {
                            builder = builder.set_expression_attribute_names(
                                super::protocol_serde::shape_expression_attribute_name_map::de_expression_attribute_name_map(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
            ...
            Ok(Some(super::serde_util::keys_and_attributes_correct_errors(builder).build().map_err(
