...
pub fn ser_replica_settings_update(
    ...
    input: &super::types::ReplicaSettingsUpdate,
    ...
    if let Some(var_2) = &input.replica_provisioned_read_capacity_auto_scaling_settings_update {
        ...
        super::protocol_serde::shape_auto_scaling_settings_update::ser_auto_scaling_settings_update(&mut object_3, var_2)?;
        object_3.finish();
    }
        ...
        for item_6 in var_4 {
            {
                ...
                super::protocol_serde::shape_replica_global_secondary_index_settings_update::ser_replica_global_secondary_index_settings_update(
                    &mut object_7,
                    item_6,
                )?;
                object_7.finish();
