...
pub fn de_get_resource_policy_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::get_resource_policy::GetResourcePolicyOutput, super::operation::get_resource_policy::GetResourcePolicyError>
{
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::get_resource_policy::GetResourcePolicyError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InternalServerError" => super::operation::get_resource_policy::GetResourcePolicyError::InternalServerError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidEndpointException" => super::operation::get_resource_policy::GetResourcePolicyError::InvalidEndpointException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "PolicyNotFoundException" => super::operation::get_resource_policy::GetResourcePolicyError::PolicyNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => super::operation::get_resource_policy::GetResourcePolicyError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::get_resource_policy::GetResourcePolicyError::generic(generic),
    })
}
...
) -> std::result::Result<super::operation::get_resource_policy::GetResourcePolicyOutput, super::operation::get_resource_policy::GetResourcePolicyError>
{
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::get_resource_policy::builders::GetResourcePolicyOutputBuilder::default();
        output = super::protocol_serde::shape_get_resource_policy::de_get_resource_policy(_response_body, output)
            .map_err(super::operation::get_resource_policy::GetResourcePolicyError::unhandled)?;
...
pub(crate) fn de_get_resource_policy(
    ...
    super::operation::get_resource_policy::builders::GetResourcePolicyOutputBuilder,
