...
pub fn ser_update_global_table_settings_input_input(
    ...
    if let Some(var_4) = &input.global_table_provisioned_write_capacity_auto_scaling_settings_update {
        ...
        super::protocol_serde::shape_auto_scaling_settings_update::ser_auto_scaling_settings_update(&mut object_5, var_4)?;
        object_5.finish();
    }
        ...
        for item_8 in var_6 {
            {
                ...
                super::protocol_serde::shape_global_table_global_secondary_index_settings_update::ser_global_table_global_secondary_index_settings_update(&mut object_9, item_8)?;
                object_9.finish();
            }
        }
        array_7.finish();
        ...
        for item_12 in var_10 {
            {
                ...
                super::protocol_serde::shape_replica_settings_update::ser_replica_settings_update(&mut object_13, item_12)?;
                object_13.finish();
            }
        }
        array_11.finish();
