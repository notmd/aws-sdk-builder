        ...
        for (key_10, value_11) in var_8 {
            {
                ...
                super::protocol_serde::shape_condition::ser_condition(&mut object_12, value_11)?;
                object_12.finish();
            }
        }
        object_9.finish();
        ...
        for (key_16, value_17) in var_14 {
            {
                ...
                super::protocol_serde::shape_attribute_value::ser_attribute_value(&mut object_18, value_17)?;
                object_18.finish();
            }
        }
        object_15.finish();
        ...
        for (key_30, value_31) in var_28 {
            {
                ...
                super::protocol_serde::shape_attribute_value::ser_attribute_value(&mut object_32, value_31)?;
                object_32.finish();
            }
        }
        object_29.finish();
