...
pub fn de_get_item_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::get_item::GetItemOutput, super::operation::get_item::GetItemError> {
    #[allow(unused_mut)]
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::get_item::GetItemError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::get_item::GetItemError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InternalServerError" => super::operation::get_item::GetItemError::InternalServerError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidEndpointException" => super::operation::get_item::GetItemError::InvalidEndpointException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ProvisionedThroughputExceededException" => {
            super::operation::get_item::GetItemError::ProvisionedThroughputExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = super::types::error::builders::ProvisionedThroughputExceededExceptionBuilder::default();
                    output = super::protocol_serde::shape_provisioned_throughput_exceeded_exception::de_provisioned_throughput_exceeded_exception_json_err(_response_body, output).map_err(super::operation::get_item::GetItemError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        "RequestLimitExceeded" => super::operation::get_item::GetItemError::RequestLimitExceeded({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => super::operation::get_item::GetItemError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ThrottlingException" => super::operation::get_item::GetItemError::ThrottlingException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::get_item::GetItemError::generic(generic),
    })
}
...
pub fn de_get_item_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::get_item::builders::GetItemOutputBuilder::default();
        output = super::protocol_serde::shape_get_item::de_get_item(_response_body, output)
            .map_err(super::operation::get_item::GetItemError::unhandled)?;
...
pub fn ser_get_item_input(
    input: &super::operation::get_item::GetItemInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    super::protocol_serde::shape_get_item_input::ser_get_item_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_get_item(
    _value: &[u8],
    mut builder: super::operation::get_item::builders::GetItemOutputBuilder,
) -> ::std::result::Result<super::operation::get_item::builders::GetItemOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
