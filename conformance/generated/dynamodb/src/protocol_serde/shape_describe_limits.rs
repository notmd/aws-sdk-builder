...
pub fn de_describe_limits_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::describe_limits::DescribeLimitsOutput, super::operation::describe_limits::DescribeLimitsError> {
    #[allow(unused_mut)]
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::describe_limits::DescribeLimitsError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::describe_limits::DescribeLimitsError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InternalServerError" => super::operation::describe_limits::DescribeLimitsError::InternalServerError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidEndpointException" => super::operation::describe_limits::DescribeLimitsError::InvalidEndpointException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::describe_limits::DescribeLimitsError::generic(generic),
    })
}
...
pub fn de_describe_limits_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::describe_limits::builders::DescribeLimitsOutputBuilder::default();
        output = super::protocol_serde::shape_describe_limits::de_describe_limits(_response_body, output)
            .map_err(super::operation::describe_limits::DescribeLimitsError::unhandled)?;
...
pub fn ser_describe_limits_input(
    _input: &super::operation::describe_limits::DescribeLimitsInput,
...
pub(crate) fn de_describe_limits(
    _value: &[u8],
    mut builder: super::operation::describe_limits::builders::DescribeLimitsOutputBuilder,
) -> ::std::result::Result<
    super::operation::describe_limits::builders::DescribeLimitsOutputBuilder,
