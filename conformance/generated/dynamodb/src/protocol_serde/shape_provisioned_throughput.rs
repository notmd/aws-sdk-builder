...
pub fn ser_provisioned_throughput(
    ...
    input: &super::types::ProvisionedThroughput,
...
pub(crate) fn de_provisioned_throughput<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::types::ProvisionedThroughput>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::types::builders::ProvisionedThroughputBuilder::default();
            loop {
                match tokens.next().transpose()? {
            ...
            Ok(Some(super::serde_util::provisioned_throughput_correct_errors(builder).build().map_err(
