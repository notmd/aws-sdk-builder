...
pub fn ser_restore_table_from_backup_input_input(
        ...
        for item_6 in var_4 {
            {
                ...
                super::protocol_serde::shape_global_secondary_index::ser_global_secondary_index(&mut object_7, item_6)?;
                object_7.finish();
            }
        }
        array_5.finish();
        ...
        for item_10 in var_8 {
            {
                ...
                super::protocol_serde::shape_local_secondary_index::ser_local_secondary_index(&mut object_11, item_10)?;
                object_11.finish();
            }
        }
        array_9.finish();
    ...
    if let Some(var_12) = &input.provisioned_throughput_override {
        ...
        super::protocol_serde::shape_provisioned_throughput::ser_provisioned_throughput(&mut object_13, var_12)?;
        object_13.finish();
    }
    if let Some(var_14) = &input.on_demand_throughput_override {
        ...
        super::protocol_serde::shape_on_demand_throughput::ser_on_demand_throughput(&mut object_15, var_14)?;
        object_15.finish();
    }
    if let Some(var_16) = &input.sse_specification_override {
        #[allow(unused_mut)]
        let mut object_17 = object.key("SSESpecificationOverride").start_object();
        super::protocol_serde::shape_sse_specification::ser_sse_specification(&mut object_17, var_16)?;
        object_17.finish();
    }
