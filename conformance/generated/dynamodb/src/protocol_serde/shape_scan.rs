...
pub fn de_scan_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::scan::ScanOutput, super::operation::scan::ScanError> {
    #[allow(unused_mut)]
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::scan::ScanError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::scan::ScanError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InternalServerError" => super::operation::scan::ScanError::InternalServerError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidEndpointException" => super::operation::scan::ScanError::InvalidEndpointException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ProvisionedThroughputExceededException" => {
            super::operation::scan::ScanError::ProvisionedThroughputExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = super::types::error::builders::ProvisionedThroughputExceededExceptionBuilder::default();
                    output = super::protocol_serde::shape_provisioned_throughput_exceeded_exception::de_provisioned_throughput_exceeded_exception_json_err(_response_body, output).map_err(super::operation::scan::ScanError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        "RequestLimitExceeded" => super::operation::scan::ScanError::RequestLimitExceeded({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => super::operation::scan::ScanError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ThrottlingException" => super::operation::scan::ScanError::ThrottlingException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::scan::ScanError::generic(generic),
    })
}
...
pub fn de_scan_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::scan::builders::ScanOutputBuilder::default();
        output = super::protocol_serde::shape_scan::de_scan(_response_body, output).map_err(super::operation::scan::ScanError::unhandled)?;
...
pub fn ser_scan_input(
    input: &super::operation::scan::ScanInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    super::protocol_serde::shape_scan_input::ser_scan_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_scan(
    _value: &[u8],
    mut builder: super::operation::scan::builders::ScanOutputBuilder,
) -> ::std::result::Result<super::operation::scan::builders::ScanOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
