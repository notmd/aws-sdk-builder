...
pub fn ser_incremental_export_specification(
    ...
    input: &super::types::IncrementalExportSpecification,
...
pub(crate) fn de_incremental_export_specification<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::types::IncrementalExportSpecification>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::types::builders::IncrementalExportSpecificationBuilder::default();
            loop {
                match tokens.next().transpose()? {
                        ...
                        "ExportViewType" => {
                            builder = builder.set_export_view_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| super::types::ExportViewType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
