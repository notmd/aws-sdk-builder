...
pub struct ExpectedAttributeValue {
    ...
    /// </ul>
    pub comparison_operator: ::std::option::Option<super::types::ComparisonOperator>,
    ...
    pub attribute_value_list: ::std::option::Option<::std::vec::Vec<super::types::AttributeValue>>,
}
impl ExpectedAttributeValue {
    ...
    /// <p><code>AttributeValueList</code> must contain two <code>AttributeValue</code> elements of the same type, either String, Number, or Binary (not a set type). A target attribute matches if the target value is greater than, or equal to, the first element and less than, or equal to, the second element. If an item contains an <code>AttributeValue</code> element of a different type than the one provided in the request, the value does not match. For example, <code>{"S":"6"}</code> does not compare to <code>{"N":"6"}</code>. Also, <code>{"N":"6"}</code> does not compare to <code>{"NS":\["6", "2", "1"\]}</code></p></li>
    /// </ul>
    pub fn comparison_operator(&self) -> ::std::option::Option<&super::types::ComparisonOperator> {
    ...
    pub fn attribute_value_list(&self) -> &[super::types::AttributeValue] {
...
impl ExpectedAttributeValue {
    ...
    pub fn builder() -> super::types::builders::ExpectedAttributeValueBuilder {
        super::types::builders::ExpectedAttributeValueBuilder::default()
    }
}
...
pub struct ExpectedAttributeValueBuilder {
    ...
    pub(crate) comparison_operator: ::std::option::Option<super::types::ComparisonOperator>,
    pub(crate) attribute_value_list: ::std::option::Option<::std::vec::Vec<super::types::AttributeValue>>,
}
impl ExpectedAttributeValueBuilder {
    ...
    /// <p><code>AttributeValueList</code> must contain two <code>AttributeValue</code> elements of the same type, either String, Number, or Binary (not a set type). A target attribute matches if the target value is greater than, or equal to, the first element and less than, or equal to, the second element. If an item contains an <code>AttributeValue</code> element of a different type than the one provided in the request, the value does not match. For example, <code>{"S":"6"}</code> does not compare to <code>{"N":"6"}</code>. Also, <code>{"N":"6"}</code> does not compare to <code>{"NS":\["6", "2", "1"\]}</code></p></li>
    /// </ul>
    pub fn comparison_operator(mut self, input: super::types::ComparisonOperator) -> Self {
    ...
    /// <p><code>AttributeValueList</code> must contain two <code>AttributeValue</code> elements of the same type, either String, Number, or Binary (not a set type). A target attribute matches if the target value is greater than, or equal to, the first element and less than, or equal to, the second element. If an item contains an <code>AttributeValue</code> element of a different type than the one provided in the request, the value does not match. For example, <code>{"S":"6"}</code> does not compare to <code>{"N":"6"}</code>. Also, <code>{"N":"6"}</code> does not compare to <code>{"NS":\["6", "2", "1"\]}</code></p></li>
    /// </ul>
    pub fn set_comparison_operator(mut self, input: ::std::option::Option<super::types::ComparisonOperator>) -> Self {
    ...
    /// <p><code>AttributeValueList</code> must contain two <code>AttributeValue</code> elements of the same type, either String, Number, or Binary (not a set type). A target attribute matches if the target value is greater than, or equal to, the first element and less than, or equal to, the second element. If an item contains an <code>AttributeValue</code> element of a different type than the one provided in the request, the value does not match. For example, <code>{"S":"6"}</code> does not compare to <code>{"N":"6"}</code>. Also, <code>{"N":"6"}</code> does not compare to <code>{"NS":\["6", "2", "1"\]}</code></p></li>
    /// </ul>
    pub fn get_comparison_operator(&self) -> &::std::option::Option<super::types::ComparisonOperator> {
    ...
    /// <p>For Binary, DynamoDB treats each byte of the binary data as unsigned when it compares binary values.</p>
    /// <p>For information on specifying data types in JSON, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/DataFormat.html">JSON Data Format</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p>
    pub fn attribute_value_list(mut self, input: super::types::AttributeValue) -> Self {
    ...
    /// <p>For Binary, DynamoDB treats each byte of the binary data as unsigned when it compares binary values.</p>
    /// <p>For information on specifying data types in JSON, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/DataFormat.html">JSON Data Format</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p>
    pub fn set_attribute_value_list(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::AttributeValue>>) -> Self {
    ...
    /// <p>For Binary, DynamoDB treats each byte of the binary data as unsigned when it compares binary values.</p>
    /// <p>For information on specifying data types in JSON, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/DataFormat.html">JSON Data Format</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p>
    pub fn get_attribute_value_list(&self) -> &::std::option::Option<::std::vec::Vec<super::types::AttributeValue>> {
        &self.attribute_value_list
    }
    /// Consumes the builder and constructs a [`ExpectedAttributeValue`](crate::types::ExpectedAttributeValue).
    pub fn build(self) -> super::types::ExpectedAttributeValue {
        super::types::ExpectedAttributeValue {
            value: self.value,
            exists: self.exists,
