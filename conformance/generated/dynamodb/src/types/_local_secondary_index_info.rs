...
impl LocalSecondaryIndexInfo {
    ...
    pub fn builder() -> super::types::builders::LocalSecondaryIndexInfoBuilder {
        super::types::builders::LocalSecondaryIndexInfoBuilder::default()
    }
}
...
impl LocalSecondaryIndexInfoBuilder {
    ...
    pub fn build(self) -> super::types::LocalSecondaryIndexInfo {
        super::types::LocalSecondaryIndexInfo {
