...
impl CreateGlobalTableWitnessGroupMemberActionBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::CreateGlobalTableWitnessGroupMemberAction, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::CreateGlobalTableWitnessGroupMemberAction {
            region_name: self.region_name.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("region_name", "region_name was not specified but it is required when building CreateGlobalTableWitnessGroupMemberAction"))?,
        })
    }
}
