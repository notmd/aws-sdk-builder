...
impl ParameterizedStatement {
    ...
    pub fn builder() -> super::types::builders::ParameterizedStatementBuilder {
        super::types::builders::ParameterizedStatementBuilder::default()
    }
}
...
impl ParameterizedStatementBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::ParameterizedStatement, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ParameterizedStatement {
