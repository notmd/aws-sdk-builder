...
impl PutRequest {
    ...
    pub fn builder() -> super::types::builders::PutRequestBuilder {
        super::types::builders::PutRequestBuilder::default()
    }
}
...
impl PutRequestBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::PutRequest, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::PutRequest {
