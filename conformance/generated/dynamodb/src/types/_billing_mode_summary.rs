...
impl BillingModeSummary {
    ...
    pub fn builder() -> super::types::builders::BillingModeSummaryBuilder {
        super::types::builders::BillingModeSummaryBuilder::default()
    }
}
...
impl BillingModeSummaryBuilder {
    ...
    pub fn build(self) -> super::types::BillingModeSummary {
        super::types::BillingModeSummary {
