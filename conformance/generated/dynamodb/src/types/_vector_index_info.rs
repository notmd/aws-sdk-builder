...
impl VectorIndexInfo {
    ...
    pub fn builder() -> super::types::builders::VectorIndexInfoBuilder {
        super::types::builders::VectorIndexInfoBuilder::default()
    }
}
...
impl VectorIndexInfoBuilder {
    ...
    pub fn build(self) -> super::types::VectorIndexInfo {
        super::types::VectorIndexInfo {
