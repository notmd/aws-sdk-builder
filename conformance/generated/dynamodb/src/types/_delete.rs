...
impl Delete {
    ...
    pub fn builder() -> super::types::builders::DeleteBuilder {
        super::types::builders::DeleteBuilder::default()
    }
}
...
impl DeleteBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::Delete, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::Delete {
