...
impl ::aws_types::request_id::RequestId for super::types::error::TransactionInProgressException {
...
impl TransactionInProgressException {
    ...
    pub fn builder() -> super::types::error::builders::TransactionInProgressExceptionBuilder {
        super::types::error::builders::TransactionInProgressExceptionBuilder::default()
    }
}
...
impl TransactionInProgressExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::TransactionInProgressException {
        super::types::error::TransactionInProgressException {
