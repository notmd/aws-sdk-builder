...
impl TransactionInProgressException {
    /// Creates a new builder-style object to manufacture [`TransactionInProgressException`](crate::types::TransactionInProgressException).
    pub fn builder() -> crate::types::builders::TransactionInProgressExceptionBuilder {
        crate::types::builders::TransactionInProgressExceptionBuilder::default()
    }
}

/// A builder for [`TransactionInProgressException`](crate::types::TransactionInProgressException).
...
impl TransactionInProgressExceptionBuilder {
    ...
    /// Consumes the builder and constructs a [`TransactionInProgressException`](crate::types::TransactionInProgressException).
    pub fn build(self) -> crate::types::TransactionInProgressException {
        crate::types::TransactionInProgressException {
