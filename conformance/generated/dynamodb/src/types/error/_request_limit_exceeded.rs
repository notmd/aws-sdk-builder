...
impl ::aws_types::request_id::RequestId for super::types::error::RequestLimitExceeded {
...
impl RequestLimitExceeded {
    ...
    pub fn builder() -> super::types::error::builders::RequestLimitExceededBuilder {
        super::types::error::builders::RequestLimitExceededBuilder::default()
    }
}
...
impl RequestLimitExceededBuilder {
    ...
    pub fn build(self) -> super::types::error::RequestLimitExceeded {
        super::types::error::RequestLimitExceeded {
