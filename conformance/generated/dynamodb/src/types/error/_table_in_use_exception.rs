...
impl ::aws_types::request_id::RequestId for super::types::error::TableInUseException {
...
impl TableInUseException {
    ...
    pub fn builder() -> super::types::error::builders::TableInUseExceptionBuilder {
        super::types::error::builders::TableInUseExceptionBuilder::default()
    }
}
...
impl TableInUseExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::TableInUseException {
        super::types::error::TableInUseException {
