...
impl ::aws_types::request_id::RequestId for super::types::error::ConditionalCheckFailedException {
...
impl ConditionalCheckFailedException {
    ...
    pub fn builder() -> super::types::error::builders::ConditionalCheckFailedExceptionBuilder {
        super::types::error::builders::ConditionalCheckFailedExceptionBuilder::default()
    }
}
...
impl ConditionalCheckFailedExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::ConditionalCheckFailedException {
        super::types::error::ConditionalCheckFailedException {
