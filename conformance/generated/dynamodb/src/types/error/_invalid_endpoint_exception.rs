...
impl ::aws_types::request_id::RequestId for super::types::error::InvalidEndpointException {
...
impl InvalidEndpointException {
    ...
    pub fn builder() -> super::types::error::builders::InvalidEndpointExceptionBuilder {
        super::types::error::builders::InvalidEndpointExceptionBuilder::default()
    }
}
...
impl InvalidEndpointExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::InvalidEndpointException {
        super::types::error::InvalidEndpointException {
