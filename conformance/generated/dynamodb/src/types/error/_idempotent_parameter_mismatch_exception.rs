...
impl ::aws_types::request_id::RequestId for super::types::error::IdempotentParameterMismatchException {
...
impl IdempotentParameterMismatchException {
    ...
    pub fn builder() -> super::types::error::builders::IdempotentParameterMismatchExceptionBuilder {
        super::types::error::builders::IdempotentParameterMismatchExceptionBuilder::default()
    }
}
...
impl IdempotentParameterMismatchExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::IdempotentParameterMismatchException {
        super::types::error::IdempotentParameterMismatchException {
