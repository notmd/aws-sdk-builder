...
impl TransactionCanceledException {
    /// Creates a new builder-style object to manufacture [`TransactionCanceledException`](crate::types::TransactionCanceledException).
    pub fn builder() -> crate::types::builders::TransactionCanceledExceptionBuilder {
        crate::types::builders::TransactionCanceledExceptionBuilder::default()
    }
}

/// A builder for [`TransactionCanceledException`](crate::types::TransactionCanceledException).
...
impl TransactionCanceledExceptionBuilder {
    ...
    pub fn set_cancellation_reasons(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::CancellationReason>>) -> Self { self.cancellation_reasons = input; self }
    /// <p>A list of cancellation reasons.</p>
    pub fn get_cancellation_reasons(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::CancellationReason>> { &self.cancellation_reasons }
    /// Consumes the builder and constructs a [`TransactionCanceledException`](crate::types::TransactionCanceledException).
    pub fn build(self) -> crate::types::TransactionCanceledException {
        crate::types::TransactionCanceledException {
