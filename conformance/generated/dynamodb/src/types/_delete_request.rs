...
impl DeleteRequest {
    ...
    pub fn builder() -> super::types::builders::DeleteRequestBuilder {
        super::types::builders::DeleteRequestBuilder::default()
    }
}
...
impl DeleteRequestBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::DeleteRequest, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::DeleteRequest {
