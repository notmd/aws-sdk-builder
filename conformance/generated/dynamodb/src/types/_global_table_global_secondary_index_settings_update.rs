...
impl GlobalTableGlobalSecondaryIndexSettingsUpdateBuilder {
    ...
    pub fn set_provisioned_write_capacity_auto_scaling_settings_update(mut self, input: ::std::option::Option<crate::types::AutoScalingSettingsUpdate>) -> Self { self.provisioned_write_capacity_auto_scaling_settings_update = input; self }
    /// <p>Auto scaling settings for managing a global secondary index's write capacity units.</p>
    pub fn get_provisioned_write_capacity_auto_scaling_settings_update(&self) -> &::std::option::Option<crate::types::AutoScalingSettingsUpdate> { &self.provisioned_write_capacity_auto_scaling_settings_update }
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::GlobalTableGlobalSecondaryIndexSettingsUpdate, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::GlobalTableGlobalSecondaryIndexSettingsUpdate {
            index_name: self.index_name.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("index_name", "index_name was not specified but it is required when building GlobalTableGlobalSecondaryIndexSettingsUpdate"))?,
