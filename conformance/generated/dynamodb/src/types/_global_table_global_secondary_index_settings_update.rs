...
pub struct GlobalTableGlobalSecondaryIndexSettingsUpdate {
    ...
    pub provisioned_write_capacity_auto_scaling_settings_update: ::std::option::Option<super::types::AutoScalingSettingsUpdate>,
}
impl GlobalTableGlobalSecondaryIndexSettingsUpdate {
    ...
    /// <p>Auto scaling settings for managing a global secondary index's write capacity units.</p>
    pub fn provisioned_write_capacity_auto_scaling_settings_update(&self) -> ::std::option::Option<&super::types::AutoScalingSettingsUpdate> {
...
impl GlobalTableGlobalSecondaryIndexSettingsUpdate {
    ...
    pub fn builder() -> super::types::builders::GlobalTableGlobalSecondaryIndexSettingsUpdateBuilder {
        super::types::builders::GlobalTableGlobalSecondaryIndexSettingsUpdateBuilder::default()
    }
}
...
pub struct GlobalTableGlobalSecondaryIndexSettingsUpdateBuilder {
    ...
    pub(crate) provisioned_write_capacity_auto_scaling_settings_update: ::std::option::Option<super::types::AutoScalingSettingsUpdate>,
}
impl GlobalTableGlobalSecondaryIndexSettingsUpdateBuilder {
    ...
    /// <p>Auto scaling settings for managing a global secondary index's write capacity units.</p>
    pub fn provisioned_write_capacity_auto_scaling_settings_update(mut self, input: super::types::AutoScalingSettingsUpdate) -> Self {
    ...
    /// <p>Auto scaling settings for managing a global secondary index's write capacity units.</p>
    pub fn get_provisioned_write_capacity_auto_scaling_settings_update(&self) -> &::std::option::Option<super::types::AutoScalingSettingsUpdate> {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::types::GlobalTableGlobalSecondaryIndexSettingsUpdate, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::GlobalTableGlobalSecondaryIndexSettingsUpdate {
