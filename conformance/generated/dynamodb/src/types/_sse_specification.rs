...
impl SseSpecification {
    ...
    pub fn builder() -> super::types::builders::SseSpecificationBuilder {
        super::types::builders::SseSpecificationBuilder::default()
    }
}
...
impl SseSpecificationBuilder {
    ...
    pub fn build(self) -> super::types::SseSpecification {
        super::types::SseSpecification {
