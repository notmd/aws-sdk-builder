...
pub struct ReplicaSettingsUpdate {
    ...
    pub replica_provisioned_read_capacity_auto_scaling_settings_update: ::std::option::Option<super::types::AutoScalingSettingsUpdate>,
    /// <p>Represents the settings of a global secondary index for a global table that will be modified.</p>
    pub replica_global_secondary_index_settings_update:
        ::std::option::Option<::std::vec::Vec<super::types::ReplicaGlobalSecondaryIndexSettingsUpdate>>,
    /// <p>Replica-specific table class. If not specified, uses the source table's table class.</p>
    pub replica_table_class: ::std::option::Option<super::types::TableClass>,
}
impl ReplicaSettingsUpdate {
    ...
    /// <p>Auto scaling settings for managing a global table replica's read capacity units.</p>
    pub fn replica_provisioned_read_capacity_auto_scaling_settings_update(&self) -> ::std::option::Option<&super::types::AutoScalingSettingsUpdate> {
    ...
    pub fn replica_global_secondary_index_settings_update(&self) -> &[super::types::ReplicaGlobalSecondaryIndexSettingsUpdate] {
        self.replica_global_secondary_index_settings_update.as_deref().unwrap_or_default()
    }
    /// <p>Replica-specific table class. If not specified, uses the source table's table class.</p>
    pub fn replica_table_class(&self) -> ::std::option::Option<&super::types::TableClass> {
...
impl ReplicaSettingsUpdate {
    ...
    pub fn builder() -> super::types::builders::ReplicaSettingsUpdateBuilder {
        super::types::builders::ReplicaSettingsUpdateBuilder::default()
    }
}
...
pub struct ReplicaSettingsUpdateBuilder {
    ...
    pub(crate) replica_provisioned_read_capacity_auto_scaling_settings_update: ::std::option::Option<super::types::AutoScalingSettingsUpdate>,
    pub(crate) replica_global_secondary_index_settings_update:
        ::std::option::Option<::std::vec::Vec<super::types::ReplicaGlobalSecondaryIndexSettingsUpdate>>,
    pub(crate) replica_table_class: ::std::option::Option<super::types::TableClass>,
}
impl ReplicaSettingsUpdateBuilder {
    ...
    /// <p>Auto scaling settings for managing a global table replica's read capacity units.</p>
    pub fn replica_provisioned_read_capacity_auto_scaling_settings_update(mut self, input: super::types::AutoScalingSettingsUpdate) -> Self {
    ...
    ///
    /// <p>Represents the settings of a global secondary index for a global table that will be modified.</p>
    pub fn replica_global_secondary_index_settings_update(mut self, input: super::types::ReplicaGlobalSecondaryIndexSettingsUpdate) -> Self {
    ...
    pub fn set_replica_global_secondary_index_settings_update(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::ReplicaGlobalSecondaryIndexSettingsUpdate>>,
    ) -> Self {
    ...
    /// <p>Replica-specific table class. If not specified, uses the source table's table class.</p>
    pub fn replica_table_class(mut self, input: super::types::TableClass) -> Self {
        self.replica_table_class = ::std::option::Option::Some(input);
        self
    }
    /// <p>Replica-specific table class. If not specified, uses the source table's table class.</p>
    pub fn set_replica_table_class(mut self, input: ::std::option::Option<super::types::TableClass>) -> Self {
        self.replica_table_class = input;
        self
    }
    /// <p>Replica-specific table class. If not specified, uses the source table's table class.</p>
    pub fn get_replica_table_class(&self) -> &::std::option::Option<super::types::TableClass> {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::ReplicaSettingsUpdate, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ReplicaSettingsUpdate {
