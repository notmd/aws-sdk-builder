...
impl GlobalSecondaryIndexInfo {
    ...
    pub fn builder() -> super::types::builders::GlobalSecondaryIndexInfoBuilder {
        super::types::builders::GlobalSecondaryIndexInfoBuilder::default()
    }
}
...
impl GlobalSecondaryIndexInfoBuilder {
    ...
    pub fn build(self) -> super::types::GlobalSecondaryIndexInfo {
        super::types::GlobalSecondaryIndexInfo {
