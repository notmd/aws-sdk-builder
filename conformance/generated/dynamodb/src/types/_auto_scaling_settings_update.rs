...
pub struct AutoScalingSettingsUpdate {
    ...
    pub scaling_policy_update: ::std::option::Option<super::types::AutoScalingPolicyUpdate>,
}
impl AutoScalingSettingsUpdate {
    ...
    /// <p>The scaling policy to apply for scaling target global table or global secondary index capacity units.</p>
    pub fn scaling_policy_update(&self) -> ::std::option::Option<&super::types::AutoScalingPolicyUpdate> {
...
impl AutoScalingSettingsUpdate {
    ...
    pub fn builder() -> super::types::builders::AutoScalingSettingsUpdateBuilder {
        super::types::builders::AutoScalingSettingsUpdateBuilder::default()
    }
}
...
pub struct AutoScalingSettingsUpdateBuilder {
    ...
    pub(crate) scaling_policy_update: ::std::option::Option<super::types::AutoScalingPolicyUpdate>,
}
impl AutoScalingSettingsUpdateBuilder {
    ...
    /// <p>The scaling policy to apply for scaling target global table or global secondary index capacity units.</p>
    pub fn scaling_policy_update(mut self, input: super::types::AutoScalingPolicyUpdate) -> Self {
        self.scaling_policy_update = ::std::option::Option::Some(input);
        self
    }
    /// <p>The scaling policy to apply for scaling target global table or global secondary index capacity units.</p>
    pub fn set_scaling_policy_update(mut self, input: ::std::option::Option<super::types::AutoScalingPolicyUpdate>) -> Self {
        self.scaling_policy_update = input;
        self
    }
    /// <p>The scaling policy to apply for scaling target global table or global secondary index capacity units.</p>
    pub fn get_scaling_policy_update(&self) -> &::std::option::Option<super::types::AutoScalingPolicyUpdate> {
    ...
    pub fn build(self) -> super::types::AutoScalingSettingsUpdate {
        super::types::AutoScalingSettingsUpdate {
