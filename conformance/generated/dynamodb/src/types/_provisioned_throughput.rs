...
impl ProvisionedThroughput {
    ...
    pub fn builder() -> super::types::builders::ProvisionedThroughputBuilder {
        super::types::builders::ProvisionedThroughputBuilder::default()
    }
}
...
impl ProvisionedThroughputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::ProvisionedThroughput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ProvisionedThroughput {
