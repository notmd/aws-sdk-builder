...
pub struct ReplicaAutoScalingUpdate {
    ...
    pub replica_global_secondary_index_updates: ::std::option::Option<::std::vec::Vec<super::types::ReplicaGlobalSecondaryIndexAutoScalingUpdate>>,
    /// <p>Represents the auto scaling settings to be modified for a global table or global secondary index.</p>
    pub replica_provisioned_read_capacity_auto_scaling_update: ::std::option::Option<super::types::AutoScalingSettingsUpdate>,
}
impl ReplicaAutoScalingUpdate {
    ...
    pub fn replica_global_secondary_index_updates(&self) -> &[super::types::ReplicaGlobalSecondaryIndexAutoScalingUpdate] {
        self.replica_global_secondary_index_updates.as_deref().unwrap_or_default()
    }
    /// <p>Represents the auto scaling settings to be modified for a global table or global secondary index.</p>
    pub fn replica_provisioned_read_capacity_auto_scaling_update(&self) -> ::std::option::Option<&super::types::AutoScalingSettingsUpdate> {
...
impl ReplicaAutoScalingUpdate {
    ...
    pub fn builder() -> super::types::builders::ReplicaAutoScalingUpdateBuilder {
        super::types::builders::ReplicaAutoScalingUpdateBuilder::default()
    }
}
...
pub struct ReplicaAutoScalingUpdateBuilder {
    ...
    pub(crate) replica_global_secondary_index_updates:
        ::std::option::Option<::std::vec::Vec<super::types::ReplicaGlobalSecondaryIndexAutoScalingUpdate>>,
    pub(crate) replica_provisioned_read_capacity_auto_scaling_update: ::std::option::Option<super::types::AutoScalingSettingsUpdate>,
}
impl ReplicaAutoScalingUpdateBuilder {
    ...
    ///
    /// <p>Represents the auto scaling settings of global secondary indexes that will be modified.</p>
    pub fn replica_global_secondary_index_updates(mut self, input: super::types::ReplicaGlobalSecondaryIndexAutoScalingUpdate) -> Self {
    ...
    pub fn set_replica_global_secondary_index_updates(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::ReplicaGlobalSecondaryIndexAutoScalingUpdate>>,
    ) -> Self {
    ...
    /// <p>Represents the auto scaling settings to be modified for a global table or global secondary index.</p>
    pub fn replica_provisioned_read_capacity_auto_scaling_update(mut self, input: super::types::AutoScalingSettingsUpdate) -> Self {
    ...
    /// <p>Represents the auto scaling settings to be modified for a global table or global secondary index.</p>
    pub fn get_replica_provisioned_read_capacity_auto_scaling_update(&self) -> &::std::option::Option<super::types::AutoScalingSettingsUpdate> {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::ReplicaAutoScalingUpdate, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ReplicaAutoScalingUpdate {
