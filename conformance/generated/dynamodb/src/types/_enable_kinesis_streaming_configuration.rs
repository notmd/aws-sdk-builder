...
impl EnableKinesisStreamingConfiguration {
    ...
    pub fn builder() -> super::types::builders::EnableKinesisStreamingConfigurationBuilder {
        super::types::builders::EnableKinesisStreamingConfigurationBuilder::default()
    }
}
...
impl EnableKinesisStreamingConfigurationBuilder {
    ...
    pub fn build(self) -> super::types::EnableKinesisStreamingConfiguration {
        super::types::EnableKinesisStreamingConfiguration {
