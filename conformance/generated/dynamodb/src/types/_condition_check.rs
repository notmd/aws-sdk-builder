...
impl ConditionCheck {
    ...
    pub fn builder() -> super::types::builders::ConditionCheckBuilder {
        super::types::builders::ConditionCheckBuilder::default()
    }
}
...
impl ConditionCheckBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::ConditionCheck, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ConditionCheck {
