...
impl CreateReplicationGroupMemberAction {
    ...
    pub fn builder() -> super::types::builders::CreateReplicationGroupMemberActionBuilder {
        super::types::builders::CreateReplicationGroupMemberActionBuilder::default()
    }
}
...
impl CreateReplicationGroupMemberActionBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::CreateReplicationGroupMemberAction, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::CreateReplicationGroupMemberAction {
