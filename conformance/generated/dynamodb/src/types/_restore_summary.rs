...
impl RestoreSummary {
    ...
    pub fn builder() -> super::types::builders::RestoreSummaryBuilder {
        super::types::builders::RestoreSummaryBuilder::default()
    }
}
...
impl RestoreSummaryBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::RestoreSummary, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::RestoreSummary {
