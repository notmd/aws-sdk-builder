...
impl DeleteGlobalSecondaryIndexAction {
    ...
    pub fn builder() -> super::types::builders::DeleteGlobalSecondaryIndexActionBuilder {
        super::types::builders::DeleteGlobalSecondaryIndexActionBuilder::default()
    }
}
...
impl DeleteGlobalSecondaryIndexActionBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::DeleteGlobalSecondaryIndexAction, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::DeleteGlobalSecondaryIndexAction {
