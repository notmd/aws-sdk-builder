...
impl BackupDescriptionBuilder {
    ...
    pub fn set_source_table_details(mut self, input: ::std::option::Option<crate::types::SourceTableDetails>) -> Self { self.source_table_details = input; self }
    /// <p>Contains the details of the table when the backup was created.</p>
    pub fn get_source_table_details(&self) -> &::std::option::Option<crate::types::SourceTableDetails> { &self.source_table_details }
    /// <p>Contains the details of the features enabled on the table when the backup was created. For example, LSIs, GSIs, streams, TTL.</p>
    ...
    pub fn set_source_table_feature_details(mut self, input: ::std::option::Option<crate::types::SourceTableFeatureDetails>) -> Self { self.source_table_feature_details = input; self }
    /// <p>Contains the details of the features enabled on the table when the backup was created. For example, LSIs, GSIs, streams, TTL.</p>
    pub fn get_source_table_feature_details(&self) -> &::std::option::Option<crate::types::SourceTableFeatureDetails> { &self.source_table_feature_details }
