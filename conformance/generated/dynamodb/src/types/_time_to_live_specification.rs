...
impl TimeToLiveSpecification {
    ...
    pub fn builder() -> super::types::builders::TimeToLiveSpecificationBuilder {
        super::types::builders::TimeToLiveSpecificationBuilder::default()
    }
}
...
impl TimeToLiveSpecificationBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::TimeToLiveSpecification, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::TimeToLiveSpecification {
