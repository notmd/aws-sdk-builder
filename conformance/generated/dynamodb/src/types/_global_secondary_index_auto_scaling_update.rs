...
impl GlobalSecondaryIndexAutoScalingUpdate {
    ...
    pub fn builder() -> super::types::builders::GlobalSecondaryIndexAutoScalingUpdateBuilder {
        super::types::builders::GlobalSecondaryIndexAutoScalingUpdateBuilder::default()
    }
}
...
impl GlobalSecondaryIndexAutoScalingUpdateBuilder {
    ...
    pub fn build(self) -> super::types::GlobalSecondaryIndexAutoScalingUpdate {
        super::types::GlobalSecondaryIndexAutoScalingUpdate {
