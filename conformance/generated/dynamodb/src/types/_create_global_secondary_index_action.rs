...
impl CreateGlobalSecondaryIndexAction {
    ...
    pub fn builder() -> super::types::builders::CreateGlobalSecondaryIndexActionBuilder {
        super::types::builders::CreateGlobalSecondaryIndexActionBuilder::default()
    }
}
...
impl CreateGlobalSecondaryIndexActionBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::CreateGlobalSecondaryIndexAction, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::CreateGlobalSecondaryIndexAction {
