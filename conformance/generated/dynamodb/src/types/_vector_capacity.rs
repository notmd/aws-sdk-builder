...
impl VectorCapacity {
    ...
    pub fn builder() -> super::types::builders::VectorCapacityBuilder {
        super::types::builders::VectorCapacityBuilder::default()
    }
}
...
impl VectorCapacityBuilder {
    ...
    pub fn build(self) -> super::types::VectorCapacity {
        super::types::VectorCapacity {
