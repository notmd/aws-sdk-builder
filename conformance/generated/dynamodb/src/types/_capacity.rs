...
impl Capacity {
    ...
    pub fn builder() -> super::types::builders::CapacityBuilder {
        super::types::builders::CapacityBuilder::default()
    }
}
...
impl CapacityBuilder {
    ...
    pub fn build(self) -> super::types::Capacity {
        super::types::Capacity {
