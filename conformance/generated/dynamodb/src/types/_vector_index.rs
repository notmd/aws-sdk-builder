...
impl VectorIndex {
    ...
    pub fn builder() -> super::types::builders::VectorIndexBuilder {
        super::types::builders::VectorIndexBuilder::default()
    }
}
...
impl VectorIndexBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::VectorIndex, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::VectorIndex {
