...
impl PointInTimeRecoverySpecification {
    ...
    pub fn builder() -> super::types::builders::PointInTimeRecoverySpecificationBuilder {
        super::types::builders::PointInTimeRecoverySpecificationBuilder::default()
    }
}
...
impl PointInTimeRecoverySpecificationBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::PointInTimeRecoverySpecification, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::PointInTimeRecoverySpecification {
