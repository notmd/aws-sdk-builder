...
pub struct StreamSpecification {
    ...
    /// </ul>
    pub stream_view_type: ::std::option::Option<super::types::StreamViewType>,
}
impl StreamSpecification {
    ...
    /// <p><code>NEW_AND_OLD_IMAGES</code> - Both the new and the old item images of the item are written to the stream.</p></li>
    /// </ul>
    pub fn stream_view_type(&self) -> ::std::option::Option<&super::types::StreamViewType> {
...
impl StreamSpecification {
    ...
    pub fn builder() -> super::types::builders::StreamSpecificationBuilder {
        super::types::builders::StreamSpecificationBuilder::default()
    }
}
...
pub struct StreamSpecificationBuilder {
    ...
    pub(crate) stream_view_type: ::std::option::Option<super::types::StreamViewType>,
}
impl StreamSpecificationBuilder {
    ...
    /// <p><code>NEW_AND_OLD_IMAGES</code> - Both the new and the old item images of the item are written to the stream.</p></li>
    /// </ul>
    pub fn stream_view_type(mut self, input: super::types::StreamViewType) -> Self {
    ...
    /// <p><code>NEW_AND_OLD_IMAGES</code> - Both the new and the old item images of the item are written to the stream.</p></li>
    /// </ul>
    pub fn set_stream_view_type(mut self, input: ::std::option::Option<super::types::StreamViewType>) -> Self {
    ...
    /// <p><code>NEW_AND_OLD_IMAGES</code> - Both the new and the old item images of the item are written to the stream.</p></li>
    /// </ul>
    pub fn get_stream_view_type(&self) -> &::std::option::Option<super::types::StreamViewType> {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::StreamSpecification, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::StreamSpecification {
