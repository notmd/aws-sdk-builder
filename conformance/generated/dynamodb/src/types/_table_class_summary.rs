...
impl TableClassSummary {
    ...
    pub fn builder() -> super::types::builders::TableClassSummaryBuilder {
        super::types::builders::TableClassSummaryBuilder::default()
    }
}
...
impl TableClassSummaryBuilder {
    ...
    pub fn build(self) -> super::types::TableClassSummary {
        super::types::TableClassSummary {
