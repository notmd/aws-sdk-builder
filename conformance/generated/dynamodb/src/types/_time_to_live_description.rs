...
pub struct TimeToLiveDescription {
    ...
    pub time_to_live_status: ::std::option::Option<super::types::TimeToLiveStatus>,
    /// <p>The name of the TTL attribute for items in the table.</p>
    pub attribute_name: ::std::option::Option<::std::string::String>,
}
impl TimeToLiveDescription {
    /// <p>The TTL status for the table.</p>
    pub fn time_to_live_status(&self) -> ::std::option::Option<&super::types::TimeToLiveStatus> {
...
impl TimeToLiveDescription {
    ...
    pub fn builder() -> super::types::builders::TimeToLiveDescriptionBuilder {
        super::types::builders::TimeToLiveDescriptionBuilder::default()
    }
}
...
pub struct TimeToLiveDescriptionBuilder {
    pub(crate) time_to_live_status: ::std::option::Option<super::types::TimeToLiveStatus>,
    pub(crate) attribute_name: ::std::option::Option<::std::string::String>,
}
impl TimeToLiveDescriptionBuilder {
    /// <p>The TTL status for the table.</p>
    pub fn time_to_live_status(mut self, input: super::types::TimeToLiveStatus) -> Self {
        self.time_to_live_status = ::std::option::Option::Some(input);
        self
    }
    /// <p>The TTL status for the table.</p>
    pub fn set_time_to_live_status(mut self, input: ::std::option::Option<super::types::TimeToLiveStatus>) -> Self {
        self.time_to_live_status = input;
        self
    }
    /// <p>The TTL status for the table.</p>
    pub fn get_time_to_live_status(&self) -> &::std::option::Option<super::types::TimeToLiveStatus> {
    ...
    pub fn build(self) -> super::types::TimeToLiveDescription {
        super::types::TimeToLiveDescription {
