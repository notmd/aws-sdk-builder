...
impl ProvisionedThroughputOverride {
    ...
    pub fn builder() -> super::types::builders::ProvisionedThroughputOverrideBuilder {
        super::types::builders::ProvisionedThroughputOverrideBuilder::default()
    }
}
...
impl ProvisionedThroughputOverrideBuilder {
    ...
    pub fn build(self) -> super::types::ProvisionedThroughputOverride {
        super::types::ProvisionedThroughputOverride {
