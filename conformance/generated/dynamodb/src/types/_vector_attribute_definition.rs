...
impl VectorAttributeDefinition {
    ...
    pub fn builder() -> super::types::builders::VectorAttributeDefinitionBuilder {
        super::types::builders::VectorAttributeDefinitionBuilder::default()
    }
}
...
impl VectorAttributeDefinitionBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::VectorAttributeDefinition, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::VectorAttributeDefinition {
