...
impl AutoScalingTargetTrackingScalingPolicyConfigurationUpdateBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::AutoScalingTargetTrackingScalingPolicyConfigurationUpdate, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::AutoScalingTargetTrackingScalingPolicyConfigurationUpdate {
            ...
            target_value: self.target_value.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("target_value", "target_value was not specified but it is required when building AutoScalingTargetTrackingScalingPolicyConfigurationUpdate"))?,
        })
    }
}
