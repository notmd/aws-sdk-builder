...
pub struct ReplicaGlobalSecondaryIndexSettingsUpdate {
    ...
    pub provisioned_read_capacity_auto_scaling_settings_update: ::std::option::Option<super::types::AutoScalingSettingsUpdate>,
}
impl ReplicaGlobalSecondaryIndexSettingsUpdate {
    ...
    /// <p>Auto scaling settings for managing a global secondary index replica's read capacity units.</p>
    pub fn provisioned_read_capacity_auto_scaling_settings_update(&self) -> ::std::option::Option<&super::types::AutoScalingSettingsUpdate> {
...
impl ReplicaGlobalSecondaryIndexSettingsUpdate {
    ...
    pub fn builder() -> super::types::builders::ReplicaGlobalSecondaryIndexSettingsUpdateBuilder {
        super::types::builders::ReplicaGlobalSecondaryIndexSettingsUpdateBuilder::default()
    }
}
...
pub struct ReplicaGlobalSecondaryIndexSettingsUpdateBuilder {
    ...
    pub(crate) provisioned_read_capacity_auto_scaling_settings_update: ::std::option::Option<super::types::AutoScalingSettingsUpdate>,
}
impl ReplicaGlobalSecondaryIndexSettingsUpdateBuilder {
    ...
    /// <p>Auto scaling settings for managing a global secondary index replica's read capacity units.</p>
    pub fn provisioned_read_capacity_auto_scaling_settings_update(mut self, input: super::types::AutoScalingSettingsUpdate) -> Self {
    ...
    /// <p>Auto scaling settings for managing a global secondary index replica's read capacity units.</p>
    pub fn get_provisioned_read_capacity_auto_scaling_settings_update(&self) -> &::std::option::Option<super::types::AutoScalingSettingsUpdate> {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::types::ReplicaGlobalSecondaryIndexSettingsUpdate, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ReplicaGlobalSecondaryIndexSettingsUpdate {
