...
pub struct BatchStatementError {
    ...
    pub code: ::std::option::Option<super::types::BatchStatementErrorCodeEnum>,
...
impl BatchStatementError {
    /// <p>The error code associated with the failed PartiQL batch statement.</p>
    pub fn code(&self) -> ::std::option::Option<&super::types::BatchStatementErrorCodeEnum> {
        self.code.as_ref()
    }
    /// <p>The error message associated with the PartiQL batch response.</p>
...
impl BatchStatementError {
    ...
    pub fn builder() -> super::types::builders::BatchStatementErrorBuilder {
        super::types::builders::BatchStatementErrorBuilder::default()
    }
}
...
pub struct BatchStatementErrorBuilder {
    pub(crate) code: ::std::option::Option<super::types::BatchStatementErrorCodeEnum>,
...
impl BatchStatementErrorBuilder {
    /// <p>The error code associated with the failed PartiQL batch statement.</p>
    pub fn code(mut self, input: super::types::BatchStatementErrorCodeEnum) -> Self {
        self.code = ::std::option::Option::Some(input);
        self
    }
    /// <p>The error code associated with the failed PartiQL batch statement.</p>
    pub fn set_code(mut self, input: ::std::option::Option<super::types::BatchStatementErrorCodeEnum>) -> Self {
        self.code = input;
        self
    }
    /// <p>The error code associated with the failed PartiQL batch statement.</p>
    pub fn get_code(&self) -> &::std::option::Option<super::types::BatchStatementErrorCodeEnum> {
        &self.code
    }
    /// <p>The error message associated with the PartiQL batch response.</p>
    ...
    pub fn build(self) -> super::types::BatchStatementError {
        super::types::BatchStatementError {
            code: self.code,
