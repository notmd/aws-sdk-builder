...
pub struct TransactGetItem {
    ...
    pub get: ::std::option::Option<super::types::Get>,
}
impl TransactGetItem {
    /// <p>Contains the primary key that identifies the item to get, together with the name of the table that contains the item, and optionally the specific attributes of the item to retrieve.</p>
    pub fn get(&self) -> ::std::option::Option<&super::types::Get> {
        self.get.as_ref()
    }
}
impl TransactGetItem {
    /// Creates a new builder-style object to manufacture [`TransactGetItem`](crate::types::TransactGetItem).
    pub fn builder() -> super::types::builders::TransactGetItemBuilder {
        super::types::builders::TransactGetItemBuilder::default()
    }
}
...
pub struct TransactGetItemBuilder {
    pub(crate) get: ::std::option::Option<super::types::Get>,
}
impl TransactGetItemBuilder {
    /// <p>Contains the primary key that identifies the item to get, together with the name of the table that contains the item, and optionally the specific attributes of the item to retrieve.</p>
    /// This field is required.
    pub fn get(mut self, input: super::types::Get) -> Self {
        self.get = ::std::option::Option::Some(input);
        self
    }
    /// <p>Contains the primary key that identifies the item to get, together with the name of the table that contains the item, and optionally the specific attributes of the item to retrieve.</p>
    pub fn set_get(mut self, input: ::std::option::Option<super::types::Get>) -> Self {
        self.get = input;
        self
    }
    /// <p>Contains the primary key that identifies the item to get, together with the name of the table that contains the item, and optionally the specific attributes of the item to retrieve.</p>
    pub fn get_get(&self) -> &::std::option::Option<super::types::Get> {
        &self.get
    }
    /// Consumes the builder and constructs a [`TransactGetItem`](crate::types::TransactGetItem).
    pub fn build(self) -> super::types::TransactGetItem {
        super::types::TransactGetItem { get: self.get }
    }
}
