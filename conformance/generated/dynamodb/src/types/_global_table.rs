...
impl GlobalTable {
    ...
    pub fn builder() -> super::types::builders::GlobalTableBuilder {
        super::types::builders::GlobalTableBuilder::default()
    }
}
...
impl GlobalTableBuilder {
    ...
    pub fn build(self) -> super::types::GlobalTable {
        super::types::GlobalTable {
