...
impl DeleteGlobalTableWitnessGroupMemberAction {
    ...
    pub fn builder() -> super::types::builders::DeleteGlobalTableWitnessGroupMemberActionBuilder {
        super::types::builders::DeleteGlobalTableWitnessGroupMemberActionBuilder::default()
    }
}
...
impl DeleteGlobalTableWitnessGroupMemberActionBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::types::DeleteGlobalTableWitnessGroupMemberAction, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::DeleteGlobalTableWitnessGroupMemberAction {
