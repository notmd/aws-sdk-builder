...
impl SourceTableFeatureDetailsBuilder {
    ...
    pub fn set_local_secondary_indexes(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::LocalSecondaryIndexInfo>>) -> Self { self.local_secondary_indexes = input; self }
    /// <p>Represents the LSI properties for the table when the backup was created. It includes the IndexName, KeySchema and Projection for the LSIs on the table at the time of backup.</p>
    pub fn get_local_secondary_indexes(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::LocalSecondaryIndexInfo>> { &self.local_secondary_indexes }
    /// <p>Represents the GSI properties for the table when the backup was created. It includes the IndexName, KeySchema, Projection, and ProvisionedThroughput for the GSIs on the table at the time of backup.</p>
    ...
    pub fn set_global_secondary_indexes(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::GlobalSecondaryIndexInfo>>) -> Self { self.global_secondary_indexes = input; self }
    /// <p>Represents the GSI properties for the table when the backup was created. It includes the IndexName, KeySchema, Projection, and ProvisionedThroughput for the GSIs on the table at the time of backup.</p>
    pub fn get_global_secondary_indexes(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::GlobalSecondaryIndexInfo>> { &self.global_secondary_indexes }
    /// <p>Stream settings on the table when the backup was created.</p>
    ...
    pub fn set_stream_description(mut self, input: ::std::option::Option<crate::types::StreamSpecification>) -> Self { self.stream_description = input; self }
    /// <p>Stream settings on the table when the backup was created.</p>
    pub fn get_stream_description(&self) -> &::std::option::Option<crate::types::StreamSpecification> { &self.stream_description }
    /// <p>Time to Live settings on the table when the backup was created.</p>
    ...
    pub fn set_vector_indexes(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::VectorIndexInfo>>) -> Self { self.vector_indexes = input; self }
    /// <p>The vector index properties for the table at the time the backup was created, including the index name, vector attribute, dimensions, distance function, search schema, and projection.</p>
    pub fn get_vector_indexes(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::VectorIndexInfo>> { &self.vector_indexes }
