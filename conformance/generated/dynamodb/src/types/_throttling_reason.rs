...
impl ThrottlingReason {
    ...
    pub fn builder() -> super::types::builders::ThrottlingReasonBuilder {
        super::types::builders::ThrottlingReasonBuilder::default()
    }
}
...
impl ThrottlingReasonBuilder {
    ...
    pub fn build(self) -> super::types::ThrottlingReason {
        super::types::ThrottlingReason {
            reason: self.reason,
