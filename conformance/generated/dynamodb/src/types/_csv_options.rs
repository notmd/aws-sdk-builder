...
impl CsvOptions {
    ...
    pub fn builder() -> super::types::builders::CsvOptionsBuilder {
        super::types::builders::CsvOptionsBuilder::default()
    }
}
...
impl CsvOptionsBuilder {
    ...
    pub fn build(self) -> super::types::CsvOptions {
        super::types::CsvOptions {
