...
impl BackupDetailsBuilder {
    ...
    pub fn set_backup_size_bytes(mut self, input: ::std::option::Option<i64>) -> Self { self.backup_size_bytes = input; self }
    /// <p>Size of the backup in bytes. DynamoDB updates this value approximately every six hours. Recent changes might not be reflected in this value.</p>
    pub fn get_backup_size_bytes(&self) -> &::std::option::Option<i64> { &self.backup_size_bytes }
    /// <p>Backup can be in one of the following states: CREATING, ACTIVE, DELETED.</p>
    /// This field is required.
    ...
    pub fn set_backup_status(mut self, input: ::std::option::Option<crate::types::BackupStatus>) -> Self { self.backup_status = input; self }
    /// <p>Backup can be in one of the following states: CREATING, ACTIVE, DELETED.</p>
    pub fn get_backup_status(&self) -> &::std::option::Option<crate::types::BackupStatus> { &self.backup_status }
    /// <p>BackupType:</p><ul><li><p><code>USER</code> - You create and manage these using the on-demand backup feature.</p></li><li><p><code>SYSTEM</code> - If you delete a table with point-in-time recovery enabled, a <code>SYSTEM</code> backup is automatically created and is retained for 35 days (at no additional cost). System backups allow you to restore the deleted table to the state it was in just before the point of deletion.</p></li><li><p><code>AWS_BACKUP</code> - On-demand backup created by you from Backup service.</p></li></ul>
    /// This field is required.
    ...
    pub fn set_backup_type(mut self, input: ::std::option::Option<crate::types::BackupType>) -> Self { self.backup_type = input; self }
    /// <p>BackupType:</p><ul><li><p><code>USER</code> - You create and manage these using the on-demand backup feature.</p></li><li><p><code>SYSTEM</code> - If you delete a table with point-in-time recovery enabled, a <code>SYSTEM</code> backup is automatically created and is retained for 35 days (at no additional cost). System backups allow you to restore the deleted table to the state it was in just before the point of deletion.</p></li><li><p><code>AWS_BACKUP</code> - On-demand backup created by you from Backup service.</p></li></ul>
    pub fn get_backup_type(&self) -> &::std::option::Option<crate::types::BackupType> { &self.backup_type }
    /// <p>Time at which the backup was created. This is the request time of the backup.</p>
    /// This field is required.
    ...
    pub fn set_backup_creation_date_time(mut self, input: ::std::option::Option<::aws_smithy_types::DateTime>) -> Self { self.backup_creation_date_time = input; self }
    /// <p>Time at which the backup was created. This is the request time of the backup.</p>
    pub fn get_backup_creation_date_time(&self) -> &::std::option::Option<::aws_smithy_types::DateTime> { &self.backup_creation_date_time }
    /// <p>Time at which the automatic on-demand backup created by DynamoDB will expire. This <code>SYSTEM</code> on-demand backup expires automatically 35 days after its creation.</p>
    ...
    pub fn set_backup_expiry_date_time(mut self, input: ::std::option::Option<::aws_smithy_types::DateTime>) -> Self { self.backup_expiry_date_time = input; self }
    /// <p>Time at which the automatic on-demand backup created by DynamoDB will expire. This <code>SYSTEM</code> on-demand backup expires automatically 35 days after its creation.</p>
    pub fn get_backup_expiry_date_time(&self) -> &::std::option::Option<::aws_smithy_types::DateTime> { &self.backup_expiry_date_time }
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::BackupDetails, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::BackupDetails {
            backup_arn: self.backup_arn.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("backup_arn", "backup_arn was not specified but it is required when building BackupDetails"))?,
            backup_name: self.backup_name.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("backup_name", "backup_name was not specified but it is required when building BackupDetails"))?,
            backup_size_bytes: self.backup_size_bytes,
            backup_status: self.backup_status.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("backup_status", "backup_status was not specified but it is required when building BackupDetails"))?,
            backup_type: self.backup_type.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("backup_type", "backup_type was not specified but it is required when building BackupDetails"))?,
            backup_creation_date_time: self.backup_creation_date_time.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("backup_creation_date_time", "backup_creation_date_time was not specified but it is required when building BackupDetails"))?,
