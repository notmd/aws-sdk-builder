...
pub struct KinesisDataStreamDestination {
    ...
    pub approximate_creation_date_time_precision: ::std::option::Option<super::types::ApproximateCreationDateTimePrecision>,
}
impl KinesisDataStreamDestination {
    ...
    /// <p>The precision of the Kinesis data stream timestamp. The values are either <code>MILLISECOND</code> or <code>MICROSECOND</code>.</p>
    pub fn approximate_creation_date_time_precision(&self) -> ::std::option::Option<&super::types::ApproximateCreationDateTimePrecision> {
...
impl KinesisDataStreamDestination {
    ...
    pub fn builder() -> super::types::builders::KinesisDataStreamDestinationBuilder {
        super::types::builders::KinesisDataStreamDestinationBuilder::default()
    }
}
...
pub struct KinesisDataStreamDestinationBuilder {
    ...
    pub(crate) approximate_creation_date_time_precision: ::std::option::Option<super::types::ApproximateCreationDateTimePrecision>,
}
impl KinesisDataStreamDestinationBuilder {
    ...
    /// <p>The precision of the Kinesis data stream timestamp. The values are either <code>MILLISECOND</code> or <code>MICROSECOND</code>.</p>
    pub fn approximate_creation_date_time_precision(mut self, input: super::types::ApproximateCreationDateTimePrecision) -> Self {
    ...
    pub fn set_approximate_creation_date_time_precision(
        mut self,
        input: ::std::option::Option<super::types::ApproximateCreationDateTimePrecision>,
    ) -> Self {
        self.approximate_creation_date_time_precision = input;
        self
    }
    /// <p>The precision of the Kinesis data stream timestamp. The values are either <code>MILLISECOND</code> or <code>MICROSECOND</code>.</p>
    pub fn get_approximate_creation_date_time_precision(&self) -> &::std::option::Option<super::types::ApproximateCreationDateTimePrecision> {
    ...
    pub fn build(self) -> super::types::KinesisDataStreamDestination {
        super::types::KinesisDataStreamDestination {
