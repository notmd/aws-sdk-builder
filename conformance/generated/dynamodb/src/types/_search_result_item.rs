...
impl SearchResultItem {
    ...
    pub fn builder() -> super::types::builders::SearchResultItemBuilder {
        super::types::builders::SearchResultItemBuilder::default()
    }
}
...
impl SearchResultItemBuilder {
    ...
    pub fn build(self) -> super::types::SearchResultItem {
        super::types::SearchResultItem {
            item: self.item,
