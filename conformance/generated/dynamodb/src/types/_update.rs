...
impl Update {
    ...
    pub fn builder() -> super::types::builders::UpdateBuilder {
        super::types::builders::UpdateBuilder::default()
    }
}
...
impl UpdateBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::Update, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::Update {
