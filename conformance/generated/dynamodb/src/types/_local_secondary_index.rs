...
impl LocalSecondaryIndex {
    ...
    pub fn builder() -> super::types::builders::LocalSecondaryIndexBuilder {
        super::types::builders::LocalSecondaryIndexBuilder::default()
    }
}
...
impl LocalSecondaryIndexBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::LocalSecondaryIndex, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::LocalSecondaryIndex {
