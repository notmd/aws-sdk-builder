...
impl LocalSecondaryIndexBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::LocalSecondaryIndex, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::LocalSecondaryIndex {
            index_name: self.index_name.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("index_name", "index_name was not specified but it is required when building LocalSecondaryIndex"))?,
            key_schema: self.key_schema.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("key_schema", "key_schema was not specified but it is required when building LocalSecondaryIndex"))?,
