...
pub struct ImportTableDescription {
    ...
    pub import_status: ::std::option::Option<super::types::ImportStatus>,
    ...
    pub s3_bucket_source: ::std::option::Option<super::types::S3BucketSource>,
    ...
    pub input_format: ::std::option::Option<super::types::InputFormat>,
    /// <p>The format options for the data that was imported into the target table. There is one value, CsvOption.</p>
    pub input_format_options: ::std::option::Option<super::types::InputFormatOptions>,
    /// <p>The compression options for the data that has been imported into the target table. The values are NONE, GZIP, or ZSTD.</p>
    pub input_compression_type: ::std::option::Option<super::types::InputCompressionType>,
    /// <p>The parameters for the new table that is being imported into.</p>
    pub table_creation_parameters: ::std::option::Option<super::types::TableCreationParameters>,
...
impl ImportTableDescription {
    ...
    /// <p>The status of the import.</p>
    pub fn import_status(&self) -> ::std::option::Option<&super::types::ImportStatus> {
    ...
    /// <p>Values for the S3 bucket the source file is imported from. Includes bucket name (required), key prefix (optional) and bucket account owner ID (optional).</p>
    pub fn s3_bucket_source(&self) -> ::std::option::Option<&super::types::S3BucketSource> {
    ...
    /// <p>The format of the source data going into the target table.</p>
    pub fn input_format(&self) -> ::std::option::Option<&super::types::InputFormat> {
        self.input_format.as_ref()
    }
    /// <p>The format options for the data that was imported into the target table. There is one value, CsvOption.</p>
    pub fn input_format_options(&self) -> ::std::option::Option<&super::types::InputFormatOptions> {
        self.input_format_options.as_ref()
    }
    /// <p>The compression options for the data that has been imported into the target table. The values are NONE, GZIP, or ZSTD.</p>
    pub fn input_compression_type(&self) -> ::std::option::Option<&super::types::InputCompressionType> {
        self.input_compression_type.as_ref()
    }
    /// <p>The parameters for the new table that is being imported into.</p>
    pub fn table_creation_parameters(&self) -> ::std::option::Option<&super::types::TableCreationParameters> {
...
impl ImportTableDescription {
    ...
    pub fn builder() -> super::types::builders::ImportTableDescriptionBuilder {
        super::types::builders::ImportTableDescriptionBuilder::default()
    }
}
...
pub struct ImportTableDescriptionBuilder {
    ...
    pub(crate) import_status: ::std::option::Option<super::types::ImportStatus>,
    pub(crate) table_arn: ::std::option::Option<::std::string::String>,
    pub(crate) table_id: ::std::option::Option<::std::string::String>,
    pub(crate) client_token: ::std::option::Option<::std::string::String>,
    pub(crate) s3_bucket_source: ::std::option::Option<super::types::S3BucketSource>,
    pub(crate) error_count: ::std::option::Option<i64>,
    pub(crate) cloud_watch_log_group_arn: ::std::option::Option<::std::string::String>,
    pub(crate) input_format: ::std::option::Option<super::types::InputFormat>,
    pub(crate) input_format_options: ::std::option::Option<super::types::InputFormatOptions>,
    pub(crate) input_compression_type: ::std::option::Option<super::types::InputCompressionType>,
    pub(crate) table_creation_parameters: ::std::option::Option<super::types::TableCreationParameters>,
...
impl ImportTableDescriptionBuilder {
    ...
    /// <p>The status of the import.</p>
    pub fn import_status(mut self, input: super::types::ImportStatus) -> Self {
        self.import_status = ::std::option::Option::Some(input);
        self
    }
    /// <p>The status of the import.</p>
    pub fn set_import_status(mut self, input: ::std::option::Option<super::types::ImportStatus>) -> Self {
        self.import_status = input;
        self
    }
    /// <p>The status of the import.</p>
    pub fn get_import_status(&self) -> &::std::option::Option<super::types::ImportStatus> {
        &self.import_status
    }
    /// <p>The Amazon Resource Number (ARN) of the table being imported into.</p>
    ...
    /// <p>Values for the S3 bucket the source file is imported from. Includes bucket name (required), key prefix (optional) and bucket account owner ID (optional).</p>
    pub fn s3_bucket_source(mut self, input: super::types::S3BucketSource) -> Self {
        self.s3_bucket_source = ::std::option::Option::Some(input);
        self
    }
    /// <p>Values for the S3 bucket the source file is imported from. Includes bucket name (required), key prefix (optional) and bucket account owner ID (optional).</p>
    pub fn set_s3_bucket_source(mut self, input: ::std::option::Option<super::types::S3BucketSource>) -> Self {
        self.s3_bucket_source = input;
        self
    }
    /// <p>Values for the S3 bucket the source file is imported from. Includes bucket name (required), key prefix (optional) and bucket account owner ID (optional).</p>
    pub fn get_s3_bucket_source(&self) -> &::std::option::Option<super::types::S3BucketSource> {
    ...
    /// <p>The format of the source data going into the target table.</p>
    pub fn input_format(mut self, input: super::types::InputFormat) -> Self {
        self.input_format = ::std::option::Option::Some(input);
        self
    }
    /// <p>The format of the source data going into the target table.</p>
    pub fn set_input_format(mut self, input: ::std::option::Option<super::types::InputFormat>) -> Self {
        self.input_format = input;
        self
    }
    /// <p>The format of the source data going into the target table.</p>
    pub fn get_input_format(&self) -> &::std::option::Option<super::types::InputFormat> {
        &self.input_format
    }
    /// <p>The format options for the data that was imported into the target table. There is one value, CsvOption.</p>
    pub fn input_format_options(mut self, input: super::types::InputFormatOptions) -> Self {
        self.input_format_options = ::std::option::Option::Some(input);
        self
    }
    /// <p>The format options for the data that was imported into the target table. There is one value, CsvOption.</p>
    pub fn set_input_format_options(mut self, input: ::std::option::Option<super::types::InputFormatOptions>) -> Self {
        self.input_format_options = input;
        self
    }
    /// <p>The format options for the data that was imported into the target table. There is one value, CsvOption.</p>
    pub fn get_input_format_options(&self) -> &::std::option::Option<super::types::InputFormatOptions> {
        &self.input_format_options
    }
    /// <p>The compression options for the data that has been imported into the target table. The values are NONE, GZIP, or ZSTD.</p>
    pub fn input_compression_type(mut self, input: super::types::InputCompressionType) -> Self {
        self.input_compression_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The compression options for the data that has been imported into the target table. The values are NONE, GZIP, or ZSTD.</p>
    pub fn set_input_compression_type(mut self, input: ::std::option::Option<super::types::InputCompressionType>) -> Self {
        self.input_compression_type = input;
        self
    }
    /// <p>The compression options for the data that has been imported into the target table. The values are NONE, GZIP, or ZSTD.</p>
    pub fn get_input_compression_type(&self) -> &::std::option::Option<super::types::InputCompressionType> {
        &self.input_compression_type
    }
    /// <p>The parameters for the new table that is being imported into.</p>
    pub fn table_creation_parameters(mut self, input: super::types::TableCreationParameters) -> Self {
        self.table_creation_parameters = ::std::option::Option::Some(input);
        self
    }
    /// <p>The parameters for the new table that is being imported into.</p>
    pub fn set_table_creation_parameters(mut self, input: ::std::option::Option<super::types::TableCreationParameters>) -> Self {
        self.table_creation_parameters = input;
        self
    }
    /// <p>The parameters for the new table that is being imported into.</p>
    pub fn get_table_creation_parameters(&self) -> &::std::option::Option<super::types::TableCreationParameters> {
    ...
    pub fn build(self) -> super::types::ImportTableDescription {
        super::types::ImportTableDescription {
