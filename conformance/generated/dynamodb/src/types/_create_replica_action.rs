...
impl CreateReplicaAction {
    ...
    pub fn builder() -> super::types::builders::CreateReplicaActionBuilder {
        super::types::builders::CreateReplicaActionBuilder::default()
    }
}
...
impl CreateReplicaActionBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::CreateReplicaAction, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::CreateReplicaAction {
