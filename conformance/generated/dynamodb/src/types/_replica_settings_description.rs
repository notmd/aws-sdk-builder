...
pub struct ReplicaSettingsDescription {
    ...
    pub replica_billing_mode_summary: ::std::option::Option<super::types::BillingModeSummary>,
    ...
    pub replica_provisioned_read_capacity_auto_scaling_settings: ::std::option::Option<super::types::AutoScalingSettingsDescription>,
    ...
    pub replica_provisioned_write_capacity_auto_scaling_settings: ::std::option::Option<super::types::AutoScalingSettingsDescription>,
    /// <p>Replica global secondary index settings for the global table.</p>
    pub replica_global_secondary_index_settings: ::std::option::Option<::std::vec::Vec<super::types::ReplicaGlobalSecondaryIndexSettingsDescription>>,
...
impl ReplicaSettingsDescription {
    ...
    /// <p>The read/write capacity mode of the replica.</p>
    pub fn replica_billing_mode_summary(&self) -> ::std::option::Option<&super::types::BillingModeSummary> {
    ...
    /// <p>Auto scaling settings for a global table replica's read capacity units.</p>
    pub fn replica_provisioned_read_capacity_auto_scaling_settings(&self) -> ::std::option::Option<&super::types::AutoScalingSettingsDescription> {
    ...
    /// <p>Auto scaling settings for a global table replica's write capacity units.</p>
    pub fn replica_provisioned_write_capacity_auto_scaling_settings(&self) -> ::std::option::Option<&super::types::AutoScalingSettingsDescription> {
    ...
    pub fn replica_global_secondary_index_settings(&self) -> &[super::types::ReplicaGlobalSecondaryIndexSettingsDescription] {
...
impl ReplicaSettingsDescription {
    ...
    pub fn builder() -> super::types::builders::ReplicaSettingsDescriptionBuilder {
        super::types::builders::ReplicaSettingsDescriptionBuilder::default()
    }
}
...
pub struct ReplicaSettingsDescriptionBuilder {
    ...
    pub(crate) replica_billing_mode_summary: ::std::option::Option<super::types::BillingModeSummary>,
    pub(crate) replica_provisioned_read_capacity_units: ::std::option::Option<i64>,
    pub(crate) replica_provisioned_read_capacity_auto_scaling_settings: ::std::option::Option<super::types::AutoScalingSettingsDescription>,
    pub(crate) replica_provisioned_write_capacity_units: ::std::option::Option<i64>,
    pub(crate) replica_provisioned_write_capacity_auto_scaling_settings: ::std::option::Option<super::types::AutoScalingSettingsDescription>,
    pub(crate) replica_global_secondary_index_settings:
        ::std::option::Option<::std::vec::Vec<super::types::ReplicaGlobalSecondaryIndexSettingsDescription>>,
...
impl ReplicaSettingsDescriptionBuilder {
    ...
    /// <p>The read/write capacity mode of the replica.</p>
    pub fn replica_billing_mode_summary(mut self, input: super::types::BillingModeSummary) -> Self {
        self.replica_billing_mode_summary = ::std::option::Option::Some(input);
        self
    }
    /// <p>The read/write capacity mode of the replica.</p>
    pub fn set_replica_billing_mode_summary(mut self, input: ::std::option::Option<super::types::BillingModeSummary>) -> Self {
        self.replica_billing_mode_summary = input;
        self
    }
    /// <p>The read/write capacity mode of the replica.</p>
    pub fn get_replica_billing_mode_summary(&self) -> &::std::option::Option<super::types::BillingModeSummary> {
    ...
    /// <p>Auto scaling settings for a global table replica's read capacity units.</p>
    pub fn replica_provisioned_read_capacity_auto_scaling_settings(mut self, input: super::types::AutoScalingSettingsDescription) -> Self {
    ...
    pub fn set_replica_provisioned_read_capacity_auto_scaling_settings(
        mut self,
        input: ::std::option::Option<super::types::AutoScalingSettingsDescription>,
    ) -> Self {
    ...
    pub fn get_replica_provisioned_read_capacity_auto_scaling_settings(
        &self,
    ) -> &::std::option::Option<super::types::AutoScalingSettingsDescription> {
    ...
    /// <p>Auto scaling settings for a global table replica's write capacity units.</p>
    pub fn replica_provisioned_write_capacity_auto_scaling_settings(mut self, input: super::types::AutoScalingSettingsDescription) -> Self {
    ...
    ///
    /// <p>Replica global secondary index settings for the global table.</p>
    pub fn replica_global_secondary_index_settings(mut self, input: super::types::ReplicaGlobalSecondaryIndexSettingsDescription) -> Self {
    ...
    pub fn set_replica_global_secondary_index_settings(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::ReplicaGlobalSecondaryIndexSettingsDescription>>,
    ) -> Self {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::ReplicaSettingsDescription, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ReplicaSettingsDescription {
