...
pub struct ReplicaGlobalSecondaryIndexSettingsDescription {
    ...
    pub provisioned_read_capacity_auto_scaling_settings: ::std::option::Option<super::types::AutoScalingSettingsDescription>,
    ...
    pub provisioned_write_capacity_auto_scaling_settings: ::std::option::Option<super::types::AutoScalingSettingsDescription>,
}
impl ReplicaGlobalSecondaryIndexSettingsDescription {
    ...
    /// <p>Auto scaling settings for a global secondary index replica's read capacity units.</p>
    pub fn provisioned_read_capacity_auto_scaling_settings(&self) -> ::std::option::Option<&super::types::AutoScalingSettingsDescription> {
    ...
    /// <p>Auto scaling settings for a global secondary index replica's write capacity units.</p>
    pub fn provisioned_write_capacity_auto_scaling_settings(&self) -> ::std::option::Option<&super::types::AutoScalingSettingsDescription> {
...
impl ReplicaGlobalSecondaryIndexSettingsDescription {
    ...
    pub fn builder() -> super::types::builders::ReplicaGlobalSecondaryIndexSettingsDescriptionBuilder {
        super::types::builders::ReplicaGlobalSecondaryIndexSettingsDescriptionBuilder::default()
    }
}
...
pub struct ReplicaGlobalSecondaryIndexSettingsDescriptionBuilder {
    ...
    pub(crate) provisioned_read_capacity_auto_scaling_settings: ::std::option::Option<super::types::AutoScalingSettingsDescription>,
    pub(crate) provisioned_write_capacity_units: ::std::option::Option<i64>,
    pub(crate) provisioned_write_capacity_auto_scaling_settings: ::std::option::Option<super::types::AutoScalingSettingsDescription>,
}
impl ReplicaGlobalSecondaryIndexSettingsDescriptionBuilder {
    ...
    /// <p>Auto scaling settings for a global secondary index replica's read capacity units.</p>
    pub fn provisioned_read_capacity_auto_scaling_settings(mut self, input: super::types::AutoScalingSettingsDescription) -> Self {
    ...
    /// <p>Auto scaling settings for a global secondary index replica's read capacity units.</p>
    pub fn get_provisioned_read_capacity_auto_scaling_settings(&self) -> &::std::option::Option<super::types::AutoScalingSettingsDescription> {
    ...
    /// <p>Auto scaling settings for a global secondary index replica's write capacity units.</p>
    pub fn provisioned_write_capacity_auto_scaling_settings(mut self, input: super::types::AutoScalingSettingsDescription) -> Self {
    ...
    /// <p>Auto scaling settings for a global secondary index replica's write capacity units.</p>
    pub fn get_provisioned_write_capacity_auto_scaling_settings(&self) -> &::std::option::Option<super::types::AutoScalingSettingsDescription> {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::types::ReplicaGlobalSecondaryIndexSettingsDescription, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ReplicaGlobalSecondaryIndexSettingsDescription {
