...
pub struct AutoScalingSettingsDescription {
    ...
    pub scaling_policies: ::std::option::Option<::std::vec::Vec<super::types::AutoScalingPolicyDescription>>,
}
impl AutoScalingSettingsDescription {
    ...
    pub fn scaling_policies(&self) -> &[super::types::AutoScalingPolicyDescription] {
...
impl AutoScalingSettingsDescription {
    ...
    pub fn builder() -> super::types::builders::AutoScalingSettingsDescriptionBuilder {
        super::types::builders::AutoScalingSettingsDescriptionBuilder::default()
    }
}
...
pub struct AutoScalingSettingsDescriptionBuilder {
    ...
    pub(crate) scaling_policies: ::std::option::Option<::std::vec::Vec<super::types::AutoScalingPolicyDescription>>,
}
impl AutoScalingSettingsDescriptionBuilder {
    ...
    ///
    /// <p>Information about the scaling policies.</p>
    pub fn scaling_policies(mut self, input: super::types::AutoScalingPolicyDescription) -> Self {
    ...
    /// <p>Information about the scaling policies.</p>
    pub fn set_scaling_policies(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::AutoScalingPolicyDescription>>) -> Self {
        self.scaling_policies = input;
        self
    }
    /// <p>Information about the scaling policies.</p>
    pub fn get_scaling_policies(&self) -> &::std::option::Option<::std::vec::Vec<super::types::AutoScalingPolicyDescription>> {
        &self.scaling_policies
    }
    /// Consumes the builder and constructs a [`AutoScalingSettingsDescription`](crate::types::AutoScalingSettingsDescription).
    pub fn build(self) -> super::types::AutoScalingSettingsDescription {
        super::types::AutoScalingSettingsDescription {
