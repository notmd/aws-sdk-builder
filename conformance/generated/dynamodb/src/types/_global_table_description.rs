...
pub struct GlobalTableDescription {
    ...
    pub replication_group: ::std::option::Option<::std::vec::Vec<super::types::ReplicaDescription>>,
    ...
    /// </ul>
    pub global_table_status: ::std::option::Option<super::types::GlobalTableStatus>,
...
impl GlobalTableDescription {
    ...
    pub fn replication_group(&self) -> &[super::types::ReplicaDescription] {
    ...
    /// <p><code>ACTIVE</code> - The global table is ready for use.</p></li>
    /// </ul>
    pub fn global_table_status(&self) -> ::std::option::Option<&super::types::GlobalTableStatus> {
...
impl GlobalTableDescription {
    ...
    pub fn builder() -> super::types::builders::GlobalTableDescriptionBuilder {
        super::types::builders::GlobalTableDescriptionBuilder::default()
    }
}
...
pub struct GlobalTableDescriptionBuilder {
    pub(crate) replication_group: ::std::option::Option<::std::vec::Vec<super::types::ReplicaDescription>>,
    pub(crate) global_table_arn: ::std::option::Option<::std::string::String>,
    pub(crate) creation_date_time: ::std::option::Option<::aws_smithy_types::DateTime>,
    pub(crate) global_table_status: ::std::option::Option<super::types::GlobalTableStatus>,
...
impl GlobalTableDescriptionBuilder {
    ...
    ///
    /// <p>The Regions where the global table has replicas.</p>
    pub fn replication_group(mut self, input: super::types::ReplicaDescription) -> Self {
    ...
    /// <p>The Regions where the global table has replicas.</p>
    pub fn set_replication_group(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::ReplicaDescription>>) -> Self {
        self.replication_group = input;
        self
    }
    /// <p>The Regions where the global table has replicas.</p>
    pub fn get_replication_group(&self) -> &::std::option::Option<::std::vec::Vec<super::types::ReplicaDescription>> {
    ...
    /// <p><code>ACTIVE</code> - The global table is ready for use.</p></li>
    /// </ul>
    pub fn global_table_status(mut self, input: super::types::GlobalTableStatus) -> Self {
    ...
    /// <p><code>ACTIVE</code> - The global table is ready for use.</p></li>
    /// </ul>
    pub fn set_global_table_status(mut self, input: ::std::option::Option<super::types::GlobalTableStatus>) -> Self {
    ...
    /// <p><code>ACTIVE</code> - The global table is ready for use.</p></li>
    /// </ul>
    pub fn get_global_table_status(&self) -> &::std::option::Option<super::types::GlobalTableStatus> {
    ...
    pub fn build(self) -> super::types::GlobalTableDescription {
        super::types::GlobalTableDescription {
