...
impl DeleteReplicationGroupMemberAction {
    ...
    pub fn builder() -> super::types::builders::DeleteReplicationGroupMemberActionBuilder {
        super::types::builders::DeleteReplicationGroupMemberActionBuilder::default()
    }
}
...
impl DeleteReplicationGroupMemberActionBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::DeleteReplicationGroupMemberAction, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::DeleteReplicationGroupMemberAction {
