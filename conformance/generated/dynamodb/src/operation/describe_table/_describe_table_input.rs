...
impl DescribeTableInput {
    ...
    pub fn builder() -> super::operation::describe_table::builders::DescribeTableInputBuilder {
        super::operation::describe_table::builders::DescribeTableInputBuilder::default()
    }
}
...
impl DescribeTableInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::describe_table::DescribeTableInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::describe_table::DescribeTableInput { table_name: self.table_name })
    }
}
