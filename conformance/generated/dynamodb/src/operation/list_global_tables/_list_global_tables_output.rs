...
pub struct ListGlobalTablesOutput {
    ...
    pub global_tables: ::std::option::Option<::std::vec::Vec<super::types::GlobalTable>>,
...
impl ListGlobalTablesOutput {
    ...
    pub fn global_tables(&self) -> &[super::types::GlobalTable] {
...
impl ListGlobalTablesOutput {
    ...
    pub fn builder() -> super::operation::list_global_tables::builders::ListGlobalTablesOutputBuilder {
        super::operation::list_global_tables::builders::ListGlobalTablesOutputBuilder::default()
    }
}
...
pub struct ListGlobalTablesOutputBuilder {
    pub(crate) global_tables: ::std::option::Option<::std::vec::Vec<super::types::GlobalTable>>,
...
impl ListGlobalTablesOutputBuilder {
    ...
    ///
    /// <p>List of global table names.</p>
    pub fn global_tables(mut self, input: super::types::GlobalTable) -> Self {
    ...
    /// <p>List of global table names.</p>
    pub fn set_global_tables(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::GlobalTable>>) -> Self {
        self.global_tables = input;
        self
    }
    /// <p>List of global table names.</p>
    pub fn get_global_tables(&self) -> &::std::option::Option<::std::vec::Vec<super::types::GlobalTable>> {
        &self.global_tables
    }
    /// <p>Last evaluated global table name.</p>
    ...
    pub fn build(self) -> super::operation::list_global_tables::ListGlobalTablesOutput {
