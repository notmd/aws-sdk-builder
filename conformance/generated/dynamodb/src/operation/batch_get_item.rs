...
pub mod _batch_get_item_input {
    include!(concat!(env!("OUT_DIR"), "/generated/dynamodb/src/operation/batch_get_item/_batch_get_item_input.rs"));
}
pub use _batch_get_item_input::BatchGetItemInput;
pub type Input = BatchGetItemInput;
pub mod _batch_get_item_output {
    include!(concat!(env!("OUT_DIR"), "/generated/dynamodb/src/operation/batch_get_item/_batch_get_item_output.rs"));
}
pub use _batch_get_item_output::BatchGetItemOutput;
pub type Output = BatchGetItemOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/dynamodb/src/operation/batch_get_item/builders.rs"));
}
