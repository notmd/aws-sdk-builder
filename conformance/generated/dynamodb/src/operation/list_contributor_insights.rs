...
pub mod _list_contributor_insights_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/dynamodb/src/operation/list_contributor_insights/_list_contributor_insights_input.rs"
    ));
}
...
pub mod _list_contributor_insights_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/dynamodb/src/operation/list_contributor_insights/_list_contributor_insights_output.rs"
    ));
}
