    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::transact_write_items::TransactWriteItemsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::transact_write_items::TransactWriteItemsOutput>()
    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(super::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut super::operation::transact_write_items::TransactWriteItemsInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for TransactWriteItemsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_transact_write_items::de_transact_write_items_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_transact_write_items::de_transact_write_items_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for TransactWriteItemsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::transact_write_items::TransactWriteItemsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::transact_write_items::TransactWriteItemsInput,
        ...
        let body =
            ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_transact_write_items::ser_transact_write_items_input(&input)?);
...
fn get_resource_arn_list(input: &super::operation::transact_write_items::TransactWriteItemsInput) -> Option<::std::vec::Vec<&::std::string::String>> {
    ...
    let _prj_11 = _fld_1
        ...
        .flat_map(|v| {
            ...
            fn map(_v: &super::types::TransactWriteItem) -> ::std::option::Option<::std::vec::Vec<::std::option::Option<&::std::string::String>>> {
...
impl ::aws_types::request_id::RequestId for super::operation::transact_write_items::TransactWriteItemsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::transact_write_items::_transact_write_items_input::TransactWriteItemsInput;

pub use super::operation::transact_write_items::_transact_write_items_output::TransactWriteItemsOutput;
