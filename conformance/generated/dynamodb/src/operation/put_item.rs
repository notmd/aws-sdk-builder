    ...
    > {
        let map_err =
            |err: ::aws_smithy_runtime_api::client::result::SdkError<
                ...
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >| { err.map_service_error(|err| err.downcast::<super::operation::put_item::PutItemError>().expect("correct error type")) };
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::put_item::PutItemOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutItemResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_put_item::de_put_item_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_put_item::de_put_item_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutItemRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::put_item::PutItemInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::put_item::PutItemInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_put_item::ser_put_item_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::put_item::PutItemError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::put_item::_put_item_input::PutItemInput;

pub use super::operation::put_item::_put_item_output::PutItemOutput;
