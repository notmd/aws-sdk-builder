    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::update_continuous_backups::UpdateContinuousBackupsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::update_continuous_backups::UpdateContinuousBackupsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateContinuousBackupsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_update_continuous_backups::de_update_continuous_backups_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_update_continuous_backups::de_update_continuous_backups_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateContinuousBackupsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::update_continuous_backups::UpdateContinuousBackupsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::update_continuous_backups::UpdateContinuousBackupsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_update_continuous_backups::ser_update_continuous_backups_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::update_continuous_backups::UpdateContinuousBackupsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::update_continuous_backups::_update_continuous_backups_input::UpdateContinuousBackupsInput;

pub use super::operation::update_continuous_backups::_update_continuous_backups_output::UpdateContinuousBackupsOutput;
