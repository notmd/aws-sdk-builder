...
pub struct UpdateTableInput {
    ...
    pub global_secondary_index_updates: ::std::option::Option<::std::vec::Vec<super::types::GlobalSecondaryIndexUpdate>>,
    ...
    pub sse_specification: ::std::option::Option<super::types::SseSpecification>,
    /// <p>A list of replica update actions (create, delete, or update) for the table.</p>
    pub replica_updates: ::std::option::Option<::std::vec::Vec<super::types::ReplicationGroupUpdate>>,
    ...
    pub table_class: ::std::option::Option<super::types::TableClass>,
    ...
    pub global_table_witness_updates: ::std::option::Option<::std::vec::Vec<super::types::GlobalTableWitnessGroupUpdate>>,
    ...
    pub vector_index_updates: ::std::option::Option<::std::vec::Vec<super::types::VectorIndexUpdate>>,
}
impl UpdateTableInput {
    ...
    pub fn global_secondary_index_updates(&self) -> &[super::types::GlobalSecondaryIndexUpdate] {
    ...
    /// <p>The new server-side encryption settings for the specified table.</p>
    pub fn sse_specification(&self) -> ::std::option::Option<&super::types::SseSpecification> {
    ...
    pub fn replica_updates(&self) -> &[super::types::ReplicationGroupUpdate] {
        self.replica_updates.as_deref().unwrap_or_default()
    }
    /// <p>The table class of the table to be updated. Valid values are <code>STANDARD</code> and <code>STANDARD_INFREQUENT_ACCESS</code>.</p>
    pub fn table_class(&self) -> ::std::option::Option<&super::types::TableClass> {
    ...
    pub fn global_table_witness_updates(&self) -> &[super::types::GlobalTableWitnessGroupUpdate] {
    ...
    pub fn vector_index_updates(&self) -> &[super::types::VectorIndexUpdate] {
...
impl UpdateTableInput {
    ...
    pub fn builder() -> super::operation::update_table::builders::UpdateTableInputBuilder {
        super::operation::update_table::builders::UpdateTableInputBuilder::default()
    }
}
...
pub struct UpdateTableInputBuilder {
    ...
    pub(crate) global_secondary_index_updates: ::std::option::Option<::std::vec::Vec<super::types::GlobalSecondaryIndexUpdate>>,
    pub(crate) stream_specification: ::std::option::Option<super::types::StreamSpecification>,
    pub(crate) sse_specification: ::std::option::Option<super::types::SseSpecification>,
    pub(crate) replica_updates: ::std::option::Option<::std::vec::Vec<super::types::ReplicationGroupUpdate>>,
    pub(crate) table_class: ::std::option::Option<super::types::TableClass>,
    pub(crate) deletion_protection_enabled: ::std::option::Option<bool>,
    pub(crate) multi_region_consistency: ::std::option::Option<super::types::MultiRegionConsistency>,
    pub(crate) global_table_witness_updates: ::std::option::Option<::std::vec::Vec<super::types::GlobalTableWitnessGroupUpdate>>,
    ...
    pub(crate) vector_index_updates: ::std::option::Option<::std::vec::Vec<super::types::VectorIndexUpdate>>,
}
impl UpdateTableInputBuilder {
    ...
    /// <p>You can create or delete only one global secondary index per <code>UpdateTable</code> operation.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/GSI.OnlineOps.html">Managing Global Secondary Indexes</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p>
    pub fn global_secondary_index_updates(mut self, input: super::types::GlobalSecondaryIndexUpdate) -> Self {
    ...
    pub fn set_global_secondary_index_updates(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::GlobalSecondaryIndexUpdate>>,
    ) -> Self {
    ...
    /// <p>You can create or delete only one global secondary index per <code>UpdateTable</code> operation.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/GSI.OnlineOps.html">Managing Global Secondary Indexes</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p>
    pub fn get_global_secondary_index_updates(&self) -> &::std::option::Option<::std::vec::Vec<super::types::GlobalSecondaryIndexUpdate>> {
    ...
    /// <p>The new server-side encryption settings for the specified table.</p>
    pub fn sse_specification(mut self, input: super::types::SseSpecification) -> Self {
        self.sse_specification = ::std::option::Option::Some(input);
        self
    }
    /// <p>The new server-side encryption settings for the specified table.</p>
    pub fn set_sse_specification(mut self, input: ::std::option::Option<super::types::SseSpecification>) -> Self {
        self.sse_specification = input;
        self
    }
    /// <p>The new server-side encryption settings for the specified table.</p>
    pub fn get_sse_specification(&self) -> &::std::option::Option<super::types::SseSpecification> {
    ...
    ///
    /// <p>A list of replica update actions (create, delete, or update) for the table.</p>
    pub fn replica_updates(mut self, input: super::types::ReplicationGroupUpdate) -> Self {
    ...
    /// <p>A list of replica update actions (create, delete, or update) for the table.</p>
    pub fn set_replica_updates(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::ReplicationGroupUpdate>>) -> Self {
        self.replica_updates = input;
        self
    }
    /// <p>A list of replica update actions (create, delete, or update) for the table.</p>
    pub fn get_replica_updates(&self) -> &::std::option::Option<::std::vec::Vec<super::types::ReplicationGroupUpdate>> {
        &self.replica_updates
    }
    /// <p>The table class of the table to be updated. Valid values are <code>STANDARD</code> and <code>STANDARD_INFREQUENT_ACCESS</code>.</p>
    pub fn table_class(mut self, input: super::types::TableClass) -> Self {
        self.table_class = ::std::option::Option::Some(input);
        self
    }
    /// <p>The table class of the table to be updated. Valid values are <code>STANDARD</code> and <code>STANDARD_INFREQUENT_ACCESS</code>.</p>
    pub fn set_table_class(mut self, input: ::std::option::Option<super::types::TableClass>) -> Self {
        self.table_class = input;
        self
    }
    /// <p>The table class of the table to be updated. Valid values are <code>STANDARD</code> and <code>STANDARD_INFREQUENT_ACCESS</code>.</p>
    pub fn get_table_class(&self) -> &::std::option::Option<super::types::TableClass> {
        &self.table_class
    }
    /// <p>Indicates whether deletion protection is to be enabled (true) or disabled (false) on the table.</p>
    ...
    /// <p>You can create or delete only one witness per <code>UpdateTable</code> operation.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/V2globaltables_HowItWorks.html#V2globaltables_HowItWorks.consistency-modes">Multi-Region strong consistency (MRSC)</a> in the Amazon DynamoDB Developer Guide</p>
    pub fn global_table_witness_updates(mut self, input: super::types::GlobalTableWitnessGroupUpdate) -> Self {
    ...
    pub fn set_global_table_witness_updates(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::GlobalTableWitnessGroupUpdate>>,
    ) -> Self {
    ...
    /// <p>You can create or delete only one witness per <code>UpdateTable</code> operation.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/V2globaltables_HowItWorks.html#V2globaltables_HowItWorks.consistency-modes">Multi-Region strong consistency (MRSC)</a> in the Amazon DynamoDB Developer Guide</p>
    pub fn get_global_table_witness_updates(&self) -> &::std::option::Option<::std::vec::Vec<super::types::GlobalTableWitnessGroupUpdate>> {
    ...
    /// <p>A list of vector indexes to be added to or removed from the table. You can add or remove one vector index for each <code>UpdateTable</code> operation.</p>
    /// <p>To add a vector index, specify <code>IndexName</code>, <code>VectorAttribute</code>, <code>Dimensions</code>, <code>DistanceFunction</code>, and <code>Projection</code>. To remove a vector index, specify only the <code>IndexName</code>.</p>
    pub fn vector_index_updates(mut self, input: super::types::VectorIndexUpdate) -> Self {
    ...
    /// <p>A list of vector indexes to be added to or removed from the table. You can add or remove one vector index for each <code>UpdateTable</code> operation.</p>
    /// <p>To add a vector index, specify <code>IndexName</code>, <code>VectorAttribute</code>, <code>Dimensions</code>, <code>DistanceFunction</code>, and <code>Projection</code>. To remove a vector index, specify only the <code>IndexName</code>.</p>
    pub fn set_vector_index_updates(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::VectorIndexUpdate>>) -> Self {
        self.vector_index_updates = input;
        self
    }
    /// <p>A list of vector indexes to be added to or removed from the table. You can add or remove one vector index for each <code>UpdateTable</code> operation.</p>
    /// <p>To add a vector index, specify <code>IndexName</code>, <code>VectorAttribute</code>, <code>Dimensions</code>, <code>DistanceFunction</code>, and <code>Projection</code>. To remove a vector index, specify only the <code>IndexName</code>.</p>
    pub fn get_vector_index_updates(&self) -> &::std::option::Option<::std::vec::Vec<super::types::VectorIndexUpdate>> {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::update_table::UpdateTableInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::update_table::UpdateTableInput {
