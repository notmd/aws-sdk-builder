...
pub mod _put_resource_policy_input {
    include!(concat!(env!("OUT_DIR"), "/generated/dynamodb/src/operation/put_resource_policy/_put_resource_policy_input.rs"));
}
...
pub mod _put_resource_policy_output {
    include!(concat!(env!("OUT_DIR"), "/generated/dynamodb/src/operation/put_resource_policy/_put_resource_policy_output.rs"));
}
...
/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/dynamodb/src/operation/put_resource_policy/builders.rs"));
}
