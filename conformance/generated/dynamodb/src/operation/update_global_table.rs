...
pub mod _update_global_table_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/dynamodb/src/operation/update_global_table/_update_global_table_input.rs"
    ));
}
...
pub mod _update_global_table_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/dynamodb/src/operation/update_global_table/_update_global_table_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/dynamodb/src/operation/update_global_table/builders.rs"
    ));
}
