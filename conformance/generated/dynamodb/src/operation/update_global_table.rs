    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::update_global_table::UpdateGlobalTableError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::update_global_table::UpdateGlobalTableOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateGlobalTableResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_update_global_table::de_update_global_table_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_update_global_table::de_update_global_table_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateGlobalTableRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::update_global_table::UpdateGlobalTableInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::update_global_table::UpdateGlobalTableInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_update_global_table::ser_update_global_table_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::update_global_table::UpdateGlobalTableError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::update_global_table::_update_global_table_input::UpdateGlobalTableInput;

pub use super::operation::update_global_table::_update_global_table_output::UpdateGlobalTableOutput;
