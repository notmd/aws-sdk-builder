...
pub struct BatchWriteItemInput {
    ...
    /// </ul></li>
    /// </ul>
    pub request_items: ::std::option::Option<::std::collections::HashMap<::std::string::String, ::std::vec::Vec<super::types::WriteRequest>>>,
...
impl BatchWriteItemInput {
    ...
    pub fn builder() -> super::operation::batch_write_item::builders::BatchWriteItemInputBuilder {
        super::operation::batch_write_item::builders::BatchWriteItemInputBuilder::default()
    }
}
...
pub struct BatchWriteItemInputBuilder {
    pub(crate) request_items: ::std::option::Option<::std::collections::HashMap<::std::string::String, ::std::vec::Vec<super::types::WriteRequest>>>,
...
impl BatchWriteItemInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::batch_write_item::BatchWriteItemInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::batch_write_item::BatchWriteItemInput {
