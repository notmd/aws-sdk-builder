...
pub mod _describe_contributor_insights_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/dynamodb/src/operation/describe_contributor_insights/_describe_contributor_insights_input.rs"
    ));
}
...
pub mod _describe_contributor_insights_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/dynamodb/src/operation/describe_contributor_insights/_describe_contributor_insights_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/dynamodb/src/operation/describe_contributor_insights/builders.rs"
    ));
}
