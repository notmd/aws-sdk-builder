...
pub mod _describe_contributor_insights_input {
    include!(concat!(env!("OUT_DIR"), "/generated/dynamodb/src/operation/describe_contributor_insights/_describe_contributor_insights_input.rs"));
}
pub use _describe_contributor_insights_input::DescribeContributorInsightsInput;
pub type Input = DescribeContributorInsightsInput;
pub mod _describe_contributor_insights_output {
    include!(concat!(env!("OUT_DIR"), "/generated/dynamodb/src/operation/describe_contributor_insights/_describe_contributor_insights_output.rs"));
}
pub use _describe_contributor_insights_output::DescribeContributorInsightsOutput;
pub type Output = DescribeContributorInsightsOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/dynamodb/src/operation/describe_contributor_insights/builders.rs"));
}
