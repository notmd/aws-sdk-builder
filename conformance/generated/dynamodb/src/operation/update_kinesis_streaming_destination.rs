// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        impl Input {
            ...
            pub fn update_kinesis_streaming_configuration(&self) -> ::std::option::Option<&super::super::types::UpdateKinesisStreamingConfiguration> { self.update_kinesis_streaming_configuration.as_ref() }
        }
        #[derive(Clone, Debug, Default)]
        pub struct Output {
        ...
        pub type UpdateKinesisStreamingDestinationInput = Input;
        pub type UpdateKinesisStreamingDestinationOutput = Output;
        pub type UpdateKinesisStreamingDestinationError = Error;
        #[derive(Clone, Debug)]
        pub enum Error {
...
pub use builders::Builder;
        pub type UpdateKinesisStreamingDestinationFluentBuilder = builders::Builder;
