...
impl CreateBackupInput {
    ...
    pub fn builder() -> super::operation::create_backup::builders::CreateBackupInputBuilder {
        super::operation::create_backup::builders::CreateBackupInputBuilder::default()
    }
}
...
impl CreateBackupInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::create_backup::CreateBackupInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::create_backup::CreateBackupInput {
