...
impl DisableKinesisStreamingDestinationOutput {
    ...
    pub fn builder() -> super::operation::disable_kinesis_streaming_destination::builders::DisableKinesisStreamingDestinationOutputBuilder {
...
impl DisableKinesisStreamingDestinationOutputBuilder {
    ...
    pub fn build(self) -> super::operation::disable_kinesis_streaming_destination::DisableKinesisStreamingDestinationOutput {
