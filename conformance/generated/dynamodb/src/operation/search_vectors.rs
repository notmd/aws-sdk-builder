...
pub mod _search_vectors_input {
    include!(concat!(env!("OUT_DIR"), "/generated/dynamodb/src/operation/search_vectors/_search_vectors_input.rs"));
}
pub use _search_vectors_input::SearchVectorsInput;
pub type Input = SearchVectorsInput;
pub mod _search_vectors_output {
    include!(concat!(env!("OUT_DIR"), "/generated/dynamodb/src/operation/search_vectors/_search_vectors_output.rs"));
}
pub use _search_vectors_output::SearchVectorsOutput;
pub type Output = SearchVectorsOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/dynamodb/src/operation/search_vectors/builders.rs"));
}
