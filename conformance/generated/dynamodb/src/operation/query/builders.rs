...
pub use super::operation::query::_query_input::QueryInputBuilder;

pub use super::operation::query::_query_output::QueryOutputBuilder;

impl super::operation::query::builders::QueryInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::Client,
    ) -> ::std::result::Result<
        super::operation::query::QueryOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::query::QueryError,
...
pub struct QueryFluentBuilder {
    ...
    inner: super::operation::query::builders::QueryInputBuilder,
    config_override: ::std::option::Option<super::config::Builder>,
}
impl super::client::customize::internal::CustomizableSend<super::operation::query::QueryOutput, super::operation::query::QueryError>
    for QueryFluentBuilder
{
    fn send(
        ...
        super::client::customize::internal::SendResult<super::operation::query::QueryOutput, super::operation::query::QueryError>,
    > {
...
impl QueryFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::query::builders::QueryInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            super::operation::query::Query::operation_runtime_plugins(self.handle.runtime_plugins.clone(), &self.handle.conf, self.config_override);
        super::operation::query::Query::orchestrate(&runtime_plugins, input).await
    }

    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
    pub fn customize(
        self,
    ) -> super::client::customize::CustomizableOperation<super::operation::query::QueryOutput, super::operation::query::QueryError, Self> {
    ...
    pub fn into_paginator(self) -> super::operation::query::paginator::QueryPaginator {
        super::operation::query::paginator::QueryPaginator::new(self.handle, self.inner)
    }
