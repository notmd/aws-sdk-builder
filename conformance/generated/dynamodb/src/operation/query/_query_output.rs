...
impl QueryOutput {
    ...
    pub fn builder() -> super::operation::query::builders::QueryOutputBuilder {
        super::operation::query::builders::QueryOutputBuilder::default()
    }
}
...
impl QueryOutputBuilder {
    ...
    pub fn build(self) -> super::operation::query::QueryOutput {
