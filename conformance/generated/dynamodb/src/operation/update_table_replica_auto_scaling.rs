...
pub mod _update_table_replica_auto_scaling_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/dynamodb/src/operation/update_table_replica_auto_scaling/_update_table_replica_auto_scaling_input.rs"
    ));
}
...
pub mod _update_table_replica_auto_scaling_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/dynamodb/src/operation/update_table_replica_auto_scaling/_update_table_replica_auto_scaling_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/dynamodb/src/operation/update_table_replica_auto_scaling/builders.rs"
    ));
}
