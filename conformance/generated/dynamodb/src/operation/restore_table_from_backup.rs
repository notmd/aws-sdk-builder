    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::restore_table_from_backup::RestoreTableFromBackupError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::restore_table_from_backup::RestoreTableFromBackupOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RestoreTableFromBackupResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_restore_table_from_backup::de_restore_table_from_backup_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_restore_table_from_backup::de_restore_table_from_backup_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RestoreTableFromBackupRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::restore_table_from_backup::RestoreTableFromBackupInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::restore_table_from_backup::RestoreTableFromBackupInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_restore_table_from_backup::ser_restore_table_from_backup_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::restore_table_from_backup::RestoreTableFromBackupError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::restore_table_from_backup::_restore_table_from_backup_input::RestoreTableFromBackupInput;

pub use super::operation::restore_table_from_backup::_restore_table_from_backup_output::RestoreTableFromBackupOutput;
