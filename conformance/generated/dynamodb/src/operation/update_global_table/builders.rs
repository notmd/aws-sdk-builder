...
pub use super::operation::update_global_table::_update_global_table_input::UpdateGlobalTableInputBuilder;

pub use super::operation::update_global_table::_update_global_table_output::UpdateGlobalTableOutputBuilder;

impl super::operation::update_global_table::builders::UpdateGlobalTableInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::Client,
    ) -> ::std::result::Result<
        super::operation::update_global_table::UpdateGlobalTableOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::update_global_table::UpdateGlobalTableError,
...
pub struct UpdateGlobalTableFluentBuilder {
    ...
    inner: super::operation::update_global_table::builders::UpdateGlobalTableInputBuilder,
...
impl UpdateGlobalTableFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::update_global_table::builders::UpdateGlobalTableInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::update_global_table::UpdateGlobalTable::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::update_global_table::UpdateGlobalTable::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn replica_updates(mut self, input: super::types::ReplicaUpdate) -> Self {
        self.inner = self.inner.replica_updates(input);
        self
    }
    /// <p>A list of Regions that should be added or removed from the global table.</p>
    pub fn set_replica_updates(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::ReplicaUpdate>>) -> Self {
        self.inner = self.inner.set_replica_updates(input);
        self
    }
    /// <p>A list of Regions that should be added or removed from the global table.</p>
    pub fn get_replica_updates(&self) -> &::std::option::Option<::std::vec::Vec<super::types::ReplicaUpdate>> {
