...
pub struct UpdateGlobalTableInput {
    ...
    pub replica_updates: ::std::option::Option<::std::vec::Vec<super::types::ReplicaUpdate>>,
}
impl UpdateGlobalTableInput {
    ...
    pub fn replica_updates(&self) -> &[super::types::ReplicaUpdate] {
...
impl UpdateGlobalTableInput {
    ...
    pub fn builder() -> super::operation::update_global_table::builders::UpdateGlobalTableInputBuilder {
        super::operation::update_global_table::builders::UpdateGlobalTableInputBuilder::default()
    }
}
...
pub struct UpdateGlobalTableInputBuilder {
    ...
    pub(crate) replica_updates: ::std::option::Option<::std::vec::Vec<super::types::ReplicaUpdate>>,
}
impl UpdateGlobalTableInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::update_global_table::UpdateGlobalTableInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::update_global_table::UpdateGlobalTableInput {
