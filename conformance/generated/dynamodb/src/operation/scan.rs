...
impl Scan {
    ...
    > {
        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<
            ...
            ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
        >| { err.map_service_error(|err| err.downcast::<super::operation::scan::ScanError>().expect("correct error type")) };
        let context = Self::orchestrate_with_stop_point(runtime_plugins, input, ::aws_smithy_runtime::client::orchestrator::StopPoint::None)
            .await
            .map_err(map_err)?;
        let output = context.finalize().map_err(map_err)?;
        ::std::result::Result::Ok(output.downcast::<super::operation::scan::ScanOutput>().expect("correct output type"))
    }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ScanResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_scan::de_scan_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_scan::de_scan_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ScanRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::scan::ScanInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::scan::ScanInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_scan::ser_scan_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::scan::ScanError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::scan::_scan_input::ScanInput;

pub use super::operation::scan::_scan_output::ScanOutput;
