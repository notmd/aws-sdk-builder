...
pub mod _scan_input {
    include!(concat!(env!("OUT_DIR"), "/generated/dynamodb/src/operation/scan/_scan_input.rs"));
}
pub use _scan_input::ScanInput;
pub type Input = ScanInput;
pub mod _scan_output {
    include!(concat!(env!("OUT_DIR"), "/generated/dynamodb/src/operation/scan/_scan_output.rs"));
}
pub use _scan_output::ScanOutput;
pub type Output = ScanOutput;
