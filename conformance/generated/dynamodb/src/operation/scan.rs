// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        pub struct Scan;
        impl Scan { pub fn new() -> Self { Self } }
        #[derive(Clone, Debug, Default)]
        pub struct Input {
            ...
            pub scan_filter: ::std::option::Option<super::super::types::FilterConditionMap>,
            pub segment: ::std::option::Option<super::super::types::ScanSegment>,
            pub select: ::std::option::Option<super::super::types::Select>,
            pub table_name: ::std::option::Option<super::super::types::TableArn>,
            pub total_segments: ::std::option::Option<super::super::types::ScanTotalSegments>,
        }
        impl Input {
            ...
            pub fn scan_filter(&self) -> ::std::option::Option<&super::super::types::FilterConditionMap> { self.scan_filter.as_ref() }
        ...
        pub type ScanInput = Input;
        pub type ScanOutput = Output;
