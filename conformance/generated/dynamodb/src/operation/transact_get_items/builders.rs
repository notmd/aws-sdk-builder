...
pub use super::operation::transact_get_items::_transact_get_items_input::TransactGetItemsInputBuilder;

pub use super::operation::transact_get_items::_transact_get_items_output::TransactGetItemsOutputBuilder;

impl super::operation::transact_get_items::builders::TransactGetItemsInputBuilder {
...
pub struct TransactGetItemsFluentBuilder {
    ...
    inner: super::operation::transact_get_items::builders::TransactGetItemsInputBuilder,
...
impl TransactGetItemsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::transact_get_items::builders::TransactGetItemsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::transact_get_items::TransactGetItems::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::transact_get_items::TransactGetItems::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn transact_items(mut self, input: super::types::TransactGetItem) -> Self {
        self.inner = self.inner.transact_items(input);
        self
    }
    /// <p>An ordered array of up to 100 <code>TransactGetItem</code> objects, each of which contains a <code>Get</code> structure.</p>
    pub fn set_transact_items(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::TransactGetItem>>) -> Self {
        self.inner = self.inner.set_transact_items(input);
        self
    }
    /// <p>An ordered array of up to 100 <code>TransactGetItem</code> objects, each of which contains a <code>Get</code> structure.</p>
    pub fn get_transact_items(&self) -> &::std::option::Option<::std::vec::Vec<super::types::TransactGetItem>> {
