...
pub struct TransactGetItemsInput {
    ...
    pub transact_items: ::std::option::Option<::std::vec::Vec<super::types::TransactGetItem>>,
...
impl TransactGetItemsInput {
    ...
    pub fn transact_items(&self) -> &[super::types::TransactGetItem] {
...
impl TransactGetItemsInput {
    ...
    pub fn builder() -> super::operation::transact_get_items::builders::TransactGetItemsInputBuilder {
        super::operation::transact_get_items::builders::TransactGetItemsInputBuilder::default()
    }
}
...
pub struct TransactGetItemsInputBuilder {
    pub(crate) transact_items: ::std::option::Option<::std::vec::Vec<super::types::TransactGetItem>>,
...
impl TransactGetItemsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::transact_get_items::TransactGetItemsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::transact_get_items::TransactGetItemsInput {
