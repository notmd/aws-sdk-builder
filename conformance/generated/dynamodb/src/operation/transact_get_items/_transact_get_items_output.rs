...
impl TransactGetItemsOutput {
    ...
    pub fn builder() -> super::operation::transact_get_items::builders::TransactGetItemsOutputBuilder {
        super::operation::transact_get_items::builders::TransactGetItemsOutputBuilder::default()
    }
}
...
impl TransactGetItemsOutputBuilder {
    ...
    pub fn build(self) -> super::operation::transact_get_items::TransactGetItemsOutput {
