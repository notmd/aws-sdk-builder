...
impl DescribeExport {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::operation::describe_export::DescribeExportOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::describe_export::DescribeExportError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::describe_export::DescribeExportError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::describe_export::DescribeExportOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeExportResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_describe_export::de_describe_export_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_describe_export::de_describe_export_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeExportRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::describe_export::DescribeExportInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::describe_export::DescribeExportInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_describe_export::ser_describe_export_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::describe_export::DescribeExportError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::describe_export::_describe_export_input::DescribeExportInput;

pub use super::operation::describe_export::_describe_export_output::DescribeExportOutput;
