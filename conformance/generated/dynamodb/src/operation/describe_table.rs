// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        #[derive(Clone, Debug, Default)]
        pub struct Output {
            pub table: ::std::option::Option<super::super::types::TableDescription>,
        }
        impl Output {
            pub fn table(&self) -> ::std::option::Option<&super::super::types::TableDescription> { self.table.as_ref() }
        }
        pub type DescribeTableInput = Input;
        pub type DescribeTableOutput = Output;
