    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::describe_table::DescribeTableError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::describe_table::DescribeTableOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeTableResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_describe_table::de_describe_table_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_describe_table::de_describe_table_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeTableRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::describe_table::DescribeTableInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::describe_table::DescribeTableInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_describe_table::ser_describe_table_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::describe_table::DescribeTableError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::describe_table::_describe_table_input::DescribeTableInput;

pub use super::operation::describe_table::_describe_table_output::DescribeTableOutput;
