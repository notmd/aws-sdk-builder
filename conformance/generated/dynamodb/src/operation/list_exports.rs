    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_exports::ListExportsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_exports::ListExportsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListExportsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_exports::de_list_exports_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_exports::de_list_exports_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListExportsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_exports::ListExportsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_exports::ListExportsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_list_exports::ser_list_exports_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::list_exports::ListExportsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_exports::_list_exports_input::ListExportsInput;

pub use super::operation::list_exports::_list_exports_output::ListExportsOutput;
