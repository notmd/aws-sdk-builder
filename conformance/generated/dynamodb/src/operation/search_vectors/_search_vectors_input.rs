...
pub struct SearchVectorsInput {
    ...
    pub search_vector: ::std::option::Option<::std::vec::Vec<super::types::AttributeValue>>,
...
impl SearchVectorsInput {
    ...
    pub fn search_vector(&self) -> &[super::types::AttributeValue] {
...
impl SearchVectorsInput {
    ...
    pub fn builder() -> super::operation::search_vectors::builders::SearchVectorsInputBuilder {
        super::operation::search_vectors::builders::SearchVectorsInputBuilder::default()
    }
}
...
pub struct SearchVectorsInputBuilder {
    ...
    pub(crate) search_vector: ::std::option::Option<::std::vec::Vec<super::types::AttributeValue>>,
...
impl SearchVectorsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::search_vectors::SearchVectorsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::search_vectors::SearchVectorsInput {
