...
pub struct Builder {
    input: super::_list_tags_of_resource_input::ListTagsOfResourceInputBuilder,
...
impl Builder {
    ...
    pub async fn send(self) -> ::std::result::Result<super::ListTagsOfResourceOutput, super::ListTagsOfResourceError> {
        let input = self
            .input
            .build()
            .map_err(|error| super::ListTagsOfResourceError::Unhandled(error.to_string()))?;
        let path = "/";
        ...
        let response = self
            ...
            .await
            .map_err(super::ListTagsOfResourceError::Unhandled)?;
        let status = response.status();
        if !status.is_success() {
            return Err(super::ListTagsOfResourceError::unhandled_with_request_ids(
                format!("ListTagsOfResource returned HTTP {}", status),
