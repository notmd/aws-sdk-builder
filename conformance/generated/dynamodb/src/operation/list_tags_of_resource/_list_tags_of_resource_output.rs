...
impl ListTagsOfResourceOutput {
    ...
    pub fn builder() -> super::operation::list_tags_of_resource::builders::ListTagsOfResourceOutputBuilder {
        super::operation::list_tags_of_resource::builders::ListTagsOfResourceOutputBuilder::default()
    }
}
...
impl ListTagsOfResourceOutputBuilder {
    ...
    pub fn build(self) -> super::operation::list_tags_of_resource::ListTagsOfResourceOutput {
