...
impl ListTagsOfResourceInput {
    ...
    pub fn builder() -> super::operation::list_tags_of_resource::builders::ListTagsOfResourceInputBuilder {
        super::operation::list_tags_of_resource::builders::ListTagsOfResourceInputBuilder::default()
    }
}
...
impl ListTagsOfResourceInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_tags_of_resource::ListTagsOfResourceInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::list_tags_of_resource::ListTagsOfResourceInput {
