...
pub struct UpdateKinesisStreamingDestinationOutput {
    ...
    pub destination_status: ::std::option::Option<super::types::DestinationStatus>,
    /// <p>The command to update the Kinesis streaming destination configuration.</p>
    pub update_kinesis_streaming_configuration: ::std::option::Option<super::types::UpdateKinesisStreamingConfiguration>,
...
impl UpdateKinesisStreamingDestinationOutput {
    ...
    /// <p>The status of the attempt to update the Kinesis streaming destination output.</p>
    pub fn destination_status(&self) -> ::std::option::Option<&super::types::DestinationStatus> {
        self.destination_status.as_ref()
    }
    /// <p>The command to update the Kinesis streaming destination configuration.</p>
    pub fn update_kinesis_streaming_configuration(&self) -> ::std::option::Option<&super::types::UpdateKinesisStreamingConfiguration> {
...
impl UpdateKinesisStreamingDestinationOutput {
    ...
    pub fn builder() -> super::operation::update_kinesis_streaming_destination::builders::UpdateKinesisStreamingDestinationOutputBuilder {
        super::operation::update_kinesis_streaming_destination::builders::UpdateKinesisStreamingDestinationOutputBuilder::default()
    }
}
...
pub struct UpdateKinesisStreamingDestinationOutputBuilder {
    ...
    pub(crate) destination_status: ::std::option::Option<super::types::DestinationStatus>,
    pub(crate) update_kinesis_streaming_configuration: ::std::option::Option<super::types::UpdateKinesisStreamingConfiguration>,
    _request_id: Option<String>,
}
impl UpdateKinesisStreamingDestinationOutputBuilder {
    ...
    /// <p>The status of the attempt to update the Kinesis streaming destination output.</p>
    pub fn destination_status(mut self, input: super::types::DestinationStatus) -> Self {
        self.destination_status = ::std::option::Option::Some(input);
        self
    }
    /// <p>The status of the attempt to update the Kinesis streaming destination output.</p>
    pub fn set_destination_status(mut self, input: ::std::option::Option<super::types::DestinationStatus>) -> Self {
        self.destination_status = input;
        self
    }
    /// <p>The status of the attempt to update the Kinesis streaming destination output.</p>
    pub fn get_destination_status(&self) -> &::std::option::Option<super::types::DestinationStatus> {
        &self.destination_status
    }
    /// <p>The command to update the Kinesis streaming destination configuration.</p>
    pub fn update_kinesis_streaming_configuration(mut self, input: super::types::UpdateKinesisStreamingConfiguration) -> Self {
    ...
    pub fn set_update_kinesis_streaming_configuration(
        mut self,
        input: ::std::option::Option<super::types::UpdateKinesisStreamingConfiguration>,
    ) -> Self {
        self.update_kinesis_streaming_configuration = input;
        self
    }
    /// <p>The command to update the Kinesis streaming destination configuration.</p>
    pub fn get_update_kinesis_streaming_configuration(&self) -> &::std::option::Option<super::types::UpdateKinesisStreamingConfiguration> {
    ...
    pub fn build(self) -> super::operation::update_kinesis_streaming_destination::UpdateKinesisStreamingDestinationOutput {
