...
impl DescribeGlobalTableInput {
    ...
    pub fn builder() -> super::operation::describe_global_table::builders::DescribeGlobalTableInputBuilder {
        super::operation::describe_global_table::builders::DescribeGlobalTableInputBuilder::default()
    }
}
...
impl DescribeGlobalTableInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::describe_global_table::DescribeGlobalTableInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::describe_global_table::DescribeGlobalTableInput {
