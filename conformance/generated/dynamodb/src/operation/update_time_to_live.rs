...
pub mod _update_time_to_live_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/dynamodb/src/operation/update_time_to_live/_update_time_to_live_input.rs"
    ));
}
...
pub mod _update_time_to_live_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/dynamodb/src/operation/update_time_to_live/_update_time_to_live_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/dynamodb/src/operation/update_time_to_live/builders.rs"
    ));
}
