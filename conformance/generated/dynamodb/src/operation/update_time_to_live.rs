    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::update_time_to_live::UpdateTimeToLiveError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::update_time_to_live::UpdateTimeToLiveOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateTimeToLiveResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_update_time_to_live::de_update_time_to_live_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_update_time_to_live::de_update_time_to_live_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateTimeToLiveRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::update_time_to_live::UpdateTimeToLiveInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::update_time_to_live::UpdateTimeToLiveInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_update_time_to_live::ser_update_time_to_live_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::update_time_to_live::UpdateTimeToLiveError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::update_time_to_live::_update_time_to_live_input::UpdateTimeToLiveInput;

pub use super::operation::update_time_to_live::_update_time_to_live_output::UpdateTimeToLiveOutput;
