...
impl ListTablesOutput {
    ...
    pub fn builder() -> super::operation::list_tables::builders::ListTablesOutputBuilder {
        super::operation::list_tables::builders::ListTablesOutputBuilder::default()
    }
}
...
impl ListTablesOutputBuilder {
    ...
    pub fn build(self) -> super::operation::list_tables::ListTablesOutput {
