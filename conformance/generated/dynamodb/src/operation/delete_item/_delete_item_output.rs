...
impl DeleteItemOutput {
    ...
    pub fn builder() -> super::operation::delete_item::builders::DeleteItemOutputBuilder {
        super::operation::delete_item::builders::DeleteItemOutputBuilder::default()
    }
}
...
impl DeleteItemOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_item::DeleteItemOutput {
