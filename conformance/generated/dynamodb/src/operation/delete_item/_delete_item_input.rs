...
impl DeleteItemInput {
    ...
    pub fn builder() -> super::operation::delete_item::builders::DeleteItemInputBuilder {
        super::operation::delete_item::builders::DeleteItemInputBuilder::default()
    }
}
...
impl DeleteItemInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::delete_item::DeleteItemInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::delete_item::DeleteItemInput {
