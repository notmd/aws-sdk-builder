...
impl ExecuteStatementInput {
    ...
    pub fn builder() -> super::operation::execute_statement::builders::ExecuteStatementInputBuilder {
        super::operation::execute_statement::builders::ExecuteStatementInputBuilder::default()
    }
}
...
impl ExecuteStatementInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::execute_statement::ExecuteStatementInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::execute_statement::ExecuteStatementInput {
