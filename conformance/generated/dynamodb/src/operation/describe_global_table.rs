    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::describe_global_table::DescribeGlobalTableError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::describe_global_table::DescribeGlobalTableOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeGlobalTableResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_describe_global_table::de_describe_global_table_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_describe_global_table::de_describe_global_table_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeGlobalTableRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::describe_global_table::DescribeGlobalTableInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::describe_global_table::DescribeGlobalTableInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_describe_global_table::ser_describe_global_table_input(
            &input,
        )?);
...
impl ::aws_types::request_id::RequestId for super::operation::describe_global_table::DescribeGlobalTableError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::describe_global_table::_describe_global_table_input::DescribeGlobalTableInput;

pub use super::operation::describe_global_table::_describe_global_table_output::DescribeGlobalTableOutput;
