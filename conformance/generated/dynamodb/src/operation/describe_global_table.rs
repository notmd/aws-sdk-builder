...
pub mod _describe_global_table_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/dynamodb/src/operation/describe_global_table/_describe_global_table_input.rs"
    ));
}
...
pub mod _describe_global_table_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/dynamodb/src/operation/describe_global_table/_describe_global_table_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/dynamodb/src/operation/describe_global_table/builders.rs"
    ));
}
