...
pub mod _query_input {
    include!(concat!(env!("OUT_DIR"), "/generated/dynamodb/src/operation/query/_query_input.rs"));
}
pub use _query_input::QueryInput;
pub type Input = QueryInput;
pub mod _query_output {
    include!(concat!(env!("OUT_DIR"), "/generated/dynamodb/src/operation/query/_query_output.rs"));
}
pub use _query_output::QueryOutput;
pub type Output = QueryOutput;
