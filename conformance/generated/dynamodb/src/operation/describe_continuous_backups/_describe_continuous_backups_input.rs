...
impl DescribeContinuousBackupsInput {
    ...
    pub fn builder() -> super::operation::describe_continuous_backups::builders::DescribeContinuousBackupsInputBuilder {
        super::operation::describe_continuous_backups::builders::DescribeContinuousBackupsInputBuilder::default()
    }
}
...
impl DescribeContinuousBackupsInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::describe_continuous_backups::DescribeContinuousBackupsInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::describe_continuous_backups::DescribeContinuousBackupsInput { table_name: self.table_name })
    }
}
