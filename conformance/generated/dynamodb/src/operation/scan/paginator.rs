...
pub struct ScanPaginator {
    ...
    builder: super::operation::scan::builders::ScanInputBuilder,
    stop_on_duplicate_token: bool,
}

impl ScanPaginator {
    /// Create a new paginator-wrapper
    pub(crate) fn new(handle: std::sync::Arc<super::client::Handle>, builder: super::operation::scan::builders::ScanInputBuilder) -> Self {
        Self {
            handle,
            builder,
    ...
    pub fn items(self) -> super::operation::scan::paginator::ScanPaginatorItems {
        super::operation::scan::paginator::ScanPaginatorItems(self)
    }
    ...
    > {
        ...
        let runtime_plugins =
            super::operation::scan::Scan::operation_runtime_plugins(handle.runtime_plugins.clone(), &handle.conf, ::std::option::Option::None)
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::operation::scan::Scan::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_scan_output_output_last_evaluated_key(resp);
...
impl ScanPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| super::lens::lens_scan_output_output_items(page).unwrap_or_default().into_iter())
    }
}
