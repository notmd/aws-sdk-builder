...
impl ScanOutput {
    ...
    pub fn builder() -> super::operation::scan::builders::ScanOutputBuilder {
        super::operation::scan::builders::ScanOutputBuilder::default()
    }
}
...
impl ScanOutputBuilder {
    ...
    pub fn build(self) -> super::operation::scan::ScanOutput {
