    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_item::DeleteItemError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_item::DeleteItemOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteItemResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_item::de_delete_item_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_item::de_delete_item_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteItemRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::delete_item::DeleteItemInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_item::DeleteItemInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_delete_item::ser_delete_item_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::delete_item::DeleteItemError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_item::_delete_item_input::DeleteItemInput;

pub use super::operation::delete_item::_delete_item_output::DeleteItemOutput;
