...
impl ListImportsOutputBuilder {
    ...
    pub fn set_import_summary_list(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::ImportSummary>>) -> Self { self.import_summary_list = input; self }
    /// <p>A list of <code>ImportSummary</code> objects.</p>
    pub fn get_import_summary_list(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::ImportSummary>> { &self.import_summary_list }
    /// <p>If this value is returned, there are additional results to be displayed. To retrieve them, call <code>ListImports</code> again, with <code>NextToken</code> set to this value.</p>
