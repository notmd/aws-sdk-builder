...
impl ListImportsInput {
    ...
    pub fn builder() -> super::operation::list_imports::builders::ListImportsInputBuilder {
        super::operation::list_imports::builders::ListImportsInputBuilder::default()
    }
}
...
impl ListImportsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::list_imports::ListImportsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_imports::ListImportsInput {
