...
pub struct BatchGetItemInput {
    ...
    /// </ul>
    pub request_items: ::std::option::Option<::std::collections::HashMap<::std::string::String, super::types::KeysAndAttributes>>,
...
impl BatchGetItemInput {
    ...
    /// <p><code>AttributesToGet</code> - This is a legacy parameter. Use <code>ProjectionExpression</code> instead. For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.AttributesToGet.html">AttributesToGet</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p></li>
    /// </ul>
    pub fn request_items(&self) -> ::std::option::Option<&::std::collections::HashMap<::std::string::String, super::types::KeysAndAttributes>> {
...
impl BatchGetItemInput {
    ...
    pub fn builder() -> super::operation::batch_get_item::builders::BatchGetItemInputBuilder {
        super::operation::batch_get_item::builders::BatchGetItemInputBuilder::default()
    }
}
...
pub struct BatchGetItemInputBuilder {
    pub(crate) request_items: ::std::option::Option<::std::collections::HashMap<::std::string::String, super::types::KeysAndAttributes>>,
...
impl BatchGetItemInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::batch_get_item::BatchGetItemInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::batch_get_item::BatchGetItemInput {
