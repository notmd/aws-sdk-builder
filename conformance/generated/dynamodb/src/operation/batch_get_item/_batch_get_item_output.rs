...
pub struct BatchGetItemOutput {
    ...
    pub responses: ::std::option::Option<
        ::std::collections::HashMap<
            ::std::string::String,
            ::std::vec::Vec<::std::collections::HashMap<::std::string::String, super::types::AttributeValue>>,
        >,
    >,
    ...
    pub unprocessed_keys: ::std::option::Option<::std::collections::HashMap<::std::string::String, super::types::KeysAndAttributes>>,
...
impl BatchGetItemOutput {
    ...
    /// </ul>
    /// <p>If there are no unprocessed keys remaining, the response contains an empty <code>UnprocessedKeys</code> map.</p>
    pub fn unprocessed_keys(&self) -> ::std::option::Option<&::std::collections::HashMap<::std::string::String, super::types::KeysAndAttributes>> {
...
impl BatchGetItemOutput {
    ...
    pub fn builder() -> super::operation::batch_get_item::builders::BatchGetItemOutputBuilder {
        super::operation::batch_get_item::builders::BatchGetItemOutputBuilder::default()
    }
}
...
pub struct BatchGetItemOutputBuilder {
    pub(crate) responses: ::std::option::Option<
        ...
        >,
    >,
    pub(crate) unprocessed_keys: ::std::option::Option<::std::collections::HashMap<::std::string::String, super::types::KeysAndAttributes>>,
...
impl BatchGetItemOutputBuilder {
    ...
    pub fn responses(
        ...
        v: ::std::vec::Vec<::std::collections::HashMap<::std::string::String, super::types::AttributeValue>>,
    ) -> Self {
    ...
    /// </ul>
    /// <p>If there are no unprocessed keys remaining, the response contains an empty <code>UnprocessedKeys</code> map.</p>
    pub fn unprocessed_keys(mut self, k: impl ::std::convert::Into<::std::string::String>, v: super::types::KeysAndAttributes) -> Self {
    ...
    pub fn get_unprocessed_keys(
        &self,
    ) -> &::std::option::Option<::std::collections::HashMap<::std::string::String, super::types::KeysAndAttributes>> {
    ...
    pub fn build(self) -> super::operation::batch_get_item::BatchGetItemOutput {
