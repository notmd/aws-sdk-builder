    ...
    pub fn build(self) -> super::Input { self.input }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::BatchGetItemOutput, super::BatchGetItemError> {
                         ...
                         if !status.is_success() {
                             return Err(super::BatchGetItemError::unhandled_with_request_ids(format!("BatchGetItem returned HTTP {}", status), response.header("x-amzn-requestid").map(str::to_owned), ::std::option::Option::None));
                         }
