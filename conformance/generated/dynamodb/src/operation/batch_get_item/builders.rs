...
pub use super::operation::batch_get_item::_batch_get_item_input::BatchGetItemInputBuilder;

pub use super::operation::batch_get_item::_batch_get_item_output::BatchGetItemOutputBuilder;

impl super::operation::batch_get_item::builders::BatchGetItemInputBuilder {
...
pub struct BatchGetItemFluentBuilder {
    ...
    inner: super::operation::batch_get_item::builders::BatchGetItemInputBuilder,
...
impl BatchGetItemFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::batch_get_item::builders::BatchGetItemInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::batch_get_item::BatchGetItem::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::batch_get_item::BatchGetItem::orchestrate(&runtime_plugins, input).await
    }
    ...
    /// </ul>
    pub fn request_items(mut self, k: impl ::std::convert::Into<::std::string::String>, v: super::types::KeysAndAttributes) -> Self {
    ...
    pub fn set_request_items(
        mut self,
        input: ::std::option::Option<::std::collections::HashMap<::std::string::String, super::types::KeysAndAttributes>>,
    ) -> Self {
    ...
    /// <p><code>AttributesToGet</code> - This is a legacy parameter. Use <code>ProjectionExpression</code> instead. For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.AttributesToGet.html">AttributesToGet</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p></li>
    /// </ul>
    pub fn get_request_items(&self) -> &::std::option::Option<::std::collections::HashMap<::std::string::String, super::types::KeysAndAttributes>> {
