...
pub struct CreateGlobalTableInput {
    ...
    pub replication_group: ::std::option::Option<::std::vec::Vec<super::types::Replica>>,
}
impl CreateGlobalTableInput {
    ...
    pub fn replication_group(&self) -> &[super::types::Replica] {
...
impl CreateGlobalTableInput {
    ...
    pub fn builder() -> super::operation::create_global_table::builders::CreateGlobalTableInputBuilder {
        super::operation::create_global_table::builders::CreateGlobalTableInputBuilder::default()
    }
}
...
pub struct CreateGlobalTableInputBuilder {
    ...
    pub(crate) replication_group: ::std::option::Option<::std::vec::Vec<super::types::Replica>>,
}
impl CreateGlobalTableInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::create_global_table::CreateGlobalTableInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::create_global_table::CreateGlobalTableInput {
