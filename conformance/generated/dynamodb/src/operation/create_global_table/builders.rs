...
pub use super::operation::create_global_table::_create_global_table_input::CreateGlobalTableInputBuilder;

pub use super::operation::create_global_table::_create_global_table_output::CreateGlobalTableOutputBuilder;

impl super::operation::create_global_table::builders::CreateGlobalTableInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::Client,
    ) -> ::std::result::Result<
        super::operation::create_global_table::CreateGlobalTableOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::create_global_table::CreateGlobalTableError,
...
pub struct CreateGlobalTableFluentBuilder {
    ...
    inner: super::operation::create_global_table::builders::CreateGlobalTableInputBuilder,
...
impl CreateGlobalTableFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::create_global_table::builders::CreateGlobalTableInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::create_global_table::CreateGlobalTable::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::create_global_table::CreateGlobalTable::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn replication_group(mut self, input: super::types::Replica) -> Self {
        self.inner = self.inner.replication_group(input);
        self
    }
    /// <p>The Regions where the global table needs to be created.</p>
    pub fn set_replication_group(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::Replica>>) -> Self {
        self.inner = self.inner.set_replication_group(input);
        self
    }
    /// <p>The Regions where the global table needs to be created.</p>
    pub fn get_replication_group(&self) -> &::std::option::Option<::std::vec::Vec<super::types::Replica>> {
