    ...
    pub fn build(self) -> super::Input { self.input }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::CreateGlobalTableOutput, super::CreateGlobalTableError> {
                         ...
                         if !status.is_success() {
                             return Err(super::CreateGlobalTableError::unhandled_with_request_ids(format!("CreateGlobalTable returned HTTP {}", status), response.header("x-amzn-requestid").map(str::to_owned), ::std::option::Option::None));
                         }
