...
pub mod _untag_resource_input {
    include!(concat!(env!("OUT_DIR"), "/generated/dynamodb/src/operation/untag_resource/_untag_resource_input.rs"));
}
pub use _untag_resource_input::UntagResourceInput;
pub type Input = UntagResourceInput;
pub mod _untag_resource_output {
    include!(concat!(env!("OUT_DIR"), "/generated/dynamodb/src/operation/untag_resource/_untag_resource_output.rs"));
}
...
/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/dynamodb/src/operation/untag_resource/builders.rs"));
}
