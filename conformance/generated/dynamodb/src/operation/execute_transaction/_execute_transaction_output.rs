...
pub struct ExecuteTransactionOutput {
    ...
    pub responses: ::std::option::Option<::std::vec::Vec<super::types::ItemResponse>>,
...
impl ExecuteTransactionOutput {
    ...
    pub fn responses(&self) -> &[super::types::ItemResponse] {
...
impl ExecuteTransactionOutput {
    ...
    pub fn builder() -> super::operation::execute_transaction::builders::ExecuteTransactionOutputBuilder {
        super::operation::execute_transaction::builders::ExecuteTransactionOutputBuilder::default()
    }
}
...
pub struct ExecuteTransactionOutputBuilder {
    pub(crate) responses: ::std::option::Option<::std::vec::Vec<super::types::ItemResponse>>,
...
impl ExecuteTransactionOutputBuilder {
    ...
    ///
    /// <p>The response to a PartiQL transaction.</p>
    pub fn responses(mut self, input: super::types::ItemResponse) -> Self {
    ...
    /// <p>The response to a PartiQL transaction.</p>
    pub fn set_responses(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::ItemResponse>>) -> Self {
        self.responses = input;
        self
    }
    /// <p>The response to a PartiQL transaction.</p>
    pub fn get_responses(&self) -> &::std::option::Option<::std::vec::Vec<super::types::ItemResponse>> {
        &self.responses
    }
    ...
    pub fn build(self) -> super::operation::execute_transaction::ExecuteTransactionOutput {
