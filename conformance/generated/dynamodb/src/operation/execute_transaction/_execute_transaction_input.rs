...
pub struct ExecuteTransactionInput {
    ...
    pub transact_statements: ::std::option::Option<::std::vec::Vec<super::types::ParameterizedStatement>>,
...
impl ExecuteTransactionInput {
    ...
    pub fn transact_statements(&self) -> &[super::types::ParameterizedStatement] {
...
impl ExecuteTransactionInput {
    ...
    pub fn builder() -> super::operation::execute_transaction::builders::ExecuteTransactionInputBuilder {
        super::operation::execute_transaction::builders::ExecuteTransactionInputBuilder::default()
    }
}
...
pub struct ExecuteTransactionInputBuilder {
    pub(crate) transact_statements: ::std::option::Option<::std::vec::Vec<super::types::ParameterizedStatement>>,
...
impl ExecuteTransactionInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::execute_transaction::ExecuteTransactionInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::execute_transaction::ExecuteTransactionInput {
