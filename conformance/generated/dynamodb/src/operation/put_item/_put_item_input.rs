...
impl PutItemInput {
    ...
    pub fn builder() -> super::operation::put_item::builders::PutItemInputBuilder {
        super::operation::put_item::builders::PutItemInputBuilder::default()
    }
}
...
impl PutItemInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::put_item::PutItemInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::put_item::PutItemInput {
