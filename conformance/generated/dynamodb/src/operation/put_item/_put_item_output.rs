...
impl PutItemOutput {
    ...
    pub fn builder() -> super::operation::put_item::builders::PutItemOutputBuilder {
        super::operation::put_item::builders::PutItemOutputBuilder::default()
    }
}
...
impl PutItemOutputBuilder {
    ...
    pub fn build(self) -> super::operation::put_item::PutItemOutput {
