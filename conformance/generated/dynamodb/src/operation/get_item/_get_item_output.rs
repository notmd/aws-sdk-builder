...
impl GetItemOutput {
    ...
    pub fn builder() -> super::operation::get_item::builders::GetItemOutputBuilder {
        super::operation::get_item::builders::GetItemOutputBuilder::default()
    }
}
...
impl GetItemOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_item::GetItemOutput {
