...
impl GetItemInput {
    ...
    pub fn builder() -> super::operation::get_item::builders::GetItemInputBuilder {
        super::operation::get_item::builders::GetItemInputBuilder::default()
    }
}
...
impl GetItemInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::get_item::GetItemInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_item::GetItemInput {
