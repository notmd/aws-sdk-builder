...
pub mod _enable_kinesis_streaming_destination_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/dynamodb/src/operation/enable_kinesis_streaming_destination/_enable_kinesis_streaming_destination_input.rs"
    ));
}
...
pub mod _enable_kinesis_streaming_destination_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/dynamodb/src/operation/enable_kinesis_streaming_destination/_enable_kinesis_streaming_destination_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/dynamodb/src/operation/enable_kinesis_streaming_destination/builders.rs"
    ));
}
