...
pub mod _update_item_input {
    include!(concat!(env!("OUT_DIR"), "/generated/dynamodb/src/operation/update_item/_update_item_input.rs"));
}
pub use _update_item_input::UpdateItemInput;
pub type Input = UpdateItemInput;
pub mod _update_item_output {
    include!(concat!(env!("OUT_DIR"), "/generated/dynamodb/src/operation/update_item/_update_item_output.rs"));
}
pub use _update_item_output::UpdateItemOutput;
pub type Output = UpdateItemOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/dynamodb/src/operation/update_item/builders.rs"));
}
