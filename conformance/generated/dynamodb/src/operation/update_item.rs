    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::update_item::UpdateItemError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::update_item::UpdateItemOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateItemResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_update_item::de_update_item_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_update_item::de_update_item_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateItemRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::update_item::UpdateItemInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::update_item::UpdateItemInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_update_item::ser_update_item_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::update_item::UpdateItemError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::update_item::_update_item_input::UpdateItemInput;

pub use super::operation::update_item::_update_item_output::UpdateItemOutput;
