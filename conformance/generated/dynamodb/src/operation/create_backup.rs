...
impl CreateBackup {
    ...
    pub(crate) async fn orchestrate(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::create_backup::CreateBackupError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::create_backup::CreateBackupError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::create_backup::CreateBackupOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateBackupResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_create_backup::de_create_backup_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_create_backup::de_create_backup_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateBackupRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::create_backup::CreateBackupInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::create_backup::CreateBackupInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_create_backup::ser_create_backup_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::create_backup::CreateBackupError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::create_backup::_create_backup_input::CreateBackupInput;

pub use super::operation::create_backup::_create_backup_output::CreateBackupOutput;
