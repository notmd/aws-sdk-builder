...
pub struct DescribeContributorInsightsOutput {
    ...
    pub contributor_insights_status: ::std::option::Option<super::types::ContributorInsightsStatus>,
    ...
    /// </ul>
    pub failure_exception: ::std::option::Option<super::types::FailureException>,
    ...
    pub contributor_insights_mode: ::std::option::Option<super::types::ContributorInsightsMode>,
...
impl DescribeContributorInsightsOutput {
    ...
    /// <p>Current status of contributor insights.</p>
    pub fn contributor_insights_status(&self) -> ::std::option::Option<&super::types::ContributorInsightsStatus> {
    ...
    /// <p>InternalServerError - Failed to create Amazon CloudWatch Contributor Insights rules. Please retry request.</p></li>
    /// </ul>
    pub fn failure_exception(&self) -> ::std::option::Option<&super::types::FailureException> {
        self.failure_exception.as_ref()
    }
    /// <p>The mode of CloudWatch Contributor Insights for DynamoDB that determines which events are emitted. Can be set to track all access and throttled events or throttled events only.</p>
    pub fn contributor_insights_mode(&self) -> ::std::option::Option<&super::types::ContributorInsightsMode> {
...
impl DescribeContributorInsightsOutput {
    ...
    pub fn builder() -> super::operation::describe_contributor_insights::builders::DescribeContributorInsightsOutputBuilder {
        super::operation::describe_contributor_insights::builders::DescribeContributorInsightsOutputBuilder::default()
    }
}
...
pub struct DescribeContributorInsightsOutputBuilder {
    ...
    pub(crate) contributor_insights_status: ::std::option::Option<super::types::ContributorInsightsStatus>,
    pub(crate) last_update_date_time: ::std::option::Option<::aws_smithy_types::DateTime>,
    pub(crate) failure_exception: ::std::option::Option<super::types::FailureException>,
    pub(crate) contributor_insights_mode: ::std::option::Option<super::types::ContributorInsightsMode>,
    _request_id: Option<String>,
}
impl DescribeContributorInsightsOutputBuilder {
    ...
    /// <p>Current status of contributor insights.</p>
    pub fn contributor_insights_status(mut self, input: super::types::ContributorInsightsStatus) -> Self {
        self.contributor_insights_status = ::std::option::Option::Some(input);
        self
    }
    /// <p>Current status of contributor insights.</p>
    pub fn set_contributor_insights_status(mut self, input: ::std::option::Option<super::types::ContributorInsightsStatus>) -> Self {
        self.contributor_insights_status = input;
        self
    }
    /// <p>Current status of contributor insights.</p>
    pub fn get_contributor_insights_status(&self) -> &::std::option::Option<super::types::ContributorInsightsStatus> {
    ...
    /// <p>InternalServerError - Failed to create Amazon CloudWatch Contributor Insights rules. Please retry request.</p></li>
    /// </ul>
    pub fn failure_exception(mut self, input: super::types::FailureException) -> Self {
    ...
    /// <p>InternalServerError - Failed to create Amazon CloudWatch Contributor Insights rules. Please retry request.</p></li>
    /// </ul>
    pub fn set_failure_exception(mut self, input: ::std::option::Option<super::types::FailureException>) -> Self {
    ...
    /// <p>InternalServerError - Failed to create Amazon CloudWatch Contributor Insights rules. Please retry request.</p></li>
    /// </ul>
    pub fn get_failure_exception(&self) -> &::std::option::Option<super::types::FailureException> {
        &self.failure_exception
    }
    /// <p>The mode of CloudWatch Contributor Insights for DynamoDB that determines which events are emitted. Can be set to track all access and throttled events or throttled events only.</p>
    pub fn contributor_insights_mode(mut self, input: super::types::ContributorInsightsMode) -> Self {
        self.contributor_insights_mode = ::std::option::Option::Some(input);
        self
    }
    /// <p>The mode of CloudWatch Contributor Insights for DynamoDB that determines which events are emitted. Can be set to track all access and throttled events or throttled events only.</p>
    pub fn set_contributor_insights_mode(mut self, input: ::std::option::Option<super::types::ContributorInsightsMode>) -> Self {
        self.contributor_insights_mode = input;
        self
    }
    /// <p>The mode of CloudWatch Contributor Insights for DynamoDB that determines which events are emitted. Can be set to track all access and throttled events or throttled events only.</p>
    pub fn get_contributor_insights_mode(&self) -> &::std::option::Option<super::types::ContributorInsightsMode> {
    ...
    pub fn build(self) -> super::operation::describe_contributor_insights::DescribeContributorInsightsOutput {
