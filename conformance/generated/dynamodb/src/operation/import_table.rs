    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::import_table::ImportTableError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::import_table::ImportTableOutput>()
    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(super::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut super::operation::import_table::ImportTableInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ImportTableResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_import_table::de_import_table_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_import_table::de_import_table_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ImportTableRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::import_table::ImportTableInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::import_table::ImportTableInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_import_table::ser_import_table_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::import_table::ImportTableError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::import_table::_import_table_input::ImportTableInput;

pub use super::operation::import_table::_import_table_output::ImportTableOutput;
