    ...
    pub fn build(self) -> super::Input { self.input }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::UpdateTimeToLiveOutput, super::UpdateTimeToLiveError> {
                         ...
                         if !status.is_success() {
                             return Err(super::UpdateTimeToLiveError::unhandled_with_request_ids(format!("UpdateTimeToLive returned HTTP {}", status), response.header("x-amzn-requestid").map(str::to_owned), ::std::option::Option::None));
                         }
