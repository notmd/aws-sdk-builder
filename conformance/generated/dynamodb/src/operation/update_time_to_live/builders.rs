...
pub use super::operation::update_time_to_live::_update_time_to_live_input::UpdateTimeToLiveInputBuilder;

pub use super::operation::update_time_to_live::_update_time_to_live_output::UpdateTimeToLiveOutputBuilder;

impl super::operation::update_time_to_live::builders::UpdateTimeToLiveInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::Client,
    ) -> ::std::result::Result<
        super::operation::update_time_to_live::UpdateTimeToLiveOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::update_time_to_live::UpdateTimeToLiveError,
...
pub struct UpdateTimeToLiveFluentBuilder {
    ...
    inner: super::operation::update_time_to_live::builders::UpdateTimeToLiveInputBuilder,
...
impl UpdateTimeToLiveFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::update_time_to_live::builders::UpdateTimeToLiveInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::update_time_to_live::UpdateTimeToLive::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::update_time_to_live::UpdateTimeToLive::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn time_to_live_specification(mut self, input: super::types::TimeToLiveSpecification) -> Self {
        self.inner = self.inner.time_to_live_specification(input);
        self
    }
    /// <p>Represents the settings used to enable or disable Time to Live for the specified table.</p>
    pub fn set_time_to_live_specification(mut self, input: ::std::option::Option<super::types::TimeToLiveSpecification>) -> Self {
        self.inner = self.inner.set_time_to_live_specification(input);
        self
    }
    /// <p>Represents the settings used to enable or disable Time to Live for the specified table.</p>
    pub fn get_time_to_live_specification(&self) -> &::std::option::Option<super::types::TimeToLiveSpecification> {
