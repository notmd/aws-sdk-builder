    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::update_global_table_settings::UpdateGlobalTableSettingsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::update_global_table_settings::UpdateGlobalTableSettingsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateGlobalTableSettingsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_update_global_table_settings::de_update_global_table_settings_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_update_global_table_settings::de_update_global_table_settings_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateGlobalTableSettingsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::update_global_table_settings::UpdateGlobalTableSettingsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::update_global_table_settings::UpdateGlobalTableSettingsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_update_global_table_settings::ser_update_global_table_settings_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::update_global_table_settings::UpdateGlobalTableSettingsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::update_global_table_settings::_update_global_table_settings_input::UpdateGlobalTableSettingsInput;

pub use super::operation::update_global_table_settings::_update_global_table_settings_output::UpdateGlobalTableSettingsOutput;
