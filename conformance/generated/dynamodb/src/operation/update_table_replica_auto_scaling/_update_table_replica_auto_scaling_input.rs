...
pub struct UpdateTableReplicaAutoScalingInput {
    ...
    pub global_secondary_index_updates: ::std::option::Option<::std::vec::Vec<super::types::GlobalSecondaryIndexAutoScalingUpdate>>,
    ...
    pub provisioned_write_capacity_auto_scaling_update: ::std::option::Option<super::types::AutoScalingSettingsUpdate>,
    /// <p>Represents the auto scaling settings of replicas of the table that will be modified.</p>
    pub replica_updates: ::std::option::Option<::std::vec::Vec<super::types::ReplicaAutoScalingUpdate>>,
}
impl UpdateTableReplicaAutoScalingInput {
    ...
    pub fn global_secondary_index_updates(&self) -> &[super::types::GlobalSecondaryIndexAutoScalingUpdate] {
    ...
    /// <p>Represents the auto scaling settings to be modified for a global table or global secondary index.</p>
    pub fn provisioned_write_capacity_auto_scaling_update(&self) -> ::std::option::Option<&super::types::AutoScalingSettingsUpdate> {
    ...
    pub fn replica_updates(&self) -> &[super::types::ReplicaAutoScalingUpdate] {
...
impl UpdateTableReplicaAutoScalingInput {
    ...
    pub fn builder() -> super::operation::update_table_replica_auto_scaling::builders::UpdateTableReplicaAutoScalingInputBuilder {
        super::operation::update_table_replica_auto_scaling::builders::UpdateTableReplicaAutoScalingInputBuilder::default()
    }
}
...
pub struct UpdateTableReplicaAutoScalingInputBuilder {
    pub(crate) global_secondary_index_updates: ::std::option::Option<::std::vec::Vec<super::types::GlobalSecondaryIndexAutoScalingUpdate>>,
    pub(crate) table_name: ::std::option::Option<::std::string::String>,
    pub(crate) provisioned_write_capacity_auto_scaling_update: ::std::option::Option<super::types::AutoScalingSettingsUpdate>,
    pub(crate) replica_updates: ::std::option::Option<::std::vec::Vec<super::types::ReplicaAutoScalingUpdate>>,
}
impl UpdateTableReplicaAutoScalingInputBuilder {
    ...
    ///
    /// <p>Represents the auto scaling settings of the global secondary indexes of the replica to be updated.</p>
    pub fn global_secondary_index_updates(mut self, input: super::types::GlobalSecondaryIndexAutoScalingUpdate) -> Self {
    ...
    pub fn set_global_secondary_index_updates(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::GlobalSecondaryIndexAutoScalingUpdate>>,
    ) -> Self {
        self.global_secondary_index_updates = input;
        self
    }
    /// <p>Represents the auto scaling settings of the global secondary indexes of the replica to be updated.</p>
    pub fn get_global_secondary_index_updates(&self) -> &::std::option::Option<::std::vec::Vec<super::types::GlobalSecondaryIndexAutoScalingUpdate>> {
    ...
    /// <p>Represents the auto scaling settings to be modified for a global table or global secondary index.</p>
    pub fn provisioned_write_capacity_auto_scaling_update(mut self, input: super::types::AutoScalingSettingsUpdate) -> Self {
    ...
    /// <p>Represents the auto scaling settings to be modified for a global table or global secondary index.</p>
    pub fn get_provisioned_write_capacity_auto_scaling_update(&self) -> &::std::option::Option<super::types::AutoScalingSettingsUpdate> {
    ...
    ///
    /// <p>Represents the auto scaling settings of replicas of the table that will be modified.</p>
    pub fn replica_updates(mut self, input: super::types::ReplicaAutoScalingUpdate) -> Self {
    ...
    /// <p>Represents the auto scaling settings of replicas of the table that will be modified.</p>
    pub fn set_replica_updates(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::ReplicaAutoScalingUpdate>>) -> Self {
        self.replica_updates = input;
        self
    }
    /// <p>Represents the auto scaling settings of replicas of the table that will be modified.</p>
    pub fn get_replica_updates(&self) -> &::std::option::Option<::std::vec::Vec<super::types::ReplicaAutoScalingUpdate>> {
    ...
    pub fn build(
        ...
        super::operation::update_table_replica_auto_scaling::UpdateTableReplicaAutoScalingInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::update_table_replica_auto_scaling::UpdateTableReplicaAutoScalingInput {
