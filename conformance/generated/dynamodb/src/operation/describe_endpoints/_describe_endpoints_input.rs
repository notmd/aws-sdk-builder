...
impl DescribeEndpointsInput {
    ...
    pub fn builder() -> super::operation::describe_endpoints::builders::DescribeEndpointsInputBuilder {
        super::operation::describe_endpoints::builders::DescribeEndpointsInputBuilder::default()
    }
}
...
impl DescribeEndpointsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::describe_endpoints::DescribeEndpointsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::describe_endpoints::DescribeEndpointsInput {})
    }
}
