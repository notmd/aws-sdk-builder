    ...
    pub fn build(self) -> super::Input { self.input }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::UpdateContinuousBackupsOutput, super::UpdateContinuousBackupsError> {
                         ...
                         if !status.is_success() {
                             return Err(super::UpdateContinuousBackupsError::unhandled_with_request_ids(format!("UpdateContinuousBackups returned HTTP {}", status), response.header("x-amzn-requestid").map(str::to_owned), ::std::option::Option::None));
                         }
