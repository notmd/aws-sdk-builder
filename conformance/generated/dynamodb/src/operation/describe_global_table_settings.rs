...
pub mod _describe_global_table_settings_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/dynamodb/src/operation/describe_global_table_settings/_describe_global_table_settings_input.rs"
    ));
}
...
pub mod _describe_global_table_settings_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/dynamodb/src/operation/describe_global_table_settings/_describe_global_table_settings_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/dynamodb/src/operation/describe_global_table_settings/builders.rs"
    ));
}
