...
pub mod _get_item_input {
    include!(concat!(env!("OUT_DIR"), "/generated/dynamodb/src/operation/get_item/_get_item_input.rs"));
}
pub use _get_item_input::GetItemInput;
pub type Input = GetItemInput;
pub mod _get_item_output {
    include!(concat!(env!("OUT_DIR"), "/generated/dynamodb/src/operation/get_item/_get_item_output.rs"));
}
pub use _get_item_output::GetItemOutput;
pub type Output = GetItemOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/dynamodb/src/operation/get_item/builders.rs"));
}
