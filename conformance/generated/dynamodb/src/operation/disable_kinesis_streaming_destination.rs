...
pub mod _disable_kinesis_streaming_destination_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/dynamodb/src/operation/disable_kinesis_streaming_destination/_disable_kinesis_streaming_destination_input.rs"
    ));
}
...
pub mod _disable_kinesis_streaming_destination_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/dynamodb/src/operation/disable_kinesis_streaming_destination/_disable_kinesis_streaming_destination_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/dynamodb/src/operation/disable_kinesis_streaming_destination/builders.rs"
    ));
}
