    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::update_table::UpdateTableError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::update_table::UpdateTableOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateTableResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_update_table::de_update_table_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_update_table::de_update_table_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateTableRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::update_table::UpdateTableInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::update_table::UpdateTableInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_update_table::ser_update_table_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::update_table::UpdateTableError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::update_table::_update_table_input::UpdateTableInput;

pub use super::operation::update_table::_update_table_output::UpdateTableOutput;
