...
pub mod _update_table_input {
    include!(concat!(env!("OUT_DIR"), "/generated/dynamodb/src/operation/update_table/_update_table_input.rs"));
}
pub use _update_table_input::UpdateTableInput;
pub type Input = UpdateTableInput;
pub mod _update_table_output {
    include!(concat!(env!("OUT_DIR"), "/generated/dynamodb/src/operation/update_table/_update_table_output.rs"));
}
pub use _update_table_output::UpdateTableOutput;
pub type Output = UpdateTableOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/dynamodb/src/operation/update_table/builders.rs"));
}
