...
impl DeleteTableInput {
    ...
    pub fn builder() -> super::operation::delete_table::builders::DeleteTableInputBuilder {
        super::operation::delete_table::builders::DeleteTableInputBuilder::default()
    }
}
...
impl DeleteTableInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::delete_table::DeleteTableInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::delete_table::DeleteTableInput { table_name: self.table_name })
    }
}
