...
impl TransactWriteItemsOutput {
    ...
    pub fn builder() -> super::operation::transact_write_items::builders::TransactWriteItemsOutputBuilder {
        super::operation::transact_write_items::builders::TransactWriteItemsOutputBuilder::default()
    }
}
...
impl TransactWriteItemsOutputBuilder {
    ...
    pub fn build(self) -> super::operation::transact_write_items::TransactWriteItemsOutput {
