...
impl ListExportsInput {
    ...
    pub fn builder() -> super::operation::list_exports::builders::ListExportsInputBuilder {
        super::operation::list_exports::builders::ListExportsInputBuilder::default()
    }
}
...
impl ListExportsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::list_exports::ListExportsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_exports::ListExportsInput {
