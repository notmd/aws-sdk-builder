...
pub struct BatchExecuteStatementOutput {
    ...
    pub responses: ::std::option::Option<::std::vec::Vec<super::types::BatchStatementResponse>>,
...
impl BatchExecuteStatementOutput {
    ...
    pub fn responses(&self) -> &[super::types::BatchStatementResponse] {
...
impl BatchExecuteStatementOutput {
    ...
    pub fn builder() -> super::operation::batch_execute_statement::builders::BatchExecuteStatementOutputBuilder {
        super::operation::batch_execute_statement::builders::BatchExecuteStatementOutputBuilder::default()
    }
}
...
pub struct BatchExecuteStatementOutputBuilder {
    pub(crate) responses: ::std::option::Option<::std::vec::Vec<super::types::BatchStatementResponse>>,
...
impl BatchExecuteStatementOutputBuilder {
    ...
    ///
    /// <p>The response to each PartiQL statement in the batch. The values of the list are ordered according to the ordering of the request statements.</p>
    pub fn responses(mut self, input: super::types::BatchStatementResponse) -> Self {
    ...
    /// <p>The response to each PartiQL statement in the batch. The values of the list are ordered according to the ordering of the request statements.</p>
    pub fn set_responses(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::BatchStatementResponse>>) -> Self {
        self.responses = input;
        self
    }
    /// <p>The response to each PartiQL statement in the batch. The values of the list are ordered according to the ordering of the request statements.</p>
    pub fn get_responses(&self) -> &::std::option::Option<::std::vec::Vec<super::types::BatchStatementResponse>> {
        &self.responses
    }
    ...
    pub fn build(self) -> super::operation::batch_execute_statement::BatchExecuteStatementOutput {
