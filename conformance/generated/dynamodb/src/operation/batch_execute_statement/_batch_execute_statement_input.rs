...
pub struct BatchExecuteStatementInput {
    ...
    pub statements: ::std::option::Option<::std::vec::Vec<super::types::BatchStatementRequest>>,
...
impl BatchExecuteStatementInput {
    ...
    pub fn statements(&self) -> &[super::types::BatchStatementRequest] {
...
impl BatchExecuteStatementInput {
    ...
    pub fn builder() -> super::operation::batch_execute_statement::builders::BatchExecuteStatementInputBuilder {
        super::operation::batch_execute_statement::builders::BatchExecuteStatementInputBuilder::default()
    }
}
...
pub struct BatchExecuteStatementInputBuilder {
    pub(crate) statements: ::std::option::Option<::std::vec::Vec<super::types::BatchStatementRequest>>,
...
impl BatchExecuteStatementInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::batch_execute_statement::BatchExecuteStatementInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::batch_execute_statement::BatchExecuteStatementInput {
