...
pub use super::operation::batch_execute_statement::_batch_execute_statement_input::BatchExecuteStatementInputBuilder;

pub use super::operation::batch_execute_statement::_batch_execute_statement_output::BatchExecuteStatementOutputBuilder;

impl super::operation::batch_execute_statement::builders::BatchExecuteStatementInputBuilder {
...
pub struct BatchExecuteStatementFluentBuilder {
    ...
    inner: super::operation::batch_execute_statement::builders::BatchExecuteStatementInputBuilder,
...
impl BatchExecuteStatementFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::batch_execute_statement::builders::BatchExecuteStatementInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::batch_execute_statement::BatchExecuteStatement::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::batch_execute_statement::BatchExecuteStatement::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn statements(mut self, input: super::types::BatchStatementRequest) -> Self {
        self.inner = self.inner.statements(input);
        self
    }
    /// <p>The list of PartiQL statements representing the batch to run.</p>
    pub fn set_statements(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::BatchStatementRequest>>) -> Self {
        self.inner = self.inner.set_statements(input);
        self
    }
    /// <p>The list of PartiQL statements representing the batch to run.</p>
    pub fn get_statements(&self) -> &::std::option::Option<::std::vec::Vec<super::types::BatchStatementRequest>> {
