...
impl DescribeExportInput {
    ...
    pub fn builder() -> super::operation::describe_export::builders::DescribeExportInputBuilder {
        super::operation::describe_export::builders::DescribeExportInputBuilder::default()
    }
}
...
impl DescribeExportInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::describe_export::DescribeExportInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::describe_export::DescribeExportInput { export_arn: self.export_arn })
    }
}
