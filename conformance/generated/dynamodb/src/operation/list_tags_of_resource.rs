...
pub mod _list_tags_of_resource_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/dynamodb/src/operation/list_tags_of_resource/_list_tags_of_resource_input.rs"
    ));
}
...
pub mod _list_tags_of_resource_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/dynamodb/src/operation/list_tags_of_resource/_list_tags_of_resource_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/dynamodb/src/operation/list_tags_of_resource/builders.rs"
    ));
}
