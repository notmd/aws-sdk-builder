...
pub struct UpdateGlobalTableSettingsInput {
    ...
    /// </ul>
    pub global_table_billing_mode: ::std::option::Option<super::types::BillingMode>,
    ...
    pub global_table_provisioned_write_capacity_auto_scaling_settings_update: ::std::option::Option<super::types::AutoScalingSettingsUpdate>,
    /// <p>Represents the settings of a global secondary index for a global table that will be modified.</p>
    pub global_table_global_secondary_index_settings_update:
        ::std::option::Option<::std::vec::Vec<super::types::GlobalTableGlobalSecondaryIndexSettingsUpdate>>,
    /// <p>Represents the settings for a global table in a Region that will be modified.</p>
    pub replica_settings_update: ::std::option::Option<::std::vec::Vec<super::types::ReplicaSettingsUpdate>>,
}
impl UpdateGlobalTableSettingsInput {
    ...
    /// <p><code>PAY_PER_REQUEST</code> - We recommend using <code>PAY_PER_REQUEST</code> for unpredictable workloads. <code>PAY_PER_REQUEST</code> sets the billing mode to <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/on-demand-capacity-mode.html">On-demand capacity mode</a>.</p></li>
    /// </ul>
    pub fn global_table_billing_mode(&self) -> ::std::option::Option<&super::types::BillingMode> {
    ...
    pub fn global_table_provisioned_write_capacity_auto_scaling_settings_update(
        &self,
    ) -> ::std::option::Option<&super::types::AutoScalingSettingsUpdate> {
    ...
    pub fn global_table_global_secondary_index_settings_update(&self) -> &[super::types::GlobalTableGlobalSecondaryIndexSettingsUpdate] {
    ...
    pub fn replica_settings_update(&self) -> &[super::types::ReplicaSettingsUpdate] {
...
impl UpdateGlobalTableSettingsInput {
    ...
    pub fn builder() -> super::operation::update_global_table_settings::builders::UpdateGlobalTableSettingsInputBuilder {
        super::operation::update_global_table_settings::builders::UpdateGlobalTableSettingsInputBuilder::default()
    }
}
...
pub struct UpdateGlobalTableSettingsInputBuilder {
    ...
    pub(crate) global_table_billing_mode: ::std::option::Option<super::types::BillingMode>,
    pub(crate) global_table_provisioned_write_capacity_units: ::std::option::Option<i64>,
    pub(crate) global_table_provisioned_write_capacity_auto_scaling_settings_update: ::std::option::Option<super::types::AutoScalingSettingsUpdate>,
    pub(crate) global_table_global_secondary_index_settings_update:
        ::std::option::Option<::std::vec::Vec<super::types::GlobalTableGlobalSecondaryIndexSettingsUpdate>>,
    pub(crate) replica_settings_update: ::std::option::Option<::std::vec::Vec<super::types::ReplicaSettingsUpdate>>,
}
impl UpdateGlobalTableSettingsInputBuilder {
    ...
    /// <p><code>PAY_PER_REQUEST</code> - We recommend using <code>PAY_PER_REQUEST</code> for unpredictable workloads. <code>PAY_PER_REQUEST</code> sets the billing mode to <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/on-demand-capacity-mode.html">On-demand capacity mode</a>.</p></li>
    /// </ul>
    pub fn global_table_billing_mode(mut self, input: super::types::BillingMode) -> Self {
    ...
    /// <p><code>PAY_PER_REQUEST</code> - We recommend using <code>PAY_PER_REQUEST</code> for unpredictable workloads. <code>PAY_PER_REQUEST</code> sets the billing mode to <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/on-demand-capacity-mode.html">On-demand capacity mode</a>.</p></li>
    /// </ul>
    pub fn set_global_table_billing_mode(mut self, input: ::std::option::Option<super::types::BillingMode>) -> Self {
    ...
    /// <p><code>PAY_PER_REQUEST</code> - We recommend using <code>PAY_PER_REQUEST</code> for unpredictable workloads. <code>PAY_PER_REQUEST</code> sets the billing mode to <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/on-demand-capacity-mode.html">On-demand capacity mode</a>.</p></li>
    /// </ul>
    pub fn get_global_table_billing_mode(&self) -> &::std::option::Option<super::types::BillingMode> {
    ...
    /// <p>Auto scaling settings for managing provisioned write capacity for the global table.</p>
    pub fn global_table_provisioned_write_capacity_auto_scaling_settings_update(mut self, input: super::types::AutoScalingSettingsUpdate) -> Self {
    ...
    pub fn set_global_table_provisioned_write_capacity_auto_scaling_settings_update(
        mut self,
        input: ::std::option::Option<super::types::AutoScalingSettingsUpdate>,
    ) -> Self {
    ...
    ///
    /// <p>Represents the settings of a global secondary index for a global table that will be modified.</p>
    pub fn global_table_global_secondary_index_settings_update(mut self, input: super::types::GlobalTableGlobalSecondaryIndexSettingsUpdate) -> Self {
    ...
    pub fn set_global_table_global_secondary_index_settings_update(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::GlobalTableGlobalSecondaryIndexSettingsUpdate>>,
    ) -> Self {
    ...
    ///
    /// <p>Represents the settings for a global table in a Region that will be modified.</p>
    pub fn replica_settings_update(mut self, input: super::types::ReplicaSettingsUpdate) -> Self {
    ...
    /// <p>Represents the settings for a global table in a Region that will be modified.</p>
    pub fn set_replica_settings_update(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::ReplicaSettingsUpdate>>) -> Self {
        self.replica_settings_update = input;
        self
    }
    /// <p>Represents the settings for a global table in a Region that will be modified.</p>
    pub fn get_replica_settings_update(&self) -> &::std::option::Option<::std::vec::Vec<super::types::ReplicaSettingsUpdate>> {
    ...
    pub fn build(
        ...
        super::operation::update_global_table_settings::UpdateGlobalTableSettingsInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::update_global_table_settings::UpdateGlobalTableSettingsInput {
