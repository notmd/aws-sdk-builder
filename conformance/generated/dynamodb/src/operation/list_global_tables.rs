...
pub mod _list_global_tables_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/dynamodb/src/operation/list_global_tables/_list_global_tables_input.rs"
    ));
}
...
pub mod _list_global_tables_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/dynamodb/src/operation/list_global_tables/_list_global_tables_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/dynamodb/src/operation/list_global_tables/builders.rs"
    ));
}
