...
impl TransactGetItems {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::operation::transact_get_items::TransactGetItemsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::transact_get_items::TransactGetItemsError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::transact_get_items::TransactGetItemsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::transact_get_items::TransactGetItemsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for TransactGetItemsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_transact_get_items::de_transact_get_items_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_transact_get_items::de_transact_get_items_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for TransactGetItemsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::transact_get_items::TransactGetItemsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::transact_get_items::TransactGetItemsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_transact_get_items::ser_transact_get_items_input(&input)?);
...
fn get_resource_arn_list(input: &super::operation::transact_get_items::TransactGetItemsInput) -> Option<::std::vec::Vec<&::std::string::String>> {
    ...
    let _prj_4 = _fld_1
        ...
        .flat_map(|v| {
            ...
            fn map(_v: &super::types::TransactGetItem) -> ::std::option::Option<&::std::string::String> {
...
impl ::aws_types::request_id::RequestId for super::operation::transact_get_items::TransactGetItemsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::transact_get_items::_transact_get_items_input::TransactGetItemsInput;

pub use super::operation::transact_get_items::_transact_get_items_output::TransactGetItemsOutput;
