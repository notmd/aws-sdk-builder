...
pub struct ListBackupsInput {
    ...
    /// </ul>
    pub backup_type: ::std::option::Option<super::types::BackupTypeFilter>,
}
impl ListBackupsInput {
    ...
    /// <p><code>ALL</code> - All types of on-demand backups (USER and SYSTEM).</p></li>
    /// </ul>
    pub fn backup_type(&self) -> ::std::option::Option<&super::types::BackupTypeFilter> {
...
impl ListBackupsInput {
    ...
    pub fn builder() -> super::operation::list_backups::builders::ListBackupsInputBuilder {
        super::operation::list_backups::builders::ListBackupsInputBuilder::default()
    }
}
...
pub struct ListBackupsInputBuilder {
    ...
    pub(crate) backup_type: ::std::option::Option<super::types::BackupTypeFilter>,
}
impl ListBackupsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::list_backups::ListBackupsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_backups::ListBackupsInput {
