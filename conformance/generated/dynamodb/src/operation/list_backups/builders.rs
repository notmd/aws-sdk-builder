    ...
    pub fn build(self) -> super::Input { self.input }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::ListBackupsOutput, super::ListBackupsError> {
                         ...
                         if !status.is_success() {
                             return Err(super::ListBackupsError::unhandled_with_request_ids(format!("ListBackups returned HTTP {}", status), response.header("x-amzn-requestid").map(str::to_owned), ::std::option::Option::None));
                         }
