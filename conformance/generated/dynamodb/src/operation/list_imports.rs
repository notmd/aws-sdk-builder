// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        impl Output {
            pub fn import_summary_list(&self) -> &[super::super::types::ImportSummary] { self.import_summary_list.as_deref().unwrap_or(&[]) }
            pub fn next_token(&self) -> ::std::option::Option<&str> { self.next_token.as_deref() }
        }
        pub type ListImportsInput = Input;
        pub type ListImportsOutput = Output;
