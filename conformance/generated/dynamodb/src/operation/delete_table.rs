...
impl DeleteTable {
    ...
    pub(crate) async fn orchestrate(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::delete_table::DeleteTableError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_table::DeleteTableError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_table::DeleteTableOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteTableResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_table::de_delete_table_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_table::de_delete_table_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteTableRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_table::DeleteTableInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_table::DeleteTableInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_delete_table::ser_delete_table_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::delete_table::DeleteTableError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_table::_delete_table_input::DeleteTableInput;

pub use super::operation::delete_table::_delete_table_output::DeleteTableOutput;
