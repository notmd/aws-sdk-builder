...
impl DescribeBackupInput {
    ...
    pub fn builder() -> super::operation::describe_backup::builders::DescribeBackupInputBuilder {
        super::operation::describe_backup::builders::DescribeBackupInputBuilder::default()
    }
}
...
impl DescribeBackupInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::describe_backup::DescribeBackupInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::describe_backup::DescribeBackupInput { backup_arn: self.backup_arn })
    }
}
