...
impl DescribeLimitsInput {
    ...
    pub fn builder() -> super::operation::describe_limits::builders::DescribeLimitsInputBuilder {
        super::operation::describe_limits::builders::DescribeLimitsInputBuilder::default()
    }
}
...
impl DescribeLimitsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::describe_limits::DescribeLimitsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::describe_limits::DescribeLimitsInput {})
    }
}
