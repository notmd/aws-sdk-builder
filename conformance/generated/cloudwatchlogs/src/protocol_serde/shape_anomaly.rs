...
pub(crate) fn de_anomaly<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::types::Anomaly>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::types::builders::AnomalyBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "histogram" => {
                            builder = builder.set_histogram(super::protocol_serde::shape_histogram::de_histogram(tokens, _value, depth + 1)?);
                        }
                        "logSamples" => {
                            builder = builder.set_log_samples(super::protocol_serde::shape_log_samples::de_log_samples(tokens, _value, depth + 1)?);
                        }
                        "patternTokens" => {
                            builder = builder.set_pattern_tokens(super::protocol_serde::shape_pattern_tokens::de_pattern_tokens(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
            ...
            Ok(Some(super::serde_util::anomaly_correct_errors(builder).build().map_err(|err| {
