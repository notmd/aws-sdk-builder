...
pub fn de_start_live_tail_http_error(
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::start_live_tail::StartLiveTailError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => super::operation::start_live_tail::StartLiveTailError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidOperationException" => super::operation::start_live_tail::StartLiveTailError::InvalidOperationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidParameterException" => super::operation::start_live_tail::StartLiveTailError::InvalidParameterException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "LimitExceededException" => super::operation::start_live_tail::StartLiveTailError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => super::operation::start_live_tail::StartLiveTailError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn ser_start_live_tail_input(
    ...
    super::protocol_serde::shape_start_live_tail_input::ser_start_live_tail_input_input(&mut object, input)?;
    object.finish();
