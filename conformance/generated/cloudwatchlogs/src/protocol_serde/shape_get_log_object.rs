...
pub fn de_get_log_object_http_error(
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::get_log_object::GetLogObjectError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => super::operation::get_log_object::GetLogObjectError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidOperationException" => super::operation::get_log_object::GetLogObjectError::InvalidOperationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidParameterException" => super::operation::get_log_object::GetLogObjectError::InvalidParameterException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "LimitExceededException" => super::operation::get_log_object::GetLogObjectError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => super::operation::get_log_object::GetLogObjectError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn ser_get_log_object_input(
    ...
    super::protocol_serde::shape_get_log_object_input::ser_get_log_object_input_input(&mut object, input)?;
    object.finish();
