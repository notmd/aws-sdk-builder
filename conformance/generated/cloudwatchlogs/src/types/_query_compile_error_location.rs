...
impl QueryCompileErrorLocation {
    ...
    pub fn builder() -> super::types::builders::QueryCompileErrorLocationBuilder {
        super::types::builders::QueryCompileErrorLocationBuilder::default()
    }
}
...
impl QueryCompileErrorLocationBuilder {
    ...
    pub fn build(self) -> super::types::QueryCompileErrorLocation {
        super::types::QueryCompileErrorLocation {
