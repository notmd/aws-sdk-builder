...
impl ImportStatistics {
    ...
    pub fn builder() -> super::types::builders::ImportStatisticsBuilder {
        super::types::builders::ImportStatisticsBuilder::default()
    }
}
...
impl ImportStatisticsBuilder {
    ...
    pub fn build(self) -> super::types::ImportStatistics {
        super::types::ImportStatistics {
