...
impl ParseRoute53 {
    ...
    pub fn builder() -> super::types::builders::ParseRoute53Builder {
        super::types::builders::ParseRoute53Builder::default()
    }
}
...
impl ParseRoute53Builder {
    ...
    pub fn build(self) -> super::types::ParseRoute53 {
        super::types::ParseRoute53 { source: self.source }
    }
}
