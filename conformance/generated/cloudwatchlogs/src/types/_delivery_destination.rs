...
/// <p>This structure contains information about one <i>delivery destination</i> in your account. A delivery destination is an Amazon Web Services resource that represents an Amazon Web Services service that logs can be sent to. CloudWatch Logs, Amazon S3, Firehose, and X-Ray are supported as delivery destinations.</p>
...
pub struct DeliveryDestination {
    ...
    pub output_format: ::std::option::Option<super::types::OutputFormat>,
    /// <p>A structure that contains the ARN of the Amazon Web Services resource that will receive the logs.</p>
    pub delivery_destination_configuration: ::std::option::Option<super::types::DeliveryDestinationConfiguration>,
...
impl DeliveryDestination {
    ...
    /// <p>The format of the logs that are sent to this delivery destination.</p>
    pub fn output_format(&self) -> ::std::option::Option<&super::types::OutputFormat> {
        self.output_format.as_ref()
    }
    /// <p>A structure that contains the ARN of the Amazon Web Services resource that will receive the logs.</p>
    pub fn delivery_destination_configuration(&self) -> ::std::option::Option<&super::types::DeliveryDestinationConfiguration> {
...
impl DeliveryDestination {
    ...
    pub fn builder() -> super::types::builders::DeliveryDestinationBuilder {
        super::types::builders::DeliveryDestinationBuilder::default()
    }
}
...
pub struct DeliveryDestinationBuilder {
    ...
    pub(crate) output_format: ::std::option::Option<super::types::OutputFormat>,
    pub(crate) delivery_destination_configuration: ::std::option::Option<super::types::DeliveryDestinationConfiguration>,
...
impl DeliveryDestinationBuilder {
    ...
    /// <p>The format of the logs that are sent to this delivery destination.</p>
    pub fn output_format(mut self, input: super::types::OutputFormat) -> Self {
        self.output_format = ::std::option::Option::Some(input);
        self
    }
    /// <p>The format of the logs that are sent to this delivery destination.</p>
    pub fn set_output_format(mut self, input: ::std::option::Option<super::types::OutputFormat>) -> Self {
        self.output_format = input;
        self
    }
    /// <p>The format of the logs that are sent to this delivery destination.</p>
    pub fn get_output_format(&self) -> &::std::option::Option<super::types::OutputFormat> {
        &self.output_format
    }
    /// <p>A structure that contains the ARN of the Amazon Web Services resource that will receive the logs.</p>
    pub fn delivery_destination_configuration(mut self, input: super::types::DeliveryDestinationConfiguration) -> Self {
        self.delivery_destination_configuration = ::std::option::Option::Some(input);
        self
    }
    /// <p>A structure that contains the ARN of the Amazon Web Services resource that will receive the logs.</p>
    pub fn set_delivery_destination_configuration(mut self, input: ::std::option::Option<super::types::DeliveryDestinationConfiguration>) -> Self {
        self.delivery_destination_configuration = input;
        self
    }
    /// <p>A structure that contains the ARN of the Amazon Web Services resource that will receive the logs.</p>
    pub fn get_delivery_destination_configuration(&self) -> &::std::option::Option<super::types::DeliveryDestinationConfiguration> {
    ...
    pub fn build(self) -> super::types::DeliveryDestination {
        super::types::DeliveryDestination {
            name: self.name,
            arn: self.arn,
