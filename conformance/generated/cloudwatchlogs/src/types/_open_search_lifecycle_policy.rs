...
impl OpenSearchLifecyclePolicy {
    ...
    pub fn builder() -> super::types::builders::OpenSearchLifecyclePolicyBuilder {
        super::types::builders::OpenSearchLifecyclePolicyBuilder::default()
    }
}
...
impl OpenSearchLifecyclePolicyBuilder {
    ...
    pub fn build(self) -> super::types::OpenSearchLifecyclePolicy {
        super::types::OpenSearchLifecyclePolicy {
