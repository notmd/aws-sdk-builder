...
pub struct OpenSearchDataAccessPolicy {
    ...
    pub status: ::std::option::Option<super::types::OpenSearchResourceStatus>,
}
impl OpenSearchDataAccessPolicy {
    ...
    /// <p>This structure contains information about the status of this OpenSearch Service resource.</p>
    pub fn status(&self) -> ::std::option::Option<&super::types::OpenSearchResourceStatus> {
        self.status.as_ref()
    }
}
impl OpenSearchDataAccessPolicy {
    /// Creates a new builder-style object to manufacture [`OpenSearchDataAccessPolicy`](crate::types::OpenSearchDataAccessPolicy).
    pub fn builder() -> super::types::builders::OpenSearchDataAccessPolicyBuilder {
        super::types::builders::OpenSearchDataAccessPolicyBuilder::default()
    }
}
...
pub struct OpenSearchDataAccessPolicyBuilder {
    ...
    pub(crate) status: ::std::option::Option<super::types::OpenSearchResourceStatus>,
}
impl OpenSearchDataAccessPolicyBuilder {
    ...
    /// <p>This structure contains information about the status of this OpenSearch Service resource.</p>
    pub fn status(mut self, input: super::types::OpenSearchResourceStatus) -> Self {
        self.status = ::std::option::Option::Some(input);
        self
    }
    /// <p>This structure contains information about the status of this OpenSearch Service resource.</p>
    pub fn set_status(mut self, input: ::std::option::Option<super::types::OpenSearchResourceStatus>) -> Self {
        self.status = input;
        self
    }
    /// <p>This structure contains information about the status of this OpenSearch Service resource.</p>
    pub fn get_status(&self) -> &::std::option::Option<super::types::OpenSearchResourceStatus> {
        &self.status
    }
    /// Consumes the builder and constructs a [`OpenSearchDataAccessPolicy`](crate::types::OpenSearchDataAccessPolicy).
    pub fn build(self) -> super::types::OpenSearchDataAccessPolicy {
        super::types::OpenSearchDataAccessPolicy {
