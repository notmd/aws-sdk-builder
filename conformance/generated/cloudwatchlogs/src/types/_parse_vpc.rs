...
impl ParseVpc {
    ...
    pub fn builder() -> super::types::builders::ParseVpcBuilder {
        super::types::builders::ParseVpcBuilder::default()
    }
}
...
impl ParseVpcBuilder {
    ...
    pub fn build(self) -> super::types::ParseVpc {
        super::types::ParseVpc { source: self.source }
    }
}
