...
impl OpenSearchResourceConfig {
    ...
    pub fn builder() -> super::types::builders::OpenSearchResourceConfigBuilder {
        super::types::builders::OpenSearchResourceConfigBuilder::default()
    }
}
...
impl OpenSearchResourceConfigBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::OpenSearchResourceConfig, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::OpenSearchResourceConfig {
