...
impl SearchedLogStream {
    ...
    pub fn builder() -> super::types::builders::SearchedLogStreamBuilder {
        super::types::builders::SearchedLogStreamBuilder::default()
    }
}
...
impl SearchedLogStreamBuilder {
    ...
    pub fn build(self) -> super::types::SearchedLogStream {
        super::types::SearchedLogStream {
