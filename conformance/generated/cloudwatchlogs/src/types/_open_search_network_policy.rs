...
impl OpenSearchNetworkPolicy {
    ...
    pub fn builder() -> super::types::builders::OpenSearchNetworkPolicyBuilder {
        super::types::builders::OpenSearchNetworkPolicyBuilder::default()
    }
}
...
impl OpenSearchNetworkPolicyBuilder {
    ...
    pub fn build(self) -> super::types::OpenSearchNetworkPolicy {
        super::types::OpenSearchNetworkPolicy {
