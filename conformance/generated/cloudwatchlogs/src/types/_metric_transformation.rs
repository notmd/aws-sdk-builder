...
pub struct MetricTransformation {
    ...
    pub unit: ::std::option::Option<super::types::StandardUnit>,
}
impl MetricTransformation {
    ...
    /// <p>The unit to assign to the metric. If you omit this, the unit is set as <code>None</code>.</p>
    pub fn unit(&self) -> ::std::option::Option<&super::types::StandardUnit> {
        self.unit.as_ref()
    }
}
impl MetricTransformation {
    /// Creates a new builder-style object to manufacture [`MetricTransformation`](crate::types::MetricTransformation).
    pub fn builder() -> super::types::builders::MetricTransformationBuilder {
        super::types::builders::MetricTransformationBuilder::default()
    }
}
...
pub struct MetricTransformationBuilder {
    ...
    pub(crate) unit: ::std::option::Option<super::types::StandardUnit>,
}
impl MetricTransformationBuilder {
    ...
    /// <p>The unit to assign to the metric. If you omit this, the unit is set as <code>None</code>.</p>
    pub fn unit(mut self, input: super::types::StandardUnit) -> Self {
        self.unit = ::std::option::Option::Some(input);
        self
    }
    /// <p>The unit to assign to the metric. If you omit this, the unit is set as <code>None</code>.</p>
    pub fn set_unit(mut self, input: ::std::option::Option<super::types::StandardUnit>) -> Self {
        self.unit = input;
        self
    }
    /// <p>The unit to assign to the metric. If you omit this, the unit is set as <code>None</code>.</p>
    pub fn get_unit(&self) -> &::std::option::Option<super::types::StandardUnit> {
        &self.unit
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::types::MetricTransformation, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::MetricTransformation {
