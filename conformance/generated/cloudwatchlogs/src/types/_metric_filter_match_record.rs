...
impl MetricFilterMatchRecord {
    ...
    pub fn builder() -> super::types::builders::MetricFilterMatchRecordBuilder {
        super::types::builders::MetricFilterMatchRecordBuilder::default()
    }
}
...
impl MetricFilterMatchRecordBuilder {
    ...
    pub fn build(self) -> super::types::MetricFilterMatchRecord {
        super::types::MetricFilterMatchRecord {
