...
impl LiveTailSessionLogEvent {
    ...
    pub fn builder() -> super::types::builders::LiveTailSessionLogEventBuilder {
        super::types::builders::LiveTailSessionLogEventBuilder::default()
    }
}
...
impl LiveTailSessionLogEventBuilder {
    ...
    pub fn build(self) -> super::types::LiveTailSessionLogEvent {
        super::types::LiveTailSessionLogEvent {
