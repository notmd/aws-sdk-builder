...
impl S3DeliveryConfiguration {
    ...
    pub fn builder() -> super::types::builders::S3DeliveryConfigurationBuilder {
        super::types::builders::S3DeliveryConfigurationBuilder::default()
    }
}
...
impl S3DeliveryConfigurationBuilder {
    ...
    pub fn build(self) -> super::types::S3DeliveryConfiguration {
        super::types::S3DeliveryConfiguration {
