...
impl ResourcePolicy {
    ...
    pub fn builder() -> super::types::builders::ResourcePolicyBuilder {
        super::types::builders::ResourcePolicyBuilder::default()
    }
}
...
impl ResourcePolicyBuilder {
    ...
    pub fn build(self) -> super::types::ResourcePolicy {
        super::types::ResourcePolicy {
