...
impl ParseWaf {
    ...
    pub fn builder() -> super::types::builders::ParseWafBuilder {
        super::types::builders::ParseWafBuilder::default()
    }
}
...
impl ParseWafBuilder {
    ...
    pub fn build(self) -> super::types::ParseWaf {
        super::types::ParseWaf { source: self.source }
    }
}
