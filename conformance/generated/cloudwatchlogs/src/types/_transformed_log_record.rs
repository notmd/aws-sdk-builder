...
impl TransformedLogRecord {
    ...
    pub fn builder() -> super::types::builders::TransformedLogRecordBuilder {
        super::types::builders::TransformedLogRecordBuilder::default()
    }
}
...
impl TransformedLogRecordBuilder {
    ...
    pub fn build(self) -> super::types::TransformedLogRecord {
        super::types::TransformedLogRecord {
