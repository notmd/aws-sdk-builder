...
impl ConfigurationTemplateDeliveryConfigValues {
    ...
    pub fn builder() -> super::types::builders::ConfigurationTemplateDeliveryConfigValuesBuilder {
        super::types::builders::ConfigurationTemplateDeliveryConfigValuesBuilder::default()
    }
}
...
impl ConfigurationTemplateDeliveryConfigValuesBuilder {
    ...
    pub fn build(self) -> super::types::ConfigurationTemplateDeliveryConfigValues {
        super::types::ConfigurationTemplateDeliveryConfigValues {
