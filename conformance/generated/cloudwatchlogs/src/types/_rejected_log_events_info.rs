...
impl RejectedLogEventsInfo {
    ...
    pub fn builder() -> super::types::builders::RejectedLogEventsInfoBuilder {
        super::types::builders::RejectedLogEventsInfoBuilder::default()
    }
}
...
impl RejectedLogEventsInfoBuilder {
    ...
    pub fn build(self) -> super::types::RejectedLogEventsInfo {
        super::types::RejectedLogEventsInfo {
