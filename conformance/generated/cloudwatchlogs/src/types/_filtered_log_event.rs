...
impl FilteredLogEvent {
    ...
    pub fn builder() -> super::types::builders::FilteredLogEventBuilder {
        super::types::builders::FilteredLogEventBuilder::default()
    }
}
...
impl FilteredLogEventBuilder {
    ...
    pub fn build(self) -> super::types::FilteredLogEvent {
        super::types::FilteredLogEvent {
