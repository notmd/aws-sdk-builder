...
impl RenameKeyEntry {
    ...
    pub fn builder() -> super::types::builders::RenameKeyEntryBuilder {
        super::types::builders::RenameKeyEntryBuilder::default()
    }
}
...
impl RenameKeyEntryBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::RenameKeyEntry, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::RenameKeyEntry {
