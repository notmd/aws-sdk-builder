...
impl TypeConverterEntry {
    ...
    /// <p>The type to convert the field value to. Valid values are <code>integer</code>, <code>double</code>, <code>string</code> and <code>boolean</code>.</p>
    pub fn r#type(&self) -> &super::types::Type {
        &self.r#type
    }
}
impl TypeConverterEntry {
    /// Creates a new builder-style object to manufacture [`TypeConverterEntry`](crate::types::TypeConverterEntry).
    pub fn builder() -> super::types::builders::TypeConverterEntryBuilder {
        super::types::builders::TypeConverterEntryBuilder::default()
    }
}
...
pub struct TypeConverterEntryBuilder {
    ...
    pub(crate) r#type: ::std::option::Option<super::types::Type>,
}
impl TypeConverterEntryBuilder {
    ...
    /// <p>The type to convert the field value to. Valid values are <code>integer</code>, <code>double</code>, <code>string</code> and <code>boolean</code>.</p>
    /// This field is required.
    pub fn r#type(mut self, input: super::types::Type) -> Self {
        self.r#type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The type to convert the field value to. Valid values are <code>integer</code>, <code>double</code>, <code>string</code> and <code>boolean</code>.</p>
    pub fn set_type(mut self, input: ::std::option::Option<super::types::Type>) -> Self {
        self.r#type = input;
        self
    }
    /// <p>The type to convert the field value to. Valid values are <code>integer</code>, <code>double</code>, <code>string</code> and <code>boolean</code>.</p>
    pub fn get_type(&self) -> &::std::option::Option<super::types::Type> {
        &self.r#type
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::types::TypeConverterEntry, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::TypeConverterEntry {
