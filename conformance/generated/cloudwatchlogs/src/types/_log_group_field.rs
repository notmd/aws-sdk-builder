...
impl LogGroupField {
    ...
    pub fn builder() -> super::types::builders::LogGroupFieldBuilder {
        super::types::builders::LogGroupFieldBuilder::default()
    }
}
...
impl LogGroupFieldBuilder {
    ...
    pub fn build(self) -> super::types::LogGroupField {
        super::types::LogGroupField {
            name: self.name,
