...
impl QueryInfo {
    ...
    pub fn builder() -> super::types::builders::QueryInfoBuilder {
        super::types::builders::QueryInfoBuilder::default()
    }
}
...
impl QueryInfoBuilder {
    ...
    pub fn build(self) -> super::types::QueryInfo {
        super::types::QueryInfo {
