...
impl LiveTailSessionMetadata {
    ...
    pub fn builder() -> super::types::builders::LiveTailSessionMetadataBuilder {
        super::types::builders::LiveTailSessionMetadataBuilder::default()
    }
}
...
impl LiveTailSessionMetadataBuilder {
    ...
    pub fn build(self) -> super::types::LiveTailSessionMetadata {
        super::types::LiveTailSessionMetadata {
