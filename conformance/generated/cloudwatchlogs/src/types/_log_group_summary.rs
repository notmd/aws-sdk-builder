...
impl LogGroupSummary {
    ...
    pub fn builder() -> super::types::builders::LogGroupSummaryBuilder {
        super::types::builders::LogGroupSummaryBuilder::default()
    }
}
...
impl LogGroupSummaryBuilder {
    ...
    pub fn build(self) -> super::types::LogGroupSummary {
        super::types::LogGroupSummary {
