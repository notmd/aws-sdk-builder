...
impl InputLogEvent {
    ...
    pub fn builder() -> super::types::builders::InputLogEventBuilder {
        super::types::builders::InputLogEventBuilder::default()
    }
}
...
impl InputLogEventBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::InputLogEvent, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::InputLogEvent {
