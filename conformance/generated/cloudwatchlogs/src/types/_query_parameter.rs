...
impl QueryParameter {
    ...
    pub fn builder() -> super::types::builders::QueryParameterBuilder {
        super::types::builders::QueryParameterBuilder::default()
    }
}
...
impl QueryParameterBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::QueryParameter, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::QueryParameter {
