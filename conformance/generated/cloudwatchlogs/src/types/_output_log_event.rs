...
impl OutputLogEvent {
    ...
    pub fn builder() -> super::types::builders::OutputLogEventBuilder {
        super::types::builders::OutputLogEventBuilder::default()
    }
}
...
impl OutputLogEventBuilder {
    ...
    pub fn build(self) -> super::types::OutputLogEvent {
