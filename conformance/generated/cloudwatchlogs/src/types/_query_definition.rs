...
impl QueryDefinition {
    ...
    pub fn builder() -> super::types::builders::QueryDefinitionBuilder {
        super::types::builders::QueryDefinitionBuilder::default()
    }
}
...
impl QueryDefinitionBuilder {
    ...
    pub fn build(self) -> super::types::QueryDefinition {
        super::types::QueryDefinition {
