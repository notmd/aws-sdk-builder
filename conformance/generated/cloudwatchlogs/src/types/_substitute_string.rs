...
pub struct SubstituteString {
    ...
    pub entries: ::std::vec::Vec<super::types::SubstituteStringEntry>,
}
impl SubstituteString {
    /// <p>An array of objects, where each object contains the information about one key to match and replace.</p>
    pub fn entries(&self) -> &[super::types::SubstituteStringEntry] {
        use std::ops::Deref;
        self.entries.deref()
    }
}
impl SubstituteString {
    ...
    pub fn builder() -> super::types::builders::SubstituteStringBuilder {
        super::types::builders::SubstituteStringBuilder::default()
    }
}
...
pub struct SubstituteStringBuilder {
    pub(crate) entries: ::std::option::Option<::std::vec::Vec<super::types::SubstituteStringEntry>>,
}
impl SubstituteStringBuilder {
    ...
    ///
    /// <p>An array of objects, where each object contains the information about one key to match and replace.</p>
    pub fn entries(mut self, input: super::types::SubstituteStringEntry) -> Self {
    ...
    /// <p>An array of objects, where each object contains the information about one key to match and replace.</p>
    pub fn set_entries(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::SubstituteStringEntry>>) -> Self {
        self.entries = input;
        self
    }
    /// <p>An array of objects, where each object contains the information about one key to match and replace.</p>
    pub fn get_entries(&self) -> &::std::option::Option<::std::vec::Vec<super::types::SubstituteStringEntry>> {
        &self.entries
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::types::SubstituteString, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::SubstituteString {
