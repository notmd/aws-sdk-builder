...
impl DeleteKeys {
    ...
    pub fn builder() -> super::types::builders::DeleteKeysBuilder {
        super::types::builders::DeleteKeysBuilder::default()
    }
}
...
impl DeleteKeysBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::DeleteKeys, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::DeleteKeys {
