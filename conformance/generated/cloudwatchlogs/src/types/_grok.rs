...
impl Grok {
    ...
    pub fn builder() -> super::types::builders::GrokBuilder {
        super::types::builders::GrokBuilder::default()
    }
}
...
impl GrokBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::Grok, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::Grok {
            source: self.source,
