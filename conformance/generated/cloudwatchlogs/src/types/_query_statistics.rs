...
impl QueryStatistics {
    ...
    pub fn builder() -> super::types::builders::QueryStatisticsBuilder {
        super::types::builders::QueryStatisticsBuilder::default()
    }
}
...
impl QueryStatisticsBuilder {
    ...
    pub fn build(self) -> super::types::QueryStatistics {
        super::types::QueryStatistics {
