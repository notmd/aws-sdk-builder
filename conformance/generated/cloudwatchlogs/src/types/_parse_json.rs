...
impl ParseJson {
    ...
    pub fn builder() -> super::types::builders::ParseJsonBuilder {
        super::types::builders::ParseJsonBuilder::default()
    }
}
...
impl ParseJsonBuilder {
    ...
    pub fn build(self) -> super::types::ParseJson {
        super::types::ParseJson {
            source: self.source,
