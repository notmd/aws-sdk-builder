...
impl AnomalyDetector {
    ...
    pub fn builder() -> super::types::builders::AnomalyDetectorBuilder {
        super::types::builders::AnomalyDetectorBuilder::default()
    }
}
...
impl AnomalyDetectorBuilder {
    ...
    pub fn build(self) -> super::types::AnomalyDetector {
