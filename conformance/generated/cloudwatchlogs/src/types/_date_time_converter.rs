...
impl DateTimeConverter {
    ...
    pub fn builder() -> super::types::builders::DateTimeConverterBuilder {
        super::types::builders::DateTimeConverterBuilder::default()
    }
}
...
impl DateTimeConverterBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::DateTimeConverter, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::DateTimeConverter {
