...
impl ParseCloudfront {
    ...
    pub fn builder() -> super::types::builders::ParseCloudfrontBuilder {
        super::types::builders::ParseCloudfrontBuilder::default()
    }
}
...
impl ParseCloudfrontBuilder {
    ...
    pub fn build(self) -> super::types::ParseCloudfront {
        super::types::ParseCloudfront { source: self.source }
    }
}
