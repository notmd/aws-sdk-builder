...
impl LiveTailSessionStart {
    ...
    pub fn builder() -> super::types::builders::LiveTailSessionStartBuilder {
        super::types::builders::LiveTailSessionStartBuilder::default()
    }
}
...
impl LiveTailSessionStartBuilder {
    ...
    pub fn build(self) -> super::types::LiveTailSessionStart {
        super::types::LiveTailSessionStart {
