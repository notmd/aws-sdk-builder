...
impl OpenSearchCollection {
    ...
    pub fn builder() -> super::types::builders::OpenSearchCollectionBuilder {
        super::types::builders::OpenSearchCollectionBuilder::default()
    }
}
...
impl OpenSearchCollectionBuilder {
    ...
    pub fn build(self) -> super::types::OpenSearchCollection {
        super::types::OpenSearchCollection {
