...
pub struct LiveTailSessionUpdate {
    ...
    pub session_metadata: ::std::option::Option<super::types::LiveTailSessionMetadata>,
    ...
    pub session_results: ::std::option::Option<::std::vec::Vec<super::types::LiveTailSessionLogEvent>>,
}
impl LiveTailSessionUpdate {
    /// <p>This object contains the session metadata for a Live Tail session.</p>
    pub fn session_metadata(&self) -> ::std::option::Option<&super::types::LiveTailSessionMetadata> {
    ...
    pub fn session_results(&self) -> &[super::types::LiveTailSessionLogEvent] {
...
impl LiveTailSessionUpdate {
    ...
    pub fn builder() -> super::types::builders::LiveTailSessionUpdateBuilder {
        super::types::builders::LiveTailSessionUpdateBuilder::default()
    }
}
...
pub struct LiveTailSessionUpdateBuilder {
    pub(crate) session_metadata: ::std::option::Option<super::types::LiveTailSessionMetadata>,
    pub(crate) session_results: ::std::option::Option<::std::vec::Vec<super::types::LiveTailSessionLogEvent>>,
}
impl LiveTailSessionUpdateBuilder {
    /// <p>This object contains the session metadata for a Live Tail session.</p>
    pub fn session_metadata(mut self, input: super::types::LiveTailSessionMetadata) -> Self {
        self.session_metadata = ::std::option::Option::Some(input);
        self
    }
    /// <p>This object contains the session metadata for a Live Tail session.</p>
    pub fn set_session_metadata(mut self, input: ::std::option::Option<super::types::LiveTailSessionMetadata>) -> Self {
        self.session_metadata = input;
        self
    }
    /// <p>This object contains the session metadata for a Live Tail session.</p>
    pub fn get_session_metadata(&self) -> &::std::option::Option<super::types::LiveTailSessionMetadata> {
    ...
    /// <p>An array, where each member of the array includes the information for one log event in the Live Tail session.</p>
    /// <p>A <code>sessionResults</code> array can include as many as 500 log events. If the number of log events matching the request exceeds 500 per second, the log events are sampled down to 500 log events to be included in each <code>sessionUpdate</code> structure.</p>
    pub fn session_results(mut self, input: super::types::LiveTailSessionLogEvent) -> Self {
    ...
    /// <p>An array, where each member of the array includes the information for one log event in the Live Tail session.</p>
    /// <p>A <code>sessionResults</code> array can include as many as 500 log events. If the number of log events matching the request exceeds 500 per second, the log events are sampled down to 500 log events to be included in each <code>sessionUpdate</code> structure.</p>
    pub fn set_session_results(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::LiveTailSessionLogEvent>>) -> Self {
        self.session_results = input;
        self
    }
    /// <p>An array, where each member of the array includes the information for one log event in the Live Tail session.</p>
    /// <p>A <code>sessionResults</code> array can include as many as 500 log events. If the number of log events matching the request exceeds 500 per second, the log events are sampled down to 500 log events to be included in each <code>sessionUpdate</code> structure.</p>
    pub fn get_session_results(&self) -> &::std::option::Option<::std::vec::Vec<super::types::LiveTailSessionLogEvent>> {
        &self.session_results
    }
    /// Consumes the builder and constructs a [`LiveTailSessionUpdate`](crate::types::LiveTailSessionUpdate).
    pub fn build(self) -> super::types::LiveTailSessionUpdate {
        super::types::LiveTailSessionUpdate {
