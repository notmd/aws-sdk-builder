...
impl Anomaly {
    ...
    /// <p>An array of sample log event messages that are considered to be part of this anomaly.</p>
    pub fn log_samples(&self) -> &[super::types::LogEvent] {
        use std::ops::Deref;
        self.log_samples.deref()
    }
    /// <p>An array of structures where each structure contains information about one token that makes up the pattern.</p>
    pub fn pattern_tokens(&self) -> &[super::types::PatternToken] {
        use std::ops::Deref;
...
impl Anomaly {
    ...
    pub fn builder() -> super::types::builders::AnomalyBuilder {
        super::types::builders::AnomalyBuilder::default()
    }
}
...
pub struct AnomalyBuilder {
    ...
    pub(crate) log_samples: ::std::option::Option<::std::vec::Vec<super::types::LogEvent>>,
    pub(crate) pattern_tokens: ::std::option::Option<::std::vec::Vec<super::types::PatternToken>>,
...
impl AnomalyBuilder {
    ...
    ///
    /// <p>An array of sample log event messages that are considered to be part of this anomaly.</p>
    pub fn log_samples(mut self, input: super::types::LogEvent) -> Self {
    ...
    /// <p>An array of sample log event messages that are considered to be part of this anomaly.</p>
    pub fn set_log_samples(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::LogEvent>>) -> Self {
        self.log_samples = input;
        self
    }
    /// <p>An array of sample log event messages that are considered to be part of this anomaly.</p>
    pub fn get_log_samples(&self) -> &::std::option::Option<::std::vec::Vec<super::types::LogEvent>> {
        &self.log_samples
    }
    ...
    ///
    /// <p>An array of structures where each structure contains information about one token that makes up the pattern.</p>
    pub fn pattern_tokens(mut self, input: super::types::PatternToken) -> Self {
    ...
    /// <p>An array of structures where each structure contains information about one token that makes up the pattern.</p>
    pub fn set_pattern_tokens(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::PatternToken>>) -> Self {
        self.pattern_tokens = input;
        self
    }
    /// <p>An array of structures where each structure contains information about one token that makes up the pattern.</p>
    pub fn get_pattern_tokens(&self) -> &::std::option::Option<::std::vec::Vec<super::types::PatternToken>> {
        &self.pattern_tokens
    }
    ...
    pub fn build(self) -> ::std::result::Result<super::types::Anomaly, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::Anomaly {
