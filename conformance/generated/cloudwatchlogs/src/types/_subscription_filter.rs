...
impl SubscriptionFilter {
    ...
    pub fn builder() -> super::types::builders::SubscriptionFilterBuilder {
        super::types::builders::SubscriptionFilterBuilder::default()
    }
}
...
impl SubscriptionFilterBuilder {
    ...
    pub fn build(self) -> super::types::SubscriptionFilter {
