...
impl UpperCaseString {
    ...
    pub fn builder() -> super::types::builders::UpperCaseStringBuilder {
        super::types::builders::UpperCaseStringBuilder::default()
    }
}
...
impl UpperCaseStringBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::UpperCaseString, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::UpperCaseString {
