...
impl LookupTable {
    ...
    pub fn builder() -> super::types::builders::LookupTableBuilder {
        super::types::builders::LookupTableBuilder::default()
    }
}
...
impl LookupTableBuilder {
    ...
    pub fn build(self) -> super::types::LookupTable {
        super::types::LookupTable {
