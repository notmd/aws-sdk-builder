...
impl CopyValueEntry {
    ...
    pub fn builder() -> super::types::builders::CopyValueEntryBuilder {
        super::types::builders::CopyValueEntryBuilder::default()
    }
}
...
impl CopyValueEntryBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::CopyValueEntry, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::CopyValueEntry {
