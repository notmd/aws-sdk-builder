...
impl OpenSearchApplication {
    ...
    pub fn builder() -> super::types::builders::OpenSearchApplicationBuilder {
        super::types::builders::OpenSearchApplicationBuilder::default()
    }
}
...
impl OpenSearchApplicationBuilder {
    ...
    pub fn build(self) -> super::types::OpenSearchApplication {
        super::types::OpenSearchApplication {
