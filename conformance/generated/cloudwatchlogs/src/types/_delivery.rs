...
pub struct Delivery {
    ...
    pub s3_delivery_configuration: ::std::option::Option<super::types::S3DeliveryConfiguration>,
...
impl Delivery {
    ...
    /// <p>This structure contains delivery configurations that apply only when the delivery destination resource is an S3 bucket.</p>
    pub fn s3_delivery_configuration(&self) -> ::std::option::Option<&super::types::S3DeliveryConfiguration> {
...
impl Delivery {
    ...
    pub fn builder() -> super::types::builders::DeliveryBuilder {
        super::types::builders::DeliveryBuilder::default()
    }
}
...
pub struct DeliveryBuilder {
    ...
    pub(crate) s3_delivery_configuration: ::std::option::Option<super::types::S3DeliveryConfiguration>,
...
impl DeliveryBuilder {
    ...
    pub fn build(self) -> super::types::Delivery {
