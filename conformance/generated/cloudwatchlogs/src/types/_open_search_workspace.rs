...
impl OpenSearchWorkspace {
    ...
    pub fn builder() -> super::types::builders::OpenSearchWorkspaceBuilder {
        super::types::builders::OpenSearchWorkspaceBuilder::default()
    }
}
...
impl OpenSearchWorkspaceBuilder {
    ...
    pub fn build(self) -> super::types::OpenSearchWorkspace {
        super::types::OpenSearchWorkspace {
