...
impl ResultField {
    ...
    pub fn builder() -> super::types::builders::ResultFieldBuilder {
        super::types::builders::ResultFieldBuilder::default()
    }
}
...
impl ResultFieldBuilder {
    ...
    pub fn build(self) -> super::types::ResultField {
        super::types::ResultField {
            field: self.field,
            value: self.value,
        }
    }
