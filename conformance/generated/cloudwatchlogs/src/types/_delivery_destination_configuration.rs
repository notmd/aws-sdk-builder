...
impl DeliveryDestinationConfiguration {
    ...
    pub fn builder() -> super::types::builders::DeliveryDestinationConfigurationBuilder {
        super::types::builders::DeliveryDestinationConfigurationBuilder::default()
    }
}
...
impl DeliveryDestinationConfigurationBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::DeliveryDestinationConfiguration, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::DeliveryDestinationConfiguration {
