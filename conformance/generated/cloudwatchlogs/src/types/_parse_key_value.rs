...
impl ParseKeyValue {
    ...
    pub fn builder() -> super::types::builders::ParseKeyValueBuilder {
        super::types::builders::ParseKeyValueBuilder::default()
    }
}
...
impl ParseKeyValueBuilder {
    ...
    pub fn build(self) -> super::types::ParseKeyValue {
        super::types::ParseKeyValue {
            source: self.source,
