...
impl SubstituteStringEntry {
    ...
    pub fn builder() -> super::types::builders::SubstituteStringEntryBuilder {
        super::types::builders::SubstituteStringEntryBuilder::default()
    }
}
...
impl SubstituteStringEntryBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::SubstituteStringEntry, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::SubstituteStringEntry {
