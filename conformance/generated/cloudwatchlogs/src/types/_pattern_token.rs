...
impl PatternToken {
    ...
    pub fn builder() -> super::types::builders::PatternTokenBuilder {
        super::types::builders::PatternTokenBuilder::default()
    }
}
...
impl PatternTokenBuilder {
    ...
    pub fn build(self) -> super::types::PatternToken {
        super::types::PatternToken {
