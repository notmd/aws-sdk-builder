...
pub struct SyslogConfiguration {
    ...
    pub source_type: ::std::option::Option<super::types::SyslogSourceType>,
...
impl SyslogConfiguration {
    ...
    /// <p>The source type for the syslog configuration.</p>
    pub fn source_type(&self) -> ::std::option::Option<&super::types::SyslogSourceType> {
...
impl SyslogConfiguration {
    ...
    pub fn builder() -> super::types::builders::SyslogConfigurationBuilder {
        super::types::builders::SyslogConfigurationBuilder::default()
    }
}
...
pub struct SyslogConfigurationBuilder {
    ...
    pub(crate) source_type: ::std::option::Option<super::types::SyslogSourceType>,
...
impl SyslogConfigurationBuilder {
    ...
    /// <p>The source type for the syslog configuration.</p>
    pub fn source_type(mut self, input: super::types::SyslogSourceType) -> Self {
        self.source_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The source type for the syslog configuration.</p>
    pub fn set_source_type(mut self, input: ::std::option::Option<super::types::SyslogSourceType>) -> Self {
        self.source_type = input;
        self
    }
    /// <p>The source type for the syslog configuration.</p>
    pub fn get_source_type(&self) -> &::std::option::Option<super::types::SyslogSourceType> {
        &self.source_type
    }
    /// <p>The ID of the VPC endpoint used for syslog ingestion.</p>
    ...
    pub fn build(self) -> super::types::SyslogConfiguration {
        super::types::SyslogConfiguration {
