...
impl ::aws_types::request_id::RequestId for super::types::error::DataAlreadyAcceptedException {
...
impl DataAlreadyAcceptedException {
    ...
    pub fn builder() -> super::types::error::builders::DataAlreadyAcceptedExceptionBuilder {
        super::types::error::builders::DataAlreadyAcceptedExceptionBuilder::default()
    }
}
...
impl DataAlreadyAcceptedExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::DataAlreadyAcceptedException {
        super::types::error::DataAlreadyAcceptedException {
