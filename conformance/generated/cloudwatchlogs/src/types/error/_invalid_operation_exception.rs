...
impl ::aws_types::request_id::RequestId for super::types::error::InvalidOperationException {
...
impl InvalidOperationException {
    ...
    pub fn builder() -> super::types::error::builders::InvalidOperationExceptionBuilder {
        super::types::error::builders::InvalidOperationExceptionBuilder::default()
    }
}
...
impl InvalidOperationExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::InvalidOperationException {
        super::types::error::InvalidOperationException {
