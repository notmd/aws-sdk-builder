...
pub struct ScheduledQueryDestination {
    ...
    pub destination_type: ::std::option::Option<super::types::ScheduledQueryDestinationType>,
    ...
    pub status: ::std::option::Option<super::types::ActionStatus>,
...
impl ScheduledQueryDestination {
    /// <p>The type of destination for query results.</p>
    pub fn destination_type(&self) -> ::std::option::Option<&super::types::ScheduledQueryDestinationType> {
    ...
    /// <p>The processing status of the destination delivery.</p>
    pub fn status(&self) -> ::std::option::Option<&super::types::ActionStatus> {
        self.status.as_ref()
    }
    /// <p>The identifier of the processed result at the destination.</p>
...
impl ScheduledQueryDestination {
    ...
    pub fn builder() -> super::types::builders::ScheduledQueryDestinationBuilder {
        super::types::builders::ScheduledQueryDestinationBuilder::default()
    }
}
...
pub struct ScheduledQueryDestinationBuilder {
    pub(crate) destination_type: ::std::option::Option<super::types::ScheduledQueryDestinationType>,
    pub(crate) destination_identifier: ::std::option::Option<::std::string::String>,
    pub(crate) status: ::std::option::Option<super::types::ActionStatus>,
    pub(crate) processed_identifier: ::std::option::Option<::std::string::String>,
    pub(crate) error_message: ::std::option::Option<::std::string::String>,
}
impl ScheduledQueryDestinationBuilder {
    /// <p>The type of destination for query results.</p>
    pub fn destination_type(mut self, input: super::types::ScheduledQueryDestinationType) -> Self {
        self.destination_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The type of destination for query results.</p>
    pub fn set_destination_type(mut self, input: ::std::option::Option<super::types::ScheduledQueryDestinationType>) -> Self {
        self.destination_type = input;
        self
    }
    /// <p>The type of destination for query results.</p>
    pub fn get_destination_type(&self) -> &::std::option::Option<super::types::ScheduledQueryDestinationType> {
    ...
    /// <p>The processing status of the destination delivery.</p>
    pub fn status(mut self, input: super::types::ActionStatus) -> Self {
        self.status = ::std::option::Option::Some(input);
        self
    }
    /// <p>The processing status of the destination delivery.</p>
    pub fn set_status(mut self, input: ::std::option::Option<super::types::ActionStatus>) -> Self {
        self.status = input;
        self
    }
    /// <p>The processing status of the destination delivery.</p>
    pub fn get_status(&self) -> &::std::option::Option<super::types::ActionStatus> {
        &self.status
    }
    /// <p>The identifier of the processed result at the destination.</p>
    ...
    pub fn build(self) -> super::types::ScheduledQueryDestination {
        super::types::ScheduledQueryDestination {
