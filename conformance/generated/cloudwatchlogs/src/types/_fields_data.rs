...
impl FieldsData {
    ...
    pub fn builder() -> super::types::builders::FieldsDataBuilder {
        super::types::builders::FieldsDataBuilder::default()
    }
}
...
impl FieldsDataBuilder {
    ...
    pub fn build(self) -> super::types::FieldsData {
        super::types::FieldsData { data: self.data }
    }
}
