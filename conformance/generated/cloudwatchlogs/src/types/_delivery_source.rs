...
pub struct DeliverySource {
    ...
    pub status: ::std::option::Option<super::types::DeliverySourceStatus>,
    ...
    pub status_reason: ::std::option::Option<super::types::DeliverySourceStatusReason>,
}
impl DeliverySource {
    /// <p>The unique name of the delivery source.</p>
    ...
    /// <p>The status of the delivery source. A delivery source can have the status <code>ACTIVE</code> or <code>INACTIVE</code>. Note: This value is defined for selective log types.</p>
    pub fn status(&self) -> ::std::option::Option<&super::types::DeliverySourceStatus> {
        self.status.as_ref()
    }
    /// <p>The reason for the status of the delivery source. A status reason of <code>RESOURCE_DELETED</code> indicates that the resource associated with the delivery source has been deleted. Note: This value is defined for selective log types.</p>
    pub fn status_reason(&self) -> ::std::option::Option<&super::types::DeliverySourceStatusReason> {
        self.status_reason.as_ref()
    }
}
impl DeliverySource {
    /// Creates a new builder-style object to manufacture [`DeliverySource`](crate::types::DeliverySource).
    pub fn builder() -> super::types::builders::DeliverySourceBuilder {
        super::types::builders::DeliverySourceBuilder::default()
    }
}
...
pub struct DeliverySourceBuilder {
    ...
    pub(crate) status: ::std::option::Option<super::types::DeliverySourceStatus>,
    pub(crate) status_reason: ::std::option::Option<super::types::DeliverySourceStatusReason>,
}
impl DeliverySourceBuilder {
    ...
    /// <p>The status of the delivery source. A delivery source can have the status <code>ACTIVE</code> or <code>INACTIVE</code>. Note: This value is defined for selective log types.</p>
    pub fn status(mut self, input: super::types::DeliverySourceStatus) -> Self {
        self.status = ::std::option::Option::Some(input);
        self
    }
    /// <p>The status of the delivery source. A delivery source can have the status <code>ACTIVE</code> or <code>INACTIVE</code>. Note: This value is defined for selective log types.</p>
    pub fn set_status(mut self, input: ::std::option::Option<super::types::DeliverySourceStatus>) -> Self {
        self.status = input;
        self
    }
    /// <p>The status of the delivery source. A delivery source can have the status <code>ACTIVE</code> or <code>INACTIVE</code>. Note: This value is defined for selective log types.</p>
    pub fn get_status(&self) -> &::std::option::Option<super::types::DeliverySourceStatus> {
        &self.status
    }
    /// <p>The reason for the status of the delivery source. A status reason of <code>RESOURCE_DELETED</code> indicates that the resource associated with the delivery source has been deleted. Note: This value is defined for selective log types.</p>
    pub fn status_reason(mut self, input: super::types::DeliverySourceStatusReason) -> Self {
        self.status_reason = ::std::option::Option::Some(input);
        self
    }
    /// <p>The reason for the status of the delivery source. A status reason of <code>RESOURCE_DELETED</code> indicates that the resource associated with the delivery source has been deleted. Note: This value is defined for selective log types.</p>
    pub fn set_status_reason(mut self, input: ::std::option::Option<super::types::DeliverySourceStatusReason>) -> Self {
        self.status_reason = input;
        self
    }
    /// <p>The reason for the status of the delivery source. A status reason of <code>RESOURCE_DELETED</code> indicates that the resource associated with the delivery source has been deleted. Note: This value is defined for selective log types.</p>
    pub fn get_status_reason(&self) -> &::std::option::Option<super::types::DeliverySourceStatusReason> {
        &self.status_reason
    }
    /// Consumes the builder and constructs a [`DeliverySource`](crate::types::DeliverySource).
    pub fn build(self) -> super::types::DeliverySource {
        super::types::DeliverySource {
            name: self.name,
            arn: self.arn,
