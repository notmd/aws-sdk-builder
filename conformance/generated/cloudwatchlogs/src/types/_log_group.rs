...
pub struct LogGroup {
    ...
    pub data_protection_status: ::std::option::Option<super::types::DataProtectionStatus>,
    /// <p>Displays all the properties that this log group has inherited from account-level settings.</p>
    pub inherited_properties: ::std::option::Option<::std::vec::Vec<super::types::InheritedProperty>>,
...
impl LogGroup {
    ...
    /// <p>Displays whether this log group has a protection policy, or whether it had one in the past. For more information, see <a href="https://docs.aws.amazon.com/AmazonCloudWatchLogs/latest/APIReference/API_PutDataProtectionPolicy.html">PutDataProtectionPolicy</a>.</p>
    pub fn data_protection_status(&self) -> ::std::option::Option<&super::types::DataProtectionStatus> {
    ...
    pub fn inherited_properties(&self) -> &[super::types::InheritedProperty] {
...
impl LogGroup {
    ...
    pub fn builder() -> super::types::builders::LogGroupBuilder {
        super::types::builders::LogGroupBuilder::default()
    }
}
...
pub struct LogGroupBuilder {
    ...
    pub(crate) data_protection_status: ::std::option::Option<super::types::DataProtectionStatus>,
    pub(crate) inherited_properties: ::std::option::Option<::std::vec::Vec<super::types::InheritedProperty>>,
...
impl LogGroupBuilder {
    ...
    /// <p>Displays whether this log group has a protection policy, or whether it had one in the past. For more information, see <a href="https://docs.aws.amazon.com/AmazonCloudWatchLogs/latest/APIReference/API_PutDataProtectionPolicy.html">PutDataProtectionPolicy</a>.</p>
    pub fn data_protection_status(mut self, input: super::types::DataProtectionStatus) -> Self {
        self.data_protection_status = ::std::option::Option::Some(input);
        self
    }
    /// <p>Displays whether this log group has a protection policy, or whether it had one in the past. For more information, see <a href="https://docs.aws.amazon.com/AmazonCloudWatchLogs/latest/APIReference/API_PutDataProtectionPolicy.html">PutDataProtectionPolicy</a>.</p>
    pub fn set_data_protection_status(mut self, input: ::std::option::Option<super::types::DataProtectionStatus>) -> Self {
        self.data_protection_status = input;
        self
    }
    /// <p>Displays whether this log group has a protection policy, or whether it had one in the past. For more information, see <a href="https://docs.aws.amazon.com/AmazonCloudWatchLogs/latest/APIReference/API_PutDataProtectionPolicy.html">PutDataProtectionPolicy</a>.</p>
    pub fn get_data_protection_status(&self) -> &::std::option::Option<super::types::DataProtectionStatus> {
    ...
    ///
    /// <p>Displays all the properties that this log group has inherited from account-level settings.</p>
    pub fn inherited_properties(mut self, input: super::types::InheritedProperty) -> Self {
    ...
    /// <p>Displays all the properties that this log group has inherited from account-level settings.</p>
    pub fn set_inherited_properties(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::InheritedProperty>>) -> Self {
        self.inherited_properties = input;
        self
    }
    /// <p>Displays all the properties that this log group has inherited from account-level settings.</p>
    pub fn get_inherited_properties(&self) -> &::std::option::Option<::std::vec::Vec<super::types::InheritedProperty>> {
    ...
    pub fn build(self) -> super::types::LogGroup {
        super::types::LogGroup {
