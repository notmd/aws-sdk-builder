...
impl OpenSearchDataSource {
    ...
    pub fn builder() -> super::types::builders::OpenSearchDataSourceBuilder {
        super::types::builders::OpenSearchDataSourceBuilder::default()
    }
}
...
impl OpenSearchDataSourceBuilder {
    ...
    pub fn build(self) -> super::types::OpenSearchDataSource {
        super::types::OpenSearchDataSource {
