...
impl IntegrationSummary {
    ...
    pub fn builder() -> super::types::builders::IntegrationSummaryBuilder {
        super::types::builders::IntegrationSummaryBuilder::default()
    }
}
...
impl IntegrationSummaryBuilder {
    ...
    pub fn build(self) -> super::types::IntegrationSummary {
        super::types::IntegrationSummary {
