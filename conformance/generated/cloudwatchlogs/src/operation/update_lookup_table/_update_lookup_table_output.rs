...
impl UpdateLookupTableOutput {
    ...
    pub fn builder() -> super::operation::update_lookup_table::builders::UpdateLookupTableOutputBuilder {
        super::operation::update_lookup_table::builders::UpdateLookupTableOutputBuilder::default()
    }
}
...
impl UpdateLookupTableOutputBuilder {
    ...
    pub fn build(self) -> super::operation::update_lookup_table::UpdateLookupTableOutput {
