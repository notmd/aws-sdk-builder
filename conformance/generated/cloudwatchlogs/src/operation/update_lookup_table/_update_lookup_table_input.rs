...
impl UpdateLookupTableInput {
    ...
    pub fn builder() -> super::operation::update_lookup_table::builders::UpdateLookupTableInputBuilder {
        super::operation::update_lookup_table::builders::UpdateLookupTableInputBuilder::default()
    }
}
...
impl UpdateLookupTableInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::update_lookup_table::UpdateLookupTableInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::update_lookup_table::UpdateLookupTableInput {
