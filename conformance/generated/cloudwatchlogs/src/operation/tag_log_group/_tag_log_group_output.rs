...
impl TagLogGroupOutput {
    ...
    pub fn builder() -> super::operation::tag_log_group::builders::TagLogGroupOutputBuilder {
        super::operation::tag_log_group::builders::TagLogGroupOutputBuilder::default()
    }
}
...
impl TagLogGroupOutputBuilder {
    ...
    pub fn build(self) -> super::operation::tag_log_group::TagLogGroupOutput {
