...
impl TagLogGroupInput {
    ...
    pub fn builder() -> super::operation::tag_log_group::builders::TagLogGroupInputBuilder {
        super::operation::tag_log_group::builders::TagLogGroupInputBuilder::default()
    }
}
...
impl TagLogGroupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::tag_log_group::TagLogGroupInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::tag_log_group::TagLogGroupInput {
