...
impl CreateLogStreamInput {
    ...
    pub fn builder() -> super::operation::create_log_stream::builders::CreateLogStreamInputBuilder {
        super::operation::create_log_stream::builders::CreateLogStreamInputBuilder::default()
    }
}
...
impl CreateLogStreamInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::create_log_stream::CreateLogStreamInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::create_log_stream::CreateLogStreamInput {
