...
impl CreateLogStreamOutput {
    ...
    pub fn builder() -> super::operation::create_log_stream::builders::CreateLogStreamOutputBuilder {
        super::operation::create_log_stream::builders::CreateLogStreamOutputBuilder::default()
    }
}
...
impl CreateLogStreamOutputBuilder {
    ...
    pub fn build(self) -> super::operation::create_log_stream::CreateLogStreamOutput {
