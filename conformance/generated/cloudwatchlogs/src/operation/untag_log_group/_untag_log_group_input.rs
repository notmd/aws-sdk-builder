...
impl UntagLogGroupInput {
    ...
    pub fn builder() -> super::operation::untag_log_group::builders::UntagLogGroupInputBuilder {
        super::operation::untag_log_group::builders::UntagLogGroupInputBuilder::default()
    }
}
...
impl UntagLogGroupInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::untag_log_group::UntagLogGroupInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::untag_log_group::UntagLogGroupInput {
