...
impl UntagLogGroupOutput {
    ...
    pub fn builder() -> super::operation::untag_log_group::builders::UntagLogGroupOutputBuilder {
        super::operation::untag_log_group::builders::UntagLogGroupOutputBuilder::default()
    }
}
...
impl UntagLogGroupOutputBuilder {
    ...
    pub fn build(self) -> super::operation::untag_log_group::UntagLogGroupOutput {
