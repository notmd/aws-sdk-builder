...
impl ListIntegrationsInput {
    ...
    pub fn builder() -> super::operation::list_integrations::builders::ListIntegrationsInputBuilder {
        super::operation::list_integrations::builders::ListIntegrationsInputBuilder::default()
    }
}
...
impl ListIntegrationsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_integrations::ListIntegrationsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_integrations::ListIntegrationsInput {
