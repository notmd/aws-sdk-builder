...
impl PutSubscriptionFilterOutput {
    ...
    pub fn builder() -> super::operation::put_subscription_filter::builders::PutSubscriptionFilterOutputBuilder {
        super::operation::put_subscription_filter::builders::PutSubscriptionFilterOutputBuilder::default()
    }
}
...
impl PutSubscriptionFilterOutputBuilder {
    ...
    pub fn build(self) -> super::operation::put_subscription_filter::PutSubscriptionFilterOutput {
