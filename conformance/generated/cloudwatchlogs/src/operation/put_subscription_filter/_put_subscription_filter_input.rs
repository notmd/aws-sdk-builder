...
pub struct PutSubscriptionFilterInput {
    ...
    pub distribution: ::std::option::Option<super::types::Distribution>,
...
impl PutSubscriptionFilterInput {
    ...
    /// <p>The method used to distribute log data to the destination. By default, log data is grouped by log stream, but the grouping can be set to random for a more even distribution. This property is only applicable when the destination is an Amazon Kinesis data stream.</p>
    pub fn distribution(&self) -> ::std::option::Option<&super::types::Distribution> {
...
impl PutSubscriptionFilterInput {
    ...
    pub fn builder() -> super::operation::put_subscription_filter::builders::PutSubscriptionFilterInputBuilder {
        super::operation::put_subscription_filter::builders::PutSubscriptionFilterInputBuilder::default()
    }
}
...
pub struct PutSubscriptionFilterInputBuilder {
    ...
    pub(crate) distribution: ::std::option::Option<super::types::Distribution>,
...
impl PutSubscriptionFilterInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::put_subscription_filter::PutSubscriptionFilterInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::put_subscription_filter::PutSubscriptionFilterInput {
