...
impl DescribeLogGroupsInput {
    ...
    pub fn builder() -> super::operation::describe_log_groups::builders::DescribeLogGroupsInputBuilder {
        super::operation::describe_log_groups::builders::DescribeLogGroupsInputBuilder::default()
    }
}
...
impl DescribeLogGroupsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::describe_log_groups::DescribeLogGroupsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::describe_log_groups::DescribeLogGroupsInput {
