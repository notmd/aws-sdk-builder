...
pub struct DescribeFieldIndexesInput {
    ...
    pub index_categories: ::std::option::Option<::std::vec::Vec<super::types::IndexCategory>>,
...
impl DescribeFieldIndexesInput {
    ...
    pub fn index_categories(&self) -> &[super::types::IndexCategory] {
...
impl DescribeFieldIndexesInput {
    ...
    pub fn builder() -> super::operation::describe_field_indexes::builders::DescribeFieldIndexesInputBuilder {
        super::operation::describe_field_indexes::builders::DescribeFieldIndexesInputBuilder::default()
    }
}
...
pub struct DescribeFieldIndexesInputBuilder {
    ...
    pub(crate) index_categories: ::std::option::Option<::std::vec::Vec<super::types::IndexCategory>>,
...
impl DescribeFieldIndexesInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::describe_field_indexes::DescribeFieldIndexesInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::describe_field_indexes::DescribeFieldIndexesInput {
