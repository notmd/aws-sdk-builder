...
pub use super::operation::describe_field_indexes::_describe_field_indexes_input::DescribeFieldIndexesInputBuilder;

pub use super::operation::describe_field_indexes::_describe_field_indexes_output::DescribeFieldIndexesOutputBuilder;

impl super::operation::describe_field_indexes::builders::DescribeFieldIndexesInputBuilder {
...
pub struct DescribeFieldIndexesFluentBuilder {
    ...
    inner: super::operation::describe_field_indexes::builders::DescribeFieldIndexesInputBuilder,
...
impl DescribeFieldIndexesFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::describe_field_indexes::builders::DescribeFieldIndexesInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::describe_field_indexes::DescribeFieldIndexes::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::describe_field_indexes::DescribeFieldIndexes::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn index_categories(mut self, input: super::types::IndexCategory) -> Self {
    ...
    /// <p>If you omit this parameter, the response includes the <code>DEFAULT</code>, <code>CUSTOM</code>, and <code>INACTIVE</code> categories.</p>
    /// <p>For more information about automatically indexed fields and using the <code>AUTO</code> category, see <a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/CloudWatchLogs-Field-Indexing-Automatic.html">Automatically indexed fields</a>.</p>
    pub fn set_index_categories(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::IndexCategory>>) -> Self {
    ...
    /// <p>If you omit this parameter, the response includes the <code>DEFAULT</code>, <code>CUSTOM</code>, and <code>INACTIVE</code> categories.</p>
    /// <p>For more information about automatically indexed fields and using the <code>AUTO</code> category, see <a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/CloudWatchLogs-Field-Indexing-Automatic.html">Automatically indexed fields</a>.</p>
    pub fn get_index_categories(&self) -> &::std::option::Option<::std::vec::Vec<super::types::IndexCategory>> {
