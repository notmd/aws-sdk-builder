...
impl DeleteLogGroupOutput {
    ...
    pub fn builder() -> super::operation::delete_log_group::builders::DeleteLogGroupOutputBuilder {
        super::operation::delete_log_group::builders::DeleteLogGroupOutputBuilder::default()
    }
}
...
impl DeleteLogGroupOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_log_group::DeleteLogGroupOutput {
