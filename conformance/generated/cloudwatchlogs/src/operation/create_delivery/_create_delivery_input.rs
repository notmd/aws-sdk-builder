...
impl CreateDeliveryInput {
    ...
    pub fn builder() -> super::operation::create_delivery::builders::CreateDeliveryInputBuilder {
        super::operation::create_delivery::builders::CreateDeliveryInputBuilder::default()
    }
}
...
impl CreateDeliveryInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::create_delivery::CreateDeliveryInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::create_delivery::CreateDeliveryInput {
