...
pub use super::operation::put_integration::_put_integration_input::PutIntegrationInputBuilder;

pub use super::operation::put_integration::_put_integration_output::PutIntegrationOutputBuilder;

impl super::operation::put_integration::builders::PutIntegrationInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::Client,
    ) -> ::std::result::Result<
        super::operation::put_integration::PutIntegrationOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::put_integration::PutIntegrationError,
...
pub struct PutIntegrationFluentBuilder {
    ...
    inner: super::operation::put_integration::builders::PutIntegrationInputBuilder,
...
impl PutIntegrationFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::put_integration::builders::PutIntegrationInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::put_integration::PutIntegration::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::put_integration::PutIntegration::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn resource_config(mut self, input: super::types::ResourceConfig) -> Self {
        self.inner = self.inner.resource_config(input);
        self
    }
    /// <p>A structure that contains configuration information for the integration that you are creating.</p>
    pub fn set_resource_config(mut self, input: ::std::option::Option<super::types::ResourceConfig>) -> Self {
        self.inner = self.inner.set_resource_config(input);
        self
    }
    /// <p>A structure that contains configuration information for the integration that you are creating.</p>
    pub fn get_resource_config(&self) -> &::std::option::Option<super::types::ResourceConfig> {
