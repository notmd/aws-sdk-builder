...
pub struct PutIntegrationInput {
    ...
    pub resource_config: ::std::option::Option<super::types::ResourceConfig>,
...
impl PutIntegrationInput {
    ...
    /// <p>A structure that contains configuration information for the integration that you are creating.</p>
    pub fn resource_config(&self) -> ::std::option::Option<&super::types::ResourceConfig> {
...
impl PutIntegrationInput {
    ...
    pub fn builder() -> super::operation::put_integration::builders::PutIntegrationInputBuilder {
        super::operation::put_integration::builders::PutIntegrationInputBuilder::default()
    }
}
...
pub struct PutIntegrationInputBuilder {
    ...
    pub(crate) resource_config: ::std::option::Option<super::types::ResourceConfig>,
...
impl PutIntegrationInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::put_integration::PutIntegrationInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::put_integration::PutIntegrationInput {
