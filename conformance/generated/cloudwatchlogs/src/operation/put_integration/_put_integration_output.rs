...
impl PutIntegrationOutput {
    ...
    pub fn builder() -> super::operation::put_integration::builders::PutIntegrationOutputBuilder {
        super::operation::put_integration::builders::PutIntegrationOutputBuilder::default()
    }
}
...
impl PutIntegrationOutputBuilder {
    ...
    pub fn build(self) -> super::operation::put_integration::PutIntegrationOutput {
