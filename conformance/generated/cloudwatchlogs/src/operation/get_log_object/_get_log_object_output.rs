...
pub struct GetLogObjectOutput {
    ...
    pub field_stream:
        super::event_receiver::EventReceiver<super::types::GetLogObjectResponseStream, super::types::error::GetLogObjectResponseStreamError>,
...
impl GetLogObjectOutputBuilder {
    ...
    pub fn field_stream(
        mut self,
        input: super::event_receiver::EventReceiver<super::types::GetLogObjectResponseStream, super::types::error::GetLogObjectResponseStreamError>,
    ) -> Self {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_log_object::GetLogObjectOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_log_object::GetLogObjectOutput {
