...
impl GetLogObjectInput {
    ...
    pub fn builder() -> super::operation::get_log_object::builders::GetLogObjectInputBuilder {
        super::operation::get_log_object::builders::GetLogObjectInputBuilder::default()
    }
}
