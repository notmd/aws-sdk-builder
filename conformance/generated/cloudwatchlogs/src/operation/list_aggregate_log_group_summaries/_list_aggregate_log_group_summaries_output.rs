...
pub struct ListAggregateLogGroupSummariesOutput {
    ...
    pub aggregate_log_group_summaries: ::std::option::Option<::std::vec::Vec<super::types::AggregateLogGroupSummary>>,
...
impl ListAggregateLogGroupSummariesOutput {
    ...
    pub fn aggregate_log_group_summaries(&self) -> &[super::types::AggregateLogGroupSummary] {
...
impl ListAggregateLogGroupSummariesOutput {
    ...
    pub fn builder() -> super::operation::list_aggregate_log_group_summaries::builders::ListAggregateLogGroupSummariesOutputBuilder {
        super::operation::list_aggregate_log_group_summaries::builders::ListAggregateLogGroupSummariesOutputBuilder::default()
    }
}
...
pub struct ListAggregateLogGroupSummariesOutputBuilder {
    pub(crate) aggregate_log_group_summaries: ::std::option::Option<::std::vec::Vec<super::types::AggregateLogGroupSummary>>,
...
impl ListAggregateLogGroupSummariesOutputBuilder {
    ...
    ///
    /// <p>The list of aggregate log group summaries grouped by the specified data source characteristics.</p>
    pub fn aggregate_log_group_summaries(mut self, input: super::types::AggregateLogGroupSummary) -> Self {
    ...
    pub fn set_aggregate_log_group_summaries(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<super::types::AggregateLogGroupSummary>>,
    ) -> Self {
        self.aggregate_log_group_summaries = input;
        self
    }
    /// <p>The list of aggregate log group summaries grouped by the specified data source characteristics.</p>
    pub fn get_aggregate_log_group_summaries(&self) -> &::std::option::Option<::std::vec::Vec<super::types::AggregateLogGroupSummary>> {
    ...
    pub fn build(self) -> super::operation::list_aggregate_log_group_summaries::ListAggregateLogGroupSummariesOutput {
