...
pub use super::operation::list_aggregate_log_group_summaries::_list_aggregate_log_group_summaries_input::ListAggregateLogGroupSummariesInputBuilder;

pub use super::operation::list_aggregate_log_group_summaries::_list_aggregate_log_group_summaries_output::ListAggregateLogGroupSummariesOutputBuilder;

impl super::operation::list_aggregate_log_group_summaries::builders::ListAggregateLogGroupSummariesInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::Client,
    ) -> ::std::result::Result<
        super::operation::list_aggregate_log_group_summaries::ListAggregateLogGroupSummariesOutput,
...
pub struct ListAggregateLogGroupSummariesFluentBuilder {
    ...
    inner: super::operation::list_aggregate_log_group_summaries::builders::ListAggregateLogGroupSummariesInputBuilder,
...
impl ListAggregateLogGroupSummariesFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::list_aggregate_log_group_summaries::builders::ListAggregateLogGroupSummariesInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::list_aggregate_log_group_summaries::ListAggregateLogGroupSummaries::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::list_aggregate_log_group_summaries::ListAggregateLogGroupSummaries::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::operation::list_aggregate_log_group_summaries::paginator::ListAggregateLogGroupSummariesPaginator {
        super::operation::list_aggregate_log_group_summaries::paginator::ListAggregateLogGroupSummariesPaginator::new(self.handle, self.inner)
    }
    ///
    ...
    pub fn log_group_class(mut self, input: super::types::LogGroupClass) -> Self {
        self.inner = self.inner.log_group_class(input);
        self
    }
    /// <p>Filters the results by log group class to include only log groups of the specified class.</p>
    pub fn set_log_group_class(mut self, input: ::std::option::Option<super::types::LogGroupClass>) -> Self {
        self.inner = self.inner.set_log_group_class(input);
        self
    }
    /// <p>Filters the results by log group class to include only log groups of the specified class.</p>
    pub fn get_log_group_class(&self) -> &::std::option::Option<super::types::LogGroupClass> {
    ...
    pub fn data_sources(mut self, input: super::types::DataSourceFilter) -> Self {
        self.inner = self.inner.data_sources(input);
        self
    }
    /// <p>Filters the results by data source characteristics to include only log groups associated with the specified data sources.</p>
    pub fn set_data_sources(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::DataSourceFilter>>) -> Self {
        self.inner = self.inner.set_data_sources(input);
        self
    }
    /// <p>Filters the results by data source characteristics to include only log groups associated with the specified data sources.</p>
    pub fn get_data_sources(&self) -> &::std::option::Option<::std::vec::Vec<super::types::DataSourceFilter>> {
        self.inner.get_data_sources()
    }
    /// <p>Specifies how to group the log groups in the summary.</p>
    pub fn group_by(mut self, input: super::types::ListAggregateLogGroupSummariesGroupBy) -> Self {
        self.inner = self.inner.group_by(input);
        self
    }
    /// <p>Specifies how to group the log groups in the summary.</p>
    pub fn set_group_by(mut self, input: ::std::option::Option<super::types::ListAggregateLogGroupSummariesGroupBy>) -> Self {
        self.inner = self.inner.set_group_by(input);
        self
    }
    /// <p>Specifies how to group the log groups in the summary.</p>
    pub fn get_group_by(&self) -> &::std::option::Option<super::types::ListAggregateLogGroupSummariesGroupBy> {
