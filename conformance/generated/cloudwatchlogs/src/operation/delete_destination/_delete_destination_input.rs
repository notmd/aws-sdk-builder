...
impl DeleteDestinationInput {
    ...
    pub fn builder() -> super::operation::delete_destination::builders::DeleteDestinationInputBuilder {
        super::operation::delete_destination::builders::DeleteDestinationInputBuilder::default()
    }
}
...
impl DeleteDestinationInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::delete_destination::DeleteDestinationInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::delete_destination::DeleteDestinationInput {
