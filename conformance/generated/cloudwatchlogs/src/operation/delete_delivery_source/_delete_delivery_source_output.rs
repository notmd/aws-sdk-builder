...
impl DeleteDeliverySourceOutput {
    ...
    pub fn builder() -> super::operation::delete_delivery_source::builders::DeleteDeliverySourceOutputBuilder {
        super::operation::delete_delivery_source::builders::DeleteDeliverySourceOutputBuilder::default()
    }
}
...
impl DeleteDeliverySourceOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_delivery_source::DeleteDeliverySourceOutput {
