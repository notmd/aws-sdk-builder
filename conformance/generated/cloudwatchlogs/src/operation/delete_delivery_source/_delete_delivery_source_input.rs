...
impl DeleteDeliverySourceInput {
    ...
    pub fn builder() -> super::operation::delete_delivery_source::builders::DeleteDeliverySourceInputBuilder {
        super::operation::delete_delivery_source::builders::DeleteDeliverySourceInputBuilder::default()
    }
}
...
impl DeleteDeliverySourceInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::delete_delivery_source::DeleteDeliverySourceInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::delete_delivery_source::DeleteDeliverySourceInput { name: self.name })
    }
}
