...
pub use super::operation::describe_log_streams::_describe_log_streams_input::DescribeLogStreamsInputBuilder;

pub use super::operation::describe_log_streams::_describe_log_streams_output::DescribeLogStreamsOutputBuilder;

impl super::operation::describe_log_streams::builders::DescribeLogStreamsInputBuilder {
...
pub struct DescribeLogStreamsFluentBuilder {
    ...
    inner: super::operation::describe_log_streams::builders::DescribeLogStreamsInputBuilder,
...
impl DescribeLogStreamsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::describe_log_streams::builders::DescribeLogStreamsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::describe_log_streams::DescribeLogStreams::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::describe_log_streams::DescribeLogStreams::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::operation::describe_log_streams::paginator::DescribeLogStreamsPaginator {
        super::operation::describe_log_streams::paginator::DescribeLogStreamsPaginator::new(self.handle, self.inner)
    }
    ...
    pub fn order_by(mut self, input: super::types::OrderBy) -> Self {
    ...
    /// <p>If you order the results by event time, you cannot specify the <code>logStreamNamePrefix</code> parameter.</p>
    /// <p><code>lastEventTimestamp</code> represents the time of the most recent log event in the log stream in CloudWatch Logs. This number is expressed as the number of milliseconds after <code>Jan 1, 1970 00:00:00 UTC</code>. <code>lastEventTimestamp</code> updates on an eventual consistency basis. It typically updates in less than an hour from ingestion, but in rare situations might take longer.</p>
    pub fn set_order_by(mut self, input: ::std::option::Option<super::types::OrderBy>) -> Self {
    ...
    /// <p>If you order the results by event time, you cannot specify the <code>logStreamNamePrefix</code> parameter.</p>
    /// <p><code>lastEventTimestamp</code> represents the time of the most recent log event in the log stream in CloudWatch Logs. This number is expressed as the number of milliseconds after <code>Jan 1, 1970 00:00:00 UTC</code>. <code>lastEventTimestamp</code> updates on an eventual consistency basis. It typically updates in less than an hour from ingestion, but in rare situations might take longer.</p>
    pub fn get_order_by(&self) -> &::std::option::Option<super::types::OrderBy> {
