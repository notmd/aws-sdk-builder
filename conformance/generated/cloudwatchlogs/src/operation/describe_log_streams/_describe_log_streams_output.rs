...
pub struct DescribeLogStreamsOutput {
    /// <p>The log streams.</p>
    pub log_streams: ::std::option::Option<::std::vec::Vec<super::types::LogStream>>,
...
impl DescribeLogStreamsOutput {
    ...
    pub fn log_streams(&self) -> &[super::types::LogStream] {
...
impl DescribeLogStreamsOutput {
    ...
    pub fn builder() -> super::operation::describe_log_streams::builders::DescribeLogStreamsOutputBuilder {
        super::operation::describe_log_streams::builders::DescribeLogStreamsOutputBuilder::default()
    }
}
...
pub struct DescribeLogStreamsOutputBuilder {
    pub(crate) log_streams: ::std::option::Option<::std::vec::Vec<super::types::LogStream>>,
...
impl DescribeLogStreamsOutputBuilder {
    ...
    ///
    /// <p>The log streams.</p>
    pub fn log_streams(mut self, input: super::types::LogStream) -> Self {
    ...
    /// <p>The log streams.</p>
    pub fn set_log_streams(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::LogStream>>) -> Self {
        self.log_streams = input;
        self
    }
    /// <p>The log streams.</p>
    pub fn get_log_streams(&self) -> &::std::option::Option<::std::vec::Vec<super::types::LogStream>> {
        &self.log_streams
    }
    /// <p>The token for the next set of items to return. The token expires after 24 hours.</p>
    ...
    pub fn build(self) -> super::operation::describe_log_streams::DescribeLogStreamsOutput {
