...
impl DeleteLogAnomalyDetectorInput {
    ...
    pub fn builder() -> super::operation::delete_log_anomaly_detector::builders::DeleteLogAnomalyDetectorInputBuilder {
        super::operation::delete_log_anomaly_detector::builders::DeleteLogAnomalyDetectorInputBuilder::default()
    }
}
...
impl DeleteLogAnomalyDetectorInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::delete_log_anomaly_detector::DeleteLogAnomalyDetectorInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::delete_log_anomaly_detector::DeleteLogAnomalyDetectorInput {
