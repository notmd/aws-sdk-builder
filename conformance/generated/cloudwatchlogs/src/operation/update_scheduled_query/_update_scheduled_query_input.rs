...
impl UpdateScheduledQueryInput {
    ...
    pub fn builder() -> super::operation::update_scheduled_query::builders::UpdateScheduledQueryInputBuilder {
        super::operation::update_scheduled_query::builders::UpdateScheduledQueryInputBuilder::default()
    }
}
...
impl UpdateScheduledQueryInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::update_scheduled_query::UpdateScheduledQueryInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::update_scheduled_query::UpdateScheduledQueryInput {
