...
impl CreateScheduledQueryOutput {
    ...
    pub fn builder() -> super::operation::create_scheduled_query::builders::CreateScheduledQueryOutputBuilder {
        super::operation::create_scheduled_query::builders::CreateScheduledQueryOutputBuilder::default()
    }
}
...
impl CreateScheduledQueryOutputBuilder {
    ...
    pub fn build(self) -> super::operation::create_scheduled_query::CreateScheduledQueryOutput {
