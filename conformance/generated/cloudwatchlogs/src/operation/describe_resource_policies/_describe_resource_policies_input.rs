...
pub struct DescribeResourcePoliciesInput {
    ...
    pub policy_scope: ::std::option::Option<super::types::PolicyScope>,
}
impl DescribeResourcePoliciesInput {
    ...
    /// <p>Specifies the scope of the resource policy. Valid values are <code>ACCOUNT</code> or <code>RESOURCE</code>. When not specified, defaults to <code>ACCOUNT</code>.</p>
    pub fn policy_scope(&self) -> ::std::option::Option<&super::types::PolicyScope> {
...
impl DescribeResourcePoliciesInput {
    ...
    pub fn builder() -> super::operation::describe_resource_policies::builders::DescribeResourcePoliciesInputBuilder {
        super::operation::describe_resource_policies::builders::DescribeResourcePoliciesInputBuilder::default()
    }
}
...
pub struct DescribeResourcePoliciesInputBuilder {
    ...
    pub(crate) policy_scope: ::std::option::Option<super::types::PolicyScope>,
}
impl DescribeResourcePoliciesInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::describe_resource_policies::DescribeResourcePoliciesInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::describe_resource_policies::DescribeResourcePoliciesInput {
