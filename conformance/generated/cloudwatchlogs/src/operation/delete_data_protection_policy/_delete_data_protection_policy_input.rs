...
impl DeleteDataProtectionPolicyInput {
    ...
    pub fn builder() -> super::operation::delete_data_protection_policy::builders::DeleteDataProtectionPolicyInputBuilder {
        super::operation::delete_data_protection_policy::builders::DeleteDataProtectionPolicyInputBuilder::default()
    }
}
...
impl DeleteDataProtectionPolicyInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::delete_data_protection_policy::DeleteDataProtectionPolicyInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::delete_data_protection_policy::DeleteDataProtectionPolicyInput {
