...
impl DescribeMetricFiltersInput {
    ...
    pub fn builder() -> super::operation::describe_metric_filters::builders::DescribeMetricFiltersInputBuilder {
        super::operation::describe_metric_filters::builders::DescribeMetricFiltersInputBuilder::default()
    }
}
...
impl DescribeMetricFiltersInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::describe_metric_filters::DescribeMetricFiltersInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::describe_metric_filters::DescribeMetricFiltersInput {
