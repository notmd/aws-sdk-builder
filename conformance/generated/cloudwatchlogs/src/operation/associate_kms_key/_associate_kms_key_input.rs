...
impl AssociateKmsKeyInput {
    ...
    pub fn builder() -> super::operation::associate_kms_key::builders::AssociateKmsKeyInputBuilder {
        super::operation::associate_kms_key::builders::AssociateKmsKeyInputBuilder::default()
    }
}
...
impl AssociateKmsKeyInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::associate_kms_key::AssociateKmsKeyInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::associate_kms_key::AssociateKmsKeyInput {
