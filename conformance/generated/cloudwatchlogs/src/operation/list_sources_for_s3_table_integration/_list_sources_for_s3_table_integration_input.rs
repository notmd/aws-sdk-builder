...
impl ListSourcesForS3TableIntegrationInput {
    ...
    pub fn builder() -> super::operation::list_sources_for_s3_table_integration::builders::ListSourcesForS3TableIntegrationInputBuilder {
        super::operation::list_sources_for_s3_table_integration::builders::ListSourcesForS3TableIntegrationInputBuilder::default()
    }
}
...
impl ListSourcesForS3TableIntegrationInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::list_sources_for_s3_table_integration::ListSourcesForS3TableIntegrationInput,
