...
impl DeleteScheduledQueryInput {
    ...
    pub fn builder() -> super::operation::delete_scheduled_query::builders::DeleteScheduledQueryInputBuilder {
        super::operation::delete_scheduled_query::builders::DeleteScheduledQueryInputBuilder::default()
    }
}
...
impl DeleteScheduledQueryInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::delete_scheduled_query::DeleteScheduledQueryInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::delete_scheduled_query::DeleteScheduledQueryInput { identifier: self.identifier })
    }
}
