...
impl PutDestinationPolicyInput {
    ...
    pub fn builder() -> super::operation::put_destination_policy::builders::PutDestinationPolicyInputBuilder {
        super::operation::put_destination_policy::builders::PutDestinationPolicyInputBuilder::default()
    }
}
...
impl PutDestinationPolicyInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::put_destination_policy::PutDestinationPolicyInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::put_destination_policy::PutDestinationPolicyInput {
