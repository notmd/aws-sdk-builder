...
impl PutDeliveryDestinationPolicyInput {
    ...
    pub fn builder() -> super::operation::put_delivery_destination_policy::builders::PutDeliveryDestinationPolicyInputBuilder {
        super::operation::put_delivery_destination_policy::builders::PutDeliveryDestinationPolicyInputBuilder::default()
    }
}
...
impl PutDeliveryDestinationPolicyInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::put_delivery_destination_policy::PutDeliveryDestinationPolicyInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::put_delivery_destination_policy::PutDeliveryDestinationPolicyInput {
