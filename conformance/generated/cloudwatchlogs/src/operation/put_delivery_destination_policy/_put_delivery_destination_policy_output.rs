...
impl PutDeliveryDestinationPolicyOutput {
    ...
    pub fn builder() -> super::operation::put_delivery_destination_policy::builders::PutDeliveryDestinationPolicyOutputBuilder {
        super::operation::put_delivery_destination_policy::builders::PutDeliveryDestinationPolicyOutputBuilder::default()
    }
}
...
impl PutDeliveryDestinationPolicyOutputBuilder {
    ...
    pub fn build(self) -> super::operation::put_delivery_destination_policy::PutDeliveryDestinationPolicyOutput {
