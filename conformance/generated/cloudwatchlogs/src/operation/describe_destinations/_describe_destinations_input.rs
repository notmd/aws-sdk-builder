...
impl DescribeDestinationsInput {
    ...
    pub fn builder() -> super::operation::describe_destinations::builders::DescribeDestinationsInputBuilder {
        super::operation::describe_destinations::builders::DescribeDestinationsInputBuilder::default()
    }
}
...
impl DescribeDestinationsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::describe_destinations::DescribeDestinationsInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::describe_destinations::DescribeDestinationsInput {
