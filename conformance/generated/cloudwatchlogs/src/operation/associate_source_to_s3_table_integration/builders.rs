...
pub use super::operation::associate_source_to_s3_table_integration::_associate_source_to_s3_table_integration_input::AssociateSourceToS3TableIntegrationInputBuilder;

pub use super::operation::associate_source_to_s3_table_integration::_associate_source_to_s3_table_integration_output::AssociateSourceToS3TableIntegrationOutputBuilder;

impl super::operation::associate_source_to_s3_table_integration::builders::AssociateSourceToS3TableIntegrationInputBuilder {
...
pub struct AssociateSourceToS3TableIntegrationFluentBuilder {
    ...
    inner: super::operation::associate_source_to_s3_table_integration::builders::AssociateSourceToS3TableIntegrationInputBuilder,
...
impl AssociateSourceToS3TableIntegrationFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::associate_source_to_s3_table_integration::builders::AssociateSourceToS3TableIntegrationInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            super::operation::associate_source_to_s3_table_integration::AssociateSourceToS3TableIntegration::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        super::operation::associate_source_to_s3_table_integration::AssociateSourceToS3TableIntegration::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn data_source(mut self, input: super::types::DataSource) -> Self {
        self.inner = self.inner.data_source(input);
        self
    }
    /// <p>The data source to associate with the S3 Table Integration. Contains the name and type of the data source.</p>
    pub fn set_data_source(mut self, input: ::std::option::Option<super::types::DataSource>) -> Self {
        self.inner = self.inner.set_data_source(input);
        self
    }
    /// <p>The data source to associate with the S3 Table Integration. Contains the name and type of the data source.</p>
    pub fn get_data_source(&self) -> &::std::option::Option<super::types::DataSource> {
