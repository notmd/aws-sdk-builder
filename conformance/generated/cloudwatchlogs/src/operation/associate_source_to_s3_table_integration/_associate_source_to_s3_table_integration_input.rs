...
impl AssociateSourceToS3TableIntegrationInput {
    ...
    pub fn builder() -> super::operation::associate_source_to_s3_table_integration::builders::AssociateSourceToS3TableIntegrationInputBuilder {
        super::operation::associate_source_to_s3_table_integration::builders::AssociateSourceToS3TableIntegrationInputBuilder::default()
    }
}
...
impl AssociateSourceToS3TableIntegrationInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::associate_source_to_s3_table_integration::AssociateSourceToS3TableIntegrationInput,
