...
impl StopQueryOutput {
    ...
    pub fn builder() -> super::operation::stop_query::builders::StopQueryOutputBuilder {
        super::operation::stop_query::builders::StopQueryOutputBuilder::default()
    }
}
...
impl StopQueryOutputBuilder {
    ...
    pub fn build(self) -> super::operation::stop_query::StopQueryOutput {
