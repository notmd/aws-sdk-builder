...
impl StopQueryInput {
    ...
    pub fn builder() -> super::operation::stop_query::builders::StopQueryInputBuilder {
        super::operation::stop_query::builders::StopQueryInputBuilder::default()
    }
}
...
impl StopQueryInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::stop_query::StopQueryInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::stop_query::StopQueryInput { query_id: self.query_id })
    }
}
