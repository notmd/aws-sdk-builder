...
impl GetTransformerInput {
    ...
    pub fn builder() -> super::operation::get_transformer::builders::GetTransformerInputBuilder {
        super::operation::get_transformer::builders::GetTransformerInputBuilder::default()
    }
}
...
impl GetTransformerInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_transformer::GetTransformerInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_transformer::GetTransformerInput {
