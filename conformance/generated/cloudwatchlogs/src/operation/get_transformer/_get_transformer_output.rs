...
impl GetTransformerOutput {
    ...
    pub fn builder() -> super::operation::get_transformer::builders::GetTransformerOutputBuilder {
        super::operation::get_transformer::builders::GetTransformerOutputBuilder::default()
    }
}
...
impl GetTransformerOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_transformer::GetTransformerOutput {
