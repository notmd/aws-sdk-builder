...
impl ListLogAnomalyDetectorsInput {
    ...
    pub fn builder() -> super::operation::list_log_anomaly_detectors::builders::ListLogAnomalyDetectorsInputBuilder {
        super::operation::list_log_anomaly_detectors::builders::ListLogAnomalyDetectorsInputBuilder::default()
    }
}
...
impl ListLogAnomalyDetectorsInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::list_log_anomaly_detectors::ListLogAnomalyDetectorsInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::list_log_anomaly_detectors::ListLogAnomalyDetectorsInput {
