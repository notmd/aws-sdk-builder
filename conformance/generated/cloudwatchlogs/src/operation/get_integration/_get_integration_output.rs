...
pub struct GetIntegrationOutput {
    ...
    pub integration_type: ::std::option::Option<super::types::IntegrationType>,
    /// <p>The current status of this integration.</p>
    pub integration_status: ::std::option::Option<super::types::IntegrationStatus>,
    ...
    pub integration_details: ::std::option::Option<super::types::IntegrationDetails>,
...
impl GetIntegrationOutput {
    ...
    /// <p>The type of integration. Integrations with OpenSearch Service have the type <code>OPENSEARCH</code>.</p>
    pub fn integration_type(&self) -> ::std::option::Option<&super::types::IntegrationType> {
        self.integration_type.as_ref()
    }
    /// <p>The current status of this integration.</p>
    pub fn integration_status(&self) -> ::std::option::Option<&super::types::IntegrationStatus> {
        self.integration_status.as_ref()
    }
    /// <p>A structure that contains information about the integration configuration. For an integration with OpenSearch Service, this includes information about OpenSearch Service resources such as the collection, the workspace, and policies.</p>
    pub fn integration_details(&self) -> ::std::option::Option<&super::types::IntegrationDetails> {
...
impl GetIntegrationOutput {
    ...
    pub fn builder() -> super::operation::get_integration::builders::GetIntegrationOutputBuilder {
        super::operation::get_integration::builders::GetIntegrationOutputBuilder::default()
    }
}
...
pub struct GetIntegrationOutputBuilder {
    ...
    pub(crate) integration_type: ::std::option::Option<super::types::IntegrationType>,
    pub(crate) integration_status: ::std::option::Option<super::types::IntegrationStatus>,
    pub(crate) integration_details: ::std::option::Option<super::types::IntegrationDetails>,
    _request_id: Option<String>,
}
impl GetIntegrationOutputBuilder {
    ...
    /// <p>The type of integration. Integrations with OpenSearch Service have the type <code>OPENSEARCH</code>.</p>
    pub fn integration_type(mut self, input: super::types::IntegrationType) -> Self {
        self.integration_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The type of integration. Integrations with OpenSearch Service have the type <code>OPENSEARCH</code>.</p>
    pub fn set_integration_type(mut self, input: ::std::option::Option<super::types::IntegrationType>) -> Self {
        self.integration_type = input;
        self
    }
    /// <p>The type of integration. Integrations with OpenSearch Service have the type <code>OPENSEARCH</code>.</p>
    pub fn get_integration_type(&self) -> &::std::option::Option<super::types::IntegrationType> {
        &self.integration_type
    }
    /// <p>The current status of this integration.</p>
    pub fn integration_status(mut self, input: super::types::IntegrationStatus) -> Self {
        self.integration_status = ::std::option::Option::Some(input);
        self
    }
    /// <p>The current status of this integration.</p>
    pub fn set_integration_status(mut self, input: ::std::option::Option<super::types::IntegrationStatus>) -> Self {
        self.integration_status = input;
        self
    }
    /// <p>The current status of this integration.</p>
    pub fn get_integration_status(&self) -> &::std::option::Option<super::types::IntegrationStatus> {
        &self.integration_status
    }
    /// <p>A structure that contains information about the integration configuration. For an integration with OpenSearch Service, this includes information about OpenSearch Service resources such as the collection, the workspace, and policies.</p>
    pub fn integration_details(mut self, input: super::types::IntegrationDetails) -> Self {
        self.integration_details = ::std::option::Option::Some(input);
        self
    }
    /// <p>A structure that contains information about the integration configuration. For an integration with OpenSearch Service, this includes information about OpenSearch Service resources such as the collection, the workspace, and policies.</p>
    pub fn set_integration_details(mut self, input: ::std::option::Option<super::types::IntegrationDetails>) -> Self {
        self.integration_details = input;
        self
    }
    /// <p>A structure that contains information about the integration configuration. For an integration with OpenSearch Service, this includes information about OpenSearch Service resources such as the collection, the workspace, and policies.</p>
    pub fn get_integration_details(&self) -> &::std::option::Option<super::types::IntegrationDetails> {
    ...
    pub fn build(self) -> super::operation::get_integration::GetIntegrationOutput {
        super::operation::get_integration::GetIntegrationOutput {
