...
impl GetIntegrationInput {
    ...
    pub fn builder() -> super::operation::get_integration::builders::GetIntegrationInputBuilder {
        super::operation::get_integration::builders::GetIntegrationInputBuilder::default()
    }
}
...
impl GetIntegrationInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_integration::GetIntegrationInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_integration::GetIntegrationInput {
