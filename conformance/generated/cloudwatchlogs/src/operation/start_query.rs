...
impl StartQuery {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::operation::start_query::StartQueryOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::start_query::StartQueryError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::start_query::StartQueryError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::start_query::StartQueryOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartQueryResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_start_query::de_start_query_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_start_query::de_start_query_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartQueryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::start_query::StartQueryInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::start_query::StartQueryInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_start_query::ser_start_query_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::start_query::StartQueryError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::start_query::_start_query_input::StartQueryInput;

pub use super::operation::start_query::_start_query_output::StartQueryOutput;
