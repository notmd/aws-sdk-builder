...
impl StartLiveTailInput {
    ...
    pub fn builder() -> super::operation::start_live_tail::builders::StartLiveTailInputBuilder {
        super::operation::start_live_tail::builders::StartLiveTailInputBuilder::default()
    }
}
...
impl StartLiveTailInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::start_live_tail::StartLiveTailInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::start_live_tail::StartLiveTailInput {
