...
impl GetLogEventsInput {
    ...
    pub fn builder() -> super::operation::get_log_events::builders::GetLogEventsInputBuilder {
        super::operation::get_log_events::builders::GetLogEventsInputBuilder::default()
    }
}
...
impl GetLogEventsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_log_events::GetLogEventsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_log_events::GetLogEventsInput {
