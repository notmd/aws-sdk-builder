...
pub struct DescribeDeliverySourcesOutput {
    ...
    pub delivery_sources: ::std::option::Option<::std::vec::Vec<super::types::DeliverySource>>,
...
impl DescribeDeliverySourcesOutput {
    ...
    pub fn delivery_sources(&self) -> &[super::types::DeliverySource] {
...
impl DescribeDeliverySourcesOutput {
    ...
    pub fn builder() -> super::operation::describe_delivery_sources::builders::DescribeDeliverySourcesOutputBuilder {
        super::operation::describe_delivery_sources::builders::DescribeDeliverySourcesOutputBuilder::default()
    }
}
...
pub struct DescribeDeliverySourcesOutputBuilder {
    pub(crate) delivery_sources: ::std::option::Option<::std::vec::Vec<super::types::DeliverySource>>,
...
impl DescribeDeliverySourcesOutputBuilder {
    ...
    ///
    /// <p>An array of structures. Each structure contains information about one delivery source in the account.</p>
    pub fn delivery_sources(mut self, input: super::types::DeliverySource) -> Self {
    ...
    /// <p>An array of structures. Each structure contains information about one delivery source in the account.</p>
    pub fn set_delivery_sources(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::DeliverySource>>) -> Self {
        self.delivery_sources = input;
        self
    }
    /// <p>An array of structures. Each structure contains information about one delivery source in the account.</p>
    pub fn get_delivery_sources(&self) -> &::std::option::Option<::std::vec::Vec<super::types::DeliverySource>> {
    ...
    pub fn build(self) -> super::operation::describe_delivery_sources::DescribeDeliverySourcesOutput {
