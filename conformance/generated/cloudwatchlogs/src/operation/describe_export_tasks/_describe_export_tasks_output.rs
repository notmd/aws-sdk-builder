...
pub struct DescribeExportTasksOutput {
    ...
    pub export_tasks: ::std::option::Option<::std::vec::Vec<super::types::ExportTask>>,
...
impl DescribeExportTasksOutput {
    ...
    pub fn export_tasks(&self) -> &[super::types::ExportTask] {
...
impl DescribeExportTasksOutput {
    ...
    pub fn builder() -> super::operation::describe_export_tasks::builders::DescribeExportTasksOutputBuilder {
        super::operation::describe_export_tasks::builders::DescribeExportTasksOutputBuilder::default()
    }
}
...
pub struct DescribeExportTasksOutputBuilder {
    pub(crate) export_tasks: ::std::option::Option<::std::vec::Vec<super::types::ExportTask>>,
...
impl DescribeExportTasksOutputBuilder {
    ...
    ///
    /// <p>The export tasks.</p>
    pub fn export_tasks(mut self, input: super::types::ExportTask) -> Self {
    ...
    /// <p>The export tasks.</p>
    pub fn set_export_tasks(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::ExportTask>>) -> Self {
        self.export_tasks = input;
        self
    }
    /// <p>The export tasks.</p>
    pub fn get_export_tasks(&self) -> &::std::option::Option<::std::vec::Vec<super::types::ExportTask>> {
        &self.export_tasks
    }
    /// <p>The token for the next set of items to return. The token expires after 24 hours.</p>
    ...
    pub fn build(self) -> super::operation::describe_export_tasks::DescribeExportTasksOutput {
