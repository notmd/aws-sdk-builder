...
impl DeleteLookupTableInput {
    ...
    pub fn builder() -> super::operation::delete_lookup_table::builders::DeleteLookupTableInputBuilder {
        super::operation::delete_lookup_table::builders::DeleteLookupTableInputBuilder::default()
    }
}
...
impl DeleteLookupTableInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::delete_lookup_table::DeleteLookupTableInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::delete_lookup_table::DeleteLookupTableInput {
