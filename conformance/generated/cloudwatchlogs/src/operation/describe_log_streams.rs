    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::describe_log_streams::DescribeLogStreamsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::describe_log_streams::DescribeLogStreamsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeLogStreamsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_describe_log_streams::de_describe_log_streams_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_describe_log_streams::de_describe_log_streams_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeLogStreamsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::describe_log_streams::DescribeLogStreamsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::describe_log_streams::DescribeLogStreamsInput,
        ...
        let body =
            ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_describe_log_streams::ser_describe_log_streams_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::describe_log_streams::DescribeLogStreamsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::describe_log_streams::_describe_log_streams_input::DescribeLogStreamsInput;

pub use super::operation::describe_log_streams::_describe_log_streams_output::DescribeLogStreamsOutput;
