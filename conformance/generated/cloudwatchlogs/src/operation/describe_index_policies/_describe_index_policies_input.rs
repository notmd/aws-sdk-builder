...
impl DescribeIndexPoliciesInput {
    ...
    pub fn builder() -> super::operation::describe_index_policies::builders::DescribeIndexPoliciesInputBuilder {
        super::operation::describe_index_policies::builders::DescribeIndexPoliciesInputBuilder::default()
    }
}
...
impl DescribeIndexPoliciesInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::describe_index_policies::DescribeIndexPoliciesInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::describe_index_policies::DescribeIndexPoliciesInput {
