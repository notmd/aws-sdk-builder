...
impl GetLogRecordInput {
    ...
    pub fn builder() -> super::operation::get_log_record::builders::GetLogRecordInputBuilder {
        super::operation::get_log_record::builders::GetLogRecordInputBuilder::default()
    }
}
