...
impl GetLogRecordOutput {
    ...
    pub fn builder() -> super::operation::get_log_record::builders::GetLogRecordOutputBuilder {
        super::operation::get_log_record::builders::GetLogRecordOutputBuilder::default()
    }
}
...
impl GetLogRecordOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_log_record::GetLogRecordOutput {
