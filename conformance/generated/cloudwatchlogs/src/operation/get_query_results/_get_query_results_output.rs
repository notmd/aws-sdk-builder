...
pub struct GetQueryResultsOutput {
    ...
    pub results: ::std::option::Option<::std::vec::Vec<::std::vec::Vec<super::types::ResultField>>>,
    ...
    pub statistics: ::std::option::Option<super::types::QueryStatistics>,
    ...
    pub status: ::std::option::Option<super::types::QueryStatus>,
...
impl GetQueryResultsOutput {
    ...
    pub fn results(&self) -> &[::std::vec::Vec<super::types::ResultField>] {
        self.results.as_deref().unwrap_or_default()
    }
    /// <p>Includes the number of log events scanned by the query, the number of log events that matched the query criteria, and the total number of bytes in the scanned log events. These values reflect the full raw results of the query.</p>
    pub fn statistics(&self) -> ::std::option::Option<&super::types::QueryStatistics> {
        self.statistics.as_ref()
    }
    /// <p>The status of the most recent running of the query. Possible values are <code>Cancelled</code>, <code>Complete</code>, <code>Failed</code>, <code>Running</code>, <code>Scheduled</code>, <code>Timeout</code>, and <code>Unknown</code>.</p>
    /// <p>Queries time out after 60 minutes of runtime. To avoid having your queries time out, reduce the time range being searched or partition your query into a number of queries.</p>
    pub fn status(&self) -> ::std::option::Option<&super::types::QueryStatus> {
        self.status.as_ref()
    }
    /// <p>If you associated an KMS key with the CloudWatch Logs Insights query results in this account, this field displays the ARN of the key that's used to encrypt the query results when <a href="https://docs.aws.amazon.com/AmazonCloudWatchLogs/latest/APIReference/API_StartQuery.html">StartQuery</a> stores them.</p>
...
impl GetQueryResultsOutput {
    ...
    pub fn builder() -> super::operation::get_query_results::builders::GetQueryResultsOutputBuilder {
        super::operation::get_query_results::builders::GetQueryResultsOutputBuilder::default()
    }
}
...
pub struct GetQueryResultsOutputBuilder {
    ...
    pub(crate) results: ::std::option::Option<::std::vec::Vec<::std::vec::Vec<super::types::ResultField>>>,
    pub(crate) statistics: ::std::option::Option<super::types::QueryStatistics>,
    pub(crate) status: ::std::option::Option<super::types::QueryStatus>,
...
impl GetQueryResultsOutputBuilder {
    ...
    /// <p>The log events that matched the query criteria during the most recent time it ran.</p>
    /// <p>The <code>results</code> value is an array of arrays. Each log event is one object in the top-level array. Each of these log event objects is an array of <code>field</code>/<code>value</code> pairs.</p>
    pub fn results(mut self, input: ::std::vec::Vec<super::types::ResultField>) -> Self {
    ...
    /// <p>The log events that matched the query criteria during the most recent time it ran.</p>
    /// <p>The <code>results</code> value is an array of arrays. Each log event is one object in the top-level array. Each of these log event objects is an array of <code>field</code>/<code>value</code> pairs.</p>
    pub fn set_results(mut self, input: ::std::option::Option<::std::vec::Vec<::std::vec::Vec<super::types::ResultField>>>) -> Self {
        self.results = input;
        self
    }
    /// <p>The log events that matched the query criteria during the most recent time it ran.</p>
    /// <p>The <code>results</code> value is an array of arrays. Each log event is one object in the top-level array. Each of these log event objects is an array of <code>field</code>/<code>value</code> pairs.</p>
    pub fn get_results(&self) -> &::std::option::Option<::std::vec::Vec<::std::vec::Vec<super::types::ResultField>>> {
        &self.results
    }
    /// <p>Includes the number of log events scanned by the query, the number of log events that matched the query criteria, and the total number of bytes in the scanned log events. These values reflect the full raw results of the query.</p>
    pub fn statistics(mut self, input: super::types::QueryStatistics) -> Self {
        self.statistics = ::std::option::Option::Some(input);
        self
    }
    /// <p>Includes the number of log events scanned by the query, the number of log events that matched the query criteria, and the total number of bytes in the scanned log events. These values reflect the full raw results of the query.</p>
    pub fn set_statistics(mut self, input: ::std::option::Option<super::types::QueryStatistics>) -> Self {
        self.statistics = input;
        self
    }
    /// <p>Includes the number of log events scanned by the query, the number of log events that matched the query criteria, and the total number of bytes in the scanned log events. These values reflect the full raw results of the query.</p>
    pub fn get_statistics(&self) -> &::std::option::Option<super::types::QueryStatistics> {
        &self.statistics
    }
    /// <p>The status of the most recent running of the query. Possible values are <code>Cancelled</code>, <code>Complete</code>, <code>Failed</code>, <code>Running</code>, <code>Scheduled</code>, <code>Timeout</code>, and <code>Unknown</code>.</p>
    /// <p>Queries time out after 60 minutes of runtime. To avoid having your queries time out, reduce the time range being searched or partition your query into a number of queries.</p>
    pub fn status(mut self, input: super::types::QueryStatus) -> Self {
        self.status = ::std::option::Option::Some(input);
        self
    }
    /// <p>The status of the most recent running of the query. Possible values are <code>Cancelled</code>, <code>Complete</code>, <code>Failed</code>, <code>Running</code>, <code>Scheduled</code>, <code>Timeout</code>, and <code>Unknown</code>.</p>
    /// <p>Queries time out after 60 minutes of runtime. To avoid having your queries time out, reduce the time range being searched or partition your query into a number of queries.</p>
    pub fn set_status(mut self, input: ::std::option::Option<super::types::QueryStatus>) -> Self {
        self.status = input;
        self
    }
    /// <p>The status of the most recent running of the query. Possible values are <code>Cancelled</code>, <code>Complete</code>, <code>Failed</code>, <code>Running</code>, <code>Scheduled</code>, <code>Timeout</code>, and <code>Unknown</code>.</p>
    /// <p>Queries time out after 60 minutes of runtime. To avoid having your queries time out, reduce the time range being searched or partition your query into a number of queries.</p>
    pub fn get_status(&self) -> &::std::option::Option<super::types::QueryStatus> {
        &self.status
    }
    /// <p>If you associated an KMS key with the CloudWatch Logs Insights query results in this account, this field displays the ARN of the key that's used to encrypt the query results when <a href="https://docs.aws.amazon.com/AmazonCloudWatchLogs/latest/APIReference/API_StartQuery.html">StartQuery</a> stores them.</p>
    ...
    pub fn build(self) -> super::operation::get_query_results::GetQueryResultsOutput {
        super::operation::get_query_results::GetQueryResultsOutput {
