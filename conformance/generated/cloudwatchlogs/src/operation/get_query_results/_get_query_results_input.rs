...
impl GetQueryResultsInput {
    ...
    pub fn builder() -> super::operation::get_query_results::builders::GetQueryResultsInputBuilder {
        super::operation::get_query_results::builders::GetQueryResultsInputBuilder::default()
    }
}
...
impl GetQueryResultsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_query_results::GetQueryResultsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_query_results::GetQueryResultsInput {
