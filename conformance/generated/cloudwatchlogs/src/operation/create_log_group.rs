...
impl CreateLogGroup {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::operation::create_log_group::CreateLogGroupOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::create_log_group::CreateLogGroupError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::create_log_group::CreateLogGroupError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::create_log_group::CreateLogGroupOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateLogGroupResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_create_log_group::de_create_log_group_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_create_log_group::de_create_log_group_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateLogGroupRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::create_log_group::CreateLogGroupInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::create_log_group::CreateLogGroupInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_create_log_group::ser_create_log_group_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::create_log_group::CreateLogGroupError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::create_log_group::_create_log_group_input::CreateLogGroupInput;

pub use super::operation::create_log_group::_create_log_group_output::CreateLogGroupOutput;
