...
impl TestMetricFilterInput {
    ...
    pub fn builder() -> super::operation::test_metric_filter::builders::TestMetricFilterInputBuilder {
        super::operation::test_metric_filter::builders::TestMetricFilterInputBuilder::default()
    }
}
...
impl TestMetricFilterInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::test_metric_filter::TestMetricFilterInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::test_metric_filter::TestMetricFilterInput {
