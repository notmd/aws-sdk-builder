...
impl ListTagsLogGroupInput {
    ...
    pub fn builder() -> super::operation::list_tags_log_group::builders::ListTagsLogGroupInputBuilder {
        super::operation::list_tags_log_group::builders::ListTagsLogGroupInputBuilder::default()
    }
}
...
impl ListTagsLogGroupInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_tags_log_group::ListTagsLogGroupInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_tags_log_group::ListTagsLogGroupInput {
