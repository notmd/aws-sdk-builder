...
impl ListTagsLogGroupOutput {
    ...
    pub fn builder() -> super::operation::list_tags_log_group::builders::ListTagsLogGroupOutputBuilder {
        super::operation::list_tags_log_group::builders::ListTagsLogGroupOutputBuilder::default()
    }
}
...
impl ListTagsLogGroupOutputBuilder {
    ...
    pub fn build(self) -> super::operation::list_tags_log_group::ListTagsLogGroupOutput {
