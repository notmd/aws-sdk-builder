...
impl DeleteSubscriptionFilterInput {
    ...
    pub fn builder() -> super::operation::delete_subscription_filter::builders::DeleteSubscriptionFilterInputBuilder {
        super::operation::delete_subscription_filter::builders::DeleteSubscriptionFilterInputBuilder::default()
    }
}
...
impl DeleteSubscriptionFilterInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::delete_subscription_filter::DeleteSubscriptionFilterInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::delete_subscription_filter::DeleteSubscriptionFilterInput {
