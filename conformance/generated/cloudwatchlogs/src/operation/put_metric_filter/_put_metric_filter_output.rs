...
impl PutMetricFilterOutput {
    ...
    pub fn builder() -> super::operation::put_metric_filter::builders::PutMetricFilterOutputBuilder {
        super::operation::put_metric_filter::builders::PutMetricFilterOutputBuilder::default()
    }
}
...
impl PutMetricFilterOutputBuilder {
    ...
    pub fn build(self) -> super::operation::put_metric_filter::PutMetricFilterOutput {
