...
pub struct PutMetricFilterInput {
    ...
    pub metric_transformations: ::std::option::Option<::std::vec::Vec<super::types::MetricTransformation>>,
...
impl PutMetricFilterInput {
    ...
    pub fn metric_transformations(&self) -> &[super::types::MetricTransformation] {
...
impl PutMetricFilterInput {
    ...
    pub fn builder() -> super::operation::put_metric_filter::builders::PutMetricFilterInputBuilder {
        super::operation::put_metric_filter::builders::PutMetricFilterInputBuilder::default()
    }
}
...
pub struct PutMetricFilterInputBuilder {
    ...
    pub(crate) metric_transformations: ::std::option::Option<::std::vec::Vec<super::types::MetricTransformation>>,
...
impl PutMetricFilterInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::put_metric_filter::PutMetricFilterInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::put_metric_filter::PutMetricFilterInput {
