...
impl DeleteQueryDefinitionOutput {
    ...
    pub fn builder() -> super::operation::delete_query_definition::builders::DeleteQueryDefinitionOutputBuilder {
        super::operation::delete_query_definition::builders::DeleteQueryDefinitionOutputBuilder::default()
    }
}
...
impl DeleteQueryDefinitionOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_query_definition::DeleteQueryDefinitionOutput {
