...
impl DeleteQueryDefinitionInput {
    ...
    pub fn builder() -> super::operation::delete_query_definition::builders::DeleteQueryDefinitionInputBuilder {
        super::operation::delete_query_definition::builders::DeleteQueryDefinitionInputBuilder::default()
    }
}
...
impl DeleteQueryDefinitionInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::delete_query_definition::DeleteQueryDefinitionInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::delete_query_definition::DeleteQueryDefinitionInput {
