...
impl DeleteIndexPolicyInput {
    ...
    pub fn builder() -> super::operation::delete_index_policy::builders::DeleteIndexPolicyInputBuilder {
        super::operation::delete_index_policy::builders::DeleteIndexPolicyInputBuilder::default()
    }
}
...
impl DeleteIndexPolicyInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::delete_index_policy::DeleteIndexPolicyInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::delete_index_policy::DeleteIndexPolicyInput {
