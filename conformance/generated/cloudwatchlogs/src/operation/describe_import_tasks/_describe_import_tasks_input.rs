...
impl DescribeImportTasksInput {
    ...
    pub fn builder() -> super::operation::describe_import_tasks::builders::DescribeImportTasksInputBuilder {
        super::operation::describe_import_tasks::builders::DescribeImportTasksInputBuilder::default()
    }
}
...
impl DescribeImportTasksInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::describe_import_tasks::DescribeImportTasksInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::describe_import_tasks::DescribeImportTasksInput {
