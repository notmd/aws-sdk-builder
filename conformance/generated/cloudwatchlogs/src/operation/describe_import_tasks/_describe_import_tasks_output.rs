...
pub struct DescribeImportTasksOutput {
    ...
    pub imports: ::std::option::Option<::std::vec::Vec<super::types::Import>>,
...
impl DescribeImportTasksOutput {
    ...
    pub fn imports(&self) -> &[super::types::Import] {
...
impl DescribeImportTasksOutput {
    ...
    pub fn builder() -> super::operation::describe_import_tasks::builders::DescribeImportTasksOutputBuilder {
        super::operation::describe_import_tasks::builders::DescribeImportTasksOutputBuilder::default()
    }
}
...
pub struct DescribeImportTasksOutputBuilder {
    pub(crate) imports: ::std::option::Option<::std::vec::Vec<super::types::Import>>,
...
impl DescribeImportTasksOutputBuilder {
    ...
    ///
    /// <p>The list of import tasks that match the request filters.</p>
    pub fn imports(mut self, input: super::types::Import) -> Self {
    ...
    /// <p>The list of import tasks that match the request filters.</p>
    pub fn set_imports(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::Import>>) -> Self {
        self.imports = input;
        self
    }
    /// <p>The list of import tasks that match the request filters.</p>
    pub fn get_imports(&self) -> &::std::option::Option<::std::vec::Vec<super::types::Import>> {
        &self.imports
    }
    /// <p>The token to use when requesting the next set of results. Not present if there are no additional results to retrieve.</p>
    ...
    pub fn build(self) -> super::operation::describe_import_tasks::DescribeImportTasksOutput {
