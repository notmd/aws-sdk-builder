...
impl StartQueryInput {
    ...
    pub fn builder() -> super::operation::start_query::builders::StartQueryInputBuilder {
        super::operation::start_query::builders::StartQueryInputBuilder::default()
    }
}
...
impl StartQueryInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::start_query::StartQueryInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::start_query::StartQueryInput {
