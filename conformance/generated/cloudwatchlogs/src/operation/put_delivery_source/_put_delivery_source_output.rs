...
impl PutDeliverySourceOutput {
    ...
    pub fn builder() -> super::operation::put_delivery_source::builders::PutDeliverySourceOutputBuilder {
        super::operation::put_delivery_source::builders::PutDeliverySourceOutputBuilder::default()
    }
}
...
impl PutDeliverySourceOutputBuilder {
    ...
    pub fn build(self) -> super::operation::put_delivery_source::PutDeliverySourceOutput {
