...
impl PutDeliverySourceInput {
    ...
    pub fn builder() -> super::operation::put_delivery_source::builders::PutDeliverySourceInputBuilder {
        super::operation::put_delivery_source::builders::PutDeliverySourceInputBuilder::default()
    }
}
...
impl PutDeliverySourceInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::put_delivery_source::PutDeliverySourceInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::put_delivery_source::PutDeliverySourceInput {
            name: self.name,
