...
impl DisassociateKmsKeyOutput {
    ...
    pub fn builder() -> super::operation::disassociate_kms_key::builders::DisassociateKmsKeyOutputBuilder {
        super::operation::disassociate_kms_key::builders::DisassociateKmsKeyOutputBuilder::default()
    }
}
...
impl DisassociateKmsKeyOutputBuilder {
    ...
    pub fn build(self) -> super::operation::disassociate_kms_key::DisassociateKmsKeyOutput {
