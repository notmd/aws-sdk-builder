...
pub struct UpdateAnomalyInput {
    ...
    pub suppression_type: ::std::option::Option<super::types::SuppressionType>,
    ...
    pub suppression_period: ::std::option::Option<super::types::SuppressionPeriod>,
...
impl UpdateAnomalyInput {
    ...
    /// <p>Use this to specify whether the suppression to be temporary or infinite. If you specify <code>LIMITED</code>, you must also specify a <code>suppressionPeriod</code>. If you specify <code>INFINITE</code>, any value for <code>suppressionPeriod</code> is ignored.</p>
    pub fn suppression_type(&self) -> ::std::option::Option<&super::types::SuppressionType> {
        self.suppression_type.as_ref()
    }
    /// <p>If you are temporarily suppressing an anomaly or pattern, use this structure to specify how long the suppression is to last.</p>
    pub fn suppression_period(&self) -> ::std::option::Option<&super::types::SuppressionPeriod> {
...
impl UpdateAnomalyInput {
    ...
    pub fn builder() -> super::operation::update_anomaly::builders::UpdateAnomalyInputBuilder {
        super::operation::update_anomaly::builders::UpdateAnomalyInputBuilder::default()
    }
}
...
pub struct UpdateAnomalyInputBuilder {
    ...
    pub(crate) suppression_type: ::std::option::Option<super::types::SuppressionType>,
    pub(crate) suppression_period: ::std::option::Option<super::types::SuppressionPeriod>,
...
impl UpdateAnomalyInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::update_anomaly::UpdateAnomalyInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::update_anomaly::UpdateAnomalyInput {
