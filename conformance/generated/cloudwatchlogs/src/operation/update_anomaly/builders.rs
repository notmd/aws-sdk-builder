...
pub use super::operation::update_anomaly::_update_anomaly_input::UpdateAnomalyInputBuilder;

pub use super::operation::update_anomaly::_update_anomaly_output::UpdateAnomalyOutputBuilder;

impl super::operation::update_anomaly::builders::UpdateAnomalyInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::Client,
    ) -> ::std::result::Result<
        super::operation::update_anomaly::UpdateAnomalyOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::update_anomaly::UpdateAnomalyError,
...
pub struct UpdateAnomalyFluentBuilder {
    ...
    inner: super::operation::update_anomaly::builders::UpdateAnomalyInputBuilder,
...
impl UpdateAnomalyFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::update_anomaly::builders::UpdateAnomalyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::update_anomaly::UpdateAnomaly::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::update_anomaly::UpdateAnomaly::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn suppression_type(mut self, input: super::types::SuppressionType) -> Self {
        self.inner = self.inner.suppression_type(input);
        self
    }
    /// <p>Use this to specify whether the suppression to be temporary or infinite. If you specify <code>LIMITED</code>, you must also specify a <code>suppressionPeriod</code>. If you specify <code>INFINITE</code>, any value for <code>suppressionPeriod</code> is ignored.</p>
    pub fn set_suppression_type(mut self, input: ::std::option::Option<super::types::SuppressionType>) -> Self {
        self.inner = self.inner.set_suppression_type(input);
        self
    }
    /// <p>Use this to specify whether the suppression to be temporary or infinite. If you specify <code>LIMITED</code>, you must also specify a <code>suppressionPeriod</code>. If you specify <code>INFINITE</code>, any value for <code>suppressionPeriod</code> is ignored.</p>
    pub fn get_suppression_type(&self) -> &::std::option::Option<super::types::SuppressionType> {
    ...
    pub fn suppression_period(mut self, input: super::types::SuppressionPeriod) -> Self {
        self.inner = self.inner.suppression_period(input);
        self
    }
    /// <p>If you are temporarily suppressing an anomaly or pattern, use this structure to specify how long the suppression is to last.</p>
    pub fn set_suppression_period(mut self, input: ::std::option::Option<super::types::SuppressionPeriod>) -> Self {
        self.inner = self.inner.set_suppression_period(input);
        self
    }
    /// <p>If you are temporarily suppressing an anomaly or pattern, use this structure to specify how long the suppression is to last.</p>
    pub fn get_suppression_period(&self) -> &::std::option::Option<super::types::SuppressionPeriod> {
