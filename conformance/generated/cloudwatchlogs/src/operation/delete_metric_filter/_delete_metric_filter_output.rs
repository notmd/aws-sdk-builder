...
impl DeleteMetricFilterOutput {
    ...
    pub fn builder() -> super::operation::delete_metric_filter::builders::DeleteMetricFilterOutputBuilder {
        super::operation::delete_metric_filter::builders::DeleteMetricFilterOutputBuilder::default()
    }
}
...
impl DeleteMetricFilterOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_metric_filter::DeleteMetricFilterOutput {
