...
pub struct PutResourcePolicyOutput {
    /// <p>The new policy.</p>
    pub resource_policy: ::std::option::Option<super::types::ResourcePolicy>,
...
impl PutResourcePolicyOutput {
    /// <p>The new policy.</p>
    pub fn resource_policy(&self) -> ::std::option::Option<&super::types::ResourcePolicy> {
...
pub struct PutResourcePolicyOutputBuilder {
    pub(crate) resource_policy: ::std::option::Option<super::types::ResourcePolicy>,
    pub(crate) revision_id: ::std::option::Option<::std::string::String>,
    _request_id: Option<String>,
}
impl PutResourcePolicyOutputBuilder {
    /// <p>The new policy.</p>
    pub fn resource_policy(mut self, input: super::types::ResourcePolicy) -> Self {
        self.resource_policy = ::std::option::Option::Some(input);
        self
    }
    /// <p>The new policy.</p>
    pub fn set_resource_policy(mut self, input: ::std::option::Option<super::types::ResourcePolicy>) -> Self {
        self.resource_policy = input;
        self
    }
    /// <p>The new policy.</p>
    pub fn get_resource_policy(&self) -> &::std::option::Option<super::types::ResourcePolicy> {
