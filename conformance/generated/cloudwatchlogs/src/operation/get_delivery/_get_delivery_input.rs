...
impl GetDeliveryInput {
    ...
    pub fn builder() -> super::operation::get_delivery::builders::GetDeliveryInputBuilder {
        super::operation::get_delivery::builders::GetDeliveryInputBuilder::default()
    }
}
...
impl GetDeliveryInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::get_delivery::GetDeliveryInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_delivery::GetDeliveryInput { id: self.id })
    }
}
