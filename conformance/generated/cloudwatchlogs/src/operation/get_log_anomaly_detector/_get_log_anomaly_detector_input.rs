...
impl GetLogAnomalyDetectorInput {
    ...
    pub fn builder() -> super::operation::get_log_anomaly_detector::builders::GetLogAnomalyDetectorInputBuilder {
        super::operation::get_log_anomaly_detector::builders::GetLogAnomalyDetectorInputBuilder::default()
    }
}
...
impl GetLogAnomalyDetectorInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_log_anomaly_detector::GetLogAnomalyDetectorInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::get_log_anomaly_detector::GetLogAnomalyDetectorInput {
