...
impl GetStorageTierPolicyInput {
    ...
    pub fn builder() -> super::operation::get_storage_tier_policy::builders::GetStorageTierPolicyInputBuilder {
        super::operation::get_storage_tier_policy::builders::GetStorageTierPolicyInputBuilder::default()
    }
}
...
impl GetStorageTierPolicyInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_storage_tier_policy::GetStorageTierPolicyInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::get_storage_tier_policy::GetStorageTierPolicyInput {})
    }
}
