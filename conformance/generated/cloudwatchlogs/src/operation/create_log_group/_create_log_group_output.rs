...
impl CreateLogGroupOutput {
    ...
    pub fn builder() -> super::operation::create_log_group::builders::CreateLogGroupOutputBuilder {
        super::operation::create_log_group::builders::CreateLogGroupOutputBuilder::default()
    }
}
...
impl CreateLogGroupOutputBuilder {
    ...
    pub fn build(self) -> super::operation::create_log_group::CreateLogGroupOutput {
