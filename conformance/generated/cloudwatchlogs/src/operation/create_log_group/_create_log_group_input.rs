...
impl CreateLogGroupInput {
    ...
    pub fn builder() -> super::operation::create_log_group::builders::CreateLogGroupInputBuilder {
        super::operation::create_log_group::builders::CreateLogGroupInputBuilder::default()
    }
}
...
impl CreateLogGroupInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::create_log_group::CreateLogGroupInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::create_log_group::CreateLogGroupInput {
