...
pub use super::operation::create_log_anomaly_detector::_create_log_anomaly_detector_input::CreateLogAnomalyDetectorInputBuilder;

pub use super::operation::create_log_anomaly_detector::_create_log_anomaly_detector_output::CreateLogAnomalyDetectorOutputBuilder;

impl super::operation::create_log_anomaly_detector::builders::CreateLogAnomalyDetectorInputBuilder {
...
pub struct CreateLogAnomalyDetectorFluentBuilder {
    ...
    inner: super::operation::create_log_anomaly_detector::builders::CreateLogAnomalyDetectorInputBuilder,
...
impl CreateLogAnomalyDetectorFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::create_log_anomaly_detector::builders::CreateLogAnomalyDetectorInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::create_log_anomaly_detector::CreateLogAnomalyDetector::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::create_log_anomaly_detector::CreateLogAnomalyDetector::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn evaluation_frequency(mut self, input: super::types::EvaluationFrequency) -> Self {
        self.inner = self.inner.evaluation_frequency(input);
        self
    }
    /// <p>Specifies how often the anomaly detector is to run and look for anomalies. Set this value according to the frequency that the log group receives new logs. For example, if the log group receives new log events every 10 minutes, then 15 minutes might be a good setting for <code>evaluationFrequency</code> .</p>
    pub fn set_evaluation_frequency(mut self, input: ::std::option::Option<super::types::EvaluationFrequency>) -> Self {
        self.inner = self.inner.set_evaluation_frequency(input);
        self
    }
    /// <p>Specifies how often the anomaly detector is to run and look for anomalies. Set this value according to the frequency that the log group receives new logs. For example, if the log group receives new log events every 10 minutes, then 15 minutes might be a good setting for <code>evaluationFrequency</code> .</p>
    pub fn get_evaluation_frequency(&self) -> &::std::option::Option<super::types::EvaluationFrequency> {
