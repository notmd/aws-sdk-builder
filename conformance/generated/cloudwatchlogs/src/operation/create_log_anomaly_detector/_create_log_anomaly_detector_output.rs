...
impl CreateLogAnomalyDetectorOutput {
    ...
    pub fn builder() -> super::operation::create_log_anomaly_detector::builders::CreateLogAnomalyDetectorOutputBuilder {
        super::operation::create_log_anomaly_detector::builders::CreateLogAnomalyDetectorOutputBuilder::default()
    }
}
...
impl CreateLogAnomalyDetectorOutputBuilder {
    ...
    pub fn build(self) -> super::operation::create_log_anomaly_detector::CreateLogAnomalyDetectorOutput {
