...
impl PutDestinationInput {
    ...
    pub fn builder() -> super::operation::put_destination::builders::PutDestinationInputBuilder {
        super::operation::put_destination::builders::PutDestinationInputBuilder::default()
    }
}
...
impl PutDestinationInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::put_destination::PutDestinationInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::put_destination::PutDestinationInput {
