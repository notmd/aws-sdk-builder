...
pub struct PutAccountPolicyInput {
    ...
    pub policy_type: ::std::option::Option<super::types::PolicyType>,
...
impl PutAccountPolicyInput {
    ...
    /// <p>The type of policy that you're creating or updating.</p>
    pub fn policy_type(&self) -> ::std::option::Option<&super::types::PolicyType> {
...
impl PutAccountPolicyInput {
    ...
    pub fn builder() -> super::operation::put_account_policy::builders::PutAccountPolicyInputBuilder {
        super::operation::put_account_policy::builders::PutAccountPolicyInputBuilder::default()
    }
}
...
impl PutAccountPolicyInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::put_account_policy::PutAccountPolicyInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::put_account_policy::PutAccountPolicyInput {
