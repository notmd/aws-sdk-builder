...
pub struct DescribeConfigurationTemplatesInput {
    ...
    pub delivery_destination_types: ::std::option::Option<::std::vec::Vec<super::types::DeliveryDestinationType>>,
...
impl DescribeConfigurationTemplatesInput {
    ...
    pub fn delivery_destination_types(&self) -> &[super::types::DeliveryDestinationType] {
...
impl DescribeConfigurationTemplatesInput {
    ...
    pub fn builder() -> super::operation::describe_configuration_templates::builders::DescribeConfigurationTemplatesInputBuilder {
        super::operation::describe_configuration_templates::builders::DescribeConfigurationTemplatesInputBuilder::default()
    }
}
...
pub struct DescribeConfigurationTemplatesInputBuilder {
    ...
    pub(crate) delivery_destination_types: ::std::option::Option<::std::vec::Vec<super::types::DeliveryDestinationType>>,
...
impl DescribeConfigurationTemplatesInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::describe_configuration_templates::DescribeConfigurationTemplatesInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::describe_configuration_templates::DescribeConfigurationTemplatesInput {
