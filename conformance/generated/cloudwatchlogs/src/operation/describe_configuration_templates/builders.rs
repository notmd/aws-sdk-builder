...
pub use super::operation::describe_configuration_templates::_describe_configuration_templates_input::DescribeConfigurationTemplatesInputBuilder;

pub use super::operation::describe_configuration_templates::_describe_configuration_templates_output::DescribeConfigurationTemplatesOutputBuilder;

impl super::operation::describe_configuration_templates::builders::DescribeConfigurationTemplatesInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::Client,
    ) -> ::std::result::Result<
        super::operation::describe_configuration_templates::DescribeConfigurationTemplatesOutput,
...
pub struct DescribeConfigurationTemplatesFluentBuilder {
    ...
    inner: super::operation::describe_configuration_templates::builders::DescribeConfigurationTemplatesInputBuilder,
...
impl DescribeConfigurationTemplatesFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::describe_configuration_templates::builders::DescribeConfigurationTemplatesInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::describe_configuration_templates::DescribeConfigurationTemplates::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::describe_configuration_templates::DescribeConfigurationTemplates::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::operation::describe_configuration_templates::paginator::DescribeConfigurationTemplatesPaginator {
        super::operation::describe_configuration_templates::paginator::DescribeConfigurationTemplatesPaginator::new(self.handle, self.inner)
    }
    ...
    pub fn delivery_destination_types(mut self, input: super::types::DeliveryDestinationType) -> Self {
        self.inner = self.inner.delivery_destination_types(input);
        self
    }
    /// <p>Use this parameter to filter the response to include only the configuration templates that apply to the delivery destination types that you specify here.</p>
    pub fn set_delivery_destination_types(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::DeliveryDestinationType>>) -> Self {
        self.inner = self.inner.set_delivery_destination_types(input);
        self
    }
    /// <p>Use this parameter to filter the response to include only the configuration templates that apply to the delivery destination types that you specify here.</p>
    pub fn get_delivery_destination_types(&self) -> &::std::option::Option<::std::vec::Vec<super::types::DeliveryDestinationType>> {
