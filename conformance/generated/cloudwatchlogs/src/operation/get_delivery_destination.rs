    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_delivery_destination::GetDeliveryDestinationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_delivery_destination::GetDeliveryDestinationOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetDeliveryDestinationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_delivery_destination::de_get_delivery_destination_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_delivery_destination::de_get_delivery_destination_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetDeliveryDestinationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_delivery_destination::GetDeliveryDestinationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_delivery_destination::GetDeliveryDestinationInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_get_delivery_destination::ser_get_delivery_destination_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::get_delivery_destination::GetDeliveryDestinationError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_delivery_destination::_get_delivery_destination_input::GetDeliveryDestinationInput;

pub use super::operation::get_delivery_destination::_get_delivery_destination_output::GetDeliveryDestinationOutput;
