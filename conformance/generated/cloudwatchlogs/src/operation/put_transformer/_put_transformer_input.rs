...
impl PutTransformerInput {
    ...
    pub fn builder() -> super::operation::put_transformer::builders::PutTransformerInputBuilder {
        super::operation::put_transformer::builders::PutTransformerInputBuilder::default()
    }
}
...
impl PutTransformerInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::put_transformer::PutTransformerInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::put_transformer::PutTransformerInput {
