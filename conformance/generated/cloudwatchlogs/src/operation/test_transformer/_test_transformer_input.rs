...
pub struct TestTransformerInput {
    ...
    pub transformer_config: ::std::option::Option<::std::vec::Vec<super::types::Processor>>,
...
impl TestTransformerInput {
    ...
    pub fn transformer_config(&self) -> &[super::types::Processor] {
...
impl TestTransformerInput {
    ...
    pub fn builder() -> super::operation::test_transformer::builders::TestTransformerInputBuilder {
        super::operation::test_transformer::builders::TestTransformerInputBuilder::default()
    }
}
...
pub struct TestTransformerInputBuilder {
    pub(crate) transformer_config: ::std::option::Option<::std::vec::Vec<super::types::Processor>>,
...
impl TestTransformerInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::test_transformer::TestTransformerInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::test_transformer::TestTransformerInput {
