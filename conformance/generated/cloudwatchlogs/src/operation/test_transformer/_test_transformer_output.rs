...
pub struct TestTransformerOutput {
    ...
    pub transformed_logs: ::std::option::Option<::std::vec::Vec<super::types::TransformedLogRecord>>,
...
impl TestTransformerOutput {
    ...
    pub fn transformed_logs(&self) -> &[super::types::TransformedLogRecord] {
...
impl TestTransformerOutput {
    ...
    pub fn builder() -> super::operation::test_transformer::builders::TestTransformerOutputBuilder {
        super::operation::test_transformer::builders::TestTransformerOutputBuilder::default()
    }
}
...
pub struct TestTransformerOutputBuilder {
    pub(crate) transformed_logs: ::std::option::Option<::std::vec::Vec<super::types::TransformedLogRecord>>,
    _request_id: Option<String>,
}
impl TestTransformerOutputBuilder {
    ...
    ///
    /// <p>An array where each member of the array includes both the original version and the transformed version of one of the log events that you input.</p>
    pub fn transformed_logs(mut self, input: super::types::TransformedLogRecord) -> Self {
    ...
    /// <p>An array where each member of the array includes both the original version and the transformed version of one of the log events that you input.</p>
    pub fn set_transformed_logs(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::TransformedLogRecord>>) -> Self {
        self.transformed_logs = input;
        self
    }
    /// <p>An array where each member of the array includes both the original version and the transformed version of one of the log events that you input.</p>
    pub fn get_transformed_logs(&self) -> &::std::option::Option<::std::vec::Vec<super::types::TransformedLogRecord>> {
    ...
    pub fn build(self) -> super::operation::test_transformer::TestTransformerOutput {
