...
impl PutLogGroupDeletionProtectionInput {
    ...
    pub fn builder() -> super::operation::put_log_group_deletion_protection::builders::PutLogGroupDeletionProtectionInputBuilder {
        super::operation::put_log_group_deletion_protection::builders::PutLogGroupDeletionProtectionInputBuilder::default()
    }
}
...
impl PutLogGroupDeletionProtectionInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::put_log_group_deletion_protection::PutLogGroupDeletionProtectionInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::put_log_group_deletion_protection::PutLogGroupDeletionProtectionInput {
