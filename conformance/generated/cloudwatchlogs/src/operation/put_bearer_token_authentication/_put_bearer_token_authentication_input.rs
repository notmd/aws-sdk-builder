...
impl PutBearerTokenAuthenticationInput {
    ...
    pub fn builder() -> super::operation::put_bearer_token_authentication::builders::PutBearerTokenAuthenticationInputBuilder {
        super::operation::put_bearer_token_authentication::builders::PutBearerTokenAuthenticationInputBuilder::default()
    }
}
...
impl PutBearerTokenAuthenticationInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::put_bearer_token_authentication::PutBearerTokenAuthenticationInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::put_bearer_token_authentication::PutBearerTokenAuthenticationInput {
