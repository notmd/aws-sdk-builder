...
impl GetDeliveryDestinationPolicyInput {
    ...
    pub fn builder() -> super::operation::get_delivery_destination_policy::builders::GetDeliveryDestinationPolicyInputBuilder {
        super::operation::get_delivery_destination_policy::builders::GetDeliveryDestinationPolicyInputBuilder::default()
    }
}
...
impl GetDeliveryDestinationPolicyInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::get_delivery_destination_policy::GetDeliveryDestinationPolicyInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::get_delivery_destination_policy::GetDeliveryDestinationPolicyInput {
