...
pub struct ListLogGroupsInput {
    ...
    pub log_group_tags: ::std::option::Option<::std::vec::Vec<super::types::TagFilter>>,
}
impl ListLogGroupsInput {
    ...
    pub fn log_group_tags(&self) -> &[super::types::TagFilter] {
...
impl ListLogGroupsInput {
    ...
    pub fn builder() -> super::operation::list_log_groups::builders::ListLogGroupsInputBuilder {
        super::operation::list_log_groups::builders::ListLogGroupsInputBuilder::default()
    }
}
...
pub struct ListLogGroupsInputBuilder {
    ...
    pub(crate) log_group_tags: ::std::option::Option<::std::vec::Vec<super::types::TagFilter>>,
}
impl ListLogGroupsInputBuilder {
    ...
    ///
    /// <p>An array of tag filters to return only log groups that have specific tags. Multiple filters are combined with AND logic.</p>
    pub fn log_group_tags(mut self, input: super::types::TagFilter) -> Self {
    ...
    /// <p>An array of tag filters to return only log groups that have specific tags. Multiple filters are combined with AND logic.</p>
    pub fn set_log_group_tags(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::TagFilter>>) -> Self {
        self.log_group_tags = input;
        self
    }
    /// <p>An array of tag filters to return only log groups that have specific tags. Multiple filters are combined with AND logic.</p>
    pub fn get_log_group_tags(&self) -> &::std::option::Option<::std::vec::Vec<super::types::TagFilter>> {
        &self.log_group_tags
    }
    /// Consumes the builder and constructs a [`ListLogGroupsInput`](crate::operation::list_log_groups::ListLogGroupsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_log_groups::ListLogGroupsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_log_groups::ListLogGroupsInput {
