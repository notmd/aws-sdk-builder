...
pub struct ListLogGroupsOutput {
    ...
    pub log_groups: ::std::option::Option<::std::vec::Vec<super::types::LogGroupSummary>>,
...
impl ListLogGroupsOutput {
    ...
    pub fn log_groups(&self) -> &[super::types::LogGroupSummary] {
...
impl ListLogGroupsOutput {
    ...
    pub fn builder() -> super::operation::list_log_groups::builders::ListLogGroupsOutputBuilder {
        super::operation::list_log_groups::builders::ListLogGroupsOutputBuilder::default()
    }
}
...
pub struct ListLogGroupsOutputBuilder {
    pub(crate) log_groups: ::std::option::Option<::std::vec::Vec<super::types::LogGroupSummary>>,
...
impl ListLogGroupsOutputBuilder {
    ...
    ///
    /// <p>An array of structures, where each structure contains the information about one log group.</p>
    pub fn log_groups(mut self, input: super::types::LogGroupSummary) -> Self {
    ...
    /// <p>An array of structures, where each structure contains the information about one log group.</p>
    pub fn set_log_groups(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::LogGroupSummary>>) -> Self {
        self.log_groups = input;
        self
    }
    /// <p>An array of structures, where each structure contains the information about one log group.</p>
    pub fn get_log_groups(&self) -> &::std::option::Option<::std::vec::Vec<super::types::LogGroupSummary>> {
        &self.log_groups
    }
    /// <p>The token for the next set of items to return. The token expires after 24 hours.</p>
    ...
    pub fn build(self) -> super::operation::list_log_groups::ListLogGroupsOutput {
