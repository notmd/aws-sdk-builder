...
impl CancelExportTaskOutput {
    ...
    pub fn builder() -> super::operation::cancel_export_task::builders::CancelExportTaskOutputBuilder {
        super::operation::cancel_export_task::builders::CancelExportTaskOutputBuilder::default()
    }
}
...
impl CancelExportTaskOutputBuilder {
    ...
    pub fn build(self) -> super::operation::cancel_export_task::CancelExportTaskOutput {
