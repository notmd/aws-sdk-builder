...
impl CancelExportTaskInput {
    ...
    pub fn builder() -> super::operation::cancel_export_task::builders::CancelExportTaskInputBuilder {
        super::operation::cancel_export_task::builders::CancelExportTaskInputBuilder::default()
    }
}
...
impl CancelExportTaskInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::cancel_export_task::CancelExportTaskInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::cancel_export_task::CancelExportTaskInput { task_id: self.task_id })
    }
}
