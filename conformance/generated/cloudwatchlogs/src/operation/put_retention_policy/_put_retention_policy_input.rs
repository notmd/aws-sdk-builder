...
impl PutRetentionPolicyInput {
    ...
    pub fn builder() -> super::operation::put_retention_policy::builders::PutRetentionPolicyInputBuilder {
        super::operation::put_retention_policy::builders::PutRetentionPolicyInputBuilder::default()
    }
}
...
impl PutRetentionPolicyInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::put_retention_policy::PutRetentionPolicyInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::put_retention_policy::PutRetentionPolicyInput {
