...
impl PutRetentionPolicyOutput {
    ...
    pub fn builder() -> super::operation::put_retention_policy::builders::PutRetentionPolicyOutputBuilder {
        super::operation::put_retention_policy::builders::PutRetentionPolicyOutputBuilder::default()
    }
}
...
impl PutRetentionPolicyOutputBuilder {
    ...
    pub fn build(self) -> super::operation::put_retention_policy::PutRetentionPolicyOutput {
