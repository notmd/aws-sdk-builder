...
pub struct DescribeDeliveriesOutput {
    ...
    pub deliveries: ::std::option::Option<::std::vec::Vec<super::types::Delivery>>,
...
impl DescribeDeliveriesOutput {
    ...
    pub fn deliveries(&self) -> &[super::types::Delivery] {
...
impl DescribeDeliveriesOutput {
    ...
    pub fn builder() -> super::operation::describe_deliveries::builders::DescribeDeliveriesOutputBuilder {
        super::operation::describe_deliveries::builders::DescribeDeliveriesOutputBuilder::default()
    }
}
...
pub struct DescribeDeliveriesOutputBuilder {
    pub(crate) deliveries: ::std::option::Option<::std::vec::Vec<super::types::Delivery>>,
...
impl DescribeDeliveriesOutputBuilder {
    ...
    ///
    /// <p>An array of structures. Each structure contains information about one delivery in the account.</p>
    pub fn deliveries(mut self, input: super::types::Delivery) -> Self {
    ...
    /// <p>An array of structures. Each structure contains information about one delivery in the account.</p>
    pub fn set_deliveries(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::Delivery>>) -> Self {
        self.deliveries = input;
        self
    }
    /// <p>An array of structures. Each structure contains information about one delivery in the account.</p>
    pub fn get_deliveries(&self) -> &::std::option::Option<::std::vec::Vec<super::types::Delivery>> {
        &self.deliveries
    }
    /// <p>The token for the next set of items to return. The token expires after 24 hours.</p>
    ...
    pub fn build(self) -> super::operation::describe_deliveries::DescribeDeliveriesOutput {
