...
impl DescribeDeliveriesInput {
    ...
    pub fn builder() -> super::operation::describe_deliveries::builders::DescribeDeliveriesInputBuilder {
        super::operation::describe_deliveries::builders::DescribeDeliveriesInputBuilder::default()
    }
}
...
impl DescribeDeliveriesInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::describe_deliveries::DescribeDeliveriesInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::describe_deliveries::DescribeDeliveriesInput {
