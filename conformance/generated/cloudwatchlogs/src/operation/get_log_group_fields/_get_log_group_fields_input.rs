...
impl GetLogGroupFieldsInput {
    ...
    pub fn builder() -> super::operation::get_log_group_fields::builders::GetLogGroupFieldsInputBuilder {
        super::operation::get_log_group_fields::builders::GetLogGroupFieldsInputBuilder::default()
    }
}
...
impl GetLogGroupFieldsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_log_group_fields::GetLogGroupFieldsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_log_group_fields::GetLogGroupFieldsInput {
