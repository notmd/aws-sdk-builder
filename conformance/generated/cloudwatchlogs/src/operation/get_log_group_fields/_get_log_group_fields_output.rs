...
pub struct GetLogGroupFieldsOutput {
    ...
    pub log_group_fields: ::std::option::Option<::std::vec::Vec<super::types::LogGroupField>>,
...
impl GetLogGroupFieldsOutput {
    ...
    pub fn log_group_fields(&self) -> &[super::types::LogGroupField] {
...
impl GetLogGroupFieldsOutput {
    ...
    pub fn builder() -> super::operation::get_log_group_fields::builders::GetLogGroupFieldsOutputBuilder {
        super::operation::get_log_group_fields::builders::GetLogGroupFieldsOutputBuilder::default()
    }
}
...
pub struct GetLogGroupFieldsOutputBuilder {
    pub(crate) log_group_fields: ::std::option::Option<::std::vec::Vec<super::types::LogGroupField>>,
    _request_id: Option<String>,
}
impl GetLogGroupFieldsOutputBuilder {
    ...
    ///
    /// <p>The array of fields found in the query. Each object in the array contains the name of the field, along with the percentage of time it appeared in the log events that were queried.</p>
    pub fn log_group_fields(mut self, input: super::types::LogGroupField) -> Self {
    ...
    /// <p>The array of fields found in the query. Each object in the array contains the name of the field, along with the percentage of time it appeared in the log events that were queried.</p>
    pub fn set_log_group_fields(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::LogGroupField>>) -> Self {
        self.log_group_fields = input;
        self
    }
    /// <p>The array of fields found in the query. Each object in the array contains the name of the field, along with the percentage of time it appeared in the log events that were queried.</p>
    pub fn get_log_group_fields(&self) -> &::std::option::Option<::std::vec::Vec<super::types::LogGroupField>> {
    ...
    pub fn build(self) -> super::operation::get_log_group_fields::GetLogGroupFieldsOutput {
