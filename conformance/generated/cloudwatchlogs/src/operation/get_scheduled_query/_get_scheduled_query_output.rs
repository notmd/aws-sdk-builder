...
impl GetScheduledQueryOutput {
    ...
    pub fn builder() -> super::operation::get_scheduled_query::builders::GetScheduledQueryOutputBuilder {
        super::operation::get_scheduled_query::builders::GetScheduledQueryOutputBuilder::default()
    }
}
...
impl GetScheduledQueryOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_scheduled_query::GetScheduledQueryOutput {
