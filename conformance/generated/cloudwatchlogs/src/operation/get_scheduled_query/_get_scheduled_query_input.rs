...
impl GetScheduledQueryInput {
    ...
    pub fn builder() -> super::operation::get_scheduled_query::builders::GetScheduledQueryInputBuilder {
        super::operation::get_scheduled_query::builders::GetScheduledQueryInputBuilder::default()
    }
}
...
impl GetScheduledQueryInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_scheduled_query::GetScheduledQueryInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_scheduled_query::GetScheduledQueryInput { identifier: self.identifier })
    }
}
