...
impl DescribeLookupTablesInput {
    ...
    pub fn builder() -> super::operation::describe_lookup_tables::builders::DescribeLookupTablesInputBuilder {
        super::operation::describe_lookup_tables::builders::DescribeLookupTablesInputBuilder::default()
    }
}
...
impl DescribeLookupTablesInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::describe_lookup_tables::DescribeLookupTablesInput, ::aws_smithy_types::error::operation::BuildError>
    {
