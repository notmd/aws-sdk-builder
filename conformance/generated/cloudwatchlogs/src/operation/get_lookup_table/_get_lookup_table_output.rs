...
impl GetLookupTableOutput {
    ...
    pub fn builder() -> super::operation::get_lookup_table::builders::GetLookupTableOutputBuilder {
        super::operation::get_lookup_table::builders::GetLookupTableOutputBuilder::default()
    }
}
...
impl GetLookupTableOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_lookup_table::GetLookupTableOutput {
