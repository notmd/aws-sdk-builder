...
impl GetLookupTableInput {
    ...
    pub fn builder() -> super::operation::get_lookup_table::builders::GetLookupTableInputBuilder {
        super::operation::get_lookup_table::builders::GetLookupTableInputBuilder::default()
    }
}
...
impl GetLookupTableInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_lookup_table::GetLookupTableInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_lookup_table::GetLookupTableInput {
