...
impl CancelImportTaskInput {
    ...
    pub fn builder() -> super::operation::cancel_import_task::builders::CancelImportTaskInputBuilder {
        super::operation::cancel_import_task::builders::CancelImportTaskInputBuilder::default()
    }
}
...
impl CancelImportTaskInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::cancel_import_task::CancelImportTaskInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::cancel_import_task::CancelImportTaskInput { import_id: self.import_id })
    }
}
