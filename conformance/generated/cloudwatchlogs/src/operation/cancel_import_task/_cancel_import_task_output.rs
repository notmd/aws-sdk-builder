...
impl CancelImportTaskOutput {
    ...
    pub fn builder() -> super::operation::cancel_import_task::builders::CancelImportTaskOutputBuilder {
        super::operation::cancel_import_task::builders::CancelImportTaskOutputBuilder::default()
    }
}
...
impl CancelImportTaskOutputBuilder {
    ...
    pub fn build(self) -> super::operation::cancel_import_task::CancelImportTaskOutput {
