...
impl PutQueryDefinitionOutput {
    ...
    pub fn builder() -> super::operation::put_query_definition::builders::PutQueryDefinitionOutputBuilder {
        super::operation::put_query_definition::builders::PutQueryDefinitionOutputBuilder::default()
    }
}
...
impl PutQueryDefinitionOutputBuilder {
    ...
    pub fn build(self) -> super::operation::put_query_definition::PutQueryDefinitionOutput {
