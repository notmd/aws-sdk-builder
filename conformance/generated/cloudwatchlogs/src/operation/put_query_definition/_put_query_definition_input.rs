...
pub struct PutQueryDefinitionInput {
    ...
    pub parameters: ::std::option::Option<::std::vec::Vec<super::types::QueryParameter>>,
}
impl PutQueryDefinitionInput {
    ...
    pub fn parameters(&self) -> &[super::types::QueryParameter] {
...
impl PutQueryDefinitionInput {
    ...
    pub fn builder() -> super::operation::put_query_definition::builders::PutQueryDefinitionInputBuilder {
        super::operation::put_query_definition::builders::PutQueryDefinitionInputBuilder::default()
    }
}
...
pub struct PutQueryDefinitionInputBuilder {
    ...
    pub(crate) parameters: ::std::option::Option<::std::vec::Vec<super::types::QueryParameter>>,
}
impl PutQueryDefinitionInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::put_query_definition::PutQueryDefinitionInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::put_query_definition::PutQueryDefinitionInput {
