...
impl PutIndexPolicyInput {
    ...
    pub fn builder() -> super::operation::put_index_policy::builders::PutIndexPolicyInputBuilder {
        super::operation::put_index_policy::builders::PutIndexPolicyInputBuilder::default()
    }
}
...
impl PutIndexPolicyInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::put_index_policy::PutIndexPolicyInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::put_index_policy::PutIndexPolicyInput {
