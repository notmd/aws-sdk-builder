...
impl DeleteIntegrationOutput {
    ...
    pub fn builder() -> super::operation::delete_integration::builders::DeleteIntegrationOutputBuilder {
        super::operation::delete_integration::builders::DeleteIntegrationOutputBuilder::default()
    }
}
...
impl DeleteIntegrationOutputBuilder {
    ...
    pub fn build(self) -> super::operation::delete_integration::DeleteIntegrationOutput {
