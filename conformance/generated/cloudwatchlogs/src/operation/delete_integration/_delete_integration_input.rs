...
impl DeleteIntegrationInput {
    ...
    pub fn builder() -> super::operation::delete_integration::builders::DeleteIntegrationInputBuilder {
        super::operation::delete_integration::builders::DeleteIntegrationInputBuilder::default()
    }
}
