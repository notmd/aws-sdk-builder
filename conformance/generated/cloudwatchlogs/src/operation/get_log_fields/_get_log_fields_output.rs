...
pub struct GetLogFieldsOutput {
    ...
    pub log_fields: ::std::option::Option<::std::vec::Vec<super::types::LogFieldsListItem>>,
...
impl GetLogFieldsOutput {
    ...
    pub fn log_fields(&self) -> &[super::types::LogFieldsListItem] {
...
impl GetLogFieldsOutput {
    ...
    pub fn builder() -> super::operation::get_log_fields::builders::GetLogFieldsOutputBuilder {
        super::operation::get_log_fields::builders::GetLogFieldsOutputBuilder::default()
    }
}
...
pub struct GetLogFieldsOutputBuilder {
    pub(crate) log_fields: ::std::option::Option<::std::vec::Vec<super::types::LogFieldsListItem>>,
    _request_id: Option<String>,
}
impl GetLogFieldsOutputBuilder {
    ...
    ///
    /// <p>The list of log fields for the specified data source, including field names and their data types.</p>
    pub fn log_fields(mut self, input: super::types::LogFieldsListItem) -> Self {
    ...
    /// <p>The list of log fields for the specified data source, including field names and their data types.</p>
    pub fn set_log_fields(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::LogFieldsListItem>>) -> Self {
        self.log_fields = input;
        self
    }
    /// <p>The list of log fields for the specified data source, including field names and their data types.</p>
    pub fn get_log_fields(&self) -> &::std::option::Option<::std::vec::Vec<super::types::LogFieldsListItem>> {
        &self.log_fields
    }
    ...
    pub fn build(self) -> super::operation::get_log_fields::GetLogFieldsOutput {
