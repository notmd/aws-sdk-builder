...
impl GetLogFieldsInput {
    ...
    pub fn builder() -> super::operation::get_log_fields::builders::GetLogFieldsInputBuilder {
        super::operation::get_log_fields::builders::GetLogFieldsInputBuilder::default()
    }
}
...
impl GetLogFieldsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_log_fields::GetLogFieldsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_log_fields::GetLogFieldsInput {
