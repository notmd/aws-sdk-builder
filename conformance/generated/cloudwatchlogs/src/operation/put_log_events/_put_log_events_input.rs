...
pub struct PutLogEventsInput {
    ...
    /// <p>The log events.</p>
    pub log_events: ::std::option::Option<::std::vec::Vec<super::types::InputLogEvent>>,
    ...
    pub entity: ::std::option::Option<super::types::Entity>,
}
impl PutLogEventsInput {
    ...
    pub fn log_events(&self) -> &[super::types::InputLogEvent] {
    ...
    /// <p>The entity associated with the log events.</p>
    pub fn entity(&self) -> ::std::option::Option<&super::types::Entity> {
        self.entity.as_ref()
    }
}
impl PutLogEventsInput {
    /// Creates a new builder-style object to manufacture [`PutLogEventsInput`](crate::operation::put_log_events::PutLogEventsInput).
    pub fn builder() -> super::operation::put_log_events::builders::PutLogEventsInputBuilder {
        super::operation::put_log_events::builders::PutLogEventsInputBuilder::default()
    }
}
...
pub struct PutLogEventsInputBuilder {
    ...
    pub(crate) log_events: ::std::option::Option<::std::vec::Vec<super::types::InputLogEvent>>,
    pub(crate) sequence_token: ::std::option::Option<::std::string::String>,
    pub(crate) entity: ::std::option::Option<super::types::Entity>,
}
impl PutLogEventsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::put_log_events::PutLogEventsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::put_log_events::PutLogEventsInput {
