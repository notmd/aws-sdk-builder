...
impl DeleteTransformerInput {
    ...
    pub fn builder() -> super::operation::delete_transformer::builders::DeleteTransformerInputBuilder {
        super::operation::delete_transformer::builders::DeleteTransformerInputBuilder::default()
    }
}
...
impl DeleteTransformerInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::delete_transformer::DeleteTransformerInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::delete_transformer::DeleteTransformerInput {
