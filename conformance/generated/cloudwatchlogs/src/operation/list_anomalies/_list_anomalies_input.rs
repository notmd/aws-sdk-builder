...
pub struct ListAnomaliesInput {
    ...
    pub suppression_state: ::std::option::Option<super::types::SuppressionState>,
...
impl ListAnomaliesInput {
    ...
    /// <p>You can specify this parameter if you want to the operation to return only anomalies that are currently either suppressed or unsuppressed.</p>
    pub fn suppression_state(&self) -> ::std::option::Option<&super::types::SuppressionState> {
...
impl ListAnomaliesInput {
    ...
    pub fn builder() -> super::operation::list_anomalies::builders::ListAnomaliesInputBuilder {
        super::operation::list_anomalies::builders::ListAnomaliesInputBuilder::default()
    }
}
...
pub struct ListAnomaliesInputBuilder {
    ...
    pub(crate) suppression_state: ::std::option::Option<super::types::SuppressionState>,
...
impl ListAnomaliesInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_anomalies::ListAnomaliesInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_anomalies::ListAnomaliesInput {
