...
impl CreateLookupTableOutput {
    ...
    pub fn builder() -> super::operation::create_lookup_table::builders::CreateLookupTableOutputBuilder {
        super::operation::create_lookup_table::builders::CreateLookupTableOutputBuilder::default()
    }
}
...
impl CreateLookupTableOutputBuilder {
    ...
    pub fn build(self) -> super::operation::create_lookup_table::CreateLookupTableOutput {
