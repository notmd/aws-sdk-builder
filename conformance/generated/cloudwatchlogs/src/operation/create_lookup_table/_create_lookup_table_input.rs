...
impl CreateLookupTableInput {
    ...
    pub fn builder() -> super::operation::create_lookup_table::builders::CreateLookupTableInputBuilder {
        super::operation::create_lookup_table::builders::CreateLookupTableInputBuilder::default()
    }
}
...
impl CreateLookupTableInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::create_lookup_table::CreateLookupTableInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::create_lookup_table::CreateLookupTableInput {
