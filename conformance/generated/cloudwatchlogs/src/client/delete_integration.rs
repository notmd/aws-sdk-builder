...
impl super::Client {
    ...
    pub fn delete_integration(&self) -> super::operation::delete_integration::builders::DeleteIntegrationFluentBuilder {
        super::operation::delete_integration::builders::DeleteIntegrationFluentBuilder::new(self.handle.clone())
    }
}
