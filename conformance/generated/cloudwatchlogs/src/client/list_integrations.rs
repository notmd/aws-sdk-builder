...
impl super::Client {
    ...
    pub fn list_integrations(&self) -> super::operation::list_integrations::builders::ListIntegrationsFluentBuilder {
        super::operation::list_integrations::builders::ListIntegrationsFluentBuilder::new(self.handle.clone())
    }
}
