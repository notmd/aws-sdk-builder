...
impl super::Client {
    ...
    pub fn delete_metric_filter(&self) -> super::operation::delete_metric_filter::builders::DeleteMetricFilterFluentBuilder {
        super::operation::delete_metric_filter::builders::DeleteMetricFilterFluentBuilder::new(self.handle.clone())
    }
}
