...
impl super::Client {
    ...
    pub fn get_delivery_source(&self) -> super::operation::get_delivery_source::builders::GetDeliverySourceFluentBuilder {
        super::operation::get_delivery_source::builders::GetDeliverySourceFluentBuilder::new(self.handle.clone())
    }
}
