...
impl super::Client {
    ...
    pub fn get_delivery_destination_policy(
        &self,
    ) -> super::operation::get_delivery_destination_policy::builders::GetDeliveryDestinationPolicyFluentBuilder {
        super::operation::get_delivery_destination_policy::builders::GetDeliveryDestinationPolicyFluentBuilder::new(self.handle.clone())
    }
}
