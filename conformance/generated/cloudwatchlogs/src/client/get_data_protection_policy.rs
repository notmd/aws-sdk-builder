...
impl super::Client {
    ...
    pub fn get_data_protection_policy(&self) -> super::operation::get_data_protection_policy::builders::GetDataProtectionPolicyFluentBuilder {
        super::operation::get_data_protection_policy::builders::GetDataProtectionPolicyFluentBuilder::new(self.handle.clone())
    }
}
