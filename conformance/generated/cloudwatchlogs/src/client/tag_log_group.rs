...
impl super::Client {
    ...
    pub fn tag_log_group(&self) -> super::operation::tag_log_group::builders::TagLogGroupFluentBuilder {
        super::operation::tag_log_group::builders::TagLogGroupFluentBuilder::new(self.handle.clone())
    }
}
