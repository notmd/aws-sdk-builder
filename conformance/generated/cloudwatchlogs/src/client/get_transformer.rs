...
impl super::Client {
    ...
    pub fn get_transformer(&self) -> super::operation::get_transformer::builders::GetTransformerFluentBuilder {
        super::operation::get_transformer::builders::GetTransformerFluentBuilder::new(self.handle.clone())
    }
}
