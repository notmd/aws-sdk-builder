...
impl super::Client {
    ...
    pub fn list_anomalies(&self) -> super::operation::list_anomalies::builders::ListAnomaliesFluentBuilder {
        super::operation::list_anomalies::builders::ListAnomaliesFluentBuilder::new(self.handle.clone())
    }
}
