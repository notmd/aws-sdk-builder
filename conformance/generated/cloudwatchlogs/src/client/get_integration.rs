...
impl super::Client {
    ...
    pub fn get_integration(&self) -> super::operation::get_integration::builders::GetIntegrationFluentBuilder {
        super::operation::get_integration::builders::GetIntegrationFluentBuilder::new(self.handle.clone())
    }
}
