...
impl super::Client {
    ...
    pub fn get_delivery_destination(&self) -> super::operation::get_delivery_destination::builders::GetDeliveryDestinationFluentBuilder {
        super::operation::get_delivery_destination::builders::GetDeliveryDestinationFluentBuilder::new(self.handle.clone())
    }
}
