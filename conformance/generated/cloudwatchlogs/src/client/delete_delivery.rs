...
impl super::Client {
    ...
    pub fn delete_delivery(&self) -> super::operation::delete_delivery::builders::DeleteDeliveryFluentBuilder {
        super::operation::delete_delivery::builders::DeleteDeliveryFluentBuilder::new(self.handle.clone())
    }
}
