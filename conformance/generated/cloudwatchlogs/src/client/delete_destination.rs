...
impl super::Client {
    ...
    pub fn delete_destination(&self) -> super::operation::delete_destination::builders::DeleteDestinationFluentBuilder {
        super::operation::delete_destination::builders::DeleteDestinationFluentBuilder::new(self.handle.clone())
    }
}
