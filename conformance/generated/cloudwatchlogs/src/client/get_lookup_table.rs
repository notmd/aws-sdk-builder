...
impl super::Client {
    ...
    pub fn get_lookup_table(&self) -> super::operation::get_lookup_table::builders::GetLookupTableFluentBuilder {
        super::operation::get_lookup_table::builders::GetLookupTableFluentBuilder::new(self.handle.clone())
    }
}
