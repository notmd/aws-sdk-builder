...
impl super::Client {
    ...
    pub fn describe_subscription_filters(
        &self,
    ) -> super::operation::describe_subscription_filters::builders::DescribeSubscriptionFiltersFluentBuilder {
        super::operation::describe_subscription_filters::builders::DescribeSubscriptionFiltersFluentBuilder::new(self.handle.clone())
    }
}
