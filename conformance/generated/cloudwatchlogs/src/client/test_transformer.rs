...
impl super::Client {
    ...
    pub fn test_transformer(&self) -> super::operation::test_transformer::builders::TestTransformerFluentBuilder {
        super::operation::test_transformer::builders::TestTransformerFluentBuilder::new(self.handle.clone())
    }
}
