...
impl super::Client {
    ...
    pub fn put_retention_policy(&self) -> super::operation::put_retention_policy::builders::PutRetentionPolicyFluentBuilder {
        super::operation::put_retention_policy::builders::PutRetentionPolicyFluentBuilder::new(self.handle.clone())
    }
}
