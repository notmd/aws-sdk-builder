...
impl super::Client {
    ...
    pub fn describe_deliveries(&self) -> super::operation::describe_deliveries::builders::DescribeDeliveriesFluentBuilder {
        super::operation::describe_deliveries::builders::DescribeDeliveriesFluentBuilder::new(self.handle.clone())
    }
}
