...
impl super::Client {
    ...
    pub fn delete_scheduled_query(&self) -> super::operation::delete_scheduled_query::builders::DeleteScheduledQueryFluentBuilder {
        super::operation::delete_scheduled_query::builders::DeleteScheduledQueryFluentBuilder::new(self.handle.clone())
    }
}
