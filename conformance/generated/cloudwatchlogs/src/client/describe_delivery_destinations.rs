...
impl super::Client {
    ...
    pub fn describe_delivery_destinations(
        &self,
    ) -> super::operation::describe_delivery_destinations::builders::DescribeDeliveryDestinationsFluentBuilder {
        super::operation::describe_delivery_destinations::builders::DescribeDeliveryDestinationsFluentBuilder::new(self.handle.clone())
    }
}
