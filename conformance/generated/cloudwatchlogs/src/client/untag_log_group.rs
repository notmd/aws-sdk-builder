...
impl super::Client {
    ...
    pub fn untag_log_group(&self) -> super::operation::untag_log_group::builders::UntagLogGroupFluentBuilder {
        super::operation::untag_log_group::builders::UntagLogGroupFluentBuilder::new(self.handle.clone())
    }
}
