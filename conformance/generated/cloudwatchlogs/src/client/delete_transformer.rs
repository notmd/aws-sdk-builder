...
impl super::Client {
    ...
    pub fn delete_transformer(&self) -> super::operation::delete_transformer::builders::DeleteTransformerFluentBuilder {
        super::operation::delete_transformer::builders::DeleteTransformerFluentBuilder::new(self.handle.clone())
    }
}
