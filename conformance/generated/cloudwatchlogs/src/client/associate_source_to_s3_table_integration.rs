...
impl super::Client {
    ...
    pub fn associate_source_to_s3_table_integration(
        &self,
    ) -> super::operation::associate_source_to_s3_table_integration::builders::AssociateSourceToS3TableIntegrationFluentBuilder {
        super::operation::associate_source_to_s3_table_integration::builders::AssociateSourceToS3TableIntegrationFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
