...
impl super::Client {
    ...
    pub fn describe_resource_policies(&self) -> super::operation::describe_resource_policies::builders::DescribeResourcePoliciesFluentBuilder {
        super::operation::describe_resource_policies::builders::DescribeResourcePoliciesFluentBuilder::new(self.handle.clone())
    }
}
