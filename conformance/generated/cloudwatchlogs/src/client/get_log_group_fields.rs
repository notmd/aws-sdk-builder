...
impl super::Client {
    ...
    pub fn get_log_group_fields(&self) -> super::operation::get_log_group_fields::builders::GetLogGroupFieldsFluentBuilder {
        super::operation::get_log_group_fields::builders::GetLogGroupFieldsFluentBuilder::new(self.handle.clone())
    }
}
