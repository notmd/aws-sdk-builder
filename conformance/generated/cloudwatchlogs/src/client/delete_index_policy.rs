...
impl super::Client {
    ...
    pub fn delete_index_policy(&self) -> super::operation::delete_index_policy::builders::DeleteIndexPolicyFluentBuilder {
        super::operation::delete_index_policy::builders::DeleteIndexPolicyFluentBuilder::new(self.handle.clone())
    }
}
