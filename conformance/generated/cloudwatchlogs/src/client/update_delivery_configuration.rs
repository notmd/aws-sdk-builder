...
impl super::Client {
    ...
    pub fn update_delivery_configuration(
        &self,
    ) -> super::operation::update_delivery_configuration::builders::UpdateDeliveryConfigurationFluentBuilder {
        super::operation::update_delivery_configuration::builders::UpdateDeliveryConfigurationFluentBuilder::new(self.handle.clone())
    }
}
