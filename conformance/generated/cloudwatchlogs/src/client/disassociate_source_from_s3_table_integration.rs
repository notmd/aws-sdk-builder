...
impl super::Client {
    ...
    pub fn disassociate_source_from_s3_table_integration(
        &self,
    ) -> super::operation::disassociate_source_from_s3_table_integration::builders::DisassociateSourceFromS3TableIntegrationFluentBuilder {
        super::operation::disassociate_source_from_s3_table_integration::builders::DisassociateSourceFromS3TableIntegrationFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
