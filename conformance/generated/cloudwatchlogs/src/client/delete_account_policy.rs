...
impl super::Client {
    ...
    pub fn delete_account_policy(&self) -> super::operation::delete_account_policy::builders::DeleteAccountPolicyFluentBuilder {
        super::operation::delete_account_policy::builders::DeleteAccountPolicyFluentBuilder::new(self.handle.clone())
    }
}
