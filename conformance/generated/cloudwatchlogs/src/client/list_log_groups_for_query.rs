...
impl super::Client {
    ...
    pub fn list_log_groups_for_query(&self) -> super::operation::list_log_groups_for_query::builders::ListLogGroupsForQueryFluentBuilder {
        super::operation::list_log_groups_for_query::builders::ListLogGroupsForQueryFluentBuilder::new(self.handle.clone())
    }
}
