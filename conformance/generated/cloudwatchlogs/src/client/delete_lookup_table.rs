...
impl super::Client {
    ...
    pub fn delete_lookup_table(&self) -> super::operation::delete_lookup_table::builders::DeleteLookupTableFluentBuilder {
        super::operation::delete_lookup_table::builders::DeleteLookupTableFluentBuilder::new(self.handle.clone())
    }
}
