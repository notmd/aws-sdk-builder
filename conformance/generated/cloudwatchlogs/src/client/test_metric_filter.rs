...
impl super::Client {
    ...
    pub fn test_metric_filter(&self) -> super::operation::test_metric_filter::builders::TestMetricFilterFluentBuilder {
        super::operation::test_metric_filter::builders::TestMetricFilterFluentBuilder::new(self.handle.clone())
    }
}
