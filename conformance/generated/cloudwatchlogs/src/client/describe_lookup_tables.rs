...
impl super::Client {
    ...
    pub fn describe_lookup_tables(&self) -> super::operation::describe_lookup_tables::builders::DescribeLookupTablesFluentBuilder {
        super::operation::describe_lookup_tables::builders::DescribeLookupTablesFluentBuilder::new(self.handle.clone())
    }
}
