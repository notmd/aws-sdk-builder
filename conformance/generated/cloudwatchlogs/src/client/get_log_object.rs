...
impl super::Client {
    ...
    pub fn get_log_object(&self) -> super::operation::get_log_object::builders::GetLogObjectFluentBuilder {
        super::operation::get_log_object::builders::GetLogObjectFluentBuilder::new(self.handle.clone())
    }
}
