...
impl super::Client {
    ...
    pub fn delete_log_anomaly_detector(&self) -> super::operation::delete_log_anomaly_detector::builders::DeleteLogAnomalyDetectorFluentBuilder {
        super::operation::delete_log_anomaly_detector::builders::DeleteLogAnomalyDetectorFluentBuilder::new(self.handle.clone())
    }
}
