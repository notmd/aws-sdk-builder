...
impl super::Client {
    ...
    pub fn delete_data_protection_policy(
        &self,
    ) -> super::operation::delete_data_protection_policy::builders::DeleteDataProtectionPolicyFluentBuilder {
        super::operation::delete_data_protection_policy::builders::DeleteDataProtectionPolicyFluentBuilder::new(self.handle.clone())
    }
}
