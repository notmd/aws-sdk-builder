...
impl super::Client {
    ...
    pub fn delete_retention_policy(&self) -> super::operation::delete_retention_policy::builders::DeleteRetentionPolicyFluentBuilder {
        super::operation::delete_retention_policy::builders::DeleteRetentionPolicyFluentBuilder::new(self.handle.clone())
    }
}
