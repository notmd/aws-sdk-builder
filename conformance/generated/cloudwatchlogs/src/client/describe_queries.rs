...
impl super::Client {
    ...
    pub fn describe_queries(&self) -> super::operation::describe_queries::builders::DescribeQueriesFluentBuilder {
        super::operation::describe_queries::builders::DescribeQueriesFluentBuilder::new(self.handle.clone())
    }
}
