...
impl super::Client {
    ...
    pub fn describe_query_definitions(&self) -> super::operation::describe_query_definitions::builders::DescribeQueryDefinitionsFluentBuilder {
        super::operation::describe_query_definitions::builders::DescribeQueryDefinitionsFluentBuilder::new(self.handle.clone())
    }
}
