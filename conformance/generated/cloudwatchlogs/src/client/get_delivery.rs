...
impl super::Client {
    ...
    pub fn get_delivery(&self) -> super::operation::get_delivery::builders::GetDeliveryFluentBuilder {
        super::operation::get_delivery::builders::GetDeliveryFluentBuilder::new(self.handle.clone())
    }
}
