...
impl super::Client {
    ...
    pub fn delete_delivery_source(&self) -> super::operation::delete_delivery_source::builders::DeleteDeliverySourceFluentBuilder {
        super::operation::delete_delivery_source::builders::DeleteDeliverySourceFluentBuilder::new(self.handle.clone())
    }
}
