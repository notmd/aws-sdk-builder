...
impl super::Client {
    ...
    pub fn get_storage_tier_policy(&self) -> super::operation::get_storage_tier_policy::builders::GetStorageTierPolicyFluentBuilder {
        super::operation::get_storage_tier_policy::builders::GetStorageTierPolicyFluentBuilder::new(self.handle.clone())
    }
}
