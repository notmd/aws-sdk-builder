...
impl super::Client {
    ...
    pub fn delete_delivery_destination_policy(
        &self,
    ) -> super::super::operation::delete_delivery_destination_policy::builders::DeleteDeliveryDestinationPolicyFluentBuilder {
        super::super::operation::delete_delivery_destination_policy::builders::DeleteDeliveryDestinationPolicyFluentBuilder::new(self.handle.clone())
    }
}
