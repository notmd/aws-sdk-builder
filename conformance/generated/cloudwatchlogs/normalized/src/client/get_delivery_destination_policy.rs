...
impl super::Client {
    ...
    pub fn get_delivery_destination_policy(
        &self,
    ) -> super::super::operation::get_delivery_destination_policy::builders::GetDeliveryDestinationPolicyFluentBuilder {
        super::super::operation::get_delivery_destination_policy::builders::GetDeliveryDestinationPolicyFluentBuilder::new(self.handle.clone())
    }
}
