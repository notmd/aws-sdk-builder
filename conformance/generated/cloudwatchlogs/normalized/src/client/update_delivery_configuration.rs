...
impl super::Client {
    ...
    pub fn update_delivery_configuration(
        &self,
    ) -> super::super::operation::update_delivery_configuration::builders::UpdateDeliveryConfigurationFluentBuilder {
        super::super::operation::update_delivery_configuration::builders::UpdateDeliveryConfigurationFluentBuilder::new(self.handle.clone())
    }
}
