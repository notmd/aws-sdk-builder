...
impl super::Client {
    ...
    pub fn delete_data_protection_policy(
        &self,
    ) -> super::super::operation::delete_data_protection_policy::builders::DeleteDataProtectionPolicyFluentBuilder {
        super::super::operation::delete_data_protection_policy::builders::DeleteDataProtectionPolicyFluentBuilder::new(self.handle.clone())
    }
}
