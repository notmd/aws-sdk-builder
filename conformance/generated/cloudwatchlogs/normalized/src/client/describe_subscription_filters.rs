...
impl super::Client {
    ...
    pub fn describe_subscription_filters(
        &self,
    ) -> super::super::operation::describe_subscription_filters::builders::DescribeSubscriptionFiltersFluentBuilder {
        super::super::operation::describe_subscription_filters::builders::DescribeSubscriptionFiltersFluentBuilder::new(self.handle.clone())
    }
}
