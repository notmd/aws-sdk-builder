...
impl super::Client {
    ...
    pub fn put_log_group_deletion_protection(
        &self,
    ) -> super::super::operation::put_log_group_deletion_protection::builders::PutLogGroupDeletionProtectionFluentBuilder {
        super::super::operation::put_log_group_deletion_protection::builders::PutLogGroupDeletionProtectionFluentBuilder::new(self.handle.clone())
    }
}
