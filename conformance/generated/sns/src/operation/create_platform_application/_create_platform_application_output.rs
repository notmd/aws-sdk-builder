...
impl CreatePlatformApplicationOutput {
    pub fn builder() -> CreatePlatformApplicationOutputBuilder { CreatePlatformApplicationOutputBuilder::default() }
}
#[derive(Clone, Debug, Default)]
...
impl CreatePlatformApplicationOutputBuilder {
    ...
    pub fn build(self) -> CreatePlatformApplicationOutput { CreatePlatformApplicationOutput {
