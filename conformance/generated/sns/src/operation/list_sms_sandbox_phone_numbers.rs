...
pub mod _list_sms_sandbox_phone_numbers_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/list_sms_sandbox_phone_numbers/_list_sms_sandbox_phone_numbers_input.rs"
    ));
}
...
pub mod _list_sms_sandbox_phone_numbers_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/list_sms_sandbox_phone_numbers/_list_sms_sandbox_phone_numbers_output.rs"
    ));
}
