...
impl ListSmsSandboxPhoneNumbers {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::list_sms_sandbox_phone_numbers::ListSmsSandboxPhoneNumbersInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_sms_sandbox_phone_numbers::ListSMSSandboxPhoneNumbersError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_sms_sandbox_phone_numbers::ListSmsSandboxPhoneNumbersOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListSMSSandboxPhoneNumbersResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_sms_sandbox_phone_numbers::de_list_sms_sandbox_phone_numbers_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_sms_sandbox_phone_numbers::de_list_sms_sandbox_phone_numbers_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListSMSSandboxPhoneNumbersRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_sms_sandbox_phone_numbers::ListSmsSandboxPhoneNumbersInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_sms_sandbox_phone_numbers::ListSmsSandboxPhoneNumbersInput,
...
impl ::aws_types::request_id::RequestId for super::operation::list_sms_sandbox_phone_numbers::ListSMSSandboxPhoneNumbersError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_sms_sandbox_phone_numbers::_list_sms_sandbox_phone_numbers_input::ListSmsSandboxPhoneNumbersInput;

pub use super::operation::list_sms_sandbox_phone_numbers::_list_sms_sandbox_phone_numbers_output::ListSmsSandboxPhoneNumbersOutput;
