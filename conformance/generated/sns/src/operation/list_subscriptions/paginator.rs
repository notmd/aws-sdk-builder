...
pub struct ListSubscriptionsPaginator {
    ...
    builder: super::operation::list_subscriptions::builders::ListSubscriptionsInputBuilder,
...
impl ListSubscriptionsPaginator {
    ...
    pub fn items(self) -> super::operation::list_subscriptions::paginator::ListSubscriptionsPaginatorItems {
        super::operation::list_subscriptions::paginator::ListSubscriptionsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::operation::list_subscriptions::ListSubscriptions::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_list_subscriptions_output_output_next_token(resp);
...
impl ListSubscriptionsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::lens::lens_list_subscriptions_output_output_subscriptions(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
