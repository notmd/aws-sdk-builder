...
pub use super::operation::list_subscriptions::_list_subscriptions_input::ListSubscriptionsInputBuilder;

pub use super::operation::list_subscriptions::_list_subscriptions_output::ListSubscriptionsOutputBuilder;

impl super::operation::list_subscriptions::builders::ListSubscriptionsInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::list_subscriptions::ListSubscriptionsError,
...
pub struct ListSubscriptionsFluentBuilder {
    ...
    inner: super::operation::list_subscriptions::builders::ListSubscriptionsInputBuilder,
...
impl ListSubscriptionsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::list_subscriptions::builders::ListSubscriptionsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::list_subscriptions::ListSubscriptions::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::list_subscriptions::ListSubscriptions::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn into_paginator(self) -> super::operation::list_subscriptions::paginator::ListSubscriptionsPaginator {
        super::operation::list_subscriptions::paginator::ListSubscriptionsPaginator::new(self.handle, self.inner)
    }
