...
pub mod _list_endpoints_by_platform_application_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/list_endpoints_by_platform_application/_list_endpoints_by_platform_application_input.rs"
    ));
}
...
pub mod _list_endpoints_by_platform_application_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/list_endpoints_by_platform_application/_list_endpoints_by_platform_application_output.rs"
    ));
}
