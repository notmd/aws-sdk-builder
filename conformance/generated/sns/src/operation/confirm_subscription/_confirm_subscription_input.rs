...
impl ConfirmSubscriptionInput {
    ...
    pub fn builder() -> super::operation::confirm_subscription::builders::ConfirmSubscriptionInputBuilder {
        super::operation::confirm_subscription::builders::ConfirmSubscriptionInputBuilder::default()
    }
}
...
impl ConfirmSubscriptionInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::confirm_subscription::ConfirmSubscriptionInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::confirm_subscription::ConfirmSubscriptionInput {
