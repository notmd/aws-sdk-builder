...
impl VerifySmsSandboxPhoneNumberInput {
    ...
    pub fn builder() -> super::operation::verify_sms_sandbox_phone_number::builders::VerifySmsSandboxPhoneNumberInputBuilder {
        super::operation::verify_sms_sandbox_phone_number::builders::VerifySmsSandboxPhoneNumberInputBuilder::default()
    }
}
...
impl VerifySmsSandboxPhoneNumberInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::verify_sms_sandbox_phone_number::VerifySmsSandboxPhoneNumberInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::verify_sms_sandbox_phone_number::VerifySmsSandboxPhoneNumberInput {
