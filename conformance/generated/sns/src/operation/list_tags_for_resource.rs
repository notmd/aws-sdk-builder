...
pub mod _list_tags_for_resource_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/list_tags_for_resource/_list_tags_for_resource_input.rs"
    ));
}
...
pub mod _list_tags_for_resource_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/list_tags_for_resource/_list_tags_for_resource_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/list_tags_for_resource/builders.rs"
    ));
}
