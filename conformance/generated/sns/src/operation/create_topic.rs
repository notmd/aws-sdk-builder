...
impl CreateTopic {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::create_topic::CreateTopicInput,
    ) -> ::std::result::Result<
        super::operation::create_topic::CreateTopicOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::create_topic::CreateTopicError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::create_topic::CreateTopicError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::create_topic::CreateTopicOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateTopicResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_create_topic::de_create_topic_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_create_topic::de_create_topic_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateTopicRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::create_topic::CreateTopicInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::create_topic::CreateTopicInput,
...
impl ::aws_types::request_id::RequestId for super::operation::create_topic::CreateTopicError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::create_topic::_create_topic_input::CreateTopicInput;

pub use super::operation::create_topic::_create_topic_output::CreateTopicOutput;
