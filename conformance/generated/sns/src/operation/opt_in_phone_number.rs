...
impl OptInPhoneNumber {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::opt_in_phone_number::OptInPhoneNumberInput,
    ) -> ::std::result::Result<
        super::operation::opt_in_phone_number::OptInPhoneNumberOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::opt_in_phone_number::OptInPhoneNumberError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::opt_in_phone_number::OptInPhoneNumberError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::opt_in_phone_number::OptInPhoneNumberOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for OptInPhoneNumberResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_opt_in_phone_number::de_opt_in_phone_number_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_opt_in_phone_number::de_opt_in_phone_number_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for OptInPhoneNumberRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::opt_in_phone_number::OptInPhoneNumberInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::opt_in_phone_number::OptInPhoneNumberInput,
...
impl ::aws_types::request_id::RequestId for super::operation::opt_in_phone_number::OptInPhoneNumberError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::opt_in_phone_number::_opt_in_phone_number_input::OptInPhoneNumberInput;

pub use super::operation::opt_in_phone_number::_opt_in_phone_number_output::OptInPhoneNumberOutput;
