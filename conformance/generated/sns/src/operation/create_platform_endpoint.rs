...
impl CreatePlatformEndpoint {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::create_platform_endpoint::CreatePlatformEndpointInput,
    ) -> ::std::result::Result<
        super::operation::create_platform_endpoint::CreatePlatformEndpointOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::create_platform_endpoint::CreatePlatformEndpointError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::create_platform_endpoint::CreatePlatformEndpointError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::create_platform_endpoint::CreatePlatformEndpointOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreatePlatformEndpointResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_create_platform_endpoint::de_create_platform_endpoint_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_create_platform_endpoint::de_create_platform_endpoint_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreatePlatformEndpointRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::create_platform_endpoint::CreatePlatformEndpointInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::create_platform_endpoint::CreatePlatformEndpointInput,
...
impl ::aws_types::request_id::RequestId for super::operation::create_platform_endpoint::CreatePlatformEndpointError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::create_platform_endpoint::_create_platform_endpoint_input::CreatePlatformEndpointInput;

pub use super::operation::create_platform_endpoint::_create_platform_endpoint_output::CreatePlatformEndpointOutput;
