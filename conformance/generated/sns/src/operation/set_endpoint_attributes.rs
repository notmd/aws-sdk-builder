...
pub mod _set_endpoint_attributes_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/set_endpoint_attributes/_set_endpoint_attributes_input.rs"
    ));
}
...
pub mod _set_endpoint_attributes_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/set_endpoint_attributes/_set_endpoint_attributes_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/set_endpoint_attributes/builders.rs"
    ));
}
