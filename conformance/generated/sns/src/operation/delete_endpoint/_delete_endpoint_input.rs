...
impl DeleteEndpointInput {
    ...
    pub fn builder() -> super::operation::delete_endpoint::builders::DeleteEndpointInputBuilder {
        super::operation::delete_endpoint::builders::DeleteEndpointInputBuilder::default()
    }
}
...
impl DeleteEndpointInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::delete_endpoint::DeleteEndpointInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::delete_endpoint::DeleteEndpointInput {
