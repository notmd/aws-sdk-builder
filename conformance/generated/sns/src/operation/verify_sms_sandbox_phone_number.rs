// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        pub type VerifySmsSandboxPhoneNumberInput = Input;
        pub type VerifySmsSandboxPhoneNumberOutput = Output;
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::VerifySmsSandboxPhoneNumberOutput, super::VerifySmsSandboxPhoneNumberError> {
                         ...
                         let response = self.client.request(super::super::super::transport::Method::Post, &path, &headers, &body).await.map_err(super::VerifySmsSandboxPhoneNumberError::Unhandled)?;
