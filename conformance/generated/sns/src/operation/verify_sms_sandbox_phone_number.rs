...
impl VerifySmsSandboxPhoneNumber {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::verify_sms_sandbox_phone_number::VerifySmsSandboxPhoneNumberInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::verify_sms_sandbox_phone_number::VerifySMSSandboxPhoneNumberError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::verify_sms_sandbox_phone_number::VerifySmsSandboxPhoneNumberOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for VerifySMSSandboxPhoneNumberResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_verify_sms_sandbox_phone_number::de_verify_sms_sandbox_phone_number_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_verify_sms_sandbox_phone_number::de_verify_sms_sandbox_phone_number_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for VerifySMSSandboxPhoneNumberRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::verify_sms_sandbox_phone_number::VerifySmsSandboxPhoneNumberInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::verify_sms_sandbox_phone_number::VerifySmsSandboxPhoneNumberInput,
...
impl ::aws_types::request_id::RequestId for super::operation::verify_sms_sandbox_phone_number::VerifySMSSandboxPhoneNumberError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::verify_sms_sandbox_phone_number::_verify_sms_sandbox_phone_number_input::VerifySmsSandboxPhoneNumberInput;

pub use super::operation::verify_sms_sandbox_phone_number::_verify_sms_sandbox_phone_number_output::VerifySmsSandboxPhoneNumberOutput;
