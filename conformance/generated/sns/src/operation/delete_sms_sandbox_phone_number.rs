...
impl DeleteSmsSandboxPhoneNumber {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::delete_sms_sandbox_phone_number::DeleteSmsSandboxPhoneNumberInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_sms_sandbox_phone_number::DeleteSMSSandboxPhoneNumberError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_sms_sandbox_phone_number::DeleteSmsSandboxPhoneNumberOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteSMSSandboxPhoneNumberResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_sms_sandbox_phone_number::de_delete_sms_sandbox_phone_number_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_sms_sandbox_phone_number::de_delete_sms_sandbox_phone_number_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteSMSSandboxPhoneNumberRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_sms_sandbox_phone_number::DeleteSmsSandboxPhoneNumberInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_sms_sandbox_phone_number::DeleteSmsSandboxPhoneNumberInput,
...
impl ::aws_types::request_id::RequestId for super::operation::delete_sms_sandbox_phone_number::DeleteSMSSandboxPhoneNumberError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_sms_sandbox_phone_number::_delete_sms_sandbox_phone_number_input::DeleteSmsSandboxPhoneNumberInput;

pub use super::operation::delete_sms_sandbox_phone_number::_delete_sms_sandbox_phone_number_output::DeleteSmsSandboxPhoneNumberOutput;
