...
pub mod _delete_sms_sandbox_phone_number_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/delete_sms_sandbox_phone_number/_delete_sms_sandbox_phone_number_input.rs"
    ));
}
...
pub mod _delete_sms_sandbox_phone_number_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/delete_sms_sandbox_phone_number/_delete_sms_sandbox_phone_number_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/delete_sms_sandbox_phone_number/builders.rs"
    ));
}
