...
impl ListPhoneNumbersOptedOut {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::list_phone_numbers_opted_out::ListPhoneNumbersOptedOutInput,
    ) -> ::std::result::Result<
        super::operation::list_phone_numbers_opted_out::ListPhoneNumbersOptedOutOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::list_phone_numbers_opted_out::ListPhoneNumbersOptedOutError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_phone_numbers_opted_out::ListPhoneNumbersOptedOutError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_phone_numbers_opted_out::ListPhoneNumbersOptedOutOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListPhoneNumbersOptedOutResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_phone_numbers_opted_out::de_list_phone_numbers_opted_out_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_phone_numbers_opted_out::de_list_phone_numbers_opted_out_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListPhoneNumbersOptedOutRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_phone_numbers_opted_out::ListPhoneNumbersOptedOutInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_phone_numbers_opted_out::ListPhoneNumbersOptedOutInput,
...
impl ::aws_types::request_id::RequestId for super::operation::list_phone_numbers_opted_out::ListPhoneNumbersOptedOutError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_phone_numbers_opted_out::_list_phone_numbers_opted_out_input::ListPhoneNumbersOptedOutInput;

pub use super::operation::list_phone_numbers_opted_out::_list_phone_numbers_opted_out_output::ListPhoneNumbersOptedOutOutput;
