...
pub mod _get_subscription_attributes_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/get_subscription_attributes/_get_subscription_attributes_input.rs"
    ));
}
...
pub mod _get_subscription_attributes_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/get_subscription_attributes/_get_subscription_attributes_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/get_subscription_attributes/builders.rs"
    ));
}
