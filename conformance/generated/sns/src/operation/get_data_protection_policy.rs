...
pub mod _get_data_protection_policy_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/get_data_protection_policy/_get_data_protection_policy_input.rs"
    ));
}
...
pub mod _get_data_protection_policy_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/get_data_protection_policy/_get_data_protection_policy_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/get_data_protection_policy/builders.rs"
    ));
}
