...
impl GetSmsSandboxAccountStatusInput {
    ...
    pub fn builder() -> super::operation::get_sms_sandbox_account_status::builders::GetSmsSandboxAccountStatusInputBuilder {
        super::operation::get_sms_sandbox_account_status::builders::GetSmsSandboxAccountStatusInputBuilder::default()
    }
}
...
impl GetSmsSandboxAccountStatusInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::get_sms_sandbox_account_status::GetSmsSandboxAccountStatusInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::get_sms_sandbox_account_status::GetSmsSandboxAccountStatusInput {})
    }
}
