...
pub mod _create_sms_sandbox_phone_number_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/create_sms_sandbox_phone_number/_create_sms_sandbox_phone_number_input.rs"
    ));
}
...
pub mod _create_sms_sandbox_phone_number_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/create_sms_sandbox_phone_number/_create_sms_sandbox_phone_number_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/create_sms_sandbox_phone_number/builders.rs"
    ));
}
