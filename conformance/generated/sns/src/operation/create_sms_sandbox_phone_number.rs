...
impl CreateSmsSandboxPhoneNumber {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::create_sms_sandbox_phone_number::CreateSmsSandboxPhoneNumberInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::create_sms_sandbox_phone_number::CreateSMSSandboxPhoneNumberError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::create_sms_sandbox_phone_number::CreateSmsSandboxPhoneNumberOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateSMSSandboxPhoneNumberResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_create_sms_sandbox_phone_number::de_create_sms_sandbox_phone_number_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_create_sms_sandbox_phone_number::de_create_sms_sandbox_phone_number_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateSMSSandboxPhoneNumberRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::create_sms_sandbox_phone_number::CreateSmsSandboxPhoneNumberInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::create_sms_sandbox_phone_number::CreateSmsSandboxPhoneNumberInput,
...
impl ::aws_types::request_id::RequestId for super::operation::create_sms_sandbox_phone_number::CreateSMSSandboxPhoneNumberError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::create_sms_sandbox_phone_number::_create_sms_sandbox_phone_number_input::CreateSmsSandboxPhoneNumberInput;

pub use super::operation::create_sms_sandbox_phone_number::_create_sms_sandbox_phone_number_output::CreateSmsSandboxPhoneNumberOutput;
