...
impl Unsubscribe {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::unsubscribe::UnsubscribeInput,
    ) -> ::std::result::Result<
        super::operation::unsubscribe::UnsubscribeOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::unsubscribe::UnsubscribeError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::unsubscribe::UnsubscribeError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::unsubscribe::UnsubscribeOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UnsubscribeResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_unsubscribe::de_unsubscribe_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_unsubscribe::de_unsubscribe_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UnsubscribeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::unsubscribe::UnsubscribeInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::unsubscribe::UnsubscribeInput,
...
impl ::aws_types::request_id::RequestId for super::operation::unsubscribe::UnsubscribeError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::unsubscribe::_unsubscribe_input::UnsubscribeInput;

pub use super::operation::unsubscribe::_unsubscribe_output::UnsubscribeOutput;
