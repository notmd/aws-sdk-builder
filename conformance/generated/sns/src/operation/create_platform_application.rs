// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        pub type CreatePlatformApplicationInput = Input;
        pub type CreatePlatformApplicationOutput = Output;
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::CreatePlatformApplicationOutput, super::CreatePlatformApplicationError> {
                         let path = "/";
                         ...
                         Ok(super::CreatePlatformApplicationOutput::default())
                     }
                 }
}
