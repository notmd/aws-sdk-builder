...
/// Paginator for [`ListOriginationNumbers`](crate::operation::list_origination_numbers::ListOriginationNumbers)
pub struct ListOriginationNumbersPaginator {
    handle: std::sync::Arc<super::client::Handle>,
    builder: super::operation::list_origination_numbers::builders::ListOriginationNumbersInputBuilder,
...
impl ListOriginationNumbersPaginator {
    ...
    pub fn items(self) -> super::operation::list_origination_numbers::paginator::ListOriginationNumbersPaginatorItems {
        super::operation::list_origination_numbers::paginator::ListOriginationNumbersPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            super::operation::list_origination_numbers::ListOriginationNumbers::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_list_origination_numbers_output_output_next_token(resp);
...
impl ListOriginationNumbersPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::lens::lens_list_origination_numbers_output_output_phone_numbers(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
