...
impl GetTopicAttributesInput {
    ...
    pub fn builder() -> super::operation::get_topic_attributes::builders::GetTopicAttributesInputBuilder {
        super::operation::get_topic_attributes::builders::GetTopicAttributesInputBuilder::default()
    }
}
...
impl GetTopicAttributesInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_topic_attributes::GetTopicAttributesInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::get_topic_attributes::GetTopicAttributesInput { topic_arn: self.topic_arn })
    }
}
