...
pub use super::operation::list_sms_sandbox_phone_numbers::_list_sms_sandbox_phone_numbers_input::ListSmsSandboxPhoneNumbersInputBuilder;

pub use super::operation::list_sms_sandbox_phone_numbers::_list_sms_sandbox_phone_numbers_output::ListSmsSandboxPhoneNumbersOutputBuilder;

impl super::operation::list_sms_sandbox_phone_numbers::builders::ListSmsSandboxPhoneNumbersInputBuilder {
...
impl ListSmsSandboxPhoneNumbersFluentBuilder {
    ...
    pub fn into_paginator(self) -> super::operation::list_sms_sandbox_phone_numbers::paginator::ListSmsSandboxPhoneNumbersPaginator {
        super::operation::list_sms_sandbox_phone_numbers::paginator::ListSmsSandboxPhoneNumbersPaginator::new(self.handle, self.inner)
    }
