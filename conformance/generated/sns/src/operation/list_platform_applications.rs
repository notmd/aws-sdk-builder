...
pub mod _list_platform_applications_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/list_platform_applications/_list_platform_applications_input.rs"
    ));
}
...
pub mod _list_platform_applications_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/list_platform_applications/_list_platform_applications_output.rs"
    ));
}
