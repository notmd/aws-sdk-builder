...
impl ListTopics {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::list_topics::ListTopicsInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_topics::ListTopicsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_topics::ListTopicsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListTopicsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_topics::de_list_topics_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_topics::de_list_topics_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListTopicsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::list_topics::ListTopicsInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_topics::ListTopicsInput,
...
impl ::aws_types::request_id::RequestId for super::operation::list_topics::ListTopicsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_topics::_list_topics_input::ListTopicsInput;

pub use super::operation::list_topics::_list_topics_output::ListTopicsOutput;
