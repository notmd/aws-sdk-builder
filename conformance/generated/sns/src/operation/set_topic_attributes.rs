...
pub mod _set_topic_attributes_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/set_topic_attributes/_set_topic_attributes_input.rs"
    ));
}
...
pub mod _set_topic_attributes_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/set_topic_attributes/_set_topic_attributes_output.rs"
    ));
}
