...
impl ListOriginationNumbers {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::list_origination_numbers::ListOriginationNumbersInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_origination_numbers::ListOriginationNumbersError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_origination_numbers::ListOriginationNumbersOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListOriginationNumbersResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_origination_numbers::de_list_origination_numbers_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_origination_numbers::de_list_origination_numbers_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListOriginationNumbersRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_origination_numbers::ListOriginationNumbersInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_origination_numbers::ListOriginationNumbersInput,
...
impl ::aws_types::request_id::RequestId for super::operation::list_origination_numbers::ListOriginationNumbersError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_origination_numbers::_list_origination_numbers_input::ListOriginationNumbersInput;

pub use super::operation::list_origination_numbers::_list_origination_numbers_output::ListOriginationNumbersOutput;
