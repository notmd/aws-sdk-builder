    ...
    pub fn build(self) -> super::Input { self.input }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::CreateTopicOutput, super::CreateTopicError> {
                         ...
                         if !status.is_success() {
                             return Err(super::CreateTopicError::unhandled_with_request_ids(format!("CreateTopic returned HTTP {}", status), response.header("x-amzn-requestid").map(str::to_owned), ::std::option::Option::None));
                         }
                         let mut output = super::_create_topic_output::CreateTopicOutputBuilder::default();
