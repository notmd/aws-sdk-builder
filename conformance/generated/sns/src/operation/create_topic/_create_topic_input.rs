...
impl CreateTopicInput {
    ...
    pub fn builder() -> super::operation::create_topic::builders::CreateTopicInputBuilder {
        super::operation::create_topic::builders::CreateTopicInputBuilder::default()
    }
}
...
impl CreateTopicInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::create_topic::CreateTopicInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::create_topic::CreateTopicInput {
            name: self.name,
