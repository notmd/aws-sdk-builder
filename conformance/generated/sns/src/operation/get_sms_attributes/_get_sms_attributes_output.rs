...
impl GetSmsAttributesOutput {
    ...
    pub fn builder() -> super::operation::get_sms_attributes::builders::GetSmsAttributesOutputBuilder {
        super::operation::get_sms_attributes::builders::GetSmsAttributesOutputBuilder::default()
    }
}
...
impl GetSmsAttributesOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_sms_attributes::GetSmsAttributesOutput {
