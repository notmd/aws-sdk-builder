...
impl SetSmsAttributesInputBuilder {
    ...
    pub fn build(self) -> crate::operation::set_sms_attributes::SetSmsAttributesInput {
        crate::operation::set_sms_attributes::SetSmsAttributesInput { attributes: self.attributes }
    }
}
