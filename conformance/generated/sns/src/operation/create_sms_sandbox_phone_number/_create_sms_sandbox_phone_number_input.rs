...
pub struct CreateSmsSandboxPhoneNumberInput {
    ...
    pub language_code: ::std::option::Option<super::types::LanguageCodeString>,
}
impl CreateSmsSandboxPhoneNumberInput {
    ...
    /// <p>The language to use for sending the OTP. The default value is <code>en-US</code>.</p>
    pub fn language_code(&self) -> ::std::option::Option<&super::types::LanguageCodeString> {
...
impl CreateSmsSandboxPhoneNumberInput {
    ...
    pub fn builder() -> super::operation::create_sms_sandbox_phone_number::builders::CreateSmsSandboxPhoneNumberInputBuilder {
        super::operation::create_sms_sandbox_phone_number::builders::CreateSmsSandboxPhoneNumberInputBuilder::default()
    }
}
...
pub struct CreateSmsSandboxPhoneNumberInputBuilder {
    ...
    pub(crate) language_code: ::std::option::Option<super::types::LanguageCodeString>,
}
impl CreateSmsSandboxPhoneNumberInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::create_sms_sandbox_phone_number::CreateSmsSandboxPhoneNumberInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::create_sms_sandbox_phone_number::CreateSmsSandboxPhoneNumberInput {
