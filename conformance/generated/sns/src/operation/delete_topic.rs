...
impl DeleteTopic {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::delete_topic::DeleteTopicInput,
    ) -> ::std::result::Result<
        super::operation::delete_topic::DeleteTopicOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::delete_topic::DeleteTopicError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_topic::DeleteTopicError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_topic::DeleteTopicOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteTopicResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_topic::de_delete_topic_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_topic::de_delete_topic_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteTopicRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_topic::DeleteTopicInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_topic::DeleteTopicInput,
...
impl ::aws_types::request_id::RequestId for super::operation::delete_topic::DeleteTopicError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_topic::_delete_topic_input::DeleteTopicInput;

pub use super::operation::delete_topic::_delete_topic_output::DeleteTopicOutput;
