...
pub mod _set_subscription_attributes_input {
    include!(concat!(env!("OUT_DIR"), "/generated/sns/src/operation/set_subscription_attributes/_set_subscription_attributes_input.rs"));
}
pub use _set_subscription_attributes_input::SetSubscriptionAttributesInput;
pub type Input = SetSubscriptionAttributesInput;
pub mod _set_subscription_attributes_output {
    include!(concat!(env!("OUT_DIR"), "/generated/sns/src/operation/set_subscription_attributes/_set_subscription_attributes_output.rs"));
}
pub use _set_subscription_attributes_output::SetSubscriptionAttributesOutput;
pub type Output = SetSubscriptionAttributesOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/sns/src/operation/set_subscription_attributes/builders.rs"));
}
