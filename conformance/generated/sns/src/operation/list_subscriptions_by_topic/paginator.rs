...
pub struct ListSubscriptionsByTopicPaginator {
    ...
    builder: super::operation::list_subscriptions_by_topic::builders::ListSubscriptionsByTopicInputBuilder,
...
impl ListSubscriptionsByTopicPaginator {
    ...
    pub fn items(self) -> super::operation::list_subscriptions_by_topic::paginator::ListSubscriptionsByTopicPaginatorItems {
        super::operation::list_subscriptions_by_topic::paginator::ListSubscriptionsByTopicPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            super::operation::list_subscriptions_by_topic::ListSubscriptionsByTopic::orchestrate(&runtime_plugins, input.clone())
                                .await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_list_subscriptions_by_topic_output_output_next_token(resp);
...
impl ListSubscriptionsByTopicPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::lens::lens_list_subscriptions_by_topic_output_output_subscriptions(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
