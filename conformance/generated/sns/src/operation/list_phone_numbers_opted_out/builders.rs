...
pub struct Builder {
    input: super::_list_phone_numbers_opted_out_input::ListPhoneNumbersOptedOutInputBuilder,
...
impl Builder {
    ...
    pub async fn send(self) -> ::std::result::Result<super::ListPhoneNumbersOptedOutOutput, super::ListPhoneNumbersOptedOutError> {
        let input = self
            .input
            .build()
            .map_err(|error| super::ListPhoneNumbersOptedOutError::Unhandled(error.to_string()))?;
        let path = "/";
        ...
        let response = self
            ...
            .await
            .map_err(super::ListPhoneNumbersOptedOutError::Unhandled)?;
        let status = response.status();
        if !status.is_success() {
            return Err(super::ListPhoneNumbersOptedOutError::unhandled_with_request_ids(
                format!("ListPhoneNumbersOptedOut returned HTTP {}", status),
