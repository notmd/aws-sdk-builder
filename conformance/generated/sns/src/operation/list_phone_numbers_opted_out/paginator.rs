...
/// Paginator for [`ListPhoneNumbersOptedOut`](crate::operation::list_phone_numbers_opted_out::ListPhoneNumbersOptedOut)
pub struct ListPhoneNumbersOptedOutPaginator {
    handle: std::sync::Arc<super::client::Handle>,
    builder: super::operation::list_phone_numbers_opted_out::builders::ListPhoneNumbersOptedOutInputBuilder,
...
impl ListPhoneNumbersOptedOutPaginator {
    ...
    pub fn items(self) -> super::operation::list_phone_numbers_opted_out::paginator::ListPhoneNumbersOptedOutPaginatorItems {
        super::operation::list_phone_numbers_opted_out::paginator::ListPhoneNumbersOptedOutPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            super::operation::list_phone_numbers_opted_out::ListPhoneNumbersOptedOut::orchestrate(&runtime_plugins, input.clone())
                                .await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::lens::reflens_list_phone_numbers_opted_out_output_output_next_token(resp);
...
impl ListPhoneNumbersOptedOutPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::lens::lens_list_phone_numbers_opted_out_output_output_phone_numbers(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
