...
impl UnsubscribeInput {
    ...
    pub fn builder() -> super::operation::unsubscribe::builders::UnsubscribeInputBuilder {
        super::operation::unsubscribe::builders::UnsubscribeInputBuilder::default()
    }
}
...
impl UnsubscribeInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::unsubscribe::UnsubscribeInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::unsubscribe::UnsubscribeInput {
