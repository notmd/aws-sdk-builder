...
impl ListSubscriptionsByTopic {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::list_subscriptions_by_topic::ListSubscriptionsByTopicInput,
    ) -> ::std::result::Result<
        super::operation::list_subscriptions_by_topic::ListSubscriptionsByTopicOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::list_subscriptions_by_topic::ListSubscriptionsByTopicError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_subscriptions_by_topic::ListSubscriptionsByTopicError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_subscriptions_by_topic::ListSubscriptionsByTopicOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListSubscriptionsByTopicResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_subscriptions_by_topic::de_list_subscriptions_by_topic_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_subscriptions_by_topic::de_list_subscriptions_by_topic_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListSubscriptionsByTopicRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_subscriptions_by_topic::ListSubscriptionsByTopicInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_subscriptions_by_topic::ListSubscriptionsByTopicInput,
...
impl ::aws_types::request_id::RequestId for super::operation::list_subscriptions_by_topic::ListSubscriptionsByTopicError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_subscriptions_by_topic::_list_subscriptions_by_topic_input::ListSubscriptionsByTopicInput;

pub use super::operation::list_subscriptions_by_topic::_list_subscriptions_by_topic_output::ListSubscriptionsByTopicOutput;
