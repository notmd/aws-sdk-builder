// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        impl ListSubscriptionsByTopic { pub fn new() -> Self { Self } }
        #[derive(Clone, Debug, Default)]
        pub struct Input {
        ...
        pub struct Output {
            pub next_token: ::std::option::Option<super::super::types::NextToken>,
            pub subscriptions: ::std::option::Option<super::super::types::SubscriptionsList>,
        }
        impl Output {
            pub fn next_token(&self) -> ::std::option::Option<&str> { self.next_token.as_deref() }
            pub fn subscriptions(&self) -> &[super::super::types::Subscription] { self.subscriptions.as_deref().unwrap_or(&[]) }
        }
        pub type ListSubscriptionsByTopicInput = Input;
        pub type ListSubscriptionsByTopicOutput = Output;
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::ListSubscriptionsByTopicOutput, super::ListSubscriptionsByTopicError> {
                         ...
                         let response = self.client.request(super::super::super::transport::Method::Post, &path, &headers, &body).await.map_err(super::ListSubscriptionsByTopicError::Unhandled)?;
