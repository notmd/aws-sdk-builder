...
pub use super::operation::get_platform_application_attributes::_get_platform_application_attributes_input::GetPlatformApplicationAttributesInputBuilder;

pub use super::operation::get_platform_application_attributes::_get_platform_application_attributes_output::GetPlatformApplicationAttributesOutputBuilder;

impl super::operation::get_platform_application_attributes::builders::GetPlatformApplicationAttributesInputBuilder {
...
pub struct GetPlatformApplicationAttributesFluentBuilder {
    ...
    inner: super::operation::get_platform_application_attributes::builders::GetPlatformApplicationAttributesInputBuilder,
...
impl GetPlatformApplicationAttributesFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::get_platform_application_attributes::builders::GetPlatformApplicationAttributesInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::get_platform_application_attributes::GetPlatformApplicationAttributes::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::get_platform_application_attributes::GetPlatformApplicationAttributes::orchestrate(&runtime_plugins, input).await
    }
