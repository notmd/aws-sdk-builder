...
impl GetSmsAttributes {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::get_sms_attributes::GetSmsAttributesInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_sms_attributes::GetSMSAttributesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_sms_attributes::GetSmsAttributesOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetSMSAttributesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_sms_attributes::de_get_sms_attributes_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_sms_attributes::de_get_sms_attributes_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetSMSAttributesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_sms_attributes::GetSmsAttributesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_sms_attributes::GetSmsAttributesInput,
...
impl ::aws_types::request_id::RequestId for super::operation::get_sms_attributes::GetSMSAttributesError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_sms_attributes::_get_sms_attributes_input::GetSmsAttributesInput;

pub use super::operation::get_sms_attributes::_get_sms_attributes_output::GetSmsAttributesOutput;
