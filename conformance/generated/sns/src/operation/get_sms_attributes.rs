...
pub mod _get_sms_attributes_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/get_sms_attributes/_get_sms_attributes_input.rs"
    ));
}
...
pub mod _get_sms_attributes_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/get_sms_attributes/_get_sms_attributes_output.rs"
    ));
}
