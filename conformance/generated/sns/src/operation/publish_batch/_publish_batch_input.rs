...
pub struct PublishBatchInput {
    ...
    pub publish_batch_request_entries: ::std::option::Option<::std::vec::Vec<super::types::PublishBatchRequestEntry>>,
}
impl PublishBatchInput {
    ...
    pub fn publish_batch_request_entries(&self) -> &[super::types::PublishBatchRequestEntry] {
...
impl PublishBatchInput {
    ...
    pub fn builder() -> super::operation::publish_batch::builders::PublishBatchInputBuilder {
        super::operation::publish_batch::builders::PublishBatchInputBuilder::default()
    }
}
...
pub struct PublishBatchInputBuilder {
    ...
    pub(crate) publish_batch_request_entries: ::std::option::Option<::std::vec::Vec<super::types::PublishBatchRequestEntry>>,
}
impl PublishBatchInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::publish_batch::PublishBatchInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::publish_batch::PublishBatchInput {
