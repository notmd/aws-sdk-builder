...
impl Subscribe {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::subscribe::SubscribeInput,
    ) -> ::std::result::Result<
    ...
    > {
        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<
            ...
            ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
        >| {
            err.map_service_error(|err| err.downcast::<super::operation::subscribe::SubscribeError>().expect("correct error type"))
        };
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::subscribe::SubscribeOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SubscribeResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_subscribe::de_subscribe_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_subscribe::de_subscribe_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SubscribeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::subscribe::SubscribeInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::subscribe::SubscribeInput,
...
impl ::aws_types::request_id::RequestId for super::operation::subscribe::SubscribeError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::subscribe::_subscribe_input::SubscribeInput;

pub use super::operation::subscribe::_subscribe_output::SubscribeOutput;
