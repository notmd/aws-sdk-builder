...
pub mod _check_if_phone_number_is_opted_out_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/check_if_phone_number_is_opted_out/_check_if_phone_number_is_opted_out_input.rs"
    ));
}
...
pub mod _check_if_phone_number_is_opted_out_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/check_if_phone_number_is_opted_out/_check_if_phone_number_is_opted_out_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/check_if_phone_number_is_opted_out/builders.rs"
    ));
}
