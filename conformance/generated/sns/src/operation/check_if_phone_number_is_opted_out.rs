...
pub mod _check_if_phone_number_is_opted_out_input {
    include!(concat!(env!("OUT_DIR"), "/generated/sns/src/operation/check_if_phone_number_is_opted_out/_check_if_phone_number_is_opted_out_input.rs"));
}
pub use _check_if_phone_number_is_opted_out_input::CheckIfPhoneNumberIsOptedOutInput;
pub type Input = CheckIfPhoneNumberIsOptedOutInput;
pub mod _check_if_phone_number_is_opted_out_output {
    include!(concat!(env!("OUT_DIR"), "/generated/sns/src/operation/check_if_phone_number_is_opted_out/_check_if_phone_number_is_opted_out_output.rs"));
}
pub use _check_if_phone_number_is_opted_out_output::CheckIfPhoneNumberIsOptedOutOutput;
pub type Output = CheckIfPhoneNumberIsOptedOutOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/sns/src/operation/check_if_phone_number_is_opted_out/builders.rs"));
}
