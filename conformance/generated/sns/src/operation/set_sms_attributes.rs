...
pub mod _set_sms_attributes_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/set_sms_attributes/_set_sms_attributes_input.rs"
    ));
}
...
pub mod _set_sms_attributes_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/set_sms_attributes/_set_sms_attributes_output.rs"
    ));
}
