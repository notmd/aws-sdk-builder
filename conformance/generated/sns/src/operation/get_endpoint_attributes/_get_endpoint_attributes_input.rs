...
impl GetEndpointAttributesInput {
    ...
    pub fn builder() -> super::operation::get_endpoint_attributes::builders::GetEndpointAttributesInputBuilder {
        super::operation::get_endpoint_attributes::builders::GetEndpointAttributesInputBuilder::default()
    }
}
...
impl GetEndpointAttributesInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_endpoint_attributes::GetEndpointAttributesInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::get_endpoint_attributes::GetEndpointAttributesInput {
