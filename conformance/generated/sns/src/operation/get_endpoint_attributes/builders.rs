...
pub use super::operation::get_endpoint_attributes::_get_endpoint_attributes_input::GetEndpointAttributesInputBuilder;

pub use super::operation::get_endpoint_attributes::_get_endpoint_attributes_output::GetEndpointAttributesOutputBuilder;

impl super::operation::get_endpoint_attributes::builders::GetEndpointAttributesInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::get_endpoint_attributes::GetEndpointAttributesError,
...
pub struct GetEndpointAttributesFluentBuilder {
    ...
    inner: super::operation::get_endpoint_attributes::builders::GetEndpointAttributesInputBuilder,
...
impl GetEndpointAttributesFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::get_endpoint_attributes::builders::GetEndpointAttributesInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::get_endpoint_attributes::GetEndpointAttributes::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::get_endpoint_attributes::GetEndpointAttributes::orchestrate(&runtime_plugins, input).await
    }
