...
impl ListSubscriptions {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::list_subscriptions::ListSubscriptionsInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_subscriptions::ListSubscriptionsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_subscriptions::ListSubscriptionsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListSubscriptionsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_subscriptions::de_list_subscriptions_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_subscriptions::de_list_subscriptions_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListSubscriptionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_subscriptions::ListSubscriptionsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_subscriptions::ListSubscriptionsInput,
...
impl ::aws_types::request_id::RequestId for super::operation::list_subscriptions::ListSubscriptionsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_subscriptions::_list_subscriptions_input::ListSubscriptionsInput;

pub use super::operation::list_subscriptions::_list_subscriptions_output::ListSubscriptionsOutput;
