// Generated by aws-sdk-build aws-sdk-build-rust-native-0.2.0. DO NOT EDIT.
        ...
        impl ListSubscriptions { pub fn new() -> Self { Self } }
        #[derive(Clone, Debug, Default)]
        pub struct Input {
        ...
        pub type ListSubscriptionsInput = Input;
        pub type ListSubscriptionsOutput = Output;
...
Self { input: super::Input::default(), client }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::ListSubscriptionsOutput, super::ListSubscriptionsError> {
                         ...
                         Ok(super::ListSubscriptionsOutput::default())
                     }
                 }
}
