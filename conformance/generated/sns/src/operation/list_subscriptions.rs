...
pub mod _list_subscriptions_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/list_subscriptions/_list_subscriptions_input.rs"
    ));
}
...
pub mod _list_subscriptions_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/list_subscriptions/_list_subscriptions_output.rs"
    ));
}
