...
pub struct ListEndpointsByPlatformApplicationOutput {
    ...
    pub endpoints: ::std::option::Option<::std::vec::Vec<super::types::Endpoint>>,
...
impl ListEndpointsByPlatformApplicationOutput {
    ...
    pub fn endpoints(&self) -> &[super::types::Endpoint] {
...
impl ListEndpointsByPlatformApplicationOutput {
    ...
    pub fn builder() -> super::operation::list_endpoints_by_platform_application::builders::ListEndpointsByPlatformApplicationOutputBuilder {
        super::operation::list_endpoints_by_platform_application::builders::ListEndpointsByPlatformApplicationOutputBuilder::default()
    }
}
...
pub struct ListEndpointsByPlatformApplicationOutputBuilder {
    pub(crate) endpoints: ::std::option::Option<::std::vec::Vec<super::types::Endpoint>>,
...
impl ListEndpointsByPlatformApplicationOutputBuilder {
    ...
    ///
    /// <p>Endpoints returned for <code>ListEndpointsByPlatformApplication</code> action.</p>
    pub fn endpoints(mut self, input: super::types::Endpoint) -> Self {
    ...
    /// <p>Endpoints returned for <code>ListEndpointsByPlatformApplication</code> action.</p>
    pub fn set_endpoints(mut self, input: ::std::option::Option<::std::vec::Vec<super::types::Endpoint>>) -> Self {
        self.endpoints = input;
        self
    }
    /// <p>Endpoints returned for <code>ListEndpointsByPlatformApplication</code> action.</p>
    pub fn get_endpoints(&self) -> &::std::option::Option<::std::vec::Vec<super::types::Endpoint>> {
        &self.endpoints
    }
    /// <p><code>NextToken</code> string is returned when calling <code>ListEndpointsByPlatformApplication</code> action if additional records are available after the first page results.</p>
    ...
    pub fn build(self) -> super::operation::list_endpoints_by_platform_application::ListEndpointsByPlatformApplicationOutput {
