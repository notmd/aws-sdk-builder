...
pub mod _put_data_protection_policy_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/put_data_protection_policy/_put_data_protection_policy_input.rs"
    ));
}
...
pub mod _put_data_protection_policy_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/put_data_protection_policy/_put_data_protection_policy_output.rs"
    ));
}
...
pub mod builders {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/put_data_protection_policy/builders.rs"
    ));
}
