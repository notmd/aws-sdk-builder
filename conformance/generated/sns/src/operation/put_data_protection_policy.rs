...
pub mod _put_data_protection_policy_input {
    include!(concat!(env!("OUT_DIR"), "/generated/sns/src/operation/put_data_protection_policy/_put_data_protection_policy_input.rs"));
}
pub use _put_data_protection_policy_input::PutDataProtectionPolicyInput;
pub type Input = PutDataProtectionPolicyInput;
pub mod _put_data_protection_policy_output {
    include!(concat!(env!("OUT_DIR"), "/generated/sns/src/operation/put_data_protection_policy/_put_data_protection_policy_output.rs"));
}
pub use _put_data_protection_policy_output::PutDataProtectionPolicyOutput;
pub type Output = PutDataProtectionPolicyOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/sns/src/operation/put_data_protection_policy/builders.rs"));
}
