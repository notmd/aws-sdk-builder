...
impl GetEndpointAttributes {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::get_endpoint_attributes::GetEndpointAttributesInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_endpoint_attributes::GetEndpointAttributesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_endpoint_attributes::GetEndpointAttributesOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetEndpointAttributesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_endpoint_attributes::de_get_endpoint_attributes_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_endpoint_attributes::de_get_endpoint_attributes_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetEndpointAttributesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_endpoint_attributes::GetEndpointAttributesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_endpoint_attributes::GetEndpointAttributesInput,
...
impl ::aws_types::request_id::RequestId for super::operation::get_endpoint_attributes::GetEndpointAttributesError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_endpoint_attributes::_get_endpoint_attributes_input::GetEndpointAttributesInput;

pub use super::operation::get_endpoint_attributes::_get_endpoint_attributes_output::GetEndpointAttributesOutput;
