...
impl GetTopicAttributes {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::get_topic_attributes::GetTopicAttributesInput,
    ) -> ::std::result::Result<
        super::operation::get_topic_attributes::GetTopicAttributesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::get_topic_attributes::GetTopicAttributesError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::get_topic_attributes::GetTopicAttributesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::get_topic_attributes::GetTopicAttributesOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetTopicAttributesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_get_topic_attributes::de_get_topic_attributes_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_get_topic_attributes::de_get_topic_attributes_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetTopicAttributesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::get_topic_attributes::GetTopicAttributesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::get_topic_attributes::GetTopicAttributesInput,
...
impl ::aws_types::request_id::RequestId for super::operation::get_topic_attributes::GetTopicAttributesError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::get_topic_attributes::_get_topic_attributes_input::GetTopicAttributesInput;

pub use super::operation::get_topic_attributes::_get_topic_attributes_output::GetTopicAttributesOutput;
