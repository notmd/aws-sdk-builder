...
pub mod _get_topic_attributes_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/get_topic_attributes/_get_topic_attributes_input.rs"
    ));
}
...
pub mod _get_topic_attributes_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sns/src/operation/get_topic_attributes/_get_topic_attributes_output.rs"
    ));
}
