...
impl ListTopicsOutputBuilder {
    ...
    pub fn set_topics(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::Topic>>) -> Self { self.topics = input; self }
    /// <p>A list of topic ARNs.</p>
    pub fn get_topics(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::Topic>> { &self.topics }
    /// <p>Token to pass along to the next <code>ListTopics</code> request. This element is returned if there are additional topics to retrieve.</p>
