...
impl ListTopicsInput {
    ...
    pub fn builder() -> super::operation::list_topics::builders::ListTopicsInputBuilder {
        super::operation::list_topics::builders::ListTopicsInputBuilder::default()
    }
}
...
impl ListTopicsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::list_topics::ListTopicsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::list_topics::ListTopicsInput { next_token: self.next_token })
    }
}
