...
impl CheckIfPhoneNumberIsOptedOutInput {
    ...
    pub fn builder() -> super::operation::check_if_phone_number_is_opted_out::builders::CheckIfPhoneNumberIsOptedOutInputBuilder {
        super::operation::check_if_phone_number_is_opted_out::builders::CheckIfPhoneNumberIsOptedOutInputBuilder::default()
    }
}
...
impl CheckIfPhoneNumberIsOptedOutInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::check_if_phone_number_is_opted_out::CheckIfPhoneNumberIsOptedOutInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::check_if_phone_number_is_opted_out::CheckIfPhoneNumberIsOptedOutInput {
