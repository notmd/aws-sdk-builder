...
impl PublishBatch {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::publish_batch::PublishBatchInput,
    ) -> ::std::result::Result<
        super::operation::publish_batch::PublishBatchOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::publish_batch::PublishBatchError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::publish_batch::PublishBatchError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::publish_batch::PublishBatchOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PublishBatchResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_publish_batch::de_publish_batch_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_publish_batch::de_publish_batch_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PublishBatchRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::publish_batch::PublishBatchInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::publish_batch::PublishBatchInput,
...
impl ::aws_types::request_id::RequestId for super::operation::publish_batch::PublishBatchError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::publish_batch::_publish_batch_input::PublishBatchInput;

pub use super::operation::publish_batch::_publish_batch_output::PublishBatchOutput;
