...
impl super::Client {
    ...
    pub fn list_platform_applications(&self) -> super::operation::list_platform_applications::builders::ListPlatformApplicationsFluentBuilder {
        super::operation::list_platform_applications::builders::ListPlatformApplicationsFluentBuilder::new(self.handle.clone())
    }
}
