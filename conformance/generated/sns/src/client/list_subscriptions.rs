...
impl super::Client {
    ...
    pub fn list_subscriptions(&self) -> super::operation::list_subscriptions::builders::ListSubscriptionsFluentBuilder {
        super::operation::list_subscriptions::builders::ListSubscriptionsFluentBuilder::new(self.handle.clone())
    }
}
