...
impl super::Client {
    ...
    pub fn list_origination_numbers(&self) -> super::operation::list_origination_numbers::builders::ListOriginationNumbersFluentBuilder {
        super::operation::list_origination_numbers::builders::ListOriginationNumbersFluentBuilder::new(self.handle.clone())
    }
}
