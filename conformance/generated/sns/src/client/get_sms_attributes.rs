...
impl super::Client {
    ...
    pub fn get_sms_attributes(&self) -> super::operation::get_sms_attributes::builders::GetSMSAttributesFluentBuilder {
        super::operation::get_sms_attributes::builders::GetSMSAttributesFluentBuilder::new(self.handle.clone())
    }
}
