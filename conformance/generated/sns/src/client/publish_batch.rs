...
impl super::Client {
    ...
    pub fn publish_batch(&self) -> super::operation::publish_batch::builders::PublishBatchFluentBuilder {
        super::operation::publish_batch::builders::PublishBatchFluentBuilder::new(self.handle.clone())
    }
}
