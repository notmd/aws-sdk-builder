...
impl super::Client {
    ...
    pub fn verify_sms_sandbox_phone_number(
        &self,
    ) -> super::operation::verify_sms_sandbox_phone_number::builders::VerifySMSSandboxPhoneNumberFluentBuilder {
        super::operation::verify_sms_sandbox_phone_number::builders::VerifySMSSandboxPhoneNumberFluentBuilder::new(self.handle.clone())
    }
}
