...
impl super::Client {
    ...
    pub fn list_subscriptions_by_topic(&self) -> super::operation::list_subscriptions_by_topic::builders::ListSubscriptionsByTopicFluentBuilder {
        super::operation::list_subscriptions_by_topic::builders::ListSubscriptionsByTopicFluentBuilder::new(self.handle.clone())
    }
}
