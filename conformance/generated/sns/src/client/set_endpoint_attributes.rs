...
impl super::Client {
    ...
    pub fn set_endpoint_attributes(&self) -> super::operation::set_endpoint_attributes::builders::SetEndpointAttributesFluentBuilder {
        super::operation::set_endpoint_attributes::builders::SetEndpointAttributesFluentBuilder::new(self.handle.clone())
    }
}
