...
impl super::Client {
    ...
    pub fn list_endpoints_by_platform_application(
        &self,
    ) -> super::operation::list_endpoints_by_platform_application::builders::ListEndpointsByPlatformApplicationFluentBuilder {
        super::operation::list_endpoints_by_platform_application::builders::ListEndpointsByPlatformApplicationFluentBuilder::new(self.handle.clone())
    }
}
