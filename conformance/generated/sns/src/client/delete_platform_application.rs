...
impl super::Client {
    ...
    pub fn delete_platform_application(&self) -> super::operation::delete_platform_application::builders::DeletePlatformApplicationFluentBuilder {
        super::operation::delete_platform_application::builders::DeletePlatformApplicationFluentBuilder::new(self.handle.clone())
    }
}
