...
impl super::Client {
    ...
    pub fn create_platform_application(&self) -> super::operation::create_platform_application::builders::CreatePlatformApplicationFluentBuilder {
        super::operation::create_platform_application::builders::CreatePlatformApplicationFluentBuilder::new(self.handle.clone())
    }
}
