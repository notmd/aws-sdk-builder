...
impl super::Client {
    ...
    pub fn list_sms_sandbox_phone_numbers(
        &self,
    ) -> super::operation::list_sms_sandbox_phone_numbers::builders::ListSMSSandboxPhoneNumbersFluentBuilder {
        super::operation::list_sms_sandbox_phone_numbers::builders::ListSMSSandboxPhoneNumbersFluentBuilder::new(self.handle.clone())
    }
}
