...
impl super::Client {
    ...
    pub fn get_endpoint_attributes(&self) -> super::operation::get_endpoint_attributes::builders::GetEndpointAttributesFluentBuilder {
        super::operation::get_endpoint_attributes::builders::GetEndpointAttributesFluentBuilder::new(self.handle.clone())
    }
}
