...
impl super::Client {
    ...
    pub fn list_topics(&self) -> super::operation::list_topics::builders::ListTopicsFluentBuilder {
        super::operation::list_topics::builders::ListTopicsFluentBuilder::new(self.handle.clone())
    }
}
