...
impl super::Client {
    ...
    pub fn list_phone_numbers_opted_out(&self) -> super::operation::list_phone_numbers_opted_out::builders::ListPhoneNumbersOptedOutFluentBuilder {
        super::operation::list_phone_numbers_opted_out::builders::ListPhoneNumbersOptedOutFluentBuilder::new(self.handle.clone())
    }
}
