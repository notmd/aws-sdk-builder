...
impl super::Client {
    ...
    pub fn check_if_phone_number_is_opted_out(
        &self,
    ) -> super::operation::check_if_phone_number_is_opted_out::builders::CheckIfPhoneNumberIsOptedOutFluentBuilder {
        super::operation::check_if_phone_number_is_opted_out::builders::CheckIfPhoneNumberIsOptedOutFluentBuilder::new(self.handle.clone())
    }
}
