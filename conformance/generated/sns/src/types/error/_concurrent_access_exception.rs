...
impl ::aws_types::request_id::RequestId for super::types::error::ConcurrentAccessException {
...
impl ConcurrentAccessException {
    ...
    pub fn builder() -> super::types::error::builders::ConcurrentAccessExceptionBuilder {
        super::types::error::builders::ConcurrentAccessExceptionBuilder::default()
    }
}
...
impl ConcurrentAccessExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::ConcurrentAccessException {
        super::types::error::ConcurrentAccessException {
