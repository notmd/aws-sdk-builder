...
impl ::aws_types::request_id::RequestId for super::types::error::TopicLimitExceededException {
...
impl TopicLimitExceededException {
    ...
    pub fn builder() -> super::types::error::builders::TopicLimitExceededExceptionBuilder {
        super::types::error::builders::TopicLimitExceededExceptionBuilder::default()
    }
}
...
impl TopicLimitExceededExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::TopicLimitExceededException {
        super::types::error::TopicLimitExceededException {
