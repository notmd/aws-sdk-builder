...
impl ::aws_types::request_id::RequestId for super::types::error::BatchRequestTooLongException {
...
impl BatchRequestTooLongException {
    ...
    pub fn builder() -> super::types::error::builders::BatchRequestTooLongExceptionBuilder {
        super::types::error::builders::BatchRequestTooLongExceptionBuilder::default()
    }
}
...
impl BatchRequestTooLongExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::BatchRequestTooLongException {
        super::types::error::BatchRequestTooLongException {
