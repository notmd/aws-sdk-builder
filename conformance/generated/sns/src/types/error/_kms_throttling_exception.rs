...
impl ::aws_types::request_id::RequestId for super::types::error::KmsThrottlingException {
...
impl KmsThrottlingException {
    ...
    pub fn builder() -> super::types::error::builders::KmsThrottlingExceptionBuilder {
        super::types::error::builders::KmsThrottlingExceptionBuilder::default()
    }
}
...
impl KmsThrottlingExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::KmsThrottlingException {
        super::types::error::KmsThrottlingException {
