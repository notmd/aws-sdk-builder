...
impl ::aws_types::request_id::RequestId for super::types::error::AuthorizationErrorException {
...
impl AuthorizationErrorException {
    ...
    pub fn builder() -> super::types::error::builders::AuthorizationErrorExceptionBuilder {
        super::types::error::builders::AuthorizationErrorExceptionBuilder::default()
    }
}
...
impl AuthorizationErrorExceptionBuilder {
    ...
    pub fn build(self) -> super::types::error::AuthorizationErrorException {
        super::types::error::AuthorizationErrorException {
