...
impl PlatformApplication {
    ...
    pub fn builder() -> super::types::builders::PlatformApplicationBuilder {
        super::types::builders::PlatformApplicationBuilder::default()
    }
}
...
impl PlatformApplicationBuilder {
    ...
    pub fn build(self) -> super::types::PlatformApplication {
