...
impl Tag {
    ...
    pub fn builder() -> super::types::builders::TagBuilder {
        super::types::builders::TagBuilder::default()
    }
}
...
impl TagBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::Tag, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::Tag {
