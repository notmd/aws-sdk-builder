...
pub struct SmsSandboxPhoneNumber {
    ...
    pub status: ::std::option::Option<super::types::SmsSandboxPhoneNumberVerificationStatus>,
}
impl SmsSandboxPhoneNumber {
    ...
    /// <p>The destination phone number's verification status.</p>
    pub fn status(&self) -> ::std::option::Option<&super::types::SmsSandboxPhoneNumberVerificationStatus> {
        self.status.as_ref()
    }
}
...
impl SmsSandboxPhoneNumber {
    ...
    pub fn builder() -> super::types::builders::SmsSandboxPhoneNumberBuilder {
        super::types::builders::SmsSandboxPhoneNumberBuilder::default()
    }
}
...
pub struct SmsSandboxPhoneNumberBuilder {
    ...
    pub(crate) status: ::std::option::Option<super::types::SmsSandboxPhoneNumberVerificationStatus>,
}
impl SmsSandboxPhoneNumberBuilder {
    ...
    /// <p>The destination phone number's verification status.</p>
    pub fn status(mut self, input: super::types::SmsSandboxPhoneNumberVerificationStatus) -> Self {
        self.status = ::std::option::Option::Some(input);
        self
    }
    /// <p>The destination phone number's verification status.</p>
    pub fn set_status(mut self, input: ::std::option::Option<super::types::SmsSandboxPhoneNumberVerificationStatus>) -> Self {
        self.status = input;
        self
    }
    /// <p>The destination phone number's verification status.</p>
    pub fn get_status(&self) -> &::std::option::Option<super::types::SmsSandboxPhoneNumberVerificationStatus> {
        &self.status
    }
    /// Consumes the builder and constructs a [`SmsSandboxPhoneNumber`](crate::types::SmsSandboxPhoneNumber).
    pub fn build(self) -> super::types::SmsSandboxPhoneNumber {
        super::types::SmsSandboxPhoneNumber {
