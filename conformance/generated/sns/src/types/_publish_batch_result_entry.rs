...
impl PublishBatchResultEntry {
    ...
    pub fn builder() -> super::types::builders::PublishBatchResultEntryBuilder {
        super::types::builders::PublishBatchResultEntryBuilder::default()
    }
}
...
impl PublishBatchResultEntryBuilder {
    ...
    pub fn build(self) -> super::types::PublishBatchResultEntry {
        super::types::PublishBatchResultEntry {
            id: self.id,
