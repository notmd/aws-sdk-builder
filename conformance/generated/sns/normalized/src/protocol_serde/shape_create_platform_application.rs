...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(super::super::operation::create_platform_application::CreatePlatformApplicationError::unhandled(
                generic,
            ))
        }
    };
...
pub fn de_create_platform_application(
    ...
    super::super::operation::create_platform_application::builders::CreatePlatformApplicationOutputBuilder,
