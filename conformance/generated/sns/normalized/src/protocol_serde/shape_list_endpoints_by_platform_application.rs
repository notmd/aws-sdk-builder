...
> {
    ...
    Err(match error_code {
        "AuthorizationError" => {
            super::super::operation::list_endpoints_by_platform_application::ListEndpointsByPlatformApplicationError::AuthorizationErrorException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = super::super::types::error::builders::AuthorizationErrorExceptionBuilder::default();
                    output =
                        super::super::protocol_serde::shape_authorization_error_exception::de_authorization_error_exception_xml_err(_response_body, output)
                            .map_err(super::super::operation::list_endpoints_by_platform_application::ListEndpointsByPlatformApplicationError::unhandled)?;
        ...
        "InternalError" => {
            super::super::operation::list_endpoints_by_platform_application::ListEndpointsByPlatformApplicationError::InternalErrorException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidParameter" => {
            super::super::operation::list_endpoints_by_platform_application::ListEndpointsByPlatformApplicationError::InvalidParameterException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output =
            super::super::operation::list_endpoints_by_platform_application::builders::ListEndpointsByPlatformApplicationOutputBuilder::default();
        output =
            super::super::protocol_serde::shape_list_endpoints_by_platform_application::de_list_endpoints_by_platform_application(_response_body, output)
                .map_err(super::super::operation::list_endpoints_by_platform_application::ListEndpointsByPlatformApplicationError::unhandled)?;
...
pub fn de_list_endpoints_by_platform_application(
    ...
    super::super::operation::list_endpoints_by_platform_application::builders::ListEndpointsByPlatformApplicationOutputBuilder,
