...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(super::super::operation::create_platform_endpoint::CreatePlatformEndpointError::unhandled(
                generic,
            ))
        }
    };
...
pub fn de_create_platform_endpoint(
    ...
    super::super::operation::create_platform_endpoint::builders::CreatePlatformEndpointOutputBuilder,
