...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(super::super::operation::list_origination_numbers::ListOriginationNumbersError::unhandled(
                generic,
            ))
        }
    };
...
pub fn de_list_origination_numbers(
    ...
    super::super::operation::list_origination_numbers::builders::ListOriginationNumbersOutputBuilder,
