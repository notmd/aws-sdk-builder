...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(super::super::operation::get_subscription_attributes::GetSubscriptionAttributesError::unhandled(
                generic,
            ))
        }
    };
...
pub fn de_get_subscription_attributes(
    ...
    super::super::operation::get_subscription_attributes::builders::GetSubscriptionAttributesOutputBuilder,
