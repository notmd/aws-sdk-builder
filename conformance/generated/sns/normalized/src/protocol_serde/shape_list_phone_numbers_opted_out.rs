...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(super::super::operation::list_phone_numbers_opted_out::ListPhoneNumbersOptedOutError::unhandled(
                generic,
            ))
        }
    };
...
pub fn de_list_phone_numbers_opted_out(
    ...
    super::super::operation::list_phone_numbers_opted_out::builders::ListPhoneNumbersOptedOutOutputBuilder,
