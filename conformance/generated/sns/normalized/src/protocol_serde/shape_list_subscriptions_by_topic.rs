...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(super::super::operation::list_subscriptions_by_topic::ListSubscriptionsByTopicError::unhandled(
                generic,
            ))
        }
    };
...
pub fn de_list_subscriptions_by_topic(
    ...
    super::super::operation::list_subscriptions_by_topic::builders::ListSubscriptionsByTopicOutputBuilder,
