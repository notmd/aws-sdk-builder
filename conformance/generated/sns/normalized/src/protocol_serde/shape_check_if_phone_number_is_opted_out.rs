...
> {
    ...
    Err(match error_code {
        "AuthorizationError" => {
            super::super::operation::check_if_phone_number_is_opted_out::CheckIfPhoneNumberIsOptedOutError::AuthorizationErrorException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
pub fn de_check_if_phone_number_is_opted_out(
    ...
    super::super::operation::check_if_phone_number_is_opted_out::builders::CheckIfPhoneNumberIsOptedOutOutputBuilder,
