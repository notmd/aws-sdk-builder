...
> {
    ...
    Err(match error_code {
        "AuthorizationError" => {
            super::super::operation::set_platform_application_attributes::SetPlatformApplicationAttributesError::AuthorizationErrorException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidParameter" => {
            super::super::operation::set_platform_application_attributes::SetPlatformApplicationAttributesError::InvalidParameterException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
