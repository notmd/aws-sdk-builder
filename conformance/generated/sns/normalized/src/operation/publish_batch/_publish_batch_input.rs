...
impl PublishBatchInput {
    ...
    pub fn publish_batch_request_entries(&self) -> &[super::super::super::types::PublishBatchRequestEntry] {
...
impl PublishBatchInput {
    ...
    pub fn builder() -> super::super::super::operation::publish_batch::builders::PublishBatchInputBuilder {
        super::super::super::operation::publish_batch::builders::PublishBatchInputBuilder::default()
    }
}
...
pub struct PublishBatchInputBuilder {
    ...
    pub(crate) publish_batch_request_entries: ::std::option::Option<::std::vec::Vec<super::super::super::types::PublishBatchRequestEntry>>,
}
impl PublishBatchInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::publish_batch::PublishBatchInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::super::operation::publish_batch::PublishBatchInput {
