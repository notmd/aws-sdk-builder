...
pub struct ListPhoneNumbersOptedOutPaginator {
    ...
    builder: super::super::super::operation::list_phone_numbers_opted_out::builders::ListPhoneNumbersOptedOutInputBuilder,
...
impl ListPhoneNumbersOptedOutPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::list_phone_numbers_opted_out::paginator::ListPhoneNumbersOptedOutPaginatorItems {
        super::super::super::operation::list_phone_numbers_opted_out::paginator::ListPhoneNumbersOptedOutPaginatorItems(self)
    }
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_phone_numbers_opted_out_output_output_next_token(resp);
...
impl ListPhoneNumbersOptedOutPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_list_phone_numbers_opted_out_output_output_phone_numbers(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
