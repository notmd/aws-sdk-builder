...
impl ListPhoneNumbersOptedOutOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_phone_numbers_opted_out::builders::ListPhoneNumbersOptedOutOutputBuilder {
        super::super::super::operation::list_phone_numbers_opted_out::builders::ListPhoneNumbersOptedOutOutputBuilder::default()
    }
}
...
impl ListPhoneNumbersOptedOutOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::list_phone_numbers_opted_out::ListPhoneNumbersOptedOutOutput {
