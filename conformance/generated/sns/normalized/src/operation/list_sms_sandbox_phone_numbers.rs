...
impl ListSmsSandboxPhoneNumbers {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::list_sms_sandbox_phone_numbers::ListSMSSandboxPhoneNumbersError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::list_sms_sandbox_phone_numbers::ListSmsSandboxPhoneNumbersOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SNS", "ListSMSSandboxPhoneNumbers", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListSmsSandboxPhoneNumbersTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListSmsSandboxPhoneNumbersInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListSMSSandboxPhoneNumbersResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_list_sms_sandbox_phone_numbers::de_list_sms_sandbox_phone_numbers_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_list_sms_sandbox_phone_numbers::de_list_sms_sandbox_phone_numbers_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListSMSSandboxPhoneNumbersRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::list_sms_sandbox_phone_numbers::ListSmsSandboxPhoneNumbersInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::list_sms_sandbox_phone_numbers::ListSmsSandboxPhoneNumbersInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::list_sms_sandbox_phone_numbers::ListSMSSandboxPhoneNumbersError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::list_sms_sandbox_phone_numbers::_list_sms_sandbox_phone_numbers_input::ListSmsSandboxPhoneNumbersInput;

pub use super::super::operation::list_sms_sandbox_phone_numbers::_list_sms_sandbox_phone_numbers_output::ListSmsSandboxPhoneNumbersOutput;
