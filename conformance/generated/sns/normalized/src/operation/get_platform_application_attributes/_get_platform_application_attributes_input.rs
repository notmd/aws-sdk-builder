...
impl GetPlatformApplicationAttributesInput {
    ...
    pub fn builder() -> super::super::super::operation::get_platform_application_attributes::builders::GetPlatformApplicationAttributesInputBuilder {
        super::super::super::operation::get_platform_application_attributes::builders::GetPlatformApplicationAttributesInputBuilder::default()
    }
}
...
impl GetPlatformApplicationAttributesInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::get_platform_application_attributes::GetPlatformApplicationAttributesInput,
