...
pub use super::super::super::operation::get_platform_application_attributes::_get_platform_application_attributes_input::GetPlatformApplicationAttributesInputBuilder;

pub use super::super::super::operation::get_platform_application_attributes::_get_platform_application_attributes_output::GetPlatformApplicationAttributesOutputBuilder;

impl super::super::super::operation::get_platform_application_attributes::builders::GetPlatformApplicationAttributesInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::get_platform_application_attributes::GetPlatformApplicationAttributesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::get_platform_application_attributes::GetPlatformApplicationAttributesError,
...
pub struct GetPlatformApplicationAttributesFluentBuilder {
    ...
    inner: super::super::super::operation::get_platform_application_attributes::builders::GetPlatformApplicationAttributesInputBuilder,
