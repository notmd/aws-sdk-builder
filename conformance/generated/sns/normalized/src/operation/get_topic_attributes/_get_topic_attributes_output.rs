...
impl GetTopicAttributesOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_topic_attributes::builders::GetTopicAttributesOutputBuilder {
        super::super::super::operation::get_topic_attributes::builders::GetTopicAttributesOutputBuilder::default()
    }
}
...
impl GetTopicAttributesOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::get_topic_attributes::GetTopicAttributesOutput {
