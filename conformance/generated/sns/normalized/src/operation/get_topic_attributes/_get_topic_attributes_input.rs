...
impl GetTopicAttributesInput {
    ...
    pub fn builder() -> super::super::super::operation::get_topic_attributes::builders::GetTopicAttributesInputBuilder {
        super::super::super::operation::get_topic_attributes::builders::GetTopicAttributesInputBuilder::default()
    }
}
