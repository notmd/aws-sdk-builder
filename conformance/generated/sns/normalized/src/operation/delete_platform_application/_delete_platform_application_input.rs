...
impl DeletePlatformApplicationInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_platform_application::builders::DeletePlatformApplicationInputBuilder {
        super::super::super::operation::delete_platform_application::builders::DeletePlatformApplicationInputBuilder::default()
    }
}
