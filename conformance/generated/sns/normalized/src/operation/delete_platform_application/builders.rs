...
pub use super::super::super::operation::delete_platform_application::_delete_platform_application_input::DeletePlatformApplicationInputBuilder;

pub use super::super::super::operation::delete_platform_application::_delete_platform_application_output::DeletePlatformApplicationOutputBuilder;

impl super::super::super::operation::delete_platform_application::builders::DeletePlatformApplicationInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_platform_application::DeletePlatformApplicationOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_platform_application::DeletePlatformApplicationError,
...
pub struct DeletePlatformApplicationFluentBuilder {
    ...
    inner: super::super::super::operation::delete_platform_application::builders::DeletePlatformApplicationInputBuilder,
...
impl DeletePlatformApplicationFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_platform_application::builders::DeletePlatformApplicationInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_platform_application::DeletePlatformApplication::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_platform_application::DeletePlatformApplication::orchestrate(&runtime_plugins, input).await
    }
