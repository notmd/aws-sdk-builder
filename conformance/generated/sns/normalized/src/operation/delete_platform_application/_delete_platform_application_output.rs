...
impl DeletePlatformApplicationOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_platform_application::builders::DeletePlatformApplicationOutputBuilder {
        super::super::super::operation::delete_platform_application::builders::DeletePlatformApplicationOutputBuilder::default()
    }
}
...
impl DeletePlatformApplicationOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_platform_application::DeletePlatformApplicationOutput {
