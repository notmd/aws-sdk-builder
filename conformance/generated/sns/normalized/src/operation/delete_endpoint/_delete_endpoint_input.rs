...
impl DeleteEndpointInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_endpoint::builders::DeleteEndpointInputBuilder {
        super::super::super::operation::delete_endpoint::builders::DeleteEndpointInputBuilder::default()
    }
}
...
impl DeleteEndpointInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::delete_endpoint::DeleteEndpointInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::delete_endpoint::DeleteEndpointInput {
