...
pub use super::super::super::operation::delete_endpoint::_delete_endpoint_input::DeleteEndpointInputBuilder;

pub use super::super::super::operation::delete_endpoint::_delete_endpoint_output::DeleteEndpointOutputBuilder;

impl super::super::super::operation::delete_endpoint::builders::DeleteEndpointInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_endpoint::DeleteEndpointOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_endpoint::DeleteEndpointError,
...
pub struct DeleteEndpointFluentBuilder {
    ...
    inner: super::super::super::operation::delete_endpoint::builders::DeleteEndpointInputBuilder,
...
impl DeleteEndpointFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_endpoint::builders::DeleteEndpointInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_endpoint::DeleteEndpoint::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_endpoint::DeleteEndpoint::orchestrate(&runtime_plugins, input).await
    }
