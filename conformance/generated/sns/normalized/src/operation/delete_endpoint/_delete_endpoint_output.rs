...
impl DeleteEndpointOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_endpoint::builders::DeleteEndpointOutputBuilder {
        super::super::super::operation::delete_endpoint::builders::DeleteEndpointOutputBuilder::default()
    }
}
...
impl DeleteEndpointOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_endpoint::DeleteEndpointOutput {
