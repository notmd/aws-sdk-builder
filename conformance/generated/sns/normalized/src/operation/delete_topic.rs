...
impl DeleteTopic {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::super::operation::delete_topic::DeleteTopicOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::delete_topic::DeleteTopicError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::delete_topic::DeleteTopicError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::delete_topic::DeleteTopicOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SNS", "DeleteTopic", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteTopic {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DeleteTopicResponseDeserializer,
        ));
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteTopic")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteTopicResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_delete_topic::de_delete_topic_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_delete_topic::de_delete_topic_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteTopicRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::delete_topic::DeleteTopicInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::delete_topic::DeleteTopicInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::delete_topic::DeleteTopicError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::delete_topic::_delete_topic_input::DeleteTopicInput;

pub use super::super::operation::delete_topic::_delete_topic_output::DeleteTopicOutput;
