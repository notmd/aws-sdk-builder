        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::super::super::operation::list_sms_sandbox_phone_numbers::ListSMSSandboxPhoneNumbers::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_sms_sandbox_phone_numbers_output_output_next_token(resp);
...
impl ListSMSSandboxPhoneNumbersPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::SmsSandboxPhoneNumber,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::list_sms_sandbox_phone_numbers::ListSMSSandboxPhoneNumbersError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_list_sms_sandbox_phone_numbers_output_output_phone_numbers(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
