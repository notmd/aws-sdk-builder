...
impl ListSmsSandboxPhoneNumbersInput {
    ...
    pub fn builder() -> super::super::super::operation::list_sms_sandbox_phone_numbers::builders::ListSmsSandboxPhoneNumbersInputBuilder {
        super::super::super::operation::list_sms_sandbox_phone_numbers::builders::ListSmsSandboxPhoneNumbersInputBuilder::default()
    }
}
