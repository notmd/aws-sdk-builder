...
impl OptInPhoneNumberInput {
    ...
    pub fn builder() -> super::super::super::operation::opt_in_phone_number::builders::OptInPhoneNumberInputBuilder {
        super::super::super::operation::opt_in_phone_number::builders::OptInPhoneNumberInputBuilder::default()
    }
}
