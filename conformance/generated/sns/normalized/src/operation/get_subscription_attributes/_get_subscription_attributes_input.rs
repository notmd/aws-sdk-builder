...
impl GetSubscriptionAttributesInput {
    ...
    pub fn builder() -> super::super::super::operation::get_subscription_attributes::builders::GetSubscriptionAttributesInputBuilder {
        super::super::super::operation::get_subscription_attributes::builders::GetSubscriptionAttributesInputBuilder::default()
    }
}
