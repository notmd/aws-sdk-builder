...
impl GetSubscriptionAttributesOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_subscription_attributes::builders::GetSubscriptionAttributesOutputBuilder {
        super::super::super::operation::get_subscription_attributes::builders::GetSubscriptionAttributesOutputBuilder::default()
    }
}
...
impl GetSubscriptionAttributesOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::get_subscription_attributes::GetSubscriptionAttributesOutput {
