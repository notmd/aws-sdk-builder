...
impl ListOriginationNumbersOutput {
    ...
    pub fn phone_numbers(&self) -> &[super::super::super::types::PhoneNumberInformation] {
...
impl ListOriginationNumbersOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_origination_numbers::builders::ListOriginationNumbersOutputBuilder {
        super::super::super::operation::list_origination_numbers::builders::ListOriginationNumbersOutputBuilder::default()
    }
}
...
pub struct ListOriginationNumbersOutputBuilder {
    ...
    pub(crate) phone_numbers: ::std::option::Option<::std::vec::Vec<super::super::super::types::PhoneNumberInformation>>,
    _request_id: Option<String>,
}
impl ListOriginationNumbersOutputBuilder {
    ...
    ///
    /// <p>A list of the calling account's verified and pending origination numbers.</p>
    pub fn phone_numbers(mut self, input: super::super::super::types::PhoneNumberInformation) -> Self {
    ...
    /// <p>A list of the calling account's verified and pending origination numbers.</p>
    pub fn set_phone_numbers(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::PhoneNumberInformation>>) -> Self {
        self.phone_numbers = input;
        self
    }
    /// <p>A list of the calling account's verified and pending origination numbers.</p>
    pub fn get_phone_numbers(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::PhoneNumberInformation>> {
        &self.phone_numbers
    }
    ...
    pub fn build(self) -> super::super::super::operation::list_origination_numbers::ListOriginationNumbersOutput {
