...
pub struct ListOriginationNumbersPaginator {
    ...
    builder: super::super::super::operation::list_origination_numbers::builders::ListOriginationNumbersInputBuilder,
...
impl ListOriginationNumbersPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::list_origination_numbers::paginator::ListOriginationNumbersPaginatorItems {
        super::super::super::operation::list_origination_numbers::paginator::ListOriginationNumbersPaginatorItems(self)
    }
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_origination_numbers_output_output_next_token(resp);
...
impl ListOriginationNumbersPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::PhoneNumberInformation,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::list_origination_numbers::ListOriginationNumbersError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_list_origination_numbers_output_output_phone_numbers(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
