...
impl ListOriginationNumbersInput {
    ...
    pub fn builder() -> super::super::super::operation::list_origination_numbers::builders::ListOriginationNumbersInputBuilder {
        super::super::super::operation::list_origination_numbers::builders::ListOriginationNumbersInputBuilder::default()
    }
}
...
impl ListOriginationNumbersInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::list_origination_numbers::ListOriginationNumbersInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::list_origination_numbers::ListOriginationNumbersInput {
