...
impl DeleteSmsSandboxPhoneNumberInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_sms_sandbox_phone_number::builders::DeleteSmsSandboxPhoneNumberInputBuilder {
        super::super::super::operation::delete_sms_sandbox_phone_number::builders::DeleteSmsSandboxPhoneNumberInputBuilder::default()
    }
}
