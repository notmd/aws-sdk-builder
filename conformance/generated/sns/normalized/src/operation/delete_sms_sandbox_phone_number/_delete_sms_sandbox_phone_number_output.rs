...
impl DeleteSmsSandboxPhoneNumberOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_sms_sandbox_phone_number::builders::DeleteSmsSandboxPhoneNumberOutputBuilder {
        super::super::super::operation::delete_sms_sandbox_phone_number::builders::DeleteSmsSandboxPhoneNumberOutputBuilder::default()
    }
}
...
impl DeleteSmsSandboxPhoneNumberOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_sms_sandbox_phone_number::DeleteSmsSandboxPhoneNumberOutput {
