...
impl PublishInput {
    ...
    pub fn builder() -> super::super::super::operation::publish::builders::PublishInputBuilder {
        super::super::super::operation::publish::builders::PublishInputBuilder::default()
    }
}
