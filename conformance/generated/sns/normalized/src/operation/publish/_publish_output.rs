...
impl PublishOutput {
    ...
    pub fn builder() -> super::super::super::operation::publish::builders::PublishOutputBuilder {
        super::super::super::operation::publish::builders::PublishOutputBuilder::default()
    }
}
...
impl PublishOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::publish::PublishOutput {
