...
impl SetSubscriptionAttributesInput {
    ...
    pub fn builder() -> super::super::super::operation::set_subscription_attributes::builders::SetSubscriptionAttributesInputBuilder {
        super::super::super::operation::set_subscription_attributes::builders::SetSubscriptionAttributesInputBuilder::default()
    }
}
