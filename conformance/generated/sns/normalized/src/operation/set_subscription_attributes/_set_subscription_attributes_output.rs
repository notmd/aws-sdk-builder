...
impl SetSubscriptionAttributesOutput {
    ...
    pub fn builder() -> super::super::super::operation::set_subscription_attributes::builders::SetSubscriptionAttributesOutputBuilder {
        super::super::super::operation::set_subscription_attributes::builders::SetSubscriptionAttributesOutputBuilder::default()
    }
}
...
impl SetSubscriptionAttributesOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::set_subscription_attributes::SetSubscriptionAttributesOutput {
