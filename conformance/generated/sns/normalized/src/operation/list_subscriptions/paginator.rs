...
pub struct ListSubscriptionsPaginator {
    ...
    builder: super::super::super::operation::list_subscriptions::builders::ListSubscriptionsInputBuilder,
...
impl ListSubscriptionsPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::list_subscriptions::paginator::ListSubscriptionsPaginatorItems {
        super::super::super::operation::list_subscriptions::paginator::ListSubscriptionsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = super::super::super::operation::list_subscriptions::ListSubscriptions::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_subscriptions_output_output_next_token(resp);
...
impl ListSubscriptionsPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::Subscription,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::list_subscriptions::ListSubscriptionsError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_list_subscriptions_output_output_subscriptions(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
