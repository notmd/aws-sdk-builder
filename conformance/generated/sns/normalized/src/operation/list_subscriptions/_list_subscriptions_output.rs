...
impl ListSubscriptionsOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_subscriptions::builders::ListSubscriptionsOutputBuilder {
        super::super::super::operation::list_subscriptions::builders::ListSubscriptionsOutputBuilder::default()
    }
}
...
impl ListSubscriptionsOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::list_subscriptions::ListSubscriptionsOutput {
