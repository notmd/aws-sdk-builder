...
impl ListSubscriptionsInput {
    ...
    pub fn builder() -> super::super::super::operation::list_subscriptions::builders::ListSubscriptionsInputBuilder {
        super::super::super::operation::list_subscriptions::builders::ListSubscriptionsInputBuilder::default()
    }
}
