...
impl SetSmsAttributesOutput {
    ...
    pub fn builder() -> super::super::super::operation::set_sms_attributes::builders::SetSmsAttributesOutputBuilder {
        super::super::super::operation::set_sms_attributes::builders::SetSmsAttributesOutputBuilder::default()
    }
}
...
impl SetSmsAttributesOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::set_sms_attributes::SetSmsAttributesOutput {
