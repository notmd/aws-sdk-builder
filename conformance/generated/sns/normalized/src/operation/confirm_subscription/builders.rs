...
pub use super::super::super::operation::confirm_subscription::_confirm_subscription_input::ConfirmSubscriptionInputBuilder;

pub use super::super::super::operation::confirm_subscription::_confirm_subscription_output::ConfirmSubscriptionOutputBuilder;

impl super::super::super::operation::confirm_subscription::builders::ConfirmSubscriptionInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::confirm_subscription::ConfirmSubscriptionOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::confirm_subscription::ConfirmSubscriptionError,
...
pub struct ConfirmSubscriptionFluentBuilder {
    ...
    inner: super::super::super::operation::confirm_subscription::builders::ConfirmSubscriptionInputBuilder,
...
impl ConfirmSubscriptionFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::confirm_subscription::builders::ConfirmSubscriptionInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::confirm_subscription::ConfirmSubscription::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::confirm_subscription::ConfirmSubscription::orchestrate(&runtime_plugins, input).await
    }
