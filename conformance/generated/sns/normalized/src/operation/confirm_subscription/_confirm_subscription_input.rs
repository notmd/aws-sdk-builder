...
impl ConfirmSubscriptionInput {
    ...
    pub fn builder() -> super::super::super::operation::confirm_subscription::builders::ConfirmSubscriptionInputBuilder {
        super::super::super::operation::confirm_subscription::builders::ConfirmSubscriptionInputBuilder::default()
    }
}
