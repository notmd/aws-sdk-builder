...
impl ConfirmSubscriptionOutput {
    ...
    pub fn builder() -> super::super::super::operation::confirm_subscription::builders::ConfirmSubscriptionOutputBuilder {
        super::super::super::operation::confirm_subscription::builders::ConfirmSubscriptionOutputBuilder::default()
    }
}
...
impl ConfirmSubscriptionOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::confirm_subscription::ConfirmSubscriptionOutput {
