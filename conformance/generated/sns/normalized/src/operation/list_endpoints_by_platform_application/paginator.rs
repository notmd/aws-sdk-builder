...
pub struct ListEndpointsByPlatformApplicationPaginator {
    ...
    builder: super::super::super::operation::list_endpoints_by_platform_application::builders::ListEndpointsByPlatformApplicationInputBuilder,
...
impl ListEndpointsByPlatformApplicationPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::Endpoint,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::list_endpoints_by_platform_application::ListEndpointsByPlatformApplicationError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_list_endpoints_by_platform_application_output_output_endpoints(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
