...
pub use super::super::super::operation::list_endpoints_by_platform_application::_list_endpoints_by_platform_application_input::ListEndpointsByPlatformApplicationInputBuilder;

pub use super::super::super::operation::list_endpoints_by_platform_application::_list_endpoints_by_platform_application_output::ListEndpointsByPlatformApplicationOutputBuilder;

impl super::super::super::operation::list_endpoints_by_platform_application::builders::ListEndpointsByPlatformApplicationInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::list_endpoints_by_platform_application::ListEndpointsByPlatformApplicationOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::list_endpoints_by_platform_application::ListEndpointsByPlatformApplicationError,
...
pub struct ListEndpointsByPlatformApplicationFluentBuilder {
    ...
    inner: super::super::super::operation::list_endpoints_by_platform_application::builders::ListEndpointsByPlatformApplicationInputBuilder,
