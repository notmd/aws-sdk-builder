...
impl CreatePlatformApplicationOutput {
    ...
    pub fn builder() -> super::super::super::operation::create_platform_application::builders::CreatePlatformApplicationOutputBuilder {
        super::super::super::operation::create_platform_application::builders::CreatePlatformApplicationOutputBuilder::default()
    }
}
...
impl CreatePlatformApplicationOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::create_platform_application::CreatePlatformApplicationOutput {
