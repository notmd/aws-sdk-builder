...
impl SetEndpointAttributesInput {
    ...
    pub fn builder() -> super::super::super::operation::set_endpoint_attributes::builders::SetEndpointAttributesInputBuilder {
        super::super::super::operation::set_endpoint_attributes::builders::SetEndpointAttributesInputBuilder::default()
    }
}
