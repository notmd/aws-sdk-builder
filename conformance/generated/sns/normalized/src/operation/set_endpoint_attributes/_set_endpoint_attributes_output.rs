...
impl SetEndpointAttributesOutput {
    ...
    pub fn builder() -> super::super::super::operation::set_endpoint_attributes::builders::SetEndpointAttributesOutputBuilder {
        super::super::super::operation::set_endpoint_attributes::builders::SetEndpointAttributesOutputBuilder::default()
    }
}
...
impl SetEndpointAttributesOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::set_endpoint_attributes::SetEndpointAttributesOutput {
