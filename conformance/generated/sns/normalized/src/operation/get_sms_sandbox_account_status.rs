...
impl GetSmsSandboxAccountStatus {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::get_sms_sandbox_account_status::GetSMSSandboxAccountStatusError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::get_sms_sandbox_account_status::GetSmsSandboxAccountStatusOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SNS", "GetSMSSandboxAccountStatus", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetSMSSandboxAccountStatusResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_get_sms_sandbox_account_status::de_get_sms_sandbox_account_status_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_get_sms_sandbox_account_status::de_get_sms_sandbox_account_status_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetSMSSandboxAccountStatusRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::get_sms_sandbox_account_status::GetSmsSandboxAccountStatusInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::get_sms_sandbox_account_status::GetSmsSandboxAccountStatusInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::get_sms_sandbox_account_status::GetSMSSandboxAccountStatusError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::get_sms_sandbox_account_status::_get_sms_sandbox_account_status_input::GetSmsSandboxAccountStatusInput;

pub use super::super::operation::get_sms_sandbox_account_status::_get_sms_sandbox_account_status_output::GetSmsSandboxAccountStatusOutput;
