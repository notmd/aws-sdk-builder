...
impl SubscribeOutput {
    ...
    pub fn builder() -> super::super::super::operation::subscribe::builders::SubscribeOutputBuilder {
        super::super::super::operation::subscribe::builders::SubscribeOutputBuilder::default()
    }
}
...
impl SubscribeOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::subscribe::SubscribeOutput {
