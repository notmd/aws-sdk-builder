...
impl SubscribeInput {
    ...
    pub fn builder() -> super::super::super::operation::subscribe::builders::SubscribeInputBuilder {
        super::super::super::operation::subscribe::builders::SubscribeInputBuilder::default()
    }
}
