...
impl CreateTopicInput {
    ...
    pub fn builder() -> super::super::super::operation::create_topic::builders::CreateTopicInputBuilder {
        super::super::super::operation::create_topic::builders::CreateTopicInputBuilder::default()
    }
}
