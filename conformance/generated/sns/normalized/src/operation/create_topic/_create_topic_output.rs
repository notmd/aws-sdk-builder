...
impl CreateTopicOutput {
    ...
    pub fn builder() -> super::super::super::operation::create_topic::builders::CreateTopicOutputBuilder {
        super::super::super::operation::create_topic::builders::CreateTopicOutputBuilder::default()
    }
}
...
impl CreateTopicOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::create_topic::CreateTopicOutput {
