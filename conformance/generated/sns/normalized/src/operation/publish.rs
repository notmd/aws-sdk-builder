...
impl Publish {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::super::operation::publish::PublishOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::publish::PublishError,
    ...
    > {
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::publish::PublishOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PublishResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_publish::de_publish_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_publish::de_publish_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PublishRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::super::operation::publish::PublishInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::publish::PublishInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::publish::PublishError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::publish::_publish_input::PublishInput;

pub use super::super::operation::publish::_publish_output::PublishOutput;
