...
impl CreatePlatformEndpointOutput {
    ...
    pub fn builder() -> super::super::super::operation::create_platform_endpoint::builders::CreatePlatformEndpointOutputBuilder {
        super::super::super::operation::create_platform_endpoint::builders::CreatePlatformEndpointOutputBuilder::default()
    }
}
...
impl CreatePlatformEndpointOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::create_platform_endpoint::CreatePlatformEndpointOutput {
