...
impl GetSmsAttributesOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_sms_attributes::builders::GetSmsAttributesOutputBuilder {
        super::super::super::operation::get_sms_attributes::builders::GetSmsAttributesOutputBuilder::default()
    }
}
...
impl GetSmsAttributesOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::get_sms_attributes::GetSmsAttributesOutput {
