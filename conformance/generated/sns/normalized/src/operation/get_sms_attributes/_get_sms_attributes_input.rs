...
impl GetSmsAttributesInput {
    ...
    pub fn builder() -> super::super::super::operation::get_sms_attributes::builders::GetSmsAttributesInputBuilder {
        super::super::super::operation::get_sms_attributes::builders::GetSmsAttributesInputBuilder::default()
    }
}
