...
pub struct ListPlatformApplicationsPaginator {
    ...
    builder: super::super::super::operation::list_platform_applications::builders::ListPlatformApplicationsInputBuilder,
...
impl ListPlatformApplicationsPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::list_platform_applications::paginator::ListPlatformApplicationsPaginatorItems {
        super::super::super::operation::list_platform_applications::paginator::ListPlatformApplicationsPaginatorItems(self)
    }
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_platform_applications_output_output_next_token(resp);
...
impl ListPlatformApplicationsPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            super::super::super::types::PlatformApplication,
            ::aws_smithy_runtime_api::client::result::SdkError<
                super::super::super::operation::list_platform_applications::ListPlatformApplicationsError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_list_platform_applications_output_output_platform_applications(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
