...
impl ListPlatformApplicationsOutput {
    ...
    pub fn platform_applications(&self) -> &[super::super::super::types::PlatformApplication] {
...
impl ListPlatformApplicationsOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_platform_applications::builders::ListPlatformApplicationsOutputBuilder {
        super::super::super::operation::list_platform_applications::builders::ListPlatformApplicationsOutputBuilder::default()
    }
}
...
pub struct ListPlatformApplicationsOutputBuilder {
    pub(crate) platform_applications: ::std::option::Option<::std::vec::Vec<super::super::super::types::PlatformApplication>>,
...
impl ListPlatformApplicationsOutputBuilder {
    ...
    ///
    /// <p>Platform applications returned when calling <code>ListPlatformApplications</code> action.</p>
    pub fn platform_applications(mut self, input: super::super::super::types::PlatformApplication) -> Self {
    ...
    /// <p>Platform applications returned when calling <code>ListPlatformApplications</code> action.</p>
    pub fn get_platform_applications(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::PlatformApplication>> {
    ...
    pub fn build(self) -> super::super::super::operation::list_platform_applications::ListPlatformApplicationsOutput {
