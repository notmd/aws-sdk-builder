...
impl ListOriginationNumbers {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::super::operation::list_origination_numbers::ListOriginationNumbersOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::list_origination_numbers::ListOriginationNumbersError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::list_origination_numbers::ListOriginationNumbersError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::list_origination_numbers::ListOriginationNumbersOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SNS", "ListOriginationNumbers", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListOriginationNumbersTelemetryInputCaptureInterceptor {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListOriginationNumbersResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_list_origination_numbers::de_list_origination_numbers_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_list_origination_numbers::de_list_origination_numbers_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListOriginationNumbersRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::list_origination_numbers::ListOriginationNumbersInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::list_origination_numbers::ListOriginationNumbersInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::list_origination_numbers::ListOriginationNumbersError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::list_origination_numbers::_list_origination_numbers_input::ListOriginationNumbersInput;

pub use super::super::operation::list_origination_numbers::_list_origination_numbers_output::ListOriginationNumbersOutput;
