...
impl GetSmsSandboxAccountStatusOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_sms_sandbox_account_status::builders::GetSmsSandboxAccountStatusOutputBuilder {
        super::super::super::operation::get_sms_sandbox_account_status::builders::GetSmsSandboxAccountStatusOutputBuilder::default()
    }
}
...
impl GetSmsSandboxAccountStatusOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::get_sms_sandbox_account_status::GetSmsSandboxAccountStatusOutput {
