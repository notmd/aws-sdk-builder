...
impl GetSmsSandboxAccountStatusInput {
    ...
    pub fn builder() -> super::super::super::operation::get_sms_sandbox_account_status::builders::GetSmsSandboxAccountStatusInputBuilder {
        super::super::super::operation::get_sms_sandbox_account_status::builders::GetSmsSandboxAccountStatusInputBuilder::default()
    }
}
...
impl GetSmsSandboxAccountStatusInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::get_sms_sandbox_account_status::GetSmsSandboxAccountStatusInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::get_sms_sandbox_account_status::GetSmsSandboxAccountStatusInput {})
    }
}
