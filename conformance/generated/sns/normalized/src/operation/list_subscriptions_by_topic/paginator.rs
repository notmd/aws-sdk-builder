...
pub struct ListSubscriptionsByTopicPaginator {
    ...
    builder: super::super::super::operation::list_subscriptions_by_topic::builders::ListSubscriptionsByTopicInputBuilder,
...
impl ListSubscriptionsByTopicPaginator {
    ...
    pub fn items(self) -> super::super::super::operation::list_subscriptions_by_topic::paginator::ListSubscriptionsByTopicPaginatorItems {
        super::super::super::operation::list_subscriptions_by_topic::paginator::ListSubscriptionsByTopicPaginatorItems(self)
    }
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = super::super::super::lens::reflens_list_subscriptions_by_topic_output_output_next_token(resp);
...
impl ListSubscriptionsByTopicPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            super::super::super::lens::lens_list_subscriptions_by_topic_output_output_subscriptions(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
