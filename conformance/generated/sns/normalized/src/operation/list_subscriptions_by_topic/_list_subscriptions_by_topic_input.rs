...
impl ListSubscriptionsByTopicInput {
    ...
    pub fn builder() -> super::super::super::operation::list_subscriptions_by_topic::builders::ListSubscriptionsByTopicInputBuilder {
        super::super::super::operation::list_subscriptions_by_topic::builders::ListSubscriptionsByTopicInputBuilder::default()
    }
}
