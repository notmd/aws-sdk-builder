...
impl SetTopicAttributes {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::set_topic_attributes::SetTopicAttributesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::set_topic_attributes::SetTopicAttributesOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SNS", "SetTopicAttributes", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetTopicAttributesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_set_topic_attributes::de_set_topic_attributes_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_set_topic_attributes::de_set_topic_attributes_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetTopicAttributesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::set_topic_attributes::SetTopicAttributesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::set_topic_attributes::SetTopicAttributesInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::set_topic_attributes::SetTopicAttributesError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::set_topic_attributes::_set_topic_attributes_input::SetTopicAttributesInput;

pub use super::super::operation::set_topic_attributes::_set_topic_attributes_output::SetTopicAttributesOutput;
