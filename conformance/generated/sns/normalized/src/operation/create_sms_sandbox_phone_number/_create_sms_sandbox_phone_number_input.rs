...
impl CreateSmsSandboxPhoneNumberInput {
    ...
    /// <p>The language to use for sending the OTP. The default value is <code>en-US</code>.</p>
    pub fn language_code(&self) -> ::std::option::Option<&super::super::super::types::LanguageCodeString> {
...
impl CreateSmsSandboxPhoneNumberInput {
    ...
    pub fn builder() -> super::super::super::operation::create_sms_sandbox_phone_number::builders::CreateSmsSandboxPhoneNumberInputBuilder {
        super::super::super::operation::create_sms_sandbox_phone_number::builders::CreateSmsSandboxPhoneNumberInputBuilder::default()
    }
}
...
pub struct CreateSmsSandboxPhoneNumberInputBuilder {
    ...
    pub(crate) language_code: ::std::option::Option<super::super::super::types::LanguageCodeString>,
}
