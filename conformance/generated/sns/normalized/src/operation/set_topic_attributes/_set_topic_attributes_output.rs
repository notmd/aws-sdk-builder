...
impl SetTopicAttributesOutput {
    ...
    pub fn builder() -> super::super::super::operation::set_topic_attributes::builders::SetTopicAttributesOutputBuilder {
        super::super::super::operation::set_topic_attributes::builders::SetTopicAttributesOutputBuilder::default()
    }
}
...
impl SetTopicAttributesOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::set_topic_attributes::SetTopicAttributesOutput {
