...
impl GetEndpointAttributesOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_endpoint_attributes::builders::GetEndpointAttributesOutputBuilder {
        super::super::super::operation::get_endpoint_attributes::builders::GetEndpointAttributesOutputBuilder::default()
    }
}
...
impl GetEndpointAttributesOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::get_endpoint_attributes::GetEndpointAttributesOutput {
