...
impl GetEndpointAttributesInput {
    ...
    pub fn builder() -> super::super::super::operation::get_endpoint_attributes::builders::GetEndpointAttributesInputBuilder {
        super::super::super::operation::get_endpoint_attributes::builders::GetEndpointAttributesInputBuilder::default()
    }
}
