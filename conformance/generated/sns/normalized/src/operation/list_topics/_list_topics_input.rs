...
impl ListTopicsInput {
    ...
    pub fn builder() -> super::super::super::operation::list_topics::builders::ListTopicsInputBuilder {
        super::super::super::operation::list_topics::builders::ListTopicsInputBuilder::default()
    }
}
