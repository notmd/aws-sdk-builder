...
pub use super::super::super::operation::set_platform_application_attributes::_set_platform_application_attributes_input::SetPlatformApplicationAttributesInputBuilder;

pub use super::super::super::operation::set_platform_application_attributes::_set_platform_application_attributes_output::SetPlatformApplicationAttributesOutputBuilder;

impl super::super::super::operation::set_platform_application_attributes::builders::SetPlatformApplicationAttributesInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::set_platform_application_attributes::SetPlatformApplicationAttributesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::set_platform_application_attributes::SetPlatformApplicationAttributesError,
...
pub struct SetPlatformApplicationAttributesFluentBuilder {
    ...
    inner: super::super::super::operation::set_platform_application_attributes::builders::SetPlatformApplicationAttributesInputBuilder,
