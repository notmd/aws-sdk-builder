...
impl SetPlatformApplicationAttributesOutput {
    ...
    pub fn builder() -> super::super::super::operation::set_platform_application_attributes::builders::SetPlatformApplicationAttributesOutputBuilder {
        super::super::super::operation::set_platform_application_attributes::builders::SetPlatformApplicationAttributesOutputBuilder::default()
    }
}
...
impl SetPlatformApplicationAttributesOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::set_platform_application_attributes::SetPlatformApplicationAttributesOutput {
