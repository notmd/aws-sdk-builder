...
impl CheckIfPhoneNumberIsOptedOutOutput {
    ...
    pub fn builder() -> super::super::super::operation::check_if_phone_number_is_opted_out::builders::CheckIfPhoneNumberIsOptedOutOutputBuilder {
        super::super::super::operation::check_if_phone_number_is_opted_out::builders::CheckIfPhoneNumberIsOptedOutOutputBuilder::default()
    }
}
...
impl CheckIfPhoneNumberIsOptedOutOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::check_if_phone_number_is_opted_out::CheckIfPhoneNumberIsOptedOutOutput {
