...
pub use super::super::super::operation::check_if_phone_number_is_opted_out::_check_if_phone_number_is_opted_out_input::CheckIfPhoneNumberIsOptedOutInputBuilder;

pub use super::super::super::operation::check_if_phone_number_is_opted_out::_check_if_phone_number_is_opted_out_output::CheckIfPhoneNumberIsOptedOutOutputBuilder;

impl super::super::super::operation::check_if_phone_number_is_opted_out::builders::CheckIfPhoneNumberIsOptedOutInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::check_if_phone_number_is_opted_out::CheckIfPhoneNumberIsOptedOutOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::check_if_phone_number_is_opted_out::CheckIfPhoneNumberIsOptedOutError,
...
pub struct CheckIfPhoneNumberIsOptedOutFluentBuilder {
    ...
    inner: super::super::super::operation::check_if_phone_number_is_opted_out::builders::CheckIfPhoneNumberIsOptedOutInputBuilder,
