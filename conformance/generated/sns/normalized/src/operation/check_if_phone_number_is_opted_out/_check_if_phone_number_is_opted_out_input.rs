...
impl CheckIfPhoneNumberIsOptedOutInput {
    ...
    pub fn builder() -> super::super::super::operation::check_if_phone_number_is_opted_out::builders::CheckIfPhoneNumberIsOptedOutInputBuilder {
        super::super::super::operation::check_if_phone_number_is_opted_out::builders::CheckIfPhoneNumberIsOptedOutInputBuilder::default()
    }
}
