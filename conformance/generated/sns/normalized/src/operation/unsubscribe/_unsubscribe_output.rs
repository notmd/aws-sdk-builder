...
impl UnsubscribeOutput {
    ...
    pub fn builder() -> super::super::super::operation::unsubscribe::builders::UnsubscribeOutputBuilder {
        super::super::super::operation::unsubscribe::builders::UnsubscribeOutputBuilder::default()
    }
}
...
impl UnsubscribeOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::unsubscribe::UnsubscribeOutput {
