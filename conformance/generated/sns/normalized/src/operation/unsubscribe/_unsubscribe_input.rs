...
impl UnsubscribeInput {
    ...
    pub fn builder() -> super::super::super::operation::unsubscribe::builders::UnsubscribeInputBuilder {
        super::super::super::operation::unsubscribe::builders::UnsubscribeInputBuilder::default()
    }
}
