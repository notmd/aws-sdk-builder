...
pub use super::super::super::operation::unsubscribe::_unsubscribe_input::UnsubscribeInputBuilder;

pub use super::super::super::operation::unsubscribe::_unsubscribe_output::UnsubscribeOutputBuilder;

impl super::super::super::operation::unsubscribe::builders::UnsubscribeInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::unsubscribe::UnsubscribeOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::unsubscribe::UnsubscribeError,
...
pub struct UnsubscribeFluentBuilder {
    ...
    inner: super::super::super::operation::unsubscribe::builders::UnsubscribeInputBuilder,
...
impl UnsubscribeFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::unsubscribe::builders::UnsubscribeInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::unsubscribe::Unsubscribe::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::unsubscribe::Unsubscribe::orchestrate(&runtime_plugins, input).await
    }
