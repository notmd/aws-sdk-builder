...
impl DeleteTopicInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_topic::builders::DeleteTopicInputBuilder {
        super::super::super::operation::delete_topic::builders::DeleteTopicInputBuilder::default()
    }
}
