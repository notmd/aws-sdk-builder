...
impl DeleteTopicOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_topic::builders::DeleteTopicOutputBuilder {
        super::super::super::operation::delete_topic::builders::DeleteTopicOutputBuilder::default()
    }
}
...
impl DeleteTopicOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_topic::DeleteTopicOutput {
