...
pub use super::super::super::operation::delete_topic::_delete_topic_input::DeleteTopicInputBuilder;

pub use super::super::super::operation::delete_topic::_delete_topic_output::DeleteTopicOutputBuilder;

impl super::super::super::operation::delete_topic::builders::DeleteTopicInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_topic::DeleteTopicOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_topic::DeleteTopicError,
...
pub struct DeleteTopicFluentBuilder {
    ...
    inner: super::super::super::operation::delete_topic::builders::DeleteTopicInputBuilder,
...
impl DeleteTopicFluentBuilder {
    /// Creates a new `DeleteTopicFluentBuilder`.
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_topic::builders::DeleteTopicInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_topic::DeleteTopic::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_topic::DeleteTopic::orchestrate(&runtime_plugins, input).await
    }
