...
impl super::Client {
    ...
    pub fn publish_batch(&self) -> super::super::operation::publish_batch::builders::PublishBatchFluentBuilder {
        super::super::operation::publish_batch::builders::PublishBatchFluentBuilder::new(self.handle.clone())
    }
}
