...
impl super::Client {
    ...
    pub fn list_sms_sandbox_phone_numbers(
        &self,
    ) -> super::super::operation::list_sms_sandbox_phone_numbers::builders::ListSMSSandboxPhoneNumbersFluentBuilder {
        super::super::operation::list_sms_sandbox_phone_numbers::builders::ListSMSSandboxPhoneNumbersFluentBuilder::new(self.handle.clone())
    }
}
