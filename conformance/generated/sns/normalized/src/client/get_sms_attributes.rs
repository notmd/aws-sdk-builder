...
impl super::Client {
    ...
    pub fn get_sms_attributes(&self) -> super::super::operation::get_sms_attributes::builders::GetSMSAttributesFluentBuilder {
        super::super::operation::get_sms_attributes::builders::GetSMSAttributesFluentBuilder::new(self.handle.clone())
    }
}
