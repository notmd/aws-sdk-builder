...
impl super::Client {
    ...
    pub fn delete_topic(&self) -> super::super::operation::delete_topic::builders::DeleteTopicFluentBuilder {
        super::super::operation::delete_topic::builders::DeleteTopicFluentBuilder::new(self.handle.clone())
    }
}
