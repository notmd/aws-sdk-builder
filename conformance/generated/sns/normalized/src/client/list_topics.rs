...
impl super::Client {
    ...
    pub fn list_topics(&self) -> super::super::operation::list_topics::builders::ListTopicsFluentBuilder {
        super::super::operation::list_topics::builders::ListTopicsFluentBuilder::new(self.handle.clone())
    }
}
