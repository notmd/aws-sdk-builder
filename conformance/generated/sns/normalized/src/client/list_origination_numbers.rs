...
impl super::Client {
    ...
    pub fn list_origination_numbers(&self) -> super::super::operation::list_origination_numbers::builders::ListOriginationNumbersFluentBuilder {
        super::super::operation::list_origination_numbers::builders::ListOriginationNumbersFluentBuilder::new(self.handle.clone())
    }
}
