...
impl super::Client {
    ...
    pub fn delete_endpoint(&self) -> super::super::operation::delete_endpoint::builders::DeleteEndpointFluentBuilder {
        super::super::operation::delete_endpoint::builders::DeleteEndpointFluentBuilder::new(self.handle.clone())
    }
}
