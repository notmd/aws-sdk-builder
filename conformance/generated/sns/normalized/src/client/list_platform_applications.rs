...
impl super::Client {
    ...
    pub fn list_platform_applications(&self) -> super::super::operation::list_platform_applications::builders::ListPlatformApplicationsFluentBuilder {
        super::super::operation::list_platform_applications::builders::ListPlatformApplicationsFluentBuilder::new(self.handle.clone())
    }
}
