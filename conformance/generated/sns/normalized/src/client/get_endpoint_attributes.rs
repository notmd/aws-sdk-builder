...
impl super::Client {
    ...
    pub fn get_endpoint_attributes(&self) -> super::super::operation::get_endpoint_attributes::builders::GetEndpointAttributesFluentBuilder {
        super::super::operation::get_endpoint_attributes::builders::GetEndpointAttributesFluentBuilder::new(self.handle.clone())
    }
}
