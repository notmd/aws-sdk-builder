...
impl super::Client {
    ...
    pub fn unsubscribe(&self) -> super::super::operation::unsubscribe::builders::UnsubscribeFluentBuilder {
        super::super::operation::unsubscribe::builders::UnsubscribeFluentBuilder::new(self.handle.clone())
    }
}
