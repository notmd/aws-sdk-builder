...
impl super::Client {
    ...
    pub fn delete_sms_sandbox_phone_number(
        &self,
    ) -> super::super::operation::delete_sms_sandbox_phone_number::builders::DeleteSMSSandboxPhoneNumberFluentBuilder {
        super::super::operation::delete_sms_sandbox_phone_number::builders::DeleteSMSSandboxPhoneNumberFluentBuilder::new(self.handle.clone())
    }
}
