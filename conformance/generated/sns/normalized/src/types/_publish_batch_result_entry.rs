...
impl PublishBatchResultEntry {
    ...
    pub fn builder() -> super::super::types::builders::PublishBatchResultEntryBuilder {
        super::super::types::builders::PublishBatchResultEntryBuilder::default()
    }
}
...
impl PublishBatchResultEntryBuilder {
    ...
    pub fn build(self) -> super::super::types::PublishBatchResultEntry {
        super::super::types::PublishBatchResultEntry {
            id: self.id,
