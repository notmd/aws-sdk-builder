...
impl PublishBatchRequestEntry {
    ...
    pub fn builder() -> super::super::types::builders::PublishBatchRequestEntryBuilder {
        super::super::types::builders::PublishBatchRequestEntryBuilder::default()
    }
}
...
impl PublishBatchRequestEntryBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::PublishBatchRequestEntry, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::PublishBatchRequestEntry {
