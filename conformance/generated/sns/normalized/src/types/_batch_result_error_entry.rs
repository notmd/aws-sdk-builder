...
impl BatchResultErrorEntry {
    ...
    pub fn builder() -> super::super::types::builders::BatchResultErrorEntryBuilder {
        super::super::types::builders::BatchResultErrorEntryBuilder::default()
    }
}
...
impl BatchResultErrorEntryBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::BatchResultErrorEntry, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::BatchResultErrorEntry {
