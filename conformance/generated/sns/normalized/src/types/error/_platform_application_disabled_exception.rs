...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::PlatformApplicationDisabledException {
...
impl PlatformApplicationDisabledException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::PlatformApplicationDisabledExceptionBuilder {
        super::super::super::types::error::builders::PlatformApplicationDisabledExceptionBuilder::default()
    }
}
...
impl PlatformApplicationDisabledExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::PlatformApplicationDisabledException {
        super::super::super::types::error::PlatformApplicationDisabledException {
