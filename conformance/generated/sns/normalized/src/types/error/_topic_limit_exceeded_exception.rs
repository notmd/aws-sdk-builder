...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::TopicLimitExceededException {
...
impl TopicLimitExceededException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::TopicLimitExceededExceptionBuilder {
        super::super::super::types::error::builders::TopicLimitExceededExceptionBuilder::default()
    }
}
...
impl TopicLimitExceededExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::TopicLimitExceededException {
        super::super::super::types::error::TopicLimitExceededException {
