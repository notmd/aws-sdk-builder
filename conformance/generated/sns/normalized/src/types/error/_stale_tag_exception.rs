...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::StaleTagException {
...
impl StaleTagException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::StaleTagExceptionBuilder {
        super::super::super::types::error::builders::StaleTagExceptionBuilder::default()
    }
}
...
impl StaleTagExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::StaleTagException {
        super::super::super::types::error::StaleTagException {
