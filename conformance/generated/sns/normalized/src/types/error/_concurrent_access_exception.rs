...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::ConcurrentAccessException {
...
impl ConcurrentAccessException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::ConcurrentAccessExceptionBuilder {
        super::super::super::types::error::builders::ConcurrentAccessExceptionBuilder::default()
    }
}
...
impl ConcurrentAccessExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::ConcurrentAccessException {
        super::super::super::types::error::ConcurrentAccessException {
