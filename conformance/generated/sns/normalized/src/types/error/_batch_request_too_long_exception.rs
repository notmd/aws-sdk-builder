...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::BatchRequestTooLongException {
...
impl BatchRequestTooLongException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::BatchRequestTooLongExceptionBuilder {
        super::super::super::types::error::builders::BatchRequestTooLongExceptionBuilder::default()
    }
}
...
impl BatchRequestTooLongExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::BatchRequestTooLongException {
        super::super::super::types::error::BatchRequestTooLongException {
