...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::AuthorizationErrorException {
...
impl AuthorizationErrorException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::AuthorizationErrorExceptionBuilder {
        super::super::super::types::error::builders::AuthorizationErrorExceptionBuilder::default()
    }
}
...
impl AuthorizationErrorExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::AuthorizationErrorException {
        super::super::super::types::error::AuthorizationErrorException {
