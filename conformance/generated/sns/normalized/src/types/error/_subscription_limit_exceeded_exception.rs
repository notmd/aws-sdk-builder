...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::SubscriptionLimitExceededException {
...
impl SubscriptionLimitExceededException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::SubscriptionLimitExceededExceptionBuilder {
        super::super::super::types::error::builders::SubscriptionLimitExceededExceptionBuilder::default()
    }
}
...
impl SubscriptionLimitExceededExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::SubscriptionLimitExceededException {
        super::super::super::types::error::SubscriptionLimitExceededException {
