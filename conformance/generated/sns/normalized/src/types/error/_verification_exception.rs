...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::VerificationException {
...
impl VerificationException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::VerificationExceptionBuilder {
        super::super::super::types::error::builders::VerificationExceptionBuilder::default()
    }
}
