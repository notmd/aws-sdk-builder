...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::KmsThrottlingException {
...
impl KmsThrottlingException {
    ...
    pub fn builder() -> super::super::super::types::error::builders::KmsThrottlingExceptionBuilder {
        super::super::super::types::error::builders::KmsThrottlingExceptionBuilder::default()
    }
}
...
impl KmsThrottlingExceptionBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::KmsThrottlingException {
        super::super::super::types::error::KmsThrottlingException {
