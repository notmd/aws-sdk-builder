...
impl PlatformApplication {
    ...
    pub fn builder() -> super::super::types::builders::PlatformApplicationBuilder {
        super::super::types::builders::PlatformApplicationBuilder::default()
    }
}
...
impl PlatformApplicationBuilder {
    ...
    pub fn build(self) -> super::super::types::PlatformApplication {
        super::super::types::PlatformApplication {
