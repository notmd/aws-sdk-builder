...
pub struct PhoneNumberInformation {
    ...
    pub route_type: ::std::option::Option<super::super::types::RouteType>,
    /// <p>The capabilities of each phone number.</p>
    pub number_capabilities: ::std::option::Option<::std::vec::Vec<super::super::types::NumberCapability>>,
}
impl PhoneNumberInformation {
    ...
    /// <p>The list of supported routes.</p>
    pub fn route_type(&self) -> ::std::option::Option<&super::super::types::RouteType> {
    ...
    pub fn number_capabilities(&self) -> &[super::super::types::NumberCapability] {
...
impl PhoneNumberInformation {
    ...
    pub fn builder() -> super::super::types::builders::PhoneNumberInformationBuilder {
        super::super::types::builders::PhoneNumberInformationBuilder::default()
    }
}
...
pub struct PhoneNumberInformationBuilder {
    ...
    pub(crate) route_type: ::std::option::Option<super::super::types::RouteType>,
    pub(crate) number_capabilities: ::std::option::Option<::std::vec::Vec<super::super::types::NumberCapability>>,
}
impl PhoneNumberInformationBuilder {
    ...
    /// <p>The list of supported routes.</p>
    pub fn route_type(mut self, input: super::super::types::RouteType) -> Self {
        self.route_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The list of supported routes.</p>
    pub fn set_route_type(mut self, input: ::std::option::Option<super::super::types::RouteType>) -> Self {
        self.route_type = input;
        self
    }
    /// <p>The list of supported routes.</p>
    pub fn get_route_type(&self) -> &::std::option::Option<super::super::types::RouteType> {
        &self.route_type
    }
    ...
    ///
    /// <p>The capabilities of each phone number.</p>
    pub fn number_capabilities(mut self, input: super::super::types::NumberCapability) -> Self {
    ...
    /// <p>The capabilities of each phone number.</p>
    pub fn set_number_capabilities(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::types::NumberCapability>>) -> Self {
        self.number_capabilities = input;
        self
    }
    /// <p>The capabilities of each phone number.</p>
    pub fn get_number_capabilities(&self) -> &::std::option::Option<::std::vec::Vec<super::super::types::NumberCapability>> {
        &self.number_capabilities
    }
    /// Consumes the builder and constructs a [`PhoneNumberInformation`](crate::types::PhoneNumberInformation).
    pub fn build(self) -> super::super::types::PhoneNumberInformation {
        super::super::types::PhoneNumberInformation {
