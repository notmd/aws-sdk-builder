...
pub(crate) fn evaluate_bdd<'a, Cond, Params, R, Context>(
    ...
    params: &'a Params,
    context: &mut Context,
    diagnostic_collector: &mut super::super::endpoint_lib::diagnostic::DiagnosticCollector,
    mut condition_evaluator: impl FnMut(&Cond, &'a Params, &mut Context, &mut super::super::endpoint_lib::diagnostic::DiagnosticCollector) -> bool,
