...
impl super::Client {
    ...
    pub fn list_queue_tags(&self) -> super::super::operation::list_queue_tags::builders::ListQueueTagsFluentBuilder {
        super::super::operation::list_queue_tags::builders::ListQueueTagsFluentBuilder::new(self.handle.clone())
    }
}
