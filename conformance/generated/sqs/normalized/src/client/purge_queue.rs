...
impl super::Client {
    ...
    pub fn purge_queue(&self) -> super::super::operation::purge_queue::builders::PurgeQueueFluentBuilder {
        super::super::operation::purge_queue::builders::PurgeQueueFluentBuilder::new(self.handle.clone())
    }
}
