...
impl super::Client {
    ...
    pub fn cancel_message_move_task(&self) -> super::super::operation::cancel_message_move_task::builders::CancelMessageMoveTaskFluentBuilder {
        super::super::operation::cancel_message_move_task::builders::CancelMessageMoveTaskFluentBuilder::new(self.handle.clone())
    }
}
