...
impl super::Client {
    ...
    pub fn get_queue_url(&self) -> super::super::operation::get_queue_url::builders::GetQueueUrlFluentBuilder {
        super::super::operation::get_queue_url::builders::GetQueueUrlFluentBuilder::new(self.handle.clone())
    }
}
