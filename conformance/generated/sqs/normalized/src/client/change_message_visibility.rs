...
impl super::Client {
    ...
    pub fn change_message_visibility(&self) -> super::super::operation::change_message_visibility::builders::ChangeMessageVisibilityFluentBuilder {
        super::super::operation::change_message_visibility::builders::ChangeMessageVisibilityFluentBuilder::new(self.handle.clone())
    }
}
