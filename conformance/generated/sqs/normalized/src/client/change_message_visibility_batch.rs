...
impl super::Client {
    ...
    pub fn change_message_visibility_batch(
        &self,
    ) -> super::super::operation::change_message_visibility_batch::builders::ChangeMessageVisibilityBatchFluentBuilder {
        super::super::operation::change_message_visibility_batch::builders::ChangeMessageVisibilityBatchFluentBuilder::new(self.handle.clone())
    }
}
