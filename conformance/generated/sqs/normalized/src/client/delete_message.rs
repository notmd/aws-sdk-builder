...
impl super::Client {
    ...
    pub fn delete_message(&self) -> super::super::operation::delete_message::builders::DeleteMessageFluentBuilder {
        super::super::operation::delete_message::builders::DeleteMessageFluentBuilder::new(self.handle.clone())
    }
}
