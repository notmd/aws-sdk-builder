...
impl super::Client {
    ...
    pub fn list_dead_letter_source_queues(
        &self,
    ) -> super::super::operation::list_dead_letter_source_queues::builders::ListDeadLetterSourceQueuesFluentBuilder {
        super::super::operation::list_dead_letter_source_queues::builders::ListDeadLetterSourceQueuesFluentBuilder::new(self.handle.clone())
    }
}
