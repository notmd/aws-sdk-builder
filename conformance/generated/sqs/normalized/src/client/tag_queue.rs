...
impl super::Client {
    ...
    pub fn tag_queue(&self) -> super::super::operation::tag_queue::builders::TagQueueFluentBuilder {
        super::super::operation::tag_queue::builders::TagQueueFluentBuilder::new(self.handle.clone())
    }
}
