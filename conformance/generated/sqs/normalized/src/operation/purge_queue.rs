...
impl PurgeQueue {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::super::operation::purge_queue::PurgeQueueOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::purge_queue::PurgeQueueError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::purge_queue::PurgeQueueError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::purge_queue::PurgeQueueOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SQS", "PurgeQueue", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PurgeQueue {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            PurgeQueueResponseDeserializer,
        ));
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PurgeQueueResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_purge_queue::de_purge_queue_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_purge_queue::de_purge_queue_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PurgeQueueRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::purge_queue::PurgeQueueInput,
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for PurgeQueueError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::PurgeQueueInProgress(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
...
impl ::aws_types::request_id::RequestId for super::super::operation::purge_queue::PurgeQueueError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::purge_queue::_purge_queue_input::PurgeQueueInput;

pub use super::super::operation::purge_queue::_purge_queue_output::PurgeQueueOutput;
