...
impl UntagQueue {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::super::operation::untag_queue::UntagQueueOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::untag_queue::UntagQueueError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::untag_queue::UntagQueueError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::untag_queue::UntagQueueOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SQS", "UntagQueue", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UntagQueue {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UntagQueueResponseDeserializer,
        ));
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UntagQueueResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_untag_queue::de_untag_queue_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_untag_queue::de_untag_queue_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UntagQueueRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::untag_queue::UntagQueueInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::untag_queue::UntagQueueError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::untag_queue::_untag_queue_input::UntagQueueInput;

pub use super::super::operation::untag_queue::_untag_queue_output::UntagQueueOutput;
