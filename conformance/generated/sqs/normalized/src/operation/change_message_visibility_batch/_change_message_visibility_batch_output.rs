...
pub struct ChangeMessageVisibilityBatchOutput {
    ...
    pub successful: ::std::vec::Vec<super::super::super::types::ChangeMessageVisibilityBatchResultEntry>,
...
impl ChangeMessageVisibilityBatchOutput {
    /// <p>A list of <code> <code>ChangeMessageVisibilityBatchResultEntry</code> </code> items.</p>
    pub fn successful(&self) -> &[super::super::super::types::ChangeMessageVisibilityBatchResultEntry] {
        use std::ops::Deref;
...
impl ChangeMessageVisibilityBatchOutput {
    ...
    pub fn builder() -> super::super::super::operation::change_message_visibility_batch::builders::ChangeMessageVisibilityBatchOutputBuilder {
        super::super::super::operation::change_message_visibility_batch::builders::ChangeMessageVisibilityBatchOutputBuilder::default()
    }
}
...
pub struct ChangeMessageVisibilityBatchOutputBuilder {
    pub(crate) successful: ::std::option::Option<::std::vec::Vec<super::super::super::types::ChangeMessageVisibilityBatchResultEntry>>,
...
impl ChangeMessageVisibilityBatchOutputBuilder {
    ...
    ///
    /// <p>A list of <code> <code>ChangeMessageVisibilityBatchResultEntry</code> </code> items.</p>
    pub fn successful(mut self, input: super::super::super::types::ChangeMessageVisibilityBatchResultEntry) -> Self {
    ...
    /// <p>A list of <code> <code>ChangeMessageVisibilityBatchResultEntry</code> </code> items.</p>
    pub fn get_successful(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::ChangeMessageVisibilityBatchResultEntry>> {
        &self.successful
    }
