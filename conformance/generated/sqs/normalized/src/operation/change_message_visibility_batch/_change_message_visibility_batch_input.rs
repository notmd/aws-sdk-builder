...
impl ChangeMessageVisibilityBatchInput {
    ...
    pub fn entries(&self) -> &[super::super::super::types::ChangeMessageVisibilityBatchRequestEntry] {
...
impl ChangeMessageVisibilityBatchInput {
    ...
    pub fn builder() -> super::super::super::operation::change_message_visibility_batch::builders::ChangeMessageVisibilityBatchInputBuilder {
        super::super::super::operation::change_message_visibility_batch::builders::ChangeMessageVisibilityBatchInputBuilder::default()
    }
}
...
pub struct ChangeMessageVisibilityBatchInputBuilder {
    ...
    pub(crate) entries: ::std::option::Option<::std::vec::Vec<super::super::super::types::ChangeMessageVisibilityBatchRequestEntry>>,
}
