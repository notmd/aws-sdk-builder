...
pub use super::super::super::operation::change_message_visibility_batch::_change_message_visibility_batch_input::ChangeMessageVisibilityBatchInputBuilder;

pub use super::super::super::operation::change_message_visibility_batch::_change_message_visibility_batch_output::ChangeMessageVisibilityBatchOutputBuilder;

impl super::super::super::operation::change_message_visibility_batch::builders::ChangeMessageVisibilityBatchInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::change_message_visibility_batch::ChangeMessageVisibilityBatchError,
...
pub struct ChangeMessageVisibilityBatchFluentBuilder {
    ...
    inner: super::super::super::operation::change_message_visibility_batch::builders::ChangeMessageVisibilityBatchInputBuilder,
...
impl ChangeMessageVisibilityBatchFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::change_message_visibility_batch::builders::ChangeMessageVisibilityBatchInputBuilder {
        &self.inner
    }
    ...
    pub fn entries(mut self, input: super::super::super::types::ChangeMessageVisibilityBatchRequestEntry) -> Self {
    ...
    /// <p>Lists the receipt handles of the messages for which the visibility timeout must be changed.</p>
    pub fn get_entries(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::ChangeMessageVisibilityBatchRequestEntry>> {
