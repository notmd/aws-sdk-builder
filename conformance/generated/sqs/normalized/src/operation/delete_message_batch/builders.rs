...
pub use super::super::super::operation::delete_message_batch::_delete_message_batch_input::DeleteMessageBatchInputBuilder;

pub use super::super::super::operation::delete_message_batch::_delete_message_batch_output::DeleteMessageBatchOutputBuilder;

impl super::super::super::operation::delete_message_batch::builders::DeleteMessageBatchInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_message_batch::DeleteMessageBatchError,
...
pub struct DeleteMessageBatchFluentBuilder {
    ...
    inner: super::super::super::operation::delete_message_batch::builders::DeleteMessageBatchInputBuilder,
...
impl DeleteMessageBatchFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_message_batch::builders::DeleteMessageBatchInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_message_batch::DeleteMessageBatch::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_message_batch::DeleteMessageBatch::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn entries(mut self, input: super::super::super::types::DeleteMessageBatchRequestEntry) -> Self {
        self.inner = self.inner.entries(input);
        self
    }
    /// <p>Lists the receipt handles for the messages to be deleted.</p>
    pub fn set_entries(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::DeleteMessageBatchRequestEntry>>) -> Self {
        self.inner = self.inner.set_entries(input);
        self
    }
    /// <p>Lists the receipt handles for the messages to be deleted.</p>
    pub fn get_entries(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::DeleteMessageBatchRequestEntry>> {
