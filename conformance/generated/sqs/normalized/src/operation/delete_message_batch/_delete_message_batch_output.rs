...
pub struct DeleteMessageBatchOutput {
    ...
    pub successful: ::std::vec::Vec<super::super::super::types::DeleteMessageBatchResultEntry>,
...
impl DeleteMessageBatchOutput {
    /// <p>A list of <code> <code>DeleteMessageBatchResultEntry</code> </code> items.</p>
    pub fn successful(&self) -> &[super::super::super::types::DeleteMessageBatchResultEntry] {
        use std::ops::Deref;
...
impl DeleteMessageBatchOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_message_batch::builders::DeleteMessageBatchOutputBuilder {
        super::super::super::operation::delete_message_batch::builders::DeleteMessageBatchOutputBuilder::default()
    }
}
...
pub struct DeleteMessageBatchOutputBuilder {
    pub(crate) successful: ::std::option::Option<::std::vec::Vec<super::super::super::types::DeleteMessageBatchResultEntry>>,
...
impl DeleteMessageBatchOutputBuilder {
    ...
    ///
    /// <p>A list of <code> <code>DeleteMessageBatchResultEntry</code> </code> items.</p>
    pub fn successful(mut self, input: super::super::super::types::DeleteMessageBatchResultEntry) -> Self {
    ...
    /// <p>A list of <code> <code>DeleteMessageBatchResultEntry</code> </code> items.</p>
    pub fn get_successful(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::DeleteMessageBatchResultEntry>> {
        &self.successful
    }
