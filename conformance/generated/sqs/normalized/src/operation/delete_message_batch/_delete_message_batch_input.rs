...
impl DeleteMessageBatchInput {
    ...
    pub fn entries(&self) -> &[super::super::super::types::DeleteMessageBatchRequestEntry] {
...
impl DeleteMessageBatchInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_message_batch::builders::DeleteMessageBatchInputBuilder {
        super::super::super::operation::delete_message_batch::builders::DeleteMessageBatchInputBuilder::default()
    }
}
...
pub struct DeleteMessageBatchInputBuilder {
    ...
    pub(crate) entries: ::std::option::Option<::std::vec::Vec<super::super::super::types::DeleteMessageBatchRequestEntry>>,
}
