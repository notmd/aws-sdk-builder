...
impl SendMessageInput {
    ...
    pub fn builder() -> super::super::super::operation::send_message::builders::SendMessageInputBuilder {
        super::super::super::operation::send_message::builders::SendMessageInputBuilder::default()
    }
}
