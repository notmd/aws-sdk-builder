...
impl SendMessageOutput {
    ...
    pub fn builder() -> super::super::super::operation::send_message::builders::SendMessageOutputBuilder {
        super::super::super::operation::send_message::builders::SendMessageOutputBuilder::default()
    }
}
...
impl SendMessageOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::send_message::SendMessageOutput {
