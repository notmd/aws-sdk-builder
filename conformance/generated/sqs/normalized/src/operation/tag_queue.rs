...
impl TagQueue {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::super::operation::tag_queue::TagQueueOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::tag_queue::TagQueueError,
    ...
    > {
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::tag_queue::TagQueueOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for TagQueueResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_tag_queue::de_tag_queue_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_tag_queue::de_tag_queue_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for TagQueueRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::tag_queue::TagQueueInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::tag_queue::TagQueueError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::tag_queue::_tag_queue_input::TagQueueInput;

pub use super::super::operation::tag_queue::_tag_queue_output::TagQueueOutput;
