...
impl SetQueueAttributesOutput {
    ...
    pub fn builder() -> super::super::super::operation::set_queue_attributes::builders::SetQueueAttributesOutputBuilder {
        super::super::super::operation::set_queue_attributes::builders::SetQueueAttributesOutputBuilder::default()
    }
}
...
impl SetQueueAttributesOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::set_queue_attributes::SetQueueAttributesOutput {
