...
impl SetQueueAttributesInput {
    ...
    pub fn builder() -> super::super::super::operation::set_queue_attributes::builders::SetQueueAttributesInputBuilder {
        super::super::super::operation::set_queue_attributes::builders::SetQueueAttributesInputBuilder::default()
    }
}
