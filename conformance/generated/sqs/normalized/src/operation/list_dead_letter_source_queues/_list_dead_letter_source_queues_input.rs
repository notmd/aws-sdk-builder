...
impl ListDeadLetterSourceQueuesInput {
    ...
    pub fn builder() -> super::super::super::operation::list_dead_letter_source_queues::builders::ListDeadLetterSourceQueuesInputBuilder {
        super::super::super::operation::list_dead_letter_source_queues::builders::ListDeadLetterSourceQueuesInputBuilder::default()
    }
}
