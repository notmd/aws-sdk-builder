...
impl ListDeadLetterSourceQueuesOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_dead_letter_source_queues::builders::ListDeadLetterSourceQueuesOutputBuilder {
        super::super::super::operation::list_dead_letter_source_queues::builders::ListDeadLetterSourceQueuesOutputBuilder::default()
    }
}
