...
impl DeleteQueueInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_queue::builders::DeleteQueueInputBuilder {
        super::super::super::operation::delete_queue::builders::DeleteQueueInputBuilder::default()
    }
}
