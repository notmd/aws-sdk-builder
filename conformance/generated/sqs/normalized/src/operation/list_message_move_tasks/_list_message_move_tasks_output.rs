...
impl ListMessageMoveTasksOutput {
    ...
    pub fn results(&self) -> &[super::super::super::types::ListMessageMoveTasksResultEntry] {
...
impl ListMessageMoveTasksOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_message_move_tasks::builders::ListMessageMoveTasksOutputBuilder {
        super::super::super::operation::list_message_move_tasks::builders::ListMessageMoveTasksOutputBuilder::default()
    }
}
...
pub struct ListMessageMoveTasksOutputBuilder {
    pub(crate) results: ::std::option::Option<::std::vec::Vec<super::super::super::types::ListMessageMoveTasksResultEntry>>,
    _request_id: Option<String>,
}
impl ListMessageMoveTasksOutputBuilder {
    ...
    ///
    /// <p>A list of message movement tasks and their attributes.</p>
    pub fn results(mut self, input: super::super::super::types::ListMessageMoveTasksResultEntry) -> Self {
    ...
    /// <p>A list of message movement tasks and their attributes.</p>
    pub fn set_results(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::ListMessageMoveTasksResultEntry>>) -> Self {
        self.results = input;
        self
    }
    /// <p>A list of message movement tasks and their attributes.</p>
    pub fn get_results(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::ListMessageMoveTasksResultEntry>> {
        &self.results
    }
    ...
    pub fn build(self) -> super::super::super::operation::list_message_move_tasks::ListMessageMoveTasksOutput {
