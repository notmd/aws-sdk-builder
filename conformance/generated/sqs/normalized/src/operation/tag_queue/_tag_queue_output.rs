...
impl TagQueueOutput {
    ...
    pub fn builder() -> super::super::super::operation::tag_queue::builders::TagQueueOutputBuilder {
        super::super::super::operation::tag_queue::builders::TagQueueOutputBuilder::default()
    }
}
...
impl TagQueueOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::tag_queue::TagQueueOutput {
