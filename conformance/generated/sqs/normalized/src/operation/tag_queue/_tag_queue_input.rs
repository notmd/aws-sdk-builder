...
impl TagQueueInput {
    ...
    pub fn builder() -> super::super::super::operation::tag_queue::builders::TagQueueInputBuilder {
        super::super::super::operation::tag_queue::builders::TagQueueInputBuilder::default()
    }
}
