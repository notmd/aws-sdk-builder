...
impl GetQueueUrlOutput {
    ...
    pub fn builder() -> super::super::super::operation::get_queue_url::builders::GetQueueUrlOutputBuilder {
        super::super::super::operation::get_queue_url::builders::GetQueueUrlOutputBuilder::default()
    }
}
...
impl GetQueueUrlOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::get_queue_url::GetQueueUrlOutput {
