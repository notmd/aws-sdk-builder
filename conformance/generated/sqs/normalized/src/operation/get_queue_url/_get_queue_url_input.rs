...
impl GetQueueUrlInput {
    ...
    pub fn builder() -> super::super::super::operation::get_queue_url::builders::GetQueueUrlInputBuilder {
        super::super::super::operation::get_queue_url::builders::GetQueueUrlInputBuilder::default()
    }
}
