...
pub use super::super::super::operation::delete_message::_delete_message_input::DeleteMessageInputBuilder;

pub use super::super::super::operation::delete_message::_delete_message_output::DeleteMessageOutputBuilder;

impl super::super::super::operation::delete_message::builders::DeleteMessageInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::delete_message::DeleteMessageOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::delete_message::DeleteMessageError,
...
pub struct DeleteMessageFluentBuilder {
    ...
    inner: super::super::super::operation::delete_message::builders::DeleteMessageInputBuilder,
...
impl DeleteMessageFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::delete_message::builders::DeleteMessageInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::delete_message::DeleteMessage::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::delete_message::DeleteMessage::orchestrate(&runtime_plugins, input).await
    }
