...
impl DeleteMessageOutput {
    ...
    pub fn builder() -> super::super::super::operation::delete_message::builders::DeleteMessageOutputBuilder {
        super::super::super::operation::delete_message::builders::DeleteMessageOutputBuilder::default()
    }
}
...
impl DeleteMessageOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::delete_message::DeleteMessageOutput {
