...
impl DeleteMessageInput {
    ...
    pub fn builder() -> super::super::super::operation::delete_message::builders::DeleteMessageInputBuilder {
        super::super::super::operation::delete_message::builders::DeleteMessageInputBuilder::default()
    }
}
...
impl DeleteMessageInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::super::operation::delete_message::DeleteMessageInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::super::super::operation::delete_message::DeleteMessageInput {
