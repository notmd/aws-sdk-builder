...
impl DeleteQueue {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::delete_queue::DeleteQueueInput,
    ) -> ::std::result::Result<
        super::super::operation::delete_queue::DeleteQueueOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::delete_queue::DeleteQueueError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::delete_queue::DeleteQueueError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::delete_queue::DeleteQueueOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SQS", "DeleteQueue", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteQueueResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_delete_queue::de_delete_queue_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_delete_queue::de_delete_queue_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteQueueRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::delete_queue::DeleteQueueInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::delete_queue::DeleteQueueInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::delete_queue::DeleteQueueError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::delete_queue::_delete_queue_input::DeleteQueueInput;

pub use super::super::operation::delete_queue::_delete_queue_output::DeleteQueueOutput;
