...
pub struct SendMessageBatchOutput {
    ...
    pub successful: ::std::vec::Vec<super::super::super::types::SendMessageBatchResultEntry>,
    ...
    pub failed: ::std::vec::Vec<super::super::super::types::BatchResultErrorEntry>,
    _request_id: Option<String>,
}
impl SendMessageBatchOutput {
    /// <p>A list of <code> <code>SendMessageBatchResultEntry</code> </code> items.</p>
    pub fn successful(&self) -> &[super::super::super::types::SendMessageBatchResultEntry] {
        use std::ops::Deref;
...
impl SendMessageBatchOutput {
    ...
    pub fn builder() -> super::super::super::operation::send_message_batch::builders::SendMessageBatchOutputBuilder {
        super::super::super::operation::send_message_batch::builders::SendMessageBatchOutputBuilder::default()
    }
}
...
pub struct SendMessageBatchOutputBuilder {
    pub(crate) successful: ::std::option::Option<::std::vec::Vec<super::super::super::types::SendMessageBatchResultEntry>>,
...
impl SendMessageBatchOutputBuilder {
    ...
    ///
    /// <p>A list of <code> <code>SendMessageBatchResultEntry</code> </code> items.</p>
    pub fn successful(mut self, input: super::super::super::types::SendMessageBatchResultEntry) -> Self {
    ...
    /// <p>A list of <code> <code>SendMessageBatchResultEntry</code> </code> items.</p>
    pub fn set_successful(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::SendMessageBatchResultEntry>>) -> Self {
        self.successful = input;
        self
    }
    /// <p>A list of <code> <code>SendMessageBatchResultEntry</code> </code> items.</p>
    pub fn get_successful(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::SendMessageBatchResultEntry>> {
        &self.successful
    }
