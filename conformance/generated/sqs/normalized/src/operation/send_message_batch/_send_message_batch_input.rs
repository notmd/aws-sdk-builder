...
impl SendMessageBatchInput {
    ...
    pub fn entries(&self) -> &[super::super::super::types::SendMessageBatchRequestEntry] {
...
impl SendMessageBatchInput {
    ...
    pub fn builder() -> super::super::super::operation::send_message_batch::builders::SendMessageBatchInputBuilder {
        super::super::super::operation::send_message_batch::builders::SendMessageBatchInputBuilder::default()
    }
}
...
pub struct SendMessageBatchInputBuilder {
    ...
    pub(crate) entries: ::std::option::Option<::std::vec::Vec<super::super::super::types::SendMessageBatchRequestEntry>>,
}
