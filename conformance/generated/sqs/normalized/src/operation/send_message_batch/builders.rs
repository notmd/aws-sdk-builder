...
pub use super::super::super::operation::send_message_batch::_send_message_batch_input::SendMessageBatchInputBuilder;

pub use super::super::super::operation::send_message_batch::_send_message_batch_output::SendMessageBatchOutputBuilder;

impl super::super::super::operation::send_message_batch::builders::SendMessageBatchInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::send_message_batch::SendMessageBatchError,
...
pub struct SendMessageBatchFluentBuilder {
    ...
    inner: super::super::super::operation::send_message_batch::builders::SendMessageBatchInputBuilder,
...
impl SendMessageBatchFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::send_message_batch::builders::SendMessageBatchInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::send_message_batch::SendMessageBatch::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::send_message_batch::SendMessageBatch::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub fn entries(mut self, input: super::super::super::types::SendMessageBatchRequestEntry) -> Self {
        self.inner = self.inner.entries(input);
        self
    }
    /// <p>A list of <code> <code>SendMessageBatchRequestEntry</code> </code> items.</p>
    pub fn set_entries(mut self, input: ::std::option::Option<::std::vec::Vec<super::super::super::types::SendMessageBatchRequestEntry>>) -> Self {
        self.inner = self.inner.set_entries(input);
        self
    }
    /// <p>A list of <code> <code>SendMessageBatchRequestEntry</code> </code> items.</p>
    pub fn get_entries(&self) -> &::std::option::Option<::std::vec::Vec<super::super::super::types::SendMessageBatchRequestEntry>> {
