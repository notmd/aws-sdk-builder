...
impl DeleteMessage {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::super::operation::delete_message::DeleteMessageOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::delete_message::DeleteMessageError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::delete_message::DeleteMessageError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::delete_message::DeleteMessageOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteMessageResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_delete_message::de_delete_message_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_delete_message::de_delete_message_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteMessageRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::delete_message::DeleteMessageInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::delete_message::DeleteMessageInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::delete_message::DeleteMessageError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::delete_message::_delete_message_input::DeleteMessageInput;

pub use super::super::operation::delete_message::_delete_message_output::DeleteMessageOutput;
