...
impl ReceiveMessageOutput {
    ...
    pub fn builder() -> super::super::super::operation::receive_message::builders::ReceiveMessageOutputBuilder {
        super::super::super::operation::receive_message::builders::ReceiveMessageOutputBuilder::default()
    }
}
...
impl ReceiveMessageOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::receive_message::ReceiveMessageOutput {
