...
impl ReceiveMessageInput {
    ...
    pub fn message_system_attribute_names(&self) -> &[super::super::super::types::MessageSystemAttributeName] {
...
impl ReceiveMessageInput {
    ...
    pub fn builder() -> super::super::super::operation::receive_message::builders::ReceiveMessageInputBuilder {
        super::super::super::operation::receive_message::builders::ReceiveMessageInputBuilder::default()
    }
}
...
pub struct ReceiveMessageInputBuilder {
    ...
    pub(crate) attribute_names: ::std::option::Option<::std::vec::Vec<super::super::super::types::QueueAttributeName>>,
    pub(crate) message_system_attribute_names: ::std::option::Option<::std::vec::Vec<super::super::super::types::MessageSystemAttributeName>>,
