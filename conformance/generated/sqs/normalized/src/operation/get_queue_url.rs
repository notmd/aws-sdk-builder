...
impl GetQueueUrl {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::super::operation::get_queue_url::GetQueueUrlInput,
    ) -> ::std::result::Result<
        super::super::operation::get_queue_url::GetQueueUrlOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::get_queue_url::GetQueueUrlError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::get_queue_url::GetQueueUrlError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::get_queue_url::GetQueueUrlOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SQS", "GetQueueUrl", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetQueueUrl {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetQueueUrlResponseDeserializer,
        ));
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetQueueUrl")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetQueueUrlResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_get_queue_url::de_get_queue_url_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_get_queue_url::de_get_queue_url_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetQueueUrlRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::get_queue_url::GetQueueUrlInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::get_queue_url::GetQueueUrlInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::get_queue_url::GetQueueUrlError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::get_queue_url::_get_queue_url_input::GetQueueUrlInput;

pub use super::super::operation::get_queue_url::_get_queue_url_output::GetQueueUrlOutput;
