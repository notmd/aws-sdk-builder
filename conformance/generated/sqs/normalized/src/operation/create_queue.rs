...
impl CreateQueue {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::super::operation::create_queue::CreateQueueOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::operation::create_queue::CreateQueueError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::create_queue::CreateQueueError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::create_queue::CreateQueueOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateQueueResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_create_queue::de_create_queue_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_create_queue::de_create_queue_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateQueueRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::create_queue::CreateQueueInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::create_queue::CreateQueueInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::create_queue::CreateQueueError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::create_queue::_create_queue_input::CreateQueueInput;

pub use super::super::operation::create_queue::_create_queue_output::CreateQueueOutput;
