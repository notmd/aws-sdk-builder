...
impl ChangeMessageVisibilityInput {
    ...
    pub fn builder() -> super::super::super::operation::change_message_visibility::builders::ChangeMessageVisibilityInputBuilder {
        super::super::super::operation::change_message_visibility::builders::ChangeMessageVisibilityInputBuilder::default()
    }
}
...
impl ChangeMessageVisibilityInputBuilder {
    ...
    pub fn build(
        ...
        super::super::super::operation::change_message_visibility::ChangeMessageVisibilityInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::super::super::operation::change_message_visibility::ChangeMessageVisibilityInput {
