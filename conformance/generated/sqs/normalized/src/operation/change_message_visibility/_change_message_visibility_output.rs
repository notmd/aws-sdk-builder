...
impl ChangeMessageVisibilityOutput {
    ...
    pub fn builder() -> super::super::super::operation::change_message_visibility::builders::ChangeMessageVisibilityOutputBuilder {
        super::super::super::operation::change_message_visibility::builders::ChangeMessageVisibilityOutputBuilder::default()
    }
}
...
impl ChangeMessageVisibilityOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::change_message_visibility::ChangeMessageVisibilityOutput {
