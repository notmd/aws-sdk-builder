...
impl ListQueuesInput {
    ...
    pub fn builder() -> super::super::super::operation::list_queues::builders::ListQueuesInputBuilder {
        super::super::super::operation::list_queues::builders::ListQueuesInputBuilder::default()
    }
}
