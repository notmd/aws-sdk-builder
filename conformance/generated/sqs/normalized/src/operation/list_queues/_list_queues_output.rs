...
impl ListQueuesOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_queues::builders::ListQueuesOutputBuilder {
        super::super::super::operation::list_queues::builders::ListQueuesOutputBuilder::default()
    }
}
...
impl ListQueuesOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::list_queues::ListQueuesOutput {
