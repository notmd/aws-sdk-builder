...
impl GetQueueAttributesInput {
    ...
    pub fn builder() -> super::super::super::operation::get_queue_attributes::builders::GetQueueAttributesInputBuilder {
        super::super::super::operation::get_queue_attributes::builders::GetQueueAttributesInputBuilder::default()
    }
}
