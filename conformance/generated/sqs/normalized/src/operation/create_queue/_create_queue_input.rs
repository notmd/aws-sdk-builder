...
pub struct CreateQueueInput {
    ...
    pub attributes: ::std::option::Option<::std::collections::HashMap<super::super::super::types::QueueAttributeName, ::std::string::String>>,
...
impl CreateQueueInput {
    ...
    pub fn builder() -> super::super::super::operation::create_queue::builders::CreateQueueInputBuilder {
        super::super::super::operation::create_queue::builders::CreateQueueInputBuilder::default()
    }
}
...
pub struct CreateQueueInputBuilder {
    ...
    pub(crate) attributes: ::std::option::Option<::std::collections::HashMap<super::super::super::types::QueueAttributeName, ::std::string::String>>,
