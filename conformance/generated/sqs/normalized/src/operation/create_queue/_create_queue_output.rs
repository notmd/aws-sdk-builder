...
impl CreateQueueOutput {
    ...
    pub fn builder() -> super::super::super::operation::create_queue::builders::CreateQueueOutputBuilder {
        super::super::super::operation::create_queue::builders::CreateQueueOutputBuilder::default()
    }
}
...
impl CreateQueueOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::create_queue::CreateQueueOutput {
