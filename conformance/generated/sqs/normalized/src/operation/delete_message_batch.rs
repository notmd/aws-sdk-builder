...
impl DeleteMessageBatch {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::delete_message_batch::DeleteMessageBatchError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::delete_message_batch::DeleteMessageBatchOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SQS", "DeleteMessageBatch", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteMessageBatchResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_delete_message_batch::de_delete_message_batch_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_delete_message_batch::de_delete_message_batch_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteMessageBatchRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::delete_message_batch::DeleteMessageBatchInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::delete_message_batch::DeleteMessageBatchInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::delete_message_batch::DeleteMessageBatchError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::delete_message_batch::_delete_message_batch_input::DeleteMessageBatchInput;

pub use super::super::operation::delete_message_batch::_delete_message_batch_output::DeleteMessageBatchOutput;
