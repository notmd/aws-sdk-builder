...
pub use super::super::super::operation::untag_queue::_untag_queue_input::UntagQueueInputBuilder;

pub use super::super::super::operation::untag_queue::_untag_queue_output::UntagQueueOutputBuilder;

impl super::super::super::operation::untag_queue::builders::UntagQueueInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::untag_queue::UntagQueueOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::untag_queue::UntagQueueError,
...
pub struct UntagQueueFluentBuilder {
    ...
    inner: super::super::super::operation::untag_queue::builders::UntagQueueInputBuilder,
...
impl UntagQueueFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::untag_queue::builders::UntagQueueInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::untag_queue::UntagQueue::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::untag_queue::UntagQueue::orchestrate(&runtime_plugins, input).await
    }
