...
impl UntagQueueInput {
    ...
    pub fn builder() -> super::super::super::operation::untag_queue::builders::UntagQueueInputBuilder {
        super::super::super::operation::untag_queue::builders::UntagQueueInputBuilder::default()
    }
}
