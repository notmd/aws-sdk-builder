...
impl CancelMessageMoveTaskOutput {
    ...
    pub fn builder() -> super::super::super::operation::cancel_message_move_task::builders::CancelMessageMoveTaskOutputBuilder {
        super::super::super::operation::cancel_message_move_task::builders::CancelMessageMoveTaskOutputBuilder::default()
    }
}
...
impl CancelMessageMoveTaskOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::cancel_message_move_task::CancelMessageMoveTaskOutput {
