...
impl CancelMessageMoveTaskInput {
    ...
    pub fn builder() -> super::super::super::operation::cancel_message_move_task::builders::CancelMessageMoveTaskInputBuilder {
        super::super::super::operation::cancel_message_move_task::builders::CancelMessageMoveTaskInputBuilder::default()
    }
}
