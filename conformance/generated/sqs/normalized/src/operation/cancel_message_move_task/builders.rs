...
pub use super::super::super::operation::cancel_message_move_task::_cancel_message_move_task_input::CancelMessageMoveTaskInputBuilder;

pub use super::super::super::operation::cancel_message_move_task::_cancel_message_move_task_output::CancelMessageMoveTaskOutputBuilder;

impl super::super::super::operation::cancel_message_move_task::builders::CancelMessageMoveTaskInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::super::super::Client,
    ) -> ::std::result::Result<
        super::super::super::operation::cancel_message_move_task::CancelMessageMoveTaskOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::super::super::operation::cancel_message_move_task::CancelMessageMoveTaskError,
...
pub struct CancelMessageMoveTaskFluentBuilder {
    ...
    inner: super::super::super::operation::cancel_message_move_task::builders::CancelMessageMoveTaskInputBuilder,
...
impl CancelMessageMoveTaskFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::super::super::operation::cancel_message_move_task::builders::CancelMessageMoveTaskInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::super::super::operation::cancel_message_move_task::CancelMessageMoveTask::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::super::super::operation::cancel_message_move_task::CancelMessageMoveTask::orchestrate(&runtime_plugins, input).await
    }
