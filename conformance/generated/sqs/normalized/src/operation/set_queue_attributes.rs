...
impl SetQueueAttributes {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::set_queue_attributes::SetQueueAttributesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::set_queue_attributes::SetQueueAttributesOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SQS", "SetQueueAttributes", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetQueueAttributesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_set_queue_attributes::de_set_queue_attributes_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_set_queue_attributes::de_set_queue_attributes_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetQueueAttributesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::set_queue_attributes::SetQueueAttributesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::set_queue_attributes::SetQueueAttributesInput,
...
impl ::aws_types::request_id::RequestId for super::super::operation::set_queue_attributes::SetQueueAttributesError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::set_queue_attributes::_set_queue_attributes_input::SetQueueAttributesInput;

pub use super::super::operation::set_queue_attributes::_set_queue_attributes_output::SetQueueAttributesOutput;
