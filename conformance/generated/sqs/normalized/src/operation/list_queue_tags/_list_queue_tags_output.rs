...
impl ListQueueTagsOutput {
    ...
    pub fn builder() -> super::super::super::operation::list_queue_tags::builders::ListQueueTagsOutputBuilder {
        super::super::super::operation::list_queue_tags::builders::ListQueueTagsOutputBuilder::default()
    }
}
...
impl ListQueueTagsOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::list_queue_tags::ListQueueTagsOutput {
