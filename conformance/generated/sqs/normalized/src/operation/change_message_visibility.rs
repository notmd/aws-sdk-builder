...
impl ChangeMessageVisibility {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::super::operation::change_message_visibility::ChangeMessageVisibilityError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::super::operation::change_message_visibility::ChangeMessageVisibilityOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SQS", "ChangeMessageVisibility", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ChangeMessageVisibilityTelemetryInputCaptureInterceptor {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ChangeMessageVisibilityResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::super::protocol_serde::shape_change_message_visibility::de_change_message_visibility_http_error(status, headers, body)
        } else {
            super::super::protocol_serde::shape_change_message_visibility::de_change_message_visibility_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ChangeMessageVisibilityRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::super::operation::change_message_visibility::ChangeMessageVisibilityInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::super::operation::change_message_visibility::ChangeMessageVisibilityInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::super::protocol_serde::shape_change_message_visibility::ser_change_message_visibility_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::super::operation::change_message_visibility::ChangeMessageVisibilityError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::super::operation::change_message_visibility::_change_message_visibility_input::ChangeMessageVisibilityInput;

pub use super::super::operation::change_message_visibility::_change_message_visibility_output::ChangeMessageVisibilityOutput;
