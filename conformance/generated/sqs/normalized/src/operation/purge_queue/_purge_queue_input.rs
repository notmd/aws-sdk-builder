...
impl PurgeQueueInput {
    ...
    pub fn builder() -> super::super::super::operation::purge_queue::builders::PurgeQueueInputBuilder {
        super::super::super::operation::purge_queue::builders::PurgeQueueInputBuilder::default()
    }
}
