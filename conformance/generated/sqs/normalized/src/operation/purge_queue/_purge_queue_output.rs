...
impl PurgeQueueOutput {
    ...
    pub fn builder() -> super::super::super::operation::purge_queue::builders::PurgeQueueOutputBuilder {
        super::super::super::operation::purge_queue::builders::PurgeQueueOutputBuilder::default()
    }
}
...
impl PurgeQueueOutputBuilder {
    ...
    pub fn build(self) -> super::super::super::operation::purge_queue::PurgeQueueOutput {
