...
pub fn de_send_message_batch_http_error(
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::send_message_batch::SendMessageBatchError::unhandled(generic)),
    };
    ...
    Err(match error_code {
        ...
        "BatchRequestTooLong" => super::super::operation::send_message_batch::SendMessageBatchError::BatchRequestTooLong({
            ...
            let mut tmp = {
                #[allow(unused_mut)]
                let mut output = super::super::types::error::builders::BatchRequestTooLongBuilder::default();
                output = super::super::protocol_serde::shape_batch_request_too_long::de_batch_request_too_long_json_err(_response_body, output)
                    .map_err(super::super::operation::send_message_batch::SendMessageBatchError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
        ...
        "InvalidAddress" => super::super::operation::send_message_batch::SendMessageBatchError::InvalidAddress({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidSecurity" => super::super::operation::send_message_batch::SendMessageBatchError::InvalidSecurity({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "RequestThrottled" => super::super::operation::send_message_batch::SendMessageBatchError::RequestThrottled({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_send_message_batch_http_response(
    ...
    Ok({
        ...
        output = super::super::protocol_serde::shape_send_message_batch::de_send_message_batch(_response_body, output)
            .map_err(super::super::operation::send_message_batch::SendMessageBatchError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::super::serde_util::send_message_batch_output_output_correct_errors(output)
            .build()
            .map_err(super::super::operation::send_message_batch::SendMessageBatchError::unhandled)?
    })
}
...
pub fn ser_send_message_batch_input(
    input: &super::super::operation::send_message_batch::SendMessageBatchInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    super::super::protocol_serde::shape_send_message_batch_input::ser_send_message_batch_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_send_message_batch(
    _value: &[u8],
    mut builder: super::super::operation::send_message_batch::builders::SendMessageBatchOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::send_message_batch::builders::SendMessageBatchOutputBuilder,
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "Successful" => {
                    builder = builder.set_successful(
                        super::super::protocol_serde::shape_send_message_batch_result_entry_list::de_send_message_batch_result_entry_list(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
