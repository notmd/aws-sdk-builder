        ...
        for (key_6, value_7) in var_4 {
            {
                ...
                super::super::protocol_serde::shape_message_attribute_value::ser_message_attribute_value(&mut object_8, value_7)?;
                object_8.finish();
            }
        }
        object_5.finish();
        ...
        for (key_11, value_12) in var_9 {
            {
                ...
                super::super::protocol_serde::shape_message_system_attribute_value::ser_message_system_attribute_value(&mut object_13, value_12)?;
                object_13.finish();
            }
        }
        object_10.finish();
