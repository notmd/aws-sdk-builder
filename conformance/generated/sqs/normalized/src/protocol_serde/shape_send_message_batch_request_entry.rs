...
pub fn ser_send_message_batch_request_entry(
    ...
    input: &super::super::types::SendMessageBatchRequestEntry,
        ...
        for (key_4, value_5) in var_2 {
            {
                ...
                super::super::protocol_serde::shape_message_attribute_value::ser_message_attribute_value(&mut object_6, value_5)?;
                object_6.finish();
            }
        }
        object_3.finish();
        ...
        for (key_9, value_10) in var_7 {
            {
                ...
                super::super::protocol_serde::shape_message_system_attribute_value::ser_message_system_attribute_value(&mut object_11, value_10)?;
                object_11.finish();
            }
        }
        object_8.finish();
