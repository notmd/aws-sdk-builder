...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::super::operation::change_message_visibility_batch::ChangeMessageVisibilityBatchError::unhandled(generic)),
    };
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::super::operation::change_message_visibility_batch::builders::ChangeMessageVisibilityBatchOutputBuilder::default();
        output = super::super::protocol_serde::shape_change_message_visibility_batch::de_change_message_visibility_batch(_response_body, output)
            .map_err(super::super::operation::change_message_visibility_batch::ChangeMessageVisibilityBatchError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::super::serde_util::change_message_visibility_batch_output_output_correct_errors(output)
            .build()
            .map_err(super::super::operation::change_message_visibility_batch::ChangeMessageVisibilityBatchError::unhandled)?
    })
}
...
pub fn ser_change_message_visibility_batch_input(
    ...
    super::super::protocol_serde::shape_change_message_visibility_batch_input::ser_change_message_visibility_batch_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_change_message_visibility_batch(
    _value: &[u8],
    mut builder: super::super::operation::change_message_visibility_batch::builders::ChangeMessageVisibilityBatchOutputBuilder,
) -> ::std::result::Result<
    super::super::operation::change_message_visibility_batch::builders::ChangeMessageVisibilityBatchOutputBuilder,
