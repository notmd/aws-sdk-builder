...
impl DeleteMessageBatchRequestEntry {
    ...
    pub fn builder() -> super::super::types::builders::DeleteMessageBatchRequestEntryBuilder {
        super::super::types::builders::DeleteMessageBatchRequestEntryBuilder::default()
    }
}
