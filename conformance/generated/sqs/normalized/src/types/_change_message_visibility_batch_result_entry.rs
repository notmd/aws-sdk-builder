...
impl ChangeMessageVisibilityBatchResultEntry {
    ...
    pub fn builder() -> super::super::types::builders::ChangeMessageVisibilityBatchResultEntryBuilder {
        super::super::types::builders::ChangeMessageVisibilityBatchResultEntryBuilder::default()
    }
}
...
impl ChangeMessageVisibilityBatchResultEntryBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::super::types::ChangeMessageVisibilityBatchResultEntry, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::ChangeMessageVisibilityBatchResultEntry {
