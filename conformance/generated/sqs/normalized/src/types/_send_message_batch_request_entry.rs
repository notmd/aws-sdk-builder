...
impl SendMessageBatchRequestEntry {
    ...
    pub fn builder() -> super::super::types::builders::SendMessageBatchRequestEntryBuilder {
        super::super::types::builders::SendMessageBatchRequestEntryBuilder::default()
    }
}
...
impl SendMessageBatchRequestEntryBuilder {
    ...
    pub fn message_system_attributes(
        mut self,
        k: super::super::types::MessageSystemAttributeNameForSends,
        v: super::super::types::MessageSystemAttributeValue,
    ) -> Self {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::SendMessageBatchRequestEntry, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::SendMessageBatchRequestEntry {
