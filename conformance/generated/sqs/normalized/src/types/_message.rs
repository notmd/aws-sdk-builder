...
pub struct Message {
    ...
    pub attributes: ::std::option::Option<::std::collections::HashMap<super::super::types::MessageSystemAttributeName, ::std::string::String>>,
    ...
    pub message_attributes: ::std::option::Option<::std::collections::HashMap<::std::string::String, super::super::types::MessageAttributeValue>>,
}
impl Message {
    /// <p>A unique identifier for the message. A <code>MessageId</code>is considered unique across all Amazon Web Services accounts for an extended period of time.</p>
...
impl MessageBuilder {
    ...
    /// </ul>
    /// <p><code>ApproximateFirstReceiveTimestamp</code> and <code>SentTimestamp</code> are each returned as an integer representing the <a href="http://en.wikipedia.org/wiki/Unix_time">epoch time</a> in milliseconds.</p>
    pub fn attributes(mut self, k: super::super::types::MessageSystemAttributeName, v: impl ::std::convert::Into<::std::string::String>) -> Self {
    ...
    pub fn set_attributes(
        mut self,
        input: ::std::option::Option<::std::collections::HashMap<super::super::types::MessageSystemAttributeName, ::std::string::String>>,
    ) -> Self {
    ...
    ///
    /// <p>Each message attribute consists of a <code>Name</code>, <code>Type</code>, and <code>Value</code>. For more information, see <a href="https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-message-metadata.html#sqs-message-attributes">Amazon SQS message attributes</a> in the <i>Amazon SQS Developer Guide</i>.</p>
    pub fn message_attributes(mut self, k: impl ::std::convert::Into<::std::string::String>, v: super::super::types::MessageAttributeValue) -> Self {
    ...
    pub fn set_message_attributes(
        mut self,
        input: ::std::option::Option<::std::collections::HashMap<::std::string::String, super::super::types::MessageAttributeValue>>,
    ) -> Self {
