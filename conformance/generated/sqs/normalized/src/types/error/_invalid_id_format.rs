...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::InvalidIdFormat {
...
impl InvalidIdFormat {
    ...
    pub fn builder() -> super::super::super::types::error::builders::InvalidIdFormatBuilder {
        super::super::super::types::error::builders::InvalidIdFormatBuilder::default()
    }
}
...
impl InvalidIdFormatBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::InvalidIdFormat {
        super::super::super::types::error::InvalidIdFormat {
