...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::TooManyEntriesInBatchRequest {
...
impl TooManyEntriesInBatchRequest {
    ...
    pub fn builder() -> super::super::super::types::error::builders::TooManyEntriesInBatchRequestBuilder {
        super::super::super::types::error::builders::TooManyEntriesInBatchRequestBuilder::default()
    }
}
...
impl TooManyEntriesInBatchRequestBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::TooManyEntriesInBatchRequest {
        super::super::super::types::error::TooManyEntriesInBatchRequest {
