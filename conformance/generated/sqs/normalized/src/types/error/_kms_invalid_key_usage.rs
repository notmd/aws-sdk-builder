...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::KmsInvalidKeyUsage {
...
impl KmsInvalidKeyUsage {
    ...
    pub fn builder() -> super::super::super::types::error::builders::KmsInvalidKeyUsageBuilder {
        super::super::super::types::error::builders::KmsInvalidKeyUsageBuilder::default()
    }
}
...
impl KmsInvalidKeyUsageBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::KmsInvalidKeyUsage {
        super::super::super::types::error::KmsInvalidKeyUsage {
