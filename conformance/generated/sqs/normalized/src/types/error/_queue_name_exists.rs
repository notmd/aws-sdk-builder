...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::QueueNameExists {
...
impl QueueNameExists {
    ...
    pub fn builder() -> super::super::super::types::error::builders::QueueNameExistsBuilder {
        super::super::super::types::error::builders::QueueNameExistsBuilder::default()
    }
}
...
impl QueueNameExistsBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::QueueNameExists {
        super::super::super::types::error::QueueNameExists {
