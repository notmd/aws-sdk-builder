...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::KmsOptInRequired {
...
impl KmsOptInRequired {
    ...
    pub fn builder() -> super::super::super::types::error::builders::KmsOptInRequiredBuilder {
        super::super::super::types::error::builders::KmsOptInRequiredBuilder::default()
    }
}
...
impl KmsOptInRequiredBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::KmsOptInRequired {
        super::super::super::types::error::KmsOptInRequired {
