...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::InvalidSecurity {
...
impl InvalidSecurity {
    ...
    pub fn builder() -> super::super::super::types::error::builders::InvalidSecurityBuilder {
        super::super::super::types::error::builders::InvalidSecurityBuilder::default()
    }
}
...
impl InvalidSecurityBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::InvalidSecurity {
        super::super::super::types::error::InvalidSecurity {
