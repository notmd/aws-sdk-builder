...
impl ::aws_types::request_id::RequestId for super::super::super::types::error::KmsNotFound {
...
impl KmsNotFound {
    ...
    pub fn builder() -> super::super::super::types::error::builders::KmsNotFoundBuilder {
        super::super::super::types::error::builders::KmsNotFoundBuilder::default()
    }
}
...
impl KmsNotFoundBuilder {
    ...
    pub fn build(self) -> super::super::super::types::error::KmsNotFound {
        super::super::super::types::error::KmsNotFound {
