...
impl MessageSystemAttributeValue {
    ...
    pub fn builder() -> super::super::types::builders::MessageSystemAttributeValueBuilder {
        super::super::types::builders::MessageSystemAttributeValueBuilder::default()
    }
}
...
impl MessageSystemAttributeValueBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::MessageSystemAttributeValue, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::MessageSystemAttributeValue {
