...
impl MessageAttributeValue {
    ...
    pub fn builder() -> super::super::types::builders::MessageAttributeValueBuilder {
        super::super::types::builders::MessageAttributeValueBuilder::default()
    }
}
...
impl MessageAttributeValueBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::MessageAttributeValue, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::MessageAttributeValue {
