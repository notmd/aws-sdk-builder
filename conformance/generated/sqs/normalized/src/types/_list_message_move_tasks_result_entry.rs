...
impl ListMessageMoveTasksResultEntry {
    ...
    pub fn builder() -> super::super::types::builders::ListMessageMoveTasksResultEntryBuilder {
        super::super::types::builders::ListMessageMoveTasksResultEntryBuilder::default()
    }
}
...
impl ListMessageMoveTasksResultEntryBuilder {
    ...
    pub fn build(self) -> super::super::types::ListMessageMoveTasksResultEntry {
        super::super::types::ListMessageMoveTasksResultEntry {
