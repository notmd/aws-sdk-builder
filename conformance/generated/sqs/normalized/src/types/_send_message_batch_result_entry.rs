...
impl SendMessageBatchResultEntry {
    ...
    pub fn builder() -> super::super::types::builders::SendMessageBatchResultEntryBuilder {
        super::super::types::builders::SendMessageBatchResultEntryBuilder::default()
    }
}
...
impl SendMessageBatchResultEntryBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::super::types::SendMessageBatchResultEntry, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::super::types::SendMessageBatchResultEntry {
