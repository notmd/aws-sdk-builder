...
impl ChangeMessageVisibilityBatchRequestEntry {
    ...
    pub fn builder() -> super::types::builders::ChangeMessageVisibilityBatchRequestEntryBuilder {
        super::types::builders::ChangeMessageVisibilityBatchRequestEntryBuilder::default()
    }
}
...
impl ChangeMessageVisibilityBatchRequestEntryBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::types::ChangeMessageVisibilityBatchRequestEntry, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::ChangeMessageVisibilityBatchRequestEntry {
