...
impl DeleteMessageBatchResultEntry {
    ...
    pub fn builder() -> super::types::builders::DeleteMessageBatchResultEntryBuilder {
        super::types::builders::DeleteMessageBatchResultEntryBuilder::default()
    }
}
...
impl DeleteMessageBatchResultEntryBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::DeleteMessageBatchResultEntry, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::DeleteMessageBatchResultEntry {
