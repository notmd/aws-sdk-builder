...
impl ::aws_types::request_id::RequestId for super::types::error::KmsInvalidKeyUsage {
...
impl KmsInvalidKeyUsage {
    ...
    pub fn builder() -> super::types::error::builders::KmsInvalidKeyUsageBuilder {
        super::types::error::builders::KmsInvalidKeyUsageBuilder::default()
    }
}
...
impl KmsInvalidKeyUsageBuilder {
    ...
    pub fn build(self) -> super::types::error::KmsInvalidKeyUsage {
        super::types::error::KmsInvalidKeyUsage {
