...
impl ::aws_types::request_id::RequestId for super::types::error::InvalidSecurity {
...
impl InvalidSecurity {
    ...
    pub fn builder() -> super::types::error::builders::InvalidSecurityBuilder {
        super::types::error::builders::InvalidSecurityBuilder::default()
    }
}
...
impl InvalidSecurityBuilder {
    ...
    pub fn build(self) -> super::types::error::InvalidSecurity {
        super::types::error::InvalidSecurity {
