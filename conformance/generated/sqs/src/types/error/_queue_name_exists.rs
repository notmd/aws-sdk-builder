...
impl ::aws_types::request_id::RequestId for super::types::error::QueueNameExists {
...
impl QueueNameExists {
    ...
    pub fn builder() -> super::types::error::builders::QueueNameExistsBuilder {
        super::types::error::builders::QueueNameExistsBuilder::default()
    }
}
...
impl QueueNameExistsBuilder {
    ...
    pub fn build(self) -> super::types::error::QueueNameExists {
        super::types::error::QueueNameExists {
