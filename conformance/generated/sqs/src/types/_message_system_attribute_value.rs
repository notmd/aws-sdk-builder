...
impl MessageSystemAttributeValue {
    ...
    pub fn builder() -> super::types::builders::MessageSystemAttributeValueBuilder {
        super::types::builders::MessageSystemAttributeValueBuilder::default()
    }
}
...
impl MessageSystemAttributeValueBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::MessageSystemAttributeValue, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::MessageSystemAttributeValue {
