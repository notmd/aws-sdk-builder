...
impl ChangeMessageVisibilityBatchResultEntryBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::ChangeMessageVisibilityBatchResultEntry, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::ChangeMessageVisibilityBatchResultEntry {
            id: self.id.ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("id", "id was not specified but it is required when building ChangeMessageVisibilityBatchResultEntry"))?,
        })
    }
}
