...
impl MessageAttributeValue {
    ...
    pub fn builder() -> super::types::builders::MessageAttributeValueBuilder {
        super::types::builders::MessageAttributeValueBuilder::default()
    }
}
...
impl MessageAttributeValueBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::types::MessageAttributeValue, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::types::MessageAttributeValue {
