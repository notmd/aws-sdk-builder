...
pub struct Message {
    ...
    pub attributes: ::std::option::Option<::std::collections::HashMap<super::types::MessageSystemAttributeName, ::std::string::String>>,
...
impl Message {
    ...
    /// </ul>
    /// <p><code>ApproximateFirstReceiveTimestamp</code> and <code>SentTimestamp</code> are each returned as an integer representing the <a href="http://en.wikipedia.org/wiki/Unix_time">epoch time</a> in milliseconds.</p>
    pub fn attributes(&self) -> ::std::option::Option<&::std::collections::HashMap<super::types::MessageSystemAttributeName, ::std::string::String>> {
...
pub struct MessageBuilder {
    ...
    pub(crate) attributes: ::std::option::Option<::std::collections::HashMap<super::types::MessageSystemAttributeName, ::std::string::String>>,
...
impl MessageBuilder {
    ...
    /// </ul>
    /// <p><code>ApproximateFirstReceiveTimestamp</code> and <code>SentTimestamp</code> are each returned as an integer representing the <a href="http://en.wikipedia.org/wiki/Unix_time">epoch time</a> in milliseconds.</p>
    pub fn attributes(mut self, k: super::types::MessageSystemAttributeName, v: impl ::std::convert::Into<::std::string::String>) -> Self {
    ...
    pub fn set_attributes(
        mut self,
        input: ::std::option::Option<::std::collections::HashMap<super::types::MessageSystemAttributeName, ::std::string::String>>,
    ) -> Self {
    ...
    pub fn get_attributes(
        &self,
    ) -> &::std::option::Option<::std::collections::HashMap<super::types::MessageSystemAttributeName, ::std::string::String>> {
        &self.attributes
    }
    /// <p>An MD5 digest of the non-URL-encoded message attribute string. You can use this attribute to verify that Amazon SQS received the message correctly. Amazon SQS URL-decodes the message before creating the MD5 digest. For information about MD5, see <a href="https://www.ietf.org/rfc/rfc1321.txt">RFC1321</a>.</p>
