...
impl PurgeQueueInput {
    ...
    pub fn builder() -> super::operation::purge_queue::builders::PurgeQueueInputBuilder {
        super::operation::purge_queue::builders::PurgeQueueInputBuilder::default()
    }
}
...
impl PurgeQueueInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::purge_queue::PurgeQueueInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::purge_queue::PurgeQueueInput { queue_url: self.queue_url })
    }
}
