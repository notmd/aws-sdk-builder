...
impl SendMessageBatch {
    ...
    pub(crate) async fn orchestrate(
        ...
        super::operation::send_message_batch::SendMessageBatchOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::send_message_batch::SendMessageBatchError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::send_message_batch::SendMessageBatchError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::send_message_batch::SendMessageBatchOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SendMessageBatchResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_send_message_batch::de_send_message_batch_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_send_message_batch::de_send_message_batch_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SendMessageBatchRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::send_message_batch::SendMessageBatchInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::send_message_batch::SendMessageBatchInput,
...
impl ::aws_types::request_id::RequestId for super::operation::send_message_batch::SendMessageBatchError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::send_message_batch::_send_message_batch_input::SendMessageBatchInput;

pub use super::operation::send_message_batch::_send_message_batch_output::SendMessageBatchOutput;
