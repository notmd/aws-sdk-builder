    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_message_batch::DeleteMessageBatchError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_message_batch::DeleteMessageBatchOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteMessageBatchResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_message_batch::de_delete_message_batch_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_message_batch::de_delete_message_batch_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteMessageBatchRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_message_batch::DeleteMessageBatchInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_message_batch::DeleteMessageBatchInput,
        ...
        let body =
            ::aws_smithy_types::body::SdkBody::from(super::protocol_serde::shape_delete_message_batch::ser_delete_message_batch_input(&input)?);
...
impl ::aws_types::request_id::RequestId for super::operation::delete_message_batch::DeleteMessageBatchError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_message_batch::_delete_message_batch_input::DeleteMessageBatchInput;

pub use super::operation::delete_message_batch::_delete_message_batch_output::DeleteMessageBatchOutput;
