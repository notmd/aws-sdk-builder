...
pub mod _delete_message_batch_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sqs/src/operation/delete_message_batch/_delete_message_batch_input.rs"
    ));
}
...
pub mod _delete_message_batch_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sqs/src/operation/delete_message_batch/_delete_message_batch_output.rs"
    ));
}
