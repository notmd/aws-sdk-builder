...
impl ListDeadLetterSourceQueues {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: super::operation::list_dead_letter_source_queues::ListDeadLetterSourceQueuesInput,
    ) -> ::std::result::Result<
        super::operation::list_dead_letter_source_queues::ListDeadLetterSourceQueuesOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::list_dead_letter_source_queues::ListDeadLetterSourceQueuesError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_dead_letter_source_queues::ListDeadLetterSourceQueuesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_dead_letter_source_queues::ListDeadLetterSourceQueuesOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListDeadLetterSourceQueuesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_dead_letter_source_queues::de_list_dead_letter_source_queues_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_dead_letter_source_queues::de_list_dead_letter_source_queues_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListDeadLetterSourceQueuesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_dead_letter_source_queues::ListDeadLetterSourceQueuesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_dead_letter_source_queues::ListDeadLetterSourceQueuesInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_list_dead_letter_source_queues::ser_list_dead_letter_source_queues_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::list_dead_letter_source_queues::ListDeadLetterSourceQueuesError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_dead_letter_source_queues::_list_dead_letter_source_queues_input::ListDeadLetterSourceQueuesInput;

pub use super::operation::list_dead_letter_source_queues::_list_dead_letter_source_queues_output::ListDeadLetterSourceQueuesOutput;
