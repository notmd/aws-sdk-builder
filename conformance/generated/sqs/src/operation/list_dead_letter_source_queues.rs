...
pub mod _list_dead_letter_source_queues_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sqs/src/operation/list_dead_letter_source_queues/_list_dead_letter_source_queues_input.rs"
    ));
}
...
pub mod _list_dead_letter_source_queues_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sqs/src/operation/list_dead_letter_source_queues/_list_dead_letter_source_queues_output.rs"
    ));
}
