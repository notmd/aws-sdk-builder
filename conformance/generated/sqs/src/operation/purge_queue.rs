...
impl PurgeQueue {
    ...
    pub(crate) async fn orchestrate(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::purge_queue::PurgeQueueError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::purge_queue::PurgeQueueError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::purge_queue::PurgeQueueOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PurgeQueueResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_purge_queue::de_purge_queue_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_purge_queue::de_purge_queue_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PurgeQueueRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::purge_queue::PurgeQueueInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::purge_queue::PurgeQueueInput,
...
impl ::aws_types::request_id::RequestId for super::operation::purge_queue::PurgeQueueError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::purge_queue::_purge_queue_input::PurgeQueueInput;

pub use super::operation::purge_queue::_purge_queue_output::PurgeQueueOutput;
