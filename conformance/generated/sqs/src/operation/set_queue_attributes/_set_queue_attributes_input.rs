...
impl SetQueueAttributesInput {
    ...
    pub fn builder() -> super::operation::set_queue_attributes::builders::SetQueueAttributesInputBuilder {
        super::operation::set_queue_attributes::builders::SetQueueAttributesInputBuilder::default()
    }
}
...
impl SetQueueAttributesInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::set_queue_attributes::SetQueueAttributesInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::set_queue_attributes::SetQueueAttributesInput {
