...
pub use super::operation::tag_queue::_tag_queue_input::TagQueueInputBuilder;

pub use super::operation::tag_queue::_tag_queue_output::TagQueueOutputBuilder;

impl super::operation::tag_queue::builders::TagQueueInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::tag_queue::TagQueueError,
...
pub struct TagQueueFluentBuilder {
    ...
    inner: super::operation::tag_queue::builders::TagQueueInputBuilder,
    config_override: ::std::option::Option<super::config::Builder>,
}
impl super::client::customize::internal::CustomizableSend<super::operation::tag_queue::TagQueueOutput, super::operation::tag_queue::TagQueueError>
    for TagQueueFluentBuilder
{
    fn send(
        ...
        super::client::customize::internal::SendResult<super::operation::tag_queue::TagQueueOutput, super::operation::tag_queue::TagQueueError>,
    > {
...
impl TagQueueFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::tag_queue::builders::TagQueueInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::tag_queue::TagQueue::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::tag_queue::TagQueue::orchestrate(&runtime_plugins, input).await
    }

    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
    pub fn customize(
        self,
    ) -> super::client::customize::CustomizableOperation<super::operation::tag_queue::TagQueueOutput, super::operation::tag_queue::TagQueueError, Self>
    {
