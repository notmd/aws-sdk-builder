...
impl ListQueueTagsOutput {
    ...
    pub fn builder() -> super::operation::list_queue_tags::builders::ListQueueTagsOutputBuilder {
        super::operation::list_queue_tags::builders::ListQueueTagsOutputBuilder::default()
    }
}
...
impl ListQueueTagsOutputBuilder {
    ...
    pub fn build(self) -> super::operation::list_queue_tags::ListQueueTagsOutput {
