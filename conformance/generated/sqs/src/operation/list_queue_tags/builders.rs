...
pub use super::operation::list_queue_tags::_list_queue_tags_input::ListQueueTagsInputBuilder;

pub use super::operation::list_queue_tags::_list_queue_tags_output::ListQueueTagsOutputBuilder;

impl super::operation::list_queue_tags::builders::ListQueueTagsInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &super::Client,
    ) -> ::std::result::Result<
        super::operation::list_queue_tags::ListQueueTagsOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::list_queue_tags::ListQueueTagsError,
...
pub struct ListQueueTagsFluentBuilder {
    ...
    inner: super::operation::list_queue_tags::builders::ListQueueTagsInputBuilder,
...
impl ListQueueTagsFluentBuilder {
    ...
    pub fn as_input(&self) -> &super::operation::list_queue_tags::builders::ListQueueTagsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = super::operation::list_queue_tags::ListQueueTags::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        super::operation::list_queue_tags::ListQueueTags::orchestrate(&runtime_plugins, input).await
    }
