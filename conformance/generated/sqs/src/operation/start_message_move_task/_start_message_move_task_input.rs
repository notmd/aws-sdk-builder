...
impl StartMessageMoveTaskInput {
    ...
    pub fn builder() -> super::operation::start_message_move_task::builders::StartMessageMoveTaskInputBuilder {
        super::operation::start_message_move_task::builders::StartMessageMoveTaskInputBuilder::default()
    }
}
...
impl StartMessageMoveTaskInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::start_message_move_task::StartMessageMoveTaskInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::start_message_move_task::StartMessageMoveTaskInput {
