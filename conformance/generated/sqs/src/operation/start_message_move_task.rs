...
pub mod _start_message_move_task_input {
    include!(concat!(env!("OUT_DIR"), "/generated/sqs/src/operation/start_message_move_task/_start_message_move_task_input.rs"));
}
pub use _start_message_move_task_input::StartMessageMoveTaskInput;
pub type Input = StartMessageMoveTaskInput;
pub mod _start_message_move_task_output {
    include!(concat!(env!("OUT_DIR"), "/generated/sqs/src/operation/start_message_move_task/_start_message_move_task_output.rs"));
}
pub use _start_message_move_task_output::StartMessageMoveTaskOutput;
pub type Output = StartMessageMoveTaskOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/sqs/src/operation/start_message_move_task/builders.rs"));
}
