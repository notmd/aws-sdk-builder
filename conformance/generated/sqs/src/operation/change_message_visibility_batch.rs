    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::change_message_visibility_batch::ChangeMessageVisibilityBatchError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::change_message_visibility_batch::ChangeMessageVisibilityBatchOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ChangeMessageVisibilityBatchResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_change_message_visibility_batch::de_change_message_visibility_batch_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_change_message_visibility_batch::de_change_message_visibility_batch_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ChangeMessageVisibilityBatchRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::change_message_visibility_batch::ChangeMessageVisibilityBatchInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::change_message_visibility_batch::ChangeMessageVisibilityBatchInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            super::protocol_serde::shape_change_message_visibility_batch::ser_change_message_visibility_batch_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId for super::operation::change_message_visibility_batch::ChangeMessageVisibilityBatchError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::change_message_visibility_batch::_change_message_visibility_batch_input::ChangeMessageVisibilityBatchInput;

pub use super::operation::change_message_visibility_batch::_change_message_visibility_batch_output::ChangeMessageVisibilityBatchOutput;
