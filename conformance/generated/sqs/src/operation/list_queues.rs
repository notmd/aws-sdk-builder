    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_queues::ListQueuesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_queues::ListQueuesOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListQueuesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_queues::de_list_queues_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_queues::de_list_queues_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListQueuesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<super::operation::list_queues::ListQueuesInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_queues::ListQueuesInput,
...
impl ::aws_types::request_id::RequestId for super::operation::list_queues::ListQueuesError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_queues::_list_queues_input::ListQueuesInput;

pub use super::operation::list_queues::_list_queues_output::ListQueuesOutput;
