...
pub mod _get_queue_attributes_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sqs/src/operation/get_queue_attributes/_get_queue_attributes_input.rs"
    ));
}
...
pub mod _get_queue_attributes_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sqs/src/operation/get_queue_attributes/_get_queue_attributes_output.rs"
    ));
}
