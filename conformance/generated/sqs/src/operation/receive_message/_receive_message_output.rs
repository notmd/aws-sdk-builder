...
impl ReceiveMessageOutput {
    ...
    pub fn builder() -> super::operation::receive_message::builders::ReceiveMessageOutputBuilder {
        super::operation::receive_message::builders::ReceiveMessageOutputBuilder::default()
    }
}
...
impl ReceiveMessageOutputBuilder {
    ...
    pub fn build(self) -> super::operation::receive_message::ReceiveMessageOutput {
