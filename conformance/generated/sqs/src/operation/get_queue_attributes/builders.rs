    ...
    pub fn build(self) -> super::Input { self.input }
                     ...
                     pub async fn send(self) -> ::std::result::Result<super::GetQueueAttributesOutput, super::GetQueueAttributesError> {
                         ...
                         if !status.is_success() {
                             return Err(super::GetQueueAttributesError::unhandled_with_request_ids(format!("GetQueueAttributes returned HTTP {}", status), response.header("x-amzn-requestid").map(str::to_owned), ::std::option::Option::None));
                         }
