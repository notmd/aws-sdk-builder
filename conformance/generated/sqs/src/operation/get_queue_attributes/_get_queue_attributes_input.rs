...
impl GetQueueAttributesInput {
    ...
    pub fn builder() -> super::operation::get_queue_attributes::builders::GetQueueAttributesInputBuilder {
        super::operation::get_queue_attributes::builders::GetQueueAttributesInputBuilder::default()
    }
}
...
impl GetQueueAttributesInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::get_queue_attributes::GetQueueAttributesInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::get_queue_attributes::GetQueueAttributesInput {
