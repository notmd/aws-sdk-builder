...
impl SendMessage {
    ...
    pub(crate) async fn orchestrate(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            super::operation::send_message::SendMessageError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::send_message::SendMessageError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::send_message::SendMessageOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SendMessageResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_send_message::de_send_message_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_send_message::de_send_message_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SendMessageRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::send_message::SendMessageInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::send_message::SendMessageInput,
...
impl ::aws_types::request_id::RequestId for super::operation::send_message::SendMessageError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::send_message::_send_message_input::SendMessageInput;

pub use super::operation::send_message::_send_message_output::SendMessageOutput;
