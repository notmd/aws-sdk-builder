...
impl ::std::fmt::Display for Error {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match self {
            ...
            Self::InvalidMessageContents(value) => value.fmt(f),
...
pub mod _send_message_input {
    include!(concat!(env!("OUT_DIR"), "/generated/sqs/src/operation/send_message/_send_message_input.rs"));
}
pub use _send_message_input::SendMessageInput;
pub type Input = SendMessageInput;
pub mod _send_message_output {
    include!(concat!(env!("OUT_DIR"), "/generated/sqs/src/operation/send_message/_send_message_output.rs"));
}
pub use _send_message_output::SendMessageOutput;
pub type Output = SendMessageOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/sqs/src/operation/send_message/builders.rs"));
}
