...
pub mod _tag_queue_input {
    include!(concat!(env!("OUT_DIR"), "/generated/sqs/src/operation/tag_queue/_tag_queue_input.rs"));
}
pub use _tag_queue_input::TagQueueInput;
pub type Input = TagQueueInput;
pub mod _tag_queue_output {
    include!(concat!(env!("OUT_DIR"), "/generated/sqs/src/operation/tag_queue/_tag_queue_output.rs"));
}
pub use _tag_queue_output::TagQueueOutput;
pub type Output = TagQueueOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/sqs/src/operation/tag_queue/builders.rs"));
}
