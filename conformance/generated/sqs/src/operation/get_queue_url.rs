...
pub mod _get_queue_url_input {
    include!(concat!(env!("OUT_DIR"), "/generated/sqs/src/operation/get_queue_url/_get_queue_url_input.rs"));
}
pub use _get_queue_url_input::GetQueueUrlInput;
pub type Input = GetQueueUrlInput;
pub mod _get_queue_url_output {
    include!(concat!(env!("OUT_DIR"), "/generated/sqs/src/operation/get_queue_url/_get_queue_url_output.rs"));
}
pub use _get_queue_url_output::GetQueueUrlOutput;
pub type Output = GetQueueUrlOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/sqs/src/operation/get_queue_url/builders.rs"));
}
