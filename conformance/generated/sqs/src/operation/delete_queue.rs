    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::delete_queue::DeleteQueueError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::delete_queue::DeleteQueueOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteQueueResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_delete_queue::de_delete_queue_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_delete_queue::de_delete_queue_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteQueueRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::delete_queue::DeleteQueueInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::delete_queue::DeleteQueueInput,
...
impl ::aws_types::request_id::RequestId for super::operation::delete_queue::DeleteQueueError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::delete_queue::_delete_queue_input::DeleteQueueInput;

pub use super::operation::delete_queue::_delete_queue_output::DeleteQueueOutput;
