...
pub mod _delete_queue_input {
    include!(concat!(env!("OUT_DIR"), "/generated/sqs/src/operation/delete_queue/_delete_queue_input.rs"));
}
pub use _delete_queue_input::DeleteQueueInput;
pub type Input = DeleteQueueInput;
pub mod _delete_queue_output {
    include!(concat!(env!("OUT_DIR"), "/generated/sqs/src/operation/delete_queue/_delete_queue_output.rs"));
}
pub use _delete_queue_output::DeleteQueueOutput;
pub type Output = DeleteQueueOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/sqs/src/operation/delete_queue/builders.rs"));
}
