...
pub mod _receive_message_input {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sqs/src/operation/receive_message/_receive_message_input.rs"
    ));
}
pub use _receive_message_input::ReceiveMessageInput;
pub type Input = ReceiveMessageInput;
pub mod _receive_message_output {
    include!(concat!(
        env!("OUT_DIR"),
        "/generated/sqs/src/operation/receive_message/_receive_message_output.rs"
    ));
}
pub use _receive_message_output::ReceiveMessageOutput;
pub type Output = ReceiveMessageOutput;

/// Builders
pub mod builders {
    include!(concat!(env!("OUT_DIR"), "/generated/sqs/src/operation/receive_message/builders.rs"));
}
