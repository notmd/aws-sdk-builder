...
impl ListDeadLetterSourceQueuesInput {
    ...
    pub fn builder() -> super::operation::list_dead_letter_source_queues::builders::ListDeadLetterSourceQueuesInputBuilder {
        super::operation::list_dead_letter_source_queues::builders::ListDeadLetterSourceQueuesInputBuilder::default()
    }
}
...
impl ListDeadLetterSourceQueuesInputBuilder {
    ...
    pub fn build(
        ...
        super::operation::list_dead_letter_source_queues::ListDeadLetterSourceQueuesInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(super::operation::list_dead_letter_source_queues::ListDeadLetterSourceQueuesInput {
