    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<super::operation::list_queue_tags::ListQueueTagsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<super::operation::list_queue_tags::ListQueueTagsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListQueueTagsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            super::protocol_serde::shape_list_queue_tags::de_list_queue_tags_http_error(status, headers, body)
        } else {
            super::protocol_serde::shape_list_queue_tags::de_list_queue_tags_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListQueueTagsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<super::operation::list_queue_tags::ListQueueTagsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &super::operation::list_queue_tags::ListQueueTagsInput,
...
impl ::aws_types::request_id::RequestId for super::operation::list_queue_tags::ListQueueTagsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use super::operation::list_queue_tags::_list_queue_tags_input::ListQueueTagsInput;

pub use super::operation::list_queue_tags::_list_queue_tags_output::ListQueueTagsOutput;
