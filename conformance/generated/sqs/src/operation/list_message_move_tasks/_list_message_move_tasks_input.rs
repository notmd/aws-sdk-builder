...
impl ListMessageMoveTasksInput {
    ...
    pub fn builder() -> super::operation::list_message_move_tasks::builders::ListMessageMoveTasksInputBuilder {
        super::operation::list_message_move_tasks::builders::ListMessageMoveTasksInputBuilder::default()
    }
}
...
impl ListMessageMoveTasksInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<super::operation::list_message_move_tasks::ListMessageMoveTasksInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(super::operation::list_message_move_tasks::ListMessageMoveTasksInput {
