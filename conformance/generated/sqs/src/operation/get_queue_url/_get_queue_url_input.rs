...
impl GetQueueUrlInput {
    ...
    pub fn builder() -> super::operation::get_queue_url::builders::GetQueueUrlInputBuilder {
        super::operation::get_queue_url::builders::GetQueueUrlInputBuilder::default()
    }
}
...
impl GetQueueUrlInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<super::operation::get_queue_url::GetQueueUrlInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(super::operation::get_queue_url::GetQueueUrlInput {
