...
impl GetQueueUrlOutput {
    ...
    pub fn builder() -> super::operation::get_queue_url::builders::GetQueueUrlOutputBuilder {
        super::operation::get_queue_url::builders::GetQueueUrlOutputBuilder::default()
    }
}
...
impl GetQueueUrlOutputBuilder {
    ...
    pub fn build(self) -> super::operation::get_queue_url::GetQueueUrlOutput {
