...
pub fn de_add_permission_http_error(
    ...
    Err(match error_code {
        "InvalidAddress" => super::operation::add_permission::AddPermissionError::InvalidAddress({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidSecurity" => super::operation::add_permission::AddPermissionError::InvalidSecurity({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "OverLimit" => super::operation::add_permission::AddPermissionError::OverLimit({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "RequestThrottled" => super::operation::add_permission::AddPermissionError::RequestThrottled({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
