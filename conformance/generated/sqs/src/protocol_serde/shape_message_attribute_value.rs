...
pub fn ser_message_attribute_value(
    ...
    input: &super::types::MessageAttributeValue,
...
pub(crate) fn de_message_attribute_value<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<super::types::MessageAttributeValue>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = super::types::builders::MessageAttributeValueBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "StringListValues" => {
                            builder =
                                builder.set_string_list_values(super::protocol_serde::shape_string_list::de_string_list(tokens, _value, depth + 1)?);
                        }
                        "BinaryListValues" => {
                            builder =
                                builder.set_binary_list_values(super::protocol_serde::shape_binary_list::de_binary_list(tokens, _value, depth + 1)?);
                        }
                        "DataType" => {
            ...
            Ok(Some(super::serde_util::message_attribute_value_correct_errors(builder).build().map_err(
