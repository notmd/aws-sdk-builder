...
pub fn de_list_queues_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::list_queues::ListQueuesOutput, super::operation::list_queues::ListQueuesError> {
    #[allow(unused_mut)]
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::list_queues::ListQueuesError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::list_queues::ListQueuesError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InvalidAddress" => super::operation::list_queues::ListQueuesError::InvalidAddress({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidSecurity" => super::operation::list_queues::ListQueuesError::InvalidSecurity({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "RequestThrottled" => super::operation::list_queues::ListQueuesError::RequestThrottled({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::list_queues::ListQueuesError::generic(generic),
    })
}
...
pub fn de_list_queues_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::list_queues::builders::ListQueuesOutputBuilder::default();
        output = super::protocol_serde::shape_list_queues::de_list_queues(_response_body, output)
            .map_err(super::operation::list_queues::ListQueuesError::unhandled)?;
...
pub fn ser_list_queues_input(
    input: &super::operation::list_queues::ListQueuesInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    super::protocol_serde::shape_list_queues_input::ser_list_queues_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_list_queues(
    _value: &[u8],
    mut builder: super::operation::list_queues::builders::ListQueuesOutputBuilder,
) -> ::std::result::Result<super::operation::list_queues::builders::ListQueuesOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
