...
pub fn de_delete_message_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<super::operation::delete_message::DeleteMessageOutput, super::operation::delete_message::DeleteMessageError> {
    #[allow(unused_mut)]
    let mut generic_builder = super::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(super::operation::delete_message::DeleteMessageError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::delete_message::DeleteMessageError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InvalidAddress" => super::operation::delete_message::DeleteMessageError::InvalidAddress({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidIdFormat" => super::operation::delete_message::DeleteMessageError::InvalidIdFormat({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                let mut output = super::types::error::builders::InvalidIdFormatBuilder::default();
                output = super::protocol_serde::shape_invalid_id_format::de_invalid_id_format_json_err(_response_body, output)
                    .map_err(super::operation::delete_message::DeleteMessageError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
        ...
        "InvalidSecurity" => super::operation::delete_message::DeleteMessageError::InvalidSecurity({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ReceiptHandleIsInvalid" => super::operation::delete_message::DeleteMessageError::ReceiptHandleIsInvalid({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                let mut output = super::types::error::builders::ReceiptHandleIsInvalidBuilder::default();
                output = super::protocol_serde::shape_receipt_handle_is_invalid::de_receipt_handle_is_invalid_json_err(_response_body, output)
                    .map_err(super::operation::delete_message::DeleteMessageError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
        ...
        "RequestThrottled" => super::operation::delete_message::DeleteMessageError::RequestThrottled({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => super::operation::delete_message::DeleteMessageError::generic(generic),
    })
}
...
pub fn de_delete_message_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::delete_message::builders::DeleteMessageOutputBuilder::default();
...
pub fn ser_delete_message_input(
    input: &super::operation::delete_message::DeleteMessageInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    super::protocol_serde::shape_delete_message_input::ser_delete_message_input_input(&mut object, input)?;
    object.finish();
