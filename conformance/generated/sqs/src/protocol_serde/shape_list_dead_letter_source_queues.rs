...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::list_dead_letter_source_queues::ListDeadLetterSourceQueuesError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InvalidAddress" => super::operation::list_dead_letter_source_queues::ListDeadLetterSourceQueuesError::InvalidAddress({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidSecurity" => super::operation::list_dead_letter_source_queues::ListDeadLetterSourceQueuesError::InvalidSecurity({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::list_dead_letter_source_queues::builders::ListDeadLetterSourceQueuesOutputBuilder::default();
        output = super::protocol_serde::shape_list_dead_letter_source_queues::de_list_dead_letter_source_queues(_response_body, output)
            .map_err(super::operation::list_dead_letter_source_queues::ListDeadLetterSourceQueuesError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        super::serde_util::list_dead_letter_source_queues_output_output_correct_errors(output)
            .build()
            .map_err(super::operation::list_dead_letter_source_queues::ListDeadLetterSourceQueuesError::unhandled)?
    })
}
...
pub fn ser_list_dead_letter_source_queues_input(
    ...
    super::protocol_serde::shape_list_dead_letter_source_queues_input::ser_list_dead_letter_source_queues_input_input(&mut object, input)?;
    object.finish();
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "queueUrls" => {
                    builder = builder.set_queue_urls(super::protocol_serde::shape_queue_url_list::de_queue_url_list(tokens, _value, depth + 1)?);
                }
                "NextToken" => {
