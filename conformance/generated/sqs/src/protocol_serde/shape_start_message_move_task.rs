...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(super::operation::start_message_move_task::StartMessageMoveTaskError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InvalidAddress" => super::operation::start_message_move_task::StartMessageMoveTaskError::InvalidAddress({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidSecurity" => super::operation::start_message_move_task::StartMessageMoveTaskError::InvalidSecurity({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "RequestThrottled" => super::operation::start_message_move_task::StartMessageMoveTaskError::RequestThrottled({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => super::operation::start_message_move_task::StartMessageMoveTaskError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = super::operation::start_message_move_task::builders::StartMessageMoveTaskOutputBuilder::default();
        output = super::protocol_serde::shape_start_message_move_task::de_start_message_move_task(_response_body, output)
            .map_err(super::operation::start_message_move_task::StartMessageMoveTaskError::unhandled)?;
...
pub fn ser_start_message_move_task_input(
    ...
    super::protocol_serde::shape_start_message_move_task_input::ser_start_message_move_task_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_start_message_move_task(
    _value: &[u8],
    mut builder: super::operation::start_message_move_task::builders::StartMessageMoveTaskOutputBuilder,
) -> ::std::result::Result<
    super::operation::start_message_move_task::builders::StartMessageMoveTaskOutputBuilder,
