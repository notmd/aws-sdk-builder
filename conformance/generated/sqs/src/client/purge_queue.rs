...
impl super::Client {
    ...
    pub fn purge_queue(&self) -> super::operation::purge_queue::builders::PurgeQueueFluentBuilder {
        super::operation::purge_queue::builders::PurgeQueueFluentBuilder::new(self.handle.clone())
    }
}
