...
impl super::Client {
    ...
    pub fn get_queue_url(&self) -> super::operation::get_queue_url::builders::GetQueueUrlFluentBuilder {
        super::operation::get_queue_url::builders::GetQueueUrlFluentBuilder::new(self.handle.clone())
    }
}
