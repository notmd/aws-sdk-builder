...
impl super::Client {
    ...
    pub fn cancel_message_move_task(&self) -> super::operation::cancel_message_move_task::builders::CancelMessageMoveTaskFluentBuilder {
        super::operation::cancel_message_move_task::builders::CancelMessageMoveTaskFluentBuilder::new(self.handle.clone())
    }
}
