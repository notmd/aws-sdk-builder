...
impl super::Client {
    ...
    pub fn list_queues(&self) -> super::operation::list_queues::builders::ListQueuesFluentBuilder {
        super::operation::list_queues::builders::ListQueuesFluentBuilder::new(self.handle.clone())
    }
}
